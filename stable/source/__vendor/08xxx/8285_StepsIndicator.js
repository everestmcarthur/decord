...
// Function ID: 8286
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8283, 8284, 8286, 8287]
// Exports: StepsIndicator

// Module 8285 (StepsIndicator)
import _mod8283 from "module_8283" /* 8283 */;
import _mod8284 from "module_8284" /* 8284 */;
import SliderTrackMark from "SliderTrackMark" /* 8286 */;
import StepNumber from "StepNumber" /* 8287 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8283.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8283.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8284.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8283.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8284.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8283).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8284).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8284).styles.stepIndicatorElement;
    }
