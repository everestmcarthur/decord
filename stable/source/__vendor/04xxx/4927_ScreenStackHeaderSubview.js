...
// Dependencies: [109, 19, 17, 21, 4928, 4924, 4929, 4930, 4925, 4931]
...
const forwardRefResult = noop.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  const edgeInsetApplication = _mod4928.useEdgeInsetApplication(flag, flag2, flag3);
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4924).isHeaderBarButtonsAvailableForCurrentPlatform) {
      result = tmp(4929).prepareHeaderBarButtonItems(headerLeftBarButtonItems, "left");
  ...
  if (headerRightBarButtonItems) {
    if (tmp(4924).isHeaderBarButtonsAvailableForCurrentPlatform) {
      result1 = tmp(4929).prepareHeaderBarButtonItems(headerRightBarButtonItems, "right");
