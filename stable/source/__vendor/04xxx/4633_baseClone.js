      ...
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          ...
          if (tmp32(536)(arr)) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4637)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4640)(arr, tmp32(4644)(obj2, arr));
                  const tmp32Result = tmp32(4640);
                } else {
                  tmp32ResultResult = tmp32(4648)(arr, tmp32(4649)(obj2, arr));
                  const tmp32Result3 = tmp32(4648);
                }
