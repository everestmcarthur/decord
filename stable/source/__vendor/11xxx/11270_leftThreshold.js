...
// Function ID: 11271
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1636, 11271, 6736, 6668]
// Exports: default

// Module 11270 (leftThreshold)
import cancelAnimation from "cancelAnimation" /* 1636 */;
import _mod11271 from "module_11271" /* 11271 */;
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod11271.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod11271.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod11271.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod11271.SwipeDirection.LEFT;
      }
