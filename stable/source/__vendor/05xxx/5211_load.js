...
// Function ID: 5212
// Name: load
// Dependencies: [5212, 5213, 5214, 5215, 5216, 5229, 5231, 5232, 5244, 5248, 5252, 5254, 5256, 5257, 5258, 5259, 5260, 5261, 5262, 5263, 5264, 5265, 5238]
// Exports: load
...
function loadView(byteLength, response) {
  ...
  function addPngTextTags(readTags) {
    if (flag) {
      ...
      if (closure_1.png) {
        objectAssignResult3 = _mod5213.objectAssign({}, closure_1.png, readTags);
      }
      closure_1.png = objectAssignResult3;
      let objectAssignResult4 = readTags;
      if (closure_1.pngText) {
        objectAssignResult4 = _mod5213.objectAssign({}, closure_1.png, readTags);
      }
