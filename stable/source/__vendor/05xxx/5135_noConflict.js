...
const fn = function() {
  ...
  humanize.date = (str, arg1) => {
    ...
    const dependencyMap2 = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
    closure_5 = {
      d() {
  ...
  humanize.intword = (arg0, arg1, sum, arg3, arg4, arg5, arg6) => {
    ...
    const result = arg0 / Math.pow(num, tmp2);
    let str4 = "";
    if (items[tmp2]) {
