...
// Dependencies: [32, 19, 17, 21, 6733, 6660, 6735, 6722, 6731, 6730, 6709]
// Exports: VirtualDetector

// Module 6734 (VirtualDetector)
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("module_6733").useInterceptingDetectorContext();
    ...
    closure_4(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: tmp, handlerTags, methods: tmp2.gesture.detectorCallbacks, viewRef: "a", userSelect: "<string:194379779>", touchAction: "<string:910229507>", enableContextMenu: "<string:2363293699>" };
