...
// Dependencies: [13659, 13655, 13660, 13661, 13662]
// Exports: deflate, deflateEnd, deflateInit, deflateResetKeep, deflateSetDictionary, deflateSetHeader

// Module 13658 (flush_block_only)
import _mod13655 from "module_13655" /* 13655 */;
import _mod13659 from "module_13659" /* 13659 */;
import StaticTreeDesc from "StaticTreeDesc" /* 13660 */;
import adler32 from "adler32" /* 13661 */;
import _mod13662 from "module_13662" /* 13662 */;
    ...
    if (0 === state.strm.avail_in) {
      ...
      if (0 === avail_in) {
        ...
        if (1 === strm.state.wrap) {
          ...
          strm.adler = tmp15(13662)(strm.adler, _window, avail_in, sum1);
        }
...
function DeflateState() {
  ...
  const buf16 = new _mod13655.Buf16(1146);
  obj.dyn_ltree = buf16;
  const buf161 = new _mod13655.Buf16(122);
  obj.dyn_dtree = buf161;
  const buf162 = new _mod13655.Buf16(78);
  obj.bl_tree = buf162;
  ...
  obj.d_desc = null;
  obj.bl_desc = null;
  const buf163 = new tmp(13655).Buf16(16);
  obj.bl_count = buf163;
  const buf164 = new tmp(13655).Buf16(573);
  obj.heap = buf164;
  const heap = obj.heap;
  ...
  obj.heap_len = 0;
  obj.heap_max = 0;
  const buf165 = new tmp(13655).Buf16(573);
  obj.depth = buf165;
                ...
                if (num2 <= 9) {
                  if (strategy >= 0) {
                    if (strategy <= 4) {
                      ...
                      const buf8 = new _mod13655.Buf8(2 * obj.w_size);
                      obj.window = buf8;
                      const buf16 = new _mod13655.Buf16(obj.hash_size);
                      obj.head = buf16;
                      const buf161 = new _mod13655.Buf16(obj.w_size);
                      obj.prev = buf161;
                      obj.lit_bufsize = 1 << memLevel + 6;
                      obj.pending_buf_size = 4 * obj.lit_bufsize;
                      const buf81 = new _mod13655.Buf8(obj.pending_buf_size);
            ...
            if (state.input) {
              ...
              if (42 === state8.status) {
                if (2 === state8.wrap) {
                  ...
                  if (state8.gzhead) {
                    ...
                    if (state8.gzhead.hcrc) {
                      state.adler = _mod13662(state.adler, state8.pending_buf, state8.pending, 0);
                    }
                    state8.gzindex = 0;
                    state8.status = 69;
              ...
              if (69 === state8.status) {
                if (state8.gzhead.extra) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      while (state8.gzindex < (65535 & state8.gzhead.extra.length)) {
                        if (state8.pending !== state8.pending_buf_size) {
                          ...
                          if (tmp36) {
                            state.adler = _mod13662(state.adler, state8.pending_buf, state8.pending - tmp35, tmp35);
                          }
                      ...
                      if (tmp29) {
                        state.adler = _mod13662(state.adler, state8.pending_buf, state8.pending - pending, pending);
                      }
                      state = state.state;
                      let avail_out = state.pending;
                  ...
                  if (tmp40) {
                    state.adler = _mod13662(state.adler, state8.pending_buf, state8.pending - pending2, pending2);
                  }
                ...
                if (state8.gzhead.name) {
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp46) {
                        state.adler = _mod13662(state.adler, state8.pending_buf, state8.pending - pending3, tmp44);
                      }
                    ...
                    if (tmp52) {
                      state.adler = _mod13662(state.adler, state8.pending_buf, state8.pending - pending4, pending4);
                    }
                    if (0 === num46) {
                      state8.gzindex = 0;
                      state8.status = 91;
                ...
                if (state8.gzhead.comment) {
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp58) {
                        state.adler = _mod13662(state.adler, state8.pending_buf, state8.pending - pending5, tmp56);
                      }
                    ...
                    if (tmp64) {
                      state.adler = _mod13662(state.adler, state8.pending_buf, state8.pending - pending6, pending6);
                    }
                    if (0 === num53) {
                      state8.status = 103;
                    }
        ...
        if (1 !== wrap) {
          if (!state.lookahead) {
            ...
            if (length >= state.w_size) {
              ...
              const buf8 = new _mod13655.Buf8(state.w_size);
              const obj = _mod13655;
