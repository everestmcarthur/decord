...
if (!RNScreensTurboModule) {
  ...
  const obj4 = { logger: _mod1640.logger, defaultReturnValue: obj3 };
  fn.__closure = obj4;
  ...
  const obj5 = { logger: _mod1640.logger, defaultReturnValue: "a" };
  fn2.__closure = obj5;
  ...
  const obj6 = { logger: _mod1640.logger, defaultReturnValue: "a" };
  fn3.__closure = obj6;
