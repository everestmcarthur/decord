...
const items = [
  entry,
  {
    ...
    value: function clone(arr) {
      ...
      const result = MessageType(1212).reflectionMergePartial(this, obj2, arr);
      return obj2;
    }
  },
  {
  ...
  },
  {
    ...
    value: function internalJsonRead(obj, arg1, arg2) {
      ...
      const error = new Error("Unable to parse message " + self.typeName + " from JSON " + MessageType(1189).typeofJsonValue(obj) + ".");
      throw error;
    }
  },
  {
