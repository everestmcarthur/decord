...
// Function ID: 9151
// Name: pbkdf2Init
// Dependencies: [5, 9148, 9147, 9151]
// Exports: pbkdf2, pbkdf2Async

// Module 9150 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9147).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9151).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9147).toBytes(B);
