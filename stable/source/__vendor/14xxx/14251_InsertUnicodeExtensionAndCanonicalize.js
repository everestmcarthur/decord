...
// Dependencies: [14244, 14252]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14251 (InsertUnicodeExtensionAndCanonicalize)
import _mod14244 from "module_14244" /* 14244 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14252 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14244.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
