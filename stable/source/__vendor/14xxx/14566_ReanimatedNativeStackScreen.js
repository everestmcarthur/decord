...
// Dependencies: [109, 19, 17, 21, 1636, 4916, 1614, 14567, 14568]

// Module 14566 (ReanimatedNativeStackScreen)
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef14568.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef14567.Provider, { value: sharedValue, children: jsx(_modDef14568.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
