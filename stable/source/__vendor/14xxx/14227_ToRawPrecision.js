...
// Function ID: 14228
// Name: ToRawPrecision
// Dependencies: [1162, 14208, 14209, 14211, 14221]
// Exports: ToRawPrecision

// Module 14227 (ToRawPrecision)
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  let tmp4;
  if (ZERO.isZero()) {
    let repeatResult = _mod14209.repeat("0", maximumSignificantDigits);
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(14209).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(14209).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(14209).repeat("0", -num3 - 1)}${arr}`;
