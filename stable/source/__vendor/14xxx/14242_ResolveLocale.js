...
import LookupMatcher from "LookupMatcher" /* 14243 */;
import _mod14244 from "module_14244" /* 14244 */;
import BestFitMatcher from "BestFitMatcher" /* 14248 */;
...
export const ResolveLocale = function ResolveLocale(arg0, arg1, localeMatcher, arg3, arg4, fn) {
  ...
  if (0 < arg3.length) {
    do {
      ...
      let invariantResult = _mod14244.invariant(isArray, "keyLocaleData for ".concat(str, " must be an array"));
      let first = items1[0];
      let tmp19 = undefined === first;
      if (!tmp19) {
        tmp19 = typeof first === "string";
      }
      let invariantResult1 = _mod14244.invariant(tmp19, "value must be a string or undefined");
