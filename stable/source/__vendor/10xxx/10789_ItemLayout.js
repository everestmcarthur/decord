...
// Function ID: 10790
// Name: ItemLayout
// Dependencies: [19, 21, 10772, 10790, 1636]
// Exports: ItemLayout

// Module 10789 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10772.useGlobalState().props;
  ...
  const offsetX = _mod10790.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10790;
  const fn = function k() {
