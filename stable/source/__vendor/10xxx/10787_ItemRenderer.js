...
// Function ID: 10788
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10788, 1636, 10765, 10789]
// Exports: ItemRenderer

// Module 10787 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod10788.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
