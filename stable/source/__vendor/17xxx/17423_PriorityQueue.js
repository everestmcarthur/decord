...
// Function ID: 17424
// Name: PriorityQueue
// Dependencies: [41, 42, 17424]

// Module 17423 (PriorityQueue)
...
const entry = {
  ...
  value: function enqueue(run, arg1) {
    ...
    _queue1.splice(PriorityQueue(17424).default(self._queue, obj, (priority, priority2) => priority2.priority - priority.priority), 0, obj);
  }
};
const items = [
  entry,
