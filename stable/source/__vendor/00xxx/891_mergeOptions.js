...
function Form(onSubmitError) {
  ...
  f107840 = screenshotInput(function*(arg0, value) {
    if (c6 === 2) {
      c6 = 3;
...
function Dialog(onFormSubmitted) {
  ...
  const tmp2 = fn2(() => {
    obj = { __html: null };
    const _document = f71276(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document2 = f71276(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document3 = f71276(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document4 = f71276(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document5 = f71276(merged[2]).GLOBAL_OBJ.document;
    const elementNS4 = _document5.createElementNS("http://www.w3.org/2000/svg", "defs");
    const _document6 = f71276(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document7 = f71276(merged[2]).GLOBAL_OBJ.document;
