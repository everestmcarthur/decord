...
export const browserTracingIntegration = () => {
  ...
  closure_3 = { name: "transform", source: "call" };
...
export const startBrowserTracingPageLoadSpan = function startBrowserTracingPageLoadSpan(f108179, tmp2Result, arg2) {
  f108179.emit("startPageLoadSpan", tmp2Result, arg2);
  const currentScope = _mod682.getCurrentScope();
