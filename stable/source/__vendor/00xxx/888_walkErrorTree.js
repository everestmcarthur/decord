    ...
    if (exceptions.length + 1 < arg1) {
      if (obj12.isString(tmp)) {
        ...
        if (tmp28Result.isInstanceOf(tmp, Error)) {
          exceptionFromErrorResult = tmp28(889).exceptionFromError(stackParser, originalException[arg3]);
          const tmp28Result3 = tmp28(889);
        } else {
          ...
          tmp28Result4 = tmp28(682);
        }
        tmp28Result = tmp28(682);
      }
      const items2 = [];
