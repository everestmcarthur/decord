...
// Function ID: 3885
// Name: G
// Dependencies: [3885, 3886, 3889, 3890, 3892, 3893, 3894]
...
if (!module_3886) {
  const obj2 = { default: module_3886 };
  let tmp5 = obj2;
} else {
  tmp5 = module_3886;
}
...
if (!module_3890) {
  const obj4 = { default: module_3890 };
  let tmp9 = obj4;
} else {
  tmp9 = module_3890;
}
...
if (!module_3892) {
  const obj5 = { default: module_3892 };
  let tmp11 = obj5;
} else {
  tmp11 = module_3892;
}
...
if (!module_3893) {
  const obj6 = { default: module_3893 };
  let tmp13 = obj6;
} else {
  tmp13 = module_3893;
}
