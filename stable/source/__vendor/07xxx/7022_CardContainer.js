...
// Function ID: 7023
// Name: CardContainer
// Dependencies: [19, 17, 21, 1484, 5631, 7023, 7024, 7025, 7012]
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let obj2 = Link;
  const keyboardManager = _mod7023.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7023;
  ...
  obj12.children = React4(_mod5631.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5631.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5631.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7025.Card, obj5);
