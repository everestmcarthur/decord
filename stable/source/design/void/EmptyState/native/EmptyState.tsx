...
export default function EmptyState(Illustration) {
  ...
  if (null != Illustration.Illustration) {
    ...
    tmp8Result = null;
    if (tmp6) {
      const obj2 = { resizeMode: "contain", source: tmp2(4411).isThemeLight(tmp5) ? Illustration.lightSource : Illustration.darkSource, style: null };
  ...
  if (null != title) {
    ...
    obj4.style = items4;
    obj4.children = title;
    tmp14 = React4(tmp2(4556).Text, obj4);
  }
  items3[1] = tmp14;
  let tmp16 = null;
  if (null != body) {
    ...
    obj5.style = items5;
    obj5.children = body;
    tmp16 = React4(tmp2(4556).Text, obj5);
  }
  items3[2] = tmp16;
  items3[3] = children;
