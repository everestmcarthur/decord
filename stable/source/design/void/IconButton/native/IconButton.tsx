...
// Dependencies: [19, 21, 4560, 576, 5441, 5123, 1178, 2]
...
const obj3 = { container: { borderRadius: nativeDefault.radii.xs, alignItems: "center", justifyContent: "center", backgroundColor: fn(5441).DARK_PRIMARY_700_LIGHT_PRIMARY_230 }, small: { height: Sizes.SMALL_24, width: Sizes.SMALL_24 }, medium: { height: Sizes.MEDIUM_32, width: Sizes.MEDIUM_32 }, large: { height: Sizes.LARGE_40, width: Sizes.LARGE_40 }, smallCircular: { borderRadius: Sizes.SMALL_24 / 2 }, mediumCircular: { borderRadius: Sizes.MEDIUM_32 / 2 }, largeCircular: { borderRadius: Sizes.LARGE_40 / 2 }, icon: null };
const obj4 = { borderRadius: nativeDefault.radii.xs, alignItems: "center", justifyContent: "center", backgroundColor: fn(5441).DARK_PRIMARY_700_LIGHT_PRIMARY_230 };
const obj5 = { borderRadius: Sizes.SMALL_24 / 2 };
obj3.icon = { tintColor: fn(5441).DARK_PRIMARY_300_LIGHT_PRIMARY_500 };
