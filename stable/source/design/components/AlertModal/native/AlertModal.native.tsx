...
// Function ID: 4911
// Name: AlertModal
// Dependencies: [5, 32, 718, 19, 17, 1085, 21, 4560, 576, 4271, 4906, 4296, 1874, 4911, 4958, 1249, 4963, 1114, 4279, 1611, 4971, 1477, 4972, 4973, 4556, 4974, 4975, 2]
...
function AlertModalBackdrop() {
  ...
  dependencyMap = tmp4;
  const alertStore = context(4906).useAlertStore((arg0) => {
  ...
  let obj2 = context(4296);
  fn.__closure = { withAlertModalSpring, sharedVisible: tmp2[1], sharedTransitionState, TransitionStates: context(4271).TransitionStates, runOnJS: context(4296).runOnJS, cleanUp: context };
  ...
  return closure_10(context(4963).Backdrop, obj4);
}
class AlertModal {
  constructor(arg0) {
...
let obj4 = { withSpring: fn(4974).withSpring, MODAL_SPRING: obj3 };
