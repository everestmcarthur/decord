...
// Dependencies: [19, 21, 4980, 4560, 4296, 4974, 4978, 4976, 8915, 576, 2]
// Exports: CollapsibleFloatingActionButton

// Module 8914 (CollapsibleFloatingActionButton)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4296 */;
import spring from "spring" /* 4974 */;
import springPresets from "springPresets" /* 4978 */;
import ButtonConstants2 from "ButtonConstants" /* 4980 */;
import FloatingActionButton from "FloatingActionButton" /* 8915 */;
...
function CollapsableButton(arg0) {
  ...
  B.__closure = { FAB_BUTTON_SIZE: collapseText(4980).FAB_BUTTON_SIZE, withSpring: collapseText(4974).withSpring, interpolate: collapseText(4296).interpolate, collapseText, FAB_PADDING_HORIZONTAL: 20, FAB_PADDING_VERTICAL: buttonPadding, SUBTLE_SPRING: collapseText(4978).SUBTLE_SPRING };
...
export const CollapsibleFloatingActionButton = function CollapsibleFloatingActionButton(arg0) {
  ...
  if (positionRight == null) {
    positionRight = tmp3(8915).DEFAULT_POSITION_OFFSET;
  }
  const rect = { position: "absolute", right: positionRight, bottom: null };
  if (positionBottom == null) {
    positionBottom = tmp3(8915).DEFAULT_POSITION_OFFSET;
  }
