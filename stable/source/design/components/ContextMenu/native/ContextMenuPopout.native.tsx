...
// Dependencies: [32, 19, 17, 21, 4560, 576, 8674, 4296, 4271, 6981, 1477, 1115, 4974, 8673, 6655, 4556, 14169, 4962, 4963, 1114, 2]
...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = { withSpring: visible(4974).withSpring, visible, CONTEXT_MENU_SPRING: visible(8674).CONTEXT_MENU_SPRING };
  ...
  const obj2 = { withSpring: visible(4974).withSpring, visible, CONTEXT_MENU_SPRING: visible(8674).CONTEXT_MENU_SPRING };
  ...
  return tmp3(visible(4963).Backdrop, obj3);
}
...
obj2.container = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8674).CONTEXT_MENU_MIN_WIDTH };
let obj3 = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8674).CONTEXT_MENU_MIN_WIDTH };
obj2.titleContainer = { padding: fn(8674).CONTEXT_MENU_ITEM_PADDING };
let obj4 = { padding: fn(8674).CONTEXT_MENU_ITEM_PADDING };
obj2.divider = { borderBottomWidth: fn(8674).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
