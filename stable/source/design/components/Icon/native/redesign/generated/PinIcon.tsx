...
// Function ID: 10959
// Name: PinIcon
// Dependencies: [19, 21, 576, 4261, 10959, 2]
// Exports: PinIcon

// Module 10958 (PinIcon)
...
export const PinIcon = function PinIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10959, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
