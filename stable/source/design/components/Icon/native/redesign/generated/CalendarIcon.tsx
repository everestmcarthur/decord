...
// Function ID: 9792
// Name: CalendarIcon
// Dependencies: [19, 21, 576, 4261, 9792, 2]
// Exports: CalendarIcon

// Module 9791 (CalendarIcon)
...
export const CalendarIcon = function CalendarIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9792, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
