...
// Dependencies: [19, 21, 576, 4261, 12373, 2]
// Exports: ChevronLargeRightIcon

// Module 12372 (ChevronLargeRightIcon)
...
export const ChevronLargeRightIcon = function ChevronLargeRightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12373, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
