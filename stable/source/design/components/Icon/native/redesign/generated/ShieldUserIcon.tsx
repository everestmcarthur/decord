...
// Function ID: 9759
// Name: ShieldUserIcon
// Dependencies: [19, 21, 576, 4261, 8124, 2]
// Exports: ShieldUserIcon

// Module 9758 (ShieldUserIcon)
...
export const ShieldUserIcon = function ShieldUserIcon(tmp2Result) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8124, color: INTERACTIVE_ICON_DEFAULT, style: tmp2Result.style });
};
