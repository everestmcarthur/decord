...
// Dependencies: [19, 21, 576, 4261, 15381, 2]
// Exports: EmojiMeltingFaceIcon

// Module 15380 (EmojiMeltingFaceIcon)
...
export const EmojiMeltingFaceIcon = function EmojiMeltingFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15381, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
