...
// Dependencies: [19, 21, 576, 4261, 7052, 2]
// Exports: MagnifyingGlassIcon

// Module 7051 (MagnifyingGlassIcon)
...
export const MagnifyingGlassIcon = function MagnifyingGlassIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7052, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
