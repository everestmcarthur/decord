...
// Function ID: 10159
// Name: MagicWandIcon
// Dependencies: [19, 21, 576, 4261, 10159, 2]
// Exports: MagicWandIcon

// Module 10158 (MagicWandIcon)
...
export const MagicWandIcon = function MagicWandIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10159, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
