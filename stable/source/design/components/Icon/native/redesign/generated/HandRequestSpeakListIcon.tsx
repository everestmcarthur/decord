...
// Dependencies: [19, 21, 576, 4261, 9935, 2]
// Exports: HandRequestSpeakListIcon

// Module 9934 (HandRequestSpeakListIcon)
...
export const HandRequestSpeakListIcon = function HandRequestSpeakListIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9935, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
