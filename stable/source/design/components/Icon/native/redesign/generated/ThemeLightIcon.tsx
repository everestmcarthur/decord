...
// Function ID: 15271
// Name: ThemeLightIcon
// Dependencies: [19, 21, 576, 4261, 15271, 2]
// Exports: ThemeLightIcon

// Module 15270 (ThemeLightIcon)
...
export const ThemeLightIcon = function ThemeLightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15271, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
