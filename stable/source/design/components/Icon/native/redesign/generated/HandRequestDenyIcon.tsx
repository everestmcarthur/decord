...
// Dependencies: [19, 21, 576, 4261, 9940, 2]
// Exports: HandRequestDenyIcon

// Module 9939 (HandRequestDenyIcon)
...
export const HandRequestDenyIcon = function HandRequestDenyIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9940, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
