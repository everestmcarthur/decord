...
// Dependencies: [19, 21, 576, 4261, 5036, 2]
// Exports: AnnouncementsIcon

// Module 5094 (AnnouncementsIcon)
...
export const AnnouncementsIcon = function AnnouncementsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5036, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
