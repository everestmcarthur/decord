...
// Function ID: 5098
// Name: StageIcon
// Dependencies: [19, 21, 576, 4261, 5037, 2]
// Exports: StageIcon

// Module 5097 (StageIcon)
...
export const StageIcon = function StageIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5037, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
