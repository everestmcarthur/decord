...
// Function ID: 10138
// Name: CirclePlayIcon
// Dependencies: [19, 17, 21, 576, 4261, 10138, 10139, 2]
// Exports: CirclePlayIcon

// Module 10137 (CirclePlayIcon)
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod10138, color: secondaryColor, style }), ];
  const obj3 = { source: _mod10139, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
