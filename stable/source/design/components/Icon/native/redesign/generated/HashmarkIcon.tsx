...
// Function ID: 15585
// Name: HashmarkIcon
// Dependencies: [19, 21, 576, 4261, 15585, 2]
// Exports: HashmarkIcon

// Module 15584 (HashmarkIcon)
...
export const HashmarkIcon = function HashmarkIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15585, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
