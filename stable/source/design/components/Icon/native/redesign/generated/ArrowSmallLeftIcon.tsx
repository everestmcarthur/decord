...
// Dependencies: [19, 21, 576, 4261, 9586, 2]
// Exports: ArrowSmallLeftIcon

// Module 9585 (ArrowSmallLeftIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4261 */;
import _mod9586 from "module_9586" /* 9586 */;
...
export const ArrowSmallLeftIcon = function ArrowSmallLeftIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9586, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
