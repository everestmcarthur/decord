...
// Dependencies: [19, 21, 576, 4261, 9132, 2]
// Exports: MicrophoneDenyIcon

// Module 9131 (MicrophoneDenyIcon)
...
export const MicrophoneDenyIcon = function MicrophoneDenyIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9132, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
