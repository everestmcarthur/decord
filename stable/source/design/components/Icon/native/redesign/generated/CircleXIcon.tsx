...
// Function ID: 6617
// Name: CircleXIcon
// Dependencies: [19, 17, 21, 576, 4261, 6617, 6618, 2]
// Exports: CircleXIcon

// Module 6616 (CircleXIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4261 */;
import _mod6617 from "module_6617" /* 6617 */;
...
export const CircleXIcon = function CircleXIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6617, color: secondaryColor, style }), ];
  const obj3 = { source: _mod6618, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
