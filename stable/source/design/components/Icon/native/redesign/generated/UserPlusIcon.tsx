...
// Function ID: 4498
// Name: UserPlusIcon
// Dependencies: [19, 21, 576, 4261, 4498, 2]
// Exports: UserPlusIcon

// Module 4497 (UserPlusIcon)
...
export const UserPlusIcon = function UserPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4498, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
