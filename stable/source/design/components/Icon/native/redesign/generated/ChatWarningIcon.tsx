...
// Dependencies: [19, 21, 576, 4261, 8019, 2]
// Exports: ChatWarningIcon

// Module 12457 (ChatWarningIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4261 */;
import _mod8019 from "module_8019" /* 8019 */;
...
export const ChatWarningIcon = function ChatWarningIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8019, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
