...
// Dependencies: [19, 21, 576, 4261, 9926, 2]
// Exports: MicrophoneArrowRightIcon

// Module 9925 (MicrophoneArrowRightIcon)
...
export const MicrophoneArrowRightIcon = function MicrophoneArrowRightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9926, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
