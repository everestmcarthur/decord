...
// Function ID: 5073
// Name: ThreadLockIcon
// Dependencies: [19, 21, 576, 4261, 5029, 2]
// Exports: ThreadLockIcon

// Module 5072 (ThreadLockIcon)
...
export const ThreadLockIcon = function ThreadLockIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5029, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
