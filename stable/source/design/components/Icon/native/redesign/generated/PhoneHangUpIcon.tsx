...
// Dependencies: [19, 21, 576, 4261, 7884, 2]
// Exports: PhoneHangUpIcon

// Module 7883 (PhoneHangUpIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4261 */;
import _mod7884 from "module_7884" /* 7884 */;
...
export const PhoneHangUpIcon = function PhoneHangUpIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7884, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
