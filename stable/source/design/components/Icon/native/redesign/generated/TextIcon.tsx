...
// Function ID: 5081
// Name: TextIcon
// Dependencies: [19, 21, 576, 4261, 5032, 2]
// Exports: TextIcon

// Module 5080 (TextIcon)
...
export const TextIcon = function TextIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5032, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
