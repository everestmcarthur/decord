...
export const LottieIcon = noop.forwardRef((color, ref) => {
  ...
  obj3.style = items4;
  obj2.children = jsx(_modDef5530, { ref, source: color.dotLottie, colorFilters: null, hardwareAccelerationAndroid: true, loop: false, onAnimationLoaded: null, resizeMode: "cover", style: null });
