...
// Dependencies: [19, 21, 4560, 576, 4980, 4296, 4974, 8099, 2]
// Exports: FloatingActionButton

// Module 8915 (FloatingActionButton)
...
export const FloatingActionButton = function FloatingActionButton(positionRight) {
  ...
  F.__closure = { withSpring: positionBottom(4974).withSpring, positionBottom, DEFAULT_POSITION_OFFSET: 16, SPRING_CONFIG, positionRight };
  ...
  obj3.children = jsx(positionBottom(8099).BaseIconButton, {});
