...
// Function ID: 4992
// Name: ButtonEllipsis
// Dependencies: [19, 21, 4296, 4560, 576, 4561, 4981, 4992, 2]
// Exports: Ellipsis
  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        const tmp5Result3 = tmp5(4296);
        tmp11(tmp5Result.withDelay(result1, tmp5Result3.withRepeat(tmp5(4561).withTiming(1, tmp8, "animate-always"), -1, true)));
        return () => {
...
ELLIPSIS_APPEAR_TIMING.easing = Easing.inOut(fn(4296).Easing.quad);
...
withEllipsisAnimation.__closure = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: fn(4296).withDelay, withRepeat: fn(4296).withRepeat, withTiming: fn(4561).withTiming, ELLIPSIS_APPEAR_TIMING };
