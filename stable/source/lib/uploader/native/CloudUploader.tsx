...
// Function ID: 7840
// Name: CloudUploader
// Dependencies: [5, 17, 1074, 4553, 3, 7840, 7755, 1114, 5179, 5138, 5174, 7841, 1115, 7842, 5127, 5128, 12, 2]

// Module 7839 (CloudUploader)
import LoggerDefault from "Logger" /* 3 */;
import _modDef12 from "module_12" /* 12 */;
import Upload from "Upload" /* 5128 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import UploaderBase from "UploaderBase" /* 7840 */;
                ...
                try {
                  ...
                  if (0 === length) {
                    if (arg0 === 1) {
                      ...
                      c2 = 1;
                      const obj7 = { value: files(7755).startBackgroundTask(obj4), done: false };
                      return obj7;
                    }
                  } else if (arg0 === 1) {
                    c2 = 3;
                    ...
                    closure_128_0 = value;
                    if (tmp2._aborted) {
                      files(7755).endBackgroundTask(closure_128_0);
                      const obj = files(7755);
                    }
                    c2 = 3;
                    return { value: "HermesInternal", done: null };
                  }
          ...
          if (closure_130_6 > Math.max(uploadTarget.getMaxFileSize(closure_130_5.channelId), c6)) {
            ...
            if (closure_130_4 > uploadTarget.getMaxTotalAttachmentSize()) {
              ...
              if (_self === undefined) {
                ...
                c6 = 3;
                constants = 1;
                const obj18 = { value: _self(5138).getFileSize(closure_130_5.item.uri), done: false };
                return obj18;
              }
            }
          }
