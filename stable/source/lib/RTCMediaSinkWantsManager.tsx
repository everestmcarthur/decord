...
// Dependencies: [32, 502, 1074, 4585, 1090, 4882, 13809, 4618, 4629, 4447, 9615, 11, 12, 1115, 558, 4615, 2]
...
import WindowVisibilityVideoManager2 from "WindowVisibilityVideoManager" /* 9615 */;
...
prototype["reset"] = function reset() {
  ...
  const WindowVisibilityVideoManager = tmp3(9615).WindowVisibilityVideoManager;
