...
// Dependencies: [32, 5, 5277, 5542, 7457, 7458, 7678, 7680, 7595, 5502, 4582, 502, 1957, 7681, 1979, 4544, 4781, 4199, 4600, 4575, 7687, 1371, 1074, 7689, 7326, 4553, 17, 3, 4543, 7690, 4548, 7693, 7694, 4740, 7699, 5449, 7718, 1242, 4545, 7735, 7738, 4799, 7740, 1114, 2024, 5129, 573, 7752, 4745, 7753, 7600, 1272, 4783, 7221, 9, 7488, 5272, 11, 1986, 2006, 7477, 5275, 7754, 7755, 7759, 7760, 4218, 7684, 1384, 7267, 7761, 7830, 7834, 7837, 7843, 7844, 7848, 11692, 5543, 1090, 7940, 1894, 7765, 4411, 10749, 4904, 2]

// Module 7456 (MessageActionCreators)
...
import MessageRoundtripTrackerStore from "MessageRoundtripTrackerStore" /* 7458 */;
...
function trackInvite(channelId) {
  ...
  if (result1) {
    result1 = tmp3(7735).isEmbeddedApplicationInvite(invite);
    const tmp3Result = tmp3(7735);
  }
  let id1;
  if (invite != null) {
  ...
  if (tmp8) {
    const result2 = tmp3(7694).trackAppEmbedLinkSent(id1, LinkType.ACTIVITY_INVITE, id);
    const tmp3Result5 = tmp3(7694);
  }
        ...
        try {
          ...
          if (0 === c2) {
            ...
            if (closure_128_0.body.length > 0) {
              dependencyMap = 3;
              const obj7 = { value: v0(4783).createMessageRecord(closure_128_0.body[0]), done: true };
              return obj7;
            } else {
              dependencyMap = 3;
              return { value: "HermesInternal", done: null };
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != databaseResult) {
                if (null != basicChannel) {
                  orCreate = tmp2(5272).getOrCreate(closure_0);
                  if (!orCreate.hasMoreAfter) {
                    c2 = 1;
                    dependencyMap = 1;
                    const obj6 = { value: v0(2006).tryLoadAsync(async () => closure_1(7477).load(closure_1_1, c0, closure_1)), done: false };
                    return obj6;
                  }
                  const obj2 = tmp2(5272);
                }
              }
              dependencyMap = 3;
            ...
            if (null != closure_128_3) {
              ...
              if (0 !== closure_128_5.length) {
                ...
                const obj8 = tmp2(573);
                obj9.isForegroundCacheLoad = v0(5275).isIOSPushNotificationRawPayloadFixExperimentEnabled();
                obj8.dispatch(obj9);
                const obj10 = v0(5275);
              }
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (tmp2.reaction) {
                ...
                dependencyMap = 1;
                c4 = 1;
                const obj6 = { value: tmp2(7754)(closure_0), done: false };
                return obj6;
              }
            }
          } else if (arg0 === 1) {
            ...
            if (null != closure_129_0) {
              ...
              closure_0 = nonce;
              if (nonce == null) {
                closure_0 = closure_0(7753).createNonce();
                const obj = closure_0(7753);
              }
              ...
              closure_130_3 = obj9;
              closure_129_2 = tmp2(7755).backgroundify(function _trySend() {
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              dependencyMap = 1;
              const obj5 = { value: tmp2(7765).unarchiveThreadIfNecessary(tmp3), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
            ...
            closure_128_2 = obj6;
            const obj8 = { type: tmp3(7834).MessageDataType.EDIT, message: closure_128_2 };
            tmp2(7834).enqueue(obj8, (hasErr) => {
              hasErr = hasErr.hasErr;
              let hasItem = !hasErr;
              if (!hasErr) {
                const AUTOMOD_ERROR_CODES = channelId(7940).AUTOMOD_ERROR_CODES;
                hasItem = AUTOMOD_ERROR_CODES.has(hasErr.body.code);
              }
              if (hasItem) {
                const obj = { type: channelId(7834).MessageDataType.EDIT, message };
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              dependencyMap = 1;
              const obj5 = { value: tmp5(7765).unarchiveThreadIfNecessary(tmp2), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              c2 = 1;
              const obj5 = { value: v1(7765).unarchiveThreadIfNecessary(tmp4), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c2 = 3;
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (flag) {
                ...
                c2 = 1;
                dependencyMap = 1;
                const obj5 = { value: id(7765).unarchiveThreadIfNecessary(channelId), done: false };
                return obj5;
              }
            }
          } else if (arg0 === 1) {
