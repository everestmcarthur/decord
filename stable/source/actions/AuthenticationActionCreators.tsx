...
// Dependencies: [5, 6594, 502, 6595, 1074, 6596, 3, 4554, 573, 4418, 1100, 4763, 4753, 1250, 1272, 4461, 6597, 6598, 510, 1099, 2]
...
export default {
    ...
    return obj2.post(request).then((body) => {
      ...
      if (null != body.body) {
        ...
        if (null != suspended_user_token) {
          ...
          const obj2 = { type: "LOGIN_SUSPENDED_USER", suspendedUserToken: suspended_user_token1 };
      ...
      if (code === constants.ACCOUNT_SCHEDULED_FOR_DELETION) {
        if (null != password) {
          if ("" !== tmp6) {
            const obj4 = { type: "LOGIN_ACCOUNT_SCHEDULED_FOR_DELETION", credentials: null };
            const obj5 = { login, password: tmp6 };
      ...
      if (code === constants.ACCOUNT_DISABLED) {
        if (null != password) {
          if ("" !== tmp7) {
            const obj7 = { type: "LOGIN_ACCOUNT_DISABLED", credentials: null };
            const obj8 = { login, password: tmp7 };
            obj7.credentials = obj8;
            DispatcherDefault.dispatch(obj7);
          }
        }
      }
      if (code === constants.PHONE_VERIFICATION_REQUIRED) {
        const obj10 = { type: "LOGIN_PHONE_IP_AUTHORIZATION_REQUIRED", credentials: null };
        const obj11 = { login, password };
        obj10.credentials = obj11;
        DispatcherDefault.dispatch(obj10);
      } else {
        const obj13 = { type: "LOGIN_FAILURE", error: v6OrEarlierAPIError };
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj5 = { value: closure_0(6597).fetchWebAuthnPasswordlessChallenge(), done: false };
              return obj5;
            }
          } else if (1 === tmp8) {
            dependencyMap = 0;
            ...
            if (4 === tmp8) {
              ...
              if (tmp16) {
                c4 = 6;
                c5 = 1;
                const obj15 = { value: tmp3(6598).signalUnknownCredential(closure_128_3), done: false };
                return obj15;
              }
            } else if (5 === tmp8) {
              if (arg0 === 1) {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj7 = { value: tmp3(4753).post(request), done: false };
              return obj7;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
  ...
  logout(TTI_test, LOGIN) {
    ...
    request.body = obj2;
    const obj = DEFAULT_LOGGED_OUT(4753);
    const tmp3 = _require;
