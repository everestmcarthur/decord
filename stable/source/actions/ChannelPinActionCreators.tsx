        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp2(7765).unarchiveThreadIfNecessary(tmp3.id), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: id(7765).unarchiveThreadIfNecessary(channel.id), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            HTTP.del(obj6).catch(() => {
              ...
              return closure_1(4904).show(obj2);
            });
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
