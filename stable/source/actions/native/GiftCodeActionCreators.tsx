...
// Module 11437 (actions/GiftCodeActionCreators)
...
function openGiftCodeRedeemModal(code) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11443, dependencyMap.paths), { code }, "GIFT_CODE_REDEEM_MODAL_KEY");
}
