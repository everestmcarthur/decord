...
// Dependencies: [32, 1647, 1648, 1640, 1649, 1650]
      ...
      if (undefined !== _mod1648.createReactDOMStyle) {
        if (undefined !== animatableRef.style) {
          if (typeof updatePropsDOM === "function") {
            ...
            const reactDOMStyle = tmp36(1648).createReactDOMStyle(obj4);
            const _Array = Array;
            const tmp36Result = tmp36(1648);
            if (tmp18) {
              reactDOMStyle.transform = tmp36(1648).createTransformValue(reactDOMStyle.transform);
              const tmp36Result3 = tmp36(1648);
            }
            ...
            if (tmp19) {
              ...
              reactDOMStyle.textShadow = tmp36(1648).createTextShadowValue({ textShadowColor: null, textShadowOffset: null, textShadowRadius: null });
              const obj5 = { textShadowColor: null, textShadowOffset: null, textShadowRadius: null };
              const tmp36Result4 = tmp36(1648);
            }
