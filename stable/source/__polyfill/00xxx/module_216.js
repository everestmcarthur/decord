...
const fn = function t(arg0) {
    ...
    constructor(arg0) {
      ...
      if (arg0 instanceof Headers) {
        ...
        if (Array.isArray(arg0)) {
          item1 = arg0.forEach(function(item) {
            if (2 != item.length) {
          ...
          item2 = ownPropertyNames.forEach(function(item) {
  ...
  function readBlobAsArrayBuffer(response) {
          ...
          if (self.status <= 599) {
            ...
            if (headers instanceof Headers) {
              ...
              if (Array.isArray(headers)) {
                item1 = headers.forEach(function(item) {
                  if (2 != item.length) {
                    const _TypeError = TypeError;
                    const typeError = new TypeError("Headers constructor: expected name/value pair to be length 2, found" + item.length);
                    throw typeError;
  ...
  if (!_globalThis) {
    _globalThis = undefined !== global && global;
    ...
    constructor() {
      ...
      obj.arrayBuffer = function() {
        ...
        if (this._bodyArrayBuffer) {
          ...
          return self.blob().then(readBlobAsArrayBuffer);
        } else {
          const _Error = Error;
  ...
  Body.clone = function() {
    ...
    if (headers instanceof Headers) {
      ...
      const _Array = Array;
      if (Array.isArray(headers)) {
        const item1 = headers.forEach(function(item) {
          if (2 != item.length) {
            const _TypeError = TypeError;
            const typeError = new TypeError("Headers constructor: expected name/value pair to be length 2, found" + item.length);
            throw typeError;
