...
let fn = function n() {
  ...
  function unpack(arg0, arg1) {
    ...
    if (arg0.length >= 3) {
      ...
      if (typeof type$p === "function") {
        ...
        mapped = arg0[0];
        tmp4 = f107630[typeof call === "unknown" ? toString(first) : call(toString, first)] || "object";
      } else {
    ...
    if (typeof last === "function") {
      ...
      if (items.length >= 2) {
        ...
        if (typeof type$p === "function") {
          ...
          str = formatted;
          tmp9 = f107630[typeof call === "unknown" ? toString(tmp6) : call(toString, tmp6)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    test(arg0) {
      ...
      if (!items.length) {
        if (typeof type$p === "function") {
          ...
          tmp8 = f107630[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    if (typeof last === "function") {
      ...
      if (items.length >= 2) {
        ...
        if (typeof type$p === "function") {
          ...
          str = formatted;
          tmp13 = f107630[typeof call === "unknown" ? toString(tmp10) : call(toString, tmp10)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    test() {
      ...
      if (1 === items.length) {
        ...
        if (typeof type$p === "function") {
          ...
          tmp8 = f107630[typeof call === "unknown" ? toString(first) : call(toString, first)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
  ...
  function mix$1(arg0, arg1, arg2) {
    ...
    if (obj17[first]) {
      if (typeof type$p === "function") {
        ...
        tmp17 = f107630[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    } else {
    ...
    function setColors(items) {
      ...
      if (items) {
        if (typeof type$p === "function") {
          const _Object = Object;
          const call = toString.call;
          brewer = "string" === (f107630[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object");
          const tmp4 = f107630[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
      ...
      if (typeof type$p === "function") {
        ...
        tmp10 = f107630[typeof call2 === "unknown" ? toString2(arr2) : call2(toString2, arr2)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    }
      ...
      if (!isNaN(arg0)) {
        if (null !== arg0) {
          ...
          if (typeof type$p === "function") {
            ...
            tmp29 = f107630[typeof call === "unknown" ? toString(tmp27) : call(toString, tmp27)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
    ...
    fn.padding = (arg0) => {
      if (null != arg0) {
        if (typeof type$p === "function") {
          ...
          items = tmp6;
          let tmp = fn;
          tmp5 = f107630[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
  ...
  f107630 = (arg0, arg1) => {
    const items = [f107630(arg0[0], arg1[0]), f107630(arg0[1], arg1[1]), f107630(arg0[2], arg1[2])];
    return items;
  };
  blend.normal = (arg0, arg1) => {
    const obj = closure_2_206(arg1);
    const rgbResult = closure_2_206(arg1).rgb();
    return closure_2_206.rgb(f107630(rgbResult, closure_2_206(arg0).rgb()));
  };
      ...
      const item = values.forEach((item) => {
        ...
        if (c0) {
          if (typeof type$p === "function") {
            const _Object = Object;
            const call = toString.call;
            tmp2 = "object" === (f107630[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object");
            const tmp6 = f107630[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
  ...
  function limits(analyzeResult, arg1, arg2) {
    ...
    if (typeof type$p === "function") {
      ...
      tmp4 = f107630[typeof call === "unknown" ? toString(analyzeResult) : call(toString, analyzeResult)] || "object";
    } else {
      throw new TypeError("Trying to call a non-function");
    }
  }
  ...
  chroma$k.bezier = (arr) => {
    ...
    if (2 === mapped.length) {
      ...
      [f107630, type$p, type$p, last] = mapped3;
      fn = function a(arg0) {
        closure_0 = arg0;
        const items = [0, 1, 2];
      ...
      fn.hue = (arg0) => {
        if (null == arg0) {
          ...
          if (typeof type$p === "function") {
            ...
            tmp8 = fn;
            tmp3 = f107630[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
