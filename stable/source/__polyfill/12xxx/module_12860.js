// Module ID: 12860
// Function ID: 12861
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12800, 12815, 12797, 12861, 12825, 12828, 12829, 12801, 12854, 12812, 12862, 12823, 12806, 12837, 12856]
...
let items = [
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(12854).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12829).DEBUG_BUILD) {
        const logger = tmp2(12801).logger;
  ...
  },
  {
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      ...
      checkInId = ServerRuntimeClient(12812).uuid4();
    }
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        ...
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(12806).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(12806);
        } else {
          spanToTraceContextResult = tmp(12828).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(12828);
        }
        const tmpResult4 = ServerRuntimeClient(12837);
        if (_getSpanForScopeResult) {
