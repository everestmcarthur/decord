// Module ID: 12801
// Function ID: 12802
// Dependencies: [12802, 12800]

// Module 12801
import GLOBAL_OBJ from "module_12802" /* 12802 */;

const require = globalThis.__r;

function consoleSandbox(fn) {
  if ("console" in console(12802).GLOBAL_OBJ) {
    console = console(12802).GLOBAL_OBJ.console;
    dependencyMap = {};
...
export const logger = GLOBAL_OBJ.getGlobalSingleton("logger", function makeLogger() {
  ...
  if (require("module_12800").DEBUG_BUILD) {
