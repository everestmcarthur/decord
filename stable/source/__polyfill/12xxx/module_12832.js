// Module ID: 12832
// Function ID: 12833
// Dependencies: [718, 12828, 12833, 12834, 12806, 12815, 12823, 12816, 12801, 12818, 12829, 12835]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod12818.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod12815.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod12818.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
