// Module ID: 12807
// Function ID: 12808
// Dependencies: [12800, 12801, 12808, 12809, 12810]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(12808).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(12808);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod12809.htmlTreeAsString(arg0);
      const tmp2Result = _mod12809;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod12810.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod12810.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod12800.DEBUG_BUILD) {
        const logger = tmp7(12801).logger;
        const _HermesInternal = HermesInternal;
