// Module ID: 12906
// Function ID: 12907
// Dependencies: [718, 12797, 12800, 12801, 12815, 12825, 12829, 12833, 12883, 12806, 12835, 12816, 12834, 12872, 12818, 12814, 12808]
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod12872.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(12808).isInstanceOf(headers, Request);
        const tmpResult = tmp(12808);
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(12808).isInstanceOf(headers, Headers);
        const tmpResult2 = tmp(12808);
      }
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod12833.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12818).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12818);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(12818).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(12883).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12883);
    }
    const activeSpan = setHttpStatus(12806).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(12816).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(12816).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(12835).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(12835);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12833);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12834).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12806);
  }
};
