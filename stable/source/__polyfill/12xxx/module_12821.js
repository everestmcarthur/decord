// Module ID: 12821
// Function ID: 12822
// Dependencies: [41, 42, 12822, 12808, 12819, 12827]
...
function withScope(arg0) {
  const mainCarrier = AsyncContextStack(12819).getMainCarrier();
  const obj = AsyncContextStack(12819);
  const sentryCarrier = AsyncContextStack(12819).getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = tmp(12827).getDefaultCurrentScope();
    const tmpResult = tmp(12827);
    stack = new _moduleResult(defaultCurrentScope, tmp(12827).getDefaultIsolationScope());
...
function withIsolationScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = tmp(12827).getDefaultCurrentScope();
    const tmpResult = tmp(12827);
    stack = new closure_3(defaultCurrentScope, tmp(12827).getDefaultIsolationScope());
    const tmpResult2 = tmp(12827);
  }
  sentryCarrier.stack = stack;
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(12827).getDefaultCurrentScope();
      const tmp2Result = tmp2(12827);
      stack = new closure_2_3(defaultCurrentScope, tmp2(12827).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(12827);
    }
    sentryCarrier.stack = stack;
...
export function getStackAsyncContextStrategy() {
  return {
    ...
    withSetIsolationScope(arg0, arg1) {
      closure_0 = arg1;
      let mainCarrier = closure_0(12819).getMainCarrier();
      let obj = closure_0(12819);
      let sentryCarrier = closure_0(12819).getSentryCarrier(mainCarrier);
      let stack = sentryCarrier.stack;
      if (!stack) {
        let defaultCurrentScope = tmp(12827).getDefaultCurrentScope();
        const tmpResult = tmp(12827);
        stack = new closure_3(defaultCurrentScope, tmp(12827).getDefaultIsolationScope());
        const tmpResult2 = tmp(12827);
      }
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(12827).getDefaultCurrentScope();
        const tmpResult = tmp(12827);
        stack = new closure_1_3(defaultCurrentScope, tmp(12827).getDefaultIsolationScope());
        const tmpResult2 = tmp(12827);
      }
      sentryCarrier.stack = stack;
