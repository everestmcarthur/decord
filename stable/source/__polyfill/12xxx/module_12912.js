// Module ID: 12912
// Function ID: 12913
// Dependencies: [32, 5, 12799, 12913, 12807, 12802, 12815, 12808]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod12799;
      obj2.endTimestamp = 1000 * _mod12815.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12799.addHandler("fetch-body-resolved", arg0);
      ...
      closure_0(12807).fill(closure_0(12802).GLOBAL_OBJ, "fetch", (arg0) => {
        ...
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12799);
                    obj5.endTimestamp = 1000 * stack(12815).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12815);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12799);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12815).timestampInSeconds();
            obj2.error = error;
            ...
            if (tmp5) {
              ...
              const result = tmp(12807).addNonEnumerableProperty(error, "framesToPop", 1);
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_12799").addHandler("fetch", arg0);
