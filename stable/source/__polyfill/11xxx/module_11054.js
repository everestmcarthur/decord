// Module ID: 11054
// Function ID: 11055
// Dependencies: [5, 17, 11055, 11056, 11061, 11062, 11063, 11064, 11065]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11062 */;
import _modAll11063 from "module_11063" /* 11063 */;
import _modAll11064 from "module_11064" /* 11064 */;
import syncAll from "sync" /* 11065 */;
...
const subs = fn(11055).ProductType.subs;
const inapp = fn(11055).ProductType.inapp;
...
export const IapAndroid = _modAll11063;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11064;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11056).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11056.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11056.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11056.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11056.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11056.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11056).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11061).singleProductAndroidMap);
      return tmp2(11056).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11056).getAndroidModuleType();
      const androidModule = tmp2(11056).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11055).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11056).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11055).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11056).getAndroidModule();
            ...
            const androidModule1 = v3(11056).getAndroidModule();
