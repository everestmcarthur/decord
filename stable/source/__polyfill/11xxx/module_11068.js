...
export const useIAP = () => {
  const iAPContext = require("module_11069").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11054").requestPurchase,
    requestSubscription: require("module_11054").requestSubscription
  };
};
