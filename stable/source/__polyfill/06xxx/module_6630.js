// Module ID: 6630
// Function ID: 6631
// Dependencies: [32, 19, 17, 21, 1636, 6631, 6632, 6655, 6628, 6644, 38, 6638, 6808, 6810, 6813, 6815, 6819, 6822, 6826]
      ...
      if (initialPosition !== sharedValue2.value) {
        if (undefined !== initialPosition) {
          if (sharedValue13.value !== value22.ANIMATION_STATE.RUNNING) {
            ...
            iter.value = tmp18(6644).animate(obj);
            const tmp18Result2 = tmp18(6644);
          }
        }
      }
    };
    ...
    getEvaluatedPosition = function getEvaluatedPosition(arg0) {
      ...
      if (arg0 === value22.ANIMATION_SOURCE.KEYBOARD) {
        if (DEFAULT_KEYBOARD_BLUR_BEHAVIOR === tmp(6628).KEYBOARD_BLUR_BEHAVIOR.restore) {
          if (value3 === tmp(6628).KEYBOARD_STATE.HIDDEN) {
      ...
      if (keyboardBehavior === value22.KEYBOARD_BEHAVIOR.extend) {
        if (value3 === tmp(6628).KEYBOARD_STATE.SHOWN) {
          return value4;
        }
      }
