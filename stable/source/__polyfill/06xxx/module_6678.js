// Module ID: 6678
// Function ID: 6679
// Dependencies: [19, 21, 6679, 6700, 6705, 6701, 6706, 6707, 6690, 6703, 6702, 6708, 6709]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6690(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6690(current.viewRef) });
      return () => {
