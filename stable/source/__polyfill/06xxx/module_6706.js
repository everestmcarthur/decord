...
getHandler.__closure = { CALLBACK_TYPE: fn(6676).CALLBACK_TYPE };
...
touchEventTypeToCallbackType.__closure = { TouchEventType: fn(6663).TouchEventType, CALLBACK_TYPE: fn(6676).CALLBACK_TYPE };
...
const obj2 = { TouchEventType: fn(6663).TouchEventType, CALLBACK_TYPE: fn(6676).CALLBACK_TYPE };
runWorklet.__closure = { getHandler, tagMessage: fn(6660).tagMessage };
