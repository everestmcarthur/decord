// Module ID: 6693
// Function ID: 6694
// Dependencies: [41, 42, 93, 95, 98, 19, 6694, 6660, 6682, 6680]
...
import PlatformConstants from "module_6694" /* 6694 */;
...
const entry = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6660).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  entry,
