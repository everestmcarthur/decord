// Module ID: 6711
// Function ID: 6712
// Dependencies: [32, 19, 6712, 6723, 6714, 6727, 6698]
...
export const useJSResponderHandler = function useJSResponderHandler(gesture) {
  _require = gesture;
  let tmp = closure_3(require("module_6727").JSResponderContext);
  dependencyMap = tmp;
  ...
  closure_5(() => {
    ...
    const enabledSharedValues = gesture(6712).getEnabledSharedValues(Reanimated);
