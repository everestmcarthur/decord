// Module ID: 6797
// Function ID: 6798
// Dependencies: [17, 6628, 6635, 1636, 6798, 6799]
...
export const useGestureEventsHandlersDefault = () => {
  ...
  function handleOnChange(arg0, translationY) {
    ...
    if (sharedValue.value.initialPosition !== initialPosition) {
      ...
      animatedPosition.value = _mod6798.clamp(sum1, initialPosition, value3);
      const clampResult = _mod6798.clamp(sum1, initialPosition, value3);
    }
  ...
  function handleOnEnd(arg0, translationY) {
    ...
    const snapPointResult = _mod6799.snapPoint(translationY.translationY + sharedValue.value.initialPosition, velocityY, substr);
