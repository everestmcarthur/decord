...
wrappedSetGestureState.__closure = { tagMessage: fn(6660).tagMessage };
...
function create(handlerTag) {
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6661").State };
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("module_6661").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6661").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("module_6661").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6661").State };
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("module_6661").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6661").State };
...
create.__closure = { wrappedSetGestureState, State: fn(6661).State };
