// Module ID: 6682
// Function ID: 6683
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 6683, 6661, 6677, 6684, 6686, 6659, 6688, 6687, 6689, 6690, 6660, 6674]
// Exports: default

// Module 6682
import handlerIDToTag2 from "handlerIDToTag" /* 6659 */;
import tagMessage from "tagMessage" /* 6660 */;
import _mod6677 from "module_6677" /* 6677 */;
...
let closure_10 = { [fn(6661).State.UNDETERMINED]: undefined, [fn(6661).State.BEGAN]: "onBegan", [fn(6661).State.FAILED]: "onFailed", [fn(6661).State.CANCELLED]: "onCancelled", [fn(6661).State.ACTIVE]: "onActivated", [fn(6661).State.END]: "onEnded" };
    ...
    constructor(arg0) {
      ...
      tmp3Result.attachGestureHandler = (viewTag) => {
        ...
        if (!tmp6) {
          ...
          const result1 = tmp2(6686).scheduleFlushOperations();
          const tmp2Result = tmp2(6686);
          tmp2(6687).ghQueueMicrotask(() => {
