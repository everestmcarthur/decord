// Module ID: 10539
// Function ID: 10540
// Dependencies: [41, 42, 93, 95, 98, 10531, 10439, 10440, 10444]
...
const regExp = new RegExp("(dit|deze|vorig|afgelopen|(?:aan)?komend|over|\\+|-)e?\\s*(" + _mod10531.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = NLTimeUnitCasualRelativeFormatParser(10531).parseDuration(arg1[2]);
      if ("vorig" !== formatted) {
