// Module ID: 10624
// Function ID: 10625
// Dependencies: [41, 42, 93, 95, 98, 10437, 10625, 10464, 10444]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10625.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10464).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10625).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
