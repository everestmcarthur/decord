// Module ID: 10465
// Function ID: 10466
// Dependencies: [41, 42, 93, 95, 98, 10437, 10436, 10440, 10444]
...
const regExp = new RegExp("(this|last|past|next|after\\s*this)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10436.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ENRelativeDateFormatParser(10436).TIME_UNIT_DICTIONARY[str3];
      if ("next" != formatted) {
      ...
      const ParsingComponents2 = tmp(10440).ParsingComponents;
