// Module ID: 10534
// Function ID: 10535
// Dependencies: [41, 42, 93, 95, 98, 10437, 10531, 10438, 10444]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10531.MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + _mod10531.YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLMonthNameParser(10531).MONTH_DICTIONARY[arg1[1].toLowerCase(arg1[1])];
      parsingComponents.assign("month", tmp4);
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10531).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10438).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
