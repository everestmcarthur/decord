...
const regExp = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10436.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10436.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
