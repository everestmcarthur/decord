// Module ID: 10469
// Function ID: 10470
// Dependencies: [41, 42, 93, 95, 98, 10436, 10439, 10440, 10456]
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, text, start) {
      const parseDurationResult = ENMergeRelativeFollowByDateRefiner(10436).parseDuration(text.text);
      ...
      return new ENMergeRelativeFollowByDateRefiner(10440).ParsingResult(start.reference, text.index, "" + text.text + arg0 + start.text, relativeFromReference);
    }
  }
];
