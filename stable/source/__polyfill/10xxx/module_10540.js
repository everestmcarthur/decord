// Module ID: 10540
// Function ID: 10541
// Dependencies: [41, 42, 93, 95, 98, 10437, 10531, 10440, 10444]
...
const regExp = new RegExp("(dit|deze|(?:aan)?komend|volgend|afgelopen|vorig)e?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10531.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLRelativeDateFormatParser(10531).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp2(10440).ParsingComponents;
