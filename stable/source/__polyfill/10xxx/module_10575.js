// Module ID: 10575
// Function ID: 10576
// Dependencies: [41, 42, 93, 95, 98, 10461, 10443, 10568]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    _inherits(RUCasualTimeParser, _mod10568.AbstractParserWithLeftRightBoundaryChecking);
    const entry = {
                    ...
                    if (!str2.endsWith("\u0443\u0442\u0440\u0430")) {
                      if (str2.match(/в\s*полдень/)) {
                        ...
                        if (str2.match(/следующей\s*ночью/)) {
                          ...
                          RUCasualTimeParser(10443).assignSimilarDate(parsingComponents, date);
