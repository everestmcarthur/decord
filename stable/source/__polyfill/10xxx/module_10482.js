// Module ID: 10482
// Function ID: 10483
// Dependencies: [41, 42, 93, 95, 98, 10437, 10483, 10464, 10444]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:a[mn]\\s*?)?(?:(diese[mn]|letzte[mn]|n(?:\u00E4|ae)chste[mn])\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10483.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(diese|letzte|n(?:\u00E4|ae)chste)\\s*woche)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return DEWeekdayParser(10464).createParsingComponentsAtWeekday(reference.reference, DEWeekdayParser(10483).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
