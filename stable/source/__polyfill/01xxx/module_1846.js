// Module ID: 1846
// Function ID: 1847
// Dependencies: [5, 19, 21, 1636, 1844, 1847, 1830, 1826, 1626, 1848, 1849, 1850]
...
export default forwardRef((bottomOffset, arg1) => {
  ...
  const reanimatedFocusedInput = require("module_1830").useReanimatedFocusedInput();
  const input = reanimatedFocusedInput.input;
  const update = reanimatedFocusedInput.update;
  const obj10 = require("module_1830");
  ...
  closure_35 = tmp32;
  const items8 = [tmp32];
  const tmp33 = animatedRef(() => _mod1848.debounce(closure_35, 200), items8);
  closure_36 = tmp33;
  class N {
    constructor(arg0) {
      iter = closure_23;
  ...
  const obj23 = require("module_1849");
  class De {
    constructor() {
      return input.value;
    }
