...
export default {
  read(getUint8, sum) {
    const byteAt = _modDef5230.getByteAt(getUint8, sum);
    let num = 0;
    if (16 & byteAt) {
      num = 1;
    }
    ...
    obj3.Animation = obj4;
    sum = sum + c2;
    const byteAt1 = _modDef5230.getByteAt(getUint8, sum);
    const tmpResult = _modDef5230;
    const sum1 = byteAt1 + 256 * _modDef5230.getByteAt(getUint8, sum + 1);
