// Module ID: 5254
// Function ID: 5255
// Dependencies: [5213, 5255]

// Module 5254
import _mod5213 from "module_5213" /* 5213 */;
import iccTags from "iccTags" /* 5255 */;
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (uint323 > uint322) {
                  ...
                  if (tmp55(5255).iccTags[stringFromDataView]) {
                    ...
                    obj2[tmp55(5255).iccTags[stringFromDataView].name] = obj3;
                  } else {
                ...
                if (1 === uint324) {
                  ...
                  if (tmp25(5255).iccTags[stringFromDataView]) {
                    ...
                    obj2[tmp25(5255).iccTags[stringFromDataView].name] = obj9;
                  } else {
                  ...
                  if (iccTags.iccTags[stringFromDataView]) {
                    ...
                    obj2[tmp33(5255).iccTags[stringFromDataView].name] = obj12;
                  } else {
                ...
                if (tmp55(5255).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5255).iccTags[stringFromDataView].name] = obj14;
                } else {
                ...
                if (tmp55(5255).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5255).iccTags[stringFromDataView].name] = obj16;
                } else {
