// Module ID: 5679
// Function ID: 5680
// Dependencies: [32, 19, 17, 21, 1614, 5659, 5671, 5655, 5652, 5638, 1484]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5652.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
