    ...
    if (tmp < byteLength.byteLength) {
      while (true) {
        ...
        if (byteLength.getUint8(tmp) !== 28) {
          ...
          obj3.name = combined;
          obj3.value = items;
          obj3.description = getTagDescription(tmp8(5245).iptc[uint16], items, obj, encoding);
          ...
          if (tmp18) {
            let obj5 = tmp8(5245).iptc[uint16];
