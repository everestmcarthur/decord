...
const obj = {
  ...
  2: { name: "GPSLatitude", description: fn(5238).getCalculatedGpsValue },
  3: {
...
const obj3 = { name: "GPSLatitude", description: fn(5238).getCalculatedGpsValue };
...
const obj4 = { name: "GPSLongitude", description: fn(5238).getCalculatedGpsValue };
obj[27] = { name: "GPSProcessingMethod", description: fn(5238).getEncodedString };
const obj5 = { name: "GPSProcessingMethod", description: fn(5238).getEncodedString };
