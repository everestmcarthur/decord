  ...
  read(byteLength, arg1) {
    ...
    for (let num = 0; num < arg1.length; num = num + 1) {
      ...
      if (stringFromDataView === PNG_CHUNK_TYPE_SIZE.TYPE_PHYS) {
        ...
        let tmp28;
        if (tmp27) {
          let tmpResult9 = tmp(5230);
          let longAt2 = tmpResult9.getLongAt(byteLength, tmp26 + tmp3(5220).PNG_CHUNK_DATA_OFFSET + 4);
        ...
        let tmp32;
        if (tmp31) {
          let tmpResult10 = tmp(5230);
          let byteAt = tmpResult10.getByteAt(byteLength, tmp30 + tmp3(5220).PNG_CHUNK_DATA_OFFSET + 8);
        ...
        let tmp9;
        if (tmp8) {
          let tmpResult11 = tmp(5230);
          let shortAt = tmpResult11.getShortAt(byteLength, tmp34 + tmp3(5220).PNG_CHUNK_DATA_OFFSET);
          let tmpResult12 = tmp(5230);
          let byteAt1 = tmpResult12.getByteAt(byteLength, tmp34 + tmp3(5220).PNG_CHUNK_DATA_OFFSET + 2);
          let tmpResult13 = tmp(5230);
          let byteAt2 = tmpResult13.getByteAt(byteLength, tmp34 + tmp3(5220).PNG_CHUNK_DATA_OFFSET + 3);
          let tmpResult14 = tmp(5230);
          let byteAt3 = tmpResult14.getByteAt(byteLength, tmp34 + tmp3(5220).PNG_CHUNK_DATA_OFFSET + 4);
          let tmpResult15 = tmp(5230);
          let byteAt4 = tmpResult15.getByteAt(byteLength, tmp34 + tmp3(5220).PNG_CHUNK_DATA_OFFSET + 5);
          let tmpResult16 = tmp(5230);
          let byteAt5 = tmpResult16.getByteAt(byteLength, tmp34 + tmp3(5220).PNG_CHUNK_DATA_OFFSET + 6);
