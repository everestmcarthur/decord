// Module ID: 5248
// Function ID: 5249
// Dependencies: [32, 42, 41, 93, 95, 98, 158, 5213, 5249, 5250, 5251]

// Module 5248
import _wrapNativeSuperDefault from "_wrapNativeSuper" /* 158 */;
import _modDef5249 from "module_5249" /* 5249 */;
import calculateGPSValueDefault from "calculateGPSValue" /* 5251 */;
...
function parseNodeAsSimpleRdfDescription(attributes, key10005) {
  ...
  ParseError(5213).objectAssign(obj, obj4, obj6);
  const prop = iter.value["rdf:value"];
  const obj3 = ParseError(5213);
...
function parseNodeAsStructureRdfDescription(value, key10005) {
  ...
  if (undefined !== value.value["rdf:Description"]) {
    ...
    ParseError(5213).objectAssign(obj.attributes, obj6);
