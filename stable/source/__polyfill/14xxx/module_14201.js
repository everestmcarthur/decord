...
function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod14267.parseUnicodeLocaleId(arr3);
    ...
    if (region) {
      ...
      if (tmp4) {
        ...
        if (result) {
          ...
          obj3 = { lang: "und", script: "Array", region: "options", variants };
        }
  ...
  if (script) {
    ...
    const tmp5 = tmp(14267).likelySubtags[tmp(undefined, 14267).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
  ...
  if (region) {
    ...
    const tmp6 = tmp(14267).likelySubtags[tmp(undefined, 14267).emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
  ...
  if (!tmp7) {
    ...
    tmp7 = tmp(14267).likelySubtags[tmp(undefined, 14267).emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
...
const module_14202 = e.__importDefault(_mod14202);
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14267).emitUnicodeLanguageId(obj.__assign(Locale(1162).__assign({}, Locale(14267).parseUnicodeLanguageId(tmp2)), obj3));
            const parseUnicodeLocaleIdResult = Locale(14267).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (tmp(Locale(14267).emitUnicodeLanguageId(obj4)) === result) {
              ...
              const obj6 = { lang, script: "Array", region: "options", variants };
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = tmp3(14267).emitUnicodeLocaleId(tmp3Result.__assign(tmp3(1162).__assign({}, parseUnicodeLocaleIdResult), obj5));
              const __assignResult = tmp3(1162).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (tmp(tmp3(14267).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = tmp3(14267).emitUnicodeLocaleId(tmp3Result7.__assign(tmp3(1162).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (tmp(tmp3(14267).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = tmp3(14267).emitUnicodeLocaleId(tmp3Result9.__assign(tmp3(1162).__assign({}, parseUnicodeLocaleIdResult), obj11));
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14267).emitUnicodeLanguageId(Locale(14267).parseUnicodeLanguageId(module_14202.default(this).locale));
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_14202.default(this).calendar;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_14202.default(this).collation;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_14202.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_14202.default(this).numeric;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_14202.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14267).parseUnicodeLanguageId(module_14202.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14267).parseUnicodeLanguageId(module_14202.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14267).parseUnicodeLanguageId(module_14202.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_14202.default(this);
