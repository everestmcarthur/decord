// Module ID: 14048
// Function ID: 14049
// Dependencies: [41, 42, 14020, 14047, 14021, 14023, 14022, 14019, 14049]

// Module 14048
import _createClass from "_createClass" /* 42 */;
import LRUCache from "LRUCache" /* 14049 */;
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(14021).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(14021).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(14022)("hyphen replace", str);
        let str3 = str.replace(tmp11(14023).safeRe[tmp11(undefined, 14023).t.COMPARATORTRIM], tmp11(14023).comparatorTrimReplace);
        tmp11(14022)("comparator trim", str3);
        const str5 = str3.replace(tmp11(14023).safeRe[tmp11(undefined, 14023).t.TILDETRIM], tmp11(14023).tildeTrimReplace);
        tmp11(14022)("tilde trim", str5);
        let str7 = str5.replace(tmp11(14023).safeRe[tmp11(undefined, 14023).t.CARETTRIM], tmp11(14023).caretTrimReplace);
        tmp11(14022)("caret trim", str7);
        let parts = str7.split(" ");
        let mapped = parts.map((item) => {
          const options = self.options;
          if (typeof parseComparator === "function") {
            Range(14022)("comp", item, options);
            if (typeof replaceCarets === "function") {
              const parts = item.trim().split(/\s+/);
              const mapped = parts.map((item) => {
                if (typeof replaceCaret === "function") {
                  closure_0 = item;
                  self(14022)("caret", item, tmp);
                  const safeRe = self(14023).safeRe;
                  const t = self(14023).t;
                  if (tmp.loose) {
                  ...
                  return item.replace(tmp6, (arg0, str, str2, str3, arg4) => {
                    options(14022)("caret", closure_0, arg0, str, str2, str3, arg4);
              ...
              if (typeof replaceTildes === "function") {
                ...
                const mapped1 = parts1.map((item) => {
                  if (typeof replaceTilde === "function") {
                    ...
                    return item.replace(tmp5, (arg0, str, str2, str3, arg4) => {
                      options(14022)("tilde", closure_0, arg0, str, str2, str3, arg4);
                      if (typeof closure_2_9 === "function") {
                        let tmp5 = !str;
                        if (str) {
                          tmp5 = "x" === str.toLowerCase();
                          ...
                          if (typeof tmp4 === "function") {
                            ...
                            if (tmp6) {
                              ...
                              if (tmp7) {
                                ...
                                tmp(14022)("replaceTilde pr", arg4);
                                const _HermesInternal2 = HermesInternal;
                ...
                tmp2(14022)("tildes", str7);
                if (typeof replaceXRanges === "function") {
                  tmp2(14022)("replaceXRanges", str7, options);
                  ...
                  const mapped2 = parts2.map((item) => {
                    if (typeof replaceXRange === "function") {
                      ...
                      return str.replace(tmp5, (arg0, arg1, str, str2, str3, arg5) => {
                        let combined = arg0;
                        str = arg1;
                        options(14022)("xRange", str, arg0, arg1, str, str2, str3, arg5);
                        if (typeof closure_2_9 === "function") {
                          let tmp6 = !str;
                          if (str) {
                          ...
                          tmp2(14022)("xRange return", combined);
                          return combined;
                        } else {
                          throw new TypeError("Trying to call a non-function");
                        }
                  ...
                  tmp2(14022)("xrange", str10);
                  if (typeof replaceStars === "function") {
                    tmp2(14022)("replaceStars", str10, options);
                    const replaced = str10.trim().replace(tmp2(14023).safeRe[tmp2(undefined, 14023).t.STAR], "");
                    tmp2(14022)("stars", replaced);
                    return replaced;
                  } else {
                    throw new TypeError("Trying to call a non-function");
                  }
        ...
        let mapped1 = parts1.map((item) => {
          ...
          if (typeof replaceGTE0 === "function") {
            Range(14022)("replaceGTE0", item, options);
            const t = Range(14023).t;
            return item.trim().replace(Range(14023).safeRe[options.includePrerelease ? t.GTE0PRE : t.GTE0], "");
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        });
        ...
        if (loose) {
          found = mapped1.filter((item) => {
            Range(14022)("loose invalid filter", item, self.options);
            return item.match(Range(14023).safeRe[Range(undefined, 14023).t.COMPARATORLOOSE]);
          });
        }
        tmp11(14022)("range list", found);
        const _Map = Map;
        const map = new Map();
        let mapped2 = found.map((item) => new Range(14047)(item, self.options));
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(14019)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
...
function testSet(arg0, prerelease, options) {
  ...
  if (prerelease.prerelease.length) {
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          let tmp5 = Range(14022)(arg0[num2].semver);
          if (arg0[num2].semver !== Range(14047).ANY) {
