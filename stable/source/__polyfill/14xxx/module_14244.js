...
import data from "data" /* 14245 */;
import regions from "regions" /* 14246 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14245).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14245).data.supplemental.languageMatching["written-new"];
