  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14024).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(14024);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14024).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(14024);
      }
