// Module ID: 14377
// Function ID: 14378
// Dependencies: [14378, 14379, 1253, 14380]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14380.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14380.percentDecode(_Buffer.from(buffer));
  }
}
