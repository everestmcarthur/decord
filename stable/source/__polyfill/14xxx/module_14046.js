// Module ID: 14046
// Function ID: 14047
// Dependencies: [14019, 14023, 14018]
...
export default (num, arg1) => {
  if (num instanceof _mod14019) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14023).safeRe;
        const t2 = tmp(14023).t;
      ...
      if (null === match2) {
        ...
        return _mod14018("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
