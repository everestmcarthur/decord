...
obj.t = obj2;
const items3 = [["\\s", 1], , ];
const items4 = ["\\d", _mod14021.MAX_LENGTH];
items3[1] = items4;
const items5 = ["[a-zA-Z0-9-]", _mod14021.MAX_SAFE_BUILD_LENGTH];
items3[2] = items5;
_mod14022("NUMERICIDENTIFIER", 0, "0|[1-9]\\d*");
...
_mod14022("NUMERICIDENTIFIERLOOSE", 1, "\\d+");
...
_mod14022("NONNUMERICIDENTIFIER", 2, combined);
...
_mod14022("MAINVERSION", 3, combined1);
obj2.MAINVERSION = 3;
items2[3] = combined1;
...
_mod14022("MAINVERSIONLOOSE", 4, combined2);
...
_mod14022("PRERELEASEIDENTIFIER", 5, combined3);
...
_mod14022("PRERELEASEIDENTIFIERLOOSE", 6, combined4);
...
_mod14022("PRERELEASE", 7, combined5);
obj2.PRERELEASE = 7;
items2[7] = combined5;
...
_mod14022("PRERELEASELOOSE", 8, combined6);
...
_mod14022("BUILDIDENTIFIER", 9, combined7);
...
_mod14022("FULLPLAIN", 11, combined9);
obj2.FULLPLAIN = 11;
items2[11] = combined9;
...
_mod14022("LOOSEPLAIN", 13, combined11);
obj2.LOOSEPLAIN = 13;
...
_mod14022("XRANGEIDENTIFIERLOOSE", 16, combined13);
...
_mod14022("XRANGEIDENTIFIER", 17, combined14);
...
_mod14022("XRANGEPLAIN", 18, combined15);
obj2.XRANGEPLAIN = 18;
...
_mod14022("XRANGEPLAINLOOSE", 19, combined16);
...
_mod14022("XRANGE", 20, combined17);
obj2.XRANGE = 20;
...
_mod14022("XRANGELOOSE", 21, combined18);
obj2.XRANGELOOSE = 21;
...
items1[21] = regExp43;
const combined19 = "(^|[^\\d])(\\d{1," + _mod14021.MAX_SAFE_COMPONENT_LENGTH + "})(?:\\.(\\d{1," + _mod14021.MAX_SAFE_COMPONENT_LENGTH + "}))?(?:\\.(\\d{1," + _mod14021.MAX_SAFE_COMPONENT_LENGTH + "}))?";
const tmp104 = ((items2) => {
  let str = items2;
  while (tmp2 !== undefined) {
    let tmp5 = _slicedToArray(tmp3, 2);
...
_mod14022("COERCEPLAIN", 22, combined19);
obj2.COERCEPLAIN = 22;
...
_mod14022("COERCE", 23, combined20);
obj2.COERCE = 23;
...
_mod14022("COERCERTL", 25, items2[obj2.COERCE]);
obj2.COERCERTL = 25;
...
_mod14022("COERCERTLFULL", 26, items2[obj2.COERCEFULL]);
...
_mod14022("TILDETRIM", 28, combined21);
obj2.TILDETRIM = 28;
...
_mod14022("TILDELOOSE", 30, combined23);
obj2.TILDELOOSE = 30;
...
_mod14022("CARETTRIM", 32, combined24);
obj2.CARETTRIM = 32;
...
_mod14022("CARETLOOSE", 34, combined26);
obj2.CARETLOOSE = 34;
...
_mod14022("COMPARATORLOOSE", 35, combined27);
...
_mod14022("COMPARATOR", 36, combined28);
obj2.COMPARATOR = 36;
...
_mod14022("COMPARATORTRIM", 37, combined29);
...
_mod14022("HYPHENRANGE", 38, combined30);
obj2.HYPHENRANGE = 38;
...
_mod14022("HYPHENRANGELOOSE", 39, combined31);
...
_mod14022("GTE0PRE", 42, "^\\s*>=\\s*0\\.0\\.0-0\\s*$");
obj2.GTE0PRE = 42;
