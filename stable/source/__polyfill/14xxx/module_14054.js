// Module ID: 14054
// Function ID: 14055
// Dependencies: [14048, 14019, 14039]
...
export default (arg0, arg1) => {
  obj = new obj(14048)(arg0, arg1);
  const tmp3 = new obj(14019)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14019)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14019(semver.semver.version);
