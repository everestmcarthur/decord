// Module ID: 14056
// Function ID: 14057
// Dependencies: [14019, 14048, 14039, 14044, 14040, 14043, 14050, 14047]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14019")(arg0, arg3);
  const tmp4 = new require("module_14048")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14039);
    let tmpResult = tmp(14044);
    const tmpResult3 = tmp(14040);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14040);
      tmpResult = tmp(14043);
      tmpResult4 = tmp(14039);
  ...
  if (require("module_14050")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
