// Module ID: 8530
// Function ID: 8531
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8472, 8531, 8481]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ x1, y1, x2, y2 } = props);
    const merged = Object.assign(Line(8472).extract(this, props));
    obj.x1 = x1;
    obj.y1 = y1;
    obj.x2 = x2;
    obj.y2 = y2;
    const obj2 = Line(8472);
    const obj3 = {
      ref(arg0) {
