// Module ID: 8545
// Function ID: 8546
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8546, 8541, 8481]
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (points) => {
      ...
      if (points) {
        ...
        points.d = "M" + Polygon(8546)(points) + "z";
      }
      if (closure_0.root) {
...
const entry = {
  ...
  value: function render() {
    ...
    if (points) {
      const _HermesInternal = HermesInternal;
      combined = "M" + Polygon(8546)(points) + "z";
    }
    obj.d = combined;
    const merged = Object.assign(props);
    return jsx(Polygon(8541), { ref: this.refMethod, d: null });
  }
};
let items = [entry];
