// Module ID: 8528
// Function ID: 8529
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8470, 8529, 8472, 8481]
...
_inherits(SvgImage, _modDef8481);
const entry = {
  key: "render",
  value: function render() {
    ...
    const size = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: SvgImage(8470).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
    [tmp2, tmp3] = parts;
    const tmp6 = SvgImage(8470).meetOrSliceTypes[tmp3] || 0;
    size.align = SvgImage(8470).alignEnum[tmp2] || "xMidYMid";
    ...
    const tmp7 = SvgImage(8470).alignEnum[tmp2] || "xMidYMid";
    const merged = Object.assign(SvgImage(8472).withoutXY(this, props));
