// Module ID: 8461
// Function ID: 8462
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8462, 8463, 8464, 8465, 8469, 8470, 8471, 8481]

// Module 8461
import extractOpacityDefault from "extractOpacity" /* 8463 */;
import extractResponderDefault from "extractResponder" /* 8464 */;
import _modDef8469 from "module_8469" /* 8469 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8462).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8462).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8481);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8465).extractTransformSvgView(tmp);
      const obj3 = Svg(8465);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8470)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8471, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8469, {});
  }
};
let items = [entry];
