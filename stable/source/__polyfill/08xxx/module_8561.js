// Module ID: 8561
// Function ID: 8562
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8473, 8562, 8472, 8481]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8473).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8472).withoutXY(this, props));
