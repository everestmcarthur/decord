// Module ID: 8491
// Function ID: 8492
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8472, 8492, 8481]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, rx, ry } = props);
    const merged = Object.assign(Ellipse(8472).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.rx = rx;
    obj.ry = ry;
    const obj2 = Ellipse(8472);
    const obj3 = {
      ref(arg0) {
