// Module ID: 8543
// Function ID: 8544
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8465, 8535, 8544, 8470, 8481]
...
const entry = {
  ...
  value: function render() {
    ...
    const tmp3Result = Pattern(8465)(patternTransform);
    ...
    if (patternContentUnits) {
      num2 = tmp(8535)[patternContentUnits];
    }
    ...
    const tmp3 = Pattern(8465);
    const merged = Object.assign(size);
    const merged1 = Object.assign(tmp(8470)({ viewBox, preserveAspectRatio }));
    obj.children = children;
    return jsx(Pattern(8544), {
      ref(arg0) {
        return self.refMethod(arg0);
      }
    });
