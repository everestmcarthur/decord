// Module ID: 8559
// Function ID: 8560
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8465, 8473, 8479, 8472, 8560, 8556, 8481]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8473).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8481);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8473).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8472).withoutXY(self, tmp);
      ...
      const obj5 = {};
      const obj2 = TextPath(8472);
      const merged1 = Object.assign(withoutXYResult);
      return jsx(_modDef8560, {});
    } else {
      ...
      return jsx(_modDef8556, { ref: self.refMethod, children });
    }
