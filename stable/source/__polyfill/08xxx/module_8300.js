// Module ID: 8300
// Function ID: 8301
// Dependencies: [19, 17, 21, 113, 8301, 39, 38, 8303, 8304]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8303").container, require("module_8303").webView, style];
  const items4 = [require("module_8303").container, containerStyle];
