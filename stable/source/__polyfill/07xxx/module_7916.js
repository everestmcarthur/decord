// Module ID: 7916
// Function ID: 7917
// Dependencies: [32, 19, 17, 21, 1484, 1614, 5631, 7917, 4912, 7918, 7920, 7921, 7922, 7923]
...
function SceneView(arg0) {
  ...
  const frameSize = num6(5631).useFrameSize((width) => width.width > width.height);
  num6 = 0;
  if (!context) {
    let top;
  ...
  const obj4 = num6(5631);
  const frameSize1 = num6(5631).useFrameSize((arg0) => 56 + num6);
  const tmp8Result = num6(5631);
  let num7 = 2;
  const tmp8Result5 = num6(1484);
  [tmp17, tmp18] = noop.useState(frameSize1);
  dependencyMap = tmp18;
  const tmp16 = _slicedToArray(noop.useState(frameSize1), 2);
  const callback = obj3.useCallback(num6(7917).debounce(tmp18, 100), []);
  ...
  let eventResult;
  const headerConfigProps = num6(7918).useHeaderConfigProps(obj5);
  if (null == header) {
  ...
  const tmp8Result8 = num6(7918);
  obj20.children = closure_10(num6(5631).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5631).HeaderShownContext.Provider, obj20);
  obj13.children = items5;
  obj12.children = tmp38(num6(5631).HeaderHeightContext.Provider, obj13);
  obj10.children = closure_10(num6(7920).AnimatedHeaderHeightContext.Provider, obj12);
  obj9.children = closure_10(num6(4912).ScreenStackItem, obj10);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("module_7921").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("module_7921");
  const invalidPreventRemoveError = require("module_7922").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("module_7922");
  const modalRouteKeys = require("module_7923").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("module_5631").SafeAreaProviderCompat, obj4);
};
