// Module ID: 7025
// Function ID: 7026
// Dependencies: [32, 19, 17, 21, 7019, 7020, 1505, 7026, 7005, 5640, 7027, 7028, 7029, 7030]
// Exports: Card

// Module 7025
import PanGestureHandler from "PanGestureHandler" /* 7005 */;
...
export const Card = function Card(shadowEnabled) {
      ...
      if (ref7.current) {
        if (typeof getAnimateToValue === "function") {
          if (tmp5.current.closing) {
            let num2 = _mod7019.getDistanceForDirection(tmp9, tmp10, "rtl" === tmp11);
          } else {
            num2 = 0;
          }
          tmp7 = num2;
  ...
  let merged = Object.assign(flag2(7028).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
  if (typeof direction === "function") {
    ...
    items13[1] = tmp19(tmp18(7029).CardContent, obj12);
    obj9.children = items13;
    obj8.children = tmp17(tmp25, obj9);
    obj7.children = tmp19(tmp18(7005).PanGestureHandler, obj8);
    items5[2] = tmp19(tmp20.View, obj7);
    obj3.children = items5;
    return tmp17(flag2(7027).CardAnimationContext.Provider, obj3);
  } else {
    throw new TypeError("Trying to call a non-function");
  }
