// Module ID: 7014
// Function ID: 7015
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 7015, 7017, 5631, 7019, 7021, 7022, 7031, 7032]
...
let obj = { default: fn(7015).DefaultTransition, fade: fn(7015).ModalFadeTransition, fade_from_bottom: fn(7015).FadeFromBottomAndroid, fade_from_right: fn(7015).FadeFromRightAndroid, none: fn(7015).DefaultTransition, reveal_from_bottom: fn(7015).RevealFromBottomAndroid, scale_from_center: fn(7015).ScaleFromCenterAndroid, slide_from_left: fn(7015).SlideFromLeftIOS, slide_from_right: fn(7015).SlideFromRightIOS, slide_from_bottom: fn(7015).BottomSheetAndroid };
...
const entry = {
  ...
  value: function render() {
    ...
    obj4.children = items3.map((key, index) => {
      ...
      if (typeof getInterpolationIndex === "function") {
        ...
        if (typeof getIsModal === "function") {
          ...
          obj.children = React6(CardStack(7022).CardContainer, obj3);
    ...
    items2[1] = renderHeader(CardStack(7021).MaybeScreenContainer, obj4);
    obj.children = items2;
...
const entry1 = {
  ...
  value: function getDerivedStateFromProps(routes, routes2) {
    ...
    const modalRouteKeys = CardStack(7031).getModalRouteKeys(items1, {});
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 = cardStyleInterpolator === CardStack(7017).forModalPresentationIOS || "forModalPresentationIOS" === cardStyleInterpolator.name;
                let tmp10 = !tmp9;
                if (tmp9) {
