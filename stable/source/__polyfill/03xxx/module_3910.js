// Module ID: 3910
// Function ID: 3911
// Dependencies: [3812, 3882, 3896, 3883, 3650, 3813, 3651, 3654, 3655]
// Exports: default
    ...
    if (locale1.formatLong) {
      if (locale1.formatRelative) {
        ...
        if (isNaN(defaultResult4)) {
          ...
          return format.default(defaultResult1, locale1.formatRelative(str5, defaultResult5, subMilliseconds.default(defaultResult2, module_3813.default(defaultResult2)), obj), obj2);
        }
      } else {
