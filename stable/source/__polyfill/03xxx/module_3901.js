// Module ID: 3901
// Function ID: 3902
// Dependencies: [3813, 3826, 3650, 3899, 3900, 3896, 3651, 3655]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_3813.default(defaultResult5) - module_3813.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_3813.default(defaultResult5);
    }
  } else {
