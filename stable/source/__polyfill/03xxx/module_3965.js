...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("M" === arg1) {
      return _createSuperInternal(3958).mapValue(_createSuperInternal(3958).parseNumericPattern(_createSuperInternal(3959).numericPatterns.month, arg0), valueCallback);
    } else if ("MM" === arg1) {
      return _createSuperInternal(3958).mapValue(_createSuperInternal(3958).parseNDigits(2, arg0), valueCallback);
    } else if ("Mo" === arg1) {
      return _createSuperInternal(3958).mapValue(ordinalNumber.ordinalNumber(arg0, { unit: "month" }), valueCallback);
    } else if ("MMM" === arg1) {
