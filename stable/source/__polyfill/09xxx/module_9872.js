// Module ID: 9872
// Function ID: 9873
// Dependencies: [9873, 9875, 9877, 9878, 9879]

// Module 9872
import QR8bitByte from "QR8bitByte" /* 9873 */;
import QRRSBlock from "QRRSBlock" /* 9875 */;
import QRBitBuffer from "QRBitBuffer" /* 9877 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9878.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9878.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9878.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
