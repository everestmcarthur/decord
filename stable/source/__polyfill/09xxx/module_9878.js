// Module ID: 9878
// Function ID: 9879
// Dependencies: [9879, 9880, 9874]

// Module 9878
import _mod9874 from "module_9874" /* 9874 */;
import QRPolynomial from "QRPolynomial" /* 9879 */;
import array2 from "array2" /* 9880 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod9874.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(9874).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(9874).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(9874).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod9874.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(9874).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(9874).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(9874).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod9874.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(9874).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(9874).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(9874).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
