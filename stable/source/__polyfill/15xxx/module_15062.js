// Module ID: 15062
// Function ID: 15063
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8457, 9881]
...
import emptyFunction_mod from "module_9881" /* 9881 */;
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = tmp23(tmp24(8457).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = tmp23(tmp24(8457).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(8457).G, obj3);
      const items1 = [timestampProducer(CircularProgress(8457).Svg, size2), ];
