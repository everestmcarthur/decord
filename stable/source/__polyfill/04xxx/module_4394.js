...
// Module 4394
import _mod4395 from "module_4395" /* 4395 */;
...
function parse(str, delimiter) {
  ...
  while (null != match) {
    ...
    if (tmp3) {
      ...
      let obj = { name: tmp9, prefix: null, delimiter: null, optional: null, repeat: null, partial: null, asterisk: null, pattern: null };
      if (!str3) {
        str3 = "";
      }
      obj.prefix = str3;
