// Module ID: 4393
// Function ID: 4394
// Dependencies: [19, 4389, 1107, 1108, 4394, 4396, 4398, 1101]
...
import parse_mod from "module_4394" /* 4394 */;
import AsyncMode from "AsyncMode" /* 4396 */;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F125607 */ function() { ... });
            },
        get() {
              return value;
            },
