// Module ID: 4949
// Function ID: 4950
// Dependencies: [32, 109, 19, 17, 21, 4950, 4925, 4951, 4952, 4954]
// Exports: default
...
export default function TabsHost(onNativeFocusChange) {
  onNativeFocusChange(4950).bottomTabsDebugLog("TabsHost render");
  ...
  const obj = onNativeFocusChange(4950);
