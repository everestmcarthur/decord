// Module ID: 4388
// Function ID: 4389
// Dependencies: [19, 4389, 1107, 1108, 1101, 4392]
...
export const MemoryRouter = Component2(4392).MemoryRouter;
export const Prompt = Component2(4392).Prompt;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4392).matchPath(_location.pathname, obj2);
          const obj = Component2(4392);
        }
