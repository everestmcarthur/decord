...
// Function ID: 8779
// Name: SKUPreview
// Dependencies: [19, 17, 7546, 1074, 21, 4560, 8779, 576, 8172, 8803, 1889, 8816, 8805, 8828, 8830, 8831, 4262, 4271, 1369, 2]
// Exports: default

// Module 8778 (SKUPreview)
...
import WishlistItemCardBase from "WishlistItemCardBase" /* 8779 */;
...
function CollectiblesSKUPreview(sku) {
  ...
  if (DEFAULT_ITEM_SIZE === undefined) {
    DEFAULT_ITEM_SIZE = sku(8779).DEFAULT_ITEM_SIZE;
  }
  const items = [sku];
...
let size = { width: fn(8779).DEFAULT_ITEM_SIZE, height: fn(8779).DEFAULT_ITEM_SIZE };
size = fn(2);
