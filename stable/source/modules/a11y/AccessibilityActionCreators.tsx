...
// Dependencies: [4552, 1074, 1938, 1084, 573, 1242, 9364, 2]
...
export const setPrefersReducedMotion = function setPrefersReducedMotion(reduce) {
  ...
  if (!useReducedMotion) {
    if (useReducedMotion2) {
      ...
      const result = tmp(9364).applySettingsOverride(obj3);
      const tmpResult = tmp(9364);
    }
  }
  if (useReducedMotion) {
  ...
  if (useReducedMotion) {
    const result1 = tmp(9364).clearSettingsOverride("gifAutoPlay", "animateEmoji", "animateStickers");
