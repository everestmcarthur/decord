...
const obj2 = { wrapper: { position: "relative", backgroundColor: fn(12478).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 }, progress: null };
let obj3 = { position: "relative", backgroundColor: fn(12478).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 };
...
export default function GuildProgressBar(percent) {
  ...
  obj4.style = items2;
  obj3.children = jsx(sharedValue(4296).View, { style: null });
