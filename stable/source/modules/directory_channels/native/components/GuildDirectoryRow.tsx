...
// Dependencies: [5, 32, 19, 17, 1957, 1979, 1074, 21, 4560, 576, 504, 7342, 5520, 9836, 1187, 1396, 1114, 5607, 5584, 1971, 4556, 12317, 4975, 2]
...
export default noop.memo(function GuildDirectoryRow(entry) {
  ...
  if (null != approximatePresenceCount) {
    ...
    items3[1] = tmp9(tmp2(4556).Text, obj13);
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(4556).Text, obj20);
  }
  items7[1] = tmp9Result;
  ...
  items7[3] = closure_10(entry(4975).Button, obj22);
  obj5.children = items7;
  obj4.children = closure_12(View, obj5);
  return closure_10(entry(5607).Card, obj4);
});
