...
obj.placeholderText = { height: 15, borderRadius: 5, backgroundColor: fn(5441).DARK_PRIMARY_500_LIGHT_PRIMARY_230 };
obj.placeholderBody = { width: "100%", marginTop: 10 };
let closure_5 = createStyles.createStyles(obj);
let obj3 = { height: 15, borderRadius: 5, backgroundColor: fn(5441).DARK_PRIMARY_500_LIGHT_PRIMARY_230 };
size = fn(2);
