...
// Dependencies: [19, 17, 1385, 1979, 1371, 21, 4560, 1611, 11733, 9251, 504, 8182, 5584, 4556, 1114, 5123, 8180, 1178, 7150, 2]
// Exports: default
...
export default function AppInteractionInfoActionSheet(message) {
  ...
  if (interactionMetadata != null) {
    tmp5 = interactionMetadata.authorizing_integration_owners[message(undefined, 9251).ApplicationIntegrationType.USER_INSTALL];
  }
  dependencyMap = tmp5;
  const interactionMetadata2 = message.interactionMetadata;
  let tmp7;
  if (interactionMetadata2 != null) {
    tmp7 = interactionMetadata2.authorizing_integration_owners[message(undefined, 9251).ApplicationIntegrationType.GUILD_INSTALL];
  }
  noop = tmp7;
  ...
  if (null != stateFromStores1) {
    ...
    const obj6 = { guild: stateFromStores1, size: tmp10(5584).GuildIconSizes.SMALL_32 };
    const items5 = [closure_8(tmp2(5584), obj6), ];
    ...
    const items6 = [closure_8(tmp10(4556).Text, obj8), ];
    ...
    items6[1] = closure_8(tmp10(4556).Text, obj9);
    ...
    if (null != stateFromStores) {
      ...
      const items8 = [closure_8(tmp10(4556).Text, obj15), ];
      ...
      items8[1] = closure_8(tmp10(4556).Text, obj16);
      obj14.children = items8;
      items7[1] = closure_9(id, obj14);
      obj12.children = items7;
      obj11.children = closure_9(id, obj12);
      tmp26 = closure_8(tmp10(5123).PressableOpacity, obj11);
    }
  }
  ...
  if (null != tmp15) {
    ...
    const items11 = [closure_8(tmp10(4556).Text, obj23), ];
    ...
    items11[1] = closure_8(tmp10(4556).Text, obj24);
    obj22.children = items11;
    items10[1] = tmp31(id, obj22);
    obj20.children = items10;
    obj19.children = tmp31(id, obj20);
    tmp32 = closure_8(tmp10(5123).PressableOpacity, obj19);
  }
  items9[1] = tmp32;
  obj18.children = items9;
  return closure_9(message(7150).BottomSheet, obj18);
};
