...
// Dependencies: [1074, 8365, 1242, 8366, 1365, 1115, 5568, 2]
// Exports: getMediaShareParams, resolveShareFileExtension, trackAppClickInNativeShareSheet

// Module 8364 (ShowShareActionSheetUtils)
    ...
    if (true !== source.disableDownload) {
      if (null != source.shareURI) {
        if (obj11.isDiscordDirectAssetUrl(source.shareURI)) {
          ...
          if (null != videoURI) {
            const decideFileExtensionResult = tmp(5568).decideFileExtension(videoURI, contentType, true);
