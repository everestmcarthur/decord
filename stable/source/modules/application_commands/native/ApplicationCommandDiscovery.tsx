...
// Dependencies: [32, 19, 17, 4999, 12399, 10268, 1074, 21, 12400, 4560, 576, 4982, 12401, 9422, 1894, 9304, 4272, 1114, 4740, 12, 12402, 7523, 12403, 12404, 1178, 10423, 2]
// Exports: default
...
import ApplicationSectionHeader from "ApplicationSectionHeader" /* 12400 */;
import ApplicationCommandDiscoveryManager from "ApplicationCommandDiscoveryManager" /* 12401 */;
import ApplicationCommandsCategoriesDefault from "ApplicationCommandsCategories" /* 12402 */;
...
export default function ApplicationCommandDiscovery(channel) {
  ...
  const discovery = channel(9422).useDiscovery(obj5);
  ...
  obj9.renderSectionHeader = function renderSectionHeader(section) {
    ...
    if (tmp3Result) {
      const obj3 = { lightSource: tmp4(10423), darkSource: tmp4(10423), body: null, containerStyle: null, imageStyle: null };
      const intl = util.intl;
