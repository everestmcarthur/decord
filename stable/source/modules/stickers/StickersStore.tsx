        ...
        if (arg0 === 1) {
          ...
          if (Loaded === Unloaded.Unloaded) {
            ...
            if (null != databaseResult) {
              ...
              c2 = 1;
              c3 = 1;
              const obj6 = { value: TryLoad.tryLoadOrResetCacheGatewayAsync("StickerStore.loadSavedGuildStickers", async () => closure_1(10).timeAsync("\u{1F4BE}", "loadSavedGuildStickers", async () => closure_2_1(5505).getAsync(closure_1_0))), done: false };
              return obj6;
            }
          }
          c3 = 3;
