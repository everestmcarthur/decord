...
// Dependencies: [19, 17, 7237, 1074, 1373, 21, 10414, 1114, 576, 10415, 10416, 4560, 1178, 4556, 573, 7419, 9370, 1477, 7162, 4994, 1242, 9398, 5123, 6992, 10417, 2]
// Exports: default
...
export default function StickersPremiumUpsellAlert(arg0) {
  ...
  const tmp5 = analyticsLocations(9370)(PREMIUM_MONTH_TIER_2.PREMIUM_MONTH_TIER_2);
  let priceString;
  if (tmp5 != null) {
  ...
  obj3.children = closure_14(native.Icon, { source: analyticsLocations(6992) });
  ...
  const obj4 = { source: analyticsLocations(6992) };
  ...
  const obj6 = { source: analyticsLocations(10417), style: tmp.imageHeader };
