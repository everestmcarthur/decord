...
// Dependencies: [5, 32, 19, 17, 1979, 1371, 5502, 10278, 1074, 7151, 21, 4560, 1115, 576, 10392, 10240, 10246, 4527, 4556, 1114, 10393, 4259, 504, 1477, 1242, 10406, 4975, 10408, 10394, 10399, 4218, 7189, 1935, 4899, 10410, 1896, 4740, 5520, 10411, 7382, 10181, 8678, 9975, 10412, 8599, 10347, 7150, 2]
...
function UnavailableStickerDetail(arg0) {
  ...
  const callback = obj2.useCallback(() => {
    if (null != stickerAssetUrl) {
      ...
      obj.openLazy(asyncRequireImpl(10410, dependencyMap.paths), "StickerOptionsActionSheet", obj2, "stack");
    }
  }, items1);
...
function GuildStickerDetail(sticker) {
  ...
  const callback = obj.useCallback((arg0) => {
    ...
    if (arg0) {
      let StarOutlineIcon = tmp9(10240).StarIcon;
    } else {
      StarOutlineIcon = tmp9(10246).StarOutlineIcon;
    }
...
export default noop.memo(function StickerDetailActionSheet(chatInputRef) {
  ...
  if (null == first) {
    ...
    return tmp6(tmp2(7150).BottomSheet, obj3);
  }
