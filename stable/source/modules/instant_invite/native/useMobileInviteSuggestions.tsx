...
// Dependencies: [32, 19, 2021, 1979, 9839, 4584, 7736, 1074, 1085, 504, 1242, 9852, 9853, 2]
// Exports: default

// Module 9838 (useMobileInviteSuggestions)
...
export default function useMobileInviteSuggestions(arg0, _location, arg2, application_id) {
  ...
  const effect1 = rows.useEffect(() => {
    ...
    if (isGuildVoiceResult) {
      ...
      isGuildVoiceResult = closure_0(9852).getGuildMembersInMobileVCInvitesExperiment(obj2);
      const obj = closure_0(9852);
    }
    if (dependencyMap !== constants.EMBEDDED_APPLICATION) {
      if (!isGuildVoiceResult) {
      ...
      const inviteSuggestions = closure_0(9853).loadInviteSuggestions(obj4);
      const obj3 = closure_0(9853);
