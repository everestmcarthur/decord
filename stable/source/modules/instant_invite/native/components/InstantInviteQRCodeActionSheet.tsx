...
// Dependencies: [19, 17, 1979, 1371, 1074, 21, 4560, 576, 5584, 504, 1114, 573, 4258, 7198, 7149, 9870, 4556, 2]
// Exports: default

// Module 9869 (InstantInviteQRCodeActionSheet)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import GuildIconDefault from "GuildIcon" /* 5584 */;
import components_native_QRCodeDefault from "components_native/QRCode" /* 9870 */;
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != GuildStore.getGuild(channel2.guild_id)) {
        const obj4 = { guild: obj8.getGuild(channel2.guild_id), size: tmp6(5584).GuildIconSizes.LARGE };
    ...
    obj5.header = closure_9(tmp6(7149).BottomSheetTitleHeader, obj6);
    ...
    if (tmp19Result2) {
      ...
      tmp19Result2 = tmp19(tmp6(4556).Text, obj13);
    }
    items3[1] = tmp19Result2;
    obj7.children = items3;
    obj5.children = closure_10(View, obj7);
    return closure_9(tmp6(7198).ActionSheet, obj5);
  }
  tmp12 = null;
