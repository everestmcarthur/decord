...
// Dependencies: [32, 19, 17, 9862, 21, 4560, 576, 4982, 6655, 9896, 8098, 9060, 2]

// Module 9861 (InstantInviteShareApps)
...
const InstantInviteConstants = fn(9862);
...
export default noop.memo(function InstantInviteShareApps(onItemPressed) {
  ...
  closure_1 = onItemPressed(4982).useFontScale();
