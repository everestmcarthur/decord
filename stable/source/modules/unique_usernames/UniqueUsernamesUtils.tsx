...
// Module 14714 (UniqueUsernamesUtils)
...
export const formatUsernameLiveCheckValidation = function formatUsernameLiveCheckValidation(arg0) {
  ...
  const obj2 = { error: _mod4745.P.nullish };
  return withResult3.with({ error: _mod4745.P.nullish }, () => ({ type: UniqueUsernamesTypes.NameValidationState.INTERNAL_ERROR, message: "" })).otherwise(() => {
