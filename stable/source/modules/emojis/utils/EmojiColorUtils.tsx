...
// Dependencies: [4409, 4410, 672, 7783, 2]
// Exports: buildEmojiColorPalette

// Module 7958 (EmojiColorUtils)
...
function buildPlatformedThemedEmojiColorPalette(shouldProcessMobileColors) {
  ...
  if (null != colors) {
    ...
    if (colors.length >= 1) {
      ...
      palette = null;
      if (null != color) {
        const rawRgbToHslResult = tmp2(4409).rawRgbToHsl(color.red, color.blue, color.green);
        const tmp2Result = tmp2(4409);
        const obj3 = { foreground: null, background: null, ratio: 3, saturationFactor: null };
        const tmp2Result9 = tmp2(4409);
        ...
        const tmp11 = c4;
        const tmp2Result12 = tmp2(4409);
        const obj5 = { foreground: tmp5(672)(findColorByHsvResult), background: tmp5(672)(tmp8), ratio: 7, saturationFactor };
        const accessibleForegroundColor2 = tmp2(4409).getAccessibleForegroundColor(obj5);
        const tmp2Result13 = tmp2(4409);
        const obj6 = { foreground: tmp5(672)(findColorByHsvResult), background: tmp5(672)(tmp11), ratio: 7, saturationFactor };
        const accessibleForegroundColor3 = tmp2(4409).getAccessibleForegroundColor(obj6);
        let hexResult;
        ...
        const tmp2Result14 = tmp2(4409);
        const obj8 = { colorRGB: accessibleForegroundColor, saturationFactor };
        obj7.backgroundColor = tmp2(4409).getSaturatedColorHex(obj8);
        ...
        const tmp2Result15 = tmp2(4409);
        const obj11 = { colorRGB: accessibleForegroundColor1, saturationFactor };
        obj10.backgroundColor = tmp2(4409).getSaturatedColorHex(obj11);
