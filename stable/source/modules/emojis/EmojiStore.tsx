...
// Function ID: 5460
// Name: EmojiStore
// Dependencies: [32, 5, 4476, 5460, 2025, 1221, 2021, 1959, 2015, 1979, 5438, 1371, 5461, 5462, 1374, 1074, 5463, 1084, 4213, 5464, 11, 12, 1090, 1986, 2006, 10, 5465, 573, 4597, 38, 4547, 1369, 5466, 5467, 5499, 4190, 4153, 504, 4217, 4216, 2]
...
import Frecency_mod from "Frecency" /* 4597 */;
        ...
        if (arg0 === 1) {
          ...
          if (Loading === __initData8.Unloaded) {
            ...
            if (null != databaseResult) {
              ...
              c2 = 1;
              c3 = 1;
              const obj6 = { value: React(2006).tryLoadOrResetCacheGatewayAsync("EmojiStore.loadSavedEmojis", async () => closure_1(10).timeAsync("\u{1F4BE}", "loadSavedEmojis", async () => closure_2_1(5465).getAsync(closure_1_0))), done: false };
              return obj6;
            }
          }
          c3 = 3;
