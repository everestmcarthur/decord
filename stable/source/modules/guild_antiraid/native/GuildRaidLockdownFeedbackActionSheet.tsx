...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  obj7.header = closure_6(guildId(7149).BottomSheetTitleHeader, obj8);
  ...
  if (hasItem) {
    ...
    hasItem = tmp7(tmp5(7085).TextArea, obj11);
  }
  items1[1] = hasItem;
  const obj12 = {
    onPress() {
  ...
  items1[2] = closure_6(guildId(4975).Button, obj12);
  obj9.children = items1;
  obj7.children = tmp8(tmp9, obj9);
  return closure_6(guildId(7198).ActionSheet, obj7);
};
