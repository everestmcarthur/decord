...
// Dependencies: [5, 2025, 13708, 9072, 1074, 1114, 1369, 7341, 1242, 17830, 1256, 2]
...
// Module 17831 (GlobalDiscoveryServersUtils)
...
import GlobalDiscoveryServersFeaturedSearchManagerDefault from "GlobalDiscoveryServersFeaturedSearchManager" /* 17830 */;
...
const GlobalDiscoveryServersConstants = fn(9072);
...
export const fromDiscoverableGuildSearchResult = function fromDiscoverableGuildSearchResult(id) {
  const obj = { id: id.id, name: id.name, description: id.description, splash: id.splash, banner: id.banner, icon: id.icon, features: new Set(id.features), presenceCount: null, memberCount: null, premiumSubscriptionCount: "r", preferredLocale: "padding", discoverySplash: "<string:1645936644>", emojis: "<string:1061224450>" };
