...
// Dependencies: [19, 17, 4552, 2021, 1371, 7306, 1074, 1085, 21, 4560, 576, 504, 7781, 5004, 5520, 4556, 1114, 4404, 7311, 4793, 11, 1178, 7889, 7962, 2]
...
function MessageContent(arg0) {
  ...
  const subscribeGuildMembers = message(7311).useSubscribeGuildMembers({ [thread.guild_id]: items }, "ThreadBrowserRowSubtext");
  ...
  obj7.children = closure_9(message(4556).Text, obj8);
...
export const ThreadSubtext = function ThreadSubtext(thread) {
  ...
  const obj2 = id(7781);
  const timestampString = id(7781).getTimestampString(lastMessageTimestamp);
  const tmpResult = id(7781);
  const tmpResult2 = id(7781);
  return closure_9(closure_14, { thread, timestamp: timestampString, accessibilityLabel: id(7781).getTimestampAccessibilityLabel(lastMessageTimestamp) });
};
