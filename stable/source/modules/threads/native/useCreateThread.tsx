...
// Dependencies: [5, 19, 4901, 4553, 7162, 9311, 7456, 7682, 9315, 9313, 7839, 5179, 5134, 9316, 2]
...
export default function useCreateThread(arg0) {
  ...
  return analyticsLocations(9311).useCreateThreadCommon({
    parentChannel,
    parentMessageId,
    threadSettings,
    privateThreadMode,
