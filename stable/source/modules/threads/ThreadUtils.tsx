...
// Function ID: 7782
// Name: ThreadUtils
// Dependencies: [109, 4575, 4741, 4201, 1113, 1074, 1114, 7499, 4740, 1242, 7774, 7114, 1384, 504, 11, 4153, 2]
...
export const trackThreadNotificationSettingsUpdated = function trackThreadNotificationSettingsUpdated(getGuildId, flags) {
  ...
  if (null != result) {
    ...
    const currentChannelSettings = tmp(7114).getCurrentChannelSettings(guildId, parent_id);
    ...
    let result1 = tmp(7114).muteConfigToTimestamp(obj7.getMuteConfig(getGuildId.id));
    ...
    if (null != flags.mute_config) {
      ...
      const tmpResult4 = tmp(7114);
    }
    obj2.new_thread_muted_until = result1;
    const tmpResult3 = tmp(7114);
