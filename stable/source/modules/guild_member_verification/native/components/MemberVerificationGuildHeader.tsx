...
// Dependencies: [19, 17, 5573, 21, 4560, 576, 1396, 5583, 1611, 4296, 4987, 5584, 5590, 4556, 1114, 2]
// Exports: default

// Module 5582 (MemberVerificationGuildHeader)
...
export default function MemberVerificationGuildHeader(hasManualFormFields) {
  ...
  if (null != guild.banner) {
    ...
    tmp3 = top;
    guildBannerSource = require("module_5583");
    tmp5 = importDefault;
  }
