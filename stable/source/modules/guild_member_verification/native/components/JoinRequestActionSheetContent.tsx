...
// Dependencies: [19, 17, 1957, 7151, 7208, 21, 4560, 576, 8242, 8231, 8228, 8239, 8180, 16581, 8247, 8257, 11116, 13064, 13121, 504, 12637, 4383, 4975, 5071, 1114, 4384, 9036, 4556, 6616, 4242, 11, 4520, 5433, 8098, 4511, 4513, 1611, 16584, 2]
...
function OpenInterviewButton(arg0) {
  ...
  if (!obj3.isActionedApplicationStatus(joinRequest.applicationStatus)) {
    ...
    obj4.icon = closure_8(tmp(5071).ChatIcon, obj5);
    if (label == null) {
    ...
    let tmp6Result = closure_8(tmp(4975).Button, obj4);
  } else {
    tmp6Result = null;
  }
  return tmp6Result;
...
let closure_12 = noop.memo((user) => {
  ...
  const tmp3 = joinRequest(8242)();
  const tmp4 = joinRequest(8231)(ACTION_SHEET_MAX_WIDTH);
  ({ primaryColor, secondaryColor, theme } = joinRequest(8228)({ user, displayProfile }));
  const tmp5 = joinRequest(8228)({ user, displayProfile });
  const tmp6 = user;
  const userProfileColors = user(8239).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null != user) {
    ...
    const items1 = [closure_8(tmp(8247), obj3), ];
    ...
    obj5.onPress = tmp8;
    const items2 = [closure_8(tmp(8257), obj5), ];
    ...
    const items4 = [closure_8(tmp6(13064).PrimaryInfo, obj10), ];
    const obj11 = { user };
    items4[1] = closure_8(tmp(13121), obj11);
    obj9.children = items4;
    obj7.children = closure_9(View, obj9);
    items2[1] = closure_8(tmp(11116), obj7);
    obj4.children = items2;
    items1[1] = closure_9(View, obj4);
    obj2.children = items1;
    tmp9 = closure_9(closure_10, obj2);
    const tmpResult = tmp(11116);
  }
  return tmp9;
});
let closure_14 = noop.memo((joinRequest) => {
  ...
  if (applicationStatus === MemberVerificationTypes.GuildJoinRequestApplicationStatuses.SUBMITTED) {
    if (null != joinRequest.interviewChannelId) {
      ...
      const items = [React6(tmp2(9036).HourglassIcon, obj4), ];
      ...
      obj5.children = React6(tmp2(4556).Text, obj6);
  ...
  if (MemberVerificationTypes.GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
    ...
    const items2 = [React6(tmp2(6616).CircleXIcon, obj10), ];
    ...
    const items3 = [React6(tmp2(4556).Text, obj11), , ];
    ...
    if (null != actionedByUser) {
      ...
      if (null != actionedAt) {
        ...
        const items4 = [tmp20(tmp2(4556).Text, obj13), , ];
        ...
        items4[2] = tmp20(tmp2(4556).Text, obj16);
    ...
    if (tmp20Result) {
      ...
      tmp20Result = tmp20(tmp2(4556).Text, obj17);
    }
    ...
    const items6 = [React6(tmp2(4520).CircleCheckIcon, obj22), ];
    ...
    const items7 = [React6(tmp2(4556).Text, obj23), ];
    let tmp6Result = null;
    if (null != actionedByUser) {
      tmp6Result = null;
      if (null != actionedAt) {
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const joinRequestButtonActions = joinRequest(12637).useJoinRequestButtonActions(joinRequest, joinRequest.interviewChannelId, callback);
  ...
  const obj = joinRequest(12637);
  const tmp5 = closure_9;
  obj2.icon = closure_8(joinRequest(4511).CheckmarkLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" });
  ...
  const children = [closure_8(joinRequest(8098).IconButton, obj2), , ];
  ...
  obj4.icon = closure_8(joinRequest(4513).XLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" });
  const intl2 = joinRequest(1114).intl;
  obj4.label = intl2.string(joinRequest(1114).t.hDtbsz);
  obj4.onPress = rejectRequest;
  obj4.disabled = submitting;
  children[1] = closure_8(joinRequest(8098).IconButton, obj4);
  ...
  if (tmp6Result) {
    ...
    obj6.icon = tmp6(tmp2(5071).ChatIcon, obj7);
    const intl3 = tmp2(1114).intl;
    obj6.label = intl3.string(tmp2(1114).t.KQeYoC);
    obj6.onPress = handleOpenInterview;
    obj6.disabled = submitting;
    tmp6Result = tmp6(tmp2(8098).IconButton, obj6);
  }
  children[2] = tmp6Result;
  return tmp5(joinRequest(5433).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
let closure_16 = noop.memo((arg0) => {
  ...
  if (MemberVerificationTypes.VerificationFormFieldTypes.TERMS === field_type) {
    ...
    const items1 = [React6(tmp2(4556).Text, obj3), ];
    ...
    items1[1] = React6(tmp2(4520).CircleCheckIcon, obj4);
    obj2.children = items1;
    return React7(View, obj2);
    ...
    const items2 = [React6(tmp2(4556).Text, obj5), ];
    ...
    obj6.children = React6(tmp2(4556).Text, obj8);
    ...
    const items4 = [React6(tmp2(4556).Text, obj9), ];
    ...
    obj10.children = React6(tmp2(4556).Text, obj11);
