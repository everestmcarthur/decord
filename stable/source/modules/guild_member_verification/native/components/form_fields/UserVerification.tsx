...
export default function UserVerification(arg0) {
  ...
  if (null == field.platform) {
    ...
    if (tmp5) {
      const obj = { passesVerification: verification[tmp12(undefined, 4384).UserVerificationFieldPlatforms.PHONE], platform: tmp12(4384).UserVerificationFieldPlatforms.PHONE };
