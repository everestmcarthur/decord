...
// Dependencies: [32, 19, 17, 4901, 4900, 21, 4560, 576, 504, 1477, 1483, 6981, 11151, 7864, 1114, 9313, 11244, 7085, 10929, 2]
// Exports: default
    ...
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = channelId(stateFromStores[13]).getRenderHeaderTextButton(intl.string(channelId(stateFromStores[14]).t["R3BPH+"]), () => {
          ...
          id(9313).update(closure_1_0, closure_1_1, ChannelMessage.ChannelMessage, obj2);
          const obj = id(9313);
          id(11244).close();
        });
