...
// Function ID: 9444
// Name: oauth2/Header
// Dependencies: [19, 17, 1074, 21, 4560, 576, 1396, 1178, 4556, 9444, 1384, 1114, 2]
// Exports: default

// Module 9443 (oauth2/Header)
...
export default function Header(accountScopes) {
  ...
  if (null != bot) {
    ...
    tmp8Result = tmp8(tmp2(9444), obj13);
    const tmp2Result2 = tmp2(9444);
  }
  items3[1] = tmp8Result;
