// Module ID: 9255
// Function ID: 9256
// Dependencies: [19, 17, 21, 4560, 576, 7123, 9256, 4556, 1114, 4975, 4763, 2]
// Exports: default
...
export default function ErrorResult(error) {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef9256, style: tmp.image }), ];
  ...
  if (!error.hideFooter) {
    ...
    tmp6Result = tmp6(tmp3(4975).Button, obj5);
  }
  items1[1] = tmp6Result;
  obj.children = items1;
