...
// Dependencies: [19, 17, 1074, 21, 4560, 576, 9249, 8340, 1114, 4260, 9427, 9229, 7380, 4556, 9429, 2]
// Exports: default

// Module 9426 (ApplicationEducation)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4556 */;
import OAuth2Scopes from "OAuth2Scopes" /* 8340 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9249 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4260).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9427).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9229).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7380).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8340).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4260).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9229).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7380).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4556).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9429).AuthorizeFormSeparator, {})];
