...
// Function ID: 9432
// Name: GuildSelector
// Dependencies: [19, 17, 1074, 21, 4560, 576, 4527, 9432, 1896, 1114, 1086, 4556, 1178, 8599, 2]
// Exports: default

// Module 9431 (GuildSelector)
...
export default function GuildSelector(disabled) {
  ...
  const callback = noop.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(9432, dependencyMap.paths), GuildSelector, obj2);
  }, items);
  ...
  const items1 = [closure_7(selectedGuildId(4556).Text, obj2), , , ];
  let tmp6Result = null;
  if (null != error) {
    tmp6Result = null;
    if ("" !== error) {
  ...
  items1[2] = closure_7(selectedGuildId(8599).FormRow, { label: name, disabled: disabled.disabled, trailing: closure_7(selectedGuildId(8599).FormRow.Arrow, {}), DEPRECATED_style: tmp.select, onPress: callback });
