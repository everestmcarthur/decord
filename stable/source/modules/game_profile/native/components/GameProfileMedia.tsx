...
// Dependencies: [32, 19, 17, 1085, 21, 4560, 576, 8725, 8692, 8262, 8308, 1116, 8718, 8726, 2]
// Exports: default

// Module 8724 (GameProfileMedia)
import nativeDefault from "native" /* 576 */;
import openMediaModal from "openMediaModal" /* 8262 */;
import GameProfileAnalyticUtils from "GameProfileAnalyticUtils" /* 8692 */;
import GameProfileMediaSources from "GameProfileMediaSources" /* 8725 */;
...
obj2.mediaItem = { maxWidth: fn(8725).MEDIA_ITEM_MAX_WIDTH, maxHeight: fn(8725).MEDIA_ITEM_MAX_HEIGHT, borderRadius: nativeDefault.radii.lg, overflow: "hidden" };
