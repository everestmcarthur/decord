...
// Dependencies: [19, 17, 8359, 21, 4560, 576, 4255, 8721, 1114, 1894, 4242, 8884, 8891, 4556, 2]
// Exports: default

// Module 8883 (GameProfileDetails)
...
import SKUUtils from "SKUUtils" /* 8721 */;
...
const IGDB_ATTRIBUTION_LINK = fn(8359).IGDB_ATTRIBUTION_LINK;
const jsxProd = fn(21);
          ...
          if (!tmp34) {
            ...
            if (!tmp61) {
              ...
              if (obj != null) {
                ...
                if (websites != null) {
                  const mapped3 = websites.map((item) => trackAction(8891)(item, trackAction(576).colors.ICON_SUBTLE));
              ...
              const obj8 = { style: closure_2.platformsContainer, children: platforms.map((platform) => closure_1_8(game(8884).GameUpdatePlatformIcon, { platform, size: "md", color: trackAction(576).colors.ICON_SUBTLE }, platform)) };
