...
// Dependencies: [5, 2025, 8688, 1074, 8767, 573, 4802, 1272, 504, 559, 1090, 8758, 2]
// Exports: getGameAnnouncements, getShopCollection

// Module 8766 (GameProfileHttpUtils)
...
let closure_7 = fn(8767).SIMILAR_GAMES_BLOCKED_GAME_IDS;
