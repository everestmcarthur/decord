...
// Dependencies: [19, 1957, 4199, 1960, 1074, 504, 9841, 1982, 1369, 2]
// Exports: default
...
export default function useFavoritesGuildChannelFilter() {
  ...
  return noop.useCallback((type, arg1) => {
    ...
    if (sortByMatchScore.AutocompleterResultTypes.USER === type) {
      ...
      return tmp15;
    } else if (tmp(9841).AutocompleterResultTypes.GROUP_DM === type) {
      return null == stateFromStores[type.record.id];
    } else {
      if (tmp(9841).AutocompleterResultTypes.TEXT_CHANNEL !== type) {
