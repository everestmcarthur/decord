...
// Dependencies: [5, 21, 10228, 1896, 4527, 10233, 10232, 1114, 3225, 8668, 10240, 10246, 1178, 2]
// Exports: default

// Module 10227 (buildFavoritesSectionButtons)
...
function openNoAccessUpsell() {
  ...
  obj.openLazy(asyncRequireImpl(10233, dependencyMap.paths), openFavoritesGuildLimitUpsell.FAVORITES_UPSELL_SHEET_KEY, { source: "channel_context_menu" });
}
const jsx = fn(21).jsx;
const size = fn(2);
  ...
  if (isExperimentEnabled.isExperimentEnabled) {
    ...
    if (tmp2) {
      ...
      if (tmp3) {
        ...
        obj2.label = intl3.string(_modDef3225.TN4nAX);
        ...
        obj3.label = intl2.string(_modDef3225.G9fGlP);
