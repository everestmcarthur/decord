...
function FavoritesGuildAddCategoryActionSheet() {
  ...
  obj2.header = closure_6(value(7149).BottomSheetTitleHeader, obj3);
  ...
  const items1 = [closure_6(value(6606).TextInput, obj4), ];
  ...
  items1[1] = closure_6(value(4975).Button, obj5);
  obj2.children = items1;
  return closure_7(value(7150).BottomSheet, obj2);
}
