...
import openFavoritesGuildChannelSortModalDefault from "openFavoritesGuildChannelSortModal" /* 16144 */;
...
export default function FavoritesGuildActionSheet(onClose) {
  ...
  obj3.header = closure_4(onClose(7149).BottomSheetTitleHeader, obj4);
  let tmp8Result = null;
  if (tmp4.isAvailable) {
    ...
    const obj8 = { IconComponent: tmp5(5073).ThreadIcon };
    obj7.icon = tmp8(tmp5(7200).ActionSheetRow.Icon, obj8);
    ({ isEnabled: obj6.value, toggle: obj6.onValueChange } = tmp4);
    obj5.children = tmp8(tmp5(7200).ActionSheetSwitchRow, obj7);
    tmp8Result = tmp8(tmp5(7200).ActionSheetRow.Group, obj5);
  }
  ...
  if (obj.useFavoritesAccess("FavoritesGuildActionSheet").hasAccess) {
    ...
    if (stateFromStores) {
      ...
      const obj11 = { IconComponent: tmp5(12155).ArrowsUpDownIcon };
      obj10.icon = tmp8(tmp5(7200).ActionSheetRow.Icon, obj11);
      obj10.onPress = function onPress() {
        onClose();
        openFavoritesGuildChannelSortModalDefault();
      };
      obj9.children = tmp8(tmp5(7200).ActionSheetRow, obj10);
      tmp8Result3 = tmp8(tmp5(7200).ActionSheetRow.Group, obj9);
    }
  }
  ...
  obj13.icon = closure_4(onClose(7200).ActionSheetRow.Icon, { IconComponent: EyeSlashIcon });
  let str = "danger";
  if (tmp2.isPreview) {
    str = "default";
  }
  ...
  const items2 = [closure_4(onClose(7200).ActionSheetRow, obj13), ];
  ...
  if (tmp3.isAvailable) {
    ...
    const obj25 = { IconComponent: tmp5(4518).TrashIcon };
    obj24.icon = tmp8(tmp5(7200).ActionSheetRow.Icon, obj25);
    obj24.onPress = function onPress() {
      onClose();
      closure_2.perform();
    };
    tmp8Result4 = tmp8(tmp5(7200).ActionSheetRow, obj24);
  }
  items2[1] = tmp8Result4;
  items1[2] = closure_5(onClose(7200).ActionSheetRow.Group, { hasIcons: true, children: items2 });
  obj3.children = items1;
  return closure_5(onClose(7198).ActionSheet, obj3);
};
