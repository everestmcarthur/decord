...
// Dependencies: [109, 9473, 1961, 1957, 4385, 2012, 2011, 1074, 9474, 3, 4399, 12787, 5411, 1100, 12792, 4763, 4767, 5520, 9687, 4417, 573, 4761, 4491, 12793, 2]
...
function updateSelectedChannelListener(location) {
  const matchPathResult = channel2(12787).matchPath(location.pathname, { path: items, strict: false, exact: false });
  let params;
  if (matchPathResult != null) {
  ...
  if (null == voiceChannelId2) {
    if (null == voiceGuildId2) {
      ...
      if (isGuildVoiceResult) {
        ...
        obj21.popWithKey(tmp(4767).getVoiceChannelKey(channel.id));
  ...
  tmpResult5 = channel2(9687);
  const tmpResult6 = channel2(4417);
...
const setVoiceChatDrawerState = fn(9473).setVoiceChatDrawerState;
let closure_6 = fn(1961).isGuildSelectableChannelType;
const Constants = fn(1074);
({ ME: closure_11, Routes } = Constants);
const ChannelTypes = Constants.ChannelTypes;
const VoiceChatDrawerState = fn(9474).VoiceChatDrawerState;
