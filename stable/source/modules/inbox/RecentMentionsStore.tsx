...
// Dependencies: [4210, 502, 1957, 4781, 4575, 4209, 4381, 4741, 1371, 1074, 510, 4783, 4771, 4798, 12, 4589, 7270, 7638, 504, 573, 2]

// Module 7637 (RecentMentionsStore)
        ...
        if (!tmp2(7638)(message, id)) {
          ...
          if (tmp2(4798)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(4798)(obj3);
