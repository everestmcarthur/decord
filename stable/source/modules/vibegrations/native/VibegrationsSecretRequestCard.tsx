...
export default function VibegrationsSecretRequestCard(projectId) {
  ...
  obj2.children = intl.string(request(3547)["/e28TK"]);
  const items1 = [closure_5(projectId(4556).Text, obj2), , , ];
  if (null != request.note) {
    ...
    obj5.text = intl3.string(tmp8(3547)["gVV+HX"]);
    items1[3] = tmp5(tmp6(4975).Button, obj5);
    obj.children = items1;
