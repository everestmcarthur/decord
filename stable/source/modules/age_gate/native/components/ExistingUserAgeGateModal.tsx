...
// Module 17308 (ExistingUserAgeGateModal)
...
export default function ExistingUserAgeGateModal(source) {
  ...
  const shouldAgeVerifyForAgeGate = source(4771).useShouldAgeVerifyForAgeGate();
    ...
    if (constants.NSFW_SERVER_INVITE !== source) {
      ...
      let obj2 = {
        ...
        render(arg0, arg1) {
            ...
            if (closure_0 === constants2.NSFW_SERVER_INVITE) {
              if (obj.isIOS()) {
                let fn = () => {
                  ...
                  const obj2 = { key: "AGE_GATE_AGE_VERIFIED", icon: ref(17310), content: null };
            ...
            fn = () => {
              closure_0(7211).closeAgeGateModal();
              const obj = closure_0(7211);
              const obj3 = { key: "AGE_GATE_AGE_VERIFIED", icon: closure_1_1(17310), content: null };
              const intl = closure_0(1114).intl;
              obj3.content = intl.string(closure_0(1114).t.gUiIGZ);
              closure_1_1(4259).open(obj3);
            };
          }
      };
