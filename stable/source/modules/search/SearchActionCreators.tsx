...
// Dependencies: [12344, 12352, 573, 12, 7782, 12355, 1940, 2]

// Module 12351 (SearchActionCreators)
import _modDef12 from "module_12" /* 12 */;
import UserSettingsProtoActionCreators from "UserSettingsProtoActionCreators" /* 1940 */;
import SearchTabsFetchManagerDefault from "SearchTabsFetchManager" /* 12352 */;
...
export default {
  fetchTabMessages(searchContext) {
    ...
    const tokenizeQueryResult = searchContext(12344).tokenizeQuery(searchQueryString);
    const searchQueryFromTokens = searchContext(12344).getSearchQueryFromTokens(tokenizeQueryResult);
    ...
    let obj2 = searchContext(12344);
    const result = searchContext(12344).searchModeToSearchQueryParams(searchMode);
    let obj3 = {};
    const merged = Object.assign(searchQueryFromTokens);
    const merged1 = Object.assign(result);
    const tmpResult = searchContext(12344);
    guildIdFromSearchContext = searchContext(12344).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      tmp(12344).setIncludeNSFW(obj3, guildIdFromSearchContext);
      const tmpResult5 = tmp(12344);
    }
    const tmpResult4 = searchContext(12344);
    ...
    obj4.id = searchContext(12344).getSearchContextId(searchContext);
    ...
    const tmpResult6 = searchContext(12344);
  ...
  fetchMessages(arg0) {
    ...
    let obj2 = {};
    const obj = guildIdFromSearchContext(12344);
    const tokenizeQueryResult = guildIdFromSearchContext(12344).tokenizeQuery(searchQueryString);
    const merged = Object.assign(guildIdFromSearchContext(12344).getSearchQueryFromTokens(tokenizeQueryResult));
    let obj3 = guildIdFromSearchContext(12344);
    const merged1 = Object.assign(guildIdFromSearchContext(12344).searchModeToSearchQueryParams(searchMode));
    obj2.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(12344);
    guildIdFromSearchContext = guildIdFromSearchContext(12344).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      tmp(12344).setIncludeNSFW(obj2, guildIdFromSearchContext);
    ...
    searchContextId = guildIdFromSearchContext(12344).getSearchContextId(searchContext);
    const tmp9 = searchContextId;
    const tmpResult2 = guildIdFromSearchContext(12344);
    ...
    const obj7 = searchContextId(12355).create({ id: searchContextId, searchType: searchContext.type, searchQuery: obj2 });
