...
// Dependencies: [1957, 5509, 12, 12370, 10867, 1114, 504, 573, 2]

// Module 12369 (SearchPeopleTabStore)
import _modDef12 from "module_12" /* 12 */;
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import util from "util" /* 1114 */;
import useUserListData from "useUserListData" /* 10867 */;
import NewMessageUserList from "NewMessageUserList" /* 12370 */;
...
prototype["search"] = function search(str) {
  ...
  if ("" === trimmed) {
    ...
    if (0 === trimmed1.length) {
      ...
      const found = values.filter(trimmed1(12370).filterGroupDMs);
...
prototype["processResults"] = function processResults() {
  ...
  if (this.groupDMs.length > 0) {
    ...
    if ("" !== self.searchQueryString) {
      ...
      obj3.title = intl.string(tmp(1114).t.qGlQrW);
