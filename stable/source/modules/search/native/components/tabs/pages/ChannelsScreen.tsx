...
// Function ID: 16695
// Name: ChannelsScreen
// Dependencies: [19, 4584, 12367, 12343, 7879, 7878, 21, 12344, 504, 16241, 16645, 1114, 4272, 16649, 12362, 16686, 16641, 16653, 2]
...
let closure_10 = fn(7878).SearchResultContentEntityTypes;
const jsx = fn(21).jsx;
const size = fn(2);
