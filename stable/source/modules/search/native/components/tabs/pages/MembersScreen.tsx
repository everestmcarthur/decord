...
// Function ID: 16688
// Name: MembersScreen
// Dependencies: [19, 17, 7279, 1957, 2021, 1979, 2011, 1371, 12368, 12343, 7879, 7878, 1074, 21, 4560, 576, 563, 7162, 12344, 16649, 4204, 1874, 12362, 8180, 1114, 4272, 16688, 16686, 16641, 11593, 16653, 16689, 7182, 11597, 12190, 16691, 2]
...
function SearchableMembersScreen(searchContext) {
  ...
  dependencyMap = searchContext(12344).getSearchContextId(searchContext);
  ...
  fullscreenPlaceholderCount = searchContext(16649).useFullscreenPlaceholderCount({ placeholderHeight, numColumns: 1 });
  let obj4 = { placeholderHeight, numColumns: 1 };
  const tmp4Result8 = searchContext(16649);
  ...
  const tmp4Result13 = searchContext(16688);
...
let closure_16 = fn(7878).SearchResultContentEntityTypes;
...
export default noop.memo(function MembersScreen(searchContext) {
  ...
  if (constants3.CHANNEL === type) {
    ...
    if (stateFromStores) {
      ...
      tmp21Result = tmp21(tmp2(16691), obj7);
    }
    obj6.listHeaderContent = tmp21Result;
    obj4.children = jsx(tmp2(12190), { channelId: searchContext.channelId, disableStickySections: true, listStyleOverride: tmp.userList, onUserPress: tmp7(1874).dismissGlobalKeyboard, listHeaderContent: null });
