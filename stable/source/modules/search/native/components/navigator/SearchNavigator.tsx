...
// Dependencies: [19, 17, 7878, 16646, 1074, 21, 4560, 576, 7914, 7000, 12362, 1611, 16868, 7864, 16863, 16864, 2]
...
let closure_5 = fn(7878).SearchEntrypointAnalyticsLocations;
...
export default noop.memo((route) => {
  ...
  const accessibilityNativeStackOptions = searchContext(7000).useAccessibilityNativeStackOptions();
  ...
  const items2 = [
    ...
    closure_8(closure_11.Screen, {
      ...
      options(route) {
        ...
        const obj = {
          headerShown: true,
          header: route(7864).renderHeader,
