...
// Dependencies: [32, 19, 17, 4552, 5459, 1374, 21, 4296, 4560, 576, 504, 4561, 4974, 7127, 4272, 1114, 4262, 4277, 5123, 7130, 1396, 4556, 7133, 1178, 2]
// Exports: default

// Module 7126 (GuildOnboardingPromptOptionButton)
...
obj.easing = Easing.out(fn(4296).Easing.ease);
...
export default function PromptOptionButton(option) {
  ...
  let obj3 = option(4296);
  R.__closure = { selected, withTiming: option(4561).withTiming, Easing: option(4296).Easing, useReducedMotion: stateFromStores1, withSequence: option(4296).withSequence, withSpring: option(4974).withSpring };
  ...
  let obj4 = { selected, withTiming: option(4561).withTiming, Easing: option(4296).Easing, useReducedMotion: stateFromStores1, withSequence: option(4296).withSequence, withSpring: option(4974).withSpring };
  ...
  let tmp2Result = option(4296);
  V.__closure = { showMemberCount, withDelay: option(4296).withDelay, withTiming: option(4561).withTiming, Easing: option(4296).Easing, useReducedMotion: stateFromStores1 };
  V.__workletHash = 9518487706997;
  V.__initData = token;
  const animatedStyle1 = tmp2Result.useAnimatedStyle(V);
  const obj6 = { showMemberCount, withDelay: option(4296).withDelay, withTiming: option(4561).withTiming, Easing: option(4296).Easing, useReducedMotion: stateFromStores1 };
  sharedValue = option(4296).useSharedValue(1);
  isUnseen = canBeNew;
  if (canBeNew) {
  ...
  const tmp2Result16 = option(4296);
  fn.__closure = { withTiming: option(4561).withTiming, selected, SELECTION_TIMING: sharedValue };
  fn.__workletHash = 11553377214675;
  fn.__initData = token1;
  derivedValue = tmp2Result16.useDerivedValue(fn);
  const obj7 = { withTiming: option(4561).withTiming, selected, SELECTION_TIMING: sharedValue };
  ...
  const tmp2Result17 = option(4296);
  fn2.__closure = { withTiming: option(4561).withTiming, isNew: isUnseen, SELECTION_TIMING: sharedValue };
  fn2.__workletHash = 9359578148244;
  fn2.__initData = token2;
  derivedValue1 = tmp2Result17.useDerivedValue(fn2);
  const obj8 = { withTiming: option(4561).withTiming, isNew: isUnseen, SELECTION_TIMING: sharedValue };
  class W {
    constructor() {
      obj = closure_0(closure_2[7]);
      items = [, ];
  ...
  const tmp2Result18 = option(4296);
  W.__closure = { interpolateColor: option(4296).interpolateColor, newProgress: derivedValue1, unselectedBorderColor: token, newBorderColor: token1, selectedProgress: derivedValue, selectedBorderColor: token2, selectedBackgroundColor: token3 };
  W.__workletHash = 1340353593596;
  W.__initData = token3;
  const animatedStyle2 = tmp2Result18.useAnimatedStyle(W);
  const obj9 = { interpolateColor: option(4296).interpolateColor, newProgress: derivedValue1, unselectedBorderColor: token, newBorderColor: token1, selectedProgress: derivedValue, selectedBorderColor: token2, selectedBackgroundColor: token3 };
  class K {
    constructor() {
      if (closure_4) {
        obj = {};
  ...
  const tmp2Result19 = option(4296);
  ...
  if (tmp38Result) {
    ...
    obj13.name = str;
    obj12.children = closure_9(tmp7(7130), obj13);
    tmp38Result = tmp38(closure_5, obj12);
    const tmp7Result = tmp7(7130);
  }
  const items8 = [tmp38Result, ];
  const obj15 = { style: tmp.optionText, children: null };
  const items9 = [closure_9(option(4556).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: option.title }), ];
  ...
  if (tmp44Result) {
    ...
    tmp44Result = tmp44(tmp2(4556).Text, obj17);
  }
  items9[1] = tmp44Result;
  obj15.children = items9;
  items8[1] = ref(closure_5, obj15);
  obj11.children = items8;
  const items10 = [ref(option(5123).PressableOpacity, obj11), , , ];
  ...
  if (num > 0) {
    ...
    obj18.children = tmp44(tmp2(4556).Text, obj19);
    tmp44Result2 = tmp44(tmp7(4296).View, obj18);
  }
  ...
  const tmp2Result20 = option(4277);
  obj21.children = closure_9(option(7133).CheckmarkSmallIcon, { size: "xs", color: selected(576).colors.WHITE });
  items10[2] = closure_9(selected(4296).View, obj21);
  if (canBeNew) {
    canBeNew = !selected;
  }
  if (canBeNew) {
  ...
  return ref(selected(4296).View, obj10);
};
