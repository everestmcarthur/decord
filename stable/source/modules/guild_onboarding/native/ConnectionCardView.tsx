...
export default function ConnectionCardView(description) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(4556).Text, obj5);
  }
  items1[1] = tmp4Result;
  ...
  if (isLoading) {
    ...
    const items3 = [tmp4(tmp5(4556).Text, obj7), tmp4(tmp5(4520).CircleCheckIcon, { size: "sm", color: "status-positive" })];
    ...
    tmp4Result2 = tmp4(tmp5(4975).Button, obj8);
  }
