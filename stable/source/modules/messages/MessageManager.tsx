...
// Function ID: 9948
// Name: MessageManager
// Dependencies: [32, 4576, 5277, 1961, 7280, 1957, 1979, 4575, 2011, 4381, 1074, 1964, 1090, 3, 5272, 9948, 4491, 8375, 7456, 9949, 510, 4386, 1100, 7282, 4904, 1114, 573, 7118, 2]

// Module 9947 (MessageManager)
...
import getAdaptiveMessageLimit from "getAdaptiveMessageLimit" /* 9949 */;
      ...
      if (type !== constants.GUILD_STORE) {
        ...
        if (null == type1) {
          ...
          if (orCreate.some(AttachmentUrlUtilsAll.messageHasExpiredAttachmentUrl)) {
            ...
            tmp9(5272).clear(channelId);
            const tmp9Result = tmp9(5272);
            orCreate1 = tmp9(5272).getOrCreate(channelId);
            const tmp9Result9 = tmp9(5272);
          }
          let obj7 = orCreate1;
          if (tmp15) {
          ...
          if (tmp19) {
            ...
            obj10 = mutation1;
            const tmp9Result11 = tmp9(5272);
          }
          if (isPreload) {
            if (!GatewayConnectionStore.isConnected()) {
              let flag = true;
            }
            let hasUnreadResult = tmp9(8375)(channelId);
            if (hasUnreadResult) {
            ...
            if (flag) {
              ...
              if (null == messageId) {
                ...
                tmp9(7456).jumpToMessage(obj12);
                const tmp9Result16 = tmp9(7456);
              }
              const tmp9Result12 = tmp9(5272);
            }
          }
