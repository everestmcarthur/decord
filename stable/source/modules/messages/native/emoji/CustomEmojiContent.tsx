...
// Dependencies: [19, 17, 5460, 4381, 1371, 1074, 21, 4560, 576, 4218, 1242, 9398, 4527, 10336, 504, 7162, 5464, 4216, 4192, 10290, 7189, 1935, 10344, 7382, 10337, 10240, 10246, 4556, 1114, 10341, 4259, 10345, 1896, 8678, 1178, 4975, 5587, 10346, 8599, 10347, 10348, 2]
// Exports: default
  ...
  if (tidaWebformEnabled) {
    ...
    if (setting) {
      ...
      function handleOpenEmojiOptionsMenu() {
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10345, dependencyMap.paths), "EmojiOptionsActionSheet", { emojiSrc: emojiNode.src }, "stack");
      }
