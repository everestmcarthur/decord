...
// Dependencies: [1074, 5000, 8011, 7961, 1114, 7963, 7965, 2]
// Exports: createApplicationCommandSourceSystemMessage

// Module 8010 (ApplicationCommandSourceSystemMessage)
...
import ApplicationCommands from "ApplicationCommands" /* 8011 */;
...
export const createApplicationCommandSourceSystemMessage = function createApplicationCommandSourceSystemMessage(message) {
  ...
  if (null != applicationCommand) {
    if (null != name) {
      const messageAuthorWithProcessedColor = tmp(7961).getMessageAuthorWithProcessedColor(message);
