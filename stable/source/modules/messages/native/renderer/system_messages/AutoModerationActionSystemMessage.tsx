...
// Dependencies: [17, 1957, 2021, 4199, 4209, 1371, 1074, 12, 4411, 576, 7937, 7508, 4793, 1114, 7992, 4153, 8015, 8016, 1396, 8019, 6612, 1399, 8020, 7186, 7965, 4713, 4188, 4242, 8021, 8022, 2]
// Exports: createAutoModerationActionSystemMessage

// Module 8014 (AutoModerationActionSystemMessage)
...
import _modDef8020 from "module_8020" /* 8020 */;
...
const AutomodMessageUtils = tmp(7508);
const RowGeneratorStyleSheet = tmp(7937);
const AutomodNotificationEmbedTypeKeys = tmp(7992);
const AutomodRaidAlertTypes = tmp(8015);
const GuildAntiRaidUtils = tmp(8016);
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (result1) {
        ...
        if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.RAID !== notificationType) {
          if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.MENTION_RAID === notificationType) {
            ...
            if (null != avatar) {
              ...
              obj4.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef8020)).uri;
              ...
              obj4.subtitleRight = _modDef4153(message.timestamp).fromNow();
            ...
            obj5.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef6612)).uri;
      ...
      obj8.headerIconURL = getRaidAlertResolveCTAText(intl9(importDefault(tmp42 ? 8019 : 6612))).uri;
    ...
    if (null == guildId) {
      ...
      if (null != iconRoleId) {
        if (null != guildId) {
          ...
          roleIcon = RoleIconUtils.getRoleIcon(obj10);
          const tmpResult50 = RoleIconUtils;
        }
      }
      const obj11 = {};
      ...
      obj12.actionsIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(tmp57(result1 ? 8021 : 8022))).uri;
