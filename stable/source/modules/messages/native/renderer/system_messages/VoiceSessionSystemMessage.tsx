...
// Dependencies: [1957, 7981, 7961, 8072, 1114, 7963, 7965, 2]
// Exports: createVoiceSessionSystemMessage

// Module 8071 (VoiceSessionSystemMessage)
...
export const createVoiceSessionSystemMessage = function createVoiceSessionSystemMessage(message) {
  ...
  if (null == tmp3) {
    ...
    obj3.usernameOnClick = tmp(7963)(obj4);
    ...
    obj5.usernameOnClick = tmp(7963)(obj6);
