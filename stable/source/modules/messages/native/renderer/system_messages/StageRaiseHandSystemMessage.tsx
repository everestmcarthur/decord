...
// Dependencies: [5418, 1957, 4199, 1074, 1114, 2024, 7961, 11, 4707, 7963, 7965, 2]
// Exports: createStageRaiseHandSystemMessage

// Module 8030 (StageRaiseHandSystemMessage)
...
export const createStageRaiseHandSystemMessage = function createStageRaiseHandSystemMessage(roleStyle) {
  ...
  const merged = Object.assign(tmp6(7965)(roleStyle));
  return obj3;
};
