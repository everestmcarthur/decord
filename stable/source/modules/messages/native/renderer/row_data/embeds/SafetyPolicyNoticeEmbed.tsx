...
// Dependencies: [17, 1074, 8420, 4153, 1114, 7947, 8595, 2]
      ...
      if (type === MessageEmbedTypes.SAFETY_POLICY_NOTICE) {
        ...
        if (null != rawValue) {
          if (null != parsed) {
            ...
            obj.titleIcon = renderer_EmbedUtils.getAssetUriForEmbed(Image.resolveAssetSource(_modDef8595));
            const intl2 = util.intl;
            const obj3 = { daysAgo: null };
            const obj4 = _modDef4153();
            obj3.daysAgo = obj4.diff(_modDef4153.unix(parsed), "days");
