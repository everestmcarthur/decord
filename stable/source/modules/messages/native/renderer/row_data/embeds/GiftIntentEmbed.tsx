...
// Dependencies: [8079, 1371, 1373, 4560, 576, 1114, 8083, 4404, 7947, 4496, 8084, 8085, 2]
// Exports: createGiftIntentEmbed

// Module 8078 (GiftIntentEmbed)
  ...
  if (null == giftingPrompt) {
    ...
    if (null == user) {
      ...
      if (null == tmp) {
        ...
        obj9.subHeaderIconUrl = renderer_EmbedUtils.getAssetUriForEmbed(tmp8(4496));
        const intl3 = util.intl;
        obj9.primaryCtaLabel = intl3.string(util.t.ilhtIa);
        obj9.primaryCtaIconUrl = renderer_EmbedUtils.getAssetUriForEmbed(tmp8(8084));
        obj9.secondaryCtaIconUrl = renderer_EmbedUtils.getAssetUriForEmbed(tmp8(8085));
