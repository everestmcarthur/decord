  ...
  if (null != animationData) {
    ...
    obj3.children = function children(markAsDismissed) {
      ...
      if (tmp6Result) {
        ...
        const items2 = [tmp(tmp2(4556).Text, obj9), ];
      ...
      obj.children = closure_1_8(first(4296).View, obj2);
      return closure_1_8(closure_0(1178).OverlayView, obj);
    };
    tmp8 = closure_8(animationData(10630), obj3);
...
obj3.opacity = fn(7784).BACKDROP_OPACITY;
