...
// Dependencies: [19, 7680, 4210, 7681, 7838, 1371, 11673, 1074, 1964, 7601, 21, 4404, 11, 11674, 10256, 7182, 1242, 7456, 4904, 1114, 11675, 11678, 11679, 4272, 7834, 11681, 7765, 4417, 1100, 4785, 7190, 4258, 4705, 4573, 10252, 4710, 1365, 9948, 8264, 8371, 8374, 7292, 4527, 11682, 1896, 7289, 8635, 2528, 7276, 4571, 8180, 4740, 11259, 11684, 1109, 11685, 1894, 11709, 11714, 11715, 11719, 11732, 2]
// Exports: getContextBarCancelReason, handleCopyId, handleCopyMessageLink, handleCreateThread, longPressMessageOptionHandler

// Module 11672 (LongPressMessageActionSheetUtils)
...
import ChannelPinActionCreatorsDefault from "ChannelPinActionCreators" /* 11679 */;
import SavedMessageHelpers from "SavedMessageHelpers" /* 11709 */;
import SavedMessageSources from "SavedMessageSources" /* 11714 */;
...
import SendMessageOptionsStore from "SendMessageOptionsStore" /* 11673 */;
...
export const handleCopyMessageLink = function handleCopyMessageLink(channel, message_id) {
  ...
  if (null != channelPermalink) {
    tmp3(7190).copy(channelPermalink);
    const tmp3Result = tmp3(7190);
    tmp3(4258).presentLinkCopied();
    const tmp3Result2 = tmp3(4258);
  }
};
...
export const longPressMessageOptionHandler = function longPressMessageOptionHandler(analyticsLocations) {
  ...
  if (!disabled) {
      ...
      if (intl26.string(tmp(1114).t.n5EBAJ) !== label) {
        ...
        if (intl27.string(id(2528)["1D+vqy"]) === label) {
          if (tmpResult.canReportMessageToMods(message)) {
            let result = tmp(8635).showReportToModMessageModal(message);
            const tmpResult34 = tmp(8635);
          }
          tmpResult = tmp(7276);
        } else {
                  ...
                  if (null != user) {
                    if (chatInputRef != null) {
                      ...
                      if (current7 != null) {
                        ...
                        current7.insertText("@" + tmp130(4404).getUserTag(user, { decoration: "never" }), null, true);
                        const tmp130Result = tmp130(4404);
                      }
                    }
                    if (chatInputRef != null) {
                  ...
                  if (intl32.string(tmp(1114).t.cduTBL) === label) {
                    ...
                    if (intl33.string(tmp(1114).t.fsBWmS) === label) {
                      ...
                      if (intl34.string(tmp(1114).t.MFGE51) === label) {
                        ...
                        obj3.children = jsx(tmp130(11675), { channelId: id });
                        ...
                        tmp130(4904).show(obj3);
                        const tmp130Result29 = tmp130(4904);
                      } else {
                        ...
                        if (intl35.string(tmp(1114).t.CvQ18w) === label) {
                          ...
                          const obj6 = { message };
                          obj5.children = jsx(tmp130(11678), { message });
                          ...
                          tmp130(4904).show(obj5);
                          const tmp130Result30 = tmp130(4904);
                        } else {
                          ...
                          if (intl36.string(tmp(1114).t["Bse+F/"]) === label) {
                            ...
                            const obj8 = { message };
                            obj7.children = jsx(tmp130(11678), { message });
                            ...
                            tmp130(4904).show(obj7);
                            const tmp130Result31 = tmp130(4904);
                          } else {
                            ...
                            if (intl37.string(tmp(1114).t["lE/PG3"]) === label) {
                              ...
                              const tmp130Result32 = tmp130(7456);
                            } else {
                              ...
                              if (intl38.string(tmp(1114).t["2km5Gf"]) === label) {
                                ...
                                const tmp130Result33 = tmp130(7456);
                              } else {
                                ...
                                if (intl39.string(tmp(1114).t.xwMqD7) === label) {
                                  if (message.state === constants7.SENDING) {
                                    ...
                                    const tmp130Result34 = tmp130(7834);
                                    tmp130(7456).deleteMessage(id, id2, true);
                                    const tmp130Result35 = tmp130(7456);
                                  } else if (message.state === tmp86.SEND_FAILED) {
                                    tmp130(7456).deleteMessage(id, id2, true);
                                    const tmp130Result36 = tmp130(7456);
                                  } else {
                                    closure_132_0 = id;
                                    ...
                                    const obj11 = { message };
                                    obj10.children = jsx(tmp130(11678), { message });
                                    ...
                                    tmp130(4904).show(obj10);
                                    const tmp130Result37 = tmp130(4904);
                                  }
                                  const obj13 = { channel_id: id, guild_id, action_sheet_option: "delete", message_state: message.state };
                                  tmp130(4740).trackWithMetadata(constants.MESSAGE_ACTION_SHEET_OPTION_PRESSED, obj13);
                                  const tmp130Result38 = tmp130(4740);
                                } else {
                                  ...
                                  if (intl40.string(tmp(1114).t["5911Lb"]) === label) {
                                    ...
                                    tmp130(11681)(channel, message, items, SendMessageOptionsStore.getOptions(message.id));
                                    const tmp130Result39 = tmp130(11681);
                                    const obj15 = { channel_id: id, guild_id, action_sheet_option: "retry", message_state: message.state };
                                    tmp130(4740).trackWithMetadata(constants.MESSAGE_ACTION_SHEET_OPTION_PRESSED, obj15);
                                    const tmp130Result40 = tmp130(4740);
                                  } else {
                                    ...
                                    if (intl41.string(tmp(1114).t.JrGD7E) === label) {
                                      ...
                                      if (isMessageComponentsV2(contentMessage)) {
                                        const allTextDisplayContent = tmp(4785).getAllTextDisplayContent(contentMessage.components);
                                        if (null != allTextDisplayContent) {
                                          tmp(7190).copy(allTextDisplayContent);
                                          const tmpResult40 = tmp(7190);
                                        }
                                        const tmpResult39 = tmp(4785);
                                      } else {
                                        tmp(7190).copy(contentMessage.content);
                                        const tmpResult41 = tmp(7190);
                                      }
                                      tmp(4258).presentMessageCopied();
                                      const tmpResult42 = tmp(4258);
                                    } else {
                                      const intl42 = tmp(1114).intl;
                                      if (intl42.string(tmp(1114).t.lfIHs4) === label) {
                                        const result4 = tmp(11259).handleAddNewReactions(channel, id2);
                                        const tmpResult43 = tmp(11259);
                                      } else {
                                        const intl43 = tmp(1114).intl;
                                        if (intl43.string(tmp(1114).t.gHp0C4) === label) {
                                          if ("Preview" === actionSheetSource) {
                                            const result5 = tmp(11259).handleViewPreviewReactions(id2, id);
                                            const tmpResult44 = tmp(11259);
                                          } else {
                                            ...
                                            tmp(11259).handleViewReactions(obj17);
                                            const tmpResult45 = tmp(11259);
                                          }
                                        } else {
                                          const intl44 = tmp(1114).intl;
                                          if (intl44.string(tmp(1114).t.ZbtGBm) === label) {
                                            const result6 = tmp(11259).handleRemoveAllReactions(id, id2);
                                            const tmpResult46 = tmp(11259);
                                          } else {
                                            const intl45 = tmp(1114).intl;
                                            if (intl45.string(tmp(1114).t["g33r/P"]) === label) {
                                              const obj19 = { recipientIds: message.author.id };
                                              tmp130(4573).openPrivateChannel(obj19);
                                              const tmp130Result41 = tmp130(4573);
                                            } else {
                                              ...
                                              if (intl46.string(tmp(1114).t.Xrt5Po) === label) {
                                                ...
                                                const channelPermalink = tmp(4705).getChannelPermalink(channel.guild_id, channel.id, id2);
                                                if (null != channelPermalink) {
                                                  tmp(7190).copy(channelPermalink);
                                                  const tmpResult48 = tmp(7190);
                                                  tmp(4258).presentLinkCopied();
                                                  const tmpResult49 = tmp(4258);
                                                }
                                                const tmpResult47 = tmp(4705);
                                              } else {
                                                ...
                                                if (intl47.string(tmp(1114).t.RpE9k7) === label) {
                                                  ...
                                                  if (intl48.string(tmp(1114).t["S/xNKV"]) === label) {
                                                    ...
                                                    if (null != mediaUrl) {
                                                      closure_131_2 = tmp(4710).urlMatchesFileExtension(selectedMedia.mediaUrl, closure_15);
                                                      const tmpResult50 = tmp(4710);
                                                      ...
                                                      if (null != toURLSafeResult) {
                                                        if (obj40.isRefreshableAttachmentUrl(toURLSafeResult)) {
                                                          let result7 = tmp53(9948).maybeRefreshAttachmentUrl(selectedMedia.mediaUrl);
                                                          const tmp53Result = tmp53(9948);
                                                        }
                                                        obj40 = id2(9948);
                                                        tmp53 = id2;
                                                    ...
                                                    if (intl49.string(tmp(1114).t.JVuuz3) === label) {
                                                      ...
                                                      if (null != mediaUrl1) {
                                                        const result8 = tmp(8264).downloadMediaAssetWithContentType(selectedMedia.mediaUrl, constants6.VIDEO, selectedMedia.contentType);
                                                        result8.then(() => {
                                                      ...
                                                      if (intl50.string(tmp(1114).t.vbAEaA) === label) {
                                                        ...
                                                        if (null != mediaUrl2) {
                                                          ...
                                                          tmp(8371).handleClick(obj21);
                                                          const tmpResult52 = tmp(8371);
                                                        }
                                                      } else {
                                                            ...
                                                            if (intl53.string(tmp(1114).t["5IEsGx"]) === label) {
                                                              ...
                                                              if (intl54.string(tmp(1114).t.I3ltXO) === label) {
                                                                ...
                                                                if (intl55.string(tmp(1114).t.rBIGBL) === label) {
                                                                  ...
                                                                  const result9 = tmp130(7765).openThreadCreationForMobile(channel, id1, "Message");
                                                                  let result10 = null == message;
                                                                  if (!result10) {
                                                                    const tmpResult55 = tmp(4417);
                                                                  ...
                                                                  const tmp130Result44 = tmp130(7765);
                                                                } else {
                                                                  ...
                                                                  if (intl56.string(tmp(1114).t["39d0Wj"]) === label) {
                                                                    ...
                                                                    if (intl57.string(tmp(1114).t.PHjkRE) === label) {
                                                                      ...
                                                                      const tmp130Result48 = tmp130(4527);
                                                                      const obj24 = { channel, commandType: tmp(1894).ApplicationCommandType.MESSAGE, commandTargetId: message.id };
                                                                      const result11 = tmp(4417).navigateToContextMenuCommands(obj24);
                                                                      const tmpResult58 = tmp(4417);
                                                                    } else {
                                                                      const intl58 = tmp(1114).intl;
                                                                      if (intl58.string(tmp(1114).t.tpxJto) === label) {
                                                                        const obj25 = { channelId: id, messageId: id2, displayToast: true, source: tmp(11714).SavedMessageSources.LONG_PRESS_ACTION_SHEET };
                                                                        const result12 = tmp(11709).addOrUpdateSavedMessage(obj25);
                                                                        const tmpResult59 = tmp(11709);
                                                                      } else {
                                                                        ...
                                                                        if (intl59.string(tmp(1114).t.SvXS1Z) === label) {
                                                                          ...
                                                                          tmp(11709).removeSavedMessage(obj26);
                                                                          const tmpResult60 = tmp(11709);
                                                                        } else {
                                                                          ...
                                                                          if (intl60.string(tmp(1114).t.mJ3P0N) === label) {
                                                                            ...
                                                                            obj27.onBack = onBack;
                                                                            tmp130(4527).openLazy(tmp(1896)(11715, tmp2.paths), "MessageReminderDurationActionSheet", obj27);
                                                                            const tmp130Result49 = tmp130(4527);
                                                                          } else {
                                                                            ...
                                                                            if (intl61.string(tmp(1114).t.vrbqs1) === label) {
                                                                              ...
                                                                              obj28.onBack = onBack;
                                                                              tmp130(4527).openLazy(tmp(1896)(11715, tmp2.paths), "MessageReminderDurationActionSheet", obj28);
                                                                              const tmp130Result50 = tmp130(4527);
                                                                            } else {
                                                                              ...
                                                                              if (intl62.string(tmp(1114).t.ZH7P2h) === label) {
                                                                                if (null != selectedMedia) {
                                                                                  ...
                                                                                  if (!result13) {
                                                                                    result13 = tmp(7292).messageHasObscurableMedia(message);
                                                                                    const tmpResult61 = tmp(7292);
                                                                                  }
                                                                                  if (result13) {
                                                                                    ...
                                                                                    obj29.embedId = id3;
                                                                                    tmp130(4527).openLazy(tmp(1896)(11682, tmp2.paths), closure_20, obj29);
                                                                                    const tmp130Result51 = tmp130(4527);
                                                                                  }
                                                                                }
                                                                              } else {
                                                                                ...
                                                                                if (intl63.string(tmp(1114).t.grdwwt) === label) {
                                                                                  ...
                                                                                  tmp130(11719).endPollEarly({ channelId: null, messageId: null });
                                                                                  const obj30 = { channelId: null, messageId: null };
                                                                                  const tmp130Result52 = tmp130(11719);
                                                                                } else {
                                                                                  const intl64 = tmp(1114).intl;
                                                                                  if (intl64.string(tmp(1114).t.Rjezbz) === label) {
                                                                                    const obj31 = { message, guildId: guild_id, onBack };
                                                                                    tmp130(4527).openLazy(tmp(1896)(11732, tmp2.paths), "AppInteractionInfoActionSheet", obj31);
                                                                                    const tmp130Result53 = tmp130(4527);
                                                                                  } else {
                                                                                      ...
                                                                                      if (intl66.string(tmp(1114).t.wUIMqa) !== label) {
                                                                                        ...
                                                                                        if (intl67.string(tmp(1114).t.kFwAsa) === label) {
                                                                                          ...
                                                                                          if ("attachment" === sourceType) {
                                                                                            ...
                                                                                            tmp130(4904).show(obj32);
                                                                                            const tmp130Result54 = tmp130(4904);
                                                                                          }
                                                                                        }
                                                                                      }
                                                                                    }
                                                                                    ...
                                                                                    tmp130(4904).show(obj33);
                                                                                    const tmp130Result55 = tmp130(4904);
                                                                                  }
                                                                                }
                                                                              }
                                                                            }
                                                        ...
                                                        if (flag) {
                                                          ...
                                                          const tmpResult62 = tmp(7190);
                                                          tmp(4258).presentLinkCopied();
                                                          flag = true;
                                                          const tmpResult63 = tmp(4258);
                                                        }
                                                        if (flag) {
                                                          let hostname;
                                                          if (null != mediaUrl3) {
                                                            hostname = tmp(8374).getHostname(mediaUrl3);
                                                            const tmpResult64 = tmp(8374);
                                                          }
    ...
    if (tmpResult65.canReportMessage(message)) {
      const result14 = tmp(8635).showReportModalForMessage(message, "mobile_message_action_sheet");
      const tmpResult66 = tmp(8635);
    }
    tmpResult65 = tmp(7289);
  }
};
