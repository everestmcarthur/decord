...
// Dependencies: [32, 19, 17, 21, 4560, 576, 8171, 15341, 15342, 4528, 4527, 7150, 7149, 1114, 2786, 4975, 4973, 10907, 10904, 10905, 2]
// Exports: default
...
export default function DisplayNameStylesEffectPickerSheet(userId) {
  ...
  const tmp = closure_9();
  let obj = userId(8171);
  const visibleEffectOrder = userId(15341).useVisibleEffectOrder();
  const obj2 = userId(15341);
  const displayNameStylesNewEffects = userId(15342).useDisplayNameStylesNewEffects(visibleEffectOrder);
  ...
  if (null != userId) {
    ...
    obj8.onPress = tmp8;
    obj7.children = closure_7(tmp2(4975).Button, obj8);
    obj6.trailing = closure_7(closure_5, obj7);
    obj5.children = closure_7(tmp2(7149).BottomSheetTitleHeader, obj6);
    ...
    obj10.children = closure_7(tmp2(4973).Stack, obj11);
    obj9.children = closure_7(closure_5, obj10);
    obj4.children = closure_7(closure_5, obj9);
    tmp9 = closure_7(tmp2(7150).BottomSheet, obj4);
  }
  return tmp9;
};
