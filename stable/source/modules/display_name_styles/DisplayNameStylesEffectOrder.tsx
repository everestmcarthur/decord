...
// Dependencies: [19, 1389, 9183, 2]
// Exports: useVisibleEffectOrder

// Module 15341 (DisplayNameStylesEffectOrder)
...
export const useVisibleEffectOrder = function useVisibleEffectOrder() {
  isDisplayNameStylesFlywheelSettersEnabled = isDisplayNameStylesFlywheelSettersEnabled(9183).useIsDisplayNameStylesFlywheelSettersEnabled("effect-order");
