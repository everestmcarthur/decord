...
// Function ID: 16977
// Name: CutoutImage
// Dependencies: [32, 19, 17, 21, 1256, 8457, 13035, 2]

// Module 16976 (CutoutImage)
import v1 from "v1" /* 1256 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;

const getReactNativeSVGImageSourceDefault = tmp13(13035);
require = fn;
  ...
  if (num14 <= 0) {
    ...
    if (null == v4Result) {
      ...
      if (null != imageBackgroundColor) {
        ...
        tmp15Result13 = tmp15(tmp(8457).Rect, size3);
      }
      ...
      if (null == imageSource) {
        ...
        if (null != borderStroke) {
          ...
          tmp15Result14 = tmp15(tmp(8457).Rect, size4);
        }
        ...
        if (typeof imageSource !== "number") {
          ...
          let tmp15Result15 = tmp15(tmp(8457).Image, size5);
        }
    ...
    tmp15Result18 = tmp15(tmp(8457).Rect, size9);
  }
});
