...
export default function SmsScreen(mfaChallenge) {
  ...
  const screenStyles = finish(15674).useScreenStyles(tmp2);
  ...
  let obj4 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15678).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  const items1 = [handleChange(mfaChallenge(6606).TextInput, obj4), ];
  ...
  items1[1] = handleChange(mfaChallenge(4975).Button, obj5);
  ...
  obj6.disabled = tmp6;
  obj2.submit = handleChange(finish(15676), obj6);
