...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items1 = [closure_13(trackAnalyticsEvent(4556).Text, obj3), ];
  const obj4 = { variant: "text-md/medium", style: tmp.takeoverDescription, children: null };
  const intl2 = trackAnalyticsEvent(1114).intl;
  obj4.children = intl2.string(trackAnalyticsEvent(1114).t.uicS5l);
  items1[1] = closure_13(trackAnalyticsEvent(4556).Text, obj4);
  ...
  const items2 = [closure_13(trackAnalyticsEvent(4975).Button, obj6), ];
  ...
  items2[1] = closure_13(trackAnalyticsEvent(4975).Button, obj7);
  obj5.children = items2;
