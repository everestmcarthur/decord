...
// Dependencies: [19, 17, 4209, 11368, 21, 4560, 576, 11395, 11398, 11399, 504, 11375, 7209, 1114, 8781, 8780, 4527, 11403, 1896, 4255, 6971, 6969, 6970, 6968, 9048, 11406, 6616, 8405, 4905, 11393, 8671, 8670, 8635, 9918, 9917, 4763, 11407, 11411, 11412, 11413, 9407, 9408, 11414, 11404, 5687, 5605, 5611, 2]
// Exports: default
...
import EducationIcon from "EducationIcon" /* 11412 */;
...
export default function SafetyToolsActionSheet(channelId) {
  ...
  const memo = recipientId.useMemo(() => {
    ...
    obj5.icon = importDefault(stateFromStores1 ? 6971 : 6969);
    if (stateFromStores1) {
