...
export const trackNamedViewEvent = function trackNamedViewEvent(warningId) {
  ...
  const obj2 = { channel_id: channelId, warning_id: null, warning_type: null, other_user_id: null, view_name: null, is_nudge_warning: null };
  let parsed;
  if (null != warningId) {
    const _parseInt = parseInt;
    parsed = parseInt(warningId);
...
export const trackCtaEvent = function trackCtaEvent(warningId) {
  ...
  const obj2 = { channel_id: channelId, warning_id: null, warning_type: null, other_user_id: null, cta: null, is_nudge_warning: null };
  let parsed;
  if (null != warningId) {
    const _parseInt = parseInt;
    parsed = parseInt(warningId);
