...
// Function ID: 16346
// Name: HomeDrawerDM
// Dependencies: [19, 17, 1961, 4209, 4741, 1371, 1085, 21, 4560, 504, 4713, 16346, 15320, 13291, 9065, 4556, 10114, 7880, 16308, 4423, 4420, 2]
// Exports: default
  ...
  const title = stateFromStores.useMemo(() => {
    ...
    if (isMuted) {
      ...
      if (isTemporary) {
        ...
        BellSlashIcon = tmp5(9065).BellSlashIcon;
      }
    } else {
