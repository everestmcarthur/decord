...
// Dependencies: [5, 9032, 1074, 9034, 559, 1090, 573, 1272, 1232, 2]
// Exports: fetchDeveloperWidgetConfigs, fetchFeaturedWidgetConfigs, fetchWidgetConfigs

// Module 9033 (ApplicationWidgetConfigActions)
import DurationsDefault from "Durations" /* 1090 */;
import HTTPUtils from "HTTPUtils" /* 1272 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import ApplicationWidgetConfigStore from "ApplicationWidgetConfigStore" /* 9032 */;
...
const FetchState = fn(9032).FetchState;
const Endpoints = fn(1074).Endpoints;
const promiseDeduper = new fn(9034).PromiseDeduper();
...
const promiseDeduper3 = new fn(9034).PromiseDeduper();
const promiseDeduper4 = new fn(9034).PromiseDeduper();
const size = fn(2);
