...
// Dependencies: [19, 17, 21, 4560, 576, 8932, 9019, 9020, 2]
// Exports: default

// Module 9023 (UserProfileApplicationWidgetTopContainedLayout)
...
export default function UserProfileApplicationWidgetTopContainedLayout(header) {
  ...
  if (null != fieldValue) {
    ...
    tmp12Result = tmp12(tmp2(9020).ImageSkeleton, obj10);
  }
