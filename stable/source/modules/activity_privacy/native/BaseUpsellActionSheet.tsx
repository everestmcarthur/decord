...
function StoreGuildIcon(guildId) {
  ...
  obj2.size = guildId(5584).GuildIconSizes.XSMALL;
...
export default function BaseUpsellActionSheet(toastContent) {
  ...
  const items1 = [closure_7(toastContent(4556).Text, { style: tmp.title, accessibilityRole: "header", variant: "heading-xl/bold", color: "text-strong", children: title }), closure_7(toastContent(4556).Text, { style: tmp.description, variant: "text-md/medium", color: "text-default", children: subtitle }), closure_7(GuildCard, { guildIds: affectedGuildIds, direction, onPress: onCardPress }), ];
  const obj5 = { style: tmp.buttonsContainer, children: null };
  const items2 = [closure_7(toastContent(4975).Button, { variant: "primary", size: "md", text: confirmText, onPress: callback }), ];
  ...
  items2[1] = closure_7(toastContent(4975).Button, obj6);
