...
// Dependencies: [1956, 4582, 502, 5278, 1957, 1908, 5419, 1371, 9483, 4579, 4581, 1074, 4585, 5428, 4195, 9484, 12, 9485, 9486, 4712, 8218, 4612, 2]
// Exports: activityParticipantIdToApplicationId, areParticipantsEqual, getEmbeddedActivityParticipantId

// Module 9482 (ChannelRTCParticipants)
...
import useIsSpeaking from "useIsSpeaking" /* 9484 */;
...
prototype["_getParticipantsForUser"] = function _getParticipantsForUser(userId) {
  ...
  if (null == user) {
    ...
    if (tmp3) {
      ...
      obj.userAvatarDecoration = tmp8(8218).getAvatarDecoration(user, guildId);
