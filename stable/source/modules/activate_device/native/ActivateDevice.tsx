...
// Function ID: 13879
// Name: ActivateDevice
// Dependencies: [32, 19, 17, 21, 4560, 576, 13879, 13881, 9579, 9267, 13882, 9244, 13883, 5587, 13884, 13888, 13889, 1396, 13890, 7123, 2]
// Exports: ActivateDevice

// Module 13878 (ActivateDevice)
import nativeDefault from "native" /* 576 */;
import FastImageDefault from "FastImage" /* 5587 */;
import ConsoleOAuthApplications from "ConsoleOAuthApplications" /* 9267 */;
...
export const ActivateDevice = (onClose) => {
  ...
  obj6.source = first(first1[17]).makeSource(require("module_13890"));
