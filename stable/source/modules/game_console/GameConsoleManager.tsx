...
// Dependencies: [5, 502, 1908, 4583, 4578, 4579, 4577, 9239, 4585, 3, 38, 9095, 10014, 7118, 4447, 9454, 1369, 4904, 1114, 17372, 9457, 2]
...
const prototype = function GameConsoleManager() {
  ...
  applyArgumentsResult.handleWaitForRemoteSession = function handleWaitForRemoteSession() {
    ...
    awaitRemoteTimeout.start(60000, () => {
      closure_1_0(9454).disconnectRemote();
      const obj = closure_1_0(9454);
      ...
      if (null != error) {
        ...
        if (commandId === tmp) {
          ...
          if (null != tmp8Result) {
            ...
            const result1 = tmp6(9457).showSelfDismissableAlert(obj2);
            const tmp6Result = tmp6(9457);
          }
