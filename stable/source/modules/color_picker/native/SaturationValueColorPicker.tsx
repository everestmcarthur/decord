...
// Dependencies: [32, 19, 17, 21, 4560, 576, 4296, 14601, 4987, 6655, 2]
// Exports: default

// Module 14603 (SaturationValueColorPicker)
...
function ColorBox(hue) {
  ...
  let obj = hue(4296);
  S.__closure = { hslToRgbWorklet: hue(14601).hslToRgbWorklet, hue };
  ...
  const obj2 = { hslToRgbWorklet: hue(14601).hslToRgbWorklet, hue };
  fn.__closure = { runOnJS: hue(4296).runOnJS, setColor: tmp2[1] };
  ...
  obj4.colors = items1;
  const obj3 = { runOnJS: hue(4296).runOnJS, setColor: tmp2[1] };
...
export default function SaturationValueColorPicker(hue) {
  ...
  let size = { saturation, normalizeValue: hue(14601).normalizeValue, width: colorBoxWidth, value, height: first1, onPanUpdate, runOnJS: hue(4296).runOnJS };
  fn.__closure = size;
  ...
  const size1 = { saturation, normalizeValue: hue(14601).normalizeValue, width: colorBoxWidth, value, height: first1, onPanUpdate, runOnJS: hue(4296).runOnJS };
  fn2.__closure = size1;
  ...
  let obj = hue(6655);
  fn3.__closure = { onPanFinalize, runOnJS: hue(4296).runOnJS };
  fn3.__workletHash = 12553589408812;
  fn3.__initData = __initData5;
  obj2.onFinalize = fn3;
  const panGesture = obj.usePanGesture(obj2);
  let obj3 = { onPanFinalize, runOnJS: hue(4296).runOnJS };
  ...
  let obj6 = hue(4296);
  fn4.__closure = { hsvToRgbWorklet: hue(14601).hsvToRgbWorklet, hue, saturation, value, colorBoxWidth, colorBoxHeight: first1 };
  ...
  let obj4 = { hsvToRgbWorklet: hue(14601).hsvToRgbWorklet, hue, saturation, value, colorBoxWidth, colorBoxHeight: first1 };
