...
// Dependencies: [32, 19, 17, 4200, 4201, 1957, 1074, 21, 4560, 576, 504, 7304, 1477, 11257, 7873, 11419, 5123, 1114, 4511, 4556, 9782, 4503, 7456, 11, 4491, 11420, 2]
// Exports: default
...
export default function ForumPostActionBar(channel) {
  ...
  let obj = channel(504);
  const firstMessage = channel(7304).useFirstForumPostMessage(channel).firstMessage;
  let obj2 = channel(7304);
  ...
  const items4 = [tmp.actionBarContainer, channel(7873).useGradientTop()];
  obj6.style = items4;
  ...
  if (tmp11) {
    ...
    obj7.children = closure_10(tmp2(11419).ForumPostActionBarReactions, obj8);
  ...
  if (stateFromStores2) {
    ...
    obj10.children = closure_10(tmp2(4503).LinkIcon, { size: "xs" });
    items7[1] = closure_10(tmp2(5123).PressableOpacity, obj10);
    ...
    obj11.children = closure_10(tmp2(11420).ArrowLargeUpIcon, { size: "xs" });
    items7[2] = closure_10(tmp2(5123).PressableOpacity, obj11);
    ...
    if (stateFromStores1) {
      ...
      obj12.style = tmp.actionButton;
      obj12.onPress = items9;
      const items11 = [closure_10(tmp2(9782).BellIcon, { size: "xs" }), ];
      ...
      items11[1] = closure_10(tmp2(4556).Text, obj14);
