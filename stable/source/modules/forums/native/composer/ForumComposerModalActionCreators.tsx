...
// Module 10256 (ForumComposerModalActionCreators)
...
export const openCreateForumPostModal = function openCreateForumPostModal(guildId) {
  ...
  if (!tmp4) {
    ...
    const result1 = tmp(7767).trackForumCreateNewPostStarted({ guildId: null, channelId: null });
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10257, tmp2.paths), guildId, c3);
};
