...
// Dependencies: [32, 19, 4552, 21, 4560, 576, 504, 4296, 4561, 5607, 2]
...
export default noop.memo(() => {
  ...
  const timingConfig = _slicedToArray(noop.useState(() => {
    ...
    obj2.easing = Easing.inOut(stateFromStores(4296).Easing.sin);
  ...
  fn.__closure = { reducedMotion: stateFromStores, ROW_OPACITY_END, withDelay: stateFromStores(4296).withDelay, INITIAL_DELAY_MS: 1000, withRepeat: stateFromStores(4296).withRepeat, withSequence: stateFromStores(4296).withSequence, withTiming: stateFromStores(4561).withTiming, timingConfig };
  fn.__workletHash = 9488742940898;
  fn.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(fn);
  let obj4 = { style: animatedStyle, pointerEvents: "none", children: jsx(stateFromStores(5607).Card, { variant: "secondary", style: tmp.postPlaceholder }) };
  return jsx(timingConfig(4296).View, { style: animatedStyle, pointerEvents: "none", children: jsx(stateFromStores(5607).Card, { variant: "secondary", style: tmp.postPlaceholder }) });
});
