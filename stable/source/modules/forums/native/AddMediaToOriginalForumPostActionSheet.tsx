...
// Dependencies: [32, 5, 19, 17, 1957, 4901, 1979, 4781, 1074, 21, 4560, 576, 7839, 5179, 5134, 4527, 9316, 9313, 11, 5129, 9315, 7765, 1272, 12003, 7456, 7600, 4905, 1114, 504, 7162, 7767, 5138, 7150, 12004, 4556, 4976, 2]
// Exports: default
      ...
      if (0 === c8) {
        ...
        if (arg0 === 1) {
          ...
          closure_132_5.on("progress", (currentSize) => {
            const kestrelConfig = closure_0(5179).getKestrelConfig({ location: "native.AddMediaToOriginalForumPostActionSheet" });
            const obj = closure_0(5179);
          ...
          closure_132_5.on("complete", () => {
            dependencyMap(false);
            closure_1(9313).clearAll(closure_1_0, ChannelMessage.ChannelMessage);
            const obj = closure_1(9313);
            closure_1(4527).hideActionSheet();
          });
