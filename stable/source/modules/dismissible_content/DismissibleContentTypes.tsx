...
// Module 1944 (DismissibleContentTypes)
...
const items4 = [dismissible_content.DismissibleContent.VANITY_URL_POWERUP_ROLLBACK_NOTIFICATION, dismissible_content.DismissibleContent.GAME_SERVER_HOSTING_NEW_BADGE, dismissible_content.DismissibleContent.GAME_SERVER_HOSTING_NEW_COACHMARK, dismissible_content.DismissibleContent.GUILD_TAG_AVAILABLE_COACHMARK_V2, dismissible_content.DismissibleContent.GAME_CLAIM_COACHMARK, dismissible_content.DismissibleContent.FIRST_BOOSTER_UPSELL, dismissible_content.DismissibleContent.MOBILE_ACCOUNT_LINKING_BANNER, dismissible_content.DismissibleContent.FILE_UPLOAD_POWERUP_ROLLBACK_NOTIFICATION];
