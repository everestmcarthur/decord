...
// Dependencies: [19, 17, 4552, 1074, 21, 504, 15835, 1115, 8815, 15836, 5587, 4975, 1114, 12960, 576, 4527, 4255, 2024, 10235, 3127, 2]
// Exports: default
...
export default function IncentivizedAccountLinkConfirmationBottomSheet() {
  ...
  if (obj.useStateFromStores(items, () => useReducedMotion.useReducedMotion)) {
    ...
    if (tmpResult.isAndroid()) {
      const obj4 = { url: tmp4(15836), style: null };
      const size1 = { width: v150, height: v150 };
      obj4.style = size1;
      tmp3Result = tmp3(tmp4(8815), obj4);
      tmp8 = tmp4;
      tmp9 = tmp3;
      const tmp4Result = tmp4(8815);
    } else {
      const obj5 = { source: null, resizeMode: "contain", style: null };
      const obj6 = { uri: tmp4(15836) };
      obj5.source = obj6;
      const size2 = { width: v150, height: v150 };
      obj5.style = size2;
      tmp3Result = tmp3(tmp4(5587), obj5);
      tmp8 = tmp4;
      tmp9 = tmp3;
      const tmp4Result2 = tmp4(5587);
    }
    tmpResult = tmp(1115);
  }
  ...
  obj9.title = intl2.string(tmp8(3127).ublzTG);
  const intl3 = tmp(1114).intl;
  obj9.description = intl3.string(tmp8(3127).JgM2xu);
