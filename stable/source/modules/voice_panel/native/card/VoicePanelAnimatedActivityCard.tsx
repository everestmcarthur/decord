...
// Dependencies: [32, 19, 1956, 9492, 1957, 12277, 12275, 1074, 1920, 21, 4560, 576, 12276, 16692, 504, 17146, 9510, 7168, 9638, 7162, 7182, 9625, 13988, 4296, 9482, 6655, 1477, 9478, 7073, 17147, 9641, 17148, 17149, 17153, 4271, 2]

// Module 17145 (VoicePanelAnimatedActivityCard)
...
function VoicePanelAnimatedActivityCardInner(applicationId) {
  ...
  const context = focused.useContext(sharedVisible(12276));
  ...
  const tmp7 = sharedVisible(16692)();
  ...
  const activityShelfItemData = applicationId(17146).useActivityShelfItemData(guild_id1, applicationId);
  ...
  const tmp8Result = applicationId(17146);
  ...
  const tmp17 = sharedVisible(9638)();
  ...
  const tmp4Result = sharedVisible(7162);
  let tmp21 = null != tmp17;
  const analyticsContext = applicationId(9625).useAnalyticsContext();
  if (tmp21) {
    let id;
    if (application != null) {
      id = application.id;
  ...
  if (!tmp21) {
    ...
    if (stateFromStores1 != null) {
      ...
      if (participants != null) {
        found = participants.find((item) => applicationId(13988).isActivityParticipantCurrentUserCurrentSession(item));
      }
    }
    tmp21 = null != found;
  }
  ...
  const tmp8Result12 = applicationId(9625);
  let fn = function q() {
  ...
  const tmp8Result13 = applicationId(4296);
  fn2.__closure = { VoicePanelModes: controlsSpecs, runOnJS: applicationId(4296).runOnJS, incrementActivityKey };
  ...
  if (null != stateFromStores1) {
    ...
    embeddedActivityParticipantId = tmp8(9482).getEmbeddedActivityParticipantId({ applicationId: null, instanceId: null });
    const obj4 = { applicationId: null, instanceId: null };
    const tmp8Result14 = tmp8(9482);
  }
  const obj3 = { VoicePanelModes: controlsSpecs, runOnJS: applicationId(4296).runOnJS, incrementActivityKey };
  ...
  const tmp8Result15 = applicationId(4296);
  re.__closure = { runOnJS: applicationId(4296).runOnJS, setIsActivityFocused: tmp2Result[1] };
  ...
  const obj5 = { runOnJS: applicationId(4296).runOnJS, setIsActivityFocused: tmp2Result[1] };
  class Se {
    constructor() {
  ...
  const tmp8Result16 = applicationId(4296);
  ...
  const tmp39 = !sharedVisible(9478)();
  __initData3 = tmp39;
  backgroundColor = tmp.activityContainerBackground.backgroundColor;
  const obj6 = { runOnJS: applicationId(4296).runOnJS, handleTargetAspectRatioParams: callback1, gridOrientationLockState, hasJoined: tmp21, updateNotJoinedActivityDimensions: callback2 };
  class Te {
    constructor() {
      num = 0;
      if (IS_IOS) {
  ...
  const tmp8Result17 = applicationId(4296);
  const items11 = [mode];
  ...
  if (null == stateFromStores) {
    ...
    if (tmp21) {
      ...
      obj11.children = focusedOrientationLockState(tmp4(9641), obj12, tmp3[0]);
      const items13 = [focusedOrientationLockState(tmp4(17147), obj11), ];
      let tmp47Result = null;
      if (stateFromStores2) {
        tmp47Result = tmp47(tmp4(17148), {});
      }
      items13[1] = tmp47Result;
      obj9.children = items13;
      obj8.children = tmp48(tmp4Result3, obj9);
      let tmp47Result2 = tmp47(tmp8(6655).GestureDetector, obj8);
      let tmp44 = tmp47;
      const tmp4Result4 = tmp4(17147);
    } else if (null == activityShelfItemData) {
      const obj13 = { activity: stateFromStores1, application };
      tmp47Result2 = focusedOrientationLockState(tmp4(17149), obj13);
      ...
      obj14.children = focusedOrientationLockState(tmp4(17153), obj15);
      tmp47Result2 = focusedOrientationLockState(tmp8(6655).GestureDetector, obj14);
    }
    const obj16 = { value: tmp4Result(tmp4(7182).ACTIVITY_TILE).analyticsLocations, children: tmp47Result2 };
    return tmp44(tmp8(7162).AnalyticsLocationProvider, obj16);
  }
...
let VoicePanelControlsModes = fn(12275).VoicePanelControlsModes;
