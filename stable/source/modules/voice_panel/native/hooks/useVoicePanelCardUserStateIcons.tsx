...
// Dependencies: [19, 4583, 4579, 4581, 21, 12276, 9126, 563, 10022, 4615, 9987, 16239, 17057, 4259, 6610, 576, 1114, 2]
// Exports: default

// Module 17109 (useVoicePanelCardUserStateIcons)
import VoiceStateIconUtils from "VoiceStateIconUtils" /* 9126 */;
...
export default function useVoicePanelCardUserStateIcons(arg0, id, guildId) {
  ...
  callback1 = obj.useCallback(() => {
    const obj2 = {
      ...
      icon() {
        return stateFromStores1(closure_1_0(6610).CircleErrorIcon, { size: "xs", color: id(576).colors.STATUS_WARNING });
      },
      content: null
    };
      ...
      if (closure_0 === ParticipantTypes.STREAM) {
        ...
        if (null != muteDeafenIconState) {
          let obj5 = {
            ...
            onPress() {
                    if (closure_0(9126).MuteDeafenIconState.DEAFENED_SERVER === muteDeafenIconState) {
