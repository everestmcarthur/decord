...
// Function ID: 17097
// Name: VoicePanelUI
// Dependencies: [32, 19, 17, 4576, 8291, 4768, 12277, 12275, 4581, 12278, 21, 3, 4974, 4560, 576, 4296, 1608, 12276, 1611, 6655, 9501, 11359, 17097, 4528, 17090, 4262, 12281, 9685, 17095, 17083, 10998, 9616, 7603, 7073, 7162, 7182, 1249, 17098, 7156, 17099, 17100, 9514, 17101, 17103, 17134, 17163, 17167, 17172, 2]

// Module 17096 (VoicePanelUI)
...
import utils_triggerIOSHapticDefault from "utils/triggerIOSHaptic" /* 17097 */;
...
function AnimatedWrapper(children) {
  ...
  let connected;
  let animatedStyle1;
  const height = wrapperOffset(9685).useGlobalStatusIndicatorState().height;
  ...
  const derivedValue = wrapperOffset(4296).useDerivedValue(fn);
  obj4 = wrapperOffset(17095);
  const pIPState = obj4.usePIPState();
  let obj3 = wrapperOffset(4296);
      ...
      if (modeToSet !== VoicePanelModes.PIP) {
        ...
        if (modeToSet === tmp8.PANEL) {
          if (connected) {
            ...
            const maxPanelWidth = tmp(17083).getMaxPanelWidth(obj3);
            const tmpResult = tmp(17083);
            const panelX = tmp(17083).getPanelX(windowWidth, maxPanelWidth);
            const _Math = Math;
            const tmpResult2 = tmp(17083);
  ...
  let obj7 = wrapperOffset(4296);
  fn4.__closure = { useReducedMotion, wrapperDimensions, wrapperOffset, connected, mode, VoicePanelModes: animatedStyle1, runOnJS: wrapperOffset(4296).runOnJS, updateSourceTrackingView: height(9616).updateSourceTrackingView, withSpring: wrapperOffset(4974).withSpring, DRAWER_SPRING_PHYSICS_GESTURE_ACTIVE, DRAWER_SIZE_PHYSICS: obj4 };
  ...
  const obj9 = wrapperOffset(4296);
  M.__closure = { computeBorderRadii, mode, connected, wrapperDimensions, withSpring: wrapperOffset(4974).withSpring, BORDER_RADIUS_PHYSICS: windowDimensions, VoicePanelModes: animatedStyle1, styles: tmp3 };
  ...
  if (!wrapperOffset(7603).isStable) {
    ...
    const obj12 = { runOnJS: tmp(4296).runOnJS, log };
    fn5.__closure = obj12;
    fn5.__workletHash = 5206450827682;
    fn5.__initData = __initData21;
    const animatedReaction1 = tmp(4296).useAnimatedReaction(Y, fn5);
    ...
    const obj14 = { runOnJS: tmp(4296).runOnJS, log };
    T.__closure = obj14;
    T.__workletHash = 7760779241631;
    T.__initData = __initData23;
    const animatedReaction2 = tmp(4296).useAnimatedReaction(H, T);
    let tmpResult2 = tmp(4296);
  }
  ...
  const obj10 = { computeBorderRadii, mode, connected, wrapperDimensions, withSpring: wrapperOffset(4974).withSpring, BORDER_RADIUS_PHYSICS: windowDimensions, VoicePanelModes: animatedStyle1, styles: tmp3 };
  const obj16 = { style: wrapperTransformStyles, pointerEvents: "box-none", children: null };
  const tmp4Result = height(7073);
  obj16.children = closure_21(height(7073), { style: wrapperSurfaceStyles, layout: layoutTransition, children: children.children });
  obj15.children = closure_21(height(7073), obj16);
...
const POP_RESISTANCE = fn(12278).POP_RESISTANCE;
const jsxProd = fn(21);
...
layoutTransition.__closure = { withSpring: fn(4974).withSpring, LAYOUT_PHYSICS };
...
let obj = { withSpring: fn(4974).withSpring, LAYOUT_PHYSICS };
scrollViewLayoutTransition.__closure = { withSpring: fn(4974).withSpring, LAYOUT_PHYSICS, EMBEDDED_ACTIVITY_ORIENTATION_UPDATE_SAFE_LAYOUT_PHYSICS: obj2 };
...
obj9.zIndex = 1;
obj6.wrapper = obj9;
let obj3 = { withSpring: fn(4974).withSpring, LAYOUT_PHYSICS, EMBEDDED_ACTIVITY_ORIENTATION_UPDATE_SAFE_LAYOUT_PHYSICS: obj2 };
...
let closure_70 = noop.memo((onPress) => {
  ...
  let obj = opacity(4296);
  fn.__closure = { withSpring: opacity(4974).withSpring, opacity, DrawerShadeOpacityPhysics };
...
export default noop.memo(function VoicePanelUI() {
  ...
  const sharedValue = channelId(4296).useSharedValue(0);
  closure_129_21 = sharedValue;
  let obj = channelId(4296);
  const sharedValue1 = channelId(4296).useSharedValue(false);
  closure_129_22 = sharedValue1;
  obj2 = channelId(4296);
  const sharedValue2 = channelId(4296).useSharedValue(false);
  closure_129_23 = sharedValue2;
  let obj3 = channelId(4296);
  const sharedValue3 = channelId(4296).useSharedValue({ start: 0, end: VOICE_PANEL_CHUNK_DIVISOR });
  ...
  const animatedRef = channelId(4296).useAnimatedRef();
  closure_129_28 = animatedRef;
  let obj6 = channelId(4296);
  const sharedValue4 = channelId(4296).useSharedValue({ absoluteXStart: 0, absoluteYStart: 0, cancel: false, active: false, requiresPop: false });
      ...
      if (mode.connected) {
        if (!mode.gestureActive) {
          if (mode === VoicePanelModes.PANEL) {
            tmp2(4296).runOnJS(closure_2)(true);
            const tmp2Result = tmp2(4296);
          }
          if (mode === VoicePanelModes.PANEL) {
            tmp2(4296).runOnJS(closure_3)(true);
            const tmp2Result6 = tmp2(4296);
          } else {
            tmp2(4296).runOnJS(closure_3)(false);
            const tmp2Result7 = tmp2(4296);
          }
          if (mode === tmp9.PIP) {
            tmp2(4296).runOnJS(noop)(true);
            const tmp2Result8 = tmp2(4296);
          } else {
            tmp2(4296).runOnJS(noop)(false);
            const tmp2Result9 = tmp2(4296);
          }
          tmp9 = VoicePanelModes;
        }
      }
      tmp2(4296).runOnJS(closure_2)(false);
      const tmp2Result10 = tmp2(4296);
    }
  };
  const obj8 = channelId(4296);
  fn2.__closure = { cheapWorkletShallowEqual: channelId(9501).cheapWorkletShallowEqual, VoicePanelModes, runOnJS: channelId(4296).runOnJS, setPanelFullscreen: callback, setPanelOpen: callback1, setPanelPIP: callback2 };
  fn2.__workletHash = 10989484188294;
  fn2.__initData = __initData2;
  const animatedReaction = obj8.useAnimatedReaction(fn, fn2);
  const obj9 = { cheapWorkletShallowEqual: channelId(9501).cheapWorkletShallowEqual, VoicePanelModes, runOnJS: channelId(4296).runOnJS, setPanelFullscreen: callback, setPanelOpen: callback1, setPanelPIP: callback2 };
  let fn3 = function _() {
    return mode.get();
  };
  fn3.__closure = { mode };
  ...
  const obj12 = channelId(4296);
  Ve.__closure = { runOnJS: channelId(4296).runOnJS, handleFocusChange: callback3 };
  ...
  const memo1 = noop.useMemo(() => {
    ...
    const fn2 = function u(arg0) {
      if (!gestureState.get().cancel) {
        closure_1(11359)(wrapperOffset, { x: 0, y: 0 });
        ...
        if (!gestureState.get().active) {
          if (!obj5.get().cancel) {
            ...
            if (mode.get() === setMode.PANEL) {
              ...
              flag = false;
              if (tmp12) {
                channelId(4296).runOnJS(closure_1(17097))();
                flag = true;
                const tmpResult = channelId(4296);
              }
            }
            const tmp25 = closure_1(11359);
            if (flag) {
        ...
        if (merged1 !== setMode.PIP) {
          ...
          if (lockScrolling.get()) {
            ...
            if (!obj.get().requiresPop) {
              ...
              closure_1(11359)(wrapperOffset, point);
            } else {
              const _Math = Math;
          ...
          closure_1(11359)(wrapperOffset, point1);
          const tmp7 = closure_1(11359);
        }
      }
    };
    ...
    const fn5 = function s() {
      ...
      closure_1(11359)(gestureState, { cancel: false, active: false });
      closure_1(11359)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
    };
    ...
    const fn6 = function n(velocityY) {
      if (!gestureState.get().cancel) {
        ...
        if (mode.get() === setMode.PIP) {
          ...
          const result = channelId(17090).calculatePIPPositionFromVelocity(obj6);
          ({ pipX, pipY } = result);
          const obj7 = { pipX, pipY };
          closure_1(11359)(wrapperDimensions, obj7);
          closure_1(11359)(wrapperOffset, { gestureActive: false });
          const obj5 = channelId(17090);
          ...
          if (velocityY > 0) {
            if (connected.get()) {
              ...
              if (wrapperOffset.get().y > 0.2 * diff) {
                closure_1(11359)(tmp12, { gestureActive: false });
                channelId(4296).runOnJS(dismissPanel)();
                const obj3 = channelId(4296);
              } else {
                closure_1(11359)(tmp12, { gestureActive: false, x: 0, y: 0 });
  ...
  const obj13 = { runOnJS: channelId(4296).runOnJS, handleFocusChange: callback3 };
  ...
  const animatedReaction3 = channelId(4296).useAnimatedReaction(Te, Me);
  const obj17 = channelId(4296);
  const token = channelId(4262).useToken(nativeDefault.modules.mobile.VOICE_PANEL_GUTTER);
  closure_129_31 = token;
  const obj18 = channelId(4262);
  class Ye {
    constructor() {
  ...
  if (tmp6[0]) {
    ...
    const items7 = [closure_21(tmp2(17099), {}), , ];
    ...
    obj25.onAccessibilityEscape = tmp2(9514);
    const items8 = [closure_21(tmp2(17101), {}), , , ];
    ...
    obj27.children = closure_21(tmp2(17103), obj28);
    const items9 = [closure_21(tmp13(7156).LayerScope, obj27), ];
    ...
    const items10 = [closure_21(tmp2(17134), obj33), closure_21(tmp2(17163), {})];
    obj32.children = items10;
    obj31.children = lockScrolling(closure_32, obj32);
    obj30.children = closure_21(tmp13(6655).GestureDetector, obj31);
    obj29.children = closure_21(tmp2(7073), obj30);
    items9[1] = closure_21(tmp13(6655).GestureDetector, obj29);
    obj26.children = items9;
    items8[1] = lockScrolling(AnimatedWrapper, obj26);
    items8[2] = closure_21(tmp2(17167), {});
    const obj34 = { gestureState: sharedValue4 };
    items8[3] = closure_21(tmp2(17172), obj34);
    obj25.children = items8;
    items7[2] = lockScrolling(tmp2Result, obj25);
    obj23.children = items7;
    obj22.children = lockScrolling(tmp13(7156).LayerScope, obj23);
    tmp37 = closure_21(tmp13(7162).AnalyticsLocationProvider, obj22);
    const tmp2Result2 = tmp2(7073);
  }
  return tmp37;
});
