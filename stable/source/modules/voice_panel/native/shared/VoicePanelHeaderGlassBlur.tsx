...
export default noop.memo(function HeaderGlassBlur(shown) {
  ...
  const animatedStyle = shown(4296).useAnimatedStyle(fn);
  let obj = shown(4296);
  ...
  const obj3 = shown(4296);
  fn2.__closure = { withSpring: shown(4974).withSpring, shown };
  ...
  obj5.style = items;
  const obj4 = { withSpring: shown(4974).withSpring, shown };
  ...
  items3[1] = closure_4(tmp6Result2, { style: tmp2(4411).isThemeDark(tmp7) ? tmp.strokeAlt : tmp.strokeAltLight });
