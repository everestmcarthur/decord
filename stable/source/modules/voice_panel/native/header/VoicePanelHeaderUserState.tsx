...
// Dependencies: [19, 4576, 21, 4296, 8908, 4560, 576, 17109, 17107, 9125, 5589, 12276, 504, 4561, 2]

// Module 17108 (VoicePanelHeaderUserState)
...
function useVoicePanelHeaderUserStateIcons(participant, guildId, userIcons) {
  ...
  while (iter !== undefined) {
    ...
    if (nextResult.type === useVoicePanelCardUserStateIcons.VoicePanelCardUserStateIconType.USER_VIDEO_ICON) {
      ...
      obj2.children = jsx(tmp11(9125).VideoIcon, { style: tmp.floatingIcon, state: null });
      let arr = items.push(jsx(tmp11(8908).BackgroundBlurView, { blurTheme: "dark", style: tmp.floatingIconWrapper, children: null }, "video"));
    }
    if (tmp9.type === tmp11(17109).VoicePanelCardUserStateIconType.MUTE_DEAFEN_ICON) {
      ...
      obj4.children = tmp36(tmp11(9125).MuteDeafenIcon, obj5);
      let arr2 = items.push(tmp35(tmp11(8908).BackgroundBlurView, obj4, "mute-deafen"));
    }
    continue;
  }
  if (0 !== items.length) {
...
const jsx = fn(21).jsx;
let closure_6 = ReanimatedRexport.createAnimatedComponent(fn(8908).BackgroundBlurView);
...
export default noop.memo(function VoicePanelHeaderUserState(isHeaderHidden) {
  ...
  fn.__closure = { withTiming: isHeaderHidden(4561).withTiming, isHeaderHidden, OPACITY_TIMING };
