...
// Dependencies: [19, 1956, 4576, 9492, 502, 1957, 1908, 4199, 1371, 4584, 1074, 4581, 9158, 21, 4560, 576, 504, 17115, 4713, 9176, 9137, 5589, 4556, 9218, 1114, 5095, 7, 4259, 17112, 8362, 5605, 5611, 15565, 8633, 5612, 573, 7201, 1935, 9095, 4761, 8631, 9983, 4527, 17116, 1896, 9160, 9179, 17117, 17105, 17060, 11427, 9124, 17118, 7380, 17119, 9129, 17120, 10115, 9956, 10037, 10036, 2]

// Module 17114 (VoicePanelSettingsOverview)
...
import FormComponents from "FormComponents" /* 9124 */;
import useIsSecureFramesVerified from "useIsSecureFramesVerified" /* 9137 */;
import SecureFramesPlatformUtilsDefault from "SecureFramesPlatformUtils" /* 9160 */;
import useIsSecureFramesUIEnabled from "useIsSecureFramesUIEnabled" /* 9176 */;
...
import getChannelInfoSubtitleDefault from "getChannelInfoSubtitle" /* 17115 */;
...
function ShareActivityLogsButton() {
  ...
  const obj = { onPress: callback, icon: collapsedCategories(TableRowIcon.TableRowIcon, { IconComponent: WrenchIcon.WrenchIcon, source: _modDef8633 }), label: null, trailing: null };
  let intl = util.intl;
...
function ActivityDebugToggle() {
  ...
  obj2.icon = collapsedCategories(TableRowIcon.TableRowIcon, { IconComponent: WrenchIcon.WrenchIcon, source: _modDef8633 });
...
let closure_17 = fn(9158).SECURE_FRAMES_CALL_VERIFICATION_BOTTOM_SHEET_KEY;
const jsxProd = fn(21);
...
export default noop.memo(function VoicePanelSettingsOverview(guildId) {
  ...
  const callback4 = stateFromStores1.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(17116, dependencyMap.paths), closure_17, { channelId });
  }, items10);
