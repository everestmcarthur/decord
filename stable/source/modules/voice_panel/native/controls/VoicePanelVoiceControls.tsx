...
// Dependencies: [19, 17, 1957, 12275, 21, 4560, 576, 4296, 12276, 17040, 9588, 1935, 17104, 9987, 13796, 4973, 5687, 17213, 1114, 9997, 504, 12107, 4962, 6655, 1608, 5589, 7123, 12285, 2]
...
import getEmbeddedActivityLaunchability from "getEmbeddedActivityLaunchability" /* 9588 */;
...
import MobileGoLiveEntrypointExperimentDefault from "MobileGoLiveEntrypointExperiment" /* 17104 */;
...
let closure_10 = noop.memo((arg0) => {
  ...
  if (!tmp2) {
    ...
    items[1] = hasOwnProperty(tmp3(17213).GameConsoles, obj4);
    ...
    const items1 = [hasOwnProperty(tmp3(17213).DeafenSwitch, {}), , , , ];
    const obj6 = { channel, connected: tmp2 };
    items1[1] = hasOwnProperty(tmp3(17213).AudioRouteButton, obj6);
    const obj7 = { channelId };
    items1[2] = hasOwnProperty(tmp3(17213).HideNonVideoParticipants, obj7);
    items1[3] = hasOwnProperty(tmp3(17213).HideSelfVideo, {});
    let tmp12Result = tmp2;
    if (tmp2) {
      const obj8 = { channel, connected: tmp2 };
      tmp12Result = tmp12(tmp3(17213).InviteButton, obj8);
    }
    items1[4] = tmp12Result;
    obj5.children = items1;
    items[3] = tmp7(tmp3(5687).TableRowGroup, obj5);
    items[4] = hasOwnProperty(tmp3(9997).VoiceProcessingOptions, {});
    const obj9 = { guildId: channel.guild_id };
    const items2 = [hasOwnProperty(tmp3(17213).VoiceSettingsButton, obj9), ];
    let tmp12Result2 = null != tmp6;
    if (tmp12Result2) {
      const obj10 = { stream: tmp6 };
      tmp12Result2 = tmp12(tmp3(17213).ReportStreamIssueButton, obj10);
    }
    const obj11 = { hasIcons: true, children: null };
    items2[1] = tmp12Result2;
    obj11.children = items2;
    items[5] = tmp7(tmp3(5687).TableRowGroup, obj11);
    let tmp7Result = null;
    if (tmp2) {
      tmp7Result = null;
      if (setting) {
        tmp7Result = null;
        if (embeddedActivityLaunchability === tmp3(9588).EmbeddedActivityLaunchability.CAN_LAUNCH) {
          ...
          tmp7Result = tmp7(tmp3(5687).TableRowGroup, obj12);
        }
      }
    }
    ...
    const obj14 = { openTab };
    const items4 = [hasOwnProperty(tmp3(17213).ActivitiesButton, obj14), ];
    if (tmp3(17104).MobileGoLiveEntrypointTreatment.SCREENSHARE_REPLACES_CHAT === treatment) {
      const obj15 = { openTab };
      let tmp9Result = tmp9(tmp3(17213).ChatButton, obj15);
      const obj16 = { hasIcons: true, children: null };
      items4[1] = tmp9Result;
      obj16.children = items4;
      tmp7(tmp3(5687).TableRowGroup, obj16);
    } else if (tmp3(17104).MobileGoLiveEntrypointTreatment.SCREENSHARE_REPLACES_SOUNDBOARD !== treatment) {
      const obj17 = { channel };
      tmp9Result = tmp9(tmp3(17213).ScreenshareButton, obj17);
    }
    const obj18 = { channel };
    tmp9Result = tmp9(tmp3(17213).SoundboardButton, obj18);
  }
});
