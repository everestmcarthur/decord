...
// Dependencies: [19, 14132, 12277, 12275, 21, 12276, 4296, 17175, 4974, 14439, 4963, 2]

// Module 17210 (VoicePanelControlsDimOverlay)
...
require = fn;
let closure_4 = fn(14132).BACKDROP_OPAQUE_MAX_OPACITY;
