...
// Dependencies: [32, 19, 17, 7780, 5459, 5277, 5502, 1074, 4999, 10268, 5000, 10429, 1374, 21, 7038, 10430, 4560, 1115, 576, 12390, 1477, 6981, 5682, 504, 4262, 10124, 12392, 12393, 1935, 5686, 10428, 12394, 7334, 10267, 5516, 10338, 12395, 7521, 1894, 7683, 11995, 1609, 4740, 12396, 12397, 9319, 5022, 12235, 4296, 12398, 7523, 12405, 4556, 1114, 8605, 12406, 12407, 2]
          ...
          if (" " === tmp[tmp2 - 1]) {
            ...
            if (null != result) {
              ...
              if ("gameMentionInput" === result1) {
                ...
                if (enabled) {
                  if (null == anchor2) {
                    const tmp33Result2 = tmp33(10267);
    ...
    if (type.type !== constants.EMOJI_PREMIUM_UPSELL) {
      ...
      if (type.type === tmp.TIMESTAMP_MENTION) {
        ...
        if (null != applicationCommandManager) {
          const result = tmp8(5022).formatTimestampMention(type.mention);
          tmp18 = autocompleteResultText;
          tmp19 = tmp13;
          if (null != result) {
