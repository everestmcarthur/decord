...
// Dependencies: [19, 17, 1074, 21, 4560, 576, 7162, 5123, 8180, 9929, 1178, 4556, 9930, 1114, 9931, 4707, 6992, 5431, 8399, 5587, 9932, 7072, 2]
// Exports: default

// Module 9928 (RequestToSpeakParticipantList)
...
export default function RequestToSpeakParticipantList(channel) {
  ...
  if (0 === sortedRequestToSpeakParticipants.length) {
    ...
    const obj4 = { source: require("module_9932") };
