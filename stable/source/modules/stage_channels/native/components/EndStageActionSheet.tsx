...
// Dependencies: [19, 17, 5414, 1074, 21, 4560, 576, 4527, 9088, 8597, 1178, 1114, 4556, 4975, 8399, 2]
// Exports: default

// Module 9087 (EndStageActionSheet)
...
export default function EndStageActionSheet(channel) {
  ...
  items[1] = closure_5(channel(4556).Text, obj4);
  ...
  obj5.children = closure_5(channel(4975).Button, obj6);
  ...
  obj7.children = closure_5(channel(4975).Button, obj8);
