...
// Function ID: 10075
// Name: AudienceTile
// Dependencies: [19, 17, 2021, 21, 4560, 576, 4707, 1178, 8622, 1477, 504, 5425, 4712, 6655, 1114, 8394, 10055, 4411, 10075, 2]
...
function RaisedHandIcon(rtsState) {
  ...
  const obj = { style: items, children: hasOwnProperty(native.Icon, { style: tmp.raisedHand, source: tmp5(8622), color: PRIMARY_800 }) };
