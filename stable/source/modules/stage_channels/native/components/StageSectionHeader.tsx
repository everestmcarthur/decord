...
export default function StageSectionHeader(collapsed) {
  ...
  fn.__closure = { withTiming: collapsed(4561).withTiming, collapsed };
  ...
  obj5.children = items;
  const items1 = [closure_5(collapsed(4556).Text, obj5), , ];
  ...
  let obj2 = { withTiming: collapsed(4561).withTiming, collapsed };
  const tmp7 = closure_5;
  const tmp8 = closure_3;
  obj8.children = closure_6(tmp2(1178).Icon, { source: _modDef7158, style: tmp.collapseIcon });
