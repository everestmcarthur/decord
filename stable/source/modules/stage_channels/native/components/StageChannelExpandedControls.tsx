...
// Dependencies: [19, 17, 4582, 502, 1979, 21, 4560, 4409, 576, 9589, 9477, 504, 5417, 9094, 10019, 2]
...
const useChannelVideoLimitDefault = tmp2(9094);
const require = fn;
...
export default noop.memo((channel) => {
  ...
  if (tmp11) {
    ...
    obj5.disabled = tmp12;
    items5.push(tmp9(tmp5(10019).ScreenshareButton, obj5));
  }
