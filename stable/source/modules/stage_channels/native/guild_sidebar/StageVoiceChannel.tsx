...
// Dependencies: [19, 17, 7527, 4199, 4575, 4741, 4584, 1962, 1074, 10123, 21, 1114, 4560, 576, 504, 5417, 16241, 5431, 5425, 5057, 5569, 1874, 8394, 10918, 4713, 9477, 16119, 16230, 16124, 2]
...
let obj = { voiceStates: { marginLeft: 36, marginBottom: 8 }, container: { marginVertical: fn(10123).CHANNEL_MARGIN_VERTICAL, marginHorizontal: 8, borderRadius: nativeDefault.radii.md } };
...
export default noop.memo((channel) => {
  ...
  let obj = channel(504);
  const stageParticipantsCount = channel(5431).useStageParticipantsCount(channel.id, tmp2(5425).StageChannelParticipantNamedIndex.AUDIENCE);
  ...
  if (null != channel.userLimit) {
    ...
    const obj3 = {};
    const obj4 = { accessible: true, accessibilityRole: "button", accessibilityLabel: formatToPlainStringResult1 };
    ...
    obj3.channelInfo = tmp12(tmp5(16230), obj5);
    ...
    if (tmp12Result) {
      ...
      obj6.children = tmp12(tmp5(16124), obj7);
  ...
  if (sum > 0) {
    ...
    formatToPlainStringResult1 = intl3.formatToPlainString(tmp2(1114).t["7yr3Qc"], obj8);
  }
});
