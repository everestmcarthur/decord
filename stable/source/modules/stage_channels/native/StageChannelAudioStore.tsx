...
// Dependencies: [17, 9089, 1957, 4583, 17124, 9090, 504, 573, 2]

// Module 17123 (StageChannelAudioStore)
import _mod17 from "module_17" /* 17 */;
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import VoiceCallTypes from "VoiceCallTypes" /* 9090 */;
import DefaultAudioRouteExperimentDefault from "DefaultAudioRouteExperiment" /* 17124 */;
...
function handleAudioRouteChanged() {
  if (c8) {
    ...
    if (flag2) {
      if (currentRouteType !== tmp3(9090).RouteTypes.SPEAKER) {
        if (currentRouteType !== tmp3(9090).RouteTypes.BLUETOOTH) {
          if (currentRouteType !== tmp3(9090).RouteTypes.WIRED) {
