...
export default function NotificationReactivationActionSheet(location) {
  ...
  const items2 = [closure_8(closure_5, { style: tmp.image, source: _modDef17461, resizeMode: "contain" }), , , ];
  ...
  items2[1] = closure_8(_location(4556).Text, obj4);
  ...
  items2[2] = closure_8(_location(4556).Text, obj5);
  ...
  const items3 = [closure_8(_location(4975).Button, obj7), ];
  ...
  items3[1] = closure_8(_location(4975).Button, obj8);
  obj6.children = items3;
  items2[3] = closure_9(_location(5433).ButtonGroup, obj6);
