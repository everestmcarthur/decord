...
// Dependencies: [19, 17, 12681, 1074, 21, 4560, 576, 5524, 1611, 4527, 12753, 1896, 5682, 5587, 12754, 4556, 1114, 8599, 12708, 4975, 2]
// Exports: default
...
export default function DiscoverabilityLanding(onNext) {
  ...
  noop = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12753, dependencyMap.paths), "Discoverability Landing", { allowPhone, allowEmail });
  }, items);
