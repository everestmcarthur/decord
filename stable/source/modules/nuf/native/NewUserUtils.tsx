...
// Function ID: 17451
// Name: NewUserUtils
// Dependencies: [5, 17, 15961, 5281, 1371, 1074, 12682, 4770, 12684, 1115, 9826, 573, 1484, 12687, 4417, 17451, 4763, 1100, 12750, 2]
...
function lastStepComplete(STEP_GUILD_TEMPLATE) {
  ...
  if (obj2.isModalOpen(NewUserModalTypes.NEW_USER_MODAL_KEY)) {
    ModalActionCreatorsDefault.popWithKey(tmp(17451).NEW_USER_MODAL_KEY);
  }
