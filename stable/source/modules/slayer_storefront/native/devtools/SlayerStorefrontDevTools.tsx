...
export default function SlayerStorefrontDevTools() {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            if (0 !== length.length) {
              ...
              c5 = 2;
              c6 = 1;
              const obj5 = { value: length(10821).fetchSKU(length), done: false };
              return obj5;
            } else {
              c6 = 3;
            }
  ...
  const callback2 = noop.useCallback(() => {
    callback((skuId) => {
      ...
      const result = closure_0(10802).openSocialLayerStorefrontProductGiftPurchaseSuccessModal(obj2);
    });
  }, items4);
  ...
  if (tmp15Result) {
    ...
    tmp15Result = tmp15(tmp5(5605).TableRow, obj8);
  }
