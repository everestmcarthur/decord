...
// Dependencies: [32, 19, 17, 5510, 7228, 10805, 1074, 21, 672, 576, 4560, 5682, 10806, 8308, 5587, 4556, 1114, 10807, 1178, 1925, 4802, 1611, 9372, 504, 7168, 7165, 7226, 7182, 4992, 1242, 10802, 10803, 1115, 4231, 10808, 9371, 10809, 10818, 7231, 5631, 5680, 4987, 8831, 10822, 3417, 4975, 8098, 8084, 10825, 10827, 2]
// Exports: default

// Module 10804 (SocialLayerStorefrontProductDetailsModal)
...
import carouselMediaItems from "carouselMediaItems" /* 10806 */;
import StorefrontNativeUtils from "StorefrontNativeUtils" /* 10807 */;
import redirectToSlayerStorefrontWebDefault from "redirectToSlayerStorefrontWeb" /* 10808 */;
...
function SKUNameAndDescriptionSection(sku) {
  ...
  if (!obj.isNullOrEmpty(sku.name)) {
    ...
    const items = [closure_1_14(tmp2(4556).Heading, obj3), ];
...
function ItemDetailsSection(selectedItem) {
  ...
  if (!isNullOrEmptyResult) {
    ...
    tmp14 = closure_1_14(tmp8(4556).Heading, obj4);
  }
  const items = [tmp14, , ];
  ...
  if (!isNullOrEmptyResult1) {
    ...
    items1[1] = closure_1_14(tmp8(4556).Text, obj8);
  ...
  if (!isNullOrEmptyResult2) {
    ...
    tmp23 = closure_1_14(tmp8(4556).Text, obj9);
  }
  items[2] = tmp23;
  obj3.children = items;
...
function SocialLayerStorefrontProductDetailsModal(skuId) {
  ...
  const storeFront = analyticsLocations(9372).useNativeIAPPayments().storeFront;
  let obj = analyticsLocations(9372);
  ...
  const getOrFetchApplication = skuId(7168).useGetOrFetchApplication(applicationId);
  let tmp10 = getOrFetchApplication;
  const obj4 = skuId(7168);
  if (getOrFetchApplication == null) {
    tmp10 = null;
  }
  const tmp2Result = analyticsLocations(7165);
  ...
  const OTPACOMOrderExperiment = tmp4(9371).OTPACOMOrderExperiment;
  ...
  if (tmp28) {
    ...
    const items10 = [skuId];
    obj5.skuIds = items10;
    obj5.onOrderRetryCancellation = tmp4(10802).closeSocialLayerStorefrontProductDetailsModal;
    ...
    obj5.children = closure_14(tmp4(10818).HeadlessSlayerStorefrontPurchaseRunner, obj8);
    tmp41Result = tmp41(tmp2(10809), obj5, skuId);
    const tmp2Result2 = tmp2(10809);
  }
  ...
  if (null == stateFromStores) {
    ...
    const items14 = [closure_14(tmp4(5631).HeaderBackButton, obj12), ];
    ...
    obj13.children = name;
    items14[1] = closure_14(tmp4(4556).Heading, obj13);
    ...
    if (exclusive) {
      ...
      exclusive = tmp47(tmp2(4987), obj15);
    }
    ...
    if (null != tmp23) {
      ...
      if (tmp47Result) {
        ...
        tmp47Result = tmp47(tmp2(8831), obj18);
      }
    }
    const items17 = [tmp47Result, , ];
    let exclusive2 = stateFromStores.exclusive;
    if (exclusive2) {
      const obj19 = { style: tmp.exclusiveBadgeContainer, children: tmp47(tmp4(10822).ExclusiveBadge, {}) };
    ...
    if (!result) {
      ...
      obj28.children = intl2.string(tmp2(3417).gndWN7);
      tmp47Result5 = tmp47(tmp4(4556).Text, obj28);
    }
    ...
    obj30.children = closure_14(tmp4(4975).Button, obj31);
    const items21 = [closure_14(memo1, obj30), ];
    if (result1) {
      const obj32 = { icon: tmp2(8084), variant: "primary", size: "lg", disabled: tmp26, accessibilityLabel: null, onPress: null };
      const intl3 = tmp4(1114).intl;
      obj32.accessibilityLabel = intl3.string(tmp4(1114).t.QAZA5f);
      obj32.onPress = tmp46;
      result1 = tmp47(tmp4(8098).IconButton, obj32);
    }
    items21[1] = result1;
    ...
    if (result) {
      ...
      const mobileFinePrintMessageForApplication = tmp4(10825).getMobileFinePrintMessageForApplication(getOrFetchApplication, stringResult, obj34);
...
obj.header = { height: fn(5682).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", paddingHorizontal: nativeDefault.space.PX_8, gap: nativeDefault.space.PX_8, borderBottomWidth: 1, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
obj.headerTitle = { flexShrink: 1 };
let obj2 = { height: fn(5682).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", paddingHorizontal: nativeDefault.space.PX_8, gap: nativeDefault.space.PX_8, borderBottomWidth: 1, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
...
obj.hero = { marginHorizontal: nativeDefault.space.PX_16, height: fn(10806).MOBILE_HERO_HEIGHT_PX, borderRadius: nativeDefault.radii.md, overflow: "hidden", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH };
let obj16 = { marginHorizontal: nativeDefault.space.PX_16, height: fn(10806).MOBILE_HERO_HEIGHT_PX, borderRadius: nativeDefault.radii.md, overflow: "hidden", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH };
