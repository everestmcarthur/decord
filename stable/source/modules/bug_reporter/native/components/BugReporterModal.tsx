...
// Dependencies: [5, 32, 19, 17, 1371, 10189, 21, 4560, 576, 672, 1090, 4763, 1483, 504, 1114, 5624, 5128, 4259, 6992, 10191, 559, 10192, 9572, 7377, 5688, 5587, 1396, 5150, 4973, 4556, 5607, 10201, 5123, 1178, 4975, 6606, 5687, 5605, 4527, 10216, 1896, 5685, 7085, 1348, 10219, 10181, 7000, 2]
// Exports: default
  ...
  constructor(arg0) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp5(5150).launchImageLibraryAsync({ mediaType: "any", includeBase64: false, selectionLimit: 1 }), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            if (null != closure_128_0) {
              ...
              obj6.platform = tmp2(5128).UploadPlatform.REACT_NATIVE;
          ...
          try {
            ...
            if (0 === description) {
              if (arg0 === 1) {
                  ...
                  const tmp = closure_3_3(function*(arg0, value, arg2) {
                    if (c6 === 2) {
                      ...
                      try {
                          ...
                          if (arg0 === 1) {
                            ...
                            if (closure_131_5 >= 20) {
                              if (closure_131_4) {
                                ...
                                const obj5 = { key: "BUG_REPORT_BUG_SUBMITTED", icon: closure_2_1(9572), content: null, toastDurationMs: null };
                                const intl2 = closure_2_0(1114).intl;
                                obj5.content = intl2.string(closure_2_0(1114).t.jB8yOL);
                                obj5.toastDurationMs = toastDurationMs;
                                closure_2_1(4259).open(obj5);
                                const obj6 = closure_2_1(4259);
                              } else {
                                const obj7 = { key: "BUG_REPORT_FAILED_TO_SUBMIT", icon: closure_2_1(6992), content: null };
                                const intl = closure_2_0(1114).intl;
                                obj7.content = intl.string(closure_2_0(1114).t["4t1o0u"]);
                                closure_2_1(4259).open(obj7);
                                const obj4 = closure_2_1(4259);
                              }
                              c6 = 3;
                            }
                          }
                        ...
                        c5 = 1;
                        c6 = 1;
                        const obj11 = { value: closure_2_0(10192).submitReport(closure_131_0, closure_131_1, closure_131_2), done: false };
                        return obj11;
                      } catch (tmp50) {
                        c6 = tmp;
                        throw tmp50;
                ...
                if (ref.current) {
                  if (first5) {
                    let obj5 = { key: "BUG_REPORT_SUBMITTING_BUG", icon: screenshot(6992), content: null, toastDurationMs: null };
                    let intl2 = handleSubmit(1114).intl;
                    obj5.content = intl2.string(handleSubmit(1114).t.Uuqbcm);
                    obj5.toastDurationMs = toastDurationMs;
                    screenshot(4259).open(obj5);
                    closure_1_16(true);
                    first8();
                    let obj9 = screenshot(4259);
                  }
                  priority = 3;
                } else {
                  callback(true);
                  if (null == priority) {
                    let obj7 = { key: "BUG_REPORT_FAILED_TO_SUBMIT", icon: screenshot(6992), content: null };
                    let intl = handleSubmit(1114).intl;
                    obj7.content = intl.string(handleSubmit(1114).t["4t1o0u"]);
                    screenshot(4259).open(obj7);
                    callback(false);
                    priority = 3;
                    ...
                    description = 1;
                    priority = 1;
                    let obj10 = { value: handleSubmit(10191).getAttachments(first3), done: false };
                    return obj10;
                  }
                }
              }
    ...
    if (!stateFromStores) {
      ...
      obj34.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10216, dependencyMap.paths), "BugReporterFeatureActionSheet", { features: null != first7 ? first7.features : [], feature: first8, setFeature });
      };
      if (null != first8) {
        name = first8.name;
      } else {
