...
// Function ID: 8259
// Name: HeaderAvatar
// Dependencies: [19, 17, 4552, 2021, 4600, 1074, 21, 4560, 576, 1178, 504, 8259, 8167, 8260, 8248, 5123, 2]

// Module 8258 (HeaderAvatar)
...
export default noop.forwardRef((animate, ref) => {
  ...
  obj7.streaming = tmp9(8260)(activities);
  if (flag) {
    flag = !stateFromStores;
  }
  obj7.animate = flag;
  obj7.avatarDecoration = tmp10(guildId(8167).getProfilePreviewValue(obj6));
  if (null != onPress) {
    ...
    jsx(obj(5123).PressableOpacity, { ref, onPress, onLongPress: onPress, style, activeOpacity: 0.8, accessibilityRole: "imagebutton" });
  } else {
    const obj11 = { ref, style, accessibilityRole: "image", accessible: true };
    const merged3 = Object.assign(merged);
    if (undefined !== pendingAvatarSrc) {
      const obj12 = { source: null };
      const objResult = obj(8248);
