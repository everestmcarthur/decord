...
// Dependencies: [5279, 1074, 4447, 7118, 1935, 10096, 1940, 1218, 10095, 2]

// Module 17341 (CustomStatusManager)
    ...
    if (null != setting) {
      if ("0" !== setting) {
        ...
        if (diff > 0) {
          ...
          applyArgumentsResult(10095).setFocusMode(false);
          timeout1.stop();
          const tmpResult = applyArgumentsResult(10095);
        }
      }
    }
    if (null != timeout1) {
