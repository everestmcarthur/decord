...
// Dependencies: [19, 17, 7208, 21, 4560, 576, 8187, 8243, 8228, 8242, 8239, 4425, 4527, 11154, 1896, 4271, 8247, 8257, 11116, 11117, 11157, 8807, 2]
// Exports: default
...
export default function CustomStatusPreview(user) {
  ...
  const callback = noop.useCallback(() => {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11154, dependencyMap.paths), "UserProfileCustomStatusActionSheet", { user, previewText: pendingStatusText, previewEmoji: pendingStatusEmoji }, "stack");
  }, items);
