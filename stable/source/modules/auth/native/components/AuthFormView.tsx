...
// Function ID: 6973
// Name: AuthFormView
// Dependencies: [19, 17, 21, 4560, 576, 6944, 6973, 6974, 6975, 6978, 2]
// Exports: default
...
export default function AuthFormView(arg0) {
  ...
  if (tmp3) {
    ...
    if (null != headerText) {
      ...
      tmp15 = timestampProducer(tmp(6974), obj3);
    }
    const items1 = [tmp15, , ];
    let tmp17 = null;
    if (null != subHeader) {
    ...
    const items3 = [timestampProducer(tmp(6975), obj5), timestampProducer(tmp(6978), {}), ];
