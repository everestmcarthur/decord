...
// Function ID: 15952
// Name: Welcome
// Dependencies: [19, 17, 15952, 4476, 7457, 12417, 1385, 4544, 8745, 1074, 7326, 7736, 21, 4560, 576, 12663, 1114, 38, 1178, 4404, 4556, 13223, 6945, 13865, 1483, 1611, 504, 4992, 7475, 1242, 510, 6593, 5598, 15953, 15948, 1484, 5433, 4975, 4271, 5682, 11901, 2]
// Exports: default
...
function GuildTemplateCard(arg0) {
  ...
  obj.style = items;
  const items1 = [closure_1_20(hasOwnProperty, { source: _modDef13223 }), ];
...
function Centerpiece(inlineButtons) {
  ...
  const items1 = [closure_1_20(hasOwnProperty, { style: tmp3.logo, source: _mod13865 }), , ];
