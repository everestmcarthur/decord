...
// Dependencies: [1957, 2015, 1979, 1371, 1074, 4792, 1369, 1399, 7187, 8124, 1091, 576, 8125, 5028, 2]
// Exports: getChannelIconData, transformSearchableSelectOptions

// Module 8123 (NativeSearchableSelectActionComponentUtils)
      ...
      if (null != role) {
        ...
        if (null != tmp14) {
          ...
          if (tmpResult7.canGuildUseRoleIcons(tmp14, role)) {
            ...
            const tmpResult8 = tmp(7187);
          }
          if (null == roleIconData) {
            const obj2 = {};
            const merged1 = Object.assign(type);
            obj2.iconSrc = tmp(1399).ensureAvatarSource(_modDef8124).uri;
