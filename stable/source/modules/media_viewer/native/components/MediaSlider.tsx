...
// Function ID: 8275
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4560, 1115, 5598, 12, 672, 5168, 5123, 1114, 8275, 8277, 4556, 8279, 8288, 576, 2]
// Exports: default

// Module 8274 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  obj2.style = items3;
  const timeFormat = controls(5168).getTimeFormat(tmp3);
  ...
  if (paused) {
    let PauseIcon = tmp16(8275).PlayIcon;
  } else {
    PauseIcon = tmp16(8277).PauseIcon;
  }
  obj3.children = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5123).PressableOpacity, obj3), , , ];
  ...
  obj4.style = items5;
  items4[1] = closure_6(controls(4556).Text, obj4);
  ...
  items7[1] = closure_6(paused(8279), obj11);
  ...
  const tmp9Result4 = paused(8279);
  obj13.children = controls(5168).getTimeFormat(ref.current);
  items4[3] = closure_6(controls(4556).Text, obj13);
