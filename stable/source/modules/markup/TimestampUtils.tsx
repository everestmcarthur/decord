...
const TIMESTAMP_FORMATS = {
  ...
  R(toDate) {
    ...
    try {
      ...
      let fromNowResult = tmp(4153)(toDate.toDate()).fromNow();
      const tmpResultResult = tmp(4153)(toDate.toDate());
      const result6 = tmp(4153).relativeTimeThreshold("s", result);
