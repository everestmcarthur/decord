...
// Function ID: 5002
// Name: MarkupLinkRule
// Dependencies: [32, 1437, 5002, 4996, 1369, 4543, 1365, 5003, 4257, 12, 2]
...
function isSuspiciousUrl(url) {
  if (obj.isSuspiciousCodedLink(url)) {
    ...
    if (null == value) {
      const sanitizeWhitespaceResult = tmp(5002).sanitizeWhitespace(url);
      const obj3 = { whitespaceSanitized: sanitizeWhitespaceResult, fullySanitized: null };
      const tmpResult = tmp(5002);
      obj3.fullySanitized = tmp(5002).sanitizeUnicodeConfusables(sanitizeWhitespaceResult);
            ...
            if (null != tmp38) {
              if (null != validateContentTypes(rules(value4.fullySanitized, obj12), items1)) {
                ...
                if (0 === str4.trim().length) {
                  const obj13 = { type: tmp37(4996).AST_KEY.TEXT, content: tmp2 };
                  return obj13;
                } else if (tmp46(4543)(str4).length > 0) {
                  const obj14 = { type: tmp37(4996).AST_KEY.TEXT, content: tmp2 };
                  return obj14;
                } else {
                  if (str4 !== str3) {
                    if (tmp46(4543)(str3).length > 0) {
                      const obj15 = { type: tmp37(4996).AST_KEY.TEXT, content: tmp2 };
                      return obj15;
                    } else {
                      items3 = [];
                      ...
                      if (null == validateContentTypes(tmp54, items3)) {
                        const obj16 = { type: tmp37(4996).AST_KEY.TEXT, content: tmp2 };
                        return obj16;
                      }
                  ...
                  const obj17 = { content: tmp46(4257).parserFor(pickResult)(value3.whitespaceSanitized, obj12), target: tmp48.target, title: value4.whitespaceSanitized };
                  return obj17;
                }
              }
            }
