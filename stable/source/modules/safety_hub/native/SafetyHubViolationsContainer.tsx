...
// Dependencies: [32, 19, 17, 8431, 8420, 1074, 21, 4560, 576, 9056, 8594, 4556, 1114, 13577, 11158, 8419, 11, 14777, 8421, 4763, 11883, 1896, 11887, 504, 1242, 11885, 2]
...
function ClassificationDetail(classification) {
  ...
  let obj4 = {
    onPress() {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11883, dependencyMap.paths), { classificationId: id, source: React6.StandingTab });
    },
    children: null
  };
