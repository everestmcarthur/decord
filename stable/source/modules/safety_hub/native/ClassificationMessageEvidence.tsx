...
// Dependencies: [32, 19, 17, 1183, 1371, 8431, 8420, 1074, 21, 7933, 4560, 504, 4411, 11897, 11898, 8419, 4710, 8262, 8309, 11899, 8658, 4783, 11, 2]
// Exports: default

// Module 11896 (ClassificationMessageEvidence)
...
export default function ClassificationEvidence(arg0) {
  ...
  if (obj3.useStateFromStores(items1, () => ref(4411).isThemeLight(id.theme))) {
  ...
  memo = obj2.useMemo(() => {
    ...
    return attachments.map((filename) => {
      ...
      obj.filename = str;
      obj.flags = ref(8419).getSpoilerFlagsForAttachment(filename);
      obj.size = 0;
  ...
  if (first3 > 0) {
    ...
    obj5.children = first2.map((uri, index) => {
      closure_0 = uri;
      return closure_1_18(first(8309), {
        source: { uri: uri.url },
        onLoad(arg0) {
          closure_0 = arg0;
          closure_1_4((arg0) => {
