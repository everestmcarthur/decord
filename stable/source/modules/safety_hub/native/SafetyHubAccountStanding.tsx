...
// Dependencies: [32, 19, 17, 1371, 8431, 8420, 21, 8421, 14775, 4560, 576, 1114, 14769, 4520, 6610, 9631, 6616, 6940, 504, 1396, 8817, 1178, 4556, 2]
// Exports: default

// Module 14774 (SafetyHubAccountStanding)
...
import SafetyHubAccountStandingLabels from "SafetyHubAccountStandingLabels" /* 14769 */;
...
let obj = { [fn(8421).AccountStandingState.ALL_GOOD]: { left: "0%" } };
let obj2 = { left: "25%", transform: null };
let items = [{ translateX: -0.5 * fn(14775).SUBWAY_MARKER_WIDTH }];
obj2.transform = items;
obj[fn(8421).AccountStandingState.LIMITED] = obj2;
let obj4 = { left: "50%", transform: null };
let obj3 = { translateX: -0.5 * fn(14775).SUBWAY_MARKER_WIDTH };
let items1 = [{ translateX: -0.5 * fn(14775).SUBWAY_MARKER_WIDTH }];
obj4.transform = items1;
obj[fn(8421).AccountStandingState.VERY_LIMITED] = obj4;
let obj6 = { left: "75%", transform: null };
let obj5 = { translateX: -0.5 * fn(14775).SUBWAY_MARKER_WIDTH };
let items2 = [{ translateX: -0.5 * fn(14775).SUBWAY_MARKER_WIDTH }];
obj6.transform = items2;
obj[fn(8421).AccountStandingState.AT_RISK] = obj6;
let obj8 = { left: "100%", transform: null };
let obj7 = { translateX: -0.5 * fn(14775).SUBWAY_MARKER_WIDTH };
let items3 = [{ translateX: -fn(14775).SUBWAY_MARKER_WIDTH }];
obj8.transform = items3;
obj[fn(8421).AccountStandingState.SUSPENDED] = obj8;
...
const obj9 = { translateX: -fn(14775).SUBWAY_MARKER_WIDTH };
...
export default function SafetyHubAccountStanding() {
  ...
  const items5 = [closure_9(accountStanding(4556).Text, obj8), closure_9(accountStanding(4556).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
