...
// Function ID: 14471
// Name: application
// Dependencies: [4788, 4465, 1074, 9563, 9565, 14471, 8862, 9560, 9524, 1242, 1272, 8860, 2]

// Module 14470 (application)
  ...
  [RPCCommands.SEND_ANALYTICS_EVENT]: {
    ...
    handler(arg0) {
      ...
      if (tmpResult.hasApplicationFlag(application, constants.EMBEDDED_FIRST_PARTY)) {
        const activeAnalyticsSessionIDs = tmp(9524).getActiveAnalyticsSessionIDs(id);
        ...
        const tmp12 = new tmp5(9560)(obj6, "This application cannot access this API");
        throw tmp12;
      }
