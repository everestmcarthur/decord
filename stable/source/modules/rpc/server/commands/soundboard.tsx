...
// Function ID: 14511
// Name: soundboard
// Dependencies: [5, 5012, 1371, 4465, 1085, 8340, 7338, 5020, 9563, 7373, 7344, 9560, 7375, 7182, 2]
...
let obj3 = {};
let items = [fn(8340).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
let obj5 = {};
const items1 = [fn(8340).OAuth2Scopes.RPC, fn(8340).OAuth2Scopes.RPC_VOICE_WRITE];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp2(7338).maybeFetchSoundboardSounds(), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          if (result) {
            result = tmp2(7344).canUseSoundboardSound(currentUser2, sound2, closure_128_2);
            const obj = tmp2(7344);
          }
          closure_128_3 = result;
          if (null == closure_128_2) {
            const obj8 = { errorCode: constants.INVALID_CHANNEL };
            const tmp52 = new tmp5(9560)(obj8, "Invalid Channel.");
            throw tmp52;
          } else if (closure_128_3) {
            if (tmp74(7375)(closure_128_2)) {
              if (null != sound2) {
                const items = [tmp5(7182).RPC];
                tmp2(7344).playSound(sound2, closure_128_2.id, items);
                const obj4 = tmp2(7344);
              }
              c3 = 3;
              return { value: "HermesInternal", done: null };
            } else {
              const obj9 = { errorCode: constants.INVALID_PERMISSIONS };
              const tmp32 = new tmp5(9560)(obj9, "Invalid Permissions.");
              throw tmp32;
            }
          } else {
            const obj10 = { errorCode: constants.INVALID_SOUND };
            const tmp22 = new tmp74(9560)(obj10, "Invalid Sound.");
            throw tmp22;
          }
        }
      } catch (tmp56) {
