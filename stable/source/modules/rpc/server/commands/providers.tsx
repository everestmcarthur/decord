...
// Function ID: 14494
// Name: providers
// Dependencies: [5, 5281, 4465, 1074, 1920, 1085, 9563, 9565, 5283, 9560, 573, 1109, 9258, 5406, 2]
...
obj2 = {
  ...
  handler(arg0) {
    ...
    if (null == value) {
      ...
      const tmp4Result1 = new tmp4(9560)(obj4, "Platform not found for provider \"" + provider + "\"");
      throw tmp4Result1;
    } else if (provider !== constants.AMAZON_MUSIC) {
      let obj5 = { errorCode: constants2.UNAUTHORIZED_FOR_APPLICATION };
      const tmp22 = new tmp4(9560)(obj5, "Command not available for this application");
      throw tmp22;
                ...
                if (arg0 === 1) {
                  ...
                  if (null == account) {
                    ...
                    function handleConnectionsCallbackError() {
                      ...
                      const tmp = connection_redirect(9560);
                      successRedirect(new connection_redirect(9560)({ errorCode: closure_3_9.OAUTH2_ERROR }, "OAuth2 setup for \"" + closure_0 + "\" failed"));
                      const tmp2 = new connection_redirect(9560)({ errorCode: closure_3_9.OAUTH2_ERROR }, "OAuth2 setup for \"" + closure_0 + "\" failed");
                      connection_redirect(573).unsubscribe("USER_CONNECTIONS_UPDATE", closure_1_3);
                      const ComponentDispatch = closure_0(1109).ComponentDispatch;
                      ComponentDispatch.unsubscribe(constants2.CONNECTIONS_CALLBACK_ERROR, closure_1_4);
                    }
      ...
      const tmp10 = new tmp4(9560)(obj6, "Command not available for this application");
      throw tmp10;
    }
