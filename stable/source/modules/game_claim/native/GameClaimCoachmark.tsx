...
// Dependencies: [5, 19, 17, 1074, 1954, 21, 576, 16194, 10124, 4980, 4560, 16195, 8926, 1114, 5607, 5123, 5680, 4556, 4975, 8584, 7316, 2]
...
const GameClaimCardStackDefault = tmp5(16194);
require = fn;
...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    const items = [closure_8(tmp2(5123).PressableOpacity, obj3), , , , ];
    ...
    items[2] = closure_8(tmp2(4556).Text, obj5);
    ...
    items[3] = closure_8(tmp2(4556).Text, obj7);
    ...
    obj9.icon = closure_8(tmp2(8584).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj8.children = closure_8(tmp2(4975).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5607).Card, obj2);
  }
