...
// Dependencies: [19, 17, 11430, 21, 4560, 576, 4495, 4411, 13874, 13875, 504, 11794, 4153, 7123, 4556, 1114, 4975, 4763, 2]
// Exports: default
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  let stateFromStores;
  const tmp = closure_9();
  const tmp4 = stateFromStores(4495)();
  ...
  const tmp2Result2 = stateFromStores(4153);
  let expiresAt;
  if (override != null) {
    expiresAt = override.expiresAt;
  }
  const obj4 = stateFromStores(4153)();
  const durationResult = tmp2Result2.duration(stateFromStores(4153)().diff(expiresAt));
  const rect = { top: true, bottom: true, style: tmp.container, children: null };
  const obj2 = { style: tmp.content, children: null };
  const humanizeResult = tmp2Result2.duration(stateFromStores(4153)().diff(expiresAt)).humanize();
  ...
  if (null != id) {
    ...
    items3[1] = tmp14(tmp5(4556).Text, obj8);
    ...
    tmp14Result = tmp14(tmp5(4556).Text, obj10);
  }
  ...
  if (null != id) {
    ...
    obj13.children = tmp14(tmp5(4975).Button, obj14);
    ...
    items5[1] = tmp14(tmp5(4975).Button, obj15);
    ...
    tmp12Result2 = tmp14(tmp5(4975).Button, obj16);
  }
