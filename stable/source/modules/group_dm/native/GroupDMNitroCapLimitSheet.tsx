...
// Dependencies: [19, 17, 4552, 11598, 1074, 21, 4560, 576, 504, 11596, 1242, 4527, 11602, 9972, 11603, 7150, 4556, 1114, 4975, 8668, 2]
// Exports: default

// Module 11601 (GroupDMNitroCapLimitSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4527 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 9972 */;
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11602 */;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  const groupDMNitroAudience = _location(11596).useGroupDMNitroAudience();
  importDefault = tmp6;
  ...
  let obj2 = _location(11596);
  let obj3 = noop;
  obj4.acquisitionStrategy = _location(11596).GroupDMNitroAcquisitionStrategy.CHECKOUT;
  ...
  const items3 = [closure_11(_location(4556).Text, obj6), , ];
  ...
  items3[1] = closure_11(_location(4556).Text, obj8);
  ...
  obj11.text = intl3.string(_location(11596).getGroupDMNitroCapCTAMessage(groupDMNitroAudience));
  const tmp2Result = _location(11596);
  obj11.icon = closure_11(_location(8668).NitroWheelIcon, { style: tmp.nitroWheelIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: "custom" });
  ...
  obj11.onPress = tmp16;
  const items4 = [closure_11(_location(4975).Button, obj11), ];
  ...
  items4[1] = closure_11(_location(4975).Button, obj14);
  obj10.children = items4;
  items3[2] = closure_12(View, obj10);
  obj5.children = items3;
  obj13.children = closure_12(View, obj5);
  return closure_11(_location(7150).BottomSheet, obj13);
};
