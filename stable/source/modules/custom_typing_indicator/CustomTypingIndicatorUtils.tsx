...
// Dependencies: [5459, 8161, 1957, 5438, 1371, 1074, 1374, 1379, 3549, 4213, 4217, 1392, 1086, 4204, 504, 2]
...
let obj2 = {};
obj2[fn(1379).TypingSuggestion.UNSPECIFIED] = _modDef3549.kh4K4F;
obj2[fn(1379).TypingSuggestion.YAPPING] = _modDef3549.m9AeqG;
obj2[fn(1379).TypingSuggestion.VENTING] = _modDef3549["SZ0/Qu"];
obj2[fn(1379).TypingSuggestion.OVERSHARING] = _modDef3549.N8cWE8;
obj2[fn(1379).TypingSuggestion.BARKING] = _modDef3549.L5aWEN;
obj2[fn(1379).TypingSuggestion.BABBLING] = _modDef3549.AoBaEw;
obj2[fn(1379).TypingSuggestion.DAYDREAMING] = _modDef3549["3hOLod"];
obj2[fn(1379).TypingSuggestion.MEOWING] = _modDef3549["0Z9/o9"];
