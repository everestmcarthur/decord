...
// Dependencies: [32, 19, 21, 4560, 576, 7198, 7149, 1114, 3549, 5685, 11975, 5688, 2]
// Exports: default
...
export default function CustomTypingIndicatorTypingSuggestionPickerSheet(onChange) {
  ...
  obj2.title = intl.string(_modDef3549["X+ijyw"]);
  ...
  return jsx(onChange(7198).ActionSheet, { contentStyles: closure_6().content, header: null, dismissAccessibilityLabel: null, children: null });
};
