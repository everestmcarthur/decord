...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  obj6.children = closure_7(ref(11974), obj7);
  ...
  obj8.children = closure_7(ref(11974), obj9);
  ...
  obj10.children = closure_7(ref(11974), obj11);
  ...
  obj13.children = intl2.string(ref(3549).uGxDiu);
  items3[3] = closure_7(markAsDismissed(4556).Text, obj13);
  const obj14 = { variant: "text-md/normal", style: tmp2.body, color: "text-muted", children: null };
  const intl3 = markAsDismissed(1114).intl;
  obj14.children = intl3.string(ref(3549).yezU3E);
  items3[4] = closure_7(markAsDismissed(4556).Text, obj14);
  ...
  obj16.text = intl4.string(ref(3549).TswY68);
  obj16.onPress = callback;
  const items11 = [closure_7(markAsDismissed(4975).Button, obj16), ];
  ...
  items11[1] = closure_7(markAsDismissed(4975).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7123).SafeAreaPaddingView, obj2);
