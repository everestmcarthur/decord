...
// Dependencies: [19, 10100, 21, 4713, 1114, 4793, 4571, 4763, 10147, 1896, 10175, 1178, 4556, 2]
// Exports: default
...
export default function ForumThreadCreatedNotification(notification) {
  ...
  const callback1 = guild.useCallback(() => ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10147, dependencyMap.paths), { channelId: notification.parentChannel.id }), items2);
