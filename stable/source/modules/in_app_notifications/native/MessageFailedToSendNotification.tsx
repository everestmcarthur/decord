...
// Module 10184 (MessageFailedToSendNotification)
...
export default noop.memo(function MessageFailedToSendNotification(notification) {
  ...
  const tmp = closure_6();
  obj3.children = jsx(channelId(10185).RetryIcon, { size: "md", color: messageId(576).colors.ICON_SUBTLE });
  ...
  obj2.children = jsx(channelId(10112).SystemMessageText, { text: null });
  obj2.header = obj;
  obj2.onPress = callback;
  obj2.notification = notification;
  return jsx(channelId(10175).NotificationPressable, { icon: null, children: null, header: null, onPress: null, notification: null });
});
