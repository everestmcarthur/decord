...
// Function ID: 8643
// Name: NodeView
// Dependencies: [32, 19, 17, 4559, 1957, 4199, 8643, 8641, 1074, 1085, 21, 4560, 576, 5598, 4995, 4556, 4409, 4515, 504, 5123, 8644, 1483, 4962, 4971, 8638, 8636, 4740, 4272, 8646, 8650, 8651, 7123, 8654, 8655, 8656, 8657, 8662, 8663, 9041, 9042, 9043, 9044, 9045, 9046, 9047, 9058, 9061, 9062, 9067, 9068, 9081, 9082, 9083, 9086, 2]
// Exports: default

// Module 8642 (NodeView)
...
import ArrowDefault from "Arrow" /* 8644 */;
...
function ChildItem(child) {
  ...
  const items1 = [closure_16(child(4556).Text, { style: tmp.childButtonText, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: tmp3 }), ];
  if (stateFromStores) {
  ...
  if (stateFromStores) {
    ...
    stateFromStores = tmp9(tmp5(4556).Text, obj6);
  }
  ...
  return closure_16(child(5123).PressableHighlight, obj2);
}
...
const REMEDIATION_ELEMENT_TYPES = fn(8643).REMEDIATION_ELEMENT_TYPES;
const IN_APP_REPORTS_NODE = fn(8641).IN_APP_REPORTS_NODE;
