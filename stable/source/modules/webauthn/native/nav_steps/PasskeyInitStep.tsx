...
// Dependencies: [32, 19, 17, 14659, 14660, 21, 4560, 576, 504, 5692, 4556, 1114, 5433, 8098, 4518, 4527, 14672, 1896, 10255, 5687, 5605, 14674, 1483, 6597, 6951, 7377, 8599, 2]
// Exports: default
...
function CredentialList(navigation) {
  ...
  if (0 === credentials.length) {
    ...
    items1[1] = closure_8(tmp(4556).Text, obj3);
    ...
    obj4.children = credentials.map((label) => {
      ...
      obj3.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14672, dependencyMap.paths), "WEBAUTHN_DELETE_SHEET_KEY", { credential, deleting, setDeleting });
      };
    ...
    return closure_8(tmp(5687).TableRowGroup, obj4);
  }
