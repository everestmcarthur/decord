...
// Dependencies: [5, 32, 19, 2012, 1371, 1074, 21, 4560, 5682, 5519, 5138, 12324, 5520, 1971, 9853, 7123, 12338, 2]
// Exports: default

// Module 12337 (CreateGuildContainer)
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5682).NAV_BAR_HEIGHT } };
