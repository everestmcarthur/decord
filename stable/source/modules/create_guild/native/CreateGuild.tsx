...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4556).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4556).Text, obj4);
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6606).TextInput, obj6);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7201).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4556).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(4975).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(6941), obj11);
