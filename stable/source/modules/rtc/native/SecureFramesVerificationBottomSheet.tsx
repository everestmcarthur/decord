...
// Dependencies: [19, 17, 9158, 21, 4560, 576, 9164, 4527, 7150, 7149, 7199, 5123, 1114, 4556, 4973, 5095, 9171, 9174, 2]
// Exports: default

// Module 9173 (SecureFramesVerificationBottomSheet)
...
const SecureFramesConstants = fn(9158);
...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const readableSecureFramesFingerprint = onShareClick(9164).useReadableSecureFramesFingerprint({ fingerprintBase64: epochAuthenticator, chunkSize, desiredLength });
  ...
  const obj4 = { title: null, leading: closure_8(onShareClick(7199).ActionSheetCloseButton, { onPress: callback1 }), trailing: null };
  ...
  obj5.children = closure_8(onShareClick(4556).Text, obj6);
  obj4.trailing = closure_8(onShareClick(5123).PressableOpacity, obj5);
  obj3.header = closure_8(onShareClick(7149).BottomSheetTitleHeader, obj4);
  ...
  const obj = onShareClick(9164);
  let obj2 = { fingerprintBase64: epochAuthenticator, chunkSize, desiredLength };
  const tmp2 = onShareClick;
  const tmp8 = closure_9;
  const tmp9 = View;
  obj9.children = closure_8(onShareClick(5095).LockIcon, { style: tmp.icon, color: readableSecureFramesFingerprint(576).colors.TEXT_SUBTLE });
  const items1 = [closure_8(View, obj9), closure_8(onShareClick(4556).Text, { variant: "heading-xl/bold", color: "mobile-text-heading-primary", children: title }), closure_8(onShareClick(4556).Text, { style: tmp.subtitle, variant: "text-md/medium", color: "text-default", children: subtitle })];
  obj8.children = items1;
  const items2 = [closure_9(onShareClick(4973).Stack, obj8), , ];
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(tmp10(9174), obj13);
  }
  obj12.trailing = tmp7Result;
  obj12.chunks = readableSecureFramesFingerprint;
  obj12.columns = columns;
  items2[1] = closure_8(readableSecureFramesFingerprint(9171), obj12);
  ...
  return closure_8(onShareClick(7150).BottomSheet, obj3);
};
