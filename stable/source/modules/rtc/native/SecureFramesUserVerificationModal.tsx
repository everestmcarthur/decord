...
// Dependencies: [32, 19, 17, 1957, 1371, 9158, 1074, 1182, 21, 4560, 576, 504, 4712, 9162, 9164, 9137, 9165, 9156, 4763, 4259, 4520, 1114, 9166, 9167, 8362, 7162, 8180, 9168, 1178, 7123, 5123, 5628, 4556, 4973, 9169, 9171, 4975, 2]
// Exports: default

// Module 9161 (SecureFramesUserVerificationModal)
  ...
  const callback2 = fingerprintUserKey.useCallback(() => {
    if (null != fingerprint) {
      if (null != readableSecureFramesFingerprint) {
        ...
        if (enabled) {
          let userVerificationDeeplink = showShareActionSheet(9156).getUserVerificationDeeplink(tmp8, tmp);
          const showShareActionSheetResult = showShareActionSheet(9156);
        } else {
          userVerificationDeeplink = obj3.join(" ");
        }
        tmp8 = userId;
        showShareActionSheet = showShareActionSheet(8362).showShareActionSheet;
        obj2 = { message: userVerificationDeeplink };
        showShareActionSheet(obj2, constants.SECURE_FRAMES_VOICE_BOTTOM_SHEET);
        const showShareActionSheetResult1 = showShareActionSheet(8362);
      }
