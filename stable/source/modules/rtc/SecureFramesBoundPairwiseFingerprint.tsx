...
// Dependencies: [5, 502, 4583, 9158, 206, 9141, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 9163 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(9158).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
