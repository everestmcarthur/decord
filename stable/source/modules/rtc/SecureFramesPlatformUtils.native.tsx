...
// Dependencies: [1957, 4583, 9158, 1074, 4763, 9161, 1896, 4527, 9172, 1114, 4905, 1178, 7244, 9175, 2]

// Module 9160 (SecureFramesPlatformUtils)
...
export default {
  openSecureFramesStreamVerification(streamKey, channelId) {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(9172, dependencyMap.paths), timestampProducer, { streamKey, channelId });
  },
  openSecureFramesUserVerificationModal(id, id2, fn) {
    if (fn()) {
      const obj2 = { userId: id, channelId: id2 };
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9161, dependencyMap.paths), obj2, React5);
    }
  },
  ...
  handleSecureFramesUserVerificationLink(arg0) {
    ...
    if (null != channelId) {
      if (null != channel) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(9175, dependencyMap.paths), hasOwnProperty, obj);
      }
    }
