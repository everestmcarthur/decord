...
// Dependencies: [5, 502, 1957, 4579, 9158, 1074, 573, 9156, 4461, 4904, 1114, 9160, 5411, 2]

// Module 9159 (SecureFramesActionCreators)
...
let closure_7 = fn(9158).SECURE_FRAMES_PUBLIC_KEY_VERSION;
