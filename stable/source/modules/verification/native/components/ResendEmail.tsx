...
// Function ID: 6592
// Name: ResendEmail
// Dependencies: [32, 19, 17, 1951, 1371, 1074, 21, 4560, 1483, 504, 38, 6592, 5621, 5692, 4556, 1114, 4975, 6593, 4259, 2]
// Exports: default

// Module 6591 (ResendEmail)
...
export default function ResendEmail() {
  ...
  const result = verified(6592).isEmailReverification(stateFromStores1);
  let tmp16Result = !result;
  const obj4 = verified(6592);
  ...
  items4[1] = closure_9(navigation(4556).Text, obj6);
  ...
  items4[2] = closure_9(navigation(4556).Text, obj7);
  ...
  obj9.children = closure_9(navigation(4975).Button, obj10);
  ...
  if (!result) {
    ...
    obj11.children = tmp16(tmp2(4975).Button, obj12);
