...
// Dependencies: [5, 19, 17, 17512, 1951, 1371, 1074, 21, 4560, 1178, 17513, 1114, 4975, 1484, 1250, 5624, 7377, 9806, 7195, 6593, 17517, 6591, 6603, 6600, 6982, 7044, 7045, 6592, 17518, 7078, 6993, 504, 4527, 4425, 7000, 2]
// Exports: default
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17513).VerifyPhone, title: null, body: null, children: null };
  ...
  obj2.children = jsx(navigation(4975).Button, { text: null, onPress: null });
  obj.children = <View style={closure_12().button}>{null}</View>;
  return jsx(navigation(1178).EmptyState, { Illustration: navigation(17513).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(9806), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(7195).showSimpleActionSheet(obj2);
        };
      ...
      let obj10 = stateFromStores(5624);
      ...
      obj11.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      const obj13 = stateFromStores(5624);
      ...
      obj14.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5624);
      ...
      const obj19 = stateFromStores(5624);
      ...
      obj20.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      const obj22 = stateFromStores(5624);
      ...
      obj23.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      obj26.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      obj29.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      obj32.headerTitle = stateFromStores(5624).getHeaderNoTitle();
      ...
      obj35.headerTitle = stateFromStores(5624).getHeaderNoTitle();
