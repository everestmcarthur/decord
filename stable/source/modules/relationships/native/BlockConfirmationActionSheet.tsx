...
// Dependencies: [32, 19, 17, 1957, 4209, 1371, 9049, 11387, 1074, 21, 4560, 576, 8186, 1114, 4517, 5687, 5605, 1178, 1611, 7162, 7182, 504, 8182, 7150, 1242, 6627, 7931, 4556, 4712, 6969, 4527, 11389, 1896, 1250, 4975, 9048, 8405, 2024, 4255, 2]

// Module 11388 (BlockConfirmationActionSheet)
...
const UserRemediationAction = fn(9049).UserRemediationAction;
...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp2(7931) };
    ...
    const obj13 = { username: tmp2(4712).getName(stateFromStores2, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1114).t.CIbzHR, obj13);
    items9[1] = closure_14(tmp7(4556).Text, obj12);
    ...
    items9[2] = closure_14(tmp7(4556).Text, obj14);
    ...
    if (!stateFromStores1) {
      ...
      const obj19 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp2(6969) };
      ...
      obj18.onPress = function onPress() {
        ...
        const tmp2 = asyncRequireImpl(11389, dependencyMap.paths);
      ...
      obj17.children = tmp13(tmp7(5605).TableRow, obj18);
      obj16.children = tmp13(tmp7(5687).TableRowGroup, obj17);
    ...
    obj22.onPress = function onPress() {
      ...
      obj.blockUser(userId, { location: AnalyticsLocationDefault.BLOCK_CONFIRMATION_ACTION_SHEET }).then(() => {
        const result = channelId(8405).showBlockSuccessToast(userId, closure_1_1);
        if (onSuccess != null) {
          onSuccess();
        }
        const obj = channelId(8405);
    ...
    obj22.disabled = tmp6;
    obj22.loading = tmp6;
    const items11 = [closure_14(tmp7(4975).Button, obj22), ];
    ...
    items11[1] = closure_14(tmp7(4556).Text, obj23);
    obj21.children = items11;
    items10[3] = closure_15(c5, obj21);
    obj20.children = items10;
    obj5.children = closure_15(tmp7(6627).BottomSheetScrollView, obj20);
    obj4.children = closure_14(tmp7(7150).BottomSheet, obj5);
    tmp13Result2 = tmp13(tmp7(7162).AnalyticsLocationProvider, obj4);
