...
// Dependencies: [19, 17, 4209, 1074, 11387, 21, 4560, 576, 12596, 504, 9048, 10875, 12624, 4404, 4527, 11388, 1896, 8635, 4573, 4975, 1114, 4556, 2]
// Exports: default
...
export default function RestrictedMessagePreviewActions(channel) {
  ...
  const callback4 = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11388, dependencyMap.paths), closure_8, { userId: user.id, channelId: channel.id });
  }, items6);
