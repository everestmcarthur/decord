...
// Dependencies: [32, 19, 17, 1957, 4781, 1371, 21, 4560, 576, 1611, 504, 16899, 16901, 12443, 2]
// Exports: default
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [closure_10(tmp2(16899), obj6), ];
      const obj7 = { channelId };
      items8[1] = closure_10(tmp2(16901), obj7);
      ...
      obj8.children = closure_10(tmp2(12443), obj10);
