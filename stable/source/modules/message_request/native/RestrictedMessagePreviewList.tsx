...
// Dependencies: [19, 17, 4781, 21, 4560, 16902, 576, 5081, 4556, 1114, 4515, 4242, 7162, 504, 8180, 7933, 16903, 8658, 5123, 16904, 2]
// Exports: default

// Module 16901 (RestrictedMessagePreviewList)
...
import RestrictedBlockedMessageGroupDefault from "RestrictedBlockedMessageGroup" /* 16904 */;
...
let obj2 = { container: { flexDirection: "column" }, hiddenMedia: { marginLeft: fn(16902).RESTRICTED_CONTENT_INSET }, messageRow: { position: "relative" }, avatarHitbox: null, dateDivider: null, dividerLine: null, mediaPlaceholderCard: null, mediaHiddenRow: null };
let size = { position: "absolute", top: 0, left: 0, width: fn(16902).RESTRICTED_CONTENT_INSET, height: fn(16902).RESTRICTED_AVATAR_SIZE };
obj2.avatarHitbox = size;
let obj3 = { marginLeft: fn(16902).RESTRICTED_CONTENT_INSET };
