...
// Module 10946 (InstantInviteCode)
...
export default function InstantInviteCode(invite) {
  ...
  const items1 = [closure_8(invite(4556).Text, { variant: "text-lg/bold", tabularNumbers: true, children: invite.code }), ];
  ...
  obj.children = closure_9(invite(4973).Stack, obj2);
