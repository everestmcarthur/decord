...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  const items1 = [timestampProducer(tmp9(4556).Text, obj3), , , , ];
  ...
  items1[1] = timestampProducer(tmp9(4556).Text, obj4);
  ...
  items1[2] = timestampProducer(tmp9(4556).Text, obj5);
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4556).Text, obj7);
  }
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(4975).Button, obj10);
