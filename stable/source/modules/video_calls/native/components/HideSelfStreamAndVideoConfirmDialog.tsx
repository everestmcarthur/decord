...
// Dependencies: [19, 17, 17214, 21, 4560, 1114, 4994, 4556, 9364, 2]
// Exports: default

// Module 17215 (HideSelfStreamAndVideoConfirmDialog)
...
const constants = fn(17214).SelfStreamAndVideoAlertType;
const jsxProd = fn(21);
...
export default function HideSelfStreamAndVideoConfirmDialog(arg0) {
  ...
  const items = [closure_5(tmp6(4556).Text, { style: tmp2.description, variant: "text-sm/medium", children: stringResult1 }), ];
  const obj4 = {
  ...
  items[1] = closure_5(tmp6(4556).Text, obj4);
  obj2.children = items;
