...
// Dependencies: [17, 1074, 21, 4560, 576, 9116, 9607, 4556, 1114, 4975, 9618, 4615, 9095, 2]
// Exports: default
...
import VideoStreamReadyActionCreators from "VideoStreamReadyActionCreators" /* 9618 */;
...
export default function UserVideoFailed(arg0) {
  ...
  if (!removeSplashImage) {
    ...
    tmp9 = closure_5(tmp3(9607).StreamFailed, obj3);
  }
  ...
  if (!removeRetryButton) {
    ...
    tmp11Result = tmp11(tmp3(4975).Button, obj8);
  }
