...
// Dependencies: [19, 17, 1074, 21, 4560, 576, 9598, 6655, 1178, 9599, 4556, 1114, 2]
// Exports: default

// Module 9597 (ScreenshareTile)
...
export default function ScreenShareTile(onSingleTap) {
  ...
  items[1] = timestampProducer(React4, { source: _modDef9599, style: tmp.image, resizeMode: "contain" });
