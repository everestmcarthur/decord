...
// Dependencies: [19, 17, 9473, 21, 4560, 576, 9947, 1611, 9595, 12, 9477, 4495, 5125, 10082, 9487, 11345, 5123, 1114, 1178, 11584, 12778, 2]

// Module 10081 (ChannelVoiceChat)
...
const useIsVoiceChatFocused = fn(9473).useIsVoiceChatFocused;
const jsxProd = fn(21);
...
export default noop.memo((channel) => {
  ...
  const top = tmp6.top;
  ({ left, right } = tmp6);
  const voiceChatNavigationContext = id(9595).useVoiceChatNavigationContext();
  let openVoice;
  ...
  const obj = noop;
  const obj2 = id(9595);
  const isConnectedToVoiceChannel = id(9477).useIsConnectedToVoiceChannel(channel.channel);
  const tmp7Result = id(9477);
  ...
  if (!flag) {
    ...
    obj6.barStyle = str2;
    tmp16Result = tmp16(tmp4(9487), obj6);
    const tmp19 = !tmp2;
    const tmp4Result = tmp4(9487);
  }
  ...
  items3[3] = closure_6(guild_id(11345), { guildId: guild_id, channelId: id, chatInputRef: ref, screenIndex: "voice-panel" });
  ...
  obj10.children = closure_6(id(1178).Icon, { source: guild_id(11584), size: id(1178).Icon.Sizes.MEDIUM });
  const items7 = [closure_6(id(5123).PressableOpacity, obj10), ];
  const obj11 = { source: guild_id(11584), size: id(1178).Icon.Sizes.MEDIUM };
  items7[1] = closure_6(View, { style: tmp.chatHeaderTitleContainer, children: closure_6(id(12778).ChannelTitle, { guildId: guild_id, channelId: id }) });
  obj9.children = items7;
  items3[4] = closure_7(View, obj9);
  obj5.children = items3;
  items2[1] = closure_7(id(10082).ChannelContainer, obj5);
