...
// Dependencies: [32, 19, 17, 9473, 1074, 21, 4560, 1178, 9495, 1477, 6981, 9498, 4296, 4974, 9499, 9500, 6655, 1115, 2]

// Module 9494 (PictureInPicture)
...
const toggleFocus = fn(9473).toggleFocus;
