...
// Dependencies: [19, 17, 1074, 21, 4560, 1178, 4296, 9684, 4561, 7123, 1477, 8457, 9685, 9689, 9480, 4962, 7162, 7182, 9639, 9697, 1242, 2]

// Module 9683 (FocusedControls)
...
import useGlobalStatusIndicatorState from "useGlobalStatusIndicatorState" /* 9685 */;
import GlobalStatusIndicator from "GlobalStatusIndicator" /* 9689 */;
...
function FocusedControlsHeader(reveal) {
  ...
  let obj2 = reveal(4296);
  fn2.__closure = { withTiming: reveal(4561).withTiming, offsetY: derivedValue, TIMING_CONFIG };
  ...
  obj4.children = closure_7(reveal(7123).SafeAreaPaddingView, rect);
  return closure_7(derivedValue(4296).View, obj4);
}
...
export default noop.memo((disableGradient) => {
  ...
  const tmp6 = globalStatusIndicatorHeightSharedValue(9684)();
  dependencyMap = tmp6;
  ...
  if (null != actionBar) {
    ...
    if (null != expandedControls) {
      ...
      tmp17Result = closure_7(tmp5(9697), obj6);
    }
  }
  items1[2] = tmp17Result;
  obj5.children = items1;
  return closure_8(globalStatusIndicatorHeightSharedValue(4296).View, obj5);
});
