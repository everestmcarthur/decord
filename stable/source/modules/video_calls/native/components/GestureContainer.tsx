...
// Dependencies: [19, 17, 9473, 9479, 21, 4560, 576, 1477, 4296, 6655, 4763, 4561, 1178, 2]
// Exports: default
...
export default function GestureContainer(children) {
  ...
  sharedValue = height(4296).useSharedValue(0);
  const Gesture = height(6655).Gesture;
  let obj = height(4296);
  ...
  fn.__closure = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4296).runOnJS, ModalActionCreators: sharedValue(4763), withTiming: height(4561).withTiming, DECELERATED_EASING: height(1178).DECELERATED_EASING };
  fn.__workletHash = 10736744030668;
  fn.__initData = __initData;
  let obj2 = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4296).runOnJS, ModalActionCreators: sharedValue(4763), withTiming: height(4561).withTiming, DECELERATED_EASING: height(1178).DECELERATED_EASING };
  ...
  const obj8 = height(4296);
  fn2.__closure = { interpolate: height(4296).interpolate, position: sharedValue, height };
  ...
  let obj3 = { interpolate: height(4296).interpolate, position: sharedValue, height };
  obj4.children = jsx(height(6655).GestureDetector, { gesture: failOffsetXResult, children: jsx(sharedValue(4296).View, { style: animatedStyle, children: children.children }) });
