...
// Function ID: 9611
// Name: VideoRenderer
// Dependencies: [32, 19, 17, 21, 4560, 9611, 9612, 9614, 1477, 1115, 8333, 9619, 9620, 9622, 4296, 2]

// Module 9610 (VideoRenderer)
...
export default noop.memo((gestureEnabled) => {
  ...
  let onReady;
  const tmp2 = onReady();
  const surfaceDirectRendererExperiment = resizeMode(9611).useSurfaceDirectRendererExperiment(userId, { location: "VideoRenderer" });
  ...
  closure_8 = tmp15;
  const obj = resizeMode(9611);
  [tmp17, c9] = first1(noop.useState(true), 2);
  width(9612)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = width(9614)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  noop.useRef(null);
  ...
  const store = resizeMode(8333).useStore((orientation) => orientation.orientation);
  ...
  if (tmp17) {
    ...
    tmp35 = closure_8(tmp18(9619), obj3);
  }
  const tmp37 = store === resizeMode(8333).OrientationType.PORTRAIT;
  const obj2 = resizeMode(8333);
  if (tmp3Result.isAndroid()) {
    ...
    const items11 = [closure_8(tmp18(9622), obj7), tmp35];
    obj6.children = items11;
    obj5.children = c9(first2, obj6);
    const items12 = [closure_8(tmp18(9620), obj5), ];
    ...
    obj12.children = closure_8(tmp18(9622), obj13);
    const items13 = [closure_8(tmp18(4296).View, obj12), ];
    let tmp48 = null;
    if (tmp37) {
    ...
    const items17 = [closure_8(tmp18(9622), obj16), tmp35];
