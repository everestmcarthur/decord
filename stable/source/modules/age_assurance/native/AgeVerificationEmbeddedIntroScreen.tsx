...
// Dependencies: [19, 1074, 21, 4560, 576, 8419, 8580, 8588, 8422, 8423, 4973, 5692, 4556, 4773, 8590, 1114, 2946, 8412, 2024, 2]
// Exports: default

// Module 8587 (AgeVerificationEmbeddedIntroScreen)
...
import AgeVerificationGetStartedModal from "AgeVerificationGetStartedModal" /* 8580 */;
import useAgeVerificationMethodsDefault from "useAgeVerificationMethods" /* 8588 */;
...
export default function AgeVerificationEmbeddedIntroScreen(arg0) {
  ...
  const isSuspendedUser = navigation(8419).useIsSuspendedUser();
  ...
  let obj = navigation(8419);
  obj7.children = navigation(4773).getAgeVerificationGetStartedTitle(entryPoint);
  const items2 = [closure_5(navigation(4556).Text, obj7), ];
  const obj9 = { variant: "text-md/medium", color: "text-strong", style: tmp.header, children: null };
  const obj8 = navigation(4773);
  obj9.children = navigation(4773).getAgeVerificationGetStartedSubtitle(entryPoint, undefined, isSuspendedUser);
  items2[1] = closure_5(navigation(4556).Text, obj9);
  obj6.children = items2;
  items1[1] = closure_6(navigation(4973).Stack, obj6);
  obj5.children = items1;
  const items3 = [closure_6(navigation(4973).Stack, obj5), closure_5(navigation(8590).AgeVerificationMethodsContainer, { ageVerificationMethods: useAgeVerificationMethodsDefault({ onClose, classificationId, onGoogleWalletSelect: callback }).ageVerificationMethods, modalSessionId })];
  obj4.children = items3;
  const items4 = [closure_6(navigation(4973).Stack, obj4), ];
  ...
  items4[1] = closure_5(navigation(4556).Text, obj11);
  obj3.children = items4;
  obj2.children = closure_6(navigation(8423).ModalContent, obj3);
  return closure_5(navigation(8422).ModalScreen, obj2);
};
