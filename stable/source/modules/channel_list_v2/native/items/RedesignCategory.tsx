...
// Dependencies: [19, 17, 7531, 7117, 4741, 10123, 21, 4560, 1115, 576, 4556, 12757, 5123, 11158, 11563, 10918, 504, 4713, 10980, 16110, 16111, 7113, 1114, 7196, 11564, 6616, 2]
// Exports: CategoryChannel, RecentlyActiveCategory, SuggestedCategory, useCategoryPressEvents

// Module 16109 (RedesignCategory)
...
import useFavoritesGuildCategoryAddActionDefault from "useFavoritesGuildCategoryAddAction" /* 10980 */;
import CategoryCollapseActionCreators from "CategoryCollapseActionCreators" /* 11563 */;
import useFavoritesGuildCategoryFullNoticeDefault from "useFavoritesGuildCategoryFullNotice" /* 16110 */;
import useFavoritesGuildCategoryLongPressDefault from "useFavoritesGuildCategoryLongPress" /* 16111 */;
import noop from "module_19" /* 19 */;
import RecentlyActiveCollapseStore from "RecentlyActiveCollapseStore" /* 7531 */;
...
function renderCategoryItem(muted) {
  ...
  if (typeof name === "string") {
    ...
    tmp34Result = closure_11(trailingAction(4556).Text, obj2);
  }
  let tmp3 = null;
  if (null != icon) {
  ...
  if (null == trailingAction) {
    ...
    if (null == note) {
      ...
      if (tmp) {
        ...
        let tmp28Result = tmp28(trailingAction(5123).PressableHighlight, obj7);
      } else {
    ...
    obj10 = tmp9(trailingAction(5123).PressableOpacity, obj10);
    obj9.children = obj10;
...
export const CategoryChannel = function CategoryChannel(channel) {
  ...
  if (null != tmp10) {
    ...
    tmp13 = closure_11(tmp2(4556).Text, obj4);
  }
  obj2.note = tmp13;
  ...
  obj7.icon = closure_11(channel(11158).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed2 ? obj3 : obj4 });
...
export const RecentlyActiveCategory = function RecentlyActiveCategory(guildId) {
  ...
  obj3 = {};
  const merged1 = Object.assign(merged);
  obj3.icon = closure_11(tmp2(11158).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed ? obj3 : obj4 });
