...
// Function ID: 16228
// Name: UnknownChannel
// Dependencies: [19, 10123, 4742, 21, 4560, 576, 4259, 1114, 4515, 4713, 10918, 16119, 2]
...
const obj3 = { marginVertical: fn(10123).CHANNEL_MARGIN_VERTICAL, marginHorizontal: 8, borderRadius: nativeDefault.radii.md };
const size = fn(2);
