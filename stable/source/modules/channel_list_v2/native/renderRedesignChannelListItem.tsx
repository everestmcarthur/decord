...
// Dependencies: [19, 17, 5418, 1961, 1957, 2012, 4584, 10123, 1964, 7534, 21, 16191, 16193, 16197, 576, 7072, 7528, 16108, 1114, 12299, 16186, 16198, 16133, 4980, 16200, 16202, 16204, 16208, 16210, 16211, 16212, 16213, 16214, 16217, 16219, 16220, 16223, 16116, 1094, 16227, 16228, 16238, 16240, 16242, 1982, 16126, 5425, 16124, 16243, 2]
...
// Module 16192 (renderRedesignChannelListItem)
...
import CategoryChannel from "CategoryChannel" /* 16108 */;
import ThreadChannelDefault from "ThreadChannel" /* 16116 */;
import VoiceUserSummary from "VoiceUserSummary" /* 16133 */;
import channel_list_v2_ChannelListUtils from "channel_list_v2/ChannelListUtils" /* 16186 */;
import ShowAllVoiceChannelsButtonDefault from "ShowAllVoiceChannelsButton" /* 16198 */;
import SectionFooterHelpers from "SectionFooterHelpers" /* 16243 */;
...
let obj = { nonChannelContainer: { marginHorizontal: 16 }, liveChannelNotice: { marginTop: fn(16191).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16191).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 }, gameClaimNotice: null, applicationAccountLinkNotice: null, showAllVoiceChannelsButtonLastShownChannelActive: null, showAllVoiceChannelsButtonLastShownChannelInactive: null };
let obj2 = { marginTop: fn(16191).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16191).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.gameClaimNotice = { marginTop: fn(16193).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16193).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj3 = { marginTop: fn(16193).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16193).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.applicationAccountLinkNotice = { marginTop: fn(16197).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16197).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj4 = { marginTop: fn(16197).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16197).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
  ...
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    if (obj.isNamedCategorySection(section)) {
      ...
      if (null != namedCategoryFromSection) {
        ...
        tmp5 = collapsedCategories(tmp(16108).CategoryChannel, obj8);
      }
      return tmp5;
    } else {
      return null;
...
export const getChannelListSectionFooterSize = function getChannelListSectionFooterSize(guildChannels, section, result) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    ...
    let num5 = 0;
    if (flag) {
      num5 = tmp3(12299).DIVIDER_HEIGHT;
    }
    return num5;
  } else {
    if (guildChannels.favoritesSectionNumber !== section) {
    ...
    return tmp3(12299).DIVIDER_HEIGHT;
  }
};
  ...
  if (channel(7528).SECTION_INDEX_CHANNEL_NOTICES === section) {
    ...
    if (null != row1) {
      if (constants.SPACER === row1) {
        ...
        const obj5 = { guild };
        obj4.children = closure_18(selectedChannelId(16200), obj5);
        tmp65 = closure_18(View, obj4);
      } else if (tmp66.MFA_WARNING === row1) {
        const obj6 = { style: obj.nonChannelContainer, children: closure_18(selectedChannelId(16202), {}) };
        tmp65 = closure_18(View, obj6);
      } else if (tmp66.LIVE_CHANNEL_NOTICE === row1) {
        const obj7 = { style: obj.liveChannelNotice, guild };
        tmp65 = closure_18(selectedChannelId(16191), obj7);
        ...
        if (null != gameClaimMarkAsDismissed) {
          ...
          obj9.children = closure_18(selectedChannelId(16193), obj10);
        ...
        if (null != applicationAccountLinkMarkAsDismissed) {
          ...
          if (null != startApplicationAccountLinkAuthorization) {
            ...
            if (null != accountLinkApplication) {
              ...
              obj11.children = closure_18(selectedChannelId(16197), obj12);
        ...
        if (tmp66.FAVORITES_SUGGESTIONS === row1) {
          tmp65 = closure_18(selectedChannelId(16204), {});
        }
      }
    }
    return tmp65;
    ...
    if (null != row2) {
      if (constants2.GUILD_ROLE_SUBSCRIPTIONS === row2) {
        ...
        tmp55Result = closure_18(selectedChannelId(16208), obj13);
      } else if (tmp32.GUILD_HOME === row2) {
        const obj14 = { guild, selected: selectedChannelId === StaticChannelRoute.GUILD_HOME };
        tmp55Result = closure_18(selectedChannelId(16210), obj14);
        ...
        tmp55Result = closure_18(tmp(16211).GuildRolesAndChannelsRow, obj15);
        ...
        tmp55Result = closure_18(selectedChannelId(16212), obj16);
        ...
        obj18.children = closure_18(tmp(16213).NewMemberActionsProgress, obj19);
        const items = [closure_18(View, obj18), closure_18(selectedChannelId(12299), {})];
        obj17.children = items;
        tmp55Result = closure_19(View, obj17);
      } else if (tmp32.GUILD_HUB_HEADER_OPTIONS === row2) {
        const obj20 = { guild };
        tmp55Result = closure_18(selectedChannelId(16214), obj20);
    ...
    if (null != channelFromSectionRow) {
      ...
      if (tmp(1094).ChannelTypes.GUILD_APP === type) {
        ...
        const items2 = [closure_18(selectedChannelId(16227), obj27), ];
        ...
        const items3 = [closure_18(selectedChannelId(16228), obj28), ];
        ...
        tmp13 = closure_18(selectedChannelId(16238), obj30);
      } else if (tmp(1094).ChannelTypes.GUILD_STAGE_VOICE === type) {
        const obj31 = { channel: record, selected: tmp5 };
        tmp13 = closure_18(selectedChannelId(16240), obj31);
      } else {
          ...
          if (tmp(1094).ChannelTypes.GROUP_DM !== type) {
            if (section === guildChannels.voiceChannelsSectionNumber) {
              if (record.isCategory()) {
                ...
                let tmp9 = closure_18(tmp(16108).CategoryChannel, obj32);
              }
              tmp13 = tmp9;
            }
            if (tmpResult.isFavoritesGuildId(guildChannels.id)) {
              if (set2.has(record.type)) {
                ...
                tmp9 = closure_18(selectedChannelId(16228), obj33);
              }
            }
            const obj34 = { channel: record, selected: tmp5 };
            tmp9 = closure_18(selectedChannelId(16227), obj34);
            tmpResult = tmp(1982);
          }
        }
        const obj35 = { channel: record, selected: tmp5 };
        tmp13 = closure_18(selectedChannelId(16242), obj35);
      }
    }
    return tmp13;
  }
...
export const getChannelListItemSize = function getChannelListItemSize(liveChannelNoticeHeight) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    ...
    if (constants.SPACER === row1) {
      ...
      return tmp(16200).getScaledGuildProgressButtonHeight(fontScale);
    } else if (tmp28.MFA_WARNING === row1) {
      return tmp(16202).getScaledGuildMFAWarningHeight(fontScale);
      ...
      return tmp(16193).getScaledGameClaimNoticeHeight(fontScale);
    } else if (tmp28.APPLICATION_ACCOUNT_LINK === row1) {
      return tmp(16197).getScaledAccountLinkBannerHeight(fontScale);
                ...
                if (tmp26.GUILD_BOOSTS !== row2) {
                  ...
                  if (tmp26.GUILD_VIBEGRATIONS !== row2) {
                    if (tmp26.GUILD_NEW_MEMBER_ACTIONS_PROGRESS_BAR === row2) {
                      num4 = 48 + tmp(12299).DIVIDER_HEIGHT;
                    } else {
                      ...
                      if (tmp26.GUILD_HUB_HEADER_OPTIONS !== row2) {
                        ...
                        if (tmp26.GUILD_SCHEDULED_EVENTS !== row2) {
                          if (tmp26.GUILD_PREMIUM_PROGRESS_BAR === row2) {
                            num4 = tmp(16223).BOOST_PROGRESS_BAR_HEIGHT + tmp(12299).DIVIDER_HEIGHT;
                          } else {
                            num4 = 0;
    ...
    if (null != channelFromSectionRow) {
      ...
      if (type1 === type) {
          ...
          if (tmp(1094).ChannelTypes.GUILD_STAGE_VOICE !== type) {
            ...
            if (tmp(1094).ChannelTypes.DM !== type) {
              ...
              if (tmp(1094).ChannelTypes.GROUP_DM !== type) {
                ...
                let sum1 = tmp31;
                if (result > 0) {
                  sum1 = tmp31 + result * tmp(16126).getVoiceUserHeight(fontScale);
                  const tmpResult12 = tmp(16126);
                }
                num = sum1;
              }
            }
        ...
        const voiceUserHeight = tmp(16126).getVoiceUserHeight(fontScale);
        ...
        if (record.type === tmp(1094).ChannelTypes.GUILD_STAGE_VOICE) {
          ...
          if (StageChannelParticipantStore.getParticipantCount(record.id, tmp(5425).StageChannelParticipantNamedIndex.AUDIENCE) > 0) {
            num3 = tmp(16124).getAudienceItemHeight(fontScale);
            const tmpResult14 = tmp(16124);
          }
        }
        let sum4 = tmp31;
        if (participantCount > 0) {
          const sum2 = tmp31 + num2;
          const sum3 = sum2 + tmp(16238).VOICE_USERS_MARGIN_TOP + voiceUserHeight * participantCount;
          sum4 = sum3 + tmp(16238).VOICE_USERS_MARGIN_BOTTOM + num3;
        }
        num = sum4;
        const tmpResult13 = tmp(16126);
      }
    }
    return num;
  }
...
export const calculateVoiceSummary = function calculateVoiceSummary(arg0) {
  ...
  if (tmpResult.getSectionFooterConfig(guildChannels, optInChannelsEnabled, section).canHaveVoiceSummary) {
    ...
    if (null == namedCategoryFromSection) {
      ...
      const sectionFooterActiveVoiceChannels = tmp(16243).getSectionFooterActiveVoiceChannels(obj2);
      let tmp5 = null;
