...
// Dependencies: [19, 17, 4552, 4251, 10123, 1074, 21, 7874, 4495, 4411, 4982, 16137, 1982, 16107, 10124, 4262, 576, 4980, 10998, 4560, 4296, 4297, 5125, 16138, 1477, 504, 1484, 4974, 4978, 13910, 1396, 5587, 16181, 2]
// Exports: useRedesignGuildHeaderHeight

// Module 16136 (RedesignGuildHeader)
...
export const useRedesignGuildHeaderHeight = function useRedesignGuildHeaderHeight(id) {
  ...
  let num6 = 0;
  if (tmp9) {
    num6 = tmp7(10124).scaleTextLineHeight(token, fontScale);
    const tmp7Result2 = tmp7(10124);
  }
