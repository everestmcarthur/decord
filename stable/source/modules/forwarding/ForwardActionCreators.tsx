...
// Dependencies: [32, 5, 1957, 4199, 1074, 4553, 8349, 7682, 1096, 7684, 1384, 7456, 11689, 4803, 2]
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (prop) {
                let guild_id = tmp2(8349).GAME_CONTENT_GUILD_ID;
            ...
            if (1 === tmp5) {
              if (arg0 === 1) {
                ...
                if (!result) {
                  result = tmp2(11689).isRatelimitedInChannel(closure_128_0, PermissionStore);
                  const obj2 = tmp2(11689);
                }
                if (!result) {
                  const obj3 = alsoForwardToChannelId(7456);
                  const id = closure_128_0.id;
                  const obj25 = { location: constants2.FORWARDING, flags: closure_128_1 };
                  dependencyMap = 2;
                  v3 = 1;
                  const obj26 = { value: obj3.sendMessage(id, alsoForwardToChannelId(7682).parse(closure_128_0, closure_128_2), false, obj25), done: false };
                  return obj26;
                }
              }
            } else if (arg0 === 1) {
