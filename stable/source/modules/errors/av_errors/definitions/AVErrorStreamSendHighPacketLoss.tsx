...
// Dependencies: [4582, 4599, 4612, 17840, 9116, 17837, 2]

// Module 17842 (AVErrorStreamSendHighPacketLoss)
  ...
  getActiveErrors() {
    ...
    if (null == currentUserActiveStream) {
      ...
      if (null == mediaEngineConnectionId) {
        ...
        const accumulatedStatsWithMinDatapoints = tmp8(17840).getAccumulatedStatsWithMinDatapoints(mediaEngineConnectionId, currentUserActiveStream.ownerId);
        let tmp6 = null;
        if (null != accumulatedStatsWithMinDatapoints) {
          if (10 < 100 * accumulatedStatsWithMinDatapoints.short.packetLossRate) {
            const obj2 = { type: tmp8(9116).AVError.STREAM_SEND_HIGH_PACKET_LOSS };
            const tmp8Result3 = tmp8(17837);
            const merged = Object.assign(tmp8Result3.getStreamErrorContext(tmp8(4612).encodeStreamKey(currentUserActiveStream)));
            const items = [obj2];
            const tmp3 = items;
            const tmp8Result4 = tmp8(4612);
          }
          tmp6 = tmp3;
        }
        return tmp6;
