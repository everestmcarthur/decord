...
// Dependencies: [19, 17, 4741, 21, 4560, 576, 10154, 1114, 4713, 1483, 5624, 7119, 7114, 504, 8599, 10156, 10157, 10161, 10168, 10174, 4975, 2]
// Exports: default
...
export default function NotificationSettingsChannel(channel) {
  ...
  if (muted) {
    ...
    obj5.subtitle = tmp(10156).getMuteBannerSubtitleFromConfig(stateFromStoresObject.config);
    obj5.onPressUnmute = callback1;
    muted = closure_6(tmp(10156).NotificationSettingsMuteBanner, obj5);
  ...
  if (isForumLikeChannelResult) {
    ...
    isForumLikeChannelResult = tmp11(tmp(10174).NotificationSettingsChannelPost, obj9);
  }
  ...
  if (!inherited) {
    ...
    obj10.children = tmp11(tmp(4975).Button, obj11);
