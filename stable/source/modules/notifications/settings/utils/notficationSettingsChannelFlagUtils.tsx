...
// Module 10154 (notficationSettingsChannelFlagUtils)
...
export const updateChannelPreset = function updateChannelPreset(guild_id, id, arg2) {
  ...
  if (arg2 === notificationSettingsPresetUtils.Presets.ALL_MESSAGES) {
    ...
    const obj2 = { message_notifications: UserNotificationSettings.ALL_MESSAGES, flags: tmp2(10155).withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ALL_MESSAGES) };
    const result = obj4.updateChannelOverrideSettings(guild_id, id, obj2, tmp2(7114).NotificationLabels.PresetAll);
    const tmp2Result = tmp2(10155);
  } else if (arg2 === tmp2(4744).Presets.MENTIONS) {
    const obj = NotificationSettingsModalActionCreatorsDefault;
    const obj3 = { message_notifications: UserNotificationSettings.ONLY_MENTIONS, flags: tmp2(10155).withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ONLY_MENTIONS) };
    const result1 = obj.updateChannelOverrideSettings(guild_id, id, obj3, tmp2(7114).NotificationLabels.PresetMentions);
    ...
    const obj5 = { message_notifications: UserNotificationSettings.NO_MESSAGES, flags: tmp2(10155).withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ONLY_MENTIONS) };
    const result2 = obj7.updateChannelOverrideSettings(guild_id, id, obj5, tmp2(7114).NotificationLabels.PresetNothing);
