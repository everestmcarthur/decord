...
// Dependencies: [14447, 1114, 14452, 14453, 1232, 2]

// Module 14451 (NotifSettingsUtils)
...
function buildChannelsAndMapping() {
  const assignedNotifSettingsAndMappings = map(14453).getAssignedNotifSettingsAndMappings();
