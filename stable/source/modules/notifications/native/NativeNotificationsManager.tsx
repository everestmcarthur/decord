...
// Dependencies: [5, 17, 7636, 4575, 1074, 3, 17809, 9693, 11, 7118, 1115, 8206, 1242, 2]
    ...
    if (logger === 2) {
      ...
      try {
        ...
        if (0 === c7) {
          ...
          c7 = 6;
          logger = 1;
          const obj11 = { value: applyArgumentsResult(8206).removeFile(closure_131_0, closure_131_2), done: false };
          return obj11;
        }
      } catch (tmp41) {
        closure_5 = tmp41;
