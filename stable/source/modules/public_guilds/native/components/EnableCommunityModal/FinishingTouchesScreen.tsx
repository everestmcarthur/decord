...
// Dependencies: [32, 19, 17, 9070, 2015, 8036, 1074, 21, 4262, 576, 504, 4204, 9069, 1086, 17627, 17669, 17668, 17666, 1114, 4556, 4973, 5687, 17678, 7201, 2024, 2]
// Exports: default
...
const PublicGuildsConstants = fn(8036);
...
export default function FinishingTouchesScreen() {
  ...
  const token = guild(4262).useToken(defaultMessageNotifications(576).modules.mobile.TABLE_ROW_PADDING);
  let obj2 = guild(4262);
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(9069).saveGuild(features.id, obj4);
      if (removeResult !== everyoneRole.permissions) {
        const items = [obj2];
        guild(17627).saveRoleSettings(features.id, items);
        const obj = guild(17627);
      }
      const obj5 = first(9069);
    }
  }, []);
  ...
  let obj4 = { headerRef: ref, currentStep: guild(17666).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [closure_16(guild(4556).Text, obj6), closure_16(closure_6, { resizeMode: "contain", source: tmp19.finishingTouches }), , ];
  ...
  items2[2] = closure_16(guild(4556).Heading, obj8);
  ...
  items2[3] = closure_16(guild(4556).Text, obj9);
  ...
  obj11.children = closure_16(guild(7201).TableSwitchRow, obj12);
  const items4 = [closure_16(defaultMessageNotifications(17678), obj11), ];
  ...
  const tmp4Result = defaultMessageNotifications(17678);
  ...
  obj15.children = closure_16(guild(7201).TableSwitchRow, obj16);
  items4[1] = closure_16(defaultMessageNotifications(17678), obj15);
  obj14.children = items4;
  const items5 = [closure_17(guild(5687).TableRowGroup, obj14), ];
  ...
  obj19.value = first1;
  obj18.children = closure_16(guild(7201).TableSwitchRow, obj19);
  items5[1] = closure_16(guild(5687).TableRowGroup, obj18);
  obj10.children = items5;
  items3[1] = closure_17(guild(4973).Stack, obj10);
  ...
  const tmp4Result4 = defaultMessageNotifications(17678);
  ...
  items3[2] = closure_16(guild(4556).Text, obj20);
  obj4.children = items3;
  return closure_17(guild(17666).EnableCommunityModalScreen, obj4);
};
