...
// Dependencies: [19, 1373, 4232, 1379, 4260, 1114, 3063, 9377, 4218, 8763, 9379, 8668, 9227, 9381, 9383, 576, 2]
// Exports: default

// Module 9376 (usePremiumFeatures)
...
import ScreenStreamIcon from "ScreenStreamIcon" /* 9227 */;
import UploadIcon from "UploadIcon" /* 9377 */;
import SuperReactionIcon from "SuperReactionIcon" /* 9379 */;
import BoostGemIcon from "BoostGemIcon" /* 9381 */;
import UserSquareIcon from "UserSquareIcon" /* 9383 */;
...
export default function usePremiumFeatures(arg0) {
  ...
  return noop.useMemo(() => {
    ...
    obj.label = intl.formatToPlainString(_modDef3063.gsE005, { totalSeats: TOTAL_PREMIUM_GROUP_USERS });
    ...
    obj3.label = intl2.string(_modDef3063["G6K/+s"]);
    ...
    obj11.label = intl8.formatToPlainString(_modDef3063.HVCRVf, { numBoosts });
