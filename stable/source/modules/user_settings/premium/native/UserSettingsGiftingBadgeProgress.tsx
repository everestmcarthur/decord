...
// Dependencies: [32, 19, 17, 8193, 21, 4560, 576, 7162, 7182, 504, 8185, 4556, 1114, 2492, 10754, 4975, 11035, 10666, 13575, 13577, 11158, 2]
// Exports: default

// Module 13574 (UserSettingsGiftingBadgeProgress)
...
let closure_8 = fn(8193).getSingleRequirementThreshold;
const jsxProd = fn(21);
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(13575).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
    if (null != nextTier) {
    ...
    if (tmp16Result) {
      ...
      tmp16Result = tmp16(tmp4(10754), obj10);
    }
    ...
    obj15.children = closure_9(tmp7(4556).Text, obj17);
    ...
    obj18.icon = closure_9(tmp7(11035).GiftIcon, obj19);
    const intl4 = tmp7(1114).intl;
    obj18.text = intl4.string(tmp4(2492).DZnomS);
    obj18.onPress = function onPress() {
      utils_openGiftModal.openGiftModal({ analyticsLocation, analyticsLocations });
    };
    items5[1] = closure_9(tmp7(4975).Button, obj18);
    ...
    const items6 = [closure_9(tmp7(4556).Text, obj22), ];
    if (tmp11Result) {
    ...
    if (tmp11Result) {
      ...
      items7[1] = tmp16(tmp7(4556).Text, obj26);
