...
// Dependencies: [19, 17, 1371, 21, 4560, 9156, 5605, 1114, 5123, 5680, 4556, 6994, 1483, 504, 4404, 7864, 15854, 8880, 2]
// Exports: default

// Module 15857 (SettingsSecureFramesVerificationsScreen)
...
function VerificationListItem(userId) {
  ...
  return jsx(userId(5605).TableRow, { label: null, subLabel: null, start: null, end: null, trailing: null });
}
...
function ClearVerificationsListFooter(userId) {
  ...
  return jsx(userId(5605).TableRow, { label: null, subLabel: null, onPress: null, start: true, end: true });
}
...
export default function SettingsSecureFramesVerificationsScreen() {
  const tmp = closure_7();
  userId = userId(6994).useSettingNavigationRoute().params.userId;
  let obj = userId(6994);
  ...
  const obj5 = userId(15854);
  obj7.ListFooterComponent = <View style={tmp.listFooter}><ClearVerificationsListFooter userId={userId} /></View>;
  obj6.children = jsx(userId(8880).FlashList, { keyExtractor, getItemType, renderItem, data: memo, contentContainerStyle: tmp.listContent, ListFooterComponent: null });
