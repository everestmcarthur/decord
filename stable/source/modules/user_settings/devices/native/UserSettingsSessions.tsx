...
// Dependencies: [32, 19, 17, 1371, 1074, 21, 4560, 5524, 576, 14674, 504, 14952, 4973, 5687, 1114, 5605, 7123, 4556, 1369, 5123, 1178, 6992, 1483, 12268, 6990, 14953, 8885, 10069, 6960, 14954, 2]
// Exports: default
...
function UserSettingsSessions() {
  ...
  let authSessions = otherSessions(14674).useAuthSessions();
  ({ currentSession, otherSessions } = authSessions);
  const obj = otherSessions(14674);
  ...
  if (null == currentSession) {
    ...
    const items1 = [closure_10(tmp2(5687).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      ...
      let tmp20Result = tmp20(tmp2(5687).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result2 = tmp21(tmp2(5605).TableRow, obj8);
    }
    items1[2] = tmp21Result2;
    obj4.children = items1;
    tmp20Result2 = tmp20(tmp2(4973).Stack, obj4);
  }
  ...
  const items3 = [closure_10(otherSessions(4556).Text, obj11), tmp20Result2];
  obj10.children = items3;
  obj9.children = closure_11(otherSessions(7123).SafeAreaPaddingView, obj10);
...
function SessionInfo(session) {
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
        ...
        if ("ios" !== trimmed) {
          if ("android" !== trimmed) {
            if ("horizon os" === trimmed) {
              const obj2 = { text: os, iconSource: _modDef10069, IconComponent: session(14954).VrHeadsetIcon };
              let tmp9 = session;
              let obj = obj2;
            } else {
              obj = { text: os, iconSource: _modDef14953, IconComponent: session(8885).ScreenIcon };
              tmp9 = session;
            }
          }
        }
        const obj3 = { text: os, iconSource: _modDef10069, IconComponent: session(6960).MobilePhoneIcon };
        tmp9 = session;
        obj = obj3;
      }
      ...
      if (!current) {
        ...
        const obj5 = { style: tmp.logoutButton, source: _modDef6992 };
        obj4.children = closure_10(tmp9(1178).Icon, obj5);
        tmp18 = closure_10(tmp9(5123).PressableOpacity, obj4);
      }
      ...
      const items1 = [closure_10(tmp9(4556).Text, obj8), ];
      ...
      if (tmp22Result) {
        ...
        const items2 = [tmp20(tmp9(4556).Text, obj10), ];
        const obj11 = { variant: "text-md/semibold", children: found[1] };
        items2[1] = tmp20(tmp9(4556).Text, obj11);
      ...
      obj12.icon = closure_10(tmp9(5605).TableRow.Icon, obj13);
      ...
      if (tmp20Result3) {
        ...
        obj14.children = tmp20(tmp9(4556).Text, obj15);
      ...
      if (tmp20Result4) {
        ...
        obj16.children = tmp20(tmp9(4556).Text, obj17);
      ...
      return closure_10(tmp9(5605).TableRow, obj12);
    }
  }
  ...
  obj19.iconSource = _modDef14953;
  obj19.IconComponent = session(8885).ScreenIcon;
  tmp9 = session;
  obj = obj19;
}
function UnknownLegacySessionsInfo() {
  ...
  obj2.icon = closure_10(require("TableRow").TableRow.Icon, { variant: "translucent", source: _modDef12268 });
