...
// Dependencies: [19, 17, 7107, 1074, 21, 576, 4560, 9247, 8892, 9437, 4515, 1611, 504, 1483, 1484, 7170, 4556, 1114, 5687, 1396, 5605, 12060, 6990, 6995, 2]
...
import applications from "applications" /* 9247 */;
...
export const DisclosureIcon = function DisclosureIcon(disclosure) {
  ...
  return noop.useMemo(() => {
    if (applications.ApplicationDisclosureType.IP_LOCATION === disclosure) {
      ...
      return closure_2_11(tmp2(8892).GlobeEarthIcon, obj2);
    } else if (tmp2(9247).ApplicationDisclosureType.DISPLAYS_ADVERTISEMENTS === tmp) {
      const obj3 = { style, size: "xs" };
      return closure_2_11(tmp2(9437).EmbedIcon, obj3);
    } else {
