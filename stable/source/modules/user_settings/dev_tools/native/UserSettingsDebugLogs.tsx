...
// Dependencies: [32, 19, 17, 1074, 21, 4560, 576, 6622, 1611, 4259, 510, 7, 4556, 7050, 15002, 1114, 15568, 4527, 15569, 8880, 2]
// Exports: default
...
export default function UserSettingsDebugLogs() {
  ...
  items4[1] = closure_8(require("module_8880").FlashList, obj8);
