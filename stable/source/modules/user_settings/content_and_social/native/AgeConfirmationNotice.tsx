...
// Dependencies: [19, 17, 8400, 21, 7301, 14691, 4255, 2024, 8412, 8414, 576, 1178, 4975, 1114, 4556, 2]
// Exports: default
...
export default function AgeConfirmationNotice() {
  sensitiveContentFilterHelpArticle = sensitiveContentFilterHelpArticle(7301).useSensitiveContentFilterHelpArticle();
  ...
  const callback = noop.useCallback(() => {
    const obj = onPress(8412);
    const result = obj.showAgeVerificationGetStartedModal({ entryPoint: sensitiveContentFilterHelpArticle(8414).AgeVerificationModalEntryPoint.CONTENT_AND_SOCIAL_NOTICE });
    const obj2 = { entryPoint: sensitiveContentFilterHelpArticle(8414).AgeVerificationModalEntryPoint.CONTENT_AND_SOCIAL_NOTICE };
  ...
  obj4.button = jsx(sensitiveContentFilterHelpArticle(4975).Button, { variant: "secondary", size: "sm", text: null, onPress: null });
