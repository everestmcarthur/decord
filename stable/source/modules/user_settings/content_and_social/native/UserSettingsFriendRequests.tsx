...
export default function UserSettingsFriendRequests() {
  ...
  const items1 = [closure_7(setting(7201).TableSwitchRow, obj3), , ];
  ...
  items1[1] = closure_7(setting(7201).TableSwitchRow, obj4);
  ...
  items1[2] = closure_7(setting(7201).TableSwitchRow, obj5);
  obj2.children = items1;
  obj.children = closure_8(setting(5687).TableRowGroup, obj2);
