...
// Dependencies: [19, 17, 1074, 21, 4560, 9232, 2024, 9270, 4556, 1114, 7123, 4975, 2]
// Exports: default

// Module 9451 (XboxLinkEducation)
...
export default function XboxLinkEducation(onClose) {
  ...
  const items = [React5(React4, { source: noop.useMemo(() => ({ uri: _modDef9270 }), []), style: tmp.image }), , ];
