...
// Dependencies: [19, 9225, 1074, 21, 4560, 1114, 5101, 9227, 5089, 9229, 1483, 2024, 9230, 9231, 2]
// Exports: default

// Module 9226 (XboxLinkLanding)
import HelpdeskUtilsDefault from "HelpdeskUtils" /* 2024 */;
import _modDef9230 from "module_9230" /* 9230 */;
...
export default function XboxLinkLanding() {
  ...
  const memo1 = noop.useMemo(() => ({ uri: _modDef9230 }), []);
  ...
  return jsx(navigation(9231).TwoWayLinkLanding, { platformType: constants2.XBOX, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
};
