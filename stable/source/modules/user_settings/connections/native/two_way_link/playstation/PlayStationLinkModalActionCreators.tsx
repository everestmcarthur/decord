...
// Dependencies: [4763, 9260, 1896, 2]

// Module 9259 (PlayStationLinkModalActionCreators)
...
export default {
  showModal(locationStack, platformType) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9260, dependencyMap.paths), { locationStack, platformType }, c3);
  },
  hideModal() {
