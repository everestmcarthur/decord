...
// Dependencies: [19, 17, 21, 4560, 9232, 9270, 4556, 1114, 7123, 4975, 2]
// Exports: PlayStationLinkSuccess

// Module 9269 (PlayStationLinkSuccess)
...
export const PlayStationLinkSuccess = function PlayStationLinkSuccess(onClose) {
  ...
  const items = [timestampProducer(React4, { source: noop.useMemo(() => ({ uri: _modDef9270 }), []), style: tmp.image }), , ];
