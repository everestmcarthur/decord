...
// Dependencies: [19, 9278, 1074, 8339, 21, 4560, 1483, 9236, 9282, 1114, 2]
// Exports: default

// Module 9281 (CrunchyrollLinkPreConnect)
...
const redirectDestination = fn(8339).CRUNCHYROLL_LINK_DEST_ORIGIN;
const jsx = fn(21).jsx;
...
export default function CrunchyrollLinkPreConnect() {
  ...
  const obj2 = { platformType: PlatformTypes.CRUNCHYROLL, onError: callback1, onNext: callback, img: _modDef9282, imgStyle: tmp.image, title: null, body: null, redirectDestination: null };
  ...
  return jsx(navigation(9236).TwoWayLinkPreConnect, { platformType: PlatformTypes.CRUNCHYROLL, onError: callback1, onNext: callback, img: _modDef9282, imgStyle: tmp.image, title: null, body: null, redirectDestination: null });
};
