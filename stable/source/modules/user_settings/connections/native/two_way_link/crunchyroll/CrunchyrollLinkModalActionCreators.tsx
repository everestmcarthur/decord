...
// Dependencies: [4763, 9277, 1896, 2]

// Module 9276 (CrunchyrollLinkModalActionCreators)
...
export default {
  showModal(locationStack) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9277, dependencyMap.paths), { locationStack }, c3);
  },
  hideModal() {
