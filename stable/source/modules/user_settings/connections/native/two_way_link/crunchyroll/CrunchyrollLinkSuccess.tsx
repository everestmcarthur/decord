...
// Dependencies: [19, 17, 21, 4560, 9232, 9285, 4556, 1114, 7123, 4975, 2]
// Exports: default

// Module 9284 (CrunchyrollLinkSuccess)
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef9285, style: tmp.image }), , ];
