...
// Dependencies: [19, 17, 7107, 502, 5281, 2025, 1074, 21, 4560, 576, 4495, 504, 13085, 7170, 5406, 4527, 14960, 1896, 9258, 14962, 8599, 4973, 14965, 14966, 2]
...
export const UserSettingsConnections = function UserSettingsConnections(selectedPlatformType) {
  ...
  if (!fetching) {
    if (!tmp7Result.isLoading) {
      ...
      obj4.children = closure_12(tmp4(4973).Stack, obj5);
      tmp14 = closure_11(tmp4(8599).Form, obj4);
    }
    return tmp14;
  }
