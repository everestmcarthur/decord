...
const forwardRefResult = noop.forwardRef((arg0, ref) => {
  ...
  if (null != stateFromStores) {
    ...
    const items3 = [closure_10(tmp3(4556).Text, obj5), , , , ];
    ...
    items3[1] = closure_10(tmp3(4556).Text, obj6);
    ...
    if (null != obj2) {
      ...
      if (null == obj2.getFieldMessage("password")) {
        ...
        tmp19Result = tmp19(tmp20(6941), obj9);
      }
    }
    ...
    obj18.loading = tmp7;
    obj10.children = closure_10(tmp3(4975).Button, obj18);
