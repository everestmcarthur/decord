...
// Dependencies: [19, 17, 4209, 1371, 1074, 8400, 21, 4560, 576, 14690, 1114, 7382, 504, 6998, 5621, 5605, 4975, 2]
...
export default noop.memo(() => {
  ...
  if (null != bannerText) {
    ...
    if (null != bannerText) {
      ...
      obj9.trailing = React7(tmp2(4975).Button, obj10);
      tmp14 = React7(tmp2(5605).TableRow, obj9);
    }
    items2[1] = tmp14;
