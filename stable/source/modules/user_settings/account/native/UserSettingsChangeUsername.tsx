...
// Dependencies: [5, 32, 19, 17, 1371, 1074, 21, 4560, 576, 4745, 14709, 4556, 1114, 1483, 504, 4218, 14710, 6990, 6984, 1272, 1484, 7864, 6606, 6998, 6938, 2]
// Exports: default

// Module 14708 (UserSettingsChangeUsername)
...
function UsernameStatusMessage(showHint) {
  ...
  const obj2 = { type: showHint(14709).NameValidationState.AVAILABLE, message: null };
  ...
  return match.with(obj, (children) => closure_1_11(showHint(4556).Text, { variant: "text-xs/medium", color: "text-feedback-critical", children })).with(obj2, (children) => closure_1_11(showHint(4556).Text, { variant: "text-xs/medium", color: "text-feedback-positive", children })).otherwise(() => {
    let tmp = null;
    if (showHint) {
