...
// Function ID: 14792
// Name: TwoFASetupScan
// Dependencies: [32, 19, 21, 4560, 576, 7190, 14789, 14785, 7123, 1178, 1114, 4556, 5123, 2]
// Exports: default

// Module 14791 (TwoFASetupScan)
...
export default function TwoFASetupScan(totpSecret) {
  ...
  const twoFASetupStyles = totpSecret(14789).useTwoFASetupStyles();
  ...
  items2[2] = closure_4(totpSecret(4556).Text, { variant: "text-md/bold", style: { textAlign: "center" }, children: totpSecret });
  ...
  items2[3] = closure_4(totpSecret(5123).PressableOpacity, obj5);
  obj2.children = items2;
  obj7.children = closure_5(totpSecret(7123).SafeAreaPaddingView, obj2);
  return closure_4(totpSecret(14785).TwoFASetupModalScreen, obj7);
};
