...
// Dependencies: [32, 19, 17, 1074, 21, 4560, 7198, 7149, 9724, 7199, 4973, 6606, 7200, 4527, 4975, 1114, 10235, 5814, 5607, 4556, 2]
// Exports: default
...
function DemoActionSheet() {
  ...
  if (first) {
    ...
    tmp14Result = tmp14(tmp15(9724).ActionSheetHeaderPressableText, obj2);
  }
  obj.leading = tmp14Result;
  let tmp14Result2 = tmp2;
  if (tmp2) {
    const obj3 = { onPress: NOOP };
    tmp14Result2 = tmp14(tmp15(7199).ActionSheetCloseButton, obj3);
  }
