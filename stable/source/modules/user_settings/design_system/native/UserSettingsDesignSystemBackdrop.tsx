...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  let obj = showBackdrop(4296);
  fn.__closure = { withSpring: showBackdrop(4974).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(4978).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(4973).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(4963).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4556).Text, obj9);
    obj7.children = tmp13(tmp8(5607).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(4958).Dialog, obj5);
  }
