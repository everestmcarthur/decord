...
// Dependencies: [19, 17, 21, 4560, 1178, 5584, 4973, 5607, 4556, 13031, 1399, 14180, 12622, 11005, 12623, 8819, 2]
// Exports: default
...
export default function UserSettingsDesignSystemPile() {
  ...
  items[0] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items = [closure_5(size(4556).Text, { variant: "text-md/medium", color: "text-subtle", children }), ];
      ...
      items[1] = closure_5(size(13031).AvatarPile, obj3);
      obj.children = items;
  ...
  items[2] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items[1] = closure_5(size(14180).AvatarDuoPile, obj3);
      obj.children = items;
      return closure_6(size(4973).Stack, obj, children);
    })
  });
  ...
  items[4] = hasOwnProperty(SampleCard, {
    ...
    children: items1.map((size) => {
      const obj = { children: null };
      items = [closure_5(size(4556).Text, { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() }), ];
      const obj2 = { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() };
      items[1] = closure_5(size(12622).GuildIconPile, { size, names: names2, totalCount: 128, children: names2.map((value, index) => closure_2_5(GuildIconDefault, { value, size }, index)) });
      obj.children = items;
