...
// Dependencies: [32, 4577, 5012, 502, 1908, 4585, 9099, 11, 1187, 510, 1940, 9098, 12, 14074, 9454, 7118, 2]

// Module 17322 (AudioSettingsManager)
...
import AudioSettingsDefaultVolumes from "AudioSettingsDefaultVolumes" /* 9099 */;
import AudioSettingsPending from "AudioSettingsPending" /* 14074 */;
...
function handleSetLocalMute(arg0) {
  ...
  if (userId !== AuthenticationStore.getId()) {
    ...
    PreloadedUserSettingsActionCreators.updateAsync("audioContextSettings", async (arg0) => {
      closure_0 = arg0;
      let result = closure_0(14074).drainPendingAudioSettings((arg0, arg1, arg2) => {
        let diff;
          ...
          if (closure_0[result][arg1] != null) {
            ...
            if (typeof DEFAULT_VOLUME_FOR_CONTEXT === "function") {
              if (arg0 === constants.STREAM) {
                let USER2 = tmp5(9099).AudioSettingsDefaultVolumes.STREAM;
              } else {
                USER2 = tmp5(9099).AudioSettingsDefaultVolumes.USER;
              }
              if (!tmp21) {
                delete tmp2[tmp];
              }
            ...
            if (arg0 === constants.STREAM) {
              let USER = tmp5(9099).AudioSettingsDefaultVolumes.STREAM;
            } else {
              USER = tmp5(9099).AudioSettingsDefaultVolumes.USER;
            }
...
let apply = apply_mod;
let closure_13 = apply.debounce(fn(9454).remoteAudioSettingsUpdate, 500, { maxWait: 500 });
