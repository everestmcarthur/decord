...
// Dependencies: [19, 17, 4582, 502, 1908, 4585, 21, 4560, 504, 38, 9095, 9984, 1114, 5605, 9991, 2]
// Exports: default
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  const items4 = [closure_9(stateFromStores1(5605).TableRow, obj5), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(5605).TableRow, obj8);
    const tmp11Result = VolumeSliderDefault;
  }
  items4[1] = tmp9Result;
  obj4.children = items4;
  return tmp8(stateFromStores1(9984).UserSettingsTableRowGroup, obj4);
};
