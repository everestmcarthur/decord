...
// Dependencies: [19, 17, 4552, 1074, 21, 4296, 4987, 4974, 4978, 4560, 576, 7162, 7182, 9398, 9368, 4975, 1114, 1178, 504, 9974, 2]
...
function SettingsAppearanceChannelListPreviewNitroUpsellComponent(theme) {
  ...
  let obj = theme(4296);
  fn.__closure = { theme, ThemeTypes, StyleSheet, withSpring: theme(4974).withSpring, springStandard: theme(4978).springStandard };
  fn.__workletHash = 16911565077998;
  fn.__initData = __initData2;
  const animatedStyle = obj.useAnimatedStyle(fn);
  const obj2 = { theme, ThemeTypes, StyleSheet, withSpring: theme(4974).withSpring, springStandard: theme(4978).springStandard };
  ...
  items1[1] = closure_10(theme(4975).Button, obj5);
...
animationEntering.__closure = { withSpring: fn(4974).withSpring, springStandard: fn(4978).springStandard };
...
animationExiting.__closure = { withSpring: fn(4974).withSpring, springStandard: fn(4978).springStandard };
...
let obj2 = { withSpring: fn(4974).withSpring, springStandard: fn(4978).springStandard };
size = fn(2);
