...
// Dependencies: [19, 17, 1074, 12414, 21, 4560, 576, 12415, 1242, 5607, 9065, 4556, 1114, 4975, 2]
// Exports: default
...
export default function NotificationPermissionSettingsHeader() {
  ...
  canSeePushNotificationNudge = canSeePushNotificationNudge(12415).useCanSeePushNotificationNudge();
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj5.children = closure_11(tmp2(9065).BellSlashIcon, obj6);
    ...
    items1[1] = closure_11(tmp2(4556).Text, obj7);
    ...
    items1[2] = closure_11(tmp2(4556).Text, obj8);
    ...
    obj10.onPress = tmp6;
    obj9.children = closure_11(tmp2(4975).Button, obj10);
    items1[3] = closure_11(View, obj9);
    obj4.children = items1;
    obj3.children = closure_12(View, obj4);
    obj2.children = closure_11(tmp2(5607).Card, obj3);
