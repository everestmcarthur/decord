...
// Dependencies: [5, 1385, 15591, 1074, 8400, 6593, 8405, 4753, 1250, 573, 15615, 2]
...
let closure_8 = async function _getGeneratedPoolById() {
  ...
  await value.then((body) => {
    ...
    if (body.ok) {
      ...
      closure_1(8405).showFailedToast(constants.GENERIC_ERROR);
      const obj = closure_1(8405);
    }
  }).catch(() => {
    closure_1_1(8405).showFailedToast(constants.GENERIC_ERROR);
    return null;
  });
  return arg1;
};
