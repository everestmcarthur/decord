...
// Dependencies: [32, 19, 17, 14686, 1954, 21, 4560, 576, 1943, 14719, 14725, 8412, 14720, 7388, 4515, 4556, 1114, 5123, 5680, 14757, 4975, 2]
// Exports: TinyBroncoAgeGroupHeader

// Module 14724 (TinyBroncoAgeGroupHeader)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import Text_Text from "Text/Text" /* 4556 */;
import AgeVerificationActionCreatorsDefault from "AgeVerificationActionCreators" /* 8412 */;
import useAgeGroupPresentation from "useAgeGroupPresentation" /* 14719 */;
...
function AccountStatusNotice(arg0) {
  ...
  if (shouldShowTinyBroncoAccountStatus) {
    ...
    if (null != tmp5[0]) {
      ...
      const obj4 = { style: tmp.noticeIcon, children: closure_8(tmp2(4515).CircleInformationIcon, { size: "xs", color: "text-link" }) };
      ...
      items[1] = closure_8(tmp2(4556).Text, obj5);
      ...
      obj7.onPress = tmp7;
      obj7.children = closure_8(tmp2(5680).XSmallIcon, { size: "sm", color: "icon-strong" });
      items[2] = closure_8(tmp2(5123).PressableOpacity, obj7);
      obj3.children = items;
...
function AgeGroupDescription(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const obj3 = { handleOnAgeGatedContentHook: tmp(14757).handleOpenAgeGatedContentSupportArticle };
    obj2.children = intl3.format(_modDef14725.gi4ulu, obj3);
    return React6(tmp(4556).Text, obj2);
  } else if (tmp(14719).AgeGroupState.TEEN === ageGroup) {
    const obj4 = { variant: "text-sm/normal", color: "text-default", children: null };
    const intl2 = tmp(1114).intl;
    const obj5 = { handleOnAgeGatedContentHook: tmp(14757).handleOpenAgeGatedContentSupportArticle, handleOnConfirmAgeHook: tmp(14719).handleShowAgeVerification };
    obj4.children = intl2.format(_modDef14725["221iML"], obj5);
    return React6(tmp(4556).Text, obj4);
  } else if (tmp(14719).AgeGroupState.UNVERIFIED === ageGroup) {
    const obj = { variant: "text-sm/normal", color: "text-default", children: null };
    const intl = tmp(1114).intl;
    obj6 = { handleOnAgeGatedContentHook: tmp(14757).handleOpenAgeGatedContentSupportArticle, handleOnConfirmAgeHook: tmp(14719).handleShowAgeVerification };
    obj.children = intl.format(_modDef14725["W0/7DD"], obj6);
...
function AgeGroupCallToAction(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const intl2 = tmp(1114).intl;
    obj2.text = intl2.string(_modDef14725["+7NlgO"]);
    obj2.onPress = tmp(14757).handleOpenAgeGatedContentSupportArticle;
    return React6(tmp(4975).Button, obj2);
  } else if (tmp(14719).AgeGroupState.UNVERIFIED === ageGroup) {
    const obj = { grow: true, variant: "secondary", size: "md", text: null, onPress: null };
    const intl = tmp(1114).intl;
    obj.text = intl.string(_modDef14725["cI+bc/"]);
    obj.onPress = tmp(14719).handleShowAgeVerification;
    return React6(tmp(4975).Button, obj);
  }
}
const View = fn(17).View;
const TINY_BRONCO_BLOG_URL = fn(14686).TINY_BRONCO_BLOG_URL;
...
let closure_12 = [];
let obj6 = {};
obj6[fn(14719).AgeGroupState.ADULT] = _modDef14725["8TWztV"];
obj6[fn(14719).AgeGroupState.TEEN] = _modDef14725.qSkhZH;
obj6[fn(14719).AgeGroupState.UNVERIFIED] = _modDef14725.vGxRDB;
let obj7 = {};
obj7[fn(14719).AgeGroupState.ADULT] = _modDef14725.t5QjmQ;
obj7[fn(14719).AgeGroupState.TEEN] = _modDef14725["41MDhK"];
obj7[fn(14719).AgeGroupState.UNVERIFIED] = _modDef14725.m95jW8;
const size = fn(2);
