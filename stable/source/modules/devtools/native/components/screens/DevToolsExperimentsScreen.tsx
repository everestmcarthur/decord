...
// Dependencies: [32, 19, 17, 4476, 502, 1979, 4477, 21, 4560, 576, 11485, 11486, 6981, 7049, 11818, 12, 1178, 8233, 7050, 7055, 7893, 4481, 4527, 5605, 4556, 1255, 11815, 5687, 7891, 7190, 4259, 4520, 7150, 7149, 2]
...
import ExperimentDevToolsUtils from "ExperimentDevToolsUtils" /* 7893 */;
...
function GuildExperimentDebugView(arg0) {
  ...
  const tmp18 = View;
  obj6.subLabel = str;
  const items1 = [closure_11(obj3(5687).TableRowGroup, { title: "Overview", hasIcons: false, children: closure_11(obj3(5605).TableRow, obj6) }), closure_11(obj3(1178).Spacer, { size: 16 }), , , , , , , ];
  const obj8 = { title: "Guild Assignments", hasIcons: false, children: null };
  const obj7 = { title: "Overview", hasIcons: false, children: closure_11(obj3(5605).TableRow, obj6) };
  obj8.children = closure_11(obj3(5605).TableRow, { label: items.join("\n") });
  items1[2] = closure_11(obj3(5687).TableRowGroup, obj8);
  ...
  items1[4] = closure_11(obj3(5687).TableRowGroup, { title: "Server Descriptor", hasIcons: false, children: closure_11(obj3(5605).TableRow, { label: str3 }) });
  items1[5] = closure_11(obj3(1178).Spacer, { size: 16 });
  if (null != override) {
    const _JSON2 = JSON;
    str2 = JSON.stringify(override, undefined, 2);
  }
  const obj10 = { title: "Server Descriptor", hasIcons: false, children: closure_11(obj3(5605).TableRow, { label: str3 }) };
  items1[6] = closure_11(obj3(5687).TableRowGroup, { title: "Override Descriptor", hasIcons: false, children: closure_11(obj3(5605).TableRow, { label: str2 }) });
  items1[7] = closure_11(obj3(1178).Spacer, { size: 16 });
  if (0 === mapped.length) {
    let mapped3 = tmp19(tmp20(5605).TableRow, { label: "none" });
  } else {
    mapped3 = mapped.map((label) => closure_1_11(obj3(dependencyMap[23]).TableRow, { label, labelLineClamp: 1 }, label));
  }
  items1[8] = closure_11(obj3(5687).TableRowGroup, { title: "Recent Exposures", hasIcons: false, children: mapped3 });
  ...
  constructor(arg0) {
    ...
    callback = closure_4.useCallback(() => {
      ClipboardUtils.copy(uRLForExperiment, () => {
        const obj = uRLForExperiment(4259);
        obj.open({ key: "experiment-link-copied", content: "Copied experiment link", IconComponent: onCopyLink(4520).CircleCheckIcon, iconColor: "status-positive" });
        if (closure_1_0 != null) {
          closure_1_0();
        }
      });
