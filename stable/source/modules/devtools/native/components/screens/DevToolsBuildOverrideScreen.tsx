...
// Dependencies: [32, 19, 17, 11430, 21, 4560, 576, 8868, 15584, 6981, 504, 11794, 4973, 5687, 5605, 4507, 7190, 4258, 15161, 4518, 5685, 5688, 6606, 4975, 1369, 2]
...
let items = [{ label: "Branch Name", value: "branch", icon: jsx(fn(8868).TagIcon, {}) }, ];
let obj5 = { label: "Branch Name", value: "branch", icon: jsx(fn(8868).TagIcon, {}) };
items[1] = { label: "Commit SHA", value: "id", icon: jsx(fn(15584).HashmarkIcon, {}) };
let obj6 = { label: "Commit SHA", value: "id", icon: jsx(fn(15584).HashmarkIcon, {}) };
const size = fn(2);
...
export default noop.memo(() => {
  ...
  obj3.paddingBottom = tmp.contentContainer.padding + first(6981)({ includeKeyboardHeight: true }).insets.bottom;
  obj2.contentContainerStyle = obj3;
  let tmp10Result = null;
  if (null != stateFromStores) {
    const obj4 = { icon: tmp7(tmp3(4507).CopyIcon, {}), label: null, subLabel: null, onPress: null };
    first = stateFromStores;
    ...
    const items1 = [tmp7(tmp3(5605).TableRow, obj4), , ];
    const obj6 = { icon: tmp7(tmp3(15161).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(11794).refreshBuildOverride, arrow: true };
    items1[1] = tmp7(tmp3(5605).TableRow, obj6);
    const obj7 = { icon: tmp7(tmp3(4518).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(11794).clearBuildOverride, arrow: true };
    items1[2] = tmp7(tmp3(5605).TableRow, obj7);
    obj5.children = items1;
    tmp10Result = tmp10(tmp3(5687).TableRowGroup, obj5);
  }
  ...
  obj10.label = jsx(first(6606).TextInput, {
    size: "md",
  ...
  obj9.children = jsx(first(5605).TableRow, { icon, label: null });
  ...
  obj2.children = jsxs(first(4973).Stack, { spacing: 16, children: null });
