...
// Dependencies: [5, 32, 19, 17, 15591, 502, 21, 11830, 9408, 11035, 15592, 11929, 15594, 9965, 15596, 13844, 15598, 15600, 15602, 15604, 10357, 15606, 15608, 15610, 15612, 7380, 4560, 576, 4973, 6606, 4975, 4527, 15614, 7150, 7149, 5687, 5605, 4511, 504, 6981, 2]
// Exports: default
...
function UserActionSheet(pool) {
  ...
  let obj = { header: closure_10(pool(7149).BottomSheetTitleHeader, { title: pool.summary, subtitle: "" + usersForPool.length + " users" }), children: null };
  ...
  obj3.children = closure_10(pool(5687).TableRowGroup, {
...
export default function DevToolsGeneratedTestUsersScreen() {
  ...
  items2[1] = closure_11(stateFromStoresArray(5687).TableRowGroup, obj6);
  obj5.children = items2;
  obj3.children = closure_11(stateFromStoresArray(4973).Stack, obj5);
