...
// Dependencies: [32, 19, 1371, 1074, 1373, 21, 4560, 504, 4218, 9310, 9319, 4259, 1114, 5123, 4556, 8668, 2]
...
const forwardRefResult = noop.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(9310)();
  _slicedToArray = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj3.children = "-" + tmp6;
    const items2 = [closure_8(tmp2(4556).Text, obj3), closure_8(tmp2(8668).NitroWheelIcon, { size: "sm" })];
    obj2.children = items2;
    tmp10 = closure_9(tmp2(5123).PressableOpacity, obj2);
  }
  return tmp10;
});
