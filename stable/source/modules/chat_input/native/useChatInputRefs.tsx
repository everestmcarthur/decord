...
// Dependencies: [19, 7780, 5502, 4901, 7681, 7687, 1371, 9491, 1074, 5000, 4553, 5598, 4425, 12, 11992, 11994, 11995, 11998, 11999, 9310, 7777, 4427, 1609, 1481, 1115, 4428, 1874, 1242, 11672, 7456, 11674, 12000, 7682, 12001, 4899, 12033, 6625, 2]
// Exports: default
...
let closure_11 = fn(9491).updateChatInputContainerHeight;
    ...
    let obj4 = {
      ...
      handleCancelEditing() {
        ...
        if (null != editingMessage) {
          ...
          tmp6(7456).endEditMessage(channel.id);
          const tmp6Result = tmp6(7456);
        }
      },
      handlePressKey(arg0) {
        const current = props.current;
          ...
          if (null != threadCreationCallback) {
            ...
            if (applicationCommandManager != null) {
              sendCommandResult = applicationCommandManager.sendCommand(state.current.text, tmp4.current.channel, (command, optionValues) => {
                ...
                obj2.params = obj4;
                const result = threadCreationCallback(12001).chatInputSendApplicationCommand(obj2);
              });
            }
            if (!sendCommandResult) {
              const text1 = chatInputTextFieldHeight(ref[14]).getText(chatInputNativeRef.current, ref3.current, (text) => {
                if (null != props.current.pendingEdit) {
                  ...
                  obj3.chatInputRef = chatInputRef;
                  obj2.params = obj3;
                  const result = chatInputProps(12001).chatInputHandleSendText(obj2);
                  const obj = chatInputProps(12001);
                }
        ...
        if (!SlowmodeStore.isChannelOnCooldown(channel)) {
          ...
          if (null != sticker) {
            if (!obj7.isStandardSticker(current2)) {
              ...
              obj.params = obj2;
              const result = tmp27(12001).chatInputValidateContentLength(obj);
              if (null != result) {
                closure_1.cancel();
                if (null != threadCreationCallback) {
                  ...
                  tmp27(11674).deletePendingReply(channel.id);
                  const tmp27Result2 = tmp27(11674);
                  tmp31(7777).saveDraft(channel.id, "", DraftType.ChannelMessage);
