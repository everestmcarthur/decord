...
// Dependencies: [19, 17, 4552, 4901, 1371, 1074, 21, 1178, 4560, 576, 4262, 4556, 1114, 5123, 6940, 504, 4277, 4794, 9182, 7962, 12426, 4378, 4296, 4561, 11674, 1242, 11672, 1100, 4793, 12427, 7777, 12215, 7847, 2]
...
function ChatInputReplyBarNoAuthor(onCancelReplying) {
  ...
  const tmp7 = map1;
  obj6.children = closure_1_12(native.Icon, { source: _modDef6940, size: native.Icon.Sizes.CUSTOM, style: tmp.floatingCloseIcon });
...
function ChatInputEditBar(onCancelEditing) {
  ...
  obj4.children = closure_1_12(native.Icon, { source: _modDef6940, size: native.Icon.Sizes.CUSTOM, style: tmp.floatingCloseIcon });
  const obj6 = { style: tmp.contextBarRow, children: null };
  const obj7 = { children: null };
  const items = [tmp8, ];
  const obj5 = { source: _modDef6940, size: native.Icon.Sizes.CUSTOM, style: tmp.floatingCloseIcon };
...
function ChatInputScheduledMessageBar(scheduledTimestamp) {
  ...
  const items = [tmp8, ];
  const obj7 = { source: _modDef6940, size: native.Icon.Sizes.CUSTOM, style: tmp.floatingCloseIcon };
