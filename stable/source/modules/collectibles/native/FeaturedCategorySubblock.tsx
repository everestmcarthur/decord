...
// Dependencies: [19, 17, 7542, 1076, 1074, 21, 4560, 1483, 8773, 504, 15821, 15826, 5123, 1114, 576, 1242, 7541, 7182, 7554, 8838, 2]
// Exports: default

// Module 15831 (FeaturedCategorySubblock)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import CollectiblesActionCreators from "CollectiblesActionCreators" /* 7541 */;
import VisibilitySensorDefault from "VisibilitySensor" /* 15826 */;
...
export default function _default(subblock) {
  ...
  dependencyMap = subblock(8773).useCollectiblesAnalyticsContext();
  const assetUrl = subblock.assetUrl;
  let obj2 = subblock(8773);
  ...
  let obj5 = { onChange: subblock(15821).useTrackProductCardImpression(subblock.categoryStoreListingId, "mobile_home", "featured_block").handleCardVisibilityChange, children: null };
  let obj4 = subblock(15821);
  ...
  obj6.onPress = function onPress() {
    ...
    if (null != stateFromStores) {
      if (tmp9.isOrbsExclusive) {
        ...
        obj3.analyticsSource = tmp(7182).COLLECTIBLES_SHOP;
  ...
  if (result) {
    ...
    result = tmp11(tmp2(8838).LimitedTimeBadge, obj11);
  }
  items1[1] = result;
  obj6.children = items1;
  obj5.children = tmp13(subblock(5123).PressableOpacity, obj6);
