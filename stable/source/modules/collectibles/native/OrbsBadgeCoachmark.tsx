...
// Dependencies: [19, 17, 21, 4560, 11193, 1114, 4418, 11132, 2]
// Exports: default, useOrbsBadgeCoachmark

// Module 11192 (OrbsBadgeCoachmark)
...
function OrbsBadgeCoachmarkImg() {
  ...
  const obj2 = { source: { uri: _modDef11193 }, style: tmp.coachmarkImage };
  obj.children = <hasOwnProperty source={{ uri: _modDef11193 }} style={tmp.coachmarkImage} />;
