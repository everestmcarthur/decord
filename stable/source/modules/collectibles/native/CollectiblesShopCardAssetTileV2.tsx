...
// Dependencies: [32, 19, 17, 1076, 21, 8770, 576, 4560, 8801, 5095, 7553, 1889, 8172, 8803, 5587, 8851, 1077, 8852, 8816, 8805, 8828, 8830, 4409, 4262, 8771, 2]

// Module 8850 (CollectiblesShopCardAssetTileV2)
...
import CheckmarkLargeBoldIcon from "CheckmarkLargeBoldIcon" /* 8801 */;
import BundleSampleV2Default from "BundleSampleV2" /* 8803 */;
import ProfileEffectSampleV2Default from "ProfileEffectSampleV2" /* 8805 */;
import AvatarDecorationSampleV2Default from "AvatarDecorationSampleV2" /* 8816 */;
import ProfileFrameSamplePreviewDefault from "ProfileFrameSamplePreview" /* 8828 */;
import NameplateCardPreviewDefault from "NameplateCardPreview" /* 8830 */;
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1889).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      let size = { skuId: product.skuId, width: tmp2(8852).FRACTIONAL_NITRO_COIN_SIZE.CARD, height: tmp2(8852).FRACTIONAL_NITRO_COIN_SIZE.CARD };
      return closure_7(tmp2(8852).FractionalNitroCoinIllustration, size);
    } else {
      ...
      if (tmp2(1889).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = { profileFrame: first, previewWidth: tmp2(8770).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32, previewHeight, profileBackgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
