...
// Dependencies: [19, 17, 1371, 1076, 21, 4560, 576, 5123, 4528, 4529, 1178, 13176, 4556, 1114, 7162, 7541, 4527, 13177, 8838, 504, 4218, 8174, 7554, 2]
...
export const EditCollectiblesListItemNone = function EditCollectiblesListItemNone(asDefault) {
  ...
  const items = [React5(native.Icon, { source: _modDef13176, size: native.IconSizes.LARGE }), ];
...
export const EditCollectiblesListItemShop = function EditCollectiblesListItemShop(analyticsSource) {
  ...
  const items1 = [closure_7(analyticsSource(1178).Icon, { source: analyticsLocations(13177), size: analyticsSource(1178).IconSizes.LARGE }), , ];
  ...
  items1[1] = closure_7(analyticsSource(4556).Text, obj3);
  items1[2] = closure_7(analyticsSource(8838).NewBadge, { style: tmp2.newIcon });
  obj.children = items1;
...
export const EditCollectiblesListItemProduct = function EditCollectiblesListItemProduct(skuId) {
  ...
  if (null == purchase) {
    if (!result) {
      ...
      let tmp14 = React5(tmp3(8838).LockBadge, obj6);
    }
    items1[1] = tmp14;
  ...
  if (result) {
    ...
    if (!isTryItOut) {
      if (null == purchase) {
        ...
        tmp15 = React5(tmp3(8838).PremiumBadge, obj7);
      } else {
        tmp15 = null;
      }
    }
