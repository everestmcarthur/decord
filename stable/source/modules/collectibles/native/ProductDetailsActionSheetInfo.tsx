...
// Dependencies: [17, 21, 4560, 576, 13150, 4556, 7554, 8848, 1114, 13151, 1889, 2]
// Exports: default

// Module 13149 (ProductDetailsActionSheetInfo)
...
import useProductDescription from "useProductDescription" /* 13150 */;
import InlinePriceTagDefault from "InlinePriceTag" /* 13151 */;
...
function ProductPurchaseStatus(product) {
  ...
  if (productPurchaseState.isPurchased) {
    ...
    let children = tmp6(tmp(4556).Text, obj3);
  } else if (tmp5) {
    ...
    children = tmp6(tmp(4556).Text, obj4);
  } else {
    children = !result;
    if (!result) {
