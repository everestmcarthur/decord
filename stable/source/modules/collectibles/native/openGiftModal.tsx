...
export const openShopGiftModal = function openShopGiftModal(items1) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11013, dependencyMap.paths), { skuId, analyticsLocations, lockedRecipientUser, onGiftModalDismiss, giftingOrigin }, c3, navigationParams);
};
