...
// Dependencies: [19, 17, 1371, 1076, 1074, 5444, 8184, 21, 4560, 576, 12142, 4556, 1114, 504, 8857, 11489, 7541, 7182, 7133, 4527, 11106, 1896, 1242, 11772, 5447, 4763, 8180, 11095, 8098, 8780, 8672, 15841, 1483, 2]
// Exports: default
...
function CollectiblesShopHeaderRight(currentScreen) {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj.action = function action() {
      ...
      obj2.analyticsSource = stateFromStores(7182).COLLECTIBLES_SHOP_MOBILE_FEATURED_PAGE_MENU_ITEM;
      obj2.screen = constants.FEATURED_PAGE;
      const result = currentScreen(7541).openCollectiblesShopMobile(obj2);
    };
    ...
    obj2.action = function action() {
      ...
      obj2.analyticsLocations = items;
      obj2.analyticsSource = stateFromStores(7182).COLLECTIBLES_SHOP_MOBILE_SHOP_ALL_MENU_ITEM;
    ...
    obj3.action = function action() {
      ...
      obj2.analyticsLocations = items;
      obj2.analyticsSource = stateFromStores(7182).COLLECTIBLES_SHOP_MOBILE_ORBS_MENU_ITEM;
