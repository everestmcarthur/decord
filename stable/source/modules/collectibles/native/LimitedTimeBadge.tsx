...
export default function LimitedTimeBadge(unpublishedAt) {
  ...
  if (hasItem) {
    ...
    obj6.children = sum;
    obj5.children = jsx(tmp2(4556).Text, { color: str2, variant: "text-xs/bold", accessibilityLabel: null, allowFontScaling: false, children: null });
