...
// Dependencies: [19, 17, 4552, 21, 4560, 576, 5624, 4763, 8856, 11095, 504, 5587, 11785, 8308, 11786, 7123, 8851, 4556, 1114, 4975, 8168, 8854, 7000, 2]
// Exports: default

// Module 13160 (OrbBadgeCollectedModal)
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    const obj4 = { uri: onPressViewBadge(11785) };
    obj3.source = obj4;
    obj3.style = tmp.background;
    let tmp9Result = tmp9(onPressViewBadge(5587), obj3);
    ...
    const obj6 = { uri: onPressViewBadge(11786) };
    obj5.source = obj6;
    obj5.poster = onPressViewBadge(11785);
    obj5.style = tmp.background;
    tmp9Result = tmp9(tmp2(8308).VideoComponent, obj5);
  ...
  const items4 = [tmp13(tmp12(5587), obj8), ];
  ...
  const items5 = [tmp13(modalKey(4556).Text, obj12), ];
  ...
  items5[1] = tmp13(modalKey(4556).Text, obj13);
  ...
  let obj = {
    screens: {
      [closure_9.ROOT]: {
        ...
        headerRight() {
          return timestampProducer(BalanceWidgetPill.BalanceWidgetPill, { initialRenderedBalance: orbBalancePriorToPurchase, balance: _mod8856.useFetchVirtualCurrencyBalance().balance });
        },
        title: ""
      }
    },
