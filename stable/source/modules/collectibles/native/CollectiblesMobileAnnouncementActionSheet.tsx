...
// Module 16947 (CollectiblesMobileAnnouncementActionSheet)
...
import _modDef16948 from "module_16948" /* 16948 */;
...
export default function CollectiblesMobileAnnouncementActionSheet(markAsDismissed) {
  ...
  obj = markAsDismissed(16949);
  obj4.source = { uri: _modDef16950 };
  ...
  items3[1] = closure_9(markAsDismissed(4556).Text, obj6);
  const obj7 = { style: tmp.featureRows, children: null };
  const obj8 = { icon: closure_9(markAsDismissed(5692).PaintIllocon, { size: 32 }), text: null };
  const intl3 = tmp2(1114).intl;
  obj8.text = intl3.string(markAsDismissed(1114).t["6ZWB0C"]);
  const items4 = [closure_9(FeatureRow, obj8), , ];
  const obj9 = { icon: closure_9(markAsDismissed(5692).HeartIllocon, { size: 32 }), text: null };
  ...
  items3[3] = closure_9(markAsDismissed(4975).Button, obj11);
  obj3.children = items3;
  obj2.children = closure_10(closure_5, obj3);
  return closure_9(markAsDismissed(7150).BottomSheet, obj2);
};
