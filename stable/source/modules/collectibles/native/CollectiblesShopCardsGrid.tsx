...
// Dependencies: [19, 17, 7542, 21, 4560, 8770, 8773, 15828, 12, 2]
// Exports: default
...
let obj2 = { rowContainer: { flexDirection: "row", gap: fn(8770).COLLECTIBLES_SHOP_CARD_GAP } };
...
export default function CollectiblesShopCardsGrid(accessibilityLabel) {
  ...
  const cardLayout = products(15828).useCardLayout();
  ...
  obj2.contentContainerStyle = { gap: products(8770).COLLECTIBLES_SHOP_CARD_GAP, paddingTop, paddingBottom, width: cardLayout.rowWidth, alignSelf: "center" };
