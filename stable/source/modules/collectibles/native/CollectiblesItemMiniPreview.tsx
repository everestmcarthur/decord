...
// Dependencies: [19, 17, 7547, 1887, 7548, 7549, 8223, 8804, 21, 576, 4560, 8816, 8828, 5587, 8829, 8807, 1886, 8824, 2]
...
let closure_8 = fn(8223).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
