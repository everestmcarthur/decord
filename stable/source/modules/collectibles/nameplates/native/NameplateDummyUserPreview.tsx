...
// Dependencies: [19, 17, 1183, 21, 1178, 576, 4560, 504, 4269, 8824, 8826, 8827, 2]
// Exports: NameplateDummyUserPreview

// Module 8823 (NameplateDummyUserPreview)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj4.children = hasOwnProperty(native.Avatar, { source: importDefault(stateFromStores ? 8826 : 8827), size: NORMAL, "aria-hidden": true, style: tmp3.avatar });
