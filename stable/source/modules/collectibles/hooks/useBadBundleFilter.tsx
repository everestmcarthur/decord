...
// Dependencies: [19, 1371, 7558, 563, 4218, 8848, 7554, 7553, 2]
    ...
    if (null != arr) {
      ...
      if (0 !== arr.length) {
        found = arr.filter((product) => {
          const obj = canUseShopDiscountsResult(8848);
