  ...
  if (null != avatarDecoration) {
    if (null != asset2) {
      ...
      if (typeof avatarDecoration === "object") {
        tmp2 = null;
        if (null != avatarDecoration) {
          const result = tmp12(1882).parseSkuIdFromServerData(avatarDecoration);
          tmp2 = null;
          if (null != result) {
      ...
      if (typeof asset2 === "object") {
        tmp6 = null;
        if (null != asset2) {
          const result1 = tmp12(1882).parseSkuIdFromServerData(asset2);
          tmp6 = null;
          if (null != result1) {
