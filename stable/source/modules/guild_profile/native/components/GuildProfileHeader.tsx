...
// Dependencies: [19, 17, 2025, 502, 2021, 9200, 21, 4560, 576, 504, 7737, 11, 1971, 8749, 8748, 4259, 4527, 7342, 5584, 4556, 5123, 8746, 1114, 2]
// Exports: default

// Module 9199 (GuildProfileHeader)
...
const getBadgeTooltip = fn(9200).getBadgeTooltip;
const jsxProd = fn(21);
