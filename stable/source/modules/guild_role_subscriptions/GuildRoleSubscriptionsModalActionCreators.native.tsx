...
// Module 17754 (GuildRoleSubscriptionsModalActionCreators)
import asyncRequireImpl from "asyncRequireImpl" /* 1896 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4763 */;
import GuildRoleSubscriptionBenefitEditorModalStateStore from "GuildRoleSubscriptionBenefitEditorModalStateStore" /* 17755 */;
...
export const showCreateBenefitModal = function showCreateBenefitModal(arg0) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(17756, dependencyMap.paths), { benefitType: type, guildId, onSave, listingId }, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditBenefitModal = function showEditBenefitModal(benefit) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(17756, dependencyMap.paths), { benefitType: benefit.ref_type, guildId, onDelete, onSave, listingId }, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditEmojisModal = function showEditEmojisModal(initialTierEmojiIds) {
  ...
  obj2.onSave = onSave;
  obj.pushLazy(asyncRequireImpl(17762, dependencyMap.paths), obj2, "GuildRoleSubscriptionEmojiEditorModal");
};
