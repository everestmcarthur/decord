...
// Module 17737 (GuildSettingsRoleSubscriptionContainer)
...
function ApplicationRejectedNotice(guildId) {
  ...
  if (null != resubmissionError) {
    ...
    let tmp14 = closure_7(tmp9(12227), obj2);
    const tmp9Result = tmp9(12227);
  } else if (null != requestRejectedNoticeText) {
    const obj3 = { notice: requestRejectedNoticeText };
    tmp14 = closure_7(tmp9(17686), obj3);
  } else if (tmp13) {
    const obj4 = { notice: null };
    const intl3 = tmp2(1114).intl;
    obj4.notice = intl3.string(tmp2(1114).t.MyJpJT);
    tmp14 = closure_7(tmp9(17686), obj4);
    const tmp9Result5 = tmp9(17686);
    ...
    tmp14 = closure_7(tmp9(17686), obj5);
    const tmp9Result6 = tmp9(17686);
  } else if (true === hasItem1) {
    const obj6 = { notice: null };
    const intl = tmp2(1114).intl;
    obj6.notice = intl.string(tmp2(1114).t.e2g9sW);
    tmp14 = closure_7(tmp9(17686), obj6);
    const tmp9Result7 = tmp9(17686);
  } else {
    tmp14 = null;
    if (true === hasItem) {
      ...
      tmp14 = closure_7(tmp9(17686), obj7);
      const tmp9Result8 = tmp9(17686);
    }
  }
  let tmp24 = null;
  if (null != tmp14) {
