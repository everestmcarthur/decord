...
function GuildServerSubscriberCount(arg0) {
  ...
  items[2] = style;
  obj.style = items;
  const items1 = [timestampProducer(Text_Text.Text, { style: tmp.subscriberCount, variant: "text-sm/medium", color: "text-overlay-light", children: subscriberCount }), timestampProducer(native.Icon, { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10307 }), ];
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp4.isLoading) {
    const obj2 = { style: tmp.cardContainer, children: closure_6(tmp2(17683), {}) };
    ...
    obj4.source = obj5;
    const items1 = [closure_6(tmp2(5587), obj4), ];
    ...
    if (tmp7Result) {
      ...
      if (tmp9Result2) {
        ...
        tmp9Result2 = tmp9(tmp10(4556).Text, obj15);
      }
