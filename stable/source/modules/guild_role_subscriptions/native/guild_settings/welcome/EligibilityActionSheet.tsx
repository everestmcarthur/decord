...
// Dependencies: [19, 1074, 21, 4560, 4527, 9069, 7382, 17690, 7150, 4556, 1114, 17694, 2]
// Exports: default
...
import EligibilityChecklistDefault from "EligibilityChecklist" /* 17694 */;
...
export default function EligibilityActionSheet(onRequireModeratorMFAClick) {
  ...
  const memo = noop.useMemo(() => ({
    actions: {
      onEnableMFAClick() {
        closure_1_1(4527).hideActionSheet(closure_1_7);
        const obj = closure_1_1(4527);
        closure_1_1(9069).close();
        const obj2 = closure_1_1(9069);
        onRequireModeratorMFAClick(7382).openUserSettings({ screen: constants.ACCOUNT });
      },
  ...
  const items1 = [closure_5(onRequireModeratorMFAClick(4556).Heading, obj2), ];
