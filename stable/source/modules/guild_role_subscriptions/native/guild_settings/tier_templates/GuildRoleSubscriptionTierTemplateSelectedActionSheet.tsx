...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [closure_5(markAsDismissed(4556).Text, obj4), closure_5(markAsDismissed(1178).Spacer, { size: 12 }), , , ];
  ...
  items[2] = closure_5(markAsDismissed(4556).Text, obj5);
  ...
  items[4] = closure_5(markAsDismissed(4976).BaseTextButton, obj6);
  obj3.children = items;
