...
// Dependencies: [19, 1957, 21, 4560, 13901, 504, 4713, 9056, 4527, 17758, 1896, 5028, 5080, 4556, 1114, 1178, 9945, 2]
// Exports: default

// Module 17757 (FormChannelPicker)
...
export default function FormChannelPicker(channelId) {
  ...
  let obj2 = {
    ...
    onPress() {
      ...
      obj.openLazy(asyncRequireImpl(17758, dependencyMap.paths), "ChannelSelectorActionSheet", obj2);
    },
    children: null
  };
  ...
  items3[2] = closure_4(channelId(stateFromStores[15]).Icon, { size: channelId(stateFromStores[15]).Icon.Sizes.MEDIUM, source: require("module_9945") });
