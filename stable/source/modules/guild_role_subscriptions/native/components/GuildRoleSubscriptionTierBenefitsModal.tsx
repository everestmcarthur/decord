...
// Dependencies: [32, 19, 17, 15231, 17732, 15208, 21, 4560, 576, 9056, 5587, 17748, 4556, 1114, 1396, 17749, 13901, 15235, 38, 17727, 8599, 9822, 17750, 17751, 17744, 15215, 17723, 15230, 17753, 17754, 17763, 15234, 17764, 17736, 2]
// Exports: GuildRoleSubscriptionTierChannelBenefitsModal, GuildRoleSubscriptionTierIntangibleBenefitsModal

// Module 17747 (GuildRoleSubscriptionTierBenefitsModal)
...
import useRoleSubscriptionEmojisDefault from "useRoleSubscriptionEmojis" /* 17753 */;
import GuildRoleSubscriptionsModalActionCreatorsAll from "GuildRoleSubscriptionsModalActionCreators" /* 17754 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;

const AllChannelsSwitchDefault = tmp10(17764);
require = fn;
...
function ListFooterSection(onChangeTrialInterval) {
  ...
  const roleSubscriptionSettingsDisabled = onChangeTrialInterval(17727).useRoleSubscriptionSettingsDisabled();
  ...
  const items1 = [closure_12(onChangeTrialInterval(8599).FormSwitchRow, obj3), ];
  ...
  const items3 = [closure_12(onChangeTrialInterval(4556).Text, obj5), , , , , , ];
  const obj6 = { style: tmp4.header, children: null };
  const obj = onChangeTrialInterval(17727);
  const intl3 = tmp8(1114).intl;
  obj6.children = intl3.string(onChangeTrialInterval(1114).t.m1KuWd);
  items3[1] = closure_12(options(9822), obj6);
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    type = type.type;
    const obj = { style: closure_1(13901)().header, children: null };
    const tmp2 = closure_1(13901)();
    ...
    return tmp3(closure_1(9822), obj);
  }
  ...
  const obj10 = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
        ...
        obj.children = closure_12(closure_0(17763).GuildRoleSubscriptionBenefitPreview, obj5);
        tmp3Result = tmp3(closure_1(9056), obj);
        const tmp6 = closure_1(9056);
      }
      return tmp3Result;
    },
...
let AllChannelAccessOptions = fn(15231).AllChannelAccessOptions;
const useGroupIsFullGateState = fn(17732).useGroupIsFullGateState;
