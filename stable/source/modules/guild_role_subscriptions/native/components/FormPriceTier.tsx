...
// Function ID: 17774
// Name: FormPriceTier
// Dependencies: [19, 17732, 1074, 21, 1114, 13899, 7234, 38, 4527, 9432, 1896, 2]
// Exports: default

// Module 17773 (FormPriceTier)
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9432, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
        },
      placeholder: null
    };
