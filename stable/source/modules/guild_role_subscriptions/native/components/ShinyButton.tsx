...
// Function ID: 10307
// Name: ShinyButton
// Dependencies: [19, 21, 4560, 576, 4976, 1178, 10307, 2]
// Exports: default

// Module 10306 (ShinyButton)
...
export default function ShinyButton(style) {
  ...
  let tmp3Result;
  if (!loading) {
    const obj2 = { size: tmp4(1178).Icon.Sizes.REFRESH_SMALL_16, source: _modDef10307, style: null };
