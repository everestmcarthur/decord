...
// Dependencies: [19, 17, 15208, 21, 4560, 15243, 1178, 9945, 4556, 4213, 15236, 4713, 5028, 1114, 2]
// Exports: GuildRoleSubscriptionBenefitPreview

// Module 17763 (GuildRoleSubscriptionBenefitPreview)
import native from "native" /* 1178 */;
import UnicodeEmojisDefault from "UnicodeEmojis" /* 4213 */;
import Text_Text from "Text/Text" /* 4556 */;
import _modDef9945 from "module_9945" /* 9945 */;
import GuildRoleSubscriptionTierTemplatesUtils from "GuildRoleSubscriptionTierTemplatesUtils" /* 15236 */;
...
function ChannelBenefitRow(benefit) {
  ...
  if (null == channelWithTemplateFallback) {
    ...
    let tmp9 = hasOwnProperty(tmp2(4556).Text, obj2);
  } else {
    ...
    items[1] = hasOwnProperty(tmp2(4556).Text, obj6);
    obj4.children = items;
...
const constants = fn(15208).GuildRoleSubscriptionBenefitTypes;
const jsxProd = fn(21);
