...
// Dependencies: [32, 19, 17, 15208, 1074, 21, 4560, 576, 4262, 15241, 13901, 17744, 15230, 7187, 17727, 9822, 1114, 17733, 17771, 17736, 2]
// Exports: GuildRoleSubscriptionTierDesignTab, default

// Module 17770 (GuildRoleSubscriptionTierDesignModal)
...
function Content() {
  ...
  items1[1] = closure_9(role(9822), obj7);
  ...
  items1[2] = closure_9(role(17733), obj8);
  const obj9 = { style: tmp3.header, children: null };
  const tmpResult3 = role(17733);
  const intl3 = tmp4(1114).intl;
  obj9.children = intl3.string(require("util").t["W7hH+z"]);
  items1[3] = closure_9(role(9822), obj9);
  items1[4] = closure_9(role(17771), { color: tmp7, onChange: tmp8, disabled: roleSubscriptionSettingsDisabled });
  obj6.children = items1;
  return closure_10(closure_11, obj6);
}
const View = fn(17).View;
const constants = fn(15208).GuildRoleSubscriptionsTierScenes;
