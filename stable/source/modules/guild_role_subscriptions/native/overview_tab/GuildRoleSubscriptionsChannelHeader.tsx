...
// Dependencies: [19, 17, 21, 4560, 576, 1178, 12783, 4556, 1114, 2]

// Module 13268 (GuildRoleSubscriptionsChannelHeader)
...
export default noop.memo(function GuildRoleSubscriptionsChannelHeader() {
  ...
  const items = [React4(native.Icon, { source: _modDef12783, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
