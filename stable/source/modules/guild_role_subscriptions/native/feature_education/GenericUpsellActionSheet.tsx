...
// Dependencies: [19, 17, 1954, 21, 4560, 576, 8171, 7150, 5587, 7154, 4556, 1178, 4975, 2]
// Exports: default
...
export default function GenericUpsellActionSheet(markAsDismissed) {
  ...
  const tmp = closure_7();
  const bottomSheetRef1 = markAsDismissed(8171).useBottomSheetRef();
  ...
  return closure_5(markAsDismissed(7150).BottomSheet, obj2);
};
