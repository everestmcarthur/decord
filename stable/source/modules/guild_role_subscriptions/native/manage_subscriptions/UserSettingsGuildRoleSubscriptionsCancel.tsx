...
// Dependencies: [5, 32, 19, 17, 4224, 21, 4560, 576, 15230, 4153, 1114, 5584, 1178, 4556, 15220, 5587, 15238, 7162, 7182, 9372, 4905, 4884, 4258, 4240, 4975, 15226, 15215, 15239, 15240, 504, 2]
// Exports: default
...
const FastAssetImageDefault = tmp2(15239);
require = fn;
function WhatYouLose(subscription) {
  ...
  const obj5 = _modDef4153(subscription.subscription.currentPeriodEnd);
  const intl = util.intl;
  const formatResult = _modDef4153(subscription.subscription.currentPeriodEnd).format(c12);
  const intl2 = util.intl;
  const formatResult1 = intl.format(util.t.EtAXzC, { subscriptionEndDate: _modDef4153(subscription.subscription.currentPeriodEnd).format(c12) });
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  const tmp5 = subscription(7162);
  const cancelSubscription1 = subscription(9372).useCancelSubscription(subscription.id, subscription.isACOM);
      ...
      try {
        ...
        if (0 === c4) {
          if (arg0 === 1) {
            ...
            obj6.body = "You can resubscribe any time before " + tmp3(4153)(subscription.currentPeriodEnd).format(closure_1_12) + ".";
          ...
          if (1 === tmp7) {
            if (arg0 === 1) {
              ...
              if (closure_129_6) {
                ...
                c4 = 4;
                c5 = 1;
                const obj13 = { value: tmp63(4884).cancelSubscription(closure_129_1.id, closure_129_4), done: false };
                return obj13;
              } else {
                const _Error = Error;
            ...
            if (2 === tmp7) {
              ...
              closure_128_1 = tmp63;
              closure_129_3(false);
              guild(4258).presentFailedToast(closure_128_1.message);
              ...
              if (3 === tmp7) {
                ...
                if (arg0 === 1) {
                  ...
                  c4 = 5;
                  c5 = 1;
                  const obj16 = { value: tmp63(4884).fetchSubscriptions(), done: false };
                  return obj16;
                }
              } else if (arg0 === 1) {
                c5 = 3;
              ...
              if (closure_128_0) {
                ...
                guild(4258).presentFailedToast(intl.string(guild(1114).t.R0RpRX));
                const obj5 = guild(4258);
              }
              dependencyMap = 0;
            }
            dependencyMap = 0;
  ...
  obj2.children = closure_10(guild(4975).Button, obj3);
...
function Content(subscription) {
  ...
  if (null != listing) {
    ...
    if (null != guild) {
      ...
      items1[2] = closure_1_10(tmp5(4556).Text, obj7);
