...
function ChannelIcon(arg0) {
  ...
  if (channel.type === ChannelTypes.DM) {
    ...
    return map1(tmp9(12383).BaseChannelIcon, obj10);
  }
}
function DMChannelIcon(userId) {
  ...
  const obj3 = { user: stateFromStores, guildId: "o", size: userId(1178).AvatarSizes.XSMALL_20, style: tmp.dmAvatar, status, isMobileOnline, isVROnline, statusStyle: "y\u00F6n" };
...
let obj5 = { backgroundColor: fn(5441).DARK_393C42_LIGHT_DEE0E4 };
const size = fn(2);
