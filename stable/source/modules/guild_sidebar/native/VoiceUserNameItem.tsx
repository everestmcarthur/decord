...
// Dependencies: [32, 19, 17, 21, 4560, 4794, 9182, 4556, 4404, 1114, 16128, 2]
// Exports: default

// Module 16127 (VoiceUserNameItem)
import Text_Text from "Text/Text" /* 4556 */;
import useDisplayNameStylesDefault from "useDisplayNameStyles" /* 4794 */;
import useDisplayNameStylesFont from "useDisplayNameStylesFont" /* 9182 */;
...
export default function VoiceUserNameItem(arg0) {
  ...
  if (isGuest) {
    ...
    isGuest = tmp18(tmp5(4556).Text, obj6);
  }
  items1[1] = isGuest;
  ...
  if (tmp12) {
    ...
    obj7.children = React5(tmp2(16128), obj8);
