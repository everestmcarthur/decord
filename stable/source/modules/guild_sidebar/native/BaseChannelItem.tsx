...
// Dependencies: [19, 17, 10123, 4742, 21, 4560, 576, 4556, 1116, 1178, 10170, 8908, 12384, 2]
...
export default function BaseChannelItem(mode) {
  ...
  if (hideIcon) {
    ...
    if (flag) {
      ...
      AnimatedPressableHighlight = mode(8908).AnimatedPressableHighlight;
    }
    obj2 = {};
