...
// Dependencies: [5, 19, 17, 4381, 1074, 1373, 21, 4560, 9700, 1896, 12712, 7212, 9319, 7182, 16297, 13718, 504, 16311, 1114, 16356, 11209, 576, 2]

// Module 16355 (GuildsBarCreateJoinButton)
...
export default noop.memo(function GuildsBarCreateJoinButton() {
  ...
  const guildsBarAnimatedWrapperStyles = enabled(16297).useGuildsBarAnimatedWrapperStyles();
  ...
  const obj4 = { selected: stateFromStores, circle: false, unread: false, styles: guildsBarAnimatedWrapperStyles, overState: "y", config: memo, label: null, expandedChildren: null, children: "status-positive" };
  obj2 = enabled(504);
  const intl = tmp2(1114).intl;
  obj4.label = intl.string(enabled(1114).t.l5WIbf);
  obj4.expandedChildren = jsx(enabled(16356).HomeDrawerAddServerRowExpandedChildren, {});
  const colors = nativeDefault.colors;
  obj4.children = jsx(enabled(11209).CirclePlusIcon, { size: "md", color: stateFromStores ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT });
  obj3.children = jsx(GuildsBarAnimatedItemWrapperDefault, { selected: stateFromStores, circle: false, unread: false, styles: guildsBarAnimatedWrapperStyles, overState: "y", config: memo, label: null, expandedChildren: null, children: "status-positive" });
