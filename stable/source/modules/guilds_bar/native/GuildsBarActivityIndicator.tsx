...
// Dependencies: [19, 21, 4560, 576, 4262, 5589, 1178, 9791, 9789, 5097, 8628, 8885, 16337, 10115, 16338, 5101, 16339, 5106, 5033, 16332, 2]
...
import ScreenIcon from "ScreenIcon" /* 8885 */;
import _modDef9789 from "module_9789" /* 9789 */;
import CalendarIcon from "CalendarIcon" /* 9791 */;
...
function getMediaIcon(activeEvent) {
  if (activeEvent.activeEvent) {
    const obj2 = { icon: CalendarIcon.CalendarIcon, source: _modDef9789 };
    let tmp6 = obj2;
  } else if (tmp4) {
    const obj3 = { icon: StageIcon.StageIcon, source: _modDef8628 };
    tmp6 = obj3;
  } else if (tmp3) {
    const obj4 = { icon: ScreenIcon.ScreenIcon, source: _modDef16337 };
    tmp6 = obj4;
  } else if (tmp2) {
    const obj5 = { icon: VideoIcon.VideoIcon, source: _modDef16338 };
    tmp6 = obj5;
  } else if (tmp) {
    const obj6 = { icon: VoiceNormalIcon.VoiceNormalIcon, source: _modDef16339 };
    tmp6 = obj6;
  } else {
    tmp6 = null;
    if (tmp5) {
      const obj = { icon: AppsIcon.AppsIcon, source: _modDef5033 };
      tmp6 = obj;
    }
  }
  return tmp6;
