...
// Module 16350 (GuildsBarGeoRestrictedBadge)
...
export default noop.memo(function GuildsBarGeoRestrictedBadge(style) {
  ...
  obj.style = items;
  const obj2 = { source: _modDef12268, style: tmp.badgeImage };
  obj.children = jsx(FastImageDefault, { source: _modDef12268, style: tmp.badgeImage });
