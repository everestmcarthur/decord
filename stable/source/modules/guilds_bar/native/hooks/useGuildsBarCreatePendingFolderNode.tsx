...
// Dependencies: [19, 4382, 5439, 504, 9212, 16361, 5541, 5440, 1114, 2]
// Exports: default
...
export default function useGuildsBarCreatePendingFolderNode() {
  ...
  if (arr2.length > 0) {
    const obj3 = { folderId: tmp2(16361).SpecialGuildsNodeIds.PENDING_JOIN_REQUESTS_FOLDER, folderName: null, expanded: null, guildIds: null };
    const intl = tmp2(1114).intl;
    obj3.folderName = intl.string(tmp2(1114).t["scsU+l"]);
    obj3.expanded = stateFromStores1;
    obj3.guildIds = arr2;
    const folderNode = tmp2(5440).createFolderNode(obj3);
