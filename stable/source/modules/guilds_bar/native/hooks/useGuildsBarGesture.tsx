...
// Dependencies: [5, 19, 17, 1979, 5438, 16287, 16288, 4296, 551, 4528, 4411, 12, 1232, 1114, 7072, 16025, 4262, 576, 4184, 10998, 1249, 5520, 9364, 8673, 1115, 1611, 4962, 16289, 16290, 15102, 6655, 2]
// Exports: default

// Module 16286 (useGuildsBarGesture)
...
export default function useGuildsBarGesture() {
  ...
  handleGestureEnd = fastListRef.useCallback((event) => {
    ...
    state1.setStateShallow({ dragSpecs: "transform", overSpecs: "call" });
  ...
  const callback4 = fastListRef.useCallback((arg0) => {
    ...
    if (null != obj2) {
      ...
      if (id !== id1) {
        const ContextMenuStore = tmp66(8673).ContextMenuStore;
        if (null != ContextMenuStore.getState().menu) {
          tmp66(8673).hideContextMenu();
          const tmp66Result = tmp66(8673);
        }
        node2 = node;
