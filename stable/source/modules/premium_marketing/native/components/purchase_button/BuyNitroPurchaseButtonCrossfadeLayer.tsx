...
// Dependencies: [32, 19, 17, 21, 4296, 4561, 4564, 4975, 2]
...
export default function BuyNitroPurchaseButtonCrossfadeLayer(arg0) {
  ...
  const sharedValue = onDone(4296).useSharedValue(1);
  let obj = onDone(4296);
  let fn = function _() {
  ...
  const obj3 = { style: null, pointerEvents: "none", children: jsx(onDone(4975).Button, { text: snapshot.ctaText, variant: snapshot.variant, size: "lg", grow: true, onPress: "Boolean" }) };
  const items1 = [StyleSheet.absoluteFill, animatedStyle];
  obj3.style = items1;
  return jsx(sharedValue(4296).View, { style: null, pointerEvents: "none", children: jsx(onDone(4975).Button, { text: snapshot.ctaText, variant: snapshot.variant, size: "lg", grow: true, onPress: "Boolean" }) });
};
