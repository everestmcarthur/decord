...
let closure_8 = noop.memo((perk) => {
  ...
  if (null != detail) {
    ...
    obj2.description = intl.string(detail.description);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp9(13390), obj5);
    }
    ...
    obj4.children = items;
    obj2.actions = hasOwnProperty(tmp2(4973).Stack, obj4);
    tmp6Result2 = tmp6(tmp2(10235).PromoSheet, obj2);
