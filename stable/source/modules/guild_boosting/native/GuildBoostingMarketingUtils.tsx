...
// Dependencies: [4454, 8763, 12532, 10386, 12534, 12536, 9377, 9758, 11704, 10240, 5097, 10119, 2]
...
export const getIconForPerk = function getIconForPerk(perkIcon) {
  if (GuildBoostingUtils.PerkIcons.EMOJI === perkIcon) {
    ...
    return tmp(9377).UploadIcon;
  } else if (tmp(4454).PerkIcons.CUSTOM_ROLE_ICON === perkIcon) {
    return tmp(9758).ShieldUserIcon;
