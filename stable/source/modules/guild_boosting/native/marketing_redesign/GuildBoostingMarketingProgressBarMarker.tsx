...
let obj2 = { [TIER_1]: _modDef13588, [TIER_2]: _modDef13589, [TIER_3]: _modDef13590 };
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items1[1] = obj4;
    obj3.style = items1;
    const animatedStyle = tmp5(4296).useAnimatedStyle(P);
    const obj5 = { style: null };
    const items2 = [tmp.progressBarMarkerBackground, animatedStyle];
    obj5.style = items2;
    const items3 = [closure_7(tmp2(4296).View, obj5), , ];
    ...
    if (tmp20Result) {
      const obj8 = { source: tmp2(11569), style: tmp.progressBarMarkerUnlockedIcon };
    ...
    obj9.children = tmp5(4454).getTierName(tier, { useLevels: false });
    items5[1] = closure_7(tmp5(4556).Text, obj9);
  ...
  const tmp5Result5 = useReducedMotion(4411);
