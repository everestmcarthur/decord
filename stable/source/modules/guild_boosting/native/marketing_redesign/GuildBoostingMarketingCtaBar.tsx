...
// Dependencies: [32, 19, 17, 1371, 4455, 1074, 1373, 21, 1090, 4560, 576, 1178, 4296, 4561, 7162, 7182, 563, 13465, 8066, 4469, 4218, 1379, 13519, 13521, 4987, 13580, 4556, 1114, 5584, 5123, 13506, 7402, 13583, 13584, 4975, 5434, 10666, 13585, 9398, 2]
// Exports: default
...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  let obj3 = guild(4296);
  fn.__closure = { withTiming: guild(4561).withTiming, isVisible };
  fn.__workletHash = 6895237370657;
  fn.__initData = __initData;
  closure_130_0 = tmp12;
  const animatedStyle = obj3.useAnimatedStyle(fn);
  const obj4 = { withTiming: guild(4561).withTiming, isVisible };
  ...
  const obj5 = guild(4296);
  fn2.__closure = { withTiming: guild(4561).withTiming, isVisible: !isVisible };
  fn2.__workletHash = 6895237370657;
  fn2.__initData = __initData;
  const animatedStyle1 = obj5.useAnimatedStyle(fn2);
  const obj6 = { withTiming: guild(4561).withTiming, isVisible: !isVisible };
  const tmp14 = isVisible(13465);
  const tmp14Result = isVisible(13465)(fractionalPremiumInfo.endsAt, guild(13465).CountDownMessageTypes.LONG_TIME_LEFT);
  const isInReverseTrial = guild(8066).useIsInReverseTrial();
  const obj7 = guild(8066);
  ...
  const tmp4Result = isVisible(4987);
  const items5 = [closure_12(isVisible(13580), { guild }), , , ];
  ...
  const items6 = [closure_12(guild(4556).Heading, obj14), , , , ];
  const obj15 = { style: tmp.guildIcon, textStyle: tmp.guildIconText, guild, size: null };
  const tmp4Result3 = isVisible(4987);
  obj15.size = guild(5584).GuildIconSizes.LARGE;
  items6[1] = closure_12(isVisible(5584), obj15);
  const obj16 = {
    onPress() {
      window.clearTimeout(ref.current);
      closure_2((arg0) => !arg0);
  ...
  const tmp4Result4 = isVisible(5584);
  const items9 = [closure_12(guild(1178).Icon, { style: tmp.guildBoostCountIcon, source: isVisible(13506), color: isVisible(576).unsafe_rawColors.GUILD_BOOSTING_PINK, size: guild(1178).Icon.Sizes.SMALL }), ];
  ...
  obj21.children = intl2.format(guild(1114).t["pob/cL"], { subscriptions: isVisible(4469)(premiumGroupRole.guild.id).total });
  items9[1] = closure_12(guild(4556).Text, obj21);
  obj19.children = items9;
  const items10 = [closure_13(isVisible(4296).View, obj19), ];
  ...
  obj22.children = closure_12(guild(4556).Text, obj23);
  items10[1] = closure_12(isVisible(4296).View, obj22);
  obj18.children = items10;
  items7[1] = closure_13(memo, obj18);
  obj16.children = items7;
  items6[2] = closure_13(guild(5123).PressableOpacity, obj16);
  items6[3] = tmp20;
  ...
  items6[4] = closure_12(isVisible(7402), obj24);
  obj13.children = items6;
  items5[1] = closure_13(memo, obj13);
  items5[2] = closure_12(isVisible(13583), { style: tmp.headerStars });
  items5[3] = closure_12(isVisible(13584), { style: tmp.headerWave });
  ...
  if (isPremiumResult) {
    ...
    const obj29 = { size: tmp7(1178).Icon.Sizes.SMALL, source: tmp4(13585), style: tmp.giftIcon };
  ...
  obj27.children = closure_12(guild(4975).Button, obj30);
