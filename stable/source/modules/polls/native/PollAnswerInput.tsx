...
// Dependencies: [19, 17, 1957, 4901, 7829, 1374, 21, 4560, 576, 12230, 1114, 7761, 5123, 1178, 11126, 9313, 4527, 12231, 1896, 8764, 8599, 4519, 12234, 2]
// Exports: default
  ...
  const items2 = [
    closure_12(ImageInput, {
      ...
      openImageInputActionSheet() {
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12231, dependencyMap.paths), closure_2_10, { channelId, index, answer, onSaveAltText: handleSaveAltText, onRemoveAnswerImage, openExpressionPicker });
      },
