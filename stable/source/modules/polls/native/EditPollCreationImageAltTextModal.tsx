...
// Dependencies: [32, 19, 17, 7829, 21, 4560, 576, 12230, 12232, 7123, 1114, 1178, 6992, 4556, 5578, 9822, 8599, 2]
// Exports: default
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const obj4 = { onPress: onSave(12232).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
  const intl = onSave(1114).intl;
  obj4.accessibilityLabel = intl.string(onSave(1114).t.cpT0Cq);
  obj4.children = closure_8(onSave(1178).Icon, { source: value(6992) });
  ...
  items1[1] = closure_8(onSave(4556).Text, obj6);
  ...
  obj7.children = closure_8(onSave(4556).Text, obj8);
  ...
  items4[2] = closure_8(onSave(8599).FormInput, obj14);
  ...
  return closure_9(onSave(7123).SafeAreaPaddingView, obj2);
};
