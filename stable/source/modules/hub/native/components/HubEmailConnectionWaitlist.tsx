...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const items1 = [closure_6(closure_5, { source: navigation(12739), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4556).Text, obj5);
  ...
  obj6.children = closure_6(onClose(4975).Button, obj7);
