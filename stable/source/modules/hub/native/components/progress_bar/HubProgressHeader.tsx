...
// Dependencies: [19, 17, 9837, 12314, 21, 4560, 576, 12673, 1187, 1114, 8599, 4527, 12677, 1896, 12756, 2]
// Exports: default
...
let obj2 = { container: { overflow: "hidden", height: fn(12314).GUILD_DIRECTORY_PROGRESS_BAR_HEIGHT, padding: 16 }, icon: { width: 48, height: 48 }, innerContainer: { paddingVertical: 8, paddingLeft: 8, paddingRight: 12, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH } };
  ...
  if (null == nextHubProgressStep) {
    ...
    obj5.onPress = function onPress() {
      ...
      if (!tmp) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12677, dependencyMap.paths), React4, obj2);
      }
    };
