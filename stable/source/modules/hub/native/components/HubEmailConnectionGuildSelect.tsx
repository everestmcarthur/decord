...
// Dependencies: [5, 32, 19, 17, 12723, 21, 4560, 576, 8599, 5584, 1971, 4556, 1114, 1611, 4975, 1178, 1483, 7377, 7051, 12736, 4461, 12731, 2]
// Exports: default
            ...
            try {
              ...
              if (0 === c4) {
                if (arg0 === 1) {
                  ...
                  c4 = 3;
                  v3 = 1;
                  const obj5 = { value: email(12736).sendVerificationEmail(email, true, id), done: false };
                  return obj5;
                }
              } else if (1 === tmp8) {
                c3 = 0;
