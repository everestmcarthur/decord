...
// Function ID: 16215
// Name: HubSidebar
// Dependencies: [19, 17, 2012, 2011, 1074, 10123, 21, 4560, 576, 12383, 1178, 504, 16215, 16216, 15596, 1114, 4571, 12757, 12312, 4497, 9826, 2]
// Exports: default

// Module 16214 (HubSidebar)
...
function HubItem(arg0) {
  ...
  const tmp = closure_9();
  obj.name = React5(tmp5(12383).BaseChannelName, { name: label, mode: DEFAULT });
  obj.icon = React5(tmp5(12383).BaseChannelIcon, { mode: DEFAULT, IconComponent });
  let tmp6Result = null;
  if (null != unreadCount) {
...
let obj2 = { container: { marginVertical: fn(10123).CHANNEL_MARGIN_VERTICAL, marginHorizontal: 8, borderRadius: nativeDefault.radii.md }, row: { flex: 1 } };
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    const obj5 = { guild };
    const items4 = [closure_7(stateFromStores(16216), obj5), , , ];
    const obj6 = { active: stateFromStores1, IconComponent: tmp(15596).CompassIcon, label: null, handleItemClick: null, unreadCount: null };
    ...
    const obj7 = { IconComponent: tmp(12757).PlusMediumIcon, label: null, handleItemClick: null };
    ...
    const obj8 = { IconComponent: tmp(4497).UserPlusIcon, label: null, handleItemClick: null };
