...
// Dependencies: [4296, 16692, 17014, 9501, 16913, 17015, 11359, 2]
// Exports: default
...
export default function usePIPAvoidanceSpecs(safeArea) {
  ...
  fn2.__closure = { cheapWorkletShallowEqual: require("cheapWorkletShallowEqual").cheapWorkletShallowEqual, getPIPBottomOffsetForPIPMode: sharedValue(16913), getAdjustedBottomOffsets: sharedValue(17015), updateSharedValueIfChanged: sharedValue(11359), pipAvoidanceSpecs: sharedValue };
