...
// Dependencies: [5, 19, 1957, 2011, 1074, 4189, 9532, 9551, 9541, 1109, 2]
// Exports: default
          ...
          try {
            ...
            if (0 === c3) {
              ...
              if (1 === tmp5) {
                if (arg0 === 1) {
                  ...
                  if (null != embeddedActivityLocationChannelId) {
                    if (closure_2_1(9532)(embeddedActivityLocationChannelId)) {
                      if (voiceChannelId.getVoiceChannelId() !== embeddedActivityLocationChannelId) {
                        ...
                        c3 = 2;
                        c4 = 1;
                        const obj6 = { value: closure_2_1(9551)(obj5), done: false };
                        return obj6;
                      }
                    }
                  }
              ...
              const timerId = setTimeout(() => {
                closure_3_1(9541)(closure_1_3, _location);
                if (closure_0 != null) {
                  closure_0();
                }
              }, 0);
