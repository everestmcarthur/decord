...
// Dependencies: [5, 1956, 1920, 1074, 9517, 9416, 1115, 9658, 12062, 12063, 1894, 8862, 9639, 9638, 7168, 4189, 7162, 9512, 9513, 4573, 9554, 9539, 2]
// Exports: default, getStaffReleasePhase

// Module 12061 (useActivityShelfItem)
...
import useCurrentEmbeddedApplicationDefault from "useCurrentEmbeddedApplication" /* 9638 */;
...
export default function useActivityShelfItem(backgroundResolution) {
  ...
  if (null != activity.activity_preview_video_asset_id) {
    tmp9 = tmp(12062)(application.id, activity.activity_preview_video_asset_id);
  }
  let channel;
  ...
  if (tmp4Result.hasApplicationFlag(application, ApplicationFlags.EMBEDDED_RELEASED)) {
    ...
    const str = activityItem.activity.client_platform_config[tmp(9416)(undefined, tmp4Result3.getOS(tmp4Result3))].release_phase;
    let replaced;
    ...
    const tmpResult2 = tmp(9416);
  } else {
    const tmp4Result4 = tmp4(8862);
  }
