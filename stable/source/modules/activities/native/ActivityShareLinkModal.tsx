...
// Dependencies: [5, 32, 19, 17, 1957, 1371, 1956, 10865, 4553, 21, 4560, 576, 504, 10986, 12136, 14488, 7168, 1369, 14490, 7456, 7682, 4259, 1114, 7190, 4258, 1477, 1611, 1115, 5631, 7864, 5624, 7377, 4503, 5125, 10989, 11000, 2]
// Exports: default
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != first3) {
              dependencyMap = 1;
              c3 = 1;
              let obj4 = { value: Promise.all(first1.map(tmp2(10986).getOrResolveChannelIdFromDestinationId)), done: false };
              return obj4;
            } else {
              c3 = 3;
            }
          ...
          closure_128_1 = tmp2(14490).resolveActivityShareMessageContent(closure_129_3, closure_129_14, closure_129_12);
          closure_129_6(true);
                ...
                try {
                  ...
                  if (0 === c2) {
                    if (arg0 === 1) {
                      ...
                      if (null != channel) {
                        const obj2 = closure_2_1(7456);
                        const obj6 = { location: constants.ACTIVITY_SHARE };
                        c2 = 1;
                        c1 = 1;
                        const obj7 = { value: obj2.sendMessage(tmp17, closure_2_1(7682).parse(channel, c1), false, obj6), done: false };
                        return obj7;
                      }
                    }
                  } else if (arg0 === 1) {
