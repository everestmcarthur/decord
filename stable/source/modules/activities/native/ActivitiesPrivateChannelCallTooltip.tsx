...
export default function ActivitiesPrivateChannelCallTooltip(onClosePress) {
  ...
  const tmp2Result = num(4296);
  T.__closure = { withRepeat: num(4296).withRepeat, withSequence: num(4296).withSequence, withTiming: num(4561).withTiming, OFFSET: 40, translateBounceOffset: num, TIMING_CONFIG };
  ...
  obj6.children = jsx(num(4975).Button, { text: null, onPress: null, variant: "secondary", size: "sm", grow: true });
