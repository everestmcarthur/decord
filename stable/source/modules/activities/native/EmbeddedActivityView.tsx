...
// Dependencies: [109, 32, 19, 17, 1956, 1920, 1350, 21, 4560, 9640, 1477, 573, 9642, 9643, 9645, 9638, 504, 9647, 9521, 9648, 9656, 2]

// Module 9641 (EmbeddedActivityView)
import DispatcherDefault from "Dispatcher" /* 573 */;
import EmbeddedActivitiesNativeManagerDefault from "EmbeddedActivitiesNativeManager" /* 9521 */;
import doesOrientationMatchLockStateDefault from "doesOrientationMatchLockState" /* 9642 */;
import WakeLockDefault from "WakeLock" /* 9645 */;
...
const memoResult = noop.memo(function EmbeddedActivityViewInner(portraitSafeAreasConfig) {
  ...
  const tmp4 = currentEmbeddedActivity(9638)();
  dependencyMap = tmp4;
  ...
  if (null == currentEmbeddedActivity) {
    ...
    const discordEnvQueryParams = tmp5(9643).getDiscordEnvQueryParams();
    ...
    const tmp5Result = tmp5(9643);
  }
  currentEmbeddedActivity(9647)({ connectedEmbeddedActivity: currentEmbeddedActivity });
  ...
  const obj5 = { orientationLockState: stateFromStores, showLoadingIndicator: tmp22, setShowLoadingStateForLockingOrientation: tmp9, application: tmp4, setOrientationLockState: layoutMode(9640).setOrientationLockState };
  setIsResetting = useBaseActivityView({ orientationLockState: stateFromStores, showLoadingIndicator: tmp22, setShowLoadingStateForLockingOrientation: tmp9, application: tmp4, setOrientationLockState: layoutMode(9640).setOrientationLockState }).setIsResetting;
  ...
  if (null != currentEmbeddedActivity) {
    ...
    if (null != id) {
      ...
      const tmp2Result = tmp2(9648);
      obj7.allowPopups = tmp5(9656).allowPopups(tmp4);
      obj7.isPipOrGridMode = layoutMode === constants.PIP || layoutMode === constants.GRID;
      obj7.webViewKey = tmp5(9521).EMBEDDED_ACTIVITY_WEB_VIEW_KEY;
      if (tmp26) {
