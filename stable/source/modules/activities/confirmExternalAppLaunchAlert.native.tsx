...
// Dependencies: [19, 17, 1920, 21, 4560, 9550, 4556, 1114, 4975, 4255, 4904, 2]
// Exports: confirmExternalAppLaunchAlert

// Module 9549 (confirmExternalAppLaunchAlert)
...
function ConfirmActivityGateContent(activityName) {
  ...
  const items = [timestampProducer(React3, { source: _modDef9550, style: tmp.announcementBirb }), , , ];
