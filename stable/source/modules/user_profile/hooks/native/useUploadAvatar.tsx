...
// Dependencies: [5, 19, 1371, 1074, 1373, 563, 9319, 4527, 5138, 4218, 14596, 8170, 8168, 8165, 8167, 2]
// Exports: default
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj8 = { value: tmp22(5138).openImagePicker(obj6), done: false };
            return obj8;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          if (null == base64) {
            ...
            if (!closure_129_1) {
              canUseAnimatedAvatarResult = tmp22(4218).canUseAnimatedAvatar(closure_129_3);
              const obj = tmp22(4218);
            }
          ...
          tmp22 = tmp2;
          const obj2 = tmp2(14596);
          obj10.description = tmp2(8170).generateAvatarDescription();
          obj10.originalMd5 = originalMd5;
          closure_128_4 = obj2.createPendingImage(obj10);
          if (closure_129_1) {
            tmp28(8168).setTryItOutAvatar(closure_128_4);
            const tmp28Result = tmp28(8168);
          } else {
            const obj11 = { guildId: closure_129_0, avatar: closure_128_4 };
            tmp28(8165).setPendingChanges(obj11);
            const tmp28Result2 = tmp28(8165);
            const result = tmp2(8167).announcePendingAvatarChange("set");
            const obj7 = tmp2(8167);
          }
          const obj4 = tmp2(8170);
        }
      } catch (tmp38) {
        c3 = tmp;
        throw tmp38;
