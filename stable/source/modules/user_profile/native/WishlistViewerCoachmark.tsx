...
// Dependencies: [19, 17, 1954, 21, 4560, 13134, 1114, 11132, 2]
// Exports: default
...
function CoachmarkImage() {
  ...
  const obj2 = { source: { uri: _modDef13134 }, style: tmp.image };
  obj.children = <hasOwnProperty source={{ uri: _modDef13134 }} style={tmp.image} />;
