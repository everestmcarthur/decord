...
// Dependencies: [32, 19, 17, 1957, 2021, 1371, 8184, 1074, 21, 4560, 576, 8186, 1114, 5687, 5605, 1178, 4411, 4495, 504, 8187, 7162, 7182, 8191, 8200, 1242, 8182, 8180, 7150, 6627, 7931, 6969, 4556, 4712, 4975, 5123, 1935, 2]

// Module 8183 (UserProfileSpeedBumpActionSheet)
...
function InformationTable(speedBumpType) {
  let items;
  let obj = { icon: _modDef8186, text: null };
  const intl = items(1114).intl;
  obj.text = intl.string(items(1114).t.kcuWva);
  items = [obj, ];
  const obj2 = { icon: _modDef8186, text: null };
  ...
  items[1] = obj2;
  return closure_12(items(5687).TableRowGroup, {
    hasIcons: true,
...
const UserProfileAnalyticsTypes = fn(8184).UserProfileAnalyticsTypes;
