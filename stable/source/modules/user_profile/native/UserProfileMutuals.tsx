...
// Dependencies: [19, 17, 8184, 7208, 21, 4560, 8191, 12606, 12998, 4527, 12612, 1896, 8180, 7342, 5123, 13031, 1178, 4556, 12613, 12622, 5584, 12607, 2]
// Exports: default
...
export default function UserProfileMutuals(user) {
  ...
  const userProfileAnalyticsContext = user(8191).useUserProfileAnalyticsContext();
  ...
  if (guildId(12998)(user)) {
    ...
    if (tmp7) {
      ...
      const obj3 = {
        ...
        onPress() {
              ...
              ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12612, dependencyMap.paths), "UserProfileMutualsActionSheet", {
                user,
      ...
      const items = [closure_6(tmp2(13031).AvatarPile, obj4), ];
      const obj5 = { variant, color, children: tmp5(12613)(mutualFriends.length) };
      items[1] = closure_6(tmp2(4556).Text, obj5);
      obj3.children = items;
      tmp9Result = tmp9(tmp2(5123).PressableOpacity, obj3);
    }
    ...
    if (tmp15) {
      ...
      tmp15 = closure_6(tmp2(4556).Text, obj6);
    }
    items1[1] = tmp15;
    ...
    if (tmp8) {
      ...
      if (!tmp7) {
        ...
        tmp21 = closure_6(tmp2(12622).GuildIconPile, obj8);
      }
      const items2 = [tmp21, ];
      const obj9 = { variant, color, children: tmp5(12607)(mutualGuilds.length) };
      items2[1] = closure_6(tmp2(4556).Text, obj9);
      obj7.children = items2;
      tmp9Result2 = tmp9(tmp2(5123).PressableOpacity, obj7);
    }
