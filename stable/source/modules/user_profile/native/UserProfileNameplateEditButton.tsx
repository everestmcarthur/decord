...
// Dependencies: [19, 17, 2021, 7208, 1085, 21, 4560, 576, 504, 8167, 14638, 4527, 14639, 1896, 14621, 1114, 8824, 1178, 13176, 2]
// Exports: default
...
export default function UserProfileNameplateEditButton(user) {
  ...
  const profilePreviewValue = user(8167).getProfilePreviewValue(obj3);
  const obj2 = user(8167);
  let skuId;
    ...
    if (null != nameplateData) {
      if (null != nameplateRecord) {
        if (null != nameplateProduct) {
          ...
          obj8.children = tmp15(guildId(8824), obj9);
          let tmp15Result = tmp15(closure_5, obj8);
        }
        obj6.leading = tmp15Result;
        return tmp15(tmp3(14621).UserProfileEditFormButton, obj6);
      }
    }
    const obj10 = { source: guildId(13176), style: tmp.noneIcon };
