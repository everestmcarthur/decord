...
// Dependencies: [32, 19, 17, 7659, 4209, 1371, 1074, 21, 1178, 4560, 576, 504, 13067, 9854, 12, 1369, 5123, 1114, 4556, 7209, 2]
// Exports: default
...
export default function UserProfileYourFriendsCard(arg0) {
  ...
  const effect = stateFromStoresArray1.useEffect(() => {
    const userAffinitiesV2 = closure_0(9854).fetchUserAffinitiesV2();
  }, []);
