...
// Dependencies: [19, 17, 21, 4560, 576, 4271, 7184, 4409, 8605, 4556, 2]
// Exports: default

// Module 11587 (UserProfileSection)
...
export default function UserProfileSection(title) {
  ...
  if (null != primaryColor) {
    if (null != profileThemeValues) {
      let borderColor = tmp3(4409).hexOpacityToRgba(tmp3(8605).DIVIDER_COLORS[theme], profileThemeValues.dividerOpacity);
    ...
    if (null != title) {
      ...
      const items1 = [React3(tmp3(4556).Text, obj7), headerIcon];
