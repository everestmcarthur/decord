...
// Dependencies: [19, 17, 4209, 1074, 21, 4560, 576, 8242, 563, 4556, 1114, 9048, 2]
// Exports: default
...
export default function RemediatedUserNotice(user) {
  ...
  if (isBlocked) {
    ...
    if (isBlocked) {
      ...
      isBlocked = closure_6(tmp4(4556).Text, obj3);
    }
    ...
    if (isIgnored) {
      ...
      const items3 = [closure_6(tmp4(4556).Text, obj5), closure_6(tmp4(4556).Text, { variant: "text-sm/semibold", color: "text-default", accessibilityElementsHidden: true, importantForAccessibility: "no", children: "\u2022" }), ];
