...
// Dependencies: [19, 17, 1371, 1074, 21, 4560, 576, 504, 4218, 7198, 7149, 1114, 8668, 5687, 5605, 8599, 14597, 2]
// Exports: default
...
const UserProfileUpsellButtonDefault = tmp5(14597);
require = fn;
...
export default function ChangeAvatarActionSheet(showRemoveAvatar) {
  ...
  if (isPremiumResult) {
    isPremiumResult = tmp8(tmp2(8668).NitroWheelIcon, {});
  }
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(5605).TableRow, obj6);
  }
  items2[1] = tmp8Result;
  if (showAnimatedAvatarUpsell) {
    ...
    const items3 = [tmp8(tmp2(8599).FormLabel, obj9), ];
    const obj10 = { style: tmp.nitroWheel, size: "sm" };
    items3[1] = tmp8(tmp2(8668).NitroWheelIcon, obj10);
    ...
    const items4 = [tmp8(tmp2(8599).FormSubLabel, obj12), ];
    ...
    showAnimatedAvatarUpsell = tmp8(tmp2(5605).TableRow, obj7);
  ...
  if (tmp8Result2) {
    ...
    obj16.children = tmp8(tmp2(8599).FormLabel, obj17);
    obj15.label = tmp8(View, obj16);
    obj15.onPress = handleEditAvatarDecorationSelect;
    tmp8Result2 = tmp8(tmp2(5605).TableRow, obj15);
  }
  ...
  if (flag) {
    ...
    obj18.label = tmp8(tmp2(8599).FormLabel, obj19);
    obj18.onPress = handleRemoveAvatarSelect;
    flag = tmp8(tmp2(5605).TableRow, obj18);
  }
