...
// Dependencies: [32, 19, 17, 4600, 8184, 21, 4560, 576, 8218, 504, 5605, 1178, 4712, 10881, 5584, 4556, 12606, 9798, 12613, 12614, 11156, 12607, 12608, 1114, 12618, 12620, 2]
// Exports: default

// Module 12612 (UserProfileMutualsActionSheet)
...
import useUserProfileMutualsDefault from "useUserProfileMutuals" /* 12606 */;
import getMutualGuildsLabelDefault from "getMutualGuildsLabel" /* 12607 */;
import getMutualFriendsLabelDefault from "getMutualFriendsLabel" /* 12613 */;
...
function MutualFriendRow(mutualFriend) {
  ...
  const avatarDecoration = user(8218).useAvatarDecoration(user);
  const obj = user(8218);
  ...
  obj3.start = start;
  obj3.end = end;
  return closure_9(user(5605).TableRow, obj3, user.id);
}
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  if (null == mutualFriends) {
    ...
    const obj6 = { style: tmp.emptyState, children: closure_9(tmp6(12614).NoMutualFriends, {}) };
    ...
    tmp10 = closure_9(tmp6(11156).UserProfileStackedActionSheetList, obj7);
  }
  obj4.page = tmp10;
  const items = [obj4, ];
  let length1;
  ...
  if (null == mutualGuilds) {
    ...
    const obj10 = { style: tmp.emptyState, children: tmp9(tmp6(12608).NoMutualServers, {}) };
    ...
    tmp9Result = tmp9(tmp6(11156).UserProfileStackedActionSheetList, obj11);
  }
  ...
  const items1 = [tmp9(closure_5, { children: tmp9(user(12618).Tabs, { state: segmentedControlState }) }), tmp9(user(12620).SegmentedControlPages, { state: segmentedControlState })];
