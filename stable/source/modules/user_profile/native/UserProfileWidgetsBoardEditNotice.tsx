...
// Dependencies: [19, 17, 1954, 21, 4560, 576, 8242, 10630, 1943, 4515, 4556, 1114, 5123, 5680, 2]
// Exports: default
...
export default function UserProfileWidgetsBoardEditNotice() {
  ...
  obj.children = function children(markAsDismissed) {
    ...
    if (markAsDismissed.visibleContent === dismissible_content.DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE) {
      ...
      obj2.children = hasOwnProperty(tmp(4515).CircleInformationIcon, obj3);
      ...
      items1[1] = hasOwnProperty(tmp(4556).Text, obj4);
      ...
      obj5.children = hasOwnProperty(tmp(5680).XSmallIcon, { size: "sm" });
      items1[2] = hasOwnProperty(tmp(5123).PressableOpacity, obj5);
      obj.children = items1;
