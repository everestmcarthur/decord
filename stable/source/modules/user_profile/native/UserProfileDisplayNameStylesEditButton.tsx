...
// Dependencies: [32, 19, 17, 1074, 1954, 21, 4560, 576, 1483, 9183, 7388, 1943, 8167, 4794, 10907, 1390, 1242, 1114, 14618, 1178, 13176, 10904, 14619, 14621, 2786, 2]
// Exports: default
...
export default function UserProfileDisplayNameStylesEditButton(user) {
  ...
  const tmp16 = nativeStackNavigation(() => {
    if (null == closure_6) {
      const obj2 = { source: _modDef13176, style: closure_3.noneIcon };
