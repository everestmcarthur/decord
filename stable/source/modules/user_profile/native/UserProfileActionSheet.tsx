...
// Dependencies: [32, 19, 17, 1957, 2021, 1371, 8161, 7208, 1074, 7151, 21, 4560, 6627, 4296, 1611, 504, 8187, 7162, 7182, 8171, 1935, 8191, 5126, 8202, 8215, 8216, 8217, 8222, 8208, 8227, 8228, 8231, 1477, 5682, 8225, 4495, 4262, 576, 8200, 8232, 8182, 2009, 8188, 1242, 4418, 4527, 1483, 8180, 7150, 1178, 8233, 1114, 4271, 8238, 1115, 7382, 8241, 12991, 13064, 8807, 7154, 13135, 1187, 2]

// Module 8201 (UserProfileActionSheet)
...
import ProfileFrameLayerOrder from "ProfileFrameLayerOrder" /* 8208 */;
import ProfileFrameDefault from "ProfileFrame" /* 8222 */;
import scaleProfileFrameDefault from "scaleProfileFrame" /* 8225 */;
import ApplicationPresenceUtils from "ApplicationPresenceUtils" /* 8232 */;
...
export default noop.memo(function UserProfileActionSheet(userId) {
  ...
  const memo = prop.useMemo(() => {
    ...
    return (arg0, arg1, arg2) => {
      const scrollEventsHandlersDefault = animatedScrollableState(6627).useScrollEventsHandlersDefault(arg0, arg1, arg2);
      const obj = animatedScrollableState(6627);
      ...
      fn.__closure = { defaultHandleOnScroll: handleOnScroll, scrollPosition: animatedScrollableState, animatedScrollableState, SCROLLABLE_STATE: animatedScrollableState(6627).SCROLLABLE_STATE };
      fn.__workletHash = 13254130622789;
      fn.__initData = __initData;
      const items = [handleOnScroll, animatedScrollableState];
      const obj5 = {};
      const obj4 = { defaultHandleOnScroll: handleOnScroll, scrollPosition: animatedScrollableState, animatedScrollableState, SCROLLABLE_STATE: animatedScrollableState(6627).SCROLLABLE_STATE };
