...
// Dependencies: [19, 17, 2025, 1385, 4405, 7621, 1074, 1182, 5408, 21, 4560, 576, 5407, 11580, 5283, 1396, 4411, 1178, 11583, 11584, 4262, 11585, 11586, 4528, 7190, 4258, 1114, 8371, 4740, 4255, 5123, 4556, 4271, 504, 7503, 11587, 2]
      ...
      callback1 = obj19.useCallback(() => {
        if (null != platformUserUrl) {
          let obj2 = {
            ...
            onConfirm() {
                account(4740).trackWithMetadata(constants.CONNECTED_ACCOUNT_VIEWED, { platform_type: type.type, other_user_id });
                const obj = account(4740);
...
export default function LegacyUserProfileConnections(user) {
  ...
  const obj2 = user(504);
  const theme = user(4271).useThemeContext().theme;
  const tmpResult = user(4271);
  ...
  if (!stateFromStores1) {
    ...
    if (0 !== memo1.length) {
      ...
      if (tmp10) {
        ...
        tmp10 = closure_14(stateFromStores(11587), obj4);
      ...
      obj6.children = tmp8;
      items6[1] = closure_14(stateFromStores(11587), obj6);
