...
// Dependencies: [32, 19, 17, 4552, 8783, 8784, 1371, 7621, 8184, 7151, 21, 4560, 576, 4296, 4561, 504, 1611, 7162, 7182, 13090, 13091, 13072, 8789, 8192, 11156, 1114, 6627, 5687, 7201, 7073, 11038, 8098, 4518, 2]
// Exports: default
...
import WishlistActionCreatorsDefault from "WishlistActionCreators" /* 8789 */;
...
let closure_12 = fn(8184).TrackUserProfileWishlistActions;
...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7162)(analyticsLocations1, tmp4(7182).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  const obj2 = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(7162);
  ({ cardWidth: c5, rowWidth } = analyticsContext(13090)({ maxWidth: ACTION_SHEET_MAX_WIDTH }));
  if (null != rowWidth) {
    let obj3 = { width: rowWidth };
    let tmp7 = obj3;
  }
  let tmp6 = analyticsContext(13090)({ maxWidth: ACTION_SHEET_MAX_WIDTH });
  const items1 = [value];
  ...
  obj9.children = closure_14(wishlistId(7201).TableSwitchRow, obj10);
  obj8.children = closure_14(wishlistId(5687).TableRowGroup, obj9);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = tmp16(tmp2(6627).BottomSheetScrollView, obj5);
