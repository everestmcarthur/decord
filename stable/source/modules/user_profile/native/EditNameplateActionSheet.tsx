...
// Dependencies: [32, 19, 17, 7558, 1887, 2021, 1074, 21, 4560, 576, 8171, 7162, 7182, 1242, 8165, 8172, 7150, 4556, 1114, 8173, 10739, 504, 14640, 8167, 14641, 13178, 13179, 8174, 8823, 4987, 11225, 2]
// Exports: default

// Module 14639 (EditNameplateActionSheet)
...
import EditNameplateSection from "EditNameplateSection" /* 14641 */;
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp4 = purchase(8174)(previewSkuId);
  ...
  const items1 = [closure_10(tmp10(8823).NameplateDummyUserPreview, { width: 100 }), closure_10(tmp10(8823).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj4.colors = items2;
  items1[2] = closure_10(purchase(4987), obj4);
  obj3.children = items1;
  const items3 = [closure_11(View, obj3), closure_10(tmp10(11225).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj5 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [closure_10(tmp10(8823).NameplateDummyUserPreview, { width: 140 }), closure_10(tmp10(8823).NameplateDummyUserPreview, { width: 100 }), ];
  const obj6 = { style: tmp.nameplatePreviewGradient, start: { x: 0, y: 0.2 }, end: { x: 0, y: 0.9 }, colors: null };
  const tmp2Result = purchase(4987);
  const items5 = ["" + tmp.nameplatePreviewGradient.color + "00", tmp.nameplatePreviewGradient.color];
  obj6.colors = items5;
  items4[2] = closure_10(purchase(4987), obj6);
...
export default function EditNameplateActionSheet(arg0) {
  ...
  const callback = obj2.useCallback(() => {
    ...
    obj.track(constants.OPEN_POPOUT, { type: first(7182).EDIT_NAMEPLATE_SHEET, is_fullscreen: true });
  }, []);
  ...
  items1[1] = closure_10(guildId(4556).Text, obj7);
  ...
  obj8.analyticsSource = tmp7(7182).EDIT_NAMEPLATE_SHEET;
  items2[1] = closure_10(first(8173), obj8);
  obj4.children = items2;
  obj3.children = tmp12(guildId(7150).BottomSheet, obj4);
  return closure_10(guildId(7162).AnalyticsLocationProvider, obj3);
};
