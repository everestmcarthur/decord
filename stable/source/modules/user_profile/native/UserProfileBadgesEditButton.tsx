...
export default function UserProfileBadgesEditButton(arg0) {
  ...
  const callback = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14623, dependencyMap.paths), "Customize Badges", { analyticsLocations });
    if (closure_3) {
  ...
  if (isBadgeManagementEnabled) {
    if (0 === length) {
      ...
      obj2.labelTrailing = closure_8(tmp2(14621).UserProfileEditFormLabelBadges, obj3);
      ...
      obj4.children = closure_8(tmp2(4556).Text, obj5);
      ...
      return closure_8(tmp2(14621).UserProfileEditFormButton, obj2);
    } else {
      noop = tmp2(11204).getLegacyIconUrlByBadgeId(badges);
      ...
      obj8.labelTrailing = closure_8(tmp2(14621).UserProfileEditFormLabelBadges, obj9);
      ...
      if (tmp15Result) {
        ...
        obj11.children = "+" + diff;
        tmp15Result = tmp15(tmp2(4556).Text, obj11);
      }
      ...
      return closure_8(tmp2(14621).UserProfileEditFormButton, obj8);
    }
  } else {
    return null;
  }
