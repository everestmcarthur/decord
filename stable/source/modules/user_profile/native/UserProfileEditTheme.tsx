...
// Dependencies: [19, 17, 21, 4560, 576, 1091, 7205, 5123, 1114, 10255, 4556, 8187, 8228, 8133, 4679, 4380, 1943, 14598, 4527, 14627, 1896, 8678, 2]
// Exports: default

// Module 14626 (UserProfileEditTheme)
...
export default function UserProfileEditTheme(pendingThemeColors) {
  ...
  const tmp = closure_6();
  let tmp4 = f97636(primaryColor[11])(user.id, guildId);
  f97636 = tmp4;
  const tmp5 = f97636(primaryColor[12])({ user, displayProfile: tmp4, pendingThemeColors: pendingThemeColors.pendingThemeColors, isPreview: flag });
  primaryColor = tmp5.primaryColor;
  secondaryColor = tmp5.secondaryColor;
  if (pendingAvatarSrc == null) {
    pendingAvatarSrc = user.getAvatarURL(guildId, 80);
  }
  suggestedColors = secondaryColor(primaryColor[13]).useAvatarColors(pendingAvatarSrc, f97636(tmp3[4]).unsafe_rawColors.PRIMARY_530, false);
    ...
    if (null != secondaryColor) {
      ...
      if (showResetMenu) {
        ...
        obj5.onPress = function onPress() {
          ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14627, dependencyMap.paths), "Profile Theme", {
            onResetTheme() {
      ...
      f97636 = (arg0) => {
        if (arg0 !== primaryColor) {
          ...
          let themeColors;
          if (f97636 != null) {
            themeColors = f97636.themeColors;
          }
          let tmp8;
      ...
      obj8.onPress = () => {
        ...
        closure_1(primaryColor[17])({ color: secondaryColor, onSelect: f97636, suggestedColors });
      };
