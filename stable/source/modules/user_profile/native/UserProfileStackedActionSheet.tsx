...
// Dependencies: [19, 17, 21, 4560, 576, 1611, 6627, 8599, 1115, 7150, 5123, 1114, 5628, 4556, 2]
...
export default function UserProfileStackedActionSheet(onBack) {
  ...
  if (tmp4Result2) {
    ...
    obj3.onPress = onBack;
    obj3.children = tmp4(tmp5(5628).ArrowLargeLeftIcon, { size: "md" });
    tmp4Result = tmp4(tmp5(5123).PressableOpacity, obj3);
  }
