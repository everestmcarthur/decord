...
// Dependencies: [5, 19, 17, 8161, 1074, 21, 4560, 576, 7162, 4218, 4527, 5138, 14596, 6989, 7198, 7149, 1114, 8668, 5687, 5605, 8599, 14597, 504, 8170, 8187, 8249, 1091, 8165, 14598, 14600, 4556, 1178, 14605, 2]
// Exports: default
...
function ChangeBannerColorRow(user) {
  ...
  const tmp7 = pendingAccentColor(8187)(user.id);
...
export default function ChangeBannerActionSheet(isTryItOut) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (dependencyMap === 1) {
            ...
            const obj4 = tmp5(4527);
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp5(5138).openImagePicker(closure_1_8), done: false };
            return obj6;
          }
          ...
          if (null != base64) {
            const obj8 = { assetOrigin: tmp2(6989).AssetOriginTypes.NEW_ASSET, imageUri: base64, description: "", originalAsset: "Array", originalMd5 };
            closure_129_0(tmp2(14596).createPendingImage(obj8));
  ...
  let tmp4Result = flag;
  if (flag) {
    tmp4Result = tmp4(tmp5(8668).NitroWheelIcon, {});
  }
  ...
  if (!flag) {
    ...
    tmp4Result5 = tmp4(tmp5(8668).NitroWheelIcon, obj6);
  }
  ...
  if (!flag) {
    ...
    obj9.children = tmp4(tmp2(14597), obj10);
  ...
  if (showRemoveBanner) {
    ...
    obj12.label = tmp4(tmp5(8599).FormLabel, obj11);
    obj12.onPress = function handleBannerDelete() {
      _require(null);
      ActionSheetActionCreatorsDefault.hideActionSheet();
    };
    showRemoveBanner = tmp4(tmp5(5605).TableRow, obj12);
  }
