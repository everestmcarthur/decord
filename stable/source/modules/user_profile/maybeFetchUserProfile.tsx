...
// Dependencies: [1957, 2021, 7621, 7541, 8133, 5407, 573, 8182, 8189, 2]
// Exports: default

// Module 8188 (maybeFetchUserProfile)
import UserActionCreators from "UserActionCreators" /* 8182 */;
import preloadUserBannerImageDefault from "preloadUserBannerImage" /* 8189 */;
...
export default function maybeFetchUserProfile(id, guildIconURL) {
  ...
  if ("" === id) {
    ...
    if (flag3) {
      ...
      const profile = require("UserActionCreators").fetchProfile(id, obj5, obj5(8189));
