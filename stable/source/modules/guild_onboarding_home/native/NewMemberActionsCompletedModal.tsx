...
export default function NewMemberActionsCompleted(arg0) {
  ...
  const tmp = closure_7();
  sharedValue = sharedValue(4296).useSharedValue(initialPercent);
  ...
  fn.__closure = { withDelay: sharedValue(4296).withDelay, withTiming: sharedValue(4561).withTiming, barWidth: sharedValue };
  ...
  const items1 = [closure_5(sharedValue(4556).Text, obj5), ];
