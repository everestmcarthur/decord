...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  items1[1] = closure_3(href(4556).Text, obj4);
  ...
  items1[2] = closure_3(href(4556).Text, obj5);
  obj3.children = items1;
  const items2 = [closure_4(href(4973).Stack, obj3), ];
  ...
  const items3 = [closure_3(href(4975).Button, obj7), ];
  ...
  items3[1] = closure_3(href(4975).Button, obj8);
  obj6.children = items3;
  items2[1] = closure_4(href(4973).Stack, obj6);
  obj2.children = items2;
  obj.children = closure_4(href(4973).Stack, obj2);
