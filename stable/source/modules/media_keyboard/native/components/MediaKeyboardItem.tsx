...
// Dependencies: [19, 17, 4900, 10654, 21, 4296, 4560, 576, 4409, 1178, 10402, 4556, 504, 5136, 10655, 1114, 5168, 5138, 10656, 10657, 4561, 1477, 10658, 5087, 10117, 2]
...
function NewCaption(arg0) {
  ...
  obj.style = items;
  const items1 = [React7(native.Icon, { source: _modDef10402, style: tmp.icon }), React7(Text_Text.Text, { style: textStyle, color: "text-overlay-light", variant: "text-xs/bold", children: label })];
  obj.children = items1;
