...
// Dependencies: [19, 17, 1979, 21, 4560, 576, 504, 17343, 17347, 7198, 11379, 4556, 1114, 5584, 4975, 6995, 1935, 4259, 9572, 4527, 13910, 2]
// Exports: default
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj4 = { source: stateFromStores(11379), style: tmp.headerImage };
    ...
    items2[1] = closure_7(tmp2(4556).Text, obj5);
    ...
    items2[2] = closure_7(tmp2(4556).Text, obj6);
    ...
    const items3 = [closure_7(tmp2(4556).Text, obj9), ];
    const obj10 = { style: tmp.guildInfo, children: null };
    const obj11 = { guild: stateFromStores, size: tmp2(5584).GuildIconSizes.SMALL_32 };
    const items4 = [closure_7(stateFromStores(5584), obj11), ];
    const obj12 = { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: stateFromStores.name };
    items4[1] = closure_7(tmp2(4556).Text, obj12);
    ...
    const obj13 = {
      ...
      onPress() {
          ...
          RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
            const obj2 = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: stateFromStores(9572), content: null };
            const intl = guildId(1114).intl;
            obj2.content = intl.string(guildId(1114).t.rlYD1W);
            stateFromStores(4259).open(obj2);
          });
    ...
    items2[4] = closure_7(tmp2(4975).Button, obj13);
    const obj14 = {
      size: "lg",
      variant: "secondary",
      onPress() {
    ...
    items2[5] = closure_7(tmp2(4975).Button, obj14);
    ...
    items2[6] = closure_7(tmp2(4556).Text, obj15);
    obj3.children = items2;
    obj2.children = closure_8(closure_4, obj3);
    tmp6 = closure_7(tmp2(7198).ActionSheet, obj2);
