...
// Dependencies: [5, 11665, 1074, 1272, 7861, 573, 4783, 2]
...
let closure_8 = async function _fetchAndUpdateSavedMessages() {
  ...
  closure_128_1 = results.map((message) => {
    ...
    if (null != message.message) {
      messageRecord = closure_1_0(4783).createMessageRecord(message.message);
      const obj = closure_1_0(4783);
    }
    const obj2 = { message: messageRecord, saveData: closure_1_0(7861).savedMessageDataToClient(message.save_data) };
    return obj2;
  });
