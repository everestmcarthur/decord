...
// Dependencies: [32, 19, 11665, 21, 4560, 576, 504, 1090, 11716, 7149, 1114, 5123, 5628, 11717, 5605, 4527, 4763, 11718, 1896, 4153, 7150, 5687, 4511, 2]
// Exports: default
...
export default function MessageReminderDurationActionSheet(createReminder) {
  ...
  let obj3 = createReminder(11716);
  const dueInString = obj3.useDueInString({ dueAt, now: tmp7, type: createReminder(11716).DueInStringTypes.SHORT });
  ...
  const memo = obj2.useMemo(() => {
    ...
    if (tmpResult) {
      ...
      obj2.onPress = tmp4;
      obj2.children = tmp(tmp2(5628).ArrowLargeLeftIcon, { size: "md" });
      tmpResult = tmp(tmp2(5123).PressableOpacity, obj2);
    }
  ...
  if (tmp14Result) {
    const obj6 = { icon: tmp14(tmp2(4511).CheckmarkLargeIcon, {}), label: null, onPress: null, start: true, end: true };
    ...
    tmp14Result = tmp14(tmp2(5605).TableRow, obj6, "remove-reminder");
  }
  items3[1] = tmp14Result;
  obj5.children = items3;
  return isOverdue(createReminder(7150).BottomSheet, obj5);
};
