...
// Function ID: 13295
// Name: ForLaterIntro
// Dependencies: [17, 7151, 21, 4560, 576, 7861, 13295, 13296, 4556, 1114, 13297, 11712, 4523, 7209, 2]
// Exports: default

// Module 13294 (ForLaterIntro)
...
import BookmarkIcon from "BookmarkIcon" /* 11712 */;
...
function IntroDemo(isReminder) {
  ...
  const obj3 = { source: { uri: _modDef13297 }, style: tmp.avatar };
...
export default function ForLaterIntro(type) {
  ...
  const items = [timestampProducer(React3, { source: importDefault(tmp4 ? 13295 : 13296), style: tmp.upsellImage }), , ];
  ...
  const obj3 = { source: importDefault(tmp4 ? 13295 : 13296), style: tmp.upsellImage };
