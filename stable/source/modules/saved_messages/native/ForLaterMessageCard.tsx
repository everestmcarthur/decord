...
// Dependencies: [5, 19, 17, 4199, 1074, 21, 4560, 576, 5607, 6610, 4556, 1114, 8098, 4519, 11709, 11716, 4763, 1242, 7861, 4153, 13289, 504, 13290, 13293, 12219, 12220, 2]

// Module 13288 (ForLaterMessageCard)
import nativeDefault from "native" /* 576 */;
import _modDef4519 from "module_4519" /* 4519 */;
...
export default noop.memo(function ForLaterMessageCard(savedMessage) {
  ...
  const savedMessageChannel = savedMessage(11716).useSavedMessageChannel(savedMessage);
                ...
                try {
                  ...
                  if (0 === c1) {
                    if (arg0 === 1) {
                      ...
                      c1 = 1;
                      c2 = 1;
                      const obj5 = { value: v3(11716).savedMessageJumpToMessage(tmp4, c1), done: false };
                      return obj5;
                    }
                  } else if (arg0 === 1) {
                    c2 = 3;
                    ...
                    if (null != tmp4.saveData.dueAt) {
                      let BOOKMARK = v3(7861).SavedMessageSortTypes.REMINDER;
                    } else {
                      BOOKMARK = v3(7861).SavedMessageSortTypes.BOOKMARK;
                    }
                    obj8.type = BOOKMARK;
                    let diffResult;
                    if (null != tmp4.saveData.dueAt) {
                      diffResult = v1(4153)().diff(tmp4.saveData.dueAt);
                      const obj = v1(4153)();
                    }
  ...
  if (null != savedMessage.message) {
    if (null != savedMessageChannel) {
      if (obj2.useStateFromStores(items1, () => {
        ...
        const tmp8 = closure_10(savedMessageChannel(13290), obj3);
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          tmp6Result = tmp6(tmp2(13293).ForLaterCardReminderHeader, obj5);
        }
        ...
        obj6.actions = tmp12;
        items2[1] = closure_10(tmp2(12219).ForLaterCardHeader, obj6);
        ...
        items2[3] = closure_10(tmp2(12220).ForLaterMessageRow, obj8);
        obj4.children = items2;
        return closure_11(tmp2(5607).Card, obj4);
      }
    }
  }
