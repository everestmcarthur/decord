...
// Function ID: 7864
// Name: ForLaterModal
// Dependencies: [19, 17, 21, 4560, 576, 1611, 1114, 7861, 5631, 7864, 1115, 5624, 4763, 13285, 2]
// Exports: default

// Module 7863 (ForLaterModal)
...
export default function ForLaterModal(type) {
  ...
  const items = [closure_4(require("module_5631").Header, obj3), ];
