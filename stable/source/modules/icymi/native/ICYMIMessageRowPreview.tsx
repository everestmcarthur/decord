...
// Dependencies: [19, 1074, 21, 7898, 7880, 7935, 7302, 4495, 4560, 576, 1935, 7933, 8658, 8127, 1114, 2]
...
function ICYMIMessageRowPreview(pointerEvents) {
  ...
  return setting2(messageOptions(8658), {
    pointerEvents: str,
    horizontalOffset: 0,
    modifyRow(arg0) {
...
export const MessageRowPreview = noop.memo((message) => {
  ...
  const obj2 = {};
  const merged2 = Object.assign(message(7935).DEFAULT_OPTIONS);
  obj2.ignoreMentioned = true;
  obj2.renderReplies = false;
  obj2.renderThreadEmbeds = false;
  obj2.renderReactions = false;
