...
// Function ID: 16519
// Name: CaughtUpRow
// Dependencies: [5, 32, 19, 17, 21, 4296, 4556, 16455, 576, 8352, 16472, 16468, 4418, 4561, 4262, 13015, 1114, 4975, 16494, 4987, 1093, 672, 2]
// Exports: default

// Module 16518 (CaughtUpRow)
...
export default function ExploreServersRow(visible) {
  ...
  const sharedValue = visible(4296).useSharedValue(false);
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            dependencyMap(true);
            v1(8352).itemInteracted("caught_up", "caught_up", "press_explore");
            const obj5 = v1(8352);
            ...
            v1(8352).feedItemActioned(obj4);
            const obj6 = v1(8352);
            v1 = 1;
            dependencyMap = 1;
            const obj7 = { value: tmp4(16472).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const callback1 = noop.useCallback(() => {
    sharedValue(8352).itemInteracted("caught_up", "caught_up", "press_home");
    const obj = sharedValue(8352);
    sharedValue(8352).feedItemActioned({ itemId: "caught_up", itemType: "caught_up", actionParameters: { actionGestureType: "press", actionTargetElement: "back_to_home_button", actionIntentType: "navigate", actionDestinationType: "guild_home" } });
    const obj2 = sharedValue(8352);
  ...
  let obj2 = visible(4296);
  E.__closure = { visibleSharedValue: sharedValue, withTiming: visible(4561).withTiming, Easing: visible(4296).Easing };
  E.__workletHash = 6575188656069;
  E.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(E);
  let obj3 = { visibleSharedValue: sharedValue, withTiming: visible(4561).withTiming, Easing: visible(4296).Easing };
  const fn = function b() {
    let num = 0;
    if (sharedValue.get()) {
  ...
  let obj4 = visible(4296);
  fn.__closure = { visibleSharedValue: sharedValue, withDelay: visible(4296).withDelay, withSequence: visible(4296).withSequence, withTiming: visible(4561).withTiming, Easing: visible(4296).Easing };
  fn.__workletHash = 469742746264;
  fn.__initData = __initData2;
  const animatedStyle1 = obj4.useAnimatedStyle(fn);
  let obj5 = { visibleSharedValue: sharedValue, withDelay: visible(4296).withDelay, withSequence: visible(4296).withSequence, withTiming: visible(4561).withTiming, Easing: visible(4296).Easing };
  ...
  let obj6 = visible(4296);
  fn2.__closure = { visibleSharedValue: sharedValue, withDelay: visible(4296).withDelay, withSequence: visible(4296).withSequence, withTiming: visible(4561).withTiming, Easing: visible(4296).Easing };
  fn2.__workletHash = 14933607481025;
  fn2.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(fn2);
  let obj7 = { visibleSharedValue: sharedValue, withDelay: visible(4296).withDelay, withSequence: visible(4296).withSequence, withTiming: visible(4561).withTiming, Easing: visible(4296).Easing };
  const token = visible(4262).useToken(sharedValue(576).colors.BACKGROUND_BRAND);
  const obj9 = { children: null };
  const obj10 = { style: tmp.container, children: null };
  const obj11 = { style: tmp.textContainer, children: null };
  const obj12 = { style: null, children: closure_7(visible(13015).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }) };
  const items1 = [tmp.iconWrapper, animatedStyle];
  obj12.style = items1;
  const items2 = [closure_7(sharedValue(4296).View, obj12), , ];
  ...
  const items6 = [closure_7(visible(4975).Button, obj17), ];
  ...
  items6[1] = closure_7(visible(4975).Button, obj18);
  obj16.children = items6;
  items5[1] = closure_8(View, obj16);
  obj10.children = items5;
  const items7 = [closure_8(View, obj10), closure_7(visible(16494).Separator, {}), ];
