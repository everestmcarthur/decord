...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4560, 576, 5682, 1611, 4495, 1483, 8360, 16472, 4763, 7864, 7872, 1114, 5587, 16474, 16475, 16476, 16477, 4556, 9292, 13013, 4520, 4527, 16478, 1896, 4975, 2]
// Exports: default

// Module 16471 (ICYMIInfoScreen)
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const ICYMIAnalytics = tmp2(8360).ICYMIAnalytics;
            const result = ICYMIAnalytics.trackFeedOnboardingScreenSkipped({ location: "overview" });
            dependencyMap(true);
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: tmp2(16472).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj5;
          } else {
            v1(4763).pop();
            dependencyMap = 3;
  ...
  obj2.children = closure_9(extendedOnboarding(7864).HeaderIconButton, obj3);
  ...
  obj6.uri = navigation(16474);
  obj5.source = obj6;
  obj5.style = tmp.bgImage;
  const items5 = [closure_9(navigation(5587), obj5), ];
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(16475);
  } else {
    tmp2Result = tmp2(16476);
  }
  ...
  obj11.source = navigation(16477);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5587), obj11);
  ...
  items7[2] = closure_9(extendedOnboarding(4556).Text, obj12);
  ...
  items7[3] = closure_9(extendedOnboarding(4556).Text, obj13);
  ...
  const tmp2Result2 = navigation(5587);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9292).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = closure_9(extendedOnboarding(4556).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9292).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13013).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = closure_9(extendedOnboarding(4556).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13013).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  ...
  items12[1] = closure_9(extendedOnboarding(4556).Text, obj26);
  ...
  items13[1] = closure_9(extendedOnboarding(4556).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(4975).Button, obj30);
