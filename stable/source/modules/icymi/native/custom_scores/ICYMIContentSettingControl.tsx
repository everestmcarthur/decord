...
// Dependencies: [32, 19, 17, 4741, 8336, 21, 4560, 576, 8351, 1114, 1178, 16463, 16464, 16465, 9798, 9799, 504, 16466, 4556, 7201, 4713, 2]
...
import SegmentedControlState from "SegmentedControlState" /* 9798 */;
import SegmentedControl from "SegmentedControl" /* 9799 */;
...
function ContentSettingsControl(initialValue) {
  ...
  const obj2 = { source: _modDef16463, style: null };
  ...
  const obj4 = { source: _modDef16464, style: null };
  ...
  const obj6 = { source: _modDef16465, style: null };
  ...
  const obj7 = {
    ...
    onSetActiveIndex(arg0) {
      ...
      if (0 === arg0) {
        MORE = tmp(8351).ICYMICustomScore.LESS;
      } else if (2 === arg0) {
        MORE = tmp(8351).ICYMICustomScore.MORE;
      }
      _undefined(MORE);
      closure_1_0(MORE);
    },
  ...
  if (ICYMIUtils.ICYMICustomScore.LESS !== tmp3) {
    num = 1;
    if (tmp4(8351).ICYMICustomScore.MORE === tmp3) {
      num = 2;
    }
  }
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  let obj = id(504);
  const numberToCustomScoreResult = id(8351).numberToCustomScore(stateFromStores);
  c1 = numberToCustomScoreResult;
  const tmp5 = numberToCustomScoreResult === id(8351).ICYMICustomScore.MUTED;
  const items1 = [id];
  ...
  const items3 = [closure_8(id(4556).Text, obj3), , , , ];
  ...
  items3[1] = closure_8(id(4556).Text, obj4);
  ...
  obj9.children = closure_8(id(7201).TableSwitchRow, obj10);
  ...
  items3[4] = closure_8(id(4556).Text, obj11);
