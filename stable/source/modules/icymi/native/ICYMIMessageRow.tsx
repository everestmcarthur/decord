...
// Dependencies: [19, 17, 1957, 2021, 1979, 4209, 4741, 1371, 16493, 1074, 21, 576, 16455, 1115, 16456, 8264, 8349, 504, 16499, 16500, 4556, 1114, 1178, 4712, 5520, 8351, 8352, 10918, 11662, 16494, 16496, 11, 5123, 9776, 16502, 2]
// Exports: default

// Module 16498 (ICYMIMessageRow)
...
function ReplyMessageContent(message) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_14(tmp2(4556).Text, obj5), ];
    ...
    obj10.style = obj11;
    obj10.children = tmp2(4712).getName(guild.id, channel.id, stateFromStores);
    const items4 = [closure_14(tmp2(4556).Text, obj10), ];
    ...
    items4[1] = closure_14(tmp2(16456).ICYMIContext.Provider, obj12);
...
export default function MessageRowWrapper(arg0) {
  ...
  gravityMessage = gravityMessage(8351).useGravityMessage(message);
  const obj = gravityMessage(8351);
