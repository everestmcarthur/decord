...
// Dependencies: [5, 19, 1957, 4901, 1371, 1374, 4553, 21, 504, 8131, 9313, 4573, 16510, 4404, 7682, 7456, 16506, 4527, 4259, 1114, 14890, 8352, 11126, 7763, 16510, 1896, 2]
    ...
    obj2.openReplyActionSheet = noop.useCallback(() => {
      if (null != stateFromStores) {
        ...
        if (ContentInventoryEntryType.ContentInventoryEntryType.CUSTOM_STATUS !== content_type) {
          if (tmp9(8131).ContentInventoryEntryType.TOP_GAME === content_type) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16510, tmp10.paths), "ReactActionSheet", obj5);
      }
    }, items6);
