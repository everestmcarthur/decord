...
// Dependencies: [19, 17, 1371, 21, 13012, 8136, 13017, 16455, 576, 504, 4794, 9182, 7168, 8134, 8681, 8692, 8131, 16505, 1896, 8352, 4763, 16509, 1114, 16511, 4556, 4404, 7641, 11, 672, 5123, 5587, 16512, 2]
// Exports: default
...
let items = [{ Badge: BadgesAll.NewGameBadge, predicate: fn(8136).isEntryNew }, , , , ];
let obj = { Badge: BadgesAll.NewGameBadge, predicate: fn(8136).isEntryNew };
items[1] = {
