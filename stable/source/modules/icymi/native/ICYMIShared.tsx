...
// Function ID: 16495
// Name: ICYMIShared
// Dependencies: [19, 17, 7306, 1957, 2021, 4199, 1371, 1074, 21, 8349, 9204, 5087, 10137, 16423, 7110, 7244, 7038, 7456, 4491, 16455, 1115, 576, 1178, 8819, 5584, 4982, 5123, 4556, 7641, 16495, 8678, 504, 4712, 8352, 8180, 5094, 8351, 16091, 9791, 1114, 16456, 4495, 4262, 4409, 4296, 4561, 4573, 5071, 7209, 4550, 2]
...
export const SimplePost = function SimplePost(arg0) {
  ...
  token = highlight(4262).useToken(token(576).colors.MESSAGE_HIGHLIGHT_BACKGROUND_DEFAULT, tmp4);
  let obj = highlight(4262);
  const hexWithOpacityResult = highlight(4409).hexWithOpacity(token(576).unsafe_rawColors.BRAND_360, 0.25);
  dependencyMap = hexWithOpacityResult;
  let obj2 = highlight(4409);
  const sharedValue = highlight(4296).useSharedValue(0);
  let obj3 = highlight(4296);
  const fn = function c() {
  ...
  let obj4 = highlight(4296);
  fn.__closure = { interpolateColor: highlight(4296).interpolateColor, progress: sharedValue, bgColor: token, bgColorHighlighted: hexWithOpacityResult };
  ...
  if (highlight) {
    ...
    const items2 = [tmp12(tmp2(4296).View, obj7), ];
  ...
  if (obj2.useStateFromStores(items2, () => PermissionStore.canWithPartialContext(constants5.VIEW_CHANNEL, { channelId: parentMessage.id }))) {
    if (null != thread) {
      if (null != mostRecentMessage) {
        ...
        items4[1] = closure_18(tmp2(4556).Text, obj5);
        const obj7 = { style: tmp.commentCount, children: null };
        const obj8 = { style: tmp.commentsIcon };
        const items5 = [closure_18(tmp2(5071).ChatIcon, obj8), , ];
        const obj9 = { variant: "text-sm/bold", color: "interactive-text-default", children: str };
        items5[1] = closure_18(tmp2(4556).Text, obj9);
        const obj10 = { style: tmp.chevron, size: "xxs" };
        items5[2] = closure_18(tmp2(7209).ChevronSmallRightIcon, obj10);
        obj7.children = items5;
        items4[2] = closure_19(View, obj7);
        obj3.children = items4;
        return closure_19(tmp2(5123).PressableHighlight, obj3);
      }
    }
    ...
    const items7 = [closure_18(tmp2(4556).Text, obj12), ];
    const obj13 = { style: tmp.commentCount, children: null };
    const obj14 = { style: tmp.commentsIcon };
    const items8 = [closure_18(tmp2(5071).ChatIcon, obj14), ];
    const obj15 = { style: tmp.chevron, size: "xxs" };
    items8[1] = closure_18(tmp2(7209).ChevronSmallRightIcon, obj15);
    obj13.children = items8;
    items7[1] = closure_19(View, obj13);
    obj11.children = items7;
    return closure_19(tmp2(5123).PressableHighlight, obj11);
  } else {
    return null;
  }
