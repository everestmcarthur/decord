      ...
      try {
        ...
        if (0 === v3) {
          if (arg0 === 1) {
            ...
            v3 = 1;
            dependencyMap = 1;
            const obj7 = { value: v3(8352).fetchDehydrated({ isReloading: true }), done: false };
            return obj7;
          }
        } else if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            v3 = 2;
            dependencyMap = 1;
            const obj9 = { value: v3(8352).reloadICYMITab(), done: false };
            return obj9;
          }
        } else if (2 === tmp5) {
          if (arg0 === 1) {
            ...
            v3 = 3;
            dependencyMap = 1;
            const obj12 = { value: v3(8352).getGuildChannelScores(), done: false };
            return obj12;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
