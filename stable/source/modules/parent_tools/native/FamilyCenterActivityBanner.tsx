...
// Dependencies: [19, 17, 21, 4560, 8651, 8652, 14879, 576, 11924, 1114, 2396, 14886, 14887, 4556, 2]
// Exports: default

// Module 14878 (FamilyCenterActivityBanner)
...
const FamilyCenterBannerButton = tmp2(14879);
require = fn;
...
export default function FamilyCenterActivityBanner() {
  ...
  obj5.source = tmp(tmp3 ? 14886 : 14887);
  obj5.style = tmp4.art;
