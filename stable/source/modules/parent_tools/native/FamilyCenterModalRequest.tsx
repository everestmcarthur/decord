...
// Dependencies: [5, 19, 17, 1371, 7538, 21, 4560, 576, 1483, 563, 7539, 11920, 7593, 11921, 8422, 8423, 1178, 1396, 1114, 2396, 4556, 11922, 11923, 11931, 5433, 4975, 4763, 5692, 8652, 38, 11569, 6992, 5577, 8273, 1894, 8412, 8414, 4773, 5624, 11932, 11933, 2]
// Exports: default

// Module 11919 (FamilyCenterModalRequest)
...
import ModalScreen from "ModalScreen" /* 8422 */;
import ModalContent from "ModalContent" /* 8423 */;
import useIsInAdultAgeGroupDefault from "useIsInAdultAgeGroup" /* 8652 */;
import FamilyCenterModalRequestRouting from "FamilyCenterModalRequestRouting" /* 11920 */;
...
function FamilyCenterConfirmAgeScreen(teenIdentity) {
  ...
  const tmp7 = stateFromStores(8273)(stateFromStores);
  dependencyMap = tmp7;
  ...
  const callback = noop.useCallback(() => {
    const obj = stateFromStores(8412);
    const result = obj.showAgeVerificationGetStartedModal({ entryPoint: navigation(8414).AgeVerificationModalEntryPoint.FAMILY_CENTER_CONNECTION });
  }, []);
  const obj3 = { style: tmp.content, children: null };
  const obj2 = navigation(563);
  const items2 = [closure_12(closure_6, { style: tmp.art, children: closure_12(navigation(5692).FamilyShieldSpotIllustration, {}) }), , ];
  ...
  items2[1] = closure_12(navigation(4556).Text, obj5);
  ...
  items2[2] = closure_12(navigation(4556).Text, obj7);
  ...
  const items4 = [closure_12(navigation(4975).Button, obj10), ];
  ...
  items4[1] = closure_12(navigation(4975).Button, obj11);
  obj9.children = items4;
  obj8.children = closure_13(navigation(5433).ButtonGroup, obj9);
  items3[1] = closure_12(navigation(11931).ModalFooter, obj8);
  obj6.children = items3;
  return closure_13(navigation(8422).ModalScreen, obj6);
}
...
function FamilyCenterPrereqMustBeAdultScreen() {
  ...
  const tmp3 = stateFromStores(8273)(stateFromStores);
  dependencyMap = tmp3;
  ...
  obj5.onPress = stateFromStores(4763).pop;
