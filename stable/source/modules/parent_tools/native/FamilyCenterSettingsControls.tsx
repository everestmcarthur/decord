...
// Dependencies: [19, 17, 7538, 1074, 21, 4560, 576, 4556, 1114, 2396, 4763, 14910, 1896, 14912, 5605, 8651, 14896, 7594, 1483, 14913, 4973, 5687, 4975, 7587, 4573, 14828, 7539, 14914, 2]
// Exports: default

// Module 14909 (FamilyCenterSettingsControls)
...
function SpendingLimitRow(teenId) {
  ...
  const tmp = closure_9();
  const spendingLimitDisplayState = teenId(14912).useSpendingLimitDisplayState(teenId.cap);
  ...
  if ("off" === kind) {
    ...
    obj2.trailing = closure_7(tmp2(4556).Text, obj3);
    let tmp8 = obj2;
    ...
    obj4.trailing = closure_7(tmp2(4556).Text, obj5);
    tmp8 = obj4;
    ...
    obj12.trailing = closure_7(tmp2(4556).Text, obj13);
    ...
    obj12.subLabel = closure_7(tmp2(4556).Text, obj14);
    tmp8 = obj12;
  ...
  if (null != teenId) {
    fn = () => {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14910, dependencyMap.paths), { teenId }, undefined, { animation: "slide_from_right" });
    };
  }
  obj15.onPress = fn;
  obj15.arrow = null != teenId;
  obj15.disabled = null == teenId;
  return closure_7(teenId(5605).TableRow, obj15);
}
...
function FamilyCenterSettingsParentalControls() {
  const tmp = closure_9();
  selectedTeenUser = selectedTeenUser(14896).useSelectedTeenUser();
  let obj = selectedTeenUser(14896);
  const shouldLoadSettingsForSelectedTeenUser = selectedTeenUser(14896).useShouldLoadSettingsForSelectedTeenUser();
  const obj2 = selectedTeenUser(14896);
  const isFamilyCenterV3Enabled = selectedTeenUser(7594).useIsFamilyCenterV3Enabled({ location: "FamilyCenterSettingsControls" });
  const obj3 = selectedTeenUser(7594);
  ...
  const items1 = [closure_7(selectedTeenUser(4556).Text, obj6), , ];
  ...
  items1[1] = closure_7(selectedTeenUser(4556).Text, obj7);
  ...
  const items2 = [closure_7(selectedTeenUser(5605).TableRow, obj9), , , ];
  ...
  items2[1] = closure_7(selectedTeenUser(5605).TableRow, obj10);
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(5605).TableRow, obj12);
  }
  items2[3] = tmp15Result2;
  obj8.children = closure_8(selectedTeenUser(5687).TableRowGroup, { hasIcons: false, children: items2 });
  items1[2] = closure_7(View, obj8);
  obj5.children = items1;
  return closure_8(selectedTeenUser(4973).Stack, obj5);
}
