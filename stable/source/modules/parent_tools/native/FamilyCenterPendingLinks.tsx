...
// Dependencies: [19, 17, 7538, 21, 4560, 576, 8651, 11924, 1114, 2396, 4556, 8652, 5123, 4763, 14928, 1896, 1178, 9572, 14929, 14926, 14930, 14921, 2]
// Exports: default
  ...
  if (undefined === str) {
    ...
    if (tmp4) {
      ...
      obj2.onPress = function onPress() {
        ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14930, dependencyMap.paths), { otherUser: str });
      };
      obj2.style = tmp.actionButton;
      const obj4 = { size: tmp5(1178).Icon.Sizes.SMALL, disableColor: true, source: tmp2(14926) };
      obj2.children = closure_5(tmp5(1178).Icon, obj4);
      let tmp8Result = tmp17(tmp5(5123).PressableOpacity, obj2);
      let tmp14 = tmp17;
    } else {
      ...
      if (!tmp7) {
        ...
        obj.onPress = function onPress() {
          ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14928, dependencyMap.paths), { otherUser: str });
        };
        const items = [, ];
        ({ actionButton: arr[0], actionButtonFirst: arr[1] } = tmp);
        obj.style = items;
        const obj6 = { size: tmp5(1178).Icon.Sizes.SMALL, disableColor: true, source: tmp2(9572) };
      ...
      obj8.onPress = function onPress() {
        ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14929, dependencyMap.paths), { otherUser: str });
      };
      obj8.style = tmp.actionButton;
      const obj10 = { size: tmp5(1178).Icon.Sizes.SMALL, disableColor: true, source: tmp2(14926) };
      obj8.children = tmp14(tmp5(1178).Icon, obj10);
      items1[1] = tmp14(tmp5(5123).PressableOpacity, obj8);
      obj7.children = items1;
      tmp8Result = closure_6(closure_7, obj7);
    }
    const obj11 = { otherUser: str, actions: tmp8Result };
    return tmp14(tmp2(14921), obj11);
  }
