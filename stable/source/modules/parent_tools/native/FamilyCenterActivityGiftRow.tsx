...
// Dependencies: [19, 17, 21, 4560, 576, 8174, 14896, 14905, 14907, 4404, 14906, 4556, 2]
// Exports: default

// Module 14908 (FamilyCenterActivityGiftRow)
...
export default function FamilyCenterActivityGiftRow(arg0) {
  ...
  if (null == displayName) {
    ...
    if (null != teenUserForId) {
      name = tmp2(4404).getName(teenUserForId);
    ...
    const items = [React4(tmp2(14906), obj5), ];
    ...
    const items1 = [React4(tmp5(4556).Text, obj7), ];
    const obj8 = { variant: "text-xs/medium", color: "text-muted", children: giftSubtext };
    items1[1] = React4(tmp5(4556).Text, obj8);
