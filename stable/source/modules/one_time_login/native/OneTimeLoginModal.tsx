...
// Dependencies: [5, 19, 17, 502, 1371, 1074, 1230, 21, 4560, 576, 1611, 1477, 1116, 1242, 4763, 4417, 1100, 4906, 4910, 6610, 1114, 4910, 6593, 5125, 4378, 13865, 4556, 6942, 2]
// Exports: default
...
export default function OneTimeLoginModal(token) {
  ...
  const obj3 = { dark: token(4378).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
  ...
  items8[1] = closure_13(token(4556).Text, obj8);
  ...
  const items10 = [closure_13(token(4556).Text, obj10), ];
  ...
  items10[1] = closure_13(token(6942).LinkButton, obj11);
