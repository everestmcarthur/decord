...
// Module 15116 (QuestDisclosureModalActionCreators)
...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      const result = tmp(7718).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(7718).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5451).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(7724).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(7724);
    } else if (tmp(5451).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5451).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
    const merged1 = Object.assign(tmp11);
    obj12.isTargetedDisclosure = isTargetedDisclosure.isTargetedDisclosure;
    obj9.pushLazy(asyncRequireImpl(15117, tmp2.paths), obj12, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
