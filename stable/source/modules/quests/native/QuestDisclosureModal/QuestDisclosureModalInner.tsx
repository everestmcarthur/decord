...
// Dependencies: [17, 1074, 21, 4560, 576, 1935, 9292, 1114, 8892, 11830, 9229, 5692, 4556, 11300, 5607, 2024, 4975, 2]
// Exports: default
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  if (setting) {
    obj.icon = tmp5(tmp2(9292).ServerIcon, { size: "xs" });
    ...
    obj.icon = tmp5(tmp2(8892).GlobeEarthIcon, { size: "xs" });
    const intl = tmp2(1114).intl;
    obj.text = intl.string(tmp2(1114).t.xQSdPv);
    items1 = [obj, , ];
    const obj2 = { icon: tmp5(tmp2(11830).UserIcon, { size: "xs" }), text: null };
    const intl2 = tmp2(1114).intl;
    obj2.text = intl2.string(tmp2(1114).t.mYt7hQ);
    items1[1] = obj2;
    const obj3 = { icon: tmp5(tmp2(9229).GameControllerIcon, { size: "xs" }), text: null };
  ...
  if (isTargetedDisclosure) {
    ...
    isTargetedDisclosure = tmp6(tmp2(5607).Card, obj7);
  }
