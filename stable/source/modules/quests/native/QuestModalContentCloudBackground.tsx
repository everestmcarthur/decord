...
// Dependencies: [19, 17, 21, 4560, 4269, 4495, 4987, 5587, 15131, 15132, 2]
// Exports: default

// Module 15130 (QuestModalContentCloudBackground)
...
export default function QuestModalContentCloudBackground(align) {
  ...
  if (isThemeDarkResult) {
    ...
    obj6.style = items2;
    obj6.source = importDefault(isThemeDarkResult ? 15131 : 15132);
