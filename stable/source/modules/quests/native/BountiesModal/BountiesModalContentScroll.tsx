...
// Dependencies: [32, 19, 17, 7702, 5444, 15008, 1074, 1954, 21, 1116, 576, 4560, 4296, 1477, 1611, 15009, 11488, 11525, 11526, 4561, 4564, 7718, 11502, 1109, 504, 15012, 15013, 1256, 7728, 15015, 15016, 11281, 5451, 5449, 11517, 15005, 15017, 15049, 15050, 15020, 15051, 11783, 15052, 8880, 15056, 4987, 15057, 15058, 4285, 13400, 2]
// Exports: default

// Module 15007 (BountiesModalContentScroll)
...
import BountiesVerticalScrollExperiment from "BountiesVerticalScrollExperiment" /* 11526 */;
import shared_ThemeTypes from "shared/ThemeTypes" /* 13400 */;
import BountiesModalActionCreatorsDefault from "BountiesModalActionCreators" /* 15005 */;
import BountiesScrollPromptFooter from "BountiesScrollPromptFooter" /* 15009 */;
import useBountiesRecapScroll from "useBountiesRecapScroll" /* 15012 */;
import useBountySwipeUpNux from "useBountySwipeUpNux" /* 15013 */;
import useBountiesAutoScroll from "useBountiesAutoScroll" /* 15015 */;
import useBountiesRecapOrbCount from "useBountiesRecapOrbCount" /* 15016 */;
import BountiesScrollVideoItem from "BountiesScrollVideoItem" /* 15017 */;
import BountiesScrollRecapPage from "BountiesScrollRecapPage" /* 15052 */;
...
function BountiesModalContentScrollInner(arg0) {
  ...
  if (0 === data.length) {
    ...
    if (tmp55) {
      let tmp99 = c15(tmp2(15049), {});
    } else {
      tmp99 = null;
      if (tmp45) {
        const obj33 = { orbAmount: stateFromStores };
        tmp99 = c15(tmp5(15050).BountiesScrollRecapFooter, obj33);
      }
    }
    ...
    const items30 = [c15(tmp2(15051), obj36), , , , , , , ];
    ...
    if (tmp30) {
      ...
      obj37.children = tmp102(tmp5(11783).QuestContentImpressionTrackerNative, obj38);
      tmp102Result = tmp102(tmp2(4296).View, obj37);
    }
    ...
    obj39.children = c15(tmp5(8880).AnimatedFlashList, obj40);
    items30[2] = c15(tmp2(4296).View, obj39);
    ...
    if (null != tmp18) {
      ...
      tmp102Result5 = tmp102(tmp2(15056), obj41);
    }
    ...
    if (tmp93) {
      ...
      if (data.length > 1) {
        ...
        obj42.children = tmp102(tmp2(4987), obj43);
        tmp102Result6 = tmp102(tmp2(4296).View, obj42);
      }
    }
    ...
    if (tmp42) {
      ...
      tmp102Result7 = tmp102(tmp2(15057), obj45);
    }
    obj44.children = tmp102Result7;
    items30[5] = c15(tmp2(4296).View, obj44);
    ...
    if (visible) {
      ...
      if (!tmp19) {
        ...
        obj46.children = tmp102(tmp2(15058), obj47);
        tmp102Result8 = tmp102(tmp104, obj46);
      }
    }
    items30[6] = tmp102Result8;
    const tmp103 = ref;
    const tmp2Result = tmp2(15051);
    if (!tmp55) {
      tmp55 = tmp45;
    }
    if (tmp55) {
    ...
    items30[7] = c15(tmp2(15009), obj48);
    obj35.children = items30;
    obj34.children = tmp103(questHomeBounties, obj35);
    return c15(tmp5(15020).BountyVideoEndAppStoreProvider, obj34);
  }
