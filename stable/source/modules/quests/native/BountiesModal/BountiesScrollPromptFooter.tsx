...
// Dependencies: [19, 17, 4552, 5444, 21, 4560, 576, 4561, 4564, 504, 1611, 4296, 4271, 15010, 15011, 9974, 2]
// Exports: default
...
function BountiesScrollPromptFooterContent(zIndex) {
  ...
  obj3.children = closure_7(zIndex(4271).BountiesScrollGradientRive, { stateMachine: "State Machine 1", fit: "fill", alignment: "bottom-center", withReducedMotion: str });
