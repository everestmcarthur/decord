...
// Dependencies: [19, 17, 4552, 5444, 21, 4560, 576, 4561, 4564, 11526, 15043, 1114, 4296, 4987, 15046, 15048, 4556, 10185, 15010, 504, 15011, 9974, 2]
// Exports: default

// Module 15045 (BountiesScrollEndCard)
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const isBountiesVerticalScrollExperimentEnabled = isActive(11526).useIsBountiesVerticalScrollExperimentEnabled("BountiesScrollEndCard");
  let obj = isActive(11526);
  const bountyCtaInfo = isActive(15043).getBountyCtaInfo(bounty);
  const intl = isActive(1114).intl;
  const stringResult = intl.string(isActive(1114).t["9UtZAY"]);
  let obj2 = isActive(15043);
  const fn = function y() {
  ...
  const obj3 = isActive(4296);
  fn.__closure = { isScrollingInBoundsSharedValue, withTiming: isActive(4561).withTiming, isActive, timingStandard: isActive(4564).timingStandard };
  ...
  obj5.style = items;
  const items1 = [closure_9(closure_6, { style: tmp.backdropTint, pointerEvents: "none" }), closure_9(isScrollingInBoundsSharedValue(4987), { colors: ["rgba(0, 0, 0, 0.48)", "rgba(0, 0, 0, 0.8)"], style: tmp.backdropGradient, pointerEvents: "none" }), ];
  if (isBountiesVerticalScrollExperimentEnabled) {
    ...
    const items3 = [tmp10(tmp9(15046), obj9), ];
    ...
    obj10.children = tmp10(tmp9(15048), obj11);
    items3[1] = tmp10(tmp11, obj10);
    obj8.children = items3;
    let tmp10Result = tmp8(tmp9(4296).View, obj8);
  } else {
    let tmp13;
    if (isActive) {
      tmp13 = onReplay;
    ...
    items6[1] = tmp10(tmp2(10185).RetryIcon, obj17);
    obj13.children = items6;
    obj12.children = tmp8(tmp9(4296).View, obj13);
    tmp10Result = tmp10(closure_4, obj12);
  }
  items1[2] = tmp10Result;
  obj5.children = items1;
  return closure_10(isScrollingInBoundsSharedValue(4296).View, obj5);
}
...
entering.__closure = { withTiming: fn(4561).withTiming, timingStandard: fn(4564).timingStandard };
...
let obj2 = { withTiming: fn(4561).withTiming, timingStandard: fn(4564).timingStandard };
fn2.__closure = { withTiming: fn(4561).withTiming, timingStandard: fn(4564).timingStandard };
