...
// Dependencies: [19, 17, 5444, 15098, 21, 576, 4560, 15105, 1114, 15099, 4296, 4974, 15095, 15195, 5587, 7073, 4556, 15198, 5692, 2]
...
export default noop.memo(function QuestDockBountyHeader() {
  const questDockBounty = activeQuestDockMode(15105).useQuestDockBounty();
  ...
  const tmpResult = activeQuestDockMode(4296);
  ...
  const tmpResult4 = activeQuestDockMode(4296);
  ...
  const obj3 = { withSpring: activeQuestDockMode(4974).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  const bountyCreative = activeQuestDockMode(15105).useBountyCreative(questDockBounty);
  const tmpResult5 = activeQuestDockMode(15105);
  const tmpResult6 = activeQuestDockMode(15095);
  const obj4 = { onSubmenuPress: activeQuestDockMode(15095).useActionSheetPressHandler(bountyCreative), children: null };
  ...
  if (tmp10Result) {
    ...
    obj6.source = obj7;
    tmp10Result = tmp10(tmp11(5587), obj6);
  }
