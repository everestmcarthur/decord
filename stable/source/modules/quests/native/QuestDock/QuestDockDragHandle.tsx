...
export default noop.memo(function QuestDockDragHandle(arg0) {
  ...
  dependencyMap = tmp5;
  youBarHorizontalMargin = activeQuestDockMode(15100).useYouBarHorizontalMargin();
  const obj = activeQuestDockMode(15100);
  ...
  const animatedStyle = activeQuestDockMode(4296).useAnimatedStyle(fn);
  ...
  const animatedStyle1 = activeQuestDockMode(4296).useAnimatedStyle(fn2);
  const obj4 = activeQuestDockMode(4296);
  ...
  const obj6 = activeQuestDockMode(4296);
  M.__closure = { withSpring: activeQuestDockMode(4974).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  M.__workletHash = 7055026667171;
  M.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(M);
  const obj7 = { withSpring: activeQuestDockMode(4974).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  class C {
    constructor() {
      tmp = closure_0(closure_2[9]);
      if (!closure_2) {
  ...
  obj10.style = items;
  const obj9 = { withSpring: activeQuestDockMode(4974).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  ...
  obj11.layout = activeQuestDockMode(15097).dimensionsLayoutTransition;
  ...
  obj12.children = closure_7(activeQuestDockMode(7154).ActionSheetHeaderBar, { variant: "overlay", accessibilityLabel: stringResult });
  const items2 = [closure_7(windowDimensions(7073), obj12), ];
  ...
  obj13.children = closure_7(tmp2(7154).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = closure_7(tmp12(7073), obj13);
