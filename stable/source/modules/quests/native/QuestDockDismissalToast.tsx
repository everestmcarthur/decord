...
// Dependencies: [19, 17, 21, 4560, 576, 4556, 1114, 12290, 4259, 12773, 2]
// Exports: displayQuestDismissalToast

// Module 15109 (QuestDockDismissalToast)
...
function QuestDockDismissalNotification() {
  ...
  obj.children = intl.format(require("util").t.dYE1px, {
    arrowHook() {
      const obj = { style: closure_0.toastArrowForwardIconContainer, children: <React3 resizeMode="contain" source={_modDef12290} style={closure_0.toastArrowForwardIcon} /> };
      return <React4 style={closure_0.toastArrowForwardIconContainer}><React3 resizeMode="contain" source={_modDef12290} style={closure_0.toastArrowForwardIcon} /></React4>;
    }
  });
...
export const displayQuestDismissalToast = function displayQuestDismissalToast() {
  ...
  obj.open({ key: "QUEST_BAR_DISMISS_TOAST", content: QuestDockDismissalNotification, icon: _modDef12773, position: "bottom" });
};
