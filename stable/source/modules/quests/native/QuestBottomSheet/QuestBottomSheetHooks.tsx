...
export const useWatchTaskPressHandler = function useWatchTaskPressHandler(questId) {
  ...
  return noop.useCallback(() => {
    ...
    if (obj3.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_bottom_sheet_watch_task")) {
      const obj4 = { type: tmp8(11202).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp8(5451).AdCreativeType.QUEST, adCreativeId: tmp4, questContentCTA: tmp8(7728).QuestContentCTA.WATCH_VIDEO, surfaceId: tmp8(5447).QuestContent.QUEST_BOTTOM_SHEET, sourceQuestContent: tmp6, impressionId: null, questContentPosition: null };
      let id;
      if (obj2 != null) {
        id = obj2.getId();
      }
      ...
      tmp8(11198).captureAdUserAction(obj4);
      const tmp8Result = tmp8(11198);
    } else {
      const obj5 = { questId: tmp4, questContent: tmp8(5447).QuestContent.QUEST_BOTTOM_SHEET, questContentCTA: tmp8(7728).QuestContentCTA.WATCH_VIDEO, questContentPosition: null, impressionId: null, sourceQuestContent: null };
      ...
      const result = tmp8(7718).trackQuestContentClicked(obj5);
      const tmp8Result2 = tmp8(7718);
    }
  }, items1);
};
      ...
      try {
        ...
        if (0 === c1) {
          ...
          if (obj12.shouldMigrateToAdAnalyticsInterface(tmp4(11197).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_bottom_sheet_mobile_activity")) {
            ...
            const obj10 = { questId: closure_128_0, questContent: tmp4(5447).QuestContent.QUEST_BOTTOM_SHEET, questContentCTA: tmp4(7728).QuestContentCTA.LAUNCH_MOBILE_ACTIVITY, questContentPosition: null, impressionId: null, sourceQuestContent: null };
            let questContentPosition1;
            if (closure_128_4 != null) {
            ...
            const result = captureAdUserAction(7718).trackQuestContentClicked(obj10);
