...
// Dependencies: [19, 17, 1371, 21, 4560, 576, 11488, 11501, 504, 11295, 7722, 1114, 4556, 5452, 5607, 15134, 11290, 15126, 11772, 15121, 5123, 8308, 4987, 5587, 15164, 8275, 2]
...
export const QuestBottomSheetProgressCardPlayStreamTask = function QuestBottomSheetProgressCardPlayStreamTask(quest) {
  ...
  c8 = undefined;
  const tmp = closure_9();
  questTaskDetails = questTaskDetails(11488).useQuestTaskDetails(quest);
  let obj = questTaskDetails(11488);
  let isQuestProgressing = questTaskDetails(11488).useIsQuestProgressing(quest);
  ...
  noop = tmp9;
  let obj2 = questTaskDetails(11488);
  const result = questTaskDetails(11501).supportedTaskPlatforms(quest);
  c4 = result;
  const tmp2Result = questTaskDetails(11501);
  questFormattedDate = questTaskDetails(11488).useQuestFormattedDate(quest.config.rewardsConfig.rewardsExpireAt);
  gameTitle = quest.config.messages.gameTitle;
  const tmp2Result5 = questTaskDetails(11488);
  ...
  const tmp2Result7 = questTaskDetails(11295);
  ...
  if (isQuestProgressing) {
    ...
    obj7.children = tmp18(tmp2(4556).Text, obj8);
    isQuestProgressing = tmp18(tmp17, obj7);
  }
  items3[1] = isQuestProgressing;
  obj3.children = items3;
  return c8(questTaskDetails(5607).Card, obj3);
};
export const QuestBottomSheetProgressCardWatchTask = function QuestBottomSheetProgressCardWatchTask(quest) {
  ...
  const watchTaskPressHandler = quest(15126).useWatchTaskPressHandler({ questId: quest.id, sourceQuestContent: quest.sourceQuestContent });
  ...
  if (isHeroVideoSupportedResult) {
    ...
    obj7.source = obj8;
    const items4 = [tmp14(tmp2(8308).VideoComponent, obj7), ];
  ...
  tmp2Result2 = quest(11488);
  items7[1] = closure_7(quest(8275).PlayIcon, { color: nativeDefault.colors.WHITE });
  ...
  obj4.children = closure_8(quest(5607).Card, obj5);
  return closure_7(quest(5123).PressableOpacity, obj4);
};
