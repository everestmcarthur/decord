...
// Dependencies: [5, 32, 19, 17, 7703, 17035, 5444, 21, 4560, 576, 1116, 4495, 4269, 504, 7168, 7724, 11488, 11780, 5447, 1396, 11281, 7728, 4763, 4277, 11779, 15121, 4973, 5587, 11775, 4556, 1114, 4975, 5617, 7377, 6992, 11783, 11933, 2]
// Exports: default
...
function QuestActivityUnenrolledModalInner(quest) {
  ...
  const theme = quest(4495).useTheme();
  let obj = quest(4495);
  const tmp4 = closure_14(quest(4269).isThemeDark(theme));
  let obj2 = quest(4269);
  ...
  let obj3 = quest(504);
  let obj4 = quest(7168);
  const getOrFetchApplication = obj4.useGetOrFetchApplication(quest(7724).getActivityApplicationId(quest));
  const obj5 = quest(7724);
  const questTaskDetails = quest(11488).useQuestTaskDetails(quest);
  let obj6 = quest(11488);
  const obj7 = quest(11780);
  const items1 = [getOrFetchApplication];
  const questsInstructionsToWinReward = obj7.useQuestsInstructionsToWinReward({ quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5447).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL });
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const obj4 = { questContent: tmp4(5447).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL, questContentCTA: tmp4(7728).QuestContentCTA.START_QUEST, sourceQuestContent: tmp4(5447).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(11281).enrollInQuest(quest.id, obj4), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const obj8 = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5447).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
  const checkboxA11yNative = quest(4277).useCheckboxA11yNative({ checked });
  ({ accessibilityRole, accessibilityState } = checkboxA11yNative);
  const obj9 = quest(4277);
  const isQuestAccessSuspended = quest(11488).useIsQuestAccessSuspended();
  const obj10 = quest(11488);
  trackQuestContentClickedWithImpression = quest(11779).useTrackQuestContentClickedWithImpression();
  ...
  if (tmp18Result) {
    ...
    obj16.children = tmp18(checked(5587), obj17);
  ...
  obj19.children = closure_11(checked(11775), size);
  ...
  const items6 = [closure_11(quest(4556).Text, obj21), ];
  ...
  items6[1] = closure_12(quest(4556).Text, obj22);
  ...
  const items9 = [closure_11(quest(4975).Button, obj26), ];
  ...
  items9[1] = closure_11(quest(4975).Button, obj27);
...
export default function QuestActivityUnenrolledModal(questId) {
  ...
  if (null == stateFromStores) {
    ...
    return closure_11(tmp(11933).Modal, obj4);
  }
  let obj = questId(504);
  tmp = questId;
};
