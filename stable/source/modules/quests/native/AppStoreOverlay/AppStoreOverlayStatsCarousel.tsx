...
function AppStoreOverlayStatCardItem(onRatingPress) {
  ...
  if ("rating" === type) {
    ...
    if (null != stat.ratingCount) {
      result1 = tmp9(11509).formatAppStoreRatingCount(stat.ratingCount, tmp9(1114).intl.currentLocale);
      const tmp9Result = tmp9(11509);
    }
  ...
  if (tmp23Result) {
    ...
    if (null == secondaryContent) {
      ...
      secondaryContent = tmp23(tmp20(4556).Text, obj9);
    }
