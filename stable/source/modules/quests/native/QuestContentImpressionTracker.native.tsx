...
// Dependencies: [32, 19, 1895, 11201, 1074, 21, 8880, 8273, 504, 11491, 11492, 5451, 2]
// Exports: BillableAdPlacementImpressionTrackerNative, QuestContentImpressionTrackerNative

// Module 11783 (QuestContentImpressionTracker)
...
function AdContentImpressionTrackerBaseNative(skipRemountKey) {
  ...
  let tmp6 = visibilityRef(8273)(tmp3);
  const adContentImpressionTrackerProps = adContentIds2(11491).useAdContentImpressionTrackerProps(skipRemountKey);
  ...
  const obj2 = adContentIds2(11491);
  let items1 = [joined];
  const tmp10 = _slicedToArray(adContentIds2(8880).useRecyclingState(false, items1), 2);
  dependencyMap = tmp11;
  ...
  const obj4 = adContentIds2(8880);
  const obj6 = {};
  const merged1 = Object.assign(skipRemountKey);
  const merged2 = Object.assign({ visible: overrideVisibility, visibleChanged: overrideVisibility !== tmp5(8273)(overrideVisibility) });
  obj6.focused = tmp3;
  ...
  if (tmp17) {
    obj7.adCreativeType = tmp(5451).AdCreativeType.QUEST;
    let tmp19 = obj7;
  } else {
