...
export default function BannerBase(arg0) {
  ...
  obj8.style = items3;
  const items4 = [closure_7(sharedValue(4987), obj8), , ];
  ...
  obj10.source = require("module_12066");
  obj10.autoPlay = !stateFromStores;
  const items5 = [closure_7(sharedValue(5529), obj10), image];
  ...
  return closure_8(sharedValue(4296).View, obj7);
};
