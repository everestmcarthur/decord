...
// Dependencies: [5, 32, 19, 21, 12032, 9295, 11997, 7523, 5612, 4975, 1114, 4505, 2]
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            const obj2 = tmp3(9295);
            obj6.optionValues = tmp3(11997).parseOptionValuesForSend(commandContext.channel, command, {});
            obj6.context = commandContext;
            obj6.sectionName = sectionName;
            obj6.commandOrigin = tmp3(7523).CommandOrigin.APP_LAUNCHER_APPLICATION_VIEW;
            dependencyMap = 2;
            c4 = 1;
