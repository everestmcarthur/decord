...
// Dependencies: [19, 21, 1484, 8098, 5629, 5681, 1114, 2]
// Exports: default
...
export default function AppLauncherBackButton(onPress) {
  ...
  const obj2 = { size: "sm", variant: "secondary-overlay", icon: importDefault(canGoBackResult ? 5629 : 5681), onPress: onPress.onPress, accessibilityLabel: null, maxFontSizeMultiplier: 1.5 };
