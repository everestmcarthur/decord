...
// Dependencies: [32, 19, 1074, 21, 4560, 576, 1874, 4527, 12175, 1896, 12173, 5123, 4556, 2]
// Exports: default
...
export default function AppLauncherAutocompleteOption(arg0) {
  ...
  function onPress() {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12175, dependencyMap.paths), "AppLauncherAutocompleteActionSheet", {
      option,
      initChoice,
      onChoiceSelect(arg0) {
        closure_1_9(arg0);
