...
// Dependencies: [32, 19, 17, 1482, 21, 4560, 576, 8880, 1611, 1115, 5442, 8599, 4527, 6945, 12170, 12171, 2]
// Exports: default

// Module 12169 (AppLauncherChoicesActionSheet)
...
export default function AppLauncherChoicesActionSheet(option) {
  ...
  if (tmp13) {
    ...
    tmp16 = closure_7(tmp3(12171).AppLauncherListSearchBar, obj3);
  }
  const items3 = [tmp16, ];
  if (0 === data.length) {
    let tmp20 = closure_7(tmp3(12171).AppLauncherListEmptyState, {});
  } else {
  ...
  return closure_8(option(12170).AppLauncherCommandOptionActionSheet, obj2);
};
