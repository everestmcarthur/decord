...
// Dependencies: [19, 17, 1371, 9414, 1482, 1074, 21, 576, 4560, 4296, 504, 12055, 4262, 8133, 12060, 9295, 8862, 12135, 4556, 1178, 8098, 4504, 1242, 7190, 12136, 4258, 1114, 12137, 2]
// Exports: default

// Module 12134 (application_view/Header)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import ToastUtils from "ToastUtils" /* 4258 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4296 */;
import ClipboardUtils from "ClipboardUtils" /* 7190 */;
import useAvatarColorDefault from "useAvatarColor" /* 8133 */;
...
export default function Header(application) {
  ...
  if (null != application) {
    appLauncherIconSource = tmp(12055).getAppLauncherIconSource(application);
    const tmpResult = tmp(12055);
  }
  let obj = application(504);
  let str = application(4262).useToken(nativeDefault.colors.BACKGROUND_BASE_LOW);
  let tmp7 = appLauncherIconSource;
  const tmpResult9 = application(4262);
  ...
  if (null != appLauncherIconSource) {
    ...
    let tmp12 = closure_8(tmp5(12060), obj2);
    let tmp13 = closure_8;
  } else {
  ...
  const tmpResult10 = application(4296);
  ...
  const tmpResult11 = application(4296);
  ...
  let obj5 = { interpolate: application(4296).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult12 = application(4296);
  ...
  let obj6 = { interpolate: application(4296).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult13 = application(4296);
  ...
  if (null != application) {
    str2 = tmp(9295).getSectionName(application);
    const tmpResult14 = tmp(9295);
  }
  ...
  if (hasApplicationFlagResult) {
    hasApplicationFlagResult = tmp(8862).hasApplicationFlag(application, constants2.EMBEDDED);
    const tmpResult15 = tmp(8862);
  }
  ...
  const obj7 = { interpolate: application(4296).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  const tmp23 = id;
  ...
  if (null != application) {
    ...
    if (tmpResult16.isRealApplication(application)) {
      ...
      const obj15 = {
        ...
        onPress() {
              ...
              if (c2) {
                ...
                const merged = Object.assign(tmp4(9295).getInstallAppProps(tmp2));
                activityLaunchURL = obj4.getApplicationInstallURL(obj6);
                const tmp4Result = tmp4(9295);
              }
      ...
      const items7 = [tmp13(tmp(8098).IconButton, obj15), ];
      const obj16 = { application, onAddAppMenuClick };
      items7[1] = tmp13(tmp5(12137), obj16);
      obj14.children = items7;
      tmp22Result = tmp22(tmp23, obj14);
    }
    tmpResult16 = tmp(9295);
  }
