...
// Dependencies: [19, 17, 1074, 21, 4560, 12133, 12152, 4740, 9415, 4556, 1114, 7523, 2]
// Exports: default
...
let obj2 = { container: { marginBottom: fn(12133).BETWEEN_SECTIONS_MARGIN }, header: { flexDirection: "row", alignItems: "center", gap: 4, marginBottom: 8 } };
...
export default function FrecencyCommandsSection(commands) {
  ...
  if (0 !== arr.length) {
    ...
    obj2.children = arr(context(4556).Heading, obj3);
