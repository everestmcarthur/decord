...
export const SubmittingOverlay = function SubmittingOverlay(submitting) {
  ...
  S.__closure = { withSpring: submitting(4974).withSpring, submitting, SUBTLE_SPRING: submitting(4978).SUBTLE_SPRING };
  ...
  obj3.style = items;
  if (submitting) {
    submitting = tmp5(tmp2(4991).Ellipsis, { variant: "active", size: "md" });
  }
