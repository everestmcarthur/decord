...
let closure_10 = noop.memo((applicationId) => {
  ...
  heroMediaDimensions = heroMediaDimensions(12088).useHeroMediaDimensions({ width: obj.useRequiredAppLauncherContext().width });
