...
// Dependencies: [19, 17, 4552, 21, 1894, 4560, 576, 504, 4296, 12165, 12166, 4556, 12167, 1178, 10420, 2]
// Exports: default
...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    if (hasItem1) {
      ...
      tmp17Result = tmp17(tmp2(4556).Text, obj7);
    }
    ...
    items2[2] = closure_5(tmp2(4556).Text, obj9);
    if (hasItem) {
      ...
      const obj11 = { style: tmp.optionErrorIcon, source: tmp18(10420), size: tmp2(1178).IconSizes.REFRESH_SMALL_16 };
      ...
      items3[1] = tmp17(tmp2(4556).Text, obj12);
      obj10.children = items3;
      hasItem = tmp19(tmp18(4296).View, obj10);
    }
    items2[3] = hasItem;
    obj6.children = items2;
    obj5.children = closure_6(View, obj6);
    obj4.children = closure_5(ReanimatedRexportDefault.View, obj5);
    obj3.children = closure_5(tmp2(12166).AwaitAnimationContext, obj4);
    return closure_5(tmp2(4296).LayoutAnimationConfig, obj3);
  } else {
    return null;
  }
