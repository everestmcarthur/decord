...
// Dependencies: [109, 19, 1482, 1074, 21, 7914, 4560, 576, 7162, 7182, 4427, 1609, 7000, 4740, 1484, 12087, 12131, 12157, 12199, 11220, 2]
...
export default noop.memo(function AppLauncherNavigator(arg0) {
  ...
  obj17.children = closure_8(entrypoint(7162).AnalyticsLocationProvider, obj2);
  ...
  return closure_8(entrypoint(11220).AppLauncherContext.Provider, { value: { bottomSheetExpandReasonRef, bottomSheetIndex, bottomSheetPosition, chatInputRef, entrypoint, entrypointParams: tmp20, keyboardCloseReasonRef, onActivityItemSelected, width }, children: closure_8(entrypoint(1484).NavigationIndependentTree, obj16) });
});
