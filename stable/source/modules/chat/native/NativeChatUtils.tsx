...
export default {
  ...
  updateRows(arg0, rows) {
    if (null != arg0) {
      if (obj6.isIOS()) {
        const andIncrementChangesetIdForChat = tmp31(11278).getAndIncrementChangesetIdForChat(arg0);
        ({ rows, forceReload } = rows);
        if (forceReload == null) {
          forceReload = false;
        }
        const tmp31Result = tmp31(11278);
        ...
        if (null != tmp2) {
          ...
          const andIncrementChangesetIdForChat1 = tmp31(11278).getAndIncrementChangesetIdForChat(arg0);
          ...
          const tmp31Result2 = tmp31(11278);
        }
      }
      obj6 = PlatformUtils;
    }
  ...
  clearRows(arg0) {
    if (null != arg0) {
      if (obj4.isIOS()) {
        ...
        Commands.clearRows(arg0, tmp6(11278).getAndIncrementChangesetIdForChat(arg0));
        const tmp6Result = tmp6(11278);
      } else {
        const tmp2 = React4(arg0);
        if (null != tmp2) {
          const obj = NativeChatModuleDefault;
          obj.clearRows(tmp2, tmp6(11278).getAndIncrementChangesetIdForChat(arg0));
          const tmp6Result2 = tmp6(11278);
        }
      }
      obj4 = PlatformUtils;
    }
