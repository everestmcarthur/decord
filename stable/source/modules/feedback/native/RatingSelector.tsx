...
// Function ID: 11636
// Name: RatingSelector
// Dependencies: [19, 17, 11631, 21, 4560, 11636, 11637, 1114, 11641, 11642, 11646, 11647, 8601, 5123, 2]
// Exports: default

// Module 11635 (RatingSelector)
import _modDef11636 from "module_11636" /* 11636 */;
import _modDef11641 from "module_11641" /* 11641 */;
import _modDef11646 from "module_11646" /* 11646 */;
...
export default function RatingSelector(ratingOptions) {
  ...
  let obj3 = { selected: _modDef11636, normal: null };
  tmp = closure_9();
  obj3.normal = textLabels(11637).useFeedbackModalSadDesaturatedSource();
  obj2.source = obj3;
  ...
  let obj6 = { selected: _modDef11641, normal: null };
  let obj4 = textLabels(11637);
  obj6.normal = textLabels(11642).useFeedbackModalNeutralDesaturatedSource();
  obj5.source = obj6;
  ...
  const obj9 = { selected: _modDef11646, normal: null };
  let obj7 = textLabels(11642);
  obj9.normal = textLabels(11647).useFeedbackModalHappyDesaturatedSource();
  obj8.source = obj9;
  ...
  return <closure_3 style={tmp2.ratings}>{mapped.map((rating) => {
    ...
    if (null != rating) {
      ...
      obj.children = jsx(textLabels(8601).RowButton, { accessibilityRole: "button", accessibilityLabel: getLabel(), accessibilityState: null, onPress: null, icon: null, label: null });
