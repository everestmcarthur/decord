...
// Dependencies: [32, 19, 17, 11631, 21, 4560, 576, 4527, 8273, 12, 11634, 4992, 4763, 11653, 1896, 1611, 7150, 7149, 7199, 6627, 4556, 11635, 5687, 5605, 5604, 1114, 2]
// Exports: default

// Module 11652 (FeedbackActionSheet)
...
export default function FeedbackActionSheet(feedbackReasons) {
  ...
  const unmountEffect = reasons(otherKey[11]).useUnmountEffect(() => {
    if (c13) {
      ...
      obj2.pushLazy(asyncRequireImpl(11653, dependencyMap.paths), obj3);
