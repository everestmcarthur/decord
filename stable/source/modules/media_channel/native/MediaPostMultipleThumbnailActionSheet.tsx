...
// Module 10270 (MediaPostMultipleThumbnailActionSheet)
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4556).Text, obj6), closure_5(markAsDismissed(1178).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4556).Text, obj7);
  ...
  items2[3] = closure_5(markAsDismissed(4556).Text, obj8);
  ...
  items2[5] = closure_5(markAsDismissed(4975).Button, obj9);
  obj3.children = items2;
  obj2.children = closure_6(markAsDismissed(6627).BottomSheetScrollView, obj3);
