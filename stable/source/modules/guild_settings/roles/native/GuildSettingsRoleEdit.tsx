...
// Dependencies: [109, 5, 19, 17, 2016, 502, 2021, 2015, 1979, 9070, 17613, 17608, 1074, 17615, 21, 4560, 576, 4271, 5624, 7377, 1114, 4740, 17617, 12, 1242, 9744, 17627, 4259, 9572, 5597, 5520, 11578, 4904, 1178, 5687, 5605, 17628, 17635, 17637, 17638, 4973, 8599, 1483, 504, 4204, 7040, 2]
// Exports: default
...
import ChannelPermissionsUtils from "ChannelPermissionsUtils" /* 9744 */;
    ...
    applyArgumentsResult.handleSaveRole = function handleSaveRole() {
      return new Promise((arg0) => {
        ...
        if (effectiveSection === constants2.PERMISSIONS) {
          ...
          const obj4 = { name, color: primary_color1, colors: tmp7, hoist, mentionable };
        }
        ...
        function success() {
          applyArgumentsResult(17627).commitSectionChanges(id, effectiveSection);
          navigation.pop();
      ...
      closure_0 = asyncGeneratorStep(async (arg0, value) => {
        if (c2 === 2) {
          ...
          try {
            ...
            if (0 === v1) {
              if (arg0 === 1) {
                ...
                if (null === guild_connections) {
                  v1 = 1;
                  c2 = 1;
                  const obj6 = { value: tmp4(11578).putRoleConnectionsConfigurations(id.id, role.id, []), done: false };
                  return obj6;
                }
              }
            } else if (arg0 === 1) {
            ...
            v1(5520).deleteRole(closure_128_1.id, closure_128_2.id);
            closure_128_3.pop();
            c2 = 3;
            return { value: "HermesInternal", done: null };
          } catch (tmp18) {
...
prototype["renderSubScreenButtons"] = function renderSubScreenButtons() {
  ...
  const items = [closure_22(self(5605).TableRow, obj2), , ];
  ...
  items[1] = closure_22(self(5605).TableRow, obj3);
  ...
  items[2] = closure_22(self(5605).TableRow, obj4);
  obj.children = items;
...
prototype["render"] = function render() {
  ...
  if (tmp2) {
    ...
    let tmp22Result = tmp22(tmp24(4973).Stack, obj7);
  } else {
    ...
    obj9.children = __initData3(tmp24(4973).Stack, obj17);
    tmp22Result = tmp22(tmp24(8599).Form, obj9);
  }
