...
// Dependencies: [19, 17, 7128, 17613, 1074, 5408, 21, 4560, 576, 5407, 12, 6610, 4556, 1114, 4973, 5123, 2024, 5685, 5688, 17639, 4975, 11209, 4527, 17641, 1896, 17642, 17644, 504, 8599, 17627, 2]
// Exports: default
...
function HeaderSection(arg0) {
  ...
  if (hasConnections) {
    ...
    obj6.children = tmp13(tmp10(4556).Text, obj7);
    tmp13Result = tmp13(tmp10(5123).PressableOpacity, obj6);
  }
...
function AndOrRadios(setPendingRoleConfigurations) {
  ...
  if (ConnectionsUtils.ConnectionConfigurationRuleOperator.OR === ConnectionsUtils.ConnectionConfigurationRuleOperator.AND) {
    ...
    const obj3 = { value: tmp(5407).ConnectionConfigurationRuleOperator.OR, label: null, disabled: null };
    ...
    obj3.disabled = tmp11;
    const items2 = [closure_1_10(tmp(5688).TableRadioRow, obj3), ];
    const obj4 = { value: tmp(5407).ConnectionConfigurationRuleOperator.AND, label: null, disabled: null };
    const intl3 = tmp(1114).intl;
    obj4.label = intl3.string(tmp(1114).t.gHXS9A);
    obj4.disabled = locked;
    items2[1] = closure_1_10(tmp(5688).TableRadioRow, obj4);
    obj2.children = items2;
    return closure_1_11(tmp(5685).TableRadioGroup, obj2);
  }
}
...
function AddConnectionButton(locked) {
  ...
  obj.onPress = function onPress() {
    ...
    obj.openLazy(asyncRequireImpl(17641, dependencyMap.paths), combined, obj2);
  };
...
export default function GuildSettingsRolesEditConnectionsControls(guild) {
  ...
  const obj9 = {
    handleConnectionTapped(connectionType, applicationId) {
      const items = [...memo];
      const obj = { connectionType, connectionMetadataField: "Array", applicationId, operator: "pos", value: 79953921 };
      items.push(obj);
      if (AND === ConnectionsUtils.ConnectionConfigurationRuleOperator.AND) {
        if (0 === items.length) {
          let items1 = [];
