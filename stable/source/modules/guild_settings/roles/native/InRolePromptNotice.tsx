...
// Dependencies: [19, 17, 1074, 21, 4560, 576, 1384, 17634, 1178, 9631, 4556, 1114, 2]
// Exports: default
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      const obj3 = { style: string.icon, source: _modDef9631, color: nativeDefault.unsafe_rawColors.YELLOW_300 };
      ...
      Icon = tmp6(tmp(4556).Text, obj4);
      items[1] = Icon;
      obj2.children = items;
      let tmp4Result = tmp4(tmp5, obj2);
    } else {
      const obj5 = { style: string.icon, source: _modDef9631 };
      ...
      items1[1] = tmp6(tmp(4556).Text, obj6);
