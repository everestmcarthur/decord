...
// Dependencies: [5, 32, 19, 17, 1975, 2015, 1371, 9070, 17612, 1074, 21, 4560, 5682, 576, 1242, 4740, 4556, 1114, 17610, 504, 38, 4204, 1483, 6625, 5624, 5520, 4258, 17609, 4527, 16294, 1896, 4973, 6606, 5687, 5605, 14600, 1091, 4975, 17616, 17617, 9069, 17618, 6981, 4962, 4971, 7039, 4992, 7000, 2]
// Exports: default
...
function RoleCreateScene() {
  ...
  const callback2 = onSelect.useCallback(() => {
    React6.dismiss();
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16294, dependencyMap.paths), "RoleColorPicker", { color, onSelect });
  }, items3);
...
export default function GuildSettingsRoleCreateModal() {
  ...
  return closure_21(stateFromStores(7000).Navigator, { screens, initialRouteName: obj7.STEP_DISPLAY });
};
