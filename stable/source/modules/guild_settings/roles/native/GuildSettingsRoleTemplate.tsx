...
// Dependencies: [32, 19, 17, 4552, 1979, 17612, 1074, 21, 4560, 576, 6945, 1477, 4962, 4296, 1242, 4740, 8279, 5123, 4556, 10762, 1178, 11569, 4975, 1114, 2]
// Exports: default
      ...
      renderItem(item) {
        ...
        if (null != contentPrefaceResult) {
          ...
          if ("" !== contentPrefaceResult) {
            ...
            tmp3Result = tmp3(tmp10(4556).Text, obj6);
          }
        }
        ...
        obj8.children = item.contents().map((children, index) => {
          ...
          const items = [closure_3_14(native.Icon, { source: _modDef11569, size: native.IconSizes.MEDIUM, color: nativeDefault.unsafe_rawColors.GREEN_360 }), closure_3_14(Text_Text.Text, { style: closure_3.templateContentText, variant: "text-sm/medium", children })];
          obj.children = items;
