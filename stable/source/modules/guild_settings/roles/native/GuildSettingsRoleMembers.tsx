...
// Dependencies: [32, 19, 17, 7128, 1074, 21, 4560, 576, 4259, 5597, 1114, 17617, 7311, 504, 4904, 9069, 1178, 1242, 4527, 17618, 1896, 10947, 8098, 6616, 7050, 4515, 4556, 5605, 11209, 2]
// Exports: default
...
function onMembersLoadFail() {
  const obj2 = { key: "ERROR_OCCURRED_TRY_AGAIN", icon: _modDef5597, content: null };
...
export default function GuildSettingsRoleMembers(guild) {
    ...
    if (found.length !== arr.length) {
      ...
      obj2.onConfirm = function onConfirm() {
        ...
        GuildSettingsActionCreatorsDefault.updateMemberRoles(guild.id, name.id, found, [], items).catch(() => {
          ...
          obj2.icon = found(5597);
          found(4259).open(obj2);
        });
      };
  ...
  const callback1 = found.useCallback(() => {
    ...
    obj2.openLazy(asyncRequireImpl(17618, dependencyMap.paths), "role-add-members-" + guild.id + "-" + role.id, { guild, role });
  }, items3);
