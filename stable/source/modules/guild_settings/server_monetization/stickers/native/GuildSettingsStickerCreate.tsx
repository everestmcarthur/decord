...
// Dependencies: [5, 32, 19, 17, 5459, 5502, 1074, 1374, 1938, 21, 4560, 576, 6981, 11151, 5598, 4213, 5138, 17583, 10393, 4899, 4556, 1114, 4457, 2024, 4975, 4973, 5123, 10181, 17584, 11126, 7130, 1396, 8763, 6606, 7085, 2]
...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    items2[2] = onPressEmoji(stickerId(4556).Text, obj10);
    ...
    obj12.variant = str;
    items2[3] = tmp27(stickerId(4975).Button, obj12);
  ...
  const items4 = [onPressEmoji(stickerId(4556).Text, obj15), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    let tmp32Result = tmp32(tmp14(10181), obj17);
    const tmp14Result4 = tmp14(10181);
  } else if (null != uri) {
  ...
  items4[1] = onPressEmoji(stickerId(5123).PressableHighlight, obj16);
  ...
  items4[2] = onPressEmoji(stickerId(4556).Text, obj20);
  const obj21 = {
  ...
  if (null != first1) {
    ...
    obj22.src = emojiURL;
    let tmp32Result2 = tmp32(tmp14(7130), obj22);
    const tmp14Result5 = tmp14(7130);
  } else {
    tmp32Result2 = tmp32(tmp31(8763).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4556).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj21.children = items5;
  items4[3] = closure_17(stickerId(5123).PressableHighlight, obj21);
  ...
  items4[4] = onPressEmoji(stickerId(6606).TextInput, obj24);
  ...
  items4[5] = onPressEmoji(stickerId(7085).TextArea, obj26);
  const obj27 = {
  ...
  items4[6] = onPressEmoji(stickerId(4975).Button, obj27);
  obj14.children = items4;
  items3[1] = closure_17(stickerId(4973).Stack, obj14);
