...
// Function ID: 17542
// Name: AuditLogUtils
// Dependencies: [5459, 7100, 4747, 1962, 5502, 17540, 1957, 2015, 4209, 1371, 17539, 1074, 1964, 11867, 7101, 1963, 3, 4589, 1114, 8393, 11, 17542, 1086, 1384, 4713, 1894, 4404, 14, 1091, 9828, 17543, 4242, 4153, 2]
...
import InstantInviteUtilsDefault from "InstantInviteUtils" /* 9828 */;
    ...
    if (tmp.CHANNEL !== targetType) {
      if (tmp.CHANNEL_OVERWRITE !== targetType) {
        if (tmp.USER === targetType) {
          ...
          const obj23 = {};
          obj23[__3TkD(8393).GuildInviteFlags.IS_GUEST_INVITE] = __3TkD(1114).t.XYZMbL;
          __3TkD = obj23;
      ...
      if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_UPDATE !== action) {
        if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_DELETE === action) {
          ...
          if (null == found2) {
            ...
            } else if (tmp198(17542).GuildFeedItemTypes.FORUM_POST === newValue) {
                      ...
                      if (tmp2.GUILD_SCHEDULED_EVENT !== targetType) {
                        if (tmp2.GUILD_SCHEDULED_EVENT_EXCEPTION !== targetType) {
                          if (tmp2.THREAD === targetType) {
                            ...
                            let tmp10 = null;
                            if (tmp9) {
                              tmp10 = ((channel) => result3(4713).computeChannelName(channel, user, closure_1_12, true))(tmp7);
                            }
                            let tmp11 = tmp10;
                            if (null == tmp10) {
                              tmp11 = tmp10;
    ...
    if (null != tmp3) {
      ...
      if (null != result1.options) {
        ...
        if (null != result1.options.event_exception_id) {
          ...
          let obj5 = closure_0(4242);
          let tmp244 = items(4153);
          let str5;
          if (found20 != null) {
                                        ...
                                        if (tmp323.AUTO_MODERATION_REMOVE_ALLOW_LIST !== key19) {
                                          if (tmp323.AUTO_MODERATION_EXEMPT_CHANNELS === key19) {
                                            ...
                                            if (null != newValue.oldValue) {
                                              ...
                                              oldValue = obj2.dateFormat(_modDef4153(date1), "LLLL");
                                            }
                                            if (!oldValue) {
                                              oldValue = newValue.oldValue;
                                            }
