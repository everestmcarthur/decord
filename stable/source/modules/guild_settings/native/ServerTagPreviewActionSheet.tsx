...
// Dependencies: [19, 17, 9071, 21, 4560, 576, 9193, 9194, 13916, 4527, 4556, 1114, 4975, 7039, 7198, 7149, 2]
// Exports: default
...
export default function ServerTagPreviewActionSheet(guildId) {
  ...
  if (null != guildProfile) {
    ...
    const items1 = [closure_6(tmp2(4556).Text, obj4), ];
    ...
    items1[1] = closure_6(tmp2(4975).Button, obj6);
  ...
  const items2 = [tmp8(guildId(7149).BottomSheetTitleHeader, obj13), tmp7];
  obj7.children = items2;
  return closure_7(guildId(7198).ActionSheet, obj7);
};
