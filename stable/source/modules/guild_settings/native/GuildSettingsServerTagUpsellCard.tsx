...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(12527), obj8);
  }
  ...
  const items6 = [closure_6(guildId(4556).Text, obj10), ];
  ...
  items6[1] = closure_6(guildId(4556).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(guildId(4973).Stack, obj9);
  ...
  obj12.icon = closure_6(guildId(16221).BoostTier2Icon, { color: "white" });
  obj12.onPress = guildId.onUnlockPress;
  items5[2] = closure_6(guildId(4975).Button, obj12);
  obj6.children = items5;
  items4[3] = closure_7(guildId(4973).Stack, obj6);
