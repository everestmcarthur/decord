...
// Dependencies: [19, 2012, 1979, 4199, 1371, 16146, 9070, 1074, 21, 4740, 4560, 5605, 1114, 4515, 17522, 5538, 4204, 17524, 14957, 8763, 10119, 11745, 9073, 8868, 9758, 17526, 4503, 5687, 15594, 5089, 9439, 4262, 576, 1483, 504, 9069, 17527, 7260, 7267, 4258, 8599, 4973, 16854, 1396, 17528, 7040, 2]
// Exports: default

// Module 17521 (GuildSettingsModalLanding)
...
function SettingsSection(guild) {
  ...
  obj.icon = closure_15(guild(5605).TableRow.Icon, { IconComponent: guild(4515).CircleInformationIcon });
  ...
  if (canManageGuild) {
    ...
    const obj4 = { IconComponent: tmp2(17522).ModerationIcon };
    obj3.icon = tmp(tmp2(5605).TableRow.Icon, obj4);
    obj3.onPress = function onPress() {
      return importDefault(constants2.MODERATION);
    };
    items.push(tmp(tmp2(5605).TableRow, obj3, "moderation"));
  }
  if (canViewAuditLog) {
    const obj5 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1114).intl;
    obj5.label = intl3.string(tmp2(1114).t.SPWLyT);
    const obj6 = { IconComponent: tmp2(5538).ClipboardListIcon };
    obj5.icon = tmp(tmp2(5605).TableRow.Icon, obj6);
    obj5.onPress = function onPress() {
      return importDefault(constants2.AUDIT_LOG);
    };
    items.push(tmp(tmp2(5605).TableRow, obj5, "auditlogs"));
  }
  ...
  if (canManageChannels) {
    ...
    const obj9 = { IconComponent: tmp2(17524).ChannelListIcon };
    ...
    items.push(tmp(tmp2(5605).TableRow, obj8, "channels"));
  }
  ...
  if (tmp11) {
    ...
    const obj11 = { IconComponent: tmp2(14957).PuzzlePieceIcon };
    obj10.icon = tmp(tmp2(5605).TableRow.Icon, obj11);
    obj10.onPress = function onPress() {
      return importDefault(constants2.INTEGRATIONS);
    };
    items.push(tmp(tmp2(5605).TableRow, obj10, "integrations"));
  }
  if (canManageGuildExpressions) {
    ...
    const obj13 = { IconComponent: tmp2(8763).ReactionIcon };
    obj12.icon = tmp(tmp2(5605).TableRow.Icon, obj13);
    obj12.onPress = function onPress() {
      return importDefault(constants2.EMOJI);
    };
    items.push(tmp(tmp2(5605).TableRow, obj12, "emoji"));
    ...
    const obj15 = { IconComponent: tmp2(10119).StickerIcon };
    obj14.icon = tmp(tmp2(5605).TableRow.Icon, obj15);
    obj14.onPress = function onPress() {
      return importDefault(constants2.STICKERS);
    };
    items.push(tmp(tmp2(5605).TableRow, obj14, "stickers"));
  }
  if (canConfigureOfficialMessages) {
    ...
    const obj17 = { IconComponent: tmp2(11745).StampIcon };
    obj16.icon = tmp(tmp2(5605).TableRow.Icon, obj17);
    obj16.onPress = function onPress() {
      return importDefault(constants2.OFFICIAL_MESSAGES);
    };
    items.push(tmp(tmp2(5605).TableRow, obj16, "official-messages"));
  }
  const obj2 = { IconComponent: guild(4515).CircleInformationIcon };
  if (tmp2Result.canUseMobileServerTagSettings(guild.id)) {
    ...
    const obj19 = { IconComponent: tmp2(8868).TagIcon };
    obj18.icon = tmp(tmp2(5605).TableRow.Icon, obj19);
    obj18.onPress = function onPress() {
      return importDefault(constants2.TAG);
    };
    items.push(tmp(tmp2(5605).TableRow, obj18, "server-tag"));
  }
  if (canManageGuild) {
    ...
    const obj21 = { IconComponent: tmp2(9758).ShieldUserIcon };
    obj20.icon = tmp(tmp2(5605).TableRow.Icon, obj21);
    obj20.onPress = function onPress() {
      return importDefault(constants2.SECURITY);
    };
    items.push(tmp(tmp2(5605).TableRow, obj20, "security"));
  }
  if (isGuildAdmin) {
    isGuildAdmin = tmp2(17526).canSeeVanityUrlSettings(guild);
    const tmp2Result2 = tmp2(17526);
  }
  if (isGuildAdmin) {
    ...
    const obj23 = { IconComponent: tmp2(4503).LinkIcon };
    obj22.icon = tmp(tmp2(5605).TableRow.Icon, obj23);
    obj22.onPress = function onPress() {
      return importDefault(constants2.VANITY_URL);
    };
    items.push(tmp(tmp2(5605).TableRow, obj22, "vanity"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    tmpResult = tmp(tmp2(5687).TableRowGroup, obj24);
  }
  return tmpResult;
}
function CommunitySection(pushScreen) {
  ...
  if (hasItem) {
    ...
    const obj3 = { IconComponent: tmp3(15594).TreehouseIcon };
    obj2.icon = tmp2(tmp3(5605).TableRow.Icon, obj3);
    ...
    const obj4 = { IconComponent: tmp3(15594).TreehouseIcon };
    obj2.icon = tmp2(tmp3(5605).TableRow.Icon, obj4);
    obj2.onPress = function onPress() {
...
function UserManagementSection(pushScreen) {
  ...
  obj.icon = closure_15(pushScreen(5605).TableRow.Icon, { IconComponent: pushScreen(5089).GroupIcon });
  obj.onPress = function onPress() {
  ...
  if (canManageRoles) {
    ...
    const obj4 = { IconComponent: tmp2(9758).ShieldUserIcon };
    obj3.icon = tmp(tmp2(5605).TableRow.Icon, obj4);
    obj3.onPress = function onPress() {
      return pushScreen(constants2.ROLES);
    };
    items.push(tmp(tmp2(5605).TableRow, obj3, "roles"));
  }
  if (canManageGuild) {
    const obj5 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1114).intl;
    obj5.label = intl3.string(tmp2(1114).t.ngRFjZ);
    const obj6 = { IconComponent: tmp2(4503).LinkIcon };
    obj5.icon = tmp(tmp2(5605).TableRow.Icon, obj6);
    obj5.onPress = function onPress() {
      return pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(tmp(tmp2(5605).TableRow, obj5, "invites"));
  }
  if (canManageBans) {
    const obj7 = { label: null, arrow: true, icon: null, onPress: null };
    const intl4 = tmp2(1114).intl;
    obj7.label = intl4.string(tmp2(1114).t.ZbeITS);
    const obj8 = { IconComponent: tmp2(9439).HammerIcon };
    obj7.icon = tmp(tmp2(5605).TableRow.Icon, obj8);
    obj7.onPress = function onPress() {
      return pushScreen(constants2.BANS);
    };
    items.push(tmp(tmp2(5605).TableRow, obj7, "bans"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    obj9.children = items;
    tmpResult = tmp(tmp2(5687).TableRowGroup, obj9);
  }
  return tmpResult;
}
function GuildSettingsModalLandingInner(guild) {
  ...
  const token = guild(4262).useToken(updateErrors(576).modules.mobile.TABLE_ROW_PADDING);
  ...
  const obj5 = noop;
  const obj6 = guild(17527);
  const tmp11 = guild(17527).useChannelsAllowedToUnlink(guild.id).length > 0;
  ...
  if (canManageGuildRoleSubscriptions) {
    ...
    tmp17Result2 = tmp17(tmp3(17528), obj12);
  }
  ...
  obj8.children = closure_16(guild(4973).Stack, obj9);
  const items6 = [closure_15(guild(8599).Form, obj8), closure_15(guild(7040).NavScrim, {})];
