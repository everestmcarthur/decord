...
// Dependencies: [19, 17, 5542, 21, 4560, 576, 4404, 4556, 16581, 1396, 5605, 1178, 1611, 16586, 4384, 16587, 504, 1114, 8880, 8233, 7040, 2]
...
let closure_12 = noop.memo((joinRequest) => {
  ...
  if (null == joinRequest) {
    ...
    if (null == user) {
      ...
      obj2.start = start;
      obj2.end = end;
      return closure_7(joinRequest(5605).TableRow, obj2);
    }
  }
});
