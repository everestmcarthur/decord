...
// Dependencies: [19, 1975, 1957, 2012, 4480, 4199, 4209, 1371, 9070, 1074, 21, 4560, 576, 1114, 4271, 4258, 5624, 7377, 9069, 11334, 1384, 7195, 4905, 4994, 6606, 4713, 5687, 5605, 7993, 17339, 7201, 5685, 5688, 16160, 2024, 17534, 1396, 11352, 1178, 7085, 5549, 8599, 4973, 7040, 1483, 504, 2]
// Exports: default
...
import GuildProfileLimits from "GuildProfileLimits" /* 5549 */;
...
class GuildSettingsModalOverview extends PureComponent {
  constructor() {
    ...
    applyArgumentsResult.handleAFKTimeoutChange = function handleAFKTimeoutChange() {
      const obj = applyArgumentsResult(7195);
...
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj4.trailing = closure_1_19(tmp4(5605).TableRow.TrailingText, { text: channelName });
  obj4.onPress = self.handleAfkChannelChange;
  const items = [closure_1_19(tmp4(5605).TableRow, obj4), ];
  ...
  obj5.disabled = tmp15;
  obj5.trailing = closure_1_19(tmp4(5605).TableRow.TrailingText, { text: labelResult });
  obj5.onPress = self.handleAFKTimeoutChange;
  items[1] = closure_1_19(tmp4(5605).TableRow, obj5);
  obj3.children = items;
  return closure_1_20(tmp4(5687).TableRowGroup, obj3);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  const result = tmp(7993).isEligibleForRoleSubscriptionPurchaseSystemMessageSettings(guild);
  ...
  obj3.trailing = closure_1_19(tmp(5605).TableRow.TrailingText, { text: channelName });
  obj3.onPress = self.handleSystemChannelChange;
  const items = [closure_1_19(tmp(5605).TableRow, obj3), , , , , , , ];
  ...
  items[1] = closure_1_19(tmp(7201).TableSwitchRow, obj4);
  ...
  items[2] = closure_1_19(tmp(7201).TableSwitchRow, obj5);
  ...
  items[3] = closure_1_19(tmp(7201).TableSwitchRow, obj6);
  ...
  items[4] = closure_1_19(tmp(7201).TableSwitchRow, obj7);
  if (hasFlagResult) {
    ...
    hasFlagResult = tmp16(tmp(7201).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = tmp16(tmp(7201).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = tmp16(tmp(7201).TableSwitchRow, obj10);
    const tmpResult22 = tmp(1384);
  }
  items[7] = result1;
  obj2.children = items;
  return tmp15(tmp(5687).TableRowGroup, obj2);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  if (obj.getMobileBoostProgressBarEnabled("GuildSettingsModalOverview")) {
    ...
    obj2.children = closure_1_19(tmp(7201).TableSwitchRow, obj3);
    tmp3 = closure_1_19(tmp(5687).TableRowGroup, obj2);
  }
  return tmp3;
};
...
prototype["renderSummaries"] = function renderSummaries() {
  ...
  if (obj.canGuildUseConversationSummaries(guild, false)) {
    ...
    obj4.children = closure_1_19(tmp(7201).TableSwitchRow, obj5);
    return closure_1_19(tmp(5687).TableRowGroup, obj4);
  } else {
    return null;
  }
