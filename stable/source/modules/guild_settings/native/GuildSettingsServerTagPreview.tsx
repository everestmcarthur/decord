...
// Dependencies: [5, 32, 19, 17, 1371, 7945, 21, 4560, 576, 504, 4712, 1396, 13917, 4556, 1114, 4973, 10164, 9190, 13918, 13962, 4975, 5607, 2]
// Exports: default
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  let obj = guildId(504);
  const name = onAdopted(4712).useName(guildId, null, stateFromStores);
  let obj3 = onAdopted(4712);
  let avatarURL;
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp2(13917).adoptGuildIdentity(guildId, true), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
  ...
  const items2 = [closure_10(guildId(4556).Text, obj2), ];
  ...
  const items4 = [closure_10(closure_6, { source: onAdopted(10164), style: tmp.avatar, importantForAccessibility: "no" }), ];
  ...
  items5[1] = closure_10(guildId(4556).Text, obj9);
  ...
  if (tmp15Result3) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(13918).GuildBadge, size);
    }
    obj14.guildBadge = tmp15Result;
    tmp15Result3 = tmp15(tmp2(9190).BaseGuildTagChiplet, obj14);
  }
  ...
  items9[1] = closure_10(guildId(4556).Text, obj15);
  ...
  const obj7 = { source: onAdopted(10164), style: tmp.avatar, importantForAccessibility: "no" };
  const tmp18 = closure_6;
  const items11 = [closure_10(tmp18, { source: onAdopted(13962), style: tmp.avatar, importantForAccessibility: "no" }), ];
  ...
  items12[1] = closure_10(guildId(4556).Text, obj20);
  ...
  items6[3] = closure_10(guildId(4975).Button, obj21);
  obj5.children = items6;
  items2[1] = closure_11(guildId(4973).Stack, obj5);
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result4 = tmp15(tmp2(5607).Card, obj23);
  }
  return tmp15Result4;
};
