...
// Dependencies: [19, 17, 1371, 21, 4560, 576, 4712, 4404, 9809, 1178, 504, 8599, 5605, 2]

// Module 10947 (DetailedGuildIdentityUserRow)
...
export default noop.memo(function DetailedGuildIdentityUserRow(arrow) {
  ...
  if (null == stateFromStores) {
    ...
    let tmp2Result = tmp2(tmp(8599).FormRow, obj2);
  } else {
    ...
    tmp2Result = tmp2(tmp(5605).TableRow, obj4);
  }
});
