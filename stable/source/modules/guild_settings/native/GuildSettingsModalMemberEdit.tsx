...
// Dependencies: [19, 17, 4552, 1975, 2016, 2021, 2015, 1979, 4199, 1371, 11842, 1074, 21, 4560, 576, 4204, 12, 5604, 1178, 4556, 5605, 1114, 5687, 4271, 7377, 5624, 4404, 9444, 4188, 8599, 4973, 6606, 11843, 11844, 4258, 11849, 1483, 504, 38, 9409, 7311, 7040, 11854, 11856, 5598, 7000, 2]
// Exports: default
...
import useCanToggleCommunicationDisableOnUser from "useCanToggleCommunicationDisableOnUser" /* 9409 */;
...
prototype["updateNavigator"] = function updateNavigator(submitting) {
  ...
  if (!tmp) {
    if (submitting) {
      ...
      fn = self(5624).getHeaderCloseButton(onClose);
      let obj = self(5624);
    }
...
prototype["render"] = function render() {
  ...
  if (null == member) {
    ...
    if (user.bot) {
      ...
      tmp18Result = tmp18(tmp21(9444), obj);
      const tmp21Result = tmp21(9444);
    }
    items[1] = tmp18Result;
    obj2.children = items;
    if (null == member) {
      ...
      if (!bot) {
        ...
        obj4.children = tmp18(tmp19(5605).TableRow, obj5);
        tmp18Result3 = tmp18(tmp19(5687).TableRowGroup, obj4);
      }
      ...
      obj9.label = tmp7;
      obj8.children = tmp18(tmp19(5605).TableRow, obj9);
      const items2 = [tmp18(tmp19(5687).TableRowGroup, obj8), , , , , , ];
      if (!canChangeNick) {
      ...
      if (canChangeNick) {
        ...
        canChangeNick = tmp18(tmp19(6606).TextInput, obj11);
      }
      ...
      if (canKick) {
        ...
        canKick = tmp18(tmp19(5687).TableRowGroup, obj13);
        const tmp21Result5 = tmp21(4404);
      }
      items2[4] = canKick;
      if (canBan) {
        ...
        const obj20 = { user: tmp21(4404).getName(user) };
        obj19.label = intl6.formatToPlainString(tmp19(1114).t.TuAZuW, obj20);
        obj19.onPress = self.handleBan;
        obj18.children = tmp18(tmp19(5605).TableRow, obj19);
        canBan = tmp18(tmp19(5687).TableRowGroup, obj18);
        const tmp21Result6 = tmp21(4404);
      }
      items2[5] = canBan;
      items2[6] = tmp18Result3;
      obj7.children = items2;
      obj6.children = tmp16(tmp19(4973).Stack, obj7);
      return tmp18(tmp19(8599).Form, obj6);
    } else {
      ...
      if (result) {
        const obj23 = { user: tmp21(4404).getName(user) };
        ...
        const tmp21Result7 = tmp21(4404);
      } else {
        const obj24 = { user: tmp21(4404).getName(user) };
