...
export const MIN_EXPRESSION_PICKER_WIDTH = 498;
export const MIN_MARGIN = 8;
export const PADDING_HORIZONTAL = 8;
export const PADDING_VERTICAL = 4;
export const ExpressionPickerWidths = { MIN: "min", MAX: "max" };
export const ExpressionPickerOrder = items;
