          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              if (null == closure_129_3) {
                ...
                const utcResult = _modDef4153().utc();
                obj6.createdAfter = _modDef4153().utc().subtract(_location(7429).DRAFT_ORDER_LOOKBACK_DAYS, "days").toISOString();
                ...
                c5 = 3;
                c6 = 1;
                const subtractResult = _modDef4153().utc().subtract(_location(7429).DRAFT_ORDER_LOOKBACK_DAYS, "days");
              }
            }
          } else if (2 === tmp7) {
            c4 = 0;
            ...
            obj11.tags = obj12;
            const result = _location(4233).captureBillingException(closure_129_5, obj11);
            throw closure_129_5;
          } else if (arg0 === 1) {
            c6 = 3;
            throw value;
