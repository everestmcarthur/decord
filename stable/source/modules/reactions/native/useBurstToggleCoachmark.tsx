...
// Dependencies: [32, 19, 17, 1371, 1954, 21, 1943, 4560, 576, 9379, 504, 4218, 7388, 1114, 11132, 2]
// Exports: default
...
export default function useBurstToggleCoachmark(targetRef) {
  ...
  obj2 = first(4218);
  const tmp5 = _slicedToArray(first(7388).useSelectedDismissibleContent(items2), 2);
  first = tmp5[0];
  closure_1 = tmp7;
  ...
  const coachmark = first(11132).useCoachmark(targetRef, memo);
  return tmp5[1];
};
