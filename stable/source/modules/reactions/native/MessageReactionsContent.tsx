...
// Dependencies: [32, 19, 17, 4552, 1957, 2021, 7762, 4199, 1074, 21, 4296, 4556, 4560, 576, 504, 4211, 1332, 7763, 7764, 5598, 12, 7162, 11262, 4712, 4404, 8180, 7137, 1178, 1396, 9809, 1115, 5680, 8605, 11263, 1114, 11264, 4409, 1935, 7130, 11265, 4561, 1477, 4518, 4527, 11266, 1896, 7209, 7189, 11267, 4528, 4529, 1611, 8233, 7150, 6627, 510, 7269, 7784, 7825, 11268, 7072, 2]
...
function ReactionTab(arg0) {
  ...
  if (null != emojiColorPalette) {
    const obj3 = { backgroundColor: tmp3(4409).hexOpacityToRgba(emojiColorPalette.backgroundColor, emojiColorPalette.opacity) };
    tmp8 = obj3;
...
function EmojiOptionsButton(channelId) {
  ...
  const obj2 = {
    onPress: noop.useCallback(() => {
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11266, dependencyMap.paths), "ReactionEmojiOptionsActionSheet", { channelId, messageId, reaction, canRemoveReactions }, "replaceTopSheet");
    }, items2),
  ...
  const items3 = [closure_17(channelId(4556).Text, obj3), ];
...
function ReactionTabs(setReactionSelectedIndex) {
  ...
  const obj = setReactionSelectedIndex(7189);
  ...
  obj4.initialNumTabsToRender = reactionSelectedIndex(4211).MAX_REACTIONS;
  const items = [closure_17(setReactionSelectedIndex(11267), obj4), closure_17(setReactionSelectedIndex(8605), { outer: true }), ];
  ...
  obj7.children = reactionSelectedIndex(4211).getReactionEmojiName(reactions[reactionSelectedIndex].emoji);
  const items1 = [closure_17(reactionSelectedIndex(4556).Text, obj7), ];
  const obj12 = {};
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  const isActiveChannelOrUnarchivableThread = tmp10(7269).useIsActiveChannelOrUnarchivableThread(stateFromStores);
  closure_130_0 = channelId;
  const tmp10Result3 = tmp10(7269);
  ...
  let obj3 = { scrollable: true, backdropOpacity: tmp10(7784).BACKDROP_OPACITY, backdropChildren: null, header: null, children: null };
  ...
  if (NORMAL === tmp10(7763).ReactionTypes.BURST) {
    ...
    obj4.children = tmp27(tmp19(7825), obj5);
  ...
  if (tmp26) {
    ...
    let tmp27Result4 = tmp27(tmp19(11268), obj7, name);
    const tmp19Result3 = tmp19(11268);
  } else {
    const obj8 = { inActionSheet: true };
    const merged1 = Object.assign(obj2);
    tmp27Result4 = tmp27(tmp19(7072), obj8, name);
    const tmp19Result4 = tmp19(7072);
  }
  obj3.children = tmp27Result4;
  return closure_17(tmp10(7150).BottomSheet, obj3);
};
