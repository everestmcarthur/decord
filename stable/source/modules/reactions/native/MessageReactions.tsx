...
// Dependencies: [19, 4781, 21, 504, 7162, 7182, 11261, 2]
// Exports: default
...
export default function MessageReactions(emoji) {
  ...
  if (items3.length > 0) {
    ...
    let tmp9Result = tmp9(tmp4(11261).MessageReactionsContent, obj3);
  } else {
    tmp9Result = tmp9(tmp4(11261).MessageReactionsEmpty, {});
  }
  obj2.children = tmp9Result;
  return jsx(items3(7162).AnalyticsLocationProvider, { value: tmp3(AnalyticsLocationDefault.MESSAGE_REACTIONS).analyticsLocations, children: null });
};
