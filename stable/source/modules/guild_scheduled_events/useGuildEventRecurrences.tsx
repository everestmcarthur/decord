...
// Dependencies: [32, 19, 7526, 504, 9804, 9671, 12, 11, 1090, 9787, 2]
// Exports: default

// Module 9803 (useGuildEventRecurrences)
...
import usePrevValueDefault from "usePrevValue" /* 9804 */;
...
export default function useGuildEventRecurrences(arg0, arg1, byWeekday) {
  ...
  if (null != byWeekday) {
    if (null != stateFromStores) {
      ...
      let _Date = Date;
      let rRule = tmp(9671).getRRule(byWeekday);
