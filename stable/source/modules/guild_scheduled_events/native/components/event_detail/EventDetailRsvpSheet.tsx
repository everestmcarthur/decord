...
// Dependencies: [19, 17, 4600, 1371, 1085, 21, 4560, 576, 5524, 8408, 9808, 4556, 1114, 8599, 5587, 7162, 504, 1178, 9809, 4404, 8180, 9810, 6627, 5577, 2]

// Module 9807 (EventDetailRsvpSheet)
...
function RemainingUsersRow(remainingUsersGroup) {
  ...
  const obj3 = { source: _modDef9808, style: tmp.remainingUsersIcon };
