...
// Dependencies: [19, 17, 1963, 1074, 21, 4560, 576, 9668, 4527, 9088, 8597, 1178, 1114, 4556, 4975, 9709, 2]
// Exports: default

// Module 9811 (EndEventActionSheet)
...
export default function EndEventActionSheet(channel) {
  ...
  const tmp = closure_7();
  const activeEvent = channel(9668).useActiveEvent(channel.id);
  if (null == activeEvent) {
    return null;
  } else {
    ...
    obj6.children = closure_5(tmp2(4975).Button, obj7);
    ...
    obj8.children = closure_5(tmp2(4975).Button, obj9);
    items[3] = closure_5(View, obj8);
    obj3.children = items;
    obj2.children = closure_6(View, obj3);
    return closure_5(activeEvent(8597), obj2);
  }
  let obj = channel(9668);
};
