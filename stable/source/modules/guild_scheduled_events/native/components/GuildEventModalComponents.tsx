...
// Dependencies: [19, 17, 1963, 1074, 21, 4560, 6606, 1114, 9671, 4556, 8908, 1874, 4527, 9432, 1896, 9717, 9718, 9719, 5101, 9720, 9721, 8628, 5097, 5685, 5688, 7085, 4153, 9723, 4973, 2]
...
// Module 9716 (GuildEventModalComponents)
...
import useGuildsUserCanStartStageIn from "useGuildsUserCanStartStageIn" /* 9718 */;
import _modDef9719 from "module_9719" /* 9719 */;
import _modDef9720 from "module_9720" /* 9720 */;
import LocationIcon from "LocationIcon" /* 9721 */;
import noop from "module_19" /* 19 */;

const _modDef8628 = tmp4(8628);
require = fn;
...
export const GuildEventRecurrence = function GuildEventRecurrence(startDate) {
  ...
  recurrenceOptions = startDate(9671).getRecurrenceOptions(startDate);
  ...
  obj3.children = closure_11(startDate(4556).Text, obj4);
  ...
  const obj5 = {
    onPress() {
      ...
      obj2.openLazy(asyncRequireImpl(9432, dependencyMap.paths), "SelectRecurrenceOption", obj3);
    },
    text: null,
    value: null,
    icon: null,
...
export const GuildEventEntityTypeSelection = function GuildEventEntityTypeSelection(arg0) {
  ...
  if (features.has(GuildFeatures.COMMUNITY)) {
    ...
    obj4.icon = _modDef8628;
    obj4.IconComponent = tmp(5097).StageIcon;
...
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  if (maximumDate === undefined) {
    ...
    maximumDate = timeLabel(4153)().add(30, "days").endOf("month");
    const addResult = timeLabel(4153)().add(30, "days");
  }
  ...
  time = "date";
  items[1] = closure_11(time(8908).InputButton, {
    text: dateLabel,
  ...
  time = "time";
  items2[1] = closure_11(time(8908).InputButton, {
    text: timeLabel,
  ...
  obj2.children = closure_12(time(4973).Stack, obj3);
