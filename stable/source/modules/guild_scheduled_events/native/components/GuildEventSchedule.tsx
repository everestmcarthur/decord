...
// Dependencies: [19, 21, 4153, 9671, 9716, 1114, 2]
// Exports: default

// Module 9715 (GuildEventSchedule)
...
export default function GuildEventSchedule(schedule) {
  ...
  const addResult = onChange(4153)().add(schedule(9671).MAX_DAYS_AHEAD_AN_EVENT_CAN_START, "days");
  ...
  const addResult1 = onChange(4153)().add(schedule(9671).MAX_DAYS_AHEAD_AN_EVENT_CAN_END, "days");
  if (null != recurrenceId) {
    addResult.add(tmp3(9671).MAX_YEARS_AHEAD_RECURRING_EVENT, "years");
    addResult1.add(tmp3(9671).MAX_YEARS_AHEAD_RECURRING_EVENT, "years");
  }
  const obj2 = {
  ...
  const children = [closure_4(schedule(9716).GuildEventDatetime, obj2), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = closure_4(tmp3(9716).GuildEventDatetime, obj4);
  }
