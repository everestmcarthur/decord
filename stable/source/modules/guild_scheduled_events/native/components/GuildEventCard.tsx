...
// Function ID: 9815
// Name: GuildEventCard
// Dependencies: [19, 17, 4583, 7526, 1963, 21, 4560, 576, 9778, 5433, 504, 9710, 5607, 8411, 9802, 2]

// Module 9814 (GuildEventCard)
import nativeDefault from "native" /* 576 */;
import ButtonGroup from "ButtonGroup" /* 5433 */;
import GuildEventCardComponents from "GuildEventCardComponents" /* 9778 */;
...
function GuildEventCardControls(onCloseAction) {
  ...
  if (tmp6Result) {
    const obj3 = { event };
    tmp6Result = tmp6(tmp2(9778).GuildEventCardRSVPAction, obj3);
  }
  items[1] = tmp6Result;
