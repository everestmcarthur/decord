...
// Dependencies: [19, 17, 1957, 1979, 7526, 21, 4560, 576, 504, 9675, 9677, 9674, 9671, 1114, 5123, 9778, 4556, 9704, 1178, 9806, 2]
// Exports: default

// Module 9805 (GuildEventRecurrence)
...
export default function GuildEventRecurrence(recurrenceId) {
  ...
  let obj2 = guildEventId(9675)(recurrenceId, id);
  const tmp6 = guildEventId(9675);
  const items1 = [c6];
  ...
  closure_5 = recurrenceId(9677).useManageResourcePermissions(stateFromStores2).canManageGuildEvent(stateFromStores);
  const tmp2Result5 = recurrenceId(9677);
  const eventScheduleById = recurrenceId(9674).useEventScheduleById(guildEventId, recurrenceId);
  ...
  if (null == stateFromStores) {
    ...
    obj4.children = closure_8(tmp2(9778).GuildEventCardHeader, obj5);
    const items5 = [closure_8(tmp2(5123).PressableOpacity, obj4), ];
    ...
    if (tmp21Result) {
      ...
      tmp21Result = tmp21(tmp2(4556).Text, obj7);
    }
    ...
    const obj9 = { source: tmp5(9806), size: tmp2(1178).Icon.Sizes.REFRESH_SMALL_16, style: tmp.secondarySmallIcon };
    obj8.children = closure_8(tmp2(1178).Icon, obj9);
    items6[1] = closure_8(tmp2(5123).PressableOpacity, obj8);
    obj6.children = items6;
    items5[1] = closure_9(stateFromStores1, obj6);
    obj3.children = items5;
    return closure_9(stateFromStores1, obj3);
  }
  const tmp2Result6 = recurrenceId(9674);
};
