...
// Dependencies: [19, 17, 21, 576, 4560, 4259, 8780, 4271, 8239, 4262, 8782, 1114, 1369, 8801, 5095, 2]
// Exports: default

// Module 8779 (WishlistItemCardBase)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import ToastActionCreatorsDefault from "ToastActionCreators" /* 4259 */;
import useToken from "useToken" /* 4262 */;
import native from "native" /* 4271 */;
import useUserProfileColors from "useUserProfileColors" /* 8239 */;
...
function SourceIcon(toastText) {
  ...
  const obj = {
    ...
    children: closure_5(toastText(8780).HeartIcon, { color: nativeDefault.colors.INTERACTIVE_ICON_DEFAULT, size: "md" })
  };
...
export default function WishlistItemCardBase(username) {
  ...
  let tmp14Result4 = source === tmp2(8782).WishlistItemSource.WISHLIST;
  ...
  if (tmp14Result) {
    ...
    obj7.children = tmp14(tmp2(8801).CheckmarkLargeBoldIcon, obj8);
  ...
  if (tmp14Result3) {
    ...
    obj9.children = tmp14(tmp2(5095).LockIcon, obj10);
