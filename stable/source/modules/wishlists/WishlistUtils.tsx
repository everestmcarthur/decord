...
// Function ID: 13073
// Name: WishlistUtils
// Dependencies: [32, 5511, 8786, 8787, 8788, 1074, 1373, 1114, 7231, 2]
...
require = fn;
let closure_4 = fn(8786).isCollectiblesWishlistItemRecord;
let closure_5 = fn(8787).isPremiumWishlistItemRecord;
const isSKUWishlistItemRecord = fn(8788).isSKUWishlistItemRecord;
