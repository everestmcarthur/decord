...
// Dependencies: [19, 17, 8193, 1954, 21, 4560, 576, 4527, 4418, 7150, 10754, 4556, 1114, 2492, 4975, 10666, 7182, 16942, 11035, 504, 8185, 2]
// Exports: default
...
function HasBadgeCoachmark(markAsDismissed) {
  ...
  const items3 = [closure_8(markAsDismissed(4556).Text, obj6), ];
  ...
  items3[1] = closure_8(markAsDismissed(4556).Text, obj7);
  ...
  obj8.children = closure_8(markAsDismissed(4975).Button, obj9);
...
function NewBadgeCoachmark(markAsDismissed) {
  ...
  const obj4 = { source: { uri: _modDef16942 }, style: tmp.newBadgeImage };
  ...
  const items3 = [closure_8(markAsDismissed(4556).Text, obj7), ];
  ...
  items3[1] = closure_8(markAsDismissed(4556).Text, obj8);
  ...
  const obj5 = { uri: _modDef16942 };
  obj10.icon = closure_8(markAsDismissed(11035).GiftIcon, { size: "sm", color: nativeDefault.colors.CONTROL_PRIMARY_TEXT_DEFAULT });
  obj10.onPress = callback;
  obj9.children = closure_8(markAsDismissed(4975).Button, obj10);
