...
// Dependencies: [19, 17, 7547, 1887, 21, 4560, 576, 8179, 4277, 11047, 5123, 8830, 8816, 8801, 4556, 1114, 2]
// Exports: default
...
let closure_10 = noop.memo((rewardSkuId) => {
  ...
  if (null == product) {
    ...
    if (claimed) {
      ...
      obj8.children = tmp7(tmp2(8801).CheckmarkLargeBoldIcon, obj9);
    ...
    const items4 = [React5(tmp2(4556).Text, obj11), ];
    ...
    items4[1] = React5(tmp2(4556).Text, obj12);
    obj10.children = items4;
    items3[2] = React6(View, obj10);
    obj4.children = items3;
    return React6(tmp2(5123).PressableOpacity, obj4);
  }
});
