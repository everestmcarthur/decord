...
// Dependencies: [19, 17, 4552, 10670, 1074, 1954, 21, 4560, 576, 1115, 504, 10758, 16931, 8273, 4527, 7162, 7182, 10666, 7150, 8814, 5587, 4556, 4975, 11035, 1114, 2]
// Exports: default

// Module 16930 (GiftingPromotionCoachmark)
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const themeAndReducedMotionAwareAssetUrl = markAsDismissed(10758).useThemeAndReducedMotionAwareAssetUrl(asset);
  let obj2 = markAsDismissed(10758);
  ...
  const str = markAsDismissed(16931).useTickingFormattedLimitedOfferTimeLeft(endDate);
  importDefault = tmp9;
  ...
  const tmp2Result3 = markAsDismissed(16931);
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp18Result) {
        ...
        obj5.children = tmp18(tmp2(4556).Text, obj6);
      ...
      obj10.icon = tmp18(tmp2(11035).GiftIcon, obj11);
      const intl = tmp2(1114).intl;
      obj10.text = intl.string(tmp2(1114).t.Ve9Ge6);
      obj10.onPress = tmp16;
      items4[3] = tmp18(tmp2(4975).Button, obj10);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj12.children = tmp18(tmp2(8814).APNGPlayer, obj13);
      ...
      tmp18Result4 = tmp18(tmp10(5587), obj14);
