...
// Dependencies: [19, 17, 1371, 1373, 1074, 21, 4560, 576, 11163, 7634, 11188, 5587, 4556, 1114, 11189, 504, 1885, 8774, 1250, 1611, 7382, 4527, 8180, 9972, 9975, 7150, 6627, 2]
// Exports: default

// Module 11162 (TieredTenureBadgeActionSheet)
import nativeDefault from "native" /* 576 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4527 */;
import FastImageDefault from "FastImage" /* 5587 */;
import openUserSettings from "openUserSettings" /* 7382 */;
import TieredTenureBadgeUtils from "TieredTenureBadgeUtils" /* 7634 */;
import showUserProfileActionSheet from "showUserProfileActionSheet" /* 8180 */;
import useMobileTenureBadgeImages from "useMobileTenureBadgeImages" /* 11163 */;
import useTenureBadgeRequirementString from "useTenureBadgeRequirementString" /* 11188 */;
...
function TieredTenureBadgeItem(arg0) {
  ...
  if (null != tieredTenureBadgeData) {
    ...
    if (isUsersBadge) {
      ...
      isUsersBadge = tmp11(tmp2(4556).Text, obj6);
    }
