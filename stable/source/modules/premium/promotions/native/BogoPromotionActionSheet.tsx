...
// Dependencies: [19, 17, 1373, 1074, 1954, 21, 4560, 576, 7162, 7422, 7150, 5587, 4556, 1114, 2024, 9975, 2]
// Exports: default

// Module 16933 (BogoPromotionActionSheet)
...
export default function BogoPromotionActionSheet(markAsDismissed) {
  ...
  obj2.style = items2;
  const items3 = [closure_12(analyticsLocations(5587), { source: { uri: "https://cdn.discordapp.com/assets/content/a59aed2e0e61a955dc3e0f4f6f7ab295e39f89a93c4f01e4bd84ed7fb418ec63.png" }, style: tmp.image }), , , ];
  ...
  items3[1] = closure_12(markAsDismissed(4556).Text, obj4);
  ...
  items3[2] = closure_12(markAsDismissed(4556).Text, obj5);
  ...
  obj8.children = closure_12(analyticsLocations(9975), obj9);
