...
import Tier048Px from "Tier048Px" /* 13512 */;
...
export default function BoostedGuildTierProgressCircle(arg0) {
  ...
  if (null == guild) {
    ...
    if (null != guild) {
      ...
      const obj6 = { style: tmp.guildTierName, variant: "text-xs/semibold", color: "interactive-text-active", children: tmp19(4454).getTierName(guild.premiumTier) };
      items[1] = tmp8(tmp19(4556).Text, obj6);
      obj4.children = items;
