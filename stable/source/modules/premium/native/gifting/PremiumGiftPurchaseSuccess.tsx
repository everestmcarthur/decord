...
// Dependencies: [19, 17, 5510, 1373, 1074, 21, 4560, 576, 10704, 1483, 10748, 4799, 10667, 8362, 4975, 1114, 4218, 7190, 4258, 10835, 4556, 8908, 4508, 2]
...
export default function PremiumGiftSuccessBody(giftCodeRecord) {
  ...
  let tmp = closure_11();
  const nativeGiftContext = giftCodeRecord(10704).useNativeGiftContext();
  ({ giftStyle, premiumType, planInterval } = nativeGiftContext);
  let obj = giftCodeRecord(10704);
  const giftCodeURL = giftCodeRecord(4799).getGiftCodeURL(giftCodeRecord.code);
  ...
  let obj2 = giftCodeRecord(4799);
  const tmp6 = giftCodeURL;
  const tierDisplayNameByPlanId = giftCodeURL(4218).getTierDisplayNameByPlanId(subscriptionPlanId);
  const obj4 = giftCodeURL(4218);
  ...
  obj3.children = closure_8(giftCodeURL(10835), { giftStyle });
  ...
  items1[1] = closure_8(giftCodeRecord(4556).Text, obj6);
  ...
  items1[2] = closure_8(giftCodeRecord(4556).Text, obj7);
  ...
  const items2 = [closure_8(giftCodeRecord(4556).Text, obj10), ];
  obj5 = giftCodeURL(4218);
  const tmp10 = closure_9;
  const tmp12 = View;
  items2[1] = closure_8(giftCodeRecord(8908).InputButton, { text: giftCodeURL, icon: tmp6(4508), iconPosition: "end", onPress: callback });
  ...
  items1[4] = closure_8(giftCodeRecord(4556).Text, obj12);
