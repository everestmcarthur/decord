...
export const PremiumAnimatedGiftButton = function PremiumAnimatedGiftButton(arg0) {
  ...
  obj6.children = jsx(tmp3(5529), { ref: tmp9, style: tmp7.animationRefresh, source: { uri: animationDataUrl }, loop, autoPlay: false, onAnimationFinish: onAnimationFinished });
  ...
  return jsx(stateFromStores(4296).View, { exiting: FadeOut, children: null });
};
