...
obj2.header = obj3;
obj2.description = { alignSelf: "center", textAlign: "center", paddingBottom: 32, color: fn(5441).DARK_WHITE_500_LIGHT_BLACK_500 };
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  const premiumBundledItemsFromProductId = productId(7409).getPremiumBundledItemsFromProductId(productId);
  const obj2 = productId(7409);
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj9.planName = tmp5(4218).getPremiumTypeDisplayName(premiumTier);
    ...
    obj12.children = closure_11(tmp5(4975).Button, obj13);
    ...
    obj15.children = closure_11(tmp5(4975).Button, obj16);
    ...
    obj17.children = closure_11(tmp5(4975).Button, obj18);
