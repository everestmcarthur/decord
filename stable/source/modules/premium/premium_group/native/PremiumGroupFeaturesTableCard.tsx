...
// Dependencies: [17, 7432, 21, 4560, 576, 4556, 1114, 13490, 1178, 4987, 4409, 9387, 2]
// Exports: default

// Module 13489 (PremiumGroupFeaturesTableCard)
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  if (null == tmp4) {
    ...
    const items1 = [hasOwnProperty(tmp2(9387), { width: 181, height: 16 }), hasOwnProperty(BetaPill, {})];
