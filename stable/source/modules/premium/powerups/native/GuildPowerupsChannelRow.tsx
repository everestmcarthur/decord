...
// Module 16220 (GuildPowerupsChannelRow)
...
import SidebarCoachmarkOverlay from "SidebarCoachmarkOverlay" /* 16014 */;
...
function GuildPowerupsChannelRowIndicator(indicator) {
  ...
  if (null == indicator) {
    ...
    if (GuildPowerupsNotification.GuildPowerupNotificationIndicatorType.WARNING === type) {
      ...
      return hasOwnProperty(tmp4(6610).CircleErrorIcon, obj2);
...
export default function GuildPowerupsChannelRow(guildId) {
  ...
  obj5.mode = DEFAULT;
  obj4.name = closure_5(tmp14(12383).BaseChannelName, obj5);
  const tmp3Result = dismissNewBadgeIfShown(12383);
  obj4.icon = closure_5(tmp14(12383).BaseChannelIcon, { mode: DEFAULT, IconComponent: tmp14(16221).BoostTier2Icon });
  ...
  return closure_5(tmp14(7156).LayerScope, obj8);
};
