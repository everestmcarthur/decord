...
// Dependencies: [19, 17, 4450, 1074, 12570, 21, 4560, 576, 4987, 9381, 8096, 12552, 12531, 4556, 1114, 2428, 12503, 12523, 12571, 12572, 12528, 2]
// Exports: default

// Module 12569 (GuildPowerupsLevelCard)
...
const GuildPowerupsCardDefault = tmp5(12572);
require = fn;
...
const TIER_CARDS = fn(12570).TIER_CARDS;
const jsxProd = fn(21);
