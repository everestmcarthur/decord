...
// Dependencies: [32, 19, 1979, 4449, 4450, 1074, 4453, 504, 4469, 2]
// Exports: default

// Module 12508 (useBoostToUnlockFeaturedPowerup)
...
let items = [{ skuId: fn(4453).GUILD_POWERUP_LEVEL_1_SKU_ID, threshold: 1 }, , , , , , ];
let obj = { skuId: fn(4453).GUILD_POWERUP_LEVEL_1_SKU_ID, threshold: 1 };
items[1] = { skuId: fn(4453).GUILD_POWERUP_LEVEL_2_SKU_ID, threshold: 2 };
const obj2 = { skuId: fn(4453).GUILD_POWERUP_LEVEL_2_SKU_ID, threshold: 2 };
items[2] = { skuId: fn(4453).GUILD_POWERUP_LEVEL_3_SKU_ID, threshold: 2 };
const obj3 = { skuId: fn(4453).GUILD_POWERUP_LEVEL_3_SKU_ID, threshold: 2 };
items[3] = { skuId: fn(4453).GUILD_POWERUP_TAG_SKU_ID, threshold: 1 };
const obj4 = { skuId: fn(4453).GUILD_POWERUP_TAG_SKU_ID, threshold: 1 };
items[4] = { skuId: fn(4453).GUILD_POWERUP_ROLE_COLOR_SKU_ID, threshold: 1 };
const obj5 = { skuId: fn(4453).GUILD_POWERUP_ROLE_COLOR_SKU_ID, threshold: 1 };
items[5] = { skuId: fn(4453).GUILD_TAGS_BADGE_PACK_FLEX_POWERUP_SKU_ID, threshold: 1 };
const obj6 = { skuId: fn(4453).GUILD_TAGS_BADGE_PACK_FLEX_POWERUP_SKU_ID, threshold: 1 };
