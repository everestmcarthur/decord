...
// Module 13447 (ReferralProgramPerkCard)
...
export const ReferralProgramPerkCard = function ReferralProgramPerkCard() {
  ...
  const callback = noop.useCallback(() => {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(13452, dependencyMap.paths), "referral-program-share-action-sheet");
  }, items2);
  ...
  if (!useAltReferralCardArt) {
    ...
    const items4 = [tmp17(tmp2(4556).Text, obj10), , ];
    ...
    if (null != tmp12) {
      ...
      items4[1] = tmp17(tmp2(4556).Text, obj12);
      if (isEligibleForIncentive) {
        const obj22 = { nRewardsGranted: closure_129_0, referralRewardType: tmp12 };
        isEligibleForIncentive = tmp17(tmp5(13462), obj22);
      }
      ...
      obj23.children = tmp17(tmp2(4975).Button, obj24);
    ...
    let tmp5Result2 = tmp5(6330);
  } else if (tmp12 === tmp2(13450).ReferralRewardType.DISCOUNT) {
    tmp5Result2 = tmp5(5918);
  }
};
