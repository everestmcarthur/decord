...
// Dependencies: [7452, 1954, 1090, 1114, 4380, 1943, 11, 1945, 8057, 504, 8067, 2]
...
// Module 8056 (ReferralProgramUtils)
...
export const useIsReferralProgramPopoverShowable = function useIsReferralProgramPopoverShowable() {
  ...
  if (obj4.useIsReferralReminderDCExperimentEnabled({ location: "ReferralProgramUtils" })) {
    ...
    if (tmp8) {
      tmp8 = !tmp(4380).UNSAFE_isSnowflakeBoundDismissibleContentDismissed(tmp(1943).DismissibleContent.REFERRAL_PROGRAM_POPOVER_V2, stateFromStores1).isDismissed;
      const tmpResult = tmp(4380);
    }
    let tmp6 = tmp8;
  } else {
    tmp6 = !tmp(4380).UNSAFE_isDismissibleContentDismissed(tmp(1943).DismissibleContent.REFERRAL_PROGRAM_POPOVER);
