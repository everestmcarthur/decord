...
// Dependencies: [32, 19, 17, 1074, 1954, 12414, 21, 4560, 576, 1242, 9065, 4556, 1114, 4975, 12415, 5123, 5680, 15484, 7388, 1943, 2]
// Exports: default
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = { style: tmp.iconContainer, children: closure_14(onDismiss(9065).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }) };
  ...
  const items1 = [closure_14(onDismiss(4556).Text, obj5), , ];
  ...
  items1[1] = closure_14(onDismiss(4556).Text, obj6);
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12415).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
    const obj = onDismiss(12415);
  ...
  obj8.children = closure_14(onDismiss(4975).Button, obj9);
  ...
  obj10.children = closure_14(onDismiss(5680).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = closure_14(onDismiss(5123).PressableHighlight, obj10);
  obj.children = items;
