...
// Dependencies: [19, 17, 21, 4560, 576, 1178, 10657, 4556, 1114, 2]
...
export const ForYouUnreadClearedState = function ForYouUnreadClearedState() {
  ...
  const items = [React4(View, { style: tmp.imageContainer }), React4(native.Icon, { source: _modDef10657, style: tmp.icon, color: tmp.icon.color }), ];
