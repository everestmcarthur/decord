...
// Module 7639 (NotificationCenterItemsStore)
...
let obj = { loading: false, initialized: false, errored: false, isDataStale: false, notifCenterItems: [], staleNotifCenterItems: [], notifCenterIds: new Set(), notifCenterLocalItems: [], paginationHasMore: true, paginationCursor: "flex", notifCenterActive: "onTapSummary", notifCenterTabFocused: false };
...
const notificationCenterItemsStore = new NotificationCenterItemsStore(DispatcherDefault, {
  ...
  LOGOUT() {
    ...
    obj = { loading: false, initialized: false, errored: false, isDataStale: false, notifCenterItems: [], staleNotifCenterItems: [], notifCenterIds: new Set(), notifCenterLocalItems: null, paginationHasMore: true, paginationCursor: "flex", notifCenterActive: "onTapSummary", notifCenterTabFocused: false };
    if (flag) {
