...
// Dependencies: [32, 19, 17, 1385, 502, 2021, 2015, 1979, 11825, 5408, 1074, 21, 4560, 576, 1114, 5407, 4511, 4556, 4495, 12, 4262, 5283, 11571, 9444, 1178, 1396, 4411, 38, 7162, 7182, 504, 1242, 4740, 5520, 7150, 7204, 4975, 4527, 11574, 8180, 2]
// Exports: default
    ...
    obj1 = {
      children: keys.map((item, index) => {
            ...
            if (officialApplicationIds.includes(str)) {
              ...
              let tmp12 = value2(tmp2(11571), obj2);
            } else if (null != tmp7) {
              const obj3 = { style: closure_1.botTag, verified: false };
              tmp12 = value2(tmp2(9444), obj3);
            }
            ...
            if (null == value) {
              ...
              let tmp26 = null;
              if (null != tmp7) {
                const obj6 = { style: tmp21.popoutCheckGroupPlatformIcon, user: tmp7, size: tmp11(1178).AvatarSizes.XSMALL, guildId: "Array" };
              ...
              items1[2] = value2(tmp11(4556).Text, obj7);
              items1[3] = tmp12;
              ...
              obj8.source = tmp11Result.makeSource(tmp11(4411).isThemeDark(dependencyMap) ? icon.darkPNG : icon.lightPNG);
              obj8.size = tmp11(1178).Icon.Sizes.MEDIUM;
              tmp23(tmp11(1178).Icon, obj8);
              const tmp11Result2 = tmp11(4411);
            }
          })
    };
