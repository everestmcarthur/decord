...
// Dependencies: [19, 1074, 1365, 9948, 10375, 1114, 2]
// Exports: useFavoriteGIFsMobile

// Module 10374 (gif_picker/GIFPickerUtils)
...
export const useFavoriteGIFsMobile = function useFavoriteGIFsMobile() {
  sortedFavoriteGIFs = sortedFavoriteGIFs(10375).useSortedFavoriteGIFs(transformFavoriteGifUrl);
