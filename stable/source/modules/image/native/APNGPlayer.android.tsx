...
// Function ID: 8815
// Name: APNGPlayer
// Dependencies: [19, 21, 8815, 2]
// Exports: useAPNGPlayerControls

// Module 8814 (APNGPlayer)
...
export const APNGPlayer = noop.forwardRef((onLoad, ref) => {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref, () => ({
    play() {
      if (null != ref.current) {
        const Commands = onLoad(8815).Commands;
    ...
    stop() {
      if (null != ref.current) {
        ...
        const Commands2 = onLoad(8815).Commands;
  ...
  return jsx(ref(8815), { ref, onLoad: callback });
});
