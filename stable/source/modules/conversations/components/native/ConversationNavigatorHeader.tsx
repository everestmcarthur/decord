...
// Dependencies: [19, 17, 1957, 21, 4560, 576, 504, 4713, 7864, 2]
// Exports: default

// Module 7925 (ConversationNavigatorHeader)
...
export default function ConversationNavigatorHeader(channelId) {
  ...
  obj2.children = jsx(channelId(7864).GenericHeaderTitle, { title: channelId.title, subtitle: tmp3, variant: "heading-lg/semibold", subtitleColor: "text-muted" });
