...
// Dependencies: [19, 17, 4552, 7151, 1374, 21, 4560, 1115, 576, 504, 5123, 7130, 1396, 10290, 1477, 4217, 7969, 11126, 7763, 8763, 2]
...
let closure_13 = noop.memo((emoji) => {
  ...
  return closure_9(emoji(5123).PressableOpacity, obj2);
});
