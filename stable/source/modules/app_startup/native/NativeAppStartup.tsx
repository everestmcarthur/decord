...
// Dependencies: [32, 5, 17232, 17282, 17, 17302, 2026, 2011, 1895, 7460, 17303, 1074, 9, 3, 17898, 7492, 17899, 11796, 504, 1249, 1234, 17901, 1899, 1115, 10, 17902, 9522, 573, 17903, 7475, 1232, 17904, 17905, 9693, 510, 1242, 13641, 2003, 9299, 2037, 1155, 17906, 1896, 8333, 17908, 14393, 7674, 17926, 17927, 17928, 9947, 7488, 7476, 4419, 1183, 4552, 14441, 16961, 16962, 1099, 14194, 7459, 14446, 14460, 7636, 17929, 6655, 7461, 7476, 2]
// Exports: init, initHeadlessTask

// Module 17231 (NativeAppStartup)
      ...
      if (0 === c2) {
        ...
        promise = new Promise((arg0) => {
          ...
          closure_0(paths[42])(paths[52], paths.paths).then((result) => result.default.loadCacheAsync(closure_2_4(closure_2_0(paths[53]).computeInitialNavigationState(), 1)[0], async () => {
            closure_0(14441).updateSaturation(closure_0(4552).default.saturation);
            obj = closure_0(14441);
            closure_0(16961).updateVisualRefresh(true);
            const obj2 = closure_0(16961);
            closure_0(16962).updateTheme(closure_0(1183).default.theme);
            closure_1_0();
          }));
        });
...
const module_17232 = fn(17232);
const superagentPatch = fn(17282);
...
let c21 = false;
let c25 = null;
const future = new fn(9299).Future();
