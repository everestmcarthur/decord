...
// Dependencies: [19, 17, 1074, 21, 4560, 576, 1242, 6981, 4962, 7873, 1115, 5578, 5125, 13858, 1114, 2]
// Exports: default
...
export default function UsernameSearchScreen(navigation) {
  ...
  const clientThemesOverride = navigation(7873).useClientThemesOverride();
  let obj = navigation(7873);
  let prop = null;
  if (obj2.isIOS()) {
    prop = null;
  ...
  obj7.ref = ref;
  obj5.children = closure_8(ref(13858), obj7);
