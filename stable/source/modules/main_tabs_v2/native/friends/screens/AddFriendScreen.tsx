...
// Dependencies: [32, 19, 17, 1371, 1074, 12682, 21, 4560, 576, 12684, 4404, 1242, 1114, 8362, 7864, 1115, 5125, 4556, 13858, 13860, 2]
// Exports: default
...
export default function AddFriendScreen(navigation) {
  ...
  let callback;
  let tmp = closure_13();
  const contactSyncAccount = navigation(12684).useContactSyncAccount();
  let obj = navigation(12684);
  let obj2 = navigation(12684);
  [tmp5, c2] = callback(noop.useState(!navigation(12684).isContactSyncEnabled(contactSyncAccount)), 2);
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(7864).getRenderHeaderTextButton(intl.string(navigation(1114).t.RDE0Sc), callback);
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !tmp2(12684).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = tmp2(12684);
      }
      dependencyMap(tmp5);
    });
  }, items);
  ...
  const items2 = [closure_10(navigation(4556).Text, obj4), , , ];
  ...
  items2[1] = closure_10(navigation(4556).Text, obj5);
  items2[2] = closure_10(contactSyncAccount(13858), { style: tmp.input, autoFocusInput: false, sourcePage: navigation.route.params.sourcePage });
  ...
  const items3 = [closure_10(navigation(4556).Text, obj8), ];
  let tmp10Result = null;
  if (tmp5) {
    const obj9 = { style: tmp.rowContainer, location: "Add Friend Modal" };
    tmp10Result = closure_10(contactSyncAccount(13860), obj9);
  }
