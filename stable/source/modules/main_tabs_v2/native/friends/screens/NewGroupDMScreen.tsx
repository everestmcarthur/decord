...
// Dependencies: [32, 5, 19, 17, 1957, 13758, 4583, 1371, 10865, 1074, 21, 4560, 576, 4573, 4767, 9188, 9542, 4527, 504, 11597, 11599, 11596, 1242, 4259, 1114, 16758, 7864, 11600, 4258, 7874, 9861, 8379, 7759, 1178, 10866, 16691, 2]
// Exports: default
                    ...
                    if (dependencyMap === 2) {
                      ...
                      try {
                        ...
                        if (0 === v3) {
                          ...
                          v3 = 3;
                          dependencyMap = 1;
                          const obj10 = { value: id(4767).monkeyPatchCall(), done: false };
                          return obj10;
                        }
                      } catch (tmp26) {
                        dependencyMap = tmp;
