...
// Dependencies: [5, 32, 19, 17, 4600, 15297, 1085, 21, 4560, 576, 563, 4794, 9182, 16080, 16081, 10885, 9776, 15298, 1115, 10900, 1178, 4556, 2]
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let tmp10 = activity(4794)({ userId: user.id, guildId });
  const displayNameStylesFont = user(9182).useDisplayNameStylesFont({ displayNameStyles: tmp10 });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                const obj5 = { value: user(16080).getEmojiSource(c1.emoji), done: false };
                return obj5;
              } else {
                v3 = 3;
              }
            ...
            if (arg0 === 1) {
              ...
              c2 = 2;
              v3 = 1;
              const obj9 = { value: user(16081).getEmojiDominantColors(obj8), done: false };
              return obj9;
            }
          } else if (arg0 === 1) {
            v3 = 3;
  ...
  let obj3 = user(9182);
  const gameMentionsAsPlainText = user(10885).useGameMentionsAsPlainText(activity.state);
  const items2 = [userTitle, , ];
  const tmp6Result = user(10885);
  items2[1] = user(9776).getStatusLabel(status);
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(10900), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15298).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4556).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15298).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4556).Text, obj19);
  ...
  return closure_12(activity(15298), obj4);
};
