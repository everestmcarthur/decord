...
// Function ID: 16062
// Name: HappeningNow
// Dependencies: [32, 19, 17, 15297, 1074, 21, 7074, 4560, 576, 6655, 6964, 16062, 1242, 4992, 1484, 16063, 7162, 7182, 16070, 16071, 4296, 11359, 12, 8880, 1114, 16072, 16073, 16090, 16092, 16093, 16076, 16089, 16094, 16088, 16075, 1369, 2]
...
export default noop.memo((listRef) => {
  ...
  const obj2 = { withoutUserCards: "HermesInternal", guildId: "Array", showMultipleActivitiesPerChannel: "cherries", isFocused: isFocused1 };
