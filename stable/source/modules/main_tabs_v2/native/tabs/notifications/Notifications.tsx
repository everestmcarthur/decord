...
// Dependencies: [19, 17, 11089, 1954, 21, 4560, 576, 4418, 6945, 7855, 16405, 7123, 5123, 1114, 16406, 4556, 16407, 7861, 16409, 7162, 7182, 7475, 5630, 7156, 16413, 16414, 11901, 4413, 1611, 16017, 5125, 4271, 2]
...
let closure_12 = noop.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  if (!nestedInLaunchPad) {
    ...
    obj4.onPress = goBack;
    obj4.children = tmp12(tmp5(16406).LeftBackIconWithBadge, {});
    const items1 = [tmp12(tmp5(5123).PressableOpacity, obj4), , ];
    ...
    items1[1] = tmp12(tmp5(4556).Text, obj5);
    const obj6 = { style: tmp.actionButtons, children: null };
    let tmp10Result = null;
    if (isForLaterExperimentOn) {
      const obj7 = { children: null };
      const obj8 = { ref, type: tmp5(7861).SavedMessageSortTypes.BOOKMARK, onOpen: callback };
      const items2 = [tmp12(tmp2(16407), obj8), ];
      const obj9 = { type: null, onOpen: null };
      const tmp2Result = tmp2(16407);
      obj9.type = tmp5(7861).SavedMessageSortTypes.REMINDER;
      obj9.onOpen = callback;
      items2[1] = tmp12(tmp2(16407), obj9);
      obj7.children = items2;
      tmp10Result = tmp10(closure_8, obj7);
      const tmp2Result2 = tmp2(16407);
    }
    const items3 = [tmp10Result, tmp12(tmp2(16409), {})];
