...
// Dependencies: [19, 21, 12191, 576, 10124, 12478, 12481, 8601, 16201, 1114, 12594, 2]
...
export default function GuildProgressButton(guild) {
  guild = guild.guild;
  const guildProgressStep = guild(12478).useGuildProgressStep(guild);
  ...
  let obj = guild(12478);
  obj2.icon = jsx(guild(8601).RowButton.Icon, { source: completed(16201) });
  const intl = guild(1114).intl;
  obj2.label = intl.string(guild(1114).t.o3HK3d);
  obj2.subLabel = subtitle;
  obj2.onPress = callback;
  obj2.trailing = jsx(completed(12594), { percent: percentComplete });
  return jsx(guild(8601).RowButton, { icon: null, label: null, subLabel: null, onPress: null, trailing: null });
};
