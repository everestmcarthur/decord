...
// Function ID: 16258
// Name: ChannelsEmpty
// Dependencies: [19, 17, 4199, 1074, 21, 4560, 4556, 576, 563, 9069, 9743, 15103, 8601, 1178, 16258, 1114, 16259, 4976, 2]
...
export default noop.memo(function ChannelsEmpty(guild) {
  ...
  const obj2 = guild(15103);
  items4[1] = { paddingBottom: guild(15103).useYouBarTotalHeight(16) };
  obj3.style = items4;
  ...
  items6[1] = closure_8(guild(4556).Text, obj10);
  ...
  items6[2] = closure_8(guild(4556).Text, obj11);
  if (canCreateChannel) {
    ...
    obj12.children = tmp11(tmp2(4976).BaseTextButton, obj13);
