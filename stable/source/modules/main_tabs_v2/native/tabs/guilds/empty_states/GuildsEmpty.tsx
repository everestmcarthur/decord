...
// Function ID: 16273
// Name: GuildsEmpty
// Dependencies: [32, 19, 17, 502, 1979, 4381, 1074, 21, 4560, 576, 4556, 12712, 16273, 1114, 4973, 4975, 1484, 563, 8774, 1250, 1982, 4419, 5126, 15103, 2]

// Module 16272 (GuildsEmpty)
...
export default noop.memo(function GuildsEmpty(arg0) {
  ...
  const tmp7 = selectedGuildId(8774);
  const isScreenLandscape = navigation(5126).useIsScreenLandscape();
  navigation(15103);
  ...
  if (stateFromStores) {
    ...
    obj6.children = closure_13(tmp2(4556).Text, obj7);
