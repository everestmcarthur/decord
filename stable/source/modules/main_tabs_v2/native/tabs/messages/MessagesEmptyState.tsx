...
// Dependencies: [32, 19, 17, 21, 4560, 1477, 1483, 8774, 1250, 5126, 15103, 16057, 4556, 1114, 4975, 2]
// Exports: default
...
export default function MessagesEmptyState() {
  ...
  const obj8 = { resizeMode: "contain", source: _modDef16057, style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
