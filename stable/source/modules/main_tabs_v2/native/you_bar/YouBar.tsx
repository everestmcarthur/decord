...
// Function ID: 16366
// Name: YouBar
// Dependencies: [5, 32, 19, 17, 4379, 4381, 1371, 15101, 1074, 1954, 21, 4560, 576, 1477, 15094, 11533, 4420, 15100, 15104, 4296, 4974, 8353, 16366, 16367, 504, 8219, 16369, 4418, 4528, 1369, 12, 16372, 1896, 4417, 11223, 7342, 1943, 1114, 7382, 16013, 6655, 1178, 16386, 16387, 16388, 16393, 16396, 4271, 16398, 16399, 2]
...
import YouBarFloatingShadeDefault from "YouBarFloatingShade" /* 16398 */;
import ConnectionBannerDefault from "ConnectionBanner" /* 16399 */;
...
let closure_26 = noop.memo(() => {
  let tmp = closure_21();
  const mobileQuestDock = isMobileQuestDockRenderedBase(15094).useMobileQuestDock();
  let obj = isMobileQuestDockRenderedBase(15094);
  isMobileQuestDockRenderedBase = isMobileQuestDockRenderedBase(15094).useIsMobileQuestDockRenderedBase(mobileQuestDock);
  let obj2 = isMobileQuestDockRenderedBase(15094);
  const drawerWidth = isMobileQuestDockRenderedBase(11533).useDrawerWidth();
  let obj3 = isMobileQuestDockRenderedBase(11533);
  const youBarHorizontalMargin = isMobileQuestDockRenderedBase(15100).useYouBarHorizontalMargin();
  ...
  dependencyMap = tmp10;
  let obj4 = isMobileQuestDockRenderedBase(15100);
  const youBarBottomMargin = isMobileQuestDockRenderedBase(15100).useYouBarBottomMargin();
  const tmp4Result = isMobileQuestDockRenderedBase(15100);
  const connectionBannerHeight = isMobileQuestDockRenderedBase(15104).useConnectionBannerHeight();
  let items = [tmp10, youBarHorizontalMargin];
  const memo = sharedValue.useMemo(() => {
    const size = { marginHorizontal: youBarHorizontalMargin, height, padding, width };
    return size;
  }, items);
  const tmp4Result11 = isMobileQuestDockRenderedBase(15104);
  sharedValue = isMobileQuestDockRenderedBase(4296).useSharedValue(false);
  const tmp4Result12 = isMobileQuestDockRenderedBase(4296);
  let fn = function r() {
  ...
  const tmp4Result13 = isMobileQuestDockRenderedBase(4296);
  fn.__closure = { withSpring: isMobileQuestDockRenderedBase(4974).withSpring, barMarginBottom: youBarBottomMargin, connectionBannerHeight, YOU_BAR_SPRING_CONFIG: callback3, isPressedValue: sharedValue, isQuestRendered: isMobileQuestDockRenderedBase };
  fn.__workletHash = 7314807713815;
  fn.__initData = __initData;
  const animatedStyle = tmp4Result13.useAnimatedStyle(fn);
  const obj5 = { withSpring: isMobileQuestDockRenderedBase(4974).withSpring, barMarginBottom: youBarBottomMargin, connectionBannerHeight, YOU_BAR_SPRING_CONFIG: callback3, isPressedValue: sharedValue, isQuestRendered: isMobileQuestDockRenderedBase };
  const iCYMIEnabled = isMobileQuestDockRenderedBase(8353).useICYMIEnabled("TabsNavigator");
  const tmp4Result14 = isMobileQuestDockRenderedBase(8353);
  const youBarCoachmark = isMobileQuestDockRenderedBase(16366).useYouBarCoachmark({ isQuestRendered: isMobileQuestDockRenderedBase });
  const visibleContent = youBarCoachmark.visibleContent;
  const markAsDismissed = youBarCoachmark.markAsDismissed;
  const tmp4Result15 = isMobileQuestDockRenderedBase(16366);
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(16367).useShowTinyBroncoPromoSheet({ visibleContent, markAsDismissed });
  ...
  const tmp4Result16 = isMobileQuestDockRenderedBase(16367);
  ...
  const nameplate = isMobileQuestDockRenderedBase(8219).useNameplate({ user: stateFromStores });
  const tmp4Result18 = isMobileQuestDockRenderedBase(8219);
  ...
  callback3 = sharedValue.useCallback(() => {
    ...
    if (null != coerceGuildsRouteResult) {
      const result = tmp(4528).triggerHapticFeedback(tmp(4528).HapticFeedbackTypes.SOFT);
      ...
      if (guildId === ME) {
        ...
        if (null != lastSelectedGuildId) {
          tmp(7342).transitionToGuild(lastSelectedGuildId);
  ...
  const tmp4Result19 = isMobileQuestDockRenderedBase(16369);
  ...
  obj6.style = items9;
  const items10 = [closure_19(youBarHorizontalMargin(16386), { hasNameplate: null != nameplate, isLargeAvatar: !isMobileQuestDockRenderedBase, barWidth: tmp10, isQuestRendered: isMobileQuestDockRenderedBase, avatarSize: tmp37 }), , , ];
  let tmp40Result = tmp22;
  if (null != nameplate) {
    const obj7 = { nameplate, barWidth: tmp10, isQuestRendered: isMobileQuestDockRenderedBase, avatarSize: tmp37 };
    tmp40Result = tmp40(tmp2(16387), obj7);
  }
  ...
  obj9.children = closure_19(youBarHorizontalMargin(16388), { isQuestRendered: isMobileQuestDockRenderedBase, onAvatarPress: memo1 });
  obj8.children = closure_19(markAsDismissed, obj9);
  items10[2] = closure_19(isMobileQuestDockRenderedBase(6655).GestureDetector, obj8);
  const obj10 = { style: tmp.youRowRight, children: null };
  let tmp40Result2 = null;
  if (iCYMIEnabled) {
    const obj11 = { hasNameplate: tmp22 };
    tmp40Result2 = tmp40(tmp2(16393), obj11);
  }
  const items11 = [tmp40Result2, closure_19(youBarHorizontalMargin(16396), { hasNameplate: null != nameplate })];
  obj10.children = items11;
  items10[3] = closure_20(visibleContent, obj10);
  obj6.children = items10;
  return closure_20(youBarHorizontalMargin(4296).View, obj6);
});
