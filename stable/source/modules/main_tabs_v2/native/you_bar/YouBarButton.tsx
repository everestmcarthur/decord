...
// Function ID: 16396
// Name: YouBarButton
// Dependencies: [19, 17, 15101, 21, 4560, 576, 8819, 7870, 8098, 2]
...
class YouBarButtonIcon {
  constructor(arg0) {
    ...
    items2[1] = hasBadge;
    memo1 = obj2.useMemo(() => {
      const rect = { position: "absolute", left: size2 - badgeSize + num3, top: size2 - badgeSize + num4, right: "accessible", bottom: "httpServerLocation", padding: "Object", minWidth: "r" };
      return rect;
    }, items1);
