...
// Dependencies: [19, 4552, 15101, 21, 4262, 576, 15187, 504, 4296, 4974, 8824, 2]

// Module 16387 (YouBarNameplate)
...
export default noop.memo(function YouBarNameplate(isQuestRendered) {
  ...
  token = isQuestRendered(4262).useToken(token(576).modules.mobile.YOU_BAR_BORDER_RADIUS);
  ...
  fn.__closure = { withSpring: isQuestRendered(4974).withSpring, isQuestRendered, questDockAnimatedBorderRadius: tmp4, borderRadius: token, YOU_BAR_SPRING_CONFIG };
  ...
  const obj4 = { withSpring: isQuestRendered(4974).withSpring, isQuestRendered, questDockAnimatedBorderRadius: tmp4, borderRadius: token, YOU_BAR_SPRING_CONFIG };
  if (str) {
    str = "always";
  }
  obj6.animate = str;
  obj5.children = jsx(tmp2(8824), { nameplate, isFocused: true, animate: null });
