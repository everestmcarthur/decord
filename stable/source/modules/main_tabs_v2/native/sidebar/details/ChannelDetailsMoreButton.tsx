...
// Dependencies: [19, 21, 10918, 7867, 7864, 1114, 9806, 2]
// Exports: default
...
export default function MoreButton(channel) {
  ...
  if (null != channel) {
    if (channel.isDM()) {
      ...
      obj2.source = _modDef9806;
      obj2.onPress = tmp;
      obj.children = jsx(channel(7864).HeaderIconButton, { accessibilityLabel: null, source: null, onPress: null });
