...
// Dependencies: [109, 19, 17, 1074, 21, 4560, 576, 4763, 8774, 1250, 7475, 1611, 16875, 1115, 16759, 2]
// Exports: default

// Module 16874 (modal/ModalScreen)
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(7475).trackAppUIViewed("ModalScreen"), []);
