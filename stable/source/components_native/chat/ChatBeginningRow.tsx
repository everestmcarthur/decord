...
// Dependencies: [32, 5, 19, 17, 4552, 1956, 7277, 9070, 7107, 7621, 1961, 1975, 1957, 2012, 2021, 1979, 4199, 4209, 4741, 1371, 1074, 1964, 11598, 12473, 12447, 11387, 21, 4560, 576, 5071, 1114, 5073, 5105, 5106, 5078, 5080, 4962, 4556, 4255, 4262, 5123, 11613, 1178, 12474, 8631, 10255, 504, 4404, 7962, 4713, 9744, 7275, 7272, 10632, 4495, 4550, 12475, 12476, 38, 11, 12478, 4258, 9069, 5138, 12482, 5812, 9826, 6232, 2024, 12593, 12596, 8635, 4573, 4975, 12600, 4906, 12601, 7170, 9521, 1242, 9066, 7950, 7119, 7114, 4259, 4527, 12603, 1896, 7162, 12604, 8188, 8180, 7190, 12605, 8192, 7342, 4763, 12622, 5584, 9048, 10875, 12624, 11388, 12631, 8601, 11595, 8379, 4380, 1943, 11607, 11599, 11596, 11597, 11603, 8668, 10037, 7221, 10915, 4503, 12635, 12639, 2]
// Exports: default

// Module 12472 (ChatBeginningRow)
...
import enhanced_role_colors_EnhancedRoleColorUtils from "enhanced_role_colors/EnhancedRoleColorUtils" /* 7962 */;
...
import openGroupDMAddMembers from "openGroupDMAddMembers" /* 11595 */;
import showChatGDMUpsellActionSheetDefault from "showChatGDMUpsellActionSheet" /* 11607 */;
...
const ChannelAccessInfoDefault = tmp(12475);
require = fn;
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    ...
    if (isPrivate) {
      obj4.IconComponent = tmp17(5078).TextLockIcon;
      obj4.label = tmp17(1114).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj4;
    } else {
      obj4.IconComponent = tmp17(5080).TextIcon;
      obj4.label = tmp17(1114).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj4;
    }
...
function ChatBeginningRowHeader(arg0) {
  ...
  const tmp4 = null != subtitleLink && subtitleLink(4962).useIsScreenReaderEnabled();
  ...
  if (!isGameInvitesPost) {
    ...
    obj4.style = items1;
    obj4.children = title;
    items[1] = closure_44(tmp2(4556).Text, obj4);
    obj3.children = items;
  ...
  if (tmp11Result) {
    ...
    tmp11Result = closure_44(tmp2(4556).Text, obj6);
  }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj3.style = items;
    const obj4 = { source: _modDef12474, size: tmp2(1178).IconSizes.REFRESH_SMALL_16, color: token };
    ...
    items1[1] = closure_44(tmp2(4556).Text, obj5);
    obj3.children = items1;
    isPrivate = tmp6(tmp2(5123).PressableOpacity, obj3);
  }
  ...
  if (canEdit) {
    ...
    const items5 = [closure_44(tmp2(10255).PencilIcon, obj7), ];
    ...
    items5[1] = closure_44(tmp2(4556).Text, obj8);
    obj6.children = items5;
    canEdit = tmp6(tmp2(5123).PressableOpacity, obj6);
  }
  items3[1] = canEdit;
...
function ThreadOwner(arg0) {
  ...
  if (str == null) {
    str = guildId(4404).getName(stateFromStores);
    const obj4 = guildId(4404);
  }
  if (str == null) {
    str = "???";
  }
  ...
  if ("username" === stateFromStores2) {
    ...
    return closure_44(tmp2(4556).Text, obj6);
  } else {
    ...
    items3[1] = closure_44(tmp2(4556).Text, obj9);
...
function ChatBeginningRowThread(channel) {
  ...
  const result = channel(9744).isPrivateGuildChannel(channel);
  const obj = channel(9744);
  const appliedTags = channel(7275).useAppliedTags(channel);
  const obj2 = channel(7275);
  const isGameInvitesPost = channel(7272).useIsGameInvitesPost(channel);
  channel(504);
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp12Result3 = tmp12(tmp4(4556).Text, obj6);
    }
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp8) {
        ...
        tmp12Result4 = tmp12(tmp4(4556).Text, obj8);
      }
    }
...
function DMSpamButton(channel) {
  ...
  const dMMessageToReport = channel(12596).useDMMessageToReport(channel, user.id, true === user.bot);
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return closure_44(tmp(4975).Button, obj2);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      const obj3 = { size: tmp2(1178).Icon.Sizes.SMALL, source: _modDef12600, style: tmp.appDMButtonIcon };
      ...
      tmp4 = closure_44(tmp2(4975).Button, obj2);
    }
  }
  return tmp4;
}
  ...
  if (channel.user.bot) {
    ...
    obj2.onPress = function onPress() {
      if (stateFromStores) {
        ...
        const obj2 = { channel };
        tmp(4527).openLazy(asyncRequireImpl(12603, dependencyMap.paths), "MessageNotificationChannelActionSheet", obj2);
...
function ChatBeginningRowDM(channel) {
  ...
  if (null == user) {
    ...
    userTag = tmp2(4404).getUserTag(user, { decoration: "never", identifiable: "always" });
    const tmp2Result = tmp2(4404);
    const name = tmp2(4404).getName(user);
    ...
    const items5 = [closure_44(tmp7(5123).PressableOpacity, obj5), , , , , , ];
    ...
    obj7.children = closure_44(tmp7(4556).Text, obj8);
    items5[1] = closure_44(tmp7(5123).PressableOpacity, obj7);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj9.children = tmp15(tmp7(4556).Text, obj10);
      tmp15Result = tmp15(tmp7(5123).PressableOpacity, obj9);
    }
    ...
    items5[3] = closure_44(tmp7(4556).Text, obj11);
    let tmp15Result2 = null;
    if (user.isProvisional) {
      let obj12 = { style: tmp.provisionalAccountExplainer, userId: user.id, iconSize: 14 };
      tmp15Result2 = tmp15(tmp7(12631).ChatProvisionalAccountExplainerCard, obj12);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
          ...
          if (null != user) {
            let obj2 = {
              ...
              onPressMutualGuild(arg0) {
                  const result = channel(8192).trackUserProfileAction({ action: "PRESS_MUTUAL_GUILD" });
                  const obj = channel(8192);
            ...
            ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12605, dependencyMap.paths), "MutualGuildsActionSheet", obj2);
          }
        }
        ...
        const items6 = [tmp15(tmp7(12622).GuildIconPile, obj14), ];
        ...
        items6[1] = tmp15(tmp7(4556).Text, obj15);
        obj13.children = items6;
        tmp18Result = tmp18(tmp7(5123).PressableOpacity, obj13);
      }
    }
    ...
    if (user.isNonUserBot()) {
      ...
      tmp18Result4 = tmp15(function RelationshipButtons(reportButton) {
        ...
        if (stateFromStores === constants8.PENDING_INCOMING) {
          ...
          const items1 = [tmp4(tmp(4556).Text, obj4), ];
          ...
          const items2 = [tmp4(tmp(4975).Button, obj7), , , ];
          ...
          items2[1] = tmp4(tmp(4975).Button, obj8);
          ...
          items2[2] = tmp4(tmp(4975).Button, obj9);
          ...
          if (tmp6.NONE === stateFromStores) {
            ...
            if (!bot) {
              ...
              tmp4Result = tmp4(tmp(4975).Button, obj11);
            }
            ...
            tmp4Result2 = tmp4(tmp(4975).Button, obj12);
            ...
            tmp4Result2 = tmp4(tmp(4975).Button, obj13);
          } else {
            tmp4Result2 = null;
            if (tmp6.PENDING_OUTGOING === stateFromStores) {
              const obj14 = { text: null, size: "sm", variant: "active", disabled: true, onPress: "padding" };
              const intl9 = tmp(1114).intl;
              obj14.text = intl9.string(tmp(1114).t.xMH6vD);
              tmp4Result2 = tmp4(tmp(4975).Button, obj14);
            }
          }
...
function ChatBeginningRowGroupDM(channel) {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (first) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp2(8379).mobileCreateInvite(channel, constants.GROUP_DM), done: false };
              return obj5;
            }
          }
        } else if (arg0 === 1) {
  ...
  const callback2 = noop.useCallback(() => {
    ...
    if ("open" === groupDMAddMembersAction) {
      ...
      const result = tmp(11595).showGroupDMAddMembersRoadblock(groupDMAddMembersAction, constants2.CHANNEL_TEXT_AREA);
  ...
  let obj = channel(504);
  let obj2 = first(11599);
  const obj3 = { location: GroupDMChatBeginning };
  const tmp13 = GroupDMChatBeginning;
  const groupDMNitroAudience = channel(11596).useGroupDMNitroAudience();
  ...
  obj5.acquisitionStrategy = channel(11596).GroupDMNitroAcquisitionStrategy.MARKETING;
  const tmp2Result = first(11603);
  ...
  const tmp2ResultResult = first(11603)(obj5);
  obj7.size = channel(1178).AvatarSizes.XXLARGE;
  const items5 = [closure_44(first(10915), obj7), , , ];
  ...
  obj8.variant = str;
  obj8.children = arr;
  items5[1] = closure_44(channel(4556).Text, obj8);
  ...
  items5[2] = closure_44(channel(4556).Text, obj9);
  let tmp19Result = null;
  if (!tmp23) {
    if (enabled) {
      const obj11 = { style: tmp.gdmInviteFriends, onPress: tmp2ResultResult, IconComponent: tmp7(8668).NitroWheelIcon, iconVariant: "default", title: null, subtitle: null };
      ...
      tmp21Result = null;
      if (stateFromStores) {
        const obj13 = { style: tmp.gdmInviteFriends, onPress: callback2, IconComponent: tmp7(10037).GroupPlusIcon, iconVariant: "default", title: null };
    ...
    obj14.IconComponent = tmp7(4503).LinkIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      tmp21Result4 = tmp21(tmp2(12635), obj15);
    }
...
let closure_42 = fn(12447).MOBILE_MESSAGE_REQUESTS_MODAL_KEY;
let closure_43 = fn(11387).BLOCK_CONFIRMATION_ACTION_SHEET_KEY;
const jsxProd = fn(21);
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              let base64;
              tmp5(9069).init(id);
              const obj7 = tmp5(9069);
              const obj5 = { size };
              dependencyMap = 1;
              c3 = 1;
              const obj6 = { value: tmp5(5138).openImagePicker(obj5), done: false };
              return obj6;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            base64 = value.base64;
            if (null != base64) {
              tmp5(9069).updateIcon(closure_129_2, base64);
              const obj = tmp5(9069);
              tmp5(9069).open(closure_129_2, constants.LANDING);
              const obj2 = tmp5(9069);
            }
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
