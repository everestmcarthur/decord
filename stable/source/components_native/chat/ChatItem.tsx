...
// Function ID: 8659
// Name: ChatItem
// Dependencies: [32, 19, 17, 4552, 1074, 7934, 21, 576, 8659, 1089, 8660, 7270, 8661, 4560, 1115, 8127, 4262, 672, 4987, 2]
// Exports: default

// Module 8658 (ChatItem)
...
import AutoModerationSystemMessageViewNativeComponent from "AutoModerationSystemMessageViewNativeComponent" /* 8659 */;
...
function DCDChatItem(message) {
  ...
  if (message.type === MessageTypes.AUTO_MODERATION_ACTION) {
    ...
    if (AUTOMOD_INCIDENT_ACTIONS.has(message.type)) {
      ...
      tmp3Result = closure_1_10(tmp21(8660).default, obj3);
    } else if (isSystemMessageDefault(message)) {
      const obj4 = {};
      const merged3 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8661).default, obj4);
    } else {
      const obj = {};
      const merged4 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8660).default, obj);
    }
  }
  return tmp3Result;
}
...
export const DCDMessageView = fn(8660).default;
export const DCDSystemMessageView = fn(8661).default;
export const DCDAutoModerationSystemMessageView = fn(8659).default;
