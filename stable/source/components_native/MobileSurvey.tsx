...
// Function ID: 16926
// Name: MobileSurvey
// Dependencies: [5, 19, 4751, 1074, 21, 4560, 504, 1242, 4752, 4994, 1114, 4255, 1178, 576, 9450, 2]
// Exports: default
...
export default function MobileSurvey() {
  ...
  if (null != stateFromStores) {
    ...
    obj3.renderConfirmRightIcon = function renderConfirmRightIcon() {
      return jsx(native.Icon, { style: confirmIcon.confirmIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: native.Icon.Sizes.SMALL, source: _modDef9450 });
    };
