...
// Dependencies: [19, 17, 2025, 1371, 1074, 7432, 1373, 21, 4560, 576, 4511, 1114, 1880, 504, 4218, 4987, 1093, 4556, 13544, 13545, 9397, 4975, 2]
// Exports: default
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4556).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4556).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4556).Text, obj9);
    }
    const items3 = [tmp6Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: tmp5(13544) };
    const items4 = [closure_1_10(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: tmp5(13545) };
    ...
    tmp5Result3 = tmp5(4218);
    obj15.IconComponent = tmp2(4511).CheckmarkLargeIcon;
    const intl4 = tmp2(1114).intl;
    const obj16 = { discountPercentage: null };
    const tmp5Result4 = tmp5(9397);
    ...
    const items5 = [obj15, ];
    const obj17 = { IconComponent: tmp2(4511).CheckmarkLargeIcon, label: null, color: null };
    ...
    tmp = tmp6(tmp2(4975).Button, obj20);
    obj19.children = tmp;
