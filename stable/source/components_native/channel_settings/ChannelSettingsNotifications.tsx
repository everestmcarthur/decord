...
// Dependencies: [19, 1961, 1957, 4480, 4209, 4741, 1371, 1074, 21, 1114, 4560, 576, 4271, 4740, 7119, 4527, 10149, 1896, 7114, 4713, 5687, 5605, 10151, 7201, 5685, 5688, 4556, 8599, 4973, 504, 10152, 10153, 2]
// Exports: default
...
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(5688).TableRadioRow, obj3);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(5688).TableRadioRow, obj4);
    obj.children = items;
    ...
    items1[1] = tmp12(tmp7(5688).TableRadioRow, obj6);
    ...
    items1[2] = tmp12(tmp7(5688).TableRadioRow, obj7);
    ...
    items1[3] = tmp12(tmp7(5688).TableRadioRow, obj8);
    obj.children = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5687).TableRowGroup, obj7);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj6.children = items;
