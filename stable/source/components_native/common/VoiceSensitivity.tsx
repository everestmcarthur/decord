...
// Dependencies: [5, 32, 19, 17, 1908, 5419, 1895, 1074, 4770, 21, 4560, 576, 4409, 1477, 504, 5139, 4615, 4272, 1114, 1178, 8599, 8279, 1115, 2]
// Exports: default
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              c1 = 1;
              c2 = 1;
              const obj4 = { value: onThresholdChange(5139).hasPermission(constants.AUDIO, { showAuthorizationError: false }), done: false };
              return obj4;
            }
          } else if (arg0 === 1) {
            c2 = 3;
