...
// Function ID: 4617
// Name: destroy
// Dependencies: [32, 5, 4585, 4617, 4618, 4619, 4623, 4, 1910, 4615, 4624, 1341, 1116, 4626, 4686, 2]
...
prototype["connect"] = function connect(arg0, arg1, videoSupported) {
  ...
  obj3 = self(4626).create(arg0, arg1, videoSupported, flag);
  obj3.on(obj3(4615).BaseConnectionEvent.Destroy, (arg0) => {
  ...
  obj3.on(obj3(4615).BaseConnectionEvent.Connected, () => {
    obj3.setVideoBroadcast(self.shouldConnectionBroadcastVideo(obj3));
  });
  obj3.on(obj3(4615).BaseConnectionEvent.Silence, (arg0) => {
  ...
  self.emit(obj3(4615).MediaEngineEvent.Connection, obj3);
  return obj3;
};
...
prototype["setAudioInputDevice"] = function setAudioInputDevice(audioInputDeviceId) {
  ...
  if (obj.supportsFeature(constants6.SET_AUDIO_DEVICE_BY_ID)) {
    ...
    const audioInputDevices = tmp(4686).getAudioInputDevices();
...
prototype["setAudioOutputDevice"] = function setAudioOutputDevice(audioOutputDeviceId) {
  ...
  if (obj.supportsFeature(constants6.SET_AUDIO_DEVICE_BY_ID)) {
    ...
    const audioOutputDevices = tmp(4686).getAudioOutputDevices();
