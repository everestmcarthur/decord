...
// Function ID: 4291
// Name: BaseRive
// Dependencies: [19, 17, 21, 4291, 4279, 4341, 4342, 4343, 2]
...
export const BaseRive = noop.forwardRef(function BaseRiveInner(renderDataBinding, ref) {
  ...
  if (null == riveFile) {
    ...
    if (null != fit) {
      const obj10 = { fit: tmp(4343).FIT_MAP[fit] };
      let obj11 = obj10;
    } else {
      obj11 = {};
    }
    ...
    if (null != alignment) {
      const obj12 = { alignment: tmp(4343).ALIGNMENT_MAP[alignment] };
      let obj13 = obj12;
    } else {
      obj13 = {};
    }
    ...
    timestampProducer(tmp(4291).RiveView, obj7);
  }
});
