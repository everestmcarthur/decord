...
// Function ID: 5135
// Name: FileUtils
// Dependencies: [1979, 1371, 1074, 1373, 12, 5135, 4486, 4218, 5129, 4457, 1114, 2]
...
export const fileUploadLimitRoadblockDescription = function fileUploadLimitRoadblockDescription(arg0) {
  ...
  const formatSizeResult = _Math(4457).formatSize(maxSize / 1024, { useKibibytes: true });
  const obj = _Math(4457);
