      ...
      if (0 === c4) {
        if (arg0 === 1) {
          ...
          if (isStorekit2Available()) {
            ...
            c4 = 2;
            c5 = 1;
            const obj6 = { value: require("module_11053").getStorefront(), done: false };
            return obj6;
          } else {
            c5 = 3;
            ...
            if (0 === c6) {
              if (arg0 === 1) {
                ...
                if (null != currentUser.getCurrentUser()) {
                  ...
                  c6 = 2;
                  c7 = 1;
                  const obj5 = { value: sku(11053).clearTransactionIOS(), done: false };
                  return obj5;
                } else {
                  const _Error2 = Error;
              ...
              if (1 === tmp7) {
                ...
                if (arg0 === 1) {
                  ...
                  c6 = 3;
                  c7 = 1;
                  const obj9 = { value: sku(11053).requestPurchase(obj8), done: false };
                  return obj9;
                }
              } else if (arg0 === 1) {
                c7 = 3;
          ...
          if (0 === c6) {
            if (arg0 === 1) {
              ...
              if (null != currentUser) {
                ...
                c6 = 2;
                c7 = 1;
                const obj7 = { value: requestJSONString(11053).requestPurchase(obj6), done: false };
                return obj7;
              } else {
                const _Error2 = Error;
                const error = new Error("purchaseProduct: no valid user");
            ...
            if (1 === tmp7) {
              ...
              if (!set.has(closure_130_3.code)) {
                const result = requestJSONString(4233).captureBillingException(closure_130_3);
                const obj3 = requestJSONString(4233);
              }
