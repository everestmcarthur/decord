...
// Dependencies: [19, 17, 21, 4560, 576, 5441, 4995, 4556, 8096, 8097, 4257, 2]

// Module 8095 (utils/ChangeLogUtils)
...
function ChangeLogStrong(arg0) {
  ...
  if (obj.useManaTypeConsolidationExperiment("ChangeLogStrong")) {
    ...
    const obj2 = { variant: "experimental/body-sm/semibold", color: str, children: tmp(8097).smartOutput(node, output, state) };
    let reactResult = jsx(tmp(4556).Text, { variant: "experimental/body-sm/semibold", color: str, children: tmp(8097).smartOutput(node, output, state) });
    const tmpResult = tmp(8097);
  } else {
...
function ChangeLogImage(arg0) {
  ...
  const obj2 = { uri: _modDef4257.sanitizeUrl(node.target) };
  obj.source = obj2;
...
obj2.container = { borderLeftWidth: 2, paddingLeft: 8, marginBottom: 10, borderLeftColor: fn(5441).DARK_PRIMARY_500_LIGHT_PRIMARY_300 };
const obj4 = { borderLeftWidth: 2, paddingLeft: 8, marginBottom: 10, borderLeftColor: fn(5441).DARK_PRIMARY_500_LIGHT_PRIMARY_300 };
