...
// Dependencies: [4362, 1386, 1958, 1372, 7965, 504, 7966, 573, 2]

// Module 7964 (MessageReactionsStore)
...
const dependencyMap = {};
const items = [fn(7965).ReactionTypes.NORMAL, fn(7965).ReactionTypes.BURST];
