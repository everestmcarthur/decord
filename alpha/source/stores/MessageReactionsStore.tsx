...
// Dependencies: [4396, 1386, 2041, 1372, 8003, 504, 8004, 573, 2]

// Module 8002 (MessageReactionsStore)
...
const dependencyMap = {};
const items = [fn(8003).ReactionTypes.NORMAL, fn(8003).ReactionTypes.BURST];
