...
// Dependencies: [2014, 1961, 4360, 1962, 502, 1958, 2022, 1980, 4361, 4371, 1372, 1074, 1983, 12, 4875, 1086, 4366, 504, 573, 2]
...
let closure_6 = fn(4360).createFavoritesGuildChannelRecord;
