...
// Dependencies: [502, 1074, 1249, 573, 7657, 1241, 7668, 7669, 2]

// Module 7656 (stores/AnalyticsTrackingStore)
...
const obj2 = {
  ...
  scheduleWhenIdle: fn(7668).requestSafeIdleCallback,
  sendUnloadRequest: fn(7669).sendUnloadRequest
};
