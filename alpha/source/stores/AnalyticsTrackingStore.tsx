...
// Dependencies: [502, 1074, 1249, 573, 7701, 1241, 7712, 7713, 2]

// Module 7700 (stores/AnalyticsTrackingStore)
...
const obj2 = {
  ...
  scheduleWhenIdle: fn(7712).requestSafeIdleCallback,
  sendUnloadRequest: fn(7713).sendUnloadRequest
};
