...
// Function ID: 10283
// Name: RTCDebugStore
// Dependencies: [32, 1909, 1372, 1074, 4747, 10283, 4777, 573, 504, 2]
// Exports: getLastGraphValue, keySection, parseSection

// Module 10282 (RTCDebugStore)
...
prototype2["getInboundStats"] = function getInboundStats(arg0, context) {
  ...
  obj = { codec: name, resolution: null, bitrateEstimate: "Array", fps: 70 };
  let resolution;
  if (found != null) {
  ...
  RTC_DEBUG_MODAL_OPEN_REPLAY_AT_PATH: function handleOpenReplayAtPath(path) {
    ...
    if (mediaEngine.supports(constants.CONNECTION_REPLAY)) {
      if (0 !== path.length) {
        ...
        if (null != replayConnection) {
          replayConnection.on(replayConnection(4777).BaseConnectionEvent.Video, (userId, arg1, arg2, arg3) => {
            let num = arg3;
