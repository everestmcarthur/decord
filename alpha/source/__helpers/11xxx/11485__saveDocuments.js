...
// Function ID: 11486
// Name: _saveDocuments
// Dependencies: [5, 17, 11478]
// Exports: saveDocuments

// Module 11485 (_saveDocuments)
...
let closure_3 = async function _saveDocuments() {
  ...
  await asyncGeneratorStep(async () => {
    ...
    const NativeDocumentPicker2 = tmp2(11478).NativeDocumentPicker;
    closure_128_0 = await NativeDocumentPicker2.saveDocument(tmp2);
    const NativeDocumentPicker = tmp2(11478).NativeDocumentPicker;
