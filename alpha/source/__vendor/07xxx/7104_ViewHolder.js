...
// Function ID: 7105
// Name: ViewHolder
// Dependencies: [19, 21, 7067, 7100]

// Module 7104 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_7067").getInvertedTransformStyle(horizontal);
    let obj = require("module_7067");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
