...
// Dependencies: [19, 21, 7036, 7037, 7039]

// Module 7035 (ScrollableContainer)
import BottomSheetDraggableScrollable from "BottomSheetDraggableScrollable" /* 7036 */;
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  let tmp2Result = tmp6;
  if (onRefresh) {
    const obj3 = { scrollableGesture: nativeGesture, refreshing, progressViewOffset, onRefresh, style: _mod7039.styles.container, children: tmp6 };
    tmp2Result = jsx(_modDef7037, { scrollableGesture: nativeGesture, refreshing, progressViewOffset, onRefresh, style: _mod7039.styles.container, children: tmp6 });
  }
  return tmp2Result;
});
