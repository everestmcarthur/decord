...
// Dependencies: [19, 17, 21, 5843, 1485, 7249, 7250]
// Exports: HeaderContainer

// Module 7248 (HeaderContainer)
...
export const HeaderContainer = function HeaderContainer(getFocusedRoute) {
  ...
  closure_6 = noop.useContext(_mod5843.HeaderBackContext);
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = { title: require("module_5843").getHeaderTitle(tmp11, route.name), href: buildHref(route.name, route.params) };
                tmp9 = obj2;
                const obj3 = require("module_5843");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7249").forSlideRight;
                    } else {
                      forSlideUp = require("module_7249").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7249").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7249").forNoAnimation;
            }
