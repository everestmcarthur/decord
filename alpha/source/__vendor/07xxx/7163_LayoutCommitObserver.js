...
// Dependencies: [7094, 19, 21, 7113, 7112]

// Module 7163 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod7112.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod7112.useLayoutState(0), 2);
  ...
  return jsx(_mod7113.RecyclerViewContextProvider, { value, children: children.children });
});
