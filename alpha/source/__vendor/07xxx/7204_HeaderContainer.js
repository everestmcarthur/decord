...
// Dependencies: [19, 17, 21, 5801, 1485, 7205, 7206]
// Exports: HeaderContainer

// Module 7204 (HeaderContainer)
...
export const HeaderContainer = function HeaderContainer(getFocusedRoute) {
  ...
  closure_6 = noop.useContext(_mod5801.HeaderBackContext);
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = { title: require("module_5801").getHeaderTitle(tmp11, route.name), href: buildHref(route.name, route.params) };
                tmp9 = obj2;
                const obj3 = require("module_5801");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7205").forSlideRight;
                    } else {
                      forSlideUp = require("module_7205").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7205").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7205").forNoAnimation;
            }
