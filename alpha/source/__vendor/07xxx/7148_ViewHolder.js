...
// Function ID: 7149
// Name: ViewHolder
// Dependencies: [19, 21, 7111, 7144]

// Module 7148 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_7111").getInvertedTransformStyle(horizontal);
    let obj = require("module_7111");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
