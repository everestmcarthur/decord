...
// Dependencies: [7094, 19, 21, 7113, 7144, 7148]
// Exports: ViewHolderCollection

// Module 7150 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 7148 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(7113).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7144).CompatView, { style: tmp19, children: null });
};
