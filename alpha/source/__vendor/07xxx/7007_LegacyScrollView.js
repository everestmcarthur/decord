...
// Dependencies: [32, 109, 19, 17, 21, 7006, 6897, 6934]
// Exports: LegacyFlatList

// Module 7007 (LegacyScrollView)
...
const jsx = fn(21).jsx;
let closure_9 = _modDef7006(ScrollView, { disallowInterruption: true, shouldCancelWhenOutside: false });
...
const tmp3 = _modDef7006(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false });
const tmp4 = _modDef7006(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });

export const LegacyRefreshControl = tmp3;
export { LegacyScrollView };
export const LegacySwitch = tmp4;
export const LegacyTextInput = _modDef7006(TextInput);
export const LegacyDrawerLayoutAndroid = _modDef7006(DrawerLayoutAndroid, { disallowInterruption: true });
export const LegacyFlatList = (arg0) => {
  ...
  while (tmp3 !== undefined) {
    [first, tmp9] = tmp4;
    let tmp8 = first;
    let nativeViewProps = ref(6934).nativeViewProps;
