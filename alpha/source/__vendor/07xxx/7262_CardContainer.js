...
// Function ID: 7263
// Name: CardContainer
// Dependencies: [19, 17, 21, 1485, 5843, 7263, 7264, 7265, 7252]

// Module 7262 (CardContainer)
import Link from "Link" /* 1485 */;
import _mod5843 from "module_5843" /* 5843 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7252 */;
import _mod7263 from "module_7263" /* 7263 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7264 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5843.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7263.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7263;
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5843).getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = tmp2(5843);
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5843.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5843.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5843.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7265.Card, obj5);
