...
// Dependencies: [7103, 7104, 7116, 7118, 7119, 7091, 7121, 7132, 7133, 7134]

// Module 7115 (RecyclerViewManager)
import _modDef7104 from "module_7104" /* 7104 */;
import ViewabilityManagerDefault from "ViewabilityManager" /* 7119 */;
import _classCallCheck from "module_7103" /* 7103 */;
  ...
  },
  {
    ...
    value: function getLayout(arg0) {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(7091).ErrorMessages.layoutManagerNotInitializedLayoutInfo);
        throw error;
      }
    }
  },
  ...
  },
  {
    ...
    value: function getChildContainerDimensions() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(7091).ErrorMessages.layoutManagerNotInitializedChildContainer);
        throw error;
      }
    }
  },
  ...
  },
  {
    ...
    value: function getWindowSize() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(7091).ErrorMessages.layoutManagerNotInitializedWindowSize);
        throw error;
      }
    }
  },
    ...
    value: function updateLayoutParams(windowSize, firstItemOffset) {
      ...
      if (this.layoutManager) {
        ...
        if (BooleanResult !== Boolean(self.propsRef.horizontal)) {
          const _Error = Error;
          const error = new Error(RecyclerViewManager(7091).ErrorMessages.horizontalPropCannotBeToggled);
          throw error;
        }
  ...
  },
  {
    ...
    value: function computeVisibleIndices() {
      ...
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(7091).ErrorMessages.layoutManagerNotInitializedVisibleIndices);
        throw error;
      }
    }
  },
    ...
    value: function getLayoutManagerClass() {
      ...
      if (this.propsRef.masonry) {
        if (self.propsRef.horizontal) {
          const _Error2 = Error;
          const error = new Error(RecyclerViewManager(7091).ErrorMessages.masonryAndHorizontalIncompatible);
          throw error;
        }
      }
      if (self.numColumns > 1) {
        if (self.propsRef.horizontal) {
          const _Error = Error;
          const error1 = new Error(RecyclerViewManager(7091).ErrorMessages.numColumnsAndHorizontalIncompatible);
          throw error1;
        }
      }
      if (self.propsRef.masonry) {
        let RVLinearLayoutManagerImpl = RecyclerViewManager(7121).RVMasonryLayoutManagerImpl;
      } else {
        if (self.numColumns > 1) {
          if (!self.propsRef.horizontal) {
            RVLinearLayoutManagerImpl = RecyclerViewManager(7132).RVGridLayoutManagerImpl;
          }
        }
        RVLinearLayoutManagerImpl = RecyclerViewManager(7133).RVLinearLayoutManagerImpl;
      }
  ...
  },
  {
    ...
    value: function checkPropsAndWarn() {
      if (tmp) {
        ...
        console.warn(RecyclerViewManager(7134).WarningMessages.keyExtractorNotDefinedForMVCP);
      }
    }
  }
];

export const RecyclerViewManager = _modDef7104(RecyclerViewManager, items);
