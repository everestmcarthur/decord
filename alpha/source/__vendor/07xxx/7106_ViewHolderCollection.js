...
// Dependencies: [7050, 19, 21, 7069, 7100, 7104]
// Exports: ViewHolderCollection

// Module 7106 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 7104 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(7069).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7100).CompatView, { style: tmp19, children: null });
};
