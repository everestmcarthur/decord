...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f109774, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f72562, items);
  f109774 = screenshotInput(function*(arg0, value) {
    if (c6 === 2) {
      c6 = 3;
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (3 === tmp8) {
            ...
            if (messageLabel) {
              const debug = f109774(onSubmitSuccess[2]).debug;
  ...
  f109774 = function(arg0) {
    const self = this;
    const apply = f109774.apply;
  ...
  obj = { class: "form", onSubmit: tmp13(() => f72562, items1) };
...
function Dialog(onFormSubmitted) {
  ...
  const tmp2 = fn2(() => {
    obj = { __html: null };
    const _document = f72562(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document2 = f72562(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document3 = f72562(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document4 = f72562(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document5 = f72562(merged[2]).GLOBAL_OBJ.document;
    const elementNS4 = _document5.createElementNS("http://www.w3.org/2000/svg", "defs");
    const _document6 = f72562(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document7 = f72562(merged[2]).GLOBAL_OBJ.document;
