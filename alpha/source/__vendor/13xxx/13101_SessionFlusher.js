...
// Function ID: 13102
// Name: SessionFlusher
// Dependencies: [41, 42, 13054, 13075]

// Module 13101 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(13054).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(13075).getIsolationScope();
        ...
        const obj = SessionFlusher(13075);
      }
    }
  },
  {
