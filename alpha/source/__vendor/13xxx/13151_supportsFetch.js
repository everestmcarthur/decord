...
// Function ID: 13152
// Name: supportsFetch
// Dependencies: [13040, 13038, 13039]
...
// Module 13151 (supportsFetch)
import _mod13040 from "module_13040" /* 13040 */;

require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in _mod13040.GLOBAL_OBJ) {
    try {
...
export const supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(_mod13040.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(13040).GLOBAL_OBJ.document;
      if (_document) {
...
export const supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in _mod13040.GLOBAL_OBJ;
};
