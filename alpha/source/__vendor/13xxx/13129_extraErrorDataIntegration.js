...
// Dependencies: [13095, 13046, 13084, 13045, 13048, 13067, 13039]

// Module 13129 (extraErrorDataIntegration)
      ...
      if (obj.originalException) {
        ...
        if (obj2.isError(obj.originalException)) {
          ...
          if (tmp7) {
            ...
            const normalizer = tmp4(13084);
            const normalizeResult = normalizer.normalize(tmp7, num);
            if (tmp4Result.isPlainObject(normalizeResult)) {
              const result = tmp4(13045).addNonEnumerableProperty(normalizeResult, "__sentry_skip_normalization__", true);
              obj3[tmp6] = normalizeResult;
              const tmp4Result2 = tmp4(13045);
            }
            let obj4 = {};
            const merged1 = Object.assign(contexts);
            obj4.contexts = obj3;
            tmp3 = obj4;
            tmp4Result = tmp4(13046);
          }
