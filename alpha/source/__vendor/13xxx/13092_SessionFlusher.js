...
// Function ID: 13093
// Name: SessionFlusher
// Dependencies: [41, 42, 13045, 13066]

// Module 13092 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(13045).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(13066).getIsolationScope();
        ...
        const obj = SessionFlusher(13066);
      }
    }
  },
  {
