...
// Dependencies: [10728, 10729, 10724, 10730, 10731, 10732, 10733]
// Exports: includeCommonConfiguration

// Module 10727 (includeCommonConfiguration)
...
fn(_mod10728);
const regExp = fn(_mod10729);
const OverlapRemovalRefiner = fn(OverlapRemovalRefiner2);
const module_10730 = fn(_mod10730);
fn(_mod10731);
fn(_mod10732);
...
export const includeCommonConfiguration = function includeCommonConfiguration(parsers, flag) {
  ...
  refiners5.push(new module_10730.default());
  const refiners6 = parsers.refiners;
  const _default6 = new module_10730.default();
