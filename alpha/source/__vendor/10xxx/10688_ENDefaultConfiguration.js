...
// Dependencies: [41, 42, 10689, 10699, 10700, 10701, 10702, 10703, 10704, 10706, 10707, 10708, 10711, 10714, 10716, 10717, 10719, 10720, 10721, 10722, 10723, 10724, 10725, 10726, 10727]

// Module 10688 (ENDefaultConfiguration)
...
import OverlapRemovalRefiner2 from "OverlapRemovalRefiner" /* 10724 */;
...
const regExp = fn(_mod10725);
const _isNativeReflectConstruct = fn(_mod10726);
...
let items = [
  entry,
  {
    ...
    value: function createConfiguration(flag) {
      ...
      obj.refiners = items1;
      const result = ENDefaultConfiguration(10727).includeCommonConfiguration(obj, flag);
