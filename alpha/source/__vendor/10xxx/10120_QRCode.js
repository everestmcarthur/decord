...
// Function ID: 10121
// Name: QRCode
// Dependencies: [10121, 10125, 10130, 19, 10133]

// Module 10120 (QRCode)
import QRCode_mod from "module_10121" /* 10121 */;
import module_10125_mod from "module_10125" /* 10125 */;
import emptyFunction from "module_10130" /* 10130 */;
import noop_mod from "module_19" /* 19 */;
import QRCodeSvg_mod from "QRCodeSvg" /* 10133 */;
...
QRCode = tmp3;
let module_10125 = module_10125_mod;
if (!module_10125) {
  let obj2 = { default: module_10125 };
  let tmp5 = obj2;
} else {
  tmp5 = module_10125;
}
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const _default1 = new QRCode.default(-1, module_10125.default[level]);
