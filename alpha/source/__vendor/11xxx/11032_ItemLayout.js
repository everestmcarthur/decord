...
// Function ID: 11033
// Name: ItemLayout
// Dependencies: [19, 21, 11015, 11033, 1637]
// Exports: ItemLayout

// Module 11032 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod11015.useGlobalState().props;
  ...
  const offsetX = _mod11033.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod11033;
  const fn = function k() {
