...
// Function ID: 11518
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1637, 11518, 6929, 6861]
// Exports: default

// Module 11517 (leftThreshold)
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod11518.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod11518.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod11518.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod11518.SwipeDirection.LEFT;
      }
