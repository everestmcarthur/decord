...
// Dependencies: [4971, 1282, 5018, 5022, 1283, 5035, 1303, 5027, 5023, 5036, 5037]
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4971(arg0)) {
    if (tmp(5018)(arg1)) {
      if (tmp(5022)(__Writable__)) {
        if (tmp(1283)) {
          const tmp30 = tmp(1283)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(5023)(tmp30);
          }
          return tmp(5037)(arg0, arg1, tmp(5036)(arg0), __Writable__, tmp31);
        } else if (tmp(5035)(__Writable__)) {
          ...
          return tmp(5027)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
