...
// Function ID: 5110
// Name: ScreenStack
// Dependencies: [109, 19, 21, 5110, 5111, 5112]
// Exports: default

// Module 5109 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_mod5111.GHContext);
  ...
  _modDef5110("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5110(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod5111.RNSScreensRefContext.Provider, { value: ref, children: null });
};
