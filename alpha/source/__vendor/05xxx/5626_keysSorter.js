...
// Function ID: 5627
// Name: keysSorter
// Dependencies: [5627, 5628, 1542]
// Exports: extract, parse, stringify

// Module 5626 (keysSorter)
...
export const parse = (str, arg1) => {
  _require = undefined;
  const arrayFormat = require("module_5628")({ arrayFormat: "none" }, arg1).arrayFormat;
...
export const stringify = (arg0, arg1) => {
  _require = arg0;
  const tmp = require("module_5628")({ encode: true, strict: true, arrayFormat: "none" }, arg1);
  dependencyMap = tmp;
  closure_129_0 = tmp;
  ...
  if ("index" === arrayFormat) {
    let fn = (arg0, arg1, arg2) => {
      if (null === arg1) {
        if (!closure_0.encode) {
          ...
          let encodeURIComponentResult = _mod5627(arg0);
        } else {
    ...
    fn = "bracket" === arrayFormat ? ((arg0, arg1) => {
      if (null === arg1) {
        ...
        let encodeURIComponentResult2 = _mod5627(arg0);
      } else {
        const _encodeURIComponent = encodeURIComponent;
    ...
    const mapped = sorted.map((item) => {
      ...
      if (undefined === closure_0[item]) {
        ...
        if (!items.encode) {
          ...
          let encodeURIComponentResult = closure_0(5627)(item);
        } else {
          const _encodeURIComponent3 = encodeURIComponent;
        ...
        if (Array.isArray(arr)) {
          ...
          if (!tmp.encode) {
            ...
            let encodeURIComponentResult1 = closure_0(5627)(arr);
          } else {
            const _encodeURIComponent2 = encodeURIComponent;
            encodeURIComponentResult1 = encodeURIComponent(arr);
          }
        } else if (tmp.strict) {
          let encodeURIComponentResult2 = closure_0(5627)(item);
        } else {
          const _encodeURIComponent = encodeURIComponent;
