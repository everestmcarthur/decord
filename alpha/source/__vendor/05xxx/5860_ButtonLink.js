...
// Function ID: 5861
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1485, 5852, 5861, 5862]
// Exports: Button

// Module 5860 (ButtonLink)
import Link from "Link" /* 1485 */;
import ColorDefault from "Color" /* 5852 */;
import _mod5861 from "module_5861" /* 5861 */;
import Text from "Text" /* 5862 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5852)(color);
      str4 = tmp9(5852)(color).darken(0.71).string();
      const darkenResult = tmp9(5852)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5861.PlatformPressable, {});
}
