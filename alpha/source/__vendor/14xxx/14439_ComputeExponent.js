...
// Dependencies: [1161, 14424, 14440, 14441]
// Exports: ComputeExponent

// Module 14439 (ComputeExponent)
  ...
  if (timesResult.isZero()) {
    ...
    if (roundedNumber.isZero()) {
      ...
      if (floorResult1.eq(floorResult.minus(result))) {
        ...
        const items2 = [tmp2(14440).ComputeExponentForMagnitude(internalSlots, floorResult.plus(1)), floorResult.plus(1).toNumber()];
        return items2;
      }
