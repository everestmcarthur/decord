...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants1.length) {
      ...
      const result = tmp2(14487).parseUnicodeLanguageId(str.split(tmp2(14487).SEPARATOR));
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      if (str2) {
        ...
        const result1 = tmp10(14487).parseUnicodeLanguageId(str2.split(tmp10(14487).SEPARATOR));
  ...
  if (tmp9.region) {
    ...
    if (str3) {
      ...
      const result2 = tmp14(14487).parseUnicodeLanguageId(str3.split(tmp14(14487).SEPARATOR));
  ...
  if (str4) {
    ...
    const result3 = tmp17(14487).parseUnicodeLanguageId(str4.split(tmp17(14487).SEPARATOR));
  ...
  if (tmp19.region) {
    ...
    const str6 = tmp17(14486).territoryAlias[formatted];
    let tmp22;
    if (str6) {
      ...
      obj20.variants = [];
      const str8 = tmp17(14488).likelySubtags[tmp17(undefined, 14484).emitUnicodeLanguageId(undefined, obj20)];
      tmp22 = first;
      if (str8) {
        const region = tmp17(14487).parseUnicodeLanguageId(str8.split(tmp17(14487).SEPARATOR)).region;
        let tmp24 = region;
        if (region) {
  ...
  if (tmp19.script) {
    ...
    if (tmp17(14486).scriptAlias[tmp19.script]) {
      tmp19.script = tmp17(14486).scriptAlias[tmp19.script];
    }
  ...
  if (tmp19.variants.length) {
    for (let num7 = 0; num7 < tmp19.variants.length; num7 = num7 + 1) {
      ...
      if (languageAlias.variantAlias[formatted2]) {
        let tmp30 = tmp27(14486).variantAlias[formatted2];
        if (tmp27(14487).isUnicodeVariantSubtag(tmp30)) {
          tmp19.variants[num7] = tmp30;
        } else if (tmp27(14487).isUnicodeLanguageSubtag(tmp30)) {
          tmp19.lang = tmp30;
        }
      }
    }
