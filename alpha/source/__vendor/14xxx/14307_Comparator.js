...
// Function ID: 14308
// Name: Comparator
// Dependencies: [41, 42, 14280, 14282, 14283, 14279, 14305, 14308]

// Module 14307 (Comparator)
...
const entry = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(14283).safeRe;
    const t = Comparator(14283).t;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(14279)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
        self.semver = semver;
      }
...
const items = [
  ...
  },
  {
    ...
    value: function test(arg0) {
      const self = this;
      let tmp = arg0;
      Comparator(14282)("Comparator.test", arg0, this.options.loose);
      if (this.semver !== closure_3) {
        if (tmp !== tmp5) {
          if (typeof tmp === "string") {
            try {
              tmp = new tmp2(14279)(tmp, self.options);
            } catch (err) {
              return false;
            }
          }
          return tmp2(14305)(tmp, self.operator, self.semver, self.options);
        }
      }
      return true;
    }
    ...
    value: function intersects(value, arg1) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(14308)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(14308)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(14280)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(14305)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(14305)(self.semver, ">", value.semver, tmp45);
