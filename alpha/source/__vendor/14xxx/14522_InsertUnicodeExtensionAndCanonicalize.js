...
// Dependencies: [14515, 14523]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14522 (InsertUnicodeExtensionAndCanonicalize)
import _mod14515 from "module_14515" /* 14515 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14523 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14515.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
