...
// Dependencies: [32, 19, 17, 21, 6970, 6897, 6972, 6959, 6968, 6967, 6946]
// Exports: VirtualDetector

// Module 6971 (VirtualDetector)
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("module_6970").useInterceptingDetectorContext();
    ...
    closure_4(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: tmp, handlerTags, methods: tmp2.gesture.detectorCallbacks, viewRef: "a", userSelect: "ok", touchAction: "sol", enableContextMenu: "ters" };
