...
// Function ID: 6949
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6853, 6920, 6949, 6950, 6951, 6952, 6953, 6946, 6861, 6859]
// Exports: default

// Module 6948 (hitSlop)
import _mod6920 from "module_6920" /* 6920 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6949 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6952 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6920.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6949).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6949);
          } else {
