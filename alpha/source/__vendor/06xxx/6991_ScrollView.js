...
// Function ID: 6992
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6904, 6905, 6924, 6964, 6960]
// Exports: FlatList

// Module 6991 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6960 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6904";
import module_6904 from "module_6904" /* 6904 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6904(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6905).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6904(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6905).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6904(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6904(TextInput);
