...
// Function ID: 6948
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6860, 6861, 6880, 6920, 6916]
// Exports: FlatList

// Module 6947 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6916 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6860";
import module_6860 from "module_6860" /* 6860 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6860(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6861).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6860(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6861).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6860(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6860(TextInput);
