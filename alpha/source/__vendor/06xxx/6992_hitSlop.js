...
// Function ID: 6993
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6897, 6964, 6993, 6994, 6995, 6996, 6997, 6990, 6905, 6903]
// Exports: default

// Module 6992 (hitSlop)
import _mod6964 from "module_6964" /* 6964 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6993 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6996 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6964.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6993).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6993);
          } else {
