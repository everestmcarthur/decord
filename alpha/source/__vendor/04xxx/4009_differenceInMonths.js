...
// Dependencies: [3811, 3997, 3987, 3812, 4010]
// Exports: default

// Module 4009 (differenceInMonths)
...
if (!module_4010) {
  const obj5 = { default: module_4010 };
  let tmp11 = obj5;
} else {
  tmp11 = module_4010;
}
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_4010.default(_typeof.default(date)) && 1 === absolute && 1 === obj3.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
