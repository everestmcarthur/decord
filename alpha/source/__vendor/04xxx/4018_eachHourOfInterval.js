...
// Dependencies: [3965, 3811, 3812]
// Exports: default

// Module 4018 (eachHourOfInterval)
      ...
      if (!isNaN(NumberResult)) {
        ...
        if (defaultResult1.getTime() <= time1) {
          do {
            ...
            let defaultResult3 = module_3965.default(defaultResult1, NumberResult);
