...
// Dependencies: [4457, 4461]
// Exports: installWorkletsSupport

// Module 4456 (installWorkletsSupport)
...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4461.NitroModules;
    const boxResult = NitroModules.box(_mod4461.NitroModules);
    require = boxResult;
