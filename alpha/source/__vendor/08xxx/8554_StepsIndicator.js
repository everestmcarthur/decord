...
// Function ID: 8555
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8552, 8553, 8555, 8556]
// Exports: StepsIndicator

// Module 8554 (StepsIndicator)
import _mod8552 from "module_8552" /* 8552 */;
import _mod8553 from "module_8553" /* 8553 */;
import SliderTrackMark from "SliderTrackMark" /* 8555 */;
import StepNumber from "StepNumber" /* 8556 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8552.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8552.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8553.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8552.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8553.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8552).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8553).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8553).styles.stepIndicatorElement;
    }
