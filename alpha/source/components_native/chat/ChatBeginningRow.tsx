...
// Dependencies: [32, 5, 19, 17, 4748, 2040, 7517, 9855, 7347, 7855, 2045, 2059, 2041, 2096, 2105, 2063, 4395, 4405, 4937, 1372, 1074, 2048, 11842, 12721, 12695, 11643, 21, 4756, 576, 5282, 1115, 5284, 5316, 5317, 5289, 5291, 5171, 4752, 4451, 4457, 5334, 11857, 1177, 12722, 8902, 10507, 504, 4600, 8218, 4909, 9822, 7515, 7512, 10886, 4690, 4746, 12723, 12724, 38, 11, 12726, 4453, 9854, 5349, 12730, 6046, 10075, 6466, 2108, 12840, 12843, 8906, 4769, 5186, 12847, 5110, 12848, 7410, 9575, 1241, 10410, 8206, 7359, 7354, 4454, 4723, 12850, 1980, 7402, 12851, 8455, 8447, 7429, 12852, 8459, 7582, 4959, 12869, 5796, 10002, 11131, 12871, 11644, 12878, 8872, 11839, 8648, 4576, 2027, 11851, 11843, 11840, 11841, 11847, 8939, 10288, 7461, 11173, 4698, 12882, 12886, 2]
// Exports: default

// Module 12720 (ChatBeginningRow)
...
import ThreadIcon from "ThreadIcon" /* 5284 */;
...
import openGroupDMAddMembers from "openGroupDMAddMembers" /* 11839 */;
import showChatGDMUpsellActionSheetDefault from "showChatGDMUpsellActionSheet" /* 11851 */;
...
import _modDef12847 from "module_12847" /* 12847 */;
import UserSettingsAuthedAppDeleteWarningModalDefault from "UserSettingsAuthedAppDeleteWarningModal" /* 12848 */;
import PortalAccessibilityWorkaroundViewDefault from "PortalAccessibilityWorkaroundView" /* 12886 */;
...
const ChannelAccessInfoDefault = tmp(12723);
require = fn;
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    ...
    if (isPrivate) {
      let AppsIcon = tmp6(5316).AppsLockIcon;
      let tmp9 = tmp6;
    } else {
      AppsIcon = tmp6(5317).AppsIcon;
      tmp9 = tmp6;
    }
    ...
    if (isPrivate) {
      obj4.IconComponent = tmp17(5289).TextLockIcon;
      obj4.label = tmp17(1115).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj4;
    } else {
      obj4.IconComponent = tmp17(5291).TextIcon;
      obj4.label = tmp17(1115).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj4;
    }
...
function ChatBeginningRowHeader(arg0) {
  ...
  const tmp4 = null != subtitleLink && subtitleLink(5171).useIsScreenReaderEnabled();
  ...
  if (!isGameInvitesPost) {
    ...
    obj4.style = items1;
    obj4.children = title;
    items[1] = closure_44(tmp2(4752).Text, obj4);
    obj3.children = items;
  ...
  if (tmp11Result) {
    ...
    tmp11Result = closure_44(tmp2(4752).Text, obj6);
  }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj3.style = items;
    const obj4 = { source: _modDef12722, size: tmp2(1177).IconSizes.REFRESH_SMALL_16, color: token };
    ...
    items1[1] = closure_44(tmp2(4752).Text, obj5);
    obj3.children = items1;
    isPrivate = tmp6(tmp2(5334).PressableOpacity, obj3);
  }
  ...
  if (canEdit) {
    ...
    const items5 = [closure_44(tmp2(10507).PencilIcon, obj7), ];
    ...
    items5[1] = closure_44(tmp2(4752).Text, obj8);
    obj6.children = items5;
    canEdit = tmp6(tmp2(5334).PressableOpacity, obj6);
  }
  items3[1] = canEdit;
...
function ThreadOwner(arg0) {
  ...
  if (str == null) {
    str = guildId(4600).getName(stateFromStores);
    const obj4 = guildId(4600);
  }
  if (str == null) {
    str = "???";
  }
  ...
  if ("username" === stateFromStores2) {
    ...
    return closure_44(tmp2(4752).Text, obj6);
  } else {
    ...
    items3[1] = closure_44(tmp2(4752).Text, obj9);
...
function ChatBeginningRowThread(channel) {
  ...
  const result = channel(9822).isPrivateGuildChannel(channel);
  const obj = channel(9822);
  const appliedTags = channel(7515).useAppliedTags(channel);
  const obj2 = channel(7515);
  const isGameInvitesPost = channel(7512).useIsGameInvitesPost(channel);
  channel(504);
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp12Result3 = tmp12(tmp4(4752).Text, obj6);
    }
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp8) {
        ...
        tmp12Result4 = tmp12(tmp4(4752).Text, obj8);
      }
    }
...
function DMSpamButton(channel) {
  ...
  const dMMessageToReport = channel(12843).useDMMessageToReport(channel, user.id, true === user.bot);
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return closure_44(tmp(5186).Button, obj2);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      const obj3 = { size: tmp2(1177).Icon.Sizes.SMALL, source: _modDef12847, style: tmp.appDMButtonIcon };
      ...
      tmp4 = closure_44(tmp2(5186).Button, obj2);
    }
  }
  return tmp4;
}
  ...
  if (channel.user.bot) {
    ...
    obj2.onPress = function onPress() {
      if (stateFromStores) {
        ...
        const obj2 = { channel };
        tmp(4723).openLazy(asyncRequireImpl(12850, dependencyMap.paths), "MessageNotificationChannelActionSheet", obj2);
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = closure_47();
  dependencyMap = tmp;
  const analyticsLocations = user(7402)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  let tmp4Result = user(12851)(id);
  id = tmp4Result;
  const tmp4 = user(12851);
  ...
  if (null == user) {
    ...
    userTag = tmp2(4600).getUserTag(user, { decoration: "never", identifiable: "always" });
    const tmp2Result = tmp2(4600);
    const name = tmp2(4600).getName(user);
    ...
    const items5 = [closure_44(tmp7(5334).PressableOpacity, obj5), , , , , , ];
    ...
    obj7.children = closure_44(tmp7(4752).Text, obj8);
    items5[1] = closure_44(tmp7(5334).PressableOpacity, obj7);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj9.children = tmp15(tmp7(4752).Text, obj10);
      tmp15Result = tmp15(tmp7(5334).PressableOpacity, obj9);
    }
    ...
    items5[3] = closure_44(tmp7(4752).Text, obj11);
    let tmp15Result2 = null;
    if (user.isProvisional) {
      let obj12 = { style: tmp.provisionalAccountExplainer, userId: user.id, iconSize: 14 };
      tmp15Result2 = tmp15(tmp7(12878).ChatProvisionalAccountExplainerCard, obj12);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
          ...
          if (null != user) {
            let obj2 = {
              ...
              onPressMutualGuild(arg0) {
                  ...
                  user(4959).popWithKey(closure_1_42);
                }
            };
            ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12852, dependencyMap.paths), "MutualGuildsActionSheet", obj2);
          }
        }
        ...
        let obj14 = {
          size: tmp7(5796).GuildIconSizes.SMALL,
        ...
        const items6 = [tmp15(tmp7(12869).GuildIconPile, obj14), ];
        ...
        items6[1] = tmp15(tmp7(4752).Text, obj15);
        obj13.children = items6;
        tmp18Result = tmp18(tmp7(5334).PressableOpacity, obj13);
      }
    }
    ...
    if (user.isNonUserBot()) {
      ...
      tmp18Result4 = tmp15(function RelationshipButtons(reportButton) {
        ...
        if (stateFromStores === constants8.PENDING_INCOMING) {
          ...
          const items1 = [tmp4(tmp(4752).Text, obj4), ];
          ...
          const items2 = [tmp4(tmp(5186).Button, obj7), , , ];
          ...
          items2[1] = tmp4(tmp(5186).Button, obj8);
          ...
          items2[2] = tmp4(tmp(5186).Button, obj9);
          ...
          if (tmp6.NONE === stateFromStores) {
            ...
            if (!bot) {
              ...
              tmp4Result = tmp4(tmp(5186).Button, obj11);
            }
            ...
            tmp4Result2 = tmp4(tmp(5186).Button, obj12);
            ...
            tmp4Result2 = tmp4(tmp(5186).Button, obj13);
          } else {
            tmp4Result2 = null;
            if (tmp6.PENDING_OUTGOING === stateFromStores) {
              ...
              tmp4Result2 = tmp4(tmp(5186).Button, obj14);
            }
          }
...
function ChatBeginningRowGroupDM(channel) {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (first) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp2(8648).mobileCreateInvite(channel, constants.GROUP_DM), done: false };
              return obj5;
            }
          }
        } else if (arg0 === 1) {
  ...
  const callback2 = noop.useCallback(() => {
    ...
    if ("open" === groupDMAddMembersAction) {
      if (tmpResult.UNSAFE_isDismissibleContentDismissed(tmp(2027).DismissibleContent.GDM_INVITE_REMINDER)) {
        onClick();
      } else {
        const obj2 = { onClick };
      ...
      const result = tmp(11839).showGroupDMAddMembersRoadblock(groupDMAddMembersAction, constants2.CHANNEL_TEXT_AREA);
      const tmpResult2 = tmp(11839);
    }
  }, items3);
  ...
  let obj = channel(504);
  let obj2 = first(11843);
  const obj3 = { location: GroupDMChatBeginning };
  const tmp13 = GroupDMChatBeginning;
  const groupDMNitroAudience = channel(11840).useGroupDMNitroAudience();
  ...
  let obj4 = channel(11840);
  if (stateFromStores) {
    enabled = tmp7(11840).isGroupDMNitroUpsellAudience(groupDMNitroAudience);
    const tmp7Result = tmp7(11840);
  }
  if (enabled) {
  ...
  tmp16 = first(11841)({ useNitroCapExperiment: true });
  obj5.acquisitionStrategy = channel(11840).GroupDMNitroAcquisitionStrategy.MARKETING;
  const tmp2Result = first(11847);
  ...
  const tmp2ResultResult = first(11847)(obj5);
  obj7.size = channel(1177).AvatarSizes.XXLARGE;
  const items5 = [closure_44(first(11173), obj7), , , ];
  ...
  const tmp23 = channel.id === channel(7461).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj8.variant = str;
  obj8.children = arr;
  items5[1] = closure_44(channel(4752).Text, obj8);
  ...
  items5[2] = closure_44(channel(4752).Text, obj9);
  let tmp19Result = null;
  if (!tmp23) {
    if (enabled) {
      const obj11 = { style: tmp.gdmInviteFriends, onPress: tmp2ResultResult, IconComponent: tmp7(8939).NitroWheelIcon, iconVariant: "default", title: null, subtitle: null };
      ...
      tmp21Result = null;
      if (stateFromStores) {
        const obj13 = { style: tmp.gdmInviteFriends, onPress: callback2, IconComponent: tmp7(10288).GroupPlusIcon, iconVariant: "default", title: null };
    ...
    obj14.IconComponent = tmp7(4698).LinkIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      tmp21Result4 = tmp21(tmp2(12882), obj15);
    }
...
let closure_42 = fn(12695).MOBILE_MESSAGE_REQUESTS_MODAL_KEY;
let closure_43 = fn(11643).BLOCK_CONFIRMATION_ACTION_SHEET_KEY;
const jsxProd = fn(21);
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              let base64;
              tmp5(9854).init(id);
              const obj7 = tmp5(9854);
              const obj5 = { size };
              dependencyMap = 1;
              c3 = 1;
              const obj6 = { value: tmp5(5349).openImagePicker(obj5), done: false };
              return obj6;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            base64 = value.base64;
            if (null != base64) {
              tmp5(9854).updateIcon(closure_129_2, base64);
              const obj = tmp5(9854);
              tmp5(9854).open(closure_129_2, constants.LANDING);
              const obj2 = tmp5(9854);
            }
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
