...
// Function ID: 8930
// Name: ChatItem
// Dependencies: [32, 19, 17, 4748, 1074, 8190, 21, 576, 8930, 1090, 8931, 7510, 8932, 4756, 1364, 8394, 4457, 672, 5198, 2]
// Exports: default
...
function DCDChatItem(message) {
  ...
  if (message.type === MessageTypes.AUTO_MODERATION_ACTION) {
    ...
    if (AUTOMOD_INCIDENT_ACTIONS.has(message.type)) {
      ...
      tmp3Result = closure_1_10(tmp21(8931).default, obj3);
    } else if (isSystemMessageDefault(message)) {
      const obj4 = {};
      const merged3 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8932).default, obj4);
    } else {
      const obj = {};
      const merged4 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8931).default, obj);
    }
  }
  return tmp3Result;
}
