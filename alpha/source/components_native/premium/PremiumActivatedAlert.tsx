...
// Dependencies: [19, 17, 1074, 21, 4722, 5611, 4380, 10953, 10954, 10955, 10956, 10957, 9623, 10958, 10959, 10960, 10961, 10962, 10963, 8287, 10964, 4573, 10965, 10966, 10967, 10968, 10969, 10970, 10971, 10972, 10973, 1115, 4656, 5163, 10974, 10975, 1177, 2]
// Exports: default

// Module 10952 (PremiumActivatedAlert)
...
let closure_11 = createStyles.createStyles((arg0) => {
  if (PremiumUtils.Branding.BUNDLE === arg0) {
    ...
    if (tmp(4380).Branding.TIER_0 !== arg0) {
      if (tmp(4380).Branding.TIER_1 !== arg0) {
        if (tmp(4380).Branding.TIER_2 !== arg0) {
          if (tmp(4380).Branding.PREMIUM_GUILD === arg0) {
...
export default function PremiumActivatedAlert(onClose) {
  ...
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    ...
    let tmp9 = obj2;
  } else if (tmp7(4380).Branding.TIER_1 === premiumBranding) {
    const obj3 = { logo: { width: 82, height: 32 } };
    tmp9 = obj3;
  } else {
    if (tmp7(4380).Branding.BUNDLE !== premiumBranding) {
      if (tmp7(4380).Branding.TIER_2 !== premiumBranding) {
        if (tmp7(4380).Branding.PREMIUM_GUILD === premiumBranding) {
  ...
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result10 = tmp4(10953);
  } else if (tmp7(4380).Branding.TIER_1 === premiumBranding) {
    tmp4Result10 = tmp4(10954);
  } else if (tmp7(4380).Branding.TIER_2 === premiumBranding) {
    tmp4Result10 = tmp4(10955);
  } else if (tmp7(4380).Branding.BUNDLE === premiumBranding) {
    tmp4Result10 = tmp4(10956);
  } else if (tmp7(4380).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result10 = tmp4(10957);
  }
  obj7.source = tmp4Result10;
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result11 = tmp4(10962);
  } else if (tmp7(4380).Branding.TIER_1 === premiumBranding) {
    tmp4Result11 = tmp4(10963);
  } else {
    if (tmp7(4380).Branding.BUNDLE !== premiumBranding) {
      if (tmp7(4380).Branding.TIER_2 !== premiumBranding) {
        if (tmp7(4380).Branding.PREMIUM_GUILD === premiumBranding) {
          tmp4Result11 = tmp4(10964);
        }
      }
    }
    tmp4Result11 = tmp4(8287);
  }
  const items = [React5(React3, { source: tmp4Result11, style: tmp9.logo }), , ];
  let tmp16Result = null;
  if (premiumBranding === PremiumUtils.Branding.BUNDLE) {
    const obj9 = { source: tmp4(10974), style: tmp.logoPlusPremiumGuild };
    tmp16Result = tmp16(tmp17, obj9);
  }
  items[1] = tmp16Result;
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result12 = tmp4(9623);
  } else if (tmp7(4380).Branding.TIER_1 === premiumBranding) {
    tmp4Result12 = tmp4(10958);
  } else if (tmp7(4380).Branding.TIER_2 === premiumBranding) {
    tmp4Result12 = tmp4(10959);
  } else if (tmp7(4380).Branding.BUNDLE === premiumBranding) {
    tmp4Result12 = tmp4(10960);
  } else if (tmp7(4380).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result12 = tmp4(10961);
  }
  ...
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    if (tmp7Result.isThemeDark(tmp6)) {
      let tmp4Result14 = tmp4(10965);
    } else {
      tmp4Result14 = tmp4(10966);
    }
    tmp7Result = tmp7(4573);
  } else {
    if (tmp7(4380).Branding.TIER_1 === premiumBranding) {
      if (tmp7Result5.isThemeDark(tmp6)) {
        let tmp4Result15 = tmp4(10967);
      } else {
        tmp4Result15 = tmp4(10968);
      }
      let tmp4Result18 = tmp4Result15;
      tmp7Result5 = tmp7(4573);
    } else if (tmp7(4380).Branding.TIER_2 === premiumBranding) {
      if (tmp7Result6.isThemeDark(tmp6)) {
        let tmp4Result16 = tmp4(10969);
      } else {
        tmp4Result16 = tmp4(10970);
      }
      tmp4Result18 = tmp4Result16;
      tmp7Result6 = tmp7(4573);
    } else if (tmp7(4380).Branding.BUNDLE === premiumBranding) {
      if (tmp7Result7.isThemeDark(tmp6)) {
        let tmp4Result17 = tmp4(10971);
      } else {
        tmp4Result17 = tmp4(10972);
      }
      tmp4Result18 = tmp4Result17;
      tmp7Result7 = tmp7(4573);
    } else if (tmp7(4380).Branding.PREMIUM_GUILD === premiumBranding) {
      tmp4Result18 = tmp4(10973);
    }
    ...
    if (tmp7(4380).Branding.TIER_0 !== premiumBranding) {
      if (tmp7(4380).Branding.TIER_1 !== premiumBranding) {
        if (tmp7(4380).Branding.TIER_2 === premiumBranding) {
          ...
          obj14.planName = tmp7(4380).getExternalPlanDisplayName({ planId: null, additionalPlans: null });
