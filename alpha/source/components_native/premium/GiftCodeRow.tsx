...
// Function ID: 13768
// Name: GiftCodeRow
// Dependencies: [19, 17, 1074, 21, 4722, 576, 4432, 11682, 4961, 8593, 6814, 4718, 5144, 1115, 4314, 1177, 2]

// Module 13767 (GiftCodeRow)
...
prototype["render"] = function render() {
  ...
  if (null != giftCode.expiresAt) {
    ...
    obj11.hours = expiresAt.diff(require("module_4314")(), "h");
...
GiftCodeRow.contextType = fn(4432).ThemeContext;
const size = fn(2);
