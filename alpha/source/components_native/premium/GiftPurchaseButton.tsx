...
// Dependencies: [5, 19, 17, 4386, 7433, 21, 5150, 4718, 504, 7436, 11301, 7358, 10989, 5067, 1115, 4380, 10904, 5145, 13772, 2]
// Exports: default

// Module 13771 (GiftPurchaseButton)
...
export default function GiftPurchaseButton(style) {
  ...
  const callback = analyticsLocations.useCallback(productIdForGift(function*() {
    ...
    planId(10904).openGiftModal({ recipientUserId: closure_129_2, premiumType, planInterval, analyticsLocation: closure_129_1, analyticsLocations: closure_129_4, order: closure_128_0 });
