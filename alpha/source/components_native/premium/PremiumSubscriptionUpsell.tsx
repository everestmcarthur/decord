...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4752).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4752).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4752).Text, obj9);
    }
    ...
    const items5 = [obj15, ];
    const obj17 = { IconComponent: tmp2(4706).CheckmarkLargeIcon, label: null, color: null };
    ...
    tmp = tmp6(tmp2(5186).Button, obj20);
    obj19.children = tmp;
