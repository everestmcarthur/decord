...
// Function ID: 16614
// Name: UnreadBars
// Dependencies: [19, 17, 4714, 1074, 21, 4722, 5694, 576, 4571, 4432, 4690, 4691, 1177, 1115, 504, 12666, 2]
// Exports: default

// Module 16613 (UnreadBars)
...
import TransitionGroup from "TransitionGroup" /* 12666 */;
...
UnreadBar.contextType = fn(4432).ThemeContext;
const size = fn(2);
