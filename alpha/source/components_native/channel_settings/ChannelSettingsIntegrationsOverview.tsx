...
// Dependencies: [19, 1962, 1958, 1074, 21, 1484, 7364, 5857, 1115, 5775, 1177, 1397, 4722, 576, 504, 8831, 5142, 17114, 17219, 2]
// Exports: default

// Module 17218 (ChannelSettingsIntegrationsOverview)
...
function LinkedLobbyFormSection(channel) {
  ...
  if (null != getOrFetchApplication) {
    ...
    obj3.children = closure_6(tmp(5775).TableRow, obj4);
    tmp5 = closure_6(tmp(5857).TableRowGroup, obj3);
...
export default function ConnectedChannelSettingsIntegrationsOverview(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    if (canManageWebhooks) {
      ...
      obj6.icon = tmp6(tmp(17114).WebhookIcon, {});
      obj6.onPress = function onPress() {
        return closure_1.push(ChannelSettingsSections.WEBHOOKS);
      };
      const items1 = [tmp6(tmp(5775).TableRow, obj6), ];
      ...
      if (hasItem) {
        ...
        obj7.icon = tmp6(tmp(17219).ChannelsFollowedIcon, {});
        obj7.onPress = function onPress() {
          return closure_1.push(ChannelSettingsSections.CHANNELS_FOLLOWED);
        };
        hasItem = tmp6(tmp(5775).TableRow, obj7);
      }
      const obj8 = { hasIcons: true, children: null };
      items1[1] = hasItem;
      obj8.children = items1;
      canManageWebhooks = tmp7(tmp(5857).TableRowGroup, obj8);
    }
    ...
    obj3.children = closure_7(tmp(5142).Stack, obj4);
    tmp6Result = tmp6(tmp(8831).Form, obj3);
  }
  return tmp6Result;
};
