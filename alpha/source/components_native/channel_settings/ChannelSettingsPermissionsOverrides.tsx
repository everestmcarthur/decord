...
// Dependencies: [32, 5, 19, 17, 2059, 2041, 2099, 2063, 4395, 4405, 1372, 1074, 21, 4756, 576, 1484, 1612, 504, 11860, 11859, 4400, 1086, 9824, 4769, 1978, 4600, 5108, 1115, 4451, 2108, 2049, 17287, 8105, 4752, 4909, 11206, 5817, 1177, 5899, 17291, 1364, 17292, 2]
// Exports: default

// Module 17286 (ChannelSettingsPermissionsOverrides)
...
import PermissionSpecUtilsDefault from "PermissionSpecUtils" /* 17287 */;
...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
    ...
    if (fromCreate) {
      let obj = {
        headerRight() {
            ...
            return closure_2_19(closure_0(8105).HeaderTextButton, obj);
          }
      };
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    let tmp12Result = tmp12(tmp5(11206), obj6);
  } else {
    ...
    tmp12Result = tmp12(tmp2(5817).TableRow, obj7);
  }
  ...
  items6[2] = first.map((permissions, index) => {
    ...
    obj.children = closure_2_19(TableRowGroup.TableRowGroup, {
      ...
      children: permissions.map((description, index) => {
        ...
        const obj = { variant: "text-xs/medium", color: "text-subtle", children: closure_1_0(17291).renderDescription(description.description) };
        const items = [closure_1_19(closure_1_0(4752).Text, obj), ];
        let tmp5Result = null;
        if (false !== tmp) {
          tmp5Result = null;
          if ("" !== tmp) {
            const obj3 = { variant: "text-xs/medium", color: "text-feedback-critical", children: tmp };
            tmp5Result = tmp5(tmp6(4752).Text, obj3);
          }
        }
        items[1] = tmp5Result;
        const obj2 = closure_1_0(17291);
        ...
        obj4.trailing = closure_1_19(id(17292), obj5);
        return closure_1_19(closure_1_0(5817).TableRow, obj4, "row-" + index);
      })
    });
