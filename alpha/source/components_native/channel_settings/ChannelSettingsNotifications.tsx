...
// Dependencies: [19, 2045, 2041, 4675, 4405, 4937, 1372, 1074, 21, 1115, 4756, 576, 4466, 4936, 7359, 4723, 10396, 1980, 7354, 4909, 5899, 5817, 10400, 7440, 5897, 5900, 4752, 8870, 5184, 504, 10401, 10402, 2]
// Exports: default

// Module 10395 (ChannelSettingsNotifications)
...
import NotificationSettingsChannelDefault from "NotificationSettingsChannel" /* 10402 */;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(10400).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(10400).MuteSettingType.CHANNEL;
    }
    obj7.type = CHANNEL;
...
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(5897).TableRadioGroup;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5899).TableRowGroup, obj7);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj6.children = items;
...
ChannelSettingsNotifications.contextType = fn(4466).ThemeContext;
const size = fn(2);
