...
// Dependencies: [109, 19, 17, 21, 4722, 576, 4432, 10110, 5132, 10124, 8475, 2]

// Module 10109 (components_native/QRCode)
import nativeDefault from "native" /* 576 */;
import VisualEffectViewThemedDefault from "VisualEffectViewThemed" /* 8475 */;
import QRCodeDefault from "QRCode" /* 10110 */;
import _mod10124 from "module_10124" /* 10124 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;

const VisualEffectViewDefault = tmp7(5132);
require = fn;
...
QRCode.contextType = fn(4432).ThemeContext;
...
QRCodeWithOverlay.prototype["render"] = function render() {
  ...
  obj3.style = items1;
  obj4 = { style: tmp[frozen[SIZE_40]], source: _mod10124 };
...
QRCodeWithOverlay.contextType = fn(4432).ThemeContext;
