...
// Dependencies: [109, 19, 21, 4452, 4535, 4507, 2]

// Module 4534 (TeenScreenTimeRive)
import BaseRive from "BaseRive" /* 4452 */;
import RiveErrorBoundary from "RiveErrorBoundary" /* 4507 */;
import _modDef4535 from "module_4535" /* 4535 */;
...
let closure_8 = noop.forwardRef(function TeenScreenTimeRiveInner(defaultViewModelInstance, ref) {
  ...
  return jsx(BaseRive.BaseRive, { ref, src: _modDef4535, artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: tmp, stateMachine: defaultViewModelInstance.stateMachine });
});
const size = fn(2);
