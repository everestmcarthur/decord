...
// Dependencies: [32, 1187, 10939, 10931, 10929, 10930, 2]

// Module 10949 (billing_settings_banner)
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.headerLocalized) {
    ...
    const joined2 = LocalizedString.internalBinaryWrite(header.headerLocalized, tag.tag(5, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = LocalizedString.internalBinaryWrite(header.headerLocalized, tag.tag(5, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.bodyLocalized) {
    const LocalizedString2 = localized_string.LocalizedString;
    const tagResult5 = tag.tag(6, _mod1187.WireType.LengthDelimited);
    const joined3 = LocalizedString2.internalBinaryWrite(header.bodyLocalized, tag.tag(6, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = LocalizedString2.internalBinaryWrite(header.bodyLocalized, tag.tag(6, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.helpArticle) {
    ...
    const joined4 = HelpArticle.internalBinaryWrite(header.helpArticle, tag.tag(7, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = HelpArticle.internalBinaryWrite(header.helpArticle, tag.tag(7, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
