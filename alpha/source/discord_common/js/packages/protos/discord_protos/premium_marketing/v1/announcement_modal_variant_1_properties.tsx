...
// Dependencies: [32, 1187, 10929, 10930, 10931, 2]

// Module 10928 (announcement_modal_variant_1_properties)
import _mod1187 from "module_1187" /* 1187 */;
import localized_string from "localized_string" /* 10929 */;
import help_article from "help_article" /* 10930 */;
import cta_button from "cta_button" /* 10931 */;
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if ("" !== header.pill) {
    tag.tag(2, _mod1187.WireType.LengthDelimited).string(header.pill);
    const tagResult1 = tag.tag(2, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.body) {
    tag.tag(3, _mod1187.WireType.LengthDelimited).string(header.body);
    const tagResult2 = tag.tag(3, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.imageLink) {
    tag.tag(4, _mod1187.WireType.LengthDelimited).string(header.imageLink);
    const tagResult3 = tag.tag(4, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.imageLinkLightTheme) {
    tag.tag(5, _mod1187.WireType.LengthDelimited).string(header.imageLinkLightTheme);
  ...
  if (header.headerLocalized) {
    ...
    const joined = LocalizedString.internalBinaryWrite(header.headerLocalized, tag.tag(6, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = LocalizedString.internalBinaryWrite(header.headerLocalized, tag.tag(6, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.pillLocalized) {
    const LocalizedString2 = localized_string.LocalizedString;
    const tagResult6 = tag.tag(7, _mod1187.WireType.LengthDelimited);
    const joined1 = LocalizedString2.internalBinaryWrite(header.pillLocalized, tag.tag(7, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = LocalizedString2.internalBinaryWrite(header.pillLocalized, tag.tag(7, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.bodyLocalized) {
    ...
    const joined2 = LocalizedString3.internalBinaryWrite(header.bodyLocalized, tag.tag(8, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = LocalizedString3.internalBinaryWrite(header.bodyLocalized, tag.tag(8, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.helpArticle) {
    ...
    const joined3 = HelpArticle.internalBinaryWrite(header.helpArticle, tag.tag(9, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = HelpArticle.internalBinaryWrite(header.helpArticle, tag.tag(9, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype2["internalBinaryWrite"] = function internalBinaryWrite(heroArtLocalizedVideoLinksDarkTheme, tag, writeUnknownFields) {
  ...
  while (iter !== undefined) {
    ...
    let tagResult2 = stringResult.tag(2, _mod1187.WireType.LengthDelimited);
  ...
  for (const item10053 of keys1) {
    ...
    let tagResult4 = forkResult1.tag(1, _mod1187.WireType.LengthDelimited);
    let stringResult2 = tagResult4.string(item10053);
    let tagResult5 = stringResult2.tag(2, _mod1187.WireType.LengthDelimited);
  ...
  while (iter2 !== undefined) {
    ...
    let tagResult7 = forkResult2.tag(1, _mod1187.WireType.LengthDelimited);
    let stringResult4 = tagResult7.string(nextResult1);
    let tagResult8 = stringResult4.tag(2, _mod1187.WireType.LengthDelimited);
...
prototype3["internalBinaryWrite"] = function internalBinaryWrite(link, tag, writeUnknownFields) {
  if ("" !== link.link) {
    tag.tag(1, _mod1187.WireType.LengthDelimited).string(link.link);
    const tagResult = tag.tag(1, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== link.locale) {
    tag.tag(2, _mod1187.WireType.LengthDelimited).string(link.locale);
    const tagResult1 = tag.tag(2, _mod1187.WireType.LengthDelimited);
  }
  if (false !== link.isDefault) {
    tag.tag(3, _mod1187.WireType.Varint).bool(link.isDefault);
...
prototype4["internalBinaryWrite"] = function internalBinaryWrite(disclaimerText, tag, writeUnknownFields) {
  if ("" !== disclaimerText.disclaimerText) {
    tag.tag(1, _mod1187.WireType.LengthDelimited).string(disclaimerText.disclaimerText);
    const tagResult = tag.tag(1, _mod1187.WireType.LengthDelimited);
  }
  if (disclaimerText.disclaimerHelpArticle) {
    const HelpArticle = help_article.HelpArticle;
    const tagResult1 = tag.tag(2, _mod1187.WireType.LengthDelimited);
    const joined = HelpArticle.internalBinaryWrite(disclaimerText.disclaimerHelpArticle, tag.tag(2, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = HelpArticle.internalBinaryWrite(disclaimerText.disclaimerHelpArticle, tag.tag(2, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (disclaimerText.disclaimerTextLocalized) {
    const LocalizedString = localized_string.LocalizedString;
    const tagResult2 = tag.tag(3, _mod1187.WireType.LengthDelimited);
    const joined1 = LocalizedString.internalBinaryWrite(disclaimerText.disclaimerTextLocalized, tag.tag(3, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = LocalizedString.internalBinaryWrite(disclaimerText.disclaimerTextLocalized, tag.tag(3, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype5["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if ("" !== header.subheader) {
    tag.tag(2, _mod1187.WireType.LengthDelimited).string(header.subheader);
    const tagResult1 = tag.tag(2, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.videoLink) {
    tag.tag(3, _mod1187.WireType.LengthDelimited).string(header.videoLink);
    const tagResult2 = tag.tag(3, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.helpArticleId) {
    tag.tag(4, _mod1187.WireType.LengthDelimited).string(header.helpArticleId);
    const tagResult3 = tag.tag(4, _mod1187.WireType.LengthDelimited);
  }
  let num5 = 0;
  ...
  if (header.button) {
    ...
    const tagResult5 = tag.tag(6, _mod1187.WireType.LengthDelimited);
    const joined1 = CTAButton.internalBinaryWrite(header.button, tag.tag(6, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = CTAButton.internalBinaryWrite(header.button, tag.tag(6, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("" !== header.heroArtVideoLinkLightTheme) {
    tag.tag(8, _mod1187.WireType.LengthDelimited).string(header.heroArtVideoLinkLightTheme);
    const tagResult6 = tag.tag(8, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.heroArtImageLinkDarkTheme) {
    tag.tag(9, _mod1187.WireType.LengthDelimited).string(header.heroArtImageLinkDarkTheme);
    const tagResult7 = tag.tag(9, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.heroArtImageLinkLightTheme) {
    tag.tag(10, _mod1187.WireType.LengthDelimited).string(header.heroArtImageLinkLightTheme);
    const tagResult8 = tag.tag(10, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.modalTopPill) {
    tag.tag(11, _mod1187.WireType.LengthDelimited).string(header.modalTopPill);
    const tagResult9 = tag.tag(11, _mod1187.WireType.LengthDelimited);
  }
  let num11 = 0;
  if (0 < header.heroArtVideoSubtitles.length) {
    do {
      let tagResult10 = tag.tag(13, _mod1187.WireType.LengthDelimited);
  ...
  if (header.storage) {
    const tagResult11 = tag.tag(14, _mod1187.WireType.LengthDelimited);
    const joined3 = closure_4.internalBinaryWrite(header.storage, tag.tag(14, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = closure_4.internalBinaryWrite(header.storage, tag.tag(14, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.disclaimer) {
    const tagResult12 = tag.tag(15, _mod1187.WireType.LengthDelimited);
    const joined4 = subtitleType.internalBinaryWrite(header.disclaimer, tag.tag(15, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = subtitleType.internalBinaryWrite(header.disclaimer, tag.tag(15, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.helpArticle) {
    const HelpArticle = help_article.HelpArticle;
    const tagResult13 = tag.tag(18, _mod1187.WireType.LengthDelimited);
    const joined5 = HelpArticle.internalBinaryWrite(header.helpArticle, tag.tag(18, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = HelpArticle.internalBinaryWrite(header.helpArticle, tag.tag(18, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.headerLocalized) {
    const LocalizedString = localized_string.LocalizedString;
    const tagResult14 = tag.tag(19, _mod1187.WireType.LengthDelimited);
    const joined6 = LocalizedString.internalBinaryWrite(header.headerLocalized, tag.tag(19, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = LocalizedString.internalBinaryWrite(header.headerLocalized, tag.tag(19, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.subheaderLocalized) {
    const LocalizedString2 = localized_string.LocalizedString;
    const tagResult15 = tag.tag(20, _mod1187.WireType.LengthDelimited);
    const joined7 = LocalizedString2.internalBinaryWrite(header.subheaderLocalized, tag.tag(20, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = LocalizedString2.internalBinaryWrite(header.subheaderLocalized, tag.tag(20, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (header.modalTopPillLocalized) {
    const LocalizedString3 = localized_string.LocalizedString;
    const tagResult16 = tag.tag(21, _mod1187.WireType.LengthDelimited);
    const joined8 = LocalizedString3.internalBinaryWrite(header.modalTopPillLocalized, tag.tag(21, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = LocalizedString3.internalBinaryWrite(header.modalTopPillLocalized, tag.tag(21, _mod1187.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("" !== header.dismissKey) {
    tag.tag(7, _mod1187.WireType.LengthDelimited).string(header.dismissKey);
    const tagResult17 = tag.tag(7, _mod1187.WireType.LengthDelimited);
  }
  if ("" !== header.body) {
    tag.tag(12, _mod1187.WireType.LengthDelimited).string(header.body);
    const tagResult18 = tag.tag(12, _mod1187.WireType.LengthDelimited);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
