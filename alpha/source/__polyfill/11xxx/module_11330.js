...
export const useIAP = () => {
  const iAPContext = require("module_11331").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11316").requestPurchase,
    requestSubscription: require("module_11316").requestSubscription
  };
};
