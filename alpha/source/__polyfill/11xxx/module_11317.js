...
export const useIAP = () => {
  const iAPContext = require("module_11318").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11303").requestPurchase,
    requestSubscription: require("module_11303").requestSubscription
  };
};
