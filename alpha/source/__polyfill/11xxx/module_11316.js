// Module ID: 11316
// Function ID: 11317
// Dependencies: [5, 17, 11317, 11318, 11323, 11324, 11325, 11326, 11327]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11324 */;
import _modAll11325 from "module_11325" /* 11325 */;
import _modAll11326 from "module_11326" /* 11326 */;
import syncAll from "sync" /* 11327 */;
...
const subs = fn(11317).ProductType.subs;
const inapp = fn(11317).ProductType.inapp;
...
export const IapAndroid = _modAll11325;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11326;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11318).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11318.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11318.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11318.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11318.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11318.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11318).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11323).singleProductAndroidMap);
      return tmp2(11318).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11318).getAndroidModuleType();
      const androidModule = tmp2(11318).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11317).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11318).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11317).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11318).getAndroidModule();
            ...
            const androidModule1 = v3(11318).getAndroidModule();
