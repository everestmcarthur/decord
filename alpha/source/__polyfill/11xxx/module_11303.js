// Module ID: 11303
// Function ID: 11304
// Dependencies: [5, 17, 11304, 11305, 11310, 11311, 11312, 11313, 11314]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11311 */;
import _modAll11312 from "module_11312" /* 11312 */;
import _modAll11313 from "module_11313" /* 11313 */;
import syncAll from "sync" /* 11314 */;
...
const subs = fn(11304).ProductType.subs;
const inapp = fn(11304).ProductType.inapp;
...
export const IapAndroid = _modAll11312;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11313;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11305).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11305.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11305.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11305.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11305.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11305.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11305).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11310).singleProductAndroidMap);
      return tmp2(11305).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11305).getAndroidModuleType();
      const androidModule = tmp2(11305).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11304).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11305).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11304).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11305).getAndroidModule();
            ...
            const androidModule1 = v3(11305).getAndroidModule();
