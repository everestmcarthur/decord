// Module ID: 14648
// Function ID: 14649
// Dependencies: [14649, 14650, 1252, 14651]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14651.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14651.percentDecode(_Buffer.from(buffer));
  }
}
