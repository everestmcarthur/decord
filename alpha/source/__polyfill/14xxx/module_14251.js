// Module ID: 14251
// Function ID: 14252
// Dependencies: [14224, 14228, 14223]
...
export default (num, arg1) => {
  if (num instanceof _mod14224) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14228).safeRe;
        const t2 = tmp(14228).t;
      ...
      if (null === match2) {
        ...
        return _mod14223("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
