// Module ID: 14316
// Function ID: 14317
// Dependencies: [14279, 14308, 14299, 14304, 14300, 14303, 14310, 14307]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14279")(arg0, arg3);
  const tmp4 = new require("module_14308")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14299);
    let tmpResult = tmp(14304);
    const tmpResult3 = tmp(14300);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14300);
      tmpResult = tmp(14303);
      tmpResult4 = tmp(14299);
  ...
  if (require("module_14310")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
