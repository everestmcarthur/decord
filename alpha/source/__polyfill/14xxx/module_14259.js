// Module ID: 14259
// Function ID: 14260
// Dependencies: [14253, 14224, 14244]
...
export default (arg0, arg1) => {
  obj = new obj(14253)(arg0, arg1);
  const tmp3 = new obj(14224)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14224)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14224(semver.semver.version);
