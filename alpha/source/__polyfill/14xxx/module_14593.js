// Module ID: 14593
// Function ID: 14594
// Dependencies: [14594, 14595, 1252, 14596]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14596.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14596.percentDecode(_Buffer.from(buffer));
  }
}
