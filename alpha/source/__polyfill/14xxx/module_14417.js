// Module ID: 14417
// Function ID: 14418
// Dependencies: [1161, 14418, 14419, 14483, 14490, 14495, 14510, 14511]
...
function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod14483.parseUnicodeLocaleId(arr3);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      const obj = { lang, script, region, variants: [] };
      const tmp4 = tmp(14483).likelySubtags[tmp(undefined, 14483).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(14483).parseUnicodeLanguageId(tmp4);
        ...
        return tmp(14483).emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = tmp(14483).likelySubtags[tmp(undefined, 14483).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = tmp(14483).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = tmp(14483).likelySubtags[tmp(undefined, 14483).emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = tmp(14483).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = tmp(14483).likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = tmp(14483).likelySubtags[tmp(undefined, 14483).emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = tmp(14483).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
const module_14418 = e.__importDefault(_mod14418);
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14483).emitUnicodeLanguageId(obj.__assign(Locale(1161).__assign({}, Locale(14483).parseUnicodeLanguageId(tmp2)), obj3));
            const parseUnicodeLocaleIdResult = Locale(14483).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (tmp(Locale(14483).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = tmp3(14483).emitUnicodeLocaleId(tmp3Result.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj5));
              const __assignResult = tmp3(1161).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (tmp(tmp3(14483).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = tmp3(14483).emitUnicodeLocaleId(tmp3Result7.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (tmp(tmp3(14483).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = tmp3(14483).emitUnicodeLocaleId(tmp3Result9.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj11));
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14483).emitUnicodeLanguageId(Locale(14483).parseUnicodeLanguageId(module_14418.default(this).locale));
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_14418.default(this).calendar;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_14418.default(this).collation;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_14418.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_14418.default(this).numeric;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_14418.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14483).parseUnicodeLanguageId(module_14418.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14483).parseUnicodeLanguageId(module_14418.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14483).parseUnicodeLanguageId(module_14418.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_14418.default(this);
      if (Locale(14419).HasOwnProperty(defaultResult, "initializedLocale")) {
