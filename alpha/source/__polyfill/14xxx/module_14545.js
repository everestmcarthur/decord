// Module ID: 14545
// Function ID: 14546
// Dependencies: [14546, 14547, 1161, 14548, 14549]
...
import calendars from "calendars" /* 14546 */;
import hourCycles from "hourCycles" /* 14547 */;
import timezones from "timezones" /* 14548 */;
import weekData from "weekData" /* 14549 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14547).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14547).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14547).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1161).__spreadArray(items, tmp2(14548).timezones[formatted], true);
  } else {
    return items;
  }
};
