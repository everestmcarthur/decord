// Module ID: 14314
// Function ID: 14315
// Dependencies: [14308, 14279, 14299]
...
export default (arg0, arg1) => {
  obj = new obj(14308)(arg0, arg1);
  const tmp3 = new obj(14279)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14279)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14279(semver.semver.version);
