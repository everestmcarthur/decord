// Module ID: 14306
// Function ID: 14307
// Dependencies: [14279, 14283, 14278]
...
export default (num, arg1) => {
  if (num instanceof _mod14279) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14283).safeRe;
        const t2 = tmp(14283).t;
      ...
      if (null === match2) {
        ...
        return _mod14278("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
