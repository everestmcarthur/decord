// Module ID: 14515
// Function ID: 14516
// Dependencies: [14516, 1161, 14517]
// Exports: findBestMatch, invariant

// Module 14515
import e from "e" /* 1161 */;
import data from "data" /* 14516 */;
import regions from "regions" /* 14517 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14516).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14516).data.supplemental.languageMatching["written-new"];
