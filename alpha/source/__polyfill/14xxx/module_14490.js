// Module ID: 14490
// Function ID: 14491
// Dependencies: [14491, 14492, 1161, 14493, 14494]
...
import calendars from "calendars" /* 14491 */;
import hourCycles from "hourCycles" /* 14492 */;
import timezones from "timezones" /* 14493 */;
import weekData from "weekData" /* 14494 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14492).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14492).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14492).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1161).__spreadArray(items, tmp2(14493).timezones[formatted], true);
  } else {
    return items;
  }
};
