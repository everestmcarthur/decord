// Module ID: 14261
// Function ID: 14262
// Dependencies: [14224, 14253, 14244, 14249, 14245, 14248, 14255, 14252]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14224")(arg0, arg3);
  const tmp4 = new require("module_14253")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14244);
    let tmpResult = tmp(14249);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14245);
      tmpResult = tmp(14248);
      tmpResult4 = tmp(14244);
  ...
  if (require("module_14255")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
