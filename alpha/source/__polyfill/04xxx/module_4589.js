// Module ID: 4589
// Function ID: 4590
// Dependencies: [19, 4585, 1108, 1109, 4590, 4592, 4594, 1102]
...
import parse_mod from "module_4590" /* 4590 */;
import AsyncMode from "AsyncMode" /* 4592 */;
import module_4594_mod from "module_4594" /* 4594 */;
...
let module_4594 = module_4594_mod;
if (module_4594) {
  if (typeof module_4594 === "object") {
    if ("default" in module_4594) {
      module_4594 = module_4594.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F128215 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4594(fn, displayName);
};
