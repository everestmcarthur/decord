// Module ID: 4113
// Function ID: 4114
// Dependencies: [4057, 4044, 3811, 4061, 4056, 3974, 3815, 3812, 3816, 4114, 4058, 4115]
// Exports: default

// Module 4113
import throwProtectedError from "throwProtectedError" /* 4058 */;
import parsers from "parsers" /* 4115 */;
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3815.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3815.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4114).DateToSystemTimezoneSetter();
