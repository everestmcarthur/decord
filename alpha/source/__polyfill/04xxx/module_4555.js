// Module ID: 4555
// Function ID: 4556
// Dependencies: [19, 4551, 1108, 1109, 4556, 4558, 4560, 1102]
...
import parse_mod from "module_4556" /* 4556 */;
import AsyncMode from "AsyncMode" /* 4558 */;
import module_4560_mod from "module_4560" /* 4560 */;
...
let module_4560 = module_4560_mod;
if (module_4560) {
  if (typeof module_4560 === "object") {
    if ("default" in module_4560) {
      module_4560 = module_4560.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F127787 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4560(fn, displayName);
};
