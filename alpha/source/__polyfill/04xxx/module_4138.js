    ...
    if ("i" !== arg1) {
      if ("ii" !== arg1) {
        if ("io" === arg1) {
          ...
          if ("iii" === arg1) {
            return _createSuperInternal(4119).mapValue(ordinalNumber.day(arg0, { width: "abbreviated", context: "formatting" }) || ordinalNumber.day(arg0, { width: "short", context: "formatting" }) || ordinalNumber.day(arg0, { width: "narrow", context: "formatting" }), valueCallback);
          } else if ("iiiii" === arg1) {
            return _createSuperInternal(4119).mapValue(ordinalNumber.day(arg0, { width: "narrow", context: "formatting" }), valueCallback);
          } else if ("iiiiii" === arg1) {
            return _createSuperInternal(4119).mapValue(ordinalNumber.day(arg0, { width: "short", context: "formatting" }) || ordinalNumber.day(arg0, { width: "narrow", context: "formatting" }), valueCallback);
          } else {
            return _createSuperInternal(4119).mapValue(ordinalNumber.day(arg0, { width: "wide", context: "formatting" }) || ordinalNumber.day(arg0, { width: "abbreviated", context: "formatting" }) || ordinalNumber.day(arg0, { width: "short", context: "formatting" }) || ordinalNumber.day(arg0, { width: "narrow", context: "formatting" }), valueCallback);
          }
        }
      }
    }
...
let items = [
  ...
  },
  {
    ...
    value: function set(arg0, arg1, arg2) {
      const defaultResult = module_4139.default(arg0, arg2);
