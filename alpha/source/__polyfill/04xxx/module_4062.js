// Module ID: 4062
// Function ID: 4063
// Dependencies: [3974, 3987, 3811, 4060, 4061, 4057, 3812, 3816]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_3974.default(defaultResult5) - module_3974.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_3974.default(defaultResult5);
    }
  } else {
