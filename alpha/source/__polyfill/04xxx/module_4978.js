// Module ID: 4978
// Function ID: 4979
// Dependencies: [1315, 4979, 4981, 4982, 5006, 5007, 4994, 5030, 5017, 5031, 5032]
...
export default function map(arg0) {
  ...
  if (_mod5006(arg0)) {
    ...
    const tmp12 = tmp(5007)(tmp3, tmp5);
    for (let num2 = 0; num2 < tmp5; num2 = num2 + 1) {
      let tmp13 = require;
      let tmp15 = ToString(num2);
      if (HasProperty(tmp3, tmp15)) {
        let tmp17 = tmp13(5017)(tmp3, tmp15);
        let items = [tmp17, num2, tmp3];
        let tmp18 = tmp13(5031)(arg0, tmp11, items);
        let tmp19 = tmp13(5032)(tmp12, tmp15, tmp18);
      }
    }
    return tmp12;
  } else {
