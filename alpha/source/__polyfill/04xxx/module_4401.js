...
// Module 4401
let fn = () => {
  let handler = function r(arg0, _exports22, firstResult) {
    let fn;
    let _exports = arg0;
    dependencyMap = _exports22;
    closure_2 = firstResult;
    ...
    closure_3 = tmp;
    let num = 0;
    if (0 < firstResult.length) {
      _exports = firstResult[num];
      let _exports2 = _exports22[_exports];
      while (!_exports2) {
        if (arg0[_exports]) {
          let obj = { exports: {} };
          _exports22[_exports] = obj;
          ...
          if (typeof call === "unknown") {
            firstResult = first(fn, obj, _exports2, firstResult, arg0, _exports22, firstResult);
            break;
          } else {
            let callResult = call(_exports3, fn, obj, _exports2, firstResult, arg0, _exports22, firstResult);
            break;
          }
          break;
        } else {
        ...
        _exports = _exports22[_exports].exports;
      }
    }
    return function o(arg0, arg1) {
      ...
      return dependencyMap[arg0].exports;
    };
  };
    ...
    (arg0, arg1, arg2) => {
      function loadScript(forceScriptReload) {
        ...
        const item = keys.forEach((item) => {
          ...
          const attr = element.setAttribute(combined, "".concat(closure_2[item]));
        });
  ...
  let items4 = [
    (arg0, arg1, arg2) => {
      ...
      module.exports = function isChrome(arg0) {
        ...
        if (!tmp2) {
          tmp2 = closure_0(userAgent);
        }
        if (!tmp2) {
          tmp2 = closure_1(userAgent);
        }
        if (!tmp2) {
          tmp2 = closure_2(userAgent);
        }
        if (!tmp2) {
          tmp2 = closure_3(userAgent);
        }
        if (!tmp2) {
          tmp2 = closure_4(userAgent);
        }
        return !tmp2;
      };
    },
  ...
  const items10 = [
    (arg0, arg1, arg2) => {
      ...
      module.exports = function isIosSafari(arg0) {
        ...
        let isMatch = closure_0(userAgent);
        if (isMatch) {
          isMatch = re2.test(userAgent);
        }
        if (isMatch) {
          isMatch = userAgent.indexOf("CriOS") <= -1;
        }
        if (isMatch) {
          isMatch = !closure_1(userAgent);
        }
        if (isMatch) {
  ...
  const items18 = [
    (arg0, arg1, arg2) => {
      ...
      module.exports = function supportsPopups(arg0) {
        ...
        if (!tmp2) {
          const tmp16 = closure_3(userAgent);
          let isMatch1 = !tmp16;
          if (!tmp16) {
        ...
        constructor(arg0) {
          ...
          if (typeof global !== "function") {
            ...
            if (obj.shouldCatchExceptions(obj1)) {
              ...
              catchPromise = _promise.catch(/* F126735 */ function() { ... });
            }
    ...
    (arg0, arg1, arg2) => {
      function wrapPromise(arg0) {
        ...
        return function() {
          ...
          if (typeof items[items.length - 1] === "function") {
            onceResult = closure_1.once(closure_0.deferred(items.pop()));
          }
          return closure_2.promiseOrCallback(closure_0.apply(this, items), onceResult);
        };
      }
      ...
      wrapPromise.wrapPrototype = (arg0, arg1) => {
        ...
        const found = ownPropertyNames.filter((item) => {
          ...
          if (tmp) {
            tmp = typeof closure_0.prototype[item] === "function";
          }
          let tmp4 = closure_2;
  ...
  const items40 = [
    function(arg0, arg1, obj) {
      const fn = (arg0) => {
        ...
        function loadAXOScript(combined2, minified) {
          let flag = minified;
        ...
        arg0.loadAxo = function loadAxo(arg0) {
          ...
          const f126752 = () => {
            ...
            if (typeof Symbol === "function") {
              let _Symbol = Symbol;
              obj[Symbol.iterator] = /* F126746 */ function() { ... };
            }
            return obj;
          };
  ...
  const items41 = [
    function(arg0, arg1, arg2) {
        ...
        if (validInputType.isValidInputType(arg0)) {
          if (0 === arg0.length) {
            return closure_8.map((item) => {
              let tmp = dependencyMap[item];
              if (!tmp) {
                tmp = items[item];
              }
              return closure_1_5.clone(tmp);
            });
          } else {
      ...
      closure_0 = fn;
      dependencyMap = global("./lib/card-types");
      ...
      creditCardType.updateCard = (arg0, type) => {
        ...
        if (tmp) {
          ...
          const tmp11 = closure_0(closure_0({}, globalResult.clone(tmp)), type);
      ...
      class Framebus {
        ...
        on(arg0, arg1) {
          ...
          if (this.isDestroyed) {
            ...
            namespaceEventResult = self.namespaceEvent(fn);
            tmp3 = Framebus;
            result = Framebus.subscriptionArgsInvalid(namespaceEventResult, arg1, origin);
            flag = !result;
            if (!result) {
              fn = arg1;
        ...
        targetFramesAsWindows() {
          if (this.limitBroadcastToFramesArray) {
            ...
            found = mapped.filter(/* F126759 */ function() { ... });
          } else {
            found = [];
          }
          return found;
        ...
        hasMatchingTargetFrame(arg0) {
          ...
          if (this.limitBroadcastToFramesArray) {
            ...
            tmp = globalThis;
            _Boolean = Boolean;
            return Boolean(result.find(/* F126760 */ function() { ... }));
          } else {
            flag = true;
            return true;
          }
  ...
  const items59 = [
    (fn, arg1, arg2) => {
      ...
      arg2.packagePayload = function packagePayload(namespaceEventResult, origin, eventData, fn) {
        const obj = { event: namespaceEventResult, origin };
        if (typeof fn === "function") {
    ...
    function(fn, arg1, arg2) {
      ...
      arg2.subscribeReplier = function subscribeReplier(fn, origin) {
        ...
        function replier(arg0, arg1) {
          closure_0(arg0, arg1);
          Framebus = closure_0.Framebus;
          Framebus.target({ origin }).off(defaultResult, replier);
        }
  ...
  const items66 = [
    (fn, arg1, arg2) => {
      ...
      arg2.isKitKatWebview = function isKitKatWebview(arg0) {
        ...
        let isMatch = closure_1(tmp);
        if (isMatch) {
          isMatch = re4.test(tmp);
        }
        return isMatch;
      };
  ...
  const items86 = [
    (arg0, arg1, arg2) => {
      ...
      module.exports = { AMEX_NONCE_REQUIRED: { type: globalResult.types.MERCHANT, code: "AMEX_NONCE_REQUIRED" }, AMEX_NETWORK_ERROR: { type: globalResult.types.NETWORK, code: "AMEX_NETWORK_ERROR" } };
    },
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          return closure_1.verify({ name: "American Express", client: client.client, authorization: client.authorization }).then(() => closure_2.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_3.create(client.authorization), name: "American Express" })).then((client) => {
    ...
    (arg0, arg1, arg2) => {
      class ApplePay {
        ...
        _createPaymentRequestSynchronously(arg0) {
          ...
          obj.supportedNetworks = supportedNetworks.map(/* F122952 */ function() { ... });
          ...
          return closure_3.verify({ name: "Apple Pay", client: client.client, authorization: client.authorization }).then(() => {
            ...
            const nextPromise = closure_5.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_4.create(client.authorization), name: "Apple Pay" }).then((getConfiguration) => {
              if (getConfiguration.getConfiguration().gatewayConfiguration.applePayWeb) {
                ...
                const tmp6 = new closure_1_2(constants.APPLE_PAY_NOT_ENABLED);
        ...
        request(arg0, arg1) {
          ...
          if (typeof module === "function") {
            ...
            catchPromise = nextPromise.catch((error) => {
              ...
              closure_1(error, null, httpStatus);
            });
          }
          return tmp;
        }
        ...
        getConfiguration: global("@braintree/wrap-promise")(function getConfiguration(arg0, sessionId) {
          ...
          return new Promise((arg0, arg1) => {
            ...
            if (attrs.authorizationFingerprint) {
              ...
              sessionId(request, (originalError, gatewayConfiguration, arg2) => {
                if (originalError) {
                  if (403 === arg2) {
                    let CLIENT_GATEWAY_NETWORK = constants2.CLIENT_AUTHORIZATION_INSUFFICIENT;
                  } else if (401 === arg2) {
                    CLIENT_GATEWAY_NETWORK = constants2.CLIENT_AUTHORIZATION_INVALID;
                  } else {
  ...
  const items96 = [
    (arg0, arg1, arg2) => {
      function _requestWithRetry(url, sum, arg2) {
        closure_0 = url;
        assign = sum;
        closure_2 = arg2;
        ({ graphQL, timeout } = url);
            ...
            if (4 === requestObject.readyState) {
              ...
              if (closure_1 < 1) {
                ...
                if (tmp22) {
                  sum = closure_1 + 1;
                  closure_1 = sum;
                  _requestWithRetry(closure_0, sum, closure_2);
                }
              }
              let str3 = closure_4;
              if (!closure_4) {
        ...
        if (data.data) {
          if (!data.errors) {
            ...
            if (clientConfiguration.applePayWeb) {
              ...
              closure_0 = closure_3;
              obj.applePayWeb.supportedNetworks = supportedCardBrands.reduce((arr, item) => {
                let combined = arr;
  ...
  const items106 = [
    (arg0, arg1, arg2) => {
      ...
      let obj = {
        (arg0, arg1, arg2) => {
          if (arg2) {
            let tmp2 = closure_6(arg0, arg1);
          } else {
            tmp2 = closure_5(arg0, arg1);
          }
          return tmp2;
        },
          ...
          return closure_3.verify({ name: "Data Collector", client: client.client, authorization: client.authorization }).then(() => {
            ...
            closure_2._createPromise = closure_4.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_5.create(client.authorization), name: "Data Collector" }).then((getConfiguration) => {
              ...
              if (0 === closure_1_2._instances.length) {
                const tmp10 = new closure_2(constants.DATA_COLLECTOR_REQUIRES_CREATE_OPTIONS);
            ...
            closure_2.teardown = globalResult(function teardown() {
              return _instances._createPromise.then(() => { ... });
            });
            client = closure_2;
            closure_2.getDeviceData = globalResult(function getDeviceData(arg0) {
              let obj = arg0;
              if (!arg0) {
                obj = {};
              }
      ...
      module.exports = {
        setup(arg0) {
          ...
          if (cachedDeviceData) {
            ...
            obj2.setCachedDeviceData(obj.merchantId, obj3.deviceData);
  ...
  const items115 = [
    (arg0, arg1, arg2) => {
      ...
      exports.cipher.aes = function(arr) {
        const self = this;
        if (!this.l[0][0][0]) {
          self.G();
        }
      ...
      exports.hash.sha256 = function(u) {
        const self = this;
        if (!this.b[0]) {
          self.G();
        }
      ...
      exports.prng.prototype = {
        ...
        startCollectors() {
          const self = this;
          if (!this.s) {
            const a = { loadTimeCollector: null, mouseCollector: null, keyboardCollector: null, accelerometerCollector: null, touchCollector: null };
            a.loadTimeCollector = () => {
            ...
            if (window.addEventListener) {
              ...
              if (document.attachEvent) {
                ...
                const bug = new a.exception.bug("can't attach event");
                throw bug;
              }
            }
            self.s = true;
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          const verifyResult = client.verify({ name: "fastlane", client: client.client, authorization: client.authorization });
          return client.verify({ name: "fastlane", client: client.client, authorization: client.authorization }).then(() => closure_3.create({ authorization: client.authorization, client: client.client, assetsUrl: closure_2.create(client.authorization), name: "fastlane" })).then((client) => closure_1(assign({ client, deviceData: client.deviceData }, client)));
        }),
        VERSION: "3.112.1"
      };
    },
          ...
          return closure_4.verify({ name: "Google Pay", client: client.client, authorization: client.authorization }).then(() => {
            ...
            const nextPromise = closure_1_3.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_1_2.create(client.authorization), name: "Google Pay" }).then((client) => {
              ...
              if (!client.getConfiguration().gatewayConfiguration.androidPay) {
                const tmp7 = new closure_2_1(constants.GOOGLE_PAYMENT_NOT_ENABLED);
      ...
      const exports = {
        ...
        destroy(ReanimatedCustomWebAnimationsStyle) {
          ...
          const item = arr.forEach((nodeType) => {
            ...
            if (matchFocusElementResult) {
              matchFocusElementResult = exports.matchFocusElement(nodeType.getAttribute("id"));
            }
            if (matchFocusElementResult) {
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        addMetadata(_configuration, data) {
          if (data) {
            let obj = closure_1(data);
          } else {
            obj = {};
          }
          const attrs = closure_0(_configuration.authorization).attrs;
          const tmp2 = closure_1(_configuration.analyticsMetadata);
      ...
      module.exports = {
        sendEvent: function sendPaypalEvent(arg0, arg1, arg2) {
          ...
          return resolved.then((getConfiguration) => {
            ...
            obj.tracking = items1;
            const request = { url: constants.ANALYTICS_URL, method: "post", data: obj, timeout: constants.ANALYTICS_REQUEST_TIMEOUT_MS };
            return getConfiguration._request(request, closure_1);
          }).catch((error) => {
            if (closure_1) {
              tmp(error);
            }
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = (arg0, arr) => {
        ...
        const item = arr.forEach((item) => {
          closure_0 = item;
          closure_0[item] = () => {
            throw new closure_0({ type: constants.METHOD_CALLED_AFTER_TEARDOWN.type, code: constants.METHOD_CALLED_AFTER_TEARDOWN.code, message: `${closure_0} cannot be called after teardown.` });
          };
        });
      };
    },
  ...
  const items155 = [
    (arg0, arg1, arg2) => {
      module.exports = (arg0, key10009, arg2) => {
        let num = 0;
        if (0 < arg0.length) {
          while (true) {
            let obj = arg0[num];
    ...
    (arg0, arg1, arg2) => {
      ...
      class FrameService {
        ...
        _writeDispatchFrame() {
          ...
          size = { "aria-hidden": true, name: text, title: text, src: this._options.dispatchFrameUrl, class: closure_6.DISPATCH_FRAME_CLASS, height: 0, width: 0, style: { position: "absolute", left: "-9999px" } };
          ...
          fn = function() {
            ...
            if (this.isFrameClosed()) {
              ...
              if (self._onCompleteCallback) {
                const tmp6 = new closure_1_9(constants.FRAME_SERVICE_FRAME_CLOSED);
    ...
    (arg0, arg1, arg2) => {
      ...
      class Modal {
        ...
        _lockScrolling() {
          ...
          rect = { left: tmp - tmp2, top: null, overflowStyle: document.body.style.overflow, positionStyle: document.body.style.position };
  ...
  const items165 = [
    (arg0, arg1, arg2) => {
      const globalResult = global("../../braintree-error");
      module.exports = { FRAME_SERVICE_FRAME_CLOSED: { type: globalResult.types.INTERNAL, code: "FRAME_SERVICE_FRAME_CLOSED", message: "Frame closed before tokenization could occur." }, FRAME_SERVICE_FRAME_OPEN_FAILED: { type: globalResult.types.INTERNAL, code: "FRAME_SERVICE_FRAME_OPEN_FAILED", message: "Frame failed to open." } };
    },
    { "../../braintree-error": 143 }
  ];
  obj[166] = items165;
      ...
      module.exports = (gatewayConfiguration, apiVersion, merchantId) => {
        ...
        if (2 === apiVersion) {
          ...
          if (androidPay.paypalClientId) {
            ...
            obj15.parameters = tmp3({}, obj18, obj16);
    ...
    (arg0, arg1, arg2) => {
      ...
      let obj = {
        isShadowElement(element) {
          return "[object ShadowRoot]" === closure_1(element).toString();
        },
        getShadowHost(arg0) {
        ...
        transformToSlot: null
      };
      function transformToSlot(element, arg1) {
        element = closure_1(element).querySelector("style");
      ...
      obj.transformToSlot = transformToSlot;
      module.exports = obj;
    },
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        atob(match) {
          ...
          const _window = window;
          return typeof call === "unknown" ? _atob(match) : call(_window, match);
        },
        _atob: atobPolyfill
      };
    },
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          return closure_1.verify({ name: "Local Payment", client: client.client, authorization: client.authorization }).then(() => closure_2.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_3.create(client.authorization), name: "Local Payment" })).then((client) => {
            client.client = client;
            if (true !== client.getConfiguration().gatewayConfiguration.paypalEnabled) {
              const tmp12 = new closure_5(constants.LOCAL_PAYMENT_NOT_ENABLED);
              ...
              if (tmp.redirectUrl) {
                ...
                if (tmp5.token) {
                  ...
                  let catchPromise = tokenizer.tokenize(tmp5).then((tokenizePayload) => {
                  ...
                  const nextPromise = tokenizer.tokenize(tmp5).then((tokenizePayload) => {
                    tokenizer.tokenizePayload = tokenizePayload;
                    return tokenizer;
                  });
                } else {
    ...
    (arg0, arg1, arg2) => {
      class Masterpass {
        ...
        tokenize(arg0) {
          ...
          if (global) {
            ...
            if (!flag) {
              ...
              if (tmp._authInProgress) {
                ...
                tmp12 = new.target;
                tmp13 = new.target;
                tmp14 = new closure_1(closure_2.MASTERPASS_TOKENIZATION_ALREADY_IN_PROGRESS);
                tmp15 = tmp14;
          ...
          tmp16 = new closure_1(closure_2.MASTERPASS_TOKENIZE_MISSING_REQUIRED_OPTION);
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          return closure_1.verify({ name: "Masterpass", client: client.client, authorization: client.authorization }).then(() => {
            ...
            return resolveResult;
          }).then(() => closure_4.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_5.create(client.authorization), name: "Masterpass" })).then((client) => {
            client.client = client;
            client = client.client;
            if (client.getConfiguration().gatewayConfiguration.masterpass) {
              const obj = new closure_3(tmp);
              let _initializeResult = obj._initialize();
            } else {
              const tmp7 = new client(constants.MASTERPASS_NOT_ENABLED);
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          return closure_1.verify({ name: "Payment Request", client: client.client, authorization: client.authorization }).then(() => closure_2.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_3.create(client.authorization), name: "Payment Request" })).then((client) => {
            closure_0.client = client;
  ...
  const items196 = [
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          closure_0 = client;
          return closure_0.verify({ name: "PayPal Checkout", client: client.client, authorization: client.authorization }).then(() => new closure_1(closure_0)._initialize(closure_0));
        }),
        isSupported() {
          return true;
        },
    ...
    (arg0, arg1, arg2) => {
      class PayPalCheckout {
        ...
        startVaultInitiatedCheckout(arg0) {
          ...
          if (this._vaultInitiatedCheckoutInProgress) {
            ...
            if (closure_1) {
              ...
              tmp5 = closure_1;
              closure_0 = closure_1({}, global, { flow: "checkout" });
              tmp6 = closure_0;
        ...
        teardown() {
          ...
          catchPromise = _frameServicePromise.catch(/* F123117 */ function() { ... });
      ...
      class PayPal {
          ...
          return window.popupBridge ? ((arg0, path) => {
            ...
            if (!arg0) {
              if (!path) {
                if (path) {
                  ...
                  self._tokenizePayPal(closure_0, path.queryItems).then(closure_1).catch(closure_2);
            ...
            if (code) {
              if ("FRAME_SERVICE_FRAME_CLOSED" === code.code) {
                ...
                const tmp25 = new closure_1(constants.PAYPAL_POPUP_CLOSED);
                closure_2(tmp25);
              } else {
                code = code.code;
                if (code) {
        ...
        _tokenizePayPal(arg0, arg1) {
          ...
          return nextPromise.catch((error) => {
            ...
            const _frameService = self._frameService;
            _frameService.close();
            return Promise.reject(closure_2(error, { type: constants.PAYPAL_ACCOUNT_TOKENIZATION_FAILED.type, code: constants.PAYPAL_ACCOUNT_TOKENIZATION_FAILED.code, message: constants.PAYPAL_ACCOUNT_TOKENIZATION_FAILED.message }));
          });
        }
        _formatTokenizePayload(arg0) {
          first = {};
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          return closure_1.verify({ name: "PayPal", client: client.client, authorization: client.authorization }).then(() => closure_2.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_3.create(client.authorization), name: "PayPal" })).then((client) => {
            client.client = client;
            if (true !== client.getConfiguration().gatewayConfiguration.paypalEnabled) {
  ...
  const items202 = [
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          closure_0 = client;
          return closure_0.verify({ name: "PreferredPaymentMethods", client: client.client, authorization: client.authorization }).then(() => new closure_1().initialize(closure_0));
        }),
        VERSION: "3.112.1"
      };
    },
      ...
      module.exports = {
        ...
        openPopup(arg0, debug) {
          ...
          return new Promise((arg0, arg1) => {
            ...
            const size = { name: "sepadirectdebit", dispatchFrameUrl: null, openFrameUrl: null, top: null, left: null, height: null, width: null };
            const sum1 = Math.round((window.outerWidth - width) / 2) + window.screenLeft;
            size.dispatchFrameUrl = `${closure_2}/dispatch-frame${closure_1_4(closure_3)}.html`;
            size.openFrameUrl = `${closure_2}/sepa-landing-frame${closure_1_4(closure_3)}.html`;
            size.top = sum;
            size.left = sum1;
            size.height = height;
            size.width = width;
            closure_2.create(size, (open) => {
        ...
        handleApproval(_client, last_4) {
          ...
          const requestResult = _client.request({ api: "clientApi", method: "post", endpoint: "payment_methods/sepa_debit_accounts", data: { sepa_debit_account: { last_4: last_4.last4, merchant_or_partner_customer_id: last_4.customerId, bank_reference_token: last_4.bankReferenceToken, mandate_type: last_4.mandateType }, merchant_account_id: last_4.merchantAccountId } });
          return _client.request({ api: "clientApi", method: "post", endpoint: "payment_methods/sepa_debit_accounts", data: { sepa_debit_account: { last_4: last_4.last4, merchant_or_partner_customer_id: last_4.customerId, bank_reference_token: last_4.bankReferenceToken, mandate_type: last_4.mandateType }, merchant_account_id: last_4.merchantAccountId } }).then((nonce) => {
            if (nonce.nonce) {
              ...
              const tmp5 = new closure_0(constants.SEPA_TRANSACTION_FAILED);
              throw tmp5;
            }
          }).catch(() => {
        ...
        handleApprovalForFullPageRedirect(client, result) {
          ...
          let requestResult = client.request({ api: "clientApi", method: "get", endpoint: `sepa_debit/${result.cart_id}` });
          ...
          return client.request({ api: "clientApi", method: "get", endpoint: `sepa_debit/${result.cart_id}` }).then((sepaDebitMandateDetail) => {
            ...
            closure_3.sendEvent(closure_0, "sepa.redirect.tokenization.success");
            return result;
          }).catch(() => {
            closure_3.sendEvent(closure_0, "sepa.redirect.handle-approval.failed");
            throw new closure_0(constants.SEPA_TRANSACTION_FAILED);
          });
        }
      };
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(arg0) {
          ...
          let nextPromise = closure_4.verify({ name: "SEPA", client: closure_0.client, authorization: closure_0.authorization }).then(() => closure_3.create({ authorization: closure_0.authorization, client: closure_0.client, debug: closure_0.debug, assetsUrl: closure_2.create(closure_0.authorization), name: "SEPA" }));
          return closure_4.verify({ name: "SEPA", client: closure_0.client, authorization: closure_0.authorization }).then(() => closure_3.create({ authorization: closure_0.authorization, client: closure_0.client, debug: closure_0.debug, assetsUrl: closure_2.create(closure_0.authorization), name: "SEPA" })).then((client) => {
            closure_0.client = client;
    ...
    (arg0, arg1, arg2) => {
      class InlineIframeFramework {
        ...
        _addV1IframeToPage() {
          ...
          _emitResult = this._emit(InlineIframeFramework.events.AUTHENTICATION_IFRAME_AVAILABLE, obj, /* F123163 */ function() { ... });
          return;
        }
    ...
    (arg0, arg1, arg2) => {
      class SongbirdFramework {
        ...
        prepareLookup(arg0) {
          ...
          nextPromise1 = nextPromise.then(() => { ... });
          catchPromise = nextPromise1.catch(/* F123177 */ function() { ... });
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          const verifyResult = client.verify({ name: "US Bank Account", client: client.client, authorization: client.authorization });
          return client.verify({ name: "US Bank Account", client: client.client, authorization: client.authorization }).then(() => closure_2.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_3.create(client.authorization), name: "US Bank Account" })).then((client) => {
            client.client = client;
            client = client.client;
            if (client.getConfiguration().gatewayConfiguration.usBankAccount) {
              let rejectResult = new closure_5(tmp);
            } else {
              const tmp7 = new closure_1(constants.US_BANK_ACCOUNT_NOT_ENABLED);
              rejectResult = Promise.reject(tmp7);
            }
            return rejectResult;
          });
      ...
      class USBankAccount {
        ...
        _loadPlaid(arg0) {
          ...
          if (window.Plaid) {
            ...
            if (element) {
              closure_129_0 = element;
              closure_129_1 = tmp;
              loadHandler2 = function loadHandler() { ... };
              closure_129_2 = loadHandler2;
              errorHandler2 = function errorHandler() { ... };
              closure_129_3 = errorHandler2;
              str7 = "error";
        ...
        deletePaymentMethod(arg0) {
          ...
          return _createPromise.then((getConfiguration) => {
            ...
            if ("CLIENT_TOKEN" === getConfiguration.getConfiguration().authorizationType) {
              ...
              const tmp6 = new closure_1_1(constants.VAULT_MANAGER_DELETE_PAYMENT_METHOD_NONCE_REQUIRES_CLIENT_TOKEN);
              catchPromise = Promise.reject(tmp6);
            }
            return catchPromise;
          });
  ...
  const items233 = [
    function(arg0, arg1, arg2) {
      ...
      module.exports = function createVenmoDesktop(arg0) {
        return new closure_0.default(arg0).initialize();
      };
    },
    { "./venmo-desktop": 236 }
  ];
      ...
      class VenmoDesktop {
          ...
          promise = new this.Promise((arg0, launchDesktopPromiseRejectFunction) => {
            ...
            function unknownErrorHandler(err) {
              if (typeof removeListeners === "function") {
                const bus = self.bus;
                bus.off(constants.VENMO_DESKTOP_CUSTOMER_CANCELED, customerCancelledHandler);
                const bus2 = self.bus;
                bus2.off(constants.VENMO_DESKTOP_UNKNOWN_ERROR, unknownErrorHandler);
        ...
        startPolling() {
          ...
          nextPromise1 = nextPromise.then((userName) => {
            if (userName) {
              const obj = { paymentMethodNonce: userName.paymentMethodId, username: `@${userName.userName || "".replace("@", "")}`, payerInfo: userName.payerInfo, id: null };
                  ...
                  if (status) {
                    ...
                    if (status !== status) {
                      ...
                      if ("CREATED" !== status) {
                        ...
                        return obj.Promise.reject(obj2);
                      }
                    }
          ...
          return closure_1.verify({ name: "Venmo", client: client.client, authorization: client.authorization }).then(() => {
            if (client.profileId) {
              if (typeof tmp.profileId !== "string") {
                const tmp17 = new closure_1_5(constants.VENMO_INVALID_PROFILE_ID);
                let rejectResult = Promise.reject(tmp17);
              }
              return rejectResult;
            }
            if (client.deepLinkReturnUrl) {
              if (typeof tmp.deepLinkReturnUrl !== "string") {
                const tmp10 = new closure_1_5(constants.VENMO_INVALID_DEEP_LINK_RETURN_URL);
                rejectResult = Promise.reject(tmp10);
              }
            }
            ...
            const nextPromise = closure_1_2.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_1_3.create(client.authorization), name: "Venmo" }).then((client) => {
              ...
              if (!client.getConfiguration().gatewayConfiguration.payWithVenmo) {
                const tmp7 = new closure_2_5(constants.VENMO_NOT_ENABLED);
                rejectResult = Promise.reject(tmp7);
              }
              return rejectResult;
            });
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        runWebLogin(frameServiceInstance) {
          ...
          frameServiceInstance.open({}, (arg0) => {
            if (arg0) {
              ...
              const promise = closure_1_1(1);
              closure_1_1(1).then((result) => {
                closure_1_4.resolve(result);
              }).catch((error) => {
                closure_0 = error;
                closure_3().then(() => { ... });
              });
              const nextPromise = closure_1_1(1).then((result) => {
                closure_1_4.resolve(result);
              });
            }
            frameServiceInstance.close();
        ...
        setupDesktopWebLogin(arg0) {
          ...
          const size = { name: "venmoDesktopWebLogin", dispatchFrameUrl: null, openFrameUrl: null, top: null, left: null, height: 570, width: 400 };
          const sum1 = Math.round((window.outerWidth - 400) / 2) + window.screenLeft;
          size.dispatchFrameUrl = `${`${assetsUrl}/web/3.112.1/html`}/dispatch-frame${closure_1(debug)}.html`;
          size.openFrameUrl = `${`${assetsUrl}/web/3.112.1/html`}/venmo-landing-frame${closure_1(debug)}.html`;
          size.top = sum;
          size.left = sum1;
          closure_0.create(size, (arg0) => {
  ...
  const items245 = [
    (arg0, arg1, arg2) => {
      const globalResult = global("../lib/braintree-error");
      module.exports = { VISA_CHECKOUT_NOT_ENABLED: { type: globalResult.types.MERCHANT, code: "VISA_CHECKOUT_NOT_ENABLED", message: "Visa Checkout is not enabled for this merchant." }, VISA_CHECKOUT_INIT_OPTIONS_REQUIRED: { type: globalResult.types.MERCHANT, code: "VISA_CHECKOUT_INIT_OPTIONS_REQUIRED", message: "initOptions requires an object." }, VISA_CHECKOUT_PAYMENT_REQUIRED: { type: globalResult.types.MERCHANT, code: "VISA_CHECKOUT_PAYMENT_REQUIRED", message: "tokenize requires callid, encKey, and encPaymentData." }, VISA_CHECKOUT_TOKENIZATION: { type: globalResult.types.NETWORK, code: "VISA_CHECKOUT_TOKENIZATION", message: "A network error occurred when processing the Visa Checkout payment." } };
    },
    { "../lib/braintree-error": 143 }
  ];
  obj[246] = items245;
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          const verifyResult = client.verify({ name: "Visa Checkout", client: client.client, authorization: client.authorization });
          return client.verify({ name: "Visa Checkout", client: client.client, authorization: client.authorization }).then(() => closure_2.create({ authorization: client.authorization, client: client.client, debug: client.debug, assetsUrl: closure_3.create(client.authorization), name: "Visa Checkout" })).then((client) => {
            client.client = client;
            client = client.client;
            if (client.getConfiguration().gatewayConfiguration.visaCheckout) {
              closure_5.sendEvent(tmp.client, "visacheckout.initialized");
              let rejectResult = new closure_4(tmp);
            } else {
              const tmp7 = new closure_1(constants.VISA_CHECKOUT_NOT_ENABLED);
              rejectResult = Promise.reject(tmp7);
            }
            return rejectResult;
          });
