...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    return _createSuperInternal(4119).parseNumericPattern(_createSuperInternal(4120).numericPatterns.dayOfYear, arg0);
  }
};
let items = [
  entry,
  {
    ...
    value: function validate(getUTCFullYear, arg1) {
      ...
      let tmp2 = arg1 >= 1;
      if (_createSuperInternal(4119).isLeapYearIndex(uTCFullYear)) {
        if (tmp2) {
          tmp2 = arg1 <= 366;
        }
        let tmp3 = tmp2;
