// Module ID: 4121
// Function ID: 4122
// Dependencies: [4053, 3814, 4119, 4117]
...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("Y" === arg1) {
      return _createSuperInternal(4119).mapValue(_createSuperInternal(4119).parseNDigits(4, arg0), valueCallback);
    } else if ("Yo" === arg1) {
      return _createSuperInternal(4119).mapValue(ordinalNumber.ordinalNumber(arg0, { unit: "year" }), valueCallback);
    } else {
      return _createSuperInternal(4119).mapValue(_createSuperInternal(4119).parseNDigits(arg1.length, arg0), valueCallback);
    }
  }
};
let items = [
  ...
  },
  {
    ...
    value: function set(setUTCFullYear, era, isTwoDigitYear, firstWeekContainsDate) {
      if (isTwoDigitYear.isTwoDigitYear) {
        setUTCFullYear.setUTCFullYear(_createSuperInternal(4119).normalizeTwoDigitYear(isTwoDigitYear.year, tmp), 0, firstWeekContainsDate.firstWeekContainsDate);
