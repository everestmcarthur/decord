// Module ID: 4071
// Function ID: 4072
// Dependencies: [3973, 4043, 4057, 4044, 3811, 3974, 3812, 3815, 3816]
// Exports: default
...
export default function formatRelative(arg0, arg1, locale) {
  ...
  const defaultResult3 = module_3815.default(num);
  if (locale1.localize) {
    if (locale1.formatLong) {
      if (locale1.formatRelative) {
        ...
        if (isNaN(defaultResult4)) {
          ...
          const defaultResult5 = subMilliseconds.default(defaultResult1, module_3974.default(defaultResult1));
          const obj = { locale: locale1, weekStartsOn: defaultResult3 };
          const obj2 = { locale: locale1, weekStartsOn: defaultResult3 };
          return format.default(defaultResult1, locale1.formatRelative(str5, defaultResult5, subMilliseconds.default(defaultResult2, module_3974.default(defaultResult2)), obj), obj2);
        }
      } else {
