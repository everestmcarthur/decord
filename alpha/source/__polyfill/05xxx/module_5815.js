// Module ID: 5815
// Function ID: 5816
// Dependencies: [5813, 5816]

// Module 5815
import _mod5813 from "module_5813" /* 5813 */;
import swizzle from "swizzle" /* 5816 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5813")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5813");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5813")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5813)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
