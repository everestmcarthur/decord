// Module ID: 5743
// Function ID: 5744
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5744, 5745]

// Module 5743
import _modDef5744 from "module_5744" /* 5744 */;
...
const entry = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5744).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
...
let items = [
  ...
  },
  {
    ...
    value: function renderLottieView() {
      ...
      const parsePossibleSourcesResult = LottieView(5745).parsePossibleSources(source);
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(_modDef5744, { ref: self.captureRef });
        }
      }
