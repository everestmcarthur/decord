// Module ID: 5849
// Function ID: 5850
// Dependencies: [32, 19, 17, 21, 1615, 5829, 5841, 5825, 5822, 5808, 1485]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5822.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
