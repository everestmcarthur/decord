// Module ID: 5086
// Function ID: 5087
// Dependencies: [109, 19, 17, 21, 5087, 5088, 5089]
// Exports: default
...
export default function TabsScreen(arg0) {
  ...
  const result = _mod5089.parseAndroidIconToNativeProps(icon);
  const tmp5Result = _mod5089;
  const result1 = _mod5089.parseAndroidIconToNativeProps(selectedIcon);
