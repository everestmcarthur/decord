// Module ID: 5857
// Function ID: 5858
// Dependencies: [5855, 5858]

// Module 5857
import _mod5855 from "module_5855" /* 5855 */;
import swizzle from "swizzle" /* 5858 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5855")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5855");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5855")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5855)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
