// Module ID: 5891
// Function ID: 5892
// Dependencies: [32, 19, 17, 21, 1615, 5871, 5883, 5867, 5864, 5850, 1485]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5864.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
