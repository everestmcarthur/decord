...
function getCreationDate(value) {
  const stringValue = _mod5450.getStringValue(value);
...
obj2[524] = {
  ...
  repeatable: true,
  description(value) {
    const parts = _mod5450.getStringValue(value).split(":");
    let str2 = "";
    let str3 = "";
    if (parts[3]) {
      str3 = `/${tmp[3]}`;
...
obj2[662] = {
  name: "Audio Type",
  description(value) {
    let str = _mod5450.getStringValue(value);
...
obj2[663] = {
  ...
  description(value) {
    return parseInt(_mod5450.getStringValue(value), 10) + " Hz";
  }
};
obj2[664] = {
  name: "Audio Sampling Resolution",
  description(value) {
    const parsed = parseInt(_mod5450.getStringValue(value), 10);
    let str = " bits";
    if (1 === parsed) {
      str = " bit";
    }
...
obj2[713] = {
  ...
  description(value, ObjectData_Preview_File_Format) {
    ...
    if (ObjectData_Preview_File_Format["ObjectData Preview File Format"]) {
      const stringValue1 = _mod5450.getStringValue(ObjectData_Preview_File_Format["ObjectData Preview File Format"].value);
      if (obj[stringValue1]) {
        if (obj[stringValue1][stringValue]) {
          return obj[stringValue1][stringValue];
        }
      }
      const tmpResult = _mod5450;
    }
    return stringValue;
  }
};
