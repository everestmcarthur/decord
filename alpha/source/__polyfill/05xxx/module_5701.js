// Module ID: 5701
// Function ID: 5702
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5702, 5703]

// Module 5701
import _modDef5702 from "module_5702" /* 5702 */;
...
const entry = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5702).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
...
let items = [
  ...
  },
  {
    ...
    value: function renderLottieView() {
      ...
      const parsePossibleSourcesResult = LottieView(5703).parsePossibleSources(source);
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(_modDef5702, { ref: self.captureRef });
        }
      }
