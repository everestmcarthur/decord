...
export const isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && _mod5355.isAvifStringIncluded(fileChunk);
};
...
export const isHEIC = function isHEIC(fileChunk) {
  fileChunk = _mod5355.getFileChunk(fileChunk);
  const FileTypes = _mod5356.FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && _mod5355.isHeicSignatureIncluded(fileChunk);
};
