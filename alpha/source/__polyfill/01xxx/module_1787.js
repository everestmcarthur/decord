// Module ID: 1787
// Function ID: 1788
// Dependencies: [19, 17, 1640, 1788, 1783, 1737, 1648, 1789, 1709, 1681, 1735]
      ...
      if (typeof value === "object") {
        if (null !== value) {
          if (undefined !== value.value) {
            ...
            const reanimatedError = new _mod1648.ReanimatedError("Invalid value passed to `" + nextResult + "`, maybe you forgot to use `.value`?");
  ...
  if (flag5) {
    frame = function frame(timestamp) {
      ...
      if (isAnimationCancelled.isAnimationCancelled) {
        ...
        _mod1737.updateProps(closure_0, obj);
        if (flag3) {
    ...
    if (flag4) {
      require("module_1737").updateProps(shareableViewDescriptors, obj2);
      const obj8 = require("module_1737");
    }
  } else {
    c8.isAnimationCancelled = true;
    c8.animations = [];
    let shallowEqualResult = require("module_1783").shallowEqual(last, obj);
    if (shallowEqualResult) {
      shallowEqualResult = !arg5;
    }
    if (!shallowEqualResult) {
      tmp19(1737).updateProps(shareableViewDescriptors, obj, flag);
      const tmp19Result = tmp19(1737);
    }
    const obj6 = require("module_1783");
    tmp19 = _require;
  }
  c8.last = obj;
}
styleUpdater.__closure = { SHOULD_BE_USE_WEB: module_1640, processBoxShadow: o.processBoxShadow, isAnimated: _mod1783.isAnimated, prepareAnimation, runAnimations, updateProps: _mod1737.updateProps, shallowEqual: _mod1783.shallowEqual };
...
let obj = { SHOULD_BE_USE_WEB: module_1640, processBoxShadow: o.processBoxShadow, isAnimated: _mod1783.isAnimated, prepareAnimation, runAnimations, updateProps: _mod1737.updateProps, shallowEqual: _mod1783.shallowEqual };
jestStyleUpdater.__closure = { isAnimated: _mod1783.isAnimated, prepareAnimation, runAnimations, updatePropsJestWrapper: _mod1737.updatePropsJestWrapper, shallowEqual: _mod1783.shallowEqual };
...
export const useAnimatedStyle = function useAnimatedStyle(fn, items, arg2, arg3) {
  ...
  if (arg2) {
    workletsHash = require("module_1783").buildWorkletsHash(items1);
    let obj2 = require("module_1783");
  }
  sharedValue = require("module_1789").useSharedValue(true);
