// Module ID: 8569
// Function ID: 8570
// Dependencies: [19, 17, 21, 113, 8570, 39, 38, 8572, 8573]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8572").container, require("module_8572").webView, style];
  const items4 = [require("module_8572").container, containerStyle];
