// Module ID: 8798
// Function ID: 8799
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8740, 8799, 8742, 8751]
...
_inherits(SvgImage, _modDef8751);
const entry = {
  key: "render",
  value: function render() {
    ...
    const size = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: SvgImage(8740).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
    [tmp2, tmp3] = parts;
    const tmp6 = SvgImage(8740).meetOrSliceTypes[tmp3] || 0;
    size.align = SvgImage(8740).alignEnum[tmp2] || "xMidYMid";
    ...
    const tmp7 = SvgImage(8740).alignEnum[tmp2] || "xMidYMid";
    const merged = Object.assign(SvgImage(8742).withoutXY(this, props));
