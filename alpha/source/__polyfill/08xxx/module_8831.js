// Module ID: 8831
// Function ID: 8832
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8743, 8832, 8742, 8751]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8743).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8742).withoutXY(this, props));
