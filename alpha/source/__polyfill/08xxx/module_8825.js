// Module ID: 8825
// Function ID: 8826
// Dependencies: [41, 42, 93, 95, 98, 19, 8826, 21, 8735, 8742, 8743, 8749, 8828, 8751]
...
import extractFontDefault from "extractFont" /* 8749 */;
...
_isNativeReflectConstruct = fn(8826);
const jsx = fn(21).jsx;
class Text {
  constructor() {
    self = this;
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const propsAndStylesResult = Text(8742).propsAndStyles(matrix);
      const obj = Text(8742);
      const merged = Object.assign(propsAndStylesResult, Text(8743).pickNotNil(extractFontDefault(propsAndStylesResult, true)));
      if (closure_0.root) {
...
_inherits(Text, _modDef8751);
const entry = {
  key: "render",
  value: function render() {
    const propsAndStylesResult = Text(8742).propsAndStyles(this.props);
    const obj2 = {};
    const obj = Text(8742);
