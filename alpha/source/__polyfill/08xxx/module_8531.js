// Module ID: 8531
// Function ID: 8532
// Dependencies: [19, 17, 21, 113, 8532, 39, 38, 8534, 8535]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8534").container, require("module_8534").webView, style];
  const items4 = [require("module_8534").container, containerStyle];
