// Module ID: 8813
// Function ID: 8814
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8735, 8805, 8814, 8740, 8751]
...
const entry = {
  ...
  value: function render() {
    ...
    const tmp3Result = Pattern(8735)(patternTransform);
    ...
    if (patternContentUnits) {
      num2 = tmp(8805)[patternContentUnits];
    }
    ...
    const tmp3 = Pattern(8735);
    const merged = Object.assign(size);
    const merged1 = Object.assign(tmp(8740)({ viewBox, preserveAspectRatio }));
    obj.children = children;
    return jsx(Pattern(8814), {
      ref(arg0) {
        return self.refMethod(arg0);
      }
    });
