// Module ID: 8731
// Function ID: 8732
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8732, 8733, 8734, 8735, 8739, 8740, 8741, 8751]

// Module 8731
import extractOpacityDefault from "extractOpacity" /* 8733 */;
import extractResponderDefault from "extractResponder" /* 8734 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8732).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8732).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8751);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8735).extractTransformSvgView(tmp);
      const obj3 = Svg(8735);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8740)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8741, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8739, {});
  }
};
let items = [entry];
