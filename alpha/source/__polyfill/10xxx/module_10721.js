// Module ID: 10721
// Function ID: 10722
// Dependencies: [41, 42, 93, 95, 98, 10690, 10693, 10694, 10698]
...
const regExp = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10690.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10690.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = ENTimeUnitCasualRelativeFormatParser(10690).parseDuration(arg1[2]);
