// Module ID: 10873
// Function ID: 10874
// Dependencies: [41, 42, 93, 95, 98, 10691, 10860, 10718, 10698]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:il\\s*?)?(?:(questa|l'ultima|scorsa|prossima)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10860.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(questa|l'ultima|scorsa|prossima)\\s*settimana)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ITWeekdayParser(10718).createParsingComponentsAtWeekday(reference.reference, ITWeekdayParser(10860).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
