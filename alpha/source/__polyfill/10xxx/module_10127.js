// Module ID: 10127
// Function ID: 10128
// Dependencies: [10128, 10129, 10123]

// Module 10127
import _mod10123 from "module_10123" /* 10123 */;
import QRPolynomial from "QRPolynomial" /* 10128 */;
import array2 from "array2" /* 10129 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod10123.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(10123).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(10123).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(10123).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod10123.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(10123).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(10123).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(10123).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod10123.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(10123).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(10123).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(10123).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
