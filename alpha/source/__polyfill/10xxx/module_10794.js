// Module ID: 10794
// Function ID: 10795
// Dependencies: [41, 42, 93, 95, 98, 10691, 10785, 10694, 10698]
...
const regExp = new RegExp("(dit|deze|(?:aan)?komend|volgend|afgelopen|vorig)e?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10785.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLRelativeDateFormatParser(10785).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp2(10694).ParsingComponents;
