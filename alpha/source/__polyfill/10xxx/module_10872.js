// Module ID: 10872
// Function ID: 10873
// Dependencies: [41, 42, 93, 95, 98, 10685, 10697, 10698]
  ...
  entry,
  {
    ...
    value: function innerExtract(refDate, arg1) {
      ...
      if ("pomeriggio" === formatted) {
        parsingComponents.imply("meridiem", ITCasualTimeParser(10685).Meridiem.PM);
        ...
        if ("sera" !== formatted) {
          if ("notte" !== formatted) {
            if ("mezzanotte" === formatted) {
              ...
              ITCasualTimeParser(10697).assignSimilarDate(parsingComponents, date);
              ITCasualTimeParser(10697).implySimilarTime(parsingComponents, date);
              parsingComponents.imply("hour", 0);
              parsingComponents.imply("minute", 0);
              parsingComponents.imply("second", 0);
            } else if ("mattina" === formatted) {
              parsingComponents.imply("meridiem", ITCasualTimeParser(10685).Meridiem.AM);
