// Module ID: 10743
// Function ID: 10744
// Dependencies: [41, 42, 93, 95, 98, 10691, 10737, 10692, 10698]
...
const regExp = new RegExp("(?:am\\s*?)?(?:den\\s*?)?([0-9]{1,2})\\.(?:\\s*(?:bis(?:\\s*(?:am|zum))?|\\-|\\\u2013|\\s)\\s*([0-9]{1,2})\\.?)?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10737.MONTH_DICTIONARY) + ")(?:(?:-|/|,?\\s*)(" + _mod10737.YEAR_PATTERN + "(?![^\\s]\\d)))?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      const tmp4 = DEMonthNameLittleEndianParser(10737).MONTH_DICTIONARY[index[3].toLowerCase(index[3])];
