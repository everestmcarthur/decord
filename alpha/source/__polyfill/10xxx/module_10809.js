...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return "(" + RUTimeUnitAgoFormatParser(10804).TIME_UNITS_PATTERN + ")\\s{0,5}\u043D\u0430\u0437\u0430\u0434(?=(?:\\W|$))";
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ParsingComponents.createRelativeFromReference(reference.reference, RUTimeUnitAgoFormatParser(10677).reverseDuration(RUTimeUnitAgoFormatParser(10804).parseDuration(arg1[1])));
    }
  }
];
