// Module ID: 10669
// Function ID: 10670
// Dependencies: [10670, 10671, 10678, 10680, 10718, 10730, 10743, 10754, 10763, 10781, 10802, 10817, 10827, 10842, 10861]

// Module 10669
import Chrono from "Chrono" /* 10670 */;
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_10671").ParsingContext;
          }
    };
    ...
    exports.de = fn(_mod10718);
    exports.fr = fn(_mod10730);
    exports.ja = fn(_mod10743);
    exports.pt = fn(_mod10754);
    exports.nl = fn(_mod10763);
    exports.zh = fn(_mod10781);
    exports.ru = fn(_mod10802);
    exports.es = fn(_mod10817);
    exports.uk = fn(_mod10827);
    exports.it = fn(_mod10842);
    exports.sv = fn(_mod10861);
