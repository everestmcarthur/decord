// Module ID: 10877
// Function ID: 10878
// Dependencies: [10687, 10694, 10696, 10720, 10732, 10878, 10880, 10881, 10882, 10727]
...
fn(_mod10880);
fn(_mod10881);
const _isNativeReflectConstruct = fn(_mod10882);
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("module_10687").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
