// Module ID: 10748
// Function ID: 10749
// Dependencies: [41, 42, 10745, 10702]
...
const items = [
  entry,
  {
    ...
    value: function extract(reference, groups) {
      const tmp3 = JPWeekdayParser(10745).WEEKDAY_OFFSET[groups.groups.weekday];
      if (undefined === tmp3) {
        return null;
      } else {
        let str2 = "last";
        ...
        return tmp(10702).createParsingComponentsAtWeekday(reference.reference, tmp3, str2);
      }
      tmp = JPWeekdayParser;
    }
  }
