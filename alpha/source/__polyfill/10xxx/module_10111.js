// Module ID: 10111
// Function ID: 10112
// Dependencies: [10112, 10114, 10116, 10117, 10118]

// Module 10111
import QR8bitByte from "QR8bitByte" /* 10112 */;
import QRRSBlock from "QRRSBlock" /* 10114 */;
import QRBitBuffer from "QRBitBuffer" /* 10116 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10117.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10117.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10117.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
