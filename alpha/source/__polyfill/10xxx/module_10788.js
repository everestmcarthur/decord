// Module ID: 10788
// Function ID: 10789
// Dependencies: [41, 42, 93, 95, 98, 10691, 10785, 10692, 10698]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10785.MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + _mod10785.YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLMonthNameParser(10785).MONTH_DICTIONARY[arg1[1].toLowerCase(arg1[1])];
      parsingComponents.assign("month", tmp4);
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10785).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10692).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
