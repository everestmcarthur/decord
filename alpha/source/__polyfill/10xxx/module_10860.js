// Module ID: 10860
// Function ID: 10861
// Dependencies: [41, 42, 93, 95, 98, 10844, 10677, 10678, 10694]
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, text, start) {
      const parseDurationResult = ENMergeRelativeDateRefiner(10844).parseDuration(text.text);
      ...
      return new ENMergeRelativeDateRefiner(10678).ParsingResult(start.reference, text.index, "" + text.text + arg0 + start.text, relativeFromReference);
    }
  }
];
