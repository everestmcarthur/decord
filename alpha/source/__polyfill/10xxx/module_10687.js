// Module ID: 10687
// Function ID: 10688
// Dependencies: [41, 42, 10688, 10694]

// Module 10687
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10688 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10694).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10694).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10694).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10694).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10694).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
