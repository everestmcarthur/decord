// Module ID: 10121
// Function ID: 10122
// Dependencies: [10122, 10124, 10126, 10127, 10128]

// Module 10121
import QR8bitByte from "QR8bitByte" /* 10122 */;
import QRRSBlock from "QRRSBlock" /* 10124 */;
import QRBitBuffer from "QRBitBuffer" /* 10126 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10127.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10127.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10127.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
