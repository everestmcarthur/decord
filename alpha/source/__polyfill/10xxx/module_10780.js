// Module ID: 10780
// Function ID: 10781
// Dependencies: [41, 42, 93, 95, 98, 10769, 10678, 10682]
...
const regExp = new RegExp("(" + _mod10769.TIME_UNITS_PATTERN + ")(later|na|vanaf nu|voortaan|vooruit|uit)(?=(?:\\W|$))", "i");
const regExp1 = new RegExp("(" + _mod10769.TIME_UNITS_PATTERN + ")(later|vanaf nu)(?=(?:\\W|$))", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = NLTimeUnitLaterFormatParser(10678).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, NLTimeUnitLaterFormatParser(10769).parseDuration(arg1[1]));
    }
  }
];
