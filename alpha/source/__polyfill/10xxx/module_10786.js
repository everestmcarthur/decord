// Module ID: 10786
// Function ID: 10787
// Dependencies: [41, 42, 93, 95, 98, 10691, 10785, 10718, 10698]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:op\\s*?)?(?:(deze|vorige|volgende)\\s*(?:week\\s*)?)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10785.WEEKDAY_DICTIONARY) + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return NLWeekdayParser(10718).createParsingComponentsAtWeekday(reference.reference, NLWeekdayParser(10785).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
