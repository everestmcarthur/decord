// Module ID: 10772
// Function ID: 10773
// Dependencies: [41, 42, 93, 95, 98, 10675, 10769, 10676, 10682]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10769.MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + _mod10769.YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLMonthNameParser(10769).MONTH_DICTIONARY[arg1[1].toLowerCase(arg1[1])];
      parsingComponents.assign("month", tmp4);
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10769).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10676).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
