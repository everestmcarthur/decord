// Module ID: 10718
// Function ID: 10719
// Dependencies: [10694, 10696]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10718
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10694 */;
import Meridiem from "Meridiem" /* 10696 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10696).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10696).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10696).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10696).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
