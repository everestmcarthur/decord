// Module ID: 10797
// Function ID: 10798
// Dependencies: [10687, 10694, 10696, 10729, 10798, 10800, 10801, 10802, 10803, 10804, 10805, 10807, 10808, 10809, 10810, 10811, 10812, 10813, 10814, 10727]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let obj = {
      enumerable: true,
      get() {
            return require("module_10687").Chrono;
          }
    };
    ...
    let closure_6 = fn2(_mod10729);
    let closure_7 = fn2(_mod10798);
    let closure_8 = fn2(_mod10800);
    let closure_9 = fn2(_mod10801);
    let closure_10 = fn2(_mod10802);
    let closure_11 = fn2(_mod10803);
    const fn2Result = fn2(_mod10804);
    let closure_13 = fn2(_mod10805);
    let closure_14 = fn2(_mod10807);
    let closure_15 = fn2(_mod10808);
    let closure_16 = fn2(_mod10809);
    let closure_17 = fn2(_mod10810);
    let closure_18 = fn2(_mod10811);
    let closure_19 = fn2(_mod10812);
    exports.hant = fn(_mod10813);
    exports.hans = fn(_mod10814);
    ...
    const chrono1 = new require("module_10687").Chrono(createConfiguration());
