// Module ID: 10778
// Function ID: 10779
// Dependencies: [41, 42, 93, 95, 98, 10675, 10769, 10678, 10682]
...
const regExp = new RegExp("(dit|deze|(?:aan)?komend|volgend|afgelopen|vorig)e?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10769.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLRelativeDateFormatParser(10769).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp2(10678).ParsingComponents;
