...
export const useScrollHandler = (arg0, onScroll, onScrollBeginDrag, onScrollEndDrag) => {
  ...
  if (arg0 === undefined) {
    useScrollEventsHandlersDefault = require("module_6891").useScrollEventsHandlersDefault;
  }
  _require = onScroll;
