// Module ID: 6913
// Function ID: 6914
// Dependencies: [93, 95, 98, 42, 41, 6914, 6897]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6914).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6897).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6897);
      }
      return tmp;
    }
  }
