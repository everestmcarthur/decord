// Module ID: 6915
// Function ID: 6916
// Dependencies: [19, 21, 6916, 6937, 6942, 6938, 6943, 6944, 6927, 6940, 6939, 6945, 6946]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6927(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6927(current.viewRef) });
      return () => {
