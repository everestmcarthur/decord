...
fn.__closure = { ANIMATION_CONFIGS: fn(6821).ANIMATION_CONFIGS, ANIMATION_METHOD: fn(6821).ANIMATION_METHOD, withTiming: fn(1637).withTiming, withSpring: fn(1637).withSpring };
