// Module ID: 6886
// Function ID: 6887
// Dependencies: [41, 42, 93, 95, 98, 19, 6887, 6853, 6875, 6873]
...
import PlatformConstants from "module_6887" /* 6887 */;
...
const entry = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6853).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  entry,
...
if (forceTouchAvailable) {
  ...
  const items2 = [];
  HermesBuiltin.arraySpread(items1, HermesBuiltin.arraySpread(fn(6873).baseGestureHandlerProps, 0));
  obj.allowedProps = items2;
  obj.config = {};
  importDefaultResultResult = _modDef6875(obj);
  const importDefaultResult4 = _modDef6875;
}
let flag;
if (PlatformConstants != null) {
