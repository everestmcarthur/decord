// Module ID: 13098
// Function ID: 13099
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 13038, 13053, 13035, 13099, 13063, 13066, 13067, 13039, 13092, 13050, 13100, 13061, 13044, 13075, 13094]
...
import __SENTRY_DEBUG__ from "module_13038" /* 13038 */;
...
_inherits(ServerRuntimeClient, _mod13094.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(13099).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(13099);
    return ServerRuntimeClient(13063).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(13063);
      return obj.resolvedSyncPromise(ServerRuntimeClient(13099).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(13066).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(13066);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(13092).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(13067).DEBUG_BUILD) {
        const logger = tmp2(13039).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(13100);
          ...
          if (ServerRuntimeClient(13067).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(13039).logger;
          ...
          if (ServerRuntimeClient(13067).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(13039).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(13050).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(13061)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(13044).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(13044);
        } else {
          spanToTraceContextResult = tmp(13066).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(13066);
        }
        const tmpResult4 = ServerRuntimeClient(13075);
        if (_getSpanForScopeResult) {
