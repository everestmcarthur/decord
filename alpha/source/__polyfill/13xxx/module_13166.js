// Module ID: 13166
// Function ID: 13167
// Dependencies: [13054, 13051, 13164]
// Exports: callFrameToStackFrame, watchdogTimer

// Module 13166
import stackParserFromStackParserOptions from "stackParserFromStackParserOptions" /* 13051 */;
...
export const callFrameToStackFrame = function callFrameToStackFrame(location, str, fn) {
  ...
  if (replaced) {
    filenameIsInAppResult = tmp4(13164).filenameIsInApp(replaced);
    const tmp4Result = tmp4(13164);
  }
