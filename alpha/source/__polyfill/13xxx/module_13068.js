// Module ID: 13068
// Function ID: 13069
// Dependencies: [41, 42, 13069, 13055, 13066, 13074]
...
function withScope(arg0) {
  const mainCarrier = AsyncContextStack(13066).getMainCarrier();
  const obj = AsyncContextStack(13066);
  const sentryCarrier = AsyncContextStack(13066).getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = tmp(13074).getDefaultCurrentScope();
    const tmpResult = tmp(13074);
    stack = new _moduleResult(defaultCurrentScope, tmp(13074).getDefaultIsolationScope());
...
function withIsolationScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = tmp(13074).getDefaultCurrentScope();
    const tmpResult = tmp(13074);
    stack = new closure_3(defaultCurrentScope, tmp(13074).getDefaultIsolationScope());
    const tmpResult2 = tmp(13074);
  }
  sentryCarrier.stack = stack;
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(13074).getDefaultCurrentScope();
      const tmp2Result = tmp2(13074);
      stack = new closure_2_3(defaultCurrentScope, tmp2(13074).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(13074);
    }
    sentryCarrier.stack = stack;
...
export function getStackAsyncContextStrategy() {
  return {
    ...
    withSetIsolationScope(arg0, arg1) {
      closure_0 = arg1;
      let mainCarrier = closure_0(13066).getMainCarrier();
      let obj = closure_0(13066);
      let sentryCarrier = closure_0(13066).getSentryCarrier(mainCarrier);
      let stack = sentryCarrier.stack;
      if (!stack) {
        let defaultCurrentScope = tmp(13074).getDefaultCurrentScope();
        const tmpResult = tmp(13074);
        stack = new closure_3(defaultCurrentScope, tmp(13074).getDefaultIsolationScope());
        const tmpResult2 = tmp(13074);
      }
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(13074).getDefaultCurrentScope();
        const tmpResult = tmp(13074);
        stack = new closure_1_3(defaultCurrentScope, tmp(13074).getDefaultIsolationScope());
        const tmpResult2 = tmp(13074);
      }
      sentryCarrier.stack = stack;
