// Module ID: 13111
// Function ID: 13112
// Dependencies: [13112, 13092, 13113, 13072, 13076, 13048, 13105]
...
export const createTransport = function createTransport(bufferSize, arg1) {
  ...
  if (arg2 === undefined) {
    ...
    promiseBuffer = require("module_13112").makePromiseBuffer(num);
    let obj = require("module_13112");
  }
  closure_3 = {};
  return {
    send(arg0) {
        ...
        return recordEnvelopeLoss.add(() => {
          ...
          if (arg0 instanceof _mod13105.SentryError) {
            ...
            if (typeof recordEnvelopeLoss === "function") {
              ...
              tmp(13092).forEachEnvelopeItem(closure_1, (arg0, arg1) => {
                if ("event" === arg1) {
                  const _Array = Array;
                  let tmp4;
                  if (Array.isArray(arg0)) {
              ...
              return tmp(13072).resolvedSyncPromise({});
            } else {
              throw new TypeError("Trying to call a non-function");
            }
          } else {
