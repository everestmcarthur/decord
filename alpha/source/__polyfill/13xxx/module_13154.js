// Module ID: 13154
// Function ID: 13155
// Dependencies: [5, 13044, 13047, 13048, 13076, 13062, 13072, 13096, 13075, 13093, 13082, 13063]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(13075).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(13093);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(13093);
        ...
        closure_0(13075).withScope((setContext) => {
