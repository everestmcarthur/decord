// Module ID: 13150
// Function ID: 13151
// Dependencies: [32, 5, 13037, 13151, 13045, 13040, 13053, 13046]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod13037;
      obj2.endTimestamp = 1000 * _mod13053.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod13037.addHandler("fetch-body-resolved", arg0);
  _mod13037.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(13045).fill(closure_0(13040).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(13037);
                    obj5.endTimestamp = 1000 * stack(13053).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(13053);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(13037);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(13053).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(13053);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(13046);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(13045).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(13045);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_13037").addHandler("fetch", arg0);
  let obj = require("module_13037");
  require("module_13037").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod13045.fill(_mod13040.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
