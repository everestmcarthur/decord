// Module ID: 13054
// Function ID: 13055
// Dependencies: [13047, 13048, 13055, 13056, 13057]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(13055).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(13055);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod13056.htmlTreeAsString(arg0);
      const tmp2Result = _mod13056;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod13057.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod13057.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod13047.DEBUG_BUILD) {
        const logger = tmp7(13048).logger;
        const _HermesInternal = HermesInternal;
