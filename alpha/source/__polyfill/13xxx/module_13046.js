// Module ID: 13046
// Function ID: 13047
// Dependencies: [13047, 13048, 13051]
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (_mod13047.DEBUG_BUILD) {
          const logger = tmp19(13048).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(13051).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(13051);
        }
      }
    }
