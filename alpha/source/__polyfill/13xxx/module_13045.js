// Module ID: 13045
// Function ID: 13046
// Dependencies: [13038, 13039, 13046, 13047, 13048]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(13046).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(13046);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod13047.htmlTreeAsString(arg0);
      const tmp2Result = _mod13047;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod13048.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod13048.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod13038.DEBUG_BUILD) {
        const logger = tmp7(13039).logger;
        const _HermesInternal = HermesInternal;
