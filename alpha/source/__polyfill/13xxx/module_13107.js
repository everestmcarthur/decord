// Module ID: 13107
// Function ID: 13108
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 13047, 13062, 13044, 13108, 13072, 13075, 13076, 13048, 13101, 13059, 13109, 13070, 13053, 13084, 13103]
...
_inherits(ServerRuntimeClient, _mod13103.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(13108).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(13108);
    return ServerRuntimeClient(13072).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(13072);
      return obj.resolvedSyncPromise(ServerRuntimeClient(13108).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(13075).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(13075);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(13101).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(13076).DEBUG_BUILD) {
        const logger = tmp2(13048).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(13109);
          ...
          if (ServerRuntimeClient(13076).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(13048).logger;
          ...
          if (ServerRuntimeClient(13076).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(13048).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(13059).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(13070)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(13053).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(13053);
        } else {
          spanToTraceContextResult = tmp(13075).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(13075);
        }
        const tmpResult4 = ServerRuntimeClient(13084);
        if (_getSpanForScopeResult) {
