// Module ID: 13079
// Function ID: 13080
// Dependencies: [718, 13075, 13080, 13081, 13053, 13062, 13070, 13063, 13048, 13065, 13076, 13082]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod13065.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod13062.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod13065.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
