// Module ID: 7011
// Function ID: 7012
// Dependencies: [32, 109, 19, 17, 21, 6897, 6993, 6994, 6995, 6996, 7012, 6990, 6915, 6988]
// Exports: default

// Module 7011
import tagMessage2 from "tagMessage" /* 6897 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6993 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6996 */;
import GestureObjects2 from "GestureObjects" /* 7012 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6993).gestureToPressableEvent(arg0));
        let obj = hitSlop(6993);
      }
    };
