// Module ID: 7099
// Function ID: 7100
// Dependencies: [17, 19, 21, 7067, 7100, 7101, 7102]
...
import _mod7101 from "module_7101" /* 7101 */;
import CompatScroller from "CompatScroller" /* 7102 */;
...
export const useSecondaryProps = function useSecondaryProps(ListHeaderComponent) {
  ...
  let tmp7 = ListEmptyComponentStyle(() => {
    ...
    if (ListHeaderComponent) {
      ...
      obj.style = items;
      obj.children = _mod7101.getValidComponent(tmp);
  ...
  let obj2 = {
    ...
    renderEmpty: ListEmptyComponentStyle(() => {
      if (ListEmptyComponent) {
        const validComponent = _mod7101.getValidComponent(tmp);
  ...
  obj2.renderStickyHeaderBackdrop = ListEmptyComponentStyle(() => {
    ...
    if (backdropComponent) {
      ...
      obj.children = _mod7101.getValidComponent(backdropComponent1);
