// Module ID: 17680
// Function ID: 17681
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8727, 10130]
...
import emptyFunction_mod from "module_10130" /* 10130 */;
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = tmp23(tmp24(8727).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = tmp23(tmp24(8727).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(8727).G, obj3);
      const items1 = [timestampProducer(CircularProgress(8727).Svg, size2), ];
