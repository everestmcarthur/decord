  ...
  if (!tmp2Result.isDOMError(error)) {
    if (!tmp2Result16.isDOMException(error)) {
      if (tmp2Result17.isError(error)) {
          ...
          if (!tmp2Result19.isEvent(error)) {
            ...
            if (arg3) {
              if (arg2) {
                ...
                const result = tmp2(682).addExceptionMechanism(obj6, { synthetic: true });
                const tmp2Result20 = tmp2(682);
              }
            }
            ...
            tmp2Result21 = tmp2(682);
            const _HermesInternal = HermesInternal;
            const result1 = tmp2(682).addExceptionTypeValue(obj6, "" + error, undefined);
            const tmp2Result22 = tmp2(682);
            const result2 = tmp2(682).addExceptionMechanism(obj6, { synthetic: true });
            const tmp2Result23 = tmp2(682);
          }
          tmp2Result19 = tmp2(682);
        }
        tmp2Result18 = tmp2(682);
        ...
        const tmp2Result24 = tmp2(682);
        obj11.__serialized__ = tmp2(682).normalizeToSize(error, normalizeDepth);
  ...
  if ("stack" in error) {
    ...
    if (arg3) {
      if (arg2) {
        ...
        const result4 = tmp2(682).addExceptionMechanism(obj19, { synthetic: true });
        const tmp2Result28 = tmp2(682);
      }
    }
    ...
    tmp2Result29 = tmp2(682);
    const result5 = tmp2(682).addExceptionTypeValue(obj19, combined1);
    const tmp2Result30 = tmp2(682);
  }
  if ("code" in error) {
    const obj25 = {};
