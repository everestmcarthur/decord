// Module ID: 741
// Function ID: 742
// Dependencies: [32, 5, 41, 42, 742, 743, 702, 688, 689, 740, 745, 750, 695, 692, 710, 752, 728, 729, 723, 735, 713, 722, 753, 701, 696, 738, 754, 755, 724, 684, 711]
...
const entry = {
  ...
  value: function captureException(arg0, arg1, arg2) {
    ...
    dependencyMap = arg0;
    closure_2 = arg2;
    const uuid4Result = closure_0(695).uuid4();
    const obj = closure_0(695);
...
items[15] = {
  ...
  value: function sendEvent(arg0) {
    ...
    let eventEnvelope = closure_0(728).createEventEnvelope(arg0, self._dsn, self._options._metadata, self._options.tunnel);
...
items[22] = {
  ...
  value: function _updateSessionFromEvent(status, level) {
    ...
    if (tmp8) {
      ...
      const self = this;
      obj3.errors = errors;
      closure_0(710).updateSession(status, obj3);
      this.captureSession(status);
      const obj = closure_0(710);
    }
  }
};
...
items[25] = {
  ...
  value: function _prepareEvent(type, integrations, arg2, setLastEventId) {
    ...
    return closure_0(735).prepareEvent(options, type, integrations, arg2, self, setLastEventId).then((contexts) => {
      if (null === contexts) {
        return contexts;
      } else {
...
items[27] = {
  ...
  value: function _processEvent(type, arg1, arg2, arg3) {
    ...
    if (undefined !== sampleRate) {
      const parseSampleRateResult = str2(701).parseSampleRate(sampleRate);
      let obj = str2(701);
    }
    if (undefined === type.type) {
      if (typeof parseSampleRateResult === "number") {
        if (obj4.safeMathRandom() > parseSampleRateResult) {
          ...
          obj2[closure_7] = true;
          return tmp9(738).rejectedSyncPromise(obj2);
        }
        obj4 = str2(696);
        tmp9 = str2;
      }
  ...
  value: function _flushOutcomes() {
    ...
    if (0 !== _clearOutcomesResult.length) {
      ...
      if (self._dsn) {
        ...
        if (tunnel) {
          tunnel = tmp(702).dsnToString(self._dsn);
          const tmpResult2 = tmp(702);
        }
        self.sendEnvelope(tmp(754).createClientReportEnvelope(_clearOutcomesResult, tunnel));
        const tmpResult = tmp(754);
      } else if (DEBUG_BUILD) {
