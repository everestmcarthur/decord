...
class AnimatedSubtraction {
  constructor(arg0, arg1, arg2) {
    self = this;
    tmp = c2(this, AnimatedSubtraction);
    items = [];
...
_inherits(AnimatedSubtraction, _modDef366);
const entry = {
  key: "__makeNative",
  value: function __makeNative(arg0) {
    ...
    const self = this;
    let fn = hasOwnProperty(_getPrototypeOf(AnimatedSubtraction.prototype), "__makeNative", this);
...
let items = [
  ...
  },
  {
    ...
    value: function __attach() {
      ...
      _b.__addChild(this);
      const self = this;
      let fn = hasOwnProperty(_getPrototypeOf(AnimatedSubtraction.prototype), "__attach", this);
      if (typeof fn === "function") {
        fn = (items) => fn.apply(self, items);
      }
      fn([]);
  ...
  },
  {
    ...
    value: function __detach() {
      ...
      const self = this;
      let fn = hasOwnProperty(_getPrototypeOf(AnimatedSubtraction.prototype), "__detach", this);
      if (typeof fn === "function") {
        fn = (items) => fn.apply(self, items);
      }
      fn([]);
...
export default _createClass(AnimatedSubtraction, items);
