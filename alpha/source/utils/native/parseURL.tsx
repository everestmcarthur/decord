...
// Function ID: 4737
// Name: parseURL
// Dependencies: [32, 1074, 1076, 4737, 4738, 1472, 1929, 1368, 4739, 4744, 13236, 4994, 14111, 1366, 4910, 9328, 7646, 1609, 1364, 9979, 1241, 1254, 14112, 2]
// Exports: default
...
export default function parseURL(arg0) {
  ...
  if (null == sanitizeUrlResult) {
    ...
    if (findGiftCodesResult.length > 0) {
      ...
      const result = tmp5(14111).findRemoteAuthFingerprint(host, pathname);
      if (null != result) {
        if (result.length > 0) {
          ...
          if (null != tryParseChannelPathResult) {
            ...
            if (null != pathname.match(re27)) {
              ...
              if (null != pathname.match(re16)) {
                ...
                const result1 = tmp5(9328).parseOAuth2AuthorizeProps(str6);
                if (null != result1) {
                  ...
                  if (match5.length > 1) {
                    ...
                    switch (match5[1]) {
                      ...
                      case "mobile-web-redirect-checkout":
                        let result2 = tmp5(7646).isMobileWebRedirectCheckoutEnabled();
                        if (result2) {
