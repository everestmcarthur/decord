...
// Dependencies: [5, 3, 4953, 5340, 4343, 2]
// Exports: convertFileToJpeg

// Module 5436 (imageConversion)
...
export const renameToJpegExtension = fn(5340).renameToJpegExtension;
