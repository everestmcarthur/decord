...
// Dependencies: [5, 3, 4986, 5383, 4377, 2]
// Exports: convertFileToJpeg

// Module 5478 (imageConversion)
...
export const renameToJpegExtension = fn(5383).renameToJpegExtension;
