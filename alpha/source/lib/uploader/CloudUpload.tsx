...
// Function ID: 5339
// Name: CloudUpload
// Dependencies: [109, 5, 32, 4755, 1184, 4805, 1074, 3, 1271, 5339, 5347, 1091, 559, 5381, 12, 1462, 5349, 5383, 5384, 5385, 5368, 5386, 5387, 5391, 1231, 5348, 5340, 5392, 5393, 1980, 5478, 1241, 2]
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            const uploadTarget = v3(5387).getUploadTarget(tmp17.item.target);
            dependencyMap = 1;
