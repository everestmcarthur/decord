...
// Function ID: 5297
// Name: CloudUpload
// Dependencies: [109, 5, 32, 4721, 1184, 4771, 1074, 3, 1271, 5297, 5305, 1091, 559, 5338, 12, 1462, 5307, 5340, 5341, 5342, 5326, 5343, 5344, 5348, 5349, 1231, 5306, 5298, 5350, 5351, 1897, 5436, 1241, 2]
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            const uploadTarget = v3(5344).getUploadTarget(tmp17.item.target);
            dependencyMap = 1;
