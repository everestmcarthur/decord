...
// Dependencies: [5, 8864, 1958, 1074, 573, 4580, 7967, 1271, 7519, 2]
...
// Module 8863 (ChannelSettingsActionCreators)
    ...
    try {
      ...
      if (0 === c4) {
        ...
        request = then((arg0) => {
          ...
          if (!tmp5) {
            const result = closure_1(7519).checkGuildTemplateDirty(guildId);
            const tmpResult = closure_1(7519);
          }
          return arg0;
        }, (body) => {
