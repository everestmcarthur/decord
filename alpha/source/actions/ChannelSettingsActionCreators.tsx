...
// Dependencies: [5, 8903, 2041, 1074, 573, 4614, 8005, 1271, 7563, 2]
...
// Module 8902 (ChannelSettingsActionCreators)
    ...
    try {
      ...
      if (0 === c4) {
        ...
        request = then((arg0) => {
          ...
          if (!tmp5) {
            const result = closure_1(7563).checkGuildTemplateDirty(guildId);
            const tmpResult = closure_1(7563);
          }
          return arg0;
        }, (body) => {
