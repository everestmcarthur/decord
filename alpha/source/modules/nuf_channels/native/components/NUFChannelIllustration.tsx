...
// Dependencies: [32, 19, 17, 21, 4722, 576, 1115, 13979, 13980, 4458, 4723, 13981, 13982, 13983, 13984, 5777, 5249, 4718, 2]
// Exports: default

// Module 13978 (NUFChannelIllustration)
...
export default function NUFChannelIllustration() {
  ...
  obj14.children = closure_7(first(4458).View, {
    style: animatedStyle,
