...
// Function ID: 17830
// Name: NewTermsModal
// Dependencies: [5, 32, 19, 17, 1952, 1074, 21, 4722, 576, 7390, 1115, 6785, 1612, 5800, 5139, 8411, 9008, 1249, 4718, 5144, 9288, 10045, 2]
// Exports: default

// Module 17829 (NewTermsModal)
...
export default function NewTermsModal() {
  ...
  memo(5800).useNavigatorBackPressHandler(memo(5139).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [closure_12(tmp6(4718).Text, obj6), , , , , , ];
    ...
    items2[1] = closure_12(tmp6(4718).Text, obj7);
    ...
    items2[2] = closure_12(tmp6(4718).Text, obj9);
    ...
    items2[3] = closure_12(tmp6(4718).Text, obj11);
    ...
    items2[4] = closure_12(tmp6(4718).Text, obj13);
    ...
    items2[5] = closure_12(tmp6(4718).Text, obj15);
    ...
    items2[6] = closure_12(tmp6(4718).Text, obj17);
    ...
    obj18.children = closure_12(tmp6(5144).Button, obj19);
    ...
    items3[2] = closure_12(tmp2(9288), obj20);
    obj3.children = items3;
    tmp10 = closure_13(closure_6, obj3);
    const tmp2Result = tmp2(9288);
  }
  return tmp10;
};
