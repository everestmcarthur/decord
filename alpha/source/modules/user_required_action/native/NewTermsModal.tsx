...
export default function NewTermsModal() {
  ...
  if (null != memo) {
    ...
    const items2 = [closure_12(tmp6(4752).Text, obj6), , , , , , ];
    ...
    items2[1] = closure_12(tmp6(4752).Text, obj7);
    ...
    items2[2] = closure_12(tmp6(4752).Text, obj9);
    ...
    items2[3] = closure_12(tmp6(4752).Text, obj11);
    ...
    items2[4] = closure_12(tmp6(4752).Text, obj13);
    ...
    items2[5] = closure_12(tmp6(4752).Text, obj15);
    ...
    items2[6] = closure_12(tmp6(4752).Text, obj17);
    ...
    obj18.children = closure_12(tmp6(5186).Button, obj19);
