...
// Dependencies: [4372, 502, 1958, 4943, 4737, 4371, 4543, 4903, 1372, 1074, 510, 4945, 4933, 4960, 12, 4751, 7466, 7834, 504, 573, 2]
        ...
        if (!tmp2(7834)(message, id)) {
          ...
          if (tmp2(4960)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(4960)(obj3);
              const tmp2Result = tmp2(4960);
            }
            tmp20 = tmp12;
            if (tmp2ResultResult) {
              c26 = false;
