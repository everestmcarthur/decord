...
// Dependencies: [5, 32, 19, 17, 4447, 7914, 2041, 5105, 12211, 12212, 1074, 4749, 4965, 21, 4756, 576, 8230, 4613, 4963, 12507, 4492, 11776, 1478, 12126, 5338, 5339, 7696, 9422, 11918, 1110, 4454, 1115, 10345, 4614, 5350, 4453, 9846, 6892, 12509, 12490, 10261, 2]

// Module 12506 (VoiceMessageButton)
...
import isChannelFocused from "isChannelFocused" /* 10345 */;
import VoiceMessageUtils from "VoiceMessageUtils" /* 12507 */;
...
const VoiceMessagesUIStore = fn(12211);
...
const VoiceMessageConstants = fn(12212);
...
export default noop.memo((disabled) => {
  ...
  const tmp9 = sharedValue1(11776)();
  _require = sharedValue(function*(arg0) {
    closure_129_2 = yield closure_0(12507).endAudioRecording();
    const data = closure_129_2.data;
    const startTimeMillis = closure_129_2.startTimeMillis;
    closure_1_6(false);
    if (closure_129_0) {
      closure_1_9.current = closure_129_1;
      let result = closure_0(12507).emitVoiceMessageRecorded(closure_129_1, data.durationSecs, startTimeMillis);
    }
    if (data.durationSecs < closure_2_20 / 1000) {
      const result1 = closure_0(12507).emitVoiceMessageRecorded(closure_0(12126).VoiceMessageRecordingResult.CANCELLED_DURATION, data.durationSecs, startTimeMillis);
      __initData();
    }
    const result2 = closure_0(12507).emitVoiceMessageRecorded(closure_0(12126).VoiceMessageRecordingResult.SENT, data.durationSecs, startTimeMillis);
    const channel = callback.getChannel(closure_1);
    if (null != channel) {
      const cloudUpload = new closure_0(5338).CloudUpload({ uri: data.filename, originalUri: data.filename, mimeType: "audio/ogg", filename: "voice-message.ogg", platform: closure_0(5339).UploadPlatform.REACT_NATIVE, durationSecs: data.durationSecs, waveform: data.waveform }, channel.id);
      const items = [cloudUpload];
      closure_129_6 = items;
      const pendingReply2 = pendingReply.getPendingReply(closure_1);
      const sendMessageOptionsForReply = sharedValue1(7696).getSendMessageOptionsForReply(pendingReply2);
      { uri: data.filename, originalUri: data.filename, mimeType: "audio/ogg", filename: "voice-message.ogg", platform: closure_0(5339).UploadPlatform.REACT_NATIVE, durationSecs: data.durationSecs, waveform: data.waveform };
      const id = channel.id;
      ...
      sharedValue1(7696).sendMessage(id, { content: "", tts: false, invalidEmojis: [], validNonShortcutEmojis: [] }, undefined, obj17);
      sharedValue1(7696);
      closure_0(11918).deletePendingReply(closure_1);
      closure_0(11918);
      sharedValue1(7696);
    }
    ...
    if (cancelReason === undefined) {
      cancelReason = closure_0(12126).VoiceMessageRecordingResult.CANCELLED_USER_REQUESTED;
    }
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              c3 = 1;
              const obj5 = { value: cancel(12507).endAudioRecording(), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            closure_128_0 = value;
            const result = cancel(12507).emitVoiceMessageRecorded(cancel(12126).VoiceMessageRecordingResult.CANCELLED_GESTURE_CONFLICT, closure_128_0.data.durationSecs, closure_128_0.startTimeMillis);
            const obj = cancel(12507);
          }
          c3 = 3;
  ...
  let obj6 = { ref: sharedValue1(12509)().tooltipTargetRef, IconComponent: null, active: false, accessibilityLabel: null, accessibilityActions: null, onAccessibilityAction: null, disabled: null };
  ...
  obj5.children = jsx(sharedValue1(12490), { ref: sharedValue1(12509)().tooltipTargetRef, IconComponent: null, active: false, accessibilityLabel: null, accessibilityActions: null, onAccessibilityAction: null, disabled: null });
