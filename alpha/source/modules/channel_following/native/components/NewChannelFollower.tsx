...
// Dependencies: [32, 19, 17, 1962, 1958, 2013, 1980, 4361, 5608, 1074, 21, 4722, 576, 8400, 4656, 504, 4875, 5161, 4573, 11579, 11580, 7346, 6820, 5754, 1177, 5197, 4718, 1115, 5142, 5857, 5775, 4689, 9664, 1897, 11581, 8831, 5603, 5144, 11584, 7350, 2]
// Exports: default

// Module 11578 (NewChannelFollower)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1897 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4689 */;
import openChannelPickerDefault from "openChannelPicker" /* 11581 */;
import ChannelFollowerActionCreatorsDefault from "ChannelFollowerActionCreators" /* 11584 */;
...
export default function NewChannelFollower(targetChannelId) {
  ...
  obj15.onPress = function onPress() {
    ...
    obj.openLazy(asyncRequireImpl(9664, dependencyMap.paths), "NewChannelFollowerGuildPicker", obj2);
  };
