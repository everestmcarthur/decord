...
// Dependencies: [2109, 1372, 12735, 4646, 1074, 573, 12736, 4997, 1271, 12738, 4667, 1241, 12739, 12737, 2]
...
// Module 12734 (GameServerActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import HTTPUtils from "HTTPUtils" /* 1271 */;
import gameServerResponseToInstanceDefault from "gameServerResponseToInstance" /* 4667 */;
import StoreUtils from "StoreUtils" /* 4997 */;
import GameServerMocks from "GameServerMocks" /* 12736 */;
import GameServerStatus from "GameServerStatus" /* 12737 */;
import regionResponseToRegionDefault from "regionResponseToRegion" /* 12739 */;
import LocaleStore from "LocaleStore" /* 2109 */;
import UserStore from "UserStore" /* 1372 */;
import OwnedGameServersStore from "OwnedGameServersStore" /* 12735 */;

const require = globalThis.__r;

require = fn;
const GAME_SERVER_COLLECTION_ID = fn(4646).GAME_SERVER_COLLECTION_ID;
...
export const optimisticallyMarkGameServerResizing = function optimisticallyMarkGameServerResizing(arg0) {
  ...
  if (null != found) {
    const obj2 = { type: "GAME_SERVER_UPDATE", guildId: "Array", gameServer: "DATA_COLLECTOR_REQUIRES_CREATE_OPTIONS" };
    const obj3 = {};
...
export const wakeMyGameServer = function wakeMyGameServer(arg0) {
  ...
  if (null != found) {
    let obj2 = { type: "GAME_SERVER_UPDATE", guildId: "Array", gameServer: "DATA_COLLECTOR_REQUIRES_CREATE_OPTIONS" };
    let obj3 = {};
  ...
  return HTTP.post({ url: constants.GAME_SERVER_ME_WAKE(arg0), rejectWithError: true }).then((body) => {
    body = body.body;
    let tmp3 = body;
    if (body.status === closure_0(12737).GameServerStatus.SLEEPING) {
      const obj2 = {};
      const merged = Object.assign(body);
      obj2.status = closure_0(12737).GameServerStatus.STARTING;
      tmp3 = obj2;
    }
