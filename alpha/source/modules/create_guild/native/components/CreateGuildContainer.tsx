...
// Dependencies: [5, 32, 19, 2013, 1372, 1074, 21, 4722, 5852, 5689, 5307, 12563, 5690, 1972, 10092, 7319, 12577, 2]
// Exports: default

// Module 12576 (CreateGuildContainer)
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5852).NAV_BAR_HEIGHT } };
