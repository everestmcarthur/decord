...
// Dependencies: [5, 32, 19, 2096, 1372, 1074, 21, 4756, 5894, 5731, 5349, 12572, 5732, 2055, 10102, 7363, 12586, 2]
// Exports: default

// Module 12585 (CreateGuildContainer)
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5894).NAV_BAR_HEIGHT } };
