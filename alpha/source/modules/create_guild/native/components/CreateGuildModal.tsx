...
// Dependencies: [19, 17, 2096, 7218, 1074, 21, 12726, 10081, 1241, 5732, 12959, 1249, 5836, 12961, 12963, 12585, 1115, 12964, 8105, 12966, 12967, 12978, 8145, 7240, 2]
// Exports: default

// Module 12960 (CreateGuildModal)
...
export default function CreateGuildModal(channel) {
  ...
  obj2.screens = isWindowSmall.useMemo(() => {
    ...
    let obj2 = {
      ...
      render() {
        return closure_1_10(closure_1(12961), { trigger: constants2.IN_APP });
      }
    };
    ...
    impressionProperties[constants.CREATION_INTENT] = {
      ...
      render(guildTemplate) {
        return closure_1_10(closure_1(12963), { guildTemplate: guildTemplate.guildTemplate, trigger: constants2.IN_APP });
      }
    };
    let obj4 = {
      impressionName: discord_common_AnalyticsUtils.ImpressionNames.GUILD_ADD_INTENT_SELECTION,
    ...
    impressionProperties[constants.CREATE_SERVER] = {
      ...
      render(arg0, arg1) {
        ...
        obj.onCreate = function onCreate(guild) {
          ...
          const guildProgress = closure_0(12726).createGuildProgress(id);
          defaultChannel = defaultChannel.getDefaultChannel(id);
          if (null != defaultChannel) {
            closure_1(10081).init(id, defaultChannel.id, { location: "Guild Create Flow" });
            const obj3 = { guildId: id };
            closure_0.push(constants.GUILD_INVITE, obj3);
            const obj2 = closure_1(10081);
        ...
        return closure_10(closure_1(12585), obj);
      }
    };
    const obj5 = {
      impressionName: discord_common_AnalyticsUtils.ImpressionNames.GUILD_ADD_CUSTOMIZE,
    ...
    impressionProperties[constants.GUILD_INVITE] = {
      ...
      render(guildId) {
        ...
        return closure_1_10(closure_1(12964), {
    ...
    impressionProperties[constants.JOIN_SERVER] = {
      ...
      headerTitle: isWindowSmall ? (() => {
        ...
        return closure_1_10(initialRoute(8105).GenericHeaderTitle, obj);
      }) : (() => null),
      render(arg0) {
    ...
    impressionProperties[constants.ACCEPT_INVITE] = {
      ...
      render(code) {
        const obj = { code: code.code, onPressClose: closure_1(12959).closeCreateGuildModal };
        return closure_1_10(closure_1(12967), obj);
      }
    };
    const obj9 = {
      ...
      render() {
        return closure_1_10(closure_1(12978), { isNestedNavigator: true });
      }
    };
