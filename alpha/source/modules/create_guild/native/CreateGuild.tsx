...
// Function ID: 12578
// Name: CreateGuild
// Dependencies: [19, 17, 1372, 1074, 21, 4722, 576, 5129, 5138, 5142, 4718, 1115, 12041, 6799, 7396, 5144, 7135, 2]
// Exports: default

// Module 12577 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4718).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4718).Text, obj4);
  items1[2] = closure_7(ref(12041), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6799).TextInput, obj6);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7396).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4718).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(5144).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(7135), obj11);
        const tmp12Result = ref(7135);
      }
    }
  }
  items1[7] = tmp9Result2;
  obj.children = closure_8(isScreenReaderEnabled(5142).Stack, { children: items1 });
