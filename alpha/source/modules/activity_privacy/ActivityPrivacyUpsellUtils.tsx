...
// Dependencies: [5721, 4675, 2063, 5650, 1186, 7235, 1115, 2019, 2]
...
// Module 15123 (ActivityPrivacyUpsellUtils)
  ...
  if (setting === ACTIVITY_STATUS_OFF) {
    ...
    if (num >= 0) {
      if (num2 >= 0) {
        ...
        dependencyMap = tmp8(7235).getSanitizedActivityRestrictedGuilds();
