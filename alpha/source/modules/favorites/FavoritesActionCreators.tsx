...
// Dependencies: [5, 1950, 1962, 1958, 4361, 2012, 4543, 1961, 1971, 1074, 1085, 1186, 1217, 12, 10465, 10468, 5066, 1115, 1941, 11, 10474, 10475, 1983, 1101, 10478, 10479, 10481, 2]
...
// Module 10464 (FavoritesActionCreators)
            ...
            let obj5 = {
              update(favoriteChannels) {
                          ...
                          if (obj.size(favoriteChannels) >= closure_2_13) {
                            ...
                            const favoritesAccess = tmp(10465).getFavoritesAccess();
                            const favoriteLimit = favoritesAccess.favoriteLimit;
                            tmp6 = null;
                            if (favoriteLimit > 0) {
                              tmp6 = null;
...
const resetFatigueCooldown = fn(1950).resetFatigueCooldown;
        ...
        if (!tmp2) {
          ...
          if (null == tmp8) {
            ...
            if (obj5.size(favoriteChannels) >= map1) {
              ...
              favoritesAccess = tmp18(10465).getFavoritesAccess();
              const favoriteLimit = favoritesAccess.favoriteLimit;
              tmp11 = null;
              if (favoriteLimit > 0) {
            ...
            if (null == tmp11) {
              ...
              tmp7(5066).show(obj);
              const tmp7Result2 = tmp7(5066);
            }
            str = tmp7(10468)(favoritesAccess);
            obj5 = _modDef12;
          }
        }
      }
...
export const setFavoritesGuildVisibilityFromSettings = function setFavoritesGuildVisibilityFromSettings(arg0) {
  ...
  if (!arg0) {
    isFavoritesGuildIdResult = tmp(1983).isFavoritesGuildId(SelectedGuildStore.getGuildId());
    const tmpResult = tmp(1983);
  }
  if (isFavoritesGuildIdResult) {
