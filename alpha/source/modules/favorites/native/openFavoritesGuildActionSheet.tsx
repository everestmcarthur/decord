...
// Dependencies: [4689, 16394, 1897, 2]
// Exports: default

// Module 16393 (openFavoritesGuildActionSheet)
...
export default function openFavoritesGuildActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16394, dependencyMap.paths), FavoritesGuildActionSheet, {
    onClose() {
