...
// Dependencies: [19, 17, 21, 4722, 576, 10465, 11228, 4689, 10469, 1897, 10468, 5862, 5142, 4718, 1115, 3322, 5144, 12995, 2]
// Exports: default

// Module 17123 (FavoritesEmptyState)
...
export default function FavoritesEmptyState() {
  ...
  obj4.children = intl.string(_modDef3322["wh+Rz1"]);
  ...
  obj5.children = intl2.string(_modDef3322["+SuGKb"]);
  ...
  if (obj.useFavoritesAccess("favorites_empty_state").hasAccess) {
    ...
    obj6.text = intl4.string(tmp9(3322)["6kk0gM"]);
    obj6.icon = tmp8(tmp2(12995).PlusMediumIcon, {});
    obj6.onPress = callback;
    let obj7 = obj6;
  } else {
    obj7 = { variant: "primary", text: null, onPress: null };
    const intl3 = tmp2(1115).intl;
    obj7.text = intl3.string(tmp9(3322).yYVbdv);
