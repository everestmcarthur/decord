...
// Dependencies: [38, 4723, 8951, 1980, 573, 2]

// Module 8950 (GameProfileActionCreators)
...
export default {
  openGameProfileModal(arg0) {
    ...
    obj.openLazy(asyncRequireImpl(8951, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, sourceUserId }, stackingBehavior);
  },
  returnToGameProfile(gameId) {
    ...
    obj2.openLazy(asyncRequireImpl(8951, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, initialScrollOffset });
  },
