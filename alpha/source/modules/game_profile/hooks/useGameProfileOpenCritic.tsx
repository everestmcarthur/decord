...
// Dependencies: [9003, 1115, 9004, 9005, 9006, 9007, 2]
...
export const getOpenCriticTierText = function getOpenCriticTierText(tier) {
  ...
  } else if (tmp(9003).OpenCriticTier.STRONG === tier) {
    const intl3 = tmp(1115).intl;
    return intl3.string(tmp(1115).t.MLxnSg);
  } else if (tmp(9003).OpenCriticTier.FAIR === tier) {
    const intl2 = tmp(1115).intl;
    return intl2.string(tmp(1115).t["3f19KA"]);
  } else if (tmp(9003).OpenCriticTier.WEAK === tier) {
...
export const getOpenCriticCircleRatingColor = function getOpenCriticCircleRatingColor(tier) {
  ...
  if (OpenCriticTier.OpenCriticTier.MIGHTY !== tier) {
    ...
    if (tmp(9003).OpenCriticTier.STRONG !== tier) {
      foregroundColor = "#4aa1ce";
      if (tmp(9003).OpenCriticTier.FAIR !== tier) {
        foregroundColor = "";
        if (tmp(9003).OpenCriticTier.WEAK === tier) {
