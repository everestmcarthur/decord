...
// Dependencies: [19, 17, 4762, 4371, 1074, 21, 4722, 576, 504, 4718, 1115, 16563, 4585, 4582, 2]
// Exports: default

// Module 16567 (HomeDrawerDirectMessagesRow)
...
function HomeDrawerDMsRow() {
  ...
  if (stateFromStores > 0) {
    ...
    items1[1] = React5(tmp2(4718).Text, obj4);
