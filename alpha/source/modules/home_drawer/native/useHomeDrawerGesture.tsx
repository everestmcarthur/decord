...
// Dependencies: [32, 19, 16349, 16356, 1074, 11719, 4619, 4492, 1485, 1241, 4757, 16350, 4724, 1478, 1612, 4616, 11720, 4614, 16357, 4613, 6892, 7314, 2]
// Exports: useDoesLandOnHomeDrawer, useHomeDrawerState, useHomeGesture, useIsHomeDrawerEnabled

// Module 16355 (useHomeDrawerGesture)
import ReanimatedRexport from "ReanimatedRexport" /* 4492 */;
import NavigationRouteUtils from "NavigationRouteUtils" /* 4613 */;
import HapticUtils from "HapticUtils" /* 4724 */;
import timing from "timing" /* 4757 */;
import HomeDrawerAnimations from "HomeDrawerAnimations" /* 16350 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import HomeDrawerStore from "HomeDrawerStore" /* 16349 */;
import HomeDrawerSubtitleStore from "HomeDrawerSubtitleStore" /* 16356 */;

require = fn;
const computeMaxX = fn(16349).computeMaxX;
