...
// Dependencies: [19, 17, 1074, 21, 4722, 576, 1484, 7573, 1115, 12977, 1177, 4718, 5144, 2]
// Exports: default

// Module 12976 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerLeft() {
        ...
        obj.onPress = onPress;
        return closure_2_6(onClose(7573).HeaderActionButton, obj);
      }
    });
  }, items);
  const obj2 = { style: tmp.container, children: null };
  let obj = onClose(1484);
  const items1 = [closure_6(closure_5, { source: navigation(12977), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4718).Text, obj5);
  ...
  obj6.children = closure_6(onClose(5144).Button, obj7);
