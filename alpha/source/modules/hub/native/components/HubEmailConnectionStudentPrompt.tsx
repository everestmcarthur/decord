...
// Dependencies: [19, 17, 12961, 1074, 21, 4722, 5694, 576, 1484, 12969, 1177, 1115, 7333, 12971, 1241, 12972, 2]
// Exports: default

// Module 12970 (HubEmailConnectionStudentPrompt)
...
export default function HubEmailConnectionStudentPrompt(onClose) {
  ...
  obj6.source = invite(12971);
  obj5.leading = closure_7(closure_4, obj6);
  obj5.trailing = invite(7333).Arrow;
