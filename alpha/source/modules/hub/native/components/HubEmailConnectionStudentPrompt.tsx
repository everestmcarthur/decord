...
// Dependencies: [19, 17, 12970, 1074, 21, 4756, 5736, 576, 1484, 12978, 1177, 1115, 7377, 12980, 1241, 12981, 2]
// Exports: default

// Module 12979 (HubEmailConnectionStudentPrompt)
...
export default function HubEmailConnectionStudentPrompt(onClose) {
  ...
  obj6.source = invite(12980);
  obj5.leading = closure_7(closure_4, obj6);
  obj5.trailing = invite(7377).Arrow;
