...
// Dependencies: [1980, 10076, 1074, 1941, 1385, 2]
// Exports: setHubProgressActionComplete, skipHubProgress

// Module 10075 (HubProgressActionCreators)
...
require = fn;
const HUB_PROGRESS_STEP_ORDER = fn(10076).HUB_PROGRESS_STEP_ORDER;
...
export const setHubProgressActionComplete = function setHubProgressActionComplete(guildId, JOIN_GUILD) {
  if (null != guildId) {
    ...
    if (hasItem) {
      ...
      const result = items(1941).updateUserGuildSettings(guildId, (hubProgress) => {
        let flag = false;
