...
// Dependencies: [2063, 4395, 1372, 1074, 1364, 4959, 10552, 1980, 9409, 2]
// Exports: handleNSFWGuildInvite, isNSFWInvite, shouldNSFWGateGuild

// Module 10551 (age_gate/AgeGateUtils)
...
const AgeRestrictedContentSettingsUtils = tmp(9409);
require = fn;
...
export const handleNSFWGuildInvite = function handleNSFWGuildInvite(invite) {
  if (obj.isIOS()) {
    ...
    if (!tmp10) {
      ...
      obj2.pushLazy(asyncRequireImpl(10552, tmp2.paths), obj3);
      flag2 = true;
      const tmp12 = asyncRequireImpl(10552, tmp2.paths);
    }
    return flag2;
  } else {
    return false;
