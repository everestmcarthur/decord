...
// Function ID: 10537
// Name: NsfwGateGuild
// Dependencies: [19, 17, 2022, 1372, 10537, 1074, 21, 4722, 576, 1115, 2025, 1241, 9534, 7169, 10538, 4718, 5144, 2]
// Exports: default

// Module 10536 (NsfwGateGuild)
...
const NsfwGateSource = fn(10537).NsfwGateSource;
...
export default function NsfwGateGuild(guildId) {
  ...
  const items1 = [closure_11(currentUser(7169), {}), , , , , ];
  const formatResult = intl3.format(guildId(1115).t.Z12LNW, obj);
  items1[1] = closure_11(closure_5, { source: currentUser(10538), style: tmp.image });
  items1[2] = closure_11(guildId(4718).Text, { style: tmp.header, variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: stringResult });
  items1[3] = closure_11(guildId(4718).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: stringResult1 });
  items1[4] = closure_11(guildId(4718).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: formatResult });
  ...
  items1[5] = closure_11(guildId(5144).Button, obj8);
