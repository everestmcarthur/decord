...
// Dependencies: [5, 32, 19, 17, 1952, 1372, 1099, 17636, 1074, 21, 4722, 1484, 504, 1241, 1115, 2025, 38, 16209, 4925, 4314, 16232, 7319, 4718, 17639, 5144, 2]
// Exports: default

// Module 17638 (ExistingUserAgeGate)
...
let closure_11 = fn(17636).ExistingUserAgeGateScreens;
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const diffResult = v1(4314)().diff(date, "years");
            if (diffResult < 18) {
              const obj4 = {
                source,
                onConfirm() {
