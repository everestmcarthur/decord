...
// Dependencies: [19, 17, 17513, 1372, 1074, 21, 4756, 576, 5232, 5796, 1115, 10649, 4718, 17529, 8990, 5334, 1177, 5306, 4724, 4725, 504, 4414, 10222, 1612, 6892, 4629, 8513, 2]

// Module 17531 (SoundboardSoundPickerCategories)
...
function SoundCategoryItem(style) {
  ...
  if (SoundboardTypes.SoundboardSoundGridSectionType.GUILD === type) {
    ...
    if (tmp2(5232).SoundboardSoundGridSectionType.TOP_SOUNDS === type) {
      ...
      tmp7 = closure_1_10(tmp2(8990).TrophyIcon, obj4);
      tmp6 = null;
      tmp14Result = null;
    }
  }
  ...
  if (locked) {
    ...
    obj8.children = tmp14(tmp2(5306).LockIcon, obj9);
...
const setSearchQuery = fn(17513).setSearchQuery;
