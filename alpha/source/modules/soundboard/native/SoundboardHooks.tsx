...
// Dependencies: [5, 19, 4748, 1182, 17514, 7391, 1478, 504, 4607, 2024, 7578, 2]
// Exports: useMaybeFetchSoundboardSounds, useSoundButtonStyleConfig

// Module 17522 (SoundboardHooks)
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              c1 = 1;
              c0 = 1;
              const obj5 = { value: shouldFetch(7578).maybeFetchSoundboardSounds(), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c0 = 3;
