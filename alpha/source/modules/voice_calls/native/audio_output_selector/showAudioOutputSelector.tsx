...
// Dependencies: [17, 9934, 1364, 4723, 9935, 1980, 2]
// Exports: showAudioOutputSelector

// Module 9933 (showAudioOutputSelector)
import _mod17 from "module_17" /* 17 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1980 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4723 */;
import VoicePanelHeaderConstants from "VoicePanelHeaderConstants" /* 9934 */;
...
export const showAudioOutputSelector = function showAudioOutputSelector(channelId, isConnectedToVoiceChannel) {
  if (obj.isAndroid()) {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(9935, dependencyMap.paths), closure_4, obj3);
  } else {
