...
// Dependencies: [17, 9353, 1364, 4689, 9354, 1897, 2]
// Exports: showAudioOutputSelector

// Module 9352 (showAudioOutputSelector)
import _mod17 from "module_17" /* 17 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1897 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4689 */;
import VoicePanelHeaderConstants from "VoicePanelHeaderConstants" /* 9353 */;
...
export const showAudioOutputSelector = function showAudioOutputSelector(channelId, isConnectedToVoiceChannel) {
  if (obj.isAndroid()) {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(9354, dependencyMap.paths), closure_4, obj3);
  } else {
