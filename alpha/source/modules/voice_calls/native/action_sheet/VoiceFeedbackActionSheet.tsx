...
// Dependencies: [19, 1074, 11875, 21, 1241, 1115, 2744, 11878, 16997, 17005, 16999, 4723, 17000, 1980, 4453, 2]
// Exports: default

// Module 17004 (VoiceFeedbackActionSheet)
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1980 */;
import _modDef2744 from "module_2744" /* 2744 */;
import ToastUtils from "ToastUtils" /* 4453 */;
import FeedbackUtils from "FeedbackUtils" /* 11878 */;
import FeedbackActionSheetV2Default from "FeedbackActionSheetV2" /* 16997 */;
import shouldShowLogUploadForCategory from "shouldShowLogUploadForCategory" /* 16999 */;
import trackVoiceFeedbackDefault from "trackVoiceFeedback" /* 17005 */;
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj.problemOptions = analyticsData(11878).getConnectionFeedbackOptions();
  ...
  let obj2 = analyticsData(11878);
  obj4.problemOptions = analyticsData(11878).getAudioFeedbackOptions({ isMobile: true });
  ...
  let obj5 = analyticsData(11878);
  obj7.problemOptions = analyticsData(11878).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11878);
  obj10.problemOptions = analyticsData(11878).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11878);
    ...
    if (null != rating) {
      ...
      if (null != reason) {
        if (obj3.shouldShowLogUploadForCategory(rating, category, reason)) {
          ...
          tmp20(4723).openLazy(asyncRequireImpl(17000, dependencyMap.paths), "UploadLogs", { mediaSessionId: null, rtcConnectionId: null });
          const obj7 = { mediaSessionId: null, rtcConnectionId: null };
          const tmp20Result = tmp20(4723);
        }
