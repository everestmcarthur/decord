...
// Dependencies: [19, 17, 1182, 502, 5448, 1958, 2022, 1909, 4762, 1074, 21, 4722, 576, 9716, 504, 4573, 13995, 13996, 1177, 13997, 13998, 13999, 14000, 9870, 4718, 1115, 8831, 7940, 10302, 4579, 4929, 4689, 5292, 9420, 4874, 9412, 4566, 2]

// Module 13994 (VoiceMemberUser)
...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    obj2.subLabel = closure_11(tmp3(8831).FormSubLabel, obj3);
    ...
    if (tmp10Result) {
      ...
      obj4.children = tmp10(channel(10302), obj5);
      tmp10Result = tmp10(closure_3, obj4);
      const tmp20 = channel(10302);
    }
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      closure_11(channelId(5292).PressableOpacity, obj);
    }
  }
  return tmp3;
}
...
let closure_16 = noop.memo((user) => {
  ...
  const tmp7 = channel(9716)({ userId: user.id });
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14000), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13997), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13998), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13999), style: tmp19 };
          }
          tmp20(tmp8(1177).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = tmp5(13995);
        } else {
          tmp5Result = tmp5(13996);
        }
  ...
  if (stateFromStores1) {
    ...
    items4[1] = closure_12(tmp8(4718).Text, obj17);
  ...
  obj15.label = closure_11(user(8831).FormRow.Label, obj18);
  if (localVideoAutoDisabled) {
    const obj19 = { style: tmp2.autoDisabledVideo, children: null };
    const obj20 = { source: tmp5(9870), size: tmp8(1177).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    ...
    items6[1] = tmp20(tmp8(4718).Text, obj21);
  ...
  return closure_11(user(8831).FormRow, obj15);
});
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  const obj = id(504);
  const name = id2(4874).getName(id2.guild_id, id2.id, id);
  const obj2 = id2(4874);
  const obj4 = {
    onPress() {
  ...
  const canRing = id(9412).useCanRing(id, "DisconnectedUserRow");
  ...
  obj4.label = closure_11(id(8831).FormRow.Label, obj5);
  const obj3 = id(9412);
  ...
  if (!canRing) {
    ...
    return tmp7(tmp2(8831).FormRow, obj7);
  } else {
