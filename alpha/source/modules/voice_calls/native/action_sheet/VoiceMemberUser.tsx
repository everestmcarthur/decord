...
// Dependencies: [19, 17, 1182, 502, 5490, 2041, 2105, 1992, 4796, 1074, 21, 4756, 576, 9617, 504, 4607, 14049, 14050, 1177, 14051, 14052, 14053, 14054, 9712, 4752, 1115, 8870, 7978, 10314, 4613, 4963, 4723, 5334, 10001, 4908, 9993, 4600, 2]

// Module 14048 (VoiceMemberUser)
...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    obj2.subLabel = closure_11(tmp3(8870).FormSubLabel, obj3);
    ...
    if (tmp10Result) {
      ...
      obj4.children = tmp10(channel(10314), obj5);
      tmp10Result = tmp10(closure_3, obj4);
      const tmp20 = channel(10314);
    }
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      closure_11(channelId(5334).PressableOpacity, obj);
    }
  }
  return tmp3;
}
...
let closure_16 = noop.memo((user) => {
  ...
  const tmp7 = channel(9617)({ userId: user.id });
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14054), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14051), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14052), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14053), style: tmp19 };
          }
          tmp20(tmp8(1177).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = tmp5(14049);
        } else {
          tmp5Result = tmp5(14050);
        }
  ...
  obj15.label = closure_11(user(8870).FormRow.Label, obj18);
  if (localVideoAutoDisabled) {
    const obj19 = { style: tmp2.autoDisabledVideo, children: null };
    const obj20 = { source: tmp5(9712), size: tmp8(1177).Icon.Sizes.EXTRA_SMALL, disableColor: true };
  ...
  return closure_11(user(8870).FormRow, obj15);
});
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  const canRing = id(9993).useCanRing(id, "DisconnectedUserRow");
  ...
  obj4.label = closure_11(id(8870).FormRow.Label, obj5);
  const obj3 = id(9993);
  ...
  if (!canRing) {
    ...
    return tmp7(tmp2(8870).FormRow, obj7);
  } else {
