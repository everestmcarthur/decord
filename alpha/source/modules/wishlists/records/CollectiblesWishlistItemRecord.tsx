...
// Dependencies: [7787, 7786, 1971, 7788, 7789, 5723, 9058, 1074, 1973, 2]
// Exports: isCollectiblesWishlistItemRecord

// Module 9059 (CollectiblesWishlistItemRecord)
...
let closure_3 = fn(7786).transformSKUToCollectiblesItem;
