...
// Dependencies: [19, 17, 21, 576, 4756, 4454, 9053, 4466, 8506, 4457, 9055, 1115, 1370, 9075, 5306, 2]
// Exports: default
...
export default function WishlistItemCardBase(username) {
  ...
  let tmp14Result4 = source === tmp2(9055).WishlistItemSource.WISHLIST;
  ...
  if (tmp14Result) {
    ...
    obj7.children = tmp14(tmp2(9075).CheckmarkLargeBoldIcon, obj8);
  ...
  if (tmp14Result3) {
    ...
    obj9.children = tmp14(tmp2(5306).LockIcon, obj10);
