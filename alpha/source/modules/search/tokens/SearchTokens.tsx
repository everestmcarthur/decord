...
// Function ID: 12594
// Name: SearchTokens
// Dependencies: [32, 2041, 2096, 4405, 2095, 4601, 1372, 12594, 12595, 1074, 4348, 12, 1115, 4909, 4600, 12592, 12596, 5729, 5654, 10090, 12597, 12598, 2]
...
import SearchTokensUtils from "SearchTokensUtils" /* 12596 */;
import SearchTokenStreamerModeUtils from "SearchTokenStreamerModeUtils" /* 12597 */;
...
export const isValidFilterAnswerForSubmit = function isValidFilterAnswerForSubmit(searchTokenType, trimmed) {
  if (null == closure_37[searchTokenType]) {
    ...
    if (SearchTokenTypes.ANSWER_HAS === tmp) {
      return tmp7(12596).validateForMapWithNegation("has", getHasMap(), token);
      ...
      return tmp7(12596).validateForMapWithNegation("author_type", obj, token);
