...
// Dependencies: [2041, 12591, 8120, 1074, 12611, 12592, 4936, 1255, 2019, 2]

// Module 12610 (search/tracking/Tracking)
...
require = fn;
let closure_5 = fn(8120).SEARCH_HISTORY_TO_ANALYTICS_SEARCH_HISTORY;
