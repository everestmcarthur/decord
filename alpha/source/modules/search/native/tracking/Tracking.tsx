...
// Dependencies: [1958, 12582, 8082, 1074, 12602, 12583, 4902, 1255, 1936, 2]

// Module 12601 (search/tracking/Tracking)
...
require = fn;
let closure_5 = fn(8082).SEARCH_HISTORY_TO_ANALYTICS_SEARCH_HISTORY;
