...
// Dependencies: [19, 12591, 12605, 1074, 12, 12592, 12613, 12590, 2]
// Exports: useAutoSearchMembersTab

// Module 17185 (useAutoSearchMembersTab)
...
require = fn;
let closure_5 = fn(12605).SEARCH_TEXT_INPUT_DEBOUNCE_TIME;
...
export const useAutoSearchMembersTab = function useAutoSearchMembersTab(searchContext, arg1) {
    ...
    if (!closure_1) {
      const debounceResult = _mod12.debounce((searchQueryString) => {
        if (!autocompleteVisible.isAutocompleteVisible(searchContext)) {
          const guildIdFromSearchContext = closure_0(12592).getGuildIdFromSearchContext(tmp);
          if (null != guildIdFromSearchContext) {
            ...
            obj4.threadId = tmp12;
            closure_1(12613).searchGuildMemberTab(obj4);
            const obj3 = closure_1(12613);
          }
          const obj2 = closure_0(12592);
        }
      }, closure_5);
  ...
  const effect1 = noop.useEffect(() => () => {
    const result = closure_1(12613).cleanupGuildMemberTab(searchContext);
  }, items1);
};
