...
// Dependencies: [19, 12582, 12596, 1074, 12, 12583, 12604, 12581, 2]
// Exports: useAutoSearchMembersTab

// Module 17109 (useAutoSearchMembersTab)
...
export const useAutoSearchMembersTab = function useAutoSearchMembersTab(searchContext, arg1) {
    ...
    if (!closure_1) {
      const debounceResult = _mod12.debounce((searchQueryString) => {
        if (!autocompleteVisible.isAutocompleteVisible(searchContext)) {
          const guildIdFromSearchContext = closure_0(12583).getGuildIdFromSearchContext(tmp);
          if (null != guildIdFromSearchContext) {
            ...
            obj4.threadId = tmp12;
            closure_1(12604).searchGuildMemberTab(obj4);
            const obj3 = closure_1(12604);
          }
          const obj2 = closure_0(12583);
        }
      }, closure_5);
  ...
  const effect1 = noop.useEffect(() => () => {
    const result = closure_1(12604).cleanupGuildMemberTab(searchContext);
  }, items1);
};
