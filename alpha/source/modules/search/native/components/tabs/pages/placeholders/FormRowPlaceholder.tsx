...
// Dependencies: [19, 17, 8121, 21, 4756, 576, 17105, 4492, 2]
// Exports: default

// Module 17137 (FormRowPlaceholder)
...
let obj2 = { itemContainer: { flexDirection: "row", paddingHorizontal: 16, overflow: "hidden", height: 64, paddingVertical: fn(8121).SEARCH_ROW_TAP_STATE_PADDING, alignItems: "center" }, avatar: null, innerContainer: null, upperText: null, lowerText: null };
