...
// Dependencies: [1958, 4371, 1372, 8083, 8082, 1074, 4875, 1115, 12583, 12595, 1934, 504, 573, 2]

// Module 12582 (SearchQueryStore)
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import SearchUtils from "SearchUtils" /* 12583 */;
import SearchQueryTagManagerDefault from "SearchQueryTagManager" /* 12595 */;
...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (isObfuscatedResult) {
    ...
    let channelName;
    if (null != channel) {
      channelName = obj(4875).computeChannelName(channel, UserStore, RelationshipStore);
      const obj2 = obj(4875);
    }
    if (null == channelName) {
      let items1 = [];
