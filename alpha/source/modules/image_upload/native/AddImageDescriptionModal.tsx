...
// Dependencies: [32, 19, 17, 5063, 5062, 21, 4722, 576, 504, 1478, 1484, 7177, 11399, 8067, 1115, 9545, 11491, 7281, 11174, 2]
// Exports: default

// Module 11492 (AddImageDescriptionModal)
    ...
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = channelId(stateFromStores[13]).getRenderHeaderTextButton(intl.string(channelId(stateFromStores[14]).t["R3BPH+"]), () => {
          ...
          id(9545).update(closure_1_0, closure_1_1, ChannelMessage.ChannelMessage, obj2);
          const obj = id(9545);
          id(11491).close();
        });
