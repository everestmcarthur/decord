...
// Dependencies: [19, 17, 1074, 12950, 21, 4756, 10376, 576, 1364, 1484, 1241, 1177, 5193, 16773, 5334, 16774, 14451, 4752, 1115, 7382, 2]
// Exports: ForYouSuggestedFriendShowAllRow

// Module 16778 (ForYouShowAllRow)
...
import ChannelPressableWrapper from "ChannelPressableWrapper" /* 16773 */;
import ChannelWrapper from "ChannelWrapper" /* 16774 */;
...
function ForYouShowAllRow(panelVariant) {
  ...
  items1[2] = React5(native.Icon, { style: tmp4.icon, color: tmp4.iconColor.color, source: _modDef7382, size: native.IconSizes.CUSTOM });
