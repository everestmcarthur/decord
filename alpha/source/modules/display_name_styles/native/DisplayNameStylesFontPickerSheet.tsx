...
// Dependencies: [32, 19, 17, 1085, 21, 4722, 576, 8400, 15548, 15550, 1392, 1389, 4690, 4689, 7346, 15554, 1115, 2870, 5144, 5142, 14831, 9414, 4718, 4676, 2]
// Exports: default

// Module 15553 (DisplayNameStylesFontPickerSheet)
import nativeDefault from "native" /* 576 */;
import _modDef2870 from "module_2870" /* 2870 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4689 */;
import HapticUtils from "HapticUtils" /* 4690 */;
import DisplayNameStylesSheetHeaderDefault from "DisplayNameStylesSheetHeader" /* 15554 */;
...
export default function DisplayNameStylesFontPickerSheet(displayName) {
  ...
  if (tmp15Result) {
    ...
    let items2 = [tmp11(tmp2(4676).CircleInformationIcon, { size: "sm" }), ];
    ...
    items2[1] = tmp11(tmp2(4718).Text, obj12);
