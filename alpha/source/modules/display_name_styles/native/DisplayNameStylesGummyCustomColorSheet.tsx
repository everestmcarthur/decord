...
// Dependencies: [19, 17, 1390, 21, 4722, 576, 4458, 1389, 1092, 4690, 4689, 7346, 15554, 1115, 5144, 15560, 14817, 2]
// Exports: default

// Module 15559 (DisplayNameStylesGummyCustomColorSheet)
...
export default function DisplayNameStylesGummyCustomColorSheet(onSelect) {
  ...
  obj8.children = closure_7(View, { style: tmp.preview, children: closure_7(sharedValue(15560), { hue: sharedValue }) });
  const items1 = [closure_7(View, obj8), ];
  const obj10 = { style: tmp.huePickerInset, children: closure_7(sharedValue(14817), { hue: sharedValue, onPanFinalize: callback, saturation, lightness, fullWidth: true }) };
