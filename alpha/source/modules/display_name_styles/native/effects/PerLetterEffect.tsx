...
// Dependencies: [19, 17, 21, 4756, 11165, 11166, 4752, 2]
// Exports: default

// Module 11164 (PerLetterEffect)
...
export default function PerLetterEffect(name) {
  ...
  const memo = noop.useMemo(() => {
    const regex = colors(11165)();
    closure_1 = 0;
    let obj = name(11166);
    return name(11166).splitGraphemes(regex).map((children, index) => {
      regex.lastIndex = 0;
  ...
  obj2.style = items2;
  obj2.children = memo;
  obj.children = jsx(name(4752).Text, {});
