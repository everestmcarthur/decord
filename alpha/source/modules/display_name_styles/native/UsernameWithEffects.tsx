...
// Dependencies: [19, 17, 1390, 21, 1391, 4722, 576, 1365, 11147, 4956, 9415, 1389, 4957, 9414, 4423, 11148, 4718, 4728, 4426, 11151, 1370, 2]

// Module 11146 (UsernameWithEffects)
...
export default noop.memo((userName) => {
  ...
  if (STATIC === undefined) {
    STATIC = userName(11147).EffectDisplayType.STATIC;
  }
  ...
  let num2;
  const tmp6 = num2(4956)({ userId, guildId, pendingDisplayNameStyles, ignoreDisabledStylesSetting });
  const isDisplayNameStylesFlywheelViewersEnabled = userName(9415).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  const obj = userName(9415);
  ...
  const displayNameStylesEnabled = userName(4957).useDisplayNameStylesEnabled({ location: "UsernameWithEffects" });
  const obj3 = userName(4957);
  const displayNameStylesFont = userName(9414).useDisplayNameStylesFont({ displayNameStyles: result, ignoreDisabledStylesSetting });
  let tmp12;
  ...
  const obj4 = userName(9414);
  const token = userName(4423).useToken(tmp4(576).colors.BACKGROUND_BASE_LOW);
  const tmp7Result = userName(4423);
  const token1 = userName(4423).useToken(tmp4(576).colors.WHITE);
  const tmp7Result7 = userName(4423);
  const displayNameStylesAccessibleColors = userName(11148).useDisplayNameStylesAccessibleColors({ displayNameStyles: result, backgroundColor: token });
  let first;
  ...
  const tmp7Result10 = userName(4728);
  const tmp20 = userName(4718).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
  ...
  if (displayNameStylesEnabled) {
    if (null != tmp6) {
      if (STATIC !== tmp7(11147).EffectDisplayType.PLAIN) {
        if (null != colorVariants) {
          ...
          if (effectId === tmp7(1391).DisplayNameEffect.GUMMY) {
            const tmp4Result = tmp4(11151);
            const tmp66 = closure_9;
            let str3 = tmp7(4426).getNodeText(userName);
            if (str3 == null) {
              str3 = "";
            }
            ...
            if (tmp7(1391).DisplayNameEffect.GRADIENT !== effectId) {
              if (tmp7(1391).DisplayNameEffect.PRISM !== effectId) {
                if (tmp7(1391).DisplayNameEffect.NEON === effectId) {
                  ...
                  if (null != colorVariants) {
                    ...
                    const items6 = [closure_9(tmp7(4718).Text, obj10), ];
                    const obj11 = {};
                    ...
                    items6[1] = closure_9(tmp7(4718).Text, obj11);
              ...
              return closure_9(tmp7(4718).Text, obj13);
            }
      ...
      return closure_9(tmp7(4718).Text, obj14);
    }
  }
  const obj15 = {};
  ...
  return closure_9(userName(4718).Text, obj15);
});
