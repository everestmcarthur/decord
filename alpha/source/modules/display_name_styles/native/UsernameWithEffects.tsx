...
export default noop.memo((userName) => {
  ...
  const tmp7Result10 = userName(4762);
  const tmp20 = userName(4752).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
  ...
  if (displayNameStylesEnabled) {
    if (null != tmp6) {
        ...
        if (null != colorVariants) {
          ...
          if (effectId === tmp7(1391).DisplayNameEffect.GUMMY) {
            ...
            if (tmp7(1391).DisplayNameEffect.GRADIENT !== effectId) {
              if (tmp7(1391).DisplayNameEffect.PRISM !== effectId) {
                if (tmp7(1391).DisplayNameEffect.NEON === effectId) {
                  ...
                  if (null != colorVariants) {
                    ...
                    const items6 = [closure_9(tmp7(4752).Text, obj10), ];
                    const obj11 = {};
                    ...
                    items6[1] = closure_9(tmp7(4752).Text, obj11);
              ...
              return closure_9(tmp7(4752).Text, obj13);
            }
      ...
      return closure_9(tmp7(4752).Text, obj14);
    }
  }
  const obj15 = {};
  ...
  return closure_9(userName(4752).Text, obj15);
});
