...
// Dependencies: [4723, 15614, 1980, 2]
// Exports: default

// Module 15613 (showGummyCustomColorSheet)
...
export default function showGummyCustomColorSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15614, dependencyMap.paths), DisplayNameStylesGummyCustomColorSheet, arg0, "stack");
};
