...
// Dependencies: [17, 4981, 1074, 21, 4756, 5198, 15967, 2]
// Exports: default

// Module 15966 (CheckpointBackground)
...
export default function CheckpointBackground() {
  ...
  const obj3 = { source: { uri: _modDef15967 }, style: tmp.background, resizeMode: "cover" };
