...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 8997, 1115, 10357, 12775, 5270, 5266, 10623, 13790, 9609, 4664, 13792, 4722, 576, 13784, 5611, 4458, 4723, 4718, 4656, 4573, 5156, 5292, 4615, 13793, 13795, 4571, 1177, 13797, 13798, 5751, 12807, 2]
// Exports: default

// Module 13789 (GuildBoostingMarketingTierCards)
...
import ServerBoostStreamQualityMarketingExperiment from "ServerBoostStreamQualityMarketingExperiment" /* 13792 */;
...
let items = [
  {
    orderCollapsed: 0,
    isIncluded: true,
    IconComponent: fn(8997).ReactionIcon,
    getCopy() {
...
items[1] = {
  isIncluded: true,
  IconComponent: fn(10357).StickerIcon,
  getCopy() {
    const intl = util.intl;
...
items[2] = {
  isIncluded: true,
  IconComponent: fn(12775).ScreenArrowIcon,
  getCopy() {
    const intl = util.intl;
...
items[3] = {
  orderCollapsed: 2,
  isIncluded: true,
  IconComponent: fn(5270).VoiceNormalIcon,
  getCopy() {
    const intl = util.intl;
...
items[4] = {
  isIncluded: true,
  IconComponent: fn(5266).StageIcon,
  getCopy() {
    const intl = util.intl;
...
items[5] = {
  orderCollapsed: 1,
  isIncluded: true,
  IconComponent: fn(10623).GifIcon,
  getCopy() {
    const intl = util.intl;
...
items[6] = {
  isIncluded: true,
  IconComponent: fn(13790).ServerGridIcon,
  getCopy() {
    const intl = util.intl;
...
items[7] = {
  isIncluded: false,
  IconComponent: fn(9609).UploadIcon,
  getCopy() {
    const intl = util.intl;
...
items[10] = {
  isIncluded: false,
  IconComponent: fn(4664).LinkIcon,
  getCopy() {
    const intl = util.intl;
...
obj37.cardsScroller = { flex: 1, marginTop: fn(13784).PROGRESS_BAR_SPACING };
...
const obj41 = { flex: 1, marginTop: fn(13784).PROGRESS_BAR_SPACING };
obj37.sparkleStar = { position: "absolute", tintColor: fn(5611).DARK_WHITE_500_LIGHT_GUILD_BOOSTING_PINK };
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13793).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13795).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      const tmp2Result4 = tmp2(5156);
      const items7 = [tmp7(4571).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result7 = tmp7(4571);
      items7[1] = tmp7(4571).hexWithOpacity(tmp9, 1);
      const tmp7Result8 = tmp7(4571);
      items7[2] = tmp7(4571).hexWithOpacity(tmp9, 0);
      obj15.colors = items7;
      obj15.start = { x: 0, y: 0 };
      obj15.end = { x: 1, y: 0 };
      ...
      const tmp7Result9 = tmp7(4571);
      const tmp2Result5 = tmp2(5156);
      const items10 = [tmp7(4571).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result10 = tmp7(4571);
      items10[1] = tmp7(4571).hexWithOpacity(tmp9, 1);
      const tmp7Result11 = tmp7(4571);
      items10[2] = tmp7(4571).hexWithOpacity(tmp9, 0);
    ...
    obj22 = tmp13(tmp7(4718).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5156), obj21);
    const tmp2Result6 = tmp2(5156);
  }
});
const size = fn(2);
