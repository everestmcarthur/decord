...
// Dependencies: [19, 17, 1074, 21, 13786, 13787, 13788, 4722, 576, 4656, 4458, 4571, 4573, 5143, 12827, 11804, 4718, 4615, 2]
// Exports: default

// Module 13785 (GuildBoostingMarketingProgressBarMarker)
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items1[1] = obj4;
    obj3.style = items1;
    const animatedStyle = tmp5(4458).useAnimatedStyle(P);
    ...
    obj9.children = tmp5(4615).getTierName(tier, { useLevels: false });
    items5[1] = closure_7(tmp5(4718).Text, obj9);
