...
// Dependencies: [32, 19, 17, 1372, 4616, 1074, 1374, 21, 1091, 4722, 576, 1177, 4458, 4723, 7358, 7378, 563, 13665, 8285, 4630, 4380, 1380, 13718, 13720, 5156, 13778, 4718, 1115, 5754, 5292, 13705, 7598, 13781, 13782, 5144, 5604, 10904, 13783, 9630, 2]
// Exports: default

// Module 13777 (GuildBoostingMarketingCtaBar)
...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  analyticsLocations = isVisible(7358)(isVisible(7378).BOOSTED_GUILD_PERKS_MODAL).analyticsLocations;
  const tmp6 = isVisible(7358);
  const items = [ref];
  ...
  let obj3 = guild(4458);
  fn.__closure = { withTiming: guild(4723).withTiming, isVisible };
  fn.__workletHash = 6895237370657;
  fn.__initData = __initData;
  closure_130_0 = tmp12;
  const animatedStyle = obj3.useAnimatedStyle(fn);
  const obj4 = { withTiming: guild(4723).withTiming, isVisible };
  ...
  const obj5 = guild(4458);
  fn2.__closure = { withTiming: guild(4723).withTiming, isVisible: !isVisible };
  fn2.__workletHash = 6895237370657;
  fn2.__initData = __initData;
  const animatedStyle1 = obj5.useAnimatedStyle(fn2);
  const obj6 = { withTiming: guild(4723).withTiming, isVisible: !isVisible };
  const tmp14 = isVisible(13665);
  const tmp14Result = isVisible(13665)(fractionalPremiumInfo.endsAt, guild(13665).CountDownMessageTypes.LONG_TIME_LEFT);
  const isInReverseTrial = guild(8285).useIsInReverseTrial();
  const obj7 = guild(8285);
  ...
  const tmp4Result = isVisible(5156);
  const items5 = [closure_12(isVisible(13778), { guild }), , , ];
  ...
  const items6 = [closure_12(guild(4718).Heading, obj14), , , , ];
  const obj15 = { style: tmp.guildIcon, textStyle: tmp.guildIconText, guild, size: null };
  const tmp4Result3 = isVisible(5156);
  obj15.size = guild(5754).GuildIconSizes.LARGE;
  items6[1] = closure_12(isVisible(5754), obj15);
  const obj16 = {
    onPress() {
      window.clearTimeout(ref.current);
      closure_2((arg0) => !arg0);
  ...
  const items7 = [closure_12(guild(4718).Text, { style: tmp.guildName, color: "text-overlay-light", variant: "text-md/bold", children: guild.name }), ];
  ...
  const tmp4Result4 = isVisible(5754);
  const items9 = [closure_12(guild(1177).Icon, { style: tmp.guildBoostCountIcon, source: isVisible(13705), color: isVisible(576).unsafe_rawColors.GUILD_BOOSTING_PINK, size: guild(1177).Icon.Sizes.SMALL }), ];
  ...
  obj21.children = intl2.format(guild(1115).t["pob/cL"], { subscriptions: isVisible(4630)(premiumGroupRole.guild.id).total });
  items9[1] = closure_12(guild(4718).Text, obj21);
  obj19.children = items9;
  const items10 = [closure_13(isVisible(4458).View, obj19), ];
  ...
  obj22.children = closure_12(guild(4718).Text, obj23);
  items10[1] = closure_12(isVisible(4458).View, obj22);
  obj18.children = items10;
  items7[1] = closure_13(memo, obj18);
  obj16.children = items7;
  items6[2] = closure_13(guild(5292).PressableOpacity, obj16);
  items6[3] = tmp20;
  ...
  items6[4] = closure_12(isVisible(7598), obj24);
  obj13.children = items6;
  items5[1] = closure_13(memo, obj13);
  items5[2] = closure_12(isVisible(13781), { style: tmp.headerStars });
  items5[3] = closure_12(isVisible(13782), { style: tmp.headerWave });
  ...
  if (isPremiumResult) {
    ...
    const obj29 = { size: tmp7(1177).Icon.Sizes.SMALL, source: tmp4(13783), style: tmp.giftIcon };
  ...
  obj27.children = closure_12(guild(5144).Button, obj30);
