...
export default function GuildBoostingMarketingPersistentCta(arg0) {
  ...
  let obj2 = isVisible(4492);
  fn.__closure = { useReducedMotion: stateFromStores, VISIBILITY_OFFSET: 120, withSpring: isVisible(5185).withSpring, isVisible, SPRING_CONFIG };
  ...
  const obj3 = { useReducedMotion: stateFromStores, VISIBILITY_OFFSET: 120, withSpring: isVisible(5185).withSpring, isVisible, SPRING_CONFIG };
  ...
  return closure_6(stateFromStores(4492).View, obj4);
};
