...
// Dependencies: [4959, 18087, 1980, 2]

// Module 18086 (EnableCommunityModalActionCreators)
...
export default {
  open() {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(18087, dependencyMap.paths), undefined, ENABLED_COMMUNITY_MODAL_KEY);
  },
  close() {
