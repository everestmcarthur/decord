...
// Dependencies: [7879, 7881, 7882, 5677, 7884, 7885, 7886, 5717, 7887, 7888, 7717, 7889, 7890, 7730, 7729, 7731, 7891, 2]

// Module 7878 (MobileAppDatabaseManager)
import AppDatabaseManager from "AppDatabaseManager" /* 7879 */;
