...
// Dependencies: [502, 4779, 4795, 9952, 9953, 1074, 9969, 4808, 4811, 504, 573, 2]

// Module 9951 (SecureFramesVerifiedStore)
  ...
  RTC_CONNECTION_STATE: function handleRtcConnectionState(state) {
    ...
    if (state.state !== RTCConnectionStates.DISCONNECTED) {
      ...
      if (BaseConnectionEvent.MediaEngineContextTypes.STREAM === context) {
        ...
        return tmp6;
      } else if (tmp10(4811).MediaEngineContextTypes.DEFAULT === context) {
        map.clear();
        map1.clear();
        c10 = false;
      }
