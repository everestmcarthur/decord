...
// Dependencies: [5, 502, 4745, 9390, 206, 9373, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 9395 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(9390).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
