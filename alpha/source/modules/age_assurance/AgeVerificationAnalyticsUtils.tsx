...
// Dependencies: [1958, 1074, 1241, 2, 8646]
...
// Module 8645 (AgeVerificationAnalyticsUtils)
...
export const NsfwSpaceWarningModalType = fn(8646).NsfwSpaceWarningModalType;
