...
// Dependencies: [19, 8682, 21, 5114, 1115, 3066, 4752, 8681, 2108, 5114, 2]
// Exports: default

// Module 8861 (ManualReviewDecidedTeenAlertModal)
...
require = fn;
const FALLBACK_TEEN_AGE_RANGE = fn(8682).FALLBACK_TEEN_AGE_RANGE;
const jsx = fn(21).jsx;
const size = fn(2);
