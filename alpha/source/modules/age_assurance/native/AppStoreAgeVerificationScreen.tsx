...
// Dependencies: [5, 32, 19, 17, 21, 5084, 5089, 1484, 4968, 8842, 8845, 8710, 8844, 8692, 8693, 5184, 4752, 1115, 3034, 5645, 5186, 8683, 2]
// Exports: default
...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  const watchAgeVerificationStatusChange = modalSessionId(4968).useWatchAgeVerificationStatusChange(modalSessionId.onClose);
  ...
  if ("loading" === tmp5.type) {
    ...
    items3[1] = tmp10(tmp(4752).Text, obj4);
    ...
    const items4 = [tmp10(tmp(4752).Text, obj6), ];
    ...
    obj7.children = tmp10(tmp(5186).Button, obj8);
    items4[1] = tmp10(tmp(5645).ButtonGroup, obj7);
