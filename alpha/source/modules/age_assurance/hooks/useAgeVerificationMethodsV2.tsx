...
// Dependencies: [5, 32, 19, 8724, 8689, 8708, 573, 2]
// Exports: useAgeVerificationMethodsV2

// Module 8723 (useAgeVerificationMethodsV2)
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            v0(false);
            v0 = 2;
            const result = closure_0(8689).isCurrentUserSuspended();
            const obj7 = closure_0(8708);
            if (result) {
              c5 = 4;
              c6 = 1;
