...
// Dependencies: [5, 32, 19, 8686, 8651, 8670, 573, 2]
// Exports: useAgeVerificationMethodsV2

// Module 8685 (useAgeVerificationMethodsV2)
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            v0(false);
            v0 = 2;
            const result = closure_0(8651).isCurrentUserSuspended();
            const obj7 = closure_0(8670);
            if (result) {
              c5 = 4;
              c6 = 1;
