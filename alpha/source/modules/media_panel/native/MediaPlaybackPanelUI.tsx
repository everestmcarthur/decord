...
// Dependencies: [32, 19, 9745, 14811, 12525, 12524, 21, 4756, 576, 1612, 1478, 17675, 4492, 9663, 11615, 17471, 4757, 4760, 5185, 17473, 7396, 6892, 17677, 2]
// Exports: default

// Module 17676 (MediaPlaybackPanelUI)
...
import MediaPlaybackPanelStateContextDefault from "MediaPlaybackPanelStateContext" /* 17675 */;
...
export default function MediaPlaybackPanelUI() {
  ...
  if (mode.get() === MediaPlaybackPanelModes.PIP) {
    ...
    if (mode.get() === tmp12.PIP) {
      ...
      const context1 = obj2.useContext(tmp2(17675));
