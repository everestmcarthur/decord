...
// Dependencies: [32, 19, 9903, 14757, 12516, 12515, 21, 4722, 576, 1612, 1478, 17598, 4458, 9733, 11606, 17394, 4723, 4726, 5143, 17396, 7352, 6848, 17600, 2]
// Exports: default

// Module 17599 (MediaPlaybackPanelUI)
...
import MorphablePanelUtils from "MorphablePanelUtils" /* 17394 */;
import MediaPlaybackPanelStateContextDefault from "MediaPlaybackPanelStateContext" /* 17598 */;
...
const MediaPlaybackPanelConstants = fn(14757);
({ MEDIA_PLAYBACK_PANEL_LAYOUT_PHYSICS: closure_7, MediaPlaybackPanelModes: closure_8 } = MediaPlaybackPanelConstants);
const IS_IOS = fn(12516).IS_IOS;
const BORDER_RADIUS_PHYSICS = fn(12515).BORDER_RADIUS_PHYSICS;
const jsx = fn(21).jsx;
...
export default function MediaPlaybackPanelUI() {
  ...
  if (mode.get() === MediaPlaybackPanelModes.PIP) {
    ...
    if (mode.get() === tmp12.PIP) {
      ...
      const obj11 = { withTiming: tmp6(4723).withTiming, wrapperOpacity: sharedValue2, timingFast: tmp6(4726).timingFast, animateWrapperTranslation: sharedValue3, withSpring: tmp6(5143).withSpring, wrapperTranslationX: sharedValue, MEDIA_PLAYBACK_PANEL_LAYOUT_PHYSICS, wrapperTranslationY: sharedValue1, wrapperDimensions, wrapperElevationStyles: maskEmptyElevation };
      L.__closure = obj11;
      L.__workletHash = 11049335639852;
      L.__initData = __initData4;
      const animatedStyle1 = tmp6(4458).useAnimatedStyle(L);
      closure_129_16 = animatedStyle1;
      const xl = tmp2(576).radii.xl;
      closure_129_17 = xl;
      const tmp6Result = tmp6(4458);
      class B {
        constructor() {
      ...
      const obj12 = { withSpring: tmp6(5143).withSpring, borderRadius: xl, BORDER_RADIUS_PHYSICS, maskElevationStyles: maskElevation };
      B.__closure = obj12;
      B.__workletHash = 7035830192327;
      B.__initData = __initData5;
      const animatedStyle2 = tmp6(4458).useAnimatedStyle(B);
      ...
      const animatedStyle3 = tmp6(4458).useAnimatedStyle(fn4);
      const context1 = obj2.useContext(tmp2(17598));
      ...
      const tmp6Result4 = tmp6(4458);
      obj14.mode = tmp6(17396).MorphablePanelModes.PIP;
      ...
      const View = tmp2(4458).View;
      const obj18 = { style: tmp31, children: null };
      const obj19 = { gesture: tmp2(17396)(obj14), children: null };
      const obj20 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj20.style = items3;
      obj20.children = jsx(tmp2(17600), {});
      obj19.children = jsx(tmp2(4458).View, { style: null, children: null });
      obj18.children = jsx(tmp6(6848).GestureDetector, { gesture: tmp2(17396)(obj14), children: null });
      obj17.children = jsx(tmp2(4458).View, { style: tmp31, children: null });
      class R {
        constructor() {
          obj = { mode: closure_1_5.get(), wrapperDimensions: closure_0.get(), pipAvoidanceSpecs: closure_1_7.get(), wrapperOffset: closure_1.get(), windowDimensions: closure_1_4, safeArea: closure_1_3, pipState: closure_1_6.get() };
          return obj;
      ...
      obj15.children = jsx(tmp2(4458).View, { style: animatedStyle, pointerEvents: "box-none", children: null });
      return jsx(tmp6(7352).LayerScope, { children: null });
    }
  }
