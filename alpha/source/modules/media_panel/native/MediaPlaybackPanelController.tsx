...
// Dependencies: [32, 19, 4748, 2040, 4964, 14811, 9314, 12525, 21, 4492, 1612, 17462, 14810, 504, 17675, 2]
// Exports: default

// Module 17674 (MediaPlaybackPanelController)
...
const require = fn;
const MediaPlaybackPanelModes = fn(14811).MediaPlaybackPanelModes;
