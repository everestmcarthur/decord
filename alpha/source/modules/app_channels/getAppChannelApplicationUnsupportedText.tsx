...
// Dependencies: [9832, 1115, 2]
// Exports: default

// Module 9831 (getAppChannelApplicationUnsupportedText)
import GuildEmbeddedApplicationUnsupportedReason from "GuildEmbeddedApplicationUnsupportedReason" /* 9832 */;
...
export default function getAppChannelApplicationUnsupportedText(supported) {
  if (!supported.supported) {
    ...
    } else if (tmp(9832).GuildEmbeddedApplicationUnsupportedReason.SURFACE_NOT_SUPPORTED === reason) {
