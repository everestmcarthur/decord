...
// Dependencies: [9993, 1115, 2]
// Exports: default

// Module 9992 (getAppChannelApplicationUnsupportedText)
import GuildEmbeddedApplicationUnsupportedReason from "GuildEmbeddedApplicationUnsupportedReason" /* 9993 */;
...
export default function getAppChannelApplicationUnsupportedText(supported) {
  if (!supported.supported) {
    ...
    } else if (tmp(9993).GuildEmbeddedApplicationUnsupportedReason.SURFACE_NOT_SUPPORTED === reason) {
