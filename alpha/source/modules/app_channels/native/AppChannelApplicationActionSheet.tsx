...
// Dependencies: [19, 21, 9827, 4723, 7437, 7389, 1115, 5897, 5900, 9831, 9829, 2]
// Exports: default

// Module 9830 (AppChannelApplicationActionSheet)
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4723 */;
import AppChannelApplicationIconDefault from "AppChannelApplicationIcon" /* 9829 */;
import getAppChannelApplicationUnsupportedTextDefault from "getAppChannelApplicationUnsupportedText" /* 9831 */;
...
export default function AppChannelApplicationActionSheet(arg0) {
  ...
  const options = onChange(9827).useAppChannelApplicationOptions(guildId, channelId, selectedApplicationId).options;
  ...
  obj2.header = jsx(onChange(7389).BottomSheetTitleHeader, { title: null });
  ...
  obj2.children = jsx(onChange(5897).TableRadioGroup, { accessibilityLabel: null, value: null, onChange: null, hasIcons: true, children: null });
  return jsx(onChange(7437).ActionSheet, { header: null, children: null });
};
