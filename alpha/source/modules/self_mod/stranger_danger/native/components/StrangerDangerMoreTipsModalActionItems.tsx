...
// Dependencies: [32, 19, 4371, 1372, 11165, 21, 504, 4566, 11622, 9280, 1115, 7164, 7162, 8148, 5857, 11638, 2]
// Exports: default

// Module 11637 (StrangerDangerMoreTipsModalActionItems)
import util from "util" /* 1115 */;
import UserUtilsDefault from "UserUtils" /* 4566 */;
import DenyIcon from "DenyIcon" /* 8148 */;
...
export default function StrangerDangerMoreTipsModalActionItems(channelId) {
  ...
  const memo1 = stateFromStores.useMemo(() => {
    ...
    if (first) {
      let EyeSlashIcon = tmp11(7164).EyeIcon;
    } else {
      EyeSlashIcon = tmp11(7162).EyeSlashIcon;
    }
