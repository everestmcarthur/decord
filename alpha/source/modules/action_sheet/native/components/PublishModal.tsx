...
// Function ID: 11920
// Name: PublishModal
// Dependencies: [32, 19, 17, 21, 4756, 5653, 11920, 1177, 1115, 2]
// Exports: default

// Module 11919 (PublishModal)
import util from "util" /* 1115 */;
import native from "native" /* 1177 */;
import useChannelFollowerStatsDefault from "useChannelFollowerStats" /* 11920 */;
...
let obj2 = { alertContainer: { paddingTop: 16 }, alertLoading: { paddingTop: 62, paddingBottom: 46 }, alertBodyText: { marginBottom: 16, fontSize: 16, lineHeight: 24, color: fn(5653).DARK_PRIMARY_300_LIGHT_PRIMARY_400 } };
