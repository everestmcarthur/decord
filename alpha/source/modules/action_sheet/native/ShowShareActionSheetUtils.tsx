...
// Dependencies: [1074, 8596, 1241, 8597, 1366, 1364, 5738, 2]
// Exports: getMediaShareParams, resolveShareFileExtension, trackAppClickInNativeShareSheet

// Module 8595 (ShowShareActionSheetUtils)
import Constants from "Constants" /* 1074 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import URLUtilsDefault from "URLUtils" /* 1366 */;
import FileExtensionUtils from "FileExtensionUtils" /* 5738 */;
import SharePreparingModalConstants from "SharePreparingModalConstants" /* 8596 */;
    ...
    if (true !== source.disableDownload) {
      if (null != source.shareURI) {
        if (obj11.isDiscordDirectAssetUrl(source.shareURI)) {
          ...
          if (null != videoURI) {
            const decideFileExtensionResult = tmp(5738).decideFileExtension(videoURI, contentType, true);
            ...
            const decideFileExtensionResult1 = tmp(5738).decideFileExtension(source.uri, contentType, true);
