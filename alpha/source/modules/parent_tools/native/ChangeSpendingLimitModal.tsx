...
// Dependencies: [5, 19, 17, 21, 4722, 576, 8826, 4718, 1115, 2480, 15126, 4420, 4681, 4925, 4419, 7430, 8654, 8655, 5142, 6799, 12170, 5603, 5144, 5794, 11451, 2]
// Exports: default

// Module 15125 (ChangeSpendingLimitModal)
...
function ChangeSpendingLimitScreen(teenId) {
  ...
  importDefault = async function _handleSave(dependencyMap) {
    ...
    if (1 === tmp7) {
      ...
      tmp3(4419).presentFailedToast(intl.string(v2(2480).Wu8BK2));
      c3 = 3;
      tmp3(4419);
      ...
      obj7.content = intl2.string(v2(2480)["2WKfG1"]);
      obj7.IconComponent = tmp3(4681).CircleCheckIcon;
      v2(4420).open(obj7);
      v2(4420);
      v2(4925).pop();
      dependencyMap = 0;
  ...
  if (null != monthlySpend) {
    ...
    if (monthlySpend > 0) {
      formatPriceResult = tmp2(7430).formatPrice(monthlySpend, tmp5);
  ...
  obj3.children = intl.string(_modDef2480.IFguF2);
  ...
  obj5.children = intl2.string(_modDef2480["1fHSu2"]);
  ...
  obj6.accessibilityLabel = intl3.string(_modDef2480["1fHSu2"]);
  ...
  obj6.placeholder = intl4.string(_modDef2480.DjSv82);
  let str = "number-pad";
  if (exponent > 0) {
    str = "decimal-pad";
  }
  ...
  if (null == formatPriceResult) {
    ...
    items[1] = tmp8(tmp2(5142).Stack, obj4);
    obj2.children = items;
    obj8.children = tmp8(tmp2(5142).Stack, obj2);
    const items3 = [tmp9(tmp2(8655).ModalContent, obj8), ];
    if (isClearingCap) {
      const obj9 = { variant: "destructive", text: null, onPress: null, disabled: null, loading: null };
      const intl8 = tmp2(1115).intl;
      obj9.text = intl8.string(tmp10(2480).JZDGJ8);
    ...
    const items4 = [tmp9(tmp2(5144).Button, obj10), ];
    const obj14 = { variant: "tertiary", text: null, onPress: null };
    const intl9 = tmp2(1115).intl;
    obj14.text = intl9.string(tmp2(1115).t["ETE/oC"]);
    obj14.onPress = tmp10(4925).pop;
    items4[1] = tmp9(tmp2(5144).Button, obj14);
    obj13.children = items4;
    obj12.children = tmp8(tmp2(5603).ButtonGroup, obj13);
    items3[1] = tmp9(tmp2(12170).ModalFooter, obj12);
    obj11.children = items3;
    return tmp8(tmp2(8654).ModalScreen, obj11);
    ...
    const items5 = [tmp9(tmp2(8826).WarningIcon, obj16), ];
    ...
    formatToPlainStringResult = intl6.formatToPlainString(tmp10(2480).Tk6x4X, obj18);
    obj17.children = formatToPlainStringResult;
    items5[1] = tmp9(tmp2(4718).Text, obj17);
    ...
    obj19.children = intl5.formatToPlainString(tmp10(2480).pfAlRY, obj20);
    tmp9Result1 = tmp9(tmp2(4718).Text, obj19);
  }
}
...
export default function ChangeSpendingLimitModal(teenId) {
  ...
  const memo = noop.useMemo(() => {
    ...
    const obj2 = {
      ...
      headerTitle() {
        ...
        obj.children = intl.string(closure_1_1(2480).xMRO6A);
        return closure_1_6(teenId(4718).Text, obj);
      },
      render() {
  ...
  return closure_6(teenId(11451).Modal, obj);
};
