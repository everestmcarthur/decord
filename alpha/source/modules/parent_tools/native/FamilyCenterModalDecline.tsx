...
// Module 15198 (FamilyCenterModalDecline)
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  const tmp2 = declineLinkRequest(8923)();
  ...
  obj5.iconSrc = declineLinkRequest(7232);
  const items1 = [closure_5(declineLinkRequest(15194), obj5), , ];
  ...
  items1[2] = closure_5(declineLinkRequest(15164), { user: otherUser });
  ...
  const items4 = [closure_6(otherUser(8693).ModalContent, obj3), ];
  ...
  obj10.children = closure_6(otherUser(5645).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12179).ModalFooter, obj10);
