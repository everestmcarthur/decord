...
// Dependencies: [4969, 7778, 1074, 1241, 7779, 4959, 12167, 1980, 2]
// Exports: handleFamilyCenterQRCodeScan, resumeFamilyCenterConnection

// Module 12166 (FamilyCenterNativeUtils)
...
export const resumeFamilyCenterConnection = function resumeFamilyCenterConnection() {
  ...
  if (flag) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12167, dependencyMap.paths), { userId: null, linkCode: null }, c7);
    flag = true;
