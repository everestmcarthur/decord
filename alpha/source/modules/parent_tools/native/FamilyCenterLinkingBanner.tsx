...
// Dependencies: [19, 17, 21, 4722, 576, 8884, 12163, 1115, 2480, 15132, 4718, 15094, 2]
// Exports: default

// Module 15131 (FamilyCenterLinkingBanner)
...
import FamilyCenterBannerButton from "FamilyCenterBannerButton" /* 15094 */;
import _modDef15132 from "module_15132" /* 15132 */;
...
function FamilyCenterLinkingBannerParentContent() {
  ...
  obj2.header = intl.string(_modDef2480["7xxAni"]);
  const intl2 = util.intl;
  obj2.description = intl2.string(_modDef2480["1M9So2"]);
  const items = [hasOwnProperty(FamilyCenterLinkingInstructionsRow, obj2), , , ];
  const obj3 = { index: 2, header: null, description: null };
  const intl3 = util.intl;
  obj3.header = intl3.string(_modDef2480["AXgx+a"]);
  const intl4 = util.intl;
  obj3.description = intl4.string(_modDef2480.GzMFnb);
  ...
  obj4.header = intl5.string(_modDef2480.MZn1tG);
  const intl6 = util.intl;
  obj4.description = intl6.string(_modDef2480["8rLBxD"]);
...
export default function FamilyCenterLinkingBanner() {
  ...
  const intl2 = util.intl;
  const ageSpecificText = obj.useAgeSpecificText(intl.string(_modDef2480.zUCWEL), intl2.string(_modDef2480.B0NPbp));
  const stringResult = intl.string(_modDef2480.zUCWEL);
  const intl3 = util.intl;
  const obj2 = useAgeSpecificText;
  const intl4 = util.intl;
  const obj3 = { style: tmp.container, children: null };
  const obj4 = { source: null, style: null, resizeMethod: "resize" };
  const ageSpecificText1 = obj2.useAgeSpecificText(intl3.format(_modDef2480.yMnoDl, { link: "https://support.discord.com/hc/articles/14155060633623" }), intl4.string(_modDef2480.JsAEDi));
  obj4.source = _modDef15132;
  obj4.style = tmp.art;
