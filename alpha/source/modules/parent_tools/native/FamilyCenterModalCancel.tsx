...
// Dependencies: [19, 17, 21, 4756, 576, 8923, 4959, 4453, 1115, 12169, 38, 8692, 8693, 15194, 7232, 4752, 2482, 15164, 12179, 5645, 5186, 5836, 11463, 2]
// Exports: default

// Module 15199 (FamilyCenterModalCancel)
...
function FamilyCenterModalCancelScreen(otherUser) {
  ...
  const obj = otherUser(12169);
  obj5.iconSrc = cancelLinkRequest(7232);
  const items1 = [closure_5(cancelLinkRequest(15194), obj5), , ];
  ...
  items1[2] = closure_5(cancelLinkRequest(15164), { user: otherUser });
  obj4.children = items1;
  obj3.children = closure_6(View, obj4);
  const items2 = [closure_5(otherUser(8693).ModalContent, obj3), ];
  ...
  const items3 = [closure_5(otherUser(5186).Button, obj9), ];
  ...
  obj10.onPress = cancelLinkRequest(4959).pop;
  items3[1] = closure_5(otherUser(5186).Button, obj10);
  obj8.children = items3;
  obj7.children = closure_6(otherUser(5645).ButtonGroup, obj8);
  items2[1] = closure_5(otherUser(12179).ModalFooter, obj7);
  obj2.children = items2;
  return closure_6(otherUser(8692).ModalScreen, obj2);
}
...
export default function FamilyCenterModalCancel(otherUser) {
  ...
  return closure_5(otherUser(11463).Modal, obj);
};
