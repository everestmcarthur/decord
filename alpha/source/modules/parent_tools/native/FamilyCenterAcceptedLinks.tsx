...
// Dependencies: [19, 17, 7778, 21, 4756, 576, 8923, 8922, 12172, 1115, 2482, 4752, 15188, 15190, 5334, 4959, 15193, 1980, 1177, 15195, 2]
// Exports: default
...
export default function FamilyCenterAcceptedLinks() {
  ...
  if (0 === activeLinkUsers.length) {
    ...
    obj6.children = tmp10(tmp2(15188), obj7);
    let mapped = tmp10(tmp9, obj6);
    const tmp2Result = tmp2(15188);
  } else {
