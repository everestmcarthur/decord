...
// Dependencies: [1091, 1083, 1115, 2480, 2]
...
// Module 7734 (FamilyCenterConstants)
...
const items = [
  obj2.USER_INTERACTION,
  {
    ...
    tooltipHeader() {
      ...
      return intl.string(_modDef2480.kvTgWP);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
      const tmp = _modDef2480;
      if (arg0) {
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2480["4T3zWT"], { count });
    },
    ...
    timestampFormatter() {
      ...
      const intl = util.intl;
      obj.today = intl.string(_modDef2480.fLBUx7);
      const intl2 = util.intl;
      obj.yesterday = intl2.string(_modDef2480.cHHgxI);
      obj.days = _modDef2480.qvKjp8;
      return obj;
    }
  }
];
...
const items2 = [
  obj2.USER_CALLED,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2480.D7Sngz);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2480["0GE4Ni"], { count });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    timestampFormatter() {
      const obj = { today: null, yesterday: null, days: null };
      const intl = util.intl;
      obj.today = intl.string(_modDef2480.IHd5cZ);
      const intl2 = util.intl;
      obj.yesterday = intl2.string(_modDef2480.wOsfxv);
      obj.days = _modDef2480.oCk8c4;
      return obj;
    }
  }
];
...
const items3 = [
  obj2.USER_ADD,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2480.kIcKAj);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2480["TEvo+H"], { count });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    timestampFormatter() {
      const obj = { today: null, yesterday: null, days: null };
      const intl = util.intl;
      obj.today = intl.string(_modDef2480.JUHIYZ);
      const intl2 = util.intl;
      obj.yesterday = intl2.string(_modDef2480.GiswUW);
      obj.days = _modDef2480["fwQgE/"];
      return obj;
    }
  }
];
...
const items4 = [
  obj2.GUILD_ADD,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2480.uav9Bh);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2480["7feG7T"], { count });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
...
const items5 = [
  obj2.GUILD_INTERACTION,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2480.CcrbCw);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2480.rcPInc, { count });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
...
const items6 = [
  obj2.TOTAL_VOICE_MINUTES,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2480.eo4Fxh);
    },
    tooltipDescription() {
      const intl = util.intl;
      return intl.string(_modDef2480["O/AElu"]);
    },
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2480.eGFWUd, { count });
    },
    sectionDescription() {
      const intl = util.intl;
      return intl.string(_modDef2480["O/AElu"]);
...
const items7 = [
  obj2.PURCHASES,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2480.NMYKsh);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(amount) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2480.FPViWL, { amount });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
...
const items8 = [
  obj2.GIFTS,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2480.ULUspo);
    },
    tooltipDescription() {
      const intl = util.intl;
      return intl.string(_modDef2480.nH8vlc);
    },
    sectionHeader(amount) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2480["0R6I/b"], { amount });
    },
    sectionDescription() {
      const intl = util.intl;
      return intl.string(_modDef2480.nH8vlc);
...
export const FAMILY_CENTER_LINK_REQUEST_ERROR_EXPERIENCES = {
  [obj4.GENERIC_ERROR]: {
    header() {
      const intl = util.intl;
      return intl.string(_modDef2480.nGX8Co);
    },
    description() {
      const intl = util.intl;
      return intl.string(_modDef2480.Uss2dn);
    },
    icon: obj3.X
  },
  [obj4.PENDING_REQUEST_EXISTS]: {
    header() {
      const intl = util.intl;
      return intl.string(_modDef2480.tu0MRv);
    },
    description(email) {
      email = email.email;
      if (null != email) {
        const intl2 = util.intl;
        const obj = { email };
        let formatToPlainStringResult = intl2.formatToPlainString(_modDef2480.xNEkdx, obj);
      } else {
        const intl = util.intl;
        formatToPlainStringResult = intl.string(_modDef2480.Xyjnwn);
      }
  ...
  [obj4.INELIGIBLE_FOR_FAMILY_CENTER]: {
    header() {
      const intl = util.intl;
      return intl.string(_modDef2480.W9JLJh);
    },
    description() {
      const intl = util.intl;
      return intl.format(_modDef2480.On5iRI, { link: "https://support.discord.com/hc/requests/new?ticket_form_id=360000029731" });
    },
    icon: obj3.X
  }
};
...
export const PENDING_LINK_REQUEST_TIMESTAMP_FORMATTER = () => {
  ...
  const intl = util.intl;
  time.seconds = intl.string(_modDef2480.CJdoee);
  time.minutes = _modDef2480.InzMn3;
  time.hours = _modDef2480.ErkYCI;
  const intl2 = util.intl;
  time.yesterday = intl2.string(_modDef2480.GvfssA);
  time.days = _modDef2480.pWig18;
  time.date = _modDef2480.MP3khg;
  return time;
};
export const ACCEPTED_LINK_REQUEST_TIMESTAMP_FORMATTER = () => {
  const time = { seconds: null, minutes: null, hours: null, yesterday: null, days: null, date: null };
  const intl = util.intl;
  time.seconds = intl.string(_modDef2480.Bqsamd);
  time.minutes = _modDef2480.kX3wJg;
  time.hours = _modDef2480.J18GbG;
  const intl2 = util.intl;
  time.yesterday = intl2.string(_modDef2480.Ln9zMn);
  time.days = _modDef2480.WRtySz;
  time.date = _modDef2480.Y3ZYtM;
  return time;
};
