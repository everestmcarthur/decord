...
// Dependencies: [1220, 7777, 1374, 504, 15099, 7474, 7475, 1115, 2482, 2]
...
function getSpendingLimitDisplayState(amount, arg1) {
  if (null == amount) {
    ...
    if (arg1 >= amount.amount) {
      ...
      let num = tmp5(7475).CurrencyExponents[amount.currency];
      if (num == null) {
        num = 2;
      }
      ...
      if (diff <= 10 * 10 ** num) {
        ...
        const obj4 = { amount: tmp5(7474).formatPrice(diff, currency) };
