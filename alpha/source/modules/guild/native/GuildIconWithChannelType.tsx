...
// Dependencies: [19, 17, 21, 5796, 4756, 576, 5239, 11267, 9093, 1177, 2]
// Exports: GuildIconWithChannelType

// Module 11266 (GuildIconWithChannelType)
...
let obj2 = {};
obj2[obj.SMALL_32] = { pileSize: 32, guildIconSize: fn(5796).GuildIconSizes.XSMALL, typeIconSize: 12, typeIconPadding: 4, gap: 3 };
const createStyles = fn(4756);
let obj5 = { typeIconWrapper: null };
let obj3 = { pileSize: 32, guildIconSize: fn(5796).GuildIconSizes.XSMALL, typeIconSize: 12, typeIconPadding: 4, gap: 3 };
