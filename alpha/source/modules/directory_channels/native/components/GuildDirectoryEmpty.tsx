...
// Dependencies: [19, 17, 2096, 1074, 21, 4756, 576, 1612, 504, 12559, 13006, 1177, 1115, 4752, 8870, 12560, 13007, 10075, 13008, 2]
// Exports: default

// Module 13005 (GuildDirectoryEmpty)
...
export default function GuildDirectoryEmpty(guild) {
  ...
  if (canCreateOrAddGuildInDirectory) {
    const obj9 = {
      ...
      iconSource: tmp2(13007),
      title: null
    };
    const intl3 = tmp4(1115).intl;
    obj9.title = intl3.string(tmp4(1115).t.hyK15i);
    tmp8Result = tmp8(tmp4(8870).FormCTA, obj9);
  }
  items2[3] = tmp8Result;
  const obj10 = {
    style: tmp.ctaContainer,
    ...
    iconSource: channel(13008),
    title: null
  };
  const intl4 = tmp4(1115).intl;
  obj10.title = intl4.string(guild(1115).t.L4bwJ9);
  items2[4] = closure_7(guild(8870).FormCTA, obj10);
