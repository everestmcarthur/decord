...
// Dependencies: [19, 17, 21, 4722, 576, 5611, 12580, 2]

// Module 12579 (GuildDirectoryPlaceholderRow)
...
let size = { width: 40, height: 40, borderRadius: nativeDefault.radii.sm, overflow: "hidden", marginRight: 16, backgroundColor: fn(5611).DARK_PRIMARY_500_LIGHT_PRIMARY_230 };
obj.placeholderAvatar = size;
obj.placeholderText = { height: 15, borderRadius: 5, backgroundColor: fn(5611).DARK_PRIMARY_500_LIGHT_PRIMARY_230 };
obj.placeholderBody = { width: "100%", marginTop: 10 };
let closure_5 = createStyles.createStyles(obj);
let obj3 = { height: 15, borderRadius: 5, backgroundColor: fn(5611).DARK_PRIMARY_500_LIGHT_PRIMARY_230 };
size = fn(2);
