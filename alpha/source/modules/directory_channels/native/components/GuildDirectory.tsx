...
// Function ID: 12920
// Name: GuildDirectory
// Dependencies: [19, 17, 2063, 4771, 12564, 12557, 12562, 1074, 21, 4756, 576, 12920, 12921, 12587, 12588, 4752, 12922, 1115, 5186, 7291, 12149, 12923, 12559, 5334, 12560, 13004, 504, 1612, 7715, 9, 7350, 4588, 12568, 1241, 13005, 12552, 13009, 2]
// Exports: default

// Module 12919 (GuildDirectory)
...
import GuildDirectoryRowDefault from "GuildDirectoryRow" /* 12587 */;
import GuildDirectoryPlaceholderRowDefault from "GuildDirectoryPlaceholderRow" /* 12588 */;
import GuildDirectoryRowGenerator from "GuildDirectoryRowGenerator" /* 12921 */;
import _mod12922 from "module_12922" /* 12922 */;
import HubProgressHeaderDefault from "HubProgressHeader" /* 12923 */;
import GuildDirectoryCategorySelectorDefault from "GuildDirectoryCategorySelector" /* 13009 */;
...
function GuildDirectoryFooter(hideFooter) {
  ...
  if (obj.useCanCreateOrAddGuildInDirectory(channel)) {
    ...
    if (!hideFooter.hideFooter) {
      ...
      const obj4 = { style: tmp.addIcon, children: closure_19(tmp2(13004).PlusMediumIcon, {}) };
      ...
      tmp4 = closure_19(tmp2(5334).PressableOpacity, obj2);
    }
  }
  return tmp4;
}
