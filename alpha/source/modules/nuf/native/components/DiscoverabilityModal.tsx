...
// Dependencies: [19, 17, 12919, 1372, 1074, 21, 4722, 576, 5852, 1484, 504, 12926, 1094, 12946, 12990, 12939, 1249, 7196, 1115, 2]

// Module 12989 (DiscoverabilityModal)
...
import ContactSyncNameInputDefault from "ContactSyncNameInput" /* 12939 */;
...
function DiscoverabilityNameScene() {
  ...
  const callback = noop.useCallback((arg0) => {
    const result = allowPhone(12946).startContactSyncForDiscoverability(arg0);
    const obj = allowPhone(12946);
    const result1 = allowPhone(12946).closeDiscoverabilityModal(false);
  }, []);
...
let obj2 = { container: { flex: 1, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, justifyContent: "center", paddingBottom: 44, paddingTop: fn(5852).NAV_BAR_HEIGHT + 32 } };
