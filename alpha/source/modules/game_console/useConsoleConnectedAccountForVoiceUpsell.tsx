...
// Dependencies: [5493, 5491, 4773, 9357, 1074, 504, 17577, 2]
// Exports: default

// Module 17576 (useConsoleConnectedAccountForVoiceUpsell)
...
const require = fn;
const CONSOLE_VOICE_PLATFORMS = fn(9357).CONSOLE_VOICE_PLATFORMS;
