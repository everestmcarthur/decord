...
// Dependencies: [5, 32, 19, 17, 1085, 21, 4756, 576, 7390, 7389, 4752, 12043, 4723, 5184, 5899, 5817, 15833, 7429, 8153, 4704, 15932, 2]
// Exports: default

// Module 15931 (DevToolsOTATestScreen)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4752 */;
import ClipboardUtils from "ClipboardUtils" /* 7429 */;
import BundleUpdaterDefault from "BundleUpdater" /* 12043 */;
...
export default function DevToolsOTATestScreen() {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp5(12043).verifyOtaFiles(), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
  ...
  const items = [
    closure_8(subLabel(5817).TableRow, { label: "Status", subLabel: tmp8[0], icon: closure_8(subLabel(15833).WrenchIcon, {}) }),
    closure_8(subLabel(5817).TableRow, {
  ...
  obj2.children = items;
  const items1 = [closure_9(subLabel(5899).TableRowGroup, obj2), , , ];
  let str;
  if (tmp5 != null) {
    str = tmp5.source;
  }
  ...
  let obj3 = { label: "Status", subLabel: tmp8[0], icon: closure_8(subLabel(15833).WrenchIcon, {}) };
  let obj4 = {
    label: "Root Path (tap to copy)",
    subLabel,
    onPress: function copyRootPath() {
  ...
  const items2 = [closure_8(subLabel(5817).TableRow, { label: "Manifest Source", subLabel: str, icon: closure_8(subLabel(15833).WrenchIcon, {}) }), ];
  const obj6 = { icon: closure_8(subLabel(8153).PaperIcon, {}), label: null };
  let str2 = "{}";
  if (null != tmp5) {
  ...
  obj6.label = str2;
  items2[1] = closure_8(subLabel(5817).TableRow, obj6);
  obj7.children = items2;
  items1[1] = closure_9(subLabel(5899).TableRowGroup, obj7);
  let obj8 = { icon: closure_8(subLabel(15833).WrenchIcon, {}), label: "Is cookie set?", subLabel: null };
  let str3 = "Yes";
  if (null == tmp7) {
    str3 = "No";
  }
  obj8.subLabel = str3;
  const items3 = [closure_8(subLabel(5817).TableRow, obj8), ];
  let tmp12Result = null != tmp7;
  if (tmp12Result) {
    const obj9 = { icon: tmp12(tmp15(15833).WrenchIcon, {}), label: null };
    const _JSON = JSON;
    obj9.label = JSON.stringify(tmp7, null, 2);
    tmp12Result = tmp12(tmp15(5817).TableRow, obj9);
  }
  items3[1] = tmp12Result;
  items1[2] = closure_9(subLabel(5899).TableRowGroup, { title: "Build Override Cookie", hasIcons: true, children: items3 });
  let obj5 = { label: "Manifest Source", subLabel: str, icon: closure_8(subLabel(15833).WrenchIcon, {}) };
  const items4 = [closure_8(subLabel(5817).TableRow, { label: "Check for Update & Reload", icon: closure_8(subLabel(4704).DownloadIcon, {}), onPress: BundleUpdaterDefault.checkForUpdateAndReload }), ];
  ...
  items4[1] = closure_8(subLabel(5817).TableRow, {
    label: "Verify OTA Files",
    subLabel: str4,
    icon: closure_8(subLabel(15932).ClipboardCheckIcon, {}),
  ...
  items1[3] = closure_9(subLabel(5899).TableRowGroup, obj12);
