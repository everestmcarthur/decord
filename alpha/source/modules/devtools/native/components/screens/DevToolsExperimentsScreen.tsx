...
// Dependencies: [32, 19, 17, 4671, 502, 2063, 4672, 21, 4756, 576, 11733, 11734, 7221, 7289, 12065, 12, 1177, 8500, 7290, 7295, 8135, 4676, 4723, 5817, 4752, 1254, 12062, 5899, 8133, 7429, 4454, 4715, 7390, 7389, 2]
...
function GuildExperimentDebugView(arg0) {
  ...
  if (0 === mapped.length) {
    let mapped3 = tmp19(tmp20(5817).TableRow, { label: "none" });
  } else {
  ...
  constructor(arg0) {
    ...
    callback = closure_4.useCallback(() => {
      ClipboardUtils.copy(uRLForExperiment, () => {
        const obj = uRLForExperiment(4454);
        obj.open({ key: "experiment-link-copied", content: "Copied experiment link", IconComponent: onCopyLink(4715).CircleCheckIcon, iconColor: "status-positive" });
        if (closure_1_0 != null) {
          closure_1_0();
        }
      });
