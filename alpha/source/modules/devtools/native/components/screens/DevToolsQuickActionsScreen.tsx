...
// Dependencies: [32, 5, 19, 17, 4748, 5489, 1373, 2109, 1182, 1184, 1372, 7953, 1074, 12956, 1374, 11624, 1185, 21, 4756, 576, 12997, 573, 12955, 9471, 14711, 4959, 15940, 1980, 11663, 2024, 2027, 15052, 15054, 13956, 4454, 15833, 15956, 1612, 504, 2019, 15957, 5899, 7440, 15848, 1177, 15533, 4607, 15593, 15958, 10507, 1115, 5817, 15688, 5824, 7196, 15959, 15990, 7206, 1231, 1350, 1364, 2]
// Exports: default

// Module 15939 (DevToolsQuickActionsScreen)
...
import requestReviewModalDefault from "requestReviewModal" /* 13956 */;
...
import OverridePremiumTypeActions from "OverridePremiumTypeActions" /* 15958 */;
...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11663, dependencyMap.paths), {
    onClose() {
...
function launchTotpSetupSuccess() {
  ...
  const items = [asyncRequireImpl(15052, dependencyMap.paths), asyncRequireImpl(15054, dependencyMap.paths)];
...
function launchMFA() {
  ModalActionCreatorsDefault.pop();
  asyncRequireImpl(15940, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  const tmp2 = locale;
  let isCheckpointEnabled = locale(15956).useIsCheckpointEnabled("DevToolsQuickActionsScreen");
  let obj = locale(15956);
  ...
  if (tmp9) {
    return closure_21(tmp2(15957).default, {});
  } else {
    ...
    obj8.children = closure_21(tmp2(7440).TableSwitchRow, obj9);
    const items5 = [closure_21(tmp2(5899).TableRowGroup, obj8), , , , , , , , , ];
    ...
    const obj12 = { label: str, disabled: usingSystemTheme, icon: tmp15(tmp2(15533).ThemeLightIcon, {}), value: tmp2(4607).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [tmp15(tmp2(7440).TableSwitchRow, obj12), ];
    const obj13 = { label: "Reduced Motion", icon: tmp15(tmp2(15593).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    items6[1] = tmp15(tmp2(7440).TableSwitchRow, obj13);
    obj11.children = items6;
    items5[2] = closure_22(tmp2(5899).TableRowGroup, obj11);
    ...
    const obj18 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp12, icon: tmp15(tmp2(15688).LanguageIcon, {}), trailing: tmp15(tmp2(5824).TableRowArrow, {}) };
    const items7 = [tmp15(tmp2(5817).TableRow, obj18), , , , , , , , , ];
    const obj19 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: tmp15(tmp2(7196).KeyIcon, {}), trailing: tmp15(tmp2(5824).TableRowArrow, {}) };
    items7[1] = tmp15(tmp2(5817).TableRow, obj19);
    ...
    obj20.icon = tmp15(tmp2(15833).WrenchIcon, {});
    obj20.trailing = tmp15(tmp2(5824).TableRowArrow, {});
    items7[2] = tmp15(tmp2(5817).TableRow, obj20);
    const obj21 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: tmp15(tmp2(7196).KeyIcon, {}), trailing: tmp15(tmp2(5824).TableRowArrow, {}) };
    items7[3] = tmp15(tmp2(5817).TableRow, obj21);
    const obj22 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: tmp15(tmp2(7196).KeyIcon, {}), trailing: tmp15(tmp2(5824).TableRowArrow, {}) };
    items7[4] = tmp15(tmp2(5817).TableRow, obj22);
    const obj23 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: tmp15(tmp2(7196).KeyIcon, {}), trailing: tmp15(tmp2(5824).TableRowArrow, {}) };
    items7[5] = tmp15(tmp2(5817).TableRow, obj23);
    if (isCheckpointEnabled) {
      const obj24 = {
        label: "Launch Checkpoint",
        subLabel: "Look back at your year on Discord",
        onPress() {
              return showDevWidget(15959)("devtools");
            },
        icon: tmp15(tmp2(7196).KeyIcon, {}),
        trailing: tmp15(tmp2(5824).TableRowArrow, {})
      };
      isCheckpointEnabled = tmp15(tmp2(5817).TableRow, obj24);
    }
    items7[6] = isCheckpointEnabled;
    const obj25 = { label: "Test captcha", onPress: tmp2(15990).showCaptchaTestModal, icon: tmp15(tmp2(7196).KeyIcon, {}), trailing: tmp15(tmp2(5824).TableRowArrow, {}) };
    items7[7] = tmp15(tmp2(5817).TableRow, obj25);
    const obj26 = {
      label: "Ignored Profile Speedbump Suppression",
      subLabel: "Suppresses the speedbump for ignored profiles.",
      icon: tmp15(tmp2(7206).EyeSlashIcon, {}),
      value: setting,
      onValueChange() {
    ...
    const items8 = [tmp15(tmp2(5817).TableRow, obj30), , , , , ];
    const obj31 = {
      icon: tmp15(tmp2(15833).WrenchIcon, {}),
    ...
    items8[1] = tmp15(tmp2(5817).TableRow, obj31);
    const obj32 = {
      icon: tmp15(tmp2(15833).WrenchIcon, {}),
    ...
    items8[2] = tmp15(tmp2(5817).TableRow, obj32);
    const obj33 = {
      icon: tmp15(tmp2(15833).WrenchIcon, {}),
    ...
    items8[3] = tmp15(tmp2(5817).TableRow, obj33);
    const obj34 = {
      icon: tmp15(tmp2(15833).WrenchIcon, {}),
    ...
    items8[4] = tmp15(tmp2(5817).TableRow, obj34);
    const obj35 = {
      icon: tmp15(tmp2(15833).WrenchIcon, {}),
    ...
    items8[5] = tmp15(tmp2(5817).TableRow, obj35);
    obj29.children = items8;
    items5[8] = closure_22(tmp2(5899).TableRowGroup, obj29);
    ...
    if (isIOSResult) {
      ...
      obj38.children = tmp15(tmp2(5817).TableRow, obj39);
      items9[1] = tmp15(tmp2(5899).TableRowGroup, obj38);
