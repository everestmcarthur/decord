...
// Dependencies: [5, 19, 17, 1220, 12814, 2063, 4577, 16010, 1074, 21, 4756, 576, 1271, 4348, 4653, 12740, 15890, 7440, 12746, 2024, 2027, 1612, 504, 4752, 5899, 5817, 2]
// Exports: default

// Module 16009 (DevToolsGuildPowerupsScreen)
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12746).markContentAsDismissed(dc, guildId, false);
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj5.style = items4;
    obj5.children = closure_18(tmp5(4752).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
