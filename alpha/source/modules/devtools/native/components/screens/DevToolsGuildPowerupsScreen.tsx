...
// Dependencies: [5, 19, 17, 1220, 12805, 1980, 4543, 15934, 1074, 21, 4722, 576, 1271, 4314, 4619, 12731, 15835, 7396, 12737, 1941, 1944, 1612, 504, 4718, 5857, 5775, 2]
// Exports: default

// Module 15933 (DevToolsGuildPowerupsScreen)
...
import toggleDismissibleContentDismissStateDefault from "toggleDismissibleContentDismissState" /* 15835 */;
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12737).markContentAsDismissed(dc, guildId, false);
      const tmpResult = tmp(12737);
    } else {
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj5.style = items4;
    obj5.children = closure_18(tmp5(4718).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
