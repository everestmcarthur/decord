...
// Dependencies: [32, 19, 17, 11677, 21, 4722, 576, 9101, 15800, 7177, 504, 12032, 5142, 5857, 5775, 4668, 7385, 4419, 15364, 4679, 5855, 5858, 6799, 5144, 1370, 2]

// Module 15799 (DevToolsBuildOverrideScreen)
...
let items = [{ label: "Branch Name", value: "branch", icon: jsx(fn(9101).TagIcon, {}) }, ];
let obj5 = { label: "Branch Name", value: "branch", icon: jsx(fn(9101).TagIcon, {}) };
items[1] = { label: "Commit SHA", value: "id", icon: jsx(fn(15800).HashmarkIcon, {}) };
let obj6 = { label: "Commit SHA", value: "id", icon: jsx(fn(15800).HashmarkIcon, {}) };
const size = fn(2);
...
export default noop.memo(() => {
  ...
  const stateFromStores = first(504).useStateFromStores(items, () => {
    ...
    let tmp;
    if (overrides != null) {
      tmp = overrides[first(undefined, 12032).DEVICE_FIELD];
    }
    return tmp;
  });
  ...
  obj3.paddingBottom = tmp.contentContainer.padding + first(7177)({ includeKeyboardHeight: true }).insets.bottom;
  obj2.contentContainerStyle = obj3;
  let tmp10Result = null;
  if (null != stateFromStores) {
    const obj4 = { icon: tmp7(tmp3(4668).CopyIcon, {}), label: null, subLabel: null, onPress: null };
    first = stateFromStores;
    ...
    const items1 = [tmp7(tmp3(5775).TableRow, obj4), , ];
    const obj6 = { icon: tmp7(tmp3(15364).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(12032).refreshBuildOverride, arrow: true };
    items1[1] = tmp7(tmp3(5775).TableRow, obj6);
    const obj7 = { icon: tmp7(tmp3(4679).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(12032).clearBuildOverride, arrow: true };
    items1[2] = tmp7(tmp3(5775).TableRow, obj7);
    obj5.children = items1;
    tmp10Result = tmp10(tmp3(5857).TableRowGroup, obj5);
  }
  ...
  let obj = first(504);
  items2[1] = jsx(first(5855).TableRadioGroup, {
    ...
    children: items.map((value) => {
      value = value.value;
      ({ icon, label } = value);
      return jsx(first(5858).TableRadioRow, { value, label, icon }, value);
    })
  });
  ...
  obj10.label = jsx(first(6799).TextInput, {
    size: "md",
  ...
  obj9.children = jsx(first(5775).TableRow, { icon, label: null });
  items2[2] = jsx(first(5857).TableRowGroup, { title: label1, hasIcons: true, children: null });
  items2[3] = jsx(first(5144).Button, {
  ...
  obj2.children = jsxs(first(5142).Stack, { spacing: 16, children: null });
