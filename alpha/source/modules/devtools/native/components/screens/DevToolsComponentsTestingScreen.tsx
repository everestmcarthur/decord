...
// Dependencies: [32, 19, 17, 2095, 21, 4756, 576, 4980, 1978, 8380, 5819, 4752, 16019, 16022, 5186, 5184, 16023, 573, 2]
// Exports: default

// Module 16018 (DevToolsComponentsTestingScreen)
...
function Select(children) {
  ...
  if (type1 === obj.type) {
    ...
    tmp6(tmp4(4752).Text, state);
  } else {
    items[2] = tmp7(tmp4(4752).Text, { variant: "text-md/normal", children: "Nothing selected" });
    let str3 = "off";
    if (tmp2) {
      str3 = "on";
    }
    ...
    items[3] = tmp7(tmp4(5186).Button, obj6);
    obj3.children = items;
