...
// Dependencies: [19, 21, 4756, 576, 1612, 1626, 4624, 4492, 1610, 1094, 4629, 2]
// Exports: default

// Module 10532 (PortalKeyboardFooterIOS)
...
export default function PortalKeyboardFooterIOS(animatedSheetIndex) {
  ...
  const keyboardTypeSharedValue = animatedSheetIndex(4624).useKeyboardTypeSharedValue();
  let obj2 = animatedSheetIndex(4624);
  class S {
    constructor() {
      tmp = closure_0;
      tmp2 = closure_2;
  ...
  let obj3 = animatedSheetIndex(4492);
  S.__closure = { interpolate: animatedSheetIndex(4492).interpolate, progress, bottom, followSystemKeyboard: flag, keyboardType: keyboardTypeSharedValue, KeyboardTypes: animatedSheetIndex(1610).KeyboardTypes, animatedSheetIndex, height, EXPRESSION_FOOTER_HEIGHT: animatedSheetIndex(1094).EXPRESSION_FOOTER_HEIGHT };
  ...
  let obj4 = { interpolate: animatedSheetIndex(4492).interpolate, progress, bottom, followSystemKeyboard: flag, keyboardType: keyboardTypeSharedValue, KeyboardTypes: animatedSheetIndex(1610).KeyboardTypes, animatedSheetIndex, height, EXPRESSION_FOOTER_HEIGHT: animatedSheetIndex(1094).EXPRESSION_FOOTER_HEIGHT };
  return height(flag(4492).View, { style: memo, children: height(animatedSheetIndex(4629).PortalHost, { name: str }) });
};
