...
// Dependencies: [19, 4748, 2063, 4395, 5626, 1074, 1374, 21, 504, 2049, 1115, 4723, 1241, 5643, 5637, 5203, 5645, 5186, 5646, 10487, 5904, 5799, 8869, 2]
// Exports: default
...
export default function StageBoostingActionSheet(channel) {
  ...
  if (stateFromStores2) {
    ...
    if (tmp9) {
      ...
      const items5 = [closure_14(tmp(5186).Button, obj4), ];
      ...
      tmp24Result = tmp24(tmp(5186).Button, obj7);
    }
