...
// Dependencies: [19, 17, 4738, 1958, 7832, 1980, 1963, 10144, 1074, 21, 4722, 5852, 4571, 576, 1241, 4902, 9719, 4925, 4929, 504, 10169, 10272, 1115, 4923, 1177, 4875, 5601, 5595, 5156, 4718, 8860, 8857, 10273, 10274, 8626, 9907, 10275, 10276, 10065, 10146, 10152, 10153, 10158, 10277, 10278, 2]
// Exports: HideChannelCallButton, closeStageModal

// Module 10271 (StageActionHeader)
...
import ChannelCallNavigatorIconDefault from "ChannelCallNavigatorIcon" /* 10169 */;
...
import ChannelCallHeaderButtons from "ChannelCallHeaderButtons" /* 10278 */;
...
let obj3 = { height: fn(5852).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", paddingHorizontal: 12, overflow: "visible" };
...
export const HideChannelCallButton = function HideChannelCallButton(channel) {
  ...
  obj2.children = closure_12(channel(1177).MaskedBadge, { value: stateFromStores, maskStyle: {} });
