...
// Dependencies: [19, 17, 4772, 2041, 7870, 2063, 2046, 10154, 1074, 21, 4756, 5894, 4605, 576, 1241, 4936, 9649, 4959, 4963, 504, 10181, 10284, 1115, 4957, 1177, 4909, 5643, 5637, 5198, 4752, 8899, 8896, 10285, 10286, 8664, 9749, 10287, 10288, 10075, 10156, 10162, 10163, 10168, 10289, 10290, 2]
// Exports: HideChannelCallButton, closeStageModal

// Module 10283 (StageActionHeader)
...
import ChannelCallHeaderButtons from "ChannelCallHeaderButtons" /* 10290 */;
...
let obj3 = { height: fn(5894).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", paddingHorizontal: 12, overflow: "visible" };
