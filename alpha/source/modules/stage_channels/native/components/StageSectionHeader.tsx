...
// Dependencies: [19, 17, 21, 4722, 576, 4458, 4723, 4718, 1177, 7354, 2]
// Exports: default

// Module 10297 (StageSectionHeader)
...
export default function StageSectionHeader(collapsed) {
  ...
  let obj = collapsed(4458);
  const tmp2 = collapsed;
  fn.__closure = { withTiming: collapsed(4723).withTiming, collapsed };
  ...
  obj5.children = items;
  const items1 = [closure_5(collapsed(4718).Text, obj5), , ];
  ...
  let obj2 = { withTiming: collapsed(4723).withTiming, collapsed };
  const tmp7 = closure_5;
  const tmp8 = closure_3;
  obj8.children = closure_6(tmp2(1177).Icon, { source: _modDef7354, style: tmp.collapseIcon });
