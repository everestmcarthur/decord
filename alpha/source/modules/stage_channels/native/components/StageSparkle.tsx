...
// Function ID: 8640
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4722, 576, 8640, 5757, 8641, 4432, 2]
// Exports: default

// Module 8639 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8641) };
  items1[1] = React4(tmp10(5757), obj5);
  obj.children = items1;
