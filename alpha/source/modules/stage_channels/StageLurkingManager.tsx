...
// Dependencies: [1958, 4543, 1899, 573, 7517, 1370, 2]

// Module 13169 (StageLurkingManager)
...
class StageLurkingManager extends tmp2 {
  constructor() {
    ...
    applyArgumentsResult.handleDisconnectFromStageChannel = function handleDisconnectFromStageChannel(guildId) {
      ...
      applyArgumentsResult(7517).stopLurkingAll(items.filter(applyArgumentsResult(1370).isNotNullish));
    };
