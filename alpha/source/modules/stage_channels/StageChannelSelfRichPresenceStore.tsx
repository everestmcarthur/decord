...
// Dependencies: [2041, 2063, 4779, 4405, 2095, 1372, 5630, 2046, 5626, 1074, 4400, 9627, 5637, 4909, 5629, 1331, 504, 573, 2]

// Module 9626 (StageChannelSelfRichPresenceStore)
        ...
        if (obj2.canEveryone(constants2.VIEW_CHANNEL, channel)) {
          ...
          if (null != guild) {
            ...
            if (features.has(constants.DISCOVERABLE)) {
              ...
              const mutableParticipants = StageChannelParticipantStore.getMutableParticipants(channel.id, tmp12(5637).StageChannelParticipantNamedIndex.SPEAKER);
...
const STAGE_APPLICATION_ID = fn(5626).STAGE_APPLICATION_ID;
