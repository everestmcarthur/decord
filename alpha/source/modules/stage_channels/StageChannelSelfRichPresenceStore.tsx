...
// Dependencies: [1958, 1980, 4745, 4371, 2012, 1372, 5588, 1963, 5584, 1074, 4366, 9767, 5595, 4875, 5587, 1331, 504, 573, 2]

// Module 9766 (StageChannelSelfRichPresenceStore)
        ...
        if (obj2.canEveryone(constants2.VIEW_CHANNEL, channel)) {
          ...
          if (null != guild) {
            ...
            if (features.has(constants.DISCOVERABLE)) {
              ...
              const mutableParticipants = StageChannelParticipantStore.getMutableParticipants(channel.id, tmp12(5595).StageChannelParticipantNamedIndex.SPEAKER);
              ...
              if (topic == null) {
                topic = tmp12(4875).computeChannelName(channel, UserStore, RelationshipStore);
                const tmp12Result = tmp12(4875);
              }
              obj.name = topic;
...
const STAGE_APPLICATION_ID = fn(5584).STAGE_APPLICATION_ID;
