...
// Dependencies: [502, 2095, 5633, 5626, 1982, 573, 510, 13219, 2]

// Module 13218 (StageChannelNewUserManager)
...
let require = fn;
let closure_7 = fn(5626).STAGE_AUDIENCE_NOTICE_SHOWN_STORAGE_KEY;
