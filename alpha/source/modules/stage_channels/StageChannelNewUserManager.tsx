...
// Dependencies: [502, 2012, 5591, 5584, 1899, 573, 510, 13171, 2]

// Module 13170 (StageChannelNewUserManager)
...
let require = fn;
let closure_7 = fn(5584).STAGE_AUDIENCE_NOTICE_SHOWN_STORAGE_KEY;
