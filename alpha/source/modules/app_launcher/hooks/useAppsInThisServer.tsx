...
// Dependencies: [19, 9528, 1372, 5168, 504, 9654, 1895, 9538, 12363, 12, 9644, 2]
// Exports: default

// Module 12364 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9528).useGuildIndexState;
const limit = fn(5168).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
