...
// Dependencies: [19, 17, 1483, 21, 4722, 576, 7346, 7345, 7394, 4689, 1177, 2]
// Exports: AppLauncherCommandOptionActionSheet

// Module 12408 (AppLauncherCommandOptionActionSheet)
...
export const AppLauncherCommandOptionActionSheet = function AppLauncherCommandOptionActionSheet(startExpanded) {
  ...
  obj3.leading = <View style={{ alignSelf: "flex-start" }}>{jsx(merged(7394).ActionSheetCloseButton, {
    onPress() {
      ActionSheetActionCreatorsDefault.hideActionSheet();
      const onDismiss = merged.onDismiss;
      if (onDismiss != null) {
  ...
  obj.header = jsx(merged(7345).BottomSheetTitleHeader, { titleContainerStyle: tmp2.titleContainer, titleWrapperStyle: tmp2.titleWrapper, subtitleStyle: tmp2.subtitleWrapper, leading: null, title: null, subtitle: null, trailing: null });
