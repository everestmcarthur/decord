...
// Dependencies: [32, 19, 1074, 21, 4722, 576, 1875, 4689, 12413, 1897, 12411, 5292, 4718, 2]
// Exports: default

// Module 12412 (AppLauncherAutocompleteOption)
...
export default function AppLauncherAutocompleteOption(arg0) {
  ...
  function onPress() {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12413, dependencyMap.paths), "AppLauncherAutocompleteActionSheet", {
      option,
      initChoice,
      onChoiceSelect(arg0) {
        closure_1_9(arg0);
