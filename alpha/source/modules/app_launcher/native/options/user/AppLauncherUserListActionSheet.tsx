...
// Dependencies: [19, 1483, 21, 4722, 4689, 7717, 1177, 12410, 1115, 12408, 12428, 11828, 12409, 5775, 2]
// Exports: default

// Module 12427 (AppLauncherUserListActionSheet)
...
function EmptyStateWithSnowflakeQuery(onPressRow) {
  ...
  obj.data = items;
  return jsx(onPressRow(12409).AppLauncherList, {
    contentContainerStyle: closure_6().emptyState,
    data: null,
    renderItem(label) {
      return jsx(TableRow.TableRow, { label: label.item, start: true, end: true, onPress: onPressRow });
