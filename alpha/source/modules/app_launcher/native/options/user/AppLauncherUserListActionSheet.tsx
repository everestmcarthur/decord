...
// Dependencies: [19, 1483, 21, 4756, 4723, 7761, 1177, 12419, 1115, 12417, 12437, 11837, 12418, 5817, 2]
// Exports: default

// Module 12436 (AppLauncherUserListActionSheet)
...
function EmptyStateWithSnowflakeQuery(onPressRow) {
  ...
  obj.data = items;
  return jsx(onPressRow(12418).AppLauncherList, {
    contentContainerStyle: closure_6().emptyState,
    data: null,
    renderItem(label) {
      return jsx(TableRow.TableRow, { label: label.item, start: true, end: true, onPress: onPressRow });
