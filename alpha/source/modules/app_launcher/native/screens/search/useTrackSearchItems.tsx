...
// Dependencies: [19, 11479, 9047, 1249, 7763, 2]
// Exports: useTrackSearchItems

// Module 12357 (useTrackSearchItems)
      ...
      if (isViewable.isViewable) {
        ...
        if (null != tmp2) {
          if (null == ref.current[tmp2]) {
            ...
            const obj3 = { location: closure_0(7763).ApplicationCommandTriggerLocations.APP_LAUNCHER_HOME_SEARCH, application_id: applicationId, command_id: commandId, search_results_position: isViewable.index, query, source };
