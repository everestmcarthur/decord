...
// Dependencies: [19, 21, 4722, 576, 4458, 5143, 5147, 2]
// Exports: usePinnedSearchBarBottomBorder

// Module 12339 (SearchBarBottomBorder)
...
export const usePinnedSearchBarBottomBorder = function usePinnedSearchBarBottomBorder(arg0) {
  ...
  let tmp = closure_5();
  const sharedValue = triggerScrollHeight(4458).useSharedValue(0);
  ...
  let obj = triggerScrollHeight(4458);
  const fn = function u() {
    let num = 0;
  ...
  const obj2 = triggerScrollHeight(4458);
  fn.__closure = { withSpring: triggerScrollHeight(5143).withSpring, scrollPosition: sharedValue, triggerScrollHeight, springStandard: triggerScrollHeight(5147).springStandard };
  ...
  obj5.style = items2;
  obj4.bottomBorderComponent = jsx(sharedValue(4458).View, { style: null }, key);
  return obj4;
};
