...
export const AppLauncherCommandViewHeader = function AppLauncherCommandViewHeader(onPress) {
  ...
  let obj = scrollOffsetY(4492);
  A.__closure = { interpolate: scrollOffsetY(4492).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE };
  A.__workletHash = 15596175827193;
  A.__initData = __initData;
  const animatedStyle = obj.useAnimatedStyle(A);
  let obj2 = { interpolate: scrollOffsetY(4492).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE };
  class E {
    constructor() {
  ...
  let obj3 = scrollOffsetY(4492);
  E.__closure = { APP_ICON_SIZE: 72, APP_ICON_BORDER_WIDTH: 4, DEFAULT_CONTENT_PADDING, interpolate: scrollOffsetY(4492).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE };
  E.__workletHash = 13563524587234;
  E.__initData = __initData2;
  const animatedStyle1 = obj3.useAnimatedStyle(E);
  let obj4 = { APP_ICON_SIZE: 72, APP_ICON_BORDER_WIDTH: 4, DEFAULT_CONTENT_PADDING, interpolate: scrollOffsetY(4492).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE };
  class N {
    constructor() {
      obj = { opacity: null };
      obj2 = closure_0(closure_2[8]);
  ...
  let obj5 = scrollOffsetY(4492);
  N.__closure = { interpolate: scrollOffsetY(4492).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE };
  N.__workletHash = 2637023147700;
  N.__initData = __initData3;
  const animatedStyle2 = obj5.useAnimatedStyle(N);
  let obj6 = { interpolate: scrollOffsetY(4492).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE };
  let str = scrollOffsetY(4457).useToken(section(576).colors.BACKGROUND_BASE_LOW);
  const obj7 = scrollOffsetY(4457);
  ...
  items4[2] = tmp16(scrollOffsetY(4752).Text, obj12);
  ...
  obj13.style = items6;
  items4[4] = tmp16(section(4492).View, obj13);
