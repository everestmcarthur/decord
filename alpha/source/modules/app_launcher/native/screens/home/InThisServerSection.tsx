...
// Dependencies: [19, 17, 21, 4756, 576, 12339, 1370, 4752, 1115, 5334, 12302, 9183, 9522, 12307, 2]
// Exports: default

// Module 12361 (InThisServerSection)
...
export default function InThisServerSection(arg0) {
  ...
  if (0 === items.length) {
    ...
    if (tmp5Result) {
      ...
      tmp5Result = tmp5(tmp11(5334).PressableOpacity, obj4);
    }
    items2[1] = tmp5Result;
