...
// Dependencies: [32, 19, 9530, 9528, 9529, 12310, 5168, 5169, 9533, 1895, 9527, 9643, 12281, 12312, 12, 9647, 504, 9483, 12311, 12313, 2]
...
// Module 12309 (AppLauncherSearchUtils)
...
import SearchAppsRequestSource from "SearchAppsRequestSource" /* 12311 */;
import ArraySearch from "ArraySearch" /* 12312 */;
import ApplicationDirectoryActionCreatorsAll from "ApplicationDirectoryActionCreators" /* 12313 */;
  ...
  return (applicationId) => {
    if (applicationId.applicationId in closure_2) {
      ...
      if (FAKE_BUILT_IN_APP == null) {
        FAKE_BUILT_IN_APP = tmp3(9527).FAKE_BUILT_IN_APP;
      }
      const sectionName = AppLauncherUtils.getSectionName(FAKE_BUILT_IN_APP);
      tmp3 = require;
