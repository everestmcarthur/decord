...
// Dependencies: [19, 17, 1372, 21, 4722, 576, 1177, 504, 18248, 18251, 1397, 4718, 1115, 2774, 5292, 2480, 9036, 15141, 15095, 4420, 5142, 5862, 9291, 15100, 2]
// Exports: default

// Module 18250 (PendingRequestList)
import nativeDefault from "native" /* 576 */;
import AvatarUtilsDefault from "AvatarUtils" /* 1397 */;
import _modDef2774 from "module_2774" /* 2774 */;
import useRefreshLinkCodeOnExpiryDefault from "useRefreshLinkCodeOnExpiry" /* 15095 */;
...
export default function PendingRequestList(arg0) {
  ...
  obj7.children = intl.string(_modDef2774["/SbB94"]);
  ...
  obj17.accessibilityLabel = intl5.string(_modDef2774.z9gkwZ);
