...
// Dependencies: [19, 21, 10628, 10624, 4454, 1115, 10639, 10626, 1221, 8535, 8639, 10492, 576, 10498, 2]

// Module 13257 (MediaViewerOverlayButtonFavoriteGIF)
...
export default noop.memo(function GIFFavButton(source) {
  ...
  const callback = noop.useCallback(() => {
    if (isFavoriteGIF) {
      tmp(10624).removeFavoriteGIF(uri);
      const tmpResult = tmp(10624);
      ...
      const gIFThumbnailForFavorite = tmp(10626).getGIFThumbnailForFavorite({ providerName: null, thumbnail: null });
      const obj6 = { providerName: null, thumbnail: null };
      const tmpResult2 = tmp(10626);
