...
// Dependencies: [19, 21, 4722, 576, 1612, 1936, 5292, 11775, 4718, 1115, 2]

// Module 13212 (MediaModalOverlayAltText)
...
export default noop.memo(function MediaModalOverlayAltTextButton(description) {
  ...
  if (ViewImageDescriptions.useSetting()) {
    ...
    if (0 !== str.length) {
      ...
      obj.children = jsx(tmp3(4718).Text, { variant: "text-xs/semibold", color: "text-overlay-light", children: null });
      tmp4 = jsx(tmp3(5292).PressableOpacity, {
        style: tmp2.container,
        onPress() {
              if (str == null) {
                str = "";
