...
// Dependencies: [32, 19, 17, 21, 1364, 4622, 13274, 13275, 8535, 8534, 11911, 8530, 6892, 13276, 9700, 2]

// Module 13273 (MediaViewerItem)
import PlatformUtils2 from "PlatformUtils" /* 1364 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6892 */;
import useMediaViewerSources from "useMediaViewerSources" /* 8530 */;
import useEntranceAnimation from "useEntranceAnimation" /* 13275 */;
...
export const MediaViewerItem = noop.memo((index) => {
  ...
  const memo = obj.useMemo(() => {
    ...
    const Gesture2 = tmp(6892).Gesture;
    ...
    const Gesture5 = tmp(6892).Gesture;
    ...
    const Gesture6 = tmp(6892).Gesture;
