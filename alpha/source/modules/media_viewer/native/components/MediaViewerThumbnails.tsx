...
// Dependencies: [32, 19, 17, 8524, 21, 13207, 4423, 576, 4458, 5132, 1364, 4722, 5757, 8497, 4459, 7268, 2]
// Exports: default

// Module 13206 (MediaViewerThumbnails)
...
function ObscuredView(source) {
  ...
  if (tmp4) {
    if (source.spoiler) {
      ...
      tmp10Result = tmp10(tmp7(4458).View, obj2);
