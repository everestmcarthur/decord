...
// Function ID: 13227
// Name: MediaViewer
// Dependencies: [32, 19, 17, 21, 1364, 4458, 13227, 13228, 8499, 6848, 7268, 7358, 7378, 8525, 13232, 4723, 8494, 8564, 9719, 4459, 9721, 2]

// Module 13226 (MediaViewer)
import ReanimatedRexport from "ReanimatedRexport" /* 4458 */;
import timing from "timing" /* 4723 */;
import useVideoControls from "useVideoControls" /* 8494 */;
import MediaViewerDimensionsContext from "MediaViewerDimensionsContext" /* 8525 */;
import MediaViewerItem from "MediaViewerItem" /* 13228 */;
...
function MediaViewer(arg0) {
  ...
  value = [height(7378).MEDIA_VIEWER];
  let tmp = height;
  const tmp3 = height(7358);
  ...
  const tmp9 = height(13232)({ index, onClose, sources, windowHeight: height, windowWidth: width });
  dependencyMap = tmp9;
  ...
  const items5 = [translatePos(height(9719), { barStyle: "light-content", hidden: !tmp5 }), translatePos(height(4458).View, { style: animatedStyle }), translatePos(height(4459), { ref: animatedRef, style: animatedStyle2, children: translatePos(ref, { entranceAnimationDriver: sharedValue, onContentSizeChange, onScroll, onLongPress, originLayout, panGestureConfig: mediaViewerPanGestureConfig, ref, renderMedia, sources, useItemVisible, windowHeight: height, windowWidth: width, index, zoomed }) }), , ];
  ...
  items5[3] = translatePos(height(4459), obj18);
  items5[4] = translatePos(tmp(9721), {});
  obj16.children = items5;
  const children = tmp28(tmp29, obj16);
  return translatePos(tmp7(7358).AnalyticsLocationProvider, { value: tmp3(value).analyticsLocations, children });
}
