...
// Dependencies: [19, 17, 21, 7138, 15892, 7319, 5142, 4718, 15893, 7169, 2]
// Exports: default
...
export default function MFAOptionScreen(arg0) {
  ...
  if (tmp10Result5) {
    ...
    tmp10Result5 = tmp10(tmp(15893), obj8);
  }
