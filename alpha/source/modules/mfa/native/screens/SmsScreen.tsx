...
// Function ID: 15955
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 1074, 21, 7182, 15947, 1115, 1271, 15951, 15946, 6843, 5186, 15949, 2]
// Exports: default

// Module 15954 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj4 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15951).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  items1[1] = handleChange(mfaChallenge(5186).Button, obj5);
