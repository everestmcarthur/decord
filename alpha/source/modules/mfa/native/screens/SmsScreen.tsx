...
// Function ID: 15900
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 1074, 21, 7138, 15892, 1115, 1271, 15896, 15891, 6799, 5144, 15894, 2]
// Exports: default

// Module 15899 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  const tmp2 = finish(7138)();
  const screenStyles = finish(15892).useScreenStyles(tmp2);
  const tmp4 = first(noop.useState(null), 2);
  dependencyMap = tmp4[1];
  let obj = finish(15892);
  ...
  let obj4 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15896).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  const items1 = [handleChange(mfaChallenge(6799).TextInput, obj4), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(15896).SMS_CODE_LENGTH;
  }
  obj6.disabled = tmp6;
  obj2.submit = handleChange(finish(15894), obj6);
