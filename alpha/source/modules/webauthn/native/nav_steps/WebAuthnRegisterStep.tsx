...
// Dependencies: [32, 19, 17, 14927, 21, 4756, 576, 7187, 1115, 1177, 1484, 1364, 14944, 7363, 14945, 4752, 5645, 5186, 2]
// Exports: default
...
export default function WebAuthnRegisterStep() {
  ...
  const obj8 = {
    children: closure_7(navigation(5186).Button, {
      text: string2Result,
      disabled: tmp7,
      loading: tmp7,
      onPress() {
