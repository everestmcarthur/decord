...
// Dependencies: [32, 19, 17, 14872, 14873, 21, 4722, 576, 504, 5862, 4718, 1115, 5603, 8140, 4679, 4689, 14885, 1897, 10491, 5857, 5775, 14886, 1484, 6789, 7145, 7573, 8831, 2]
// Exports: default

// Module 14884 (PasskeyInitStep)
...
function CredentialList(navigation) {
  ...
  if (0 === credentials.length) {
    ...
    const items1 = [closure_8(tmp(5862).PasskeysSpotIllustration, { scale: 0.6 }), ];
    ...
    items1[1] = closure_8(tmp(4718).Text, obj3);
    ...
    obj4.children = credentials.map((label) => {
      ...
      obj3.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14885, dependencyMap.paths), "WEBAUTHN_DELETE_SHEET_KEY", { credential, deleting, setDeleting });
      };
    ...
    return closure_8(tmp(5857).TableRowGroup, obj4);
  }
