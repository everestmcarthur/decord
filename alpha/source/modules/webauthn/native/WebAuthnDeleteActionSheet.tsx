...
// Dependencies: [19, 17, 21, 4756, 576, 4723, 7390, 7389, 1115, 7438, 4752, 5186, 6833, 4454, 10911, 4715, 9712, 8865, 2]
// Exports: default
...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj4.children = closure_4(credential(4752).Text, obj5);
  ...
  obj6.children = closure_4(credential(5186).Button, obj7);
