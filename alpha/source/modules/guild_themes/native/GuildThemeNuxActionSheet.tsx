...
// Dependencies: [5, 32, 19, 17, 4543, 4609, 1955, 21, 3, 4722, 576, 16419, 4652, 504, 4689, 1115, 7346, 16420, 4718, 5855, 5858, 1177, 5144, 2]
// Exports: default

// Module 16418 (GuildThemeNuxActionSheet)
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  [tmp5, c2] = noop.useState(guildId(16419).getInitialGuildThemeNuxSelection);
  const tmp4 = _slicedToArray(noop.useState(guildId(16419).getInitialGuildThemeNuxSelection), 2);
  [tmp7, c3] = noop.useState(null);
  const tmp6 = _slicedToArray(noop.useState(null), 2);
  [tmp9, c4] = noop.useState(false);
  noop = noop.useRef(false);
  const tmp10 = tmp5 === guildId(4652).GuildThemeSourcePreference.PERSONAL;
  closure_6 = tmp10;
  ...
  const items7 = [closure_10(markAsDismissed(16420), { themeSettings: stateFromStores1, isPersonal: tmp10 }), , , , , , ];
  ...
  items7[1] = closure_10(guildId(4718).Text, obj4);
  ...
  items7[2] = closure_10(guildId(4718).Text, obj5);
  ...
  obj8.value = guildId(4652).GuildThemeSourcePreference.GUILD;
  const items8 = [closure_10(guildId(5858).TableRadioRow, obj8), ];
  const obj9 = { label: null, value: null };
  const intl6 = tmp2(1115).intl;
  obj9.label = intl6.string(guildId(1115).t.js8y7t);
  obj9.value = guildId(4652).GuildThemeSourcePreference.PERSONAL;
  items8[1] = closure_10(guildId(5858).TableRadioRow, obj9);
  obj7.children = items8;
  obj6.children = closure_11(guildId(5855).TableRadioGroup, obj7);
  ...
  obj14.children = closure_10(guildId(5144).Button, obj15);
  items7[6] = closure_10(closure_6, obj14);
  obj3.children = items7;
  return closure_11(guildId(7346).BottomSheet, obj3);
};
