...
// Function ID: 8067
// Name: ForLaterModal
// Dependencies: [19, 17, 21, 4722, 576, 1612, 1115, 8064, 5801, 8067, 1364, 5794, 4925, 13529, 2]
// Exports: default

// Module 8066 (ForLaterModal)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4925 */;
import HeaderShared from "HeaderShared" /* 8067 */;
import ForLaterScreenDefault from "ForLaterScreen" /* 13529 */;
...
export default function ForLaterModal(type) {
  ...
  const items = [closure_4(require("module_5801").Header, obj3), ];
