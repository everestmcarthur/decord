...
// Dependencies: [4723, 12220, 1980, 2]
// Exports: openCustomTypingIndicatorAnnounceActionSheet

// Module 12219 (openCustomTypingIndicatorAnnounceActionSheet)
...
export const openCustomTypingIndicatorAnnounceActionSheet = function openCustomTypingIndicatorAnnounceActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12220, dependencyMap.paths), CustomTypingIndicatorAnnounceActionSheet, {
    markAsDismissed() {
