...
// Dependencies: [4689, 12211, 1897, 2]
// Exports: openCustomTypingIndicatorAnnounceActionSheet

// Module 12210 (openCustomTypingIndicatorAnnounceActionSheet)
...
export const openCustomTypingIndicatorAnnounceActionSheet = function openCustomTypingIndicatorAnnounceActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12211, dependencyMap.paths), CustomTypingIndicatorAnnounceActionSheet, {
    markAsDismissed() {
