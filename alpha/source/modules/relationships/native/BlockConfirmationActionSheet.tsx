...
// Dependencies: [32, 19, 17, 2041, 4405, 1372, 10003, 11643, 1074, 21, 4756, 576, 8453, 1115, 4712, 5899, 5817, 1177, 1612, 7402, 7422, 504, 8449, 7390, 1241, 6864, 8187, 4752, 4908, 7207, 4723, 11645, 1980, 1249, 5186, 10002, 8674, 2108, 4451, 2]

// Module 11644 (BlockConfirmationActionSheet)
...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj13 = { username: tmp2(4908).getName(stateFromStores2, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1115).t.CIbzHR, obj13);
    items9[1] = closure_14(tmp7(4752).Text, obj12);
    ...
    items9[2] = closure_14(tmp7(4752).Text, obj14);
    ...
    if (!stateFromStores1) {
      ...
      obj17.children = tmp13(tmp7(5817).TableRow, obj18);
      obj16.children = tmp13(tmp7(5899).TableRowGroup, obj17);
    ...
    obj22.disabled = tmp6;
    obj22.loading = tmp6;
    const items11 = [closure_14(tmp7(5186).Button, obj22), ];
    ...
    items11[1] = closure_14(tmp7(4752).Text, obj23);
    ...
    tmp13Result2 = tmp13(tmp7(7402).AnalyticsLocationProvider, obj4);
    const tmp2Result = tmp2(4908);
  }
  return tmp13Result2;
});
