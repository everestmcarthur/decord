...
// Dependencies: [32, 19, 17, 2041, 1372, 10003, 11643, 1074, 21, 4756, 576, 8453, 1115, 4712, 5899, 5817, 1177, 1612, 7402, 7422, 504, 1241, 8449, 7390, 6864, 7207, 4752, 4908, 8187, 4723, 11644, 1980, 1249, 5186, 10002, 2108, 4451, 2]

// Module 11645 (IgnoreConfirmationActionSheet)
...
import _modDef4712 from "module_4712" /* 4712 */;
...
export default noop.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(7207) };
    ...
    const obj13 = { username: tmp4(4908).getName(stateFromStores1, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1115).t["WrQD/Y"], obj13);
    items7[1] = closure_13(tmp7(4752).Text, obj12);
    ...
    items7[2] = closure_13(tmp7(4752).Text, obj14);
    ...
    const obj19 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(8187), color: tmp.destructiveIcon.color };
    ...
    obj18.subLabel = closure_13(tmp7(4752).Text, obj20);
    ...
    obj18.onPress = function onPress() {
      ...
      const tmp2 = asyncRequireImpl(11644, dependencyMap.paths);
    ...
    obj17.children = closure_13(tmp7(5817).TableRow, obj18);
    obj16.children = closure_13(tmp7(5899).TableRowGroup, obj17);
    ...
    obj22.disabled = tmp3;
    obj22.loading = tmp3;
    const items9 = [closure_13(tmp7(5186).Button, obj22), ];
    ...
    const obj25 = {
      articleLink() {
          channelId(4723).hideActionSheet();
          const obj = channelId(4723);
          const articleURL = channelId(2108).getArticleURL(constants3.STEALTH_REMEDIATION_FEATURE_GUIDE);
          const obj2 = channelId(2108);
          channelId(4451).openURL(articleURL);
        }
    };
    obj23.children = intl8.format(tmp7(1115).t.iX9qtL, obj25);
    items9[1] = closure_13(tmp7(4752).Text, obj23);
    obj21.children = items9;
    items8[3] = closure_14(stateFromStores, obj21);
    obj8.children = items8;
    obj4.children = closure_14(tmp7(6864).BottomSheetScrollView, obj8);
    obj3.children = closure_13(tmp7(7390).BottomSheet, obj4);
    tmp12Result = tmp12(tmp7(7402).AnalyticsLocationProvider, obj3);
    const tmp4Result = tmp4(4908);
  }
  return tmp12Result;
});
