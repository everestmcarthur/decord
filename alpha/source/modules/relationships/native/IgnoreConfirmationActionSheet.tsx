...
// Dependencies: [32, 19, 17, 1958, 1372, 9281, 11634, 1074, 21, 4722, 576, 8415, 1115, 4678, 5857, 5775, 1177, 1612, 7358, 7378, 504, 1241, 8411, 7346, 6820, 7163, 4718, 4874, 8149, 4689, 11635, 1897, 1249, 5144, 9280, 2025, 4417, 2]

// Module 11636 (IgnoreConfirmationActionSheet)
...
import _modDef4678 from "module_4678" /* 4678 */;
...
const UserRemediationAction = fn(9281).UserRemediationAction;
const RestrictionConfirmationConstants = fn(11634);
...
export default noop.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  items = [channelId(7378).IGNORE_CONFIRMATION_ACTION_SHEET];
  const tmp6 = channelId(7358);
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(7163) };
    ...
    const obj13 = { username: tmp4(4874).getName(stateFromStores1, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1115).t["WrQD/Y"], obj13);
    items7[1] = closure_13(tmp7(4718).Text, obj12);
    ...
    items7[2] = closure_13(tmp7(4718).Text, obj14);
    ...
    const obj19 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(8149), color: tmp.destructiveIcon.color };
    ...
    obj18.subLabel = closure_13(tmp7(4718).Text, obj20);
    ...
    obj18.onPress = function onPress() {
      ...
      const tmp2 = asyncRequireImpl(11635, dependencyMap.paths);
    ...
    obj17.children = closure_13(tmp7(5775).TableRow, obj18);
    obj16.children = closure_13(tmp7(5857).TableRowGroup, obj17);
    ...
    obj22.onPress = function onPress() {
      ...
      RelationshipActionCreatorsDefault.ignoreUser(userId, AnalyticsLocationDefault.IGNORE_CONFIRMATION_ACTION_SHEET, channelId).then(() => {
        ...
        channelId(4689).hideActionSheet();
      });
    ...
    obj22.disabled = tmp3;
    obj22.loading = tmp3;
    const items9 = [closure_13(tmp7(5144).Button, obj22), ];
    ...
    const obj25 = {
      articleLink() {
          channelId(4689).hideActionSheet();
          const obj = channelId(4689);
          const articleURL = channelId(2025).getArticleURL(constants3.STEALTH_REMEDIATION_FEATURE_GUIDE);
          const obj2 = channelId(2025);
          channelId(4417).openURL(articleURL);
        }
    };
    obj23.children = intl8.format(tmp7(1115).t.iX9qtL, obj25);
    items9[1] = closure_13(tmp7(4718).Text, obj23);
    obj21.children = items9;
    items8[3] = closure_14(stateFromStores, obj21);
    obj8.children = items8;
    obj4.children = closure_14(tmp7(6820).BottomSheetScrollView, obj8);
    obj3.children = closure_13(tmp7(7346).BottomSheet, obj4);
    tmp12Result = tmp12(tmp7(7358).AnalyticsLocationProvider, obj3);
