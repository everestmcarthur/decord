...
// Dependencies: [32, 19, 17, 9705, 1074, 21, 4722, 1177, 9727, 1478, 7177, 9730, 4458, 5143, 9731, 9732, 6848, 1364, 2]

// Module 9726 (PictureInPicture)
...
const toggleFocus = fn(9705).toggleFocus;
