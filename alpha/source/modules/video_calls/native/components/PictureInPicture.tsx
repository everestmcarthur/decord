...
// Dependencies: [32, 19, 17, 9639, 1074, 21, 4756, 1177, 9657, 1478, 7221, 9660, 4492, 5185, 9661, 9662, 6892, 1364, 2]

// Module 9656 (PictureInPicture)
...
const toggleFocus = fn(9639).toggleFocus;
