...
// Function ID: 9736
// Name: CallBarAction
// Dependencies: [19, 17, 9705, 21, 4571, 576, 4722, 9736, 5292, 9737, 4718, 2]
// Exports: NotifiedActionButton, PrimaryActionButton, ToggledActionButton

// Module 9735 (CallBarAction)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4718 */;
import Pressables from "Pressables" /* 5292 */;
import CircleWithCutoutUtilsDefault from "CircleWithCutoutUtils" /* 9737 */;
...
const resetFocusTimer = fn(9705).resetFocusTimer;
const jsxProd = fn(21);
