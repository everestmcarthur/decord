...
// Dependencies: [19, 17, 1074, 21, 4722, 1177, 4458, 9923, 4723, 7319, 1478, 8689, 9924, 9928, 9712, 5129, 7358, 7378, 9878, 9936, 1241, 2]

// Module 9922 (FocusedControls)
...
import useGlobalStatusIndicatorState from "useGlobalStatusIndicatorState" /* 9924 */;
import GlobalStatusIndicator from "GlobalStatusIndicator" /* 9928 */;
...
function FocusedControlsHeader(reveal) {
  ...
  let obj2 = reveal(4458);
  fn2.__closure = { withTiming: reveal(4723).withTiming, offsetY: derivedValue, TIMING_CONFIG };
  ...
  obj4.children = closure_7(reveal(7319).SafeAreaPaddingView, rect);
  return closure_7(derivedValue(4458).View, obj4);
}
...
export default noop.memo((disableGradient) => {
  ...
  const tmp6 = globalStatusIndicatorHeightSharedValue(9923)();
  dependencyMap = tmp6;
  ...
  analyticsLocations = globalStatusIndicatorHeightSharedValue(7358)(tmp5(7378).FOCUSED_VOICE_CONTROLS).analyticsLocations;
  closure_7 = tmp5(9878)();
  ...
  if (null != actionBar) {
    ...
    if (null != expandedControls) {
      ...
      tmp17Result = closure_7(tmp5(9936), obj6);
    }
  }
  items1[2] = tmp17Result;
  obj5.children = items1;
  return closure_8(globalStatusIndicatorHeightSharedValue(4458).View, obj5);
});
