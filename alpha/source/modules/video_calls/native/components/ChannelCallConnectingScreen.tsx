...
// Dependencies: [19, 17, 4773, 1992, 4395, 4774, 9639, 1074, 1085, 21, 4756, 9664, 4723, 7390, 1609, 6864, 10235, 4909, 10194, 10075, 10256, 10257, 1115, 9910, 5623, 4690, 10258, 9768, 504, 10040, 7585, 10265, 10042, 10266, 576, 9714, 10267, 2]
...
export const ChannelCallConnectingHeader = function ChannelCallConnectingHeader(channel) {
  ...
  let tmp9Result = null;
  if (null != fn) {
    const obj2 = { source: tmp2(10257), onPress: fn, accessibilityLabel: null };
    const intl = tmp5(1115).intl;
    const obj3 = { channelName: tmp4 };
    obj2.accessibilityLabel = intl.formatToPlainString(tmp5(1115).t["dHHb/2"], obj3);
    tmp9Result = tmp9(tmp2(10256), obj2);
    const tmp2Result = tmp2(10256);
  }
