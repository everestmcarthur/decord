...
// Dependencies: [19, 17, 17587, 21, 4722, 1115, 5163, 4718, 9596, 2]
// Exports: default

// Module 17588 (HideSelfStreamAndVideoConfirmDialog)
...
const constants = fn(17587).SelfStreamAndVideoAlertType;
const jsxProd = fn(21);
...
export default function HideSelfStreamAndVideoConfirmDialog(arg0) {
  ...
  const items = [closure_5(tmp6(4718).Text, { style: tmp2.description, variant: "text-sm/medium", children: stringResult1 }), ];
  const obj4 = {
  ...
  items[1] = closure_5(tmp6(4718).Text, obj4);
  obj2.children = items;
