...
// Function ID: 9850
// Name: VideoRenderer
// Dependencies: [32, 19, 17, 21, 4722, 9850, 9851, 9853, 1478, 1364, 8564, 9858, 9859, 9861, 4458, 2]

// Module 9849 (VideoRenderer)
...
export default noop.memo((gestureEnabled) => {
  ...
  let onReady;
  const tmp2 = onReady();
  const surfaceDirectRendererExperiment = resizeMode(9850).useSurfaceDirectRendererExperiment(userId, { location: "VideoRenderer" });
  ...
  closure_8 = tmp15;
  const obj = resizeMode(9850);
  [tmp17, c9] = first1(noop.useState(true), 2);
  width(9851)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = width(9853)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  noop.useRef(null);
  ...
  const store = resizeMode(8564).useStore((orientation) => orientation.orientation);
  ...
  if (tmp17) {
    ...
    tmp35 = closure_8(tmp18(9858), obj3);
  }
  const tmp37 = store === resizeMode(8564).OrientationType.PORTRAIT;
  const obj2 = resizeMode(8564);
  if (tmp3Result.isAndroid()) {
    ...
    const items11 = [closure_8(tmp18(9861), obj7), tmp35];
    obj6.children = items11;
    obj5.children = c9(first2, obj6);
    const items12 = [closure_8(tmp18(9859), obj5), ];
    ...
    obj12.children = closure_8(tmp18(9861), obj13);
    const items13 = [closure_8(tmp18(4458).View, obj12), ];
    let tmp48 = null;
    if (tmp37) {
    ...
    const items17 = [closure_8(tmp18(9861), obj16), tmp35];
