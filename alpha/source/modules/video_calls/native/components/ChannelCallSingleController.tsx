...
// Dependencies: [19, 4744, 502, 1074, 4743, 21, 1241, 4902, 504, 10267, 10269, 10270, 2]
// Exports: ChannelCallSingleController

// Module 10266 (ChannelCallSingleController)
...
export const ChannelCallSingleController = function ChannelCallSingleController(selectedParticipant) {
  ...
  if (ParticipantTypes.STREAM === type) {
    if (null == tmp4) {
      ...
      let tmp18 = channel;
      tmp18 = tmp18(selectedParticipant.user.id === tmp15 ? 10267 : 10269);
    ...
    return jsx(channel(10270), { participant: selectedParticipant, channel });
