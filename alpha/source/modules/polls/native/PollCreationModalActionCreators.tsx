...
// Dependencies: [4959, 12449, 1980, 2]
// Exports: closeCreatePollModal, openCreatePollModal

// Module 12448 (PollCreationModalActionCreators)
...
export const openCreatePollModal = function openCreatePollModal(merged) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12449, dependencyMap.paths), merged, c3);
};
