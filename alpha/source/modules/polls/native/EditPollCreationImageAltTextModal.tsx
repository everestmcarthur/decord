...
// Dependencies: [32, 19, 17, 8031, 21, 4722, 576, 12468, 12470, 7319, 1115, 1177, 7188, 4718, 5748, 10061, 8831, 2]
// Exports: default

// Module 12471 (EditPollCreationImageAltTextModal)
import nativeDefault from "native" /* 576 */;
import EditPollCreationImageAltTextModalActionCreators from "EditPollCreationImageAltTextModalActionCreators" /* 12470 */;
...
const MAX_POLL_ANSWER_LENGTH = fn(8031).MAX_POLL_ANSWER_LENGTH;
const jsxProd = fn(21);
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = value(12468)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  const obj4 = { onPress: onSave(12470).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
  const intl = onSave(1115).intl;
  obj4.accessibilityLabel = intl.string(onSave(1115).t.cpT0Cq);
  obj4.children = closure_8(onSave(1177).Icon, { source: value(7188) });
  ...
  items1[1] = closure_8(onSave(4718).Text, obj6);
  ...
  obj7.children = closure_8(onSave(4718).Text, obj8);
  ...
  items4[2] = closure_8(onSave(8831).FormInput, obj14);
  ...
  return closure_9(onSave(7319).SafeAreaPaddingView, obj2);
};
