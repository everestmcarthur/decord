...
// Dependencies: [19, 17, 1955, 21, 4722, 576, 1612, 4689, 7346, 5142, 5862, 4718, 1115, 2252, 5144, 2]
// Exports: default

// Module 7588 (GiftCardMobileConsumptionActionSheet)
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_6(View, { style: tmp.illustration, children: closure_6(markAsDismissed(5862).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
  ...
  items3[1] = closure_6(markAsDismissed(4718).Text, obj5);
  ...
  items3[2] = closure_6(markAsDismissed(5144).Button, obj6);
  obj3.children = items3;
  obj2.children = closure_7(markAsDismissed(5142).Stack, obj3);
  obj.children = closure_6(View, obj2);
  return closure_6(markAsDismissed(7346).BottomSheet, obj);
};
