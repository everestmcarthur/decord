...
// Dependencies: [19, 17, 21, 4722, 576, 6814, 1115, 4566, 7247, 1177, 4718, 6809, 2]
// Exports: default

// Module 11105 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4718).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4718).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6809).CircleXIcon, { size: "xs" });
