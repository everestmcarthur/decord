...
// Dependencies: [5, 1074, 3, 1091, 7314, 17727, 1231, 1241, 7671, 7667, 7657, 2]

// Module 17726 (JSWatchdogManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp2(7657).getSession(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          c3 = 3;
