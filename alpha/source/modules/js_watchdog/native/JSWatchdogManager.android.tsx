...
// Dependencies: [5, 1074, 3, 1091, 7358, 17807, 1231, 1241, 7715, 7711, 7701, 2]

// Module 17806 (JSWatchdogManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp2(7701).getSession(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          c3 = 3;
