...
// Dependencies: [5620, 1074, 573, 4723, 9341, 9372, 9383, 4959, 9394, 1980, 5495, 9396, 8640, 4451, 5618, 2]
// Exports: default

// Module 9340 (authorizeConnection)
import Constants from "Constants" /* 1074 */;
import LinkingDefault from "Linking" /* 4451 */;
import Constants2 from "Constants" /* 5620 */;
      ...
      if (platformType !== tmp.PLAYSTATION_STAGING) {
        if (platformType === tmp.CRUNCHYROLL) {
          ...
          if (true === isFederated) {
            ...
            tmp28(4959).pushLazy(handleModalClose5(1980)(9396, tmp29.paths), obj2);
            if (null != onClose) {
            ...
            tmp28(5618).authorize(platformType, obj5).then((body) => {
