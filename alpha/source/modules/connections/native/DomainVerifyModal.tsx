...
// Dependencies: [32, 19, 17, 1074, 21, 4722, 576, 1484, 1271, 7319, 4718, 1115, 6798, 9520, 5144, 4925, 5794, 7196, 2]
// Exports: default

// Module 9519 (DomainVerifyModal)
...
import DomainVerifyUtils from "DomainVerifyUtils" /* 9520 */;
...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj2.headerLeft = onClose(5794).getHeaderBackButton(onClose);
    ...
    const obj3 = onClose(5794);
    obj4.headerLeft = onClose(5794).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(5794);
    obj6.headerLeft = onClose(5794).getHeaderBackButton(onClose);
    ...
    return closure_8(onClose(7196).Navigator, obj8);
  }
};
