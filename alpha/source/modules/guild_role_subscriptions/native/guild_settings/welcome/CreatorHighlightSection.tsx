...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp6.isLoading) {
    ...
    items3[1] = closure_6(tmp2(4752).Text, obj10);
    ...
    items3[2] = closure_6(tmp2(4752).Text, obj11);
    ...
    if (tmp9Result) {
      ...
      const items5 = [tmp11(tmp2(4752).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4752).Text, obj16);
      }
    ...
    obj18.onPress = tmp7;
    obj17.children = closure_6(tmp2(5187).BaseTextButton, obj18);
