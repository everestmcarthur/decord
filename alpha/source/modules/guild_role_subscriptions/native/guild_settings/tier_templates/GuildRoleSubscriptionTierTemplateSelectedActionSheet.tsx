...
// Dependencies: [19, 17, 2038, 21, 4756, 576, 1612, 7390, 6864, 4752, 1115, 1177, 5187, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [closure_5(markAsDismissed(4752).Text, obj4), closure_5(markAsDismissed(1177).Spacer, { size: 12 }), , , ];
  ...
  items[2] = closure_5(markAsDismissed(4752).Text, obj5);
