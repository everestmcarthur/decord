...
// Dependencies: [19, 17, 1955, 21, 4722, 576, 1612, 7346, 6820, 4718, 1115, 1177, 5145, 2]
// Exports: default

// Module 18146 (GuildRoleSubscriptionTierTemplateSelectedActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [closure_5(markAsDismissed(4718).Text, obj4), closure_5(markAsDismissed(1177).Spacer, { size: 12 }), , , ];
  ...
  items[2] = closure_5(markAsDismissed(4718).Text, obj5);
  ...
  items[4] = closure_5(markAsDismissed(5145).BaseTextButton, obj6);
  obj3.children = items;
