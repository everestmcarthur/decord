...
// Function ID: 10543
// Name: ShinyButton
// Dependencies: [19, 21, 4722, 576, 5145, 1177, 10543, 2]
// Exports: default

// Module 10542 (ShinyButton)
...
export default function ShinyButton(style) {
  ...
  let tmp3Result;
  if (!loading) {
    const obj2 = { size: tmp4(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef10543, style: null };
