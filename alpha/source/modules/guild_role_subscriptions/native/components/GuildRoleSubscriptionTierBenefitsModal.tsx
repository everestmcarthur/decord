...
// Dependencies: [32, 19, 17, 15437, 18098, 15414, 21, 4722, 576, 9288, 5757, 18114, 4718, 1115, 1397, 18115, 14106, 15441, 38, 18093, 8831, 10061, 18116, 18117, 18110, 15421, 18089, 15436, 18119, 18120, 18129, 15440, 18130, 18102, 2]
// Exports: GuildRoleSubscriptionTierChannelBenefitsModal, GuildRoleSubscriptionTierIntangibleBenefitsModal

// Module 18113 (GuildRoleSubscriptionTierBenefitsModal)
...
import useRoleSubscriptionFormatDefault from "useRoleSubscriptionFormat" /* 18089 */;
import GuildRoleSubscriptionTierEditStepDefault from "GuildRoleSubscriptionTierEditStep" /* 18102 */;
import _modDef18114 from "module_18114" /* 18114 */;
import EmojiAliasDefault from "EmojiAlias" /* 18115 */;
import useRoleSubscriptionEmojisDefault from "useRoleSubscriptionEmojis" /* 18119 */;
import GuildRoleSubscriptionsModalActionCreatorsAll from "GuildRoleSubscriptionsModalActionCreators" /* 18120 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;

const AllChannelsSwitchDefault = tmp10(18130);
require = fn;
...
function ListFooterSection(onChangeTrialInterval) {
  ...
  const tmp = closure_15();
  const tmp4 = options(14106)();
  const tmp5 = options(15441)(interval);
  ...
  const roleSubscriptionSettingsDisabled = onChangeTrialInterval(18093).useRoleSubscriptionSettingsDisabled();
  ...
  const items1 = [closure_12(onChangeTrialInterval(8831).FormSwitchRow, obj3), ];
  ...
  const items3 = [closure_12(onChangeTrialInterval(4718).Text, obj5), , , , , , ];
  const obj6 = { style: tmp4.header, children: null };
  const obj = onChangeTrialInterval(18093);
  const intl3 = tmp8(1115).intl;
  obj6.children = intl3.string(onChangeTrialInterval(1115).t.m1KuWd);
  items3[1] = closure_12(options(10061), obj6);
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    type = type.type;
    const obj = { style: closure_1(14106)().header, children: null };
    const tmp2 = closure_1(14106)();
    ...
    return tmp3(closure_1(10061), obj);
  }
  ...
  const obj10 = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
        ...
        obj.onPress = function onPress() {
          ...
          closure_1_2(dependencyMap[29]).showEditBenefitModal({
            ...
            onDelete() {
              ref_type = closure_1;
              if (ref_type.ref_type === constants.CHANNEL) {
                closure_2_8((arr) => arr.filter(/* F128041 */ function() { ... }));
              } else {
                closure_2_10((arr) => arr.filter(/* F128042 */ function() { ... }));
              }
            },
            onSave(ref_type) {
              closure_0 = ref_type;
        ...
        obj.children = closure_12(closure_0(18129).GuildRoleSubscriptionBenefitPreview, obj5);
        tmp3Result = tmp3(closure_1(9288), obj);
        const tmp6 = closure_1(9288);
      }
      return tmp3Result;
    },
...
let AllChannelAccessOptions = fn(15437).AllChannelAccessOptions;
const useGroupIsFullGateState = fn(18098).useGroupIsFullGateState;
