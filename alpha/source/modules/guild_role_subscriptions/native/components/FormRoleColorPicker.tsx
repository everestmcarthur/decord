...
// Dependencies: [19, 1074, 21, 4722, 4689, 16548, 1897, 14104, 14813, 1092, 2]
// Exports: default

// Module 18137 (FormRoleColorPicker)
...
export default function FormRoleColorPicker(color) {
  ...
  const callback = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16548, dependencyMap.paths), "RoleColorPicker", { color, onSelect: onChange });
  }, items);
