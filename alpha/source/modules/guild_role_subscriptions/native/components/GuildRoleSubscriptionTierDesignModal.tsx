...
// Dependencies: [32, 19, 17, 15414, 1074, 21, 4722, 576, 4423, 15447, 14106, 18110, 15436, 7383, 18093, 10061, 1115, 18099, 18137, 18102, 2]
// Exports: GuildRoleSubscriptionTierDesignTab, default

// Module 18136 (GuildRoleSubscriptionTierDesignModal)
...
import GuildRoleSubscriptionMemberPreview from "GuildRoleSubscriptionMemberPreview" /* 15447 */;
...
function Content() {
  ...
  items1[1] = closure_9(role(10061), obj7);
  ...
  items1[2] = closure_9(role(18099), obj8);
  const obj9 = { style: tmp3.header, children: null };
  const tmpResult3 = role(18099);
  const intl3 = tmp4(1115).intl;
  obj9.children = intl3.string(require("util").t["W7hH+z"]);
  items1[3] = closure_9(role(10061), obj9);
  items1[4] = closure_9(role(18137), { color: tmp7, onChange: tmp8, disabled: roleSubscriptionSettingsDisabled });
  obj6.children = items1;
  return closure_10(closure_11, obj6);
}
const View = fn(17).View;
const constants = fn(15414).GuildRoleSubscriptionsTierScenes;
