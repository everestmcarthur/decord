...
// Function ID: 18140
// Name: FormPriceTier
// Dependencies: [19, 18098, 1074, 21, 1115, 14104, 7430, 38, 4689, 9664, 1897, 2]
// Exports: default

// Module 18139 (FormPriceTier)
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9664, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
        },
      placeholder: null
    };
