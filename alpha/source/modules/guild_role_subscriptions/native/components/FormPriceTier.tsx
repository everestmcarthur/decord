...
// Function ID: 18219
// Name: FormPriceTier
// Dependencies: [19, 18177, 1074, 21, 1115, 14158, 7474, 38, 4723, 9539, 1980, 2]
// Exports: default

// Module 18218 (FormPriceTier)
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9539, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
        },
      placeholder: null
    };
