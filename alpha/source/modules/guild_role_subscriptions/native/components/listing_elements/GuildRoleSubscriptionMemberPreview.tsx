...
// Dependencies: [19, 17, 1372, 21, 4722, 576, 1115, 504, 4874, 1397, 7383, 5757, 4718, 1092, 1177, 7401, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 15447 (GuildRoleSubscriptionMemberPreview)
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(7383).getRoleIconData(role, 16);
    const obj2 = { style: null, children: null };
    const items1 = [tmp3.container, style];
    obj2.style = items1;
    const obj3 = { style: tmp3.avatar, source };
    const items2 = [timestampProducer(tmp6(5757), obj3), ];
    ...
    const tmp4Result = tmp4(7383);
    obj7.color = utils_ColorUtilsAll.int2hex(role.color);
    obj6.style = obj7;
    obj6.children = tmp8;
    const items3 = [timestampProducer(tmp4(4718).Text, obj6), , , ];
