...
// Dependencies: [19, 17, 15492, 1074, 21, 4756, 576, 5736, 4474, 10010, 1177, 18210, 1115, 18211, 2]
// Exports: default

// Module 18209 (AllChannelsSwitch)
...
import _modDef18210 from "module_18210" /* 18210 */;
import _modDef18211 from "module_18211" /* 18211 */;
...
const AllChannelAccessOptions = fn(15492).AllChannelAccessOptions;
...
export default function AllChannelsSwitch(style) {
  ...
  obj.style = items;
  const obj2 = { icon: _modDef18210, label: null, selected: null, onPress: null, disabled: null };
  ...
  const obj4 = { icon: _modDef18211, label: null, selected: null, onPress: null, disabled: null };
