...
// Dependencies: [18121, 4925, 18122, 1897, 18128, 2]
// Exports: showCreateBenefitModal, showEditBenefitModal, showEditEmojisModal

// Module 18120 (GuildRoleSubscriptionsModalActionCreators)
...
export const showCreateBenefitModal = function showCreateBenefitModal(arg0) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(18122, dependencyMap.paths), { benefitType: type, guildId, onSave, listingId }, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditBenefitModal = function showEditBenefitModal(benefit) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(18122, dependencyMap.paths), { benefitType: benefit.ref_type, guildId, onDelete, onSave, listingId }, GuildRoleSubscriptionBenefitEditorModal);
};
