...
// Dependencies: [5, 32, 19, 17, 5063, 7883, 1074, 21, 4722, 576, 9543, 7979, 7358, 7378, 1612, 7177, 5294, 5242, 17001, 7396, 1115, 17003, 12225, 12200, 12884, 11610, 1485, 1241, 4902, 4587, 1101, 10496, 17002, 4588, 2]

// Module 17000 (CreateThreadView)
...
import useCreateThreadViewPropsDefault from "useCreateThreadViewProps" /* 11610 */;
...
function CreateThreadViewInner(screenIndex) {
  ...
  const effect = noop.useEffect(() => () => {
    parentChannel(7979).clearDraft(user.id, DraftType.ThreadSettings);
    const obj = parentChannel(7979);
    parentChannel(7979).clearDraft(user.id, DraftType.FirstThreadMessage);
  }, items);
  ...
  const tmp12Result = parentChannel(10496)(obj4);
          ...
          if (0 === v2) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  current(closure_0(17002).makeEmptyTitleError());
                  const obj8 = closure_0(17002);
                  closure_0(4588).dismissKeyboard();
                  tmp60.current = false;
                  c5 = 0;
                  c7 = 3;
                  return { value: "HermesInternal", done: null };
            ...
            if (1 === current) {
              ...
              if (code === constants.AUTOMOD_TITLE_BLOCKED) {
                current(closure_0(17002).makeAutomodViolationError(closure_130_0.body, closure_0));
                const obj5 = closure_0(17002);
                closure_0(4588).dismissKeyboard();
                const obj6 = closure_0(4588);
              } else {
                ...
                if (tmp23) {
                  current(closure_0(17002).makeApiNameRequiredError());
                  const obj3 = closure_0(17002);
                  closure_0(4588).dismissKeyboard();
                  const obj4 = closure_0(4588);
                }
              }
            } else if (arg0 === 1) {
              c7 = 3;
              ...
              parentChannel(7979).saveDraft(closure_0.id, "", DraftType.FirstThreadMessage);
              c5 = 0;
              const obj = parentChannel(7979);
            }
            current = tmp60;
  ...
  const tmp12 = parentChannel(10496);
  const tmp11Result = parentChannel(7358);
  const tmp16 = parentChannel(1612)();
  const ref = noop.useRef(null);
  const ref1 = noop.useRef(null);
  let obj5 = { value: tmp11Result(parentChannel(7378).CREATE_THREAD).analyticsLocations, children: null };
  const items3 = [closure_13(parentChannel(5294), { absolute: true }), ];
  let obj6 = { style: null, children: null };
  const items4 = [tmp.container, { marginBottom: parentChannel(7177)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom - tmp16.bottom }];
  obj6.style = items4;
  ...
  const items6 = [closure_13(closure_6, { style: tmp.threadIconContainer, children: closure_13(require("ThreadIcon").ThreadIcon, { size: "lg" }) }), closure_13(parentChannel(17001), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(9543).PrivateThreadMode.Disabled) {
        const obj12 = { style: tmp.optionPrivateThread, children: null };
        const obj13 = { start: true, end: true, disabled: privateThreadMode !== tmp2(9543).PrivateThreadMode.Enabled, label: null, subLabel: null, value: null, onValueChange: null };
        const intl = tmp2(1115).intl;
        obj13.label = intl.string(tmp2(1115).t.F1zyvU);
        const intl2 = tmp2(1115).intl;
        obj13.subLabel = intl2.string(tmp2(1115).t.Wy5RIQ);
        obj13.value = tmp2(9543).getIsPrivate(threadSettingsDraft, privateThreadMode);
        ...
        obj12.children = tmp22(tmp2(7396).TableSwitchRow, obj13);
        tmp22Result = tmp22(tmp23, obj12);
        const tmp2Result = tmp2(9543);
      }
    }
  }
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(17003).ThreadCreationStarterMessage, obj16);
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj17.children = tmp22(tmp11(12225), obj18);
    tmp22Result2 = tmp22(tmp23, obj17);
  }
  items5[2] = tmp22Result2;
  items5[3] = closure_13(parentChannel(12200), { ref, channel: parentChannel, onJumpToPresent, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = closure_13(parentChannel(12884), { channelId: parentChannel.id });
