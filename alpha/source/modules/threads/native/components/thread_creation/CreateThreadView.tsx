...
// Dependencies: [5, 32, 19, 17, 5105, 7921, 1074, 21, 4756, 576, 9418, 8017, 7402, 7422, 1612, 7221, 5336, 5284, 17077, 7440, 1115, 17079, 12234, 12209, 12893, 11619, 1485, 1241, 4936, 4621, 1101, 10512, 17078, 4622, 2]

// Module 17076 (CreateThreadView)
...
import useCreateThreadViewPropsDefault from "useCreateThreadViewProps" /* 11619 */;
...
function CreateThreadViewInner(screenIndex) {
  ...
  const effect = noop.useEffect(() => () => {
    parentChannel(8017).clearDraft(user.id, DraftType.ThreadSettings);
    const obj = parentChannel(8017);
    parentChannel(8017).clearDraft(user.id, DraftType.FirstThreadMessage);
  }, items);
  ...
  const tmp12Result = parentChannel(10512)(obj4);
          ...
          if (0 === v2) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  current(closure_0(17078).makeEmptyTitleError());
                  const obj8 = closure_0(17078);
            ...
            if (1 === current) {
              ...
              if (code === constants.AUTOMOD_TITLE_BLOCKED) {
                current(closure_0(17078).makeAutomodViolationError(closure_130_0.body, closure_0));
                const obj5 = closure_0(17078);
                closure_0(4622).dismissKeyboard();
                ...
                if (tmp23) {
                  current(closure_0(17078).makeApiNameRequiredError());
                  const obj3 = closure_0(17078);
                  closure_0(4622).dismissKeyboard();
              ...
              parentChannel(8017).saveDraft(closure_0.id, "", DraftType.FirstThreadMessage);
              c5 = 0;
              const obj = parentChannel(8017);
            }
            current = tmp60;
  ...
  const tmp12 = parentChannel(10512);
  const tmp11Result = parentChannel(7402);
  const tmp16 = parentChannel(1612)();
  const ref = noop.useRef(null);
  const ref1 = noop.useRef(null);
  let obj5 = { value: tmp11Result(parentChannel(7422).CREATE_THREAD).analyticsLocations, children: null };
  const items3 = [closure_13(parentChannel(5336), { absolute: true }), ];
  let obj6 = { style: null, children: null };
  const items4 = [tmp.container, { marginBottom: parentChannel(7221)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom - tmp16.bottom }];
  obj6.style = items4;
  ...
  const items6 = [closure_13(closure_6, { style: tmp.threadIconContainer, children: closure_13(require("ThreadIcon").ThreadIcon, { size: "lg" }) }), closure_13(parentChannel(17077), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(9418).PrivateThreadMode.Disabled) {
        const obj12 = { style: tmp.optionPrivateThread, children: null };
        const obj13 = { start: true, end: true, disabled: privateThreadMode !== tmp2(9418).PrivateThreadMode.Enabled, label: null, subLabel: null, value: null, onValueChange: null };
        const intl = tmp2(1115).intl;
        obj13.label = intl.string(tmp2(1115).t.F1zyvU);
        const intl2 = tmp2(1115).intl;
        obj13.subLabel = intl2.string(tmp2(1115).t.Wy5RIQ);
        obj13.value = tmp2(9418).getIsPrivate(threadSettingsDraft, privateThreadMode);
        ...
        obj12.children = tmp22(tmp2(7440).TableSwitchRow, obj13);
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(17079).ThreadCreationStarterMessage, obj16);
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj17.children = tmp22(tmp11(12234), obj18);
    tmp22Result2 = tmp22(tmp23, obj17);
  }
  items5[2] = tmp22Result2;
  items5[3] = closure_13(parentChannel(12209), { ref, channel: parentChannel, onJumpToPresent, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = closure_13(parentChannel(12893), { channelId: parentChannel.id });
