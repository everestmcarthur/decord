...
// Dependencies: [5, 19, 1074, 21, 4656, 5453, 1115, 7375, 7376, 1241, 4902, 1397, 4573, 1177, 4664, 7373, 2]
// Exports: default

// Module 7374 (ProviderConnectionCard)
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              const obj4 = {};
              const obj5 = v3(1241);
              const merged = Object.assign(provider_id(4902).collectGuildAnalyticsMetadata(guildId));
