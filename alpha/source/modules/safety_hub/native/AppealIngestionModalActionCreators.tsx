...
// Dependencies: [573, 4925, 12130, 1897, 2]

// Module 12129 (AppealIngestionModalActionCreators)
...
export default {
  open(classificationId) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12130, dependencyMap.paths), classificationId, APPEAL_INGESTION_MODAL_KEY);
  },
  close() {
