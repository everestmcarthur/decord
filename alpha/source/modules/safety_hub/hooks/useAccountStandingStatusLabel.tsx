...
// Dependencies: [12135, 12163, 15034, 1115, 15035, 2]
// Exports: useAccountStandingStatusLabel

// Module 15033 (useAccountStandingStatusLabel)
import util from "util" /* 1115 */;
import useSafetyHubAccountStanding from "useSafetyHubAccountStanding" /* 12135 */;
import useSafetyHubInitialized from "useSafetyHubInitialized" /* 12163 */;
import useSafetyHubFetchError from "useSafetyHubFetchError" /* 15034 */;
...
export const useAccountStandingStatusLabel = function useAccountStandingStatusLabel() {
  ...
  if (safetyHubInitialized) {
    ...
    let formatToPlainStringResult = intl.formatToPlainString(tmp(15035).ACCOUNT_STANDING_SHORT_STATUS[safetyHubAccountStanding.state], obj4);
  } else {
