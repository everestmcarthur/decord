...
// Dependencies: [19, 17, 1074, 21, 4722, 576, 12208, 7468, 12260, 12268, 12261, 11666, 2]
// Exports: default

// Module 12267 (ForumPostListFooter)
...
const ForumPostReactions = tmp2(11666);
require = fn;
...
export default function ForumPostListFooter(parentChannel) {
  ...
  if (isGameInvitesPost) {
    ...
    isGameInvitesPost = tmp8(tmp9(12268), obj4);
  }
