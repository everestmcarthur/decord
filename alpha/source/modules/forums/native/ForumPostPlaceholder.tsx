...
// Dependencies: [32, 19, 4714, 21, 4722, 576, 504, 4458, 4723, 5777, 2]

// Module 12269 (ForumPostPlaceholder)
...
export default noop.memo(() => {
  ...
  fn.__closure = { reducedMotion: stateFromStores, ROW_OPACITY_END, withDelay: stateFromStores(4458).withDelay, INITIAL_DELAY_MS: 1000, withRepeat: stateFromStores(4458).withRepeat, withSequence: stateFromStores(4458).withSequence, withTiming: stateFromStores(4723).withTiming, timingConfig };
  fn.__workletHash = 9488742940898;
  fn.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(fn);
  let obj4 = { style: animatedStyle, pointerEvents: "none", children: jsx(stateFromStores(5777).Card, { variant: "secondary", style: tmp.postPlaceholder }) };
  return jsx(timingConfig(4458).View, { style: animatedStyle, pointerEvents: "none", children: jsx(stateFromStores(5777).Card, { variant: "secondary", style: tmp.postPlaceholder }) });
});
