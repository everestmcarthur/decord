...
// Dependencies: [5677, 7502, 502, 1958, 4737, 2012, 1967, 1969, 12, 7503, 11, 504, 1975, 573, 2]
// Exports: computeThreadIdsSnapshot

// Module 7501 (ForumActivePostStore)
...
function rebuildState(refreshThreadIds) {
  ...
  if (null != channel) {
      ...
      closure_21 = apply.chain(closure_19).sort((id, id) => {
        ...
        if (!obj.isForumPostPinned(id)) {
          ...
          if (tmpResult.isForumPostPinned(id)) {
            num = 1;
          } else if (closure_0 === tmp(1967).ThreadSortOrder.LATEST_ACTIVITY) {
    ...
    const valueResult = LATEST_ACTIVITY === LATEST_ACTIVITY(1967).ThreadSortOrder.LATEST_ACTIVITY ? closure_21 : closure_20.value();
