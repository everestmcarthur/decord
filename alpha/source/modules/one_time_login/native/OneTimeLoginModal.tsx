...
// Dependencies: [5, 19, 17, 502, 1372, 1074, 1229, 21, 4722, 576, 1612, 1478, 1365, 1241, 4925, 4579, 1101, 5068, 5072, 6803, 1115, 5072, 6785, 5294, 4540, 14071, 4718, 7136, 2]
// Exports: default

// Module 14070 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  const obj3 = { dark: token(4540).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
  const items6 = [closure_13(ThemedGradientDefault, obj2), ];
  let obj4 = { style: tmp.container, children: null };
  let obj5 = { style: tmp.centerContent, children: null };
  const items7 = [closure_13(callback3, { source: token(14071), style: tmp.logo }), ];
  ...
  items8[1] = closure_13(token(4718).Text, obj8);
  ...
  const items10 = [closure_13(token(4718).Text, obj10), ];
  ...
  items10[1] = closure_13(token(7136).LinkButton, obj11);
