...
// Dependencies: [5, 19, 17, 502, 1372, 1074, 1229, 21, 4756, 576, 1612, 1478, 1365, 1241, 4959, 4613, 1101, 5110, 5114, 6847, 1115, 5114, 6829, 5336, 4574, 14125, 4752, 7180, 2]
// Exports: default
...
export default function OneTimeLoginModal(token) {
  ...
  const obj3 = { dark: token(4574).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
  ...
  items8[1] = closure_13(token(4752).Text, obj8);
  ...
  const items10 = [closure_13(token(4752).Text, obj10), ];
