...
// Function ID: 5295
// Name: ThemedGradient
// Dependencies: [19, 17, 4541, 21, 4722, 4573, 4572, 4571, 1478, 5156, 4656, 576, 4576, 4540, 672, 1231, 563, 4578, 4655, 1230, 2]
// Exports: CustomThemedGradient, default, validateColors

// Module 5294 (ThemedGradient)
...
import GuildThemePresets from "GuildThemePresets" /* 4576 */;
import useRoutedActiveGuildThemeDefault from "useRoutedActiveGuildTheme" /* 4578 */;
...
function CustomThemesGradient(arg0) {
  ...
  if (reduced.length >= 2) {
    ...
    obj.style = items2;
    tmp10Result = closure_6(reduced(5156), obj);
    const tmp2Result = reduced(5156);
  }
  return tmp10Result;
}
...
export default function ThemedGradient(overlayOpacity) {
  ...
  if (null != gradientOverride) {
    if (tmp12) {
      if (gradientOverride.type === tmp6(1230).ClientThemeType.CUSTOM_BACKGROUND_GRADIENT) {
        ...
        if (withOverlay) {
          ...
          const obj5 = { backgroundColor: tmp6(4571).hexWithOpacity(tmp8, num) };
          items2[1] = obj5;
          obj4.style = items2;
          items1[1] = timestampProducer(View, obj4);
          obj3.children = items1;
          tmp60 = React5(View, obj3);
          const tmp6Result8 = tmp6(4571);
        }
        return tmp60;
      }
    }
    if (gradientOverride.type === tmp6(1230).ClientThemeType.BACKGROUND_GRADIENT_PRESET) {
      ...
      if (withOverlay) {
        ...
        const obj9 = { backgroundColor: tmp6(4571).hexWithOpacity(tmp8, num) };
        items4[1] = obj9;
        obj8.style = items4;
        items3[1] = timestampProducer(View, obj8);
        obj7.children = items3;
        tmp49 = React5(View, obj7);
        const tmp6Result9 = tmp6(4571);
      }
      return tmp49;
    }
  }
  if (null != tmp10) {
    ...
    if (withOverlay) {
      ...
      const obj13 = { backgroundColor: tmp6(4571).hexWithOpacity(tmp8, num) };
      items6[1] = obj13;
      obj12.style = items6;
      items5[1] = tmp34(View, obj12);
      obj11.children = items5;
      tmp40 = React5(View, obj11);
      const tmp6Result10 = tmp6(4571);
    }
    let tmp13 = tmp40;
    ...
    if (tmp12) {
      if (tmp12) {
        ...
        if (withOverlay) {
          ...
          const obj17 = { backgroundColor: tmp6(4571).hexWithOpacity(tmp8, num) };
          items8[1] = obj17;
          obj16.style = items8;
          items7[1] = tmp23(View, obj16);
          obj15.children = items7;
          tmp31 = React5(View, obj15);
          const tmp6Result11 = tmp6(4571);
        }
        tmp13 = tmp31;
    ...
    if (null != preset) {
      ...
      if (withOverlay) {
        ...
        const obj21 = { backgroundColor: tmp6(4571).hexWithOpacity(tmp8, num) };
        items10[1] = obj21;
        obj20.style = items10;
        items9[1] = tmp14(View, obj20);
        obj19.children = items9;
        tmp20 = React5(View, obj19);
        const tmp6Result12 = tmp6(4571);
      }
      tmp13 = tmp20;
