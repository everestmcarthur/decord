...
// Dependencies: [1183, 1182, 1184, 1220, 1084, 1228, 4569, 1186, 573, 504, 2]
...
import isPerModeThemingActive from "isPerModeThemingActive" /* 4569 */;
...
prototype["getState"] = function getState() {
  ...
  if (tmp2) {
    ...
    obj = { theme: "PX_16", customTheme: "accessible" };
  }
  return obj;
};
