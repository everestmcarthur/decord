...
// Dependencies: [5, 32, 19, 7477, 3, 504, 12, 9480, 4429, 2]
...
// Module 9479 (NativePaymentHooks)
        ...
        try {
          ...
          if (0 === v2) {
            ...
            if (1 === tmp8) {
              ...
              v2("Unable to fetch");
              const result = closure_2_0(4429).captureBillingException(closure_128_1);
              const obj3 = closure_2_0(4429);
            } else if (arg0 === 1) {
              c5 = 3;
              throw value;
            } else if (arg0 !== 2) {
