...
// Dependencies: [5, 32, 19, 7479, 4419, 4420, 7477, 1074, 3, 504, 7659, 11015, 4429, 11067, 5810, 1241, 11069, 7480, 38, 5079, 11071, 11072, 2]
// Exports: useCancelSubscription, useCreateSubscription, useGoogleSkuIds, useMobileStoreFront, useResubscribeSubscription

// Module 11066 (hooks/NativePaymentHooks)
import LoggerDefault from "Logger" /* 3 */;
import initialize from "initialize" /* 504 */;
import BillingUtils from "BillingUtils" /* 4429 */;
import ProductIds from "ProductIds" /* 7480 */;
import BillingActionCreatorsDefault from "BillingActionCreators" /* 7659 */;
...
function useCancelSubscription(arg0, arg1) {
  ...
  obj2.cancelSubscription = memo.useCallback(storeFront(function*() {
    ...
    closure_128_0 = yield tmp2(7659).cancelGenericSubscription(closure_6.requestIdentifier, closure_6.subscriptionId, closure_1);
    yield tmp2(5079).fetchSubscriptions();
...
function useResubscribeSubscription(arg0) {
  ...
  obj2.resubscribeSubscription = noop.useCallback(stateFromStores(function*() {
    ...
    closure_128_0 = yield tmp2(7659).resubscribeGenericSubscription(closure_5, stateFromStores.isACOM);
    yield tmp2(5079).fetchSubscriptions();
    return closure_128_0;
  }), items3);
  return obj2;
