...
// Dependencies: [5, 32, 19, 16195, 16196, 1074, 21, 16192, 16211, 5161, 7241, 1115, 7275, 16224, 7276, 2]
// Exports: default

// Module 16223 (components/VerifyPhone)
import RegistrationBailoutButtonDefault from "RegistrationBailoutButton" /* 16224 */;
...
const require = fn;
let closure_6 = fn(16195).doesRegistrationHaveIdentityType;
...
export default function VerifyPhone(phone) {
  ...
  onPhoneTokenReceived(16211)(closure_7(sourceState));
  const items = [context];
  ...
  onBail(function*(arg0) {
    ...
    yield onPhoneTokenReceived(7241).verifyPhone(closure_0, closure_0, false);
    if (1 === tmp7) {
      v0 = 0;
  ...
  onPhoneTokenReceived(7275)(callback1);
  const items3 = [onBail];
  ...
  const tmp7 = onPhoneTokenReceived(16211);
  obj.codeType = require("CodeField").CodeType.NUMERIC;
  obj.footer = memo;
  obj.disabled = tmp5;
  return jsx(onPhoneTokenReceived(7276), { title, description, error: tmp3, onCodeEntered, codeType: null, footer: null, disabled: null, loading: null, disableKeyboardAvoidingView: true });
};
