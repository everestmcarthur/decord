...
obj7.layout = LinearTransition.easing(Easing.inOut(fn(4492).Easing.quad)).duration(300);
const easingResult = LinearTransition.easing(Easing.inOut(fn(4492).Easing.quad));
const size = fn(2);
