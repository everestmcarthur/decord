...
// Dependencies: [19, 17, 6786, 21, 4722, 4440, 1115, 5787, 4718, 2]
// Exports: default

// Module 16234 (PromotionalEmailCheckBox)
...
const PromoEmailConsentStore = fn(6786);
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    const items = [closure_6(tmp4(5787).FormCheckbox, obj4), ];
    ...
    items[1] = closure_6(tmp4(4718).Text, obj5);
    obj3.children = items;
