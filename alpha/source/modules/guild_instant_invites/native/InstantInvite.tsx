...
// Function ID: 11196
// Name: InstantInvite
// Dependencies: [19, 17, 2045, 1372, 1074, 21, 4756, 576, 504, 7408, 11196, 11197, 5109, 1115, 11198, 1101, 11200, 5819, 5184, 7412, 4752, 8173, 8178, 11204, 11205, 11207, 11210, 11212, 2]
// Exports: LinkedChannelInvite

// Module 11195 (InstantInvite)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import actions_AlertActionCreatorsDefault from "actions/AlertActionCreators" /* 5109 */;
import ArrowSmallRightIcon from "ArrowSmallRightIcon" /* 11198 */;
import InstantInviteIconsDefault from "InstantInviteIcons" /* 11200 */;
import InstantInviteCreatorDefault from "InstantInviteCreator" /* 11205 */;
import InviteRolesDisplayDefault from "InviteRolesDisplay" /* 11210 */;
import InstantInviteUsesLabelDefault from "InstantInviteUsesLabel" /* 11212 */;
...
export default noop.memo((onInviteRevoked) => {
  ...
  const inviteActions = invite(11207).useInviteActions({ invite, onInviteRevoked: onInviteRevoked.onInviteRevoked });
  ...
  const items2 = [
    ...
    closure_8(invite(8173).ContextMenu, {
      items: inviteActions,
      children(ref) {
        ...
        return closure_1_8(invite(8178).IconButton, obj);
      }
    })
  ];
  obj2.children = items2;
  const items3 = [closure_9(invite(5184).Stack, obj2), , , ];
  let obj = invite(11207);
  ...
  items3[1] = closure_8(invite(11204).InstantInviteDetails, { channel: memo, expiresAt: invite.getExpiresAt() });
  if (tmp9Result) {
  ...
  return closure_9(invite(5819).Card, obj7);
});
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  let obj2 = channel(7408);
  canUnlinkLobbyChannel = channel(11196).useCanUnlinkLobbyChannel(channel);
  let str;
  const tmp2Result = channel(11196);
  ...
  const tmp9Result = canUnlinkLobbyChannel(11197)(channel.id, str);
  ...
  const tmp9 = canUnlinkLobbyChannel(11197);
  obj4.size = channel(7412).GameIconSizes.SIZE_24;
  const items3 = [closure_8(canUnlinkLobbyChannel(7412), obj4), ];
  ...
  const items4 = [
    closure_9(View, obj3),
    closure_8(channel(8173).ContextMenu, {
      items: memo,
      children(ref) {
        const merged = Object.assign(ref, Object.assign({ ref: 0 }));
        const obj = { size: "sm", variant: "secondary", icon: canUnlinkLobbyChannel(11200).more, accessibilityLabel: null, ref: null };
        const intl = channel(1115).intl;
        obj.accessibilityLabel = intl.string(channel(1115).t.DEoVWZ);
        obj.ref = ref.ref;
        const merged1 = Object.assign(merged);
        return closure_1_8(channel(8178).IconButton, obj);
      }
    })
  ];
  obj7.children = items4;
  const items5 = [closure_9(channel(5184).Stack, obj7), closure_8(channel(11204).InstantInviteDetails, { channel }), ];
  const obj9 = { direction: "horizontal", align: "flex-end", children: null };
  const obj10 = { style: tmp.creatorWrapper, children: closure_8(canUnlinkLobbyChannel(11205), { user: stateFromStores, guildId: channel.guild_id }) };
  obj9.children = closure_8(View, obj10);
  items5[2] = closure_8(channel(5184).Stack, obj9);
  obj6.children = items5;
  return closure_9(channel(5819).Card, obj6);
};
