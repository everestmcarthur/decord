...
// Function ID: 11183
// Name: InstantInvite
// Dependencies: [19, 17, 1962, 1372, 1074, 21, 4722, 576, 504, 7364, 11183, 11184, 5067, 1115, 11185, 1101, 11187, 5777, 5142, 7368, 4718, 8135, 8140, 11191, 11192, 11194, 11197, 11199, 2]
// Exports: LinkedChannelInvite

// Module 11182 (InstantInvite)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import actions_AlertActionCreatorsDefault from "actions/AlertActionCreators" /* 5067 */;
import ArrowSmallRightIcon from "ArrowSmallRightIcon" /* 11185 */;
import InstantInviteIconsDefault from "InstantInviteIcons" /* 11187 */;
import InstantInviteCreatorDefault from "InstantInviteCreator" /* 11192 */;
import InviteRolesDisplayDefault from "InviteRolesDisplay" /* 11197 */;
import InstantInviteUsesLabelDefault from "InstantInviteUsesLabel" /* 11199 */;
...
export default noop.memo((onInviteRevoked) => {
  ...
  const inviteActions = invite(11194).useInviteActions({ invite, onInviteRevoked: onInviteRevoked.onInviteRevoked });
  ...
  const items2 = [
    closure_8(invite(4718).Text, { variant: "text-lg/bold", tabularNumbers: true, children: invite.code }),
    closure_8(invite(8135).ContextMenu, {
      items: inviteActions,
      children(ref) {
        ...
        return closure_1_8(invite(8140).IconButton, obj);
      }
    })
  ];
  obj2.children = items2;
  const items3 = [closure_9(invite(5142).Stack, obj2), , , ];
  let obj = invite(11194);
  ...
  items3[1] = closure_8(invite(11191).InstantInviteDetails, { channel: memo, expiresAt: invite.getExpiresAt() });
  if (tmp9Result) {
  ...
  items3[3] = closure_9(invite(5142).Stack, obj8);
  obj7.children = items3;
  return closure_9(invite(5777).Card, obj7);
});
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  const getOrFetchApplication = channel(7364).useGetOrFetchApplication(application_id);
  let obj2 = channel(7364);
  canUnlinkLobbyChannel = channel(11183).useCanUnlinkLobbyChannel(channel);
  let str;
  const tmp2Result = channel(11183);
  ...
  const tmp9Result = canUnlinkLobbyChannel(11184)(channel.id, str);
  ...
  const tmp9 = canUnlinkLobbyChannel(11184);
  obj4.size = channel(7368).GameIconSizes.SIZE_24;
  const items3 = [closure_8(canUnlinkLobbyChannel(7368), obj4), ];
  ...
  obj5.children = name;
  items3[1] = closure_8(channel(4718).Text, obj5);
  obj3.children = items3;
  const items4 = [
    closure_9(View, obj3),
    closure_8(channel(8135).ContextMenu, {
      items: memo,
      children(ref) {
        const merged = Object.assign(ref, Object.assign({ ref: 0 }));
        const obj = { size: "sm", variant: "secondary", icon: canUnlinkLobbyChannel(11187).more, accessibilityLabel: null, ref: null };
        const intl = channel(1115).intl;
        obj.accessibilityLabel = intl.string(channel(1115).t.DEoVWZ);
        obj.ref = ref.ref;
        const merged1 = Object.assign(merged);
        return closure_1_8(channel(8140).IconButton, obj);
      }
    })
  ];
  obj7.children = items4;
  const items5 = [closure_9(channel(5142).Stack, obj7), closure_8(channel(11191).InstantInviteDetails, { channel }), ];
  const obj9 = { direction: "horizontal", align: "flex-end", children: null };
  const obj10 = { style: tmp.creatorWrapper, children: closure_8(canUnlinkLobbyChannel(11192), { user: stateFromStores, guildId: channel.guild_id }) };
  obj9.children = closure_8(View, obj10);
  items5[2] = closure_8(channel(5142).Stack, obj9);
  obj6.children = items5;
  return closure_9(channel(5777).Card, obj6);
};
