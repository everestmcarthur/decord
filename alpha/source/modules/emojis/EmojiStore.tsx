...
// Function ID: 5672
// Name: EmojiStore
// Dependencies: [32, 5, 4671, 5672, 2109, 1220, 2105, 2043, 2099, 2063, 5650, 1372, 5673, 5674, 1375, 1074, 5675, 1084, 4409, 5676, 11, 12, 1091, 2070, 2090, 10, 5677, 573, 4793, 38, 4743, 1370, 5678, 5679, 5711, 4386, 4348, 504, 4413, 4412, 2]
...
const emojiStore = new EmojiStore(DispatcherDefault, {
  ...
  TOP_EMOJIS_FETCH_SUCCESS: function handleTopEmojisLoaded(topEmojisMetadata) {
    ...
    const tmpResult = _modDef4348(_modDef4348());
    obj.topEmojisTTL = _modDef4348(_modDef4348()).add(1, "days").valueOf();
