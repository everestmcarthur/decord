...
// Function ID: 4410
// Name: UnicodeEmojis
// Dependencies: [4410, 4411, 4412, 4413, 12, 14247, 2]
// Exports: asUnicodeEmoji

// Module 4409 (UnicodeEmojis)
import _modDef12 from "module_12" /* 12 */;
import EmojiTypes from "EmojiTypes" /* 4412 */;
import _mod14247 from "module_14247" /* 14247 */;
import defaultImageSrcGenerator from "defaultImageSrcGenerator" /* 4410 */;
...
function findInlineEmojisFromSurrogates(text, arg1) {
      ...
      if (null != ``) {
        if ("" !== ``) {
          if (tmp3 === closure_13) {
            ...
            let str3 = "";
            let tmp16 = require;
            let tmp18 = require("module_4411").surrogateToEmoji[`${tmp3}`];
            let tmp19 = null;
            if (null != tmp18) {
              tmp19 = tmp16(4411).emojis[tmp18];
            }
            let first;
            if (tmp19 != null) {
              first = tmp19.names[0];
            ...
            let tmp10 = require;
            let tmp12 = require("module_4411").surrogateToEmoji[str];
            let tmp13 = null;
            if (null != tmp12) {
              tmp13 = tmp10(4411).emojis[tmp12];
            }
            let first1;
            if (tmp13 != null) {
  ...
  if (!tmp23) {
    ...
    const tmp26 = require("module_4411").surrogateToEmoji[str2];
    let tmp27 = null;
    if (null != tmp26) {
      tmp27 = tmp24(4411).emojis[tmp26];
    }
    let first2;
    if (tmp27 != null) {
...
Object.defineProperty(prototype, "name", {
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != global) {
        const tmp6 = require("module_4411").surrogateToEmoji[global];
        let tmp7 = null;
        if (null != tmp6) {
          tmp7 = tmp4(4411).emojis[tmp6];
        }
        let first;
        if (tmp7 != null) {
          first = tmp7.names[0];
...
export default {
  ...
  getCategories() {
    return Object.keys(require("module_4411").emojisByCategory);
  },
  getByName(arg0) {
    const tmp3 = require("module_4411").nameToEmoji[arg0];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("module_4411").emojis[tmp3];
    }
    let tmp5 = null;
    if (null != tmp4) {
  ...
  getByCategory(name) {
    value = map.get(name);
    if (null == value) {
      const tmp4 = require("module_4411").emojisByCategory[name];
      const emojis = require("module_4411").emojis;
  ...
  translateInlineEmojiToSurrogates(emojiName) {
    return emojiName.replace(re7, (arg0, arg1) => {
      ...
      const tmp3 = require("module_4411").nameToEmoji[arg1];
      let tmp4 = null;
      if (null != tmp3) {
        tmp4 = require("module_4411").emojis[tmp3];
      }
  ...
  convertNameToSurrogate(emojiName) {
    ...
    const tmp3 = require("module_4411").nameToEmoji[emojiName];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("module_4411").emojis[tmp3];
    }
  ...
  convertSurrogateToName(name, arg1) {
    ...
    const tmp3 = require("module_4411").surrogateToEmoji[name];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("module_4411").emojis[tmp3];
    }
  ...
  convertSurrogateToBase(surrogates) {
    ...
    const tmp4 = require("module_4411").surrogateToEmoji[reduced];
    let tmp5 = null;
    if (null != tmp4) {
      tmp5 = tmp2(4411).emojis[tmp4];
    }
    let str;
    if (tmp5 != null) {
      str = tmp5.names[0];
    ...
    const tmp6 = require("module_4411").nameToEmoji[str];
    let tmp7 = null;
    if (null != tmp6) {
      tmp7 = tmp2(4411).emojis[tmp6];
    }
    let tmp8 = null;
    if (null != tmp7) {
  ...
  numDiversitySprites: fn(4411).numDiversitySprites,
  numNonDiversitySprites: fn(4411).numNonDiversitySprites,
  ...
  hasSurrogates(match) {
    return _modDef12.toArray(match).some((item) => null != require("module_4411").surrogateToEmoji[item]);
  }
};
