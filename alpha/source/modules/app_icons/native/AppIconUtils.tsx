...
// Function ID: 13715
// Name: AppIconUtils
// Dependencies: [32, 5, 19, 17, 9436, 1074, 1374, 3, 1364, 13715, 9437, 5203, 573, 1241, 4454, 1115, 7622, 1609, 2]
// Exports: isAppIconsSupported, navigateToAppIconSettings, setAppIcon, useAppIcons, useCurrentAppIcon

// Module 13714 (AppIconUtils)
...
const AppIconConstants = fn(9436);
...
if (PlatformUtils.isAndroid()) {
  let DCDIconManager = fn(13715).default;
} else {
