...
// Dependencies: [19, 17, 1372, 2038, 21, 4756, 576, 504, 4414, 4723, 7390, 17384, 1177, 10220, 4752, 1115, 5186, 13714, 2]
// Exports: default
...
export default function AppIconsCoachmarkActionSheet(markAsDismissed) {
  ...
  items2[2] = closure_8(markAsDismissed(4752).Text, obj9);
