...
// Dependencies: [19, 17, 5676, 2026, 1958, 1181, 4904, 21, 4722, 17046, 576, 16601, 7465, 504, 4875, 8090, 15528, 7525, 5151, 17362, 5177, 12301, 10352, 8084, 17364, 9794, 16489, 17358, 5292, 17365, 17045, 17359, 17360, 2]
...
export default noop.memo(function TextChannel(subtitle) {
  ...
  if (null != tmp8ResultResult) {
    ...
    return tmp8Result4(tmp26(tmp2(5292).PressableHighlight, obj6));
  }
