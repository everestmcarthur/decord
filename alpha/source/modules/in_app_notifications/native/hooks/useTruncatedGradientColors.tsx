...
// Dependencies: [19, 4722, 4423, 576, 672, 2]
// Exports: default

// Module 10351 (useTruncatedGradientColors)
...
export default function useTruncatedGradientColors() {
  const tmp = closure_4();
  token = token(4423).useToken(nativeDefault.colors.MOBILE_ALERT_BACKGROUND_DEFAULT);
