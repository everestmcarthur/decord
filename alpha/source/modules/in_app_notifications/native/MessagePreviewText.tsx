...
// Dependencies: [19, 17, 1958, 10339, 1085, 21, 4722, 1365, 576, 10351, 10352, 10338, 4718, 5757, 10374, 4955, 10379, 10380, 1096, 7498, 1115, 8084, 2]
// Exports: default
...
export default function MessagePreviewText(message) {
  ...
  if (memo.length > 0) {
    ...
    if (tmp29) {
      tmp29 = previewableMedia[0].type === tmp(10374).PreviewableMediaTypes.GIF;
    }
    ...
    if (null != nullableMessageAuthor) {
      ...
      tmp(10338);
      if (null != channel) {
        const obj10 = { channel, message, color: "text-default", layout: tmp(8084).ChannelListLayoutTypes.COZY, variant: tmp24, muted: false, lineClamp };
        return React6(tmp(10352).ChannelRowPreview, obj10);
      }
    }
    ...
    if (previewableMedia.length > 0) {
      if (null !== text) {
        ...
        if (tmp17Result) {
          ...
          tmp17Result = React6(tmp(4718).Text, obj13);
        }
    ...
    if (null != message.poll) {
      ...
      items3[1] = React6(tmp(4718).Text, obj18);
