...
// Dependencies: [19, 17, 2041, 2063, 10351, 1074, 21, 4756, 1177, 4718, 576, 10350, 10430, 504, 1095, 10428, 10362, 10364, 8122, 38, 1115, 4959, 8101, 8102, 1241, 10426, 2]

// Module 11579 (ReminderNotification)
...
import MessageNotificationHeaderDefault from "MessageNotificationHeader" /* 10428 */;
import noop from "module_19" /* 19 */;
import ChannelStore from "ChannelStore" /* 2041 */;
import GuildStore from "GuildStore" /* 2063 */;

const MediaPreviewRightAccessory = tmp2(10430);
require = fn;
...
function NotificationBody(channel) {
  ...
  if (!hasPreviewableMedia) {
    if (null == message.poll) {
      const obj5 = { channel, message, color: "text-default", layout: tmp(8122).ChannelListLayoutTypes.COZY, variant: messagePreviewTextVariant, muted: false, lineClamp: num };
...
export default noop.memo(function ReminderNotification(notification) {
  ...
  return closure_10(notification(10426).NotificationPressable, { icon: closure_10(NotificationAvatar, { user: notification.author, guildId: channel.guild_id }), header: memo, onPress: callback, notification, rightAccessory: closure_10(closure_16, { message }), children: closure_10(NotificationBody, { channel, message }) });
});
