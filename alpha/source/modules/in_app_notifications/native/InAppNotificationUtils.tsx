...
// Dependencies: [19, 10351, 1074, 12, 1255, 1365, 1091, 7542, 4936, 2]
...
// Module 10350 (InAppNotificationUtils)
...
require = fn;
const REACTION_MILESTONE_COUNTS = fn(10351).REACTION_MILESTONE_COUNTS;
