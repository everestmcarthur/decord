...
// Dependencies: [19, 10339, 1074, 12, 1255, 1365, 1091, 7498, 4902, 2]
...
// Module 10338 (InAppNotificationUtils)
...
require = fn;
const REACTION_MILESTONE_COUNTS = fn(10339).REACTION_MILESTONE_COUNTS;
