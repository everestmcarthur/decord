...
// Dependencies: [19, 21, 4722, 5163, 1115, 9742, 4718, 2]
// Exports: IgnoreThermalStateAlert

// Module 9834 (IgnoreThermalStateAlert)
...
export const IgnoreThermalStateAlert = function IgnoreThermalStateAlert(onConfirm) {
  ...
  const items = [closure_3(onConfirm(4718).Text, obj2), ];
  ...
  items[1] = closure_3(onConfirm(4718).Text, obj3);
  obj.children = items;
