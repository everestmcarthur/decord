...
// Dependencies: [5, 2002, 2041, 2063, 4395, 1372, 4775, 2040, 9635, 9612, 5108, 1115, 7403, 9611, 9636, 2]
// Exports: maybeJoinEmbeddedActivity

// Module 9634 (handlePressJoinActivity)
import AlertActionCreatorsDefault from "AlertActionCreators" /* 5108 */;
import getEmbeddedActivityJoinability from "getEmbeddedActivityJoinability" /* 9635 */;
...
function handlePressJoinActivity(arg0) {
  ...
  } else if (tmp(9635).EmbeddedActivityJoinability.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION === embeddedActivityJoinability) {
    const result = tmp(9612).showActivitiesInvalidPermissionsAlert();
    const tmpResult = tmp(9612);
  } else if (tmp(9635).EmbeddedActivityJoinability.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS === embeddedActivityJoinability) {
  ...
  } else if (tmp(9635).EmbeddedActivityJoinability.ACTIVITY_NOT_SUPPORTED_ON_OS === embeddedActivityJoinability) {
  ...
  } else if (tmp(9635).EmbeddedActivityJoinability.ACTIVITY_AGE_GATED === embeddedActivityJoinability) {
