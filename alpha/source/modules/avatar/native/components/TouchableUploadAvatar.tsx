...
// Dependencies: [19, 17, 21, 4722, 576, 14071, 5292, 1115, 5757, 1177, 13015, 2]
// Exports: default

// Module 17759 (TouchableUploadAvatar)
...
export default function TouchableUploadAvatar(onSelectAvatar) {
  ...
  if (showPendingAvatar) {
    ...
    const obj6 = { size: native.Icon.Sizes.MEDIUM, source: _modDef13015, style: tmp.uploadAvatarIcon };
