...
// Dependencies: [4959, 14136, 1980, 2]

// Module 14135 (ActivateDeviceModalActionCreators)
...
export default {
  showModal(userCode) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14136, dependencyMap.paths), { userCode }, ACTIVATE_DEVICE_MODAL_KEY);
  },
  hideModal() {
