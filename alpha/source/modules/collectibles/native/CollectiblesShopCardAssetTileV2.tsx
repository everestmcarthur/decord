...
// Dependencies: [32, 19, 17, 1076, 21, 9043, 576, 4756, 9075, 5306, 7793, 1973, 8439, 9077, 5799, 9123, 1077, 9124, 9090, 9079, 9102, 9104, 4605, 4457, 9044, 2]

// Module 9122 (CollectiblesShopCardAssetTileV2)
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1973).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      let size = { skuId: product.skuId, width: tmp2(9124).FRACTIONAL_NITRO_COIN_SIZE.CARD, height: tmp2(9124).FRACTIONAL_NITRO_COIN_SIZE.CARD };
      return closure_7(tmp2(9124).FractionalNitroCoinIllustration, size);
    } else {
      ...
      if (tmp2(1973).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = { profileFrame: first, previewWidth: tmp2(9043).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32, previewHeight, profileBackgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
