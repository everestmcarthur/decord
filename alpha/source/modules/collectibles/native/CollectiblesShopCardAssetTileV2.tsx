...
// Dependencies: [32, 19, 17, 1076, 21, 9004, 576, 4722, 9036, 5264, 7749, 1890, 8401, 9038, 5757, 9084, 1077, 9085, 9051, 9040, 9063, 9065, 4571, 4423, 9005, 2]

// Module 9083 (CollectiblesShopCardAssetTileV2)
...
import NameplateCardPreviewDefault from "NameplateCardPreview" /* 9065 */;
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1890).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      let size = { skuId: product.skuId, width: tmp2(9085).FRACTIONAL_NITRO_COIN_SIZE.CARD, height: tmp2(9085).FRACTIONAL_NITRO_COIN_SIZE.CARD };
      return closure_7(tmp2(9085).FractionalNitroCoinIllustration, size);
    } else {
      ...
      if (tmp2(1890).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = { profileFrame: first, previewWidth: tmp2(9004).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32, previewHeight, profileBackgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
