...
// Function ID: 16134
// Name: HeroBlock
// Dependencies: [19, 17, 7782, 1076, 1074, 21, 9043, 4756, 576, 9150, 16134, 1484, 9046, 504, 11737, 4690, 16135, 4457, 4605, 16136, 15336, 7402, 7422, 16138, 1241, 4607, 16140, 16141, 16142, 5198, 4752, 5186, 1115, 12018, 5661, 5334, 7449, 7396, 16143, 8996, 2]
// Exports: default

// Module 16133 (HeroBlock)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import CollectiblesShopCardV2 from "CollectiblesShopCardV2" /* 9043 */;
import CollectiblesAnalyticsContext from "CollectiblesAnalyticsContext" /* 9046 */;
import SkeletonCardDefault from "SkeletonCard" /* 9150 */;
...
const result = 0.75 * fn(9043).COLLECTIBLES_SHOP_CARD_WIDTH;
...
export default function _default(heroBlock) {
  ...
  closure_5 = undefined;
  closure_6 = undefined;
  let obj = heroBlock(16134);
  dependencyMap = heroBlock(1484).useNavigation();
  let obj2 = heroBlock(1484);
  noop = heroBlock(9046).useCollectiblesAnalyticsContext();
  ...
  let isEligibleForQuests = heroBlock(11737).getIsEligibleForQuests();
  const tmpResult9 = heroBlock(11737);
  const tmp7 = preferVCPrice(4690)();
  const tmp8 = closure_14();
  const tmpResult10 = heroBlock(16135);
  ...
  const tmp12 = preferVCPrice(16136)();
  closure_5 = tmp12;
  ...
  const filteredAndSortedProducts = heroBlock(15336).useFilteredAndSortedProducts({ products: memo, bypassAndroidUnsyncedFilter: tmp4 });
  closure_6 = tmp14;
  const tmpResult15 = heroBlock(15336);
  let unpublishedAt;
  ...
  if (undefined === stateFromStores) {
    ...
    if (!tmp4) {
      const obj4 = { value: tmp15(preferVCPrice(7422).COLLECTIBLES_SHOP_HERO).analyticsLocations, children: null };
      ...
      if (tmp4) {
        ...
        const obj28 = { style: tmp8.heroViewAllIcon, children: tmp22(tmp(7449).ChevronSmallRightIcon, { size: "sm", color: "white" }) };
        items9[1] = tmp22(tmp25, obj28);
        obj24.children = items9;
        obj20.children = tmp24(tmp25, obj24);
        tmp24Result2 = tmp22(tmp(5334).PressableOpacity, obj20, stateFromStores.storeListingId);
      }
      ...
      if (tmp4) {
        ...
        let tmp22Result9 = tmp22(tmp6(16143), obj30);
        const tmp6Result3 = tmp6(16143);
      } else {
        if (0 === filteredAndSortedProducts.length) {
          ...
          obj34.snapToInterval = tmp(9043).COLLECTIBLES_SHOP_CARD_WIDTH + tmp6(576).space.PX_12;
          ...
          tmp22Result10 = tmp22(tmp(8996).FlashList, obj34);
        }
        const obj36 = { children: tmp22Result10 };
        tmp22Result9 = tmp22(closure_12, obj36);
      }
      const obj37 = { children: tmp22Result9 };
      obj29.children = closure_11(tmp(7396).LayerScope, obj37);
      items6[2] = closure_11(closure_5, obj29);
      obj6.children = items6;
      obj5.children = closure_13(closure_5, obj6);
      obj4.children = closure_11(tmp6(16142), obj5);
      return closure_11(tmp(7402).AnalyticsLocationProvider, obj4);
    } else {
