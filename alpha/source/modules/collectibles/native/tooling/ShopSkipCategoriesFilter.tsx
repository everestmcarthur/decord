...
// Dependencies: [19, 17, 7738, 21, 4722, 576, 504, 5142, 4718, 7737, 2]
// Exports: ShopSkipCategoriesFilter

// Module 15951 (ShopSkipCategoriesFilter)
...
export const ShopSkipCategoriesFilter = function ShopSkipCategoriesFilter() {
  ...
  const items1 = [closure_5(stateFromStores(4718).Text, { variant: "text-md/normal", style: tmp.label, children: "Hide first # of categories" }), ];
  ...
  const items3 = [
    closure_5(closure_3, {
      ...
      children: closure_5(stateFromStores(4718).Text, { variant: "text-lg/semibold", children: "\u2212" })
    }),
    closure_5(stateFromStores(4718).Text, { variant: "text-md/semibold", style: tmp.valueText, children: stateFromStores }),
  ...
  obj2.children = closure_6(stateFromStores(5142).Stack, obj7);
