...
// Dependencies: [19, 17, 1076, 7391, 2038, 21, 4756, 576, 1478, 6864, 1612, 4492, 17401, 4752, 7781, 7422, 7390, 17402, 1115, 5904, 5186, 2]
// Exports: default

// Module 17400 (CollectiblesMobileAnnouncementActionSheet)
...
export default function CollectiblesMobileAnnouncementActionSheet(markAsDismissed) {
  ...
  const obj3 = { source: { uri: _modDef17402 }, style: tmp.framePreviewImage, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants" };
  ...
  const obj7 = { icon: closure_9(markAsDismissed(5904).PaintIllocon, { size: 32 }), text: null };
  ...
  const obj8 = { icon: closure_9(markAsDismissed(5904).HeartIllocon, { size: 32 }), text: null };
  ...
  const obj9 = { icon: closure_9(markAsDismissed(5904).ShopIllocon, { size: 32 }), text: null };
  ...
  return closure_9(markAsDismissed(7390).BottomSheet, obj);
};
