...
// Dependencies: [19, 17, 1372, 1076, 21, 4756, 576, 5334, 4724, 4725, 1177, 13474, 4752, 1115, 7402, 7781, 4723, 13475, 9110, 504, 4414, 8441, 7794, 2]
// Exports: EditCollectiblesListItemNone, EditCollectiblesListItemProduct, EditCollectiblesListItemShop

// Module 13473 (CollectiblesEditUserProfileListItems)
...
export const EditCollectiblesListItemShop = function EditCollectiblesListItemShop(analyticsSource) {
  ...
  const items1 = [closure_7(analyticsSource(1177).Icon, { source: analyticsLocations(13475), size: analyticsSource(1177).IconSizes.LARGE }), , ];
...
export const EditCollectiblesListItemProduct = function EditCollectiblesListItemProduct(skuId) {
  ...
  if (!result) {
    result = tmp3(7794).isPremiumCollectiblesPurchase(purchase);
    const tmp3Result = tmp3(7794);
  }
  ...
  if (null == purchase) {
    if (!result) {
      ...
      let tmp14 = React5(tmp3(9110).LockBadge, obj6);
    }
    items1[1] = tmp14;
  ...
  if (result) {
    ...
    if (!isTryItOut) {
      if (null == purchase) {
        ...
        tmp15 = React5(tmp3(9110).PremiumBadge, obj7);
      } else {
        tmp15 = null;
      }
    }
