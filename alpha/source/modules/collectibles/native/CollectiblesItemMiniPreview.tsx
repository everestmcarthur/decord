...
// Dependencies: [19, 17, 7787, 1971, 7788, 7789, 8490, 9078, 21, 576, 4756, 9090, 9102, 5799, 9103, 9081, 1970, 9098, 2]

// Module 13441 (CollectiblesItemMiniPreview)
...
let closure_8 = fn(8490).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
