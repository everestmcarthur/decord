...
// Dependencies: [19, 17, 4714, 21, 4722, 576, 8401, 1887, 1115, 4718, 5156, 8408, 8488, 8396, 504, 4566, 4956, 11146, 11147, 1177, 11158, 5775, 2]
// Exports: default

// Module 13388 (NameplateProductPreview)
...
function NameplateUser(arg0) {
  ...
  const icon = noop.useMemo(() => {
    const obj = { user: currentUser, guildId: "a", size: native.AvatarSizes.NORMAL, avatarDecoration, animate: !stateFromStores, autoStatusCutout: null, "aria-hidden": "Array" };
...
export default function NameplateProductPreview(product) {
  ...
  if (null != nameplateData) {
    ...
    items[1] = React5(tmp2(4718).Text, obj8);
    ...
    items[5] = React5(tmp2(4718).Text, obj12);
