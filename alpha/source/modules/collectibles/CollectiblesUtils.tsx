...
// Dependencies: [7743, 1888, 7744, 7745, 7751, 1076, 1074, 1085, 4380, 1378, 1380, 7430, 1364, 1890, 12, 1115, 7749, 2]
...
import ProfileFrameRecord from "ProfileFrameRecord" /* 7745 */;
import CollectiblesProductUtils from "CollectiblesProductUtils" /* 7749 */;
import ShopAssetConfigRecord from "ShopAssetConfigRecord" /* 7751 */;
...
function getItemRecordsFromPurchases(arr, PROFILE_EFFECT) {
  ...
  } else if (PROFILE_EFFECT === tmp(1890).CollectiblesItemType.NAMEPLATE) {
    const items1 = [];
    HermesBuiltin.arraySpread(arr.values(), 0);
  ...
  } else if (PROFILE_EFFECT === tmp(1890).CollectiblesItemType.PROFILE_EFFECT) {
    const items2 = [];
    HermesBuiltin.arraySpread(arr.values(), 0);
  ...
  } else if (PROFILE_EFFECT === tmp(1890).CollectiblesItemType.PROFILE_FRAME) {
    const items3 = [];
    HermesBuiltin.arraySpread(arr.values(), 0);
...
export const getProductTypeNameForLogging = function getProductTypeNameForLogging(arg0, arg1) {
  if (CollectiblesItemType.CollectiblesItemType.AVATAR_DECORATION === arg0) {
  ...
  } else if (tmp(1890).CollectiblesItemType.PROFILE_EFFECT === arg0) {
    return "profile effect";
  } else if (tmp(1890).CollectiblesItemType.NAMEPLATE === arg0) {
    return "nameplate";
  } else if (tmp(1890).CollectiblesItemType.PROFILE_FRAME === arg0) {
    return "profile frame";
  } else if (tmp(1890).CollectiblesItemType.BUNDLE === arg0) {
    return "bundle";
  } else if (tmp(1890).CollectiblesItemType.EXTERNAL_SKU === arg0) {
    ...
    return str3;
  } else if (tmp(1890).CollectiblesItemType.VARIANTS_GROUP === arg0) {
