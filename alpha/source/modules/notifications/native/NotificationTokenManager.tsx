...
// Dependencies: [17, 1235, 12656, 13833, 502, 14663, 1074, 1899, 573, 9932, 14666, 14667, 1231, 1115, 2806, 1364, 14668, 1241, 12655, 2]

// Module 14662 (NotificationTokenManager)
...
import PushNotificationActionCreatorsDefault from "PushNotificationActionCreators" /* 12655 */;
import NotificationSettingsConstants from "NotificationSettingsConstants" /* 14663 */;
import NotifSettingsExperiments from "NotifSettingsExperiments" /* 14666 */;
import NotifSettingsUtilsDefault from "NotifSettingsUtils" /* 14667 */;
import NativeNotifSettingsModuleDefault from "NativeNotifSettingsModule" /* 14668 */;
...
prototype["registerLegacyNotificationCategories"] = function registerLegacyNotificationCategories() {
  ...
  if (null != registerNotificationCategoriesAndGroups) {
    ...
    const intl = util.intl;
    obj.calls = intl.string(_modDef2806["IUH/Oe"]);
    const intl2 = util.intl;
    obj.mediaConnections = intl2.string(_modDef2806.VeBD1N);
    const intl3 = util.intl;
    obj.messages = intl3.string(_modDef2806["4qWUAO"]);
    const intl4 = util.intl;
    obj.directMessages = intl4.string(_modDef2806.NGdNZb);
    const intl5 = util.intl;
    obj.friendRequests = intl5.string(_modDef2806.NxgGZA);
    const intl6 = util.intl;
    obj.polls = intl6.string(_modDef2806.MOjygY);
    const intl7 = util.intl;
    obj.social = intl7.string(_modDef2806["UzRF+8"]);
    const intl8 = util.intl;
    obj.stageLive = intl8.string(_modDef2806["4n388K"]);
    const intl9 = util.intl;
    obj.guildEventLive = intl9.string(_modDef2806["40TIqW"]);
    const intl10 = util.intl;
    obj.guildHighlights = intl10.string(util.t.p5jg9S);
    const intl11 = util.intl;
    obj.forumThreadCreated = intl11.string(_modDef2806.HibKoy);
    const intl12 = util.intl;
    obj.systemMessages = intl12.string(_modDef2806.zJlwvV);
    const intl13 = util.intl;
    obj.other = intl13.string(_modDef2806.kIrLfg);
    const intl14 = util.intl;
    obj.default = intl14.string(_modDef2806["T+79Eo"]);
    const intl15 = util.intl;
    obj.reactions = intl15.string(util.t.gHp0C4);
    const obj2 = { realtime: null, social: null, server: null, other: null };
    const intl16 = util.intl;
    obj2.realtime = intl16.string(_modDef2806.S5cB9e);
    const intl17 = util.intl;
    obj2.social = intl17.string(_modDef2806["UzRF+8"]);
    const intl18 = util.intl;
    obj2.server = intl18.string(_modDef2806.zRKbpz);
    const intl19 = util.intl;
    obj2.other = intl19.string(_modDef2806.q5M7HV);
