...
// Dependencies: [32, 19, 4714, 504, 1364, 17333, 5757, 2]
// Exports: default

// Module 17332 (usePreloadedAsset)
  ...
  const effect = obj4.useEffect(() => {
    if (null != c0) {
      if (closure_3) {
        ...
        if (dependencyMap) {
          if (null != num(17333)) {
            let preloadResult = num(17333).preload(tmp);
            const obj2 = num(17333);
          }
          preloadResult.then(() => {
            if (!c0) {
              c0 = true;
        ...
        preloadResult = num(5757).preload(tmp, timeout + 1000);
        let obj = num(5757);
      }
    }
  }, items1);
