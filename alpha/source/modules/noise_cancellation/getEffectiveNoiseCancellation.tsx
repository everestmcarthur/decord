...
// Dependencies: [1364, 10252, 2]
// Exports: default

// Module 10251 (getEffectiveNoiseCancellation)
  ...
  if (!obj.isIOS()) {
    if (!tmpResult.isMac()) {
      ...
      if (arg0) {
        ...
        if (!tmp5) {
          tmp5 = !tmp(10252).getWindowsAudioEffectsExperimentConfig({ location: "setNoiseCancellation" }).preferSystemEffects;
          const tmpResult4 = tmp(10252);
        }
        if (tmp5) {
          tmp5 = arg0;
        }
