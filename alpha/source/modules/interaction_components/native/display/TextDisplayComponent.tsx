...
// Dependencies: [32, 19, 4748, 2041, 2095, 8379, 21, 8380, 38, 4746, 8131, 504, 2019, 8541, 16024, 11865, 11835, 2]
// Exports: default

// Module 16023 (TextDisplayComponent)
...
require = fn;
let closure_8 = fn(8379).TEXT_DISPLAY_COMPONENT_MARKDOWN_RENDER_OPTIONS;
const jsx = fn(21).jsx;
const size = fn(2);
