...
// Dependencies: [19, 17, 10547, 21, 4756, 576, 1177, 8424, 4752, 1115, 10564, 2]

// Module 10566 (EmojiPickerListComponents)
...
const memoResult = noop.memo(() => {
  ...
  const items = [React4(native.Icon, { source: _modDef8424, size: native.Icon.Sizes.SMALL }), ];
