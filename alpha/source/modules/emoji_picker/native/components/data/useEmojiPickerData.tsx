...
// Dependencies: [19, 5629, 5633, 10531, 504, 10545, 10546, 10547, 10549, 2]
// Exports: default

// Module 10544 (useEmojiPickerData)
import getEmojiPickerDataRowItemNativeSectionDefault from "getEmojiPickerDataRowItemNativeSection" /* 10545 */;
import getEmojiPickerDataRowPremiumInlineRoadblockDefault from "getEmojiPickerDataRowPremiumInlineRoadblock" /* 10546 */;
import PremiumUpsellSectionDivider from "PremiumUpsellSectionDivider" /* 10547 */;
import getEmojiPickerDataRowItemSlimEmojiDefault from "getEmojiPickerDataRowItemSlimEmoji" /* 10549 */;
import noop from "module_19" /* 19 */;
import EmojiStore from "EmojiStore" /* 5629 */;

require = fn;
const LoadState = fn(5629).LoadState;
const EmojiCategoryTypes = fn(5633).EmojiCategoryTypes;
let closure_7 = fn(10531).EmojiPickerRenderingDataType;
