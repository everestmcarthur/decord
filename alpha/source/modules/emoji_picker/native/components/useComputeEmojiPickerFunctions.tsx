...
// Dependencies: [32, 19, 5675, 10547, 10551, 4409, 12, 10542, 2017, 2]
// Exports: default

// Module 10550 (useComputeEmojiPickerFunctions)
...
const constants3 = fn(10547).EmojiPickerRenderingDataType;
const size = fn(2);
