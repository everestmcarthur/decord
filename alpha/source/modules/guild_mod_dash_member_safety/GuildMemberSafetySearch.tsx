...
// Dependencies: [32, 7760, 4875, 11, 4383, 4401, 2]
// Exports: getDefaultSearchState

// Module 7759 (GuildMemberSafetySearch)
...
prototype["updateSearchState"] = function updateSearchState(arg0) {
  ...
  this._searchState = {};
  this.hasDefaultQuery = _modDef4875(this._searchState, closure_4);
  return true;
};
