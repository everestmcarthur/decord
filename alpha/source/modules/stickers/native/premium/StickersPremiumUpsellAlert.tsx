...
// Dependencies: [19, 17, 7477, 1074, 1374, 21, 10667, 1115, 576, 10668, 10669, 4756, 1177, 4752, 573, 7659, 9477, 1478, 7402, 5205, 1241, 9505, 5334, 7232, 10670, 2]
// Exports: default

// Module 10666 (StickersPremiumUpsellAlert)
...
import _modDef10667 from "module_10667" /* 10667 */;
...
export default function StickersPremiumUpsellAlert(arg0) {
  ...
  const tmp5 = analyticsLocations(9477)(PREMIUM_MONTH_TIER_2.PREMIUM_MONTH_TIER_2);
  let priceString;
  if (tmp5 != null) {
    priceString = tmp5.priceString;
  }
  analyticsLocations = tmp3(7402)().analyticsLocations;
  ...
  const tmp3Result = analyticsLocations(5205);
  obj3.children = closure_14(native.Icon, { source: analyticsLocations(7232) });
  ...
  const obj4 = { source: analyticsLocations(7232) };
  const items2 = [closure_14(closure_5, { source: analyticsLocations(10670), style: tmp.imageHeader }), , ];
  ...
  const obj6 = { source: analyticsLocations(10670), style: tmp.imageHeader };
