...
// Dependencies: [32, 19, 17, 1980, 10632, 1074, 1218, 21, 4722, 576, 1936, 5061, 5438, 1241, 5292, 1177, 1397, 5754, 10416, 5264, 4690, 4691, 10600, 10601, 7251, 1115, 10663, 2]
// Exports: default

// Module 10662 (StickerPickerCategories)
...
let useStickerPickerStore = fn(10632).useStickerPickerStore;
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(10600)();
  const tmp20 = closure_15;
  const items9 = [closure_14(categoryIndex(7251), { estimatedListSize: "windowSize", horizontal: true, itemSize: EXPRESSION_FOOTER_HEIGHT, keyboardShouldPersistTaps: "always", listId: ExpressionPickerViewType.STICKER, onLayout: callback4, onScroll: callback1, placeholderConfig: tmp19, ref, scrollReporting: "callbacks", sections: memo, renderItem: callback5, showsHorizontalScrollIndicator: false, style: tmp.list }), ];
  ...
  if (tmp22Result) {
    ...
    obj4.style = items10;
    const obj5 = { style: tmp.guildIcon, source: tmp17(10663) };
    obj4.children = tmp22(categories(1177).Icon, obj5);
    obj3.children = tmp22(closure_5, obj4);
    tmp22Result = tmp22(categories(5292).PressableOpacity, obj3);
  }
  items9[1] = tmp22Result;
  obj.children = items9;
  return tmp20(categoryIndex(10601), obj);
};
