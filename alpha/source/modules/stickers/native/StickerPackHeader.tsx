...
// Dependencies: [19, 17, 10514, 21, 4722, 576, 4718, 5061, 1177, 10639, 10640, 1115, 10641, 5292, 2]
...
export default noop.memo((withDescription) => {
  ...
  if (result) {
    ...
    const obj6 = { source: _modDef10639, style: tmp.animatedIcon, size: tmp6(1177).Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color };
  ...
  if (null != onPress) {
    ...
    let tmp4Result = tmp4(tmp6(5292).PressableOpacity, obj15);
  } else {
