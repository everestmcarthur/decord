...
// Function ID: 5168
// Name: MarkupRules
// Dependencies: [32, 718, 1958, 2016, 1980, 1372, 1074, 5168, 5169, 5170, 1115, 5173, 2019, 4874, 4566, 5174, 2075, 5175, 5176, 5179, 4375, 5181, 5192, 5193, 5194, 5195, 5166, 5196, 12, 2]
...
function hydrateUserMention(everyoneOrHere, channelId) {
  ...
  if (null != str) {
    ...
    if (null != channel) {
      ...
      if (nickname == null) {
        nickname = tmp4(4566).getName(str);
