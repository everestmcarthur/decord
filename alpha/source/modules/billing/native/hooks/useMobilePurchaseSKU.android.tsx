...
// Dependencies: [5, 19, 7620, 1372, 1074, 7434, 3, 10946, 5768, 1241, 573, 7625, 4395, 1926, 11064, 1255, 2]
// Exports: default

// Module 11063 (useMobilePurchaseSKU)
...
const require = fn;
let closure_5 = fn(7620).useNativeCheckoutStoreOrNull;
