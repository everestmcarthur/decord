...
// Dependencies: [19, 17, 1074, 21, 4722, 576, 4656, 1177, 1115, 2025, 4573, 11688, 11689, 2]
// Exports: default

// Module 11687 (BlockedPaymentsCountryDisplay)
...
export default function BlockedPaymentsCountryDisplay() {
  ...
  if (obj7.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(11688);
  } else {
    tmp2Result = tmp2(11689);
  }
