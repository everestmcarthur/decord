...
// Dependencies: [5, 32, 19, 17, 1372, 5722, 1074, 1374, 21, 3, 1612, 10958, 504, 11309, 7781, 1969, 9480, 11281, 4723, 5109, 7794, 5184, 4752, 5819, 5186, 11090, 1255, 10922, 7390, 11083, 2]
// Exports: default
...
function GiftPurchaseSKUView(selectedSkuId) {
  ...
  items6[14] = str;
  const items7 = [closure_11(selectedSkuId(4752).Text, { variant: "text-md/medium", color: "text-overlay-light", children: items6 }), , ];
  let str4 = "Send Gift";
  if (isFetching) {
    str4 = "Loading...";
  }
  let obj9 = {
    children: closure_12(selectedSkuId(5186).Button, {
      variant: "primary",
      text: str4,
