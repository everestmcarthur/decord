...
// Dependencies: [19, 17, 21, 4722, 576, 5611, 1177, 4718, 2]
// Exports: default

// Module 13548 (PaymentFlowWarningMessage)
...
const obj2 = { container: { padding: 10, marginVertical: 5, borderRadius: nativeDefault.radii.xs, display: "flex", flexDirection: "row", alignItems: "center", backgroundColor: fn(5611).DARK_PRIMARY_630_LIGHT_PRIMARY_230 }, icon: { marginRight: 10 }, text: { flexShrink: 1 } };
