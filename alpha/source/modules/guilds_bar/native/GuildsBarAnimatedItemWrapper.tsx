...
// Dependencies: [19, 5153, 16539, 21, 4722, 576, 4423, 4432, 5143, 4458, 7269, 16552, 16279, 16282, 1115, 4433, 16553, 5759, 9054, 2]
// Exports: default, useGuildsBarAnimatedWrapperStyles

// Module 16551 (GuildsBarAnimatedItemWrapper)
  ...
  const effect = obj5.useEffect(() => {
    if (undefined !== ref.current) {
      if (tmp.current !== expanded) {
        ...
        const t = util.t;
        AccessibilityAnnouncer = AccessibilityAnnouncer(4433).AccessibilityAnnouncer;
