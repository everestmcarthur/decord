...
// Dependencies: [5650, 5652, 2]
// Exports: default

// Module 16673 (getGuildBarNeighbors)
import GuildsTree from "GuildsTree" /* 5652 */;
    ...
    if (node.type === GuildsTree.GuildsNodeType.GUILD) {
      ...
      if (null == root) {
        ...
        if (index < 0) {
          ...
          let tmp2 = null;
          if (root.type === tmp5(5652).GuildsNodeType.FOLDER) {
            tmp2 = root;
          }
          const obj = { containingFolder: tmp2, above: null, below: null };
          let tmp3 = null;
          if (null != root.children[index - 1]) {
            const obj2 = { node: tmp8, isFolder: tmp8.type === tmp5(5652).GuildsNodeType.FOLDER };
            tmp3 = obj2;
          }
          obj.above = tmp3;
          let tmp4 = null;
          if (null != root.children[index + 1]) {
            const obj3 = { node: tmp9, isFolder: tmp9.type === tmp5(5652).GuildsNodeType.FOLDER };
            tmp4 = obj3;
          }
          obj.below = tmp4;
          return obj;
