...
// Dependencies: [5, 19, 17, 1980, 5608, 16542, 16539, 4458, 551, 4690, 4573, 12, 1231, 1115, 7268, 16279, 4423, 576, 4345, 11245, 1248, 5690, 9596, 8136, 1364, 1612, 5129, 16543, 16544, 15305, 6848, 2]
// Exports: default

// Module 16541 (useGuildsBarGesture)
    ...
    if (item.section >= GUILDS) {
      ...
      if (null != GUILDS) {
        ...
        if (FastList.FastListItemTypes.SECTION !== type) {
          if (tmp9(7268).FastListItemTypes.ITEM === type) {
      ...
      if (null != overSpecs) {
        if (null != dragSpecs) {
          ...
          if (FastList.FastListItemTypes.SECTION === type2) {
            ...
            if (tmp34(7268).FastListItemTypes.SECTION === type) {
              let str = "before";
              let str2 = "before";
