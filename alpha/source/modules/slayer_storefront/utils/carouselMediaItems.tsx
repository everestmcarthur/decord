        ...
        if (null != tmp5) {
          ...
          if (mime_type.startsWith("video/")) {
            ...
            if (null != tmp4.backgroundAssetId) {
              let tmp26Result2 = tmp26(4964);
              assetURL1 = tmp26Result2.getAssetURL(applicationId, tmp4.backgroundAssetId, heroWidth, tmp26(7422).LARGE_ASSET_FORMAT);
            }
            ...
            let assetURL3;
            if (null != tmp4.backgroundAssetId) {
              let tmp8Result2 = tmp8(4964);
              assetURL3 = tmp8Result2.getAssetURL(applicationId, tmp4.backgroundAssetId, heroWidth, tmp8(7422).LARGE_ASSET_FORMAT);
            }
