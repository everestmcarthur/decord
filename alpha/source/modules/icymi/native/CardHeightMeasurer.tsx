...
// Dependencies: [19, 17, 21, 16786, 8621, 2]

// Module 16853 (CardHeightMeasurer)
...
export const CardHeightMeasurer = noop.memo((children) => {
  ...
  }, items)} pointerEvents="box-none" style={{ width: noop.useContext(itemId(16786).ICYMIContext).width, alignSelf: "center" }}>{arg0.children}</View>;
});
