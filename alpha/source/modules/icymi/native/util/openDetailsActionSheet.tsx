...
// Dependencies: [8621, 4723, 16791, 1980, 2]
// Exports: openDetailsActionSheet

// Module 16825 (openDetailsActionSheet)
...
export const openDetailsActionSheet = function openDetailsActionSheet(arg0) {
  ...
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16791, dependencyMap.paths), "ItemDetailsActionSheet", { guildId, channelId, id });
};
