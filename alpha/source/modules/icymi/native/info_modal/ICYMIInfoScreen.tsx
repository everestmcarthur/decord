...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4722, 576, 5852, 1612, 4656, 1484, 8591, 16726, 4925, 8067, 8075, 1115, 5757, 16728, 16729, 16730, 16731, 4718, 9524, 13255, 4681, 4689, 16732, 1897, 5144, 2]
// Exports: default

// Module 16725 (ICYMIInfoScreen)
...
let size = { position: "absolute", justifyContent: "center", left: 12, width: 24, height: fn(5852).NAV_BAR_HEIGHT, zIndex: 2 };
obj2.closeIcon = size;
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const ICYMIAnalytics = tmp2(8591).ICYMIAnalytics;
            const result = ICYMIAnalytics.trackFeedOnboardingScreenSkipped({ location: "overview" });
            dependencyMap(true);
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: tmp2(16726).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj5;
          } else {
            v1(4925).pop();
            dependencyMap = 3;
  ...
  obj2.style = items2;
  let obj3 = {
    source: navigation(8075),
    onPress() {
      return navigation(4925).pop();
    },
  ...
  obj2.children = closure_9(extendedOnboarding(8067).HeaderIconButton, obj3);
  ...
  obj6.uri = navigation(16728);
  obj5.source = obj6;
  obj5.style = tmp.bgImage;
  const items5 = [closure_9(navigation(5757), obj5), ];
  const obj7 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5757);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(16729);
  } else {
    tmp2Result = tmp2(16730);
  }
  const items7 = [closure_9(navigation(5757), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj11 = { source: null, style: null };
  const obj10 = { source: { uri: tmp2Result }, style: tmp.headerImg };
  const tmp17 = navigation(5757);
  obj11.source = navigation(16731);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5757), obj11);
  ...
  items7[2] = closure_9(extendedOnboarding(4718).Text, obj12);
  ...
  items7[3] = closure_9(extendedOnboarding(4718).Text, obj13);
  ...
  const tmp2Result2 = navigation(5757);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9524).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = closure_9(extendedOnboarding(4718).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9524).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13255).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = closure_9(extendedOnboarding(4718).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13255).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj23 = { style: tmp.divider };
  const items12 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(4681).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = closure_9(extendedOnboarding(4718).Text, obj26);
  ...
  obj27.children = intl7.format(extendedOnboarding(1115).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(extendedOnboarding(4718).Text, {
  ...
  items13[1] = closure_9(extendedOnboarding(4718).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(5144).Button, obj30);
