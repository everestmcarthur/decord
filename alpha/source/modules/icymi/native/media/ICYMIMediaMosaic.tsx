...
// Dependencies: [32, 19, 17, 4748, 2041, 4405, 1372, 8605, 1074, 21, 4756, 576, 4906, 1094, 504, 8577, 4492, 4757, 16831, 5799, 4752, 1115, 8544, 5349, 5334, 8621, 10243, 5312, 16786, 8535, 8618, 1370, 12, 7350, 8529, 4909, 2]
// Exports: default
...
function MediaMosaicImage(source) {
  ...
  let obj = source(4492);
  fn.__closure = { withTiming: source(4757).withTiming, imageFinishedLoading };
  ...
  obj5.blurRadius = num;
  items3[1] = closure_15(imageFinishedLoading(4492).Image, obj5, source.uri);
