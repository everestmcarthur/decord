...
// Dependencies: [32, 5, 19, 17, 2041, 5105, 5104, 1074, 11121, 4749, 21, 4756, 576, 9871, 1115, 16836, 4454, 1478, 4609, 8114, 16837, 5336, 4574, 4466, 7221, 11943, 11952, 5186, 4959, 11246, 1370, 7916, 9420, 1255, 5339, 7696, 9422, 1612, 1364, 5843, 8105, 5836, 11249, 2]
...
function GravityShareFooter(arg0) {
  ...
  if (0 !== count) {
    ...
    items2[1] = map1(tmp7(5186).Button, obj5);
