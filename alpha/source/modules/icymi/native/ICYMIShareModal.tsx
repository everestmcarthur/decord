...
// Dependencies: [32, 5, 19, 17, 1958, 5063, 5062, 1074, 11108, 4715, 21, 4722, 576, 10020, 1115, 16760, 4420, 1478, 4575, 8076, 16761, 5294, 4540, 4432, 7177, 11934, 11943, 5144, 4925, 11233, 1370, 7878, 9545, 1255, 5297, 7652, 9547, 1612, 1364, 5801, 8067, 5794, 11236, 2]
// Exports: GameShareModal, GuildEventShareModal

// Module 16759 (ICYMIShareModal)
...
import ShareEventUtils from "ShareEventUtils" /* 10020 */;
import useShareChatInputActions from "useShareChatInputActions" /* 11934 */;
import ShareChatInputDefault from "ShareChatInput" /* 11943 */;
...
function GravityShareFooter(arg0) {
  ...
  if (0 !== count) {
    ...
    items2[1] = map1(tmp7(5144).Button, obj5);
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            c5 = 2;
            c6 = 1;
            const obj7 = { value: entry(16760).sendMessageWithEmbed(obj6), done: false };
            return obj7;
          }
        } else if (1 === tmp7) {
          c4 = 0;
