...
// Function ID: 16820
// Name: useICYMIItems
// Dependencies: [19, 8605, 8618, 504, 8621, 2]
// Exports: default
...
function createItem(id, type, unread) {
  ...
  if (ICYMITypes.ICYMIItemTypes.MESSAGE === type) {
    ...
    if (tmp(8618).ICYMIItemTypes.ACTIVITY !== type) {
      if (tmp(8618).ICYMIItemTypes.CUSTOM_STATUS !== type) {
        if (tmp(8618).ICYMIItemTypes.GUILD_EVENT === type) {
          ...
          obj6.unread = unread;
          return obj6;
        } else if (tmp(8618).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
