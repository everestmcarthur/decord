...
// Dependencies: [17775, 2]

// Module 17779 (HolidayEventsUtils)
...
export default {
  ...
  useHolidaySoundpack() {
    ...
    if (tmp5) {
      tmp6 = null;
      if (null != tmp(17775).soundpack) {
        tmp6 = null;
        if (null != tmp(17775).soundpackLabel) {
          const obj2 = { soundpack: tmp(17775).soundpack, soundpackLabel: tmp(17775).soundpackLabel };
          tmp6 = obj2;
        }
      }
    }
  ...
  getAppSpinnerSources() {
    ...
    if (tmp4) {
      appSpinnerSources = tmp2(17775).appSpinnerSources;
    }
  ...
  getLoadingTips() {
    ...
    let tmp5 = null;
    if (tmp4) {
      const getLoadingTips = tmp2(17775).getLoadingTips;
      let loadingTips;
      if (getLoadingTips != null) {
        loadingTips = getLoadingTips();
      }
      tmp5 = loadingTips;
      const tmp2Result = tmp2(17775);
    }
    return tmp5;
  },
  getHolidaySoundpack() {
