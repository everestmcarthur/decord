...
// Dependencies: [4371, 1074, 4357, 504, 573, 2]

// Module 7854 (GameRelationshipStore)
...
const secondaryIndexMap = new fn(4357).SecondaryIndexMap(function gameRelationshipsIndex(arg0) {
  const items = [];
