...
export default function ChannelAccessInfo(guild) {
  ...
  const items2 = [closure_8(guild(4752).Text, { variant: "eyebrow", children: stringResult }), ];
  let obj2 = {
  ...
  if (null != first) {
    ...
    function renderCounts(MEMBERS, length, arg2, GroupIcon) {
      if (0 === length) {
        ...
        items[1] = React6(tmp4(4752).Text, obj8);
        obj6.children = items;
