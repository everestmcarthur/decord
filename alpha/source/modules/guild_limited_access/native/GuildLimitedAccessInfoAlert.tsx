...
// Dependencies: [19, 2063, 14095, 1074, 21, 4756, 5736, 576, 1115, 5205, 1177, 4752, 2]
// Exports: default

// Module 14094 (GuildLimitedAccessInfoAlert)
...
require = fn;
const helpdeskArticle = fn(14095).GUILD_LIMITED_ACCESS_HC_LINK;
const jsxProd = fn(21);
