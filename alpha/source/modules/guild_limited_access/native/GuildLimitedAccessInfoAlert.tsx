...
// Dependencies: [19, 1980, 14041, 1074, 21, 4722, 5694, 576, 1115, 5163, 1177, 4718, 2]
// Exports: default

// Module 14040 (GuildLimitedAccessInfoAlert)
...
require = fn;
const helpdeskArticle = fn(14041).GUILD_LIMITED_ACCESS_HC_LINK;
const jsxProd = fn(21);
