...
// Dependencies: [32, 19, 17, 11875, 21, 4756, 576, 4723, 12, 8542, 5203, 4959, 11897, 1980, 1115, 4752, 11879, 5816, 5899, 5817, 5186, 1612, 7390, 7389, 7438, 6864, 2]
// Exports: default

// Module 16997 (FeedbackActionSheetV2)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5203).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11897, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11897, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4752).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11879), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5816).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5817).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5899).TableRowGroup, obj10);
        ...
        items3[1] = closure_7(tmp20(5186).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5899).TableRowGroup, obj14);
      ...
      items4[1] = closure_7(tmp20(5186).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7438).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7389).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6864).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7390).BottomSheet, obj16);
};
