...
// Dependencies: [1115, 1895, 2]
// Exports: getValidationErrorText

// Module 5168 (ApplicationCommandConstants)
...
export const getValidationErrorText = function getValidationErrorText(option) {
  if (null != option.choices) {
    ...
    } else if (tmp3(1895).ApplicationCommandOptionType.CHANNEL === type) {
      const intl7 = tmp3(1115).intl;
      return intl7.string(tmp3(1115).t.Q0z2Gx);
    } else if (tmp3(1895).ApplicationCommandOptionType.INTEGER === type) {
      const intl6 = tmp3(1115).intl;
      return intl6.string(tmp3(1115).t["d/9Rk4"]);
    } else if (tmp3(1895).ApplicationCommandOptionType.NUMBER === type) {
      const intl5 = tmp3(1115).intl;
      return intl5.string(tmp3(1115).t["FDyk/V"]);
    } else if (tmp3(1895).ApplicationCommandOptionType.ROLE === type) {
      const intl4 = tmp3(1115).intl;
      return intl4.string(tmp3(1115).t.vrRQn0);
    } else if (tmp3(1895).ApplicationCommandOptionType.USER === type) {
      const intl3 = tmp3(1115).intl;
      return intl3.string(tmp3(1115).t.i2r7j5);
    } else if (tmp3(1895).ApplicationCommandOptionType.MENTIONABLE === type) {
