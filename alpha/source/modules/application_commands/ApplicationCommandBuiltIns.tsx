...
// Dependencies: [5, 1958, 4361, 1372, 5168, 1074, 9539, 2024, 4715, 7719, 1115, 9540, 1895, 1936, 9541, 9542, 7465, 9543, 1095, 9544, 7652, 7878, 5690, 4566, 1091, 9641, 4314, 4735, 38, 7444, 9642, 2]
// Exports: getBuiltInCommands

// Module 9538 (ApplicationCommandBuiltIns)
...
const DiceRollConstants = fn(9539);
...
let obj = {};
let obj2 = { id: BuiltInSectionId.BUILT_IN, type: fn(7719).ApplicationCommandSectionType.BUILT_IN };
...
let obj3 = { id: BuiltInSectionId.FRECENCY, type: fn(7719).ApplicationCommandSectionType.BUILT_IN };
...
let items = [...fn(9540).default];
let obj4 = { id: "-1", untranslatedName: "shrug", displayName: "shrug", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[tmp5] = obj4;
const sum = tmp5 + 1;
let obj6 = { id: "-2", untranslatedName: "tableflip", displayName: "tableflip", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum] = obj6;
const sum1 = sum + 1;
let obj8 = { id: "-3", untranslatedName: "unflip", displayName: "unflip", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum1] = obj8;
const sum2 = sum1 + 1;
let obj10 = { id: "-4", untranslatedName: "tts", displayName: "tts", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum2] = obj10;
const sum3 = sum2 + 1;
const obj12 = { id: "-5", untranslatedName: "me", displayName: "me", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum3] = obj12;
const sum4 = sum3 + 1;
const obj14 = { id: "-6", untranslatedName: "spoiler", displayName: "spoiler", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum4] = obj14;
const sum5 = sum4 + 1;
const obj16 = { id: "-7", untranslatedName: "nick", displayName: "nick", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum5] = obj16;
const sum6 = sum5 + 1;
const obj18 = { id: "-10", untranslatedName: "thread", displayName: "thread", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum6] = obj18;
const sum7 = sum6 + 1;
const obj21 = { id: "-11", untranslatedName: "kick", displayName: "kick", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum7] = obj21;
const sum8 = sum7 + 1;
const obj24 = { id: "-12", untranslatedName: "ban", displayName: "ban", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum8] = obj24;
const sum9 = sum8 + 1;
const obj28 = { id: "-13", untranslatedName: "timeout", displayName: "timeout", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum9] = obj28;
const sum10 = sum9 + 1;
const obj32 = { id: "-14", untranslatedName: "msg", displayName: "msg", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            c0 = 1;
            const obj6 = {
              value: v1(4735).openPrivateChannel(obj5).then((result) => {
                        channel = channel.getChannel(result);
                        c1(38)(null != channel, "Newly created PrivateChannel is null");
                        const obj = c1(7652);
                        obj.sendMessage(channel.id, c1(7878).parse(channel, dependencyMap), true, { location: constants.PRIVATE_MESSAGE_COMMAND });
                      }),
              done: false
            };
            return obj6;
...
items[sum10] = obj32;
const obj35 = { id: "-18", untranslatedName: "roll-dice", displayName: "roll-dice", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7719).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
export const PLATFORM_COMMANDS = fn(9540).default;
