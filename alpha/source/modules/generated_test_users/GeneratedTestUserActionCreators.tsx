...
// Dependencies: [5, 1386, 15862, 1074, 8669, 6829, 8674, 4949, 1249, 573, 15886, 2]
// Exports: getGeneratedPoolById, loginAsGeneratedUser, removeGeneratedPoolFromList

// Module 15885 (GeneratedTestUserActionCreators)
...
let closure_8 = async function _getGeneratedPoolById() {
  ...
  await value.then((body) => {
    ...
    if (body.ok) {
      ...
      const GeneratedTestPoolRecord = closure_0(15886).GeneratedTestPoolRecord;
      ...
      closure_1(8674).showFailedToast(constants.GENERIC_ERROR);
      const obj = closure_1(8674);
    }
  }).catch(() => {
    closure_1_1(8674).showFailedToast(constants.GENERIC_ERROR);
    return null;
  });
  return arg1;
};
