...
// Dependencies: [19, 17, 21, 4722, 576, 1612, 16881, 7393, 7345, 1115, 3676, 6820, 4718, 4404, 4314, 2]
// Exports: default

// Module 16882 (VibegrationsChangelogSheet)
...
export default function VibegrationsChangelogSheet() {
  ...
  obj3.title = intl.string(_modDef3676.x07mpp);
