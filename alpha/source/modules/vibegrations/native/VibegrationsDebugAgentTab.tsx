...
export default function VibegrationsDebugAgentTab(projectId) {
  ...
  if (null == lifetime) {
    ...
    if (null != outcomes) {
      ...
      if (Object.keys(status.agent.outcomes).length > 0) {
        ...
        obj17.label = intl2.string(tmp20(3678).Q2OlgI);
  ...
  if (null == stateFromStores) {
    ...
    const obj21 = { label: intl43.string(tmp20(3678)["VwF+oY"]), value: null, hint: null };
  ...
  if (null != stateFromStores1) {
    ...
    obj33.text = intl14.string(tmp20(3678).B0KV7p);
    obj33.disabled = "pending" === stateFromStores3;
    obj33.onPress = callback;
    const items17 = [tmp18(tmp2(5186).Button, obj33), , ];
    let str9 = "text-muted";
    if (null != tmp15) {
      str9 = "text-muted";
    ...
    if (true === pendingTurn) {
      ...
      obj36.text = intl46.string(tmp20(3678)["044+ju"]);
      obj36.onPress = callback1;
      const items18 = [tmp18(tmp2(5186).Button, obj36), ];
      const obj37 = { variant: "text-xs/normal", color: "text-muted", children: null };
      const intl47 = tmp2(1115).intl;
      obj37.children = intl47.string(tmp20(3678)["8D32H6"]);
      items18[1] = tmp18(tmp2(4752).Text, obj37);
    ...
    if (traceVisible) {
      ...
      if (null != session) {
        ...
        obj38.title = intl18.string(tmp20(3678).ZRxAPD);
      ...
      if (null != limits) {
        ...
        obj45.title = intl25.string(tmp20(3678)["EmSF+A"]);
      ...
      obj55.title = intl15.string(tmp20(3678).F5eP7e);
