...
// Dependencies: [19, 17, 13360, 21, 4756, 576, 504, 17023, 5819, 16753, 4752, 1115, 3678, 17021, 2]
// Exports: default

// Module 17047 (VibegrationsThinkingOverlay)
...
export default function VibegrationsThinkingOverlay(projectId) {
  ...
  if ("" !== text) {
    ...
    obj9.children = tmp7(tmp10(17021), obj10);
  ...
  obj4.children = closure_7(projectId(5819).Card, { variant: "primary", shadow: "high", children: tmp9(closure_5, obj5) });
