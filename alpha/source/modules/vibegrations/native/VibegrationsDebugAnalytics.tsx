...
// Dependencies: [19, 21, 17062, 1115, 3678, 17060, 17059, 2]
// Exports: VibegrationsDebugAgentAnalyticsRows, VibegrationsDebugWorkerAnalyticsSection

// Module 17073 (VibegrationsDebugAnalytics)
  ...
  if ("ok" !== analytics.status) {
    ...
    if (null == found) {
      ...
      if (null != analyticsMemoryValueResult) {
        ...
        tmp17Result = tmp17(tmp12(17062).DebugStatRow, obj);
      }
...
export const VibegrationsDebugWorkerAnalyticsSection = function VibegrationsDebugWorkerAnalyticsSection(analytics) {
  ...
  if ("ok" !== analytics.status) {
    ...
    let obj3 = { children: tmp(17060).analyticsUnavailableReason(analytics) };
    obj2.children = React3(tmp(17062).DebugNote, obj3);
    return React3(tmp(17062).DebugSection, obj2);
  } else {
    ...
    if (0 === found.length) {
      ...
      let mapped1 = tmp5(tmp(17062).DebugNote, obj4);
    } else {
    ...
    return React3(tmp(17062).DebugSection, obj);
  }
};
