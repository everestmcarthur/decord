...
// Dependencies: [32, 19, 17, 13359, 21, 4756, 576, 7875, 1612, 5114, 1115, 3678, 4723, 4752, 5899, 5817, 7437, 7389, 6864, 2]
// Exports: default
...
export default function VibegrationsVersionHistorySheet(projectId) {
  ...
  if ("loading" === tmp5.status) {
    ...
    obj3.children = jsx(projectId(4752).Text, { variant: "text-md/normal", color: "text-muted", children: null });
    ...
    obj5.children = jsx(projectId(4752).Text, { variant: "text-md/normal", color: "text-muted", children: null });
