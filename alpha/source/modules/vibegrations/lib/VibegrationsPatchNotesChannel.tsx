...
export const formatPlaySuffix = function formatPlaySuffix(PLAY_LINE_CHANNEL_PLACEHOLDER) {
  ...
  return "\n\n" + intl.formatToPlainString(_modDef3676.bhoZhI, { channel: PLAY_LINE_CHANNEL_PLACEHOLDER });
};
