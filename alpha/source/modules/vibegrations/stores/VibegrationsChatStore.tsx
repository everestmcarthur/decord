...
// Dependencies: [32, 109, 7777, 10337, 2095, 4577, 5491, 9308, 1074, 2048, 1115, 3678, 9311, 2019, 10157, 504, 573, 2]
    ...
    if (tmp) {
      ...
      if (null != project) {
        ...
        if (!result4) {
          ...
          if (isWindowFocusedResult) {
            isWindowFocusedResult = tmp68(9311).isWindowFocused();
            const tmp68Result = tmp68(9311);
          }
          if (guild_id == null) {
