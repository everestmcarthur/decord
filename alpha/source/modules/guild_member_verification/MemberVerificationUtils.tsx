...
// Dependencies: [5228, 1074, 4546, 1370, 2]
...
// Module 5227 (MemberVerificationUtils)
import Constants from "Constants" /* 1074 */;
import MemberVerificationTypes from "MemberVerificationTypes" /* 4546 */;
import MemberVerificationConstants from "MemberVerificationConstants" /* 5228 */;
  ...
  if (required.required) {
    if (null == response) {
      ...
      if (MemberVerificationTypes.VerificationFormFieldTypes.TERMS !== field_type) {
        if (tmp4(4546).VerificationFormFieldTypes.VERIFICATION !== field_type) {
          if (tmp4(4546).VerificationFormFieldTypes.TEXT_INPUT !== field_type) {
            if (tmp4(4546).VerificationFormFieldTypes.PARAGRAPH !== field_type) {
              if (tmp4(4546).VerificationFormFieldTypes.MULTIPLE_CHOICE === field_type) {
