...
// Dependencies: [19, 17, 1958, 7347, 7404, 21, 4722, 576, 8471, 8460, 8457, 8468, 8409, 16841, 8476, 8486, 11364, 13306, 13366, 504, 12875, 4545, 5144, 5240, 1115, 4546, 9268, 4718, 6809, 4404, 11, 4681, 5603, 8140, 4672, 4674, 1612, 16844, 2]

// Module 16843 (JoinRequestActionSheetContent)
...
import openJoinRequestActionSheetDefault from "openJoinRequestActionSheet" /* 16841 */;
...
function OpenInterviewButton(arg0) {
  ...
  const joinRequestButtonActions = interviewChannelId(12875).useJoinRequestButtonActions(joinRequest, interviewChannelId);
  ({ handleOpenInterview, submitting } = joinRequestButtonActions);
  const obj2 = interviewChannelId(12875);
  if (!obj3.isActionedApplicationStatus(joinRequest.applicationStatus)) {
    ...
    obj4.icon = closure_8(tmp(5240).ChatIcon, obj5);
    if (label == null) {
    ...
    let tmp6Result = closure_8(tmp(5144).Button, obj4);
  } else {
    tmp6Result = null;
  }
  return tmp6Result;
...
const paddingTop = fn(7404).PROFILE_CONTENT_WITHOUT_STATUS_TOP_PADDING;
const jsxProd = fn(21);
...
let closure_12 = noop.memo((user) => {
  ...
  const tmp3 = joinRequest(8471)();
  const tmp4 = joinRequest(8460)(ACTION_SHEET_MAX_WIDTH);
  ({ primaryColor, secondaryColor, theme } = joinRequest(8457)({ user, displayProfile }));
  const tmp5 = joinRequest(8457)({ user, displayProfile });
  const tmp6 = user;
  const userProfileColors = user(8468).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null != user) {
    ...
    const items1 = [closure_8(tmp(8476), obj3), ];
    ...
    obj5.onPress = tmp8;
    const items2 = [closure_8(tmp(8486), obj5), ];
    ...
    const items4 = [closure_8(tmp6(13306).PrimaryInfo, obj10), ];
    const obj11 = { user };
    items4[1] = closure_8(tmp(13366), obj11);
    obj9.children = items4;
    obj7.children = closure_9(View, obj9);
    items2[1] = closure_8(tmp(11364), obj7);
    obj4.children = items2;
    items1[1] = closure_9(View, obj4);
    obj2.children = items1;
    tmp9 = closure_9(closure_10, obj2);
    const tmpResult = tmp(11364);
  }
  return tmp9;
});
let closure_14 = noop.memo((joinRequest) => {
  ...
  if (applicationStatus === MemberVerificationTypes.GuildJoinRequestApplicationStatuses.SUBMITTED) {
    if (null != joinRequest.interviewChannelId) {
      ...
      const items = [React6(tmp2(9268).HourglassIcon, obj4), ];
      ...
      obj5.children = React6(tmp2(4718).Text, obj6);
  ...
  if (MemberVerificationTypes.GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
    ...
    const items2 = [React6(tmp2(6809).CircleXIcon, obj10), ];
    ...
    const items3 = [React6(tmp2(4718).Text, obj11), , ];
    ...
    if (null != actionedByUser) {
      ...
      if (null != actionedAt) {
        ...
        const items4 = [tmp20(tmp2(4718).Text, obj13), , ];
        ...
        items4[2] = tmp20(tmp2(4718).Text, obj16);
    ...
    if (tmp20Result) {
      ...
      tmp20Result = tmp20(tmp2(4718).Text, obj17);
    }
  ...
  } else if (tmp2(4546).GuildJoinRequestApplicationStatuses.APPROVED === applicationStatus) {
    ...
    const items6 = [React6(tmp2(4681).CircleCheckIcon, obj22), ];
    ...
    const items7 = [React6(tmp2(4718).Text, obj23), ];
    let tmp6Result = null;
    if (null != actionedByUser) {
      tmp6Result = null;
      if (null != actionedAt) {
        ...
        const items8 = [tmp8(tmp2(4718).Text, obj25), , ];
        ...
        items8[2] = tmp8(tmp2(4718).Text, obj28);
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const joinRequestButtonActions = joinRequest(12875).useJoinRequestButtonActions(joinRequest, joinRequest.interviewChannelId, callback);
  ...
  const obj = joinRequest(12875);
  const tmp5 = closure_9;
  obj2.icon = closure_8(joinRequest(4672).CheckmarkLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" });
  ...
  const children = [closure_8(joinRequest(8140).IconButton, obj2), , ];
  ...
  obj4.icon = closure_8(joinRequest(4674).XLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" });
  const intl2 = joinRequest(1115).intl;
  obj4.label = intl2.string(joinRequest(1115).t.hDtbsz);
  obj4.onPress = rejectRequest;
  obj4.disabled = submitting;
  children[1] = closure_8(joinRequest(8140).IconButton, obj4);
  ...
  if (tmp6Result) {
    ...
    obj6.icon = tmp6(tmp2(5240).ChatIcon, obj7);
    const intl3 = tmp2(1115).intl;
    obj6.label = intl3.string(tmp2(1115).t.KQeYoC);
    obj6.onPress = handleOpenInterview;
    obj6.disabled = submitting;
    tmp6Result = tmp6(tmp2(8140).IconButton, obj6);
  }
  children[2] = tmp6Result;
  return tmp5(joinRequest(5603).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
let closure_16 = noop.memo((arg0) => {
  ...
  if (MemberVerificationTypes.VerificationFormFieldTypes.TERMS === field_type) {
    ...
    const items1 = [React6(tmp2(4718).Text, obj3), ];
    ...
    items1[1] = React6(tmp2(4681).CircleCheckIcon, obj4);
    obj2.children = items1;
    return React7(View, obj2);
  } else if (tmp2(4546).VerificationFormFieldTypes.MULTIPLE_CHOICE === field_type) {
    const obj5 = { style: tmp.formQuestion, variant: "text-sm/semibold", color: "text-subtle", children: field.label };
    const items2 = [React6(tmp2(4718).Text, obj5), ];
    ...
    obj6.children = React6(tmp2(4718).Text, obj8);
    ...
    const items4 = [React6(tmp2(4718).Text, obj9), ];
    ...
    obj10.children = React6(tmp2(4718).Text, obj11);
...
export default noop.memo(function JoinRequestActionSheetContent(displayProfile) {
  ...
  if (joinRequest.applicationStatus === joinRequest(4546).GuildJoinRequestApplicationStatuses.SUBMITTED) {
  ...
  items1[4] = closure_8(memo(16844), { guildId: joinRequest.guildId, userId: joinRequest.userId, selectedJoinRequestId: joinRequest.joinRequestId });
  obj.children = items1;
