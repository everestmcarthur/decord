...
// Dependencies: [5, 32, 19, 7855, 12695, 1074, 12696, 11224, 4656, 10602, 8455, 1241, 12698, 2019, 8906, 2]
// Exports: useMessageRequestActions

// Module 12694 (useMessageRequestActions)
...
require = fn;
const MessageRequestConstants = fn(12695);
