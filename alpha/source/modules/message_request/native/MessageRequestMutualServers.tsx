...
// Dependencies: [19, 17, 21, 4756, 5796, 17338, 1115, 12869, 4752, 5334, 2]
// Exports: default

// Module 17337 (MessageRequestMutualServers)
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (iconSize === undefined) {
    iconSize = iconSize(5796).GuildIconSizes.XXSMALL_12;
  }
  ...
  const mutualGuildsForMessageRequests = iconSize(17338).useMutualGuildsForMessageRequests(userId);
  ...
  if (tmp9) {
    ...
    tmp9 = closure_4(tmp4(12869).GuildIconPile, obj4);
  }
  const items1 = [tmp9, ];
  ...
  items1[1] = closure_4(iconSize(4752).Text, obj5);
  ...
  if (null != onPress) {
    ...
    if (length > 0) {
      ...
      tmp11Result = tmp11(tmp4(5334).PressableOpacity, obj6);
    }
  }
  return tmp11Result;
};
