...
// Dependencies: [19, 17, 4976, 21, 4756, 17357, 576, 5292, 4752, 1115, 4710, 4438, 7402, 504, 8447, 8189, 17358, 8929, 5334, 17359, 2]
// Exports: default

// Module 17356 (RestrictedMessagePreviewList)
...
import RestrictedBlockedMessageGroupDefault from "RestrictedBlockedMessageGroup" /* 17359 */;
...
let obj2 = { container: { flexDirection: "column" }, hiddenMedia: { marginLeft: fn(17357).RESTRICTED_CONTENT_INSET }, messageRow: { position: "relative" }, avatarHitbox: null, dateDivider: null, dividerLine: null, mediaPlaceholderCard: null, mediaHiddenRow: null };
let size = { position: "absolute", top: 0, left: 0, width: fn(17357).RESTRICTED_CONTENT_INSET, height: fn(17357).RESTRICTED_AVATAR_SIZE };
obj2.avatarHitbox = size;
let obj3 = { marginLeft: fn(17357).RESTRICTED_CONTENT_INSET };
