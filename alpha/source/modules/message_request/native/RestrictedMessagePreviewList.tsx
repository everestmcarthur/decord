...
// Dependencies: [19, 17, 4943, 21, 4722, 17280, 576, 5250, 4718, 1115, 4676, 4404, 7358, 504, 8409, 8151, 17281, 8890, 5292, 17282, 2]
// Exports: default

// Module 17279 (RestrictedMessagePreviewList)
...
import RestrictedBlockedMessageGroupDefault from "RestrictedBlockedMessageGroup" /* 17282 */;
...
let obj2 = { container: { flexDirection: "column" }, hiddenMedia: { marginLeft: fn(17280).RESTRICTED_CONTENT_INSET }, messageRow: { position: "relative" }, avatarHitbox: null, dateDivider: null, dividerLine: null, mediaPlaceholderCard: null, mediaHiddenRow: null };
let size = { position: "absolute", top: 0, left: 0, width: fn(17280).RESTRICTED_CONTENT_INSET, height: fn(17280).RESTRICTED_AVATAR_SIZE };
obj2.avatarHitbox = size;
let obj3 = { marginLeft: fn(17280).RESTRICTED_CONTENT_INSET };
