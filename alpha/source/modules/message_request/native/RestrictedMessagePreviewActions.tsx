...
// Dependencies: [19, 17, 4371, 1074, 11634, 21, 4722, 576, 12834, 504, 9280, 11118, 12862, 4566, 4689, 11635, 1897, 8867, 4735, 5144, 1115, 4718, 2]
// Exports: default

// Module 17278 (RestrictedMessagePreviewActions)
...
let closure_8 = fn(11634).BLOCK_CONFIRMATION_ACTION_SHEET_KEY;
const jsxProd = fn(21);
...
export default function RestrictedMessagePreviewActions(channel) {
  ...
  const callback4 = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11635, dependencyMap.paths), closure_8, { userId: user.id, channelId: channel.id });
  }, items6);
