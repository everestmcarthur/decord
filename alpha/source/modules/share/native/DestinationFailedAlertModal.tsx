...
function FailedUserRow(user) {
  ...
  if (null != user) {
    ...
    items2[1] = closure_10(tmp2(4752).Text, obj5);
...
export default function DestinationFailedAlertModal(arg0) {
  ...
  if (null != onRetry) {
    ...
    const items = [tmp2(tmp3(5114).AlertActionButton, obj4, "confirm"), ];
    const obj5 = { variant: "secondary", text: null };
    const intl3 = tmp3(1115).intl;
    obj5.text = intl3.string(tmp3(1115).t.WAI6xu);
    items[1] = tmp2(tmp3(5114).AlertActionButton, obj5, "cancel");
    obj3.children = items;
    ...
    tmp2Result = tmp2(tmp3(5114).AlertActionButton, obj6, "confirm");
  }
