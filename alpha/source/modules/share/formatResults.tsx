...
// Function ID: 11234
// Name: formatResults
// Dependencies: [5, 10079, 1958, 4361, 1372, 11234, 1074, 10080, 4735, 10089, 1115, 1370, 12, 2]
...
export const formatResultsWithHeaders = function formatResultsWithHeaders(hasNonEmptyQuery) {
  ...
  if (hasNonEmptyQuery.hasNonEmptyQuery) {
    ...
    if (null != queryMode) {
      ...
      items4 = [tmp(10080).createHeaderResult(intl2.string(tmp(1115).t["80lOZ1"])), , ];
      let tmp13 = null;
      if (null != selectedChannelId) {
        ...
        if (null != tmp7) {
          ...
          if (isAllowedType(tmp7)) {
            let canResult = tmp7.type === tmp(10080).AutocompleterResultTypes.USER;
            if (!canResult) {
