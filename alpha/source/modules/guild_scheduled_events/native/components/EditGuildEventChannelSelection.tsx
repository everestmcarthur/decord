...
// Dependencies: [19, 17, 4395, 4405, 1372, 7766, 1074, 21, 4756, 576, 6858, 9810, 9796, 4909, 504, 5239, 9798, 9799, 1115, 4752, 5334, 1875, 9813, 9782, 4723, 9539, 1980, 1177, 9795, 2]
// Exports: default
...
export default function EditGuildEventChannelSelection(guild) {
  ...
  obj6.style = items3;
  const items4 = [closure_11(guild(4752).Heading, { style: tmp.channelTypeText, variant: "text-sm/semibold", color: "text-subtle", children: stringResult }), ];
  ...
  obj8.onPress = function onPress() {
    ...
    obj3.openLazy(asyncRequireImpl(9539, tmp.paths), "SelectUpdatesChannel", obj4);
  };
  ...
  const items6 = [tmp12Result, closure_11(guild(4752).Text, { style: tmp.channelNameText, variant: "text-md/medium", color: "interactive-text-active", children: tmp7 }), ];
