...
// Dependencies: [32, 19, 17, 2045, 9814, 9783, 1074, 21, 4756, 576, 5334, 1177, 7232, 9815, 4752, 1115, 5186, 4959, 9816, 1980, 4723, 2]
// Exports: default

// Module 9813 (StageChannelUpsell)
...
let closure_7 = fn(9814).useStageChannelUpsellCardStore;
let closure_8 = fn(9783).CREATE_GUILD_EVENT_MODAL_KEY;
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4752).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9816, dependencyMap.paths), {
        guildId,
