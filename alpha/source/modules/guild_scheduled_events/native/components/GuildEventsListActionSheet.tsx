...
// Dependencies: [19, 17, 4771, 2047, 1074, 4938, 21, 4756, 9760, 7389, 1115, 9802, 9782, 9749, 9878, 9886, 5203, 1241, 7350, 7390, 10061, 5798, 2]
// Exports: default

// Module 9885 (GuildEventsListActionSheet)
...
function GuildEventsListHeader(arg0) {
  ...
  if (tmp3Result) {
    ...
    tmp3Result = tmp3(tmp4(9802).ActionSheetHeaderPressableText, obj3);
  }
...
export default function GuildEventsListActionSheet(guild) {
  ...
  obj3.children = jsx(events(10061), { inActionSheet: true, events, onPressEvent: callback1, onCloseAction: callback, guild, lastAckedId: null });
  obj.children = <View style={tmp.container}>{null}</View>;
  return jsx(guild(7390).BottomSheet, { showGradient: true, scrollable: events.length > 0, startExpanded: true, dismissAccessibilityLabel: null, header: null, children: null });
};
