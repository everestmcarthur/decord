...
// Dependencies: [19, 17, 2038, 21, 4756, 576, 1612, 7390, 6864, 4752, 1115, 1177, 5186, 2]
// Exports: default

// Module 10522 (MediaPostMultipleThumbnailActionSheet)
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4752).Text, obj6), closure_5(markAsDismissed(1177).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4752).Text, obj7);
  ...
  items2[3] = closure_5(markAsDismissed(4752).Text, obj8);
