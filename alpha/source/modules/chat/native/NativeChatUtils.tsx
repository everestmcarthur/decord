...
// Dependencies: [17, 1364, 11536, 1231, 11537, 11538, 2]

// Module 11535 (NativeChatUtils)
import SentryUtilsDefault from "SentryUtils" /* 1231 */;
import PlatformUtils from "PlatformUtils" /* 1364 */;
import ChatNativeComponent from "ChatNativeComponent" /* 11536 */;
import NativeChatModuleDefault from "NativeChatModule" /* 11538 */;
...
export default {
  scrollTo(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp5(11536).Commands;
  ...
  scrollToBottom(arg0, arg1) {
    if (null != arg0) {
      if (obj.isIOS()) {
        ...
        const Commands = tmp2(11536).Commands;
  ...
  scrollIntoView(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp4(11536).Commands;
  ...
  updateRows(arg0, rows) {
    if (null != arg0) {
      if (obj6.isIOS()) {
        const andIncrementChangesetIdForChat = tmp31(11537).getAndIncrementChangesetIdForChat(arg0);
        ({ rows, forceReload } = rows);
        if (forceReload == null) {
          forceReload = false;
        }
        const tmp31Result = tmp31(11537);
        ...
        const Commands = tmp31(11536).Commands;
        const _JSON2 = JSON;
        ...
        if (null != tmp2) {
          ...
          const andIncrementChangesetIdForChat1 = tmp31(11537).getAndIncrementChangesetIdForChat(arg0);
          ...
          const tmp31Result2 = tmp31(11537);
        }
      }
      obj6 = PlatformUtils;
    }
  ...
  clearRows(arg0) {
    if (null != arg0) {
      if (obj4.isIOS()) {
        const Commands = tmp6(11536).Commands;
        Commands.clearRows(arg0, tmp6(11537).getAndIncrementChangesetIdForChat(arg0));
        const tmp6Result = tmp6(11537);
      } else {
        const tmp2 = React4(arg0);
        if (null != tmp2) {
          const obj = NativeChatModuleDefault;
          obj.clearRows(tmp2, tmp6(11537).getAndIncrementChangesetIdForChat(arg0));
          const tmp6Result2 = tmp6(11537);
        }
      }
      obj4 = PlatformUtils;
    }
