...
// Dependencies: [7782, 11552, 7942, 7933, 3991, 1115, 11553, 11554, 11555, 11556, 11557, 5659, 2]
  ...
  if (null != tmp5) {
    if ("expiresAt" in tmp5) {
      if (null != tmp5.expiresAt) {
        ...
        const differenceInDaysResult = tmp3(3991).differenceInDays(date1, date);
        const _Math3 = Math;
        let num = 0;
        ...
        if (sum >= 12) {
          ...
          const differenceInDaysResult1 = tmp3(3991).differenceInDays(date1, date);
          ...
          const tmp3Result2 = tmp3(3991);
        }
        const tmp3Result = tmp3(3991);
      }
    }
  }
  return null;
...
export const isCollectibleQuestRewardPermanentWithPremiumSubscription = function isCollectibleQuestRewardPermanentWithPremiumSubscription(config) {
  ...
  if (hasItem) {
    ...
    let tmp11 = null;
    if (type1 === tmp3(7942).QuestRewardTypes.COLLECTIBLE) {
      tmp11 = found1;
    }
    let expirationMode1;
    if (tmp11 != null) {
    ...
    hasItem = expirationMode1 === tmp3(11552).QuestRewardExpirationMode.PREMIUM_PERMANENT;
  }
  return hasItem;
};
...
export const getPlatformString = function getPlatformString(arg0) {
  ...
  } else if (tmp(5659).QuestRewardCodePlatforms.PLAYSTATION === arg0) {
    const intl4 = tmp(1115).intl;
    return intl4.string(tmp(1115).t["6IeKx2"]);
  } else if (tmp(5659).QuestRewardCodePlatforms.SWITCH === arg0) {
    const intl3 = tmp(1115).intl;
    return intl3.string(tmp(1115).t["1pp0su"]);
  } else if (tmp(5659).QuestRewardCodePlatforms.PC === arg0) {
    const intl2 = tmp(1115).intl;
    return intl2.string(tmp(1115).t["YK+wUg"]);
  } else if (tmp(5659).QuestRewardCodePlatforms.CROSS_PLATFORM === arg0) {
