...
// Dependencies: [5, 32, 2040, 9312, 1999, 4778, 2015, 4780, 7937, 17484, 5656, 9313, 1091, 7943, 7933, 9623, 5657, 11540, 5659, 7962, 4887, 4886, 7358, 5664, 7958, 4808, 1370, 4885, 7956, 573, 2]

// Module 18336 (QuestProgressManager)
...
import QuestVariants from "QuestVariants" /* 5657 */;
  ...
  for (const item10020 of eligibleQuestsForApplicationId) {
    if (tmp) {
      ...
      if (features.includes(QuestVariants.QuestVariants.MOBILE_ACTIVITY_QUEST)) {
        let tmp6Result = tmp6(11540);
        let obj3 = { questContent: tmp6(5659).QuestContent.RUNNING_ACTIVITY, questContentCTA: tmp6(7962).QuestContentCTA.START_QUEST, sourceQuestContent: tmp6(5659).QuestContent.RUNNING_ACTIVITY };
      ...
      if (null != value) {
        if (null != value.config) {
          if (null != value.userStatus) {
            const questTaskDetails = applyArgumentsResult(7958).getQuestTaskDetails(value, applyArgumentsResult(5664).FirstPartyQuestTaskTypesSets.DESKTOP);
            const _Math = Math;
...
prototype["getActivelyProgressingQuests"] = function getActivelyProgressingQuests(arg0) {
  ...
  } else if (tmp(5664).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP === arg0) {
    return self.getActivelyProgressingStreamOnDesktopQuests();
  } else if (tmp(5664).FirstPartyQuestTaskTypes.PLAY_ACTIVITY === arg0) {
