...
// Dependencies: [19, 17, 7939, 21, 4756, 576, 15387, 11736, 7958, 4379, 11765, 4752, 1115, 15409, 2]
// Exports: default

// Module 15414 (VideoQuestModalHeader)
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11765).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
  ...
  const items1 = [closure_5(quest(4752).Text, obj5), ];
  ...
  items1[1] = closure_5(quest(4752).Text, obj7);
  obj4.children = items1;
  const items2 = [closure_6(View, obj4), closure_5(questTaskDetails(15409), { iconColor: closeButtonIconColor, onClose })];
