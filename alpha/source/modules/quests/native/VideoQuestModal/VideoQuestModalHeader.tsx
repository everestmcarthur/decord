...
// Dependencies: [19, 17, 7901, 21, 4722, 576, 15332, 11729, 7920, 4345, 11758, 4718, 1115, 15354, 2]
// Exports: default

// Module 15359 (VideoQuestModalHeader)
...
const useVideoQuestUIStore = fn(7901).useVideoQuestUIStore;
const jsxProd = fn(21);
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  quest = quest(15332).useVideoQuestModalContext().quest;
  let obj = quest(15332);
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11758).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(11758);
  }
  ...
  const items1 = [closure_5(quest(4718).Text, obj5), ];
  ...
  items1[1] = closure_5(quest(4718).Text, obj7);
  obj4.children = items1;
  const items2 = [closure_6(View, obj4), closure_5(questTaskDetails(15354), { iconColor: closeButtonIconColor, onClose })];
