...
export default noop.memo(function QuestDockBountyHeader() {
  ...
  const tmpResult = activeQuestDockMode(4492);
  ...
  obj8.children = closure_7(activeQuestDockMode(4752).Text, { variant: "text-md/medium", color: "text-strong", lineClamp: 1, accessible: false, children: str });
