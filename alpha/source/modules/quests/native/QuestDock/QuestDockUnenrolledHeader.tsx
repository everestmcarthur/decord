...
// Dependencies: [19, 17, 1085, 21, 4722, 15308, 15298, 15319, 5617, 7924, 4656, 4573, 15297, 15398, 4718, 1115, 5757, 15402, 15403, 15356, 2]
...
export default noop.memo(function QuestDockUnenrolledHeader() {
  ...
  if (LIGHT === tmp10.DARK) {
    let tmp7Result4 = tmp7(15402);
  } else {
    tmp7Result4 = tmp7(15403);
  }
