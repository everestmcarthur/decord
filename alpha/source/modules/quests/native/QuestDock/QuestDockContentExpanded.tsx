...
// Dependencies: [19, 17, 5614, 15301, 21, 4722, 15302, 11605, 4458, 15300, 5143, 7269, 2]

// Module 15393 (QuestDockContentExpanded)
...
let QUEST_DOCK_MODE_CHANGE_PHYSICS = fn(15301).QUEST_DOCK_MODE_CHANGE_PHYSICS;
const jsx = fn(21).jsx;
