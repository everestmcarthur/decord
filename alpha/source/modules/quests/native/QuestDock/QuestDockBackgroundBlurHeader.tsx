...
// Dependencies: [32, 19, 17, 5614, 15301, 21, 4722, 576, 5143, 15302, 1365, 4423, 15390, 4458, 7269, 15399, 15367, 5292, 4718, 1115, 11359, 15401, 8142, 2]

// Module 15398 (QuestDockBackgroundBlurHeader)
...
questDockHeaderLayoutAnimation.__closure = { withSpring: fn(5143).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
...
let obj5 = { withSpring: fn(5143).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
let size = fn(2);
...
export default noop.memo(function QuestDockBackgroundBlurHeader(hideBlurWhenCollapsed) {
  ...
  const context = noop.useContext(activeQuestDockMode(15302).QuestDockGestureContext);
  ...
  token = activeQuestDockMode(4423).useToken(questDockWrapperSpecs(576).modules.mobile.QUEST_DOCK_BORDER_RADIUS);
  const tmp9 = questDockWrapperSpecs(15390)(token);
  noop = tmp9;
  let obj = activeQuestDockMode(4423);
  class Y {
    constructor() {
  ...
  let obj2 = activeQuestDockMode(4458);
  Y.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5143).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  Y.__workletHash = 17202411570804;
  Y.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(Y);
  let obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5143).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  const fn = function x() {
    let num = 1;
  ...
  let obj4 = activeQuestDockMode(4458);
  fn.__closure = { withSpring: activeQuestDockMode(5143).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn.__workletHash = 5804990093011;
  fn.__initData = __initData2;
  const animatedStyle1 = obj4.useAnimatedStyle(fn);
  let obj5 = { withSpring: activeQuestDockMode(5143).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  const animatedStyle2 = activeQuestDockMode(4458).useAnimatedStyle(fn2);
  let obj6 = activeQuestDockMode(4458);
  ...
  const obj8 = activeQuestDockMode(4458);
  W.__closure = { withSpring: activeQuestDockMode(5143).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  W.__workletHash = 6229744150165;
  W.__initData = __initData4;
  const animatedStyle3 = obj8.useAnimatedStyle(W);
  const obj9 = { withSpring: activeQuestDockMode(5143).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  class V {
    constructor() {
      right = 0;
      if (activeQuestDockMode.get() !== QuestDockMode.EXPANDED) {
  ...
  const animatedStyle4 = activeQuestDockMode(4458).useAnimatedStyle(V);
  const obj10 = activeQuestDockMode(4458);
  class Z {
    constructor() {
      pointerEvents = "none";
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  const animatedProps = activeQuestDockMode(4458).useAnimatedProps(Z);
  const obj11 = activeQuestDockMode(4458);
  class F {
    constructor() {
      obj = activeQuestDockMode;
      tmp = QuestDockMode;
  ...
  const obj12 = activeQuestDockMode(4458);
  F.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5143).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  F.__workletHash = 8904986205240;
  F.__initData = __initData7;
  const animatedStyle5 = obj12.useAnimatedStyle(F);
  const obj13 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5143).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  ...
  const obj14 = activeQuestDockMode(4458);
  fn3.__closure = { withSpring: activeQuestDockMode(5143).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  obj16.style = items;
  const obj15 = { withSpring: activeQuestDockMode(5143).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  const tmp7Result = questDockWrapperSpecs(7269);
  if (tmpResult.isAndroid()) {
    if (null != blurHash) {
      ...
      let tmp24 = closure_12(tmp7(15399), obj17);
    ...
    if (withPressableDisclosure) {
      ...
      obj27.children = tmp23(tmp(4718).Text, obj28);
      tmp23Result = tmp23(tmp26, obj27);
    }
    const items8 = [tmp23Result, tmp23(tmp7(15401), {}), ];
    ...
    obj29.children = tmp23(tmp(8142).MoreHorizontalIcon, obj30);
    items8[2] = tmp23(tmp(5292).PressableOpacity, obj29);
    obj22.children = items8;
    obj21.children = tmp19(tmp7(7269), obj22);
  ...
  tmp23 = closure_12;
  tmp24 = closure_12(tmp7(15367), { layoutAnimatedStyle: animatedStyle5, opacityAnimatedStyle: animatedStyle6, layoutAnimation: tmp21 });
});
