...
// Dependencies: [19, 17, 5614, 15301, 21, 4722, 15302, 15303, 4458, 5143, 7269, 15300, 7350, 1115, 2]

// Module 15394 (QuestDockDragHandle)
...
export default noop.memo(function QuestDockDragHandle(arg0) {
  ...
  const tmp = closure_9();
  const context = youBarHorizontalMargin.useContext(activeQuestDockMode(15302).QuestDockGestureContext);
  activeQuestDockMode = context.activeQuestDockMode;
  const windowDimensions = context.windowDimensions;
  dependencyMap = tmp5;
  youBarHorizontalMargin = activeQuestDockMode(15303).useYouBarHorizontalMargin();
  const obj = activeQuestDockMode(15303);
  ...
  const animatedStyle = activeQuestDockMode(4458).useAnimatedStyle(fn);
  ...
  const animatedStyle1 = activeQuestDockMode(4458).useAnimatedStyle(fn2);
  const obj4 = activeQuestDockMode(4458);
  ...
  const obj6 = activeQuestDockMode(4458);
  M.__closure = { withSpring: activeQuestDockMode(5143).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  M.__workletHash = 7055026667171;
  M.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(M);
  const obj7 = { withSpring: activeQuestDockMode(5143).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  class C {
    constructor() {
      tmp = closure_0(closure_2[9]);
      if (!closure_2) {
  ...
  C.__closure = { withSpring: activeQuestDockMode(5143).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  ...
  obj10.style = items;
  const obj9 = { withSpring: activeQuestDockMode(5143).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  const tmp12 = windowDimensions;
  const obj11 = { style: animatedStyle1, layout: null, children: null };
  const tmp13 = windowDimensions(7269);
  const tmp14 = closure_8;
  obj11.layout = activeQuestDockMode(15300).dimensionsLayoutTransition;
  const obj12 = { style: null, children: null };
  const items1 = [tmp.dragHandleOverlay, animatedStyle3];
  obj12.style = items1;
  const tmp15 = windowDimensions(7269);
  ...
  obj12.children = closure_7(activeQuestDockMode(7350).ActionSheetHeaderBar, { variant: "overlay", accessibilityLabel: stringResult });
  const items2 = [closure_7(windowDimensions(7269), obj12), ];
  ...
  obj13.style = items3;
  const tmp16 = windowDimensions(7269);
  obj13.children = closure_7(tmp2(7350).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = closure_7(tmp12(7269), obj13);
