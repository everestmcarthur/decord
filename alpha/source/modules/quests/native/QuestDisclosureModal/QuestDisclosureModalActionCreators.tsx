...
// Dependencies: [5663, 7958, 15363, 7963, 7964, 7974, 7952, 4959, 15375, 1980, 2]

// Module 15374 (QuestDisclosureModalActionCreators)
...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      const result = tmp(7952).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(7952).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5663).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(7958).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(7958);
    } else if (tmp(5663).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5663).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
    const merged1 = Object.assign(tmp11);
    obj12.isTargetedDisclosure = isTargetedDisclosure.isTargetedDisclosure;
    obj9.pushLazy(asyncRequireImpl(15375, tmp2.paths), obj12, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
