...
// Dependencies: [19, 17, 15316, 21, 4756, 576, 11739, 15312, 11546, 11749, 5663, 5661, 7962, 5799, 4752, 2]
// Exports: default

// Module 15315 (BountiesEndCardPressableCta)
...
const END_CARD_IMAGE_SIZE = fn(15316).END_CARD_IMAGE_SIZE;
const jsxProd = fn(21);
