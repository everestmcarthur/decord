...
// Dependencies: [19, 17, 21, 5149, 4458, 8689, 4722, 576, 1364, 4723, 4718, 9677, 2]
// Exports: default

// Module 15258 (BountiesModalTimer)
...
let size = { alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT, borderRadius: nativeDefault.radii.round, width: fn(5149).SMALL_BUTTON_HEIGHT, height: fn(5149).SMALL_BUTTON_HEIGHT };
obj.progress = size;
