...
// Dependencies: [5, 7934, 4805, 7936, 7937, 1074, 3, 573, 5663, 11545, 7935, 4657, 7701, 7955, 1271, 5659, 7933, 2]
...
// Module 11774 (BountyActionCreators)
        ...
        if (arg0 === 1) {
          ...
          const obj4 = {
            value: fetchBountiesAndDispatch(tmp5, asyncGeneratorStep(async () => {
                      closure_128_0 = await tmp2(7701).getSession();
        ...
        if (arg0 === 1) {
          ...
          if (obj16.isDismissible(closure_1)) {
            if (!dismissingContent.isDismissingContent(adCreativeId)) {
              ...
              DispatcherDefault.dispatch(obj5);
              c5 = 1;
              const adMetadataSealed = tmp55(7933).getAdMetadataSealed(tmp54, adCreativeId);
              const tmp55Result = tmp55(7933);
              const adTrafficMetadataSealed = tmp55(7933).getAdTrafficMetadataSealed(tmp54, undefined, adCreativeId);
              const tmp55Result3 = tmp55(7933);
              const questPlacementFromQuestContent = tmp55(7933).getQuestPlacementFromQuestContent(tmp54);
