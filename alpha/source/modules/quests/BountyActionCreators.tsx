...
// Dependencies: [5, 7896, 4771, 7898, 7899, 1074, 3, 573, 5621, 11536, 7897, 4623, 7657, 7917, 1271, 5617, 7895, 2]
...
// Module 11765 (BountyActionCreators)
        ...
        if (arg0 === 1) {
          ...
          const obj4 = {
            value: fetchBountiesAndDispatch(tmp5, asyncGeneratorStep(async () => {
                      closure_128_0 = await tmp2(7657).getSession();
        ...
        if (arg0 === 1) {
          ...
          if (obj16.isDismissible(closure_1)) {
            if (!dismissingContent.isDismissingContent(adCreativeId)) {
              ...
              DispatcherDefault.dispatch(obj5);
              c5 = 1;
              const adMetadataSealed = tmp55(7895).getAdMetadataSealed(tmp54, adCreativeId);
              const tmp55Result = tmp55(7895);
              const adTrafficMetadataSealed = tmp55(7895).getAdTrafficMetadataSealed(tmp54, undefined, adCreativeId);
              const tmp55Result3 = tmp55(7895);
              const questPlacementFromQuestContent = tmp55(7895).getQuestPlacementFromQuestContent(tmp54);
