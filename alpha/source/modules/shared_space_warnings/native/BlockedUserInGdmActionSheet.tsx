...
// Dependencies: [19, 17, 1958, 1372, 13946, 1074, 21, 4722, 576, 4718, 4874, 1115, 504, 1370, 1177, 12068, 11160, 4681, 4676, 1241, 7393, 11626, 5857, 5775, 5144, 4689, 13947, 4735, 2]
// Exports: default

// Module 13945 (BlockedUserInGdmActionSheet)
...
import SharedSpacesWarningActionCreators from "SharedSpacesWarningActionCreators" /* 13947 */;
...
function UserCalloutAvatars(userIds) {
  ...
  if (1 === userIds.length) {
    if (null != UserStore.getUser(userIds[0])) {
      ...
      tmp6 = closure_11(tmp(12068).UserIcon, {});
    }
  } else {
    const obj4 = { users: found, size: tmp(1177).AvatarSizes.REFRESH_MEDIUM_32 };
    return closure_11(tmp(11160).FacepileGroupDMAvatar, obj4);
  }
}
...
const SharedSpaceWarningConstants = fn(13946);
