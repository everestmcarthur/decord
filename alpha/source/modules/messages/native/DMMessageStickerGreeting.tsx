...
// Dependencies: [5, 32, 19, 17, 5672, 4943, 1372, 21, 4722, 576, 4540, 4423, 4571, 4420, 12506, 12507, 7652, 1115, 504, 1090, 4566, 12508, 10630, 4458, 4723, 1177, 10629, 5156, 5292, 10416, 4718, 5144, 2]
// Exports: default

// Module 12505 (DMMessageStickerGreeting)
...
const END = fn(4540).GradientPercentage.END;
        ...
        if (0 === c4) {
          if (arg0 === 1) {
            ...
            function showErrorToast(content) {
              ...
              obj.open({ key: "HANDLE_WAVE_PRESS_TOAST", content, icon: closure_1(12506) });
            }
