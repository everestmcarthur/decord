...
// Dependencies: [19, 17, 4714, 7475, 2016, 21, 4722, 576, 11, 7325, 504, 7323, 1177, 4718, 7346, 11828, 2]
// Exports: default

// Module 11827 (RoleMembersActionSheet)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import Text_Text from "Text/Text" /* 4718 */;
import GuildRoleMemberActionCreators from "GuildRoleMemberActionCreators" /* 7325 */;
...
export default function RoleMembersActionSheet(guildId) {
  ...
  const tmp11 = roleId(7323)(guildId);
  let tmp12 = null;
  if (roleId !== result) {
    let tmp13;
    if (tmp11 != null) {
  ...
  if (null != stateFromStores) {
    ...
    obj5.roleId = roleId;
    obj4.children = closure_8(tmp9(11828), obj5);
    tmp16Result = tmp16(tmp3(7346).BottomSheet, obj4);
    let tmp9Result = tmp9(11828);
  }
  return tmp16Result;
};
