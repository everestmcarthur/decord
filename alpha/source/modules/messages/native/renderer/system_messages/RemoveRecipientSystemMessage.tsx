...
// Dependencies: [2045, 2041, 1372, 8217, 8219, 1115, 8221, 2]
// Exports: createRemoveRecipientSystemMessage

// Module 8235 (RemoveRecipientSystemMessage)
...
export const createRemoveRecipientSystemMessage = function createRemoveRecipientSystemMessage(message) {
  ...
  if (message.author.id === first) {
    ...
    const merged = Object.assign(tmp8(8221)(message));
    return obj3;
  } else {
    const user = UserStore.getUser(first);
    const userAuthorWithProcessedColor = tmp5(8217).getUserAuthorWithProcessedColor(user, channel);
    const obj4 = {};
    ...
    obj4.otherUsernameOnClick = tmp8(8219)(obj5);
    ...
    const merged2 = Object.assign(tmp8(8221)(message));
    return obj6;
  }
};
