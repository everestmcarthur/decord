...
// Dependencies: [17, 11686, 7976, 8202, 12041, 13523, 1363, 1115, 8193, 576, 4607, 12060, 12061, 13521, 2]
// Exports: createBuildOverrideEmbed

// Module 13522 (BuildOverrideEmbed)
...
import BuildOverrideStore2 from "BuildOverrideStore" /* 11686 */;
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 12041).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(tmp(13521)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
