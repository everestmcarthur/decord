...
// Dependencies: [17, 4748, 11569, 2059, 2041, 2105, 2063, 4395, 4405, 1372, 4775, 4780, 11570, 1074, 7976, 11571, 8202, 8203, 1397, 4600, 4574, 4909, 1115, 11572, 2]
// Exports: canShowVoiceChannelListInviteEmbed, createVoiceChannelListInviteEmbed

// Module 11568 (VoiceChannelListInviteEmbed)
...
export const createVoiceChannelListInviteEmbed = function createVoiceChannelListInviteEmbed(invite, theme) {
  ...
  if (null == tmp) {
    ...
    const embedScrollGradientBackground = guild(4574).getEmbedScrollGradientBackground();
    ...
    obj5.headerText = "";
    let obj4 = guild(4574);
    obj5.titleText = guild(4909).computeChannelName(channel2, UserStore, RelationshipStore);
