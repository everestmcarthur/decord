...
// Function ID: 13492
// Name: GiftCodeEmbed
// Dependencies: [17, 502, 11690, 1372, 5722, 1074, 1374, 13492, 13493, 13494, 13495, 13496, 13497, 13498, 13499, 13500, 13501, 13502, 11289, 4600, 8202, 4607, 4574, 1115, 12060, 12061, 576, 4348, 8193, 8203, 13503, 13504, 13505, 13506, 13507, 7466, 4414, 2]
// Exports: createGiftCodeEmbed

// Module 13491 (GiftCodeEmbed)
          ...
          if (obj.getIsResolved(giftCode)) {
            ...
            if (null == value) {
              ...
              if (obj25.isThemeDark(closure_1)) {
                let tmp119Result = tmp119(12060);
                let tmp121 = tmp119;
              } else {
                tmp119Result = tmp119(12061);
                tmp121 = tmp119;
              }
              ...
              if (tmp15) {
                ...
                if (TIER_0.TIER_0 === skuId) {
                  ...
                  if (tmp79Result2.isThemeDark(closure_1)) {
                    let tmp86Result = tmp86(13504);
                  } else {
                    tmp86Result = tmp86(13505);
                  }
                  ...
                  if (tmp50.TIER_1 === skuId) {
                    ...
                    if (tmp69Result2.isThemeDark(closure_1)) {
                      let tmp76Result = tmp76(13504);
                      let tmp78 = tmp76;
                    } else {
                      tmp76Result = tmp76(13505);
                      tmp78 = tmp76;
                    }
                    ...
                    if (tmp50.TIER_2 !== skuId) {
                      if (tmp50.LEGACY !== skuId) {
                        ...
                        if (obj29.isThemeDark(closure_1)) {
                          let tmp137Result = tmp137(13504);
                          tmp52 = tmp137;
                        } else {
                          tmp137Result = tmp137(13505);
                          tmp52 = tmp137;
                        }
                    ...
                    if (tmp58Result2.isThemeDark(closure_1)) {
                      let tmp65Result = tmp65(13504);
                      let tmp67 = tmp65;
                    } else {
                      tmp65Result = tmp65(13505);
                      tmp67 = tmp65;
                    }
                  ...
                  if (tmp55Result.isGameItemSKU(value2)) {
                    const str3 = tmp55(7466).getGameItemThumbnailUrl(value2);
                    let str1;
                    if (str3 != null) {
                      str1 = str3.toString();
                    }
