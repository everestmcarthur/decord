...
// Dependencies: [4950, 5450, 13474, 1386, 502, 1958, 13475, 9764, 4943, 4762, 5449, 1372, 11708, 1074, 8572, 7359, 13476, 1115, 12183, 13477, 11996, 12001, 8369, 13478, 11997, 13281, 12003, 12000, 13479, 9744, 9527, 11995, 8365, 12186, 13480, 13481, 12004, 12005, 13482, 13483, 13486, 2966, 2]
// Exports: createActivityRichPresenceInviteEmbed

// Module 13473 (ActivityRichPresenceInviteEmbed)
import isInviteActiveDefault from "isInviteActive" /* 11996 */;
import getRequestToStreamCTAAndIsDisabledDefault from "getRequestToStreamCTAAndIsDisabled" /* 13486 */;
...
import ActivityLauncherStore from "ActivityLauncherStore" /* 11708 */;

const require = globalThis.__r;

const require = fn;
const SpotifyApplication = fn(13474).SpotifyApplication;
  ...
  if (null != message.author) {
    if (null != message.activity) {
      if (null != channel) {
        ...
        if (intl(12183).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          _require = channel;
          const application2 = message.application;
          let id1;
          const applicationFromMessage = intl(13477).getApplicationFromMessage(message);
          ...
          if (tmp14) {
            const application3 = intl(7359).fetchApplication(id1, false);
            const intlResult1 = intl(7359);
          }
            ...
            if (null != application1) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != application1.icon) {
                  appIconSrc = intl(12186).getAppIconSrc(application1.id, application1.icon, application1.bot);
                  const intlResult2 = intl(12186);
                }
                let string2 = intl(12186).getAppGradientColors(appIconSrc);
                ...
                if (null != message.application) {
                  ...
                  const requestToStreamText = intl(13478).getRequestToStreamText(message, channel, obj5.getId());
                  ...
                  intl = intl(1115).intl;
                  string2 = intl.string;
                  string2Result = string2(tmp131(2966).nAyuPp);
                ...
                if (null != icon_override) {
                  assetImage = intl(8369).getAssetImage(application1.id, message.activity.icon_override);
                  const intlResult6 = intl(8369);
                }
                const intlResult5 = intl(12001);
                const tmp139 = !tmp138;
                ...
                const headerText = intl(13478).getHeaderText(name_override, type5, tmp139);
                if (null != findActivityResult) {
                  ...
                  let length = intl(11997).getPartySize(findActivityResult).maxPartySize;
                  const intlResult8 = intl(11997);
                  const currentActivityGamePlatform = intl(13281).getCurrentActivityGamePlatform();
                  const tmp40 = tmp137(12003)(LocalActivityStore, SelfPresenceStore, application1.id);
                  const intlResult9 = intl(13281);
                  const isInParty = intl(12000).getIsInParty(tmp40, findActivityResult);
                  const intlResult11 = intl(13479);
                  ...
                  const intlResult10 = intl(12000);
                  const intlResult12 = intl(9744);
                  const canLaunchFrameResult = intl(9744).canLaunchFrame(application1);
                  const intlResult13 = intl(9527);
                  const isEmbeddedAppResult = intl(9527).isEmbeddedApp(application1);
                  ...
                  const canJoin = intl(11995).getCanJoin(obj3);
                  ...
                  if (null != start) {
                    ...
                    const _Date = Date;
                    str2 = intl(8365).formatActiveTimestamp(obj4, Date.now());
                    const intlResult15 = intl(8365);
                  }
                  if (assetImage == null) {
                    let appIconSrc1 = null;
                    if (null != application1.icon) {
                      appIconSrc1 = intl(12186).getAppIconSrc(application1.id, application1.icon, application1.bot);
                      const intlResult16 = intl(12186);
                    }
                  ...
                  if (tmp57Result) {
                    if (null != findActivityResult) {
                      if (null != findActivityResult.details) {
                        ...
                        if (tmp138) {
                          const tmp95 = tmp137(13480)(findActivityResult, application1.id);
                    ...
                    let details;
                    const partyText = intl(13478).getPartyText(obj9);
                    if (findActivityResult != null) {
                    ...
                    const intlResult17 = intl(13478);
                    tmp84 = null != details && "" !== details;
                    const supportsRemoteJoin = intl(12004).getSupportsRemoteJoin(findActivityResult);
                    intl(12005);
                    if (canJoin.canJoin) {
                      let remoteJoinFooterLabel;
                      if (null != remoteJoinPlatform) {
                        remoteJoinFooterLabel = intl(13476).getRemoteJoinFooterLabel(remoteJoinPlatform);
                        const intlResult20 = intl(13476);
                      }
                      ...
                      const obj13 = { label: "PX_16", disabled: null, footerLabel: -131184.0703125107 };
                      ...
                      obj16 = { label: "PX_16", disabled: null, footerLabel: -131184.0703125107 };
                  ...
                  if (null != remoteJoinPlatform) {
                    const items = [];
                    const tmp114 = intl(13482).ACTIVITY_GAME_PLATFORM_TO_ICON_KEY[remoteJoinPlatform];
                    ...
                    joinFromSupportedPlatformsIconKeys = intl(13482).getJoinFromSupportedPlatformsIconKeys(obj17);
                    const intlResult23 = intl(13482);
                  }
                  const intlResult14 = intl(11995);
                  const tmp116 = tmp72;
                  channel = null;
                  const appGradientColors = intl(12186).getAppGradientColors(tmp116);
                  ...
                  if (true !== isGameInvitesChannelResult) {
                    ...
                    let presenceActivityInviteCoverImageURL = intl(13483).getPresenceActivityInviteCoverImageURL(obj18);
                    const intlResult25 = intl(13483);
                  } else {
                  ...
                  obj19.title = name;
                  tmp27 = obj19;
                  const intlResult24 = intl(12186);
                }
                arr = [];
                const intlResult7 = intl(13478);
              }
            }
            return tmp27;
          }
          const intlResult = intl(13477);
        } else {
          if (intl(12183).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (intl(12183).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility) {
              return null;
            }
          }
          const obj20 = { displayType: obj.BLOCKED, headerText: null, subtitle: null, ctaButtonEnabled: false, ctaButtonText: "PX_16", ctaButtonIsLoading: "Array", footerLabel: "flex", gradientColors: 0, iconSrc: null, isPlatformSupported: "Array", isSpotifyParty: "channelId", maxPartySize: "replace", partyMemberAvatarURIs: "isArray", partySizeText: "<string:16732958>", platformIconKeys: "<string:16711935>", coverImageUrl: "useRecyclerViewManager", detailsText: "<string:23199744>", title: "<string:301882193>" };
          const intl2 = intl(1115).intl;
          obj20.headerText = intl2.string(intl(1115).t.pkq6Vq);
          if (contentClassificationVisibility === intl(12183).ContentClassificationVisibility.BLOCK_UNDERAGE) {
