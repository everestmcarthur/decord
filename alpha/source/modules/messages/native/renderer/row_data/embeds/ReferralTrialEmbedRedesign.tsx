...
// Dependencies: [1958, 1372, 4386, 7646, 7433, 1074, 1374, 4722, 576, 7436, 8274, 1115, 4566, 2025, 4380, 7645, 8275, 1609, 8165, 8271, 2]
// Exports: createReferralTrialEmbedRedesign

// Module 8273 (ReferralTrialEmbedRedesign)
      ...
      if (channel.isDM()) {
        ...
        if (null != user) {
          if (null != user1) {
            ...
            obj6.headerImageUrl = tmp41(8274);
            ...
            if (null == relevantUserTrialOffer) {
              ...
              const values = Object.values(tmp39(7436).TrialIdToProductOfferId[closure_9]);
              id = undefined;
              ...
              const isPremiumResult = tmp41(4380).isPremium(user);
              ...
              const tmp41Result10 = tmp41(4380);
              const result = tmp39(7645).hasUserTrialOfferExpired(relevantUserTrialOffer);
              const tmp39Result = tmp39(7645);
              let tmp15 = null == relevantUserTrialOffer.expiresAt;
              const name1 = tmp41(4566).getName(user);
              if (!tmp15) {
                tmp15 = result;
              }
              if (!tmp15) {
              ...
              if (!tmp15) {
                ...
                const referralTrialOfferExpirationCopy = tmp39(8275).getReferralTrialOfferExpirationCopy(expiresAt.getTime());
                const intl = tmp39(1115).intl;
                const tmp39Result5 = tmp39(8275);
                ...
                obj9.duration = tmp39(4380).formatIntervalDuration(obj8);
                const tmp39Result6 = tmp39(4380);
              ...
              if (tmp10) {
                if (!tmp21) {
                  ...
                  if (tmp27) {
                    ...
                    obj13.acceptLabelIconUrl = tmp39(8165).getAssetUriForEmbed(tmp41(8271));
                    tmp31 = obj13;
                    const tmp39Result7 = tmp39(8165);
                  }
                  return tmp31;
                }
              }
              ...
              const tmp41Result11 = tmp41(4566);
            }
            const formatToPartsResult = intl11.formatToParts(tmp39(1115).t.yisueA, obj4);
          }
        }
        const obj19 = { titleText: "", titleColor, headerImageUrl: tmp41(8274), headerText: "", headerColor: headerTextColor, backgroundColor, borderColor: backgroundColor, bodyText: null, bodyTextColor: null, canBeAccepted: false };
