...
// Dependencies: [109, 17, 4981, 8379, 8131, 1370, 1978, 4980, 1115, 8380, 8387, 8388, 8390, 8393, 8394, 4968, 5346, 8395, 8397, 8208, 4906, 1385, 4986, 8376, 8375, 1366, 1438, 1091, 4746, 8411, 1365, 4409, 2]
                    ...
                    if (null != height) {
                      if (height > 0) {
                        if (obj.isImageContentType(contentType)) {
                          let VISUAL_PLACEHOLDER = tmp(8394).MediaGalleryItemType.IMAGE;
                        } else {
                          if (tmpResult.isVideoContentType(contentType)) {
                            VISUAL_PLACEHOLDER = tmp(8394).MediaGalleryItemType.VIDEO;
                          }
                          tmpResult = tmp(4906);
                        }
  ...
  if (null != width) {
    if (width > 0) {
      if (null != height) {
        if (height > 0) {
          if (obj.isImageContentType(contentType)) {
            return tmp(8394).MediaGalleryItemType.IMAGE;
          } else {
            if (tmpResult.isVideoContentType(contentType)) {
              return tmp(8394).MediaGalleryItemType.VIDEO;
            }
            tmpResult = tmp(4906);
          }
          obj = MediaFormatTesters;
