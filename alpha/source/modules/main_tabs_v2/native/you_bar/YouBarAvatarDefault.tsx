...
// Dependencies: [19, 17, 15359, 1074, 21, 4756, 576, 4457, 1177, 9093, 9036, 2]

// Module 16719 (YouBarAvatarDefault)
...
const ClipViewDefault = tmp4(9093);
require = fn;
function AvatarDefault() {
  ...
  const point = { shape: tmp2(9093).CutoutShape.Circle, x: diff, y: diff, size: 2 * sum };
