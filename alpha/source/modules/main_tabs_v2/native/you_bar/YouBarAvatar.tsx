...
// Function ID: 16721
// Name: YouBarAvatar
// Dependencies: [5, 32, 19, 17, 4748, 5491, 1372, 15359, 1074, 21, 4756, 576, 504, 1177, 4466, 4492, 8484, 9093, 5185, 4457, 9092, 8425, 4724, 7622, 1980, 6892, 2]

// Module 16720 (YouBarAvatar)
...
function YouBarAvatarLarge(transitionState) {
  ...
  if (null != stateFromStores) {
    ...
    const obj7 = { user: stateFromStores, guildId: "Array", size, animate: true, needsOffscreenAlphaCompositing: null, status: null, statusSizeOverride: null, cutout: null, statusStyle: "FRECENCY_SECTION_SET_SELECTION" };
    if (OFFLINE === StatusTypes.UNKNOWN) {
      OFFLINE = StatusTypes.OFFLINE;
    }
    obj7.status = OFFLINE;
