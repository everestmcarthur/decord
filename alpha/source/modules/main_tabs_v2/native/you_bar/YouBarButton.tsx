...
// Function ID: 16650
// Name: YouBarButton
// Dependencies: [19, 17, 15304, 21, 4722, 576, 9054, 8073, 8140, 2]

// Module 16649 (YouBarButton)
...
class YouBarButtonIcon {
  constructor(arg0) {
    ...
    items2[1] = hasBadge;
    memo1 = obj2.useMemo(() => {
      const rect = { position: "absolute", left: size2 - badgeSize + num3, top: size2 - badgeSize + num4, right: "call", bottom: "width", padding: "channel", minWidth: "accessible" };
      return rect;
    }, items1);
