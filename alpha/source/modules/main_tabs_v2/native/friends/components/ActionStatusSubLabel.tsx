...
// Dependencies: [19, 21, 4722, 4433, 4458, 4718, 5151, 4723, 2]
// Exports: ActionStatusSubLabel

// Module 16699 (ActionStatusSubLabel)
...
let closure_7 = ReanimatedRexport.createAnimatedComponent(fn(4718).Text);
