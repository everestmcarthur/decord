...
// Dependencies: [19, 17, 21, 16738, 576, 9093, 4756, 1115, 9183, 4752, 2]

// Module 17250 (YouScreenNavIcon)
...
const md = fn(16738).ICON_SIZE.md;
const result = (nativeDefault.space.PX_32 - md) / 2;
const TEXT_DEFAULT = nativeDefault.colors.TEXT_DEFAULT;
const point = { shape: fn(9093).CutoutShape.Circle, x: md - 8 - 4, y: -4, size: 16 };
let items = [point];
