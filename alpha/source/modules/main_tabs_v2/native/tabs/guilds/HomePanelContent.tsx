...
// Dependencies: [19, 17, 16349, 1074, 16615, 21, 4756, 16355, 16616, 4492, 11258, 5336, 16358, 8116, 4457, 576, 1365, 5180, 12149, 2]

// Module 16614 (HomePanelContent)
...
import GuildsBarDefault from "GuildsBar" /* 16616 */;
...
function ContentMaskGradient(offsetX) {
  ...
  const obj4 = { pointerEvents: "none", style: null, children: closure_9(guildsBarPullX(5336), { absolute: true, tall: true, wide: true, mix: true }) };
  let items = [absoluteFill.absoluteFill, animatedStyle];
  obj4.style = items;
  return closure_9(guildsBarPullX(4492).View, obj4);
}
function HomeDrawerPanelContent() {
  ...
  const obj7 = ref(4492);
  fn.__closure = { isGradientTheme: isClientThemeOrCustomThemeActive, maxX: tmp9, interpolateColor: ref(4492).interpolateColor, panelTranslateX, baseLowest: token, panelBg: token1 };
  ...
  const obj8 = { isGradientTheme: isClientThemeOrCustomThemeActive, maxX: tmp9, interpolateColor: ref(4492).interpolateColor, panelTranslateX, baseLowest: token, panelBg: token1 };
  ...
  const obj9 = ref(4492);
  fn2.__closure = { interpolate: ref(4492).interpolate, panelTranslateX, INITIAL_OPEN_WIDTH: ref(16355).INITIAL_OPEN_WIDTH, Extrapolation: ref(4492).Extrapolation, isGradientTheme: isClientThemeOrCustomThemeActive, interpolateColor: ref(4492).interpolateColor, maxX: tmp9, baseLowest: token, panelBg: token1 };
  ...
  if (doesLandOnHomeDrawer) {
    tmp17Result2 = tmp17(tmp3(12149).TTIFirstContentfulPaint, { label: "home_drawer", checkFocusedScreen: "guilds" });
  }
  items3[2] = tmp17Result2;
  obj12.children = items3;
  obj11.children = closure_10(panelTranslateX(4492).View, obj12);
  return closure_9(panelTranslateX(4492).View, obj11);
}
