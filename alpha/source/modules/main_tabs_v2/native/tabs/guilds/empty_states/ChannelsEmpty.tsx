...
// Function ID: 16512
// Name: ChannelsEmpty
// Dependencies: [19, 17, 4361, 1074, 21, 4722, 4718, 576, 563, 9301, 9982, 15306, 8833, 1177, 16512, 1115, 16513, 5145, 2]

// Module 16511 (ChannelsEmpty)
...
let obj3 = {};
const merged = Object.assign(fn(4718).TextStyleSheet["heading-md/bold"]);
obj3.fontSize = 18;
obj3.marginTop = 16;
obj3.marginBottom = 8;
obj.headerText = obj3;
...
export default noop.memo(function ChannelsEmpty(guild) {
  ...
  const obj2 = guild(15306);
  items4[1] = { paddingBottom: guild(15306).useYouBarTotalHeight(16) };
  obj3.style = items4;
  if (canCustomizeGuild) {
    ...
    const obj7 = { source: _modDef16512, disableColor: true };
    obj6.icon = closure_8(tmp2(1177).Icon, obj7);
    const intl = tmp2(1115).intl;
    obj6.label = intl.string(tmp2(1115).t["Yhi9/N"]);
    obj6.onPress = callback;
    obj5.children = closure_8(tmp2(8833).RowButton, obj6);
    canCustomizeGuild = closure_8(tmp8, obj5);
  }
  const items5 = [canCustomizeGuild, ];
  const obj8 = { style: tmp.content, children: null };
  const obj4 = { paddingBottom: guild(15306).useYouBarTotalHeight(16) };
  const items6 = [closure_8(closure_5, { source: _modDef16513 }), , , ];
  ...
  items6[1] = closure_8(guild(4718).Text, obj10);
  ...
  items6[2] = closure_8(guild(4718).Text, obj11);
  if (canCreateChannel) {
    ...
    obj12.children = tmp11(tmp2(5145).BaseTextButton, obj13);
