...
// Function ID: 16588
// Name: ChannelsEmpty
// Dependencies: [19, 17, 4395, 1074, 21, 4756, 4752, 576, 563, 9854, 9821, 15361, 8872, 1177, 16588, 1115, 16589, 5187, 2]

// Module 16587 (ChannelsEmpty)
...
import _modDef16589 from "module_16589" /* 16589 */;
...
let obj3 = {};
const merged = Object.assign(fn(4752).TextStyleSheet["heading-md/bold"]);
obj3.fontSize = 18;
obj3.marginTop = 16;
obj3.marginBottom = 8;
obj.headerText = obj3;
...
export default noop.memo(function ChannelsEmpty(guild) {
  ...
  items6[1] = closure_8(guild(4752).Text, obj10);
  ...
  items6[2] = closure_8(guild(4752).Text, obj11);
  if (canCreateChannel) {
    ...
    obj12.children = tmp11(tmp2(5187).BaseTextButton, obj13);
