...
// Function ID: 7573
// Name: SearchBarNav
// Dependencies: [19, 17, 21, 4722, 5852, 576, 5292, 1115, 1364, 5798, 4718, 7246, 2]
...
export default noop.forwardRef((onClose, ref) => {
  ...
  if (obj2.isAndroid()) {
    ...
    let tmp3Result = tmp3(tmp4(5798).ArrowLargeLeftIcon, obj3);
  } else {
    ...
    tmp3Result = tmp3(tmp4(4718).Text, obj4);
  }
