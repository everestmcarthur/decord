...
// Function ID: 11160
// Name: GroupDMRow
// Dependencies: [19, 11108, 21, 4875, 11160, 1177, 11161, 4718, 5774, 5775, 2]
// Exports: default

// Module 11159 (GroupDMRow)
import native from "native" /* 1177 */;
import useChannelNameDefault from "useChannelName" /* 4875 */;
import GroupDMAvatarDefault from "GroupDMAvatar" /* 11160 */;
import useRecipientsLabel from "useRecipientsLabel" /* 11161 */;
...
export default function GroupDMRow(channel) {
  ...
  if (null != recipientsLabel) {
    ...
    tmp5Result = tmp5(tmp7(4718).Text, obj4);
  }
  ...
  if (NONE === UserRowModes.TOGGLE) {
    ...
    obj5.checked = flag;
    let tmp5Result2 = tmp5(tmp7(5774).TableCheckboxRow, obj5);
  } else {
    const obj6 = {};
    const merged3 = Object.assign(obj3);
    tmp5Result2 = tmp5(tmp7(5775).TableRow, obj6);
  }
  return tmp5Result2;
};
