...
// Dependencies: [19, 17, 4714, 21, 4722, 576, 4458, 504, 4723, 4726, 2]

// Module 10074 (UserPlaceholderRow)
...
export default noop.memo(function UserPlaceholderRow(animate) {
  ...
  sharedValue = sharedValue(4458).useSharedValue(1);
  ...
  const animatedStyle = tmp4(4458).useAnimatedStyle(fn);
  ...
  return closure_7(flag(4458).View, obj3);
});
