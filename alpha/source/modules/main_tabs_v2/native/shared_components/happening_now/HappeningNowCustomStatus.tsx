...
// Dependencies: [5, 32, 19, 17, 4796, 15560, 1085, 21, 4756, 576, 563, 4989, 9995, 16410, 16411, 11141, 9866, 15561, 1364, 11155, 1177, 4752, 2]
// Exports: CustomStatusActivityCard

// Module 16409 (HappeningNowCustomStatus)
import nativeDefault from "native" /* 576 */;
import ActivityEmojiDefault from "ActivityEmoji" /* 11155 */;
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let tmp10 = activity(4989)({ userId: user.id, guildId });
  const displayNameStylesFont = user(9995).useDisplayNameStylesFont({ displayNameStyles: tmp10 });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                const obj5 = { value: user(16410).getEmojiSource(c1.emoji), done: false };
                return obj5;
              } else {
                v3 = 3;
              }
            ...
            if (arg0 === 1) {
              ...
              c2 = 2;
              v3 = 1;
              const obj9 = { value: user(16411).getEmojiDominantColors(obj8), done: false };
              return obj9;
            }
          } else if (arg0 === 1) {
            v3 = 3;
  ...
  let obj3 = user(9995);
  const gameMentionsAsPlainText = user(11141).useGameMentionsAsPlainText(activity.state);
  const items2 = [userTitle, , ];
  const tmp6Result = user(11141);
  items2[1] = user(9866).getStatusLabel(status);
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(11155), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15561).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4752).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15561).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4752).Text, obj19);
  ...
  return closure_12(activity(15561), obj4);
};
