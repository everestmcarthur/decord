...
// Dependencies: [19, 17, 4796, 1372, 15560, 1074, 21, 1177, 4756, 7402, 504, 1241, 8447, 1980, 4600, 9866, 15561, 8527, 2]

// Module 16423 (HappeningNowCardUser)
...
let closure_7 = fn(15560).HappeningNowCardTrackingType;
