...
obj.icon = { avatarSize: fn(1177).AvatarSizes.LARGE_48, guildIconSize: fn(5796).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5796).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj5 = { avatarSize: fn(1177).AvatarSizes.LARGE_48, guildIconSize: fn(5796).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5796).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
obj6.icon = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(7412).GameIconSizes.SMALL };
...
const obj7 = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(7412).GameIconSizes.SMALL };
