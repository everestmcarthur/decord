...
// Function ID: 10380
// Name: Compact
// Dependencies: [576, 1177, 5796, 7412, 10378, 2]
// Exports: getCompactStyles

// Module 10379 (Compact)
import nativeDefault from "native" /* 576 */;
import deepmergeDefault from "deepmerge" /* 10378 */;
...
CHANNEL_LIST_STYLES_COMPACT.icon = { avatarSize: fn(1177).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5796).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5796).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj5 = { avatarSize: fn(1177).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5796).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5796).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
