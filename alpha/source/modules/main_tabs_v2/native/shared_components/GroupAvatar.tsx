...
// Function ID: 13286
// Name: GroupAvatar
// Dependencies: [19, 17, 4714, 21, 4722, 576, 4573, 5756, 563, 4458, 4723, 5143, 7176, 4718, 5757, 2]
// Exports: default

// Module 13285 (GroupAvatar)
...
function AnimatedContainer(children) {
  ...
  const fn = function y() {
    ...
    if (stateFromStores) {
      ...
      withSpringResult = tmp(5143).withSpring(sharedValue2.get(), closure_11);
    ...
    if (stateFromStores) {
      ...
      value3 = tmp(5143).withSpring(sharedValue1.get(), closure_11);
      const tmpResult3 = tmp(5143);
    }
    items[1] = { translateY: value3 };
    if (stateFromStores) {
      let value4 = sharedValue3.get();
    } else {
      value4 = tmp(5143).withSpring(sharedValue3.get(), closure_10);
      const tmpResult4 = tmp(5143);
    }
