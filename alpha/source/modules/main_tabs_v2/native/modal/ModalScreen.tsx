...
// Dependencies: [109, 19, 17, 1074, 21, 4722, 576, 4925, 9008, 1249, 7671, 1612, 17253, 1364, 16899, 2]
// Exports: default

// Module 17252 (modal/ModalScreen)
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(7671).trackAppUIViewed("ModalScreen"), []);
  ...
  tmp7Result = modal(17253);
  let isIOSResult = modal(1364).isIOS();
  if (isIOSResult) {
    isIOSResult = closure_9(tmp7(16899).PortalKeyboardRenderer, { portal: false });
  }
