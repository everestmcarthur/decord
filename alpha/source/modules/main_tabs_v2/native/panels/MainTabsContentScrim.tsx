...
// Dependencies: [17, 21, 4722, 576, 4458, 2]
// Exports: MainTabsContentScrim

// Module 16784 (MainTabsContentScrim)
...
export const MainTabsContentScrim = function MainTabsContentScrim(translateX) {
  ...
  let obj = translateX(4458);
  fn.__closure = { interpolate: translateX(4458).interpolate, translateX, maxWidth, Extrapolation: translateX(4458).Extrapolation };
  ...
  obj3.style = items;
  return jsx(maxWidth(4458).View, { style: null, pointerEvents: "none" });
};
