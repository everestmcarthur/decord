...
// Dependencies: [19, 17, 21, 8118, 4722, 576, 7196, 7671, 1612, 8067, 1115, 11175, 17255, 17274, 17275, 2]
// Exports: default

// Module 17254 (MessageRequestsNavigator)
...
export default function MessageRequestsNavigator() {
  ...
  obj6.getComponent = function getComponent() {
    return closure_0(17274).default;
  };
  ...
  obj8.getComponent = function getComponent() {
    return closure_0(17275).default;
  };
