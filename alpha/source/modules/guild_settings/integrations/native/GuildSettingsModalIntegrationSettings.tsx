...
// Dependencies: [19, 17, 2016, 9302, 21, 17940, 1115, 4722, 576, 5858, 5292, 5775, 17941, 5857, 7396, 4432, 4718, 5453, 1397, 4573, 8831, 5142, 4314, 5855, 17942, 7236, 9301, 504, 4656, 17904, 2]
// Exports: default

// Module 17939 (GuildSettingsModalIntegrationSettings)
...
function ForceSyncIcon(isSyncing) {
  if (isSyncing.isSyncing) {
    ...
    obj.onPress = tmp;
    const obj2 = { source: _modDef17941 };
...
GuildSettingsModalIntegrationSettings.prototype["render"] = function render() {
  ...
  if (null != tmp) {
    ...
    obj.trailing = closure_7(integration(4718).Text, obj2);
    const tmp2 = closure_7(integration(5775).TableRow, obj);
  }
  ...
  value = self(5453).get(integration.type);
  if (null == value) {
    const _Object = Object;
    const values = Object.values(tmp12(17940).IntegrationExpireGracePeriodTypes);
    ...
    obj7.children = closure_7(tmp15(5775).TableRow, obj8);
    const items1 = [closure_7(tmp15(5857).TableRowGroup, obj7), , , , ];
    ...
    const obj12 = { datetime: tmp16(4314)(integration.synced_at).calendar() };
    ...
    const items2 = [closure_7(tmp15(5775).TableRow, obj10), tmp2];
    obj9.children = items2;
    items1[1] = closure_8(tmp15(5857).TableRowGroup, obj9);
    ...
    const obj17 = { value: tmp15(17942).IntegrationExpireBehaviorTypes.REMOVE_ROLE, label: null };
    const intl6 = tmp15(1115).intl;
    obj17.label = intl6.string(tmp15(1115).t["6kpw4i"]);
    const items3 = [closure_7(tmp15(5858).TableRadioRow, obj17), ];
    const obj18 = { value: tmp15(17942).IntegrationExpireBehaviorTypes.KICK, label: null };
    const intl7 = tmp15(1115).intl;
    obj18.label = intl7.string(tmp15(1115).t.fQUQIJ);
    items3[1] = closure_7(tmp15(5858).TableRadioRow, obj18);
    obj16.children = items3;
    items1[2] = closure_8(tmp15(5855).TableRadioGroup, obj16);
    ...
    items1[3] = closure_7(tmp15(5857).TableRowGroup, obj19);
    items1[4] = tmp13;
    obj6.children = items1;
    obj5.children = closure_8(tmp15(5142).Stack, obj6);
    const items4 = [closure_7(tmp15(8831).Form, obj5), closure_7(tmp15(7236).NavScrim, {})];
    ...
    icon.source = tmp15Result.makeSource(tmp15(4573).isThemeDark(props.theme) ? icon.darkPNG : icon.lightPNG);
    icon.style = iter.integrationIcon;
    tmp18(tmp19, icon);
    const tmp20 = tmp15(4573).isThemeDark(props.theme) ? icon.darkPNG : icon.lightPNG;
  }
};
GuildSettingsModalIntegrationSettings.contextType = fn(4432).ThemeContext;
const size = fn(2);
