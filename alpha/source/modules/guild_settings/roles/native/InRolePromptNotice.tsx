...
// Dependencies: [19, 17, 1074, 21, 4722, 576, 1385, 17976, 1177, 9870, 4718, 1115, 2]
// Exports: default

// Module 17975 (InRolePromptNotice)
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      const obj3 = { style: string.icon, source: _modDef9870, color: nativeDefault.unsafe_rawColors.YELLOW_300 };
      ...
      Icon = tmp6(tmp(4718).Text, obj4);
      items[1] = Icon;
      obj2.children = items;
      let tmp4Result = tmp4(tmp5, obj2);
    } else {
      const obj5 = { style: string.icon, source: _modDef9870 };
      ...
      items1[1] = tmp6(tmp(4718).Text, obj6);
      obj2.children = items1;
      tmp4Result = tmp4(tmp5, obj2);
    }
    isRolePowerfulResult = tmp(17976).isRolePowerful(role);
  }
};
