...
// Dependencies: [19, 17, 4610, 21, 4722, 576, 504, 4614, 12763, 12731, 5156, 5142, 12766, 4718, 1115, 5144, 16475, 2]
// Exports: default

// Module 17930 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(12766), obj8);
  }
  ...
  const items6 = [closure_6(guildId(4718).Text, obj10), ];
  ...
  items6[1] = closure_6(guildId(4718).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(guildId(5142).Stack, obj9);
  ...
  obj12.icon = closure_6(guildId(16475).BoostTier2Icon, { color: "white" });
  obj12.onPress = guildId.onUnlockPress;
  items5[2] = closure_6(guildId(5144).Button, obj12);
  obj6.children = items5;
  items4[3] = closure_7(guildId(5142).Stack, obj6);
