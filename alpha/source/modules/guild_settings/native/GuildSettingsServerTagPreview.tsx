...
// Dependencies: [5, 32, 19, 17, 1372, 8201, 21, 4756, 576, 504, 4908, 1397, 14177, 4752, 1115, 5184, 10415, 10012, 14178, 14222, 5186, 5819, 2]
// Exports: default
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  let obj = guildId(504);
  const name = onAdopted(4908).useName(guildId, null, stateFromStores);
  let obj3 = onAdopted(4908);
  let avatarURL;
  ...
  const items2 = [closure_10(guildId(4752).Text, obj2), ];
  ...
  items5[1] = closure_10(guildId(4752).Text, obj9);
  ...
  const items8 = [closure_10(guildId(4752).Text, { variant: "text-md/semibold", color: "text-default", children: name }), ];
  ...
  if (tmp15Result3) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(14178).GuildBadge, size);
    }
  ...
  items9[1] = closure_10(guildId(4752).Text, obj15);
  ...
  const items11 = [closure_10(tmp18, { source: onAdopted(14222), style: tmp.avatar, importantForAccessibility: "no" }), ];
  ...
  items12[1] = closure_10(guildId(4752).Text, obj20);
  ...
  items6[3] = closure_10(guildId(5186).Button, obj21);
  obj5.children = items6;
  items2[1] = closure_11(guildId(5184).Stack, obj5);
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result4 = tmp15(tmp2(5819).Card, obj23);
  }
  return tmp15Result4;
};
