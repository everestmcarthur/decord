...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [closure_12(guildId(4752).Text, obj5), , ];
  ...
  obj6.children = closure_12(guildId(5186).Button, obj7);
  ...
  if (hasItem) {
    ...
    tmp17Result = tmp17(tmp2(4752).Text, obj8);
  }
  ...
  obj12.children = closure_12(guildId(4752).Text, obj13);
