...
// Dependencies: [32, 19, 17, 14952, 2038, 21, 4756, 576, 2027, 14985, 14991, 8681, 14986, 7628, 4710, 4752, 1115, 5334, 5892, 15023, 5186, 2]
// Exports: TinyBroncoAgeGroupHeader

// Module 14990 (TinyBroncoAgeGroupHeader)
...
function AccountStatusNotice(arg0) {
  ...
  if (shouldShowAgeNotice) {
    ...
    if (null != tmp5[0]) {
      ...
      obj7.onPress = tmp7;
      obj7.children = closure_8(tmp2(5892).XSmallIcon, { size: "sm", color: "icon-strong" });
      items[2] = closure_8(tmp2(5334).PressableOpacity, obj7);
      obj3.children = items;
...
function AgeGroupDescription(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const obj3 = { handleOnAgeGatedContentHook: tmp(14985).handleOpenAgeGatedContentArticle };
    obj2.children = intl3.format(_modDef14991.gi4ulu, obj3);
    return React6(tmp(4752).Text, obj2);
  } else if (tmp(14985).AgeGroupState.TEEN === ageGroup) {
    const obj4 = { variant: "text-sm/normal", color: "text-default", children: null };
    const intl2 = tmp(1115).intl;
    const obj5 = { handleOnAgeGatedContentHook: tmp(14985).handleOpenAgeGatedContentArticle, handleOnConfirmAgeHook: tmp(14985).handleShowAgeVerification };
    obj4.children = intl2.format(_modDef14991["221iML"], obj5);
    return React6(tmp(4752).Text, obj4);
  } else if (tmp(14985).AgeGroupState.UNVERIFIED === ageGroup) {
    const obj = { variant: "text-sm/normal", color: "text-default", children: null };
    const intl = tmp(1115).intl;
    obj6 = { handleOnAgeGatedContentHook: tmp(15023).handleOpenUnconfirmedAgeGroupSupportArticle, handleOnConfirmAgeHook: tmp(14985).handleShowAgeVerification };
    obj.children = intl.format(_modDef14991["W0/7DD"], obj6);
...
function AgeGroupCallToAction(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const intl2 = tmp(1115).intl;
    obj2.text = intl2.string(_modDef14991["+7NlgO"]);
    obj2.onPress = tmp(14985).handleOpenAgeGatedContentArticle;
    return React6(tmp(5186).Button, obj2);
  } else if (tmp(14985).AgeGroupState.UNVERIFIED === ageGroup) {
    const obj = { grow: true, variant: "secondary", size: "md", text: null, onPress: null };
    const intl = tmp(1115).intl;
    obj.text = intl.string(_modDef14991["cI+bc/"]);
    obj.onPress = tmp(14985).handleShowAgeVerification;
    return React6(tmp(5186).Button, obj);
  }
}
const View = fn(17).View;
const TINY_BRONCO_BLOG_URL = fn(14952).TINY_BRONCO_BLOG_URL;
...
let closure_12 = [];
let obj6 = {};
obj6[fn(14985).AgeGroupState.ADULT] = _modDef14991["8TWztV"];
obj6[fn(14985).AgeGroupState.TEEN] = _modDef14991.qSkhZH;
obj6[fn(14985).AgeGroupState.UNVERIFIED] = _modDef14991.vGxRDB;
let obj7 = {};
obj7[fn(14985).AgeGroupState.ADULT] = _modDef14991.t5QjmQ;
obj7[fn(14985).AgeGroupState.TEEN] = _modDef14991["41MDhK"];
obj7[fn(14985).AgeGroupState.UNVERIFIED] = _modDef14991.m95jW8;
const size = fn(2);
