...
// Function ID: 16455
// Name: VoiceUsers
// Dependencies: [19, 17, 2105, 21, 4756, 576, 10376, 8115, 504, 16455, 10374, 1115, 12782, 4752, 9997, 16459, 7551, 16462, 2]
// Exports: default, getAudienceItemHeight

// Module 16454 (VoiceUsers)
...
let closure_12 = noop.memo((voiceState) => {
  ...
  const tmp = channel;
  const tmp3 = closure_11(channel(8115)());
  ...
  obj2.children = closure_6(tmp(16455), obj5, user.id);
