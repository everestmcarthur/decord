...
// Dependencies: [32, 19, 17, 21, 4722, 4956, 9414, 4718, 4566, 1115, 16382, 2]
// Exports: default

// Module 16381 (VoiceUserNameItem)
import Text_Text from "Text/Text" /* 4718 */;
import useDisplayNameStylesDefault from "useDisplayNameStyles" /* 4956 */;
import useDisplayNameStylesFont from "useDisplayNameStylesFont" /* 9414 */;
...
export default function VoiceUserNameItem(arg0) {
  ...
  if (isGuest) {
    ...
    isGuest = tmp18(tmp5(4718).Text, obj6);
  }
  items1[1] = isGuest;
  ...
  if (tmp12) {
    ...
    obj7.children = React5(tmp2(16382), obj8);
