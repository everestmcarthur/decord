...
// Dependencies: [32, 19, 17, 5451, 1372, 13920, 1074, 1955, 21, 4722, 576, 4432, 1612, 4689, 7346, 7345, 7394, 5142, 4718, 1115, 5144, 13199, 9490, 7578, 4430, 5453, 1397, 1177, 8689, 504, 13921, 5576, 4542, 1944, 2]
// Exports: default, useShouldShowRobloxConnectionCoachmark

// Module 17309 (RobloxConnectionCoachmark)
...
export default function RobloxConnectionActionSheet(markAsDismissed) {
  ...
  let tmp = closure_15();
  const theme = markAsDismissed(4432).useThemeContext().theme;
  let obj2 = { startExpanded: true, contentStyles: tmp.content, header: null, onDismiss: null, children: null };
  let obj = markAsDismissed(4432);
  obj2.header = closure_13(markAsDismissed(7345).BottomSheetTitleHeader, { title: null, leading: closure_13(markAsDismissed(7394).ActionSheetCloseButton, { onPress: handleCancel }) });
  ...
  obj5.children = items;
  const items1 = [closure_14(markAsDismissed(5142).Stack, obj5), , ];
  ...
  const items2 = [closure_13(markAsDismissed(4718).Text, obj7), ];
  ...
  items2[1] = closure_13(markAsDismissed(4718).Text, obj8);
  obj6.children = items2;
  items1[1] = closure_14(markAsDismissed(5142).Stack, obj6);
  ...
  const obj3 = { title: null, leading: closure_13(markAsDismissed(7394).ActionSheetCloseButton, { onPress: handleCancel }) };
  obj10.icon = closure_13(markAsDismissed(13199).WindowLaunchIcon, { size: "sm", color: nativeDefault.colors.WHITE });
  ...
  const items3 = [closure_13(markAsDismissed(5144).Button, obj10), ];
  ...
  items3[1] = closure_13(markAsDismissed(5144).Button, obj12);
  obj9.children = items3;
  items1[2] = closure_14(markAsDismissed(5142).Stack, obj9);
  obj4.children = items1;
  obj2.children = closure_14(markAsDismissed(5142).Stack, obj4);
  return closure_13(markAsDismissed(7346).BottomSheet, obj2);
};
export { UnionIcon };
export const useShouldShowRobloxConnectionCoachmark = function useShouldShowRobloxConnectionCoachmark() {
  ...
  stateFromStores = stateFromStores(504).useStateFromStores(items, () => appInstalled.isAppInstalled(stateFromStores(13921).DetectableAppNames.ROBLOX));
