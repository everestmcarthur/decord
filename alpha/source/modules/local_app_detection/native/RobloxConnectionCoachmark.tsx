...
// Dependencies: [32, 19, 17, 5493, 1372, 13975, 1074, 2038, 21, 4756, 576, 4466, 1612, 4723, 7390, 7389, 7438, 5184, 4752, 1115, 5186, 13247, 9340, 7622, 4464, 5495, 1397, 1177, 8727, 504, 13976, 5618, 4576, 2027, 2]
...
export default function RobloxConnectionActionSheet(markAsDismissed) {
  ...
  obj5.children = items;
  const items1 = [closure_14(markAsDismissed(5184).Stack, obj5), , ];
  ...
  const items2 = [closure_13(markAsDismissed(4752).Text, obj7), ];
  ...
  items2[1] = closure_13(markAsDismissed(4752).Text, obj8);
  obj6.children = items2;
  items1[1] = closure_14(markAsDismissed(5184).Stack, obj6);
  ...
  const obj3 = { title: null, leading: closure_13(markAsDismissed(7438).ActionSheetCloseButton, { onPress: handleCancel }) };
  ...
  const items3 = [closure_13(markAsDismissed(5186).Button, obj10), ];
  ...
  items3[1] = closure_13(markAsDismissed(5186).Button, obj12);
