...
// Dependencies: [32, 2040, 13292, 504, 7408, 2]
// Exports: default

// Module 13291 (useEntryActivityAndApplication)
...
export default function useEntryActivityAndApplication(extra) {
  ...
  [activityApplication, obj2.fallbackApplication] = activityApplication(7408)(items1);
  ...
  const tmp4 = activityApplication(7408);
