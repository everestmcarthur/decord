...
// Dependencies: [19, 17, 21, 4722, 12717, 576, 4458, 4723, 4726, 2]
// Exports: default

// Module 14185 (GuildProgressBar)
...
const obj2 = { wrapper: { position: "relative", backgroundColor: fn(12717).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 }, progress: null };
let obj3 = { position: "relative", backgroundColor: fn(12717).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 };
...
export default function GuildProgressBar(percent) {
  ...
  obj3.style = items1;
  const animatedStyle = percent(4458).useAnimatedStyle(fn);
  const obj4 = { style: null };
  const items2 = [tmp.progress, animatedStyle];
  obj4.style = items2;
  obj3.children = jsx(sharedValue(4458).View, { style: null });
