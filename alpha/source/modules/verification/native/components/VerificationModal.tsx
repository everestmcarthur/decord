...
// Dependencies: [5, 19, 17, 17902, 2035, 1372, 1074, 21, 4756, 1177, 17903, 1115, 5186, 1485, 1249, 5836, 7617, 9897, 7434, 6829, 17907, 6827, 6840, 6837, 7222, 7284, 7285, 6828, 17908, 7318, 7233, 504, 4723, 4622, 7240, 2]
// Exports: default

// Module 17901 (VerificationModal)
import Link from "Link" /* 1485 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4723 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import PhoneVerificationStore from "PhoneVerificationStore" /* 17902 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17903).VerifyPhone, title: null, body: null, children: null };
  ...
  return jsx(navigation(1177).EmptyState, { Illustration: navigation(17903).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(9897), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(7434).showSimpleActionSheet(obj2);
        };
        return closure_1_11(stateFromStores(7617).HeaderActionButton, obj);
      };
      obj8.render = function render() {
        return closure_1_11(closure_1_1(17907), {});
      };
      ...
      let obj10 = stateFromStores(5836);
      ...
      obj11.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      obj11.render = function render() {
        return closure_1_11(closure_1_1(6827), {});
      };
      ...
      const obj13 = stateFromStores(5836);
      ...
      obj14.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5836);
      ...
      obj17.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      obj17.render = function render() {
        return closure_1_11(closure_1_1(6840), { isChangeEmail: false });
      };
      ...
      const obj19 = stateFromStores(5836);
      ...
      obj20.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      obj20.render = function render() {
        return closure_1_11(closure_1_1(6837), {});
      };
      ...
      const obj22 = stateFromStores(5836);
      ...
      obj23.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      obj23.render = function render() {
        return closure_1_11(closure_1_1(7222), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5836);
      ...
      obj26.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      obj26.render = function render(arg0, arg1) {
        closure_0 = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = closure_0(7285).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return closure_0.push(constants.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F128564 */ function() { ... });
              obj.onSubmit = function onSubmit() { ... };
              closure_1 = closure_1_3(/* F128566 */ function() { ... });
              obj.onSuccess = function onSuccess() { ... };
              closure_0.push(constants.VERIFY_PASSWORD, obj);
            }
          });
        };
        return closure_11(closure_1(7284), obj);
      };
      ...
      const obj28 = stateFromStores(5836);
      ...
      obj29.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      obj29.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7318), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5836);
      ...
      obj32.headerTitle = stateFromStores(5836).getHeaderNoTitle();
      obj32.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7233), {});
      };
      ...
      const obj34 = stateFromStores(5836);
      ...
      obj35.headerTitle = stateFromStores(5836).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(7240).Navigator, {
    screens: noop.useMemo(() => {
      let obj = {};
      let obj2 = { impressionName: stateFromStores(1249).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS }, headerTitle: null, render: null };
      let obj3 = { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
