...
// Dependencies: [5, 19, 17, 17822, 1952, 1372, 1074, 21, 4722, 1177, 17823, 1115, 5144, 1485, 1249, 5794, 7573, 10045, 7390, 6785, 17827, 6783, 6796, 6793, 7178, 7240, 7241, 6784, 17828, 7274, 7189, 504, 4689, 4588, 7196, 2]
// Exports: default

// Module 17821 (VerificationModal)
import Link from "Link" /* 1485 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4689 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import PhoneVerificationStore from "PhoneVerificationStore" /* 17822 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17823).VerifyPhone, title: null, body: null, children: null };
  ...
  obj2.children = jsx(navigation(5144).Button, { text: null, onPress: null });
  obj.children = <View style={closure_12().button}>{null}</View>;
  return jsx(navigation(1177).EmptyState, { Illustration: navigation(17823).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  const effect = noop.useEffect(() => {
    ...
    stateFromStores(4588).dismissKeyboard();
  }, []);
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(10045), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(7390).showSimpleActionSheet(obj2);
        };
        return closure_1_11(stateFromStores(7573).HeaderActionButton, obj);
      };
      obj8.render = function render() {
        return closure_1_11(closure_1_1(17827), {});
      };
      ...
      let obj10 = stateFromStores(5794);
      ...
      obj11.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      obj11.render = function render() {
        return closure_1_11(closure_1_1(6783), {});
      };
      ...
      const obj13 = stateFromStores(5794);
      ...
      obj14.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5794);
      ...
      obj17.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      obj17.render = function render() {
        return closure_1_11(closure_1_1(6796), { isChangeEmail: false });
      };
      ...
      const obj19 = stateFromStores(5794);
      ...
      obj20.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      obj20.render = function render() {
        return closure_1_11(closure_1_1(6793), {});
      };
      ...
      const obj22 = stateFromStores(5794);
      ...
      obj23.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      obj23.render = function render() {
        return closure_1_11(closure_1_1(7178), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5794);
      ...
      obj26.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      obj26.render = function render(arg0, arg1) {
        closure_0 = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = closure_0(7241).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return closure_0.push(constants.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F128136 */ function() { ... });
              obj.onSubmit = function onSubmit() { ... };
              closure_1 = closure_1_3(/* F128138 */ function() { ... });
              obj.onSuccess = function onSuccess() { ... };
              closure_0.push(constants.VERIFY_PASSWORD, obj);
            }
          });
        };
        return closure_11(closure_1(7240), obj);
      };
      ...
      const obj28 = stateFromStores(5794);
      ...
      obj29.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      obj29.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7274), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5794);
      ...
      obj32.headerTitle = stateFromStores(5794).getHeaderNoTitle();
      obj32.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7189), {});
      };
      ...
      const obj34 = stateFromStores(5794);
      ...
      obj35.headerTitle = stateFromStores(5794).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(7196).Navigator, {
    screens: noop.useMemo(() => {
      let obj = {};
      let obj2 = { impressionName: stateFromStores(1249).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS }, headerTitle: null, render: null };
      let obj3 = { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
