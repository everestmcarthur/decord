...
// Dependencies: [5, 32, 19, 17, 1372, 21, 4756, 1484, 504, 6838, 1094, 4657, 4454, 1115, 6839, 4752, 5186, 2]
// Exports: default
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_10(tmp2(4752).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5186).Button, obj9);
