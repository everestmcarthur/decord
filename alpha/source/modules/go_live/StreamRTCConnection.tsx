...
// Dependencies: [1915, 4767, 4768, 502, 1958, 4770, 1909, 4771, 4745, 4772, 1074, 4747, 1091, 4749, 4773, 1953, 4774, 4775, 12, 573, 4776, 4777, 4851, 1241, 4716, 4857, 4751, 4858, 4862, 4863, 13878, 7868, 2]

// Module 4766 (StreamRTCConnection)
import _modDef12 from "module_12" /* 12 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import DurationsDefault from "Durations" /* 1091 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import CrossPlatformNativeUtilsDefault from "CrossPlatformNativeUtils" /* 4716 */;
import SoundshareStatsAggregatorDefault from "SoundshareStatsAggregator" /* 4773 */;
import StreamKeyUtils from "StreamKeyUtils" /* 4774 */;
import VideoStreamStatsDefault from "VideoStreamStats" /* 4775 */;
import BaseConnectionEvent from "BaseConnectionEvent" /* 4777 */;
import GameAnalyticsUtils from "GameAnalyticsUtils" /* 4851 */;
import getSoundshareAnalyticsContextDefault from "getSoundshareAnalyticsContext" /* 4857 */;
import getReportedStreamResolutionDefault from "getReportedStreamResolution" /* 4858 */;
import getStreamSourceMetadataDefault from "getStreamSourceMetadata" /* 4862 */;
...
import RTCConnection from "RTCConnection" /* 4749 */;
...
prototype["initializeEvents"] = function initializeEvents() {
      ...
      if (_connection8 != null) {
        _connection8.on(BaseConnectionEvent.BaseConnectionEvent.ScreenshareFinish, (screenshare_frames, videohook_frames, hybrid_dxgi_frames, hybrid_gdi_frames, hybrid_videohook_frames, hybrid_graphics_capture_frames, hybrid_capture_method_switches, hybrid_gdi_bitblt_frames, hybrid_gdi_printwindow_frames, hybrid_graphics_capture_frames_unique, hybrid_dxgi_frames_unique, hybrid_videohook_frames_unique, hybrid_gdi_bitblt_frames_unique, hybrid_gdi_printwindow_frames_unique, skip_history_json, quartz_frames, desktop_capturer_type, activity, go_live_camera_frames, screencapturekit_frames, hdr_frames_capable, hdr_frames, target_window_elevated, arg23, arg24, videohook_backend) => {
          ...
          closure_1_4().then((result) => {
            ...
            obj3.discord_is_elevated = self(4716).getDiscordIsElevated();
      ...
      if (_connection5 != null) {
        _connection5.on(BaseConnectionEvent.BaseConnectionEvent.FirstFrameStats, (remoteVideoStreamCreatedTimestamp) => {
          if (!closure_1_1._firstFrameDelivered) {
            ...
            const obj2 = self(1241);
            const obj4 = c0(4751);
            obj5.time_total_to_first_frame = c0(4751).now() - obj.getCreatedTime();
  ...
  this.on(require("RTCConnectionEvent").RTCConnectionEvent.VideoSourceQualityChanged, (guildId, channelId, senderUserId, arg3, maxFrameRate, context) => {
    ...
    let tmp4 = arg3;
    if (senderUserId === id) {
      tmp4 = self(4858)("StreamRTCConnection", guildId, arg3, maxFrameRate);
    }
...
prototype["trackVideoEndStats"] = function trackVideoEndStats(reason) {
  ...
  if (null != _videoQuality) {
    ...
    let obj = { stream_application_name: obj5(4863).default.getApplicationNames() };
    if (self.isOwner) {
      let obj2 = { clips_enabled: tmp5(13878).isClipsEnabled(), clips_buffer_length: tmp8.clipsLength };
      obj3 = obj2;
      const tmp5Result = tmp5(13878);
    } else {
      obj3 = {};
    }
    if (self.isOwner) {
    ...
    const _default = obj5(4863).default;
    tmp5 = obj5;
  }
};
