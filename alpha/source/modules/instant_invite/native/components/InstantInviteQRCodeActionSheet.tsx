...
// Dependencies: [19, 17, 2063, 1372, 1074, 21, 4756, 576, 5796, 504, 1115, 573, 4453, 7437, 7389, 10119, 4752, 2]
// Exports: default

// Module 10118 (InstantInviteQRCodeActionSheet)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import GuildIconDefault from "GuildIcon" /* 5796 */;
import components_native_QRCodeDefault from "components_native/QRCode" /* 10119 */;
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != GuildStore.getGuild(channel2.guild_id)) {
        const obj4 = { guild: obj8.getGuild(channel2.guild_id), size: tmp6(5796).GuildIconSizes.LARGE };
