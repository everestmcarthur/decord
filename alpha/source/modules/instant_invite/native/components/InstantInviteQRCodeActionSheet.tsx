...
// Dependencies: [19, 17, 1980, 1372, 1074, 21, 4722, 576, 5754, 504, 1115, 573, 4419, 7393, 7345, 10109, 4718, 2]
// Exports: default

// Module 10108 (InstantInviteQRCodeActionSheet)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import GuildIconDefault from "GuildIcon" /* 5754 */;
import components_native_QRCodeDefault from "components_native/QRCode" /* 10109 */;
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != GuildStore.getGuild(channel2.guild_id)) {
        const obj4 = { guild: obj8.getGuild(channel2.guild_id), size: tmp6(5754).GuildIconSizes.LARGE };
    ...
    if (tmp19Result2) {
      ...
      tmp19Result2 = tmp19(tmp6(4718).Text, obj13);
    }
