...
// Dependencies: [5, 19, 2096, 4675, 2105, 2063, 4395, 5650, 1372, 13408, 7976, 1074, 1241, 4723, 13409, 1980, 5729, 504, 4467, 1115, 8648, 10077, 10150, 2]
// Exports: sendGuildInvite, showGuildInviteActionSheet, useServerInviteRows

// Module 13407 (GuildInviteUtils)
...
export const showGuildInviteActionSheet = function showGuildInviteActionSheet(id, newestAnalyticsLocation) {
  ...
  obj3.openLazy(asyncRequireImpl(13409, dependencyMap.paths), "invite-to-guilds-" + id, { recipientId: id, source: newestAnalyticsLocation });
};
