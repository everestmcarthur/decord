...
// Dependencies: [7700, 1074, 3, 7358, 17803, 1339, 16336, 17804, 7715, 2]

// Module 17802 (JankSessionManager)
import LoggerDefault from "Logger" /* 3 */;
import clientLaunchId from "clientLaunchId" /* 1339 */;
import NativeJankSessionModuleDefault from "NativeJankSessionModule" /* 17803 */;
import JankNavigationReporterDefault from "JankNavigationReporter" /* 17804 */;
    ...
    const nextPromise = pendingReports.then((arr) => {
      ...
      if (0 !== arr.length) {
        const result = AnalyticsTrackingStore.submitEventsImmediately(arr.flatMap((screens) => {
          ...
          let merged = Object.assign(screens(7715).getDeviceMetadata());
          ...
          const items = [
            ...
            ...screens.map((item) => {
              ...
              const merged = Object.assign(screens(7715).getDeviceMetadata());
