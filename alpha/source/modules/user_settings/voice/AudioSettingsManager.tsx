...
// Dependencies: [32, 4739, 5182, 502, 1909, 4747, 9331, 11, 1186, 510, 1941, 9330, 12, 14279, 9686, 7314, 2]

// Module 17649 (AudioSettingsManager)
...
import AudioSettingsDefaultVolumes from "AudioSettingsDefaultVolumes" /* 9331 */;
import AudioSettingsPending from "AudioSettingsPending" /* 14279 */;
...
function handleConnectionOpen() {
  ...
  if (typeof SETTINGS_MIGRATION_KEY === "function") {
    ...
    if (!Storage.get("AudioContextSettingsMigrated:" + tmp3)) {
      const PreloadedUserSettingsActionCreators = tmp(1941).PreloadedUserSettingsActionCreators;
      PreloadedUserSettingsActionCreators.updateAsync("audioContextSettings", async (arg0) => {
        ...
        return flag;
      }, tmp(1941).UserSettingsDelay.AUTOMATED);
    }
  } else {
...
function handleSetLocalMute(arg0) {
  ...
  if (userId !== AuthenticationStore.getId()) {
    ...
    PreloadedUserSettingsActionCreators.updateAsync("audioContextSettings", async (arg0) => {
      closure_0 = arg0;
      let result = closure_0(14279).drainPendingAudioSettings((arg0, arg1, arg2) => {
        let diff;
          ...
          if (closure_0[result][arg1] != null) {
            ...
            if (typeof DEFAULT_VOLUME_FOR_CONTEXT === "function") {
              if (arg0 === constants.STREAM) {
                let USER2 = tmp5(9331).AudioSettingsDefaultVolumes.STREAM;
              } else {
                USER2 = tmp5(9331).AudioSettingsDefaultVolumes.USER;
              }
              if (!tmp21) {
                delete tmp2[tmp];
              }
            ...
            if (arg0 === constants.STREAM) {
              let USER = tmp5(9331).AudioSettingsDefaultVolumes.STREAM;
            } else {
              USER = tmp5(9331).AudioSettingsDefaultVolumes.USER;
            }
...
let apply = apply_mod;
let closure_13 = apply.debounce(fn(9686).remoteAudioSettingsUpdate, 500, { maxWait: 500 });
