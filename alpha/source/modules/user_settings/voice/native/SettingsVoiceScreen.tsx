...
// Dependencies: [19, 17, 1909, 8194, 1074, 21, 2025, 4722, 4656, 4573, 10242, 10243, 1115, 6848, 10241, 4718, 10238, 11714, 14904, 2]
// Exports: default

// Module 15456 (SettingsVoiceScreen)
import util from "util" /* 1115 */;
import useThemeDefault from "useTheme" /* 4656 */;
import Text_Text from "Text/Text" /* 4718 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6848 */;
import KrispLogo2 from "KrispLogo" /* 10241 */;
...
function KrispLogo() {
  ...
  if (obj.isThemeLight(tmp4)) {
    let tmp2Result = tmp2(10242);
  } else {
    tmp2Result = tmp2(10243);
  }
...
function SystemProcessingSubLabel() {
  ...
  if (obj.useNoiseCancellationDeferredToSystem()) {
    ...
    tmp3 = React7(tmp(4718).Text, obj2);
  }
  return tmp3;
}
