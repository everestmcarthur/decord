...
// Dependencies: [19, 17, 1074, 12653, 21, 4722, 576, 12654, 1241, 5777, 9297, 4718, 1115, 5144, 2]
// Exports: default
...
export default function NotificationPermissionSettingsHeader() {
  ...
  canSeePushNotificationNudge = canSeePushNotificationNudge(12654).useCanSeePushNotificationNudge();
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj5.children = closure_11(tmp2(9297).BellSlashIcon, obj6);
    ...
    items1[1] = closure_11(tmp2(4718).Text, obj7);
    ...
    items1[2] = closure_11(tmp2(4718).Text, obj8);
    ...
    obj10.onPress = tmp6;
    obj9.children = closure_11(tmp2(5144).Button, obj10);
    items1[3] = closure_11(View, obj9);
    obj4.children = items1;
    obj3.children = closure_12(View, obj4);
    obj2.children = closure_11(tmp2(5777).Card, obj3);
