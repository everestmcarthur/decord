...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4756, 576, 6859, 510, 10447, 1612, 7290, 5334, 1115, 8631, 10448, 13205, 8996, 4752, 2]
// Exports: default

// Module 15839 (UserSettingsPushNotificationLogs)
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7290).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10447)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10448)(closure_128_0, false) };
          tmp2(8631).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(13205).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5334).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(8996).FlashList, obj4);
  obj.children = items2;
