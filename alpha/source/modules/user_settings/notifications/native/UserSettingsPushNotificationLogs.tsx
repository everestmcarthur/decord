...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4722, 576, 6815, 510, 10431, 1612, 7246, 5292, 1115, 8593, 10432, 9291, 8957, 4718, 2]
// Exports: default

// Module 15784 (UserSettingsPushNotificationLogs)
...
let size = { backgroundColor: nativeDefault.colors.INPUT_BACKGROUND_DEFAULT, marginLeft: nativeDefault.space.PX_8, borderRadius: nativeDefault.radii.md, height: fn(6815).InputHeights.MD, width: fn(6815).InputHeights.MD, justifyContent: "center", alignItems: "center" };
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7246).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10431)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10432)(closure_128_0, false) };
          tmp2(8593).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(9291).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5292).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(8957).FlashList, obj4);
  obj.children = items2;
