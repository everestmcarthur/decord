...
// Dependencies: [5, 32, 19, 17, 21, 4722, 576, 6789, 1115, 14998, 7143, 14999, 15009, 4718, 1177, 5144, 2]
// Exports: default

// Module 15008 (TwoFASetupSuccess)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 1177 */;
import Text_Text from "Text/Text" /* 4718 */;
import components_Button_Button from "components/Button/Button" /* 5144 */;
import TwoFASetupModal from "TwoFASetupModal" /* 14999 */;
...
export default function TwoFASetupSuccess() {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              c5 = 3;
              c6 = 1;
              const obj5 = { value: setRegistering(6789).finishRegisterWebAuthnCredential(intl.string(setRegistering(1115).t["8H5RmH"]), closure_129_0, closure_129_1), done: false };
              return obj5;
            }
          } else {
            if (2 === tmp8) {
              ...
              setError(14998).close();
              c4 = 0;
              const obj = setError(14998);
            }
            c4 = 0;
            c6 = 3;
  ...
  items[1] = closure_8(closure_7, { source: _mod15009, style: tmp.image });
