...
// Dependencies: [5, 32, 19, 17, 1372, 1074, 21, 4722, 576, 4907, 14921, 4718, 1115, 1484, 504, 4380, 14922, 7186, 7180, 1271, 1485, 8067, 6799, 7194, 7132, 2]
// Exports: default
  ...
  onSubmitEditing = obj5.useCallback(() => {
    if (isMatch) {
      ...
      navigation = closure_4(function*(arg0) {
        ...
        closure_129_0 = yield closure_2_2(7180).saveAccountChanges(user, { close: false });
        if (!closure_129_0.ok) {
