...
// Dependencies: [109, 5, 19, 8428, 7855, 1372, 1074, 504, 573, 7224, 11352, 7228, 7231, 14875, 8435, 4656, 14876, 8449, 8465, 13375, 2019, 14177, 1115, 2]
// Exports: default

// Module 14874 (useUserProfileEditForm)
...
export default function useUserProfileEditForm() {
  ...
  const effect = noop.useEffect(() => () => stateFromStores(573).wait(pendingChanges(7224).resetAllPending), []);
      ...
      try {
        ...
        if (0 === c6) {
          if (arg0 === 1) {
            ...
            if (stateFromStores) {
              ...
              const accountUpdateForUpdateRequest = pendingChanges(11352).getAccountUpdateForUpdateRequest(pendingChanges);
              closure_131_0 = accountUpdateForUpdateRequest;
              const obj26 = pendingChanges(11352);
              profileChangesForUpdateRequest = pendingChanges(11352).getProfileChangesForUpdateRequest(pendingChanges);
              const obj27 = pendingChanges(11352);
              primaryGuildChangesForUpdateRequest = pendingChanges(11352).getPrimaryGuildChangesForUpdateRequest(pendingChanges);
              closure_131_3 = true;
              closure_131_4 = false;
              ...
              if (Object.keys(accountUpdateForUpdateRequest).length > 0) {
                c6 = 1;
                c7 = 1;
                const obj6 = { value: pendingChanges(7224).saveProfileAndAccountChanges(accountUpdateForUpdateRequest), done: false };
                return obj6;
              } else {
                ...
                if (Object.keys(profileChangesForUpdateRequest).length > 0) {
                  ...
                  c6 = 2;
                  c7 = 1;
                  const obj8 = { value: pendingChanges(8435).saveProfileChanges(closure_131_8, undefined, bannerOriginalMd5), done: false };
                  return obj8;
                } else {
                  ...
                  c6 = 3;
                  c7 = 1;
                  const obj13 = { value: pendingChanges(14876).updateBadgeSettings(obj11), done: false };
                  return obj13;
                }
              }
              const obj28 = pendingChanges(11352);
            }
          }
        } else if (1 === tmp7) {
          if (arg0 === 1) {
            ...
            if (ok) {
              ...
              if (undefined !== closure_132_0.pendingAvatar) {
                ...
                const result = pendingChanges(7228).trackUserAvatarUpdated(obj16);
                const obj22 = pendingChanges(7228);
              }
              const result1 = pendingChanges(7224).resetPendingAccountChanges();
              const obj24 = pendingChanges(7224);
            } else {
              let username;
              if (closure_131_5 != null) {
              ...
              if (null != username) {
                const result2 = pendingChanges(7231).showInvalidUsernameToast();
                closure_131_4 = true;
                const obj21 = pendingChanges(7231);
              } else {
                let avatar;
                if (closure_131_5 != null) {
                ...
                if (null != avatar) {
                  const result3 = pendingChanges(14875).showGenericProfileUpdateFailureToast(closure_131_5.body.avatar);
                  closure_131_4 = true;
                  const obj44 = pendingChanges(14875);
                }
              }
            }
          ...
          if (arg0 === 1) {
            ...
            if (ok2) {
              const result4 = pendingChanges(8435).resetPendingProfileChanges();
              const obj19 = pendingChanges(8435);
            } else {
              const aPIError = new pendingChanges(4656).APIError(closure_131_9);
              firstFieldErrorMessage = aPIError.getFirstFieldErrorMessage("banner");
              if (null != firstFieldErrorMessage) {
                const result5 = pendingChanges(14875).showGenericProfileUpdateFailureToast(firstFieldErrorMessage);
                closure_131_4 = true;
                const obj18 = pendingChanges(14875);
              }
            }
          ...
          if (3 === tmp7) {
            if (arg0 === 1) {
              ...
              if (closure_131_12) {
                ...
                if (null != closure_131_13) {
                  const profile = pendingChanges(8449).fetchProfile(closure_131_13);
                  c6 = 4;
                  c7 = 1;
                  const obj23 = {
                    value: profile.catch(() => {
            ...
            if (arg0 === 1) {
              ...
              const result6 = pendingChanges(13375).resetPendingBadgeSettings();
              const obj7 = pendingChanges(13375);
            }
          } else if (6 === tmp7) {
            c5 = 0;
            closure_131_3 = false;
            ...
            if (7 === tmp7) {
              if (arg0 === 1) {
                ...
                const result7 = pendingChanges(7224).resetPendingLegacyUsernameDisabled();
                c5 = 0;
                const obj5 = pendingChanges(7224);
              }
            } else if (arg0 === 1) {
              c7 = 3;
              throw value;
              ...
              if (ok4) {
                const result8 = pendingChanges(7224).resetPendingPrimaryGuildChanges();
                const obj3 = pendingChanges(7224);
              } else {
                const aPIError1 = new pendingChanges(4656).APIError(closure_131_15);
                firstFieldErrorMessage2 = aPIError1.getFirstFieldErrorMessage("banner");
                if (null != firstFieldErrorMessage2) {
                  const result9 = pendingChanges(14875).showGenericProfileUpdateFailureToast(firstFieldErrorMessage2);
                  closure_131_4 = true;
                  const obj2 = pendingChanges(14875);
                }
              }
            ...
            if (!tmp140) {
              ...
              const result10 = pendingChanges(14875).showGenericProfileUpdateFailureToast(intl.string(pendingChanges(1115).t["84MExs"]));
              const obj29 = pendingChanges(14875);
            }
            c7 = 3;
          ...
          c6 = 5;
          c7 = 1;
          const obj39 = { value: pendingChanges(8465).fetchBadgeDirectory(), done: false };
          return obj39;
        }
        ...
        if (Object.keys(primaryGuildChangesForUpdateRequest).length > 0) {
          ...
          if (undefined !== primaryGuildId) {
            c6 = 8;
            c7 = 1;
            const obj41 = { value: pendingChanges(14177).adoptGuildIdentity(primaryGuildId, null !== primaryGuildId), done: false };
            return obj41;
          }
        }
      } catch (tmp192) {
  ...
  return {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (stateFromStores) {
                ...
                dependencyMap = 1;
                c3 = 1;
                const obj6 = { value: tmp5(7224).saveProfileAndAccountChanges(obj5), done: false };
                return obj6;
              }
            }
          } else if (arg0 === 1) {
            ...
            if (ok) {
              const result = tmp5(7224).resetPendingAccountChanges();
              const obj = tmp5(7224);
            }
          }
          c3 = 3;
    ...
    resetPending: pendingChanges(7224).resetAllPending
  };
};
