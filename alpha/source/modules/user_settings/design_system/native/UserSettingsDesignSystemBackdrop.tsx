...
// Dependencies: [32, 19, 17, 21, 4722, 5777, 5142, 4718, 5144, 4458, 5143, 5147, 5125, 5130, 2]
// Exports: default

// Module 16025 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  let obj = showBackdrop(4458);
  fn.__closure = { withSpring: showBackdrop(5143).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5147).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5142).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5130).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4718).Text, obj9);
    obj7.children = tmp13(tmp8(5777).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5125).Dialog, obj5);
  }
