...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  let obj = showBackdrop(4492);
  fn.__closure = { withSpring: showBackdrop(5185).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5189).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5184).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5172).Backdrop, obj6), ];
