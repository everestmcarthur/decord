...
// Dependencies: [32, 19, 17, 1074, 21, 4756, 7437, 7389, 9802, 7438, 5184, 6843, 7439, 4723, 5186, 1115, 10487, 6048, 5819, 4752, 2]
// Exports: default

// Module 16107 (UserSettingsDesignSystemSheets)
...
function DemoActionSheet() {
  ...
  if (first) {
    ...
    tmp14Result = tmp14(tmp15(9802).ActionSheetHeaderPressableText, obj2);
  }
  obj.leading = tmp14Result;
  let tmp14Result2 = tmp2;
  if (tmp2) {
    const obj3 = { onPress: NOOP };
    tmp14Result2 = tmp14(tmp15(7438).ActionSheetCloseButton, obj3);
  }
