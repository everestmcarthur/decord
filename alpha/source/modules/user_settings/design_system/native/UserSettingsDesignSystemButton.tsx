...
// Dependencies: [32, 19, 17, 1074, 1229, 21, 15989, 5144, 15990, 8140, 7577, 10135, 14382, 8168, 14384, 9298, 14383, 9366, 4722, 576, 1484, 4689, 15991, 1897, 5142, 4718, 10895, 10125, 10131, 10133, 10132, 10130, 10129, 5603, 4432, 1092, 5156, 5777, 5294, 9151, 2]
// Exports: default

// Module 15988 (UserSettingsDesignSystemButton)
...
import _modDef10131 from "module_10131" /* 10131 */;
...
import useDesignSystemSettingsStateDefault from "useDesignSystemSettingsState" /* 15989 */;
import _modDef15990 from "module_15990" /* 15990 */;
...
function ExampleCustomIconToggleButton() {
  ...
  obj2.on = { variant: "destructive", accessibilityLabel: "Mute", icon: _modDef9366 };
  const obj3 = { variant: "destructive", accessibilityLabel: "Mute", icon: _modDef9366 };
  obj2.off = { variant: "secondary", accessibilityLabel: "Mute", icon: _modDef9366 };
...
export default function UserSettingsDesignSystemButton() {
  ...
  navigation.setOptions({
    headerRight() {
      return closure_2_10(IconButton.IconButton, { onPress, icon: _modDef7577, size: "sm", variant: "secondary", accessibilityLabel: "Settings" });
    }
  });
  ...
  obj25.icon = closure_10(require("components/Button/Button").Button.Icon, { source: _modDef10895 });
  ...
  const obj26 = { source: _modDef10895 };
  obj28.icon = closure_10(require("components/Button/Button").Button.Icon, { variant: "entity", source: _modDef10125 });
  ...
  const obj29 = { variant: "entity", source: _modDef10125 };
  ...
  obj59.children = closure_10(ExampleImageButton, { image: _modDef10131, label: "Telegram" });
  const items24 = [closure_10(closure_5, obj59), , ];
  const obj61 = { style: null, children: null };
  const items25 = [tmp.buttonContainer];
  obj61.style = items25;
  const obj60 = { image: _modDef10131, label: "Telegram" };
  obj61.children = closure_10(ExampleImageButton, { image: _modDef10133, label: "WhatsApp" });
  items24[1] = closure_10(closure_5, obj61);
  const obj63 = { style: null, children: null };
  const items26 = [tmp.buttonContainer];
  obj63.style = items26;
  const obj62 = { image: _modDef10133, label: "WhatsApp" };
  obj63.children = closure_10(ExampleImageButton, { image: _modDef10132, label: "Twitter" });
  ...
  const obj64 = { image: _modDef10132, label: "Twitter" };
  ...
  const items31 = [closure_10(ExampleImageButton, { image: _modDef10130, label: "Label", showLabel: true }), , ];
  const obj78 = { image: _modDef10130, label: "Label", showLabel: true };
  items31[1] = closure_10(ExampleImageButton, { image: _modDef10125, label: "Label", showLabel: true });
  const obj79 = { image: _modDef10125, label: "Label", showLabel: true };
  items31[2] = closure_10(ExampleImageButton, { image: _modDef10129, label: "Label", showLabel: true });
  ...
  const obj80 = { image: _modDef10129, label: "Label", showLabel: true };
  const items32 = [closure_10(ExampleImageButton, { image: _modDef10131, label: "Supercalifragilisticexpialidocious", showLabel: true }), , ];
  const obj83 = { image: _modDef10131, label: "Supercalifragilisticexpialidocious", showLabel: true };
  items32[1] = closure_10(ExampleImageButton, { image: _modDef10133, label: "Supercalifragilisticexpialidocious", showLabel: true });
  const obj84 = { image: _modDef10133, label: "Supercalifragilisticexpialidocious", showLabel: true };
  items32[2] = closure_10(ExampleImageButton, { image: _modDef10132, label: "Supercalifragilisticexpialidocious", showLabel: true });
  ...
  const obj85 = { image: _modDef10132, label: "Supercalifragilisticexpialidocious", showLabel: true };
