...
// Dependencies: [32, 19, 17, 1074, 1229, 21, 16065, 5186, 16066, 8178, 7621, 10145, 14437, 8206, 14439, 10410, 14438, 9947, 4756, 576, 1484, 4723, 16067, 1980, 5184, 4752, 10911, 10135, 10141, 10143, 10142, 10140, 10139, 5645, 4466, 1092, 5198, 5819, 5336, 9190, 2]
// Exports: default

// Module 16064 (UserSettingsDesignSystemButton)
...
import _modDef10141 from "module_10141" /* 10141 */;
import _modDef10142 from "module_10142" /* 10142 */;
import _modDef10143 from "module_10143" /* 10143 */;
import ImageButton from "ImageButton" /* 10145 */;
import _modDef10410 from "module_10410" /* 10410 */;
import _modDef10911 from "module_10911" /* 10911 */;
import ToggleButton from "ToggleButton" /* 14437 */;
import useToggleButtonProps from "useToggleButtonProps" /* 14438 */;
import ToggleIconButton from "ToggleIconButton" /* 14439 */;
import useDesignSystemSettingsStateDefault from "useDesignSystemSettingsState" /* 16065 */;
import _modDef16066 from "module_16066" /* 16066 */;
...
function ExampleCustomIconToggleButton() {
  ...
  obj2.on = { variant: "destructive", accessibilityLabel: "Mute", icon: _modDef9947 };
  const obj3 = { variant: "destructive", accessibilityLabel: "Mute", icon: _modDef9947 };
  obj2.off = { variant: "secondary", accessibilityLabel: "Mute", icon: _modDef9947 };
...
export default function UserSettingsDesignSystemButton() {
  ...
  navigation.setOptions({
    headerRight() {
      return closure_2_10(IconButton.IconButton, { onPress, icon: _modDef7621, size: "sm", variant: "secondary", accessibilityLabel: "Settings" });
    }
  });
  ...
  obj25.icon = closure_10(require("components/Button/Button").Button.Icon, { source: _modDef10911 });
  ...
  const obj26 = { source: _modDef10911 };
  obj28.icon = closure_10(require("components/Button/Button").Button.Icon, { variant: "entity", source: _modDef10135 });
  ...
  const obj29 = { variant: "entity", source: _modDef10135 };
  ...
  obj59.children = closure_10(ExampleImageButton, { image: _modDef10141, label: "Telegram" });
  const items24 = [closure_10(closure_5, obj59), , ];
  const obj61 = { style: null, children: null };
  const items25 = [tmp.buttonContainer];
  obj61.style = items25;
  const obj60 = { image: _modDef10141, label: "Telegram" };
  obj61.children = closure_10(ExampleImageButton, { image: _modDef10143, label: "WhatsApp" });
  items24[1] = closure_10(closure_5, obj61);
  const obj63 = { style: null, children: null };
  const items26 = [tmp.buttonContainer];
  obj63.style = items26;
  const obj62 = { image: _modDef10143, label: "WhatsApp" };
  obj63.children = closure_10(ExampleImageButton, { image: _modDef10142, label: "Twitter" });
  ...
  const obj64 = { image: _modDef10142, label: "Twitter" };
  ...
  const items31 = [closure_10(ExampleImageButton, { image: _modDef10140, label: "Label", showLabel: true }), , ];
  const obj78 = { image: _modDef10140, label: "Label", showLabel: true };
  items31[1] = closure_10(ExampleImageButton, { image: _modDef10135, label: "Label", showLabel: true });
  const obj79 = { image: _modDef10135, label: "Label", showLabel: true };
  items31[2] = closure_10(ExampleImageButton, { image: _modDef10139, label: "Label", showLabel: true });
  ...
  const obj80 = { image: _modDef10139, label: "Label", showLabel: true };
  const items32 = [closure_10(ExampleImageButton, { image: _modDef10141, label: "Supercalifragilisticexpialidocious", showLabel: true }), , ];
  const obj83 = { image: _modDef10141, label: "Supercalifragilisticexpialidocious", showLabel: true };
  items32[1] = closure_10(ExampleImageButton, { image: _modDef10143, label: "Supercalifragilisticexpialidocious", showLabel: true });
  const obj84 = { image: _modDef10143, label: "Supercalifragilisticexpialidocious", showLabel: true };
  items32[2] = closure_10(ExampleImageButton, { image: _modDef10142, label: "Supercalifragilisticexpialidocious", showLabel: true });
  ...
  const obj85 = { image: _modDef10142, label: "Supercalifragilisticexpialidocious", showLabel: true };
