...
// Dependencies: [21, 11781, 1115, 12849, 10054, 5114, 2]
// Exports: default

// Module 12848 (UserSettingsAuthedAppDeleteWarningModal)
import util from "util" /* 1115 */;
import AlertModal from "AlertModal" /* 5114 */;
import isSocialLayerApplication from "isSocialLayerApplication" /* 11781 */;
import shouldWarnAuthorizedAppTwoWayDefault from "shouldWarnAuthorizedAppTwoWay" /* 12849 */;
...
export default function UserSettingsAuthedAppDeleteWarningModal(application) {
  ...
  if (tmp9) {
    ...
    tmp9 = React3(tmp8(10054), obj5);
    const tmp8Result = tmp8(10054);
  }
  const items = [tmp9, ];
  let tmp12 = result;
  if (result) {
    const obj7 = { look: tmp(10054).InfoBoxLooks.WARNING, children: null };
    const intl4 = tmp(1115).intl;
    obj7.children = intl4.string(tmp(1115).t.LY35Zy);
    tmp12 = React3(tmp8(10054), obj7);
    const tmp8Result2 = tmp8(10054);
  }
  items[1] = tmp12;
