...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 4756, 576, 5653, 4690, 4607, 1177, 13735, 13736, 4752, 1115, 5198, 9477, 4414, 13737, 13738, 5799, 13739, 13740, 13741, 13742, 13743, 2]
// Exports: default

// Module 13734 (PremiumFeaturesTable)
...
function CheckIcon() {
  ...
  return closure_1_11(native.Icon, { source: _modDef13735, color: shared.isThemeDark(tmp3) ? unsafe_rawColors.WHITE : unsafe_rawColors.PRIMARY_860, size: native.IconSizes.SMALL });
}
function CloseIcon() {
