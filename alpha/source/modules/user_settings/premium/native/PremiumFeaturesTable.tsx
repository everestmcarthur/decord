...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 4722, 576, 5611, 4656, 4573, 1177, 13680, 13681, 4718, 1115, 5156, 9602, 4380, 13682, 13683, 5757, 13684, 13685, 13686, 13687, 13688, 2]
// Exports: default

// Module 13679 (PremiumFeaturesTable)
...
function CheckIcon() {
  ...
  return closure_1_11(native.Icon, { source: _modDef13680, color: shared.isThemeDark(tmp3) ? unsafe_rawColors.WHITE : unsafe_rawColors.PRIMARY_860, size: native.IconSizes.SMALL });
}
function CloseIcon() {
  const tmp = closure_16();
  return closure_1_11(native.Icon, { source: _modDef13681, style: closure_16().icon, size: native.IconSizes.SMALL });
}
...
obj2.themedHighlightedCell = { backgroundColor: fn(5611).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
...
let obj7 = { icon: null };
let obj5 = { backgroundColor: fn(5611).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
