...
// Dependencies: [32, 19, 17, 1074, 7672, 1374, 21, 576, 4756, 5198, 1094, 4752, 5799, 1115, 13730, 13731, 13732, 13733, 5171, 1609, 11018, 1177, 7402, 1478, 1241, 2]
// Exports: default
...
function PremiumFeaturesCarousel(arg0) {
  ...
  const isScreenReaderEnabled = onEndReached(5171).useIsScreenReaderEnabled();
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  const items2 = [closure_10(analyticsLocations(4752).Text, obj3), closure_10(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
