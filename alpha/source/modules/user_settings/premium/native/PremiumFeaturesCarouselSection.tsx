...
// Dependencies: [32, 19, 17, 1074, 7628, 1374, 21, 576, 4722, 5156, 1094, 4718, 5757, 1115, 13675, 13676, 13677, 13678, 5129, 1609, 11005, 1177, 7358, 1478, 1241, 2]
// Exports: default

// Module 13674 (PremiumFeaturesCarouselSection)
...
function PremiumFeaturesCarousel(arg0) {
  ...
  const isScreenReaderEnabled = onEndReached(5129).useIsScreenReaderEnabled();
  ...
  if (!onEndReached(1609).isThumbstickScrollDevice) {
    if (!isScreenReaderEnabled) {
      ...
      let tmp19 = closure_10(currentIndex(11005), obj3);
    }
    let items3 = [tmp19, ];
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  const tmp = closure_14();
  const analyticsLocations = first(7358)().analyticsLocations;
  ...
  const items2 = [closure_10(analyticsLocations(4718).Text, obj3), closure_10(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
