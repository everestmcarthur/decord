...
// Dependencies: [32, 19, 17, 8460, 21, 4756, 576, 11003, 7402, 7422, 504, 8452, 4752, 1115, 2578, 11008, 5186, 11297, 10920, 13830, 11418, 2]
// Exports: default

// Module 13829 (UserSettingsGiftingBadgeProgress)
...
function GiftingBadgeIntro(analyticsLocation) {
  ...
  importDefault = tmp;
  dependencyMap = analyticsLocation(11003).useIsGiftingBadgeComplexArtEnabled(UserSettingsGiftingBadgeProgress);
  let obj = analyticsLocation(11003);
  ...
  if (null != stateFromStores) {
    ...
    obj4.children = closure_9(tmp2(4752).Text, obj5);
...
let closure_8 = fn(8460).getSingleRequirementThreshold;
const jsxProd = fn(21);
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  const isGiftingBadgeComplexArtEnabled = analyticsLocation(11003).useIsGiftingBadgeComplexArtEnabled(UserSettingsGiftingBadgeProgress);
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(11003).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
    const tmp7Result = tmp7(11003);
    let giftingBadgeTierIconUrl = tmp7(11003).getGiftingBadgeTierIconUrl(currentTier, isGiftingBadgeComplexArtEnabled);
    const tmp7Result3 = tmp7(11003);
    const giftingBadgeTierIconUrl1 = tmp7(11003).getGiftingBadgeTierIconUrl(nextTier, isGiftingBadgeComplexArtEnabled);
    if (null != nextTier) {
    ...
    obj16.children = closure_9(tmp7(4752).Text, obj18);
    ...
    obj19.icon = closure_9(tmp7(11297).GiftIcon, obj20);
    const intl4 = tmp7(1115).intl;
    obj19.text = intl4.string(tmp4(2578).DZnomS);
    obj19.onPress = function onPress() {
      utils_openGiftModal.openGiftModal({ analyticsLocation, analyticsLocations });
    };
    items5[1] = closure_9(tmp7(5186).Button, obj19);
    ...
    const items6 = [closure_9(tmp7(4752).Text, obj23), ];
    if (tmp11Result) {
      let ChevronSmallDownIcon = tmp7(13830).ChevronSmallUpIcon;
    } else {
      ChevronSmallDownIcon = tmp7(11418).ChevronSmallDownIcon;
    }
    ...
    if (tmp11Result) {
      ...
      items7[1] = tmp15(tmp7(4752).Text, obj27);
  ...
  let obj2 = analyticsLocation(11003);
};
