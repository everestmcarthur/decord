...
// Function ID: 15027
// Name: IgnoredUserRow
// Dependencies: [19, 1372, 21, 9280, 7358, 5775, 1177, 1115, 8409, 5144, 504, 2]
// Exports: default

// Module 15026 (IgnoredUserRow)
...
function IgnoredUserRow(userRecord) {
  ...
  obj.trailing = jsx(userRecord(5144).Button, { size: "sm", variant: "secondary", text: null, onPress: null });
  return jsx(userRecord(5775).TableRow, { icon: jsx(userRecord(1177).Avatar, { source: userRecord.getAvatarSource(undefined), size: userRecord(1177).AvatarSizes.REFRESH_MEDIUM_32 }), label: null, subLabel: null, labelLineClamp: 1, subLabelLineClamp: 1, accessibilityRole: "button", accessibilityActions: null, onAccessibilityAction: null, onPress: null, trailing: null });
}
const jsx = fn(21).jsx;
const size = fn(2);
