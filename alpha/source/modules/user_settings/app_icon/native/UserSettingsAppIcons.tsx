...
// Dependencies: [5, 19, 17, 1372, 1074, 9561, 21, 4722, 504, 13659, 1886, 7358, 9562, 9551, 8831, 15741, 10214, 9630, 9600, 1115, 2]

// Module 15740 (UserSettingsAppIcons)
...
import AppIconRowsDefault from "AppIconRows" /* 15741 */;
          ...
          if (arg0 === 1) {
            ...
            if (null != tmp24) {
              ...
              if (id === tmp22) {
                ...
                dependencyMap = 2;
                v3 = 1;
                const obj9 = { value: stateFromStores(13659).setAppIcon(stateFromStores(9562).FreemiumAppIconIds.DEFAULT, premiumType1), done: false };
                return obj9;
              }
            }
