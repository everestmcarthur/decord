...
// Dependencies: [5, 19, 17, 1372, 1074, 9436, 21, 4756, 504, 13714, 1969, 7402, 9437, 9426, 8870, 15796, 10226, 9505, 9475, 1115, 2]

// Module 15795 (UserSettingsAppIcons)
...
import AppIconRowsDefault from "AppIconRows" /* 15796 */;
...
export default noop.memo(() => {
          ...
          if (arg0 === 1) {
            ...
            if (null != tmp24) {
              ...
              if (id === tmp22) {
                if (importDefault !== id) {
                  if (tmp26) {
                    if (!closure_2_2) {
                      ...
                      const result = v3(9426).handleShowUpsellAlert(obj6);
                      const obj5 = v3(9426);
                    }
                  }
                  let premiumType;
                  ...
                  dependencyMap = 1;
                  v3 = 1;
                  const obj8 = { value: stateFromStores(13714).setAppIcon(id, premiumType), done: false };
                  return obj8;
                }
              } else {
                let premiumType1;
                ...
                dependencyMap = 2;
                v3 = 1;
                const obj9 = { value: stateFromStores(13714).setAppIcon(stateFromStores(9437).FreemiumAppIconIds.DEFAULT, premiumType1), done: false };
                return obj9;
              }
            }
  ...
  importDefault = stateFromStores(13714).useCurrentAppIcon();
  let obj2 = stateFromStores(13714);
  ...
  const children = [closure_9(stateFromStores(8870).Form, obj5), ];
