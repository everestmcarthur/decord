...
// Dependencies: [19, 8232, 1074, 14949, 1115, 1177, 15067, 11723, 14950, 14948, 2]

// Module 15066 (AccountViewBackupCodesSetting)
...
const route = SettingBuilders.createRoute({
  ...
  usePredicate: fn(14950).useIs2FAEnabled,
