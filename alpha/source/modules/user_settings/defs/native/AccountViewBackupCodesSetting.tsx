...
// Dependencies: [19, 8194, 1074, 14895, 1115, 1177, 15013, 11714, 14896, 14894, 2]

// Module 15012 (AccountViewBackupCodesSetting)
...
const route = SettingBuilders.createRoute({
  ...
  usePredicate: fn(14896).useIs2FAEnabled,
