...
// Dependencies: [19, 15529, 1084, 8232, 21, 1248, 15578, 11468, 1115, 11723, 1364, 2]

// Module 15577 (AndroidFontScaleSetting)
...
require = fn;
const useFontScaleStore = fn(15529).useFontScaleStore;
