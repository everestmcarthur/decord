...
// Dependencies: [19, 8194, 1186, 1115, 1936, 16152, 15069, 4689, 16153, 1897, 11714, 2]

// Module 16151 (ActivityPrivacyDefaultSharingSetting)
import util from "util" /* 1115 */;
import preloaded_user_settings from "preloaded_user_settings" /* 1186 */;
import UserSettings from "UserSettings" /* 1936 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4689 */;
import ActivityPrivacyMatchingExperiment from "ActivityPrivacyMatchingExperiment" /* 16152 */;
...
const radio = SettingBuilders.createRadio({
  ...
  onValueChange(arg0) {
    ...
    if (obj.getIsInActivityPrivacyUpsellExperiment("ActivityPrivacyDefaultSharingSetting")) {
      const affectedGuilds = tmp2(15069).computeAffectedGuilds(setting, NumberResult);
      if (null != affectedGuilds) {
        const activityRestrictionSettingName = tmp2(15069).getActivityRestrictionSettingName(NumberResult);
        const tmp2Result2 = tmp2(15069);
        ...
        ActionSheetActionCreatorsDefault.openLazy(tmp2(1897)(16153, dependencyMap.paths), "ActivityPrivacyUpsellActionSheet", obj2);
      }
      const tmp2Result = tmp2(15069);
    }
  }
});
const size = fn(2);
