...
// Dependencies: [19, 8232, 1186, 1115, 2019, 16228, 15123, 4723, 16229, 1980, 11723, 2]
...
const radio = SettingBuilders.createRadio({
  ...
  onValueChange(arg0) {
    ...
    if (obj.getIsInActivityPrivacyUpsellExperiment("ActivityPrivacyDefaultSharingSetting")) {
      const affectedGuilds = tmp2(15123).computeAffectedGuilds(setting, NumberResult);
      if (null != affectedGuilds) {
        const activityRestrictionSettingName = tmp2(15123).getActivityRestrictionSettingName(NumberResult);
        const tmp2Result2 = tmp2(15123);
        ...
        ActionSheetActionCreatorsDefault.openLazy(tmp2(1980)(16229, dependencyMap.paths), "ActivityPrivacyUpsellActionSheet", obj2);
      }
