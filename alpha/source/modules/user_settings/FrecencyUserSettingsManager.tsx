...
// Dependencies: [5, 9405, 9404, 5671, 5224, 5713, 5721, 1220, 1084, 1349, 1091, 7358, 2024, 1221, 1222, 12, 2]

// Module 17761 (FrecencyUserSettingsManager)
...
const MAX_NUM_SELECTED_ITEMS = fn(5721).MAX_NUM_SELECTED_ITEMS;
