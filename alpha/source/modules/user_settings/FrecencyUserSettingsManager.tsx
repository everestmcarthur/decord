...
// Dependencies: [5, 9530, 9529, 5629, 5182, 5671, 5679, 1220, 1084, 1349, 1091, 7314, 1941, 1221, 1222, 12, 2]

// Module 17681 (FrecencyUserSettingsManager)
...
const MAX_NUM_SELECTED_ITEMS = fn(5679).MAX_NUM_SELECTED_ITEMS;
