...
// Dependencies: [4959, 9384, 1980, 2]

// Module 9383 (CrunchyrollLinkModalActionCreators)
...
export default {
  showModal(locationStack) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9384, dependencyMap.paths), { locationStack }, c3);
  },
  hideModal() {
