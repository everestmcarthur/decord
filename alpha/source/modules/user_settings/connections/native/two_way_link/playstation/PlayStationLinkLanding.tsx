...
// Dependencies: [19, 9374, 1074, 21, 4756, 1115, 5312, 9347, 1484, 2108, 9376, 9349, 2]
// Exports: PlayStationLinkLanding

// Module 9375 (PlayStationLinkLanding)
...
export const PlayStationLinkLanding = function PlayStationLinkLanding(platformType) {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj2.icon = navigation(9347).GameControllerIcon;
    items[1] = obj2;
    return items;
  }, []);
  ...
  const memo1 = noop.useMemo(() => ({ uri: _modDef9376 }), []);
  ...
  return jsx(navigation(9349).TwoWayLinkLanding, { platformType: platformType.platformType, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
};
