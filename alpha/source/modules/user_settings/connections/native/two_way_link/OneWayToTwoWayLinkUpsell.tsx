...
// Dependencies: [19, 17, 1074, 1955, 21, 4722, 576, 5694, 1177, 10868, 4718, 5144, 1115, 2]
// Exports: OneWayToTwoWayLinkUpsell

// Module 15184 (OneWayToTwoWayLinkUpsell)
...
export const OneWayToTwoWayLinkUpsell = function OneWayToTwoWayLinkUpsell(newIndicatorDismissibleContent) {
  ...
  const items1 = [closure_6(SelectedDismissibleContentDefault, obj4), closure_6(newIndicatorDismissibleContent(4718).Text, { style: tmp.title, variant: "text-md/semibold", children: title })];
  obj3.children = items1;
  const items2 = [closure_7(View, obj3), img];
  obj2.children = items2;
  const items3 = [closure_7(View, obj2), closure_6(newIndicatorDismissibleContent(4718).Text, { style: tmp.body, variant: "text-sm/medium", children: body }), ];
