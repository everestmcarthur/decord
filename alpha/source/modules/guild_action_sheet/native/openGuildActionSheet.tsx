...
// Dependencies: [1074, 2066, 1241, 10551, 4723, 14171, 1980, 14229, 14235, 2]
// Exports: default

// Module 14170 (openGuildActionSheet)
...
export default function openGuildActionSheet(id) {
  ...
  if (!obj.isFavoritesGuildId(id.id)) {
    ...
    if (tmpResult.shouldNSFWGateGuild(id.id)) {
      const obj4 = { guild: id };
      tmp3(4723).openLazy(tmp(1980)(14171, tmp2.paths), "NsfwGateGuildSettingsActionSheet", obj4);
      ...
      if (hasItem) {
        ...
        openLazy(tmpResult2(14229, tmp2.paths), "GuildActionSheet:" + id.id, obj5);
        const tmpResult1Result = tmpResult2(14229, tmp2.paths);
      } else {
        const _HermesInternal = HermesInternal;
        const obj6 = { guild: id, expanded: flag };
        openLazy(tmpResult2(14235, tmp2.paths), "GuildActionSheet:" + id.id, obj6);
        const tmpResult1Result1 = tmpResult2(14235, tmp2.paths);
      }
