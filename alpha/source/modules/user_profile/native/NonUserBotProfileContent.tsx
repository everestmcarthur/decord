...
// Dependencies: [19, 17, 7448, 7391, 21, 8509, 8458, 4908, 4600, 8510, 8498, 8511, 1612, 8495, 8506, 7429, 4453, 8512, 4492, 8524, 11417, 1115, 11471, 2]

// Module 8508 (NonUserBotProfileContent)
import ToastUtils from "ToastUtils" /* 4453 */;
import UserUtilsDefault from "UserUtils" /* 4600 */;
import NicknameUtilsDefault from "NicknameUtils" /* 4908 */;
import ClipboardUtils from "ClipboardUtils" /* 7429 */;
import useProfileThemeDefault from "useProfileTheme" /* 8495 */;
...
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 8511 */;
...
export default noop.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  trackUserProfileAction = trackUserProfileAction(8458).useUserProfileAnalyticsContext().trackUserProfileAction;
  let obj = trackUserProfileAction(8458);
  let guild_id;
  if (channel != null) {
  ...
  const userProfileColors = trackUserProfileAction(8506).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null == user) {
    ...
    const items = [closure_7(tmp(8512), obj3), ];
    ...
    const items1 = [closure_7(tmp4(8524).OpenableUserProfileAvatar, obj5), ];
    ...
    obj8.children = closure_7(tmp(11417), obj9);
    ...
    items4[1] = obj13;
    obj12.style = items4;
    obj11.children = closure_7(tmp(11471), obj12);
  ...
  const tmp4Result = trackUserProfileAction(8506);
});
