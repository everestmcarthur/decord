...
// Dependencies: [19, 17, 2026, 2022, 1980, 7404, 1074, 1483, 21, 4722, 4423, 576, 4718, 1115, 11460, 504, 5577, 11, 11066, 5754, 11461, 1177, 8602, 7358, 8420, 11462, 4689, 4580, 1101, 7234, 4588, 1610, 8409, 11463, 5144, 7403, 2]
// Exports: default

// Module 11459 (UserProfileAboutMeCard)
...
import BioTextDefault from "BioText" /* 11460 */;
import useFriendsSinceDate from "useFriendsSinceDate" /* 11461 */;
import UserProfileAboutMeCardCommandDefault from "UserProfileAboutMeCardCommand" /* 11463 */;
import noop from "module_19" /* 19 */;
import LocaleStore from "LocaleStore" /* 2026 */;
import GuildMemberStore from "GuildMemberStore" /* 2022 */;
import GuildStore from "GuildStore" /* 1980 */;

const GuildIconDefault = tmp9(5754);
require = fn;
...
function MemberJoinDates(userId) {
  ...
  const createdAtDate1 = userId(5577).getCreatedAtDate(joinedAt, stateFromStores);
  ...
  obj8.style = items4;
  const obj9 = { themeType, icon: closure_11(userId(11066).ClydeIcon, { size: "xs" }), accessibilityLabel: null, children: null };
  ...
  if (tmp13Result) {
    ...
    const items6 = [tmp15(tmp4(4718).Text, obj11), ];
    const obj12 = { themeType, icon: null, accessibilityLabel: null, children: null };
    const obj13 = { guild: stateFromStores1, size: tmp4(5754).GuildIconSizes.XXSMALL };
...
function FriendsSinceDate(themeType) {
  ...
  if (null != friendsSinceDate) {
    ...
    items[1] = closure_1_11(tmp3(4718).Text, obj4);
    obj2.children = items;
