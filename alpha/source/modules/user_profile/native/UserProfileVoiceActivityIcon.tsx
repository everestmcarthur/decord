...
// Dependencies: [19, 4395, 1085, 21, 504, 8123, 5273, 5307, 5308, 5310, 5309, 5312, 2]
// Exports: default

// Module 11154 (UserProfileVoiceActivityIcon)
  ...
  if (!channel.isDM()) {
    if (!channel.isGroupDM()) {
      ...
      if (isGuildStageVoiceResult) {
        ...
        tmp8Result = tmp8(tmp2(5310).VoiceWarningIcon, obj4);
      } else {
        if (tmp6) {
