...
// Dependencies: [19, 1074, 21, 4722, 576, 4718, 4588, 11464, 1241, 4902, 4689, 11469, 7717, 7719, 2]
      ...
      obj2.onSetCommand = function onSetCommand() {
        ...
        if (bestActiveInput != null) {
          ...
          if (applicationCommandManager != null) {
            ...
            if (null != tmp3) {
              applicationCommandSection = tmp7(7717).getApplicationCommandSection(tmp3);
              const tmp7Result = tmp7(7717);
            }
            obj4.section = applicationCommandSection;
            obj4.location = tmp7(7719).ApplicationCommandTriggerLocations.POPULAR_COMMANDS;
