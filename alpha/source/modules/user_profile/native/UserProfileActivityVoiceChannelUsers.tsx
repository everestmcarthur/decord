...
// Dependencies: [19, 4796, 21, 8484, 504, 5817, 4908, 1177, 11416, 1115, 2]
// Exports: default

// Module 13317 (UserProfileActivityVoiceChannelUsers)
import util from "util" /* 1115 */;
import NicknameUtilsDefault from "NicknameUtils" /* 4908 */;
import UserProfileStackedActionSheet from "UserProfileStackedActionSheet" /* 11416 */;
...
function UserRow(user) {
  ...
  const avatarDecoration = user(8484).useAvatarDecoration(user, channel.guild_id);
  const obj = user(8484);
  ...
  obj3.start = start;
  obj3.end = end;
  return jsx(user(5817).TableRow, { onPress, label: null, icon: null, start: null, end: null });
}
const jsx = fn(21).jsx;
const size = fn(2);
