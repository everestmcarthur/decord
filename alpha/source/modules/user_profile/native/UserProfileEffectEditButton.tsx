...
// Dependencies: [19, 17, 7448, 9078, 1085, 21, 4756, 576, 8434, 11309, 4723, 14897, 1980, 1115, 14888, 5789, 5799, 11278, 9081, 1177, 13474, 2]
// Exports: default

// Module 14896 (UserProfileEffectEditButton)
...
export default function UserProfileEffectEditButton(isTryItOut) {
  ...
  const callback = userProfileEffect.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14897, dependencyMap.paths), "Profile Effect", { user, currentProfileEffect: userProfileEffect, guildId, isTryItOut });
  }, items);
  if (product != null) {
    name = product.name;
  }
