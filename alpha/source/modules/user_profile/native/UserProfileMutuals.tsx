...
// Dependencies: [19, 17, 8451, 7448, 21, 4756, 8458, 12853, 13285, 4723, 12859, 1980, 8447, 7582, 5334, 13318, 1177, 4752, 12860, 12869, 5796, 12854, 2]
// Exports: default

// Module 13422 (UserProfileMutuals)
...
const DIVIDER_DOT = fn(7448).DIVIDER_DOT;
const jsxProd = fn(21);
...
export default function UserProfileMutuals(user) {
  ...
  const userProfileAnalyticsContext = user(8458).useUserProfileAnalyticsContext();
  ({ context: c2, trackUserProfileAction: c3 } = userProfileAnalyticsContext);
  let obj = user(8458);
  ({ mutualFriends, mutualGuilds } = guildId(12853)(user));
  if (guildId(13285)(user)) {
    ...
    if (tmp7) {
      ...
      const obj3 = {
        ...
        onPress() {
              ...
              ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12859, dependencyMap.paths), "UserProfileMutualsActionSheet", {
                user,
                ...
                onPressMutualGuild(arg0) {
                  ...
                  const obj = user(7582);
                  guildId(4723).hideAllActionSheets();
                }
              }, "stack");
            },
        children: null
      ...
      const items = [closure_6(tmp2(13318).AvatarPile, obj4), ];
      const obj5 = { variant, color, children: tmp5(12860)(mutualFriends.length) };
      items[1] = closure_6(tmp2(4752).Text, obj5);
      obj3.children = items;
      tmp9Result = tmp9(tmp2(5334).PressableOpacity, obj3);
    }
    ...
    if (tmp15) {
      ...
      tmp15 = closure_6(tmp2(4752).Text, obj6);
    }
    items1[1] = tmp15;
    ...
    if (tmp8) {
      ...
      if (!tmp7) {
        ...
        tmp21 = closure_6(tmp2(12869).GuildIconPile, obj8);
      }
      const items2 = [tmp21, ];
      const obj9 = { variant, color, children: tmp5(12854)(mutualGuilds.length) };
      items2[1] = closure_6(tmp2(4752).Text, obj9);
      obj7.children = items2;
      tmp9Result2 = tmp9(tmp2(5334).PressableOpacity, obj7);
    }
