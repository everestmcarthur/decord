...
// Dependencies: [19, 17, 2038, 21, 4756, 576, 8509, 10884, 2027, 4710, 4752, 1115, 5334, 5892, 2]
// Exports: default

// Module 13355 (UserProfileWidgetsBoardEditNotice)
...
export default function UserProfileWidgetsBoardEditNotice() {
  ...
  obj.children = function children(markAsDismissed) {
    ...
    if (markAsDismissed.visibleContent === dismissible_content.DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE) {
      ...
      obj2.children = hasOwnProperty(tmp(4710).CircleInformationIcon, obj3);
      ...
      items1[1] = hasOwnProperty(tmp(4752).Text, obj4);
      ...
      obj5.children = hasOwnProperty(tmp(5892).XSmallIcon, { size: "sm" });
      items1[2] = hasOwnProperty(tmp(5334).PressableOpacity, obj5);
      obj.children = items1;
