...
// Dependencies: [32, 19, 17, 8422, 9017, 1980, 4371, 1372, 8390, 7817, 8413, 7404, 1074, 7347, 1955, 21, 8471, 504, 4689, 11402, 1897, 11369, 11365, 8420, 7358, 9280, 4566, 8140, 13307, 1115, 12862, 13308, 4660, 8472, 4874, 7385, 4419, 11405, 9445, 13242, 5144, 10491, 576, 9746, 13310, 8905, 13311, 8460, 8473, 1612, 13309, 13317, 13318, 7507, 11403, 8399, 13319, 8457, 8468, 9016, 13320, 9270, 13321, 13322, 13323, 13324, 13325, 12869, 13326, 13244, 13331, 11459, 7381, 13294, 13332, 13297, 13337, 13343, 10037, 8486, 8474, 13349, 4458, 13350, 13366, 13367, 13372, 13373, 7352, 12856, 12858, 13378, 2]

// Module 13306 (UserProfileContent)
...
import closeVoicePanelsDefault from "closeVoicePanels" /* 9746 */;
...
import ProvisionalAccountExplainer from "ProvisionalAccountExplainer" /* 12869 */;
...
import UserProfilePrivateInfoBannerDefault from "UserProfilePrivateInfoBanner" /* 13325 */;
import UserProfileDismissibleUpsellsDefault from "UserProfileDismissibleUpsells" /* 13326 */;
...
import UserProfileIncomingFriendRequestDefault from "UserProfileIncomingFriendRequest" /* 13367 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import BadgeDirectoryStore from "BadgeDirectoryStore" /* 8422 */;
import WishlistStore from "WishlistStore" /* 9017 */;
...
function CustomStatusBubble(guildId) {
  ...
  const callback = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11402, dependencyMap.paths), "UserProfileCustomStatusActionSheet", { user, guildId, channelId }, "stack");
  }, items2);
...
function RemoveGameFriendIconButton(user) {
  ...
  const callback = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(13308, dependencyMap.paths), "UserProfileGameFriendActionSheet", { user, guildId, channelId }, "stack");
  }, items);
...
function EditSection(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    obj6.icon = tmp6(tmp4(10491).PencilIcon, obj7);
    ...
    tmp6Result = tmp6(tmp4(5144).Button, obj6);
  }
...
function UserProfileWidgetsBoardContainer(isCurrentUser) {
  ...
  if (isCurrentUser) {
    isCurrentUser = closure_1_20(tmp(13310), {});
  }
    ...
    if (null != user) {
      if (null != stateFromStores) {
        ...
        if (tmp18Result) {
          ...
          tmp18Result = tmp18(tmp19(13331), obj7);
        }
        ...
        if (tmp18Result4) {
          ...
          tmp18Result4 = tmp18(tmp19(7381), obj10);
        }
        ...
        if (tmp18Result5) {
          ...
          tmp18Result5 = tmp18(tmp19(13294), obj11);
        }
        ...
        if (!isPreviewingChanges) {
          ...
          tmp18Result6 = tmp18(tmp19(13297), obj25);
        }
