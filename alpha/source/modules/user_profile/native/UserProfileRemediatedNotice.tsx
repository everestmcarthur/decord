...
// Dependencies: [19, 17, 4371, 1074, 21, 4722, 576, 8471, 563, 4718, 1115, 9280, 2]
// Exports: default

// Module 13372 (UserProfileRemediatedNotice)
...
export default function RemediatedUserNotice(user) {
  ...
  if (isBlocked) {
    ...
    if (isBlocked) {
      ...
      isBlocked = closure_6(tmp4(4718).Text, obj3);
    }
    ...
    if (isIgnored) {
      ...
      const items3 = [closure_6(tmp4(4718).Text, obj5), closure_6(tmp4(4718).Text, { variant: "text-sm/semibold", color: "text-default", accessibilityElementsHidden: true, importantForAccessibility: "no", children: "\u2022" }), ];
