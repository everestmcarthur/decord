...
// Dependencies: [32, 19, 17, 4762, 8413, 21, 4722, 576, 8446, 504, 5775, 1177, 4874, 11124, 5754, 4718, 12844, 10037, 12851, 12852, 11404, 12845, 12846, 1115, 12856, 12858, 2]
// Exports: default

// Module 12850 (UserProfileMutualsActionSheet)
...
import UserProfileStackedActionSheetDefault from "UserProfileStackedActionSheet" /* 11404 */;
import useUserProfileMutualsDefault from "useUserProfileMutuals" /* 12844 */;
import getMutualGuildsLabelDefault from "getMutualGuildsLabel" /* 12845 */;
import getMutualFriendsLabelDefault from "getMutualFriendsLabel" /* 12851 */;
...
function MutualFriendRow(mutualFriend) {
  ...
  const avatarDecoration = user(8446).useAvatarDecoration(user);
  const obj = user(8446);
  ...
  const obj2 = user(504);
  obj3.icon = closure_9(user(1177).Avatar, { user, size: user(1177).AvatarSizes.REFRESH_MEDIUM_32, avatarDecoration, status, guildId, isMobileOnline, isVROnline, autoStatusCutout: true });
  const obj4 = { user, size: user(1177).AvatarSizes.REFRESH_MEDIUM_32, avatarDecoration, status, guildId, isMobileOnline, isVROnline, autoStatusCutout: true };
  ...
  obj3.start = start;
  obj3.end = end;
  return closure_9(user(5775).TableRow, obj3, user.id);
}
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  if (null == mutualFriends) {
    ...
    const obj6 = { style: tmp.emptyState, children: closure_9(tmp6(12852).NoMutualFriends, {}) };
    ...
    tmp10 = closure_9(tmp6(11404).UserProfileStackedActionSheetList, obj7);
  }
  obj4.page = tmp10;
  const items = [obj4, ];
  let length1;
  ...
  if (null == mutualGuilds) {
    ...
    const obj10 = { style: tmp.emptyState, children: tmp9(tmp6(12846).NoMutualServers, {}) };
    ...
    tmp9Result = tmp9(tmp6(11404).UserProfileStackedActionSheetList, obj11);
  }
  ...
  const items1 = [tmp9(closure_5, { children: tmp9(user(12856).Tabs, { state: segmentedControlState }) }), tmp9(user(12858).SegmentedControlPages, { state: segmentedControlState })];
