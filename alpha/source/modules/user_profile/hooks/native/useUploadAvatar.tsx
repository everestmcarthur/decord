...
// Dependencies: [5, 19, 1372, 1074, 1374, 563, 9426, 4723, 5349, 4414, 14863, 8437, 8435, 8432, 8434, 2]
// Exports: default
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            tmp22(4723).hideActionSheet();
            const obj13 = tmp22(4723);
            const obj6 = { size };
            dependencyMap = 1;
            c3 = 1;
          ...
          if (null == base64) {
            ...
            if (!closure_129_1) {
              canUseAnimatedAvatarResult = tmp22(4414).canUseAnimatedAvatar(closure_129_3);
              const obj = tmp22(4414);
            }
          ...
          if (closure_129_1) {
            tmp28(8435).setTryItOutAvatar(closure_128_4);
            const tmp28Result = tmp28(8435);
          } else {
            const obj11 = { guildId: closure_129_0, avatar: closure_128_4 };
            tmp28(8432).setPendingChanges(obj11);
            const tmp28Result2 = tmp28(8432);
