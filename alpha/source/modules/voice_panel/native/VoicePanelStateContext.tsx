...
// Dependencies: [19, 12515, 12513, 12516, 7270, 12517, 1614, 12521, 2]

// Module 12514 (VoicePanelStateContext)
import VoicePanelCardLayoutManagerDefault from "VoicePanelCardLayoutManager" /* 12517 */;
import VoicePanelPIPHandoffDefault from "VoicePanelPIPHandoff" /* 12521 */;
...
ReanimatedHelperTypes = fn(7270);
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12516).MorphablePanelModes.PANEL);
