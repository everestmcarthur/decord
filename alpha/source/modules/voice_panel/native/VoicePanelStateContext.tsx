...
// Dependencies: [19, 12524, 12522, 12525, 7314, 12526, 1614, 12530, 2]

// Module 12523 (VoicePanelStateContext)
import VoicePanelCardLayoutManagerDefault from "VoicePanelCardLayoutManager" /* 12526 */;
import VoicePanelPIPHandoffDefault from "VoicePanelPIPHandoff" /* 12530 */;
...
ReanimatedHelperTypes = fn(7314);
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12525).MorphablePanelModes.PANEL);
