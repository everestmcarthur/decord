...
// Dependencies: [19, 17, 21, 9667, 8727, 2]

// Module 17646 (CircleWithCutout)
...
export const getBadgeLeft = fn(9667).getBadgeLeft;
export const getBadgeTop = fn(9667).getBadgeTop;
