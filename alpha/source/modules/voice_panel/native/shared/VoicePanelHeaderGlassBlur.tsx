...
// Dependencies: [19, 17, 21, 4722, 1364, 4458, 5143, 4656, 7269, 5131, 4573, 5759, 2]

// Module 12524 (VoicePanelHeaderGlassBlur)
...
export default noop.memo(function HeaderGlassBlur(shown) {
  ...
  const animatedStyle = shown(4458).useAnimatedStyle(fn);
  let obj = shown(4458);
  ...
  const obj3 = shown(4458);
  fn2.__closure = { withSpring: shown(5143).withSpring, shown };
  ...
  obj5.style = items;
  const obj4 = { withSpring: shown(5143).withSpring, shown };
  ...
  items3[1] = closure_4(tmp6Result2, { style: tmp2(4573).isThemeDark(tmp7) ? tmp.strokeAlt : tmp.strokeAltLight });
