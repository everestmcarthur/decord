...
// Dependencies: [19, 17, 21, 4756, 576, 12523, 4957, 5801, 4752, 1115, 2]

// Module 17592 (VoicePanelNoVideoParticipantsCard)
...
export default noop.memo(function VoicePanelNoVideoParticipantsCard() {
  ...
  const items1 = [closure_5(channelId(4752).Text, obj2), ];
  ...
  obj3.children = closure_5(channelId(4752).Text, obj4);
