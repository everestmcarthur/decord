...
// Dependencies: [19, 17, 21, 4722, 576, 12514, 4923, 5759, 4718, 1115, 2]

// Module 17515 (VoicePanelNoVideoParticipantsCard)
...
export default noop.memo(function VoicePanelNoVideoParticipantsCard() {
  ...
  const items1 = [closure_5(channelId(4718).Text, obj2), ];
  ...
  obj3.children = closure_5(channelId(4718).Text, obj4);
