...
// Function ID: 17513
// Name: useTapGestures
// Dependencies: [19, 12514, 6848, 4458, 4690, 2]
// Exports: default

// Module 17512 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = noop.useContext(isFocusedVideoZoomed(12514)).isFocusedVideoZoomed;
  ...
  return noop.useMemo(() => {
    ...
    const Gesture = current(6848).Gesture;
    const Gesture2 = current(6848).Gesture;
    ...
    fn.__closure = { runOnJS: current(4458).runOnJS, handleEvent };
    fn.__workletHash = 13571114432746;
    fn.__initData = __initData;
    const obj2 = { runOnJS: current(4458).runOnJS, handleEvent };
    const Gesture3 = tmp(6848).Gesture;
    ...
    fn2.__closure = { runOnJS: current(4458).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    const obj3 = { runOnJS: current(4458).runOnJS, handleEvent };
    const Gesture4 = tmp(6848).Gesture;
    ...
    fn3.__closure = { runOnJS: current(4458).runOnJS, triggerHapticFeedback: current(4690).triggerHapticFeedback, HapticFeedbackTypes: current(4690).HapticFeedbackTypes, handleEvent };
