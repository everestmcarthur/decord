...
// Function ID: 17590
// Name: useTapGestures
// Dependencies: [19, 12523, 6892, 4492, 4724, 2]
// Exports: default
...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    fn3.__closure = { runOnJS: current(4492).runOnJS, triggerHapticFeedback: current(4724).triggerHapticFeedback, HapticFeedbackTypes: current(4724).HapticFeedbackTypes, handleEvent };
