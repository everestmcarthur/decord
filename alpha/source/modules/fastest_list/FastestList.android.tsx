...
// Function ID: 7252
// Name: FastestList
// Dependencies: [377, 19, 21, 4458, 7252, 6820, 7253, 7254, 7256, 7257, 7259, 7262, 7263, 7267, 2]

// Module 7251 (FastestList)
import FastestListNativeComponentDefault from "FastestListNativeComponent" /* 7252 */;
...
let closure_8 = BottomSheetModal.createBottomSheetScrollableComponent(fn(6820).SCROLLABLE_TYPE.SCROLLVIEW, FastestListNativeComponent);
let closure_9 = 0;
const size = fn(2);
