...
// Dependencies: [5, 17, 1346, 1074, 4965, 1364, 10350, 10352, 1255, 7358, 10472, 2]

// Module 10471 (BugReportManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            notificationDuration = tmp2(10350).getNotificationDuration(BUG_REPORTER);
            const obj5 = tmp2(10350);
