...
// Function ID: 9479
// Name: disclosures
// Dependencies: [5, 1074, 1271, 9479, 1115, 2]
// Exports: ackDisclosures, getDisclosures, getTextForDisclosure

// Module 9478 (disclosures)
...
export const ApplicationDisclosure = fn(9479).ApplicationDisclosureType;
...
export const getTextForDisclosure = function getTextForDisclosure(disclosure) {
  ...
  } else if (tmp(9479).ApplicationDisclosureType.DISPLAYS_ADVERTISEMENTS === disclosure) {
