...
// Dependencies: [19, 17, 21, 4756, 576, 7219, 8509, 7864, 8935, 7857, 8944, 4752, 1115, 2]
// Exports: default
  ...
  if (widget instanceof UserProfilePersonalWidget.UserProfilePersonalWidget) {
    ...
    if (tmp2Result.isGameWidget(widget)) {
      ...
      if (widget.games.length > 0) {
        ...
        tmp6 = React4(tmp2(8944).WidgetSection, obj3);
      }
    }
    tmp2Result = tmp2(7857);
  }
  if (null === tmp6) {
    return null;
  } else {
    const obj4 = { style: tmp.container, children: null };
    let Text = tmp2(4752).Text;
