...
// Dependencies: [5, 32, 19, 1074, 3, 16313, 559, 7202, 13892, 16315, 1110, 1271, 6829, 16317, 2]
// Exports: useAuthWebsocket

// Module 16314 (useAuthWebsocket)
import LoggerDefault from "Logger" /* 3 */;
import typing from "typing" /* 16313 */;
import RemoteAuthCryptoDefault from "RemoteAuthCrypto" /* 16315 */;
            ...
            if (0 === c3) {
              ...
              if (arg0 === 1) {
                ...
                if ("nonce_proof" === op) {
                  ...
                  c3 = 2;
                  c4 = 1;
                  let obj5 = { value: info(16315).decryptNonce(closure_130_8(), encrypted_nonce), done: false };
                  return obj5;
                  ...
                  c3 = 3;
                  c4 = 1;
                  const obj6 = { value: info(16315).publicKeyFingerprint(closure_130_8()), done: false };
                  return obj6;
                  ...
                  if (null == ticket) {
                    ...
                    let obj7 = { step: closure_2_0(16313).RemoteAuthStep.PENDING_LOGIN, ticket };
                    c7(obj7);
                    ...
                    HTTP.post(request).then((() => {
                      closure_0 = closure_1_3(/* F128560 */ function() { ... });
                      return () => { ... };
                    })()).catch(() => closure_1_11());
                  ...
                  c3 = 4;
                  c4 = 1;
                  const obj9 = { value: closure_2_0(16317).decodeEncodedUserRecord(closure_130_8(), closure_129_6), done: false };
                  return obj9;
                } else if ("cancel" === op) {
              ...
              if (arg0 === 1) {
                ...
                if (closure_129_4 !== closure_129_1.fingerprint) {
                  ...
                  const obj19 = { step: closure_2_0(16313).RemoteAuthStep.PENDING_REMOTE_INIT, fingerprint: closure_129_4 };
                  c7(obj19);
                  c4 = 3;
              ...
              closure_129_7 = value;
              let obj = { step: closure_2_0(16313).RemoteAuthStep.PENDING_TICKET, user: closure_129_7 };
              c7(obj);
              c4 = 3;
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              c3 = 1;
              const obj6 = { value: info(16315).generateRsaKeyPair(), done: false };
              return obj6;
            }
          } else if (1 === tmp4) {
            if (arg0 === 1) {
              ...
              c2 = 2;
              c3 = 1;
              const obj9 = { value: info(16315).serializePublicKey(closure_129_3), done: false };
              return obj9;
            }
          } else if (2 === tmp4) {
            if (arg0 === 1) {
              ...
              c2 = 3;
              c3 = 1;
              const obj11 = { value: info(16315).publicKeyFingerprint(closure_129_3), done: false };
              return obj11;
            }
          } else if (arg0 === 1) {
            c3 = 3;
