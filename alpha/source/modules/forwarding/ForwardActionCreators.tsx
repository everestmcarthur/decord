...
// Dependencies: [32, 5, 2041, 4395, 1074, 4749, 8618, 7916, 1097, 7918, 1385, 7696, 11934, 4998, 2]

// Module 11938 (ForwardActionCreators)
import allSettledDefault from "allSettled" /* 4998 */;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (prop) {
                let guild_id = tmp2(8618).GAME_CONTENT_GUILD_ID;
              ...
              if (null == channel) {
                ...
                const parsed = item(7916).parse(channel, "");
                ...
                let num9 = 0;
                if (null != withMessage) {
                  const tmp39 = v3(item(7918)(withMessage), 2);
                  num9 = 0;
                  if (tmp39[0]) {
            ...
            if (1 === tmp5) {
              if (arg0 === 1) {
                ...
                if (!result) {
                  result = tmp2(11934).isRatelimitedInChannel(closure_128_0, PermissionStore);
                  const obj2 = tmp2(11934);
                }
                if (!result) {
                  const obj3 = item(7696);
                  const id = closure_128_0.id;
                  const obj25 = { location: constants2.FORWARDING, flags: closure_128_1 };
                  dependencyMap = 2;
                  v3 = 1;
                  const obj26 = { value: obj3.sendMessage(id, item(7916).parse(closure_128_0, closure_128_2), false, obj25), done: false };
                  return obj26;
                }
              }
            } else if (arg0 === 1) {
