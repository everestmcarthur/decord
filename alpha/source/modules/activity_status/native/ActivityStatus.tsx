...
// Function ID: 11125
// Name: ActivityStatus
// Dependencies: [19, 17, 4762, 4371, 1372, 11125, 1074, 21, 4722, 504, 11126, 11127, 11128, 11129, 11134, 11135, 11140, 11142, 11133, 2]
// Exports: default

// Module 11124 (ActivityStatus)
...
const DOT_UNICODE = fn(11125).DOT_UNICODE;
...
export default function ActivityStatus(guildId) {
  ...
  const voiceChannel = stateFromStores1(11127)({ userId, guildId: guildId.guildId }).voiceChannel;
  ...
  const tmp6 = stateFromStores1(11126)(userId);
  let state;
  if (memo != null) {
    state = memo.state;
  }
  const gameMentionsAsPlainText = userId(11128).useGameMentionsAsPlainText(state);
  const obj3 = userId(11128);
  ...
  if (tmp2Result.useStateFromStores(items3, () => RelationshipStore.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      let found;
      if (stateFromStores1 != null) {
        found = stateFromStores1.find(tmp5(11134));
      }
      ...
      obj4.hideIcon = tmp12;
      obj4.hideText = tmp13;
      let tmp18Result = closure_10(tmp5(11129), obj4);
      ...
      if (null != found1) {
        ...
        obj5.hideIcon = tmp12;
        obj5.hideText = tmp13;
        tmp18Result = closure_10(tmp5(11135), obj5);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj6.hideIcon = tmp12;
          obj6.hideText = tmp13;
          tmp18Result = closure_10(tmp5(11140), obj6);
        }
      }
    }
    let tmp21 = null;
    if (null != memo) {
      ...
      if (null != memo) {
        ...
        if (tmp25) {
          ...
          tmp25 = closure_10(tmp5(11142), obj7);
        }
        const items7 = [tmp25, ];
        ...
        if (tmp27) {
          ...
          tmp27 = closure_10(tmp5(11133), obj8);
        }
    ...
    if (tmp31) {
      ...
      tmp31 = closure_10(tmp5(11133), obj11);
    }
    items8[1] = tmp31;
    items8[2] = tmp21;
