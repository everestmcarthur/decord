...
// Function ID: 11138
// Name: ActivityStatus
// Dependencies: [19, 17, 4796, 4405, 1372, 11138, 1074, 21, 4756, 504, 11139, 11140, 11141, 11142, 11147, 11148, 11153, 11155, 11146, 2]
// Exports: default

// Module 11137 (ActivityStatus)
...
const DOT_UNICODE = fn(11138).DOT_UNICODE;
...
export default function ActivityStatus(guildId) {
  ...
  const voiceChannel = stateFromStores1(11140)({ userId, guildId: guildId.guildId }).voiceChannel;
  ...
  const tmp6 = stateFromStores1(11139)(userId);
  let state;
  if (memo != null) {
    state = memo.state;
  }
  const gameMentionsAsPlainText = userId(11141).useGameMentionsAsPlainText(state);
  const obj3 = userId(11141);
  ...
  if (tmp2Result.useStateFromStores(items3, () => RelationshipStore.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      let found;
      if (stateFromStores1 != null) {
        found = stateFromStores1.find(tmp5(11147));
      }
      ...
      obj4.hideIcon = tmp12;
      obj4.hideText = tmp13;
      let tmp18Result = closure_10(tmp5(11142), obj4);
      const tmp5Result = tmp5(11142);
    } else {
      let found1;
      if (stateFromStores1 != null) {
      ...
      if (null != found1) {
        ...
        obj5.hideIcon = tmp12;
        obj5.hideText = tmp13;
        tmp18Result = closure_10(tmp5(11148), obj5);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj6.hideIcon = tmp12;
          obj6.hideText = tmp13;
          tmp18Result = closure_10(tmp5(11153), obj6);
        }
      }
    }
    let tmp21 = null;
    if (null != memo) {
      ...
      if (null != memo) {
        ...
        if (tmp25) {
          ...
          tmp25 = closure_10(tmp5(11155), obj7);
        }
        const items7 = [tmp25, ];
        ...
        if (tmp27) {
          ...
          tmp27 = closure_10(tmp5(11146), obj8);
        }
    ...
    if (tmp31) {
      ...
      tmp31 = closure_10(tmp5(11146), obj11);
    }
    items8[1] = tmp31;
    items8[2] = tmp21;
