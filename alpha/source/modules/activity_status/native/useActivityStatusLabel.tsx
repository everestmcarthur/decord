...
// Dependencies: [4778, 2041, 4395, 4796, 4405, 4775, 1074, 504, 11141, 11139, 11140, 11147, 1115, 11149, 11153, 2]
// Exports: default

// Module 13569 (useActivityStatusLabel)
...
const VoiceActivityStatus = v0wJXSh(11153);
require = fn;
