  ...
  if ("channel" !== type) {
    if ("message" !== type) {
      if ("attachment" === type) {
        ...
        obj2.type = tmp(5207).AST_KEY.ATTACHMENT_LINK;
        const obj3 = { type: tmp(5207).AST_KEY.TEXT, content: value.name };
        const items = [obj3];
        obj2.content = items;
        ...
        const obj4 = { type: tmp(5207).AST_KEY.TEXT, content: "" };
        return obj4;
      }
    }
  }
