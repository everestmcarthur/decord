...
// Dependencies: [19, 17, 21, 4722, 2020, 5142, 4718, 1115, 11198, 2]
// Exports: default

// Module 12962 (InviteRolesList)
...
export default function InviteRolesList(invite) {
  ...
  if (null != guild) {
    ...
    if (0 !== memo.length) {
      ...
      const items1 = [closure_5(guild(4718).Text, obj2), ];
      ...
      obj.children = items1;
      tmp2 = closure_6(guild(5142).Stack, obj);
    }
  }
  return tmp2;
};
