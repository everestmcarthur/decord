...
// Function ID: 12964
// Name: InviteError
// Dependencies: [19, 17, 1074, 21, 4722, 576, 4573, 4656, 12964, 12965, 12966, 1115, 4718, 5144, 1397, 1177, 12967, 5754, 2025, 2]
// Exports: default

// Module 12963 (InviteError)
...
function InviteErrorBase(invite) {
  ...
  const tmp4Result = importDefault(shared.isThemeDark(useThemeDefault()) ? 12964 : 12965);
  let code;
  if (inviteError != null) {
...
function InviteDisabledError(onPressClose) {
  ...
  if (null == guild) {
    ...
    const obj6 = { style: tmp.disabledPauseIcon, source: _modDef12967 };
