...
// Dependencies: [19, 17, 12213, 21, 4466, 4492, 4757, 12498, 2]
// Exports: default, interactivityProps

// Module 12497 (ChatInputActionButtonTransitionItem)
...
function FadeTransitionItem(state) {
  ...
  const effect = noop.useEffect(() => {
    if (state === native.TransitionStates.YEETED) {
      ...
      let obj = { runOnJS: tmp(4492).runOnJS, cleanup };
      fn.__closure = obj;
      ...
      const result1 = sharedValue.set(tmp(4757).withTiming(1, CHAT_INPUT_TIMING_CONFIG, "respect-motion-settings"));
...
const CHAT_INPUT_TIMING_CONFIG = fn(12213).CHAT_INPUT_TIMING_CONFIG;
const jsx = fn(21).jsx;
