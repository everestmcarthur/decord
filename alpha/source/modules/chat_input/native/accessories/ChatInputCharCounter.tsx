...
// Dependencies: [32, 19, 1372, 1074, 1374, 21, 4722, 504, 4380, 9542, 9551, 4420, 1115, 5292, 4718, 8900, 2]

// Module 12672 (ChatInputCharCounter)
...
const forwardRefResult = noop.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(9542)();
  _slicedToArray = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj3.children = "-" + tmp6;
    const items2 = [closure_8(tmp2(4718).Text, obj3), closure_8(tmp2(8900).NitroWheelIcon, { size: "sm" })];
    obj2.children = items2;
    tmp10 = closure_9(tmp2(5292).PressableOpacity, obj2);
  }
  return tmp10;
});
