...
// Dependencies: [5, 19, 7406, 1074, 7407, 7409, 4451, 1241, 7411, 2]
// Exports: default

// Module 7405 (useStartAuthorize)
...
const require = fn;
const AuthorizeFlow = fn(7406).AuthorizeFlow;
    ...
    if (c6 === 2) {
      ...
      try {
        ...
        if (0 === c5) {
          ...
          const result = closure_0(7411).accountLinkAuthorizationStarted(closure_0.id, obj9);
          c4 = 0;
          c6 = 3;
