...
// Dependencies: [5, 19, 7362, 1074, 7363, 7365, 4417, 1241, 7367, 2]
// Exports: default

// Module 7361 (useStartAuthorize)
...
const require = fn;
const AuthorizeFlow = fn(7362).AuthorizeFlow;
    ...
    if (c6 === 2) {
      ...
      try {
        ...
        if (0 === c5) {
          ...
          const result = closure_0(7367).accountLinkAuthorizationStarted(closure_0.id, obj9);
          c4 = 0;
          c6 = 3;
