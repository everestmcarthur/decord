...
// Dependencies: [19, 17, 4714, 11833, 1074, 21, 4722, 576, 504, 11831, 1241, 4689, 11837, 10211, 11838, 7346, 4718, 1115, 5144, 8900, 2]
// Exports: default

// Module 11836 (GroupDMNitroCapLimitSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4689 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 10211 */;
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11837 */;
import useGroupDMNitroUpsellActionDefault from "useGroupDMNitroUpsellAction" /* 11838 */;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  const groupDMNitroAudience = _location(11831).useGroupDMNitroAudience();
  importDefault = tmp6;
  ...
  let obj2 = _location(11831);
  let obj3 = noop;
  obj4.acquisitionStrategy = _location(11831).GroupDMNitroAcquisitionStrategy.CHECKOUT;
  ...
  const items3 = [closure_11(_location(4718).Text, obj6), , ];
  ...
  items3[1] = closure_11(_location(4718).Text, obj8);
  ...
  obj11.text = intl3.string(_location(11831).getGroupDMNitroCapCTAMessage(groupDMNitroAudience));
  const tmp2Result = _location(11831);
  obj11.icon = closure_11(_location(8900).NitroWheelIcon, { style: tmp.nitroWheelIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: "custom" });
  ...
  obj11.onPress = tmp16;
  const items4 = [closure_11(_location(5144).Button, obj11), ];
  ...
  items4[1] = closure_11(_location(5144).Button, obj14);
  obj10.children = items4;
  items3[2] = closure_12(View, obj10);
  obj5.children = items3;
  obj13.children = closure_12(View, obj5);
  return closure_11(_location(7346).BottomSheet, obj13);
};
