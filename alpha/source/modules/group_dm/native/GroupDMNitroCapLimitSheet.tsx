...
// Dependencies: [19, 17, 4748, 11842, 1074, 21, 4756, 576, 504, 11840, 1241, 4723, 11846, 10223, 11847, 7390, 4752, 1115, 5186, 8939, 2]
// Exports: default

// Module 11845 (GroupDMNitroCapLimitSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4723 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 10223 */;
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11846 */;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  const items3 = [closure_11(_location(4752).Text, obj6), , ];
  ...
  items3[1] = closure_11(_location(4752).Text, obj8);
  ...
  obj11.icon = closure_11(_location(8939).NitroWheelIcon, { style: tmp.nitroWheelIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: "custom" });
  ...
  obj11.onPress = tmp16;
  const items4 = [closure_11(_location(5186).Button, obj11), ];
  ...
  items4[1] = closure_11(_location(5186).Button, obj14);
