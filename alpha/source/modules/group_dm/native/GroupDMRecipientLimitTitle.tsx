...
// Dependencies: [19, 17, 1074, 21, 4722, 576, 1364, 11831, 4423, 1115, 4718, 8900, 12430, 2]
// Exports: default

// Module 17143 (GroupDMRecipientLimitTitle)
...
export default function GroupDMRecipientLimitTitle(arg0) {
  ...
  if (tmp9) {
    ...
    tmp15Result = tmp15(tmp2(8900).NitroWheelIcon, obj7);
  }
