...
// Dependencies: [19, 7533, 7841, 21, 563, 9512, 9513, 9510, 7844, 4723, 7840, 2]
// Exports: default

// Module 9511 (ExplicitMediaSenderFalsePositiveActionSheet)
...
import ExplicitMediaFalsePositiveActionSheet from "ExplicitMediaFalsePositiveActionSheet" /* 9513 */;
import noop from "module_19" /* 19 */;
import ExplicitMediaStore from "ExplicitMediaStore" /* 7533 */;

require = fn;
let closure_5 = fn(7841).EXPLICIT_MEDIA_SENDER_FALSE_POSITIVE_ACTION_SHEET_KEY;
const jsx = fn(21).jsx;
const size = fn(2);
...
export default function ExplicitMediaObscuredFalsePositiveActionSheet(channelId) {
  ...
  if (stateFromStores.attachments.length <= 0) {
    messageId(4723).hideActionSheet();
    const obj4 = messageId(4723);
  }
  ...
  return jsx(channelId(9513).ExplicitMediaFalsePositiveActionSheet, { channelId, messageId, isReportFalsePositiveLoading: explicitMediaActions.isReportFalsePositiveLoading, onConfirmPress: callback, analyticsContext: channelId(7840).TrackMediaRedactionContext.EXPLICIT_MEDIA_SENDER_FALSE_POSITIVE_FLOW });
};
