...
// Dependencies: [19, 17, 1074, 21, 4492, 4756, 576, 16437, 2066, 1115, 16469, 14170, 16467, 5822, 4457, 10492, 4752, 9019, 1177, 7449, 16483, 12549, 16488, 16489, 2]
// Exports: default

// Module 16468 (ChannelListStickyHeader)
import nativeDefault from "native" /* 576 */;
import GuildBadgeV2Default from "GuildBadgeV2" /* 9019 */;
...
export default function ChannelListStickyHeader(guild) {
  ...
  const iOSPressEffects = guild(5822).useIOSPressEffects(4);
  ({ onPressIn, onPressOut, pressableStyles } = iOSPressEffects);
  const tmp6Result = guild(5822);
  ...
  if (isFavoritesGuildIdResult) {
    ...
    tmp22 = closure_6(tmp6(10492).StarIcon, obj5);
  }
  const items2 = [tmp22, , , ];
  ...
  if (flag2) {
    ...
    tmp24Result = tmp24(tmp6(7449).ChevronSmallRightIcon, obj8);
  }
  ...
  if (isFavoritesGuildIdResult) {
    tmp24Result5 = tmp24(tmp6(16483).FavoritesGuildHeaderActionButton, {});
  }
  ...
  if (flag) {
    ...
    tmp24Result6 = tmp24(tmp2(12549), obj16);
  }
  ...
  if (tmp24Result7) {
    ...
    obj17.children = tmp24(tmp2(16488), obj18);
  ...
  if (flag3) {
    ...
    tmp24Result8 = tmp24(tmp2(16489), obj20);
  }
