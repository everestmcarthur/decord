...
// Dependencies: [32, 19, 1958, 4361, 4371, 1372, 1074, 7705, 7706, 7707, 1115, 7708, 7709, 7710, 4875, 7711, 7712, 7713, 504, 7714, 2]
...
// Module 7704 (AutomodMessageUtils)
import useChannelName from "useChannelName" /* 4875 */;
import AutomodMessageEmbedKeys from "AutomodMessageEmbedKeys" /* 7705 */;
import AutomodQuarantineUserActionMessageEmbedKeys from "AutomodQuarantineUserActionMessageEmbedKeys" /* 7706 */;
import AutomodQuarantineUserMessageEmbedKeys from "AutomodQuarantineUserMessageEmbedKeys" /* 7711 */;
import AutomodNotificationEmbedKeys from "AutomodNotificationEmbedKeys" /* 7712 */;
import AutomodAlert from "AutomodAlert" /* 7713 */;
...
const AutomodInteractionCallbackTypeEmbedKeys = prop(7709);
const AutomodDecisionOutcomeEmbedKeys = prop(7710);
require = fn;
...
function _getUserProfileRuleHeaderText(profileUpdateTypeFromMessage, quarantineActionFromMessage, quarantineEventFromMessage) {
  if (AutomodQuarantineUserActionMessageEmbedKeys.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === quarantineActionFromMessage) {
    if (tmp(7707).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_UPDATE === profileUpdateTypeFromMessage) {
      const intl6 = tmp(1115).intl;
      let stringResult = intl6.string(tmp(1115).t.t98DPb);
    } else if (tmp(7707).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_RESET === profileUpdateTypeFromMessage) {
      const intl5 = tmp(1115).intl;
      stringResult = intl5.string(tmp(1115).t["7u/rlU"]);
    }
    return stringResult;
  } else if (tmp(7706).AutomodQuarantineUserActionMessageEmbedKeys.QUARANTINE_USER === quarantineActionFromMessage) {
    if (tmp(7708).AutomodQuarantineEventMessageEmbedKeys.MESSAGE_SEND === quarantineEventFromMessage) {
      const intl4 = tmp(1115).intl;
      let stringResult1 = intl4.string(tmp(1115).t.PmSMMS);
    } else if (tmp(7708).AutomodQuarantineEventMessageEmbedKeys.GUILD_JOIN === quarantineEventFromMessage) {
      const intl3 = tmp(1115).intl;
      stringResult1 = intl3.string(tmp(1115).t.m9wWzo);
    } else if (tmp(7708).AutomodQuarantineEventMessageEmbedKeys.USERNAME_UPDATE === quarantineEventFromMessage) {
      const intl2 = tmp(1115).intl;
      stringResult1 = intl2.string(tmp(1115).t.KNSkC6);
    } else if (tmp(7708).AutomodQuarantineEventMessageEmbedKeys.CLAN_TAG_UPDATE === quarantineEventFromMessage) {
      const intl7 = tmp(1115).intl;
      stringResult1 = intl7.string(tmp(1115).t.qV4K6j);
    }
    return stringResult1;
  } else if (tmp(7706).AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_GUEST_JOIN === quarantineActionFromMessage) {
...
function extractAutomodMessageFields(message) {
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.ALERT_ACTIONS_EXECUTION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.RULE_NAME;
  ...
  obj.ruleName = tmp19;
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.DECISION_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.KEYWORD;
  ...
  obj.keyword = tmp31;
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.KEYWORD_MATCHED_CONTENT;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.FLAGGED_MESSAGE_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.TIMEOUT_DURATION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.QUARANTINE_USER;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.QUARANTINE_USER_ACTION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.DECISION_REASON;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.INTERACTION_USER_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7705).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
...
export const getActionHeaderText = function getActionHeaderText(embeds, channel, arg2, integrationOwnerHook) {
  ...
  let GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7705).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7705).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  GUILD_ROOM_NOTE_OUTCOME = format(7705).AutomodMessageEmbedKeys.VOICE_CHANNEL_STATUS_OUTCOME;
  ...
  if (null == tmp32) {
    if (null != null) {
      ...
      GUILD_ROOM_NOTE_OUTCOME = format(7705).AutomodMessageEmbedKeys.GUILD_ROOM_NOTE_OUTCOME;
      ...
      if (null == tmp39) {
        if (null != null) {
          ...
          if (null == tmp22) {
            if (tmp13 !== v4xL9Sk(7710).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
          ...
          if (tmp16 !== v4xL9Sk(7709).AutomodInteractionCallbackTypeEmbedKeys.MODAL) {
            if (tmp13 !== v4xL9Sk(7710).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  ...
  } else if (tmp(7711).AutomodQuarantineUserMessageEmbedKeys.USERNAME === quarantineType) {
    const intl4 = tmp(1115).intl;
    return intl4.string(tmp(1115).t.pJQVnr);
  } else if (tmp(7711).AutomodQuarantineUserMessageEmbedKeys.GLOBAL_NAME === quarantineType) {
    const intl3 = tmp(1115).intl;
    return intl3.string(tmp(1115).t.V9eJ85);
  } else if (tmp(7711).AutomodQuarantineUserMessageEmbedKeys.CLAN_TAG === quarantineType) {
    const intl2 = tmp(1115).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  ...
  NOTIFICATION_TYPE = tmp(7712).AutomodNotificationEmbedKeys.JOIN_ATTEMPTS;
  let embeds1 = message.embeds;
  if (embeds1 == null) {
    embeds1 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7712).AutomodNotificationEmbedKeys.RAID_DATETIME;
  let embeds2 = message.embeds;
  if (embeds2 == null) {
    embeds2 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7712).AutomodNotificationEmbedKeys.DMS_SENT;
  let embeds3 = message.embeds;
  if (embeds3 == null) {
    embeds3 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7712).AutomodNotificationEmbedKeys.RAID_TYPE;
  let embeds4 = message.embeds;
  if (embeds4 == null) {
    embeds4 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7712).AutomodNotificationEmbedKeys.RESOLVED_REASON;
  let embeds5 = message.embeds;
  if (embeds5 == null) {
    embeds5 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7712).AutomodNotificationEmbedKeys.DECISION_ID;
  let embeds6 = message.embeds;
  if (embeds6 == null) {
    embeds6 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7712).AutomodNotificationEmbedKeys.SUSPICIOUS_MENTION_ACTIVITY_UNTIL;
  let embeds7 = message.embeds;
  if (embeds7 == null) {
    embeds7 = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (tmp3(7714).RaidResolutionType.DM_SPAM === resolvedReason) {
    const intl3 = tmp3(1115).intl;
    return intl3.string(tmp3(1115).t.j5V0ij);
  } else if (tmp3(7714).RaidResolutionType.JOIN_RAID === resolvedReason) {
