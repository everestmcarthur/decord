...
// Function ID: 17860
// Name: getRuleInfo
// Dependencies: [12106, 5259, 17860, 17862, 16081, 9673, 17863, 4664, 2]
// Exports: getRuleInfo

// Module 17859 (getRuleInfo)
import Constants from "Constants" /* 12106 */;
import _modDef17862 from "module_17862" /* 17862 */;
import BaseRuleInfo from "BaseRuleInfo" /* 17863 */;
  ...
  if (null != baseRuleInfo) {
    ...
    if (null != triggerType) {
      ...
      if (AutomodTriggerType.MENTION_SPAM === triggerType) {
        const obj3 = { IconComponent: tmp(5259).AtIcon };
        let tmp9 = obj3;
      } else if (tmp8.KEYWORD === triggerType) {
        const obj4 = { IconComponent: tmp(17860).ChannelListPlusIcon };
        tmp9 = obj4;
      } else {
        if (tmp8.ML_SPAM !== triggerType) {
          if (tmp8.USER_PROFILE !== triggerType) {
            if (tmp8.DEFAULT_KEYWORD_LIST === triggerType) {
              const obj5 = { IconComponent: tmp(16081).MenuIcon };
              tmp9 = obj5;
            } else if (tmp8.APPLICATION === triggerType) {
              const obj6 = { IconComponent: tmp(9673).RobotIcon };
              tmp9 = obj6;
            }
          }
        }
        const obj7 = { source: _modDef17862 };
        tmp9 = obj7;
      }
      if (tmp9 == null) {
        const obj8 = { IconComponent: tmp(4664).LinkIcon };
        tmp9 = obj8;
      }
      obj2.icon = tmp9;
      tmp4 = obj2;
