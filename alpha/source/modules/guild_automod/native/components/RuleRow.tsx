...
// Function ID: 17937
// Name: RuleRow
// Dependencies: [19, 17, 12115, 21, 4756, 576, 17937, 4752, 4457, 17939, 17934, 17933, 5186, 1115, 5817, 2]
// Exports: default
...
export default function RuleRow(triggerType) {
  ...
  const tmp = closure_8();
  const token = triggerType(4457).useToken(nativeDefault.modules.mobile.TABLE_ROW_LABEL_TEXT_STYLE);
  ...
  if (null == ruleInfo) {
    ...
    if (null == rule) {
      ...
      const items = [closure_5(tmp2(4752).Text, obj6), tmp7];
      obj5.children = items;
    ...
    if (null == rule) {
      ...
      closure_5(tmp2(5186).Button, obj7);
    } else {
      let tmp14;
      if (!rule.enabled) {
      ...
      if ("" !== headerSubtext) {
        ...
        items1[2] = closure_5(tmp2(4752).Text, obj10);
        obj9.children = items1;
        tmp19 = closure_6(tmp2(4752).Text, obj9);
      }
