...
// Dependencies: [19, 4976, 21, 504, 7402, 7422, 11520, 2]
// Exports: default

// Module 11519 (MessageReactions)
...
export default function MessageReactions(emoji) {
  ...
  if (items3.length > 0) {
    ...
    let tmp9Result = tmp9(tmp4(11520).MessageReactionsContent, obj3);
  } else {
    tmp9Result = tmp9(tmp4(11520).MessageReactionsEmpty, {});
  }
  obj2.children = tmp9Result;
  return jsx(items3(7402).AnalyticsLocationProvider, { value: tmp3(AnalyticsLocationDefault.MESSAGE_REACTIONS).analyticsLocations, children: null });
};
