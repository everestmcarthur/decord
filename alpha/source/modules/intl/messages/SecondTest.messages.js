// Module ID: 15874
// Function ID: 15875
// Dependencies: [1119, 15843, 15844, 15845, 15846, 15847, 15848, 15849, 15850, 15851, 15852, 15853, 15854, 15855, 15856, 15857, 15858, 15859, 15860, 15861, 15862, 15863, 15864, 15865, 15866, 15867, 15868, 15869, 15870, 15871, 15872, 15875, 1154, 2]

// Module 15874
import AssetJsonUtils from "AssetJsonUtils" /* 1119 */;
import _mod15843 from "module_15843" /* 15843 */;
import _mod15844 from "module_15844" /* 15844 */;
...
import _mod15875 from "module_15875" /* 15875 */;
...
const loader = module_1154.createLoader({
  bg() {
    const jsonAsset = AssetJsonUtils.loadJsonAsset(_mod15843);
    return jsonAsset.then((result) => ({ default: result }));
  },
  cs() {
    const jsonAsset = AssetJsonUtils.loadJsonAsset(_mod15844);
    return jsonAsset.then((result) => ({ default: result }));
  },
  da() {
  ...
  () => {
    const jsonAsset = AssetJsonUtils.loadJsonAsset(_mod15875);
    return jsonAsset.then((result) => ({ default: result }));
  }
}, "en-US");
let module_1154 = module_1154_mod;
