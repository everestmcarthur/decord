...
// Dependencies: [19, 17, 1074, 21, 4722, 576, 9481, 8571, 1115, 4421, 9659, 9461, 7576, 4718, 9661, 2]
// Exports: default

// Module 9658 (ApplicationEducation)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4718 */;
import OAuth2Scopes from "OAuth2Scopes" /* 8571 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9481 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4421).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9659).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9461).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7576).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8571).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4421).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9461).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7576).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4718).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9661).AuthorizeFormSeparator, {})];
