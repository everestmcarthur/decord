...
// Dependencies: [19, 17, 1074, 21, 4756, 576, 9334, 8609, 1115, 4455, 9534, 9347, 7620, 4752, 9536, 2]
// Exports: default
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4455).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9534).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9347).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7620).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8609).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4455).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9347).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7620).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4752).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9536).AuthorizeFormSeparator, {})];
