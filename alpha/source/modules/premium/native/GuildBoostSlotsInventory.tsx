...
// Dependencies: [19, 17, 1182, 2063, 4650, 4420, 1074, 21, 4756, 576, 5736, 7679, 4752, 1115, 11, 5334, 5646, 5796, 13760, 504, 1397, 13761, 13765, 5079, 4653, 12, 2]
// Exports: default

// Module 13759 (GuildBoostSlotsInventory)
...
const SubscriptionPlaceholderPattern = tmp2(13761);
require = fn;
...
function GuildBoostSlot(guildBoostSlot) {
  ...
  if (null == guildBoostSlot.guild) {
    ...
    if (!guildBoostSlot.isOnCooldown()) {
      ...
      tmp6Result2 = tmp6(guildBoostSlot(5334).PressableOpacity, obj5);
    }
...
function UnusedGuildBoostSlots(unusedSlots) {
  ...
  if (found1.length > 0) {
    ...
    obj2.action = closure_11(found(5334).PressableOpacity, obj4);
...
function BoostedGuildInfo(guild) {
  ...
  if (null != guild) {
    ...
    const obj7 = { source: _modDef13760, style: tmp.guildInfoRowIcon };
...
function BoostedGuild(arg0) {
  ...
  items3[2] = closure_11(guildBoostSlots(13765), { guild: stateFromStores, theme: stateFromStores1 });
