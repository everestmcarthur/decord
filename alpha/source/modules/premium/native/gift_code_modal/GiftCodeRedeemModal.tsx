...
// Dependencies: [19, 11690, 1372, 21, 5836, 4959, 11700, 11713, 11714, 504, 11701, 7240, 2]
// Exports: default

// Module 11699 (GiftCodeRedeemModal)
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4959 */;
import GiftCodeRedeemStartDefault from "GiftCodeRedeemStart" /* 11700 */;
import useGiftCodeErrorMessageDefault from "useGiftCodeErrorMessage" /* 11701 */;
import GiftCodeRedeemSuccessDefault from "GiftCodeRedeemSuccess" /* 11713 */;
import GiftCodeRedeemErrorDefault from "GiftCodeRedeemError" /* 11714 */;
...
export default function GiftCodeRedeemModal(code) {
  ...
  if (null == stateFromStores1) {
    ...
    const obj4 = {
      headerTitle,
      headerLeft: tmp2(5836).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop()),
      render(arg0) {
          const obj = {};
    ...
    obj5.headerLeft = tmp2(5836).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop());
    ...
    obj6.headerLeft = tmp2(5836).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop());
    ...
    if (null == stateFromStores) {
      ...
      jsx(tmp2(7240).Navigator, { screens: obj3, initialRouteStack: null });
    }
    const tmp2Result4 = tmp2(5836);
  }
};
