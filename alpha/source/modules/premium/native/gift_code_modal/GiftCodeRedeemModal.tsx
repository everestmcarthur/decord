...
// Dependencies: [19, 11681, 1372, 21, 5794, 4925, 11691, 11704, 11705, 504, 11692, 7196, 2]
// Exports: default

// Module 11690 (GiftCodeRedeemModal)
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4925 */;
import GiftCodeRedeemStartDefault from "GiftCodeRedeemStart" /* 11691 */;
import useGiftCodeErrorMessageDefault from "useGiftCodeErrorMessage" /* 11692 */;
import GiftCodeRedeemSuccessDefault from "GiftCodeRedeemSuccess" /* 11704 */;
import GiftCodeRedeemErrorDefault from "GiftCodeRedeemError" /* 11705 */;
...
export default function GiftCodeRedeemModal(code) {
  ...
  if (null == stateFromStores1) {
    ...
    const obj4 = {
      headerTitle,
      headerLeft: tmp2(5794).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop()),
      render(arg0) {
          const obj = {};
    ...
    obj5.headerLeft = tmp2(5794).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop());
    ...
    const tmp2Result3 = tmp2(5794);
    obj6.headerLeft = tmp2(5794).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop());
    ...
    if (null == stateFromStores) {
      ...
      jsx(tmp2(7196).Navigator, { screens: obj3, initialRouteStack: null });
    }
    const tmp2Result4 = tmp2(5794);
  }
};
