...
// Dependencies: [32, 19, 17, 5722, 21, 4756, 576, 504, 11702, 7408, 11309, 7794, 1973, 8439, 11349, 7363, 7466, 9105, 7412, 9077, 4941, 1177, 11374, 11483, 11484, 11709, 4752, 1115, 4994, 5186, 4959, 2]
// Exports: default

// Module 11713 (GiftCodeRedeemSuccess)
  ...
  if (null == first) {
    if (null != getOrFetchApplication) {
      if (tmp2Result7.isGameItemSKU(stateFromStores)) {
        ...
        obj10.children = tmp24(user(9105), obj11);
        ...
        tmp24Result = tmp24(user(7412), obj12);
  ...
  if (type === giftCode(1973).CollectiblesItemType.BUNDLE) {
    if (null != product) {
      ...
      if (tmp20Result) {
        ...
        tmp20Result = tmp20(user(9077), obj15);
      }
    ...
    if (tmp2Result9.isGameItemSKU(stateFromStores)) {
      ...
      if (null != first) {
        ...
        return tmp17(tmp2(7363).SafeAreaPaddingView, obj8);
      }
