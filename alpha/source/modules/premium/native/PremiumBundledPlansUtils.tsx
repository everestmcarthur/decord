...
// Dependencies: [32, 1374, 7480, 4414, 2]
...
export const getToggledIntervalProduct = function getToggledIntervalProduct(productId) {
  if (productId in ProductIds.AppStorePremiumProductIdsToPremiumBundledItems) {
    ...
    if (tmp8.premiumTier !== React4.TIER_1) {
      ...
      const values = Object.values(tmp(7480).AppStorePremiumProductIdsToPremiumBundledItems);
...
export const getProductIdsForBothIntervals = function getProductIdsForBothIntervals(monthly) {
  if (monthly in ProductIds.AppStorePremiumProductIdsToPremiumBundledItems) {
    const tmp8 = tmp(7480).AppStorePremiumProductIdsToPremiumBundledItems[monthly];
    let numPremiumGuild;
    if (monthly in tmp(7480).AppStorePremiumProductIdsToPremiumBundledItems) {
      const tmp14 = tmp(7480).AppStorePremiumProductIdsToPremiumBundledItems[monthly];
      ...
      if (null != productId) {
        if (null != productIdFromSubscription) {
          if (productId === productIdFromSubscription) {
            ...
            const tmp12 = tmp20(7480).AppStorePremiumProductIdsToPremiumBundledItems[productId];
            if (productIdFromSubscription in tmp20(7480).AppStorePremiumProductIdsToPremiumBundledItems) {
              const tmp18 = tmp20(7480).AppStorePremiumProductIdsToPremiumBundledItems[productIdFromSubscription];
