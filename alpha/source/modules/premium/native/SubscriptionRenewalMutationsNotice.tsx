...
// Dependencies: [19, 17, 4415, 21, 4756, 576, 5653, 1177, 1115, 4414, 2]
// Exports: default

// Module 13651 (SubscriptionRenewalMutationsNotice)
...
const obj2 = { container: { padding: 10, marginVertical: 5, marginHorizontal: 15, borderRadius: nativeDefault.radii.xs, display: "flex", flexDirection: "row", justifyContent: "center", backgroundColor: fn(5653).DARK_PRIMARY_630_LIGHT_PRIMARY_230 }, icon: null, text: null };
let obj3 = { padding: 10, marginVertical: 5, marginHorizontal: 15, borderRadius: nativeDefault.radii.xs, display: "flex", flexDirection: "row", justifyContent: "center", backgroundColor: fn(5653).DARK_PRIMARY_630_LIGHT_PRIMARY_230 };
