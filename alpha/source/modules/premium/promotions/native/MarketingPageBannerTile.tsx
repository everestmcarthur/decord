...
// Dependencies: [19, 17, 21, 4722, 576, 7358, 13633, 9008, 1249, 10985, 13636, 4718, 4417, 10214, 2]
// Exports: default

// Module 13632 (MarketingPageBannerTile)
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const obj = helpArticleLinkProps(13633);
  const obj3 = { type: null, name: null, properties: null };
  const buttonActionHandler = helpArticleLinkProps(13633).getButtonActionHandler(obj2);
  ...
  obj3.properties = { component_type: helpArticleLinkProps(10985).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  tmp2Result(obj3);
  const obj4 = { component_type: helpArticleLinkProps(10985).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  const formatStringWithCommonPremiumParams = helpArticleLinkProps(13636).useFormatStringWithCommonPremiumParams(bannerFields.body);
  const tmp4Result = helpArticleLinkProps(13636);
  helpArticleLinkProps = helpArticleLinkProps(13636).getHelpArticleLinkProps(bannerFields.helpArticle, bannerFields.helpArticleId);
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4718).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result3) {
    ...
    tmp12Result3 = tmp12(tmp4(4718).Text, obj11);
  }
  items3[2] = tmp12Result3;
  obj10.children = items3;
  items2[2] = closure_6(helpArticleLinkProps(4718).Text, obj10);
  ...
  if (tmp12Result4) {
    ...
    obj12.children = tmp12(tmp2(10214), obj13);
