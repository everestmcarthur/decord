...
// Dependencies: [19, 17, 21, 4756, 576, 7402, 13688, 9047, 1249, 10998, 13691, 4752, 4451, 10226, 2]
// Exports: default
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4752).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result3) {
    ...
    tmp12Result3 = tmp12(tmp4(4752).Text, obj11);
  }
  items3[2] = tmp12Result3;
  obj10.children = items3;
  items2[2] = closure_6(helpArticleLinkProps(4752).Text, obj10);
  ...
  if (tmp12Result4) {
    ...
    obj12.children = tmp12(tmp2(10226), obj13);
