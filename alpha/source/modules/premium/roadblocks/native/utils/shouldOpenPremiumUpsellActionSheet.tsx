...
// Dependencies: [8091, 1094, 8094, 9434, 2]
// Exports: default

// Module 9433 (shouldOpenPremiumUpsellActionSheet)
...
export default function maybeOpenPremiumUpsellActionSheet(initialUpsellKey) {
  ...
  if (ConstantsIOS.UpsellTypes.UPLOAD === initialUpsellKey) {
    const INCREASED_FILE_UPLOAD_SIZE = tmp(8094).EntitlementFeatureNames.INCREASED_FILE_UPLOAD_SIZE;
    ...
    const EMOJIS_EVERYWHERE = tmp(8094).EntitlementFeatureNames.EMOJIS_EVERYWHERE;
    ...
    const ANIMATED_EMOJIS = tmp(8094).EntitlementFeatureNames.ANIMATED_EMOJIS;
    ...
    let flag4 = tmp(9434).getMobileStickerPickerUpsellRestyleEnabled("native.shouldOpenPremiumUpsellActionSheet");
    if (flag4) {
      const STICKERS_EVERYWHERE = tmp(8094).EntitlementFeatureNames.STICKERS_EVERYWHERE;
    ...
    const SOUNDBOARD_EVERYWHERE = tmp(8094).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE;
    ...
    const STREAM_HIGH_QUALITY = tmp(8094).EntitlementFeatureNames.STREAM_HIGH_QUALITY;
