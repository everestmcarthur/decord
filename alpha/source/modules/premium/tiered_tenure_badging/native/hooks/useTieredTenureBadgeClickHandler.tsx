...
// Dependencies: [19, 1372, 1374, 8462, 1074, 7448, 11421, 7868, 504, 7622, 4723, 11422, 1980, 11422, 1241, 2]
// Exports: useTieredTenureBadgeClickHandler

// Module 11420 (useTieredTenureBadgeClickHandler)
...
export const useTieredTenureBadgeClickHandler = function useTieredTenureBadgeClickHandler(id, userId, themeType) {
  ...
  if (typeof id === "string") {
    tmp4 = null != tmp(7868).getTieredTenureBadge(id);
  ...
  if (tmp4) {
    callback = isPremiumSubscriber.useCallback(() => {
      if (closure_2 === UserProfileThemeTypes.YOU_SCREEN) {
        ...
        const tmp4 = asyncRequireImpl(11422, dependencyMap.paths);
        const obj4 = { userId };
