...
// Dependencies: [19, 17, 4714, 10908, 1074, 1955, 21, 4722, 576, 504, 10999, 11000, 8504, 4689, 7358, 7378, 10904, 7346, 1364, 9049, 5757, 11003, 4718, 5144, 11284, 1115, 2]
// Exports: default

// Module 17308 (GiftingPromotionCoachmark)
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp19Result) {
        ...
        tmp19Result = tmp19(tmp11(11003), obj5);
      }
      ...
      obj9.icon = tmp19(tmp2(11284).GiftIcon, obj10);
      const intl = tmp2(1115).intl;
      obj9.text = intl.string(tmp2(1115).t.Ve9Ge6);
      obj9.onPress = tmp17;
      items4[3] = tmp19(tmp2(5144).Button, obj9);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj11.children = tmp19(tmp2(9049).APNGPlayer, obj12);
      ...
      tmp19Result4 = tmp19(tmp11(5757), obj13);
