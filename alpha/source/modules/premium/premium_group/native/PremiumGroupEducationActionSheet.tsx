...
// Dependencies: [17, 4428, 21, 4756, 576, 7390, 6847, 4752, 1115, 3162, 2]
// Exports: default

// Module 13774 (PremiumGroupEducationActionSheet)
...
export default function PremiumGroupEducationActionSheet(children) {
  ...
  obj6.children = intl.format(_modDef3162.ah1Ecm, { helpCenterLink: HELP_CENTER_LINK });
