...
// Dependencies: [17, 4394, 21, 4722, 576, 7346, 6803, 4718, 1115, 3160, 2]
// Exports: default

// Module 13719 (PremiumGroupEducationActionSheet)
...
export default function PremiumGroupEducationActionSheet(children) {
  ...
  obj6.children = intl.format(_modDef3160.ah1Ecm, { helpCenterLink: HELP_CENTER_LINK });
