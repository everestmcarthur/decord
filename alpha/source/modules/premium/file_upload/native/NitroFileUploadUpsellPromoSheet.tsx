...
// Dependencies: [19, 17, 1074, 1955, 21, 4722, 576, 5161, 7578, 10211, 10471, 5862, 1115, 2580, 5144, 2]
// Exports: default

// Module 17327 (NitroFileUploadUpsellPromoSheet)
...
export default function NitroFileUploadUpsellPromoSheet(markAsDismissed) {
  ...
  obj2.title = intl.string(require("module_2580")["Uty2/X"]);
  const intl2 = markAsDismissed(callback[12]).intl;
  obj2.description = intl2.string(require("module_2580").VAgI8Q);
  ...
  obj4.text = intl3.string(require("module_2580").mRy6sO);
  let tmp9 = null;
  if (!loading) {
    tmp9 = callback2;
  }
