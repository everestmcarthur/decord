...
// Function ID: 12760
// Name: powerupListing
// Dependencies: [32, 19, 4610, 4611, 4614, 504, 2]
// Exports: useBuildGuildPowerupsSections

// Module 12759 (powerupListing)
...
let items = [fn(4614).GUILD_TAGS_BADGE_PACK_CREEPY_CRAWLIES_POWERUP_SKU_ID, fn(4614).GUILD_TAGS_BADGE_PACK_PETS_POWERUP_SKU_ID, fn(4614).GUILD_TAGS_BADGE_PACK_PLANT_POWERUP_SKU_ID, fn(4614).GUILD_TAGS_BADGE_PACK_FLEX_POWERUP_SKU_ID];
