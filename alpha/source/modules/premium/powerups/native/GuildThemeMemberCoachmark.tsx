...
// Dependencies: [19, 4714, 4610, 4611, 1955, 21, 4722, 576, 504, 4614, 12763, 16427, 4630, 5604, 1115, 2512, 12766, 11380, 2]
// Exports: default

// Module 16426 (GuildThemeMemberCoachmark)
...
require = fn;
let closure_6 = fn(4611).GUILD_THEME_POWERUP_BOOST_PRICE;
...
export default function GuildThemeMemberCoachmark(guildId) {
  ...
  guildPowerupBannerImage = guildId(12763).getGuildPowerupBannerImage(stateFromStores, stateFromStores1, true);
  if (guildPowerupBannerImage == null) {
    guildPowerupBannerImage = markAsDismissed(16427);
  }
  const diff = onDismiss - markAsDismissed(4630)(guildId).available;
  c5 = diff;
  ...
  const memo = stateFromStores1.useMemo(() => {
    ...
    obj.title = intl.string(_modDef2512.RK6NbY);
    const intl2 = util.intl;
    obj.description = intl2.string(_modDef2512.xlAqGk);
  ...
  const obj3 = guildId(12763);
  const coachmark = tmp2(11380).useCoachmark(guildId.targetRef, memo);
  return null;
};
