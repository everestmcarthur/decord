...
// Dependencies: [19, 17, 21, 576, 4422, 6804, 6805, 2]
// Exports: CircleErrorIcon

// Module 6803 (CircleErrorIcon)
...
export const CircleErrorIcon = function CircleErrorIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6804, color: secondaryColor, style }), ];
  const obj3 = { source: _mod6805, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
