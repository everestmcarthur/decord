...
// Dependencies: [19, 21, 576, 4456, 10219, 2]
// Exports: ImageSparkleIcon

// Module 10218 (ImageSparkleIcon)
...
export const ImageSparkleIcon = function ImageSparkleIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10219, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
