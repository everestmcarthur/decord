...
// Function ID: 11216
// Name: PlusLargeIcon
// Dependencies: [19, 21, 576, 4456, 11216, 2]
// Exports: PlusLargeIcon

// Module 11215 (PlusLargeIcon)
...
export const PlusLargeIcon = function PlusLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11216, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
