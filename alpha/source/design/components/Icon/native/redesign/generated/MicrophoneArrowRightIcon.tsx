...
// Dependencies: [19, 21, 576, 4456, 10177, 2]
// Exports: MicrophoneArrowRightIcon

// Module 10176 (MicrophoneArrowRightIcon)
...
export const MicrophoneArrowRightIcon = function MicrophoneArrowRightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10177, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
