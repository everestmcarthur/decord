...
// Dependencies: [19, 21, 576, 4422, 4673, 2]
// Exports: CheckmarkLargeIcon

// Module 4672 (CheckmarkLargeIcon)
...
export const CheckmarkLargeIcon = function CheckmarkLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4673, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
