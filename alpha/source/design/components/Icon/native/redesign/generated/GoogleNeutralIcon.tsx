...
// Dependencies: [19, 21, 576, 4456, 8719, 2]
// Exports: GoogleNeutralIcon

// Module 8718 (GoogleNeutralIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4456 */;
import _mod8719 from "module_8719" /* 8719 */;
...
export const GoogleNeutralIcon = function GoogleNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8719, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
