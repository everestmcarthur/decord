...
// Function ID: 5243
// Name: ThreadIcon
// Dependencies: [19, 21, 576, 4422, 5199, 2]
// Exports: ThreadIcon

// Module 5242 (ThreadIcon)
...
export const ThreadIcon = function ThreadIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5199, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
