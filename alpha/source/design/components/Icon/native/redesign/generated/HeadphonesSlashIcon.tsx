...
// Dependencies: [19, 21, 576, 4456, 9943, 2]
// Exports: HeadphonesSlashIcon

// Module 9942 (HeadphonesSlashIcon)
...
export const HeadphonesSlashIcon = function HeadphonesSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9943, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
