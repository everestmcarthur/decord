...
// Dependencies: [19, 21, 576, 4422, 9362, 2]
// Exports: HeadphonesSlashIcon

// Module 9361 (HeadphonesSlashIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4422 */;
import _mod9362 from "module_9362" /* 9362 */;
...
export const HeadphonesSlashIcon = function HeadphonesSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9362, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
