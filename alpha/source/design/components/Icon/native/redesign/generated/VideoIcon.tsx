...
// Function ID: 10366
// Name: VideoIcon
// Dependencies: [19, 21, 576, 4456, 10366, 2]
// Exports: VideoIcon

// Module 10365 (VideoIcon)
...
export const VideoIcon = function VideoIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10366, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
