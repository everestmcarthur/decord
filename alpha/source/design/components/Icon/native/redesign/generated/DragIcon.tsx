...
// Function ID: 5828
// Name: DragIcon
// Dependencies: [19, 21, 576, 4456, 5828, 2]
// Exports: DragIcon

// Module 5827 (DragIcon)
...
export const DragIcon = function DragIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5828, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
