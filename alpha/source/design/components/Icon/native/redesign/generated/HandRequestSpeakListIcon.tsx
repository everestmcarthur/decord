...
// Dependencies: [19, 21, 576, 4456, 10186, 2]
// Exports: HandRequestSpeakListIcon

// Module 10185 (HandRequestSpeakListIcon)
...
export const HandRequestSpeakListIcon = function HandRequestSpeakListIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10186, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
