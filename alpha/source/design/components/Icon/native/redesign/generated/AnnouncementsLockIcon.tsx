...
// Dependencies: [19, 21, 576, 4456, 5278, 2]
// Exports: AnnouncementsLockIcon

// Module 5304 (AnnouncementsLockIcon)
...
export const AnnouncementsLockIcon = function AnnouncementsLockIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5278, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
