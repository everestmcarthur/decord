...
// Dependencies: [19, 21, 576, 4456, 10506, 2]
// Exports: LockUnlockedIcon

// Module 10505 (LockUnlockedIcon)
...
export const LockUnlockedIcon = function LockUnlockedIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10506, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
