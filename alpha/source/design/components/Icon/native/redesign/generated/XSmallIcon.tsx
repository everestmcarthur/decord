...
// Function ID: 5851
// Name: XSmallIcon
// Dependencies: [19, 21, 576, 4422, 5851, 2]
// Exports: XSmallIcon

// Module 5850 (XSmallIcon)
...
export const XSmallIcon = function XSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5851, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
