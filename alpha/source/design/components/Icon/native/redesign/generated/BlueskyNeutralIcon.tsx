...
// Dependencies: [19, 21, 576, 4456, 9172, 2]
// Exports: BlueskyNeutralIcon

// Module 9171 (BlueskyNeutralIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4456 */;
import _mod9172 from "module_9172" /* 9172 */;
...
export const BlueskyNeutralIcon = function BlueskyNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9172, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
