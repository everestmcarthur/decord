...
// Function ID: 9146
// Name: PlusSmallIcon
// Dependencies: [19, 21, 576, 4456, 9146, 2]
// Exports: PlusSmallIcon

// Module 9145 (PlusSmallIcon)
...
export const PlusSmallIcon = function PlusSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9146, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
