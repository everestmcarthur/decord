...
// Function ID: 7577
// Name: SettingsIcon
// Dependencies: [19, 21, 576, 4422, 7577, 2]
// Exports: SettingsIcon

// Module 7576 (SettingsIcon)
...
export const SettingsIcon = function SettingsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7577, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
