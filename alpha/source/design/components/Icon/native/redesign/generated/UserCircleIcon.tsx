...
// Function ID: 11181
// Name: UserCircleIcon
// Dependencies: [19, 21, 576, 4456, 11181, 2]
// Exports: UserCircleIcon

// Module 11180 (UserCircleIcon)
...
export const UserCircleIcon = function UserCircleIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11181, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
