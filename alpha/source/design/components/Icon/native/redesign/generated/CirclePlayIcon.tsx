...
// Function ID: 8994
// Name: CirclePlayIcon
// Dependencies: [19, 17, 21, 576, 4456, 8994, 8995, 2]
// Exports: CirclePlayIcon

// Module 8993 (CirclePlayIcon)
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod8994, color: secondaryColor, style }), ];
  const obj3 = { source: _mod8995, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
