...
// Dependencies: [19, 21, 576, 4456, 8275, 2]
// Exports: ChatWarningIcon

// Module 12705 (ChatWarningIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4456 */;
import _mod8275 from "module_8275" /* 8275 */;
...
export const ChatWarningIcon = function ChatWarningIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8275, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
