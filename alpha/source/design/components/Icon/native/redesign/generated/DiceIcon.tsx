...
// Function ID: 9074
// Name: DiceIcon
// Dependencies: [19, 21, 576, 4422, 9074, 2]
// Exports: DiceIcon

// Module 9073 (DiceIcon)
...
export const DiceIcon = function DiceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9074, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
