...
// Function ID: 9113
// Name: DiceIcon
// Dependencies: [19, 21, 576, 4456, 9113, 2]
// Exports: DiceIcon

// Module 9112 (DiceIcon)
...
export const DiceIcon = function DiceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9113, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
