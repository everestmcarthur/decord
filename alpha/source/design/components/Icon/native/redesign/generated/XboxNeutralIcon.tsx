...
// Dependencies: [19, 21, 576, 4422, 8940, 2]
// Exports: XboxNeutralIcon

// Module 8939 (XboxNeutralIcon)
...
export const XboxNeutralIcon = function XboxNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8940, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
