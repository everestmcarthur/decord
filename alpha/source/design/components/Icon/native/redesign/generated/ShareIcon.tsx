...
// Function ID: 13206
// Name: ShareIcon
// Dependencies: [19, 21, 576, 4456, 9872, 2]
// Exports: ShareIcon

// Module 13205 (ShareIcon)
...
export const ShareIcon = function ShareIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9872, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
