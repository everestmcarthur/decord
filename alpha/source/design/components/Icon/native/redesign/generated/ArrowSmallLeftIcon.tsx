...
// Dependencies: [19, 21, 576, 4456, 9554, 2]
// Exports: ArrowSmallLeftIcon

// Module 9553 (ArrowSmallLeftIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4456 */;
import _mod9554 from "module_9554" /* 9554 */;
...
export const ArrowSmallLeftIcon = function ArrowSmallLeftIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9554, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
