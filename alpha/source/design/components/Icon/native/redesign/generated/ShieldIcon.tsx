...
// Function ID: 9516
// Name: ShieldIcon
// Dependencies: [19, 21, 576, 4456, 9514, 2]
// Exports: ShieldIcon

// Module 9515 (ShieldIcon)
...
export const ShieldIcon = function ShieldIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9514, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
