...
// Dependencies: [19, 21, 576, 4456, 12607, 2]
// Exports: TiktokNeutralIcon

// Module 12606 (TiktokNeutralIcon)
...
export const TiktokNeutralIcon = function TiktokNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12607, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
