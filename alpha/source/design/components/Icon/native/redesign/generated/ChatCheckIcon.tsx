...
// Function ID: 15160
// Name: ChatCheckIcon
// Dependencies: [19, 21, 576, 4456, 15160, 2]
// Exports: ChatCheckIcon

// Module 15159 (ChatCheckIcon)
...
export const ChatCheckIcon = function ChatCheckIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15160, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
