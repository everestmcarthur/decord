...
// Function ID: 13791
// Name: ServerGridIcon
// Dependencies: [19, 21, 576, 4422, 13791, 2]
// Exports: ServerGridIcon

// Module 13790 (ServerGridIcon)
...
export const ServerGridIcon = function ServerGridIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13791, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
