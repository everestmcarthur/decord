...
// Dependencies: [19, 21, 576, 4422, 5783, 2]
// Exports: ChevronSmallRightIcon

// Module 7405 (ChevronSmallRightIcon)
...
export const ChevronSmallRightIcon = function ChevronSmallRightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5783, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
