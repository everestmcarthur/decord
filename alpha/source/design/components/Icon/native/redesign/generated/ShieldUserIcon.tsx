...
// Function ID: 9840
// Name: ShieldUserIcon
// Dependencies: [19, 21, 576, 4456, 8391, 2]
// Exports: ShieldUserIcon

// Module 9839 (ShieldUserIcon)
...
export const ShieldUserIcon = function ShieldUserIcon(tmp2Result) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8391, color: INTERACTIVE_ICON_DEFAULT, style: tmp2Result.style });
};
