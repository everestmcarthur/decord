...
// Function ID: 12379
// Name: BillIcon
// Dependencies: [19, 21, 576, 4422, 12379, 2]
// Exports: BillIcon

// Module 12378 (BillIcon)
...
export const BillIcon = function BillIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12379, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
