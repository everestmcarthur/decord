...
// Dependencies: [19, 21, 576, 4422, 5224, 2]
// Exports: AppsWarningIcon

// Module 5272 (AppsWarningIcon)
...
export const AppsWarningIcon = function AppsWarningIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5224, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
