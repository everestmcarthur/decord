...
// Function ID: 5307
// Name: LockIcon
// Dependencies: [19, 21, 576, 4456, 5279, 2]
// Exports: LockIcon

// Module 5306 (LockIcon)
...
export const LockIcon = function LockIcon(WHITE) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5279, color: INTERACTIVE_ICON_DEFAULT, style: WHITE.style });
};
