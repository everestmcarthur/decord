...
// Dependencies: [19, 21, 576, 4422, 8677, 2]
// Exports: VideoSelfieIcon

// Module 8676 (VideoSelfieIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4422 */;
import _mod8677 from "module_8677" /* 8677 */;
...
export const VideoSelfieIcon = function VideoSelfieIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8677, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
