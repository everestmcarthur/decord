...
// Dependencies: [19, 21, 576, 4456, 15272, 2]
// Exports: FiltersHorizontalIcon

// Module 15271 (FiltersHorizontalIcon)
...
export const FiltersHorizontalIcon = function FiltersHorizontalIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15272, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
