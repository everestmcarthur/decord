...
// Function ID: 5257
// Name: ImageIcon
// Dependencies: [19, 21, 576, 4422, 5221, 2]
// Exports: ImageIcon

// Module 5256 (ImageIcon)
...
export const ImageIcon = function ImageIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5221, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
