...
// Function ID: 11499
// Name: KeyboardIcon
// Dependencies: [19, 21, 576, 4422, 11499, 2]
// Exports: KeyboardIcon

// Module 11498 (KeyboardIcon)
...
export const KeyboardIcon = function KeyboardIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11499, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
