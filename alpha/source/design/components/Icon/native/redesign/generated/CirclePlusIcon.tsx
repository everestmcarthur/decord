...
// Function ID: 11457
// Name: CirclePlusIcon
// Dependencies: [19, 17, 21, 576, 4422, 11457, 11458, 2]
// Exports: CirclePlusIcon

// Module 11456 (CirclePlusIcon)
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod11457, color: secondaryColor, style }), ];
  const obj3 = { source: _mod11458, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
