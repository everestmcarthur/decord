...
// Dependencies: [19, 17, 21, 576, 4422, 8936, 8937, 8938, 2]
// Exports: MinecraftNeutralIcon

// Module 8935 (MinecraftNeutralIcon)
...
export const MinecraftNeutralIcon = function MinecraftNeutralIcon(secondaryColor) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod8936, color, style }), , ];
  const obj3 = { source: _mod8937, color: str, style: null };
  const items1 = [style];
  const items2 = [];
  ...
  const obj4 = { source: _mod8938, color: str2, style: null };
  const items3 = [style];
  const items4 = [];
