...
// Dependencies: [19, 21, 576, 4456, 15260, 2]
// Exports: SubscriptionIcon

// Module 15259 (SubscriptionIcon)
...
export const SubscriptionIcon = function SubscriptionIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15260, color: ICON_STRONG, style: color.style });
};
