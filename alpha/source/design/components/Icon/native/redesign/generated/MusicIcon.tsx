...
// Function ID: 10167
// Name: MusicIcon
// Dependencies: [19, 21, 576, 4456, 10167, 2]
// Exports: MusicIcon

// Module 10166 (MusicIcon)
...
export const MusicIcon = function MusicIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10167, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
