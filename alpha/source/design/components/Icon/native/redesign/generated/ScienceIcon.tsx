...
// Function ID: 16812
// Name: ScienceIcon
// Dependencies: [19, 21, 576, 4456, 12063, 2]
// Exports: ScienceIcon

// Module 16811 (ScienceIcon)
...
export const ScienceIcon = function ScienceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12063, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
