...
// Function ID: 4659
// Name: UserPlusIcon
// Dependencies: [19, 21, 576, 4422, 4659, 2]
// Exports: UserPlusIcon

// Module 4658 (UserPlusIcon)
...
export const UserPlusIcon = function UserPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4659, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
