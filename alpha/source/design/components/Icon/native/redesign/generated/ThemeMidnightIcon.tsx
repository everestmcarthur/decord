...
// Dependencies: [19, 21, 576, 4456, 15536, 2]
// Exports: ThemeMidnightIcon

// Module 15535 (ThemeMidnightIcon)
...
export const ThemeMidnightIcon = function ThemeMidnightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15536, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
