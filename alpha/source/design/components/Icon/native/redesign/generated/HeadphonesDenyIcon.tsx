...
// Dependencies: [19, 21, 576, 4422, 9360, 2]
// Exports: HeadphonesDenyIcon

// Module 9359 (HeadphonesDenyIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4422 */;
import _mod9360 from "module_9360" /* 9360 */;
...
export const HeadphonesDenyIcon = function HeadphonesDenyIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9360, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
