...
// Dependencies: [19, 21, 576, 4456, 12403, 2]
// Exports: ArrowsUpDownIcon

// Module 12402 (ArrowsUpDownIcon)
...
export const ArrowsUpDownIcon = function ArrowsUpDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12403, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
