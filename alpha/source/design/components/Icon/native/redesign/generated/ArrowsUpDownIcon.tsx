...
// Dependencies: [19, 21, 576, 4422, 12394, 2]
// Exports: ArrowsUpDownIcon

// Module 12393 (ArrowsUpDownIcon)
...
export const ArrowsUpDownIcon = function ArrowsUpDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12394, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
