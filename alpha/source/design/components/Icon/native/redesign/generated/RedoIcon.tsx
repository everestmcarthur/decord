...
// Function ID: 15314
// Name: RedoIcon
// Dependencies: [19, 21, 576, 4422, 15314, 2]
// Exports: RedoIcon

// Module 15313 (RedoIcon)
...
export const RedoIcon = function RedoIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15314, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
