...
// Function ID: 15858
// Name: BeakerIcon
// Dependencies: [19, 21, 576, 4456, 15858, 2]
// Exports: BeakerIcon

// Module 15857 (BeakerIcon)
...
export const BeakerIcon = function BeakerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15858, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
