...
// Dependencies: [19, 21, 576, 4456, 9945, 2]
// Exports: MicrophoneDenyIcon

// Module 9944 (MicrophoneDenyIcon)
...
export const MicrophoneDenyIcon = function MicrophoneDenyIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9945, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
