...
// Function ID: 10244
// Name: VoiceXIcon
// Dependencies: [19, 21, 576, 4456, 10244, 2]
// Exports: VoiceXIcon

// Module 10243 (VoiceXIcon)
...
export const VoiceXIcon = function VoiceXIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10244, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
