...
// Function ID: 10232
// Name: VoiceXIcon
// Dependencies: [19, 21, 576, 4422, 10232, 2]
// Exports: VoiceXIcon

// Module 10231 (VoiceXIcon)
...
export const VoiceXIcon = function VoiceXIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10232, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
