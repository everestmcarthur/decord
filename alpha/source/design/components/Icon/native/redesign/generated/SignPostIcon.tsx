...
// Function ID: 14105
// Name: SignPostIcon
// Dependencies: [19, 21, 576, 4456, 14105, 2]
// Exports: SignPostIcon

// Module 14104 (SignPostIcon)
...
export const SignPostIcon = function SignPostIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod14105, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
