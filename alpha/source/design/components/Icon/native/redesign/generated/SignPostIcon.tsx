...
// Function ID: 14051
// Name: SignPostIcon
// Dependencies: [19, 21, 576, 4422, 14051, 2]
// Exports: SignPostIcon

// Module 14050 (SignPostIcon)
...
export const SignPostIcon = function SignPostIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod14051, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
