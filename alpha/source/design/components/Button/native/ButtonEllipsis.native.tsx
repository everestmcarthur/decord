...
// Function ID: 5161
// Name: ButtonEllipsis
// Dependencies: [19, 21, 4458, 4722, 576, 4723, 5150, 5161, 2]
// Exports: Ellipsis

// Module 5160 (ButtonEllipsis)
  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        const tmp5Result3 = tmp5(4458);
        tmp11(tmp5Result.withDelay(result1, tmp5Result3.withRepeat(tmp5(4723).withTiming(1, tmp8, "animate-always"), -1, true)));
        return () => {
...
ELLIPSIS_APPEAR_TIMING.easing = Easing.inOut(fn(4458).Easing.quad);
...
withEllipsisAnimation.__closure = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: fn(4458).withDelay, withRepeat: fn(4458).withRepeat, withTiming: fn(4723).withTiming, ELLIPSIS_APPEAR_TIMING };
