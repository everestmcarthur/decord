...
// Dependencies: [32, 19, 1074, 21, 5856, 5857, 5858, 2]
// Exports: TableRadioGroup

// Module 5855 (TableRadioGroup)
...
export const TableRadioGroup = function TableRadioGroup(arg0) {
  ...
  jsx = obj.useContext(onChange(5856).RedesignCompatContext);
  ...
  obj2.children = jsx(onChange(5857).TableRowGroup, { accessibilityRole: "radiogroup", accessibilityLabel, title, description, helperText, hasIcons, children: null });
