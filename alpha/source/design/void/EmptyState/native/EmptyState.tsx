...
// Function ID: 14335
// Name: EmptyState
// Dependencies: [19, 17, 21, 4722, 576, 4573, 4718, 2]
// Exports: default

// Module 14334 (EmptyState)
...
export default function EmptyState(Illustration) {
  ...
  if (null != Illustration.Illustration) {
    ...
    if (tmp9) {
      ...
      obj3.source = tmp2(4573).isThemeLight(tmp8) ? Illustration.lightSource : Illustration.darkSource;
      const items1 = [tmp.emptyImage, Illustration.imageStyle];
      obj3.style = items1;
      tmp11Result = React4(React3, obj3);
      const tmp2Result2 = tmp2(4573);
    }
  ...
  if (null != title) {
    ...
    if (null != title) {
      ...
      obj6.style = items4;
      obj6.children = title;
      tmp25 = React4(tmp2(4718).Text, obj6);
    }
    const items5 = [tmp25, ];
    let tmp27 = null;
    if (null != body) {
      ...
      obj7.style = items6;
      obj7.children = body;
      tmp27 = React4(tmp2(4718).Text, obj7);
    }
    items5[1] = tmp27;
