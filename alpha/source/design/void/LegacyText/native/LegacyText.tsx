...
// Dependencies: [19, 17, 1074, 21, 4722, 8851, 2]

// Module 8850 (LegacyText/LegacyText)
import useLegacyTextMigrationHighlight from "useLegacyTextMigrationHighlight" /* 8851 */;
