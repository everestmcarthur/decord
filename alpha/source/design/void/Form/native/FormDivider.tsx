...
// Function ID: 8838
// Name: FormDivider
// Dependencies: [19, 17, 1074, 21, 4722, 576, 4432, 7380, 4571, 5856, 2]
// Exports: default
...
export default function Divider(arg0) {
  ...
  let tmp7 = null;
  if (tmp6) {
    const obj3 = { backgroundColor: tmp2(4571).hexOpacityToRgba(obj2[theme], profileThemeValues.dividerOpacity) };
    tmp7 = obj3;
