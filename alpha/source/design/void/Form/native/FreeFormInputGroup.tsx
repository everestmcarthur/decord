...
// Dependencies: [19, 17, 21, 4756, 1364, 5898, 6843, 1177, 7176, 7177, 7179, 4752, 2]
...
export default noop.forwardRef((accessibilityLabel, ref) => {
  ...
  if (context) {
    ...
    return hasOwnProperty(tmp8(6843).TextInput, obj3);
  } else {
    ...
    if (null != hint) {
      ...
      tmp17Result2 = tmp17(tmp8(4752).Text, obj8);
    }
