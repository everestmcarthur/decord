...
// Function ID: 8833
// Name: FormCTA
// Dependencies: [19, 17, 1085, 21, 4722, 576, 1177, 5787, 7333, 8833, 2]
// Exports: default

// Module 8832 (FormCTA)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import FormCheckbox2 from "FormCheckbox" /* 5787 */;
...
export default function FormCTA(arg0) {
  ...
  if ("row-button" === variant) {
    ...
    if (completed) {
      FormCheckbox = FormCheckbox(5787).FormCheckbox;
      obj7 = { checked: true };
      trailing = tmp16(FormCheckbox, obj7);
    } else if (trailing == null) {
      trailing = tmp16(tmp17(7333).Arrow, {});
    }
