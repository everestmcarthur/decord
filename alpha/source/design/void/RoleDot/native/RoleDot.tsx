...
// Function ID: 14332
// Name: RoleDot
// Dependencies: [19, 17, 21, 4722, 576, 1364, 5151, 5173, 5156, 1370, 2]
// Exports: RoleDot

// Module 14331 (RoleDot)
...
const LinearGradientDefault = tmp5(5156);
require = fn;
  ...
  if (tmp6) {
    if (null != colors) {
      if (null != colors.secondaryColor) {
        ...
        obj6.colors = items5.filter(tmp2(1370).isNotNullish);
        obj6.start = { x: 0, y: 0 };
        obj6.end = { x: 1, y: 0 };
