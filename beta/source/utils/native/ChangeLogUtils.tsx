...
// Dependencies: [19, 17, 21, 4788, 576, 5690, 5238, 4784, 7257, 8386, 1929, 2]

// Module 8385 (utils/ChangeLogUtils)
import nativeDefault from "native" /* 576 */;
import _modDef1929 from "module_1929" /* 1929 */;
import Text_Text from "Text/Text" /* 4784 */;
import noop from "module_19" /* 19 */;
import CustomMarkup from "CustomMarkup" /* 5238 */;
...
function ChangeLogStrong(arg0) {
  ...
  if (obj.useManaTypeConsolidationExperiment("ChangeLogStrong")) {
    ...
    const obj2 = { variant: "experimental/body-sm/semibold", color: str, children: tmp(8386).smartOutput(node, output, state) };
    let reactResult = jsx(tmp(4784).Text, { variant: "experimental/body-sm/semibold", color: str, children: tmp(8386).smartOutput(node, output, state) });
...
function ChangeLogImage(arg0) {
  ...
  const obj2 = { uri: _modDef1929.sanitizeUrl(node.target) };
  obj.source = obj2;
...
obj2.container = { borderLeftWidth: 2, paddingLeft: 8, marginBottom: 10, borderLeftColor: fn(5690).DARK_PRIMARY_500_LIGHT_PRIMARY_300 };
const obj4 = { borderLeftWidth: 2, paddingLeft: 8, marginBottom: 10, borderLeftColor: fn(5690).DARK_PRIMARY_500_LIGHT_PRIMARY_300 };
