...
// Function ID: 14116
// Name: VoiceQuality
// Dependencies: [32, 8016, 4846, 14116, 8022, 4843, 12, 4817, 2]

// Module 14115 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4817).now());
