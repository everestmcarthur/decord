...
// Function ID: 14439
// Name: AIShimmer
// Dependencies: [32, 19, 17, 21, 4788, 14439, 4498, 4784, 14440, 4524, 14441, 14442, 14436, 2]

// Module 14438 (AIShimmer)
import ReanimatedRexport from "ReanimatedRexport" /* 4524 */;
import Text_Text from "Text/Text" /* 4784 */;
import AIShimmerTypes from "AIShimmerTypes" /* 14439 */;
import waveTransition2 from "waveTransition" /* 14440 */;
import createWaveTransition from "createWaveTransition" /* 14442 */;
...
function ShimmerLayers(pass) {
  ...
  const obj5 = pass(4524);
  fn.__closure = { animationProgress: animationProgress2, bandEdgesAt: pass(14440).bandEdgesAt, animationWidth: animationWidth2, overshoot: overshoot2, glyphLayerOpacityAt: pass(14440).glyphLayerOpacityAt, easeTail: pass(14440).easeTail };
  ...
  const obj6 = { animationProgress: animationProgress2, bandEdgesAt: pass(14440).bandEdgesAt, animationWidth: animationWidth2, overshoot: overshoot2, glyphLayerOpacityAt: pass(14440).glyphLayerOpacityAt, easeTail: pass(14440).easeTail };
  class T {
    constructor() {
  ...
  const animatedStyle = pass(4524).useAnimatedStyle(T);
  const obj7 = pass(4524);
  ...
  const animatedStyle1 = pass(4524).useAnimatedStyle(fn2);
  const obj8 = pass(4524);
  ...
  const animatedStyle2 = pass(4524).useAnimatedStyle(fn3);
  const obj9 = pass(4524);
  ...
  const animatedStyle3 = pass(4524).useAnimatedStyle(fn4);
