...
// Function ID: 8912
// Name: FormInput
// Dependencies: [19, 1074, 21, 4788, 576, 1364, 4498, 4639, 5935, 7362, 6880, 1177, 2]

// Module 8911 (FormInput)
...
const shared = TextArea(4639);
const RedesignCompat = TextArea(5935);
const TextInput = TextArea(6880);
const TextArea2 = TextArea(7362);
require = fn;
