...
// Function ID: 8921
// Name: FormSliderRow
// Dependencies: [19, 17, 21, 4788, 5935, 5856, 4784, 8581, 7414, 2]
// Exports: default

// Module 8920 (FormSliderRow)
...
export default function FormSliderRow(arg0) {
  ...
  if (context) {
    ...
    const items = [hasOwnProperty(tmp2(4784).Text, obj4), trailing];
    obj3.children = items;
    const items1 = [tmp6(View, obj3), ];
    const obj5 = {};
    const merged1 = Object.assign(merged);
    obj5.style = tmp5.slider;
    items1[1] = hasOwnProperty(_modDef8581, obj5);
    ...
    items2[1] = hasOwnProperty(_modDef8581, obj7);
    obj.children = items2;
