...
// Dependencies: [19, 17, 21, 4788, 1364, 5935, 6880, 1177, 7213, 7214, 7216, 4784, 2]

// Module 6879 (FreeFormInputGroup)
import PlatformUtils from "PlatformUtils" /* 1364 */;
import RedesignCompat from "RedesignCompat" /* 5935 */;
import FreeFormLabelDefault from "FreeFormLabel" /* 7213 */;
import FreeFormTextInputDefault from "FreeFormTextInput" /* 7214 */;
import FreeFormErrorLabelDefault from "FreeFormErrorLabel" /* 7216 */;
...
export default noop.forwardRef((accessibilityLabel, ref) => {
  ...
  if (context) {
    ...
    return hasOwnProperty(tmp8(6880).TextInput, obj3);
  } else {
    ...
    if (null != hint) {
      ...
      tmp17Result2 = tmp17(tmp8(4784).Text, obj8);
    }
