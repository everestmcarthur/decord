...
// Dependencies: [19, 17, 21, 4788, 576, 5371, 1115, 1177, 7215, 38, 2]

// Module 7214 (FreeFormTextInput)
...
function ClearButton(onPress) {
  ...
  const tmp = closure_9();
  obj.children = React5(native.Icon, { source: _modDef7215, style: closure_9().closeIcon, size: native.Icon.Sizes.MEDIUM });
