...
// Function ID: 5229
// Name: ButtonPill
// Dependencies: [32, 19, 17, 21, 5223, 4788, 576, 5224, 4498, 4489, 5229, 5230, 4524, 4639, 5234, 4508, 5217, 5221, 2]
// Exports: ButtonPill
  ...
  if ("experimental_premium-primary" !== variant) {
    if ("experimental_premium-basic" !== variant) {
      ...
      if (tmp11Result) {
        ...
        obj8.children = React5(tmp(4498).ExpressiveButtonRive, obj9);
      ...
      items3[1] = tmp9(tmp6(4524).View, obj12);
...
function useLoadingStyles(flag, DEFAULT_BUTTON_SIZE) {
  ...
  const fn = function o() {
    ...
    if (enabled) {
      ...
      if (!tmp3) {
        withDelayResult = tmp(4524).withDelay(c10, withSpringResult);
      ...
      const obj3 = { translateY: tmp(5217).withSpring(num2, tmp(5221).SUBTLE_SPRING) };
      const items1 = [obj3];
...
let c10 = 300;
let ButtonConstants = fn(5223);
const paddingVertical = ButtonConstants.getButtonPadding(fn(5223).SMALL_BUTTON_HEIGHT, fn(5223).SMALL_BUTTON_ICON_SIZE);
ButtonConstants = fn(5223);
const paddingVertical2 = ButtonConstants.getButtonPadding(fn(5223).MEDIUM_BUTTON_HEIGHT, fn(5223).MEDIUM_BUTTON_ICON_SIZE);
ButtonConstants = fn(5223);
const paddingVertical3 = ButtonConstants.getButtonPadding(fn(5223).LARGE_BUTTON_HEIGHT, fn(5223).LARGE_BUTTON_ICON_SIZE);
