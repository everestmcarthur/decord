...
// Function ID: 5220
// Name: BaseTextButton
// Dependencies: [32, 19, 17, 21, 4788, 576, 4524, 5220, 5217, 5221, 5223, 1364, 5224, 4784, 4508, 4756, 5226, 4491, 5228, 2]

// Module 5219 (BaseTextButton)
...
const LARGE_BUTTON_HEIGHT = fn(5223).LARGE_BUTTON_HEIGHT;
const bound = Math.max((fn(5223).MINIMUM_HIT_AREA - fn(5223).SMALL_BUTTON_HEIGHT) / 2, 0);
const rect = { top: bound, left: "Array", right: "call", bottom: bound };
obj6.sm = rect;
const LARGE_BUTTON_HEIGHT2 = fn(5223).LARGE_BUTTON_HEIGHT;
const bound1 = Math.max((fn(5223).MINIMUM_HIT_AREA - fn(5223).MEDIUM_BUTTON_HEIGHT) / 2, 0);
const rect1 = { top: bound1, left: "Array", right: "call", bottom: bound1 };
obj6.md = rect1;
const bound2 = Math.max((fn(5223).MINIMUM_HIT_AREA - fn(5223).LARGE_BUTTON_HEIGHT) / 2, 0);
