...
// Function ID: 5235
// Name: ButtonEllipsis
// Dependencies: [19, 21, 4524, 4788, 576, 4789, 5224, 5235, 2]
// Exports: Ellipsis
  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        const tmp5Result3 = tmp5(4524);
        tmp11(tmp5Result.withDelay(result1, tmp5Result3.withRepeat(tmp5(4789).withTiming(1, tmp8, "animate-always"), -1, true)));
        return () => {
...
ELLIPSIS_APPEAR_TIMING.easing = Easing.inOut(fn(4524).Easing.quad);
...
withEllipsisAnimation.__closure = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: fn(4524).withDelay, withRepeat: fn(4524).withRepeat, withTiming: fn(4789).withTiming, ELLIPSIS_APPEAR_TIMING };
