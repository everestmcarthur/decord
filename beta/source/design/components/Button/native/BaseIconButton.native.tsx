...
// Function ID: 8213
// Name: BaseIconButton
// Dependencies: [19, 21, 4788, 5223, 4524, 5220, 5224, 5226, 5228, 2]

// Module 8212 (BaseIconButton)
...
import Button_BaseButton from "Button/BaseButton" /* 5226 */;
...
export const BaseIconButton = noop.forwardRef((variant, ref) => {
  ...
  if ("sm" === DEFAULT_BUTTON_SIZE) {
    MEDIUM_BUTTON_HEIGHT = tmp4(5223).SMALL_BUTTON_HEIGHT;
  } else if ("md" === DEFAULT_BUTTON_SIZE) {
    MEDIUM_BUTTON_HEIGHT = tmp4(5223).MEDIUM_BUTTON_HEIGHT;
  }
  const bound = Math.max((tmp4(5223).MINIMUM_HIT_AREA - MEDIUM_BUTTON_HEIGHT) / 2, 0);
  const obj4 = {};
