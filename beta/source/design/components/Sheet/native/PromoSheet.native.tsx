...
// Function ID: 10528
// Name: PromoSheet
// Dependencies: [109, 19, 17, 21, 4788, 576, 10528, 7427, 5216, 10529, 4784, 2]
// Exports: PromoSheet

// Module 10527 (PromoSheet)
...
export const PromoSheet = function PromoSheet(arg0) {
  ...
  const memo = noop.useMemo(() => null != gradientColor ? ((arg0) => {
    ...
    obj.children = closure_2_7(gradientColor(10528).ExpressiveGradient, { offsetBottom: 0.25, color, backgroundColor: nativeDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND });
  ...
  if (null != graphic) {
    ...
    let tmp4Result = tmp4(tmp5(10529).Graphic, obj2);
  } else {
    tmp4Result = null;
  ...
  const items2 = [closure_7(gradientColor(4784).Text, { variant: "heading-xl/semibold", color: "mobile-text-heading-primary", style: tmp2.title, children: title }), ];
  ...
  if (null != description) {
    ...
    tmp4Result2 = tmp4(tmp5(4784).Text, obj5);
  }
  const obj6 = { spacing: 24, children: null };
  items2[1] = tmp4Result2;
  items1[1] = closure_8(gradientColor(5216).Stack, { children: items2 });
  items1[2] = actions;
  obj6.children = items1;
  obj.children = closure_8(gradientColor(5216).Stack, obj6);
  return closure_7(gradientColor(7427).BottomSheet, obj);
};
