...
// Dependencies: [32, 19, 17, 7428, 21, 4788, 576, 1364, 1612, 5203, 6901, 5931, 5230, 1094, 4524, 7429, 4508, 7430, 5235, 7431, 7432, 7317, 1478, 4641, 7433, 4498, 2]

// Module 7427 (Sheet/BottomSheet)
...
import Sheet_BottomSheetBackdrop from "Sheet/BottomSheetBackdrop" /* 7432 */;
...
const ActionSheetConstants = fn(7428);
...
let closure_19 = noop.forwardRef((windowDimensions, ref) => {
  ...
  if (!isScreenReaderEnabled) {
    ...
    if (maxDynamicContentSize == null) {
      maxDynamicContentSize = height - tmp4(5931).NAV_BAR_HEIGHT_MULTILINE - useSafeAreaInsetsDefault().top;
    }
    ...
    obj3.children = value2(tmp4(6901).BottomSheetScrollView, obj4);
...
let closure_20 = noop.forwardRef((windowDimensions, ref) => {
  ...
  if (maxHeight == null) {
    maxHeight = height - tmp5(5931).NAV_BAR_HEIGHT_MULTILINE - useSafeAreaInsetsDefault().top;
  }
