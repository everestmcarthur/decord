...
// Function ID: 5147
// Name: AlertModal
// Dependencies: [5, 32, 718, 19, 17, 1085, 21, 4788, 576, 4498, 5142, 4524, 1875, 5147, 5199, 1248, 5204, 1115, 4508, 1612, 5212, 1478, 5213, 5216, 4784, 5217, 5218, 2]
// Exports: showConfirmModal, useDismissModalCallback

// Module 5146 (AlertModal)
...
function AlertModalBackdrop() {
  ...
  dependencyMap = tmp4;
  const alertStore = context(5142).useAlertStore((arg0) => {
  ...
  let obj2 = context(4524);
  fn.__closure = { withAlertModalSpring, sharedVisible: tmp2[1], sharedTransitionState, TransitionStates: context(4498).TransitionStates, runOnJS: context(4524).runOnJS, cleanUp: context };
  ...
  return closure_10(context(5204).Backdrop, obj4);
}
class AlertModal {
  constructor(arg0) {
...
let context = noop.createContext(fn(4498).TransitionStates.YEETED);
...
let obj4 = { withSpring: fn(5217).withSpring, MODAL_SPRING: obj3 };
