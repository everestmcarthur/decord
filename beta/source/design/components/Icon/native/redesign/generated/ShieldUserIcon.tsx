...
// Function ID: 9873
// Name: ShieldUserIcon
// Dependencies: [19, 21, 576, 4488, 8424, 2]
// Exports: ShieldUserIcon

// Module 9872 (ShieldUserIcon)
...
export const ShieldUserIcon = function ShieldUserIcon(tmp2Result) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8424, color: INTERACTIVE_ICON_DEFAULT, style: tmp2Result.style });
};
