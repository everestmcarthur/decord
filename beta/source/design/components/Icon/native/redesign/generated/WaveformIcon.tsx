...
// Function ID: 10428
// Name: WaveformIcon
// Dependencies: [19, 21, 576, 4488, 10428, 2]
// Exports: WaveformIcon

// Module 10427 (WaveformIcon)
...
export const WaveformIcon = function WaveformIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10428, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
