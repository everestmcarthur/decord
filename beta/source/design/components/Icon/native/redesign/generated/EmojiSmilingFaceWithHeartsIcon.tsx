...
// Dependencies: [19, 21, 576, 4488, 15680, 2]
// Exports: EmojiSmilingFaceWithHeartsIcon

// Module 15679 (EmojiSmilingFaceWithHeartsIcon)
...
export const EmojiSmilingFaceWithHeartsIcon = function EmojiSmilingFaceWithHeartsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15680, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
