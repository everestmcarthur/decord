...
// Dependencies: [19, 21, 576, 4488, 8748, 2]
// Exports: VideoSelfieIcon

// Module 8747 (VideoSelfieIcon)
...
export const VideoSelfieIcon = function VideoSelfieIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8748, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
