...
// Dependencies: [19, 21, 576, 4488, 10257, 2]
// Exports: SpeedometerIcon

// Module 10256 (SpeedometerIcon)
...
export const SpeedometerIcon = function SpeedometerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10257, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
