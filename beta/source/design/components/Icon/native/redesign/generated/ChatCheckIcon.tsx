...
// Function ID: 15169
// Name: ChatCheckIcon
// Dependencies: [19, 21, 576, 4488, 15169, 2]
// Exports: ChatCheckIcon

// Module 15168 (ChatCheckIcon)
...
export const ChatCheckIcon = function ChatCheckIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15169, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
