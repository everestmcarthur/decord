...
// Function ID: 10448
// Name: MagicWandIcon
// Dependencies: [19, 21, 576, 4488, 10448, 2]
// Exports: MagicWandIcon

// Module 10447 (MagicWandIcon)
...
export const MagicWandIcon = function MagicWandIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10448, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
