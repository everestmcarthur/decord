...
// Dependencies: [19, 21, 576, 4488, 12434, 2]
// Exports: ArrowsUpDownIcon

// Module 12433 (ArrowsUpDownIcon)
...
export const ArrowsUpDownIcon = function ArrowsUpDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12434, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
