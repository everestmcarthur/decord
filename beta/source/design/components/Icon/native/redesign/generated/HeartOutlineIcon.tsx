...
// Dependencies: [19, 21, 576, 4488, 9152, 2]
// Exports: HeartOutlineIcon

// Module 9151 (HeartOutlineIcon)
...
export const HeartOutlineIcon = function HeartOutlineIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9152, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
