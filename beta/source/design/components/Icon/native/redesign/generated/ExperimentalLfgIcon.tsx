...
// Dependencies: [19, 21, 576, 4488, 5303, 2]
// Exports: ExperimentalLfgIcon

// Module 5320 (ExperimentalLfgIcon)
...
export const ExperimentalLfgIcon = function ExperimentalLfgIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5303, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
