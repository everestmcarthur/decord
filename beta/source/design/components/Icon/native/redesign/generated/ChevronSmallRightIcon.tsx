...
// Dependencies: [19, 21, 576, 4488, 5862, 2]
// Exports: ChevronSmallRightIcon

// Module 7486 (ChevronSmallRightIcon)
...
export const ChevronSmallRightIcon = function ChevronSmallRightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5862, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
