...
// Function ID: 9179
// Name: PlusSmallIcon
// Dependencies: [19, 21, 576, 4488, 9179, 2]
// Exports: PlusSmallIcon

// Module 9178 (PlusSmallIcon)
...
export const PlusSmallIcon = function PlusSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9179, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
