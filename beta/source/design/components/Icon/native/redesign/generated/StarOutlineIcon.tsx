...
// Dependencies: [19, 21, 576, 4488, 10539, 2]
// Exports: StarOutlineIcon

// Module 10538 (StarOutlineIcon)
...
export const StarOutlineIcon = function StarOutlineIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10539, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
