...
// Dependencies: [19, 21, 576, 4488, 15640, 2]
// Exports: EmojiColdFaceIcon

// Module 15639 (EmojiColdFaceIcon)
...
export const EmojiColdFaceIcon = function EmojiColdFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15640, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
