...
// Function ID: 10430
// Name: FileIcon
// Dependencies: [19, 21, 576, 4488, 10430, 2]
// Exports: FileIcon

// Module 10429 (FileIcon)
...
export const FileIcon = function FileIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10430, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
