...
// Function ID: 5865
// Name: DragIcon
// Dependencies: [19, 21, 576, 4488, 5865, 2]
// Exports: DragIcon

// Module 5864 (DragIcon)
...
export const DragIcon = function DragIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5865, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
