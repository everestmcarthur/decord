...
// Dependencies: [19, 21, 576, 4488, 15678, 2]
// Exports: EmojiRollingOnTheFloorLaughingIcon

// Module 15677 (EmojiRollingOnTheFloorLaughingIcon)
...
export const EmojiRollingOnTheFloorLaughingIcon = function EmojiRollingOnTheFloorLaughingIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15678, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
