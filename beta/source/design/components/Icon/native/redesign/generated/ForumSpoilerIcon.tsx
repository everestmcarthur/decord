...
// Dependencies: [19, 21, 576, 4488, 5294, 2]
// Exports: ForumSpoilerIcon

// Module 5333 (ForumSpoilerIcon)
...
export const ForumSpoilerIcon = function ForumSpoilerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5294, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
