...
// Dependencies: [19, 21, 576, 4488, 5318, 2]
// Exports: AnnouncementsLockIcon

// Module 5343 (AnnouncementsLockIcon)
...
export const AnnouncementsLockIcon = function AnnouncementsLockIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5318, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
