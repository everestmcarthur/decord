...
// Dependencies: [19, 21, 576, 4488, 4727, 2]
// Exports: UserPlatformIcon

// Module 4726 (UserPlatformIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4488 */;
import _mod4727 from "module_4727" /* 4727 */;
...
export const UserPlatformIcon = function UserPlatformIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4727, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
