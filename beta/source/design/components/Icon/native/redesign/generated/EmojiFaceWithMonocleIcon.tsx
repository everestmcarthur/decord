...
// Dependencies: [19, 21, 576, 4488, 15650, 2]
// Exports: EmojiFaceWithMonocleIcon

// Module 15649 (EmojiFaceWithMonocleIcon)
...
export const EmojiFaceWithMonocleIcon = function EmojiFaceWithMonocleIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15650, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
