...
// Dependencies: [19, 21, 576, 4488, 15668, 2]
// Exports: EmojiSmilingFaceWithSunglassesIcon

// Module 15667 (EmojiSmilingFaceWithSunglassesIcon)
...
export const EmojiSmilingFaceWithSunglassesIcon = function EmojiSmilingFaceWithSunglassesIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15668, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
