...
// Function ID: 8205
// Name: ThumbsDownIcon
// Dependencies: [19, 21, 576, 4488, 8205, 2]
// Exports: ThumbsDownIcon

// Module 8204 (ThumbsDownIcon)
...
export const ThumbsDownIcon = function ThumbsDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8205, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
