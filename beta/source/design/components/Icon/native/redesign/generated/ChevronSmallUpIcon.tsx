...
// Dependencies: [19, 21, 576, 4488, 12928, 2]
// Exports: ChevronSmallUpIcon

// Module 13865 (ChevronSmallUpIcon)
...
export const ChevronSmallUpIcon = function ChevronSmallUpIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12928, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
