...
// Function ID: 11253
// Name: InboxIcon
// Dependencies: [19, 21, 576, 4488, 11253, 2]
// Exports: InboxIcon

// Module 11252 (InboxIcon)
...
export const InboxIcon = function InboxIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11253, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
