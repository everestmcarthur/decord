...
// Function ID: 14141
// Name: SignPostIcon
// Dependencies: [19, 21, 576, 4488, 14141, 2]
// Exports: SignPostIcon

// Module 14140 (SignPostIcon)
...
export const SignPostIcon = function SignPostIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod14141, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
