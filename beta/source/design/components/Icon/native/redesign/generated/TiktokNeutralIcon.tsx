...
// Dependencies: [19, 21, 576, 4488, 12638, 2]
// Exports: TiktokNeutralIcon

// Module 12637 (TiktokNeutralIcon)
...
export const TiktokNeutralIcon = function TiktokNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12638, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
