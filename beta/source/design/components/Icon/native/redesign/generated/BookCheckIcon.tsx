...
// Function ID: 5326
// Name: BookCheckIcon
// Dependencies: [19, 21, 576, 4488, 5313, 2]
// Exports: BookCheckIcon

// Module 5325 (BookCheckIcon)
...
export const BookCheckIcon = function BookCheckIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5313, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
