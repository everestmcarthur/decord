...
// Function ID: 11500
// Name: CirclePlusIcon
// Dependencies: [19, 17, 21, 576, 4488, 11500, 11501, 2]
// Exports: CirclePlusIcon

// Module 11499 (CirclePlusIcon)
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod11500, color: secondaryColor, style }), ];
  const obj3 = { source: _mod11501, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
