...
// Dependencies: [19, 17, 21, 576, 4488, 4743, 4744, 2]
// Exports: CircleInformationIcon

// Module 4742 (CircleInformationIcon)
...
export const CircleInformationIcon = function CircleInformationIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod4743, color: secondaryColor, style }), ];
  const obj3 = { source: _mod4744, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
