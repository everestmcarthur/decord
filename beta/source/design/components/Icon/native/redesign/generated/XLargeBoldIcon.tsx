...
// Function ID: 10024
// Name: XLargeBoldIcon
// Dependencies: [19, 21, 576, 4488, 10024, 2]
// Exports: XLargeBoldIcon

// Module 10023 (XLargeBoldIcon)
...
export const XLargeBoldIcon = function XLargeBoldIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10024, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
