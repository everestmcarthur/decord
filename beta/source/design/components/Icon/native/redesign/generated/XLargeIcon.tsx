...
// Function ID: 4741
// Name: XLargeIcon
// Dependencies: [19, 21, 576, 4488, 4741, 2]
// Exports: XLargeIcon

// Module 4740 (XLargeIcon)
...
export const XLargeIcon = function XLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4741, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
