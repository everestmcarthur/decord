...
// Function ID: 10302
// Name: MicrophoneIcon
// Dependencies: [19, 21, 576, 4488, 10302, 2]
// Exports: MicrophoneIcon

// Module 10301 (MicrophoneIcon)
...
export const MicrophoneIcon = function MicrophoneIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10302, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
