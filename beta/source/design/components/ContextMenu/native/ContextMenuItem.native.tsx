...
// Dependencies: [19, 17, 21, 4524, 4788, 8208, 576, 8207, 5217, 5221, 5220, 4784, 2]
// Exports: ContextMenuItem

// Module 14477 (ContextMenuItem)
    ...
    if (null != arg1) {
      if (arg0 !== arg1) {
        ...
        if (null != measureResult) {
          ...
          const result = index * tmp2(8207).INDEX_BOUNDS_OFFSET;
          value = itemMeasurements.get();
          value[result + tmp2(8207).INDEX_BOUNDS_PAGE_X_OFFSET] = pageX;
          const value4 = itemMeasurements.get();
          value4[result + tmp2(8207).INDEX_BOUNDS_PAGE_Y_OFFSET] = pageY;
          const value5 = itemMeasurements.get();
          value5[result + tmp2(8207).INDEX_BOUNDS_WIDTH_OFFSET] = width;
          const value6 = itemMeasurements.get();
          value6[result + tmp2(8207).INDEX_BOUNDS_HEIGHT_OFFSET] = height;
        }
      }
    }
  };
