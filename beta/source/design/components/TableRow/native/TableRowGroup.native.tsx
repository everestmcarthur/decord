...
// Function ID: 5937
// Name: TableRowGroup
// Dependencies: [19, 17, 21, 4788, 576, 4784, 4489, 5851, 5855, 2]
// Exports: TableRowGroup

// Module 5936 (TableRowGroup)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4489 */;
import Text_Text from "Text/Text" /* 4784 */;
import TableRowDivider from "TableRowDivider" /* 5851 */;
...
export const TableRowGroup = function TableRowGroup(accessibilityLabel) {
  ...
  if (tmp6Result3) {
    ...
    tmp6Result3 = tmp6(tmp2(4784).Text, obj4);
  }
  items[1] = tmp6Result3;
  ...
  if (tmp6Result4) {
    ...
    tmp6Result4 = tmp6(tmp2(4784).Text, obj5);
  }
  items[3] = tmp6Result4;
  obj2.children = items;
