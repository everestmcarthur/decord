...
// Dependencies: [5, 19, 17, 1074, 21, 4788, 576, 4784, 5874, 5877, 1485, 5879, 1115, 5880, 5929, 1364, 1612, 5931, 2]
...
// Module 5873 (NavigatorHeader)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import Text_Text from "Text/Text" /* 4784 */;
import HeaderDebugOverlayDefault from "HeaderDebugOverlay" /* 5874 */;
...
function CloseButton(onPress) {
  ...
  return closure_6(require("module_5880").HeaderBackButton, obj2);
}
function CustomHeaderBackButton(onPress) {
  onPress = onPress.onPress;
  const merged = Object.assign(onPress, Object.assign({ onPress: 0 }));
  onPress(5879).useNavigatorBackPressHandler(() => {
    if (null != onPress) {
      tmp();
    }
    return null != onPress;
  ...
  return closure_6(onPress(5880).HeaderBackButton, obj2);
}
function HeaderTextButton(text) {
  ...
  return timestampProducer(_mod5880.HeaderBackButton, obj2);
}
...
let obj4 = {};
let merged = Object.assign(fn(4784).TextStyleSheet["redesign/heading-18/bold"]);
