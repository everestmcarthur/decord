...
// Dependencies: [19, 21, 5223, 4788, 4524, 5217, 5221, 5219, 9223, 576, 2]
// Exports: CollapsibleFloatingActionButton

// Module 9222 (CollapsibleFloatingActionButton)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4524 */;
import spring from "spring" /* 5217 */;
import springPresets from "springPresets" /* 5221 */;
import ButtonConstants2 from "ButtonConstants" /* 5223 */;
...
function CollapsableButton(arg0) {
  ...
  let obj = collapseText(4524);
  B.__closure = { FAB_BUTTON_SIZE: collapseText(5223).FAB_BUTTON_SIZE, withSpring: collapseText(5217).withSpring, interpolate: collapseText(4524).interpolate, collapseText, FAB_PADDING_HORIZONTAL: 20, FAB_PADDING_VERTICAL: buttonPadding, SUBTLE_SPRING: collapseText(5221).SUBTLE_SPRING };
  ...
  return jsx(collapseText(5219).BaseTextButton, {});
}
const jsx = fn(21).jsx;
const ButtonConstants = fn(5223);
const buttonPadding = ButtonConstants.getButtonPadding(fn(5223).FAB_BUTTON_SIZE, fn(5223).FAB_BUTTON_ICON_SIZE);
...
export const CollapsibleFloatingActionButton = function CollapsibleFloatingActionButton(arg0) {
  ...
  if (positionRight == null) {
    positionRight = tmp3(9223).DEFAULT_POSITION_OFFSET;
  }
  const rect = { position: "absolute", right: positionRight, bottom: null };
  if (positionBottom == null) {
    positionBottom = tmp3(9223).DEFAULT_POSITION_OFFSET;
  }
  ...
  if (null != state) {
    ...
    tmp12 = jsx(tmp3(5219).BaseTextButton, {});
  }
  return tmp12;
};
