// Module ID: 14351
// Function ID: 14352
// Dependencies: [14345, 14316, 14336]
...
export default (arg0, arg1) => {
  obj = new obj(14345)(arg0, arg1);
  const tmp3 = new obj(14316)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14316)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14316(semver.semver.version);
