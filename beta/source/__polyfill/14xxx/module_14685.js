// Module ID: 14685
// Function ID: 14686
// Dependencies: [14686, 14687, 1252, 14688]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14688.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14688.percentDecode(_Buffer.from(buffer));
  }
}
