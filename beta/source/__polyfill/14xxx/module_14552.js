// Module ID: 14552
// Function ID: 14553
// Dependencies: [14553, 1161, 14554]
// Exports: findBestMatch, invariant

// Module 14552
import e from "e" /* 1161 */;
import data from "data" /* 14553 */;
import regions from "regions" /* 14554 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14553).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14553).data.supplemental.languageMatching["written-new"];
