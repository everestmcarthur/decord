// Module ID: 14316
// Function ID: 14317
// Dependencies: [41, 42, 14317, 14318, 14319, 14320, 14321]
...
let items = [
  ...
  },
  {
    ...
    value: function compare(tmp2Result) {
      const self = this;
      SemVer(14319)("SemVer.compare", this.version, this.options, tmp2Result);
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      let compareIdentifiersResult = SemVer(14321).compareIdentifiers(self.major, tmpResult.major);
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14321).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(14321);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14321).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(14321);
      }
  ...
  },
  {
    ...
    value: function comparePre(tmp2Result) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14319)("prerelease compare", num3, tmp3, tmp4);
  ...
  },
  {
    ...
    value: function compareBuild(arg0) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14319)("build compare", num, tmp3, tmp4);
        let tmp11 = undefined === tmp3;
        if (tmp11) {
          if (undefined === tmp4) {
            break;
