// Module ID: 14343
// Function ID: 14344
// Dependencies: [14316, 14320, 14315]
...
export default (num, arg1) => {
  if (num instanceof _mod14316) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14320).safeRe;
        const t2 = tmp(14320).t;
      ...
      if (null === match2) {
        ...
        return _mod14315("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
