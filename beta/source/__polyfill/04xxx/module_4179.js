// Module ID: 4179
// Function ID: 4180
// Dependencies: [4123, 4110, 3877, 4127, 4122, 4040, 3881, 3878, 3882, 4180, 4124, 4181]
// Exports: default

// Module 4179
import throwProtectedError from "throwProtectedError" /* 4124 */;
import parsers from "parsers" /* 4181 */;
...
import dateLongFormatter_mod from "dateLongFormatter" /* 4122 */;
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("module_3882").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3881.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3881.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4180).DateToSystemTimezoneSetter();
