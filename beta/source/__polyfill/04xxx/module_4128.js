// Module ID: 4128
// Function ID: 4129
// Dependencies: [4040, 4053, 3877, 4126, 4127, 4123, 3878, 3882]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_4040.default(defaultResult5) - module_4040.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_4040.default(defaultResult5);
    }
  } else {
