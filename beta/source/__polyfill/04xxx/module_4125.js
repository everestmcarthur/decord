// Module ID: 4125
// Function ID: 4126
// Dependencies: [4053, 4075, 4080, 4123, 3877, 4126, 4127, 4040, 3878, 3882]
// Exports: default
...
import cloneObject_mod from "cloneObject" /* 4126 */;
...
if (!module_4040) {
  const obj8 = { default: module_4040 };
  let tmp17 = obj8;
} else {
  tmp17 = module_4040;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_4040.default(defaultResult5) - module_4040.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_4040.default(defaultResult5);
    }
  } else {
