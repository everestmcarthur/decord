// Module ID: 4616
// Function ID: 4617
// Dependencies: [19, 4617, 1108, 1109, 1102, 4620]
...
export const MemoryRouter = Component2(4620).MemoryRouter;
export const Prompt = Component2(4620).Prompt;
export const Redirect = Component2(4620).Redirect;
export const Route = Component2(4620).Route;
export const Router = Component2(4620).Router;
export const StaticRouter = Component2(4620).StaticRouter;
export const Switch = Component2(4620).Switch;
export const generatePath = Component2(4620).generatePath;
export const matchPath = Component2(4620).matchPath;
export const useHistory = Component2(4620).useHistory;
export const useLocation = Component2(4620).useLocation;
export const useParams = Component2(4620).useParams;
export const useRouteMatch = Component2(4620).useRouteMatch;
export const withRouter = Component2(4620).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4620).matchPath(_location.pathname, obj2);
          const obj = Component2(4620);
        }
