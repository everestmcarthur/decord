// Module ID: 4621
// Function ID: 4622
// Dependencies: [19, 4617, 1108, 1109, 4622, 4624, 4626, 1102]
...
import parse_mod from "module_4622" /* 4622 */;
import AsyncMode from "AsyncMode" /* 4624 */;
import module_4626_mod from "module_4626" /* 4626 */;
...
let module_4626 = module_4626_mod;
if (module_4626) {
  if (typeof module_4626 === "object") {
    if ("default" in module_4626) {
      module_4626 = module_4626.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F128301 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4626(fn, displayName);
};
