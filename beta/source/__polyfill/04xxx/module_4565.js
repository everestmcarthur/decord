// Module ID: 4565
// Function ID: 4566
// Dependencies: [19, 4554, 4558, 4546]
// Exports: useViewModelInstance

// Module 4565
import ArtboardByIndex from "ArtboardByIndex" /* 4554 */;
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("module_4558").useDisposableMemo(() => {
    if (closure_0) {
      let tmp6 = null != obj;
      if (tmp6) {
