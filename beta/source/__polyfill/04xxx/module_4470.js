// Module ID: 4470
// Function ID: 4471
// Dependencies: [19, 4466, 1107, 1108, 4471, 4473, 4475, 1101]
...
import parse_mod from "module_4471" /* 4471 */;
import AsyncMode from "AsyncMode" /* 4473 */;
...
if (module_4475) {
  if (typeof module_4475 === "object") {
    if ("default" in module_4475) {
      module_4475 = module_4475.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F126112 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4475(fn, displayName);
};
