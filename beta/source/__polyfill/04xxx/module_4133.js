  ...
  if (arguments.length < 1) {
    ...
    if (module_4059.default(defaultResult)) {
      ...
      if ("time" !== StringResult1) {
        ...
        const combined = "".concat(module_4120.default(defaultResult.getFullYear(), 4));
        const combined1 = combined.concat(str10);
        const combined2 = combined1.concat(module_4120.default(defaultResult.getMonth() + 1, 2));
      ...
      if ("date" !== StringResult1) {
        ...
        combined10 = combined9.concat(module_4120.default(defaultResult.getSeconds(), 2));
        const defaultResult5 = module_4120.default(defaultResult.getSeconds(), 2);
      }
      return combined10;
    } else {
