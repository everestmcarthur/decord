// Module ID: 4109
// Function ID: 4110
// Dependencies: [4059, 4110, 3877, 4111, 4122, 4040, 3881, 3878, 4123, 3882, 4124]
// Exports: default
...
if (!module_3881) {
  const obj7 = { default: module_3881 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3881;
}
...
export default function format(arg0, arg1, locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3881.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_4059.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_4040.default(defaultResult3));
