...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.core = fn(require("module_9245"));
    fn2(_mod9311, exports);
    fn2(lt, exports);
    fn2(_mod9315, exports);
    fn2(_mod9314, exports);
    fn2(_mod9316, exports);
    require("module_9245").config(fn3(_mod9264).default());
    const _Object4 = Object;
    let obj = {
      enumerable: true,
      get() {
            return require("module_9245").globalRegistry;
          }
    };
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_9245").registry;
          }
    };
    ...
    const obj4 = {
      enumerable: true,
      get() {
            return require("module_9245").$output;
          }
    };
    ...
    const obj5 = {
      enumerable: true,
      get() {
            return require("module_9245").$input;
          }
    };
    ...
    const obj7 = {
      enumerable: true,
      get() {
            return require("module_9245").clone;
          }
    };
    ...
    const obj8 = {
      enumerable: true,
      get() {
            return require("module_9245").regexes;
          }
    };
    ...
    const obj9 = {
      enumerable: true,
      get() {
            return require("module_9245").treeifyError;
          }
    };
    ...
    const obj10 = {
      enumerable: true,
      get() {
            return require("module_9245").prettifyError;
          }
    };
    ...
    const obj11 = {
      enumerable: true,
      get() {
            return require("module_9245").formatError;
          }
    };
    ...
    const obj12 = {
      enumerable: true,
      get() {
            return require("module_9245").flattenError;
          }
    };
    ...
    const obj13 = {
      enumerable: true,
      get() {
            return require("module_9245").TimePrecision;
          }
    };
    ...
    const obj14 = {
      enumerable: true,
      get() {
            return require("module_9245").util;
          }
    };
    ...
    const obj15 = {
      enumerable: true,
      get() {
            return require("module_9245").NEVER;
          }
    };
    ...
    const obj18 = {
      enumerable: true,
      get() {
            return require("module_9313").ZodISODateTime;
          }
    };
    ...
    const obj19 = {
      enumerable: true,
      get() {
            return require("module_9313").ZodISODate;
          }
    };
    ...
    const obj20 = {
      enumerable: true,
      get() {
            return require("module_9313").ZodISOTime;
          }
    };
    ...
    const obj21 = {
      enumerable: true,
      get() {
            return require("module_9313").ZodISODuration;
          }
    };
    Object.defineProperty(exports, "ZodISODuration", obj21);
    exports.iso = fn(require("module_9313"));
    exports.coerce = fn(_mod9318);
  } else {
