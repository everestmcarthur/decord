// Module ID: 11347
// Function ID: 11348
// Dependencies: [5, 17, 11348, 11349, 11354, 11355, 11356, 11357, 11358]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11355 */;
import _modAll11356 from "module_11356" /* 11356 */;
import _modAll11357 from "module_11357" /* 11357 */;
import syncAll from "sync" /* 11358 */;
...
const subs = fn(11348).ProductType.subs;
const inapp = fn(11348).ProductType.inapp;
...
export const IapAndroid = _modAll11356;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11357;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11349).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11349.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11349.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11349.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11349.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11349.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11349).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11354).singleProductAndroidMap);
      return tmp2(11349).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11349).getAndroidModuleType();
      const androidModule = tmp2(11349).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11348).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11349).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11348).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11349).getAndroidModule();
            ...
            const androidModule1 = v3(11349).getAndroidModule();
