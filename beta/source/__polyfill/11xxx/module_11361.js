...
export const useIAP = () => {
  const iAPContext = require("module_11362").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11347").requestPurchase,
    requestSubscription: require("module_11347").requestSubscription
  };
};
