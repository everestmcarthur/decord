...
const obj = {
  ...
  2: { name: "GPSLatitude", description: fn(5487).getCalculatedGpsValue },
  3: {
...
const obj3 = { name: "GPSLatitude", description: fn(5487).getCalculatedGpsValue };
obj[4] = { name: "GPSLongitude", description: fn(5487).getCalculatedGpsValue };
obj[5] = {
  name: "GPSAltitudeRef",
  description(arg0) {
    let str = "Sea level";
...
const obj4 = { name: "GPSLongitude", description: fn(5487).getCalculatedGpsValue };
obj[27] = { name: "GPSProcessingMethod", description: fn(5487).getEncodedString };
const obj5 = { name: "GPSProcessingMethod", description: fn(5487).getEncodedString };
obj[28] = { name: "GPSAreaInformation", description: fn(5487).getEncodedString };
obj[30] = {
