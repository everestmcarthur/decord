// Module ID: 10167
// Function ID: 10168
// Dependencies: [10168, 10169, 10163]

// Module 10167
import _mod10163 from "module_10163" /* 10163 */;
import QRPolynomial from "QRPolynomial" /* 10168 */;
import array2 from "array2" /* 10169 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod10163.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(10163).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(10163).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(10163).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod10163.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(10163).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(10163).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(10163).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod10163.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(10163).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(10163).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(10163).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
