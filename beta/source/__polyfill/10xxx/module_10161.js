// Module ID: 10161
// Function ID: 10162
// Dependencies: [10162, 10164, 10166, 10167, 10168]

// Module 10161
import QR8bitByte from "QR8bitByte" /* 10162 */;
import QRRSBlock from "QRRSBlock" /* 10164 */;
import QRBitBuffer from "QRBitBuffer" /* 10166 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10167.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10167.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10167.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
