// Module ID: 7012
// Function ID: 7013
// Dependencies: [19, 6951, 6934, 7013, 6997, 6973, 6960, 6933]
// Exports: useGesture
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("module_7013").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      const NativeProxy = _mod6973.NativeProxy;
      ...
      return () => {
        closure_0(6997).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(6997);
        closure_0(6933).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
