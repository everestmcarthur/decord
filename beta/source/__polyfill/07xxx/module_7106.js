// Module ID: 7106
// Function ID: 7107
// Dependencies: [32, 109, 19, 21, 7107, 6906, 4661, 7108, 6918, 6903]

// Module 7106
import normalizeSnapPoint from "normalizeSnapPoint" /* 6918 */;
import id from "id" /* 7108 */;
...
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6906").useBottomSheetModalInternal();
