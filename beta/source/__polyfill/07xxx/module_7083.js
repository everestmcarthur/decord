// Module ID: 7083
// Function ID: 7084
// Dependencies: [19, 21, 6906, 1637, 6902, 6912]
// Exports: default
...
export default function _default(children) {
  ...
  if (useGestureEventsHandlersDefault === undefined) {
    useGestureEventsHandlersDefault = _mod6906.useGestureEventsHandlersDefault;
  }
  ...
  const gestureHandler = _mod6906.useGestureHandler(value2.GESTURE_SOURCE.CONTENT, animatedContentGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
  const gestureHandler1 = _mod6906.useGestureHandler(value2.GESTURE_SOURCE.HANDLE, animatedHandleGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
