// Module ID: 7048
// Function ID: 7049
// Dependencies: [32, 109, 19, 17, 21, 6934, 7030, 7031, 7032, 7033, 7049, 7027, 6952, 7025]
// Exports: default

// Module 7048
import tagMessage2 from "tagMessage" /* 6934 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 7030 */;
import StateMachineEvent2 from "StateMachineEvent" /* 7033 */;
import GestureObjects2 from "GestureObjects" /* 7049 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(7030).gestureToPressableEvent(arg0));
        let obj = hitSlop(7030);
      }
    };
