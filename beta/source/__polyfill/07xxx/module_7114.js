// Module ID: 7114
// Function ID: 7115
// Dependencies: [109, 19, 21, 6913, 6906, 7115, 1637, 6902, 6929, 7116]
...
import _mod7115 from "module_7115" /* 7115 */;
import ScrollableContainer from "ScrollableContainer" /* 7116 */;
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(SCROLLVIEW, animatedComponent) {
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const tmp6 = hasOwnProperty(_mod6913.BottomSheetDraggableContext);
    closure_3 = tmp6;
    ...
    const scrollHandler1 = _mod6906.useScrollHandler(scrollEventsHandlersHook, onScroll, onScrollBeginDrag, onScrollEndDrag, lockableScrollableContentOffsetY);
    ...
    const setContentSize = _mod7115.useBottomSheetContentSizeSetter().setContentSize;
    if (!tmp6) {
    ...
    const tmp4Result4 = _mod6906;
    const stableCallback = _mod6906.useStableCallback((arg0, arg1) => {
      setContentSize(arg1);
      if (closure_1_2) {
        tmp2(arg0, arg1);
      }
    });
    const bottomSheetContentContainerStyle = _mod6906.useBottomSheetContentContainerStyle(tmp, contentContainerStyle);
    timestampProducer(arg1, () => scrollableRef.current);
    const tmp4Result5 = _mod6906;
    const scrollableSetter = _mod6906.useScrollableSetter(scrollableRef, SCROLLVIEW, scrollableContentOffsetY, undefined !== onRefresh, focusHook);
