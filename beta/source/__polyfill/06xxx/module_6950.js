// Module ID: 6950
// Function ID: 6951
// Dependencies: [93, 95, 98, 42, 41, 6951, 6934]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6951).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6934).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6934);
      }
      return tmp;
    }
  }
