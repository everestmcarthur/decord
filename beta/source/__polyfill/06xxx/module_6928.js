// Module ID: 6928
// Function ID: 6929
// Dependencies: [6909, 1637, 6902, 6929]
...
export const useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  const bottomSheetInternal = require("module_6909").useBottomSheetInternal();
  ...
  const fn2 = function b(contentOffset, shouldLockInitialPosition) {
    ...
    } else if (animatedAnimationState.value !== tmp(6902).ANIMATION_STATE.RUNNING) {
      closure_1.value = y;
      sharedValue.value = y;
