// Module ID: 17696
// Function ID: 17697
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8760, 10170]
...
import emptyFunction_mod from "module_10170" /* 10170 */;
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = tmp23(tmp24(8760).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = tmp23(tmp24(8760).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(8760).G, obj3);
      const items1 = [timestampProducer(CircularProgress(8760).Svg, size2), ];
