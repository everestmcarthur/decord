...
const entry = {
  ...
  value: function __detach() {
    ...
    if (this.__isNative) {
      ...
      value = API.getValue(self.__getNativeTag(), (arg0) => {
        self._value = arg0 - self._offset;
      });
    }
    self.stopAnimation();
    let fn = hasOwnProperty(_getPrototypeOf(AnimatedValue.prototype), "__detach", self);
...
let items = [
  ...
  },
  {
    ...
    value: function __makeNative(arg0) {
      const self = this;
      let fn = hasOwnProperty(_getPrototypeOf(AnimatedValue.prototype), "__makeNative", this);
      if (typeof fn === "function") {
        fn = (items) => fn.apply(self, items);
      }
      const items = [arg0];
  ...
  },
  {
    ...
    value: function addListener(arg0) {
      const self = this;
      let fn = hasOwnProperty(_getPrototypeOf(AnimatedValue.prototype), "addListener", this);
      if (typeof fn === "function") {
        fn = (items) => fn.apply(self, items);
      }
      const items = [arg0];
  ...
  },
  {
    ...
    value: function removeListener(arg0) {
      const self = this;
      let fn = hasOwnProperty(_getPrototypeOf(AnimatedValue.prototype), "removeListener", this);
      if (typeof fn === "function") {
        fn = (items) => fn.apply(self, items);
      }
      const items = [arg0];
  ...
  },
  {
    ...
    value: function removeAllListeners() {
      const self = this;
      let fn = hasOwnProperty(_getPrototypeOf(AnimatedValue.prototype), "removeAllListeners", this);
      if (typeof fn === "function") {
        fn = (items) => fn.apply(self, items);
      }
      fn([]);
  ...
  },
  {
    ...
    value: function stopAnimation(fn) {
      ...
      if (fn) {
        if (self.__isNative) {
          const API = AnimatedValue(357).API;
          value = API.getValue(self.__getNativeTag(), fn);
        } else {
          fn(self.__getValue());
        }
      }
