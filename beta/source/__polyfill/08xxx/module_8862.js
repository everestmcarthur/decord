// Module ID: 8862
// Function ID: 8863
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8768, 8776, 8782, 8775, 8863, 8859, 8784]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8776).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8784);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8776).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8775).withoutXY(self, tmp);
      ...
      const obj5 = {};
      const obj2 = TextPath(8775);
      const merged1 = Object.assign(withoutXYResult);
      return jsx(_modDef8863, {});
    } else {
      ...
      return jsx(_modDef8859, { ref: self.refMethod, children });
    }
