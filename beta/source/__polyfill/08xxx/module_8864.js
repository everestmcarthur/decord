// Module ID: 8864
// Function ID: 8865
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8776, 8865, 8775, 8784]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8776).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8775).withoutXY(this, props));
