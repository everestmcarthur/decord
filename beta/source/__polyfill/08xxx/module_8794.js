// Module ID: 8794
// Function ID: 8795
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8775, 8795, 8784]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, rx, ry } = props);
    const merged = Object.assign(Ellipse(8775).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.rx = rx;
    obj.ry = ry;
    const obj2 = Ellipse(8775);
    const obj3 = {
      ref(arg0) {
