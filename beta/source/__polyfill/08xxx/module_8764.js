// Module ID: 8764
// Function ID: 8765
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8765, 8766, 8767, 8768, 8772, 8773, 8774, 8784]

// Module 8764
import extractOpacityDefault from "extractOpacity" /* 8766 */;
import extractResponderDefault from "extractResponder" /* 8767 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8765).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8765).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8784);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8768).extractTransformSvgView(tmp);
      const obj3 = Svg(8768);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8773)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8774, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8772, {});
  }
};
let items = [entry];
