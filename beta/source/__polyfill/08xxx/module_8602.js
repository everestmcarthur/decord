// Module ID: 8602
// Function ID: 8603
// Dependencies: [19, 17, 21, 113, 8603, 39, 38, 8605, 8606]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8605").container, require("module_8605").webView, style];
  const items4 = [require("module_8605").container, containerStyle];
