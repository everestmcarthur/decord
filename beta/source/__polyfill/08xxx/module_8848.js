// Module ID: 8848
// Function ID: 8849
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8849, 8844, 8784]
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (points) => {
      ...
      if (points) {
        ...
        points.d = "M" + Polygon(8849)(points) + "z";
      }
      if (closure_0.root) {
...
const entry = {
  ...
  value: function render() {
    ...
    if (points) {
      const _HermesInternal = HermesInternal;
      combined = "M" + Polygon(8849)(points) + "z";
    }
    obj.d = combined;
    const merged = Object.assign(props);
    return jsx(Polygon(8844), { ref: this.refMethod, d: null });
  }
};
let items = [entry];
