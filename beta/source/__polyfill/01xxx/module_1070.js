...
class FeedbackWidget {
  constructor(arg0) {
            ...
            if (0 === c4) {
              if (arg0 === 1) {
                ...
                if (self._hasScreenshot()) {
                  debug.setState({ filename: "Array", attachment: "ip", attachmentUri: "text" });
                } else {
    ...
    tmp4Result._clearFormState = () => {
      closure_0._savedState = { name: "", email: "", description: "", filename: "call", attachment: "marginTop", attachmentUri: "toCharArray$esjava$1" };
    };
...
const entry1 = {
  ...
  value: function reset() {
    FeedbackWidget._savedState = { name: "", email: "", description: "", filename: "call", attachment: "marginTop", attachmentUri: "toCharArray$esjava$1" };
  }
};
const items1 = [entry1];
...
importDefaultResultResult._savedState = { name: "", email: "", description: "", filename: "call", attachment: "marginTop", attachmentUri: "toCharArray$esjava$1" };
