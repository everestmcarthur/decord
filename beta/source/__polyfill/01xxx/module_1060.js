// Module ID: 1060
// Function ID: 1061
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 1061, 867, 1062, 682, 1064, 1065, 998, 1069, 1067, 1070]
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (obj.isModalSupported()) {
        ...
        const theme = tmp(1064).getTheme();
        const Fragment = noop.Fragment;
        const children = self.props.children;
        const tmpResult = tmp(1064);
        if (isButtonVisible) {
          const _Object = Object;
          isButtonVisible = obj4.createElement(tmp(1065).FeedbackButton, Object.assign({}, tmp(998).getFeedbackButtonOptions()));
          const tmpResult5 = tmp(998);
        }
        if (isScreenshotButtonVisible) {
          const _Object2 = Object;
          isScreenshotButtonVisible = obj4.createElement(tmp(1069).ScreenshotButton, Object.assign({}, tmp(998).getScreenshotButtonOptions()));
          const tmpResult6 = tmp(998);
        }
        ...
        if (isVisible) {
          ...
          const tmpResult7 = tmp(1067);
          ({ _handleClose: obj17.onFormClose, _handleClose: obj17.onFormSubmitted } = self);
          element = <RN.View style={null}><closure_1_10 visible={isVisible} transparent animationType="none" onRequestClose={self._handleClose} testID="feedback-form-modal">{element2}<RN.View {......merged}>{createElement3(closure_1_12, obj11, createElement4(tmp(1070).FeedbackWidget, Object.assign({}, tmp(998).getFeedbackOptions(), { onFormClose: null, onFormSubmitted: null })))}</RN.View></closure_1_10></RN.View>;
          const obj12 = { onFormClose: null, onFormSubmitted: null };
          const tmpResult8 = tmp(998);
        }
