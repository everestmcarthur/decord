  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(translateX) {
        ...
        const obj2 = { opacity: delayFunction(delay, delayFunction(1708).withTiming(1, { duration })), transform: null };
        ...
        const withTimingResult = delayFunction(1708).withTiming("10deg", { duration: 0.7 * duration });
        ...
        obj7.skewX = delayFunction(delay, obj8.withSequence(withTimingResult, withTimingResult1, delayFunction(1708).withTiming("0deg", { duration: 0.15 * duration })));
        items[1] = obj7;
      ...
      fn.__closure = { delayFunction, delay, withTiming: LightSpeedOutLeft(1708).withTiming, duration, animation, config: tmp2[1], withSequence: LightSpeedOutLeft(1708).withSequence, initialValues, callback: callbackV };
