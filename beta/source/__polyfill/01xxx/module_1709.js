...
fn = function n(config, _animationToClamp) {
  ...
  fn.__closure = { _animationToClamp, config, recognizePrefixSuffix: require("module_1676").recognizePrefixSuffix, logger: require("module_1640").logger, getReduceMotionForAnimation: require("module_1676").getReduceMotionForAnimation };
