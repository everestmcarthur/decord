// Module ID: 1718
// Function ID: 1719
// Dependencies: [1676, 1719]
// Exports: withSpring

// Module 1718
import _mod1676 from "module_1676" /* 1676 */;
import _mod1719 from "module_1719" /* 1719 */;
...
fn = function n(toValue, userConfig, callback) {
  ...
  __initData = callback;
  const fn = function u() {
    let obj = { damping: 10, mass: 1, stiffness: 100, overshootClamping: false, restDisplacementThreshold: 0.01, restSpeedThreshold: 2, velocity: 0, duration: 2000, dampingRatio: 0.5, reduceMotion: "children", clamp: "indexOf" };
    ...
    obj.skipAnimation = !_mod1719.checkIfConfigIsValid(obj);
    if (0 === obj.duration) {
    ...
    let obj3 = {
      ...
      onStart(toValue, current, arg2, lastTimestamp) {
        ...
        if (lastTimestamp) {
          ...
          const obj2 = closure_0(1719);
          ({ zeta: toValue.zeta, omega0: toValue.omega0, omega1: toValue.omega1 } = closure_0(1719).initialCalculations(mass, tmp));
          if (undefined !== tmp.clamp) {
            toValue.zeta = closure_0(1719).scaleZetaToMatchClamps(toValue, tmp.clamp);
            const obj3 = closure_0(1719);
          }
          const initialCalculationsResult = closure_0(1719).initialCalculations(mass, tmp);
        }
        let lastTimestamp1;
        if (lastTimestamp != null) {
...
fn.__closure = { defineAnimation: fn(1676).defineAnimation, checkIfConfigIsValid: fn(1719).checkIfConfigIsValid, underDampedSpringCalculations: fn(1719).underDampedSpringCalculations, criticallyDampedSpringCalculations: fn(1719).criticallyDampedSpringCalculations, isAnimationTerminatingCalculation: fn(1719).isAnimationTerminatingCalculation, calculateNewMassToMatchDuration: fn(1719).calculateNewMassToMatchDuration, initialCalculations: fn(1719).initialCalculations, scaleZetaToMatchClamps: fn(1719).scaleZetaToMatchClamps, getReduceMotionForAnimation: fn(1676).getReduceMotionForAnimation };
