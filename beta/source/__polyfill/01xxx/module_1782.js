...
function validateAnimatedStyles(obj) {
  if (typeof obj !== "object") {
    ...
    const reanimatedError = new _mod1647.ReanimatedError("`useAnimatedStyle` has to return an object, found " + typeof obj + " instead.");
    throw reanimatedError;
  } else {
    const _Array = Array;
    if (Array.isArray(obj)) {
      const reanimatedError1 = new _mod1647.ReanimatedError("`useAnimatedStyle` has to return an object and cannot return static styles combined with dynamic ones. Please do merging where a component receives props.");
