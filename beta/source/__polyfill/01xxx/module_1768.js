// Module ID: 1768
// Function ID: 1769
// Dependencies: [41, 42, 93, 95, 98, 1708, 1688, 1706]
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(originX) {
        ...
        size.originY = delayFunction(delay, obj4.withSequence(withTimingResult, delayFunction(1708).withTiming(originX.targetOriginY, obj6)));
      ...
      fn.__closure = { delayFunction, delay, withTiming: JumpingTransition(1708).withTiming, config, withSequence: JumpingTransition(1708).withSequence, halfDuration: result, Easing: JumpingTransition(1688).Easing, callback: callbackV };
