// Module ID: 13110
// Function ID: 13111
// Dependencies: [718, 13106, 13111, 13112, 13084, 13093, 13101, 13094, 13079, 13096, 13107, 13113]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod13096.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod13093.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod13096.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
