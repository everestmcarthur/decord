// Module ID: 13138
// Function ID: 13139
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 13078, 13093, 13075, 13139, 13103, 13106, 13107, 13079, 13132, 13090, 13140, 13101, 13084, 13115, 13134]
...
_inherits(ServerRuntimeClient, _mod13134.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(13139).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(13139);
    return ServerRuntimeClient(13103).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(13103);
      return obj.resolvedSyncPromise(ServerRuntimeClient(13139).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(13106).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(13106);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(13132).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(13107).DEBUG_BUILD) {
        const logger = tmp2(13079).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(13140);
          ...
          if (ServerRuntimeClient(13107).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(13079).logger;
          ...
          if (ServerRuntimeClient(13107).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(13079).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(13090).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(13101)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(13084).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(13084);
        } else {
          spanToTraceContextResult = tmp(13106).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(13106);
        }
        const tmpResult4 = ServerRuntimeClient(13115);
        if (_getSpanForScopeResult) {
