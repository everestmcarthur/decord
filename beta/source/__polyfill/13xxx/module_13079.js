// Module ID: 13079
// Function ID: 13080
// Dependencies: [13080, 13078]

// Module 13079
import GLOBAL_OBJ from "module_13080" /* 13080 */;

const require = globalThis.__r;

function consoleSandbox(fn) {
  if ("console" in console(13080).GLOBAL_OBJ) {
    console = console(13080).GLOBAL_OBJ.console;
    dependencyMap = {};
...
export const logger = GLOBAL_OBJ.getGlobalSingleton("logger", function makeLogger() {
  ...
  if (require("module_13078").DEBUG_BUILD) {
