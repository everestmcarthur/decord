// Module ID: 13185
// Function ID: 13186
// Dependencies: [5, 13075, 13078, 13079, 13107, 13093, 13103, 13127, 13106, 13124, 13113, 13094]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(13106).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(13124);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(13124);
        ...
        closure_0(13106).withScope((setContext) => {
