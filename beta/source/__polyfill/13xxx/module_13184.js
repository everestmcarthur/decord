// Module ID: 13184
// Function ID: 13185
// Dependencies: [718, 13075, 13078, 13079, 13093, 13103, 13107, 13111, 13161, 13084, 13113, 13094, 13112, 13150, 13096, 13092, 13086]
...
import "module_13078";
import consoleSandbox from "module_13079" /* 13079 */;
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod13150.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(13086).isInstanceOf(headers, Request);
        const tmpResult = tmp(13086);
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(13086).isInstanceOf(headers, Headers);
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod13111.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(13096).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(13096);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(13096).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(13161).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(13161);
    }
    const activeSpan = setHttpStatus(13084).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(13094).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(13094).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(13113).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(13113);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(13111);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(13112).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(13084);
  }
};
