  ...
  if (_mod904.WINDOW.document) {
        ...
        if (!event._sentryCaptured) {
          ...
          if (!tmp2) {
            ...
            if (tmp10) {
              ...
              const result1 = tmp7Result.addNonEnumerableProperty(tmp, "_sentryId", tmp7(682).uuid4());
              const tmp7Result2 = tmp7(682);
            }
            let str6 = "input";
    ...
    const item = items.forEach((item) => {
      ...
      if (hasOwnPropertyResult) {
        tmp(682).fill(prototype, "addEventListener", (arg0) => {
          closure_0 = arg0;
        ...
        tmp(682).fill(prototype, "removeEventListener", (arg0) => {
          closure_0 = arg0;
          return function(arg0, arg1, arg2) {
            const self = this;
            if ("click" === arg0) {
