...
// Function ID: 12952
// Name: ScopeClass
// Dependencies: [32, 41, 42, 12940, 12952, 12953, 12937, 12944, 12955, 12941, 12930]

// Module 12951 (ScopeClass)
...
const entry = {
  ...
  value: function clone() {
    ...
    const obj = { traceId: ScopeClass(12940).generateTraceId(), spanId: null };
    const obj2 = ScopeClass(12940);
    obj.spanId = ScopeClass(12940).generateSpanId();
    ...
    const obj10 = {};
    const obj3 = ScopeClass(12940);
    const obj5 = {};
    const obj6 = {};
    const obj7 = {};
    const obj9 = {};
    const tmp3Result = ScopeClass(12952);
    tmp3Result._setSpanForScope(obj4, ScopeClass(12952)._getSpanForScope(self));
    return obj4;
  }
};
let items = [
  ...
  },
  {
    ...
    value: function setUser(user) {
      ...
      if (this._session) {
        const obj = { user };
        ScopeClass(12953).updateSession(self._session, obj);
        const obj2 = ScopeClass(12953);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(12952)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      const obj3 = { traceId: null };
      const obj2 = ScopeClass(12952);
      obj3.traceId = ScopeClass(12940).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        const obj = { timestamp: ScopeClass(12944).dateTimestampInSeconds() };
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: this._fingerprint || [], eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(12952)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(12955).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(12940).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(originalException, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(12930).logger;
          logger.warn("No client configured on scope - will not capture exception!");
          return event_id;
        }
      }
      event_id = ScopeClass(12941).uuid4();
    }
  },
  {
    key: "captureMessage",
