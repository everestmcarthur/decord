...
// Function ID: 5184
// Name: ScreenStack
// Dependencies: [109, 19, 21, 5184, 5185, 5186]
// Exports: default

// Module 5183 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_mod5185.GHContext);
  ...
  _modDef5184("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5184(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod5185.RNSScreensRefContext.Provider, { value: ref, children: null });
};
