...
// Function ID: 5180
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5180, 5172]
// Exports: default

// Module 5179 (SearchBar)
import _modDef5180 from "module_5180" /* 5180 */;
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5180).Commands;
  ...
  if (ref1(5172).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5172).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5172);
    obj.hideNavigationBar = tmp3(5172).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
