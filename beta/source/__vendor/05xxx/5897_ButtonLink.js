...
// Function ID: 5898
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1485, 5889, 5898, 5899]
// Exports: Button

// Module 5897 (ButtonLink)
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5889)(color);
      str4 = tmp9(5889)(color).darken(0.71).string();
      const darkenResult = tmp9(5889)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5898.PlatformPressable, {});
}
