...
// Function ID: 5293
// Name: load
// Dependencies: [5293, 5294, 5295, 5296, 5297, 5310, 5312, 5313, 5325, 5329, 5333, 5335, 5337, 5338, 5339, 5340, 5341, 5342, 5343, 5344, 5345, 5346, 5319]
// Exports: load
...
function loadView(byteLength, response) {
  let obj = response;
  if (response === undefined) {
    obj = { expanded: false, async: false, includeUnknown: false, domParser: "diversity" };
  }
  ...
  let obj2 = require("module_5296");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("module_5296").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("module_5297").USE_JPEG) {
    flag4 = false;
        ...
        if (readResult11 instanceof Promise) {
          items1.push(readResult11.then(function addIccTags(icc) {
            if (flag) {
              ...
              closure_1 = _mod5294.objectAssign({}, closure_1, icc);
            }
          }));
          flag9 = true;
        } else if (flag) {
...
export const errors = _modDef5293;
export { load };
export { loadView };
