...
// Function ID: 13133
// Name: SessionFlusher
// Dependencies: [41, 42, 13085, 13106]

// Module 13132 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(13085).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(13106).getIsolationScope();
        ...
        const obj = SessionFlusher(13106);
      }
    }
  },
  {
