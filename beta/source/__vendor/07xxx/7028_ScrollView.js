...
// Function ID: 7029
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6941, 6942, 6961, 7001, 6997]
// Exports: FlatList

// Module 7028 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6997 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6941";
import module_6941 from "module_6941" /* 6941 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6941(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6942).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6941(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6942).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6941(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6941(TextInput);
