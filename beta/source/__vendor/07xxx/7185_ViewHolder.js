...
// Function ID: 7186
// Name: ViewHolder
// Dependencies: [19, 21, 7148, 7181]

// Module 7185 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_7148").getInvertedTransformStyle(horizontal);
    let obj = require("module_7148");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
