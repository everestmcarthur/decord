...
// Function ID: 7030
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6934, 7001, 7030, 7031, 7032, 7033, 7034, 7027, 6942, 6940]
// Exports: default

// Module 7029 (hitSlop)
import _mod7001 from "module_7001" /* 7001 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 7030 */;
import StateMachineEvent2 from "StateMachineEvent" /* 7033 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod7001.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(7030).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(7030);
          } else {
