...
// Dependencies: [7140, 7141, 7153, 7155, 7156, 7128, 7158, 7169, 7170, 7171]

// Module 7152 (RecyclerViewManager)
import _modDef7141 from "module_7141" /* 7141 */;
import ViewabilityManagerDefault from "ViewabilityManager" /* 7156 */;
  ...
  },
  {
    ...
    value: function getLayout(arg0) {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(7128).ErrorMessages.layoutManagerNotInitializedLayoutInfo);
        throw error;
      }
    }
  },
  ...
  },
  {
    ...
    value: function getChildContainerDimensions() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(7128).ErrorMessages.layoutManagerNotInitializedChildContainer);
        throw error;
      }
    }
  },
  ...
  },
  {
    ...
    value: function getWindowSize() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(7128).ErrorMessages.layoutManagerNotInitializedWindowSize);
        throw error;
      }
    }
  },
    ...
    value: function updateLayoutParams(windowSize, firstItemOffset) {
      ...
      if (this.layoutManager) {
        ...
        if (BooleanResult !== Boolean(self.propsRef.horizontal)) {
          const _Error = Error;
          const error = new Error(RecyclerViewManager(7128).ErrorMessages.horizontalPropCannotBeToggled);
          throw error;
        }
  ...
  },
  {
    ...
    value: function computeVisibleIndices() {
      ...
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(7128).ErrorMessages.layoutManagerNotInitializedVisibleIndices);
        throw error;
      }
    }
  },
    ...
    value: function getLayoutManagerClass() {
      ...
      if (this.propsRef.masonry) {
        if (self.propsRef.horizontal) {
          const _Error2 = Error;
          const error = new Error(RecyclerViewManager(7128).ErrorMessages.masonryAndHorizontalIncompatible);
          throw error;
        }
      }
      if (self.numColumns > 1) {
        if (self.propsRef.horizontal) {
          const _Error = Error;
          const error1 = new Error(RecyclerViewManager(7128).ErrorMessages.numColumnsAndHorizontalIncompatible);
          throw error1;
        }
      }
      if (self.propsRef.masonry) {
        let RVLinearLayoutManagerImpl = RecyclerViewManager(7158).RVMasonryLayoutManagerImpl;
      } else {
        if (self.numColumns > 1) {
          if (!self.propsRef.horizontal) {
            RVLinearLayoutManagerImpl = RecyclerViewManager(7169).RVGridLayoutManagerImpl;
          }
        }
        RVLinearLayoutManagerImpl = RecyclerViewManager(7170).RVLinearLayoutManagerImpl;
      }
  ...
  },
  {
    ...
    value: function checkPropsAndWarn() {
      if (tmp) {
        ...
        console.warn(RecyclerViewManager(7171).WarningMessages.keyExtractorNotDefinedForMVCP);
      }
    }
  }
];

export const RecyclerViewManager = _modDef7141(RecyclerViewManager, items);
