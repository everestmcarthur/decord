...
// Dependencies: [19, 17, 21, 5880, 1485, 7286, 7287]
// Exports: HeaderContainer

// Module 7285 (HeaderContainer)
...
export const HeaderContainer = function HeaderContainer(getFocusedRoute) {
  ...
  closure_6 = noop.useContext(_mod5880.HeaderBackContext);
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = { title: require("module_5880").getHeaderTitle(tmp11, route.name), href: buildHref(route.name, route.params) };
                tmp9 = obj2;
                const obj3 = require("module_5880");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7286").forSlideRight;
                    } else {
                      forSlideUp = require("module_7286").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7286").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7286").forNoAnimation;
            }
