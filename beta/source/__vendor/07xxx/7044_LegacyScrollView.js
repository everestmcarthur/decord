...
// Dependencies: [32, 109, 19, 17, 21, 7043, 6934, 6971]
// Exports: LegacyFlatList

// Module 7044 (LegacyScrollView)
...
const jsx = fn(21).jsx;
let closure_9 = _modDef7043(ScrollView, { disallowInterruption: true, shouldCancelWhenOutside: false });
...
const tmp3 = _modDef7043(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false });
const tmp4 = _modDef7043(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });

export const LegacyRefreshControl = tmp3;
export { LegacyScrollView };
export const LegacySwitch = tmp4;
export const LegacyTextInput = _modDef7043(TextInput);
export const LegacyDrawerLayoutAndroid = _modDef7043(DrawerLayoutAndroid, { disallowInterruption: true });
export const LegacyFlatList = (arg0) => {
  ...
  while (tmp3 !== undefined) {
    [first, tmp9] = tmp4;
    let tmp8 = first;
    let nativeViewProps = ref(6971).nativeViewProps;
