...
// Dependencies: [7131, 19, 21, 7150, 7181, 7185]
// Exports: ViewHolderCollection

// Module 7187 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 7185 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(7150).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7181).CompatView, { style: tmp19, children: null });
};
