...
// Function ID: 7300
// Name: CardContainer
// Dependencies: [19, 17, 21, 1485, 5880, 7300, 7301, 7302, 7289]

// Module 7299 (CardContainer)
import Link from "Link" /* 1485 */;
import _mod5880 from "module_5880" /* 5880 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7289 */;
import _mod7300 from "module_7300" /* 7300 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7301 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5880.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7300.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7300;
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5880).getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = tmp2(5880);
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5880.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5880.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5880.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7302.Card, obj5);
