...
// Function ID: 11081
// Name: ItemLayout
// Dependencies: [19, 21, 11063, 11081, 1637]
// Exports: ItemLayout

// Module 11080 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod11063.useGlobalState().props;
  ...
  const offsetX = _mod11081.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod11081;
  const fn = function k() {
