...
// Function ID: 9997
// Name: pbkdf2Init
// Dependencies: [5, 9994, 9993, 9997]
// Exports: pbkdf2, pbkdf2Async

// Module 9996 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9993).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9997).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9993).toBytes(B);
