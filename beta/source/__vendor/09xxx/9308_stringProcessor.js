...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(9307).process(_idmap, initializeContextResult);
    tmp2(9307).extractDefs(initializeContextResult, _idmap);
    return tmp2(9307).finalize(initializeContextResult, _idmap);
  }
...
export const enumProcessor = (_zod, arg1, arg2, arg3) => {
  const enumValues = _mod9249.getEnumValues(_zod._zod.def.entries);
