...
// Dependencies: [3877, 3881, 4071]
// Exports: default

// Module 4285 (roundToNearestMinutes)
...
export default function roundToNearestMinutes(arg0, nearestTo) {
  if (arguments.length < 1) {
    ...
    const defaultResult = module_3881.default(num);
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = _mod4071.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
