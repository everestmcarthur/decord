...
// Dependencies: [3877, 4063, 4053, 3878, 4076]
// Exports: default

// Module 4075 (differenceInMonths)
...
if (!module_4076) {
  const obj5 = { default: module_4076 };
  let tmp11 = obj5;
} else {
  tmp11 = module_4076;
}
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_4076.default(_typeof.default(date)) && 1 === absolute && 1 === obj3.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
