...
// Dependencies: [4523, 4527]
// Exports: installWorkletsSupport

// Module 4522 (installWorkletsSupport)
...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4527.NitroModules;
    const boxResult = NitroModules.box(_mod4527.NitroModules);
    require = boxResult;
