...
// Dependencies: [14552, 14560]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14559 (InsertUnicodeExtensionAndCanonicalize)
import _mod14552 from "module_14552" /* 14552 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14560 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14552.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
