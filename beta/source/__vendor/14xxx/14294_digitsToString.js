    ...
    if (constructor1.d[0]) {
      if (constructor1.e <= 17) {
        ...
        while (true) {
          ...
          let plusResult = obj2.plus(f116218(timesResult1, timesResult2, sum, 1));
      ...
      if (d[0]) {
        ...
        if (Math.abs(e) < 1500000000000000) {
          if (charAtResult >= 7) {
            ...
            e2 = f116218(minusResult, constructor1.plus(1), sum, 1);
...
function taylorSeries(constructor, arg1, timesResult, constructor1, arg4) {
  ...
  while (true) {
    ...
    let obj3 = f116218(timesResult1, tmp9, precision, 1);
    if (arg4) {
  ...
  if (isFinite.isFinite()) {
    ...
    if (arr3[0]) {
      if (index < 0) {
        ...
        tmp35 = f116218(constructor2, tmp11, diff, rounding, 0, num4);
        ({ d, e } = tmp35);
        let tmp36 = flag;
      }
      if (!tmp36) {
          ...
          if (s.d) {
            if (!obj.isZero()) {
              if (obj.s < 0) {
                self.precision = sum;
                self.rounding = 1;
                const atanResult = self.atan(f116218(s, tmp3, sum, 1));
                if (sum > closure_21) {
                  const _Error2 = Error;
                  throw Error(c10);
                } else {
                ...
                atanResult1 = self.atan(f116218(s, tmp3, sum, 1));
              }
            }
          }
          if (sum > closure_21) {
...
const fn7 = function(arg0) {
  const constructor = new this.constructor(arg0);
  return f116218(this, constructor);
};
obj2.div = fn7;
obj2.dividedBy = fn7;
const fn8 = function(arg0) {
  const constructor = this.constructor;
  const constructor1 = new constructor(arg0);
  const tmp2 = f116218(this, constructor1, 0, 1, 1);
...
const fn14 = function() {
  ...
  if (this.isFinite()) {
    if (self.isZero()) {
      ...
      constructor.precision = precision;
      constructor.rounding = rounding;
      const tmp9 = f116218(self.sinh(), self.cosh(), precision, rounding);
  ...
  if (this.isFinite()) {
    if (self.e < 0) {
      ...
      if (Math.max(sdResult, precision) < 2 * -self.e - 1) {
        ...
        constructor.rounding = 1;
        const obj3 = f116218(plusResult, constructor2.minus(self), diff + precision, 1);
        constructor.precision = precision;
        constructor.rounding = rounding;
        timesResult = f116218(plusResult, constructor2.minus(self), diff + precision, 1).ln().times(0.5);
        const lnResult = f116218(plusResult, constructor2.minus(self), diff + precision, 1).ln();
      }
    }
    if (absResult.eq(1)) {
      let num4 = self.s / 0;
    ...
    if (d1) {
      if (d1[0]) {
        if (!self.eq(1)) {
          ...
          let tmp28 = f116218(tmp19, tmp17Result, sum, 1);
          let tmp29 = sum;
          let tmp30 = precision;
          if (checkRoundingDigits(tmp28.d, precision, rounding)) {
            while (true) {
              ...
              let tmp42 = f116218(tmp33, tmp31Result, sum2, 1);
              if (flag2) {
                let sum4 = tmp30 + 10;
                tmp29 = sum2;
                tmp30 = sum4;
  ...
  if (this.d) {
    if (constructor1.s) {
      ...
      if (9 == constructor.modulo) {
        const tmp15 = f116218(self, constructor1.abs(), 0, 3, 1);
        tmp15.s = tmp15.s * constructor1.s;
        obj2 = tmp15;
      } else {
        obj2 = f116218(self, tmp, 0, constructor.modulo, 1);
      }
      c8 = true;
...
const fn36 = function() {
  ...
  if (this.isFinite()) {
    if (self.isZero()) {
      ...
      sinResult.s = 1;
      const constructor1 = new constructor(1);
      const obj4 = f116218(sinResult, constructor1.minus(sinResult.times(sinResult)).sqrt(), precision + 10, 0);
      constructor.precision = precision;
      constructor.rounding = rounding;
      if (2 == num) {
        negResult = obj4.neg();
...
obj2.toFraction = function(arg0) {
  ...
  if (d) {
    ...
    let tmp47 = f116218;
    const obj4 = f116218(constructor5, constructor3, 0, 1, 1);
    ...
    if (1 != plusResult.cmp(obj3)) {
      do {
        ...
        let obj12 = f116218(tmp52, minusResult, 0, 1, 1);
...
obj2.toNearest = function(arg0, arg1) {
  ...
  if (constructor2.d[0]) {
    const timesResult = f116218(constructor1, constructor2, 0, rounding, 1).times(constructor2);
    c8 = true;
    finalise(timesResult);
    let tmp9 = timesResult;
    obj = f116218(constructor1, constructor2, 0, rounding, 1);
  } else {
...
obj2.toJSON = fn43;
obj2.valueOf = fn43;
const f116218 = (s, s2, arg2, arg3, arg4, arg5) => {
  let num13;
  let tmp21;
  let tmp27;
          ...
          if (re18.test(substr2)) {
            ...
            if (tmp42 < 0) {
              ...
              if (tmp24) {
                tmp49 = f116218;
                num21 = 4;
                obj2 = f116218(self, tmp27, 4 * tmp26);
              }
              constructor2 = obj2;
              if (!tmp22) {
                flag3 = true;
