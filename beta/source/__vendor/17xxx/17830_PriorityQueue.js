...
// Function ID: 17831
// Name: PriorityQueue
// Dependencies: [41, 42, 17831]

// Module 17830 (PriorityQueue)
...
const entry = {
  ...
  value: function enqueue(run, arg1) {
    ...
    _queue1.splice(PriorityQueue(17831).default(self._queue, obj, (priority, priority2) => priority2.priority - priority.priority), 0, obj);
  }
};
const items = [
  entry,
