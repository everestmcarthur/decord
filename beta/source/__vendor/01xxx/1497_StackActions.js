...
// Function ID: 1498
// Name: StackActions
// Dependencies: [1491, 1492, 1498, 1496]
// Exports: StackRouter
        ...
        if (-1 === index4) {
          ...
          if (routeNames5.includes(type.payload.name)) {
            ...
            if (found) {
              ...
              const paramsFromAction = tmp135(1496).createParamsFromAction(obj3);
              if (found.params !== paramsFromAction) {
                const obj5 = {};
                let merged = Object.assign(found);
                obj5.params = paramsFromAction;
              }
              const tmp135Result = tmp135(1496);
            } else {
              const obj7 = { action: type, routeParamList };
              tmp135(1498).createRouteFromAction(obj7);
              const tmp135Result2 = tmp135(1498);
            }
            const obj9 = {};
                ...
                if (routeNames4.includes(type.payload.name)) {
                  ...
                  if (-1 === num3) {
                    ...
                    if (found1) {
                      ...
                      const paramsFromAction2 = tmp43(1496).createParamsFromAction(obj20);
                      ...
                      const tmp43Result = tmp43(1496);
                    } else {
                      const obj22 = { action: type, routeParamList };
                      routeFromAction = tmp43(1498).createRouteFromAction(obj22);
                      const tmp43Result2 = tmp43(1498);
                    }
