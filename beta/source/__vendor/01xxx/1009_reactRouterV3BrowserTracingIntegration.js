  ...
  obj3.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f108680 = (name) => {
        ...
        result = feedbackAsyncIntegration.startBrowserTracingPageLoadSpan(f108680, obj2);
      };
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f120932 = (name) => {
            ...
            obj2.attributes = obj3;
            result = result(889).startBrowserTracingNavigationSpan(f120932, obj2);
          };
