  ...
  obj3.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f110558 = (name) => {
        ...
        result = feedbackAsyncIntegration.startBrowserTracingPageLoadSpan(f110558, obj2);
      };
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f123026 = (name) => {
            ...
            obj2.attributes = obj3;
            result = result(889).startBrowserTracingNavigationSpan(f123026, obj2);
          };
