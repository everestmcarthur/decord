...
// Dependencies: [109, 5, 5770, 502, 5688, 2096, 2063, 2095, 4609, 1372, 1074, 1099, 5140, 1115, 573, 5771, 1271, 5774, 7372, 1980, 7488, 7489, 7494, 7521, 7595, 4981, 1249, 7596, 4432, 1086, 7597, 4469, 1241, 7601, 1101, 4998, 7603, 2]

// Module 5769 (GuildActionCreators)
...
import LurkerActionCreators from "LurkerActionCreators" /* 7595 */;
import GuildTemplateTooltipActionCreatorsDefault from "GuildTemplateTooltipActionCreators" /* 7597 */;
import getPreviousSafeRouteForNsfwReturnDefault from "getPreviousSafeRouteForNsfwReturn" /* 7601 */;
...
export default {
        ...
        try {
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              obj5.colors = obj6;
              obj5.permissions = primary_color(4432).NONE;
              c6 = 1;
            ...
            const tmp30 = new obj6(4469)(closure_131_2);
            throw tmp30;
          } else if (arg0 === 1) {
            c8 = 3;
            throw value;
            ...
            const result = obj6(7597).checkGuildTemplateDirty(closure_132_0);
            c6 = 0;
            c8 = 3;
  ...
  updateRole(id, id2, arg2) {
    ...
    return (async () => {
      ...
      const result = tmp2(7597).checkGuildTemplateDirty(closure_129_0);
  ...
  batchChannelUpdate(arg0, arg1) {
    ...
    return (async () => {
      ...
      closure_128_0 = await HTTP.patch(request);
      const result = body(7597).checkGuildTemplateDirty(closure_129_0);
      return closure_128_0;
    })();
  },
