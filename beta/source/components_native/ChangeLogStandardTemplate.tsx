...
// Dependencies: [19, 17, 2109, 1074, 21, 4788, 576, 1177, 563, 8382, 1241, 4483, 1929, 8384, 4778, 7400, 8211, 8387, 1115, 4410, 8389, 8391, 2]
// Exports: changelogRules, getRenderChangelog

// Module 8381 (ChangeLogStandardTemplate)
...
import ChangeLogUtilsDefault from "ChangeLogUtils" /* 8384 */;
...
function LinkInner(target) {
  ...
  let obj = target(563);
  const changelog = target(8382).useChangelog(changelogId, stateFromStores).changelog;
...
export default noop.memo((video) => {
  ...
  const obj8 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: closure_10(onScroll(8387).XNeutralIcon, { size: "sm", color: "interactive-icon-default" }), accessibilityLabel: null, onPress: null };
  ...
  const items3 = [closure_10(onScroll(8211).IconButton, obj8), , ];
  const obj9 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: closure_10(onScroll(8389).FacebookNeutralIcon, { size: "sm", color: "interactive-icon-default" }), accessibilityLabel: null, onPress: null };
  ...
  items3[1] = closure_10(onScroll(8211).IconButton, obj9);
  const obj10 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: closure_10(onScroll(8391).InstagramNeutralIcon, { size: "sm", color: "interactive-icon-default" }), accessibilityLabel: null, onPress: null };
  ...
  items3[2] = closure_10(onScroll(8211).IconButton, obj10);
  obj7.children = items3;
  items2[1] = closure_11(onScroll(7400).SafeAreaPaddingView, obj7);
  obj.children = items2;
