...
// Function ID: 15823
// Name: ChangeLogModal
// Dependencies: [19, 17, 1074, 2094, 21, 4788, 576, 4498, 1241, 8562, 15823, 5836, 8610, 1115, 5371, 10043, 10692, 1177, 8381, 1478, 8382, 1485, 5873, 4380, 8383, 4784, 4991, 7277, 2]
// Exports: default

// Module 15822 (ChangeLogModal)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4991 */;
import NavigatorHeader from "NavigatorHeader" /* 5873 */;
import Navigator from "Navigator" /* 7277 */;
import ChangeLogStandardTemplateDefault from "ChangeLogStandardTemplate" /* 8381 */;
...
ListItem.contextType = fn(4498).ThemeContext;
...
prototype["renderVideo"] = function renderVideo() {
  ...
  if (null != video) {
    ...
    if (null != youtube_video_id) {
      ...
      const items = [closure_7(_modDef15823, obj4), ];
      let tmp6Result = null;
      if (!tmp2) {
        ...
        obj5.source = obj6;
        tmp6Result = tmp6(tmp7(5836), obj5);
  ...
  if (null != video) {
    ...
    const obj10 = { accessibilityLabel: "Play Video", accessibilityRole: "button", source: tmp15(10692), onPress: self.playVideo, style: tmp.playButton, iconSize: tmp18(1177).IconSizes.CUSTOM, iconStyle: tmp.playIcon };
    obj9.children = tmp12(tmp15(10043), obj10);
    tmp12Result = tmp12(tmp18(5371).PressableOpacity, obj9);
    const tmp15Result = tmp15(10043);
  }
...
ChangeLog.contextType = fn(4498).ThemeContext;
size = fn(2);
