...
// Dependencies: [32, 19, 17, 2063, 5687, 5685, 21, 4788, 576, 5690, 1484, 504, 5691, 7400, 7650, 1115, 5683, 5371, 5833, 1177, 2]
// Exports: default

// Module 5686 (SubscribeModalGuildSelect)
...
import SearchBarNavDefault from "SearchBarNav" /* 7650 */;
...
let closure_9 = fn(5685).PremiumGuildSubscribeModalScenes;
const jsxProd = fn(21);
...
obj2.guildName = { marginLeft: 32, fontSize: 16, lineHeight: 20, color: fn(5690).DARK_WHITE_500_LIGHT_PRIMARY_660 };
...
export default function SubscribeModalGuildSelect(guildBoostSlots) {
  ...
  obj5.children = closure_10(guildBoostSlots(7400).SafeAreaPaddingView, {
    bottom: true,
  ...
  return closure_11(guildBoostSlots(7400).SafeAreaPaddingView, obj3);
};
