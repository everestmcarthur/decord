...
// Dependencies: [5, 19, 17, 12845, 2063, 4682, 4452, 1074, 7706, 4677, 21, 4788, 4637, 576, 504, 4681, 5846, 4784, 1115, 13901, 13902, 5218, 13911, 5230, 1094, 1241, 13866, 38, 4685, 5141, 13915, 1980, 2]
// Exports: default

// Module 13900 (SubscribeModalConfirmation)
...
import PremiumGuildPreviewDefault from "PremiumGuildPreview" /* 13902 */;
...
function PendingCancellationWarning(slots) {
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      const obj3 = { style: tmp.pendingCancellationIcon, source: _modDef5846 };
      ...
      items1[1] = closure_1_19(tmp2(4784).Text, obj4);
...
function SubscribeConfirmation(arg0) {
  ...
  const items = [closure_1_19(timestampProducer, { style: tmp.subscribeImage, source: _modDef13901 }), , , , , ];
...
function TransferConfirmation(previousGuildSubscriptionSlots) {
  ...
  const tmp = closure_22();
  const guildSubscriptionRemovalSource = prop(13911).useGuildSubscriptionRemovalSource();
  const obj = prop(13911);
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_19(tmp2(4784).Text, obj6);
    ...
    items1[2] = closure_19(tmp2(4784).Text, obj7);
    ...
    const items2 = [closure_19(tmp2(4784).Text, obj10), , , ];
    const obj11 = { style: tmp.guildPreview, guild: stateFromStores };
    items2[1] = closure_19(onPremiumGuildSubscribe(13902), obj11);
    ...
    items2[2] = closure_19(tmp2(4784).Text, obj12);
    ...
    const obj15 = { guild };
    obj14.children = closure_19(onPremiumGuildSubscribe(13902), obj15);
    ...
    obj17.children = closure_19(tmp2(5218).Button, obj18);
...
const BoostPurchaseIntent = fn(4677).BoostPurchaseIntent;
const jsxProd = fn(21);
