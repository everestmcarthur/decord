...
// Function ID: 17396
// Name: MobileSurvey
// Dependencies: [5, 19, 4979, 1074, 21, 4788, 504, 1241, 4980, 5237, 1115, 4483, 1177, 576, 9397, 2]
// Exports: default
...
export default function MobileSurvey() {
  ...
  if (null != stateFromStores) {
    ...
    obj3.renderConfirmRightIcon = function renderConfirmRightIcon() {
      return jsx(native.Icon, { style: confirmIcon.confirmIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: native.Icon.Sizes.SMALL, source: _modDef9397 });
    };
    tmp5 = jsx(stateFromStores(5237), { body: null, confirmText: null, cancelText: null, onConfirm: null, onCancel: null, renderConfirmRightIcon: null });
    const tmp8 = stateFromStores(5237);
  }
  return tmp5;
};
