...
// Dependencies: [19, 2045, 2041, 1074, 21, 1484, 7445, 5936, 1115, 5854, 1177, 1397, 4788, 576, 504, 8903, 5216, 17205, 17311, 2]
// Exports: default
...
function LinkedLobbyFormSection(channel) {
  ...
  if (null != getOrFetchApplication) {
    ...
    tmp5 = closure_6(tmp(5936).TableRowGroup, obj3);
...
export default function ConnectedChannelSettingsIntegrationsOverview(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    if (canManageWebhooks) {
      ...
      canManageWebhooks = tmp7(tmp(5936).TableRowGroup, obj8);
    }
    ...
    obj3.children = closure_7(tmp(5216).Stack, obj4);
    tmp6Result = tmp6(tmp(8903).Form, obj3);
  }
  return tmp6Result;
};
