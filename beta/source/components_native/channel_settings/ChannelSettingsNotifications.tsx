...
// Dependencies: [19, 2045, 2041, 4707, 4437, 4969, 1372, 1074, 21, 1115, 4788, 576, 4498, 4968, 7396, 4755, 10436, 1980, 7391, 4941, 5936, 5854, 10440, 7477, 5934, 5937, 4784, 8903, 5216, 504, 10441, 10442, 2]
// Exports: default

// Module 10435 (ChannelSettingsNotifications)
...
import NotificationSettingsChannelDefault from "NotificationSettingsChannel" /* 10442 */;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(10440).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(10440).MuteSettingType.CHANNEL;
    }
    obj7.type = CHANNEL;
...
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(5934).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(5937).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(5937).TableRadioRow, obj3);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(5937).TableRadioRow, obj4);
    obj.children = items;
    ...
    items1[1] = tmp12(tmp7(5937).TableRadioRow, obj6);
    ...
    items1[2] = tmp12(tmp7(5937).TableRadioRow, obj7);
    ...
    items1[3] = tmp12(tmp7(5937).TableRadioRow, obj8);
    obj.children = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5936).TableRowGroup, obj7);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj6.children = items;
...
ChannelSettingsNotifications.contextType = fn(4498).ThemeContext;
const size = fn(2);
