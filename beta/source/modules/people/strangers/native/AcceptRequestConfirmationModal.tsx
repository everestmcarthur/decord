...
// Dependencies: [19, 17, 21, 4788, 576, 5237, 1115, 5140, 4784, 2]
// Exports: default

// Module 11166 (AcceptRequestConfirmationModal)
...
export default function AcceptRequestConfirmationModal(onConfirm) {
  ...
  const items = [closure_4(onConfirm(4784).Text, obj3), ];
  ...
  items[1] = closure_4(onConfirm(4784).Text, obj4);
  obj2.children = items;
