...
// Dependencies: [5, 32, 19, 17, 2035, 1372, 1099, 17729, 1074, 21, 4788, 1484, 504, 1241, 1115, 2108, 38, 16294, 4991, 4380, 16317, 7400, 4784, 17732, 5218, 2]
// Exports: default

// Module 17731 (ExistingUserAgeGate)
...
let closure_11 = fn(17729).ExistingUserAgeGateScreens;
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const diffResult = v1(4380)().diff(date, "years");
            if (diffResult < 18) {
              const obj4 = {
                source,
                onConfirm() {
