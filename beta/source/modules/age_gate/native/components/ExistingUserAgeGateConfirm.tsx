...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4788, 1484, 7400, 4784, 1115, 2108, 5218, 2]
// Exports: default

// Module 17733 (ExistingUserAgeGateConfirm)
...
export default function ExistingUserAgeGateConfirm(age) {
  ...
  const items = [closure_8(onConfirm(4784).Text, obj3), , ];
  ...
  items[1] = closure_8(onConfirm(4784).Text, obj4);
  ...
  obj7.children = closure_8(onConfirm(5218).Button, obj8);
  items[2] = closure_8(View, obj7);
  obj2.children = items;
  return closure_9(onConfirm(7400).SafeAreaPaddingView, obj2);
};
