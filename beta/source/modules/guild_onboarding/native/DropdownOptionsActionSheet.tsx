...
// Dependencies: [19, 17, 5708, 7377, 1375, 21, 4788, 563, 7407, 1397, 1177, 1115, 4784, 7413, 1612, 4755, 7426, 7427, 6901, 5218, 2]
// Exports: default

// Module 7412 (DropdownOptionsActionSheet)
...
export default function DropdownOptionsActionSheet(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    const obj4 = { scrollable: true, header: closure_8(tmp3(7426).BottomSheetTitleHeader, obj3), children: null };
    ...
    obj8.children = closure_8(tmp3(5218).Button, obj9);
    items2[1] = closure_8(responses, obj8);
    obj5.children = items2;
    obj4.children = closure_9(tmp3(6901).BottomSheetScrollView, obj5);
    return closure_8(tmp3(7427).BottomSheet, obj4);
  }
};
