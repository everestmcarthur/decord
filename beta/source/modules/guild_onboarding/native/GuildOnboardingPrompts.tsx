...
// Dependencies: [32, 5, 19, 17, 4780, 5821, 2041, 2063, 2095, 7377, 7378, 7374, 1074, 21, 1101, 4788, 5931, 576, 1475, 4637, 5836, 5230, 1094, 504, 1612, 1484, 4524, 7382, 7383, 1397, 1879, 1241, 4968, 4789, 5873, 7400, 7401, 1370, 5778, 4784, 1115, 2]
// Exports: default

// Module 7399 (GuildOnboardingPrompts)
...
const OnboardingPromptType = fn(7378).OnboardingPromptType;
let closure_15 = fn(7374).GuildOnboardingModalStates;
        ...
        if (!required1) {
          if (closure_17) {
            ...
            if (currentPromptIdx < prompts.length - 1) {
              ...
              const merged1 = Object.assign(tmp5(4968).collectGuildAnalyticsMetadata(tmp6));
              obj4.step = tmp9 + 1;
              obj4.required = arr[tmp9 + 1].required;
              tmp2Result.track(tmp4.GUILD_ONBOARDING_STEP_VIEWED, obj4);
              const tmp5Result = tmp5(4968);
            }
