...
// Dependencies: [32, 19, 17, 5708, 5821, 2063, 7377, 7374, 1375, 21, 4788, 5931, 576, 1484, 504, 1612, 4489, 672, 7400, 5850, 4784, 1115, 5218, 5796, 5230, 1094, 7383, 7402, 7403, 7407, 1397, 4755, 7412, 1980, 5371, 7435, 2]
// Exports: DropdownPrompt, MultipleChoicePrompt, RulesPrompt

// Module 7401 (GuildOnboardingPrompt)
...
function PromptHeader(currentPrompt) {
  ...
  if (required) {
    ...
    items1[1] = tmp5(tmp6(4784).Text, obj6);
...
function DropdownOption(option) {
  ...
  const items1 = [closure_15(closure_6, obj3), closure_15(tmp2(4784).Text, { variant: "text-md/semibold", children: option.title })];
