...
// Dependencies: [19, 17, 21, 4788, 576, 4784, 1115, 4747, 5218, 2]
// Exports: default

// Module 7454 (ConnectionCardView)
...
export default function ConnectionCardView(description) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(4784).Text, obj5);
  }
  items1[1] = tmp4Result;
  ...
  if (isLoading) {
    ...
    const items3 = [tmp4(tmp5(4784).Text, obj7), tmp4(tmp5(4747).CircleCheckIcon, { size: "sm", color: "status-positive" })];
    ...
    tmp4Result2 = tmp4(tmp5(5218).Button, obj8);
  }
