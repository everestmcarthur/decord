...
// Dependencies: [19, 17, 1957, 1979, 4676, 4285, 1371, 1085, 21, 4636, 576, 4789, 11045, 1176, 4632, 504, 4481, 11137, 4986, 4986, 1114, 2]
// Exports: default

// Module 11836 (DestinationFailedAlertModal)
...
function FailedUserRow(user) {
  ...
  if (null != user) {
    ...
    const obj4 = { user, guildId: "Boolean", status: true, isMobileOnline: null, isVROnline: null, size: 135.607, avatarDecoration: null, autoStatusCutout: null };
    let tmp13 = null;
...
function FailedChannelRow(channel) {
  ...
  const items1 = [closure_10(channel(11137).GuildIconWithChannelType, { "aria-label": "", guild: stateFromStores, channel, size: channel(11137).GuildIconWithChannelTypeSizes.SMALL_32 }), closure_10(channel(4632).Text, { style: tmp.label, variant: "text-md/medium", lineClamp: 1, ellipsizeMode: "tail", children: tmp3 })];
...
export default function DestinationFailedAlertModal(arg0) {
  ...
  if (null != onRetry) {
    ...
    const items = [tmp2(tmp3(4986).AlertActionButton, obj4, "confirm"), ];
    const obj5 = { variant: "secondary", text: null };
    const intl3 = tmp3(1114).intl;
    obj5.text = intl3.string(tmp3(1114).t.WAI6xu);
    items[1] = tmp2(tmp3(4986).AlertActionButton, obj5, "cancel");
    obj3.children = items;
    ...
    tmp2Result = tmp2(tmp3(4986).AlertActionButton, obj6, "confirm");
  }
