...
// Dependencies: [32, 19, 17, 4780, 5526, 5008, 2095, 1372, 1979, 1074, 21, 4788, 576, 5141, 5237, 1980, 504, 4784, 13606, 4524, 4789, 1115, 5371, 2]
// Exports: ChannelHeaderLoadingIndicator, useShouldChannelShowLoadingIndicator

// Module 13605 (ChatLoadingIndicator)
...
let closure_18 = noop.memo(() => {
  ...
  if (messagesCached !== false) {
    ...
    tmp4Result = tmp4(tmp(4784).Text, obj3);
  }
  items1[4] = tmp4Result;
  ...
  if (messagesReady !== true) {
    ...
    tmp4Result3 = tmp4(tmp(4784).Text, obj5);
  }
  ...
  if (connected !== true) {
    ...
    tmp4Result4 = tmp4(tmp(4784).Text, obj7);
  }
...
export const ChannelHeaderLoadingIndicator = function ChannelHeaderLoadingIndicator() {
  ...
  let obj3 = stateFromStores(4524);
  fn.__closure = { useReducedMotion: stateFromStores, withRepeat: stateFromStores(4524).withRepeat, withSequence: stateFromStores(4524).withSequence, withTiming: stateFromStores(4789).withTiming, Easing: stateFromStores(4524).Easing };
  ...
  items3[1] = closure_13(stateFromStores(4784).Text, obj7);
  obj5.children = items3;
  const tmp8 = closure_14(View, obj5);
  let tmp7Result = tmp8;
  if (stateFromStores1) {
    let obj8 = { onPress: openLoadingIndicatorDebugBody, children: tmp8 };
    tmp7Result = closure_13(tmp2(5371).PressableOpacity, obj8);
  }
  return tmp7Result;
};
