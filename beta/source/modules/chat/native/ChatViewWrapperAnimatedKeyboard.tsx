...
// Dependencies: [19, 17, 21, 4524, 4792, 11644, 4789, 5828, 11649, 11651, 7433, 11652, 2]
// Exports: default

// Module 11643 (ChatViewWrapperAnimatedKeyboard)
...
let obj = { duration: fn(4792).timingStandardDuration, easing: Easing.bezier(0.2, 0, 0, 1) };
