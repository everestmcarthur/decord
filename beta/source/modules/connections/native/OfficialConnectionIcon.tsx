...
// Dependencies: [19, 17, 1074, 21, 4788, 7463, 7482, 576, 1092, 1177, 11847, 11848, 2]
// Exports: default

// Module 11846 (OfficialConnectionIcon)
import nativeDefault from "native" /* 576 */;
import utils_ColorUtils from "utils/ColorUtils" /* 1092 */;
import native from "native" /* 1177 */;
import useRoleIconProps from "useRoleIconProps" /* 7463 */;
import RoleIconDefault from "RoleIcon" /* 7482 */;
import _modDef11847 from "module_11847" /* 11847 */;
...
export default function OfficialConnectionIcon(arg0) {
  ...
  obj5.style = items1;
  const obj6 = { style: null, size: native.Icon.Sizes.CUSTOM, source: _modDef11847, color: roleColor };
  const items2 = [tmp.verifiedCheck, size1];
  obj6.style = items2;
  const items3 = [timestampProducer(native.Icon, obj6), ];
  const obj7 = { style: null, size: native.Icon.Sizes.CUSTOM, source: _modDef11848, color: PRIMARY_630 };
