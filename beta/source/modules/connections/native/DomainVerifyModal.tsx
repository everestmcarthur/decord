...
// Dependencies: [32, 19, 17, 1074, 21, 4788, 576, 1484, 1271, 7400, 4784, 1115, 6879, 9428, 5218, 4991, 5873, 7277, 2]
// Exports: default

// Module 9427 (DomainVerifyModal)
...
import DomainVerifyUtils from "DomainVerifyUtils" /* 9428 */;
...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj2.headerLeft = onClose(5873).getHeaderBackButton(onClose);
    ...
    const obj3 = onClose(5873);
    obj4.headerLeft = onClose(5873).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(5873);
    obj6.headerLeft = onClose(5873).getHeaderBackButton(onClose);
    ...
    return closure_8(onClose(7277).Navigator, obj8);
  }
};
