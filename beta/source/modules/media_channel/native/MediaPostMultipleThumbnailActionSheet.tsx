...
// Dependencies: [19, 17, 2038, 21, 4788, 576, 1612, 7427, 6901, 4784, 1115, 1177, 5218, 2]
// Exports: default

// Module 10562 (MediaPostMultipleThumbnailActionSheet)
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4784).Text, obj6), closure_5(markAsDismissed(1177).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4784).Text, obj7);
  ...
  items2[3] = closure_5(markAsDismissed(4784).Text, obj8);
  ...
  items2[5] = closure_5(markAsDismissed(5218).Button, obj9);
  obj3.children = items2;
  obj2.children = closure_6(markAsDismissed(6901).BottomSheetScrollView, obj3);
  obj.children = closure_5(View, obj2);
  return closure_5(markAsDismissed(7427).BottomSheet, obj);
};
