...
// Dependencies: [1074, 7570, 5018, 7571, 2019, 7572, 7575, 1186, 2]

// Module 7569 (HarmTypeConfiguration)
...
obj3[obj.EXPLICIT] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    if (arg0 == null) {
      ...
      const ExplicitContentSettings = tmp12(2019).ExplicitContentSettings;
      ...
      const ExplicitContentSettings2 = tmp12(2019).ExplicitContentSettings;
    ...
    let tmp9;
    if (tmp != null) {
      tmp9 = tmp[tmp7(undefined, 7571).ContentHarmTypeChannel.GUILD];
    }
    ...
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 7571).ContentHarmTypeChannel.FRIEND_DM];
    }
    ...
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 7571).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
...
obj3[obj.GORE] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    if (arg0 == null) {
      ...
      const obj = {};
      obj[ExplicitMediaRedactionModels.ContentHarmTypeChannel.GUILD] = goreContentGuilds;
      const GoreContentSettings = tmp12(2019).GoreContentSettings;
      ...
      obj[ExplicitMediaRedactionModels.ContentHarmTypeChannel.FRIEND_DM] = goreContentFriendDm;
      const GoreContentSettings2 = tmp12(2019).GoreContentSettings;
