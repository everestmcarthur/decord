...
// Function ID: 11951
// Name: PublishModal
// Dependencies: [32, 19, 17, 21, 4788, 5690, 11951, 1177, 1115, 2]
// Exports: default

// Module 11950 (PublishModal)
import util from "util" /* 1115 */;
import native from "native" /* 1177 */;
import useChannelFollowerStatsDefault from "useChannelFollowerStats" /* 11951 */;
...
let obj2 = { alertContainer: { paddingTop: 16 }, alertLoading: { paddingTop: 62, paddingBottom: 46 }, alertBodyText: { marginBottom: 16, fontSize: 16, lineHeight: 24, color: fn(5690).DARK_PRIMARY_300_LIGHT_PRIMARY_400 } };
