...
// Dependencies: [19, 2100, 2099, 21, 12121, 504, 17978, 1115, 2]
// Exports: default

// Module 17977 (ExemptRolesActionSheet)
import RoleNameDefault from "RoleName" /* 12121 */;
...
export default function ExemptRolesActionSheet(guildId) {
  ...
  obj2.onSave = onSave;
  return jsx(stateFromStores(17978), { title: null, searchPlaceholder: null, listId: "automod-exempt-roles", items: null, initialSelected: null, getId: null, getSearchText: null, renderLabel: null, onSave: null });
};
