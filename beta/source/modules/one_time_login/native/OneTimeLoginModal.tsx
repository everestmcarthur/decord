...
// Dependencies: [5, 19, 17, 502, 1372, 1074, 1229, 21, 4788, 576, 1612, 1478, 1365, 1241, 4991, 4645, 1101, 5142, 5146, 6884, 1115, 5146, 6866, 5373, 4606, 14161, 4784, 7217, 2]
// Exports: default

// Module 14160 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  const obj3 = { dark: token(4606).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
  const items6 = [closure_13(ThemedGradientDefault, obj2), ];
  let obj4 = { style: tmp.container, children: null };
  let obj5 = { style: tmp.centerContent, children: null };
  const items7 = [closure_13(callback3, { source: token(14161), style: tmp.logo }), ];
  ...
  items8[1] = closure_13(token(4784).Text, obj8);
  ...
  const items10 = [closure_13(token(4784).Text, obj10), ];
  ...
  items10[1] = closure_13(token(7217).LinkButton, obj11);
