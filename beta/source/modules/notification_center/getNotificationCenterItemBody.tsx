...
// Dependencies: [7800, 2063, 4437, 1372, 1074, 1115, 4632, 7908, 2009, 38, 2]
...
export default function getNotificationCenterItemBody(arg0) {
  ...
  if (NotificationCenterItemsTypes.NotificationCenterLocalItems.FRIEND_REQUESTS_GROUPED === type) {
    ...
    const name2 = tmp2(4632).getName(obj2.getUser(id2));
    ...
    let num;
    const name3 = tmp2(4632).getName(obj2.getUser(id3));
  ...
  } else if (tmp6(7908).NotificationCenterLocalItems.MOBILE_NATIVE_UPDATE_AVAILABLE === type) {
    let str7;
  ...
  } else if (tmp6(7908).NotificationCenterItems.FRIEND_SUGGESTION_CREATED === type) {
    ...
    return str5;
  } else if (tmp6(7908).NotificationCenterItems.GUILD_SCHEDULED_EVENT_STARTED === type) {
  ...
  } else if (tmp6(7908).NotificationCenterLocalItems.INCOMING_FRIEND_REQUESTS === type) {
  ...
  } else if (tmp6(7908).NotificationCenterLocalItems.INCOMING_FRIEND_REQUESTS_ACCEPTED === type) {
    if (null != applicationId) {
  ...
  } else if (tmp6(7908).NotificationCenterItems.FRIEND_REQUEST_ACCEPTED === type) {
    if (null != applicationId) {
  ...
  } else if (tmp6(7908).NotificationCenterLocalItems.INCOMING_GAME_FRIEND_REQUESTS_ACCEPTED === type) {
  ...
  } else if (tmp6(7908).NotificationCenterLocalItems.INCOMING_GAME_FRIEND_REQUESTS === type) {
  ...
  } else if (tmp6(7908).NotificationCenterItems.GAME_FRIEND_REQUEST_ACCEPTED === type) {
    if (null == applicationId) {
      let body = item.body;
    } else {
