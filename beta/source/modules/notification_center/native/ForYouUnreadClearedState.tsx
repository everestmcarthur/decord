...
// Dependencies: [19, 17, 21, 4788, 576, 1177, 10948, 4784, 1115, 2]
...
export const ForYouUnreadClearedState = function ForYouUnreadClearedState() {
  ...
  const items = [React4(View, { style: tmp.imageContainer }), React4(native.Icon, { source: _modDef10948, style: tmp.icon, color: tmp.icon.color }), ];
