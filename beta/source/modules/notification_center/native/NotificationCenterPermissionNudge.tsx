...
// Dependencies: [32, 19, 17, 1074, 2038, 12693, 21, 4788, 576, 1241, 10449, 4784, 1115, 5218, 12694, 5371, 5929, 15760, 7662, 2027, 2]
// Exports: default
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = { style: tmp.iconContainer, children: closure_14(onDismiss(10449).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }) };
  ...
  const items1 = [closure_14(onDismiss(4784).Text, obj5), , ];
  ...
  items1[1] = closure_14(onDismiss(4784).Text, obj6);
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12694).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
    const obj = onDismiss(12694);
  ...
  obj8.children = closure_14(onDismiss(5218).Button, obj9);
  ...
  obj10.children = closure_14(onDismiss(5929).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = closure_14(onDismiss(5371).PressableHighlight, obj10);
  obj.children = items;
