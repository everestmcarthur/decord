...
// Dependencies: [19, 4780, 21, 4788, 8058, 504, 8101, 5778, 2]
// Exports: default

// Module 8100 (BurstReactionAnimation)
...
export default function BurstReactionAnimation(arg0) {
  ...
  if (null == burstReactionAnimationSource) {
    ...
    return jsx(importDefault(withFadeOut ? 8101 : 5778), { style: tmp2.content, loop: false, speed: null });
  }
};
