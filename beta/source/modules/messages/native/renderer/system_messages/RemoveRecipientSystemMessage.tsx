...
// Module 8268 (RemoveRecipientSystemMessage)
...
export const createRemoveRecipientSystemMessage = function createRemoveRecipientSystemMessage(message) {
  ...
  if (message.author.id === first) {
    ...
    const merged = Object.assign(tmp8(8254)(message));
    return obj3;
  } else {
    const user = UserStore.getUser(first);
    const userAuthorWithProcessedColor = tmp5(8250).getUserAuthorWithProcessedColor(user, channel);
    const obj4 = {};
    ...
    obj4.otherUsernameOnClick = tmp8(8252)(obj5);
    ...
    const merged2 = Object.assign(tmp8(8254)(message));
    return obj6;
  }
};
