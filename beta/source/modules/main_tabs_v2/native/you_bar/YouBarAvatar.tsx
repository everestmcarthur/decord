...
// Function ID: 16731
// Name: YouBarAvatar
// Dependencies: [5, 32, 19, 17, 4780, 5528, 1372, 15368, 1074, 21, 4788, 576, 504, 1177, 4498, 4524, 8517, 9126, 5217, 4489, 9125, 8458, 4756, 7656, 1980, 6929, 2]
...
function YouBarAvatarLarge(transitionState) {
  ...
  if (null != stateFromStores) {
    ...
    const obj7 = { user: stateFromStores, guildId: "Array", size, animate: true, needsOffscreenAlphaCompositing: null, status: null, statusSizeOverride: null, cutout: null, statusStyle: "CREATE_PENDING_REPLY" };
    if (OFFLINE === StatusTypes.UNKNOWN) {
      OFFLINE = StatusTypes.OFFLINE;
    }
    obj7.status = OFFLINE;
