...
// Function ID: 16729
// Name: YouBarUser
// Dependencies: [19, 17, 1372, 15368, 21, 4788, 576, 504, 4524, 5217, 4632, 16729, 16730, 16731, 2]
...
export default noop.memo(function YouBarUser(isQuestRendered) {
  ...
  const animatedStyle = tmp2(4524).useAnimatedStyle(S);
  const tmp2Result = tmp2(4524);
  const name = sharedValue(4632).useName(stateFromStores);
  if (null != stateFromStores) {
    if (null != name) {
      ...
      items2[1] = closure_9(tmp9(4524).View, obj6);
  ...
  obj9.style = items6;
  items5[1] = closure_9(sharedValue(4524).View, obj9);
