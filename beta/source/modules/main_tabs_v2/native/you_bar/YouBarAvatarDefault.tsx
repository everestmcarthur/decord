...
// Dependencies: [19, 17, 15368, 1074, 21, 4788, 576, 4489, 1177, 9126, 9069, 2]
...
const ClipViewDefault = tmp4(9126);
require = fn;
function AvatarDefault() {
  ...
  const point = { shape: tmp2(9126).CutoutShape.Circle, x: diff, y: diff, size: 2 * sum };
