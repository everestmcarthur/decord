...
// Dependencies: [19, 17, 14020, 1074, 7706, 1374, 21, 1091, 4788, 576, 17277, 1241, 1115, 4380, 563, 7721, 7713, 17275, 2108, 4784, 4446, 5371, 1177, 8972, 5230, 7484, 2]
// Exports: default
...
export default function YouExpiringTrialOfferCard(navigateToPremium) {
  ...
  importDefault = _modDef4380().add(5, "days");
  ...
  const premiumTrialOffer = navigateToPremium(7721).usePremiumTrialOffer();
  let num = 0;
  const obj3 = navigateToPremium(7721);
  ...
  if (shouldShowExpiringTrialOfferCard) {
    if (null != premiumTrialOffer) {
      if (null != stateFromStores) {
        ...
        const result = tmp4(4446).formatIntervalDuration(obj5);
        if (time.days > 0) {
        ...
        obj4.children = closure_12(tmp4(4784).Text, obj10);
        ...
        items2[1] = closure_12(tmp4(5371).PressableOpacity, obj11);
