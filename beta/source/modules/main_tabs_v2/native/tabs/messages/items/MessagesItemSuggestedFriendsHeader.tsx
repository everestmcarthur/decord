...
// Dependencies: [19, 17, 21, 4784, 576, 4788, 4524, 8570, 5373, 1115, 2]
...
const ThemedGradientDefault = tmp5(5373);
require = fn;
get_ActivityIndicator = fn(17);
({ View: closure_4, StyleSheet } = get_ActivityIndicator);
const jsxProd = fn(21);
({ jsx: hasOwnProperty, Fragment: metroRequire, jsxs: closure_7 } = jsxProd);
const sum = fn(4784).TextStyleSheet["text-md/semibold"].lineHeight + nativeDefault.space.PX_24;
