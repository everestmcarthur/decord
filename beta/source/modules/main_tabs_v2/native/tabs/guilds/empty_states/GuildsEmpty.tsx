...
// Function ID: 16612
// Name: GuildsEmpty
// Dependencies: [32, 19, 17, 502, 2063, 4609, 1074, 21, 4788, 576, 4784, 12990, 16612, 1115, 5216, 5218, 1485, 563, 9080, 1249, 2066, 4647, 5374, 15370, 2]

// Module 16611 (GuildsEmpty)
...
import _modDef16612 from "module_16612" /* 16612 */;
...
export default noop.memo(function GuildsEmpty(arg0) {
        ...
        if (tmp !== closure_2_11) {
          if (!obj3.isFavoritesGuildId(tmp)) {
            if (tmp !== closure_2_12) {
              ...
              if (null != guild) {
                closure_0 = _slicedToArray(tmp10(4647).getInitialGuildState(guild.id, undefined, false), 2)[1];
                obj2.dispatch(() => {
                  const CommonActions = navigation(dependencyMap[16]).CommonActions;
                  return CommonActions.reset(closure_0);
                });
                const tmp10Result = tmp10(4647);
              }
            }
          }
          obj3 = FavoritesUtils;
  ...
  const tmp7 = selectedGuildId(9080);
  const isScreenLandscape = navigation(5374).useIsScreenLandscape();
  navigation(15370);
  ...
  if (stateFromStores) {
    ...
    obj6.children = closure_13(tmp2(4784).Text, obj7);
