...
// Function ID: 17135
// Name: ChannelContent
// Dependencies: [19, 17, 10413, 4970, 21, 4788, 1364, 10416, 5309, 17135, 5345, 8898, 16460, 4784, 2]
...
const GuildRoleSubscriptionGatedChannelIconDefault = tmp13(16460);
require = fn;
function ChannelContentComponent(arg0) {
  ...
  if (obj17) {
    ...
    tmp10Result5 = tmp10(tmp2(4784).Text, obj16);
  }
...
let obj4 = { opacity: fn(10413).SUBTITLE_OPACITY_NORMAL, marginRight: 4, marginTop: null };
