...
// Function ID: 11203
// Name: GroupDMRow
// Dependencies: [19, 11151, 21, 4941, 11203, 1177, 11204, 4784, 5853, 5854, 2]
// Exports: default

// Module 11202 (GroupDMRow)
...
export default function GroupDMRow(channel) {
  ...
  if (null != recipientsLabel) {
    ...
    tmp5Result = tmp5(tmp7(4784).Text, obj4);
  }
  ...
  if (NONE === UserRowModes.TOGGLE) {
    ...
    obj5.checked = flag;
    let tmp5Result2 = tmp5(tmp7(5853).TableCheckboxRow, obj5);
  } else {
    const obj6 = {};
