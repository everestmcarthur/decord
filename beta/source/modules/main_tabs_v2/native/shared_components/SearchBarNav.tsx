...
// Function ID: 7651
// Name: SearchBarNav
// Dependencies: [19, 17, 21, 4788, 5931, 576, 5371, 1115, 1364, 5877, 4784, 7327, 2]

// Module 7650 (SearchBarNav)
...
let obj = { container: { flexDirection: "row", alignItems: "center", height: fn(5931).NAV_BAR_HEIGHT, paddingHorizontal: nativeDefault.space.PX_16, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: nativeDefault.colors.BORDER_STRONG }, cancelText: null, cancelIcon: null, flex: null };
let obj3 = { flexDirection: "row", alignItems: "center", height: fn(5931).NAV_BAR_HEIGHT, paddingHorizontal: nativeDefault.space.PX_16, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: nativeDefault.colors.BORDER_STRONG };
...
export default noop.forwardRef((onClose, ref) => {
  ...
  if (obj2.isAndroid()) {
    ...
    let tmp3Result = tmp3(tmp4(5877).ArrowLargeLeftIcon, obj3);
  } else {
    ...
    tmp3Result = tmp3(tmp4(4784).Text, obj4);
  }
