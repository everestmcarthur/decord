...
// Dependencies: [19, 17, 7904, 21, 4788, 576, 504, 16737, 1177, 9126, 1365, 5877, 5929, 4740, 2]
...
function IconWithBadge(includeNotificationsCount) {
  ...
  const items5 = [closure_6(tmp5(9126), obj4), ];
  let tmp9Result = null;
  if (sum > 0) {
...
export const SettingsLeftIconWithBadge = function SettingsLeftIconWithBadge(navigation) {
  ...
  if (noop.useMemo(() => navigation.getState().index > 0, items)) {
    obj.Icon = tmp3(5877).ArrowLargeLeftIcon;
    let tmp5 = obj;
  } else {
    obj.Icon = tmp3(5929).XSmallIcon;
    tmp5 = obj;
  }
