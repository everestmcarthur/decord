...
// Dependencies: [19, 17, 21, 4788, 576, 1177, 13059, 4784, 1115, 2]

// Module 13602 (HomeChannelHeader)
...
export default noop.memo(function HomeChannelHeader() {
  ...
  const items = [React4(native.Icon, { source: _modDef13059, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
