...
// Dependencies: [32, 19, 17, 1372, 1074, 12960, 21, 4788, 576, 12962, 4632, 1241, 1115, 8664, 8139, 1364, 5373, 4784, 14154, 14156, 2]
// Exports: default
...
export default function AddFriendScreen(navigation) {
  ...
  let callback;
  let tmp = closure_13();
  const contactSyncAccount = navigation(12962).useContactSyncAccount();
  let obj = navigation(12962);
  let obj2 = navigation(12962);
  [tmp5, c2] = callback(noop.useState(!navigation(12962).isContactSyncEnabled(contactSyncAccount)), 2);
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(8139).getRenderHeaderTextButton(intl.string(navigation(1115).t.RDE0Sc), callback);
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !tmp2(12962).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = tmp2(12962);
      }
      dependencyMap(tmp5);
    });
  }, items);
  const items1 = [closure_10(contactSyncAccount(5373), { absolute: true }), ];
  ...
  const items2 = [closure_10(navigation(4784).Text, obj4), , , ];
  ...
  items2[1] = closure_10(navigation(4784).Text, obj5);
  items2[2] = closure_10(contactSyncAccount(14154), { style: tmp.input, autoFocusInput: false, sourcePage: navigation.route.params.sourcePage });
  ...
  const items3 = [closure_10(navigation(4784).Text, obj8), ];
  let tmp10Result = null;
  if (tmp5) {
    const obj9 = { style: tmp.rowContainer, location: "Add Friend Modal" };
    tmp10Result = closure_10(contactSyncAccount(14156), obj9);
  }
