...
// Function ID: 14155
// Name: AddFriendById
// Dependencies: [32, 19, 17, 1074, 21, 4788, 576, 1115, 4784, 6887, 14155, 10039, 10035, 4485, 1241, 4499, 7362, 5218, 2]

// Module 14154 (AddFriendById)
...
import FriendsUtils from "FriendsUtils" /* 10039 */;
import FriendRequestMessageExperimentDefault from "FriendRequestMessageExperiment" /* 14155 */;
...
export default noop.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      const validateDiscordTagResult = sourcePage(10039).validateDiscordTag(tmp2);
      if (null != validateDiscordTagResult) {
        ...
        closure_6(obj4);
        const obj6 = { discordTag: tmp2, context: { location: "Search - Add Friend Search" }, errorUxConfig: sourcePage(10035).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED, note: null };
        let tmp9;
        if (trimmed1.length > 0) {
          tmp9 = trimmed1;
        }
        obj6.note = tmp9;
        const obj5 = ref(10035);
        ref(10035).sendRequest(obj6).then(() => {
        ...
        const sendRequestResult = ref(10035).sendRequest(obj6);
      }
      let obj = sourcePage(10039);
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(5218).Button, obj7);
    ...
    const items8 = [tmp17(sourcePage(4784).Text, obj9), , ];
    ...
    obj10.status = str2;
    items8[1] = tmp17(sourcePage(7362).TextArea, obj10);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4784).Text, obj11);
