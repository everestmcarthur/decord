...
// Dependencies: [32, 19, 17, 7907, 4437, 1372, 11151, 1074, 11165, 21, 4788, 576, 17249, 1980, 5142, 563, 7908, 2019, 16757, 7909, 11, 7439, 7459, 1241, 13385, 7445, 17250, 1331, 8480, 1115, 1484, 5936, 5854, 4784, 9922, 5373, 9923, 5371, 11289, 5941, 11157, 2]
// Exports: default
...
let closure_13 = fn(11165).MINIMUM_PENDING_INCOMING_COUNT_FOR_CLEAR_ALL;
const jsxProd = fn(21);
...
export default function FriendRequestsScreen() {
  ...
  const analyticsLocations = first(7439)(first(7459).FRIEND_REQUESTS).analyticsLocations;
  let tmp3 = first(7439);
  ...
  gameRelationshipsByType = analyticsLocations(13385).useGameRelationshipsByType(ignoredUsers.PENDING_INCOMING);
  let obj3 = analyticsLocations(13385);
  gameRelationshipsByType1 = analyticsLocations(13385).useGameRelationshipsByType(ignoredUsers.PENDING_OUTGOING);
  ...
  let obj4 = analyticsLocations(13385);
  ...
  const items11 = [outgoingData(first(5373), { absolute: true }), ];
  ...
  if (tmp28) {
    ...
    obj14.children = tmp32(tmp4(4784).Text, obj15);
    obj13.children = tmp32(tmp4(5371).PressableOpacity, obj14);
  ...
  if (tmp26) {
    ...
    WumpusCouchSpotIllustration = tmp4(5941).WumpusCouchSpotIllustration;
    obj17.illustration = WumpusCouchSpotIllustration;
    obj16.children = tmp32(tmp2(11289), obj17);
    tmp32(tmp33, obj16);
    ...
    items12[2] = tmp32(tmp4(11157).UsersFastList, obj18);
    obj11.children = items12;
    items11[1] = tmp31(tmp33, obj11);
    obj10.children = items11;
    return tmp31(tmp4(7439).AnalyticsLocationProvider, obj10);
  }
};
