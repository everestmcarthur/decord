...
// Dependencies: [19, 17, 21, 4524, 4788, 576, 16386, 4789, 5217, 1177, 16787, 5218, 1115, 2]
...
obj.easing = Easing.in(fn(4524).Easing.quad);
let obj2 = { duration: 250, easing: null };
const Easing2 = fn(4524).Easing;
obj2.easing = Easing2.in(fn(4524).Easing.quad);
let obj3 = { duration: 250, easing: null };
const Easing3 = fn(4524).Easing;
obj3.easing = Easing3.in(fn(4524).Easing.quad);
let obj4 = { duration: 250, easing: null };
const Easing4 = fn(4524).Easing;
obj4.easing = Easing4.out(fn(4524).Easing.quad);
