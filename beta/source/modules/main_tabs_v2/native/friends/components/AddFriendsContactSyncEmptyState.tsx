...
// Dependencies: [19, 17, 21, 4788, 576, 12975, 4784, 1115, 12962, 5218, 12958, 2]
// Exports: default
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  const items = [hasOwnProperty(React4, { resizeMode: "contain", style: tmp.headerImage, source: _modDef12975 }), , , ];
  ...
  const obj2 = { resizeMode: "contain", style: tmp.headerImage, source: _modDef12975 };
