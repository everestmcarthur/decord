...
// Dependencies: [19, 17, 21, 4788, 576, 5690, 5836, 12546, 2]

// Module 16690 (GuildsBarGeoRestrictedBadge)
...
const size1 = { height: 16, width: 16, opacity: fn(5690).DARK_1_LIGHT_08, tintColor: nativeDefault.colors.BLACK };
...
export default noop.memo(function GuildsBarGeoRestrictedBadge(style) {
  ...
  obj.style = items;
  const obj2 = { source: _modDef12546, style: tmp.badgeImage };
  obj.children = jsx(FastImageDefault, { source: _modDef12546, style: tmp.badgeImage });
