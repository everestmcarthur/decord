...
// Dependencies: [17, 21, 4788, 576, 12502, 4784, 1115, 10407, 12491, 11245, 2]
// Exports: default

// Module 12501 (ScheduledMessagesIntro)
...
import _modDef12502 from "module_12502" /* 12502 */;
...
export default function ScheduledMessagesIntro() {
  ...
  const items = [timestampProducer(React3, { source: _modDef12502, style: tmp.upsellImage }), , ];
  ...
  const obj3 = { source: _modDef12502, style: tmp.upsellImage };
