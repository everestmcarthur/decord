...
// Dependencies: [19, 17, 7821, 1971, 7822, 7823, 8523, 9111, 21, 576, 4788, 9123, 9135, 5836, 9136, 9114, 1970, 9131, 2]

// Module 13472 (CollectiblesItemMiniPreview)
...
let closure_8 = fn(8523).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
