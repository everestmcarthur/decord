...
// Dependencies: [17, 21, 4788, 576, 13481, 4784, 7828, 9153, 1115, 13482, 1973, 2]
// Exports: default

// Module 13480 (ProductDetailsActionSheetInfo)
...
import useProductDescription from "useProductDescription" /* 13481 */;
import InlinePriceTagDefault from "InlinePriceTag" /* 13482 */;
...
function ProductPurchaseStatus(product) {
  ...
  if (productPurchaseState.isPurchased) {
    ...
    let children = tmp6(tmp(4784).Text, obj3);
  } else if (tmp5) {
    ...
    children = tmp6(tmp(4784).Text, obj4);
  } else {
    children = !result;
    if (!result) {
