...
// Dependencies: [32, 19, 17, 7816, 7831, 8504, 21, 4788, 576, 9076, 4784, 5219, 563, 11030, 16036, 1177, 11374, 2]
// Exports: default

// Module 16035 (CollectiblesTool)
...
let closure_9 = fn(8504).useFramePreviewOverrideStore;
const jsxProd = fn(21);
