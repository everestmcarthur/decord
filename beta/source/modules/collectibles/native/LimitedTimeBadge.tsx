...
// Dependencies: [19, 17, 2109, 1182, 21, 4788, 576, 1115, 504, 4639, 7713, 4784, 2]
// Exports: default

// Module 9147 (LimitedTimeBadge)
...
export default function LimitedTimeBadge(unpublishedAt) {
  ...
  if (hasItem) {
    ...
    obj6.children = sum;
    obj5.children = jsx(tmp2(4784).Text, { color: str2, variant: "text-xs/bold", accessibilityLabel: null, allowFontScaling: false, children: null });
