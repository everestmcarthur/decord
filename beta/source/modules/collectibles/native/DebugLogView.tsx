...
// Function ID: 16171
// Name: DebugLogView
// Dependencies: [19, 17, 4787, 7830, 21, 4788, 576, 504, 4784, 2]
// Exports: default

// Module 16170 (DebugLogView)
...
const CollectiblesDebugStore = fn(7830);
...
export default function DebugLogView() {
  ...
  if (stateFromStores) {
    if (0 !== arr.length) {
      ...
      const items3 = [closure_9(tmp2(4784).Text, obj4), ];
      const obj6 = {
        onPress() {
              closure_1();
            },
      ...
      obj6.children = closure_10(tmp2(4784).Text, obj7);
