...
// Dependencies: [32, 19, 17, 1076, 21, 9076, 576, 4788, 9108, 5345, 7827, 1973, 8472, 9110, 5836, 9156, 1077, 9157, 9123, 9112, 9135, 9137, 4637, 4489, 9077, 2]

// Module 9155 (CollectiblesShopCardAssetTileV2)
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1973).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      let size = { skuId: product.skuId, width: tmp2(9157).FRACTIONAL_NITRO_COIN_SIZE.CARD, height: tmp2(9157).FRACTIONAL_NITRO_COIN_SIZE.CARD };
      return closure_7(tmp2(9157).FractionalNitroCoinIllustration, size);
    } else {
      ...
      if (tmp2(1973).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = { profileFrame: first, previewWidth: tmp2(9076).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32, previewHeight, profileBackgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
