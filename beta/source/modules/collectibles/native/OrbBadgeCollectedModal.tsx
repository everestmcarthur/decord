...
// Dependencies: [19, 17, 4780, 21, 4788, 576, 5873, 4991, 9161, 11387, 504, 5836, 12067, 8610, 12068, 7400, 9156, 4784, 1115, 5218, 8468, 9159, 7277, 2]
// Exports: default

// Module 13491 (OrbBadgeCollectedModal)
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    const obj4 = { uri: onPressViewBadge(12067) };
    obj3.source = obj4;
    obj3.style = tmp.background;
    let tmp9Result = tmp9(onPressViewBadge(5836), obj3);
    let tmp12 = onPressViewBadge;
    let tmp13 = tmp9;
    const tmp15 = onPressViewBadge(5836);
  } else {
    const obj5 = { source: null, poster: null, style: null, resizeMode: "contain", muted: true, pauseWhileAppInactive: true, paused: false };
    const obj6 = { uri: onPressViewBadge(12068) };
    obj5.source = obj6;
    obj5.poster = onPressViewBadge(12067);
    obj5.style = tmp.background;
    tmp9Result = tmp9(tmp2(8610).VideoComponent, obj5);
  ...
  const items4 = [tmp13(tmp12(5836), obj8), ];
  ...
  const items5 = [tmp13(modalKey(4784).Text, obj12), ];
  ...
  items5[1] = tmp13(modalKey(4784).Text, obj13);
  ...
  items3[1] = tmp13(modalKey(7400).SafeAreaPaddingView, rect);
  ...
  let obj = {
    screens: {
      [closure_9.ROOT]: {
        ...
        headerRight() {
          return timestampProducer(BalanceWidgetPill.BalanceWidgetPill, { initialRenderedBalance: orbBalancePriorToPurchase, balance: _mod9161.useFetchVirtualCurrencyBalance().balance });
        },
        title: ""
      }
    },
