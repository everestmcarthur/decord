...
// Dependencies: [19, 17, 1076, 7428, 2038, 21, 4788, 576, 1478, 6901, 1612, 4524, 17417, 4784, 7815, 7459, 7427, 17418, 1115, 5941, 5218, 2]
// Exports: default

// Module 17416 (CollectiblesMobileAnnouncementActionSheet)
...
export default function CollectiblesMobileAnnouncementActionSheet(markAsDismissed) {
  ...
  const obj3 = { source: { uri: _modDef17418 }, style: tmp.framePreviewImage, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants" };
  ...
  items3[1] = closure_9(markAsDismissed(4784).Text, obj5);
  const obj6 = { style: tmp.featureRows, children: null };
  const obj7 = { icon: closure_9(markAsDismissed(5941).PaintIllocon, { size: 32 }), text: null };
  ...
  const obj8 = { icon: closure_9(markAsDismissed(5941).HeartIllocon, { size: 32 }), text: null };
  ...
  const obj9 = { icon: closure_9(markAsDismissed(5941).ShopIllocon, { size: 32 }), text: null };
  ...
  items3[3] = closure_9(markAsDismissed(5218).Button, obj10);
  obj2.children = items3;
  obj.children = closure_10(closure_5, obj2);
  return closure_9(markAsDismissed(7427).BottomSheet, obj);
};
