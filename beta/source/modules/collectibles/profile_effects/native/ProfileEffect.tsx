...
// Function ID: 9115
// Name: ProfileEffect
// Dependencies: [32, 19, 17, 4780, 1979, 21, 4788, 1478, 9115, 9116, 9117, 9119, 504, 1094, 9120, 9118, 5836, 8527, 2]
// Exports: default, usePreloadProfileEffect

// Module 9114 (ProfileEffect)
import initialize from "initialize" /* 504 */;
import ConstantsIOS from "ConstantsIOS" /* 1094 */;
import useProfileEffectDefault from "useProfileEffect" /* 8527 */;
import utils from "utils" /* 9115 */;
import constants from "constants" /* 9116 */;
import ProfileEffectUtils from "ProfileEffectUtils" /* 9117 */;
import ProfileEffectLayerDefault from "ProfileEffectLayer" /* 9120 */;
...
function StaticEffect(useThumbnail) {
  ...
  if (0 === tmp8) {
    ...
    items1[1] = size1;
    size.style = items1;
    obj3.children = tmp10(tmp4(5836), size);
...
function ProfileEffect(profileEffect) {
  ...
  jsx = noop.useRef(-memo(9116).PROFILE_EFFECT_INTRO_DELAY);
  ...
  const tmp9Result = memo1(9119)(noop.useCallback((arg0) => {
    if (ref.current) {
      if (!ref3.current) {
        tmp.current = true;
