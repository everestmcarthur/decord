...
// Dependencies: [718, 8508, 8509, 8510, 2]
// Exports: compareLayerFiles, isPreviewFilename, parseLayerFilename

// Module 8507 (ProfileFrameLayerParser)
import ProfileFrameLayerType from "ProfileFrameLayerType" /* 8509 */;
import _toArray from "_toArray" /* 718 */;

require = fn;
const preview = "preview";
const responsive = "responsive";
const items = [fn(8509).ProfileFrameLayerType.STAPLE, fn(8509).ProfileFrameLayerType.RAIL, fn(8509).ProfileFrameLayerType.BORDER];
const set = new Set(items);
const items1 = [fn(8510).ProfileFrameLayerAnchor.TOP, fn(8510).ProfileFrameLayerAnchor.BOTTOM, fn(8510).ProfileFrameLayerAnchor.CENTER];
...
const dependencyMap = { [fn(8508).ProfileFrameLayerOrder.FRONT]: 0, [fn(8508).ProfileFrameLayerOrder.BACK]: 1 };
const size = fn(2);
...
export const FOLDER_ORDER_MAP = { foreground: fn(8508).ProfileFrameLayerOrder.FRONT, background: fn(8508).ProfileFrameLayerOrder.BACK };
        ...
        if (set.has(tmp20)) {
          if (tmp20 === ProfileFrameLayerType.ProfileFrameLayerType.BORDER) {
            ...
            if (substr.length > 1) {
              ...
              obj6.type = tmp20;
              obj6.anchor = tmp4(8510).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj10.type = tmp20;
                  obj10.anchor = first;
                  obj10.responsive = 2 === substr.length || tmp20 === tmp4(8509).ProfileFrameLayerType.RAIL;
                  obj9.parsed = obj10;
                  return obj9;
                }
              }
