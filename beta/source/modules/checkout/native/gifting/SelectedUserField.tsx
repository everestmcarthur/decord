...
// Dependencies: [19, 17, 21, 4788, 576, 6895, 1115, 4632, 7328, 1177, 4784, 6890, 2]
// Exports: default

// Module 11148 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4784).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4784).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6890).CircleXIcon, { size: "xs" });
