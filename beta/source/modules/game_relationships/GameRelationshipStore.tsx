...
// Dependencies: [4437, 1074, 4423, 504, 573, 2]

// Module 7926 (GameRelationshipStore)
...
const secondaryIndexMap = new fn(4423).SecondaryIndexMap(function gameRelationshipsIndex(arg0) {
  const items = [];
