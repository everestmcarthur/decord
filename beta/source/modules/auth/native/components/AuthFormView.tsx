...
// Function ID: 7248
// Name: AuthFormView
// Dependencies: [19, 17, 21, 4788, 576, 7219, 7248, 7249, 7250, 7253, 2]
// Exports: default

// Module 7247 (AuthFormView)
import nativeDefault from "native" /* 576 */;
import useWideAuthViewDefault from "useWideAuthView" /* 7219 */;
import WideAuthScrollContext from "WideAuthScrollContext" /* 7248 */;
...
export default function AuthFormView(arg0) {
  ...
  if (tmp3) {
    ...
    if (null != headerText) {
      ...
      tmp15 = timestampProducer(tmp(7249), obj3);
    }
    const items1 = [tmp15, , ];
    let tmp17 = null;
    if (null != subHeader) {
    ...
    const items3 = [timestampProducer(tmp(7250), obj5), timestampProducer(tmp(7253), {}), ];
