...
// Dependencies: [32, 19, 4805, 2098, 502, 2041, 1992, 4427, 1372, 4807, 21, 3, 4788, 504, 7619, 10299, 10314, 12554, 4524, 17564, 4756, 9813, 6929, 17653, 17654, 1115, 10301, 4784, 9977, 10300, 2]
// Exports: MicButton, PTTButton

// Module 17652 (VoicePanelMicButton)
...
export const MicButton = function MicButton(arg0) {
  ...
  const memo = noop.useMemo(() => {
    if (dominantMuteState === VoiceActionUtils.DominantMuteState.SERVER_MUTE) {
      ...
      let tmp3Result = map1(tmp(9977).MicrophoneDenyIcon, obj2);
    } else {
      if (mute) {
      ...
      tmp3Result = map1(tmp(10300).VoicePanelRiveMicButton, obj);
    }
    return tmp3Result;
  }, items2);
