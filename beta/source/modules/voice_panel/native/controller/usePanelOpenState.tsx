...
// Dependencies: [32, 19, 4996, 12555, 1074, 4524, 1110, 13071, 4614, 4627, 13064, 9604, 2]
// Exports: default

// Module 17560 (usePanelOpenState)
...
export default function usePanelOpenState(arg0, arg1, arg2, connected) {
  ...
  [first, closure_6] = doCloseChannel.useState(() => closure_1(13071).getHistory().location.pathname);
  const items1 = [arg0, first];
  const effect1 = doCloseChannel.useEffect(() => {
    closure_0 = closure_1(13071).addRouteChangeListener((pathname) => {
      if (first !== pathname.pathname) {
        closure_1_6(tmp);
        const obj2 = { path: null };
        const RouteParam = closure_0(4627).RouteParam;
        const obj = closure_0(4614);
        const RouteParam2 = closure_0(4627).RouteParam;
