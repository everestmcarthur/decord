...
// Function ID: 17606
// Name: useTapGestures
// Dependencies: [19, 12554, 6929, 4524, 4756, 2]
// Exports: default

// Module 17605 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = noop.useContext(isFocusedVideoZoomed(12554)).isFocusedVideoZoomed;
  ...
  return noop.useMemo(() => {
    ...
    const Gesture = current(6929).Gesture;
    const Gesture2 = current(6929).Gesture;
    ...
    fn.__closure = { runOnJS: current(4524).runOnJS, handleEvent };
    fn.__workletHash = 13571114432746;
    fn.__initData = __initData;
    const obj2 = { runOnJS: current(4524).runOnJS, handleEvent };
    const Gesture3 = tmp(6929).Gesture;
    ...
    fn2.__closure = { runOnJS: current(4524).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    const obj3 = { runOnJS: current(4524).runOnJS, handleEvent };
    const Gesture4 = tmp(6929).Gesture;
    ...
    fn3.__closure = { runOnJS: current(4524).runOnJS, triggerHapticFeedback: current(4756).triggerHapticFeedback, HapticFeedbackTypes: current(4756).HapticFeedbackTypes, handleEvent };
