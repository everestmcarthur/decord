  ...
  return require("initialize").useStateFromStores(items, () => {
    if (null != closure_0) {
      ...
      if (null == participant) {
        ...
        if (null != user) {
          const obj3 = { type: ParticipantTypes.USER, id: tmp, user, selfVideo: false, canRenderVideo: false, userNick: null, userAvatarDecoration: null, streamId: "flex", ringing: null, hasVideo: 29490, isSelf: null };
