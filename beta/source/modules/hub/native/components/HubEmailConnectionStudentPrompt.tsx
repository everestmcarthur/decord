...
// Dependencies: [19, 17, 13001, 1074, 21, 4788, 5773, 576, 1484, 13009, 1177, 1115, 7414, 13011, 1241, 13012, 2]
// Exports: default

// Module 13010 (HubEmailConnectionStudentPrompt)
...
export default function HubEmailConnectionStudentPrompt(onClose) {
  ...
  obj6.source = invite(13011);
  obj5.leading = closure_7(closure_4, obj6);
  obj5.trailing = invite(7414).Arrow;
