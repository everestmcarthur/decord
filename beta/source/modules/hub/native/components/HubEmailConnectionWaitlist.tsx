...
// Dependencies: [19, 17, 1074, 21, 4788, 576, 1484, 7651, 1115, 13017, 1177, 4784, 5218, 2]
// Exports: default

// Module 13016 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerLeft() {
        ...
        obj.onPress = onPress;
        return closure_2_6(onClose(7651).HeaderActionButton, obj);
      }
    });
  }, items);
  const obj2 = { style: tmp.container, children: null };
  let obj = onClose(1484);
  const items1 = [closure_6(closure_5, { source: navigation(13017), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4784).Text, obj5);
  ...
  obj6.children = closure_6(onClose(5218).Button, obj7);
