...
// Dependencies: [5, 32, 19, 17, 13001, 21, 4788, 576, 8903, 5833, 2055, 4784, 1115, 1612, 5218, 1177, 1484, 7651, 7328, 13014, 4688, 13009, 2]
// Exports: default

// Module 13019 (HubEmailConnectionGuildSelect)
            ...
            try {
              ...
              if (0 === c4) {
                if (arg0 === 1) {
                  ...
                  c4 = 3;
                  v3 = 1;
                  const obj5 = { value: email(13014).sendVerificationEmail(email, true, id), done: false };
                  return obj5;
                }
              } else if (1 === tmp8) {
                c3 = 0;
