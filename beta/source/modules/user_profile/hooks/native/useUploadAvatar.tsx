...
// Dependencies: [5, 19, 1372, 1074, 1374, 563, 9459, 4755, 5386, 4446, 14900, 8470, 8468, 8465, 8467, 2]
// Exports: default

// Module 14916 (useUploadAvatar)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            tmp22(4755).hideActionSheet();
            const obj13 = tmp22(4755);
            const obj6 = { size };
            dependencyMap = 1;
            c3 = 1;
            const obj8 = { value: tmp22(5386).openImagePicker(obj6), done: false };
            return obj8;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          if (null == base64) {
            ...
            if (!closure_129_1) {
              canUseAnimatedAvatarResult = tmp22(4446).canUseAnimatedAvatar(closure_129_3);
              const obj = tmp22(4446);
            }
          ...
          tmp22 = tmp2;
          const obj2 = tmp2(14900);
          obj10.description = tmp2(8470).generateAvatarDescription();
          obj10.originalMd5 = originalMd5;
          closure_128_4 = obj2.createPendingImage(obj10);
          if (closure_129_1) {
            tmp28(8468).setTryItOutAvatar(closure_128_4);
            const tmp28Result = tmp28(8468);
          } else {
            const obj11 = { guildId: closure_129_0, avatar: closure_128_4 };
            tmp28(8465).setPendingChanges(obj11);
            const tmp28Result2 = tmp28(8465);
            const result = tmp2(8467).announcePendingAvatarChange("set");
            const obj7 = tmp2(8467);
          }
