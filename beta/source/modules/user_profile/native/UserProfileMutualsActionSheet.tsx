...
// Dependencies: [32, 19, 17, 4828, 8484, 21, 4788, 576, 8517, 504, 5854, 1177, 4940, 11167, 5833, 4784, 12884, 9922, 12891, 12892, 11447, 12885, 12886, 1115, 12896, 12898, 2]
// Exports: default

// Module 12890 (UserProfileMutualsActionSheet)
...
import UserProfileStackedActionSheetDefault from "UserProfileStackedActionSheet" /* 11447 */;
import useUserProfileMutualsDefault from "useUserProfileMutuals" /* 12884 */;
import getMutualGuildsLabelDefault from "getMutualGuildsLabel" /* 12885 */;
import getMutualFriendsLabelDefault from "getMutualFriendsLabel" /* 12891 */;
...
function MutualFriendRow(mutualFriend) {
  ...
  const avatarDecoration = user(8517).useAvatarDecoration(user);
  const obj = user(8517);
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  if (null == mutualFriends) {
    ...
    const obj6 = { style: tmp.emptyState, children: closure_9(tmp6(12892).NoMutualFriends, {}) };
    ...
    tmp10 = closure_9(tmp6(11447).UserProfileStackedActionSheetList, obj7);
  }
  obj4.page = tmp10;
  const items = [obj4, ];
  let length1;
  ...
  if (null == mutualGuilds) {
    ...
    const obj10 = { style: tmp.emptyState, children: tmp9(tmp6(12886).NoMutualServers, {}) };
    ...
    tmp9Result = tmp9(tmp6(11447).UserProfileStackedActionSheetList, obj11);
  }
  ...
  const items1 = [tmp9(closure_5, { children: tmp9(user(12896).Tabs, { state: segmentedControlState }) }), tmp9(user(12898).SegmentedControlPages, { state: segmentedControlState })];
