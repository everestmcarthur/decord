...
// Dependencies: [19, 17, 21, 4788, 576, 1612, 6901, 8903, 1364, 7427, 5371, 1115, 5877, 4784, 2]
// Exports: UserProfileStackedActionSheetList, UserProfileStackedActionSheetSectionList, default

// Module 11447 (UserProfileStackedActionSheet)
...
export default function UserProfileStackedActionSheet(onBack) {
  ...
  if (tmp4Result2) {
    ...
    obj3.onPress = onBack;
    obj3.children = tmp4(tmp5(5877).ArrowLargeLeftIcon, { size: "md" });
    tmp4Result = tmp4(tmp5(5371).PressableOpacity, obj3);
  }
...
export const UserProfileStackedActionSheetList = function UserProfileStackedActionSheetList(data) {
  ...
  return closure_4(data(6901).BottomSheetFlatList, obj);
};
export const UserProfileStackedActionSheetSectionList = function UserProfileStackedActionSheetSectionList(renderItem) {
  ...
  return closure_4(renderItem(6901).BottomSheetSectionList, obj);
};
