...
// Dependencies: [32, 19, 17, 1074, 2038, 21, 4788, 576, 1186, 1115, 13415, 8954, 2019, 2027, 7662, 4784, 7656, 4742, 5371, 5929, 2]
// Exports: default, useIsPrivacyNoticeVisible

// Module 13414 (UserProfilePrivacyNotice)
...
export default function UserProfilePrivacyNotice() {
  ...
  if (tmp9 !== dismissible_content.DismissibleContent.PRIVATE_PROFILE_INLINE_NOTICE) {
    ...
    const obj5 = { style: tmp.icon, children: closure_7(tmp2(4742).CircleInformationIcon, { size: "xs", color: "icon-feedback-info" }) };
    ...
    items1[1] = closure_7(tmp2(4784).Text, obj6);
    ...
    obj8.children = closure_7(tmp2(5929).XSmallIcon, { size: "xs", color: "icon-feedback-info" });
    items1[2] = closure_7(tmp2(5371).PressableOpacity, obj8);
