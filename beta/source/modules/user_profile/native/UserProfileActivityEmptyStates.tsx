...
// Dependencies: [32, 19, 17, 1074, 21, 1115, 4788, 576, 4784, 4940, 12, 4801, 4755, 5218, 7656, 2]

// Module 13402 (UserProfileActivityEmptyStates)
...
const memoResult = noop.memo((user) => {
  ...
  const tmp = closure_10();
  name = name(4940).getName(guildId, channelId, user);
  ...
  obj3.children = closure_7(user(5218).Button, obj4);
