...
// Dependencies: [32, 19, 17, 502, 1074, 21, 4788, 576, 8969, 8970, 4784, 1115, 2019, 8971, 4498, 5836, 5230, 8556, 504, 7484, 8972, 8973, 2]
// Exports: default

// Module 8968 (UserProfilePersonalWidgetCard)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 4498 */;
import FastImageDefault from "FastImage" /* 5836 */;
import GifTagDefault from "GifTag" /* 8556 */;
import PersonalWidgetExpandCollapseContext from "PersonalWidgetExpandCollapseContext" /* 8969 */;
import PersonalWidgetMarkupUtils from "PersonalWidgetMarkupUtils" /* 8970 */;
import WidgetAssetUtils from "WidgetAssetUtils" /* 8971 */;
...
function PersonalWidgetShowMoreButton() {
  ...
  t = tmp5(tmp(4784).Text, { variant: "text-sm/medium", color: "text-subtle", children: intl.string(isExpanded ? t["6MwJo/"] : t.lBeKY2) });
  obj2.children = t;
...
function CoverSection(section) {
  ...
  if (null != source) {
    ...
    if (showGifTag) {
      ...
      tmp24Result5 = tmp24(tmp14(8556), obj10);
    }
...
function UserProfilePersonalWidgetCardContent(style) {
  ...
  obj2.titleLeadingIcon = closure_10(userId(8972).NitroWheelIcon, { size: "xs", color: "icon-subtle" });
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(8973), obj3);
  }
  ...
  return closure_10(disableInteraction(7484), obj2);
}
