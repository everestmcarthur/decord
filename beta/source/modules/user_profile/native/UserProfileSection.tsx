...
// Dependencies: [19, 17, 21, 4788, 576, 4498, 7461, 4637, 8909, 4784, 2]
// Exports: default

// Module 11862 (UserProfileSection)
...
export default function UserProfileSection(title) {
  ...
  if (null != primaryColor) {
    if (null != profileThemeValues) {
      let borderColor = tmp3(4637).hexOpacityToRgba(tmp3(8909).DIVIDER_COLORS[theme], profileThemeValues.dividerOpacity);
    ...
    if (null != title) {
      ...
      const items1 = [React3(tmp3(4784).Text, obj7), headerIcon];
