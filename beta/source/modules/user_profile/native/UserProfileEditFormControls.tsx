...
// Dependencies: [32, 19, 17, 21, 4788, 576, 4784, 8972, 1177, 1115, 6881, 5371, 5861, 1364, 7478, 2]
// Exports: UserProfileEditFormButton, UserProfileEditFormLabelBadges, UserProfileEditFormSwitch

// Module 14925 (UserProfileEditFormControls)
...
export const UserProfileEditFormSwitch = function UserProfileEditFormSwitch(arg0) {
  ...
  if (isAndroidResult) {
    let PressableHighlight = tmp2(5371).PressableHighlight;
  } else {
