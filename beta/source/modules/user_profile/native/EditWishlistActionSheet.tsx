...
// Dependencies: [32, 19, 17, 4780, 9089, 9090, 1372, 7889, 8484, 7428, 21, 4788, 576, 4524, 4789, 504, 1612, 7439, 7459, 13426, 13427, 13407, 9095, 8492, 11447, 1115, 6901, 5936, 7477, 7350, 11331, 8211, 4745, 2]
// Exports: default

// Module 13429 (EditWishlistActionSheet)
...
import WishlistVisibility2 from "WishlistVisibility" /* 13427 */;
...
let closure_12 = fn(8484).TrackUserProfileWishlistActions;
...
exitingAnimation.__closure = { withTiming: fn(4789).withTiming };
...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7439)(analyticsLocations1, tmp4(7459).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  const obj2 = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(7439);
  ({ cardWidth: c5, rowWidth } = analyticsContext(13426)({ maxWidth: ACTION_SHEET_MAX_WIDTH }));
  if (null != rowWidth) {
    let obj3 = { width: rowWidth };
    let tmp7 = obj3;
  }
  let tmp6 = analyticsContext(13426)({ maxWidth: ACTION_SHEET_MAX_WIDTH });
  const items1 = [value];
  ...
  obj9.children = closure_14(wishlistId(7477).TableSwitchRow, obj10);
  obj8.children = closure_14(wishlistId(5936).TableRowGroup, obj9);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = tmp16(tmp2(6901).BottomSheetScrollView, obj5);
