...
// Function ID: 11168
// Name: ActivityStatus
// Dependencies: [19, 17, 4828, 4437, 1372, 11168, 1074, 21, 4788, 504, 11169, 11170, 11171, 11172, 11177, 11178, 11183, 11185, 11176, 2]
// Exports: default

// Module 11167 (ActivityStatus)
...
const DOT_UNICODE = fn(11168).DOT_UNICODE;
...
export default function ActivityStatus(guildId) {
  ...
  const voiceChannel = stateFromStores1(11170)({ userId, guildId: guildId.guildId }).voiceChannel;
  ...
  const tmp6 = stateFromStores1(11169)(userId);
  let state;
  if (memo != null) {
    state = memo.state;
  }
  const gameMentionsAsPlainText = userId(11171).useGameMentionsAsPlainText(state);
  const obj3 = userId(11171);
  ...
  if (tmp2Result.useStateFromStores(items3, () => RelationshipStore.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      let found;
      if (stateFromStores1 != null) {
        found = stateFromStores1.find(tmp5(11177));
      }
      ...
      obj4.hideIcon = tmp12;
      obj4.hideText = tmp13;
      let tmp18Result = closure_10(tmp5(11172), obj4);
      const tmp5Result = tmp5(11172);
    } else {
      let found1;
      if (stateFromStores1 != null) {
      ...
      if (null != found1) {
        ...
        obj5.hideIcon = tmp12;
        obj5.hideText = tmp13;
        tmp18Result = closure_10(tmp5(11178), obj5);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj6.hideIcon = tmp12;
          obj6.hideText = tmp13;
          tmp18Result = closure_10(tmp5(11183), obj6);
        }
      }
    }
    let tmp21 = null;
    if (null != memo) {
      ...
      if (null != memo) {
        ...
        if (tmp25) {
          ...
          tmp25 = closure_10(tmp5(11185), obj7);
        }
        const items7 = [tmp25, ];
        ...
        if (tmp27) {
          ...
          tmp27 = closure_10(tmp5(11176), obj8);
        }
    ...
    if (tmp31) {
      ...
      tmp31 = closure_10(tmp5(11176), obj11);
    }
    items8[1] = tmp31;
    items8[2] = tmp21;
