...
// Dependencies: [19, 17, 2038, 21, 4788, 576, 1612, 7427, 6901, 4784, 1115, 1177, 5219, 2]
// Exports: default

// Module 18241 (GuildRoleSubscriptionTierTemplateSelectedActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [closure_5(markAsDismissed(4784).Text, obj4), closure_5(markAsDismissed(1177).Spacer, { size: 12 }), , , ];
  ...
  items[2] = closure_5(markAsDismissed(4784).Text, obj5);
  ...
  items[4] = closure_5(markAsDismissed(5219).BaseTextButton, obj6);
  obj3.children = items;
