...
// Dependencies: [19, 17, 2063, 1074, 21, 4788, 504, 18174, 12505, 18147, 1115, 15486, 18188, 2]
// Exports: default

// Module 18198 (GuildSettingsRoleSubscriptionContainer)
import GroupListingsFetchContext from "GroupListingsFetchContext" /* 15486 */;
import useOnboardingMonetizationEnableFlowDefault from "useOnboardingMonetizationEnableFlow" /* 18174 */;
...
function ApplicationRejectedNotice(guildId) {
  ...
  if (null != resubmissionError) {
    ...
    let tmp14 = closure_7(tmp9(12505), obj2);
    const tmp9Result = tmp9(12505);
  } else if (null != requestRejectedNoticeText) {
    const obj3 = { notice: requestRejectedNoticeText };
    tmp14 = closure_7(tmp9(18147), obj3);
  } else if (tmp13) {
    const obj4 = { notice: null };
    const intl3 = tmp2(1115).intl;
    obj4.notice = intl3.string(tmp2(1115).t.MyJpJT);
    tmp14 = closure_7(tmp9(18147), obj4);
    const tmp9Result5 = tmp9(18147);
    ...
    tmp14 = closure_7(tmp9(18147), obj5);
    const tmp9Result6 = tmp9(18147);
  } else if (true === hasItem1) {
    const obj6 = { notice: null };
    const intl = tmp2(1115).intl;
    obj6.notice = intl.string(tmp2(1115).t.e2g9sW);
    tmp14 = closure_7(tmp9(18147), obj6);
    const tmp9Result7 = tmp9(18147);
  } else {
    tmp14 = null;
    if (true === hasItem) {
      ...
      tmp14 = closure_7(tmp9(18147), obj7);
      const tmp9Result8 = tmp9(18147);
    }
  }
  let tmp24 = null;
  if (null != tmp14) {
