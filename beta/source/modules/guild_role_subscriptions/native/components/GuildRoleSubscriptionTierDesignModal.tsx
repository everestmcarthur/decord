...
// Dependencies: [32, 19, 17, 15478, 1074, 21, 4788, 576, 4489, 15511, 14196, 18205, 15500, 7464, 18188, 10111, 1115, 18194, 18232, 18197, 2]
// Exports: GuildRoleSubscriptionTierDesignTab, default

// Module 18231 (GuildRoleSubscriptionTierDesignModal)
...
function Content() {
  ...
  items1[1] = closure_9(role(10111), obj7);
  ...
  items1[2] = closure_9(role(18194), obj8);
  const obj9 = { style: tmp3.header, children: null };
  const tmpResult3 = role(18194);
  const intl3 = tmp4(1115).intl;
  obj9.children = intl3.string(require("util").t["W7hH+z"]);
  items1[3] = closure_9(role(10111), obj9);
  items1[4] = closure_9(role(18232), { color: tmp7, onChange: tmp8, disabled: roleSubscriptionSettingsDisabled });
