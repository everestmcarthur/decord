...
// Dependencies: [19, 17, 2041, 21, 4788, 4441, 15513, 1177, 4784, 504, 4941, 1115, 5271, 2]
// Exports: ChannelBenefitRow, IntangibleBenefitRow

// Module 15515 (GuildRoleSubscriptionBenefitRow)
...
const UnicodeEmojisDefault = tmp5(4441);
require = fn;
...
export const ChannelBenefitRow = function ChannelBenefitRow(benefit) {
  ...
  let tmp8 = closure_5(benefit(4784).Text, obj2);
  if (null != stateFromStores) {
    const obj3 = { style: tmp.channelTitle, children: null };
    const obj4 = { style: tmp.channelIcon, size: tmp2(1177).Icon.Sizes.CUSTOM, source: tmp2(5271).getChannelIcon(stateFromStores) };
    const items2 = [tmp7(tmp2(1177).Icon, obj4), ];
    const obj5 = { variant: "text-md/medium", color: "mobile-text-heading-primary", children: tmp6 };
    items2[1] = tmp7(tmp2(4784).Text, obj5);
