...
// Dependencies: [19, 21, 4788, 576, 5371, 4784, 1177, 15495, 2]
// Exports: default

// Module 15494 (NavigateForwardButton)
...
export default function NavigateForwardButton(arg0) {
  ...
  const items = [React3(Text_Text.Text, { style: tmp.text, variant: "text-md/semibold", color: "interactive-text-active", children: text }), React3(native.Icon, { source: _modDef15495 })];
  obj.children = items;
