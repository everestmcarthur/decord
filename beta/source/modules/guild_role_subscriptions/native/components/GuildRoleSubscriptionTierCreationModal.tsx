...
// Dependencies: [5, 32, 19, 18193, 15478, 21, 15500, 4485, 1115, 18205, 18188, 18206, 2]
// Exports: default

// Module 18204 (GuildRoleSubscriptionTierCreationModal)
...
export default function GuildRoleSubscriptionTierCreationModal(guildId) {
  ...
  let obj3 = {
    guildId,
    children: jsx(groupListingId(18206), {
      guildId,
      modalKey,
  ...
  obj2.children = jsx(guildId(18188).RoleSubscriptionSettingsDisabledContextProvider, {
    guildId,
    children: jsx(groupListingId(18206), {
      guildId,
      modalKey,
  ...
  return jsx(guildId(18205).EditStateContextProvider, { guildId, editStateId, groupListingId, children: null });
};
