...
// Dependencies: [19, 17, 21, 4788, 576, 7400, 4784, 15490, 1115, 1612, 5218, 1484, 2]
// Exports: default

// Module 18197 (GuildRoleSubscriptionTierEditStep)
...
function Footer(arg0) {
  ...
  obj.style = items;
  obj.children = timestampProducer(tmp5(5218).Button, { loading: submitting, disabled: !canProceedToNextStep, text: stringResult, onPress: onProceed });
