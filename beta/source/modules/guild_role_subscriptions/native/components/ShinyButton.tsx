...
// Function ID: 10596
// Name: ShinyButton
// Dependencies: [19, 21, 4788, 576, 5219, 1177, 10596, 2]
// Exports: default

// Module 10595 (ShinyButton)
...
export default function ShinyButton(style) {
  ...
  let tmp3Result;
  if (!loading) {
    const obj2 = { size: tmp4(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef10596, style: null };
