...
// Function ID: 16895
// Name: Elements
// Dependencies: [32, 19, 17, 4451, 21, 4788, 576, 4784, 1115, 5371, 1177, 16895, 9512, 15500, 563, 9515, 7511, 2]
...
import useStoreFrontPriceDefault from "useStoreFrontPrice" /* 9515 */;
...
export const ArrowButton = function ArrowButton(arg0) {
  ...
  const items = [React7(Text_Text.Text, { variant: "text-md/semibold", color: "text-default", style: tmp.arrowButtonText, children: text }), React7(native.Icon, { size: native.Icon.Sizes.SMALL, source: _modDef16895, style: tmp.arrowButtonIcon })];
  obj.children = items;
...
export const useFormattedSubscriptionPlan = function useFormattedSubscriptionPlan(listingId) {
  ...
  if (null != price) {
    ...
    str = "" + tmp3(7511).formatPrice(price.amount, price.currency) + "/mo.";
    const tmp3Result = tmp3(7511);
  }
  return str;
};
