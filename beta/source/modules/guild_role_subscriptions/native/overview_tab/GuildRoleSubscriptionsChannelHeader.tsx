...
// Dependencies: [19, 17, 21, 4788, 576, 1177, 13061, 4784, 1115, 2]

// Module 13601 (GuildRoleSubscriptionsChannelHeader)
...
export default noop.memo(function GuildRoleSubscriptionsChannelHeader() {
  ...
  const items = [React4(native.Icon, { source: _modDef13061, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
