...
// Dependencies: [19, 17, 21, 4788, 576, 17137, 4784, 1177, 17132, 2]

// Module 17461 (VoiceOrStageSummaryRow)
...
export default noop.memo(function VoiceOrStageSummaryRow(arg0) {
  ...
  if (tmp8Result) {
    ...
    obj4.style = items3;
    let obj5 = { size: max(1177).Icon.Sizes.CUSTOM, style: { height: 14, width: 14 }, source: _modDef17132 };
    const items4 = [closure_4(max(1177).Icon, obj5), ];
    let obj6 = { variant: "text-sm/bold", style: { marginLeft: 4 }, children: audienceCount };
    items4[1] = closure_4(max(4784).Text, obj6);
