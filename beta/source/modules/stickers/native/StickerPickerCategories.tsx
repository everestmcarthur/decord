...
// Dependencies: [32, 19, 17, 2063, 10685, 1074, 1218, 21, 4788, 576, 2019, 5135, 5517, 1241, 5371, 1177, 1397, 5833, 10472, 5345, 4756, 4757, 10653, 10654, 7332, 1115, 10716, 2]
// Exports: default
...
let useStickerPickerStore = fn(10685).useStickerPickerStore;
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(10653)();
  const tmp20 = closure_15;
  const items9 = [closure_14(categoryIndex(7332), { estimatedListSize: "windowSize", horizontal: true, itemSize: EXPRESSION_FOOTER_HEIGHT, keyboardShouldPersistTaps: "always", listId: ExpressionPickerViewType.STICKER, onLayout: callback4, onScroll: callback1, placeholderConfig: tmp19, ref, scrollReporting: "callbacks", sections: memo, renderItem: callback5, showsHorizontalScrollIndicator: false, style: tmp.list }), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(5371).PressableOpacity, obj3);
  }
  items9[1] = tmp22Result;
  obj.children = items9;
  return tmp20(categoryIndex(10654), obj);
};
