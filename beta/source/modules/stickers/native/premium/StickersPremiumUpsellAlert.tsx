...
// Dependencies: [19, 17, 7514, 1074, 1374, 21, 10704, 1115, 576, 10705, 10706, 4788, 1177, 4784, 573, 7693, 9510, 1478, 7439, 5237, 1241, 9538, 5371, 7269, 10707, 2]
// Exports: default
...
export default function StickersPremiumUpsellAlert(arg0) {
  ...
  const tmp5 = analyticsLocations(9510)(PREMIUM_MONTH_TIER_2.PREMIUM_MONTH_TIER_2);
  let priceString;
  if (tmp5 != null) {
    priceString = tmp5.priceString;
  }
  analyticsLocations = tmp3(7439)().analyticsLocations;
  ...
  const tmp3Result = analyticsLocations(5237);
  obj3.children = closure_14(native.Icon, { source: analyticsLocations(7269) });
  ...
  const obj4 = { source: analyticsLocations(7269) };
