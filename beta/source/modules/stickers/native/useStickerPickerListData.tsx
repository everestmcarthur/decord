...
// Dependencies: [19, 10685, 10570, 1218, 10600, 10684, 9467, 12, 1115, 5517, 10591, 2]
// Exports: default
...
let closure_10 = fn(10600).PREMIUM_UPSELL_SECTION_DIVIDER_HEIGHT + fn(10600).PREMIUM_UPSELL_SECTION_DIVIDER_MARGIN;
const size = fn(2);
