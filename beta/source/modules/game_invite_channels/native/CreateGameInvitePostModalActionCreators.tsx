...
// Dependencies: [4991, 13053, 1980, 2]
// Exports: closeCreateGameInvitePostModal, openCreateGameInvitePostModal

// Module 13052 (CreateGameInvitePostModalActionCreators)
...
export const openCreateGameInvitePostModal = function openCreateGameInvitePostModal(merged) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(13053, dependencyMap.paths), merged, c3);
};
