...
// Dependencies: [32, 19, 17, 5003, 21, 4788, 576, 7219, 5004, 7326, 5766, 5854, 4784, 7327, 7330, 7331, 1115, 7332, 2]
// Exports: default

// Module 7325 (CountryCallingCodeSelect)
...
const getI18NCountryName = fn(5003).getI18NCountryName;
const jsxProd = fn(21);
