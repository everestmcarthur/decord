...
// Dependencies: [19, 17, 21, 576, 4788, 4486, 9086, 4498, 8539, 4489, 9088, 1115, 1370, 9108, 5345, 2]
// Exports: default

// Module 9085 (WishlistItemCardBase)
...
function SourceIcon(toastText) {
  ...
  const obj = {
    ...
    children: closure_5(toastText(9086).HeartIcon, { color: nativeDefault.colors.INTERACTIVE_ICON_DEFAULT, size: "md" })
  };
...
export default function WishlistItemCardBase(username) {
  ...
  let tmp14Result4 = source === tmp2(9088).WishlistItemSource.WISHLIST;
  ...
  if (tmp14Result) {
    ...
    obj7.children = tmp14(tmp2(9108).CheckmarkLargeBoldIcon, obj8);
  ...
  if (tmp14Result3) {
    ...
    obj9.children = tmp14(tmp2(5345).LockIcon, obj10);
