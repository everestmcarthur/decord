...
export default function RoleIcon(arg0) {
  ...
  const obj = { fontFamily: "System", fontSize: size * num, lineHeight: "call", textAlign: true, width: size, marginBottom: -0. };
  if (null != src) {
