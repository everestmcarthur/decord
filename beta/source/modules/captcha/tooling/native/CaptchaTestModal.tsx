...
// Dependencies: [5, 32, 19, 17, 21, 4788, 576, 16001, 16002, 4486, 4784, 1177, 7400, 5218, 4991, 5873, 7277, 1115, 2]
// Exports: default

// Module 16000 (CaptchaTestModal)
...
const prop = fn(16001).HCAPTCHA_DIFFICULTY_OPTIONS;
const options = prop.map((label) => ({ name: label.label, value: label.value }));
let items = [fn(16002).CaptchaDeciderType.HCAPTCHA_RQDATA, fn(16002).CaptchaDeciderType.SMITE_RQDATA];
const set = new Set(items);
const prop1 = fn(16001).CAPTCHA_DECIDER_TYPE_OPTIONS;
