...
// Function ID: 17538
// Name: SoundButton
// Dependencies: [19, 17, 17530, 21, 4524, 4788, 576, 1364, 5371, 5217, 7407, 12217, 17538, 17539, 7439, 7459, 17541, 17527, 17543, 4784, 5345, 2]

// Module 17537 (SoundButton)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport2 from "ReanimatedRexport" /* 4524 */;
import spring from "spring" /* 5217 */;
import EmojiDefault from "Emoji" /* 7407 */;
import getSoundboardEmojiUrlDefault from "getSoundboardEmojiUrl" /* 12217 */;
import openSoundboardSoundPreviewActionSheetDefault from "openSoundboardSoundPreviewActionSheet" /* 17543 */;
...
function SoundButtonEmoji(arg0) {
  ...
  const obj2 = animationConfig(4524);
  fn.__closure = { animationConfig, withDelay: animationConfig(4524).withDelay, withSpring: animationConfig(5217).withSpring, interpolate: animationConfig(4524).interpolate, SPRING_CONFIG };
  ...
  const obj3 = { animationConfig, withDelay: animationConfig(4524).withDelay, withSpring: animationConfig(5217).withSpring, interpolate: animationConfig(4524).interpolate, SPRING_CONFIG };
  ...
  const obj5 = animationConfig(4524);
  fn2.__closure = { animationConfig: obj4, withDelay: animationConfig(4524).withDelay, withSpring: animationConfig(5217).withSpring, interpolate: animationConfig(4524).interpolate, SPRING_CONFIG };
  ...
  const obj6 = { animationConfig: obj4, withDelay: animationConfig(4524).withDelay, withSpring: animationConfig(5217).withSpring, interpolate: animationConfig(4524).interpolate, SPRING_CONFIG };
...
obj.button = { marginTop: 4, height: fn(17530).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
let obj2 = { marginTop: 4, height: fn(17530).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
...
let ReanimatedRexport = ReanimatedRexport_mod;
let closure_10 = ReanimatedRexport.createAnimatedComponent(fn(5371).PressableOpacity);
