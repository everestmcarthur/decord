...
// Dependencies: [32, 19, 1074, 2038, 21, 2027, 7662, 1177, 1115, 11754, 15602, 15604, 2]

// Module 15601 (AccessibilitySetting)
...
const route = SettingBuilders.createRoute({
  ...
  parent: null,
  IconComponent: fn(15602).AccessibilityIcon,
  useTrailing() {
  ...
  usePreNavigationAction() {
    const tmp = _slicedToArray(first(7662).useSelectedDismissibleContent(items), 2);
    first = tmp[0];
    dependencyMap = tmp3;
    items = [tmp[1], first];
