...
// Dependencies: [1992, 8265, 4813, 504, 1115, 11754, 10279, 2]

// Module 15521 (InputModeSetting)
import util from "util" /* 1115 */;
import MediaEngineStore from "MediaEngineStore" /* 1992 */;

require = fn;
const InputModes = fn(4813).InputModes;
...
const pressable = SettingBuilders.createPressable({
  ...
  onPress: fn(10279).handleInputModePress,
  useSearchTerms() {
    const intl = util.intl;
