...
// Dependencies: [32, 19, 17, 1372, 1074, 21, 4788, 5773, 576, 14977, 504, 15230, 5216, 5936, 1115, 5854, 7400, 4784, 1370, 5371, 1177, 7269, 1484, 12546, 7267, 15231, 9193, 10360, 7235, 15232, 2]
// Exports: default

// Module 15229 (UserSettingsSessions)
...
import _modDef12546 from "module_12546" /* 12546 */;
import AuthSessionsActionCreators from "AuthSessionsActionCreators" /* 15230 */;
...
const _modDef7269 = tmp10(7269);
require = fn;
function UserSettingsSessions() {
  const tmp = closure_13();
  let authSessions = otherSessions(14977).useAuthSessions();
  ({ currentSession, otherSessions } = authSessions);
  const obj = otherSessions(14977);
  ...
  if (null == currentSession) {
    ...
    const items1 = [closure_10(tmp2(5936).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      ...
      let tmp20Result = tmp20(tmp2(5936).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    tmp20Result2 = tmp20(tmp2(5216).Stack, obj4);
  }
  ...
  const items3 = [closure_10(otherSessions(4784).Text, obj11), tmp20Result2];
  obj10.children = items3;
  obj9.children = closure_11(otherSessions(7400).SafeAreaPaddingView, obj10);
...
function SessionInfo(session) {
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
        ...
        if ("ios" !== trimmed) {
          if ("android" !== trimmed) {
            if ("horizon os" === trimmed) {
              const obj2 = { text: os, iconSource: _modDef10360, IconComponent: session(15232).VrHeadsetIcon };
              let tmp9 = session;
              let obj = obj2;
            } else {
              obj = { text: os, iconSource: _modDef15231, IconComponent: session(9193).ScreenIcon };
              tmp9 = session;
            }
          }
        }
        const obj3 = { text: os, iconSource: _modDef10360, IconComponent: session(7235).MobilePhoneIcon };
        tmp9 = session;
        obj = obj3;
      }
      ...
      if (!current) {
        formatDateResult = tmp9(14977).formatDate(session.approx_last_used_time);
        const tmp9Result = tmp9(14977);
      }
      ...
      if (!current) {
        ...
        const obj5 = { style: tmp.logoutButton, source: _modDef7269 };
        obj4.children = closure_10(tmp9(1177).Icon, obj5);
        tmp18 = closure_10(tmp9(5371).PressableOpacity, obj4);
      }
      ...
      const items1 = [closure_10(tmp9(4784).Text, obj8), ];
      ...
      if (tmp22Result) {
        ...
        const items2 = [tmp20(tmp9(4784).Text, obj10), ];
        const obj11 = { variant: "text-md/semibold", children: found[1] };
        items2[1] = tmp20(tmp9(4784).Text, obj11);
      ...
      obj12.icon = closure_10(tmp9(5854).TableRow.Icon, obj13);
      ...
      if (tmp20Result3) {
        ...
        obj14.children = tmp20(tmp9(4784).Text, obj15);
      ...
      if (tmp20Result4) {
        ...
        obj16.children = tmp20(tmp9(4784).Text, obj17);
      ...
      return closure_10(tmp9(5854).TableRow, obj12);
    }
  }
  ...
  obj19.iconSource = _modDef15231;
  obj19.IconComponent = session(9193).ScreenIcon;
  tmp9 = session;
  obj = obj19;
}
function UnknownLegacySessionsInfo() {
  ...
  obj2.icon = closure_10(require("TableRow").TableRow.Icon, { variant: "translucent", source: _modDef12546 });
