...
// Dependencies: [32, 19, 17, 21, 4788, 5856, 5216, 4784, 5218, 4524, 5217, 5221, 5199, 5204, 2]
// Exports: default

// Module 16110 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  let obj = showBackdrop(4524);
  fn.__closure = { withSpring: showBackdrop(5217).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5221).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5216).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5204).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4784).Text, obj9);
    obj7.children = tmp13(tmp8(5856).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5199).Dialog, obj5);
  }
