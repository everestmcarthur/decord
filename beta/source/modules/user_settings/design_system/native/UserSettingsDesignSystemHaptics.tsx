...
// Dependencies: [19, 17, 21, 4788, 5218, 4756, 4757, 5216, 5856, 4784, 4758, 2]
// Exports: default

// Module 16120 (UserSettingsDesignSystemHaptics)
...
function HapticButton(text) {
  ...
  return closure_3(type(5218).Button, {
    variant: "secondary",
    onPress() {
...
export default function UserSettingsDesignSystemHaptics() {
  ...
  const items5 = [
    ...
    items4.map((description) => {
      ...
      return closure_3(closure_0(5218).Button, {
        variant: "secondary",
        onPress() {
