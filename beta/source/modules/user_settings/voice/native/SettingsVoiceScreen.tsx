...
// Dependencies: [19, 17, 1992, 8265, 1074, 21, 2108, 4788, 4722, 4639, 10294, 10295, 1115, 6929, 10293, 4784, 10290, 11754, 14992, 2]
// Exports: default

// Module 15520 (SettingsVoiceScreen)
import util from "util" /* 1115 */;
import useThemeDefault from "useTheme" /* 4722 */;
import Text_Text from "Text/Text" /* 4784 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6929 */;
import KrispLogo2 from "KrispLogo" /* 10293 */;
...
function KrispLogo() {
  ...
  if (obj.isThemeLight(tmp4)) {
    let tmp2Result = tmp2(10294);
  } else {
    tmp2Result = tmp2(10295);
  }
...
function SystemProcessingSubLabel() {
  ...
  if (obj.useNoiseCancellationDeferredToSystem()) {
    ...
    tmp3 = React7(tmp(4784).Text, obj2);
  }
  return tmp3;
}
