...
// Dependencies: [19, 17, 1074, 21, 4788, 7618, 7439, 10275, 1115, 5854, 10282, 7612, 4784, 2108, 2]
// Exports: default

// Module 10285 (UserSettingsSoundboardVolume)
...
export default function SoundboardVolume() {
  const tmp = closure_8();
  const amplitudinalSoundboardVolume = analyticsLocations(7618).getAmplitudinalSoundboardVolume();
  ...
  const obj = analyticsLocations(7618);
  ...
  items[1] = closure_5(analyticsLocations(4784).Text, obj7);
  obj4.children = items;
  obj3.subLabel = closure_7(closure_6, obj4);
  obj2.children = closure_5(analyticsLocations(5854).TableRow, obj3);
  return closure_5(analyticsLocations(10275).UserSettingsTableRowGroup, obj2);
};
