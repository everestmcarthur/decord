...
// Dependencies: [19, 17, 1074, 21, 2019, 7272, 5936, 1115, 7477, 1385, 2]
// Exports: default
...
export default function UserSettingsFriendRequests() {
  ...
  const items1 = [closure_7(setting(7477).TableSwitchRow, obj3), , ];
  ...
  items1[1] = closure_7(setting(7477).TableSwitchRow, obj4);
  ...
  items1[2] = closure_7(setting(7477).TableSwitchRow, obj5);
  obj2.children = items1;
  obj.children = closure_8(setting(5936).TableRowGroup, obj2);
