...
// Dependencies: [32, 19, 17, 8265, 1074, 21, 4788, 576, 1115, 2108, 16196, 15096, 12962, 16201, 7575, 11754, 15094, 14992, 16202, 4784, 2]
// Exports: ConnectedGamesPage, DiscordPermissionsPage, default

// Module 16195 (ContentAndSocialScreen)
...
import useAuthorizedSlayerApplicationsDefault from "useAuthorizedSlayerApplications" /* 16202 */;
...
export const DiscordPermissionsPage = function DiscordPermissionsPage() {
  ...
  const memo = noop.useMemo(() => {
    ...
    if (!allServersOptionSelected) {
      const items11 = [];
      HermesBuiltin.arraySpread(tmp2(16196).GUILD_SPECIFIC_SETTINGS, HermesBuiltin.arraySpread(items6, 0));
      tmp9 = items11;
    ...
    if (tmp7) {
      if (tmp8) {
        tmp15 = React7(tmp2(15096).MessageRequestsNotice, {});
      }
    }
