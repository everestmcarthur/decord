...
// Dependencies: [19, 17, 1372, 4452, 8265, 1074, 21, 4788, 576, 1484, 563, 4446, 4784, 1115, 5856, 1177, 10693, 7267, 11754, 14992, 2]
// Exports: default

// Module 15735 (SettingsChatScreen)
...
function VideoUploadQualityNitroUpsell() {
  ...
  if (!stateFromStores) {
    ...
    const obj7 = { style: tmp3.cardIcon, source: _modDef10693, size: tmp(1177).Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.PRIMARY_400 };
    ...
    items2[1] = tmp7(tmp(4784).Text, obj8);
