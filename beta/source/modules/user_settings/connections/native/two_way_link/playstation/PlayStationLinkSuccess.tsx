...
// Dependencies: [19, 17, 21, 4788, 9383, 9399, 4784, 1115, 7400, 5218, 2]
// Exports: PlayStationLinkSuccess

// Module 9414 (PlayStationLinkSuccess)
...
export const PlayStationLinkSuccess = function PlayStationLinkSuccess(onClose) {
  ...
  const items = [timestampProducer(React4, { source: noop.useMemo(() => ({ uri: _modDef9399 }), []), style: tmp.image }), , ];
