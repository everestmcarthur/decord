...
// Dependencies: [19, 17, 21, 4788, 9383, 9425, 4784, 1115, 7400, 5218, 2]
// Exports: default

// Module 9424 (CrunchyrollLinkSuccess)
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef9425, style: tmp.image }), , ];
