...
// Dependencies: [19, 9376, 1074, 21, 4788, 1484, 9386, 9387, 1115, 2]
// Exports: default

// Module 9385 (XboxLinkPreConnect)
...
export default function XboxLinkPreConnect() {
  ...
  const memo = noop.useMemo(() => ({ uri: _modDef9386 }), []);
  ...
  return jsx(navigation(9387).TwoWayLinkPreConnect, { platformType: PlatformTypes.XBOX, onError: callback1, onNext: callback, img: memo, imgStyle: tmp.image, title: null, body: null });
};
