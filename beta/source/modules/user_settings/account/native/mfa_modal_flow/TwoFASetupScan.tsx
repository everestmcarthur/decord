...
// Function ID: 15068
// Name: TwoFASetupScan
// Dependencies: [32, 19, 21, 4788, 576, 7466, 15065, 15061, 7400, 1177, 1115, 4784, 5371, 2]
// Exports: default

// Module 15067 (TwoFASetupScan)
...
export default function TwoFASetupScan(totpSecret) {
  ...
  const twoFASetupStyles = totpSecret(15065).useTwoFASetupStyles();
  ...
  items2[2] = closure_4(totpSecret(4784).Text, { variant: "text-md/bold", style: { textAlign: "center" }, children: totpSecret });
  ...
  items2[3] = closure_4(totpSecret(5371).PressableOpacity, obj5);
  obj2.children = items2;
  obj7.children = closure_5(totpSecret(7400).SafeAreaPaddingView, obj2);
  return closure_4(totpSecret(15061).TwoFASetupModalScreen, obj7);
};
