...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 4788, 576, 5690, 4722, 4639, 1177, 13770, 13771, 4784, 1115, 5230, 9510, 4446, 13772, 13773, 5836, 13774, 13775, 13776, 13777, 13778, 2]
// Exports: default

// Module 13769 (PremiumFeaturesTable)
...
function CheckIcon() {
  ...
  return closure_1_11(native.Icon, { source: _modDef13770, color: shared.isThemeDark(tmp3) ? unsafe_rawColors.WHITE : unsafe_rawColors.PRIMARY_860, size: native.IconSizes.SMALL });
}
function CloseIcon() {
  const tmp = closure_16();
  return closure_1_11(native.Icon, { source: _modDef13771, style: closure_16().icon, size: native.IconSizes.SMALL });
}
...
obj2.themedHighlightedCell = { backgroundColor: fn(5690).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
...
let obj7 = { icon: null };
let obj5 = { backgroundColor: fn(5690).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
