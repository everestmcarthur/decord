...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "PX_16", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: [], errorCallbacks: [], loaded: false, loading: "call", triggeredMigrations: "<string:887308800>", offlineEditDataVersion: "<string:3148152833>" };
  return obj;
};
