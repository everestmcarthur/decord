...
// Dependencies: [19, 17, 1074, 12693, 21, 4788, 576, 12694, 1241, 5856, 10449, 4784, 1115, 5218, 2]
// Exports: default

// Module 15762 (NotificationPermissionSettingsHeader)
...
export default function NotificationPermissionSettingsHeader() {
  ...
  canSeePushNotificationNudge = canSeePushNotificationNudge(12694).useCanSeePushNotificationNudge();
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj5.children = closure_11(tmp2(10449).BellSlashIcon, obj6);
    ...
    items1[1] = closure_11(tmp2(4784).Text, obj7);
    ...
    items1[2] = closure_11(tmp2(4784).Text, obj8);
    ...
    obj10.onPress = tmp6;
    obj9.children = closure_11(tmp2(5218).Button, obj10);
