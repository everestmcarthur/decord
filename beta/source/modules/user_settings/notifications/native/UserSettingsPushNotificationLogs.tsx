...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4788, 576, 6896, 510, 10487, 1612, 7327, 5371, 1115, 8664, 10488, 13236, 9029, 4784, 2]
// Exports: default

// Module 15848 (UserSettingsPushNotificationLogs)
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7327).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10487)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10488)(closure_128_0, false) };
          tmp2(8664).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(13236).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5371).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(9029).FlashList, obj4);
  obj.children = items2;
