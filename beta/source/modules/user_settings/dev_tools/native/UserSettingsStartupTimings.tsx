...
// Dependencies: [5, 32, 19, 17, 1346, 1074, 21, 4788, 576, 4784, 4652, 1612, 10489, 504, 9, 7749, 8664, 9029, 5216, 5936, 5853, 1347, 5854, 13236, 2]
// Exports: default

// Module 15847 (UserSettingsStartupTimings)
...
import serializeAppStartLogsDefault from "serializeAppStartLogs" /* 10489 */;
...
export default function UserSettingsStartupTimings() {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp5(4652).getAppFirstVisibleTimestamp(), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          closure_128_1 = tmp5(10489)(closure_128_0);
          const obj7 = { message: closure_128_1 };
          tmp2(8664).showShareActionSheet(obj7, "Startup Timing");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp17) {
  ...
  obj4.children = closure_8(tmp10(9029).FlashList, obj5);
