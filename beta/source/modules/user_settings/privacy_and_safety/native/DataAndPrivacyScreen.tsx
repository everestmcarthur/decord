...
// Dependencies: [19, 6868, 8265, 1074, 21, 1115, 2108, 10002, 1484, 15136, 15139, 11754, 15094, 14992, 2]
// Exports: default

// Module 16193 (DataAndPrivacyScreen)
...
export default function DataAndPrivacySettings() {
  ...
  const effect = noop.useEffect(() => {
    if (!fetchedConsents.fetchedConsents) {
      const consents = stackNavigation(15136).fetchConsents();
      const obj = stackNavigation(15136);
    }
    const harvestStatus = stackNavigation(15139).fetchHarvestStatus();
  }, []);
  ...
  obj21.screen = stackNavigation(15094).SettingsScreen.DATA_AND_PRIVACY;
  const items9 = [closure_8(items1(15094), obj21), closure_8(items1(14992), { node: memo })];
