...
// Dependencies: [19, 17, 1074, 21, 1186, 2154, 2019, 7477, 1115, 4788, 576, 5936, 2108, 2]
// Exports: default

// Module 16190 (ManageSponsoredContentScreen)
...
function AdTopicRow(adTopic) {
  ...
  let AdTopicOptOuts = adTopic(2019).AdTopicOptOuts;
  ...
  return closure_5(adTopic(7477).TableSwitchRow, obj);
}
