...
// Function ID: 11837
// Name: ChannelBrowser
// Dependencies: [32, 19, 17, 7806, 7388, 2096, 2063, 4969, 1074, 2038, 21, 4788, 576, 7258, 11837, 504, 11839, 4608, 2027, 11835, 7327, 9029, 5856, 5371, 1115, 6890, 5836, 11841, 4784, 4941, 4506, 5936, 5866, 4489, 5271, 5853, 5860, 1177, 4778, 2]
// Exports: default

// Module 11836 (ChannelBrowser)
...
let closure_17 = noop.memo((channel) => {
  ...
  const tmp3 = onChannelClick(4941)(channel);
  ...
  const checkboxA11yNative = channel(4506).useCheckboxA11yNative({ checked: stateFromStores });
  const obj3 = {
  ...
  const items1 = [closure_12(channel(5936).TableRowGroupTitle, { style: tmp.categoryTitle, title: tmp3, lineClamp: 1 }), ];
  ...
  if ("null" !== channel.id) {
    ...
    obj6.children = tmp8(tmp4(5866).FormCheckbox, obj7);
