...
// Dependencies: [19, 17, 2105, 21, 4788, 576, 504, 12513, 1115, 5836, 4784, 2]
// Exports: default

// Module 12679 (ApplicationSectionHeader)
...
export default function ApplicationSectionHeader(section) {
  ...
  const applicationCommandsIconSource = section(12513).getApplicationCommandsIconSource(section, stateFromStores);
  let nick;
  ...
  if (tmp9) {
    ...
    tmp9 = closure_5(guildId(5836), obj4);
  }
  const items1 = [tmp9, closure_5(section(4784).Text, { variant: "eyebrow", color: "interactive-text-default", children: name })];
