...
// Dependencies: [32, 19, 17, 2105, 21, 4788, 576, 5690, 5371, 1115, 1177, 504, 12513, 5836, 4784, 8903, 8575, 12687, 2]
// Exports: default

// Module 12686 (ApplicationCommandBar)
...
import DescriptionEllipsisDefault from "DescriptionEllipsis" /* 12687 */;
...
obj2.applicationCommandOption = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5690).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
let obj5 = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5690).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
...
obj2.completeCommandOption = { backgroundColor: fn(5690).DARK_PRIMARY_660_LIGHT_PRIMARY_300 };
...
export default function _default(command) {
  ...
  if (tmp22) {
    ...
    tmp22 = ref(section(5836), obj4);
  }
  const items5 = [tmp22, ref(command(4784).Text, { style: tmp.applicationName, lineClamp: 1, variant: "text-sm/semibold", color: "mobile-text-heading-primary", children: `/ ${command.displayName}` }), , ];
  ...
  if (tmp4) {
    ...
    items7[1] = tmp25(tmp12(4784).Text, obj7);
  ...
  const items8 = [c10(closure_6, obj3), ref(command(8903).FormDivider, { style: tmp.applicationDescriptionDivider }), ref(stateFromStores, { command, option: currentOption, optionState: tmp17 }), ref(command(8903).FormDivider, { style: tmp.applicationDescriptionDivider })];
