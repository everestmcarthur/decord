...
// Dependencies: [19, 4788, 4489, 576, 672, 2]
// Exports: default

// Module 10403 (useTruncatedGradientColors)
...
export default function useTruncatedGradientColors() {
  const tmp = closure_4();
  token = token(4489).useToken(nativeDefault.colors.MOBILE_ALERT_BACKGROUND_DEFAULT);
