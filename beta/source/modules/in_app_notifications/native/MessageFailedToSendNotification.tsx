...
// Dependencies: [19, 17, 21, 4788, 576, 1115, 4799, 4718, 10466, 10476, 10402, 2]

// Module 10475 (MessageFailedToSendNotification)
...
export default noop.memo(function MessageFailedToSendNotification(notification) {
  ...
  const tmp = closure_6();
  obj3.children = jsx(channelId(10476).RetryIcon, { size: "md", color: messageId(576).colors.ICON_SUBTLE });
  ...
  obj2.children = jsx(channelId(10402).SystemMessageText, { text: null });
  obj2.header = obj;
  obj2.onPress = callback;
  obj2.notification = notification;
  return jsx(channelId(10466).NotificationPressable, { icon: null, children: null, header: null, onPress: null, notification: null });
});
