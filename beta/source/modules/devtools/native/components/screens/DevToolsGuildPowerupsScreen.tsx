...
// Dependencies: [5, 19, 17, 1220, 12845, 2063, 4609, 16019, 1074, 21, 4788, 576, 1271, 4380, 4685, 12771, 15899, 7477, 12777, 2024, 2027, 1612, 504, 4784, 5936, 5854, 2]
// Exports: default

// Module 16018 (DevToolsGuildPowerupsScreen)
    ...
    try {
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          let addResult = null;
          if (!closure_2) {
            addResult = _modDef4380().add(1, "day");
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12777).markContentAsDismissed(dc, guildId, false);
      const tmpResult = tmp(12777);
    } else {
      const result1 = tmp(2024).removeDismissedRecurringContent(dismissible_content.DismissibleContent.GUILD_POWERUP_NOTIFICATION);
      const tmpResult2 = tmp(2024);
      const result2 = GuildDismissibleContentUtils.unmarkContentAsDismissed(dc, guildId);
    }
  }, items);
  return closure_18(dc(7477).TableSwitchRow, { label: closure_15(dc), value: dc.isDismissed, onValueChange: callback });
}
get_ActivityIndicator = fn(17);
({ ScrollView: hasOwnProperty, View: metroRequire } = get_ActivityIndicator);
const DevToolsGuildPowerupsConstants = fn(16019);
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj5.style = items4;
    obj5.children = closure_18(tmp5(4784).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
    ...
    obj8.children = closure_18(tmp5(5854).TableRow, obj9);
    const items6 = [closure_18(tmp5(5936).TableRowGroup, obj8), , , , , , ];
    ...
    const items7 = [closure_18(tmp5(5854).TableRow, obj11), ];
    const obj12 = {
    ...
    items7[1] = closure_18(tmp5(5854).TableRow, obj12);
    obj10.children = items7;
    items6[1] = closure_19(tmp5(5936).TableRowGroup, obj10);
    const obj13 = { title: "User Level DCs", hasIcons: false, children: closure_13.map((dc) => closure_1_18(UserDCSwitchRow, { dc }, dc)) };
    items6[2] = closure_18(tmp5(5936).TableRowGroup, obj13);
    ...
    items6[3] = closure_18(tmp5(5936).TableRowGroup, obj14);
    ...
    obj17.children = closure_18(tmp5(5854).TableRow, obj18);
    items6[6] = closure_18(tmp5(5936).TableRowGroup, obj17);
