...
// Dependencies: [19, 17, 21, 4788, 5931, 576, 4784, 5218, 1115, 2]
// Exports: default

// Module 12970 (NewUserPermissionsOnboarding)
...
let obj2 = { scrollContainer: { minHeight: "100%" }, container: { flexGrow: 1, alignItems: "center", justifyContent: "center" }, alertContainer: { paddingTop: 80 + fn(5931).NAV_BAR_HEIGHT }, alert: null, alertContent: null, alertTitle: null, alertSubtitle: null, buttonWrapper: null, primaryButtonContainer: null, trailing: null };
let obj3 = { paddingTop: 80 + fn(5931).NAV_BAR_HEIGHT };
...
export default function NewUserPermissionsOnboarding(showSkip) {
  ...
  if (flag) {
    ...
    obj10.children = tmp4(tmp6(5218).Button, obj11);
