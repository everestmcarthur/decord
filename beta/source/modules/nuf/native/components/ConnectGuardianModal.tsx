...
// Dependencies: [19, 17, 1074, 7812, 21, 4788, 576, 1612, 17865, 1241, 5826, 4784, 1115, 2482, 15162, 5218, 2]
// Exports: default

// Module 17864 (ConnectGuardianModal)
...
const FamilyCenterAction = fn(7812).FamilyCenterAction;
const jsxProd = fn(21);
...
export default function ConnectGuardianModal(route) {
  ...
  const tmp = closure_9();
  const connectGuardianGate = onComplete(17865).useConnectGuardianGate();
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj2.style = items1;
    obj2.children = closure_7(tmp4(5826).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4784).Text, obj5), ];
    ...
    items2[1] = closure_7(tmp4(4784).Text, obj6);
    ...
    const items4 = [closure_7(tmp4(4784).Text, obj8), ];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(15162).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    ...
    obj12.children = closure_7(tmp4(5218).Button, obj25);
