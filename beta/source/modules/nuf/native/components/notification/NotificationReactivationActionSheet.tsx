...
// Dependencies: [19, 17, 12693, 1074, 21, 4788, 576, 1241, 12694, 4755, 7427, 17868, 4784, 1115, 5682, 5218, 2]
// Exports: default

// Module 17867 (NotificationReactivationActionSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4755 */;
import NotificationPermissionUtil from "NotificationPermissionUtil" /* 12694 */;
import _modDef17868 from "module_17868" /* 17868 */;
import noop from "module_19" /* 19 */;

require = fn;
get_ActivityIndicator = fn(17);
({ View: closure_4, Image: hasOwnProperty } = get_ActivityIndicator);
const EventActionType = fn(12693).EventActionType;
...
export default function NotificationReactivationActionSheet(location) {
  ...
  const items2 = [closure_8(closure_5, { style: tmp.image, source: _modDef17868, resizeMode: "contain" }), , , ];
  ...
  items2[1] = closure_8(_location(4784).Text, obj4);
  ...
  items2[2] = closure_8(_location(4784).Text, obj5);
  ...
  const items3 = [closure_8(_location(5218).Button, obj7), ];
  ...
  items3[1] = closure_8(_location(5218).Button, obj8);
  obj6.children = items3;
  items2[3] = closure_9(_location(5682).ButtonGroup, obj6);
  obj2.children = items2;
  obj.children = closure_9(closure_4, obj2);
  return closure_8(_location(7427).BottomSheet, obj);
};
