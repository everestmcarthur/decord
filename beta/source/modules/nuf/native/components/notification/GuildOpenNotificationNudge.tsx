...
// Dependencies: [32, 19, 2105, 2063, 4609, 4969, 12692, 12693, 1074, 21, 504, 16868, 1115, 15760, 12694, 7383, 4627, 7662, 2027, 12695, 4755, 16867, 1980, 2]
...
export const useGuildOpenNudge = function useGuildOpenNudge() {
  ...
  let obj2 = stateFromStores3(15760);
  ...
  if (tmp12) {
    tmp12 = !tmp(4627).isPseudoGuildId(stateFromStores);
  ...
  const tmp8Result = tmp8(stateFromStores(7662).useSelectedTimeRecurringGuildDismissibleContent(prop, tmp15, closure_17), 2);
  first = tmp8Result[0];
