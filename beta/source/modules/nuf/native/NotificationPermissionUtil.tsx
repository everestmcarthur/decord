...
// Dependencies: [32, 5, 19, 17, 12692, 12693, 1074, 4997, 9592, 1241, 12695, 12701, 12702, 504, 2]
...
// Module 12694 (NotificationPermissionUtil)
...
let closure_10 = fn(4997).NotificationAuthorizationStatus;
const size = fn(2);
