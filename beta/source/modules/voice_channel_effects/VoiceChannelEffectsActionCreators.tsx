...
// Dependencies: [5708, 2095, 7621, 7622, 1074, 5258, 12, 7623, 1271, 7646, 7459, 5264, 2]
// Exports: sendVoiceChannelCustomCallSoundEffect, sendVoiceChannelSoundboardEffect

// Module 7620 (VoiceChannelEffectsActionCreators)
import EmojiStore from "EmojiStore" /* 5708 */;
import SelectedChannelStore from "SelectedChannelStore" /* 2095 */;
import VoiceChannelEffectsPersistedStore from "VoiceChannelEffectsPersistedStore" /* 7621 */;

const require = fn;
const constants = fn(7622).VoiceChannelEffectAnimationType;
...
export const sendVoiceChannelCustomCallSoundEffect = function sendVoiceChannelCustomCallSoundEffect(id, sound, arg2) {
  ...
  obj2.animation_id = abortController(7623).sampleAnimationId(BASIC, abortController(7623).CUSTOM_CALL_SOUND_ANIMATION_RANGE);
  ...
  const tmp2Result = abortController(7623);
  HTTP.post(request).then(closure_8, () => {

  });
  const postResult = HTTP.post(request);
  const items = [abortController(7459).CHANNEL_CALL];
  abortController(7646)(items, arg2, sound, abortController(5264).AnalyticsSoundType.ENTRY);
};
export const sendVoiceChannelSoundboardEffect = function sendVoiceChannelSoundboardEffect(id, emojiId, arg2, arg3, arg4) {
  ...
  abortController(7646)(items, arg2, emojiId, abortController(5264).AnalyticsSoundType.DEFAULT, arg4);
};
