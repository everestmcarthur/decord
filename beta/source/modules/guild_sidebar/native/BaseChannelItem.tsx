...
// Dependencies: [19, 17, 10413, 4970, 21, 4788, 576, 4784, 1365, 1177, 10461, 9216, 12663, 2]
// Exports: BaseChannelIcon, BaseChannelName, default, getChannelSubtitleTextProps, useChannelNameTextProps

// Module 12662 (BaseChannelItem)
...
export default function BaseChannelItem(mode) {
  ...
  if (hideIcon) {
    ...
    obj.children = items1;
    if (flag) {
      let AnimatedPressableHighlight = hideIcon(12663);
    } else {
      AnimatedPressableHighlight = mode(9216).AnimatedPressableHighlight;
    }
    obj2 = {};
    ...
    closure_8(hideIcon(10461), obj3);
    const tmp9 = hideIcon(10461);
  }
};
