...
// Function ID: 16464
// Name: VoiceUsers
// Dependencies: [19, 17, 2105, 21, 4788, 576, 10416, 8149, 504, 16464, 10414, 1115, 12813, 4784, 10030, 16468, 7585, 16471, 2]
// Exports: default, getAudienceItemHeight

// Module 16463 (VoiceUsers)
...
let closure_12 = noop.memo((voiceState) => {
  ...
  const tmp = channel;
  const tmp3 = closure_11(channel(8149)());
  ...
  obj2.children = closure_6(tmp(16464), obj5, user.id);
