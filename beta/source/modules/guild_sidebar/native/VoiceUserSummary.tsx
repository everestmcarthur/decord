...
// Dependencies: [19, 17, 21, 1177, 4788, 8149, 8148, 5347, 5351, 2]

// Module 16472 (VoiceUserSummary)
...
export default noop.memo((guildId) => {
  ...
  const items = [noPadding ? tmp.containerNoPadding : tmp.container, guildId(8148).useClientThemesOverride()];
  obj2.style = items;
  if (renderIcon) {
    if (stageIcon) {
      let VoiceNormalIcon = tmp4(5347).StageIcon;
    }
