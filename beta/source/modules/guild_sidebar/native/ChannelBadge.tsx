...
// Function ID: 16572
// Name: ChannelBadge
// Dependencies: [19, 17, 2109, 21, 4788, 563, 16572, 12579, 4784, 1881, 2]
// Exports: default

// Module 16571 (ChannelBadge)
import useStateFromStores from "useStateFromStores" /* 563 */;
import NewBadgeDefault from "NewBadge" /* 12579 */;
import MentionsBadgeDefault from "MentionsBadge" /* 16572 */;
      ...
      if (!muted) {
        ...
        if (null != postsWithUnreadsCount) {
          ...
          if (postsWithUnreadsCount > 0) {
            ...
            obj5.children = jsx(tmp2(4784).Text, { variant: "text-xs/semibold", color: "text-muted", children: tmp2(1881).humanizeValue(postsWithUnreadsCount, stateFromStores) });
