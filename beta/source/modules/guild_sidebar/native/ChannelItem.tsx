...
// Function ID: 16214
// Name: ChannelItem
// Dependencies: [109, 19, 17, 4676, 4285, 1371, 1074, 1964, 4818, 21, 4636, 576, 5522, 12512, 1396, 5668, 16214, 5156, 5109, 504, 1176, 5088, 16215, 4789, 1100, 2]

// Module 16213 (ChannelItem)
...
function ChannelIcon(arg0) {
  ...
  if (channel.type === ChannelTypes.DM) {
    ...
    return map1(tmp9(12512).BaseChannelIcon, obj10);
  }
}
function DMChannelIcon(userId) {
  ...
  const obj3 = { user: stateFromStores, guildId: "o", size: userId(1176).AvatarSizes.XSMALL_20, style: tmp.dmAvatar, status, isMobileOnline, isVROnline, statusStyle: "lock" };
