...
// Dependencies: [32, 19, 17, 21, 4788, 5021, 10028, 4784, 4632, 1115, 16467, 2]
// Exports: default

// Module 16466 (VoiceUserNameItem)
import Text_Text from "Text/Text" /* 4784 */;
import useDisplayNameStylesDefault from "useDisplayNameStyles" /* 5021 */;
import useDisplayNameStylesFont from "useDisplayNameStylesFont" /* 10028 */;
...
export default function VoiceUserNameItem(arg0) {
  ...
  if (isGuest) {
    ...
    isGuest = tmp18(tmp5(4784).Text, obj6);
  }
  items1[1] = isGuest;
  ...
  if (tmp12) {
    ...
    obj7.children = React5(tmp2(16467), obj8);
