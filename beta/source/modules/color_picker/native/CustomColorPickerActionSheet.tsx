...
// Dependencies: [32, 19, 17, 21, 4788, 576, 14904, 1092, 4524, 14905, 4637, 672, 4755, 7427, 7426, 1115, 5218, 6880, 12, 14906, 2]
// Exports: default

// Module 14903 (CustomColorPickerActionSheet)
...
export default function CustomColorPickerActionSheet(arg0) {
  ...
  sharedValue = onSelect(4524).useSharedValue(h);
  const obj4 = onSelect(4524);
  const sharedValue1 = onSelect(4524).useSharedValue(s);
  const obj6 = onSelect(4524);
  const sharedValue2 = onSelect(4524).useSharedValue(v);
  let combined;
  ...
  obj7.trailing = sharedValue2(onSelect(5218).Button, obj9);
  obj5.header = sharedValue2(onSelect(7426).BottomSheetTitleHeader, obj7);
  ...
  const items3 = [sharedValue2(onSelect(6880).TextInput, obj11), , ];
  const obj12 = { suggestedColors: null, onSelect: null, color: null };
  const obj8 = onSelect(4524);
  ...
  items3[2] = sharedValue2(tmp16(14906), {
    hue: sharedValue,
  ...
  return sharedValue2(onSelect(7427).BottomSheet, obj5);
};
