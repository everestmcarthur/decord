...
// Function ID: 13057
// Name: ChannelNavbar
// Dependencies: [19, 17, 5526, 2045, 2041, 2063, 4828, 4437, 1372, 1074, 2048, 2038, 21, 4788, 5773, 576, 504, 1115, 5271, 4941, 11167, 13057, 13058, 1177, 13059, 13060, 5836, 13061, 10591, 5371, 4784, 4632, 8560, 10043, 4608, 2027, 10921, 13062, 2]
// Exports: ChannelButtons, ChannelTitleWithoutRoute

// Module 13056 (ChannelNavbar)
...
export const ChannelTitleWithoutRoute = function ChannelTitleWithoutRoute(arg0) {
  ...
  if (null != stateFromStores) {
    channelIcon = tmp2(5271).getChannelIcon(stateFromStores);
    const tmp2Result = tmp2(5271);
  }
  let channelName = null;
  if (null != stateFromStores) {
    channelName = tmp2(4941).computeChannelName(stateFromStores, UserStore, RelationshipStore);
...
export const ChannelButtons = function ChannelButtons(buttons) {
  ...
  if (buttons != null) {
    mapped = buttons.map((onPress, index) => {
      ...
      obj.style = style;
      obj.children = children;
      const children1 = [closure_16(closure_1(10043), obj), ];
      let tmp3Result = null;
      if (hasActivitiesPrivateChannelTooltip) {
