...
// Dependencies: [32, 19, 17, 5530, 1372, 14010, 1074, 2038, 21, 4788, 576, 4498, 1612, 4755, 7427, 7426, 7475, 5216, 4784, 1115, 5218, 13278, 9373, 7656, 4496, 5532, 1397, 1177, 8760, 504, 14011, 5655, 4608, 2027, 2]
// Exports: default, useShouldShowRobloxConnectionCoachmark

// Module 17402 (RobloxConnectionCoachmark)
...
export default function RobloxConnectionActionSheet(markAsDismissed) {
  ...
  let tmp = closure_15();
  const theme = markAsDismissed(4498).useThemeContext().theme;
  let obj2 = { startExpanded: true, contentStyles: tmp.content, header: null, onDismiss: null, children: null };
  let obj = markAsDismissed(4498);
  obj2.header = closure_13(markAsDismissed(7426).BottomSheetTitleHeader, { title: null, leading: closure_13(markAsDismissed(7475).ActionSheetCloseButton, { onPress: handleCancel }) });
  ...
  obj5.children = items;
  const items1 = [closure_14(markAsDismissed(5216).Stack, obj5), , ];
  ...
  const items2 = [closure_13(markAsDismissed(4784).Text, obj7), ];
  ...
  items2[1] = closure_13(markAsDismissed(4784).Text, obj8);
  obj6.children = items2;
  items1[1] = closure_14(markAsDismissed(5216).Stack, obj6);
  ...
  const obj3 = { title: null, leading: closure_13(markAsDismissed(7475).ActionSheetCloseButton, { onPress: handleCancel }) };
  obj10.icon = closure_13(markAsDismissed(13278).WindowLaunchIcon, { size: "sm", color: nativeDefault.colors.WHITE });
  ...
  const items3 = [closure_13(markAsDismissed(5218).Button, obj10), ];
  ...
  items3[1] = closure_13(markAsDismissed(5218).Button, obj12);
  obj9.children = items3;
  items1[2] = closure_14(markAsDismissed(5216).Stack, obj9);
  obj4.children = items1;
  obj2.children = closure_14(markAsDismissed(5216).Stack, obj4);
  return closure_13(markAsDismissed(7427).BottomSheet, obj2);
};
export { UnionIcon };
export const useShouldShowRobloxConnectionCoachmark = function useShouldShowRobloxConnectionCoachmark() {
  ...
  stateFromStores = stateFromStores(504).useStateFromStores(items, () => appInstalled.isAppInstalled(stateFromStores(14011).DetectableAppNames.ROBLOX));
