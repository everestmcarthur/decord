...
// Dependencies: [32, 19, 8567, 4524, 4789, 1177, 2]
// Exports: useMediaItemSpoilerState

// Module 13286 (useMediaItemSpoilerState)
...
export const useMediaItemSpoilerState = function useMediaItemSpoilerState(index) {
  mediaItemHasSpoiler = mediaItemHasSpoiler(8567).useMediaItemHasSpoiler(index);
  let obj = mediaItemHasSpoiler(8567);
  let obj2 = noop;
  ...
  sharedValue = mediaItemHasSpoiler(4524).useSharedValue(num);
  ...
  const items1 = [tmp5, ];
  const obj3 = mediaItemHasSpoiler(4524);
  let fn = function l() {
  ...
  fn.__initData = __initData;
  items1[1] = tmp(4524).useAnimatedStyle(fn);
  return items1;
};
