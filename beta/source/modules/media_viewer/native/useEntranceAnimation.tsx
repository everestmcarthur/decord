...
// Dependencies: [32, 19, 1177, 560, 1248, 4789, 4524, 2]
// Exports: useEntranceAnimation

// Module 13306 (useEntranceAnimation)
...
export const useEntranceAnimation = function useEntranceAnimation(entranceAnimationDriver) {
  ...
  const handleError = noop.useCallback(() => {
    if (1 !== entranceAnimationDriver.get()) {
      ...
      const obj3 = timing;
      const fn = function t() {
        closure_0(4524).runOnJS(setUseEntranceAnimationState)({ isComplete: true });
        obj = closure_0(4524);
        closure_0(4524).runOnJS(incrementLoads)();
      };
