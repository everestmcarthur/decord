...
// Function ID: 8577
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4788, 1364, 5847, 12, 672, 5417, 5371, 1115, 8577, 8579, 4784, 8581, 8590, 576, 2]
// Exports: default

// Module 8576 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5847)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5847)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
  ...
  obj2.style = items3;
  const timeFormat = controls(5417).getTimeFormat(tmp3);
  ...
  if (paused) {
    let PauseIcon = tmp16(8577).PlayIcon;
  } else {
    PauseIcon = tmp16(8579).PauseIcon;
  }
  obj3.children = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5371).PressableOpacity, obj3), , , ];
  ...
  obj4.style = items5;
  items4[1] = closure_6(controls(4784).Text, obj4);
  ...
  let obj = controls(5417);
  const tmp9Result = paused(8581);
  ...
  items7[1] = closure_6(paused(8581), obj11);
  ...
  const tmp9Result4 = paused(8581);
  obj13.children = controls(5417).getTimeFormat(ref.current);
  items4[3] = closure_6(controls(4784).Text, obj13);
