...
// Dependencies: [32, 19, 17, 21, 4788, 576, 1364, 4489, 13286, 4524, 5206, 5331, 4784, 1115, 2]

// Module 13301 (MediaModalSpoilerOverlay)
...
export default noop.memo(function MediaModalSpoilerOverlay(source) {
  ...
  if (!tmp5[0]) {
    ...
    if (source.obscure) {
      ...
      items2[1] = tmp9(tmp(4784).Text, obj7);
      ...
      obj6.children = tmp9(tmp(4784).Text, obj8);
    ...
    React5(tmp3(4524).View, obj3);
    const tmp3Result = tmp3(5206);
  }
});
