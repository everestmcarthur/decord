...
// Dependencies: [19, 21, 4788, 576, 1612, 2019, 5371, 11815, 4784, 1115, 2]

// Module 13291 (MediaModalOverlayAltText)
...
export default noop.memo(function MediaModalOverlayAltTextButton(description) {
  ...
  if (ViewImageDescriptions.useSetting()) {
    ...
    if (0 !== str.length) {
      ...
      obj.children = jsx(tmp3(4784).Text, { variant: "text-xs/semibold", color: "text-overlay-light", children: null });
      tmp4 = jsx(tmp3(5371).PressableOpacity, {
        style: tmp2.container,
        onPress() {
              if (str == null) {
                str = "";
