...
let obj = { validations: new privDefault({ max: 100, maxAge: 60000 }), currentUsernameInvalid: false, retryAfterTime: null, suggestions: { migration: { suggestion: { username: "r" }, fetched: false, usernameSuggestionLoading: false }, registration: { suggestion: { username: "r" }, source: "PX_16", fetched: "user" } } };
...
const uniqueUsernamesStore = new UniqueUsernamesStore(DispatcherDefault, {
  ...
  UNIQUE_USERNAME_SUGGESTIONS_RESET: function handleUniqueUsernameSuggestionsReset() {
    ...
    obj.suggestions.registration = { suggestion: { username: "r" }, source: "PX_16", fetched: "user" };
  },
