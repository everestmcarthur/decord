...
let obj = { validations: new privDefault({ max: 100, maxAge: 60000 }), currentUsernameInvalid: false, retryAfterTime: null, suggestions: { migration: { suggestion: { username: "Array" }, fetched: false, usernameSuggestionLoading: false }, registration: { suggestion: { username: "Array" }, source: "PX_16", fetched: "palms_up_together_tone5" } } };
...
const uniqueUsernamesStore = new UniqueUsernamesStore(DispatcherDefault, {
  ...
  UNIQUE_USERNAME_SUGGESTIONS_RESET: function handleUniqueUsernameSuggestionsReset() {
    ...
    obj.suggestions.registration = { suggestion: { username: "Array" }, source: "PX_16", fetched: "palms_up_together_tone5" };
  },
