...
// Dependencies: [4973, 15009, 1115, 2]
// Exports: formatUsernameLiveCheckValidation

// Module 15014 (UniqueUsernamesUtils)
...
export const formatUsernameLiveCheckValidation = function formatUsernameLiveCheckValidation(arg0) {
  const match = _mod4973.match(arg0);
  let obj = { error: null };
  const P = _mod4973.P;
  obj.error = P.not(_mod4973.P.nullish);
  ...
  const obj2 = { error: _mod4973.P.nullish };
  return withResult3.with({ error: _mod4973.P.nullish }, () => ({ type: UniqueUsernamesTypes.NameValidationState.INTERNAL_ERROR, message: "" })).otherwise(() => {
