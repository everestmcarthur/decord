...
// Dependencies: [4427, 1074, 4608, 2027, 563, 7532, 2]
// Exports: useGuildShopPreviewVisible

// Module 7537 (useGuildShopPreviewVisible)
...
export const useGuildShopPreviewVisible = function useGuildShopPreviewVisible(features) {
  ...
  const guildEligibleForGuildProducts = tmp(7532).useGuildEligibleForGuildProducts(id);
