...
// Module 9034 (GameProfileReviewUtils)
...
export const getSteamReviewScoreDescriptionColor = function getSteamReviewScoreDescriptionColor(NO_USER_REVIEWS) {
  if (GameDetectionTypes.SteamReviewScoreDescription.NO_USER_REVIEWS === NO_USER_REVIEWS) {
    ...
    if (tmp(2018).SteamReviewScoreDescription.OVERWHELMINGLY_POSITIVE !== NO_USER_REVIEWS) {
      if (tmp(2018).SteamReviewScoreDescription.VERY_POSITIVE !== NO_USER_REVIEWS) {
        if (tmp(2018).SteamReviewScoreDescription.POSITIVE !== NO_USER_REVIEWS) {
          if (tmp(2018).SteamReviewScoreDescription.MOSTLY_POSITIVE !== NO_USER_REVIEWS) {
            if (tmp(2018).SteamReviewScoreDescription.MIXED === NO_USER_REVIEWS) {
              return "steam-review-text-mixed";
            } else {
              if (tmp(2018).SteamReviewScoreDescription.MOSTLY_NEGATIVE !== NO_USER_REVIEWS) {
                if (tmp(2018).SteamReviewScoreDescription.NEGATIVE !== NO_USER_REVIEWS) {
                  if (tmp(2018).SteamReviewScoreDescription.VERY_NEGATIVE !== NO_USER_REVIEWS) {
                    if (tmp(2018).SteamReviewScoreDescription.OVERWHELMINGLY_NEGATIVE !== NO_USER_REVIEWS) {
                      return "text-subtle";
                    }
                  }
                }
...
export const getSteamReviewScoreDescriptionIntl = function getSteamReviewScoreDescriptionIntl(result) {
  ...
  } else if (tmp(2018).SteamReviewScoreDescription.OVERWHELMINGLY_POSITIVE === result) {
    const intl9 = tmp(1115).intl;
    return intl9.string(tmp(1115).t["75sx1S"]);
  } else if (tmp(2018).SteamReviewScoreDescription.VERY_POSITIVE === result) {
    const intl8 = tmp(1115).intl;
    return intl8.string(tmp(1115).t["EkOVg+"]);
  } else if (tmp(2018).SteamReviewScoreDescription.POSITIVE === result) {
    const intl7 = tmp(1115).intl;
    return intl7.string(tmp(1115).t.ZUkFtr);
  } else if (tmp(2018).SteamReviewScoreDescription.MOSTLY_POSITIVE === result) {
    const intl6 = tmp(1115).intl;
    return intl6.string(tmp(1115).t.M7Z09a);
  } else if (tmp(2018).SteamReviewScoreDescription.MIXED === result) {
    const intl5 = tmp(1115).intl;
    return intl5.string(tmp(1115).t.c8yuHR);
  } else if (tmp(2018).SteamReviewScoreDescription.MOSTLY_NEGATIVE === result) {
    const intl4 = tmp(1115).intl;
    return intl4.string(tmp(1115).t.H0MSjG);
  } else if (tmp(2018).SteamReviewScoreDescription.NEGATIVE === result) {
    const intl3 = tmp(1115).intl;
    return intl3.string(tmp(1115).t.vpLrgz);
  } else if (tmp(2018).SteamReviewScoreDescription.VERY_NEGATIVE === result) {
    const intl2 = tmp(1115).intl;
    return intl2.string(tmp(1115).t["5spYuX"]);
  } else if (tmp(2018).SteamReviewScoreDescription.OVERWHELMINGLY_NEGATIVE === result) {
