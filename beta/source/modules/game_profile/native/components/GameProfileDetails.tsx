...
// Dependencies: [19, 17, 8661, 21, 4788, 576, 4483, 9020, 1115, 1978, 4470, 9192, 9199, 4784, 2]
// Exports: default

// Module 9191 (GameProfileDetails)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import Server from "Server" /* 1978 */;
import DateUtilsAll from "DateUtils" /* 4470 */;
import LinkingDefault from "Linking" /* 4483 */;
import Text_Text from "Text/Text" /* 4784 */;
import SKUUtils from "SKUUtils" /* 9020 */;
...
const IGDB_ATTRIBUTION_LINK = fn(8661).IGDB_ATTRIBUTION_LINK;
const jsxProd = fn(21);
          ...
          if (!tmp34) {
            ...
            if (!tmp61) {
              ...
              if (obj != null) {
                ...
                if (websites != null) {
                  const mapped3 = websites.map((item) => trackAction(9199)(item, trackAction(576).colors.ICON_SUBTLE));
              ...
              const obj8 = { style: closure_2.platformsContainer, children: platforms.map((platform) => closure_1_8(game(9192).GameUpdatePlatformIcon, { platform, size: "md", color: trackAction(576).colors.ICON_SUBTLE }, platform)) };
