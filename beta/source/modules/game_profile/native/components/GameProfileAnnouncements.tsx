...
// Dependencies: [19, 17, 9017, 21, 5238, 1115, 4788, 576, 9045, 7220, 9044, 9063, 9064, 4784, 9067, 4470, 9069, 7439, 9071, 8989, 8983, 9074, 9030, 2]
// Exports: default

// Module 9062 (GameProfileAnnouncements)
...
import GameProfileSkeletonCardRowDefault from "GameProfileSkeletonCardRow" /* 9063 */;
import AnnouncementMessageUtils from "AnnouncementMessageUtils" /* 9064 */;
import ImageWithPlaceholder from "ImageWithPlaceholder" /* 9067 */;
import navigateToGameAnnouncementDefault from "navigateToGameAnnouncement" /* 9074 */;
...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp13Result2) {
      ...
      const items6 = [tmp11(tmp34(9069).ReactionIcon, obj23), ];
      ...
      items6[1] = tmp11(tmp34(4784).Text, obj25);
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp10Result) {
    ...
    const items3 = [tmp26(tmp27(9069).ReactionIcon, obj15), ];
    ...
    items3[1] = tmp26(tmp27(4784).Text, obj17);
...
function PollAnnouncementCard(message) {
  ...
  if (null == poll) {
    ...
    const items = [closure_9(message(4784).Text, obj4), , ];
    ...
    if (tmp9Result) {
      ...
      tmp9Result = tmp9(tmp13(4784).Text, obj);
    }
    items1[1] = tmp9Result;
    ...
    const date = new Date(message.timestamp);
    obj9.createdAt = date;
    obj9.expiryLabel = message(9064).getPollExpiryLabel(poll);
...
const MAX_VISIBLE_ANNOUNCEMENTS = fn(9017).MAX_VISIBLE_ANNOUNCEMENTS;
const jsxProd = fn(21);
