...
// Dependencies: [32, 19, 17, 9017, 9073, 21, 576, 4788, 8979, 8989, 8983, 1115, 9045, 4784, 9044, 9063, 9190, 1478, 9029, 9030, 2]
// Exports: default

// Module 9189 (GameProfileSimilarGames)
...
import useSimilarGamesDefault from "useSimilarGames" /* 9190 */;
...
let closure_8 = fn(9017).MOBILE_GAME_PROFILE_MAX_WIDTH;
...
export default function GameProfileSimilarGames(arg0) {
  ...
  if (set.has(gameId)) {
    ...
    const obj5 = {
      horizontal: true,
      renderScrollComponent: tmp2(9030),
      data: similarGames,
      renderItem(game) {
    ...
    obj3.children = closure_10(_mod9029.FlashList, obj5);
