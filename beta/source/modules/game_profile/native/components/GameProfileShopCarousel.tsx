...
// Dependencies: [19, 17, 21, 4788, 576, 9076, 9044, 9063, 9183, 9184, 8989, 7815, 7459, 1115, 9029, 9030, 2]
// Exports: default

// Module 9075 (GameProfileShopCarousel)
...
function GameProfileShopCarouselContent(trackAction) {
  ...
  const tmp = closure_6();
  dependencyMap = tmp;
  const gameProfileShopCollectionProducts = closeModal(9184).useGameProfileShopCollectionProducts(collectionId);
  ...
  if (gameProfileShopCollectionProducts.isLoading) {
    ...
    if (0 !== products.length) {
      ...
      const obj5 = {
        horizontal: true,
        renderScrollComponent: trackAction(9030),
        data: products,
        renderItem(item) {
              item = item.item;
        ...
        snapToInterval: tmp2(9076).COLLECTIBLES_SHOP_CARD_WIDTH + tmp2(9076).COLLECTIBLES_SHOP_CARD_GAP
      };
      obj3.children = jsx(tmp2(9029).FlashList, {
        horizontal: true,
        renderScrollComponent: trackAction(9030),
        data: products,
        renderItem(item) {
...
obj.skeletonCards = { paddingHorizontal: fn(9076).COLLECTIBLES_SHOP_CARD_GAP };
const obj6 = { paddingHorizontal: fn(9076).COLLECTIBLES_SHOP_CARD_GAP };
obj.horizontalSpacing = { width: fn(9076).COLLECTIBLES_SHOP_CARD_GAP };
