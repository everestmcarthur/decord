...
// Dependencies: [32, 19, 17, 4780, 1085, 21, 576, 9025, 4788, 8989, 8562, 8610, 1115, 9026, 9015, 504, 9029, 9030, 2]
// Exports: default

// Module 9024 (GameProfileMedia)
import nativeDefault from "native" /* 576 */;
import openMediaModal from "openMediaModal" /* 8562 */;
import GameProfileAnalyticUtils from "GameProfileAnalyticUtils" /* 8989 */;
import GameProfileMediaSources from "GameProfileMediaSources" /* 9025 */;
...
let closure_15 = 2 * (fn(9025).MEDIA_ITEM_MAX_WIDTH + PX_12);
...
obj.mediaItem = { maxWidth: fn(9025).MEDIA_ITEM_MAX_WIDTH, maxHeight: fn(9025).MEDIA_ITEM_MAX_HEIGHT, borderRadius: nativeDefault.radii.lg, overflow: "hidden" };
