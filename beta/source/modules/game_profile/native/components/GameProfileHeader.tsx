...
// Dependencies: [19, 17, 9017, 21, 4788, 576, 4524, 9020, 9021, 5230, 9022, 4784, 2]
// Exports: default

// Module 9019 (GameProfileHeader)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4524 */;
import Text_Text from "Text/Text" /* 4784 */;
import LinearGradientDefault from "LinearGradient" /* 5230 */;
import useGameProfileHeroBackgroundURLDefault from "useGameProfileHeroBackgroundURL" /* 9021 */;
...
obj2.headerContent = { paddingTop: nativeDefault.space.PX_32, paddingHorizontal: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_12, flexDirection: "row", alignItems: "flex-end", maxWidth: fn(9017).MOBILE_GAME_PROFILE_MAX_WIDTH, alignSelf: "center", width: "100%" };
let obj4 = { paddingTop: nativeDefault.space.PX_32, paddingHorizontal: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_12, flexDirection: "row", alignItems: "flex-end", maxWidth: fn(9017).MOBILE_GAME_PROFILE_MAX_WIDTH, alignSelf: "center", width: "100%" };
...
export default function GameProfileHeader(game) {
  ...
  const mapped = genres.map(tmp2(9020).getGenreText);
  ...
  if (tmp15Result3) {
    ...
    tmp15Result3 = tmp15(tmp6(9022), obj16);
  }
  ...
  if (null != joined) {
    ...
    if ("" !== joined) {
      ...
      tmp15Result4 = tmp15(tmp2(4784).Text, obj18);
    }
  }
