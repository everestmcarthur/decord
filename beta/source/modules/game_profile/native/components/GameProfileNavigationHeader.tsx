...
// Dependencies: [19, 17, 21, 4788, 576, 4524, 4789, 1397, 9216, 4784, 9022, 2]
// Exports: default

// Module 9215 (GameProfileNavigationHeader)
...
export default function GameProfileNavigationHeader(game) {
  ...
  sharedValue = game(4524).useSharedValue(num);
  ...
  const animatedStyle = game(4524).useAnimatedStyle(fn);
  const tmp3Result = game(4524);
  ...
  const animatedStyle1 = game(4524).useAnimatedStyle(fn2);
  ...
  if (null != name) {
    ...
    const items2 = [closure_7(tmp3(9216).BackgroundBlurFill, {}), ];
    ...
    const items4 = [closure_7(tmp3(4784).Heading, obj7), ];
    let l30Rank;
    if (game != null) {
    ...
    if (tmp13Result) {
      ...
      const items5 = [tmp15(application(9022), obj9), ];
      const obj10 = { style: null, children: null };
      const items6 = [StyleSheet.absoluteFill, animatedStyle1];
      obj10.style = items6;
      const obj11 = { rank: game.l30Rank };
      obj10.children = tmp15(application(9022), obj11);
      items5[1] = tmp15(application(4524).View, obj10);
    ...
    if (tmp15Result2) {
      ...
      tmp15Result2 = tmp15(application(4524).View, obj12);
    }
