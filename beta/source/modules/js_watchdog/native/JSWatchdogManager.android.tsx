...
// Dependencies: [5, 1074, 3, 1091, 7395, 17823, 1231, 1241, 7749, 7745, 7735, 2]

// Module 17822 (JSWatchdogManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp2(7735).getSession(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          c3 = 3;
