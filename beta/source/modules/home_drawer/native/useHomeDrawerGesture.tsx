...
// Dependencies: [32, 19, 16358, 16365, 1074, 11750, 4651, 4524, 1485, 1241, 4789, 16359, 4756, 1478, 1612, 4648, 11751, 4646, 16366, 4645, 4791, 6929, 7351, 2]
// Exports: useDoesLandOnHomeDrawer, useHomeDrawerState, useHomeGesture, useIsHomeDrawerEnabled

// Module 16364 (useHomeDrawerGesture)
...
import HomeDrawerAnimations from "HomeDrawerAnimations" /* 16359 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import HomeDrawerStore from "HomeDrawerStore" /* 16358 */;
import HomeDrawerSubtitleStore from "HomeDrawerSubtitleStore" /* 16365 */;

require = fn;
const computeMaxX = fn(16358).computeMaxX;
...
export const useHomeGesture = function useHomeGesture() {
      ...
      if (null !== arg1) {
        if (arg0 !== arg1) {
          if (arg0) {
            ...
            const result1 = snapX.set(timing.withTiming(c11, HomeDrawerAnimations.HOME_DRAWER_SNAP_TIMING, "animate-always"));
  ...
  Ce.__closure = { accessibilityPreferencesSharedValue: landOnHome(snapX[20]).accessibilityPreferencesSharedValue, pullFraction: derivedValue2, HOME_DRAWER_PULL_DISTANCE: 12, flingThrow: sharedValue5, HOME_DRAWER_FLING_THROW_DISTANCE: 16 };
  Ce.__workletHash = 9960352904018;
  Ce.__initData = __initData2;
  const derivedValue3 = tmpResult17.useDerivedValue(Ce);
  const obj16 = { accessibilityPreferencesSharedValue: landOnHome(snapX[20]).accessibilityPreferencesSharedValue, pullFraction: derivedValue2, HOME_DRAWER_PULL_DISTANCE: 12, flingThrow: sharedValue5, HOME_DRAWER_FLING_THROW_DISTANCE: 16 };
  function be() {
    const obj = { transform: null };
  ...
  const memo = obj11.useMemo(() => {
    ...
    settleDrawer = function settleDrawer(flag) {
      ...
      const result1 = settleDrawer.set(landOnHome(snapX[10]).withTiming(num, tmp3(tmp4[11]).HOME_DRAWER_SETTLE_TIMING, "animate-always"));
      const obj = landOnHome(snapX[10]);
      const result2 = fireThrow.set(landOnHome(snapX[10]).withTiming(0, tmp3(tmp4[11]).HOME_DRAWER_SETTLE_TIMING, "animate-always"));
