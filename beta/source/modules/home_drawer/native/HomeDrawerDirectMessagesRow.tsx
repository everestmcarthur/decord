...
// Dependencies: [19, 17, 4828, 4437, 1074, 21, 4788, 576, 504, 4784, 1115, 16648, 4651, 4648, 2]
// Exports: default

// Module 16652 (HomeDrawerDirectMessagesRow)
...
function HomeDrawerDMsRow() {
  ...
  if (stateFromStores > 0) {
    ...
    items1[1] = React5(tmp2(4784).Text, obj4);
