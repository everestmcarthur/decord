...
// Dependencies: [7734, 1074, 3, 7395, 17819, 1339, 16345, 17820, 7749, 2]

// Module 17818 (JankSessionManager)
import LoggerDefault from "Logger" /* 3 */;
import clientLaunchId from "clientLaunchId" /* 1339 */;
import NativeJankSessionModuleDefault from "NativeJankSessionModule" /* 17819 */;
import JankNavigationReporterDefault from "JankNavigationReporter" /* 17820 */;
    ...
    const nextPromise = pendingReports.then((arr) => {
      ...
      if (0 !== arr.length) {
        const result = AnalyticsTrackingStore.submitEventsImmediately(arr.flatMap((screens) => {
          ...
          let merged = Object.assign(screens(7749).getDeviceMetadata());
          ...
          const items = [
            ...
            ...screens.map((item) => {
              ...
              const merged = Object.assign(screens(7749).getDeviceMetadata());
