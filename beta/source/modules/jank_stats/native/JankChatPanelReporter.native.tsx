...
// Dependencies: [19, 21, 16347, 16350, 2]
// Exports: default

// Module 16346 (JankChatPanelReporter)
...
export default function JankChatPanelReporter(channelId) {
  ...
  const obj = { position: translateX, openAt: 0, closedAt: maxWidth, resolveOpenName: callback, resolveClosedName: channelId(16347).getPanelListScreenName };
  return jsx(showCreateThread(16350), { position: translateX, openAt: 0, closedAt: maxWidth, resolveOpenName: callback, resolveClosedName: channelId(16347).getPanelListScreenName });
};
