...
// Dependencies: [19, 17, 11655, 21, 4788, 576, 11691, 1115, 4784, 5218, 4483, 11662, 2]
// Exports: default

// Module 11690 (SafetyToolsCrisisTextLineActionSheet)
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  const items = [closure_6(trackAnalyticsEvent(4784).Text, obj3), , ];
  ...
  items[1] = closure_6(trackAnalyticsEvent(5218).Button, obj4);
  ...
  items[2] = closure_6(trackAnalyticsEvent(5218).Button, obj5);
  obj2.children = items;
