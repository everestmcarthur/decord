...
// Dependencies: [5, 32, 19, 17, 4437, 1372, 11655, 21, 4788, 576, 504, 11682, 11685, 1484, 10035, 8707, 11662, 8939, 4486, 1115, 4747, 4485, 5218, 11693, 8975, 5291, 8888, 4483, 4784, 2]
// Exports: default

// Module 16040 (TakeActionScreen)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            const obj5 = {
              value: tmp4(8939).submitReportForInappropriateConversationSafetyAlert(lastChannelMessage, () => {
                        dependencyMap(true);
                        ...
                        obj2.IconComponent = closure_0(4747).CircleCheckIcon;
                        obj2.iconColor = iconColor;
                        obj2.containerStyle = toastContainer.toastContainer;
                        c1(4486).open(obj2);
                      }, () => {
                        const intl = closure_1_0(1115).intl;
                        closure_1_0(4485).presentFailedToast(intl.string(closure_1_0(1115).t["0YV04/"]));
                      }),
              done: false
            };
            return obj5;
          ...
          closure_128_6(false);
          const result = v1(8707).showReportSuccessToast(closure_128_0, closure_128_1);
          closure_128_3(tmp4(11662).CtaEventTypes.USER_TAKEOVER_MODAL_REPORT);
          const obj = v1(8707);
        }
        dependencyMap = 3;
