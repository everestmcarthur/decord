...
// Dependencies: [5, 14159, 1074, 7395, 14158, 7521, 2]

// Module 18268 (MidjourneyOnboardingManager)
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import AutomaticLifecycleManager from "AutomaticLifecycleManager" /* 7395 */;

const require = fn;
const MIDJOURNEY_GUILD_ID = fn(14159).MIDJOURNEY_GUILD_ID;
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            if (obj6.isEligibleForMidjourneyRedirect(channel)) {
              v1 = 1;
              dependencyMap = 1;
              const obj4 = { value: tmp21(14158).hasRedirectedToGuild(MIDJOURNEY_GUILD_ID), done: false };
              return obj4;
            } else {
              dependencyMap = 3;
            }
          ...
          v1(7521)(Routes.CHANNEL(null, closure_128_0.id));
          const tmp9 = v1(7521);
        }
        dependencyMap = 3;
