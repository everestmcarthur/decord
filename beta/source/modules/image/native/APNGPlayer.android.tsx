...
// Function ID: 9122
// Name: APNGPlayer
// Dependencies: [19, 21, 9122, 2]
// Exports: useAPNGPlayerControls

// Module 9121 (APNGPlayer)
...
export const APNGPlayer = noop.forwardRef((onLoad, ref) => {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref, () => ({
    play() {
      if (null != ref.current) {
        const Commands = onLoad(9122).Commands;
    ...
    stop() {
      if (null != ref.current) {
        ...
        const Commands2 = onLoad(9122).Commands;
  ...
  return jsx(ref(9122), { ref, onLoad: callback });
});
