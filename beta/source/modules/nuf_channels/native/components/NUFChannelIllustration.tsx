...
// Dependencies: [32, 19, 17, 21, 4788, 576, 1115, 14069, 14070, 4524, 4789, 14071, 14072, 14073, 14074, 5856, 5330, 4784, 2]
// Exports: default

// Module 14068 (NUFChannelIllustration)
...
export default function NUFChannelIllustration() {
  ...
  obj14.children = closure_7(first(4524).View, {
    style: animatedStyle,
