...
// Dependencies: [19, 17, 10587, 21, 4788, 576, 1177, 8457, 4784, 1115, 10601, 2]

// Module 10603 (EmojiPickerListComponents)
...
const memoResult = noop.memo(() => {
  ...
  const items = [React4(native.Icon, { source: _modDef8457, size: native.Icon.Sizes.SMALL }), ];
