...
// Dependencies: [19, 17, 1074, 21, 4788, 576, 9367, 8642, 1115, 4487, 9567, 9380, 7654, 4784, 9569, 2]
// Exports: default

// Module 9566 (ApplicationEducation)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4784 */;
import OAuth2Scopes from "OAuth2Scopes" /* 8642 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9367 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4487).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9567).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9380).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7654).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8642).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4487).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9380).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7654).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4784).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9569).AuthorizeFormSeparator, {})];
