...
// Function ID: 9584
// Name: oauth2/Header
// Dependencies: [19, 17, 1074, 21, 4788, 576, 1397, 1177, 4784, 9584, 1385, 1115, 2]
// Exports: default

// Module 9583 (oauth2/Header)
...
export default function Header(accountScopes) {
  ...
  if (null != bot) {
    ...
    tmp8Result = tmp8(tmp2(9584), obj13);
    const tmp2Result2 = tmp2(9584);
  }
  items3[1] = tmp8Result;
