...
// Dependencies: [19, 17, 5015, 502, 1372, 21, 4788, 576, 4722, 504, 5532, 1397, 4639, 7440, 1177, 8213, 4784, 1115, 5218, 9373, 4742, 4738, 2]
// Exports: ConnectedAccountCard, default

// Module 9372 (ConnectAccountStep)
...
export default function ConnectAccountStep(clientId) {
  ...
  value = platformType(5532).get(platformType);
  if (null == value) {
    ...
    items4[1] = closure_8(tmp5(8213).MoreHorizontalIcon, obj10);
    ...
    items6[1] = closure_8(tmp5(4784).Text, obj14);
    ...
    items7[1] = closure_8(tmp5(4784).Text, obj18);
    const obj19 = {
      variant: "primary",
      size: "sm",
      onPress() {
    ...
    items7[2] = closure_8(tmp5(5218).Button, obj19);
    ...
    const items8 = [closure_8(tmp5(4742).CircleInformationIcon, obj21), ];
    ...
    items8[1] = closure_8(tmp5(4784).Text, obj22);
    ...
    const source = tmp5Result.makeSource(tmp5(4639).isThemeLight(tmp4) ? icon.lightPNG : icon.darkPNG);
    const tmp5Result2 = tmp5(4639);
  }
};
