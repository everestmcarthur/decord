...
// Dependencies: [19, 17, 21, 4788, 576, 9359, 1612, 4524, 5217, 5371, 1115, 9586, 5929, 4784, 7400, 9588, 2]
// Exports: default

// Module 9358 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  const tmp = closure_8();
  const tmp4 = sharedValue(9359)(arg0);
  _require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9586).ArrowSmallLeftIcon, obj7);
  } else {
    const obj8 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = tmp11(tmp5(5929).XSmallIcon, obj8);
  }
  ...
  obj11.style = items3;
  items2[2] = closure_5(sharedValue(4524).View, obj11);
  ...
  obj12.children = closure_5(sharedValue(9588), obj13);
