// Module ID: 9354
// Function ID: 9355
// Dependencies: [19, 17, 21, 4788, 576, 7400, 9355, 4784, 1115, 5218, 4991, 2]
// Exports: default
...
export default function ErrorResult(error) {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef9355, style: tmp.image }), ];
  ...
  if (!error.hideFooter) {
    ...
    tmp6Result = tmp6(tmp3(5218).Button, obj5);
  }
  items1[1] = tmp6Result;
  obj.children = items1;
