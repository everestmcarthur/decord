...
// Dependencies: [32, 19, 17, 1074, 21, 4788, 576, 10664, 6896, 4524, 4789, 4792, 8211, 7329, 1115, 7327, 10662, 5371, 10670, 4784, 2]

// Module 10669 (GIFPickerHeader)
...
obj.headerContainer = { flexDirection: "row", justifyContent: "space-between", gap: fn(10664).GIF_PICKER_GUTTER_SPACING };
let obj4 = { flexDirection: "row", justifyContent: "space-between", gap: fn(10664).GIF_PICKER_GUTTER_SPACING };
obj.header = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6896).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
...
let obj5 = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6896).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
const size = fn(2);
...
export default noop.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(7327).SearchField, obj2);
  } else {
    ...
    const items = [tmp6(tmp2(10670).ChevronLargeLeftIcon, obj6), ];
    ...
    items[1] = tmp6(tmp2(4784).Text, obj7);
    obj4.children = items;
    const items1 = [React7(tmp2(5371).PressableOpacity, obj4), ];
