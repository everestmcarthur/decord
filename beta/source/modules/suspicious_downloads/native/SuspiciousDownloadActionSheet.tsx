...
// Dependencies: [19, 21, 4788, 576, 1612, 7427, 5216, 5941, 4784, 1115, 5218, 4755, 4477, 2]
// Exports: default

// Module 13269 (SuspiciousDownloadActionSheet)
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [closure_3(href(5941).TrafficConeSpotIllustration, {}), , ];
  ...
  items1[1] = closure_3(href(4784).Text, obj4);
  ...
  items1[2] = closure_3(href(4784).Text, obj5);
  obj3.children = items1;
  const items2 = [closure_4(href(5216).Stack, obj3), ];
  ...
  const items3 = [closure_3(href(5218).Button, obj7), ];
  ...
  items3[1] = closure_3(href(5218).Button, obj8);
  obj6.children = items3;
  items2[1] = closure_4(href(5216).Stack, obj6);
  obj2.children = items2;
  obj.children = closure_4(href(5216).Stack, obj2);
  return closure_3(href(7427).BottomSheet, obj);
};
