...
// Dependencies: [5, 19, 2041, 2095, 1074, 4417, 9646, 9647, 9671, 1110, 2]
// Exports: default

// Module 17518 (useTransitionToConnectedActivityInVoice)
            ...
            if (0 === c3) {
              ...
              if (1 === tmp5) {
                if (arg0 === 1) {
                  ...
                  embeddedActivityLocationChannelId = handler(4417).getEmbeddedActivityLocationChannelId(_location2);
                  if (null != embeddedActivityLocationChannelId) {
                    if (closure_2_1(9646)(embeddedActivityLocationChannelId)) {
                      if (voiceChannelId.getVoiceChannelId() !== embeddedActivityLocationChannelId) {
                        ...
                        c3 = 2;
                        c4 = 1;
                        const obj6 = { value: closure_2_1(9647)(obj5), done: false };
                        return obj6;
                      }
                    }
                  }
              ...
              const timerId = setTimeout(() => {
                closure_3_1(9671)(closure_1_3, _location);
                if (closure_0 != null) {
                  closure_0();
                }
              }, 0);
