...
// Dependencies: [5, 32, 19, 17, 2041, 1372, 2040, 11151, 4781, 21, 4788, 576, 504, 11276, 12414, 14797, 7445, 1370, 14799, 7730, 7950, 4486, 1115, 7466, 4485, 1478, 1612, 1364, 5880, 8139, 5873, 7651, 4730, 5373, 11279, 11290, 2]
// Exports: default

// Module 14798 (ActivityShareLinkModal)
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != first3) {
              dependencyMap = 1;
              c3 = 1;
              let obj4 = { value: Promise.all(first1.map(tmp2(11276).getOrResolveChannelIdFromDestinationId)), done: false };
              return obj4;
            } else {
              c3 = 3;
            }
          ...
          closure_128_1 = tmp2(14799).resolveActivityShareMessageContent(closure_129_3, closure_129_14, closure_129_12);
          closure_129_6(true);
                ...
                try {
                  ...
                  if (0 === c2) {
                    if (arg0 === 1) {
                      ...
                      if (null != channel) {
                        const obj2 = closure_2_1(7730);
                        const obj6 = { location: constants.ACTIVITY_SHARE };
                        c2 = 1;
                        c1 = 1;
                        const obj7 = { value: obj2.sendMessage(tmp17, closure_2_1(7950).parse(channel, c1), false, obj6), done: false };
                        return obj7;
                      }
                    }
                  } else if (arg0 === 1) {
          ...
          let obj6 = tmp3(4486);
          const result = tmp2(14797).closeActivityShareLinkModal();
          const obj9 = tmp2(14797);
        }
        c3 = 3;
