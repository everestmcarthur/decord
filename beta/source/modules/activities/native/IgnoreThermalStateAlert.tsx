...
// Dependencies: [19, 21, 4788, 5237, 1115, 9625, 4784, 2]
// Exports: IgnoreThermalStateAlert

// Module 9707 (IgnoreThermalStateAlert)
...
export const IgnoreThermalStateAlert = function IgnoreThermalStateAlert(onConfirm) {
  ...
  const items = [closure_3(onConfirm(4784).Text, obj2), ];
  ...
  items[1] = closure_3(onConfirm(4784).Text, obj3);
  obj.children = items;
