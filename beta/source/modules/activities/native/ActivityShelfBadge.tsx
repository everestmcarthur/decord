...
// Dependencies: [19, 17, 1074, 21, 4788, 576, 1177, 1978, 4784, 1115, 2]
// Exports: default

// Module 12368 (ActivityShelfBadge)
...
export default function ActivityShelfBadge(arg0) {
  ...
  if (labelType === Server.EmbeddedActivityLabelTypes.NEW) {
    ...
    obj.children = jsx(tmp2(4784).Text, { variant: "text-xs/semibold", style: tmp.badgeText, color: "text-overlay-light", children: null });
    ...
    if (labelType === tmp2(1978).EmbeddedActivityLabelTypes.UPDATED) {
      ...
      obj3.children = jsx(tmp2(4784).Text, { variant: "text-xs/semibold", style: tmp.badgeText, color: "text-overlay-light", children: null });
