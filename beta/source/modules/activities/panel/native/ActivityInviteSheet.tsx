...
// Dependencies: [32, 19, 17, 10189, 10128, 1074, 8010, 1085, 21, 4788, 576, 10124, 7439, 7459, 4755, 8480, 10117, 11758, 504, 10142, 7427, 7426, 1115, 1177, 10144, 7327, 17496, 2]
// Exports: default

// Module 17495 (ActivityInviteSheet)
...
import InviteSuggestionsActionCreators from "InviteSuggestionsActionCreators" /* 10142 */;
...
export default function ActivityInviteSheet(activity) {
  ...
  noop = undefined;
  const tmp = closure_16();
  analyticsLocations = analyticsLocations(7439)(analyticsLocations(7459).ACTIVITY_INVITE_SHEET).analyticsLocations;
  const tmp2 = analyticsLocations;
  const tmp4 = analyticsLocations(7439);
  ...
  obj3.header = closure_13(activity(7426).BottomSheetTitleHeader, obj4);
  if (null != tmp6) {
    const obj5 = { style: tmp.emptyState, Illustration: tmp11(10144).AppCrash, title: tmp6 };
    ...
    const obj8 = { size: "md", round: true, onChange: tmp11(10142).searchInviteSuggestions, placeholder: null };
    const intl2 = tmp11(1115).intl;
    obj8.placeholder = intl2.string(tmp11(1115).t.iI1gMg);
    obj7.children = tmp17(tmp11(7327).SearchField, obj8);
    ...
    if (tmp16) {
      ...
      tmp17Result2 = tmp17(tmp2(17496), obj10);
    }
  ...
  obj2.children = closure_13(activity(7427).BottomSheet, obj3);
  return closure_13(activity(7439).AnalyticsLocationProvider, obj2);
};
