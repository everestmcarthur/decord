...
// Dependencies: [19, 17, 1483, 21, 4788, 576, 12413, 1612, 11510, 12333, 7797, 5371, 1115, 5877, 4784, 1177, 12375, 12338, 12411, 12380, 12383, 12384, 12334, 9555, 2]
// Exports: default

// Module 12477 (AppLauncherViewAllScreen)
...
import AppLauncherBackButton from "AppLauncherBackButton" /* 12413 */;
...
let size = { width: fn(12413).BACK_BUTTON_SIZE, height: fn(12413).BACK_BUTTON_SIZE, alignItems: "center", justifyContent: "center" };
