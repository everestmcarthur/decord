...
// Dependencies: [19, 17, 21, 4788, 576, 12370, 1370, 4784, 1115, 5371, 12333, 9216, 9555, 12338, 2]
// Exports: default

// Module 12392 (InThisServerSection)
...
function AppInThisServer(onAppSelected) {
  ...
  const appLauncherIconSource = onAppSelected(12333).getAppLauncherIconSource(application);
  const obj2 = {
    accessible: true,
  ...
  if (null != appLauncherIconSource) {
    ...
    tmp6 = closure_5(application(12338), obj3);
  }
  const items = [tmp6, closure_5(onAppSelected(4784).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: application.name })];
  obj2.children = items;
  return closure_6(onAppSelected(9216).PressableScale, obj2, application.id);
}
...
export default function InThisServerSection(arg0) {
  ...
  if (0 === items.length) {
    ...
    if (tmp5Result) {
      ...
      obj4.children = tmp5(tmp11(4784).Text, obj5);
      tmp5Result = tmp5(tmp11(5371).PressableOpacity, obj4);
    }
    items2[1] = tmp5Result;
