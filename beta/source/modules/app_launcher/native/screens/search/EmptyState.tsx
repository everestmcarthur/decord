...
// Dependencies: [19, 17, 21, 4788, 12333, 9555, 1115, 4499, 4784, 2]
// Exports: default

// Module 12391 (search/EmptyState)
...
export default function EmptyState(showsGenericMessage) {
  ...
  const tmp = closure_5();
  const logAppLauncherEmptyStateView = flag(12333).useLogAppLauncherEmptyStateView(flag(9555).AppLauncherEmptyStateType.SEARCH_EMPTY, showsGenericMessage.query);
  const items = [flag];
  ...
  obj3.children = jsx(flag(4784).Text, { style: tmp.text, variant: "text-sm/medium", color: "text-default", children: null });
