...
// Dependencies: [19, 21, 4788, 576, 4524, 5217, 5221, 2]
// Exports: usePinnedSearchBarBottomBorder

// Module 12379 (SearchBarBottomBorder)
...
export const usePinnedSearchBarBottomBorder = function usePinnedSearchBarBottomBorder(arg0) {
  ...
  let tmp = closure_5();
  const sharedValue = triggerScrollHeight(4524).useSharedValue(0);
  ...
  let obj = triggerScrollHeight(4524);
  const fn = function u() {
    let num = 0;
  ...
  const obj2 = triggerScrollHeight(4524);
  fn.__closure = { withSpring: triggerScrollHeight(5217).withSpring, scrollPosition: sharedValue, triggerScrollHeight, springStandard: triggerScrollHeight(5221).springStandard };
  ...
  obj5.style = items2;
  obj4.bottomBorderComponent = jsx(sharedValue(4524).View, { style: null }, key);
  return obj4;
};
