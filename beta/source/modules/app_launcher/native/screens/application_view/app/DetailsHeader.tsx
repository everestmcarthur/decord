...
// Function ID: 9435
// Name: DetailsHeader
// Dependencies: [32, 19, 17, 21, 4788, 576, 4524, 9435, 9565, 5374, 8575, 5835, 4784, 1115, 4789, 4792, 5913, 5230, 1094, 2]

// Module 9434 (DetailsHeader)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4524 */;
import timing from "timing" /* 4789 */;
import timingPresets from "timingPresets" /* 4792 */;
import BioMarkupUtils from "BioMarkupUtils" /* 9565 */;
...
export default noop.memo(function DetailsHeader(viewContainerStyle) {
  ...
  const isPartnerApplicationResult = sharedValue(9435).isPartnerApplication(application);
  sharedValue = sharedValue(4524).useSharedValue(null);
  let obj3 = sharedValue(4524);
  let fn = function t() {
  ...
  const obj4 = sharedValue(4524);
  const sectionName = sharedValue(9435).getSectionName(application);
  const obj5 = sharedValue(9435);
  const str = sharedValue(9435).getSectionDescription(application);
  ...
  isScreenLandscape = sharedValue(5374).useIsScreenLandscape();
  const tmp24 = first(8575)(isScreenLandscape);
  closure_18 = tmp24;
  ...
  let tmp27 = first;
  const tmp2Result = sharedValue(5374);
  if (first) {
    tmp27 = !first1;
  }
  ...
  if (!hideName) {
    ...
    tmp30Result = tmp30(tmp2(4784).Heading, obj10);
  }
  ...
  if (isPartnerApplicationResult) {
    ...
    obj11.children = tmp30(tmp2(4784).Text, obj12);
  ...
  if (tmp28Result5) {
    ...
    if (tmp27) {
      ...
      items8[1] = tmp30(tmp23(5230), obj19);
      if (num2 == null) {
        num2 = 0;
      }
    ...
    obj22.children = tmp30(tmp2(4784).Text, obj23);
    const items10 = [tmp30(tmp23(5913), obj22), , ];
    ...
    if (tmp27) {
      ...
      obj24.children = tmp28(tmp2(4784).Text, obj25);
  ...
  if (!first2) {
    ...
    if (!hideName) {
      ...
      tmp30Result9 = tmp30(tmp2(4784).Heading, obj28);
    }
    ...
    if (tmp28Result5) {
      ...
      const items15 = [tmp30(tmp2(4784).Text, obj30), ];
      ...
      items15[1] = tmp30(tmp2(4784).Text, obj31);
