...
// Dependencies: [32, 19, 21, 4788, 576, 1875, 4755, 12447, 1980, 12451, 8903, 4784, 2]
// Exports: default

// Module 12446 (AppLauncherChoicesOption)
...
export default function AppLauncherChoicesOption(option) {
  ...
  const callback = onDismissChoicesSheet.useCallback(() => {
    ...
    obj2.openLazy(asyncRequireImpl(12447, dependencyMap.paths), "AppLauncherChoicesActionSheet", obj3);
  }, items);
  let tmp = closure_6();
