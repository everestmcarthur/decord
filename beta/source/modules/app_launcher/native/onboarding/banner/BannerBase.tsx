...
// Function ID: 12344
// Name: BannerBase
// Dependencies: [32, 19, 17, 4780, 21, 576, 4788, 12332, 4524, 1478, 4637, 504, 5217, 5230, 5778, 12344, 4784, 2]
// Exports: default

// Module 12343 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj10.source = require("module_12344");
  obj10.autoPlay = !stateFromStores;
  const items5 = [closure_7(sharedValue(5778), obj10), image];
  ...
  return closure_8(sharedValue(4524).View, obj7);
};
