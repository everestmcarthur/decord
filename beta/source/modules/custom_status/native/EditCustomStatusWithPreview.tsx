...
// Dependencies: [32, 19, 17, 1372, 11411, 1074, 1375, 21, 4788, 576, 5371, 1115, 1177, 7215, 11412, 1241, 9662, 504, 11413, 11414, 4639, 11416, 5212, 11417, 7258, 11442, 11216, 4654, 11444, 8139, 5873, 4784, 11185, 8911, 5936, 5854, 4755, 11496, 1980, 11498, 4745, 1365, 1626, 4991, 7277, 2]
// Exports: default

// Module 11410 (EditCustomStatusWithPreview)
...
import CustomStatusPreviewDefault from "CustomStatusPreview" /* 11444 */;
...
function ClearInputButton(onPress) {
  ...
  obj.children = map1(native.Icon, { source: _modDef7215, style: closure_15().closeIcon, size: native.Icon.Sizes.SMALL });
...
function EditCustomStatusWithPreview(navigation) {
  ...
  const callback1 = obj.useCallback(() => {
    ...
    const timerId = setTimeout(() => {
      const AccessibilityAnnouncer = navigation(4639).AccessibilityAnnouncer;
  ...
  if (null == stateFromStores) {
    ...
    obj18.onPress = function onPress() {
      ...
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11496, dependencyMap.paths), "ClearAfterOptionsActionSheet", { initialValue: first2, onChange });
    };
...
const STATUS_MAX_LENGTH = fn(11411).STATUS_MAX_LENGTH;
...
export default function EditCustomStatusWithPreviewModal(analyticsLocations) {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj2.headerTitle = function headerTitle() {
      ...
      return closure_1_13(analyticsLocations(8139).GenericHeaderTitle, obj);
    };
  ...
  return tmp2(analyticsLocations(7277).Navigator, obj);
};
