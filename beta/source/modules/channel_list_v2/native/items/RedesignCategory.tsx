...
// Dependencies: [19, 17, 7805, 7394, 4969, 10413, 21, 4788, 1364, 576, 4784, 13035, 5371, 11449, 11838, 11206, 504, 4941, 11270, 16449, 16450, 7390, 1115, 7472, 11839, 6890, 2]
// Exports: CategoryChannel, RecentlyActiveCategory, SuggestedCategory, useCategoryPressEvents

// Module 16448 (RedesignCategory)
...
import useFavoritesGuildCategoryAddActionDefault from "useFavoritesGuildCategoryAddAction" /* 11270 */;
import CategoryCollapseActionCreators from "CategoryCollapseActionCreators" /* 11838 */;
import useFavoritesGuildCategoryFullNoticeDefault from "useFavoritesGuildCategoryFullNotice" /* 16449 */;
import useFavoritesGuildCategoryLongPressDefault from "useFavoritesGuildCategoryLongPress" /* 16450 */;
...
function renderCategoryItem(muted) {
  ...
  if (typeof name === "string") {
    ...
    tmp34Result = closure_11(trailingAction(4784).Text, obj2);
  }
  let tmp3 = null;
  if (null != icon) {
  ...
  if (Icon == null) {
    Icon = trailingAction(13035).PlusMediumIcon;
  }
  if (null == trailingAction) {
    ...
    if (null == note) {
      ...
      if (tmp) {
        ...
        let tmp28Result = tmp28(trailingAction(5371).PressableHighlight, obj7);
      } else {
    ...
    obj10 = tmp9(trailingAction(5371).PressableOpacity, obj10);
    obj9.children = obj10;
...
export const CategoryChannel = function CategoryChannel(channel) {
  ...
  if (null != tmp10) {
    ...
    tmp13 = closure_11(tmp2(4784).Text, obj4);
  }
  obj2.note = tmp13;
  ...
  obj7.icon = closure_11(channel(11449).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed2 ? obj3 : obj4 });
...
export const RecentlyActiveCategory = function RecentlyActiveCategory(guildId) {
  ...
  obj3 = {};
  const merged1 = Object.assign(merged);
  obj3.icon = closure_11(tmp2(11449).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed ? obj3 : obj4 });
