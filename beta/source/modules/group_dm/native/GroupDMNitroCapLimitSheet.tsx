...
// Dependencies: [19, 17, 4780, 11873, 1074, 21, 4788, 576, 504, 11871, 1241, 4755, 11877, 10263, 11878, 7427, 4784, 1115, 5218, 8972, 2]
// Exports: default

// Module 11876 (GroupDMNitroCapLimitSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4755 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 10263 */;
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11877 */;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  const groupDMNitroAudience = _location(11871).useGroupDMNitroAudience();
  importDefault = tmp6;
  ...
  let obj2 = _location(11871);
  let obj3 = noop;
  obj4.acquisitionStrategy = _location(11871).GroupDMNitroAcquisitionStrategy.CHECKOUT;
  ...
  const items3 = [closure_11(_location(4784).Text, obj6), , ];
  ...
  items3[1] = closure_11(_location(4784).Text, obj8);
  ...
  obj11.text = intl3.string(_location(11871).getGroupDMNitroCapCTAMessage(groupDMNitroAudience));
  const tmp2Result = _location(11871);
  obj11.icon = closure_11(_location(8972).NitroWheelIcon, { style: tmp.nitroWheelIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: "custom" });
  ...
  obj11.onPress = tmp16;
  const items4 = [closure_11(_location(5218).Button, obj11), ];
  ...
  items4[1] = closure_11(_location(5218).Button, obj14);
  obj10.children = items4;
  items3[2] = closure_12(View, obj10);
  obj5.children = items3;
  obj13.children = closure_12(View, obj5);
  return closure_11(_location(7427).BottomSheet, obj13);
};
