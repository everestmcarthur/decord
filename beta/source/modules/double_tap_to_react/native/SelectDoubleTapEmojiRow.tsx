...
// Dependencies: [19, 17, 4780, 7428, 1375, 21, 4788, 1364, 576, 504, 5371, 7407, 1397, 10582, 1478, 4445, 8258, 11417, 8037, 9069, 2]

// Module 12665 (SelectDoubleTapEmojiRow)
...
let closure_13 = noop.memo((emoji) => {
  ...
  return closure_9(emoji(5371).PressableOpacity, obj2);
});
