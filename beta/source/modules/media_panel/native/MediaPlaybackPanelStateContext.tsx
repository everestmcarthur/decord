...
// Dependencies: [19, 14848, 12556, 7351, 2]

// Module 17691 (MediaPlaybackPanelStateContext)
...
obj.mode = ReanimatedHelperTypes.createFakeSharedValue(fn(14848).MediaPlaybackPanelModes.PIP);
...
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12556).MorphablePanelModes.PIP);
ReanimatedHelperTypes = fn(7351);
