...
// Dependencies: [5, 32, 19, 17, 2046, 5663, 1074, 2047, 21, 4788, 576, 504, 5671, 5235, 1241, 1875, 8701, 4755, 4688, 8710, 4784, 1115, 7427, 7400, 6880, 8713, 5218, 2]
// Exports: default

// Module 8700 (StartStageChannelActionSheet)
...
export default function StartStageChannelEventActionSheet(channel) {
      ...
      try {
        ...
        if (0 === c4) {
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp33(8701).editStage(channel, tmp53, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp33(8701);
                c4 = 2;
                c5 = 1;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp45;
            const aPIError = new channel(4688).APIError(closure_128_1);
            ...
            tmp3(4755).hideActionSheet(closure_1_10);
            dependencyMap = 0;
            const obj2 = tmp3(4755);
          }
          dependencyMap = 0;
          c5 = 3;
  ...
  const shouldAgeVerifyToSpeakForCurrentUser = channel(5671).useShouldAgeVerifyToSpeakForCurrentUser(channel.id);
  ...
  const items1 = [closure_13(stateFromStores(8710), {}), , ];
  ...
  items1[1] = closure_13(channel(4784).Text, obj5);
  ...
  items1[2] = closure_13(channel(4784).Text, obj6);
  obj4.children = items1;
  let stringResult2;
  const tmp11 = stateFromStores;
  const tmp2Result = channel(5671);
  if (null == stateFromStores) {
  ...
  items2[1] = closure_13(channel(6880).TextInput, obj8);
  items2[2] = closure_13(tmp11(8713), {
    onConfirmPress() {
  ...
  if (null != obj3) {
    ...
    tmp15Result = tmp15(tmp2(4784).Text, obj10);
  }
  ...
  obj11.children = closure_13(channel(5218).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(4784).Text, obj13);
  }
  ...
  return closure_13(channel(7427).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7400).SafeAreaPaddingView, obj7) });
};
