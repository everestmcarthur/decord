...
// Dependencies: [19, 17, 21, 4788, 576, 4524, 4789, 4784, 1177, 7435, 2]
// Exports: default

// Module 10349 (StageSectionHeader)
...
export default function StageSectionHeader(collapsed) {
  ...
  let obj = collapsed(4524);
  const tmp2 = collapsed;
  fn.__closure = { withTiming: collapsed(4789).withTiming, collapsed };
  ...
  obj5.children = items;
  const items1 = [closure_5(collapsed(4784).Text, obj5), , ];
  ...
  let obj2 = { withTiming: collapsed(4789).withTiming, collapsed };
  const tmp7 = closure_5;
  const tmp8 = closure_3;
  obj8.children = closure_6(tmp2(1177).Icon, { source: _modDef7435, style: tmp.collapseIcon });
