...
// Dependencies: [5, 32, 19, 17, 4479, 2046, 1074, 21, 1115, 4788, 576, 4941, 504, 5235, 9589, 8930, 9796, 5671, 8714, 8716, 8701, 8697, 1177, 4784, 5219, 5218, 9798, 9704, 4722, 4496, 9682, 5271, 2]
// Exports: default

// Module 9807 (GlobalStageChannelStatus)
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null != id) {
                if (obj9.shouldAgeVerifyToSpeakForCurrentUser(id.id)) {
                  const obj5 = { entryPoint: tmp41(8716).AgeVerificationModalEntryPoint.STAGE_CHANNEL_RAISE_HAND };
                  const result = tmp3(8714).showAgeVerificationGetStartedModal(obj5);
                  const obj4 = tmp3(8714);
                } else {
                  dependencyMap(true);
                  dependencyMap = 1;
                  c4 = 2;
                  c5 = 1;
                  const obj6 = { value: tmp41(8701).audienceAckRequestToSpeak(id, false), done: false };
                  return obj6;
                }
                obj9 = channel(5671);
              }
            ...
            closure_129_3(false);
            if (null == key.getKey()) {
              tmp27(8697).openStageChannel(closure_129_0);
              const obj8 = tmp27(8697);
            }
          }
          dependencyMap = 0;
          c5 = 3;
...
export default function GlobalStageChannelStatus(arg0) {
  ...
  let invitedHeaderText = tmp3(9704)(id);
    ...
    if (null != channel) {
      if (null != guild) {
        ...
        if (tmp7) {
          ...
          const items2 = [closure_10(tmp3(9682), obj4), , ];
          const obj5 = { style: activeSpeakerIcon, size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp8(5271).getChannelIconWithGuild(channel, guild) };
