...
// Dependencies: [19, 17, 5663, 1074, 21, 4788, 576, 4755, 9936, 8901, 1177, 1115, 4784, 5218, 8701, 2]
// Exports: default

// Module 13247 (EndStageActionSheet)
...
let closure_4 = fn(5663).EXPLICIT_END_STAGE_SHEET_KEY;
const jsxProd = fn(21);
...
export default function EndStageActionSheet(channel) {
  ...
  items[1] = closure_5(channel(4784).Text, obj4);
  ...
  obj5.children = closure_5(channel(5218).Button, obj6);
  ...
  obj7.children = closure_5(channel(5218).Button, obj8);
