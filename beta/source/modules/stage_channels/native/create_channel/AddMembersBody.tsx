...
// Function ID: 9885
// Name: AddMembersBody
// Dependencies: [109, 32, 19, 17, 2105, 2099, 1372, 8704, 1085, 21, 4788, 576, 4432, 7258, 504, 4775, 9855, 1177, 1115, 9871, 4499, 6901, 9875, 5768, 4784, 9880, 2]
// Exports: default

// Module 9884 (AddMembersBody)
...
export default function AddMembersBody(pendingAdditions) {
  ...
  if (first) {
    ...
    if (tmp19) {
      items2 = tmp10(9855).getNoRolesRow();
      const tmp10Result3 = tmp10(9855);
    }
  }
  let obj5 = guild(504);
  ...
  if (inActionSheet) {
    let BottomSheetScrollView = tmp6(6901).BottomSheetScrollView;
  } else {
    BottomSheetScrollView = c8;
  }
  if (inActionSheet) {
    let BottomSheetSectionList = tmp6(6901).BottomSheetSectionList;
  } else {
  ...
  obj9.children = closure_16(pendingAdditions(9875), obj10);
  ...
  if (null != inputDesc) {
    ...
    obj11.children = tmp27(tmp6(4784).Text, obj12);
  ...
  if ("" !== str) {
    if (0 === items2.length) {
      if (0 === membersRows.length) {
        ...
        const obj16 = { Illustration: tmp6(9880).NoResultsAlt, style: null, bodyStyle: null, body: null };
  ...
  const tmp4Result = pendingAdditions(9875);
  obj19.contentContainerStyle = { paddingHorizontal: pendingAdditions(576).space.PX_16, paddingBottom: pendingAdditions(576).space.PX_16 + pendingAdditions(7258)(obj).insets.bottom };
