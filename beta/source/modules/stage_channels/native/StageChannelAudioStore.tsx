...
// Dependencies: [17, 9937, 2041, 4811, 17590, 9938, 504, 573, 2]

// Module 17589 (StageChannelAudioStore)
import _mod17 from "module_17" /* 17 */;
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import VoiceCallTypes from "VoiceCallTypes" /* 9938 */;
import DefaultAudioRouteExperimentDefault from "DefaultAudioRouteExperiment" /* 17590 */;
...
function handleAudioRouteChanged() {
  if (c8) {
    ...
    if (flag2) {
      if (currentRouteType !== tmp3(9938).RouteTypes.SPEAKER) {
        if (currentRouteType !== tmp3(9938).RouteTypes.BLUETOOTH) {
          if (currentRouteType !== tmp3(9938).RouteTypes.WIRED) {
