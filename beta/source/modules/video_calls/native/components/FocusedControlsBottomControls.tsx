...
// Dependencies: [32, 19, 17, 9672, 9673, 1074, 21, 1364, 4788, 576, 5773, 1177, 1612, 4524, 9809, 1094, 1115, 7431, 4789, 6929, 9811, 1478, 9699, 1110, 4498, 5206, 4639, 9812, 2]
// Exports: default

// Module 9808 (FocusedControlsBottomControls)
...
import CallPTTButton from "CallPTTButton" /* 9812 */;
...
function FocusedControlsBottomDrawerTooltip(positionY) {
  ...
  const tmp = closure_18();
  const canShowTooltip = positionY(9809).useCanShowTooltip(positionY(1094).TooltipNames.SCREENSHARE_SWIPE_UP_CONTROLS, true);
  positionY(4524);
  const fn = function o() {
...
function FocusedControlsAboveActionBarView(positionY) {
  ...
  const animatedStyle = positionY(4524).useAnimatedStyle(fn);
  const items = [closure_13(FocusedControlsBottomDrawerTooltip, { positionY }), closure_13(positionY(7431).ActionSheetHeaderBar, {}), ];
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(offsetY(4524).View, obj5);
  }
  items[2] = tmp4Result;
  obj4.children = items;
