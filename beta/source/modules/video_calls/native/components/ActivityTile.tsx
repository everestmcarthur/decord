...
// Function ID: 9752
// Name: ActivityTile
// Dependencies: [5, 32, 19, 17, 2040, 1372, 1074, 1181, 2004, 21, 1177, 4788, 576, 504, 1370, 7445, 4940, 4632, 9752, 7439, 7459, 9738, 1115, 9668, 9669, 9754, 9667, 5371, 9755, 9771, 4784, 5219, 4498, 2]
// Exports: default

// Module 9751 (ActivityTile)
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            if (tmp12) {
              ...
              v1 = 1;
              dependencyMap = 1;
              const obj5 = { value: v1(9669)(obj4), done: false };
              return obj5;
            } else {
              dependencyMap = 3;
            }
          ...
          const result = tmp2(9754).setOrientationLockState(closure_128_3);
          const obj = tmp2(9754);
        }
        dependencyMap = 3;
