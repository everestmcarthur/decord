...
// Function ID: 9724
// Name: VideoRenderer
// Dependencies: [32, 19, 17, 21, 4788, 9724, 9725, 9727, 1478, 1364, 8635, 9732, 9733, 9735, 4524, 2]

// Module 9723 (VideoRenderer)
...
export default noop.memo((gestureEnabled) => {
  ...
  let onReady;
  const tmp2 = onReady();
  const surfaceDirectRendererExperiment = resizeMode(9724).useSurfaceDirectRendererExperiment(userId, { location: "VideoRenderer" });
  ...
  closure_8 = tmp15;
  const obj = resizeMode(9724);
  [tmp17, c9] = first1(noop.useState(true), 2);
  width(9725)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = width(9727)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  noop.useRef(null);
  ...
  const store = resizeMode(8635).useStore((orientation) => orientation.orientation);
  ...
  if (tmp17) {
    ...
    tmp35 = closure_8(tmp18(9732), obj3);
  }
  const tmp37 = store === resizeMode(8635).OrientationType.PORTRAIT;
  const obj2 = resizeMode(8635);
  if (tmp3Result.isAndroid()) {
    ...
    const items11 = [closure_8(tmp18(9735), obj7), tmp35];
    obj6.children = items11;
    obj5.children = c9(first2, obj6);
    const items12 = [closure_8(tmp18(9733), obj5), ];
    ...
    obj12.children = closure_8(tmp18(9735), obj13);
    const items13 = [closure_8(tmp18(4524).View, obj12), ];
    let tmp48 = null;
    if (tmp37) {
    ...
    const items17 = [closure_8(tmp18(9735), obj16), tmp35];
