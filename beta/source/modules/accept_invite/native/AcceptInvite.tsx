...
// Function ID: 13000
// Name: AcceptInvite
// Dependencies: [32, 19, 17, 1074, 21, 4788, 576, 1370, 4489, 5830, 13000, 13003, 1397, 1431, 13008, 1478, 5856, 2]
// Exports: default

// Module 12999 (AcceptInvite)
...
function AcceptInviteCardComponent(invite) {
  ...
  if (null == invite) {
    ...
    obj2.invite = invite;
    return closure_9(first(13000), obj2);
  } else if (tmp22.ERROR === first) {
    let obj = {};
    const merged1 = Object.assign(invite);
    obj.invite = invite;
    return closure_9(first(13003), obj);
  } else {
    return closure_9(InviteResolving, {});
  }
}
...
export default function AcceptInvite(invite) {
  ...
  if (null == splash) {
    let guildSplashSource = tmp3(13008);
  } else {
