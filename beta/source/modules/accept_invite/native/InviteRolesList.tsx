...
// Dependencies: [19, 17, 21, 4788, 2103, 5216, 4784, 1115, 11241, 2]
// Exports: default

// Module 13002 (InviteRolesList)
...
export default function InviteRolesList(invite) {
  ...
  if (null != guild) {
    ...
    if (0 !== memo.length) {
      ...
      const items1 = [closure_5(guild(4784).Text, obj2), ];
      ...
      obj.children = items1;
      tmp2 = closure_6(guild(5216).Stack, obj);
    }
  }
  return tmp2;
};
