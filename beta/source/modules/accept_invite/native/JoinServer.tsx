...
// Function ID: 7255
// Name: JoinServer
// Dependencies: [19, 17, 7255, 21, 4788, 576, 7256, 4784, 1115, 7258, 1484, 1478, 6879, 5218, 2]
// Exports: default

// Module 7254 (JoinServer)
...
export default function JoinServer(arg0) {
  ...
  if (useWindowDimensionsDefault().height > closure_6) {
    ...
    const items2 = [closure_8(tmp4(4784).Text, obj5), ];
    ...
    items2[1] = closure_8(tmp4(4784).Text, obj6);
  ...
  items3[2] = closure_8(navigation(4784).Text, obj9);
  ...
  items5[1] = closure_8(navigation(5218).Button, obj13);
  ...
  items5[3] = closure_8(navigation(5218).Button, obj14);
