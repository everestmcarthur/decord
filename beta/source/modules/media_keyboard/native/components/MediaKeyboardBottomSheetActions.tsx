...
// Dependencies: [19, 17, 21, 4788, 576, 1364, 4606, 672, 1612, 4489, 5230, 5371, 4784, 2]

// Module 10938 (MediaKeyboardBottomSheetActions)
...
export default noop.memo(function MediaKeyboardBottomSheetActions(onHeightChange) {
  ...
  noop = undefined;
  let variant;
  const gradientValue = onHeightChange(4606).useGradientValue(onHeightChange(4606).GradientPercentage.END);
  let hexResult = null;
  ...
  let obj = onHeightChange(4606);
  const tmp6 = closure_8(useSafeAreaInsetsDefault().bottom, onHeightChange(4489).useToken(nativeDefault.colors.MOBILE_FLOATINGBAR_BACKGROUND_HIGHER), hexResult);
  importDefault = tmp6;
  const tmpResult = onHeightChange(4489);
  dependencyMap = onHeightChange(4489).useToken(nativeDefault.modules.mobile.MEDIA_KEYBOARD_BUTTON_ICON_COLOR_ACTIVE);
  const tmpResult4 = onHeightChange(4489);
  noop = onHeightChange(4489).useToken(nativeDefault.modules.mobile.MEDIA_KEYBOARD_BUTTON_TEXT_COLOR_ACTIVE);
  const tmpResult5 = onHeightChange(4489);
  variant = onHeightChange(4489).useToken(nativeDefault.modules.mobile.MEDIA_KEYBOARD_BUTTON_TEXT_VARIANT);
  ...
  const tmpResult6 = onHeightChange(4489);
