...
// Dependencies: [19, 17, 1182, 502, 5527, 2041, 2105, 1992, 4828, 1074, 21, 4788, 576, 9650, 504, 4639, 14085, 14086, 1177, 14087, 14088, 14089, 14090, 9745, 4784, 1115, 8903, 8012, 10354, 4645, 4995, 4755, 5371, 10034, 4940, 10026, 4632, 2]

// Module 14084 (VoiceMemberUser)
...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    obj2.subLabel = closure_11(tmp3(8903).FormSubLabel, obj3);
    ...
    if (tmp10Result) {
      ...
      obj4.children = tmp10(channel(10354), obj5);
      tmp10Result = tmp10(closure_3, obj4);
      const tmp20 = channel(10354);
    }
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      closure_11(channelId(5371).PressableOpacity, obj);
    }
  }
  return tmp3;
}
...
let closure_16 = noop.memo((user) => {
  ...
  const tmp7 = channel(9650)({ userId: user.id });
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14090), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14087), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14088), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14089), style: tmp19 };
          }
          tmp20(tmp8(1177).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = tmp5(14085);
        } else {
          tmp5Result = tmp5(14086);
        }
  ...
  if (stateFromStores1) {
    ...
    items4[1] = closure_12(tmp8(4784).Text, obj17);
  ...
  obj15.label = closure_11(user(8903).FormRow.Label, obj18);
  if (localVideoAutoDisabled) {
    const obj19 = { style: tmp2.autoDisabledVideo, children: null };
    const obj20 = { source: tmp5(9745), size: tmp8(1177).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    ...
    items6[1] = tmp20(tmp8(4784).Text, obj21);
  ...
  return closure_11(user(8903).FormRow, obj15);
});
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  const obj = id(504);
  const name = id2(4940).getName(id2.guild_id, id2.id, id);
  const obj2 = id2(4940);
  const obj4 = {
    onPress() {
  ...
  const canRing = id(10026).useCanRing(id, "DisconnectedUserRow");
  ...
  obj4.label = closure_11(id(8903).FormRow.Label, obj5);
  const obj3 = id(10026);
  ...
  if (!canRing) {
    ...
    return tmp7(tmp2(8903).FormRow, obj7);
  } else {
