...
// Function ID: 12732
// Name: ChatInputGuard
// Dependencies: [19, 17, 9686, 21, 4788, 576, 670, 8149, 12543, 12542, 5373, 1364, 12549, 5854, 8211, 11228, 11223, 4784, 5218, 5682, 9216, 2]
// Exports: ChatInputGuardContainer, default

// Module 12731 (ChatInputGuard)
...
import getChatInputPositionStyleDefault from "getChatInputPositionStyle" /* 12542 */;
import noop from "module_19" /* 19 */;

require = fn;
get_ActivityIndicator = fn(17);
({ StyleSheet: closure_4, View: hasOwnProperty } = get_ActivityIndicator);
let closure_6 = fn(9686).updateChatInputContainerHeight;
const jsxProd = fn(21);
...
export default function ChatInputGuard(type) {
  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(11228).ArrowSmallRightIcon, obj5);
        }
        obj4.icon = actionIcon;
        obj4.onPress = actionOnPress;
        let tmp7Result = tmp7(tmp9(8211).IconButton, obj4);
      }
      obj3.trailing = tmp7Result;
      const obj6 = { variant: "text-sm/semibold", children: message };
      obj3.label = tmp7(tmp9(4784).Text, obj6);
    ...
    if (null != countdown) {
      ...
      tmp7Result = tmp7(tmp(11223), obj7);
    }
    tmp8 = hasOwnProperty;
  } else {
    ...
    if (null != subtext2) {
      ...
      if (typeof subtext2 === "string") {
        ...
        if (subtext2.length > 0) {
          ...
          tmp13Result = tmp13(tmp14(4784).Text, obj);
        }
      }
    }
    ...
    if (null != buttonSecondaryText) {
      ...
      if (null != buttonSecondaryOnPress) {
        ...
        items2[1] = tmp13(tmp14(5218).Button, obj12);
        obj11.children = items2;
        tmp16Result = tmp16(tmp14(9216).TwinButtons, obj11);
      }
    }
    ...
    if (null != countdown2) {
      ...
      tmp13Result2 = tmp13(tmp(11223), obj14);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  const chatInputFloatingOverlayStyle = screenIndex(12543).useChatInputFloatingOverlayStyle();
  ...
  const items2 = [closure_7(screenIndex(12543).ChatInputScrimGradient, {}), ];
  ...
  if (tmp3) {
    tmp10Result3 = tmp10(tmp(5373), { absolute: true, wide: true, tall: true, mix: true });
  }
  const items4 = [tmp10Result3, children];
  obj5.children = items4;
  items3[1] = closure_8(closure_5, obj5);
  const obj = screenIndex(12543);
  let tmp10Result4 = null;
  if (tmp4Result.isIOS()) {
    tmp10Result4 = null;
    if (null != channelId) {
      const obj6 = { channelId, screenIndex, onJumpToPresent };
      tmp10Result4 = tmp10(tmp(12549), obj6);
    }
  }
