...
// Dependencies: [5, 19, 1372, 21, 1484, 12723, 504, 12725, 4486, 1115, 5846, 4799, 12731, 2]

// Module 12722 (ChatInputGuardMessageRequest)
...
export default noop.memo(function ChatInputGuardMessageRequest(channel) {
  ...
  const isMessageRequestRestrictedViewer = channel(12723).useIsMessageRequestRestrictedViewer("ChatInputGuardMessageRequest");
  let obj2 = channel(12723);
