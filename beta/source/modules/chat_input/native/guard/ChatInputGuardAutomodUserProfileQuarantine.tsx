...
// Dependencies: [19, 502, 2105, 4414, 21, 504, 4433, 12145, 1115, 12731, 12748, 2]

// Module 12747 (ChatInputGuardAutomodUserProfileQuarantine)
import AutomodPermissionUtils from "AutomodPermissionUtils" /* 4433 */;
import GuildAutomodActionActionCreators from "GuildAutomodActionActionCreators" /* 12145 */;
...
export default noop.memo(function ChatInputGuardAutomodUserProfileQuarantine(guildId) {
  ...
  const automodReason = guildId(4433).getAutomodReason(stateFromStores);
  ...
  const obj2 = guildId(4433);
  tmp6 = GuildMemberFlags;
  obj3.icon = jsx(guildId(12748).ChatXIcon, {});
