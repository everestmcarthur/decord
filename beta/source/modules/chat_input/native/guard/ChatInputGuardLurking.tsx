...
// Dependencies: [19, 4428, 2041, 12244, 1074, 21, 504, 1101, 4968, 11617, 10125, 1186, 7615, 5769, 12731, 1115, 2]

// Module 12738 (ChatInputGuardLurking)
...
import showChannelFollowingActionSheet from "showChannelFollowingActionSheet" /* 11617 */;
...
export default noop.memo(function ChatInputGuardLurking(channel) {
  ...
  if (type === constants2.DIRECTORY_ENTRY) {
    ...
    let tmp15Result = jsx(guildId(12731), { type: "button-action", message: null, buttonSecondaryText: null, buttonSecondaryOnPress: null, buttonPrimaryText: null, buttonPrimaryOnPress: null });
    const tmp14 = guildId(12731);
  } else {
    ...
    tmp15Result = jsx(guildId(12731), obj4);
    const tmp17 = guildId(12731);
  }
  return tmp15Result;
});
