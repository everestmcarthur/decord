...
// Dependencies: [19, 17, 12244, 21, 4498, 4524, 4789, 12529, 2]
// Exports: default, interactivityProps

// Module 12528 (ChatInputActionButtonTransitionItem)
...
function FadeTransitionItem(state) {
  ...
  const effect = noop.useEffect(() => {
    if (state === native.TransitionStates.YEETED) {
      ...
      let obj = { runOnJS: tmp(4524).runOnJS, cleanup };
      fn.__closure = obj;
      ...
      const result1 = sharedValue.set(tmp(4789).withTiming(1, CHAT_INPUT_TIMING_CONFIG, "respect-motion-settings"));
...
const CHAT_INPUT_TIMING_CONFIG = fn(12244).CHAT_INPUT_TIMING_CONFIG;
const jsx = fn(21).jsx;
