...
// Dependencies: [19, 17, 21, 10617, 1364, 2]
// Exports: useModalDismissGuardRefreshControl

// Module 10616 (useModalDismissGuardRefreshControl)
...
export const useModalDismissGuardRefreshControl = function useModalDismissGuardRefreshControl() {
  isPortalKeyboardInModal = isPortalKeyboardInModal(10617).useIsPortalKeyboardInModal();
