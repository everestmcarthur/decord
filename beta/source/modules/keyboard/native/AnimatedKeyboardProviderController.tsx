...
// Dependencies: [19, 21, 4524, 1626, 2]

// Module 14885 (AnimatedKeyboardProviderController)
...
const mutable1 = ReanimatedRexport.makeMutable(fn(4524).KeyboardState.UNKNOWN);
