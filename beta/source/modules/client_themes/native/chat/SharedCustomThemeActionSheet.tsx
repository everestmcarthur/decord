...
// Dependencies: [32, 19, 17, 4452, 1074, 1374, 21, 4788, 576, 1241, 12230, 4636, 7427, 7426, 1115, 2712, 4784, 9504, 5218, 504, 4446, 7696, 7459, 1177, 1228, 2]
// Exports: default

// Module 12229 (SharedCustomThemeActionSheet)
...
function PrimaryActionButton(onPressApply) {
  ...
  if (obj2.getPremiumTypeFromSubscription(stateFromStores) !== PremiumTypes.TIER_2) {
    ...
    tmp6 = closure_12(tmp2(5218).Button, obj4);
  }
  return tmp6;
}
const noop = fn(19);
...
export default function _default(message) {
  ...
  obj6.title = intl.string(require("module_2712")["3ej1LT"]);
  ...
  obj8.children = intl2.string(require("module_2712").qZMUoL);
