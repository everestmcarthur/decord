...
// Dependencies: [32, 19, 21, 4788, 576, 1484, 5873, 8903, 1115, 1177, 5218, 6870, 4486, 10948, 4747, 2]
// Exports: default

// Module 14979 (WebAuthnEditStep)
...
export default function EditCredentialModal(credential) {
  ...
  const items1 = [closure_5(credential(8903).FormInput, obj3), closure_5(credential(8903).FormDivider, {}), ];
  const obj4 = {
    onPress() {
      _undefined(true);
      closure_4(null);
  ...
  items1[2] = closure_5(credential(5218).Button, obj4);
  obj2.children = items1;
  return closure_6(credential(8903).Form, obj2);
};
