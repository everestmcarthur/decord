...
// Dependencies: [32, 19, 17, 14964, 1074, 2038, 21, 4788, 576, 1484, 1115, 14969, 14970, 5873, 2108, 7400, 14973, 4784, 1364, 5218, 7224, 2]
// Exports: default

// Module 14968 (PasskeyUpsellView)
...
import PasskeyUpsellManagerDefault from "PasskeyUpsellManager" /* 14969 */;
...
export default function PasskeyUpsellView() {
  ...
  const items1 = [closure_11(closure_6, { source: _modDef14973, style: tmp4.headerImage }), , ];
  ...
  items1[1] = closure_11(navigation(4784).Text, obj7);
  const obj8 = { variant: "heading-md/normal", color: "text-default", style: tmp4.headerText, children: null };
  const obj6 = { source: _modDef14973, style: tmp4.headerImage };
  ...
  items1[2] = closure_11(navigation(4784).Text, obj8);
  ...
  items3[1] = closure_11(navigation(4784).Text, obj13);
  ...
  items5[1] = closure_11(navigation(4784).Text, obj16);
  ...
  const items6 = [closure_11(navigation(4784).Text, obj18), , ];
  ...
  items6[1] = closure_11(navigation(5218).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = closure_11(navigation(5218).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj17.children = items6;
  items2[2] = closure_12(closure_5, obj17);
  obj4.children = items2;
  obj3.children = closure_12(tmp12, obj4);
  return closure_11(navigation(7400).SafeAreaPaddingView, obj3);
};
