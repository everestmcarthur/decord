...
// Dependencies: [32, 19, 17, 2038, 21, 14973, 14970, 10527, 1115, 1364, 14969, 5682, 5218, 7224, 2]
// Exports: default

// Module 14972 (PasskeyUpsellPromoSheet)
...
export default function PasswordlessUpsellPromoSheet() {
  ...
  let obj = { source: require("module_14973"), style: { height: 190, width: 220, resizeMode: "contain" } };
  const tmp4 = closure_7(Image, { source: require("module_14973"), style: { height: 190, width: 220, resizeMode: "contain" } });
