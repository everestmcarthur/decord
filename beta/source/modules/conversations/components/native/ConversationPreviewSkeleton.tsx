...
// Dependencies: [19, 17, 7869, 21, 4788, 576, 4524, 4789, 2]
// Exports: default

// Module 8217 (ConversationPreviewSkeleton)
...
let closure_5 = fn(7869).MOBILE_PREVIEW_MESSAGE_COUNT;
const jsxProd = fn(21);
...
export default function ConversationPreviewSkeleton() {
  ...
  return closure_6(sharedValue(4524).View, obj3);
};
