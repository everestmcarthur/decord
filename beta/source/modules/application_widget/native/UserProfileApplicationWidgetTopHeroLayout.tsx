...
// Dependencies: [32, 19, 17, 1074, 7485, 21, 4788, 576, 9236, 8542, 9323, 9324, 5913, 5230, 2]
// Exports: default

// Module 9235 (UserProfileApplicationWidgetTopHeroLayout)
import nativeDefault from "native" /* 576 */;
import LinearGradientDefault from "LinearGradient" /* 5230 */;
import _modDef5913 from "module_5913" /* 5913 */;
import UserProfileSharedStyles from "UserProfileSharedStyles" /* 8542 */;
import resolvedValuesFromUserApplicationIdentityProfile from "resolvedValuesFromUserApplicationIdentityProfile" /* 9236 */;
import UserProfileApplicationWidgetFieldUtils from "UserProfileApplicationWidgetFieldUtils" /* 9323 */;
...
export default function UserProfileApplicationWidgetTopHeroLayout(header) {
  ...
  if (tmp15Result) {
    ...
    tmp15Result = tmp15(tmp4(9324).ImageSkeleton, obj9);
  }
