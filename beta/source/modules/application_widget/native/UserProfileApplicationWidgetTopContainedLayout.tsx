...
// Dependencies: [19, 17, 21, 4788, 576, 9236, 9323, 9324, 2]
// Exports: default

// Module 9327 (UserProfileApplicationWidgetTopContainedLayout)
...
export default function UserProfileApplicationWidgetTopContainedLayout(header) {
  ...
  if (null != fieldValue) {
    ...
    tmp12Result = tmp12(tmp2(9324).ImageSkeleton, obj10);
  }
