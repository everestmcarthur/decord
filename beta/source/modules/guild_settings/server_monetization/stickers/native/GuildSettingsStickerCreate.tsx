...
// Dependencies: [5, 32, 19, 17, 5708, 5751, 1074, 1375, 2022, 21, 4788, 576, 7258, 11442, 5847, 4441, 5386, 18020, 10683, 5135, 4784, 1115, 4684, 2108, 5218, 5216, 5371, 10472, 18021, 11417, 7407, 1397, 9069, 6880, 7362, 2]

// Module 18019 (GuildSettingsStickerCreate)
...
const MAX_STICKER_FILE_SIZE = fn(2022).MAX_STICKER_FILE_SIZE;
const jsxProd = fn(21);
...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    let obj9 = stickerId(4684);
    const tmp26 = closure_16;
    const tmp27 = onPressEmoji;
    obj11.articleUrl = tmp14(2108).getArticleURL(uri.STICKERS_UPLOAD);
    obj10.children = intl3.format(stickerId(1115).t.UBj0aX, obj11);
    items2[2] = onPressEmoji(stickerId(4784).Text, obj10);
    ...
    obj12.variant = str;
    items2[3] = tmp27(stickerId(5218).Button, obj12);
    obj13.children = items2;
    tmp23Result = tmp23(tmp26, obj13);
    const tmp14Result = tmp14(2108);
  }
  ...
  const items4 = [onPressEmoji(stickerId(4784).Text, obj15), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    let tmp32Result = tmp32(tmp14(10472), obj17);
    const tmp14Result4 = tmp14(10472);
  } else if (null != uri) {
    ...
    tmp32Result = tmp32(tmp31(18021).StickerPlusIcon, { size: "lg" });
  }
  obj16.children = tmp32Result;
  items4[1] = onPressEmoji(stickerId(5371).PressableHighlight, obj16);
  ...
  items4[2] = onPressEmoji(stickerId(4784).Text, obj20);
  const obj21 = {
  ...
  if (null != first1) {
    ...
    obj22.src = emojiURL;
    let tmp32Result2 = tmp32(tmp14(7407), obj22);
    const tmp14Result5 = tmp14(7407);
  } else {
    tmp32Result2 = tmp32(tmp31(9069).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4784).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj21.children = items5;
  items4[3] = closure_17(stickerId(5371).PressableHighlight, obj21);
  ...
  items4[4] = onPressEmoji(stickerId(6880).TextInput, obj24);
  ...
  items4[5] = onPressEmoji(stickerId(7362).TextArea, obj26);
  const obj27 = {
  ...
  items4[6] = onPressEmoji(stickerId(5218).Button, obj27);
  obj14.children = items4;
  items3[1] = closure_17(stickerId(5216).Stack, obj14);
