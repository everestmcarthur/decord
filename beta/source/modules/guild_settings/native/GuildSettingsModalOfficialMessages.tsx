...
// Dependencies: [32, 19, 17, 4780, 2063, 9888, 5852, 4781, 1085, 21, 4788, 576, 1115, 15542, 11612, 15544, 4788, 1484, 504, 9887, 5873, 7651, 4755, 16633, 1980, 9922, 4524, 5854, 14904, 1092, 4784, 9923, 4470, 7541, 672, 1177, 15557, 2]
// Exports: default

// Module 18254 (GuildSettingsModalOfficialMessages)
...
function MessagePreview(theme) {
  ...
  const items2 = [closure_1_12(native.Avatar, { source: _modDef15557 }), ];
...
obj2.chatSection = { paddingHorizontal: fn(5852).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
let obj5 = { paddingHorizontal: fn(5852).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
...
export default function GuildSettingsModalOfficialMessages(guildId) {
  ...
  const callback = officialMessageColor.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(16633, dependencyMap.paths), "RoleColorPicker", obj2);
  }, items5);
