...
// Dependencies: [19, 17, 9867, 21, 4788, 576, 9868, 9869, 14212, 4755, 4784, 1115, 5218, 7316, 7474, 7426, 2]
// Exports: default

// Module 14211 (ServerTagPreviewActionSheet)
import nativeDefault from "native" /* 576 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4755 */;
import GuildProfileActionCreators from "GuildProfileActionCreators" /* 9869 */;
import GuildSettingsServerTagPreviewDefault from "GuildSettingsServerTagPreview" /* 14212 */;
...
export default function ServerTagPreviewActionSheet(guildId) {
  ...
  if (null != guildProfile) {
    ...
    const items1 = [closure_6(tmp2(4784).Text, obj4), ];
    ...
    items1[1] = closure_6(tmp2(5218).Button, obj6);
    obj3.children = items1;
    tmp7 = closure_7(View, obj3);
    tmp8 = closure_6;
  } else {
    tmp7 = closure_6(tmp2(7316).SceneLoadingIndicator, {});
    tmp8 = closure_6;
  }
  ...
  const items2 = [tmp8(guildId(7426).BottomSheetTitleHeader, obj13), tmp7];
  obj7.children = items2;
  return closure_7(guildId(7474).ActionSheet, obj7);
};
