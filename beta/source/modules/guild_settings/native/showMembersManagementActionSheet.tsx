...
// Dependencies: [1372, 1115, 4755, 16926, 1980, 7539, 16927, 7471, 2]
...
export default function showMembersManagementActionSheet(guild) {
  ...
  const items = [obj];
  if (canPrune == null) {
    canPrune = tmp(7539).canPruneGuildMembers(guild, UserStore.getCurrentUser());
  ...
  const result = guild(7471).showSimpleActionSheet({ key: "GuildSettingsMembersMore", options: items, hasIcons: false });
};
