...
// Dependencies: [19, 17, 2059, 2063, 1372, 9888, 1074, 21, 4788, 576, 504, 9887, 4784, 1115, 5218, 15071, 7317, 2]
// Exports: default

// Module 18041 (GuildSettingsModalSecurity)
...
let closure_6 = fn(2059).isGuildOwnerWithRequiredMfaLevel;
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [closure_12(guildId(4784).Text, obj5), , ];
  ...
  obj6.children = closure_12(guildId(5218).Button, obj7);
  ...
  if (hasItem) {
    ...
    tmp17Result = tmp17(tmp2(4784).Text, obj8);
  }
  ...
  const items6 = [closure_12(closure_5, { source: stateFromStores(15071), style: tmp.image, resizeMode: "contain" }), ];
  ...
  obj12.children = closure_12(guildId(4784).Text, obj13);
  items6[1] = closure_12(closure_4, obj12);
  obj10.children = items6;
  items5[1] = closure_13(closure_4, obj10);
  obj3.children = items5;
  const items7 = [closure_13(closure_4, obj3), closure_12(guildId(7317).NavScrim, {})];
