...
// Dependencies: [5, 19, 17, 2109, 1074, 21, 4788, 576, 504, 18120, 1241, 7590, 7594, 5216, 4784, 1115, 1177, 5218, 18140, 7317, 2]
// Exports: default

// Module 18119 (GuildSettingsModalAnalytics)
...
export default function GuildSettingsModalAnalytics(guildId) {
  ...
  let obj = guildId(504);
  const guildAnalyticsOverview = guildId(18120).useGuildAnalyticsOverview(guildId);
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            v3 = 1;
            const obj6 = { value: v1(7590).redirectDeveloperPortalWithHandoffToken(result, v3(7594).LoginHandoffSource.GUILD_ANALYTICS_SETTING), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          v3 = 3;
  ...
  if (null == notice) {
    ...
    if (null != analytics) {
      ...
      const tmp11Result = tmp11(18140);
      const merged = Object.assign(tmp2(18120).getGuildAnalyticsCardProps(analytics.visitors, analytics.visitorsChange, stateFromStores));
      const items4 = [tmp9(tmp11Result, obj9), , , ];
      const obj10 = { metricKey: "communicators", title: null, description: null };
      const tmp2Result = tmp2(18120);
      const intl6 = tmp2(1115).intl;
      obj10.title = intl6.string(tmp2(1115).t.DDAHdQ);
      const intl7 = tmp2(1115).intl;
      obj10.description = intl7.string(tmp2(1115).t.HxWUkU);
      const tmp11Result4 = tmp11(18140);
      const merged1 = Object.assign(tmp2(18120).getGuildAnalyticsCardProps(analytics.communicators, analytics.communicatorsChange, stateFromStores));
      items4[1] = tmp9(tmp11Result4, obj10);
      const obj11 = { metricKey: "new_members", title: null };
      const tmp2Result4 = tmp2(18120);
      const intl8 = tmp2(1115).intl;
      obj11.title = intl8.string(tmp2(1115).t.hYeOqC);
      const tmp11Result5 = tmp11(18140);
      const merged2 = Object.assign(tmp2(18120).getGuildAnalyticsCardProps(analytics.newMembers, analytics.newMembersChange, stateFromStores));
      items4[2] = tmp9(tmp11Result5, obj11);
      const obj12 = { metricKey: "new_member_retention", title: null, description: null };
      const tmp2Result5 = tmp2(18120);
      ...
      items4[3] = tmp9(tmp11(18140), obj12);
      obj8.children = items4;
      tmp7Result = tmp7(tmp2(5216).Stack, obj8);
      const tmp11Result6 = tmp11(18140);
    }
    const obj13 = { children: null };
    items3[4] = tmp7Result;
    obj4.children = items3;
    obj3.children = tmp7(guildId(5216).Stack, obj4);
    const items5 = [tmp9(tmp10, obj3), tmp9(tmp2(7317).NavScrim, {})];
