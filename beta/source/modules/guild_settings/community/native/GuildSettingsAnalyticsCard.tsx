...
// Dependencies: [19, 17, 21, 4788, 576, 4486, 5856, 4784, 4742, 1115, 11707, 18141, 2]
// Exports: default

// Module 18140 (GuildSettingsAnalyticsCard)
...
export default function GuildSettingsAnalyticsCard(metricKey) {
  ...
  const items1 = [closure_6(metricKey(4784).Text, { variant: "text-md/medium", color: "text-subtle", children: title }), ];
  let tmp7Result = null;
  if (null != description) {
    ...
    obj3.children = tmp7(tmp4(4742).CircleInformationIcon, obj4);
  ...
  items2[1] = closure_6(metricKey(4784).Text, obj5);
  let tmp3Result = null;
  if (null != subtext) {
    ...
    if (isTrendingUp) {
      ...
      tmp7Result3 = tmp7(tmp4(11707).ArrowLargeUpIcon, obj7);
    }
