...
// Dependencies: [19, 17, 4780, 12283, 21, 4788, 8161, 2051, 11807, 12288, 504, 8251, 1177, 4784, 2]
// Exports: ForumPostAuthor, ForumPostMessageAuthor

// Module 12287 (ForumPostUsername)
import initialize from "initialize" /* 504 */;
import ForumLayout from "ForumLayout" /* 2051 */;
import ForumHooks from "ForumHooks" /* 8161 */;
import useChatWidthDefault from "useChatWidth" /* 11807 */;
...
function ForumPostUsername(arg0) {
  ...
  const diff = useChatWidthDefault() - tmp2(12288).GRID_HORIZONTAL_PADDING - num;
  ...
  if ("username" === stateFromStores) {
    ...
    const processColorStringsArray = tmp2(8251).useProcessColorStringsArray(authorColors);
    const tmp2Result4 = tmp2(8251);
    ...
    if (null != authorName) {
      ...
      items3[1] = React5(tmp2(4784).Text, obj6);
