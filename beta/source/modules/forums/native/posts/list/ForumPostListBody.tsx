...
// Dependencies: [19, 17, 7547, 21, 4788, 7546, 12297, 12287, 12296, 12298, 12305, 12291, 2]
// Exports: default

// Module 12304 (ForumPostListBody)
...
import ForumPostNewTagDefault from "ForumPostNewTag" /* 12297 */;
import ForumPostMessageContentDefault from "ForumPostMessageContent" /* 12305 */;
...
export default function ForumPostListBody(arg0) {
  ...
  if (!isGameInvitesPost) {
    ...
    tmp9Result = tmp9(tmp10(12298), obj7);
  }
  items2[1] = tmp9Result;
  ...
  if (!blocked) {
    ...
    if (null != media) {
      ...
      tmp9Result2 = tmp9(tmp2(12291).ForumPostMediaThumbnail, obj8);
    }
  }
