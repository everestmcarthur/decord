...
// Dependencies: [19, 17, 21, 4788, 576, 1177, 12286, 2]
// Exports: default

// Module 12285 (ForumPostPinIcon)
...
export default function ForumPostPinIcon(containerStyle) {
  const tmp = closure_5();
  const obj = { style: null, children: jsx(native.Icon, { source: _modDef12286, style: tmp.pinIcon }) };
  const items = [tmp.pin, containerStyle.containerStyle];
  obj.style = items;
  return <View style={null}>{jsx(native.Icon, { source: _modDef12286, style: tmp.pinIcon })}</View>;
};
