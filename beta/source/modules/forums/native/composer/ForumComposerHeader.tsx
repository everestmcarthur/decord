...
// Dependencies: [19, 17, 21, 4788, 576, 4941, 5371, 1115, 5929, 5338, 4784, 5325, 2]
// Exports: default

// Module 10563 (ForumComposerHeader)
...
export default function ForumComposerHeader(height) {
  ...
  if (length > 0) {
    ...
    obj5.children = tmp6(tmp7(5325).BookCheckIcon, {});
    tmp6Result = tmp6(tmp7(5371).PressableOpacity, obj5);
  }
  items[2] = tmp6Result;
