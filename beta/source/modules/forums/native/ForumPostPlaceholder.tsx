...
// Dependencies: [32, 19, 4780, 21, 4788, 576, 504, 4524, 4789, 5856, 2]

// Module 12309 (ForumPostPlaceholder)
...
export default noop.memo(() => {
  ...
  const timingConfig = _slicedToArray(noop.useState(() => {
    ...
    const Easing = stateFromStores(4524).Easing;
    obj2.easing = Easing.inOut(stateFromStores(4524).Easing.sin);
  ...
  let obj2 = stateFromStores(4524);
  fn.__closure = { reducedMotion: stateFromStores, ROW_OPACITY_END, withDelay: stateFromStores(4524).withDelay, INITIAL_DELAY_MS: 1000, withRepeat: stateFromStores(4524).withRepeat, withSequence: stateFromStores(4524).withSequence, withTiming: stateFromStores(4789).withTiming, timingConfig };
  ...
  return jsx(timingConfig(4524).View, { style: animatedStyle, pointerEvents: "none", children: jsx(stateFromStores(5856).Card, { variant: "secondary", style: tmp.postPlaceholder }) });
});
