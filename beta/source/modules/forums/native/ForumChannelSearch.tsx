...
// Dependencies: [19, 17, 2041, 8042, 21, 4788, 1485, 13595, 8139, 5218, 1115, 8174, 504, 7327, 8041, 2]

// Module 13594 (ForumChannelSearch)
...
export const ForumChannelSearchInput = noop.memo((channelId) => {
  ...
  const tmp = closure_8();
  const canSearchForumPostsByChannelId = channelId(13595).useCanSearchForumPostsByChannelId(channelId);
  let obj = channelId(13595);
