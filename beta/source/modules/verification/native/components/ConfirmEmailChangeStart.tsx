...
// Dependencies: [5, 32, 19, 17, 1372, 21, 4788, 1484, 504, 6875, 1094, 4689, 4486, 1115, 6876, 4784, 5218, 2]
// Exports: default

// Module 6874 (ConfirmEmailChangeStart)
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    let obj6 = { style: tmp.image, source: navigation(6876) };
    ...
    items1[1] = closure_10(tmp2(4784).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5218).Button, obj9);
