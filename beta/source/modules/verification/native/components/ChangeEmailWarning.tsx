...
// Dependencies: [19, 17, 1372, 5933, 1074, 21, 4788, 576, 1484, 504, 1241, 1094, 5941, 4784, 1115, 5218, 5870, 2]
// Exports: default

// Module 5940 (ChangeEmailWarning)
...
const hcArticle = fn(5933).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(5941).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4784).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4784).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(5218).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(5218).Button, obj10);
