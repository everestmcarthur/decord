...
// Function ID: 13750
// Name: AppIconUtils
// Dependencies: [32, 5, 19, 17, 9469, 1074, 1374, 3, 1364, 13750, 9470, 5235, 573, 1241, 4486, 1115, 7656, 1609, 2]
// Exports: isAppIconsSupported, navigateToAppIconSettings, setAppIcon, useAppIcons, useCurrentAppIcon

// Module 13749 (AppIconUtils)
...
const AppIconConstants = fn(9469);
...
if (PlatformUtils.isAndroid()) {
  let DCDIconManager = fn(13750).default;
} else {
