...
// Dependencies: [19, 17, 1372, 2038, 21, 4788, 576, 504, 4446, 4755, 7427, 17399, 1177, 10260, 4784, 1115, 5218, 13749, 2]
// Exports: default
...
export default function AppIconsCoachmarkActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_8(markAsDismissed(1177).Icon, { source: _modDef10260, size: markAsDismissed(1177).IconSizes.MEDIUM, style: tmp.nitroWheel, disableColor: true }), ];
  ...
  items2[2] = closure_8(markAsDismissed(4784).Text, obj9);
  ...
  const items5 = [closure_8(markAsDismissed(5218).Button, obj11), ];
  const obj12 = { variant: "secondary", text: null, onPress: null };
  const intl4 = tmp2(1115).intl;
  obj12.text = intl4.string(markAsDismissed(1115).t.iSrIIZ);
  obj12.onPress = callback;
  items5[1] = closure_8(markAsDismissed(5218).Button, obj12);
  obj10.children = items5;
  items4[1] = closure_9(closure_5, obj10);
  obj3.children = items4;
  return closure_9(markAsDismissed(7427).BottomSheet, obj3);
};
