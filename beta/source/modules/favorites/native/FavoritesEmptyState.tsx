...
// Dependencies: [19, 17, 21, 4788, 576, 10521, 11271, 4755, 10525, 1980, 10524, 5941, 5216, 4784, 1115, 3356, 5218, 13035, 2]
// Exports: default
...
export default function FavoritesEmptyState() {
  ...
  obj4.children = intl.string(_modDef3356["wh+Rz1"]);
  ...
  obj5.children = intl2.string(_modDef3356["+SuGKb"]);
  ...
  if (obj.useFavoritesAccess("favorites_empty_state").hasAccess) {
    ...
    obj6.text = intl4.string(tmp9(3356)["6kk0gM"]);
    obj6.icon = tmp8(tmp2(13035).PlusMediumIcon, {});
    obj6.onPress = callback;
    let obj7 = obj6;
  } else {
    obj7 = { variant: "primary", text: null, onPress: null };
    const intl3 = tmp2(1115).intl;
    obj7.text = intl3.string(tmp9(3356).yYVbdv);
