...
// Dependencies: [4755, 16479, 1980, 2]
// Exports: default

// Module 16478 (openFavoritesGuildActionSheet)
...
export default function openFavoritesGuildActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16479, dependencyMap.paths), FavoritesGuildActionSheet, {
    onClose() {
