...
// Dependencies: [32, 19, 2054, 21, 4788, 576, 2066, 10520, 4755, 7427, 7426, 1115, 6880, 5218, 2]
// Exports: openFavoritesGuildAddCategoryActionSheet

// Module 16495 (FavoritesGuildAddCategoryActionSheet)
...
function FavoritesGuildAddCategoryActionSheet() {
  ...
  const result = value(2066).isFavoritesGuildCategoryNameValid(value);
  ...
  obj2.header = closure_6(value(7426).BottomSheetTitleHeader, obj3);
  ...
  const items1 = [closure_6(value(6880).TextInput, obj4), ];
  ...
  items1[1] = closure_6(value(5218).Button, obj5);
  obj2.children = items1;
  return closure_7(value(7427).BottomSheet, obj2);
}
