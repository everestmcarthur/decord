...
// Dependencies: [19, 17, 1074, 21, 4788, 576, 7616, 8211, 5878, 1115, 16521, 2]
// Exports: default
...
export default function ServerPreviewBannerControls() {
  ...
  const obj2 = { size: "md", variant: "secondary-overlay", icon: _modDef5878, onPress: callback, accessibilityLabel: null, maxFontSizeMultiplier: 1.5 };
