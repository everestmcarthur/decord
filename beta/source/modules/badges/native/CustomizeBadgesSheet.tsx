...
// Dependencies: [19, 17, 8461, 1372, 8493, 1074, 7428, 1374, 21, 4788, 576, 4756, 8208, 14928, 8206, 1115, 7243, 4742, 5856, 11486, 8211, 11493, 7239, 4524, 4789, 4792, 13406, 8207, 6929, 4499, 11487, 1612, 504, 4446, 7439, 7459, 7429, 9538, 9508, 8492, 1241, 8498, 4486, 1478, 11288, 14929, 4784, 5826, 7427, 7426, 6901, 2]
// Exports: default

// Module 14927 (CustomizeBadgesSheet)
...
import EyeSlashIcon from "EyeSlashIcon" /* 7243 */;
...
import BadgeCatalogIconDefault from "BadgeCatalogIcon" /* 11486 */;
import BadgeUtils from "BadgeUtils" /* 11493 */;
import PendingBadgeSettings from "PendingBadgeSettings" /* 13406 */;
import BadgeGrid from "BadgeGrid" /* 14928 */;
  ...
  if (flag) {
    if (null != onShowPress) {
      if (!alwaysVisible) {
        ...
        obj5.icon = tmp10(tmp8(7243).EyeSlashIcon, obj6);
        ...
        obj4.children = tmp10(tmp8(8211).IconButton, obj5);
...
let closure_13 = fn(7428).ACTION_SHEET_MINIMUM_BOTTOM_PADDING;
...
getSlotOffset.__closure = { BADGE_GRID_COLUMNS: fn(14928).BADGE_GRID_COLUMNS, BADGE_GRID_GAP: fn(14928).BADGE_GRID_GAP };
    ...
    if (badge.hidden) {
      ...
      function renderTile(ref) {
        ...
        if (alwaysVisible) {
          ...
          stringResult = intl2.string(tmp6(11493).getAlwaysVisibleCopy(tmp9));
          const tmp6Result = tmp6(11493);
        }
  ...
  if (typeof closure_22 === "function") {
    ...
    let fn2 = function $() {
      ...
      if (result !== value) {
        ...
        tmp(4524).runOnJS(tmp(4756).triggerHapticFeedback)(tmp(4756).HapticFeedbackTypes.DRAG_AND_DROP_MOVE);
        const runOnJSResult = tmp(4524).runOnJS(tmp(4756).triggerHapticFeedback);
      }
    };
