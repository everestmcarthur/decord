...
// Dependencies: [19, 17, 1386, 4633, 1372, 12696, 21, 4788, 504, 4747, 576, 4742, 4784, 1115, 5371, 4506, 1177, 4632, 2]
// Exports: default
...
export default function AccountSwitcherListItem(arg0) {
  ...
  if (user.id === id) {
    if (showActiveAccountLabel) {
      ...
      let tmp8 = React7(tmp2(4784).Text, obj4);
    }
    if (null == onPressUser) {
      let PressableOpacity = React3;
    } else {
      PressableOpacity = tmp2(5371).PressableOpacity;
    }
    const obj5 = { selected: tmp7 };
    const radioA11yNative = tmp2(4506).useRadioA11yNative(obj5);
    ...
    const items4 = [React7(tmp2(4784).Text, obj12), ];
    ...
    if (tmp18Result) {
      ...
      tmp18Result = tmp18(tmp2(4784).Text, obj15);
    }
  ...
  if (user.tokenStatus === MultiAccountTokenStatus.INVALID) {
    ...
    tmp8 = React7(tmp2(4784).Text, obj17);
  }
};
