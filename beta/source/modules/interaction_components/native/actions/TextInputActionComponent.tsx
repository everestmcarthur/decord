...
// Dependencies: [32, 19, 21, 8413, 17801, 1978, 6887, 7363, 6881, 2]

// Module 17804 (TextInputActionComponent)
...
export default noop.memo((type) => {
  ...
  if (Server.TextInputComponentStyle.SMALL === style) {
    ...
    let tmp7 = jsx(tmp(6887).TextField, {});
  } else if (tmp(1978).TextInputComponentStyle.PARAGRAPH === style) {
    const obj6 = {};
    const merged1 = Object.assign(obj3);
    tmp7 = jsx(tmp(7363).TextAreaField, {});
  }
  let tmp16 = tmp7;
  if (null != label) {
    const obj7 = { label, required, errorMessage: error, children: tmp7 };
    tmp16 = jsx(tmp(6881).Input, { label, required, errorMessage: error, children: tmp7 });
  }
  return tmp16;
});
