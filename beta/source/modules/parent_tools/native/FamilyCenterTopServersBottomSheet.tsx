...
// Dependencies: [7811, 21, 4788, 576, 504, 7866, 5854, 5833, 7474, 4784, 1115, 2482, 5936, 2]
// Exports: default

// Module 15179 (FamilyCenterTopServersBottomSheet)
...
function GuildRow(guildActivity) {
  ...
  if (null == stateFromStores) {
    ...
    const topUserOrGuildDescription = tmp2(7866).getTopUserOrGuildDescription(guildActivity.messages_sent, guildActivity.call_count);
