...
// Dependencies: [5, 19, 17, 1372, 7812, 21, 4788, 576, 1484, 563, 7813, 12199, 7866, 12200, 8725, 8726, 1177, 1397, 1115, 2482, 4784, 12201, 12202, 12210, 5682, 5218, 4991, 5941, 8956, 38, 11844, 7269, 5826, 8575, 1978, 8714, 8716, 5000, 5873, 12211, 11494, 2]
// Exports: default

// Module 12198 (FamilyCenterModalRequest)
...
import NavigatorHeader2 from "NavigatorHeader" /* 5873 */;
...
import FamilyCenterModalRequestRouting from "FamilyCenterModalRequestRouting" /* 12199 */;
...
function FamilyCenterConfirmAgeScreen(teenIdentity) {
  ...
  const tmp7 = stateFromStores(8575)(stateFromStores);
  dependencyMap = tmp7;
  ...
  const callback = noop.useCallback(() => {
    const obj = stateFromStores(8714);
    const result = obj.showAgeVerificationGetStartedModal({ entryPoint: navigation(8716).AgeVerificationModalEntryPoint.FAMILY_CENTER_CONNECTION });
  }, []);
  const obj3 = { style: tmp.content, children: null };
  const obj2 = navigation(563);
  const items2 = [closure_12(closure_6, { style: tmp.art, children: closure_12(navigation(5941).FamilyShieldSpotIllustration, {}) }), , ];
  ...
  items2[1] = closure_12(navigation(4784).Text, obj5);
  ...
  items2[2] = closure_12(navigation(4784).Text, obj7);
  ...
  const items4 = [closure_12(navigation(5218).Button, obj10), ];
  ...
  items4[1] = closure_12(navigation(5218).Button, obj11);
  obj9.children = items4;
  obj8.children = closure_13(navigation(5682).ButtonGroup, obj9);
  items3[1] = closure_12(navigation(12210).ModalFooter, obj8);
  obj6.children = items3;
  return closure_13(navigation(8725).ModalScreen, obj6);
}
...
function FamilyCenterPrereqMustBeAdultScreen() {
  ...
  const tmp3 = stateFromStores(8575)(stateFromStores);
  dependencyMap = tmp3;
  ...
  obj5.onPress = stateFromStores(4991).pop;
...
export default function FamilyCenterRequestModal(userId) {
  ...
  const FamilyCenterConnectionPrereqExperiment = userId(12211).FamilyCenterConnectionPrereqExperiment;
  ...
  const FamilyCenterModalRequestSections = userId(12199).FamilyCenterModalRequestSections;
  ...
  return closure_12(userId(11494).Modal, obj);
};
