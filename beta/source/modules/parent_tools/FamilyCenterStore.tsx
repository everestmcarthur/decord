...
// Dependencies: [32, 5003, 1073, 1372, 7812, 2055, 11, 7813, 7866, 2]

// Module 7811 (FamilyCenterStore)
...
const getCountryCodeByAlpha2 = fn(5003).getCountryCodeByAlpha2;
...
prototype["loadCache"] = function loadCache() {
  ...
  if (null != snapshot) {
    ...
    snapshot = teenActivityTotals.reduce((acc, item) => {
      ...
      const result = closure_0(7866).displayTypeFromString(tmp2);
      let tmp5 = acc;
      if (undefined !== result) {
        const obj2 = {};
        const merged = Object.assign(acc);
