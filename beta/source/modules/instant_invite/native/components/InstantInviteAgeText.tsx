...
// Dependencies: [19, 17, 10116, 21, 4788, 7257, 504, 4784, 10117, 5371, 10115, 1115, 2]
// Exports: default

// Module 10186 (InstantInviteAgeText)
...
export default function InstantInviteAgeText(style) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [tmp2(10117).maxAgeString(stateFromStores.maxAge, stateFromStores.maxUses), " "];
    obj4.children = items2;
    const items3 = [closure_4(tmp2(4784).Text, obj4), ];
    if (canEditInvite) {
      const obj5 = {
        onPress() {
      ...
      obj5.children = closure_5(tmp2(4784).Text, obj6);
      canEditInvite = tmp9(tmp2(5371).PressableOpacity, obj5);
    }
    items3[1] = canEditInvite;
    obj3.children = items3;
    tmp7Result = tmp7(View, obj3);
    const tmp2Result = tmp2(10117);
  }
  return tmp7Result;
};
