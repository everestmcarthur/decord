...
// Dependencies: [5, 19, 2096, 4707, 2105, 2063, 4427, 5687, 1372, 13439, 8010, 1074, 1241, 4755, 13440, 1980, 5766, 504, 4499, 1115, 8681, 10117, 10190, 2]
// Exports: sendGuildInvite, showGuildInviteActionSheet, useServerInviteRows

// Module 13438 (GuildInviteUtils)
...
const setSendState = fn(13439).setSendState;
...
export const showGuildInviteActionSheet = function showGuildInviteActionSheet(id, newestAnalyticsLocation) {
  ...
  obj3.openLazy(asyncRequireImpl(13440, dependencyMap.paths), "invite-to-guilds-" + id, { recipientId: id, source: newestAnalyticsLocation });
};
