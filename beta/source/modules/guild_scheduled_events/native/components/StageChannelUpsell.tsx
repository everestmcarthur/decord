...
// Dependencies: [32, 19, 17, 2045, 9847, 9816, 1074, 21, 4788, 576, 5371, 1177, 7269, 9848, 4784, 1115, 5218, 4991, 9849, 1980, 4755, 2]
// Exports: default

// Module 9846 (StageChannelUpsell)
...
let closure_7 = fn(9847).useStageChannelUpsellCardStore;
let closure_8 = fn(9816).CREATE_GUILD_EVENT_MODAL_KEY;
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4784).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9849, dependencyMap.paths), {
        guildId,
