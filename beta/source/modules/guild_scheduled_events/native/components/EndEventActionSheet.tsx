...
// Dependencies: [19, 17, 2047, 1074, 21, 4788, 576, 9782, 4755, 9936, 8901, 1177, 1115, 4784, 5218, 9820, 2]
// Exports: default
...
export default function EndEventActionSheet(channel) {
  ...
  const tmp = closure_7();
  const activeEvent = channel(9782).useActiveEvent(channel.id);
  if (null == activeEvent) {
    return null;
  } else {
    ...
    obj6.children = closure_5(tmp2(5218).Button, obj7);
    ...
    obj8.children = closure_5(tmp2(5218).Button, obj9);
    items[3] = closure_5(View, obj8);
    obj3.children = items;
    obj2.children = closure_6(View, obj3);
    return closure_5(activeEvent(8901), obj2);
  }
  let obj = channel(9782);
};
