...
// Dependencies: [5, 32, 19, 17, 2041, 2063, 2047, 9816, 21, 4788, 576, 4991, 5371, 1115, 1177, 7366, 4784, 10103, 504, 9791, 10105, 7400, 8713, 10108, 5218, 2]
// Exports: default

// Module 10104 (StartEventModal)
...
import GuildEventCardDefault from "GuildEventCard" /* 10103 */;
...
function NavigationBar(onClose) {
  ...
  obj2.children = closure_1_12(native.Icon, { source: _modDef7366 });
...
const START_EVENT_MODAL_KEY = fn(9816).START_EVENT_MODAL_KEY;
const jsxProd = fn(21);
