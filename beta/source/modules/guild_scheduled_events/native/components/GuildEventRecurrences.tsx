...
// Dependencies: [19, 17, 21, 4788, 576, 9927, 4784, 1115, 11, 9929, 5218, 2]
// Exports: default
...
export default function GuildEventRecurrences(guildEventId) {
  ...
  const items = [closure_6(guildEventId(4784).Text, obj2), , ];
  ...
  if (canViewMoreRecurrences) {
    ...
    canViewMoreRecurrences = tmp7(tmp8(5218).Button, obj4);
  }
