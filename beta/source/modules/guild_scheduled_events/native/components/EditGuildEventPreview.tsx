...
// Dependencies: [19, 17, 2041, 1074, 21, 4788, 576, 1364, 504, 4941, 9822, 9898, 4784, 1115, 9899, 1177, 9900, 9821, 7400, 9901, 5218, 9785, 5141, 9917, 1980, 2]
// Exports: default

// Module 9897 (EditGuildEventPreview)
...
function PreviewBody(event) {
  ...
  const tmp6 = channel_id(4941)(stateFromStores);
  dependencyMap = tmp6;
  ...
  if (null != stateFromStores) {
    ...
    obj6.channelName = tmp5(9899)(obj7);
