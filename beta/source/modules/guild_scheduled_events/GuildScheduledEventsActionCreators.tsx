...
// Dependencies: [5, 502, 7800, 2047, 1074, 1271, 5660, 1101, 9821, 5029, 573, 9823, 11, 2]

// Module 9820 (GuildScheduledEventsActionCreators)
...
export default {
  ...
  fetchGuildEvent(arg0, arg1) {
    ...
    closure_1 = arg1;
    return (async () => {
      await tmp5(5029).httpGetWithCountryCodeQuery({ url: closure_1_10.GUILD_EVENT(tmp5, tmp2), rejectWithError: tmp5(1271).rejectWithMigratedError() });
  ...
  fetchGuildEventsForGuild(guild_id) {
    closure_0 = guild_id;
    return (async () => {
      await tmp5(5029).httpGetWithCountryCodeQuery({ url: closure_1_10.GUILD_EVENTS_FOR_GUILD(tmp5), rejectWithError: tmp5(1271).rejectWithMigratedError() });
      const body = arg1.body;
