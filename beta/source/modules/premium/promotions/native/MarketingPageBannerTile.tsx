...
// Dependencies: [19, 17, 21, 4788, 576, 7439, 13723, 9080, 1249, 11035, 13726, 4784, 4483, 10266, 2]
// Exports: default

// Module 13722 (MarketingPageBannerTile)
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const obj = helpArticleLinkProps(13723);
  const obj3 = { type: null, name: null, properties: null };
  const buttonActionHandler = helpArticleLinkProps(13723).getButtonActionHandler(obj2);
  ...
  obj3.properties = { component_type: helpArticleLinkProps(11035).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  tmp2Result(obj3);
  const obj4 = { component_type: helpArticleLinkProps(11035).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  const formatStringWithCommonPremiumParams = helpArticleLinkProps(13726).useFormatStringWithCommonPremiumParams(bannerFields.body);
  const tmp4Result = helpArticleLinkProps(13726);
  helpArticleLinkProps = helpArticleLinkProps(13726).getHelpArticleLinkProps(bannerFields.helpArticle, bannerFields.helpArticleId);
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4784).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result3) {
    ...
    tmp12Result3 = tmp12(tmp4(4784).Text, obj11);
  }
  items3[2] = tmp12Result3;
  obj10.children = items3;
  items2[2] = closure_6(helpArticleLinkProps(4784).Text, obj10);
  ...
  if (tmp12Result4) {
    ...
    obj12.children = tmp12(tmp2(10266), obj13);
