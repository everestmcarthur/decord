...
// Dependencies: [17, 21, 4788, 576, 7257, 4784, 12839, 12840, 1115, 2514, 12843, 2]
// Exports: default

// Module 12838 (GuildPowerupsNotificationContainer)
import _mod17 from "module_17" /* 17 */;
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4784 */;
import ManaTypeConsolidationExperiment from "ManaTypeConsolidationExperiment" /* 7257 */;
import useGuildPowerupTier3OverrideConfigDefault from "useGuildPowerupTier3OverrideConfig" /* 12839 */;
import useGuildPowerupExpiringNotificationsConfigDefault from "useGuildPowerupExpiringNotificationsConfig" /* 12840 */;
...
export default function GuildPowerupsNotificationContainer(guildId) {
  ...
  if (tmp4.shouldShow) {
    ...
    obj3.children = intl.string(tmp2(2514)["3FRirU"]);
    const items = [React4(tmp6(4784).Text, obj3), , ];
    ...
    if (shouldShow2) {
      ...
      shouldShow2 = tmp11(tmp2(12843), obj9);
    }
    items[2] = shouldShow2;
    obj2.children = items;
