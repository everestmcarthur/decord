...
// Dependencies: [17, 21, 4788, 576, 12824, 12825, 12826, 5146, 6884, 1115, 2514, 5146, 4784, 2]
// Exports: default

// Module 12823 (GuildPowerupsDeactivateAlert)
import _mod17 from "module_17" /* 17 */;
import nativeDefault from "native" /* 576 */;
import _modDef2514 from "module_2514" /* 2514 */;
import Text_Text from "Text/Text" /* 4784 */;
import useGuildPowerupOnDeactivateDefault from "useGuildPowerupOnDeactivate" /* 12824 */;
import useDeactivateWarningTextDefault from "useDeactivateWarningText" /* 12825 */;
...
export default function GuildPowerupsDeactivateAlert(arg0) {
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(tmp5(4784).Text, obj7);
  }
