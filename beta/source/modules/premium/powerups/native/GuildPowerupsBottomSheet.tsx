...
// Dependencies: [17, 4780, 4677, 4678, 21, 4788, 576, 12783, 12779, 12802, 12803, 504, 12804, 4498, 12806, 4784, 12807, 12809, 12810, 4742, 1115, 2514, 12796, 12816, 4680, 9890, 12817, 12818, 12822, 12827, 12828, 5218, 12826, 7427, 2]
// Exports: default

// Module 12801 (GuildPowerupsBottomSheet)
...
import useGuildPowerupLevelPerksDefault from "useGuildPowerupLevelPerks" /* 12809 */;
import GuildBoostingMarketingUtils from "GuildBoostingMarketingUtils" /* 12810 */;
import useGuildPowerupCardFooterConfigDefault from "useGuildPowerupCardFooterConfig" /* 12816 */;
import useCanGuildPowerupBeToggledDefault from "useCanGuildPowerupBeToggled" /* 12817 */;
import useGuildPowerupOnActivateDefault from "useGuildPowerupOnActivate" /* 12818 */;
import GuildPowerupAnalytics from "GuildPowerupAnalytics" /* 12826 */;
...
function GuildPowerupsBottomSheetHeader(arg0) {
  ...
  if (powerup.type === constants.LEVEL) {
    ...
    let tmp15 = React6(tmp2(12804), obj2);
    let tmp14 = React6;
    ...
    obj3.children = React6(tmp6(4498).GameServerHostingRive, obj4);
    tmp15 = React6(tmp12, obj3);
    tmp14 = React6;
  } else {
    const obj6 = { imageUrl: str, style: tmp.image, isAnimated: true };
    tmp14 = React6;
    tmp15 = React6(tmp2(12806), obj6);
  }
...
function GuildPowerupsBottomSheetBody(powerup) {
  ...
  if (constants.PERK === type) {
    ...
    if (tmp5Result) {
      ...
      const items1 = [tmp7(tmp8(4742).CircleInformationIcon, obj4), ];
      ...
      obj5.children = intl.formatToPlainString(_modDef2514.GMhQcE, obj6);
      items1[1] = tmp7(tmp8(4784).Text, obj5);
...
function GuildPowerupsBottomSheetFooter(arg0) {
  ...
  if (showConfigureButton) {
    ...
    if (!result) {
      result = tmp6(9890).canUseMobileServerTagSettings(guildId);
      const tmp6Result = tmp6(9890);
    }
  ...
  closure_2 = tmp2(12822)(guildId, powerup);
  if (tmp4) {
    ...
    if (tmp14) {
      ...
      obj2.children = intl.string(tmp2(2514)["jo5++h"]);
    ...
    if (tmp21) {
      ...
      tmp21 = React6(tmp2(12828), obj3);
    }
    items[1] = tmp21;
    if (showConfigureButton) {
      const obj4 = { variant: "primary", text: null, onPress: null };
      const intl2 = util.intl;
      obj4.text = intl2.string(tmp2(2514).g5Ds69);
      obj4.onPress = tmp10;
