...
// Dependencies: [7514, 1374, 7723, 7517, 563, 2]
// Exports: useAndroidAndLegacyIOSPremiumTrialOfferCandidates

// Module 7722 (useAndroidAndLegacyIOSPremiumTrialOfferCandidates)
...
export const useAndroidAndLegacyIOSPremiumTrialOfferCandidates = function useAndroidAndLegacyIOSPremiumTrialOfferCandidates() {
  ...
  const values6 = Object.values(tmp(7517).TrialIdToProductOfferId[React3]);
  let tmp6 = null;
  ...
  const values7 = Object.values(tmp(7517).TrialIdToProductOfferId[React4]);
  let tmp8 = null;
  ...
  const values8 = Object.values(tmp(7517).TrialIdToProductOfferId[hasOwnProperty]);
  let tmp10 = null;
  ...
  const values9 = Object.values(tmp(7517).TrialIdToProductOfferId[React5]);
  let tmp12 = null;
  ...
  const values10 = Object.values(tmp(7517).TrialIdToProductOfferId[React6]);
  let tmp14 = null;
