...
// Dependencies: [5, 32, 19, 7726, 504, 38, 7727, 8482, 2]
// Exports: useReferralProgramEligibleUsers

// Module 13738 (useReferralProgramEligibleUsers)
                ...
                if (null != tmp65) {
                  if (0 !== stateFromStores) {
                    ...
                    if (closure_3 === undefined) {
                      ...
                      if (closure_133_4[1] === searchQuery(7727).ReferralOfferStatus.PENDING) {
                        if (!closure_134_12.has(closure_133_5)) {
                          obj3 = searchQuery(8482);
                          c9 = 5;
                          c10 = 1;
