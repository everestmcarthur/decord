...
// Dependencies: [17, 7706, 21, 4788, 576, 4784, 1115, 13779, 1177, 5230, 4637, 9527, 2]
// Exports: default

// Module 13778 (PremiumGroupFeaturesTableCard)
...
import ColorConstants from "ColorConstants" /* 7706 */;
import usePremiumGroupFeaturesTableCardTextDefault from "usePremiumGroupFeaturesTableCardText" /* 13779 */;
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  if (null == tmp4) {
    ...
    const items1 = [hasOwnProperty(tmp2(9527), { width: 181, height: 16 }), hasOwnProperty(BetaPill, {})];
