...
// Dependencies: [19, 17, 7821, 1971, 21, 4788, 576, 8479, 4506, 11340, 5371, 9137, 9123, 9108, 4784, 1115, 2]
// Exports: default

// Module 11339 (GiftingSKUCardsGrid)
...
let closure_10 = noop.memo((rewardSkuId) => {
  ...
  if (null == product) {
    ...
    if (claimed) {
      ...
      obj8.children = tmp7(tmp2(9108).CheckmarkLargeBoldIcon, obj9);
    ...
    const items4 = [React5(tmp2(4784).Text, obj11), ];
    ...
    items4[1] = React5(tmp2(4784).Text, obj12);
    obj10.children = items4;
    items3[2] = React6(View, obj10);
    obj4.children = items3;
    return React6(tmp2(5371).PressableOpacity, obj4);
  }
});
