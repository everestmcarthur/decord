...
// Dependencies: [19, 17, 8493, 11327, 2038, 21, 4788, 576, 1612, 4991, 4646, 5218, 11328, 1115, 2578, 11329, 4784, 11040, 4756, 4757, 11045, 11330, 4608, 2027, 504, 8485, 2]
// Exports: default

// Module 11326 (GiftBadgePostPurchase)
...
import GiftingBadgeProgressDefault from "GiftingBadgeProgress" /* 11329 */;
import GiftingBadgeLevelUpProgressDefault from "GiftingBadgeLevelUpProgress" /* 11330 */;
...
function PostPurchaseFooter(onSendGift) {
  ...
  const callback1 = noop.useCallback(() => {
    ModalActionCreatorsDefault.pop();
    const rootNavigationRef = onSendGift(4646).getRootNavigationRef();
  ...
  obj2.icon = closure_10(onSendGift(11328).GiftIcon, { size: "sm", color: nativeDefault.colors.CONTROL_PRIMARY_TEXT_DEFAULT });
  const intl = onSendGift(1115).intl;
  obj2.text = intl.string(_modDef2578.g86YiI);
  obj2.onPress = callback;
  const items1 = [closure_10(onSendGift(5218).Button, obj2), ];
  ...
  items1[1] = closure_10(onSendGift(5218).Button, obj4);
  obj.children = items1;
...
function LevelUpScreen(arg0) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp(11045), obj6);
  }
  ...
  if (tmp10Result2) {
    ...
    tmp10Result2 = tmp10(tmp4(4784).Text, obj11);
  }
...
const GiftingBadgeConstants = fn(11327);
