...
// Dependencies: [32, 19, 17, 2109, 7514, 13836, 1374, 1085, 21, 4788, 5773, 5690, 7683, 504, 1881, 5237, 13846, 1177, 1115, 4446, 5218, 2]
// Exports: default

// Module 13845 (PremiumPlanSelectYearlyUpsellModal)
...
const usePremiumPlanSelectStore = fn(13836).usePremiumPlanSelectStore;
...
obj2.header = obj3;
obj2.description = { alignSelf: "center", textAlign: "center", paddingBottom: 32, color: fn(5690).DARK_WHITE_500_LIGHT_BLACK_500 };
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  const premiumBundledItemsFromProductId = productId(7683).getPremiumBundledItemsFromProductId(productId);
  const obj2 = productId(7683);
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj9.planName = tmp5(4446).getPremiumTypeDisplayName(premiumTier);
    ...
    obj12.children = closure_11(tmp5(5218).Button, obj13);
    ...
    obj15.children = closure_11(tmp5(5218).Button, obj16);
    ...
    obj17.children = closure_11(tmp5(5218).Button, obj18);
