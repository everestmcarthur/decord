...
// Dependencies: [19, 17, 1074, 2038, 21, 4788, 576, 5235, 7656, 10263, 10527, 5941, 1115, 2582, 5218, 2]
// Exports: default

// Module 17420 (NitroFileUploadUpsellPromoSheet)
...
export default function NitroFileUploadUpsellPromoSheet(markAsDismissed) {
  ...
  obj2.title = intl.string(require("module_2582")["Uty2/X"]);
  const intl2 = markAsDismissed(callback[12]).intl;
  obj2.description = intl2.string(require("module_2582").VAgI8Q);
  ...
  obj4.text = intl3.string(require("module_2582").mRy6sO);
  let tmp9 = null;
  if (!loading) {
    tmp9 = callback2;
  }
