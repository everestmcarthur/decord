...
// Dependencies: [19, 17, 1085, 21, 4788, 576, 1115, 2614, 4784, 5218, 1177, 2]
// Exports: default

// Module 13246 (InAppReportsBottomButton)
  ...
  if (null == button) {
    ...
    if ("submit" === button.type) {
      ...
      if (null != tmp3) {
        ...
        tmp14Result = tmp14(tmp17(4784).Text, obj4);
      }
      ...
      items1[1] = React4(tmp17(5218).Button, obj5);
