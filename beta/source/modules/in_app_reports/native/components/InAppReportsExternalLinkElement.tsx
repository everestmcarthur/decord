...
// Dependencies: [17, 21, 4788, 7256, 4784, 1115, 8905, 5860, 13244, 4483, 2]
// Exports: default

// Module 13243 (InAppReportsExternalLinkElement)
...
function ExternalLinkItem(data) {
  ...
  if (data.is_localized) {
    ...
    const obj2 = { IconComponent: url(13244).LinkExternalMediumIcon };
    obj.trailing = closure_4(url(5860).TableRowIcon, obj2);
    obj.onPress = function onPress() {
      LinkingDefault.openURL(url);
    };
    tmp3 = closure_4(url(8905).RowButton, obj);
  }
  return tmp3;
}
