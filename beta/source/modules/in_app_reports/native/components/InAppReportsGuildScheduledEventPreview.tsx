...
// Dependencies: [19, 17, 2063, 21, 4788, 576, 504, 4637, 4784, 1115, 5833, 2]
// Exports: default

// Module 13229 (InAppReportsGuildScheduledEventPreview)
...
export default function GuildScheduledEventPreview(event) {
  ...
  if (null == stateFromStores) {
    ...
    const items1 = [closure_5(tmp2(4784).Text, obj3), ];
    const obj4 = { style: null, children: null };
    const items2 = [tmp.itemContainer, ];
    const obj5 = { borderColor: tmp2(4637).hexWithOpacity(tmp.borderColor.color, 0.08) };
    items2[1] = obj5;
    obj4.style = items2;
    const obj6 = { style: tmp.guildInfo, children: null };
    const obj7 = { guild: stateFromStores, size: null, selected: false };
    const hexWithOpacityResult = tmp2(4637).hexWithOpacity(tmp.borderColor.color, 0.08);
    obj7.size = tmp2(5833).GuildIconSizes.XXSMALL;
    ...
    items3[1] = closure_5(tmp2(4784).Text, obj8);
    ...
    items4[1] = closure_5(tmp2(4784).Text, obj9);
