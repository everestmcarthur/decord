...
// Dependencies: [32, 19, 17, 1390, 1074, 21, 1389, 4788, 576, 11192, 1391, 558, 15621, 4756, 15622, 1241, 4755, 7427, 15618, 5218, 1115, 14924, 10547, 2]
// Exports: default

// Module 15620 (DisplayNameStylesGummyColorPickerSheet)
...
import showGummyCustomColorSheetDefault from "showGummyCustomColorSheet" /* 15622 */;
...
export default function DisplayNameStylesGummyColorPickerSheet(selectedColors) {
  ...
  const displayNameStylesEffectConfig = selectedColors(11192).useDisplayNameStylesEffectConfig(selectedColors(1391).DisplayNameEffect.GUMMY);
  if (tmp5) {
  ...
  let obj = selectedColors(11192);
  const tmp11 = onSelectColors;
  const tmp12Result = onSelectColors(15621)(selectedColors(1391).DisplayNameEffect.GUMMY);
  ...
  const tmp12 = onSelectColors(15621);
  ...
  obj3.trailing = closure_9(selectedColors(5218).Button, obj4);
  obj2.header = closure_9(onSelectColors(15618), obj3);
  ...
  if (findIndexResult >= 0) {
    ...
    tmp18Result = tmp18(tmp11(14924), obj10);
  }
  const items4 = [tmp18Result, ];
  const obj11 = { style: tmp.customIconOverlay, pointerEvents: "none", children: null };
  const tmp19 = onSelectColors(15618);
  const tmp22 = first1;
  obj11.children = closure_9(closure_5, { style: tmp.customIconScrim, children: closure_9(selectedColors(10547).PencilIcon, { color: "white", size: "sm" }) });
  ...
  items6[1] = closure_9(selectedColors(5218).Button, obj13);
  obj5.children = items6;
  obj2.children = closure_10(closure_5, obj5);
  return closure_9(selectedColors(7427).BottomSheet, obj2);
};
