...
// Dependencies: [32, 19, 17, 21, 4788, 576, 8471, 15613, 15614, 4756, 4755, 7427, 15618, 1115, 2872, 5218, 5216, 11192, 11189, 11190, 2]
// Exports: default

// Module 15619 (DisplayNameStylesEffectPickerSheet)
...
export default function DisplayNameStylesEffectPickerSheet(userId) {
  ...
  const tmp = closure_9();
  let obj = userId(8471);
  const visibleEffectOrder = userId(15613).useVisibleEffectOrder();
  const obj2 = userId(15613);
  const displayNameStylesNewEffects = userId(15614).useDisplayNameStylesNewEffects(visibleEffectOrder);
  ...
  if (null != userId) {
    ...
    obj6.onPress = tmp8;
    obj5.trailing = closure_7(tmp2(5218).Button, obj6);
    obj4.header = closure_7(onSelectEffect(15618), obj5);
    ...
    obj8.children = closure_7(tmp2(5216).Stack, obj9);
    obj7.children = closure_7(closure_5, obj8);
    obj4.children = closure_7(closure_5, obj7);
    tmp9 = closure_7(tmp2(7427).BottomSheet, obj4);
    const tmp12 = onSelectEffect(15618);
  }
  return tmp9;
};
