...
// Dependencies: [19, 17, 1390, 21, 1391, 4788, 576, 1365, 11190, 5021, 10029, 1389, 5022, 10028, 4489, 11191, 4784, 4794, 4492, 11194, 1370, 2]

// Module 11189 (UsernameWithEffects)
...
export default noop.memo((userName) => {
  ...
  if (STATIC === undefined) {
    STATIC = userName(11190).EffectDisplayType.STATIC;
  }
  ...
  let num2;
  const tmp6 = num2(5021)({ userId, guildId, pendingDisplayNameStyles, ignoreDisabledStylesSetting });
  const isDisplayNameStylesFlywheelViewersEnabled = userName(10029).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  const obj = userName(10029);
  ...
  const displayNameStylesEnabled = userName(5022).useDisplayNameStylesEnabled({ location: "UsernameWithEffects" });
  const obj3 = userName(5022);
  const displayNameStylesFont = userName(10028).useDisplayNameStylesFont({ displayNameStyles: result, ignoreDisabledStylesSetting });
  let tmp12;
  ...
  const obj4 = userName(10028);
  const token = userName(4489).useToken(tmp4(576).colors.BACKGROUND_BASE_LOW);
  const tmp7Result = userName(4489);
  const token1 = userName(4489).useToken(tmp4(576).colors.WHITE);
  const tmp7Result7 = userName(4489);
  const displayNameStylesAccessibleColors = userName(11191).useDisplayNameStylesAccessibleColors({ displayNameStyles: result, backgroundColor: token });
  let first;
  ...
  const tmp7Result10 = userName(4794);
  const tmp20 = userName(4784).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
  ...
  if (displayNameStylesEnabled) {
    if (null != tmp6) {
      if (STATIC !== tmp7(11190).EffectDisplayType.PLAIN) {
        if (null != colorVariants) {
          ...
          if (effectId === tmp7(1391).DisplayNameEffect.GUMMY) {
            const tmp4Result = tmp4(11194);
            const tmp66 = closure_9;
            let str3 = tmp7(4492).getNodeText(userName);
            if (str3 == null) {
              str3 = "";
            }
            ...
            if (tmp7(1391).DisplayNameEffect.GRADIENT !== effectId) {
              if (tmp7(1391).DisplayNameEffect.PRISM !== effectId) {
                if (tmp7(1391).DisplayNameEffect.NEON === effectId) {
                  ...
                  if (null != colorVariants) {
                    ...
                    const items6 = [closure_9(tmp7(4784).Text, obj10), ];
                    const obj11 = {};
                    ...
                    items6[1] = closure_9(tmp7(4784).Text, obj11);
              ...
              return closure_9(tmp7(4784).Text, obj13);
            }
      ...
      return closure_9(tmp7(4784).Text, obj14);
    }
  }
  const obj15 = {};
  ...
  return closure_9(userName(4784).Text, obj15);
});
