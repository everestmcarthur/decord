...
// Function ID: 16859
// Name: CaughtUpRow
// Dependencies: [5, 32, 19, 17, 21, 4524, 4784, 16795, 576, 8654, 16812, 16808, 4646, 4789, 4489, 13333, 1115, 5218, 16834, 5230, 1094, 672, 2]
// Exports: default
...
let closure_9 = ReanimatedRexport.createAnimatedComponent(fn(4784).Text);
...
export default function ExploreServersRow(visible) {
  ...
  const sharedValue = visible(4524).useSharedValue(false);
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            dependencyMap(true);
            v1(8654).itemInteracted("caught_up", "caught_up", "press_explore");
            const obj5 = v1(8654);
  ...
  const callback1 = noop.useCallback(() => {
    sharedValue(8654).itemInteracted("caught_up", "caught_up", "press_home");
    const obj = sharedValue(8654);
    sharedValue(8654).feedItemActioned({ itemId: "caught_up", itemType: "caught_up", actionParameters: { actionGestureType: "press", actionTargetElement: "back_to_home_button", actionIntentType: "navigate", actionDestinationType: "guild_home" } });
    const obj2 = sharedValue(8654);
    const rootNavigationRef = visible(4646).getRootNavigationRef();
  ...
  let obj2 = visible(4524);
  E.__closure = { visibleSharedValue: sharedValue, withTiming: visible(4789).withTiming, Easing: visible(4524).Easing };
  E.__workletHash = 6575188656069;
  E.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(E);
  let obj3 = { visibleSharedValue: sharedValue, withTiming: visible(4789).withTiming, Easing: visible(4524).Easing };
  const fn = function b() {
    let num = 0;
    if (sharedValue.get()) {
  ...
  let obj4 = visible(4524);
  fn.__closure = { visibleSharedValue: sharedValue, withDelay: visible(4524).withDelay, withSequence: visible(4524).withSequence, withTiming: visible(4789).withTiming, Easing: visible(4524).Easing };
  fn.__workletHash = 469742746264;
  fn.__initData = __initData2;
  const animatedStyle1 = obj4.useAnimatedStyle(fn);
  let obj5 = { visibleSharedValue: sharedValue, withDelay: visible(4524).withDelay, withSequence: visible(4524).withSequence, withTiming: visible(4789).withTiming, Easing: visible(4524).Easing };
  ...
  let obj6 = visible(4524);
  fn2.__closure = { visibleSharedValue: sharedValue, withDelay: visible(4524).withDelay, withSequence: visible(4524).withSequence, withTiming: visible(4789).withTiming, Easing: visible(4524).Easing };
  fn2.__workletHash = 14933607481025;
  fn2.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(fn2);
  let obj7 = { visibleSharedValue: sharedValue, withDelay: visible(4524).withDelay, withSequence: visible(4524).withSequence, withTiming: visible(4789).withTiming, Easing: visible(4524).Easing };
  const token = visible(4489).useToken(sharedValue(576).colors.BACKGROUND_BRAND);
  const obj9 = { children: null };
  const obj10 = { style: tmp.container, children: null };
  const obj11 = { style: tmp.textContainer, children: null };
  const obj12 = { style: null, children: closure_7(visible(13333).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }) };
  const items1 = [tmp.iconWrapper, animatedStyle];
  obj12.style = items1;
  const items2 = [closure_7(sharedValue(4524).View, obj12), , ];
  ...
  const items6 = [closure_7(visible(5218).Button, obj17), ];
  ...
  items6[1] = closure_7(visible(5218).Button, obj18);
