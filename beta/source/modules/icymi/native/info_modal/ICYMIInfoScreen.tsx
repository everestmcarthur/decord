...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4788, 576, 5931, 1612, 4722, 1484, 8662, 16812, 4991, 8139, 8147, 1115, 5836, 16814, 16815, 16816, 16817, 4784, 9432, 13331, 4747, 4755, 16818, 1980, 5218, 2]
// Exports: default
...
let size = { position: "absolute", justifyContent: "center", left: 12, width: 24, height: fn(5931).NAV_BAR_HEIGHT, zIndex: 2 };
obj2.closeIcon = size;
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const ICYMIAnalytics = tmp2(8662).ICYMIAnalytics;
  ...
  obj2.style = items2;
  let obj3 = {
    source: navigation(8147),
    onPress() {
      return navigation(4991).pop();
    },
  ...
  obj2.children = closure_9(extendedOnboarding(8139).HeaderIconButton, obj3);
  ...
  const items5 = [closure_9(navigation(5836), obj5), ];
  const obj7 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5836);
  ...
  const items7 = [closure_9(navigation(5836), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj11 = { source: null, style: null };
  const obj10 = { source: { uri: tmp2Result }, style: tmp.headerImg };
  const tmp17 = navigation(5836);
  obj11.source = navigation(16817);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5836), obj11);
  ...
  items7[2] = closure_9(extendedOnboarding(4784).Text, obj12);
  ...
  items7[3] = closure_9(extendedOnboarding(4784).Text, obj13);
  ...
  const tmp2Result2 = navigation(5836);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9432).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = closure_9(extendedOnboarding(4784).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9432).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13331).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = closure_9(extendedOnboarding(4784).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13331).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj23 = { style: tmp.divider };
  const items12 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(4747).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = closure_9(extendedOnboarding(4784).Text, obj26);
  ...
  obj27.children = intl7.format(extendedOnboarding(1115).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(extendedOnboarding(4784).Text, {
  ...
  items13[1] = closure_9(extendedOnboarding(4784).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(5218).Button, obj30);
