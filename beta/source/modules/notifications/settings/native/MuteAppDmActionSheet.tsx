...
// Dependencies: [19, 17, 21, 4788, 576, 7427, 9906, 4784, 1115, 5218, 7396, 7391, 4755, 4486, 1177, 8239, 2]
// Exports: default

// Module 12881 (MuteAppDmActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj7.onPress = function onPress() {
    ...
    obj4.icon = function icon() {
      const obj = { style: closure_1_0.mutedNotificationContainer, children: closure_2_4(closure_0(1177).Icon, { source: channel(8239), color: channel(576).unsafe_rawColors.WHITE, style: closure_1_0.mutedNotification }) };
