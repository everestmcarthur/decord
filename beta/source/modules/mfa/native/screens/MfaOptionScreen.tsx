...
// Dependencies: [19, 17, 21, 7219, 15956, 7400, 5216, 4784, 15957, 7250, 2]
// Exports: default

// Module 15955 (MfaOptionScreen)
...
import MfaScreenUtilsDefault from "MfaScreenUtils" /* 15956 */;
...
export default function MFAOptionScreen(arg0) {
  ...
  if (tmp10Result5) {
    ...
    tmp10Result5 = tmp10(tmp(15957), obj8);
  }
