...
// Dependencies: [19, 17, 21, 4788, 576, 1177, 13007, 2]

// Module 16645 (InvitesDisabledBadge)
...
export default noop.memo(function InvitesDisabledBadge(style) {
  ...
  obj.style = items;
  const obj2 = { style: tmp.pauseBackground, children: jsx(native.ThemedIcon, { style: tmp.pause, themedColor: nativeDefault.colors.INTERACTIVE_TEXT_ACTIVE, source: _modDef13007 }) };
  obj.children = <View style={tmp.pauseBackground}>{jsx(native.ThemedIcon, { style: tmp.pause, themedColor: nativeDefault.colors.INTERACTIVE_TEXT_ACTIVE, source: _modDef13007 })}</View>;
