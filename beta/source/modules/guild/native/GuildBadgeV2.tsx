...
// Function ID: 9053
// Name: GuildBadgeV2
// Dependencies: [19, 21, 4788, 1177, 4639, 9053, 9055, 9054, 2]
// Exports: default, hasGuildBadge

// Module 9052 (GuildBadgeV2)
import native from "native" /* 1177 */;
import shared from "shared" /* 4639 */;
import GuildBadgeImageSource from "GuildBadgeImageSource" /* 9053 */;
...
export default function GuildBadgeV2(arg0) {
  ...
  if (null == guild) {
    ...
    const guildBadgeImageSource = tmp5(9053).getGuildBadgeImageSource(guild, tmp8);
    let tmp10 = null;
