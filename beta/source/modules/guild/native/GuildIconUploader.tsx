...
// Dependencies: [19, 17, 1182, 21, 4788, 576, 4498, 4639, 12082, 12083, 4784, 1115, 12084, 12085, 5371, 2]

// Module 12081 (GuildIconUploader)
...
import _modDef12085 from "module_12085" /* 12085 */;
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    if (obj6.isThemeDark(ThemeStore.theme)) {
      let tmp13Result = tmp13(12082);
    } else {
      tmp13Result = tmp13(12083);
    }
...
GuildIconUploader.contextType = fn(4498).ThemeContext;
size = fn(2);
