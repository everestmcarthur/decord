...
// Dependencies: [32, 19, 17, 4780, 21, 4788, 504, 4524, 4789, 672, 5913, 5230, 2]
...
export default function VibegrationsConjureShimmer(epoch) {
  ...
  let obj = tint(504);
  const tmp2 = tint;
  sharedValue = tint(4524).useSharedValue(0);
  if (live) {
  ...
  const animatedStyle = tmp2(4524).useAnimatedStyle(W);
  let obj4 = {
    style: tmp.root,
  ...
  if (live) {
    ...
    obj6.children = closure_8(width(4524).View, obj8);
