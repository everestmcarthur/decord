...
// Dependencies: [5, 32, 19, 17, 7971, 1182, 1074, 21, 4788, 576, 15386, 5696, 7969, 504, 7992, 17058, 4524, 4789, 15394, 11571, 7996, 11577, 4496, 5856, 4784, 1115, 3710, 5218, 2]
// Exports: default
...
export default function VibegrationsQuestPromptCard(open) {
  ...
  if (null != quest) {
    ...
    if (tmp2Result8.hasWatchVideoOnMobileTasks(quest)) {
      ...
      watchableQuestResult = tmp2(17058).watchableQuest(quest, obj3);
      const tmp2Result9 = tmp2(17058);
    }
    tmp2Result8 = tmp2(7992);
  }
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != tmp2) {
              const QUEST_BAR_MOBILE = tmp2(5696).QuestContent.QUEST_BAR_MOBILE;
              ...
              if (null == enrolledAt) {
                const obj5 = { questContent: tmp2(5696).QuestContent.QUEST_BAR_MOBILE, questContentCTA: tmp2(7996).QuestContentCTA.START_QUEST, sourceQuestContent: QUEST_BAR_MOBILE };
                dependencyMap = 1;
                c3 = 1;
                const obj6 = { value: tmp2(11571).enrollInQuest(tmp2.id, obj5), done: false };
                return obj6;
              } else {
          ...
          if (value.type === tmp2(11571).QuestEnrollmentResultType.SUCCESS) {
  ...
  if (tmp17) {
    if (null != tmp29) {
      const tmp2Result13 = tmp2(11577);
      const url = tmp2Result13.getQuestAsset(tmp29, tmp2(11577).QuestAssetType.GAME_TILE, tmp2(4496).isThemeDark(stateFromStores1) ? tmp38.DARK : tmp38.LIGHT).url;
      ...
      obj13.children = intl.string(_modDef3710["09LJ+I"]);
      const items7 = [closure_11(tmp2(4784).Text, obj13), ];
      ...
      items7[1] = closure_11(tmp2(4784).Text, obj14);
      ...
      obj18.text = intl3.string(_modDef3710.egO5fO);
      obj18.onPress = tmp31;
      obj17.children = closure_11(tmp2(5218).Button, obj18);
      ...
      obj19.children = closure_11(tmp2(5218).Button, obj20);
      ...
      obj5.children = closure_11(tmp2(5856).Card, obj11);
