...
// Dependencies: [19, 17, 21, 576, 4788, 17034, 4784, 4778, 17035, 2]
      ...
      children: memo.map((kind, index) => {
            if ("text" === kind.kind) {
              ...
              obj.children = items.map((children, index) => {
                ...
                obj.style = items;
                const obj3 = { style: list.marker, children: closure_2_5(source(4784).Text, { variant: "text-md/normal", color: "text-default", children: children.marker }) };
                const items1 = [closure_2_5(View, obj3), ];
                const obj5 = { style: list.itemText, children: null };
                const obj6 = { variant: "text-md/normal", color: "text-default", children: closure_1(4778).parse(children.text, true, obj2) };
                obj5.children = closure_2_5(source(4784).Text, obj6);
