...
// Dependencies: [19, 21, 17074, 1115, 3710, 17072, 17071, 2]
...
export const VibegrationsDebugAgentAnalyticsRows = function VibegrationsDebugAgentAnalyticsRows(analytics) {
  ...
  if ("ok" !== analytics.status) {
    ...
    obj2.label = intl4.string(_modDef3710.H6PMwW);
    const intl5 = util.intl;
    obj2.value = intl5.string(_modDef3710.TLOZ8J);
    ...
    if (null == found) {
      ...
      obj3.label = intl2.string(_modDef3710.H6PMwW);
      const intl3 = util.intl;
      obj3.hint = intl3.string(_modDef3710.uAzxdh);
      ...
      obj4.label = intl6.string(_modDef3710.awAqRi);
      ...
      if (null != analyticsMemoryValueResult) {
        ...
        obj.label = intl.string(tmp18(3710).WdGviA);
...
export const VibegrationsDebugWorkerAnalyticsSection = function VibegrationsDebugWorkerAnalyticsSection(analytics) {
  analytics = analytics.analytics;
  let intl = util.intl;
  const stringResult = intl.string(_modDef3710.Pgvj3h);
  if ("ok" !== analytics.status) {
    ...
    if (0 === found.length) {
      ...
      obj4.children = intl2.string(_modDef3710.uAzxdh);
      ...
      mapped1 = found.map((label) => {
        ...
        obj.value = intl.formatToPlainString(_modDef3710.AnRynJ, obj2);
