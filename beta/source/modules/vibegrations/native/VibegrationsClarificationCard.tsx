...
// Dependencies: [32, 19, 17, 21, 4788, 576, 17046, 4784, 1115, 3710, 5856, 5218, 6880, 2]
// Exports: default
...
export default function VibegrationsClarificationCard(clarification) {
  ...
  if (clarification.questions.length > 1) {
    ...
    obj3.children = intl.formatToPlainString(onSubmit(3710)["7bypa+"], obj4);
    tmp14 = closure_6(clarification(4784).Text, obj3);
  }
  const items4 = [tmp14, closure_6(clarification(4784).Text, { variant: "text-md/semibold", color: "text-default", children: clarification.questions[bound].question }), , ];
  ...
  if (bound > 0) {
    ...
    if (!tmp6) {
      ...
      obj7.text = intl2.string(onSubmit(3710).yKdgqw);
      obj7.onPress = callback1;
      tmp19Result = tmp19(tmp20(5218).Button, obj7);
    }
  }
  ...
  obj8.placeholder = intl3.string(onSubmit(3710).qifsdL);
  const intl4 = tmp20(1115).intl;
  obj8.accessibilityLabel = intl4.formatToPlainString(onSubmit(3710).XHESTL, { question: clarification.questions[bound].question });
  obj8.value = str;
  ...
  items5[1] = closure_6(clarification(6880).TextInput, obj8);
