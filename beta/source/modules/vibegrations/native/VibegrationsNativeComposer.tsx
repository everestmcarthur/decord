...
// Dependencies: [5, 32, 19, 17, 4780, 17064, 13390, 1074, 21, 576, 4788, 1115, 3710, 5307, 9342, 4489, 504, 5398, 11518, 4755, 17065, 12521, 16271, 15280, 4732, 12528, 4784, 5371, 6890, 8206, 11245, 8911, 4498, 2]
// Exports: default
...
import PlusLargeIcon from "PlusLargeIcon" /* 11245 */;
...
import StopIcon from "StopIcon" /* 16271 */;
...
function tooLargeText(contentType) {
  ...
  return intl.formatToPlainString(_modDef3710.cI7t94, obj);
}
...
export default function VibegrationsNativeComposer(projectId) {
  ...
  callback5 = obj.useCallback((arg0) => {
    ...
    if (0 !== arg0.length) {
      ...
      if (map.length > diff) {
        ...
        let obj = { count: null };
        VIBEGRATIONS_MAX_ATTACHMENTS_PER_MESSAGE = tmp16(5307).VIBEGRATIONS_MAX_ATTACHMENTS_PER_MESSAGE;
        obj.count = VIBEGRATIONS_MAX_ATTACHMENTS_PER_MESSAGE;
        _undefined4(intl.formatToPlainString(_modDef3710.DlX57a, obj));
        const _Math = Math;
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            const obj5 = { mediaType: "any", selectionLimit: tmp2(5307).VIBEGRATIONS_MAX_ATTACHMENTS_PER_MESSAGE, skipProcessing: true };
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp5(5398).launchImageLibraryAsync(obj5), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          c3 = 3;
  ...
  const memo = obj.useMemo(() => {
    ...
    const intl = util.intl;
    obj.label = intl.string(_modDef3710.xE6M2k);
    obj.action = callback6;
    const items = [obj, ];
    const obj2 = { label: null, action: null };
    const intl2 = util.intl;
    obj2.label = intl2.string(_modDef3710.DN7KeU);
  ...
  callback10 = obj.useCallback((key) => {
    if ("stop" === key.key) {
      ...
      const intl2 = util.intl;
      obj2.accessibilityLabel = intl2.string(_modDef3710.KdgI4k);
      ...
      const intl = util.intl;
      obj.accessibilityLabel = intl.string(_modDef3710["2NWMqY"]);
  ...
  const obj12 = {
    ...
    children: closure_13(require("ContextMenu").ContextMenu, {
      ...
      children(arg0) {
        ...
        const intl = util.intl;
        obj.accessibilityLabel = intl.string(_modDef3710.gUn10I);
