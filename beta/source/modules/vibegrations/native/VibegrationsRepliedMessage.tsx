...
// Dependencies: [19, 17, 21, 17024, 4788, 576, 17027, 4632, 16940, 1115, 3710, 1177, 4784, 17031, 2]
// Exports: default
...
export default function VibegrationsRepliedMessage(replied) {
  ...
  let str = replied(4632).useName(messageAuthorUser);
  if (str == null) {
    str = "";
  }
  ...
  obj3.accessibilityLabel = intl.formatToPlainString(_modDef3710.loFt7s, { name: str, content: trimmed });
  ...
  items1[2] = closure_6(replied(4784).Text, { variant: "text-xs/semibold", color: "text-default", style: tmp.name, lineClamp: 1, children: str });
  ...
  items1[3] = closure_7(replied(4784).Text, obj8);
