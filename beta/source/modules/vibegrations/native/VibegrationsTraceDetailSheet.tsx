...
// Dependencies: [19, 17, 9341, 21, 4788, 576, 4784, 1115, 3710, 17077, 17076, 1612, 504, 17078, 17082, 17083, 17080, 7474, 7426, 6901, 2]
// Exports: default
...
function FieldRow(field) {
  if (null != field.field.value) {
    ...
    if (null != iter.chars) {
      ...
      let formatToPlainStringResult = intl2.formatToPlainString(_modDef3710.DdXP0P, obj3);
    } else {
      formatToPlainStringResult = null;
      if (null != iter.items) {
        const intl = util.intl;
        const obj = { count: iter.items };
        formatToPlainStringResult = intl.formatToPlainString(_modDef3710.OB8Qvn, obj);
      }
    }
...
function RichEntries(arg0) {
  ...
  if (0 !== entries.length) {
    ...
    obj2.children = intl.string(_modDef3710.fy9PRy);
    let items = [
      ...
      entries.map((children) => {
          ...
          if (true === children.scrubbed) {
            ...
            const intl2 = util.intl;
            obj5.children = intl2.string(_modDef3710.PkIUHD);
          ...
          if (true !== children.truncated) {
            ...
            if (null == children.chars) {
              intl = util.intl;
              let stringResult = intl.string(_modDef3710["1kBG9Z"]);
            } else {
              const intl3 = util.intl;
              const obj6 = { count: children.chars };
              stringResult = intl3.formatToPlainString(_modDef3710.VGSwo4, obj6);
            }
...
export default function VibegrationsTraceDetailSheet(projectId) {
  ...
  const obj5 = { scrollable: true, header: closure_5(tmp2(7426).BottomSheetTitleHeader, { title: tmp12 }), children: null };
  ...
  items2[1] = closure_5(tmp2(4784).Text, obj10);
  ...
  if (null == findTraceEntryResult.durationMs) {
    ...
    let stringResult = intl.string(tmp5(3710).HpKDyl);
  } else {
  ...
  items2[2] = closure_5(tmp2(4784).Text, obj11);
  ...
  if (null != findTraceEntryResult.error) {
    ...
    tmp16Result = tmp16(tmp2(4784).Text, obj12);
  }
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      obj13.title = intl25.string(tmp5(3710).jXY3mm);
      ...
      if (null != traceRichStatusLabelResult) {
        ...
        tmp16Result19 = tmp16(tmp2(4784).Text, obj15);
      }
  ...
  if (traceDetailSectionsResult.includes("result")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      obj16.title = intl26.string(tmp5(3710).KXrf5F);
      const obj17 = { label: null, value: null };
      const intl27 = tmp2(1115).intl;
      obj17.label = intl27.string(tmp5(3710)["2Aii2k"]);
      ...
      obj17.value = intl28.formatToPlainString(tmp5(3710).DdXP0P, obj18);
      ...
      if (null != findTraceEntryResult.resultAdded) {
        ...
        obj19.label = intl2.string(tmp5(3710).hpGFzS);
      ...
      if (true === findTraceEntryResult.resultTruncated) {
        ...
        obj20.label = intl3.string(tmp5(3710)["UV2R1/"]);
        const intl4 = tmp2(1115).intl;
        obj20.value = intl4.string(tmp5(3710)["1kBG9Z"]);
  ...
  if (traceDetailSectionsResult.includes("usage")) {
    ...
    if ("model" === findTraceEntryResult.kind) {
      ...
      if (null != findTraceEntryResult.systemTokens) {
        ...
        obj25.label = intl7.string(tmp5(3710).vPIcyv);
        ...
        obj25.value = intl8.formatToPlainString(tmp5(3710).Qy2iTq, obj26);
      ...
      if (null != findTraceEntryResult.inputTokens) {
        ...
        obj27.label = intl9.string(tmp5(3710)["/703Yk"]);
      ...
      if (null != findTraceEntryResult.outputTokens) {
        ...
        obj28.label = intl10.string(tmp5(3710)["6+W0dJ"]);
      ...
      if (null != findTraceEntryResult.cacheReadTokens) {
        ...
        obj29.label = intl11.string(tmp5(3710).VyAl6j);
        ...
        obj29.value = intl12.formatToPlainString(tmp5(3710).lkMc23, obj30);
      ...
      if (null != findTraceEntryResult.costUsd) {
        ...
        obj31.label = intl13.string(tmp5(3710).l9YFEQ);
      ...
      obj32.children = intl14.string(tmp5(3710).F9jaUF);
      items6[6] = tmp16(tmp2(4784).Text, obj32);
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    obj33.children = intl15.string(tmp5(3710)["ppv+97"]);
    let tmp16Result29 = tmp16(tmp2(4784).Text, obj33);
  } else {
    tmp16Result29 = null;
  }
  ...
  if (traceDetailSectionsResult.includes("diagnostics")) {
    ...
    obj34.title = intl16.string(tmp5(3710).T7SFyZ);
    if (null == findTraceEntryResult1) {
      ...
      if (length > 0) {
        ...
        obj35.label = intl18.string(tmp5(3710).fI6mzD);
        const intl19 = tmp2(1115).intl;
        const obj36 = { count: length };
        obj35.value = intl19.formatToPlainString(tmp5(3710).hO8FYp, obj36);
      ...
      if (null != findTraceEntryResult.turnId) {
        ...
        obj37.label = intl20.string(tmp5(3710).I7cJP0);
      ...
      obj38.label = intl21.string(tmp5(3710)["XVTP/S"]);
      ...
      if (null != formatClockTimeResult) {
        ...
        obj39.label = intl22.string(tmp5(3710).rD7bm0);
      ...
      if ("model" === findTraceEntryResult.kind) {
        ...
        if (null != findTraceEntryResult.stopReason) {
          ...
          obj41.label = intl23.string(tmp5(3710).rxmzYT);
      ...
      if ("tool" === findTraceEntryResult.kind) {
        ...
        if (null != findTraceEntryResult.schema) {
          ...
          if (findTraceEntryResult.schema.length > 0) {
            ...
            obj43.children = intl24.string(tmp5(3710)["6oILKx"]);
            const items8 = [tmp16(tmp2(4784).Text, obj43), ];
      ...
      obj44.label = intl17.string(tmp5(3710).NnBqcd);
  ...
  obj5.children = closure_5(tmp2(6901).BottomSheetScrollView, obj6);
  return closure_5(tmp2(7474).ActionSheet, obj5);
};
