...
// Dependencies: [19, 17, 21, 4788, 576, 4755, 17048, 4784, 1115, 3710, 5218, 2]
// Exports: default
...
export default function VibegrationsSecretRequestCard(projectId) {
  ...
  obj2.children = intl.string(request(3710)["/e28TK"]);
  const items1 = [closure_5(projectId(4784).Text, obj2), , , ];
  if (null != request.note) {
    ...
    obj5.text = intl3.string(tmp8(3710)["gVV+HX"]);
    items1[3] = tmp5(tmp6(5218).Button, obj5);
    obj.children = items1;
    return closure_6(tmp4, obj);
  }
  const intl2 = tmp6(1115).intl;
  note = intl2.string(tmp8(3710).jxvtin);
};
