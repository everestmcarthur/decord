...
// Dependencies: [19, 17, 21, 4788, 576, 4784, 1115, 3710, 17071, 5218, 2]
...
export const DebugSnapshotToolbar = function DebugSnapshotToolbar(onRefresh) {
  ...
  if ("loading" === fetchState) {
    ...
    obj3.children = intl2.string(_modDef3710["K+FvtM"]);
    ...
    if (null != generatedAt) {
      ...
      obj4.children = intl.formatToPlainString(_modDef3710["4NpaEk"], obj6);
  ...
  obj7.text = intl3.string(_modDef3710.aw0IJm);
