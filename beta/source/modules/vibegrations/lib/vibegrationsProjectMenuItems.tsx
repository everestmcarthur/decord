...
export const previewMenuItems = function previewMenuItems(canRefresh) {
  ...
  if (canRefresh.canRefresh) {
    ...
    obj.label = intl.string(_modDef3710["8oRfMw"]);
    obj.disabled = tmp;
    items.push(obj);
  }
  ...
  while (iter !== undefined) {
    ...
    if ("authorize" === nextResult.offer) {
      ...
      obj2.label = intl2.formatToPlainString(_modDef3710.JXACNA, obj3);
      ...
      obj4.label = intl3.formatToPlainString(_modDef3710.JMd7xW, obj5);
