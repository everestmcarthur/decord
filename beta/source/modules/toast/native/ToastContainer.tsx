...
// Function ID: 17429
// Name: ToastContainer
// Dependencies: [19, 4780, 17429, 21, 4788, 5690, 4524, 1478, 15361, 1612, 504, 5203, 15370, 5217, 4498, 4499, 17430, 1177, 4486, 2]

// Module 17428 (ToastContainer)
...
import ToastStore from "ToastStore" /* 17429 */;
...
function AnimatedToast(toast) {
  ...
  let fn = function p() {
    ...
    if (stateFromStores) {
      ...
      value2 = tmp8(5217).withSpring(obj2.get(), closure_10);
      const tmp8Result = tmp8(5217);
    }
    const obj3 = { opacity: value2, transform: null, maxWidth: null };
    let withSpringResult = interpolateResult;
    if (!stateFromStores) {
      const tmp8Result2 = tmp8(5217);
      ...
      obj4 = { state, TransitionStates: tmp8(4498).TransitionStates, runOnJS: tmp8(4524).runOnJS, cleanUp };
      fn.__closure = obj4;
...
let obj = { container: { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5690).TOAST_CONTAINER_SHADOW_COLOR } };
...
let obj3 = { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5690).TOAST_CONTAINER_SHADOW_COLOR };
let size = fn(2);
...
export default noop.memo(() => {
  ...
  return jsx(stateFromStoresArray(4498).TransitionGroup, { items: stateFromStoresArray, renderItem, getItemKey, wrapChildren });
});
