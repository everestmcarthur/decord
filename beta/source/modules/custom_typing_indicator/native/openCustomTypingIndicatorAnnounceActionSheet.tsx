...
// Dependencies: [4755, 12251, 1980, 2]
// Exports: openCustomTypingIndicatorAnnounceActionSheet

// Module 12250 (openCustomTypingIndicatorAnnounceActionSheet)
...
export const openCustomTypingIndicatorAnnounceActionSheet = function openCustomTypingIndicatorAnnounceActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12251, dependencyMap.paths), CustomTypingIndicatorAnnounceActionSheet, {
    markAsDismissed() {
