...
// Dependencies: [32, 19, 17, 21, 4788, 576, 5856, 4784, 1380, 1115, 3712, 7474, 12263, 5216, 2]
// Exports: default

// Module 15635 (CustomTypingIndicatorAnimationPickerSheet)
...
export default function CustomTypingIndicatorAnimationPickerSheet(onChange) {
  ...
  obj7.config = obj8;
  obj6.children = closure_6(animation(12263), obj7);
  ...
  items1[1] = closure_6(onChange(5216).Stack, obj9);
  obj5.children = items1;
  return closure_7(onChange(7474).ActionSheet, obj5);
};
