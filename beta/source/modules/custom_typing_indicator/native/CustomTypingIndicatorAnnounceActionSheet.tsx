...
// Dependencies: [19, 17, 1074, 2038, 21, 4788, 576, 7656, 7427, 7400, 7431, 12252, 1380, 12254, 12255, 12256, 12257, 12258, 12259, 12260, 1177, 1115, 4784, 3712, 5218, 2]
// Exports: default

// Module 12251 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_7(markAsDismissed(7431).ActionSheetHeaderBar, {
      onPress() {
  ...
  const items5 = [ref(12254), ref(12255), ref(12254)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12252), obj7);
  ...
  obj13.children = intl2.string(ref(3712).uGxDiu);
  items3[3] = closure_7(markAsDismissed(4784).Text, obj13);
  const obj14 = { variant: "text-md/normal", style: tmp2.body, color: "text-muted", children: null };
  const intl3 = markAsDismissed(1115).intl;
  obj14.children = intl3.string(ref(3712).yezU3E);
  items3[4] = closure_7(markAsDismissed(4784).Text, obj14);
  ...
  obj16.text = intl4.string(ref(3712).TswY68);
  obj16.onPress = callback;
  const items11 = [closure_7(markAsDismissed(5218).Button, obj16), ];
  ...
  items11[1] = closure_7(markAsDismissed(5218).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7400).SafeAreaPaddingView, obj2);
  return closure_7(markAsDismissed(7427).BottomSheet, obj);
};
