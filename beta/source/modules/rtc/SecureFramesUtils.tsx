...
// Dependencies: [32, 5, 502, 1992, 4811, 4827, 1372, 10003, 10004, 1074, 2108, 10005, 10013, 9987, 10006, 1115, 4632, 4380, 1091, 38, 206, 1271, 1231, 5140, 4940, 2]
...
// Module 10002 (SecureFramesUtils)
...
export const deleteVerification = function deleteVerification(userId, arg1, isOtherUserKeyPersistent) {
  if (isOtherUserKeyPersistent) {
    ...
    const serializeKeyResult = _mod9987.serializeKey(uint8Array);
...
export const getSecureFramesUserVerifiedTimestamp = function getSecureFramesUserVerifiedTimestamp(timestamp) {
  const tmp3 = _modDef4380(timestamp);
  const diffResult = _modDef4380().diff(tmp3, "s");
