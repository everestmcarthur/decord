...
// Dependencies: [19, 17, 8723, 21, 4788, 12172, 1115, 12170, 12190, 4784, 12184, 2]
// Exports: default

// Module 12189 (AppealIngestionRequestSent)
import AppealIngestionExternalLinkDefault from "AppealIngestionExternalLink" /* 12184 */;
...
export default function AppealIngestionRequestSent() {
  ...
  const items = [closure_7(closure_4, { source: _modDef12190, style: tmp.checkboxPng }), closure_7(require("AppealIngestionModal").AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: stringResult1 }), , , ];
  ...
  const obj4 = { source: _modDef12190, style: tmp.checkboxPng };
