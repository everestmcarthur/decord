...
// Dependencies: [32, 19, 17, 1372, 8734, 8723, 21, 8724, 15051, 4788, 576, 1115, 15043, 4747, 6884, 9745, 6890, 7215, 504, 1397, 9124, 1177, 4784, 2]
// Exports: default

// Module 15050 (SafetyHubAccountStanding)
...
import SafetyHubAccountStandingLabels from "SafetyHubAccountStandingLabels" /* 15043 */;
...
let obj = { [fn(8724).AccountStandingState.ALL_GOOD]: { left: "0%" } };
let obj2 = { left: "25%", transform: null };
let items = [{ translateX: -0.5 * fn(15051).SUBWAY_MARKER_WIDTH }];
obj2.transform = items;
obj[fn(8724).AccountStandingState.LIMITED] = obj2;
let obj4 = { left: "50%", transform: null };
let obj3 = { translateX: -0.5 * fn(15051).SUBWAY_MARKER_WIDTH };
let items1 = [{ translateX: -0.5 * fn(15051).SUBWAY_MARKER_WIDTH }];
obj4.transform = items1;
obj[fn(8724).AccountStandingState.VERY_LIMITED] = obj4;
let obj6 = { left: "75%", transform: null };
let obj5 = { translateX: -0.5 * fn(15051).SUBWAY_MARKER_WIDTH };
let items2 = [{ translateX: -0.5 * fn(15051).SUBWAY_MARKER_WIDTH }];
obj6.transform = items2;
obj[fn(8724).AccountStandingState.AT_RISK] = obj6;
let obj8 = { left: "100%", transform: null };
let obj7 = { translateX: -0.5 * fn(15051).SUBWAY_MARKER_WIDTH };
let items3 = [{ translateX: -fn(15051).SUBWAY_MARKER_WIDTH }];
obj8.transform = items3;
obj[fn(8724).AccountStandingState.SUSPENDED] = obj8;
...
const obj9 = { translateX: -fn(15051).SUBWAY_MARKER_WIDTH };
...
export default function SafetyHubAccountStanding() {
  ...
  const items5 = [closure_9(accountStanding(4784).Text, obj8), closure_9(accountStanding(4784).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
