...
// Dependencies: [19, 17, 8734, 8723, 21, 4788, 576, 1115, 504, 1612, 12167, 8714, 8716, 4755, 7427, 6901, 4784, 5936, 5854, 4483, 5218, 12165, 2]
// Exports: default

// Module 12168 (AutomatedUnderageAppealActionSheet)
...
import SafetyHubActionCreators from "SafetyHubActionCreators" /* 12165 */;
...
export default function AutomatedUnderageAppealActionSheet(onClose) {
  ...
  const items5 = [closure_8(onClose(4784).Text, obj8), ];
  ...
  items5[1] = closure_8(onClose(4784).Text, obj9);
  obj7.children = items5;
  const items6 = [closure_9(callback, obj7), , , ];
  const obj10 = { children: null };
  let obj2 = onClose(504);
  obj10.children = closure_8(onClose(5936).TableRowGroup, {
    hasIcons: true,
  ...
  obj12.children = closure_8(onClose(5936).TableRowGroup, obj13);
  ...
  const items7 = [closure_8(onClose(5218).Button, obj16), ];
  ...
  items7[1] = closure_8(onClose(4784).Text, obj17);
  obj15.children = items7;
  items6[3] = closure_9(callback, obj15);
  obj5.children = items6;
  obj4.children = closure_9(callback, obj5);
  obj3.children = closure_8(onClose(6901).BottomSheetScrollView, obj4);
  return closure_8(onClose(7427).BottomSheet, obj3);
};
