...
// Dependencies: [19, 8734, 8723, 504, 11, 8722, 8724, 12165, 2]
...
// Module 12164 (useSafetyHubClassifications)
...
require = fn;
const ViolationType = fn(8723).ViolationType;
const size = fn(2);
...
export const useSafetyHubClassification = function useSafetyHubClassification(classificationId) {
  ...
  if (obj5.isGuildClassification(stateFromStores)) {
    ...
    if (member_type === tmp(8724).MemberType.OWNER) {
