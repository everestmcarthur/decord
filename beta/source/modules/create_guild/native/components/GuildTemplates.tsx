...
// Function ID: 12993
// Name: GuildTemplates
// Dependencies: [32, 19, 17, 12989, 7255, 1074, 21, 4788, 5931, 576, 4784, 1115, 1484, 1612, 5218, 12965, 1241, 12607, 12993, 7400, 5936, 2]
// Exports: default

// Module 12992 (GuildTemplates)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import Text_Text from "Text/Text" /* 4784 */;
import ListSelectionItemDefault from "ListSelectionItem" /* 12607 */;
import NewUserAnalyticsUtils from "NewUserAnalyticsUtils" /* 12965 */;
import CreateGuildIcons from "CreateGuildIcons" /* 12993 */;
...
function GuildTemplatesJoinFooter(trigger) {
  ...
  const items2 = [
    closure_14(trigger(4784).Text, obj4),
    closure_14(trigger(5218).Button, {
      variant: "primary",
      grow: true,
      text: stringResult,
      onPress() {
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5931).NAV_BAR_HEIGHT }, scrollContainer: null, sections: null, headerContainer: null, headerTitle: null, headerDescription: null, footerSafeAreaContainer: null, footerContainer: null, footerTitle: null };
let obj3 = { marginTop: fn(5931).NAV_BAR_HEIGHT };
