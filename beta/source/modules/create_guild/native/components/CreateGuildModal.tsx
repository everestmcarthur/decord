...
// Dependencies: [19, 17, 2096, 7255, 1074, 21, 12757, 10121, 1241, 5769, 12990, 1249, 5873, 12992, 12994, 12616, 1115, 12995, 8139, 12997, 12998, 13009, 8178, 7277, 2]
// Exports: default

// Module 12991 (CreateGuildModal)
import discord_common_AnalyticsUtils from "discord_common/AnalyticsUtils" /* 1249 */;
import NavigatorHeader from "NavigatorHeader" /* 5873 */;
import CreateGuildModalActionCreatorsDefault from "CreateGuildModalActionCreators" /* 12990 */;
...
export default function CreateGuildModal(channel) {
  ...
  obj2.screens = isWindowSmall.useMemo(() => {
    ...
    let obj2 = {
      ...
      render() {
        return closure_1_10(closure_1(12992), { trigger: constants2.IN_APP });
      }
    };
    ...
    impressionProperties[constants.CREATION_INTENT] = {
      ...
      render(guildTemplate) {
        return closure_1_10(closure_1(12994), { guildTemplate: guildTemplate.guildTemplate, trigger: constants2.IN_APP });
      }
    };
    let obj4 = {
      impressionName: discord_common_AnalyticsUtils.ImpressionNames.GUILD_ADD_INTENT_SELECTION,
    ...
    impressionProperties[constants.CREATE_SERVER] = {
      ...
      render(arg0, arg1) {
        ...
        obj.onCreate = function onCreate(guild) {
          ...
          const guildProgress = closure_0(12757).createGuildProgress(id);
          defaultChannel = defaultChannel.getDefaultChannel(id);
          if (null != defaultChannel) {
            closure_1(10121).init(id, defaultChannel.id, { location: "Guild Create Flow" });
            const obj3 = { guildId: id };
            closure_0.push(constants.GUILD_INVITE, obj3);
            const obj2 = closure_1(10121);
        ...
        return closure_10(closure_1(12616), obj);
      }
    };
    const obj5 = {
      impressionName: discord_common_AnalyticsUtils.ImpressionNames.GUILD_ADD_CUSTOMIZE,
    ...
    impressionProperties[constants.GUILD_INVITE] = {
      ...
      render(guildId) {
        ...
        return closure_1_10(closure_1(12995), {
    ...
    impressionProperties[constants.JOIN_SERVER] = {
      ...
      headerTitle: isWindowSmall ? (() => {
        ...
        return closure_1_10(initialRoute(8139).GenericHeaderTitle, obj);
      }) : (() => null),
      render(arg0) {
    ...
    impressionProperties[constants.ACCEPT_INVITE] = {
      ...
      render(code) {
        const obj = { code: code.code, onPressClose: closure_1(12990).closeCreateGuildModal };
        return closure_1_10(closure_1(12998), obj);
      }
    };
    const obj9 = {
      ...
      render() {
        return closure_1_10(closure_1(13009), { isNestedNavigator: true });
      }
    };
