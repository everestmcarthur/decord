...
// Dependencies: [32, 19, 17, 1372, 2038, 21, 2027, 4788, 576, 9519, 504, 4446, 7662, 1115, 11423, 2]
// Exports: default

// Module 11422 (useBurstToggleCoachmark)
...
export default function useBurstToggleCoachmark(targetRef) {
  ...
  obj2 = first(4446);
  const tmp5 = _slicedToArray(first(7662).useSelectedDismissibleContent(items2), 2);
  first = tmp5[0];
  closure_1 = tmp7;
