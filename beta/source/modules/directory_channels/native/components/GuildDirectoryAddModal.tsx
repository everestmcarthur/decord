...
// Dependencies: [19, 12593, 21, 4788, 5931, 1249, 5873, 12591, 12594, 12602, 12606, 12616, 7400, 5847, 7277, 1115, 2]
// Exports: GuildDirectoryAddModalScreen, default

// Module 12592 (GuildDirectoryAddModal)
  ...
  ({ screens, initialStack } = useInitialValueDefault(() => {
    ...
    const obj5 = {
      ...
      render(arg0) {
        ...
        return closure_1_4(closure_1_1(12594), {});
      }
    };
    ...
    obj4[GuildDirectoryCreate.DESCRIPTION] = {
      ...
      render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_4(closure_1_1(12602), {});
      }
    };
    const obj7 = {
      fullscreen: true,
    ...
    obj4[GuildDirectoryCreate.TEMPLATES] = {
      ...
      render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_4(closure_1_1(12606), {});
      }
    };
    const obj8 = {
      fullscreen: true,
    ...
    obj4[GuildDirectoryCreate.CREATE] = {
      ...
      render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_4(closure_1_1(12616), {});
      }
    };
    obj3.screens = obj4;
