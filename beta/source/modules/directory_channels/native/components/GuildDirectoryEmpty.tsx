...
// Dependencies: [19, 17, 2096, 1074, 21, 4788, 576, 1612, 504, 12590, 13037, 1177, 1115, 4784, 8903, 12591, 13038, 10115, 13039, 2]
// Exports: default

// Module 13036 (GuildDirectoryEmpty)
...
export default function GuildDirectoryEmpty(guild) {
  ...
  items2[2] = closure_7(guild(4784).Text, obj8);
  let tmp8Result = null;
  if (canCreateOrAddGuildInDirectory) {
    const obj9 = {
      ...
      iconSource: tmp2(13038),
      title: null
    };
    const intl3 = tmp4(1115).intl;
    obj9.title = intl3.string(tmp4(1115).t.hyK15i);
    tmp8Result = tmp8(tmp4(8903).FormCTA, obj9);
  }
  items2[3] = tmp8Result;
  const obj10 = {
    style: tmp.ctaContainer,
    ...
    iconSource: channel(13039),
    title: null
  };
  const intl4 = tmp4(1115).intl;
  obj10.title = intl4.string(guild(1115).t.L4bwJ9);
  items2[4] = closure_7(guild(8903).FormCTA, obj10);
