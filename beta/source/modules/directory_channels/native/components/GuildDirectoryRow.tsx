...
// Dependencies: [5, 32, 19, 17, 2041, 2063, 1074, 21, 4788, 576, 504, 7616, 5769, 10125, 1186, 1397, 1115, 5856, 5833, 2055, 4784, 12596, 5218, 2]

// Module 12618 (GuildDirectoryRow)
import nativeDefault from "native" /* 576 */;
import AvatarUtilsDefault from "AvatarUtils" /* 1397 */;
import GuildIconDefault from "GuildIcon" /* 5833 */;
import GuildDirectoryMoreMenuDefault from "GuildDirectoryMoreMenu" /* 12596 */;
...
export default noop.memo(function GuildDirectoryRow(entry) {
  ...
  const items2 = [closure_10(entry(4784).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: entry.name }), ];
  ...
  if (null != approximatePresenceCount) {
    ...
    items3[1] = tmp9(tmp2(4784).Text, obj13);
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(4784).Text, obj20);
  }
  items7[1] = tmp9Result;
  ...
  items7[3] = closure_10(entry(5218).Button, obj22);
  obj5.children = items7;
  obj4.children = closure_12(View, obj5);
  return closure_10(entry(5856).Card, obj4);
});
