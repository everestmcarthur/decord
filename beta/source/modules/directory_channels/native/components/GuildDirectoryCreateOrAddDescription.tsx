...
// Dependencies: [5, 19, 17, 21, 4788, 12603, 2055, 12604, 12591, 12592, 4784, 1115, 12600, 2]
// Exports: default

// Module 12602 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const items = [closure_6(directoryChannelId(4784).Text, obj4), ];
  ...
  items[1] = closure_6(directoryChannelId(4784).Text, obj5);
  obj3.children = items;
  ...
  return closure_6(directoryChannelId(12592).GuildDirectoryAddModalScreen, obj);
};
