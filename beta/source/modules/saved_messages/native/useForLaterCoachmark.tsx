...
// Dependencies: [32, 19, 17, 2038, 21, 2027, 4788, 13630, 8130, 7662, 1115, 11423, 2]
// Exports: default
...
function CoachmarkImg() {
  const obj = { source: _modDef13630, style: closure_9().imageContainer };
  return <Image source={_modDef13630} style={closure_9().imageContainer} />;
}
...
export default function useForLaterCoachmark(targetRef) {
  ...
  obj = first(8130);
  const tmp4 = _slicedToArray(first(7662).useSelectedDismissibleContent(items1, undefined, true), 2);
  first = tmp4[0];
  closure_1 = tmp6;
  ...
  const coachmark = first(11423).useCoachmark(targetRef, memo);
  return tmp4[1];
};
