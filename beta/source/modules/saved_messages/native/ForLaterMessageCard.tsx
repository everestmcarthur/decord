...
// Dependencies: [5, 19, 17, 4427, 1074, 21, 4788, 576, 5856, 6884, 4784, 1115, 8211, 4746, 11986, 11993, 4991, 1241, 8136, 4380, 13623, 504, 13624, 13627, 12497, 12498, 2]

// Module 13622 (ForLaterMessageCard)
...
export default noop.memo(function ForLaterMessageCard(savedMessage) {
  ...
  const savedMessageChannel = savedMessage(11993).useSavedMessageChannel(savedMessage);
                ...
                try {
                  ...
                  if (0 === c1) {
                    if (arg0 === 1) {
                      ...
                      c1 = 1;
                      c2 = 1;
                      const obj5 = { value: v3(11993).savedMessageJumpToMessage(tmp4, c1), done: false };
                      return obj5;
                    }
                  } else if (arg0 === 1) {
                    c2 = 3;
                    ...
                    if (null != tmp4.saveData.dueAt) {
                      let BOOKMARK = v3(8136).SavedMessageSortTypes.REMINDER;
                    } else {
                      BOOKMARK = v3(8136).SavedMessageSortTypes.BOOKMARK;
                    }
                    obj8.type = BOOKMARK;
                    let diffResult;
                    if (null != tmp4.saveData.dueAt) {
                      diffResult = v1(4380)().diff(tmp4.saveData.dueAt);
                      const obj = v1(4380)();
                    }
  ...
  if (null != savedMessage.message) {
    if (null != savedMessageChannel) {
      if (obj2.useStateFromStores(items1, () => {
        ...
        const tmp8 = closure_10(savedMessageChannel(13624), obj3);
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          tmp6Result = tmp6(tmp2(13627).ForLaterCardReminderHeader, obj5);
        }
        ...
        obj6.actions = tmp12;
        items2[1] = closure_10(tmp2(12497).ForLaterCardHeader, obj6);
        ...
        items2[3] = closure_10(tmp2(12498).ForLaterMessageRow, obj8);
