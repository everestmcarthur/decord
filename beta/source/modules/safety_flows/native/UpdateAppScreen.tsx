...
// Dependencies: [17, 21, 4788, 576, 4784, 1115, 2776, 5218, 2]
// Exports: default

// Module 18339 (UpdateAppScreen)
...
export default function UpdateAppScreen() {
  ...
  obj5.text = intl3.string(_modDef2776.o4D6fm);
