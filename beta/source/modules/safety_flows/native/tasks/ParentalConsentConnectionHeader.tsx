...
// Dependencies: [19, 17, 1372, 21, 4788, 5931, 576, 1612, 504, 4784, 6866, 1115, 2776, 2]
// Exports: ParentalConsentConnectionNavbar

// Module 18341 (ParentalConsentConnectionHeader)
...
let obj2 = { row: { height: fn(5931).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 }, logOut: null };
let obj3 = { height: fn(5931).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 };
