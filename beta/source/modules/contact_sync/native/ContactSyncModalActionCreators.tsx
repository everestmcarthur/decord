...
// Dependencies: [5, 5530, 1372, 12959, 12961, 12960, 1074, 4997, 12962, 12964, 1241, 12966, 1115, 5141, 4486, 9653, 7322, 4688, 4991, 12967, 1980, 10115, 1094, 12986, 2]
...
// Module 12958 (ContactSyncModalActionCreators)
import ConstantsIOS from "ConstantsIOS" /* 1094 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1980 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4991 */;
import PhoneActionCreatorsDefault from "PhoneActionCreators" /* 7322 */;
...
import ContactSyncAnalyticsUtils from "ContactSyncAnalyticsUtils" /* 12964 */;
...
function closeContactSyncModal(skip) {
  ...
  if (null != onComplete) {
    ...
    flag2(12964).trackFlowEnd(flag, obj2);
    if (tmp16) {
      onComplete(flag);
    } else {
    ...
    if (!back) {
      ...
      flag2(12964).trackFlowEnd(flag2, obj4);
      const obj = flag2(12964);
    }
    if (tmp2) {
      let updateAnimation = back(4991).updateAnimation;
    ...
    const timerId1 = setTimeout(() => {
      ...
      if (closure_2) {
        ...
        if (back) {
          ...
          const result = tmp7(12986).previousOnboardingStep();
          const tmp7Result = tmp7(12986);
        } else {
          updateAnimation(tmp3, ModalAnimation.SLIDE_IN_OUT);
          const obj2 = { skip: flag2 };
          tmp7(12986).nextOnboardingStep(obj2);
          const tmp7Result2 = tmp7(12986);
        }
...
export const openContactSyncModal = function openContactSyncModal(initialRoutes, FRIENDS_ADD_FRIENDS_MODAL, arg2) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12967, tmp2.paths), { initialRoutes: initialRoutes.initialRoutes, openSettingsSheet: initialRoutes.openSettings, customLandingPage: initialRoutes.customLandingPage }, closure_1_20).then(arg2);
};
...
export const openContactSyncModalDeeplink = function openContactSyncModalDeeplink() {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12967, tmp2.paths), { initialRoutes: obj.initialRoutes, openSettingsSheet: obj.openSettings, customLandingPage: obj.customLandingPage }, closure_1_20).then(undefined);
};
