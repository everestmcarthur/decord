...
// Dependencies: [19, 17, 1372, 1074, 21, 4788, 576, 504, 5836, 12983, 4784, 1115, 5218, 1241, 4632, 8664, 2]
// Exports: default

// Module 12982 (ContactSyncInviteFriends)
...
const UserUtilsDefault = tmp(4632);
const showShareActionSheet = tmp5(8664);
require = fn;
