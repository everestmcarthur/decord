...
// Dependencies: [32, 19, 17, 21, 4788, 576, 7258, 1115, 4784, 1177, 5218, 12976, 2]
// Exports: default

// Module 12979 (ContactSyncNameInput)
...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  const items1 = [timestampProducer(tmp9(4784).Text, obj3), , , , ];
  ...
  items1[1] = timestampProducer(tmp9(4784).Text, obj4);
  ...
  items1[2] = timestampProducer(tmp9(4784).Text, obj5);
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4784).Text, obj7);
  }
  ...
  items2[1] = timestampProducer(tmp9(5218).Button, {
    variant: "primary",
    size: str,
    text: stringResult,
    onPress() {
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(5218).Button, obj10);
