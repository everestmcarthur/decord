...
// Function ID: 12667
// Name: DiceRollBar
// Dependencies: [19, 17, 4780, 12241, 21, 4788, 576, 504, 4524, 4789, 1177, 12667, 9145, 4784, 2]
// Exports: default

// Module 12666 (DiceRollBar)
...
const useDiceRollState = fn(12241).useDiceRollState;
const jsxProd = fn(21);
