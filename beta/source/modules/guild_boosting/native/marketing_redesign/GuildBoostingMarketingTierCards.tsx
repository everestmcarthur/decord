...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 9069, 1115, 10409, 12815, 5351, 5347, 10676, 13880, 9517, 4730, 13882, 4788, 576, 13874, 5690, 4524, 4789, 4784, 4722, 4639, 5230, 5371, 4681, 13883, 13885, 4637, 1177, 13887, 13888, 5830, 12847, 2]
// Exports: default

// Module 13879 (GuildBoostingMarketingTierCards)
...
import ServerBoostStreamQualityMarketingExperiment from "ServerBoostStreamQualityMarketingExperiment" /* 13882 */;
...
let items = [
  {
    orderCollapsed: 0,
    isIncluded: true,
    IconComponent: fn(9069).ReactionIcon,
    getCopy() {
...
items[1] = {
  isIncluded: true,
  IconComponent: fn(10409).StickerIcon,
  getCopy() {
    const intl = util.intl;
...
items[2] = {
  isIncluded: true,
  IconComponent: fn(12815).ScreenArrowIcon,
  getCopy() {
    const intl = util.intl;
...
items[3] = {
  orderCollapsed: 2,
  isIncluded: true,
  IconComponent: fn(5351).VoiceNormalIcon,
  getCopy() {
    const intl = util.intl;
...
items[4] = {
  isIncluded: true,
  IconComponent: fn(5347).StageIcon,
  getCopy() {
    const intl = util.intl;
...
items[5] = {
  orderCollapsed: 1,
  isIncluded: true,
  IconComponent: fn(10676).GifIcon,
  getCopy() {
    const intl = util.intl;
...
items[6] = {
  isIncluded: true,
  IconComponent: fn(13880).ServerGridIcon,
  getCopy() {
    const intl = util.intl;
...
items[7] = {
  isIncluded: false,
  IconComponent: fn(9517).UploadIcon,
  getCopy() {
    const intl = util.intl;
...
items[10] = {
  isIncluded: false,
  IconComponent: fn(4730).LinkIcon,
  getCopy() {
    const intl = util.intl;
...
obj37.cardsScroller = { flex: 1, marginTop: fn(13874).PROGRESS_BAR_SPACING };
...
const obj41 = { flex: 1, marginTop: fn(13874).PROGRESS_BAR_SPACING };
obj37.sparkleStar = { position: "absolute", tintColor: fn(5690).DARK_WHITE_500_LIGHT_GUILD_BOOSTING_PINK };
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13883).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13885).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      const tmp2Result4 = tmp2(5230);
      const items7 = [tmp7(4637).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result7 = tmp7(4637);
      items7[1] = tmp7(4637).hexWithOpacity(tmp9, 1);
      const tmp7Result8 = tmp7(4637);
      items7[2] = tmp7(4637).hexWithOpacity(tmp9, 0);
      obj15.colors = items7;
      obj15.start = { x: 0, y: 0 };
      obj15.end = { x: 1, y: 0 };
      ...
      const tmp7Result9 = tmp7(4637);
      const tmp2Result5 = tmp2(5230);
      const items10 = [tmp7(4637).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result10 = tmp7(4637);
      items10[1] = tmp7(4637).hexWithOpacity(tmp9, 1);
      const tmp7Result11 = tmp7(4637);
      items10[2] = tmp7(4637).hexWithOpacity(tmp9, 0);
    ...
    obj22 = tmp13(tmp7(4784).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5230), obj21);
    const tmp2Result6 = tmp2(5230);
  }
});
const size = fn(2);
