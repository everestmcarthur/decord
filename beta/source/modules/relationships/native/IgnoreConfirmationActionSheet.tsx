...
// Dependencies: [32, 19, 17, 2041, 1372, 10036, 11674, 1074, 21, 4788, 576, 8486, 1115, 4744, 5936, 5854, 1177, 1612, 7439, 7459, 504, 1241, 8482, 7427, 6901, 7244, 4784, 4940, 8220, 4755, 11675, 1980, 1249, 5218, 10035, 2108, 4483, 2]

// Module 11676 (IgnoreConfirmationActionSheet)
...
export default noop.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(7244) };
    ...
    const obj13 = { username: tmp4(4940).getName(stateFromStores1, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1115).t["WrQD/Y"], obj13);
    items7[1] = closure_13(tmp7(4784).Text, obj12);
    ...
    items7[2] = closure_13(tmp7(4784).Text, obj14);
    ...
    const obj19 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(8220), color: tmp.destructiveIcon.color };
    ...
    obj18.subLabel = closure_13(tmp7(4784).Text, obj20);
    ...
    obj18.onPress = function onPress() {
      ...
      const tmp2 = asyncRequireImpl(11675, dependencyMap.paths);
    ...
    obj17.children = closure_13(tmp7(5854).TableRow, obj18);
    obj16.children = closure_13(tmp7(5936).TableRowGroup, obj17);
    ...
    obj22.disabled = tmp3;
    obj22.loading = tmp3;
    const items9 = [closure_13(tmp7(5218).Button, obj22), ];
    ...
    items9[1] = closure_13(tmp7(4784).Text, obj23);
    obj21.children = items9;
    items8[3] = closure_14(stateFromStores, obj21);
    obj8.children = items8;
    obj4.children = closure_14(tmp7(6901).BottomSheetScrollView, obj8);
    obj3.children = closure_13(tmp7(7427).BottomSheet, obj4);
    tmp12Result = tmp12(tmp7(7439).AnalyticsLocationProvider, obj3);
