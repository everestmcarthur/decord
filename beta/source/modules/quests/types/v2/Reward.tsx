...
function _questRewardV2FromServer(type) {
  ...
  if (QuestRewardTypes.QuestRewardTypes.REWARD_CODE === type) {
    const obj2 = { type: tmp(7976).QuestRewardTypes.REWARD_CODE, skuId: null, asset: null, assetVideo: null, messages: null, approximateCount: null, redemptionLink: null };
    ...
    return obj2;
  } else if (tmp(7976).QuestRewardTypes.COLLECTIBLE === type) {
    const obj6 = { type: tmp(7976).QuestRewardTypes.COLLECTIBLE, skuId: null, asset: null, assetVideo: null, messages: null, expiresAt: null, expirationMode: null, expiresAtPremium: null };
    ...
    return obj6;
  } else if (tmp(7976).QuestRewardTypes.VIRTUAL_CURRENCY === type) {
    const obj10 = { type: tmp(7976).QuestRewardTypes.VIRTUAL_CURRENCY, skuId: type.sku_id, messages: null, orbQuantity: null, premiumOrbQuantity: null };
    ...
    return obj10;
  } else if (tmp(7976).QuestRewardTypes.FRACTIONAL_PREMIUM === type) {
    const obj20 = { type: tmp(7976).QuestRewardTypes.FRACTIONAL_PREMIUM, skuId: null, asset: null, assetVideo: null, quantity: null, messages: null };
    ...
    return obj20;
  } else if (tmp(7976).QuestRewardTypes.IN_GAME === type) {
    const obj = { type: tmp(7976).QuestRewardTypes.IN_GAME, skuId: null, asset: null, assetVideo: null, messages: null };
