...
// Function ID: 15361
// Name: QuestCard
// Dependencies: [5, 32, 19, 17, 1372, 7971, 5693, 1085, 21, 576, 4788, 4640, 4637, 4504, 5696, 7977, 12056, 11767, 1478, 11577, 15361, 9029, 5116, 5121, 7996, 504, 11582, 7992, 7967, 11587, 4722, 11340, 4489, 15388, 11770, 7997, 7998, 8008, 5700, 11780, 4755, 15390, 1980, 12057, 7826, 1115, 12049, 11797, 15394, 11571, 11584, 11585, 5225, 10414, 8989, 1364, 9148, 4784, 15395, 5856, 15434, 5836, 5230, 1094, 15420, 5840, 15401, 12052, 15435, 5216, 5218, 15438, 8211, 10477, 15421, 2]

// Module 15360 (QuestCard)
...
import openVideoQuestModalDefault from "openVideoQuestModal" /* 15394 */;
import VideoQuestModal from "VideoQuestModal" /* 15395 */;
...
export const QuestCard = noop.memo((questContent) => {
  function trackClick(CLAIM_REWARD) {
    if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_card")) {
      const obj2 = { type: tmp(8008).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp(5700).AdCreativeType.QUEST, adCreativeId: quest.id, questContentCTA: CLAIM_REWARD, surfaceId: QUEST_HOME_MOBILE, sourceQuestContent, impressionId: getQuestImpressionId() };
  ...
  function showQuestBottomSheet() {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15390, dependencyMap.paths), "QuestBottomSheet", { questId: quest.id, questContentPosition, sourceQuestContent });
  }
  const tmp = require;
        ...
        if (hasWatchVideoTasksResult) {
          ...
          obj10.onPress = function onPress() {
            ...
            if (hasWatchVideoOnMobileTasks) {
              ...
              tmp5(4755).openLazy(asyncRequireImpl(15390, dependencyMap.paths), "QuestBottomSheet", obj2);
              const tmp5Result = tmp5(4755);
            }
          };
          let tmp63 = null;
          if (isQuestAccessSuspended) {
          ...
          try {
            ...
            if (0 === v1) {
              if (arg0 === 1) {
                ...
                if (!isMobileActivityQuest) {
                  if (!hasWatchVideoTasksResult) {
                    let START_QUEST = tmp30(7996).QuestContentCTA.ACCEPT_QUEST;
                  }
                ...
                START_QUEST = tmp30(7996).QuestContentCTA.START_QUEST;
              }
            } else if (arg0 === 1) {
              dependencyMap = 3;
              throw value;
  ...
  const memo1 = obj7.useMemo(() => {
    ...
    if (closure_16) {
      if (result2) {
        ...
        const items1 = [closure_2_12(tmp2(9148).OrbsIcon, obj4), , ];
        ...
        items1[2] = closure_2_12(tmp2(4784).Text, obj7);
    ...
    if (closure_16) {
      ...
      tmp15Result = closure_2_12(tmp2(4784).Text, obj9);
    } else if (result2) {
      ...
      const items2 = [closure_2_12(tmp2(4784).Text, obj11), ];
      ...
      const items3 = [closure_2_12(tmp2(9148).OrbsIcon, obj14), , ];
      ...
      items3[2] = closure_2_12(tmp2(4784).Text, obj17);
      ...
      tmp15Result = closure_2_12(tmp2(4784).Text, obj19);
    }
  }, items10);
  if (isQuestExpiredResult) {
    tmp86 = tmp91Result10;
  ...
  if (tmp46) {
    ...
    const obj44 = {
      onPress() {
          ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15438, dependencyMap.paths), "QuestEnrollmentBlockedBottomSheet", { questId: quest.id, questEnrollmentBlockedUntil, sourceQuestContent });
        },
      variant: "tertiary",
      text: null
    };
