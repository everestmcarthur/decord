...
// Dependencies: [19, 17, 1372, 21, 4788, 576, 12049, 4755, 11767, 11582, 7976, 1115, 504, 7427, 5216, 12052, 4784, 2]
// Exports: default

// Module 12051 (QuestRewardDetailsBottomSheet)
...
function QuestRewardDetailsBottomSheet(quest) {
  ...
  let obj = quest(504);
  const tmp4 = quest;
  const defaultRewardName = quest(11582).getDefaultRewardName(quest.config, stateFromStores);
  ...
  const items3 = [closure_6(memo(12052), { quest, height: 56, width: 56, withAnimation: true }), ];
  ...
  const items4 = [closure_6(quest(4784).Text, obj6), closure_6(quest(4784).Text, { variant: "heading-lg/semibold", color: "text-strong", children: defaultRewardName })];
  obj5.children = items4;
  items3[1] = closure_7(quest(5216).Stack, obj5);
  obj4.children = items3;
  const items5 = [closure_7(quest(5216).Stack, obj4), ];
  ...
  if (tmp9Result) {
    ...
    items6[1] = tmp8(tmp4(4784).Text, obj9);
    obj7.children = items6;
    tmp9Result = tmp9(closure_8, obj7);
  }
  const obj2 = quest(11582);
  items5[1] = tmp9Result;
  obj3.children = items5;
  return closure_6(quest(7427).BottomSheet, { startExpanded: true, children: closure_7(quest(5216).Stack, obj3) });
}
