...
// Dependencies: [19, 17, 21, 4788, 4637, 576, 4489, 4722, 4640, 5230, 5913, 2]
// Exports: default

// Module 15434 (PremiumRewardGradient)
...
function PremiumRewardGlowGradient(arg0) {
  ...
  items2[1] = glowLight;
  const items3 = [timestampProducer(_modDef5913, obj5), children];
  obj4.children = items3;
