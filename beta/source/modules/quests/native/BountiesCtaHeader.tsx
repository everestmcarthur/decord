...
// Dependencies: [19, 17, 4780, 15350, 5693, 21, 576, 5223, 4788, 504, 8610, 15331, 5218, 1115, 4784, 15340, 15351, 5700, 7986, 5696, 7996, 15283, 15285, 1177, 15352, 15353, 15354, 12056, 4498, 15334, 12060, 2]

// Module 15349 (BountiesCtaHeader)
...
import BountiesBannerBackgroundDefault from "BountiesBannerBackground" /* 15352 */;
import _modDef15353 from "module_15353" /* 15353 */;
...
function BountiesCtaDescription(arg0) {
  ...
  const tmp7 = closure_1_10(tmp5(4784).Text, obj);
  ...
  if (!isEmptyOrCompleted) {
    if (!inlineLearnMore) {
      ...
      items[1] = tmp6(tmp5(4784).Text, obj4);
      obj3.children = items;
  ...
  tmp11 = closure_1_11(tmp5(4784).Text, obj5);
}
function BountiesCtaHeaderInner(bounties) {
  ...
  const bountiesEntryPointButtonVariant = bounties(15351).getBountiesEntryPointButtonVariant(shopCarouselButtonVariant);
  let obj = bounties(15351);
  ...
  if (null != replaceHeaderMediaWith) {
    ...
    const obj15 = { uri: _modDef15353, style: null, children: null };
...
const minHeight = 472 - (sum + fn(5223).MEDIUM_BUTTON_HEIGHT + PX_20 + 170);
...
export default noop.memo(function BountiesCtaHeader(isEmptyOrCompleted) {
  ...
  if (!tmp3) {
    ...
    if (tmp3) {
      ...
      const obj4 = {
        adContentId,
        adCreativeType: tmp7(5700).AdCreativeType.BOUNTY,
        questContent: tmp7(5696).QuestContent.QUEST_HOME_ENTRYPOINT_MOBILE,
        questContentPosition: 0,
        overrideVisibility: tmp2.isInView,
        sourceQuestContent: tmp7(5696).QuestContent.QUEST_HOME_ENTRYPOINT_MOBILE,
        children() {
              const obj = {};
      ...
      tmp9Result = tmp9(tmp7(12060).QuestContentImpressionTrackerNative, obj4);
    }
