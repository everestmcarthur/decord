...
// Dependencies: [32, 19, 1979, 8002, 1074, 21, 9029, 8575, 504, 11770, 11771, 5700, 2]
// Exports: BillableAdPlacementImpressionTrackerNative, QuestContentImpressionTrackerNative

// Module 12060 (QuestContentImpressionTracker)
...
function AdContentImpressionTrackerBaseNative(skipRemountKey) {
  ...
  let tmp6 = visibilityRef(8575)(tmp3);
  const adContentImpressionTrackerProps = adContentIds2(11770).useAdContentImpressionTrackerProps(skipRemountKey);
  ...
  const obj2 = adContentIds2(11770);
  let items1 = [joined];
  const tmp10 = _slicedToArray(adContentIds2(9029).useRecyclingState(false, items1), 2);
  dependencyMap = tmp11;
  ...
  const obj4 = adContentIds2(9029);
  const obj6 = {};
  const merged1 = Object.assign(skipRemountKey);
  const merged2 = Object.assign({ visible: overrideVisibility, visibleChanged: overrideVisibility !== tmp5(8575)(overrideVisibility) });
  obj6.focused = tmp3;
  ...
  if (tmp17) {
    obj7.adCreativeType = tmp(5700).AdCreativeType.QUEST;
    let tmp19 = obj7;
  } else {
    obj7.adCreativeType = skipRemountKey.adCreativeType;
    tmp19 = obj7;
  }
  return createElement(adContentIds2(11771).QuestContentImpressionTracker, tmp19);
}
let closure_6 = fn(8002).MIN_QUEST_CONTENT_VISIBILITY_PERCENTAGE;
