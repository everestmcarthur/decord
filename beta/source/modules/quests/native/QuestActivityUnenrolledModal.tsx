...
// Dependencies: [5, 32, 19, 17, 7971, 17500, 5693, 21, 4788, 576, 1365, 4722, 4496, 504, 7445, 7992, 11767, 12057, 5696, 1397, 11571, 7996, 4991, 4506, 12056, 15388, 5216, 5836, 12052, 4784, 1115, 5218, 5866, 7651, 7269, 12060, 11494, 2]
// Exports: default

// Module 17501 (QuestActivityUnenrolledModal)
...
import openQuestAccessSuspendedBottomSheetDefault from "openQuestAccessSuspendedBottomSheet" /* 15388 */;
...
function QuestActivityUnenrolledModalInner(quest) {
  ...
  const theme = quest(4722).useTheme();
  let obj = quest(4722);
  const tmp4 = closure_14(quest(4496).isThemeDark(theme));
  let obj2 = quest(4496);
  ...
  let obj3 = quest(504);
  let obj4 = quest(7445);
  const getOrFetchApplication = obj4.useGetOrFetchApplication(quest(7992).getActivityApplicationId(quest));
  const obj5 = quest(7992);
  const questTaskDetails = quest(11767).useQuestTaskDetails(quest);
  let obj6 = quest(11767);
  const obj7 = quest(12057);
  const items1 = [getOrFetchApplication];
  const questsInstructionsToWinReward = obj7.useQuestsInstructionsToWinReward({ quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5696).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL });
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const obj4 = { questContent: tmp4(5696).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL, questContentCTA: tmp4(7996).QuestContentCTA.START_QUEST, sourceQuestContent: tmp4(5696).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(11571).enrollInQuest(quest.id, obj4), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const obj8 = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5696).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
  const checkboxA11yNative = quest(4506).useCheckboxA11yNative({ checked });
  ({ accessibilityRole, accessibilityState } = checkboxA11yNative);
  const obj9 = quest(4506);
  const isQuestAccessSuspended = quest(11767).useIsQuestAccessSuspended();
  const obj10 = quest(11767);
  trackQuestContentClickedWithImpression = quest(12056).useTrackQuestContentClickedWithImpression();
  ...
  if (tmp18Result) {
    ...
    obj16.children = tmp18(checked(5836), obj17);
  ...
  obj19.children = closure_11(checked(12052), size);
  ...
  const items6 = [closure_11(quest(4784).Text, obj21), ];
  ...
  items6[1] = closure_12(quest(4784).Text, obj22);
  ...
  const items9 = [closure_11(quest(5218).Button, obj26), ];
  ...
  items9[1] = closure_11(quest(5218).Button, obj27);
  ...
  if (null == stateFromStores) {
    ...
    const obj3 = {
      ...
      headerTitle() {
          ...
          return closure_1_11(questId(4784).Text, obj);
        },
      render() {
    ...
    return closure_11(tmp(11494).Modal, obj4);
  }
  let obj = questId(504);
  tmp = questId;
};
