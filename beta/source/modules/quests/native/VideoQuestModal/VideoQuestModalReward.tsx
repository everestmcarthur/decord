...
// Dependencies: [19, 21, 4788, 15396, 11767, 12049, 5216, 576, 15401, 4784, 1115, 2]

// Module 15419 (VideoQuestModalReward)
...
export default noop.memo(function VideoQuestModalReward(style) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp3(4784).Text, obj8);
  }
  items2[1] = tmp9Result;
  obj5.children = items2;
  items1[1] = closure_5(quest(5216).Stack, obj5);
  obj3.children = items1;
  return closure_5(quest(5216).Stack, obj3);
});
