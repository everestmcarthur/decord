...
// Dependencies: [19, 17, 7973, 21, 4788, 576, 15396, 11767, 7992, 4411, 11796, 4784, 1115, 15418, 2]
// Exports: default

// Module 15423 (VideoQuestModalHeader)
...
const useVideoQuestUIStore = fn(7973).useVideoQuestUIStore;
const jsxProd = fn(21);
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  quest = quest(15396).useVideoQuestModalContext().quest;
  let obj = quest(15396);
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11796).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(11796);
  }
  ...
  const items1 = [closure_5(quest(4784).Text, obj5), ];
  ...
  items1[1] = closure_5(quest(4784).Text, obj7);
  obj4.children = items1;
  const items2 = [closure_6(View, obj4), closure_5(questTaskDetails(15418), { iconColor: closeButtonIconColor, onClose })];
