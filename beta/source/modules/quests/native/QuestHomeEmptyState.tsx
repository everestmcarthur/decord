...
// Dependencies: [19, 17, 1074, 21, 4788, 576, 1115, 4489, 4648, 7400, 1364, 4784, 15338, 5230, 2]
// Exports: default

// Module 15337 (QuestHomeEmptyState)
...
export default function QuestHomeEmptyState(subtitle) {
  ...
  if (!useChatLayoutDefault().isChatLockedOpen) {
    ...
    const obj11 = { style: tmp5.emptyImage, source: tmp7(15338), resizeMode: "cover" };
