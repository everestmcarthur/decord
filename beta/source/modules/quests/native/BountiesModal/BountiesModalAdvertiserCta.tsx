...
// Dependencies: [109, 19, 17, 4780, 5693, 21, 4524, 4788, 576, 4789, 4792, 15321, 11577, 5224, 11770, 11780, 5700, 7996, 5698, 8906, 5836, 4784, 5218, 15289, 504, 15290, 10265, 2]
// Exports: default

// Module 15320 (BountiesModalAdvertiserCta)
...
let obj = { withTiming: fn(4789).withTiming, timingStandard: fn(4792).timingStandard };
fn2.__closure = { withTiming: fn(4789).withTiming, timingFast: fn(4792).timingFast };
