...
// Dependencies: [21, 4788, 576, 11770, 4524, 4789, 4792, 15321, 5218, 11780, 5700, 5698, 7996, 1115, 2]
// Exports: default

// Module 15326 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  let tmp = closure_5();
  closure_3 = bounty(11770).useGetQuestImpressionId();
  let obj = bounty(11770);
  const fn = function y() {
    let num = 0;
    if (visible) {
      num = 1;
  ...
  let obj2 = bounty(4524);
  fn.__closure = { withTiming: bounty(4789).withTiming, visible, timingStandard: bounty(4792).timingStandard };
  ...
  if (visible) {
    ...
    const items1 = [closure_3(tmp2(5218).Button, obj5), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(5218).Button, obj6);
    }
    items1[1] = tmp9Result;
    obj4.children = items1;
    visible = closure_4(visible(4524).View, obj4);
    tmp9 = closure_3;
  }
  return visible;
};
