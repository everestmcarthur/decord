...
// Dependencies: [19, 17, 4780, 5693, 21, 4788, 576, 4789, 4792, 504, 1612, 4524, 4498, 15289, 15290, 10265, 2]
// Exports: default

// Module 15288 (BountiesScrollPromptFooter)
...
function BountiesScrollPromptFooterContent(zIndex) {
  ...
  obj3.children = closure_7(zIndex(4498).BountiesScrollGradientRive, { stateMachine: "State Machine 1", fit: "fill", alignment: "bottom-center", withReducedMotion: str });
