...
// Function ID: 4519
// Name: BaseRive
// Dependencies: [19, 17, 21, 4519, 4508, 4569, 4570, 4571, 2]
...
// Module 4518 (BaseRive)
import DataBindByName from "DataBindByName" /* 4519 */;
import ManaContext from "ManaContext" /* 4569 */;
import useRivePlayback from "useRivePlayback" /* 4570 */;
...
export const BaseRive = noop.forwardRef(function BaseRiveInner(renderDataBinding, ref) {
  ...
  const enabled = noop.useContext(tmp(4508).AccessibilityPreferencesContext).reducedMotion.enabled;
  ...
  let None = instance;
  if (instance == null) {
    None = tmp(4519).DataBindMode.None;
  }
  let reducedMotion;
  ...
  if (null == riveFile) {
    ...
    if (null != fit) {
      const obj10 = { fit: tmp(4571).FIT_MAP[fit] };
      let obj11 = obj10;
    } else {
      obj11 = {};
    }
    ...
    if (null != alignment) {
      const obj12 = { alignment: tmp(4571).ALIGNMENT_MAP[alignment] };
      let obj13 = obj12;
    } else {
      obj13 = {};
    }
    ...
    timestampProducer(tmp(4519).RiveView, obj7);
  }
});
