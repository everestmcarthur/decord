...
// Dependencies: [32, 1186, 1214, 1215, 1216, 2]

// Module 1185 (preloaded_user_settings)
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(versions, tag, writeUnknownFields) {
  if (versions.versions) {
    ...
    const joined = Versions.internalBinaryWrite(versions.versions, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = Versions.internalBinaryWrite(versions.versions, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.inbox) {
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = closure_25.internalBinaryWrite(versions.inbox, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = closure_25.internalBinaryWrite(versions.inbox, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.guilds) {
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = closure_26.internalBinaryWrite(versions.guilds, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = closure_26.internalBinaryWrite(versions.guilds, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.userContent) {
    const tagResult3 = tag.tag(4, _mod1186.WireType.LengthDelimited);
    const joined3 = closure_33.internalBinaryWrite(versions.userContent, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = closure_33.internalBinaryWrite(versions.userContent, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.voiceAndVideo) {
    const tagResult4 = tag.tag(5, _mod1186.WireType.LengthDelimited);
    const joined4 = closure_36.internalBinaryWrite(versions.voiceAndVideo, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = closure_36.internalBinaryWrite(versions.voiceAndVideo, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.textAndImages) {
    const tagResult5 = tag.tag(6, _mod1186.WireType.LengthDelimited);
    const joined5 = textAndImagesSettingsType.internalBinaryWrite(versions.textAndImages, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = textAndImagesSettingsType.internalBinaryWrite(versions.textAndImages, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.notifications) {
    const tagResult6 = tag.tag(7, _mod1186.WireType.LengthDelimited);
    const joined6 = notificationSettingsType.internalBinaryWrite(versions.notifications, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = notificationSettingsType.internalBinaryWrite(versions.notifications, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.privacy) {
    const tagResult7 = tag.tag(8, _mod1186.WireType.LengthDelimited);
    const joined7 = privacySettingsType.internalBinaryWrite(versions.privacy, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = privacySettingsType.internalBinaryWrite(versions.privacy, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.debug) {
    const tagResult8 = tag.tag(9, _mod1186.WireType.LengthDelimited);
    const joined8 = closure_44.internalBinaryWrite(versions.debug, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = closure_44.internalBinaryWrite(versions.debug, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.gameLibrary) {
    const tagResult9 = tag.tag(10, _mod1186.WireType.LengthDelimited);
    const joined9 = closure_45.internalBinaryWrite(versions.gameLibrary, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult9 = closure_45.internalBinaryWrite(versions.gameLibrary, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.status) {
    const tagResult10 = tag.tag(11, _mod1186.WireType.LengthDelimited);
    const joined10 = closure_46.internalBinaryWrite(versions.status, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult10 = closure_46.internalBinaryWrite(versions.status, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.localization) {
    const tagResult11 = tag.tag(12, _mod1186.WireType.LengthDelimited);
    const joined11 = closure_48.internalBinaryWrite(versions.localization, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult11 = closure_48.internalBinaryWrite(versions.localization, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.appearance) {
    const tagResult12 = tag.tag(13, _mod1186.WireType.LengthDelimited);
    const joined12 = appearanceSettingsType.internalBinaryWrite(versions.appearance, tag.tag(13, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult12 = appearanceSettingsType.internalBinaryWrite(versions.appearance, tag.tag(13, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.guildFolders) {
    const tagResult13 = tag.tag(14, _mod1186.WireType.LengthDelimited);
    const joined13 = closure_53.internalBinaryWrite(versions.guildFolders, tag.tag(14, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult13 = closure_53.internalBinaryWrite(versions.guildFolders, tag.tag(14, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.favorites) {
    const tagResult14 = tag.tag(15, _mod1186.WireType.LengthDelimited);
    const joined14 = closure_55.internalBinaryWrite(versions.favorites, tag.tag(15, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult14 = closure_55.internalBinaryWrite(versions.favorites, tag.tag(15, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.audioContextSettings) {
    const tagResult15 = tag.tag(16, _mod1186.WireType.LengthDelimited);
    const joined15 = closure_58.internalBinaryWrite(versions.audioContextSettings, tag.tag(16, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult15 = closure_58.internalBinaryWrite(versions.audioContextSettings, tag.tag(16, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.communities) {
    const tagResult16 = tag.tag(17, _mod1186.WireType.LengthDelimited);
    const joined16 = closure_59.internalBinaryWrite(versions.communities, tag.tag(17, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult16 = closure_59.internalBinaryWrite(versions.communities, tag.tag(17, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.broadcast) {
    const tagResult17 = tag.tag(18, _mod1186.WireType.LengthDelimited);
    const joined17 = closure_62.internalBinaryWrite(versions.broadcast, tag.tag(18, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult17 = closure_62.internalBinaryWrite(versions.broadcast, tag.tag(18, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.clips) {
    const tagResult18 = tag.tag(19, _mod1186.WireType.LengthDelimited);
    const joined18 = closure_63.internalBinaryWrite(versions.clips, tag.tag(19, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult18 = closure_63.internalBinaryWrite(versions.clips, tag.tag(19, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.forLater) {
    const tagResult19 = tag.tag(20, _mod1186.WireType.LengthDelimited);
    const joined19 = closure_67.internalBinaryWrite(versions.forLater, tag.tag(20, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult19 = closure_67.internalBinaryWrite(versions.forLater, tag.tag(20, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.safetySettings) {
    const tagResult20 = tag.tag(21, _mod1186.WireType.LengthDelimited);
    const joined20 = closure_66.internalBinaryWrite(versions.safetySettings, tag.tag(21, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult20 = closure_66.internalBinaryWrite(versions.safetySettings, tag.tag(21, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.icymiSettings) {
    const tagResult21 = tag.tag(22, _mod1186.WireType.LengthDelimited);
    const joined21 = closure_68.internalBinaryWrite(versions.icymiSettings, tag.tag(22, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult21 = closure_68.internalBinaryWrite(versions.icymiSettings, tag.tag(22, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.applications) {
    const tagResult22 = tag.tag(23, _mod1186.WireType.LengthDelimited);
    const joined22 = closure_69.internalBinaryWrite(versions.applications, tag.tag(23, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult22 = closure_69.internalBinaryWrite(versions.applications, tag.tag(23, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.ads) {
    const tagResult23 = tag.tag(24, _mod1186.WireType.LengthDelimited);
    const joined23 = closure_73.internalBinaryWrite(versions.ads, tag.tag(24, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult23 = closure_73.internalBinaryWrite(versions.ads, tag.tag(24, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.inAppFeedbackSettings) {
    const tagResult24 = tag.tag(25, _mod1186.WireType.LengthDelimited);
    const joined24 = inAppFeedbackStateType1.internalBinaryWrite(versions.inAppFeedbackSettings, tag.tag(25, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult24 = inAppFeedbackStateType1.internalBinaryWrite(versions.inAppFeedbackSettings, tag.tag(25, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.appVersionSettings) {
    const tagResult25 = tag.tag(26, _mod1186.WireType.LengthDelimited);
    const joined25 = closure_77.internalBinaryWrite(versions.appVersionSettings, tag.tag(26, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult25 = closure_77.internalBinaryWrite(versions.appVersionSettings, tag.tag(26, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype5["internalBinaryWrite"] = function internalBinaryWrite(channels, tag, writeUnknownFields) {
  ...
  if (channels.guildRecentsDismissedAt) {
    ...
    const joined2 = Timestamp.internalBinaryWrite(channels.guildRecentsDismissedAt, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = Timestamp.internalBinaryWrite(channels.guildRecentsDismissedAt, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (channels.joinSound) {
    ...
    const joined3 = closure_61.internalBinaryWrite(channels.joinSound, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = closure_61.internalBinaryWrite(channels.joinSound, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (channels.mobileRedesignChannelListSettings) {
    const tagResult8 = tag.tag(7, _mod1186.WireType.LengthDelimited);
    const joined4 = closure_49.internalBinaryWrite(channels.mobileRedesignChannelListSettings, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = closure_49.internalBinaryWrite(channels.mobileRedesignChannelListSettings, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (channels.customNotificationSoundConfig) {
    ...
    const joined5 = closure_31.internalBinaryWrite(channels.customNotificationSoundConfig, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = closure_31.internalBinaryWrite(channels.customNotificationSoundConfig, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype6["internalBinaryWrite"] = function internalBinaryWrite(id, tag, writeUnknownFields) {
  if (id.id) {
    ...
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = UInt64Value.internalBinaryWrite(id.id, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = UInt64Value.internalBinaryWrite(id.id, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (id.name) {
    const StringValue = wrappers.StringValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = StringValue.internalBinaryWrite(id.name, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = StringValue.internalBinaryWrite(id.name, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (id.color) {
    const UInt64Value2 = wrappers.UInt64Value;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = UInt64Value2.internalBinaryWrite(id.color, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = UInt64Value2.internalBinaryWrite(id.color, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype7["internalBinaryWrite"] = function internalBinaryWrite(collapsedInInbox, tag, writeUnknownFields) {
  ...
  if (collapsedInInbox.iconEmoji) {
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined = closure_29.internalBinaryWrite(collapsedInInbox.iconEmoji, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_29.internalBinaryWrite(collapsedInInbox.iconEmoji, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (collapsedInInbox.customNotificationSoundConfig) {
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined1 = closure_31.internalBinaryWrite(collapsedInInbox.customNotificationSoundConfig, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = closure_31.internalBinaryWrite(collapsedInInbox.customNotificationSoundConfig, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype8["internalBinaryWrite"] = function internalBinaryWrite(notificationSoundPackId, tag, writeUnknownFields) {
  if (notificationSoundPackId.notificationSoundPackId) {
    const StringValue = wrappers.StringValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = StringValue.internalBinaryWrite(notificationSoundPackId.notificationSoundPackId, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = StringValue.internalBinaryWrite(notificationSoundPackId.notificationSoundPackId, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype10["internalBinaryWrite"] = function internalBinaryWrite(dismissedContents, tag, writeUnknownFields) {
  ...
  if (dismissedContents.lastDismissedOutboundPromotionStartDate) {
    const StringValue = wrappers.StringValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined = StringValue.internalBinaryWrite(dismissedContents.lastDismissedOutboundPromotionStartDate, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = StringValue.internalBinaryWrite(dismissedContents.lastDismissedOutboundPromotionStartDate, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (dismissedContents.premiumTier0ModalDismissedAt) {
    const Timestamp = timestamp.Timestamp;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined1 = Timestamp.internalBinaryWrite(dismissedContents.premiumTier0ModalDismissedAt, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = Timestamp.internalBinaryWrite(dismissedContents.premiumTier0ModalDismissedAt, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (dismissedContents.guildOnboardingUpsellDismissedAt) {
    const Timestamp2 = timestamp.Timestamp;
    const tagResult3 = tag.tag(4, _mod1186.WireType.LengthDelimited);
    const joined2 = Timestamp2.internalBinaryWrite(dismissedContents.guildOnboardingUpsellDismissedAt, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = Timestamp2.internalBinaryWrite(dismissedContents.guildOnboardingUpsellDismissedAt, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (dismissedContents.safetyUserSentimentNoticeDismissedAt) {
    const Timestamp3 = timestamp.Timestamp;
    const tagResult4 = tag.tag(5, _mod1186.WireType.LengthDelimited);
    const joined3 = Timestamp3.internalBinaryWrite(dismissedContents.safetyUserSentimentNoticeDismissedAt, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = Timestamp3.internalBinaryWrite(dismissedContents.safetyUserSentimentNoticeDismissedAt, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype13["internalBinaryWrite"] = function internalBinaryWrite(videoBackgroundFilterDesktop, tag, writeUnknownFields) {
  if ("blur" === videoBackgroundFilterDesktop.videoBackgroundFilterDesktop.oneofKind) {
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = closure_35.internalBinaryWrite(videoBackgroundFilterDesktop.videoBackgroundFilterDesktop.blur, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_35.internalBinaryWrite(videoBackgroundFilterDesktop.videoBackgroundFilterDesktop.blur, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if ("customAsset" === videoBackgroundFilterDesktop.videoBackgroundFilterDesktop.oneofKind) {
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined1 = closure_34.internalBinaryWrite(videoBackgroundFilterDesktop.videoBackgroundFilterDesktop.customAsset, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = closure_34.internalBinaryWrite(videoBackgroundFilterDesktop.videoBackgroundFilterDesktop.customAsset, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (videoBackgroundFilterDesktop.alwaysPreviewVideo) {
    const BoolValue = wrappers.BoolValue;
    const tagResult3 = tag.tag(5, _mod1186.WireType.LengthDelimited);
    const joined2 = BoolValue.internalBinaryWrite(videoBackgroundFilterDesktop.alwaysPreviewVideo, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = BoolValue.internalBinaryWrite(videoBackgroundFilterDesktop.alwaysPreviewVideo, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (videoBackgroundFilterDesktop.afkTimeout) {
    ...
    const joined3 = UInt32Value.internalBinaryWrite(videoBackgroundFilterDesktop.afkTimeout, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = UInt32Value.internalBinaryWrite(videoBackgroundFilterDesktop.afkTimeout, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (videoBackgroundFilterDesktop.streamNotificationsEnabled) {
    ...
    const joined4 = BoolValue2.internalBinaryWrite(videoBackgroundFilterDesktop.streamNotificationsEnabled, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = BoolValue2.internalBinaryWrite(videoBackgroundFilterDesktop.streamNotificationsEnabled, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (videoBackgroundFilterDesktop.nativePhoneIntegrationEnabled) {
    ...
    const joined5 = BoolValue3.internalBinaryWrite(videoBackgroundFilterDesktop.nativePhoneIntegrationEnabled, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = BoolValue3.internalBinaryWrite(videoBackgroundFilterDesktop.nativePhoneIntegrationEnabled, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (videoBackgroundFilterDesktop.soundboardSettings) {
    const tagResult7 = tag.tag(9, _mod1186.WireType.LengthDelimited);
    const joined6 = closure_60.internalBinaryWrite(videoBackgroundFilterDesktop.soundboardSettings, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = closure_60.internalBinaryWrite(videoBackgroundFilterDesktop.soundboardSettings, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (videoBackgroundFilterDesktop.disableStreamPreviews) {
    ...
    const joined7 = BoolValue4.internalBinaryWrite(videoBackgroundFilterDesktop.disableStreamPreviews, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = BoolValue4.internalBinaryWrite(videoBackgroundFilterDesktop.disableStreamPreviews, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (videoBackgroundFilterDesktop.soundmojiVolume) {
    ...
    const joined8 = FloatValue.internalBinaryWrite(videoBackgroundFilterDesktop.soundmojiVolume, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = FloatValue.internalBinaryWrite(videoBackgroundFilterDesktop.soundmojiVolume, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype17["internalBinaryWrite"] = function internalBinaryWrite(profanity, tag, writeUnknownFields) {
  if (profanity.profanity) {
    const BoolValue = wrappers.BoolValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = BoolValue.internalBinaryWrite(profanity.profanity, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = BoolValue.internalBinaryWrite(profanity.profanity, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (profanity.sexualContent) {
    const BoolValue2 = wrappers.BoolValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = BoolValue2.internalBinaryWrite(profanity.sexualContent, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = BoolValue2.internalBinaryWrite(profanity.sexualContent, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (profanity.slurs) {
    const BoolValue3 = wrappers.BoolValue;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = BoolValue3.internalBinaryWrite(profanity.slurs, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = BoolValue3.internalBinaryWrite(profanity.slurs, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype18["internalBinaryWrite"] = function internalBinaryWrite(diversitySurrogate, tag, writeUnknownFields) {
  ...
  if (diversitySurrogate.diversitySurrogate) {
    const StringValue = wrappers.StringValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = StringValue.internalBinaryWrite(diversitySurrogate.diversitySurrogate, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = StringValue.internalBinaryWrite(diversitySurrogate.diversitySurrogate, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.useRichChatInput) {
    const BoolValue = wrappers.BoolValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = BoolValue.internalBinaryWrite(diversitySurrogate.useRichChatInput, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = BoolValue.internalBinaryWrite(diversitySurrogate.useRichChatInput, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.useThreadSidebar) {
    const BoolValue2 = wrappers.BoolValue;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = BoolValue2.internalBinaryWrite(diversitySurrogate.useThreadSidebar, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = BoolValue2.internalBinaryWrite(diversitySurrogate.useThreadSidebar, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.renderSpoilers) {
    const StringValue2 = wrappers.StringValue;
    const tagResult3 = tag.tag(4, _mod1186.WireType.LengthDelimited);
    const joined3 = StringValue2.internalBinaryWrite(diversitySurrogate.renderSpoilers, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = StringValue2.internalBinaryWrite(diversitySurrogate.renderSpoilers, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let num5 = 0;
  ...
  if (diversitySurrogate.viewImageDescriptions) {
    const BoolValue3 = wrappers.BoolValue;
    const tagResult6 = tag.tag(7, _mod1186.WireType.LengthDelimited);
    const joined4 = BoolValue3.internalBinaryWrite(diversitySurrogate.viewImageDescriptions, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = BoolValue3.internalBinaryWrite(diversitySurrogate.viewImageDescriptions, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.showCommandSuggestions) {
    const BoolValue4 = wrappers.BoolValue;
    const tagResult7 = tag.tag(8, _mod1186.WireType.LengthDelimited);
    const joined5 = BoolValue4.internalBinaryWrite(diversitySurrogate.showCommandSuggestions, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = BoolValue4.internalBinaryWrite(diversitySurrogate.showCommandSuggestions, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.inlineAttachmentMedia) {
    const BoolValue5 = wrappers.BoolValue;
    const tagResult8 = tag.tag(9, _mod1186.WireType.LengthDelimited);
    const joined6 = BoolValue5.internalBinaryWrite(diversitySurrogate.inlineAttachmentMedia, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = BoolValue5.internalBinaryWrite(diversitySurrogate.inlineAttachmentMedia, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.inlineEmbedMedia) {
    const BoolValue6 = wrappers.BoolValue;
    const tagResult9 = tag.tag(10, _mod1186.WireType.LengthDelimited);
    const joined7 = BoolValue6.internalBinaryWrite(diversitySurrogate.inlineEmbedMedia, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = BoolValue6.internalBinaryWrite(diversitySurrogate.inlineEmbedMedia, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.gifAutoPlay) {
    const BoolValue7 = wrappers.BoolValue;
    const tagResult10 = tag.tag(11, _mod1186.WireType.LengthDelimited);
    const joined8 = BoolValue7.internalBinaryWrite(diversitySurrogate.gifAutoPlay, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = BoolValue7.internalBinaryWrite(diversitySurrogate.gifAutoPlay, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.renderEmbeds) {
    const BoolValue8 = wrappers.BoolValue;
    const tagResult11 = tag.tag(12, _mod1186.WireType.LengthDelimited);
    const joined9 = BoolValue8.internalBinaryWrite(diversitySurrogate.renderEmbeds, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult9 = BoolValue8.internalBinaryWrite(diversitySurrogate.renderEmbeds, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.renderReactions) {
    const BoolValue9 = wrappers.BoolValue;
    const tagResult12 = tag.tag(13, _mod1186.WireType.LengthDelimited);
    const joined10 = BoolValue9.internalBinaryWrite(diversitySurrogate.renderReactions, tag.tag(13, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult10 = BoolValue9.internalBinaryWrite(diversitySurrogate.renderReactions, tag.tag(13, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.animateEmoji) {
    const BoolValue10 = wrappers.BoolValue;
    const tagResult13 = tag.tag(14, _mod1186.WireType.LengthDelimited);
    const joined11 = BoolValue10.internalBinaryWrite(diversitySurrogate.animateEmoji, tag.tag(14, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult11 = BoolValue10.internalBinaryWrite(diversitySurrogate.animateEmoji, tag.tag(14, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.animateStickers) {
    const UInt32Value = wrappers.UInt32Value;
    const tagResult14 = tag.tag(15, _mod1186.WireType.LengthDelimited);
    const joined12 = UInt32Value.internalBinaryWrite(diversitySurrogate.animateStickers, tag.tag(15, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult12 = UInt32Value.internalBinaryWrite(diversitySurrogate.animateStickers, tag.tag(15, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.enableTtsCommand) {
    const BoolValue11 = wrappers.BoolValue;
    const tagResult15 = tag.tag(16, _mod1186.WireType.LengthDelimited);
    const joined13 = BoolValue11.internalBinaryWrite(diversitySurrogate.enableTtsCommand, tag.tag(16, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult13 = BoolValue11.internalBinaryWrite(diversitySurrogate.enableTtsCommand, tag.tag(16, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.messageDisplayCompact) {
    const BoolValue12 = wrappers.BoolValue;
    const tagResult16 = tag.tag(17, _mod1186.WireType.LengthDelimited);
    const joined14 = BoolValue12.internalBinaryWrite(diversitySurrogate.messageDisplayCompact, tag.tag(17, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult14 = BoolValue12.internalBinaryWrite(diversitySurrogate.messageDisplayCompact, tag.tag(17, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.explicitContentFilter) {
    ...
    const joined15 = UInt32Value2.internalBinaryWrite(diversitySurrogate.explicitContentFilter, tag.tag(19, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult15 = UInt32Value2.internalBinaryWrite(diversitySurrogate.explicitContentFilter, tag.tag(19, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.viewNsfwGuilds) {
    ...
    const joined16 = BoolValue13.internalBinaryWrite(diversitySurrogate.viewNsfwGuilds, tag.tag(20, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult16 = BoolValue13.internalBinaryWrite(diversitySurrogate.viewNsfwGuilds, tag.tag(20, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.convertEmoticons) {
    ...
    const joined17 = BoolValue14.internalBinaryWrite(diversitySurrogate.convertEmoticons, tag.tag(21, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult17 = BoolValue14.internalBinaryWrite(diversitySurrogate.convertEmoticons, tag.tag(21, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.expressionSuggestionsEnabled) {
    ...
    const joined18 = BoolValue15.internalBinaryWrite(diversitySurrogate.expressionSuggestionsEnabled, tag.tag(22, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult18 = BoolValue15.internalBinaryWrite(diversitySurrogate.expressionSuggestionsEnabled, tag.tag(22, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.viewNsfwCommands) {
    ...
    const joined19 = BoolValue16.internalBinaryWrite(diversitySurrogate.viewNsfwCommands, tag.tag(23, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult19 = BoolValue16.internalBinaryWrite(diversitySurrogate.viewNsfwCommands, tag.tag(23, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.useLegacyChatInput) {
    ...
    const joined20 = BoolValue17.internalBinaryWrite(diversitySurrogate.useLegacyChatInput, tag.tag(24, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult20 = BoolValue17.internalBinaryWrite(diversitySurrogate.useLegacyChatInput, tag.tag(24, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let num24 = 0;
  ...
  if (diversitySurrogate.dmSpamFilter) {
    ...
    const joined21 = UInt32Value3.internalBinaryWrite(diversitySurrogate.dmSpamFilter, tag.tag(26, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult21 = UInt32Value3.internalBinaryWrite(diversitySurrogate.dmSpamFilter, tag.tag(26, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (diversitySurrogate.includeStickersInAutocomplete) {
    ...
    const joined22 = BoolValue18.internalBinaryWrite(diversitySurrogate.includeStickersInAutocomplete, tag.tag(28, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult22 = BoolValue18.internalBinaryWrite(diversitySurrogate.includeStickersInAutocomplete, tag.tag(28, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.explicitContentSettings) {
    const tagResult27 = tag.tag(29, _mod1186.WireType.LengthDelimited);
    const joined23 = closure_37.internalBinaryWrite(diversitySurrogate.explicitContentSettings, tag.tag(29, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult23 = closure_37.internalBinaryWrite(diversitySurrogate.explicitContentSettings, tag.tag(29, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.keywordFilterSettings) {
    const tagResult28 = tag.tag(30, _mod1186.WireType.LengthDelimited);
    const joined24 = closure_40.internalBinaryWrite(diversitySurrogate.keywordFilterSettings, tag.tag(30, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult24 = closure_40.internalBinaryWrite(diversitySurrogate.keywordFilterSettings, tag.tag(30, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.includeSoundmojiInAutocomplete) {
    ...
    const joined25 = BoolValue19.internalBinaryWrite(diversitySurrogate.includeSoundmojiInAutocomplete, tag.tag(31, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult25 = BoolValue19.internalBinaryWrite(diversitySurrogate.includeSoundmojiInAutocomplete, tag.tag(31, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.goreContentSettings) {
    const tagResult30 = tag.tag(32, _mod1186.WireType.LengthDelimited);
    const joined26 = closure_38.internalBinaryWrite(diversitySurrogate.goreContentSettings, tag.tag(32, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult26 = closure_38.internalBinaryWrite(diversitySurrogate.goreContentSettings, tag.tag(32, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.defaultReactionEmoji) {
    const tagResult31 = tag.tag(33, _mod1186.WireType.LengthDelimited);
    const joined27 = inAppFeedbackStateType.internalBinaryWrite(diversitySurrogate.defaultReactionEmoji, tag.tag(33, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult27 = inAppFeedbackStateType.internalBinaryWrite(diversitySurrogate.defaultReactionEmoji, tag.tag(33, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.showMentionSuggestions) {
    ...
    const joined28 = BoolValue20.internalBinaryWrite(diversitySurrogate.showMentionSuggestions, tag.tag(34, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult28 = BoolValue20.internalBinaryWrite(diversitySurrogate.showMentionSuggestions, tag.tag(34, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.selfHarmContentSettings) {
    const tagResult33 = tag.tag(35, _mod1186.WireType.LengthDelimited);
    const joined29 = closure_39.internalBinaryWrite(diversitySurrogate.selfHarmContentSettings, tag.tag(35, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult29 = closure_39.internalBinaryWrite(diversitySurrogate.selfHarmContentSettings, tag.tag(35, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.isCrossDmSearchEnabled) {
    ...
    const joined30 = BoolValue21.internalBinaryWrite(diversitySurrogate.isCrossDmSearchEnabled, tag.tag(36, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult30 = BoolValue21.internalBinaryWrite(diversitySurrogate.isCrossDmSearchEnabled, tag.tag(36, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (diversitySurrogate.customSearchUrl) {
    ...
    const joined31 = StringValue3.internalBinaryWrite(diversitySurrogate.customSearchUrl, tag.tag(38, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult31 = StringValue3.internalBinaryWrite(diversitySurrogate.customSearchUrl, tag.tag(38, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (diversitySurrogate.includeGameMentionsInAutocomplete) {
    ...
    const joined32 = BoolValue22.internalBinaryWrite(diversitySurrogate.includeGameMentionsInAutocomplete, tag.tag(39, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult32 = BoolValue22.internalBinaryWrite(diversitySurrogate.includeGameMentionsInAutocomplete, tag.tag(39, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype19["internalBinaryWrite"] = function internalBinaryWrite(showInAppNotifications, tag, writeUnknownFields) {
  if (showInAppNotifications.showInAppNotifications) {
    const BoolValue = wrappers.BoolValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = BoolValue.internalBinaryWrite(showInAppNotifications.showInAppNotifications, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = BoolValue.internalBinaryWrite(showInAppNotifications.showInAppNotifications, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.notifyFriendsOnGoLive) {
    const BoolValue2 = wrappers.BoolValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = BoolValue2.internalBinaryWrite(showInAppNotifications.notifyFriendsOnGoLive, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = BoolValue2.internalBinaryWrite(showInAppNotifications.notifyFriendsOnGoLive, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (showInAppNotifications.enableBurstReactionNotifications) {
    const BoolValue3 = wrappers.BoolValue;
    const tagResult3 = tag.tag(4, _mod1186.WireType.LengthDelimited);
    const joined2 = BoolValue3.internalBinaryWrite(showInAppNotifications.enableBurstReactionNotifications, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = BoolValue3.internalBinaryWrite(showInAppNotifications.enableBurstReactionNotifications, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.quietMode) {
    const BoolValue4 = wrappers.BoolValue;
    const tagResult4 = tag.tag(5, _mod1186.WireType.LengthDelimited);
    const joined3 = BoolValue4.internalBinaryWrite(showInAppNotifications.quietMode, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = BoolValue4.internalBinaryWrite(showInAppNotifications.quietMode, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (showInAppNotifications.gameActivityExcludeSteamNotifications) {
    const BoolValue5 = wrappers.BoolValue;
    const tagResult9 = tag.tag(10, _mod1186.WireType.LengthDelimited);
    const joined4 = BoolValue5.internalBinaryWrite(showInAppNotifications.gameActivityExcludeSteamNotifications, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = BoolValue5.internalBinaryWrite(showInAppNotifications.gameActivityExcludeSteamNotifications, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableVoiceActivityNotifications) {
    const BoolValue6 = wrappers.BoolValue;
    const tagResult10 = tag.tag(11, _mod1186.WireType.LengthDelimited);
    const joined5 = BoolValue6.internalBinaryWrite(showInAppNotifications.enableVoiceActivityNotifications, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = BoolValue6.internalBinaryWrite(showInAppNotifications.enableVoiceActivityNotifications, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableFriendOnlineNotifications) {
    const BoolValue7 = wrappers.BoolValue;
    const tagResult11 = tag.tag(12, _mod1186.WireType.LengthDelimited);
    const joined6 = BoolValue7.internalBinaryWrite(showInAppNotifications.enableFriendOnlineNotifications, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = BoolValue7.internalBinaryWrite(showInAppNotifications.enableFriendOnlineNotifications, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableUserResurrectionNotifications) {
    const BoolValue8 = wrappers.BoolValue;
    const tagResult12 = tag.tag(13, _mod1186.WireType.LengthDelimited);
    const joined7 = BoolValue8.internalBinaryWrite(showInAppNotifications.enableUserResurrectionNotifications, tag.tag(13, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = BoolValue8.internalBinaryWrite(showInAppNotifications.enableUserResurrectionNotifications, tag.tag(13, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableFriendAnniversaryNotifications) {
    const BoolValue9 = wrappers.BoolValue;
    const tagResult13 = tag.tag(14, _mod1186.WireType.LengthDelimited);
    const joined8 = BoolValue9.internalBinaryWrite(showInAppNotifications.enableFriendAnniversaryNotifications, tag.tag(14, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = BoolValue9.internalBinaryWrite(showInAppNotifications.enableFriendAnniversaryNotifications, tag.tag(14, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableGameUpdateNotifications) {
    const BoolValue10 = wrappers.BoolValue;
    const tagResult14 = tag.tag(15, _mod1186.WireType.LengthDelimited);
    const joined9 = BoolValue10.internalBinaryWrite(showInAppNotifications.enableGameUpdateNotifications, tag.tag(15, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult9 = BoolValue10.internalBinaryWrite(showInAppNotifications.enableGameUpdateNotifications, tag.tag(15, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableProfileUpdatesNotifications) {
    const BoolValue11 = wrappers.BoolValue;
    const tagResult15 = tag.tag(16, _mod1186.WireType.LengthDelimited);
    const joined10 = BoolValue11.internalBinaryWrite(showInAppNotifications.enableProfileUpdatesNotifications, tag.tag(16, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult10 = BoolValue11.internalBinaryWrite(showInAppNotifications.enableProfileUpdatesNotifications, tag.tag(16, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableServerTrendingNotifications) {
    const BoolValue12 = wrappers.BoolValue;
    const tagResult16 = tag.tag(17, _mod1186.WireType.LengthDelimited);
    const joined11 = BoolValue12.internalBinaryWrite(showInAppNotifications.enableServerTrendingNotifications, tag.tag(17, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult11 = BoolValue12.internalBinaryWrite(showInAppNotifications.enableServerTrendingNotifications, tag.tag(17, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableDmReplyNudgeReminders) {
    const BoolValue13 = wrappers.BoolValue;
    const tagResult17 = tag.tag(18, _mod1186.WireType.LengthDelimited);
    const joined12 = BoolValue13.internalBinaryWrite(showInAppNotifications.enableDmReplyNudgeReminders, tag.tag(18, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult12 = BoolValue13.internalBinaryWrite(showInAppNotifications.enableDmReplyNudgeReminders, tag.tag(18, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableSummaryReminderNotifications) {
    const BoolValue14 = wrappers.BoolValue;
    const tagResult18 = tag.tag(19, _mod1186.WireType.LengthDelimited);
    const joined13 = BoolValue14.internalBinaryWrite(showInAppNotifications.enableSummaryReminderNotifications, tag.tag(19, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult13 = BoolValue14.internalBinaryWrite(showInAppNotifications.enableSummaryReminderNotifications, tag.tag(19, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableGdmAllReactionNotifications) {
    const BoolValue15 = wrappers.BoolValue;
    const tagResult19 = tag.tag(20, _mod1186.WireType.LengthDelimited);
    const joined14 = BoolValue15.internalBinaryWrite(showInAppNotifications.enableGdmAllReactionNotifications, tag.tag(20, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult14 = BoolValue15.internalBinaryWrite(showInAppNotifications.enableGdmAllReactionNotifications, tag.tag(20, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableFriendGamingActivityNotifications) {
    const BoolValue16 = wrappers.BoolValue;
    const tagResult20 = tag.tag(21, _mod1186.WireType.LengthDelimited);
    const joined15 = BoolValue16.internalBinaryWrite(showInAppNotifications.enableFriendGamingActivityNotifications, tag.tag(21, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult15 = BoolValue16.internalBinaryWrite(showInAppNotifications.enableFriendGamingActivityNotifications, tag.tag(21, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableUpcomingServerEventNotifications) {
    const BoolValue17 = wrappers.BoolValue;
    const tagResult21 = tag.tag(22, _mod1186.WireType.LengthDelimited);
    const joined16 = BoolValue17.internalBinaryWrite(showInAppNotifications.enableUpcomingServerEventNotifications, tag.tag(22, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult16 = BoolValue17.internalBinaryWrite(showInAppNotifications.enableUpcomingServerEventNotifications, tag.tag(22, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.enableScreenDowntimeScheduleNotifications) {
    const BoolValue18 = wrappers.BoolValue;
    const tagResult22 = tag.tag(23, _mod1186.WireType.LengthDelimited);
    const joined17 = BoolValue18.internalBinaryWrite(showInAppNotifications.enableScreenDowntimeScheduleNotifications, tag.tag(23, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult17 = BoolValue18.internalBinaryWrite(showInAppNotifications.enableScreenDowntimeScheduleNotifications, tag.tag(23, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.notifyFriendsOnProfileUpdate) {
    const BoolValue19 = wrappers.BoolValue;
    const tagResult23 = tag.tag(24, _mod1186.WireType.LengthDelimited);
    const joined18 = BoolValue19.internalBinaryWrite(showInAppNotifications.notifyFriendsOnProfileUpdate, tag.tag(24, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult18 = BoolValue19.internalBinaryWrite(showInAppNotifications.notifyFriendsOnProfileUpdate, tag.tag(24, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (showInAppNotifications.notifyFriendsOnComeOnline) {
    const BoolValue20 = wrappers.BoolValue;
    const tagResult24 = tag.tag(25, _mod1186.WireType.LengthDelimited);
    const joined19 = BoolValue20.internalBinaryWrite(showInAppNotifications.notifyFriendsOnComeOnline, tag.tag(25, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult19 = BoolValue20.internalBinaryWrite(showInAppNotifications.notifyFriendsOnComeOnline, tag.tag(25, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype20["internalBinaryWrite"] = function internalBinaryWrite(allowActivityPartyPrivacyFriends, tag, writeUnknownFields) {
  ...
  if (allowActivityPartyPrivacyFriends.allowActivityPartyPrivacyFriends) {
    const BoolValue = wrappers.BoolValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = BoolValue.internalBinaryWrite(allowActivityPartyPrivacyFriends.allowActivityPartyPrivacyFriends, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = BoolValue.internalBinaryWrite(allowActivityPartyPrivacyFriends.allowActivityPartyPrivacyFriends, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.allowActivityPartyPrivacyVoiceChannel) {
    const BoolValue2 = wrappers.BoolValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = BoolValue2.internalBinaryWrite(allowActivityPartyPrivacyFriends.allowActivityPartyPrivacyVoiceChannel, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = BoolValue2.internalBinaryWrite(allowActivityPartyPrivacyFriends.allowActivityPartyPrivacyVoiceChannel, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (allowActivityPartyPrivacyFriends.detectPlatformAccounts) {
    ...
    const joined3 = BoolValue3.internalBinaryWrite(allowActivityPartyPrivacyFriends.detectPlatformAccounts, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = BoolValue3.internalBinaryWrite(allowActivityPartyPrivacyFriends.detectPlatformAccounts, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.passwordless) {
    const BoolValue4 = wrappers.BoolValue;
    const tagResult6 = tag.tag(9, _mod1186.WireType.LengthDelimited);
    const joined4 = BoolValue4.internalBinaryWrite(allowActivityPartyPrivacyFriends.passwordless, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = BoolValue4.internalBinaryWrite(allowActivityPartyPrivacyFriends.passwordless, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.contactSyncEnabled) {
    const BoolValue5 = wrappers.BoolValue;
    const tagResult7 = tag.tag(10, _mod1186.WireType.LengthDelimited);
    const joined5 = BoolValue5.internalBinaryWrite(allowActivityPartyPrivacyFriends.contactSyncEnabled, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = BoolValue5.internalBinaryWrite(allowActivityPartyPrivacyFriends.contactSyncEnabled, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.friendSourceFlags) {
    const UInt32Value = wrappers.UInt32Value;
    const tagResult8 = tag.tag(11, _mod1186.WireType.LengthDelimited);
    const joined6 = UInt32Value.internalBinaryWrite(allowActivityPartyPrivacyFriends.friendSourceFlags, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = UInt32Value.internalBinaryWrite(allowActivityPartyPrivacyFriends.friendSourceFlags, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.friendDiscoveryFlags) {
    const UInt32Value2 = wrappers.UInt32Value;
    const tagResult9 = tag.tag(12, _mod1186.WireType.LengthDelimited);
    const joined7 = UInt32Value2.internalBinaryWrite(allowActivityPartyPrivacyFriends.friendDiscoveryFlags, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = UInt32Value2.internalBinaryWrite(allowActivityPartyPrivacyFriends.friendDiscoveryFlags, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (allowActivityPartyPrivacyFriends.defaultMessageRequestRestricted) {
    ...
    const joined11 = BoolValue6.internalBinaryWrite(allowActivityPartyPrivacyFriends.defaultMessageRequestRestricted, tag.tag(17, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = BoolValue6.internalBinaryWrite(allowActivityPartyPrivacyFriends.defaultMessageRequestRestricted, tag.tag(17, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.dropsOptedOut) {
    const BoolValue7 = wrappers.BoolValue;
    const tagResult15 = tag.tag(18, _mod1186.WireType.LengthDelimited);
    const joined12 = BoolValue7.internalBinaryWrite(allowActivityPartyPrivacyFriends.dropsOptedOut, tag.tag(18, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = BoolValue7.internalBinaryWrite(allowActivityPartyPrivacyFriends.dropsOptedOut, tag.tag(18, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.nonSpamRetrainingOptIn) {
    const BoolValue8 = wrappers.BoolValue;
    const tagResult16 = tag.tag(19, _mod1186.WireType.LengthDelimited);
    const joined13 = BoolValue8.internalBinaryWrite(allowActivityPartyPrivacyFriends.nonSpamRetrainingOptIn, tag.tag(19, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult9 = BoolValue8.internalBinaryWrite(allowActivityPartyPrivacyFriends.nonSpamRetrainingOptIn, tag.tag(19, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.familyCenterEnabled) {
    const BoolValue9 = wrappers.BoolValue;
    const tagResult17 = tag.tag(20, _mod1186.WireType.LengthDelimited);
    const joined14 = BoolValue9.internalBinaryWrite(allowActivityPartyPrivacyFriends.familyCenterEnabled, tag.tag(20, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult10 = BoolValue9.internalBinaryWrite(allowActivityPartyPrivacyFriends.familyCenterEnabled, tag.tag(20, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.familyCenterEnabledV2) {
    const BoolValue10 = wrappers.BoolValue;
    const tagResult18 = tag.tag(21, _mod1186.WireType.LengthDelimited);
    const joined15 = BoolValue10.internalBinaryWrite(allowActivityPartyPrivacyFriends.familyCenterEnabledV2, tag.tag(21, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult11 = BoolValue10.internalBinaryWrite(allowActivityPartyPrivacyFriends.familyCenterEnabledV2, tag.tag(21, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.hideLegacyUsername) {
    const BoolValue11 = wrappers.BoolValue;
    const tagResult19 = tag.tag(22, _mod1186.WireType.LengthDelimited);
    const joined16 = BoolValue11.internalBinaryWrite(allowActivityPartyPrivacyFriends.hideLegacyUsername, tag.tag(22, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult12 = BoolValue11.internalBinaryWrite(allowActivityPartyPrivacyFriends.hideLegacyUsername, tag.tag(22, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.inappropriateConversationWarnings) {
    ...
    const joined17 = BoolValue12.internalBinaryWrite(allowActivityPartyPrivacyFriends.inappropriateConversationWarnings, tag.tag(23, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult13 = BoolValue12.internalBinaryWrite(allowActivityPartyPrivacyFriends.inappropriateConversationWarnings, tag.tag(23, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.recentGamesEnabled) {
    const BoolValue13 = wrappers.BoolValue;
    const tagResult21 = tag.tag(24, _mod1186.WireType.LengthDelimited);
    const joined18 = BoolValue13.internalBinaryWrite(allowActivityPartyPrivacyFriends.recentGamesEnabled, tag.tag(24, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult14 = BoolValue13.internalBinaryWrite(allowActivityPartyPrivacyFriends.recentGamesEnabled, tag.tag(24, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (allowActivityPartyPrivacyFriends.allowGameFriendDmsInDiscord) {
    ...
    const joined19 = BoolValue14.internalBinaryWrite(allowActivityPartyPrivacyFriends.allowGameFriendDmsInDiscord, tag.tag(26, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult15 = BoolValue14.internalBinaryWrite(allowActivityPartyPrivacyFriends.allowGameFriendDmsInDiscord, tag.tag(26, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.defaultGuildsRestrictedV2) {
    ...
    const joined20 = BoolValue15.internalBinaryWrite(allowActivityPartyPrivacyFriends.defaultGuildsRestrictedV2, tag.tag(27, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult16 = BoolValue15.internalBinaryWrite(allowActivityPartyPrivacyFriends.defaultGuildsRestrictedV2, tag.tag(27, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (allowActivityPartyPrivacyFriends.quests3PDataOptedOut) {
    ...
    const joined21 = BoolValue16.internalBinaryWrite(allowActivityPartyPrivacyFriends.quests3PDataOptedOut, tag.tag(30, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult17 = BoolValue16.internalBinaryWrite(allowActivityPartyPrivacyFriends.quests3PDataOptedOut, tag.tag(30, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (allowActivityPartyPrivacyFriends.showLocalTime) {
    const BoolValue17 = wrappers.BoolValue;
    const tagResult28 = tag.tag(31, _mod1186.WireType.LengthDelimited);
    const joined22 = BoolValue17.internalBinaryWrite(allowActivityPartyPrivacyFriends.showLocalTime, tag.tag(31, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult18 = BoolValue17.internalBinaryWrite(allowActivityPartyPrivacyFriends.showLocalTime, tag.tag(31, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (allowActivityPartyPrivacyFriends.hideFriendRequestNotes) {
    ...
    const joined23 = BoolValue18.internalBinaryWrite(allowActivityPartyPrivacyFriends.hideFriendRequestNotes, tag.tag(33, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult19 = BoolValue18.internalBinaryWrite(allowActivityPartyPrivacyFriends.hideFriendRequestNotes, tag.tag(33, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype21["internalBinaryWrite"] = function internalBinaryWrite(rtcPanelShowVoiceStates, tag, writeUnknownFields) {
  if (rtcPanelShowVoiceStates.rtcPanelShowVoiceStates) {
    const BoolValue = wrappers.BoolValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = BoolValue.internalBinaryWrite(rtcPanelShowVoiceStates.rtcPanelShowVoiceStates, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = BoolValue.internalBinaryWrite(rtcPanelShowVoiceStates.rtcPanelShowVoiceStates, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype22["internalBinaryWrite"] = function internalBinaryWrite(installShortcutDesktop, tag, writeUnknownFields) {
  if (installShortcutDesktop.installShortcutDesktop) {
    const BoolValue = wrappers.BoolValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = BoolValue.internalBinaryWrite(installShortcutDesktop.installShortcutDesktop, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = BoolValue.internalBinaryWrite(installShortcutDesktop.installShortcutDesktop, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (installShortcutDesktop.installShortcutStartMenu) {
    const BoolValue2 = wrappers.BoolValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = BoolValue2.internalBinaryWrite(installShortcutDesktop.installShortcutStartMenu, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = BoolValue2.internalBinaryWrite(installShortcutDesktop.installShortcutStartMenu, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (installShortcutDesktop.disableGamesTab) {
    const BoolValue3 = wrappers.BoolValue;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = BoolValue3.internalBinaryWrite(installShortcutDesktop.disableGamesTab, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = BoolValue3.internalBinaryWrite(installShortcutDesktop.disableGamesTab, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype23["internalBinaryWrite"] = function internalBinaryWrite(status, tag, writeUnknownFields) {
  if (status.status) {
    const StringValue = wrappers.StringValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = StringValue.internalBinaryWrite(status.status, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = StringValue.internalBinaryWrite(status.status, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (status.customStatus) {
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = closure_47.internalBinaryWrite(status.customStatus, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = closure_47.internalBinaryWrite(status.customStatus, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (status.showCurrentGame) {
    const BoolValue = wrappers.BoolValue;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = BoolValue.internalBinaryWrite(status.showCurrentGame, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = BoolValue.internalBinaryWrite(status.showCurrentGame, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (status.statusCreatedAtMs) {
    const UInt64Value = wrappers.UInt64Value;
    const tagResult4 = tag.tag(5, _mod1186.WireType.LengthDelimited);
    const joined3 = UInt64Value.internalBinaryWrite(status.statusCreatedAtMs, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = UInt64Value.internalBinaryWrite(status.statusCreatedAtMs, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype24["internalBinaryWrite"] = function internalBinaryWrite(text, tag, writeUnknownFields) {
  ...
  if (text.label) {
    const StringValue = wrappers.StringValue;
    const tagResult5 = tag.tag(6, _mod1186.WireType.LengthDelimited);
    const joined = StringValue.internalBinaryWrite(text.label, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = StringValue.internalBinaryWrite(text.label, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype25["internalBinaryWrite"] = function internalBinaryWrite(locale, tag, writeUnknownFields) {
  if (locale.locale) {
    const StringValue = wrappers.StringValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = StringValue.internalBinaryWrite(locale.locale, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = StringValue.internalBinaryWrite(locale.locale, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (locale.timezoneOffset) {
    const Int32Value = wrappers.Int32Value;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = Int32Value.internalBinaryWrite(locale.timezoneOffset, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = Int32Value.internalBinaryWrite(locale.timezoneOffset, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (locale.timezoneName) {
    const StringValue2 = wrappers.StringValue;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = StringValue2.internalBinaryWrite(locale.timezoneName, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = StringValue2.internalBinaryWrite(locale.timezoneName, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype26["internalBinaryWrite"] = function internalBinaryWrite(layout, tag, writeUnknownFields) {
  if (layout.layout) {
    const StringValue = wrappers.StringValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = StringValue.internalBinaryWrite(layout.layout, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = StringValue.internalBinaryWrite(layout.layout, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (layout.messagePreviews) {
    const StringValue2 = wrappers.StringValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = StringValue2.internalBinaryWrite(layout.messagePreviews, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = StringValue2.internalBinaryWrite(layout.messagePreviews, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype27["internalBinaryWrite"] = function internalBinaryWrite(theme, tag, writeUnknownFields) {
  ...
  if (theme.clientThemeSettings) {
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined = closure_52.internalBinaryWrite(theme.clientThemeSettings, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_52.internalBinaryWrite(theme.clientThemeSettings, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (theme.channelListLayout) {
    const StringValue = wrappers.StringValue;
    const tagResult4 = tag.tag(6, _mod1186.WireType.LengthDelimited);
    const joined1 = StringValue.internalBinaryWrite(theme.channelListLayout, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = StringValue.internalBinaryWrite(theme.channelListLayout, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (theme.messagePreviews) {
    const StringValue2 = wrappers.StringValue;
    const tagResult5 = tag.tag(7, _mod1186.WireType.LengthDelimited);
    const joined2 = StringValue2.internalBinaryWrite(theme.messagePreviews, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = StringValue2.internalBinaryWrite(theme.messagePreviews, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (theme.searchResultExactCountEnabled) {
    const BoolValue = wrappers.BoolValue;
    const tagResult6 = tag.tag(8, _mod1186.WireType.LengthDelimited);
    const joined3 = BoolValue.internalBinaryWrite(theme.searchResultExactCountEnabled, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = BoolValue.internalBinaryWrite(theme.searchResultExactCountEnabled, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (theme.happeningNowCardsDisabled) {
    const BoolValue2 = wrappers.BoolValue;
    const tagResult8 = tag.tag(10, _mod1186.WireType.LengthDelimited);
    const joined4 = BoolValue2.internalBinaryWrite(theme.happeningNowCardsDisabled, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = BoolValue2.internalBinaryWrite(theme.happeningNowCardsDisabled, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype29["internalBinaryWrite"] = function internalBinaryWrite(backgroundGradientPresetId, tag, writeUnknownFields) {
  if (backgroundGradientPresetId.backgroundGradientPresetId) {
    ...
    const joined = UInt32Value.internalBinaryWrite(backgroundGradientPresetId.backgroundGradientPresetId, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = UInt32Value.internalBinaryWrite(backgroundGradientPresetId.backgroundGradientPresetId, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (backgroundGradientPresetId.customUserThemeSettings) {
    const tagResult1 = tag.tag(4, _mod1186.WireType.LengthDelimited);
    const joined1 = closure_51.internalBinaryWrite(backgroundGradientPresetId.customUserThemeSettings, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = closure_51.internalBinaryWrite(backgroundGradientPresetId.customUserThemeSettings, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype31["internalBinaryWrite"] = function internalBinaryWrite(guildIds, tag, writeUnknownFields) {
  ...
  if (guildIds.id) {
    ...
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = Int64Value.internalBinaryWrite(guildIds.id, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = Int64Value.internalBinaryWrite(guildIds.id, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (guildIds.name) {
    const StringValue = wrappers.StringValue;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = StringValue.internalBinaryWrite(guildIds.name, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = StringValue.internalBinaryWrite(guildIds.name, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (guildIds.color) {
    const UInt64Value = wrappers.UInt64Value;
    const tagResult3 = tag.tag(4, _mod1186.WireType.LengthDelimited);
    const joined3 = UInt64Value.internalBinaryWrite(guildIds.color, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = UInt64Value.internalBinaryWrite(guildIds.color, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype32["internalBinaryWrite"] = function internalBinaryWrite(favoriteChannels, tag, writeUnknownFields) {
  ...
  if (favoriteChannels.guildVisible) {
    ...
    const joined2 = BoolValue.internalBinaryWrite(favoriteChannels.guildVisible, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = BoolValue.internalBinaryWrite(favoriteChannels.guildVisible, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype33["internalBinaryWrite"] = function internalBinaryWrite(nickname, tag, writeUnknownFields) {
  ...
  if (nickname.channelType) {
    const UInt32Value = wrappers.UInt32Value;
    const tagResult4 = tag.tag(5, _mod1186.WireType.LengthDelimited);
    const joined = UInt32Value.internalBinaryWrite(nickname.channelType, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = UInt32Value.internalBinaryWrite(nickname.channelType, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype36["internalBinaryWrite"] = function internalBinaryWrite(disableHomeAutoNav, tag, writeUnknownFields) {
  if (disableHomeAutoNav.disableHomeAutoNav) {
    const BoolValue = wrappers.BoolValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = BoolValue.internalBinaryWrite(disableHomeAutoNav.disableHomeAutoNav, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = BoolValue.internalBinaryWrite(disableHomeAutoNav.disableHomeAutoNav, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype39["internalBinaryWrite"] = function internalBinaryWrite(allowFriends, tag, writeUnknownFields) {
  ...
  if (allowFriends.allowFriends) {
    const BoolValue = wrappers.BoolValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = BoolValue.internalBinaryWrite(allowFriends.allowFriends, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = BoolValue.internalBinaryWrite(allowFriends.allowFriends, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  if (allowFriends.autoBroadcast) {
    const BoolValue2 = wrappers.BoolValue;
    const tagResult3 = tag.tag(4, _mod1186.WireType.LengthDelimited);
    const joined3 = BoolValue2.internalBinaryWrite(allowFriends.autoBroadcast, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = BoolValue2.internalBinaryWrite(allowFriends.autoBroadcast, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype40["internalBinaryWrite"] = function internalBinaryWrite(allowVoiceRecording, tag, writeUnknownFields) {
  if (allowVoiceRecording.allowVoiceRecording) {
    const BoolValue = wrappers.BoolValue;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = BoolValue.internalBinaryWrite(allowVoiceRecording.allowVoiceRecording, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = BoolValue.internalBinaryWrite(allowVoiceRecording.allowVoiceRecording, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype42["internalBinaryWrite"] = function internalBinaryWrite(oneTimePurchaseLimit, tag, writeUnknownFields) {
  if (oneTimePurchaseLimit.oneTimePurchaseLimit) {
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = closure_64.internalBinaryWrite(oneTimePurchaseLimit.oneTimePurchaseLimit, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_64.internalBinaryWrite(oneTimePurchaseLimit.oneTimePurchaseLimit, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype43["internalBinaryWrite"] = function internalBinaryWrite(safetySettingsPreset, tag, writeUnknownFields) {
  ...
  if (safetySettingsPreset.spendingLimitSettings) {
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined = closure_65.internalBinaryWrite(safetySettingsPreset.spendingLimitSettings, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_65.internalBinaryWrite(safetySettingsPreset.spendingLimitSettings, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype47["internalBinaryWrite"] = function internalBinaryWrite(appDmSettings, tag, writeUnknownFields) {
  if (appDmSettings.appDmSettings) {
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = closure_71.internalBinaryWrite(appDmSettings.appDmSettings, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_71.internalBinaryWrite(appDmSettings.appDmSettings, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (appDmSettings.appSharingSettings) {
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = closure_72.internalBinaryWrite(appDmSettings.appSharingSettings, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = closure_72.internalBinaryWrite(appDmSettings.appSharingSettings, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype51["internalBinaryWrite"] = function internalBinaryWrite(lastImpressionTime, tag, writeUnknownFields) {
  if (lastImpressionTime.lastImpressionTime) {
    const UInt64Value = wrappers.UInt64Value;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = UInt64Value.internalBinaryWrite(lastImpressionTime.lastImpressionTime, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = UInt64Value.internalBinaryWrite(lastImpressionTime.lastImpressionTime, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (lastImpressionTime.optOutExpiryTime) {
    const UInt64Value2 = wrappers.UInt64Value;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = UInt64Value2.internalBinaryWrite(lastImpressionTime.optOutExpiryTime, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = UInt64Value2.internalBinaryWrite(lastImpressionTime.optOutExpiryTime, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype52["internalBinaryWrite"] = function internalBinaryWrite(emojiId, tag, writeUnknownFields) {
  if (emojiId.emojiId) {
    const UInt64Value = wrappers.UInt64Value;
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
    const joined = UInt64Value.internalBinaryWrite(emojiId.emojiId, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = UInt64Value.internalBinaryWrite(emojiId.emojiId, tag.tag(1, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (emojiId.emojiName) {
    const StringValue = wrappers.StringValue;
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
    const joined1 = StringValue.internalBinaryWrite(emojiId.emojiName, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = StringValue.internalBinaryWrite(emojiId.emojiName, tag.tag(2, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (emojiId.animated) {
    const BoolValue = wrappers.BoolValue;
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
    const joined2 = BoolValue.internalBinaryWrite(emojiId.animated, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = BoolValue.internalBinaryWrite(emojiId.animated, tag.tag(3, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (emojiId.disableDoubleTap) {
    const BoolValue2 = wrappers.BoolValue;
    const tagResult3 = tag.tag(4, _mod1186.WireType.LengthDelimited);
    const joined3 = BoolValue2.internalBinaryWrite(emojiId.disableDoubleTap, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = BoolValue2.internalBinaryWrite(emojiId.disableDoubleTap, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
