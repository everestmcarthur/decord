...
// Dependencies: [502, 1074, 1249, 573, 7735, 1241, 7746, 7747, 2]

// Module 7734 (stores/AnalyticsTrackingStore)
...
const obj2 = {
  ...
  scheduleWhenIdle: fn(7746).requestSafeIdleCallback,
  sendUnloadRequest: fn(7747).sendUnloadRequest
};
