...
// Dependencies: [8683, 8010, 8684, 8686, 8687, 504, 573, 2]

// Module 8682 (InstantInviteStore)
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import headDefault from "head" /* 8684 */;
import reverseDefault from "reverse" /* 8686 */;
...
const instantInviteStore = new InstantInviteStore(DispatcherDefault, {
  ...
  FRIEND_INVITE_CREATE_SUCCESS: function handleFriendInviteCreateSuccess(invite) {
    ...
    let tmpResult = tmp(tmp2(_modDef8687(Object.values(closure_8), "createdAt")));
    if (tmpResult == null) {
      tmpResult = null;
    }
    c2 = tmpResult;
  ...
  FRIEND_INVITE_REVOKE_SUCCESS: function handleFriendInviteRevokeSuccess(invites) {
    ...
    let tmp2Result = tmp2(tmp3(_modDef8687(Object.values(closure_8), "createdAt")));
    if (tmp2Result == null) {
      tmp2Result = null;
    }
    c2 = tmp2Result;
