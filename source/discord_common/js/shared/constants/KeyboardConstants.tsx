...
// Module 7614 (KeyboardConstants)
import _mod7615 from "module_7615" /* 7615 */;
import size from "module_2" /* 2 */;

const items = [_mod7615.Key.F6, "f6"];
const items1 = [items, , , , , , , ];
const items2 = [_mod7615.Key.Tab, "tab"];
items1[1] = items2;
const items3 = [_mod7615.Key.ArrowDown, "down"];
items1[2] = items3;
const items4 = [_mod7615.Key.ArrowUp, "up"];
items1[3] = items4;
const items5 = [_mod7615.Key.ArrowLeft, "left"];
items1[4] = items5;
const items6 = [_mod7615.Key.ArrowRight, "right"];
items1[5] = items6;
const items7 = [_mod7615.Key.Home, "home"];
items1[6] = items7;
const items8 = [_mod7615.Key.End, "end"];
items1[7] = items8;
...
export const KeyboardEventKey = _mod7615.Key;
export const FOCUS_SECTION_JUMP_KEY = _mod7615.Key.F6;
