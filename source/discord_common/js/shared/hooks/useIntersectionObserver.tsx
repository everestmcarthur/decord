...
// Dependencies: [19, 7748, 7749, 2]
// Exports: useIntersectionObserver, useIsVisible

// Module 7747 (useIntersectionObserver)
import InteractionObserverUtils from "InteractionObserverUtils" /* 7749 */;
...
export const useIntersectionObserver = function useIntersectionObserver(arg0, arg1) {
  ...
  const tmp3Result = flag(7748)(tmp4);
...
export const useIsVisible = function useIsVisible(arg0, arg1) {
  ...
  let current = num(7748)((isIntersecting) => {
  ...
  closure_129_2 = tmp6;
  let tmp8 = tmp4;
  const tmp3 = num(7748)((isIntersecting) => {
    closure_0(isIntersecting.isIntersecting);
  });
  ...
  const tmpResultResult = num(7748)(tmp8);
