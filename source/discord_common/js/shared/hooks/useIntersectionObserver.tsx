...
// Dependencies: [19, 7802, 7803, 2]
// Exports: useIntersectionObserver, useIsVisible

// Module 7801 (useIntersectionObserver)
import InteractionObserverUtils from "InteractionObserverUtils" /* 7803 */;
...
export const useIntersectionObserver = function useIntersectionObserver(arg0, arg1) {
  ...
  const tmp3Result = flag(7802)(tmp4);
...
export const useIsVisible = function useIsVisible(arg0, arg1) {
  ...
  let current = num(7802)((isIntersecting) => {
  ...
  closure_129_2 = tmp6;
  let tmp8 = tmp4;
  const tmp3 = num(7802)((isIntersecting) => {
    closure_0(isIntersecting.isIntersecting);
  });
  ...
  const tmpResultResult = num(7802)(tmp8);
