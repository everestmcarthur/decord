...
// Dependencies: [19, 7711, 7712, 2]
// Exports: useIntersectionObserver, useIsVisible

// Module 7710 (useIntersectionObserver)
import InteractionObserverUtils from "InteractionObserverUtils" /* 7712 */;
...
export const useIntersectionObserver = function useIntersectionObserver(arg0, arg1) {
  ...
  const tmp3Result = flag(7711)(tmp4);
...
export const useIsVisible = function useIsVisible(arg0, arg1) {
  ...
  let current = num(7711)((isIntersecting) => {
  ...
  closure_129_2 = tmp6;
  let tmp8 = tmp4;
  const tmp3 = num(7711)((isIntersecting) => {
    closure_0(isIntersecting.isIntersecting);
  });
  ...
  const tmpResultResult = num(7711)(tmp8);
