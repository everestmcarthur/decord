...
prototype["internalBinaryWrite"] = function internalBinaryWrite(localizations, tag, writeUnknownFields) {
  if ("" !== localizations.default) {
    tag.tag(1, _mod1188.WireType.LengthDelimited).string(localizations.default);
  ...
  while (iter !== undefined) {
    ...
    let tagResult3 = stringResult1.tag(2, _mod1188.WireType.LengthDelimited);
...
prototype2["internalBinaryWrite"] = function internalBinaryWrite(localizations, tag, writeUnknownFields) {
  if ("0" !== localizations.default) {
    tag.tag(1, _mod1188.WireType.Bit64).fixed64(localizations.default);
  ...
  while (iter !== undefined) {
    ...
    let tagResult3 = stringResult.tag(2, _mod1188.WireType.Bit64);
