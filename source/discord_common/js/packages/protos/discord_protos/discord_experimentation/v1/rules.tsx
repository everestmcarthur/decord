...
prototype["internalBinaryWrite"] = function internalBinaryWrite(type, tag, writeUnknownFields) {
  let length;
  if (0 !== type.type) {
    tag.tag(1, _mod1188.WireType.Varint).int32(type.type);
  ...
  if (type.override) {
    ...
    const joined1 = ruleType.internalBinaryWrite(type.override, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = ruleType.internalBinaryWrite(type.override, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== type.isSunsetRule) {
    tag.tag(4, _mod1188.WireType.Varint).bool(type.isSunsetRule);
    const tagResult3 = tag.tag(4, _mod1188.WireType.Varint);
  }
  if (0 !== type.subtype) {
    tag.tag(5, _mod1188.WireType.Varint).int32(type.subtype);
    const tagResult4 = tag.tag(5, _mod1188.WireType.Varint);
  }
  if ("" !== type.hash) {
    tag.tag(6, _mod1188.WireType.LengthDelimited).string(type.hash);
...
prototype2["internalBinaryWrite"] = function internalBinaryWrite(variationId, tag, writeUnknownFields) {
  if (0 !== variationId.variationId) {
    tag.tag(1, _mod1188.WireType.Varint).int32(variationId.variationId);
    const tagResult = tag.tag(1, _mod1188.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype3["create"] = function create(arr) {
  obj = { filter: { oneofKind: "disabled" }, negate: false };
  const _Object = Object;
  _Object.defineProperty(obj, _mod1188.MESSAGE_TYPE, { enumerable: false, value: this });
  if (undefined !== arr) {
    const result = _mod1188.reflectionMergePartial(this, obj, arr);
...
prototype3["internalBinaryWrite"] = function internalBinaryWrite(negate, tag, writeUnknownFields) {
  if ("clientVersion" === negate.filter.oneofKind) {
    ...
    const joined = sDKVersionSpecifierType.internalBinaryWrite(negate.filter.clientVersion, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = sDKVersionSpecifierType.internalBinaryWrite(negate.filter.clientVersion, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("clientOs" === negate.filter.oneofKind) {
    const tagResult1 = tag.tag(3, _mod1188.WireType.LengthDelimited);
    const joined1 = clientLocation_LocationType4.internalBinaryWrite(negate.filter.clientOs, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = clientLocation_LocationType4.internalBinaryWrite(negate.filter.clientOs, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("staff" === negate.filter.oneofKind) {
    const tagResult2 = tag.tag(4, _mod1188.WireType.LengthDelimited);
    const joined2 = overrideType.internalBinaryWrite(negate.filter.staff, tag.tag(4, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = overrideType.internalBinaryWrite(negate.filter.staff, tag.tag(4, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userInGuild" === negate.filter.oneofKind) {
    const tagResult3 = tag.tag(5, _mod1188.WireType.LengthDelimited);
    const joined3 = overrideType1.internalBinaryWrite(negate.filter.userInGuild, tag.tag(5, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = overrideType1.internalBinaryWrite(negate.filter.userInGuild, tag.tag(5, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userIds" === negate.filter.oneofKind) {
    const tagResult4 = tag.tag(6, _mod1188.WireType.LengthDelimited);
    const joined4 = overrideType2.internalBinaryWrite(negate.filter.userIds, tag.tag(6, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = overrideType2.internalBinaryWrite(negate.filter.userIds, tag.tag(6, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("clientLocale" === negate.filter.oneofKind) {
    const tagResult5 = tag.tag(7, _mod1188.WireType.LengthDelimited);
    const joined5 = overrideType4.internalBinaryWrite(negate.filter.clientLocale, tag.tag(7, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = overrideType4.internalBinaryWrite(negate.filter.clientLocale, tag.tag(7, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("clientLocation" === negate.filter.oneofKind) {
    const tagResult6 = tag.tag(8, _mod1188.WireType.LengthDelimited);
    const joined6 = overrideType6.internalBinaryWrite(negate.filter.clientLocation, tag.tag(8, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = overrideType6.internalBinaryWrite(negate.filter.clientLocation, tag.tag(8, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("clientIp" === negate.filter.oneofKind) {
    const tagResult7 = tag.tag(9, _mod1188.WireType.LengthDelimited);
    const joined7 = clientLocation_LocationType2.internalBinaryWrite(negate.filter.clientIp, tag.tag(9, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = clientLocation_LocationType2.internalBinaryWrite(negate.filter.clientIp, tag.tag(9, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userLocale" === negate.filter.oneofKind) {
    const tagResult8 = tag.tag(10, _mod1188.WireType.LengthDelimited);
    const joined8 = overrideType3.internalBinaryWrite(negate.filter.userLocale, tag.tag(10, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = overrideType3.internalBinaryWrite(negate.filter.userLocale, tag.tag(10, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("bot" === negate.filter.oneofKind) {
    const tagResult9 = tag.tag(11, _mod1188.WireType.LengthDelimited);
    const joined9 = clientRequiredChangesType.internalBinaryWrite(negate.filter.bot, tag.tag(11, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult9 = clientRequiredChangesType.internalBinaryWrite(negate.filter.bot, tag.tag(11, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userAgeRange" === negate.filter.oneofKind) {
    const tagResult10 = tag.tag(12, _mod1188.WireType.LengthDelimited);
    const joined10 = clientRequiredChangesType1.internalBinaryWrite(negate.filter.userAgeRange, tag.tag(12, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult10 = clientRequiredChangesType1.internalBinaryWrite(negate.filter.userAgeRange, tag.tag(12, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userIdRange" === negate.filter.oneofKind) {
    const tagResult11 = tag.tag(13, _mod1188.WireType.LengthDelimited);
    const joined11 = fixed64ValueType.internalBinaryWrite(negate.filter.userIdRange, tag.tag(13, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult11 = fixed64ValueType.internalBinaryWrite(negate.filter.userIdRange, tag.tag(13, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userHasFlag" === negate.filter.oneofKind) {
    const tagResult12 = tag.tag(14, _mod1188.WireType.LengthDelimited);
    const joined12 = fixed64ValueType1.internalBinaryWrite(negate.filter.userHasFlag, tag.tag(14, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult12 = fixed64ValueType1.internalBinaryWrite(negate.filter.userHasFlag, tag.tag(14, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("unitIdInRangeByHash" === negate.filter.oneofKind) {
    const tagResult13 = tag.tag(15, _mod1188.WireType.LengthDelimited);
    const joined13 = fixed64ValueType2.internalBinaryWrite(negate.filter.unitIdInRangeByHash, tag.tag(15, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult13 = fixed64ValueType2.internalBinaryWrite(negate.filter.unitIdInRangeByHash, tag.tag(15, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("clientReleaseChannel" === negate.filter.oneofKind) {
    const tagResult14 = tag.tag(16, _mod1188.WireType.LengthDelimited);
    const joined14 = fixed64ValueType3.internalBinaryWrite(negate.filter.clientReleaseChannel, tag.tag(16, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult14 = fixed64ValueType3.internalBinaryWrite(negate.filter.clientReleaseChannel, tag.tag(16, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("always" === negate.filter.oneofKind) {
    const tagResult15 = tag.tag(17, _mod1188.WireType.LengthDelimited);
    const joined15 = fixed64ValueType4.internalBinaryWrite(negate.filter.always, tag.tag(17, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult15 = fixed64ValueType4.internalBinaryWrite(negate.filter.always, tag.tag(17, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("clientSystemLocale" === negate.filter.oneofKind) {
    const tagResult16 = tag.tag(18, _mod1188.WireType.LengthDelimited);
    const joined16 = overrideType5.internalBinaryWrite(negate.filter.clientSystemLocale, tag.tag(18, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult16 = overrideType5.internalBinaryWrite(negate.filter.clientSystemLocale, tag.tag(18, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("unitIdInExperiment" === negate.filter.oneofKind) {
    const tagResult17 = tag.tag(19, _mod1188.WireType.LengthDelimited);
    const joined17 = fixed64ValueType5.internalBinaryWrite(negate.filter.unitIdInExperiment, tag.tag(19, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult17 = fixed64ValueType5.internalBinaryWrite(negate.filter.unitIdInExperiment, tag.tag(19, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userPremiumType" === negate.filter.oneofKind) {
    const tagResult18 = tag.tag(20, _mod1188.WireType.LengthDelimited);
    const joined18 = fixed64ValueType6.internalBinaryWrite(negate.filter.userPremiumType, tag.tag(20, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult18 = fixed64ValueType6.internalBinaryWrite(negate.filter.userPremiumType, tag.tag(20, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("unitIdMatchesFilterSnapshot" === negate.filter.oneofKind) {
    const tagResult19 = tag.tag(21, _mod1188.WireType.LengthDelimited);
    const joined19 = fixed64ValueType7.internalBinaryWrite(negate.filter.unitIdMatchesFilterSnapshot, tag.tag(21, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult19 = fixed64ValueType7.internalBinaryWrite(negate.filter.unitIdMatchesFilterSnapshot, tag.tag(21, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("guildIds" === negate.filter.oneofKind) {
    const tagResult20 = tag.tag(22, _mod1188.WireType.LengthDelimited);
    const joined20 = fixed64ValueType8.internalBinaryWrite(negate.filter.guildIds, tag.tag(22, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult20 = fixed64ValueType8.internalBinaryWrite(negate.filter.guildIds, tag.tag(22, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("guildIdRange" === negate.filter.oneofKind) {
    const tagResult21 = tag.tag(23, _mod1188.WireType.LengthDelimited);
    const joined21 = guildMemberCountRangeType.internalBinaryWrite(negate.filter.guildIdRange, tag.tag(23, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult21 = guildMemberCountRangeType.internalBinaryWrite(negate.filter.guildIdRange, tag.tag(23, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("guildMemberCountRange" === negate.filter.oneofKind) {
    const tagResult22 = tag.tag(25, _mod1188.WireType.LengthDelimited);
    const joined22 = guildIdsType.internalBinaryWrite(negate.filter.guildMemberCountRange, tag.tag(25, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult22 = guildIdsType.internalBinaryWrite(negate.filter.guildMemberCountRange, tag.tag(25, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("guildHasFeature" === negate.filter.oneofKind) {
    const tagResult23 = tag.tag(26, _mod1188.WireType.LengthDelimited);
    const joined23 = guildIdRangeType.internalBinaryWrite(negate.filter.guildHasFeature, tag.tag(26, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult23 = guildIdRangeType.internalBinaryWrite(negate.filter.guildHasFeature, tag.tag(26, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userLocation" === negate.filter.oneofKind) {
    const tagResult24 = tag.tag(27, _mod1188.WireType.LengthDelimited);
    const joined24 = clientLocation_LocationType.internalBinaryWrite(negate.filter.userLocation, tag.tag(27, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult24 = clientLocation_LocationType.internalBinaryWrite(negate.filter.userLocation, tag.tag(27, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userIp" === negate.filter.oneofKind) {
    const tagResult25 = tag.tag(28, _mod1188.WireType.LengthDelimited);
    const joined25 = clientLocation_LocationType3.internalBinaryWrite(negate.filter.userIp, tag.tag(28, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult25 = clientLocation_LocationType3.internalBinaryWrite(negate.filter.userIp, tag.tag(28, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("installationIds" === negate.filter.oneofKind) {
    const tagResult26 = tag.tag(29, _mod1188.WireType.LengthDelimited);
    const joined26 = closure_47.internalBinaryWrite(negate.filter.installationIds, tag.tag(29, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult26 = closure_47.internalBinaryWrite(negate.filter.installationIds, tag.tag(29, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("userStoreCountry" === negate.filter.oneofKind) {
    const tagResult27 = tag.tag(31, _mod1188.WireType.LengthDelimited);
    const joined27 = clientLocation_LocationType1.internalBinaryWrite(negate.filter.userStoreCountry, tag.tag(31, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult27 = clientLocation_LocationType1.internalBinaryWrite(negate.filter.userStoreCountry, tag.tag(31, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype4["internalBinaryWrite"] = function internalBinaryWrite(workAccounts, tag, writeUnknownFields) {
  if (false !== workAccounts.workAccounts) {
    tag.tag(1, _mod1188.WireType.Varint).bool(workAccounts.workAccounts);
    const tagResult = tag.tag(1, _mod1188.WireType.Varint);
  }
  if (false !== workAccounts.personalAccounts) {
    tag.tag(2, _mod1188.WireType.Varint).bool(workAccounts.personalAccounts);
...
prototype11["internalBinaryWrite"] = function internalBinaryWrite(city, tag, writeUnknownFields) {
  if ("" !== city.city) {
    tag.tag(1, _mod1188.WireType.LengthDelimited).string(city.city);
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
  }
  if ("" !== city.subdivision) {
    tag.tag(2, _mod1188.WireType.LengthDelimited).string(city.subdivision);
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
  }
  if ("" !== city.country) {
    tag.tag(3, _mod1188.WireType.LengthDelimited).string(city.country);
    const tagResult2 = tag.tag(3, _mod1188.WireType.LengthDelimited);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype12["internalBinaryWrite"] = function internalBinaryWrite(isoCountry, tag, writeUnknownFields) {
  if ("" !== isoCountry.isoCountry) {
    tag.tag(1, _mod1188.WireType.LengthDelimited).string(isoCountry.isoCountry);
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
  }
  if ("" !== isoCountry.isoSubdivision) {
    tag.tag(2, _mod1188.WireType.LengthDelimited).string(isoCountry.isoSubdivision);
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype13["create"] = function create(arr) {
  obj = { location: { oneofKind: "disabled" } };
  const _Object = Object;
  _Object.defineProperty(obj, _mod1188.MESSAGE_TYPE, { enumerable: false, value: this });
  if (undefined !== arr) {
    const result = _mod1188.reflectionMergePartial(this, obj, arr);
...
prototype13["internalBinaryWrite"] = function internalBinaryWrite(location, tag, writeUnknownFields) {
  if ("isoRegion" === location.location.oneofKind) {
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = items82.internalBinaryWrite(location.location.isoRegion, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items82.internalBinaryWrite(location.location.isoRegion, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("isEu" === location.location.oneofKind) {
    tag.tag(2, _mod1188.WireType.Varint).bool(location.location.isEu);
    const tagResult1 = tag.tag(2, _mod1188.WireType.Varint);
  }
  if ("place" === location.location.oneofKind) {
    const tagResult2 = tag.tag(3, _mod1188.WireType.LengthDelimited);
    const joined1 = items81.internalBinaryWrite(location.location.place, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = items81.internalBinaryWrite(location.location.place, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype14["internalBinaryWrite"] = function internalBinaryWrite(locations, tag, writeUnknownFields) {
  ...
  if (false !== locations.preferClientIp) {
    tag.tag(2, _mod1188.WireType.Varint).bool(locations.preferClientIp);
    const tagResult1 = tag.tag(2, _mod1188.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype17["internalBinaryWrite"] = function internalBinaryWrite(blocks, tag, writeUnknownFields) {
  ...
  if (false !== blocks.preferClientIp) {
    tag.tag(2, _mod1188.WireType.Varint).bool(blocks.preferClientIp);
    const tagResult1 = tag.tag(2, _mod1188.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype18["internalBinaryWrite"] = function internalBinaryWrite(iosVersion, tag, writeUnknownFields) {
  if (iosVersion.iosVersion) {
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = items161.internalBinaryWrite(iosVersion.iosVersion, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items161.internalBinaryWrite(iosVersion.iosVersion, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.androidVersion) {
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
    const joined1 = items161.internalBinaryWrite(iosVersion.androidVersion, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = items161.internalBinaryWrite(iosVersion.androidVersion, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.macosVersion) {
    const tagResult2 = tag.tag(3, _mod1188.WireType.LengthDelimited);
    const joined2 = items161.internalBinaryWrite(iosVersion.macosVersion, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = items161.internalBinaryWrite(iosVersion.macosVersion, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.windowsVersion) {
    const tagResult3 = tag.tag(4, _mod1188.WireType.LengthDelimited);
    const joined3 = items161.internalBinaryWrite(iosVersion.windowsVersion, tag.tag(4, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = items161.internalBinaryWrite(iosVersion.windowsVersion, tag.tag(4, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.playstationVersion) {
    const tagResult4 = tag.tag(5, _mod1188.WireType.LengthDelimited);
    const joined4 = items161.internalBinaryWrite(iosVersion.playstationVersion, tag.tag(5, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = items161.internalBinaryWrite(iosVersion.playstationVersion, tag.tag(5, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.xboxVersion) {
    const tagResult5 = tag.tag(6, _mod1188.WireType.LengthDelimited);
    const joined5 = items161.internalBinaryWrite(iosVersion.xboxVersion, tag.tag(6, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = items161.internalBinaryWrite(iosVersion.xboxVersion, tag.tag(6, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.linuxVersion) {
    const tagResult6 = tag.tag(7, _mod1188.WireType.LengthDelimited);
    const joined6 = items161.internalBinaryWrite(iosVersion.linuxVersion, tag.tag(7, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = items161.internalBinaryWrite(iosVersion.linuxVersion, tag.tag(7, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype19["internalBinaryWrite"] = function internalBinaryWrite(ranges, tag, writeUnknownFields) {
  ...
  if (false !== ranges.workAroundPyotoBug) {
    tag.tag(2, _mod1188.WireType.Varint).bool(ranges.workAroundPyotoBug);
    const tagResult1 = tag.tag(2, _mod1188.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype20["internalBinaryWrite"] = function internalBinaryWrite(lowerBound, tag, writeUnknownFields) {
  if (lowerBound.lowerBound) {
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = items163.internalBinaryWrite(lowerBound.lowerBound, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items163.internalBinaryWrite(lowerBound.lowerBound, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (lowerBound.upperBound) {
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
    const joined1 = items163.internalBinaryWrite(lowerBound.upperBound, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = items163.internalBinaryWrite(lowerBound.upperBound, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype21["internalBinaryWrite"] = function internalBinaryWrite(version, tag, writeUnknownFields) {
  if (version.version) {
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = items164.internalBinaryWrite(version.version, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items164.internalBinaryWrite(version.version, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== version.inclusive) {
    tag.tag(2, _mod1188.WireType.Varint).bool(version.inclusive);
    const tagResult1 = tag.tag(2, _mod1188.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype22["internalBinaryWrite"] = function internalBinaryWrite(version, tag, writeUnknownFields) {
  if (0 !== version.version) {
    tag.tag(1, _mod1188.WireType.Varint).int32(version.version);
    const tagResult = tag.tag(1, _mod1188.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype23["internalBinaryWrite"] = function internalBinaryWrite(iosVersion, tag, writeUnknownFields) {
  if (iosVersion.iosVersion) {
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = items211.internalBinaryWrite(iosVersion.iosVersion, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items211.internalBinaryWrite(iosVersion.iosVersion, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.androidVersion) {
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
    const joined1 = items211.internalBinaryWrite(iosVersion.androidVersion, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = items211.internalBinaryWrite(iosVersion.androidVersion, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.webVersion) {
    const tagResult2 = tag.tag(3, _mod1188.WireType.LengthDelimited);
    const joined2 = items211.internalBinaryWrite(iosVersion.webVersion, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = items211.internalBinaryWrite(iosVersion.webVersion, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (iosVersion.nativeVersion) {
    const tagResult3 = tag.tag(4, _mod1188.WireType.LengthDelimited);
    const joined3 = items211.internalBinaryWrite(iosVersion.nativeVersion, tag.tag(4, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = items211.internalBinaryWrite(iosVersion.nativeVersion, tag.tag(4, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== iosVersion.allowNonNativeWeb) {
    tag.tag(6, _mod1188.WireType.Varint).bool(iosVersion.allowNonNativeWeb);
    const tagResult4 = tag.tag(6, _mod1188.WireType.Varint);
  }
  if (iosVersion.clientRequiredChanges) {
    const tagResult5 = tag.tag(5, _mod1188.WireType.LengthDelimited);
    const joined4 = items215.internalBinaryWrite(iosVersion.clientRequiredChanges, tag.tag(5, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = items215.internalBinaryWrite(iosVersion.clientRequiredChanges, tag.tag(5, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype25["internalBinaryWrite"] = function internalBinaryWrite(lowerBound, tag, writeUnknownFields) {
  if (lowerBound.lowerBound) {
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = items213.internalBinaryWrite(lowerBound.lowerBound, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items213.internalBinaryWrite(lowerBound.lowerBound, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (lowerBound.upperBound) {
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
    const joined1 = items213.internalBinaryWrite(lowerBound.upperBound, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = items213.internalBinaryWrite(lowerBound.upperBound, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype26["internalBinaryWrite"] = function internalBinaryWrite(version, tag, writeUnknownFields) {
  if (version.version) {
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = items214.internalBinaryWrite(version.version, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items214.internalBinaryWrite(version.version, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== version.inclusive) {
    tag.tag(2, _mod1188.WireType.Varint).bool(version.inclusive);
    const tagResult1 = tag.tag(2, _mod1188.WireType.Varint);
...
prototype27["internalBinaryWrite"] = function internalBinaryWrite(major, tag, writeUnknownFields) {
  if (0 !== major.major) {
    tag.tag(1, _mod1188.WireType.Varint).uint32(major.major);
    const tagResult = tag.tag(1, _mod1188.WireType.Varint);
  }
  if (major.minor) {
    const UInt32Value = wrappers.UInt32Value;
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
    const joined = UInt32Value.internalBinaryWrite(major.minor, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = UInt32Value.internalBinaryWrite(major.minor, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (major.build) {
    const UInt64Value = wrappers.UInt64Value;
    const tagResult2 = tag.tag(3, _mod1188.WireType.LengthDelimited);
    const joined1 = UInt64Value.internalBinaryWrite(major.build, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = UInt64Value.internalBinaryWrite(major.build, tag.tag(3, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype29["internalBinaryWrite"] = function internalBinaryWrite(isBot, tag, writeUnknownFields) {
  if (false !== isBot.isBot) {
    tag.tag(1, _mod1188.WireType.Varint).bool(isBot.isBot);
    const tagResult = tag.tag(1, _mod1188.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype30["internalBinaryWrite"] = function internalBinaryWrite(minAgeYears, tag, writeUnknownFields) {
  if (minAgeYears.minAgeYears) {
    const UInt32Value = wrappers.UInt32Value;
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = UInt32Value.internalBinaryWrite(minAgeYears.minAgeYears, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = UInt32Value.internalBinaryWrite(minAgeYears.minAgeYears, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (minAgeYears.maxAgeYears) {
    const UInt32Value2 = wrappers.UInt32Value;
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
    const joined1 = UInt32Value2.internalBinaryWrite(minAgeYears.maxAgeYears, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = UInt32Value2.internalBinaryWrite(minAgeYears.maxAgeYears, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype31["internalBinaryWrite"] = function internalBinaryWrite(value, tag, writeUnknownFields) {
  if ("0" !== value.value) {
    tag.tag(1, _mod1188.WireType.Bit64).fixed64(value.value);
...
prototype32["internalBinaryWrite"] = function internalBinaryWrite(minId, tag, writeUnknownFields) {
  if (minId.minId) {
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = items281.internalBinaryWrite(minId.minId, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items281.internalBinaryWrite(minId.minId, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (minId.maxId) {
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
    const joined1 = items281.internalBinaryWrite(minId.maxId, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = items281.internalBinaryWrite(minId.maxId, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype33["internalBinaryWrite"] = function internalBinaryWrite(mask, tag, writeUnknownFields) {
  if ("0" !== mask.mask) {
    tag.tag(1, _mod1188.WireType.Bit64).fixed64(mask.mask);
    const tagResult = tag.tag(1, _mod1188.WireType.Bit64);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype34["internalBinaryWrite"] = function internalBinaryWrite(hashKey, tag, writeUnknownFields) {
  if ("" !== hashKey.hashKey) {
    tag.tag(1, _mod1188.WireType.LengthDelimited).string(hashKey.hashKey);
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
  }
  if (0 !== hashKey.stopRingPosition) {
    tag.tag(2, _mod1188.WireType.Varint).uint32(hashKey.stopRingPosition);
    const tagResult1 = tag.tag(2, _mod1188.WireType.Varint);
  }
  if (0 !== hashKey.startRingPosition) {
    tag.tag(3, _mod1188.WireType.Varint).uint32(hashKey.startRingPosition);
...
prototype36["internalBinaryWrite"] = function internalBinaryWrite(value, tag, writeUnknownFields) {
  if (false !== value.value) {
    tag.tag(1, _mod1188.WireType.Varint).bool(value.value);
    const tagResult = tag.tag(1, _mod1188.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
...
prototype37["internalBinaryWrite"] = function internalBinaryWrite(experimentId, tag, writeUnknownFields) {
  ...
  if ("0" !== experimentId.experimentId) {
    tag.tag(1, _mod1188.WireType.Bit64).fixed64(experimentId.experimentId);
    const tagResult = tag.tag(1, _mod1188.WireType.Bit64);
  }
...
prototype39["internalBinaryWrite"] = function internalBinaryWrite(filterSnapshotName, tag, writeUnknownFields) {
  ...
  if ("" !== filterSnapshotName.filterSnapshotName) {
    tag.tag(1, _mod1188.WireType.LengthDelimited).string(filterSnapshotName.filterSnapshotName);
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
  }
...
prototype41["internalBinaryWrite"] = function internalBinaryWrite(minCount, tag, writeUnknownFields) {
  if (minCount.minCount) {
    const UInt32Value = wrappers.UInt32Value;
    const tagResult = tag.tag(1, _mod1188.WireType.LengthDelimited);
    const joined = UInt32Value.internalBinaryWrite(minCount.minCount, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = UInt32Value.internalBinaryWrite(minCount.minCount, tag.tag(1, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (minCount.maxCount) {
    const UInt32Value2 = wrappers.UInt32Value;
    const tagResult1 = tag.tag(2, _mod1188.WireType.LengthDelimited);
    const joined1 = UInt32Value2.internalBinaryWrite(minCount.maxCount, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = UInt32Value2.internalBinaryWrite(minCount.maxCount, tag.tag(2, _mod1188.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
