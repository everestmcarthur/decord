...
// Dependencies: [32, 1188, 10761, 10762, 10763, 2]

// Module 10760 (announcement_modal_variant_1_properties)
import _mod1188 from "module_1188" /* 1188 */;
import localized_string from "localized_string" /* 10761 */;
import help_article from "help_article" /* 10762 */;
import cta_button from "cta_button" /* 10763 */;
...
class FeatureCard$Type extends MessageType {
  constructor() {
    ...
    tmp1 = new tmp("discord_protos.premium_marketing.v1.FeatureCard", items, T);
    return tmp1;
  }
}
...
class Variant1Storage$Type extends MessageType2 {
  constructor() {
    ...
    tmp1 = new tmp("discord_protos.premium_marketing.v1.Variant1Storage", items, new.target);
    return tmp1;
  }
}
...
class Subtitle$Type extends MessageType3 {
  constructor() {
    ...
    tmp1 = new tmp("discord_protos.premium_marketing.v1.Subtitle", items, new.target);
    return tmp1;
  }
}
...
const variant1StorageType = new Variant1Storage$Type("discord_protos.premium_marketing.v1.Subtitle", items2, tmp5, tmp4, Subtitle$Type, "create", "internalBinaryRead", "internalBinaryWrite", Variant1Storage$Type, items2, tmp, fn, dependencyMap, object);
...
class Disclaimer$Type extends MessageType4 {
  constructor() {
    ...
    tmp1 = new tmp("discord_protos.premium_marketing.v1.Disclaimer", items, T);
    return tmp1;
  }
}
...
const subtitleType = new Subtitle$Type("discord_protos.premium_marketing.v1.Disclaimer", items3, tmp5, Disclaimer$Type, Subtitle$Type, "create", "internalBinaryRead", "internalBinaryWrite", items3, new.target, tmp, fn, dependencyMap, object, tmp22);
...
class AnnouncementModalVariant1Properties$Type extends MessageType5 {
  constructor() {
    ...
    tmp1 = new tmp("discord_protos.premium_marketing.v1.AnnouncementModalVariant1Properties", items, T);
    return tmp1;
  }
}
