...
// Function ID: 17368
// Name: parse
// Dependencies: [32, 17368, 17325, 4301, 17369, 17370, 2]
// Exports: getMessage, setUpdateRules

// Module 17367 (parse)
import _modDef4301 from "module_4301" /* 4301 */;
import _modDef17325 from "module_17325" /* 17325 */;
import markdownRules from "markdownRules" /* 17369 */;
import i18n_updateRules from "i18n/updateRules" /* 17370 */;
import _slicedToArray from "module_32" /* 32 */;

require = fn;
const Constants = fn(17368);
...
export const setUpdateRules = function setUpdateRules(fn) {
  ...
  _modDef4301.parserFor(fn(rules));
  const obj2 = _modDef4301;
  closure_1 = obj2.reactFor(_modDef4301.ruleOutput(rules, "react"));
  f119767 = (arr, context, unsafeContext) => {
  ...
  closure_0 = _modDef4301.parserFor(markdownRules.rules);
  f119768 = (arg0, context, unsafeContext) => closure_0(arg0 + "\n\n", { inline: false, context, unsafeContext });
};
export const getMessage = function getMessage(str, arg1) {
  if (null == str) {
    ...
    if (null == f119767) {
      const rules = markdownRules.rules;
      _modDef4301.parserFor(i18n_updateRules.default(rules));
      const obj2 = _modDef4301;
      closure_1 = obj2.reactFor(_modDef4301.ruleOutput(rules, "react"));
      f119767 = (arr, context, unsafeContext) => {
        const hasItem = arr.includes("\n\n");
    ...
    if (isMatch) {
      if (typeof FormattedMessage === "function") {
        ...
        const tmp15 = new _modDef17325(obj5.message, arg1);
