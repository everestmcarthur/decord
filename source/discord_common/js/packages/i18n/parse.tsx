...
// Function ID: 17427
// Name: parse
// Dependencies: [32, 17427, 17384, 4336, 17428, 17429, 2]
// Exports: getMessage, setUpdateRules

// Module 17426 (parse)
import _modDef4336 from "module_4336" /* 4336 */;
import _modDef17384 from "module_17384" /* 17384 */;
import markdownRules from "markdownRules" /* 17428 */;
import i18n_updateRules from "i18n/updateRules" /* 17429 */;
import _slicedToArray from "module_32" /* 32 */;

require = fn;
const Constants = fn(17427);
...
export const setUpdateRules = function setUpdateRules(fn) {
  ...
  _modDef4336.parserFor(fn(rules));
  const obj2 = _modDef4336;
  closure_1 = obj2.reactFor(_modDef4336.ruleOutput(rules, "react"));
  f120052 = (arr, context, unsafeContext) => {
  ...
  closure_0 = _modDef4336.parserFor(markdownRules.rules);
  f120053 = (arg0, context, unsafeContext) => closure_0(arg0 + "\n\n", { inline: false, context, unsafeContext });
};
export const getMessage = function getMessage(str, arg1) {
  if (null == str) {
    ...
    if (null == f120052) {
      const rules = markdownRules.rules;
      _modDef4336.parserFor(i18n_updateRules.default(rules));
      const obj2 = _modDef4336;
      closure_1 = obj2.reactFor(_modDef4336.ruleOutput(rules, "react"));
      f120052 = (arr, context, unsafeContext) => {
        const hasItem = arr.includes("\n\n");
    ...
    if (isMatch) {
      if (typeof FormattedMessage === "function") {
        ...
        const tmp15 = new _modDef17384(obj5.message, arg1);
