...
// Function ID: 17483
// Name: parse
// Dependencies: [32, 17483, 17440, 4334, 17484, 17485, 2]
// Exports: getMessage, setUpdateRules

// Module 17482 (parse)
import _modDef4334 from "module_4334" /* 4334 */;
import _modDef17440 from "module_17440" /* 17440 */;
import markdownRules from "markdownRules" /* 17484 */;
import i18n_updateRules from "i18n/updateRules" /* 17485 */;
import _slicedToArray from "module_32" /* 32 */;

require = fn;
const Constants = fn(17483);
...
export const setUpdateRules = function setUpdateRules(fn) {
  ...
  _modDef4334.parserFor(fn(rules));
  const obj2 = _modDef4334;
  closure_1 = obj2.reactFor(_modDef4334.ruleOutput(rules, "react"));
  f120553 = (arr, context, unsafeContext) => {
  ...
  closure_0 = _modDef4334.parserFor(markdownRules.rules);
  f120554 = (arg0, context, unsafeContext) => closure_0(arg0 + "\n\n", { inline: false, context, unsafeContext });
};
export const getMessage = function getMessage(str, arg1) {
  if (null == str) {
    ...
    if (null == f120553) {
      const rules = markdownRules.rules;
      _modDef4334.parserFor(i18n_updateRules.default(rules));
      const obj2 = _modDef4334;
      closure_1 = obj2.reactFor(_modDef4334.ruleOutput(rules, "react"));
      f120553 = (arr, context, unsafeContext) => {
        const hasItem = arr.includes("\n\n");
    ...
    if (isMatch) {
      if (typeof FormattedMessage === "function") {
        ...
        const tmp15 = new _modDef17440(obj5.message, arg1);
