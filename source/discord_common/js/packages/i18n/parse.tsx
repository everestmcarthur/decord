...
// Function ID: 17524
// Name: parse
// Dependencies: [32, 17524, 17481, 4336, 17525, 17526, 2]
// Exports: getMessage, setUpdateRules

// Module 17523 (parse)
import _modDef4336 from "module_4336" /* 4336 */;
import _modDef17481 from "module_17481" /* 17481 */;
import markdownRules from "markdownRules" /* 17525 */;
import i18n_updateRules from "i18n/updateRules" /* 17526 */;
import _slicedToArray from "module_32" /* 32 */;

require = fn;
const Constants = fn(17524);
...
export const setUpdateRules = function setUpdateRules(fn) {
  ...
  f120941 = (arr, context, unsafeContext) => {
  ...
  f120942 = (arg0, context, unsafeContext) => closure_0(arg0 + "\n\n", { inline: false, context, unsafeContext });
};
  ...
  if (null == str) {
    ...
    if (isMatch) {
      if (typeof FormattedMessage === "function") {
        ...
        const tmp15 = new _modDef17481(obj5.message, arg1);
