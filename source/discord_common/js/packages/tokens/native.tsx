...
export default {
  ...
  shadows: mapValuesDefault(Shadows, (arg0) => {
    ...
    f70953 = (shadowColorAndroid, arg1) => arg1 ? shadowColorAndroid.shadowColorAndroid : shadowColorAndroid.shadowColor;
    f70953 = (shadowOpacity) => shadowOpacity.shadowOpacity;
    f70953 = (shadowRadius) => shadowRadius.shadowRadius;
    f70953 = (elevation) => elevation.elevation;
    return {
      shadowOffset: {
        resolve(isAndroid) {
          return f70953(require[isAndroid.theme].nativeStyles, isAndroid.isAndroid);
        }
      },
      shadowColor: {
        resolve(isAndroid) {
