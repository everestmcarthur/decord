...
export default {
  ...
  shadows: mapValuesDefault(Shadows, (arg0) => {
    ...
    f70751 = (shadowColorAndroid, arg1) => arg1 ? shadowColorAndroid.shadowColorAndroid : shadowColorAndroid.shadowColor;
    f70751 = (shadowOpacity) => shadowOpacity.shadowOpacity;
    f70751 = (shadowRadius) => shadowRadius.shadowRadius;
    f70751 = (elevation) => elevation.elevation;
    return {
      shadowOffset: {
        resolve(isAndroid) {
          return f70751(require[isAndroid.theme].nativeStyles, isAndroid.isAndroid);
        }
      },
      shadowColor: {
        resolve(isAndroid) {
