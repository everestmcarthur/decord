...
export default {
  ...
  shadows: mapValuesDefault(Shadows, (arg0) => {
    ...
    f71920 = (shadowColorAndroid, arg1) => arg1 ? shadowColorAndroid.shadowColorAndroid : shadowColorAndroid.shadowColor;
    f71920 = (shadowOpacity) => shadowOpacity.shadowOpacity;
    f71920 = (shadowRadius) => shadowRadius.shadowRadius;
    f71920 = (elevation) => elevation.elevation;
    return {
      shadowOffset: {
        resolve(isAndroid) {
          return f71920(require[isAndroid.theme].nativeStyles, isAndroid.isAndroid);
        }
      },
      shadowColor: {
        resolve(isAndroid) {
