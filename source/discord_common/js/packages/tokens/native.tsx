...
export default {
  ...
  shadows: mapValuesDefault(Shadows, (arg0) => {
    ...
    f71667 = (shadowColorAndroid, arg1) => arg1 ? shadowColorAndroid.shadowColorAndroid : shadowColorAndroid.shadowColor;
    f71667 = (shadowOpacity) => shadowOpacity.shadowOpacity;
    f71667 = (shadowRadius) => shadowRadius.shadowRadius;
    f71667 = (elevation) => elevation.elevation;
    return {
      shadowOffset: {
        resolve(isAndroid) {
          return f71667(require[isAndroid.theme].nativeStyles, isAndroid.isAndroid);
        }
      },
      shadowColor: {
        resolve(isAndroid) {
