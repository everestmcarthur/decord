// Module ID: 8966
// Function ID: 8967
// Dependencies: [19, 17, 21, 1115, 6924, 4343, 6923, 6699, 2]
...
let closure_8 = ReanimatedRexport.createAnimatedComponent(fn(6924).FlashList);
const forwardRefResult = noop.forwardRef((arg0, ref) => {
  maintainVisibleContentPosition = { maintainVisibleContentPosition, ref };
  const merged = Object.assign(arg0);
  return jsx(_mod6924.FlashList, { maintainVisibleContentPosition, ref });
});
...
let ReanimatedRexport = ReanimatedRexport_mod;
let closure_9 = ReanimatedRexport.createAnimatedComponent(fn(6924).FlashList);
const forwardRefResult2 = noop.forwardRef((arg0, ref) => {
  ...
  return jsx(_mod6924.FlashList, { ref, maintainVisibleContentPosition, masonry: true });
});
const forwardRefResult3 = noop.forwardRef((arg0, ref) => {
  ...
  return jsx(refreshControl(6923), { ref, maintainVisibleContentPosition });
});
const size = fn(2);
const result = size.fileFinishedImporting("../discord_common/js/packages/flash-list/index.js");
for (const key10063 in require("module_6924")) {
  arg5[key10063] = require("module_6924")[key10063];
  continue;
}
...
export const BottomSheetMasonryFlashList = noop.forwardRef((arg0, ref) => {
  ...
  maintainVisibleContentPosition.renderScrollComponent = preventNativeModalDismiss(6699).BottomSheetScrollView;
  const merged1 = Object.assign(merged);
  maintainVisibleContentPosition.refreshControl = memo;
