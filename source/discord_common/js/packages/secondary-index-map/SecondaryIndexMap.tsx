...
// Dependencies: [32, 4240, 2]

// Module 4239 (SecondaryIndexMap)
import sortedIndexByDefault from "sortedIndexBy" /* 4240 */;
...
class SecondaryIndexMap {
  constructor(arg0, arg1) {
    ...
    merged = Object.assign({ valueMap: null, valueArray: null, valueIndexes: null, valueIndexesForGetter: null, dirty: false, _version: 0 });
    map = new Map();
    merged[0] = map;
    merged[1] = [];
    merged[2] = {};
    merged[3] = {};
    merged.indexBy = global;
    merged.sortBy = fn;
    merged.isEqual = fn;
    return merged;
  }
