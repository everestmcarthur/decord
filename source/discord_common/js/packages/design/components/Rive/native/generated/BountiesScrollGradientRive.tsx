...
// Dependencies: [109, 19, 21, 4337, 4396, 4392, 2]

// Module 4395 (BountiesScrollGradientRive)
import BaseRive from "BaseRive" /* 4337 */;
import RiveErrorBoundary from "RiveErrorBoundary" /* 4392 */;
import _modDef4396 from "module_4396" /* 4396 */;
...
let closure_8 = noop.forwardRef(function BountiesScrollGradientRiveInner(defaultViewModelInstance, ref) {
  ...
  return jsx(BaseRive.BaseRive, { ref, src: _modDef4396, artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: tmp, stateMachine: defaultViewModelInstance.stateMachine });
});
const size = fn(2);
