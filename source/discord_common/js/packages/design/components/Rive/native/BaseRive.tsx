...
// Function ID: 4305
// Name: BaseRive
// Dependencies: [19, 17, 21, 4305, 4294, 4355, 4356, 4357, 2]
...
// Module 4304 (BaseRive)
import DataBindByName from "DataBindByName" /* 4305 */;
import ManaContext from "ManaContext" /* 4355 */;
import useRivePlayback from "useRivePlayback" /* 4356 */;
...
export const BaseRive = noop.forwardRef(function BaseRiveInner(renderDataBinding, ref) {
  ...
  const enabled = noop.useContext(tmp(4294).AccessibilityPreferencesContext).reducedMotion.enabled;
  ...
  let None = instance;
  if (instance == null) {
    None = tmp(4305).DataBindMode.None;
  }
  let reducedMotion;
  ...
  if (null == riveFile) {
    ...
    if (null != fit) {
      const obj10 = { fit: tmp(4357).FIT_MAP[fit] };
      let obj11 = obj10;
    } else {
      obj11 = {};
    }
    ...
    if (null != alignment) {
      const obj12 = { alignment: tmp(4357).ALIGNMENT_MAP[alignment] };
      let obj13 = obj12;
    } else {
      obj13 = {};
    }
    ...
    timestampProducer(tmp(4305).RiveView, obj7);
  }
});
