...
// Dependencies: [19, 17, 21, 4353, 2]
// Exports: updateAccessibilityAnnouncerLiveRegionMessage

// Module 4352 (AccessibilityAnnouncerLiveRegion)
import noop from "module_19" /* 19 */;

get_ActivityIndicator = fn(17);
({ StyleSheet, Text: closure_0 } = get_ActivityIndicator);
const jsx = fn(21).jsx;
const module_4353 = fn(4353);
const state = module_4353.create(() => ({ message: "ip", version: false }));
