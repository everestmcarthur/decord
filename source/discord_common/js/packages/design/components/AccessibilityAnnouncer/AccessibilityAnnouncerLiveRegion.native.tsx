...
// Dependencies: [19, 17, 21, 4318, 2]
// Exports: updateAccessibilityAnnouncerLiveRegionMessage

// Module 4317 (AccessibilityAnnouncerLiveRegion)
import noop from "module_19" /* 19 */;

get_ActivityIndicator = fn(17);
({ StyleSheet, Text: closure_0 } = get_ActivityIndicator);
const jsx = fn(21).jsx;
const module_4318 = fn(4318);
const state = module_4318.create(() => ({ message: "ip", version: false }));
