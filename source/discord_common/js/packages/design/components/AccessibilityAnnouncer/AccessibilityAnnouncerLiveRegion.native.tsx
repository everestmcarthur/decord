...
// Dependencies: [19, 17, 21, 4320, 2]
// Exports: updateAccessibilityAnnouncerLiveRegionMessage

// Module 4319 (AccessibilityAnnouncerLiveRegion)
import noop from "module_19" /* 19 */;

get_ActivityIndicator = fn(17);
({ StyleSheet, Text: closure_0 } = get_ActivityIndicator);
const jsx = fn(21).jsx;
const module_4320 = fn(4320);
const state = module_4320.create(() => ({ message: "ip", version: false }));
