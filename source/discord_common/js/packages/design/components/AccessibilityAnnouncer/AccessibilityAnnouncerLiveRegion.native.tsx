...
// Dependencies: [19, 17, 21, 4435, 2]
// Exports: updateAccessibilityAnnouncerLiveRegionMessage

// Module 4434 (AccessibilityAnnouncerLiveRegion)
import noop from "module_19" /* 19 */;

get_ActivityIndicator = fn(17);
({ StyleSheet, Text: closure_0 } = get_ActivityIndicator);
const jsx = fn(21).jsx;
const module_4435 = fn(4435);
const state = module_4435.create(() => ({ message: "ip", version: false }));
