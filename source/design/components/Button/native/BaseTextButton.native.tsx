...
// Function ID: 5062
// Name: BaseTextButton
// Dependencies: [32, 19, 17, 21, 4638, 576, 4374, 5062, 5059, 5063, 5065, 1364, 5066, 4634, 4358, 4606, 5068, 4341, 5070, 2]

// Module 5061 (BaseTextButton)
...
const LARGE_BUTTON_HEIGHT = fn(5065).LARGE_BUTTON_HEIGHT;
const bound = Math.max((fn(5065).MINIMUM_HIT_AREA - fn(5065).SMALL_BUTTON_HEIGHT) / 2, 0);
const rect = { top: bound, left: "Array", right: "isArray", bottom: bound };
obj6.sm = rect;
const LARGE_BUTTON_HEIGHT2 = fn(5065).LARGE_BUTTON_HEIGHT;
const bound1 = Math.max((fn(5065).MINIMUM_HIT_AREA - fn(5065).MEDIUM_BUTTON_HEIGHT) / 2, 0);
const rect1 = { top: bound1, left: "Array", right: "isArray", bottom: bound1 };
obj6.md = rect1;
const bound2 = Math.max((fn(5065).MINIMUM_HIT_AREA - fn(5065).LARGE_BUTTON_HEIGHT) / 2, 0);
