...
// Function ID: 9982
// Name: ImageButton
// Dependencies: [19, 17, 21, 4606, 5031, 576, 5032, 4343, 5025, 5029, 5034, 8173, 4602, 2]
...
let closure_8 = createStyles.createStyles((arg0, arg1, arg2) => {
  ...
  if ("sm" === arg0) {
    MEDIUM_BUTTON_PADDING = tmp(5031).SMALL_BUTTON_PADDING;
  } else if ("md" === arg0) {
    MEDIUM_BUTTON_PADDING = tmp(5031).MEDIUM_BUTTON_PADDING;
  }
