...
// Dependencies: [109, 19, 17, 5069, 1074, 21, 4348, 4638, 5066, 4374, 1370, 1364, 2]

// Module 5068 (Button/BaseButton)
...
export const BaseButton = noop.forwardRef((disabled, ref) => {
  ...
  if (null != DARK) {
    ...
    tmp12 = jsx(tmp4(4348).ThemeContextProvider, { theme: DARK, children });
  }
