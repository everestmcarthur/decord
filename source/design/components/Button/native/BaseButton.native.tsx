...
// Dependencies: [109, 19, 17, 5071, 1074, 21, 4350, 4640, 5068, 4376, 1370, 1364, 2]

// Module 5070 (Button/BaseButton)
...
export const BaseButton = noop.forwardRef((disabled, ref) => {
  ...
  if (null != DARK) {
    ...
    tmp12 = jsx(tmp4(4350).ThemeContextProvider, { theme: DARK, children });
  }
