...
// Function ID: 5076
// Name: ButtonEllipsis
// Dependencies: [19, 21, 4376, 4639, 576, 4640, 5065, 5076, 2]
// Exports: Ellipsis
  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        tmp11(tmp5Result.withDelay(result1, tmp5Result3.withRepeat(tmp5(4640).withTiming(1, tmp8, "animate-always"), -1, true)));
        return () => {
