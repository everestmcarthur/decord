...
// Function ID: 5006
// Name: ButtonEllipsis
// Dependencies: [19, 21, 4310, 4574, 576, 4575, 4995, 5006, 2]
// Exports: Ellipsis
  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        const tmp5Result3 = tmp5(4310);
        tmp11(tmp5Result.withDelay(result1, tmp5Result3.withRepeat(tmp5(4575).withTiming(1, tmp8, "animate-always"), -1, true)));
        return () => {
...
ELLIPSIS_APPEAR_TIMING.easing = Easing.inOut(fn(4310).Easing.quad);
...
withEllipsisAnimation.__closure = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: fn(4310).withDelay, withRepeat: fn(4310).withRepeat, withTiming: fn(4575).withTiming, ELLIPSIS_APPEAR_TIMING };
