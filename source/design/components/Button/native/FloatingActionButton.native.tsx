...
// Dependencies: [19, 21, 4639, 576, 5064, 4376, 5058, 8206, 2]
// Exports: FloatingActionButton

// Module 9041 (FloatingActionButton)
...
export const FloatingActionButton = function FloatingActionButton(positionRight) {
  ...
  F.__closure = { withSpring: positionBottom(5058).withSpring, positionBottom, DEFAULT_POSITION_OFFSET: 16, SPRING_CONFIG, positionRight };
  ...
  obj3.children = jsx(positionBottom(8206).BaseIconButton, {});
