...
// Dependencies: [19, 21, 4574, 576, 4994, 4310, 4988, 8114, 2]
...
export const FloatingActionButton = function FloatingActionButton(positionRight) {
  ...
  F.__closure = { withSpring: positionBottom(4988).withSpring, positionBottom, DEFAULT_POSITION_OFFSET: 16, SPRING_CONFIG, positionRight };
  ...
  obj3.children = jsx(positionBottom(8114).BaseIconButton, {});
