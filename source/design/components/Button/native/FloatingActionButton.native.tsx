...
// Dependencies: [19, 21, 4638, 576, 5065, 4374, 5059, 8215, 2]
// Exports: FloatingActionButton

// Module 9052 (FloatingActionButton)
...
export const FloatingActionButton = function FloatingActionButton(positionRight) {
  ...
  let obj = positionBottom(4374);
  F.__closure = { withSpring: positionBottom(5059).withSpring, positionBottom, DEFAULT_POSITION_OFFSET: 16, SPRING_CONFIG, positionRight };
  ...
  obj3.children = jsx(positionBottom(8215).BaseIconButton, {});
  return jsx(positionRight(4374).View, { style: animatedStyle, children: null });
};
