...
// Dependencies: [32, 19, 17, 21, 4638, 576, 8803, 4374, 4348, 7091, 1478, 1364, 5059, 8802, 6763, 4634, 14282, 5045, 5046, 1115, 2]
// Exports: ContextMenuPopout

// Module 14284 (ContextMenuPopout)
...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = { withSpring: visible(5059).withSpring, visible, CONTEXT_MENU_SPRING: visible(8803).CONTEXT_MENU_SPRING };
  ...
  const obj2 = { withSpring: visible(5059).withSpring, visible, CONTEXT_MENU_SPRING: visible(8803).CONTEXT_MENU_SPRING };
  ...
  return tmp3(visible(5046).Backdrop, obj3);
}
...
obj2.container = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8803).CONTEXT_MENU_MIN_WIDTH };
let obj3 = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8803).CONTEXT_MENU_MIN_WIDTH };
obj2.titleContainer = { padding: fn(8803).CONTEXT_MENU_ITEM_PADDING };
let obj4 = { padding: fn(8803).CONTEXT_MENU_ITEM_PADDING };
obj2.divider = { borderBottomWidth: fn(8803).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
