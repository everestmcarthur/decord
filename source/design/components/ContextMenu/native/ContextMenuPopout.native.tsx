...
// Dependencies: [32, 19, 17, 21, 4639, 576, 8794, 4376, 4350, 7088, 1478, 1364, 5058, 8793, 6760, 4635, 14264, 5046, 5047, 1115, 2]
// Exports: ContextMenuPopout

// Module 14266 (ContextMenuPopout)
...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = { withSpring: visible(5058).withSpring, visible, CONTEXT_MENU_SPRING: visible(8794).CONTEXT_MENU_SPRING };
  ...
  const obj2 = { withSpring: visible(5058).withSpring, visible, CONTEXT_MENU_SPRING: visible(8794).CONTEXT_MENU_SPRING };
  ...
  return tmp3(visible(5047).Backdrop, obj3);
}
...
obj2.container = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8794).CONTEXT_MENU_MIN_WIDTH };
let obj3 = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8794).CONTEXT_MENU_MIN_WIDTH };
obj2.titleContainer = { padding: fn(8794).CONTEXT_MENU_ITEM_PADDING };
let obj4 = { padding: fn(8794).CONTEXT_MENU_ITEM_PADDING };
obj2.divider = { borderBottomWidth: fn(8794).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
