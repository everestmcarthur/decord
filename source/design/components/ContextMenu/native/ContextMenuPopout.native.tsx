...
// Dependencies: [32, 19, 17, 21, 4607, 576, 8761, 4343, 4317, 7055, 1477, 1115, 5026, 8760, 6727, 4603, 14221, 5014, 5015, 1114, 2]
// Exports: ContextMenuPopout

// Module 14223 (ContextMenuPopout)
import nativeDefault from "native" /* 576 */;
import PlatformUtils from "PlatformUtils" /* 1115 */;
import native from "native" /* 4317 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4343 */;
import useIsScreenReaderEnabled from "useIsScreenReaderEnabled" /* 5014 */;
...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = { withSpring: visible(5026).withSpring, visible, CONTEXT_MENU_SPRING: visible(8761).CONTEXT_MENU_SPRING };
  ...
  const obj2 = { withSpring: visible(5026).withSpring, visible, CONTEXT_MENU_SPRING: visible(8761).CONTEXT_MENU_SPRING };
  ...
  return tmp3(visible(5015).Backdrop, obj3);
}
...
obj2.container = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8761).CONTEXT_MENU_MIN_WIDTH };
let obj3 = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8761).CONTEXT_MENU_MIN_WIDTH };
obj2.titleContainer = { padding: fn(8761).CONTEXT_MENU_ITEM_PADDING };
let obj4 = { padding: fn(8761).CONTEXT_MENU_ITEM_PADDING };
obj2.divider = { borderBottomWidth: fn(8761).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
