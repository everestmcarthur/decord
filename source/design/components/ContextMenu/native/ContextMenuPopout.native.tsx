...
// Dependencies: [32, 19, 17, 21, 4605, 576, 8738, 4341, 4315, 7033, 1477, 1115, 5024, 8737, 6705, 4601, 14243, 5012, 5013, 1114, 2]
// Exports: ContextMenuPopout

// Module 14245 (ContextMenuPopout)
...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = { withSpring: visible(5024).withSpring, visible, CONTEXT_MENU_SPRING: visible(8738).CONTEXT_MENU_SPRING };
  ...
  const obj2 = { withSpring: visible(5024).withSpring, visible, CONTEXT_MENU_SPRING: visible(8738).CONTEXT_MENU_SPRING };
  ...
  return tmp3(visible(5013).Backdrop, obj3);
}
...
obj2.container = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8738).CONTEXT_MENU_MIN_WIDTH };
let obj3 = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8738).CONTEXT_MENU_MIN_WIDTH };
obj2.titleContainer = { padding: fn(8738).CONTEXT_MENU_ITEM_PADDING };
let obj4 = { padding: fn(8738).CONTEXT_MENU_ITEM_PADDING };
obj2.divider = { borderBottomWidth: fn(8738).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
