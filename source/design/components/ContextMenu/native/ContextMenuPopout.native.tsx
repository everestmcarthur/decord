...
// Dependencies: [32, 19, 17, 21, 4606, 576, 8759, 4343, 4317, 7054, 1477, 1115, 5025, 8758, 6726, 4602, 14219, 5013, 5014, 1114, 2]
...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = { withSpring: visible(5025).withSpring, visible, CONTEXT_MENU_SPRING: visible(8759).CONTEXT_MENU_SPRING };
  ...
  const obj2 = { withSpring: visible(5025).withSpring, visible, CONTEXT_MENU_SPRING: visible(8759).CONTEXT_MENU_SPRING };
  ...
  return tmp3(visible(5014).Backdrop, obj3);
}
...
obj2.container = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8759).CONTEXT_MENU_MIN_WIDTH };
let obj3 = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8759).CONTEXT_MENU_MIN_WIDTH };
obj2.titleContainer = { padding: fn(8759).CONTEXT_MENU_ITEM_PADDING };
let obj4 = { padding: fn(8759).CONTEXT_MENU_ITEM_PADDING };
obj2.divider = { borderBottomWidth: fn(8759).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
