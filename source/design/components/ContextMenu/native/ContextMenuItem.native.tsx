...
// Dependencies: [19, 17, 21, 4374, 4638, 8803, 576, 8802, 5059, 5063, 5062, 4634, 2]
    ...
    if (null != arg1) {
      if (arg0 !== arg1) {
        ...
        if (null != measureResult) {
          ...
          const result = index * tmp2(8802).INDEX_BOUNDS_OFFSET;
          value = itemMeasurements.get();
          value[result + tmp2(8802).INDEX_BOUNDS_PAGE_X_OFFSET] = pageX;
          const value4 = itemMeasurements.get();
          value4[result + tmp2(8802).INDEX_BOUNDS_PAGE_Y_OFFSET] = pageY;
          const value5 = itemMeasurements.get();
          value5[result + tmp2(8802).INDEX_BOUNDS_WIDTH_OFFSET] = width;
          const value6 = itemMeasurements.get();
          value6[result + tmp2(8802).INDEX_BOUNDS_HEIGHT_OFFSET] = height;
        }
      }
    }
  };
