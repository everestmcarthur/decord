...
// Dependencies: [19, 21, 5032, 4603, 4607, 5028, 2]

// Module 8997 (Button/HeaderButton)
...
const diff = fn(5032).SMALL_BUTTON_HEIGHT - 2 * fn(5032).BUTTON_BORDER_WIDTH;
const diff1 = diff - fn(4603).TextStyleSheet["heading-md/bold"].lineHeight;
const createStyles = fn(4607);
const React4 = createStyles.createStyles({ pill: { paddingVertical: diff1 / 2 } });
HeaderButton.Icon = fn(5028).BaseTextButton.Icon;
const size = fn(2);
