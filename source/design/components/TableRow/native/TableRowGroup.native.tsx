...
// Function ID: 5773
// Name: TableRowGroup
// Dependencies: [19, 17, 21, 4639, 576, 4635, 4341, 5687, 5691, 2]
// Exports: TableRowGroup

// Module 5772 (TableRowGroup)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4341 */;
import Text_Text from "Text/Text" /* 4635 */;
import TableRowDivider from "TableRowDivider" /* 5687 */;
...
export const TableRowGroup = function TableRowGroup(accessibilityLabel) {
  ...
  if (tmp6Result3) {
    ...
    tmp6Result3 = tmp6(tmp2(4635).Text, obj4);
  }
  items[1] = tmp6Result3;
  ...
  if (tmp6Result4) {
    ...
    tmp6Result4 = tmp6(tmp2(4635).Text, obj5);
  }
  items[3] = tmp6Result4;
  obj2.children = items;
