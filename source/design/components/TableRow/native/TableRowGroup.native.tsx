...
// Function ID: 5858
// Name: TableRowGroup
// Dependencies: [19, 17, 21, 4722, 576, 4718, 4423, 5772, 5776, 2]
// Exports: TableRowGroup

// Module 5857 (TableRowGroup)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4423 */;
import Text_Text from "Text/Text" /* 4718 */;
import TableRowDivider from "TableRowDivider" /* 5772 */;
...
export const TableRowGroup = function TableRowGroup(accessibilityLabel) {
  ...
  if (tmp6Result3) {
    ...
    tmp6Result3 = tmp6(tmp2(4718).Text, obj4);
  }
  items[1] = tmp6Result3;
  ...
  if (tmp6Result4) {
    ...
    tmp6Result4 = tmp6(tmp2(4718).Text, obj5);
  }
  items[3] = tmp6Result4;
  obj2.children = items;
