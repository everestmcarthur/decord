...
// Dependencies: [32, 19, 1074, 21, 5774, 5775, 5776, 2]
// Exports: TableRadioGroup

// Module 5773 (TableRadioGroup)
...
export const TableRadioGroup = function TableRadioGroup(arg0) {
  ...
  jsx = obj.useContext(onChange(5774).RedesignCompatContext);
  ...
  obj2.children = jsx(onChange(5775).TableRowGroup, { accessibilityRole: "radiogroup", accessibilityLabel, title, description, helperText, hasIcons, children: null });
