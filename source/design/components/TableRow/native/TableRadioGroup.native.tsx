...
// Dependencies: [32, 19, 1074, 21, 5738, 5739, 5740, 2]
// Exports: TableRadioGroup

// Module 5737 (TableRadioGroup)
...
export const TableRadioGroup = function TableRadioGroup(arg0) {
  ...
  jsx = obj.useContext(onChange(5738).RedesignCompatContext);
  ...
  obj2.children = jsx(onChange(5739).TableRowGroup, { accessibilityRole: "radiogroup", accessibilityLabel, title, description, helperText, hasIcons, children: null });
