...
// Dependencies: [32, 19, 1074, 21, 5736, 5737, 5738, 2]
// Exports: TableRadioGroup

// Module 5735 (TableRadioGroup)
...
export const TableRadioGroup = function TableRadioGroup(arg0) {
  ...
  jsx = obj.useContext(onChange(5736).RedesignCompatContext);
  ...
  obj2.children = jsx(onChange(5737).TableRowGroup, { accessibilityRole: "radiogroup", accessibilityLabel, title, description, helperText, hasIcons, children: null });
