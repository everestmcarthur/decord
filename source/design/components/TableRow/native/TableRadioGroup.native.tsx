...
// Dependencies: [32, 19, 1074, 21, 5737, 5738, 5739, 2]
// Exports: TableRadioGroup

// Module 5736 (TableRadioGroup)
...
export const TableRadioGroup = function TableRadioGroup(arg0) {
  ...
  jsx = obj.useContext(onChange(5737).RedesignCompatContext);
  ...
  obj2.children = jsx(onChange(5738).TableRowGroup, { accessibilityRole: "radiogroup", accessibilityLabel, title, description, helperText, hasIcons, children: null });
