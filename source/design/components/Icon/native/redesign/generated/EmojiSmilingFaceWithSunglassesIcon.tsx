...
// Dependencies: [19, 21, 576, 4338, 15504, 2]
// Exports: EmojiSmilingFaceWithSunglassesIcon

// Module 15503 (EmojiSmilingFaceWithSunglassesIcon)
...
export const EmojiSmilingFaceWithSunglassesIcon = function EmojiSmilingFaceWithSunglassesIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15504, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
