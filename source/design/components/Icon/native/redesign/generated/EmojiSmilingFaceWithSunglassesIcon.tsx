...
// Dependencies: [19, 21, 576, 4340, 15488, 2]
// Exports: EmojiSmilingFaceWithSunglassesIcon

// Module 15487 (EmojiSmilingFaceWithSunglassesIcon)
...
export const EmojiSmilingFaceWithSunglassesIcon = function EmojiSmilingFaceWithSunglassesIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15488, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
