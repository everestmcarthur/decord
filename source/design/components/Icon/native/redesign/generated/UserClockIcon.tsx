...
// Function ID: 13156
// Name: UserClockIcon
// Dependencies: [19, 21, 576, 4274, 13156, 2]
// Exports: UserClockIcon

// Module 13155 (UserClockIcon)
...
export const UserClockIcon = function UserClockIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13156, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
