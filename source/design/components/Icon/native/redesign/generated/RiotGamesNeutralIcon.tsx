...
// Dependencies: [19, 21, 576, 4274, 8736, 2]
// Exports: RiotGamesNeutralIcon

// Module 8735 (RiotGamesNeutralIcon)
...
export const RiotGamesNeutralIcon = function RiotGamesNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8736, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
