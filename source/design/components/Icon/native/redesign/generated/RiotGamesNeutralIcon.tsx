...
// Dependencies: [19, 21, 576, 4340, 8829, 2]
// Exports: RiotGamesNeutralIcon

// Module 8828 (RiotGamesNeutralIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4340 */;
import _mod8829 from "module_8829" /* 8829 */;
...
export const RiotGamesNeutralIcon = function RiotGamesNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8829, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
