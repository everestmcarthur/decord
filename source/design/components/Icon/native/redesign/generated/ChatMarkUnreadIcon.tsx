...
// Dependencies: [19, 21, 576, 4274, 10277, 2]
// Exports: ChatMarkUnreadIcon

// Module 10276 (ChatMarkUnreadIcon)
...
export const ChatMarkUnreadIcon = function ChatMarkUnreadIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10277, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
