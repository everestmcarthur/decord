...
// Dependencies: [19, 21, 576, 4305, 10315, 2]
// Exports: ChatMarkUnreadIcon

// Module 10314 (ChatMarkUnreadIcon)
...
export const ChatMarkUnreadIcon = function ChatMarkUnreadIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10315, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
