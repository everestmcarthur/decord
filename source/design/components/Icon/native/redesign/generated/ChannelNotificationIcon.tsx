...
// Dependencies: [19, 21, 576, 4274, 10994, 2]
// Exports: ChannelNotificationIcon

// Module 10993 (ChannelNotificationIcon)
...
export const ChannelNotificationIcon = function ChannelNotificationIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10994, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
