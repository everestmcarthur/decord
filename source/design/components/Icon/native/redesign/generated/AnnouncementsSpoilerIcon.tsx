...
// Dependencies: [19, 21, 576, 4307, 5099, 2]
// Exports: AnnouncementsSpoilerIcon

// Module 5144 (AnnouncementsSpoilerIcon)
...
export const AnnouncementsSpoilerIcon = function AnnouncementsSpoilerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5099, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
