...
// Function ID: 10525
// Name: AnalyticsIcon
// Dependencies: [19, 21, 576, 4338, 10525, 2]
// Exports: AnalyticsIcon

// Module 10524 (AnalyticsIcon)
...
export const AnalyticsIcon = function AnalyticsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10525, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
