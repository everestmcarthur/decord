...
// Function ID: 10517
// Name: AnalyticsIcon
// Dependencies: [19, 21, 576, 4340, 10517, 2]
// Exports: AnalyticsIcon

// Module 10516 (AnalyticsIcon)
...
export const AnalyticsIcon = function AnalyticsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10517, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
