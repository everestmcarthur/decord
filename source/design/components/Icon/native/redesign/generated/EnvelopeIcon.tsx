...
// Function ID: 7192
// Name: EnvelopeIcon
// Dependencies: [19, 21, 576, 4338, 7192, 2]
// Exports: EnvelopeIcon

// Module 7191 (EnvelopeIcon)
...
export const EnvelopeIcon = function EnvelopeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7192, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
