...
// Function ID: 7189
// Name: EnvelopeIcon
// Dependencies: [19, 21, 576, 4340, 7189, 2]
// Exports: EnvelopeIcon

// Module 7188 (EnvelopeIcon)
...
export const EnvelopeIcon = function EnvelopeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7189, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
