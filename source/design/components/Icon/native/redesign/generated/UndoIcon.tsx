...
// Function ID: 15201
// Name: UndoIcon
// Dependencies: [19, 21, 576, 4340, 15201, 2]
// Exports: UndoIcon

// Module 15200 (UndoIcon)
...
export const UndoIcon = function UndoIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15201, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
