...
// Function ID: 11301
// Name: CirclePlusIcon
// Dependencies: [19, 17, 21, 576, 4307, 11301, 11302, 2]
// Exports: CirclePlusIcon

// Module 11300 (CirclePlusIcon)
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod11301, color: secondaryColor, style }), ];
  const obj3 = { source: _mod11302, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
