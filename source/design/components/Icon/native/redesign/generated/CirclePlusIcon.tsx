...
// Function ID: 11338
// Name: CirclePlusIcon
// Dependencies: [19, 17, 21, 576, 4337, 11338, 11339, 2]
// Exports: CirclePlusIcon

// Module 11337 (CirclePlusIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4337 */;
import _mod11338 from "module_11338" /* 11338 */;
import _mod11339 from "module_11339" /* 11339 */;
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod11338, color: secondaryColor, style }), ];
  const obj3 = { source: _mod11339, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
