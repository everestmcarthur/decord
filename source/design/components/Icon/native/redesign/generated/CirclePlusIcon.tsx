...
// Function ID: 11339
// Name: CirclePlusIcon
// Dependencies: [19, 17, 21, 576, 4337, 11339, 11340, 2]
// Exports: CirclePlusIcon

// Module 11338 (CirclePlusIcon)
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod11339, color: secondaryColor, style }), ];
  const obj3 = { source: _mod11340, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
