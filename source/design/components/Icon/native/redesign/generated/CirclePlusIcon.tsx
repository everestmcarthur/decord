...
// Function ID: 11299
// Name: CirclePlusIcon
// Dependencies: [19, 17, 21, 576, 4307, 11299, 11300, 2]
// Exports: CirclePlusIcon

// Module 11298 (CirclePlusIcon)
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod11299, color: secondaryColor, style }), ];
  const obj3 = { source: _mod11300, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
