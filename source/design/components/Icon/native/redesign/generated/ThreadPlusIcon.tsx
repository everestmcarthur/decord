...
// Function ID: 12308
// Name: ThreadPlusIcon
// Dependencies: [19, 21, 576, 4305, 12308, 2]
// Exports: ThreadPlusIcon

// Module 12307 (ThreadPlusIcon)
...
export const ThreadPlusIcon = function ThreadPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12308, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
