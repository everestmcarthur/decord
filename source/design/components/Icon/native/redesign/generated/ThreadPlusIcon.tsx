...
// Function ID: 12372
// Name: ThreadPlusIcon
// Dependencies: [19, 21, 576, 4340, 12372, 2]
// Exports: ThreadPlusIcon

// Module 12371 (ThreadPlusIcon)
...
export const ThreadPlusIcon = function ThreadPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12372, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
