...
// Dependencies: [19, 21, 576, 4340, 10122, 2]
// Exports: ScreenArrowIcon

// Module 12684 (ScreenArrowIcon)
...
export const ScreenArrowIcon = function ScreenArrowIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10122, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
