...
// Dependencies: [19, 21, 576, 4340, 10103, 2]
// Exports: ScreenArrowIcon

// Module 12667 (ScreenArrowIcon)
...
export const ScreenArrowIcon = function ScreenArrowIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10103, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
