...
// Dependencies: [19, 21, 576, 4274, 11186, 2]
// Exports: ChevronSmallDownIcon

// Module 11185 (ChevronSmallDownIcon)
...
export const ChevronSmallDownIcon = function ChevronSmallDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11186, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
