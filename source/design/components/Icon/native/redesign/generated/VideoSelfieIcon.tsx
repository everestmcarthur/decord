...
// Dependencies: [19, 21, 576, 4307, 8530, 2]
// Exports: VideoSelfieIcon

// Module 8529 (VideoSelfieIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4307 */;
import _mod8530 from "module_8530" /* 8530 */;
...
export const VideoSelfieIcon = function VideoSelfieIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8530, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
