...
// Dependencies: [19, 21, 576, 4274, 8472, 2]
// Exports: VideoSelfieIcon

// Module 8471 (VideoSelfieIcon)
...
export const VideoSelfieIcon = function VideoSelfieIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8472, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
