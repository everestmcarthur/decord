...
// Function ID: 13040
// Name: NewUserIcon
// Dependencies: [19, 21, 576, 4274, 13040, 2]
// Exports: NewUserIcon

// Module 13039 (NewUserIcon)
...
export const NewUserIcon = function NewUserIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13040, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
