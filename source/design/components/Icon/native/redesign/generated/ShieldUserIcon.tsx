...
// Function ID: 9904
// Name: ShieldUserIcon
// Dependencies: [19, 21, 576, 4340, 8271, 2]
// Exports: ShieldUserIcon

// Module 9903 (ShieldUserIcon)
...
export const ShieldUserIcon = function ShieldUserIcon(tmp2Result) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8271, color: INTERACTIVE_ICON_DEFAULT, style: tmp2Result.style });
};
