...
// Function ID: 9893
// Name: ShieldUserIcon
// Dependencies: [19, 21, 576, 4338, 8252, 2]
// Exports: ShieldUserIcon

// Module 9892 (ShieldUserIcon)
...
export const ShieldUserIcon = function ShieldUserIcon(tmp2Result) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8252, color: INTERACTIVE_ICON_DEFAULT, style: tmp2Result.style });
};
