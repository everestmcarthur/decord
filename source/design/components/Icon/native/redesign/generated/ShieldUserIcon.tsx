...
// Function ID: 9885
// Name: ShieldUserIcon
// Dependencies: [19, 21, 576, 4340, 8243, 2]
// Exports: ShieldUserIcon

// Module 9884 (ShieldUserIcon)
...
export const ShieldUserIcon = function ShieldUserIcon(tmp2Result) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8243, color: INTERACTIVE_ICON_DEFAULT, style: tmp2Result.style });
};
