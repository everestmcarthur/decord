...
// Function ID: 13413
// Name: VideoDenyIcon
// Dependencies: [19, 21, 576, 4337, 13413, 2]
// Exports: VideoDenyIcon

// Module 13412 (VideoDenyIcon)
...
export const VideoDenyIcon = function VideoDenyIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13413, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
