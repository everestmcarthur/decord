...
// Dependencies: [19, 21, 576, 4340, 4591, 2]
// Exports: CheckmarkLargeIcon

// Module 4590 (CheckmarkLargeIcon)
...
export const CheckmarkLargeIcon = function CheckmarkLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4591, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
