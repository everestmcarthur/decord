...
// Dependencies: [19, 21, 576, 4305, 13919, 2]
// Exports: ChannelListMagnifyingGlassIcon

// Module 13918 (ChannelListMagnifyingGlassIcon)
...
export const ChannelListMagnifyingGlassIcon = function ChannelListMagnifyingGlassIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13919, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
