...
// Dependencies: [19, 21, 576, 4307, 8987, 2]
// Exports: TwitchNeutralIcon

// Module 8986 (TwitchNeutralIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4307 */;
import _mod8987 from "module_8987" /* 8987 */;
...
export const TwitchNeutralIcon = function TwitchNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8987, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
