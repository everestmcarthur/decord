...
// Dependencies: [19, 21, 576, 4338, 9038, 2]
// Exports: TwitchNeutralIcon

// Module 9037 (TwitchNeutralIcon)
...
export const TwitchNeutralIcon = function TwitchNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9038, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
