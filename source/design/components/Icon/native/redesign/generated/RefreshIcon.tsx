...
// Function ID: 15250
// Name: RefreshIcon
// Dependencies: [19, 21, 576, 4340, 15250, 2]
// Exports: RefreshIcon

// Module 15249 (RefreshIcon)
...
export const RefreshIcon = function RefreshIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15250, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
