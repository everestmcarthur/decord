...
// Function ID: 11024
// Name: PlusLargeIcon
// Dependencies: [19, 21, 576, 4305, 11024, 2]
// Exports: PlusLargeIcon

// Module 11023 (PlusLargeIcon)
...
export const PlusLargeIcon = function PlusLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11024, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
