...
// Function ID: 10984
// Name: PlusLargeIcon
// Dependencies: [19, 21, 576, 4274, 10984, 2]
// Exports: PlusLargeIcon

// Module 10983 (PlusLargeIcon)
...
export const PlusLargeIcon = function PlusLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10984, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
