...
// Function ID: 11088
// Name: PlusLargeIcon
// Dependencies: [19, 21, 576, 4340, 11088, 2]
// Exports: PlusLargeIcon

// Module 11087 (PlusLargeIcon)
...
export const PlusLargeIcon = function PlusLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11088, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
