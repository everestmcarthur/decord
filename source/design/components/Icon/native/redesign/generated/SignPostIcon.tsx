...
// Function ID: 13957
// Name: SignPostIcon
// Dependencies: [19, 21, 576, 4340, 13957, 2]
// Exports: SignPostIcon

// Module 13956 (SignPostIcon)
...
export const SignPostIcon = function SignPostIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13957, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
