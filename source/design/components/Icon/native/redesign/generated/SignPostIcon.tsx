...
// Function ID: 13868
// Name: SignPostIcon
// Dependencies: [19, 21, 576, 4274, 13868, 2]
// Exports: SignPostIcon

// Module 13867 (SignPostIcon)
...
export const SignPostIcon = function SignPostIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13868, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
