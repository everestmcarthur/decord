...
// Function ID: 13930
// Name: SignPostIcon
// Dependencies: [19, 21, 576, 4337, 13930, 2]
// Exports: SignPostIcon

// Module 13929 (SignPostIcon)
...
export const SignPostIcon = function SignPostIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13930, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
