...
// Dependencies: [19, 21, 576, 4338, 8267, 2]
// Exports: GameControllerIcon

// Module 9366 (GameControllerIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4338 */;
import _mod8267 from "module_8267" /* 8267 */;
...
export const GameControllerIcon = function GameControllerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8267, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
