...
// Dependencies: [19, 21, 576, 4338, 15736, 2]
// Exports: DoubleCheckmarkIcon

// Module 15735 (DoubleCheckmarkIcon)
...
export const DoubleCheckmarkIcon = function DoubleCheckmarkIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15736, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
