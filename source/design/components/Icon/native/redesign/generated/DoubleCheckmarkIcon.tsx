...
// Dependencies: [19, 21, 576, 4340, 15718, 2]
// Exports: DoubleCheckmarkIcon

// Module 15717 (DoubleCheckmarkIcon)
...
export const DoubleCheckmarkIcon = function DoubleCheckmarkIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15718, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
