...
// Dependencies: [19, 21, 576, 4274, 15408, 2]
// Exports: EmojiFaceWithSpiralEyesIcon

// Module 15407 (EmojiFaceWithSpiralEyesIcon)
...
export const EmojiFaceWithSpiralEyesIcon = function EmojiFaceWithSpiralEyesIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15408, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
