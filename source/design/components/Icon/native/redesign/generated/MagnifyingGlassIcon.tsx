...
// Dependencies: [19, 21, 576, 4307, 7126, 2]
// Exports: MagnifyingGlassIcon

// Module 7125 (MagnifyingGlassIcon)
...
export const MagnifyingGlassIcon = function MagnifyingGlassIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7126, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
