...
// Dependencies: [19, 21, 576, 4307, 7125, 2]
// Exports: MagnifyingGlassIcon

// Module 7124 (MagnifyingGlassIcon)
...
export const MagnifyingGlassIcon = function MagnifyingGlassIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7125, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
