...
// Dependencies: [19, 21, 576, 4340, 15714, 2]
// Exports: AchievementsIcon

// Module 15713 (AchievementsIcon)
...
export const AchievementsIcon = function AchievementsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15714, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
