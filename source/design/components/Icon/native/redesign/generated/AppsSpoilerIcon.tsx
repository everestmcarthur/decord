...
// Dependencies: [19, 21, 576, 4307, 5108, 2]
// Exports: AppsSpoilerIcon

// Module 5156 (AppsSpoilerIcon)
...
export const AppsSpoilerIcon = function AppsSpoilerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5108, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
