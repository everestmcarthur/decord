...
// Dependencies: [19, 21, 576, 4338, 9517, 2]
// Exports: SuperReactionIcon

// Module 9516 (SuperReactionIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4338 */;
import _mod9517 from "module_9517" /* 9517 */;
...
export const SuperReactionIcon = function SuperReactionIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9517, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
