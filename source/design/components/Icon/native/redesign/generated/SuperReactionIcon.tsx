...
// Dependencies: [19, 21, 576, 4340, 9528, 2]
// Exports: SuperReactionIcon

// Module 9527 (SuperReactionIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4340 */;
import _mod9528 from "module_9528" /* 9528 */;
...
export const SuperReactionIcon = function SuperReactionIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9528, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
