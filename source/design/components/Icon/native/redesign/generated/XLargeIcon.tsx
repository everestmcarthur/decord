...
// Function ID: 4560
// Name: XLargeIcon
// Dependencies: [19, 21, 576, 4307, 4560, 2]
// Exports: XLargeIcon

// Module 4559 (XLargeIcon)
...
export const XLargeIcon = function XLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4560, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
