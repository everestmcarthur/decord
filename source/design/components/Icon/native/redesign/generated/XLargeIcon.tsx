...
// Function ID: 4528
// Name: XLargeIcon
// Dependencies: [19, 21, 576, 4274, 4528, 2]
// Exports: XLargeIcon

// Module 4527 (XLargeIcon)
...
export const XLargeIcon = function XLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4528, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
