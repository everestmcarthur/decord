...
// Dependencies: [19, 21, 576, 4274, 15428, 2]
// Exports: EmojiUpsideDownFaceIcon

// Module 15427 (EmojiUpsideDownFaceIcon)
...
export const EmojiUpsideDownFaceIcon = function EmojiUpsideDownFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15428, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
