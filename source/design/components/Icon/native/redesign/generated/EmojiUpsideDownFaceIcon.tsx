...
// Dependencies: [19, 21, 576, 4340, 15513, 2]
// Exports: EmojiUpsideDownFaceIcon

// Module 15512 (EmojiUpsideDownFaceIcon)
...
export const EmojiUpsideDownFaceIcon = function EmojiUpsideDownFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15513, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
