...
// Dependencies: [19, 21, 576, 4274, 12615, 2]
// Exports: BoostGemSlashIcon

// Module 12614 (BoostGemSlashIcon)
...
export const BoostGemSlashIcon = function BoostGemSlashIcon(isTierUnlocked) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12615, color: INTERACTIVE_ICON_DEFAULT, style: isTierUnlocked.style });
};
