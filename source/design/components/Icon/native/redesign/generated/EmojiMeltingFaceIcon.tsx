...
// Dependencies: [19, 21, 576, 4337, 15463, 2]
// Exports: EmojiMeltingFaceIcon

// Module 15462 (EmojiMeltingFaceIcon)
...
export const EmojiMeltingFaceIcon = function EmojiMeltingFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15463, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
