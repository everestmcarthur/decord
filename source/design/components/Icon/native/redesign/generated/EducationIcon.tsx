...
// Function ID: 11480
// Name: EducationIcon
// Dependencies: [19, 21, 576, 4305, 11478, 2]
// Exports: EducationIcon

// Module 11479 (EducationIcon)
...
export const EducationIcon = function EducationIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11478, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
