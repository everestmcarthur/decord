...
// Dependencies: [19, 21, 576, 4338, 9269, 2]
// Exports: MicrophoneDenyIcon

// Module 9268 (MicrophoneDenyIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4338 */;
import _mod9269 from "module_9269" /* 9269 */;
...
export const MicrophoneDenyIcon = function MicrophoneDenyIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9269, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
