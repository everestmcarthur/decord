...
// Dependencies: [19, 21, 576, 4340, 9258, 2]
// Exports: MicrophoneDenyIcon

// Module 9257 (MicrophoneDenyIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4340 */;
import _mod9258 from "module_9258" /* 9258 */;
...
export const MicrophoneDenyIcon = function MicrophoneDenyIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9258, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
