...
// Function ID: 8567
// Name: IdCardIcon
// Dependencies: [19, 21, 576, 4340, 8567, 2]
// Exports: IdCardIcon

// Module 8566 (IdCardIcon)
...
export const IdCardIcon = function IdCardIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8567, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
