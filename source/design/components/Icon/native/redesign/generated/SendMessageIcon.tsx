...
// Dependencies: [19, 21, 576, 4338, 4583, 2]
// Exports: SendMessageIcon

// Module 4582 (SendMessageIcon)
...
export const SendMessageIcon = function SendMessageIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4583, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
