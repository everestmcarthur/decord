...
// Function ID: 8116
// Name: PaperIcon
// Dependencies: [19, 21, 576, 4422, 8116, 2]
// Exports: PaperIcon

// Module 8115 (PaperIcon)
...
export const PaperIcon = function PaperIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8116, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
