...
// Function ID: 5259
// Name: GroupIcon
// Dependencies: [19, 21, 576, 4422, 5203, 2]
// Exports: GroupIcon

// Module 5258 (GroupIcon)
...
export const GroupIcon = function GroupIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5203, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
