...
// Function ID: 10138
// Name: VoiceXIcon
// Dependencies: [19, 21, 576, 4340, 10138, 2]
// Exports: VoiceXIcon

// Module 10137 (VoiceXIcon)
...
export const VoiceXIcon = function VoiceXIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10138, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
