...
// Function ID: 10127
// Name: VoiceXIcon
// Dependencies: [19, 21, 576, 4338, 10127, 2]
// Exports: VoiceXIcon

// Module 10126 (VoiceXIcon)
...
export const VoiceXIcon = function VoiceXIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10127, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
