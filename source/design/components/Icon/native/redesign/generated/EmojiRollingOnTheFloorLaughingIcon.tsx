...
// Dependencies: [19, 21, 576, 4340, 15498, 2]
// Exports: EmojiRollingOnTheFloorLaughingIcon

// Module 15497 (EmojiRollingOnTheFloorLaughingIcon)
...
export const EmojiRollingOnTheFloorLaughingIcon = function EmojiRollingOnTheFloorLaughingIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15498, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
