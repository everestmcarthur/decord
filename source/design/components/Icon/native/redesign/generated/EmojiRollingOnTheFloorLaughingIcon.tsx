...
// Dependencies: [19, 21, 576, 4340, 15519, 2]
// Exports: EmojiRollingOnTheFloorLaughingIcon

// Module 15518 (EmojiRollingOnTheFloorLaughingIcon)
...
export const EmojiRollingOnTheFloorLaughingIcon = function EmojiRollingOnTheFloorLaughingIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15519, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
