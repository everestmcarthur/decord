...
// Dependencies: [19, 21, 576, 4338, 15514, 2]
// Exports: EmojiRollingOnTheFloorLaughingIcon

// Module 15513 (EmojiRollingOnTheFloorLaughingIcon)
...
export const EmojiRollingOnTheFloorLaughingIcon = function EmojiRollingOnTheFloorLaughingIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15514, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
