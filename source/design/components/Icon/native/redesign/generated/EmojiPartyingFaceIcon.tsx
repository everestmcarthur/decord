...
// Dependencies: [19, 21, 576, 4337, 15469, 2]
// Exports: EmojiPartyingFaceIcon

// Module 15468 (EmojiPartyingFaceIcon)
...
export const EmojiPartyingFaceIcon = function EmojiPartyingFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15469, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
