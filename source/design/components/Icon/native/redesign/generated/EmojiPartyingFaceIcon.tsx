...
// Dependencies: [19, 21, 576, 4338, 15496, 2]
// Exports: EmojiPartyingFaceIcon

// Module 15495 (EmojiPartyingFaceIcon)
...
export const EmojiPartyingFaceIcon = function EmojiPartyingFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15496, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
