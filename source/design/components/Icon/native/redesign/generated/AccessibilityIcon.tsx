...
// Dependencies: [19, 21, 576, 4422, 15539, 2]
// Exports: AccessibilityIcon

// Module 15538 (AccessibilityIcon)
...
export const AccessibilityIcon = function AccessibilityIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15539, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
