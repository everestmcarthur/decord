...
// Function ID: 12599
// Name: SoundboardIcon
// Dependencies: [19, 21, 576, 4305, 12599, 2]
// Exports: SoundboardIcon

// Module 12598 (SoundboardIcon)
...
export const SoundboardIcon = function SoundboardIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12599, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
