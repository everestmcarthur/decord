...
// Function ID: 12659
// Name: SoundboardIcon
// Dependencies: [19, 21, 576, 4337, 12659, 2]
// Exports: SoundboardIcon

// Module 12658 (SoundboardIcon)
...
export const SoundboardIcon = function SoundboardIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12659, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
