...
// Function ID: 11117
// Name: InboxIcon
// Dependencies: [19, 21, 576, 4340, 11117, 2]
// Exports: InboxIcon

// Module 11116 (InboxIcon)
...
export const InboxIcon = function InboxIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11117, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
