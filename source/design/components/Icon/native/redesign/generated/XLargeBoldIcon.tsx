...
// Function ID: 9264
// Name: XLargeBoldIcon
// Dependencies: [19, 21, 576, 4307, 9264, 2]
// Exports: XLargeBoldIcon

// Module 9263 (XLargeBoldIcon)
...
export const XLargeBoldIcon = function XLargeBoldIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9264, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
