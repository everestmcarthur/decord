...
// Function ID: 9204
// Name: XLargeBoldIcon
// Dependencies: [19, 21, 576, 4274, 9204, 2]
// Exports: XLargeBoldIcon

// Module 9203 (XLargeBoldIcon)
...
export const XLargeBoldIcon = function XLargeBoldIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9204, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
