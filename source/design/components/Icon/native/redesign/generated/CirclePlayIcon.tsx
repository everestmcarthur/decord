...
// Function ID: 10263
// Name: CirclePlayIcon
// Dependencies: [19, 17, 21, 576, 4340, 10263, 10264, 2]
// Exports: CirclePlayIcon

// Module 10262 (CirclePlayIcon)
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod10263, color: secondaryColor, style }), ];
  const obj3 = { source: _mod10264, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
