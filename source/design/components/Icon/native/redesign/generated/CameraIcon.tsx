...
// Function ID: 10795
// Name: CameraIcon
// Dependencies: [19, 21, 576, 4338, 10795, 2]
// Exports: CameraIcon

// Module 10794 (CameraIcon)
...
export const CameraIcon = function CameraIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10795, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
