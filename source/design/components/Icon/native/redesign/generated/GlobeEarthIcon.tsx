...
// Function ID: 9019
// Name: GlobeEarthIcon
// Dependencies: [19, 21, 576, 4340, 9019, 2]
// Exports: GlobeEarthIcon

// Module 9018 (GlobeEarthIcon)
...
export const GlobeEarthIcon = function GlobeEarthIcon(dependencyMap) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9019, color: INTERACTIVE_ICON_DEFAULT, style: dependencyMap.style });
};
