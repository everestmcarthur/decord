...
// Function ID: 9065
// Name: QuoteIcon
// Dependencies: [19, 21, 576, 4338, 9065, 2]
// Exports: QuoteIcon

// Module 9064 (QuoteIcon)
...
export const QuoteIcon = function QuoteIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9065, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
