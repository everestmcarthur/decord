...
// Dependencies: [19, 21, 576, 4340, 9256, 2]
// Exports: HeadphonesSlashIcon

// Module 9255 (HeadphonesSlashIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4340 */;
import _mod9256 from "module_9256" /* 9256 */;
...
export const HeadphonesSlashIcon = function HeadphonesSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9256, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
