...
// Function ID: 13148
// Name: PaperPlusIcon
// Dependencies: [19, 21, 576, 4307, 13148, 2]
// Exports: PaperPlusIcon

// Module 13147 (PaperPlusIcon)
...
export const PaperPlusIcon = function PaperPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13148, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
