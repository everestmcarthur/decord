...
// Dependencies: [19, 21, 576, 4274, 8732, 2]
// Exports: RobloxNeutralIcon

// Module 8731 (RobloxNeutralIcon)
...
export const RobloxNeutralIcon = function RobloxNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8732, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
