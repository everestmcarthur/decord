...
// Dependencies: [19, 21, 576, 4340, 8825, 2]
// Exports: RobloxNeutralIcon

// Module 8824 (RobloxNeutralIcon)
...
export const RobloxNeutralIcon = function RobloxNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8825, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
