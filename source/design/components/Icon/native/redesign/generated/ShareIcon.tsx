...
// Function ID: 9144
// Name: ShareIcon
// Dependencies: [19, 21, 576, 4307, 9144, 2]
// Exports: ShareIcon

// Module 9143 (ShareIcon)
...
export const ShareIcon = function ShareIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9144, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
