...
// Dependencies: [19, 21, 576, 4338, 9025, 2]
// Exports: PlaystationNeutralIcon

// Module 9024 (PlaystationNeutralIcon)
...
export const PlaystationNeutralIcon = function PlaystationNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9025, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
