...
// Dependencies: [19, 21, 576, 4340, 9040, 2]
// Exports: PlaystationNeutralIcon

// Module 9039 (PlaystationNeutralIcon)
...
export const PlaystationNeutralIcon = function PlaystationNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9040, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
