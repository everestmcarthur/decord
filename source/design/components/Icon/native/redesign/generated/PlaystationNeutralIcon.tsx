...
// Dependencies: [19, 21, 576, 4422, 9124, 2]
// Exports: PlaystationNeutralIcon

// Module 9123 (PlaystationNeutralIcon)
...
export const PlaystationNeutralIcon = function PlaystationNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9124, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
