...
// Dependencies: [19, 21, 576, 4340, 9014, 2]
// Exports: PlaystationNeutralIcon

// Module 9013 (PlaystationNeutralIcon)
...
export const PlaystationNeutralIcon = function PlaystationNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9014, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
