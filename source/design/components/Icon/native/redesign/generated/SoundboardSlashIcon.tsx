...
// Dependencies: [19, 21, 576, 4305, 13115, 2]
// Exports: SoundboardSlashIcon

// Module 13114 (SoundboardSlashIcon)
...
export const SoundboardSlashIcon = function SoundboardSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13115, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
