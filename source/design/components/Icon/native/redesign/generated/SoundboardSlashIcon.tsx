...
// Dependencies: [19, 21, 576, 4340, 13200, 2]
// Exports: SoundboardSlashIcon

// Module 13199 (SoundboardSlashIcon)
...
export const SoundboardSlashIcon = function SoundboardSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13200, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
