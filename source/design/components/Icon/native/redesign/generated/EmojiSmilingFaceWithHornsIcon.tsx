...
// Dependencies: [19, 21, 576, 4338, 15502, 2]
// Exports: EmojiSmilingFaceWithHornsIcon

// Module 15501 (EmojiSmilingFaceWithHornsIcon)
...
export const EmojiSmilingFaceWithHornsIcon = function EmojiSmilingFaceWithHornsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15502, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
