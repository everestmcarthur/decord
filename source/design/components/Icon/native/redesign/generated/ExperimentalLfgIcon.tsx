...
// Dependencies: [19, 21, 576, 4274, 5074, 2]
// Exports: ExperimentalLfgIcon

// Module 5084 (ExperimentalLfgIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4274 */;
import _mod5074 from "module_5074" /* 5074 */;
...
export const ExperimentalLfgIcon = function ExperimentalLfgIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5074, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
