...
// Dependencies: [19, 21, 576, 4305, 5110, 2]
// Exports: ExperimentalLfgIcon

// Module 5120 (ExperimentalLfgIcon)
...
export const ExperimentalLfgIcon = function ExperimentalLfgIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5110, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
