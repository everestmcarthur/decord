...
// Dependencies: [19, 21, 576, 4307, 13143, 2]
// Exports: ThreadMinusIcon

// Module 13142 (ThreadMinusIcon)
...
export const ThreadMinusIcon = function ThreadMinusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13143, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
