...
// Dependencies: [19, 21, 576, 4274, 13080, 2]
// Exports: ThreadMinusIcon

// Module 13079 (ThreadMinusIcon)
...
export const ThreadMinusIcon = function ThreadMinusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13080, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
