...
// Dependencies: [19, 21, 576, 4338, 13197, 2]
// Exports: ThreadMinusIcon

// Module 13196 (ThreadMinusIcon)
...
export const ThreadMinusIcon = function ThreadMinusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13197, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
