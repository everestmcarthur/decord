...
// Dependencies: [19, 21, 576, 4340, 13186, 2]
// Exports: ThreadMinusIcon

// Module 13185 (ThreadMinusIcon)
...
export const ThreadMinusIcon = function ThreadMinusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13186, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
