...
// Function ID: 15694
// Name: StaffBadgeIcon
// Dependencies: [19, 21, 576, 4338, 15694, 2]
// Exports: StaffBadgeIcon

// Module 15693 (StaffBadgeIcon)
...
export const StaffBadgeIcon = function StaffBadgeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15694, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
