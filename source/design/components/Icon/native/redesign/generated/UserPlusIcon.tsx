...
// Function ID: 4575
// Name: UserPlusIcon
// Dependencies: [19, 21, 576, 4338, 4575, 2]
// Exports: UserPlusIcon

// Module 4574 (UserPlusIcon)
...
export const UserPlusIcon = function UserPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4575, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
