...
// Dependencies: [19, 21, 576, 4337, 15355, 2]
// Exports: ThemeMidnightIcon

// Module 15354 (ThemeMidnightIcon)
...
export const ThemeMidnightIcon = function ThemeMidnightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15355, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
