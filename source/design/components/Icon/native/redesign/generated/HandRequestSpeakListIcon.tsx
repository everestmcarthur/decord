...
// Dependencies: [19, 21, 576, 4305, 9999, 2]
// Exports: HandRequestSpeakListIcon

// Module 9998 (HandRequestSpeakListIcon)
...
export const HandRequestSpeakListIcon = function HandRequestSpeakListIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9999, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
