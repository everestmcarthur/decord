...
// Dependencies: [19, 21, 576, 4274, 7148, 2]
// Exports: CheckmarkSmallIcon

// Module 7147 (CheckmarkSmallIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4274 */;
import _mod7148 from "module_7148" /* 7148 */;
...
export const CheckmarkSmallIcon = function CheckmarkSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7148, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
