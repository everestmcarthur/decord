...
// Dependencies: [19, 21, 576, 4305, 15485, 2]
// Exports: EmojiSmilingFaceWithHeartsIcon

// Module 15484 (EmojiSmilingFaceWithHeartsIcon)
...
export const EmojiSmilingFaceWithHeartsIcon = function EmojiSmilingFaceWithHeartsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15485, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
