...
// Function ID: 11919
// Name: CloudIcon
// Dependencies: [19, 21, 576, 4337, 11919, 2]
// Exports: CloudIcon

// Module 11918 (CloudIcon)
...
export const CloudIcon = function CloudIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11919, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
