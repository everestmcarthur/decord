...
// Dependencies: [19, 21, 576, 4340, 5714, 2]
// Exports: ArrowLargeLeftIcon

// Module 5713 (ArrowLargeLeftIcon)
...
export const ArrowLargeLeftIcon = function ArrowLargeLeftIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5714, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
