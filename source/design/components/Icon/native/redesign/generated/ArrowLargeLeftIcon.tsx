...
// Dependencies: [19, 21, 576, 4338, 5715, 2]
// Exports: ArrowLargeLeftIcon

// Module 5714 (ArrowLargeLeftIcon)
...
export const ArrowLargeLeftIcon = function ArrowLargeLeftIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5715, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
