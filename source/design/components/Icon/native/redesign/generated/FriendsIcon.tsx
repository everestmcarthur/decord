...
// Function ID: 4338
// Name: FriendsIcon
// Dependencies: [19, 21, 576, 4338, 4573, 2]
// Exports: FriendsIcon

// Module 4337 (FriendsIcon)
...
export const FriendsIcon = function FriendsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4573, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
