...
// Function ID: 10505
// Name: ObjectIcon
// Dependencies: [19, 21, 576, 4340, 10505, 2]
// Exports: ObjectIcon

// Module 10504 (ObjectIcon)
...
export const ObjectIcon = function ObjectIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10505, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
