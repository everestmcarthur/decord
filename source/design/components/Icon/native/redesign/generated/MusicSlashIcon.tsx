...
// Function ID: 10003
// Name: MusicSlashIcon
// Dependencies: [19, 21, 576, 4307, 10003, 2]
// Exports: MusicSlashIcon

// Module 10002 (MusicSlashIcon)
...
export const MusicSlashIcon = function MusicSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10003, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
