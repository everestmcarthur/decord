...
// Dependencies: [19, 21, 576, 4274, 5055, 2]
// Exports: VoiceWarningIcon

// Module 5113 (VoiceWarningIcon)
...
export const VoiceWarningIcon = function VoiceWarningIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5055, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
