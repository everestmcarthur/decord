...
// Dependencies: [19, 21, 576, 4305, 5091, 2]
// Exports: VoiceWarningIcon

// Module 5149 (VoiceWarningIcon)
...
export const VoiceWarningIcon = function VoiceWarningIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5091, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
