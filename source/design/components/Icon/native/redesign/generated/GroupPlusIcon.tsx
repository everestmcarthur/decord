...
// Function ID: 10172
// Name: GroupPlusIcon
// Dependencies: [19, 21, 576, 4338, 10170, 2]
// Exports: GroupPlusIcon

// Module 10171 (GroupPlusIcon)
...
export const GroupPlusIcon = function GroupPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10170, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
