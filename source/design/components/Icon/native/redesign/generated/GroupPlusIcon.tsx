...
// Function ID: 10164
// Name: GroupPlusIcon
// Dependencies: [19, 21, 576, 4340, 10162, 2]
// Exports: GroupPlusIcon

// Module 10163 (GroupPlusIcon)
...
export const GroupPlusIcon = function GroupPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10162, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
