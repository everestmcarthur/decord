...
// Function ID: 15269
// Name: TicketIcon
// Dependencies: [19, 21, 576, 4307, 15269, 2]
// Exports: TicketIcon

// Module 15268 (TicketIcon)
...
export const TicketIcon = function TicketIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15269, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
