...
// Dependencies: [19, 21, 576, 4340, 15850, 2]
// Exports: ArrowSmallDownIcon

// Module 15849 (ArrowSmallDownIcon)
...
export const ArrowSmallDownIcon = function ArrowSmallDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15850, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
