...
// Function ID: 10340
// Name: PencilIcon
// Dependencies: [19, 21, 576, 4307, 8040, 2]
// Exports: PencilIcon

// Module 10339 (PencilIcon)
...
export const PencilIcon = function PencilIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8040, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
