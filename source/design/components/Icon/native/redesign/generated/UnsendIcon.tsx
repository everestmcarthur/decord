...
// Function ID: 15192
// Name: UnsendIcon
// Dependencies: [19, 21, 576, 4337, 15192, 2]
// Exports: UnsendIcon

// Module 15191 (UnsendIcon)
...
export const UnsendIcon = function UnsendIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15192, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
