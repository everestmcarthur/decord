...
// Function ID: 10495
// Name: BackspaceIcon
// Dependencies: [19, 21, 576, 4340, 10495, 2]
// Exports: BackspaceIcon

// Module 10494 (BackspaceIcon)
...
export const BackspaceIcon = function BackspaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10495, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
