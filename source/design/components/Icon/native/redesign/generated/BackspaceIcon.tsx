...
// Function ID: 10511
// Name: BackspaceIcon
// Dependencies: [19, 21, 576, 4340, 10511, 2]
// Exports: BackspaceIcon

// Module 10510 (BackspaceIcon)
...
export const BackspaceIcon = function BackspaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10511, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
