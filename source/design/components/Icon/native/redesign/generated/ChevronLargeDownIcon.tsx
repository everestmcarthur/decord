...
// Dependencies: [19, 21, 576, 4307, 13649, 2]
// Exports: ChevronLargeDownIcon

// Module 13648 (ChevronLargeDownIcon)
...
export const ChevronLargeDownIcon = function ChevronLargeDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13649, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
