...
// Function ID: 5275
// Name: AppsLockIcon
// Dependencies: [19, 21, 576, 4422, 5238, 2]
// Exports: AppsLockIcon

// Module 5274 (AppsLockIcon)
...
export const AppsLockIcon = function AppsLockIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5238, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
