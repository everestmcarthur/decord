...
// Function ID: 10452
// Name: GifIcon
// Dependencies: [19, 21, 576, 4305, 8137, 2]
// Exports: GifIcon

// Module 10451 (GifIcon)
...
export const GifIcon = function GifIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8137, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
