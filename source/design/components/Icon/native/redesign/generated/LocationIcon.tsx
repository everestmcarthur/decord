...
// Function ID: 9867
// Name: LocationIcon
// Dependencies: [19, 21, 576, 4340, 9867, 2]
// Exports: LocationIcon

// Module 9866 (LocationIcon)
...
export const LocationIcon = function LocationIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9867, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
