...
// Dependencies: [19, 21, 576, 4422, 5205, 2]
// Exports: AnnouncementsIcon

// Module 5263 (AnnouncementsIcon)
...
export const AnnouncementsIcon = function AnnouncementsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5205, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
