...
// Dependencies: [19, 21, 576, 4305, 5086, 2]
// Exports: AnnouncementsIcon

// Module 5144 (AnnouncementsIcon)
...
export const AnnouncementsIcon = function AnnouncementsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5086, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
