...
// Function ID: 9005
// Name: RibbonIcon
// Dependencies: [19, 21, 576, 4307, 9005, 2]
// Exports: RibbonIcon

// Module 9004 (RibbonIcon)
...
export const RibbonIcon = function RibbonIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9005, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
