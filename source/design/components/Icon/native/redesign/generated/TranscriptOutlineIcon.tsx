...
// Dependencies: [19, 21, 576, 4340, 15153, 2]
// Exports: TranscriptOutlineIcon

// Module 15152 (TranscriptOutlineIcon)
...
export const TranscriptOutlineIcon = function TranscriptOutlineIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15153, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
