...
// Function ID: 5630
// Name: DragIcon
// Dependencies: [19, 21, 576, 4274, 5630, 2]
// Exports: DragIcon

// Module 5629 (DragIcon)
...
export const DragIcon = function DragIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5630, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
