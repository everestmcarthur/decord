...
// Function ID: 5786
// Name: DragIcon
// Dependencies: [19, 21, 576, 4422, 5786, 2]
// Exports: DragIcon

// Module 5785 (DragIcon)
...
export const DragIcon = function DragIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5786, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
