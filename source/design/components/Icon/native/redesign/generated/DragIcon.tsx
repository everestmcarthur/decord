...
// Function ID: 5666
// Name: DragIcon
// Dependencies: [19, 21, 576, 4305, 5666, 2]
// Exports: DragIcon

// Module 5665 (DragIcon)
...
export const DragIcon = function DragIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5666, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
