...
// Dependencies: [19, 21, 576, 4340, 15848, 2]
// Exports: ArrowSmallUpIcon

// Module 15847 (ArrowSmallUpIcon)
...
export const ArrowSmallUpIcon = function ArrowSmallUpIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15848, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
