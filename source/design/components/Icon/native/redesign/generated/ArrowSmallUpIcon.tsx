...
// Dependencies: [19, 21, 576, 4338, 15866, 2]
// Exports: ArrowSmallUpIcon

// Module 15865 (ArrowSmallUpIcon)
...
export const ArrowSmallUpIcon = function ArrowSmallUpIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15866, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
