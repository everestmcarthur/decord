...
// Dependencies: [19, 21, 576, 4338, 15512, 2]
// Exports: EmojiZanyFaceIcon

// Module 15511 (EmojiZanyFaceIcon)
...
export const EmojiZanyFaceIcon = function EmojiZanyFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15512, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
