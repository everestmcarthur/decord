...
// Dependencies: [19, 21, 576, 4274, 15432, 2]
// Exports: EmojiZanyFaceIcon

// Module 15431 (EmojiZanyFaceIcon)
...
export const EmojiZanyFaceIcon = function EmojiZanyFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15432, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
