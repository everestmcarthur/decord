...
// Dependencies: [19, 21, 576, 4338, 13112, 2]
// Exports: MoreVerticalIcon

// Module 13111 (MoreVerticalIcon)
...
export const MoreVerticalIcon = function MoreVerticalIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13112, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
