...
// Dependencies: [19, 21, 576, 4305, 13038, 2]
// Exports: MoreVerticalIcon

// Module 13037 (MoreVerticalIcon)
...
export const MoreVerticalIcon = function MoreVerticalIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13038, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
