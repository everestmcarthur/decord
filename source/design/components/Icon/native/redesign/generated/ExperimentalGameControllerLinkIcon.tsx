...
// Dependencies: [19, 21, 576, 4338, 8876, 2]
// Exports: ExperimentalGameControllerLinkIcon

// Module 8875 (ExperimentalGameControllerLinkIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4338 */;
import _mod8876 from "module_8876" /* 8876 */;
...
export const ExperimentalGameControllerLinkIcon = function ExperimentalGameControllerLinkIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8876, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
