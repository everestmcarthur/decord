...
// Dependencies: [19, 21, 576, 4422, 5232, 2]
// Exports: TextControllerIcon

// Module 5248 (TextControllerIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4422 */;
import _mod5232 from "module_5232" /* 5232 */;
...
export const TextControllerIcon = function TextControllerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5232, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
