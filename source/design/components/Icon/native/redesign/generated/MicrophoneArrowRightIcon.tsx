...
// Dependencies: [19, 21, 576, 4340, 10071, 2]
// Exports: MicrophoneArrowRightIcon

// Module 10070 (MicrophoneArrowRightIcon)
...
export const MicrophoneArrowRightIcon = function MicrophoneArrowRightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10071, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
