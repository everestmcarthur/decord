...
// Dependencies: [19, 21, 576, 4305, 8771, 2]
// Exports: BattlenetNeutralIcon

// Module 8770 (BattlenetNeutralIcon)
...
export const BattlenetNeutralIcon = function BattlenetNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8771, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
