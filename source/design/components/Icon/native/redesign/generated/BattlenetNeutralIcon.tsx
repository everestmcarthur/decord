...
// Dependencies: [19, 21, 576, 4340, 8827, 2]
// Exports: BattlenetNeutralIcon

// Module 8826 (BattlenetNeutralIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4340 */;
import _mod8827 from "module_8827" /* 8827 */;
...
export const BattlenetNeutralIcon = function BattlenetNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8827, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
