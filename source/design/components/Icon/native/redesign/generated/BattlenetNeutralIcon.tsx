...
// Dependencies: [19, 21, 576, 4338, 8836, 2]
// Exports: BattlenetNeutralIcon

// Module 8835 (BattlenetNeutralIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4338 */;
import _mod8836 from "module_8836" /* 8836 */;
...
export const BattlenetNeutralIcon = function BattlenetNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8836, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
