...
// Function ID: 10973
// Name: ClydeIcon
// Dependencies: [19, 21, 576, 4340, 10973, 2]
// Exports: ClydeIcon

// Module 10972 (ClydeIcon)
...
export const ClydeIcon = function ClydeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10973, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
