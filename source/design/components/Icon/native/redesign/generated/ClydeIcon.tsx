...
// Function ID: 10947
// Name: ClydeIcon
// Dependencies: [19, 21, 576, 4337, 10947, 2]
// Exports: ClydeIcon

// Module 10946 (ClydeIcon)
...
export const ClydeIcon = function ClydeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10947, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
