...
// Function ID: 10965
// Name: ClydeIcon
// Dependencies: [19, 21, 576, 4338, 10965, 2]
// Exports: ClydeIcon

// Module 10964 (ClydeIcon)
...
export const ClydeIcon = function ClydeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10965, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
