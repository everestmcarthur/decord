...
// Function ID: 10908
// Name: ClydeIcon
// Dependencies: [19, 21, 576, 4307, 10908, 2]
// Exports: ClydeIcon

// Module 10907 (ClydeIcon)
...
export const ClydeIcon = function ClydeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10908, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
