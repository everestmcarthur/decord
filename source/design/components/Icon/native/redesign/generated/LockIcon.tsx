...
// Function ID: 5110
// Name: LockIcon
// Dependencies: [19, 21, 576, 4274, 5082, 2]
// Exports: LockIcon

// Module 5109 (LockIcon)
...
export const LockIcon = function LockIcon(WHITE) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5082, color: INTERACTIVE_ICON_DEFAULT, style: WHITE.style });
};
