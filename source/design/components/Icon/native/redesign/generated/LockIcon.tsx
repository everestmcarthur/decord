...
// Function ID: 5180
// Name: LockIcon
// Dependencies: [19, 21, 576, 4340, 5152, 2]
// Exports: LockIcon

// Module 5179 (LockIcon)
...
export const LockIcon = function LockIcon(WHITE) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5152, color: INTERACTIVE_ICON_DEFAULT, style: WHITE.style });
};
