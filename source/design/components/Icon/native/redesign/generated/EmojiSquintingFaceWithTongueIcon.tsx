...
// Dependencies: [19, 21, 576, 4422, 15606, 2]
// Exports: EmojiSquintingFaceWithTongueIcon

// Module 15605 (EmojiSquintingFaceWithTongueIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4422 */;
import _mod15606 from "module_15606" /* 15606 */;
...
export const EmojiSquintingFaceWithTongueIcon = function EmojiSquintingFaceWithTongueIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15606, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
