...
// Dependencies: [19, 21, 576, 4338, 15506, 2]
// Exports: EmojiSquintingFaceWithTongueIcon

// Module 15505 (EmojiSquintingFaceWithTongueIcon)
...
export const EmojiSquintingFaceWithTongueIcon = function EmojiSquintingFaceWithTongueIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15506, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
