...
// Dependencies: [19, 21, 576, 4340, 15511, 2]
// Exports: EmojiSquintingFaceWithTongueIcon

// Module 15510 (EmojiSquintingFaceWithTongueIcon)
...
export const EmojiSquintingFaceWithTongueIcon = function EmojiSquintingFaceWithTongueIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15511, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
