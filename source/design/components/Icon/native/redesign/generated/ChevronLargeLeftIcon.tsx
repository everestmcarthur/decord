...
// Dependencies: [19, 21, 576, 4307, 10465, 2]
// Exports: ChevronLargeLeftIcon

// Module 10464 (ChevronLargeLeftIcon)
...
export const ChevronLargeLeftIcon = function ChevronLargeLeftIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10465, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
