...
// Dependencies: [19, 21, 576, 4307, 10467, 2]
// Exports: ChevronLargeLeftIcon

// Module 10466 (ChevronLargeLeftIcon)
...
export const ChevronLargeLeftIcon = function ChevronLargeLeftIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10467, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
