...
// Dependencies: [19, 21, 576, 4337, 10504, 2]
// Exports: ChevronLargeLeftIcon

// Module 10503 (ChevronLargeLeftIcon)
...
export const ChevronLargeLeftIcon = function ChevronLargeLeftIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10504, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
