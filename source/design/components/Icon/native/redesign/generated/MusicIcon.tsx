...
// Function ID: 9982
// Name: MusicIcon
// Dependencies: [19, 21, 576, 4305, 9982, 2]
// Exports: MusicIcon

// Module 9981 (MusicIcon)
...
export const MusicIcon = function MusicIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9982, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
