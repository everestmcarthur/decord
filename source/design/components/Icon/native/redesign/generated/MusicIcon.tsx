...
// Function ID: 10005
// Name: MusicIcon
// Dependencies: [19, 21, 576, 4307, 10005, 2]
// Exports: MusicIcon

// Module 10004 (MusicIcon)
...
export const MusicIcon = function MusicIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10005, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
