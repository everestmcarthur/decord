...
// Function ID: 12905
// Name: PlusMediumIcon
// Dependencies: [19, 21, 576, 4340, 12350, 2]
// Exports: PlusMediumIcon

// Module 12904 (PlusMediumIcon)
...
export const PlusMediumIcon = function PlusMediumIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12350, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
