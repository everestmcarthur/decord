...
// Function ID: 15615
// Name: HashmarkIcon
// Dependencies: [19, 21, 576, 4274, 15615, 2]
// Exports: HashmarkIcon

// Module 15614 (HashmarkIcon)
...
export const HashmarkIcon = function HashmarkIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15615, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
