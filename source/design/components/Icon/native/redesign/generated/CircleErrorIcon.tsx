...
// Dependencies: [19, 17, 21, 576, 4274, 6625, 6626, 2]
// Exports: CircleErrorIcon

// Module 6624 (CircleErrorIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4274 */;
import _mod6625 from "module_6625" /* 6625 */;
import _mod6626 from "module_6626" /* 6626 */;
...
export const CircleErrorIcon = function CircleErrorIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6625, color: secondaryColor, style }), ];
  const obj3 = { source: _mod6626, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
