...
// Dependencies: [19, 17, 21, 576, 4307, 6682, 6683, 2]
// Exports: CircleErrorIcon

// Module 6681 (CircleErrorIcon)
...
export const CircleErrorIcon = function CircleErrorIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6682, color: secondaryColor, style }), ];
  const obj3 = { source: _mod6683, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
