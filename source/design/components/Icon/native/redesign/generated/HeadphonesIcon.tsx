...
// Function ID: 12626
// Name: HeadphonesIcon
// Dependencies: [19, 21, 576, 4307, 12626, 2]
// Exports: HeadphonesIcon

// Module 12625 (HeadphonesIcon)
...
export const HeadphonesIcon = function HeadphonesIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12626, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
