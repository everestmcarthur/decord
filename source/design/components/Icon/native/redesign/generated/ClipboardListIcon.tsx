...
// Dependencies: [19, 21, 576, 4307, 5590, 2]
// Exports: ClipboardListIcon

// Module 5589 (ClipboardListIcon)
...
export const ClipboardListIcon = function ClipboardListIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5590, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
