...
// Dependencies: [19, 21, 576, 4307, 8786, 2]
// Exports: SteamNeutralIcon

// Module 8785 (SteamNeutralIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4307 */;
import _mod8786 from "module_8786" /* 8786 */;
...
export const SteamNeutralIcon = function SteamNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8786, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
