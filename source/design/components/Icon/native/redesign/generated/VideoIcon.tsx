...
// Function ID: 10354
// Name: VideoIcon
// Dependencies: [19, 21, 576, 4422, 10354, 2]
// Exports: VideoIcon

// Module 10353 (VideoIcon)
...
export const VideoIcon = function VideoIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10354, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
