...
// Function ID: 10183
// Name: AttachmentIcon
// Dependencies: [19, 21, 576, 4305, 10183, 2]
// Exports: AttachmentIcon

// Module 10182 (AttachmentIcon)
...
export const AttachmentIcon = function AttachmentIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10183, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
