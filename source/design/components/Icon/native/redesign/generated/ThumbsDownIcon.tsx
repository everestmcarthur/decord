...
// Function ID: 8051
// Name: ThumbsDownIcon
// Dependencies: [19, 21, 576, 4340, 8051, 2]
// Exports: ThumbsDownIcon

// Module 8050 (ThumbsDownIcon)
...
export const ThumbsDownIcon = function ThumbsDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8051, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
