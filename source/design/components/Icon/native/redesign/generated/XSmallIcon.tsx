...
// Function ID: 5769
// Name: XSmallIcon
// Dependencies: [19, 21, 576, 4340, 5769, 2]
// Exports: XSmallIcon

// Module 5768 (XSmallIcon)
...
export const XSmallIcon = function XSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5769, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
