...
// Function ID: 5767
// Name: XSmallIcon
// Dependencies: [19, 21, 576, 4338, 5767, 2]
// Exports: XSmallIcon

// Module 5766 (XSmallIcon)
...
export const XSmallIcon = function XSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5767, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
