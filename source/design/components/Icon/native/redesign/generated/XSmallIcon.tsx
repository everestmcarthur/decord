...
// Function ID: 5732
// Name: XSmallIcon
// Dependencies: [19, 21, 576, 4307, 5732, 2]
// Exports: XSmallIcon

// Module 5731 (XSmallIcon)
...
export const XSmallIcon = function XSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5732, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
