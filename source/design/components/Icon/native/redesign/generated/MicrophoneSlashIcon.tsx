...
// Dependencies: [19, 21, 576, 4340, 9282, 2]
// Exports: MicrophoneSlashIcon

// Module 9281 (MicrophoneSlashIcon)
...
export const MicrophoneSlashIcon = function MicrophoneSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9282, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
