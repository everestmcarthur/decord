...
// Dependencies: [19, 21, 576, 4338, 8260, 2]
// Exports: UnknownGameIcon

// Module 8698 (UnknownGameIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4338 */;
import _mod8260 from "module_8260" /* 8260 */;
...
export const UnknownGameIcon = function UnknownGameIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8260, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
