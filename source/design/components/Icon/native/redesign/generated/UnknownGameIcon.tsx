...
// Dependencies: [19, 21, 576, 4340, 8279, 2]
// Exports: UnknownGameIcon

// Module 8718 (UnknownGameIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4340 */;
import _mod8279 from "module_8279" /* 8279 */;
...
export const UnknownGameIcon = function UnknownGameIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8279, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
