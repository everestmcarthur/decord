...
// Dependencies: [19, 21, 576, 4307, 8217, 2]
// Exports: UnknownGameIcon

// Module 8656 (UnknownGameIcon)
...
export const UnknownGameIcon = function UnknownGameIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8217, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
