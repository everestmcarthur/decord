...
// Dependencies: [19, 21, 576, 4307, 10053, 2]
// Exports: SpeedometerIcon

// Module 10052 (SpeedometerIcon)
...
export const SpeedometerIcon = function SpeedometerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10053, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
