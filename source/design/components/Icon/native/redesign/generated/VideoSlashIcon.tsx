...
// Function ID: 13183
// Name: VideoSlashIcon
// Dependencies: [19, 21, 576, 4340, 13183, 2]
// Exports: VideoSlashIcon

// Module 13182 (VideoSlashIcon)
...
export const VideoSlashIcon = function VideoSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13183, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
