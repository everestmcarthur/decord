...
// Function ID: 13142
// Name: VideoSlashIcon
// Dependencies: [19, 21, 576, 4307, 13142, 2]
// Exports: VideoSlashIcon

// Module 13141 (VideoSlashIcon)
...
export const VideoSlashIcon = function VideoSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13142, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
