...
// Function ID: 13202
// Name: VideoSlashIcon
// Dependencies: [19, 21, 576, 4340, 13202, 2]
// Exports: VideoSlashIcon

// Module 13201 (VideoSlashIcon)
...
export const VideoSlashIcon = function VideoSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13202, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
