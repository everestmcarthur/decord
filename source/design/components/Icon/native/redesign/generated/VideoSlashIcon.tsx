...
// Function ID: 13194
// Name: VideoSlashIcon
// Dependencies: [19, 21, 576, 4338, 13194, 2]
// Exports: VideoSlashIcon

// Module 13193 (VideoSlashIcon)
...
export const VideoSlashIcon = function VideoSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13194, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
