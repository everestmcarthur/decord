...
// Dependencies: [19, 17, 21, 576, 4305, 4566, 4567, 2]
// Exports: CircleCheckIcon

// Module 4565 (CircleCheckIcon)
...
export const CircleCheckIcon = function CircleCheckIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod4566, color: secondaryColor, style }), ];
  const obj3 = { source: _mod4567, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
