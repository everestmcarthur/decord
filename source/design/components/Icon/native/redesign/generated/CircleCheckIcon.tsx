...
// Dependencies: [19, 17, 21, 576, 4307, 4568, 4569, 2]
// Exports: CircleCheckIcon

// Module 4567 (CircleCheckIcon)
...
export const CircleCheckIcon = function CircleCheckIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod4568, color: secondaryColor, style }), ];
  const obj3 = { source: _mod4569, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
