...
// Dependencies: [19, 17, 21, 576, 4422, 4682, 4683, 2]
// Exports: CircleCheckIcon

// Module 4681 (CircleCheckIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4422 */;
import _mod4682 from "module_4682" /* 4682 */;
import _mod4683 from "module_4683" /* 4683 */;
...
export const CircleCheckIcon = function CircleCheckIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod4682, color: secondaryColor, style }), ];
  const obj3 = { source: _mod4683, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
