...
// Dependencies: [19, 21, 576, 4340, 11380, 2]
// Exports: SpoilerIcon

// Module 11379 (generated/SpoilerIcon)
...
export const SpoilerIcon = function SpoilerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11380, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
