...
// Dependencies: [19, 21, 576, 4338, 5136, 2]
// Exports: ForumSpoilerIcon

// Module 5168 (ForumSpoilerIcon)
...
export const ForumSpoilerIcon = function ForumSpoilerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5136, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
