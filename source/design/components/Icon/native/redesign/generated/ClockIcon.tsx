...
// Function ID: 4601
// Name: ClockIcon
// Dependencies: [19, 21, 576, 4338, 4601, 2]
// Exports: ClockIcon

// Module 4600 (ClockIcon)
...
export const ClockIcon = function ClockIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4601, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
