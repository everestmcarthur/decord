...
// Dependencies: [19, 21, 576, 4274, 8916, 2]
// Exports: NintendoSwitchNeutralIcon

// Module 8915 (NintendoSwitchNeutralIcon)
...
export const NintendoSwitchNeutralIcon = function NintendoSwitchNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8916, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
