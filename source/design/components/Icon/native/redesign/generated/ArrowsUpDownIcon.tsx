...
// Dependencies: [19, 21, 576, 4340, 12303, 2]
// Exports: ArrowsUpDownIcon

// Module 12302 (ArrowsUpDownIcon)
...
export const ArrowsUpDownIcon = function ArrowsUpDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12303, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
