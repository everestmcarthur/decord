...
export const EpicGamesNeutralIcon = function EpicGamesNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8823, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
