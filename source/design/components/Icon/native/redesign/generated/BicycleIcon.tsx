...
// Function ID: 10487
// Name: BicycleIcon
// Dependencies: [19, 21, 576, 4340, 10487, 2]
// Exports: BicycleIcon

// Module 10486 (BicycleIcon)
...
export const BicycleIcon = function BicycleIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10487, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
