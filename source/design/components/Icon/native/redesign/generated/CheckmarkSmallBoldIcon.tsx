...
// Dependencies: [19, 21, 576, 4340, 5703, 2]
// Exports: CheckmarkSmallBoldIcon

// Module 9571 (CheckmarkSmallBoldIcon)
...
export const CheckmarkSmallBoldIcon = function CheckmarkSmallBoldIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5703, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
