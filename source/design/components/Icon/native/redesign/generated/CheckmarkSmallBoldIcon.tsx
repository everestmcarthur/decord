...
// Dependencies: [19, 21, 576, 4338, 5704, 2]
// Exports: CheckmarkSmallBoldIcon

// Module 9582 (CheckmarkSmallBoldIcon)
...
export const CheckmarkSmallBoldIcon = function CheckmarkSmallBoldIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5704, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
