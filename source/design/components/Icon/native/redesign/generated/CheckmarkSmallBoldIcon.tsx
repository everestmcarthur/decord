...
// Dependencies: [19, 21, 576, 4340, 5706, 2]
// Exports: CheckmarkSmallBoldIcon

// Module 9593 (CheckmarkSmallBoldIcon)
...
export const CheckmarkSmallBoldIcon = function CheckmarkSmallBoldIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5706, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
