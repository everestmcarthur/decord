...
// Function ID: 9877
// Name: CalendarIcon
// Dependencies: [19, 21, 576, 4307, 9877, 2]
// Exports: CalendarIcon

// Module 9876 (CalendarIcon)
...
export const CalendarIcon = function CalendarIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9877, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
