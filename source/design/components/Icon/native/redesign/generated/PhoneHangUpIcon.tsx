...
// Dependencies: [19, 21, 576, 4340, 7990, 2]
// Exports: PhoneHangUpIcon

// Module 7989 (PhoneHangUpIcon)
...
export const PhoneHangUpIcon = function PhoneHangUpIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7990, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
