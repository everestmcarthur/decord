...
// Dependencies: [19, 21, 576, 4307, 7958, 2]
// Exports: PhoneHangUpIcon

// Module 7957 (PhoneHangUpIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4307 */;
import _mod7958 from "module_7958" /* 7958 */;
...
export const PhoneHangUpIcon = function PhoneHangUpIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7958, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
