...
// Dependencies: [19, 21, 576, 4274, 8612, 2]
// Exports: LinkExternalSmallIcon

// Module 8611 (LinkExternalSmallIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4274 */;
import _mod8612 from "module_8612" /* 8612 */;
...
export const LinkExternalSmallIcon = function LinkExternalSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8612, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
