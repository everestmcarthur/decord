...
export const LinkExternalSmallIcon = function LinkExternalSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8670, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
