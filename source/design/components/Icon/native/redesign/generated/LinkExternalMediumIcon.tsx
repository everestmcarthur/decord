...
// Dependencies: [19, 21, 576, 4307, 9169, 2]
// Exports: LinkExternalMediumIcon

// Module 9168 (LinkExternalMediumIcon)
...
export const LinkExternalMediumIcon = function LinkExternalMediumIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9169, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
