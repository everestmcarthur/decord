...
// Function ID: 15712
// Name: CompassIcon
// Dependencies: [19, 21, 576, 4338, 15712, 2]
// Exports: CompassIcon

// Module 15711 (CompassIcon)
...
export const CompassIcon = function CompassIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15712, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
