...
// Dependencies: [19, 21, 576, 4274, 12387, 2]
// Exports: TwitterNeutralIcon

// Module 12386 (TwitterNeutralIcon)
...
export const TwitterNeutralIcon = function TwitterNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12387, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
