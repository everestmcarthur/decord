...
// Dependencies: [19, 21, 576, 4422, 12600, 2]
// Exports: TwitterNeutralIcon

// Module 12599 (TwitterNeutralIcon)
...
export const TwitterNeutralIcon = function TwitterNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12600, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
