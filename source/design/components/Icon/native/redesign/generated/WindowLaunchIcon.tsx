...
// Dependencies: [19, 21, 576, 4340, 13093, 2]
// Exports: WindowLaunchIcon

// Module 13092 (WindowLaunchIcon)
...
export const WindowLaunchIcon = function WindowLaunchIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13093, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
