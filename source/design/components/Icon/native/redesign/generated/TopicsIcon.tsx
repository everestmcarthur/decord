...
// Function ID: 11894
// Name: TopicsIcon
// Dependencies: [19, 21, 576, 4422, 11894, 2]
// Exports: TopicsIcon

// Module 11893 (TopicsIcon)
...
export const TopicsIcon = function TopicsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11894, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
