...
// Dependencies: [19, 21, 576, 4422, 10490, 2]
// Exports: LockUnlockedIcon

// Module 10489 (LockUnlockedIcon)
...
export const LockUnlockedIcon = function LockUnlockedIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10490, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
