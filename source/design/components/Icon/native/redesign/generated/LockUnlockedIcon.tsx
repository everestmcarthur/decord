...
// Dependencies: [19, 21, 576, 4340, 10396, 2]
// Exports: LockUnlockedIcon

// Module 10395 (LockUnlockedIcon)
...
export const LockUnlockedIcon = function LockUnlockedIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10396, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
