...
// Dependencies: [19, 21, 576, 4422, 5233, 2]
// Exports: ExperimentalLfgLockIcon

// Module 5253 (ExperimentalLfgLockIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4422 */;
import _mod5233 from "module_5233" /* 5233 */;
...
export const ExperimentalLfgLockIcon = function ExperimentalLfgLockIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5233, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
