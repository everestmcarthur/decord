...
// Function ID: 15419
// Name: ChatDotsIcon
// Dependencies: [19, 21, 576, 4307, 15419, 2]
// Exports: ChatDotsIcon

// Module 15418 (ChatDotsIcon)
...
export const ChatDotsIcon = function ChatDotsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15419, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
