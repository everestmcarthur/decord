...
// Dependencies: [19, 21, 576, 4338, 4577, 2]
// Exports: UserPlatformIcon

// Module 4576 (UserPlatformIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4338 */;
import _mod4577 from "module_4577" /* 4577 */;
...
export const UserPlatformIcon = function UserPlatformIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4577, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
