...
// Function ID: 7167
// Name: ListViewIcon
// Dependencies: [19, 21, 576, 4307, 7167, 2]
// Exports: ListViewIcon

// Module 7166 (ListViewIcon)
...
export const ListViewIcon = function ListViewIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7167, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
