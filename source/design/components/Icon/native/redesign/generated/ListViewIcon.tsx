...
// Function ID: 7201
// Name: ListViewIcon
// Dependencies: [19, 21, 576, 4340, 7201, 2]
// Exports: ListViewIcon

// Module 7200 (ListViewIcon)
...
export const ListViewIcon = function ListViewIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7201, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
