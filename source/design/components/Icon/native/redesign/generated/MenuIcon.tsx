...
// Function ID: 15921
// Name: MenuIcon
// Dependencies: [19, 21, 576, 4305, 15921, 2]
// Exports: MenuIcon

// Module 15920 (MenuIcon)
...
export const MenuIcon = function MenuIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15921, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
