...
// Function ID: 4306
// Name: BaseIconImage
// Dependencies: [19, 17, 21, 4306, 2]
// Exports: BaseIconImage

// Module 4305 (BaseIconImage)
...
const jsx = fn(21).jsx;
let closure_4 = { xxs: { width: 12, height: 12 }, xs: { width: 16, height: 16 }, sm: { width: 18, height: 18 }, md: { width: 24, height: 24 }, lg: { width: 32, height: 32 }, custom: { width: "call", height: "accessibilityLabel" }, refresh_sm: { width: 18, height: 18 } };
const size = fn(2);
