...
// Function ID: 4308
// Name: BaseIconImage
// Dependencies: [19, 17, 21, 4308, 2]
// Exports: BaseIconImage

// Module 4307 (BaseIconImage)
...
const jsx = fn(21).jsx;
let closure_4 = { xxs: { width: 12, height: 12 }, xs: { width: 16, height: 16 }, sm: { width: 18, height: 18 }, md: { width: 24, height: 24 }, lg: { width: 32, height: 32 }, custom: { width: "guild", height: "call" }, refresh_sm: { width: 18, height: 18 } };
const size = fn(2);
