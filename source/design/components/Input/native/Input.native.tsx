...
// Function ID: 6719
// Name: Input
// Dependencies: [19, 17, 21, 4640, 576, 6719, 4343, 4636, 6720, 2]
// Exports: Input
...
export const Input = function Input(arg0) {
  ...
  if (null == label) {
    ...
    if (null != description) {
      ...
      tmp11Result = tmp11(tmp2(4636).Text, obj5);
    }
    items[2] = tmp11Result;
    let tmp11Result2 = null;
    if (null != errorMessage) {
      const obj6 = { style: tmp.error, children: errorMessage };
      tmp11Result2 = tmp11(tmp2(6720).ErrorText, obj6);
    }
    ...
    const items1 = [React3(tmp2(4636).Text, obj8), labelTrailing];
    ...
    if (required) {
      ...
      tmp5Result2 = tmp5(tmp2(4636).Text, obj10);
    }
    items2[1] = tmp5Result2;
    obj9.children = items2;
    tmp5Result = tmp5(tmp2(4636).Text, obj9);
  }
};
