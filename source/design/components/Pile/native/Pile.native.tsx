...
// Function ID: 11073
// Name: Pile
// Dependencies: [19, 17, 21, 4605, 1369, 12, 8884, 11073, 2]
// Exports: Pile
  ...
  obj2.children = Children1.map(children, (type, arg1) => {
    if (noop.isValidElement(type)) {
      ...
      if (arg1 < length - 1) {
        ...
        if (tmp3(8884).CutoutShape.Circle === closure_1_0) {
          ...
          point.size = sum;
        } else if (tmp3(8884).CutoutShape.RoundedRect === tmp10) {
          ...
          tmp3(1369).assertNever(tmp10);
          const tmp3Result3 = tmp3(1369);
        }
        tmp3Result = tmp3(12);
      }
      let num6 = 0;
