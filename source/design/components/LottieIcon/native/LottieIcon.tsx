...
// Function ID: 10089
// Name: LottieIcon
// Dependencies: [19, 17, 21, 576, 6728, 4358, 4339, 5616, 2]

// Module 10088 (LottieIcon)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4339 */;
import _modDef5616 from "module_5616" /* 5616 */;
...
export const LottieIcon = noop.forwardRef((color, ref) => {
  ...
  enabled = noop.useContext(tmp3(4358).AccessibilityPreferencesContext).reducedMotion.enabled;
  let tmp12 = tmp5;
  if ("custom" === size) {
    tmp12 = width;
  }
  ...
  obj3.style = items4;
  obj2.children = jsx(_modDef5616, { ref, source: color.dotLottie, colorFilters: null, hardwareAccelerationAndroid: true, loop: false, onAnimationLoaded: null, resizeMode: "cover", style: null });
