...
// Function ID: 7139
// Name: TextAreaField
// Dependencies: [19, 17, 21, 4605, 576, 6671, 6664, 4308, 7139, 1114, 6674, 4601, 2]

// Module 7138 (TextAreaField)
...
const Text_Text = prop(4601);
const NativeTextInput = prop(6674);
const useCharacterLimitAnnouncement = prop(7139);
require = fn;
