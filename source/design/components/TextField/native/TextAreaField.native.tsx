...
// Function ID: 7161
// Name: TextAreaField
// Dependencies: [19, 17, 21, 4607, 576, 6693, 6686, 4310, 7161, 1114, 6696, 4603, 2]

// Module 7160 (TextAreaField)
...
const Text_Text = prop(4603);
const NativeTextInput = prop(6696);
const useCharacterLimitAnnouncement = prop(7161);
require = fn;
