...
// Function ID: 6696
// Name: BaseTextField
// Dependencies: [19, 21, 1115, 6693, 4314, 6696, 4313, 2]

// Module 6695 (BaseTextField)
...
import NativeTextInput from "NativeTextInput" /* 6696 */;
...
export const BaseTextField = noop.forwardRef((size, ref2) => {
  ...
  if (size.enableAndroidSanitizedInputWorkaround) {
    ...
    obj5.secureTextEntry = tmp(1115).isAndroid() || secureTextEntry;
    const tmp7 = tmp(1115).isAndroid() || secureTextEntry;
