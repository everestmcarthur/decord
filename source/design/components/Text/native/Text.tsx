...
import PlainTextEligibility from "PlainTextEligibility" /* 4645 */;
import _modDef4646 from "module_4646" /* 4646 */;
...
const useManaTextMigrationHighlight = fn(4634);
