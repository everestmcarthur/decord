...
// Dependencies: [32, 19, 17, 4328, 1074, 21, 8908, 1249, 4605, 5055, 7262, 5041, 504, 12566, 4989, 2]
// Exports: ActionSheetPresenter

// Module 14248 (ActionSheetPresenter)
...
let closure_9 = noop.forwardRef((sheetKey, ref) => {
  ...
  return jsx(transitionState(7262).Provider, { value: memo, children: jsx(sheetKey(5041).Dialog, { dialogKey: sheetKey, onDismiss: callback2, zIndex, children: content }) });
});
const size = fn(2);
...
export const ActionSheetPresenter = function ActionSheetPresenter(appEntryKey) {
  ...
  return jsx(appEntryKey(12566).TransitionGroup, { style: StyleSheet.absoluteFill, component: appEntryKey(4989).TransitionGroupOverlayView, children: mapped });
};
