...
// Dependencies: [32, 19, 17, 4330, 1074, 21, 8897, 1249, 4606, 5056, 7259, 5042, 504, 12558, 4990, 2]
// Exports: ActionSheetPresenter

// Module 14230 (ActionSheetPresenter)
...
let closure_9 = noop.forwardRef((sheetKey, ref) => {
  ...
  return jsx(transitionState(7259).Provider, { value: memo, children: jsx(sheetKey(5042).Dialog, { dialogKey: sheetKey, onDismiss: callback2, zIndex, children: content }) });
});
const size = fn(2);
...
export const ActionSheetPresenter = function ActionSheetPresenter(appEntryKey) {
  ...
  return jsx(appEntryKey(12558).TransitionGroup, { style: StyleSheet.absoluteFill, component: appEntryKey(4990).TransitionGroupOverlayView, children: mapped });
};
