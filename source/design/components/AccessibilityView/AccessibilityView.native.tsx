...
// Dependencies: [19, 17, 21, 4974, 4310, 2]

// Module 4973 (AccessibilityView)
import useAccessibilityViewIsModalToggleDefault from "useAccessibilityViewIsModalToggle" /* 4974 */;
