...
// Dependencies: [19, 17, 21, 5010, 4341, 2]

// Module 5009 (AccessibilityView)
import useAccessibilityViewIsModalToggleDefault from "useAccessibilityViewIsModalToggle" /* 5010 */;
