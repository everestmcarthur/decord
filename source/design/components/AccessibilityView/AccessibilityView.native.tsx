...
// Dependencies: [19, 17, 21, 5127, 4458, 2]

// Module 5126 (AccessibilityView)
import useAccessibilityViewIsModalToggleDefault from "useAccessibilityViewIsModalToggle" /* 5127 */;
