...
// Dependencies: [19, 17, 21, 5043, 4374, 2]

// Module 5042 (AccessibilityView)
import useAccessibilityViewIsModalToggleDefault from "useAccessibilityViewIsModalToggle" /* 5043 */;
