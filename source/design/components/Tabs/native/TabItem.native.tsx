...
// Function ID: 12858
// Name: TabItem
// Dependencies: [19, 17, 21, 4458, 4722, 576, 5143, 4718, 1364, 1115, 2]
// Exports: TabItem

// Module 12857 (TabItem)
...
function TabItemCount(arg0) {
  ...
  T.__closure = { withSpring: sharedValue(5143).withSpring, countAnimationState: sharedValue, COUNT_SPRING_CONFIG, interpolate: sharedValue(4458).interpolate };
  ...
  closure_129_3 = tmp7;
  let obj3 = { withSpring: sharedValue(5143).withSpring, countAnimationState: sharedValue, COUNT_SPRING_CONFIG, interpolate: sharedValue(4458).interpolate };
  const fn = function c() {
  ...
  const tmp2Result = sharedValue(4458);
  fn.__closure = { colors: tmp7, pressed, index, activeIndex, withSpring: sharedValue(5143).withSpring, TEXT_SPRING_CONFIG };
  fn.__workletHash = 11643476765161;
  fn.__initData = __initData;
  const animatedStyle1 = tmp2Result.useAnimatedStyle(fn);
  const obj5 = { style: null, children: closure_4(sharedValue(4718).Text, { animated: true, variant: "text-sm/medium", style: animatedStyle1, lineClamp: 1, children: count }) };
