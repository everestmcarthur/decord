...
// Function ID: 12759
// Name: TabItem
// Dependencies: [19, 17, 21, 4374, 4638, 576, 5059, 4634, 1364, 1115, 2]
// Exports: TabItem

// Module 12758 (TabItem)
...
function TabItemCount(arg0) {
  ...
  let obj2 = sharedValue(4374);
  T.__closure = { withSpring: sharedValue(5059).withSpring, countAnimationState: sharedValue, COUNT_SPRING_CONFIG, interpolate: sharedValue(4374).interpolate };
  ...
  closure_129_3 = tmp7;
  let obj3 = { withSpring: sharedValue(5059).withSpring, countAnimationState: sharedValue, COUNT_SPRING_CONFIG, interpolate: sharedValue(4374).interpolate };
  const fn = function c() {
  ...
  const tmp2Result = sharedValue(4374);
  fn.__closure = { colors: tmp7, pressed, index, activeIndex, withSpring: sharedValue(5059).withSpring, TEXT_SPRING_CONFIG };
  fn.__workletHash = 11643476765161;
  fn.__initData = __initData;
  const animatedStyle1 = tmp2Result.useAnimatedStyle(fn);
  const obj5 = { style: null, children: closure_4(sharedValue(4634).Text, { animated: true, variant: "text-sm/medium", style: animatedStyle1, lineClamp: 1, children: count }) };
