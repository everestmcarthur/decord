...
// Function ID: 12767
// Name: TabItem
// Dependencies: [19, 17, 21, 4376, 4640, 576, 5061, 4636, 1364, 1115, 2]
// Exports: TabItem

// Module 12766 (TabItem)
...
function TabItemCount(arg0) {
  ...
  T.__closure = { withSpring: sharedValue(5061).withSpring, countAnimationState: sharedValue, COUNT_SPRING_CONFIG, interpolate: sharedValue(4376).interpolate };
  ...
  closure_129_3 = tmp7;
  let obj3 = { withSpring: sharedValue(5061).withSpring, countAnimationState: sharedValue, COUNT_SPRING_CONFIG, interpolate: sharedValue(4376).interpolate };
  const fn = function c() {
  ...
  const tmp2Result = sharedValue(4376);
  fn.__closure = { colors: tmp7, pressed, index, activeIndex, withSpring: sharedValue(5061).withSpring, TEXT_SPRING_CONFIG };
  fn.__workletHash = 11643476765161;
  fn.__initData = __initData;
  const animatedStyle1 = tmp2Result.useAnimatedStyle(fn);
  const obj5 = { style: null, children: closure_4(sharedValue(4636).Text, { animated: true, variant: "text-sm/medium", style: animatedStyle1, lineClamp: 1, children: count }) };
