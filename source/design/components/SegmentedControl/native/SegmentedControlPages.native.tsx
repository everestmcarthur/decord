...
// Dependencies: [32, 19, 17, 21, 4310, 12647, 1115, 6669, 4985, 4937, 2]
// Exports: SegmentedControlPages

// Module 12646 (SegmentedControlPages)
...
import MathUtils from "MathUtils" /* 12647 */;
  ...
  function te(arg0, width) {
    if (0 !== pageWidth) {
      ...
      if (tmp4) {
        ...
        const tmp13Result = tmp13(4310);
        tmp13(4310).runOnJS(callback1)(obj2.get());
        const runOnJSResult = tmp13(4310).runOnJS(callback1);
      }
    }
  }
  ...
  function re(contentOffset) {
    ...
    if (-1 !== scrollTarget.get()) {
      if (0 === obj2.roundIfClose(contentOffset.x - obj.get(), 0.0001)) {
        ...
        value = obj.get();
        tmp(4310).runOnJS(callback2)(value);
