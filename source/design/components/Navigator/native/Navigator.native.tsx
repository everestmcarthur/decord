...
// Function ID: 7108
// Name: Navigator
// Dependencies: [32, 19, 17, 21, 4639, 576, 7108, 5709, 4341, 7109, 1612, 1115, 12, 7142, 1485, 4574, 7148, 1232, 2]
  ...
  const obj4 = {
    ...
    screenOptions: gestureDirection.useCallback((navigation) => {
      ...
      if (navigatorShouldCrossfade) {
        ...
        fn2 = tmp3(7109).CardStyleInterpolators.forHorizontalIOS;
      }
      obj.cardStyleInterpolator = fn2;
      if (disableHeaderAnimation) {
        let fn3 = tmp3(7109).HeaderStyleInterpolators.forNoAnimation;
      } else if (tmp2) {
        fn3 = tmp3(7109).HeaderStyleInterpolators.forFade;
      } else {
        fn3 = (arg0) => {
