...
// Dependencies: [5, 19, 17, 1074, 21, 4639, 576, 4635, 5710, 5713, 1485, 5715, 1115, 5716, 5765, 1364, 1612, 5767, 2]
...
// Module 5709 (NavigatorHeader)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import Text_Text from "Text/Text" /* 4635 */;
import HeaderDebugOverlayDefault from "HeaderDebugOverlay" /* 5710 */;
...
function CloseButton(onPress) {
  ...
  return closure_6(require("module_5716").HeaderBackButton, obj2);
}
function CustomHeaderBackButton(onPress) {
  onPress = onPress.onPress;
  const merged = Object.assign(onPress, Object.assign({ onPress: 0 }));
  onPress(5715).useNavigatorBackPressHandler(() => {
    if (null != onPress) {
      tmp();
    }
    return null != onPress;
  ...
  return closure_6(onPress(5716).HeaderBackButton, obj2);
}
function HeaderTextButton(text) {
  ...
  return timestampProducer(_mod5716.HeaderBackButton, obj2);
}
...
let obj4 = {};
let merged = Object.assign(fn(4635).TextStyleSheet["redesign/heading-18/bold"]);
