...
// Function ID: 4956
// Name: AlertModal
// Dependencies: [5, 32, 718, 19, 17, 1085, 21, 4605, 576, 4315, 4951, 4341, 1874, 4956, 5008, 1249, 5013, 1114, 4325, 1611, 5021, 1477, 5022, 5023, 4601, 5024, 5025, 2]
// Exports: showConfirmModal, useDismissModalCallback

// Module 4955 (AlertModal)
...
import OverlayViewDefault from "OverlayView" /* 4956 */;
...
function AlertModalBackdrop() {
  ...
  dependencyMap = tmp4;
  const alertStore = context(4951).useAlertStore((arg0) => {
  ...
  let obj2 = context(4341);
  fn.__closure = { withAlertModalSpring, sharedVisible: tmp2[1], sharedTransitionState, TransitionStates: context(4315).TransitionStates, runOnJS: context(4341).runOnJS, cleanUp: context };
  ...
  return closure_10(context(5013).Backdrop, obj4);
}
class AlertModal {
  constructor(arg0) {
...
let obj4 = { withSpring: fn(5024).withSpring, MODAL_SPRING: obj3 };
