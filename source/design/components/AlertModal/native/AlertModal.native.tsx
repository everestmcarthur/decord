...
// Function ID: 4989
// Name: AlertModal
// Dependencies: [5, 32, 718, 19, 17, 1085, 21, 4638, 576, 4348, 4984, 4374, 1875, 4989, 5041, 1248, 5046, 1115, 4358, 1612, 5054, 1478, 5055, 5058, 4634, 5059, 5060, 2]
// Exports: showConfirmModal, useDismissModalCallback

// Module 4988 (AlertModal)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import KeyboardManagerUtils from "KeyboardManagerUtils" /* 1875 */;
import native from "native" /* 4348 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4374 */;
import useAlertStore2 from "useAlertStore" /* 4984 */;
import OverlayViewDefault from "OverlayView" /* 4989 */;
...
function AlertModalBackdrop() {
  ...
  dependencyMap = tmp4;
  const alertStore = context(4984).useAlertStore((arg0) => {
  ...
  let obj2 = context(4374);
  fn.__closure = { withAlertModalSpring, sharedVisible: tmp2[1], sharedTransitionState, TransitionStates: context(4348).TransitionStates, runOnJS: context(4374).runOnJS, cleanUp: context };
  ...
  return closure_10(context(5046).Backdrop, obj4);
}
class AlertModal {
  constructor(arg0) {
...
let context = noop.createContext(fn(4348).TransitionStates.YEETED);
...
let obj4 = { withSpring: fn(5059).withSpring, MODAL_SPRING: obj3 };
