...
// Function ID: 4925
// Name: AlertModal
// Dependencies: [5, 32, 718, 19, 17, 1085, 21, 4574, 576, 4284, 4920, 4310, 1874, 4925, 4972, 1249, 4977, 1114, 4294, 1611, 4985, 1477, 4986, 4987, 4570, 4988, 4989, 2]
// Exports: showConfirmModal, useDismissModalCallback

// Module 4924 (AlertModal)
...
import OverlayViewDefault from "OverlayView" /* 4925 */;
...
function AlertModalBackdrop() {
  ...
  dependencyMap = tmp4;
  const alertStore = context(4920).useAlertStore((arg0) => {
  ...
  let obj2 = context(4310);
  fn.__closure = { withAlertModalSpring, sharedVisible: tmp2[1], sharedTransitionState, TransitionStates: context(4284).TransitionStates, runOnJS: context(4310).runOnJS, cleanUp: context };
  ...
  return closure_10(context(4977).Backdrop, obj4);
}
class AlertModal {
  constructor(arg0) {
...
let obj4 = { withSpring: fn(4988).withSpring, MODAL_SPRING: obj3 };
