...
// Function ID: 4958
// Name: AlertModal
// Dependencies: [5, 32, 718, 19, 17, 1085, 21, 4607, 576, 4317, 4953, 4343, 1874, 4958, 5010, 1249, 5015, 1114, 4327, 1611, 5023, 1477, 5024, 5025, 4603, 5026, 5027, 2]
// Exports: showConfirmModal, useDismissModalCallback

// Module 4957 (AlertModal)
...
import OverlayViewDefault from "OverlayView" /* 4958 */;
...
function AlertModalBackdrop() {
  ...
  dependencyMap = tmp4;
  const alertStore = context(4953).useAlertStore((arg0) => {
  ...
  return closure_10(context(5015).Backdrop, obj4);
}
class AlertModal {
  constructor(arg0) {
...
let obj4 = { withSpring: fn(5026).withSpring, MODAL_SPRING: obj3 };
