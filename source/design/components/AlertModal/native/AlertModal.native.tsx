...
// Function ID: 4991
// Name: AlertModal
// Dependencies: [5, 32, 718, 19, 17, 1085, 21, 4640, 576, 4350, 4986, 4376, 1875, 4991, 5043, 1248, 5048, 1115, 4360, 1612, 5056, 1478, 5057, 5060, 4636, 5061, 5062, 2]
// Exports: showConfirmModal, useDismissModalCallback

// Module 4990 (AlertModal)
...
import OverlayViewDefault from "OverlayView" /* 4991 */;
...
function AlertModalBackdrop() {
  ...
  dependencyMap = tmp4;
  const alertStore = context(4986).useAlertStore((arg0) => {
  ...
  return closure_10(context(5048).Backdrop, obj4);
}
class AlertModal {
  constructor(arg0) {
...
let obj4 = { withSpring: fn(5061).withSpring, MODAL_SPRING: obj3 };
