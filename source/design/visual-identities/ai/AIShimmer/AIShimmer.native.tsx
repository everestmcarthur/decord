...
// Function ID: 14347
// Name: AIShimmer
// Dependencies: [32, 19, 17, 21, 4722, 14347, 4432, 4718, 14348, 4458, 14349, 14350, 14344, 2]

// Module 14346 (AIShimmer)
import ReanimatedRexport from "ReanimatedRexport" /* 4458 */;
import Text_Text from "Text/Text" /* 4718 */;
import AIShimmerTypes from "AIShimmerTypes" /* 14347 */;
import waveTransition2 from "waveTransition" /* 14348 */;
import createWaveTransition from "createWaveTransition" /* 14350 */;
...
function ShimmerLayers(pass) {
  ...
  const obj5 = pass(4458);
  fn.__closure = { animationProgress: animationProgress2, bandEdgesAt: pass(14348).bandEdgesAt, animationWidth: animationWidth2, overshoot: overshoot2, glyphLayerOpacityAt: pass(14348).glyphLayerOpacityAt, easeTail: pass(14348).easeTail };
  ...
  const obj6 = { animationProgress: animationProgress2, bandEdgesAt: pass(14348).bandEdgesAt, animationWidth: animationWidth2, overshoot: overshoot2, glyphLayerOpacityAt: pass(14348).glyphLayerOpacityAt, easeTail: pass(14348).easeTail };
  class T {
    constructor() {
  ...
  const animatedStyle = pass(4458).useAnimatedStyle(T);
  const obj7 = pass(4458);
  ...
  const animatedStyle1 = pass(4458).useAnimatedStyle(fn2);
  const obj8 = pass(4458);
  ...
  const animatedStyle2 = pass(4458).useAnimatedStyle(fn3);
  const obj9 = pass(4458);
  ...
  const animatedStyle3 = pass(4458).useAnimatedStyle(fn4);
