...
// Function ID: 1181
// Name: Button/Button
// Dependencies: [19, 17, 1074, 1181, 21, 4640, 576, 4489, 5529, 1364, 12811, 8767, 4491, 5774, 5062, 2]
...
import StylesheetUtils from "StylesheetUtils" /* 12811 */;
...
obj2.buttonOutlined = { backgroundColor: "transparent", borderWidth: 1, borderStyle: "solid", borderColor: fn(5529).BUTTON_OUTLINED_BORDER };
obj2.buttonXsmall = { minHeight: 24 };
obj2.buttonSmall = { minHeight: 32 };
obj2.buttonMedium = { minHeight: 40 };
obj2.buttonLarge = { minHeight: 46 };
const obj33 = { backgroundColor: "transparent", borderWidth: 1, borderStyle: "solid", borderColor: fn(5529).BUTTON_OUTLINED_BORDER };
...
obj2.textOutlined = { color: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.faded = { opacity: 0.5 };
const obj41 = { color: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
...
obj2.buttonPrimaryDefault = { backgroundColor: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
const obj44 = { backgroundColor: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.buttonPrimaryDarkDefault = { backgroundColor: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
const obj45 = { backgroundColor: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.buttonGreyDefault = { backgroundColor: fn(5529).DARK_PRIMARY_500_LIGHT_PRIMARY_430 };
const obj46 = { backgroundColor: fn(5529).DARK_PRIMARY_500_LIGHT_PRIMARY_430 };
obj2.textPrimary = { color: fn(5529).DARK_PRIMARY_500_LIGHT_PRIMARY_100 };
const obj47 = { color: fn(5529).DARK_PRIMARY_500_LIGHT_PRIMARY_100 };
obj2.textTransparent = { color: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
const obj48 = { color: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.buttonPrimaryDisabled = { backgroundColor: fn(5529).BUTTON_PRIMARY_DISABLED_BACKGROUND };
const obj49 = { backgroundColor: fn(5529).BUTTON_PRIMARY_DISABLED_BACKGROUND };
obj2.buttonPrimaryDarkDisabled = { backgroundColor: fn(5529).BUTTON_PRIMARY_DISABLED_BACKGROUND };
const obj50 = { backgroundColor: fn(5529).BUTTON_PRIMARY_DISABLED_BACKGROUND };
obj2.buttonGreyDisabled = { backgroundColor: fn(5529).BUTTON_GREY_DISABLED_BACKGROUND };
