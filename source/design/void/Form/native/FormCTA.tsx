...
// Function ID: 8686
// Name: FormCTA
// Dependencies: [19, 17, 1085, 21, 4606, 576, 1178, 5668, 7210, 8686, 2]
// Exports: default

// Module 8685 (FormCTA)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1178 */;
import FormCheckbox2 from "FormCheckbox" /* 5668 */;
...
export default function FormCTA(arg0) {
  ...
  if ("row-button" === variant) {
    ...
    if (completed) {
      FormCheckbox = FormCheckbox(5668).FormCheckbox;
      obj7 = { checked: true };
      trailing = tmp16(FormCheckbox, obj7);
    } else if (trailing == null) {
      trailing = tmp16(tmp17(7210).Arrow, {});
    }
