...
// Function ID: 8730
// Name: FormCTA
// Dependencies: [19, 17, 1085, 21, 4638, 576, 1177, 5703, 7247, 8730, 2]
// Exports: default

// Module 8729 (FormCTA)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import FormCheckbox2 from "FormCheckbox" /* 5703 */;
...
export default function FormCTA(arg0) {
  ...
  if ("row-button" === variant) {
    ...
    if (completed) {
      FormCheckbox = FormCheckbox(5703).FormCheckbox;
      obj7 = { checked: true };
      trailing = tmp16(FormCheckbox, obj7);
    } else if (trailing == null) {
      trailing = tmp16(tmp17(7247).Arrow, {});
    }
