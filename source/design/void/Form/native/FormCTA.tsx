...
// Function ID: 8750
// Name: FormCTA
// Dependencies: [19, 17, 1085, 21, 4640, 576, 1177, 5705, 7251, 8750, 2]
// Exports: default

// Module 8749 (FormCTA)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import FormCheckbox2 from "FormCheckbox" /* 5705 */;
...
export default function FormCTA(arg0) {
  ...
  if ("row-button" === variant) {
    ...
    if (completed) {
      FormCheckbox = FormCheckbox(5705).FormCheckbox;
      obj7 = { checked: true };
      trailing = tmp16(FormCheckbox, obj7);
    } else if (trailing == null) {
      trailing = tmp16(tmp17(7251).Arrow, {});
    }
