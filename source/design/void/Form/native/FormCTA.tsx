...
// Function ID: 8688
// Name: FormCTA
// Dependencies: [19, 17, 1085, 21, 4607, 576, 1178, 5669, 7211, 8688, 2]
// Exports: default

// Module 8687 (FormCTA)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1178 */;
import FormCheckbox2 from "FormCheckbox" /* 5669 */;
...
export default function FormCTA(arg0) {
  ...
  if ("row-button" === variant) {
    ...
    if (completed) {
      FormCheckbox = FormCheckbox(5669).FormCheckbox;
      obj7 = { checked: true };
      trailing = tmp16(FormCheckbox, obj7);
    } else if (trailing == null) {
      trailing = tmp16(tmp17(7211).Arrow, {});
    }
