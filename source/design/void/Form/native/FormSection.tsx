...
// Function ID: 8729
// Name: FormSection
// Dependencies: [19, 17, 1181, 21, 4639, 576, 5771, 7244, 8725, 5772, 8729, 1364, 2]
// Exports: default

// Module 8728 (FormSection)
...
import FormTitleDefault from "FormTitle" /* 8729 */;
...
export default function FormSection(arg0) {
  ...
  if (noop.useContext(RedesignCompat.RedesignCompatContext)) {
    ...
    obj4.children = found;
    obj3.children = timestampProducer(tmp3(5772).TableRowGroup, obj4);
