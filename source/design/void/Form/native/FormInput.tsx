...
// Function ID: 8695
// Name: FormInput
// Dependencies: [19, 1074, 21, 4607, 576, 1115, 4317, 4458, 5738, 7159, 6678, 1178, 2]

// Module 8694 (FormInput)
...
const RedesignCompat = TextArea(5738);
const TextInput = TextArea(6678);
const TextArea2 = TextArea(7159);
require = fn;
