...
// Dependencies: [19, 17, 21, 4574, 576, 5137, 1114, 1178, 6954, 38, 2]
...
function ClearButton(onPress) {
  ...
  const tmp = closure_9();
  obj.children = React5(native.Icon, { source: _modDef6954, style: closure_9().closeIcon, size: native.Icon.Sizes.MEDIUM });
