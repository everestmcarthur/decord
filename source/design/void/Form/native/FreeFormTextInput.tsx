...
// Dependencies: [19, 17, 21, 4606, 576, 5174, 1114, 1178, 7011, 38, 2]

// Module 7010 (FreeFormTextInput)
...
function ClearButton(onPress) {
  ...
  const tmp = closure_9();
  obj.children = React5(native.Icon, { source: _modDef7011, style: closure_9().closeIcon, size: native.Icon.Sizes.MEDIUM });
