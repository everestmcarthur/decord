...
// Function ID: 8704
// Name: FormSliderRow
// Dependencies: [19, 17, 21, 4607, 5738, 5659, 4603, 8366, 7211, 2]
// Exports: default

// Module 8703 (FormSliderRow)
...
export default function FormSliderRow(arg0) {
  ...
  if (context) {
    ...
    const items = [hasOwnProperty(tmp2(4603).Text, obj4), trailing];
    obj3.children = items;
    const items1 = [tmp6(View, obj3), ];
    const obj5 = {};
    const merged1 = Object.assign(merged);
    obj5.style = tmp5.slider;
    items1[1] = hasOwnProperty(_modDef8366, obj5);
    obj2.children = items1;
    let tmp6Result = tmp6(tmp2(5659).Card, obj2);
  } else {
    ...
    items2[1] = hasOwnProperty(_modDef8366, obj7);
    obj.children = items2;
