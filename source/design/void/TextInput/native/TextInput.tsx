...
// Dependencies: [19, 17, 1074, 21, 4605, 576, 4456, 1115, 4454, 2]

// Module 9827 (TextInput/TextInput)
...
const forwardRefResult = noop.forwardRef((style, ref) => {
  ...
  if (tmp3Result3.isAndroid()) {
    hexWithOpacityResult = tmp3(4454).hexWithOpacity(tmp6, 0.5);
    const tmp3Result4 = tmp3(4454);
  }
