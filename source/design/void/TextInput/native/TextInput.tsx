...
// Dependencies: [19, 17, 1074, 21, 4574, 576, 4425, 1115, 4423, 2]

// Module 9789 (TextInput/TextInput)
...
const forwardRefResult = noop.forwardRef((style, ref) => {
  ...
  if (tmp3Result3.isAndroid()) {
    hexWithOpacityResult = tmp3(4423).hexWithOpacity(tmp6, 0.5);
    const tmp3Result4 = tmp3(4423);
  }
