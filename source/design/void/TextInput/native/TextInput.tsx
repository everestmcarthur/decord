...
// Dependencies: [19, 17, 1074, 21, 4638, 576, 4489, 1364, 4487, 2]

// Module 9897 (TextInput/TextInput)
...
const forwardRefResult = noop.forwardRef((style, ref) => {
  ...
  if (tmp3Result3.isAndroid()) {
    hexWithOpacityResult = tmp3(4487).hexWithOpacity(tmp6, 0.5);
    const tmp3Result4 = tmp3(4487);
  }
