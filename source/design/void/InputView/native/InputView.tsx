...
// Function ID: 14306
// Name: InputView
// Dependencies: [109, 19, 17, 1074, 21, 4640, 576, 5529, 4350, 1177, 4636, 1115, 6727, 4491, 12324, 1364, 2]

// Module 14305 (InputView)
...
import components_BottomSheetTextInputDefault from "components/BottomSheetTextInput" /* 12324 */;
...
obj2.inputView = { fontSize: 16, paddingBottom: 0, paddingTop: 0, textAlignVertical: "top", flex: 1, color: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.inputViewBorder = { marginTop: 8, height: 2 };
let obj5 = { fontSize: 16, paddingBottom: 0, paddingTop: 0, textAlignVertical: "top", flex: 1, color: fn(5529).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
...
obj2.charactersLength = { alignSelf: "flex-end", fontFamily: Fonts.CODE_BOLD, color: fn(5529).DARK_PRIMARY_400_LIGHT_PRIMARY_300 };
let obj7 = { alignSelf: "flex-end", fontFamily: Fonts.CODE_BOLD, color: fn(5529).DARK_PRIMARY_400_LIGHT_PRIMARY_300 };
...
InputView.contextType = fn(4350).ThemeContext;
