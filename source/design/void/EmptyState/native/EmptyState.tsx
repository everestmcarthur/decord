...
// Function ID: 14178
// Name: EmptyState
// Dependencies: [19, 17, 21, 4606, 576, 4458, 4602, 2]
// Exports: default

// Module 14177 (EmptyState)
...
export default function EmptyState(Illustration) {
  ...
  if (null != Illustration.Illustration) {
    ...
    if (tmp9) {
      ...
      obj3.source = tmp2(4458).isThemeLight(tmp8) ? Illustration.lightSource : Illustration.darkSource;
  ...
  if (null != title) {
    ...
    if (null != title) {
      ...
      obj6.style = items4;
      obj6.children = title;
      tmp25 = React4(tmp2(4602).Text, obj6);
    }
    const items5 = [tmp25, ];
    let tmp27 = null;
    if (null != body) {
      ...
      obj7.style = items6;
      obj7.children = body;
      tmp27 = React4(tmp2(4602).Text, obj7);
    }
    items5[1] = tmp27;
