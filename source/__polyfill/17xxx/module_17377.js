// Module ID: 17377
// Function ID: 17378
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8577, 10007]
...
import emptyFunction_mod from "module_10007" /* 10007 */;
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = tmp23(tmp24(8577).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = tmp23(tmp24(8577).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(8577).G, obj3);
      const items1 = [timestampProducer(CircularProgress(8577).Svg, size2), ];
