// Module ID: 17337
// Function ID: 17338
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8574, 10005]
...
import emptyFunction_mod from "module_10005" /* 10005 */;
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = tmp23(tmp24(8574).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = tmp23(tmp24(8574).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(8574).G, obj3);
      const items1 = [timestampProducer(CircularProgress(8574).Svg, size2), ];
