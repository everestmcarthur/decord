// Module ID: 8663
// Function ID: 8664
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8585, 8655, 8664, 8590, 8601]
...
const entry = {
  ...
  value: function render() {
    ...
    const tmp3Result = Pattern(8585)(patternTransform);
    ...
    if (patternContentUnits) {
      num2 = tmp(8655)[patternContentUnits];
    }
    ...
    const tmp3 = Pattern(8585);
    const merged = Object.assign(size);
    const merged1 = Object.assign(tmp(8590)({ viewBox, preserveAspectRatio }));
    obj.children = children;
    return jsx(Pattern(8664), {
      ref(arg0) {
        return self.refMethod(arg0);
      }
    });
