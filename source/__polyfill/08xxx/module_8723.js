// Module ID: 8723
// Function ID: 8724
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8704, 8724, 8713]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, rx, ry } = props);
    const merged = Object.assign(Ellipse(8704).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.rx = rx;
    obj.ry = ry;
    const obj2 = Ellipse(8704);
    const obj3 = {
      ref(arg0) {
