// Module ID: 8966
// Function ID: 8967
// Dependencies: [8967, 9033, 9034, 9037, 9036, 9038, 8986, 9030, 9039, 8977, 9035, 9040]

// Module 8966
import ar from "ar" /* 8977 */;
import _mod8986 from "module_8986" /* 8986 */;
import _mod9033 from "module_9033" /* 9033 */;
import lt from "lt" /* 9034 */;
import _mod9036 from "module_9036" /* 9036 */;
import _mod9037 from "module_9037" /* 9037 */;
import _mod9038 from "module_9038" /* 9038 */;
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.core = fn(require("module_8967"));
    fn2(_mod9033, exports);
    fn2(lt, exports);
    fn2(_mod9037, exports);
    fn2(_mod9036, exports);
    fn2(_mod9038, exports);
    require("module_8967").config(fn3(_mod8986).default());
    const _Object4 = Object;
    let obj = {
      enumerable: true,
      get() {
            return require("module_8967").globalRegistry;
          }
    };
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_8967").registry;
          }
    };
    ...
    const obj3 = {
      enumerable: true,
      get() {
            return require("module_8967").config;
          }
    };
    ...
    const obj4 = {
      enumerable: true,
      get() {
            return require("module_8967").$output;
          }
    };
    ...
    const obj5 = {
      enumerable: true,
      get() {
            return require("module_8967").$input;
          }
    };
    ...
    const obj6 = {
      enumerable: true,
      get() {
            return require("module_8967").$brand;
          }
    };
    ...
    const obj7 = {
      enumerable: true,
      get() {
            return require("module_8967").clone;
          }
    };
    ...
    const obj8 = {
      enumerable: true,
      get() {
            return require("module_8967").regexes;
          }
    };
    ...
    const obj9 = {
      enumerable: true,
      get() {
            return require("module_8967").treeifyError;
          }
    };
    ...
    const obj10 = {
      enumerable: true,
      get() {
            return require("module_8967").prettifyError;
          }
    };
    ...
    const obj11 = {
      enumerable: true,
      get() {
            return require("module_8967").formatError;
          }
    };
    ...
    const obj12 = {
      enumerable: true,
      get() {
            return require("module_8967").flattenError;
          }
    };
    ...
    const obj13 = {
      enumerable: true,
      get() {
            return require("module_8967").TimePrecision;
          }
    };
    ...
    const obj14 = {
      enumerable: true,
      get() {
            return require("module_8967").util;
          }
    };
    ...
    const obj15 = {
      enumerable: true,
      get() {
            return require("module_8967").NEVER;
          }
    };
    ...
    const obj18 = {
      enumerable: true,
      get() {
            return require("module_9035").ZodISODateTime;
          }
    };
    ...
    const obj19 = {
      enumerable: true,
      get() {
            return require("module_9035").ZodISODate;
          }
    };
    ...
    const obj20 = {
      enumerable: true,
      get() {
            return require("module_9035").ZodISOTime;
          }
    };
    ...
    const obj21 = {
      enumerable: true,
      get() {
            return require("module_9035").ZodISODuration;
          }
    };
    Object.defineProperty(exports, "ZodISODuration", obj21);
    exports.iso = fn(require("module_9035"));
    exports.coerce = fn(_mod9040);
  } else {
