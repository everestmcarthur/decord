// Module ID: 8327
// Function ID: 8328
// Dependencies: [19, 17, 21, 113, 8328, 39, 38, 8330, 8331]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8330").container, require("module_8330").webView, style];
  const items4 = [require("module_8330").container, containerStyle];
