// Module ID: 8581
// Function ID: 8582
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8582, 8583, 8584, 8585, 8589, 8590, 8591, 8601]

// Module 8581
import extractOpacityDefault from "extractOpacity" /* 8583 */;
import extractResponderDefault from "extractResponder" /* 8584 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8582).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8582).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8601);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8585).extractTransformSvgView(tmp);
      const obj3 = Svg(8585);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8590)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8591, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8589, {});
  }
};
let items = [entry];
