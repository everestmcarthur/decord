// Module ID: 8674
// Function ID: 8675
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8675, 8670, 8610]
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (points) => {
      ...
      if (points) {
        ...
        points.d = "M" + Polygon(8675)(points) + "z";
      }
      if (closure_0.root) {
...
const entry = {
  ...
  value: function render() {
    ...
    if (points) {
      const _HermesInternal = HermesInternal;
      combined = "M" + Polygon(8675)(points) + "z";
    }
    obj.d = combined;
    const merged = Object.assign(props);
    return jsx(Polygon(8670), { ref: this.refMethod, d: null });
  }
};
let items = [entry];
