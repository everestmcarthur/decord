// Module ID: 8399
// Function ID: 8400
// Dependencies: [8400, 32, 109, 19, 17, 8401, 21, 8403, 8404, 8405]
...
const _slicedToArray = module_8400(_mod32);
const _objectWithoutProperties = module_8400(_objectWithoutProperties2);
...
const __INTERNAL_VIEW_CONFIG = module_8400(_mod8401);
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === SLIDER_DEFAULT_INITIAL_VALUE) {
    SLIDER_DEFAULT_INITIAL_VALUE = _mod8403.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (undefined === lowerLimit) {
    ...
    const obj = { web: num, default: _mod8403.constants.LIMIT_MIN_VALUE };
  ...
  if (undefined === upperLimit) {
    ...
    const obj2 = { web: num2, default: _mod8403.constants.LIMIT_MAX_VALUE };
  ...
  if (null == SLIDER_DEFAULT_INITIAL_VALUE2) {
    SLIDER_DEFAULT_INITIAL_VALUE2 = _mod8403.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (!num3) {
    DEFAULT_STEP_RESOLUTION = _mod8403.constants.DEFAULT_STEP_RESOLUTION;
  }
  ...
  if ("ios" === get_ActivityIndicator.Platform.OS) {
    let defaultSlider = _mod8404.styles.defaultSlideriOS;
    let tmp24 = require;
  } else {
    tmp24 = require;
    defaultSlider = _mod8404.styles.defaultSlider;
  }
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = obj6.jsx(tmp24(8405).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
