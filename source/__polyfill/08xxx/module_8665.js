// Module ID: 8665
// Function ID: 8666
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8666, 8661, 8601]
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (points) => {
      ...
      if (points) {
        ...
        points.d = "M" + Polygon(8666)(points) + "z";
      }
      if (closure_0.root) {
...
const entry = {
  ...
  value: function render() {
    ...
    if (points) {
      const _HermesInternal = HermesInternal;
      combined = "M" + Polygon(8666)(points) + "z";
    }
    obj.d = combined;
    const merged = Object.assign(props);
    return jsx(Polygon(8661), { ref: this.refMethod, d: null });
  }
};
let items = [entry];
