// Module ID: 8546
// Function ID: 8547
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8547, 8548, 8549, 8550, 8554, 8555, 8556, 8566]

// Module 8546
import extractOpacityDefault from "extractOpacity" /* 8548 */;
import extractResponderDefault from "extractResponder" /* 8549 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8547).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8547).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8566);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8550).extractTransformSvgView(tmp);
      const obj3 = Svg(8550);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8555)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8556, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
