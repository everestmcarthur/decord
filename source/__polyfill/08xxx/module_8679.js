// Module ID: 8679
// Function ID: 8680
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8585, 8593, 8599, 8592, 8680, 8676, 8601]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8593).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8601);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8593).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8592).withoutXY(self, tmp);
      ...
      return jsx(_modDef8676, { ref: self.refMethod, children });
    }
