// Module ID: 8760
// Function ID: 8761
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8702, 8761, 8704, 8713]
...
_inherits(SvgImage, _modDef8713);
const entry = {
  key: "render",
  value: function render() {
    ...
    const size = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: SvgImage(8702).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
    [tmp2, tmp3] = parts;
    const tmp6 = SvgImage(8702).meetOrSliceTypes[tmp3] || 0;
    size.align = SvgImage(8702).alignEnum[tmp2] || "xMidYMid";
    ...
    const tmp7 = SvgImage(8702).alignEnum[tmp2] || "xMidYMid";
    const merged = Object.assign(SvgImage(8704).withoutXY(this, props));
