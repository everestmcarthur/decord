// Module ID: 8578
// Function ID: 8579
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8559, 8579, 8568]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, rx, ry } = props);
    const merged = Object.assign(Ellipse(8559).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.rx = rx;
    obj.ry = ry;
    const obj2 = Ellipse(8559);
    const obj3 = {
      ref(arg0) {
