// Module ID: 8692
// Function ID: 8693
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8614, 8684, 8693, 8619, 8630]
...
const entry = {
  ...
  value: function render() {
    ...
    const tmp3Result = Pattern(8614)(patternTransform);
    ...
    if (patternContentUnits) {
      num2 = tmp(8684)[patternContentUnits];
    }
    ...
    const tmp3 = Pattern(8614);
    const merged = Object.assign(size);
    const merged1 = Object.assign(tmp(8619)({ viewBox, preserveAspectRatio }));
    obj.children = children;
    return jsx(Pattern(8693), {
      ref(arg0) {
        return self.refMethod(arg0);
      }
    });
