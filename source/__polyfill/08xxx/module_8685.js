// Module ID: 8685
// Function ID: 8686
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8594, 8601, 8602, 8608, 8686, 8610]
...
import extractFontDefault from "extractFont" /* 8608 */;
...
class TSpan {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const propsAndStylesResult = TSpan(8601).propsAndStyles(matrix);
      const obj = TSpan(8601);
      const merged = Object.assign(propsAndStylesResult, TSpan(8602).pickNotNil(extractFontDefault(propsAndStylesResult, false)));
      if (closure_0.root) {
...
_inherits(TSpan, _modDef8610);
const entry = {
  key: "render",
  value: function render() {
    const propsAndStylesResult = TSpan(8601).propsAndStyles(this.props);
    const obj2 = {};
    const obj = TSpan(8601);
