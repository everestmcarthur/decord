// Module ID: 8648
// Function ID: 8649
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8590, 8649, 8592, 8601]
...
_inherits(SvgImage, _modDef8601);
const entry = {
  key: "render",
  value: function render() {
    ...
    const size = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: SvgImage(8590).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
    [tmp2, tmp3] = parts;
    const tmp6 = SvgImage(8590).meetOrSliceTypes[tmp3] || 0;
    size.align = SvgImage(8590).alignEnum[tmp2] || "xMidYMid";
    ...
    const tmp7 = SvgImage(8590).alignEnum[tmp2] || "xMidYMid";
    const merged = Object.assign(SvgImage(8592).withoutXY(this, props));
