// Module ID: 8648
// Function ID: 8649
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8560, 8649, 8559, 8568]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8560).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8559).withoutXY(this, props));
