// Module ID: 8684
// Function ID: 8685
// Dependencies: [41, 42, 93, 95, 98, 19, 8685, 21, 8594, 8601, 8602, 8608, 8687, 8610]
...
_isNativeReflectConstruct = fn(8685);
const jsx = fn(21).jsx;
class Text {
  constructor() {
    self = this;
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const propsAndStylesResult = Text(8601).propsAndStyles(matrix);
      const obj = Text(8601);
      const merged = Object.assign(propsAndStylesResult, Text(8602).pickNotNil(extractFontDefault(propsAndStylesResult, true)));
      if (closure_0.root) {
...
_inherits(Text, _modDef8610);
const entry = {
  key: "render",
  value: function render() {
    const propsAndStylesResult = Text(8601).propsAndStyles(this.props);
    const obj2 = {};
    const obj = Text(8601);
