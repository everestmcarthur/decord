// Module ID: 8488
// Function ID: 8489
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8489, 8490, 8491, 8492, 8496, 8497, 8498, 8508]

// Module 8488
import extractOpacityDefault from "extractOpacity" /* 8490 */;
import extractResponderDefault from "extractResponder" /* 8491 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8489).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8489).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8508);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8492).extractTransformSvgView(tmp);
      const obj3 = Svg(8492);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8497)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8498, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8496, {});
  }
};
let items = [entry];
