// Module ID: 8646
// Function ID: 8647
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8552, 8560, 8566, 8559, 8647, 8643, 8568]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8560).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8568);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8560).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8559).withoutXY(self, tmp);
      ...
      const obj5 = {};
      const obj2 = TextPath(8559);
      const merged1 = Object.assign(withoutXYResult);
      return jsx(_modDef8647, {});
    } else {
      ...
      return jsx(_modDef8643, { ref: self.refMethod, children });
    }
