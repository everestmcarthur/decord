// Module ID: 8646
// Function ID: 8647
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8558, 8647, 8557, 8566]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8558).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8557).withoutXY(this, props));
