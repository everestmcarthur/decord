// Module ID: 8644
// Function ID: 8645
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8550, 8558, 8564, 8557, 8645, 8641, 8566]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8558).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8566);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8558).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8557).withoutXY(self, tmp);
      ...
      const obj5 = {};
      const obj2 = TextPath(8557);
      const merged1 = Object.assign(withoutXYResult);
      return jsx(_modDef8645, {});
    } else {
      ...
      return jsx(_modDef8641, { ref: self.refMethod, children });
    }
