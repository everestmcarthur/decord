// Module ID: 8640
// Function ID: 8641
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8621, 8641, 8630]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, rx, ry } = props);
    const merged = Object.assign(Ellipse(8621).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.rx = rx;
    obj.ry = ry;
    const obj2 = Ellipse(8621);
    const obj3 = {
      ref(arg0) {
