// Module ID: 8640
// Function ID: 8641
// Dependencies: [41, 42, 93, 95, 98, 19, 8641, 21, 8550, 8557, 8558, 8564, 8643, 8566]
...
class Text {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const obj = Text(8557);
      const merged = Object.assign(propsAndStylesResult, Text(8558).pickNotNil(extractFontDefault(propsAndStylesResult, true)));
      if (closure_0.root) {
...
const entry = {
  ...
  value: function render() {
    const propsAndStylesResult = Text(8557).propsAndStyles(this.props);
    const obj2 = {};
    const obj = Text(8557);
