// Module ID: 8705
// Function ID: 8706
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8614, 8621, 8622, 8628, 8706, 8630]
...
class TSpan {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const propsAndStylesResult = TSpan(8621).propsAndStyles(matrix);
      const obj = TSpan(8621);
      const merged = Object.assign(propsAndStylesResult, TSpan(8622).pickNotNil(extractFontDefault(propsAndStylesResult, false)));
      if (closure_0.root) {
...
_inherits(TSpan, _modDef8630);
const entry = {
  key: "render",
  value: function render() {
    const propsAndStylesResult = TSpan(8621).propsAndStyles(this.props);
    const obj2 = {};
    const obj = TSpan(8621);
