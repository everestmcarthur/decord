// Module ID: 8693
// Function ID: 8694
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8694, 8695, 8696, 8697, 8701, 8702, 8703, 8713]

// Module 8693
import extractOpacityDefault from "extractOpacity" /* 8695 */;
import extractResponderDefault from "extractResponder" /* 8696 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8694).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8694).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8713);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8697).extractTransformSvgView(tmp);
      const obj3 = Svg(8697);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8702)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8703, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8701, {});
  }
};
let items = [entry];
