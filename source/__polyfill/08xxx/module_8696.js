// Module ID: 8696
// Function ID: 8697
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8695, 8690, 8630]
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (points) => {
      ...
      if (points) {
        ...
        points.d = "M" + Polyline(8695)(points);
      }
      if (closure_0.root) {
...
_inherits(Polyline, _modDef8630);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (points) {
      const _HermesInternal = HermesInternal;
      combined = "M" + Polyline(8695)(points);
    }
    obj.d = combined;
    const merged = Object.assign(props);
    return jsx(Polyline(8690), { ref: this.refMethod, d: null });
  }
};
let items = [entry];
