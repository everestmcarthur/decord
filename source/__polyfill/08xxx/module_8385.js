// Module ID: 8385
// Function ID: 8386
// Dependencies: [19, 17, 21, 113, 8386, 39, 38, 8388, 8389]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8388").container, require("module_8388").webView, style];
  const items4 = [require("module_8388").container, containerStyle];
