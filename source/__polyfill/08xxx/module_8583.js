// Module ID: 8583
// Function ID: 8584
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8492, 8499, 8500, 8506, 8584, 8508]
...
class TSpan {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const propsAndStylesResult = TSpan(8499).propsAndStyles(matrix);
      const obj = TSpan(8499);
      const merged = Object.assign(propsAndStylesResult, TSpan(8500).pickNotNil(extractFontDefault(propsAndStylesResult, false)));
      if (closure_0.root) {
...
_inherits(TSpan, _modDef8508);
const entry = {
  key: "render",
  value: function render() {
    const propsAndStylesResult = TSpan(8499).propsAndStyles(this.props);
    const obj2 = {};
    const obj = TSpan(8499);
