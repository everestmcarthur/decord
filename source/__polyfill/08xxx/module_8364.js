// Module ID: 8364
// Function ID: 8365
// Dependencies: [19, 17, 21, 113, 8365, 39, 38, 8367, 8368]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8367").container, require("module_8367").webView, style];
  const items4 = [require("module_8367").container, containerStyle];
