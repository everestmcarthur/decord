// Module ID: 8364
// Function ID: 8365
// Dependencies: [8365, 32, 109, 19, 17, 8366, 21, 8368, 8369, 8370]
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === lowerLimit) {
    ...
    const obj = { web: num, default: _mod8368.constants.LIMIT_MIN_VALUE };
  ...
  if (undefined === upperLimit) {
    ...
    const obj2 = { web: num2, default: _mod8368.constants.LIMIT_MAX_VALUE };
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = obj6.jsx(tmp24(8370).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
