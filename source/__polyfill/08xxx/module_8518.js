// Module ID: 8518
// Function ID: 8519
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8499, 8519, 8508]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, rx, ry } = props);
    const merged = Object.assign(Ellipse(8499).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.rx = rx;
    obj.ry = ry;
    const obj2 = Ellipse(8499);
    const obj3 = {
      ref(arg0) {
