// Module ID: 8577
// Function ID: 8578
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8578, 8559, 8560]
...
const entry = {
  ...
  value: function render() {
    ...
    const merged = Object.assign(FeMerge(8559).extractFilter(this.props));
    const obj2 = FeMerge(8559);
    const merged1 = Object.assign(FeMerge(8559).extractFeMerge(this.props, this));
