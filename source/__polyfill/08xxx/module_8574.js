// Module ID: 8574
// Function ID: 8575
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8573, 8568, 8508]
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (points) => {
      ...
      if (points) {
        ...
        points.d = "M" + Polyline(8573)(points);
      }
      if (closure_0.root) {
...
_inherits(Polyline, _modDef8508);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (points) {
      const _HermesInternal = HermesInternal;
      combined = "M" + Polyline(8573)(points);
    }
    obj.d = combined;
    const merged = Object.assign(props);
    return jsx(Polyline(8568), { ref: this.refMethod, d: null });
  }
};
let items = [entry];
