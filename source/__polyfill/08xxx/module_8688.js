// Module ID: 8688
// Function ID: 8689
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8594, 8602, 8608, 8601, 8689, 8685, 8610]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8602).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8610);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8602).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8601).withoutXY(self, tmp);
      ...
      const obj5 = {};
      const obj2 = TextPath(8601);
      const merged1 = Object.assign(withoutXYResult);
      return jsx(_modDef8689, {});
    } else {
      ...
      return jsx(_modDef8685, { ref: self.refMethod, children });
    }
