// Module ID: 8525
// Function ID: 8526
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8526, 8527, 8528, 8529, 8533, 8534, 8535, 8545]

// Module 8525
import extractOpacityDefault from "extractOpacity" /* 8527 */;
import extractResponderDefault from "extractResponder" /* 8528 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8526).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8526).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8545);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8529).extractTransformSvgView(tmp);
      const obj3 = Svg(8529);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8534)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8535, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8533, {});
  }
};
let items = [entry];
