// Module ID: 8710
// Function ID: 8711
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8622, 8711, 8621, 8630]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8622).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8621).withoutXY(this, props));
