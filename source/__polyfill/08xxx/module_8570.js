// Module ID: 8570
// Function ID: 8571
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8492, 8562, 8571, 8497, 8508]
...
const entry = {
  ...
  value: function render() {
    ...
    const tmp3Result = Pattern(8492)(patternTransform);
    ...
    if (patternContentUnits) {
      num2 = tmp(8562)[patternContentUnits];
    }
    ...
    const tmp3 = Pattern(8492);
    const merged = Object.assign(size);
    const merged1 = Object.assign(tmp(8497)({ viewBox, preserveAspectRatio }));
    obj.children = children;
    return jsx(Pattern(8571), {
      ref(arg0) {
        return self.refMethod(arg0);
      }
    });
