// Module ID: 8548
// Function ID: 8549
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8549, 8550, 8551, 8552, 8556, 8557, 8558, 8568]

// Module 8548
import extractOpacityDefault from "extractOpacity" /* 8550 */;
import extractResponderDefault from "extractResponder" /* 8551 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8549).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8549).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8568);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8552).extractTransformSvgView(tmp);
      const obj3 = Svg(8552);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8557)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8558, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
