// Module ID: 8708
// Function ID: 8709
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8614, 8622, 8628, 8621, 8709, 8705, 8630]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8622).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8630);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8622).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8621).withoutXY(self, tmp);
      ...
      const obj5 = {};
      const obj2 = TextPath(8621);
      const merged1 = Object.assign(withoutXYResult);
      return jsx(_modDef8709, {});
    } else {
      ...
      return jsx(_modDef8705, { ref: self.refMethod, children });
    }
