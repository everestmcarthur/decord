// Module ID: 8420
// Function ID: 8421
// Dependencies: [19, 17, 21, 113, 8421, 39, 38, 8423, 8424]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8423").container, require("module_8423").webView, style];
  const items4 = [require("module_8423").container, containerStyle];
