// Module ID: 8590
// Function ID: 8591
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8591, 8592, 8593, 8594, 8598, 8599, 8600, 8610]

// Module 8590
import extractOpacityDefault from "extractOpacity" /* 8592 */;
import extractResponderDefault from "extractResponder" /* 8593 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8591).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8591).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8610);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8594).extractTransformSvgView(tmp);
      const obj3 = Svg(8594);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8599)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8600, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8598, {});
  }
};
let items = [entry];
