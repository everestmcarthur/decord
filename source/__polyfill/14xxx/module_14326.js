// Module ID: 14326
// Function ID: 14327
// Dependencies: [14327, 14328, 1162, 14329, 14330]
...
import calendars from "calendars" /* 14327 */;
import hourCycles from "hourCycles" /* 14328 */;
import timezones from "timezones" /* 14329 */;
import weekData from "weekData" /* 14330 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14328).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14328).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14328).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1162).__spreadArray(items, tmp2(14329).timezones[formatted], true);
  } else {
    return items;
  }
};
