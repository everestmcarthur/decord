// Module ID: 14166
// Function ID: 14167
// Dependencies: [14129, 14158, 14149, 14154, 14150, 14153, 14160, 14157]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14129")(arg0, arg3);
  const tmp4 = new require("module_14158")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14149);
    let tmpResult = tmp(14154);
    const tmpResult3 = tmp(14150);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14150);
      tmpResult = tmp(14153);
      tmpResult4 = tmp(14149);
  ...
  if (require("module_14160")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
