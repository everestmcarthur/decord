// Module ID: 14429
// Function ID: 14430
// Dependencies: [14430, 14431, 1253, 14432]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14432.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14432.percentDecode(_Buffer.from(buffer));
  }
}
