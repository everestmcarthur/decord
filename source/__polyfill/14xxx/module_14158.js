// Module ID: 14158
// Function ID: 14159
// Dependencies: [14121, 14150, 14141, 14146, 14142, 14145, 14152, 14149]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14121")(arg0, arg3);
  const tmp4 = new require("module_14150")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14141);
    let tmpResult = tmp(14146);
    const tmpResult3 = tmp(14142);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14142);
      tmpResult = tmp(14145);
      tmpResult4 = tmp(14141);
  ...
  if (require("module_14152")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
