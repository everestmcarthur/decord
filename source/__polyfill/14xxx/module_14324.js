// Module ID: 14324
// Function ID: 14325
// Dependencies: [14325, 14326, 1162, 14327, 14328]
...
import calendars from "calendars" /* 14325 */;
import hourCycles from "hourCycles" /* 14326 */;
import timezones from "timezones" /* 14327 */;
import weekData from "weekData" /* 14328 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14326).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14326).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14326).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1162).__spreadArray(items, tmp2(14327).timezones[formatted], true);
  } else {
    return items;
  }
};
