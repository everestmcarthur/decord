// Module ID: 14077
// Function ID: 14078
// Dependencies: [14071, 14042, 14062]
...
export default (arg0, arg1) => {
  obj = new obj(14071)(arg0, arg1);
  const tmp3 = new obj(14042)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14042)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14042(semver.semver.version);
