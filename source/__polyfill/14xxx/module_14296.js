// Module ID: 14296
// Function ID: 14297
// Dependencies: [14297, 1162, 14298]
// Exports: findBestMatch, invariant

// Module 14296
import e from "e" /* 1162 */;
import data from "data" /* 14297 */;
import regions from "regions" /* 14298 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14297).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14297).data.supplemental.languageMatching["written-new"];
