// Module ID: 14106
// Function ID: 14107
// Dependencies: [14069, 14098, 14089, 14094, 14090, 14093, 14100, 14097]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14069")(arg0, arg3);
  const tmp4 = new require("module_14098")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14089);
    let tmpResult = tmp(14094);
    const tmpResult3 = tmp(14090);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14090);
      tmpResult = tmp(14093);
      tmpResult4 = tmp(14089);
  ...
  if (require("module_14100")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
