          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                let arr = Array.from(self[URLSearchParams(undefined, 14375).implSymbol]);
                let num2 = 0;
                let tmp11 = arr;
                if (0 < arr.length) {
                  do {
                    ...
                    let tmp5 = callback2;
                    let tmp6 = callback2(arr.map(URLSearchParams(14375).tryWrapperForImpl), 2);
                    [tmp7, tmp8] = tmp6;
                    let call = fn.call;
                    let tmp9 = num2;
                    ...
                    let _Array = Array;
                    arr = Array.from(self[tmp3(undefined, 14375).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr;
