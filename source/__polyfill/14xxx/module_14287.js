// Module ID: 14287
// Function ID: 14288
// Dependencies: [1160, 14288, 14289, 14353, 14360, 14365, 14380, 14381]
...
function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod14353.parseUnicodeLocaleId(arr3);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      const obj = { lang, script, region, variants: [] };
      const tmp4 = tmp(14353).likelySubtags[tmp(undefined, 14353).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(14353).parseUnicodeLanguageId(tmp4);
        ...
        if (result) {
          ...
          const tmpResult = tmp(1160);
          obj2.variants = tmpResult.__spreadArray(tmp(1160).__spreadArray([], variants, true), result.variants, true);
          let obj3 = obj2;
        ...
        return tmp(14353).emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = tmp(14353).likelySubtags[tmp(undefined, 14353).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = tmp(14353).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
      if (result1) {
        ...
        obj5.region = region;
        const tmpResult9 = tmp(1160);
        obj5.variants = tmpResult9.__spreadArray(tmp(1160).__spreadArray([], items, true), result1.variants, true);
        let obj6 = obj5;
        const tmpResult10 = tmp(1160);
      } else {
  ...
  if (region) {
    ...
    const tmp6 = tmp(14353).likelySubtags[tmp(undefined, 14353).emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = tmp(14353).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
      if (result2) {
        ...
        const tmpResult11 = tmp(1160);
        obj8.variants = tmpResult11.__spreadArray(tmp(1160).__spreadArray([], items1, true), result2.variants, true);
        let obj9 = obj8;
        const tmpResult12 = tmp(1160);
      } else {
  ...
  let tmp7 = tmp(14353).likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = tmp(14353).likelySubtags[tmp(undefined, 14353).emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = tmp(14353).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
    ...
    if (result3) {
      ...
      const tmpResult13 = tmp(1160);
      obj11.variants = tmpResult13.__spreadArray(tmp(1160).__spreadArray([], items2, true), result3.variants, true);
      let tmp14 = obj11;
      const tmpResult14 = tmp(1160);
    } else {
      obj11.lang = "und";
      obj11.script = script;
      obj11.region = region;
...
const module_14288 = e.__importDefault(_mod14288);
...
let tmp2 = (() => {
    ...
    minimize() {
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            const obj = Locale(1160);
            const obj3 = { variants: [] };
            const result = Locale(14353).emitUnicodeLanguageId(obj.__assign(Locale(1160).__assign({}, Locale(14353).parseUnicodeLanguageId(tmp2)), obj3));
            const parseUnicodeLocaleIdResult = Locale(14353).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (tmp(Locale(14353).emitUnicodeLanguageId(obj4)) === result) {
              const tmp3Result = tmp3(1160);
              const tmp3Result6 = tmp3(1160);
              if (undefined === variants) {
                variants = [];
              }
              if (!lang) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = tmp3(14353).emitUnicodeLocaleId(tmp3Result.__assign(tmp3(1160).__assign({}, parseUnicodeLocaleIdResult), obj5));
              const __assignResult = tmp3(1160).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (tmp(tmp3(14353).emitUnicodeLanguageId(obj7)) === result) {
                  const tmp3Result7 = tmp3(1160);
                  let items = variants;
                  const tmp3Result8 = tmp3(1160);
                  if (undefined === variants) {
                    items = [];
                  }
                  let str2 = lang;
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = tmp3(14353).emitUnicodeLocaleId(tmp3Result7.__assign(tmp3(1160).__assign({}, parseUnicodeLocaleIdResult), obj8));
                  const __assignResult1 = tmp3(1160).__assign({}, parseUnicodeLocaleIdResult);
                }
              }
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (tmp(tmp3(14353).emitUnicodeLanguageId(obj10)) === result) {
                  const tmp3Result9 = tmp3(1160);
                  let items1 = variants;
                  const tmp3Result10 = tmp3(1160);
                  if (undefined === variants) {
                    items1 = [];
                  }
                  let str = lang;
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = tmp3(14353).emitUnicodeLocaleId(tmp3Result9.__assign(tmp3(1160).__assign({}, parseUnicodeLocaleIdResult), obj11));
                  const __assignResult2 = tmp3(1160).__assign({}, parseUnicodeLocaleIdResult);
                }
              }
            }
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14353).emitUnicodeLanguageId(Locale(14353).parseUnicodeLanguageId(module_14288.default(this).locale));
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_14288.default(this).calendar;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_14288.default(this).collation;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_14288.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_14288.default(this).numeric;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_14288.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14353).parseUnicodeLanguageId(module_14288.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14353).parseUnicodeLanguageId(module_14288.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14353).parseUnicodeLanguageId(module_14288.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_14288.default(this);
      if (Locale(14289).HasOwnProperty(defaultResult, "initializedLocale")) {
