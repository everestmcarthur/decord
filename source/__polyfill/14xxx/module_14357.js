// Module ID: 14357
// Function ID: 14358
// Dependencies: [14358, 1161, 14359]
// Exports: findBestMatch, invariant

// Module 14357
import e from "e" /* 1161 */;
import data from "data" /* 14358 */;
import regions from "regions" /* 14359 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14358).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14358).data.supplemental.languageMatching["written-new"];
