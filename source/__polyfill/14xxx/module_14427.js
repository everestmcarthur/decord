// Module ID: 14427
// Function ID: 14428
// Dependencies: [14428, 14429, 1253, 14430]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14430.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14430.percentDecode(_Buffer.from(buffer));
  }
}
