...
export default () => {
  ...
  return (arg0) => {
    ...
    obj = {
      onConnect() {
        const XHRInterceptor = obj(14504).XHRInterceptor;
        XHRInterceptor.setSendCallback(onSend);
        const XHRInterceptor2 = obj(14504).XHRInterceptor;
        XHRInterceptor2.setResponseCallback(onResponse);
        const XHRInterceptor3 = obj(14504).XHRInterceptor;
