// Module ID: 14069
// Function ID: 14070
// Dependencies: [14042, 14046, 14041]
...
export default (num, arg1) => {
  if (num instanceof _mod14042) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14046).safeRe;
        const t2 = tmp(14046).t;
      ...
      if (null === match2) {
        ...
        return _mod14041("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
