// Module ID: 14451
// Function ID: 14452
// Dependencies: [14452, 14453, 1253, 14454]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14454.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14454.percentDecode(_Buffer.from(buffer));
  }
}
