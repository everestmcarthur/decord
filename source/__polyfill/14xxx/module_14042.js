// Module ID: 14042
// Function ID: 14043
// Dependencies: [41, 42, 14043, 14044, 14045, 14046, 14047]
...
let items = [
  ...
  },
  {
    ...
    value: function compare(tmp2Result) {
      const self = this;
      SemVer(14045)("SemVer.compare", this.version, this.options, tmp2Result);
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      let compareIdentifiersResult = SemVer(14047).compareIdentifiers(self.major, tmpResult.major);
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14047).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(14047);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14047).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(14047);
      }
  ...
  },
  {
    ...
    value: function comparePre(tmp2Result) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14045)("prerelease compare", num3, tmp3, tmp4);
  ...
  },
  {
    ...
    value: function compareBuild(arg0) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14045)("build compare", num, tmp3, tmp4);
        let tmp11 = undefined === tmp3;
        if (tmp11) {
          if (undefined === tmp4) {
            break;
