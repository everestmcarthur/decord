// Module ID: 14490
// Function ID: 14491
// Dependencies: [14491, 14492, 1252, 14493]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14493.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14493.percentDecode(_Buffer.from(buffer));
  }
}
