// Module ID: 14294
// Function ID: 14295
// Dependencies: [14295, 1162, 14296]
// Exports: findBestMatch, invariant

// Module 14294
import e from "e" /* 1162 */;
import data from "data" /* 14295 */;
import regions from "regions" /* 14296 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14295).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14295).data.supplemental.languageMatching["written-new"];
