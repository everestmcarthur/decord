// Module ID: 14118
// Function ID: 14119
// Dependencies: [14091, 14095, 14090]
...
export default (num, arg1) => {
  if (num instanceof _mod14091) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14095).safeRe;
        const t2 = tmp(14095).t;
      ...
      if (null === match2) {
        ...
        return _mod14090("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
