// Module ID: 14164
// Function ID: 14165
// Dependencies: [14158, 14129, 14149]
...
export default (arg0, arg1) => {
  obj = new obj(14158)(arg0, arg1);
  const tmp3 = new obj(14129)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14129)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14129(semver.semver.version);
