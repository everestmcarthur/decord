// Module ID: 14460
// Function ID: 14461
// Dependencies: [14461, 1161, 14462]
// Exports: findBestMatch, invariant

// Module 14460
import e from "e" /* 1161 */;
import data from "data" /* 14461 */;
import regions from "regions" /* 14462 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14461).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14461).data.supplemental.languageMatching["written-new"];
