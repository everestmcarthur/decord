// Module ID: 14269
// Function ID: 14270
// Dependencies: [14270, 1162, 14271]
// Exports: findBestMatch, invariant

// Module 14269
import e from "e" /* 1162 */;
import data from "data" /* 14270 */;
import regions from "regions" /* 14271 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14270).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14270).data.supplemental.languageMatching["written-new"];
