// Module ID: 14148
// Function ID: 14149
// Dependencies: [14121, 14125, 14120]
...
export default (num, arg1) => {
  if (num instanceof _mod14121) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14125).safeRe;
        const t2 = tmp(14125).t;
      ...
      if (null === match2) {
        ...
        return _mod14120("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
