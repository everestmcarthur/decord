// Module ID: 14369
// Function ID: 14370
// Dependencies: [14370, 14371, 1161, 14372, 14373]
...
import calendars from "calendars" /* 14370 */;
import hourCycles from "hourCycles" /* 14371 */;
import timezones from "timezones" /* 14372 */;
import weekData from "weekData" /* 14373 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14371).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14371).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14371).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1161).__spreadArray(items, tmp2(14372).timezones[formatted], true);
  } else {
    return items;
  }
};
