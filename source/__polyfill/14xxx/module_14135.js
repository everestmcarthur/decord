// Module ID: 14135
// Function ID: 14136
// Dependencies: [14108, 14112, 14107]
...
export default (num, arg1) => {
  if (num instanceof _mod14108) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14112).safeRe;
        const t2 = tmp(14112).t;
      ...
      if (null === match2) {
        ...
        return _mod14107("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
