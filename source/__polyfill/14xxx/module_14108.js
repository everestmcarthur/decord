// Module ID: 14108
// Function ID: 14109
// Dependencies: [41, 42, 14109, 14110, 14111, 14112, 14113]
...
let items = [
  ...
  },
  {
    ...
    value: function compare(tmp2Result) {
      const self = this;
      SemVer(14111)("SemVer.compare", this.version, this.options, tmp2Result);
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      let compareIdentifiersResult = SemVer(14113).compareIdentifiers(self.major, tmpResult.major);
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14113).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(14113);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14113).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(14113);
      }
  ...
  },
  {
    ...
    value: function comparePre(tmp2Result) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14111)("prerelease compare", num3, tmp3, tmp4);
  ...
  },
  {
    ...
    value: function compareBuild(arg0) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14111)("build compare", num, tmp3, tmp4);
        let tmp11 = undefined === tmp3;
        if (tmp11) {
          if (undefined === tmp4) {
            break;
