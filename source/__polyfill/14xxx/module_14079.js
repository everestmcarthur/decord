// Module ID: 14079
// Function ID: 14080
// Dependencies: [14042, 14071, 14062, 14067, 14063, 14066, 14073, 14070]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14042")(arg0, arg3);
  const tmp4 = new require("module_14071")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14062);
    let tmpResult = tmp(14067);
    const tmpResult3 = tmp(14063);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14063);
      tmpResult = tmp(14066);
      tmpResult4 = tmp(14062);
  ...
  if (require("module_14073")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
