// Module ID: 14137
// Function ID: 14138
// Dependencies: [14131, 14102, 14122]
...
export default (arg0, arg1) => {
  obj = new obj(14131)(arg0, arg1);
  const tmp3 = new obj(14102)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14102)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14102(semver.semver.version);
