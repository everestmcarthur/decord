// Module ID: 14318
// Function ID: 14319
// Dependencies: [14319, 1162, 14320]
// Exports: findBestMatch, invariant

// Module 14318
import e from "e" /* 1162 */;
import data from "data" /* 14319 */;
import regions from "regions" /* 14320 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14319).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14319).data.supplemental.languageMatching["written-new"];
