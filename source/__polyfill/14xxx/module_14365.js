// Module ID: 14365
// Function ID: 14366
// Dependencies: [14366, 1161, 14367]
// Exports: findBestMatch, invariant

// Module 14365
import e from "e" /* 1161 */;
import data from "data" /* 14366 */;
import regions from "regions" /* 14367 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14366).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14366).data.supplemental.languageMatching["written-new"];
