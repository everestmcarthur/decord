// Module ID: 14462
// Function ID: 14463
// Dependencies: [14463, 14464, 1253, 14465]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14465.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14465.percentDecode(_Buffer.from(buffer));
  }
}
