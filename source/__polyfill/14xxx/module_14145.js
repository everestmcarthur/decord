// Module ID: 14145
// Function ID: 14146
// Dependencies: [14108, 14137, 14128, 14133, 14129, 14132, 14139, 14136]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14108")(arg0, arg3);
  const tmp4 = new require("module_14137")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14128);
    let tmpResult = tmp(14133);
    const tmpResult3 = tmp(14129);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14129);
      tmpResult = tmp(14132);
      tmpResult4 = tmp(14128);
  ...
  if (require("module_14139")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
