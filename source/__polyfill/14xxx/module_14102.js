// Module ID: 14102
// Function ID: 14103
// Dependencies: [14096, 14067, 14087]
...
export default (arg0, arg1) => {
  obj = new obj(14096)(arg0, arg1);
  const tmp3 = new obj(14067)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14067)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14067(semver.semver.version);
