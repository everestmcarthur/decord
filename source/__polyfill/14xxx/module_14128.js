// Module ID: 14128
// Function ID: 14129
// Dependencies: [14091, 14120, 14111, 14116, 14112, 14115, 14122, 14119]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14091")(arg0, arg3);
  const tmp4 = new require("module_14120")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14111);
    let tmpResult = tmp(14116);
    const tmpResult3 = tmp(14112);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14112);
      tmpResult = tmp(14115);
      tmpResult4 = tmp(14111);
  ...
  if (require("module_14122")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
