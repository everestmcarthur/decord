// Module ID: 14502
// Function ID: 14503
// Dependencies: [41, 42, 32, 14496, 14503, 14504]

// Module 14502
import _mod14496 from "module_14496" /* 14496 */;
import URLSearchParamsImpl from "URLSearchParamsImpl" /* 14503 */;
...
let obj = {
  next: {
    value: function next() {
      const tmp3 = this[_mod14496.iterInternalSymbol];
      ({ kind, index } = tmp3);
      const arr = Array.from(tmp3.target[_mod14496.implSymbol]);
      if (index >= arr.length) {
        return { value: "HermesInternal", done: null };
      } else {
        tmp3.index = index + 1;
        [tmp7, tmp8] = arr[index].map(_mod14496.tryWrapperForImpl);
        if ("key" === kind) {
          let tmp4 = tmp7;
        } else if ("value" === kind) {
          tmp4 = tmp8;
...
let closure_6 = Object.create(_mod14496.IteratorPrototype, obj);
let obj2 = {
  _mixedIntoPredicates: [],
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod14496.implSymbol)) {
        if (arg0[tmp(undefined, 14496).implSymbol] instanceof tmp(14503).implementation) {
          return true;
        }
      }
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj2, _mod14496.iterInternalSymbol, obj);
    return obj2;
  },
  create(arg0, arg1, arg2) {
    if (undefined === arg0[_mod14496.ctorRegistrySymbol]) {
      ...
      const _URLSearchParams = arg0[_mod14496.ctorRegistrySymbol].URLSearchParams;
  ...
  createImpl(arg0, arg1, arg2) {
    ...
    return _mod14496.implForWrapper(obj2);
  },
  _internalSetup(arg0) {
  ...
  setup(wrapper, arg1) {
    ...
    if (URLSearchParamsImpl.init) {
      tmp2(14503).init(wrapper[tmp2(undefined, 14496).implSymbol], obj);
      const tmp2Result = tmp2(14503);
    }
    return wrapper;
  },
  install(arg0) {
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(URLSearchParams(14504).USVString(arguments[0], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 1" }));
              const obj = URLSearchParams(14504);
              items.push(URLSearchParams(14504).USVString(arguments[1], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 2" }));
              const tmp12 = self[URLSearchParams(undefined, 14496).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(14504).USVString(arguments[0], { context: "Failed to execute 'delete' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 14496).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(14504).USVString(arguments[0], { context: "Failed to execute 'get' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 14496).implSymbol];
                const get = tmp6.get;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(14504).USVString(arguments[0], { context: "Failed to execute 'getAll' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(14504);
                const tmp11 = self[URLSearchParams(undefined, 14496).implSymbol];
                const getAll = tmp11.getAll;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return URLSearchParams(14496).tryWrapperForImpl(HermesBuiltin.apply(items1, tmp11));
              }
            }
          }
          const typeError1 = new TypeError("Illegal invocation");
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(14504).USVString(arguments[0], { context: "Failed to execute 'has' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 14496).implSymbol];
                const has = tmp6.has;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 2) {
                ...
                const items = [];
                items.push(URLSearchParams(14504).USVString(arguments[0], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(14504);
                items.push(URLSearchParams(14504).USVString(arguments[1], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 2" }));
                const tmp12 = self[URLSearchParams(undefined, 14496).implSymbol];
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return HermesBuiltin.apply(items1, tmp12);
      ...
      },
      {
        ...
        value: function sort() {
          ...
          if (this) {
            const _exports = module.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 14496).implSymbol].sort();
            }
          }
      ...
      },
      {
        ...
        value: function toString() {
          ...
          if (this) {
            const _exports = module.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 14496).implSymbol].toString();
            }
          }
          const typeError = new TypeError("Illegal invocation");
          throw typeError;
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                const arr2 = Array.from(self[URLSearchParams(undefined, 14496).implSymbol]);
                let num2 = 0;
                let tmp11 = arr2;
                if (0 < arr2.length) {
                  do {
                    ...
                    let tmp6 = _slicedToArray(arr.map(URLSearchParams(14496).tryWrapperForImpl), 2);
                    [tmp7, tmp8] = tmp6;
                    call = call.call;
                    ...
                    let _Array = Array;
                    arr3 = Array.from(self[tmp3(undefined, 14496).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr3;
    ...
    if (undefined === arg0[URLSearchParams(undefined, 14496).ctorRegistrySymbol]) {
      let _Object = Object;
    ...
    arg0[URLSearchParams(undefined, 14496).ctorRegistrySymbol].URLSearchParams = tmp;
