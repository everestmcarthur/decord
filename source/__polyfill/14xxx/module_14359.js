// Module ID: 14359
// Function ID: 14360
// Dependencies: [14360, 14361, 1162, 14362, 14363]
...
import calendars from "calendars" /* 14360 */;
import hourCycles from "hourCycles" /* 14361 */;
import timezones from "timezones" /* 14362 */;
import weekData from "weekData" /* 14363 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14361).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14361).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14361).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1162).__spreadArray(items, tmp2(14362).timezones[formatted], true);
  } else {
    return items;
  }
};
