// Module ID: 14339
// Function ID: 14340
// Dependencies: [14340, 1161, 14341]
// Exports: findBestMatch, invariant

// Module 14339
import e from "e" /* 1161 */;
import data from "data" /* 14340 */;
import regions from "regions" /* 14341 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14340).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14340).data.supplemental.languageMatching["written-new"];
