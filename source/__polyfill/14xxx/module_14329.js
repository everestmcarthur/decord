// Module ID: 14329
// Function ID: 14330
// Dependencies: [14330, 1162, 14331]
// Exports: findBestMatch, invariant

// Module 14329
import e from "e" /* 1162 */;
import data from "data" /* 14330 */;
import regions from "regions" /* 14331 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14330).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14330).data.supplemental.languageMatching["written-new"];
