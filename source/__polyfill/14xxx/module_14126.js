// Module ID: 14126
// Function ID: 14127
// Dependencies: [14120, 14091, 14111]
...
export default (arg0, arg1) => {
  obj = new obj(14120)(arg0, arg1);
  const tmp3 = new obj(14091)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14091)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14091(semver.semver.version);
