// Module ID: 14286
// Function ID: 14287
// Dependencies: [1162, 14287, 14288, 14352, 14359, 14364, 14379, 14380]
...
function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod14352.parseUnicodeLocaleId(arr3);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      const obj = { lang, script, region, variants: [] };
      const tmp4 = tmp(14352).likelySubtags[tmp(undefined, 14352).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(14352).parseUnicodeLanguageId(tmp4);
        ...
        if (result) {
          ...
          obj3 = { lang: "und", script: "Array", region: "accessible", variants };
        }
        parseUnicodeLocaleIdResult.lang = obj3;
        return tmp(14352).emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = tmp(14352).likelySubtags[tmp(undefined, 14352).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = tmp(14352).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = tmp(14352).likelySubtags[tmp(undefined, 14352).emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = tmp(14352).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = tmp(14352).likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = tmp(14352).likelySubtags[tmp(undefined, 14352).emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = tmp(14352).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
const module_14287 = e.__importDefault(_mod14287);
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14352).emitUnicodeLanguageId(obj.__assign(Locale(1162).__assign({}, Locale(14352).parseUnicodeLanguageId(tmp2)), obj3));
            const parseUnicodeLocaleIdResult = Locale(14352).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (tmp(Locale(14352).emitUnicodeLanguageId(obj4)) === result) {
              ...
              const obj6 = { lang, script: "Array", region: "accessible", variants };
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = tmp3(14352).emitUnicodeLocaleId(tmp3Result.__assign(tmp3(1162).__assign({}, parseUnicodeLocaleIdResult), obj5));
              const __assignResult = tmp3(1162).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (tmp(tmp3(14352).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = tmp3(14352).emitUnicodeLocaleId(tmp3Result7.__assign(tmp3(1162).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (tmp(tmp3(14352).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = tmp3(14352).emitUnicodeLocaleId(tmp3Result9.__assign(tmp3(1162).__assign({}, parseUnicodeLocaleIdResult), obj11));
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14352).emitUnicodeLanguageId(Locale(14352).parseUnicodeLanguageId(module_14287.default(this).locale));
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_14287.default(this).calendar;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_14287.default(this).collation;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_14287.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_14287.default(this).numeric;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_14287.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14352).parseUnicodeLanguageId(module_14287.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14352).parseUnicodeLanguageId(module_14287.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14352).parseUnicodeLanguageId(module_14287.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_14287.default(this);
      if (Locale(14288).HasOwnProperty(defaultResult, "initializedLocale")) {
