// Module ID: 14498
// Function ID: 14499
// Dependencies: [14499, 14500, 1252, 14501]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14501.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14501.percentDecode(_Buffer.from(buffer));
  }
}
