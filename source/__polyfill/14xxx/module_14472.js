// Module ID: 14472
// Function ID: 14473
// Dependencies: [14473, 14474, 1252, 14475]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14475.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14475.percentDecode(_Buffer.from(buffer));
  }
}
