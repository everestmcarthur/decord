// Module ID: 5340
// Function ID: 5341
// Dependencies: [5299, 5341]

// Module 5340
import _mod5299 from "module_5299" /* 5299 */;
import iccTags from "iccTags" /* 5341 */;
            ...
            if (uint321 > buffer.length) {
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (uint323 > uint322) {
                  ...
                  if (tmp55(5341).iccTags[stringFromDataView]) {
                    let obj3 = { value: applyResult, description: applyResult };
                    obj2[tmp55(5341).iccTags[stringFromDataView].name] = obj3;
                  } else {
                ...
                if (1 === uint324) {
                  text = items[0].text;
                  if (tmp25(5341).iccTags[stringFromDataView]) {
                    let obj9 = { value: text, description: text };
                    obj2[tmp25(5341).iccTags[stringFromDataView].name] = obj9;
                  } else {
                  ...
                  if (iccTags.iccTags[stringFromDataView]) {
                    ...
                    obj2[tmp33(5341).iccTags[stringFromDataView].name] = obj12;
                  } else {
                ...
                if (tmp55(5341).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5341).iccTags[stringFromDataView].name] = obj14;
                } else {
                ...
                if (tmp55(5341).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5341).iccTags[stringFromDataView].name] = obj16;
                } else {
...
export default {
  read(buffer, arr, arg2) {
    if (arg2) {
      if (arr[0].compressionMethod !== _mod5299.COMPRESSION_METHOD_NONE) {
        if (arr[0].compressionMethod === tmp(5299).COMPRESSION_METHOD_DEFLATE) {
