// Module ID: 5308
// Function ID: 5309
// Dependencies: [5268, 5283, 5284, 5280, 5263]
...
export default {
  read(buffer, c5, arg2) {
    let iter;
    const byteOrder = _modDef5268.getByteOrder(buffer, c5);
    ...
    if (ifd.MPEntry) {
      ...
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let result = num13 * c3;
          let obj4 = _modDef5280;
          let typeSize = obj4.getTypeSize("LONG");
          if (byteOrder === _modDef5268.LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
          ...
          if (0 !== num13) {
            ...
            let deferInitResult = obj15.deferInit(items[num13], "base64", function() {
              return _mod5263.getBase64Image(this.image);
            });
            num13 = num13 + 1;
            let _Math2 = Math;
          }
        ...
        const typeSize4 = _modDef5280.getTypeSize("LONG");
        if (byteOrder === _modDef5268.LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
