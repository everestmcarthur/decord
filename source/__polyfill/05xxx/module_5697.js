// Module ID: 5697
// Function ID: 5698
// Dependencies: [5695, 5698]

// Module 5697
import _mod5695 from "module_5695" /* 5695 */;
import swizzle from "swizzle" /* 5698 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5695")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5695");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5695")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5695)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
