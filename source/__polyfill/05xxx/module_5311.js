...
export default {
  read(byteLength, sum) {
    ...
    if (sum + 4 <= byteLength.byteLength) {
      const longAt = _modDef5282.getLongAt(byteLength, sum);
    ...
    if (sum + 4 + 4 <= byteLength.byteLength) {
      const longAt1 = _modDef5282.getLongAt(byteLength, sum + 4);
    ...
    if (sum + 8 + 1 <= byteLength.byteLength) {
      const byteAt = _modDef5282.getByteAt(byteLength, sum + 8);
    ...
    if (sum + 9 + 1 <= byteLength.byteLength) {
      const byteAt1 = _modDef5282.getByteAt(byteLength, sum + 9);
    ...
    if (sum + 10 + 1 <= byteLength.byteLength) {
      const byteAt2 = _modDef5282.getByteAt(byteLength, sum + 10);
    ...
    if (sum + 11 + 1 <= byteLength.byteLength) {
      const byteAt3 = _modDef5282.getByteAt(byteLength, sum + 11);
    ...
    if (sum + 12 + 1 <= byteLength.byteLength) {
      const byteAt4 = _modDef5282.getByteAt(byteLength, sum + 12);
