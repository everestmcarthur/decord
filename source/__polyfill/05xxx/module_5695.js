// Module ID: 5695
// Function ID: 5696
// Dependencies: [5693, 5696]

// Module 5695
import _mod5693 from "module_5693" /* 5693 */;
import swizzle from "swizzle" /* 5696 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5693")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5693");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5693")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5693)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
