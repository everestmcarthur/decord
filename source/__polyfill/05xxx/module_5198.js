...
export const detectFile = function detectFile(uint8Array, chunkSize) {
  ...
  const fileChunk = _mod5199.getFileChunk(uint8Array, num3);
  if (0 !== fileChunk.length) {
    const items = [];
    const items1 = [];
    for (const key10027 in _mod5200.FileTypes) {
      let _Object4 = Object;
      let call2 = hasOwnProperty2.call;
      let tmp23 = require;
      let FileTypes5 = _mod5200.FileTypes;
