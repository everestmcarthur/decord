// Module ID: 5238
// Function ID: 5239
// Dependencies: [5239, 5240, 5241, 5242, 5243, 5236, 5235]

// Module 5238
import _mod5235 from "module_5235" /* 5235 */;
import _mod5236 from "module_5236" /* 5236 */;
import _mod5239 from "module_5239" /* 5239 */;
import is7Z from "is7Z" /* 5240 */;
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      hasOwnProperty = Object.prototype.hasOwnProperty;
      let call = hasOwnProperty.call;
      let FileTypes = _mod5236.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      let tmp19 = item10079;
      let tmp21 = require;
      let FileTypes2 = _mod5236.FileTypes;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5236.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let FileTypes3 = tmp21(5236).FileTypes;
    ...
    fileChunk = _mod5235.getFileChunk(fileChunk, num2);
    const FileTypes4 = _mod5236.FileTypes;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5236.FileTypes;
