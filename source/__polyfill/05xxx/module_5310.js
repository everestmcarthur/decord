// Module ID: 5310
// Function ID: 5311
// Dependencies: [5270, 5285, 5286, 5282, 5265]
...
export default {
  read(buffer, c5, arg2) {
    let iter;
    const byteOrder = _modDef5270.getByteOrder(buffer, c5);
    ...
    if (ifd.MPEntry) {
      ...
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let result = num13 * c3;
          let obj4 = _modDef5282;
          let typeSize = obj4.getTypeSize("LONG");
          if (byteOrder === _modDef5270.LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
          ...
          if (0 !== num13) {
            ...
            let deferInitResult = obj15.deferInit(items[num13], "base64", function() {
              return _mod5265.getBase64Image(this.image);
            });
            num13 = num13 + 1;
            let _Math2 = Math;
          }
        ...
        const typeSize4 = _modDef5282.getTypeSize("LONG");
        if (byteOrder === _modDef5270.LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
