// Module ID: 5002
// Function ID: 5003
// Dependencies: [109, 19, 17, 21, 5003, 5004, 5005]
// Exports: default
...
export default function TabsScreen(arg0) {
  ...
  const result = _mod5005.parseAndroidIconToNativeProps(icon);
  const tmp5Result = _mod5005;
  const result1 = _mod5005.parseAndroidIconToNativeProps(selectedIcon);
