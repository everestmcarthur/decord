// Module ID: 5616
// Function ID: 5617
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5617, 5618]

// Module 5616
import _modDef5617 from "module_5617" /* 5617 */;
...
const entry = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5617).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
...
let items = [
  ...
  },
  {
    ...
    value: function renderLottieView() {
      ...
      const parsePossibleSourcesResult = LottieView(5618).parsePossibleSources(source);
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(_modDef5617, { ref: self.captureRef });
        }
      }
