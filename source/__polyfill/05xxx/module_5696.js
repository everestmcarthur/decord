// Module ID: 5696
// Function ID: 5697
// Dependencies: [5694, 5697]

// Module 5696
import _mod5694 from "module_5694" /* 5694 */;
import swizzle from "swizzle" /* 5697 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5694")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5694");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5694")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5694)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
