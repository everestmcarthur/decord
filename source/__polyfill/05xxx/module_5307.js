  ...
  read(byteLength, arg1, arg2, arg3) {
    ...
    if (LevelInfo) {
      ...
      if (sum1 + 7 <= byteLength.byteLength) {
        ...
        const int16 = byteLength.getInt16(sum2, byteOrder === tmp3(5268).LITTLE_ENDIAN);
        const obj5 = { value: int16, description: "" + -0.5 * int16 };
        obj3.RollAngle = obj5;
        const sum3 = sum1 + tmp17.PITCH_ANGLE;
        const int161 = byteLength.getInt16(sum3, byteOrder === tmp3(5268).LITTLE_ENDIAN);
        const obj6 = { value: int161, description: "" + -0.5 * int161 };
        obj3.PitchAngle = obj6;
      }
      const tmp7Result = _mod5263;
      delete tmp[tmp2];
      tmp10 = _mod5263.objectAssign({}, ifd, obj3);
      const objectAssignResult = _mod5263.objectAssign({}, ifd, obj3);
    }
    return tmp10;
  },
