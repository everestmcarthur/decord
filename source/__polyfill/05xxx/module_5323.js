...
obj[33434] = { name: "ExposureTime", description: fn2(5322).ExposureTime };
const obj2 = { name: "ExposureTime", description: fn2(5322).ExposureTime };
obj[33437] = { name: "FNumber", description: fn2(5322).FNumber };
const obj3 = { name: "FNumber", description: fn2(5322).FNumber };
obj[34850] = { name: "ExposureProgram", description: fn2(5322).ExposureProgram };
obj[34856] = {
  name: "OECF",
  description() {
...
const obj4 = { name: "ExposureProgram", description: fn2(5322).ExposureProgram };
obj[37121] = { name: "ComponentsConfiguration", description: fn2(5322).ComponentsConfiguration };
const obj5 = { name: "ComponentsConfiguration", description: fn2(5322).ComponentsConfiguration };
obj[37377] = { name: "ShutterSpeedValue", description: fn2(5322).ShutterSpeedValue };
const obj6 = { name: "ShutterSpeedValue", description: fn2(5322).ShutterSpeedValue };
obj[37378] = { name: "ApertureValue", description: fn2(5322).ApertureValue };
obj[37381] = {
...
const obj7 = { name: "ApertureValue", description: fn2(5322).ApertureValue };
obj[37383] = { name: "MeteringMode", description: fn2(5322).MeteringMode };
const obj8 = { name: "MeteringMode", description: fn2(5322).MeteringMode };
obj[37384] = { name: "LightSource", description: fn2(5322).LightSource };
obj[37385] = {
  name: "Flash",
  description(arg0) {
...
const obj9 = { name: "LightSource", description: fn2(5322).LightSource };
obj[37386] = { name: "FocalLength", description: fn2(5322).FocalLength };
obj[37394] = {
...
const obj10 = { name: "FocalLength", description: fn2(5322).FocalLength };
obj[37510] = { name: "UserComment", description: fn(5324).getEncodedString };
obj[37888] = {
...
const obj11 = { name: "UserComment", description: fn(5324).getEncodedString };
obj[40961] = { name: "ColorSpace", description: fn2(5322).ColorSpace };
obj[41484] = {
...
const obj12 = { name: "ColorSpace", description: fn2(5322).ColorSpace };
obj[41488] = { name: "FocalPlaneResolutionUnit", description: fn2(5322).FocalPlaneResolutionUnit };
obj[41492] = {
...
const obj13 = { name: "FocalPlaneResolutionUnit", description: fn2(5322).FocalPlaneResolutionUnit };
obj[41985] = { name: "CustomRendered", description: fn2(5322).CustomRendered };
const obj14 = { name: "CustomRendered", description: fn2(5322).CustomRendered };
obj[41986] = { name: "ExposureMode", description: fn2(5322).ExposureMode };
const obj15 = { name: "ExposureMode", description: fn2(5322).ExposureMode };
obj[41987] = { name: "WhiteBalance", description: fn2(5322).WhiteBalance };
obj[41988] = {
...
const obj16 = { name: "WhiteBalance", description: fn2(5322).WhiteBalance };
obj[41989] = { name: "FocalLengthIn35mmFilm", description: fn2(5322).FocalLengthIn35mmFilm };
const obj17 = { name: "FocalLengthIn35mmFilm", description: fn2(5322).FocalLengthIn35mmFilm };
obj[41990] = { name: "SceneCaptureType", description: fn2(5322).SceneCaptureType };
obj[41991] = {
  name: "GainControl",
  description(arg0) {
    let str = "None";
...
const obj18 = { name: "SceneCaptureType", description: fn2(5322).SceneCaptureType };
obj[41992] = { name: "Contrast", description: fn2(5322).Contrast };
const obj19 = { name: "Contrast", description: fn2(5322).Contrast };
obj[41993] = { name: "Saturation", description: fn2(5322).Saturation };
const obj20 = { name: "Saturation", description: fn2(5322).Saturation };
obj[41994] = { name: "Sharpness", description: fn2(5322).Sharpness };
obj[41995] = {
