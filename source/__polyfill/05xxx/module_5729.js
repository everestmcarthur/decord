// Module ID: 5729
// Function ID: 5730
// Dependencies: [32, 19, 17, 21, 1614, 5709, 5721, 5705, 5702, 5688, 1484]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5702.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
