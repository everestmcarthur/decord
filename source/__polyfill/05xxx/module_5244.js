...
export default {
  ...
  getShortAt(dataView, sum, byteOrder) {
    return dataView.getUint16(sum, byteOrder === _modDef5232.LITTLE_ENDIAN);
  },
  getLongAt(dataView, sum, byteOrder) {
    return dataView.getUint32(sum, byteOrder === _modDef5232.LITTLE_ENDIAN);
  },
  getRationalAt(getUint32, sum, arg2) {
    const items = [getUint32.getUint32(sum, arg2 === _modDef5232.LITTLE_ENDIAN), ];
    sum = sum + 4;
    items[1] = getUint32.getUint32(sum, arg2 === _modDef5232.LITTLE_ENDIAN);
    return items;
  },
  ...
  getSlongAt(getInt32, sum, arg2) {
    return getInt32.getInt32(sum, arg2 === _modDef5232.LITTLE_ENDIAN);
  },
  getSrationalAt(getInt32, sum, arg2) {
    const items = [getInt32.getInt32(sum, arg2 === _modDef5232.LITTLE_ENDIAN), ];
    sum = sum + 4;
    items[1] = getInt32.getInt32(sum, arg2 === _modDef5232.LITTLE_ENDIAN);
    return items;
  },
  getIfdPointerAt(getUint32, sum, arg2) {
    return getUint32.getUint32(sum, arg2 === _modDef5232.LITTLE_ENDIAN);
  },
  typeSizes,
  tagTypes: obj2,
  getTypeSize(LONG) {
