// Module ID: 5342
// Function ID: 5343
// Dependencies: [5301, 5343]

// Module 5342
import _mod5301 from "module_5301" /* 5301 */;
import iccTags from "iccTags" /* 5343 */;
            ...
            if (uint321 > buffer.length) {
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (uint323 > uint322) {
                  ...
                  if (tmp55(5343).iccTags[stringFromDataView]) {
                    let obj3 = { value: applyResult, description: applyResult };
                    obj2[tmp55(5343).iccTags[stringFromDataView].name] = obj3;
                  } else {
                ...
                if (1 === uint324) {
                  text = items[0].text;
                  if (tmp25(5343).iccTags[stringFromDataView]) {
                    let obj9 = { value: text, description: text };
                    obj2[tmp25(5343).iccTags[stringFromDataView].name] = obj9;
                  } else {
                  ...
                  if (iccTags.iccTags[stringFromDataView]) {
                    ...
                    obj2[tmp33(5343).iccTags[stringFromDataView].name] = obj12;
                  } else {
                ...
                if (tmp55(5343).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5343).iccTags[stringFromDataView].name] = obj14;
                } else {
                ...
                if (tmp55(5343).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5343).iccTags[stringFromDataView].name] = obj16;
                } else {
...
export default {
  read(buffer, arr, arg2) {
    if (arg2) {
      if (arr[0].compressionMethod !== _mod5301.COMPRESSION_METHOD_NONE) {
        if (arr[0].compressionMethod === tmp(5301).COMPRESSION_METHOD_DEFLATE) {
