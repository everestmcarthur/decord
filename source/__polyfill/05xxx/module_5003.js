// Module ID: 5003
// Function ID: 5004
// Dependencies: [109, 19, 17, 21, 5004, 5005, 5006]
// Exports: default
...
export default function TabsScreen(arg0) {
  ...
  const result = _mod5006.parseAndroidIconToNativeProps(icon);
  const tmp5Result = _mod5006;
  const result1 = _mod5006.parseAndroidIconToNativeProps(selectedIcon);
