// Module ID: 5619
// Function ID: 5620
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5620, 5621]

// Module 5619
import _modDef5620 from "module_5620" /* 5620 */;
...
const entry = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5620).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
...
let items = [
  ...
  },
  {
    ...
    value: function renderLottieView() {
      ...
      const parsePossibleSourcesResult = LottieView(5621).parsePossibleSources(source);
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(_modDef5620, { ref: self.captureRef });
        }
      }
