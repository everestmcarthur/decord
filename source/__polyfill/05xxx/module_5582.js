// Module ID: 5582
// Function ID: 5583
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5583, 5584]

// Module 5582
import _modDef5583 from "module_5583" /* 5583 */;
...
const entry = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5583).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
...
let items = [
  ...
  },
  {
    ...
    value: function renderLottieView() {
      ...
      const parsePossibleSourcesResult = LottieView(5584).parsePossibleSources(source);
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(_modDef5583, { ref: self.captureRef });
        }
      }
