// Module ID: 5659
// Function ID: 5660
// Dependencies: [5657, 5660]

// Module 5659
import _mod5657 from "module_5657" /* 5657 */;
import swizzle from "swizzle" /* 5660 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5657")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5657");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5657")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5657)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
