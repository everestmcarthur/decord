// Module ID: 5301
// Function ID: 5302
// Dependencies: [5302, 5303, 5305, 5306, 5307, 5311, 5312, 5313, 5314, 5299]
  ...
  parseAppMarkers(byteLength, flag2) {
    if (_modDef5302.USE_TIFF) {
      if (tmpResult.isTiffFile(byteLength)) {
        const tmpResult16 = tmp(5303);
        const findTiffOffsetsResult = tmp(5303).findTiffOffsets();
