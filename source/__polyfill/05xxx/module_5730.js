// Module ID: 5730
// Function ID: 5731
// Dependencies: [5728, 5731]

// Module 5730
import _mod5728 from "module_5728" /* 5728 */;
import swizzle from "swizzle" /* 5731 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5728")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5728");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5728")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5728)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
