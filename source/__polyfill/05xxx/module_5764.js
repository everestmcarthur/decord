// Module ID: 5764
// Function ID: 5765
// Dependencies: [32, 19, 17, 21, 1615, 5744, 5756, 5740, 5737, 5723, 1485]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5737.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
