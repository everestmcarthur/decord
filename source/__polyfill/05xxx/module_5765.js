// Module ID: 5765
// Function ID: 5766
// Dependencies: [32, 19, 17, 21, 1615, 5745, 5757, 5741, 5738, 5724, 1485]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5738.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
