// Module ID: 5733
// Function ID: 5734
// Dependencies: [5731, 5734]

// Module 5733
import _mod5731 from "module_5731" /* 5731 */;
import swizzle from "swizzle" /* 5734 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5731")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5731");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5731")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5731)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
