// Module ID: 5693
// Function ID: 5694
// Dependencies: [32, 19, 17, 21, 1614, 5673, 5685, 5669, 5666, 5652, 1484]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5666.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
