// Module ID: 5276
// Function ID: 5277
// Dependencies: [5277, 5278, 5279, 5280, 5281, 5274, 5273]

// Module 5276
import _mod5273 from "module_5273" /* 5273 */;
import _mod5274 from "module_5274" /* 5274 */;
import _mod5277 from "module_5277" /* 5277 */;
import is7Z from "is7Z" /* 5278 */;
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      hasOwnProperty = Object.prototype.hasOwnProperty;
      let call = hasOwnProperty.call;
      let FileTypes = _mod5274.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      let tmp19 = item10079;
      let tmp21 = require;
      let FileTypes2 = _mod5274.FileTypes;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5274.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let FileTypes3 = tmp21(5274).FileTypes;
    ...
    fileChunk = _mod5273.getFileChunk(fileChunk, num2);
    const FileTypes4 = _mod5274.FileTypes;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5274.FileTypes;
