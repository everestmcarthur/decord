...
export const isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && _mod5270.isAvifStringIncluded(fileChunk);
};
...
export const isHEIC = function isHEIC(fileChunk) {
  fileChunk = _mod5270.getFileChunk(fileChunk);
  const FileTypes = _mod5271.FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && _mod5270.isHeicSignatureIncluded(fileChunk);
};
