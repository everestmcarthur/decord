// Module ID: 5731
// Function ID: 5732
// Dependencies: [5729, 5732]

// Module 5731
import _mod5729 from "module_5729" /* 5729 */;
import swizzle from "swizzle" /* 5732 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5729")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5729");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5729")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5729)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
