// Module ID: 5731
// Function ID: 5732
// Dependencies: [32, 19, 17, 21, 1614, 5711, 5723, 5707, 5704, 5690, 1484]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5704.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
