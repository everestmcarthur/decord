// Module ID: 5767
// Function ID: 5768
// Dependencies: [32, 19, 17, 21, 1615, 5747, 5759, 5743, 5740, 5726, 1485]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5740.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
