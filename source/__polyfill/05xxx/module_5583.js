// Module ID: 5583
// Function ID: 5584
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5584, 5585]

// Module 5583
import _modDef5584 from "module_5584" /* 5584 */;
...
const entry = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5584).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
...
let items = [
  ...
  },
  {
    ...
    value: function renderLottieView() {
      ...
      const parsePossibleSourcesResult = LottieView(5585).parsePossibleSources(source);
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(_modDef5584, { ref: self.captureRef });
        }
      }
