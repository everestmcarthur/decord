...
const entry = {
  ...
  value: function parse(arg0, arg1) {
    if ("X" === arg1) {
      return _createSuperInternal(4001).parseTimezonePattern(_createSuperInternal(4002).timezonePatterns.basicOptionalMinutes, arg0);
    } else if ("XX" === arg1) {
      return _createSuperInternal(4001).parseTimezonePattern(_createSuperInternal(4002).timezonePatterns.basic, arg0);
    } else if ("XXXX" === arg1) {
      return _createSuperInternal(4001).parseTimezonePattern(_createSuperInternal(4002).timezonePatterns.basicOptionalSeconds, arg0);
    } else if ("XXXXX" === arg1) {
      return _createSuperInternal(4001).parseTimezonePattern(_createSuperInternal(4002).timezonePatterns.extendedOptionalSeconds, arg0);
    } else {
      return _createSuperInternal(4001).parseTimezonePattern(_createSuperInternal(4002).timezonePatterns.extended, arg0);
    }
  }
};
let items = [
