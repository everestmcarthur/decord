...
let fn = function t(exports, React) {
    ...
    for (let num = 1; num < arguments.length; num = num + 1) {
      ...
      if (num % 2) {
        ...
        if (Object.getOwnPropertySymbols) {
          ...
          let push2 = keys.push;
          let applyResult = push2.apply(keys, ownPropertySymbols.filter((item) => Object.getOwnPropertyDescriptor(closure_0, item).enumerable));
        }
  ...
  let tmp = (function o() {
    ...
    const obj = { array: shim, bool: shim, func: shim, number: shim, object: shim, string: shim, symbol: shim, any: shim, arrayOf: getShim, element: shim, elementType: shim, instanceOf: getShim, node: shim, objectOf: getShim, oneOf: getShim, oneOfType: getShim, shape: getShim, exact: getShim, checkPropTypes, resetWarningCache: _objectSpread2 };
    obj.PropTypes = obj;
    return obj;
  })();
  let _default = tmp;
        ...
        if (typeof tmp8 === "function") {
          ...
          if (typeof tmp8 === "function") {
            ...
            if (first1.checkoutSdk) {
              ...
              obj4 = { value: null };
              obj4.value = tmp18;
              element = obj.createElement(closure_20.Provider, obj1, obj.createElement(closure_22.Provider, obj4, exports.children));
            }
            return element;
          } else {
  ...
  let obj = { stripe: _default.any, options: _default.shape({ fetchClientSecret: _default.func.isRequired, elementsOptions: _default.object }).isRequired };
