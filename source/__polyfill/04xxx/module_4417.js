// Module ID: 4417
// Function ID: 4418
// Dependencies: [19, 4406, 4410, 4398]
// Exports: useViewModelInstance

// Module 4417
import ArtboardByIndex from "ArtboardByIndex" /* 4406 */;
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("module_4410").useDisposableMemo(() => {
    if (closure_0) {
      let tmp6 = null != obj;
      if (tmp6) {
