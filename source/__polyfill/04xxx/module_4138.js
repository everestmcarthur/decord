// Module ID: 4138
// Function ID: 4139
// Dependencies: [3726, 4139, 3730, 3727]
// Exports: default
  ...
  if ("object" === _typeof(year)) {
    if (null !== year) {
      ...
      if (isNaN(defaultResult1.getTime())) {
        ...
        if (null != year.month) {
          defaultResult2 = module_4139.default(defaultResult1, year.month);
        }
        if (null != year.date) {
          defaultResult2.setDate(module_3730.default(year.date));
        }
        if (null != year.hours) {
          defaultResult2.setHours(module_3730.default(year.hours));
        }
        if (null != year.minutes) {
          defaultResult2.setMinutes(module_3730.default(year.minutes));
        }
        if (null != year.seconds) {
          defaultResult2.setSeconds(module_3730.default(year.seconds));
        }
        if (null != year.milliseconds) {
          defaultResult2.setMilliseconds(module_3730.default(year.milliseconds));
        }
