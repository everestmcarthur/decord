// Module ID: 4471
// Function ID: 4472
// Dependencies: [19, 4467, 1108, 1109, 4472, 4474, 4476, 1102]
...
import parse_mod from "module_4472" /* 4472 */;
import AsyncMode from "AsyncMode" /* 4474 */;
import module_4476_mod from "module_4476" /* 4476 */;
...
let module_4476 = module_4476_mod;
if (module_4476) {
  if (typeof module_4476 === "object") {
    if ("default" in module_4476) {
      module_4476 = module_4476.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F126886 */ function() { ... });
            },
        get() {
              return value;
            },
    ...
    if (closure_1_0) {
      ...
      if (history.staticContext) {
        ...
        const obj4 = {
          ...
          onUpdate(arg0, to) {
                const _location = Component6(1102).createLocation(to.to);
                const obj = Component6(1102);
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4476(fn, displayName);
};
