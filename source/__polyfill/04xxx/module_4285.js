        ...
        constructor(arg0) {
          ...
          if (typeof global !== "function") {
            ...
            if (obj.shouldCatchExceptions(obj1)) {
              ...
              catchPromise = _promise.catch(/* F125036 */ function() { ... });
            }
        ...
        arg0.loadAxo = function loadAxo(arg0) {
          ...
          const f125053 = () => {
            ...
            if (typeof Symbol === "function") {
              let _Symbol = Symbol;
              obj[Symbol.iterator] = /* F125047 */ function() { ... };
            }
            return obj;
          };
      ...
      class Framebus {
        ...
        targetFramesAsWindows() {
          if (this.limitBroadcastToFramesArray) {
            ...
            found = mapped.filter(/* F125060 */ function() { ... });
          } else {
            found = [];
          }
          return found;
        ...
        hasMatchingTargetFrame(arg0) {
          ...
          if (this.limitBroadcastToFramesArray) {
            ...
            tmp = globalThis;
            _Boolean = Boolean;
            return Boolean(result.find(/* F125061 */ function() { ... }));
          } else {
            flag = true;
            return true;
          }
    ...
    (arg0, arg1, arg2) => {
      class ApplePay {
        ...
        _createPaymentRequestSynchronously(arg0) {
          ...
          obj.supportedNetworks = supportedNetworks.map(/* F121293 */ function() { ... });
    ...
    (arg0, arg1, arg2) => {
      class PayPalCheckout {
        ...
        teardown() {
          ...
          catchPromise = _frameServicePromise.catch(/* F121458 */ function() { ... });
    ...
    (arg0, arg1, arg2) => {
      class InlineIframeFramework {
        ...
        _addV1IframeToPage() {
          ...
          _emitResult = this._emit(InlineIframeFramework.events.AUTHENTICATION_IFRAME_AVAILABLE, obj, /* F121504 */ function() { ... });
          return;
        }
    ...
    (arg0, arg1, arg2) => {
      class SongbirdFramework {
        ...
        prepareLookup(arg0) {
          ...
          nextPromise1 = nextPromise.then(() => { ... });
          catchPromise = nextPromise1.catch(/* F121518 */ function() { ... });
