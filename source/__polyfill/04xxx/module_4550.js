// Module ID: 4550
// Function ID: 4551
// Dependencies: [19, 4551, 1108, 1109, 1102, 4554]
...
export const MemoryRouter = Component2(4554).MemoryRouter;
export const Prompt = Component2(4554).Prompt;
export const Redirect = Component2(4554).Redirect;
export const Route = Component2(4554).Route;
export const Router = Component2(4554).Router;
export const StaticRouter = Component2(4554).StaticRouter;
export const Switch = Component2(4554).Switch;
export const generatePath = Component2(4554).generatePath;
export const matchPath = Component2(4554).matchPath;
export const useHistory = Component2(4554).useHistory;
export const useLocation = Component2(4554).useLocation;
export const useParams = Component2(4554).useParams;
export const useRouteMatch = Component2(4554).useRouteMatch;
export const withRouter = Component2(4554).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4554).matchPath(_location.pathname, obj2);
          const obj = Component2(4554);
        }
