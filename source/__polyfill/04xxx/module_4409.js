// Module ID: 4409
// Function ID: 4410
// Dependencies: [32, 19, 4410]
// Exports: useRiveProperty

// Module 4409
import _mod4410 from "module_4410" /* 4410 */;
...
export const useRiveProperty = function useRiveProperty(instance, FillColor, f30757) {
  closure_0 = instance;
  closure_1 = FillColor;
  closure_2 = f30757;
  let tmp = hasOwnProperty(undefined);
  const items = [instance, FillColor];
  const disposableMemo = _mod4410.useDisposableMemo(() => {
    if (closure_0) {
