// Module ID: 4466
// Function ID: 4467
// Dependencies: [19, 4467, 1108, 1109, 1102, 4470]
...
export const MemoryRouter = Component2(4470).MemoryRouter;
export const Prompt = Component2(4470).Prompt;
export const Redirect = Component2(4470).Redirect;
export const Route = Component2(4470).Route;
export const Router = Component2(4470).Router;
export const StaticRouter = Component2(4470).StaticRouter;
export const Switch = Component2(4470).Switch;
export const generatePath = Component2(4470).generatePath;
export const matchPath = Component2(4470).matchPath;
export const useHistory = Component2(4470).useHistory;
export const useLocation = Component2(4470).useLocation;
export const useParams = Component2(4470).useParams;
export const useRouteMatch = Component2(4470).useRouteMatch;
export const withRouter = Component2(4470).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4470).matchPath(_location.pathname, obj2);
          const obj = Component2(4470);
        }
