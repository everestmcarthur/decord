// Module ID: 4407
// Function ID: 4408
// Dependencies: [19, 4403, 1107, 1108, 4408, 4410, 4412, 1101]
...
import parse_mod from "module_4408" /* 4408 */;
import AsyncMode from "AsyncMode" /* 4410 */;
import module_4412_mod from "module_4412" /* 4412 */;
...
let module_4412 = module_4412_mod;
if (module_4412) {
  if (typeof module_4412 === "object") {
    if ("default" in module_4412) {
      module_4412 = module_4412.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F125811 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4412(fn, displayName);
};
