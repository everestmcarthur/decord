// Module ID: 4348
// Function ID: 4349
// Dependencies: [32, 19, 4330, 4343, 4338]
...
const RiveColor2 = tmp(4338);
require = fn;
fn(19).useCallback;
const f30553 = (colorProperty, arg1) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(FillColor, instance) {
  const cResult = c.c(8);
  const tmp4 = _slicedToArray(_mod4343.useRiveProperty(instance, FillColor, f30553), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
