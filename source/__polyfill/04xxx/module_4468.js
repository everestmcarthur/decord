// Module ID: 4468
// Function ID: 4469
// Dependencies: [19, 4469, 1108, 1109, 1102, 4472]
...
export const MemoryRouter = Component2(4472).MemoryRouter;
export const Prompt = Component2(4472).Prompt;
export const Redirect = Component2(4472).Redirect;
export const Route = Component2(4472).Route;
export const Router = Component2(4472).Router;
export const StaticRouter = Component2(4472).StaticRouter;
export const Switch = Component2(4472).Switch;
export const generatePath = Component2(4472).generatePath;
export const matchPath = Component2(4472).matchPath;
export const useHistory = Component2(4472).useHistory;
export const useLocation = Component2(4472).useLocation;
export const useParams = Component2(4472).useParams;
export const useRouteMatch = Component2(4472).useRouteMatch;
export const withRouter = Component2(4472).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4472).matchPath(_location.pathname, obj2);
          const obj = Component2(4472);
        }
