// Module ID: 4382
// Function ID: 4383
// Dependencies: [19, 4371, 4375, 4363]
// Exports: useViewModelInstance

// Module 4382
import ArtboardByIndex from "ArtboardByIndex" /* 4371 */;
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("module_4375").useDisposableMemo(() => {
    if (closure_0) {
      let tmp6 = null != obj;
      if (tmp6) {
