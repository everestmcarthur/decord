// Module ID: 4374
// Function ID: 4375
// Dependencies: [32, 19, 4375]
// Exports: useRiveProperty

// Module 4374
import _mod4375 from "module_4375" /* 4375 */;
...
export const useRiveProperty = function useRiveProperty(instance, FillColor, f30641) {
  closure_0 = instance;
  closure_1 = FillColor;
  closure_2 = f30641;
  let tmp = hasOwnProperty(undefined);
  const items = [instance, FillColor];
  const disposableMemo = _mod4375.useDisposableMemo(() => {
    if (closure_0) {
