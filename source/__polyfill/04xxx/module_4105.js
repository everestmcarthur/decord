// Module ID: 4105
// Function ID: 4106
// Dependencies: [3693, 4106, 3697, 3694]
// Exports: default
  ...
  if ("object" === _typeof(year)) {
    if (null !== year) {
      ...
      if (isNaN(defaultResult1.getTime())) {
        ...
        if (null != year.month) {
          defaultResult2 = module_4106.default(defaultResult1, year.month);
        }
        if (null != year.date) {
          defaultResult2.setDate(module_3697.default(year.date));
        }
        if (null != year.hours) {
          defaultResult2.setHours(module_3697.default(year.hours));
        }
        if (null != year.minutes) {
          defaultResult2.setMinutes(module_3697.default(year.minutes));
        }
        if (null != year.seconds) {
          defaultResult2.setSeconds(module_3697.default(year.seconds));
        }
        if (null != year.milliseconds) {
          defaultResult2.setMilliseconds(module_3697.default(year.milliseconds));
        }
