// Module ID: 4433
// Function ID: 4434
// Dependencies: [19, 4434, 1107, 1108, 1101, 4437]
...
export const MemoryRouter = Component2(4437).MemoryRouter;
export const Prompt = Component2(4437).Prompt;
export const Redirect = Component2(4437).Redirect;
export const Route = Component2(4437).Route;
export const Router = Component2(4437).Router;
export const StaticRouter = Component2(4437).StaticRouter;
export const Switch = Component2(4437).Switch;
export const generatePath = Component2(4437).generatePath;
export const matchPath = Component2(4437).matchPath;
export const useHistory = Component2(4437).useHistory;
export const useLocation = Component2(4437).useLocation;
export const useParams = Component2(4437).useParams;
export const useRouteMatch = Component2(4437).useRouteMatch;
export const withRouter = Component2(4437).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4437).matchPath(_location.pathname, obj2);
          const obj = Component2(4437);
        }
