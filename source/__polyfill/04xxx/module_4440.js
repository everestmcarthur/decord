// Module ID: 4440
// Function ID: 4441
// Dependencies: [19, 4436, 1107, 1108, 4441, 4443, 4445, 1101]
...
import parse_mod from "module_4441" /* 4441 */;
import AsyncMode from "AsyncMode" /* 4443 */;
import module_4445_mod from "module_4445" /* 4445 */;
...
let module_4445 = module_4445_mod;
if (module_4445) {
  if (typeof module_4445 === "object") {
    if ("default" in module_4445) {
      module_4445 = module_4445.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F126073 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4445(fn, displayName);
};
