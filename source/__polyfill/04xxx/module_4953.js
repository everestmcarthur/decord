// Module ID: 4953
// Function ID: 4954
// Dependencies: [109, 19, 17, 21, 4951, 4942, 4935, 4954, 4941, 4957, 4930]

// Module 4953
import _modDef4930 from "module_4930" /* 4930 */;
import _modDef4935 from "module_4935" /* 4935 */;
import styleDefault from "style" /* 4954 */;
...
export default noop.forwardRef(function ScreenStackItem(unstable_sheetFooter, ref) {
  ...
  dependencyMap = flag4.useContext(screenId(4951).RNSScreensRefContext);
  ...
  const effect = obj.useEffect(() => {
    _modDef4935(false, "Dynamically changing header's visibility in modals will result in remounting the screen and losing all local state.");
  ...
  _modDef4935(flag5, "[RNScreens] Using both `blurEffect` and `scrollEdgeEffects` simultaneously may cause overlapping effects.");
  ...
  const items1 = [closure_5(screenId(4942).EdgeInsetApplicationContext.Provider, { value: obj2.useEdgeInsetApplication(flag, flag2, flag3).nextContextValue, children: closure_5(styleDefault, { contentStyle, style: container, stackPresentation, children }) }), , ];
  const merged1 = Object.assign(headerConfig);
  items1[1] = closure_5(screenId(4941).ScreenStackHeaderConfig, {});
  let tmp18Result = "formSheet" === stackPresentation && unstable_sheetFooter;
  if (tmp18Result) {
    const obj5 = { children: unstable_sheetFooter() };
    tmp18Result = tmp18(tmp2(4957).FooterComponent, obj5);
  }
  ...
  return closure_5(_modDef4930, obj6);
});
