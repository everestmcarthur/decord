// Module ID: 4435
// Function ID: 4436
// Dependencies: [19, 4436, 1107, 1108, 1101, 4439]
...
export const MemoryRouter = Component2(4439).MemoryRouter;
export const Prompt = Component2(4439).Prompt;
export const Redirect = Component2(4439).Redirect;
export const Route = Component2(4439).Route;
export const Router = Component2(4439).Router;
export const StaticRouter = Component2(4439).StaticRouter;
export const Switch = Component2(4439).Switch;
export const generatePath = Component2(4439).generatePath;
export const matchPath = Component2(4439).matchPath;
export const useHistory = Component2(4439).useHistory;
export const useLocation = Component2(4439).useLocation;
export const useParams = Component2(4439).useParams;
export const useRouteMatch = Component2(4439).useRouteMatch;
export const withRouter = Component2(4439).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4439).matchPath(_location.pathname, obj2);
          const obj = Component2(4439);
        }
