// Module ID: 4030
// Function ID: 4031
// Dependencies: [3974, 3961, 3728, 3978, 3973, 3891, 3732, 3729, 3733, 4031, 3975, 4032]
// Exports: default

// Module 4030
import throwProtectedError from "throwProtectedError" /* 3975 */;
import parsers from "parsers" /* 4032 */;
...
import dateLongFormatter_mod from "dateLongFormatter" /* 3973 */;
...
if (!module_3891) {
  const obj6 = { default: module_3891 };
  let tmp13 = obj6;
} else {
  tmp13 = module_3891;
}
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("module_3733").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3732.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3732.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4031).DateToSystemTimezoneSetter();
