// Module ID: 4414
// Function ID: 4415
// Dependencies: [32, 19, 4396, 4409, 4404]
...
const RiveColor2 = tmp(4404);
require = fn;
fn(19).useCallback;
const f30916 = (colorProperty, arg1) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(FillColor, instance) {
  const cResult = c.c(8);
  const tmp4 = _slicedToArray(_mod4409.useRiveProperty(instance, FillColor, f30916), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
