// Module ID: 4412
// Function ID: 4413
// Dependencies: [32, 19, 4394, 4407, 4402]
...
const RiveColor2 = tmp(4402);
require = fn;
fn(19).useCallback;
const f30817 = (colorProperty, arg1) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(FillColor, instance) {
  const cResult = c.c(8);
  const tmp4 = _slicedToArray(_mod4407.useRiveProperty(instance, FillColor, f30817), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
