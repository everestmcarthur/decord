// Module ID: 4059
// Function ID: 4060
// Dependencies: [3987, 4009, 4014, 4057, 3811, 4060, 4061, 3974, 3812, 3816]
// Exports: default
...
import cloneObject_mod from "cloneObject" /* 4060 */;
...
if (!module_3974) {
  const obj8 = { default: module_3974 };
  let tmp17 = obj8;
} else {
  tmp17 = module_3974;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_3974.default(defaultResult5) - module_3974.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_3974.default(defaultResult5);
    }
  } else {
