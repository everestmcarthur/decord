        ...
        constructor(arg0) {
          ...
          if (typeof global !== "function") {
            ...
            if (obj.shouldCatchExceptions(obj1)) {
              ...
              catchPromise = _promise.catch(/* F125844 */ function() { ... });
            }
        ...
        arg0.loadAxo = function loadAxo(arg0) {
          ...
          const f125861 = () => {
            ...
            if (typeof Symbol === "function") {
              let _Symbol = Symbol;
              obj[Symbol.iterator] = /* F125855 */ function() { ... };
            }
            return obj;
          };
      ...
      class Framebus {
        ...
        targetFramesAsWindows() {
          if (this.limitBroadcastToFramesArray) {
            ...
            found = mapped.filter(/* F125868 */ function() { ... });
          } else {
            found = [];
          }
          return found;
        ...
        hasMatchingTargetFrame(arg0) {
          ...
          if (this.limitBroadcastToFramesArray) {
            ...
            tmp = globalThis;
            _Boolean = Boolean;
            return Boolean(result.find(/* F125869 */ function() { ... }));
          } else {
            flag = true;
            return true;
          }
    ...
    (arg0, arg1, arg2) => {
      class ApplePay {
        ...
        _createPaymentRequestSynchronously(arg0) {
          ...
          obj.supportedNetworks = supportedNetworks.map(/* F122089 */ function() { ... });
    ...
    (arg0, arg1, arg2) => {
      class PayPalCheckout {
        ...
        teardown() {
          ...
          catchPromise = _frameServicePromise.catch(/* F122254 */ function() { ... });
    ...
    (arg0, arg1, arg2) => {
      class InlineIframeFramework {
        ...
        _addV1IframeToPage() {
          ...
          _emitResult = this._emit(InlineIframeFramework.events.AUTHENTICATION_IFRAME_AVAILABLE, obj, /* F122300 */ function() { ... });
          return;
        }
    ...
    (arg0, arg1, arg2) => {
      class SongbirdFramework {
        ...
        prepareLookup(arg0) {
          ...
          nextPromise1 = nextPromise.then(() => { ... });
          catchPromise = nextPromise1.catch(/* F122314 */ function() { ... });
