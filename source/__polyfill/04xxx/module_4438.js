// Module ID: 4438
// Function ID: 4439
// Dependencies: [19, 4434, 1107, 1108, 4439, 4441, 4443, 1101]
...
import parse_mod from "module_4439" /* 4439 */;
import AsyncMode from "AsyncMode" /* 4441 */;
import module_4443_mod from "module_4443" /* 4443 */;
...
let module_4443 = module_4443_mod;
if (module_4443) {
  if (typeof module_4443 === "object") {
    if ("default" in module_4443) {
      module_4443 = module_4443.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F126082 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4443(fn, displayName);
};
