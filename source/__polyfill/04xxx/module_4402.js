// Module ID: 4402
// Function ID: 4403
// Dependencies: [19, 4403, 1107, 1108, 1101, 4406]
...
export const MemoryRouter = Component2(4406).MemoryRouter;
export const Prompt = Component2(4406).Prompt;
export const Redirect = Component2(4406).Redirect;
export const Route = Component2(4406).Route;
export const Router = Component2(4406).Router;
export const StaticRouter = Component2(4406).StaticRouter;
export const Switch = Component2(4406).Switch;
export const generatePath = Component2(4406).generatePath;
export const matchPath = Component2(4406).matchPath;
export const useHistory = Component2(4406).useHistory;
export const useLocation = Component2(4406).useLocation;
export const useParams = Component2(4406).useParams;
export const useRouteMatch = Component2(4406).useRouteMatch;
export const withRouter = Component2(4406).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4406).matchPath(_location.pathname, obj2);
          const obj = Component2(4406);
        }
