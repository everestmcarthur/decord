// Module ID: 4473
// Function ID: 4474
// Dependencies: [19, 4469, 1108, 1109, 4474, 4476, 4478, 1102]
...
import parse_mod from "module_4474" /* 4474 */;
import AsyncMode from "AsyncMode" /* 4476 */;
...
if (module_4478) {
  if (typeof module_4478 === "object") {
    if ("default" in module_4478) {
      module_4478 = module_4478.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F126362 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4478(fn, displayName);
};
