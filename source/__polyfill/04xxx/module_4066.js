...
const entry = {
  ...
  value: function parse(arg0, arg1) {
    if ("x" === arg1) {
      return _createSuperInternal(4034).parseTimezonePattern(_createSuperInternal(4035).timezonePatterns.basicOptionalMinutes, arg0);
    } else if ("xx" === arg1) {
      return _createSuperInternal(4034).parseTimezonePattern(_createSuperInternal(4035).timezonePatterns.basic, arg0);
    } else if ("xxxx" === arg1) {
      return _createSuperInternal(4034).parseTimezonePattern(_createSuperInternal(4035).timezonePatterns.basicOptionalSeconds, arg0);
    } else if ("xxxxx" === arg1) {
      return _createSuperInternal(4034).parseTimezonePattern(_createSuperInternal(4035).timezonePatterns.extendedOptionalSeconds, arg0);
    } else {
      return _createSuperInternal(4034).parseTimezonePattern(_createSuperInternal(4035).timezonePatterns.extended, arg0);
    }
  }
};
let items = [
