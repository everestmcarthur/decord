// Module ID: 4028
// Function ID: 4029
// Dependencies: [3972, 3959, 3726, 3976, 3971, 3889, 3730, 3727, 3731, 4029, 3973, 4030]
// Exports: default

// Module 4028
import throwProtectedError from "throwProtectedError" /* 3973 */;
import parsers from "parsers" /* 4030 */;
import code_mod from "module_3972" /* 3972 */;
...
import dateLongFormatter_mod from "dateLongFormatter" /* 3971 */;
...
if (!module_3889) {
  const obj6 = { default: module_3889 };
  let tmp13 = obj6;
} else {
  tmp13 = module_3889;
}
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("module_3731").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3730.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3730.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4029).DateToSystemTimezoneSetter();
