...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber, arg3) {
    ...
    if ("c" !== arg1) {
      if ("cc" !== arg1) {
        if ("co" === arg1) {
          return _createSuperInternal(4036).mapValue(ordinalNumber.ordinalNumber(arg0, { unit: "day" }), valueCallback);
        } else if ("ccc" === arg1) {
...
let items = [
  ...
  },
  {
    ...
    value: function set(arg0, arg1, arg2, arg3) {
      const defaultResult = module_4052.default(arg0, arg2, arg3);
