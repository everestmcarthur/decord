...
const entry = {
  ...
  value: function parse(arg0, arg1) {
    if ("R" === arg1) {
      let parseNDigitsSignedResult = _createSuperInternal(4003).parseNDigitsSigned(4, arg0);
    } else {
      parseNDigitsSignedResult = _createSuperInternal(4003).parseNDigitsSigned(arg1.length, arg0);
    }
