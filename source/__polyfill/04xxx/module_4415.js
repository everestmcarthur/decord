// Module ID: 4415
// Function ID: 4416
// Dependencies: [19, 4404, 4408, 4396]
// Exports: useViewModelInstance

// Module 4415
import ArtboardByIndex from "ArtboardByIndex" /* 4404 */;
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("module_4408").useDisposableMemo(() => {
    if (closure_0) {
      let tmp6 = null != obj;
      if (tmp6) {
