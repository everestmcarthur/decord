// Module ID: 4384
// Function ID: 4385
// Dependencies: [19, 4373, 4377, 4365]
// Exports: useViewModelInstance

// Module 4384
import ArtboardByIndex from "ArtboardByIndex" /* 4373 */;
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("module_4377").useDisposableMemo(() => {
    if (closure_0) {
      let tmp6 = null != obj;
      if (tmp6) {
