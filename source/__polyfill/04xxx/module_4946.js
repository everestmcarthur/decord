// Module ID: 4946
// Function ID: 4947
// Dependencies: [109, 19, 17, 21, 4947, 4938]
...
export default noop.forwardRef(function SearchBar(autoCapitalize, ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref(4947).Commands;
  ...
  if (ref(4938).isSearchBarAvailableForCurrentPlatform) {
    const obj = {};
    ...
    obj2.obscureBackground = tmp3(4938).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(4938);
    obj2.hideNavigationBar = tmp3(4938).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
