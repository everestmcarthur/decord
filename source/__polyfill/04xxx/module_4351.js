// Module ID: 4351
// Function ID: 4352
// Dependencies: [19, 4340, 4344, 4332]
// Exports: useViewModelInstance

// Module 4351
import ArtboardByIndex from "ArtboardByIndex" /* 4340 */;
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("module_4344").useDisposableMemo(() => {
    if (closure_0) {
      let tmp6 = null != obj;
      if (tmp6) {
