// Module ID: 4069
// Function ID: 4070
// Dependencies: [3811, 3993, 4054, 3815]
// Exports: default
      ...
      if (NumberResult >= 0) {
        if (NumberResult <= 3) {
          ...
          if (0 !== timezoneOffset) {
            ...
            let str7 = "-";
            const defaultResult6 = obj.default(module_3815.default(absolute / 60), 2);
            if (timezoneOffset < 0) {
              str7 = "+";
            }
          ...
          const combined7 = combined6.concat(module_4054.default(defaultResult.getSeconds(), 2));
