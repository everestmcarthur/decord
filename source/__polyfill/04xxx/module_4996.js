// Module ID: 4996
// Function ID: 4997
// Dependencies: [109, 19, 17, 21, 4984, 4994, 4993, 4997, 4998, 5001, 4983, 5003, 4974]

// Module 4996
import _modDef4974 from "module_4974" /* 4974 */;
import _modDef4993 from "module_4993" /* 4993 */;
import styleDefault from "style" /* 4998 */;
...
export default noop.forwardRef(function ScreenStackItem(arg0, ref) {
  ...
  dependencyMap = flag5.useContext(tmp4(4994).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = tmp4(4997).isIOS26OrHigher;
  }
  ...
  if (screenId(4997).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(tmp4(5001).SafeAreaView, obj5);
  }
  obj4.children = tmp19Result;
  obj3.children = closure_4(styleDefault, obj4);
  const items1 = [closure_4(screenId(4984).EdgeInsetApplicationContext.Provider, obj3), , ];
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(tmp4(5003).FooterComponent, obj7);
  }
  ...
  return closure_4(_modDef4974, obj8);
});
