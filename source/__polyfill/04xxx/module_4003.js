// Module ID: 4003
// Function ID: 4004
// Dependencies: [3935, 3696, 4001, 3999]
...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("Y" === arg1) {
      return _createSuperInternal(4001).mapValue(_createSuperInternal(4001).parseNDigits(4, arg0), valueCallback);
    } else if ("Yo" === arg1) {
      return _createSuperInternal(4001).mapValue(ordinalNumber.ordinalNumber(arg0, { unit: "year" }), valueCallback);
    } else {
      return _createSuperInternal(4001).mapValue(_createSuperInternal(4001).parseNDigits(arg1.length, arg0), valueCallback);
    }
  }
};
let items = [
  ...
  },
  {
    ...
    value: function set(setUTCFullYear, era, isTwoDigitYear, firstWeekContainsDate) {
      if (isTwoDigitYear.isTwoDigitYear) {
        setUTCFullYear.setUTCFullYear(_createSuperInternal(4001).normalizeTwoDigitYear(isTwoDigitYear.year, tmp), 0, firstWeekContainsDate.firstWeekContainsDate);
