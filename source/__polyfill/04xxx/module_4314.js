// Module ID: 4314
// Function ID: 4315
// Dependencies: [17, 4315, 4316]
// Exports: isRuntimeAlive

// Module 4314
import _mod17 from "module_17" /* 17 */;
import _mod4315 from "module_4315" /* 4315 */;
import _mod4316 from "module_4316" /* 4316 */;
...
if (null != installedNitro) {
  ...
  if (installedNitro.version !== _mod4315.version) {
    const _Error2 = Error;
    const version = installedNitro.version;
    const _HermesInternal2 = HermesInternal;
    const error = new Error("Nitro was installed twice: once with native version " + version + " and once with JS version " + _mod4315.version + ". This usually means react-native-nitro-modules exists multiple times in node_modules (e.g. in monorepos or double-linked setups).");
    throw error;
  }
} else {
  try {
    ...
    if (null != installResult) {
      ...
      if (null == installedNitro1) {
        ...
        const moduleNotFoundError = new _mod4316.ModuleNotFoundError(error2);
