// Module ID: 15138
// Function ID: 15139
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8521, 9945]
...
import emptyFunction_mod from "module_9945" /* 9945 */;
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = tmp23(tmp24(8521).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = tmp23(tmp24(8521).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(8521).G, obj3);
      const items1 = [timestampProducer(CircularProgress(8521).Svg, size2), ];
