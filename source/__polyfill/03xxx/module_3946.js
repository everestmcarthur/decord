// Module ID: 3946
// Function ID: 3947
// Dependencies: [3858, 3871, 3695, 3944, 3945, 3941, 3696, 3700]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_3858.default(defaultResult5) - module_3858.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_3858.default(defaultResult5);
    }
  } else {
