// Module ID: 3778
// Function ID: 3779
// Dependencies: [3779, 3780, 3781, 3782, 3783]
...
import date_mod from "module_3783" /* 3783 */;

if (!module_3779) {
  const obj = { default: module_3779 };
  let tmp3 = obj;
} else {
  tmp3 = module_3779;
}
if (!module_3780) {
  const obj2 = { default: module_3780 };
  let tmp5 = obj2;
} else {
  tmp5 = module_3780;
}
if (!module_3781) {
  const obj3 = { default: module_3781 };
  let tmp7 = obj3;
} else {
  tmp7 = module_3781;
}
