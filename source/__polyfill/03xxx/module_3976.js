// Module ID: 3976
// Function ID: 3977
// Dependencies: [3904, 3926, 3931, 3974, 3728, 3977, 3978, 3891, 3729, 3733]
// Exports: default
...
import cloneObject_mod from "cloneObject" /* 3977 */;
...
if (!module_3891) {
  const obj8 = { default: module_3891 };
  let tmp17 = obj8;
} else {
  tmp17 = module_3891;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_3891.default(defaultResult5) - module_3891.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_3891.default(defaultResult5);
    }
  } else {
