// Module ID: 3979
// Function ID: 3980
// Dependencies: [3891, 3904, 3728, 3977, 3978, 3974, 3729, 3733]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_3891.default(defaultResult5) - module_3891.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_3891.default(defaultResult5);
    }
  } else {
