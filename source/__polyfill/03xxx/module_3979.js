...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("L" === arg1) {
      return _createSuperInternal(3971).mapValue(_createSuperInternal(3971).parseNumericPattern(_createSuperInternal(3972).numericPatterns.month, arg0), valueCallback);
    } else if ("LL" === arg1) {
