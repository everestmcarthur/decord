// Module ID: 3965
// Function ID: 3966
// Dependencies: [3909, 3896, 3663, 3913, 3908, 3826, 3667, 3664, 3668, 3966, 3910, 3967]
// Exports: default

// Module 3965
import throwProtectedError from "throwProtectedError" /* 3910 */;
import parsers from "parsers" /* 3967 */;
import code_mod from "module_3909" /* 3909 */;
...
import dateLongFormatter_mod from "dateLongFormatter" /* 3908 */;
...
if (!module_3826) {
  const obj6 = { default: module_3826 };
  let tmp13 = obj6;
} else {
  tmp13 = module_3826;
}
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("module_3668").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3667.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3667.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(3966).DateToSystemTimezoneSetter();
