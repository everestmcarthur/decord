// Module ID: 3944
// Function ID: 3945
// Dependencies: [3856, 3869, 3693, 3942, 3943, 3939, 3694, 3698]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_3856.default(defaultResult5) - module_3856.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_3856.default(defaultResult5);
    }
  } else {
