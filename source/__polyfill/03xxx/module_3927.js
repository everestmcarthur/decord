// Module ID: 3927
// Function ID: 3928
// Dependencies: [3877, 3928, 3695, 3929, 3940, 3858, 3699, 3696, 3941, 3700, 3942]
// Exports: default

// Module 3927
import throwProtectedError from "throwProtectedError" /* 3942 */;
...
import G from "G" /* 3929 */;
import dateLongFormatter_mod from "dateLongFormatter" /* 3940 */;
import module_3858_mod from "module_3858" /* 3858 */;
import module_3699_mod from "module_3699" /* 3699 */;
import requiredArgs_mod from "requiredArgs" /* 3696 */;
import code_mod from "module_3941" /* 3941 */;

const require = globalThis.__r;

let module_3877 = module_3877_mod;
if (!module_3877) {
  const obj = { default: module_3877 };
  let tmp3 = obj;
} else {
  tmp3 = module_3877;
}
...
if (!module_3858) {
  const obj6 = { default: module_3858 };
  let tmp13 = obj6;
} else {
  tmp13 = module_3858;
}
...
if (!module_3699) {
  const obj7 = { default: module_3699 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3699;
}
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("module_3700").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3699.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_3877.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_3858.default(defaultResult3));
