// Module ID: 3802
// Function ID: 3803
// Dependencies: [3803, 3804, 3805, 3806, 3807]
...
import date_mod from "module_3807" /* 3807 */;

if (!module_3803) {
  const obj = { default: module_3803 };
  let tmp3 = obj;
} else {
  tmp3 = module_3803;
}
if (!module_3804) {
  const obj2 = { default: module_3804 };
  let tmp5 = obj2;
} else {
  tmp5 = module_3804;
}
if (!module_3805) {
  const obj3 = { default: module_3805 };
  let tmp7 = obj3;
} else {
  tmp7 = module_3805;
}
