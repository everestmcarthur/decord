// Module ID: 3840
// Function ID: 3841
// Dependencies: [3841, 3842, 3693, 3694, 3697]
// Exports: default
...
export default function add(arg0, years) {
  ...
  if (years) {
    if ("object" === _typeof(years)) {
      let num = 0;
      if (years.years) {
        num = module_3697.default(years.years);
      }
      let num2 = 0;
      if (years.months) {
        num2 = module_3697.default(years.months);
      }
      let num3 = 0;
      if (years.weeks) {
        num3 = module_3697.default(years.weeks);
      }
      let num4 = 0;
      if (years.days) {
        num4 = module_3697.default(years.days);
      }
      let num5 = 0;
      if (years.hours) {
        num5 = module_3697.default(years.hours);
      }
      let num6 = 0;
      if (years.minutes) {
        num6 = module_3697.default(years.minutes);
      }
      let num7 = 0;
      if (years.seconds) {
        num7 = module_3697.default(years.seconds);
      }
      const defaultResult1 = _typeof.default(arg0);
      if (num2) {
        let defaultResult2 = module_3842.default(defaultResult1, num2 + 12 * num);
      } else {
        defaultResult2 = defaultResult1;
      }
      if (num4) {
        let defaultResult3 = module_3841.default(defaultResult2, num4 + 7 * num3);
      } else {
