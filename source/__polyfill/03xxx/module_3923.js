// Module ID: 3923
// Function ID: 3924
// Dependencies: [3825, 3895, 3909, 3896, 3663, 3826, 3664, 3667, 3668]
// Exports: default
...
export default function formatRelative(arg0, arg1, locale) {
  ...
  const defaultResult3 = module_3667.default(num);
  if (locale1.localize) {
    if (locale1.formatLong) {
      if (locale1.formatRelative) {
        ...
        if (isNaN(defaultResult4)) {
          ...
          const defaultResult5 = subMilliseconds.default(defaultResult1, module_3826.default(defaultResult1));
          const obj = { locale: locale1, weekStartsOn: defaultResult3 };
          const obj2 = { locale: locale1, weekStartsOn: defaultResult3 };
          return format.default(defaultResult1, locale1.formatRelative(str5, defaultResult5, subMilliseconds.default(defaultResult2, module_3826.default(defaultResult2)), obj), obj2);
        }
      } else {
