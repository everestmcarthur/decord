// Module ID: 3958
// Function ID: 3959
// Dependencies: [3908, 3959, 3726, 3960, 3971, 3889, 3730, 3727, 3972, 3731, 3973]
// Exports: default
...
if (!module_3730) {
  const obj7 = { default: module_3730 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3730;
}
...
export default function format(arg0, arg1, locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3730.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_3908.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_3889.default(defaultResult3));
