// Module ID: 3813
// Function ID: 3814
// Dependencies: [3814, 3663, 3667, 3664, 3815, 3816]
// Exports: default
...
if (!module_3816) {
  const obj6 = { default: module_3816 };
  let tmp13 = obj6;
} else {
  tmp13 = module_3816;
}
...
export default function addBusinessDays(arg0, arg1) {
  ...
  let obj2 = module_3814;
  let defaultResult2 = module_3814.default(defaultResult1);
  ...
  if (isNaN(defaultResult3)) {
    ...
    if (absolute > 0) {
      do {
        ...
        let tmp9 = module_3814;
        diff = absolute;
        if (!module_3814.default(defaultResult1)) {
          diff = absolute - 1;
        }
        absolute = diff;
        obj2 = tmp9;
    ...
    if (defaultResult2) {
      if (module_3816.default(defaultResult1)) {
        let num6 = -1;
        if (num3 < 0) {
          num6 = 2;
        }
      ...
      if (module_3815.default(defaultResult1)) {
        let num7 = -2;
        if (num3 < 0) {
          num7 = 1;
        }
