...
export default function formatRFC7231(arg0) {
  if (arguments.length < 1) {
    ...
    if (module_3845.default(defaultResult)) {
      ...
      const defaultResult1 = module_3906.default(defaultResult.getUTCDate(), 2);
      const defaultResult2 = module_3906.default(defaultResult.getUTCHours(), 2);
      const concat = "".concat;
      const defaultResult3 = module_3906.default(defaultResult.getUTCMinutes(), 2);
      ...
      return combined5.concat(module_3906.default(defaultResult.getUTCSeconds(), 2), " GMT");
    } else {
