// Module ID: 3955
// Function ID: 3956
// Dependencies: [3857, 3927, 3941, 3928, 3695, 3858, 3696, 3699, 3700]
// Exports: default
...
export default function formatRelative(arg0, arg1, locale) {
  ...
  const defaultResult3 = module_3699.default(num);
  if (locale1.localize) {
    if (locale1.formatLong) {
      if (locale1.formatRelative) {
        ...
        if (isNaN(defaultResult4)) {
          ...
          const defaultResult5 = subMilliseconds.default(defaultResult1, module_3858.default(defaultResult1));
          const obj = { locale: locale1, weekStartsOn: defaultResult3 };
          const obj2 = { locale: locale1, weekStartsOn: defaultResult3 };
          return format.default(defaultResult1, locale1.formatRelative(str5, defaultResult5, subMilliseconds.default(defaultResult2, module_3858.default(defaultResult2)), obj), obj2);
        }
      } else {
