// Module ID: 3997
// Function ID: 3998
// Dependencies: [3941, 3928, 3695, 3945, 3940, 3858, 3699, 3696, 3700, 3998, 3942, 3999]
// Exports: default

// Module 3997
import throwProtectedError from "throwProtectedError" /* 3942 */;
import parsers from "parsers" /* 3999 */;
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3699.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3699.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(3998).DateToSystemTimezoneSetter();
