// Module ID: 3921
// Function ID: 3922
// Dependencies: [3663, 3845, 3906, 3667]
// Exports: default
      ...
      if (NumberResult >= 0) {
        if (NumberResult <= 3) {
          ...
          if (0 !== timezoneOffset) {
            ...
            let str7 = "-";
            const defaultResult6 = obj.default(module_3667.default(absolute / 60), 2);
            if (timezoneOffset < 0) {
              str7 = "+";
            }
          ...
          const combined7 = combined6.concat(module_3906.default(defaultResult.getSeconds(), 2));
