// Module ID: 3914
// Function ID: 3915
// Dependencies: [3826, 3839, 3663, 3912, 3913, 3909, 3664, 3668]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_3826.default(defaultResult5) - module_3826.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_3826.default(defaultResult5);
    }
  } else {
