// Module ID: 3740
// Function ID: 3741
// Dependencies: [3741, 3742, 3743, 3744, 3745]
...
import date_mod from "module_3745" /* 3745 */;

if (!module_3741) {
  const obj = { default: module_3741 };
  let tmp3 = obj;
} else {
  tmp3 = module_3741;
}
if (!module_3742) {
  const obj2 = { default: module_3742 };
  let tmp5 = obj2;
} else {
  tmp5 = module_3742;
}
if (!module_3743) {
  const obj3 = { default: module_3743 };
  let tmp7 = obj3;
} else {
  tmp7 = module_3743;
}
