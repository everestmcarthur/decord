// Module ID: 3986
// Function ID: 3987
// Dependencies: [3888, 3958, 3972, 3959, 3726, 3889, 3727, 3730, 3731]
// Exports: default
...
export default function formatRelative(arg0, arg1, locale) {
  ...
  const defaultResult3 = module_3730.default(num);
  if (locale1.localize) {
    if (locale1.formatLong) {
      if (locale1.formatRelative) {
        ...
        if (isNaN(defaultResult4)) {
          ...
          const defaultResult5 = subMilliseconds.default(defaultResult1, module_3889.default(defaultResult1));
          const obj = { locale: locale1, weekStartsOn: defaultResult3 };
          const obj2 = { locale: locale1, weekStartsOn: defaultResult3 };
          return format.default(defaultResult1, locale1.formatRelative(str5, defaultResult5, subMilliseconds.default(defaultResult2, module_3889.default(defaultResult2)), obj), obj2);
        }
      } else {
