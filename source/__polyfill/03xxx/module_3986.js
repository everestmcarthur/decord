// Module ID: 3986
// Function ID: 3987
// Dependencies: [3728, 3910, 3971, 3732]
// Exports: default
      ...
      if (NumberResult >= 0) {
        if (NumberResult <= 3) {
          ...
          if (0 !== timezoneOffset) {
            ...
            let str7 = "-";
            const defaultResult6 = obj.default(module_3732.default(absolute / 60), 2);
            if (timezoneOffset < 0) {
              str7 = "+";
            }
          ...
          const combined7 = combined6.concat(module_3971.default(defaultResult.getSeconds(), 2));
