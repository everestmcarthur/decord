...
export default function formatISO9075(arg0, format) {
  if (arguments.length < 1) {
    ...
    if (module_3845.default(defaultResult)) {
      format = undefined;
      if (null != format) {
      ...
      let str13 = "";
      if ("time" !== StringResult1) {
        const defaultResult1 = module_3906.default(defaultResult.getDate(), 2);
        const concat3 = "".concat;
        const combined = "".concat(module_3906.default(defaultResult.getFullYear(), 4));
        const combined1 = combined.concat(str10);
        const combined2 = combined1.concat(module_3906.default(defaultResult.getMonth() + 1, 2));
        const combined3 = combined2.concat(str10);
        str13 = combined3.concat(defaultResult1);
        const defaultResult2 = module_3906.default(defaultResult.getMonth() + 1, 2);
      }
      let combined10 = str13;
      if ("date" !== StringResult1) {
        const defaultResult3 = module_3906.default(defaultResult.getHours(), 2);
        let str14 = " ";
        const defaultResult4 = module_3906.default(defaultResult.getMinutes(), 2);
        if ("" === str13) {
          str14 = "";
        }
        const concat = "".concat;
        ...
        combined10 = combined9.concat(module_3906.default(defaultResult.getSeconds(), 2));
        const defaultResult5 = module_3906.default(defaultResult.getSeconds(), 2);
      }
      return combined10;
    } else {
