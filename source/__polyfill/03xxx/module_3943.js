// Module ID: 3943
// Function ID: 3944
// Dependencies: [3871, 3893, 3898, 3941, 3695, 3944, 3945, 3858, 3696, 3700]
// Exports: default
...
import cloneObject_mod from "cloneObject" /* 3944 */;
...
if (!module_3858) {
  const obj8 = { default: module_3858 };
  let tmp17 = obj8;
} else {
  tmp17 = module_3858;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_3858.default(defaultResult5) - module_3858.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_3858.default(defaultResult5);
    }
  } else {
