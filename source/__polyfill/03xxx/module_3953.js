// Module ID: 3953
// Function ID: 3954
// Dependencies: [3855, 3925, 3939, 3926, 3693, 3856, 3694, 3697, 3698]
// Exports: default
...
export default function formatRelative(arg0, arg1, locale) {
  ...
  const defaultResult3 = module_3697.default(num);
  if (locale1.localize) {
    if (locale1.formatLong) {
      if (locale1.formatRelative) {
        ...
        if (isNaN(defaultResult4)) {
          ...
          const defaultResult5 = subMilliseconds.default(defaultResult1, module_3856.default(defaultResult1));
          const obj = { locale: locale1, weekStartsOn: defaultResult3 };
          const obj2 = { locale: locale1, weekStartsOn: defaultResult3 };
          return format.default(defaultResult1, locale1.formatRelative(str5, defaultResult5, subMilliseconds.default(defaultResult2, module_3856.default(defaultResult2)), obj), obj2);
        }
      } else {
