// Module ID: 3953
// Function ID: 3954
// Dependencies: [3695, 3877, 3938, 3699]
// Exports: default
      ...
      if (NumberResult >= 0) {
        if (NumberResult <= 3) {
          ...
          if (0 !== timezoneOffset) {
            ...
            let str7 = "-";
            const defaultResult6 = obj.default(module_3699.default(absolute / 60), 2);
            if (timezoneOffset < 0) {
              str7 = "+";
            }
          ...
          const combined7 = combined6.concat(module_3938.default(defaultResult.getSeconds(), 2));
