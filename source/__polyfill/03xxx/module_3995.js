// Module ID: 3995
// Function ID: 3996
// Dependencies: [3939, 3926, 3693, 3943, 3938, 3856, 3697, 3694, 3698, 3996, 3940, 3997]
// Exports: default

// Module 3995
import throwProtectedError from "throwProtectedError" /* 3940 */;
import parsers from "parsers" /* 3997 */;
import code_mod from "module_3939" /* 3939 */;
...
import dateLongFormatter_mod from "dateLongFormatter" /* 3938 */;
...
if (!module_3856) {
  const obj6 = { default: module_3856 };
  let tmp13 = obj6;
} else {
  tmp13 = module_3856;
}
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("module_3698").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3697.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3697.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(3996).DateToSystemTimezoneSetter();
