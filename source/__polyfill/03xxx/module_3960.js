// Module ID: 3960
// Function ID: 3961
// Dependencies: [3910, 3961, 3728, 3962, 3973, 3891, 3732, 3729, 3974, 3733, 3975]
// Exports: default
...
if (!module_3732) {
  const obj7 = { default: module_3732 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3732;
}
...
export default function format(arg0, arg1, locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3732.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_3910.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_3891.default(defaultResult3));
