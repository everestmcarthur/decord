// Module ID: 3871
// Function ID: 3872
// Dependencies: [3728, 3872]
// Exports: default

// Module 3871
import _mod3872 from "module_3872" /* 3872 */;
import module_3728_mod from "module_3728" /* 3728 */;

let module_3728 = module_3728_mod;
if (!module_3728) {
...
let closure_4 = {
  lastWeek: function lastWeekFormat(arg0, arg1, arg2) {
    const toDateResult = _mod3872.toDate(arg0);
    const uTCDay = toDateResult.getUTCDay();
    if (module_3728.default(toDateResult, arg1, arg2)) {
      let text = `${"'\u0443 " + tmp2} о' p`;
    } else {
      if (0 !== uTCDay) {
        if (3 !== uTCDay) {
