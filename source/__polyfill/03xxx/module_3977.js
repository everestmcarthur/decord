// Module ID: 3977
// Function ID: 3978
// Dependencies: [3889, 3902, 3726, 3975, 3976, 3972, 3727, 3731]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_3889.default(defaultResult5) - module_3889.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_3889.default(defaultResult5);
    }
  } else {
