// Module ID: 3925
// Function ID: 3926
// Dependencies: [3875, 3926, 3693, 3927, 3938, 3856, 3697, 3694, 3939, 3698, 3940]
// Exports: default
...
if (!module_3697) {
  const obj7 = { default: module_3697 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3697;
}
...
export default function format(arg0, arg1, locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3697.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_3875.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_3856.default(defaultResult3));
