...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    return _createSuperInternal(3971).parseNumericPattern(_createSuperInternal(3972).numericPatterns.dayOfYear, arg0);
  }
};
let items = [
  entry,
  {
    ...
    value: function validate(getUTCFullYear, arg1) {
      ...
      let tmp2 = arg1 >= 1;
      if (_createSuperInternal(3971).isLeapYearIndex(uTCFullYear)) {
        if (tmp2) {
          tmp2 = arg1 <= 366;
        }
        let tmp3 = tmp2;
