// Module ID: 3974
// Function ID: 3975
// Dependencies: [3902, 3924, 3929, 3972, 3726, 3975, 3976, 3889, 3727, 3731]
// Exports: default
...
import cloneObject_mod from "cloneObject" /* 3975 */;
...
if (!module_3889) {
  const obj8 = { default: module_3889 };
  let tmp17 = obj8;
} else {
  tmp17 = module_3889;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_3889.default(defaultResult5) - module_3889.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_3889.default(defaultResult5);
    }
  } else {
