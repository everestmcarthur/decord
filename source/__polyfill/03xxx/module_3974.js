...
const entry = {
  ...
  value: function parse(arg0, arg1) {
    if ("R" === arg1) {
      let parseNDigitsSignedResult = _createSuperInternal(3971).parseNDigitsSigned(4, arg0);
    } else {
      parseNDigitsSignedResult = _createSuperInternal(3971).parseNDigitsSigned(arg1.length, arg0);
    }
