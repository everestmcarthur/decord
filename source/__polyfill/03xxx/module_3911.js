// Module ID: 3911
// Function ID: 3912
// Dependencies: [3839, 3861, 3866, 3909, 3663, 3912, 3913, 3826, 3664, 3668]
// Exports: default
...
import cloneObject_mod from "cloneObject" /* 3912 */;
...
if (!module_3826) {
  const obj8 = { default: module_3826 };
  let tmp17 = obj8;
} else {
  tmp17 = module_3826;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_3826.default(defaultResult5) - module_3826.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_3826.default(defaultResult5);
    }
  } else {
