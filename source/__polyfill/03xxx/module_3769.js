// Module ID: 3769
// Function ID: 3770
// Dependencies: [3770, 3771, 3772, 3773, 3774]
...
import date_mod from "module_3774" /* 3774 */;

if (!module_3770) {
  const obj = { default: module_3770 };
  let tmp3 = obj;
} else {
  tmp3 = module_3770;
}
if (!module_3771) {
  const obj2 = { default: module_3771 };
  let tmp5 = obj2;
} else {
  tmp5 = module_3771;
}
if (!module_3772) {
  const obj3 = { default: module_3772 };
  let tmp7 = obj3;
} else {
  tmp7 = module_3772;
}
