// Module ID: 3941
// Function ID: 3942
// Dependencies: [3869, 3891, 3896, 3939, 3693, 3942, 3943, 3856, 3694, 3698]
// Exports: default
...
import cloneObject_mod from "cloneObject" /* 3942 */;
...
if (!module_3856) {
  const obj8 = { default: module_3856 };
  let tmp17 = obj8;
} else {
  tmp17 = module_3856;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_3856.default(defaultResult5) - module_3856.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_3856.default(defaultResult5);
    }
  } else {
