// Module ID: 3895
// Function ID: 3896
// Dependencies: [3845, 3896, 3663, 3897, 3908, 3826, 3667, 3664, 3909, 3668, 3910]
// Exports: default
...
if (!module_3667) {
  const obj7 = { default: module_3667 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3667;
}
...
export default function format(arg0, arg1, locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3667.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_3845.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_3826.default(defaultResult3));
