// Module ID: 13014
// Function ID: 13015
// Dependencies: [5, 12976, 12948, 12992, 13013]
          ...
          if (0 === c6) {
            ...
            const obj10 = {
              value: (function shouldQueue(arg0, arg1, arg2) {
                      const result = createStore(12992).envelopeContainsItemType(arg0, ["client_report"]);
                      let tmp2 = !result;
                      if (!result) {
            ...
            if (arg0 === 1) {
              ...
              closure_130_3 = createStore(13013).parseRetryAfterHeader(closure_130_2.headers["retry-after"]);
              const obj5 = createStore(13013);
            }
          } else {
            if (6 === tmp6) {
              if (arg0 === 1) {
