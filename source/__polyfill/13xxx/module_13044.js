// Module ID: 13044
// Function ID: 13045
// Dependencies: [12944, 12947, 12949, 12975, 12953, 12976, 12948, 13045, 12962, 12982, 12983]
...
import COUNTER_METRIC_TYPE from "COUNTER_METRIC_TYPE" /* 13045 */;
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    ...
    let rootSpan;
    if (activeSpan) {
      rootSpan = tmp3(12953).getRootSpan(activeSpan);
      const tmp3Result = tmp3(12953);
    }
    let description = rootSpan;
    if (rootSpan) {
      description = tmp3(12953).spanToJSON(rootSpan).description;
      const tmp3Result3 = tmp3(12953);
    }
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("module_12962").timestampInSeconds();
      c4 = timestampInSecondsResult;
      const obj = require("module_12962");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("module_12982").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
