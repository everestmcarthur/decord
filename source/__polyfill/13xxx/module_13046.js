// Module ID: 13046
// Function ID: 13047
// Dependencies: [5, 12936, 12939, 12940, 12968, 12954, 12964, 12988, 12967, 12985, 12974, 12955]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(12967).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(12985);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(12985);
        ...
        closure_0(12967).withScope((setContext) => {
