// Module ID: 13102
// Function ID: 13103
// Dependencies: [13103, 13083, 13104, 13063, 13067, 13039, 13096]
...
export const createTransport = function createTransport(bufferSize, arg1) {
  ...
  if (arg2 === undefined) {
    ...
    promiseBuffer = require("module_13103").makePromiseBuffer(num);
    let obj = require("module_13103");
  }
  closure_3 = {};
  return {
    send(arg0) {
      ...
      bufferSize(dependencyMap[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = _mod13083.envelopeItemTypeToDataCategory(arg1);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: _mod13083.serializeEnvelope(dependencyMap) };
          return dependencyMap(obj).then((statusCode) => {
            ...
            if (DEBUG_BUILD) {
              DEBUG_BUILD = items(13067).DEBUG_BUILD;
            }
            if (DEBUG_BUILD) {
              const logger = items(13039).logger;
              const _HermesInternal = HermesInternal;
              logger.warn("Sentry responded with status code " + statusCode.statusCode + " to sent event.");
            }
            closure_3 = items(13104).updateRateLimits(closure_3, statusCode);
            return statusCode;
          }, (arg0) => {
            if (typeof recordEnvelopeLoss === "function") {
              const network_error = "network_error";
              closure_0(13083).forEachEnvelopeItem(dependencyMap, (arg0, arg1) => {
                if ("event" === arg1) {
                  const _Array = Array;
                  let tmp4;
                  if (Array.isArray(arg0)) {
          ...
          if (arg0 instanceof _mod13096.SentryError) {
            ...
            if (typeof recordEnvelopeLoss === "function") {
              ...
              tmp(13083).forEachEnvelopeItem(closure_1, (arg0, arg1) => {
                if ("event" === arg1) {
                  const _Array = Array;
                  let tmp4;
                  if (Array.isArray(arg0)) {
              ...
              const tmpResult = tmp(13083);
              return tmp(13063).resolvedSyncPromise({});
            } else {
              throw new TypeError("Trying to call a non-function");
            }
          } else {
