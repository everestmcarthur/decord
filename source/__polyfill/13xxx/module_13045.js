// Module ID: 13045
// Function ID: 13046
// Dependencies: [718, 12936, 12939, 12940, 12954, 12964, 12968, 12972, 13022, 12945, 12974, 12955, 12973, 13011, 12957, 12953, 12947]
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod13011.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(12947).isInstanceOf(headers, Request);
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(12947).isInstanceOf(headers, Headers);
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod12972.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12957).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12957);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(12957).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(13022).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(13022);
    }
    const activeSpan = setHttpStatus(12945).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(12955).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(12955).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(12974).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(12974);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12972);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12973).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12945);
  }
};
