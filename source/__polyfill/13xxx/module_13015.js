// Module ID: 13015
// Function ID: 13016
// Dependencies: [5, 12992, 12995, 13002]
...
function eventFromEnvelope(arg0, arg1) {
  closure_0 = arg1;
  _mod12992.forEachEnvelopeItem(arg0, (arg0, arg1) => {
  ...
  return (arg0) => {
    ...
    function getTransport(arg0, arg1) {
      ...
      if (value) {
        ...
        const dsnFromStringResult = _mod12995.dsnFromString(arg0);
        if (dsnFromStringResult) {
          let merged = tunnel;
          const envelopeEndpointWithUrlEncodedAuth = tmp4(13002).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, tunnel.tunnel);
          let tmp9 = tunnel;
          let obj3 = {};
          if (arg1) {
      ...
      return (async (arg0, value) => {
        const mapped = v3({
          ...
          getEvent(arg0) {
            ...
            dependencyMap(12992).forEachEnvelopeItem(dependencyMap, () => { ... });
        ...
        await Promise.all(arr3.map((item) => {
          ...
          return obj.send(dependencyMap(12992).createEnvelope(tmp4, 12992));
        }));
        return value[0];
      })();
    };
