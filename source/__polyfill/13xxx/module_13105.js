// Module ID: 13105
// Function ID: 13106
// Dependencies: [5, 13067, 13039, 13083, 13104]
          ...
          if (0 === c6) {
            ...
            const obj10 = {
              value: (function shouldQueue(arg0, arg1, arg2) {
                      const result = createStore(13083).envelopeContainsItemType(arg0, ["client_report"]);
                      let tmp2 = !result;
                      if (!result) {
            ...
            if (arg0 === 1) {
              ...
              closure_130_3 = createStore(13104).parseRetryAfterHeader(closure_130_2.headers["retry-after"]);
              const obj5 = createStore(13104);
            }
          } else {
            if (6 === tmp6) {
              if (arg0 === 1) {
