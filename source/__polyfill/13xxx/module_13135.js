// Module ID: 13135
// Function ID: 13136
// Dependencies: [13035, 13038, 13040, 13066, 13044, 13067, 13039, 13136, 13053, 13073, 13074]
...
import COUNTER_METRIC_TYPE from "COUNTER_METRIC_TYPE" /* 13136 */;
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    ...
    let rootSpan;
    if (activeSpan) {
      rootSpan = tmp3(13044).getRootSpan(activeSpan);
      const tmp3Result = tmp3(13044);
    }
    let description = rootSpan;
    if (rootSpan) {
      description = tmp3(13044).spanToJSON(rootSpan).description;
      const tmp3Result3 = tmp3(13044);
    }
    ...
    const globalSingleton = _mod13040.getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("module_13053").timestampInSeconds();
      c4 = timestampInSecondsResult;
      const obj = require("module_13053");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("module_13073").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
        return closure_0(name[10]).handleCallbackErrors(() => fn(), () => {

        }, () => {
          const timestampInSecondsResult = _mod13053.timestampInSeconds();
