// Module ID: 13022
// Function ID: 13023
// Dependencies: [12922, 12925, 12927, 12953, 12931, 12954, 12926, 13023, 12940, 12960, 12961]
...
import COUNTER_METRIC_TYPE from "COUNTER_METRIC_TYPE" /* 13023 */;
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    ...
    let rootSpan;
    if (activeSpan) {
      rootSpan = tmp3(12931).getRootSpan(activeSpan);
      const tmp3Result = tmp3(12931);
    }
    let description = rootSpan;
    if (rootSpan) {
      description = tmp3(12931).spanToJSON(rootSpan).description;
      const tmp3Result3 = tmp3(12931);
    }
    ...
    const globalSingleton = _mod12927.getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("module_12940").timestampInSeconds();
      c4 = timestampInSecondsResult;
      const obj = require("module_12940");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("module_12960").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
        return closure_0(name[10]).handleCallbackErrors(() => fn(), () => {

        }, () => {
          const timestampInSecondsResult = _mod12940.timestampInSeconds();
