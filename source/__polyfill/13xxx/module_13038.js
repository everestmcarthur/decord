// Module ID: 13038
// Function ID: 13039
// Dependencies: [32, 5, 12925, 13039, 12933, 12928, 12941, 12934]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod12925;
      obj2.endTimestamp = 1000 * _mod12941.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12925.addHandler("fetch-body-resolved", arg0);
  _mod12925.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(12933).fill(closure_0(12928).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12925);
                    obj5.endTimestamp = 1000 * stack(12941).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12941);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12925);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12941).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(12941);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(12934);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(12933).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(12933);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_12925").addHandler("fetch", arg0);
  let obj = require("module_12925");
  require("module_12925").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod12933.fill(_mod12928.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
