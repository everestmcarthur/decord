// Module ID: 13038
// Function ID: 13039
// Dependencies: [5, 12928, 12931, 12932, 12960, 12946, 12956, 12980, 12959, 12977, 12966, 12947]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(12959).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(12977);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(12977);
        ...
        closure_0(12959).withScope((setContext) => {
