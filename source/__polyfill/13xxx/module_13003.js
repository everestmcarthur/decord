// Module ID: 13003
// Function ID: 13004
// Dependencies: [32, 5, 12890, 13004, 12898, 12893, 12906, 12899]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod12890;
      obj2.endTimestamp = 1000 * _mod12906.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12890.addHandler("fetch-body-resolved", arg0);
  _mod12890.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(12898).fill(closure_0(12893).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12890);
                    obj5.endTimestamp = 1000 * stack(12906).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12906);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12890);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12906).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(12906);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(12899);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(12898).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(12898);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_12890").addHandler("fetch", arg0);
  let obj = require("module_12890");
  require("module_12890").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod12898.fill(_mod12893.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
