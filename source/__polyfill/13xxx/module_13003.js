// Module ID: 13003
// Function ID: 13004
// Dependencies: [32, 41, 42, 12995, 12976, 12948, 13002, 12959, 12955, 12971, 12972, 13004, 12991, 12992, 12975, 12997, 12984, 13005, 12988, 13006, 12953]
...
const entry = {
  ...
  value: function captureException(arg0, arg1, arg2) {
    const self = this;
    closure_1 = arg2;
    const uuid4Result = BaseClient(12959).uuid4();
    const obj = BaseClient(12959);
...
let items = [
  entry,
  {
    ...
    value: function captureMessage(arg0, arg1, arg2, arg3) {
      const self = this;
      closure_1 = arg3;
      const obj = { event_id: BaseClient(12959).uuid4() };
      const merged = Object.assign(arg2);
      const obj2 = BaseClient(12959);
      let StringResult = arg0;
      if (!obj3.isParameterizedString(arg0)) {
        const _String = String;
        StringResult = String(arg0);
      }
      obj3 = BaseClient(12955);
  ...
  },
  {
    ...
    value: function captureSession(release) {
      if (typeof release.release !== "string") {
        if (BaseClient(12976).DEBUG_BUILD) {
          const logger = tmp(12948).logger;
        ...
        BaseClient(12971).updateSession(release, { init: false });
        const obj = BaseClient(12971);
      }
    }
  },
  {
  ...
  },
  {
    ...
    value: function flush(arg0) {
      ...
      if (_transport) {
        ...
        nextPromise = BaseClient(12972).resolvedSyncPromise(true);
        const obj = BaseClient(12972);
      }
      return nextPromise;
    }
  },
  ...
  },
  {
    ...
    value: function addIntegration(arg0) {
      BaseClient(13004).setupIntegration(this, arg0, this._integrations);
      if (!this._integrations[arg0.name]) {
        const items = [arg0];
        const result = BaseClient(13004).afterSetupIntegrations(this, items);
        const tmpResult = BaseClient(13004);
      }
    }
  },
  {
    ...
    value: function sendEvent(arg0) {
      ...
      let eventEnvelope = BaseClient(12991).createEventEnvelope(arg0, self._dsn, self._options._metadata, self._options.tunnel);
      for (const item10025 of tmp3) {
        let obj3 = BaseClient(12992);
        let obj4 = BaseClient(12992);
  ...
  },
  {
    ...
    value: function sendSession(arg0) {
      this.sendEnvelope(BaseClient(12991).createSessionEnvelope(arg0, this._dsn, this._options._metadata, this._options.tunnel));
    }
  },
  {
    ...
    value: function recordDroppedEvent(arg0, arg1, num) {
      ...
      if (this._options.sendClientReports) {
        ...
        if (BaseClient(12976).DEBUG_BUILD) {
          const logger = tmp6(12948).logger;
          let str3 = "";
          if (num2 > 1) {
  ...
  },
  {
    ...
    value: function sendEnvelope(arg0) {
      ...
      if (BaseClient(12976).DEBUG_BUILD) {
        let logger = tmp2(12948).logger;
        logger.error("Transport disabled");
      }
      nextPromise = BaseClient(12972).resolvedSyncPromise({});
    }
  },
  {
    ...
    value: function _setupIntegrations() {
      ...
      this._integrations = BaseClient(13004).setupIntegrations(this, integrations);
      const obj = BaseClient(13004);
      const result = BaseClient(13004).afterSetupIntegrations(this, integrations);
    }
  },
  {
    ...
    value: function _updateSessionFromEvent(status, level) {
      ...
      if (tmp9) {
        ...
        const self = this;
        obj3.errors = errors;
        BaseClient(12971).updateSession(status, obj3);
  ...
  },
  {
    ...
    value: function _isClientDoneProcessing(arg0) {
      const self = this;
      closure_0 = arg0;
      return new BaseClient(12972).SyncPromise((arg0) => {
        closure_0 = arg0;
        c1 = 0;
    ...
    value: function _prepareEvent(type, integrations) {
      ...
      return currentScope(self[15]).prepareEvent(options, type, integrations, currentScope, self, isolationScope).then((contexts) => {
        if (null === contexts) {
          ...
          const obj = { trace: BaseClient(12975).getTraceContextFromScope(currentScope) };
          const merged = Object.assign(contexts.contexts);
          contexts.contexts = obj;
          const obj2 = BaseClient(12975);
          const obj4 = { dynamicSamplingContext: BaseClient(12984).getDynamicSamplingContextFromScope(self, currentScope) };
  ...
  },
  {
    ...
    value: function _processEvent(type, arg1, arg2) {
      ...
      if (undefined !== sampleRate) {
        const parseSampleRateResult = str(12988).parseSampleRate(sampleRate);
        let obj = str(12988);
      }
      if (undefined === type) {
        if (typeof parseSampleRateResult === "number") {
          ...
          if (Math.random() > parseSampleRateResult) {
            ...
            let sentryError = new str(13005).SentryError("Discarding event because it's not included in the random sample (sampling rate = " + sampleRate + ")", "log");
            return str(12972).rejectedSyncPromise(sentryError);
          }
        }
      }
      str = "replay";
      ...
      let nextPromise = self._prepareEvent(type, arg1, arg2, type.sdkProcessingMetadata || {}.capturedSpanIsolationScope).then((result) => {
        if (null === result) {
          ...
          let sentryError = new BaseClient(13005).SentryError("An event processor returned `null`, will not send event.", "log");
          throw sentryError;
        } else {
          if (data.data) {
          ...
          if (obj.isThenable(promise)) {
            let nextPromise = promise.then((result) => {
              if (!obj.isPlainObject(result)) {
                if (null !== result) {
                  const sentryError = new str(13005).SentryError(combined);
                  throw sentryError;
                }
              }
              return result;
            }, (arg0) => {
              const sentryError = new str(13005).SentryError("" + closure_0 + " rejected with " + arg0);
              throw sentryError;
            });
          } else {
            nextPromise = promise;
            if (!obj2.isPlainObject(promise)) {
              nextPromise = promise;
              if (null !== promise) {
                const sentryError1 = new BaseClient(13005).SentryError(combined);
                throw sentryError1;
              }
            }
            obj2 = BaseClient(12955);
          }
          return nextPromise;
        }
      });
      return self._prepareEvent(type, arg1, arg2, type.sdkProcessingMetadata || {}.capturedSpanIsolationScope).then((result) => {
        ...
        if (null === sdkProcessingMetadata) {
          ...
          const _HermesInternal = HermesInternal;
          const sentryError = new BaseClient(13005).SentryError("" + closure_6 + " returned `null`, will not send event.", "log");
          throw sentryError;
        } else {
          if (session) {
        ...
        if (originalException instanceof BaseClient(13005).SentryError) {
          throw originalException;
        } else {
          const obj = { data: { __sentry__: true }, originalException };
          self.captureException(originalException, obj);
          const _HermesInternal = HermesInternal;
          const sentryError = new tmp(13005).SentryError("Event processing pipeline threw an error, original event will not be sent. Details have been sent as a new event.\nReason: " + originalException);
          throw sentryError;
        }
        tmp = BaseClient;
      });
  ...
  },
  {
    ...
    value: function _flushOutcomes() {
      ...
      if (0 !== _clearOutcomesResult.length) {
        const DEBUG_BUILD = tmp(12976).DEBUG_BUILD;
        if (self._dsn) {
          if (DEBUG_BUILD) {
            const logger4 = tmp(12948).logger;
            logger4.log("Sending outcomes:", _clearOutcomesResult);
          }
          let tunnel = self._options.tunnel;
          if (tunnel) {
            tunnel = tmp(12995).dsnToString(self._dsn);
            const tmpResult2 = tmp(12995);
          }
          self.sendEnvelope(tmp(13006).createClientReportEnvelope(_clearOutcomesResult, tunnel));
          const tmpResult = tmp(13006);
        } else if (DEBUG_BUILD) {
