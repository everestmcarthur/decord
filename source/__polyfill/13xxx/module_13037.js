// Module ID: 13037
// Function ID: 13038
// Dependencies: [718, 12928, 12931, 12932, 12946, 12956, 12960, 12964, 13014, 12937, 12966, 12947, 12965, 13003, 12949, 12945, 12939]
...
import "module_12931";
import consoleSandbox from "module_12932" /* 12932 */;
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod13003.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(12939).isInstanceOf(headers, Request);
        const tmpResult = tmp(12939);
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(12939).isInstanceOf(headers, Headers);
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod12964.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12949).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12949);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(12949).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(13014).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(13014);
    }
    const activeSpan = setHttpStatus(12937).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(12947).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(12947).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(12966).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(12966);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12964);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12965).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12937);
  }
};
