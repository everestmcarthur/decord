// Module ID: 13054
// Function ID: 13055
// Dependencies: [5, 12944, 12947, 12948, 12976, 12962, 12972, 12996, 12975, 12993, 12982, 12963]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(12975).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(12993);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(12993);
        ...
        closure_0(12975).withScope((setContext) => {
