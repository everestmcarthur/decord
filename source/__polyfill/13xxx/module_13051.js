// Module ID: 13051
// Function ID: 13052
// Dependencies: [32, 5, 12938, 13052, 12946, 12941, 12954, 12947]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod12938;
      obj2.endTimestamp = 1000 * _mod12954.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12938.addHandler("fetch-body-resolved", arg0);
  _mod12938.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(12946).fill(closure_0(12941).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12938);
                    obj5.endTimestamp = 1000 * stack(12954).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12954);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12938);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12954).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(12954);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(12947);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(12946).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(12946);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_12938").addHandler("fetch", arg0);
  let obj = require("module_12938");
  require("module_12938").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod12946.fill(_mod12941.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
