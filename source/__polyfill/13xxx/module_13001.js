// Module ID: 13001
// Function ID: 13002
// Dependencies: [32, 5, 12888, 13002, 12896, 12891, 12904, 12897]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod12888;
      obj2.endTimestamp = 1000 * _mod12904.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12888.addHandler("fetch-body-resolved", arg0);
  _mod12888.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(12896).fill(closure_0(12891).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12888);
                    obj5.endTimestamp = 1000 * stack(12904).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12904);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12888);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12904).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(12904);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(12897);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(12896).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(12896);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_12888").addHandler("fetch", arg0);
  let obj = require("module_12888");
  require("module_12888").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod12896.fill(_mod12891.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
