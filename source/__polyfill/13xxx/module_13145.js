// Module ID: 13145
// Function ID: 13146
// Dependencies: [5, 13035, 13038, 13039, 13067, 13053, 13063, 13087, 13066, 13084, 13073, 13054]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(13066).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(13084);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(13084);
        ...
        closure_0(13066).withScope((setContext) => {
