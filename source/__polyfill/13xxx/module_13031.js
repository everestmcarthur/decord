// Module ID: 13031
// Function ID: 13032
// Dependencies: [718, 12922, 12925, 12926, 12940, 12950, 12954, 12958, 13008, 12931, 12960, 12941, 12959, 12997, 12943, 12939, 12933]
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod12997.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(12933).isInstanceOf(headers, Request);
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(12933).isInstanceOf(headers, Headers);
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod12958.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12943).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12943);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(12943).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(13008).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(13008);
    }
    const activeSpan = setHttpStatus(12931).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(12941).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(12941).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(12960).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(12960);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12958);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12959).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12931);
  }
};
