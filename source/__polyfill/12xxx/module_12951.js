// Module ID: 12951
// Function ID: 12952
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12891, 12906, 12888, 12952, 12916, 12919, 12920, 12892, 12945, 12903, 12953, 12914, 12897, 12928, 12947]
...
_inherits(ServerRuntimeClient, _mod12947.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(12952).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(12952);
    return ServerRuntimeClient(12916).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12916);
      return obj.resolvedSyncPromise(ServerRuntimeClient(12952).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12919).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12919);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(12945).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12920).DEBUG_BUILD) {
        const logger = tmp2(12892).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12953);
          ...
          if (ServerRuntimeClient(12920).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12892).logger;
          ...
          if (ServerRuntimeClient(12920).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12892).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(12903).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12914)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(12897).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(12897);
        } else {
          spanToTraceContextResult = tmp(12919).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(12919);
        }
        const tmpResult4 = ServerRuntimeClient(12928);
        if (_getSpanForScopeResult) {
