// Module ID: 12940
// Function ID: 12941
// Dependencies: [12941, 12939]

// Module 12940
import GLOBAL_OBJ from "module_12941" /* 12941 */;

const require = globalThis.__r;

function consoleSandbox(fn) {
  if ("console" in console(12941).GLOBAL_OBJ) {
    console = console(12941).GLOBAL_OBJ.console;
    dependencyMap = {};
...
export const logger = GLOBAL_OBJ.getGlobalSingleton("logger", function makeLogger() {
  ...
  if (require("module_12939").DEBUG_BUILD) {
