// Module ID: 12999
// Function ID: 13000
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12939, 12954, 12936, 13000, 12964, 12967, 12968, 12940, 12993, 12951, 13001, 12962, 12945, 12976, 12995]
...
_inherits(ServerRuntimeClient, _mod12995.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(13000).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(13000);
    return ServerRuntimeClient(12964).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12964);
      return obj.resolvedSyncPromise(ServerRuntimeClient(13000).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12967).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12967);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(12993).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12968).DEBUG_BUILD) {
        const logger = tmp2(12940).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(13001);
          ...
          if (ServerRuntimeClient(12968).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12940).logger;
          ...
          if (ServerRuntimeClient(12968).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12940).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(12951).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12962)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(12945).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(12945);
        } else {
          spanToTraceContextResult = tmp(12967).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(12967);
        }
        const tmpResult4 = ServerRuntimeClient(12976);
        if (_getSpanForScopeResult) {
