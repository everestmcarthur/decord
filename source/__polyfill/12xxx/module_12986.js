// Module ID: 12986
// Function ID: 12987
// Dependencies: [12976, 12953, 12948]
...
export const logSpanEnd = function logSpanEnd(spanContext) {
  if (_mod12976.DEBUG_BUILD) {
    const spanToJSONResult = tmp(12953).spanToJSON(spanContext);
...
export const logSpanStart = function logSpanStart(spanContext) {
  if (_mod12976.DEBUG_BUILD) {
    ...
    const spanIsSampledResult = tmp(12953).spanIsSampled(spanContext);
    ...
    if (rootSpan !== spanContext) {
      ...
      ({ op: op2, description: description2 } = tmp(12953).spanToJSON(rootSpan));
      ...
      const spanToJSONResult1 = tmp(12953).spanToJSON(rootSpan);
    }
    const logger = tmp(12948).logger;
