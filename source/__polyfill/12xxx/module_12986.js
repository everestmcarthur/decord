// Module ID: 12986
// Function ID: 12987
// Dependencies: [12886, 12889, 12891, 12917, 12895, 12918, 12890, 12987, 12904, 12924, 12925]
...
import COUNTER_METRIC_TYPE from "COUNTER_METRIC_TYPE" /* 12987 */;
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    ...
    let rootSpan;
    if (activeSpan) {
      rootSpan = tmp3(12895).getRootSpan(activeSpan);
      const tmp3Result = tmp3(12895);
    }
    let description = rootSpan;
    if (rootSpan) {
      description = tmp3(12895).spanToJSON(rootSpan).description;
      const tmp3Result3 = tmp3(12895);
    }
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("module_12904").timestampInSeconds();
      c4 = timestampInSecondsResult;
      const obj = require("module_12904");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("module_12924").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
        return closure_0(name[10]).handleCallbackErrors(() => fn(), () => {

        }, () => {
          const timestampInSecondsResult = _mod12904.timestampInSeconds();
