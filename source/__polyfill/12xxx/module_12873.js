// Module ID: 12873
// Function ID: 12874
// Dependencies: [12866, 12867, 12874, 12875, 12876]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(12874).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(12874);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod12875.htmlTreeAsString(arg0);
      const tmp2Result = _mod12875;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod12876.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod12876.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod12866.DEBUG_BUILD) {
        const logger = tmp7(12867).logger;
        const _HermesInternal = HermesInternal;
