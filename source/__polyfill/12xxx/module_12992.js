// Module ID: 12992
// Function ID: 12993
// Dependencies: [5, 12954, 12926, 12970, 12991]
          ...
          if (0 === c6) {
            ...
            const obj10 = {
              value: (function shouldQueue(arg0, arg1, arg2) {
                      const result = createStore(12970).envelopeContainsItemType(arg0, ["client_report"]);
                      let tmp2 = !result;
                      if (!result) {
            ...
            if (arg0 === 1) {
              ...
              closure_130_3 = createStore(12991).parseRetryAfterHeader(closure_130_2.headers["retry-after"]);
              const obj5 = createStore(12991);
            }
          } else {
            if (6 === tmp6) {
              if (arg0 === 1) {
