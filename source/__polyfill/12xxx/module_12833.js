// Module ID: 12833
// Function ID: 12834
// Dependencies: [12826, 12827, 12834, 12835, 12836]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(12834).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(12834);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod12835.htmlTreeAsString(arg0);
      const tmp2Result = _mod12835;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod12836.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod12836.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod12826.DEBUG_BUILD) {
        const logger = tmp7(12827).logger;
        const _HermesInternal = HermesInternal;
