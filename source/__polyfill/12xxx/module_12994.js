// Module ID: 12994
// Function ID: 12995
// Dependencies: [5, 12971, 12974, 12981]
...
function eventFromEnvelope(arg0, arg1) {
  closure_0 = arg1;
  _mod12971.forEachEnvelopeItem(arg0, (arg0, arg1) => {
  ...
  return (arg0) => {
    ...
    function getTransport(arg0, arg1) {
      ...
      if (value) {
        ...
        const dsnFromStringResult = _mod12974.dsnFromString(arg0);
        if (dsnFromStringResult) {
          let merged = tunnel;
          const envelopeEndpointWithUrlEncodedAuth = tmp4(12981).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, tunnel.tunnel);
          let tmp9 = tunnel;
          let obj3 = {};
          if (arg1) {
      ...
      return (async (arg0, value) => {
        const mapped = v3({
          ...
          getEvent(arg0) {
            ...
            dependencyMap(12971).forEachEnvelopeItem(dependencyMap, () => { ... });
        ...
        await Promise.all(arr3.map((item) => {
          ...
          return obj.send(dependencyMap(12971).createEnvelope(tmp4, 12971));
        }));
        return value[0];
      })();
    };
