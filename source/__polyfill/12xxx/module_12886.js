// Module ID: 12886
// Function ID: 12887
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12826, 12841, 12823, 12887, 12851, 12854, 12855, 12827, 12880, 12838, 12888, 12849, 12832, 12863, 12882]
...
_inherits(ServerRuntimeClient, _mod12882.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(12887).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(12887);
    return ServerRuntimeClient(12851).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12851);
      return obj.resolvedSyncPromise(ServerRuntimeClient(12887).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12854).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12854);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(12880).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12855).DEBUG_BUILD) {
        const logger = tmp2(12827).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12888);
          ...
          if (ServerRuntimeClient(12855).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12827).logger;
          ...
          if (ServerRuntimeClient(12855).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12827).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(12838).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12849)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(12832).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(12832);
        } else {
          spanToTraceContextResult = tmp(12854).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(12854);
        }
        const tmpResult4 = ServerRuntimeClient(12863);
        if (_getSpanForScopeResult) {
