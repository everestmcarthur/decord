// Module ID: 12932
// Function ID: 12933
// Dependencies: [718, 12823, 12826, 12827, 12841, 12851, 12855, 12859, 12909, 12832, 12861, 12842, 12860, 12898, 12844, 12840, 12834]
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod12898.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(12834).isInstanceOf(headers, Request);
        const tmpResult = tmp(12834);
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(12834).isInstanceOf(headers, Headers);
        const tmpResult2 = tmp(12834);
      }
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod12859.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12844).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12844);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(12844).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(12909).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12909);
    }
    const activeSpan = setHttpStatus(12832).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(12842).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(12842).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(12861).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(12861);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12859);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12860).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12832);
  }
};
