// Module ID: 12932
// Function ID: 12933
// Dependencies: [12925, 12926, 12933, 12934, 12935]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(12933).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(12933);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod12925.DEBUG_BUILD) {
        const logger = tmp7(12926).logger;
        const _HermesInternal = HermesInternal;
