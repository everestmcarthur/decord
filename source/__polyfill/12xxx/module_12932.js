// Module ID: 12932
// Function ID: 12933
// Dependencies: [12933, 12931]

// Module 12932
import GLOBAL_OBJ from "module_12933" /* 12933 */;

const require = globalThis.__r;

function consoleSandbox(fn) {
  if ("console" in console(12933).GLOBAL_OBJ) {
    console = console(12933).GLOBAL_OBJ.console;
    dependencyMap = {};
...
export const logger = GLOBAL_OBJ.getGlobalSingleton("logger", function makeLogger() {
  ...
  if (require("module_12931").DEBUG_BUILD) {
