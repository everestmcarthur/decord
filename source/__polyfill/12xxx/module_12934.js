// Module ID: 12934
// Function ID: 12935
// Dependencies: [5, 12911, 12914, 12921]
    ...
    function getTransport(arg0, arg1) {
      ...
      if (value) {
        ...
        if (dsnFromStringResult) {
          let merged = tunnel;
          const envelopeEndpointWithUrlEncodedAuth = tmp4(12921).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, tunnel.tunnel);
          let tmp9 = tunnel;
          let obj3 = {};
          if (arg1) {
