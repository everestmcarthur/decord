// Module ID: 12888
// Function ID: 12889
// Dependencies: [12889, 12890, 12893]
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (_mod12889.DEBUG_BUILD) {
          const logger = tmp19(12890).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12893).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12893);
        }
      }
    }
