// Module ID: 12979
// Function ID: 12980
// Dependencies: [718, 12975, 12980, 12981, 12953, 12962, 12970, 12963, 12948, 12965, 12976, 12982]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod12965.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod12962.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod12965.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
