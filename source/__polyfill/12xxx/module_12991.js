// Module ID: 12991
// Function ID: 12992
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12931, 12946, 12928, 12992, 12956, 12959, 12960, 12932, 12985, 12943, 12993, 12954, 12937, 12968, 12987]
...
_inherits(ServerRuntimeClient, _mod12987.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(12992).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(12992);
    return ServerRuntimeClient(12956).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12956);
      return obj.resolvedSyncPromise(ServerRuntimeClient(12992).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12959).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12959);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(12985).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12960).DEBUG_BUILD) {
        const logger = tmp2(12932).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12993);
          ...
          if (ServerRuntimeClient(12960).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12932).logger;
          ...
          if (ServerRuntimeClient(12960).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12932).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(12943).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12954)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(12937).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(12937);
        } else {
          spanToTraceContextResult = tmp(12959).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(12959);
        }
        const tmpResult4 = ServerRuntimeClient(12968);
        if (_getSpanForScopeResult) {
