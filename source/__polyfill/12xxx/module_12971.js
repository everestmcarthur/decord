// Module ID: 12971
// Function ID: 12972
// Dependencies: [718, 12967, 12972, 12973, 12945, 12954, 12962, 12955, 12940, 12957, 12968, 12974]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod12957.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod12954.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod12957.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
