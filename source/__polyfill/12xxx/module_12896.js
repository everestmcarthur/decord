// Module ID: 12896
// Function ID: 12897
// Dependencies: [12889, 12890, 12897, 12898, 12899]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(12897).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(12897);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod12898.htmlTreeAsString(arg0);
      const tmp2Result = _mod12898;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod12899.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod12899.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod12889.DEBUG_BUILD) {
        const logger = tmp7(12890).logger;
        const _HermesInternal = HermesInternal;
