// Module ID: 12996
// Function ID: 12997
// Dependencies: [5, 12886, 12889, 12890, 12918, 12904, 12914, 12938, 12917, 12935, 12924, 12905]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(12917).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(12935);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(12935);
        ...
        closure_0(12917).withScope((setContext) => {
