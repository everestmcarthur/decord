// Module ID: 12998
// Function ID: 12999
// Dependencies: [5, 12960, 12932, 12976, 12997]
          ...
          if (0 === c6) {
            ...
            const obj10 = {
              value: (function shouldQueue(arg0, arg1, arg2) {
                      const result = createStore(12976).envelopeContainsItemType(arg0, ["client_report"]);
                      let tmp2 = !result;
                      if (!result) {
            ...
            if (arg0 === 1) {
              ...
              closure_130_3 = createStore(12997).parseRetryAfterHeader(closure_130_2.headers["retry-after"]);
              const obj5 = createStore(12997);
            }
          } else {
            if (6 === tmp6) {
              if (arg0 === 1) {
