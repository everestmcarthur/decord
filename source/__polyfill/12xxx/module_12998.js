// Module ID: 12998
// Function ID: 12999
// Dependencies: [5, 12888, 12891, 12892, 12920, 12906, 12916, 12940, 12919, 12937, 12926, 12907]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(12919).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(12937);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(12937);
        ...
        closure_0(12919).withScope((setContext) => {
