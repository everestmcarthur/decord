// Module ID: 12958
// Function ID: 12959
// Dependencies: [718, 12954, 12959, 12960, 12932, 12941, 12949, 12942, 12927, 12944, 12955, 12961]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod12944.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod12941.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod12944.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
