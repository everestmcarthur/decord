// Module ID: 12958
// Function ID: 12959
// Dependencies: [5, 12920, 12892, 12936, 12957]
          ...
          if (0 === c6) {
            ...
            const obj10 = {
              value: (function shouldQueue(arg0, arg1, arg2) {
                      const result = createStore(12936).envelopeContainsItemType(arg0, ["client_report"]);
                      let tmp2 = !result;
                      if (!result) {
            ...
            if (arg0 === 1) {
              ...
              closure_130_3 = createStore(12957).parseRetryAfterHeader(closure_130_2.headers["retry-after"]);
              const obj5 = createStore(12957);
            }
          } else {
            if (6 === tmp6) {
              if (arg0 === 1) {
