// Module ID: 12954
// Function ID: 12955
// Dependencies: [12947, 12948, 12955, 12956, 12957]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(12955).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(12955);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod12956.htmlTreeAsString(arg0);
      const tmp2Result = _mod12956;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod12957.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod12957.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod12947.DEBUG_BUILD) {
        const logger = tmp7(12948).logger;
        const _HermesInternal = HermesInternal;
