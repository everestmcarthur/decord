// Module ID: 12930
// Function ID: 12931
// Dependencies: [12931, 12932, 12935]
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (_mod12931.DEBUG_BUILD) {
          const logger = tmp19(12932).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12935).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12935);
        }
      }
    }
