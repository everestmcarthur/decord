// Module ID: 12938
// Function ID: 12939
// Dependencies: [32, 5, 12825, 12939, 12833, 12828, 12841, 12834]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod12825;
      obj2.endTimestamp = 1000 * _mod12841.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12825.addHandler("fetch-body-resolved", arg0);
  _mod12825.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(12833).fill(closure_0(12828).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12825);
                    obj5.endTimestamp = 1000 * stack(12841).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12841);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12825);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12841).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(12841);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(12834);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(12833).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(12833);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_12825").addHandler("fetch", arg0);
  let obj = require("module_12825");
  require("module_12825").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod12833.fill(_mod12828.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
