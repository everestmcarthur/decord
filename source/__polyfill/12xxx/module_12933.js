// Module ID: 12933
// Function ID: 12934
// Dependencies: [12926, 12927, 12934, 12935, 12936]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(12934).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(12934);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod12935.htmlTreeAsString(arg0);
      const tmp2Result = _mod12935;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod12936.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod12936.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod12926.DEBUG_BUILD) {
        const logger = tmp7(12927).logger;
        const _HermesInternal = HermesInternal;
