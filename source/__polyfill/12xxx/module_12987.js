// Module ID: 12987
// Function ID: 12988
// Dependencies: [32, 41, 42, 12979, 12960, 12932, 12986, 12943, 12939, 12955, 12956, 12988, 12975, 12976, 12959, 12981, 12968, 12989, 12972, 12990, 12937]
...
const entry = {
  ...
  value: function captureException(arg0, arg1, arg2) {
    const self = this;
    closure_1 = arg2;
    const uuid4Result = BaseClient(12943).uuid4();
    const obj = BaseClient(12943);
...
let items = [
  entry,
  {
    ...
    value: function captureMessage(arg0, arg1, arg2, arg3) {
      const self = this;
      closure_1 = arg3;
      const obj = { event_id: BaseClient(12943).uuid4() };
      const merged = Object.assign(arg2);
      const obj2 = BaseClient(12943);
      let StringResult = arg0;
      if (!obj3.isParameterizedString(arg0)) {
        const _String = String;
        StringResult = String(arg0);
      }
      obj3 = BaseClient(12939);
  ...
  },
  {
    ...
    value: function captureSession(release) {
      if (typeof release.release !== "string") {
        if (BaseClient(12960).DEBUG_BUILD) {
          const logger = tmp(12932).logger;
        ...
        BaseClient(12955).updateSession(release, { init: false });
        const obj = BaseClient(12955);
      }
    }
  },
  {
  ...
  },
  {
    ...
    value: function flush(arg0) {
      ...
      if (_transport) {
        ...
        nextPromise = BaseClient(12956).resolvedSyncPromise(true);
        const obj = BaseClient(12956);
      }
      return nextPromise;
    }
  },
  ...
  },
  {
    ...
    value: function addIntegration(arg0) {
      BaseClient(12988).setupIntegration(this, arg0, this._integrations);
      if (!this._integrations[arg0.name]) {
        const items = [arg0];
        const result = BaseClient(12988).afterSetupIntegrations(this, items);
        const tmpResult = BaseClient(12988);
      }
    }
  },
  {
    ...
    value: function sendEvent(arg0) {
      ...
      let eventEnvelope = BaseClient(12975).createEventEnvelope(arg0, self._dsn, self._options._metadata, self._options.tunnel);
      for (const item10025 of tmp3) {
        let obj3 = BaseClient(12976);
        let obj4 = BaseClient(12976);
  ...
  },
  {
    ...
    value: function sendSession(arg0) {
      this.sendEnvelope(BaseClient(12975).createSessionEnvelope(arg0, this._dsn, this._options._metadata, this._options.tunnel));
    }
  },
  {
  ...
  },
  {
    ...
    value: function sendEnvelope(arg0) {
      ...
      if (BaseClient(12960).DEBUG_BUILD) {
        let logger = tmp2(12932).logger;
        logger.error("Transport disabled");
      }
      nextPromise = BaseClient(12956).resolvedSyncPromise({});
    }
  },
  {
    ...
    value: function _setupIntegrations() {
      ...
      this._integrations = BaseClient(12988).setupIntegrations(this, integrations);
      const obj = BaseClient(12988);
      const result = BaseClient(12988).afterSetupIntegrations(this, integrations);
    }
  },
  {
    ...
    value: function _updateSessionFromEvent(status, level) {
      ...
      if (tmp9) {
        ...
        const self = this;
        obj3.errors = errors;
        BaseClient(12955).updateSession(status, obj3);
  ...
  },
  {
    ...
    value: function _isClientDoneProcessing(arg0) {
      const self = this;
      closure_0 = arg0;
      return new BaseClient(12956).SyncPromise((arg0) => {
        closure_0 = arg0;
        c1 = 0;
    ...
    value: function _prepareEvent(type, integrations) {
      ...
      return currentScope(self[15]).prepareEvent(options, type, integrations, currentScope, self, isolationScope).then((contexts) => {
        if (null === contexts) {
          ...
          const obj = { trace: BaseClient(12959).getTraceContextFromScope(currentScope) };
          const merged = Object.assign(contexts.contexts);
          contexts.contexts = obj;
          const obj2 = BaseClient(12959);
          const obj4 = { dynamicSamplingContext: BaseClient(12968).getDynamicSamplingContextFromScope(self, currentScope) };
  ...
  },
  {
    ...
    value: function _processEvent(type, arg1, arg2) {
      ...
      if (undefined !== sampleRate) {
        const parseSampleRateResult = str(12972).parseSampleRate(sampleRate);
        let obj = str(12972);
      }
      if (undefined === type) {
        if (typeof parseSampleRateResult === "number") {
          ...
          if (Math.random() > parseSampleRateResult) {
            ...
            let sentryError = new str(12989).SentryError("Discarding event because it's not included in the random sample (sampling rate = " + sampleRate + ")", "log");
            return str(12956).rejectedSyncPromise(sentryError);
          }
        }
      }
      str = "replay";
      ...
      let nextPromise = self._prepareEvent(type, arg1, arg2, type.sdkProcessingMetadata || {}.capturedSpanIsolationScope).then((result) => {
        if (null === result) {
          ...
          let sentryError = new BaseClient(12989).SentryError("An event processor returned `null`, will not send event.", "log");
          throw sentryError;
        } else {
          if (data.data) {
          ...
          if (obj.isThenable(promise)) {
            let nextPromise = promise.then((result) => {
              if (!obj.isPlainObject(result)) {
                if (null !== result) {
                  const sentryError = new str(12989).SentryError(combined);
                  throw sentryError;
                }
              }
              return result;
            }, (arg0) => {
              const sentryError = new str(12989).SentryError("" + closure_0 + " rejected with " + arg0);
              throw sentryError;
            });
          } else {
            nextPromise = promise;
            if (!obj2.isPlainObject(promise)) {
              nextPromise = promise;
              if (null !== promise) {
                const sentryError1 = new BaseClient(12989).SentryError(combined);
                throw sentryError1;
              }
            }
            obj2 = BaseClient(12939);
          }
          return nextPromise;
        }
      });
      return self._prepareEvent(type, arg1, arg2, type.sdkProcessingMetadata || {}.capturedSpanIsolationScope).then((result) => {
        ...
        if (null === sdkProcessingMetadata) {
          ...
          const _HermesInternal = HermesInternal;
          const sentryError = new BaseClient(12989).SentryError("" + closure_6 + " returned `null`, will not send event.", "log");
          throw sentryError;
        } else {
          if (session) {
        ...
        if (originalException instanceof BaseClient(12989).SentryError) {
          throw originalException;
        } else {
          const obj = { data: { __sentry__: true }, originalException };
          self.captureException(originalException, obj);
          const _HermesInternal = HermesInternal;
          const sentryError = new tmp(12989).SentryError("Event processing pipeline threw an error, original event will not be sent. Details have been sent as a new event.\nReason: " + originalException);
          throw sentryError;
        }
        tmp = BaseClient;
      });
  ...
  },
  {
    ...
    value: function _flushOutcomes() {
      ...
      if (0 !== _clearOutcomesResult.length) {
        const DEBUG_BUILD = tmp(12960).DEBUG_BUILD;
        if (self._dsn) {
          if (DEBUG_BUILD) {
            const logger4 = tmp(12932).logger;
            logger4.log("Sending outcomes:", _clearOutcomesResult);
          }
          let tunnel = self._options.tunnel;
          if (tunnel) {
            tunnel = tmp(12979).dsnToString(self._dsn);
            const tmpResult2 = tmp(12979);
          }
          self.sendEnvelope(tmp(12990).createClientReportEnvelope(_clearOutcomesResult, tunnel));
