// Module ID: 12988
// Function ID: 12989
// Dependencies: [12888, 12891, 12893, 12919, 12897, 12920, 12892, 12989, 12906, 12926, 12927]
...
import COUNTER_METRIC_TYPE from "COUNTER_METRIC_TYPE" /* 12989 */;
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    ...
    let rootSpan;
    if (activeSpan) {
      rootSpan = tmp3(12897).getRootSpan(activeSpan);
      const tmp3Result = tmp3(12897);
    }
    let description = rootSpan;
    if (rootSpan) {
      description = tmp3(12897).spanToJSON(rootSpan).description;
      const tmp3Result3 = tmp3(12897);
    }
    ...
    const globalSingleton = _mod12893.getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("module_12906").timestampInSeconds();
      c4 = timestampInSecondsResult;
      const obj = require("module_12906");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("module_12926").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
        return closure_0(name[10]).handleCallbackErrors(() => fn(), () => {

        }, () => {
          const timestampInSecondsResult = _mod12906.timestampInSeconds();
