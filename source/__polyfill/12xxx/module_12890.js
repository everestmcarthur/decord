// Module ID: 12890
// Function ID: 12891
// Dependencies: [12891, 12889]

// Module 12890
import GLOBAL_OBJ from "module_12891" /* 12891 */;

const require = globalThis.__r;

function consoleSandbox(fn) {
  if ("console" in console(12891).GLOBAL_OBJ) {
    console = console(12891).GLOBAL_OBJ.console;
    dependencyMap = {};
...
export const logger = GLOBAL_OBJ.getGlobalSingleton("logger", function makeLogger() {
  ...
  if (require("module_12889").DEBUG_BUILD) {
