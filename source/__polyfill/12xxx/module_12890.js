// Module ID: 12890
// Function ID: 12891
// Dependencies: [12891, 12871, 12892, 12851, 12855, 12827, 12884]
...
export const createTransport = function createTransport(bufferSize, arg1) {
  ...
  if (arg2 === undefined) {
    ...
    promiseBuffer = require("module_12891").makePromiseBuffer(num);
    let obj = require("module_12891");
  }
  closure_3 = {};
  return {
    send(arg0) {
        ...
        return recordEnvelopeLoss.add(() => {
          ...
          if (arg0 instanceof _mod12884.SentryError) {
            ...
            if (typeof recordEnvelopeLoss === "function") {
              ...
              tmp(12871).forEachEnvelopeItem(closure_1, (arg0, arg1) => {
                if ("event" === arg1) {
                  const _Array = Array;
                  let tmp4;
                  if (Array.isArray(arg0)) {
              ...
              const tmpResult = tmp(12871);
              return tmp(12851).resolvedSyncPromise({});
            } else {
              throw new TypeError("Trying to call a non-function");
            }
          } else {
