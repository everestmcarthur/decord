// Module ID: 12941
// Function ID: 12942
// Dependencies: [12903, 12906, 12919, 12942, 12943, 12929, 12901, 12944, 12937, 12913]
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = _mod12901.truncate(environment.message, num);
  }
  value = iter;
  ...
  if (value) {
    iter.value = _mod12901.truncate(iter.value, num);
  }
  ...
  if (url) {
    request.url = _mod12901.truncate(request.url, num);
  }
}
function applyDebugIds(exception, arg1) {
  const filenameToDebugIdMap = _mod12944.getFilenameToDebugIdMap(arg1);
  try {
