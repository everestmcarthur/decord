// Module ID: 12858
// Function ID: 12859
// Dependencies: [718, 12854, 12859, 12860, 12832, 12841, 12849, 12842, 12827, 12844, 12855, 12861]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod12844.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod12841.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod12844.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
