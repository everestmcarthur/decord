// Module ID: 12925
// Function ID: 12926
// Dependencies: [12926, 12927, 12930]
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (_mod12926.DEBUG_BUILD) {
          const logger = tmp19(12927).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12930).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12930);
        }
      }
    }
