// Module ID: 12970
// Function ID: 12971
// Dependencies: [32, 12927, 12971, 12932, 12973]
...
export const createAttachmentEnvelopeItem = function createAttachmentEnvelopeItem(data) {
  if (typeof data.data === "string") {
    ...
    if (!_mod12927.GLOBAL_OBJ.__SENTRY__) {
      const _TextEncoder = TextEncoder;
      const encoder = new TextEncoder();
      let encodeResult = encoder.encode(data);
    }
    __SENTRY__ = __SENTRY__(12927).GLOBAL_OBJ.__SENTRY__;
    ...
    const items = [_mod12932.dropUndefinedKeys(obj3), data1];
    return items;
  }
};
...
export const createEventEnvelopeHeaders = function createEventEnvelopeHeaders(event_id, sdk, arg2, arg3) {
  ...
  let tmp4 = arg2 && arg3;
  if (tmp4) {
    const obj3 = { dsn: _mod12973.dsnToString(arg3) };
    tmp4 = obj3;
  }
  ...
  if (event_id.sdkProcessingMetadata && event_id.sdkProcessingMetadata.dynamicSamplingContext) {
    ...
    obj4.trace = _mod12932.dropUndefinedKeys(obj6);
    tmp8 = obj4;
  }
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    function readJson() {
      ...
      if (_mod12927.GLOBAL_OBJ.__SENTRY__) {
        if (tmp3(12927).GLOBAL_OBJ.__SENTRY__.decodePolyfill) {
          const __SENTRY__ = tmp3(12927).GLOBAL_OBJ.__SENTRY__;
    ...
    let encodePolyfill = dependencyMap;
    if (!require("module_12927").GLOBAL_OBJ.__SENTRY__) {
      const _TextEncoder = TextEncoder;
      const encoder = new TextEncoder();
  ...
  function append(json) {
    if (typeof sum === "string") {
      if (typeof json === "string") {
        ...
        if (_mod12927.GLOBAL_OBJ.__SENTRY__) {
          if (tmp14(12927).GLOBAL_OBJ.__SENTRY__.encodePolyfill) {
            const __SENTRY__2 = tmp14(12927).GLOBAL_OBJ.__SENTRY__;
