// Module ID: 12957
// Function ID: 12958
// Dependencies: [718, 12953, 12958, 12959, 12931, 12940, 12948, 12941, 12926, 12943, 12954, 12960]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod12943.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod12940.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod12943.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
