// Module ID: 12957
// Function ID: 12958
// Dependencies: [5, 12934, 12937, 12944]
...
function eventFromEnvelope(arg0, arg1) {
  closure_0 = arg1;
  _mod12934.forEachEnvelopeItem(arg0, (arg0, arg1) => {
  ...
  return (arg0) => {
    ...
    function getTransport(arg0, arg1) {
      ...
      if (value) {
        ...
        const dsnFromStringResult = _mod12937.dsnFromString(arg0);
        if (dsnFromStringResult) {
          let merged = tunnel;
          const envelopeEndpointWithUrlEncodedAuth = tmp4(12944).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, tunnel.tunnel);
          let tmp9 = tunnel;
          let obj3 = {};
          if (arg1) {
      ...
      return (async (arg0, value) => {
        const mapped = v3({
          ...
          getEvent(arg0) {
            ...
            dependencyMap(12934).forEachEnvelopeItem(dependencyMap, () => { ... });
        ...
        await Promise.all(arr3.map((item) => {
          ...
          return obj.send(dependencyMap(12934).createEnvelope(tmp4, 12934));
        }));
        return value[0];
      })();
    };
