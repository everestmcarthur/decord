// Module ID: 12985
// Function ID: 12986
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12925, 12940, 12922, 12986, 12950, 12953, 12954, 12926, 12979, 12937, 12987, 12948, 12931, 12962, 12981]
...
_inherits(ServerRuntimeClient, _mod12981.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(12986).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(12986);
    return ServerRuntimeClient(12950).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      return obj.resolvedSyncPromise(ServerRuntimeClient(12986).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12953).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12953);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(12979).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12954).DEBUG_BUILD) {
        const logger = tmp2(12926).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12987);
          ...
          if (ServerRuntimeClient(12954).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12926).logger;
          ...
          if (ServerRuntimeClient(12954).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12926).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(12937).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12948)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(12931).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(12931);
        } else {
          spanToTraceContextResult = tmp(12953).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(12953);
        }
        const tmpResult4 = ServerRuntimeClient(12962);
        if (_getSpanForScopeResult) {
