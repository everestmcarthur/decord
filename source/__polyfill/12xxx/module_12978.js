// Module ID: 12978
// Function ID: 12979
// Dependencies: [32, 5, 12865, 12979, 12873, 12868, 12881, 12874]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod12865;
      obj2.endTimestamp = 1000 * _mod12881.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12865.addHandler("fetch-body-resolved", arg0);
  _mod12865.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(12873).fill(closure_0(12868).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12865);
                    obj5.endTimestamp = 1000 * stack(12881).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12881);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12865);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12881).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(12881);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(12874);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(12873).addNonEnumerableProperty(error, "framesToPop", 1);
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  ...
  require("module_12865").maybeInstrument("fetch", () => {
    ...
    if (!flag) {
      _mod12873.fill(_mod12868.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
