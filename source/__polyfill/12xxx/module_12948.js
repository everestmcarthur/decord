// Module ID: 12948
// Function ID: 12949
// Dependencies: [12949, 12947]

// Module 12948
import GLOBAL_OBJ from "module_12949" /* 12949 */;

const require = globalThis.__r;

function consoleSandbox(fn) {
  if ("console" in console(12949).GLOBAL_OBJ) {
    console = console(12949).GLOBAL_OBJ.console;
    dependencyMap = {};
...
export const logger = GLOBAL_OBJ.getGlobalSingleton("logger", function makeLogger() {
  ...
  if (require("module_12947").DEBUG_BUILD) {
