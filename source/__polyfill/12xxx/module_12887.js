// Module ID: 12887
// Function ID: 12888
// Dependencies: [41, 42, 12888, 12874, 12885, 12893]
...
function withScope(arg0) {
  const mainCarrier = AsyncContextStack(12885).getMainCarrier();
  const obj = AsyncContextStack(12885);
  const sentryCarrier = AsyncContextStack(12885).getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = tmp(12893).getDefaultCurrentScope();
    const tmpResult = tmp(12893);
    stack = new _moduleResult(defaultCurrentScope, tmp(12893).getDefaultIsolationScope());
    const tmpResult2 = tmp(12893);
  }
...
function withIsolationScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = tmp(12893).getDefaultCurrentScope();
    const tmpResult = tmp(12893);
    stack = new closure_3(defaultCurrentScope, tmp(12893).getDefaultIsolationScope());
    const tmpResult2 = tmp(12893);
  }
  sentryCarrier.stack = stack;
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(12893).getDefaultCurrentScope();
      const tmp2Result = tmp2(12893);
      stack = new closure_2_3(defaultCurrentScope, tmp2(12893).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(12893);
    }
    sentryCarrier.stack = stack;
...
export function getStackAsyncContextStrategy() {
  return {
    ...
    withSetIsolationScope(arg0, arg1) {
      closure_0 = arg1;
      let mainCarrier = closure_0(12885).getMainCarrier();
      let obj = closure_0(12885);
      let sentryCarrier = closure_0(12885).getSentryCarrier(mainCarrier);
      let stack = sentryCarrier.stack;
      if (!stack) {
        let defaultCurrentScope = tmp(12893).getDefaultCurrentScope();
        const tmpResult = tmp(12893);
        stack = new closure_3(defaultCurrentScope, tmp(12893).getDefaultIsolationScope());
        const tmpResult2 = tmp(12893);
      }
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(12893).getDefaultCurrentScope();
        const tmpResult = tmp(12893);
        stack = new closure_1_3(defaultCurrentScope, tmp(12893).getDefaultIsolationScope());
        const tmpResult2 = tmp(12893);
      }
      sentryCarrier.stack = stack;
