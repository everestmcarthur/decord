// Module ID: 12947
// Function ID: 12948
// Dependencies: [41, 42, 12948, 12934, 12945, 12953]
...
function withScope(arg0) {
  const mainCarrier = AsyncContextStack(12945).getMainCarrier();
  const obj = AsyncContextStack(12945);
  const sentryCarrier = AsyncContextStack(12945).getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = tmp(12953).getDefaultCurrentScope();
    const tmpResult = tmp(12953);
    stack = new _moduleResult(defaultCurrentScope, tmp(12953).getDefaultIsolationScope());
...
function withIsolationScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = tmp(12953).getDefaultCurrentScope();
    const tmpResult = tmp(12953);
    stack = new closure_3(defaultCurrentScope, tmp(12953).getDefaultIsolationScope());
    const tmpResult2 = tmp(12953);
  }
  sentryCarrier.stack = stack;
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(12953).getDefaultCurrentScope();
      const tmp2Result = tmp2(12953);
      stack = new closure_2_3(defaultCurrentScope, tmp2(12953).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(12953);
    }
    sentryCarrier.stack = stack;
...
export function getStackAsyncContextStrategy() {
  return {
    ...
    withSetIsolationScope(arg0, arg1) {
      closure_0 = arg1;
      let mainCarrier = closure_0(12945).getMainCarrier();
      let obj = closure_0(12945);
      let sentryCarrier = closure_0(12945).getSentryCarrier(mainCarrier);
      let stack = sentryCarrier.stack;
      if (!stack) {
        let defaultCurrentScope = tmp(12953).getDefaultCurrentScope();
        const tmpResult = tmp(12953);
        stack = new closure_3(defaultCurrentScope, tmp(12953).getDefaultIsolationScope());
        const tmpResult2 = tmp(12953);
      }
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(12953).getDefaultCurrentScope();
        const tmpResult = tmp(12953);
        stack = new closure_1_3(defaultCurrentScope, tmp(12953).getDefaultIsolationScope());
        const tmpResult2 = tmp(12953);
      }
      sentryCarrier.stack = stack;
