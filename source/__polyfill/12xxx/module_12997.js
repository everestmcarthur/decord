// Module ID: 12997
// Function ID: 12998
// Dependencies: [718, 12888, 12891, 12892, 12906, 12916, 12920, 12924, 12974, 12897, 12926, 12907, 12925, 12963, 12909, 12905, 12899]
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod12963.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(12899).isInstanceOf(headers, Request);
        const tmpResult = tmp(12899);
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(12899).isInstanceOf(headers, Headers);
        const tmpResult2 = tmp(12899);
      }
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod12924.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12909).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12909);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(12909).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(12974).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12974);
    }
    const activeSpan = setHttpStatus(12897).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(12907).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(12907).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(12926).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(12926);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12924);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12925).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12897);
  }
};
