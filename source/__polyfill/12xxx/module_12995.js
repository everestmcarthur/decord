// Module ID: 12995
// Function ID: 12996
// Dependencies: [718, 12886, 12889, 12890, 12904, 12914, 12918, 12922, 12972, 12895, 12924, 12905, 12923, 12961, 12907, 12903, 12897]
...
import "module_12889";
import consoleSandbox from "module_12890" /* 12890 */;
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod12961.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(12897).isInstanceOf(headers, Request);
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(12897).isInstanceOf(headers, Headers);
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod12922.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12907).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12907);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(12907).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(12972).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12972);
    }
    const activeSpan = setHttpStatus(12895).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(12905).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(12905).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(12924).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(12924);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12922);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12923).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12895);
  }
};
