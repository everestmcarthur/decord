// Module ID: 12946
// Function ID: 12947
// Dependencies: [12947, 12948, 12951]
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (_mod12947.DEBUG_BUILD) {
          const logger = tmp19(12948).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12951).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12951);
        }
      }
    }
