// Module ID: 12946
// Function ID: 12947
// Dependencies: [12939, 12940, 12947, 12948, 12949]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(12947).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(12947);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod12948.htmlTreeAsString(arg0);
      const tmp2Result = _mod12948;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod12949.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod12949.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod12939.DEBUG_BUILD) {
        const logger = tmp7(12940).logger;
        const _HermesInternal = HermesInternal;
