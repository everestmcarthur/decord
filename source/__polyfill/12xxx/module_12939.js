// Module ID: 12939
// Function ID: 12940
// Dependencies: [12901, 12904, 12917, 12940, 12941, 12927, 12899, 12942, 12935, 12911]
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = _mod12899.truncate(environment.message, num);
  }
  value = iter;
  ...
  if (value) {
    iter.value = _mod12899.truncate(iter.value, num);
  }
  ...
  if (url) {
    request.url = _mod12899.truncate(request.url, num);
  }
}
function applyDebugIds(exception, arg1) {
  const filenameToDebugIdMap = _mod12942.getFilenameToDebugIdMap(arg1);
  try {
