// Module ID: 12968
// Function ID: 12969
// Dependencies: [41, 42, 12969, 12955, 12966, 12974]
...
function withScope(arg0) {
  const mainCarrier = AsyncContextStack(12966).getMainCarrier();
  const obj = AsyncContextStack(12966);
  const sentryCarrier = AsyncContextStack(12966).getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = tmp(12974).getDefaultCurrentScope();
    const tmpResult = tmp(12974);
    stack = new _moduleResult(defaultCurrentScope, tmp(12974).getDefaultIsolationScope());
...
function withIsolationScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = tmp(12974).getDefaultCurrentScope();
    const tmpResult = tmp(12974);
    stack = new closure_3(defaultCurrentScope, tmp(12974).getDefaultIsolationScope());
    const tmpResult2 = tmp(12974);
  }
  sentryCarrier.stack = stack;
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(12974).getDefaultCurrentScope();
      const tmp2Result = tmp2(12974);
      stack = new closure_2_3(defaultCurrentScope, tmp2(12974).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(12974);
    }
    sentryCarrier.stack = stack;
...
export function getStackAsyncContextStrategy() {
  return {
    ...
    withSetIsolationScope(arg0, arg1) {
      closure_0 = arg1;
      let mainCarrier = closure_0(12966).getMainCarrier();
      let obj = closure_0(12966);
      let sentryCarrier = closure_0(12966).getSentryCarrier(mainCarrier);
      let stack = sentryCarrier.stack;
      if (!stack) {
        let defaultCurrentScope = tmp(12974).getDefaultCurrentScope();
        const tmpResult = tmp(12974);
        stack = new closure_3(defaultCurrentScope, tmp(12974).getDefaultIsolationScope());
        const tmpResult2 = tmp(12974);
      }
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(12974).getDefaultCurrentScope();
        const tmpResult = tmp(12974);
        stack = new closure_1_3(defaultCurrentScope, tmp(12974).getDefaultIsolationScope());
        const tmpResult2 = tmp(12974);
      }
      sentryCarrier.stack = stack;
