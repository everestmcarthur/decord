// Module ID: 11146
// Function ID: 11147
// Dependencies: [5, 17, 11147, 11148, 11153, 11154, 11155, 11156, 11157]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11154 */;
import _modAll11155 from "module_11155" /* 11155 */;
import _modAll11156 from "module_11156" /* 11156 */;
import syncAll from "sync" /* 11157 */;
...
const subs = fn(11147).ProductType.subs;
const inapp = fn(11147).ProductType.inapp;
...
export const IapAndroid = _modAll11155;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11156;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11148).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11148.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11148.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11148.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11148.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11148.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11148).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11153).singleProductAndroidMap);
      return tmp2(11148).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11148).getAndroidModuleType();
      const androidModule = tmp2(11148).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11147).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11148).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11147).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11148).getAndroidModule();
            ...
            const androidModule1 = v3(11148).getAndroidModule();
