...
export const useIAP = () => {
  const iAPContext = require("module_11198").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11183").requestPurchase,
    requestSubscription: require("module_11183").requestSubscription
  };
};
