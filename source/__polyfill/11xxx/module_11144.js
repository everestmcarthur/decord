// Module ID: 11144
// Function ID: 11145
// Dependencies: [5, 17, 11145, 11146, 11151, 11152, 11153, 11154, 11155]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11152 */;
import _modAll11153 from "module_11153" /* 11153 */;
import _modAll11154 from "module_11154" /* 11154 */;
import syncAll from "sync" /* 11155 */;
...
const subs = fn(11145).ProductType.subs;
const inapp = fn(11145).ProductType.inapp;
...
export const IapAndroid = _modAll11153;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11154;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11146).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11146.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11146.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11146.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11146.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11146.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11146).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11151).singleProductAndroidMap);
      return tmp2(11146).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11146).getAndroidModuleType();
      const androidModule = tmp2(11146).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11145).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11146).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11145).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11146).getAndroidModule();
            ...
            const androidModule1 = v3(11146).getAndroidModule();
