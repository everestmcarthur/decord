// Module ID: 11188
// Function ID: 11189
// Dependencies: [5, 17, 11189, 11190, 11195, 11196, 11197, 11198, 11199]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11196 */;
import _modAll11197 from "module_11197" /* 11197 */;
import _modAll11198 from "module_11198" /* 11198 */;
import syncAll from "sync" /* 11199 */;
...
const subs = fn(11189).ProductType.subs;
const inapp = fn(11189).ProductType.inapp;
...
export const IapAndroid = _modAll11197;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11198;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11190).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11190.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11190.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11190.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11190.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11190.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11190).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11195).singleProductAndroidMap);
      return tmp2(11190).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11190).getAndroidModuleType();
      const androidModule = tmp2(11190).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11189).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11190).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11189).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11190).getAndroidModule();
            ...
            const androidModule1 = v3(11190).getAndroidModule();
