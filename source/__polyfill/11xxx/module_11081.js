// Module ID: 11081
// Function ID: 11082
// Dependencies: [5, 17, 11082, 11083, 11088, 11089, 11090, 11091, 11092]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11089 */;
import _modAll11090 from "module_11090" /* 11090 */;
import _modAll11091 from "module_11091" /* 11091 */;
import syncAll from "sync" /* 11092 */;
...
const subs = fn(11082).ProductType.subs;
const inapp = fn(11082).ProductType.inapp;
...
export const IapAndroid = _modAll11090;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11091;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11083).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11083.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11083.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11083.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11083.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11083.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11083).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11088).singleProductAndroidMap);
      return tmp2(11083).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11083).getAndroidModuleType();
      const androidModule = tmp2(11083).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11082).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11083).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11082).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11083).getAndroidModule();
            ...
            const androidModule1 = v3(11083).getAndroidModule();
