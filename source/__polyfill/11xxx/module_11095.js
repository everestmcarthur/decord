...
export const useIAP = () => {
  const iAPContext = require("module_11096").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11081").requestPurchase,
    requestSubscription: require("module_11081").requestSubscription
  };
};
