...
export const useIAP = () => {
  const iAPContext = require("module_11199").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11184").requestPurchase,
    requestSubscription: require("module_11184").requestSubscription
  };
};
