...
export const useIAP = () => {
  const iAPContext = require("module_11217").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11202").requestPurchase,
    requestSubscription: require("module_11202").requestSubscription
  };
};
