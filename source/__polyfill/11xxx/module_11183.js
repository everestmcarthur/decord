// Module ID: 11183
// Function ID: 11184
// Dependencies: [5, 17, 11184, 11185, 11190, 11191, 11192, 11193, 11194]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11191 */;
import _modAll11192 from "module_11192" /* 11192 */;
import _modAll11193 from "module_11193" /* 11193 */;
import syncAll from "sync" /* 11194 */;
...
const subs = fn(11184).ProductType.subs;
const inapp = fn(11184).ProductType.inapp;
...
export const IapAndroid = _modAll11192;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11193;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11185).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11185.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11185.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11185.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11185.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11185.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11185).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11190).singleProductAndroidMap);
      return tmp2(11185).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11185).getAndroidModuleType();
      const androidModule = tmp2(11185).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11184).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11185).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11184).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11185).getAndroidModule();
            ...
            const androidModule1 = v3(11185).getAndroidModule();
