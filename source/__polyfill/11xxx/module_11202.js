// Module ID: 11202
// Function ID: 11203
// Dependencies: [5, 17, 11203, 11204, 11209, 11210, 11211, 11212, 11213]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11210 */;
import _modAll11211 from "module_11211" /* 11211 */;
import _modAll11212 from "module_11212" /* 11212 */;
import syncAll from "sync" /* 11213 */;
...
const subs = fn(11203).ProductType.subs;
const inapp = fn(11203).ProductType.inapp;
...
export const IapAndroid = _modAll11211;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11212;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11204).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11204.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11204.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11204.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11204.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11204.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11204).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11209).singleProductAndroidMap);
      return tmp2(11204).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11204).getAndroidModuleType();
      const androidModule = tmp2(11204).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11203).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11204).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11203).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11204).getAndroidModule();
            ...
            const androidModule1 = v3(11204).getAndroidModule();
