...
export const useIAP = () => {
  const iAPContext = require("module_11203").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11188").requestPurchase,
    requestSubscription: require("module_11188").requestSubscription
  };
};
