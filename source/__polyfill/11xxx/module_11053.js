// Module ID: 11053
// Function ID: 11054
// Dependencies: [11054, 11055, 11066, 11068, 11069, 11060, 11070]
...
for (const key10017 in require("module_11055")) {
  let tmp3 = key10017;
  arg5[key10017] = require("module_11055")[key10017];
  continue;
}
...
for (const key10025 in require("useIAP")) {
  let tmp5 = key10025;
  arg5[key10025] = require("useIAP")[key10025];
  continue;
}
for (const key10029 in require("useIAPContext")) {
  let tmp6 = key10029;
  arg5[key10029] = require("useIAPContext")[key10029];
  continue;
}
