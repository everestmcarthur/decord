...
export const useIAP = () => {
  const iAPContext = require("module_11225").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11210").requestPurchase,
    requestSubscription: require("module_11210").requestSubscription
  };
};
