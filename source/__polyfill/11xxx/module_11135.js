...
export const useIAP = () => {
  const iAPContext = require("module_11136").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11121").requestPurchase,
    requestSubscription: require("module_11121").requestSubscription
  };
};
