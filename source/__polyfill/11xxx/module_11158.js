...
export const useIAP = () => {
  const iAPContext = require("module_11159").useIAPContext();
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (arg0 === 1) {
            ...
            c4 = 2;
            c5 = 1;
            const obj7 = { value: closure_0(currentPurchaseError[3]).getProducts(obj6), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          c5 = 3;
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (arg0 === 1) {
            ...
            c4 = 2;
            c5 = 1;
            const obj7 = { value: closure_0(currentPurchaseError[3]).getSubscriptions(obj6), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          c5 = 3;
  ...
  return {
    ...
    requestPurchase: require("module_11144").requestPurchase,
    requestSubscription: require("module_11144").requestSubscription
  };
};
