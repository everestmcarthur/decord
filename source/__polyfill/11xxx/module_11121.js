// Module ID: 11121
// Function ID: 11122
// Dependencies: [5, 17, 11122, 11123, 11128, 11129, 11130, 11131, 11132]
...
// Module 11121
import _mod11123 from "module_11123" /* 11123 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11129 */;
import _modAll11130 from "module_11130" /* 11130 */;
import _modAll11131 from "module_11131" /* 11131 */;
import syncAll from "sync" /* 11132 */;
...
const subs = fn(11122).ProductType.subs;
const inapp = fn(11122).ProductType.inapp;
...
export const IapAndroid = _modAll11130;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11131;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11123).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11123.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11123.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11123.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11123.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11123.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11123).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11128).singleProductAndroidMap);
      return tmp2(11123).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11123).getAndroidModuleType();
      const androidModule = tmp2(11123).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11122).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11123).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11122).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11123).getAndroidModule();
            ...
            const androidModule1 = v3(11123).getAndroidModule();
