...
export const useIAP = () => {
  const iAPContext = require("module_11161").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11146").requestPurchase,
    requestSubscription: require("module_11146").requestSubscription
  };
};
