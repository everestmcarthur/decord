      ...
      switch (c11) {
        case 0:
          if (arg0 === 1) {
            ...
            let value4;
            const obj5 = { responseTexts: [], finishReasons: [], responseId: "", responseModel: "", promptTokens: "r", completionTokens: "w", cacheCreationInputTokens: "data", cacheReadInputTokens: "now", toolCalls: [], activeToolBlocks: {} };
            closure_136_2 = obj5;
            closure_136_4 = false;
            closure_136_5 = false;
            c9 = 4;
...
export const instrumentMessageStream = function instrumentMessageStream(applyResult, arg1, flag) {
  closure_0 = arg1;
  closure_1 = flag;
  const obj = { responseTexts: [], finishReasons: [], responseId: "", responseModel: "", promptTokens: "r", completionTokens: "w", cacheCreationInputTokens: "data", cacheReadInputTokens: "now", toolCalls: [], activeToolBlocks: {} };
