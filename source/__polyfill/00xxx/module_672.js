...
let fn = function n() {
  ...
  function clip_rgb(items) {
    items._clipped = false;
    items._unclipped = items.slice(0);
    let num = 0;
    do {
      if (num < 3) {
        let tmp2 = items[num] < 0 || items[num] > 255;
        if (tmp2) {
          items._clipped = true;
        }
        let num4 = items[num];
  ...
  function unpack(arg0, arg1) {
    ...
    if (arg0.length >= 3) {
      ...
      if (typeof type$p === "function") {
        ...
        mapped = arg0[0];
        tmp4 = f108356[typeof call === "unknown" ? toString(first) : call(toString, first)] || "object";
      } else {
    ...
    if (typeof last === "function") {
      ...
      if (items.length >= 2) {
        ...
        if (typeof type$p === "function") {
          ...
          str = formatted;
          tmp9 = f108356[typeof call === "unknown" ? toString(tmp6) : call(toString, tmp6)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    test(arg0) {
      ...
      if (!items.length) {
        if (typeof type$p === "function") {
          ...
          tmp8 = f108356[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    if (typeof last === "function") {
      ...
      if (items.length >= 2) {
        ...
        if (typeof type$p === "function") {
          ...
          str = formatted;
          tmp13 = f108356[typeof call === "unknown" ? toString(tmp10) : call(toString, tmp10)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
      ...
      const text1 = `0${str8.toString(16)}`;
      const substr1 = `0${str8.toString(16)}`.substr(`0${str8.toString(16)}`.length - 2);
  ...
  obj2.format.hsi = function hsi2rgb_1() {
    ...
    if (result < 0.3333333333333333) {
      ...
      const result6 = result * (result - 0.3333333333333333);
      ...
      diff2 = (1 - num2) / 3;
      const result9 = result * (result - 0.6666666666666666);
    ...
    test() {
      ...
      if (1 === items.length) {
        ...
        if (typeof type$p === "function") {
          ...
          tmp8 = f108356[typeof call === "unknown" ? toString(first) : call(toString, first)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
  ...
  chroma$k.kelvin = fn2;
  chroma$k.temp = fn2;
  obj2.format.temperature = temperature2rgb_1;
  obj2.format.kelvin = temperature2rgb_1;
    ...
    if (typeof luminance_x === "function") {
      ...
      if (typeof tmp === "function") {
        ...
        if (typeof tmp === "function") {
          ...
          return tmp6 + tmp11 + 0.0722 * result5;
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
  ...
  function mix$1(arg0, arg1, arg2) {
    ...
    if (obj17[first]) {
      if (typeof type$p === "function") {
        ...
        tmp17 = f108356[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    } else {
    ...
    function setColors(items) {
      ...
      if (items) {
        if (typeof type$p === "function") {
          const _Object = Object;
          const call = toString.call;
          brewer = "string" === (f108356[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object");
          const tmp4 = f108356[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
      ...
      if (typeof type$p === "function") {
        ...
        if ("array" === tmp10) {
          ...
          if (0 < substr.length) {
            do {
              substr[num2] = chroma$k(substr[num2]);
              num2 = num2 + 1;
        ...
        tmp10 = f108356[typeof call2 === "unknown" ? toString2(arr2) : call2(toString2, arr2)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    }
    let fn = function tMapLightness(arg0) {
      return arg0;
    };
      ...
      if (!isNaN(arg0)) {
        if (null !== arg0) {
          ...
          if (typeof type$p === "function") {
            ...
            tmp29 = f108356[typeof call === "unknown" ? toString(tmp27) : call(toString, tmp27)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
      ...
      if (arguments.length) {
        ...
        if (arr.length === substr.length) {
          if (closure_10 !== closure_11) {
            ...
            if (0 < arr.length) {
              do {
                let arr2 = closure_5.push((arr[num4] - closure_10) / (closure_11 - closure_10));
                num4 = num4 + 1;
                length2 = arr.length;
              } while (num4 < length2);
            }
    ...
    fn.padding = (arg0) => {
      if (null != arg0) {
        if (typeof type$p === "function") {
          ...
          items = tmp6;
          let tmp = fn;
          tmp5 = f108356[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
  ...
  f108356 = (arg0, arg1) => {
    const items = [f108356(arg0[0], arg1[0]), f108356(arg0[1], arg1[1]), f108356(arg0[2], arg1[2])];
    return items;
  };
  blend.normal = (arg0, arg1) => {
    const obj = closure_2_206(arg1);
    const rgbResult = closure_2_206(arg1).rgb();
    return closure_2_206.rgb(f108356(rgbResult, closure_2_206(arg0).rgb()));
  };
  ...
  function analyze(arg0, arg1) {
    ...
    if (typeof type$p === "function") {
      ...
      const item = values.forEach((item) => {
        ...
        if (c0) {
          if (typeof type$p === "function") {
            const _Object = Object;
            const call = toString.call;
            tmp2 = "object" === (f108356[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object");
            const tmp6 = f108356[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
      ...
      const items = [, ];
      ({ min: arr2[0], max: arr2[1] } = range);
      range.domain = items;
      range.limits = (arg0, arg1) => limits(range, arg0, arg1);
      return range;
    } else {
      throw new TypeError("Trying to call a non-function");
    }
  ...
  function limits(analyzeResult, arg1, arg2) {
    ...
    if (typeof type$p === "function") {
      const _Object = Object;
      const call = toString.call;
      let tmp5 = analyzeResult;
      if ("array" == tmp4) {
        tmp5 = analyze(analyzeResult);
      }
      ({ min, max, values } = tmp5);
        ...
        if ("e" === str.substr(0, 1)) {
          ...
          if (min <= 0) {
            ...
            for (let num20 = 1; num20 < num; num20 = num20 + 1) {
              let arr27 = items1.push(pow(10, result + num20 / num * (result1 - result)));
            }
            items1.push(max);
          }
          ...
          let items2 = [];
          items2.push(min);
          for (let num3 = 1; num3 < num; num3 = num3 + 1) {
            let arr34 = items2.push(min + num3 / num * (max - min));
          }
          items2.push(max);
          let num5 = 0;
          do {
            ...
            for (let num7 = 0; num7 < length; num7 = num7 + 1) {
              let _Number = Number;
              let num8 = 0;
              if (0 < num) {
                do {
                  let tmp18 = abs(items2[num8] - tmp14);
                  let tmp20 = tmp16;
                  let tmp21 = MAX_VALUE;
                  if (tmp18 < MAX_VALUE) {
                    tmp20 = num8;
            ...
            for (let num11 = 0; num11 < num; num11 = num11 + 1) {
              array4[num11] = array4[num11] * (1 / array3[num11]);
            }
            let num12 = 0;
            flag = false;
            if (0 < num) {
              flag = true;
              while (array4[num12] === items2[num12]) {
                let sum = num12 + 1;
                num12 = sum;
                flag = false;
                if (sum >= num) {
          ...
          for (let num14 = 0; num14 < length; num14 = num14 + 1) {
            let arr3 = obj[array[num14]];
            let arr36 = arr3.push(sorted[num14]);
          }
          const items3 = [];
          for (let num15 = 0; num15 < num; num15 = num15 + 1) {
            let arr37 = items3.push(obj[num15][0]);
            let arr38 = items3.push(obj[num15][obj[num15].length - 1]);
          }
      ...
      tmp4 = f108356[typeof call === "unknown" ? toString(analyzeResult) : call(toString, analyzeResult)] || "object";
    } else {
      throw new TypeError("Trying to call a non-function");
    }
  }
  ...
  chroma$k.bezier = (arr) => {
    ...
    if (2 === mapped.length) {
      ...
      [f108356, type$p, type$p, last] = mapped3;
      fn = function a(arg0) {
        closure_0 = arg0;
        const items = [0, 1, 2];
  ...
  chroma$k.cubehelix = (arg0, arg1, arg2, arg3, arg4) => {
    ...
    if (typeof type$p === "function") {
      ...
      const fn = function f(arg0) {
        ...
        items = [255 * (tmp3 + result1 * (-0.14861 * tmp9 + 1.78277 * tmp10)), 255 * (tmp3 + result1 * (-0.29227 * tmp9 - 0.90649 * tmp10)), 255 * (tmp3 + result1 * (1.97294 * tmp9)), 1];
        clip_rgb(items);
      ...
      fn.hue = (arg0) => {
        if (null == arg0) {
          ...
          if (typeof type$p === "function") {
            ...
            tmp8 = fn;
            tmp3 = f108356[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
