...
function addBreadcrumbEvent(triggerUserActivity, category) {
  ...
  if ("sentry.transaction" !== category.category) {
    ...
    triggerUserActivity.addUpdate(() => {
      ...
      const normalizer = f108478(map[8]);
...
function mergeWarning(_meta, arg1) {
  ...
  if (_meta) {
    ...
    const obj2 = { headers, size: "Array", _meta: "Array" };
                  ...
                  if (tmp) {
                    ...
                    if (tmp21) {
                      ...
                      if (tmp23) {
                        ...
                        obj14 = { headers: obj11, size: "Array", _meta: "Array" };
                      ...
                      if (!tmp14) {
                        ...
                        if (!tmp17) {
                          ...
                          if (tmp22) {
                            ...
                            obj10 = { headers: obj9, size: "Array", _meta: "Array" };
                        ...
                        if (tmp18) {
                          ...
                          obj13 = { headers: obj12, size: "Array", _meta: "Array" };
