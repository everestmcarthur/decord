  ...
  map: function mapChildren(element, arg1, arg2) {
    ...
    if (null == element) {
      ...
      mapIntoArray(element, items, "", "", (arg0) => {
        const call = f69327.call;
        closure_2 = tmp3 + 1;
        return typeof call === "unknown" ? f69327(arg0, +closure_2) : call(closure_1_1, arg0, +closure_2);
      });
      return items;
    }
  },
  forEach(element, arg1, arg2) {
    const f69325 = function() {
      const self = this;
      const apply = f69325.apply;
