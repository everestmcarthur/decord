// Module ID: 9009
// Function ID: 9010
// Dependencies: [32, 5, 9010, 9005, 9011, 9008, 9012, 9006, 9013]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_7 = fn(_mod9010);
    let fnResult = fn(_mod9005);
    let closure_9 = fn(_mod9011);
    let closure_10 = fn(require("module_9008"));
    ...
    let obj = {
      enumerable: true,
      get() {
            return require("module_9008").clone;
          }
    };
      ...
      _zod.implement = (fn) => {
        ...
        if (typeof fn !== "function") {
          ...
          return function() {
            ...
            let parsed = items;
            if (_def._def.input) {
              parsed = _mod9006.parse(tmp._def.input, items);
            }
            const applyResult = Reflect.apply(_def, this, parsed);
            let parsed1 = applyResult;
            if (_def._def.output) {
              parsed1 = _mod9006.parse(tmp._def.output, applyResult);
            }
            return parsed1;
          };
        }
            ...
            const iter = (async (arg0, value) => {
              if (1 === tmp5) {
                if (arg0 === 1) {
                  ...
                  c5 = 2;
                  c6 = 1;
                  return { value: _self(9006).parseAsync(self._def.input, closure_130_0), done: false };
                } else {
                ...
                if (3 === tmp5) {
                  if (arg0 === 1) {
                    ...
                    if (self._def.output) {
                      c5 = 4;
                      c6 = 1;
                      return { value: _self(9006).parseAsync(self._def.output, closure_130_2), done: false };
                    } else {
