// Module ID: 9963
// Function ID: 9964
// Dependencies: [9964, 9965, 9959]

// Module 9963
import _mod9959 from "module_9959" /* 9959 */;
import QRPolynomial from "QRPolynomial" /* 9964 */;
import array2 from "array2" /* 9965 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod9959.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(9959).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(9959).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(9959).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod9959.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(9959).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(9959).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(9959).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod9959.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(9959).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(9959).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(9959).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
