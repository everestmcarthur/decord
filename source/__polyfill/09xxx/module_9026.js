// Module ID: 9026
// Function ID: 9027
// Dependencies: [9027, 9093, 9094, 9097, 9096, 9098, 9046, 9090, 9099, 9037, 9095, 9100]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.core = fn(require("module_9027"));
    fn2(_mod9093, exports);
    fn2(lt, exports);
    fn2(_mod9097, exports);
    fn2(_mod9096, exports);
    fn2(_mod9098, exports);
    require("module_9027").config(fn3(_mod9046).default());
    const _Object4 = Object;
    let obj = {
      enumerable: true,
      get() {
            return require("module_9027").globalRegistry;
          }
    };
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_9027").registry;
          }
    };
    ...
    const obj4 = {
      enumerable: true,
      get() {
            return require("module_9027").$output;
          }
    };
    ...
    const obj5 = {
      enumerable: true,
      get() {
            return require("module_9027").$input;
          }
    };
    ...
    const obj7 = {
      enumerable: true,
      get() {
            return require("module_9027").clone;
          }
    };
    ...
    const obj8 = {
      enumerable: true,
      get() {
            return require("module_9027").regexes;
          }
    };
    ...
    const obj9 = {
      enumerable: true,
      get() {
            return require("module_9027").treeifyError;
          }
    };
    ...
    const obj10 = {
      enumerable: true,
      get() {
            return require("module_9027").prettifyError;
          }
    };
    ...
    const obj11 = {
      enumerable: true,
      get() {
            return require("module_9027").formatError;
          }
    };
    ...
    const obj12 = {
      enumerable: true,
      get() {
            return require("module_9027").flattenError;
          }
    };
    ...
    const obj13 = {
      enumerable: true,
      get() {
            return require("module_9027").TimePrecision;
          }
    };
    ...
    const obj14 = {
      enumerable: true,
      get() {
            return require("module_9027").util;
          }
    };
    ...
    const obj15 = {
      enumerable: true,
      get() {
            return require("module_9027").NEVER;
          }
    };
    ...
    const obj18 = {
      enumerable: true,
      get() {
            return require("module_9095").ZodISODateTime;
          }
    };
    ...
    const obj19 = {
      enumerable: true,
      get() {
            return require("module_9095").ZodISODate;
          }
    };
    ...
    const obj20 = {
      enumerable: true,
      get() {
            return require("module_9095").ZodISOTime;
          }
    };
    ...
    const obj21 = {
      enumerable: true,
      get() {
            return require("module_9095").ZodISODuration;
          }
    };
    Object.defineProperty(exports, "ZodISODuration", obj21);
    exports.iso = fn(require("module_9095"));
    exports.coerce = fn(_mod9100);
  } else {
