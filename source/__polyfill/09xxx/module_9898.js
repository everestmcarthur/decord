// Module ID: 9898
// Function ID: 9899
// Dependencies: [9899, 9901, 9903, 9904, 9905]

// Module 9898
import QR8bitByte from "QR8bitByte" /* 9899 */;
import QRRSBlock from "QRRSBlock" /* 9901 */;
import QRBitBuffer from "QRBitBuffer" /* 9903 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9904.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9904.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9904.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
