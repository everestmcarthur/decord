// Module ID: 9936
// Function ID: 9937
// Dependencies: [9937, 9939, 9941, 9942, 9943]

// Module 9936
import QR8bitByte from "QR8bitByte" /* 9937 */;
import QRRSBlock from "QRRSBlock" /* 9939 */;
import QRBitBuffer from "QRBitBuffer" /* 9941 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9942.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9942.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9942.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
