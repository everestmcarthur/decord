// Module ID: 9904
// Function ID: 9905
// Dependencies: [9905, 9906, 9900]

// Module 9904
import _mod9900 from "module_9900" /* 9900 */;
import QRPolynomial from "QRPolynomial" /* 9905 */;
import array2 from "array2" /* 9906 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod9900.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(9900).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(9900).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(9900).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod9900.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(9900).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(9900).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(9900).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod9900.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(9900).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(9900).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(9900).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
