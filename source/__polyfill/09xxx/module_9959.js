// Module ID: 9959
// Function ID: 9960
// Dependencies: [9960, 9962, 9964, 9965, 9966]

// Module 9959
import QR8bitByte from "QR8bitByte" /* 9960 */;
import QRRSBlock from "QRRSBlock" /* 9962 */;
import QRBitBuffer from "QRBitBuffer" /* 9964 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9965.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9965.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9965.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
