// Module ID: 9942
// Function ID: 9943
// Dependencies: [9943, 9944, 9938]

// Module 9942
import _mod9938 from "module_9938" /* 9938 */;
import QRPolynomial from "QRPolynomial" /* 9943 */;
import array2 from "array2" /* 9944 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod9938.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(9938).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(9938).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(9938).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod9938.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(9938).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(9938).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(9938).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod9938.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(9938).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(9938).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(9938).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
