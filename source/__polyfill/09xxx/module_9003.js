// Module ID: 9003
// Function ID: 9004
// Dependencies: [9004, 9070, 9071, 9074, 9073, 9075, 9023, 9067, 9076, 9014, 9072, 9077]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.core = fn(require("module_9004"));
    fn2(_mod9070, exports);
    fn2(lt, exports);
    fn2(_mod9074, exports);
    fn2(_mod9073, exports);
    fn2(_mod9075, exports);
    require("module_9004").config(fn3(_mod9023).default());
    const _Object4 = Object;
    let obj = {
      enumerable: true,
      get() {
            return require("module_9004").globalRegistry;
          }
    };
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_9004").registry;
          }
    };
    ...
    const obj4 = {
      enumerable: true,
      get() {
            return require("module_9004").$output;
          }
    };
    ...
    const obj5 = {
      enumerable: true,
      get() {
            return require("module_9004").$input;
          }
    };
    ...
    const obj7 = {
      enumerable: true,
      get() {
            return require("module_9004").clone;
          }
    };
    ...
    const obj8 = {
      enumerable: true,
      get() {
            return require("module_9004").regexes;
          }
    };
    ...
    const obj9 = {
      enumerable: true,
      get() {
            return require("module_9004").treeifyError;
          }
    };
    ...
    const obj10 = {
      enumerable: true,
      get() {
            return require("module_9004").prettifyError;
          }
    };
    ...
    const obj11 = {
      enumerable: true,
      get() {
            return require("module_9004").formatError;
          }
    };
    ...
    const obj12 = {
      enumerable: true,
      get() {
            return require("module_9004").flattenError;
          }
    };
    ...
    const obj13 = {
      enumerable: true,
      get() {
            return require("module_9004").TimePrecision;
          }
    };
    ...
    const obj14 = {
      enumerable: true,
      get() {
            return require("module_9004").util;
          }
    };
    ...
    const obj15 = {
      enumerable: true,
      get() {
            return require("module_9004").NEVER;
          }
    };
    ...
    const obj18 = {
      enumerable: true,
      get() {
            return require("module_9072").ZodISODateTime;
          }
    };
    ...
    const obj19 = {
      enumerable: true,
      get() {
            return require("module_9072").ZodISODate;
          }
    };
    ...
    const obj20 = {
      enumerable: true,
      get() {
            return require("module_9072").ZodISOTime;
          }
    };
    ...
    const obj21 = {
      enumerable: true,
      get() {
            return require("module_9072").ZodISODuration;
          }
    };
    Object.defineProperty(exports, "ZodISODuration", obj21);
    exports.iso = fn(require("module_9072"));
    exports.coerce = fn(_mod9077);
  } else {
