// Module ID: 9030
// Function ID: 9031
// Dependencies: [32, 5, 9031, 9026, 9032, 9029, 9033, 9027, 9034]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_7 = fn(_mod9031);
    let fnResult = fn(_mod9026);
    let closure_9 = fn(_mod9032);
    let closure_10 = fn(require("module_9029"));
    ...
    let obj = {
      enumerable: true,
      get() {
            return require("module_9029").clone;
          }
    };
      ...
      _zod.implement = (fn) => {
        ...
        if (typeof fn !== "function") {
          ...
          return function() {
            ...
            let parsed = items;
            if (_def._def.input) {
              parsed = _mod9027.parse(tmp._def.input, items);
            }
            const applyResult = Reflect.apply(_def, this, parsed);
            let parsed1 = applyResult;
            if (_def._def.output) {
              parsed1 = _mod9027.parse(tmp._def.output, applyResult);
            }
            return parsed1;
          };
        }
                  ...
                  if (0 === c5) {
                    ...
                    if (1 === tmp5) {
                      if (arg0 === 1) {
                        ...
                        c5 = 2;
                        c6 = 1;
                        const obj5 = { value: _self(9027).parseAsync(self._def.input, closure_130_0), done: false };
                        return obj5;
                      } else {
                      ...
                      if (3 === tmp5) {
                        if (arg0 === 1) {
                          ...
                          if (self._def.output) {
                            c5 = 4;
                            c6 = 1;
                            const obj8 = { value: _self(9027).parseAsync(self._def.output, closure_130_2), done: false };
                            return obj8;
                          } else {
                      ...
                      c6 = 3;
                      const obj9 = { value: tmp6, done: true };
                      return obj9;
                    }
                    closure_130_1 = tmp12;
                    const _Reflect = Reflect;
                    c5 = 3;
                    c6 = 1;
                    const obj10 = { value: Reflect.apply(closure_131_0, closure_4, closure_130_1), done: false };
                    return obj10;
                  }
                } catch (tmp26) {
                  c6 = tmp;
