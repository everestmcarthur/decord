// Module ID: 9877
// Function ID: 9878
// Dependencies: [9878, 9879, 9873]

// Module 9877
import _mod9873 from "module_9873" /* 9873 */;
import QRPolynomial from "QRPolynomial" /* 9878 */;
...
const obj = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod9873.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(9873).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(9873).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(9873).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod9873.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(9873).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(9873).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(9873).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod9873.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(9873).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(9873).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(9873).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
