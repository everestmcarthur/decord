// Module ID: 9069
// Function ID: 9070
// Dependencies: [32, 5, 9070, 9065, 9071, 9068, 9072, 9066, 9073]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_7 = fn(_mod9070);
    let fnResult = fn(_mod9065);
    let closure_9 = fn(_mod9071);
    let closure_10 = fn(require("module_9068"));
    ...
    let obj = {
      enumerable: true,
      get() {
            return require("module_9068").clone;
          }
    };
      ...
      _zod.implement = (fn) => {
        ...
        if (typeof fn !== "function") {
          ...
          return function() {
            ...
            let parsed = items;
            if (_def._def.input) {
              parsed = _mod9066.parse(tmp._def.input, items);
            }
            const applyResult = Reflect.apply(_def, this, parsed);
            let parsed1 = applyResult;
            if (_def._def.output) {
              parsed1 = _mod9066.parse(tmp._def.output, applyResult);
            }
            return parsed1;
          };
        }
            ...
            const iter = (async (arg0, value) => {
              if (1 === tmp5) {
                if (arg0 === 1) {
                  ...
                  c5 = 2;
                  c6 = 1;
                  return { value: _self(9066).parseAsync(self._def.input, closure_130_0), done: false };
                } else {
                ...
                if (3 === tmp5) {
                  if (arg0 === 1) {
                    ...
                    if (self._def.output) {
                      c5 = 4;
                      c6 = 1;
                      return { value: _self(9066).parseAsync(self._def.output, closure_130_2), done: false };
                    } else {
