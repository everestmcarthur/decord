// Module ID: 9998
// Function ID: 9999
// Dependencies: [9999, 10001, 10003, 10004, 10005]

// Module 9998
import QR8bitByte from "QR8bitByte" /* 9999 */;
import QRRSBlock from "QRRSBlock" /* 10001 */;
import QRBitBuffer from "QRBitBuffer" /* 10003 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10004.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10004.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10004.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
