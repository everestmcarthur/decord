// Module ID: 7011
// Function ID: 7012
// Dependencies: [17, 19, 21, 6979, 7012, 7013, 7014]
...
import CompatScroller from "CompatScroller" /* 7014 */;
...
export const useSecondaryProps = function useSecondaryProps(ListHeaderComponent) {
  ...
  let tmp7 = ListEmptyComponentStyle(() => {
    ...
    if (ListHeaderComponent) {
      ...
      obj.style = items;
      obj.children = _mod7013.getValidComponent(tmp);
  ...
  let obj2 = {
    ...
    renderEmpty: ListEmptyComponentStyle(() => {
      if (ListEmptyComponent) {
        const validComponent = _mod7013.getValidComponent(tmp);
  ...
  obj2.renderStickyHeaderBackdrop = ListEmptyComponentStyle(() => {
    ...
    if (backdropComponent) {
      ...
      obj.children = _mod7013.getValidComponent(backdropComponent1);
