// Module ID: 7028
// Function ID: 7029
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 7029, 7031, 5645, 7033, 7035, 7036, 7045, 7046]
...
let obj = { default: fn(7029).DefaultTransition, fade: fn(7029).ModalFadeTransition, fade_from_bottom: fn(7029).FadeFromBottomAndroid, fade_from_right: fn(7029).FadeFromRightAndroid, none: fn(7029).DefaultTransition, reveal_from_bottom: fn(7029).RevealFromBottomAndroid, scale_from_center: fn(7029).ScaleFromCenterAndroid, slide_from_left: fn(7029).SlideFromLeftIOS, slide_from_right: fn(7029).SlideFromRightIOS, slide_from_bottom: fn(7029).BottomSheetAndroid };
...
function getDistanceFromOptions(size, gestureDirection, arg2) {
  ...
  if (gestureDirection1) {
    return CardStack(7033).getDistanceForDirection(size, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(7029).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(7029).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(7033).getDistanceForDirection(size, gestureDirection, arg2);
  }
}
...
const entry = {
  ...
  value: function render() {
        ...
        if (typeof getIsModal === "function") {
          ...
          if (!tmp16) {
            ...
            if (typeof getIsModalPresentation === "function") {
              let tmp20 = cardStyleInterpolator === CardStack(7031).forModalPresentationIOS;
              if (!tmp20) {
                tmp20 = "forModalPresentationIOS" === cardStyleInterpolator.name;
              }
              if (tmp20) {
          ...
          obj.children = React6(CardStack(7036).CardContainer, obj3);
          return React6(CardStack(7035).MaybeScreen, obj, key.key);
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
    ...
    items2[1] = renderHeader(CardStack(7035).MaybeScreenContainer, obj4);
    obj.children = items2;
...
const entry1 = {
  ...
  value: function getDerivedStateFromProps(routes, routes2) {
    ...
    const modalRouteKeys = CardStack(7045).getModalRouteKeys(items1, {});
      ...
      if (tmp8) {
        ...
        if (index !== arg2.length - 1) {
          ...
          if ("default" !== str2) {
            ...
            ModalTransition = CardStack(7029).ModalFadeTransition;
          } else {
            if ("modal" !== options.presentation) {
              if (!hasItem1) {
                ModalTransition = CardStack(7029).DefaultTransition;
              }
            }
            ModalTransition = CardStack(7029).ModalTransition;
          }
          ...
          if (undefined !== cardStyleInterpolator) {
            ...
            if (undefined === cardOverlayEnabled) {
              ...
              if (!tmp38) {
                if (typeof getIsModalPresentation === "function") {
                  let tmp42 = cardStyleInterpolator === CardStack(7031).forModalPresentationIOS;
                  if (!tmp42) {
            ...
            if (str10 == null) {
              ...
              if (tmp43) {
                if (typeof getIsModalPresentation === "function") {
                  str10 = "screen";
                  if (cardStyleInterpolator !== CardStack(7031).forModalPresentationIOS) {
            ...
            forNoAnimation = CardStack(7031).forNoAnimation;
          }
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 = cardStyleInterpolator === CardStack(7031).forModalPresentationIOS || "forModalPresentationIOS" === cardStyleInterpolator.name;
                let tmp10 = !tmp9;
                if (tmp9) {
                  let tmp7Result = tmp7(7046);
