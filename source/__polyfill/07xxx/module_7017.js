// Module ID: 7017
// Function ID: 7018
// Dependencies: [17, 19, 21, 6985, 7018, 7019, 7020]
...
import CompatScroller from "CompatScroller" /* 7020 */;
...
export const useSecondaryProps = function useSecondaryProps(ListHeaderComponent) {
  ...
  let tmp7 = ListEmptyComponentStyle(() => {
    ...
    if (ListHeaderComponent) {
      ...
      obj.style = items;
      obj.children = _mod7019.getValidComponent(tmp);
  ...
  let obj2 = {
    ...
    renderEmpty: ListEmptyComponentStyle(() => {
      if (ListEmptyComponent) {
        const validComponent = _mod7019.getValidComponent(tmp);
  ...
  obj2.renderStickyHeaderBackdrop = ListEmptyComponentStyle(() => {
    ...
    if (backdropComponent) {
      ...
      obj.children = _mod7019.getValidComponent(backdropComponent1);
