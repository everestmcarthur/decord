// Module ID: 7077
// Function ID: 7078
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7078, 7081, 1484, 5682, 1614, 7085, 7087]
...
class StackView {
  constructor() {
    ...
    obj1 = { routes: [], previousState: "y", openingRouteKeys: 0.25, closingRouteKeys: null, replacingRouteKeys: "MASTERPASS_POPUP_MISSING_REQUIRED_PARAMETERS", descriptors: "Masterpass popup failed to return all required parameters needed to continue tokenization." };
    ...
    tmp3Result.renderHeader = (arg0) => {
      ...
      return jsx(closure_0(7081).HeaderContainer, {});
    };
        ...
        if (tmp6.key !== tmp7.key) {
          if (arr3.some((key) => key.key === closure_7.key)) {
            if (!substr1.some((key) => key.key === closure_6.key)) {
              ...
              tmp23 = arr3(7087).getAnimationEnabled(animation) && !found2.includes(tmp6.key);
            }
          }
          let animation1;
