// Module ID: 10012
// Function ID: 10013
// Dependencies: [10013, 10014, 10008]

// Module 10012
import _mod10008 from "module_10008" /* 10008 */;
import QRPolynomial from "QRPolynomial" /* 10013 */;
import array2 from "array2" /* 10014 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod10008.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(10008).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(10008).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(10008).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod10008.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(10008).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(10008).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(10008).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod10008.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(10008).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(10008).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(10008).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
