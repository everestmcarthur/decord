// Module ID: 10601
// Function ID: 10602
// Dependencies: [41, 42, 93, 95, 98, 10573, 10572, 10576, 10580]
...
const regExp = new RegExp("(this|last|past|next|after\\s*this)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10572.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ENRelativeDateFormatParser(10572).TIME_UNIT_DICTIONARY[str3];
      if ("next" != formatted) {
