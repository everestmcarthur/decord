// Module ID: 10601
// Function ID: 10602
// Dependencies: [41, 42, 10593, 10550]
...
const items = [
  entry,
  {
    ...
    value: function extract(reference, arg1) {
      const tmp3 = JPWeekdayWithParenthesesParser(10593).WEEKDAY_OFFSET[arg1.groups.weekday];
      let parsingComponentsAtWeekday = null;
      if (undefined !== tmp3) {
        parsingComponentsAtWeekday = JPWeekdayWithParenthesesParser(10550).createParsingComponentsAtWeekday(reference.reference, tmp3);
      }
