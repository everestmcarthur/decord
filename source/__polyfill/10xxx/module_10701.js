...
const entry = {
  ...
  value: function patternLeftBoundary() {
    return RUTimeUnitWithinFormatParser(10702).REGEX_PARTS.leftBoundary;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerPattern(option) {
      ...
      if (option.option.forwardDate) {
        let _RegExp1 = new _RegExp(tmp, RUTimeUnitWithinFormatParser(10702).REGEX_PARTS.flags);
      } else {
        const _HermesInternal = HermesInternal;
        const combined = "(?:\u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435|\u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0438)\\s*" + tmp;
        _RegExp1 = new _RegExp(combined, RUTimeUnitWithinFormatParser(10702).REGEX_PARTS.flags);
      }
      return _RegExp1;
    }
  },
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = RUTimeUnitWithinFormatParser(10576).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, RUTimeUnitWithinFormatParser(10702).parseDuration(arg1[1]));
    }
  }
];
