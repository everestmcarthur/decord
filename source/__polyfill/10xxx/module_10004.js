// Module ID: 10004
// Function ID: 10005
// Dependencies: [10005, 10006, 10000]

// Module 10004
import _mod10000 from "module_10000" /* 10000 */;
import QRPolynomial from "QRPolynomial" /* 10005 */;
import array2 from "array2" /* 10006 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod10000.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(10000).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(10000).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(10000).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod10000.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(10000).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(10000).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(10000).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod10000.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(10000).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(10000).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(10000).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
