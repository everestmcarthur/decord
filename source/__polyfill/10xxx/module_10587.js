// Module ID: 10587
// Function ID: 10588
// Dependencies: [10563, 10565]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10587
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10563 */;
import Meridiem from "Meridiem" /* 10565 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10565).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10565).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10565).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10565).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
