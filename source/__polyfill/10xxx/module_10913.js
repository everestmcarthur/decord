...
export const usePanGestureProxy = (onConfigurePanGesture) => {
  ...
  const tmp = onGestureUpdate(() => {
    ...
    const userDefinedConflictGestures = { onBegin: "call", onStart: "LengthDelimited", onUpdate: "getCurrentUser", onEnd: "fill", onFinalize: "IconComponent" };
