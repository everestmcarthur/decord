// Module ID: 10710
// Function ID: 10711
// Dependencies: [41, 42, 93, 95, 98, 10523, 10711, 10550, 10530]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10711.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10550).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10711).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
