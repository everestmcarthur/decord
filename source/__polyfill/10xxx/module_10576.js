// Module ID: 10576
// Function ID: 10577
// Dependencies: [41, 42, 93, 95, 98, 10569, 10523, 10525, 10526, 10530]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:\\s*((?:n\u00E4chste|kommende|folgende|letzte|vergangene|vorige|vor(?:her|an)gegangene)(?:s|n|m|r)?|vor|in)\\s*)?(" + DETimeUnitAgoFormatParser(10569).NUMBER_PATTERN + ")?(?:\\s*(n\u00E4chste|kommende|folgende|letzte|vergangene|vorige|vor(?:her|an)gegangene)(?:s|n|m|r)?)?\\s*(" + DETimeUnitAgoFormatParser(10523).matchAnyPattern(DETimeUnitAgoFormatParser(10569).TIME_UNIT_DICTIONARY) + ")", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      let num = 1;
      if (arg1[2]) {
        num = DETimeUnitAgoFormatParser(10569).parseNumberPattern(arg1[2]);
      }
      const obj = {};
      obj[DETimeUnitAgoFormatParser(10569).TIME_UNIT_DICTIONARY[arg1[4].toLowerCase(arg1[4])]] = num;
