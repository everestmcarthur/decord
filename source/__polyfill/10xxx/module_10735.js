// Module ID: 10735
// Function ID: 10736
// Dependencies: [41, 42, 93, 95, 96, 98, 10554, 10574]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10554).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10554).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
