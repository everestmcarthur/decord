...
const keys = Object.keys(_mod10638.NUMBER);
...
const keys1 = Object.keys(_mod10638.NUMBER);
...
const keys2 = Object.keys(_mod10638.NUMBER);
const regExp = new RegExp(text1 + "]+)?(?:\\s*)(?:\u5206|:|\uFF1A)?(?:\\s*)(\\d+|[" + keys2.join("") + "]+)?(?:\\s*)(?:\u79D2)?)(?:\\s*(A.M.|P.M.|AM?|PM?))?", "i");
const keys3 = Object.keys(_mod10638.NUMBER);
...
const keys4 = Object.keys(_mod10638.NUMBER);
...
const keys5 = Object.keys(_mod10638.NUMBER);
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (index[1]) {
        ...
        if (index[8]) {
          ...
          if (isNaN(parsed)) {
            zhStringToNumberResult = ZHHantTimeExpressionParser(10638).zhStringToNumber(index[8]);
          }
        ...
        const _isNaN2 = isNaN;
        if (isNaN(parsed1)) {
          parsed1 = ZHHantTimeExpressionParser(10638).zhStringToNumber(index[6]);
        }
        if (index[7]) {
          let num17 = 30;
          let rounded = parsed1;
          if ("\u534A" != index[7]) {
            ...
            if ("\u6B63" != index[7]) {
              ...
              if ("\u6574" != index[7]) {
                ...
                rounded = parsed1;
                if (isNaN(parsed2)) {
                  num17 = ZHHantTimeExpressionParser(10638).zhStringToNumber(index[7]);
                  rounded = parsed1;
                }
              }
            }
          ...
          if (match) {
            ...
            if (match[1]) {
              ...
              if (match[8]) {
                ...
                if (isNaN(parsed3)) {
                  zhStringToNumberResult1 = ZHHantTimeExpressionParser(10638).zhStringToNumber(match[8]);
                }
              ...
              const _isNaN5 = isNaN;
              if (isNaN(parsed4)) {
                parsed4 = ZHHantTimeExpressionParser(10638).zhStringToNumber(match[6]);
              }
              if (match[7]) {
                let num38 = 30;
                ...
                if ("\u534A" != match[7]) {
                  ...
                  if ("\u6B63" != match[7]) {
                    ...
                    if ("\u6574" != match[7]) {
                      ...
                      rounded1 = parsed4;
                      if (isNaN(parsed5)) {
                        num38 = ZHHantTimeExpressionParser(10638).zhStringToNumber(match[7]);
                        rounded1 = parsed4;
                      }
                    }
                  }
