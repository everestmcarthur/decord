...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ParsingComponents.createRelativeFromReference(reference.reference, UKTimeUnitAgoFormatParser(10575).reverseDuration(UKTimeUnitAgoFormatParser(10727).parseDuration(arg1[1])));
    }
  }
];
