// Module ID: 10684
// Function ID: 10685
// Dependencies: [41, 42, 93, 95, 98, 10502, 10671, 10529, 10509]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:il\\s*?)?(?:(questa|l'ultima|scorsa|prossima)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10671.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(questa|l'ultima|scorsa|prossima)\\s*settimana)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ITWeekdayParser(10529).createParsingComponentsAtWeekday(reference.reference, ITWeekdayParser(10671).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
