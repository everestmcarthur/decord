// Module ID: 10684
// Function ID: 10685
// Dependencies: [41, 42, 93, 95, 98, 10581, 10675, 10584, 10588]
...
const regExp = new RegExp("(dit|deze|(?:aan)?komend|volgend|afgelopen|vorig)e?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10675.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLRelativeDateFormatParser(10675).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp2(10584).ParsingComponents;
