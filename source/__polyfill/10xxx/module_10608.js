// Module ID: 10608
// Function ID: 10609
// Dependencies: [10584, 10586]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10608
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10584 */;
import Meridiem from "Meridiem" /* 10586 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10586).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10586).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10586).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10586).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
