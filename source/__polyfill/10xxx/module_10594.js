// Module ID: 10594
// Function ID: 10595
// Dependencies: [41, 42, 93, 95, 96, 98, 10586, 10595]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10586).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10586).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
