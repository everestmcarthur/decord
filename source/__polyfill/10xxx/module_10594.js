          ...
          if (tmp6 >= 1) {
            if (tmp6 <= 31) {
              ...
              if (index[4]) {
                ...
                start2.assign("year", SlashDateFormatParser(10566).findMostLikelyADYear(parsed2));
              } else {
                const start = parsingResult.start;
                start.imply("year", SlashDateFormatParser(10566).findYearClosestToRef(text.refDate, tmp6, tmp7));
              }
