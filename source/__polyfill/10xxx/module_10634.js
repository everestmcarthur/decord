// Module ID: 10634
// Function ID: 10635
// Dependencies: [41, 42, 93, 95, 98, 10573, 10635, 10600, 10580]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(?:ce)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10635.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(dernier|prochain)\\s*)?(?=\\W|\\d|$)", "i");
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (undefined === tmp4) {
        ...
        return tmp2(10600).createParsingComponentsAtWeekday(reference.reference, tmp4, str4);
      }
