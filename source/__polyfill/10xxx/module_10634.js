// Module ID: 10634
// Function ID: 10635
// Dependencies: [41, 42, 93, 95, 98, 10627, 10581, 10583, 10584, 10588]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:\\s*((?:n\u00E4chste|kommende|folgende|letzte|vergangene|vorige|vor(?:her|an)gegangene)(?:s|n|m|r)?|vor|in)\\s*)?(" + DETimeUnitAgoFormatParser(10627).NUMBER_PATTERN + ")?(?:\\s*(n\u00E4chste|kommende|folgende|letzte|vergangene|vorige|vor(?:her|an)gegangene)(?:s|n|m|r)?)?\\s*(" + DETimeUnitAgoFormatParser(10581).matchAnyPattern(DETimeUnitAgoFormatParser(10627).TIME_UNIT_DICTIONARY) + ")", "i");
    return regExp;
  }
};
const items = [
