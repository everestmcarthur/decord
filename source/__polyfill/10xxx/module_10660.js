// Module ID: 10660
// Function ID: 10661
// Dependencies: [41, 42, 93, 95, 98, 10565, 10659, 10592, 10572]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:op\\s*?)?(?:(deze|vorige|volgende)\\s*(?:week\\s*)?)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10659.WEEKDAY_DICTIONARY) + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return NLWeekdayParser(10592).createParsingComponentsAtWeekday(reference.reference, NLWeekdayParser(10659).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
