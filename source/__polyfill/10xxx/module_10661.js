// Module ID: 10661
// Function ID: 10662
// Dependencies: [41, 42, 93, 95, 98, 10547, 10529, 10654]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    _inherits(RUCasualTimeParser, _mod10654.AbstractParserWithLeftRightBoundaryChecking);
    const entry = {
                    ...
                    if (!str2.endsWith("\u0443\u0442\u0440\u0430")) {
                      if (str2.match(/в\s*полдень/)) {
                        ...
                        if (str2.match(/следующей\s*ночью/)) {
                          ...
                          RUCasualTimeParser(10529).assignSimilarDate(parsingComponents, date);
