// Module ID: 10663
// Function ID: 10664
// Dependencies: [41, 42, 93, 95, 98, 10560, 10654, 10563, 10567]
...
const regExp = new RegExp("(dit|deze|(?:aan)?komend|volgend|afgelopen|vorig)e?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10654.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLRelativeDateFormatParser(10654).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp2(10563).ParsingComponents;
