// Module ID: 10850
// Function ID: 10851
// Dependencies: [41, 42, 93, 95, 96, 98, 10669, 10689]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10669).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10669).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
