// Module ID: 10670
// Function ID: 10671
// Dependencies: [41, 42, 93, 95, 98, 10573, 10667, 10574, 10580]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10667.MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + _mod10667.YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLMonthNameParser(10667).MONTH_DICTIONARY[arg1[1].toLowerCase(arg1[1])];
      parsingComponents.assign("month", tmp4);
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10667).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10574).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
