// Module ID: 10745
// Function ID: 10746
// Dependencies: [41, 42, 93, 95, 98, 10729, 10562, 10563, 10579]
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, text, start) {
      const parseDurationResult = ENMergeRelativeDateRefiner(10729).parseDuration(text.text);
      ...
      return new ENMergeRelativeDateRefiner(10563).ParsingResult(start.reference, text.index, "" + text.text + arg0 + start.text, relativeFromReference);
    }
  }
];
