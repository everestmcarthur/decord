// Module ID: 10603
// Function ID: 10604
// Dependencies: [41, 42, 93, 95, 98, 10572, 10575, 10576, 10580]
...
const regExp = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10572.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10572.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = ENTimeUnitCasualRelativeFormatParser(10572).parseDuration(arg1[2]);
