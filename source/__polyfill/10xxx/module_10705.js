// Module ID: 10705
// Function ID: 10706
// Dependencies: [41, 42, 93, 95, 98, 10674, 10677, 10678, 10682]
...
const regExp = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10674.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10674.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = ENTimeUnitCasualRelativeFormatParser(10674).parseDuration(arg1[2]);
