// Module ID: 10566
// Function ID: 10567
// Dependencies: [41, 42, 93, 95, 98, 10521, 10567, 10548, 10528]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:a[mn]\\s*?)?(?:(diese[mn]|letzte[mn]|n(?:\u00E4|ae)chste[mn])\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10567.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(diese|letzte|n(?:\u00E4|ae)chste)\\s*woche)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return DEWeekdayParser(10548).createParsingComponentsAtWeekday(reference.reference, DEWeekdayParser(10567).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
