// Module ID: 10518
// Function ID: 10519
// Dependencies: [41, 42, 93, 95, 98, 10510, 10467, 10471]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:in|f\u00FCr|w\u00E4hrend)\\s*(" + DETimeUnitWithinFormatParser(10510).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = DETimeUnitWithinFormatParser(10467).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, DETimeUnitWithinFormatParser(10510).parseDuration(arg1[1]));
    }
  }
];
