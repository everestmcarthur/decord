// Module ID: 10615
// Function ID: 10616
// Dependencies: [41, 42, 93, 95, 98, 10608, 10467, 10471]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:en|por|durante|de|dentro de)\\s*(" + ESTimeUnitWithinFormatParser(10608).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = ESTimeUnitWithinFormatParser(10467).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, ESTimeUnitWithinFormatParser(10608).parseDuration(arg1[1]));
    }
  }
];
