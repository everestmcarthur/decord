// Module ID: 10748
// Function ID: 10749
// Dependencies: [41, 42, 93, 95, 96, 98, 10567, 10587]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10567).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10567).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
