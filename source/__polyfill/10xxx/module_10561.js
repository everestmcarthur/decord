// Module ID: 10561
// Function ID: 10562
// Dependencies: [41, 42, 93, 95, 98, 10464, 10558, 10465, 10471]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10558.MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + _mod10558.YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLMonthNameParser(10558).MONTH_DICTIONARY[arg1[1].toLowerCase(arg1[1])];
      parsingComponents.assign("month", tmp4);
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10558).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10465).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
