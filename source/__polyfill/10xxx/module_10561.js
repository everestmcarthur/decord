// Module ID: 10561
// Function ID: 10562
// Dependencies: [41, 42, 10562, 10568]

// Module 10561
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10562 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10568).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10568).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10568).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10568).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10568).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
