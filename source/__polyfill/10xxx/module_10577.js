// Module ID: 10577
// Function ID: 10578
// Dependencies: [41, 42, 10578, 10584]

// Module 10577
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10578 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10584).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10584).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10584).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10584).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10584).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
