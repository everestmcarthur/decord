// Module ID: 10759
// Function ID: 10760
// Dependencies: [10569, 10576, 10578, 10602, 10614, 10760, 10762, 10763, 10764, 10609]
...
fn(_mod10762);
fn(_mod10763);
const _isNativeReflectConstruct = fn(_mod10764);
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("module_10569").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
