// Module ID: 10537
// Function ID: 10538
// Dependencies: [41, 42, 10534, 10491]
...
const items = [
  entry,
  {
    ...
    value: function extract(reference, groups) {
      const tmp3 = JPWeekdayParser(10534).WEEKDAY_OFFSET[groups.groups.weekday];
      if (undefined === tmp3) {
        return null;
      } else {
        let str2 = "last";
        ...
        return tmp(10491).createParsingComponentsAtWeekday(reference.reference, tmp3, str2);
      }
      tmp = JPWeekdayParser;
    }
  }
