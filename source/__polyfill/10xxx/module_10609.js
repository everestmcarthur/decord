// Module ID: 10609
// Function ID: 10610
// Dependencies: [41, 42, 93, 95, 98, 10581, 10580, 10584, 10588]
...
const regExp = new RegExp("(this|last|past|next|after\\s*this)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10580.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ENRelativeDateFormatParser(10580).TIME_UNIT_DICTIONARY[str3];
      if ("next" != formatted) {
