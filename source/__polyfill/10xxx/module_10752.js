// Module ID: 10752
// Function ID: 10753
// Dependencies: [41, 42, 93, 95, 98, 10565, 10753, 10592, 10572]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10753.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10592).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10753).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
