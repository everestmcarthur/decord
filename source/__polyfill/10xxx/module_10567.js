// Module ID: 10567
// Function ID: 10568
// Dependencies: [10568, 10569, 10576, 10578, 10616, 10628, 10641, 10652, 10661, 10679, 10700, 10715, 10725, 10740, 10759]

// Module 10567
import Chrono from "Chrono" /* 10568 */;
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_10569").ParsingContext;
          }
    };
    ...
    exports.de = fn(_mod10616);
    exports.fr = fn(_mod10628);
    exports.ja = fn(_mod10641);
    exports.pt = fn(_mod10652);
    exports.nl = fn(_mod10661);
    exports.zh = fn(_mod10679);
    exports.ru = fn(_mod10700);
    exports.es = fn(_mod10715);
    exports.uk = fn(_mod10725);
    exports.it = fn(_mod10740);
    exports.sv = fn(_mod10759);
