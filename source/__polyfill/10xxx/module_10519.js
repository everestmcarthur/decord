// Module ID: 10519
// Function ID: 10520
// Dependencies: [41, 42, 10520, 10526]

// Module 10519
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10520 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10526).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10526).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10526).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10526).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10526).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
