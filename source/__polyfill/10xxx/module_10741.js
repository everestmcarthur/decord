// Module ID: 10741
// Function ID: 10742
// Dependencies: [41, 42, 93, 95, 98, 10554, 10566, 10567]
  ...
  entry,
  {
    ...
    value: function innerExtract(refDate, arg1) {
      ...
      if ("pomeriggio" === formatted) {
        parsingComponents.imply("meridiem", ITCasualTimeParser(10554).Meridiem.PM);
        ...
        if ("sera" !== formatted) {
          if ("notte" !== formatted) {
            if ("mezzanotte" === formatted) {
              ...
              ITCasualTimeParser(10566).assignSimilarDate(parsingComponents, date);
              ITCasualTimeParser(10566).implySimilarTime(parsingComponents, date);
              parsingComponents.imply("hour", 0);
              parsingComponents.imply("minute", 0);
              parsingComponents.imply("second", 0);
            } else if ("mattina" === formatted) {
              parsingComponents.imply("meridiem", ITCasualTimeParser(10554).Meridiem.AM);
