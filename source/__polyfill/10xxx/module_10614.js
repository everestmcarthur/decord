// Module ID: 10614
// Function ID: 10615
// Dependencies: [41, 42, 93, 95, 98, 10606, 10563, 10567]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:in|f\u00FCr|w\u00E4hrend)\\s*(" + DETimeUnitWithinFormatParser(10606).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ParsingComponents.createRelativeFromReference(reference.reference, DETimeUnitWithinFormatParser(10606).parseDuration(arg1[1]));
    }
  }
];
