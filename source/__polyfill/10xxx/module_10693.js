// Module ID: 10693
// Function ID: 10694
// Dependencies: [41, 42, 93, 95, 96, 98, 10689, 10565, 10574]
...
const entry = {
  ...
  value: function patternFlags() {
    return RUTimeExpressionParser(10689).REGEX_PARTS.flags;
  }
};
let items = [
  entry,
  ...
  },
  {
    ...
    value: function primarySuffix() {
      return "(?:\\s*(?:\u0443\u0442\u0440\u0430|\u0432\u0435\u0447\u0435\u0440\u0430|\u043F\u043E\u0441\u043B\u0435 \u043F\u043E\u043B\u0443\u0434\u043D\u044F))?(?!\\/)" + RUTimeExpressionParser(10689).REGEX_PARTS.rightBoundary;
    }
  },
  {
        ...
        if (first.endsWith("\u0432\u0435\u0447\u0435\u0440\u0430")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", RUTimeExpressionParser(10565).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", RUTimeExpressionParser(10565).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
