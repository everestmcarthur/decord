// Module ID: 10573
// Function ID: 10574
// Dependencies: [41, 42, 93, 95, 96, 98, 10565, 10574]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10565).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10565).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
