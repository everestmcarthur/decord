// Module ID: 10637
// Function ID: 10638
// Dependencies: [41, 42, 93, 95, 98, 10605, 10587, 10586, 10588]
      ...
      value: function innerExtract(refDate, arg1) {
            ...
            if ("maintenant" === str2) {
              ...
              if (str2.match(/cette\s*nuit/)) {
                FRCasualDateParser(10587).assignSimilarDate(parsingComponents, refDate);
                parsingComponents.imply("hour", 22);
                parsingComponents.imply("meridiem", FRCasualDateParser(10586).Meridiem.PM);
              } else if (str2.match(/la\s*veille/)) {
                const _Date = Date;
                const date = new Date(refDate.getTime());
                date.setDate(date.getDate() - 1);
                FRCasualDateParser(10587).assignSimilarDate(parsingComponents, date);
