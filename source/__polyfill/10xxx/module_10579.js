// Module ID: 10579
// Function ID: 10580
// Dependencies: [41, 42, 93, 95, 98, 10547, 10529, 10528, 10530]
      ...
      value: function innerExtract(refDate, arg1) {
            ...
            if ("maintenant" === str2) {
              ...
              if (str2.match(/cette\s*nuit/)) {
                FRCasualDateParser(10529).assignSimilarDate(parsingComponents, refDate);
                parsingComponents.imply("hour", 22);
                parsingComponents.imply("meridiem", FRCasualDateParser(10528).Meridiem.PM);
              } else if (str2.match(/la\s*veille/)) {
                const _Date = Date;
                const date = new Date(refDate.getTime());
                date.setDate(date.getDate() - 1);
                FRCasualDateParser(10529).assignSimilarDate(parsingComponents, date);
