// Module ID: 10520
// Function ID: 10521
// Dependencies: [41, 42, 93, 95, 98, 10488, 10470, 10469, 10471]
      ...
      value: function innerExtract(refDate, arg1) {
            ...
            if ("maintenant" === str2) {
              ...
              if (str2.match(/cette\s*nuit/)) {
                FRCasualDateParser(10470).assignSimilarDate(parsingComponents, refDate);
                parsingComponents.imply("hour", 22);
                parsingComponents.imply("meridiem", FRCasualDateParser(10469).Meridiem.PM);
              } else if (str2.match(/la\s*veille/)) {
                const _Date = Date;
                const date = new Date(refDate.getTime());
                date.setDate(date.getDate() - 1);
                FRCasualDateParser(10470).assignSimilarDate(parsingComponents, date);
