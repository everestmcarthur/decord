// Module ID: 10520
// Function ID: 10521
// Dependencies: [41, 42, 93, 95, 98, 10504, 10521]
      ...
      if (dateResult > start6.date()) {
        ...
        if (start20.isOnlyWeekdayComponent()) {
          if (AbstractMergeDateRangeRefiner(10504).addDuration(dateResult2, { day: 7 }) > dateResult1) {
            const addDurationResult = tmp6(10504).addDuration(dateResult2, { day: 7 });
        ...
        if (start7.isOnlyWeekdayComponent()) {
          if (AbstractMergeDateRangeRefiner(10504).addDuration(dateResult1, { day: -7 }) < dateResult2) {
            const addDurationResult1 = tmp8(10504).addDuration(dateResult1, { day: -7 });
        ...
        if (start8.isDateWithUnknownYear()) {
          if (AbstractMergeDateRangeRefiner(10504).addDuration(dateResult2, { year: 1 }) > dateResult1) {
            ...
            start11.imply("year", tmp10(10504).addDuration(dateResult2, { year: 1 }).getFullYear());
            tmp5 = start2;
            obj = start;
            const addDurationResult2 = tmp10(10504).addDuration(dateResult2, { year: 1 });
          }
        ...
        if (start9.isDateWithUnknownYear()) {
          if (AbstractMergeDateRangeRefiner(10504).addDuration(dateResult1, { year: -1 }) < dateResult2) {
            ...
            start10.imply("year", tmp12(10504).addDuration(dateResult1, { year: -1 }).getFullYear());
            tmp5 = start2;
            obj = start;
            const addDurationResult3 = tmp12(10504).addDuration(dateResult1, { year: -1 });
          }
