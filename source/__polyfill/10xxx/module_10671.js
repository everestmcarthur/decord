    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (index[1]) {
        ...
        if (index[8]) {
          ...
          if (isNaN(parsed)) {
            zhStringToNumberResult = ZHHansTimeExpressionParser(10668).zhStringToNumber(index[8]);
          }
        ...
        const _isNaN2 = isNaN;
        if (isNaN(parsed1)) {
          parsed1 = ZHHansTimeExpressionParser(10668).zhStringToNumber(index[6]);
        }
        if (index[7]) {
          let num17 = 30;
          let rounded = parsed1;
          if ("\u534A" != index[7]) {
            ...
            if ("\u6B63" != index[7]) {
              ...
              if ("\u6574" != index[7]) {
                ...
                rounded = parsed1;
                if (isNaN(parsed2)) {
                  num17 = ZHHansTimeExpressionParser(10668).zhStringToNumber(index[7]);
                  rounded = parsed1;
                }
              }
            }
          ...
          if (match) {
            ...
            if (match[1]) {
              ...
              if (match[8]) {
                ...
                if (isNaN(parsed3)) {
                  zhStringToNumberResult1 = ZHHansTimeExpressionParser(10668).zhStringToNumber(match[8]);
                }
              ...
              const _isNaN5 = isNaN;
              if (isNaN(parsed4)) {
                parsed4 = ZHHansTimeExpressionParser(10668).zhStringToNumber(match[6]);
              }
              if (match[7]) {
                let num38 = 30;
                ...
                if ("\u534A" != match[7]) {
                  ...
                  if ("\u6B63" != match[7]) {
                    ...
                    if ("\u6574" != match[7]) {
                      ...
                      rounded1 = parsed4;
                      if (isNaN(parsed5)) {
                        num38 = ZHHansTimeExpressionParser(10668).zhStringToNumber(match[7]);
                        rounded1 = parsed4;
                      }
                    }
                  }
