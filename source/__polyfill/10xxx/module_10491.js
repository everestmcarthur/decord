// Module ID: 10491
// Function ID: 10492
// Dependencies: [10467, 10469]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10491
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10467 */;
import Meridiem from "Meridiem" /* 10469 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10469).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10469).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10469).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10469).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
