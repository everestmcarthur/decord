// Module ID: 10756
// Function ID: 10757
// Dependencies: [41, 42, 93, 95, 98, 10573, 10742, 10576, 10580]
...
const regExp = new RegExp("(questo|ultimo|scorso|prossimo|dopo\\s*questo|questa|ultima|scorsa|prossima\\s*questa)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10742.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ITRelativeDateFormatParser(10742).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp(10576).ParsingComponents;
