// Module ID: 10756
// Function ID: 10757
// Dependencies: [41, 42, 93, 95, 96, 98, 10575, 10595]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10575).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10575).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
