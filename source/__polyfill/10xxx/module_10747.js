// Module ID: 10747
// Function ID: 10748
// Dependencies: [41, 42, 93, 95, 98, 10560, 10748, 10587, 10567]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10748.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10587).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10748).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
