// Module ID: 10517
// Function ID: 10518
// Dependencies: [41, 42, 10518, 10524]

// Module 10517
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10518 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10524).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10524).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10524).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10524).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10524).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
