// Module ID: 10767
// Function ID: 10768
// Dependencies: [10577, 10584, 10586, 10610, 10622, 10768, 10770, 10771, 10772, 10617]
...
fn(_mod10770);
fn(_mod10771);
const _isNativeReflectConstruct = fn(_mod10772);
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("module_10577").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
