// Module ID: 10492
// Function ID: 10493
// Dependencies: [41, 42, 93, 95, 98, 10464, 10463, 10467, 10471]
...
const regExp = new RegExp("(this|last|past|next|after\\s*this)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10463.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ENRelativeDateFormatParser(10463).TIME_UNIT_DICTIONARY[str3];
      if ("next" != formatted) {
