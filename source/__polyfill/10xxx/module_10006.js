// Module ID: 10006
// Function ID: 10007
// Dependencies: [10007, 10009, 10011, 10012, 10013]

// Module 10006
import QR8bitByte from "QR8bitByte" /* 10007 */;
import QRRSBlock from "QRRSBlock" /* 10009 */;
import QRBitBuffer from "QRBitBuffer" /* 10011 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10012.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10012.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10012.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
