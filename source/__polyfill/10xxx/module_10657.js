// Module ID: 10657
// Function ID: 10658
// Dependencies: [41, 42, 93, 95, 98, 10560, 10654, 10561, 10567]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10654.MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + _mod10654.YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLMonthNameParser(10654).MONTH_DICTIONARY[arg1[1].toLowerCase(arg1[1])];
      parsingComponents.assign("month", tmp4);
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10654).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10561).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
