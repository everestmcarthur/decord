// Module ID: 10713
// Function ID: 10714
// Dependencies: [41, 42, 93, 95, 98, 10581, 10710, 10582, 10712]
...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return "((?:\u0432)\\s*)?(" + RUMonthNameParser(10581).matchAnyPattern(RUMonthNameParser(10710).MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + RUMonthNameParser(10710).YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)";
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (index[3]) {
        ...
        start4.assign("year", tmp7(10710).parseYear(index[3]));
      } else {
