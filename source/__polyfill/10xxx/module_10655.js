// Module ID: 10655
// Function ID: 10656
// Dependencies: [41, 42, 93, 95, 98, 10656, 10505, 10509]
...
let closure_6 = "(?:(?:\u043F\u0440\u0438\u0431\u043B\u0438\u0437\u043D\u043E|\u043E\u0440\u0456\u0454\u043D\u0442\u043E\u0432\u043D\u043E)\\s*(?:~\\s*)?)?(" + _mod10656.TIME_UNITS_PATTERN + ")" + _mod10656.REGEX_PARTS.rightBoundary;
...
const entry = {
  ...
  value: function patternLeftBoundary() {
    return UKTimeUnitWithinFormatParser(10656).REGEX_PARTS.leftBoundary;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerPattern(option) {
      ...
      if (option.option.forwardDate) {
        ...
        _RegExp1 = new _RegExp(combined, UKTimeUnitWithinFormatParser(10656).REGEX_PARTS.flags);
      }
      return _RegExp1;
    }
  },
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = UKTimeUnitWithinFormatParser(10505).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, UKTimeUnitWithinFormatParser(10656).parseDuration(arg1[1]));
    }
  }
];
