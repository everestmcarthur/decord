// Module ID: 10696
// Function ID: 10697
// Dependencies: [41, 42, 93, 95, 96, 98, 10515, 10535]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10515).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10515).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
