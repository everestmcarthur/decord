// Module ID: 10590
// Function ID: 10591
// Dependencies: [41, 42, 93, 95, 98, 10559, 10562, 10563, 10567]
...
const regExp = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10559.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10559.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = ENTimeUnitCasualRelativeFormatParser(10559).parseDuration(arg1[2]);
