// Module ID: 10591
// Function ID: 10592
// Dependencies: [10592, 10594, 10595, 10596, 10597, 10598, 10599, 10519, 10526, 10528, 10600, 10601, 10565, 10559]
// Exports: createCasualConfiguration, parse, parseDate

// Module 10591
import includeCommonConfiguration from "includeCommonConfiguration" /* 10559 */;
import _mod10565 from "module_10565" /* 10565 */;
import JPStandardParser2 from "JPStandardParser" /* 10592 */;
...
function createCasualConfiguration() {
  ...
  parsers.unshift(new module_10595.default());
  return tmp;
}
const JPStandardParser = fn(JPStandardParser2);
fn(_mod10594);
const module_10595 = fn(_mod10595);
fn(_mod10596);
fn(_mod10597);
fn(_mod10598);
fn(_mod10599);
fn(_mod10600);
const regExp = fn(_mod10601);
