// Module ID: 10610
// Function ID: 10611
// Dependencies: [41, 42, 93, 95, 98, 10565, 10611, 10592, 10572]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:a[mn]\\s*?)?(?:(diese[mn]|letzte[mn]|n(?:\u00E4|ae)chste[mn])\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10611.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(diese|letzte|n(?:\u00E4|ae)chste)\\s*woche)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return DEWeekdayParser(10592).createParsingComponentsAtWeekday(reference.reference, DEWeekdayParser(10611).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
