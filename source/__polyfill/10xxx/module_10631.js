// Module ID: 10631
// Function ID: 10632
// Dependencies: [41, 42, 93, 95, 98, 10627, 10568, 10572]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:dans|en|pour|pendant|de)\\s*(" + FRTimeUnitWithinFormatParser(10627).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = FRTimeUnitWithinFormatParser(10568).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, FRTimeUnitWithinFormatParser(10627).parseDuration(arg1[1]));
    }
  }
];
