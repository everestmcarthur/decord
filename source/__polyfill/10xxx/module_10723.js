// Module ID: 10723
// Function ID: 10724
// Dependencies: [41, 42, 93, 95, 96, 98, 10719, 10570, 10579]

// Module 10723
import AbstractTimeExpressionParser from "AbstractTimeExpressionParser" /* 10579 */;
...
const entry = {
  ...
  value: function patternFlags() {
    return UKTimeExpressionParser(10719).REGEX_PARTS.flags;
  }
};
let items = [
  entry,
  ...
  },
  {
    ...
    value: function primarySuffix() {
      return "(?:\\s*(?:\u0440\u0430\u043D\u043A\u0443|\u0432\u0435\u0447\u043E\u0440\u0430|\u043F\u043E \u043E\u0431\u0456\u0434\u0456|\u043F\u0456\u0441\u043B\u044F \u043E\u0431\u0456\u0434\u0443))?(?!\\/)" + UKTimeExpressionParser(10719).REGEX_PARTS.rightBoundary;
    }
  },
  {
        ...
        if (first.endsWith("\u0432\u0435\u0447\u043E\u0440\u0430")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", UKTimeExpressionParser(10570).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", UKTimeExpressionParser(10570).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
