// Module ID: 10703
// Function ID: 10704
// Dependencies: [41, 42, 93, 95, 98, 10675, 10674, 10678, 10682]
...
const regExp = new RegExp("(this|last|past|next|after\\s*this)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10674.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ENRelativeDateFormatParser(10674).TIME_UNIT_DICTIONARY[str3];
      if ("next" != formatted) {
