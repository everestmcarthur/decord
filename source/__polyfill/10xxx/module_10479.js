// Module ID: 10479
// Function ID: 10480
// Dependencies: [41, 42, 93, 95, 98, 10463, 10467, 10466, 10471]
...
const regExp1 = new RegExp("(" + _mod10463.TIME_UNITS_NO_ABBR_PATTERN + ")\\s{0,5}(?:ago|before|earlier)(?=\\W|$)", "i");
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (parseDurationResult) {
        ...
        relativeFromReference = ParsingComponents.createRelativeFromReference(reference.reference, tmp(10466).reverseDuration(parseDurationResult));
      }
