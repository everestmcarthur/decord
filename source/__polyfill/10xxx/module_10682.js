// Module ID: 10682
// Function ID: 10683
// Dependencies: [41, 42, 93, 95, 98, 10681, 10575, 10580]
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (isNaN(num)) {
        num = ZHHansDeadlineFormatParser(10681).zhStringToNumber(index[1]);
      }
      if (isNaN(num)) {
        num = 3;
        if ("\u51E0" !== index[1]) {
      ...
      if (index[2][0].match(/[日天星礼月年]/)) {
        if ("\u65E5" != str3) {
          ...
          const addDurationResult = ZHHansDeadlineFormatParser(10575).addDuration(createParsingResult.refDate, obj);
        ...
        const addDurationResult1 = ZHHansDeadlineFormatParser(10575).addDuration(createParsingResult.refDate, obj);
