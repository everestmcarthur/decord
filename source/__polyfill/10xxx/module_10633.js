// Module ID: 10633
// Function ID: 10634
// Dependencies: [41, 42, 93, 95, 98, 10581, 10627, 10582, 10588]
...
const regExp = new RegExp("(?:am\\s*?)?(?:den\\s*?)?([0-9]{1,2})\\.(?:\\s*(?:bis(?:\\s*(?:am|zum))?|\\-|\\\u2013|\\s)\\s*([0-9]{1,2})\\.?)?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10627.MONTH_DICTIONARY) + ")(?:(?:-|/|,?\\s*)(" + _mod10627.YEAR_PATTERN + "(?![^\\s]\\d)))?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      const tmp4 = DEMonthNameLittleEndianParser(10627).MONTH_DICTIONARY[index[3].toLowerCase(index[3])];
