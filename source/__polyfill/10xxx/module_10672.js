// Module ID: 10672
// Function ID: 10673
// Dependencies: [41, 42, 93, 95, 98, 10671, 10502, 10503, 10509]
...
const regExp = new RegExp("(?:on\\s{0,3})?(" + _mod10671.ORDINAL_NUMBER_PATTERN + ")(?:\\s{0,3}(?:al|\\-|\\\u2013|fino|alle|allo)?\\s{0,3}(" + _mod10671.ORDINAL_NUMBER_PATTERN + "))?(?:-|/|\\s{0,3}(?:dal)?\\s{0,3})(" + repeatedTimeunitPattern.matchAnyPattern(_mod10671.MONTH_DICTIONARY) + ")(?:(?:-|/|,?\\s{0,3})(" + _mod10671.YEAR_PATTERN + "(?![^\\s]\\d)))?(?=\\W|$)", "i");
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10671).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10671).parseOrdinalNumberPattern(index[2]);
