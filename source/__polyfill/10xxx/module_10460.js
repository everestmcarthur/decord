// Module ID: 10460
// Function ID: 10461
// Dependencies: [41, 42, 10461, 10467]

// Module 10460
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10461 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      } else if (!(extractResult instanceof tmp6(10467).ParsingComponents)) {
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10467).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
