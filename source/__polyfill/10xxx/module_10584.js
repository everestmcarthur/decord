// Module ID: 10584
// Function ID: 10585
// Dependencies: [41, 42, 93, 95, 98, 10573, 10572, 10580]
...
const regExp = new RegExp("([0-9]{4})[-\\.\\/\\s](?:(" + repeatedTimeunitPattern.matchAnyPattern(_mod10572.MONTH_DICTIONARY) + ")|([0-9]{1,2}))[-\\.\\/\\s]([0-9]{1,2})(?=\\W|$)", "i");
  ...
  entry,
  {
    ...
    value: function innerExtract(arg0, arg1) {
      ...
      if (arg1[3]) {
        ...
        parsed2 = ENYearMonthDayParser(10572).MONTH_DICTIONARY[str.toLowerCase(str)];
      }
      if (parsed2 < 1) {
        const self = this;
