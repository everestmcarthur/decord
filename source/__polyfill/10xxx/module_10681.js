// Module ID: 10681
// Function ID: 10682
// Dependencies: [41, 42, 93, 95, 98, 10680, 10567, 10572]
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (isNaN(num)) {
        num = ZHHantDeadlineFormatParser(10680).zhStringToNumber(index[1]);
      }
      if (isNaN(num)) {
        num = 3;
        if ("\u5E7E" !== index[1]) {
      ...
      if (index[2][0].match(/[日天星禮月年]/)) {
        if ("\u65E5" != str3) {
          ...
          const addDurationResult = ZHHantDeadlineFormatParser(10567).addDuration(createParsingResult.refDate, obj);
        ...
        const addDurationResult1 = ZHHantDeadlineFormatParser(10567).addDuration(createParsingResult.refDate, obj);
