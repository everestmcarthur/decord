// Module ID: 10681
// Function ID: 10682
// Dependencies: [41, 42, 93, 95, 98, 10581, 10675, 10588]
...
const regExp = new RegExp("([0-9]{4})[\\.\\/\\s](?:(" + repeatedTimeunitPattern.matchAnyPattern(_mod10675.MONTH_DICTIONARY) + ")|([0-9]{1,2}))[\\.\\/\\s]([0-9]{1,2})(?=\\W|$)", "i");
  ...
  entry,
  {
    ...
    value: function innerExtract(arg0, arg1) {
      if (arg1[3]) {
        ...
        parsed = NLCasualYearMonthDayParser(10675).MONTH_DICTIONARY[str.toLowerCase(str)];
      }
      if (parsed >= 1) {
        if (parsed <= 12) {
