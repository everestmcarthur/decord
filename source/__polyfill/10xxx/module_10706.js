// Module ID: 10706
// Function ID: 10707
// Dependencies: [41, 42, 93, 95, 96, 98, 10702, 10578, 10587]
...
const entry = {
  ...
  value: function patternFlags() {
    return RUTimeExpressionParser(10702).REGEX_PARTS.flags;
  }
};
let items = [
  entry,
  ...
  },
  {
    ...
    value: function primarySuffix() {
      return "(?:\\s*(?:\u0443\u0442\u0440\u0430|\u0432\u0435\u0447\u0435\u0440\u0430|\u043F\u043E\u0441\u043B\u0435 \u043F\u043E\u043B\u0443\u0434\u043D\u044F))?(?!\\/)" + RUTimeExpressionParser(10702).REGEX_PARTS.rightBoundary;
    }
  },
  {
        ...
        if (first.endsWith("\u0432\u0435\u0447\u0435\u0440\u0430")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", RUTimeExpressionParser(10578).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", RUTimeExpressionParser(10578).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
