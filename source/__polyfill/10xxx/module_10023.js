// Module ID: 10023
// Function ID: 10024
// Dependencies: [10024, 10025, 10019]

// Module 10023
import _mod10019 from "module_10019" /* 10019 */;
import QRPolynomial from "QRPolynomial" /* 10024 */;
import array2 from "array2" /* 10025 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod10019.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(10019).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(10019).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(10019).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod10019.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(10019).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(10019).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(10019).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod10019.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(10019).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(10019).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(10019).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
