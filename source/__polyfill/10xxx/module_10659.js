// Module ID: 10659
// Function ID: 10660
// Dependencies: [41, 42, 93, 95, 98, 10545, 10527, 10652]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    _inherits(RUCasualTimeParser, _mod10652.AbstractParserWithLeftRightBoundaryChecking);
    const entry = {
                    ...
                    if (!str2.endsWith("\u0443\u0442\u0440\u0430")) {
                      if (str2.match(/в\s*полдень/)) {
                        ...
                        if (str2.match(/следующей\s*ночью/)) {
                          ...
                          RUCasualTimeParser(10527).assignSimilarDate(parsingComponents, date);
