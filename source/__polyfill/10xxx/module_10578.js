// Module ID: 10578
// Function ID: 10579
// Dependencies: [41, 42, 93, 95, 96, 98, 10570, 10579]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10570).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10570).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
