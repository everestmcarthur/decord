// Module ID: 10709
// Function ID: 10710
// Dependencies: [10519, 10526, 10528, 10552, 10564, 10710, 10712, 10713, 10714, 10559]
...
fn(_mod10712);
fn(_mod10713);
const _isNativeReflectConstruct = fn(_mod10714);
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("module_10519").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
