// Module ID: 10477
// Function ID: 10478
// Dependencies: [41, 42, 93, 95, 96, 98, 10469, 10478]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10469).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10469).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
