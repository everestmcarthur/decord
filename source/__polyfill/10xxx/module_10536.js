// Module ID: 10536
// Function ID: 10537
// Dependencies: [41, 42, 93, 95, 96, 98, 10528, 10537]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10528).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10528).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
