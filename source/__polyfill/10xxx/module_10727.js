// Module ID: 10727
// Function ID: 10728
// Dependencies: [10728, 10730, 10731, 10732, 10733, 10734, 10735, 10736, 10737, 10738, 10739, 10740, 10741, 10742, 10743, 10589, 10744, 10745, 10556, 10596]
...
fn(_mod10744);
const _isNativeReflectConstruct = fn(_mod10745);
...
parsers4.unshift(new _isNativeReflectConstruct.default());
const chrono = new _mod10556.Chrono(configuration);
const chrono1 = new _mod10556.Chrono(createConfiguration(true, false));
const chrono2 = new _mod10556.Chrono(createConfiguration(false, true));
