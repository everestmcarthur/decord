// Module ID: 10498
// Function ID: 10499
// Dependencies: [41, 42, 10499, 10505]

// Module 10498
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10499 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10505).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10505).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10505).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10505).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10505).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
