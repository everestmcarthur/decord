// Module ID: 10626
// Function ID: 10627
// Dependencies: [41, 42, 93, 95, 98, 10581, 10627, 10608, 10588]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:a[mn]\\s*?)?(?:(diese[mn]|letzte[mn]|n(?:\u00E4|ae)chste[mn])\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10627.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(diese|letzte|n(?:\u00E4|ae)chste)\\s*woche)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return DEWeekdayParser(10608).createParsingComponentsAtWeekday(reference.reference, DEWeekdayParser(10627).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
