// Module ID: 10626
// Function ID: 10627
// Dependencies: [41, 42, 93, 95, 98, 10565, 10627, 10592, 10572]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(?:ce)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10627.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(dernier|prochain)\\s*)?(?=\\W|\\d|$)", "i");
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (undefined === tmp4) {
        ...
        return tmp2(10592).createParsingComponentsAtWeekday(reference.reference, tmp4, str4);
      }
