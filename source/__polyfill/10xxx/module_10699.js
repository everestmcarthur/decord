// Module ID: 10699
// Function ID: 10700
// Dependencies: [41, 42, 93, 95, 98, 10696, 10588]
...
const keys = Object.keys(_mod10696.NUMBER);
...
const keys1 = Object.keys(_mod10696.NUMBER);
...
const keys2 = Object.keys(_mod10696.NUMBER);
const regExp = new RegExp(text1 + "]+)?(?:\\s*)(?:\u5206|:|\uFF1A)?(?:\\s*)(\\d+|[" + keys2.join("") + "]+)?(?:\\s*)(?:\u79D2)?)(?:\\s*(A.M.|P.M.|AM?|PM?))?", "i");
const keys3 = Object.keys(_mod10696.NUMBER);
...
const keys4 = Object.keys(_mod10696.NUMBER);
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (index[1]) {
        ...
        if (index[8]) {
          ...
          if (isNaN(parsed)) {
            zhStringToNumberResult = ZHHantTimeExpressionParser(10696).zhStringToNumber(index[8]);
          }
        ...
        const _isNaN2 = isNaN;
        if (isNaN(parsed1)) {
          parsed1 = ZHHantTimeExpressionParser(10696).zhStringToNumber(index[6]);
        }
        if (index[7]) {
          let num17 = 30;
          let rounded = parsed1;
          if ("\u534A" != index[7]) {
            ...
            if ("\u6B63" != index[7]) {
              ...
              if ("\u6574" != index[7]) {
                ...
                rounded = parsed1;
                if (isNaN(parsed2)) {
                  num17 = ZHHantTimeExpressionParser(10696).zhStringToNumber(index[7]);
                  rounded = parsed1;
                }
              }
            }
        ...
        if (num17 >= 60) {
          ...
          if (index[9]) {
            if (rounded > 12) {
              ...
              const formatted = index[9][0].toLowerCase();
              let tmp42 = rounded;
              if ("a" == formatted) {
                let num22 = rounded;
                if (12 == rounded) {
          ...
          if (match) {
            ...
            if (match[1]) {
              ...
              if (match[8]) {
                ...
                if (isNaN(parsed3)) {
                  zhStringToNumberResult1 = ZHHantTimeExpressionParser(10696).zhStringToNumber(match[8]);
                }
              ...
              const _isNaN5 = isNaN;
              if (isNaN(parsed4)) {
                parsed4 = ZHHantTimeExpressionParser(10696).zhStringToNumber(match[6]);
              }
              if (match[7]) {
                let num38 = 30;
                ...
                if ("\u534A" != match[7]) {
                  ...
                  if ("\u6B63" != match[7]) {
                    ...
                    if ("\u6574" != match[7]) {
                      ...
                      rounded1 = parsed4;
                      if (isNaN(parsed5)) {
                        num38 = ZHHantTimeExpressionParser(10696).zhStringToNumber(match[7]);
                        rounded1 = parsed4;
                      }
                    }
                  }
              ...
              if (num38 >= 60) {
                ...
                if (match[9]) {
                  if (rounded1 > 12) {
                    ...
                    const formatted1 = match[9][0].toLowerCase();
                    let tmp94 = rounded1;
                    if ("a" == formatted1) {
                      let num42 = rounded1;
                      if (12 == rounded1) {
                ...
                end10.assign("hour", num41);
                const end11 = parsingResult.end;
                end11.assign("minute", num38);
                if (0 <= num40) {
                  const end14 = parsingResult.end;
                  end14.assign("meridiem", num40);
                } else {
