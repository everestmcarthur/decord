// Module ID: 10595
// Function ID: 10596
// Dependencies: [41, 42, 93, 95, 98, 10564, 10567, 10568, 10572]
...
const regExp = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10564.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10564.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = ENTimeUnitCasualRelativeFormatParser(10564).parseDuration(arg1[2]);
