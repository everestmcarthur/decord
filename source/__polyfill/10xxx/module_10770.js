// Module ID: 10770
// Function ID: 10771
// Dependencies: [41, 42, 93, 95, 98, 10675, 10769, 10702, 10682]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:op\\s*?)?(?:(deze|vorige|volgende)\\s*(?:week\\s*)?)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10769.WEEKDAY_DICTIONARY) + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return NLWeekdayParser(10702).createParsingComponentsAtWeekday(reference.reference, NLWeekdayParser(10769).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
