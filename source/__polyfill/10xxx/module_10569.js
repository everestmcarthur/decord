// Module ID: 10569
// Function ID: 10570
// Dependencies: [41, 42, 10570, 10576]

// Module 10569
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10570 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10576).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10576).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10576).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10576).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10576).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
