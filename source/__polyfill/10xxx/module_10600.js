// Module ID: 10600
// Function ID: 10601
// Dependencies: [10576, 10578]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10600
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10576 */;
import Meridiem from "Meridiem" /* 10578 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10578).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10578).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10578).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10578).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
