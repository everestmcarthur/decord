// Module ID: 10698
// Function ID: 10699
// Dependencies: [41, 42, 93, 95, 96, 98, 10517, 10537]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10517).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10517).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
