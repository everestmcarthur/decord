// Module ID: 10556
// Function ID: 10557
// Dependencies: [41, 42, 10557, 10563]

// Module 10556
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10557 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10563).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10563).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10563).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10563).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10563).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
