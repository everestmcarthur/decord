// Module ID: 10733
// Function ID: 10734
// Dependencies: [41, 42, 93, 95, 98, 10560, 10729, 10567]
...
const regExp = new RegExp("([0-9]{4})[\\.\\/\\s](?:(" + repeatedTimeunitPattern.matchAnyPattern(_mod10729.MONTH_DICTIONARY) + ")|([0-9]{1,2}))[\\.\\/\\s]([0-9]{1,2})(?=\\W|$)", "i");
  ...
  entry,
  {
    ...
    value: function innerExtract(arg0, arg1) {
      if (arg1[3]) {
        ...
        parsed = ENCasualYearMonthDayParser(10729).MONTH_DICTIONARY[str.toLowerCase(str)];
      }
      if (parsed >= 1) {
        if (parsed <= 12) {
