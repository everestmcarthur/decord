// Module ID: 10746
// Function ID: 10747
// Dependencies: [10556, 10563, 10565, 10589, 10601, 10747, 10749, 10750, 10751, 10596]
...
fn(_mod10749);
fn(_mod10750);
const _isNativeReflectConstruct = fn(_mod10751);
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("module_10556").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
