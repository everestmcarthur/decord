// Module ID: 10678
// Function ID: 10679
// Dependencies: [41, 42, 93, 95, 98, 10667, 10576, 10580]
...
const regExp = new RegExp("(" + _mod10667.TIME_UNITS_PATTERN + ")(later|na|vanaf nu|voortaan|vooruit|uit)(?=(?:\\W|$))", "i");
const regExp1 = new RegExp("(" + _mod10667.TIME_UNITS_PATTERN + ")(later|vanaf nu)(?=(?:\\W|$))", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = NLTimeUnitLaterFormatParser(10576).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, NLTimeUnitLaterFormatParser(10667).parseDuration(arg1[1]));
    }
  }
];
