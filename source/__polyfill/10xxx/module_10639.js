// Module ID: 10639
// Function ID: 10640
// Dependencies: [41, 42, 93, 95, 96, 98, 10458, 10478]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10458).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10458).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
