// Module ID: 10612
// Function ID: 10613
// Dependencies: [41, 42, 93, 95, 98, 10464, 10608, 10465, 10471]
...
const regExp = new RegExp("([0-9]{1,2})(?:\u00BA|\u00AA|\u00B0)?(?:\\s*(?:desde|de|\\-|\\\u2013|ao?|\\s)\\s*([0-9]{1,2})(?:\u00BA|\u00AA|\u00B0)?)?\\s*(?:de)?\\s*(?:-|/|\\s*(?:de|,)?\\s*)(" + repeatedTimeunitPattern.matchAnyPattern(_mod10608.MONTH_DICTIONARY) + ")(?:\\s*(?:de|,)?\\s*(" + _mod10608.YEAR_PATTERN + "))?(?=\\W|$)", "i");
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (parsed > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10608).parseYear(index[4]));
        } else {
