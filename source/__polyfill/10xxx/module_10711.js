// Module ID: 10711
// Function ID: 10712
// Dependencies: [41, 42, 93, 95, 98, 10597, 10579, 10704]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    _inherits(RUCasualTimeParser, _mod10704.AbstractParserWithLeftRightBoundaryChecking);
    const entry = {
                    ...
                    if (!str2.endsWith("\u0443\u0442\u0440\u0430")) {
                      if (str2.match(/в\s*полдень/)) {
                        ...
                        if (str2.match(/следующей\s*ночью/)) {
                          ...
                          RUCasualTimeParser(10579).assignSimilarDate(parsingComponents, date);
