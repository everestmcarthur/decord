// Module ID: 10640
// Function ID: 10641
// Dependencies: [41, 42, 93, 95, 98, 10633, 10466, 10467, 10471]
...
const regExp = new RegExp("(" + _mod10633.TIME_UNITS_PATTERN + ")\\s{0,5}(?:fa|prima|precedente)(?=(?:\\W|$))", "i");
const regExp1 = new RegExp("(" + _mod10633.TIME_UNITS_PATTERN + ")\\s{0,5}fa(?=(?:\\W|$))", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const parseDurationResult = ENTimeUnitAgoFormatParser(10633).parseDuration(arg1[1]);
      const ParsingComponents = ENTimeUnitAgoFormatParser(10467).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, ENTimeUnitAgoFormatParser(10466).reverseDuration(ENTimeUnitAgoFormatParser(10633).parseDuration(arg1[1])));
    }
  }
];
