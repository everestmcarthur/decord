// Module ID: 10640
// Function ID: 10641
// Dependencies: [41, 42, 93, 95, 98, 10635, 10573, 10575, 10576, 10580]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:les?|la|l'|du|des?)\\s*(" + FRTimeUnitAgoFormatParser(10635).NUMBER_PATTERN + ")?(?:\\s*(prochaine?s?|derni[e\u00E8]re?s?|pass[\u00E9e]e?s?|pr[\u00E9e]c[\u00E9e]dents?|suivante?s?))?\\s*(" + FRTimeUnitAgoFormatParser(10573).matchAnyPattern(FRTimeUnitAgoFormatParser(10635).TIME_UNIT_DICTIONARY) + ")(?:\\s*(prochaine?s?|derni[e\u00E8]re?s?|pass[\u00E9e]e?s?|pr[\u00E9e]c[\u00E9e]dents?|suivante?s?))?", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      let num = 1;
      if (arg1[1]) {
        num = FRTimeUnitAgoFormatParser(10635).parseNumberPattern(arg1[1]);
      }
      const obj = {};
      obj[FRTimeUnitAgoFormatParser(10635).TIME_UNIT_DICTIONARY[arg1[3].toLowerCase(arg1[3])]] = num;
