// Module ID: 10640
// Function ID: 10641
// Dependencies: [41, 42, 93, 95, 98, 10526, 10508, 10633]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    _inherits(RUCasualTimeParser, _mod10633.AbstractParserWithLeftRightBoundaryChecking);
    const entry = {
                    ...
                    if (!str2.endsWith("\u0443\u0442\u0440\u0430")) {
                      if (str2.match(/в\s*полдень/)) {
                        ...
                        if (str2.match(/следующей\s*ночью/)) {
                          ...
                          RUCasualTimeParser(10508).assignSimilarDate(parsingComponents, date);
