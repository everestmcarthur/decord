// Module ID: 10598
// Function ID: 10599
// Dependencies: [41, 42, 93, 95, 98, 10596, 10502, 10503, 10509]
  ...
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          parsingComponents.assign("year", tmp(10596).parseYear(index[4]));
        } else {
          parsingComponents.imply("year", tmp(10503).findYearClosestToRef(createParsingComponents.refDate, result, tmp3));
        }
        if (index[2]) {
          const result1 = tmp(10596).parseOrdinalNumberPattern(index[2]);
