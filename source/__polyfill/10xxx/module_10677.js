// Module ID: 10677
// Function ID: 10678
// Dependencies: [41, 42, 93, 95, 96, 98, 10496, 10516]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10496).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10496).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
