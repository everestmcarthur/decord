// Module ID: 10611
// Function ID: 10612
// Dependencies: [41, 42, 93, 95, 98, 10580, 10583, 10584, 10588]
...
const regExp = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10580.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(this|last|past|next|after|\\+|-)\\s*(" + _mod10580.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = ENTimeUnitCasualRelativeFormatParser(10580).parseDuration(arg1[2]);
