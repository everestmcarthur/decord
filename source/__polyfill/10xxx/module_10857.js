// Module ID: 10857
// Function ID: 10858
// Dependencies: [41, 42, 93, 95, 98, 10675, 10844, 10702, 10682]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:il\\s*?)?(?:(questa|l'ultima|scorsa|prossima)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10844.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(questa|l'ultima|scorsa|prossima)\\s*settimana)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ITWeekdayParser(10702).createParsingComponentsAtWeekday(reference.reference, ITWeekdayParser(10844).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
