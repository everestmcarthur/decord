// Module ID: 10017
// Function ID: 10018
// Dependencies: [10018, 10020, 10022, 10023, 10024]

// Module 10017
import QR8bitByte from "QR8bitByte" /* 10018 */;
import QRRSBlock from "QRRSBlock" /* 10020 */;
import QRBitBuffer from "QRBitBuffer" /* 10022 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10023.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10023.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10023.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
