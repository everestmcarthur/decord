// Module ID: 10648
// Function ID: 10649
// Dependencies: [41, 42, 93, 95, 98, 10643, 10581, 10583, 10584, 10588]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:les?|la|l'|du|des?)\\s*(" + FRTimeUnitAgoFormatParser(10643).NUMBER_PATTERN + ")?(?:\\s*(prochaine?s?|derni[e\u00E8]re?s?|pass[\u00E9e]e?s?|pr[\u00E9e]c[\u00E9e]dents?|suivante?s?))?\\s*(" + FRTimeUnitAgoFormatParser(10581).matchAnyPattern(FRTimeUnitAgoFormatParser(10643).TIME_UNIT_DICTIONARY) + ")(?:\\s*(prochaine?s?|derni[e\u00E8]re?s?|pass[\u00E9e]e?s?|pr[\u00E9e]c[\u00E9e]dents?|suivante?s?))?", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      let num = 1;
      if (arg1[1]) {
        num = FRTimeUnitAgoFormatParser(10643).parseNumberPattern(arg1[1]);
      }
      const obj = {};
      obj[FRTimeUnitAgoFormatParser(10643).TIME_UNIT_DICTIONARY[arg1[3].toLowerCase(arg1[3])]] = num;
      ...
      if (formatted) {
        ...
        if (isMatch) {
          reverseDurationResult = tmp3(10583).reverseDuration(obj);
        }
        const ParsingComponents = tmp3(10584).ParsingComponents;
