// Module ID: 10764
// Function ID: 10765
// Dependencies: [41, 42, 93, 95, 98, 10581, 10750, 10584, 10588]
...
const regExp = new RegExp("(questo|ultimo|scorso|prossimo|dopo\\s*questo|questa|ultima|scorsa|prossima\\s*questa)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10750.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ITRelativeDateFormatParser(10750).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp(10584).ParsingComponents;
