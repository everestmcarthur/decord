// Module ID: 10550
// Function ID: 10551
// Dependencies: [10526, 10528]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10550
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10526 */;
import Meridiem from "Meridiem" /* 10528 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10528).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10528).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10528).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10528).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
