// Module ID: 10736
// Function ID: 10737
// Dependencies: [41, 42, 93, 95, 98, 10735, 10581, 10582, 10737]
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10735).parseYearPattern(index[4]));
        } else {
          const start = parsingResult.start;
          start.imply("year", tmp2(10582).findYearClosestToRef(createParsingResult.reference.instant, result, tmp4));
        }
        if (index[2]) {
          const start3 = parsingResult.start;
          const result1 = tmp2(10735).parseOrdinalNumberPattern(index[2]);
