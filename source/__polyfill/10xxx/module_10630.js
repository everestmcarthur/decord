// Module ID: 10630
// Function ID: 10631
// Dependencies: [41, 42, 93, 95, 98, 10578, 10580]
      ...
      if ("apr\u00E8s-midi" !== formatted) {
        if ("aprem" !== formatted) {
          if ("soir" === formatted) {
            ...
            parsingComponents.imply("meridiem", FRCasualTimeParser(10578).Meridiem.PM);
          } else if ("matin" === formatted) {
            parsingComponents.imply("hour", 8);
            parsingComponents.imply("minute", 0);
            parsingComponents.imply("meridiem", FRCasualTimeParser(10578).Meridiem.AM);
