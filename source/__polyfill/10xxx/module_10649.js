// Module ID: 10649
// Function ID: 10650
// Dependencies: [41, 42, 93, 95, 98, 10633, 10466, 10467, 10483]
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, text, start) {
      const parseDurationResult = ENMergeRelativeDateRefiner(10633).parseDuration(text.text);
      let reverseDurationResult = parseDurationResult;
      if (null != str.match(/\s+(prima|dal)$/i)) {
        reverseDurationResult = tmp(10466).reverseDuration(parseDurationResult);
      }
      const ParsingComponents = tmp(10467).ParsingComponents;
      const ReferenceWithTimezone = tmp(10467).ReferenceWithTimezone;
      start = start.start;
      ...
      return new ENMergeRelativeDateRefiner(10467).ParsingResult(start.reference, text.index, "" + text.text + arg0 + start.text, relativeFromReference);
    }
  }
];
