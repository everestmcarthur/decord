// Module ID: 10656
// Function ID: 10657
// Dependencies: [41, 42, 93, 95, 98, 10651, 10586, 10588]
...
function createTimeComponents(createParsingComponents, arg1, arg2, arg3, arg4) {
  ...
  let parsed = parseInt(JPTimeExpressionParser(10651).toHankaku(arg1));
  if (isNaN(parsed)) {
    parsed = tmp(10651).jaStringToNumber(arg1);
  }
  if (parsed > 24) {
    return null;
  } else {
    if (arg2) {
      ...
      if ("\u534A" !== arg2) {
        ...
        const parsed1 = parseInt(tmp(10651).toHankaku(arg2));
        const _isNaN = isNaN;
        num = parsed1;
        if (isNaN(parsed1)) {
          num = tmp(10651).jaStringToNumber(arg2);
        }
      }
      if (num >= 60) {
        return null;
    ...
    if (arg3) {
      ...
      let parsed2 = parseInt(tmp(10651).toHankaku(arg3));
      const _isNaN2 = isNaN;
      if (isNaN(parsed2)) {
        parsed2 = tmp(10651).jaStringToNumber(arg3);
      }
      if (parsed2 >= 60) {
        return null;
      } else {
        ...
        if ("\u5348\u524D" !== arg4) {
          if ("a" !== str2.toLowerCase()) {
            ...
            if (!tmp8) {
              ...
              num6 = sum;
              num5 = tmp(10586).Meridiem.PM;
            }
          }
          str2 = arg4[0];
        }
        const AM = tmp(10586).Meridiem.AM;
        num5 = AM;
        num6 = parsed;
        if (12 === parsed) {
          num6 = 0;
    ...
    if (num5 >= 0) {
      ...
      parsingComponents.imply("meridiem", tmp(10586).Meridiem.AM);
    } else {
      parsingComponents.imply("meridiem", tmp(10586).Meridiem.PM);
    }
