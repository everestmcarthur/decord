// Module ID: 10656
// Function ID: 10657
// Dependencies: [41, 42, 93, 95, 98, 10654, 10560, 10561, 10567]
...
const combined = "(?:on\\s*?)?(" + _mod10654.ORDINAL_NUMBER_PATTERN + ")(?:\\s*(?:tot|\\-|\\\u2013|until|through|till|\\s)\\s*(" + _mod10654.ORDINAL_NUMBER_PATTERN + "))?(?:-|/|\\s*(?:of)?\\s*)(";
  ...
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          parsingComponents.assign("year", tmp(10654).parseYear(index[4]));
        } else {
          parsingComponents.imply("year", tmp(10561).findYearClosestToRef(createParsingComponents.refDate, result, tmp3));
        }
        if (index[2]) {
          const result1 = tmp(10654).parseOrdinalNumberPattern(index[2]);
