// Module ID: 10521
// Function ID: 10522
// Dependencies: [41, 42, 93, 95, 98, 10469, 10471]
      ...
      if ("apr\u00E8s-midi" !== formatted) {
        if ("aprem" !== formatted) {
          if ("soir" === formatted) {
            ...
            parsingComponents.imply("meridiem", FRCasualTimeParser(10469).Meridiem.PM);
          } else if ("matin" === formatted) {
            parsingComponents.imply("hour", 8);
            parsingComponents.imply("minute", 0);
            parsingComponents.imply("meridiem", FRCasualTimeParser(10469).Meridiem.AM);
