// Module ID: 10760
// Function ID: 10761
// Dependencies: [41, 42, 93, 95, 98, 10573, 10761, 10600, 10580]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10761.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10600).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10761).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
