// Module ID: 10646
// Function ID: 10647
// Dependencies: [41, 42, 93, 95, 98, 10464, 10633, 10491, 10471]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:il\\s*?)?(?:(questa|l'ultima|scorsa|prossima)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10633.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(questa|l'ultima|scorsa|prossima)\\s*settimana)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ITWeekdayParser(10491).createParsingComponentsAtWeekday(reference.reference, ITWeekdayParser(10633).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
