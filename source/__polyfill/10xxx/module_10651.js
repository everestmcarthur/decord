// Module ID: 10651
// Function ID: 10652
// Dependencies: [41, 42, 10643, 10600]
...
const items = [
  entry,
  {
    ...
    value: function extract(reference, arg1) {
      const tmp3 = JPWeekdayWithParenthesesParser(10643).WEEKDAY_OFFSET[arg1.groups.weekday];
      let parsingComponentsAtWeekday = null;
      if (undefined !== tmp3) {
        parsingComponentsAtWeekday = JPWeekdayWithParenthesesParser(10600).createParsingComponentsAtWeekday(reference.reference, tmp3);
      }
