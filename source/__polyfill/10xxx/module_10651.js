// Module ID: 10651
// Function ID: 10652
// Dependencies: [41, 42, 93, 95, 98, 10464, 10652, 10491, 10471]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10652.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10491).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10652).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
