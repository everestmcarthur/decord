// Module ID: 10515
// Function ID: 10516
// Dependencies: [41, 42, 93, 95, 96, 98, 10507, 10516]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10507).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10507).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
