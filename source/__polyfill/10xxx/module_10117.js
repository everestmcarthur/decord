// Module ID: 10117
// Function ID: 10118
// Dependencies: [10118, 10119, 10113]

// Module 10117
import _mod10113 from "module_10113" /* 10113 */;
import QRPolynomial from "QRPolynomial" /* 10118 */;
import array2 from "array2" /* 10119 */;
...
const exports = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod10113.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(10113).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(10113).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(10113).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod10113.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(10113).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(10113).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(10113).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod10113.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(10113).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(10113).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(10113).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
