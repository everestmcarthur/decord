// Module ID: 10692
// Function ID: 10693
// Dependencies: [41, 42, 93, 95, 98, 10690, 10504, 10505, 10509]
...
const regExp = new RegExp("(denna|den h\u00E4r|f\u00F6rra|passerade|n\u00E4sta|kommande|efter|\\+|-)\\s*(" + _mod10690.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(denna|den h\u00E4r|f\u00F6rra|passerade|n\u00E4sta|kommande|efter|\\+|-)\\s*(" + _mod10690.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = SVTimeUnitCasualRelativeFormatParser(10690).parseDuration(arg1[2]);
