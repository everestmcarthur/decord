// Module ID: 10692
// Function ID: 10693
// Dependencies: [41, 42, 93, 95, 98, 10521, 10690, 10522, 10528]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10690.MONTH_DICTIONARY) + ")(?:-|/|\\s*,?\\s*)(" + _mod10690.ORDINAL_NUMBER_PATTERN + ")(?!\\s*(?:am|pm))\\s*(?:(?:al|\\-|\\alle|\\del|\\s)\\s*(" + _mod10690.ORDINAL_NUMBER_PATTERN + ")\\s*)?(?:(?:-|/|\\s*,?\\s*)(" + _mod10690.YEAR_PATTERN + "))?(?=\\W|$)(?!\\:\\d)", "i");
  ...
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          parsingComponents.assign("year", tmp(10690).parseYear(index[4]));
        } else {
