// Module ID: 10676
// Function ID: 10677
// Dependencies: [41, 42, 93, 95, 98, 10573, 10667, 10576, 10580]
...
const regExp = new RegExp("(dit|deze|(?:aan)?komend|volgend|afgelopen|vorig)e?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10667.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLRelativeDateFormatParser(10667).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp2(10576).ParsingComponents;
