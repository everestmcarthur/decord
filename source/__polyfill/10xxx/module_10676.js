// Module ID: 10676
// Function ID: 10677
// Dependencies: [41, 42, 93, 95, 98, 10581, 10675, 10608, 10588]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:op\\s*?)?(?:(deze|vorige|volgende)\\s*(?:week\\s*)?)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10675.WEEKDAY_DICTIONARY) + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return NLWeekdayParser(10608).createParsingComponentsAtWeekday(reference.reference, NLWeekdayParser(10675).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
