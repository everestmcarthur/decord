// Module ID: 10534
// Function ID: 10535
// Dependencies: [41, 42, 93, 95, 96, 98, 10526, 10535]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10526).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10526).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
