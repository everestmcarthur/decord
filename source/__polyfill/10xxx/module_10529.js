// Module ID: 10529
// Function ID: 10530
// Dependencies: [10505, 10507]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10529
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10505 */;
import Meridiem from "Meridiem" /* 10507 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10507).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10507).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10507).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10507).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
