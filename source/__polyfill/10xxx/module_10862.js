// Module ID: 10862
// Function ID: 10863
// Dependencies: [41, 42, 93, 95, 98, 10675, 10863, 10702, 10682]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10863.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10702).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10863).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
