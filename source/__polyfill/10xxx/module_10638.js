// Module ID: 10638
// Function ID: 10639
// Dependencies: [41, 42, 93, 95, 98, 10586, 10588]
      ...
      if ("apr\u00E8s-midi" !== formatted) {
        if ("aprem" !== formatted) {
          if ("soir" === formatted) {
            ...
            parsingComponents.imply("meridiem", FRCasualTimeParser(10586).Meridiem.PM);
          } else if ("matin" === formatted) {
            parsingComponents.imply("hour", 8);
            parsingComponents.imply("minute", 0);
            parsingComponents.imply("meridiem", FRCasualTimeParser(10586).Meridiem.AM);
