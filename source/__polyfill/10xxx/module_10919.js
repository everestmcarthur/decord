...
export const horizontalStackLayout = function horizontalStackLayout(modeConfig) {
  ...
  fn.__closure = { screen, modeConfig, getCommonVariables, getCommonStyles, interpolate: modeConfig(1637).interpolate, Extrapolation: modeConfig(1637).Extrapolation };
