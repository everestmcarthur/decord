// Module ID: 1754
// Function ID: 1755
// Dependencies: [41, 42, 93, 95, 98, 1708, 1706]
...
class BounceIn {
  constructor() {
    ...
    items = [...arguments];
    closure_0 = undefined;
    tmp = c2(this, BounceOutRight);
    items1 = [...items];
    tmp2 = closure_4;
    obj = closure_4(BounceOutRight);
    tmp3 = closure_3;
    if (hasOwnProperty()) {
      tmp5 = globalThis;
      _Reflect = Reflect;
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n() {
        ...
        obj3.scale = delayFunction(delay, obj4.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(1, { duration: 0.15 * duration })));
        const items = [obj3];
      ...
      fn.__closure = { delayFunction, delay, withSequence: BounceOutRight(1708).withSequence, withTiming: BounceOutRight(1708).withTiming, duration, initialValues, callback: callbackV };
...
_inherits(BounceIn, fn(1706).ComplexAnimationBuilder);
const entry = {
  key: "getDuration",
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(translateY) {
        ...
        obj3.translateY = delayFunction(delay, obj4.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(0, { duration: 0.15 * duration })));
        const items = [obj3];
        obj2.transform = items;
        obj.animations = obj2;
        const obj13 = { transform: null };
...
_inherits(BounceInDown, fn(1706).ComplexAnimationBuilder);
const entry2 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
...
_inherits(BounceInUp, fn(1706).ComplexAnimationBuilder);
const entry4 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(translateX) {
        ...
        const obj9 = delayFunction(1708);
        const withTimingResult2 = delayFunction(1708).withTiming(10, { duration: 0.15 * duration });
        obj3.translateX = delayFunction(delay, obj4.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(0, { duration: 0.15 * duration })));
        const items = [obj3];
        obj2.transform = items;
        obj.animations = obj2;
        const obj13 = { transform: null };
...
_inherits(BounceInLeft, fn(1706).ComplexAnimationBuilder);
const entry6 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
...
_inherits(BounceInRight, fn(1706).ComplexAnimationBuilder);
const entry8 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n() {
        ...
        obj3.scale = delayFunction(delay, obj4.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(0, { duration: 0.55 * duration })));
        const items = [obj3];
        obj2.transform = items;
        obj.animations = obj2;
        const obj13 = { transform: null };
...
_inherits(BounceOut, fn(1706).ComplexAnimationBuilder);
const entry10 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(windowHeight) {
        ...
        obj3.translateY = delayFunction(delay, obj4.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(windowHeight.windowHeight, { duration: 0.55 * duration })));
        const items = [obj3];
        obj2.transform = items;
        obj.animations = obj2;
        const obj13 = { transform: null };
...
_inherits(BounceOutDown, fn(1706).ComplexAnimationBuilder);
const entry12 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
...
_inherits(BounceOutUp, fn(1706).ComplexAnimationBuilder);
const entry14 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(windowWidth) {
        ...
        const obj9 = delayFunction(1708);
        const withTimingResult2 = delayFunction(1708).withTiming(20, { duration: 0.15 * duration });
        obj3.translateX = delayFunction(delay, obj4.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(-windowWidth.windowWidth, { duration: 0.55 * duration })));
        const items = [obj3];
        obj2.transform = items;
        obj.animations = obj2;
        const obj13 = { transform: null };
...
_inherits(BounceOutLeft, fn(1706).ComplexAnimationBuilder);
const entry16 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
...
_inherits(BounceOutRight, fn(1706).ComplexAnimationBuilder);
const entry18 = {
  key: "getDuration",
  value: function getDuration() {
    let num = this.durationV;
