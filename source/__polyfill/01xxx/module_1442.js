// Module ID: 1442
// Function ID: 1443
// Dependencies: [1443, 1445, 1448, 1449]
...
// Module 1442
import _mod1443 from "module_1443" /* 1443 */;
import _mod1445 from "module_1445" /* 1445 */;
import _mod1448 from "module_1448" /* 1448 */;
...
export const isArgumentsObject = _mod1443;
export const isGeneratorFunction = _mod1445;
export const isTypedArray = _mod1448;
...
export const isSharedArrayBuffer = function isSharedArrayBuffer(arg0) {
  if (undefined === _SharedArrayBuffer) {
    ...
    if (undefined === isSharedArrayBufferToString.working) {
      const tmp6 = new tmp();
      tmp3.working = "[object SharedArrayBuffer]" === bindResult(tmp6);
    }
    let tmp9 = arg0;
...
export const isBoxedPrimitive = function isBoxedPrimitive(arg0) {
  ...
  if (!tmpResult) {
    ...
    if (closure_4) {
      tmpResult4 = tmp(arg0, closure_10);
    }
      ...
      if (!tmp17) {
        if (undefined === _SharedArrayBuffer) {
          ...
          if (undefined === isSharedArrayBufferToString.working) {
            ...
            tmp7.working = "[object SharedArrayBuffer]" === bindResult(tmp52);
          }
          if (isSharedArrayBufferToString.working) {
