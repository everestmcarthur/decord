...
withSequence.__closure = { logger: fn(1640).logger, defineAnimation: fn(1676).defineAnimation, getReduceMotionForAnimation: fn(1676).getReduceMotionForAnimation };
