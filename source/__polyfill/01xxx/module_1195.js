// Module ID: 1195
// Function ID: 1196
// Dependencies: [32, 93, 95, 98, 41, 42, 1194]
...
const entry1 = {
  ...
  value: function toString() {
    const self = this;
    if (obj) {
      let str1 = self.toBigInt().toString();
    ...
    if (closure_7) {
      ...
      if ("0" == trimmed) {
        ...
        if (regex.test(trimmed)) {
          ...
          [tmp24, tmp26, tmp27] = PbLong(1194).int64fromString(trimmed);
...
const tmp2Result11 = new _module1Result1(0, 0);
