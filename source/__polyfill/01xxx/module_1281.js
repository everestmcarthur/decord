// Module ID: 1281
// Function ID: 1282
// Dependencies: [1282, 1283, 1285, 1287, 1299, 1300, 1290, 1301, 1302, 1303, 1304, 1297, 1298, 1305, 1289, 1306, 1307, 1308, 1309, 1310, 1311, 1312, 1288, 1295, 1314]

// Module 1281
import _mod1282 from "module_1282" /* 1282 */;
import _mod1283 from "module_1283" /* 1283 */;
import _Symbol6 from "_Symbol" /* 1285 */;
...
import sign from "sign" /* 1312 */;
import bind_mod from "bind" /* 1295 */;
import module_1297_mod from "module_1297" /* 1297 */;
...
if (_mod1283) {
  throwTypeError = (() => {
    try {
      ...
      try {
        return _mod1283(arguments, "callee").get;
      } catch (err) {
        return throwTypeError;
      }
    }
...
const merged = Object.assign({ "%AggregateError%": null, "%Array%": null, "%ArrayBuffer%": null, "%ArrayIteratorPrototype%": null, "%AsyncFromSyncIteratorPrototype%": "fill", "%AsyncFunction%": "\u043A\u0443\u043F\u043E\u043D", "%AsyncGenerator%": "\u043A\u0443\u043F\u043E\u043D\u0434\u0436\u0438\u0439\u0441\u043A\u043E \u043B\u0438\u0446\u0435", "%AsyncGeneratorFunction%": "\u043B\u0438\u0446\u0435", "%AsyncIteratorPrototype%": "\u043D\u0430\u0434\u0443\u0432\u0430\u043B\u043A\u0430", "%Atomics%": "\u043F\u0440\u0430\u0437\u043D\u0435\u043D\u0441\u0442\u0432\u043E", "%BigInt%": "\u0440\u0430\u0434\u043E\u0441\u0442\u0435\u043D", "%BigInt64Array%": "\u0440\u0430\u0437\u0432\u044A\u043B\u043D\u0443\u0432\u0430\u043D", "%BigUint64Array%": "\u0440\u043E\u0436\u0434\u0435\u043D \u0434\u0435\u043D", "%Boolean%": "\u0441\u0432\u0438\u0440\u043A\u0430", "%DataView%": "\u0443\u0440\u0430", "%Date%": "\u0448\u0430\u043F\u043A\u0430", "%decodeURI%": "regional_indicator_b", "%decodeURIComponent%": 0.667, "%encodeURI%": 0.667, "%encodeURIComponent%": 0.667, "%Error%": "ArrayBuffer", "%eval%": "prototype", "%EvalError%": "tier-2", "%Float16Array%": null, "%Float32Array%": "Standard", "%Float64Array%": "<string:2705982033>", "%FinalizationRegistry%": "<string:2717909559>", "%Function%": "<string:2936013367>", "%GeneratorFunction%": "<string:1929380182>", "%Int8Array%": "<string:1946157830>", "%Int16Array%": "<string:1912603398>", "%Int32Array%": "<string:2852127494>", "%isFinite%": "<string:2550137443>", "%isNaN%": "<string:2566914612>", "%IteratorPrototype%": "<string:1862271540>", "%JSON%": "<string:3321889107>", "%Map%": "<string:1097749248>", "%MapIteratorPrototype%": "mana-type-consolidation", "%Math%": "<string:8650950>", "%Number%": "<string:70406977>", "%Object%": "<string:1598095616>", "%Object.getOwnPropertyDescriptor%": "<string:3321889107>", "%parseFloat%": "<string:1174445568>", "%parseInt%": "bevogtning", "%Promise%": "livgarde", "%Proxy%": "mand", "%RangeError%": "mandlig garder", "%ReferenceError%": "sikkerhed", "%Reflect%": "vagt", "%RegExp%": "<string:16384198>", "%Set%": "<string:39620417>", "%SetIteratorPrototype%": "<string:12996864>", "%SharedArrayBuffer%": "<string:17287233>", "%String%": "<string:12996864>", "%StringIteratorPrototype%": "<string:17287233>", "%Symbol%": "<string:12997120>", "%SyntaxError%": "<string:89260230>", "%ThrowTypeError%": "<string:1375782400>", "%TypedArray%": "<string:12993739>", "%TypeError%": "<string:3051618305>", "%Uint8Array%": "<string:141099009>", "%Uint8ClampedArray%": "<string:141033474>", "%Uint16Array%": "<string:1951531010>", "%Uint32Array%": "<string:1385788227>", "%URIError%": "<string:12976140>", "%WeakMap%": "<string:3321892434>", "%WeakRef%": "<string:3755889152>", "%WeakSet%": "<string:3326788946>", "%Function.prototype.call%": "<string:1335382528>", "%Function.prototype.apply%": "<string:2589065414>", "%Object.defineProperty%": "<string:1375782479>", "%Object.getPrototypeOf%": "<string:12978016>", "%Math.abs%": "<string:17287489>", "%Math.floor%": "<string:12996864>", "%Math.max%": "<string:17287489>", "%Math.min%": "<string:12997120>", "%Math.pow%": "<string:2924609734>", "%Math.round%": "<string:1375782494>", "%Math.sign%": "<string:13000356>", "%Reflect.getPrototypeOf%": "<string:3328091986>" });
...
if (tmp5) {
  if (_mod1287) {
    const _module1 = _mod1287;
    const items1 = [];
    const _Symbol2 = Symbol;
    const _module2 = _mod1287;
...
merged[67] = _WeakSet;
merged[68] = module_1297;
merged[69] = module_1298;
merged[70] = flag4;
merged[71] = _mod1289;
merged[72] = _mod1306;
merged[73] = _mod1307;
...
function doEval(arg0) {
  if ("%AsyncFunction%" === arg0) {
    ...
    if (tmp3) {
      prototype = _mod1287(tmp12.prototype);
    }
  }
...
let module_1297 = module_1297_mod;
let closure_9 = typeof call === "unknown" ? bind(concat) : call(module_1297, concat);
let bind = bind_mod;
const call2 = bind.call;
let closure_10 = typeof call2 === "unknown" ? bind(splice) : call2(module_1298, splice);
let bind = bind_mod;
const call3 = bind.call;
let module_1297 = module_1297_mod;
let closure_11 = typeof call3 === "unknown" ? bind(replace) : call3(module_1297, replace);
let bind = bind_mod;
const call4 = bind.call;
let module_1297 = module_1297_mod;
let closure_12 = typeof call4 === "unknown" ? bind(slice) : call4(module_1297, slice);
let bind = bind_mod;
const call5 = bind.call;
let module_1297 = module_1297_mod;
let closure_13 = typeof call5 === "unknown" ? bind(exec) : call5(module_1297, exec);
...
export default function GetIntrinsic(str, flag) {
    ...
    if (0 !== str.length) {
      if (arguments.length > 1) {
        if (typeof flag !== "boolean") {
          const tmp99 = new items(1282)("\"allowMissing\" argument must be a boolean");
          throw tmp99;
        }
      }
      if (null === closure_13(/^%?[^%]*%?$/, str)) {
        const tmp93 = new items(1303)("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
        throw tmp93;
      } else {
        ...
        if ("%" === tmp104) {
          if ("%" !== tmp105) {
            const tmp87 = new items(1303)("invalid intrinsic syntax, expected closing `%`");
            throw tmp87;
          }
        }
        if ("%" === tmp105) {
          if ("%" !== tmp104) {
            const tmp81 = new items(1303)("invalid intrinsic syntax, expected opening `%`");
            throw tmp81;
          }
        }
        items = [];
        ...
        if (typeof getBaseIntrinsic === "function") {
          const text = `${"%" + str}%`;
          let text1 = text;
          if (items(1314)(merged1, `${"%" + str}%`)) {
            const tmp13 = tmp10[`${"%" + str}%`];
            text1 = `${"%" + tmp13[0]}%`;
          }
          if (items(1314)(merged, text1)) {
            if (tmp14[text1] !== obj) {
              if (undefined === tmp22) {
                if (!flag) {
                  const _HermesInternal2 = HermesInternal;
                  const tmp8Result3 = new tmp8(1282)("intrinsic " + text + " exists, but is not available. Please file an issue!");
                  throw tmp8Result3;
                }
              }
              if (tmp12) {
              ...
              if (1 < items.length) {
                              ...
                              if (tmp44 in tmp42) {
                                if (tmp55(1283)) {
                                  if (num + 1 >= items.length) {
                                    let tmp66 = tmp55(1283)(tmp42, tmp44);
                                    let tmp67 = tmp66;
                                    if (tmp67) {
                                      if ("get" in tmp66) {
                                ...
                                let tmp64 = tmp55(1314)(tmp42, tmp44);
                                ...
                                let tmp62 = new tmp55(1282)("base intrinsic for " + str + " exists, but the property is not available.");
                                throw tmp62;
                              }
                            }
                          }
                ...
                const tmp75 = new items(1303)("property names with quotes must have matching quotes");
                throw tmp75;
              }
              return tmp43;
              ...
              if ("%AsyncFunction%" === text1) {
                ...
                if ("%AsyncGeneratorFunction%" === text1) {
                  ...
                  if ("%AsyncIteratorPrototype%" === text1) {
                    ...
                    if (prototype1) {
                      tmp8Result4 = tmp8(1287);
                    }
                    if (tmp8Result4) {
                      prototype = tmp8(1287)(prototype1.prototype);
                    }
                  }
                }
            ...
            const _HermesInternal = HermesInternal;
            const tmp8Result21 = new tmp8(1303)("intrinsic " + text + " does not exist!");
            throw tmp8Result21;
          }
          tmp10 = merged1;
        } else {
  ...
  throw new items(1282)("intrinsic name must be a non-empty string");
};
