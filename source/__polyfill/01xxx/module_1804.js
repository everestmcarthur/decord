// Module ID: 1804
// Function ID: 1805
// Dependencies: [1805, 1679, 1806, 1647, 1788, 1680]
...
const interpolateColorsHSV = function o(arg0, arg1, h, useCorrectedHSVInterpolation) {
  ...
  if (undefined !== useCorrectedHSVInterpolation) {
    ...
    const interpolateResult2 = tmpResult4.interpolate(arg0, arg1, h.v, _mod1805.Extrapolation.CLAMP);
    const tmpResult5 = _mod1805;
    const tmpResult6 = _mod1679;
    return tmpResult6.hsvToColor(interpolateResult, interpolateResult1, interpolateResult2, tmpResult5.interpolate(arg0, arg1, h.a, _mod1805.Extrapolation.CLAMP));
  }
  const items = [arg1[0]];
  h = h.h;
  const items1 = [h[0]];
...
interpolateColorsHSV.__closure = { interpolate: _mod1805.interpolate, Extrapolation: _mod1805.Extrapolation, hsvToColor: _mod1679.hsvToColor };
...
fn4.__closure = { toLinearSpace: fn2, interpolate: _mod1805.interpolate, Extrapolation: _mod1805.Extrapolation, rgbaColor: _mod1679.rgbaColor, toGammaSpace: fn3 };
...
let obj2 = { toLinearSpace: fn2, interpolate: _mod1805.interpolate, Extrapolation: _mod1805.Extrapolation, rgbaColor: _mod1679.rgbaColor, toGammaSpace: fn3 };
fn5.__closure = { interpolate: _mod1805.interpolate, Extrapolation: _mod1805.Extrapolation, culori: convertLrgbToOklabDefault, rgbaColor: _mod1679.rgbaColor };
...
let obj3 = { interpolate: _mod1805.interpolate, Extrapolation: _mod1805.Extrapolation, culori: convertLrgbToOklabDefault, rgbaColor: _mod1679.rgbaColor };
...
function interpolateColor(arg0, arg1, arg2) {
  ...
  if ("HSV" === str) {
    ...
    const reanimatedError = new _mod1647.ReanimatedError("Invalid color space provided: " + str + ". Supported values are: ['RGB', 'HSV', 'LAB'].");
