// Module ID: 6801
// Function ID: 6802
// Dependencies: [41, 42, 93, 95, 98, 19, 6802, 6768, 6790, 6788]
...
import PlatformConstants from "module_6802" /* 6802 */;
...
const entry = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6768).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  entry,
...
if (forceTouchAvailable) {
  ...
  const items2 = [];
  HermesBuiltin.arraySpread(items1, HermesBuiltin.arraySpread(fn(6788).baseGestureHandlerProps, 0));
  obj.allowedProps = items2;
  obj.config = {};
  importDefaultResultResult = _modDef6790(obj);
  const importDefaultResult4 = _modDef6790;
}
let flag;
if (PlatformConstants != null) {
