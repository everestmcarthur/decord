// Module ID: 6690
// Function ID: 6691
// Dependencies: [93, 95, 98, 42, 41, 6691, 6674]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6691).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6674).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6674);
      }
      return tmp;
    }
  }
