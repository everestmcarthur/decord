// Module ID: 6945
// Function ID: 6946
// Dependencies: [109, 19, 21, 6744, 6737, 6946, 1637, 6733, 6760, 6947]
...
import ScrollableContainer from "ScrollableContainer" /* 6947 */;
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(SCROLLVIEW, animatedComponent) {
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const tmp6 = hasOwnProperty(_mod6744.BottomSheetDraggableContext);
    closure_3 = tmp6;
    ...
    const scrollHandler1 = _mod6737.useScrollHandler(scrollEventsHandlersHook, onScroll, onScrollBeginDrag, onScrollEndDrag, lockableScrollableContentOffsetY);
    ...
    const setContentSize = _mod6946.useBottomSheetContentSizeSetter().setContentSize;
    if (!tmp6) {
    ...
    const tmp4Result4 = _mod6737;
    const stableCallback = _mod6737.useStableCallback((arg0, arg1) => {
      setContentSize(arg1);
      if (closure_1_2) {
        tmp2(arg0, arg1);
      }
    });
    const bottomSheetContentContainerStyle = _mod6737.useBottomSheetContentContainerStyle(tmp, contentContainerStyle);
    timestampProducer(arg1, () => scrollableRef.current);
    const tmp4Result5 = _mod6737;
    const scrollableSetter = _mod6737.useScrollableSetter(scrollableRef, SCROLLVIEW, scrollableContentOffsetY, undefined !== onRefresh, focusHook);
