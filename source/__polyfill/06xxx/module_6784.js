// Module ID: 6784
// Function ID: 6785
// Dependencies: [93, 95, 98, 42, 41, 6785, 6768]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6785).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6768).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6768);
      }
      return tmp;
    }
  }
