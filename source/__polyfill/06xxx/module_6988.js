      ...
      if (null !== prop) {
        ...
        if (undefined !== prop1) {
          ...
          if (null !== prop2) {
            ...
            if (undefined !== prop3) {
              const _Error = Error;
              const error = new Error(ViewabilityHelper(6959).ErrorMessages.multipleViewabilityThresholdTypesNotSupported);
              throw error;
            }
          }
        }
...
export default _modDef6972(ViewabilityHelper, items);
