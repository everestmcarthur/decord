// Module ID: 6668
// Function ID: 6669
// Dependencies: [6649, 1636, 6642, 6669]
...
export const useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  const bottomSheetInternal = require("module_6649").useBottomSheetInternal();
  ...
  const fn2 = function b(contentOffset, shouldLockInitialPosition) {
    ...
    } else if (animatedAnimationState.value !== tmp(6642).ANIMATION_STATE.RUNNING) {
      closure_1.value = y;
      sharedValue.value = y;
