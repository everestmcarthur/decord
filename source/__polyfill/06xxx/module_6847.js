// Module ID: 6847
// Function ID: 6848
// Dependencies: [6828, 1637, 6821, 6848]
...
export const useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  const bottomSheetInternal = require("module_6828").useBottomSheetInternal();
  ...
  const fn2 = function b(contentOffset, shouldLockInitialPosition) {
    ...
    } else if (animatedAnimationState.value !== tmp(6821).ANIMATION_STATE.RUNNING) {
      closure_1.value = y;
      sharedValue.value = y;
