// Module ID: 6789
// Function ID: 6790
// Dependencies: [19, 21, 6790, 6811, 6816, 6812, 6817, 6818, 6801, 6814, 6813, 6819, 6820]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6801(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6801(current.viewRef) });
      return () => {
