// Module ID: 6970
// Function ID: 6971
// Dependencies: [6971, 6928, 19, 17, 6972, 6973, 6943, 6974, 6968]
// Exports: useRecyclerViewController

// Module 6970
import PlatformConfig from "PlatformConfig" /* 6943 */;
import asyncGeneratorStep from "module_6971" /* 6971 */;
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  dependencyMap = arg2;
  const unmountFlag = require("module_6972").useUnmountFlag();
  let obj = require("module_6972");
  ...
  _setTimeout = require("module_6973").useUnmountAwareTimeout().setTimeout;
  let obj2 = require("module_6973");
                  ...
                  if (data) {
                    if (data.length > 0) {
                      ...
                      if (!engagedIndices.includes(closure_129_2)) {
                        const obj6 = { index: closure_129_2, animated };
                        c3 = 2;
                        c4 = 1;
