// Module ID: 6931
// Function ID: 6932
// Dependencies: [19, 6870, 6853, 6932, 6916, 6892, 6879, 6852]
// Exports: useGesture
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("module_6932").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      return () => {
        closure_0(6916).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(6916);
        closure_0(6852).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
