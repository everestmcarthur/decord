// Module ID: 6783
// Function ID: 6784
// Dependencies: [19, 21, 6784, 6805, 6810, 6806, 6811, 6812, 6795, 6808, 6807, 6813, 6814]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6795(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6795(current.viewRef) });
      return () => {
