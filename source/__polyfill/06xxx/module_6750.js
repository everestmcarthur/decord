// Module ID: 6750
// Function ID: 6751
// Dependencies: [19, 21, 6751, 6772, 6777, 6773, 6778, 6779, 6762, 6775, 6774, 6780, 6781]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6762(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6762(current.viewRef) });
      return () => {
