// Module ID: 6817
// Function ID: 6818
// Dependencies: [41, 42, 93, 95, 98, 19, 6768, 6806]
...
const entry = {
  ...
  value: function render() {
    try {
      ...
      const _Error = Error;
      const error = new Error(Wrap(6768).tagMessage("GestureDetector got more than one view as a child. If you want the gesture to work on multiple views, wrap them with a common parent and attach the gesture to that view."));
      throw error;
    }
  }
};
...
const Reanimated = fn(6806).Reanimated;
