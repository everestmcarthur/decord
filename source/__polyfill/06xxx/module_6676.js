...
wrappedSetGestureState.__closure = { tagMessage: fn(6674).tagMessage };
...
function create(handlerTag) {
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6675").State };
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("module_6675").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6675").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("module_6675").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6675").State };
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("module_6675").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6675").State };
...
create.__closure = { wrappedSetGestureState, State: fn(6675).State };
