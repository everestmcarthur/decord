// Module ID: 6920
// Function ID: 6921
// Dependencies: [17, 19, 21, 6888, 6921, 6922, 6923]
...
import CompatScroller from "CompatScroller" /* 6923 */;
...
export const useSecondaryProps = function useSecondaryProps(ListHeaderComponent) {
  ...
  let tmp7 = ListEmptyComponentStyle(() => {
    ...
    if (ListHeaderComponent) {
      ...
      obj.style = items;
      obj.children = _mod6922.getValidComponent(tmp);
  ...
  let obj2 = {
    ...
    renderEmpty: ListEmptyComponentStyle(() => {
      if (ListEmptyComponent) {
        const validComponent = _mod6922.getValidComponent(tmp);
  ...
  obj2.renderStickyHeaderBackdrop = ListEmptyComponentStyle(() => {
    ...
    if (backdropComponent) {
      ...
      obj.children = _mod6922.getValidComponent(backdropComponent1);
