// Module ID: 6704
// Function ID: 6705
// Dependencies: [6685, 1636, 6678, 6705]
...
export const useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  const bottomSheetInternal = require("module_6685").useBottomSheetInternal();
  ...
  const fn2 = function b(contentOffset, shouldLockInitialPosition) {
    ...
    } else if (animatedAnimationState.value !== tmp(6678).ANIMATION_STATE.RUNNING) {
      closure_1.value = y;
      sharedValue.value = y;
