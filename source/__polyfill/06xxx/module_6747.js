// Module ID: 6747
// Function ID: 6748
// Dependencies: [93, 95, 98, 42, 41, 6748, 6731]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6748).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6731).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6731);
      }
      return tmp;
    }
  }
