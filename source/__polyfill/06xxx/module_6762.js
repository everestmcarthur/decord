// Module ID: 6762
// Function ID: 6763
// Dependencies: [6743, 1637, 6736, 6763]
...
export const useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  const bottomSheetInternal = require("module_6743").useBottomSheetInternal();
  ...
  const fn2 = function b(contentOffset, shouldLockInitialPosition) {
    ...
    } else if (animatedAnimationState.value !== tmp(6736).ANIMATION_STATE.RUNNING) {
      closure_1.value = y;
      sharedValue.value = y;
