...
setGestureState.__closure = { tagMessage: fn(6765).tagMessage };
...
const obj = { tagMessage: fn(6765).tagMessage };
fn2.__closure = { setGestureState, State: fn(6766).State };
...
const fn3 = function n(arg0) {
  const FAILED = _mod6766.State.FAILED;
  if (typeof fn === "function") {
    const _globalThis = globalThis;
    const _globalThis2 = globalThis;
    if (globalThis._setGestureStateSync) {
...
const obj3 = { setGestureState, State: fn(6766).State };
fn3.__closure = { setGestureState, State: fn(6766).State };
...
const obj4 = { setGestureState, State: fn(6766).State };
fn4.__closure = { setGestureState, State: fn(6766).State };
