...
wrappedSetGestureState.__closure = { tagMessage: fn(6731).tagMessage };
...
function create(handlerTag) {
  ...
  const wrappedSetGestureState = function p() {
    const BEGAN = _mod6732.State.BEGAN;
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6732").State };
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("module_6732").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6732").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("module_6732").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6732").State };
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("module_6732").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6732").State };
...
create.__closure = { wrappedSetGestureState, State: fn(6732).State };
