// Module ID: 6728
// Function ID: 6729
// Dependencies: [19, 21, 6729, 6750, 6755, 6751, 6756, 6757, 6740, 6753, 6752, 6758, 6759]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6740(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6740(current.viewRef) });
      return () => {
