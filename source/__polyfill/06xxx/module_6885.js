// Module ID: 6885
// Function ID: 6886
// Dependencies: [32, 109, 19, 17, 21, 6771, 6867, 6868, 6869, 6870, 6886, 6864, 6789, 6862]
// Exports: default

// Module 6885
import tagMessage2 from "tagMessage" /* 6771 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6867 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6870 */;
import GestureObjects2 from "GestureObjects" /* 6886 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6867).gestureToPressableEvent(arg0));
        let obj = hitSlop(6867);
      }
    };
