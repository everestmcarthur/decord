// Module ID: 6880
// Function ID: 6881
// Dependencies: [19, 21, 6703, 1636, 6699, 6709]
// Exports: default
...
export default function _default(children) {
  ...
  const gestureHandler = _mod6703.useGestureHandler(value2.GESTURE_SOURCE.CONTENT, animatedContentGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
  const gestureHandler1 = _mod6703.useGestureHandler(value2.GESTURE_SOURCE.HANDLE, animatedHandleGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
