// Module ID: 6879
// Function ID: 6880
// Dependencies: [32, 109, 19, 17, 21, 6765, 6861, 6862, 6863, 6864, 6880, 6858, 6783, 6856]
// Exports: default

// Module 6879
import tagMessage2 from "tagMessage" /* 6765 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6861 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6864 */;
import GestureObjects2 from "GestureObjects" /* 6880 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6861).gestureToPressableEvent(arg0));
        let obj = hitSlop(6861);
      }
    };
