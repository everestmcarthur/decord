// Module ID: 6967
// Function ID: 6968
// Dependencies: [32, 109, 19, 17, 21, 6853, 6949, 6950, 6951, 6952, 6968, 6946, 6871, 6944]
// Exports: default

// Module 6967
import tagMessage2 from "tagMessage" /* 6853 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6949 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6952 */;
import GestureObjects2 from "GestureObjects" /* 6968 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6949).gestureToPressableEvent(arg0));
        let obj = hitSlop(6949);
      }
    };
