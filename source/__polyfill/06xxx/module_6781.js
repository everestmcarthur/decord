// Module ID: 6781
// Function ID: 6782
// Dependencies: [93, 95, 98, 42, 41, 6782, 6765]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6782).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6765).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6765);
      }
      return tmp;
    }
  }
