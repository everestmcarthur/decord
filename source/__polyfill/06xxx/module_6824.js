// Module ID: 6824
// Function ID: 6825
// Dependencies: [32, 109, 19, 17, 21, 6710, 6806, 6807, 6808, 6809, 6825, 6803, 6728, 6801]
// Exports: default

// Module 6824
import tagMessage2 from "tagMessage" /* 6710 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6806 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6809 */;
import GestureObjects2 from "GestureObjects" /* 6825 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6806).gestureToPressableEvent(arg0));
        let obj = hitSlop(6806);
      }
    };
