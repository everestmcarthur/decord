// Module ID: 6846
// Function ID: 6847
// Dependencies: [19, 6785, 6768, 6847, 6831, 6807, 6794, 6767]
// Exports: useGesture
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("module_6847").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      const NativeProxy = _mod6807.NativeProxy;
      ...
      return () => {
        closure_0(6831).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(6831);
        closure_0(6767).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
