// Module ID: 6846
// Function ID: 6847
// Dependencies: [32, 109, 19, 17, 21, 6732, 6828, 6829, 6830, 6831, 6847, 6825, 6750, 6823]
// Exports: default

// Module 6846
import tagMessage2 from "tagMessage" /* 6732 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6828 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6831 */;
import GestureObjects2 from "GestureObjects" /* 6847 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6828).gestureToPressableEvent(arg0));
        let obj = hitSlop(6828);
      }
    };
