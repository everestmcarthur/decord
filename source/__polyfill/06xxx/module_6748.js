// Module ID: 6748
// Function ID: 6749
// Dependencies: [93, 95, 98, 42, 41, 6749, 6732]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6749).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6732).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6732);
      }
      return tmp;
    }
  }
