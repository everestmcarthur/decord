// Module ID: 6787
// Function ID: 6788
// Dependencies: [93, 95, 98, 42, 41, 6788, 6771]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6788).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6771).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6771);
      }
      return tmp;
    }
  }
