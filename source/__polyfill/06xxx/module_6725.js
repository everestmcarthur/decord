// Module ID: 6725
// Function ID: 6726
// Dependencies: [6706, 1636, 6699, 6726]
...
export const useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  const bottomSheetInternal = require("module_6706").useBottomSheetInternal();
  ...
  const fn2 = function b(contentOffset, shouldLockInitialPosition) {
    ...
    } else if (animatedAnimationState.value !== tmp(6699).ANIMATION_STATE.RUNNING) {
      closure_1.value = y;
      sharedValue.value = y;
