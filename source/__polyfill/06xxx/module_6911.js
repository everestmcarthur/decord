// Module ID: 6911
// Function ID: 6912
// Dependencies: [109, 19, 21, 6710, 6703, 6912, 1636, 6699, 6726, 6913]
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(SCROLLVIEW, animatedComponent) {
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const scrollHandler1 = _mod6703.useScrollHandler(scrollEventsHandlersHook, onScroll, onScrollBeginDrag, onScrollEndDrag, lockableScrollableContentOffsetY);
    ...
    const tmp4Result4 = _mod6703;
    const stableCallback = _mod6703.useStableCallback((arg0, arg1) => {
      setContentSize(arg1);
      if (closure_1_2) {
        tmp2(arg0, arg1);
      }
