...
wrappedSetGestureState.__closure = { tagMessage: fn(6710).tagMessage };
...
function create(handlerTag) {
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6711").State };
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("module_6711").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6711").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("module_6711").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6711").State };
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("module_6711").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6711").State };
...
create.__closure = { wrappedSetGestureState, State: fn(6711).State };
