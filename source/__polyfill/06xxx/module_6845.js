// Module ID: 6845
// Function ID: 6846
// Dependencies: [32, 109, 19, 17, 21, 6731, 6827, 6828, 6829, 6830, 6846, 6824, 6749, 6822]
// Exports: default

// Module 6845
import tagMessage2 from "tagMessage" /* 6731 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6827 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6830 */;
import GestureObjects2 from "GestureObjects" /* 6846 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6827).gestureToPressableEvent(arg0));
        let obj = hitSlop(6827);
      }
    };
