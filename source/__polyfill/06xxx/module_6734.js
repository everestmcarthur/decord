...
wrappedSetGestureState.__closure = { tagMessage: fn(6732).tagMessage };
...
function create(handlerTag) {
  ...
  const wrappedSetGestureState = function p() {
    const BEGAN = _mod6733.State.BEGAN;
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6733").State };
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("module_6733").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6733").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("module_6733").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6733").State };
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("module_6733").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6733").State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = __initData4;
  obj.end = fn3;
  return obj;
}
let obj = { tagMessage: fn(6732).tagMessage };
create.__closure = { wrappedSetGestureState, State: fn(6733).State };
