...
wrappedSetGestureState.__closure = { tagMessage: fn(6768).tagMessage };
...
function create(handlerTag) {
  ...
  const wrappedSetGestureState = function p() {
    const BEGAN = _mod6769.State.BEGAN;
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6769").State };
  ...
  const fn2 = function c() {
    const ACTIVE = _mod6769.State.ACTIVE;
    if (typeof fn === "function") {
      const _globalThis = globalThis;
      const _globalThis2 = globalThis;
      if (globalThis._setGestureStateSync) {
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("module_6769").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6769").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("module_6769").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6769").State };
  S.__workletHash = 12634480855880;
  S.__initData = __initData3;
  obj.fail = S;
  const fn3 = function s() {
    const END = _mod6769.State.END;
    if (typeof fn === "function") {
      const _globalThis = globalThis;
      const _globalThis2 = globalThis;
      if (globalThis._setGestureStateSync) {
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("module_6769").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6769").State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = __initData4;
  obj.end = fn3;
  return obj;
}
let obj = { tagMessage: fn(6768).tagMessage };
create.__closure = { wrappedSetGestureState, State: fn(6769).State };
