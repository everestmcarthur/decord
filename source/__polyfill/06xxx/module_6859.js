...
class TouchableHighlight {
  constructor(arg0) {
    ...
    tmp3Result.onStateChange = (arg0, arg1) => {
      if (arg1 === TouchableHighlight(6860).TOUCHABLE_STATE.BEGAN) {
        closure_0.showUnderlay();
      } else {
        if (!tmp3) {
          closure_0.hideUnderlay();
        }
        tmp3 = arg1 !== tmp(6860).TOUCHABLE_STATE.UNDETERMINED && arg1 !== tmp(6860).TOUCHABLE_STATE.MOVED_OUTSIDE;
      }
    };
