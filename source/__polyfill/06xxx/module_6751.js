...
fn.__closure = { ANIMATION_CONFIGS: fn(6733).ANIMATION_CONFIGS, ANIMATION_METHOD: fn(6733).ANIMATION_METHOD, withTiming: fn(1637).withTiming, withSpring: fn(1637).withSpring };
