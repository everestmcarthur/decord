// Module ID: 6951
// Function ID: 6952
// Dependencies: [109, 19, 21, 6750, 6743, 6952, 1637, 6739, 6766, 6953]
...
import ScrollableContainer from "ScrollableContainer" /* 6953 */;
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(SCROLLVIEW, animatedComponent) {
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const scrollHandler1 = _mod6743.useScrollHandler(scrollEventsHandlersHook, onScroll, onScrollBeginDrag, onScrollEndDrag, lockableScrollableContentOffsetY);
    ...
    const scrollableSetter = _mod6743.useScrollableSetter(scrollableRef, SCROLLVIEW, scrollableContentOffsetY, undefined !== onRefresh, focusHook);
