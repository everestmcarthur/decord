// Module ID: 6869
// Function ID: 6870
// Dependencies: [93, 95, 98, 42, 41, 6870, 6853]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6870).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6853).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6853);
      }
      return tmp;
    }
  }
