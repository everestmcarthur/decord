// Module ID: 6956
// Function ID: 6957
// Dependencies: [17, 19, 21, 6924, 6957, 6958, 6959]
...
import CompatScroller from "CompatScroller" /* 6959 */;
...
export const useSecondaryProps = function useSecondaryProps(ListHeaderComponent) {
  ...
  let tmp7 = ListEmptyComponentStyle(() => {
    ...
    if (ListHeaderComponent) {
      ...
      obj.style = items;
      obj.children = _mod6958.getValidComponent(tmp);
  ...
  let obj2 = {
    ...
    renderEmpty: ListEmptyComponentStyle(() => {
      if (ListEmptyComponent) {
        const validComponent = _mod6958.getValidComponent(tmp);
  ...
  obj2.renderStickyHeaderBackdrop = ListEmptyComponentStyle(() => {
    ...
    if (backdropComponent) {
      ...
      obj.children = _mod6958.getValidComponent(backdropComponent1);
