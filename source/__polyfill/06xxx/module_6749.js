// Module ID: 6749
// Function ID: 6750
// Dependencies: [19, 21, 6750, 6771, 6776, 6772, 6777, 6778, 6761, 6774, 6773, 6779, 6780]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6761(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6761(current.viewRef) });
      return () => {
