// Module ID: 6912
// Function ID: 6913
// Dependencies: [109, 19, 21, 6711, 6704, 6913, 1636, 6700, 6727, 6914]
...
import ScrollableContainer from "ScrollableContainer" /* 6914 */;
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(SCROLLVIEW, animatedComponent) {
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const tmp6 = hasOwnProperty(_mod6711.BottomSheetDraggableContext);
    closure_3 = tmp6;
    ...
    const scrollHandler1 = _mod6704.useScrollHandler(scrollEventsHandlersHook, onScroll, onScrollBeginDrag, onScrollEndDrag, lockableScrollableContentOffsetY);
    ...
    const setContentSize = _mod6913.useBottomSheetContentSizeSetter().setContentSize;
    if (!tmp6) {
    ...
    const tmp4Result4 = _mod6704;
    const stableCallback = _mod6704.useStableCallback((arg0, arg1) => {
      setContentSize(arg1);
      if (closure_1_2) {
        tmp2(arg0, arg1);
      }
    });
    const bottomSheetContentContainerStyle = _mod6704.useBottomSheetContentContainerStyle(tmp, contentContainerStyle);
    timestampProducer(arg1, () => scrollableRef.current);
    const tmp4Result5 = _mod6704;
    const scrollableSetter = _mod6704.useScrollableSetter(scrollableRef, SCROLLVIEW, scrollableContentOffsetY, undefined !== onRefresh, focusHook);
