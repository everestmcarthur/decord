// Module ID: 6798
// Function ID: 6799
// Dependencies: [41, 42, 93, 95, 98, 19, 6799, 6765, 6787, 6785]
...
import PlatformConstants from "module_6799" /* 6799 */;
...
const entry = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6765).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  entry,
...
if (forceTouchAvailable) {
  ...
  const items2 = [];
  HermesBuiltin.arraySpread(items1, HermesBuiltin.arraySpread(fn(6785).baseGestureHandlerProps, 0));
  obj.allowedProps = items2;
  obj.config = {};
  importDefaultResultResult = _modDef6787(obj);
  const importDefaultResult4 = _modDef6787;
}
let flag;
if (PlatformConstants != null) {
