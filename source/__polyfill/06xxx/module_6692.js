// Module ID: 6692
// Function ID: 6693
// Dependencies: [19, 21, 6693, 6714, 6719, 6715, 6720, 6721, 6704, 6717, 6716, 6722, 6723]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6704(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6704(current.viewRef) });
      return () => {
