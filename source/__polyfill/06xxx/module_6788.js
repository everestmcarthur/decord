// Module ID: 6788
// Function ID: 6789
// Dependencies: [19, 6727, 6710, 6789, 6773, 6749, 6736, 6709]
// Exports: useGesture
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("module_6789").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      const NativeProxy = _mod6749.NativeProxy;
      ...
      return () => {
        closure_0(6773).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(6773);
        closure_0(6709).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
