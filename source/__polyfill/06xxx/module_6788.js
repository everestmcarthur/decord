// Module ID: 6788
// Function ID: 6789
// Dependencies: [32, 109, 19, 17, 21, 6674, 6770, 6771, 6772, 6773, 6789, 6767, 6692, 6765]
// Exports: default

// Module 6788
import tagMessage2 from "tagMessage" /* 6674 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6770 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6773 */;
import GestureObjects2 from "GestureObjects" /* 6789 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6770).gestureToPressableEvent(arg0));
        let obj = hitSlop(6770);
      }
    };
