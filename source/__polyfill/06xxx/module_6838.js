...
setGestureState.__closure = { tagMessage: fn(6731).tagMessage };
...
const obj = { tagMessage: fn(6731).tagMessage };
fn2.__closure = { setGestureState, State: fn(6732).State };
...
const obj3 = { setGestureState, State: fn(6732).State };
...
const obj4 = { setGestureState, State: fn(6732).State };
