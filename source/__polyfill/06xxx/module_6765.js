// Module ID: 6765
// Function ID: 6766
// Dependencies: [41, 42, 93, 95, 98, 19, 6766, 6732, 6754, 6752]
...
import PlatformConstants from "module_6766" /* 6766 */;
...
const entry = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6732).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  entry,
...
if (forceTouchAvailable) {
  ...
  const items2 = [];
  HermesBuiltin.arraySpread(items1, HermesBuiltin.arraySpread(fn(6752).baseGestureHandlerProps, 0));
  obj.allowedProps = items2;
  obj.config = {};
  importDefaultResultResult = _modDef6754(obj);
  const importDefaultResult4 = _modDef6754;
}
let flag;
if (PlatformConstants != null) {
