// Module ID: 6765
// Function ID: 6766
// Dependencies: [6746, 1637, 6739, 6766]
...
export const useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  const bottomSheetInternal = require("module_6746").useBottomSheetInternal();
  ...
  const fn2 = function b(contentOffset, shouldLockInitialPosition) {
    ...
    } else if (animatedAnimationState.value !== tmp(6739).ANIMATION_STATE.RUNNING) {
      closure_1.value = y;
      sharedValue.value = y;
