// Module ID: 6743
// Function ID: 6744
// Dependencies: [41, 42, 93, 95, 98, 19, 6744, 6710, 6732, 6730]
...
import PlatformConstants from "module_6744" /* 6744 */;
...
const entry = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6710).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  entry,
...
if (forceTouchAvailable) {
  ...
  const items2 = [];
  HermesBuiltin.arraySpread(items1, HermesBuiltin.arraySpread(fn(6730).baseGestureHandlerProps, 0));
  obj.allowedProps = items2;
  obj.config = {};
  importDefaultResultResult = _modDef6732(obj);
  const importDefaultResult4 = _modDef6732;
}
let flag;
if (PlatformConstants != null) {
