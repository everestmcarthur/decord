// Module ID: 6849
// Function ID: 6850
// Dependencies: [19, 6788, 6771, 6850, 6834, 6810, 6797, 6770]
// Exports: useGesture
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("module_6850").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      const NativeProxy = _mod6810.NativeProxy;
      ...
      return () => {
        closure_0(6834).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(6834);
        closure_0(6770).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
