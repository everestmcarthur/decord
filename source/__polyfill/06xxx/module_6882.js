// Module ID: 6882
// Function ID: 6883
// Dependencies: [32, 109, 19, 21, 6883, 6682, 4477, 6884, 6694, 6679]

// Module 6882
import normalizeSnapPoint from "normalizeSnapPoint" /* 6694 */;
import id from "id" /* 6884 */;
...
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6682").useBottomSheetModalInternal();
