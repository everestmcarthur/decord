// Module ID: 6882
// Function ID: 6883
// Dependencies: [32, 109, 19, 17, 21, 6768, 6864, 6865, 6866, 6867, 6883, 6861, 6786, 6859]
// Exports: default

// Module 6882
import tagMessage2 from "tagMessage" /* 6768 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6864 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6867 */;
import GestureObjects2 from "GestureObjects" /* 6883 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6864).gestureToPressableEvent(arg0));
        let obj = hitSlop(6864);
      }
    };
