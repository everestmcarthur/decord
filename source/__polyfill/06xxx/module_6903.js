// Module ID: 6903
// Function ID: 6904
// Dependencies: [32, 109, 19, 21, 6904, 6703, 4479, 6905, 6715, 6700]

// Module 6903
import normalizeSnapPoint from "normalizeSnapPoint" /* 6715 */;
import id from "id" /* 6905 */;
...
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6703").useBottomSheetModalInternal();
