// Module ID: 6881
// Function ID: 6882
// Dependencies: [19, 21, 6704, 1636, 6700, 6710]
// Exports: default
...
export default function _default(children) {
  ...
  if (useGestureEventsHandlersDefault === undefined) {
    useGestureEventsHandlersDefault = _mod6704.useGestureEventsHandlersDefault;
  }
  ...
  const gestureHandler = _mod6704.useGestureHandler(value2.GESTURE_SOURCE.CONTENT, animatedContentGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
  const gestureHandler1 = _mod6704.useGestureHandler(value2.GESTURE_SOURCE.HANDLE, animatedHandleGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
