// Module ID: 6723
// Function ID: 6724
// Dependencies: [41, 42, 93, 95, 98, 19, 6674, 6712]
...
const entry = {
  ...
  value: function render() {
    try {
      ...
      const _Error = Error;
      const error = new Error(Wrap(6674).tagMessage("GestureDetector got more than one view as a child. If you want the gesture to work on multiple views, wrap them with a common parent and attach the gesture to that view."));
      throw error;
    }
  }
};
...
const Reanimated = fn(6712).Reanimated;
