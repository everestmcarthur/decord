// Module ID: 6980
// Function ID: 6981
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 6981]
...
class TouchableHighlight {
  constructor(arg0) {
    ...
    tmp3Result.onStateChange = (arg0, arg1) => {
      if (arg1 === TouchableHighlight(6981).TOUCHABLE_STATE.BEGAN) {
        closure_0.showUnderlay();
      } else {
        if (!tmp3) {
          closure_0.hideUnderlay();
        }
        tmp3 = arg1 !== tmp(6981).TOUCHABLE_STATE.UNDETERMINED && arg1 !== tmp(6981).TOUCHABLE_STATE.MOVED_OUTSIDE;
      }
    };
...
let items = [
  entry,
  {
    ...
    value: function render() {
      ...
      return jsx(_modDef6981, {});
    }
  }
];
const importDefaultResultResult = _createClass(TouchableHighlight, items);
let obj = {};
let merged = Object.assign(_modDef6981.defaultProps);
