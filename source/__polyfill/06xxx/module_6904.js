// Module ID: 6904
// Function ID: 6905
// Dependencies: [32, 109, 19, 21, 6905, 6704, 4479, 6906, 6716, 6701]

// Module 6904
import normalizeSnapPoint from "normalizeSnapPoint" /* 6716 */;
import id from "id" /* 6906 */;
...
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6704").useBottomSheetModalInternal();
