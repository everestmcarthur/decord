// Module ID: 16664
// Function ID: 16665
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 16665]
// Exports: captureScreen, ensureModuleIsLoaded

// Module 16664
import _modDef16665 from "module_16665" /* 16665 */;
...
function captureRef(current, options) {
  if (ViewShot(16665)) {
    ...
    return tmp(16665).captureRef(tmp15, options);
  } else {
    const _Error = Error;
...
function releaseCapture(str) {
  if (typeof str === "string") {
    ViewShot(16665).releaseCapture(str);
    const obj = ViewShot(16665);
  }
}
...
export const captureScreen = function captureScreen(options) {
  if (ViewShot(16665)) {
    ...
    return tmp(16665).captureScreen(options);
  } else {
    const _Error = Error;
    const error = new Error("react-native-view-shot: NativeModules.RNViewShot is undefined. Make sure the library is linked on the native side.");
    throw error;
