// Module ID: 16599
// Function ID: 16600
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 16600]
// Exports: captureScreen, ensureModuleIsLoaded

// Module 16599
import _modDef16600 from "module_16600" /* 16600 */;
...
function captureRef(current, options) {
  if (ViewShot(16600)) {
    ...
    return tmp(16600).captureRef(tmp15, options);
  } else {
    const _Error = Error;
...
function releaseCapture(str) {
  if (typeof str === "string") {
    ViewShot(16600).releaseCapture(str);
    const obj = ViewShot(16600);
  }
}
...
export const captureScreen = function captureScreen(options) {
  if (ViewShot(16600)) {
    ...
    return tmp(16600).captureScreen(options);
  } else {
    const _Error = Error;
    const error = new Error("react-native-view-shot: NativeModules.RNViewShot is undefined. Make sure the library is linked on the native side.");
    throw error;
