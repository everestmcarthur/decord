...
// Function ID: 10853
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10853, 1636, 10830, 10854]
// Exports: ItemRenderer

// Module 10852 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod10853.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
