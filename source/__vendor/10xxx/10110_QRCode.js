...
// Function ID: 10111
// Name: QRCode
// Dependencies: [10111, 10115, 10120, 19, 10123]

// Module 10110 (QRCode)
import QRCode_mod from "module_10111" /* 10111 */;
import module_10115_mod from "module_10115" /* 10115 */;
import emptyFunction from "module_10120" /* 10120 */;
import noop_mod from "module_19" /* 19 */;
import QRCodeSvg_mod from "QRCodeSvg" /* 10123 */;
...
QRCode = tmp3;
let module_10115 = module_10115_mod;
if (!module_10115) {
  let obj2 = { default: module_10115 };
  let tmp5 = obj2;
} else {
  tmp5 = module_10115;
}
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const _default1 = new QRCode.default(-1, module_10115.default[level]);
