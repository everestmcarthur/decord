...
// Function ID: 10874
// Name: ItemLayout
// Dependencies: [19, 21, 10856, 10874, 1636]
// Exports: ItemLayout

// Module 10873 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10856.useGlobalState().props;
  ...
  const offsetX = _mod10874.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10874;
  const fn = function k() {
