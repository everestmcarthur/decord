...
// Function ID: 10872
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10872, 1636, 10849, 10873]
// Exports: ItemRenderer

// Module 10871 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod10872.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
