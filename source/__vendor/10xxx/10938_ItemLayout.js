...
// Function ID: 10939
// Name: ItemLayout
// Dependencies: [19, 21, 10921, 10939, 1637]
// Exports: ItemLayout

// Module 10938 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10921.useGlobalState().props;
  ...
  const offsetX = _mod10939.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10939;
  const fn = function k() {
