...
// Function ID: 10911
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10911, 1636, 10888, 10912]
// Exports: ItemRenderer

// Module 10910 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod10911.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
