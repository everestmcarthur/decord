...
// Module 10441 (getNthWeekdayOfMonth)
...
let obj = {
  ...
  dstStart(arg0) {
    const MARCH = _mod10442.Month.MARCH;
    const SUNDAY = _mod10442.Weekday.SUNDAY;
    let num = 7;
    if (0 !== SUNDAY) {
      num = SUNDAY;
    }
  ...
  dstEnd(arg0) {
    const OCTOBER = _mod10442.Month.OCTOBER;
    const SUNDAY = _mod10442.Weekday.SUNDAY;
    let num = 7;
    if (0 !== SUNDAY) {
      num = SUNDAY;
...
obj = {
  ...
  dstEnd(arg0) {
    let sum;
    let sum1;
    const NOVEMBER = _mod10442.Month.NOVEMBER;
    let num = 0;
    let num2 = 0;
    do {
      sum = num2 + 1;
