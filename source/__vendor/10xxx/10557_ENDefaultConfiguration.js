...
// Dependencies: [41, 42, 10558, 10568, 10569, 10570, 10571, 10572, 10573, 10575, 10576, 10577, 10580, 10583, 10585, 10586, 10588, 10589, 10590, 10591, 10592, 10593, 10594, 10595, 10596]

// Module 10557 (ENDefaultConfiguration)
...
const _isNativeReflectConstruct = fn(_mod10595);
...
let items = [
  entry,
  {
    ...
    value: function createConfiguration(flag) {
      ...
      obj.refiners = items1;
      const result = ENDefaultConfiguration(10596).includeCommonConfiguration(obj, flag);
