...
// Function ID: 10855
// Name: ItemLayout
// Dependencies: [19, 21, 10837, 10855, 1636]
// Exports: ItemLayout

// Module 10854 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10837.useGlobalState().props;
  ...
  const offsetX = _mod10855.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10855;
  const fn = function k() {
