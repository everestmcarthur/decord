...
// Dependencies: [10440, 10442]

// Module 10464 (getDaysToWeekday)
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, arg2) {
  ...
  if ("this" === arg2) {
    ...
    if (day == _mod10442.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10442).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10442).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10442).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10442).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
