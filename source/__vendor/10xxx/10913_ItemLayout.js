...
// Function ID: 10914
// Name: ItemLayout
// Dependencies: [19, 21, 10896, 10914, 1636]
// Exports: ItemLayout

// Module 10913 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10896.useGlobalState().props;
  ...
  const offsetX = _mod10914.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10914;
  const fn = function k() {
