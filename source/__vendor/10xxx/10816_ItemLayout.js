...
// Function ID: 10817
// Name: ItemLayout
// Dependencies: [19, 21, 10799, 10817, 1636]
// Exports: ItemLayout

// Module 10816 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10799.useGlobalState().props;
  ...
  const offsetX = _mod10817.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10817;
  const fn = function k() {
