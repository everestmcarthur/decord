...
// Function ID: 10912
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10912, 1636, 10889, 10913]
// Exports: ItemRenderer

// Module 10911 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod10912.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
