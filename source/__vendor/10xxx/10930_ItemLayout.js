...
// Function ID: 10931
// Name: ItemLayout
// Dependencies: [19, 21, 10913, 10931, 1637]
// Exports: ItemLayout

// Module 10930 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10913.useGlobalState().props;
  ...
  const offsetX = _mod10931.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10931;
  const fn = function k() {
