...
// Function ID: 10876
// Name: ItemLayout
// Dependencies: [19, 21, 10858, 10876, 1636]
// Exports: ItemLayout

// Module 10875 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10858.useGlobalState().props;
  ...
  const offsetX = _mod10876.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10876;
  const fn = function k() {
