...
// Function ID: 10815
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10815, 1636, 10792, 10816]
// Exports: ItemRenderer

// Module 10814 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod10815.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
