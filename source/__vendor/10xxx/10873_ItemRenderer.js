...
// Function ID: 10874
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10874, 1636, 10851, 10875]
// Exports: ItemRenderer

// Module 10873 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod10874.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
