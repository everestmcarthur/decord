...
// Function ID: 10434
// Name: Chrono
// Dependencies: [41, 42, 10434, 10440]

// Module 10433 (Chrono)
import ENDefaultConfiguration from "ENDefaultConfiguration" /* 10434 */;
...
obj = {
  ...
  value: function executeParser(closure_0, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof index(10440).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10440).ParsingComponents)) {
...
obj = {
  ...
  value: function createParsingComponents(extractResult) {
    ...
    if (!(extractResult instanceof ParsingContext(10440).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10440).ParsingComponents(this.reference, extractResult);
    }
...
const items2 = [
  obj,
  {
    ...
    value: function createParsingResult(index, length2, extractResult, extractResult) {
      ...
      return new ParsingContext(10440).ParsingResult(self.reference, index, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
