...
// Function ID: 10913
// Name: ItemLayout
// Dependencies: [19, 21, 10895, 10913, 1636]
// Exports: ItemLayout

// Module 10912 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10895.useGlobalState().props;
  ...
  const offsetX = _mod10913.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10913;
  const fn = function k() {
