...
// Function ID: 12981
// Name: SessionFlusher
// Dependencies: [41, 42, 12933, 12954]

// Module 12980 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12933).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12954).getIsolationScope();
        ...
        const obj = SessionFlusher(12954);
      }
    }
  },
  {
