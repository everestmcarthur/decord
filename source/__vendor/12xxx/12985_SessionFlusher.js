...
// Function ID: 12986
// Name: SessionFlusher
// Dependencies: [41, 42, 12938, 12959]

// Module 12985 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12938).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12959).getIsolationScope();
        ...
        const obj = SessionFlusher(12959);
      }
    }
  },
  {
