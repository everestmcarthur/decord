...
// Function ID: 12881
// Name: SessionFlusher
// Dependencies: [41, 42, 12833, 12854]

// Module 12880 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12833).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12854).getIsolationScope();
        ...
        const obj = SessionFlusher(12854);
      }
    }
  },
  {
