...
// Function ID: 12946
// Name: SessionFlusher
// Dependencies: [41, 42, 12898, 12919]

// Module 12945 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12898).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12919).getIsolationScope();
        ...
        const obj = SessionFlusher(12919);
      }
    }
  },
  {
