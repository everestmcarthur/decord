...
// Function ID: 12921
// Name: SessionFlusher
// Dependencies: [41, 42, 12873, 12894]

// Module 12920 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12873).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12894).getIsolationScope();
        ...
        const obj = SessionFlusher(12894);
      }
    }
  },
  {
