...
// Function ID: 12948
// Name: ScopeClass
// Dependencies: [32, 41, 42, 12936, 12948, 12949, 12933, 12940, 12951, 12937, 12926]

// Module 12947 (ScopeClass)
...
const entry = {
  ...
  value: function clone() {
    ...
    const obj = { traceId: ScopeClass(12936).generateTraceId(), spanId: null };
    const obj2 = ScopeClass(12936);
    obj.spanId = ScopeClass(12936).generateSpanId();
    ...
    const obj10 = {};
    const obj3 = ScopeClass(12936);
    const obj5 = {};
    const obj6 = {};
    const obj7 = {};
    const obj9 = {};
    const tmp3Result = ScopeClass(12948);
    tmp3Result._setSpanForScope(obj4, ScopeClass(12948)._getSpanForScope(self));
    return obj4;
  }
};
let items = [
  ...
  },
  {
    ...
    value: function setUser(user) {
      ...
      if (this._session) {
        const obj = { user };
        ScopeClass(12949).updateSession(self._session, obj);
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(12948)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      const obj3 = { traceId: null };
      const obj2 = ScopeClass(12948);
      obj3.traceId = ScopeClass(12936).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        const obj = { timestamp: ScopeClass(12940).dateTimestampInSeconds() };
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: this._fingerprint || [], eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(12948)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(12951).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(12936).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(originalException, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(12926).logger;
          logger.warn("No client configured on scope - will not capture exception!");
          return event_id;
        }
      }
      event_id = ScopeClass(12937).uuid4();
    }
  },
  {
    key: "captureMessage",
