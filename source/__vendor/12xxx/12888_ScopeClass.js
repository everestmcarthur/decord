...
// Function ID: 12889
// Name: ScopeClass
// Dependencies: [32, 41, 42, 12877, 12889, 12890, 12874, 12881, 12892, 12878, 12867]

// Module 12888 (ScopeClass)
...
const entry = {
  ...
  value: function clone() {
    ...
    const obj = { traceId: ScopeClass(12877).generateTraceId(), spanId: null };
    const obj2 = ScopeClass(12877);
    obj.spanId = ScopeClass(12877).generateSpanId();
    ...
    const obj10 = {};
    const obj3 = ScopeClass(12877);
    const obj5 = {};
    const obj6 = {};
    const obj7 = {};
    const obj9 = {};
    const tmp3Result = ScopeClass(12889);
    tmp3Result._setSpanForScope(obj4, ScopeClass(12889)._getSpanForScope(self));
    return obj4;
  }
};
let items = [
  ...
  },
  {
    ...
    value: function setUser(user) {
      if (!user) {
        user = { email: "call", id: "header", ip_address: "rejectWithError", username: "Array" };
      }
      const self = this;
      this._user = user;
      if (this._session) {
        const obj = { user };
        ScopeClass(12890).updateSession(self._session, obj);
        const obj2 = ScopeClass(12890);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(12889)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      const obj3 = { traceId: null };
      const obj2 = ScopeClass(12889);
      obj3.traceId = ScopeClass(12877).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        const obj = { timestamp: ScopeClass(12881).dateTimestampInSeconds() };
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: this._fingerprint || [], eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(12889)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(12892).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(12877).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(originalException, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(12867).logger;
          logger.warn("No client configured on scope - will not capture exception!");
          return event_id;
        }
      }
      event_id = ScopeClass(12878).uuid4();
    }
  },
  {
    key: "captureMessage",
