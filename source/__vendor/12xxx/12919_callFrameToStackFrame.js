...
// Dependencies: [12807, 12804, 12917]

// Module 12919 (callFrameToStackFrame)
import createStackParser from "createStackParser" /* 12804 */;
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  if (replaced) {
    filenameIsInAppResult = tmp4(12917).filenameIsInApp(replaced);
    const tmp4Result = tmp4(12917);
  }
