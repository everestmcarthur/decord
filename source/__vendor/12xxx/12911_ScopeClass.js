...
// Function ID: 12912
// Name: ScopeClass
// Dependencies: [32, 41, 42, 12900, 12912, 12913, 12897, 12904, 12915, 12901, 12890]

// Module 12911 (ScopeClass)
...
const entry = {
  ...
  value: function clone() {
    ...
    const obj = { traceId: ScopeClass(12900).generateTraceId(), spanId: null };
    const obj2 = ScopeClass(12900);
    obj.spanId = ScopeClass(12900).generateSpanId();
    ...
    const obj10 = {};
    const obj3 = ScopeClass(12900);
    const obj5 = {};
    const obj6 = {};
    const obj7 = {};
    const obj9 = {};
    const tmp3Result = ScopeClass(12912);
    tmp3Result._setSpanForScope(obj4, ScopeClass(12912)._getSpanForScope(self));
    return obj4;
  }
};
let items = [
  ...
  },
  {
    ...
    value: function setUser(user) {
      if (!user) {
        user = { email: "Array", id: "call", ip_address: "items", username: "httpServerLocation" };
      }
      const self = this;
      this._user = user;
      if (this._session) {
        const obj = { user };
        ScopeClass(12913).updateSession(self._session, obj);
        const obj2 = ScopeClass(12913);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(12912)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      const obj3 = { traceId: null };
      const obj2 = ScopeClass(12912);
      obj3.traceId = ScopeClass(12900).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        const obj = { timestamp: ScopeClass(12904).dateTimestampInSeconds() };
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: this._fingerprint || [], eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(12912)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(12915).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(12900).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(originalException, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(12890).logger;
          logger.warn("No client configured on scope - will not capture exception!");
          return event_id;
        }
      }
      event_id = ScopeClass(12901).uuid4();
    }
  },
  {
    key: "captureMessage",
