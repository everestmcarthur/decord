...
// Function ID: 12980
// Name: SessionFlusher
// Dependencies: [41, 42, 12932, 12953]

// Module 12979 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12932).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12953).getIsolationScope();
        ...
        const obj = SessionFlusher(12953);
      }
    }
  },
  {
