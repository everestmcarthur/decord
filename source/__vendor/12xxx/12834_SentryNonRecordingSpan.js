...
// Dependencies: [41, 42, 12811, 12806]

// Module 12834 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(12806).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
