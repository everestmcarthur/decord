...
// Dependencies: [12797, 12800, 12802, 12828, 12806, 12829, 12801, 12898, 12815, 12835, 12836]

// Module 12897 (addToMetricsAggregator)
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = _require(12828).getClient();
    const obj2 = _require(12828);
  }
  if (client) {
    const activeSpan = _require(12806).getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    if (_require(12829).DEBUG_BUILD) {
      const logger = tmp3(12801).logger;
      const _HermesInternal = HermesInternal;
      logger.log("Adding value of " + arg3 + " to " + SET_METRIC_TYPE + " metric " + arg2);
    }
    const obj3 = _require(12806);
    const globalSingleton = _require(12802).getGlobalSingleton("globalMetricsAggregators", () => {
    ...
    const tmp3Result1 = _require(12802);
  }
}
errorCallback;
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12898.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12898.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, _mod12898.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12898.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    dependencyMap = arg1;
    ...
    if (typeof fn === "function") {
      ...
      return _require(12835).startSpanManual(obj, (arg0) => {
        const callback = arg0;
        return callback(table[10]).handleCallbackErrors(() => callback(), () => {
          ...
          closure_2(lib, lib(12898).DISTRIBUTION_METRIC_TYPE, closure_1_1, parsed, obj);
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _require(12898).DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
