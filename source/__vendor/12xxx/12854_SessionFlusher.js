...
// Function ID: 12855
// Name: SessionFlusher
// Dependencies: [41, 42, 12807, 12828]

// Module 12854 (SessionFlusher)
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12807).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12828).getIsolationScope();
        ...
        const obj = SessionFlusher(12828);
      }
    }
  },
  {
