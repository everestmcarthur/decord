...
// Function ID: 12994
// Name: SessionFlusher
// Dependencies: [41, 42, 12946, 12967]

// Module 12993 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12946).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12967).getIsolationScope();
        ...
        const obj = SessionFlusher(12967);
      }
    }
  },
  {
