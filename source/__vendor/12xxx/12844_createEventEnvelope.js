...
// Module 12844 (createEventEnvelope)
import forEachEnvelopeItem from "forEachEnvelopeItem" /* 12845 */;
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(12848).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(12848);
  }
