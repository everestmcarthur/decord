...
// Module 12842 (isFullFinishedSpan)
...
class SentrySpan {
  constructor() {
    ...
    obj[require("module_12816").SEMANTIC_ATTRIBUTE_SENTRY_OP] = obj.op;
...
let items = [
  ...
  },
  {
    ...
    value: function getSpanJSON() {
      const self = this;
      let obj = SentrySpan(12807);
      obj = { data: this._attributes, description: this._name, op: this._attributes[SentrySpan(undefined, 12816).SEMANTIC_ATTRIBUTE_SENTRY_OP], parent_span_id: this._parentSpanId, span_id: this._spanId, start_timestamp: this._startTime, status: SentrySpan(12806).getStatusMessage(this._status), timestamp: null, trace_id: null, origin: _attributes[SentrySpan(undefined, 12816).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN], _metrics_summary: null, profile_id: null, exclusive_time: null, measurements: null, is_segment: null, segment_id: null };
      ({ _endTime: obj2[7], _traceId: obj2[8], _attributes } = this);
      const obj3 = SentrySpan(12806);
      obj[10] = SentrySpan(12817).getMetricSummaryJsonForSpan(this);
      obj[11] = this._attributes[SentrySpan(undefined, 12816).SEMANTIC_ATTRIBUTE_PROFILE_ID];
      obj[12] = this._attributes[SentrySpan(undefined, 12816).SEMANTIC_ATTRIBUTE_EXCLUSIVE_TIME];
      const obj4 = SentrySpan(12817);
      obj[13] = SentrySpan(12843).timedEventsToMeasurements(this._events);
      let _isStandaloneSpan = this._isStandaloneSpan;
      if (_isStandaloneSpan) {
        let tmpResult = tmp(12806);
    ...
    value: function _convertSpanToTransaction() {
      ...
      if (tmp6) {
        ...
        if (true !== self._sampled) {
          ...
          const mapped = found.map((arg0) => self(12806).spanToJSON(arg0));
          ...
          obj[0] = tmp3(12806).spanToTransactionTraceContext(self);
          obj[0] = obj;
          let substr = found1;
          ...
          const tmp3Result3 = tmp3(12806);
          const obj2 = { dynamicSamplingContext: null };
          const tmp3Result4 = tmp3(12807);
          obj2[0] = tmp3(12837).getDynamicSamplingContextFromSpan(self);
          const merged = Object.assign(tmp3Result4.dropUndefinedKeys(obj2));
          obj[6] = obj1;
          const tmp3Result5 = tmp3(12837);
          obj[7] = tmp3(12817).getMetricSummaryJsonForSpan(self);
          let tmp12 = tmp24;
          if (tmp24) {
