...
// Module 12880 (getMetadataForUrl)
const require = arg1;
const dependencyMap = arg6;
function getMetadataForUrl(arg0, arg1) {
  (function ensureMetadataStacksAreParsed(arg0) {
    if (callback(12802).GLOBAL_OBJ._sentryModuleMetadata) {
      const _Object = Object;
      const keys = Object.keys(callback(12802).GLOBAL_OBJ._sentryModuleMetadata);
      for (const item10026 of keys) {
        ...
        let tmp16 = callback(12802).GLOBAL_OBJ._sentryModuleMetadata[item10026];
        let obj = set;
