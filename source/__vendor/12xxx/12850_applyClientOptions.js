...
// Dependencies: [12812, 12815, 12828, 12851, 12852, 12838, 12810, 12853, 12846, 12822]

// Module 12850 (applyClientOptions)
...
function applyDebugIds(exception) {
  _require = _require(12853).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(12846).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(12846);
                }
