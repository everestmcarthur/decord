...
// Function ID: 12944
// Name: SessionFlusher
// Dependencies: [41, 42, 12896, 12917]

// Module 12943 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12896).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12917).getIsolationScope();
        ...
        const obj = SessionFlusher(12917);
      }
    }
  },
  {
