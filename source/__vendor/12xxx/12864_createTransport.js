...
// Dependencies: [12865, 12845, 12866, 12825, 12829, 12801, 12858]

// Module 12864 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(12845).envelopeItemTypeToDataCategory(arg1);
        const obj = items(12845);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(12845).serializeEnvelope(dependencyMap) };
          const obj2 = items(12845);
          ...
          if (arg0 instanceof items(12858).SentryError) {
