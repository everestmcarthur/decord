...
// Dependencies: [12938, 12942, 12944, 12946, 12947, 12948, 12949, 12950, 12951, 12954, 12959, 12932]
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12949.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(12949).SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(arg0, arg1) {
  ...
  const result = _mod12938.addNonEnumerableProperty(arg1, _sentryRootSpan, tmp2);
  if (arg0[_sentryChildSpans]) {
    ...
    const result1 = _mod12938.addNonEnumerableProperty(arg0, tmp6, set);
...
export const getActiveSpan = function getActiveSpan() {
  ...
  if (asyncContextStrategy.getActiveSpan) {
    ...
    activeSpan = tmpResult._getSpanForScope(tmp(12959).getCurrentScope());
