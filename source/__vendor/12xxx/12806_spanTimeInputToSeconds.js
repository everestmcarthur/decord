...
import regExp from "regExp" /* 12813 */;
import dateTimestampInSeconds from "dateTimestampInSeconds" /* 12815 */;
import _mod12816 from "module_12816" /* 12816 */;
import getMetricSummaryJsonForSpan from "getMetricSummaryJsonForSpan" /* 12817 */;
import getSpanStatusFromHttpCode from "getSpanStatusFromHttpCode" /* 12818 */;
import getMainCarrier from "getMainCarrier" /* 12819 */;
import getAsyncContextStrategy from "getAsyncContextStrategy" /* 12820 */;
  ...
  if ((function spanIsSentrySpan(getSpanJSON) {
    ...
    try {
      ...
      if ((function spanIsOpenTelemetrySdkTraceBaseSpan(attributes) {
        ...
        obj[8] = attributes[_mod12816.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[_mod12816.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
