...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      obj1 = ScopeClass(12811);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(12811);
      ...
      let tmp3Result = tmp3(12823);
      tmp3Result = tmp3(12823);
  ...
  },
  {
    ...
    value: function clear() {
      ...
      obj[0] = ScopeClass(12811).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(12815).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: tmp, eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(12823)._getSpanForScope(self) };
      return obj;
    }
  },
  {
