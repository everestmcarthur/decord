...
// Dependencies: [12828, 12849, 12874]

// Module 12909 (getCurrentHubShim)
import getClient from "getClient" /* 12828 */;
import _flush from "_flush" /* 12849 */;
import addBreadcrumb from "addBreadcrumb" /* 12874 */;
...
function getCurrentHubShim() {
  return {
    bindClient(arg0) {
      const currentScope = callback(12828).getCurrentScope();
      currentScope.setClient(arg0);
    },
    withScope: getClient.withScope,
    getClient() {
      return callback(12828).getClient();
    },
    ...
    getIntegration(id) {
      const client = callback(12828).getClient();
