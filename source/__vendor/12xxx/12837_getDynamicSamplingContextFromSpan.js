...
// Module 12837 (getDynamicSamplingContextFromSpan)
import addNonEnumerableProperty from "addNonEnumerableProperty" /* 12807 */;
import baggageHeaderToDynamicSamplingContext from "baggageHeaderToDynamicSamplingContext" /* 12814 */;
  ...
  if (client) {
    ...
    if (rootSpan[_frozenDsc]) {
      ...
      if (result) {
        ...
        const dropUndefinedKeysResult = tmp(12807).dropUndefinedKeys(obj);
        client.emit("createDsc", dropUndefinedKeysResult);
        const tmpResult1 = tmp(12807);
