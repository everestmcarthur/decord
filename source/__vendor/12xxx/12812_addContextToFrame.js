...
// Module 12812 (addContextToFrame)
import addNonEnumerableProperty from "addNonEnumerableProperty" /* 12807 */;
import isMatchingPattern from "isMatchingPattern" /* 12810 */;
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.pre_context = substr.map((arg0) => callback(12810).snipLine(arg0, 0));
    const _Math5 = Math;
    ...
    lineno.post_context = substr1.map((arg0) => callback(12810).snipLine(arg0, 0));
