...
// Dependencies: [6965, 19, 21, 6984, 7015, 7019]
// Exports: ViewHolderCollection

// Module 7021 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 7019 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(6984).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7015).CompatView, { style: tmp19, children: null });
};
