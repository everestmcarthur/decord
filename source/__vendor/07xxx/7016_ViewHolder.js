...
// Function ID: 7017
// Name: ViewHolder
// Dependencies: [19, 21, 6979, 7012]

// Module 7016 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_6979").getInvertedTransformStyle(horizontal);
    let obj = require("module_6979");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
