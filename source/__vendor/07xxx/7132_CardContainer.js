...
// Function ID: 7133
// Name: CardContainer
// Dependencies: [19, 17, 21, 1485, 5717, 7133, 7134, 7135, 7122]

// Module 7132 (CardContainer)
import Link from "Link" /* 1485 */;
import _mod5717 from "module_5717" /* 5717 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7122 */;
import _mod7133 from "module_7133" /* 7133 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7134 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5717.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7133.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7133;
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5717).getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = tmp2(5717);
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5717.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5717.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5717.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7135.Card, obj5);
