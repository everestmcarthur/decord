...
// Function ID: 7075
// Name: CardContainer
// Dependencies: [19, 17, 21, 1484, 5681, 7075, 7076, 7077, 7064]

// Module 7074 (CardContainer)
import Link from "Link" /* 1484 */;
import _mod5681 from "module_5681" /* 5681 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7064 */;
import _mod7075 from "module_7075" /* 7075 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7076 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5681.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7075.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7075;
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5681).getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = tmp2(5681);
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5681.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5681.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5681.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7077.Card, obj5);
