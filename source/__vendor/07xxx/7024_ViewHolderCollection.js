...
// Dependencies: [6968, 19, 21, 6987, 7018, 7022]
// Exports: ViewHolderCollection

// Module 7024 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 7022 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(6987).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7018).CompatView, { style: tmp19, children: null });
};
