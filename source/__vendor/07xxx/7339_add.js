...
function exp(constructor1, arg1) {
  ...
  if (16 < tmp3) {
    ...
    do {
      ...
      let plusResult = obj5.plus(f111655(timesResult1, timesResult2, sum));
    ...
    if (s.eq(10)) {
      ...
      if (Math.abs(tmp10) < 1500000000000000) {
        if (charAtResult >= 7) {
          ...
          const tmp36 = f111655(constructor3.minus(Decimal), constructor3.plus(Decimal), sum);
          times = tmp36.times;
...
const fn4 = function(arg0) {
  const constructor = new this.constructor(arg0);
  return f111655(this, constructor);
};
obj2.div = fn4;
obj2.dividedBy = fn4;
const fn5 = function(arg0) {
  ...
  const tmp2 = f111655(this, constructor1, 0, 1);
...
const fn14 = function(arg0) {
  ...
  if (self.s < 1) {
    ...
    if (self.eq(Decimal)) {
      ...
      constructor3 = f111655(ln(self, sum), ln(constructor1, sum), sum);
      c2 = true;
...
const fn16 = function(arg0) {
  ...
  if (constructor1.s) {
    if (self.s) {
      c2 = true;
      let minusResult = self.minus(f111655(self, tmp2, 0, 1).times(constructor1));
      const obj = f111655(self, tmp2, 0, 1);
    } else {
