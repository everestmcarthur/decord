...
function exp(constructor1, arg1) {
  ...
  if (16 < tmp3) {
    ...
    do {
      ...
      let plusResult = obj5.plus(f111573(timesResult1, timesResult2, sum));
    ...
    if (s.eq(10)) {
      ...
      if (Math.abs(tmp10) < 1500000000000000) {
        if (charAtResult >= 7) {
          ...
          if (tmp16 > num) {
            let constructor3 = new constructor("0." + times);
            const sum1 = num8 + num;
          } else {
            const text = `${tmp16}.`;
            constructor3 = new constructor(`${tmp16}.` + times.slice(num));
          }
          const tmp36 = f111573(constructor3.minus(Decimal), constructor3.plus(Decimal), sum);
          times = tmp36.times;
          round(times(tmp36), sum);
          num = 3;
          num8 = 2;
          const minusResult = constructor3.minus(Decimal);
        } else {
          obj = s;
          tmp13 = num;
        }
        ...
        if (sum3 > LN102.sd()) {
          ...
          const constructor4 = new constructor(constructor.LN10);
          round(constructor4, sum3);
          const text1 = `${tmp7}.`;
          const constructor5 = new constructor(`${tmp7}.` + str.slice(num));
          const timesResult1 = constructor4.times("" + tmp10);
          const tmp56 = round;
          const plusResult = ln(constructor5, sum - 10).plus(timesResult1);
          constructor.precision = precision;
          if (tmp4) {
            c2 = true;
...
obj2.dp = fn3;
obj2.decimalPlaces = fn3;
const fn4 = function(arg0) {
  const constructor = new this.constructor(arg0);
  return f111573(this, constructor);
};
obj2.div = fn4;
obj2.dividedBy = fn4;
const fn5 = function(arg0) {
  ...
  const tmp2 = f111573(this, constructor1, 0, 1);
  round(tmp2, constructor.precision);
  return tmp2;
};
obj2.idiv = fn5;
obj2.dividedToIntegerBy = fn5;
const fn6 = function(arg0) {
  return !this.cmp(arg0);
};
obj2.eq = fn6;
obj2.equals = fn6;
obj2.exponent = function() {
  let result = 7 * this.e;
  let first = this.d[0];
  let tmp3 = result;
  if (first >= 10) {
...
obj2.gt = fn7;
obj2.greaterThan = fn7;
const fn8 = function(arg0) {
  return this.cmp(arg0) >= 0;
};
obj2.gte = fn8;
obj2.greaterThanOrEqualTo = fn8;
const fn9 = function() {
...
obj2.isneg = fn10;
obj2.isNegative = fn10;
const fn11 = function() {
  return this.s > 0;
};
obj2.ispos = fn11;
obj2.isPositive = fn11;
...
const fn14 = function(arg0) {
  ...
  if (self.s < 1) {
    ...
    if (self.eq(Decimal)) {
      let constructor3 = new constructor(0);
    } else {
      constructor3 = f111573(ln(self, sum), ln(constructor1, sum), sum);
      c2 = true;
...
const fn16 = function(arg0) {
  ...
  if (constructor1.s) {
    if (self.s) {
      c2 = true;
      let minusResult = self.minus(f111573(self, tmp2, 0, 1).times(constructor1));
      const obj = f111573(self, tmp2, 0, 1);
    } else {
      const constructor2 = new constructor(self);
      minusResult = constructor2;
      round(constructor2, constructor.precision);
    }
    return minusResult;
  } else {
    const _Error = Error;
...
obj2.exp = fn17;
obj2.naturalExponential = fn17;
const fn18 = function() {
  return ln(this);
};
obj2.ln = fn18;
obj2.naturalLogarithm = fn18;
const fn19 = function() {
  const constructor = new this.constructor(this);
...
const fn22 = function() {
  ...
  if (this.s < 1) {
    ...
    const constructor3 = new constructor(text1);
    const tmp10 = floor((num + 1) / 2);
  }
};
obj2.sqrt = fn22;
obj2.squareRoot = fn22;
    ...
    if (arg0 === ~~arg0) {
      if (arg0 >= 0) {
        if (arg0 <= 1000000000) {
          ...
          round(constructor1, arg0 + tmp7 + 1, rounding);
        }
      }
    }
    const _Error2 = Error;
...
obj2.todp = fn24;
obj2.toDecimalPlaces = fn24;
obj2.toExponential = function(arg0, arg1) {
  const self = this;
  const constructor = this.constructor;
  if (undefined === arg0) {
    ...
    if (arg0 === ~~arg0) {
      if (arg0 >= 0) {
        if (arg0 <= 1000000000) {
          ...
          tmp12 = toString(constructor1, true, arg0 + 1);
        }
      }
    }
    const _Error2 = Error;
...
obj2.toFixed = function(arg0, arg1) {
  const self = this;
  const constructor = this.constructor;
  if (undefined === arg0) {
    ...
    if (arg0 === ~~arg0) {
      if (arg0 >= 0) {
        if (arg0 <= 1000000000) {
          ...
          round(constructor1, arg0 + tmp10 + 1, rounding);
          let result1 = 7 * constructor1.e;
          let first1 = constructor1.d[0];
          let tmp16 = result1;
          if (first1 >= 10) {
          ...
          const tmp3Result = toString(constructor1.abs(), false, arg0 + tmp16 + 1);
          text = tmp3Result;
          if (self.isneg()) {
            text = tmp3Result;
            if (!self.isZero()) {
...
const fn25 = function() {
  ...
  round(constructor1, tmp5 + 1, constructor.rounding);
  return constructor1;
};
obj2.toint = fn25;
obj2.toInteger = fn25;
...
const fn26 = function(arg0) {
  ...
  if (constructor1.s) {
    const constructor2 = new constructor(self);
    if (constructor2.s) {
      if (constructor2.eq(Decimal)) {
        return constructor2;
      } else {
        const precision = constructor.precision;
        if (constructor1.eq(tmp12)) {
          round(constructor2, precision);
          return constructor2;
        } else {
          ...
          if (e >= diff) {
            ...
            if (tmp15 <= 9007199254740991) {
              const constructor3 = new constructor(tmp12);
              const _Math2 = Math;
              const rounded = Math.ceil(precision / 7 + 4);
              c2 = false;
              let tmp26 = constructor3;
              if (tmp15 % 2) {
              ...
              if (constructor1.s < 0) {
                ...
                let divResult = constructor4.div(tmp30);
              } else {
          ...
          constructor2.s = 1;
          c2 = true;
          const tmp19 = exp(constructor1.times(ln(constructor2, precision + 12)));
          tmp19.s = num5;
          return tmp19;
        }
      }
    ...
    const constructor5 = new constructor(Decimal);
    return constructor5;
  }
};
obj2.pow = fn26;
obj2.toPower = fn26;
obj2.toPrecision = function(arg0, arg1) {
  const self = this;
  const constructor = this.constructor;
  if (undefined === arg0) {
    let result = 7 * self.e;
    ...
    if (arg0 === ~~arg0) {
      if (arg0 >= 1) {
        if (arg0 <= 1000000000) {
          ...
          tmp3Result = toString(constructor1, arg0 <= tmp13 || tmp13 <= constructor.toExpNeg, arg0);
      ...
      if (precision < 0) {
        ...
        if (1 == length) {
          ...
          if (1 < (c9 / (d1[0] + 1) | 0)) {
            ...
            if (+d1.length) {
              do {
                let sum4 = substr[diff3] * tmp124 + num11;
            ...
            if (+d.length) {
              do {
                let sum5 = substr1[diff4] * tmp124 + num13;
            ...
            if (num19 < 0) {
                ...
                if (1 === num29) {
                  ...
                  if (tmp69) {
                    do {
                      ...
                      let num33 = 0;
                      if (substr4[diff6] < tmp68[diff6]) {
                        num33 = 1;
                      }
                      substr4[diff6] = num33 * c9 + substr4[diff6] - tmp68[diff6];
                      tmp73 = +diff6;
                      diff6 = tmp73 - 1;
                      num32 = num33;
                    } while (tmp73);
              ...
              if (tmp77) {
                do {
                  ...
                  arr9[diff8] = num29 * c9 + arr9[diff8] - substr5[diff8];
                  tmp81 = +diff8;
                  diff8 = tmp81 - 1;
                  num34 = num29;
                } while (tmp81);
              ...
              if (-1 === num19) {
                ...
                if (tmp83) {
                  ...
                  if (tmp91) {
                    do {
                      arr9[diff9] = arr9[diff9] - num29;
                      let num37 = 0;
                      if (arr9[diff9] < tmp90[diff9]) {
                        num37 = 1;
                      }
                      arr9[diff9] = num37 * c9 + arr9[diff9] - tmp90[diff9];
                      tmp95 = +diff9;
                      diff9 = tmp95 - 1;
                      num29 = num37;
                    } while (tmp95);
        ...
        if (arg3) {
          ...
          sum15 = tmp15 + tmp116 + 1;
        }
        round(constructor1, sum15);
        return constructor1;
      }
    } else {
      const _Error = Error;
    ...
    constructor(arg0) {
      ...
      if (this instanceof Decimal) {
        ...
        if (arg0 instanceof tmp) {
          ...
          if (re8.test(substr1)) {
            tmp8 = parseDecimal;
            tmp9 = parseDecimal(self, substr1);
            return;
          } else {
            tmp6 = globalThis;
            _Error = Error;
            tmp7 = c4;
            throw Error(c4 + substr1);
          }
        }
      } else {
        tmpResult = tmp(arg0);
  ...
  constructor(arg0) {
    ...
    if (this instanceof Decimal) {
      ...
      if (global instanceof tmp) {
        ...
        _Error2 = Error;
        tmp11 = c4;
        throw Error(c4 + global);
      } else {
        num8 = 0;
        num9 = 45;
        if (45 === global.charCodeAt(0)) {
          num2 = 1;
          substr1 = global.slice(1);
          num3 = -1;
          self.s = -1;
        } else {
          num = 1;
