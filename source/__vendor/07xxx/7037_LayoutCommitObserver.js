...
// Dependencies: [6968, 19, 21, 6987, 6986]

// Module 7037 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod6986.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod6986.useLayoutState(0), 2);
  ...
  return jsx(_mod6987.RecyclerViewContextProvider, { value, children: children.children });
});
