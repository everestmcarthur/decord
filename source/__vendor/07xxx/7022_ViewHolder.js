...
// Function ID: 7023
// Name: ViewHolder
// Dependencies: [19, 21, 6985, 7018]

// Module 7022 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_6985").getInvertedTransformStyle(horizontal);
    let obj = require("module_6985");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
