...
// Dependencies: [7059, 7060, 7064, 7065]

// Module 7058 (RenderTimeTracker)
...
const entry = {
  ...
  value: function startTracking() {
    ...
    let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(7065).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
...
const items = [
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(7065).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
...
export const RenderTimeTracker = _modDef7060(RenderTimeTracker, items);
