...
// Function ID: 7096
// Name: CardContainer
// Dependencies: [19, 17, 21, 1484, 5682, 7096, 7097, 7098, 7085]

// Module 7095 (CardContainer)
import Link from "Link" /* 1484 */;
import _mod5682 from "module_5682" /* 5682 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7085 */;
import _mod7096 from "module_7096" /* 7096 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7097 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5682.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7096.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7096;
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5682).getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = tmp2(5682);
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5682.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5682.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5682.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7098.Card, obj5);
