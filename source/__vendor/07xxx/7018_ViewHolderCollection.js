...
// Dependencies: [6962, 19, 21, 6981, 7012, 7016]
// Exports: ViewHolderCollection

// Module 7018 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 7016 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(6981).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7012).CompatView, { style: tmp19, children: null });
};
