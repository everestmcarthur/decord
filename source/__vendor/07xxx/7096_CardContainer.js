...
// Function ID: 7097
// Name: CardContainer
// Dependencies: [19, 17, 21, 1484, 5683, 7097, 7098, 7099, 7086]

// Module 7096 (CardContainer)
import Link from "Link" /* 1484 */;
import _mod5683 from "module_5683" /* 5683 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7086 */;
import _mod7097 from "module_7097" /* 7097 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7098 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5683.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7097.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7097;
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5683).getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = tmp2(5683);
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5683.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5683.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5683.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7099.Card, obj5);
