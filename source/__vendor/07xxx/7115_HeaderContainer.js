...
// Dependencies: [19, 17, 21, 5716, 1485, 7116, 7117]
// Exports: HeaderContainer

// Module 7115 (HeaderContainer)
...
export const HeaderContainer = function HeaderContainer(getFocusedRoute) {
  ...
  closure_6 = noop.useContext(_mod5716.HeaderBackContext);
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = { title: require("module_5716").getHeaderTitle(tmp11, route.name), href: buildHref(route.name, route.params) };
                tmp9 = obj2;
                const obj3 = require("module_5716");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7116").forSlideRight;
                    } else {
                      forSlideUp = require("module_7116").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7116").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7116").forNoAnimation;
            }
