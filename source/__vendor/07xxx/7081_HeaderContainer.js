...
// Dependencies: [19, 17, 21, 5682, 1484, 7082, 7083]
// Exports: HeaderContainer

// Module 7081 (HeaderContainer)
...
export const HeaderContainer = function HeaderContainer(getFocusedRoute) {
  ...
  closure_6 = noop.useContext(_mod5682.HeaderBackContext);
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = { title: require("module_5682").getHeaderTitle(tmp11, route.name), href: buildHref(route.name, route.params) };
                tmp9 = obj2;
                const obj3 = require("module_5682");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7082").forSlideRight;
                    } else {
                      forSlideUp = require("module_7082").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7082").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7082").forNoAnimation;
            }
