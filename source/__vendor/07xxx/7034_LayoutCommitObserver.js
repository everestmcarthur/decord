...
// Dependencies: [6965, 19, 21, 6984, 6983]

// Module 7034 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod6983.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod6983.useLayoutState(0), 2);
  ...
  return jsx(_mod6984.RecyclerViewContextProvider, { value, children: children.children });
});
