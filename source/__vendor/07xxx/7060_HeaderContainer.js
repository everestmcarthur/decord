...
// Dependencies: [19, 17, 21, 5681, 1484, 7061, 7062]
// Exports: HeaderContainer

// Module 7060 (HeaderContainer)
...
export const HeaderContainer = function HeaderContainer(getFocusedRoute) {
  ...
  closure_6 = noop.useContext(_mod5681.HeaderBackContext);
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = { title: require("module_5681").getHeaderTitle(tmp11, route.name), href: buildHref(route.name, route.params) };
                tmp9 = obj2;
                const obj3 = require("module_5681");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7061").forSlideRight;
                    } else {
                      forSlideUp = require("module_7061").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7061").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7061").forNoAnimation;
            }
