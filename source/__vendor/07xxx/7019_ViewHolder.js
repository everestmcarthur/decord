...
// Function ID: 7020
// Name: ViewHolder
// Dependencies: [19, 21, 6982, 7015]

// Module 7019 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_6982").getInvertedTransformStyle(horizontal);
    let obj = require("module_6982");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
