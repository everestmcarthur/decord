...
// Dependencies: [109, 41, 42, 9066, 9067]

// Module 9068 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(9066).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(9066).extractDefs(self.ctx, _idmap);
      return _objectWithoutProperties(JSONSchemaGenerator(9066).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
