...
// Function ID: 9383
// Name: pbkdf2Init
// Dependencies: [5, 9380, 9379, 9383]
// Exports: pbkdf2, pbkdf2Async

// Module 9382 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9379).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9383).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9379).toBytes(B);
