...
// Dependencies: [109, 41, 42, 9002, 9003]

// Module 9004 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(9002).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(9002).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(9002).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
