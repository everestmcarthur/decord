...
// Function ID: 9277
// Name: pbkdf2Init
// Dependencies: [5, 9274, 9273, 9277]
// Exports: pbkdf2, pbkdf2Async

// Module 9276 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9273).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9277).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9273).toBytes(B);
