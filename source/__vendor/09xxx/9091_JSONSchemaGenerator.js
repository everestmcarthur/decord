...
// Dependencies: [109, 41, 42, 9089, 9090]

// Module 9091 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(9089).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(9089).extractDefs(self.ctx, _idmap);
      return _objectWithoutProperties(JSONSchemaGenerator(9089).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
