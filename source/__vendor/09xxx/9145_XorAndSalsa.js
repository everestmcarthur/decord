...
// Function ID: 9146
// Name: XorAndSalsa
// Dependencies: [5, 9146, 9147, 9149, 9151]
// Exports: scrypt, scryptAsync

// Module 9145 (XorAndSalsa)
import _asyncLoop from "_asyncLoop" /* 9146 */;
import pbkdf2Init from "pbkdf2Init" /* 9149 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 9151 */;
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9146).isLE) {
                callback(9146).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
