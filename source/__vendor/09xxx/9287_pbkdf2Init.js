...
// Function ID: 9288
// Name: pbkdf2Init
// Dependencies: [5, 9285, 9284, 9288]
// Exports: pbkdf2, pbkdf2Async

// Module 9287 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9284).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9288).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9284).toBytes(B);
