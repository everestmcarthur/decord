...
// Function ID: 9237
// Name: pbkdf2Init
// Dependencies: [5, 9234, 9233, 9237]
// Exports: pbkdf2, pbkdf2Async

// Module 9236 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9233).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9237).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9233).toBytes(B);
