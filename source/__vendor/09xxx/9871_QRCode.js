...
// Function ID: 9872
// Name: QRCode
// Dependencies: [9872, 9874, 9876, 9877, 9878]

// Module 9871 (QRCode)
import QR8bitByte from "QR8bitByte" /* 9872 */;
import QRRSBlock from "QRRSBlock" /* 9874 */;
import QRBitBuffer from "QRBitBuffer" /* 9876 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9877.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9877.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9877.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
