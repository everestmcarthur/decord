...
// Dependencies: [109, 41, 42, 9129, 9130]

// Module 9131 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(9129).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(9129).extractDefs(self.ctx, _idmap);
      return _objectWithoutProperties(JSONSchemaGenerator(9129).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
