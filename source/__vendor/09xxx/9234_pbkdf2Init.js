...
// Function ID: 9235
// Name: pbkdf2Init
// Dependencies: [5, 9232, 9231, 9235]
// Exports: pbkdf2, pbkdf2Async

// Module 9234 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9231).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9235).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9231).toBytes(B);
