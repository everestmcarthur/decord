...
// Function ID: 9214
// Name: pbkdf2Init
// Dependencies: [5, 9211, 9210, 9214]
// Exports: pbkdf2, pbkdf2Async

// Module 9213 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9210).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9214).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9210).toBytes(B);
