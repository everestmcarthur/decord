...
// Function ID: 9299
// Name: pbkdf2Init
// Dependencies: [5, 9296, 9295, 9299]
// Exports: pbkdf2, pbkdf2Async

// Module 9298 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9295).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9299).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9295).toBytes(B);
