...
// Function ID: 9998
// Name: QRCode
// Dependencies: [9998, 10002, 10007, 19, 10010]

// Module 9997 (QRCode)
import QRCode_mod from "module_9998" /* 9998 */;
import module_10002_mod from "module_10002" /* 10002 */;
import emptyFunction from "module_10007" /* 10007 */;
import noop_mod from "module_19" /* 19 */;
import QRCodeSvg_mod from "QRCodeSvg" /* 10010 */;
...
QRCode = tmp3;
let module_10002 = module_10002_mod;
if (!module_10002) {
  let obj2 = { default: module_10002 };
  let tmp5 = obj2;
} else {
  tmp5 = module_10002;
}
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const _default1 = new QRCode.default(-1, module_10002.default[level]);
