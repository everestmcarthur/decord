...
// Function ID: 5699
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1484, 5690, 5699, 5700]
// Exports: Button

// Module 5698 (ButtonLink)
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5690)(color);
      str4 = tmp9(5690)(color).darken(0.71).string();
      const darkenResult = tmp9(5690)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5699.PlatformPressable, {});
}
