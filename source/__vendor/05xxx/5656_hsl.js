...
const obj = {};
const module_5657 = Object.keys(_mod5657);
for (const item10016 of keys) {
  obj[require("module_5657")[item10016]] = item10016;
  continue;
}
...
obj2.rgb.keyword = (arg0) => {
  ...
  if (obj[arg0]) {
    ...
    const keys = Object.keys(_mod5657);
    const iter = keys[Symbol.iterator]();
    const nextResult = iter.next();
    while (iter !== undefined) {
      let tmp14 = _mod5657[nextResult];
...
obj2.keyword.rgb = (arg0) => _mod5657[arg0];
obj2.rgb.xyz = (arg0) => {
  const result = arg0[0] / 255;
  const result1 = arg0[1] / 255;
  const result2 = arg0[2] / 255;
