...
// Function ID: 5023
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5023, 5015]
// Exports: default

// Module 5022 (SearchBar)
import _modDef5023 from "module_5023" /* 5023 */;
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5023).Commands;
  ...
  if (ref1(5015).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5015).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5015);
    obj.hideNavigationBar = tmp3(5015).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
