...
// Function ID: 5737
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1485, 5728, 5737, 5738]
// Exports: Button

// Module 5736 (ButtonLink)
import Link from "Link" /* 1485 */;
import ColorDefault from "Color" /* 5728 */;
import _mod5737 from "module_5737" /* 5737 */;
import Text from "Text" /* 5738 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5728)(color);
      str4 = tmp9(5728)(color).darken(0.71).string();
      const darkenResult = tmp9(5728)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5737.PlatformPressable, {});
}
