...
// Function ID: 5700
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1484, 5691, 5700, 5701]
// Exports: Button

// Module 5699 (ButtonLink)
import Link from "Link" /* 1484 */;
import ColorDefault from "Color" /* 5691 */;
import _mod5700 from "module_5700" /* 5700 */;
import Text from "Text" /* 5701 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5691)(color);
      str4 = tmp9(5691)(color).darken(0.71).string();
      const darkenResult = tmp9(5691)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5700.PlatformPressable, {});
}
