...
const obj = { extension: "7z", mimeType: "application/x-7z-compressed", description: "7-Zip compressed file", signatures: null };
const items = [{ sequence: [55, 122, 188, 175, 39, 28] }];
obj.signatures = items;
_moduleResult._7Z = obj;
const obj2 = { extension: "lzh", mimeType: "application/x-lzh-compressed", description: "Compressed file using Lempel-Ziv and Haruyasu (LZH) compression algorithm", signatures: null };
...
const obj3 = { extension: "rar", mimeType: "application/x-rar-compressed", description: "Roshal ARchive compressed archive file", signatures: null };
...
const obj4 = { extension: "zip", mimeType: "application/zip", description: "Compressed archive file", signatures: null };
