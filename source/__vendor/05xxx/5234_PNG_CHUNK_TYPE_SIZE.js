...
// Dependencies: [5227, 5230]

// Module 5234 (PNG_CHUNK_TYPE_SIZE)
...
export default {
  isPngFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = _mod5227.getStringFromDataView(dataView, 0, u0089PNGrnu001An.length) === u0089PNGrnu001An;
    }
    return tmp;
  },
