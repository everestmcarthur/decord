...
// Function ID: 5026
// Name: ScreenStack
// Dependencies: [109, 19, 21, 5026, 5027, 5028]
// Exports: default

// Module 5025 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_mod5027.GHContext);
  ...
  _modDef5026("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5026(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod5027.RNSScreensRefContext.Provider, { value: ref, children: null });
};
