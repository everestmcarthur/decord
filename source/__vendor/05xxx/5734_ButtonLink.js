...
// Function ID: 5735
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1485, 5726, 5735, 5736]
// Exports: Button

// Module 5734 (ButtonLink)
import Link from "Link" /* 1485 */;
import ColorDefault from "Color" /* 5726 */;
import _mod5735 from "module_5735" /* 5735 */;
import Text from "Text" /* 5736 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5726)(color);
      str4 = tmp9(5726)(color).darken(0.71).string();
      const darkenResult = tmp9(5726)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5735.PlatformPressable, {});
}
