...
// Function ID: 5701
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1484, 5692, 5701, 5702]
// Exports: Button

// Module 5700 (ButtonLink)
import Link from "Link" /* 1484 */;
import ColorDefault from "Color" /* 5692 */;
import _mod5701 from "module_5701" /* 5701 */;
import Text from "Text" /* 5702 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5692)(color);
      str4 = tmp9(5692)(color).darken(0.71).string();
      const darkenResult = tmp9(5692)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5701.PlatformPressable, {});
}
