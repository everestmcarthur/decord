...
obj[282] = { name: "XResolution", description: fn(5250).XResolution };
const obj2 = { name: "XResolution", description: fn(5250).XResolution };
obj[283] = { name: "YResolution", description: fn(5250).YResolution };
obj[286] = {
  name: "XPosition",
  description(arg0) {
...
const obj3 = { name: "YResolution", description: fn(5250).YResolution };
obj[296] = { name: "ResolutionUnit", description: fn(5250).ResolutionUnit };
obj[318] = {
  name: "WhitePoint",
  description(arr) {
...
const obj4 = { name: "ResolutionUnit", description: fn(5250).ResolutionUnit };
obj[50778] = { name: "CalibrationIlluminant1", description: fn(5250).LightSource };
const obj5 = { name: "CalibrationIlluminant1", description: fn(5250).LightSource };
obj[50779] = { name: "CalibrationIlluminant2", description: fn(5250).LightSource };
obj[50941] = {
