...
// Function ID: 5106
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5106, 5098]
// Exports: default

// Module 5105 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5106).Commands;
  ...
  if (ref1(5098).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5098).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5098);
    obj.hideNavigationBar = tmp3(5098).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
