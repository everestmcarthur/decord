...
// Module 5352 (FOCAL_PLANE_RESOLUTION_UNIT)
                          ...
                          if (exif.file) {
                            ...
                            if (arg1) {
                              if (exif.exif) {
                                ...
                                let flag = false;
                                if (value7) {
                                  const obj2 = { value: value7, description: require("module_5324").FocalLengthIn35mmFilm(value7) };
                                  obj.FocalLength35efl = obj2;
                                  flag = true;
                                  const obj3 = require("module_5324");
                                }
