...
// Function ID: 5819
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1485, 5810, 5819, 5820]
// Exports: Button

// Module 5818 (ButtonLink)
import Link from "Link" /* 1485 */;
import ColorDefault from "Color" /* 5810 */;
import _mod5819 from "module_5819" /* 5819 */;
import Text from "Text" /* 5820 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5810)(color);
      str4 = tmp9(5810)(color).darken(0.71).string();
      const darkenResult = tmp9(5810)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5819.PlatformPressable, {});
}
