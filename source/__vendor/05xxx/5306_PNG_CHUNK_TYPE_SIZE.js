...
// Dependencies: [5299, 5302]

// Module 5306 (PNG_CHUNK_TYPE_SIZE)
...
export default {
  isPngFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = _mod5299.getStringFromDataView(dataView, 0, u0089PNGrnu001An.length) === u0089PNGrnu001An;
    }
    return tmp;
  },
