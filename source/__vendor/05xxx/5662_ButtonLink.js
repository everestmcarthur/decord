...
// Function ID: 5663
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1484, 5654, 5663, 5664]
// Exports: Button

// Module 5662 (ButtonLink)
import Link from "Link" /* 1484 */;
import ColorDefault from "Color" /* 5654 */;
import _mod5663 from "module_5663" /* 5663 */;
import Text from "Text" /* 5664 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5654)(color);
      str4 = tmp9(5654)(color).darken(0.71).string();
      const darkenResult = tmp9(5654)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5663.PlatformPressable, {});
}
