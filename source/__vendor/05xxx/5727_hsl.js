...
// Function ID: 5728
// Name: hsl
// Dependencies: [32, 5728]

// Module 5727 (hsl)
import _mod5728 from "module_5728" /* 5728 */;
import _slicedToArray from "module_32" /* 32 */;

const require = globalThis.__r;

const obj = {};
const module_5728 = Object.keys(_mod5728);
for (const item10016 of keys) {
  obj[require("module_5728")[item10016]] = item10016;
  continue;
}
...
obj2.rgb.keyword = (arg0) => {
  ...
  if (obj[arg0]) {
    ...
    const keys = Object.keys(_mod5728);
    const iter = keys[Symbol.iterator]();
    const nextResult = iter.next();
    while (iter !== undefined) {
      let tmp14 = _mod5728[nextResult];
...
obj2.keyword.rgb = (arg0) => _mod5728[arg0];
obj2.rgb.xyz = (arg0) => {
  const result = arg0[0] / 255;
  const result1 = arg0[1] / 255;
  const result2 = arg0[2] / 255;
