...
// Dependencies: [5265, 5268]

// Module 5272 (PNG_CHUNK_TYPE_SIZE)
...
export default {
  isPngFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = _mod5265.getStringFromDataView(dataView, 0, u0089PNGrnu001An.length) === u0089PNGrnu001An;
    }
    return tmp;
  },
