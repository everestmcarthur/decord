...
// Function ID: 5022
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5022, 5014]
// Exports: default

// Module 5021 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5022).Commands;
  ...
  if (ref1(5014).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5014).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5014);
    obj.hideNavigationBar = tmp3(5014).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
