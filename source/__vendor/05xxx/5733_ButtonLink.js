...
// Function ID: 5734
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1485, 5725, 5734, 5735]
// Exports: Button

// Module 5733 (ButtonLink)
import Link from "Link" /* 1485 */;
import ColorDefault from "Color" /* 5725 */;
import _mod5734 from "module_5734" /* 5734 */;
import Text from "Text" /* 5735 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5725)(color);
      str4 = tmp9(5725)(color).darken(0.71).string();
      const darkenResult = tmp9(5725)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5734.PlatformPressable, {});
}
