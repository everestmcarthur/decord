...
// Function ID: 5028
// Name: ScreenStack
// Dependencies: [109, 19, 21, 5028, 5029, 5030]
// Exports: default

// Module 5027 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_mod5029.GHContext);
  ...
  _modDef5028("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5028(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod5029.RNSScreensRefContext.Provider, { value: ref, children: null });
};
