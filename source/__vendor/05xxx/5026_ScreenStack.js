...
// Function ID: 5027
// Name: ScreenStack
// Dependencies: [109, 19, 21, 5027, 5028, 5029]
// Exports: default

// Module 5026 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_mod5028.GHContext);
  ...
  _modDef5027("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5027(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod5028.RNSScreensRefContext.Provider, { value: ref, children: null });
};
