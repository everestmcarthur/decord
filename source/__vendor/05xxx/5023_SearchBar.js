...
// Function ID: 5024
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5024, 5016]
// Exports: default

// Module 5023 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5024).Commands;
  ...
  if (ref1(5016).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5016).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5016);
    obj.hideNavigationBar = tmp3(5016).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
