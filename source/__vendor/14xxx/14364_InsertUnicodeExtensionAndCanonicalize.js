...
// Dependencies: [14357, 14365]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14364 (InsertUnicodeExtensionAndCanonicalize)
import _mod14357 from "module_14357" /* 14357 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14365 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14357.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
