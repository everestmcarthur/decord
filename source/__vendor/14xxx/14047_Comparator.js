...
// Function ID: 14048
// Name: Comparator
// Dependencies: [41, 42, 14020, 14022, 14023, 14019, 14045, 14048]

// Module 14047 (Comparator)
...
class Comparator {
  constructor(arg0, arg1) {
    ...
    parts = str2.split(/\s+/);
    joined = parts.join(" ");
    tmp6 = require("module_14022")("comparator", joined, tmp4);
    self.options = tmp4;
    ...
    tmp8 = require("module_14022")("comp", self);
    return;
  }
}
let obj = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(14023).safeRe;
    const t = Comparator(14023).t;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(14019)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
...
const items = [
  ...
  },
  {
    ...
    value: function test(arg0) {
      const self = this;
      let tmp = arg0;
      Comparator(14022)("Comparator.test", arg0, this.options.loose);
      if (this.semver !== closure_3) {
        if (tmp !== tmp5) {
          if (typeof tmp === "string") {
            try {
              tmp = new tmp2(14019)(tmp, self.options);
            } catch (err) {
              return false;
            }
          }
          return tmp2(14045)(tmp, self.operator, self.semver, self.options);
        }
      }
      return true;
    }
    ...
    value: function intersects(value) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(14048)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(14048)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(14020)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(14045)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(14045)(self.semver, ">", value.semver, tmp45);
