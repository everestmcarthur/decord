...
// Function ID: 14278
// Name: ToRawPrecision
// Dependencies: [1162, 14258, 14259, 14261, 14271]
// Exports: ToRawPrecision

// Module 14277 (ToRawPrecision)
import digitsToString2 from "digitsToString" /* 14258 */;
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  let tmp4;
  if (ZERO.isZero()) {
    let repeatResult = _mod14259.repeat("0", maximumSignificantDigits);
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(14259).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(14259).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(14259).repeat("0", -num3 - 1)}${arr}`;
