...
// Function ID: 14231
// Name: formatToParts
// Dependencies: [1162, 14208, 14231, 14226, 14232, 14228]
// Exports: default

// Module 14230 (formatToParts)
import digitsToString from "digitsToString" /* 14208 */;
import _mod14231 from "module_14231" /* 14231 */;
import e from "e" /* 1162 */;

let closure_2 = e.__importDefault(digitsToString);
const regExp = new RegExp("^".concat(_mod14231.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod14231.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(14226).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(14232).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(14228).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
