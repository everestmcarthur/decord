...
// Dependencies: [1162, 14258, 14280, 14259, 14273, 14275]
// Exports: PartitionNumberPattern

// Module 14285 (PartitionNumberPattern)
...
export const PartitionNumberPattern = function PartitionNumberPattern(internalSlots, isNaN) {
  ...
  return module_14280.default({ roundedNumber, formattedString, exponent: num, magnitude: num2, sign: num7 }, internalSlots.dataLocaleData, pl, internalSlots);
};
