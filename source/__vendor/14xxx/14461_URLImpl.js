...
// Function ID: 14462
// Name: URLImpl
// Dependencies: [41, 42, 14462, 14466, 14465]

// Module 14461 (URLImpl)
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(14462).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(14462).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(14465).parseUrlencoded(query);
          const tmpResult = tmp(14465);
        }
      }
      const obj = URLImpl(14462);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(14462).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
    ...
    set(arg0) {
      URLImpl(14462).basicURLParse(`${arg0}:`, { url: this._url, stateOverride: "scheme start" });
    }
  },
  {
    key: "username",
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14462).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(14462);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14462).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(14462);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(14462).serializeHost(host);
        const obj3 = URLImpl(14462);
      } else {
        const obj = URLImpl(14462);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(14462).serializeInteger(host.port)}`;
        const obj2 = URLImpl(14462);
      }
    },
    set(arg0) {
      if (!this._url.cannotBeABaseURL) {
        const obj2 = { url: tmp._url, stateOverride: "host" };
        URLImpl(14462).basicURLParse(arg0, obj2);
        const obj = URLImpl(14462);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(14462).serializeHost(tmp._url.host);
        const obj = URLImpl(14462);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(14462).serializeInteger(tmp._url.port);
        const obj = URLImpl(14462);
      }
      return str;
    },
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        URLImpl(14462).basicURLParse(substr, obj2);
        const obj = URLImpl(14462);
        self._query._list = URLImpl(14465).parseUrlencoded(substr);
      }
    }
  },
  {
