...
// Function ID: 14020
// Name: SemVer
// Dependencies: [41, 42, 14020, 14021, 14022, 14023, 14024]
...
class SemVer {
  constructor(arg0, arg1) {
    ...
    tmp2 = SemVer;
    tmp3 = closure_1;
    tmp4 = require("module_14020")(require);
    ...
    if (version.length > require("module_14021").MAX_LENGTH) {
      tmp28 = globalThis;
      ...
      tmp29 = new.target;
      tmp30 = new.target;
      typeError1 = new TypeError("version is longer than " + require("module_14021").MAX_LENGTH + " characters");
      tmp32 = typeError1;
      throw typeError1;
    } else {
      str13 = "SemVer";
      tmp38 = require("module_14022")("SemVer", version, tmp4);
      self.options = tmp4;
      ...
      if (match) {
        ...
        self.minor = +match[2];
        self.patch = +match[3];
        if (self.major <= require("module_14021").MAX_SAFE_INTEGER) {
          num = 0;
          if (self.major >= 0) {
            if (self.minor <= require("module_14021").MAX_SAFE_INTEGER) {
              if (self.minor >= 0) {
                if (self.patch <= require("module_14021").MAX_SAFE_INTEGER) {
                  if (self.patch >= 0) {
                    if (match[4]) {
                      str2 = match[4];
                      str3 = ".";
...
let items = [
  ...
  },
  {
    ...
    value: function compare(tmp2Result) {
      const self = this;
      SemVer(14022)("SemVer.compare", this.version, this.options, tmp2Result);
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      let compareIdentifiersResult = SemVer(14024).compareIdentifiers(self.major, tmpResult.major);
      if (!compareIdentifiersResult) {
        let tmp3Result = tmp3(14024);
        compareIdentifiersResult = tmp3Result.compareIdentifiers(self.minor, tmpResult.minor);
      }
      if (!compareIdentifiersResult) {
        tmp3Result = tmp3(14024);
  ...
  },
  {
    ...
    value: function comparePre(tmp2Result) {
      ...
      while (true) {
        ...
        let tmp8 = tmp3;
        let tmp9 = tmp4;
        let tmp10 = SemVer(14022)("prerelease compare", num3, tmp3, tmp4);
  ...
  },
  {
    ...
    value: function compareBuild(arg0) {
      ...
      while (true) {
        ...
        let tmp8 = tmp3;
        let tmp9 = tmp4;
        let tmp10 = SemVer(14022)("build compare", num, tmp3, tmp4);
        let tmp11 = undefined === tmp3;
        let tmp12 = num;
        if (tmp11) {
          if (undefined === tmp4) {
