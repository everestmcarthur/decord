...
// Module 14377 (parseIPv4Number)
import Buffer from "Buffer" /* 1253 */;
import error from "error" /* 14378 */;
      ...
      if (47 !== arg0) {
        ...
        if (undefined === closure_3[self.url.scheme]) {
          ...
          if (!tmp) {
            ...
            if (isASCIIHexResult) {
              tmp2Result = require("module_14379");
              num6 = 2;
    ...
    if (63 === arg0) {
      ...
      if (35 === arg0) {
        ...
        if (!tmp2) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmp3Result = require("module_14379");
            num4 = 2;
    ...
    if (!isNaN(arg0)) {
      ...
      if (0 === arg0) {
        ...
        if (!tmp4) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmpResult = require("module_14379");
            num3 = 2;
