...
// Function ID: 14243
// Name: ResolveLocale
// Dependencies: [14243, 14248, 14249, 14244, 14250, 14251]

// Module 14242 (ResolveLocale)
const require = arg1;
...
arg5.ResolveLocale = function ResolveLocale(arg0, arg1, localeMatcher) {
  ...
  if ("lookup" === localeMatcher.localeMatcher) {
    const _Array2 = Array;
    let LookupMatcherResult = str(14243).LookupMatcher(Array.from(arg0), arg1, arg5);
    let tmp5 = str;
    let tmp7 = str;
  } else {
    const _Array = Array;
    tmp5 = str;
    tmp7 = str;
    LookupMatcherResult = str(14248).BestFitMatcher(Array.from(arg0), arg1, arg5);
  }
  ...
  if (LookupMatcherResult.extension) {
    let keywords = tmp7(14249).UnicodeExtensionComponents(LookupMatcherResult.extension).keywords;
  } else {
    keywords = [];
  }
  const items = [];
  ...
  if (0 < arg3.length) {
    do {
      ...
      let invariantResult = str(14244).invariant(isArray, "keyLocaleData for ".concat(str, " must be an array"));
      let first = items1[0];
      ...
      let invariantResult1 = str(14244).invariant(tmp19, "value must be a string or undefined");
      ...
      let invariantResult2 = tmp14(14244).invariant(tmp24, "optionsValue must be a string or undefined");
      let str3 = tmp23;
      if (typeof tmp23 === "string") {
        let formatted = str.toLowerCase();
        str3 = tmp14(14250).CanonicalizeUValue(formatted, tmp23);
        if ("" === str3) {
          str3 = "true";
        }
      }
  ...
  let result = locale;
  if (items.length > 0) {
    result = tmp5(14251).InsertUnicodeExtensionAndCanonicalize(locale, [], items);
  }
  obj.locale = result;
  return obj;
};
