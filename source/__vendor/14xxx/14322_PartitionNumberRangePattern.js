...
// Dependencies: [14294, 14320, 14319, 14318, 14307]
// Exports: PartitionNumberRangePattern

// Module 14322 (PartitionNumberRangePattern)
...
export const PartitionNumberRangePattern = function PartitionNumberRangePattern(arg0, isNaN, isNaN2, getInternalSlots) {
  ...
  const result = tmp(14320).PartitionNumberPattern(internalSlots, isNaN);
  const result1 = tmp(14320).PartitionNumberPattern(internalSlots, isNaN2);
  if (FormatNumericResult === FormatNumeric.FormatNumeric(internalSlots, isNaN2)) {
    const FormatApproximatelyResult = tmp(14318).FormatApproximately(internalSlots, result);
    ...
    return tmp(14307).CollapseNumberRange(arg0, items, obj2);
  }
