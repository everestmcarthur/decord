...
// Dependencies: [109, 19, 17, 21, 1637, 5007, 1615, 14681, 14682]

// Module 14680 (ReanimatedNativeStackScreen)
...
const jsx = fn(21).jsx;
let closure_7 = cancelAnimation.createAnimatedComponent(fn(5007).InnerScreen);
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef14682.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef14681.Provider, { value: sharedValue, children: jsx(_modDef14682.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
