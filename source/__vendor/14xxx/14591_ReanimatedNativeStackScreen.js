...
// Dependencies: [109, 19, 17, 21, 1636, 4930, 1614, 14592, 14593]

// Module 14591 (ReanimatedNativeStackScreen)
...
const jsx = fn(21).jsx;
let closure_7 = cancelAnimation.createAnimatedComponent(fn(4930).InnerScreen);
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const safeAreaFrame = _mod1614.useSafeAreaFrame();
  let y = _mod1614.useSafeAreaInsets().top;
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef14593.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef14592.Provider, { value: sharedValue, children: jsx(_modDef14593.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
