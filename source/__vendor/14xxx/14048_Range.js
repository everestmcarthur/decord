...
class Range {
  constructor(arg0, arg1) {
    ...
    self = this;
    tmp = self;
    tmp2 = closure_2(this, self);
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_14020")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (value) {
        ...
        let str5 = str3.replace(tmp11(14023).safeRe[tmp11(undefined, 14023).t.TILDETRIM], tmp11(14023).tildeTrimReplace);
        tmp11(14022)("tilde trim", str5);
        const str7 = str5.replace(tmp11(14023).safeRe[tmp11(undefined, 14023).t.CARETTRIM], tmp11(14023).caretTrimReplace);
        ...
        let mapped = parts.map((str) => {
          ...
          const mapped2 = parts2.map((str) => {
            ...
            return str.replace(tmp2, (arg0, arg1, str, str2, str3) => {
              let combined = arg0;
              str = arg1;
              str(includePrerelease[6])("xRange", str, arg0, arg1, str, str2, str3, arg5);
              if (typeof closure_1_9 !== "function") {
                HermesBuiltin.throwTypeError();
              }
              let tmp6 = !str;
              ...
              str(includePrerelease[6])("xRange return", combined);
              return combined;
            });
          });
