...
// Function ID: 14172
// Name: simpleSubset
// Dependencies: [14158, 14157, 14143, 14160]

// Module 14171 (simpleSubset)
import _mod14143 from "module_14143" /* 14143 */;
import Comparator from "Comparator" /* 14157 */;
...
function simpleSubset(arg0, item10015, includePrerelease) {
  ...
  if (arg0 === item10015) {
    ...
    if (1 === arg0.length) {
      ...
      if (arg0[0].semver === Comparator.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(14157).ANY) {
            return true;
          }
        }
      }
    ...
    if (set.size > 1) {
      ...
      if (tmp) {
        if (tmp2) {
          const tmp46 = _mod14143(tmp.semver, tmp2.semver, includePrerelease);
          if (tmp46 > 0) {
            return null;
          } else {
            let tmp39 = tmp46;
...
function higherGT(semver, semver2, includePrerelease) {
  if (semver) {
    const tmp4 = _mod14143(semver.semver, semver2.semver, includePrerelease);
    let tmp5 = semver;
    if (tmp4 <= 0) {
      if (tmp4 < 0) {
        let tmp6 = semver2;
...
export default (arg0, arg1, includePrerelease) => {
  ...
  if (arg0 === arg1) {
    ...
    const tmp22 = new _mod14158(arg0, obj);
    const tmp27 = new _mod14158(arg1, obj);
    let flag = false;
