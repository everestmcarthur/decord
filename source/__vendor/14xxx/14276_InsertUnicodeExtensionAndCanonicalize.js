...
// Dependencies: [14269, 14277]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14276 (InsertUnicodeExtensionAndCanonicalize)
import _mod14269 from "module_14269" /* 14269 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14277 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14269.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
