...
// Function ID: 14447
// Name: state
// Dependencies: [14410, 14385, 14447, 14401, 14448, 14430, 14408, 14441]
...
if (!_mod14447) {
  if (!_mod14401.state) {
    ...
    let fn = function t(facade, arg1) {
      if (require("module_14408")(facade, closure_6)) {
        const typeError = new tmp(14385).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(14441)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
    ...
    let fn2 = function n(arg0) {
      return require("module_14408")(arg0, closure_6) ? arg0[closure_6] : {};
    };
    let fn5 = fn2;
    let fn3 = function u(arg0) {
      return require("module_14408")(arg0, closure_6);
    };
    let fn6 = fn3;
  }
  let obj = {
