...
// Function ID: 14498
// Name: URLImpl
// Dependencies: [41, 42, 14498, 14502, 14501]

// Module 14497 (URLImpl)
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(14498).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(14498).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(14501).parseUrlencoded(query);
          const tmpResult = tmp(14501);
        }
      }
      const obj = URLImpl(14498);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(14498).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
    ...
    set(arg0) {
      URLImpl(14498).basicURLParse(`${arg0}:`, { url: this._url, stateOverride: "scheme start" });
    }
  },
  {
    key: "username",
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14498).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(14498);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14498).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(14498);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(14498).serializeHost(host);
        const obj3 = URLImpl(14498);
      } else {
        const obj = URLImpl(14498);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(14498).serializeInteger(host.port)}`;
        const obj2 = URLImpl(14498);
      }
    },
    set(arg0) {
      if (!this._url.cannotBeABaseURL) {
        const obj2 = { url: tmp._url, stateOverride: "host" };
        URLImpl(14498).basicURLParse(arg0, obj2);
        const obj = URLImpl(14498);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(14498).serializeHost(tmp._url.host);
        const obj = URLImpl(14498);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(14498).serializeInteger(tmp._url.port);
        const obj = URLImpl(14498);
      }
      return str;
    },
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        URLImpl(14498).basicURLParse(substr, obj2);
        const obj = URLImpl(14498);
        self._query._list = URLImpl(14501).parseUrlencoded(substr);
      }
    }
  },
  {
