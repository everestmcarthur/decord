...
// Function ID: 14270
// Name: compareKV
// Dependencies: [1162, 14270, 14268, 14271, 14272]

// Module 14269 (compareKV)
...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants.length) {
      ...
      obj[1] = items;
      const str = _mod14270.languageAlias[emitUnicodeLanguageId.emitUnicodeLanguageId(undefined, obj)];
      while (!str) {
        num3 = num3 + 1;
        tmp = lang;
      }
      obj = { lang: null, script: null, region: null, variants: null };
      const result = tmp2(14271).parseUnicodeLanguageId(str.split(tmp2(14271).SEPARATOR));
      obj[0] = result.lang;
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      obj[3] = [];
      const str2 = _mod14270.languageAlias[emitUnicodeLanguageId.emitUnicodeLanguageId(undefined, obj)];
      tmp9 = tmp;
      if (str2) {
        obj1 = { lang: null, script: null, region: null, variants: null };
        const result1 = tmp10(14271).parseUnicodeLanguageId(str2.split(tmp10(14271).SEPARATOR));
  ...
  if (tmp9.region) {
    ...
    obj2[2] = [];
    const str3 = _mod14270.languageAlias[emitUnicodeLanguageId.emitUnicodeLanguageId(undefined, obj2)];
    tmp13 = tmp9;
    if (str3) {
      const obj3 = { lang: null, script: null, region: null, variants: null };
      const result2 = tmp14(14271).parseUnicodeLanguageId(str3.split(tmp14(14271).SEPARATOR));
      obj3[0] = result2.lang;
  ...
  const str4 = _mod14270.languageAlias[emitUnicodeLanguageId.emitUnicodeLanguageId(undefined, obj4)];
  let tmp19 = tmp13;
  if (str4) {
    const obj5 = { lang: null, script: null, region: null, variants: null };
    const result3 = tmp17(14271).parseUnicodeLanguageId(str4.split(tmp17(14271).SEPARATOR));
    obj5[0] = result3.lang;
  ...
  if (tmp19.region) {
    ...
    const str6 = tmp17(14270).territoryAlias[formatted];
    let tmp22;
    if (str6) {
      ...
      obj6[2] = [];
      const str8 = tmp17(14272).likelySubtags[tmp17(undefined, 14268).emitUnicodeLanguageId(undefined, obj6)];
      tmp22 = first;
      if (str8) {
        const region = tmp17(14271).parseUnicodeLanguageId(str8.split(tmp17(14271).SEPARATOR)).region;
        let tmp24 = region;
        if (region) {
  ...
  if (tmp19.script) {
    ...
    if (tmp17(14270).scriptAlias[tmp19.script]) {
      tmp19.script = tmp17(14270).scriptAlias[tmp19.script];
    }
  ...
  if (tmp19.variants.length) {
    for (let num7 = 0; num7 < tmp19.variants.length; num7 = num7 + 1) {
      ...
      let tmp29 = num7;
      if (_mod14270.variantAlias[formatted2]) {
        let tmp30 = tmp27(14270).variantAlias[formatted2];
        if (tmp27(14271).isUnicodeVariantSubtag(tmp30)) {
          tmp19.variants[num7] = tmp30;
        } else if (tmp27(14271).isUnicodeLanguageSubtag(tmp30)) {
          tmp19.lang = tmp30;
        }
      }
    }
