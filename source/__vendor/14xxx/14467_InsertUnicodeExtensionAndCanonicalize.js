...
// Dependencies: [14460, 14468]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14467 (InsertUnicodeExtensionAndCanonicalize)
import _mod14460 from "module_14460" /* 14460 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14468 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14460.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
