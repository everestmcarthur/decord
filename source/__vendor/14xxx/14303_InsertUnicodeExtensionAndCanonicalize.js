...
// Dependencies: [14296, 14304]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14303 (InsertUnicodeExtensionAndCanonicalize)
import _mod14296 from "module_14296" /* 14296 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14304 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14296.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
