...
// Dependencies: [109, 19, 17, 21, 1636, 4975, 1614, 14617, 14618]

// Module 14616 (ReanimatedNativeStackScreen)
...
const jsx = fn(21).jsx;
let closure_7 = cancelAnimation.createAnimatedComponent(fn(4975).InnerScreen);
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef14618.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef14617.Provider, { value: sharedValue, children: jsx(_modDef14618.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
