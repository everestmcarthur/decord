...
// Function ID: 14071
// Name: Comparator
// Dependencies: [41, 42, 14043, 14045, 14046, 14042, 14068, 14071]

// Module 14070 (Comparator)
...
const entry = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(14046).safeRe;
    const t = Comparator(14046).t;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(14042)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
        self.semver = semver;
      }
...
const items = [
  ...
  },
  {
    ...
    value: function test(arg0) {
      const self = this;
      let tmp = arg0;
      Comparator(14045)("Comparator.test", arg0, this.options.loose);
      if (this.semver !== closure_3) {
        if (tmp !== tmp5) {
          if (typeof tmp === "string") {
            try {
              tmp = new tmp2(14042)(tmp, self.options);
            } catch (err) {
              return false;
            }
          }
          return tmp2(14068)(tmp, self.operator, self.semver, self.options);
        }
      }
      return true;
    }
    ...
    value: function intersects(value, arg1) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(14071)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(14071)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(14043)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(14068)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(14068)(self.semver, ">", value.semver, tmp45);
