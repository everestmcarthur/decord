...
// Dependencies: [1162, 14202, 14203, 14267, 14274, 14279, 14294, 14295]

// Module 14201 (addLikelySubtags)
import getInternalSlots from "getInternalSlots" /* 14202 */;
import isStructurallyValidLanguageTag from "isStructurallyValidLanguageTag" /* 14267 */;
...
function addLikelySubtags(locale) {
  ...
  if (script) {
    if (region) {
      ...
      obj[2] = region;
      obj[3] = [];
      const tmp4 = tmp(14267).likelySubtags[tmp(undefined, 14267).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(14267).parseUnicodeLanguageId(tmp4);
        ...
        if (result) {
          ...
          let tmpResult = tmp(1162);
          tmpResult = tmp(1162);
          obj[3] = tmpResult.__spreadArray(tmpResult.__spreadArray([], variants, true), result.variants, true);
        } else {
          obj = { lang: null, script: "Array", region: "options", variants: true };
          obj[0] = "und";
          obj[3] = variants;
        }
        parseUnicodeLocaleIdResult.lang = obj;
        return tmp(14267).emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    obj1 = { lang: null, script: null, variants: null };
    obj1[0] = lang;
    obj1[1] = script;
    obj1[2] = [];
    const tmp5 = tmp(14267).likelySubtags[tmp(undefined, 14267).emitUnicodeLanguageId(undefined, obj1)];
    if (tmp5) {
      const result1 = tmp(14267).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
      if (result1) {
        ...
        obj2[3] = tmpResult1.__spreadArray(tmp(1162).__spreadArray([], items, true), result1.variants, true);
        let obj3 = obj2;
        const tmpResult2 = tmp(1162);
      } else {
        obj3 = { lang: null, script: "r", region: "PX_16", variants: null };
        obj3[0] = "und";
        obj3[2] = region;
        obj3[3] = items;
      }
  ...
  if (region) {
    ...
    obj4[1] = region;
    obj4[2] = [];
    const tmp6 = tmp(14267).likelySubtags[tmp(undefined, 14267).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp6) {
      const result2 = tmp(14267).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
      if (result2) {
        ...
        obj5[3] = tmpResult3.__spreadArray(tmp(1162).__spreadArray([], items1, true), result2.variants, true);
        let obj6 = obj5;
  ...
  let tmp7 = tmp(14267).likelySubtags[lang];
  if (!tmp7) {
    const obj7 = { lang: "und", script: null, variants: null };
    obj7[1] = script;
    obj7[2] = [];
    tmp7 = tmp(14267).likelySubtags[tmp(undefined, 14267).emitUnicodeLanguageId(undefined, obj7)];
  }
  if (tmp7) {
    const result3 = tmp(14267).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
    ...
    if (result3) {
      ...
      obj8[3] = tmpResult5.__spreadArray(tmp(1162).__spreadArray([], items2, true), result3.variants, true);
      let tmp14 = obj8;
...
let tmp2 = (() => {
        ...
        if (undefined === arg0) {
          ...
          if (typeof arg0 === "object") {
            ...
            if (constructor) {
              ...
              tmp31 = result;
              str11 = "string";
              GetOptionResult = Locale(closure_1_1[2]).GetOption(result, "language", "string", undefined, undefined);
              ...
              tmp42 = result;
              str14 = "string";
              GetOptionResult1 = Locale(closure_1_1[2]).GetOption(result, "script", "string", undefined, undefined);
              ...
              tmp52 = result;
              str17 = "string";
              GetOptionResult2 = Locale(closure_1_1[2]).GetOption(result, "region", "string", undefined, undefined);
              ...
              tmp60 = Locale;
              tmp61 = closure_1_1;
              result1 = Locale(closure_1_1[3]).parseUnicodeLanguageId(locale);
              if (tmp33) {
              ...
              tmp65 = Locale;
              tmp66 = closure_1_1;
              obj = Locale(closure_1_1[0]);
              tmp67 = Locale;
              tmp68 = closure_1_1;
              obj2 = Locale(closure_1_1[0]);
              tmp69 = Locale;
              tmp70 = closure_1_1;
              obj = { lang: null };
              obj[0] = result1;
              ...
              tmp75 = result;
              str20 = "string";
              GetOptionResult3 = Locale(closure_1_1[2]).GetOption(result, "calendar", "string", undefined, undefined);
              if (undefined !== GetOptionResult3) {
                tmp77 = closure_1_5;
                if (!closure_1_5.test(GetOptionResult3)) {
              ...
              tmp84 = result;
              str23 = "string";
              GetOptionResult4 = Locale(closure_1_1[2]).GetOption(result, "collation", "string", undefined, undefined);
              if (undefined !== GetOptionResult4) {
                tmp86 = closure_1_5;
                if (!closure_1_5.test(GetOptionResult4)) {
              ...
              if (undefined !== GetOptionResult5) {
                tmp96 = closure_1_7;
                tmp97 = closure_1_7[+GetOptionResult5];
                tmp98 = closure_1_3;
                tmp95 = tmp97;
                if (!closure_1_3.test(tmp97)) {
    ...
    minimize() {
      try {
        ...
        tmp4 = (function removeLikelySubtags(locale) {
          ...
          if (tmp2) {
            let obj = callback(1162);
            obj1 = callback(1162);
            obj = { variants: null };
            obj[0] = [];
            const result = callback(14267).emitUnicodeLanguageId(obj.__assign(obj1.__assign({}, callback(14267).parseUnicodeLanguageId(tmp2)), obj));
            const parseUnicodeLocaleIdResult = callback(14267).parseUnicodeLocaleId(locale);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            obj = { lang: null, variants: null };
            obj[0] = lang;
            obj[1] = [];
            if (tmp(callback(14267).emitUnicodeLanguageId(obj)) === result) {
              let tmp3Result = tmp3(1162);
              tmp3Result = tmp3(1162);
              if (undefined === variants) {
                variants = [];
              }
              if (!lang) {
              ...
              obj1 = { lang: null };
              const obj2 = { lang: null, script: "Array", region: "options", variants: true };
              obj2[0] = lang;
              obj2[3] = variants;
              obj1[0] = obj2;
              let emitUnicodeLocaleIdResult = tmp3(14267).emitUnicodeLocaleId(tmp3Result.__assign(tmp3Result.__assign({}, parseUnicodeLocaleIdResult), obj1));
              ...
              if (region) {
                ...
                obj3[1] = region;
                obj3[2] = [];
                if (tmp(tmp3(14267).emitUnicodeLanguageId(obj3)) === result) {
                  ...
                  const obj5 = { lang: null, script: "r", region: "PX_16", variants: null };
                  obj5[0] = str2;
                  obj5[2] = region;
                  obj5[3] = items;
                  obj4[0] = obj5;
                  emitUnicodeLocaleIdResult = tmp3(14267).emitUnicodeLocaleId(tmp3Result1.__assign(tmp3(1162).__assign({}, parseUnicodeLocaleIdResult), obj4));
              ...
              if (script) {
                ...
                obj6[2] = [];
                emitUnicodeLocaleIdResult = locale;
                if (tmp(tmp3(14267).emitUnicodeLanguageId(obj6)) === result) {
                  ...
                  const obj8 = { lang: null, script: null, region: "Array", variants: true };
                  obj8[0] = str;
                  obj8[1] = script;
                  obj8[3] = items1;
                  obj7[0] = obj8;
                  emitUnicodeLocaleIdResult = tmp3(14267).emitUnicodeLocaleId(tmp3Result3.__assign(tmp3(1162).__assign({}, parseUnicodeLocaleIdResult), obj7));
  ...
  let obj = {
    get() {
      return Locale(14267).emitUnicodeLanguageId(Locale(14267).parseUnicodeLanguageId(closure_2.default(this).locale));
    },
    enumerable: false,
    configurable: true
  };
  ...
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14267).parseUnicodeLanguageId(closure_2.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14267).parseUnicodeLanguageId(closure_2.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14267).parseUnicodeLanguageId(closure_2.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      ...
      if (Locale(14203).HasOwnProperty(defaultResult, "initializedLocale")) {
