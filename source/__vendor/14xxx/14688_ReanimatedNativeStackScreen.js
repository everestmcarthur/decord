...
// Dependencies: [109, 19, 17, 21, 1637, 5009, 1615, 14689, 14690]

// Module 14688 (ReanimatedNativeStackScreen)
...
const jsx = fn(21).jsx;
let closure_7 = cancelAnimation.createAnimatedComponent(fn(5009).InnerScreen);
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef14690.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef14689.Provider, { value: sharedValue, children: jsx(_modDef14690.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
