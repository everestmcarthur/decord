...
// Function ID: 14429
// Name: URLImpl
// Dependencies: [41, 42, 14429, 14433, 14432]

// Module 14428 (URLImpl)
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(14429).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(14429).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(14432).parseUrlencoded(query);
          const tmpResult = tmp(14432);
        }
      }
      const obj = URLImpl(14429);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(14429).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
    ...
    set(arg0) {
      URLImpl(14429).basicURLParse(`${arg0}:`, { url: this._url, stateOverride: "scheme start" });
    }
  },
  {
    key: "username",
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14429).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(14429);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14429).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(14429);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(14429).serializeHost(host);
        const obj3 = URLImpl(14429);
      } else {
        const obj = URLImpl(14429);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(14429).serializeInteger(host.port)}`;
        const obj2 = URLImpl(14429);
      }
    },
    set(arg0) {
      if (!this._url.cannotBeABaseURL) {
        const obj2 = { url: tmp._url, stateOverride: "host" };
        URLImpl(14429).basicURLParse(arg0, obj2);
        const obj = URLImpl(14429);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(14429).serializeHost(tmp._url.host);
        const obj = URLImpl(14429);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(14429).serializeInteger(tmp._url.port);
        const obj = URLImpl(14429);
      }
      return str;
    },
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        URLImpl(14429).basicURLParse(substr, obj2);
        const obj = URLImpl(14429);
        self._query._list = URLImpl(14432).parseUrlencoded(substr);
      }
    }
  },
  {
