...
// Dependencies: [1162, 14260, 14276, 14277]
// Exports: ComputeExponent

// Module 14275 (ComputeExponent)
  ...
  if (timesResult.isZero()) {
    ...
    if (roundedNumber.isZero()) {
      ...
      if (floorResult1.eq(floorResult.minus(result))) {
        ...
        const items2 = [tmp2(14276).ComputeExponentForMagnitude(internalSlots, floorResult.plus(1)), floorResult.plus(1).toNumber()];
        return items2;
      }
