...
// Dependencies: [1639, 1661, 1673, 1675, 1643]

// Module 1672 (startObservingProgress)
import _mod1661 from "module_1661" /* 1661 */;
import _mod1673 from "module_1673" /* 1673 */;
import resolvePath from "resolvePath" /* 1675 */;
...
function startObservingProgress(arg0, addListener, arg2) {
  ...
  dependencyMap = arg2 === require("module_1661").LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
  addListener.addListener(arg0 + 1000000000, () => {
    map._notifyAboutProgress(closure_0, value2.value, closure_2);
  });
}
startObservingProgress.__closure = { LayoutAnimationType: _mod1661.LayoutAnimationType, TAG_OFFSET: 1000000000 };
...
function createLayoutAnimationManager() {
  ...
  function startActually(arg0, arg1, arg2, fn) {
    ...
    if (arg1 !== map1(startActually[1]).LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS) {
      ...
      if (undefined === value2) {
        mutableUI = tmp(tmp2[2]).makeMutableUI(tmp6.initialValues);
      ...
      const withStyleAnimationResult = tmp(tmp2[3]).withStyleAnimation(animations);
...
let obj = { LayoutAnimationType: _mod1661.LayoutAnimationType, TAG_OFFSET: 1000000000 };
createLayoutAnimationManager.__closure = { LayoutAnimationType: _mod1661.LayoutAnimationType, makeMutableUI: _mod1673.makeMutableUI, stopObservingProgress, withStyleAnimation: resolvePath.withStyleAnimation, startObservingProgress, IS_ANDROID: module_1639 };
