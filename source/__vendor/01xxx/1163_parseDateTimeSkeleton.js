...
arg5.parseDateTimeSkeleton = function parseDateTimeSkeleton(str) {
  ...
  const replaced = str.replace(obj, (arg0) => {
    ...
    switch (str) {
      ...
      break;
      case "D":
        tmp18.hour = ["numeric", "2-digit"][length - 1];
      break;
      ...
      case "mes":
        str = globalThis;
        let rangeError6 = new str.RangeError("`b/B` (period) patterns are not supported, use `a` instead");
        throw rangeError6;
      case "I":
      break;
      case "InternalCard":
        str = globalThis;
        rangeError6 = new str.RangeError("`b/B` (period) patterns are not supported, use `a` instead");
        throw rangeError6;
      case "ter":
      break;
      case "na":
