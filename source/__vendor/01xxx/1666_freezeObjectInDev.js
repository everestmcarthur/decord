...
fn = function u() {
  const proxy = new Proxy({}, {
    get(arg0, arg1) {
      if ("_isReanimatedSharedValue" !== arg1) {
        if ("__remoteFunction" !== arg1) {
          ...
          const reanimatedError = new require("module_1647").ReanimatedError("Trying to access property `" + String(arg1) + "` of an object which cannot be sent to the UI runtime.");
    ...
    set() {
      const reanimatedError = new require("module_1647").ReanimatedError("Trying to write to an object which cannot be sent to the UI runtime.");
      throw reanimatedError;
    }
  });
  return proxy;
...
export const makeShareable = module_1639 ? (function makeShareableJS(arg0) {
  return arg0;
