...
let fn = function n(toValue, userConfig, callback) {
  ...
  closure_2 = callback;
  let obj = _require(1676);
  const fn = function u() {
    let obj = { damping: 10, mass: 1, stiffness: 100, overshootClamping: false, restDisplacementThreshold: 0.01, restSpeedThreshold: 2, velocity: 0, duration: 2000, dampingRatio: 0.5, reduceMotion: "call", clamp: "exports" };
  ...
  obj = { userConfig, checkIfConfigIsValid: _require(1719).checkIfConfigIsValid, underDampedSpringCalculations: _require(1719).underDampedSpringCalculations, criticallyDampedSpringCalculations: _require(1719).criticallyDampedSpringCalculations, isAnimationTerminatingCalculation: _require(1719).isAnimationTerminatingCalculation, calculateNewMassToMatchDuration: _require(1719).calculateNewMassToMatchDuration, initialCalculations: _require(1719).initialCalculations, scaleZetaToMatchClamps: _require(1719).scaleZetaToMatchClamps, toValue, callback, getReduceMotionForAnimation: _require(1676).getReduceMotionForAnimation };
  fn.__closure = obj;
