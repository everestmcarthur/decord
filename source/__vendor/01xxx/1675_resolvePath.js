...
// Function ID: 1676
// Name: resolvePath
// Dependencies: [1676, 1679, 1687, 1640]
...
function withStyleAnimation(animations) {
  ...
  fn.__closure = { ColorProperties: require("module_1679").ColorProperties, setPath, processColor: require("module_1679").processColor, styleAnimations: animations, resolvePath, __DEV__: false, logger: require("module_1640").logger, isValidLayoutAnimationProp: require("module_1676").isValidLayoutAnimationProp, withTiming: require("module_1687").withTiming };
  fn.__workletHash = 1293354823532;
  fn.__initData = __initData;
  return obj.defineAnimation({}, fn);
}
withStyleAnimation.__closure = { defineAnimation: fn(1676).defineAnimation, ColorProperties: fn(1679).ColorProperties, setPath, processColor: fn(1679).processColor, resolvePath, __DEV__: false, logger: fn(1640).logger, isValidLayoutAnimationProp: fn(1676).isValidLayoutAnimationProp, withTiming: fn(1687).withTiming };
