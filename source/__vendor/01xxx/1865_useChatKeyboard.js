...
// Dependencies: [1636, 1847, 1830, 1866]

// Module 1865 (useChatKeyboard)
const require = arg1;
const module = arg2;
...
arg5.useChatKeyboard = function useChatKeyboard(animatedRef, inverted) {
  ...
  obj4 = { padding: sharedValue, currentHeight: sharedValue1, contentOffsetY: "Boolean", scroll: true, layout: false, size: null, onLayout: true, onContentSizeChange: null };
  obj4[3] = offset2;
  obj4[4] = layout;
  obj4[5] = size;
  obj4[6] = onLayout;
