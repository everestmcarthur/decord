...
function instrumentReactRouter(f109336, arg1, arg2, location, reactrouter_v4, arg5, arg6) {
  _require = f109336;
  ...
  if (arg1) {
    ...
    if (pathname) {
      ...
      let result = require("feedbackAsyncIntegration").startBrowserTracingPageLoadSpan(f109336, obj2);
...
export const reactRouterV4BrowserTracingIntegration = function reactRouterV4BrowserTracingIntegration(instrumentNavigation) {
  ...
  obj3.afterAllSetup = function afterAllSetup(f109336) {
    result.afterAllSetup(f109336);
    instrumentReactRouter(f109336, closure_4, closure_5, dependencyMap, "reactrouter_v4", _slicedToArray, noop);
  };
  return obj3;
};
export const reactRouterV5BrowserTracingIntegration = function reactRouterV5BrowserTracingIntegration(instrumentNavigation) {
  ...
  obj3.afterAllSetup = function afterAllSetup(f109336) {
    result.afterAllSetup(f109336);
    instrumentReactRouter(f109336, closure_4, closure_5, dependencyMap, "reactrouter_v5", _slicedToArray, noop);
  };
  return obj3;
};
