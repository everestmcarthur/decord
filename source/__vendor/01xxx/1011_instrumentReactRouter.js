...
function instrumentReactRouter(f108350, arg1, arg2, location, reactrouter_v4, arg5, arg6) {
  _require = f108350;
  ...
  if (arg1) {
    ...
    if (pathname) {
      ...
      let result = require("feedbackAsyncIntegration").startBrowserTracingPageLoadSpan(f108350, obj2);
