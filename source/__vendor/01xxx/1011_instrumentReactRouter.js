...
function instrumentReactRouter(f108185, arg1, arg2, location) {
  const _require = f108185;
  dependencyMap = arg4;
  let items = arg5;
  if (arg5 === undefined) {
    items = [];
  ...
  if (arg1) {
    if (location.location) {
      ...
      if (_require(889).WINDOW.location) {
    ...
    if (pathname) {
      ...
      obj[0] = tmp5;
      obj = {};
      obj[_require(682).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "pageload";
    ...
    location.listen((pathname) => {
      if (arg1) {
        if ("PUSH" === arg1) {
          ...
          let obj = callback(889);
          obj = { name: null, attributes: null };
          obj[0] = tmp5;
          obj = {};
          obj[callback(682).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "navigation";
          const _HermesInternal = HermesInternal;
          obj[callback(682).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = "auto.navigation.react." + dependencyMap;
          obj[callback(682).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = tmp6;
          obj[1] = obj;
...
export const withSentryRouting = function withSentryRouting(displayName) {
  ...
  _require(1005).hoistNonReactStatics(WrappedRoute, displayName);
  return WrappedRoute;
};
