...
// Dependencies: [1824, 1822]
// Exports: getSwipeSimulator

// Module 1823 (computeEasingProgress)
import applyStyle from "applyStyle" /* 1822 */;
import RNScreensTurboModule2 from "RNScreensTurboModule" /* 1824 */;
...
maybeScheduleNextFrame.__closure = { computeProgress, RNScreensTurboModule: fn(1824).RNScreensTurboModule };
          ...
          if (typeof easing === "function") {
            ...
            if (typeof tmp11 === "function") {
              ...
              if (y2) {
                ...
                const result = tmp19(1822).applyStyleForBelowTopScreen(tmp21, tmp7);
                const tmp19Result = tmp19(1822);
              }
              if (typeof maybeScheduleNextFrame === "function") {
                if (y2) {
                  ...
                  const RNScreensTurboModule = tmp19(1824).RNScreensTurboModule;
            ...
            if (typeof tmp11 === "function") {
              ...
              if (typeof tmp26 === "function") {
                if (y2) {
                  ...
                  const RNScreensTurboModule = tmp22(1824).RNScreensTurboModule;
...
let obj = { computeProgress, RNScreensTurboModule: fn(1824).RNScreensTurboModule };
getSwipeSimulator.__closure = { BASE_VELOCITY: 400, ADDITIONAL_VELOCITY_FACTOR_X: 400, ADDITIONAL_VELOCITY_FACTOR_Y: 500, ADDITIONAL_VELOCITY_FACTOR_XY: 600, applyStyleForBelowTopScreen: fn(1822).applyStyleForBelowTopScreen, computeEasingProgress, easing, applyStyle: fn(1822).applyStyle, maybeScheduleNextFrame };
