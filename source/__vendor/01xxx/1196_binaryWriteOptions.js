...
// Dependencies: [41, 42, 1197, 1194, 1195]
...
const items = [
  ...
  },
  {
    ...
    value: function uint32(NumberResult) {
      const self = this;
      BinaryWriter(1197).assertUInt32(NumberResult);
  ...
  },
  {
    ...
    value: function int32(NumberResult) {
      BinaryWriter(1197).assertInt32(NumberResult);
      const obj = BinaryWriter(1197);
      BinaryWriter(1194).varint32write(NumberResult, this.buf);
      return this;
    }
  },
  {
  ...
  },
  {
    ...
    value: function float(NumberResult) {
      BinaryWriter(1197).assertFloat32(NumberResult);
  ...
  },
  {
    ...
    value: function sint32(NumberResult) {
      ...
      BinaryWriter(1194).varint32write((tmp2 ^ tmp3) >>> 0, this.buf);
      return this;
    }
  },
  {
    ...
    value: function sfixed64(arg0) {
      const uint8Array = new Uint8Array(8);
      const dataView = new DataView(uint8Array.buffer);
      const PbLong = BinaryWriter(1195).PbLong;
  ...
  },
  {
    ...
    value: function fixed64(arg0) {
      const uint8Array = new Uint8Array(8);
      const dataView = new DataView(uint8Array.buffer);
      const PbULong = BinaryWriter(1195).PbULong;
  ...
  },
  {
    ...
    value: function int64(arg0) {
      const PbLong = BinaryWriter(1195).PbLong;
      const fromResult = PbLong.from(arg0);
      BinaryWriter(1194).varint64write(fromResult.lo, fromResult.hi, this.buf);
      return this;
    }
  },
  {
    ...
    value: function sint64(arg0) {
      const PbLong = BinaryWriter(1195).PbLong;
      const fromResult = PbLong.from(arg0);
      BinaryWriter(1194).varint64write(fromResult.lo << 1 ^ fromResult.hi >> 31, (fromResult.hi << 1 | fromResult.lo >>> 31) ^ fromResult.hi >> 31, this.buf);
      return this;
    }
  },
  {
