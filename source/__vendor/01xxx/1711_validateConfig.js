...
let fn = function n(userConfig, callback) {
  ...
  const fn = function c() {
    ...
    obj = {
      ...
      current: "disabled",
      lastTimestamp: null,
      startTimestamp: "M10 5H9v1h1V5ZM11 4h-1v1h1V4Z",
      reduceMotion: null
    };
  ...
  obj = { userConfig, isValidRubberBandConfig: _require(1712).isValidRubberBandConfig, rubberBandDecay: _require(1713).rubberBandDecay, rigidDecay: _require(1714).rigidDecay, validateConfig, callback, getReduceMotionForAnimation: _require(1676).getReduceMotionForAnimation };
  fn.__closure = obj;
