...
// Function ID: 1635
// Name: Animated
// Dependencies: [5, 32, 19, 17, 21, 1635, 1636, 1626, 1825, 1827, 1828, 1829]
// Exports: KeyboardProvider

// Module 1634 (Animated)
...
import controlEdgeToEdgeValues from "controlEdgeToEdgeValues" /* 1635 */;
...
export const KeyboardProvider = (enabled) => {
  ...
  const first = tmp4[0];
  callback = tmp4[1];
  let obj = _require(1825);
  const callback2 = obj.useAnimatedValue(0);
  obj1 = _require(1825);
  const callback3 = obj1.useAnimatedValue(0);
  let obj2 = _require(1636);
  const sharedValue = obj2.useSharedValue(0);
  let obj3 = _require(1636);
  sharedValue1 = obj3.useSharedValue(0);
  sharedValue2 = _require(1636).useSharedValue(null);
  const obj5 = _require(1636);
  Animated = _require(1825).useEventHandlerRegistration(tmp3);
  const obj6 = _require(1825);
  closure_10 = _require(1825).useEventHandlerRegistration(tmp3);
  ...
  obj[3] = fn3;
  const obj9 = _require(1827);
  const animatedKeyboardHandler = _require(1827).useAnimatedKeyboardHandler(obj, []);
  ...
  obj3[9] = tmp11;
  obj3[10] = tmp11;
  obj3[11] = _require(1827).useFocusedInputLayoutHandler(obj1, []);
  obj3[12] = children;
  const items2 = [closure_10(closure_13, obj3), closure_10(Animated.View, { style: tmp10 })];
  obj2[1] = items2;
  return closure_11(_require(1829).KeyboardContext.Provider, obj2);
};
