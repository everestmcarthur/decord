...
class CMap {
  constructor() {
    f108495 = (vbox, vbox2) => {
      ...
      return f108495.naturalOrder(result, vbox3.count() * vbox4.volume());
    };
    closure_1 = [];
    c2 = false;
    obj = {
  ...
  if (arr.length) {
    if (arg1 >= 2) {
      if (arg1 <= 256) {
          ...
          while (true) {
            ...
            if (arr.count()) {
              ...
              if (arr.count()) {
                ...
                let maxResult = f108495.max(items);
                if (1 == arr.count()) {
                  let items1 = [arr.copy()];
                  tmp7 = items1;
                } else {
        ...
        obj.b2 = c8;
        obj.histo = array;
        const prototype2 = f108495.prototype;
        f108495 = (count, count2) => f108495.naturalOrder(count.count(), count2.count());
        VBox = [];
        CMap = false;
        ...
        obj.push(obj);
        iter(obj, 0.75 * arg1);
        const prototype3 = f108495.prototype;
        f108495 = (count, count2) => {
          const result = count.count() * count.volume();
          const countResult = count.count();
          return f108495.naturalOrder(result, count2.count() * count2.volume());
        };
        VBox = [];
        CMap = false;
        ...
        const prototype = f108495.prototype;
        f108495 = (vbox, vbox2) => {
          vbox = vbox.vbox;
          vbox2 = vbox.vbox;
          const vbox3 = vbox2.vbox;
