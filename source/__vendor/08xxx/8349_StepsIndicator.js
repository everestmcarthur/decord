...
// Function ID: 8350
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8347, 8348, 8350, 8351]
// Exports: StepsIndicator

// Module 8349 (StepsIndicator)
import _mod8347 from "module_8347" /* 8347 */;
import _mod8348 from "module_8348" /* 8348 */;
import SliderTrackMark from "SliderTrackMark" /* 8350 */;
import StepNumber from "StepNumber" /* 8351 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8347.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8347.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8348.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8347.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8348.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8347).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8348).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8348).styles.stepIndicatorElement;
    }
