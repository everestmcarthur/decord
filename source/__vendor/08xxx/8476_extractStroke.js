...
// Function ID: 8477
// Name: extractStroke
// Dependencies: [8474, 8462, 8477]

// Module 8476 (extractStroke)
const module = arg2;
...
arg5.default = function extractStroke(arg0, arg1, arr) {
  ...
  if (null != stroke) {
    arr.push("stroke");
    arg0.stroke = module(8474)(stroke);
  }
  if (null != strokeWidth) {
  ...
  if (null != strokeOpacity) {
    ...
    arg0.strokeOpacity = module(8462)(strokeOpacity);
  }
  if (null != strokeDasharray) {
    ...
    if (strokeDasharray) {
      ...
      if ("none" !== strokeDasharray) {
        tmp9 = module(8477)(strokeDasharray);
      }
    }
    let combined = tmp9;
    if (tmp9) {
