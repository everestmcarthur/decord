...
// Dependencies: [19, 17, 21, 8450, 8451]
// Exports: defaultRenderError, defaultRenderLoading, useWebWiewLogic

// Module 8449 (originWhitelistToRegex)
...
function originWhitelistToRegex(arg0) {
  return "^".concat(_modDef8450(arg0).replace(/\\\*/g, ".*"));
}
...
export const defaultRenderLoading = () => closure_1_10(React5, { style: _modDef8451.loadingOrErrorView, children: closure_1_10(React6, {}) });
export const defaultRenderError = (arg0, arg1, arg2) => {
  const obj = { style: _modDef8451.loadingOrErrorView, children: null };
  const items = [closure_1_10(React7, { style: _modDef8451.errorTextTitle, children: "Error loading page" }), , , ];
  const obj2 = { style: _modDef8451.errorTextTitle, children: "Error loading page" };
  items[1] = closure_1_10(React7, { style: _modDef8451.errorText, children: "Domain: ".concat(arg0) });
  const obj3 = { style: _modDef8451.errorText, children: "Domain: ".concat(arg0) };
  items[2] = closure_1_10(React7, { style: _modDef8451.errorText, children: "Error Code: ".concat(arg1) });
  const obj4 = { style: _modDef8451.errorText, children: "Error Code: ".concat(arg1) };
  items[3] = closure_1_10(React7, { style: _modDef8451.errorText, children: "Description: ".concat(arg2) });
  obj.children = items;
