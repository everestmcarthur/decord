...
// Function ID: 8517
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8514, 8515, 8517, 8518]
// Exports: StepsIndicator

// Module 8516 (StepsIndicator)
import _mod8514 from "module_8514" /* 8514 */;
import _mod8515 from "module_8515" /* 8515 */;
import SliderTrackMark from "SliderTrackMark" /* 8517 */;
import StepNumber from "StepNumber" /* 8518 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8514.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8514.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8515.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8514.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8515.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8514).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8515).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8515).styles.stepIndicatorElement;
    }
