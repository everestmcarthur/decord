...
// Function ID: 8415
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8412, 8413, 8415, 8416]
// Exports: StepsIndicator

// Module 8414 (StepsIndicator)
import _mod8412 from "module_8412" /* 8412 */;
import _mod8413 from "module_8413" /* 8413 */;
import SliderTrackMark from "SliderTrackMark" /* 8415 */;
import StepNumber from "StepNumber" /* 8416 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8412.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8412.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8413.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8412.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8413.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8412).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8413).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8413).styles.stepIndicatorElement;
    }
