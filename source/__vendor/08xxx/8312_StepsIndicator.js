...
// Function ID: 8313
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8310, 8311, 8313, 8314]
// Exports: StepsIndicator

// Module 8312 (StepsIndicator)
import _mod8310 from "module_8310" /* 8310 */;
import _mod8311 from "module_8311" /* 8311 */;
import SliderTrackMark from "SliderTrackMark" /* 8313 */;
import StepNumber from "StepNumber" /* 8314 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8310.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8310.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8311.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8310.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8311.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8310).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8311).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8311).styles.stepIndicatorElement;
    }
