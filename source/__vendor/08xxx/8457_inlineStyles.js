...
// Function ID: 8458
// Name: inlineStyles
// Dependencies: [8458, 8459, 8562, 8563, 8565, 8566, 8480]

// Module 8457 (inlineStyles)
...
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 8563 */;
...
export const camelCase = _isNativeReflectConstruct.camelCase;
export const fetchText = _fetchText.fetchText;
export const parse = _isNativeReflectConstruct.parse;
...
export const Shape = _isNativeReflectConstructDefault;
export const SvgAst = _isNativeReflectConstruct.SvgAst;
export const SvgFromUri = _isNativeReflectConstruct.SvgFromUri;
export const SvgFromXml = _isNativeReflectConstruct.SvgFromXml;
export const SvgUri = _isNativeReflectConstruct.SvgUri;
export const SvgXml = _isNativeReflectConstruct.SvgXml;
