...
// Function ID: 8472
// Name: extractProps
// Dependencies: [8472, 8463, 8473, 8476, 8464, 8462]

// Module 8471 (extractProps)
import pickNotNil from "pickNotNil" /* 8472 */;
...
function extractProps(markerMid) {
  ...
  const obj = {};
  const items = [];
  module(8463)(obj, markerMid, arg1);
  module(8473)(obj, markerMid, items);
  module(8476)(obj, markerMid, items);
  if (markerMid.color) {
  ...
  const tmp6 = module(8464)(markerMid);
  if (null !== tmp6) {
    obj.matrix = tmp6;
  }
  if (null != opacity) {
    obj.opacity = tmp(8462)(opacity);
  }
  if (null != display) {
    let str4;
    if ("none" === display) {
