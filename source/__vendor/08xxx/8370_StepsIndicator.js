...
// Function ID: 8371
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8368, 8369, 8371, 8372]
// Exports: StepsIndicator

// Module 8370 (StepsIndicator)
import _mod8368 from "module_8368" /* 8368 */;
import _mod8369 from "module_8369" /* 8369 */;
import SliderTrackMark from "SliderTrackMark" /* 8371 */;
import StepNumber from "StepNumber" /* 8372 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8368.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8368.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8369.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8368.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8369.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8368).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8369).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8369).styles.stepIndicatorElement;
    }
