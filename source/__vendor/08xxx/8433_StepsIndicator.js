...
// Function ID: 8434
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8431, 8432, 8434, 8435]
// Exports: StepsIndicator

// Module 8433 (StepsIndicator)
import _mod8431 from "module_8431" /* 8431 */;
import _mod8432 from "module_8432" /* 8432 */;
import SliderTrackMark from "SliderTrackMark" /* 8434 */;
import StepNumber from "StepNumber" /* 8435 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8431.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8431.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8432.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8431.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8432.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8431).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8432).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8432).styles.stepIndicatorElement;
    }
