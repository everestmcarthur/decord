...
// Dependencies: [8465, 8466, 8467]

// Module 8464 (appendTransformProps)
import append from "append" /* 8465 */;
import peg$SyntaxError from "peg$SyntaxError" /* 8466 */;
import peg$SyntaxError2 from "peg$SyntaxError" /* 8467 */;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(8466);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(8465);
