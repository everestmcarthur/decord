...
// Function ID: 11400
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1636, 11400, 6837, 6769]
// Exports: default

// Module 11399 (leftThreshold)
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod11400.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod11400.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod11400.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod11400.SwipeDirection.LEFT;
      }
