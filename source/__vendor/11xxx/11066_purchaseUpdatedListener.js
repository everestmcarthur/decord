...
export const purchaseUpdatedListener = (arg0, arg1) => {
  ...
  const _require = arg0;
  dependencyMap = arg1;
  const obj = _require(11056);
  const obj2 = new NativeEventEmitter(_require(11056).getNativeModule());
...
export const purchaseErrorListener = (arg0) => {
  const obj = _mod11056;
  return new NativeEventEmitter(_mod11056.getNativeModule()).addListener("purchase-error", arg0);
};
export const promotedProductListener = (arg0) => {
  let addListenerResult = null;
  if (_mod11056.isIos) {
    let tmpResult = tmp(11054);
