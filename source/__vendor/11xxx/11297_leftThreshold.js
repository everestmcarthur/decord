...
// Function ID: 11298
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1636, 11298, 6750, 6682]
// Exports: default

// Module 11297 (leftThreshold)
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod11298.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod11298.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod11298.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod11298.SwipeDirection.LEFT;
      }
