...
// Module 11054 (NativeModules)
import _mod11056 from "module_11056" /* 11056 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11062 */;
import NativeModulesAll from "NativeModules" /* 11063 */;
import fetchJsonOrThrowAll from "fetchJsonOrThrow" /* 11064 */;
...
const subs = require("module_11055").ProductType.subs;
const inapp = require("module_11055").ProductType.inapp;
...
export const isIosStorekit2 = require("module_11056").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      closure_1 = tmp5;
      closure_0 = tmp2;
      const obj3 = closure_1_0(11056);
      const androidModule = obj3.getAndroidModule();
      yield androidModule.getItemsByType(closure_1_7, closure_1_0);
      closure_0 = arg1.map(closure_1_0(11061).singleProductAndroidMap);
      const obj = closure_1_0(11056);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      ...
      androidModuleType = closure_1_0(11056).getAndroidModuleType();
      const obj10 = closure_1_0(11056);
      const androidModule = closure_1_0(11056).getAndroidModule();
      closure_1 = yield androidModule.getItemsByType(closure_1_6, closure_1_0);
      if ("android" === closure_1_0) {
        return closure_1_8(closure_1, closure_1_0(11055).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      const obj2 = closure_1_0(11056);
      dependencyMap = yield obj2.fillProductsWithAdditionalData(dependencyMap);
      return closure_1_8(dependencyMap, closure_1_0(11055).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
