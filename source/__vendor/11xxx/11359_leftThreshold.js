...
// Function ID: 11360
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1636, 11360, 6807, 6739]
// Exports: default

// Module 11359 (leftThreshold)
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod11360.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod11360.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod11360.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod11360.SwipeDirection.LEFT;
      }
