...
// Function ID: 11404
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1637, 11404, 6841, 6773]
// Exports: default

// Module 11403 (leftThreshold)
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod11404.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod11404.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod11404.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod11404.SwipeDirection.LEFT;
      }
