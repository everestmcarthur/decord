...
// Function ID: 11070
// Name: useIAPContext
// Dependencies: [5, 32, 19, 21, 11054, 11066]
// Exports: useIAPContext, withIAPContext

// Module 11069 (useIAPContext)
...
export function withIAPContext(arg0) {
  ...
  return function WrapperComponent(arg0) {
    ...
    closure_1_5(() => {
      const connection = first(11054).initConnection();
      const obj = first(11054);
    ...
    closure_1_5(() => {
      if (closure_0) {
        ...
        closure_0 = first(11066).purchaseUpdatedListener(function(arg0) {
          const self = this;
        ...
        dependencyMap = first(11066).transactionListener(function(arg0) {
          const self = this;
          const apply = closure_0.apply;
          if (typeof apply === "unknown") {
            let applyArgumentsResult = HermesBuiltin.applyArguments(self);
        ...
        const obj2 = first(11066);
        closure_2 = first(11066).purchaseErrorListener((arg0) => {
          callback(undefined);
          callback2(arg0);
        });
        const obj3 = first(11066);
        closure_3 = first(11066).promotedProductListener(first1(function*() {
          if (c3 === 2) {
            c3 = 3;
            HermesBuiltin.throwTypeError();
          } else if (tmp4 === 3) {
