...
// Function ID: 4713
// Name: baseClone
// Dependencies: [521, 514, 4713, 4714, 634, 536, 4715, 4716, 4719, 4723, 4727, 4728, 4729, 639, 4735, 4737, 4739, 656, 4724, 531, 515, 4721]

// Module 4712 (baseClone)
import assignValue from "assignValue" /* 4721 */;
  ...
  if (!fn) {
    {
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4713)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4714)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4715)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4729)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4716)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4719)(arr, tmp32(4723)(obj2, arr));
                  const tmp32Result = tmp32(4719);
                } else {
                  tmp32ResultResult = tmp32(4727)(arr, tmp32(4728)(obj2, arr));
                  const tmp32Result3 = tmp32(4727);
                }
