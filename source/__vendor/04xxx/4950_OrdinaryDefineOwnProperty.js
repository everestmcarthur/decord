...
// Dependencies: [4887, 1282, 4934, 4938, 1283, 4951, 1303, 4943, 4939, 4952, 4953]
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4887(arg0)) {
    if (tmp(4934)(arg1)) {
      if (tmp(4938)(__Writable__)) {
        if (tmp(1283)) {
          const tmp30 = tmp(1283)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4939)(tmp30);
          }
          return tmp(4953)(arg0, arg1, tmp(4952)(arg0), __Writable__, tmp31);
        } else if (tmp(4951)(__Writable__)) {
          ...
          return tmp(4943)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
