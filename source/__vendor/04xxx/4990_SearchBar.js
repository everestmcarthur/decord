...
// Function ID: 4991
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 4991, 4983]
// Exports: default

// Module 4990 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(4991).Commands;
  ...
  if (ref1(4983).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(4983).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(4983);
    obj.hideNavigationBar = tmp3(4983).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
