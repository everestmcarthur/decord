...
// Dependencies: [4342, 4346]
// Exports: installWorkletsSupport

// Module 4341 (installWorkletsSupport)
...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4346.NitroModules;
    const boxResult = NitroModules.box(_mod4346.NitroModules);
    require = boxResult;
