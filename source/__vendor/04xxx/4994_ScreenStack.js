...
// Function ID: 4995
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4995, 4996, 4997]
// Exports: default

// Module 4994 (ScreenStack)
import _modDef4995 from "module_4995" /* 4995 */;
import _mod4996 from "module_4996" /* 4996 */;
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_mod4996.GHContext);
  ...
  _modDef4995("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef4995(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod4996.RNSScreensRefContext.Provider, { value: ref, children: null });
};
