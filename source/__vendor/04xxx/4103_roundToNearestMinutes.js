...
// Dependencies: [3695, 3699, 3889]
// Exports: default

// Module 4103 (roundToNearestMinutes)
...
export default function roundToNearestMinutes(arg0, nearestTo) {
  if (arguments.length < 1) {
    ...
    const defaultResult = module_3699.default(num);
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = _mod3889.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
