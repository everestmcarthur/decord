...
// Function ID: 4714
// Name: baseClone
// Dependencies: [521, 514, 4714, 4715, 634, 536, 4716, 4717, 4720, 4724, 4728, 4729, 4730, 639, 4736, 4738, 4740, 656, 4725, 531, 515, 4722]

// Module 4713 (baseClone)
import assignValue from "assignValue" /* 4722 */;
  ...
  if (!fn) {
    {
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4714)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4715)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4716)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4730)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4717)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4720)(arr, tmp32(4724)(obj2, arr));
                  const tmp32Result = tmp32(4720);
                } else {
                  tmp32ResultResult = tmp32(4728)(arr, tmp32(4729)(obj2, arr));
                  const tmp32Result3 = tmp32(4728);
                }
