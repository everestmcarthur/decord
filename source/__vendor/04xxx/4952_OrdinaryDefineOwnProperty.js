...
// Dependencies: [4889, 1282, 4936, 4940, 1283, 4953, 1303, 4945, 4941, 4954, 4955]
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4889(arg0)) {
    if (tmp(4936)(arg1)) {
      if (tmp(4940)(__Writable__)) {
        if (tmp(1283)) {
          const tmp30 = tmp(1283)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4941)(tmp30);
          }
          return tmp(4955)(arg0, arg1, tmp(4954)(arg0), __Writable__, tmp31);
        } else if (tmp(4953)(__Writable__)) {
          ...
          return tmp(4945)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
