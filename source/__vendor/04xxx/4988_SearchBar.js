...
// Function ID: 4989
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 4989, 4981]
// Exports: default

// Module 4988 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(4989).Commands;
  ...
  if (ref1(4981).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(4981).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(4981);
    obj.hideNavigationBar = tmp3(4981).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
