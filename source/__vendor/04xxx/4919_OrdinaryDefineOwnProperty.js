...
// Dependencies: [4856, 1283, 4903, 4907, 1284, 4920, 1304, 4912, 4908, 4921, 4922]

// Module 4919 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4856(arg0)) {
    if (tmp(4903)(arg1)) {
      if (tmp(4907)(__Writable__)) {
        if (tmp(1284)) {
          const tmp30 = tmp(1284)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4908)(tmp30);
          }
          return tmp(4922)(arg0, arg1, tmp(4921)(arg0), __Writable__, tmp31);
        } else if (tmp(4920)(__Writable__)) {
          ...
          return tmp(4912)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
