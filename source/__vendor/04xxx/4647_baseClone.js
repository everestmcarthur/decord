...
// Function ID: 4648
// Name: baseClone
// Dependencies: [521, 514, 4648, 4649, 634, 536, 4650, 4651, 4654, 4658, 4662, 4663, 4664, 639, 4670, 4672, 4674, 656, 4659, 531, 515, 4656]

// Module 4647 (baseClone)
import assignValue from "assignValue" /* 4656 */;
  ...
  if (!fn) {
    {
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4648)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4649)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4650)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4664)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4651)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4654)(arr, tmp32(4658)(obj2, arr));
                  const tmp32Result = tmp32(4654);
                } else {
                  tmp32ResultResult = tmp32(4662)(arr, tmp32(4663)(obj2, arr));
                  const tmp32Result3 = tmp32(4662);
                }
