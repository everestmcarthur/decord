...
// Dependencies: [4340, 4344]
// Exports: installWorkletsSupport

// Module 4339 (installWorkletsSupport)
import reactNativeWorkletsCompat from "reactNativeWorkletsCompat" /* 4340 */;
import _mod4344 from "module_4344" /* 4344 */;
...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4344.NitroModules;
    const boxResult = NitroModules.box(_mod4344.NitroModules);
    require = boxResult;
