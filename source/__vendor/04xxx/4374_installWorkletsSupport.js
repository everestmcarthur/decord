...
// Dependencies: [4375, 4379]
// Exports: installWorkletsSupport

// Module 4374 (installWorkletsSupport)
...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4379.NitroModules;
    const boxResult = NitroModules.box(_mod4379.NitroModules);
    require = boxResult;
