...
// Dependencies: [4373, 4377]
// Exports: installWorkletsSupport

// Module 4372 (installWorkletsSupport)
...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4377.NitroModules;
    const boxResult = NitroModules.box(_mod4377.NitroModules);
    require = boxResult;
