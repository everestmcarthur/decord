...
// Dependencies: [4855, 1283, 4902, 4906, 1284, 4919, 1304, 4911, 4907, 4920, 4921]

// Module 4918 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4855(arg0)) {
    if (tmp(4902)(arg1)) {
      if (tmp(4906)(__Writable__)) {
        if (tmp(1284)) {
          const tmp30 = tmp(1284)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4907)(tmp30);
          }
          return tmp(4921)(arg0, arg1, tmp(4920)(arg0), __Writable__, tmp31);
        } else if (tmp(4919)(__Writable__)) {
          ...
          return tmp(4911)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
