...
// Dependencies: [3693, 3697, 3887]
// Exports: default

// Module 4101 (roundToNearestMinutes)
...
export default function roundToNearestMinutes(arg0, nearestTo) {
  if (arguments.length < 1) {
    ...
    const defaultResult = module_3697.default(num);
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = _mod3887.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
