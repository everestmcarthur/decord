...
// Dependencies: [3663, 3667, 3857]
// Exports: default

// Module 4071 (roundToNearestMinutes)
...
export default function roundToNearestMinutes(arg0, nearestTo) {
  if (arguments.length < 1) {
    ...
    const defaultResult = module_3667.default(num);
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = _mod3857.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
