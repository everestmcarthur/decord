...
// Function ID: 4679
// Name: baseClone
// Dependencies: [521, 514, 4679, 4680, 634, 536, 4681, 4682, 4685, 4689, 4693, 4694, 4695, 639, 4701, 4703, 4705, 656, 4690, 531, 515, 4687]

// Module 4678 (baseClone)
import assignValue from "assignValue" /* 4687 */;
  ...
  if (!fn) {
    {
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4679)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4680)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4681)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4695)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4682)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4685)(arr, tmp32(4689)(obj2, arr));
                  const tmp32Result = tmp32(4685);
                } else {
                  tmp32ResultResult = tmp32(4693)(arr, tmp32(4694)(obj2, arr));
                  const tmp32Result3 = tmp32(4693);
                }
