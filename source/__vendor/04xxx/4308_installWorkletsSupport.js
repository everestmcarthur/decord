...
// Dependencies: [4309, 4313]
// Exports: installWorkletsSupport

// Module 4308 (installWorkletsSupport)
import reactNativeWorkletsCompat from "reactNativeWorkletsCompat" /* 4309 */;
import _mod4313 from "module_4313" /* 4313 */;
...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4313.NitroModules;
    const boxResult = NitroModules.box(_mod4313.NitroModules);
    require = boxResult;
