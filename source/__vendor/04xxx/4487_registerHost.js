...
// Function ID: 4488
// Name: registerHost
// Dependencies: [4488, 4483]

// Module 4487 (registerHost)
import ACTIONS from "ACTIONS" /* 4483 */;
import print from "print" /* 4488 */;
...
function reducer(arg0, type) {
  ...
  if (ACTIONS.ACTIONS.REGISTER_HOST === type) {
  ...
  } else if (tmp4(4483).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4483).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4483).ACTIONS.REMOVE_PORTAL === type) {
