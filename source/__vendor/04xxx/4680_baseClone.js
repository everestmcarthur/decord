...
// Function ID: 4681
// Name: baseClone
// Dependencies: [521, 514, 4681, 4682, 634, 536, 4683, 4684, 4687, 4691, 4695, 4696, 4697, 639, 4703, 4705, 4707, 656, 4692, 531, 515, 4689]

// Module 4680 (baseClone)
import assignValue from "assignValue" /* 4689 */;
  ...
  if (!fn) {
    {
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4681)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4682)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4683)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4697)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4684)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4687)(arr, tmp32(4691)(obj2, arr));
                  const tmp32Result = tmp32(4687);
                } else {
                  tmp32ResultResult = tmp32(4695)(arr, tmp32(4696)(obj2, arr));
                  const tmp32Result3 = tmp32(4695);
                }
