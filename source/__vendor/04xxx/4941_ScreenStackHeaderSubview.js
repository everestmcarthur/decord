...
// Dependencies: [109, 19, 17, 21, 4942, 4938, 4943, 4944, 4939, 4945]
...
// Module 4941 (ScreenStackHeaderSubview)
...
const forwardRefResult = noop.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  const edgeInsetApplication = _mod4942.useEdgeInsetApplication(flag, flag2, flag3);
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4938).isHeaderBarButtonsAvailableForCurrentPlatform) {
      result = tmp(4943).prepareHeaderBarButtonItems(headerLeftBarButtonItems, "left");
  ...
  if (headerRightBarButtonItems) {
    if (tmp(4938).isHeaderBarButtonsAvailableForCurrentPlatform) {
      result1 = tmp(4943).prepareHeaderBarButtonItems(headerRightBarButtonItems, "right");
      const tmpResult2 = tmp(4943);
    }
  }
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4938).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj2.userInterfaceStyle = disableLeftInsetApplication.experimental_userInterfaceStyle;
  ...
  obj2.synchronousShadowStateUpdatesEnabled = get_controlledBottomTabsDefault.experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(_modDef4944, {});
});
...
export const ScreenStackHeaderSubview = _modDef4945;
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  return jsx(_modDef4945, { type: "back", style: closure_9.headerSubview, synchronousShadowStateUpdatesEnabled: get_controlledBottomTabsDefault.experiment.synchronousHeaderSubviewUpdatesEnabled, children: null });
};
