...
// Function ID: 4796
// Name: baseClone
// Dependencies: [521, 514, 4796, 4797, 634, 536, 4798, 4799, 4802, 4806, 4810, 4811, 4812, 639, 4818, 4820, 4822, 656, 4807, 531, 515, 4804]

// Module 4795 (baseClone)
import assignValue from "assignValue" /* 4804 */;
  ...
  if (!fn) {
    {
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4796)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4797)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4798)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4812)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4799)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4802)(arr, tmp32(4806)(obj2, arr));
                  const tmp32Result = tmp32(4802);
                } else {
                  tmp32ResultResult = tmp32(4810)(arr, tmp32(4811)(obj2, arr));
                  const tmp32Result3 = tmp32(4810);
                }
