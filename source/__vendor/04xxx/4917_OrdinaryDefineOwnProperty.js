...
// Dependencies: [4854, 1283, 4901, 4905, 1284, 4918, 1304, 4910, 4906, 4919, 4920]

// Module 4917 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4854(arg0)) {
    if (tmp(4901)(arg1)) {
      if (tmp(4905)(__Writable__)) {
        if (tmp(1284)) {
          const tmp30 = tmp(1284)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4906)(tmp30);
          }
          return tmp(4920)(arg0, arg1, tmp(4919)(arg0), __Writable__, tmp31);
        } else if (tmp(4918)(__Writable__)) {
          ...
          return tmp(4910)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
