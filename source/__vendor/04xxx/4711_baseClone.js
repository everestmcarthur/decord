...
// Function ID: 4712
// Name: baseClone
// Dependencies: [521, 514, 4712, 4713, 634, 536, 4714, 4715, 4718, 4722, 4726, 4727, 4728, 639, 4734, 4736, 4738, 656, 4723, 531, 515, 4720]

// Module 4711 (baseClone)
import assignValue from "assignValue" /* 4720 */;
  ...
  if (!fn) {
    {
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4712)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4713)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4714)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4728)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4715)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4718)(arr, tmp32(4722)(obj2, arr));
                  const tmp32Result = tmp32(4718);
                } else {
                  tmp32ResultResult = tmp32(4726)(arr, tmp32(4727)(obj2, arr));
                  const tmp32Result3 = tmp32(4726);
                }
