...
// Function ID: 4680
// Name: baseClone
// Dependencies: [521, 514, 4680, 4681, 634, 536, 4682, 4683, 4686, 4690, 4694, 4695, 4696, 639, 4702, 4704, 4706, 656, 4691, 531, 515, 4688]

// Module 4679 (baseClone)
import assignValue from "assignValue" /* 4688 */;
  ...
  if (!fn) {
    {
      if (require("module_521")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4680)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4681)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4682)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4696)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp12) {
                let obj2 = tmp32(4683)(arr);
              }
              closure_4 = obj2;
              tmp14 = obj2;
              if (!tmp) {
                if (tmp2) {
                  let tmp32ResultResult = tmp32(4686)(arr, tmp32(4690)(obj2, arr));
                  const tmp32Result = tmp32(4686);
                } else {
                  tmp32ResultResult = tmp32(4694)(arr, tmp32(4695)(obj2, arr));
                  const tmp32Result3 = tmp32(4694);
                }
