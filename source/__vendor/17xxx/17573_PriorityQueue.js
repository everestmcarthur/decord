...
// Function ID: 17574
// Name: PriorityQueue
// Dependencies: [41, 42, 17574]

// Module 17573 (PriorityQueue)
...
const entry = {
  ...
  value: function enqueue(run, arg1) {
    ...
    _queue1.splice(PriorityQueue(17574).default(self._queue, obj, (priority, priority2) => priority2.priority - priority.priority), 0, obj);
  }
};
const items = [
  entry,
