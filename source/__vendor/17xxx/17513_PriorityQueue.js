...
// Function ID: 17514
// Name: PriorityQueue
// Dependencies: [41, 42, 17514]

// Module 17513 (PriorityQueue)
...
const entry = {
  ...
  value: function enqueue(run, arg1) {
    ...
    _queue1.splice(PriorityQueue(17514).default(self._queue, obj, (priority, priority2) => priority2.priority - priority.priority), 0, obj);
  }
};
const items = [
  entry,
