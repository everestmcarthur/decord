...
// Function ID: 17630
// Name: PriorityQueue
// Dependencies: [41, 42, 17630]

// Module 17629 (PriorityQueue)
...
const entry = {
  ...
  value: function enqueue(run, arg1) {
    ...
    _queue1.splice(PriorityQueue(17630).default(self._queue, obj, (priority, priority2) => priority2.priority - priority.priority), 0, obj);
  }
};
const items = [
  entry,
