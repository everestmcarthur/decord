...
// Module 834 (addPrivateRequestAttributes)
...
import handleResponseError from "handleResponseError" /* 835 */;
...
function addPrivateRequestAttributes(setAttributes, prompt) {
  ...
  if ("prompt" in prompt) {
    obj = {};
    const _JSON = JSON;
    obj[_mod823.GEN_AI_PROMPT_ATTRIBUTE] = JSON.stringify(prompt.prompt);
                        ...
                        if (!BooleanResult) {
                          if (!tmp12) {
                            ...
                            return tmp2Result.startSpan(obj, (setAttributes) => {
                              ...
                              return str(dependencyMap[9]).handleCallbackErrors(() => { ... }, () => { ... }, /* F120274 */ function() { ... }, () => { ... });
                            });
                          }
                        }
                        dependencyMap = closure_0;
                            ...
                            if (arg2.length > 0) {
                              if (typeof arg2[0] === "object") {
                                ...
                                if (BooleanResult) {
                                  if (!tmp12) {
                                    closure_0 = undefined;
                                    closure_0 = _self(/* F124441 */ function() { ... });
