...
// Module 838 (addPrivateRequestAttributes)
...
function addPrivateRequestAttributes(setAttributes, config) {
  ...
  if (tmp33) {
    obj = {};
    obj[_mod823.GEN_AI_REQUEST_MESSAGES_ORIGINAL_LENGTH_ATTRIBUTE] = items.length;
    const _JSON = JSON;
    obj[_mod823.GEN_AI_REQUEST_MESSAGES_ATTRIBUTE] = JSON.stringify(truncateTextByBytes.truncateGenAiMessages(items));
                        ...
                        if (methodPath === tmp(tmp2[2]).CHATS_CREATE_METHOD) {
                          ...
                          obj[0] = function apply(closure_0) {
                            ...
                            if (isStreamingMethodResult) {
                              ...
                              obj1[2] = obj;
                              closure_0 = undefined;
                              closure_0 = callback(/* F120269 */ function() { ... });
                    ...
                    obj[0] = function apply(closure_0) {
                      ...
                      if (isStreamingMethodResult) {
                        ...
                        startSpanManualResult = tmp4Result1.startSpan(obj2, (arg0) => {
                          ...
                          return str(table[11]).handleCallbackErrors(() => { ... }, () => { ... }, /* F120273 */ function() { ... }, () => { ... });
                        });
                        const tmp4Result3 = tmp4(tmp5[3]);
                      }
                      return startSpanManualResult;
