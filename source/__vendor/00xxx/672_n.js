...
let fn = function n() {
  ...
  function hsl2css_1(arg0, arg1) {
    ...
    if (items.length >= 2) {
      ...
      str = formatted;
      const tmp7 = f107636;
      tmp9 = f107636[typeof call === "unknown" ? toString(items[diff1]) : call(toString, items[diff1])] || "object";
    }
    if (!str) {
      str = "lsa";
    }
  ...
  autodetect1.push({
    ...
    test(arg0) {
      ...
      if (!items.length) {
        ...
        const tmp6 = f107636;
        tmp8 = f107636[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
      }
    }
  });
  obj.format.gl = () => {
  ...
  function rgb2hex_1(_rgb, rgb) {
    ...
    if (items.length >= 2) {
      ...
      str = formatted;
      const tmp11 = f107636;
      tmp13 = f107636[typeof call === "unknown" ? toString(items[diff1]) : call(toString, items[diff1])] || "object";
    }
    if (!str) {
      str = "auto";
    }
  ...
  autodetect9.push({
    ...
    test() {
      ...
      if (1 === items.length) {
        ...
        const tmp6 = f107636;
        tmp8 = f107636[typeof call === "unknown" ? toString(first) : call(toString, first)] || "object";
      }
    }
  });
  round = Math.round;
  ...
  function mix$1(arg0, arg1, arg2) {
    ...
    if (obj15[first]) {
      ...
      const call2 = toString2.call;
      tmp13 = type$p;
      tmp17 = f107636[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
      let obj2 = arg1;
      if ("object" !== tmp21) {
        obj2 = Color(arg1);
      }
      tmp21 = f107636[typeof call2 === "unknown" ? toString2(arg1) : call2(toString2, arg1)] || "object";
  ...
  f107636 = (arg0, arg1) => {
    const items = [f107636(arg0[0], arg1[0]), f107636(arg0[1], arg1[1]), f107636(arg0[2], arg1[2])];
    return items;
  };
  blend.normal = (arg0, arg1) => {
    obj = chroma$k(arg1);
    const rgbResult = chroma$k(arg1).rgb();
    return chroma$k.rgb(f107636(rgbResult, chroma$k(arg0).rgb()));
  };
  f107636 = (arg0, arg1) => {
    const items = [f107636(arg0[0], arg1[0]), f107636(arg0[1], arg1[1]), f107636(arg0[2], arg1[2])];
    return items;
  ...
  function limits(analyzeResult, arg1, arg2) {
    ...
    const tmp = f107636;
    tmp2 = f107636[typeof call === "unknown" ? toString(analyzeResult) : call(toString, analyzeResult)] || "object";
  }
  sqrt = Math.sqrt;
  pow = Math.pow;
  min = Math.min;
