...
let fn = function n() {
  ...
  function hsl2css_1(arg0, arg1) {
    ...
    if (items.length >= 2) {
      ...
      str = formatted;
      const tmp7 = f107630;
      tmp9 = f107630[typeof call === "unknown" ? toString(items[diff1]) : call(toString, items[diff1])] || "object";
    }
    if (!str) {
      str = "lsa";
    }
  ...
  function rgb2hex_1(_rgb, rgb) {
    ...
    if (items.length >= 2) {
      ...
      str = formatted;
      const tmp11 = f107630;
      tmp13 = f107630[typeof call === "unknown" ? toString(items[diff1]) : call(toString, items[diff1])] || "object";
    }
    if (!str) {
      str = "auto";
    }
  ...
  function mix$1(arg0, arg1, arg2) {
    ...
    if (obj15[first]) {
      ...
      tmp21 = f107630[typeof call2 === "unknown" ? toString2(arg1) : call2(toString2, arg1)] || "object";
  ...
  blend.normal = (arg0, arg1) => {
    ...
    return chroma$k.rgb(f107630(rgbResult, chroma$k(arg0).rgb()));
  };
  f107630 = (arg0, arg1) => {
    const items = [f107630(arg0[0], arg1[0]), f107630(arg0[1], arg1[1]), f107630(arg0[2], arg1[2])];
    return items;
  ...
  function limits(analyzeResult, arg1, arg2) {
    ...
    const tmp = f107630;
    tmp2 = f107630[typeof call === "unknown" ? toString(analyzeResult) : call(toString, analyzeResult)] || "object";
  }
  sqrt = Math.sqrt;
  pow = Math.pow;
  min = Math.min;
