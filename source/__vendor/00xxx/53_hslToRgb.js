...
export default function normalizeColor(num) {
  if (typeof num === "number") {
    ...
    let tmp65 = obj;
    if (undefined === obj) {
      const tmp67 = call("[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+");
      const tmp69 = commaSeparatedCall("[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+");
      const _HermesInternal = HermesInternal;
      const combined = tmp67 + "|" + tmp69 + "|" + callWithSlashSeparator("[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+");
      ...
      const regExp3 = new RegExp("hsla(" + tmp87 + "|" + callWithSlashSeparator("[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+%", "[-+]?\\d*\\.?\\d+%", "[-+]?\\d*\\.?\\d+") + ")");
      obj.hsla = regExp3;
      const _RegExp5 = RegExp;
      const tmp94 = callModern("[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+%", "[-+]?\\d*\\.?\\d+%");
      const _HermesInternal5 = HermesInternal;
      const regExp4 = new RegExp("hwb(" + tmp94 + "|" + callWithSlashSeparator("[-+]?\\d*\\.?\\d+", "[-+]?\\d*\\.?\\d+%", "[-+]?\\d*\\.?\\d+%", "[-+]?\\d*\\.?\\d+") + ")");
      obj.hwb = regExp4;
      ...
      switch (num) {
        case "transparent":
          ...
          if (null != tmp2) {
            ...
            if (!num) {
              const hex3 = tmp65.hex3;
              const match1 = hex3.exec(num);
              if (match1) {
                const _parseInt3 = parseInt;
                let tmp8 = parseInt(match1[1] + match1[1] + match1[2] + match1[2] + match1[3] + match1[3] + "ff", 16) >>> 0;
              } else {
                const hex8 = tmp65.hex8;
                const match2 = hex8.exec(num);
                if (match2) {
                  const _parseInt2 = parseInt;
                  tmp8 = parseInt(match2[1], 16) >>> 0;
                } else {
                  const hex4 = tmp65.hex4;
                  const match3 = hex4.exec(num);
                  if (match3) {
                    const _parseInt = parseInt;
                    tmp8 = parseInt(match3[1] + match3[1] + match3[2] + match3[2] + match3[3] + match3[3] + match3[4] + match3[4], 16) >>> 0;
                  } else {
                    const hsl = tmp65.hsl;
                    ...
                    if (match4) {
                      ...
                      tmp8 = (255 | hslToRgb((result + 360) % 360 / 360, num45, num48)) >>> 0;
                    } else {
                      const hsla = tmp65.hsla;
                      ...
                      if (num2) {
                        if (undefined !== num2[6]) {
                          ...
                          let tmp22 = (hslToRgb((result1 + 360) % 360 / 360, num34, num37) | num2) >>> 0;
                          const tmp23Result = hslToRgb((result1 + 360) % 360 / 360, num34, num37);
                        } else {
                          const _parseFloat19 = parseFloat;
                          const _parseFloat20 = parseFloat;
                          const result2 = parseFloat(num2[2]) % 360;
                          const parsed5 = parseFloat(num2[3]);
                          let num24 = 0;
                          if (parsed5 >= 0) {
                            let num23 = 1;
                            if (parsed5 <= 100) {
                          ...
                          const parsed6 = parseFloat(num2[4]);
                          let num25 = 0;
                          if (parsed6 >= 0) {
                            let num27 = 1;
                            if (parsed6 <= 100) {
                          ...
                          const parsed7 = parseFloat(num2[5]);
                          let num28 = 0;
                          if (parsed7 >= 0) {
                            let num31 = 255;
                            if (parsed7 <= 1) {
                              const _Math2 = Math;
                              num31 = Math.round(255 * parsed7);
                            }
                            num28 = num31;
                          }
                          tmp22 = (hslToRgb((result2 + 360) % 360 / 360, num24, num25) | num28) >>> 0;
                          const tmp104Result = hslToRgb((result2 + 360) % 360 / 360, num24, num25);
                        }
                      } else {
                        const hwb = tmp65.hwb;
                        ...
                        if (num3) {
                          if (undefined !== num3[5]) {
                            ...
                            const parsed8 = parseFloat(num3[6]);
                            let num13 = 0;
                            if (parsed8 >= 0) {
                              let num15 = 1;
                              if (parsed8 <= 100) {
                            ...
                            const parsed9 = parseFloat(num3[7]);
                            let num16 = 0;
                            if (parsed9 >= 0) {
                              let num18 = 1;
                              if (parsed9 <= 100) {
                            ...
                            const parsed10 = parseFloat(num3[8]);
                            num3 = 0;
                            if (parsed10 >= 0) {
                              let num21 = 255;
                              if (parsed10 <= 1) {
                                const _Math = Math;
                                num21 = Math.round(255 * parsed10);
                              }
                              num3 = num21;
                            }
                            let tmp10 = (hwbToRgb((result3 + 360) % 360 / 360, num13, num16) | num3) >>> 0;
                            const tmp11Result = hwbToRgb((result3 + 360) % 360 / 360, num13, num16);
                          } else {
                            const _parseFloat17 = parseFloat;
                            const _parseFloat18 = parseFloat;
                            const result4 = parseFloat(num3[2]) % 360;
                            const parsed11 = parseFloat(num3[3]);
                            let num6 = 0;
                            if (parsed11 >= 0) {
                              let num5 = 1;
                              if (parsed11 <= 100) {
                            ...
                            const parsed12 = parseFloat(num3[4]);
                            let num7 = 0;
                            if (parsed12 >= 0) {
                              let num9 = 1;
                              if (parsed12 <= 100) {
                            ...
                            tmp10 = (255 | hwbToRgb((result4 + 360) % 360 / 360, num6, num7)) >>> 0;
                          }
                        }
                      }
                    }
            ...
            if (undefined !== num[9]) {
              ...
              const parsed13 = parseInt(num[9], 10);
              let num85 = 0;
              if (parsed13 >= 0) {
                let num86 = 255;
                if (parsed13 <= 255) {
              ...
              const parsed14 = parseInt(num[10], 10);
              let num88 = 0;
              if (parsed14 >= 0) {
                let num89 = 255;
                if (parsed14 <= 255) {
              ...
              const parsed15 = parseInt(num[11], 10);
              let num91 = 0;
              if (parsed15 >= 0) {
                let num92 = 255;
                if (parsed15 <= 255) {
              ...
              const parsed16 = parseFloat(num[12]);
              num = 0;
              if (parsed16 >= 0) {
                let num96 = 255;
                if (parsed16 <= 1) {
                  const _Math5 = Math;
                  num96 = Math.round(255 * parsed16);
                }
                num = num96;
              }
              let tmp43 = (num85 << 24 | num88 << 16 | num91 << 8 | num) >>> 0;
              const tmp54 = num85 << 24;
              const tmp56 = num88 << 16;
              const tmp58 = num91 << 8;
            } else if (undefined !== num[5]) {
              const _parseInt6 = parseInt;
              const parsed17 = parseInt(num[5], 10);
              let num70 = 0;
              if (parsed17 >= 0) {
                let num71 = 255;
                if (parsed17 <= 255) {
              ...
              const parsed18 = parseInt(num[6], 10);
              let num73 = 0;
              if (parsed18 >= 0) {
                let num74 = 255;
                if (parsed18 <= 255) {
              ...
              const parsed19 = parseInt(num[7], 10);
              let num76 = 0;
              if (parsed19 >= 0) {
                let num77 = 255;
                if (parsed19 <= 255) {
              ...
              const parsed20 = parseFloat(num[8]);
              let num79 = 0;
              if (parsed20 >= 0) {
                let num82 = 255;
                if (parsed20 <= 1) {
                  const _Math4 = Math;
                  num82 = Math.round(255 * parsed20);
                }
                num79 = num82;
              }
              tmp43 = (num70 << 24 | num73 << 16 | num76 << 8 | num79) >>> 0;
              const tmp46 = num70 << 24;
              const tmp48 = num73 << 16;
              const tmp50 = num76 << 8;
            } else {
              const _parseInt13 = parseInt;
              const parsed21 = parseInt(num[2], 10);
              let num59 = 0;
              if (parsed21 >= 0) {
                let num58 = 255;
                if (parsed21 <= 255) {
              ...
              const parsed22 = parseInt(num[3], 10);
              let num61 = 0;
              if (parsed22 >= 0) {
                let num62 = 255;
                if (parsed22 <= 255) {
              ...
              const parsed23 = parseInt(num[4], 10);
              let num64 = 0;
              if (parsed23 >= 0) {
                let num65 = 255;
                if (parsed23 <= 255) {
              ...
              tmp43 = (num59 << 24 | num61 << 16 | num64 << 8 | 255) >>> 0;
              const tmp39 = num59 << 24;
              const tmp41 = num61 << 16;
            }
          }
        break;
        case "aliceblue":
