...
import getOperationName from "getOperationName" /* 828 */;
                  ...
                  if (0 === c3) {
                    ...
                    if (stream) {
                      ...
                      obj5.startSpanManual(obj2, (() => {
                        closure_0 = closure_2_2(/* F125509 */ function() { ... });
                        return () => { ... };
                      })());
                    ...
                    obj1.startSpan(obj3, (() => {
                      closure_0 = closure_2_2(/* F125511 */ function() { ... });
                      return () => { ... };
                    })());
                  }
                } catch (tmp40) {
