...
function y$1(span, arg1, formTitle) {
  ...
  const element = { type: span, props: obj, key: tmp5, ref: tmp4, __k: null, __: null, __b: 0, __e: null, __d: "Array", __c: "Array", constructor: -1, __v: 0, __i: "OPACITY_BLURPLE_40", __u: 0.4 };
  const sum = sum2 + 1;
  sum2 = sum;
  element.__v = sum;
  if (null != obj.vnode) {
      ...
      if (null != vnodeResult2) {
        ...
        if (typeof vnodeResult2 !== "boolean") {
          ...
          if (typeof vnodeResult2 !== "function") {
                ...
                if (typeof vnodeResult2 !== "bigint") {
                  ...
                  if (vnodeResult2.constructor != String) {
                    if (isArray(vnodeResult2)) {
                      ...
                      let element = { type: g$1, props: obj, key: null, ref: null, __k: null, __: null, __b: 0, __e: null, __d: "Array", __c: "Array", constructor: -1, __v: 0, __i: "OPACITY_BLURPLE_40", __u: 0.4 };
                      let sum = sum2 + 1;
                      sum2 = sum;
                      element.__v = sum;
                      let obj4 = obj;
                      ...
                      if (vnodeResult2.__b > 0) {
                        ...
                        let element1 = { type: type2, props, key: key2, ref, __k: null, __: null, __b: 0, __e: null, __d: "Array", __c: "Array", constructor: -1, __v: 0, __i: "OPACITY_BLURPLE_40", __u: 0.4 };
                        let tmp10 = __v;
                        if (null == __v) {
                          let sum1 = sum2 + 1;
                          sum2 = sum1;
            ...
            let element2 = { type: null, props: vnodeResult2, key: null, ref: null, __k: null, __: null, __b: 0, __e: null, __d: "Array", __c: "Array", constructor: -1, __v: 0, __i: "OPACITY_BLURPLE_40", __u: 0.4 };
...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f109378, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f72309, items);
  f109378 = screenshotInput(function*(arg0, value) {
    if (c6 === 2) {
      c6 = 3;
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (3 === tmp8) {
            ...
            if (messageLabel) {
              const debug = f109378(onSubmitSuccess[2]).debug;
  ...
  f109378 = function(arg0) {
    const self = this;
    const apply = f109378.apply;
  ...
  obj = { class: "form", onSubmit: tmp13(() => f72309, items1) };
...
function Dialog(onFormSubmitted) {
  ...
  const tmp2 = fn2(() => {
    obj = { __html: null };
    const _document = f72309(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document2 = f72309(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document3 = f72309(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document4 = f72309(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document5 = f72309(merged[2]).GLOBAL_OBJ.document;
    const elementNS4 = _document5.createElementNS("http://www.w3.org/2000/svg", "defs");
    const _document6 = f72309(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document7 = f72309(merged[2]).GLOBAL_OBJ.document;
