...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f108276, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f71607, items);
  f108276 = screenshotInput(function*(arg0, value) {
    if (c6 === 2) {
      c6 = 3;
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (3 === tmp8) {
            ...
            if (messageLabel) {
              const debug = f108276(onSubmitSuccess[2]).debug;
  ...
  f108276 = function(arg0) {
    const self = this;
    const apply = f108276.apply;
  ...
  obj = { class: "form", onSubmit: tmp13(() => f71607, items1) };
...
function Dialog(onFormSubmitted) {
  ...
  const tmp2 = fn2(() => {
    obj = { __html: null };
    const _document = f71607(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document2 = f71607(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document3 = f71607(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document4 = f71607(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document5 = f71607(merged[2]).GLOBAL_OBJ.document;
    const elementNS4 = _document5.createElementNS("http://www.w3.org/2000/svg", "defs");
    const _document6 = f71607(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document7 = f71607(merged[2]).GLOBAL_OBJ.document;
