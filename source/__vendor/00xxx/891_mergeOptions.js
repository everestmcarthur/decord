...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f107846, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f71280, items);
  f107846 = undefined;
  f107846 = screenshotInput((arg0) => {
    closure_0 = arg0;
    c5 = 0;
    c6 = 0;
    closure_4 = 0;
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (3 === tmp8) {
              ...
              closure_4 = closure_3;
              if (messageLabel) {
                const debug = f107846(onSubmitSuccess[2]).debug;
  ...
  f107846 = function(arg0) {
    const self = this;
    const apply = f107846.apply;
  ...
  c46 = 8;
  obj = { class: "form", onSubmit: tmp13(() => f71280, items1) };
