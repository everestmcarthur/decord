...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f108566, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f71803, items);
  f108566 = screenshotInput(function*(arg0, value) {
    if (c6 === 2) {
      c6 = 3;
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (3 === tmp8) {
            ...
            if (messageLabel) {
              const debug = f108566(onSubmitSuccess[2]).debug;
  ...
  f108566 = function(arg0) {
    const self = this;
    const apply = f108566.apply;
  ...
  obj = { class: "form", onSubmit: tmp13(() => f71803, items1) };
...
function Dialog(onFormSubmitted) {
  ...
  const tmp2 = fn2(() => {
    obj = { __html: null };
    const _document = f71803(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document2 = f71803(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document3 = f71803(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document4 = f71803(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document5 = f71803(merged[2]).GLOBAL_OBJ.document;
    const elementNS4 = _document5.createElementNS("http://www.w3.org/2000/svg", "defs");
    const _document6 = f71803(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document7 = f71803(merged[2]).GLOBAL_OBJ.document;
