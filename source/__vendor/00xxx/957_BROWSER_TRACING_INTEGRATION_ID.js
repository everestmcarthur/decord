...
export const startBrowserTracingPageLoadSpan = function startBrowserTracingPageLoadSpan(f108615, tmp2Result, arg2) {
  f108615.emit("startPageLoadSpan", tmp2Result, arg2);
  const currentScope = _mod682.getCurrentScope();
  currentScope.setTransactionName(tmp2Result.name);
  if (f108615[_sentry_idleSpan]) {
    f108615.emit("afterStartPageLoadSpan", tmp3);
  }
  return f108615[_sentry_idleSpan];
};
