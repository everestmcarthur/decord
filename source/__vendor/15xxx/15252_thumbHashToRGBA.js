...
function thumbHashToRGBA(arg0) {
  ...
  do {
    ...
    if (num10 * 3 < result5) {
      do {
        let sum2 = tmp26 + 1;
        let arr2 = items1.push(((arg0[num4 + (tmp26 >> 1)] >> ((1 & tmp26) << 2) & 15) / 7.5 - 1) * tmp22);
        let sum3 = num10 + 1;
        tmp26 = sum2;
        num10 = sum3;
        tmp27 = sum2;
  ...
  do {
    ...
    if (num12 * 3 < result7) {
      do {
        let sum4 = tmp36 + 1;
        let arr3 = items2.push(((arg0[num4 + (tmp36 >> 1)] >> ((1 & tmp36) << 2) & 15) / 7.5 - 1) * tmp32);
        let sum5 = num12 + 1;
        tmp36 = sum4;
        num12 = sum5;
        tmp37 = sum4;
  ...
  if (tmp7) {
    ...
    do {
      ...
      if (num14 * 5 < result9) {
        do {
          let sum6 = tmp46 + 1;
          let arr4 = items3.push(((arg0[num4 + (tmp46 >> 1)] >> ((1 & tmp46) << 2) & 15) / 7.5 - 1) * result2);
          let sum7 = num14 + 1;
          tmp46 = sum6;
          num14 = sum7;
          tmp47 = sum6;
        ...
        do {
          ...
          if (tmp7) {
            do {
              ...
              if (num34 < diff3) {
                do {
                  sum14 = sum14 + tmp42[sum15] * items4[num34] * tmp102;
                  num34 = num34 + 1;
                  sum15 = sum15 + 1;
                  tmp106 = sum15;
                  tmp107 = sum14;
          ...
          let diff4 = tmp70 - 0.6666666666666666 * tmp95;
          let result15 = (3 * tmp70 - diff4 + tmp94) / 2;
          rgba[sum16] = max(0, 255 * min(1, result15));
          rgba[sum16 + 1] = max(0, 255 * min(1, result15 - tmp94));
          rgba[sum16 + 2] = max(0, 255 * min(1, diff4));
          rgba[sum16 + 3] = max(0, 255 * min(1, tmp98));
          num21 = num21 + 1;
          sum16 = sum16 + 4;
          tmp63 = sum16;
        } while (num21 < w);
...
export const rgbaToThumbHash = function rgbaToThumbHash(arg0, arg1, arg2) {
  ...
  if (arg0 <= 100) {
    if (arg1 <= 100) {
      ...
      [tmp23, tmp24, tmp25] = encodeChannel(items, max(3, maxResult), max(3, maxResult1));
      let tmp22 = _slicedToArray(encodeChannel(items, max(3, maxResult), max(3, maxResult1)), 3);
      [tmp27, tmp28, tmp29] = encodeChannel(items1, 3, 3);
      const tmp26 = _slicedToArray(encodeChannel(items1, 3, 3), 3);
      [tmp31, tmp32, tmp33] = encodeChannel(items2, 3, 3);
      if (num7 < arg0 * arg1) {
