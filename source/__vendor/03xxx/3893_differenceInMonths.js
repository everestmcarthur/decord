...
// Dependencies: [3695, 3881, 3871, 3696, 3894]
// Exports: default

// Module 3893 (differenceInMonths)
...
if (!module_3894) {
  const obj5 = { default: module_3894 };
  let tmp11 = obj5;
} else {
  tmp11 = module_3894;
}
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_3894.default(_typeof.default(date)) && 1 === absolute && 1 === obj3.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
