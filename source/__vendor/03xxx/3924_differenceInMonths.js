...
// Dependencies: [3726, 3912, 3902, 3727, 3925]
// Exports: default

// Module 3924 (differenceInMonths)
...
if (!module_3925) {
  const obj5 = { default: module_3925 };
  let tmp11 = obj5;
} else {
  tmp11 = module_3925;
}
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_3925.default(_typeof.default(date)) && 1 === absolute && 1 === obj3.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
