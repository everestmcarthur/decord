...
// Dependencies: [3728, 3914, 3904, 3729, 3927]
// Exports: default

// Module 3926 (differenceInMonths)
...
if (!module_3927) {
  const obj5 = { default: module_3927 };
  let tmp11 = obj5;
} else {
  tmp11 = module_3927;
}
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_3927.default(_typeof.default(date)) && 1 === absolute && 1 === obj3.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
