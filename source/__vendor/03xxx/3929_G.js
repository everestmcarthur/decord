...
// Function ID: 3930
// Name: G
// Dependencies: [3930, 3931, 3934, 3935, 3937, 3938, 3939]
...
import M from "M" /* 3939 */;

let module_3930 = module_3930_mod;
if (!module_3930) {
  let obj = { default: module_3930 };
  let tmp3 = obj;
} else {
  tmp3 = module_3930;
}
...
if (!module_3934) {
  const obj3 = { default: module_3934 };
  let tmp7 = obj3;
} else {
  tmp7 = module_3934;
}
...
if (!module_3935) {
  const obj4 = { default: module_3935 };
  let tmp9 = obj4;
} else {
  tmp9 = module_3935;
}
...
if (!module_3937) {
  const obj5 = { default: module_3937 };
  let tmp11 = obj5;
} else {
  tmp11 = module_3937;
}
...
if (!module_3938) {
  const obj6 = { default: module_3938 };
  let tmp13 = obj6;
} else {
  tmp13 = module_3938;
}
...
export default {
  ...
  Y(arg0, arg1, ordinalNumber, arg3) {
    const defaultResult = module_3937.default(arg0, arg3);
    let diff = defaultResult;
    if (defaultResult <= 0) {
      diff = 1 - defaultResult;
    }
    if ("YY" === arg1) {
      return module_3938.default(diff % 100, 2);
    } else {
      if ("Yo" === arg1) {
        let ordinalNumberResult = ordinalNumber.ordinalNumber(diff, { unit: "year" });
      } else {
        ordinalNumberResult = module_3938.default(diff, arg1.length);
      }
      return ordinalNumberResult;
    }
  },
  R(arg0, arg1) {
    return module_3938.default(module_3934.default(arg0), arg1.length);
  },
  u(getUTCFullYear, arg1) {
    return module_3938.default(getUTCFullYear.getUTCFullYear(), arg1.length);
  },
  Q(getUTCMonth, arg1, ordinalNumber) {
    ...
    if ("Q" === arg1) {
      ...
      return module_3938.default(rounded, 2);
    } else if ("Qo" === arg1) {
  ...
  L(getUTCMonth, arg1, ordinalNumber) {
    ...
    if ("L" === arg1) {
      ...
      return module_3938.default(uTCMonth + 1, 2);
    } else if ("Lo" === arg1) {
      return ordinalNumber.ordinalNumber(uTCMonth + 1, { unit: "month" });
    } else if ("LLL" === arg1) {
  ...
  w(arg0, arg1, ordinalNumber, arg3) {
    const defaultResult = module_3935.default(arg0, arg3);
    if ("wo" === arg1) {
      let ordinalNumberResult = ordinalNumber.ordinalNumber(defaultResult, { unit: "week" });
    } else {
      ordinalNumberResult = module_3938.default(defaultResult, arg1.length);
    }
    return ordinalNumberResult;
  },
  I(arg0, arg1, ordinalNumber) {
    const defaultResult = module_3931.default(arg0);
    if ("Io" === arg1) {
      let ordinalNumberResult = ordinalNumber.ordinalNumber(defaultResult, { unit: "week" });
    } else {
      ordinalNumberResult = module_3938.default(defaultResult, arg1.length);
  ...
  D(arg0, arg1, ordinalNumber) {
    const defaultResult = module_3930.default(arg0);
    if ("Do" === arg1) {
  ...
  e(getUTCDay, arg1, ordinalNumber, weekStartsOn) {
    ...
    if ("e" === arg1) {
      ...
      return module_3938.default(tmp2, 2);
    } else if ("eo" === arg1) {
  ...
  c(getUTCDay, arg1, ordinalNumber, weekStartsOn) {
    ...
    if ("c" === arg1) {
      ...
      return module_3938.default(tmp2, arg1.length);
    } else if ("co" === arg1) {
      return ordinalNumber.ordinalNumber(tmp2, { unit: "day" });
    } else if ("ccc" === arg1) {
  ...
  i(getUTCDay, arg1, ordinalNumber) {
    ...
    if ("i" === arg1) {
      ...
      return module_3938.default(num, arg1.length);
    } else if ("io" === arg1) {
  ...
  K(getUTCHours, arg1, ordinalNumber) {
    ...
    if ("Ko" === arg1) {
      ...
      ordinalNumberResult = module_3938.default(result, arg1.length);
    }
    return ordinalNumberResult;
  },
  k(getUTCHours, arg1, ordinalNumber) {
    ...
    if ("ko" === arg1) {
      ...
      ordinalNumberResult = module_3938.default(num, arg1.length);
    }
    return ordinalNumberResult;
  },
  ...
  X(arg0, arg1, arg2, _originalDate) {
    ...
    if (0 === timezoneOffset) {
      ...
      if (timezoneOffset % 60 === 0) {
        ...
        const _Math7 = Math;
        let sum = str5 + module_3938.default(Math.abs(timezoneOffset) / 60, 2);
      } else {
        let str4 = "+";
        if (timezoneOffset > 0) {
          str4 = "-";
        ...
        const _Math6 = Math;
        const sum1 = str4 + module_3938.default(Math.floor(absolute / 60), 2);
        sum = sum1 + module_3938.default(absolute % 60, 2);
      }
      return sum;
    } else {
      if ("XXXX" !== arg1) {
        if ("XX" !== arg1) {
          ...
          const _Math2 = Math;
          const sum2 = str + module_3938.default(Math.floor(absolute1 / 60), 2);
          return sum2 + ":" + module_3938.default(absolute1 % 60, 2);
        }
      }
      let str3 = "+";
      if (timezoneOffset > 0) {
      ...
      const _Math4 = Math;
      const sum3 = str3 + module_3938.default(Math.floor(absolute2 / 60), 2);
      return sum3 + module_3938.default(absolute2 % 60, 2);
    }
  ...
  O(arg0, arg1, arg2, _originalDate) {
    ...
    if ("O" !== arg1) {
      if ("OO" !== arg1) {
        if ("OOO" !== arg1) {
          ...
          const absolute = Math.abs(timezoneOffset);
          const _Math2 = Math;
          const sum = str + module_3938.default(Math.floor(absolute / 60), 2);
          return "GMT" + (sum + ":" + module_3938.default(absolute % 60, 2));
        }
      }
    }
    let str4 = "+";
    ...
    if (0 === result) {
      ...
      sum1 = `${tmp9}:${module_3938.default(tmp8, 2)}`;
    }
    return "GMT" + sum1;
  },
  ...
  t(arg0, arg1, arg2, _originalDate) {
    return module_3938.default(Math.floor(_originalDate._originalDate || arg0.getTime() / 1000), arg1.length);
  },
  T(arg0, arg1, arg2, _originalDate) {
    return module_3938.default(_originalDate._originalDate || arg0.getTime(), arg1.length);
  }
};
