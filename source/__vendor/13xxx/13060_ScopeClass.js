...
// Function ID: 13061
// Name: ScopeClass
// Dependencies: [32, 41, 42, 13049, 13061, 13062, 13046, 13053, 13064, 13050, 13039]

// Module 13060 (ScopeClass)
...
const entry = {
  ...
  value: function clone() {
    ...
    const obj = { traceId: ScopeClass(13049).generateTraceId(), spanId: null };
    const obj2 = ScopeClass(13049);
    obj.spanId = ScopeClass(13049).generateSpanId();
    ...
    const obj10 = {};
    const obj3 = ScopeClass(13049);
    const obj5 = {};
    const obj6 = {};
    const obj7 = {};
    const obj9 = {};
    const tmp3Result = ScopeClass(13061);
    tmp3Result._setSpanForScope(obj4, ScopeClass(13061)._getSpanForScope(self));
    return obj4;
  }
};
let items = [
  ...
  },
  {
    ...
    value: function setUser(user) {
      if (!user) {
        user = { email: "Array", id: "flexDirection", ip_address: "y", username: "HermesInternal" };
      }
      const self = this;
      this._user = user;
      if (this._session) {
        const obj = { user };
        ScopeClass(13062).updateSession(self._session, obj);
        const obj2 = ScopeClass(13062);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(13061)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      const obj3 = { traceId: null };
      const obj2 = ScopeClass(13061);
      obj3.traceId = ScopeClass(13049).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        const obj = { timestamp: ScopeClass(13053).dateTimestampInSeconds() };
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: this._fingerprint || [], eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(13061)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(13064).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(13049).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(originalException, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(13039).logger;
          logger.warn("No client configured on scope - will not capture exception!");
          return event_id;
        }
      }
      event_id = ScopeClass(13050).uuid4();
    }
  },
  {
    key: "captureMessage",
