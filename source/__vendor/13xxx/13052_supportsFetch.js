...
// Function ID: 13053
// Name: supportsFetch
// Dependencies: [12941, 12939, 12940]
...
// Module 13052 (supportsFetch)
import _mod12941 from "module_12941" /* 12941 */;

require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in _mod12941.GLOBAL_OBJ) {
    try {
...
export const supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(_mod12941.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(12941).GLOBAL_OBJ.document;
      if (_document) {
...
export const supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in _mod12941.GLOBAL_OBJ;
};
