        ...
        while (true) {
                      ...
                      if (!(1024 & state.flags)) {
                        ...
                        if (length4) {
                          ...
                          if (512 & state.flags) {
                            ...
                            buf8 = length4;
                            buf8 = tmp14;
                            state.check = _mod13662(check7, tmp16, length4, buf8);
                          }
                          buf8 = tmp12 - length4;
                          buf8 = tmp14 + length4;
                          ...
                          if (4096 & state.flags) {
                            ...
                            if (0 !== tmp12) {
                              ...
                              if (512 & state.flags) {
                                ...
                                buf8 = input;
                                buf8 = tmp14;
                                state.check = _mod13662(check9, tmp16, buf8, buf8);
                              }
                              buf8 = tmp12 - buf8;
                              buf8 = tmp14 + buf8;
                              num61 = num56;
                                                                  ...
                                                                  if (bits >= 32) {
                                                                    ...
                                                                    if (!diff3) {
                                                                      ...
                                                                      if (state.flags) {
                                                                        ...
                                                                        let tmp44 = output;
                                                                        let tmp45 = diff3;
                                                                        tmp46 = tmp41(13661)(check, tmp15, diff3, next_out - diff3);
                                                                      }
                                                                      state.check = tmp46;
                                                                      state.adler = tmp46;
                                                                    }
                                              ...
                                              if (state.mode === 30) {
                                                ...
                                                if (0 === state.lens[256]) {
                                                  ...
                                                  if (buf8) {
                                                    ...
                                                    let num74 = 0;
                                                    buf8 = obj;
                                                    buf8 = buf8(13666)(2, lens2, state.nlen, state.ndist, state.distcode, 0, state.work, obj);
                    ...
                    if (2048 & state.flags) {
                      ...
                      if (0 !== buf8) {
                        ...
                        if (512 & state.flags) {
                          ...
                          buf8 = check8;
                          buf8 = input;
                          state.check = _mod13662(check8, tmp16, buf8, buf8);
                        }
                        buf8 = buf8 - buf8;
                        buf8 = buf8 + buf8;
                        num61 = num56;
          ...
          if (!buf8) {
            ...
            if (state.flags) {
              ...
              buf8 = check11;
              buf8 = output;
              buf8 = buf8(13661)(check11, tmp15, buf8, state.next_out - buf8);
            }
            state.check = buf8;
            state.adler = buf8;
          }
