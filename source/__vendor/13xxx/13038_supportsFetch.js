...
// Function ID: 13039
// Name: supportsFetch
// Dependencies: [12927, 12925, 12926]
...
// Module 13038 (supportsFetch)
import _mod12927 from "module_12927" /* 12927 */;

require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in _mod12927.GLOBAL_OBJ) {
    try {
...
export const supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(_mod12927.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(12927).GLOBAL_OBJ.document;
      if (_document) {
...
export const supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in _mod12927.GLOBAL_OBJ;
};
