...
// Function ID: 13665
// Name: Inflate
// Dependencies: [13655, 13657, 13665, 13668, 13659, 13669, 13663]

// Module 13664 (Inflate)
import assign from "assign" /* 13655 */;
import ZStream from "ZStream" /* 13657 */;
import _mod13659 from "module_13659" /* 13659 */;
import assign2 from "assign" /* 13663 */;
...
class Inflate {
  constructor(arg0) {
    ...
    if (this instanceof Inflate) {
      ...
      if (inflateInit2Result !== require("module_13668").Z_OK) {
        tmp19 = globalThis;
        _Error = Error;
        tmp20 = new.target;
        tmp21 = new.target;
        error = new Error(require("module_13659")[inflateInit2Result]);
        tmp23 = error;
        throw error;
      } else {
        tmp14 = new.target;
    ...
    if (this.ended) {
      ...
      if (arg1 === ~~arg1) {
        ...
        if (true === arg1) {
          tmp5 = closure_0;
          tmp6 = closure_1;
          Z_NO_FLUSH = require("module_13668").Z_FINISH;
        } else {
          tmp3 = closure_0;
          tmp4 = closure_1;
          Z_NO_FLUSH = require("module_13668").Z_NO_FLUSH;
        }
        tmp7 = Z_NO_FLUSH;
      }
    }
  ...
  onEnd(arg0) {
    ...
    tmp = closure_0;
    tmp2 = closure_1;
    if (arg0 === require("module_13668").Z_OK) {
      str = "string";
