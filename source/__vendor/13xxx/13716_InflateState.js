...
function InflateState() {
  ...
  const buf16 = new _mod13706.Buf16(320);
  obj.lens = buf16;
  const buf161 = new _mod13706.Buf16(288);
  obj.work = buf161;
  obj.lendyn = null;
  obj.distdyn = null;
  obj.sane = 0;
    ...
    if (state.state) {
      ...
      if (state) {
        ...
        if (state.state) {
          ...
          state2.hold = 0;
          state2.bits = 0;
          buf32 = new _mod13706.Buf32(852);
          state2.lendyn = buf32;
          state2.lencode = buf32;
          buf321 = new _mod13706.Buf32(592);
...
function updatewindow(state, output3, length, length2) {
  ...
  if (null === state.window) {
    ...
    state.wnext = 0;
    state.whave = 0;
    const buf8 = new _mod13706.Buf8(state.wsize);
    state.window = buf8;
  }
  if (length2 >= state.wsize) {
    const obj3 = _mod13706;
...
export const inflate = function inflate(state, arg1) {
  let mode;
  const buf8 = new _mod13706.Buf8(4);
          ...
          if (1 === mode) {
              ...
              if (bits >= 16) {
                if (2 & state.wrap) {
                  if (35615 === tmp683) {
                    ...
                    state.check = _mod13713(check10, tmp2, 2, 0);
                    state.mode = 2;
                    bits = 0;
                    hold = 0;
                    diff45 = tmp684;
            ...
            if (2 === mode) {
              ...
              if (bits >= 16) {
                ...
                if (8 !== (255 & state.flags)) {
                  ...
                  if (512 & state.flags) {
                    ...
                    state.check = _mod13713(check3, tmp2, 2, 0);
                  }
                  state.mode = 3;
                  let num91 = 0;
                  let num92 = 0;
              ...
              if (3 !== mode) {
                      ...
                      if (!(1024 & state.flags)) {
                        ...
                        if (length4) {
                          ...
                          if (512 & state.flags) {
                            ...
                            state.check = _mod13713(check7, tmp16, length4, tmp592);
                          }
                          diff3 = tmp12 - length4;
                          sum7 = tmp14 + length4;
                          ...
                          if (4096 & state.flags) {
                            ...
                            if (0 !== tmp12) {
                              ...
                              if (512 & state.flags) {
                                ...
                                state.check = _mod13713(check9, tmp16, sum8, tmp596);
                              }
                                                                ...
                                                                if (bits >= 32) {
                                                                  ...
                                                                  if (!diff12) {
                                                                    ...
                                                                    if (state.flags) {
                                                                      ...
                                                                      tmp46 = tmp41(13712)(check, tmp15, diff12, next_out - diff12);
                                                                    }
                                                                    state.check = tmp46;
                                                                    state.adler = tmp46;
                                                                  }
                                            ...
                                            if (state.mode === 30) {
                                              ...
                                              if (0 === state.lens[256]) {
                                                ...
                                                if (tmp643) {
                                                  ...
                                                  let tmp191 = tmp639(13717)(2, lens2, state.nlen, state.ndist, state.distcode, 0, state.work, obj7);
                                ...
                                if (tmp605 >= 3) {
                                  ...
                                  if (0 === tmp390) {
                                    ...
                                    if (c7) {
                                      ...
                                      buf32 = new _mod13706.Buf32(512);
                                      let tmp398 = new.target;
                                      let tmp399 = new.target;
                                      buf321 = new _mod13706.Buf32(32);
                                      let num79 = 0;
                                      do {
                                        sum66 = num79 + 1;
                                        state.lens[num79] = 8;
                    ...
                    if (2048 & state.flags) {
                      ...
                      if (0 !== tmp515) {
                        ...
                        if (512 & state.flags) {
                          ...
                          state.check = _mod13713(check8, tmp16, sum74, tmp516);
                        }
                ...
                if (1024 & state.flags) {
                  ...
                  if (512 & state.flags) {
                    ...
                    num100 = _mod13713(check6, tmp2, 2, 0);
                    state.check = num100;
                  }
                } else if (state.head) {
              ...
              if (num95 >= 16) {
                ...
                if (512 & state.flags) {
                  ...
                  state.check = _mod13713(check5, tmp2, 2, 0);
                }
                state.mode = 5;
                num99 = 0;
                num100 = 0;
            ...
            if (num91 >= 32) {
              ...
              if (512 & state.flags) {
                ...
                state.check = _mod13713(check4, tmp2, 4, 0);
              }
              state.mode = 4;
              num95 = 0;
              num96 = 0;
