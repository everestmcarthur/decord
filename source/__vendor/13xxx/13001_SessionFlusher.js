...
// Function ID: 13002
// Name: SessionFlusher
// Dependencies: [41, 42, 12954, 12975]

// Module 13001 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12954).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12975).getIsolationScope();
        ...
        const obj = SessionFlusher(12975);
      }
    }
  },
  {
