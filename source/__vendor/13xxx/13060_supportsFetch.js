...
// Function ID: 13061
// Name: supportsFetch
// Dependencies: [12949, 12947, 12948]
...
// Module 13060 (supportsFetch)
import _mod12949 from "module_12949" /* 12949 */;

require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in _mod12949.GLOBAL_OBJ) {
    try {
...
export const supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(_mod12949.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(12949).GLOBAL_OBJ.document;
      if (_document) {
...
export const supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in _mod12949.GLOBAL_OBJ;
};
