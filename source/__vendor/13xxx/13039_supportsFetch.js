...
// Function ID: 13040
// Name: supportsFetch
// Dependencies: [12928, 12926, 12927]
...
// Module 13039 (supportsFetch)
import _mod12928 from "module_12928" /* 12928 */;

require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in _mod12928.GLOBAL_OBJ) {
    try {
...
export const supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(_mod12928.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(12928).GLOBAL_OBJ.document;
      if (_document) {
...
export const supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in _mod12928.GLOBAL_OBJ;
};
