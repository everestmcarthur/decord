...
// Dependencies: [13712, 13708, 13713, 13714, 13715]
// Exports: deflate, deflateEnd, deflateInit, deflateResetKeep, deflateSetDictionary, deflateSetHeader

// Module 13711 (flush_block_only)
import _mod13708 from "module_13708" /* 13708 */;
import _mod13712 from "module_13712" /* 13712 */;
import StaticTreeDesc from "StaticTreeDesc" /* 13713 */;
import adler32 from "adler32" /* 13714 */;
import _mod13715 from "module_13715" /* 13715 */;
  ...
  while (true) {
    ...
    if (0 === state.strm.avail_in) {
      ...
      if (0 === avail_in) {
        ...
        let obj2 = _mod13708;
        let arraySetResult2 = obj2.arraySet(_window, strm.input, strm.next_in, avail_in, sum1);
        if (1 === strm.state.wrap) {
          tmp15 = tmp15(13714);
          strm.adler = tmp15(strm.adler, _window, avail_in, sum1);
        } else if (2 === strm.state.wrap) {
          strm.adler = tmp15(13715)(strm.adler, _window, avail_in, sum1);
        }
...
function deflate_fast(lookahead, arg1) {
  while (true) {
...
function deflate_slow(lookahead, arg1) {
  while (true) {
    if (lookahead.lookahead < 262) {
      let tmp2 = fill_window(lookahead);
      if (lookahead.lookahead < 262) {
...
function DeflateState() {
  ...
  const buf16 = new _mod13708.Buf16(1146);
  obj.dyn_ltree = buf16;
  const buf161 = new _mod13708.Buf16(122);
  obj.dyn_dtree = buf161;
  const buf162 = new _mod13708.Buf16(78);
  obj.bl_tree = buf162;
  ...
  obj.d_desc = null;
  obj.bl_desc = null;
  const buf163 = new tmp(13708).Buf16(16);
  obj.bl_count = buf163;
  const buf164 = new tmp(13708).Buf16(573);
  obj.heap = buf164;
  const heap = obj.heap;
  ...
  obj.heap_len = 0;
  obj.heap_max = 0;
  const buf165 = new tmp(13708).Buf16(573);
  obj.depth = buf165;
                ...
                if (num2 <= 9) {
                  if (strategy >= 0) {
                    if (strategy <= 4) {
                      ...
                      const buf8 = new _mod13708.Buf8(2 * obj.w_size);
                      obj.window = buf8;
                      const buf16 = new _mod13708.Buf16(obj.hash_size);
                      obj.head = buf16;
                      const buf161 = new _mod13708.Buf16(obj.w_size);
                      obj.prev = buf161;
                      obj.lit_bufsize = 1 << memLevel + 6;
                      obj.pending_buf_size = 4 * obj.lit_bufsize;
                      const buf81 = new _mod13708.Buf8(obj.pending_buf_size);
...
const items = [
  {
    ...
    nice_length: 0,
    max_chain: 0,
    func: function deflate_stored(pending_buf_size, arg1) {
      let num = 65535;
...
export const deflateInit = function deflateInit(strm, level) {
  return deflateInit2(strm, level, 8, 15, 8, 0);
};
export { deflateInit2 };
export { deflateReset };
export const deflateResetKeep = function deflateResetKeep(state) {
  if (state) {
    if (state.state) {
      state.total_out = 0;
      state.total_in = 0;
...
export const deflateSetHeader = function deflateSetHeader(strm, header) {
  let num = -2;
  let num2 = -2;
  if (strm) {
    num2 = num;
...
export const deflate = function deflate(state, last_flush) {
  if (state) {
    if (state.state) {
      if (last_flush <= 5) {
        if (last_flush >= 0) {
            ...
            if (state.input) {
              ...
              if (42 === state8.status) {
                if (2 === state8.wrap) {
                  ...
                  if (state8.gzhead) {
                    ...
                    if (state8.gzhead.hcrc) {
                      state.adler = _mod13715(state.adler, state8.pending_buf, state8.pending, 0);
                    }
                    state8.gzindex = 0;
                    state8.status = 69;
                  ...
                  if (0 !== state8.strstart) {
                    state8.pending = +state8.pending + 1;
                    state8.pending_buf[+state8.pending] = state.adler >>> 16 >>> 8 & 255;
                    state8.pending = +state8.pending + 1;
                    state8.pending_buf[+state8.pending] = 255 & state.adler >>> 16;
                    state8.pending = +state8.pending + 1;
                    state8.pending_buf[+state8.pending] = (65535 & state.adler) >>> 8 & 255;
                    state8.pending = +state8.pending + 1;
                    state8.pending_buf[+state8.pending] = 255 & (65535 & state.adler);
                  }
                  state.adler = 1;
                }
              }
              if (69 === state8.status) {
                if (state8.gzhead.extra) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      while (state8.gzindex < (65535 & state8.gzhead.extra.length)) {
                        if (state8.pending !== state8.pending_buf_size) {
                          ...
                          if (tmp36) {
                            state.adler = _mod13715(state.adler, state8.pending_buf, state8.pending - tmp35, tmp35);
                          }
                          ...
                          if (0 !== avail_out2) {
                            let obj7 = _mod13708;
                            let arraySetResult = obj7.arraySet(state.output, state2.pending_buf, state2.pending_out, avail_out2, state.next_out);
                      ...
                      if (tmp29) {
                        state.adler = _mod13715(state.adler, state8.pending_buf, state8.pending - pending, pending);
                      }
                      state = state.state;
                      let avail_out = state.pending;
                      ...
                      if (0 !== avail_out) {
                        const obj6 = _mod13708;
                        obj6.arraySet(state.output, state.pending_buf, state.pending_out, avail_out, state.next_out);
                  ...
                  if (tmp40) {
                    state.adler = _mod13715(state.adler, state8.pending_buf, state8.pending - pending2, pending2);
                  }
                ...
                if (state8.gzhead.name) {
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp46) {
                        state.adler = _mod13715(state.adler, state8.pending_buf, state8.pending - pending3, tmp44);
                      }
                      ...
                      if (0 !== avail_out3) {
                        let obj8 = _mod13708;
                        let arraySetResult9 = obj8.arraySet(state.output, state3.pending_buf, state3.pending_out, avail_out3, state.next_out);
                    ...
                    if (tmp52) {
                      state.adler = _mod13715(state.adler, state8.pending_buf, state8.pending - pending4, pending4);
                    }
                    if (0 === num46) {
                      state8.gzindex = 0;
                      state8.status = 91;
                ...
                if (state8.gzhead.comment) {
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp58) {
                        state.adler = _mod13715(state.adler, state8.pending_buf, state8.pending - pending5, tmp56);
                      }
                      ...
                      if (0 !== avail_out4) {
                        let obj9 = _mod13708;
                        let arraySetResult10 = obj9.arraySet(state.output, state4.pending_buf, state4.pending_out, avail_out4, state.next_out);
                    ...
                    if (tmp64) {
                      state.adler = _mod13715(state.adler, state8.pending_buf, state8.pending - pending6, pending6);
                    }
                    if (0 === num53) {
                      state8.status = 103;
                    }
              ...
              if (state8.status === 103) {
                if (state8.gzhead.hcrc) {
                  if (state8.pending + 2 > state8.pending_buf_size) {
                    ...
                    if (0 !== avail_out5) {
                      const obj10 = _mod13708;
                      obj10.arraySet(state.output, state9.pending_buf, state9.pending_out, avail_out5, state.next_out);
              ...
              if (0 !== state8.pending) {
                ...
                if (0 !== avail_out6) {
                  const obj11 = _mod13708;
                  obj11.arraySet(state.output, state5.pending_buf, state5.pending_out, avail_out6, state.next_out);
                ...
                if (tmp159 - num62 <= tmp70 - num63) {
                  if (4 !== last_flush) {
                    state.msg = _mod13712[-5];
                    return -5;
                  }
                }
                tmp159 = last_flush << 1;
                ...
                if (4 === last_flush) {
                  ...
                  if (state8.wrap > 0) {
                    if (2 === state8.wrap) {
                      ...
                      state8.pending_buf[+state8.pending] = state.adler >> 8 & 255;
                      state8.pending = +state8.pending + 1;
                      state8.pending_buf[+state8.pending] = state.adler >> 16 & 255;
                      state8.pending = +state8.pending + 1;
                      state8.pending_buf[+state8.pending] = state.adler >> 24 & 255;
                      state8.pending = +state8.pending + 1;
                      state8.pending_buf[+state8.pending] = 255 & state.total_in;
                      state8.pending = +state8.pending + 1;
                      state8.pending_buf[+state8.pending] = state.total_in >> 8 & 255;
                      state8.pending = +state8.pending + 1;
                      state8.pending_buf[+state8.pending] = state.total_in >> 16 & 255;
                      state8.pending = +state8.pending + 1;
                      state8.pending_buf[+state8.pending] = state.total_in >> 24 & 255;
                    } else {
                      state8.pending = +state8.pending + 1;
                      state8.pending_buf[+state8.pending] = state.adler >>> 16 >>> 8 & 255;
                      state8.pending = +state8.pending + 1;
                    ...
                    if (0 !== avail_out8) {
                      const obj14 = _mod13708;
                      obj14.arraySet(state.output, state7.pending_buf, state7.pending_out, avail_out8, state.next_out);
              ...
              if (2 === state8.strategy) {
                while (true) {
                  ...
                  if (!obj4._tr_tally(state8, 0, state8.window[state8.strstart])) {
                    ...
                    let tmp102 = flush_block_only(state8, false);
                    let num70 = 1;
                  }
                ...
                if (0 !== last_flush) {
                  state8.insert = 0;
                  if (4 === last_flush) {
                    flush_block_only(state8, true);
                  } else if (state8.last_lit) {
                    flush_block_only(state8, false);
                  }
                }
                ...
                while (true) {
                  ...
                  if (state8.lookahead >= 3) {
                    if (state8.strstart > 0) {
                      let diff1 = state8.strstart - 1;
                      let tmp168 = _window[diff1];
                      let sum1 = diff1 + 1;
                      if (tmp168 === _window[sum1]) {
                        let sum2 = sum1 + 1;
                        if (tmp168 === _window[sum2]) {
                          let sum3 = sum2 + 1;
                          if (tmp168 === _window[sum3]) {
                            let sum4 = state8.strstart + 258;
                            let sum5 = sum3 + 1;
                            let tmp76 = sum5;
                            while (tmp168 === _window[sum5]) {
                              let sum6 = sum5 + 1;
                              tmp76 = sum6;
                              if (tmp168 !== _window[sum6]) {
                                break;
                              } else {
                                let sum7 = sum6 + 1;
                                tmp76 = sum7;
                                if (tmp168 !== _window[sum7]) {
                                  break;
                                } else {
                                  let sum8 = sum7 + 1;
                                  tmp76 = sum8;
                                  if (tmp168 !== _window[sum8]) {
                                    break;
                                  } else {
                                    let sum9 = sum8 + 1;
                                    tmp76 = sum9;
                                    if (tmp168 !== _window[sum9]) {
                                      break;
                                    } else {
                                      let sum10 = sum9 + 1;
                                      tmp76 = sum10;
                                      if (tmp168 !== _window[sum10]) {
                                        break;
                                      } else {
                                        let sum11 = sum10 + 1;
                                        tmp76 = sum11;
                                        if (tmp168 !== _window[sum11]) {
                                          break;
                                        } else {
                                          let sum12 = sum11 + 1;
                                          tmp76 = sum12;
                                          if (tmp168 !== _window[sum12]) {
                                            break;
                                          } else {
                                            sum3 = sum12;
                                            tmp76 = sum12;
                            ...
                            state8.match_length = 258 - (sum4 - tmp76);
              ...
              if (1 !== funcResult) {
                if (3 !== funcResult) {
                  if (2 === funcResult) {
                    if (1 === last_flush) {
                      StaticTreeDesc._tr_align(state8);
                    } else if (5 !== last_flush) {
                      const obj12 = StaticTreeDesc;
                      obj12._tr_stored_block(state8, 0, 0, false);
                      if (3 === last_flush) {
                        const head = state8.head;
                        let diff2 = head.length - 1;
                        if (diff2 >= 0) {
                          do {
                            head[diff2] = 0;
                            diff2 = diff2 - 1;
                    ...
                    if (0 !== avail_out7) {
                      const obj13 = _mod13708;
                      obj13.arraySet(state.output, state6.pending_buf, state6.pending_out, avail_out7, state.next_out);
...
export const deflateEnd = function deflateEnd(state) {
  let num = -2;
  if (state) {
    num = -2;
    if (state.state) {
      ...
      state.state = null;
      if (status === 113) {
        state.msg = _mod13712[-3];
      }
    }
  }
  return num;
};
export const deflateSetDictionary = function deflateSetDictionary(strm, dictionary) {
  if (strm) {
    if (strm.state) {
      const state = strm.state;
        ...
        if (1 !== wrap) {
          if (!state.lookahead) {
            ...
            if (length >= state.w_size) {
              ...
              const buf8 = new _mod13708.Buf8(state.w_size);
              const obj = _mod13708;
