...
// Dependencies: [6977, 6978, 6982, 6983]

// Module 6976 (RenderTimeTracker)
...
const entry = {
  ...
  value: function startTracking() {
    ...
    let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(6983).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
...
const items = [
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(6983).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
...
export const RenderTimeTracker = _modDef6978(RenderTimeTracker, items);
