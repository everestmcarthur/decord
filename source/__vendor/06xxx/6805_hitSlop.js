...
// Function ID: 6806
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6710, 6777, 6806, 6807, 6808, 6809, 6810, 6803, 6718, 6716]
// Exports: default

// Module 6805 (hitSlop)
import _mod6777 from "module_6777" /* 6777 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6806 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6809 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6777.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6806).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6806);
          } else {
