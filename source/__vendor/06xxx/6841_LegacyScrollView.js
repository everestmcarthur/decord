...
// Dependencies: [32, 109, 19, 17, 21, 6840, 6731, 6768]
// Exports: LegacyFlatList

// Module 6841 (LegacyScrollView)
...
const jsx = fn(21).jsx;
let closure_9 = _modDef6840(ScrollView, { disallowInterruption: true, shouldCancelWhenOutside: false });
...
const tmp3 = _modDef6840(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false });
const tmp4 = _modDef6840(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });

export const LegacyRefreshControl = tmp3;
export { LegacyScrollView };
export const LegacySwitch = tmp4;
export const LegacyTextInput = _modDef6840(TextInput);
export const LegacyDrawerLayoutAndroid = _modDef6840(DrawerLayoutAndroid, { disallowInterruption: true });
export const LegacyFlatList = (arg0) => {
  ...
  while (tmp3 !== undefined) {
    [first, tmp9] = tmp4;
    let tmp8 = first;
    let nativeViewProps = ref(6768).nativeViewProps;
