...
// Dependencies: [19, 21, 6893, 6894, 6896]

// Module 6892 (ScrollableContainer)
import BottomSheetDraggableScrollable from "BottomSheetDraggableScrollable" /* 6893 */;
import _modDef6894 from "module_6894" /* 6894 */;
import _mod6896 from "module_6896" /* 6896 */;
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  let tmp2Result = tmp6;
  if (onRefresh) {
    const obj3 = { scrollableGesture: nativeGesture, refreshing, progressViewOffset, onRefresh, style: _mod6896.styles.container, children: tmp6 };
    tmp2Result = jsx(_modDef6894, { scrollableGesture: nativeGesture, refreshing, progressViewOffset, onRefresh, style: _mod6896.styles.container, children: tmp6 });
  }
  return tmp2Result;
});
