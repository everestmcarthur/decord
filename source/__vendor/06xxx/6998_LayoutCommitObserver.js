...
// Dependencies: [6929, 19, 21, 6948, 6947]

// Module 6998 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod6947.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod6947.useLayoutState(0), 2);
  ...
  return jsx(_mod6948.RecyclerViewContextProvider, { value, children: children.children });
});
