...
// Function ID: 6861
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6765, 6832, 6861, 6862, 6863, 6864, 6865, 6858, 6773, 6771]
// Exports: default

// Module 6860 (hitSlop)
import _mod6832 from "module_6832" /* 6832 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6861 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6864 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6832.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6861).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6861);
          } else {
