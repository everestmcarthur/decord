...
// Function ID: 6769
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6681, 6682, 6701, 6741, 6737]
// Exports: FlatList

// Module 6768 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6737 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6681";
import module_6681 from "module_6681" /* 6681 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6681(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6682).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6681(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6682).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6681(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6681(TextInput);
