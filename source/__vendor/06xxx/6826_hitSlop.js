...
// Function ID: 6827
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6731, 6798, 6827, 6828, 6829, 6830, 6831, 6824, 6739, 6737]
// Exports: default

// Module 6826 (hitSlop)
import _mod6798 from "module_6798" /* 6798 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6827 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6830 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6798.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6827).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6827);
          } else {
