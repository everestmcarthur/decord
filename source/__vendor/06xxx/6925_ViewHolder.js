...
// Function ID: 6926
// Name: ViewHolder
// Dependencies: [19, 21, 6888, 6921]

// Module 6925 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_6888").getInvertedTransformStyle(horizontal);
    let obj = require("module_6888");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
