...
// Dependencies: [6871, 19, 21, 6890, 6889]

// Module 6940 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod6889.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod6889.useLayoutState(0), 2);
  ...
  return jsx(_mod6890.RecyclerViewContextProvider, { value, children: children.children });
});
