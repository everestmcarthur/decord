...
// Dependencies: [32, 19, 17, 21, 6844, 6771, 6846, 6833, 6842, 6841, 6820]
// Exports: VirtualDetector

// Module 6845 (VirtualDetector)
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("module_6844").useInterceptingDetectorContext();
    ...
    closure_4(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: tmp, handlerTags, methods: tmp2.gesture.detectorCallbacks, viewRef: "a", userSelect: "parent", touchAction: "r", enableContextMenu: "isArray" };
