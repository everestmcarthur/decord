...
// Dependencies: [6929, 19, 21, 6948, 6979, 6983]
// Exports: ViewHolderCollection

// Module 6985 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 6983 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(6948).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(6979).CompatView, { style: tmp19, children: null });
};
