...
// Dependencies: [6871, 19, 21, 6890, 6921, 6925]
// Exports: ViewHolderCollection

// Module 6927 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 6925 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(6890).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(6921).CompatView, { style: tmp19, children: null });
};
