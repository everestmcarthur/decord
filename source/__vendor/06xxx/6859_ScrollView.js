...
// Function ID: 6860
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6772, 6773, 6792, 6832, 6828]
// Exports: FlatList

// Module 6859 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6828 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6772";
import module_6772 from "module_6772" /* 6772 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6772(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6773).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6772(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6773).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6772(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6772(TextInput);
