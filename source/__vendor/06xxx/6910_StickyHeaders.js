...
// Function ID: 6911
// Name: StickyHeaders
// Dependencies: [6857, 19, 21, 6907, 6911, 6872]
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessible", target: "<string:553649237>", hidden: "<string:4236657153>", inverted: "<string:2142961666>" };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
