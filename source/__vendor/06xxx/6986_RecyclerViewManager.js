...
// Dependencies: [6974, 6975, 6987, 6989, 6990, 6962, 6992, 7003, 7004, 7005]

// Module 6986 (RecyclerViewManager)
import _modDef6975 from "module_6975" /* 6975 */;
import ViewabilityManagerDefault from "ViewabilityManager" /* 6990 */;
  ...
  },
  {
    ...
    value: function getLayout(arg0) {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(6962).ErrorMessages.layoutManagerNotInitializedLayoutInfo);
        throw error;
      }
    }
  },
  ...
  },
  {
    ...
    value: function getChildContainerDimensions() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(6962).ErrorMessages.layoutManagerNotInitializedChildContainer);
        throw error;
      }
    }
  },
  ...
  },
  {
    ...
    value: function getWindowSize() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(6962).ErrorMessages.layoutManagerNotInitializedWindowSize);
        throw error;
      }
    }
  },
    ...
    value: function updateLayoutParams(windowSize, firstItemOffset) {
      ...
      if (this.layoutManager) {
        ...
        if (BooleanResult !== Boolean(self.propsRef.horizontal)) {
          const _Error = Error;
          const error = new Error(RecyclerViewManager(6962).ErrorMessages.horizontalPropCannotBeToggled);
          throw error;
        }
  ...
  },
  {
    ...
    value: function computeVisibleIndices() {
      ...
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(6962).ErrorMessages.layoutManagerNotInitializedVisibleIndices);
        throw error;
      }
    }
  },
    ...
    value: function getLayoutManagerClass() {
      ...
      if (this.propsRef.masonry) {
        if (self.propsRef.horizontal) {
          const _Error2 = Error;
          const error = new Error(RecyclerViewManager(6962).ErrorMessages.masonryAndHorizontalIncompatible);
          throw error;
        }
      }
      if (self.numColumns > 1) {
        if (self.propsRef.horizontal) {
          const _Error = Error;
          const error1 = new Error(RecyclerViewManager(6962).ErrorMessages.numColumnsAndHorizontalIncompatible);
          throw error1;
        }
      }
      if (self.propsRef.masonry) {
        let RVLinearLayoutManagerImpl = RecyclerViewManager(6992).RVMasonryLayoutManagerImpl;
      } else {
        if (self.numColumns > 1) {
          if (!self.propsRef.horizontal) {
            RVLinearLayoutManagerImpl = RecyclerViewManager(7003).RVGridLayoutManagerImpl;
          }
        }
        RVLinearLayoutManagerImpl = RecyclerViewManager(7004).RVLinearLayoutManagerImpl;
      }
  ...
  },
  {
    ...
    value: function checkPropsAndWarn() {
      if (tmp) {
        ...
        console.warn(RecyclerViewManager(7005).WarningMessages.keyExtractorNotDefinedForMVCP);
      }
    }
  }
];

export const RecyclerViewManager = _modDef6975(RecyclerViewManager, items);
