...
// Function ID: 6826
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6738, 6739, 6758, 6798, 6794]
// Exports: FlatList

// Module 6825 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6794 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6738";
import module_6738 from "module_6738" /* 6738 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6738(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6739).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6738(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6739).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6738(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6738(TextInput);
