...
// Function ID: 6984
// Name: ViewHolder
// Dependencies: [19, 21, 6946, 6979]

// Module 6983 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_6946").getInvertedTransformStyle(horizontal);
    let obj = require("module_6946");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
