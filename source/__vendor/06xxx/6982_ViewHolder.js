...
// Function ID: 6983
// Name: ViewHolder
// Dependencies: [19, 21, 6945, 6978]

// Module 6982 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_6945").getInvertedTransformStyle(horizontal);
    let obj = require("module_6945");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
