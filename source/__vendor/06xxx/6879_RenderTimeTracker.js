...
// Dependencies: [6880, 6881, 6885, 6886]

// Module 6879 (RenderTimeTracker)
...
const entry = {
  ...
  value: function startTracking() {
    ...
    let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(6886).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
...
const items = [
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(6886).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
...
export const RenderTimeTracker = _modDef6881(RenderTimeTracker, items);
