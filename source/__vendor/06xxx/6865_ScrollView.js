...
// Function ID: 6866
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6778, 6779, 6798, 6838, 6834]
// Exports: FlatList

// Module 6865 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6834 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6778";
import module_6778 from "module_6778" /* 6778 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6778(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6779).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6778(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6779).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6778(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6778(TextInput);
