...
// Function ID: 6828
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6732, 6799, 6828, 6829, 6830, 6831, 6832, 6825, 6740, 6738]
// Exports: default

// Module 6827 (hitSlop)
import _mod6799 from "module_6799" /* 6799 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6828 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6831 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6799.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6828).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6828);
          } else {
