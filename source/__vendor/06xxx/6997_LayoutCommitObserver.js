...
// Dependencies: [6928, 19, 21, 6947, 6946]

// Module 6997 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod6946.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod6946.useLayoutState(0), 2);
  ...
  return jsx(_mod6947.RecyclerViewContextProvider, { value, children: children.children });
});
