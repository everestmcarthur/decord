...
// Dependencies: [109, 19, 17, 21, 6803, 1744, 6775]

// Module 6833 (NativeEventsManager1)
...
if (!NativeEventsManager1) {
  try {
    NativeEventsManager = fn(1744).NativeEventsManager;
...
if (tmp4) {
  ...
  if (tmp5 != null) {
    ...
    LeanReanimatedNativeDetector = obj.createAnimatedComponent(_modDef6775);
  }
}
