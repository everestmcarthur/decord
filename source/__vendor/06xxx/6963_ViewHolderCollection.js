...
// Dependencies: [6907, 19, 21, 6926, 6957, 6961]
// Exports: ViewHolderCollection

// Module 6963 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 6961 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(6926).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(6957).CompatView, { style: tmp19, children: null });
};
