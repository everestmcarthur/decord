...
// Dependencies: [32, 109, 19, 17, 21, 6819, 6710, 6747]
// Exports: LegacyFlatList

// Module 6820 (LegacyScrollView)
...
const jsx = fn(21).jsx;
let closure_9 = _modDef6819(ScrollView, { disallowInterruption: true, shouldCancelWhenOutside: false });
...
const tmp3 = _modDef6819(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false });
const tmp4 = _modDef6819(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });

export const LegacyRefreshControl = tmp3;
export { LegacyScrollView };
export const LegacySwitch = tmp4;
export const LegacyTextInput = _modDef6819(TextInput);
export const LegacyDrawerLayoutAndroid = _modDef6819(DrawerLayoutAndroid, { disallowInterruption: true });
export const LegacyFlatList = (arg0) => {
  ...
  while (tmp3 !== undefined) {
    [first, tmp9] = tmp4;
    let tmp8 = first;
    let nativeViewProps = ref(6747).nativeViewProps;
