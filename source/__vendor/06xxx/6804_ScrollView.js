...
// Function ID: 6805
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6717, 6718, 6737, 6777, 6773]
// Exports: FlatList

// Module 6804 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6773 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6717";
import module_6717 from "module_6717" /* 6717 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6717(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6718).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6717(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6718).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6717(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6717(TextInput);
