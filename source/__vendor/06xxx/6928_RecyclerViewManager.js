...
// Dependencies: [6916, 6917, 6929, 6931, 6932, 6904, 6934, 6945, 6946, 6947]

// Module 6928 (RecyclerViewManager)
import _modDef6917 from "module_6917" /* 6917 */;
import ViewabilityManagerDefault from "ViewabilityManager" /* 6932 */;
  ...
  },
  {
    ...
    value: function getLayout(arg0) {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(6904).ErrorMessages.layoutManagerNotInitializedLayoutInfo);
        throw error;
      }
    }
  },
  ...
  },
  {
    ...
    value: function getChildContainerDimensions() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(6904).ErrorMessages.layoutManagerNotInitializedChildContainer);
        throw error;
      }
    }
  },
  ...
  },
  {
    ...
    value: function getWindowSize() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(6904).ErrorMessages.layoutManagerNotInitializedWindowSize);
        throw error;
      }
    }
  },
    ...
    value: function updateLayoutParams(windowSize, firstItemOffset) {
      ...
      if (this.layoutManager) {
        ...
        if (BooleanResult !== Boolean(self.propsRef.horizontal)) {
          const _Error = Error;
          const error = new Error(RecyclerViewManager(6904).ErrorMessages.horizontalPropCannotBeToggled);
          throw error;
        }
  ...
  },
  {
    ...
    value: function computeVisibleIndices() {
      ...
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(6904).ErrorMessages.layoutManagerNotInitializedVisibleIndices);
        throw error;
      }
    }
  },
    ...
    value: function getLayoutManagerClass() {
      ...
      if (this.propsRef.masonry) {
        if (self.propsRef.horizontal) {
          const _Error2 = Error;
          const error = new Error(RecyclerViewManager(6904).ErrorMessages.masonryAndHorizontalIncompatible);
          throw error;
        }
      }
      if (self.numColumns > 1) {
        if (self.propsRef.horizontal) {
          const _Error = Error;
          const error1 = new Error(RecyclerViewManager(6904).ErrorMessages.numColumnsAndHorizontalIncompatible);
          throw error1;
        }
      }
      if (self.propsRef.masonry) {
        let RVLinearLayoutManagerImpl = RecyclerViewManager(6934).RVMasonryLayoutManagerImpl;
      } else {
        if (self.numColumns > 1) {
          if (!self.propsRef.horizontal) {
            RVLinearLayoutManagerImpl = RecyclerViewManager(6945).RVGridLayoutManagerImpl;
          }
        }
        RVLinearLayoutManagerImpl = RecyclerViewManager(6946).RVLinearLayoutManagerImpl;
      }
  ...
  },
  {
    ...
    value: function checkPropsAndWarn() {
      if (tmp) {
        ...
        console.warn(RecyclerViewManager(6947).WarningMessages.keyExtractorNotDefinedForMVCP);
      }
    }
  }
];

export const RecyclerViewManager = _modDef6917(RecyclerViewManager, items);
