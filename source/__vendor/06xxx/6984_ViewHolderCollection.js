...
// Dependencies: [6928, 19, 21, 6947, 6978, 6982]
// Exports: ViewHolderCollection

// Module 6984 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 6982 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(6947).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(6978).CompatView, { style: tmp19, children: null });
};
