...
// Dependencies: [6907, 19, 21, 6926, 6925]

// Module 6976 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod6925.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod6925.useLayoutState(0), 2);
  ...
  return jsx(_mod6926.RecyclerViewContextProvider, { value, children: children.children });
});
