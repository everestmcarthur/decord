...
// Dependencies: [32, 19, 17, 21, 6838, 6765, 6840, 6827, 6836, 6835, 6814]
// Exports: VirtualDetector

// Module 6839 (VirtualDetector)
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("module_6838").useInterceptingDetectorContext();
    ...
    closure_4(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: tmp, handlerTags, methods: tmp2.gesture.detectorCallbacks, viewRef: "a", userSelect: "Array", touchAction: "useTranslateAnimation", enableContextMenu: "r" };
