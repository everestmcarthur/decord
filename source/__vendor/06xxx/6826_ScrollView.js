...
// Function ID: 6827
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6739, 6740, 6759, 6799, 6795]
// Exports: FlatList

// Module 6826 (ScrollView)
...
const jsx = fn(21).jsx;
let closure_11 = module_6739(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6740).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6739(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6740).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6739(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6739(TextInput);
