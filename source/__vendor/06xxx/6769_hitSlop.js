...
// Function ID: 6770
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6674, 6741, 6770, 6771, 6772, 6773, 6774, 6767, 6682, 6680]
// Exports: default

// Module 6769 (hitSlop)
import _mod6741 from "module_6741" /* 6741 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6770 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6773 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6741.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6770).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6770);
          } else {
