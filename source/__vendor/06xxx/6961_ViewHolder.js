...
// Function ID: 6962
// Name: ViewHolder
// Dependencies: [19, 21, 6924, 6957]

// Module 6961 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_6924").getInvertedTransformStyle(horizontal);
    let obj = require("module_6924");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
