...
// Dependencies: [32, 19, 17, 21, 6926, 6853, 6928, 6915, 6924, 6923, 6902]
// Exports: VirtualDetector

// Module 6927 (VirtualDetector)
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("module_6926").useInterceptingDetectorContext();
    ...
    closure_4(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: tmp, handlerTags, methods: tmp2.gesture.detectorCallbacks, viewRef: "a", userSelect: "a", touchAction: "isArray", enableContextMenu: "alignItems" };
