...
// Dependencies: [32, 19, 17, 21, 6841, 6768, 6843, 6830, 6839, 6838, 6817]
// Exports: VirtualDetector

// Module 6842 (VirtualDetector)
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("module_6841").useInterceptingDetectorContext();
    ...
    closure_4(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: tmp, handlerTags, methods: tmp2.gesture.detectorCallbacks, viewRef: "a", userSelect: 33555259, touchAction: "a", enableContextMenu: "\u00E2ncora" };
