...
// Dependencies: [6916, 6917, 6921, 6922]

// Module 6915 (RenderTimeTracker)
...
const entry = {
  ...
  value: function startTracking() {
    ...
    let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(6922).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
...
const items = [
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(6922).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
...
export const RenderTimeTracker = _modDef6917(RenderTimeTracker, items);
