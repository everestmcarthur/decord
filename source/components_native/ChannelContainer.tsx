...
// Dependencies: [19, 17, 4213, 1957, 2011, 1074, 1954, 21, 4574, 4434, 10110, 504, 9615, 8300, 4394, 1943, 11355, 11356, 9727, 2]
// Exports: ChannelContainer

// Module 10109 (ChannelContainer)
...
import useChannelStylesShared from "useChannelStylesShared" /* 11355 */;
...
export const ChannelContainer = function ChannelContainer(children) {
  ...
  if (isStageChannel) {
    tmp5 = channelId(9615)(stateFromStoresObject.voiceChannelId);
  }
  ...
  const tmp8 = channelId(8300)(isPrivateResult);
  noop = tmp8;
  const tmp9 = channelId(8300)(channelId);
  closure_4 = tmp9;
