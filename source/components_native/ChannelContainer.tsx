...
// Dependencies: [19, 17, 4279, 1958, 2012, 1074, 1955, 21, 4640, 4500, 10228, 504, 9737, 8421, 4460, 1944, 11477, 11478, 9846, 2]
// Exports: ChannelContainer

// Module 10227 (ChannelContainer)
...
import useChannelStylesShared from "useChannelStylesShared" /* 11477 */;
...
export const ChannelContainer = function ChannelContainer(children) {
  ...
  if (isStageChannel) {
    tmp5 = channelId(9737)(stateFromStoresObject.voiceChannelId);
  }
  ...
  const tmp8 = channelId(8421)(isPrivateResult);
  noop = tmp8;
  const tmp9 = channelId(8421)(channelId);
  closure_4 = tmp9;
