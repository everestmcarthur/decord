...
// Function ID: 16972
// Name: MessagePreview
// Dependencies: [19, 8481, 1074, 21, 504, 1115, 16791, 13388, 2]
// Exports: default

// Module 16971 (MessagePreview)
...
export default function MessagePreview(channelId) {
  ...
  return jsx(onBeforeJumpToMessage(13388).ChatPreview, { channelId: channelId.channelId, messages: stateFromStoresObject.messages, jumpToChatProps: memo, analyticsLocation });
};
