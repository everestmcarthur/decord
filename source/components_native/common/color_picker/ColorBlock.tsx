...
// Function ID: 14626
// Name: ColorBlock
// Dependencies: [19, 17, 21, 4574, 576, 1091, 5137, 4423, 1178, 11595, 2]
...
export default noop.memo((color) => {
  ...
  if (null != onSelect) {
    ...
    if (!selected) {
      obj2.children = null;
      let tmp10Result1 = tmp6(tmp2(5137).PressableOpacity, obj2);
    } else {
    ...
    if (!selected) {
      ...
      const obj8 = { source: _modDef11595, color: null };
      if (v < 0.5) {
