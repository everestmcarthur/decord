...
// Function ID: 5045
// Name: common/Alert
// Dependencies: [19, 17, 21, 4605, 576, 1178, 4315, 5045, 4492, 5021, 4601, 1114, 5025, 5173, 5175, 1477, 5176, 2]
// Exports: getAlertButtonVariant

// Module 5044 (common/Alert)
...
Alert.contextType = fn(4315).ThemeContext;
