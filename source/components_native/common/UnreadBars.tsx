...
// Function ID: 16467
// Name: UnreadBars
// Dependencies: [19, 17, 4631, 1074, 21, 4639, 5609, 576, 4489, 4350, 4607, 4608, 1177, 1115, 504, 12558, 2]
// Exports: default

// Module 16466 (UnreadBars)
...
import TransitionGroup from "TransitionGroup" /* 12558 */;
...
UnreadBar.contextType = fn(4350).ThemeContext;
const size = fn(2);
