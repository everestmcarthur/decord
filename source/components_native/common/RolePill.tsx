...
// Function ID: 11199
// Name: RolePill
// Dependencies: [19, 17, 1074, 21, 4722, 576, 1936, 7382, 7385, 4419, 5292, 7399, 7401, 4718, 2]
// Exports: default

// Module 11198 (RolePill)
...
export default function RolePill(role) {
  ...
  if (undefined !== guild_connections) {
    ...
    let tmp10Result = tmp10(combined(7399), obj5);
  ...
  if (null != roleIconProps) {
    ...
    obj9.children = tmp10(combined(7401), obj10);
    tmp10Result2 = tmp10(tmp12, obj9);
    const tmp18 = combined(7401);
  }
  items1[1] = tmp10Result2;
  items1[2] = closure_6(role(4718).Text, { variant: "text-xs/semibold", color: "interactive-text-active", children: name });
