...
// Function ID: 11040
// Name: RolePill
// Dependencies: [19, 17, 1074, 21, 4606, 576, 1935, 7259, 7262, 4304, 5174, 7276, 7278, 4602, 2]
// Exports: default

// Module 11039 (RolePill)
...
export default function RolePill(role) {
  ...
  const roleIconProps = role(7259).useRoleIconProps({ guildId, roleId: role.id, size: 12 });
  let name = role.name;
  let combined = name;
  ...
  if (undefined !== guild_connections) {
    ...
    let tmp10Result = tmp10(combined(7276), obj5);
  ...
  if (null != roleIconProps) {
    ...
    obj9.children = tmp10(combined(7278), obj10);
    tmp10Result2 = tmp10(tmp12, obj9);
    const tmp18 = combined(7278);
  }
  items1[1] = tmp10Result2;
  items1[2] = closure_6(role(4602).Text, { variant: "text-xs/semibold", color: "interactive-text-active", children: name });
  obj4.children = items1;
  obj3.children = closure_7(View, obj4);
  return closure_6(role(5174).PressableHighlight, obj3);
};
