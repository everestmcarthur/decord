...
// Function ID: 11106
// Name: RolePill
// Dependencies: [19, 17, 1074, 21, 4640, 576, 1936, 7300, 7303, 4337, 5210, 7317, 7319, 4636, 2]
// Exports: default

// Module 11105 (RolePill)
...
export default function RolePill(role) {
  ...
  if (undefined !== guild_connections) {
    ...
    let tmp10Result = tmp10(combined(7317), obj5);
  ...
  if (null != roleIconProps) {
    ...
    obj9.children = tmp10(combined(7319), obj10);
    tmp10Result2 = tmp10(tmp12, obj9);
    const tmp18 = combined(7319);
  }
  items1[1] = tmp10Result2;
  items1[2] = closure_6(role(4636).Text, { variant: "text-xs/semibold", color: "interactive-text-active", children: name });
