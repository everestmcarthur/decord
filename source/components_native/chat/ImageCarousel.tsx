...
// Function ID: 10765
// Name: ImageCarousel
// Dependencies: [19, 17, 4980, 4979, 10765, 21, 4639, 576, 4376, 4640, 1177, 5058, 38, 5212, 504, 10766, 10327, 11383, 8364, 4635, 1115, 8395, 7075, 5207, 7045, 1478, 9439, 10768, 2]
// Exports: useTileEntranceAnimatedStyle

// Module 10764 (ImageCarousel)
...
function Tile(onEdit) {
  ...
  const callback4 = obj2.useCallback(() => {
    ...
    if (isThumbnail) {
      ...
      const obj3 = { source: tmp3(11383), size: native.Icon.Sizes.SMALL_14 };
    ...
    if (stateFromStores) {
      ...
      tmp6Result5 = tmp6(tmp3(8364), obj5);
    }
...
const ImageCarouselConstants = fn(10765);
...
export const useTileEntranceAnimatedStyle = function useTileEntranceAnimatedStyle(arg0) {
  ...
  fn.__closure = { withTiming: sharedValue(4640).withTiming, animatedStylePropValue: sharedValue, STANDARD_EASING: sharedValue(1177).STANDARD_EASING, withSpring: sharedValue(5058).withSpring };
  fn.__workletHash = 14458898683767;
