...
// Function ID: 8891
// Name: ChatItem
// Dependencies: [32, 19, 17, 4714, 1074, 8152, 21, 576, 8891, 1090, 8892, 7466, 8893, 4722, 1364, 8356, 4423, 672, 5156, 2]
// Exports: default

// Module 8890 (ChatItem)
...
import AutoModerationSystemMessageViewNativeComponent from "AutoModerationSystemMessageViewNativeComponent" /* 8891 */;
...
function DCDChatItem(message) {
  ...
  if (message.type === MessageTypes.AUTO_MODERATION_ACTION) {
    ...
    if (AUTOMOD_INCIDENT_ACTIONS.has(message.type)) {
      ...
      tmp3Result = closure_1_10(tmp21(8892).default, obj3);
    } else if (isSystemMessageDefault(message)) {
      const obj4 = {};
      const merged3 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8893).default, obj4);
    } else {
      const obj = {};
      const merged4 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8892).default, obj);
    }
  }
  return tmp3Result;
}
...
export const DCDMessageView = fn(8892).default;
export const DCDSystemMessageView = fn(8893).default;
export const DCDAutoModerationSystemMessageView = fn(8891).default;
