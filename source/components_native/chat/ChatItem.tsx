...
// Function ID: 8746
// Name: ChatItem
// Dependencies: [32, 19, 17, 4599, 1074, 8008, 21, 576, 8746, 1089, 8747, 7344, 8748, 4607, 1115, 8212, 4308, 672, 5039, 2]
// Exports: default

// Module 8745 (ChatItem)
...
import AutoModerationSystemMessageViewNativeComponent from "AutoModerationSystemMessageViewNativeComponent" /* 8746 */;
...
function DCDChatItem(message) {
  ...
  if (message.type === MessageTypes.AUTO_MODERATION_ACTION) {
    ...
    if (AUTOMOD_INCIDENT_ACTIONS.has(message.type)) {
      ...
      tmp3Result = closure_1_10(tmp21(8747).default, obj3);
    } else if (isSystemMessageDefault(message)) {
      const obj4 = {};
      const merged3 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8748).default, obj4);
    } else {
      const obj = {};
      const merged4 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8747).default, obj);
    }
  }
  return tmp3Result;
}
...
export const DCDMessageView = fn(8747).default;
export const DCDSystemMessageView = fn(8748).default;
export const DCDAutoModerationSystemMessageView = fn(8746).default;
