...
// Function ID: 8744
// Name: ChatItem
// Dependencies: [32, 19, 17, 4598, 1074, 8007, 21, 576, 8744, 1089, 8745, 7343, 8746, 4606, 1115, 8211, 4308, 672, 5038, 2]
// Exports: default

// Module 8743 (ChatItem)
...
import AutoModerationSystemMessageViewNativeComponent from "AutoModerationSystemMessageViewNativeComponent" /* 8744 */;
...
function DCDChatItem(message) {
  ...
  if (message.type === MessageTypes.AUTO_MODERATION_ACTION) {
    ...
    if (AUTOMOD_INCIDENT_ACTIONS.has(message.type)) {
      ...
      tmp3Result = closure_1_10(tmp21(8745).default, obj3);
    } else if (isSystemMessageDefault(message)) {
      const obj4 = {};
      const merged3 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8746).default, obj4);
    } else {
      const obj = {};
      const merged4 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8745).default, obj);
    }
  }
  return tmp3Result;
}
...
export const DCDMessageView = fn(8745).default;
export const DCDSystemMessageView = fn(8746).default;
export const DCDAutoModerationSystemMessageView = fn(8744).default;
