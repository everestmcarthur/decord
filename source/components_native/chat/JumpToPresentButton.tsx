...
// Dependencies: [19, 17, 9617, 5362, 4860, 21, 4639, 576, 1364, 4341, 504, 9813, 1115, 12402, 12403, 12404, 2]
// Exports: default

// Module 12401 (JumpToPresentButton)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4341 */;
import noop from "module_19" /* 19 */;
import useChatBottomManagerUIStore_mod from "useChatBottomManagerUIStore" /* 9617 */;
...
export default function JumpToPresentButton(channelId) {
  ...
  if (tmp5) {
    ...
    let tmp12Result = tmp12(screenIndex(12402), obj6);
    const tmp16 = screenIndex(12402);
  } else {
    tmp12Result = tmp12(tmp3(12404).MemoedVoicePanelDismissChatButton, {});
  }
