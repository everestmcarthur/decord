...
// Dependencies: [32, 5, 19, 17, 4628, 1956, 7380, 9193, 7210, 7723, 1961, 1975, 1957, 2012, 2021, 1979, 4275, 4285, 4817, 1371, 1074, 1964, 11722, 12598, 12572, 11515, 21, 4636, 576, 5152, 1114, 5154, 5186, 5187, 5159, 5161, 5043, 4632, 4331, 4338, 5204, 11737, 1178, 12599, 8748, 10378, 504, 4481, 8065, 4789, 9868, 7378, 7375, 10755, 4571, 4626, 12600, 12601, 38, 11, 12603, 4334, 9192, 5219, 12607, 5913, 9950, 6333, 2024, 12718, 12721, 8752, 4649, 5056, 12725, 4982, 12726, 7273, 9645, 1242, 9189, 8053, 7222, 7217, 4335, 4603, 12728, 1896, 7265, 12729, 8304, 8296, 7292, 12730, 8308, 7445, 4839, 12747, 5665, 9171, 10998, 12749, 11516, 12756, 8718, 11719, 8496, 4457, 1943, 11731, 11723, 11720, 11721, 11727, 8785, 10161, 7324, 11041, 4579, 12760, 12764, 2]
// Exports: default

// Module 12597 (ChatBeginningRow)
...
import openGroupDMAddMembers from "openGroupDMAddMembers" /* 11719 */;
import showChatGDMUpsellActionSheetDefault from "showChatGDMUpsellActionSheet" /* 11731 */;
import channel_permissions_ChannelPermissionsUtils from "channel_permissions/ChannelPermissionsUtils" /* 11737 */;
import _modDef12599 from "module_12599" /* 12599 */;
...
import PortalAccessibilityWorkaroundViewDefault from "PortalAccessibilityWorkaroundView" /* 12764 */;
...
const ChannelAccessInfoDefault = tmp(12600);
require = fn;
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    ...
    if (isPrivate) {
      let AppsIcon = tmp6(5186).AppsLockIcon;
      let tmp9 = tmp6;
    } else {
      AppsIcon = tmp6(5187).AppsIcon;
      tmp9 = tmp6;
    }
    ...
    if (isPrivate) {
      obj4.IconComponent = tmp17(5159).TextLockIcon;
      obj4.label = tmp17(1114).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj4;
    } else {
      obj4.IconComponent = tmp17(5161).TextIcon;
      obj4.label = tmp17(1114).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj4;
    }
...
function ChatBeginningRowHeader(arg0) {
  ...
  const tmp4 = null != subtitleLink && subtitleLink(5043).useIsScreenReaderEnabled();
  ...
  if (!isGameInvitesPost) {
    ...
    obj4.style = items1;
    obj4.children = title;
    items[1] = closure_44(tmp2(4632).Text, obj4);
    obj3.children = items;
  ...
  if (tmp11Result) {
    ...
    tmp11Result = closure_44(tmp2(4632).Text, obj6);
  }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj3.style = items;
    const obj4 = { source: _modDef12599, size: tmp2(1178).IconSizes.REFRESH_SMALL_16, color: token };
    ...
    items1[1] = closure_44(tmp2(4632).Text, obj5);
    obj3.children = items1;
    isPrivate = tmp6(tmp2(5204).PressableOpacity, obj3);
  }
  ...
  if (canEdit) {
    ...
    const items5 = [closure_44(tmp2(10378).PencilIcon, obj7), ];
    ...
    items5[1] = closure_44(tmp2(4632).Text, obj8);
    obj6.children = items5;
    canEdit = tmp6(tmp2(5204).PressableOpacity, obj6);
  }
  items3[1] = canEdit;
...
function ThreadOwner(arg0) {
  ...
  if (str == null) {
    str = guildId(4481).getName(stateFromStores);
    const obj4 = guildId(4481);
  }
  if (str == null) {
    str = "???";
  }
  ...
  if ("username" === stateFromStores2) {
    ...
    return closure_44(tmp2(4632).Text, obj6);
  } else {
    ...
    items3[1] = closure_44(tmp2(4632).Text, obj9);
...
function ChatBeginningRowThread(channel) {
  ...
  const result = channel(9868).isPrivateGuildChannel(channel);
  const obj = channel(9868);
  const appliedTags = channel(7378).useAppliedTags(channel);
  const obj2 = channel(7378);
  const isGameInvitesPost = channel(7375).useIsGameInvitesPost(channel);
  channel(504);
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp12Result3 = tmp12(tmp4(4632).Text, obj6);
    }
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp8) {
        ...
        tmp12Result4 = tmp12(tmp4(4632).Text, obj8);
      }
    }
...
function DMSpamButton(channel) {
  ...
  const dMMessageToReport = channel(12721).useDMMessageToReport(channel, user.id, true === user.bot);
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return closure_44(tmp(5056).Button, obj2);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      const obj3 = { size: tmp2(1178).Icon.Sizes.SMALL, source: _modDef12725, style: tmp.appDMButtonIcon };
      ...
      tmp4 = closure_44(tmp2(5056).Button, obj2);
    }
  }
  return tmp4;
}
  ...
  if (channel.user.bot) {
    ...
    obj2.onPress = function onPress() {
      if (stateFromStores) {
        ...
        const obj2 = { channel };
        tmp(4603).openLazy(asyncRequireImpl(12728, dependencyMap.paths), "MessageNotificationChannelActionSheet", obj2);
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = closure_47();
  dependencyMap = tmp;
  const analyticsLocations = user(7265)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  let tmp4Result = user(12729)(id);
  id = tmp4Result;
  const tmp4 = user(12729);
  ...
  if (null == user) {
    ...
    userTag = tmp2(4481).getUserTag(user, { decoration: "never", identifiable: "always" });
    const tmp2Result = tmp2(4481);
    const name = tmp2(4481).getName(user);
    ...
    const items5 = [closure_44(tmp7(5204).PressableOpacity, obj5), , , , , , ];
    ...
    obj7.children = closure_44(tmp7(4632).Text, obj8);
    items5[1] = closure_44(tmp7(5204).PressableOpacity, obj7);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj9.children = tmp15(tmp7(4632).Text, obj10);
      tmp15Result = tmp15(tmp7(5204).PressableOpacity, obj9);
    }
    ...
    items5[3] = closure_44(tmp7(4632).Text, obj11);
    let tmp15Result2 = null;
    if (user.isProvisional) {
      let obj12 = { style: tmp.provisionalAccountExplainer, userId: user.id, iconSize: 14 };
      tmp15Result2 = tmp15(tmp7(12756).ChatProvisionalAccountExplainerCard, obj12);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
          ...
          if (null != user) {
            let obj2 = {
              ...
              onPressMutualGuild(arg0) {
                  ...
                  user(4839).popWithKey(closure_1_42);
                }
            };
            ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12730, dependencyMap.paths), "MutualGuildsActionSheet", obj2);
          }
        }
        ...
        let obj14 = {
          size: tmp7(5665).GuildIconSizes.SMALL,
        ...
        const items6 = [tmp15(tmp7(12747).GuildIconPile, obj14), ];
        ...
        items6[1] = tmp15(tmp7(4632).Text, obj15);
        obj13.children = items6;
        tmp18Result = tmp18(tmp7(5204).PressableOpacity, obj13);
      }
    }
    ...
    if (user.isNonUserBot()) {
      ...
      tmp18Result4 = tmp15(function RelationshipButtons(reportButton) {
        ...
        if (stateFromStores === constants8.PENDING_INCOMING) {
          ...
          const items1 = [tmp4(tmp(4632).Text, obj4), ];
          ...
          const items2 = [tmp4(tmp(5056).Button, obj7), , , ];
          ...
          items2[1] = tmp4(tmp(5056).Button, obj8);
          ...
          items2[2] = tmp4(tmp(5056).Button, obj9);
          ...
          if (tmp6.NONE === stateFromStores) {
            ...
            if (!bot) {
              ...
              tmp4Result = tmp4(tmp(5056).Button, obj11);
            }
            ...
            tmp4Result2 = tmp4(tmp(5056).Button, obj12);
            ...
            tmp4Result2 = tmp4(tmp(5056).Button, obj13);
          } else {
            tmp4Result2 = null;
            if (tmp6.PENDING_OUTGOING === stateFromStores) {
              ...
              tmp4Result2 = tmp4(tmp(5056).Button, obj14);
            }
          }
...
function ChatBeginningRowGroupDM(channel) {
  ...
  const callback2 = noop.useCallback(() => {
    ...
    if ("open" === groupDMAddMembersAction) {
      ...
      const result = tmp(11719).showGroupDMAddMembersRoadblock(groupDMAddMembersAction, constants2.CHANNEL_TEXT_AREA);
      const tmpResult2 = tmp(11719);
    }
  }, items3);
  ...
  let obj = channel(504);
  let obj2 = first(11723);
  const obj3 = { location: GroupDMChatBeginning };
  const tmp13 = GroupDMChatBeginning;
  const groupDMNitroAudience = channel(11720).useGroupDMNitroAudience();
  ...
  let obj4 = channel(11720);
  if (stateFromStores) {
    enabled = tmp7(11720).isGroupDMNitroUpsellAudience(groupDMNitroAudience);
    const tmp7Result = tmp7(11720);
  }
  if (enabled) {
  ...
  tmp16 = first(11721)({ useNitroCapExperiment: true });
  obj5.acquisitionStrategy = channel(11720).GroupDMNitroAcquisitionStrategy.MARKETING;
  const tmp2Result = first(11727);
  ...
  const tmp2ResultResult = first(11727)(obj5);
  obj7.size = channel(1178).AvatarSizes.XXLARGE;
  const items5 = [closure_44(first(11041), obj7), , , ];
  ...
  const tmp23 = channel.id === channel(7324).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj8.variant = str;
  obj8.children = arr;
  items5[1] = closure_44(channel(4632).Text, obj8);
  ...
  items5[2] = closure_44(channel(4632).Text, obj9);
  let tmp19Result = null;
  if (!tmp23) {
    if (enabled) {
      const obj11 = { style: tmp.gdmInviteFriends, onPress: tmp2ResultResult, IconComponent: tmp7(8785).NitroWheelIcon, iconVariant: "default", title: null, subtitle: null };
      ...
      tmp21Result = null;
      if (stateFromStores) {
        const obj13 = { style: tmp.gdmInviteFriends, onPress: callback2, IconComponent: tmp7(10161).GroupPlusIcon, iconVariant: "default", title: null };
    ...
    obj14.IconComponent = tmp7(4579).LinkIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      tmp21Result4 = tmp21(tmp2(12760), obj15);
    }
...
let closure_42 = fn(12572).MOBILE_MESSAGE_REQUESTS_MODAL_KEY;
let closure_43 = fn(11515).BLOCK_CONFIRMATION_ACTION_SHEET_KEY;
const jsxProd = fn(21);
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              let base64;
              tmp5(9192).init(id);
              const obj7 = tmp5(9192);
              const obj5 = { size };
              dependencyMap = 1;
              c3 = 1;
              const obj6 = { value: tmp5(5219).openImagePicker(obj5), done: false };
              return obj6;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            base64 = value.base64;
            if (null != base64) {
              tmp5(9192).updateIcon(closure_129_2, base64);
              const obj = tmp5(9192);
              tmp5(9192).open(closure_129_2, constants.LANDING);
              const obj2 = tmp5(9192);
            }
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
