...
// Dependencies: [32, 5, 19, 17, 4598, 1956, 7350, 9154, 7180, 7693, 1961, 1975, 1957, 2012, 2021, 1979, 4245, 4255, 4787, 1371, 1074, 1964, 11686, 12562, 12536, 11476, 21, 4606, 576, 5122, 1114, 5124, 5156, 5157, 5129, 5131, 5013, 4602, 4301, 4308, 5174, 11701, 1178, 12563, 8716, 10339, 504, 4451, 8035, 4759, 9829, 7348, 7345, 10716, 4541, 4596, 12564, 12565, 38, 11, 12567, 4304, 9153, 5189, 12571, 5883, 9911, 6303, 2024, 12682, 12685, 8720, 4619, 5026, 12689, 4952, 12690, 7243, 9606, 1242, 9150, 8023, 7192, 7187, 4305, 4573, 12692, 1896, 7235, 12693, 8272, 8264, 7262, 12694, 8276, 7415, 4809, 12711, 5635, 9132, 10959, 12713, 11477, 12720, 8686, 11683, 8464, 4427, 1943, 11695, 11687, 11684, 11685, 11691, 8753, 10122, 7294, 11002, 4549, 12724, 12728, 2]
// Exports: default

// Module 12561 (ChatBeginningRow)
...
import ThreadIcon from "ThreadIcon" /* 5124 */;
...
import openGroupDMAddMembers from "openGroupDMAddMembers" /* 11683 */;
import showChatGDMUpsellActionSheetDefault from "showChatGDMUpsellActionSheet" /* 11695 */;
import channel_permissions_ChannelPermissionsUtils from "channel_permissions/ChannelPermissionsUtils" /* 11701 */;
import _modDef12563 from "module_12563" /* 12563 */;
...
import PortalAccessibilityWorkaroundViewDefault from "PortalAccessibilityWorkaroundView" /* 12728 */;
...
const ChannelAccessInfoDefault = tmp(12564);
require = fn;
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    ...
    if (isPrivate) {
      let AppsIcon = tmp6(5156).AppsLockIcon;
      let tmp9 = tmp6;
    } else {
      AppsIcon = tmp6(5157).AppsIcon;
      tmp9 = tmp6;
    }
    ...
    if (isPrivate) {
      obj4.IconComponent = tmp17(5129).TextLockIcon;
      obj4.label = tmp17(1114).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj4;
    } else {
      obj4.IconComponent = tmp17(5131).TextIcon;
      obj4.label = tmp17(1114).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj4;
    }
...
function ChatBeginningRowHeader(arg0) {
  ...
  const tmp4 = null != subtitleLink && subtitleLink(5013).useIsScreenReaderEnabled();
  ...
  if (!isGameInvitesPost) {
    ...
    obj4.style = items1;
    obj4.children = title;
    items[1] = closure_44(tmp2(4602).Text, obj4);
    obj3.children = items;
  ...
  if (tmp11Result) {
    ...
    tmp11Result = closure_44(tmp2(4602).Text, obj6);
  }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj3.style = items;
    const obj4 = { source: _modDef12563, size: tmp2(1178).IconSizes.REFRESH_SMALL_16, color: token };
    ...
    items1[1] = closure_44(tmp2(4602).Text, obj5);
    obj3.children = items1;
    isPrivate = tmp6(tmp2(5174).PressableOpacity, obj3);
  }
  ...
  if (canEdit) {
    ...
    const items5 = [closure_44(tmp2(10339).PencilIcon, obj7), ];
    ...
    items5[1] = closure_44(tmp2(4602).Text, obj8);
    obj6.children = items5;
    canEdit = tmp6(tmp2(5174).PressableOpacity, obj6);
  }
  items3[1] = canEdit;
...
function ThreadOwner(arg0) {
  ...
  if ("username" === stateFromStores2) {
    ...
    return closure_44(tmp2(4602).Text, obj6);
  } else {
    ...
    items3[1] = closure_44(tmp2(4602).Text, obj9);
...
function ChatBeginningRowThread(channel) {
  ...
  const appliedTags = channel(7348).useAppliedTags(channel);
  const obj2 = channel(7348);
  const isGameInvitesPost = channel(7345).useIsGameInvitesPost(channel);
  channel(504);
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp12Result3 = tmp12(tmp4(4602).Text, obj6);
    }
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp8) {
        ...
        tmp12Result4 = tmp12(tmp4(4602).Text, obj8);
      }
    }
...
function DMSpamButton(channel) {
  ...
  const dMMessageToReport = channel(12685).useDMMessageToReport(channel, user.id, true === user.bot);
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return closure_44(tmp(5026).Button, obj2);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      const obj3 = { size: tmp2(1178).Icon.Sizes.SMALL, source: _modDef12689, style: tmp.appDMButtonIcon };
      ...
      tmp4 = closure_44(tmp2(5026).Button, obj2);
    }
  }
  return tmp4;
}
  ...
  if (channel.user.bot) {
    ...
    obj2.onPress = function onPress() {
      if (stateFromStores) {
        ...
        const obj2 = { channel };
        tmp(4573).openLazy(asyncRequireImpl(12692, dependencyMap.paths), "MessageNotificationChannelActionSheet", obj2);
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = closure_47();
  dependencyMap = tmp;
  const analyticsLocations = user(7235)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  let tmp4Result = user(12693)(id);
  id = tmp4Result;
  const tmp4 = user(12693);
  ...
  if (null == user) {
    ...
    const items5 = [closure_44(tmp7(5174).PressableOpacity, obj5), , , , , , ];
    ...
    obj7.children = closure_44(tmp7(4602).Text, obj8);
    items5[1] = closure_44(tmp7(5174).PressableOpacity, obj7);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj9.children = tmp15(tmp7(4602).Text, obj10);
      tmp15Result = tmp15(tmp7(5174).PressableOpacity, obj9);
    }
    ...
    items5[3] = closure_44(tmp7(4602).Text, obj11);
    let tmp15Result2 = null;
    if (user.isProvisional) {
      let obj12 = { style: tmp.provisionalAccountExplainer, userId: user.id, iconSize: 14 };
      tmp15Result2 = tmp15(tmp7(12720).ChatProvisionalAccountExplainerCard, obj12);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
          ...
          if (null != user) {
            let obj2 = {
              ...
              onPressMutualGuild(arg0) {
                  ...
                  user(4809).popWithKey(closure_1_42);
                }
            };
            ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12694, dependencyMap.paths), "MutualGuildsActionSheet", obj2);
          }
        }
        ...
        let obj14 = {
          size: tmp7(5635).GuildIconSizes.SMALL,
        ...
        const items6 = [tmp15(tmp7(12711).GuildIconPile, obj14), ];
        ...
        items6[1] = tmp15(tmp7(4602).Text, obj15);
        obj13.children = items6;
        tmp18Result = tmp18(tmp7(5174).PressableOpacity, obj13);
      }
    }
    ...
    if (user.isNonUserBot()) {
      ...
      tmp18Result4 = tmp15(function RelationshipButtons(reportButton) {
        ...
        if (stateFromStores === constants8.PENDING_INCOMING) {
          ...
          const items1 = [tmp4(tmp(4602).Text, obj4), ];
          ...
          const items2 = [tmp4(tmp(5026).Button, obj7), , , ];
          ...
          items2[1] = tmp4(tmp(5026).Button, obj8);
          ...
          items2[2] = tmp4(tmp(5026).Button, obj9);
          ...
          if (tmp6.NONE === stateFromStores) {
            ...
            if (!bot) {
              ...
              tmp4Result = tmp4(tmp(5026).Button, obj11);
            }
            ...
            tmp4Result2 = tmp4(tmp(5026).Button, obj12);
            ...
            tmp4Result2 = tmp4(tmp(5026).Button, obj13);
          } else {
            tmp4Result2 = null;
            if (tmp6.PENDING_OUTGOING === stateFromStores) {
              ...
              tmp4Result2 = tmp4(tmp(5026).Button, obj14);
            }
          }
...
function ChatBeginningRowGroupDM(channel) {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (first) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp2(8464).mobileCreateInvite(channel, constants.GROUP_DM), done: false };
              return obj5;
            }
          }
        } else if (arg0 === 1) {
  ...
  const callback2 = noop.useCallback(() => {
    ...
    if ("open" === groupDMAddMembersAction) {
      ...
      const result = tmp(11683).showGroupDMAddMembersRoadblock(groupDMAddMembersAction, constants2.CHANNEL_TEXT_AREA);
      const tmpResult2 = tmp(11683);
    }
  }, items3);
  ...
  let obj = channel(504);
  let obj2 = first(11687);
  const obj3 = { location: GroupDMChatBeginning };
  const tmp13 = GroupDMChatBeginning;
  const groupDMNitroAudience = channel(11684).useGroupDMNitroAudience();
  ...
  let obj4 = channel(11684);
  if (stateFromStores) {
    enabled = tmp7(11684).isGroupDMNitroUpsellAudience(groupDMNitroAudience);
    const tmp7Result = tmp7(11684);
  }
  if (enabled) {
  ...
  tmp16 = first(11685)({ useNitroCapExperiment: true });
  obj5.acquisitionStrategy = channel(11684).GroupDMNitroAcquisitionStrategy.MARKETING;
  const tmp2Result = first(11691);
  ...
  const tmp2ResultResult = first(11691)(obj5);
  obj7.size = channel(1178).AvatarSizes.XXLARGE;
  const items5 = [closure_44(first(11002), obj7), , , ];
  ...
  const tmp23 = channel.id === channel(7294).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj8.variant = str;
  obj8.children = arr;
  items5[1] = closure_44(channel(4602).Text, obj8);
  ...
  items5[2] = closure_44(channel(4602).Text, obj9);
  let tmp19Result = null;
  if (!tmp23) {
    if (enabled) {
      const obj11 = { style: tmp.gdmInviteFriends, onPress: tmp2ResultResult, IconComponent: tmp7(8753).NitroWheelIcon, iconVariant: "default", title: null, subtitle: null };
      ...
      tmp21Result = null;
      if (stateFromStores) {
        const obj13 = { style: tmp.gdmInviteFriends, onPress: callback2, IconComponent: tmp7(10122).GroupPlusIcon, iconVariant: "default", title: null };
    ...
    obj14.IconComponent = tmp7(4549).LinkIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      tmp21Result4 = tmp21(tmp2(12724), obj15);
    }
...
const GuildProgressConstants = fn(12562);
({ AnalyticsActions: closure_40, AnalyticsSetupTypes: closure_41 } = GuildProgressConstants);
let closure_42 = fn(12536).MOBILE_MESSAGE_REQUESTS_MODAL_KEY;
let closure_43 = fn(11476).BLOCK_CONFIRMATION_ACTION_SHEET_KEY;
const jsxProd = fn(21);
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              let base64;
              tmp5(9153).init(id);
              const obj7 = tmp5(9153);
              const obj5 = { size };
              dependencyMap = 1;
              c3 = 1;
              const obj6 = { value: tmp5(5189).openImagePicker(obj5), done: false };
              return obj6;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            base64 = value.base64;
            if (null != base64) {
              tmp5(9153).updateIcon(closure_129_2, base64);
              const obj = tmp5(9153);
              tmp5(9153).open(closure_129_2, constants.LANDING);
              const obj2 = tmp5(9153);
            }
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
