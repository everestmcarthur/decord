...
// Function ID: 10191
// Name: StreamPreview
// Dependencies: [19, 17, 1182, 21, 4639, 576, 4350, 4491, 10191, 10192, 1115, 5207, 10193, 504, 2]
// Exports: default

// Module 10190 (StreamPreview)
...
DefaultFallback.prototype["render"] = function render() {
  ...
  if (obj3.isThemeDark(this.props.theme)) {
    let tmp6Result = tmp6(10191);
  } else {
    tmp6Result = tmp6(10192);
  }
