...
// Function ID: 10210
// Name: StreamPreview
// Dependencies: [19, 17, 1182, 21, 4640, 576, 4350, 4491, 10210, 10211, 1115, 5210, 10212, 504, 2]
// Exports: default

// Module 10209 (StreamPreview)
...
DefaultFallback.prototype["render"] = function render() {
  ...
  if (obj3.isThemeDark(this.props.theme)) {
    let tmp6Result = tmp6(10210);
  } else {
    tmp6Result = tmp6(10211);
  }
  obj2.source = tmp6Result;
  obj.children = timestampProducer(React3, obj2);
  return timestampProducer(React4, obj);
};
DefaultFallback.contextType = fn(4350).ThemeContext;
...
StreamPreview.contextType = fn(4350).ThemeContext;
