...
// Function ID: 10199
// Name: StreamPreview
// Dependencies: [19, 17, 1182, 21, 4638, 576, 4348, 4489, 10199, 10200, 1115, 5208, 10201, 504, 2]
// Exports: default

// Module 10198 (StreamPreview)
...
DefaultFallback.prototype["render"] = function render() {
  ...
  if (obj3.isThemeDark(this.props.theme)) {
    let tmp6Result = tmp6(10199);
  } else {
    tmp6Result = tmp6(10200);
  }
  obj2.source = tmp6Result;
  obj.children = timestampProducer(React3, obj2);
  return timestampProducer(React4, obj);
};
DefaultFallback.contextType = fn(4348).ThemeContext;
...
StreamPreview.contextType = fn(4348).ThemeContext;
