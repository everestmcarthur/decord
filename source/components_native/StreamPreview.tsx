...
// Function ID: 10304
// Name: StreamPreview
// Dependencies: [19, 17, 1182, 21, 4722, 576, 4432, 4573, 10304, 10305, 1115, 5292, 10306, 504, 2]
// Exports: default

// Module 10303 (StreamPreview)
...
DefaultFallback.prototype["render"] = function render() {
  ...
  if (obj3.isThemeDark(this.props.theme)) {
    let tmp6Result = tmp6(10304);
  } else {
    tmp6Result = tmp6(10305);
  }
  obj2.source = tmp6Result;
  obj.children = timestampProducer(React3, obj2);
  return timestampProducer(React4, obj);
};
DefaultFallback.contextType = fn(4432).ThemeContext;
...
StreamPreview.contextType = fn(4432).ThemeContext;
