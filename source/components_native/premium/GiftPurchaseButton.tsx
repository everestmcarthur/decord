...
// Dependencies: [5, 19, 17, 4303, 7351, 21, 5068, 4636, 504, 7354, 11208, 7276, 10895, 4985, 1115, 4297, 10810, 5063, 13680, 2]
// Exports: default

// Module 13679 (GiftPurchaseButton)
...
export default function GiftPurchaseButton(style) {
  ...
  const callback = analyticsLocations.useCallback(productIdForGift(function*() {
    ...
    planId(10810).openGiftModal({ recipientUserId: closure_129_2, premiumType, planInterval, analyticsLocation: closure_129_1, analyticsLocations: closure_129_4, order: closure_128_0 });
