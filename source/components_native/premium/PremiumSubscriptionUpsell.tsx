...
// Dependencies: [19, 17, 2025, 1371, 1074, 7505, 1373, 21, 4606, 576, 4557, 1114, 1880, 504, 4264, 5038, 1093, 4602, 13593, 13594, 9482, 5026, 2]
// Exports: default

// Module 13592 (PremiumSubscriptionUpsell)
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4602).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4602).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4602).Text, obj9);
    }
    const items3 = [tmp6Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: tmp5(13593) };
    const items4 = [closure_1_10(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: tmp5(13594) };
    ...
    obj15.IconComponent = tmp2(4557).CheckmarkLargeIcon;
    const intl4 = tmp2(1114).intl;
    const obj16 = { discountPercentage: null };
    const tmp5Result4 = tmp5(9482);
    ...
    const items5 = [obj15, ];
    const obj17 = { IconComponent: tmp2(4557).CheckmarkLargeIcon, label: null, color: null };
    ...
    tmp = tmp6(tmp2(5026).Button, obj20);
    obj19.children = tmp;
