...
// Dependencies: [19, 17, 2025, 1371, 1074, 7506, 1373, 21, 4607, 576, 4558, 1114, 1880, 504, 4264, 5039, 1093, 4603, 13595, 13596, 9484, 5027, 2]
// Exports: default

// Module 13594 (PremiumSubscriptionUpsell)
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4603).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4603).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4603).Text, obj9);
    }
    const items3 = [tmp6Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: tmp5(13595) };
    const items4 = [closure_1_10(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: tmp5(13596) };
    ...
    tmp5Result3 = tmp5(4264);
    obj15.IconComponent = tmp2(4558).CheckmarkLargeIcon;
    const intl4 = tmp2(1114).intl;
    const obj16 = { discountPercentage: null };
    const tmp5Result4 = tmp5(9484);
    ...
    const items5 = [obj15, ];
    const obj17 = { IconComponent: tmp2(4558).CheckmarkLargeIcon, label: null, color: null };
    ...
    tmp = tmp6(tmp2(5027).Button, obj20);
    obj19.children = tmp;
