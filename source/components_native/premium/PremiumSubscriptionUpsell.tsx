...
// Dependencies: [19, 17, 2026, 1372, 1074, 7542, 1374, 21, 4638, 576, 4588, 1115, 1881, 504, 4295, 5072, 1094, 4634, 13644, 13645, 9534, 5060, 2]
// Exports: default

// Module 13643 (PremiumSubscriptionUpsell)
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4634).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4634).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4634).Text, obj9);
    }
    const items3 = [tmp6Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: tmp5(13644) };
    const items4 = [closure_1_10(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: tmp5(13645) };
    ...
    tmp5Result3 = tmp5(4295);
    obj15.IconComponent = tmp2(4588).CheckmarkLargeIcon;
    const intl4 = tmp2(1115).intl;
    const obj16 = { discountPercentage: null };
    const tmp5Result4 = tmp5(9534);
    ...
    const items5 = [obj15, ];
    const obj17 = { IconComponent: tmp2(4588).CheckmarkLargeIcon, label: null, color: null };
    ...
    tmp = tmp6(tmp2(5060).Button, obj20);
    obj19.children = tmp;
