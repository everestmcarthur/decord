...
// Dependencies: [19, 17, 2026, 1372, 1074, 7628, 1374, 21, 4722, 576, 4672, 1115, 1881, 504, 4380, 5156, 1094, 4718, 13743, 13744, 9629, 5144, 2]
// Exports: default
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4718).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4718).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4718).Text, obj9);
    }
    const items3 = [tmp6Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: tmp5(13743) };
    const items4 = [closure_1_10(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: tmp5(13744) };
    ...
    tmp5Result3 = tmp5(4380);
    obj15.IconComponent = tmp2(4672).CheckmarkLargeIcon;
    const intl4 = tmp2(1115).intl;
    const obj16 = { discountPercentage: null };
    const tmp5Result4 = tmp5(9629);
    ...
    const items5 = [obj15, ];
    const obj17 = { IconComponent: tmp2(4672).CheckmarkLargeIcon, label: null, color: null };
    ...
    tmp = tmp6(tmp2(5144).Button, obj20);
    obj19.children = tmp;
