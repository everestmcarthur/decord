...
// Dependencies: [19, 17, 2026, 1372, 1074, 7539, 1374, 21, 4639, 576, 4590, 1115, 1881, 504, 4297, 5071, 1094, 4635, 13632, 13633, 9523, 5059, 2]
// Exports: default

// Module 13631 (PremiumSubscriptionUpsell)
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4635).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4635).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4635).Text, obj9);
    }
    const items3 = [tmp6Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: tmp5(13632) };
    const items4 = [closure_1_10(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: tmp5(13633) };
    ...
    tmp5Result3 = tmp5(4297);
    obj15.IconComponent = tmp2(4590).CheckmarkLargeIcon;
    const intl4 = tmp2(1115).intl;
    const obj16 = { discountPercentage: null };
    const tmp5Result4 = tmp5(9523);
    ...
    const items5 = [obj15, ];
    const obj17 = { IconComponent: tmp2(4590).CheckmarkLargeIcon, label: null, color: null };
    ...
    tmp = tmp6(tmp2(5059).Button, obj20);
    obj19.children = tmp;
