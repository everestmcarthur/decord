...
// Dependencies: [19, 17, 2026, 1372, 1074, 7546, 1374, 21, 4640, 576, 4590, 1115, 1881, 504, 4297, 5074, 1094, 4636, 13652, 13653, 9545, 5062, 2]
// Exports: default

// Module 13651 (PremiumSubscriptionUpsell)
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4636).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4636).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4636).Text, obj9);
    }
    const items3 = [tmp6Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: tmp5(13652) };
    const items4 = [closure_1_10(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: tmp5(13653) };
    ...
    tmp = tmp6(tmp2(5062).Button, obj20);
    obj19.children = tmp;
