...
// Dependencies: [32, 19, 17, 1980, 5523, 5521, 21, 4639, 576, 5526, 1484, 504, 5527, 7230, 7483, 1115, 5519, 5207, 5669, 1177, 2]
// Exports: default

// Module 5522 (SubscribeModalGuildSelect)
...
import SearchBarNavDefault from "SearchBarNav" /* 7483 */;
...
let closure_9 = fn(5521).PremiumGuildSubscribeModalScenes;
const jsxProd = fn(21);
...
obj2.guildName = { marginLeft: 32, fontSize: 16, lineHeight: 20, color: fn(5526).DARK_WHITE_500_LIGHT_PRIMARY_660 };
...
export default function SubscribeModalGuildSelect(guildBoostSlots) {
  ...
  obj5.children = closure_10(guildBoostSlots(7230).SafeAreaPaddingView, {
    bottom: true,
  ...
  return closure_11(guildBoostSlots(7230).SafeAreaPaddingView, obj3);
};
