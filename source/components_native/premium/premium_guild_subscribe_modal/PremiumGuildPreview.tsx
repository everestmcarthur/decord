...
// Dependencies: [19, 17, 1183, 1074, 21, 4607, 576, 5493, 4458, 13666, 13667, 13668, 13669, 13670, 13671, 13672, 13673, 1178, 4501, 504, 5636, 2]
// Exports: default

// Module 13665 (PremiumGuildPreview)
...
function PremiumGuildTierPill(arg0) {
  ...
  if (BoostedGuildTiers.NONE === tier) {
    let tmp22 = _modDef13667;
    const tmp21 = _modDef13666;
    ...
    let tmp17 = _modDef13669;
    const tmp16 = _modDef13668;
    ...
    let tmp12 = _modDef13671;
    const tmp11 = _modDef13670;
    ...
    let tmp8 = _modDef13673;
    const tmp26 = _modDef13672;
...
obj2.guildName = { fontSize: 16, lineHeight: 20, color: fn(5493).DARK_WHITE_500_LIGHT_BLACK_500 };
let obj4 = { fontSize: 16, lineHeight: 20, color: fn(5493).DARK_WHITE_500_LIGHT_BLACK_500 };
...
obj2.tierPillText = { fontSize: 12, lineHeight: 16, marginLeft: 4, color: fn(5493).DARK_WHITE_500_LIGHT_PRIMARY_660 };
