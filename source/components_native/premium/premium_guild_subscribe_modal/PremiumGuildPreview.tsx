...
// Dependencies: [19, 17, 1182, 1074, 21, 4640, 576, 5529, 4491, 13721, 13722, 13723, 13724, 13725, 13726, 13727, 13728, 1177, 4533, 504, 5672, 2]
// Exports: default

// Module 13720 (PremiumGuildPreview)
...
function PremiumGuildTierPill(arg0) {
  ...
  if (BoostedGuildTiers.NONE === tier) {
    let tmp22 = _modDef13722;
    const tmp21 = _modDef13721;
    ...
    let tmp17 = _modDef13724;
    const tmp16 = _modDef13723;
    ...
    let tmp12 = _modDef13726;
    const tmp11 = _modDef13725;
    ...
    let tmp8 = _modDef13728;
    const tmp26 = _modDef13727;
...
obj2.guildName = { fontSize: 16, lineHeight: 20, color: fn(5529).DARK_WHITE_500_LIGHT_BLACK_500 };
let obj4 = { fontSize: 16, lineHeight: 20, color: fn(5529).DARK_WHITE_500_LIGHT_BLACK_500 };
...
obj2.tierPillText = { fontSize: 12, lineHeight: 16, marginLeft: 4, color: fn(5529).DARK_WHITE_500_LIGHT_PRIMARY_660 };
