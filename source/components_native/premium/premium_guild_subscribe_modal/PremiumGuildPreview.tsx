...
// Dependencies: [19, 17, 1183, 1074, 21, 4636, 576, 5522, 4488, 13698, 13699, 13700, 13701, 13702, 13703, 13704, 13705, 1178, 4530, 504, 5665, 2]
// Exports: default

// Module 13697 (PremiumGuildPreview)
...
function PremiumGuildTierPill(arg0) {
  ...
  if (BoostedGuildTiers.NONE === tier) {
    let tmp22 = _modDef13699;
    const tmp21 = _modDef13698;
    ...
    let tmp17 = _modDef13701;
    const tmp16 = _modDef13700;
    ...
    let tmp12 = _modDef13703;
    const tmp11 = _modDef13702;
    ...
    let tmp8 = _modDef13705;
    const tmp26 = _modDef13704;
...
obj2.guildName = { fontSize: 16, lineHeight: 20, color: fn(5522).DARK_WHITE_500_LIGHT_BLACK_500 };
let obj4 = { fontSize: 16, lineHeight: 20, color: fn(5522).DARK_WHITE_500_LIGHT_BLACK_500 };
...
obj2.tierPillText = { fontSize: 12, lineHeight: 16, marginLeft: 4, color: fn(5522).DARK_WHITE_500_LIGHT_PRIMARY_660 };
