...
// Dependencies: [5, 19, 17, 12655, 1979, 4501, 4270, 1074, 7505, 4496, 21, 4606, 4456, 576, 504, 4500, 5648, 4602, 1114, 13662, 13663, 5026, 13672, 5038, 1093, 1242, 13627, 38, 4504, 4951, 13676, 1896, 2]
// Exports: default

// Module 13661 (SubscribeModalConfirmation)
...
import PremiumGuildPreviewDefault from "PremiumGuildPreview" /* 13663 */;
...
function PendingCancellationWarning(slots) {
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      const obj3 = { style: tmp.pendingCancellationIcon, source: _modDef5648 };
      ...
      items1[1] = closure_1_19(tmp2(4602).Text, obj4);
...
function SubscribeConfirmation(arg0) {
  ...
  const items = [closure_1_19(timestampProducer, { style: tmp.subscribeImage, source: _modDef13662 }), , , , , ];
...
function TransferConfirmation(previousGuildSubscriptionSlots) {
  ...
  const tmp = closure_22();
  const guildSubscriptionRemovalSource = prop(13672).useGuildSubscriptionRemovalSource();
  const obj = prop(13672);
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_19(tmp2(4602).Text, obj6);
    ...
    items1[2] = closure_19(tmp2(4602).Text, obj7);
    ...
    const items2 = [closure_19(tmp2(4602).Text, obj10), , , ];
    const obj11 = { style: tmp.guildPreview, guild: stateFromStores };
    items2[1] = closure_19(onPremiumGuildSubscribe(13663), obj11);
    ...
    items2[2] = closure_19(tmp2(4602).Text, obj12);
    ...
    const obj15 = { guild };
    obj14.children = closure_19(onPremiumGuildSubscribe(13663), obj15);
    items2[3] = closure_19(onPremiumGuildSubscribe(5038), obj14);
    ...
    obj17.children = closure_19(tmp2(5026).Button, obj18);
    items1[5] = closure_19(closure_7, obj17);
    obj4.children = items1;
    tmp8 = closure_20(closure_21, obj4);
    const tmp15 = onPremiumGuildSubscribe(5038);
  }
  return tmp8;
}
...
const BoostPurchaseIntent = fn(4496).BoostPurchaseIntent;
const jsxProd = fn(21);
