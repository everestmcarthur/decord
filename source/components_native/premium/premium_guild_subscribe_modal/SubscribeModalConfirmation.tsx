...
// Dependencies: [5, 19, 17, 12632, 1979, 4500, 4268, 1074, 7484, 4495, 21, 4605, 4454, 576, 504, 4499, 5647, 4601, 1114, 13683, 13684, 5025, 13693, 5037, 1093, 1242, 13650, 38, 4503, 4950, 13697, 1896, 2]
// Exports: default

// Module 13682 (SubscribeModalConfirmation)
...
import PremiumGuildPreviewDefault from "PremiumGuildPreview" /* 13684 */;
...
function PendingCancellationWarning(slots) {
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      const obj3 = { style: tmp.pendingCancellationIcon, source: _modDef5647 };
      ...
      items1[1] = closure_1_19(tmp2(4601).Text, obj4);
...
function SubscribeConfirmation(arg0) {
  ...
  const items = [closure_1_19(timestampProducer, { style: tmp.subscribeImage, source: _modDef13683 }), , , , , ];
...
function TransferConfirmation(previousGuildSubscriptionSlots) {
  ...
  const tmp = closure_22();
  const guildSubscriptionRemovalSource = prop(13693).useGuildSubscriptionRemovalSource();
  const obj = prop(13693);
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_19(tmp2(4601).Text, obj6);
    ...
    items1[2] = closure_19(tmp2(4601).Text, obj7);
    ...
    const items2 = [closure_19(tmp2(4601).Text, obj10), , , ];
    const obj11 = { style: tmp.guildPreview, guild: stateFromStores };
    items2[1] = closure_19(onPremiumGuildSubscribe(13684), obj11);
    ...
    items2[2] = closure_19(tmp2(4601).Text, obj12);
    ...
    const obj15 = { guild };
    obj14.children = closure_19(onPremiumGuildSubscribe(13684), obj15);
    items2[3] = closure_19(onPremiumGuildSubscribe(5037), obj14);
    ...
    obj17.children = closure_19(tmp2(5025).Button, obj18);
