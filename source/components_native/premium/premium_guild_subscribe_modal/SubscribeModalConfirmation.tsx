...
// Dependencies: [5, 19, 17, 12657, 1979, 4502, 4270, 1074, 7506, 4497, 21, 4607, 4456, 576, 504, 4501, 5649, 4603, 1114, 13664, 13665, 5027, 13674, 5039, 1093, 1242, 13629, 38, 4505, 4952, 13678, 1896, 2]
// Exports: default

// Module 13663 (SubscribeModalConfirmation)
...
import PremiumGuildPreviewDefault from "PremiumGuildPreview" /* 13665 */;
...
function PendingCancellationWarning(slots) {
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      const obj3 = { style: tmp.pendingCancellationIcon, source: _modDef5649 };
      ...
      items1[1] = closure_1_19(tmp2(4603).Text, obj4);
...
function SubscribeConfirmation(arg0) {
  ...
  const items = [closure_1_19(timestampProducer, { style: tmp.subscribeImage, source: _modDef13664 }), , , , , ];
...
function TransferConfirmation(previousGuildSubscriptionSlots) {
  ...
  const tmp = closure_22();
  const guildSubscriptionRemovalSource = prop(13674).useGuildSubscriptionRemovalSource();
  const obj = prop(13674);
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_19(tmp2(4603).Text, obj6);
    ...
    items1[2] = closure_19(tmp2(4603).Text, obj7);
    ...
    const items2 = [closure_19(tmp2(4603).Text, obj10), , , ];
    const obj11 = { style: tmp.guildPreview, guild: stateFromStores };
    items2[1] = closure_19(onPremiumGuildSubscribe(13665), obj11);
    ...
    items2[2] = closure_19(tmp2(4603).Text, obj12);
    ...
    const obj15 = { guild };
    obj14.children = closure_19(onPremiumGuildSubscribe(13665), obj15);
    items2[3] = closure_19(onPremiumGuildSubscribe(5039), obj14);
    ...
    obj17.children = closure_19(tmp2(5027).Button, obj18);
    items1[5] = closure_19(closure_7, obj17);
    obj4.children = items1;
    tmp8 = closure_20(closure_21, obj4);
    const tmp15 = onPremiumGuildSubscribe(5039);
  }
  return tmp8;
}
...
const BoostPurchaseIntent = fn(4497).BoostPurchaseIntent;
const jsxProd = fn(21);
