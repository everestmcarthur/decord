...
// Dependencies: [32, 19, 17, 1185, 1371, 1074, 9414, 1373, 21, 4606, 576, 4317, 4602, 7520, 1114, 4264, 9405, 9406, 4541, 4458, 9441, 9442, 9443, 9444, 9394, 9445, 9446, 9447, 9448, 504, 7273, 9449, 9404, 1477, 7235, 7255, 5043, 1242, 9450, 4503, 5045, 1178, 5638, 9451, 9452, 9408, 2]
...
function GlobalEmojiUpsell(arg0) {
  ...
  const obj6 = { image: _modDef9405, title: null, description: null };
...
function AnimatedEmojiUpsell(alertWidth) {
  ...
  const obj2 = { image: _modDef9406, title: null, description: null };
...
function PremiumGuildIdentityUpsell(alertWidth) {
  ...
  if (obj3.isThemeDark(tmp5)) {
    let tmp4Result = tmp4(9441);
  } else {
    tmp4Result = tmp4(9442);
  }
...
function CustomProfilesUpsell(alertWidth) {
  ...
  const obj3 = { image: _modDef9443, title: null, description: null };
  const intl = util.intl;
...
function GlobalStickerUpsell(alertWidth) {
  const obj = { alertWidth: alertWidth.alertWidth, upsellItem: null };
  const obj2 = { image: _modDef9444, title: null, description: null };
  const intl = util.intl;
...
function LongerMessageUpsell(alertWidth) {
  ...
  if (obj3.isThemeDark(tmp5)) {
    let tmp4Result = tmp4(9445);
  } else {
    tmp4Result = tmp4(9446);
  }
  const obj4 = { image: tmp4Result, title: null, description: null };
  const intl = tmp(1114).intl;
...
function UploadUpsell(arg0) {
  ...
  if (_slicedToArray(noop.useState(!stateFromStores), 1)[0]) {
    ...
    tmp6Result = closure_1_14(tmp(7273).TableSwitchRow, obj2);
  }
