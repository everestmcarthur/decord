...
// Dependencies: [19, 17, 5523, 1374, 21, 4639, 576, 13594, 1115, 9507, 13616, 13617, 13619, 9884, 13620, 8886, 13621, 10244, 13622, 12665, 13623, 9503, 13624, 10366, 504, 13490, 13625, 4574, 13458, 4491, 13467, 13468, 4635, 9523, 13629, 13630, 13631, 2]
// Exports: default
...
export default function GuildBoostingUpsell(arg0) {
  ...
  if (tmp2Result.isThemeDark(tmp8)) {
    let tmp7Result = tmp7(13467);
  } else {
    tmp7Result = tmp7(13468);
  }
  ...
  if (isInReverseTrial) {
    ...
    if (subscriptionPlansLoaded) {
      ...
      tmp13Result2 = tmp13(tmp7(13631), obj20);
    }
    ...
    if (stateFromStores) {
      ...
      const items5 = [tmp13(tmp2(4635).Text, obj22), , ];
      ...
      items5[1] = tmp13(tmp2(4635).Text, obj23);
      const obj24 = { style: tmp.guildList };
      items5[2] = tmp13(tmp7(13630), obj24);
      ...
      items7[1] = tmp13(tmp2(4635).Text, obj26);
      ...
      items7[2] = tmp13(tmp2(4635).Text, obj27);
