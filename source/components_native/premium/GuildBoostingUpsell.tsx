...
// Dependencies: [19, 17, 5489, 1373, 21, 4606, 576, 13555, 1114, 9466, 13577, 13578, 13580, 9843, 13581, 8848, 13582, 10203, 13583, 12623, 13584, 9462, 13585, 10324, 504, 13451, 13586, 4541, 13419, 4458, 13428, 13429, 4602, 9482, 13590, 13591, 13592, 2]
// Exports: default

// Module 13576 (GuildBoostingUpsell)
...
import StickerIcon from "StickerIcon" /* 10203 */;
...
import useSubscriptionPlansLoaded from "useSubscriptionPlansLoaded" /* 13451 */;
...
import GuildSubscriptionNoGuilds from "GuildSubscriptionNoGuilds" /* 13586 */;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  const items1 = [React5(React4, { style: tmp.imgPremiumGuild, source: _modDef13419 }), , , ];
  const obj7 = { style: tmp.logoPremiumGuild, source: null };
  const obj6 = { style: tmp.imgPremiumGuild, source: _modDef13419 };
  if (tmp2Result.isThemeDark(tmp8)) {
    let tmp7Result = tmp7(13428);
  } else {
    tmp7Result = tmp7(13429);
  }
  ...
  const items3 = [obj14, , , , ];
  const obj15 = { icon: _modDef13582, label: null, IconComponent: null, color: null };
  ...
  items3[1] = obj15;
  const obj16 = { icon: _modDef13583, label: null, color: "#4173da", IconComponent: null };
  const intl7 = tmp2(1114).intl;
  obj16.label = intl7.string(util.t.rFNkf5);
  obj16.IconComponent = HeadphonesIcon.HeadphonesIcon;
  items3[2] = obj16;
  const obj17 = { icon: _modDef13584, label: null, IconComponent: null, color: null };
  ...
  items3[3] = obj17;
  const obj18 = { icon: _modDef13585, label: null, IconComponent: null, color: null };
  ...
  if (isInReverseTrial) {
    ...
    if (subscriptionPlansLoaded) {
      ...
      tmp13Result2 = tmp13(tmp7(13592), obj20);
    }
    ...
    if (stateFromStores) {
      ...
      const items5 = [tmp13(tmp2(4602).Text, obj22), , ];
      ...
      items5[1] = tmp13(tmp2(4602).Text, obj23);
      const obj24 = { style: tmp.guildList };
      items5[2] = tmp13(tmp7(13591), obj24);
      ...
      items7[1] = tmp13(tmp2(4602).Text, obj26);
      ...
      items7[2] = tmp13(tmp2(4602).Text, obj27);
