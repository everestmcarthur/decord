...
// Dependencies: [19, 17, 5524, 1374, 21, 4638, 576, 13606, 1115, 9518, 13628, 13629, 13631, 9892, 13632, 8897, 13633, 10252, 13634, 12673, 13635, 9514, 13636, 10374, 504, 13501, 13637, 4572, 13469, 4489, 13478, 13479, 4634, 9534, 13641, 13642, 13643, 2]
// Exports: default

// Module 13627 (GuildBoostingUpsell)
...
import BoostTier3Icon from "BoostTier3Icon" /* 13629 */;
...
import GuildSubscriptionNoGuilds from "GuildSubscriptionNoGuilds" /* 13637 */;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  const items1 = [React5(React4, { style: tmp.imgPremiumGuild, source: _modDef13469 }), , , ];
  const obj7 = { style: tmp.logoPremiumGuild, source: null };
  const obj6 = { style: tmp.imgPremiumGuild, source: _modDef13469 };
  if (tmp2Result.isThemeDark(tmp8)) {
    let tmp7Result = tmp7(13478);
  } else {
    tmp7Result = tmp7(13479);
  }
  ...
  const items3 = [obj14, , , , ];
  const obj15 = { icon: _modDef13633, label: null, IconComponent: null, color: null };
  ...
  items3[1] = obj15;
  const obj16 = { icon: _modDef13634, label: null, color: "#4173da", IconComponent: null };
  const intl7 = tmp2(1115).intl;
  obj16.label = intl7.string(util.t.rFNkf5);
  obj16.IconComponent = HeadphonesIcon.HeadphonesIcon;
  items3[2] = obj16;
  const obj17 = { icon: _modDef13635, label: null, IconComponent: null, color: null };
  ...
  items3[3] = obj17;
  const obj18 = { icon: _modDef13636, label: null, IconComponent: null, color: null };
  ...
  if (isInReverseTrial) {
    ...
    if (subscriptionPlansLoaded) {
      ...
      tmp13Result2 = tmp13(tmp7(13643), obj20);
    }
    ...
    if (stateFromStores) {
      ...
      const items5 = [tmp13(tmp2(4634).Text, obj22), , ];
      ...
      items5[1] = tmp13(tmp2(4634).Text, obj23);
      const obj24 = { style: tmp.guildList };
      items5[2] = tmp13(tmp7(13642), obj24);
      ...
      items7[1] = tmp13(tmp2(4634).Text, obj26);
      ...
      items7[2] = tmp13(tmp2(4634).Text, obj27);
