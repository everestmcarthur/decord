...
// Dependencies: [19, 17, 4868, 502, 11583, 4302, 5598, 1074, 1374, 21, 4640, 576, 4350, 11584, 4636, 1115, 5062, 7340, 8982, 1177, 7286, 11314, 7323, 13348, 13350, 13351, 13349, 13352, 13353, 13354, 13355, 11183, 13356, 13359, 13360, 13675, 504, 11595, 2]

// Module 13674 (EntitlementGiftGroupCard)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import Text_Text from "Text/Text" /* 4636 */;
import components_Button_Button from "components/Button/Button" /* 5062 */;
import GameIconDefault from "GameIcon" /* 7286 */;
...
import GiftCodeActionCreatorsDefault from "GiftCodeActionCreators" /* 11584 */;
import SubscriptionUtils from "SubscriptionUtils" /* 11595 */;
...
import GiftCodeRowDefault from "GiftCodeRow" /* 13675 */;
...
prototype["renderHeader"] = function renderHeader(source, children) {
  ...
  if (isOpen) {
    let ChevronSmallRightIcon = tmp2(11314).ChevronSmallDownIcon;
  } else {
    ChevronSmallRightIcon = tmp2(7323).ChevronSmallRightIcon;
  }
...
EntitlementGiftGroupCard.contextType = fn(4350).ThemeContext;
