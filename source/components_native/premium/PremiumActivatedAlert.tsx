...
// Dependencies: [19, 17, 1074, 21, 4639, 5526, 4297, 10843, 10844, 10845, 10846, 10847, 9517, 10848, 10849, 10850, 10851, 10852, 10853, 8176, 10854, 4491, 10855, 10856, 10857, 10858, 10859, 10860, 10861, 10862, 10863, 1115, 4574, 5078, 10864, 10865, 1177, 2]
// Exports: default

// Module 10842 (PremiumActivatedAlert)
...
export default function PremiumActivatedAlert(onClose) {
  ...
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result10 = tmp4(10843);
  } else if (tmp7(4297).Branding.TIER_1 === premiumBranding) {
    tmp4Result10 = tmp4(10844);
  } else if (tmp7(4297).Branding.TIER_2 === premiumBranding) {
    tmp4Result10 = tmp4(10845);
  } else if (tmp7(4297).Branding.BUNDLE === premiumBranding) {
    tmp4Result10 = tmp4(10846);
  } else if (tmp7(4297).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result10 = tmp4(10847);
  }
  obj7.source = tmp4Result10;
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result11 = tmp4(10852);
  } else if (tmp7(4297).Branding.TIER_1 === premiumBranding) {
    tmp4Result11 = tmp4(10853);
  } else {
    if (tmp7(4297).Branding.BUNDLE !== premiumBranding) {
      if (tmp7(4297).Branding.TIER_2 !== premiumBranding) {
        if (tmp7(4297).Branding.PREMIUM_GUILD === premiumBranding) {
          tmp4Result11 = tmp4(10854);
        }
      }
    }
    tmp4Result11 = tmp4(8176);
  }
  const items = [React5(React3, { source: tmp4Result11, style: tmp9.logo }), , ];
  let tmp16Result = null;
  if (premiumBranding === PremiumUtils.Branding.BUNDLE) {
    const obj9 = { source: tmp4(10864), style: tmp.logoPlusPremiumGuild };
    tmp16Result = tmp16(tmp17, obj9);
  }
  items[1] = tmp16Result;
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result12 = tmp4(9517);
  } else if (tmp7(4297).Branding.TIER_1 === premiumBranding) {
    tmp4Result12 = tmp4(10848);
  } else if (tmp7(4297).Branding.TIER_2 === premiumBranding) {
    tmp4Result12 = tmp4(10849);
  } else if (tmp7(4297).Branding.BUNDLE === premiumBranding) {
    tmp4Result12 = tmp4(10850);
  } else if (tmp7(4297).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result12 = tmp4(10851);
  }
