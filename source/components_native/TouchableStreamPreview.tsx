...
// Dependencies: [19, 17, 4656, 4661, 502, 1958, 1980, 4278, 4658, 1074, 21, 4639, 4489, 576, 4784, 504, 1115, 5496, 4781, 4841, 4840, 4691, 5076, 10190, 4635, 2]
// Exports: default

// Module 10189 (TouchableStreamPreview)
...
const StreamKeyUtils = tmp5(4691);
require = fn;
function StreamPreviewContainer(disableTransition) {
  ...
  const callback = channel.useCallback(() => {
    ...
    if (disableTransition) {
      const result = tmp(4840).rebuildRTCActiveChannels();
