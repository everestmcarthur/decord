...
import { FAMILY_CENTER_LINK_REQUEST_REGEX as closure_7 } from "items" /* 7538 */;
...
export default function QRScannerModal(showHelp) {
  ...
  if (tmp) {
    ...
    if (!tmp3) {
      ...
      obj4[1] = intl2.string(tmp17(1114).t.dklV0G);
      obj2[1] = tmp14(tmp17(1178).LegacyText, obj4);
