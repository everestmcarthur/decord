...
// Dependencies: [19, 17, 1958, 1980, 4662, 10169, 4678, 1372, 4664, 21, 4639, 4489, 576, 1177, 504, 4792, 10171, 10170, 573, 7230, 5059, 1115, 2]
// Exports: default

// Module 10168 (RTCDebugOverlay)
...
function RTCDebugGeneral() {
  ...
  const obj6 = { obj: null };
  const tmp4 = channelId(4792)(stateFromStores1);
  const tmp6 = Section;
  const tmp7 = ObjectKV;
  obj4.name = name;
  obj6.obj = { guild: obj4, channel: { id: channelId, name: channelId(4792)(stateFromStores1) } };
...
export default function RTCDebugOverlay(arg0) {
  ...
  const effect = noop.useEffect(() => {
    ...
    return () => closure_1_1(573).wait(closure_1_2(10170).close);
  }, []);
