...
// Dependencies: [19, 17, 1958, 1980, 4661, 10177, 4677, 1372, 4663, 21, 4638, 4487, 576, 1177, 504, 4791, 10179, 10178, 573, 7233, 5060, 1115, 2]
// Exports: default

// Module 10176 (RTCDebugOverlay)
...
function RTCDebugGeneral() {
  ...
  const obj6 = { obj: null };
  const tmp4 = channelId(4791)(stateFromStores1);
  const tmp6 = Section;
  const tmp7 = ObjectKV;
  obj4.name = name;
  obj6.obj = { guild: obj4, channel: { id: channelId, name: channelId(4791)(stateFromStores1) } };
...
export default function RTCDebugOverlay(arg0) {
  ...
  const effect = noop.useEffect(() => {
    ...
    return () => closure_1_1(573).wait(closure_1_2(10178).close);
  }, []);
