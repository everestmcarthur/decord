...
// Dependencies: [19, 17, 1957, 1979, 4629, 10128, 4645, 1371, 4631, 21, 4606, 4456, 576, 1178, 504, 4759, 10130, 10129, 573, 7196, 5026, 1114, 2]
// Exports: default
...
function RTCDebugGeneral() {
  ...
  const obj6 = { obj: null };
  const tmp4 = channelId(4759)(stateFromStores1);
  const tmp6 = Section;
  const tmp7 = ObjectKV;
  obj4.name = name;
  obj6.obj = { guild: obj4, channel: { id: channelId, name: channelId(4759)(stateFromStores1) } };
