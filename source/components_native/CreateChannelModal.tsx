...
// Dependencies: [32, 19, 17, 1962, 1976, 1958, 1980, 4278, 4288, 1372, 1074, 8522, 21, 4639, 576, 5164, 5172, 5185, 5181, 5178, 5171, 5190, 5162, 5170, 5182, 5180, 5177, 5169, 5189, 1115, 4635, 2025, 4358, 5690, 5774, 8719, 1177, 7088, 504, 38, 4792, 5500, 9865, 9866, 1484, 9867, 4819, 5709, 9869, 7484, 9870, 12, 9873, 5057, 6711, 5772, 9874, 9881, 7307, 5179, 4784, 9882, 1249, 9895, 5683, 7107, 2]
// Exports: default

// Module 9864 (CreateChannelModal)
...
function ChannelTypeRow(selected) {
  ...
  if (ChannelTypes.GUILD_TEXT === channelType) {
    ...
    const items = [closure_1_20(tmp2(4635).Text, obj10), ];
    ...
    items[1] = closure_1_20(tmp2(4635).Text, obj11);
    obj9.children = items;
  ...
  if (true === isBeta) {
    ...
    const items1 = [tmp7(tmp2(8719).FormLabel, obj17), ];
...
obj4[ChannelTypes.GUILD_TEXT] = { IconComponent: fn(5164).TextIcon };
let obj5 = { IconComponent: fn(5164).TextIcon };
obj4[ChannelTypes.GUILD_FORUM] = { IconComponent: fn(5172).ForumIcon };
let obj6 = { IconComponent: fn(5172).ForumIcon };
obj4[ChannelTypes.GUILD_VOICE] = { IconComponent: fn(5185).VoiceNormalIcon };
let obj7 = { IconComponent: fn(5185).VoiceNormalIcon };
obj4[ChannelTypes.GUILD_STAGE_VOICE] = { IconComponent: fn(5181).StageIcon };
let obj8 = { IconComponent: fn(5181).StageIcon };
obj4[ChannelTypes.GUILD_ANNOUNCEMENT] = { IconComponent: fn(5178).AnnouncementsIcon };
let obj9 = { IconComponent: fn(5178).AnnouncementsIcon };
obj4[ChannelTypes.GUILD_MEDIA] = { IconComponent: fn(5171).ImageIcon };
let obj10 = { IconComponent: fn(5171).ImageIcon };
obj4[ChannelTypes.GUILD_APP] = { IconComponent: fn(5190).AppsIcon };
let obj12 = {};
let obj11 = { IconComponent: fn(5190).AppsIcon };
obj12[ChannelTypes.GUILD_TEXT] = { IconComponent: fn(5162).TextLockIcon };
let obj13 = { IconComponent: fn(5162).TextLockIcon };
obj12[ChannelTypes.GUILD_FORUM] = { IconComponent: fn(5170).ForumLockIcon };
let obj14 = { IconComponent: fn(5170).ForumLockIcon };
obj12[ChannelTypes.GUILD_VOICE] = { IconComponent: fn(5182).VoiceLockIcon };
let obj15 = { IconComponent: fn(5182).VoiceLockIcon };
obj12[ChannelTypes.GUILD_STAGE_VOICE] = { IconComponent: fn(5180).StageLockIcon };
let obj16 = { IconComponent: fn(5180).StageLockIcon };
obj12[ChannelTypes.GUILD_ANNOUNCEMENT] = { IconComponent: fn(5177).AnnouncementsLockIcon };
let obj17 = { IconComponent: fn(5177).AnnouncementsLockIcon };
obj12[ChannelTypes.GUILD_MEDIA] = { IconComponent: fn(5169).ImageLockIcon };
let obj18 = { IconComponent: fn(5169).ImageLockIcon };
obj12[ChannelTypes.GUILD_APP] = { IconComponent: fn(5189).AppsLockIcon };
