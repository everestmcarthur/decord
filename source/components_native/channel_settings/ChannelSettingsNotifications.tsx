...
// Dependencies: [19, 1962, 1958, 4559, 4288, 4821, 1372, 1074, 21, 1115, 4640, 576, 4350, 4820, 7233, 4607, 10290, 1897, 7228, 4793, 5775, 5693, 10292, 7314, 5773, 5776, 4636, 8748, 5060, 504, 10293, 10294, 2]
// Exports: default

// Module 10289 (ChannelSettingsNotifications)
...
import NotificationSettingsChannelDefault from "NotificationSettingsChannel" /* 10294 */;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(10292).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(10292).MuteSettingType.CHANNEL;
    }
    obj7.type = CHANNEL;
...
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(5773).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(5776).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(5776).TableRadioRow, obj3);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(5776).TableRadioRow, obj4);
    obj.children = items;
    ...
    items1[1] = tmp12(tmp7(5776).TableRadioRow, obj6);
    ...
    items1[2] = tmp12(tmp7(5776).TableRadioRow, obj7);
    ...
    items1[3] = tmp12(tmp7(5776).TableRadioRow, obj8);
    obj.children = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5775).TableRowGroup, obj7);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj6.children = items;
