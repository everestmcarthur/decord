...
// Dependencies: [19, 1962, 1958, 4641, 4371, 4903, 1372, 1074, 21, 1115, 4722, 576, 4432, 4902, 7315, 4689, 10384, 1897, 7310, 4875, 5857, 5775, 10386, 7396, 5855, 5858, 4718, 8831, 5142, 504, 10387, 10388, 2]
// Exports: default

// Module 10383 (ChannelSettingsNotifications)
...
import NotificationSettingsChannelDefault from "NotificationSettingsChannel" /* 10388 */;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(10386).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(10386).MuteSettingType.CHANNEL;
    }
    obj7.type = CHANNEL;
...
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(5855).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(5858).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(5858).TableRadioRow, obj3);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(5858).TableRadioRow, obj4);
    obj.children = items;
    ...
    items1[1] = tmp12(tmp7(5858).TableRadioRow, obj6);
    ...
    items1[2] = tmp12(tmp7(5858).TableRadioRow, obj7);
    ...
    items1[3] = tmp12(tmp7(5858).TableRadioRow, obj8);
    obj.children = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5857).TableRowGroup, obj7);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj6.children = items;
...
ChannelSettingsNotifications.contextType = fn(4432).ThemeContext;
const size = fn(2);
