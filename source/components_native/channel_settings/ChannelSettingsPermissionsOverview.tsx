...
// Dependencies: [32, 5, 19, 17, 2017, 1958, 2016, 1980, 4288, 1372, 1074, 21, 4640, 576, 4984, 1115, 4793, 4283, 11760, 9891, 8780, 12, 5775, 5693, 15270, 1484, 12904, 10417, 15429, 504, 1895, 11100, 17075, 5669, 7984, 4653, 2]
// Exports: default

// Module 17074 (ChannelSettingsPermissionsOverview)
...
import RoleLabel from "RoleLabel" /* 10417 */;
import DetailedGuildIdentityUserRowDefault from "DetailedGuildIdentityUserRow" /* 11100 */;
import CircleMinusIcon from "CircleMinusIcon" /* 15429 */;
import useGetOrFetchChannelOverwriteUsersDefault from "useGetOrFetchChannelOverwriteUsers" /* 17075 */;
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const syncedPermissionOverwrites = obj8.getSyncedPermissionOverwrites(tmp5, tmp2(11760).getAppChannelBotUserId(tmp2));
              closure_128_0 = syncedPermissionOverwrites;
              const obj9 = tmp2(11760);
              c2 = 1;
              c3 = 1;
              const obj5 = { value: tmp2(9891).checkChattableChannelThresholdMetAfterChannelPermissionDeny(tmp2, syncedPermissionOverwrites[guild_id].deny, syncedPermissionOverwrites[guild_id].allow), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
...
function RoleRow(onDelete) {
  ...
  if (isEditing) {
    ...
    if (!tmp) {
      ...
      tmp2Result = tmp2(tmp3(15429).CircleMinusIcon, obj2);
    }
  }
  obj.icon = tmp2Result;
  onDelete = onSelect;
