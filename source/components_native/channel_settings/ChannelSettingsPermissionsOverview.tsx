...
// Dependencies: [32, 5, 19, 17, 2017, 1958, 2016, 1980, 4286, 1372, 1074, 21, 4638, 576, 4982, 1115, 4791, 4281, 11752, 9880, 8760, 12, 5773, 5691, 15265, 1484, 12896, 10409, 15424, 504, 1895, 11092, 17036, 5667, 7978, 4651, 2]
// Exports: default

// Module 17035 (ChannelSettingsPermissionsOverview)
...
import DetailedGuildIdentityUserRowDefault from "DetailedGuildIdentityUserRow" /* 11092 */;
import CircleMinusIcon from "CircleMinusIcon" /* 15424 */;
import useGetOrFetchChannelOverwriteUsersDefault from "useGetOrFetchChannelOverwriteUsers" /* 17036 */;
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const syncedPermissionOverwrites = obj8.getSyncedPermissionOverwrites(tmp5, tmp2(11752).getAppChannelBotUserId(tmp2));
              closure_128_0 = syncedPermissionOverwrites;
              const obj9 = tmp2(11752);
              c2 = 1;
              c3 = 1;
              const obj5 = { value: tmp2(9880).checkChattableChannelThresholdMetAfterChannelPermissionDeny(tmp2, syncedPermissionOverwrites[guild_id].deny, syncedPermissionOverwrites[guild_id].allow), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
...
function RoleRow(onDelete) {
  ...
  if (isEditing) {
    ...
    if (!tmp) {
      ...
      tmp2Result = tmp2(tmp3(15424).CircleMinusIcon, obj2);
    }
  }
  obj.icon = tmp2Result;
  onDelete = onSelect;
