...
// Dependencies: [32, 5, 19, 17, 2016, 1957, 2015, 1979, 4222, 1371, 1074, 21, 4574, 576, 4918, 1114, 4727, 4217, 11641, 9772, 8658, 12, 5701, 5619, 15188, 1483, 12783, 10302, 15344, 504, 1894, 10974, 16866, 5595, 7877, 4587, 2]
// Exports: default

// Module 16865 (ChannelSettingsPermissionsOverview)
...
import RoleLabel from "RoleLabel" /* 10302 */;
...
import useGetOrFetchChannelOverwriteUsersDefault from "useGetOrFetchChannelOverwriteUsers" /* 16866 */;
...
function ChannelPermissionSyncModule(channel) {
  ...
  const callback = noop.useCallback(() => {
    ...
    obj2.title = intl.string(channel(1114).t.YWMtRe);
    const intl2 = channel(1114).intl;
    let obj3 = { channelName: null, categoryName: null };
    let obj = category(4918);
    obj3.channelName = channel(4727).computeChannelName(closure_0, UserStore, RelationshipStore, true);
    let obj4 = channel(4727);
    obj3.categoryName = channel(4727).computeChannelName(category, UserStore, RelationshipStore);
    obj2.body = intl2.format(channel(1114).t["iKW+jY"], obj3);
    const intl3 = channel(1114).intl;
    obj2.confirmText = intl3.string(channel(1114).t.eW8Gy4);
    const intl4 = channel(1114).intl;
    obj2.cancelText = intl4.string(channel(1114).t.s4uM3b);
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const syncedPermissionOverwrites = obj8.getSyncedPermissionOverwrites(tmp5, tmp2(11641).getAppChannelBotUserId(tmp2));
              closure_128_0 = syncedPermissionOverwrites;
              const obj9 = tmp2(11641);
              c2 = 1;
              c3 = 1;
              const obj5 = { value: tmp2(9772).checkChattableChannelThresholdMetAfterChannelPermissionDeny(tmp2, syncedPermissionOverwrites[guild_id].deny, syncedPermissionOverwrites[guild_id].allow), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
  ...
  const channelName = channel(4727).computeChannelName(category, UserStore, RelationshipStore);
  ...
  let obj6 = { icon: closure_16(channel(15188).RefreshIcon, {}), label: null, onPress: null };
  let intl2 = tmp3(1114).intl;
  obj6.label = intl2.string(channel(1114).t.NVwuHq);
  obj6.onPress = callback;
  obj5.children = closure_16(channel(5619).TableRow, obj6);
  obj2.children = closure_16(channel(5701).TableRowGroup, obj5);
...
function AddPermission(isEditing) {
  ...
  if (isEditing.isEditing) {
    ...
    const obj4 = { icon: closure_16(tmp2(12783).PlusMediumIcon, {}), label: null, onPress: null };
    const intl2 = tmp2(1114).intl;
    obj4.label = intl2.string(tmp2(1114).t.fVWxvT);
    obj4.onPress = function onPress() {
      closure_0.push(constants2.NEW_PERMISSION, { type: constants.ROLE });
    };
    const items = [closure_16(tmp2(5619).TableRow, obj4), ];
    const obj5 = { icon: closure_16(tmp2(12783).PlusMediumIcon, {}), label: null, onPress: null };
    const intl3 = tmp2(1114).intl;
    obj5.label = intl3.string(tmp2(1114).t.riesLt);
    obj5.onPress = function onPress() {
      closure_0.push(constants2.NEW_PERMISSION, { type: constants.MEMBER });
    };
    items[1] = closure_16(tmp2(5619).TableRow, obj5);
    obj3.children = items;
    obj2.children = closure_17(tmp2(5701).TableRowGroup, obj3);
    return closure_16(View, obj2);
  }
...
function RoleRow(onDelete) {
  ...
  if (isEditing) {
    ...
    if (!tmp) {
      ...
      tmp2Result = tmp2(tmp3(15344).CircleMinusIcon, obj2);
    }
  }
  obj.icon = tmp2Result;
  onDelete = onSelect;
...
function RoleOverwrites(guild) {
  ...
  const intl = tmp2(1114).intl;
  obj5.title = intl.string(guild(1114).t["LPJmL/"]);
  ...
  obj4.children = closure_16(guild(5701).TableRowGroup, obj5);
...
function MemberOverwrites(channel) {
  ...
  if (valueResult.length > 0) {
    ...
    obj3.title = intl.string(guild_id(1114).t["9Oq93m"]);
    ...
    obj2.children = closure_16(guild_id(5701).TableRowGroup, obj3);
