...
// Dependencies: [5, 19, 17, 4247, 1961, 1975, 8717, 1957, 2012, 1979, 4245, 4621, 16896, 4255, 1371, 16897, 1074, 1964, 7346, 1113, 1085, 21, 4606, 576, 504, 11046, 4317, 12, 16898, 4786, 1114, 5675, 7936, 8716, 4305, 9657, 9832, 7347, 4259, 1384, 4458, 16899, 9831, 4951, 4602, 9153, 4759, 5045, 4465, 4507, 16900, 6677, 7158, 1115, 5738, 7273, 4817, 5658, 14231, 16901, 9396, 4252, 9833, 16902, 5736, 5739, 1966, 1968, 2024, 4751, 5656, 7342, 9843, 9867, 11406, 4549, 1967, 16903, 7166, 11025, 15009, 10122, 7837, 4569, 4559, 5146, 11048, 4547, 4564, 5024, 11343, 8172, 8957, 5174, 16225, 8684, 1483, 2]
// Exports: default
...
import ThreadAutoArchive from "ThreadAutoArchive" /* 9396 */;
import _modDef9657 from "module_9657" /* 9657 */;
import sanitizeChannelNameDefault from "sanitizeChannelName" /* 9832 */;
import AppChannelApplicationSelectorDefault from "AppChannelApplicationSelector" /* 9833 */;
...
import threadActionSheets from "threadActionSheets" /* 11406 */;
...
const MAX_FORUM_TAGS = fn(7346).MAX_FORUM_TAGS;
      ...
      if (channel.state.hasChanges) {
        ...
        ChannelSettingsActionCreatorsDefault.saveChannel(channel.id, obj4).then((status) => {
          if (200 === status.status) {
            ...
            let goBackResult = { key: "THREAD_SETTINGS_UPDATED", icon: _modDef9657, content: null };
    ...
    tmp1.handleBlurName = function handleBlurName() {
      ...
      if (channel.isThread()) {
        ...
        if (tmp3 !== channel.name) {
          ...
          tmp(8716).updateChannel(obj2);
          closure_0.setState({ hasChanges: true });
          const tmpResult = tmp(8716);
        }
        tmp = importDefault;
      }
    };
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj4 = { value: tmp2(9831).isDefaultChannelThresholdMetAfterDelete(channel.getGuildId(), channel.id), done: false };
              return obj4;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            if (null != guild2) {
              ...
              if (features.has(constants.COMMUNITY)) {
                if (guild2.rulesChannelId === closure_128_1.id) {
                  ...
                  const items = [closure_1_47(tmp2(4602).Text, obj9), ];
                  ...
                  items[1] = closure_1_47(tmp2(4602).Text, obj10);
                  obj8.children = items;
            ...
            if (null != guild2) {
              if (!closure_128_3) {
                ...
                const items1 = [closure_1_47(tmp2(4602).Text, obj16), ];
                ...
                items1[1] = closure_1_47(tmp2(4602).Text, obj17);
                obj15.children = items1;
                obj12.children = closure_1_48(closure_1_49, obj15);
                tmp5(4951).show(obj12);
                const obj7 = tmp5(4951);
              }
            }
            const obj13 = tmp2(4759);
            ...
            obj19.confirmColor = tmp5(5045).Colors.RED;
            tmp5(4951).show(obj19);
            const obj14 = tmp5(4951);
          }
        } catch (tmp129) {
          c3 = tmp;
          throw tmp129;
...
prototype["updateNavigation"] = function updateNavigation(submitting, hasChanges) {
  ...
  if (isThread) {
    ...
    if (submitting) {
      let fn = tmp3(5675).HeaderSubmittingIndicator;
    } else {
      fn = (arg0) => {
        const obj = {};
...
prototype["renderChannelInfo"] = function renderChannelInfo() {
  ...
  const TextInput = tmp3(6677).TextInput;
  ...
  if (set5.has(channel.type)) {
    ...
    if (canManageChannels) {
      ...
      if (!obj.isIOS()) {
        ...
        obj3.value = tmp2(4817).isChannelOrGuildNSFW(channel);
        ...
        obj2.children = closure_1_47(tmp2(7273).TableSwitchRow, obj3);
        tmp = tmp4(tmp2(5738).TableRowGroup, obj2, "nsfw-section");
        const tmp2Result = tmp2(4817);
      }
      obj = PlatformUtils;
    }
  }
...
prototype["renderUserLimitSettings"] = function renderUserLimitSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (props.canManageChannels) {
      ...
      const items1 = [closure_1_47(tmp7(4602).Text, obj5), ];
      const obj6 = { variant: "text-md/medium", color: "text-muted", children: stringResult };
      items1[1] = closure_1_47(tmp7(4602).Text, obj6);
      obj4.children = items1;
      const items2 = [__V(View, obj4), ];
      ...
      items2[1] = closure_1_47(tmp7(14231).Slider, obj7);
      obj3.children = items2;
      obj2.children = __V(tmp7(5658).Card, obj3);
      items.push(closure_1_47(tmp7(5738).TableRowGroup, obj2, "channel-user-limit"));
      return items;
    }
  }
  return null;
    ...
    if (self.showVoiceSettings()) {
      if (tmp) {
        if (!channel.isGuildStageVoice()) {
          ...
          obj2.trailing = closure_47(channel(5656).TableRow.TrailingText, obj3);
          obj2.disabled = tmp2;
          obj2.onPress = function onPress() {
            return self.pushScreen(constants2.CHANGE_RTC_REGION);
          };
          obj.children = closure_47(channel(5656).TableRow, obj2);
          items.push(closure_47(channel(5738).TableRowGroup, obj, "channel-region-override"));
          return items;
        }
      }
    }
...
prototype["renderPermissions"] = function renderPermissions() {
  ...
  if (!this.props.canManageRoles) {
    ...
    ShieldUserIcon = ShieldUserIcon(9843).ShieldUserIcon;
    ...
    obj.children = closure_47(self(5656).TableRow, obj2);
    closure_47(self(5738).TableRowGroup, obj);
  }
};
...
prototype["renderCommonSettingsSection"] = function renderCommonSettingsSection() {
  ...
  if (tmp2) {
    ...
    obj.icon = closure_47(channel(9867).BellIcon, {});
    ...
    items.push(closure_47(channel(5656).TableRow, obj, "rowNotifications"));
  }
  if (closure_8(channel.type)) {
    ...
    items.push(closure_47(channel(5656).TableRow, obj2, "rowPinnedMessages"));
  }
  if (canManageChannels) {
  ...
  if (canManageChannels) {
    ...
    obj4.icon = closure_47(channel(4549).LinkIcon, {});
    obj4.onPress = function onPress() {
      return self.pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(closure_47(channel(5656).TableRow, obj4, "rowInstantInvites"));
  }
...
prototype["renderDefaultForumLayout"] = function renderDefaultForumLayout() {
  ...
  if (!channel.isForumChannel()) {
    ...
    obj3.trailing = closure_47(self(5656).TableRow.TrailingText, obj4);
    if (channel.defaultForumLayout === GridSquareIcon(1967).ForumLayout.GRID) {
      ...
      tmpResult = tmp(GridSquareIcon(7166).ListViewIcon, {});
    }
    obj3.icon = tmpResult;
    obj3.onPress = function onPress() {
      return self.pushScreen(constants2.DEFAULT_FORUM_LAYOUT);
    };
    obj2.children = closure_47(self(5656).TableRow, obj3, "forumDefaultLayout");
    closure_47(self(5738).TableRowGroup, obj2, "default-forum-layout");
  }
};
  ...
  if (hasJoinedThread) {
    ...
    if (isArchivedThread) {
      ...
      if (canUnarchiveThread) {
        const obj2 = { icon: closure_47(tmp2(4569).ClockIcon, {}), label: null, onPress: null };
        const intl2 = tmp2(1114).intl;
        ...
        closure_47(tmp2(5656).TableRow, obj2);
      }
    }
    items[1] = tmp8;
    let tmp12 = null;
    if (!isArchivedThread) {
      tmp12 = null;
      if (canManageThread) {
        const obj3 = { icon: closure_47(tmp2(4559).XLargeIcon, {}), label: null, onPress: null };
        const intl3 = tmp2(1114).intl;
        ...
        closure_47(tmp2(5656).TableRow, obj3);
      }
    }
    items[2] = tmp12;
    let tmp16 = null;
    if (isThreadModerator) {
      tmp16 = null;
      if (isLockedThread) {
        const obj4 = { icon: closure_47(tmp2(5146).LockIcon, {}), label: null, onPress: null };
        const intl4 = tmp2(1114).intl;
        ...
        closure_47(tmp2(5656).TableRow, obj4);
      }
    }
    items[3] = tmp16;
    let tmp21 = null;
    if (isThreadModerator) {
      tmp21 = null;
      if (!isLockedThread) {
        const obj5 = { icon: closure_47(tmp2(5146).LockIcon, {}), label: null, onPress: null };
        const intl5 = tmp2(1114).intl;
        ...
        closure_47(tmp2(5656).TableRow, obj5);
      }
    }
    const obj6 = { hasIcons: true, children: null };
    items[4] = tmp21;
    const obj7 = { icon: closure_47(tmp2(4549).LinkIcon, {}), label: null, onPress: null };
    const intl6 = tmp2(1114).intl;
    ...
    items[5] = closure_47(tmp2(5656).TableRow, obj7);
    obj6.children = items;
    return closure_48(tmp4, obj6);
  } else {
    const obj = { icon: closure_47(tmp2(10122).GroupPlusIcon, {}), label: null, onPress: null };
    const intl = tmp2(1114).intl;
    const string = intl.string;
    ...
    closure_47(tmp2(5656).TableRow, obj);
  }
};
prototype["renderDeleteButton"] = function renderDeleteButton() {
  ...
  if (canManageChannels) {
    ...
    if (!hasJoinedThread) {
      ...
      const items = [null, ];
      const obj3 = { variant: "danger", icon: closure_47(tmp8(4564).TrashIcon, { color: "text-feedback-critical" }), label: stringResult, onPress: this.handleDeleteChannel };
      items[1] = closure_47(tmp8(5656).TableRow, obj3);
      obj2.children = items;
      tmp = tmp13(tmp14, obj2);
    } else {
      const obj = { variant: "danger", icon: closure_47(tmp8(4547).UserMinusIcon, { color: "text-feedback-critical" }), label: null, onPress: null };
      ...
      closure_47(tmp8(5656).TableRow, obj);
    }
    tmp13 = closure_48;
  }
  return tmp;
  ...
  if (channel.isForumLikeChannel()) {
    ...
    if (channel.availableTags.length > 0) {
      ...
      if (tmp3) {
        ...
        obj5.icon = tmp10(tmp7(8957).PlusSmallIcon, obj6);
        obj5.onPress = function onPress() {
          return self.handlePressTag();
        };
        const intl3 = tmp7(1114).intl;
        obj5.accessibilityLabel = intl3.string(tmp7(1114).t["/jubeD"]);
        obj4.children = tmp10(tmp7(8172).IconButton, obj5);
    ...
    const items1 = [closure_47(canManageChannels(5738).TableRowGroup, obj2), , , ];
    ...
    if (channel.availableTags.length <= 0) {
      ...
      obj8.children = tmp10(tmp7(4602).Text, obj9);
      tmp10Result3 = tmp10(tmp7(5174).PressableOpacity, obj8);
    }
    ...
    if (tmp10Result4) {
      ...
      tmp10Result4 = tmp10(tmp7(4602).Text, obj10);
    }
    ...
    obj11.children = closure_47(canManageChannels(7273).TableSwitchRow, obj12);
    items1[3] = closure_47(canManageChannels(5738).TableRowGroup, obj11);
    obj.children = items1;
    return closure_48(canManageChannels(5024).Stack, obj);
  } else {
    return null;
  }
};
  ...
  if (props.hasCategories) {
    if (props.channel.type !== constants3.GUILD_CATEGORY) {
      if (null == category) {
        ...
        stringResult = self(4759).computeChannelName(category, UserStore, RelationshipStore);
        tmp7 = self;
        const obj = self(4759);
      }
      ...
      obj2.trailing = closure_47(tmp7(5656).TableRow.TrailingText, obj3);
      ...
      obj2.onPress = fn;
      obj4.children = closure_47(tmp7(5656).TableRow, obj2);
      return closure_47(tmp7(5738).TableRowGroup, obj4);
    }
  }
  return null;
};
