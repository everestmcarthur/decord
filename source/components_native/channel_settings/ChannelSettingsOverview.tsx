...
// Dependencies: [5, 19, 17, 4280, 1962, 1976, 8781, 1958, 2013, 1980, 4278, 4655, 17059, 4288, 1372, 17060, 1074, 1965, 7387, 1114, 1085, 21, 4640, 576, 504, 11112, 4350, 12, 17061, 4820, 1115, 5712, 7984, 8780, 4338, 9720, 9892, 7388, 4292, 1385, 4491, 17062, 9891, 4985, 4636, 9217, 4793, 5081, 4498, 4540, 17063, 6717, 7199, 1364, 5775, 7314, 4851, 5695, 14302, 17064, 9460, 4285, 9893, 17065, 5773, 5776, 1967, 1969, 2025, 4785, 5693, 7383, 9903, 9927, 11466, 4582, 1968, 17066, 7207, 11090, 15078, 10182, 7885, 4602, 4592, 5182, 11114, 4580, 4597, 5060, 11403, 8057, 9022, 5210, 16314, 8748, 1484, 2]
// Exports: default

// Module 17058 (ChannelSettingsOverview)
...
import ChannelSettingsActionCreatorsDefault from "ChannelSettingsActionCreators" /* 8780 */;
import ThreadAutoArchive from "ThreadAutoArchive" /* 9460 */;
import _modDef9720 from "module_9720" /* 9720 */;
import sanitizeChannelNameDefault from "sanitizeChannelName" /* 9892 */;
import AppChannelApplicationSelectorDefault from "AppChannelApplicationSelector" /* 9893 */;
import ChannelActionSheetUtils from "ChannelActionSheetUtils" /* 11114 */;
import AvailableForumTagDefault from "AvailableForumTag" /* 11403 */;
import threadActionSheets from "threadActionSheets" /* 11466 */;
import Slider from "Slider" /* 14302 */;
import RegionActionCreatorsDefault from "RegionActionCreators" /* 17061 */;
import SecondsSliderUtils from "SecondsSliderUtils" /* 17062 */;
import ChannelSettingsUtils from "ChannelSettingsUtils" /* 17063 */;
import ThreadAutoArchiveBottomSheet from "ThreadAutoArchiveBottomSheet" /* 17064 */;
import getCannotSwapApplicationTextDefault from "getCannotSwapApplicationText" /* 17065 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import JoinedThreadsStore from "JoinedThreadsStore" /* 4280 */;
import ChannelSettingsStore from "ChannelSettingsStore" /* 8781 */;
import ChannelStore from "ChannelStore" /* 1958 */;
import GuildChannelStore from "GuildChannelStore" /* 2013 */;
import GuildStore from "GuildStore" /* 1980 */;
import PermissionStore from "PermissionStore" /* 4278 */;
import ReadStateStore from "ReadStateStore" /* 4655 */;
import RegionStore from "RegionStore" /* 17059 */;
...
let closure_25 = fn(17060).ChannelSettingsAutoFocusElement;
...
const MAX_FORUM_TAGS = fn(7387).MAX_FORUM_TAGS;
      ...
      if (channel.state.hasChanges) {
        ...
        ChannelSettingsActionCreatorsDefault.saveChannel(channel.id, obj4).then((status) => {
          if (200 === status.status) {
            ...
            let goBackResult = { key: "THREAD_SETTINGS_UPDATED", icon: _modDef9720, content: null };
    ...
    tmp1.handleBlurName = function handleBlurName() {
      ...
      if (channel.isThread()) {
        ...
        if (tmp3 !== channel.name) {
          ...
          tmp(8780).updateChannel(obj2);
          closure_0.setState({ hasChanges: true });
          const tmpResult = tmp(8780);
        }
        tmp = importDefault;
      }
    };
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj4 = { value: tmp2(9891).isDefaultChannelThresholdMetAfterDelete(channel.getGuildId(), channel.id), done: false };
              return obj4;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            if (null != guild2) {
              ...
              if (features.has(constants.COMMUNITY)) {
                if (guild2.rulesChannelId === closure_128_1.id) {
                  ...
                  const items = [closure_1_47(tmp2(4636).Text, obj9), ];
                  ...
                  items[1] = closure_1_47(tmp2(4636).Text, obj10);
                  obj8.children = items;
            ...
            if (null != guild2) {
              if (!closure_128_3) {
                ...
                const items1 = [closure_1_47(tmp2(4636).Text, obj16), ];
                ...
                items1[1] = closure_1_47(tmp2(4636).Text, obj17);
                obj15.children = items1;
                obj12.children = closure_1_48(closure_1_49, obj15);
                tmp5(4985).show(obj12);
                const obj7 = tmp5(4985);
              }
            }
            const obj13 = tmp2(4793);
            ...
            obj19.confirmColor = tmp5(5081).Colors.RED;
            tmp5(4985).show(obj19);
            const obj14 = tmp5(4985);
          }
        } catch (tmp129) {
          c3 = tmp;
          throw tmp129;
...
prototype["updateNavigation"] = function updateNavigation(submitting, hasChanges) {
  ...
  if (isThread) {
    ...
    if (submitting) {
      let fn = tmp3(5712).HeaderSubmittingIndicator;
    } else {
      fn = (arg0) => {
        const obj = {};
...
prototype["renderChannelInfo"] = function renderChannelInfo() {
  ...
  const TextInput = tmp3(6717).TextInput;
  ...
  if (set5.has(channel.type)) {
    ...
    if (canManageChannels) {
      ...
      if (!obj.isIOS()) {
        ...
        obj3.value = tmp2(4851).isChannelOrGuildNSFW(channel);
        ...
        obj2.children = closure_1_47(tmp2(7314).TableSwitchRow, obj3);
        tmp = tmp4(tmp2(5775).TableRowGroup, obj2, "nsfw-section");
        const tmp2Result = tmp2(4851);
      }
      obj = PlatformUtils;
    }
  }
...
prototype["renderAutoArchiveDuration"] = function renderAutoArchiveDuration() {
  ...
  if (channel.isThread()) {
    if (canManageThread) {
      ...
      return closure_1_47(tmp5(17064).AutoArchiveDurationOptions, obj);
    }
  }
  return null;
};
...
prototype["renderUserLimitSettings"] = function renderUserLimitSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (props.canManageChannels) {
      ...
      const items1 = [closure_1_47(tmp7(4636).Text, obj5), ];
      const obj6 = { variant: "text-md/medium", color: "text-muted", children: stringResult };
      items1[1] = closure_1_47(tmp7(4636).Text, obj6);
      obj4.children = items1;
      const items2 = [__V(View, obj4), ];
      ...
      items2[1] = closure_1_47(tmp7(14302).Slider, obj7);
      obj3.children = items2;
      obj2.children = __V(tmp7(5695).Card, obj3);
      items.push(closure_1_47(tmp7(5775).TableRowGroup, obj2, "channel-user-limit"));
      return items;
    }
  }
  return null;
    ...
    if (self.showVoiceSettings()) {
      if (tmp) {
        if (!channel.isGuildStageVoice()) {
          ...
          obj2.trailing = closure_47(channel(5693).TableRow.TrailingText, obj3);
          obj2.disabled = tmp2;
          obj2.onPress = function onPress() {
            return self.pushScreen(constants2.CHANGE_RTC_REGION);
          };
          obj.children = closure_47(channel(5693).TableRow, obj2);
          items.push(closure_47(channel(5775).TableRowGroup, obj, "channel-region-override"));
          return items;
        }
      }
    }
...
prototype["renderPermissions"] = function renderPermissions() {
  ...
  if (!this.props.canManageRoles) {
    ...
    ShieldUserIcon = ShieldUserIcon(9903).ShieldUserIcon;
    ...
    obj.children = closure_47(self(5693).TableRow, obj2);
    closure_47(self(5775).TableRowGroup, obj);
  }
};
...
prototype["renderCommonSettingsSection"] = function renderCommonSettingsSection() {
  ...
  if (tmp2) {
    ...
    obj.icon = closure_47(channel(9927).BellIcon, {});
    ...
    items.push(closure_47(channel(5693).TableRow, obj, "rowNotifications"));
  }
  if (closure_8(channel.type)) {
    ...
    items.push(closure_47(channel(5693).TableRow, obj2, "rowPinnedMessages"));
  }
  if (canManageChannels) {
  ...
  if (canManageChannels) {
    ...
    obj4.icon = closure_47(channel(4582).LinkIcon, {});
    obj4.onPress = function onPress() {
      return self.pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(closure_47(channel(5693).TableRow, obj4, "rowInstantInvites"));
  }
...
prototype["renderDefaultForumLayout"] = function renderDefaultForumLayout() {
  ...
  if (!channel.isForumChannel()) {
    ...
    if (channel.defaultForumLayout === self(1968).ForumLayout.GRID) {
    ...
    obj3.trailing = closure_47(self(5693).TableRow.TrailingText, obj4);
    if (channel.defaultForumLayout === GridSquareIcon(1968).ForumLayout.GRID) {
      GridSquareIcon = GridSquareIcon(17066).GridSquareIcon;
      obj = {};
      let tmpResult = tmp(GridSquareIcon, obj);
    } else {
      tmpResult = tmp(GridSquareIcon(7207).ListViewIcon, {});
    }
    obj3.icon = tmpResult;
    obj3.onPress = function onPress() {
      return self.pushScreen(constants2.DEFAULT_FORUM_LAYOUT);
    };
    obj2.children = closure_47(self(5693).TableRow, obj3, "forumDefaultLayout");
    closure_47(self(5775).TableRowGroup, obj2, "default-forum-layout");
  }
};
  ...
  if (hasJoinedThread) {
    ...
    if (isArchivedThread) {
      ...
      if (canUnarchiveThread) {
        const obj2 = { icon: closure_47(tmp2(4602).ClockIcon, {}), label: null, onPress: null };
        const intl2 = tmp2(1115).intl;
        ...
        closure_47(tmp2(5693).TableRow, obj2);
      }
    }
    items[1] = tmp8;
    let tmp12 = null;
    if (!isArchivedThread) {
      tmp12 = null;
      if (canManageThread) {
        const obj3 = { icon: closure_47(tmp2(4592).XLargeIcon, {}), label: null, onPress: null };
        const intl3 = tmp2(1115).intl;
        ...
        closure_47(tmp2(5693).TableRow, obj3);
      }
    }
    items[2] = tmp12;
    let tmp16 = null;
    if (isThreadModerator) {
      tmp16 = null;
      if (isLockedThread) {
        const obj4 = { icon: closure_47(tmp2(5182).LockIcon, {}), label: null, onPress: null };
        const intl4 = tmp2(1115).intl;
        ...
        closure_47(tmp2(5693).TableRow, obj4);
      }
    }
    items[3] = tmp16;
    let tmp21 = null;
    if (isThreadModerator) {
      tmp21 = null;
      if (!isLockedThread) {
        const obj5 = { icon: closure_47(tmp2(5182).LockIcon, {}), label: null, onPress: null };
        const intl5 = tmp2(1115).intl;
        ...
        closure_47(tmp2(5693).TableRow, obj5);
      }
    }
    const obj6 = { hasIcons: true, children: null };
    items[4] = tmp21;
    const obj7 = { icon: closure_47(tmp2(4582).LinkIcon, {}), label: null, onPress: null };
    const intl6 = tmp2(1115).intl;
    ...
    items[5] = closure_47(tmp2(5693).TableRow, obj7);
    obj6.children = items;
    return closure_48(tmp4, obj6);
  } else {
    const obj = { icon: closure_47(tmp2(10182).GroupPlusIcon, {}), label: null, onPress: null };
    const intl = tmp2(1115).intl;
    const string = intl.string;
    ...
    closure_47(tmp2(5693).TableRow, obj);
  }
};
prototype["renderDeleteButton"] = function renderDeleteButton() {
  ...
  if (canManageChannels) {
    ...
    if (!hasJoinedThread) {
      ...
      const items = [null, ];
      const obj3 = { variant: "danger", icon: closure_47(tmp8(4597).TrashIcon, { color: "text-feedback-critical" }), label: stringResult, onPress: this.handleDeleteChannel };
      items[1] = closure_47(tmp8(5693).TableRow, obj3);
      obj2.children = items;
      tmp = tmp13(tmp14, obj2);
    } else {
      const obj = { variant: "danger", icon: closure_47(tmp8(4580).UserMinusIcon, { color: "text-feedback-critical" }), label: null, onPress: null };
      ...
      closure_47(tmp8(5693).TableRow, obj);
    }
    tmp13 = closure_48;
  }
  return tmp;
  ...
  if (channel.isForumLikeChannel()) {
    ...
    if (channel.availableTags.length > 0) {
      ...
      if (tmp3) {
        ...
        obj5.icon = tmp10(tmp7(9022).PlusSmallIcon, obj6);
        obj5.onPress = function onPress() {
          return self.handlePressTag();
        };
        const intl3 = tmp7(1115).intl;
        obj5.accessibilityLabel = intl3.string(tmp7(1115).t["/jubeD"]);
        obj4.children = tmp10(tmp7(8057).IconButton, obj5);
    ...
    const items1 = [closure_47(canManageChannels(5775).TableRowGroup, obj2), , , ];
    ...
    if (channel.availableTags.length <= 0) {
      ...
      obj8.children = tmp10(tmp7(4636).Text, obj9);
      tmp10Result3 = tmp10(tmp7(5210).PressableOpacity, obj8);
    }
    ...
    if (tmp10Result4) {
      ...
      tmp10Result4 = tmp10(tmp7(4636).Text, obj10);
    }
    ...
    obj11.children = closure_47(canManageChannels(7314).TableSwitchRow, obj12);
    items1[3] = closure_47(canManageChannels(5775).TableRowGroup, obj11);
    obj.children = items1;
    return closure_48(canManageChannels(5060).Stack, obj);
  } else {
    return null;
  }
};
  ...
  if (props.hasCategories) {
    if (props.channel.type !== constants3.GUILD_CATEGORY) {
      if (null == category) {
        ...
        stringResult = self(4793).computeChannelName(category, UserStore, RelationshipStore);
        tmp7 = self;
        const obj = self(4793);
      }
      const obj2 = { icon: closure_47(tmp7(16314).FolderPlusIcon, {}), label: null, trailing: null, arrow: null, onPress: null };
      const intl2 = tmp7(1115).intl;
      obj2.label = intl2.string(tmp7(1115).t.vHCZwr);
      const obj3 = { text: stringResult };
      obj2.trailing = closure_47(tmp7(5693).TableRow.TrailingText, obj3);
      ...
      obj2.onPress = fn;
      obj4.children = closure_47(tmp7(5693).TableRow, obj2);
      return closure_47(tmp7(5775).TableRowGroup, obj4);
    }
  }
  return null;
};
...
ChannelSettingsOverview.contextType = fn(4350).ThemeContext;
size = fn(2);
