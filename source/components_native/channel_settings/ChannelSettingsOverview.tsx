...
// Dependencies: [5, 19, 17, 4363, 1962, 1976, 8864, 1958, 2013, 1980, 4361, 4737, 17190, 4371, 1372, 17191, 1074, 1965, 7469, 1114, 1085, 21, 4722, 576, 504, 11205, 4432, 12, 17192, 4902, 1115, 5794, 8067, 8863, 4420, 9814, 9986, 7470, 4375, 1385, 4573, 17193, 9985, 5067, 4718, 9301, 4875, 5163, 4580, 4622, 17194, 6799, 7281, 1364, 5857, 7396, 4933, 5777, 14397, 17195, 9544, 4368, 9987, 17196, 5855, 5858, 1967, 1969, 2025, 4867, 5775, 7465, 9997, 10021, 11564, 4664, 1968, 17197, 7289, 11183, 15172, 10276, 7967, 4684, 4674, 5264, 11207, 4662, 4679, 5142, 11501, 8140, 9106, 5292, 16411, 8831, 1484, 2]
// Exports: default

// Module 17189 (ChannelSettingsOverview)
...
import ThreadAutoArchive from "ThreadAutoArchive" /* 9544 */;
import _modDef9814 from "module_9814" /* 9814 */;
import sanitizeChannelNameDefault from "sanitizeChannelName" /* 9986 */;
import AppChannelApplicationSelectorDefault from "AppChannelApplicationSelector" /* 9987 */;
import ChannelActionSheetUtils from "ChannelActionSheetUtils" /* 11207 */;
import AvailableForumTagDefault from "AvailableForumTag" /* 11501 */;
import threadActionSheets from "threadActionSheets" /* 11564 */;
import Slider from "Slider" /* 14397 */;
import RegionActionCreatorsDefault from "RegionActionCreators" /* 17192 */;
import SecondsSliderUtils from "SecondsSliderUtils" /* 17193 */;
import ChannelSettingsUtils from "ChannelSettingsUtils" /* 17194 */;
import ThreadAutoArchiveBottomSheet from "ThreadAutoArchiveBottomSheet" /* 17195 */;
import getCannotSwapApplicationTextDefault from "getCannotSwapApplicationText" /* 17196 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import JoinedThreadsStore from "JoinedThreadsStore" /* 4363 */;
import ChannelSettingsStore from "ChannelSettingsStore" /* 8864 */;
import ChannelStore from "ChannelStore" /* 1958 */;
import GuildChannelStore from "GuildChannelStore" /* 2013 */;
import GuildStore from "GuildStore" /* 1980 */;
import PermissionStore from "PermissionStore" /* 4361 */;
import ReadStateStore from "ReadStateStore" /* 4737 */;
import RegionStore from "RegionStore" /* 17190 */;
...
let closure_25 = fn(17191).ChannelSettingsAutoFocusElement;
...
const MAX_FORUM_TAGS = fn(7469).MAX_FORUM_TAGS;
      ...
      if (channel.state.hasChanges) {
        ...
        ChannelSettingsActionCreatorsDefault.saveChannel(channel.id, obj4).then((status) => {
          if (200 === status.status) {
            ...
            let goBackResult = { key: "THREAD_SETTINGS_UPDATED", icon: _modDef9814, content: null };
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj4 = { value: tmp2(9985).isDefaultChannelThresholdMetAfterDelete(channel.getGuildId(), channel.id), done: false };
              return obj4;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            if (null != guild2) {
              ...
              if (features.has(constants.COMMUNITY)) {
                if (guild2.rulesChannelId === closure_128_1.id) {
                  ...
                  const items = [closure_1_47(tmp2(4718).Text, obj9), ];
                  ...
                  items[1] = closure_1_47(tmp2(4718).Text, obj10);
                  obj8.children = items;
            ...
            if (null != guild2) {
              if (!closure_128_3) {
                ...
                const items1 = [closure_1_47(tmp2(4718).Text, obj16), ];
                ...
                items1[1] = closure_1_47(tmp2(4718).Text, obj17);
                obj15.children = items1;
                obj12.children = closure_1_48(closure_1_49, obj15);
                tmp5(5067).show(obj12);
                const obj7 = tmp5(5067);
              }
            }
            const obj13 = tmp2(4875);
            ...
            obj19.confirmColor = tmp5(5163).Colors.RED;
            tmp5(5067).show(obj19);
            const obj14 = tmp5(5067);
          }
        } catch (tmp129) {
          c3 = tmp;
          throw tmp129;
...
prototype["updateNavigation"] = function updateNavigation(submitting, hasChanges) {
  ...
  if (isThread) {
    ...
    if (submitting) {
      let fn = tmp3(5794).HeaderSubmittingIndicator;
    } else {
      fn = (arg0) => {
        const obj = {};
...
prototype["renderChannelInfo"] = function renderChannelInfo() {
  ...
  const TextInput = tmp3(6799).TextInput;
  ...
  if (set5.has(channel.type)) {
    ...
    if (canManageChannels) {
      ...
      if (!obj.isIOS()) {
        ...
        obj3.value = tmp2(4933).isChannelOrGuildNSFW(channel);
        ...
        obj2.children = closure_1_47(tmp2(7396).TableSwitchRow, obj3);
        tmp = tmp4(tmp2(5857).TableRowGroup, obj2, "nsfw-section");
...
prototype["renderAutoArchiveDuration"] = function renderAutoArchiveDuration() {
  ...
  if (channel.isThread()) {
    if (canManageThread) {
      ...
      return closure_1_47(tmp5(17195).AutoArchiveDurationOptions, obj);
    }
  }
  return null;
};
...
prototype["renderUserLimitSettings"] = function renderUserLimitSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (props.canManageChannels) {
      ...
      const items1 = [closure_1_47(tmp7(4718).Text, obj5), ];
      const obj6 = { variant: "text-md/medium", color: "text-muted", children: stringResult };
      items1[1] = closure_1_47(tmp7(4718).Text, obj6);
      obj4.children = items1;
      const items2 = [__V(View, obj4), ];
      ...
      items2[1] = closure_1_47(tmp7(14397).Slider, obj7);
      obj3.children = items2;
      obj2.children = __V(tmp7(5777).Card, obj3);
      items.push(closure_1_47(tmp7(5857).TableRowGroup, obj2, "channel-user-limit"));
      return items;
    }
  }
  return null;
    ...
    if (self.showVoiceSettings()) {
      if (tmp) {
        if (!channel.isGuildStageVoice()) {
          ...
          obj2.trailing = closure_47(channel(5775).TableRow.TrailingText, obj3);
          obj2.disabled = tmp2;
          obj2.onPress = function onPress() {
            return self.pushScreen(constants2.CHANGE_RTC_REGION);
          };
          obj.children = closure_47(channel(5775).TableRow, obj2);
          items.push(closure_47(channel(5857).TableRowGroup, obj, "channel-region-override"));
          return items;
        }
      }
    }
...
prototype["renderPermissions"] = function renderPermissions() {
  ...
  if (!this.props.canManageRoles) {
    ...
    ShieldUserIcon = ShieldUserIcon(9997).ShieldUserIcon;
    ...
    obj.children = closure_47(self(5775).TableRow, obj2);
    closure_47(self(5857).TableRowGroup, obj);
  }
};
...
prototype["renderCommonSettingsSection"] = function renderCommonSettingsSection() {
  ...
  if (tmp2) {
    ...
    obj.icon = closure_47(channel(10021).BellIcon, {});
    ...
    items.push(closure_47(channel(5775).TableRow, obj, "rowNotifications"));
  }
  if (closure_8(channel.type)) {
    ...
    items.push(closure_47(channel(5775).TableRow, obj2, "rowPinnedMessages"));
  }
  if (canManageChannels) {
  ...
  if (canManageChannels) {
    ...
    obj4.icon = closure_47(channel(4664).LinkIcon, {});
    obj4.onPress = function onPress() {
      return self.pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(closure_47(channel(5775).TableRow, obj4, "rowInstantInvites"));
  }
...
prototype["renderDefaultForumLayout"] = function renderDefaultForumLayout() {
  ...
  if (!channel.isForumChannel()) {
    ...
    obj3.trailing = closure_47(self(5775).TableRow.TrailingText, obj4);
    if (channel.defaultForumLayout === GridSquareIcon(1968).ForumLayout.GRID) {
      GridSquareIcon = GridSquareIcon(17197).GridSquareIcon;
      obj = {};
      let tmpResult = tmp(GridSquareIcon, obj);
    } else {
      tmpResult = tmp(GridSquareIcon(7289).ListViewIcon, {});
    }
    obj3.icon = tmpResult;
    obj3.onPress = function onPress() {
      return self.pushScreen(constants2.DEFAULT_FORUM_LAYOUT);
    };
    obj2.children = closure_47(self(5775).TableRow, obj3, "forumDefaultLayout");
    closure_47(self(5857).TableRowGroup, obj2, "default-forum-layout");
  }
};
  ...
  if (hasJoinedThread) {
    ...
    if (isArchivedThread) {
      ...
      if (canUnarchiveThread) {
        const obj2 = { icon: closure_47(tmp2(4684).ClockIcon, {}), label: null, onPress: null };
        const intl2 = tmp2(1115).intl;
        ...
        closure_47(tmp2(5775).TableRow, obj2);
      }
    }
    items[1] = tmp8;
    let tmp12 = null;
    if (!isArchivedThread) {
      tmp12 = null;
      if (canManageThread) {
        const obj3 = { icon: closure_47(tmp2(4674).XLargeIcon, {}), label: null, onPress: null };
        const intl3 = tmp2(1115).intl;
        ...
        closure_47(tmp2(5775).TableRow, obj3);
      }
    }
    items[2] = tmp12;
    let tmp16 = null;
    if (isThreadModerator) {
      tmp16 = null;
      if (isLockedThread) {
        const obj4 = { icon: closure_47(tmp2(5264).LockIcon, {}), label: null, onPress: null };
        const intl4 = tmp2(1115).intl;
        ...
        closure_47(tmp2(5775).TableRow, obj4);
      }
    }
    items[3] = tmp16;
    let tmp21 = null;
    if (isThreadModerator) {
      tmp21 = null;
      if (!isLockedThread) {
        const obj5 = { icon: closure_47(tmp2(5264).LockIcon, {}), label: null, onPress: null };
        const intl5 = tmp2(1115).intl;
        ...
        closure_47(tmp2(5775).TableRow, obj5);
      }
    }
    const obj6 = { hasIcons: true, children: null };
    items[4] = tmp21;
    const obj7 = { icon: closure_47(tmp2(4664).LinkIcon, {}), label: null, onPress: null };
    const intl6 = tmp2(1115).intl;
    ...
    items[5] = closure_47(tmp2(5775).TableRow, obj7);
    obj6.children = items;
    return closure_48(tmp4, obj6);
  } else {
    const obj = { icon: closure_47(tmp2(10276).GroupPlusIcon, {}), label: null, onPress: null };
    const intl = tmp2(1115).intl;
    const string = intl.string;
    ...
    closure_47(tmp2(5775).TableRow, obj);
  }
};
prototype["renderDeleteButton"] = function renderDeleteButton() {
  ...
  if (canManageChannels) {
    ...
    if (!hasJoinedThread) {
      ...
      const items = [null, ];
      const obj3 = { variant: "danger", icon: closure_47(tmp8(4679).TrashIcon, { color: "text-feedback-critical" }), label: stringResult, onPress: this.handleDeleteChannel };
      items[1] = closure_47(tmp8(5775).TableRow, obj3);
      obj2.children = items;
      tmp = tmp13(tmp14, obj2);
    } else {
      const obj = { variant: "danger", icon: closure_47(tmp8(4662).UserMinusIcon, { color: "text-feedback-critical" }), label: null, onPress: null };
      ...
      closure_47(tmp8(5775).TableRow, obj);
    }
    tmp13 = closure_48;
  }
  return tmp;
  ...
  if (channel.isForumLikeChannel()) {
    ...
    if (channel.availableTags.length > 0) {
      ...
      if (tmp3) {
        ...
        obj5.icon = tmp10(tmp7(9106).PlusSmallIcon, obj6);
        obj5.onPress = function onPress() {
          return self.handlePressTag();
        };
        const intl3 = tmp7(1115).intl;
        obj5.accessibilityLabel = intl3.string(tmp7(1115).t["/jubeD"]);
        obj4.children = tmp10(tmp7(8140).IconButton, obj5);
    ...
    const items1 = [closure_47(canManageChannels(5857).TableRowGroup, obj2), , , ];
    ...
    if (channel.availableTags.length <= 0) {
      ...
      obj8.children = tmp10(tmp7(4718).Text, obj9);
      tmp10Result3 = tmp10(tmp7(5292).PressableOpacity, obj8);
    }
    ...
    if (tmp10Result4) {
      ...
      tmp10Result4 = tmp10(tmp7(4718).Text, obj10);
    }
    ...
    obj11.children = closure_47(canManageChannels(7396).TableSwitchRow, obj12);
    items1[3] = closure_47(canManageChannels(5857).TableRowGroup, obj11);
    obj.children = items1;
    return closure_48(canManageChannels(5142).Stack, obj);
  } else {
    return null;
  }
};
  ...
  if (props.hasCategories) {
    if (props.channel.type !== constants3.GUILD_CATEGORY) {
      if (null == category) {
        ...
        stringResult = self(4875).computeChannelName(category, UserStore, RelationshipStore);
        tmp7 = self;
        const obj = self(4875);
      }
      const obj2 = { icon: closure_47(tmp7(16411).FolderPlusIcon, {}), label: null, trailing: null, arrow: null, onPress: null };
      const intl2 = tmp7(1115).intl;
      obj2.label = intl2.string(tmp7(1115).t.vHCZwr);
      const obj3 = { text: stringResult };
      obj2.trailing = closure_47(tmp7(5775).TableRow.TrailingText, obj3);
      ...
      obj2.onPress = fn;
      obj4.children = closure_47(tmp7(5775).TableRow, obj2);
      return closure_47(tmp7(5857).TableRowGroup, obj4);
    }
  }
  return null;
};
...
ChannelSettingsOverview.contextType = fn(4432).ThemeContext;
size = fn(2);
