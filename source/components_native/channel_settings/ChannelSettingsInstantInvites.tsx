...
// Dependencies: [32, 19, 17, 8781, 1958, 1074, 21, 4640, 576, 1612, 504, 8780, 11089, 1177, 11107, 11108, 1115, 7153, 17069, 7169, 2]
// Exports: default

// Module 17068 (ChannelSettingsInstantInvites)
...
const FastestListDefault = tmp2(7169);
const _modDef11107 = tmp2(11107);
const _modDef11108 = tmp2(11108);
const InstantInviteSelfMeasurerDefault = tmp2(17069);
require = fn;
...
export default function ConnectedChannelSettingsInstantInvites() {
  ...
  if (!loading) {
    if (0 === memo1.length) {
      const obj5 = { lightSource: _modDef11107, darkSource: _modDef11108, title: null, body: null };
  ...
  tmp = closure_9;
  const items8 = [closure_9(tmpResult(7153).SceneLoadingIndicator, {}), ];
  tmpResult = null;
  if (memo1.length > 0) {
