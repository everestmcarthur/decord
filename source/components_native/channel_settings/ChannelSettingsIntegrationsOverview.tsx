...
function LinkedLobbyFormSection(channel) {
  ...
  if (null != getOrFetchApplication) {
    ...
    obj3.children = closure_6(tmp(5686).TableRow, obj4);
    tmp5 = closure_6(tmp(5768).TableRowGroup, obj3);
...
export default function ConnectedChannelSettingsIntegrationsOverview(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    if (canManageWebhooks) {
      ...
      const items1 = [tmp6(tmp(5686).TableRow, obj6), ];
      ...
      if (hasItem) {
        ...
        hasItem = tmp6(tmp(5686).TableRow, obj7);
      }
      const obj8 = { hasIcons: true, children: null };
      items1[1] = hasItem;
      obj8.children = items1;
      canManageWebhooks = tmp7(tmp(5768).TableRowGroup, obj8);
    }
    ...
    obj3.children = closure_7(tmp(5054).Stack, obj4);
    tmp6Result = tmp6(tmp(8716).Form, obj3);
  }
  return tmp6Result;
};
