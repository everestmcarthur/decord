...
// Dependencies: [19, 1962, 1958, 1074, 21, 1484, 7282, 5775, 1115, 5693, 1177, 1397, 4640, 576, 504, 8748, 5060, 16974, 17088, 2]
// Exports: default

// Module 17087 (ChannelSettingsIntegrationsOverview)
...
function LinkedLobbyFormSection(channel) {
  ...
  if (null != getOrFetchApplication) {
    ...
    obj3.children = closure_6(tmp(5693).TableRow, obj4);
    tmp5 = closure_6(tmp(5775).TableRowGroup, obj3);
...
export default function ConnectedChannelSettingsIntegrationsOverview(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    if (canManageWebhooks) {
      ...
      obj6.icon = tmp6(tmp(16974).WebhookIcon, {});
      obj6.onPress = function onPress() {
        return closure_1.push(ChannelSettingsSections.WEBHOOKS);
      };
      const items1 = [tmp6(tmp(5693).TableRow, obj6), ];
      ...
      if (hasItem) {
        ...
        obj7.icon = tmp6(tmp(17088).ChannelsFollowedIcon, {});
        obj7.onPress = function onPress() {
          return closure_1.push(ChannelSettingsSections.CHANNELS_FOLLOWED);
        };
        hasItem = tmp6(tmp(5693).TableRow, obj7);
      }
      const obj8 = { hasIcons: true, children: null };
      items1[1] = hasItem;
      obj8.children = items1;
      canManageWebhooks = tmp7(tmp(5775).TableRowGroup, obj8);
    }
    ...
    obj3.children = closure_7(tmp(5060).Stack, obj4);
    tmp6Result = tmp6(tmp(8748).Form, obj3);
  }
  return tmp6Result;
};
