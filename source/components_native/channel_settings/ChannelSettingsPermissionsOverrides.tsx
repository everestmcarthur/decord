...
// Dependencies: [32, 5, 19, 17, 1976, 1958, 2016, 1980, 4278, 4288, 1372, 1074, 21, 4640, 576, 1484, 1612, 504, 11761, 11760, 4283, 1086, 9891, 4653, 1895, 4484, 4984, 1115, 4334, 2025, 1966, 17079, 7984, 4636, 4793, 11100, 5693, 1177, 5775, 17083, 1364, 17084, 2]
// Exports: default

// Module 17078 (ChannelSettingsPermissionsOverrides)
...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
    ...
    if (fromCreate) {
      let obj = {
        headerRight() {
            ...
            return closure_2_19(closure_0(7984).HeaderTextButton, obj);
          }
      };
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    let tmp12Result = tmp12(tmp5(11100), obj6);
  } else {
    ...
    tmp12Result = tmp12(tmp2(5693).TableRow, obj7);
  }
  ...
  items6[2] = first.map((permissions, index) => {
    ...
    obj.children = closure_2_19(TableRowGroup.TableRowGroup, {
      ...
      children: permissions.map((description, index) => {
        ...
        const obj = { variant: "text-xs/medium", color: "text-subtle", children: closure_1_0(17083).renderDescription(description.description) };
        const items = [closure_1_19(closure_1_0(4636).Text, obj), ];
        let tmp5Result = null;
        if (false !== tmp) {
          tmp5Result = null;
          if ("" !== tmp) {
            const obj3 = { variant: "text-xs/medium", color: "text-feedback-critical", children: tmp };
            tmp5Result = tmp5(tmp6(4636).Text, obj3);
          }
        }
        items[1] = tmp5Result;
        const obj2 = closure_1_0(17083);
        ...
        obj4.trailing = closure_1_19(id(17084), obj5);
        return closure_1_19(closure_1_0(5693).TableRow, obj4, "row-" + index);
      })
    });
