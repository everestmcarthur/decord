...
// Dependencies: [32, 5, 19, 17, 1975, 1957, 2015, 1979, 4212, 4222, 1371, 1074, 21, 4574, 576, 1483, 1611, 504, 11642, 11641, 4217, 1086, 9772, 4587, 1894, 4418, 4918, 1114, 4268, 2024, 1965, 16870, 7877, 4570, 4727, 10974, 5619, 1178, 5701, 16874, 1115, 16875, 2]
// Exports: default

// Module 16869 (ChannelSettingsPermissionsOverrides)
import nativeDefault from "native" /* 576 */;
import BigFlagUtilsAll from "BigFlagUtils" /* 1086 */;
import StageChannelPermissions from "StageChannelPermissions" /* 1965 */;
import PermissionUtils from "PermissionUtils" /* 4217 */;
import TableRowGroup from "TableRowGroup" /* 5701 */;
import AppChannelPermissionUtils from "AppChannelPermissionUtils" /* 11641 */;
...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    let tmp12Result = tmp12(tmp5(10974), obj6);
  } else {
    ...
    tmp12Result = tmp12(tmp2(5619).TableRow, obj7);
  }
  ...
  items6[2] = first.map((permissions, index) => {
    ...
    obj.children = closure_2_19(TableRowGroup.TableRowGroup, {
      ...
      children: permissions.map((description, index) => {
        ...
        const obj = { variant: "text-xs/medium", color: "text-subtle", children: closure_1_0(16874).renderDescription(description.description) };
        ...
        if (false !== tmp) {
          ...
          if ("" !== tmp) {
            ...
            tmp5Result = tmp5(tmp6(4570).Text, obj3);
          }
        }
        items[1] = tmp5Result;
        const obj2 = closure_1_0(16874);
        ...
        obj4.trailing = closure_1_19(id(16875), obj5);
        return closure_1_19(closure_1_0(5619).TableRow, obj4, "row-" + index);
      })
    });
