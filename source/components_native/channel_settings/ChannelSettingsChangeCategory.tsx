...
// Dependencies: [32, 718, 19, 1958, 7218, 1980, 4278, 4288, 1372, 1074, 21, 4639, 576, 4350, 7219, 12551, 4283, 5605, 4983, 1115, 4792, 5690, 5772, 8719, 5057, 4635, 504, 1484, 11744, 38, 2]
// Exports: default

// Module 17006 (ChannelSettingsChangeCategory)
  ...
  if (null != first) {
    ...
    if ("null" === first.id) {
      ...
      if (null != category) {
        ...
        obj4.children = tmp3(tmp4(5690).TableRow, obj5, first.id);
        tmp3Result = tmp3(tmp4(5772).TableRowGroup, obj4);
      }
    }
  }
  items[1] = tmp3Result;
...
export default function ConnectedChannelSettingsChangeCategory(channelId) {
  ...
  const appChannelBotUserId = channelId(11744).useAppChannelBotUserId(channel);
