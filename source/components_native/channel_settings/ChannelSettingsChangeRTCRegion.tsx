...
// Dependencies: [718, 19, 1958, 17020, 21, 4638, 576, 4348, 1115, 8760, 5774, 5771, 8728, 504, 38, 2]
// Exports: default

// Module 17064 (ChannelSettingsChangeRTCRegion)
...
prototype["handleSetRegion"] = function handleSetRegion(arg0) {
  ...
  self(8760).updateChannel({ rtcRegion: tmp });
...
ChannelSettingsChangeRTCRegion.contextType = fn(4348).ThemeContext;
const size = fn(2);
