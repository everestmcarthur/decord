...
// Dependencies: [19, 17, 21, 576, 4574, 4217, 1114, 7943, 8829, 16876, 4292, 2]

// Module 16875 (ChannelSettingsPermissionsOverrideCheckbox)
...
let items = [fn(4217).DENY, fn(4217).PASSTHROUGH, fn(4217).ALLOW];
