...
// Dependencies: [19, 17, 21, 576, 4722, 4366, 1115, 8148, 9036, 17216, 4440, 2]

// Module 17215 (ChannelSettingsPermissionsOverrideCheckbox)
...
let items = [fn(4366).DENY, fn(4366).PASSTHROUGH, fn(4366).ALLOW];
