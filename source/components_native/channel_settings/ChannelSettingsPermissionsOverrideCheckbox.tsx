...
// Dependencies: [19, 17, 21, 576, 4605, 4248, 1114, 7981, 8866, 16933, 4323, 2]

// Module 16932 (ChannelSettingsPermissionsOverrideCheckbox)
...
let items = [fn(4248).DENY, fn(4248).PASSTHROUGH, fn(4248).ALLOW];
