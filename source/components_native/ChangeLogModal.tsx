...
// Function ID: 15641
// Name: ChangeLogModal
// Dependencies: [19, 17, 1074, 2011, 21, 4639, 576, 4350, 1241, 8380, 15641, 5672, 8428, 1115, 5207, 9182, 10529, 1177, 8199, 1478, 8200, 1485, 5709, 4231, 8201, 4635, 4842, 7107, 2]
// Exports: default

// Module 15640 (ChangeLogModal)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4842 */;
import NavigatorHeader from "NavigatorHeader" /* 5709 */;
import Navigator from "Navigator" /* 7107 */;
import ChangeLogStandardTemplateDefault from "ChangeLogStandardTemplate" /* 8199 */;
import openMediaModal from "openMediaModal" /* 8380 */;
import common_VideoDefault from "common/Video" /* 8428 */;
import _modDef15641 from "module_15641" /* 15641 */;
...
const CHANGELOG_MODAL_KEY = fn(2011).CHANGELOG_MODAL_KEY;
const jsxProd = fn(21);
...
ListItem.contextType = fn(4350).ThemeContext;
...
prototype["renderVideo"] = function renderVideo() {
  ...
  if (null != video) {
    ...
    if (null != youtube_video_id) {
      ...
      const items = [closure_7(_modDef15641, obj4), ];
      let tmp6Result = null;
      if (!tmp2) {
        ...
        obj5.source = obj6;
        tmp6Result = tmp6(tmp7(5672), obj5);
        const tmp7Result = tmp7(5672);
      }
      items[1] = tmp6Result;
      obj3.children = items;
  ...
  if (null != video) {
    ...
    const obj10 = { accessibilityLabel: "Play Video", accessibilityRole: "button", source: tmp15(10529), onPress: self.playVideo, style: tmp.playButton, iconSize: tmp18(1177).IconSizes.CUSTOM, iconStyle: tmp.playIcon };
    obj9.children = tmp12(tmp15(9182), obj10);
    tmp12Result = tmp12(tmp18(5207).PressableOpacity, obj9);
    const tmp15Result = tmp15(9182);
  }
...
ChangeLog.contextType = fn(4350).ThemeContext;
size = fn(2);
