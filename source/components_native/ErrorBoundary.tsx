...
// Function ID: 14650
// Name: ErrorBoundary
// Dependencies: [5, 32, 19, 17, 11497, 21, 4605, 504, 11860, 5025, 1114, 4315, 1232, 573, 1178, 9919, 4601, 2]

// Module 14649 (ErrorBoundary)
...
import AppCrash from "AppCrash" /* 9919 */;
...
function MaybeClearBuildOverride() {
  ...
  if (null == obj.useStateFromStores(items, () => {
    ...
    return closure_9(tmp2(5025).Button, obj2);
  }
...
ErrorBoundary.contextType = fn(4315).ThemeContext;
const size = fn(2);
