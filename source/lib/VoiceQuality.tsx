...
// Function ID: 13911
// Name: VoiceQuality
// Dependencies: [32, 7847, 4697, 13911, 7853, 4694, 12, 4668, 2]

// Module 13910 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4668).now());
