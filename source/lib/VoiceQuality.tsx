...
// Function ID: 13873
// Name: VoiceQuality
// Dependencies: [32, 7815, 4665, 13873, 7821, 4662, 12, 4636, 2]

// Module 13872 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4636).now());
