...
// Function ID: 13843
// Name: VoiceQuality
// Dependencies: [32, 7756, 4632, 13843, 7762, 4629, 12, 4603, 2]

// Module 13842 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4603).now());
