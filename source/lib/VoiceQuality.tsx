...
// Function ID: 13892
// Name: VoiceQuality
// Dependencies: [32, 7793, 4663, 13892, 7799, 4660, 12, 4634, 2]

// Module 13891 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4634).now());
