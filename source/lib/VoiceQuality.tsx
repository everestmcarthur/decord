...
// Function ID: 13871
// Name: VoiceQuality
// Dependencies: [32, 7814, 4664, 13871, 7820, 4661, 12, 4635, 2]

// Module 13870 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4635).now());
