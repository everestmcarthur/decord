...
// Function ID: 5180
// Name: CloudUpload
// Dependencies: [109, 5, 32, 4606, 1185, 4656, 1074, 3, 1272, 5180, 5188, 1090, 559, 5221, 12, 1461, 5190, 5223, 5224, 5209, 5225, 5226, 5230, 5231, 1232, 5189, 5181, 5232, 5233, 1896, 5318, 1242, 2]

// Module 5179 (CloudUpload)
import LoggerDefault from "Logger" /* 3 */;
import BackoffDefault from "Backoff" /* 559 */;
import DurationsDefault from "Durations" /* 1090 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import HTTPUtils from "HTTPUtils" /* 1272 */;
import Upload2 from "Upload" /* 5180 */;
      ...
      try {
        ...
        if (0 === c8) {
          ...
          if (1 === tmp9) {
            ...
            if (2 === tmp9) {
                ...
                if (null != closure_132_3) {
                  ...
                  if (null != closure_132_3.convertedFile) {
                    ...
                    if (tmp130) {
                      ...
                      const obj14 = status(5209);
                      c8 = 3;
                      c9 = 1;
                      const obj10 = { value: status(5209).fromBlob(file).catch(() => null), done: false };
                      return obj10;
                    }
                  }
              ...
              if (3 === tmp9) {
                ...
                if (arg0 === 1) {
                  ...
                  const uploadPayload = v0(5225).default.getUploadPayload(closure_133_0);
                  c8 = 5;
                  c9 = 1;
                  const _default = v0(5225).default;
                }
              } else if (5 === tmp9) {
                if (arg0 === 1) {
                  c9 = 3;
                  ...
                  closure_132_5 = value;
                  uploadTarget = v0(5226).getUploadTarget(closure_133_0.item.target);
                  if (null != closure_132_5.filename) {
                    if ("" !== closure_132_5.filename) {
                      ...
                      if (0 !== closure_133_0.currentSize) {
                        kestrelConfig = v0(5231).getKestrelConfig({ location: "CloudUpload.upload.postCompressionCheck" });
                        const obj6 = v0(5231);
                        effectiveKestrelLimit = v0(5231).getEffectiveKestrelLimit(kestrelConfig, uploadTarget.getMaxFileSize(closure_133_0.channelId));
            ...
            if (!tmp141) {
              closure_133_0.mimeType = v0(5223).heicMimeType(file);
              const obj13 = v0(5223);
            }
          }
          if (closure_133_0.isCancelled()) {
            ...
            if (closure_133_0.item.platform === v0(5180).UploadPlatform.WEB) {
              if (!closure_132_0) {
              ...
              if (true !== closure_133_0.item.imageConversionEvaluated) {
                if (null != closure_133_0.item.file) {
                  if (obj25.isHeicFile(closure_133_0.item.file)) {
                    const HeicUploadConversionExperiment = v0(5224).HeicUploadConversionExperiment;
                    ...
                    if (null != uri) {
                      if (null != closure_129_0.file.type) {
                        ...
                        if (fileSize == null) {
                          c3 = 2;
                          c4 = 1;
                          const obj9 = { value: size(5181).getFileData(uri), done: false };
                          return obj9;
                        }
                      }
                    }
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            const uploadTarget = v3(5226).getUploadTarget(tmp17.item.target);
            dependencyMap = 1;
