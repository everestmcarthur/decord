...
// Function ID: 5179
// Name: CloudUpload
// Dependencies: [109, 5, 32, 4605, 1185, 4655, 1074, 3, 1272, 5179, 5187, 1090, 559, 5220, 12, 1461, 5189, 5222, 5223, 5208, 5224, 5225, 5229, 5230, 1232, 5188, 5180, 5231, 5232, 1896, 5317, 1242, 2]

// Module 5178 (CloudUpload)
import LoggerDefault from "Logger" /* 3 */;
import BackoffDefault from "Backoff" /* 559 */;
import DurationsDefault from "Durations" /* 1090 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import HTTPUtils from "HTTPUtils" /* 1272 */;
import Upload2 from "Upload" /* 5179 */;
  ...
  constructor(arg0, arg1, arg2, arg3) {
    ...
    if (typeof closure_16 === "function") {
      ...
      if (global.platform === tmp12(tmp13[9]).UploadPlatform.WEB) {
        if (null != global.imageConversionAnalytics) {
          ({ convertedMimeType, conversionFailureReason, compressTimeMs } = global.imageConversionAnalytics);
...
prototype["getResumePosition"] = function getResumePosition(responseUrl) {
  ...
  const self = this;
  return (async () => {
    const obj4 = { url, headers: { "Content-Range": "bytes */*" }, rejectWithError: true, retries: 0, timeout: { deadline: 30 * v1(1090).Millis.SECOND }, signal: self._abortController.signal };
      ...
      try {
        ...
        if (0 === c8) {
          ...
          if (1 === tmp9) {
            ...
            if (2 === tmp9) {
                ...
                if (null != closure_132_3) {
                  ...
                  if (null != closure_132_3.convertedFile) {
                    ...
                    if (tmp130) {
                      ...
                      const obj14 = status(5208);
                      c8 = 3;
                      c9 = 1;
                      const obj10 = { value: status(5208).fromBlob(file).catch(() => null), done: false };
                      return obj10;
                    }
                  }
              ...
              if (3 === tmp9) {
                ...
                if (arg0 === 1) {
                  ...
                  const uploadPayload = v0(5224).default.getUploadPayload(closure_133_0);
                  c8 = 5;
                  c9 = 1;
                  const _default = v0(5224).default;
                }
              } else if (5 === tmp9) {
                if (arg0 === 1) {
                  c9 = 3;
                  ...
                  closure_132_5 = value;
                  uploadTarget = v0(5225).getUploadTarget(closure_133_0.item.target);
                  if (null != closure_132_5.filename) {
                    if ("" !== closure_132_5.filename) {
                      ...
                      if (0 !== closure_133_0.currentSize) {
                        kestrelConfig = v0(5230).getKestrelConfig({ location: "CloudUpload.upload.postCompressionCheck" });
                        const obj6 = v0(5230);
                        effectiveKestrelLimit = v0(5230).getEffectiveKestrelLimit(kestrelConfig, uploadTarget.getMaxFileSize(closure_133_0.channelId));
            ...
            if (!tmp141) {
              closure_133_0.mimeType = v0(5222).heicMimeType(file);
              const obj13 = v0(5222);
            }
          }
          if (closure_133_0.isCancelled()) {
            ...
            if (closure_133_0.item.platform === v0(5179).UploadPlatform.WEB) {
              if (!closure_132_0) {
                if (true !== closure_133_0.item.imageConversionEvaluated) {
                  c8 = 4;
                  c9 = 1;
                  const obj22 = { value: CloudUpload.tryConvertToWebP(closure_133_0.item.file, () => v0._aborted, closure_133_0.id), done: false };
                  return obj22;
                }
              }
            }
              ...
              if (true !== closure_133_0.item.imageConversionEvaluated) {
                if (null != closure_133_0.item.file) {
                  if (obj25.isHeicFile(closure_133_0.item.file)) {
                    const HeicUploadConversionExperiment = v0(5223).HeicUploadConversionExperiment;
                    config = HeicUploadConversionExperiment.getConfig({ location: "CloudUpload.tryConvertHeicToJpeg" });
                    if (config.enabled) {
                      file = closure_133_0.item.file;
                      c8 = 2;
                      c9 = 1;
                      const obj23 = { value: CloudUpload.tryConvertHeicToJpeg(closure_133_0.item.file, () => v0._aborted, closure_133_0.id, config.quality, config.maxFileSizeBytes), done: false };
                      return obj23;
                    }
                  }
                  obj25 = v0(5222);
                    ...
                    if (null != uri) {
                      if (null != closure_129_0.file.type) {
                        ...
                        if (fileSize == null) {
                          c3 = 2;
                          c4 = 1;
                          const obj9 = { value: size(5180).getFileData(uri), done: false };
                          return obj9;
                        }
                      }
                    }
    ...
    if (c6 === 2) {
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            if (null != closure_0) {
              if (!closure_1()) {
                ...
                c5 = 2;
                c6 = 1;
                const obj5 = { value: UNKNOWN_ERROR(tmp3[29])(tmp3[30], tmp3.paths), done: false };
                return obj5;
              }
            }
            c6 = 3;
          ...
          c6 = 3;
          const obj6 = { value: { convertedFile: null, convertedMimeType: null, conversionFailureReason: "unknown_error", compressTimeMs: 0 }, done: true };
          return obj6;
        } else if (2 === tmp7) {
          if (arg0 === 1) {
            c6 = 3;
            ...
            closure_129_2 = closure_129_0.ImageConversionFailureReason;
            c5 = 3;
            c6 = 1;
            const obj8 = { value: closure_129_1(closure_130_0, closure_130_3, closure_130_4), done: false };
            return obj8;
          }
        } else if (arg0 === 1) {
          c6 = 3;
          ...
          if (!closure_130_1()) {
            ...
            if (null != closure_129_3) {
              if (!closure_129_3.success) {
                ...
                const obj = { convertedFile: null, convertedMimeType: null, conversionFailureReason: UNKNOWN_ERROR, compressTimeMs: closure_129_3.compressTimeMs };
              }
              const _HermesInternal2 = HermesInternal;
              logger.log("heic conversion worked for " + closure_130_2 + ": " + closure_129_3.sizeBefore + " -> " + closure_129_3.sizeAfter + " bytes");
              const obj10 = { convertedFile: null, convertedMimeType: "image/jpeg", conversionFailureReason: null, compressTimeMs: null };
              const _File = File;
              const items = [closure_129_3.convertedBlob];
              const obj11 = { type: "image/jpeg", lastModified: closure_130_0.lastModified };
              file = new File(items, UNKNOWN_ERROR(tmp3[17]).renameToJpegExtension(closure_130_0.name), obj11);
              obj10.convertedFile = file;
              obj10.compressTimeMs = closure_129_3.compressTimeMs;
              const obj3 = UNKNOWN_ERROR(tmp3[17]);
            }
          }
          c4 = 0;
          c6 = 3;
          const obj12 = { value: tmp10, done: true };
          return obj12;
        }
      } catch (tmp68) {
        closure_3 = tmp68;
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            const uploadTarget = v3(5225).getUploadTarget(tmp17.item.target);
            dependencyMap = 1;
        ...
        if (0 === c4) {
          if (arg0 === 1) {
            ...
            if (responseUrlStale.isResponseUrlStale(self.responseUrlSetAt)) {
              c4 = 1;
              c5 = 1;
              const obj4 = { value: _self(tmp40[20]).default.getUploadPayload(self), done: false };
              return obj4;
            } else {
              c5 = 3;
            }
