...
// Function ID: 5212
// Name: CloudUpload
// Dependencies: [109, 5, 32, 4638, 1184, 4688, 1074, 3, 1271, 5212, 5220, 1091, 559, 5253, 12, 1462, 5222, 5255, 5256, 5257, 5241, 5258, 5259, 5263, 5264, 1231, 5221, 5213, 5265, 5266, 1897, 5351, 1241, 2]

// Module 5211 (CloudUpload)
import LoggerDefault from "Logger" /* 3 */;
import BackoffDefault from "Backoff" /* 559 */;
import DurationsDefault from "Durations" /* 1091 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import HTTPUtils from "HTTPUtils" /* 1271 */;
import Upload2 from "Upload" /* 5212 */;
      ...
      try {
        ...
        if (0 === c8) {
            ...
            if (2 === tmp9) {
                ...
                if (null != closure_132_4) {
                  ...
                  if (null == closure_132_4.convertedFile) {
                    ...
                    if (tmp130) {
                      ...
                      const obj13 = status(5241);
                      c8 = 3;
                      c9 = 1;
                      const obj10 = { value: status(5241).fromBlob(file).catch(() => null), done: false };
                      return obj10;
                    } else {
              ...
              if (arg0 === 1) {
                ...
                if (arg0 !== 2) {
                  ...
                  const uploadPayload = v0(5258).default.getUploadPayload(closure_133_0);
                  c8 = 5;
                  c9 = 1;
                  const _default = v0(5258).default;
                }
                c9 = 3;
                const obj11 = { value, done: true };
                return obj11;
              ...
              if (arg0 === 1) {
                ...
                closure_132_6 = value;
                uploadTarget = v0(5259).getUploadTarget(closure_133_0.item.target);
                if (null != closure_132_6.filename) {
                  if ("" !== closure_132_6.filename) {
                    ...
                    if (0 !== closure_133_0.currentSize) {
                      kestrelConfig = v0(5264).getKestrelConfig({ location: "CloudUpload.upload.postCompressionCheck" });
                      const obj6 = v0(5264);
                      effectiveKestrelLimit = v0(5264).getEffectiveKestrelLimit(kestrelConfig, uploadTarget.getMaxFileSize(closure_133_0.channelId));
          ...
          if (closure_133_0.isCancelled()) {
            ...
            if (closure_133_0.item.platform === v0(5212).UploadPlatform.WEB) {
              if (!closure_132_0) {
              ...
              if (null != closure_133_0.item.file) {
                ...
                if (tmp173) {
                  if ("heic" === closure_132_1) {
                    const HeicUploadConversionExperiment = v0(5256).HeicUploadConversionExperiment;
                    let config = HeicUploadConversionExperiment.getConfig({ location: "CloudUpload.tryConvertToJpeg.heic" });
                  } else {
                    const JxrUploadConversionExperiment = v0(5257).JxrUploadConversionExperiment;
                  ...
                  if ("heic" === closure_132_1) {
                    let heicMimeTypeResult = v0(5255).heicMimeType(closure_133_0.item.file);
                    const obj20 = v0(5255);
                  } else {
                    heicMimeTypeResult = v0(5255).jxrMimeType(closure_133_0.item.file);
                    const obj19 = v0(5255);
                  }
                    ...
                    if (null != uri) {
                      if (null != closure_129_0.file.type) {
                        ...
                        if (fileSize == null) {
                          c3 = 2;
                          c4 = 1;
                          const obj9 = { value: size(5213).getFileData(uri), done: false };
                          return obj9;
                        }
                      }
                    }
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            const uploadTarget = v3(5259).getUploadTarget(tmp17.item.target);
            dependencyMap = 1;
