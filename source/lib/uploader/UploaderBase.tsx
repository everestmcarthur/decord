...
// Function ID: 7914
// Name: UploaderBase
// Dependencies: [5, 1074, 4600, 3, 568, 12, 5226, 5231, 5188, 5189, 2]

// Module 7913 (UploaderBase)
      ...
      try {
        ...
        if (0 === c8) {
          if (arg0 === 1) {
            ...
            const uploadTarget = _self(5226).getUploadTarget(target);
            ...
            if (self.files.length > uploadTarget.getMaxAttachmentsCount()) {
              ...
              kestrelConfig = _self(5231).getKestrelConfig({ location: "UploaderBase.compressAndCheckFileSize" });
              const _HermesInternal3 = HermesInternal;
              tmp65.log("compressing files for " + self.id);
              const files = self.files;
              _self = files[Symbol.iterator]();
              const obj15 = _self(5231);
            }
            const obj14 = _self(5226);
          }
        } else if (1 === tmp9) {
          c7 = 0;
          _self.return();
          ...
          if (0 === dependencyMap) {
            ...
            effectiveKestrelLimit = _self(5231).getEffectiveKestrelLimit(kestrelConfig, closure_132_0.getMaxFileSize(closure_132_2.channelId));
