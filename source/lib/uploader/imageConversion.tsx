...
// Dependencies: [5, 3, 4869, 5256, 4258, 2]
// Exports: convertFileToJpeg

// Module 5352 (imageConversion)
...
export const renameToJpegExtension = fn(5256).renameToJpegExtension;
