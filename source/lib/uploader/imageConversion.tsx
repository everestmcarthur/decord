...
// Dependencies: [5, 3, 4870, 5255, 4260, 2]
// Exports: convertFileToJpeg

// Module 5351 (imageConversion)
...
export const renameToJpegExtension = fn(5255).renameToJpegExtension;
