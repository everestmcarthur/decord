...
// Dependencies: [5, 3, 4871, 5258, 4260, 2]
// Exports: convertFileToJpeg

// Module 5354 (imageConversion)
...
export const renameToJpegExtension = fn(5258).renameToJpegExtension;
