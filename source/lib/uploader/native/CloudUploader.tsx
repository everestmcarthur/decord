...
// Function ID: 7954
// Name: CloudUploader
// Dependencies: [5, 17, 1074, 4631, 3, 7954, 7869, 1115, 5265, 5223, 5260, 7955, 1364, 7956, 5212, 5213, 12, 2]

// Module 7953 (CloudUploader)
import LoggerDefault from "Logger" /* 3 */;
import _modDef12 from "module_12" /* 12 */;
import Upload from "Upload" /* 5213 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import UploaderBase from "UploaderBase" /* 7954 */;
      ...
      try {
        ...
        if (0 === c6) {
          if (arg0 === 1) {
            ...
            let uploadTarget;
            closure_130_0 = files(7869).backgroundTaskIdentifierInvalid;
                ...
                try {
                  ...
                  if (0 === length) {
                    if (arg0 === 1) {
                      ...
                      c2 = 1;
                      const obj7 = { value: files(7869).startBackgroundTask(obj4), done: false };
                      return obj7;
                    }
                  } else if (arg0 === 1) {
                    c2 = 3;
                    ...
                    closure_128_0 = value;
                    if (tmp2._aborted) {
                      files(7869).endBackgroundTask(closure_128_0);
                      const obj = files(7869);
                    }
                    c2 = 3;
                    return { value: "HermesInternal", done: null };
                  }
          ...
          uploadTarget = _self(5260).getUploadTarget(closure_130_5.item.target);
          const _Math = Math;
          if (closure_130_6 > Math.max(uploadTarget.getMaxFileSize(closure_130_5.channelId), c6)) {
            ...
            if (closure_130_4 > uploadTarget.getMaxTotalAttachmentSize()) {
              ...
              if (_self === undefined) {
                ...
                c6 = 3;
                constants = 1;
                const obj18 = { value: _self(5223).getFileSize(closure_130_5.item.uri), done: false };
                return obj18;
              }
            }
          }
          const obj19 = _self(5260);
        }
      } catch (tmp83) {
        if (tmp5 === c5) {
          constants = tmp3;
