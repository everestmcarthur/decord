...
// Function ID: 13936
// Name: VideoQuality
// Dependencies: [4698, 13932, 4669, 7862, 4695, 7861, 12, 1364, 11, 1975, 2]

// Module 13935 (VideoQuality)
...
import Histogram from "Histogram" /* 7862 */;
import NetworkQualityDefault from "NetworkQuality" /* 13932 */;
import TypedEventEmitter from "TypedEventEmitter" /* 4698 */;
...
prototype["getCodecUsageStats"] = function getCodecUsageStats(receiver, userId) {
  ...
  if ("sender" !== receiver) {
    if ("streamer" !== receiver) {
      ...
      let num2 = value.get(tmp2(7861).CodecTypes.H265);
      if (num2 == null) {
        num2 = 0;
      }
      obj.codec_h265_decode_duration_sec = num2;
      let num3 = value.get(tmp2(7861).CodecTypes.VP8);
      if (num3 == null) {
        num3 = 0;
      }
      obj.codec_vp8_decode_duration_sec = num3;
      let num4 = value.get(tmp2(7861).CodecTypes.VP9);
      if (num4 == null) {
        num4 = 0;
      }
      obj.codec_vp9_decode_duration_sec = num4;
      let num5 = value.get(tmp2(7861).CodecTypes.AV1);
      if (num5 == null) {
        num5 = 0;
      }
      obj.codec_av1_decode_duration_sec = num5;
      let num6 = value.get(tmp2(7861).CodecTypes.UNKNOWN);
      if (num6 == null) {
        num6 = 0;
      }
  ...
  let num9 = map.get(tmp7(7861).CodecTypes.H265);
  if (num9 == null) {
    num9 = 0;
  }
  obj2.codec_h265_encode_duration_sec = num9;
  let num10 = map.get(tmp7(7861).CodecTypes.VP8);
  if (num10 == null) {
    num10 = 0;
  }
  obj2.codec_vp8_encode_duration_sec = num10;
  let num11 = map.get(tmp7(7861).CodecTypes.VP9);
  if (num11 == null) {
    num11 = 0;
  }
  obj2.codec_vp9_encode_duration_sec = num11;
  let num12 = map.get(tmp7(7861).CodecTypes.AV1);
  if (num12 == null) {
    num12 = 0;
  }
  obj2.codec_av1_encode_duration_sec = num12;
  let num13 = map.get(tmp7(7861).CodecTypes.UNKNOWN);
  if (num13 == null) {
    num13 = 0;
  }
  ...
  let item = self(12).forEach(this.outboundStats, (vmafHistogram, arg1) => {
    ...
    if (!obj2.isWeb()) {
      if (!tmp9Result.isIOS()) {
        ...
        let result1 = null;
        if (context === tmp9(4695).MediaEngineContextTypes.STREAM) {
          result1 = null;
          if (0 < result) {
        ...
        const tmp34 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.NVIDIA_CUDA];
        let num13 = 0;
        if (null != tmp34) {
          const _Math = Math;
        ...
        const tmp36 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.NVIDIA_DIRECT_3D];
        let num14 = 0;
        if (null != tmp36) {
          const _Math2 = Math;
        ...
        const tmp38 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.NVIDIA_VULKAN];
        let num15 = 0;
        if (null != tmp38) {
          const _Math3 = Math;
        ...
        const tmp40 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.OPENH264];
        let num16 = 0;
        if (null != tmp40) {
          const _Math4 = Math;
        ...
        const tmp42 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.VIDEOTOOLBOX];
        let num17 = 0;
        if (null != tmp42) {
          const _Math5 = Math;
        ...
        const tmp44 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.AMD_DIRECT_3D];
        let num18 = 0;
        if (null != tmp44) {
          const _Math6 = Math;
        ...
        const tmp46 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.AMD_VAAPI];
        let num19 = 0;
        if (null != tmp46) {
          const _Math7 = Math;
        ...
        const tmp48 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.INTEL];
        let num20 = 0;
        if (null != tmp48) {
          const _Math8 = Math;
        ...
        const tmp50 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.INTEL_DIRECT_3D];
        let num21 = 0;
        if (null != tmp50) {
          const _Math9 = Math;
        ...
        const tmp52 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.INTEL_VAAPI];
        let num22 = 0;
        if (null != tmp52) {
          const _Math10 = Math;
        ...
        const tmp54 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.VP8_LIBVPX];
        let num23 = 0;
        if (null != tmp54) {
          const _Math11 = Math;
        ...
        const tmp56 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.UNCATEGORIZED];
        let num24 = 0;
        if (null != tmp56) {
          const _Math12 = Math;
        ...
        const tmp58 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.WMF_CHROME];
        let num25 = 0;
        if (null != tmp58) {
          const _Math13 = Math;
        ...
        const tmp60 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.UNKNOWN];
        let num26 = 0;
        if (null != tmp60) {
          const _Math14 = Math;
        ...
        const tmp95 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.EXYNOS];
        let num32 = 0;
        if (null != tmp95) {
          const _Math20 = Math;
        ...
        const tmp97 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.QUALCOMM];
        let num33 = 0;
        if (null != tmp97) {
          const _Math21 = Math;
        ...
        const tmp99 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.MEDIATEK];
        let num34 = 0;
        if (null != tmp99) {
          const _Math22 = Math;
        ...
        const tmp101 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.WMF_SW];
        let num35 = 0;
        if (null != tmp101) {
          const _Math23 = Math;
        ...
        const tmp103 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.WMF_HW];
        let num36 = 0;
        if (null != tmp103) {
          const _Math24 = Math;
        ...
        const tmp105 = vmafHistogram.encoderBuckets[tmp9(undefined, 7861).Encoders.WMF_DIRECT_3D];
        let num37 = 0;
        if (null != tmp105) {
          const _Math25 = Math;
...
prototype["receivedStats"] = function receivedStats(nowResult, transport, streamParameters) {
  ...
  let tmp7 = self.connection.context === tmp(4695).MediaEngineContextTypes.DEFAULT;
  if (tmp7) {
    tmp7 = null != transport.camera;
  }
  self.cameraDuration.value = tmp7;
  let tmp9 = self.connection.context === tmp(4695).MediaEngineContextTypes.DEFAULT;
  if (tmp9) {
  ...
  let tmp11 = self.connection.context === tmp(4695).MediaEngineContextTypes.DEFAULT;
  if (tmp11) {
