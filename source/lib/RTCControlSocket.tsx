...
// Dependencies: [1347, 1908, 4632, 1090, 4665, 559, 3, 4636, 14132, 1115, 38, 2]
...
prototype["createWebSocket"] = function createWebSocket() {
  ...
  self.connectionStartTime = self(4636).now();
...
prototype["handleHello"] = function handleHello(d) {
  ...
  const diff = tmp4(4636).now() - self.connectionStartTime;
