...
// Dependencies: [1346, 1909, 4664, 1091, 4697, 559, 3, 4668, 14171, 1364, 38, 2]
...
prototype["createWebSocket"] = function createWebSocket() {
  ...
  self.connectionStartTime = self(4668).now();
...
prototype["handleHello"] = function handleHello(d) {
  ...
  const diff = tmp4(4668).now() - self.connectionStartTime;
