...
// Dependencies: [1346, 1909, 4663, 1091, 4696, 559, 3, 4667, 14184, 1364, 38, 2]
...
prototype["createWebSocket"] = function createWebSocket() {
  ...
  self.connectionStartTime = self(4667).now();
...
prototype["handleHello"] = function handleHello(d) {
  ...
  const diff = tmp4(4667).now() - self.connectionStartTime;
