...
// Dependencies: [1347, 1908, 4599, 1090, 4632, 559, 3, 4603, 14105, 1115, 38, 2]
...
prototype["createWebSocket"] = function createWebSocket() {
  ...
  self.connectionStartTime = self(4603).now();
...
prototype["handleHello"] = function handleHello(d) {
  ...
  const diff = tmp4(4603).now() - self.connectionStartTime;
