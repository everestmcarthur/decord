...
// Dependencies: [2015, 4278, 1962, 1958, 1980, 1372, 1074, 4289, 4820, 1084, 4279, 12, 1385, 573, 11, 504, 2]
// Exports: convertChannelOverridesToMap, getGuildDefaults

// Module 4819 (UserGuildSettingsStore)
...
const AccountNotificationFlags = fn(4289).AccountNotificationFlags;
