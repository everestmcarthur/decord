...
// Function ID: 10131
// Name: RTCDebugStore
// Dependencies: [32, 1908, 1371, 1074, 4632, 10131, 4662, 573, 504, 2]
// Exports: getLastGraphValue, keySection, parseSection

// Module 10130 (RTCDebugStore)
  ...
  RTC_DEBUG_MODAL_OPEN_REPLAY_AT_PATH: function handleOpenReplayAtPath(path) {
    ...
    if (mediaEngine.supports(constants.CONNECTION_REPLAY)) {
      if (0 !== path.length) {
        ...
        if (null != replayConnection) {
          replayConnection.on(replayConnection(4662).BaseConnectionEvent.Video, (userId, arg1, arg2, arg3) => {
            let num = arg3;
