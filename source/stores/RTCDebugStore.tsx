...
// Function ID: 10129
// Name: RTCDebugStore
// Dependencies: [32, 1908, 1371, 1074, 4631, 10129, 4661, 573, 504, 2]
// Exports: getLastGraphValue, keySection, parseSection

// Module 10128 (RTCDebugStore)
  ...
  RTC_DEBUG_MODAL_OPEN_REPLAY_AT_PATH: function handleOpenReplayAtPath(path) {
    ...
    if (mediaEngine.supports(constants.CONNECTION_REPLAY)) {
      if (0 !== path.length) {
        ...
        if (null != replayConnection) {
          replayConnection.on(replayConnection(4661).BaseConnectionEvent.Video, (userId, arg1, arg2, arg3) => {
            let num = arg3;
