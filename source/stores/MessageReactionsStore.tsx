...
// Dependencies: [4246, 1385, 1957, 1371, 7835, 504, 7836, 573, 2]

// Module 7834 (MessageReactionsStore)
...
const dependencyMap = {};
const items = [fn(7835).ReactionTypes.NORMAL, fn(7835).ReactionTypes.BURST];
