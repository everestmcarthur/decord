...
// Dependencies: [4246, 1385, 1957, 1371, 7836, 504, 7837, 573, 2]

// Module 7835 (MessageReactionsStore)
...
const dependencyMap = {};
const items = [fn(7836).ReactionTypes.NORMAL, fn(7836).ReactionTypes.BURST];
