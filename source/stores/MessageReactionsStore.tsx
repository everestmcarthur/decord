...
// Dependencies: [4244, 1385, 1957, 1371, 7814, 504, 7815, 573, 2]

// Module 7813 (MessageReactionsStore)
...
const dependencyMap = {};
const items = [fn(7814).ReactionTypes.NORMAL, fn(7814).ReactionTypes.BURST];
