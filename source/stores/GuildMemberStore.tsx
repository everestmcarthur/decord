...
// Dependencies: [2022, 2014, 502, 1957, 2015, 1979, 4230, 3, 4231, 2019, 1384, 11, 1881, 1882, 1388, 4232, 1369, 1893, 12, 4233, 504, 573, 2]
...
function trackCommunicationDisabled(guildId, tmp10Result) {
  if (null != tmp10Result.communicationDisabledUntil) {
    if (obj2.isMemberCommunicationDisabled(tmp10Result)) {
      ...
      if (result) {
        result = tmp10(4231).isMemberCommunicationDisabled(tmp10Result);
        tmp10Result = tmp10(4231);
      }
      if (result) {
    ...
    if (null == guild) {
      ...
      if (null != tmp14[user.id].communicationDisabledUntil) {
        if (tmp33Result.isMemberCommunicationDisabled(tmp16)) {
          ...
          if (result) {
            result = tmp33(4231).isMemberCommunicationDisabled(tmp16);
            const tmp33Result2 = tmp33(4231);
          }
          if (result) {
      ...
      const item = members.forEach((user) => {
        ...
        if (null != dependencyMap[user.user.id].communicationDisabledUntil) {
          if (tmp5Result7.isMemberCommunicationDisabled(tmp9)) {
            ...
            if (result) {
              result = tmp5(4231).isMemberCommunicationDisabled(tmp9);
              const tmp5Result8 = tmp5(4231);
            }
            if (result) {
      ...
      if (null == guild) {
        ...
        if (null != tmp[guildMember.user.id].communicationDisabledUntil) {
          if (tmp18Result.isMemberCommunicationDisabled(tmp22)) {
            ...
            if (result) {
              result = tmp18(4231).isMemberCommunicationDisabled(tmp22);
              const tmp18Result2 = tmp18(4231);
            }
            if (result) {
