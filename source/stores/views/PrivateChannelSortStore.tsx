...
// Dependencies: [7322, 7323, 1961, 1957, 1979, 4651, 4817, 1371, 11, 4271, 4228, 7324, 504, 573, 2]

// Module 7321 (PrivateChannelSortStore)
...
const secondaryIndexMap = new fn(4271).SecondaryIndexMap(function indexBy(value) {
  if (value.isRequest) {
    let items = [];
  } else {
