...
// Dependencies: [1916, 502, 1909, 4680, 4663, 1074, 4682, 38, 4684, 12, 4692, 7858, 573, 4695, 1364, 504, 13916, 2]

// Module 4679 (StreamRTCConnectionStore)
import _modDef12 from "module_12" /* 12 */;
import _modDef38 from "module_38" /* 38 */;
import initializeDefault from "initialize" /* 504 */;
import StreamRTCConnectionDefault from "StreamRTCConnection" /* 4684 */;
  ...
  let obj = {
    ...
    STREAM_CREATE: function handleStreamCreate(arg0) {
        ...
        if (tmp7) {
          ...
          if (tmp11) {
            tmp10[streamKey] = tmp4(7858).getStreamerApplication(decodeStreamKeyResult, PresenceStore);
            const tmp4Result = tmp4(7858);
          }
          ...
          const streamRTCAnalyticsContext = new tmp4(4684).StreamRTCAnalyticsContext(obj3);
