...
// Dependencies: [4462, 4279, 1220, 5524, 4981, 2022, 1980, 1073, 4820, 1372, 5525, 1331, 38, 1370, 1934, 2]
...
function convertNodeToGuildFolder(type) {
  ...
  if (obj42(5525).GuildsNodeType.FOLDER === type) {
    ...
    return obj3;
  } else if (tmp(5525).GuildsNodeType.GUILD === type) {
  ...
  if (null != node) {
    if (null != node1) {
      ...
      if (combine) {
        ...
        if (node1.type !== tmp13(5525).GuildsNodeType.FOLDER) {
