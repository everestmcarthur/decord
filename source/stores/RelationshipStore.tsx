...
// Dependencies: [32, 4256, 1371, 1074, 573, 504, 2]

// Module 4255 (RelationshipStore)
...
let closure_16 = 0;
let size = 0;
let closure_19 = { friends: "Array", blocked: "call", ignored: "items", blockedOrIgnored: "httpServerLocation" };
const set3 = new Set();
const map1 = new Map();
