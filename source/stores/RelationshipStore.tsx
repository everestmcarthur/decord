...
// Dependencies: [32, 4254, 1371, 1074, 573, 504, 2]

// Module 4253 (RelationshipStore)
...
let closure_16 = 0;
let size = 0;
let closure_19 = { friends: "call", blocked: "header", ignored: "rejectWithError", blockedOrIgnored: "Array" };
const set3 = new Set();
const map1 = new Map();
