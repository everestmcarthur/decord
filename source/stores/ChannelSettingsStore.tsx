...
// Dependencies: [1962, 8612, 1386, 1958, 1074, 1114, 4373, 4375, 1967, 1968, 1271, 573, 12, 1972, 4314, 504, 2]

// Module 8864 (ChannelSettingsStore)
...
function _createInvite(code) {
  ...
  obj.createdAt = _modDef4314(code.created_at);
