...
// Dependencies: [1962, 8510, 1386, 1958, 1074, 1114, 4288, 4290, 1967, 1968, 1271, 573, 12, 1972, 4229, 504, 2]

// Module 8761 (ChannelSettingsStore)
...
function _createInvite(code) {
  ...
  obj.createdAt = _modDef4229(code.created_at);
