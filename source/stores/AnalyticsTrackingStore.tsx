...
// Dependencies: [502, 1074, 1250, 573, 7513, 1242, 7524, 7525, 2]

// Module 7512 (stores/AnalyticsTrackingStore)
...
const obj2 = {
  ...
  scheduleWhenIdle: fn(7524).requestSafeIdleCallback,
  sendUnloadRequest: fn(7525).sendUnloadRequest
};
