...
// Dependencies: [502, 1074, 1250, 573, 7534, 1242, 7545, 7546, 2]

// Module 7533 (stores/AnalyticsTrackingStore)
...
const obj2 = {
  ...
  scheduleWhenIdle: fn(7545).requestSafeIdleCallback,
  sendUnloadRequest: fn(7546).sendUnloadRequest
};
