...
// Dependencies: [502, 1074, 1250, 573, 7535, 1242, 7546, 7547, 2]

// Module 7534 (stores/AnalyticsTrackingStore)
...
const obj2 = {
  ...
  scheduleWhenIdle: fn(7546).requestSafeIdleCallback,
  sendUnloadRequest: fn(7547).sendUnloadRequest
};
