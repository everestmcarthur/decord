...
// Dependencies: [502, 1074, 1250, 573, 7475, 1242, 7486, 7487, 2]

// Module 7474 (stores/AnalyticsTrackingStore)
...
const obj2 = {
  ...
  scheduleWhenIdle: fn(7486).requestSafeIdleCallback,
  sendUnloadRequest: fn(7487).sendUnloadRequest
};
