...
// Dependencies: [32, 5, 1909, 1914, 4490, 1915, 4619, 1221, 502, 14021, 9122, 1957, 4597, 1371, 14022, 1074, 4616, 4784, 14023, 1084, 14024, 4599, 3, 1090, 1115, 4629, 13287, 4461, 5153, 14025, 14026, 9728, 14027, 12, 14028, 13841, 14029, 14030, 14031, 14032, 14033, 14034, 14035, 9142, 1242, 573, 10027, 14036, 14037, 14038, 14039, 5434, 14040, 14085, 14086, 14087, 14088, 14089, 14090, 4709, 4568, 4195, 510, 14091, 10014, 5579, 14095, 14096, 1114, 4897, 14097, 14098, 14099, 38, 13853, 13852, 14100, 13836, 1232, 13701, 9642, 504, 14101, 14102, 14103, 14104, 2]
...
import NativePermissionUtils_mod from "NativePermissionUtils" /* 5153 */;
          ...
          if (null != tmp2.desktopSource) {
            ...
            if (!isWindowsResult) {
              ...
              if (!isWindowsResult1) {
                ...
                if (videoHook2) {
                  const DisableHookFramePacerExperiment = tmp70(14032).DisableHookFramePacerExperiment;
                  tmp55 = !DisableHookFramePacerExperiment.getConfig({ location: "updateVideo" }).enabled;
                }
                let enabled2 = videoHook2;
                if (videoHook2) {
                  const VideoHookDX12Experiment = tmp70(14033).VideoHookDX12Experiment;
                  enabled2 = VideoHookDX12Experiment.getConfig({ location: "updateVideo" }).enabled;
                }
                const UpscaleSmallCapturedFramesExperiment = tmp70(14034).UpscaleSmallCapturedFramesExperiment;
                ...
                obj7.enableGlobalFramePoolLock = tmp70(14035).getGlobalFramePoolLockExperimentConfig({ location: "updateVideo" }).enabled;
                ...
                const tmp70Result7 = tmp70(14035);
              } else if (true === c132) {
                const WGCDirtyRegionsExperiment = tmp70(14030).WGCDirtyRegionsExperiment;
                enabled = WGCDirtyRegionsExperiment.getConfig({ location: "updateVideo" }).enabled;
              } else {
                const WGCDirtyRegionsAllExperiment = tmp70(14031).WGCDirtyRegionsAllExperiment;
...
function handleVideoFilterError(code, arg1) {
  ...
  if (arg1 !== constants11.LIVE) {
    ...
    if (constants10.UNSUPPORTED === code) {
      AVUnderlyingError = tmp4(9142).AVUnderlyingError;
      let VideoBackgroundInitFailed = AVUnderlyingError.VideoBackgroundUnsupported;
    } else if (tmp5.INIT_FAILED === code) {
      VideoBackgroundInitFailed = tmp4(9142).AVUnderlyingError.VideoBackgroundInitFailed;
    }
...
function updateConnectionVoiceProcessing(setEchoCancellation) {
  ...
  let isWindowsResult = PlatformUtils.isWindows();
  if (isWindowsResult) {
    const tmp10Result6 = tmp10(4195);
    let release;
    if (tmp10Result6 != null) {
      release = tmp10Result6.os.release;
    }
    isWindowsResult = tmp10(14040).satisfies(release, c154);
    const tmp10Result5 = tmp10(14040);
  }
  if (isWindowsResult) {
    if (setEchoCancellation.context === MediaEngineContextTypes.DEFAULT) {
      const systemwideEchoCancellationExperimentConfig = tmp26(14037).getSystemwideEchoCancellationExperimentConfig({ location: "updateConnectionVoiceProcessing" });
      ...
      const tmp26Result = tmp26(14037);
    }
  }
  if (tmp26Result4.isDesktop()) {
    const result5 = setEchoCancellation.setNoiseCancellationCpuDisablement(tmp26(14038).getKrispCpuDisablementConfig({ location: "updateConnectionVoiceProcessing" }).consecutiveFailures);
    const tmp26Result5 = tmp26(14038);
  }
...
function applySettings() {
  ...
  if (obj2.isWindows()) {
    if (obj3.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
      ...
      if (null != guid) {
        tmp5(14096)(tmp7.guid, inputDeviceId, obj);
      }
    }
...
prototype["initialize"] = function initialize() {
  ...
  closure_72.on(pollMetrics(4629).MediaEngineEvent.Connection, (setAttenuation) => {
    ...
    tmp9Result19 = pollMetrics(14039);
    ...
    if (tmp9Result20.isWindows()) {
      ...
      if (tmp9Result21.isMac()) {
        ...
        if (satisfiesResult) {
          ...
          satisfiesResult = tmp25(14040).satisfies(release, closure_39);
          const tmp25Result = tmp25(14040);
        }
    ...
    if (tmp9Result26.isWeb()) {
      setAttenuation.setExperimentFlag(tmp22.BROWSER_HEVC, tmp25(14086).getConfig({ location: "MediaEngineStore" }).enabled);
      const tmp25Result2 = tmp25(14086);
    }
    ...
    if (enabled4) {
      ...
      const tmp9Result34 = tmp9(14087);
    }
    if (enabled4) {
      setAttenuation.setExperimentFlag(tmp22.WMF_GPU_ENCODE, true);
    }
    const result2 = closure_72.setHasFullbandPerformance(tmp25(14090)());
  ...
  closure_72.on(pollMetrics(4629).MediaEngineEvent.WatchdogTimeout, asyncGeneratorStep(async (arg0, value) => {
    if (c6 === 2) {
      c6 = 3;
      throw new TypeError("Generator functions may not be called on executing generators");
    } else if (tmp6 === 3) {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            if ("canary" === window.GLOBAL_ENV.RELEASE_CHANNEL) {
              ...
              c5 = 2;
              c6 = 1;
              const obj6 = { value: closure_1(4568).submitLiveCrashReport(obj4), done: false };
              return obj6;
            }
          }
        } else if (1 === tmp7) {
  ...
  closure_72.on(pollMetrics(4629).MediaEngineEvent.VoiceQueueMetrics, (arg0) => {
  ...
  _modDef12.each(value2, (modeOptions) => {
    ...
    if (tmp8) {
      modeOptions.modeOptions.shortcut = tmp2(14091).toCombo(modeOptions.modeOptions.shortcut);
...
prototype["getVideoEncoderExperiments"] = function getVideoEncoderExperiments(STREAM, streamer) {
  ...
  if (isWindowsResult) {
    ...
    const VideoCaptureDeviceNoReuseExperiment = tmp6(14103).VideoCaptureDeviceNoReuseExperiment;
...
const mediaEngineStore = new MediaEngineStore(DispatcherDefault, {
  ...
  CONNECTION_OPEN: function handleConnectionOpen(sessionId) {
    ...
    if (enabled) {
      enabled = tmp2(14098).getIOSAudioInterruptExperimentConfig("handleConnectionOpen").enabled;
      const tmp2Result5 = tmp2(14098);
    }
    if (enabled) {
    ...
    if (tmp2Result6.isIOS()) {
      ...
      if (setNcModels != null) {
        setNcModels(tmp2(14099).getKrispV9iOSModels());
        const tmp2Result7 = tmp2(14099);
      }
      mediaEngineStore.emitChange();
    }
    const inputDeviceId = tmp.inputDeviceId;
    ...
    if (tmp2Result8.isWindows()) {
      if (obj9.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
        ...
        if (null != guid) {
          tmp21(14096)(tmp23.guid, inputDeviceId, obj3);
        }
      }
  ...
  AUDIO_SET_LOCAL_VIDEO_DISABLED: function handleSetLocalVideoDisabled(arg0) {
    ...
    if (!tmp22) {
      ...
      if (isAutomatic) {
        tmp3(13853)(userId, tmp12 ? constants13.AUTO_DISABLE : constants13.AUTO_ENABLE, tmp11);
        if (tmp12) {
          obj.add(userId);
        } else {
          obj.delete(userId);
        ...
        if (hasItem) {
          if (!tmp12) {
            ...
            tmp3(13853)(userId, constants13.MANUAL_REENABLE, tmp11);
          }
        }
        tmp3(13853)(userId, tmp12 ? constants13.MANUAL_DISABLE : constants13.MANUAL_ENABLE, tmp11);
      }
      if (tmp19) {
        tmp19 = !tmp12;
      }
  ...
  AUDIO_SET_INPUT_DEVICE: function handleSetInputDevice(id) {
    ...
    if (obj6.isWindows()) {
      if (obj7.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
        ...
        if (null != guid) {
          tmp20(14096)(tmp22.guid, id, obj5);
        }
      }
  ...
  MEDIA_ENGINE_DEVICES: function handleDevices(videoDevices) {
    ...
    if (0 === arr.length) {
      let obj = { id: DEFAULT_DEVICE_ID, index: 0, name: tmp5, disabled: true, guid: "call", hardwareId: "forEach", containerId: "fileFinishedImporting" };
      obj2 = {};
      obj2[obj.id] = obj;
    ...
    if (!obj4.isEqual(valueResult, tmp)) {
      ...
      if (tmp3Result.isWindows()) {
        if (tmp9Result.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
          ...
          if (null != guid) {
            tmp9(14096)(tmp18.guid, id, obj7);
          }
        }
        tmp9Result = tmp9(14095);
      }
    ...
    if (0 === arr3.length) {
      const obj3 = { id: DEFAULT_DEVICE_ID, index: 0, name: tmp24, disabled: true, guid: "call", hardwareId: "forEach", containerId: "fileFinishedImporting" };
      const obj6 = {};
      obj6[obj3.id] = obj3;
    ...
    if (0 === arr5.length) {
      const obj8 = { id: DEFAULT_DEVICE_ID, index: 0, name: tmp41, disabled: true, guid: "call", hardwareId: "forEach", containerId: "fileFinishedImporting" };
      const obj9 = {};
      obj9[obj8.id] = obj8;
    ...
    if (closure_94) {
      if (!tmp9Result4.isEqual(valueResult4, tmp40)) {
        ...
        let tmp52 = "Firefox" === tmp9(4897).name;
        if (tmp52) {
          tmp52 = "" === closure_95;
        }
        if (tmp52) {
  ...
  CLIPS_INIT: function handleClipsInit(applicationName) {
    ...
    if (obj.isClipsEnabled()) {
      if (null != DiscordNativeDefault) {
        ...
        const pidFromDesktopSource = tmp3(4568).getPidFromDesktopSource(sourceId);
        const tmp3Result = tmp3(4568);
        ...
        if (videoHook2) {
          const DisableHookFramePacerExperiment = tmp(14032).DisableHookFramePacerExperiment;
          tmp21 = !DisableHookFramePacerExperiment.getConfig({ location: "handleClipsInit" }).enabled;
        }
        enabled = videoHook2;
        if (videoHook2) {
          const VideoHookDX12Experiment = tmp(14033).VideoHookDX12Experiment;
          enabled = VideoHookDX12Experiment.getConfig({ location: "handleClipsInit" }).enabled;
        }
        const UpscaleSmallCapturedFramesExperiment = tmp(14034).UpscaleSmallCapturedFramesExperiment;
        ...
        ({ minCaptureWidth, minCaptureHeight } = config);
        const obj8 = result;
        const tmpResult4 = tmp(14025);
        let isWindowsResult = tmp(1115).isWindows();
        if (isWindowsResult) {
          const tmp3Result6 = tmp3(4195);
          let release;
          if (tmp3Result6 != null) {
            release = tmp3Result6.os.release;
          }
          isWindowsResult = tmp3(14040).satisfies(release, __initData7);
          const tmp3Result5 = tmp3(14040);
        }
        ...
        if (isMacResult) {
          const tmp3Result8 = tmp3(4195);
          let release1;
          if (tmp3Result8 != null) {
            release1 = tmp3Result8.os.release;
          }
          isMacResult = tmp3(14040).satisfies(release1, __initData4);
          const tmp3Result7 = tmp3(14040);
        }
