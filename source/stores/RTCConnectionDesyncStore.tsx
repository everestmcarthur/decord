...
// Dependencies: [4659, 1958, 4662, 1372, 4658, 4663, 1074, 4660, 1933, 4791, 8336, 4694, 504, 573, 2]

// Module 13850 (RTCConnectionDesyncStore)
...
const makeSortedVoiceState = fn(4663).makeSortedVoiceState;
