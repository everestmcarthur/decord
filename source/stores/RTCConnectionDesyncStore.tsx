...
// Dependencies: [4627, 1957, 4630, 1371, 4626, 4631, 1074, 4628, 1932, 4759, 8303, 4662, 504, 573, 2]

// Module 13812 (RTCConnectionDesyncStore)
...
const makeSortedVoiceState = fn(4631).makeSortedVoiceState;
