...
// Dependencies: [4626, 1957, 4629, 1371, 4625, 4630, 1074, 4627, 1932, 4758, 8301, 4661, 504, 573, 2]

// Module 13810 (RTCConnectionDesyncStore)
...
const makeSortedVoiceState = fn(4630).makeSortedVoiceState;
