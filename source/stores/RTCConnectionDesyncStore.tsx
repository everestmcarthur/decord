...
// Dependencies: [4594, 1957, 4597, 1371, 4593, 4598, 1074, 4595, 1932, 4726, 8243, 4629, 504, 573, 2]

// Module 13782 (RTCConnectionDesyncStore)
...
const makeSortedVoiceState = fn(4598).makeSortedVoiceState;
