...
// Dependencies: [4625, 1957, 4628, 1371, 4624, 4629, 1074, 4626, 1932, 4757, 8280, 4660, 504, 573, 2]

// Module 13831 (RTCConnectionDesyncStore)
...
const makeSortedVoiceState = fn(4629).makeSortedVoiceState;
