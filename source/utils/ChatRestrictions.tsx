...
// Dependencies: [1074, 10389, 1115, 2]

// Module 10388 (ChatRestrictions)
import Constants from "Constants" /* 1074 */;
import util from "util" /* 1115 */;
import MentionGuardUtilsDefault from "MentionGuardUtils" /* 10389 */;
        ...
        if (null == getGuildId.getGuildId()) {
          ...
          if (null == extractEveryoneRoleResult) {
            ...
            if (tmp9Result.shouldShowEveryoneGuard(extractEveryoneRoleResult, getGuildId)) {
              const everyoneMemberCountResult = tmp9(10389).everyoneMemberCount(extractEveryoneRoleResult, getGuildId);
              const _Math = Math;
              const _Math2 = Math;
              const _Math3 = Math;
