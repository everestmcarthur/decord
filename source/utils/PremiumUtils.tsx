...
// Function ID: 4298
// Name: PremiumUtils
// Dependencies: [32, 19, 4298, 1372, 4299, 4300, 4302, 4303, 1074, 1374, 4311, 1085, 3, 4312, 4309, 1886, 38, 1115, 3075, 4231, 4321, 4328, 7341, 4310, 13548, 1091, 504, 11580, 5214, 4536, 14073, 1378, 1380, 9491, 2]
...
import CheckoutError from "CheckoutError" /* 11580 */;
import useFPDurationLeft from "useFPDurationLeft" /* 13548 */;
import ProductCatalog from "ProductCatalog" /* 14073 */;
...
const frozen = Object.freeze({
  ...
  getUserMaxFileSize: fn(9491).getUserMaxFileSize,
  ...
  canUseShopDiscounts(currentUser) {
    ...
    if (!hasPerkResult) {
      hasPerkResult = tmp(14073).canUserUse(tmp(14073).COLLECTIBLES, currentUser);
      const tmpResult = tmp(14073);
    }
  ...
  canUseMoreQuestOrbs(perks) {
    ...
    if (!hasPerkResult) {
      hasPerkResult = tmp(14073).canUserUse(tmp(14073).QUEST_ORB_MULTIPLIER, perks);
      const tmpResult = tmp(14073);
    }
    return hasPerkResult;
  },
