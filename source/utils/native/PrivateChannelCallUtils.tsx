...
// Dependencies: [5, 19, 4330, 4847, 1958, 4288, 2012, 1372, 1074, 1099, 4849, 21, 4850, 4840, 9813, 1110, 4842, 9598, 1897, 7145, 7318, 4606, 13859, 5496, 4984, 1115, 5223, 4505, 13894, 4985, 9314, 4497, 8515, 2]
...
// Module 4846 (PrivateChannelCallUtils)
...
function openChannelCallModal(channel) {
  if (!obj.maybeOpenAgeGateForVoiceChannel(channel.id)) {
    ...
    if (tmpResult.isVoicePanelEnabled(channel)) {
      ...
      const tmp3Result = tmp3(4842);
      tmp3Result.pushLazy(tmp(1897)(9598, dependencyMap.paths), obj4, "" + c17 + "-" + channel.id);
      const tmp5 = tmp(1897)(9598, dependencyMap.paths);
    }
    tmpResult = tmp(9813);
  }
}
...
export const openVoiceChannelActionSheet = function openVoiceChannelActionSheet(channel) {
  ...
  obj.openLazy(asyncRequireImpl(13859, dependencyMap.paths), "" + c17 + "-" + channel.id, { channel });
};
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj7 = { value: v1(5223).requestPermission(constants.CAMERA), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
        ...
        tmp4(4505).dismissKeyboard();
        const obj2 = tmp4(4505);
        const voiceChannel = v1(5496).selectVoiceChannel(closure_128_0.id, closure_128_1);
        dependencyMap = 3;
        return { value: "HermesInternal", done: null };
      } catch (tmp17) {
        dependencyMap = tmp;
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (flag) {
              dependencyMap = 1;
              c3 = 1;
              const obj6 = { value: tmp5(5223).requestPermission(constants2.CAMERA), done: false };
              return obj6;
            }
          }
        } else if (arg0 === 1) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: v1(5223).requestPermission(constants.CAMERA), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
