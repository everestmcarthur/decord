...
// Dependencies: [5, 19, 4328, 4846, 1958, 4286, 2012, 1372, 1074, 1099, 4848, 21, 4849, 4839, 9821, 1110, 4841, 9609, 1897, 7148, 7321, 4605, 13872, 5497, 4983, 1115, 5224, 4504, 13907, 4984, 9325, 4495, 8524, 2]
...
// Module 4845 (PrivateChannelCallUtils)
...
function openChannelCallModal(channel) {
  if (!obj.maybeOpenAgeGateForVoiceChannel(channel.id)) {
    ...
    if (tmpResult.isVoicePanelEnabled(channel)) {
      ...
      tmp3Result.pushLazy(tmp(1897)(9609, dependencyMap.paths), obj4, "" + c17 + "-" + channel.id);
      const tmp5 = tmp(1897)(9609, dependencyMap.paths);
    }
    tmpResult = tmp(9821);
  }
}
...
export const openVoiceChannelActionSheet = function openVoiceChannelActionSheet(channel) {
  ...
  obj.openLazy(asyncRequireImpl(13872, dependencyMap.paths), "" + c17 + "-" + channel.id, { channel });
};
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj7 = { value: v1(5224).requestPermission(constants.CAMERA), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
        ...
        tmp4(4504).dismissKeyboard();
        const obj2 = tmp4(4504);
        const voiceChannel = v1(5497).selectVoiceChannel(closure_128_0.id, closure_128_1);
        dependencyMap = 3;
        return { value: "HermesInternal", done: null };
      } catch (tmp17) {
        dependencyMap = tmp;
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (flag) {
              dependencyMap = 1;
              c3 = 1;
              const obj6 = { value: tmp5(5224).requestPermission(constants2.CAMERA), done: false };
              return obj6;
            }
          }
        } else if (arg0 === 1) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: v1(5224).requestPermission(constants.CAMERA), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
