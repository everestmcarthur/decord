...
// Function ID: 12199
// Name: MessagesUtils
// Dependencies: [1074, 7522, 4710, 8095, 4870, 2]

// Module 12198 (MessagesUtils)
      ...
      if (someResult) {
        ...
        someResult = codedLinks.some((item) => {
          ...
          if (CodedLink.CodedLinkType.BUILD_OVERRIDE !== type) {
            if (tmp(4710).CodedLinkType.MANUAL_BUILD_OVERRIDE !== type) {
              if (tmp(4710).CodedLinkType.EXPERIMENT === type) {
                const experimentFromEmbedURL = tmp(8095).getExperimentFromEmbedURL(code);
                ...
                if (tmp(4710).CodedLinkType.EVENT !== type) {
                  if (tmp(4710).CodedLinkType.CHANNEL_LINK !== type) {
                    if (tmp(4710).CodedLinkType.APP_DIRECTORY_PROFILE === type) {
                      ...
                      return tmp25;
                    } else if (tmp(4710).CodedLinkType.ACTIVITY_BOOKMARK === type) {
                          ...
                          if (tmp(4710).CodedLinkType.SOCIAL_LAYER_STOREFRONT !== type) {
                            if (tmp(4710).CodedLinkType.SOCIAL_LAYER_STOREFRONT_APP !== type) {
                              if (tmp(4710).CodedLinkType.QUESTS_EMBED === type) {
                                ...
                                if (tmp(4710).CodedLinkType.APP_DIRECTORY_STOREFRONT !== type) {
                                  if (tmp(4710).CodedLinkType.APP_DIRECTORY_STOREFRONT_SKU !== type) {
                                    if (tmp(4710).CodedLinkType.APP_OAUTH2_LINK === type) {
