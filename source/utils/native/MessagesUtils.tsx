...
// Function ID: 12027
// Name: MessagesUtils
// Dependencies: [1074, 7378, 4593, 7942, 4753, 2]

// Module 12026 (MessagesUtils)
      ...
      if (someResult) {
        ...
        someResult = codedLinks.some((item) => {
          ...
          if (CodedLink.CodedLinkType.BUILD_OVERRIDE !== type) {
            if (tmp(4593).CodedLinkType.MANUAL_BUILD_OVERRIDE !== type) {
              if (tmp(4593).CodedLinkType.EXPERIMENT === type) {
                const experimentFromEmbedURL = tmp(7942).getExperimentFromEmbedURL(code);
                ...
                if (tmp(4593).CodedLinkType.EVENT !== type) {
                  if (tmp(4593).CodedLinkType.CHANNEL_LINK !== type) {
                    if (tmp(4593).CodedLinkType.APP_DIRECTORY_PROFILE === type) {
                      ...
                      return tmp25;
                    } else if (tmp(4593).CodedLinkType.ACTIVITY_BOOKMARK === type) {
                          ...
                          if (tmp(4593).CodedLinkType.SOCIAL_LAYER_STOREFRONT !== type) {
                            if (tmp(4593).CodedLinkType.SOCIAL_LAYER_STOREFRONT_APP !== type) {
                              if (tmp(4593).CodedLinkType.QUESTS_EMBED === type) {
                                ...
                                if (tmp(4593).CodedLinkType.APP_DIRECTORY_STOREFRONT !== type) {
                                  if (tmp(4593).CodedLinkType.APP_DIRECTORY_STOREFRONT_SKU !== type) {
                                    if (tmp(4593).CodedLinkType.APP_OAUTH2_LINK === type) {
