...
// Function ID: 11987
// Name: MessagesUtils
// Dependencies: [1074, 7340, 4562, 7904, 4722, 2]

// Module 11986 (MessagesUtils)
      ...
      if (someResult) {
        ...
        someResult = codedLinks.some((item) => {
          ...
          if (CodedLink.CodedLinkType.BUILD_OVERRIDE !== type) {
            if (tmp(4562).CodedLinkType.MANUAL_BUILD_OVERRIDE !== type) {
              if (tmp(4562).CodedLinkType.EXPERIMENT === type) {
                const experimentFromEmbedURL = tmp(7904).getExperimentFromEmbedURL(code);
                ...
                if (tmp(4562).CodedLinkType.EVENT !== type) {
                  if (tmp(4562).CodedLinkType.CHANNEL_LINK !== type) {
                    if (tmp(4562).CodedLinkType.APP_DIRECTORY_PROFILE === type) {
                      ...
                      return tmp25;
                    } else if (tmp(4562).CodedLinkType.ACTIVITY_BOOKMARK === type) {
                          ...
                          if (tmp(4562).CodedLinkType.SOCIAL_LAYER_STOREFRONT !== type) {
                            if (tmp(4562).CodedLinkType.SOCIAL_LAYER_STOREFRONT_APP !== type) {
                              if (tmp(4562).CodedLinkType.QUESTS_EMBED === type) {
                                ...
                                if (tmp(4562).CodedLinkType.APP_DIRECTORY_STOREFRONT !== type) {
                                  if (tmp(4562).CodedLinkType.APP_DIRECTORY_STOREFRONT_SKU !== type) {
                                    if (tmp(4562).CodedLinkType.APP_OAUTH2_LINK === type) {
