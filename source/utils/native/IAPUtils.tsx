...
// Function ID: 11187
// Name: IAPUtils
// Dependencies: [5, 17, 4638, 4855, 1372, 7344, 1074, 1374, 11187, 3, 38, 1364, 11206, 7347, 12, 1255, 4312, 504, 11207, 1363, 4618, 11208, 2]
// Exports: makeIAPRequest, manageSubscription, shouldMockIAPForceEnable, useCanPurchaseIAP

// Module 11186 (IAPUtils)
...
import StorekitIAPQueueDefault from "StorekitIAPQueue" /* 11206 */;
import GeneratedPaymentCurrencies from "GeneratedPaymentCurrencies" /* 11207 */;
      ...
      if (0 === c4) {
        if (arg0 === 1) {
          ...
          if (isStorekit2Available()) {
            ...
            c4 = 2;
            c5 = 1;
            const obj6 = { value: require("module_11187").getStorefront(), done: false };
            return obj6;
          } else {
            c5 = 3;
...
let obj = {
  loadProducts() {
    if (obj.isIOS()) {
      ...
      let items = [StorekitIAPQueueDefault.fetchSubscriptions(Object.values(tmp(7347).ProductIds)), ];
      const _Object2 = Object;
      items[1] = StorekitIAPQueueDefault.fetchProducts(Object.values(tmp(7347).ProductIds));
