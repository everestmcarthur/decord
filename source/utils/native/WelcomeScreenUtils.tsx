...
// Dependencies: [19, 12784, 2012, 1979, 4469, 12785, 504, 12786, 4603, 12787, 1896, 2]
// Exports: openWelcomeActionSheet, useShowWelcomeModal

// Module 12783 (WelcomeScreenUtils)
import asyncRequireImpl from "asyncRequireImpl" /* 1896 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4603 */;
import WelcomeScreenActionCreators from "WelcomeScreenActionCreators" /* 12786 */;
...
export const openWelcomeActionSheet = function openWelcomeActionSheet(onHide) {
  ...
  obj.openLazy(asyncRequireImpl(12787, dependencyMap.paths), "GuildWelcomeActionSheet" + guildId, { guildId, onHide: onHide.onHide });
};
