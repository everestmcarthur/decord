...
// Dependencies: [19, 17, 21, 4639, 576, 5526, 5079, 4635, 7087, 8204, 4336, 2]

// Module 8203 (utils/ChangeLogUtils)
import nativeDefault from "native" /* 576 */;
import _modDef4336 from "module_4336" /* 4336 */;
import Text_Text from "Text/Text" /* 4635 */;
import noop from "module_19" /* 19 */;
import CustomMarkup from "CustomMarkup" /* 5079 */;
...
function ChangeLogStrong(arg0) {
  ...
  if (obj.useManaTypeConsolidationExperiment("ChangeLogStrong")) {
    ...
    const obj2 = { variant: "experimental/body-sm/semibold", color: str, children: tmp(8204).smartOutput(node, output, state) };
    let reactResult = jsx(tmp(4635).Text, { variant: "experimental/body-sm/semibold", color: str, children: tmp(8204).smartOutput(node, output, state) });
    const tmpResult = tmp(8204);
  } else {
...
obj2.container = { borderLeftWidth: 2, paddingLeft: 8, marginBottom: 10, borderLeftColor: fn(5526).DARK_PRIMARY_500_LIGHT_PRIMARY_300 };
const obj4 = { borderLeftWidth: 2, paddingLeft: 8, marginBottom: 10, borderLeftColor: fn(5526).DARK_PRIMARY_500_LIGHT_PRIMARY_300 };
