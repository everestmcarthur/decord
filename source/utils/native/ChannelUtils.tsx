...
// Dependencies: [1957, 2021, 1979, 1371, 1074, 5080, 5081, 5082, 5083, 5084, 5085, 5086, 5087, 5088, 5089, 5090, 5091, 5092, 5093, 5094, 5095, 5096, 5097, 5098, 5099, 5100, 5101, 5102, 5103, 5104, 5105, 5106, 5107, 5108, 5111, 5112, 5113, 5114, 5115, 5116, 5117, 5118, 5119, 5120, 5121, 5122, 5123, 5124, 5125, 5126, 5127, 5128, 5129, 5130, 5131, 5132, 5133, 5134, 5135, 5136, 5137, 5138, 5139, 5140, 5141, 5142, 5143, 5144, 5145, 5146, 5147, 5148, 5149, 5150, 5151, 5152, 5153, 5154, 5155, 5156, 5157, 2]
...
const ExperimentalLfgIcon = tmp(5121);
const ChatIcon2 = tmp(5122);
const ThreadLockIcon = tmp(5123);
const ThreadIcon2 = tmp(5124);
const FolderIcon = tmp(5125);
const BookCheckIcon = tmp(5126);
const TextWarningIcon2 = tmp(5127);
const TextSpoilerIcon2 = tmp(5128);
const TextLockIcon2 = tmp(5129);
const TextControllerIcon = tmp(5130);
const TextIcon2 = tmp(5131);
const ImageWarningIcon2 = tmp(5132);
const ForumWarningIcon2 = tmp(5133);
const ForumSpoilerIcon3 = tmp(5134);
const ExperimentalLfgLockIcon = tmp(5135);
const ImageLockIcon = tmp(5136);
const ForumLockIcon2 = tmp(5137);
const ImageIcon2 = tmp(5138);
const ForumIcon2 = tmp(5139);
const GroupIcon = tmp(5140);
const AtIcon = tmp(5141);
const AnnouncementsWarningIcon2 = tmp(5142);
const AnnouncementsSpoilerIcon2 = tmp(5143);
const AnnouncementsLockIcon = tmp(5144);
const AnnouncementsIcon2 = tmp(5145);
const LockIcon3 = tmp(5146);
const StageLockIcon2 = tmp(5147);
const StageIcon2 = tmp(5148);
const VoiceLockIcon3 = tmp(5149);
const VoiceWarningIcon2 = tmp(5150);
const VoiceNormalSpoilerIcon = tmp(5151);
const VoiceNormalIcon2 = tmp(5152);
const HubIcon = tmp(5153);
const AppsWarningIcon = tmp(5154);
const AppsSpoilerIcon2 = tmp(5155);
const AppsLockIcon = tmp(5156);
const AppsIcon2 = tmp(5157);
require = fn;
            ...
            if (tmp5.GUILD_CATEGORY === type) {
              ...
              if (isRulesChannel) {
                ...
                if (null != channel.linkedLobby) {
                  let tmp82Result2 = tmp82(5114);
                } else {
                  tmp82Result2 = tmp82(5083);
                }
              }
              return tmp79;
                ...
                if (isRoleRequiredDefault(channel)) {
                  ...
                  if (!ignoreTraits5) {
                    if (channel.isGameInvitesChannel()) {
                      let tmp69Result = tmp69(5115);
                    } else {
                      tmp69Result = tmp69(isMediaChannelResult ? 5116 : 5117);
                    }
                  }
                }
                if (channel.isGameInvitesChannel()) {
                  let tmp69Result2 = tmp69(5111);
                } else {
                  tmp69Result2 = tmp69(isMediaChannelResult ? 5103 : 5100);
                }
              }
              return tmp66;
              ...
              if (isRulesChannel) {
                ...
                if (isRoleRequiredDefault(channel)) {
                  ...
                  if (!ignoreTraits8) {
                    let tmp59Result = tmp59(5116);
                  }
                }
                tmp59Result = tmp59(5103);
              }
              return tmp56;
              ...
              if (isRulesChannel) {
                ...
                if (isRoleRequiredDefault(channel)) {
                  ...
                  if (!ignoreTraits11) {
                    let tmp46Result = tmp46(5118);
                  }
                }
                tmp46Result = tmp46(5087);
              }
              return tmp43;
              ...
              if (result) {
                ...
                if (!ignoreTraits12) {
                  if (isRoleRequiredDefault(channel)) {
                    let tmp32Result = tmp32(5119);
                  } else {
                    tmp32Result = tmp32(5094);
                  }
                  return tmp32Result;
                }
              }
              ...
              if (isRoleRequiredDefault(channel)) {
                ...
                if (!ignoreTraits14) {
                  let tmp36Result = tmp36(5094);
                }
              }
              tmp36Result = tmp36(5088);
              ...
              if (obj.textFocused) {
                ...
                if (result) {
                  ...
                  if (!ignoreTraits15) {
                    if (isRoleRequiredDefault(channel)) {
                      tmp17Result = tmp17(5119);
                    } else {
                      tmp17Result = tmp17(5091);
                    }
                  }
                }
                if (locked) {
                ...
                if (channel.isSpoilerChannel()) {
                  ...
                  if (!ignoreTraits19) {
                    let tmp21Result4 = tmp21(5093);
                  }
                }
                tmp21Result4 = tmp21(5089);
              }
              return tmp17Result;
              ...
              if (isRoleRequiredDefault(channel)) {
                ...
                if (!ignoreTraits22) {
                  let tmp10Result = tmp10(5120);
                }
              }
              tmp10Result = tmp10(5084);
            } else {
...
export const getSimpleChannelIconComponent = function getSimpleChannelIconComponent(channel) {
  ...
  if (channel.isForumPost()) {
    let ThreadIcon = tmp25(5122).ChatIcon;
  } else {
    ThreadIcon = tmp25(5124).ThreadIcon;
  }
  return ThreadIcon;
};
