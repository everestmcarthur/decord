...
// Dependencies: [1074, 9717, 1241, 8500, 4332, 9718, 1086, 4841, 9721, 1897, 8469, 2]
// Exports: installApplication, installPrivateChannelIntegration, openOAuth2Modal

// Module 9716 (ApplicationUtils)
...
import Constants2 from "Constants" /* 9717 */;
import authorizeCallbackDefault from "authorizeCallback" /* 9718 */;
...
export const installApplication = function installApplication(arg0) {
  ...
  if (null != customInstallUrl) {
    ...
    return customInstallUrl(8500).handleClick(obj2);
  } else {
    if (null != integrationTypesConfig) {
      ...
      if (values.some((oauth2_install_params) => {
        ...
        obj9.pushLazy(customInstallUrl(1897)(9721, dependencyMap.paths), obj6, closure_5);
      }
    }
    if (null != installParams) {
      ...
      tmp32Result2.pushLazy(customInstallUrl(1897)(9721, tmp33.paths), obj12, closure_5);
      const tmp10 = customInstallUrl(1897)(9721, tmp33.paths);
    }
  }
};
export const openOAuth2Modal = function openOAuth2Modal(arg0) {
  ...
  obj2.pushLazy(require("asyncRequireImpl")(9721, dependencyMap.paths), obj3, closure_5);
};
export const installPrivateChannelIntegration = function installPrivateChannelIntegration(arg0) {
  ...
  obj.pushLazy(asyncRequireImpl(9721, dependencyMap.paths), obj2, closure_5);
};
