...
// Dependencies: [1074, 9606, 1242, 8398, 4268, 9607, 1086, 4777, 9610, 1896, 8367, 2]
// Exports: installApplication, installPrivateChannelIntegration, openOAuth2Modal

// Module 9605 (ApplicationUtils)
...
import Constants2 from "Constants" /* 9606 */;
import authorizeCallbackDefault from "authorizeCallback" /* 9607 */;
...
export const installApplication = function installApplication(arg0) {
  ...
  if (null != customInstallUrl) {
    ...
    return customInstallUrl(8398).handleClick(obj2);
  } else {
    if (null != integrationTypesConfig) {
      ...
      if (values.some((oauth2_install_params) => {
        ...
        obj9.pushLazy(customInstallUrl(1896)(9610, dependencyMap.paths), obj6, closure_5);
      }
    }
    if (null != installParams) {
      ...
      tmp32Result2.pushLazy(customInstallUrl(1896)(9610, tmp33.paths), obj12, closure_5);
      const tmp10 = customInstallUrl(1896)(9610, tmp33.paths);
    }
  }
};
export const openOAuth2Modal = function openOAuth2Modal(arg0) {
  ...
  obj2.pushLazy(require("asyncRequireImpl")(9610, dependencyMap.paths), obj3, closure_5);
};
export const installPrivateChannelIntegration = function installPrivateChannelIntegration(arg0) {
  ...
  obj.pushLazy(asyncRequireImpl(9610, dependencyMap.paths), obj2, closure_5);
};
