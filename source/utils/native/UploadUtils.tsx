...
// Dependencies: [109, 5, 17, 1185, 4623, 1371, 1074, 4784, 3, 5153, 5164, 5143, 5170, 1115, 4271, 1114, 4231, 5142, 1152, 5173, 5175, 5148, 4553, 5176, 5177, 5178, 1369, 5179, 5180, 5181, 4805, 5182, 2]
...
function convertVideo(videoMetadata) {
  ...
  if (obj6.isAndroid()) {
    if (tmpResult.getSystemVersionMajor() > 34) {
      let _Math = Math;
      let frameRate = Math.min(videoMetadata.frameRate, tmp(5175).DEFAULT_VIDEO_ENCODING_CONFIG.frameRate);
    }
            ...
            if (!isIOSResult1) {
                ...
                if (!isIOSResult2) {
                  ...
                  if (tmp12Result9.isPhotoKitAsset(str3, str4)) {
                    ...
                    if (isVideo2) {
                      ...
                      isVideo2 = tmp12(5143).getFile(obj8).isVideo;
                      const tmp12Result10 = tmp12(5143);
                    }
                  }
                  tmp12Result9 = tmp12(5173);
                }
              ...
              if (tmp12Result11.isPhotoKitAsset(str3, str4)) {
                ...
                if (isVideo) {
                  ...
                  isVideo = tmp12(5143).getFile(obj9).isVideo;
                  const tmp12Result12 = tmp12(5143);
                }
              }
              tmp12Result11 = tmp12(5173);
            }
