...
// Dependencies: [109, 5, 17, 1185, 4655, 1371, 1074, 4816, 3, 5190, 5201, 5180, 5207, 1115, 4304, 1114, 4264, 5179, 1152, 5210, 5212, 5185, 4585, 5213, 5214, 5215, 1369, 5216, 5217, 5218, 4837, 5219, 2]
...
import VideoUploadUtils from "VideoUploadUtils" /* 5212 */;
import utils_TimeUtils from "utils/TimeUtils" /* 5219 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import UnsyncedUserSettingsStore_mod from "UnsyncedUserSettingsStore" /* 1185 */;
...
let closure_28 = async function _mediaManager() {
  closure_4 = tmp3;
  closure_3 = tmp5;
  ...
  await MediaManager[closure_131_0](closure_131_1, closure_131_2);
...
function convertVideo(videoMetadata) {
  ...
  if (obj6.isAndroid()) {
    if (tmpResult.getSystemVersionMajor() > 34) {
      let _Math = Math;
      let frameRate = Math.min(videoMetadata.frameRate, tmp(5212).DEFAULT_VIDEO_ENCODING_CONFIG.frameRate);
    }
      ...
      (function findCompatibleConfig() {
        ...
        if (result) {
          ...
          if (isAndroidResult) {
            ...
            const isIOSResult1 = tmp12(1115).isIOS();
            if (!isIOSResult1) {
              if (isIOSResult1) {
                ...
                const isIOSResult2 = tmp12(1115).isIOS();
                if (!isIOSResult2) {
                  if (isIOSResult2) {
                    ...
                    let isIOSResult = tmp12(1115).isIOS();
                    if (isIOSResult) {
                  ...
                  if (tmp12Result9.isPhotoKitAsset(str3, str4)) {
                    ...
                    if (isVideo2) {
                      ...
                      isVideo2 = tmp12(5180).getFile(obj8).isVideo;
                      const tmp12Result10 = tmp12(5180);
                    }
                  }
                  tmp12Result9 = tmp12(5210);
                }
                const tmp12Result7 = tmp12(1115);
              }
            } else {
              if (tmp12Result11.isPhotoKitAsset(str3, str4)) {
                ...
                if (isVideo) {
                  ...
                  isVideo = tmp12(5180).getFile(obj9).isVideo;
                  const tmp12Result12 = tmp12(5180);
                }
              }
              tmp12Result11 = tmp12(5210);
            }
            const tmp12Result = tmp12(1115);
          }
        } else {
...
let closure_37 = async function _processVideoUpload() {
  closure_1 = tmp2;
  ...
  closure_129_10 = await closure_130_34({ uri: closure_129_0, filename: closure_129_1, isLowQuality: closure_129_8, compressionQuality: closure_130_16.LOW, videoQualitySetting: closure_129_7, videoMetadata: closure_129_9, fileSize: closure_129_3 });
...
let closure_38 = async function _processImageOrFileUpload(arg0, value) {
  ...
  if (tmp51) {
    ...
    closure_132_0(closure_132_2[24]);
  }
  ...
  if (closure_131_12) {
    ...
    closure_132_0(closure_132_2[25]);
    ...
    closure_132_0(closure_132_2[26]);
  }
      ...
      if (0 === c7) {
        ...
        if (2 === tmp7) {
          ...
          if (arg0 === 1) {
            ...
            let tmp51 = null;
            if (closure_131_11) {
              const obj12 = { path: closure_131_11, encoderUsed: closure_132_0(closure_132_2[30]).ImageEncoder.NATIVE };
              tmp51 = obj12;
            }
            c8 = 3;
            const obj13 = { value: tmp51, done: true };
            return obj13;
          }
        } else if (4 === tmp7) {
          if (arg0 === 1) {
            ...
            let tmp47 = null;
            if (closure_131_12) {
              const obj15 = { path: closure_131_12 };
              tmp47 = obj15;
            }
            c8 = 3;
            const obj16 = { value: tmp47, done: true };
            return obj16;
          }
        } else if (5 === tmp7) {
          c5 = 0;
          ...
          if (arg0 === 1) {
            ...
            c7 = 7;
            c8 = 1;
            const obj20 = { value: MediaManager.getLosslessImageData(closure_131_0), done: false };
            return obj20;
          }
        } else if (7 === tmp7) {
          if (arg0 === 1) {
          ...
          if (arg0 === 1) {
            ...
            let tmp24 = null;
            if (closure_131_15) {
              const obj24 = { path: closure_131_15, encoderUsed: closure_131_16, outputWidth: closure_131_17, outputHeight: closure_131_18 };
              tmp24 = obj24;
            }
            c8 = 3;
            const obj25 = { value: tmp24, done: true };
            return obj25;
          }
        } else if (arg0 === 1) {
          c8 = 3;
          ...
          if (!obj18.shouldConvertToJPG(closure_131_0, closure_131_1, closure_131_2, closure_131_4, closure_131_7)) {
            if ((function shouldConvertToGifFilepath(str, str2) {
              ...
              if (!isIOSResult) {
                ...
                tmpResult = closure_1_0(5210);
              }
            })(closure_131_0, closure_131_1)) {
              c7 = 9;
              c8 = 1;
              const obj28 = { value: closure_132_27("convertToGIFFilePath", closure_131_0), done: false };
              return obj28;
            } else {
              c8 = 3;
        ...
        const obj29 = { compressionQuality: closure_131_3, forceConvertToJPG: closure_131_13, useEnhancedConversion: closure_131_5, useJpegliEncoder: closure_131_6, targetWidth: closure_131_8, targetHeight: closure_131_9 };
        c7 = 8;
        c8 = 1;
        const obj30 = { value: closure_132_27("convertToJPEG", closure_131_0, obj29), done: false };
        return obj30;
      }
    } catch (tmp107) {
      closure_6 = tmp107;
        ...
        if (0 === c8) {
          if (arg0 === 1) {
            ...
            if (null != width) {
              if (null != height) {
                c9 = 3;
                const obj4 = { value: size, done: true };
                return obj4;
              }
            }
            const obj6 = { uri, overrideFilename };
            const file = UploadUtils.getFile(obj6);
            closure_132_2 = file;
            if (!file.isImage) {
              if (!file.isVideo) {
                c9 = 3;
                const obj7 = { value: size, done: true };
                return obj7;
              }
            }
            c7 = 1;
          ...
          c9 = 3;
          const obj9 = { value: closure_132_1, done: true };
          return obj9;
        } else {
          if (2 === tmp8) {
            if (arg0 === 1) {
              ...
              if (isVideo) {
                ...
                c8 = 3;
                c9 = 1;
                const obj11 = { value: DCDFileManager.getVideoDimensions(closure_132_0), done: false };
                return obj11;
              } else {
                c7 = 0;
                c9 = 3;
...
export { getAppDir };
export { getFileInfo };
export const shouldConvertToJPG = fn(5210).shouldConvertToJPG;
export const shouldForceConvertToJPG = fn(5210).shouldForceConvertToJPG;
