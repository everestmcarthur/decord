...
// Dependencies: [2014, 4244, 4245, 1961, 1975, 2016, 502, 1957, 2021, 2015, 1979, 1371, 1074, 1086, 12, 4249, 4231, 11, 1894, 4250, 2019, 2]
...
function applyOverwrites(id, member, deserializeResult, overwrites) {
  ...
  if (null != member) {
    ...
    const tmp28Result = tmp28(4231);
    found1 = found;
    if (tmp34) {
      found1 = tmp19(1086).filter(found, closure_28);
      const tmp19Result8 = tmp19(1086);
    }
    tmp34 = tmp28(4231).isMemberCommunicationDisabled(member) && !hasItem;
  }
  return found1;
}
      ...
      if (null != guild_id) {
        if (guild_id === c19.guild_id) {
          ...
          if (null == obj2[guild_id]) {
            let obj = { id: guild_id, type: obj2(1894).PermissionOverwriteType.ROLE, allow: deserializeResult, deny: deserializeResult };
            obj2[guild_id] = obj;
          }
