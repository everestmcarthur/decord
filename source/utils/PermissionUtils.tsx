...
// Dependencies: [2014, 4246, 4247, 1961, 1975, 2016, 502, 1957, 2021, 2015, 1979, 1371, 1074, 1086, 12, 4251, 4233, 11, 1894, 4252, 2019, 2]
...
function applyOverwrites(id, member, deserializeResult, overwrites) {
  ...
  if (null != member) {
    ...
    const tmp28Result = tmp28(4233);
    found1 = found;
    if (tmp34) {
      found1 = tmp19(1086).filter(found, closure_28);
      const tmp19Result8 = tmp19(1086);
    }
    tmp34 = tmp28(4233).isMemberCommunicationDisabled(member) && !hasItem;
  }
  return found1;
}
