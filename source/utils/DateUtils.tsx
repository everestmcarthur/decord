...
// Function ID: 4287
// Name: DateUtils
// Dependencies: [2025, 3, 4287, 1935, 1187, 4289, 1114, 573, 4291, 4196, 2]
...
// Module 4286 (DateUtils)
import LoggerDefault from "Logger" /* 3 */;
import util from "util" /* 1114 */;
import preloaded_user_settings from "preloaded_user_settings" /* 1187 */;
import UserSettings from "UserSettings" /* 1935 */;
import _modDef4196 from "module_4196" /* 4196 */;
import onTimezoneChangeDefault from "onTimezoneChange" /* 4287 */;
...
function syncHourCycleToIntlConfig() {
  ...
  if (result) {
    result = tmp4(4289).supportsSystemDateFormatter();
...
export const calendarFormat = function calendarFormat(timestamp, arg1, setting) {
  ...
  const localeDataResult = _modDef4196.localeData();
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, tmp(4196)(timestamp), tmp(4196)(date));
    const tmp6 = tmp(4196)(timestamp);
  }
...
export const formatDateForDatetimeLocal = function formatDateForDatetimeLocal(arg0) {
  ...
  if (null != arg0) {
    if (arg0.length >= 200) {
      ...
      str = _modDef4196(arg0).format("YYYY-MM-DDTHH:mm");
