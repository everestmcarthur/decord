...
// Function ID: 4256
// Name: DateUtils
// Dependencies: [2025, 3, 4256, 1935, 1187, 4258, 1114, 573, 4260, 4166, 2]
...
// Module 4255 (DateUtils)
import LoggerDefault from "Logger" /* 3 */;
import util from "util" /* 1114 */;
import preloaded_user_settings from "preloaded_user_settings" /* 1187 */;
import UserSettings from "UserSettings" /* 1935 */;
import _modDef4166 from "module_4166" /* 4166 */;
import onTimezoneChangeDefault from "onTimezoneChange" /* 4256 */;
...
function syncHourCycleToIntlConfig() {
  ...
  if (result) {
    result = tmp4(4258).supportsSystemDateFormatter();
    const tmp4Result = tmp4(4258);
  }
...
export const calendarFormat = function calendarFormat(timestamp, arg1, setting) {
  ...
  const localeDataResult = _modDef4166.localeData();
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, tmp(4166)(timestamp), tmp(4166)(date));
    const tmp6 = tmp(4166)(timestamp);
  }
...
export const formatDateForDatetimeLocal = function formatDateForDatetimeLocal(arg0) {
  ...
  if (null != arg0) {
    if (arg0.length >= 200) {
      ...
      str = _modDef4166(arg0).format("YYYY-MM-DDTHH:mm");
