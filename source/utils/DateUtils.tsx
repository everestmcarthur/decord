...
// Function ID: 4322
// Name: DateUtils
// Dependencies: [2026, 3, 4322, 1936, 1186, 4324, 1115, 573, 4326, 4231, 2]
...
// Module 4321 (DateUtils)
import LoggerDefault from "Logger" /* 3 */;
import util from "util" /* 1115 */;
import preloaded_user_settings from "preloaded_user_settings" /* 1186 */;
import UserSettings from "UserSettings" /* 1936 */;
import _modDef4231 from "module_4231" /* 4231 */;
import onTimezoneChangeDefault from "onTimezoneChange" /* 4322 */;
...
function syncHourCycleToIntlConfig() {
  ...
  if (result) {
    result = tmp4(4324).supportsSystemDateFormatter();
    const tmp4Result = tmp4(4324);
  }
...
export const calendarFormat = function calendarFormat(timestamp, arg1, setting) {
  ...
  const localeDataResult = _modDef4231.localeData();
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, tmp(4231)(timestamp), tmp(4231)(date));
    const tmp6 = tmp(4231)(timestamp);
  }
...
export const formatDateForDatetimeLocal = function formatDateForDatetimeLocal(arg0) {
  ...
  if (null != arg0) {
    if (arg0.length >= 200) {
      ...
      str = _modDef4231(arg0).format("YYYY-MM-DDTHH:mm");
