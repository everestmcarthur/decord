...
// Function ID: 4289
// Name: DateUtils
// Dependencies: [2025, 3, 4289, 1935, 1187, 4291, 1114, 573, 4293, 4198, 2]
...
// Module 4288 (DateUtils)
import LoggerDefault from "Logger" /* 3 */;
import util from "util" /* 1114 */;
import preloaded_user_settings from "preloaded_user_settings" /* 1187 */;
import UserSettings from "UserSettings" /* 1935 */;
import _modDef4198 from "module_4198" /* 4198 */;
import onTimezoneChangeDefault from "onTimezoneChange" /* 4289 */;
...
function syncHourCycleToIntlConfig() {
  ...
  if (result) {
    result = tmp4(4291).supportsSystemDateFormatter();
    const tmp4Result = tmp4(4291);
  }
...
export const calendarFormat = function calendarFormat(timestamp, arg1, setting) {
  ...
  const localeDataResult = _modDef4198.localeData();
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, tmp(4198)(timestamp), tmp(4198)(date));
    const tmp6 = tmp(4198)(timestamp);
  }
...
export const formatDateForDatetimeLocal = function formatDateForDatetimeLocal(arg0) {
  ...
  if (null != arg0) {
    if (arg0.length >= 200) {
      ...
      str = _modDef4198(arg0).format("YYYY-MM-DDTHH:mm");
