...
// Function ID: 4320
// Name: DateUtils
// Dependencies: [2026, 3, 4320, 1936, 1186, 4322, 1115, 573, 4324, 4229, 2]
...
// Module 4319 (DateUtils)
import LoggerDefault from "Logger" /* 3 */;
import util from "util" /* 1115 */;
import preloaded_user_settings from "preloaded_user_settings" /* 1186 */;
import UserSettings from "UserSettings" /* 1936 */;
import _modDef4229 from "module_4229" /* 4229 */;
import onTimezoneChangeDefault from "onTimezoneChange" /* 4320 */;
...
function syncHourCycleToIntlConfig() {
  ...
  if (result) {
    result = tmp4(4322).supportsSystemDateFormatter();
...
export const calendarFormat = function calendarFormat(timestamp, arg1, setting) {
  ...
  const localeDataResult = _modDef4229.localeData();
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, tmp(4229)(timestamp), tmp(4229)(date));
    const tmp6 = tmp(4229)(timestamp);
  }
...
export const formatDateForDatetimeLocal = function formatDateForDatetimeLocal(arg0) {
  ...
  if (null != arg0) {
    if (arg0.length >= 200) {
      ...
      str = _modDef4229(arg0).format("YYYY-MM-DDTHH:mm");
