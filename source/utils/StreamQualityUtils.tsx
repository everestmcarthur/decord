...
// Dependencies: [19, 4768, 502, 1980, 4745, 1372, 1074, 4769, 1374, 4747, 1115, 504, 4858, 1241, 2]
...
// Module 9347 (StreamQualityUtils)
...
const ResolutionTypes = fn(4747).ResolutionTypes;
let size = fn(2);
