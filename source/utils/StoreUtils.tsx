...
// Function ID: 4850
// Name: StoreUtils
// Dependencies: [5, 502, 4266, 4267, 4270, 1074, 4850, 4848, 4929, 1430, 4931, 1272, 1115, 1114, 2]
...
const isMobile = fn(4848).isMobile;
let tmp4 = !isMobile;
if (!isMobile) {
  tmp4 = !fn(4848).isTablet;
}
if (tmp4) {
  tmp4 = -1 !== fn(4929).getChromeVersion();
  let obj2 = fn(4929);
}
let closure_9 = tmp4;
const size = fn(2);
