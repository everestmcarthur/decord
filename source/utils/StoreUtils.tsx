...
// Function ID: 4883
// Name: StoreUtils
// Dependencies: [5, 502, 4299, 4300, 4303, 1074, 4883, 4881, 4962, 1431, 4964, 1271, 1364, 1115, 2]
...
const isMobile = fn(4881).isMobile;
let tmp4 = !isMobile;
if (!isMobile) {
  tmp4 = !fn(4881).isTablet;
}
if (tmp4) {
  tmp4 = -1 !== fn(4962).getChromeVersion();
  let obj2 = fn(4962);
}
let closure_9 = tmp4;
const size = fn(2);
