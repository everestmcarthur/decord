...
// Function ID: 4817
// Name: StoreUtils
// Dependencies: [5, 502, 4233, 4234, 4237, 1074, 4817, 4815, 4896, 1430, 4898, 1272, 1115, 1114, 2]
...
const isMobile = fn(4815).isMobile;
let tmp4 = !isMobile;
if (!isMobile) {
  tmp4 = !fn(4815).isTablet;
}
if (tmp4) {
  tmp4 = -1 !== fn(4896).getChromeVersion();
  let obj2 = fn(4896);
}
let closure_9 = tmp4;
const size = fn(2);
