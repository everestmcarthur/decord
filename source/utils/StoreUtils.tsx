...
// Function ID: 4848
// Name: StoreUtils
// Dependencies: [5, 502, 4264, 4265, 4268, 1074, 4848, 4846, 4927, 1430, 4929, 1272, 1115, 1114, 2]
...
const isMobile = fn(4846).isMobile;
let tmp4 = !isMobile;
if (!isMobile) {
  tmp4 = !fn(4846).isTablet;
}
if (tmp4) {
  tmp4 = -1 !== fn(4927).getChromeVersion();
  let obj2 = fn(4927);
}
let closure_9 = tmp4;
const size = fn(2);
