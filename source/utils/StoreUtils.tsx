...
// Function ID: 4965
// Name: StoreUtils
// Dependencies: [5, 502, 4382, 4383, 4386, 1074, 4965, 4963, 5044, 1431, 5046, 1271, 1364, 1115, 2]
...
const isMobile = fn(4963).isMobile;
let tmp4 = !isMobile;
if (!isMobile) {
  tmp4 = !fn(4963).isTablet;
}
if (tmp4) {
  tmp4 = -1 !== fn(5044).getChromeVersion();
  let obj2 = fn(5044);
}
let closure_9 = tmp4;
const size = fn(2);
