...
// Dependencies: [1980, 1372, 4532, 4301, 1074, 1375, 1374, 4309, 4533, 1115, 1370, 4534, 2025, 12, 4229, 4535, 3075, 4295, 1231, 4546, 4562, 2]
...
// Module 4531 (GuildBoostingUtils)
import util from "util" /* 1115 */;
import SentryUtilsDefault from "SentryUtils" /* 1231 */;
import HelpdeskUtilsDefault from "HelpdeskUtils" /* 2025 */;
import _modDef4229 from "module_4229" /* 4229 */;
import PremiumUtilsAll from "PremiumUtils" /* 4295 */;
import PremiumGuildOverrides from "PremiumGuildOverrides" /* 4533 */;
import BoostingActionCreators from "BoostingActionCreators" /* 4535 */;
import useGuildPowerupsBoostCount from "useGuildPowerupsBoostCount" /* 4546 */;
...
const _modDef3075 = tmp7(3075);
const FileSizeUtils = tmp2(4534);
require = fn;
...
export const getGracePeriodEndingDate = function getGracePeriodEndingDate(arr, arg1) {
  ...
  if (num > 0) {
    ...
    if (diff < 0) {
      const obj3 = { subscriptionLength: arr.length, subscriptionsNeededForPremiumTier: null, endingSubscriptionLength: null };
