...
// Function ID: 16383
// Name: VoiceGuildTag
// Dependencies: [19, 17, 1372, 8163, 21, 1364, 4722, 576, 504, 8395, 9422, 4718, 2]
// Exports: default

// Module 16382 (VoiceGuildTag)
...
export default function VoiceGuildTagChiplet(userId) {
  ...
  const userPrimaryGuild = userId(8395).getUserPrimaryGuild(primaryGuild);
  ...
  if (null != guildId) {
    if (null != tag) {
      ...
      const guildTagBadgeUrl = tmp2(8395).getGuildTagBadgeUrl(guildId, tmp7, GuildTagBadgeSize.SIZE_12);
      const obj5 = { source: null, size: null };
      const obj6 = { uri: guildTagBadgeUrl };
      obj5.source = obj6;
      obj5.size = GuildTagBadgeSize.SIZE_12;
      const items2 = [closure_5(tmp2(9422).GuildTagBadge, obj5), ];
      const obj7 = { variant: "text-xs/semibold", color: "text-default", style: tmp.tag, children: tag };
      items2[1] = closure_5(tmp2(4718).Text, obj7);
