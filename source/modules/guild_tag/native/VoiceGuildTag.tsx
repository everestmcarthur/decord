...
// Function ID: 16236
// Name: VoiceGuildTag
// Dependencies: [19, 17, 1372, 8051, 21, 1364, 4639, 576, 504, 8285, 9316, 4635, 2]
// Exports: default

// Module 16235 (VoiceGuildTag)
...
export default function VoiceGuildTagChiplet(userId) {
  ...
  const userPrimaryGuild = userId(8285).getUserPrimaryGuild(primaryGuild);
  ...
  if (null != guildId) {
    if (null != tag) {
      ...
      const guildTagBadgeUrl = tmp2(8285).getGuildTagBadgeUrl(guildId, tmp7, GuildTagBadgeSize.SIZE_12);
      const obj5 = { source: null, size: null };
      const obj6 = { uri: guildTagBadgeUrl };
      obj5.source = obj6;
      obj5.size = GuildTagBadgeSize.SIZE_12;
      const items2 = [closure_5(tmp2(9316).GuildTagBadge, obj5), ];
      const obj7 = { variant: "text-xs/semibold", color: "text-default", style: tmp.tag, children: tag };
      items2[1] = closure_5(tmp2(4635).Text, obj7);
