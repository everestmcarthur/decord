...
// Dependencies: [5, 19, 17, 1074, 1954, 21, 576, 16262, 10208, 5031, 4606, 16263, 9010, 1114, 5658, 5174, 5731, 4602, 5026, 8669, 7389, 2]
...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    let obj3 = {
      ...
      children: closure_8(tmp2(5731).XSmallIcon, { size: "sm", color: "text-default" })
    };
    const items = [closure_8(tmp2(5174).PressableOpacity, obj3), , , , ];
    ...
    items[2] = closure_8(tmp2(4602).Text, obj5);
    ...
    items[3] = closure_8(tmp2(4602).Text, obj7);
    ...
    obj9.icon = closure_8(tmp2(8669).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj8.children = closure_8(tmp2(5026).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5658).Card, obj2);
  }
