...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    let obj3 = {
      ...
      children: closure_8(tmp2(5761).XSmallIcon, { size: "sm", color: "text-default" })
    };
    const items = [closure_8(tmp2(5204).PressableOpacity, obj3), , , , ];
    ...
    items[2] = closure_8(tmp2(4632).Text, obj5);
    ...
    items[3] = closure_8(tmp2(4632).Text, obj7);
    ...
    obj9.icon = closure_8(tmp2(8701).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj8.children = closure_8(tmp2(5056).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5688).Card, obj2);
  }
