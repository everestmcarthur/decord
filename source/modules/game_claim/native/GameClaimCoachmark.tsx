...
// Dependencies: [5, 19, 17, 1074, 1955, 21, 576, 16301, 10249, 5064, 4639, 16302, 9052, 1115, 5692, 5207, 5765, 4635, 5059, 8704, 7423, 2]
...
const GameClaimCardStackDefault = tmp5(16301);
require = fn;
...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    let obj3 = {
      ...
      children: closure_8(tmp2(5765).XSmallIcon, { size: "sm", color: "text-default" })
    };
    const items = [closure_8(tmp2(5207).PressableOpacity, obj3), , , , ];
    ...
    items[2] = closure_8(tmp2(4635).Text, obj5);
    ...
    items[3] = closure_8(tmp2(4635).Text, obj7);
    ...
    obj9.icon = closure_8(tmp2(8704).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj8.children = closure_8(tmp2(5059).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5692).Card, obj2);
  }
