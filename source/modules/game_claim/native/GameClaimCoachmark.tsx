...
// Dependencies: [5, 19, 17, 1074, 1955, 21, 576, 16321, 10257, 5065, 4638, 16322, 9063, 1115, 5693, 5208, 5766, 4634, 5060, 8713, 7426, 2]
...
const GameClaimCardStackDefault = tmp5(16321);
require = fn;
...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    let obj3 = {
      ...
      children: closure_8(tmp2(5766).XSmallIcon, { size: "sm", color: "text-default" })
    };
    const items = [closure_8(tmp2(5208).PressableOpacity, obj3), , , , ];
    ...
    items[2] = closure_8(tmp2(4634).Text, obj5);
    ...
    items[3] = closure_8(tmp2(4634).Text, obj7);
    ...
    obj9.icon = closure_8(tmp2(8713).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj8.children = closure_8(tmp2(5060).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5693).Card, obj2);
  }
