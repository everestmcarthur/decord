...
// Dependencies: [5, 19, 17, 1074, 1955, 21, 576, 16448, 10362, 5149, 4722, 16449, 9158, 1115, 5777, 5292, 5850, 4718, 5144, 8816, 7512, 7516, 2]
...
const GameClaimCardStackDefault = tmp5(16448);
require = fn;
...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    let obj3 = {
      ...
      children: closure_8(tmp2(5850).XSmallIcon, { size: "sm", color: "text-default" })
    };
    const items = [closure_8(tmp2(5292).PressableOpacity, obj3), , , , ];
    ...
    items[2] = closure_8(tmp2(4718).Text, obj5);
    ...
    items[3] = closure_8(tmp2(4718).Text, obj7);
    ...
    obj9.icon = closure_8(tmp2(8816).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj8.children = closure_8(tmp2(5144).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5777).Card, obj2);
  }
