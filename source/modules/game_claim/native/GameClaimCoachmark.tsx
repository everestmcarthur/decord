...
// Dependencies: [5, 19, 17, 1074, 1955, 21, 576, 16351, 10268, 5067, 4640, 16352, 9074, 1115, 5695, 5210, 5768, 4636, 5062, 8733, 7430, 7434, 2]
// Exports: getScaledGameClaimNoticeHeight

// Module 16350 (GameClaimCoachmark)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import ButtonConstants from "ButtonConstants" /* 5067 */;
import useGameNameAndCoverImageDefault from "useGameNameAndCoverImage" /* 9074 */;
import useScaledTextLineHeight from "useScaledTextLineHeight" /* 10268 */;
import GameClaimCardStack from "GameClaimCardStack" /* 16351 */;
import UnclaimedGamesActionCreators from "UnclaimedGamesActionCreators" /* 16352 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;

const require = globalThis.__r;

const GameClaimCardStackDefault = tmp5(16351);
require = fn;
...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    let obj3 = {
      ...
      children: closure_8(tmp2(5768).XSmallIcon, { size: "sm", color: "text-default" })
    };
    const items = [closure_8(tmp2(5210).PressableOpacity, obj3), , , , ];
    ...
    items[2] = closure_8(tmp2(4636).Text, obj5);
    ...
    items[3] = closure_8(tmp2(4636).Text, obj7);
    ...
    obj9.icon = closure_8(tmp2(8733).LinkExternalSmallIcon, { size: "xs", color: "white" });
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              v3 = 1;
              const obj5 = { value: v1(7430).redirectDeveloperPortalWithHandoffToken(constants.DEVELOPER_PORTAL_APPLICATIONS_GAME_IDENTITY, v3(7434).LoginHandoffSource.GAME_CLAIM), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            v3 = 3;
    ...
    obj8.children = closure_8(tmp2(5062).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5695).Card, obj2);
  }
