...
// Dependencies: [5, 1956, 1957, 2011, 9540, 9509, 9519, 2]
// Exports: joinOrStartActivityInChannel

// Module 11949 (_joinOrStartActivityInChannel)
            ...
            if (arg0 === 1) {
              ...
              if (applicationId === callback) {
                if (voiceChannelId === callback2) {
                  ...
                  closure_8 = callback2;
                  callback2(9540)(closure_8, channel.location);
                  channel = 3;
