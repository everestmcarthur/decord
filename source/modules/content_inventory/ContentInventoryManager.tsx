...
// Dependencies: [5, 5363, 5367, 5496, 13940, 12079, 8466, 8488, 1074, 1091, 12, 13215, 573, 13796, 18022, 7228, 2]

// Module 18021 (ContentInventoryManager)
import DispatcherDefault from "Dispatcher" /* 573 */;
import DurationsDefault from "Durations" /* 1091 */;
import ContentInventoryExperiments from "ContentInventoryExperiments" /* 13796 */;
import ContentInventoryFeature from "ContentInventoryFeature" /* 18022 */;
...
import ContentInventoryPersistedStore from "ContentInventoryPersistedStore" /* 12079 */;
...
let closure_17 = null;
let apply = fn(12);
let closure_18 = apply.debounce(fn(13215).postTrackToContentInventory, 3000, { trailing: true });
