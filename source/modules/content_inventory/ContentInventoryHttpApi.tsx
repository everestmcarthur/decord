      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === date) {
            ...
            constants = 0;
            c6 = body;
            const aPIError = new callback(4461).APIError(c6);
            throw aPIError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw body;
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            obj4[1] = callback;
            obj4.dispatch(obj4);
            const aPIError = new callback(4461).APIError(dependencyMap);
            throw aPIError;
          } else if (arg0 === 1) {
            c7 = 3;
            throw body;
...
function _deleteContentInventoryEntryHistory() {
  ...
  const tmp = callback((arg0, arg1, arg2) => {
    ...
    return (function*(arg0, arg1, arg2) {
      closure_5 = tmp3;
      c7 = 1;
      callback(573).dispatch({ type: "CONTENT_INVENTORY_DELETE_OUTBOX_ENTRY_START" });
      ...
      if (1 === tmp7) {
        ...
        if (message == null) {
          ...
          closure_3 = intl.string(lib(1114).t.FMbL3s);
        }
