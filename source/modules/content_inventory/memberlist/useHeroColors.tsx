...
// Function ID: 8160
// Name: useHeroColors
// Dependencies: [32, 19, 4566, 1183, 8158, 7566, 8160, 1091, 672, 504, 2]
...
export const getHeroColors = function getHeroColors(game_name) {
  const fallbackHeroColor = num(8160).getFallbackHeroColor(ThemeStore.theme, AccessibilityStore.saturation);
  num = 1;
