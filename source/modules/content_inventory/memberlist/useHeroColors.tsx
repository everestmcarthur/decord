...
// Function ID: 8197
// Name: useHeroColors
// Dependencies: [32, 19, 4597, 1183, 8195, 7604, 8197, 1091, 672, 504, 2]
...
export const getHeroColors = function getHeroColors(game_name) {
  const fallbackHeroColor = num(8197).getFallbackHeroColor(ThemeStore.theme, AccessibilityStore.saturation);
  num = 1;
