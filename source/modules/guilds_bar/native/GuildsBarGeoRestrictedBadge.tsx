...
// Dependencies: [19, 17, 21, 4606, 576, 5492, 5638, 12357, 2]

// Module 16419 (GuildsBarGeoRestrictedBadge)
...
const size1 = { height: 16, width: 16, opacity: fn(5492).DARK_1_LIGHT_08, tintColor: nativeDefault.colors.BLACK };
...
export default noop.memo(function GuildsBarGeoRestrictedBadge(style) {
  ...
  obj.style = items;
  const obj2 = { source: _modDef12357, style: tmp.badgeImage };
  obj.children = jsx(FastImageDefault, { source: _modDef12357, style: tmp.badgeImage });
