...
// Dependencies: [19, 17, 21, 4638, 576, 5527, 5673, 12406, 2]

// Module 16478 (GuildsBarGeoRestrictedBadge)
...
const size1 = { height: 16, width: 16, opacity: fn(5527).DARK_1_LIGHT_08, tintColor: nativeDefault.colors.BLACK };
...
export default noop.memo(function GuildsBarGeoRestrictedBadge(style) {
  ...
  obj.style = items;
  const obj2 = { source: _modDef12406, style: tmp.badgeImage };
  obj.children = jsx(FastImageDefault, { source: _modDef12406, style: tmp.badgeImage });
