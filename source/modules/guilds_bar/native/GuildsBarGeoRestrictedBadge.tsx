...
// Dependencies: [19, 17, 21, 4607, 576, 5493, 5639, 12359, 2]
...
const size1 = { height: 16, width: 16, opacity: fn(5493).DARK_1_LIGHT_08, tintColor: nativeDefault.colors.BLACK };
...
export default noop.memo(function GuildsBarGeoRestrictedBadge(style) {
  ...
  obj.style = items;
  const obj2 = { source: _modDef12359, style: tmp.badgeImage };
  obj.children = jsx(FastImageDefault, { source: _modDef12359, style: tmp.badgeImage });
