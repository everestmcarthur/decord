...
// Dependencies: [32, 19, 17, 7687, 4426, 5488, 16364, 15177, 21, 4605, 7124, 1611, 15170, 15179, 551, 558, 504, 4341, 16438, 2]

// Module 16437 (GuildsBarUnreadBars)
      ...
      if (tmp4.type === FastList.FastListItemTypes.ITEM) {
        if (tmp4.layoutStart > diff) {
          ...
          if (0 !== tmp4.layoutSize) {
            ...
            let type = tmp4.type;
            if (tmp41(7124).FastListItemTypes.SECTION === type) {
              ...
              if (tmp41(7124).FastListItemTypes.ITEM === type) {
...
let closure_17 = { beforeItem: "call", afterItem: "accessibilityLabel" };
