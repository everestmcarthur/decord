...
// Dependencies: [32, 19, 17, 7650, 4395, 5452, 16318, 15128, 21, 4574, 7086, 1611, 15121, 15130, 551, 558, 504, 4310, 16389, 2]

// Module 16388 (GuildsBarUnreadBars)
      ...
      if (tmp4.type === FastList.FastListItemTypes.ITEM) {
        if (tmp4.layoutStart > diff) {
          ...
          if (0 !== tmp4.layoutSize) {
            ...
            let type = tmp4.type;
            if (tmp41(7086).FastListItemTypes.SECTION === type) {
              ...
              if (tmp41(7086).FastListItemTypes.ITEM === type) {
