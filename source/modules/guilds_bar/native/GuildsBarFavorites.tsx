...
// Dependencies: [19, 17, 1960, 1074, 1954, 21, 4607, 576, 16365, 10315, 504, 16383, 16368, 10329, 16380, 16207, 1114, 16384, 10326, 16385, 2]
...
export default noop.memo(function GuildsBarFavorites() {
  ...
  const isFavoritesGuildSelected = shouldShowPopover(10315).useIsFavoritesGuildSelected();
  let obj2 = shouldShowPopover(10315);
  ...
  const favoritesIntroPopover = shouldShowPopover(10329).useFavoritesIntroPopover();
  ...
  const obj4 = shouldShowPopover(10329);
  ...
  obj5.children = closure_8(shouldShowPopover(10326).StarIcon, { color: isFavoritesGuildSelected ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT });
