...
// Dependencies: [19, 17, 1961, 1074, 1955, 21, 4638, 576, 16424, 10363, 504, 16442, 16427, 10377, 16439, 16266, 1115, 16443, 10374, 16444, 2]

// Module 16441 (GuildsBarFavorites)
...
export default noop.memo(function GuildsBarFavorites() {
  ...
  const obj5 = { selected: isFavoritesGuildSelected, circle: false, unread, styles: guildsBarAnimatedWrapperStyles, cutouts, overState: "l", config: memo, accessibilityActions, onAccessibilityAction, label: "AUDIO_SET_ATTENUATION", externalChildren: null, expandedChildren: null, children: null };
  ...
  obj5.children = closure_8(shouldShowPopover(10374).StarIcon, { color: isFavoritesGuildSelected ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT });
  const children = [closure_8(markPopoverAsDismissed(16424), obj5), closure_8(View, { ref, style: tmp9.anchor, pointerEvents: "none", collapsable: false }), ];
  if (shouldShowPopover) {
    const obj8 = { targetRef: ref, markAsDismissed: markPopoverAsDismissed };
    shouldShowPopover = tmp15(tmp5(16444), obj8);
  }
