...
// Dependencies: [19, 17, 1961, 1074, 1955, 21, 4639, 576, 16404, 10355, 504, 16422, 16407, 10369, 16419, 16246, 1115, 16423, 10366, 16424, 2]

// Module 16421 (GuildsBarFavorites)
...
export default noop.memo(function GuildsBarFavorites() {
  ...
  const obj5 = { selected: isFavoritesGuildSelected, circle: false, unread, styles: guildsBarAnimatedWrapperStyles, cutouts, overState: "l", config: memo, accessibilityActions, onAccessibilityAction, label: null, externalChildren: null, expandedChildren: null, children: "AUDIO_SET_LOCAL_VOLUME" };
  ...
  obj5.children = closure_8(shouldShowPopover(10366).StarIcon, { color: isFavoritesGuildSelected ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT });
  const children = [closure_8(markPopoverAsDismissed(16404), obj5), closure_8(View, { ref, style: tmp9.anchor, pointerEvents: "none", collapsable: false }), ];
  if (shouldShowPopover) {
    const obj8 = { targetRef: ref, markAsDismissed: markPopoverAsDismissed };
    shouldShowPopover = tmp15(tmp5(16424), obj8);
  }
