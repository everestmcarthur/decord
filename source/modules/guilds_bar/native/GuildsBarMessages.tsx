...
// Dependencies: [19, 4428, 1074, 21, 16380, 16365, 504, 16368, 576, 1114, 16381, 5122, 2]
...
export default noop.memo(function GuildsBarMessages() {
  ...
  const obj3 = { selected: stateFromStores, circle: false, unread: false, styles: guildsBarAnimatedWrapperStyles, cutouts, config, overState: "y", label: "heading-lg/semibold", externalChildren: "text-default", expandedChildren: null, children: 1 };
