...
// Dependencies: [5, 19, 17, 1980, 5526, 16445, 16442, 4376, 551, 4608, 4491, 12, 1231, 1115, 7186, 16182, 4341, 576, 4262, 11152, 1248, 5608, 9512, 8053, 1364, 1612, 5047, 16446, 16447, 15211, 6766, 2]
// Exports: default

// Module 16444 (useGuildsBarGesture)
    ...
    if (item.section >= GUILDS) {
      ...
      if (null != GUILDS) {
        ...
        if (FastList.FastListItemTypes.SECTION !== type) {
          if (tmp9(7186).FastListItemTypes.ITEM === type) {
      ...
      if (null != overSpecs) {
        if (null != dragSpecs) {
          ...
          if (FastList.FastListItemTypes.SECTION === type2) {
            ...
            if (tmp34(7186).FastListItemTypes.SECTION === type) {
              let str = "before";
              let str2 = "before";
