...
// Dependencies: [19, 5327, 4244, 7271, 7272, 13821, 4947, 2021, 1979, 13829, 4426, 5488, 16367, 16364, 21, 16375, 16389, 16390, 16393, 16398, 16424, 16427, 16428, 16429, 16431, 16432, 16433, 16435, 16437, 4306, 576, 1611, 15170, 15179, 15406, 504, 13912, 16439, 16440, 5012, 1477, 16442, 7124, 2]
// Exports: default

// Module 16374 (useGuildsBarProps)
import useWindowDimensions from "useWindowDimensions" /* 1477 */;
import GuildsBarFooterWrapperDefault from "GuildsBarFooterWrapper" /* 16431 */;
        ...
        const obj = {
          children: items1.map((item) => {
            if ("unavailable-guilds" === item) {
              return closure_1_19(closure_1_1(16432), {}, item);
            } else if ("empty-nux" === item) {
              return closure_1_19(closure_1_1(16433), {}, item);
            } else if ("create-join-guild" === item) {
              return closure_1_19(closure_1_1(16435), {}, item);
            }
          })
        };
