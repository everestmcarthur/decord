...
// Dependencies: [4843, 16449, 1897, 2]
// Exports: hideGuildsBarFolderModal, showGuildsBarFolderModal

// Module 16448 (GuildsBarFolderSettingsModalActionCreators)
...
export const showGuildsBarFolderModal = function showGuildsBarFolderModal(folderId) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(16449, dependencyMap.paths), { folderId }, GUILD_FOLDER_SETTINGS_MODAL_KEY);
};
