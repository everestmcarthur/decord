...
// Dependencies: [4808, 16371, 1896, 2]
// Exports: hideGuildsBarFolderModal, showGuildsBarFolderModal

// Module 16370 (GuildsBarFolderSettingsModalActionCreators)
...
export const showGuildsBarFolderModal = function showGuildsBarFolderModal(folderId) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(16371, dependencyMap.paths), { folderId }, GUILD_FOLDER_SETTINGS_MODAL_KEY);
};
