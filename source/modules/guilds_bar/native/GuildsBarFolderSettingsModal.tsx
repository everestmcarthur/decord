...
// Dependencies: [32, 19, 17, 5523, 16400, 21, 4639, 9490, 7088, 4606, 16401, 1897, 576, 5057, 6711, 1115, 5772, 5690, 1092, 14695, 5709, 504, 16398, 7107, 2]
// Exports: default
...
export default function GuildFolderSettingsModal(folderId) {
  ...
  const memo = obj2.useMemo(() => {
    ...
    if (closure_5) {
      ...
      let fn = tmp3(5709).getHeaderTextButton(intl2.string(tmp3(1115).t["R3BPH+"]), callback);
