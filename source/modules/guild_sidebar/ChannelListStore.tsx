...
// Dependencies: [1957, 2014, 7633, 5591, 4280, 1220, 502, 7224, 1958, 7634, 4278, 4654, 2012, 4820, 1084, 7635, 12, 1370, 4268, 11, 504, 573, 2]

// Module 7632 (ChannelListStore)
import SnowflakeUtilsDefault from "SnowflakeUtils" /* 11 */;
import _modDef12 from "module_12" /* 12 */;
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import embeddedActivityLocationUtils from "embeddedActivityLocationUtils" /* 4268 */;
import ChannelListStateDefault from "ChannelListState" /* 7635 */;
