...
// Dependencies: [32, 19, 12718, 2013, 1980, 1372, 7730, 1074, 1955, 563, 7359, 7361, 16517, 7584, 1944, 4542, 16441, 16518, 2]
// Exports: default

// Module 16516 (useChannelNoticeRows)
...
require = fn;
let closure_9 = fn(7730).ChannelListChannelNoticeRow;
