...
// Dependencies: [19, 17, 21, 1178, 4607, 7947, 7946, 5149, 5153, 2]
...
export default noop.memo((guildId) => {
  ...
  const items = [noPadding ? tmp.containerNoPadding : tmp.container, guildId(7946).useClientThemesOverride()];
  obj2.style = items;
  if (renderIcon) {
    if (stageIcon) {
      let VoiceNormalIcon = tmp4(5149).StageIcon;
    }
    ...
    obj4.overflowComponent = tmp4(1178).OverflowTextSmall;
    obj4.items = users;
    obj4.max = max;
    ...
    items1[1] = tmp7(tmp4(1178).SummarizedIconRow, obj4);
    obj2.children = items1;
    return tmp5(tmp6, obj2);
  }
  VoiceNormalIcon = tmp4(5153).VoiceNormalIcon;
});
