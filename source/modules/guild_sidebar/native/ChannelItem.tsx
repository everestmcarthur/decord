...
// Function ID: 16199
// Name: ChannelItem
// Dependencies: [109, 19, 17, 4645, 4253, 1371, 1074, 1964, 4787, 21, 4605, 576, 5491, 12449, 1396, 5637, 16199, 5125, 5078, 504, 1178, 5057, 16200, 4758, 1100, 2]

// Module 16198 (ChannelItem)
import nativeDefault from "native" /* 576 */;
import router_utils from "router_utils" /* 1100 */;
import AvatarUtilsDefault from "AvatarUtils" /* 1396 */;
import utils_ChannelUtils from "utils/ChannelUtils" /* 5078 */;
import BookCheckIcon2 from "BookCheckIcon" /* 5125 */;
import BaseChannelItem from "BaseChannelItem" /* 12449 */;
import _modDef16199 from "module_16199" /* 16199 */;
  ...
  if (channel.type === ChannelTypes.DM) {
    ...
    if (channel.type === tmp4.GROUP_DM) {
      ...
      if (null != channelIconSource) {
        ...
        return map1(tmp5(5637), obj7);
      }
      tmp5 = importDefault;
    }
    if (tmp2) {
      let tmp12 = _modDef16199;
    ...
    return map1(tmp9(12449).BaseChannelIcon, obj10);
  }
}
function DMChannelIcon(userId) {
  ...
  const obj3 = { user: stateFromStores, guildId: "o", size: userId(1178).AvatarSizes.XSMALL_20, style: tmp.dmAvatar, status, isMobileOnline, isVROnline, statusStyle: null };
  ...
  return closure_13(userId(1178).Avatar, obj3);
}
...
obj.avatarStatusSelected = { backgroundColor: fn(5491).DARK_393C42_LIGHT_DEE0E4 };
let closure_16 = createStyles.createStyles(obj);
let obj5 = { backgroundColor: fn(5491).DARK_393C42_LIGHT_DEE0E4 };
const size = fn(2);
