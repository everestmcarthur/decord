...
// Dependencies: [19, 17, 10256, 4820, 21, 4638, 576, 4634, 1365, 1177, 10303, 9045, 12523, 2]
// Exports: BaseChannelIcon, BaseChannelName, default, getChannelSubtitleTextProps, useChannelNameTextProps

// Module 12522 (BaseChannelItem)
...
export default function BaseChannelItem(mode) {
  ...
  if (hideIcon) {
    ...
    obj.children = items1;
    if (flag) {
      let AnimatedPressableHighlight = hideIcon(12523);
    } else {
      AnimatedPressableHighlight = mode(9045).AnimatedPressableHighlight;
    }
    obj2 = {};
    ...
    closure_8(hideIcon(10303), obj3);
    const tmp9 = hideIcon(10303);
  }
};
