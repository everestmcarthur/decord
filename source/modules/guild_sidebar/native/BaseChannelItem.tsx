...
// Dependencies: [19, 17, 10248, 4821, 21, 4639, 576, 4635, 1365, 1177, 10295, 9034, 12515, 2]
// Exports: BaseChannelIcon, BaseChannelName, default, getChannelSubtitleTextProps, useChannelNameTextProps

// Module 12514 (BaseChannelItem)
...
export default function BaseChannelItem(mode) {
  ...
  if (hideIcon) {
    ...
    obj.children = items1;
    if (flag) {
      let AnimatedPressableHighlight = hideIcon(12515);
    } else {
      AnimatedPressableHighlight = mode(9034).AnimatedPressableHighlight;
    }
    obj2 = {};
    ...
    closure_8(hideIcon(10295), obj3);
    const tmp9 = hideIcon(10295);
  }
};
