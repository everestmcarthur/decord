...
// Dependencies: [19, 17, 10267, 4822, 21, 4640, 576, 4636, 1365, 1177, 10311, 9060, 12532, 2]
// Exports: BaseChannelIcon, BaseChannelName, default, getChannelSubtitleTextProps, useChannelNameTextProps

// Module 12531 (BaseChannelItem)
...
export default function BaseChannelItem(mode) {
  ...
  if (hideIcon) {
    ...
    obj.children = items1;
    if (flag) {
      let AnimatedPressableHighlight = hideIcon(12532);
    } else {
      AnimatedPressableHighlight = mode(9060).AnimatedPressableHighlight;
    }
    obj2 = {};
    ...
    closure_8(hideIcon(10311), obj3);
    const tmp9 = hideIcon(10311);
  }
};
