...
// Dependencies: [5, 19, 17, 1074, 21, 4638, 576, 10257, 2025, 1897, 4332, 5208, 16330, 4634, 1115, 1177, 2]
// Exports: default, getScaledGuildMFAWarningHeight

// Module 16329 (GuildMFAWarning)
...
export default function GuildMFAWarning() {
  ...
  const items = [timestampProducer(Image, { style: tmp.MFAWarningIcon, source: _modDef16330 }), ];
