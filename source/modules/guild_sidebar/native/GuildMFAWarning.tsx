...
// Dependencies: [5, 19, 17, 1074, 21, 4605, 576, 10189, 2024, 1896, 4299, 5173, 16282, 4601, 1114, 1178, 2]
// Exports: default, getScaledGuildMFAWarningHeight

// Module 16281 (GuildMFAWarning)
...
export default function GuildMFAWarning() {
  ...
  const items = [timestampProducer(Image, { style: tmp.MFAWarningIcon, source: _modDef16282 }), ];
