...
// Function ID: 16360
// Name: ChannelBadge
// Dependencies: [19, 17, 2026, 21, 4638, 563, 16360, 12439, 4634, 1881, 2]
// Exports: default

// Module 16359 (ChannelBadge)
import useStateFromStores from "useStateFromStores" /* 563 */;
import NewBadgeDefault from "NewBadge" /* 12439 */;
import MentionsBadgeDefault from "MentionsBadge" /* 16360 */;
      ...
      if (!muted) {
        ...
        if (null != postsWithUnreadsCount) {
          ...
          if (postsWithUnreadsCount > 0) {
            ...
            obj5.children = jsx(tmp2(4634).Text, { variant: "text-xs/semibold", color: "text-muted", children: tmp2(1881).humanizeValue(postsWithUnreadsCount, stateFromStores) });
