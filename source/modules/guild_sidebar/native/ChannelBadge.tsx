...
// Function ID: 16340
// Name: ChannelBadge
// Dependencies: [19, 17, 2026, 21, 4639, 563, 16340, 12431, 4635, 1881, 2]
// Exports: default

// Module 16339 (ChannelBadge)
import useStateFromStores from "useStateFromStores" /* 563 */;
import NewBadgeDefault from "NewBadge" /* 12431 */;
import MentionsBadgeDefault from "MentionsBadge" /* 16340 */;
      ...
      if (!muted) {
        ...
        if (null != postsWithUnreadsCount) {
          ...
          if (postsWithUnreadsCount > 0) {
            ...
            obj5.children = jsx(tmp2(4635).Text, { variant: "text-xs/semibold", color: "text-muted", children: tmp2(1881).humanizeValue(postsWithUnreadsCount, stateFromStores) });
