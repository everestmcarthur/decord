...
// Function ID: 16390
// Name: ChannelBadge
// Dependencies: [19, 17, 2026, 21, 4640, 563, 16390, 12448, 4636, 1881, 2]
// Exports: default

// Module 16389 (ChannelBadge)
import useStateFromStores from "useStateFromStores" /* 563 */;
import NewBadgeDefault from "NewBadge" /* 12448 */;
import MentionsBadgeDefault from "MentionsBadge" /* 16390 */;
      ...
      if (!muted) {
        ...
        if (null != postsWithUnreadsCount) {
          ...
          if (postsWithUnreadsCount > 0) {
            ...
            obj5.children = jsx(tmp2(4636).Text, { variant: "text-xs/semibold", color: "text-muted", children: tmp2(1881).humanizeValue(postsWithUnreadsCount, stateFromStores) });
