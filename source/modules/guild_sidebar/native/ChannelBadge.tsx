...
// Function ID: 16487
// Name: ChannelBadge
// Dependencies: [19, 17, 2026, 21, 4722, 563, 16487, 12539, 4718, 1881, 2]
// Exports: default

// Module 16486 (ChannelBadge)
import useStateFromStores from "useStateFromStores" /* 563 */;
import NewBadgeDefault from "NewBadge" /* 12539 */;
import MentionsBadgeDefault from "MentionsBadge" /* 16487 */;
      ...
      if (!muted) {
        ...
        if (null != postsWithUnreadsCount) {
          ...
          if (postsWithUnreadsCount > 0) {
            ...
            obj5.children = jsx(tmp2(4718).Text, { variant: "text-xs/semibold", color: "text-muted", children: tmp2(1881).humanizeValue(postsWithUnreadsCount, stateFromStores) });
