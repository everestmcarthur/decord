...
// Dependencies: [32, 19, 17, 21, 4605, 4839, 9245, 4601, 4449, 1114, 16207, 2]
// Exports: default

// Module 16206 (VoiceUserNameItem)
import Text_Text from "Text/Text" /* 4601 */;
import useDisplayNameStylesDefault from "useDisplayNameStyles" /* 4839 */;
import useDisplayNameStylesFont from "useDisplayNameStylesFont" /* 9245 */;
...
export default function VoiceUserNameItem(arg0) {
  ...
  if (isGuest) {
    ...
    isGuest = tmp18(tmp5(4601).Text, obj6);
  }
  items1[1] = isGuest;
  ...
  if (tmp12) {
    ...
    obj7.children = React5(tmp2(16207), obj8);
