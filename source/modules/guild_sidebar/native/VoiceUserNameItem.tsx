...
// Dependencies: [32, 19, 17, 21, 4640, 4874, 9330, 4636, 4484, 1115, 16285, 2]
// Exports: default

// Module 16284 (VoiceUserNameItem)
import Text_Text from "Text/Text" /* 4636 */;
import useDisplayNameStylesDefault from "useDisplayNameStyles" /* 4874 */;
import useDisplayNameStylesFont from "useDisplayNameStylesFont" /* 9330 */;
...
export default function VoiceUserNameItem(arg0) {
  ...
  if (isGuest) {
    ...
    isGuest = tmp18(tmp5(4636).Text, obj6);
  }
  items1[1] = isGuest;
  ...
  if (tmp12) {
    ...
    obj7.children = React5(tmp2(16285), obj8);
