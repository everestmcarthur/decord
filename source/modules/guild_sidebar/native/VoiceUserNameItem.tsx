...
// Dependencies: [32, 19, 17, 21, 4574, 4808, 9208, 4570, 4418, 1114, 16158, 2]
// Exports: default

// Module 16157 (VoiceUserNameItem)
import Text_Text from "Text/Text" /* 4570 */;
import useDisplayNameStylesDefault from "useDisplayNameStyles" /* 4808 */;
import useDisplayNameStylesFont from "useDisplayNameStylesFont" /* 9208 */;
...
export default function VoiceUserNameItem(arg0) {
  ...
  if (isGuest) {
    ...
    isGuest = tmp18(tmp5(4570).Text, obj6);
  }
  items1[1] = isGuest;
  ...
  if (tmp12) {
    ...
    obj7.children = React5(tmp2(16158), obj8);
