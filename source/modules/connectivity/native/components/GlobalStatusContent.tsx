...
// Dependencies: [19, 17, 1957, 1979, 4597, 4592, 9712, 1074, 21, 4574, 576, 9247, 504, 9615, 9710, 4425, 4509, 5140, 4431, 9498, 1115, 1611, 9513, 9718, 2]
// Exports: default

// Module 9717 (GlobalStatusContent)
...
export default function ConnectivityGlobalStatusContent() {
  ...
  if (isScreenLandscape) {
    isScreenLandscape = tmp5(4431).isModalOpen(tmp2(9498));
    const tmp5Result5 = tmp5(4431);
  }
  if (isScreenLandscape) {
  ...
  obj2.style = items2;
  if (isScreenLandscape) {
    isScreenLandscape = closure_10(tmp2(9513), { hidden: true });
  }
  ...
  if (isGuildStageVoiceResult) {
    ...
    tmp19 = closure_10(tmp2(9718), obj4);
  }
  items3[1] = tmp19;
