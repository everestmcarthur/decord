...
// Dependencies: [5, 32, 19, 17, 4426, 4493, 1954, 21, 3, 4605, 576, 16244, 4536, 504, 4572, 1114, 7202, 16245, 4601, 5735, 5738, 1178, 5025, 2]
// Exports: default

// Module 16243 (GuildThemeNuxActionSheet)
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  [tmp5, c2] = noop.useState(guildId(16244).getInitialGuildThemeNuxSelection);
  const tmp4 = _slicedToArray(noop.useState(guildId(16244).getInitialGuildThemeNuxSelection), 2);
  [tmp7, c3] = noop.useState(null);
  const tmp6 = _slicedToArray(noop.useState(null), 2);
  [tmp9, c4] = noop.useState(false);
  noop = noop.useRef(false);
  const tmp10 = tmp5 === guildId(4536).GuildThemeSourcePreference.PERSONAL;
  closure_6 = tmp10;
  ...
  const items7 = [closure_10(markAsDismissed(16245), { themeSettings: stateFromStores1, isPersonal: tmp10 }), , , , , , ];
  ...
  items7[1] = closure_10(guildId(4601).Text, obj4);
  ...
  items7[2] = closure_10(guildId(4601).Text, obj5);
  ...
  obj8.value = guildId(4536).GuildThemeSourcePreference.GUILD;
  const items8 = [closure_10(guildId(5738).TableRadioRow, obj8), ];
  const obj9 = { label: null, value: null };
  const intl6 = tmp2(1114).intl;
  obj9.label = intl6.string(guildId(1114).t.js8y7t);
  obj9.value = guildId(4536).GuildThemeSourcePreference.PERSONAL;
  items8[1] = closure_10(guildId(5738).TableRadioRow, obj9);
  obj7.children = items8;
  obj6.children = closure_11(guildId(5735).TableRadioGroup, obj7);
  ...
  obj14.children = closure_10(guildId(5025).Button, obj15);
  items7[6] = closure_10(closure_6, obj14);
  obj3.children = items7;
  return closure_11(guildId(7202).BottomSheet, obj3);
};
