...
// Dependencies: [5, 32, 19, 17, 4461, 4527, 1955, 21, 3, 4639, 576, 16272, 4570, 504, 4606, 1115, 7257, 16273, 4635, 5770, 5773, 1177, 5059, 2]
// Exports: default

// Module 16271 (GuildThemeNuxActionSheet)
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  [tmp5, c2] = noop.useState(guildId(16272).getInitialGuildThemeNuxSelection);
  const tmp4 = _slicedToArray(noop.useState(guildId(16272).getInitialGuildThemeNuxSelection), 2);
  [tmp7, c3] = noop.useState(null);
  const tmp6 = _slicedToArray(noop.useState(null), 2);
  [tmp9, c4] = noop.useState(false);
  noop = noop.useRef(false);
  const tmp10 = tmp5 === guildId(4570).GuildThemeSourcePreference.PERSONAL;
  closure_6 = tmp10;
  ...
  const items7 = [closure_10(markAsDismissed(16273), { themeSettings: stateFromStores1, isPersonal: tmp10 }), , , , , , ];
  ...
  items7[1] = closure_10(guildId(4635).Text, obj4);
  ...
  items7[2] = closure_10(guildId(4635).Text, obj5);
  ...
  obj8.value = guildId(4570).GuildThemeSourcePreference.GUILD;
  const items8 = [closure_10(guildId(5773).TableRadioRow, obj8), ];
  const obj9 = { label: null, value: null };
  const intl6 = tmp2(1115).intl;
  obj9.label = intl6.string(guildId(1115).t.js8y7t);
  obj9.value = guildId(4570).GuildThemeSourcePreference.PERSONAL;
  items8[1] = closure_10(guildId(5773).TableRadioRow, obj9);
  obj7.children = items8;
  obj6.children = closure_11(guildId(5770).TableRadioGroup, obj7);
  ...
  obj14.children = closure_10(guildId(5059).Button, obj15);
  items7[6] = closure_10(closure_6, obj14);
  obj3.children = items7;
  return closure_11(guildId(7257).BottomSheet, obj3);
};
