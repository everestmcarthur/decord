...
// Dependencies: [5, 1958, 1372, 1074, 1115, 11086, 11094, 8491, 7873, 7299, 4335, 9960, 8508, 4336, 2]
// Exports: useInviteActions

// Module 11093 (guild_instant_invites/InstantInviteUtils)
...
export const useInviteActions = function useInviteActions(invite) {
  ...
  obj.iconSource = onInviteRevoked(11086).share;
  ...
  obj2.iconSource = onInviteRevoked(11086).copy;
  obj2.action = function action() {
    if (c3) {
      const tmpResult = tmp(9960);
      tmpResult.handleCopy(invite.code, invite.channel, InstantInviteSources.GROUP_DM, false);
    } else {
      tmp(7299).copy(getInviteURLDefault(invite.code));
  ...
  obj3.iconSource = onInviteRevoked(11086).revoke;
