...
// Dependencies: [19, 17, 1962, 4371, 1372, 21, 4722, 576, 5197, 5249, 5142, 4718, 4875, 4684, 1115, 11180, 2]
// Exports: default

// Module 11191 (InstantInviteCode)
...
export default function InstantInviteCode(invite) {
  ...
  const items1 = [closure_8(invite(4718).Text, { variant: "text-lg/bold", tabularNumbers: true, children: invite.code }), ];
  ...
  obj.children = closure_9(invite(5142).Stack, obj2);
