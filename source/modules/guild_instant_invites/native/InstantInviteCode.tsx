...
// Dependencies: [19, 17, 1962, 4286, 1372, 21, 4638, 576, 5113, 5165, 5058, 4634, 4791, 4600, 1115, 11079, 2]
// Exports: default

// Module 11090 (InstantInviteCode)
...
export default function InstantInviteCode(invite) {
  ...
  const items1 = [closure_8(invite(4634).Text, { variant: "text-lg/bold", tabularNumbers: true, children: invite.code }), ];
  ...
  obj.children = closure_9(invite(5058).Stack, obj2);
