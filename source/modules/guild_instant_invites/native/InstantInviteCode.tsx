...
// Dependencies: [19, 17, 1962, 4288, 1372, 21, 4640, 576, 5115, 5167, 5060, 4636, 4793, 4602, 1115, 11087, 2]
// Exports: default

// Module 11098 (InstantInviteCode)
...
export default function InstantInviteCode(invite) {
  ...
  const items1 = [closure_8(invite(4636).Text, { variant: "text-lg/bold", tabularNumbers: true, children: invite.code }), ];
  ...
  obj.children = closure_9(invite(5060).Stack, obj2);
