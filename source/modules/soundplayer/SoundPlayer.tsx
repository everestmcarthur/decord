...
// Function ID: 17077
// Name: SoundPlayer
// Dependencies: [19, 1957, 9642, 4656, 16703, 1962, 4661, 502, 1958, 1980, 1909, 10212, 4662, 2012, 5504, 4658, 4663, 1074, 9643, 21, 504, 10034, 4786, 4691, 4268, 1370, 7351, 2]
// Exports: default

// Module 17076 (SoundPlayer)
...
function MuteDeafen() {
  ...
  const f104720 = () => ({ inVoiceChannel: null != voiceChannelId.getVoiceChannelId(), selfMute: MediaEngineStore.isSelfMute(), selfDeaf: MediaEngineStore.isSelfDeaf(), audioPermissionReady: MediaEngineStore.isNativeAudioPermissionReady(), shouldSkipMuteUnmuteSound: MediaEngineStore.shouldSkipMuteUnmuteSound() });
  const f104721 = (selfDeaf, arg1) => {
  ...
  const effect = f104721.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function Camera() {
  const items = [MediaEngineStore, SelectedChannelStore];
  const f104722 = () => ({ videoEnabled: videoEnabled.isVideoEnabled(), inVoiceChannel: null != voiceChannelId.getVoiceChannelId() });
  const f104723 = (videoEnabled, videoEnabled2) => {
  ...
  const effect = f104723.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function RTCConnect() {
  ...
  const f104725 = (channelType, arg1) => {
  ...
  const effect = f104725.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function Speaking() {
  ...
  const f104726 = () => currentUserPTTActive.isCurrentUserPTTActive();
  const f104727 = (arg0, arg1) => {
    if (arg0 !== arg1) {
  ...
  const effect = f104727.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function SelfMutedTemporarily() {
  ...
  const f104728 = () => MediaEngineStore.isSelfMutedTemporarily();
  const f104729 = (arg0, arg1) => {
    if (arg0 !== arg1) {
  ...
  const effect = f104729.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function PriorityVAD() {
  const items = [SpeakingStore];
  const f104730 = () => currentUserPrioritySpeaker.isCurrentUserPrioritySpeaker();
  const f104731 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      if (MediaEngineStore.getMode() === constants.VOICE_ACTIVITY) {
        if (!isSelfMuteResult) {
          let str = "ptt_stop";
  ...
  const effect = f104731.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function UserHasBeenMoved() {
  ...
  const f104732 = () => VoiceStateStore.userHasBeenMovedVersion;
  const f104733 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      return "user_moved";
    }
  };
  const effect = f104733.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function UserInvitedToSpeak() {
  ...
  const f104734 = () => {
    ...
    if (null == voiceChannelId) {
      return items(f104734[22]).RequestToSpeakStates.NONE;
    } else {
      voiceStateForChannel = voiceStateForChannel.getVoiceStateForChannel(voiceChannelId);
      return items(f104734[22]).getAudienceRequestToSpeakState(voiceStateForChannel);
    }
  };
  const f104735 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      if (arg1 === items(f104734[22]).RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK) {
        return "reconnect";
      }
    }
  };
  const effect = f104735.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function VoiceChannel() {
  ...
  const f104736 = () => {
    ...
    if (null != first) {
      const encodeStreamKeyResult = items(f104736[23]).encodeStreamKey(first);
  ...
  const f104737 = (voiceChannelId, arg1) => {
    ({ channelType, voiceChannelId, voiceChannelUserCount, streamingUserIds } = arg1);
    ({ singleActiveStreamKey, singleActiveStreamViewerCount, currentUserId: f104737 } = arg1);
    closure_3 = undefined;
  ...
  const effect = f104737.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
...
function ActivitySounds() {
  ...
  const f104738 = () => {
    ...
    const embeddedActivityLocationChannelId = items(f104738[24]).getEmbeddedActivityLocationChannelId(connectedActivityLocation);
    id = id.getId();
    const obj2 = items(f104738[24]);
  ...
  const f104739 = (isGuildSpaceActivity, arg1) => {
  ...
  const effect = f104739.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f104738[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f104738();
      const tmp2 = f104739(closure_0, tmp);
