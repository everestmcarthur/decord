...
// Dependencies: [32, 19, 17, 21, 4606, 576, 14650, 1091, 4343, 14651, 4456, 672, 4573, 7223, 7222, 1114, 5026, 6677, 12, 14652, 2]
// Exports: default

// Module 14649 (CustomColorPickerActionSheet)
...
export default function CustomColorPickerActionSheet(arg0) {
  ...
  obj7.trailing = sharedValue2(onSelect(5026).Button, obj9);
  obj5.header = sharedValue2(onSelect(7222).BottomSheetTitleHeader, obj7);
  ...
  const items3 = [sharedValue2(onSelect(6677).TextInput, obj11), , ];
  ...
  items3[2] = sharedValue2(tmp16(14652), {
    hue: sharedValue,
  ...
  return sharedValue2(onSelect(7223).BottomSheet, obj5);
};
