...
// Dependencies: [32, 19, 17, 21, 4640, 576, 14719, 1092, 4376, 14720, 4489, 672, 4607, 7264, 7263, 1115, 5062, 6717, 12, 14721, 2]
// Exports: default

// Module 14718 (CustomColorPickerActionSheet)
...
export default function CustomColorPickerActionSheet(arg0) {
  ...
  obj7.trailing = sharedValue2(onSelect(5062).Button, obj9);
  obj5.header = sharedValue2(onSelect(7263).BottomSheetTitleHeader, obj7);
  ...
  const items3 = [sharedValue2(onSelect(6717).TextInput, obj11), , ];
  ...
  items3[2] = sharedValue2(tmp16(14721), {
    hue: sharedValue,
  ...
  return sharedValue2(onSelect(7264).BottomSheet, obj5);
};
