...
// Dependencies: [32, 19, 17, 21, 4607, 576, 14652, 1091, 4343, 14653, 4456, 672, 4574, 7224, 7223, 1114, 5027, 6678, 12, 14654, 2]
// Exports: default

// Module 14651 (CustomColorPickerActionSheet)
...
export default function CustomColorPickerActionSheet(arg0) {
  ...
  const int2hexResult = onSelect(1091).int2hex(color);
  let obj2 = onSelect(1091);
  ({ h, s, v } = onSelect(1091).int2hsv(color));
  ...
  let int2hsvResult = onSelect(1091).int2hsv(color);
  sharedValue = onSelect(4343).useSharedValue(h);
  const obj4 = onSelect(4343);
  const sharedValue1 = onSelect(4343).useSharedValue(s);
  const obj6 = onSelect(4343);
  const sharedValue2 = onSelect(4343).useSharedValue(v);
  let combined;
  ...
  obj7.title = intl.string(onSelect(1114).t.WTqQ5e);
  const obj9 = { variant: actionButtonVariant, size: "sm", text: null, onPress: null };
  const intl2 = tmp2(1114).intl;
  obj9.text = intl2.string(onSelect(1114).t.XqMe3N);
  obj9.onPress = callback1;
  obj7.trailing = sharedValue2(onSelect(5027).Button, obj9);
  obj5.header = sharedValue2(onSelect(7223).BottomSheetTitleHeader, obj7);
  ...
  obj11.accessibilityLabel = intl3.string(onSelect(1114).t["ozfa/h"]);
  obj11.value = value;
  ...
  const items3 = [sharedValue2(onSelect(6678).TextInput, obj11), , ];
  const obj12 = { suggestedColors: null, onSelect: null, color: null };
  const obj8 = onSelect(4343);
  ...
  if (null == value) {
    value = sharedValue.get();
    value2 = sharedValue1.get();
    memo = tmp2(1091).hsv2int(value, value2, sharedValue2.get());
    const tmp2Result = tmp2(1091);
  }
  obj12.color = memo;
  items3[1] = sharedValue2(tmp15, obj12);
  items3[2] = sharedValue2(tmp16(14654), {
    hue: sharedValue,
  ...
  return sharedValue2(onSelect(7224).BottomSheet, obj5);
};
