...
// Dependencies: [32, 19, 17, 21, 4639, 576, 4376, 14696, 5071, 6760, 2]
// Exports: default

// Module 14698 (SaturationValueColorPicker)
...
function ColorBox(hue) {
  ...
  let obj = hue(4376);
  S.__closure = { hslToRgbWorklet: hue(14696).hslToRgbWorklet, hue };
  ...
  const obj2 = { hslToRgbWorklet: hue(14696).hslToRgbWorklet, hue };
...
export default function SaturationValueColorPicker(hue) {
  ...
  let size = { saturation, normalizeValue: hue(14696).normalizeValue, width: colorBoxWidth, value, height: first1, onPanUpdate, runOnJS: hue(4376).runOnJS };
  fn.__closure = size;
  ...
  const size1 = { saturation, normalizeValue: hue(14696).normalizeValue, width: colorBoxWidth, value, height: first1, onPanUpdate, runOnJS: hue(4376).runOnJS };
  fn2.__closure = size1;
  ...
  let obj6 = hue(4376);
  fn4.__closure = { hsvToRgbWorklet: hue(14696).hsvToRgbWorklet, hue, saturation, value, colorBoxWidth, colorBoxHeight: first1 };
  ...
  let obj4 = { hsvToRgbWorklet: hue(14696).hsvToRgbWorklet, hue, saturation, value, colorBoxWidth, colorBoxHeight: first1 };
  ...
  const items2 = [closure_6(hue(6760).GestureDetector, obj7), ];
