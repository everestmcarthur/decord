...
// Dependencies: [19, 9618, 1074, 563, 8393, 9765, 1241, 2]
// Exports: default

// Module 9787 (useTrackActivityVideoPip)
...
export default function useTrackActivityPip(arg0) {
  ...
  let tmp2 = stateFromStores(8393)(stateFromStores);
  dependencyMap = tmp2;
  const tmp3 = stateFromStores(9765)();
  noop = tmp3;
