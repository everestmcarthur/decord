...
// Dependencies: [19, 4678, 1074, 21, 1115, 17364, 7489, 4606, 4840, 4984, 17361, 1897, 17365, 4691, 17366, 9952, 11724, 10132, 8753, 7, 4338, 8482, 2]
...
import _modDef17364 from "module_17364" /* 17364 */;
import _modDef17365 from "module_17365" /* 17365 */;
...
export const openHideSelfStreamAndVideoConfirmDialog = function openHideSelfStreamAndVideoConfirmDialog(arg0, arg1) {
  ...
  actions_AlertActionCreatorsDefault.openLazy({
    importer() {
      return asyncRequireImpl(17361, dependencyMap.paths).then((result) => {
...
export const reportStreamIssue = function reportStreamIssue(stream) {
  ...
  obj.onPress = function onPress() {
    ...
    obj5.openLazy(asyncRequireImpl(17366, tmp2.paths), "StreamReportProblem" + stream.ownerId, { stream, analyticsData: obj3 });
  };
  return obj;
};
