...
// Dependencies: [1956, 4590, 9523, 4596, 502, 1957, 1908, 4597, 4595, 504, 4626, 4431, 9498, 2]
// Exports: default, useHasPipParticipant

// Module 9522 (usePipVideoOrStream)
...
import VideoSpeakerStore from "VideoSpeakerStore" /* 9523 */;
