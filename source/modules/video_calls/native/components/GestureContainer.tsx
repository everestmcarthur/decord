...
// Dependencies: [19, 17, 9499, 9505, 21, 4574, 576, 1477, 4310, 6669, 4777, 4575, 1178, 2]
// Exports: default

// Module 10053 (GestureContainer)
...
export default function GestureContainer(children) {
  ...
  sharedValue = height(4310).useSharedValue(0);
  ...
  fn.__closure = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4310).runOnJS, ModalActionCreators: sharedValue(4777), withTiming: height(4575).withTiming, DECELERATED_EASING: height(1178).DECELERATED_EASING };
  fn.__workletHash = 10736744030668;
  fn.__initData = __initData;
  let obj2 = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4310).runOnJS, ModalActionCreators: sharedValue(4777), withTiming: height(4575).withTiming, DECELERATED_EASING: height(1178).DECELERATED_EASING };
  ...
  fn2.__closure = { interpolate: height(4310).interpolate, position: sharedValue, height };
  ...
  let obj3 = { interpolate: height(4310).interpolate, position: sharedValue, height };
  obj4.children = jsx(height(6669).GestureDetector, { gesture: failOffsetXResult, children: jsx(sharedValue(4310).View, { style: animatedStyle, children: children.children }) });
