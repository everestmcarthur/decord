...
// Dependencies: [19, 17, 9705, 9711, 21, 4722, 576, 1478, 4458, 6848, 4925, 4723, 1177, 2]
// Exports: default

// Module 10265 (GestureContainer)
...
export default function GestureContainer(children) {
  ...
  sharedValue = height(4458).useSharedValue(0);
  const Gesture = height(6848).Gesture;
  let obj = height(4458);
  ...
  fn.__closure = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4458).runOnJS, ModalActionCreators: sharedValue(4925), withTiming: height(4723).withTiming, DECELERATED_EASING: height(1177).DECELERATED_EASING };
  fn.__workletHash = 10736744030668;
  fn.__initData = __initData;
  let obj2 = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4458).runOnJS, ModalActionCreators: sharedValue(4925), withTiming: height(4723).withTiming, DECELERATED_EASING: height(1177).DECELERATED_EASING };
  ...
  const obj8 = height(4458);
  fn2.__closure = { interpolate: height(4458).interpolate, position: sharedValue, height };
  ...
  let obj3 = { interpolate: height(4458).interpolate, position: sharedValue, height };
  obj4.children = jsx(height(6848).GestureDetector, { gesture: failOffsetXResult, children: jsx(sharedValue(4458).View, { style: animatedStyle, children: children.children }) });
