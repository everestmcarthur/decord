...
// Dependencies: [19, 17, 9621, 9627, 21, 4640, 576, 1478, 4376, 6766, 4843, 4641, 1177, 2]
// Exports: default

// Module 10171 (GestureContainer)
...
export default function GestureContainer(children) {
  ...
  sharedValue = height(4376).useSharedValue(0);
  const Gesture = height(6766).Gesture;
  let obj = height(4376);
  ...
  fn.__closure = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4376).runOnJS, ModalActionCreators: sharedValue(4843), withTiming: height(4641).withTiming, DECELERATED_EASING: height(1177).DECELERATED_EASING };
  fn.__workletHash = 10736744030668;
  fn.__initData = __initData;
  let obj2 = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4376).runOnJS, ModalActionCreators: sharedValue(4843), withTiming: height(4641).withTiming, DECELERATED_EASING: height(1177).DECELERATED_EASING };
  ...
  const obj8 = height(4376);
  fn2.__closure = { interpolate: height(4376).interpolate, position: sharedValue, height };
  ...
  let obj3 = { interpolate: height(4376).interpolate, position: sharedValue, height };
  obj4.children = jsx(height(6766).GestureDetector, { gesture: failOffsetXResult, children: jsx(sharedValue(4376).View, { style: animatedStyle, children: children.children }) });
