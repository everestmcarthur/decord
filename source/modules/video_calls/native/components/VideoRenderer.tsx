...
// Function ID: 9675
// Name: VideoRenderer
// Dependencies: [32, 19, 17, 21, 4605, 9675, 9676, 9678, 1477, 1115, 8397, 9683, 9684, 9686, 4341, 2]

// Module 9674 (VideoRenderer)
...
export default noop.memo((gestureEnabled) => {
  ...
  let onReady;
  const tmp2 = onReady();
  const surfaceDirectRendererExperiment = resizeMode(9675).useSurfaceDirectRendererExperiment(userId, { location: "VideoRenderer" });
  ...
  closure_8 = tmp15;
  const obj = resizeMode(9675);
  [tmp17, c9] = first1(noop.useState(true), 2);
  width(9676)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = width(9678)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  noop.useRef(null);
  ...
  const store = resizeMode(8397).useStore((orientation) => orientation.orientation);
  ...
  if (tmp17) {
    ...
    tmp35 = closure_8(tmp18(9683), obj3);
  }
  const tmp37 = store === resizeMode(8397).OrientationType.PORTRAIT;
  const obj2 = resizeMode(8397);
  if (tmp3Result.isAndroid()) {
    ...
    const items11 = [closure_8(tmp18(9686), obj7), tmp35];
    obj6.children = items11;
    obj5.children = c9(first2, obj6);
    const items12 = [closure_8(tmp18(9684), obj5), ];
    ...
    obj12.children = closure_8(tmp18(9686), obj13);
    const items13 = [closure_8(tmp18(4341).View, obj12), ];
    let tmp48 = null;
    if (tmp37) {
    ...
    const items17 = [closure_8(tmp18(9686), obj16), tmp35];
