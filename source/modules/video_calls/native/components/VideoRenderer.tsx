...
// Function ID: 9737
// Name: VideoRenderer
// Dependencies: [32, 19, 17, 21, 4639, 9737, 9738, 9740, 1478, 1364, 8453, 9745, 9746, 9748, 4376, 2]

// Module 9736 (VideoRenderer)
...
export default noop.memo((gestureEnabled) => {
  ...
  let onReady;
  const tmp2 = onReady();
  const surfaceDirectRendererExperiment = resizeMode(9737).useSurfaceDirectRendererExperiment(userId, { location: "VideoRenderer" });
  ...
  closure_8 = tmp15;
  const obj = resizeMode(9737);
  [tmp17, c9] = first1(noop.useState(true), 2);
  width(9738)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = width(9740)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  noop.useRef(null);
  ...
  const store = resizeMode(8453).useStore((orientation) => orientation.orientation);
  ...
  if (tmp17) {
    ...
    tmp35 = closure_8(tmp18(9745), obj3);
  }
  const tmp37 = store === resizeMode(8453).OrientationType.PORTRAIT;
  const obj2 = resizeMode(8453);
  if (tmp3Result.isAndroid()) {
    ...
    const items11 = [closure_8(tmp18(9748), obj7), tmp35];
    obj6.children = items11;
    obj5.children = c9(first2, obj6);
    const items12 = [closure_8(tmp18(9746), obj5), ];
    ...
    obj12.children = closure_8(tmp18(9748), obj13);
    ...
    const items17 = [closure_8(tmp18(9748), obj16), tmp35];
