...
// Function ID: 9745
// Name: VideoRenderer
// Dependencies: [32, 19, 17, 21, 4638, 9745, 9746, 9748, 1478, 1364, 8462, 9753, 9754, 9756, 4374, 2]

// Module 9744 (VideoRenderer)
...
export default noop.memo((gestureEnabled) => {
  ...
  let onReady;
  const tmp2 = onReady();
  const surfaceDirectRendererExperiment = resizeMode(9745).useSurfaceDirectRendererExperiment(userId, { location: "VideoRenderer" });
