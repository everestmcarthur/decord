...
// Dependencies: [19, 1909, 21, 504, 10075, 1115, 10185, 9243, 9623, 9624, 10186, 4841, 2]
// Exports: CameraButton, GridButton

// Module 10184 (ChannelCallHeaderButtons)
...
export const GridButton = function GridButton(channel) {
  ...
  if (null != useSelectedParticipantDefault(channel)) {
    ...
    if (!tmp3) {
      ...
      obj.source = tmp(10186);
      obj.onPress = function onPress() {
        return ChannelRTCActionCreatorsDefault.selectParticipant(channel.id, null);
      };
      tmp4 = jsx(tmp(10075), { accessibilityLabel: null, source: null, onPress: null, disableBackground: true });
