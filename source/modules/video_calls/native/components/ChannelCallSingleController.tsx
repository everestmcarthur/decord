...
// Dependencies: [19, 4627, 502, 1074, 4626, 21, 1242, 4785, 504, 10093, 10095, 10096, 2]
// Exports: ChannelCallSingleController

// Module 10092 (ChannelCallSingleController)
...
export const ChannelCallSingleController = function ChannelCallSingleController(selectedParticipant) {
  ...
  if (ParticipantTypes.STREAM === type) {
    if (null == tmp4) {
      ...
      let tmp18 = channel;
      tmp18 = tmp18(selectedParticipant.user.id === tmp15 ? 10093 : 10095);
    ...
    return jsx(channel(10096), { participant: selectedParticipant, channel });
