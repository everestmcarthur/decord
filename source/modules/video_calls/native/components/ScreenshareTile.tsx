...
// Dependencies: [19, 17, 1074, 21, 4638, 576, 9735, 6763, 1177, 9736, 4634, 1115, 2]
// Exports: default

// Module 9734 (ScreenshareTile)
...
export default function ScreenShareTile(onSingleTap) {
  ...
  items[1] = timestampProducer(React4, { source: _modDef9736, style: tmp.image, resizeMode: "contain" });
