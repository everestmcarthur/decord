...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 9746, 6766, 1177, 9747, 4636, 1115, 2]
// Exports: default

// Module 9745 (ScreenshareTile)
...
export default function ScreenShareTile(onSingleTap) {
  ...
  items[1] = timestampProducer(React4, { source: _modDef9747, style: tmp.image, resizeMode: "contain" });
