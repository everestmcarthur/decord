...
// Function ID: 9656
// Name: UserTile
// Dependencies: [32, 19, 17, 9656, 502, 1957, 1908, 1074, 4595, 4599, 21, 4574, 576, 4423, 504, 8274, 1178, 9657, 4570, 1114, 9636, 9639, 8647, 9658, 9659, 9660, 9510, 9654, 9661, 9621, 9624, 6669, 9662, 2]
// Exports: default

// Module 9655 (UserTile)
...
import mediaEngineContextFromParticipantTypeDefault from "mediaEngineContextFromParticipantType" /* 9661 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import VoiceChannelEffectsStore from "VoiceChannelEffectsStore" /* 9656 */;
...
let closure_7 = fn(9656).clearVoiceChannelEffectForUser;
...
let closure_18 = noop.memo((guildId) => {
  ...
  obj5.renderVideoDetails = function renderVideoDetails() {
    if (closure_3) {
      ...
      obj2.style = items;
      const obj3 = { source: _modDef9657, size: native.Icon.Sizes.SMALL, disableColor: true };
...
let closure_19 = noop.memo((userId) => {
  ...
  if (tmp5) {
    ...
    if (tmp5) {
      ...
      obj2.style = items2;
      const obj3 = { source: _modDef9660, size: tmp2(1178).Icon.Sizes.SMALL, disableColor: true };
    ...
    if (null != tmp6) {
      ...
      items4[2] = obj4;
      obj5.style = items4;
      const obj6 = { source: tmp6, size: tmp2(1178).Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, disableColor: tmp6 === _modDef8647 };
