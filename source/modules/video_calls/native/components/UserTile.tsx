...
// Function ID: 9694
// Name: UserTile
// Dependencies: [32, 19, 17, 9694, 502, 1957, 1908, 1074, 4626, 4630, 21, 4605, 576, 4454, 504, 8311, 1178, 9695, 4601, 1114, 9674, 9677, 8684, 9696, 9697, 9698, 9548, 9692, 9699, 9659, 9662, 6705, 9700, 2]
// Exports: default

// Module 9693 (UserTile)
...
import mediaEngineContextFromParticipantTypeDefault from "mediaEngineContextFromParticipantType" /* 9699 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import VoiceChannelEffectsStore from "VoiceChannelEffectsStore" /* 9694 */;
...
let closure_7 = fn(9694).clearVoiceChannelEffectForUser;
...
let closure_18 = noop.memo((guildId) => {
  ...
  obj5.renderVideoDetails = function renderVideoDetails() {
    if (closure_3) {
      ...
      obj2.style = items;
      const obj3 = { source: _modDef9695, size: native.Icon.Sizes.SMALL, disableColor: true };
...
let closure_19 = noop.memo((userId) => {
  ...
  if (tmp5) {
    ...
    if (tmp5) {
      ...
      obj2.style = items2;
      const obj3 = { source: _modDef9698, size: tmp2(1178).Icon.Sizes.SMALL, disableColor: true };
    ...
    if (null != tmp6) {
      ...
      items4[2] = obj4;
      obj5.style = items4;
      const obj6 = { source: tmp6, size: tmp2(1178).Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, disableColor: tmp6 === _modDef8684 };
