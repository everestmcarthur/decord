...
// Dependencies: [32, 19, 17, 9610, 9611, 1074, 21, 1364, 4638, 576, 5610, 1177, 1612, 4374, 9832, 1094, 1115, 7264, 4639, 6763, 9834, 1478, 9641, 1110, 4348, 5048, 4489, 9835, 2]
// Exports: default

// Module 9831 (FocusedControlsBottomControls)
...
import CallPTTButton from "CallPTTButton" /* 9835 */;
...
function FocusedControlsBottomDrawerTooltip(positionY) {
  ...
  const tmp = closure_18();
  const canShowTooltip = positionY(9832).useCanShowTooltip(positionY(1094).TooltipNames.SCREENSHARE_SWIPE_UP_CONTROLS, true);
  positionY(4374);
  const fn = function o() {
...
function FocusedControlsAboveActionBarView(positionY) {
  ...
  const animatedStyle = positionY(4374).useAnimatedStyle(fn);
  const items = [closure_13(FocusedControlsBottomDrawerTooltip, { positionY }), closure_13(positionY(7264).ActionSheetHeaderBar, {}), ];
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(offsetY(4374).View, obj5);
  }
  items[2] = tmp4Result;
  obj4.children = items;
