...
// Dependencies: [32, 19, 17, 9621, 9622, 1074, 21, 1364, 4640, 576, 5612, 1177, 1612, 4376, 9843, 1094, 1115, 7268, 4641, 6766, 9845, 1478, 9652, 1110, 4350, 5050, 4491, 9846, 2]
// Exports: default

// Module 9842 (FocusedControlsBottomControls)
import nativeDefault from "native" /* 576 */;
import ConstantsIOS from "ConstantsIOS" /* 1094 */;
import ComponentDispatchUtils from "ComponentDispatchUtils" /* 1110 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4376 */;
import timing from "timing" /* 4641 */;
import TooltipActionCreatorsDefault from "TooltipActionCreators" /* 9845 */;
import CallPTTButton from "CallPTTButton" /* 9846 */;
...
function FocusedControlsBottomDrawerTooltip(positionY) {
  ...
  const tmp = closure_18();
  const canShowTooltip = positionY(9843).useCanShowTooltip(positionY(1094).TooltipNames.SCREENSHARE_SWIPE_UP_CONTROLS, true);
  positionY(4376);
  const fn = function o() {
...
function FocusedControlsAboveActionBarView(positionY) {
  ...
  const animatedStyle = positionY(4376).useAnimatedStyle(fn);
  const items = [closure_13(FocusedControlsBottomDrawerTooltip, { positionY }), closure_13(positionY(7268).ActionSheetHeaderBar, {}), ];
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(offsetY(4376).View, obj5);
  }
  items[2] = tmp4Result;
  obj4.children = items;
