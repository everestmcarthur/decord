...
// Dependencies: [19, 17, 21, 4638, 576, 9735, 6763, 9736, 4634, 1115, 5060, 10091, 2]
// Exports: default

// Module 10163 (ScreenshareParticipant)
...
export default function ScreenshareParticipant(participant) {
  ...
  const items3 = [timestampProducer(hasOwnProperty, { source: _modDef9736, style: tmp4.image }), , , ];
