...
// Dependencies: [19, 17, 21, 4639, 576, 9724, 6760, 9725, 4635, 1115, 5059, 10083, 2]
// Exports: default

// Module 10155 (ScreenshareParticipant)
...
export default function ScreenshareParticipant(participant) {
  ...
  const items3 = [timestampProducer(hasOwnProperty, { source: _modDef9725, style: tmp4.image }), , , ];
