...
// Dependencies: [32, 19, 4623, 1957, 9560, 9561, 9566, 1074, 21, 9564, 9567, 4464, 9577, 9749, 9574, 9750, 4343, 4472, 12876, 504, 1477, 9568, 12877, 7236, 7256, 13021, 4814, 6727, 9682, 2]

// Module 9559 (ChannelCallModal)
...
import CameraPreviewDefault from "CameraPreview" /* 9577 */;
import ChannelCallModalManagerDefault from "ChannelCallModalManager" /* 9749 */;
import ChannelCallNavigatorDefault from "ChannelCallNavigator" /* 9750 */;
import PanGestureAnimations from "PanGestureAnimations" /* 12876 */;
import RouteManagerUtils from "RouteManagerUtils" /* 12877 */;
...
let VoiceChatDrawerState = fn(9561).VoiceChatDrawerState;
...
let closure_18 = noop.memo((arg0) => {
  ...
  const effect = noop.useEffect(() => {
    if (null != first) {
      ...
      return () => {
        closure_1_1(9749).terminate();
        const obj = closure_1_1(9749);
        closure_1_1(9574).setHidden(false);
        const obj2 = closure_1_1(9574);
  ...
  function te(arg0, arg1) {
    ...
    if (tmp2) {
      ...
      if (arg0 === VoiceChatDrawerState.OPEN) {
        tmp4(4343).runOnJS(tmp4(12877).transitionToVoiceRoute)(guildId, tmp7);
