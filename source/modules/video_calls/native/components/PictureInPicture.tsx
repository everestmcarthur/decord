...
// Dependencies: [32, 19, 17, 9558, 1074, 21, 4606, 1178, 9580, 1477, 7054, 9583, 4343, 5025, 9584, 9585, 6726, 1115, 2]

// Module 9579 (PictureInPicture)
...
const toggleFocus = fn(9558).toggleFocus;
