...
// Dependencies: [32, 19, 17, 9621, 1074, 21, 4640, 1177, 9643, 1478, 7095, 9646, 4376, 5061, 9647, 9648, 6766, 1364, 2]

// Module 9642 (PictureInPicture)
...
const toggleFocus = fn(9621).toggleFocus;
