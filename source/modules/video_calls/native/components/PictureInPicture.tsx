...
// Dependencies: [32, 19, 17, 9499, 1074, 21, 4574, 1178, 9521, 1477, 6995, 9524, 4310, 4988, 9525, 9526, 6669, 1115, 2]

// Module 9520 (PictureInPicture)
...
const toggleFocus = fn(9499).toggleFocus;
