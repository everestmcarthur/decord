...
// Dependencies: [32, 19, 17, 9560, 1074, 21, 4607, 1178, 9582, 1477, 7055, 9585, 4343, 5026, 9586, 9587, 6727, 1115, 2]

// Module 9581 (PictureInPicture)
...
const toggleFocus = fn(9560).toggleFocus;
