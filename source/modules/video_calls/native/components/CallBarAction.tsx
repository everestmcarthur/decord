...
// Function ID: 9652
// Name: CallBarAction
// Dependencies: [19, 17, 9621, 21, 4489, 576, 4640, 9652, 5210, 9653, 4636, 2]
// Exports: NotifiedActionButton, PrimaryActionButton, ToggledActionButton

// Module 9651 (CallBarAction)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4636 */;
import Pressables from "Pressables" /* 5210 */;
import CircleWithCutoutUtilsDefault from "CircleWithCutoutUtils" /* 9653 */;
...
const resetFocusTimer = fn(9621).resetFocusTimer;
const jsxProd = fn(21);
