...
// Function ID: 9641
// Name: CallBarAction
// Dependencies: [19, 17, 9610, 21, 4487, 576, 4638, 9641, 5208, 9642, 4634, 2]
// Exports: NotifiedActionButton, PrimaryActionButton, ToggledActionButton

// Module 9640 (CallBarAction)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4634 */;
import Pressables from "Pressables" /* 5208 */;
import CircleWithCutoutUtilsDefault from "CircleWithCutoutUtils" /* 9642 */;
...
const resetFocusTimer = fn(9610).resetFocusTimer;
const jsxProd = fn(21);
