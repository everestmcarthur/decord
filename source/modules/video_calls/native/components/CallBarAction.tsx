...
// Function ID: 9630
// Name: CallBarAction
// Dependencies: [19, 17, 9599, 21, 4489, 576, 4639, 9630, 5207, 9631, 4635, 2]
// Exports: NotifiedActionButton, PrimaryActionButton, ToggledActionButton

// Module 9629 (CallBarAction)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4635 */;
import Pressables from "Pressables" /* 5207 */;
import CircleWithCutoutUtilsDefault from "CircleWithCutoutUtils" /* 9631 */;
...
const resetFocusTimer = fn(9599).resetFocusTimer;
const jsxProd = fn(21);
