...
// Dependencies: [5, 32, 19, 17, 9903, 9706, 1074, 9822, 21, 4722, 1478, 9837, 4458, 9904, 10320, 9709, 4933, 4925, 9826, 1897, 1110, 10182, 12907, 4575, 9928, 1364, 4432, 4605, 7196, 2]
// Exports: default

// Module 9902 (ChannelCallNavigator)
...
function CallWithVoiceChat(channel) {
  ...
  if (tmp11[0]) {
    const obj9 = { channel };
    tmp18Result = tmp18(tmp2(10320), obj9);
  }
...
function MainCallScreen(channel) {
  ...
  if (isChannelContentGated) {
    ...
    if (channel.isGuildStageVoice()) {
      let obj7 = { channel };
      tmp14Result = tmp14(id(9904), obj7);
    }
  ...
  return tmp11(tmp22, { forceHide: isConnectedToVoiceChannel(1364).isAndroid() || !isConnectedToVoiceChannel, showWhenParticipantOnScreen: !isConnectedToVoiceChannel, children: tmp11(isConnectedToVoiceChannel(4432).ThemeContextProvider, { gradient: tmp21, children: tmp14Result2 }) });
}
