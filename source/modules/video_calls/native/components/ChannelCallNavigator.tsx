...
// Dependencies: [5, 32, 19, 17, 9809, 9622, 1074, 9728, 21, 4640, 1478, 9743, 4376, 9810, 10226, 9625, 4851, 4843, 9732, 1897, 1110, 10088, 12816, 4493, 9834, 1364, 4350, 4523, 7114, 2]
// Exports: default

// Module 9808 (ChannelCallNavigator)
...
function CallWithVoiceChat(channel) {
  ...
  if (tmp11[0]) {
    const obj9 = { channel };
    tmp18Result = tmp18(tmp2(10226), obj9);
  }
...
function MainCallScreen(channel) {
  ...
  if (isChannelContentGated) {
    ...
    if (channel.isGuildStageVoice()) {
      let obj7 = { channel };
      tmp14Result = tmp14(id(9810), obj7);
    }
