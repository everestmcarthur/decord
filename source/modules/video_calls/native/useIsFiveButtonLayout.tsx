...
// Dependencies: [1958, 1980, 504, 9614, 9644, 9646, 7381, 2]
// Exports: useIsFiveButtonLayout

// Module 9643 (useIsFiveButtonLayout)
...
export const useIsFiveButtonLayout = function useIsFiveButtonLayout(id) {
  ...
  const tmp6 = guild_id(9644);
  const tmp6Result = guild_id(9644)(guild_id1, id);
  ...
  const tmp5Result = guild_id(9646);
  const tmp5ResultResult = guild_id(9646)(id1);
