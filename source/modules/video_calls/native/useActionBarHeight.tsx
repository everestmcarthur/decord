...
// Dependencies: [1908, 1074, 7165, 9529, 9532, 9615, 504, 2]
// Exports: default

// Module 9528 (useActionBarHeight)
...
let closure_5 = fn(7165).ACTION_SHEET_HANDLE_SPACING;
let sum = 2 * fn(9529).SMALL_ACTION_BUTTON_DIMENSIONS.buttonRadius + 16 + 16;
