...
// Dependencies: [1908, 1074, 7225, 9590, 9593, 9676, 504, 2]
// Exports: default

// Module 9589 (useActionBarHeight)
...
let closure_5 = fn(7225).ACTION_SHEET_HANDLE_SPACING;
let sum = 2 * fn(9590).SMALL_ACTION_BUTTON_DIMENSIONS.buttonRadius + 16 + 16;
