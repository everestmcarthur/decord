...
// Dependencies: [1908, 1074, 7203, 9567, 9570, 9653, 504, 2]
// Exports: default

// Module 9566 (useActionBarHeight)
...
let closure_5 = fn(7203).ACTION_SHEET_HANDLE_SPACING;
let sum = 2 * fn(9567).SMALL_ACTION_BUTTON_DIMENSIONS.buttonRadius + 16 + 16;
