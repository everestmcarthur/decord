...
// Dependencies: [32, 19, 17, 21, 4640, 576, 1115, 13886, 13887, 4376, 4641, 13888, 13889, 13890, 13891, 5695, 5167, 4636, 2]
// Exports: default

// Module 13885 (NUFChannelIllustration)
...
export default function NUFChannelIllustration() {
  ...
  obj14.children = closure_7(first(4376).View, {
    style: animatedStyle,
