...
// Dependencies: [32, 19, 17, 21, 4605, 576, 1114, 13846, 13847, 4341, 4606, 13848, 13849, 13850, 13851, 5657, 5130, 4601, 2]
// Exports: default

// Module 13845 (NUFChannelIllustration)
...
export default function NUFChannelIllustration() {
  ...
  obj14.children = closure_7(first(4341).View, {
    style: animatedStyle,
