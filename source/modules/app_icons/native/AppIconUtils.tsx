...
// Function ID: 13391
// Name: AppIconUtils
// Dependencies: [32, 5, 19, 17, 9355, 1074, 1373, 3, 1115, 13391, 9356, 5006, 573, 1242, 4272, 1114, 7396, 1608, 2]
// Exports: isAppIconsSupported, navigateToAppIconSettings, setAppIcon, useAppIcons, useCurrentAppIcon

// Module 13390 (AppIconUtils)
...
const AppIconConstants = fn(9355);
...
if (PlatformUtils.isAndroid()) {
  let DCDIconManager = fn(13391).default;
} else {
