...
// Function ID: 13563
// Name: AppIconUtils
// Dependencies: [32, 5, 19, 17, 9477, 1074, 1374, 3, 1364, 13563, 9478, 5079, 573, 1241, 4338, 1115, 7496, 1609, 2]
// Exports: isAppIconsSupported, navigateToAppIconSettings, setAppIcon, useAppIcons, useCurrentAppIcon

// Module 13562 (AppIconUtils)
...
const AppIconConstants = fn(9477);
...
if (PlatformUtils.isAndroid()) {
  let DCDIconManager = fn(13563).default;
} else {
