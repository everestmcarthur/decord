...
// Dependencies: [32, 5, 19, 17, 9328, 1074, 1373, 3, 1115, 13368, 9329, 4992, 573, 1242, 4259, 1114, 7382, 1608, 2]
// Exports: isAppIconsSupported, navigateToAppIconSettings, setAppIcon, useAppIcons, useCurrentAppIcon

// Module 13367 (fetchCurrentAppIcon)
  ...
  const tmp = callback2((arg0, arg1) => {
    ...
    return (function*(arg0, arg1) {
      ...
      if (1 === tmp8) {
        ...
        obj2[1] = intl.string(callback(1114).t["c76eo/"]);
        obj1.open(obj2);
        const _HermesInternal = HermesInternal;
        ...
        callback2(573).dispatch({ type: "APP_ICON_UPDATED" });
        const obj8 = callback2(573);
        obj3 = { icon_id: null, user_premium_tier: null, icon_premium_tier: null };
        obj3[0] = callback;
        obj3[1] = callback2;
        let TIER_2 = null;
        if (callback !== callback(9329).FreemiumAppIconIds.DEFAULT) {
          TIER_2 = TIER_2.TIER_2;
        }
        obj3[2] = TIER_2;
        callback2(1242).track(constants.APP_ICON_UPDATED, obj3);
        c5 = 0;
        const obj9 = callback2(1242);
      }
      c5 = 0;
      return arg1;
    })();
...
function useCurrentAppIcon() {
  const tmp = callback(React.useState(_require(9329).FreemiumAppIconIds.DEFAULT), 2);
  _require = tmp[1];
  ...
  useMountLayoutEffectDefault(() => {
    callback();
    const subscription = callback(573).subscribe("APP_ICON_UPDATED", callback);
    return () => {
...
export const useAppIcons = function useAppIcons() {
  const currentAppIcon = callback(React.useState(_require(9329).FreemiumAppIconIds.DEFAULT), 2);
  ...
  useMountLayoutEffectDefault(() => {
    dependencyMap();
    const subscription = callback(573).subscribe("APP_ICON_UPDATED", dependencyMap);
    return () => {
