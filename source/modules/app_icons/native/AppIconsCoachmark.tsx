...
// Dependencies: [19, 17, 1372, 1955, 21, 4639, 576, 504, 4297, 4606, 7257, 17079, 1177, 10095, 4635, 1115, 5059, 13542, 2]
// Exports: default

// Module 17078 (AppIconsCoachmark)
...
import _modDef17079 from "module_17079" /* 17079 */;
...
export default function AppIconsCoachmarkActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_8(markAsDismissed(1177).Icon, { source: _modDef10095, size: markAsDismissed(1177).IconSizes.MEDIUM, style: tmp.nitroWheel, disableColor: true }), ];
