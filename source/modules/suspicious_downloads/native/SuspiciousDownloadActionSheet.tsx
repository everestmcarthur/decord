...
// Dependencies: [19, 21, 4638, 576, 1612, 7260, 5058, 5778, 4634, 1115, 5060, 4605, 4326, 2]
// Exports: default

// Module 13091 (SuspiciousDownloadActionSheet)
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [closure_3(href(5778).TrafficConeSpotIllustration, {}), , ];
  ...
  items1[1] = closure_3(href(4634).Text, obj4);
  ...
  items1[2] = closure_3(href(4634).Text, obj5);
  obj3.children = items1;
  const items2 = [closure_4(href(5058).Stack, obj3), ];
  ...
  const items3 = [closure_3(href(5060).Button, obj7), ];
  ...
  items3[1] = closure_3(href(5060).Button, obj8);
  obj6.children = items3;
  items2[1] = closure_4(href(5058).Stack, obj6);
  obj2.children = items2;
  obj.children = closure_4(href(5058).Stack, obj2);
  return closure_3(href(7260).BottomSheet, obj);
};
