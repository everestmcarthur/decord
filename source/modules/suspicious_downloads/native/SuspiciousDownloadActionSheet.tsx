...
// Dependencies: [19, 21, 4639, 576, 1612, 7257, 5057, 5777, 4635, 1115, 5059, 4606, 4328, 2]
// Exports: default

// Module 13083 (SuspiciousDownloadActionSheet)
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [closure_3(href(5777).TrafficConeSpotIllustration, {}), , ];
  ...
  items1[1] = closure_3(href(4635).Text, obj4);
  ...
  items1[2] = closure_3(href(4635).Text, obj5);
  obj3.children = items1;
  const items2 = [closure_4(href(5057).Stack, obj3), ];
  ...
  const items3 = [closure_3(href(5059).Button, obj7), ];
  ...
  items3[1] = closure_3(href(5059).Button, obj8);
  obj6.children = items3;
  items2[1] = closure_4(href(5057).Stack, obj6);
  obj2.children = items2;
  obj.children = closure_4(href(5057).Stack, obj2);
  return closure_3(href(7257).BottomSheet, obj);
};
