...
// Dependencies: [32, 19, 17, 1074, 21, 4606, 576, 1611, 13918, 13916, 5632, 1272, 12, 13919, 4602, 1114, 1178, 5484, 5026, 4809, 13920, 5628, 2]
// Exports: default
...
function RemoteAuthLogin(arg0) {
  ...
  const items = [closure_9(closure_6, { source: _modDef13919, style: tmp.mainImage }), , , ];
...
function RemoteAuthLoginSucceeded() {
  ...
  const items = [React7(timestampProducer, { source: _modDef13920, style: tmp.mainImage }), , , ];
...
export default function RemoteAuth(arg0) {
  const tmp = closure_12();
  const obj = { source: _modDef13918, imageStyle: null, style: null, children: null };
  ({ imageStyle: obj.imageStyle, background: obj.style } = tmp);
  const obj2 = { style: null, source: _modDef13916 };
