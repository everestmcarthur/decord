...
// Dependencies: [19, 4632, 1182, 1085, 21, 504, 4493, 7094, 14695, 4350, 10225, 4645, 2]
// Exports: RootThemeContextProvider

// Module 14694 (RootThemeContextProvider)
...
export const RootThemeContextProvider = function RootThemeContextProvider(children) {
  ...
  manaTypeConsolidationExperiment = manaTypeConsolidationExperiment(7094).useManaTypeConsolidationExperiment("RootThemeContextProvider");
  const obj2 = manaTypeConsolidationExperiment(7094);
  [][0] = manaTypeConsolidationExperiment;
  const plainTextExperiment = manaTypeConsolidationExperiment(14695).usePlainTextExperiment("RootThemeContextProvider");
  if (null == tmp4) {
    let num2 = 0;
    if (1 !== saturation) {
    ...
    if (1 === contrast) {
      ...
      obj4.children = jsx(tmp(4645).PlainTextExperimentProvider, { enabled: plainTextExperiment, children: children.children });
      return jsx(tmp(10225).RootThemeContextProvider, { theme: stateFromStoresObject.theme, flags: num2, saturation, contrast, enabledExperiments: tmp7, children: null });
    } else {
      if (contrast > 1) {
