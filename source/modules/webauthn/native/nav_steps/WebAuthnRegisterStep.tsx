...
// Dependencies: [32, 19, 17, 14755, 21, 4639, 576, 7054, 1115, 1177, 1484, 1364, 14772, 7230, 14773, 4635, 5518, 5059, 2]
// Exports: default

// Module 14771 (WebAuthnRegisterStep)
...
export default function WebAuthnRegisterStep() {
  ...
  if (tmp19Result) {
    ...
    tmp19Result = tmp19(tmp(4635).Text, obj6);
  }
