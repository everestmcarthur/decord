...
// Dependencies: [32, 19, 17, 14709, 14710, 21, 4606, 576, 504, 5743, 4602, 1114, 5484, 8172, 4564, 4573, 14722, 1896, 10339, 5738, 5656, 14723, 1483, 6668, 7022, 7450, 8684, 2]
// Exports: default

// Module 14721 (PasskeyInitStep)
...
function CredentialList(navigation) {
  ...
  if (0 === credentials.length) {
    ...
    const items1 = [closure_8(tmp(5743).PasskeysSpotIllustration, { scale: 0.6 }), ];
    ...
    items1[1] = closure_8(tmp(4602).Text, obj3);
    ...
    obj4.children = credentials.map((label) => {
      ...
      obj3.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14722, dependencyMap.paths), "WEBAUTHN_DELETE_SHEET_KEY", { credential, deleting, setDeleting });
      };
    ...
    return closure_8(tmp(5738).TableRowGroup, obj4);
  }
