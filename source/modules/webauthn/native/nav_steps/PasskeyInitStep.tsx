...
// Dependencies: [32, 19, 17, 14712, 14713, 21, 4607, 576, 504, 5744, 4603, 1114, 5485, 8173, 4565, 4574, 14725, 1896, 10341, 5739, 5657, 14726, 1483, 6669, 7023, 7451, 8686, 2]
// Exports: default

// Module 14724 (PasskeyInitStep)
...
function CredentialList(navigation) {
  ...
  if (0 === credentials.length) {
    ...
    const items1 = [closure_8(tmp(5744).PasskeysSpotIllustration, { scale: 0.6 }), ];
    ...
    items1[1] = closure_8(tmp(4603).Text, obj3);
    ...
    obj4.children = credentials.map((label) => {
      ...
      obj3.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14725, dependencyMap.paths), "WEBAUTHN_DELETE_SHEET_KEY", { credential, deleting, setDeleting });
      };
    ...
    return closure_8(tmp(5739).TableRowGroup, obj4);
  }
