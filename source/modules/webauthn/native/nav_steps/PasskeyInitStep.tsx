...
// Dependencies: [32, 19, 17, 14734, 14735, 21, 4605, 576, 504, 5742, 4601, 1114, 5483, 8150, 4563, 4572, 14747, 1896, 10320, 5737, 5655, 14749, 1483, 6647, 7001, 7429, 8663, 2]
// Exports: default
...
function CredentialList(navigation) {
  ...
  if (0 === credentials.length) {
    ...
    items1[1] = closure_8(tmp(4601).Text, obj3);
    ...
    obj4.children = credentials.map((label) => {
      ...
      obj3.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14747, dependencyMap.paths), "WEBAUTHN_DELETE_SHEET_KEY", { credential, deleting, setDeleting });
      };
    ...
    return closure_8(tmp(5737).TableRowGroup, obj4);
  }
