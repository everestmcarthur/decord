...
// Dependencies: [32, 19, 17, 14754, 14755, 21, 4639, 576, 504, 5777, 4635, 1115, 5518, 8205, 4597, 4606, 14767, 1897, 10381, 5772, 5690, 14768, 1484, 6702, 7056, 7484, 8719, 2]
// Exports: default

// Module 14766 (PasskeyInitStep)
  ...
  if (0 === credentials.length) {
    ...
    obj4.children = credentials.map((label) => {
      ...
      obj3.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14767, dependencyMap.paths), "WEBAUTHN_DELETE_SHEET_KEY", { credential, deleting, setDeleting });
      };
