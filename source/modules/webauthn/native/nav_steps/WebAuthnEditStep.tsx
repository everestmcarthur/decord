...
// Dependencies: [32, 19, 21, 4638, 576, 1484, 5710, 8728, 1115, 1177, 5060, 6705, 4336, 10793, 4597, 2]
// Exports: default

// Module 14786 (WebAuthnEditStep)
...
export default function EditCredentialModal(credential) {
  ...
  const items1 = [closure_5(credential(8728).FormInput, obj3), closure_5(credential(8728).FormDivider, {}), ];
  const obj4 = {
    onPress() {
      _undefined(true);
      closure_4(null);
  ...
  items1[2] = closure_5(credential(5060).Button, obj4);
  obj2.children = items1;
  return closure_6(credential(8728).Form, obj2);
};
