...
// Dependencies: [32, 19, 21, 4607, 576, 1483, 5676, 8686, 1114, 1178, 5027, 6669, 4305, 10743, 4567, 2]
// Exports: default

// Module 14728 (WebAuthnEditStep)
...
export default function EditCredentialModal(credential) {
  ...
  noop = undefined;
  const tmp = closure_7();
  const navigation = credential(1483).useNavigation();
  ...
  const items1 = [closure_5(credential(8686).FormInput, obj3), closure_5(credential(8686).FormDivider, {}), ];
  const obj4 = {
    onPress() {
      _undefined(true);
      closure_4(null);
  ...
  items1[2] = closure_5(credential(5027).Button, obj4);
  obj2.children = items1;
  return closure_6(credential(8686).Form, obj2);
};
