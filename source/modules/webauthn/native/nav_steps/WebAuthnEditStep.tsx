...
// Dependencies: [32, 19, 21, 4606, 576, 1483, 5675, 8684, 1114, 1178, 5026, 6668, 4305, 10741, 4566, 2]
// Exports: default

// Module 14725 (WebAuthnEditStep)
...
export default function EditCredentialModal(credential) {
  ...
  const items1 = [closure_5(credential(8684).FormInput, obj3), closure_5(credential(8684).FormDivider, {}), ];
  const obj4 = {
    onPress() {
      _undefined(true);
      closure_4(null);
  ...
  items1[2] = closure_5(credential(5026).Button, obj4);
  obj2.children = items1;
  return closure_6(credential(8684).Form, obj2);
};
