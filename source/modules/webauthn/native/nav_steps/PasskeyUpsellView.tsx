...
// Dependencies: [32, 19, 17, 14755, 1074, 1955, 21, 4639, 576, 1484, 1115, 14760, 14761, 5709, 2025, 7230, 14764, 4635, 1364, 5059, 7054, 2]
// Exports: default

// Module 14759 (PasskeyUpsellView)
...
import PasskeyUpsellManagerDefault from "PasskeyUpsellManager" /* 14760 */;
...
export default function PasskeyUpsellView() {
  ...
  const items1 = [closure_11(closure_6, { source: _modDef14764, style: tmp4.headerImage }), , ];
  ...
  items1[1] = closure_11(navigation(4635).Text, obj7);
  const obj8 = { variant: "heading-md/normal", color: "text-default", style: tmp4.headerText, children: null };
  const obj6 = { source: _modDef14764, style: tmp4.headerImage };
  ...
  items1[2] = closure_11(navigation(4635).Text, obj8);
  ...
  items3[1] = closure_11(navigation(4635).Text, obj13);
  ...
  items5[1] = closure_11(navigation(4635).Text, obj16);
  ...
  const items6 = [closure_11(navigation(4635).Text, obj18), , ];
  ...
  items6[1] = closure_11(navigation(5059).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = closure_11(navigation(5059).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj17.children = items6;
  items2[2] = closure_12(closure_5, obj17);
  obj4.children = items2;
  obj3.children = closure_12(tmp12, obj4);
  return closure_11(navigation(7230).SafeAreaPaddingView, obj3);
};
