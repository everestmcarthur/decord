...
// Dependencies: [32, 19, 17, 14873, 1074, 1955, 21, 4722, 576, 1484, 1115, 14878, 14879, 5794, 2025, 7319, 14882, 4718, 1364, 5144, 7143, 2]
// Exports: default

// Module 14877 (PasskeyUpsellView)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import HelpdeskUtilsDefault from "HelpdeskUtils" /* 2025 */;
import NavigatorHeader from "NavigatorHeader" /* 5794 */;
import NativeCeremoniesDefault from "NativeCeremonies" /* 7143 */;
import PasskeyUpsellManagerDefault from "PasskeyUpsellManager" /* 14878 */;
import _modDef14882 from "module_14882" /* 14882 */;
...
export default function PasskeyUpsellView() {
  ...
  const items1 = [closure_11(closure_6, { source: _modDef14882, style: tmp4.headerImage }), , ];
  ...
  items1[1] = closure_11(navigation(4718).Text, obj7);
  const obj8 = { variant: "heading-md/normal", color: "text-default", style: tmp4.headerText, children: null };
  const obj6 = { source: _modDef14882, style: tmp4.headerImage };
  ...
  items1[2] = closure_11(navigation(4718).Text, obj8);
  ...
  items3[1] = closure_11(navigation(4718).Text, obj13);
  ...
  items5[1] = closure_11(navigation(4718).Text, obj16);
  ...
  const items6 = [closure_11(navigation(4718).Text, obj18), , ];
  ...
  items6[1] = closure_11(navigation(5144).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = closure_11(navigation(5144).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj17.children = items6;
  items2[2] = closure_12(closure_5, obj17);
  obj4.children = items2;
  obj3.children = closure_12(tmp12, obj4);
  return closure_11(navigation(7319).SafeAreaPaddingView, obj3);
};
