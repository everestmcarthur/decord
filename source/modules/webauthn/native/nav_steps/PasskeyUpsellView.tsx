...
// Dependencies: [32, 19, 17, 14779, 1074, 1955, 21, 4640, 576, 1484, 1115, 14784, 14785, 5712, 2025, 7237, 14788, 4636, 1364, 5062, 7061, 2]
// Exports: default

// Module 14783 (PasskeyUpsellView)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import HelpdeskUtilsDefault from "HelpdeskUtils" /* 2025 */;
import NavigatorHeader from "NavigatorHeader" /* 5712 */;
import NativeCeremoniesDefault from "NativeCeremonies" /* 7061 */;
import PasskeyUpsellManagerDefault from "PasskeyUpsellManager" /* 14784 */;
import _modDef14788 from "module_14788" /* 14788 */;
...
export default function PasskeyUpsellView() {
  ...
  const items1 = [closure_11(closure_6, { source: _modDef14788, style: tmp4.headerImage }), , ];
  ...
  items1[1] = closure_11(navigation(4636).Text, obj7);
  const obj8 = { variant: "heading-md/normal", color: "text-default", style: tmp4.headerText, children: null };
  const obj6 = { source: _modDef14788, style: tmp4.headerImage };
  ...
  items1[2] = closure_11(navigation(4636).Text, obj8);
  ...
  items3[1] = closure_11(navigation(4636).Text, obj13);
  ...
  items5[1] = closure_11(navigation(4636).Text, obj16);
  ...
  const items6 = [closure_11(navigation(4636).Text, obj18), , ];
  ...
  items6[1] = closure_11(navigation(5062).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = closure_11(navigation(5062).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj17.children = items6;
  items2[2] = closure_12(closure_5, obj17);
  obj4.children = items2;
  obj3.children = closure_12(tmp12, obj4);
  return closure_11(navigation(7237).SafeAreaPaddingView, obj3);
};
