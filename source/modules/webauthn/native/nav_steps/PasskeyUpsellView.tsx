...
// Dependencies: [32, 19, 17, 14710, 1074, 1954, 21, 4606, 576, 1483, 1114, 14715, 14716, 5675, 2024, 7196, 14719, 4602, 1115, 5026, 7020, 2]
// Exports: default

// Module 14714 (PasskeyUpsellView)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import HelpdeskUtilsDefault from "HelpdeskUtils" /* 2024 */;
import NavigatorHeader from "NavigatorHeader" /* 5675 */;
import NativeCeremoniesDefault from "NativeCeremonies" /* 7020 */;
import PasskeyUpsellManagerDefault from "PasskeyUpsellManager" /* 14715 */;
import _modDef14719 from "module_14719" /* 14719 */;
...
export default function PasskeyUpsellView() {
  ...
  const items1 = [closure_11(closure_6, { source: _modDef14719, style: tmp4.headerImage }), , ];
  ...
  items1[1] = closure_11(navigation(4602).Text, obj7);
  const obj8 = { variant: "heading-md/normal", color: "text-default", style: tmp4.headerText, children: null };
  const obj6 = { source: _modDef14719, style: tmp4.headerImage };
  ...
  items1[2] = closure_11(navigation(4602).Text, obj8);
  ...
  items3[1] = closure_11(navigation(4602).Text, obj13);
  ...
  items5[1] = closure_11(navigation(4602).Text, obj16);
  ...
  const items6 = [closure_11(navigation(4602).Text, obj18), , ];
  ...
  items6[1] = closure_11(navigation(5026).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = closure_11(navigation(5026).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj17.children = items6;
  items2[2] = closure_12(closure_5, obj17);
  obj4.children = items2;
  obj3.children = closure_12(tmp12, obj4);
  return closure_11(navigation(7196).SafeAreaPaddingView, obj3);
};
