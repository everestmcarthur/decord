...
// Dependencies: [32, 19, 17, 14713, 1074, 1954, 21, 4607, 576, 1483, 1114, 14718, 14719, 5676, 2024, 7197, 14722, 4603, 1115, 5027, 7021, 2]
// Exports: default

// Module 14717 (PasskeyUpsellView)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import HelpdeskUtilsDefault from "HelpdeskUtils" /* 2024 */;
import NavigatorHeader from "NavigatorHeader" /* 5676 */;
import NativeCeremoniesDefault from "NativeCeremonies" /* 7021 */;
import PasskeyUpsellManagerDefault from "PasskeyUpsellManager" /* 14718 */;
...
export default function PasskeyUpsellView() {
  ...
  const items1 = [closure_11(closure_6, { source: _modDef14722, style: tmp4.headerImage }), , ];
  ...
  items1[1] = closure_11(navigation(4603).Text, obj7);
  const obj8 = { variant: "heading-md/normal", color: "text-default", style: tmp4.headerText, children: null };
  const obj6 = { source: _modDef14722, style: tmp4.headerImage };
  ...
  items1[2] = closure_11(navigation(4603).Text, obj8);
  ...
  items3[1] = closure_11(navigation(4603).Text, obj13);
  ...
  items5[1] = closure_11(navigation(4603).Text, obj16);
  ...
  const items6 = [closure_11(navigation(4603).Text, obj18), , ];
  ...
  items6[1] = closure_11(navigation(5027).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = closure_11(navigation(5027).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj17.children = items6;
  items2[2] = closure_12(closure_5, obj17);
  obj4.children = items2;
  obj3.children = closure_12(tmp12, obj4);
  return closure_11(navigation(7197).SafeAreaPaddingView, obj3);
};
