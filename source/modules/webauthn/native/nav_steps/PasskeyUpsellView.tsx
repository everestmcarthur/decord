...
// Dependencies: [32, 19, 17, 14771, 1074, 1955, 21, 4638, 576, 1484, 1115, 14776, 14777, 5710, 2025, 7233, 14780, 4634, 1364, 5060, 7057, 2]
// Exports: default

// Module 14775 (PasskeyUpsellView)
...
import PasskeyUpsellManagerDefault from "PasskeyUpsellManager" /* 14776 */;
...
export default function PasskeyUpsellView() {
  ...
  const items1 = [closure_11(closure_6, { source: _modDef14780, style: tmp4.headerImage }), , ];
  ...
  items1[1] = closure_11(navigation(4634).Text, obj7);
  const obj8 = { variant: "heading-md/normal", color: "text-default", style: tmp4.headerText, children: null };
  const obj6 = { source: _modDef14780, style: tmp4.headerImage };
  ...
  items1[2] = closure_11(navigation(4634).Text, obj8);
  ...
  items3[1] = closure_11(navigation(4634).Text, obj13);
  ...
  items5[1] = closure_11(navigation(4634).Text, obj16);
  ...
  const items6 = [closure_11(navigation(4634).Text, obj18), , ];
  ...
  items6[1] = closure_11(navigation(5060).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = closure_11(navigation(5060).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj17.children = items6;
  items2[2] = closure_12(closure_5, obj17);
  obj4.children = items2;
  obj3.children = closure_12(tmp12, obj4);
  return closure_11(navigation(7233).SafeAreaPaddingView, obj3);
};
