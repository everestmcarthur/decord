...
// Dependencies: [5, 3, 6792, 6789, 1115, 1364, 7144, 7145, 1609, 2]

// Module 7143 (NativeCeremonies)
...
obj.registerAndroidCredentialManagerPasskey = function registerAndroidCredentialManagerPasskey(setError) {
  setRegistering(6792).registerPasskey;
  setError = undefined;
...
obj.registerPasskey = function registerPasskey(setError) {
  ...
  const tmp2 = setRegistering(6792);
  if (isAndroidResult) {
    setError = undefined;
...
obj.registerSecurityKey = function registerSecurityKey(setError, fn) {
  let register = fn;
  if (fn === undefined) {
    register = setRegistering(6792).register;
  }
  setError = undefined;
  setError = setError.setError;
  setRegistering = setError.setRegistering;
