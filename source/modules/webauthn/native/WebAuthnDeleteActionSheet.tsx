...
// Dependencies: [19, 17, 21, 4639, 576, 4606, 7257, 7256, 1115, 7305, 4635, 5059, 6702, 4338, 10785, 4599, 9757, 8714, 2]
// Exports: default

// Module 14767 (WebAuthnDeleteActionSheet)
import nativeDefault from "native" /* 576 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4606 */;
import WebAuthnActionCreators from "WebAuthnActionCreators" /* 6702 */;
...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj2.trailing = closure_4(credential(7305).ActionSheetCloseButton, { onPress: handleClose });
  const items = [closure_4(credential(7256).BottomSheetTitleHeader, obj2), , , ];
  ...
  obj4.children = closure_4(credential(4635).Text, obj5);
  ...
  obj6.children = closure_4(credential(5059).Button, obj7);
  ...
  obj9.onPress = function onPress() {
    ...
    const nextPromise = result.then(() => {
      ...
      obj2.icon = closure_1_1(10785);
      obj2.IconComponent = credential(4599).CircleCheckIcon;
    ...
    result.then(() => {
      ...
      const obj = closure_1_1(4338);
      obj.open({ key: "WEBAUTHN_CREDENTIAL_DELETE_ERROR_TOAST_KEY", content: error.message, icon: closure_1_1(9757), IconComponent: credential(8714).WarningIcon, iconColor: "icon-feedback-critical" });
    }).finally(() => {
      closure_1_1(false);
    });
  };
  ...
  obj8.children = closure_4(credential(5059).Button, obj9);
  items[3] = closure_4(View, obj8);
  obj.children = items;
  return closure_5(credential(7257).BottomSheet, obj);
};
