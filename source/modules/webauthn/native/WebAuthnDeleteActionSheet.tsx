...
// Dependencies: [19, 17, 21, 4640, 576, 4607, 7264, 7263, 1115, 7312, 4636, 5062, 6707, 4338, 10801, 4599, 9776, 8743, 2]
// Exports: default

// Module 14791 (WebAuthnDeleteActionSheet)
...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj2.trailing = closure_4(credential(7312).ActionSheetCloseButton, { onPress: handleClose });
  const items = [closure_4(credential(7263).BottomSheetTitleHeader, obj2), , , ];
  ...
  obj4.children = closure_4(credential(4636).Text, obj5);
  ...
  obj6.children = closure_4(credential(5062).Button, obj7);
  ...
  obj9.onPress = function onPress() {
    ...
    result.then(() => {
      ...
      obj.open({ key: "WEBAUTHN_CREDENTIAL_DELETE_ERROR_TOAST_KEY", content: error.message, icon: closure_1_1(9776), IconComponent: credential(8743).WarningIcon, iconColor: "icon-feedback-critical" });
    }).finally(() => {
      closure_1_1(false);
    });
  };
  ...
  obj8.children = closure_4(credential(5062).Button, obj9);
  items[3] = closure_4(View, obj8);
  obj.children = items;
  return closure_5(credential(7264).BottomSheet, obj);
};
