...
// Dependencies: [19, 17, 21, 4722, 576, 4689, 7346, 7345, 1115, 7394, 4718, 5144, 6789, 4420, 10895, 4681, 9870, 8826, 2]
// Exports: default

// Module 14885 (WebAuthnDeleteActionSheet)
...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj2.trailing = closure_4(credential(7394).ActionSheetCloseButton, { onPress: handleClose });
  const items = [closure_4(credential(7345).BottomSheetTitleHeader, obj2), , , ];
  ...
  obj4.children = closure_4(credential(4718).Text, obj5);
  ...
  obj6.children = closure_4(credential(5144).Button, obj7);
  ...
  obj9.onPress = function onPress() {
    ...
    const nextPromise = result.then(() => {
      ...
      obj2.icon = closure_1_1(10895);
      obj2.IconComponent = credential(4681).CircleCheckIcon;
    ...
    result.then(() => {
      ...
      const obj = closure_1_1(4420);
      obj.open({ key: "WEBAUTHN_CREDENTIAL_DELETE_ERROR_TOAST_KEY", content: error.message, icon: closure_1_1(9870), IconComponent: credential(8826).WarningIcon, iconColor: "icon-feedback-critical" });
    }).finally(() => {
      closure_1_1(false);
    });
  };
  ...
  obj8.children = closure_4(credential(5144).Button, obj9);
  items[3] = closure_4(View, obj8);
  obj.children = items;
  return closure_5(credential(7346).BottomSheet, obj);
};
