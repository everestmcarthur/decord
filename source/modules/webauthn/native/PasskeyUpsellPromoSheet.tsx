...
// Dependencies: [32, 19, 17, 1955, 21, 14764, 14761, 10361, 1115, 1364, 14760, 5518, 5059, 7054, 2]
// Exports: default

// Module 14763 (PasskeyUpsellPromoSheet)
...
export default function PasswordlessUpsellPromoSheet() {
  ...
  let obj = { source: require("module_14764"), style: { height: 190, width: 220, resizeMode: "contain" } };
  const tmp4 = closure_7(Image, { source: require("module_14764"), style: { height: 190, width: 220, resizeMode: "contain" } });
