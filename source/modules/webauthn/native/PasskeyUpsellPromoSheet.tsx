...
// Dependencies: [32, 19, 17, 1954, 21, 14719, 14716, 10319, 1114, 1115, 14715, 5484, 5026, 7020, 2]
// Exports: default

// Module 14718 (PasskeyUpsellPromoSheet)
...
export default function PasswordlessUpsellPromoSheet() {
  ...
  let obj = { source: require("module_14719"), style: { height: 190, width: 220, resizeMode: "contain" } };
  const tmp4 = closure_7(Image, { source: require("module_14719"), style: { height: 190, width: 220, resizeMode: "contain" } });
