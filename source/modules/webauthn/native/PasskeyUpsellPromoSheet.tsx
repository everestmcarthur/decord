...
// Dependencies: [32, 19, 17, 1954, 21, 14722, 14719, 10321, 1114, 1115, 14718, 5485, 5027, 7021, 2]
// Exports: default

// Module 14721 (PasskeyUpsellPromoSheet)
...
export default function PasswordlessUpsellPromoSheet() {
  ...
  let obj = { source: require("module_14722"), style: { height: 190, width: 220, resizeMode: "contain" } };
  const tmp4 = closure_7(Image, { source: require("module_14722"), style: { height: 190, width: 220, resizeMode: "contain" } });
