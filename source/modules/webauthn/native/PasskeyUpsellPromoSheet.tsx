...
// Dependencies: [32, 19, 17, 1955, 21, 14780, 14777, 10369, 1115, 1364, 14776, 5519, 5060, 7057, 2]
// Exports: default

// Module 14779 (PasskeyUpsellPromoSheet)
...
export default function PasswordlessUpsellPromoSheet() {
  ...
  let obj = { source: require("module_14780"), style: { height: 190, width: 220, resizeMode: "contain" } };
  const tmp4 = closure_7(Image, { source: require("module_14780"), style: { height: 190, width: 220, resizeMode: "contain" } });
