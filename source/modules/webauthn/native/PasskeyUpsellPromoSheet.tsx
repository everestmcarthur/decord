...
// Dependencies: [32, 19, 17, 1954, 21, 14753, 14750, 10358, 1114, 1150, 14749, 5514, 5056, 7050, 2]
// Exports: default

// Module 14752 (PasskeyUpsellPromoSheet)
...
export default function PasswordlessUpsellPromoSheet() {
  ...
  let obj = { source: require("module_14753"), style: { height: 190, width: 220, resizeMode: "contain" } };
  const tmp4 = closure_7(Image, { source: require("module_14753"), style: { height: 190, width: 220, resizeMode: "contain" } });
