...
// Dependencies: [32, 19, 17, 1954, 21, 14744, 14741, 10300, 1114, 1115, 14740, 5483, 5025, 6999, 2]
// Exports: default
...
export default function PasswordlessUpsellPromoSheet() {
  ...
  const tmp4 = closure_7(Image, { source: require("module_14744"), style: { height: 190, width: 220, resizeMode: "contain" } });
