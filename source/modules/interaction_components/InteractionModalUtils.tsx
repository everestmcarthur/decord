...
// Dependencies: [5, 32, 19, 502, 1958, 4979, 2022, 4459, 4978, 14513, 8242, 1074, 8241, 1895, 1397, 9655, 7364, 504, 5684, 11, 573, 9450, 1115, 38, 4863, 7956, 8246, 5214, 1271, 1091, 2]
// Exports: useIframeModalState, useIsFirstTextInputInModal, useModalState

// Module 17600 (InteractionModalUtils)
...
import InteractionModalStore from "InteractionModalStore" /* 14513 */;
...
export const useIsFirstTextInputInModal = function useIsFirstTextInputInModal(id) {
  ...
  let tmp6 = type === tmp(1895).ComponentType.ACTION_ROW && first.components[0].id === id;
  if (!tmp6) {
    let type1;
    if (first != null) {
      type1 = first.type;
    }
    tmp6 = type1 === tmp(1895).ComponentType.LABEL && first.component.id === id;
    const tmp8 = type1 === tmp(1895).ComponentType.LABEL && first.component.id === id;
  }
  return tmp6;
};
