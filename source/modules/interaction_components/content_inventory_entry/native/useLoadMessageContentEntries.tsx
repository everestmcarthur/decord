...
// Dependencies: [32, 5, 19, 4802, 1920, 9060, 8207, 7177, 8158, 38, 8165, 1894, 8155, 7316, 2]
// Exports: default
...
const promiseDeduper3 = new fn(9060).PromiseDeduper();
const promiseDeduper4 = new fn(9060).PromiseDeduper();
const size = fn(2);
