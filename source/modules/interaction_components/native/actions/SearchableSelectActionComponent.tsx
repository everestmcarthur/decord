...
// Dependencies: [19, 1958, 21, 4863, 8241, 38, 8249, 1895, 15832, 8251, 4605, 11970, 1897, 11966, 2]
// Exports: default
    ...
    if (type1 !== tmp(tmp2[7]).ComponentType.ROLE_SELECT) {
      ...
      obj5.onTap = function onTap() {
        if (defaultValues.type === Server.ComponentType.CHANNEL_SELECT) {
          ...
          obj3.openLazy(tmp2(1897)(11970, tmp3.paths), combined, obj2);
          const tmp14 = tmp2(1897)(11970, tmp3.paths);
        } else {
          ...
          obj.openLazy(tmp2(1897)(11966, tmp3.paths), combined1, obj4);
          const tmp5 = tmp2(1897)(11966, tmp3.paths);
        }
      };
