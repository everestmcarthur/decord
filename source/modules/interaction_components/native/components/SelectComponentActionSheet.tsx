...
// Dependencies: [19, 17, 1958, 2012, 7258, 21, 4639, 576, 7256, 1115, 5059, 9887, 4358, 5690, 5702, 9571, 7088, 4351, 1612, 1478, 5767, 504, 4606, 7257, 6732, 2]
// Exports: default

// Module 11957 (SelectComponentActionSheet)
...
function SelectionHeader(renderIcon) {
  ...
  if (selectionActionComponent.maxValues > 1) {
    ...
    tmp5Result = tmp5(tmp6(5059).Button, obj3);
  }
  ...
  if (null != onQueryChange) {
    ...
    if (null != memo) {
      ...
      tmp5Result4 = tmp5(selectedOptions(9887), obj4);
...
function SelectionOptionItem(item) {
  ...
  if (clearable) {
    ...
    let tmp6Result2 = tmp6(tmp2(5702).FormCheckbox, obj5);
  } else {
    tmp6Result2 = null;
    if (true === selected) {
      tmp6Result2 = tmp6(tmp2(9571).CheckmarkSmallBoldIcon, { color: "text-brand" });
    }
  }
