...
// Dependencies: [19, 17, 1957, 2011, 7224, 21, 4606, 576, 7222, 1114, 5026, 9846, 4325, 5656, 5668, 9530, 7054, 4318, 1611, 1477, 5733, 504, 4573, 7223, 6698, 2]
// Exports: default
...
function SelectionHeader(renderIcon) {
  ...
  if (selectionActionComponent.maxValues > 1) {
    ...
    tmp5Result = tmp5(tmp6(5026).Button, obj3);
  }
  ...
  if (null != onQueryChange) {
    ...
    if (null != memo) {
      ...
      tmp5Result4 = tmp5(selectedOptions(9846), obj4);
...
function SelectionOptionItem(item) {
  ...
  if (clearable) {
    ...
    let tmp6Result2 = tmp6(tmp2(5668).FormCheckbox, obj5);
  } else {
    tmp6Result2 = null;
    if (true === selected) {
      tmp6Result2 = tmp6(tmp2(9530).CheckmarkSmallBoldIcon, { color: "text-brand" });
    }
  }
