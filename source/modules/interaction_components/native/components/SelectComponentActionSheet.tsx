...
// Dependencies: [19, 17, 1958, 2012, 7261, 21, 4638, 576, 7259, 1115, 5060, 9895, 4356, 5691, 5703, 9582, 7091, 4349, 1612, 1478, 5768, 504, 4605, 7260, 6735, 2]
// Exports: default

// Module 11965 (SelectComponentActionSheet)
...
function SelectionHeader(renderIcon) {
  ...
  if (selectionActionComponent.maxValues > 1) {
    ...
    tmp5Result = tmp5(tmp6(5060).Button, obj3);
  }
  obj.trailing = tmp5Result;
  const children = [closure_8(renderIcon(7259).BottomSheetTitleHeader, obj), ];
  ...
  if (null != onQueryChange) {
    ...
    if (null != memo) {
      ...
      tmp5Result4 = tmp5(selectedOptions(9895), obj4);
      const tmp13 = selectedOptions(9895);
    }
  }
...
function SelectionOptionItem(item) {
  ...
  if (clearable) {
    ...
    let tmp6Result2 = tmp6(tmp2(5703).FormCheckbox, obj5);
  } else {
    tmp6Result2 = null;
    if (true === selected) {
      tmp6Result2 = tmp6(tmp2(9582).CheckmarkSmallBoldIcon, { color: "text-brand" });
    }
  }
...
let closure_7 = fn(7261).ACTION_SHEET_START_HEIGHT_RATIO;
const jsxProd = fn(21);
