...
export default function InteractionIframeModal(children) {
  ...
  let tmp11 = null;
  if (!tmp5[0]) {
    obj = { onActivityCrash: null, applicationId: null, channelId: null, guildId: null, activityUrl: null, activitySessionId: null, queryParams: null, onLoadError: null, allowPopups: null, referrerPolicy: "origin", isPipOrGridMode: false, webViewKey: "PX_16", ignoreSilentHardwareSwitch: "ansikt" };
