...
// Dependencies: [32, 19, 17, 1349, 21, 4638, 576, 17600, 7091, 8462, 17613, 5055, 4336, 1115, 9782, 9790, 5208, 4590, 4634, 9581, 2]
// Exports: default

// Module 17612 (InteractionIframeModal)
...
export default function InteractionIframeModal(children) {
  ...
  if (!tmp5[0]) {
    const obj3 = {
      ...
      webViewKey: "PX_16",
      ignoreSilentHardwareSwitch: "dierenriem"
    };
