...
// Dependencies: [32, 19, 4714, 1958, 2012, 8341, 21, 8342, 38, 4712, 8093, 504, 1936, 8503, 15948, 11856, 11826, 2]
// Exports: default

// Module 15947 (TextDisplayComponent)
...
require = fn;
let closure_8 = fn(8341).TEXT_DISPLAY_COMPONENT_MARKDOWN_RENDER_OPTIONS;
const jsx = fn(21).jsx;
const size = fn(2);
