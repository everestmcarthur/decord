...
// Dependencies: [32, 19, 4632, 1958, 2012, 8259, 21, 8260, 38, 4630, 8010, 504, 1936, 8420, 15853, 11766, 11736, 2]
// Exports: default

// Module 15852 (TextDisplayComponent)
...
require = fn;
let closure_8 = fn(8259).TEXT_DISPLAY_COMPONENT_MARKDOWN_RENDER_OPTIONS;
const jsx = fn(21).jsx;
const size = fn(2);
