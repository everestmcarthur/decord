...
// Dependencies: [32, 19, 4566, 1957, 2011, 8137, 21, 8138, 38, 4564, 7902, 504, 1935, 8299, 15749, 11647, 11617, 2]
// Exports: default

// Module 15748 (TextDisplayComponent)
...
require = fn;
let closure_8 = fn(8137).TEXT_DISPLAY_COMPONENT_MARKDOWN_RENDER_OPTIONS;
const jsx = fn(21).jsx;
const size = fn(2);
