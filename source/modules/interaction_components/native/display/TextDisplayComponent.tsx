...
// Dependencies: [32, 19, 4630, 1958, 2012, 8240, 21, 8241, 38, 4628, 8004, 504, 1936, 8401, 15836, 11758, 11728, 2]
// Exports: default

// Module 15835 (TextDisplayComponent)
...
require = fn;
let closure_8 = fn(8240).TEXT_DISPLAY_COMPONENT_MARKDOWN_RENDER_OPTIONS;
const jsx = fn(21).jsx;
const size = fn(2);
