...
// Dependencies: [32, 19, 4631, 1958, 2012, 8231, 21, 8232, 38, 4629, 7995, 504, 1936, 8392, 15818, 11750, 11720, 2]
// Exports: default

// Module 15817 (TextDisplayComponent)
...
require = fn;
let closure_8 = fn(8231).TEXT_DISPLAY_COMPONENT_MARKDOWN_RENDER_OPTIONS;
const jsx = fn(21).jsx;
const size = fn(2);
