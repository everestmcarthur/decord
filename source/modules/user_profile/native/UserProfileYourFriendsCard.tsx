...
// Dependencies: [32, 19, 17, 7673, 4222, 1371, 1074, 21, 1178, 4574, 576, 504, 13093, 9880, 12, 1369, 5137, 1114, 4570, 7223, 2]
// Exports: default

// Module 16846 (UserProfileYourFriendsCard)
...
export default function UserProfileYourFriendsCard(arg0) {
  ...
  const effect = stateFromStoresArray1.useEffect(() => {
    const userAffinitiesV2 = closure_0(9880).fetchUserAffinitiesV2();
  }, []);
