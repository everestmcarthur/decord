...
// Dependencies: [19, 17, 7260, 7203, 21, 8304, 8253, 4757, 4449, 8305, 8293, 8306, 1611, 8290, 8301, 7241, 4302, 8307, 4341, 8319, 11224, 1114, 11279, 2]

// Module 8303 (NonUserBotProfileContent)
...
import useProfileThemeDefault from "useProfileTheme" /* 8290 */;
import useUserProfileBannerHeightDefault from "useUserProfileBannerHeight" /* 8293 */;
import UserProfileSharedStylesDefault from "UserProfileSharedStyles" /* 8304 */;
import useBadgesDefault from "useBadges" /* 8305 */;
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 8306 */;
...
export default noop.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  trackUserProfileAction = trackUserProfileAction(8253).useUserProfileAnalyticsContext().trackUserProfileAction;
  let obj = trackUserProfileAction(8253);
  let guild_id;
  if (channel != null) {
  ...
  const userProfileColors = trackUserProfileAction(8301).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null == user) {
    ...
    const items = [closure_7(tmp(8307), obj3), ];
    ...
    const items1 = [closure_7(tmp4(8319).OpenableUserProfileAvatar, obj5), ];
    ...
    obj8.children = closure_7(tmp(11224), obj9);
    ...
    items4[1] = obj13;
    obj12.style = items4;
    obj11.children = closure_7(tmp(11279), obj12);
    items3[1] = closure_7(View, obj11);
    obj6.children = items3;
    items1[1] = closure_8(View, obj6);
    obj4.children = items1;
    items[1] = closure_8(tmp(4341).View, obj4);
    obj10.children = items;
    return closure_8(closure_9, obj10);
  }
  const tmp4Result = trackUserProfileAction(8301);
});
