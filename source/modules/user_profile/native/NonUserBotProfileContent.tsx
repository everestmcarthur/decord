...
// Dependencies: [19, 17, 7315, 7258, 21, 8360, 8310, 4791, 4484, 8361, 8349, 8362, 1612, 8346, 8357, 7296, 4337, 8363, 4376, 8375, 11291, 1115, 11345, 2]

// Module 8359 (NonUserBotProfileContent)
...
import useProfileThemeDefault from "useProfileTheme" /* 8346 */;
import useUserProfileBannerHeightDefault from "useUserProfileBannerHeight" /* 8349 */;
import UserProfileSharedStylesDefault from "UserProfileSharedStyles" /* 8360 */;
import useBadgesDefault from "useBadges" /* 8361 */;
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 8362 */;
...
export default noop.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  trackUserProfileAction = trackUserProfileAction(8310).useUserProfileAnalyticsContext().trackUserProfileAction;
  ...
  const userProfileColors = trackUserProfileAction(8357).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null == user) {
    ...
    const items = [closure_7(tmp(8363), obj3), ];
    ...
    const items1 = [closure_7(tmp4(8375).OpenableUserProfileAvatar, obj5), ];
    ...
    obj8.children = closure_7(tmp(11291), obj9);
    ...
    items4[1] = obj13;
    obj12.style = items4;
    obj11.children = closure_7(tmp(11345), obj12);
  ...
  const tmp4Result = trackUserProfileAction(8357);
});
