...
// Dependencies: [19, 17, 7318, 7261, 21, 8369, 8319, 4790, 4482, 8370, 8358, 8371, 1612, 8355, 8366, 7299, 4335, 8372, 4374, 8384, 11305, 1115, 11353, 2]

// Module 8368 (NonUserBotProfileContent)
...
import useProfileThemeDefault from "useProfileTheme" /* 8355 */;
import useUserProfileBannerHeightDefault from "useUserProfileBannerHeight" /* 8358 */;
import UserProfileSharedStylesDefault from "UserProfileSharedStyles" /* 8369 */;
import useBadgesDefault from "useBadges" /* 8370 */;
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 8371 */;
...
export default noop.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  trackUserProfileAction = trackUserProfileAction(8319).useUserProfileAnalyticsContext().trackUserProfileAction;
  let obj = trackUserProfileAction(8319);
  let guild_id;
  if (channel != null) {
  ...
  const userProfileColors = trackUserProfileAction(8366).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null == user) {
    ...
    const items = [closure_7(tmp(8372), obj3), ];
    ...
    const items1 = [closure_7(tmp4(8384).OpenableUserProfileAvatar, obj5), ];
    ...
    obj8.children = closure_7(tmp(11305), obj9);
    ...
    items4[1] = obj13;
    obj12.style = items4;
    obj11.children = closure_7(tmp(11353), obj12);
    items3[1] = closure_7(View, obj11);
    obj6.children = items3;
    items1[1] = closure_8(View, obj6);
    obj4.children = items1;
    items[1] = closure_8(tmp(4374).View, obj4);
    obj10.children = items;
    return closure_8(closure_9, obj10);
  }
  const tmp4Result = trackUserProfileAction(8366);
});
