...
// Dependencies: [19, 17, 7282, 7225, 21, 8327, 8276, 4759, 4451, 8328, 8316, 8329, 1611, 8313, 8324, 7263, 4304, 8330, 4343, 8342, 11249, 1114, 11303, 2]

// Module 8326 (NonUserBotProfileContent)
...
import useProfileThemeDefault from "useProfileTheme" /* 8313 */;
import useUserProfileBannerHeightDefault from "useUserProfileBannerHeight" /* 8316 */;
import UserProfileSharedStylesDefault from "UserProfileSharedStyles" /* 8327 */;
import useBadgesDefault from "useBadges" /* 8328 */;
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 8329 */;
...
export default noop.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  trackUserProfileAction = trackUserProfileAction(8276).useUserProfileAnalyticsContext().trackUserProfileAction;
  let obj = trackUserProfileAction(8276);
  let guild_id;
  if (channel != null) {
  ...
  const userProfileColors = trackUserProfileAction(8324).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null == user) {
    ...
    const items = [closure_7(tmp(8330), obj3), ];
    ...
    const items1 = [closure_7(tmp4(8342).OpenableUserProfileAvatar, obj5), ];
    ...
    obj8.children = closure_7(tmp(11249), obj9);
    ...
    items4[1] = obj13;
    obj12.style = items4;
    obj11.children = closure_7(tmp(11303), obj12);
    items3[1] = closure_7(View, obj11);
    obj6.children = items3;
    items1[1] = closure_8(View, obj6);
    obj4.children = items1;
    items[1] = closure_8(tmp(4343).View, obj4);
    obj10.children = items;
    return closure_8(closure_9, obj10);
  }
  const tmp4Result = trackUserProfileAction(8324);
});
