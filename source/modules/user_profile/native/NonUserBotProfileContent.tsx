...
// Dependencies: [19, 17, 7281, 7224, 21, 8325, 8275, 4758, 4451, 8326, 8314, 8327, 1611, 8311, 8322, 7262, 4304, 8328, 4343, 8340, 11247, 1114, 11301, 2]

// Module 8324 (NonUserBotProfileContent)
...
import useProfileThemeDefault from "useProfileTheme" /* 8311 */;
import useUserProfileBannerHeightDefault from "useUserProfileBannerHeight" /* 8314 */;
import UserProfileSharedStylesDefault from "UserProfileSharedStyles" /* 8325 */;
import useBadgesDefault from "useBadges" /* 8326 */;
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 8327 */;
...
export default noop.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  trackUserProfileAction = trackUserProfileAction(8275).useUserProfileAnalyticsContext().trackUserProfileAction;
  ...
  if (null == user) {
    ...
    const items = [closure_7(tmp(8328), obj3), ];
    ...
    const items1 = [closure_7(tmp4(8340).OpenableUserProfileAvatar, obj5), ];
    ...
    obj8.children = closure_7(tmp(11247), obj9);
    ...
    items4[1] = obj13;
    obj12.style = items4;
    obj11.children = closure_7(tmp(11301), obj12);
