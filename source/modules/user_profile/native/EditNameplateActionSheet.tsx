...
// Dependencies: [32, 19, 17, 7572, 1887, 2021, 1074, 21, 4574, 576, 8196, 7176, 7196, 1242, 8190, 8197, 7164, 4570, 1114, 8198, 10766, 504, 14666, 8192, 14667, 13201, 13202, 8199, 8851, 5001, 11252, 2]
// Exports: default

// Module 14665 (EditNameplateActionSheet)
...
import EditNameplateSection from "EditNameplateSection" /* 14667 */;
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp4 = purchase(8199)(previewSkuId);
  ...
  const items1 = [closure_10(tmp10(8851).NameplateDummyUserPreview, { width: 100 }), closure_10(tmp10(8851).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj4.colors = items2;
  items1[2] = closure_10(purchase(5001), obj4);
  obj3.children = items1;
  const items3 = [closure_11(View, obj3), closure_10(tmp10(11252).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj5 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [closure_10(tmp10(8851).NameplateDummyUserPreview, { width: 140 }), closure_10(tmp10(8851).NameplateDummyUserPreview, { width: 100 }), ];
  const obj6 = { style: tmp.nameplatePreviewGradient, start: { x: 0, y: 0.2 }, end: { x: 0, y: 0.9 }, colors: null };
  const tmp2Result = purchase(5001);
  const items5 = ["" + tmp.nameplatePreviewGradient.color + "00", tmp.nameplatePreviewGradient.color];
  obj6.colors = items5;
  items4[2] = closure_10(purchase(5001), obj6);
...
export default function EditNameplateActionSheet(arg0) {
  ...
  let obj = guildId(8196);
  const tmp7 = first;
  const analyticsLocations = first(7176)(first(7196).EDIT_NAMEPLATE_SHEET).analyticsLocations;
  const items = [first, guildId];
  const callback = obj2.useCallback(() => {
    const obj = first(1242);
    obj.track(constants.OPEN_POPOUT, { type: first(7196).EDIT_NAMEPLATE_SHEET, is_fullscreen: true });
  }, []);
  ...
  items1[1] = closure_10(guildId(4570).Text, obj7);
  ...
  obj8.analyticsSource = tmp7(7196).EDIT_NAMEPLATE_SHEET;
  items2[1] = closure_10(first(8198), obj8);
  obj4.children = items2;
  obj3.children = tmp12(guildId(7164).BottomSheet, obj4);
  return closure_10(guildId(7176).AnalyticsLocationProvider, obj3);
};
