...
// Dependencies: [32, 19, 17, 7630, 1887, 2021, 1074, 21, 4606, 576, 8255, 7235, 7255, 1242, 8249, 8256, 7223, 4602, 1114, 8257, 10823, 504, 14690, 8251, 14691, 13271, 13272, 8258, 8909, 5038, 11314, 2]
// Exports: default

// Module 14689 (EditNameplateActionSheet)
...
import EditNameplateSection from "EditNameplateSection" /* 14691 */;
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp4 = purchase(8258)(previewSkuId);
  ...
  const items1 = [closure_10(tmp10(8909).NameplateDummyUserPreview, { width: 100 }), closure_10(tmp10(8909).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj4.colors = items2;
  items1[2] = closure_10(purchase(5038), obj4);
  obj3.children = items1;
  const items3 = [closure_11(View, obj3), closure_10(tmp10(11314).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj5 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [closure_10(tmp10(8909).NameplateDummyUserPreview, { width: 140 }), closure_10(tmp10(8909).NameplateDummyUserPreview, { width: 100 }), ];
  const obj6 = { style: tmp.nameplatePreviewGradient, start: { x: 0, y: 0.2 }, end: { x: 0, y: 0.9 }, colors: null };
  const tmp2Result = purchase(5038);
  const items5 = ["" + tmp.nameplatePreviewGradient.color + "00", tmp.nameplatePreviewGradient.color];
  obj6.colors = items5;
  items4[2] = closure_10(purchase(5038), obj6);
...
export default function EditNameplateActionSheet(arg0) {
  ...
  let obj = guildId(8255);
  const tmp7 = first;
  const analyticsLocations = first(7235)(first(7255).EDIT_NAMEPLATE_SHEET).analyticsLocations;
  const items = [first, guildId];
  const callback = obj2.useCallback(() => {
    const obj = first(1242);
    obj.track(constants.OPEN_POPOUT, { type: first(7255).EDIT_NAMEPLATE_SHEET, is_fullscreen: true });
  }, []);
  ...
  obj7.children = intl.string(guildId(1114).t.BwdeM1);
  items1[1] = closure_10(guildId(4602).Text, obj7);
  ...
  obj8.analyticsSource = tmp7(7255).EDIT_NAMEPLATE_SHEET;
  items2[1] = closure_10(first(8257), obj8);
  obj4.children = items2;
  obj3.children = tmp12(guildId(7223).BottomSheet, obj4);
  return closure_10(guildId(7235).AnalyticsLocationProvider, obj3);
};
