...
// Dependencies: [32, 19, 17, 7664, 1888, 2022, 1074, 21, 4639, 576, 8290, 7269, 7289, 1241, 8284, 8291, 7257, 4635, 1115, 8292, 10867, 504, 14735, 8286, 14736, 13310, 13311, 8293, 8947, 5071, 11358, 2]
// Exports: default

// Module 14734 (EditNameplateActionSheet)
...
import EditNameplateSection from "EditNameplateSection" /* 14736 */;
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp4 = purchase(8293)(previewSkuId);
  ...
  const items1 = [closure_10(tmp10(8947).NameplateDummyUserPreview, { width: 100 }), closure_10(tmp10(8947).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj4.colors = items2;
  items1[2] = closure_10(purchase(5071), obj4);
  obj3.children = items1;
  const items3 = [closure_11(View, obj3), closure_10(tmp10(11358).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj5 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [closure_10(tmp10(8947).NameplateDummyUserPreview, { width: 140 }), closure_10(tmp10(8947).NameplateDummyUserPreview, { width: 100 }), ];
  const obj6 = { style: tmp.nameplatePreviewGradient, start: { x: 0, y: 0.2 }, end: { x: 0, y: 0.9 }, colors: null };
  const tmp2Result = purchase(5071);
  const items5 = ["" + tmp.nameplatePreviewGradient.color + "00", tmp.nameplatePreviewGradient.color];
  obj6.colors = items5;
  items4[2] = closure_10(purchase(5071), obj6);
...
export default function EditNameplateActionSheet(arg0) {
  ...
  const tmp7 = first;
  const analyticsLocations = first(7269)(first(7289).EDIT_NAMEPLATE_SHEET).analyticsLocations;
  const items = [first, guildId];
  const callback = obj2.useCallback(() => {
    const obj = first(1241);
    obj.track(constants.OPEN_POPOUT, { type: first(7289).EDIT_NAMEPLATE_SHEET, is_fullscreen: true });
  }, []);
  ...
  items1[1] = closure_10(guildId(4635).Text, obj7);
  ...
  obj8.analyticsSource = tmp7(7289).EDIT_NAMEPLATE_SHEET;
  items2[1] = closure_10(first(8292), obj8);
  obj4.children = items2;
  obj3.children = tmp12(guildId(7257).BottomSheet, obj4);
  return closure_10(guildId(7269).AnalyticsLocationProvider, obj3);
};
