...
// Dependencies: [32, 19, 17, 7667, 1888, 2022, 1074, 21, 4638, 576, 8299, 7272, 7292, 1241, 8293, 8300, 7260, 4634, 1115, 8301, 10875, 504, 14751, 8295, 14752, 13321, 13322, 8302, 8958, 5072, 11366, 2]
// Exports: default

// Module 14750 (EditNameplateActionSheet)
...
import EditNameplateSection from "EditNameplateSection" /* 14752 */;
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp4 = purchase(8302)(previewSkuId);
  ...
  const items1 = [closure_10(tmp10(8958).NameplateDummyUserPreview, { width: 100 }), closure_10(tmp10(8958).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj4.colors = items2;
  items1[2] = closure_10(purchase(5072), obj4);
  obj3.children = items1;
  const items3 = [closure_11(View, obj3), closure_10(tmp10(11366).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj5 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [closure_10(tmp10(8958).NameplateDummyUserPreview, { width: 140 }), closure_10(tmp10(8958).NameplateDummyUserPreview, { width: 100 }), ];
  const obj6 = { style: tmp.nameplatePreviewGradient, start: { x: 0, y: 0.2 }, end: { x: 0, y: 0.9 }, colors: null };
  const tmp2Result = purchase(5072);
  const items5 = ["" + tmp.nameplatePreviewGradient.color + "00", tmp.nameplatePreviewGradient.color];
  obj6.colors = items5;
  items4[2] = closure_10(purchase(5072), obj6);
...
export default function EditNameplateActionSheet(arg0) {
  ...
  let obj = guildId(8299);
  const tmp7 = first;
  const analyticsLocations = first(7272)(first(7292).EDIT_NAMEPLATE_SHEET).analyticsLocations;
  const items = [first, guildId];
  const callback = obj2.useCallback(() => {
    const obj = first(1241);
    obj.track(constants.OPEN_POPOUT, { type: first(7292).EDIT_NAMEPLATE_SHEET, is_fullscreen: true });
  }, []);
  ...
  items1[1] = closure_10(guildId(4634).Text, obj7);
  ...
  obj8.analyticsSource = tmp7(7292).EDIT_NAMEPLATE_SHEET;
  items2[1] = closure_10(first(8301), obj8);
  obj4.children = items2;
  obj3.children = tmp12(guildId(7260).BottomSheet, obj4);
  return closure_10(guildId(7272).AnalyticsLocationProvider, obj3);
};
