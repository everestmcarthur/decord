...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp4 = purchase(8290)(previewSkuId);
  ...
  const items1 = [closure_10(tmp10(8944).NameplateDummyUserPreview, { width: 100 }), closure_10(tmp10(8944).NameplateDummyUserPreview, { width: 140 }), ];
...
export default function EditNameplateActionSheet(arg0) {
  ...
  items1[1] = closure_10(guildId(4632).Text, obj7);
  ...
  obj8.analyticsSource = tmp7(7285).EDIT_NAMEPLATE_SHEET;
  items2[1] = closure_10(first(8289), obj8);
  obj4.children = items2;
  obj3.children = tmp12(guildId(7253).BottomSheet, obj4);
  return closure_10(guildId(7265).AnalyticsLocationProvider, obj3);
};
