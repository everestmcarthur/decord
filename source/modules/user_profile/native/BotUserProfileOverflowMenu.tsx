...
// Dependencies: [19, 1957, 4285, 2011, 1371, 1074, 11515, 21, 504, 13119, 13120, 8307, 7265, 7285, 8296, 1114, 9171, 4603, 11517, 1896, 1250, 8522, 11516, 13121, 13121, 1150, 12749, 1242, 7292, 4481, 4334, 8981, 9418, 12261, 1935, 13122, 4373, 8789, 8202, 8795, 576, 2]
// Exports: default
...
export default function BotUserProfileOverflowMenu(application) {
  ...
  if (isIgnored) {
    ...
    if (!tmp14) {
      ...
      obj7.action = function action() {
        ...
        obj2.openLazy(asyncRequireImpl(11516, dependencyMap.paths), closure_2_12, obj3, "stack");
      };
      items3.push(obj7);
      if (result) {
        ...
        obj8.action = function action() {
          ...
          obj2.openLazy(asyncRequireImpl(13121, dependencyMap.paths), BotReportChooser.BOT_REPORT_CHOOSER_KEY, obj3, "replaceAll");
        };
        items3.push(obj8);
      } else {
  ...
  if (relationshipType !== guildId.BLOCKED) {
    ...
    obj17.action = function action() {
      ...
      const obj2 = ActionSheetActionCreatorsDefault;
      const tmp2 = asyncRequireImpl(11517, dependencyMap.paths);
