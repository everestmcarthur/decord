...
// Dependencies: [19, 1958, 4288, 2012, 1372, 1074, 11536, 21, 504, 13144, 13145, 8338, 7276, 7296, 8327, 1115, 9196, 4607, 11538, 1897, 1249, 8553, 11537, 13146, 13146, 1364, 12771, 1241, 7303, 4484, 4337, 9011, 9443, 12283, 1936, 13147, 4376, 8052, 8057, 8059, 576, 2]
// Exports: default

// Module 13143 (BotUserProfileOverflowMenu)
...
import BotReportChooser from "BotReportChooser" /* 13146 */;
    ...
    if (!tmp14) {
      ...
      if (result) {
        ...
        obj8.action = function action() {
          ...
          obj2.openLazy(asyncRequireImpl(13146, dependencyMap.paths), BotReportChooser.BOT_REPORT_CHOOSER_KEY, obj3, "replaceAll");
        };
        items3.push(obj8);
      } else {
