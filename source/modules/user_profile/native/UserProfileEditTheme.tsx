...
// Dependencies: [19, 17, 21, 4636, 576, 1091, 7307, 5204, 1114, 10378, 4632, 8303, 8343, 8249, 4755, 4457, 1943, 14682, 4603, 14711, 1896, 8795, 2]
// Exports: default

// Module 14710 (UserProfileEditTheme)
...
export default function UserProfileEditTheme(pendingThemeColors) {
  ...
  const tmp = closure_6();
  let tmp4 = f98122(primaryColor[11])(user.id, guildId);
  f98122 = tmp4;
  const tmp5 = f98122(primaryColor[12])({ user, displayProfile: tmp4, pendingThemeColors: pendingThemeColors.pendingThemeColors, isPreview: flag });
  primaryColor = tmp5.primaryColor;
  secondaryColor = tmp5.secondaryColor;
  if (pendingAvatarSrc == null) {
    pendingAvatarSrc = user.getAvatarURL(guildId, 80);
  }
  suggestedColors = secondaryColor(primaryColor[13]).useAvatarColors(pendingAvatarSrc, f98122(tmp3[4]).unsafe_rawColors.PRIMARY_530, false);
    ...
    if (null != secondaryColor) {
      ...
      if (showResetMenu) {
        ...
        obj5.onPress = function onPress() {
          ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14711, dependencyMap.paths), "Profile Theme", {
            onResetTheme() {
      ...
      f98122 = (arg0) => {
        if (arg0 !== primaryColor) {
          ...
          let themeColors;
          if (f98122 != null) {
            themeColors = f98122.themeColors;
          }
          let tmp8;
      ...
      obj8.onPress = () => {
        ...
        closure_1(primaryColor[17])({ color: secondaryColor, onSelect: f98122, suggestedColors });
      };
