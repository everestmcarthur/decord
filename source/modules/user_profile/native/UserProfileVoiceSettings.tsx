...
// Dependencies: [19, 17, 5096, 1909, 4278, 1074, 1085, 21, 4639, 8310, 504, 4786, 9302, 10117, 9221, 7314, 1115, 9259, 10136, 13180, 12663, 13182, 10240, 6715, 4635, 12755, 9344, 8719, 4606, 9286, 9282, 2]
// Exports: default

// Module 13179 (UserProfileVoiceSettings)
...
function CurrentUserVoiceSettings(channel) {
  ...
  if (stateFromStores1) {
    ...
    tmp9Result = tmp9(tmp2(7314).UserProfileCardRows, obj6);
