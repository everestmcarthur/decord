...
// Dependencies: [8339, 4607, 4497, 1895, 2]
// Exports: default

// Module 13147 (openUserContextMenuCommands)
...
export default function openUserContextMenuCommands(analyticsLocations) {
  ...
  const result = analyticsLocations(8339).trackUserProfileAction({ action: "PRESS_VIEW_APP_COMMANDS", analyticsLocations });
  const obj = analyticsLocations(8339);
