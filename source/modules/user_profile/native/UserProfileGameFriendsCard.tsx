...
// Dependencies: [19, 21, 4606, 7241, 1114, 12721, 7280, 4602, 2]
// Exports: default

// Module 13178 (UserProfileGameFriendsCard)
...
export default function UserProfileGameFriendsCard(arg0) {
  ...
  if (0 === found.length) {
    ...
    obj4.children = jsx(tmp6(4602).Text, { variant: "text-md/normal", color: "text-default", children: formatResult });
