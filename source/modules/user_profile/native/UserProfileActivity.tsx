...
// Dependencies: [32, 19, 17, 4788, 4582, 1957, 1979, 4199, 4600, 5279, 4579, 7621, 7208, 1074, 21, 4560, 576, 1115, 4556, 8370, 13003, 4271, 10896, 1114, 11753, 5587, 1396, 8344, 8568, 4411, 10891, 7739, 13008, 13018, 7162, 7182, 13024, 8680, 8691, 13025, 504, 5123, 7207, 1178, 13011, 13026, 13028, 13006, 13036, 13007, 13039, 8259, 13041, 10022, 4615, 7726, 9987, 13042, 5411, 4702, 4527, 9991, 13029, 4713, 13043, 10899, 9775, 4763, 4767, 7342, 9513, 13044, 13046, 13047, 2]
// Exports: default

// Module 13002 (ActivityCardText)
...
import closure_13 from "sortActivity" /* 4600 */;
import closure_14 from "filterPlayingActivities" /* 5279 */;
import closure_15 from "updateVoiceState" /* 4579 */;
import closure_16 from "createUserWidgetFromServer" /* 7621 */;
import { CARD_PADDING } from "ARBITRARY_LARGE_OFFSET" /* 7208 */;
...
function ActivityCard(user) {
  ...
  let tmp2Result = tmp2(8680);
  obj = { location: "User Profile Activity Card", applicationId: application_id, source: user(8691).GameProfileSources.UserProfile, trackEntryPointImpression: true, sourceUserId: user.id };
  ...
  if (activity.type !== constants.CUSTOM_STATUS) {
    ...
    if (activity.type !== tmp14.HANG_STATUS) {
      ...
      obj2[3] = intl.formatToPlainString(ConnectPlatformButton(1114).t["9sZWVp"], obj3);
      ...
      if (tmp34Result) {
        ...
        obj5[2] = ConnectPlatformButton(1178).IconSizes.SMALL_14;
        tmp34Result = tmp34(ConnectPlatformButton(1178).Icon, obj5);
      }
      obj4[3] = tmp34Result;
      ...
      if (tmp2(13011)(activity)) {
        ...
        obj7[0] = start;
        obj7[1] = end;
        tmp34Result = tmp34(tmp2(13026), obj7);
      }
      ...
      if (null != voiceChannel) {
        ...
        if (null != stateFromStores) {
          ...
          tmp34Result1 = tmp34(tmp2(13028), obj8);
        }
      }
      ...
      if (tmp2(13006)(activity)) {
        ...
        obj9[1] = tmp5Result;
        tmp34Result2 = tmp34(ConnectPlatformButton(13036).ConnectPlatformButton, obj9);
      } else {
        tmp34Result2 = null;
        if (user.id !== currentUser.id) {
          if (tmp2(10896)(activity)) {
            ...
            obj10[0] = activity;
            obj10[1] = tmp5Result;
            tmp34Result2 = tmp34(ConnectPlatformButton(13036).PlayOnSpotifyButton, obj10);
            ...
            obj11[4] = tmp5Result;
            tmp34Result2 = tmp34(ConnectPlatformButton(13036).JoinActivityButton, obj11);
          } else {
              ...
              if (set.has(currentActivityGamePlatform)) {
                if (null != activity.party) {
                  ...
                  if (null != deepLinkUri) {
                    ...
                    obj12[4] = tmp5Result;
                    tmp34Result2 = tmp34(ConnectPlatformButton(13036).JoinGameActivityButton, obj12);
                  }
                }
              }
            }
            if (tmp2(8259)(activity)) {
              const obj13 = { activity: null, onAction: null };
              obj13[0] = activity;
              obj13[1] = tmp5Result;
              let tmp34Result3 = tmp34(ConnectPlatformButton(13036).WatchActivityButton, obj13);
            } else {
              tmp34Result3 = null;
              if (null != activity.buttons) {
                ...
                if (activity.buttons.length > 0) {
                  ...
                  obj14[1] = buttons.map((arg0, index) => closure_1_21(user(13036).CustomActivityButton, { index, user, activity, onAction: dependencyMap }, index));
      ...
      obj2[4] = obj4;
      obj2 = tmp34(ConnectPlatformButton(5123).PressableOpacity, obj2);
      obj1[1] = obj2;
...
function StreamActivityCard(user) {
  ...
  obj4 = { mode: "a", stream: "<string:264830979>", disabled: "<string:264962051>", onPress: "<string:4179492867>" };
  obj4[1] = stream;
  ...
  if (tmp19Result) {
    ...
    obj5[2] = intl3.string(tmp2(tmp3[23]).t.pEAl4b);
...
function VoiceCallActivityCard(arg0) {
  ...
  const tmp11 = stateFromStores(13024)(obj);
  closure_3 = tmp11;
  obj = { userId: user.id, onAction: tmp11 };
  stateFromStores(13025)(obj);
  ...
  if (!channel.isDM()) {
    ...
    obj3[1] = id;
    const items3 = [closure_21(tmp2(13043), obj3), ];
    ...
    if (stateFromStores1) {
      ...
      obj6[0] = channel;
      obj5[1] = tmp2(9775)(obj6);
      const intl3 = tmp6(1114).intl;
      obj5[2] = intl3.string(tmp6(1114).t["9C444m"]);
      obj5[3] = function onPress() {
        callback({ action: "OPEN_VOICE_CHANNEL" });
        stateFromStores(_undefined[60]).hideAllActionSheets();
      ...
      obj9[0] = channel;
      obj8[1] = tmp18(tmp2(10899), obj9);
      const items4 = [tmp18(tmp17, obj8), tmp5];
      obj7[2] = items4;
      obj5[4] = tmp13(tmp6(4556).Text, obj7);
      let tmp13Result = tmp18(tmp6(5123).PressableOpacity, obj5);
    } else {
      ...
      obj12[0] = channel;
      obj11[1] = tmp18(tmp2(10899), obj12);
      const items5 = [tmp18(tmp17, obj11), tmp5];
      obj10[2] = items5;
      tmp13Result = tmp13(tmp6(4556).Text, obj10);
    }
    ...
    if (null != stateFromStores) {
      ...
      obj13[1] = intl4.string(tmp6(1114).t.KLOhbO);
      const intl5 = tmp6(1114).intl;
      const obj14 = { guildName: null };
      obj14[0] = stateFromStores.name;
      obj13[2] = intl5.formatToPlainString(tmp6(1114).t["hq/Qze"], obj14);
      ...
      obj15[1] = intl6.format(tmp6(1114).t["hq/Qze"], obj16);
      obj13[4] = tmp18(tmp6(4556).Text, obj15);
      tmp18Result = tmp18(tmp6(5123).PressableOpacity, obj13);
    }
    ...
    obj17[1] = isInChannel;
    obj17[2] = tmp11;
    items7[1] = closure_21(tmp6(13036).VoiceChannelButtons, obj17);
    obj1[3] = items7;
