...
// Dependencies: [32, 19, 17, 502, 1074, 21, 4607, 576, 8752, 8753, 4603, 1114, 1935, 8754, 4317, 5639, 5039, 8341, 504, 7281, 8755, 8756, 2]
// Exports: default

// Module 8751 (UserProfilePersonalWidgetCard)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import native from "native" /* 4317 */;
import FastImageDefault from "FastImage" /* 5639 */;
import GifTagDefault from "GifTag" /* 8341 */;
import PersonalWidgetExpandCollapseContext from "PersonalWidgetExpandCollapseContext" /* 8752 */;
import PersonalWidgetMarkupUtils from "PersonalWidgetMarkupUtils" /* 8753 */;
import WidgetAssetUtils from "WidgetAssetUtils" /* 8754 */;
...
function PersonalWidgetShowMoreButton() {
  ...
  t = tmp5(tmp(4603).Text, { variant: "text-sm/medium", color: "text-subtle", children: intl.string(isExpanded ? t["6MwJo/"] : t.lBeKY2) });
  obj2.children = t;
  ...
  if (null != source) {
    ...
    if (null != source) {
      if ("" !== section.title) {
        ...
        tmp24Result4 = tmp24(tmp14(5039), obj9);
      } else {
        tmp24Result4 = null;
      }
    }
    ...
    if (showGifTag) {
      ...
      tmp24Result5 = tmp24(tmp14(8341), obj10);
    }
...
function UserProfilePersonalWidgetCardContent(style) {
  ...
  obj2.titleLeadingIcon = closure_10(userId(8755).NitroWheelIcon, { size: "xs", color: "icon-subtle" });
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(8756), obj3);
  }
  ...
  return closure_10(disableInteraction(7281), obj2);
}
