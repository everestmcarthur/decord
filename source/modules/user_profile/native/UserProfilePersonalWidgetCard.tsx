...
// Dependencies: [32, 19, 17, 502, 1074, 21, 4638, 576, 8794, 8795, 4634, 1115, 1936, 8796, 4348, 5673, 5072, 8383, 504, 7317, 8797, 8798, 2]
// Exports: default

// Module 8793 (UserProfilePersonalWidgetCard)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 4348 */;
import FastImageDefault from "FastImage" /* 5673 */;
import GifTagDefault from "GifTag" /* 8383 */;
import PersonalWidgetExpandCollapseContext from "PersonalWidgetExpandCollapseContext" /* 8794 */;
import PersonalWidgetMarkupUtils from "PersonalWidgetMarkupUtils" /* 8795 */;
import WidgetAssetUtils from "WidgetAssetUtils" /* 8796 */;
...
function PersonalWidgetShowMoreButton() {
  ...
  t = tmp5(tmp(4634).Text, { variant: "text-sm/medium", color: "text-subtle", children: intl.string(isExpanded ? t["6MwJo/"] : t.lBeKY2) });
  obj2.children = t;
  ...
  if (null != source) {
    ...
    if (null != source) {
      if ("" !== section.title) {
        ...
        tmp24Result4 = tmp24(tmp14(5072), obj9);
      } else {
        tmp24Result4 = null;
      }
    }
    ...
    if (showGifTag) {
      ...
      tmp24Result5 = tmp24(tmp14(8383), obj10);
    }
...
function UserProfilePersonalWidgetCardContent(style) {
  ...
  obj2.titleLeadingIcon = closure_10(userId(8797).NitroWheelIcon, { size: "xs", color: "icon-subtle" });
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(8798), obj3);
  }
  ...
  return closure_10(disableInteraction(7317), obj2);
}
