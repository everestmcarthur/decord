...
// Dependencies: [32, 19, 17, 502, 1074, 21, 4606, 576, 8750, 8751, 4602, 1114, 1935, 8752, 4317, 5638, 5038, 8339, 504, 7280, 8753, 8754, 2]
// Exports: default

// Module 8749 (UserProfilePersonalWidgetCard)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import native from "native" /* 4317 */;
import FastImageDefault from "FastImage" /* 5638 */;
import GifTagDefault from "GifTag" /* 8339 */;
import PersonalWidgetExpandCollapseContext from "PersonalWidgetExpandCollapseContext" /* 8750 */;
import PersonalWidgetMarkupUtils from "PersonalWidgetMarkupUtils" /* 8751 */;
import WidgetAssetUtils from "WidgetAssetUtils" /* 8752 */;
...
function PersonalWidgetShowMoreButton() {
  ...
  t = tmp5(tmp(4602).Text, { variant: "text-sm/medium", color: "text-subtle", children: intl.string(isExpanded ? t["6MwJo/"] : t.lBeKY2) });
  obj2.children = t;
  ...
  if (null != source) {
    ...
    if (null != source) {
      if ("" !== section.title) {
        ...
        tmp24Result4 = tmp24(tmp14(5038), obj9);
      } else {
        tmp24Result4 = null;
      }
    }
    ...
    if (showGifTag) {
      ...
      tmp24Result5 = tmp24(tmp14(8339), obj10);
    }
...
function UserProfilePersonalWidgetCardContent(style) {
  ...
  obj2.titleLeadingIcon = closure_10(userId(8753).NitroWheelIcon, { size: "xs", color: "icon-subtle" });
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(8754), obj3);
  }
  ...
  return closure_10(disableInteraction(7280), obj2);
}
