...
// Dependencies: [32, 19, 17, 502, 1074, 21, 4639, 576, 8785, 8786, 4635, 1115, 1936, 8787, 4350, 5672, 5071, 8374, 504, 7314, 8788, 8789, 2]
// Exports: default

// Module 8784 (UserProfilePersonalWidgetCard)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 4350 */;
import FastImageDefault from "FastImage" /* 5672 */;
import GifTagDefault from "GifTag" /* 8374 */;
import PersonalWidgetExpandCollapseContext from "PersonalWidgetExpandCollapseContext" /* 8785 */;
import PersonalWidgetMarkupUtils from "PersonalWidgetMarkupUtils" /* 8786 */;
import WidgetAssetUtils from "WidgetAssetUtils" /* 8787 */;
...
function PersonalWidgetShowMoreButton() {
  ...
  t = tmp5(tmp(4635).Text, { variant: "text-sm/medium", color: "text-subtle", children: intl.string(isExpanded ? t["6MwJo/"] : t.lBeKY2) });
  obj2.children = t;
  ...
  if (null != source) {
    ...
    if (null != source) {
      if ("" !== section.title) {
        ...
        tmp24Result4 = tmp24(tmp14(5071), obj9);
      } else {
        tmp24Result4 = null;
      }
    }
    ...
    if (showGifTag) {
      ...
      tmp24Result5 = tmp24(tmp14(8374), obj10);
    }
...
function UserProfilePersonalWidgetCardContent(style) {
  ...
  obj2.titleLeadingIcon = closure_10(userId(8788).NitroWheelIcon, { size: "xs", color: "icon-subtle" });
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(8789), obj3);
  }
  ...
  return closure_10(disableInteraction(7314), obj2);
}
