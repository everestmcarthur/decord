...
// Dependencies: [32, 19, 17, 4632, 8933, 8934, 1372, 7735, 8331, 7265, 21, 4640, 576, 4376, 4641, 504, 1612, 7276, 7296, 13248, 13249, 13229, 8939, 8339, 11312, 1115, 6738, 5775, 7314, 7187, 11194, 8057, 4597, 2]
// Exports: default

// Module 13251 (EditWishlistActionSheet)
import nativeDefault from "native" /* 576 */;
import timing from "timing" /* 4641 */;
import UserProfileAnalyticsUtils from "UserProfileAnalyticsUtils" /* 8339 */;
import WishlistActionCreatorsDefault from "WishlistActionCreators" /* 8939 */;
import WishlistVisibility2 from "WishlistVisibility" /* 13249 */;
...
const getWishlistProductLines = fn(8934).getWishlistProductLines;
let closure_12 = fn(8331).TrackUserProfileWishlistActions;
...
exitingAnimation.__closure = { withTiming: fn(4641).withTiming };
...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7276)(analyticsLocations1, tmp4(7296).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  const obj2 = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(7276);
  ({ cardWidth: c5, rowWidth } = analyticsContext(13248)({ maxWidth: ACTION_SHEET_MAX_WIDTH }));
  if (null != rowWidth) {
    let obj3 = { width: rowWidth };
    let tmp7 = obj3;
  }
  let tmp6 = analyticsContext(13248)({ maxWidth: ACTION_SHEET_MAX_WIDTH });
  const items1 = [value];
  ...
  obj9.children = closure_14(wishlistId(7314).TableSwitchRow, obj10);
  obj8.children = closure_14(wishlistId(5775).TableRowGroup, obj9);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = tmp16(tmp2(6738).BottomSheetScrollView, obj5);
