...
// Dependencies: [32, 19, 17, 4714, 9017, 9018, 1372, 7817, 8413, 7347, 21, 4722, 576, 4458, 4723, 504, 1612, 7358, 7378, 13339, 13340, 13320, 9023, 8421, 11404, 1115, 6820, 5857, 7396, 7269, 11287, 8140, 4679, 2]
// Exports: default

// Module 13342 (EditWishlistActionSheet)
import nativeDefault from "native" /* 576 */;
import timing from "timing" /* 4723 */;
import UserProfileAnalyticsUtils from "UserProfileAnalyticsUtils" /* 8421 */;
import WishlistActionCreatorsDefault from "WishlistActionCreators" /* 9023 */;
import WishlistVisibility2 from "WishlistVisibility" /* 13340 */;
...
const getWishlistProductLines = fn(9018).getWishlistProductLines;
let closure_12 = fn(8413).TrackUserProfileWishlistActions;
...
exitingAnimation.__closure = { withTiming: fn(4723).withTiming };
...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7358)(analyticsLocations1, tmp4(7378).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  const obj2 = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(7358);
  ({ cardWidth: c5, rowWidth } = analyticsContext(13339)({ maxWidth: ACTION_SHEET_MAX_WIDTH }));
  if (null != rowWidth) {
    let obj3 = { width: rowWidth };
    let tmp7 = obj3;
  }
  let tmp6 = analyticsContext(13339)({ maxWidth: ACTION_SHEET_MAX_WIDTH });
  const items1 = [value];
  ...
  obj9.children = closure_14(wishlistId(7396).TableSwitchRow, obj10);
  obj8.children = closure_14(wishlistId(5857).TableRowGroup, obj9);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = tmp16(tmp2(6820).BottomSheetScrollView, obj5);
