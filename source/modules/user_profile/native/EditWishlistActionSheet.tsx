...
// Dependencies: [32, 19, 17, 4597, 8847, 8848, 1371, 7672, 8246, 7203, 21, 4605, 576, 4341, 4606, 504, 1611, 7214, 7234, 13163, 13164, 13144, 8853, 8254, 11223, 1114, 6677, 5737, 7252, 7125, 11105, 8150, 4563, 2]
// Exports: default
...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7214)(analyticsLocations1, tmp4(7234).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  const obj2 = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(7214);
  ({ cardWidth: c5, rowWidth } = analyticsContext(13163)({ maxWidth: ACTION_SHEET_MAX_WIDTH }));
  if (null != rowWidth) {
    let obj3 = { width: rowWidth };
    let tmp7 = obj3;
  }
  let tmp6 = analyticsContext(13163)({ maxWidth: ACTION_SHEET_MAX_WIDTH });
  const items1 = [value];
  ...
  obj9.children = closure_14(wishlistId(7252).TableSwitchRow, obj10);
  obj8.children = closure_14(wishlistId(5737).TableRowGroup, obj9);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = tmp16(tmp2(6677).BottomSheetScrollView, obj5);
