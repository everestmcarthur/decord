...
// Dependencies: [32, 19, 17, 4599, 8870, 8871, 1371, 7694, 8269, 7225, 21, 4607, 576, 4343, 4608, 504, 1611, 7236, 7256, 13188, 13189, 13169, 8876, 8277, 11248, 1114, 6699, 5739, 7274, 7147, 11130, 8173, 4565, 2]
// Exports: default

// Module 13191 (EditWishlistActionSheet)
import nativeDefault from "native" /* 576 */;
import timing from "timing" /* 4608 */;
import UserProfileAnalyticsUtils from "UserProfileAnalyticsUtils" /* 8277 */;
import WishlistActionCreatorsDefault from "WishlistActionCreators" /* 8876 */;
import WishlistVisibility2 from "WishlistVisibility" /* 13189 */;
...
const getWishlistProductLines = fn(8871).getWishlistProductLines;
let closure_12 = fn(8269).TrackUserProfileWishlistActions;
...
exitingAnimation.__closure = { withTiming: fn(4608).withTiming };
...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7236)(analyticsLocations1, tmp4(7256).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  const obj2 = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(7236);
  ({ cardWidth: c5, rowWidth } = analyticsContext(13188)({ maxWidth: ACTION_SHEET_MAX_WIDTH }));
  if (null != rowWidth) {
    let obj3 = { width: rowWidth };
    let tmp7 = obj3;
  }
  let tmp6 = analyticsContext(13188)({ maxWidth: ACTION_SHEET_MAX_WIDTH });
  const items1 = [value];
  ...
  obj4.title = intl.string(wishlistId(1114).t["OEgx/4"]);
  let obj5 = { contentContainerStyle: { paddingBottom: analyticsContext(1611)().bottom }, children: null };
  ...
  obj10.label = intl2.string(wishlistId(1114).t.b2nFyA);
  const intl3 = tmp2(1114).intl;
  obj10.subLabel = intl3.string(wishlistId(1114).t.dw58pE);
  obj10.value = value;
  obj10.onValueChange = callback;
  obj9.children = closure_14(wishlistId(7274).TableSwitchRow, obj10);
  obj8.children = closure_14(wishlistId(5739).TableRowGroup, obj9);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = tmp16(tmp2(6699).BottomSheetScrollView, obj5);
