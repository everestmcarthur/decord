...
// Dependencies: [5, 32, 19, 17, 4288, 1372, 21, 4640, 576, 11084, 504, 1115, 4843, 9196, 5666, 5081, 4636, 6724, 4484, 2]
// Exports: default

// Module 13273 (AddFriendNicknameModal)
...
export default function AddFriendNicknameModal(arg0) {
  ...
  _slicedToArray = showUserProfile(11084)();
  ...
  const tmp3Result = showUserProfile(5666);
  ...
  const tmp3Result3 = showUserProfile(5081);
