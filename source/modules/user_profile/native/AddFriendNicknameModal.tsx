...
// Dependencies: [5, 32, 19, 17, 4371, 1372, 21, 4722, 576, 11177, 504, 1115, 4925, 9280, 5748, 5163, 4718, 6806, 4566, 2]
// Exports: default

// Module 13364 (AddFriendNicknameModal)
...
export default function AddFriendNicknameModal(arg0) {
  ...
  _slicedToArray = showUserProfile(11177)();
  ...
  const tmp3Result = showUserProfile(5748);
  ...
  const tmp3Result3 = showUserProfile(5163);
  obj8.placeholder = showUserProfile(4566).getName(stateFromStores1);
