...
// Dependencies: [5, 32, 19, 17, 4255, 1371, 21, 4606, 576, 11019, 504, 1114, 4809, 9132, 5629, 5045, 4602, 6684, 4451, 2]
// Exports: default

// Module 13215 (AddFriendNicknameModal)
...
export default function AddFriendNicknameModal(arg0) {
  ...
  _slicedToArray = showUserProfile(11019)();
  ...
  const tmp3Result = showUserProfile(5629);
  ...
  const tmp3Result3 = showUserProfile(5045);
  obj8.placeholder = showUserProfile(4451).getName(stateFromStores1);
