...
// Dependencies: [19, 17, 2022, 7315, 1085, 21, 4639, 576, 504, 8286, 14733, 4606, 14734, 1897, 14716, 1115, 8948, 1177, 13308, 2]
// Exports: default

// Module 14732 (UserProfileNameplateEditButton)
...
export default function UserProfileNameplateEditButton(user) {
  ...
  const fetchNameplate = user(14733).useFetchNameplate(skuId);
  ...
  if (isFetching) {
    ...
    return jsx(tmp3(14716).UserProfileEditFormButton, { label: null, buttonText: null, onPress: null, leading: null, loading: true, disabled: true, hideArrow: true });
  } else {
    let name;
    ...
    if (null != nameplateData) {
      if (null != nameplateRecord) {
        if (null != nameplateProduct) {
          ...
          obj8.children = tmp15(guildId(8948), obj9);
          let tmp15Result = tmp15(closure_5, obj8);
        }
        obj6.leading = tmp15Result;
        return tmp15(tmp3(14716).UserProfileEditFormButton, obj6);
      }
    }
    const obj10 = { source: guildId(13308), style: tmp.noneIcon };
