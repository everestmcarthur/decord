...
// Dependencies: [19, 4278, 1085, 21, 504, 7987, 5146, 5180, 5181, 5183, 5182, 5185, 2]
// Exports: default

// Module 11027 (UserProfileVoiceActivityIcon)
...
export default function UserProfileVoiceActivityIcon(channel) {
    ...
    if (!channel.isGroupDM()) {
      ...
      if (isGuildStageVoiceResult) {
        if (tmp6) {
          ...
          let tmp8Result = jsx(tmp2(5180).StageLockIcon, {});
        }
        return tmp8Result;
      }
      if (isGuildStageVoiceResult) {
        ...
        tmp8Result = jsx(tmp2(5181).StageIcon, {});
      } else if (channel.isNSFW()) {
        const obj4 = {};
        const merged3 = Object.assign(merged);
        tmp8Result = tmp8(tmp2(5183).VoiceWarningIcon, obj4);
      } else {
        if (tmp6) {
          let VoiceNormalIcon = tmp2(5182).VoiceLockIcon;
        } else {
          VoiceNormalIcon = tmp2(5185).VoiceNormalIcon;
        }
        const obj5 = {};
  ...
  return jsx(channel(7987).PhoneCallIcon, {});
};
