...
// Dependencies: [19, 4762, 21, 8446, 504, 5775, 4874, 1177, 11404, 1115, 2]
// Exports: default

// Module 13272 (UserProfileActivityVoiceChannelUsers)
import util from "util" /* 1115 */;
import NicknameUtilsDefault from "NicknameUtils" /* 4874 */;
import UserProfileStackedActionSheet from "UserProfileStackedActionSheet" /* 11404 */;
...
function UserRow(user) {
  ...
  const avatarDecoration = user(8446).useAvatarDecoration(user, channel.guild_id);
  const obj = user(8446);
  ...
  obj3.start = start;
  obj3.end = end;
  return jsx(user(5775).TableRow, { onPress, label: null, icon: null, start: null, end: null });
}
const jsx = fn(21).jsx;
const size = fn(2);
