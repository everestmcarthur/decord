...
// Dependencies: [19, 4680, 21, 8364, 504, 5693, 4792, 1177, 11312, 1115, 2]
// Exports: default

// Module 13181 (UserProfileActivityVoiceChannelUsers)
import util from "util" /* 1115 */;
import NicknameUtilsDefault from "NicknameUtils" /* 4792 */;
import UserProfileStackedActionSheet from "UserProfileStackedActionSheet" /* 11312 */;
...
function UserRow(user) {
  ...
  const avatarDecoration = user(8364).useAvatarDecoration(user, channel.guild_id);
  const obj = user(8364);
  ...
  obj3.start = start;
  obj3.end = end;
  return jsx(user(5693).TableRow, { onPress, label: null, icon: null, start: null, end: null });
}
const jsx = fn(21).jsx;
const size = fn(2);
