...
// Dependencies: [19, 17, 4597, 8847, 8246, 7260, 1074, 1076, 21, 576, 4605, 13162, 504, 13168, 8253, 13163, 7214, 5648, 1256, 13169, 8846, 4572, 7593, 7234, 5025, 12208, 1114, 13170, 4341, 4601, 8150, 5730, 13171, 2]
// Exports: default

// Module 13167 (UserProfileWishlistSuggestionsGrid)
...
import useCardGridLayoutDefault from "useCardGridLayout" /* 13163 */;
import useWishlistSuggestionsDismissibleContentDefault from "useWishlistSuggestionsDismissibleContent" /* 13168 */;
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  trackUserProfileWishlistAction = trackUserProfileWishlistAction(8253).useUserProfileAnalyticsContext().trackUserProfileWishlistAction;
  const tmp3 = closure_15();
  let obj = trackUserProfileWishlistAction(8253);
  ...
  let obj4 = trackUserProfileWishlistAction(13169);
  const items2 = obj4.useAddToWishlistGridItems({ userId, wishlist, numWishlistItemsToRecommend: 15, maxWishlistItemsToShow: 9, source: trackUserProfileWishlistAction(8846).WishlistFetchSource.USER_PROFILE }).items;
  ...
  if (0 === items2.length) {
    ...
    const obj7 = { size: "md", variant: "secondary", icon: closure_12(tmp(12208).ShopIcon, { size: "sm" }), text: null, onPress: null };
    const intl3 = tmp(1114).intl;
    obj7.text = intl3.string(tmp(1114).t.RSyoZu);
    obj7.onPress = callback;
    obj6.children = closure_12(tmp(5025).Button, obj7);
    ...
    obj12.children = intl4.string(tmp(1114).t["+GB8Kt"]);
    const items4 = [closure_12(tmp(4601).Text, obj12), ];
    ...
    obj14.icon = closure_12(tmp(5730).XSmallIcon, obj15);
    obj14.onPress = markAsDismissed;
    const intl = tmp(1114).intl;
    obj14.accessibilityLabel = intl.string(tmp(1114).t.WAI6xu);
    obj13.children = closure_12(tmp(8150).IconButton, obj14);
    ...
    items6[1] = closure_12(tmp6(13171), obj17);
    const obj18 = { style: tmp3.shopButtonContainer, children: null };
    const obj33 = { size: "md", variant: "secondary", icon: closure_12(tmp(12208).ShopIcon, { size: "sm" }), text: null, onPress: null };
    const intl2 = tmp(1114).intl;
    obj33.text = intl2.string(tmp(1114).t.RSyoZu);
    obj33.onPress = callback;
    obj18.children = closure_12(tmp(5025).Button, obj33);
    items6[2] = closure_12(View, obj18);
    obj10.children = items6;
    obj8.children = closure_13(tmp6(4341).View, obj10);
    tmp12Result = tmp12(tmp(13170).WishlistAnalyticsProvider, obj8);
  }
  return tmp12Result;
}
const View = fn(17).View;
let closure_7 = fn(8246).TrackUserProfileWishlistActions;
