...
// Dependencies: [19, 17, 4566, 8810, 8209, 7222, 1074, 1076, 21, 576, 4574, 13115, 504, 13121, 8216, 13116, 7176, 5612, 1256, 13122, 8809, 4541, 7555, 7196, 4989, 12168, 1114, 13123, 4310, 4570, 8113, 5694, 13124, 2]
// Exports: default

// Module 13120 (UserProfileWishlistSuggestionsGrid)
...
import useCardGridLayoutDefault from "useCardGridLayout" /* 13116 */;
import useWishlistSuggestionsDismissibleContentDefault from "useWishlistSuggestionsDismissibleContent" /* 13121 */;
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  trackUserProfileWishlistAction = trackUserProfileWishlistAction(8216).useUserProfileAnalyticsContext().trackUserProfileWishlistAction;
  ...
  let obj4 = trackUserProfileWishlistAction(13122);
  const items2 = obj4.useAddToWishlistGridItems({ userId, wishlist, numWishlistItemsToRecommend: 15, maxWishlistItemsToShow: 9, source: trackUserProfileWishlistAction(8809).WishlistFetchSource.USER_PROFILE }).items;
  ...
  if (0 === items2.length) {
    ...
    const obj7 = { size: "md", variant: "secondary", icon: closure_12(tmp(12168).ShopIcon, { size: "sm" }), text: null, onPress: null };
    const intl3 = tmp(1114).intl;
    obj7.text = intl3.string(tmp(1114).t.RSyoZu);
    obj7.onPress = callback;
    obj6.children = closure_12(tmp(4989).Button, obj7);
    ...
    const items4 = [closure_12(tmp(4570).Text, obj12), ];
    ...
    obj14.icon = closure_12(tmp(5694).XSmallIcon, obj15);
    obj14.onPress = markAsDismissed;
    const intl = tmp(1114).intl;
    obj14.accessibilityLabel = intl.string(tmp(1114).t.WAI6xu);
    obj13.children = closure_12(tmp(8113).IconButton, obj14);
    ...
    items6[1] = closure_12(tmp6(13124), obj17);
    const obj18 = { style: tmp3.shopButtonContainer, children: null };
    const obj33 = { size: "md", variant: "secondary", icon: closure_12(tmp(12168).ShopIcon, { size: "sm" }), text: null, onPress: null };
    const intl2 = tmp(1114).intl;
    obj33.text = intl2.string(tmp(1114).t.RSyoZu);
    obj33.onPress = callback;
    obj18.children = closure_12(tmp(4989).Button, obj33);
    items6[2] = closure_12(View, obj18);
    obj10.children = items6;
    obj8.children = closure_13(tmp6(4310).View, obj10);
    tmp12Result = tmp12(tmp(13123).WishlistAnalyticsProvider, obj8);
  }
  return tmp12Result;
}
