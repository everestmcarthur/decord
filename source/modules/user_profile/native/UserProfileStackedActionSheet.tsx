...
// Dependencies: [19, 17, 21, 4640, 576, 1612, 6738, 8748, 1364, 7264, 5210, 1115, 5716, 4636, 2]
// Exports: UserProfileStackedActionSheetList, UserProfileStackedActionSheetSectionList, default

// Module 11312 (UserProfileStackedActionSheet)
...
export default function UserProfileStackedActionSheet(onBack) {
  ...
  if (tmp4Result2) {
    ...
    obj3.onPress = onBack;
    obj3.children = tmp4(tmp5(5716).ArrowLargeLeftIcon, { size: "md" });
    tmp4Result = tmp4(tmp5(5210).PressableOpacity, obj3);
  }
...
export const UserProfileStackedActionSheetList = function UserProfileStackedActionSheetList(data) {
  ...
  return closure_4(data(6738).BottomSheetFlatList, obj);
};
export const UserProfileStackedActionSheetSectionList = function UserProfileStackedActionSheetSectionList(renderItem) {
  ...
  return closure_4(renderItem(6738).BottomSheetSectionList, obj);
};
