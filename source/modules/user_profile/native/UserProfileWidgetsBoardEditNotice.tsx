...
// Dependencies: [19, 17, 1954, 21, 4605, 576, 8304, 10695, 1943, 4560, 4601, 1114, 5173, 5730, 2]
// Exports: default

// Module 13134 (UserProfileWidgetsBoardEditNotice)
...
export default function UserProfileWidgetsBoardEditNotice() {
  ...
  obj.children = function children(markAsDismissed) {
    ...
    if (markAsDismissed.visibleContent === dismissible_content.DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE) {
      ...
      obj2.children = hasOwnProperty(tmp(4560).CircleInformationIcon, obj3);
      ...
      items1[1] = hasOwnProperty(tmp(4601).Text, obj4);
      ...
      obj5.children = hasOwnProperty(tmp(5730).XSmallIcon, { size: "sm" });
      items1[2] = hasOwnProperty(tmp(5173).PressableOpacity, obj5);
      obj.children = items1;
