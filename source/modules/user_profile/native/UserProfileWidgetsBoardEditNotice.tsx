...
// Dependencies: [19, 17, 1954, 21, 4607, 576, 8327, 10716, 1943, 4562, 4603, 1114, 5175, 5732, 2]
// Exports: default

// Module 13159 (UserProfileWidgetsBoardEditNotice)
...
export default function UserProfileWidgetsBoardEditNotice() {
  ...
  obj.children = function children(markAsDismissed) {
    ...
    if (markAsDismissed.visibleContent === dismissible_content.DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE) {
      ...
      obj2.children = hasOwnProperty(tmp(4562).CircleInformationIcon, obj3);
      ...
      items1[1] = hasOwnProperty(tmp(4603).Text, obj4);
      ...
      obj5.children = hasOwnProperty(tmp(5732).XSmallIcon, { size: "sm" });
      items1[2] = hasOwnProperty(tmp(5175).PressableOpacity, obj5);
      obj.children = items1;
