...
// Dependencies: [5, 19, 17, 8308, 1074, 21, 4640, 576, 7276, 4297, 4607, 5225, 14715, 7103, 7311, 7263, 1115, 8817, 5775, 5693, 8748, 14716, 504, 8317, 8334, 8395, 1092, 8312, 14717, 14719, 4636, 1177, 14724, 2]
// Exports: default

// Module 14714 (ChangeBannerActionSheet)
...
function ChangeBannerColorRow(user) {
  ...
  const tmp7 = pendingAccentColor(8334)(user.id);
  ...
  const items2 = [closure_9(pendingAccentColor(14719), { style: tmp.bannerColor, color: pendingAccentColor }), , ];
  ...
  items2[2] = closure_9(require("native").Icon, { style: tmp.rowArrow, size: require("native").Icon.Sizes.CUSTOM, source: pendingAccentColor(14724) });
...
export default function ChangeBannerActionSheet(isTryItOut) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (dependencyMap === 1) {
            ...
            let base64;
            let originalMd5;
            tmp5(4607).hideActionSheet();
            const obj4 = tmp5(4607);
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp5(5225).openImagePicker(closure_1_8), done: false };
            return obj6;
          }
          ...
          if (null != base64) {
            const obj8 = { assetOrigin: tmp2(7103).AssetOriginTypes.NEW_ASSET, imageUri: base64, description: "", originalAsset: "Array", originalMd5 };
            closure_129_0(tmp2(14715).createPendingImage(obj8));
  ...
  let tmp4Result = flag;
  if (flag) {
    tmp4Result = tmp4(tmp5(8817).NitroWheelIcon, {});
  }
  ...
  if (!flag) {
    ...
    tmp4Result5 = tmp4(tmp5(8817).NitroWheelIcon, obj6);
  }
  ...
  if (!flag) {
    ...
    obj9.children = tmp4(tmp2(14716), obj10);
  ...
  if (showRemoveBanner) {
    ...
    obj12.label = tmp4(tmp5(8748).FormLabel, obj11);
    obj12.onPress = function handleBannerDelete() {
      _require(null);
      ActionSheetActionCreatorsDefault.hideActionSheet();
    };
    showRemoveBanner = tmp4(tmp5(5693).TableRow, obj12);
  }
