...
// Dependencies: [5, 32, 19, 9359, 1074, 1482, 21, 12215, 9643, 4572, 7241, 12202, 4302, 1365, 8648, 8936, 1114, 5025, 576, 7215, 4618, 4470, 1609, 1242, 2]
// Exports: default

// Module 13067 (AddOrOpenAppButton)
...
function AddAppButton(application) {
  ...
  if (null != customInstallUrl) {
    if (!obj2.isDiscordUrl(customInstallUrl)) {
      let PlusSmallIcon = application(8648).LinkExternalSmallIcon;
    ...
    return jsx(tmp6(5025).Button, { text: null, onPress: null, onLongPress: null, accessibilityActions: null, onAccessibilityAction: null, icon: null });
  }
  PlusSmallIcon = application(8936).PlusSmallIcon;
  tmp6 = application;
}
        ...
        if (0 === c3) {
          if (arg0 === 1) {
            ...
            if (application1 == null) {
              c3 = 1;
              c4 = 1;
              const obj7 = { value: tmp2(7215).fetchApplication(tmp42.id), done: false };
              return obj7;
            } else {
              closure_129_1 = closure_0;
              closure_130_3(false);
              if (null != closure_129_0) {
                tmp2(4572).hideAllActionSheets();
                const obj5 = tmp2(4572);
                const obj8 = { recipientIds: closure_130_1 };
                c3 = 2;
                c4 = 1;
                const obj10 = { value: tmp2(4618).openPrivateChannel(obj8), done: false };
                return obj10;
              } else {
                c4 = 3;
              }
