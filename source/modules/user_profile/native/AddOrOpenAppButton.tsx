...
// Dependencies: [5, 32, 19, 9322, 1074, 1482, 21, 12175, 9605, 4541, 7203, 12162, 4271, 1365, 8611, 8899, 1114, 4989, 576, 7177, 4587, 4439, 1609, 1242, 2]
// Exports: default

// Module 13027 (AddOrOpenAppButton)
...
function AddAppButton(application) {
  ...
  if (null != customInstallUrl) {
    if (!obj2.isDiscordUrl(customInstallUrl)) {
      let PlusSmallIcon = application(8611).LinkExternalSmallIcon;
    ...
    return jsx(tmp6(4989).Button, { text: null, onPress: null, onLongPress: null, accessibilityActions: null, onAccessibilityAction: null, icon: null });
  }
  PlusSmallIcon = application(8899).PlusSmallIcon;
  tmp6 = application;
}
        ...
        if (0 === c3) {
          if (arg0 === 1) {
            ...
            if (application1 == null) {
              c3 = 1;
              c4 = 1;
              const obj7 = { value: tmp2(7177).fetchApplication(tmp42.id), done: false };
              return obj7;
            } else {
              closure_129_1 = closure_0;
              closure_130_3(false);
              if (null != closure_129_0) {
                tmp2(4541).hideAllActionSheets();
                const obj5 = tmp2(4541);
                const obj8 = { recipientIds: closure_130_1 };
                c3 = 2;
                c4 = 1;
                const obj10 = { value: tmp2(4587).openPrivateChannel(obj8), done: false };
                return obj10;
              } else {
                c4 = 3;
              }
