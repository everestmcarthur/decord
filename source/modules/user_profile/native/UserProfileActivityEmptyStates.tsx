...
// Dependencies: [32, 19, 17, 1074, 21, 1115, 4640, 576, 4636, 4792, 12, 4653, 4607, 5062, 7496, 2]

// Module 13224 (UserProfileActivityEmptyStates)
...
const memoResult = noop.memo((user) => {
  ...
  const tmp = closure_10();
  name = name(4792).getName(guildId, channelId, user);
  ...
  obj3.children = closure_7(user(5062).Button, obj4);
