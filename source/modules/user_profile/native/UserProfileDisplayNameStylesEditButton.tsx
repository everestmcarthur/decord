...
// Dependencies: [32, 19, 17, 1074, 1954, 21, 4605, 576, 1483, 9246, 7440, 1943, 8229, 4839, 10972, 1390, 1242, 1114, 14692, 1178, 13246, 10969, 14693, 14695, 2786, 2]
// Exports: default

// Module 14691 (UserProfileDisplayNameStylesEditButton)
...
import getDisplayNameStylesFontNameDefault from "getDisplayNameStylesFontName" /* 14692 */;
import DisplayNameStylesColorSwatchDefault from "DisplayNameStylesColorSwatch" /* 14693 */;
...
export default function UserProfileDisplayNameStylesEditButton(user) {
  ...
  const tmp16 = nativeStackNavigation(() => {
    if (null == closure_6) {
      const obj2 = { source: _modDef13246, style: closure_3.noneIcon };
      let tmp10 = jsx(native.Icon, { source: _modDef13246, style: closure_3.noneIcon });
    } else {
