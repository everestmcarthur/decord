...
// Dependencies: [32, 19, 17, 1074, 1955, 21, 4638, 576, 1484, 9320, 7498, 1944, 8295, 4872, 11048, 1391, 1241, 1115, 14729, 1177, 13319, 11045, 14730, 14732, 2787, 2]
// Exports: default

// Module 14728 (UserProfileDisplayNameStylesEditButton)
...
import getDisplayNameStylesFontNameDefault from "getDisplayNameStylesFontName" /* 14729 */;
import DisplayNameStylesColorSwatchDefault from "DisplayNameStylesColorSwatch" /* 14730 */;
...
export default function UserProfileDisplayNameStylesEditButton(user) {
  ...
  const tmp16 = nativeStackNavigation(() => {
    if (null == closure_6) {
      const obj2 = { source: _modDef13319, style: closure_3.noneIcon };
      let tmp10 = jsx(native.Icon, { source: _modDef13319, style: closure_3.noneIcon });
    } else {
