...
// Dependencies: [32, 19, 17, 1074, 1954, 21, 4607, 576, 1187, 1114, 13177, 8737, 1935, 1943, 7462, 4603, 7456, 4562, 5175, 5732, 2]
// Exports: default, useIsPrivacyNoticeVisible

// Module 13176 (UserProfilePrivacyNotice)
...
export default function UserProfilePrivacyNotice() {
  ...
  if (tmp9 !== dismissible_content.DismissibleContent.PRIVATE_PROFILE_INLINE_NOTICE) {
    ...
    const obj5 = { style: tmp.icon, children: closure_7(tmp2(4562).CircleInformationIcon, { size: "xs", color: "icon-feedback-info" }) };
    ...
    items1[1] = closure_7(tmp2(4603).Text, obj6);
    ...
    obj8.children = closure_7(tmp2(5732).XSmallIcon, { size: "xs", color: "icon-feedback-info" });
    items1[2] = closure_7(tmp2(5175).PressableOpacity, obj8);
