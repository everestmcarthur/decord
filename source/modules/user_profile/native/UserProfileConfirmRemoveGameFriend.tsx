...
// Dependencies: [19, 21, 8320, 11016, 4988, 1115, 4988, 2]
// Exports: default

// Module 12766 (UserProfileConfirmRemoveGameFriend)
...
export default function UserProfileConfirmRemoveGameFriend(gameName) {
  ...
  const items1 = [closure_4(userId(4988).AlertActionButton, obj3, "confirm-remove"), ];
  const obj4 = { variant: "secondary", text: null };
  const intl4 = userId(1115).intl;
  obj4.text = intl4.string(userId(1115).t["eN6+rI"]);
  items1[1] = closure_4(userId(4988).AlertActionButton, obj4, "nevermind");
  obj2.children = items1;
  obj.actions = closure_5(userId(4988).AlertActions, obj2);
  return closure_4(userId(4988).AlertModal, obj);
};
