...
// Dependencies: [32, 19, 17, 7282, 1374, 1085, 21, 4607, 576, 8544, 1935, 5639, 1396, 1115, 4603, 7204, 4308, 8276, 10971, 10210, 4574, 11210, 7256, 1114, 5175, 11300, 2]

// Module 11209 (UserProfileCustomStatusBubble)
...
let closure_15 = { [fn(7282).UserProfileThemeTypes.PREVIEW]: { textVariant: "text-sm/normal", emojiOnlyEmojiSize: 26, textMinWidth: 53, statusBubblePaddingHorizontal: 10, statusBubblePaddingVertical: 6 } };
