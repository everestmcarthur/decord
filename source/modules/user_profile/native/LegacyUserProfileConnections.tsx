...
// Dependencies: [19, 17, 2025, 1385, 4452, 7693, 1074, 1182, 5459, 21, 4606, 576, 5458, 11668, 5334, 1396, 4458, 1178, 11671, 11672, 4308, 11673, 11674, 4574, 7262, 4304, 1114, 8456, 4786, 4301, 5174, 4602, 4317, 504, 7576, 11675, 2]
// Exports: default, useAppplicationRoleConnectionItems, useConnectedAccountItems

// Module 11667 (LegacyUserProfileConnections)
      ...
      callback1 = obj19.useCallback(() => {
        if (null != platformUserUrl) {
          let obj2 = {
            ...
            onConfirm() {
                account(4786).trackWithMetadata(constants.CONNECTED_ACCOUNT_VIEWED, { platform_type: type.type, other_user_id });
                const obj = account(4786);
...
export default function LegacyUserProfileConnections(user) {
  ...
  closure_130_4 = user(7576).usePlatformAllowed({ forUserProfile: true });
  ...
  if (!stateFromStores1) {
    ...
    if (0 !== memo1.length) {
      ...
      if (tmp10) {
        ...
        tmp10 = closure_14(stateFromStores(11675), obj4);
        const tmp13 = stateFromStores(11675);
      }
      ...
      obj6.children = tmp8;
      items6[1] = closure_14(stateFromStores(11675), obj6);
      obj5.children = items6;
      tmp17Result = closure_15(closure_16, obj5);
      const tmp16 = stateFromStores(11675);
    }
  }
  return tmp17Result;
};
