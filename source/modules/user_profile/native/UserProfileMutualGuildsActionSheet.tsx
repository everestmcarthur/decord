...
// Dependencies: [19, 17, 21, 4574, 576, 12632, 11183, 12633, 12634, 12638, 2]
// Exports: default

// Module 12631 (UserProfileMutualGuildsActionSheet)
...
export default function UserProfileMutualGuildsActionSheet(user) {
  ...
  const obj = { scrollable: true, title: onPressMutualGuild(12633)(length), children: null };
  const obj2 = { style: tmp.container, children: null };
  if (null == mutualGuilds) {
    const obj3 = { style: tmp.loadingState, children: tmp3(closure_4, {}) };
    let tmp3Result = tmp3(tmp7, obj3);
  } else if (0 === mutualGuilds.length) {
    const obj4 = { style: tmp.emptyState, children: tmp3(user(12634).NoMutualServers, {}) };
    ...
    tmp3Result = tmp3(user(11183).UserProfileStackedActionSheetList, obj5);
  }
  obj2.children = tmp3Result;
  obj.children = <closure_3 style={tmp.container}>{null}</closure_3>;
  return <tmp4 scrollable title={onPressMutualGuild(12633)(length)}>{null}</tmp4>;
};
