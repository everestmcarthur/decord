...
// Dependencies: [19, 17, 2026, 2022, 1980, 7322, 1074, 1483, 21, 4640, 4341, 576, 4636, 1115, 11362, 504, 5495, 11, 10972, 5672, 11363, 1177, 8519, 7276, 8338, 11364, 4607, 4498, 1101, 7152, 4506, 1610, 8327, 11365, 5062, 7321, 2]
// Exports: default

// Module 11361 (UserProfileAboutMeCard)
...
import BioTextDefault from "BioText" /* 11362 */;
import useFriendsSinceDate from "useFriendsSinceDate" /* 11363 */;
import UserProfileAboutMeCardCommandDefault from "UserProfileAboutMeCardCommand" /* 11365 */;
import noop from "module_19" /* 19 */;
import LocaleStore from "LocaleStore" /* 2026 */;
import GuildMemberStore from "GuildMemberStore" /* 2022 */;
import GuildStore from "GuildStore" /* 1980 */;

const GuildIconDefault = tmp9(5672);
require = fn;
...
function MemberJoinDates(userId) {
  ...
  const createdAtDate1 = userId(5495).getCreatedAtDate(joinedAt, stateFromStores);
  ...
  obj8.style = items4;
  const obj9 = { themeType, icon: closure_11(userId(10972).ClydeIcon, { size: "xs" }), accessibilityLabel: null, children: null };
  ...
  if (tmp13Result) {
    ...
    const items6 = [tmp15(tmp4(4636).Text, obj11), ];
    const obj12 = { themeType, icon: null, accessibilityLabel: null, children: null };
    const obj13 = { guild: stateFromStores1, size: tmp4(5672).GuildIconSizes.XXSMALL };
...
function FriendsSinceDate(themeType) {
  ...
  if (null != friendsSinceDate) {
    ...
    items[1] = closure_1_11(tmp3(4636).Text, obj4);
    obj2.children = items;
