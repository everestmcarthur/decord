...
// Dependencies: [19, 17, 1074, 21, 4605, 576, 4601, 1114, 8435, 2024, 13136, 13139, 13068, 13140, 2]
// Exports: default

// Module 13135 (UserProfileActivityTab)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4601 */;
import UserProfileRecentActivityCardDefault from "UserProfileRecentActivityCard" /* 13140 */;
...
export default function UserProfileActivityTab(user) {
  ...
  ({ recent, isCurrentUser, hasCurrentActivity, hasRecentActivity } = cardStyle(13136)({ userId: user.id, currentUserId: currentUser.id, guildId }));
  ...
  if (hasCurrentActivity) {
    ...
    obj3.children = closure_5(cardStyle(13068), obj4);
