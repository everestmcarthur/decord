...
// Dependencies: [19, 1074, 21, 4639, 1612, 1484, 7553, 7269, 7289, 7097, 9524, 9494, 14720, 1115, 4635, 2]
// Exports: UserProfilePremiumUpsellCard

// Module 14742 (UserProfilePremiumUpsellCard)
...
export const UserProfilePremiumUpsellCard = function UserProfilePremiumUpsellCard(isTryItOut) {
  ...
  let nitroTrialCtaOverride = navigation(7553).useNitroTrialCtaOverride("user_profile_premium_upsell_card");
  const obj2 = navigation(7553);
  const tmp8 = analyticsLocations(7289);
  const items = [isTryItOut ? tmp8.USER_SETTINGS_TRY_OUT_PREMIUM : tmp8.USER_SETTINGS_USER_PROFILE];
  analyticsLocations = analyticsLocations(7269)(items).analyticsLocations;
  ...
  const tmp7 = analyticsLocations(7269);
  if (isTryItOut) {
  ...
  obj3.children = jsx(navigation(4635).Text, { variant: "text-sm/normal", maxFontSizeMultiplier: 2.5, children: stringResult1 });
  return jsx(tmp(14720), { style: tmp3.container, ctaText: null, showLinearGradient: true, onPress: null, children: null });
};
