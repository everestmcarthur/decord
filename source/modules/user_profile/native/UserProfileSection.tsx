...
// Dependencies: [19, 17, 21, 4638, 576, 4348, 7294, 4487, 8734, 4634, 2]
// Exports: default

// Module 11724 (UserProfileSection)
...
export default function UserProfileSection(title) {
  ...
  if (null != primaryColor) {
    if (null != profileThemeValues) {
      let borderColor = tmp3(4487).hexOpacityToRgba(tmp3(8734).DIVIDER_COLORS[theme], profileThemeValues.dividerOpacity);
    ...
    if (null != title) {
      ...
      const items1 = [React3(tmp3(4634).Text, obj7), headerIcon];
