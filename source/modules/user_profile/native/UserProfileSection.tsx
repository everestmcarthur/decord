...
// Dependencies: [19, 17, 21, 4639, 576, 4350, 7291, 4489, 8725, 4635, 2]
// Exports: default

// Module 11716 (UserProfileSection)
...
export default function UserProfileSection(title) {
  ...
  if (null != primaryColor) {
    if (null != profileThemeValues) {
      let borderColor = tmp3(4489).hexOpacityToRgba(tmp3(8725).DIVIDER_COLORS[theme], profileThemeValues.dividerOpacity);
    ...
    if (null != title) {
      ...
      const items1 = [React3(tmp3(4635).Text, obj7), headerIcon];
