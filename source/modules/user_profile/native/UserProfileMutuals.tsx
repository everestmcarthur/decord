...
// Dependencies: [19, 17, 8246, 7260, 21, 4605, 8253, 12672, 13064, 4572, 12678, 1896, 8242, 7394, 5173, 13097, 1178, 4601, 12679, 12688, 5634, 12673, 2]
// Exports: default

// Module 13194 (UserProfileMutuals)
...
export default function UserProfileMutuals(user) {
  ...
  const userProfileAnalyticsContext = user(8253).useUserProfileAnalyticsContext();
  ...
  if (guildId(13064)(user)) {
    ...
    if (tmp7) {
      ...
      const obj3 = {
        ...
        onPress() {
              ...
              ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12678, dependencyMap.paths), "UserProfileMutualsActionSheet", {
                user,
      ...
      const items = [closure_6(tmp2(13097).AvatarPile, obj4), ];
      const obj5 = { variant, color, children: tmp5(12679)(mutualFriends.length) };
      items[1] = closure_6(tmp2(4601).Text, obj5);
      obj3.children = items;
      tmp9Result = tmp9(tmp2(5173).PressableOpacity, obj3);
    }
    ...
    if (tmp15) {
      ...
      tmp15 = closure_6(tmp2(4601).Text, obj6);
    }
    items1[1] = tmp15;
    ...
    if (tmp8) {
      ...
      if (!tmp7) {
        ...
        tmp21 = closure_6(tmp2(12688).GuildIconPile, obj8);
      }
      const items2 = [tmp21, ];
      const obj9 = { variant, color, children: tmp5(12673)(mutualGuilds.length) };
      items2[1] = closure_6(tmp2(4601).Text, obj9);
      obj7.children = items2;
      tmp9Result2 = tmp9(tmp2(5173).PressableOpacity, obj7);
    }
