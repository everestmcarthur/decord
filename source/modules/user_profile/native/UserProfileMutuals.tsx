...
// Dependencies: [19, 17, 8268, 7281, 21, 4606, 8275, 12695, 13087, 4573, 12701, 1896, 8264, 7415, 5174, 13120, 1178, 4602, 12702, 12711, 5635, 12696, 2]
// Exports: default
...
export default function UserProfileMutuals(user) {
  ...
  const userProfileAnalyticsContext = user(8275).useUserProfileAnalyticsContext();
  ...
  if (guildId(13087)(user)) {
    ...
    if (tmp7) {
      ...
      const obj3 = {
        ...
        onPress() {
              ...
              ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12701, dependencyMap.paths), "UserProfileMutualsActionSheet", {
                user,
      ...
      const items = [closure_6(tmp2(13120).AvatarPile, obj4), ];
      const obj5 = { variant, color, children: tmp5(12702)(mutualFriends.length) };
      items[1] = closure_6(tmp2(4602).Text, obj5);
      obj3.children = items;
      tmp9Result = tmp9(tmp2(5174).PressableOpacity, obj3);
    }
    ...
    if (tmp15) {
      ...
      tmp15 = closure_6(tmp2(4602).Text, obj6);
    }
    items1[1] = tmp15;
    ...
    if (tmp8) {
      ...
      if (!tmp7) {
        ...
        tmp21 = closure_6(tmp2(12711).GuildIconPile, obj8);
      }
      const items2 = [tmp21, ];
      const obj9 = { variant, color, children: tmp5(12696)(mutualGuilds.length) };
      items2[1] = closure_6(tmp2(4602).Text, obj9);
      obj7.children = items2;
      tmp9Result2 = tmp9(tmp2(5174).PressableOpacity, obj7);
    }
