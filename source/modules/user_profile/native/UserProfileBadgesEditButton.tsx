...
// Dependencies: [32, 19, 17, 1955, 21, 4638, 576, 11344, 7272, 7498, 1944, 4605, 14734, 1897, 14732, 1115, 4634, 11345, 11343, 2]
// Exports: default

// Module 14733 (UserProfileBadgesEditButton)
...
export default function UserProfileBadgesEditButton(arg0) {
  ...
  onPress = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14734, dependencyMap.paths), "Customize Badges", { analyticsLocations });
    if (closure_5) {
