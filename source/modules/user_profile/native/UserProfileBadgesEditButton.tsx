...
// Dependencies: [32, 19, 17, 1955, 21, 4640, 576, 11352, 7276, 7502, 1944, 4607, 14742, 1897, 14740, 1115, 4636, 11353, 11351, 2]
// Exports: default

// Module 14741 (UserProfileBadgesEditButton)
...
export default function UserProfileBadgesEditButton(arg0) {
  ...
  onPress = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14742, dependencyMap.paths), "Customize Badges", { analyticsLocations });
    if (closure_5) {
