...
// Dependencies: [32, 19, 17, 7664, 7656, 1074, 21, 4639, 576, 8306, 8290, 7269, 7289, 1241, 8284, 8291, 7257, 4635, 1115, 8292, 10867, 504, 14730, 8286, 8307, 14731, 13310, 13311, 8293, 11357, 5071, 2]
// Exports: default

// Module 14729 (EditProfileFrameActionSheet)
...
import EditProfileFrameSection from "EditProfileFrameSection" /* 14731 */;
...
function ProfileFrameSectionPreview(arg0) {
  ...
  const items1 = [closure_9(purchase(11357), { user, guildId, profileFrame: memo, maxWidth: 280 }), ];
