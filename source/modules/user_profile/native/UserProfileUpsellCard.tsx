...
// Dependencies: [19, 17, 7318, 7542, 21, 4638, 576, 1177, 8797, 4634, 5072, 1094, 2]
// Exports: default

// Module 14736 (UserProfileUpsellCard)
...
obj2.outer = { marginHorizontal: fn(7318).PROFILE_SIDE_PADDING - 1 };
let obj4 = { marginHorizontal: fn(7318).PROFILE_SIDE_PADDING - 1 };
...
export default function UserProfileUpsellCard(headerText) {
  ...
  if (null != headerText) {
    ...
    const items3 = [tmp2(tmp3(8797).NitroWheelIcon, obj4), ];
    const obj5 = { variant: "heading-sm/bold", children: headerText };
    items3[1] = tmp2(tmp3(4634).Text, obj5);
