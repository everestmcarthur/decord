...
// Dependencies: [19, 17, 7315, 7539, 21, 4639, 576, 1177, 8788, 4635, 5071, 1094, 2]
// Exports: default

// Module 14720 (UserProfileUpsellCard)
...
obj2.outer = { marginHorizontal: fn(7315).PROFILE_SIDE_PADDING - 1 };
let obj4 = { marginHorizontal: fn(7315).PROFILE_SIDE_PADDING - 1 };
...
export default function UserProfileUpsellCard(headerText) {
  ...
  if (null != headerText) {
    ...
    const items3 = [tmp2(tmp3(8788).NitroWheelIcon, obj4), ];
    const obj5 = { variant: "heading-sm/bold", children: headerText };
    items3[1] = tmp2(tmp3(4635).Text, obj5);
