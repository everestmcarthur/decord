...
// Dependencies: [19, 17, 7260, 7484, 21, 4605, 576, 1178, 8732, 4601, 5037, 1093, 2]
// Exports: default

// Module 14699 (UserProfileUpsellCard)
...
obj2.outer = { marginHorizontal: fn(7260).PROFILE_SIDE_PADDING - 1 };
let obj4 = { marginHorizontal: fn(7260).PROFILE_SIDE_PADDING - 1 };
...
export default function UserProfileUpsellCard(headerText) {
  ...
  if (null != headerText) {
    ...
    const items3 = [tmp2(tmp3(8732).NitroWheelIcon, obj4), ];
    const obj5 = { variant: "heading-sm/bold", children: headerText };
    items3[1] = tmp2(tmp3(4601).Text, obj5);
