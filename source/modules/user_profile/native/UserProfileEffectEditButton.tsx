...
// Dependencies: [19, 17, 7222, 8832, 1085, 21, 4574, 576, 8192, 11074, 4541, 14655, 1896, 1114, 14646, 5591, 5601, 11043, 8835, 1178, 13199, 2]
// Exports: default
...
obj2.sampleProfile = { aspectRatio: fn(8832).SAMPLE_PROFILE_ASPECT_RATIO, width: "100%" };
...
export default function UserProfileEffectEditButton(isTryItOut) {
  ...
  const callback = userProfileEffect.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14655, dependencyMap.paths), "Profile Effect", { user, currentProfileEffect: userProfileEffect, guildId, isTryItOut });
  }, items);
  if (product != null) {
    name = product.name;
  }
