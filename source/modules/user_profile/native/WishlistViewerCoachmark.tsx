...
// Dependencies: [19, 17, 1954, 21, 4606, 13230, 1114, 11222, 2]
// Exports: default
...
function CoachmarkImage() {
  ...
  const obj2 = { source: { uri: _modDef13230 }, style: tmp.image };
  obj.children = <hasOwnProperty source={{ uri: _modDef13230 }} style={tmp.image} />;
