...
// Dependencies: [5, 19, 1372, 1074, 1374, 563, 9551, 4689, 5307, 4380, 14809, 8399, 8397, 8394, 8396, 2]
// Exports: default

// Module 14825 (useUploadAvatar)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            tmp22(4689).hideActionSheet();
            const obj13 = tmp22(4689);
            const obj6 = { size };
            dependencyMap = 1;
            c3 = 1;
            const obj8 = { value: tmp22(5307).openImagePicker(obj6), done: false };
            return obj8;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          if (null == base64) {
            ...
            if (!closure_129_1) {
              canUseAnimatedAvatarResult = tmp22(4380).canUseAnimatedAvatar(closure_129_3);
              const obj = tmp22(4380);
            }
          ...
          tmp22 = tmp2;
          const obj2 = tmp2(14809);
          obj10.description = tmp2(8399).generateAvatarDescription();
          obj10.originalMd5 = originalMd5;
          closure_128_4 = obj2.createPendingImage(obj10);
          if (closure_129_1) {
            tmp28(8397).setTryItOutAvatar(closure_128_4);
            const tmp28Result = tmp28(8397);
          } else {
            const obj11 = { guildId: closure_129_0, avatar: closure_128_4 };
            tmp28(8394).setPendingChanges(obj11);
            const tmp28Result2 = tmp28(8394);
            const result = tmp2(8396).announcePendingAvatarChange("set");
            const obj7 = tmp2(8396);
          }
          const obj4 = tmp2(8399);
        }
      } catch (tmp38) {
        c3 = tmp;
        throw tmp38;
