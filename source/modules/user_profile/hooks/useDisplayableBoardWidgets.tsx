...
// Dependencies: [19, 7705, 7702, 7695, 9123, 9124, 2]
...
function isNonEmptyBoardWidget(games) {
  ...
  if (!tmp3) {
    let tmp4 = games instanceof tmp(7702).UserProfilePersonalWidget;
    if (!tmp4) {
      let isGameWidgetResult = tmp(7695).isGameWidget(games);
