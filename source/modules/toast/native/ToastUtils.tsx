...
// Function ID: 4305
// Name: ToastUtils
// Dependencies: [1074, 4305, 1114, 4306, 4543, 4545, 4547, 4549, 4551, 4553, 4555, 4557, 1396, 4559, 4561, 4564, 1256, 4566, 4569, 2]
...
export const presentFriendRequestAcceptedToast = function presentFriendRequestAcceptedToast(dependencyMap) {
  ...
  obj.open({ key: "TOAST_FRIEND_REQUEST_ACCEPTED", content: stringResult, IconComponent: tmp2(4543).UserPlusIcon, iconColor: "status-positive" });
};
