...
// Function ID: 16995
// Name: ToastContainer
// Dependencies: [19, 4566, 16995, 21, 4574, 5455, 4310, 1477, 15121, 1611, 504, 4976, 15130, 4988, 4284, 4285, 16996, 1178, 4272, 2]
...
function AnimatedToast(toast) {
  ...
  let fn = function p() {
    ...
    if (stateFromStores) {
      ...
      value2 = tmp8(4988).withSpring(obj2.get(), closure_10);
      const tmp8Result = tmp8(4988);
    }
    const obj3 = { opacity: value2, transform: null, maxWidth: null };
    let withSpringResult = interpolateResult;
    if (!stateFromStores) {
      const tmp8Result2 = tmp8(4988);
      ...
      obj4 = { state, TransitionStates: tmp8(4284).TransitionStates, runOnJS: tmp8(4310).runOnJS, cleanUp };
      fn.__closure = obj4;
...
let obj = { container: { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5455).TOAST_CONTAINER_SHADOW_COLOR } };
...
let obj3 = { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5455).TOAST_CONTAINER_SHADOW_COLOR };
let size = fn(2);
