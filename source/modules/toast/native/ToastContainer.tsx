...
// Function ID: 17110
// Name: ToastContainer
// Dependencies: [19, 4631, 17110, 21, 4639, 5526, 4376, 1478, 15182, 1612, 504, 5046, 15191, 5058, 4350, 4351, 17111, 1177, 4338, 2]

// Module 17109 (ToastContainer)
...
import ToastStore from "ToastStore" /* 17110 */;
...
function AnimatedToast(toast) {
  ...
  let fn = function p() {
    ...
    if (stateFromStores) {
      ...
      value2 = tmp8(5058).withSpring(obj2.get(), closure_10);
      const tmp8Result = tmp8(5058);
    }
    const obj3 = { opacity: value2, transform: null, maxWidth: null };
    let withSpringResult = interpolateResult;
    if (!stateFromStores) {
      const tmp8Result2 = tmp8(5058);
      ...
      obj4 = { state, TransitionStates: tmp8(4350).TransitionStates, runOnJS: tmp8(4376).runOnJS, cleanUp };
      fn.__closure = obj4;
...
let obj = { container: { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5526).TOAST_CONTAINER_SHADOW_COLOR } };
...
let obj3 = { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5526).TOAST_CONTAINER_SHADOW_COLOR };
let size = fn(2);
...
export default noop.memo(() => {
  ...
  return jsx(stateFromStoresArray(4350).TransitionGroup, { items: stateFromStoresArray, renderItem, getItemKey, wrapChildren });
});
