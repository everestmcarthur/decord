...
// Function ID: 17206
// Name: ToastContainer
// Dependencies: [19, 4632, 17206, 21, 4640, 5529, 4376, 1478, 15203, 1612, 504, 5047, 15212, 5061, 4350, 4351, 17207, 1177, 4338, 2]

// Module 17205 (ToastContainer)
...
import ToastStore from "ToastStore" /* 17206 */;
...
function AnimatedToast(toast) {
  ...
  let fn = function p() {
    ...
    if (stateFromStores) {
      ...
      value2 = tmp8(5061).withSpring(obj2.get(), closure_10);
      const tmp8Result = tmp8(5061);
    }
    const obj3 = { opacity: value2, transform: null, maxWidth: null };
    let withSpringResult = interpolateResult;
    if (!stateFromStores) {
      const tmp8Result2 = tmp8(5061);
...
let obj = { container: { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5529).TOAST_CONTAINER_SHADOW_COLOR } };
...
let obj3 = { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5529).TOAST_CONTAINER_SHADOW_COLOR };
let size = fn(2);
