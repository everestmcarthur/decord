...
// Function ID: 17166
// Name: ToastContainer
// Dependencies: [19, 4630, 17166, 21, 4638, 5527, 4374, 1478, 15198, 1612, 504, 5045, 15207, 5059, 4348, 4349, 17167, 1177, 4336, 2]

// Module 17165 (ToastContainer)
...
import ToastStore from "ToastStore" /* 17166 */;
...
function AnimatedToast(toast) {
  ...
  let fn = function p() {
    ...
    if (stateFromStores) {
      ...
      value2 = tmp8(5059).withSpring(obj2.get(), closure_10);
      const tmp8Result = tmp8(5059);
    }
    const obj3 = { opacity: value2, transform: null, maxWidth: null };
    let withSpringResult = interpolateResult;
    if (!stateFromStores) {
      const tmp8Result2 = tmp8(5059);
      ...
      obj4 = { state, TransitionStates: tmp8(4348).TransitionStates, runOnJS: tmp8(4374).runOnJS, cleanUp };
      fn.__closure = obj4;
...
let obj = { container: { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5527).TOAST_CONTAINER_SHADOW_COLOR } };
...
let obj3 = { position: "absolute", alignSelf: "center", flexDirection: "row", justifyContent: "center", shadowColor: fn(5527).TOAST_CONTAINER_SHADOW_COLOR };
let size = fn(2);
...
export default noop.memo(() => {
  ...
  return jsx(stateFromStoresArray(4348).TransitionGroup, { items: stateFromStoresArray, renderItem, getItemKey, wrapChildren });
});
