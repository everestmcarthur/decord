...
// Dependencies: [5, 19, 17, 502, 1371, 1074, 1230, 21, 4574, 576, 1611, 1477, 1116, 1242, 4777, 4431, 1100, 4920, 4924, 6624, 1114, 4924, 6607, 5139, 4392, 13888, 4570, 6956, 2]
// Exports: default

// Module 13887 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  const obj3 = { dark: token(4392).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
  ...
  items8[1] = closure_13(token(4570).Text, obj8);
  ...
  const items10 = [closure_13(token(4570).Text, obj10), ];
  ...
  items10[1] = closure_13(token(6956).LinkButton, obj11);
