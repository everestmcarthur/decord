...
// Dependencies: [5, 19, 17, 502, 1372, 1074, 1229, 21, 4638, 576, 1612, 1478, 1365, 1241, 4841, 4495, 1101, 4984, 4988, 6718, 1115, 4988, 6701, 5210, 4456, 13969, 4634, 7050, 2]
// Exports: default

// Module 13968 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  const obj3 = { dark: token(4456).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
