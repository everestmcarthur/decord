...
// Dependencies: [5, 19, 17, 502, 1372, 1074, 1229, 21, 4639, 576, 1612, 1478, 1365, 1241, 4842, 4497, 1101, 4985, 4989, 6715, 1115, 4989, 6698, 5209, 4458, 13956, 4635, 7047, 2]
// Exports: default

// Module 13955 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  const obj3 = { dark: token(4458).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
