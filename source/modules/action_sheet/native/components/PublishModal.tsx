...
// Function ID: 11764
// Name: PublishModal
// Dependencies: [32, 19, 17, 21, 4606, 5492, 11764, 1178, 1114, 2]
// Exports: default
...
let obj2 = { alertContainer: { paddingTop: 16 }, alertLoading: { paddingTop: 62, paddingBottom: 46 }, alertBodyText: { marginBottom: 16, fontSize: 16, lineHeight: 24, color: fn(5492).DARK_PRIMARY_300_LIGHT_PRIMARY_400 } };
