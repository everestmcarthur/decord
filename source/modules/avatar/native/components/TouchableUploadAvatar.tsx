...
// Dependencies: [19, 17, 21, 4638, 576, 13969, 5208, 1115, 5673, 1177, 12916, 2]
// Exports: default

// Module 17654 (TouchableUploadAvatar)
...
export default function TouchableUploadAvatar(onSelectAvatar) {
  ...
  if (showPendingAvatar) {
    ...
    const obj6 = { size: native.Icon.Sizes.MEDIUM, source: _modDef12916, style: tmp.uploadAvatarIcon };
