...
// Function ID: 17645
// Name: AddAvatarModal
// Dependencies: [5, 32, 19, 17, 8289, 1074, 21, 4638, 576, 5768, 5610, 1612, 504, 14707, 17645, 8298, 8376, 5223, 8293, 8295, 4634, 1115, 17654, 1177, 5060, 17642, 1249, 7487, 5710, 7110, 2]

// Module 17644 (AddAvatarModal)
...
import VideoBackground from "VideoBackground" /* 8376 */;
import AddAvatarModalActionCreators from "AddAvatarModalActionCreators" /* 17642 */;
...
function AddAvatarScreen() {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (noop === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj9 = { value: tmp2(5223).openImagePicker(obj7), done: false };
            return obj9;
          }
        } else if (noop === 1) {
          c3 = 3;
          ...
          if (null == base64) {
            ...
            if (null != base64) {
              ...
              obj11.description = tmp2(8298).generateAvatarDescription();
              pendingImage = obj.createPendingImage(obj11);
              const obj3 = tmp2(8298);
            }
            closure_128_1 = pendingImage;
            const obj12 = { avatar: closure_128_1 };
            tmp2(8293).setPendingChanges(obj12);
            const obj4 = tmp2(8293);
            let str = "set";
            if (null == closure_128_1) {
              str = "remove";
            }
            const result = tmp2(8295).announcePendingAvatarChange(str);
            closure_129_2(undefined);
            c3 = 3;
            const obj6 = tmp2(8295);
          }
          closure_129_0(true);
        }
      } catch (tmp42) {
  ...
  if (null != selectedAvatar) {
    let obj2 = { imageUri: tmp9(17645).DEFAULT_AVATARS[selectedAvatar], description: null };
    const tmp9Result = tmp9(14707);
    obj2.description = tmp9(8298).generateAvatarDescription();
    pendingImage = tmp9Result.createPendingImage(obj2);
    const tmp9Result3 = tmp9(8298);
  }
  ...
  items3[1] = closure_9(selectedAvatar(17654), {
  ...
  const items4 = [closure_10(View, obj4), closure_9(selectedAvatar(17645), { onAvatarSelect: tmp4[1], selectedAvatar }), ];
    ...
    memo = closure_5.useMemo(() => {
      ...
      const obj2 = {
        ...
        headerRight() {
          ...
          return closure_1_9(closure_1_0(7487).HeaderActionButton, obj);
        },
        headerLeft() {
          return null;
        },
