...
// Function ID: 17686
// Name: AddAvatarModal
// Dependencies: [5, 32, 19, 17, 8308, 1074, 21, 4640, 576, 5770, 5612, 1612, 504, 14715, 17686, 8317, 8395, 5225, 8312, 8314, 4636, 1115, 17695, 1177, 5062, 17683, 1249, 7491, 5712, 7114, 2]
...
function AddAvatarScreen() {
  ...
  if (null != selectedAvatar) {
    let obj2 = { imageUri: tmp9(17686).DEFAULT_AVATARS[selectedAvatar], description: null };
    const tmp9Result = tmp9(14715);
    obj2.description = tmp9(8317).generateAvatarDescription();
    pendingImage = tmp9Result.createPendingImage(obj2);
    const tmp9Result3 = tmp9(8317);
  }
