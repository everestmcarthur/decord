...
// Function ID: 17589
// Name: AddAvatarModal
// Dependencies: [5, 32, 19, 17, 8280, 1074, 21, 4639, 576, 5767, 5609, 1612, 504, 14691, 17589, 8289, 8367, 5222, 8284, 8286, 4635, 1115, 17598, 1177, 5059, 17586, 1249, 7484, 5709, 7107, 2]

// Module 17588 (AddAvatarModal)
...
import VideoBackground from "VideoBackground" /* 8367 */;
import AddAvatarModalActionCreators from "AddAvatarModalActionCreators" /* 17586 */;
...
function AddAvatarScreen() {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (noop === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj9 = { value: tmp2(5222).openImagePicker(obj7), done: false };
            return obj9;
          }
        } else if (noop === 1) {
          c3 = 3;
          ...
          if (null == base64) {
            ...
            if (null != base64) {
              ...
              obj11.description = tmp2(8289).generateAvatarDescription();
              pendingImage = obj.createPendingImage(obj11);
              const obj3 = tmp2(8289);
            }
            closure_128_1 = pendingImage;
            const obj12 = { avatar: closure_128_1 };
            tmp2(8284).setPendingChanges(obj12);
            const obj4 = tmp2(8284);
            let str = "set";
            if (null == closure_128_1) {
              str = "remove";
            }
            const result = tmp2(8286).announcePendingAvatarChange(str);
            closure_129_2(undefined);
            c3 = 3;
            const obj6 = tmp2(8286);
          }
          closure_129_0(true);
        }
      } catch (tmp42) {
  ...
  if (null != selectedAvatar) {
    let obj2 = { imageUri: tmp9(17589).DEFAULT_AVATARS[selectedAvatar], description: null };
    const tmp9Result = tmp9(14691);
    obj2.description = tmp9(8289).generateAvatarDescription();
    pendingImage = tmp9Result.createPendingImage(obj2);
    const tmp9Result3 = tmp9(8289);
  }
  ...
  items3[1] = closure_9(selectedAvatar(17598), {
  ...
  const items4 = [closure_10(View, obj4), closure_9(selectedAvatar(17589), { onAvatarSelect: tmp4[1], selectedAvatar }), ];
    ...
    memo = closure_5.useMemo(() => {
      ...
      const obj2 = {
        ...
        headerRight() {
          ...
          return closure_1_9(closure_1_0(7484).HeaderActionButton, obj);
        },
        headerLeft() {
          return null;
        },
