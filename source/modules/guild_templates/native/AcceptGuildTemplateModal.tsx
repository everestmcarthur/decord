...
// Dependencies: [5, 32, 19, 7567, 1074, 21, 4638, 5768, 504, 5605, 11937, 7233, 11938, 5223, 11948, 11935, 5710, 7110, 2]
// Exports: default

// Module 11936 (AcceptGuildTemplateModal)
import NavigatorHeader from "NavigatorHeader" /* 5710 */;
import AcceptGuildTemplateActionCreatorsDefault from "AcceptGuildTemplateActionCreators" /* 11948 */;
...
function ConnectedAcceptGuildTemplate(code) {
  ...
  let obj = code(504);
  [name, dependencyMap] = noop.useState(name(5605).getGuildNameSuggestion());
  [first1, _slicedToArray] = noop.useState(null);
  const tmp7 = _slicedToArray(noop.useState(null), 2);
  noop = tmp7[1];
  stateFromStores(11937)(stateFromStores);
  ...
  obj3.children = jsx(stateFromStores(11938), {
    code,
    guildTemplate: stateFromStores,
    name,
    setName(arg0) {
  ...
  return jsx(code(7233).SafeAreaPaddingView, { top: true, style: tmp.container, children: null });
}
const UPLOAD_MEDIUM_SIZE = fn(1074).UPLOAD_MEDIUM_SIZE;
const jsx = fn(21).jsx;
const createStyles = fn(4638);
let obj2 = { container: { flex: 1, marginTop: fn(5768).NAV_BAR_HEIGHT } };
...
export default function AcceptGuildTemplateModal(code) {
  ...
  return jsx(code(7110).Navigator, { initialRouteName: ACCEPT_GUILD_TEMPLATE, screens: memo });
};
