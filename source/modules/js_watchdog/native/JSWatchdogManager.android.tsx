...
// Dependencies: [5, 1074, 3, 1090, 7192, 17498, 1232, 1242, 7549, 7545, 7535, 2]

// Module 17497 (JSWatchdogManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp2(7535).getSession(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          c3 = 3;
