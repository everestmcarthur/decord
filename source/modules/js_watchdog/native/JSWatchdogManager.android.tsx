...
// Dependencies: [5, 1074, 3, 1090, 7170, 17506, 1232, 1242, 7527, 7523, 7513, 2]

// Module 17505 (JSWatchdogManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp2(7513).getSession(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          c3 = 3;
