...
// Dependencies: [19, 21, 4957, 4957, 1114, 5572, 5463, 2]
// Exports: default

// Module 13028 (VoicePanelSpoilerAlert)
...
export default function VoicePanelSpoilerAlert(channelId) {
  ...
  closure_1 = channelId(4957).useDismissModalCallback();
  ...
  const items = [closure_3(channelId(4957).AlertActionButton, obj4, "confirm"), ];
  const obj5 = {
    variant: "secondary",
    onPress() {
      closure_1();
  ...
  items[1] = closure_3(channelId(4957).AlertActionButton, obj5, "cancel");
  obj3.children = items;
  obj2.actions = closure_4(channelId(4957).AlertActions, obj3);
  return closure_3(channelId(4957).AlertModal, obj2);
};
