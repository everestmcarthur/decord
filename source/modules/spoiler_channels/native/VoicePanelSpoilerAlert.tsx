...
// Dependencies: [19, 21, 4955, 4955, 1114, 5570, 5461, 2]
// Exports: default

// Module 13003 (VoicePanelSpoilerAlert)
...
export default function VoicePanelSpoilerAlert(channelId) {
  ...
  closure_1 = channelId(4955).useDismissModalCallback();
  ...
  const items = [closure_3(channelId(4955).AlertActionButton, obj4, "confirm"), ];
  const obj5 = {
    variant: "secondary",
    onPress() {
      closure_1();
  ...
  items[1] = closure_3(channelId(4955).AlertActionButton, obj5, "cancel");
  obj3.children = items;
  obj2.actions = closure_4(channelId(4955).AlertActions, obj3);
  return closure_3(channelId(4955).AlertModal, obj2);
};
