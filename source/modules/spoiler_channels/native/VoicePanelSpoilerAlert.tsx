...
// Dependencies: [19, 21, 4956, 4956, 1114, 5571, 5462, 2]
// Exports: default
...
export default function VoicePanelSpoilerAlert(channelId) {
  ...
  closure_1 = channelId(4956).useDismissModalCallback();
  ...
  const items = [closure_3(channelId(4956).AlertActionButton, obj4, "confirm"), ];
  const obj5 = {
    variant: "secondary",
    onPress() {
      closure_1();
  ...
  items[1] = closure_3(channelId(4956).AlertActionButton, obj5, "cancel");
  obj3.children = items;
  obj2.actions = closure_4(channelId(4956).AlertActions, obj3);
  return closure_3(channelId(4956).AlertModal, obj2);
};
