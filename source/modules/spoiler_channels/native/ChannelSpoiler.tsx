...
// Function ID: 12819
// Name: ChannelSpoiler
// Dependencies: [32, 19, 17, 4656, 1958, 1980, 12422, 21, 4640, 576, 504, 4793, 12423, 4841, 5608, 4498, 5115, 4636, 1115, 5060, 4630, 5210, 12817, 8562, 2]
// Exports: default

// Module 12818 (ChannelSpoiler)
...
import GatedContentDefault from "GatedContent" /* 12817 */;
...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = obj4.useContext(tmp6(12423)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        obj12.children = tmp24(tmp(4636).Text, obj13);
        tmp24Result = tmp24(tmp(5210).PressableHighlight, obj12);
      }
      items5[2] = tmp24Result;
      const obj14 = { style: tmp4.divider };
      items5[3] = closure_10(tmp25, obj14);
      obj6.children = items5;
      tmp23Result = tmp23(tmp(5060).Stack, obj6);
