...
// Function ID: 12811
// Name: ChannelSpoiler
// Dependencies: [32, 19, 17, 4654, 1958, 1980, 12413, 21, 4638, 576, 504, 4791, 12414, 4839, 5606, 4496, 5113, 4634, 1115, 5058, 4628, 5208, 12809, 8543, 2]
// Exports: default

// Module 12810 (ChannelSpoiler)
...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = obj4.useContext(tmp6(12414)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        obj12.children = tmp24(tmp(4634).Text, obj13);
        tmp24Result = tmp24(tmp(5208).PressableHighlight, obj12);
      }
      items5[2] = tmp24Result;
      const obj14 = { style: tmp4.divider };
      items5[3] = closure_10(tmp25, obj14);
      obj6.children = items5;
      tmp23Result = tmp23(tmp(5058).Stack, obj6);
