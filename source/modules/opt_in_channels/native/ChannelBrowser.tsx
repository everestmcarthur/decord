...
// Function ID: 11686
// Name: ChannelBrowser
// Dependencies: [32, 19, 17, 7635, 7214, 2012, 1979, 4817, 1074, 1954, 21, 4636, 576, 7084, 11686, 504, 11688, 4457, 1943, 11684, 7153, 9003, 5688, 5204, 1114, 6717, 5668, 11690, 4632, 4789, 4355, 5768, 5698, 4338, 5109, 5685, 5692, 1178, 4626, 2]
// Exports: default

// Module 11685 (ChannelBrowser)
...
let closure_17 = noop.memo((channel) => {
  ...
  const tmp3 = onChannelClick(4789)(channel);
  ...
  const checkboxA11yNative = channel(4355).useCheckboxA11yNative({ checked: stateFromStores });
  const obj3 = {
  ...
  const items1 = [closure_12(channel(5768).TableRowGroupTitle, { style: tmp.categoryTitle, title: tmp3, lineClamp: 1 }), ];
  ...
  if ("null" !== channel.id) {
    ...
    obj6.children = tmp8(tmp4(5698).FormCheckbox, obj7);
