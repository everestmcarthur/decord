...
// Function ID: 11650
// Name: ChannelBrowser
// Dependencies: [32, 19, 17, 7605, 7184, 2012, 1979, 4787, 1074, 1954, 21, 4606, 576, 7054, 11650, 504, 11652, 4427, 1943, 11648, 7123, 8964, 5658, 5174, 1114, 6687, 5638, 11654, 4602, 4759, 4325, 5738, 5668, 4308, 5079, 5655, 5662, 1178, 4596, 2]
// Exports: default

// Module 11649 (ChannelBrowser)
...
let closure_17 = noop.memo((channel) => {
  ...
  const tmp3 = onChannelClick(4759)(channel);
  ...
  const items1 = [closure_12(channel(5738).TableRowGroupTitle, { style: tmp.categoryTitle, title: tmp3, lineClamp: 1 }), ];
  ...
  if ("null" !== channel.id) {
    ...
    obj6.children = tmp8(tmp4(5668).FormCheckbox, obj7);
