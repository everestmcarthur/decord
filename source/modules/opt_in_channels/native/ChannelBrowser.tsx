...
// Function ID: 11588
// Name: ChannelBrowser
// Dependencies: [32, 19, 17, 7546, 7125, 2012, 1979, 4755, 1074, 1954, 21, 4574, 576, 6995, 11588, 504, 11590, 4394, 1943, 11586, 7064, 8906, 5621, 5137, 1114, 6630, 5601, 11592, 4570, 4727, 4292, 5701, 5631, 4275, 5042, 5618, 5625, 1178, 4564, 2]
// Exports: default
...
let closure_17 = noop.memo((channel) => {
  ...
  const tmp3 = onChannelClick(4727)(channel);
  ...
  const checkboxA11yNative = channel(4292).useCheckboxA11yNative({ checked: stateFromStores });
  const obj3 = {
  ...
  const items1 = [closure_12(channel(5701).TableRowGroupTitle, { style: tmp.categoryTitle, title: tmp3, lineClamp: 1 }), ];
  ...
  if ("null" !== channel.id) {
    ...
    obj7.children = tmp8(tmp4(5631).FormCheckbox, obj8);
    ...
    items2[1] = tmp8(tmp4(4570).Text, obj14);
    obj6.children = items2;
    tmp10Result = tmp10(View, obj6);
  }
  items1[1] = tmp10Result;
  obj3.children = closure_13(closure_14, { children: items1 });
  return closure_12(channel(5137).PressableOpacity, obj3);
});
