...
// Dependencies: [19, 17, 1980, 21, 4599, 576, 4639, 504, 5669, 14951, 1115, 4635, 12753, 12503, 4606, 4338, 7257, 5059, 2]
// Exports: default

// Module 14953 (BaseUpsellActionSheet)
...
function StoreGuildIcon(guildId) {
  ...
  obj2.size = guildId(5669).GuildIconSizes.XSMALL;
...
export default function BaseUpsellActionSheet(toastContent) {
  ...
  const items1 = [closure_7(toastContent(4635).Text, { style: tmp.title, accessibilityRole: "header", variant: "heading-xl/bold", color: "text-strong", children: title }), closure_7(toastContent(4635).Text, { style: tmp.description, variant: "text-md/medium", color: "text-default", children: subtitle }), closure_7(GuildCard, { guildIds: affectedGuildIds, direction, onPress: onCardPress }), ];
  const obj5 = { style: tmp.buttonsContainer, children: null };
  const items2 = [closure_7(toastContent(5059).Button, { variant: "primary", size: "md", text: confirmText, onPress: callback }), ];
  ...
  items2[1] = closure_7(toastContent(5059).Button, obj6);
  obj5.children = items2;
  items1[3] = closure_8(closure_5, obj5);
  obj2.children = items1;
  obj.children = closure_8(closure_5, obj2);
  return closure_7(toastContent(7257).BottomSheet, obj);
};
