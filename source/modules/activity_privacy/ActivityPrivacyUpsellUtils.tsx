...
// Dependencies: [5597, 4559, 1980, 5526, 1186, 7109, 1115, 1936, 2]
...
// Module 14975 (ActivityPrivacyUpsellUtils)
  ...
  if (setting === ACTIVITY_STATUS_OFF) {
    ...
    if (num >= 0) {
      if (num2 >= 0) {
        ...
        dependencyMap = tmp8(7109).getSanitizedActivityRestrictedGuilds();
