...
// Dependencies: [5561, 4527, 1979, 5490, 1187, 7069, 1114, 1935, 2]
...
// Module 14906 (ActivityPrivacyUpsellUtils)
  ...
  if (setting === ACTIVITY_STATUS_OFF) {
    ...
    if (num >= 0) {
      if (num2 >= 0) {
        ...
        dependencyMap = tmp8(7069).getSanitizedActivityRestrictedGuilds();
