...
// Dependencies: [5595, 4557, 1980, 5524, 1186, 7105, 1115, 1936, 2]
...
// Module 14967 (ActivityPrivacyUpsellUtils)
  ...
  if (setting === ACTIVITY_STATUS_OFF) {
    ...
    if (num >= 0) {
      if (num2 >= 0) {
        ...
        dependencyMap = tmp8(7105).getSanitizedActivityRestrictedGuilds();
