...
// Dependencies: [5523, 4494, 1979, 5452, 1187, 7009, 1114, 1935, 2]
...
// Module 14880 (ActivityPrivacyUpsellUtils)
  ...
  if (setting === ACTIVITY_STATUS_OFF) {
    ...
    if (num >= 0) {
      if (num2 >= 0) {
        ...
        dependencyMap = tmp8(7009).getSanitizedActivityRestrictedGuilds();
