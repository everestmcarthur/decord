...
// Dependencies: [7671, 7665, 7672, 2]

// Module 7670 (StorefrontCollectionRecord)
import CollectiblesStoreListingStylesRecord from "CollectiblesStoreListingStylesRecord" /* 7671 */;
import StorefrontProductRecord from "StorefrontProductRecord" /* 7672 */;

const AssetDisplayConfigRecord = fn(7665).AssetDisplayConfigRecord;
