...
// Dependencies: [7675, 7669, 7676, 2]

// Module 7674 (StorefrontCollectionRecord)
import CollectiblesStoreListingStylesRecord from "CollectiblesStoreListingStylesRecord" /* 7675 */;
import StorefrontProductRecord from "StorefrontProductRecord" /* 7676 */;

const AssetDisplayConfigRecord = fn(7669).AssetDisplayConfigRecord;
