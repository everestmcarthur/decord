...
// Dependencies: [19, 2025, 1371, 7305, 1074, 1373, 12, 7306, 1116, 1384, 504, 7299, 7307, 4264, 7314, 2]
  ...
  const memo = pricesForPurchaseType.useMemo(() => {
    ...
    if (null != sku) {
      if (null != stateFromStores1) {
        ...
        if (tmp12 == null) {
          tmp12 = tmp11[tmp4(undefined, 7306).StorefrontPurchaseType.SELF_PURCHASE];
        }
        let found;
        if (tmp12 != null) {
    ...
    return { userPrice: "r", pricesForPurchaseType: "ip", purchaseType: SELF_PURCHASE, storeHasPrice: null != stateFromStores1 };
  }, items1);
