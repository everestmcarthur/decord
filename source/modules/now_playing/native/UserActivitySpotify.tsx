...
// Dependencies: [19, 17, 8461, 21, 1363, 1271, 4334, 11883, 5059, 8262, 1115, 1177, 2]
// Exports: SpotifyPlayButton, attributeInstall, canOpenSpotifyUrl, openAlbum, openArtist, openTrack, openUrl

// Module 11882 (UserActivitySpotify)
...
export const SpotifyPlayButton = function SpotifyPlayButton(activity) {
  ...
  let obj2 = { icon: closure_9(activity(5059).Button.Icon, { source: _modDef8262 }), text: null, size: "sm", onPress: null, grow: true };
  ...
  obj.children = closure_9(activity(5059).Button, obj2);
