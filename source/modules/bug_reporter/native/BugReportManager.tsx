...
// Dependencies: [5, 17, 1347, 1074, 4815, 1115, 10164, 10166, 1256, 7170, 10285, 2]

// Module 10284 (BugReportManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            notificationDuration = tmp2(10164).getNotificationDuration(BUG_REPORTER);
            const obj5 = tmp2(10164);
