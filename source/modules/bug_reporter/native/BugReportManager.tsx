...
// Dependencies: [5, 17, 1347, 1074, 4817, 1115, 10186, 10188, 1256, 7192, 10306, 2]

// Module 10305 (BugReportManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            notificationDuration = tmp2(10186).getNotificationDuration(BUG_REPORTER);
            const obj5 = tmp2(10186);
