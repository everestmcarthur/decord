...
// Dependencies: [5, 32, 19, 17, 1371, 10273, 21, 4606, 576, 672, 1090, 4809, 1483, 504, 1114, 5675, 5179, 4305, 7065, 10275, 559, 10276, 9657, 7450, 5739, 5638, 1396, 5201, 5024, 4602, 5658, 10285, 5174, 1178, 5026, 6677, 5738, 5656, 4573, 10300, 1896, 5736, 7158, 1348, 10303, 10265, 7073, 2]
// Exports: default

// Module 10274 (BugReporterModal)
  ...
  constructor(arg0) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp5(5201).launchImageLibraryAsync({ mediaType: "any", includeBase64: false, selectionLimit: 1 }), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            if (null != closure_128_0) {
              ...
              obj6.platform = tmp2(5179).UploadPlatform.REACT_NATIVE;
              obj6.filename = closure_128_1.fileName;
              closure_128_2 = obj6;
              const tmp34 = new tmp5(5179)(closure_128_2);
              closure_128_3 = tmp34;
              closure_129_23.current = closure_129_7.length;
              closure_129_8((arg0) => {
                const items = [];
          ...
          try {
            ...
            if (0 === description) {
              if (arg0 === 1) {
                  ...
                  const tmp = closure_3_3(function*(arg0, value, arg2) {
                    if (c6 === 2) {
                      ...
                      try {
                          ...
                          if (arg0 === 1) {
                            ...
                            if (closure_131_5 >= 20) {
                              if (closure_131_4) {
                                ...
                                const obj5 = { key: "BUG_REPORT_BUG_SUBMITTED", icon: closure_2_1(9657), content: null, toastDurationMs: null };
                                const intl2 = closure_2_0(1114).intl;
                                obj5.content = intl2.string(closure_2_0(1114).t.jB8yOL);
                                obj5.toastDurationMs = toastDurationMs;
                                closure_2_1(4305).open(obj5);
                                const obj6 = closure_2_1(4305);
                              } else {
                                const obj7 = { key: "BUG_REPORT_FAILED_TO_SUBMIT", icon: closure_2_1(7065), content: null };
                                const intl = closure_2_0(1114).intl;
                                obj7.content = intl.string(closure_2_0(1114).t["4t1o0u"]);
                                closure_2_1(4305).open(obj7);
                                const obj4 = closure_2_1(4305);
                              }
                              c6 = 3;
                            }
                          }
                        ...
                        c5 = 1;
                        c6 = 1;
                        const obj11 = { value: closure_2_0(10276).submitReport(closure_131_0, closure_131_1, closure_131_2), done: false };
                        return obj11;
                      } catch (tmp50) {
                        c6 = tmp;
                        throw tmp50;
                ...
                if (ref.current) {
                  if (first5) {
                    let obj5 = { key: "BUG_REPORT_SUBMITTING_BUG", icon: screenshot(7065), content: null, toastDurationMs: null };
                    let intl2 = handleSubmit(1114).intl;
                    obj5.content = intl2.string(handleSubmit(1114).t.Uuqbcm);
                    obj5.toastDurationMs = toastDurationMs;
                    screenshot(4305).open(obj5);
                    closure_1_16(true);
                    first8();
                    let obj9 = screenshot(4305);
                  }
                  priority = 3;
                } else {
                  callback(true);
                  if (null == priority) {
                    let obj7 = { key: "BUG_REPORT_FAILED_TO_SUBMIT", icon: screenshot(7065), content: null };
                    let intl = handleSubmit(1114).intl;
                    obj7.content = intl.string(handleSubmit(1114).t["4t1o0u"]);
                    screenshot(4305).open(obj7);
                    callback(false);
                    priority = 3;
                    ...
                    description = 1;
                    priority = 1;
                    let obj10 = { value: handleSubmit(10275).getAttachments(first3), done: false };
                    return obj10;
                  }
                }
              }
    ...
    if (!stateFromStores) {
      ...
      obj34.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10300, dependencyMap.paths), "BugReporterFeatureActionSheet", { features: null != first7 ? first7.features : [], feature: first8, setFeature });
      };
      if (null != first8) {
        name = first8.name;
      } else {
...
export default function BugReportModal(screenshotUri) {
  ...
  return closure_10(screenshotUri(7073).Navigator, { screens, initialRouteName: "BUG_REPORT_CREATE" });
};
