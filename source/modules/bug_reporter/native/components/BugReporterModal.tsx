...
// Dependencies: [5, 32, 19, 17, 1372, 10314, 21, 4639, 576, 672, 1091, 4842, 1484, 504, 1115, 5709, 5212, 4338, 7099, 10316, 559, 10317, 9698, 7484, 5773, 5672, 1397, 5234, 5057, 4635, 5692, 10327, 5207, 1177, 5059, 6711, 5772, 5690, 4606, 10342, 1897, 5770, 7192, 1347, 10345, 10306, 7107, 2]
// Exports: default

// Module 10315 (BugReporterModal)
  ...
  constructor(arg0) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp5(5234).launchImageLibraryAsync({ mediaType: "any", includeBase64: false, selectionLimit: 1 }), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
          ...
          try {
            ...
            if (0 === description) {
              if (arg0 === 1) {
                  ...
                  const tmp = closure_3_3(function*(arg0, value, arg2) {
                    if (c6 === 2) {
                      ...
                      try {
                          ...
                          if (arg0 === 1) {
                            ...
                            if (closure_131_5 >= 20) {
                              if (closure_131_4) {
                                ...
                                const obj5 = { key: "BUG_REPORT_BUG_SUBMITTED", icon: closure_2_1(9698), content: null, toastDurationMs: null };
                                ...
                                const obj7 = { key: "BUG_REPORT_FAILED_TO_SUBMIT", icon: closure_2_1(7099), content: null };
                        ...
                        c5 = 1;
                        c6 = 1;
                        const obj11 = { value: closure_2_0(10317).submitReport(closure_131_0, closure_131_1, closure_131_2), done: false };
                        return obj11;
                      } catch (tmp50) {
                        c6 = tmp;
                        throw tmp50;
                ...
                if (ref.current) {
                  if (first5) {
                    let obj5 = { key: "BUG_REPORT_SUBMITTING_BUG", icon: screenshot(7099), content: null, toastDurationMs: null };
    ...
    if (!stateFromStores) {
      ...
      obj34.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10342, dependencyMap.paths), "BugReporterFeatureActionSheet", { features: null != first7 ? first7.features : [], feature: first8, setFeature });
      };
      if (null != first8) {
        name = first8.name;
      } else {
