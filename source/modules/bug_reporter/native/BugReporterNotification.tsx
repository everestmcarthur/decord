...
// Dependencies: [19, 17, 10322, 1074, 21, 4638, 576, 10308, 10245, 10233, 4841, 10235, 10323, 1897, 7492, 2]
// Exports: BugReporterNotification

// Module 10321 (BugReporterNotification)
...
export const BugReporterNotification = function BugReporterNotification(notification) {
  ...
  return jsx(notification(10308).NotificationPressable, {
    header: memo,
    children: jsx(notification(10245).SystemMessageText, { text: "Bzzz! Found a bug? Tap to submit." }),
    ...
    onPress() {
      if (!BugReportStore.getField("isReportOpen")) {
        ...
        ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10323, dependencyMap.paths), { screenshotUri: null, screenshot: null });
