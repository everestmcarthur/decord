...
// Dependencies: [19, 17, 10273, 1074, 21, 4606, 576, 10259, 10196, 10184, 4809, 10186, 10274, 1896, 7455, 2]
// Exports: BugReporterNotification

// Module 10272 (BugReporterNotification)
  ...
  return jsx(notification(10259).NotificationPressable, {
    ...
    onPress() {
      if (!BugReportStore.getField("isReportOpen")) {
        ...
        ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10274, dependencyMap.paths), { screenshotUri: null, screenshot: null });
