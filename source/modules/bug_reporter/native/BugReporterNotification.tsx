...
// Dependencies: [19, 17, 10275, 1074, 21, 4607, 576, 10261, 10198, 10186, 4810, 10188, 10276, 1896, 7456, 2]
// Exports: BugReporterNotification

// Module 10274 (BugReporterNotification)
...
export const BugReporterNotification = function BugReporterNotification(notification) {
  ...
  return jsx(notification(10261).NotificationPressable, {
    header: memo,
    children: jsx(notification(10198).SystemMessageText, { text: "Bzzz! Found a bug? Tap to submit." }),
    ...
    onPress() {
      if (!BugReportStore.getField("isReportOpen")) {
        ...
        ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10276, dependencyMap.paths), { screenshotUri: null, screenshot: null });
