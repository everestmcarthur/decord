...
// Dependencies: [5, 32, 19, 17, 4599, 9382, 2015, 1482, 1074, 1607, 21, 4607, 576, 12249, 504, 4343, 4608, 4611, 4575, 5039, 4456, 5028, 1114, 4552, 11311, 4787, 7055, 12250, 7597, 8360, 12146, 1249, 12123, 12252, 1894, 9381, 12088, 9665, 1477, 11452, 10726, 12253, 10727, 5190, 1874, 5180, 12254, 9502, 6699, 4603, 12255, 12256, 12287, 1178, 38, 12223, 9509, 7595, 9387, 9498, 12288, 12289, 12209, 12210, 2]
// Exports: default

// Module 12248 (AppLauncherCommandViewScreen)
...
import BaseTextButton from "BaseTextButton" /* 5028 */;
...
import showMediaKeyboardActionSheet from "showMediaKeyboardActionSheet" /* 10727 */;
...
import AppLauncherCommandViewHeader from "AppLauncherCommandViewHeader" /* 12249 */;
import ApplicationCommandValidationUtils from "ApplicationCommandValidationUtils" /* 12250 */;
import application_commands_ApplicationCommandValidationUtils from "application_commands/ApplicationCommandValidationUtils" /* 12252 */;
import CommandOptionViewDefault from "CommandOptionView" /* 12255 */;
import _modDef12288 from "module_12288" /* 12288 */;
...
function AppLauncherCommandViewFooter(arg0) {
  ...
  let fn = function h() {
    if (stateFromStores) {
      ...
      const obj9 = timing;
      const fn = function e() {
        const obj = closure_1_0(4343);
        return closure_1_0(4343).runOnJS(closure_1_0(4575).triggerHapticFeedback)(closure_1_0(4575).HapticFeedbackTypes.IMPACT_LIGHT);
      };
  ...
  callback3 = obj2.useCallback(() => {
    if (null != command) {
      ...
      if (null != firstInvalidOption) {
        ...
        tmp14(4787).trackWithMetadata(constants2.APPLICATION_COMMAND_VALIDATION_FAILED, obj);
        const tmp14Result = tmp14(4787);
      } else {
        closure_35(false);
        ...
        const tmp14Result3 = tmp14(9381);
        obj4.optionValues = tmp14(12088).parseOptionValuesForSend(commandContext.channel, tmp, optionValues.current);
        obj4.context = commandContext;
        obj4.sectionName = sectionName;
        obj4.commandOrigin = tmp14(7597).CommandOrigin.APP_LAUNCHER_APPLICATION_VIEW;
        const result1 = tmp14Result3.executeAppLauncherCommand(obj4);
        const tmp14Result4 = tmp14(12088);
        result1.then(() => {
  ...
  onPressAttachmentOption = obj2.useCallback((option) => {
    ...
    if (fileTypeFiltering.mediaFilesAllowed) {
      ...
      obj3.onPressItem = function onPressItem(item) {
        ...
        if (allowedExtensions.length > 0) {
          const items = [tmp(5190).getFileFromUploadItem(result1).filename];
          if (!analyticsLocation(items)) {
            return onCommandExecuted();
          }
          const tmpResult = tmp(5190);
        }
        const result2 = MediaKeyboardUtils.addAttachmentForCommand(item.channelId, chatInputRef, result1, obj, tmp(5180).UploadOrigin.IMAGE_PICKER);
      };
...
function NotFoundState(onPress) {
  ...
  const obj3 = { style: tmp.emptyState, lightSource: _modDef12288, darkSource: _modDef12289, title: null, body: null, children: null };
...
function NoPermsState(command) {
  ...
  const obj6 = { style: tmp.emptyState, lightSource: _modDef12209, darkSource: _modDef12210, title: null, body: null, children: null };
  const intl = util.intl;
...
obj2.optionsContainer = { paddingTop: fn(12249).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4, paddingHorizontal: DEFAULT_CONTENT_PADDING, paddingBottom: DEFAULT_CONTENT_PADDING, backgroundColor: nativeDefault.colors.MOBILE_KEYBOARD_PANEL_BACKGROUND };
...
let obj4 = { paddingTop: fn(12249).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4, paddingHorizontal: DEFAULT_CONTENT_PADDING, paddingBottom: DEFAULT_CONTENT_PADDING, backgroundColor: nativeDefault.colors.MOBILE_KEYBOARD_PANEL_BACKGROUND };
...
obj2.emptyStateContainer = { paddingTop: fn(12249).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4, flex: 1 };
obj2.failureStateButtonWrapper = { marginTop: 24, alignSelf: "center" };
let obj7 = { paddingTop: fn(12249).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4, flex: 1 };
