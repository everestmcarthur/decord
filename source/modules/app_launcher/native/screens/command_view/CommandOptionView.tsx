...
// Dependencies: [19, 17, 4632, 21, 1895, 4640, 576, 504, 4376, 12312, 12313, 4636, 12314, 1177, 10563, 2]
// Exports: default

// Module 12311 (CommandOptionView)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexportDefault from "ReanimatedRexport" /* 4376 */;
import AppLauncherCommandOptionDefault from "AppLauncherCommandOption" /* 12314 */;
...
export default function CommandOptionView(option) {
  ...
  const optionEnteringAnimation = option(12312).useOptionEnteringAnimation();
  ...
  if (set.has(option.type)) {
    ...
    const obj5 = {
      ...
      exiting: tmp2(12312).ExitingAnimation,
      layout: tmp2(12312).LayoutAnimation,
      onLayout(arg0) {
    ...
    if (hasItem1) {
      ...
      tmp17Result = tmp17(tmp2(4636).Text, obj7);
    }
    ...
    items2[2] = closure_5(tmp2(4636).Text, obj9);
    if (hasItem) {
      ...
      const obj11 = { style: tmp.optionErrorIcon, source: tmp18(10563), size: tmp2(1177).IconSizes.REFRESH_SMALL_16 };
      ...
      items3[1] = tmp17(tmp2(4636).Text, obj12);
    ...
    obj3.children = closure_5(tmp2(12313).AwaitAnimationContext, obj4);
    return closure_5(tmp2(4376).LayoutAnimationConfig, obj3);
  } else {
    return null;
  }
  const tmp2Result = option(12312);
};
