...
// Dependencies: [32, 19, 4639, 4374, 2]
// Exports: useOptionEnteringAnimation

// Module 12303 (useOptionAnimations)
...
LayoutAnimation.__closure = { withTiming: fn(4639).withTiming, OPTION_ENTRY_EXIT_LAYOUT_SHIFT_DURATION: 300 };
...
let obj = { withTiming: fn(4639).withTiming, OPTION_ENTRY_EXIT_LAYOUT_SHIFT_DURATION: 300 };
ExitingAnimation.__closure = { withTiming: fn(4639).withTiming, OPTION_ENTRY_EXIT_LAYOUT_SHIFT_DURATION: 300 };
...
export const useOptionEnteringAnimation = function useOptionEnteringAnimation() {
  sharedValue = sharedValue(4374).useSharedValue(false);
  ...
  let obj = sharedValue(4374);
  return {
    EnteringAnimation: _slicedToArray(noop.useState(() => {
      const fn = function n() {
        const obj2 = { duration: 250, easing: null };
        const Easing = sharedValue(4374).Easing;
        obj2.easing = Easing.bezier(0.25, 1.75, 0.25, 1.25);
        const obj = sharedValue(4639);
        const withTimingResult = sharedValue(4639).withTiming(1, obj2);
        const obj4 = { animations: null, initialValues: null, callback: null };
        const obj5 = { opacity: null, transform: null };
        const obj3 = sharedValue(4639);
        const withTimingResult1 = sharedValue(4639).withTiming(1, { duration: 200 });
        obj5.opacity = sharedValue(4374).withDelay(200, withTimingResult1);
        const obj7 = { scale: null };
        const obj6 = sharedValue(4374);
        obj7.scale = sharedValue(4374).withDelay(200, withTimingResult);
        const items = [obj7];
        ...
        obj4.callback = function callback() {
          sharedValue(4374).runOnJS(closure_1_2)();
        };
        return obj4;
      };
