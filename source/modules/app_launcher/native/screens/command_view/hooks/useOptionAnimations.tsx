...
// Dependencies: [32, 19, 4640, 4376, 2]
// Exports: useOptionEnteringAnimation

// Module 12295 (useOptionAnimations)
...
LayoutAnimation.__closure = { withTiming: fn(4640).withTiming, OPTION_ENTRY_EXIT_LAYOUT_SHIFT_DURATION: 300 };
...
let obj = { withTiming: fn(4640).withTiming, OPTION_ENTRY_EXIT_LAYOUT_SHIFT_DURATION: 300 };
ExitingAnimation.__closure = { withTiming: fn(4640).withTiming, OPTION_ENTRY_EXIT_LAYOUT_SHIFT_DURATION: 300 };
...
export const useOptionEnteringAnimation = function useOptionEnteringAnimation() {
  sharedValue = sharedValue(4376).useSharedValue(false);
  ...
  return {
    EnteringAnimation: _slicedToArray(noop.useState(() => {
      const fn = function n() {
        ...
        const Easing = sharedValue(4376).Easing;
        obj2.easing = Easing.bezier(0.25, 1.75, 0.25, 1.25);
        const obj = sharedValue(4640);
        const withTimingResult = sharedValue(4640).withTiming(1, obj2);
        const obj4 = { animations: null, initialValues: null, callback: null };
        const obj5 = { opacity: null, transform: null };
        const obj3 = sharedValue(4640);
        const withTimingResult1 = sharedValue(4640).withTiming(1, { duration: 200 });
        obj5.opacity = sharedValue(4376).withDelay(200, withTimingResult1);
        const obj7 = { scale: null };
        const obj6 = sharedValue(4376);
        obj7.scale = sharedValue(4376).withDelay(200, withTimingResult);
        const items = [obj7];
        ...
        obj4.callback = function callback() {
          sharedValue(4376).runOnJS(closure_1_2)();
        };
        return obj4;
      };
