...
export const AppLauncherCommandViewHeader = function AppLauncherCommandViewHeader(onPress) {
  ...
  obj = { interpolate: scrollOffsetY(4296).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE: closure_8 };
  A.__closure = obj;
  ...
  obj = { APP_ICON_SIZE: 72, APP_ICON_BORDER_WIDTH: 4, DEFAULT_CONTENT_PADDING, interpolate: scrollOffsetY(4296).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE: closure_8 };
  E.__closure = obj;
  ...
  N.__closure = { interpolate: scrollOffsetY(4296).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE: closure_8 };
  N.__workletHash = 2637023147700;
  N.__initData = closure_12;
  const animatedStyle2 = obj4.useAnimatedStyle(N);
  obj1 = { interpolate: scrollOffsetY(4296).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE: closure_8 };
  ...
  if (null != memo) {
    ...
    obj2[0] = tmp.appIcon;
    obj2[1] = memo;
    let tmp15 = callback(tmp8(5587), obj2);
    let tmp16 = callback;
  } else {
  ...
  obj5[5] = displayName;
  items4[2] = tmp16(scrollOffsetY(4556).Text, obj5);
  items4[3] = tmp16(scrollOffsetY(1178).Spacer, { size: 32 });
  const items6 = [tmp.appIconMask, animatedStyle1];
  items4[4] = tmp16(section(4296).View, { style: items6, children: tmp15 });
  obj4[1] = items4;
