...
// Dependencies: [19, 17, 1483, 21, 12265, 4639, 576, 12185, 4376, 4341, 8252, 5672, 4635, 1177, 2]
// Exports: AppLauncherCommandViewHeader

// Module 12288 (AppLauncherCommandViewHeader)
...
const sum = fn(12265).BACK_BUTTON_SIZE + 2 * DEFAULT_CONTENT_PADDING + 36 + 4;
...
export const AppLauncherCommandViewHeader = function AppLauncherCommandViewHeader(onPress) {
  ...
  if (null != memo) {
    ...
    let tmp15 = closure_6(tmp8(5672), obj8);
    let tmp16 = closure_6;
  } else {
  ...
  obj11.style = items3;
  const items4 = [tmp16(section(4376).View, obj11), tmp16(section(12265), { onPress: onPress.onPressBack }), , , ];
  ...
  items4[2] = tmp16(scrollOffsetY(4635).Text, obj12);
