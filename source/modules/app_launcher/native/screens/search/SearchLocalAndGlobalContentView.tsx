...
// Dependencies: [32, 19, 17, 9422, 12202, 1483, 21, 4639, 576, 12185, 12190, 12239, 9541, 1115, 5690, 9421, 12188, 1612, 7156, 9678, 12201, 7630, 7628, 12240, 12241, 4351, 12224, 12217, 12236, 4635, 12242, 9034, 12243, 2]

// Module 12238 (SearchLocalAndGlobalContentView)
...
function CommandRow(arg0) {
  ...
  const appLauncherIconSource = hasOptions(12185).getAppLauncherIconSource(application);
  let tmp4 = null != appLauncherIconSource;
  if (tmp4) {
    const obj2 = { iconSource: appLauncherIconSource };
    tmp4 = closure_10(onPressSend(12190), obj2);
  }
  obj = hasOptions(12185);
  const tmpResult = hasOptions(12239);
  const commandRowSend = tmpResult.useCommandRowSend({ command, context, beforeExecuteCommand, onExecuteCommand, sectionName: hasOptions(9541).AppLauncherSectionName.SEARCH });
  ...
  const obj3 = { command, context, beforeExecuteCommand, onExecuteCommand, sectionName: hasOptions(9541).AppLauncherSectionName.SEARCH };
  obj4.subLabel = hasOptions(9421).getSectionName(application);
  obj4.start = isFirstRow;
  obj4.end = isLastRow;
  obj4.onPress = onPress;
  obj4.accessibilityActions = memo;
  obj4.onAccessibilityAction = callback;
  obj4.trailing = closure_10(onPressSend(12239), { hasOptions, sending: commandRowSend.sending, onPressSend });
  return closure_10(hasOptions(5690).TableRow, obj4);
}
...
const getSection = fn(9422).getSection;
const FetchState = fn(12202).FetchState;
