...
export const usePinnedSearchBarBottomBorder = function usePinnedSearchBarBottomBorder(arg0) {
  ...
  let tmp = closure_5();
  const sharedValue = triggerScrollHeight(4343).useSharedValue(0);
  ...
  let obj = triggerScrollHeight(4343);
  const fn = function u() {
    let num = 0;
  ...
  obj5.style = items2;
  obj4.bottomBorderComponent = jsx(sharedValue(4343).View, { style: null }, key);
  return obj4;
};
