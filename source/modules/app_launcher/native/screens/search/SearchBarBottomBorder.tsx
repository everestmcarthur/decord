...
// Dependencies: [19, 21, 4638, 576, 4374, 5059, 5063, 2]
// Exports: usePinnedSearchBarBottomBorder

// Module 12239 (SearchBarBottomBorder)
...
export const usePinnedSearchBarBottomBorder = function usePinnedSearchBarBottomBorder(arg0) {
  ...
  let tmp = closure_5();
  const sharedValue = triggerScrollHeight(4374).useSharedValue(0);
  ...
  let obj = triggerScrollHeight(4374);
  const fn = function u() {
    let num = 0;
  ...
  const obj2 = triggerScrollHeight(4374);
  fn.__closure = { withSpring: triggerScrollHeight(5059).withSpring, scrollPosition: sharedValue, triggerScrollHeight, springStandard: triggerScrollHeight(5063).springStandard };
  ...
  obj5.style = items2;
  obj4.bottomBorderComponent = jsx(sharedValue(4374).View, { style: null }, key);
  return obj4;
};
