...
// Dependencies: [19, 21, 4639, 576, 4376, 5058, 5062, 2]
// Exports: usePinnedSearchBarBottomBorder

// Module 12231 (SearchBarBottomBorder)
...
export const usePinnedSearchBarBottomBorder = function usePinnedSearchBarBottomBorder(arg0) {
  ...
  fn.__closure = { withSpring: triggerScrollHeight(5058).withSpring, scrollPosition: sharedValue, triggerScrollHeight, springStandard: triggerScrollHeight(5062).springStandard };
