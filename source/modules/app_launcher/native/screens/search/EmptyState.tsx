...
// Dependencies: [19, 17, 21, 4574, 12081, 9441, 1114, 4285, 4570, 2]
// Exports: default

// Module 12139 (search/EmptyState)
...
export default function EmptyState(showsGenericMessage) {
  ...
  const tmp = closure_5();
  const logAppLauncherEmptyStateView = flag(12081).useLogAppLauncherEmptyStateView(flag(9441).AppLauncherEmptyStateType.SEARCH_EMPTY, showsGenericMessage.query);
  const items = [flag];
  ...
  obj3.children = jsx(flag(4570).Text, { style: tmp.text, variant: "text-sm/medium", color: "text-default", children: null });
