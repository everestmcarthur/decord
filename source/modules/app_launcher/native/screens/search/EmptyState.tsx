...
// Dependencies: [19, 17, 21, 4722, 12293, 9647, 1115, 4433, 4718, 2]
// Exports: default

// Module 12351 (search/EmptyState)
...
export default function EmptyState(showsGenericMessage) {
  ...
  const tmp = closure_5();
  const logAppLauncherEmptyStateView = flag(12293).useLogAppLauncherEmptyStateView(flag(9647).AppLauncherEmptyStateType.SEARCH_EMPTY, showsGenericMessage.query);
  const items = [flag];
  ...
  obj3.children = jsx(flag(4718).Text, { style: tmp.text, variant: "text-sm/medium", color: "text-default", children: null });
