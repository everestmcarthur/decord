...
// Dependencies: [19, 17, 1483, 21, 4638, 576, 12273, 1612, 11361, 12193, 7633, 5208, 1115, 5714, 4634, 1177, 12235, 12198, 12271, 12240, 12243, 12244, 12194, 9552, 2]
// Exports: default
...
import AppLauncherBackButton from "AppLauncherBackButton" /* 12273 */;
...
let size = { width: fn(12273).BACK_BUTTON_SIZE, height: fn(12273).BACK_BUTTON_SIZE, alignItems: "center", justifyContent: "center" };
