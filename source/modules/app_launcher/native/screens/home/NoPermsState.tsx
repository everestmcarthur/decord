...
// Function ID: 12265
// Name: NoPermsState
// Dependencies: [19, 17, 21, 4640, 576, 4491, 4574, 12265, 12266, 12202, 9563, 4636, 1115, 2]
// Exports: default

// Module 12264 (NoPermsState)
...
export default function EmptyState() {
  const tmp = closure_7();
  const tmp4Result = importDefault(shared.isThemeLight(useThemeDefault()) ? 12265 : 12266);
  const logAppLauncherEmptyStateView = AppLauncherNativeUtils.useLogAppLauncherEmptyStateView(tmp2(9563).AppLauncherEmptyStateType.HOME_NO_PERMISSIONS);
