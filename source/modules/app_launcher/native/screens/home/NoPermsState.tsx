...
// Function ID: 12248
// Name: NoPermsState
// Dependencies: [19, 17, 21, 4639, 576, 4491, 4574, 12248, 12249, 12185, 9541, 4635, 1115, 2]
// Exports: default

// Module 12247 (NoPermsState)
...
export default function EmptyState() {
  const tmp = closure_7();
  const tmp4Result = importDefault(shared.isThemeLight(useThemeDefault()) ? 12248 : 12249);
  const logAppLauncherEmptyStateView = AppLauncherNativeUtils.useLogAppLauncherEmptyStateView(tmp2(9541).AppLauncherEmptyStateType.HOME_NO_PERMISSIONS);
