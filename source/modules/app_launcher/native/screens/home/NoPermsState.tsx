...
// Function ID: 12184
// Name: NoPermsState
// Dependencies: [19, 17, 21, 4605, 576, 4456, 4540, 12184, 12185, 12121, 9479, 4601, 1114, 2]
// Exports: default

// Module 12183 (NoPermsState)
...
export default function EmptyState() {
  const tmp = closure_7();
  const tmp4Result = importDefault(shared.isThemeLight(useThemeDefault()) ? 12184 : 12185);
  const logAppLauncherEmptyStateView = AppLauncherNativeUtils.useLogAppLauncherEmptyStateView(tmp2(9479).AppLauncherEmptyStateType.HOME_NO_PERMISSIONS);
