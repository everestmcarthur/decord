...
// Function ID: 9379
// Name: DetailsHeader
// Dependencies: [32, 19, 17, 21, 4606, 576, 4343, 9379, 9510, 5177, 8358, 5637, 4602, 1114, 4607, 4610, 5715, 5038, 1093, 2]
...
export default noop.memo(function DetailsHeader(viewContainerStyle) {
  ...
  const isPartnerApplicationResult = sharedValue(9379).isPartnerApplication(application);
  ...
  const sectionName = sharedValue(9379).getSectionName(application);
  const obj5 = sharedValue(9379);
  const str = sharedValue(9379).getSectionDescription(application);
  ...
  if (!hideName) {
    ...
    tmp30Result = tmp30(tmp2(4602).Heading, obj10);
  }
  ...
  if (isPartnerApplicationResult) {
    ...
    obj11.children = tmp30(tmp2(4602).Text, obj12);
  ...
  if (tmp28Result5) {
    ...
    if (tmp27) {
      ...
      items8[1] = tmp30(tmp23(5038), obj19);
      if (num2 == null) {
        num2 = 0;
      }
    ...
    obj22.children = tmp30(tmp2(4602).Text, obj23);
    const items10 = [tmp30(tmp23(5715), obj22), , ];
    ...
    if (tmp27) {
      ...
      obj24.children = tmp28(tmp2(4602).Text, obj25);
  ...
  if (!first2) {
    ...
    if (!hideName) {
      ...
      tmp30Result9 = tmp30(tmp2(4602).Heading, obj28);
    }
    ...
    if (tmp28Result5) {
      ...
      const items15 = [tmp30(tmp2(4602).Text, obj30), ];
      ...
      items15[1] = tmp30(tmp2(4602).Text, obj31);
