...
// Function ID: 9443
// Name: DetailsHeader
// Dependencies: [32, 19, 17, 21, 4640, 576, 4376, 9443, 9573, 5213, 8421, 5674, 4636, 1115, 4641, 4644, 5752, 5074, 1094, 2]

// Module 9442 (DetailsHeader)
...
export default noop.memo(function DetailsHeader(viewContainerStyle) {
  ...
  const isPartnerApplicationResult = sharedValue(9443).isPartnerApplication(application);
  ...
  const sectionName = sharedValue(9443).getSectionName(application);
  const obj5 = sharedValue(9443);
  const str = sharedValue(9443).getSectionDescription(application);
  ...
  isScreenLandscape = sharedValue(5213).useIsScreenLandscape();
  const tmp24 = first(8421)(isScreenLandscape);
  closure_18 = tmp24;
  ...
  let tmp27 = first;
  const tmp2Result = sharedValue(5213);
  if (first) {
    tmp27 = !first1;
  }
  ...
  if (!hideName) {
    ...
    tmp30Result = tmp30(tmp2(4636).Heading, obj10);
  }
  ...
  if (isPartnerApplicationResult) {
    ...
    obj11.children = tmp30(tmp2(4636).Text, obj12);
  ...
  if (tmp28Result5) {
    ...
    if (tmp27) {
      ...
      items8[1] = tmp30(tmp23(5074), obj19);
      if (num2 == null) {
        num2 = 0;
      }
    ...
    obj22.children = tmp30(tmp2(4636).Text, obj23);
    const items10 = [tmp30(tmp23(5752), obj22), , ];
    ...
    if (tmp27) {
      ...
      obj24.children = tmp28(tmp2(4636).Text, obj25);
  ...
  if (!first2) {
    ...
    if (!hideName) {
      ...
      tmp30Result9 = tmp30(tmp2(4636).Heading, obj28);
    }
    ...
    if (tmp28Result5) {
      ...
      const items15 = [tmp30(tmp2(4636).Text, obj30), ];
      ...
      items15[1] = tmp30(tmp2(4636).Text, obj31);
