...
// Dependencies: [19, 17, 12205, 1182, 21, 4605, 576, 1114, 5173, 4572, 12220, 1896, 4601, 11225, 2]
// Exports: default
...
export default function CommandListSortButton(sortOrder) {
  ...
  const obj = {
    ...
    style: tmp.container,
    onPress() {
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12220, dependencyMap.paths), "CommandListSortActionSheet", {
        sortOrder,
        onSortOptionPress,
        onClose() {
  ...
  const items = [closure_6(sortOrder(4601).Text, { variant: "text-sm/medium", color: "text-default", children: stringResult }), closure_6(sortOrder(11225).ChevronSmallDownIcon, { size: "xs", color: onSortOptionPress(576).colors.TEXT_DEFAULT })];
  obj2.children = items;
