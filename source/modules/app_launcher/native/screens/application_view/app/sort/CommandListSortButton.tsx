...
// Dependencies: [19, 17, 12269, 1181, 21, 4639, 576, 1115, 5207, 4606, 12284, 1897, 4635, 11292, 2]
// Exports: default

// Module 12283 (CommandListSortButton)
...
export default function CommandListSortButton(sortOrder) {
  ...
  const obj = {
    ...
    style: tmp.container,
    onPress() {
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12284, dependencyMap.paths), "CommandListSortActionSheet", {
        sortOrder,
        onSortOptionPress,
        onClose() {
  ...
  const items = [closure_6(sortOrder(4635).Text, { variant: "text-sm/medium", color: "text-default", children: stringResult }), closure_6(sortOrder(11292).ChevronSmallDownIcon, { size: "xs", color: onSortOptionPress(576).colors.TEXT_DEFAULT })];
  obj2.children = items;
  obj.children = closure_7(View, obj2);
  return closure_6(sortOrder(5207).PressableOpacity, obj);
};
