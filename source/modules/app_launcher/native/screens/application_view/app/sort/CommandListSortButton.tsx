...
// Dependencies: [19, 17, 12377, 1181, 21, 4722, 576, 1115, 5292, 4689, 12392, 1897, 4718, 11406, 2]
// Exports: default

// Module 12391 (CommandListSortButton)
...
const CommandListSortOrder = fn(12377).CommandListSortOrder;
...
export default function CommandListSortButton(sortOrder) {
  ...
  const obj = {
    ...
    style: tmp.container,
    onPress() {
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12392, dependencyMap.paths), "CommandListSortActionSheet", {
        sortOrder,
        onSortOptionPress,
        onClose() {
  ...
  const items = [closure_6(sortOrder(4718).Text, { variant: "text-sm/medium", color: "text-default", children: stringResult }), closure_6(sortOrder(11406).ChevronSmallDownIcon, { size: "xs", color: onSortOptionPress(576).colors.TEXT_DEFAULT })];
  obj2.children = items;
  obj.children = closure_7(View, obj2);
  return closure_6(sortOrder(5292).PressableOpacity, obj);
};
