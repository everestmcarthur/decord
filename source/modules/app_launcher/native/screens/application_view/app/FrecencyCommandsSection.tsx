...
// Dependencies: [19, 17, 1074, 21, 4636, 12258, 12277, 4816, 9539, 4632, 1114, 7626, 2]
// Exports: default
...
let obj2 = { container: { marginBottom: fn(12258).BETWEEN_SECTIONS_MARGIN }, header: { flexDirection: "row", alignItems: "center", gap: 4, marginBottom: 8 } };
