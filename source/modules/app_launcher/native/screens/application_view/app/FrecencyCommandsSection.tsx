...
// Dependencies: [19, 17, 1074, 21, 4607, 12224, 12243, 4787, 9502, 4603, 1114, 7597, 2]
// Exports: default

// Module 12242 (FrecencyCommandsSection)
...
import AppDetailContent from "AppDetailContent" /* 12224 */;
import useFilterAndSortToOnlyFrecentCommandsDefault from "useFilterAndSortToOnlyFrecentCommands" /* 12243 */;
...
let obj2 = { container: { marginBottom: fn(12224).BETWEEN_SECTIONS_MARGIN }, header: { flexDirection: "row", alignItems: "center", gap: 4, marginBottom: 8 } };
...
export default function FrecencyCommandsSection(commands) {
  ...
  if (0 !== arr.length) {
    ...
    obj2.children = arr(context(4603).Heading, obj3);
