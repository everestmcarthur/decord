...
// Dependencies: [19, 17, 1372, 9540, 1483, 1074, 21, 576, 4639, 4376, 504, 12185, 4341, 8252, 12190, 9421, 8984, 12265, 4635, 1177, 8205, 4583, 1241, 7296, 12266, 4337, 1115, 12267, 2]
// Exports: default

// Module 12264 (application_view/Header)
...
import AppLauncherBackButtonDefault from "AppLauncherBackButton" /* 12265 */;
...
export default function Header(application) {
  ...
  if (null != application) {
    appLauncherIconSource = tmp(12185).getAppLauncherIconSource(application);
    const tmpResult = tmp(12185);
  }
  ...
  if (null != appLauncherIconSource) {
    ...
    let tmp12 = closure_8(tmp5(12190), obj2);
    let tmp13 = closure_8;
  } else {
  ...
  if (null != application) {
    str2 = tmp(9421).getSectionName(application);
    const tmpResult14 = tmp(9421);
  }
  ...
  if (hasApplicationFlagResult) {
    hasApplicationFlagResult = tmp(8984).hasApplicationFlag(application, constants2.EMBEDDED);
    const tmpResult15 = tmp(8984);
  }
  ...
  const tmp23 = id;
  items6[2] = tmp13(ReanimatedRexportDefault.View, { style: animatedStyle2, pointerEvents: "none", children: tmp13(application(4635).Heading, { variant: "heading-lg/bold", color: "text-overlay-light", children: str2 }) });
  ...
  if (null != application) {
    ...
    if (tmpResult16.isRealApplication(application)) {
      ...
      const obj15 = {
        ...
        onPress() {
              ...
              if (c2) {
                ...
                const merged = Object.assign(tmp4(9421).getInstallAppProps(tmp2));
                activityLaunchURL = obj4.getApplicationInstallURL(obj6);
                const tmp4Result = tmp4(9421);
              }
      ...
      const items7 = [tmp13(tmp(8205).IconButton, obj15), ];
      const obj16 = { application, onAddAppMenuClick };
      items7[1] = tmp13(tmp5(12267), obj16);
      obj14.children = items7;
      tmp22Result = tmp22(tmp23, obj14);
    }
    tmpResult16 = tmp(9421);
  }
