...
// Dependencies: [19, 17, 1371, 9499, 1482, 1074, 21, 576, 4606, 4343, 504, 12144, 4308, 8217, 12149, 9379, 8946, 12224, 4602, 1178, 8172, 4550, 1242, 7262, 12225, 4304, 1114, 12226, 2]
// Exports: default

// Module 12223 (application_view/Header)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import ToastUtils from "ToastUtils" /* 4304 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4343 */;
import ClipboardUtils from "ClipboardUtils" /* 7262 */;
import useAvatarColorDefault from "useAvatarColor" /* 8217 */;
import AppLauncherBackButtonDefault from "AppLauncherBackButton" /* 12224 */;
import getApplicationInstallURL from "getApplicationInstallURL" /* 12225 */;
...
export default function Header(application) {
  ...
  if (null != application) {
    appLauncherIconSource = tmp(12144).getAppLauncherIconSource(application);
    const tmpResult = tmp(12144);
  }
  let obj = application(504);
  let str = application(4308).useToken(nativeDefault.colors.BACKGROUND_BASE_LOW);
  let tmp7 = appLauncherIconSource;
  const tmpResult9 = application(4308);
  ...
  if (null != appLauncherIconSource) {
    ...
    let tmp12 = closure_8(tmp5(12149), obj2);
    let tmp13 = closure_8;
  } else {
  ...
  const tmpResult10 = application(4343);
  fn.__closure = { interpolate: application(4343).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn.__workletHash = 2572905048492;
  fn.__initData = __initData;
  closure_130_0 = scrollOffsetY;
  const animatedStyle = tmpResult10.useAnimatedStyle(fn);
  let obj4 = { interpolate: application(4343).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult11 = application(4343);
  fn2.__closure = { interpolate: application(4343).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn2.__workletHash = 8190094903650;
  fn2.__initData = __initData2;
  const animatedStyle1 = tmpResult11.useAnimatedStyle(fn2);
  let obj5 = { interpolate: application(4343).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult12 = application(4343);
  fn3.__closure = { interpolate: application(4343).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn3.__workletHash = 14190901941859;
  fn3.__initData = __initData3;
  closure_131_0 = scrollOffsetY;
  const animatedStyle2 = tmpResult12.useAnimatedStyle(fn3);
  let obj6 = { interpolate: application(4343).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult13 = application(4343);
  fn4.__closure = { interpolate: application(4343).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn4.__workletHash = 9589752719246;
  fn4.__initData = __initData4;
  let str2 = "";
  const animatedStyle3 = tmpResult13.useAnimatedStyle(fn4);
  if (null != application) {
    str2 = tmp(9379).getSectionName(application);
    const tmpResult14 = tmp(9379);
  }
  ...
  if (hasApplicationFlagResult) {
    hasApplicationFlagResult = tmp(8946).hasApplicationFlag(application, constants2.EMBEDDED);
    const tmpResult15 = tmp(8946);
  }
  ...
  const obj7 = { interpolate: application(4343).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  const tmp23 = id;
  items6[2] = tmp13(ReanimatedRexportDefault.View, { style: animatedStyle2, pointerEvents: "none", children: tmp13(application(4602).Heading, { variant: "heading-lg/bold", color: "text-overlay-light", children: str2 }) });
  ...
  if (null != application) {
    ...
    if (tmpResult16.isRealApplication(application)) {
      ...
      const obj15 = {
        ...
        onPress() {
              ...
              if (c2) {
                ...
                const merged = Object.assign(tmp4(9379).getInstallAppProps(tmp2));
      ...
      const items7 = [tmp13(tmp(8172).IconButton, obj15), ];
      const obj16 = { application, onAddAppMenuClick };
      items7[1] = tmp13(tmp5(12226), obj16);
      obj14.children = items7;
      tmp22Result = tmp22(tmp23, obj14);
    }
    tmpResult16 = tmp(9379);
  }
