...
// Dependencies: [19, 17, 4630, 21, 4638, 5065, 576, 4639, 4642, 504, 7987, 12179, 4374, 5615, 12385, 12204, 2]
// Exports: AppLauncherOnboardingChatInputButtonAnimation

// Module 12384 (AppLauncherOnboardingChatInputButtonAnimation)
...
import useAppLauncherOnboardingContentDefault from "useAppLauncherOnboardingContent" /* 12179 */;
import _mod12204 from "module_12204" /* 12204 */;
...
EnteringAnimation.__closure = { withTiming: fn(4639).withTiming, timingStandard: fn(4642).timingStandard };
...
ExitingAnimation.__closure = { withTiming: fn(4639).withTiming, timingStandard: fn(4642).timingStandard };
