...
// Dependencies: [32, 1957, 4494, 1371, 12074, 12075, 5013, 1090, 504, 11, 1943, 7402, 4394, 2]
// Exports: default

// Module 12073 (useCanShowAppLauncherOnboarding)
...
import AppLauncherOnboardingStore from "AppLauncherOnboardingStore" /* 12075 */;
...
export default function useCanShowAppLauncherOnboarding(channelId) {
  ...
  const tmp2Result11 = channelId(7402);
  ...
  result = channelId(4394).useIsDismissibleContentDismissed_UNSAFE(tmp2(1943).DismissibleContent.APP_LAUNCHER_ONBOARDING_BOTS_BANNER);
  const tmp2Result14 = channelId(4394);
  let result1 = channelId(4394).useIsDismissibleContentDismissed_UNSAFE(tmp2(1943).DismissibleContent.APP_LAUNCHER_ONBOARDING_APPS_BANNER);
  const tmp2Result15 = channelId(4394);
  let tmp30 = null != stateFromStores4;
  const result2 = channelId(4394).useIsDismissibleContentDismissed_UNSAFE(tmp2(1943).DismissibleContent.APP_LAUNCHER_ONBOARDING_ACTIVITIES_BANNER);
  if (tmp30) {
