...
// Dependencies: [32, 1958, 4559, 1372, 12178, 12179, 5083, 1091, 504, 11, 1944, 7495, 4460, 2]
// Exports: default

// Module 12177 (useCanShowAppLauncherOnboarding)
...
export default function useCanShowAppLauncherOnboarding(channelId) {
  ...
  const tmp2Result11 = channelId(7495);
