...
// Function ID: 12204
// Name: BannerBase
// Dependencies: [32, 19, 17, 4630, 21, 576, 4638, 12192, 4374, 1478, 4487, 504, 5059, 5072, 5615, 12204, 4634, 2]
// Exports: default

// Module 12203 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj8.style = items3;
  const items4 = [closure_7(sharedValue(5072), obj8), , ];
  ...
  obj10.source = require("module_12204");
  obj10.autoPlay = !stateFromStores;
  const items5 = [closure_7(sharedValue(5615), obj10), image];
  ...
  return closure_8(sharedValue(4374).View, obj7);
};
