...
// Function ID: 12132
// Name: BannerBase
// Dependencies: [32, 19, 17, 4597, 21, 576, 4605, 12120, 4341, 1477, 4454, 504, 5024, 5037, 5579, 12132, 4601, 2]
// Exports: default
...
export default function BannerBase(arg0) {
  ...
  obj8.style = items3;
  const items4 = [closure_7(sharedValue(5037), obj8), , ];
  ...
  obj10.source = require("module_12132");
  obj10.autoPlay = !stateFromStores;
  const items5 = [closure_7(sharedValue(5579), obj10), image];
  ...
  return closure_8(sharedValue(4341).View, obj7);
};
