...
// Function ID: 12304
// Name: BannerBase
// Dependencies: [32, 19, 17, 4714, 21, 576, 4722, 12292, 4458, 1478, 4571, 504, 5143, 5156, 5699, 12304, 4718, 2]
// Exports: default

// Module 12303 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj8.style = items3;
  const items4 = [closure_7(sharedValue(5156), obj8), , ];
  ...
  obj10.source = require("module_12304");
  obj10.autoPlay = !stateFromStores;
  const items5 = [closure_7(sharedValue(5699), obj10), image];
  ...
  return closure_8(sharedValue(4458).View, obj7);
};
