...
// Function ID: 12213
// Name: BannerBase
// Dependencies: [32, 19, 17, 4632, 21, 576, 4640, 12201, 4376, 1478, 4489, 504, 5061, 5074, 5617, 12213, 4636, 2]
// Exports: default

// Module 12212 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj8.style = items3;
  const items4 = [closure_7(sharedValue(5074), obj8), , ];
  ...
  obj10.source = require("module_12213");
  obj10.autoPlay = !stateFromStores;
  const items5 = [closure_7(sharedValue(5617), obj10), image];
