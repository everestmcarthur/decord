...
// Function ID: 12092
// Name: BannerBase
// Dependencies: [32, 19, 17, 4566, 21, 576, 4574, 12080, 4310, 1477, 4423, 504, 4988, 5001, 5543, 12092, 4570, 2]
// Exports: default

// Module 12091 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj8.style = items3;
  const items4 = [closure_7(sharedValue(5001), obj8), , ];
  ...
  obj10.source = require("module_12092");
  obj10.autoPlay = !stateFromStores;
  const items5 = [closure_7(sharedValue(5543), obj10), image];
  ...
  return closure_8(sharedValue(4310).View, obj7);
};
