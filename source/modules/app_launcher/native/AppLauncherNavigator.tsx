...
// Dependencies: [109, 19, 1482, 1074, 21, 7965, 4605, 576, 7214, 7234, 4472, 1609, 7052, 4785, 1484, 12153, 12197, 12223, 12265, 11287, 2]

// Module 12152 (AppLauncherNavigator)
...
import AppLauncherHomeScreenDefault from "AppLauncherHomeScreen" /* 12153 */;
import AppLauncherApplicationViewScreenDefault from "AppLauncherApplicationViewScreen" /* 12197 */;
import AppLauncherCommandViewScreenDefault from "AppLauncherCommandViewScreen" /* 12223 */;
import AppLauncherViewAllScreenDefault from "AppLauncherViewAllScreen" /* 12265 */;
...
export default noop.memo(function AppLauncherNavigator(arg0) {
  ...
  obj = entrypoint(4472);
  const accessibilityNativeStackOptions = entrypoint(7052).useAccessibilityNativeStackOptions();
  ...
  obj17.children = closure_8(entrypoint(7214).AnalyticsLocationProvider, obj2);
  obj16.children = closure_8(entrypoint(1484).NavigationContainer, obj17);
  let tmp19 = "customId" in overrideParams;
  const obj14 = { context };
  const tmp5Result = entrypoint(7052);
  if (!tmp19) {
  ...
  return closure_8(entrypoint(11287).AppLauncherContext.Provider, { value: { bottomSheetExpandReasonRef, bottomSheetIndex, bottomSheetPosition, chatInputRef, entrypoint, entrypointParams: tmp20, keyboardCloseReasonRef, onActivityItemSelected, width }, children: closure_8(entrypoint(1484).NavigationIndependentTree, obj16) });
});
