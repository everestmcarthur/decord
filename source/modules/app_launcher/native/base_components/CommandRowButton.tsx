...
// Dependencies: [5, 32, 19, 21, 12170, 9432, 12135, 7633, 5698, 5060, 1115, 4582, 2]
...
export default function CommandRowIcon(hasOptions) {
  if (hasOptions.hasOptions) {
    let tmp3Result = tmp3(tmp4(5698).TableRowArrow, {});
  } else {
    ...
    obj.onPress = tmp2;
    obj.icon = tmp3(tmp4(4582).SendMessageIcon, { size: "sm" });
    obj.disabled = tmp;
    tmp3Result = tmp3(tmp4(5060).Button, obj);
  }
  return tmp3Result;
};
