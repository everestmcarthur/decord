...
// Function ID: 12243
// Name: ExpandableList
// Dependencies: [32, 19, 17, 21, 4639, 8393, 4376, 4640, 4643, 5690, 1115, 4635, 2]
// Exports: default

// Module 12242 (ExpandableList)
...
export default function ExpandableList(onExpand) {
  ...
  A.__closure = { collapsedListHeight: sharedValue, withTiming: memo1(4640).withTiming, containerHeight: derivedValue, timingStandard: memo1(4643).timingStandard };
  ...
  if (!showsExpandCTAOverride) {
    ...
    obj13.children = tmp16(tmp9(4635).Text, obj15);
    ...
    obj12 = tmp16(tmp9(5690).TableRow, obj12);
