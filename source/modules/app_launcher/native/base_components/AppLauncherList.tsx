...
// Dependencies: [19, 17, 21, 4639, 1612, 12236, 4346, 1177, 12302, 1115, 7157, 2]
// Exports: AppLauncherListEmptyState, AppLauncherListSearchBar

// Module 12301 (AppLauncherList)
...
export const AppLauncherList = noop.forwardRef((contentContainerStyle, arg1) => {
  ...
  return jsx(appLauncherFlashListProps(12236), { contentContainerStyle: null, scrollIndicatorInsets: { bottom }, ref: memo });
});
export const AppLauncherListEmptyState = function AppLauncherListEmptyState() {
  const tmp = closure_6();
  const obj = { style: tmp.emptyState, imageStyle: tmp.emptyStateImage, lightSource: _modDef12302, darkSource: _modDef12302, title: null, body: null };
  const intl = util.intl;
  obj.title = intl.string(util.t.vYocDz);
  const intl2 = util.intl;
  obj.body = intl2.string(util.t.V6nAfF);
  return jsx(native.EmptyState, { style: tmp.emptyState, imageStyle: tmp.emptyStateImage, lightSource: _modDef12302, darkSource: _modDef12302, title: null, body: null });
};
