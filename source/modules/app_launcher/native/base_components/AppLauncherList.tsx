...
// Dependencies: [19, 17, 21, 4640, 1612, 12253, 4346, 1177, 12319, 1115, 7164, 2]
// Exports: AppLauncherListEmptyState, AppLauncherListSearchBar

// Module 12318 (AppLauncherList)
...
export const AppLauncherList = noop.forwardRef((contentContainerStyle, arg1) => {
  ...
  return jsx(appLauncherFlashListProps(12253), { contentContainerStyle: null, scrollIndicatorInsets: { bottom }, ref: memo });
});
export const AppLauncherListEmptyState = function AppLauncherListEmptyState() {
  const tmp = closure_6();
  const obj = { style: tmp.emptyState, imageStyle: tmp.emptyStateImage, lightSource: _modDef12319, darkSource: _modDef12319, title: null, body: null };
  const intl = util.intl;
  obj.title = intl.string(util.t.vYocDz);
  const intl2 = util.intl;
  obj.body = intl2.string(util.t.V6nAfF);
  return jsx(native.EmptyState, { style: tmp.emptyState, imageStyle: tmp.emptyStateImage, lightSource: _modDef12319, darkSource: _modDef12319, title: null, body: null });
};
