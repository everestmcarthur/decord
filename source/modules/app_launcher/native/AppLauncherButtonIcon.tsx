...
// Dependencies: [19, 17, 21, 4506, 1610, 11101, 5191, 2]
// Exports: AppLauncherButtonIcon

// Module 12386 (AppLauncherButtonIcon)
...
export const AppLauncherButtonIcon = function AppLauncherButtonIcon(style) {
  ...
  if (tmp3 === KeyboardTypes.KeyboardTypes.APP_LAUNCHER) {
    ...
    items[1] = obj3;
    obj2.style = items;
    let tmp4Result = tmp4(tmp6(11101).PlusLargeIcon, obj2);
  } else {
    const obj4 = { style };
    const merged2 = Object.assign(merged);
    tmp4Result = tmp4(tmp6(5191).AppsIcon, obj4);
  }
