...
// Dependencies: [19, 17, 21, 4504, 1609, 11082, 5187, 2]
// Exports: AppLauncherButtonIcon

// Module 12373 (AppLauncherButtonIcon)
...
export const AppLauncherButtonIcon = function AppLauncherButtonIcon(style) {
  ...
  if (tmp3 === KeyboardTypes.KeyboardTypes.APP_LAUNCHER) {
    ...
    items[1] = obj3;
    obj2.style = items;
    let tmp4Result = tmp4(tmp6(11082).PlusLargeIcon, obj2);
  } else {
    const obj4 = { style };
    const merged2 = Object.assign(merged);
    tmp4Result = tmp4(tmp6(5187).AppsIcon, obj4);
  }
