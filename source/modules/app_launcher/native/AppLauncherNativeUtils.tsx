...
// Dependencies: [19, 1958, 1372, 1483, 1074, 5086, 4820, 7637, 12203, 7635, 1895, 7898, 1885, 9443, 1397, 11369, 9770, 12208, 7282, 9669, 4608, 2]
...
// Module 12202 (AppLauncherNativeUtils)
...
import ApplicationCommandActionCreatorsAll from "ApplicationCommandActionCreators" /* 7898 */;
...
export const handleApplicationSelected = function handleApplicationSelected(entrypoint) {
  ...
  if (application.id === BuiltInSectionId.BUILT_IN) {
    let APP = tmp(7637).ApplicationCommandTriggerSections.BUILT_IN;
  } else {
    APP = tmp(7637).ApplicationCommandTriggerSections.APP;
  }
  obj2.section = APP;
...
export const getInitialOptionValues = function getInitialOptionValues(option) {
  ...
  if (Server.ApplicationCommandOptionType.BOOLEAN === type) {
    ...
    if (tmp2(1895).ApplicationCommandOptionType.STRING !== type) {
      if (tmp2(1895).ApplicationCommandOptionType.INTEGER !== type) {
        if (tmp2(1895).ApplicationCommandOptionType.NUMBER !== type) {
          if (tmp2(1895).ApplicationCommandOptionType.CHANNEL === type) {
            if (null != found) {
