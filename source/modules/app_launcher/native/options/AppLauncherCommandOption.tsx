...
// Dependencies: [19, 17, 1482, 21, 4574, 576, 1894, 12194, 12200, 12202, 12205, 12207, 12208, 12210, 5530, 12213, 12214, 12220, 5137, 6630, 2]
// Exports: default

// Module 12193 (AppLauncherCommandOption)
import nativeDefault from "native" /* 576 */;
import utils_AutocompleteUtilsDefault from "utils/AutocompleteUtils" /* 5530 */;
import AppLauncherChoicesOptionDefault from "AppLauncherChoicesOption" /* 12194 */;
import AppLauncherAttachmentOptionDefault from "AppLauncherAttachmentOption" /* 12205 */;
import AppLauncherBooleanOptionDefault from "AppLauncherBooleanOption" /* 12207 */;
import AppLauncherMentionableOptionDefault from "AppLauncherMentionableOption" /* 12208 */;
import AppLauncherMentionableListActionSheet from "AppLauncherMentionableListActionSheet" /* 12210 */;
import AppLauncherRoleOptionDefault from "AppLauncherRoleOption" /* 12213 */;
import AppLauncherUserOptionDefault from "AppLauncherUserOption" /* 12214 */;
import AppLauncherChannelOptionDefault from "AppLauncherChannelOption" /* 12220 */;
...
export default function AppLauncherCommandOption(option) {
      ...
      if (tmp2(1894).ApplicationCommandOptionType.NUMBER !== type) {
          ...
          obj4.onMentionablePress = function onMentionablePress(mentionable) {
            ...
            if (null != mentionable) {
              ...
              if (AppLauncherMentionableListActionSheet.MentionableItemTypes.USER === type) {
                ...
                const items = [obj2];
                View(name, items);
              } else if (tmp4(12210).MentionableItemTypes.ROLE === type) {
                const obj3 = { type: "roleMention", roleId: mentionable.result.id };
                const items1 = [obj3];
                View(name, items1);
              } else if (tmp4(12210).MentionableItemTypes.GLOBAL === type) {
        ...
        if (null != onDismiss) {
          ...
          const obj9 = {
            ...
            children: tmp13(tmp2(6630).CircleXIcon, { size: "md" })
          };
          items[1] = tmp13(tmp2(5137).PressableOpacity, obj9);
          obj7.children = items;
  ...
  if (null != name.choices) {
    ...
    tmp63(tmp64(12200), obj11, name.name);
    const tmp64Result = tmp64(12200);
  } else {
    ...
    tmp63(tmp64(12202), obj12, name.name);
    const tmp64Result2 = tmp64(12202);
  }
};
