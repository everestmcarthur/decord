...
// Dependencies: [32, 19, 17, 7851, 1979, 1074, 5050, 21, 12, 9502, 4606, 576, 563, 4573, 12259, 12260, 1114, 38, 5656, 4791, 4602, 1178, 12261, 2]
// Exports: default

// Module 12264 (AppLauncherAutocompleteActionSheet)
...
function Item(arg0) {
  ...
  const match = _mod4791.match(item);
...
function AutocompleteFailedEmptyState() {
  const obj = { style: closure_12().emptyState, lightSource: _modDef12261, darkSource: _modDef12261, title: null };
...
const executeCommand = apply.debounce(executeCommandDefault, fn(5050).AUTOCOMPLETE_OPTION_DEBOUNCE_TIME, { leading: true, trailing: true });
