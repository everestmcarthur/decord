...
// Dependencies: [32, 19, 1074, 21, 4640, 576, 1875, 4607, 12322, 1897, 12320, 5210, 4636, 2]
// Exports: default

// Module 12321 (AppLauncherAutocompleteOption)
...
export default function AppLauncherAutocompleteOption(arg0) {
  ...
  function onPress() {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12322, dependencyMap.paths), "AppLauncherAutocompleteActionSheet", {
      option,
      initChoice,
      onChoiceSelect(arg0) {
        closure_1_9(arg0);
