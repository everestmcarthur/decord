...
// Dependencies: [32, 19, 1074, 21, 4606, 576, 1874, 4573, 12264, 1896, 12262, 5174, 4602, 2]
// Exports: default

// Module 12263 (AppLauncherAutocompleteOption)
...
import useAnimationDelayedAutoFocus from "useAnimationDelayedAutoFocus" /* 12262 */;
...
export default function AppLauncherAutocompleteOption(arg0) {
  ...
  function onPress() {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12264, dependencyMap.paths), "AppLauncherAutocompleteActionSheet", {
      option,
      initChoice,
      onChoiceSelect(arg0) {
        closure_1_9(arg0);
