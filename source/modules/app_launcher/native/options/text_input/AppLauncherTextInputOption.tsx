...
// Dependencies: [32, 19, 17, 1374, 21, 4605, 576, 11287, 1894, 10348, 12239, 9479, 1178, 12243, 1115, 12244, 1874, 11193, 2]
// Exports: default

// Module 12242 (AppLauncherTextInputOption)
...
export default function AppLauncherTextInputOption(guildId) {
  ...
  const animationDelayedAutoFocus = onChangeText(12239).useAnimationDelayedAutoFocus(autoFocus, () => {
    const current = ref.current;
    if (current != null) {
      current.focus();
    }
  ...
  if (tmp14Result) {
    ...
    tmp14Result = tmp14(guildId(12244), obj5);
  }
