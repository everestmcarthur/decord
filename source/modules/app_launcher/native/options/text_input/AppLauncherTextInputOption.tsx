...
// Dependencies: [32, 19, 17, 1374, 21, 4607, 576, 11311, 1894, 10369, 12264, 9502, 1178, 12268, 1115, 12269, 1874, 11218, 2]
// Exports: default

// Module 12267 (AppLauncherTextInputOption)
...
export default function AppLauncherTextInputOption(guildId) {
  ...
  let obj = onChangeText(11311);
  const animationDelayedAutoFocus = onChangeText(12264).useAnimationDelayedAutoFocus(autoFocus, () => {
    const current = ref.current;
    if (current != null) {
      current.focus();
    }
  });
  if (obj.useAppLauncherContext().entrypoint === onChangeText(9502).AppLauncherEntrypoint.VOICE) {
    let TextInput = tmp4(1178).TextInput;
  } else {
    TextInput = guildId(12268);
  }
  ...
  if (tmp14Result) {
    ...
    tmp14Result = tmp14(guildId(12269), obj5);
  }
