...
// Dependencies: [32, 19, 17, 1483, 21, 4640, 576, 8873, 1612, 1364, 5530, 8748, 4607, 7057, 12317, 12318, 2]
// Exports: default

// Module 12316 (AppLauncherChoicesActionSheet)
...
export default function AppLauncherChoicesActionSheet(option) {
  ...
  if (tmp13) {
    ...
    tmp16 = closure_7(tmp3(12318).AppLauncherListSearchBar, obj3);
  }
  const items3 = [tmp16, ];
  if (0 === data.length) {
    let tmp20 = closure_7(tmp3(12318).AppLauncherListEmptyState, {});
  } else {
  ...
  return closure_8(option(12317).AppLauncherCommandOptionActionSheet, obj2);
};
