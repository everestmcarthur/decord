...
// Dependencies: [32, 19, 21, 4640, 576, 1875, 4607, 12316, 1897, 12320, 8748, 4636, 2]
// Exports: default

// Module 12315 (AppLauncherChoicesOption)
...
export default function AppLauncherChoicesOption(option) {
  ...
  const callback = onDismissChoicesSheet.useCallback(() => {
    ...
    obj2.openLazy(asyncRequireImpl(12316, dependencyMap.paths), "AppLauncherChoicesActionSheet", obj3);
  }, items);
  let tmp = closure_6();
