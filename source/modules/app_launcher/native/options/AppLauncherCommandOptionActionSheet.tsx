...
// Dependencies: [19, 17, 1483, 21, 4640, 576, 7264, 7263, 7312, 4607, 1177, 2]
// Exports: AppLauncherCommandOptionActionSheet

// Module 12317 (AppLauncherCommandOptionActionSheet)
...
export const AppLauncherCommandOptionActionSheet = function AppLauncherCommandOptionActionSheet(startExpanded) {
  ...
  const obj4 = {
    ...
    children: jsx(merged(7312).ActionSheetCloseButton, {
      onPress() {
  ...
  obj3.leading = <View style={{ alignSelf: "flex-start" }}>{jsx(merged(7312).ActionSheetCloseButton, {
    onPress() {
      ActionSheetActionCreatorsDefault.hideActionSheet();
      const onDismiss = merged.onDismiss;
      if (onDismiss != null) {
  ...
  obj.header = jsx(merged(7263).BottomSheetTitleHeader, { titleContainerStyle: tmp2.titleContainer, titleWrapperStyle: tmp2.titleWrapper, subtitleStyle: tmp2.subtitleWrapper, leading: null, title: null, subtitle: null, trailing: null });
  ...
  return jsx(merged(7264).BottomSheet, {}, option.name);
};
