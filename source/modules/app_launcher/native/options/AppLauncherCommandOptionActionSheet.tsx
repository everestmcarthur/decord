...
// Dependencies: [19, 17, 1482, 21, 4605, 576, 7202, 7201, 7250, 4572, 1178, 2]
// Exports: AppLauncherCommandOptionActionSheet

// Module 12236 (AppLauncherCommandOptionActionSheet)
...
export const AppLauncherCommandOptionActionSheet = function AppLauncherCommandOptionActionSheet(startExpanded) {
  ...
  obj3.leading = <View style={{ alignSelf: "flex-start" }}>{jsx(merged(7250).ActionSheetCloseButton, {
    onPress() {
      ActionSheetActionCreatorsDefault.hideActionSheet();
      const onDismiss = merged.onDismiss;
      if (onDismiss != null) {
  ...
  obj.header = jsx(merged(7201).BottomSheetTitleHeader, { titleContainerStyle: tmp2.titleContainer, titleWrapperStyle: tmp2.titleWrapper, subtitleStyle: tmp2.subtitleWrapper, leading: null, title: null, subtitle: null, trailing: null });
  ...
  return jsx(merged(7202).BottomSheet, {}, option.name);
};
