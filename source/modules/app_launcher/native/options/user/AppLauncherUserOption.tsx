...
// Dependencies: [32, 19, 4630, 21, 4638, 576, 504, 12318, 1875, 4605, 12327, 1897, 12327, 1177, 12321, 11066, 12324, 4634, 2]
// Exports: default
...
export default function AppLauncherUserOption(option) {
  ...
  if (null != tmp8) {
    ...
    const obj4 = { icon: tmp9(tmp2(11066).UserCircleIcon, { size: "sm", color: "interactive-text-default" }), wrapperStyle: tmp.iconWrapper };
    tmp9Result = tmp9(tmp10(12321), obj4);
    const tmp10Result = tmp10(12321);
  }
  ...
  if (null != tmp8) {
    ...
    if (null != tmp6) {
      ...
      tmp9Result2 = tmp9(tmp2(4634).Text, obj6);
    }
  }
