...
// Dependencies: [19, 1483, 21, 4640, 4607, 7635, 1177, 12319, 1115, 12317, 12337, 11738, 12318, 5693, 2]
// Exports: default

// Module 12336 (AppLauncherUserListActionSheet)
...
function EmptyStateWithSnowflakeQuery(onPressRow) {
  ...
  obj.data = items;
  return jsx(onPressRow(12318).AppLauncherList, {
    contentContainerStyle: closure_6().emptyState,
    data: null,
    renderItem(label) {
      return jsx(TableRow.TableRow, { label: label.item, start: true, end: true, onPress: onPressRow });
