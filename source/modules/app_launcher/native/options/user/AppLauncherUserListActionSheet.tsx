...
// Dependencies: [19, 1482, 21, 4607, 4574, 7595, 1178, 12263, 1114, 12261, 12281, 11683, 12262, 5657, 2]
// Exports: default

// Module 12280 (AppLauncherUserListActionSheet)
...
function EmptyStateWithSnowflakeQuery(onPressRow) {
  ...
  obj.data = items;
  return jsx(onPressRow(12262).AppLauncherList, {
    contentContainerStyle: closure_6().emptyState,
    data: null,
    renderItem(label) {
      return jsx(TableRow.TableRow, { label: label.item, start: true, end: true, onPress: onPressRow });
