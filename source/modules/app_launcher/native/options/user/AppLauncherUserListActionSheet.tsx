...
// Dependencies: [19, 1482, 21, 4605, 4572, 7573, 1178, 12238, 1114, 12236, 12256, 11659, 12237, 5655, 2]
// Exports: default

// Module 12255 (AppLauncherUserListActionSheet)
...
function EmptyStateWithSnowflakeQuery(onPressRow) {
  ...
  obj.data = items;
  return jsx(onPressRow(12237).AppLauncherList, {
    contentContainerStyle: closure_6().emptyState,
    data: null,
    renderItem(label) {
      return jsx(TableRow.TableRow, { label: label.item, start: true, end: true, onPress: onPressRow });
