...
// Dependencies: [19, 1483, 21, 4639, 4606, 7628, 1177, 12302, 1115, 12300, 12320, 11722, 12301, 5690, 2]
// Exports: default

// Module 12319 (AppLauncherUserListActionSheet)
...
function EmptyStateWithSnowflakeQuery(onPressRow) {
  ...
  obj.data = items;
  return jsx(onPressRow(12301).AppLauncherList, {
    contentContainerStyle: closure_6().emptyState,
    data: null,
    renderItem(label) {
      return jsx(TableRow.TableRow, { label: label.item, start: true, end: true, onPress: onPressRow });
