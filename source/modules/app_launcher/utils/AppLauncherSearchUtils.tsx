...
// Dependencies: [32, 19, 9361, 9359, 9360, 12138, 5049, 5050, 9364, 1894, 9358, 9475, 12109, 12140, 12, 9479, 504, 9314, 12139, 12141, 2]
...
// Module 12137 (AppLauncherSearchUtils)
...
import ArraySearch from "ArraySearch" /* 12140 */;
...
function useApplicationsInContext(allowFetch) {
  ...
  const hasBaseAccessPermissions = onlyWithCommands(9364).usePermissionContext(channel, items).hasBaseAccessPermissions;
  ...
  return (applicationId) => {
    if (applicationId.applicationId in closure_2) {
      ...
      if (FAKE_BUILT_IN_APP == null) {
        FAKE_BUILT_IN_APP = tmp3(9358).FAKE_BUILT_IN_APP;
      }
      const sectionName = AppLauncherUtils.getSectionName(FAKE_BUILT_IN_APP);
      tmp3 = require;
