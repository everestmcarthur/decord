...
// Dependencies: [32, 19, 9324, 9322, 9323, 12098, 5013, 5014, 9327, 1894, 9321, 9437, 12069, 12100, 12, 9441, 504, 9277, 12099, 12101, 2]
...
// Module 12097 (AppLauncherSearchUtils)
...
import ArraySearch from "ArraySearch" /* 12100 */;
...
function useApplicationsInContext(allowFetch) {
  ...
  const hasBaseAccessPermissions = onlyWithCommands(9327).usePermissionContext(channel, items).hasBaseAccessPermissions;
  ...
  return (applicationId) => {
    if (applicationId.applicationId in closure_2) {
      ...
      if (FAKE_BUILT_IN_APP == null) {
        FAKE_BUILT_IN_APP = tmp3(9321).FAKE_BUILT_IN_APP;
      }
      const sectionName = AppLauncherUtils.getSectionName(FAKE_BUILT_IN_APP);
      tmp3 = require;
