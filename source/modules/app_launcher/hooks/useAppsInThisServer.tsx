...
// Dependencies: [19, 9422, 1372, 5083, 504, 9548, 1895, 9432, 12255, 12, 9538, 2]
// Exports: default

// Module 12256 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9422).useGuildIndexState;
const limit = fn(5083).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
