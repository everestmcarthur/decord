...
// Dependencies: [19, 9433, 1372, 5084, 504, 9559, 1895, 9443, 12263, 12, 9549, 2]
// Exports: default

// Module 12264 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9433).useGuildIndexState;
const limit = fn(5084).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
