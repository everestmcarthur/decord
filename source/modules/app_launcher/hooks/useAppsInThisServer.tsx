...
// Dependencies: [19, 9444, 1372, 5086, 504, 9570, 1895, 9454, 12272, 12, 9560, 2]
// Exports: default

// Module 12273 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9444).useGuildIndexState;
const limit = fn(5086).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
