...
// Dependencies: [19, 9382, 1371, 5051, 504, 9509, 1894, 9392, 12216, 12, 9499, 2]
// Exports: default

// Module 12217 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9382).useGuildIndexState;
const limit = fn(5051).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
