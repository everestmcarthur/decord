...
// Dependencies: [19, 9380, 1371, 5050, 504, 9507, 1894, 9390, 12214, 12, 9497, 2]
// Exports: default

// Module 12215 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9380).useGuildIndexState;
const limit = fn(5050).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
