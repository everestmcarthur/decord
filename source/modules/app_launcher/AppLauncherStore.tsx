...
// Dependencies: [9500, 504, 573, 2]

// Module 9499 (AppLauncherStore)
...
function handleDismissWithDismissed() {
  ...
  if (DISMISSED === undefined) {
    DISMISSED = tmp(9500).AppLauncherCloseReason.DISMISSED;
  }
  obj.show = false;
...
const obj = { show: false, entrypoint: fn(9500).AppLauncherEntrypoint.NONE, lastShownEntrypoint: fn(9500).AppLauncherEntrypoint.NONE, activeViewType: null, activeChannelId: null, closeReason: fn(9500).AppLauncherCloseReason.DISMISSED, initialState: "accessible" };
