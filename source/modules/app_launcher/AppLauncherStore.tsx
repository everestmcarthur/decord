...
// Dependencies: [9502, 504, 573, 2]

// Module 9501 (AppLauncherStore)
...
function handleDismissWithDismissed() {
  ...
  if (DISMISSED === undefined) {
    DISMISSED = tmp(9502).AppLauncherCloseReason.DISMISSED;
  }
  obj.show = false;
...
const obj = { show: false, entrypoint: fn(9502).AppLauncherEntrypoint.NONE, lastShownEntrypoint: fn(9502).AppLauncherEntrypoint.NONE, activeViewType: null, activeChannelId: null, closeReason: fn(9502).AppLauncherCloseReason.DISMISSED, initialState: "accessible" };
