...
// Dependencies: [17474, 2]

// Module 17477 (HolidayEventsUtils)
...
export default {
  ...
  useHolidaySoundpack() {
    ...
    if (tmp5) {
      tmp6 = null;
      if (null != tmp(17474).soundpack) {
        tmp6 = null;
        if (null != tmp(17474).soundpackLabel) {
          const obj2 = { soundpack: tmp(17474).soundpack, soundpackLabel: tmp(17474).soundpackLabel };
          tmp6 = obj2;
        }
      }
    }
  ...
  getAppSpinnerSources() {
    ...
    if (tmp4) {
      appSpinnerSources = tmp2(17474).appSpinnerSources;
    }
  ...
  getLoadingTips() {
    ...
    let tmp5 = null;
    if (tmp4) {
      const getLoadingTips = tmp2(17474).getLoadingTips;
      let loadingTips;
      if (getLoadingTips != null) {
        loadingTips = getLoadingTips();
      }
      tmp5 = loadingTips;
      const tmp2Result = tmp2(17474);
    }
    return tmp5;
  },
  getHolidaySoundpack() {
