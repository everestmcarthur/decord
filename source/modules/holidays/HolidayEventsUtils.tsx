...
// Dependencies: [17465, 2]

// Module 17469 (HolidayEventsUtils)
...
export default {
  ...
  useHolidaySoundpack() {
    ...
    if (tmp5) {
      tmp6 = null;
      if (null != tmp(17465).soundpack) {
        tmp6 = null;
        if (null != tmp(17465).soundpackLabel) {
          const obj2 = { soundpack: tmp(17465).soundpack, soundpackLabel: tmp(17465).soundpackLabel };
          tmp6 = obj2;
        }
      }
    }
  ...
  getAppSpinnerSources() {
    ...
    if (tmp4) {
      appSpinnerSources = tmp2(17465).appSpinnerSources;
    }
  ...
  getLoadingTips() {
    ...
    let tmp5 = null;
    if (tmp4) {
      const getLoadingTips = tmp2(17465).getLoadingTips;
      let loadingTips;
      if (getLoadingTips != null) {
        loadingTips = getLoadingTips();
      }
      tmp5 = loadingTips;
      const tmp2Result = tmp2(17465);
    }
    return tmp5;
  },
  getHolidaySoundpack() {
