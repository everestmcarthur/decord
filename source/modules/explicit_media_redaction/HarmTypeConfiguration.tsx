...
// Dependencies: [1074, 7406, 4869, 7407, 1936, 7408, 7411, 1186, 2]

// Module 7405 (HarmTypeConfiguration)
import preloaded_user_settings from "preloaded_user_settings" /* 1186 */;
import UserSettings from "UserSettings" /* 1936 */;
import MediaTypes from "MediaTypes" /* 4869 */;
...
obj3[obj.EXPLICIT] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    if (arg0 == null) {
      ...
      const ExplicitContentSettings = tmp12(1936).ExplicitContentSettings;
      ...
      const ExplicitContentSettings2 = tmp12(1936).ExplicitContentSettings;
    ...
    let tmp9;
    if (tmp != null) {
      tmp9 = tmp[tmp7(undefined, 7407).ContentHarmTypeChannel.GUILD];
    }
    ...
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 7407).ContentHarmTypeChannel.FRIEND_DM];
    }
    ...
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 7407).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
...
obj3[obj.GORE] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    if (arg0 == null) {
      ...
      const obj = {};
      obj[ExplicitMediaRedactionModels.ContentHarmTypeChannel.GUILD] = goreContentGuilds;
      const GoreContentSettings = tmp12(1936).GoreContentSettings;
      ...
      obj[ExplicitMediaRedactionModels.ContentHarmTypeChannel.FRIEND_DM] = goreContentFriendDm;
      const GoreContentSettings2 = tmp12(1936).GoreContentSettings;
