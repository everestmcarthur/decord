...
// Dependencies: [1074, 7369, 4837, 7370, 1935, 7371, 7374, 1187, 2]

// Module 7368 (HarmTypeConfiguration)
import preloaded_user_settings from "preloaded_user_settings" /* 1187 */;
import UserSettings from "UserSettings" /* 1935 */;
import MediaTypes from "MediaTypes" /* 4837 */;
...
obj3[obj.EXPLICIT] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    let tmp9;
    if (tmp != null) {
      tmp9 = tmp[tmp7(undefined, 7370).ContentHarmTypeChannel.GUILD];
    }
    ...
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 7370).ContentHarmTypeChannel.FRIEND_DM];
    }
    ...
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 7370).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
