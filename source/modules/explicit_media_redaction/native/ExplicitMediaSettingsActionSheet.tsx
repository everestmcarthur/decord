...
// Dependencies: [19, 17, 21, 4638, 576, 4605, 7260, 7259, 5771, 1186, 5774, 2]
// Exports: default

// Module 14938 (ExplicitMediaSettingsActionSheet)
...
export default function ExplicitMediaSettingsActionSheet(options) {
  ...
  const items1 = [closure_5(options(7259).BottomSheetTitleHeader, { title, subtitle }), ];
  ...
  tmp4 = options;
  const tmp7 = View;
  obj.children = closure_5(options(5771).TableRadioGroup, { defaultValue: SHOW, onChange: callback, hasIcons: false, children: options.map((label) => closure_1_5(options(dependencyMap[10]).TableRadioRow, { label: label.label, value: label.value }, label.value)) });
  items1[1] = closure_5(tmp7, obj);
  obj2.children = items1;
  return tmp3(options(7260).BottomSheet, obj2);
};
