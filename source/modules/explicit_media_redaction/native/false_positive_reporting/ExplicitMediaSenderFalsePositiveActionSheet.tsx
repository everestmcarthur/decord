...
// Dependencies: [19, 7307, 7615, 21, 563, 9431, 9432, 9429, 7624, 4541, 7614, 2]
// Exports: default

// Module 9430 (ExplicitMediaSenderFalsePositiveActionSheet)
import ExplicitMediaRedactionActionCreators from "ExplicitMediaRedactionActionCreators" /* 7624 */;
import ExplicitMediaFalsePositiveActionCreatorsDefault from "ExplicitMediaFalsePositiveActionCreators" /* 9429 */;
import ExplicitMediaFalsePositiveActionSheet from "ExplicitMediaFalsePositiveActionSheet" /* 9432 */;
...
export default function ExplicitMediaObscuredFalsePositiveActionSheet(channelId) {
  ...
  const explicitMediaActions = channelId(9431).useExplicitMediaActions({
    onSuccess() {
  ...
  return jsx(channelId(9432).ExplicitMediaFalsePositiveActionSheet, { channelId, messageId, isReportFalsePositiveLoading: explicitMediaActions.isReportFalsePositiveLoading, onConfirmPress: callback, analyticsContext: channelId(7614).TrackMediaRedactionContext.EXPLICIT_MEDIA_SENDER_FALSE_POSITIVE_FLOW });
};
