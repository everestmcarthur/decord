...
// Dependencies: [19, 2013, 4278, 4288, 1372, 1074, 21, 4639, 576, 4350, 1364, 7976, 5709, 7969, 1115, 16996, 11467, 1271, 7296, 4984, 5078, 4635, 8719, 5057, 17004, 1397, 6711, 5772, 5690, 4792, 1177, 5112, 1484, 7147, 2]
// Exports: default

// Module 17003 (IntegrationsSettingsEditWebhook)
...
import PressableNavigatorModalIconDefault from "PressableNavigatorModalIcon" /* 7976 */;
import openChannelPickerDefault from "openChannelPicker" /* 11467 */;
import WebhooksActionCreatorsDefault from "WebhooksActionCreators" /* 16996 */;
import noop from "module_19" /* 19 */;
import PermissionStore from "PermissionStore" /* 4278 */;
import RelationshipStore from "RelationshipStore" /* 4288 */;
import UserStore from "UserStore" /* 1372 */;

const IconLabelBlockDefault = tmp8(17004);
require = fn;
...
prototype["render"] = function render() {
  ...
  items1[1] = closure_11(webhookId(6711).TextInput, obj5);
  ...
  const tmp2Result = closure_11(webhookId(4635).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  const tmp7 = closure_12;
  obj7.label = webhookId(4792).computeChannelName(channel, UserStore, RelationshipStore);
  obj7.onPress = self.handleChannelChange;
  const obj8 = { size: webhookId(1177).Icon.Sizes.CUSTOM, source: null, style: null };
  const tmp3Result = webhookId(4792);
  obj8.source = webhookId(5112).getChannelIcon(channel);
  obj8.style = tmp.channelIcon;
  obj7.icon = closure_11(webhookId(1177).Icon, obj8);
  obj6.children = closure_11(webhookId(5690).TableRow, obj7);
  items1[2] = closure_11(webhookId(5772).TableRowGroup, obj6);
  ...
  if (null != token) {
    ...
    obj9.children = tmp2(tmp3(5690).TableRow, obj10);
    tmp2Result4 = tmp2(tmp3(5772).TableRowGroup, obj9);
  ...
  obj11.children = closure_11(webhookId(5690).TableRow, obj12);
  items1[4] = closure_11(webhookId(5772).TableRowGroup, obj11);
  obj2.children = items1;
  obj.children = tmp7(webhookId(5057).Stack, obj2);
  return closure_11(webhookId(8719).Form, obj);
};
EditWebhook.contextType = fn(4350).ThemeContext;
const size = fn(2);
