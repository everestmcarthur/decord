...
// Dependencies: [5, 19, 1958, 2013, 1980, 4278, 1372, 16995, 1074, 21, 4639, 576, 1484, 1397, 5690, 1177, 1115, 11, 4484, 504, 16996, 8721, 16997, 4350, 2025, 4635, 16999, 5772, 8719, 5057, 7147, 2]
// Exports: default

// Module 16994 (IntegrationsSettingsWebhooksOverview)
...
import WebhooksStore from "WebhooksStore" /* 16995 */;
...
prototype["renderWebhooks"] = function renderWebhooks() {
  ...
  const items = [closure_18(webhookType(4635).Text, { variant: "text-sm/medium", color: "text-muted", children: helpText }), , ];
  ...
  items[1] = tmp4Result;
  if (0 === found.length) {
    const obj2 = { Illustration: tmp5(16999).WebhookEmpty, title: null };
    ...
    items[2] = tmp4(tmp5(5772).TableRowGroup, obj3);
    obj4.children = items;
