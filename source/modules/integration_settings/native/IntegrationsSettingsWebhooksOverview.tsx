...
// Dependencies: [5, 19, 1958, 2013, 1980, 4361, 1372, 17222, 1074, 21, 4722, 576, 1484, 1397, 5775, 1177, 1115, 11, 4566, 504, 17223, 8833, 17224, 4432, 2025, 4718, 17226, 5857, 8831, 5142, 7236, 2]
// Exports: default

// Module 17221 (IntegrationsSettingsWebhooksOverview)
...
import WebhooksStore from "WebhooksStore" /* 17222 */;
...
prototype["renderWebhooks"] = function renderWebhooks() {
  ...
  const items = [closure_18(webhookType(4718).Text, { variant: "text-sm/medium", color: "text-muted", children: helpText }), , ];
  ...
  items[1] = tmp4Result;
  if (0 === found.length) {
    const obj2 = { Illustration: tmp5(17226).WebhookEmpty, title: null };
    ...
    items[2] = tmp4(tmp5(5857).TableRowGroup, obj3);
    obj4.children = items;
