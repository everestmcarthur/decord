...
// Dependencies: [1364, 10146, 2]
// Exports: default

// Module 10145 (getEffectiveNoiseCancellation)
  ...
  if (!obj.isIOS()) {
    if (!tmpResult.isMac()) {
      ...
      if (arg0) {
        ...
        if (!tmp5) {
          tmp5 = !tmp(10146).getWindowsAudioEffectsExperimentConfig({ location: "setNoiseCancellation" }).preferSystemEffects;
          const tmpResult4 = tmp(10146);
        }
        if (tmp5) {
          tmp5 = arg0;
        }
