...
// Dependencies: [1364, 10135, 2]
// Exports: default

// Module 10134 (getEffectiveNoiseCancellation)
  ...
  if (!obj.isIOS()) {
    if (!tmpResult.isMac()) {
      ...
      if (arg0) {
        ...
        if (!tmp5) {
          tmp5 = !tmp(10135).getWindowsAudioEffectsExperimentConfig({ location: "setNoiseCancellation" }).preferSystemEffects;
          const tmpResult4 = tmp(10135);
        }
        if (tmp5) {
          tmp5 = arg0;
        }
