...
// Dependencies: [1364, 10240, 2]
// Exports: default

// Module 10239 (getEffectiveNoiseCancellation)
  ...
  if (!obj.isIOS()) {
    if (!tmpResult.isMac()) {
      ...
      if (arg0) {
        ...
        if (!tmp5) {
          tmp5 = !tmp(10240).getWindowsAudioEffectsExperimentConfig({ location: "setNoiseCancellation" }).preferSystemEffects;
          const tmpResult4 = tmp(10240);
        }
        if (tmp5) {
          tmp5 = arg0;
        }
