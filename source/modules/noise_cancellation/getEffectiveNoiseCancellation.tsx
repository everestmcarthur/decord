  ...
  if (!obj.isIOS()) {
    if (!tmpResult.isMac()) {
      ...
      if (arg0) {
        ...
        if (!tmp5) {
          tmp5 = !tmp(10066).getWindowsAudioEffectsExperimentConfig({ location: "setNoiseCancellation" }).preferSystemEffects;
          const tmpResult4 = tmp(10066);
        }
        if (tmp5) {
          tmp5 = arg0;
        }
