...
// Dependencies: [1115, 10088, 2]
// Exports: default

// Module 10087 (getEffectiveNoiseCancellation)
  ...
  if (!obj.isIOS()) {
    if (!tmpResult.isMac()) {
      ...
      if (arg0) {
        ...
        if (!tmp5) {
          tmp5 = !tmp(10088).getWindowsAudioEffectsExperimentConfig({ location: "setNoiseCancellation" }).preferSystemEffects;
          const tmpResult4 = tmp(10088);
        }
        if (tmp5) {
          tmp5 = arg0;
        }
