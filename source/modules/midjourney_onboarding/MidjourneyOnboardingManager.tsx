...
// Dependencies: [5, 13948, 1074, 7221, 13947, 7350, 2]

// Module 17920 (MidjourneyOnboardingManager)
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            if (obj6.isEligibleForMidjourneyRedirect(channel)) {
              v1 = 1;
              dependencyMap = 1;
              const obj4 = { value: tmp21(13947).hasRedirectedToGuild(MIDJOURNEY_GUILD_ID), done: false };
              return obj4;
            } else {
              dependencyMap = 3;
            }
          ...
          v1(7350)(Routes.CHANNEL(null, closure_128_0.id));
          const tmp9 = v1(7350);
        }
        dependencyMap = 3;
