...
// Dependencies: [5, 13914, 1074, 7191, 13913, 7320, 2]

// Module 17890 (MidjourneyOnboardingManager)
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import AutomaticLifecycleManager from "AutomaticLifecycleManager" /* 7191 */;

const require = fn;
const MIDJOURNEY_GUILD_ID = fn(13914).MIDJOURNEY_GUILD_ID;
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            if (obj6.isEligibleForMidjourneyRedirect(channel)) {
              v1 = 1;
              dependencyMap = 1;
              const obj4 = { value: tmp21(13913).hasRedirectedToGuild(MIDJOURNEY_GUILD_ID), done: false };
              return obj4;
            } else {
              dependencyMap = 3;
            }
          ...
          v1(7320)(Routes.CHANNEL(null, closure_128_0.id));
          const tmp9 = v1(7320);
        }
        dependencyMap = 3;
