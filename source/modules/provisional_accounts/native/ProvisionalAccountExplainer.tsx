...
// Dependencies: [19, 17, 21, 4640, 576, 12779, 12780, 5695, 4636, 1115, 6721, 7321, 2]
// Exports: ChatProvisionalAccountExplainerCard, UserProfileProvisionalAccountExplainerCard

// Module 12778 (ProvisionalAccountExplainer)
import nativeDefault from "native" /* 576 */;
import UserProfileCardDefault from "UserProfileCard" /* 7321 */;
...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const provisionalAccountExplanationText = iconSize(12780).useProvisionalAccountExplanationText({ userId, renderApplicationName: callback });
  ...
  const items2 = [closure_5(iconSize(4636).Text, obj4), closure_5(iconSize(6721).CircleErrorIcon, { size: "xs", color: "text-default" })];
  obj3.children = items2;
  const items3 = [closure_6(View, obj3), closure_5(iconSize(4636).Text, { variant: "text-sm/normal", color: "text-default", children: provisionalAccountExplanationText })];
  obj2.children = items3;
  return closure_6(iconSize(5695).Card, obj2);
};
export const UserProfileProvisionalAccountExplainerCard = function UserProfileProvisionalAccountExplainerCard(iconSize) {
  ...
  const obj = iconSize(12780);
  const intl = iconSize(1115).intl;
  obj2.title = intl.string(iconSize(1115).t.Iyka0U);
  obj2.titleIcon = closure_5(iconSize(6721).CircleErrorIcon, { size: "xs", color: "text-default" });
  obj2.children = closure_5(iconSize(4636).Text, { variant: "text-md/normal", color: "text-default", children: provisionalAccountExplanationText });
