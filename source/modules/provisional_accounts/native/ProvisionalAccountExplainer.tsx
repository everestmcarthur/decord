...
// Dependencies: [19, 17, 21, 4639, 576, 12763, 12764, 5692, 4635, 1115, 6715, 7314, 2]
// Exports: ChatProvisionalAccountExplainerCard, UserProfileProvisionalAccountExplainerCard

// Module 12762 (ProvisionalAccountExplainer)
...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const provisionalAccountExplanationText = iconSize(12764).useProvisionalAccountExplanationText({ userId, renderApplicationName: callback });
  ...
  const items2 = [closure_5(iconSize(4635).Text, obj4), closure_5(iconSize(6715).CircleErrorIcon, { size: "xs", color: "text-default" })];
  obj3.children = items2;
  const items3 = [closure_6(View, obj3), closure_5(iconSize(4635).Text, { variant: "text-sm/normal", color: "text-default", children: provisionalAccountExplanationText })];
...
export const UserProfileProvisionalAccountExplainerCard = function UserProfileProvisionalAccountExplainerCard(iconSize) {
  ...
  obj2.children = closure_5(iconSize(4635).Text, { variant: "text-md/normal", color: "text-default", children: provisionalAccountExplanationText });
