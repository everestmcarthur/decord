...
// Dependencies: [5, 32, 19, 17, 1371, 2023, 1074, 21, 4605, 8029, 5042, 1242, 11913, 4303, 1114, 9636, 5044, 4601, 4757, 11002, 2]
// Exports: default

// Module 11914 (GuildEnableCommunicationAlert)
...
export default function GuildEnableCommunicationAlert(guildId) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: v1(11913).setCommunicationDisabledDuration(guildId, userId), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  dependencyMap = tmp2;
  closure_3 = _slicedToArray(userId(8029)(userId, guildId), 1)[0];
  userId(5042)(() => {
  ...
  const tmp12 = View;
  const tmp7 = userId(5044);
  let str = userId(4757).getName(guildId, null, user);
  if (str == null) {
    str = "";
  }
  ...
  const items = [closure_10(guildId(4601).Text, obj3), ];
  ...
  items[1] = closure_10(guildId(4601).Text, obj5);
  obj2.children = items;
