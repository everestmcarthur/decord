...
// Dependencies: [5, 32, 19, 17, 1372, 2024, 1074, 21, 4640, 8113, 5079, 1241, 11994, 4338, 1115, 9720, 5081, 4636, 4792, 11087, 2]
// Exports: default

// Module 11995 (GuildEnableCommunicationAlert)
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import CountDownDefault from "CountDown" /* 11087 */;
...
export default function GuildEnableCommunicationAlert(guildId) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: v1(11994).setCommunicationDisabledDuration(guildId, userId), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  dependencyMap = tmp2;
  closure_3 = _slicedToArray(userId(8113)(userId, guildId), 1)[0];
  userId(5079)(() => {
  ...
  const tmp12 = View;
  const tmp7 = userId(5081);
  let str = userId(4792).getName(guildId, null, user);
  if (str == null) {
    str = "";
  }
  ...
  const items = [closure_10(guildId(4636).Text, obj3), ];
  ...
  items[1] = closure_10(guildId(4636).Text, obj5);
  obj2.children = items;
