...
// Dependencies: [5, 32, 19, 17, 1372, 2024, 1074, 21, 4638, 8093, 5077, 1241, 11985, 4336, 1115, 9709, 5079, 4634, 4790, 11079, 2]
// Exports: default

// Module 11986 (GuildEnableCommunicationAlert)
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import CountDownDefault from "CountDown" /* 11079 */;
...
export default function GuildEnableCommunicationAlert(guildId) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: v1(11985).setCommunicationDisabledDuration(guildId, userId), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  dependencyMap = tmp2;
  closure_3 = _slicedToArray(userId(8093)(userId, guildId), 1)[0];
  userId(5077)(() => {
  ...
  const tmp12 = View;
  const tmp7 = userId(5079);
  let str = userId(4790).getName(guildId, null, user);
  if (str == null) {
    str = "";
  }
  ...
  const items = [closure_10(guildId(4634).Text, obj3), ];
  ...
  items[1] = closure_10(guildId(4634).Text, obj5);
  obj2.children = items;
