...
// Dependencies: [11602, 1074, 8079, 7093, 7098, 6726, 1150, 1874, 14669, 38, 14671, 14780, 12, 2]
...
import SettingHookHarness from "SettingHookHarness" /* 14669 */;
import SettingsRendererConfig from "SettingsRendererConfig" /* 14671 */;
import SettingTreeManagerDefault from "SettingTreeManager" /* 14780 */;
import SettingRendererConstants from "SettingRendererConstants" /* 11602 */;
  ...
  const item = entries.forEach((item) => {
    ...
    if (!tmp2.unsearchable) {
      ...
      if (null != cachedSettingTitle) {
        ...
        HermesBuiltin.arraySpread(tmp3(14669).getCachedSettingSearchTerms(tmp), 1);
        items[1] = items1;
        items.push(items);
        const tmp3Result = tmp3(14669);
      }
      tmp3 = require;
    }
  });
