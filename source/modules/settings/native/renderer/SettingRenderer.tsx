...
// Dependencies: [32, 109, 19, 17, 2025, 14769, 1979, 11541, 21, 4605, 576, 1178, 5655, 1483, 14771, 504, 1114, 10888, 5634, 14773, 14774, 4601, 7253, 7252, 4325, 5735, 5738, 7241, 4302, 10056, 4573, 4574, 5657, 5023, 1880, 1115, 14255, 5173, 5025, 4306, 7049, 1874, 2]
// Exports: renderSettingItem, renderSettingSearchResultItem, renderSettingSearchResultPlaceholderItem

// Module 14770 (SettingRenderer)
...
import Tracking from "Tracking" /* 7049 */;
import ClipboardUtils from "ClipboardUtils" /* 7241 */;
import VolumeSliderDefault from "VolumeSlider" /* 10056 */;
import ClydeIcon from "ClydeIcon" /* 10888 */;
import SettingRendererUtils from "SettingRendererUtils" /* 14771 */;
import useHighlightSettingItem from "useHighlightSettingItem" /* 14773 */;
import SettingListItemHighlightDefault from "SettingListItemHighlight" /* 14774 */;
...
const TableRadioGroup = tmp2(5735);
require = fn;
...
let closure_21 = noop.memo((arg0) => {
  ...
  if (null != IconComponent) {
    ...
    tmp10Result = tmp10(tmp(5655).TableRow.Icon, obj3);
  }
  ...
  if (null != trailing) {
    ...
    if (typeof trailing === "string") {
      ...
      tmp10Result2 = tmp10(tmp(5655).TableRow.TrailingText, obj4);
    }
    tmp12 = tmp10Result2;
  }
  obj2.trailing = tmp12;
...
let closure_23 = noop.memo((arg0) => {
  ...
  if (null != IconComponent) {
    const obj3 = { IconComponent, variant };
    tmp8 = closure_1_14(tmp(5655).TableRow.Icon, obj3);
  }
  obj2.icon = tmp8;
  ...
  if (typeof isDisabled === "object") {
    ...
    obj7.children = closure_1_14(tmp(7253).FormSwitch, obj8);
    obj5.trailing = closure_1_14(View, obj7);
    let tmp16 = closure_1_14(tmp(5655).TableRow, obj5);
    ...
    obj9.value = value;
    tmp16 = closure_1_14(tmp(7252).TableSwitchRow, obj9);
    tmp17 = closure_1_14;
  }
...
let closure_26 = noop.memo((arg0) => {
  ...
  let highlightSettingItem = trailing(14773).useHighlightSettingItem(setting);
  trailing = undefined;
  const title = useTitle();
  if (useTrailing != null) {
    trailing = useTrailing();
  ...
  if (null != IconComponent) {
    const obj3 = { IconComponent, variant };
    tmp11Result = tmp11(tmp(5655).TableRow.Icon, obj3);
  }
  obj2.icon = tmp11Result;
  let tmp11Result2 = null;
  if (null != trailing) {
    const obj4 = { text: trailing };
    tmp11Result2 = tmp11(tmp(5655).TableRow.TrailingText, obj4);
  }
  obj2.trailing = tmp11Result2;
  obj2.start = start;
  obj2.end = end;
  const children = [closure_14(trailing(5655).TableRow, obj2), ];
  if (highlightSettingItem) {
    const obj5 = { start, end };
