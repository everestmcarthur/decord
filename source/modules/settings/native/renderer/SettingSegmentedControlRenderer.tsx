...
// Dependencies: [32, 19, 17, 14788, 11607, 21, 4639, 576, 14791, 14682, 38, 14790, 9924, 9925, 12751, 2]
// Exports: default

// Module 14800 (SettingSegmentedControlRenderer)
...
export default function SettingSegmentedControl(node) {
  ...
  const memo = noop.useMemo(() => {
    ...
    const item = settings.forEach((id) => {
      const tmp = items(14682).SETTING_RENDERER_CONFIG[id];
      ...
      obj.label = items(14790).getSettingTitle(id);
      obj.id = id;
