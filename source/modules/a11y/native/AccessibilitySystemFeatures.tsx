...
// Dependencies: [17, 4631, 1348, 14534, 11492, 1241, 14535, 2]
...
export default {
  ...
  handleReduceMotionChanged(arg0) {
    ...
    if (null != tmp5) {
      ...
      updateSharedValueIfChangedDefault(tmp(14534).accessibilityPreferencesSharedValue, obj2);
    }
  },
  ...
  handlePreferredColorSchemeChanged(colorScheme) {
    ...
    if ("dark" === colorScheme) {
      ...
      if (null != tmp21) {
        const obj2 = {};
        obj2[tmp21] = false;
        updateSharedValueIfChangedDefault(tmp19(14534).accessibilityPreferencesSharedValue, obj2);
      }
      ...
      if (null != tmp27) {
        const obj3 = {};
        obj3[tmp27] = true;
        updateSharedValueIfChangedDefault(tmp19(14534).accessibilityPreferencesSharedValue, obj3);
      }
      ...
      if (null != tmp10) {
        const obj4 = {};
        obj4[tmp10] = false;
        updateSharedValueIfChangedDefault(tmp8(14534).accessibilityPreferencesSharedValue, obj4);
      }
      ...
      if (null != tmp16) {
        const obj5 = {};
        obj5[tmp16] = true;
        updateSharedValueIfChangedDefault(tmp8(14534).accessibilityPreferencesSharedValue, obj5);
      }
    } else {
      ...
      if (null != tmp35) {
        const obj = {};
        obj[tmp35] = false;
        updateSharedValueIfChangedDefault(tmp33(14534).accessibilityPreferencesSharedValue, obj);
      }
      ...
      if (null != tmp5) {
        const obj6 = {};
        obj6[tmp5] = false;
        updateSharedValueIfChangedDefault(tmp33(14534).accessibilityPreferencesSharedValue, obj6);
      }
    }
  },
  handleAccessibilityStoreChanged() {
    ...
    if (null != tmp6) {
      ...
      updateSharedValueIfChangedDefault(tmp4(14534).accessibilityPreferencesSharedValue, obj);
    }
    ...
    if (null != tmp12) {
      const obj2 = {};
      obj2[tmp12] = tmp10;
      updateSharedValueIfChangedDefault(tmp4(14534).accessibilityPreferencesSharedValue, obj2);
    }
    ...
    if (null != tmp18) {
      const obj3 = {};
      obj3[tmp18] = tmp16;
      updateSharedValueIfChangedDefault(tmp4(14534).accessibilityPreferencesSharedValue, obj3);
    }
    ...
    if (null != tmp24) {
      const obj4 = {};
      obj4[tmp24] = tmp22;
      updateSharedValueIfChangedDefault(tmp4(14534).accessibilityPreferencesSharedValue, obj4);
    }
    ...
    if (null != tmp30) {
      const obj5 = {};
      obj5[tmp30] = tmp28;
      updateSharedValueIfChangedDefault(tmp4(14534).accessibilityPreferencesSharedValue, obj5);
    }
  },
    ...
    if ("active" === arg0) {
      ...
      result1.then((result) => {
        ...
        if (null != tmp4) {
          const obj = {};
          obj[tmp4] = result;
          updateSharedValueIfChangedDefault(tmp2(14534).accessibilityPreferencesSharedValue, obj);
        }
