...
// Dependencies: [7893, 7894, 5193, 5588, 1958, 2022, 1980, 1074, 5084, 5085, 10565, 1375, 12, 9554, 5528, 1936, 9981, 7444, 10566, 10528, 7447, 1397, 1115, 2]
// Exports: getAutocompleteOptions

// Module 10564 (AutocompleteOptions)
        ...
        if (prop) {
          if (queryEmojiResultsResult.emojis.locked.length > 0) {
            ...
            if (flag2) {
              ...
              const items2 = [query];
              const items3 = [channel, (arg0, arg1) => arg1 === channel(7447).StickerSendability.SENDABLE];
