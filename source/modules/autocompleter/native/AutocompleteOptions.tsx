...
// Dependencies: [7793, 7794, 5122, 5516, 1957, 2021, 1979, 1074, 5013, 5014, 10456, 1374, 12, 9443, 5456, 1935, 9873, 7348, 10457, 10420, 7351, 1396, 1114, 2]
// Exports: getAutocompleteOptions

// Module 10455 (AutocompleteOptions)
...
let c20 = false;
const executeCommand = apply.debounce(executeCommandDefault, fn(5013).AUTOCOMPLETE_OPTION_DEBOUNCE_TIME, { leading: true, trailing: true });
const size = fn(2);
