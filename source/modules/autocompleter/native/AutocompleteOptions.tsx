...
// Dependencies: [7899, 7900, 5195, 5590, 1958, 2022, 1980, 1074, 5086, 5087, 10573, 1375, 12, 9565, 5530, 1936, 9992, 7448, 10574, 10536, 7451, 1397, 1115, 2]
// Exports: getAutocompleteOptions

// Module 10572 (AutocompleteOptions)
        ...
        if (prop) {
          if (queryEmojiResultsResult.emojis.locked.length > 0) {
            ...
            if (flag2) {
              ...
              const items2 = [query];
              const items3 = [channel, (arg0, arg1) => arg1 === channel(7451).StickerSendability.SENDABLE];
