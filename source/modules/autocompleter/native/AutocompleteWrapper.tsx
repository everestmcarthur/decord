...
// Dependencies: [32, 19, 17, 7794, 5473, 5291, 5516, 1074, 5013, 10295, 5014, 10456, 1374, 21, 7052, 10457, 4574, 1115, 576, 12416, 1477, 6995, 5696, 504, 4275, 10151, 12418, 12419, 1935, 5700, 10455, 12420, 7348, 10294, 5530, 10365, 12421, 7535, 1894, 7697, 12021, 1609, 4754, 12422, 12423, 9345, 5036, 12261, 4310, 12424, 7537, 12431, 4570, 1114, 8632, 12432, 12433, 2]

// Module 12415 (AutocompleteWrapper)
import nativeDefault from "native" /* 576 */;
import PlatformUtils from "PlatformUtils" /* 1115 */;
import KeyboardTypes from "KeyboardTypes" /* 1609 */;
import Server from "Server" /* 1894 */;
import AppAnalyticsUtils from "AppAnalyticsUtils" /* 4754 */;
import utils_AutocompleteUtilsDefault from "utils/AutocompleteUtils" /* 5530 */;
...
import AutocompleteOptions from "AutocompleteOptions" /* 10455 */;
import TimestampSuggestionUtils from "TimestampSuggestionUtils" /* 10457 */;
import application_commands_ApplicationCommandUtils from "application_commands/ApplicationCommandUtils" /* 12261 */;
import Autocomplete from "Autocomplete" /* 12416 */;
import ChannelAutocompleteAnalytics from "ChannelAutocompleteAnalytics" /* 12422 */;
...
const BOOLEAN_CHOICES = fn(5013).BOOLEAN_CHOICES;
          ...
          if (" " === tmp[tmp2 - 1]) {
            ...
            if (null != result) {
              ...
              if ("gameMentionInput" === result1) {
                ...
                if (enabled) {
                  if (null == anchor2) {
                    const tmp33Result2 = tmp33(10294);
    ...
    if (type.type !== constants.EMOJI_PREMIUM_UPSELL) {
      ...
      if (type.type === tmp.TIMESTAMP_MENTION) {
        ...
        if (null != applicationCommandManager) {
          const result = tmp8(5036).formatTimestampMention(type.mention);
          tmp18 = autocompleteResultText;
          tmp19 = tmp13;
          if (null != result) {
