...
// Function ID: 12530
// Name: Autocomplete
// Dependencies: [19, 17, 1980, 4286, 1372, 1074, 10402, 21, 4638, 576, 8728, 504, 4482, 1177, 9943, 5691, 5700, 1115, 8253, 5113, 4791, 4634, 5673, 12530, 10527, 5208, 10314, 12, 5107, 1925, 1926, 8698, 2]

// Module 12529 (Autocomplete)
...
import TableRowTrailingText from "TableRowTrailingText" /* 5700 */;
import _modDef8253 from "module_8253" /* 8253 */;
import Form from "Form" /* 8728 */;
import StickerDefault from "Sticker" /* 10314 */;
import StickersHooks from "StickersHooks" /* 10527 */;
import ChannelAutocompleteEmojiUpsellDefault from "ChannelAutocompleteEmojiUpsell" /* 12530 */;
...
export default {
  User(user) {
    ...
    if (nick == null) {
      nick = guildId(4482).getName(user);
      const obj3 = guildId(4482);
    }
    ...
    obj2.trailing = closure_9(guildId(9943), obj5);
    return closure_9(user(8728).FormRow, obj2);
  },
  Global(arg0) {
    ({ text, badge } = arg0);
  ...
  Game(game) {
    ...
    if (obj.isNullOrEmpty(tmp4)) {
      ...
      let tmp6Result = tmp6(tmp5(8698).UnknownGameIcon, obj2);
      let tmp8 = tmp6;
    } else {
  ...
  Timestamp(description) {
    ...
    if (null != result) {
      ...
      const obj4 = { text: str };
      obj2.trailing = React7(tmp(5700).TableRowTrailingText, obj4);
      tmp5Result = tmp5(tmp(5691).TableRow, obj2);
    }
    return tmp5Result;
  }
};
