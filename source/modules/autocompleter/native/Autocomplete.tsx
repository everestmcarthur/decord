...
// Function ID: 12522
// Name: Autocomplete
// Dependencies: [19, 17, 1980, 4288, 1372, 1074, 10394, 21, 4639, 576, 8719, 504, 4484, 1177, 9935, 5690, 5699, 1115, 8244, 5112, 4792, 4635, 5672, 12522, 10519, 5207, 10306, 12, 5106, 1925, 1926, 8689, 2]

// Module 12521 (Autocomplete)
...
import TableRowTrailingText from "TableRowTrailingText" /* 5699 */;
import _modDef8244 from "module_8244" /* 8244 */;
import Form from "Form" /* 8719 */;
import StickerDefault from "Sticker" /* 10306 */;
import StickersHooks from "StickersHooks" /* 10519 */;
import ChannelAutocompleteEmojiUpsellDefault from "ChannelAutocompleteEmojiUpsell" /* 12522 */;
...
export default {
  ...
  Game(game) {
    ...
    if (obj.isNullOrEmpty(tmp4)) {
      ...
      let tmp6Result = tmp6(tmp5(8689).UnknownGameIcon, obj2);
      let tmp8 = tmp6;
    } else {
  ...
  Timestamp(description) {
    ...
    if (null != result) {
      ...
      const obj4 = { text: str };
      obj2.trailing = React7(tmp(5699).TableRowTrailingText, obj4);
      tmp5Result = tmp5(tmp(5690).TableRow, obj2);
    }
    return tmp5Result;
  }
};
