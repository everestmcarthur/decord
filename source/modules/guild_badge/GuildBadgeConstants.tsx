...
// Dependencies: [8813, 1114, 8812, 2]
// Exports: getBadgeTooltip

// Module 9263 (GuildBadgeConstants)
...
export const getBadgeTooltip = function getBadgeTooltip(badgeCategory, visibility) {
  ...
  } else if (visibility === tmp(8813).GuildVisibility.APPLY_TO_JOIN) {
  ...
  if (BadgeCategory.BadgeCategory.STAFF === badgeCategory) {
    ...
    return obj2;
  } else if (tmp(8812).BadgeCategory.VERIFIED === badgeCategory) {
    ...
    return obj3;
  } else if (tmp(8812).BadgeCategory.PARTNERED === badgeCategory) {
    ...
    return obj4;
  } else if (tmp(8812).BadgeCategory.VERIFIED_AND_PARTNERED === badgeCategory) {
    ...
    return obj5;
  } else if (tmp(8812).BadgeCategory.COMMUNITY === badgeCategory) {
    ...
    return obj6;
  } else if (tmp(8812).BadgeCategory.DISCOVERABLE === badgeCategory) {
