...
// Dependencies: [8872, 1115, 8871, 2]
// Exports: getBadgeTooltip

// Module 9326 (GuildBadgeConstants)
...
export const getBadgeTooltip = function getBadgeTooltip(badgeCategory, visibility) {
  ...
  } else if (visibility === tmp(8872).GuildVisibility.APPLY_TO_JOIN) {
  ...
  if (BadgeCategory.BadgeCategory.STAFF === badgeCategory) {
    ...
    return obj2;
  } else if (tmp(8871).BadgeCategory.VERIFIED === badgeCategory) {
    ...
    return obj3;
  } else if (tmp(8871).BadgeCategory.PARTNERED === badgeCategory) {
    ...
    return obj4;
  } else if (tmp(8871).BadgeCategory.VERIFIED_AND_PARTNERED === badgeCategory) {
    ...
    return obj5;
  } else if (tmp(8871).BadgeCategory.COMMUNITY === badgeCategory) {
    ...
    return obj6;
  } else if (tmp(8871).BadgeCategory.DISCOVERABLE === badgeCategory) {
