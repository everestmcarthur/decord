...
// Dependencies: [8883, 1115, 8882, 2]
// Exports: getBadgeTooltip

// Module 9337 (GuildBadgeConstants)
...
export const getBadgeTooltip = function getBadgeTooltip(badgeCategory, visibility) {
  ...
  } else if (visibility === tmp(8883).GuildVisibility.APPLY_TO_JOIN) {
  ...
  if (BadgeCategory.BadgeCategory.STAFF === badgeCategory) {
    ...
    return obj2;
  } else if (tmp(8882).BadgeCategory.VERIFIED === badgeCategory) {
    ...
    return obj3;
  } else if (tmp(8882).BadgeCategory.PARTNERED === badgeCategory) {
    ...
    return obj4;
  } else if (tmp(8882).BadgeCategory.VERIFIED_AND_PARTNERED === badgeCategory) {
    ...
    return obj5;
  } else if (tmp(8882).BadgeCategory.COMMUNITY === badgeCategory) {
    ...
    return obj6;
  } else if (tmp(8882).BadgeCategory.DISCOVERABLE === badgeCategory) {
