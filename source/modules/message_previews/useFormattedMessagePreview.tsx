...
// Dependencies: [502, 4255, 1371, 1074, 1089, 504, 8056, 4840, 1114, 4757, 7376, 12, 8061, 8147, 2]
// Exports: isMessageContentPreviewable, useFormattedMessagePreview

// Module 10185 (useFormattedMessagePreview)
...
import useIsCallActiveDefault from "useIsCallActive" /* 8056 */;
          ...
          if (tmp4(1089).MessageTypes.CHAT_INPUT_COMMAND !== type) {
            if (tmp4(1089).MessageTypes.CONTEXT_MENU_COMMAND !== type) {
              ...
              if (type.type === tmp4(1089).MessageTypes.CALL) {
                ...
                const obj56 = { type: "text", text: tmp4(8147).getVoiceSessionMessageContent(type) };
                tmp21 = obj56;
                const tmp4Result = tmp4(8147);
              }
            }
          }
        }
