...
// Dependencies: [502, 4253, 1371, 1074, 1089, 504, 8033, 4838, 1114, 4755, 7354, 12, 8038, 8124, 2]
// Exports: isMessageContentPreviewable, useFormattedMessagePreview

// Module 10163 (useFormattedMessagePreview)
...
import useIsCallActiveDefault from "useIsCallActive" /* 8033 */;
          ...
          if (tmp4(1089).MessageTypes.CHAT_INPUT_COMMAND !== type) {
            if (tmp4(1089).MessageTypes.CONTEXT_MENU_COMMAND !== type) {
              ...
              if (type.type === tmp4(1089).MessageTypes.CALL) {
                ...
                const obj56 = { type: "text", text: tmp4(8124).getVoiceSessionMessageContent(type) };
                tmp21 = obj56;
