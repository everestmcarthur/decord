...
// Dependencies: [502, 4255, 1371, 1074, 1089, 504, 8055, 4839, 1114, 4756, 7375, 12, 8060, 8146, 2]
// Exports: isMessageContentPreviewable, useFormattedMessagePreview

// Module 10183 (useFormattedMessagePreview)
...
import useIsCallActiveDefault from "useIsCallActive" /* 8055 */;
          ...
          if (tmp4(1089).MessageTypes.CHAT_INPUT_COMMAND !== type) {
            if (tmp4(1089).MessageTypes.CONTEXT_MENU_COMMAND !== type) {
              ...
              if (type.type === tmp4(1089).MessageTypes.CALL) {
                ...
                const obj56 = { type: "text", text: tmp4(8146).getVoiceSessionMessageContent(type) };
                tmp21 = obj56;
                const tmp4Result = tmp4(8146);
              }
            }
          }
        }
