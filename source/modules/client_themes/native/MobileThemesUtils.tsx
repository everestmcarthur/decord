...
// Dependencies: [1183, 4539, 1228, 1230, 1114, 2626, 1231, 4540, 504, 2]
...
import SavedCustomThemeStore from "SavedCustomThemeStore" /* 4539 */;
...
export const useAllMobileThemes = function useAllMobileThemes(mode) {
  ...
  if (undefined !== customThemeDisplaySettings) {
    const obj2 = { type: tmp(1231).ClientThemeType.CUSTOM_BACKGROUND_GRADIENT, getName: getCustomThemesName, theme: null, customThemeSettings: null };
