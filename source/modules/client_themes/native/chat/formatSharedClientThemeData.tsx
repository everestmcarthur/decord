...
// Dependencies: [17, 8271, 1115, 2710, 2]
// Exports: formatSharedClientThemeData

// Module 13427 (formatSharedClientThemeData)
...
export const formatSharedClientThemeData = function formatSharedClientThemeData(message, ensureAvatarSourceResult, nick) {
  ...
  if (undefined !== sharedClientTheme) {
    ...
    obj.nitroWheelIconUrl = Image.resolveAssetSource(_modDef8271).uri;
    const intl = util.intl;
    obj.previewLabel = intl.string(util.t.SKNnqq);
    const intl2 = util.intl;
    obj.previewHeading = intl2.string(_modDef2710.yl1iMm);
    const intl3 = util.intl;
    const _HermesInternal = HermesInternal;
    obj.createdByLabel = "" + intl3.format(_modDef2710.fQPSEf, { username: "__USERNAME__" });
    return obj;
  }
};
