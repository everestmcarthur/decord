...
// Dependencies: [32, 19, 17, 4386, 1074, 1374, 21, 4722, 576, 1241, 12190, 4570, 7346, 7345, 1115, 2710, 4718, 9596, 5144, 504, 4380, 7618, 7378, 1177, 1228, 2]
// Exports: default

// Module 12189 (SharedCustomThemeActionSheet)
...
function PrimaryActionButton(onPressApply) {
  ...
  if (obj2.getPremiumTypeFromSubscription(stateFromStores) !== PremiumTypes.TIER_2) {
    ...
    tmp6 = closure_12(tmp2(5144).Button, obj4);
  }
  return tmp6;
}
const noop = fn(19);
...
export default function _default(message) {
  ...
  obj6.title = intl.string(require("module_2710")["3ej1LT"]);
  ...
  obj8.children = intl2.string(require("module_2710").qZMUoL);
