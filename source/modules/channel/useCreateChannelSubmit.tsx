...
// Dependencies: [5, 32, 19, 1074, 1894, 1086, 9806, 4456, 1114, 2]
// Exports: default

// Module 9805 (useCreateChannelSubmit)
import CreateChannelActionCreatorsDefault from "CreateChannelActionCreators" /* 9806 */;
        ...
        if (0 === c7) {
          ...
          if (3 === tmp8) {
            ...
            if (null != closure_131_9) {
              ...
              if (null != id) {
                const AccessibilityAnnouncer2 = closure_0(4456).AccessibilityAnnouncer;
