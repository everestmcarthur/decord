...
// Dependencies: [19, 17, 9197, 1074, 21, 9319, 5636, 4635, 1115, 2]
// Exports: default
...
export default function CreateChannelTypeDescription(guildId) {
  ...
  if (hasItem) {
    const VISIBLE = tmp(5636).GuildProfileVisibilitySets.VISIBLE;
  ...
  if (tmp6) {
    ...
    obj2.children = jsx(tmp(4635).Text, { variant: "text-sm/normal", color: "text-subtle", children: null });
    tmp9 = <View>{null}</View>;
  }
  return tmp9;
};
