...
// Dependencies: [5, 5369, 1372, 12828, 12830, 12829, 1074, 4850, 12831, 12833, 1241, 12835, 1115, 4985, 4338, 9720, 7159, 4540, 4843, 12836, 1897, 9971, 1094, 12855, 2]
...
// Module 12827 (ContactSyncModalActionCreators)
import ConstantsIOS from "ConstantsIOS" /* 1094 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1897 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4843 */;
import PhoneActionCreatorsDefault from "PhoneActionCreators" /* 7159 */;
...
import ContactSyncAnalyticsUtils from "ContactSyncAnalyticsUtils" /* 12833 */;
...
function closeContactSyncModal(skip) {
  ...
  if (null != onComplete) {
    ...
    flag2(12833).trackFlowEnd(flag, obj2);
    if (tmp16) {
      onComplete(flag);
    } else {
    ...
    if (!back) {
      ...
      flag2(12833).trackFlowEnd(flag2, obj4);
      const obj = flag2(12833);
    }
    if (tmp2) {
      let updateAnimation = back(4843).updateAnimation;
    ...
    const timerId1 = setTimeout(() => {
      ...
      if (closure_2) {
        ...
        if (back) {
          ...
          const result = tmp7(12855).previousOnboardingStep();
          const tmp7Result = tmp7(12855);
        } else {
          updateAnimation(tmp3, ModalAnimation.SLIDE_IN_OUT);
          const obj2 = { skip: flag2 };
          tmp7(12855).nextOnboardingStep(obj2);
          const tmp7Result2 = tmp7(12855);
        }
...
export const openContactSyncModal = function openContactSyncModal(initialRoutes, FRIENDS_ADD_FRIENDS_MODAL, arg2) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12836, tmp2.paths), { initialRoutes: initialRoutes.initialRoutes, openSettingsSheet: initialRoutes.openSettings, customLandingPage: initialRoutes.customLandingPage }, closure_1_20).then(arg2);
};
...
export const openContactSyncModalDeeplink = function openContactSyncModalDeeplink() {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12836, tmp2.paths), { initialRoutes: obj.initialRoutes, openSettingsSheet: obj.openSettings, customLandingPage: obj.customLandingPage }, closure_1_20).then(undefined);
};
