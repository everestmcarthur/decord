...
// Dependencies: [19, 17, 21, 4638, 12833, 12834, 2]
// Exports: default

// Module 12832 (ContactSyncLandingImage)
import _modDef12833 from "module_12833" /* 12833 */;
import _modDef12834 from "module_12834" /* 12834 */;
...
export default function ContactSyncLandingImage() {
  ...
  const obj2 = { style: tmp.leftContainer, children: React4(React2, { resizeMode: "contain", style: tmp.landingImageLeft, source: _modDef12833 }) };
  const items = [React4(React3, obj2), ];
  const obj4 = { style: tmp.rightContainer, children: null };
  const obj3 = { resizeMode: "contain", style: tmp.landingImageLeft, source: _modDef12833 };
  obj4.children = React4(React2, { resizeMode: "contain", style: tmp.landingImageRight, source: _modDef12834 });
