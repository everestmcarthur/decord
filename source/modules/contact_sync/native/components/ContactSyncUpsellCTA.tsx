...
// Dependencies: [19, 12709, 1074, 21, 4574, 576, 8626, 1242, 12706, 7208, 1114, 13884, 2]

// Module 13883 (ContactSyncUpsellCTA)
...
require = fn;
const dismissUpsellCTA = fn(12709).dismissUpsellCTA;
...
export default noop.memo(function ContactSyncUpsellCTA(location) {
  ...
  let obj = {
    ...
    onLongPress() {
      ...
      const items = [obj3];
      obj2.options = items;
      const result = location(7208).showSimpleActionSheet(obj2);
    },
    style: null,
    iconSource: _modDef13884,
    title: null,
    subtitle: null
  };
  ...
  return jsx(location(8626).FormCTA, {
    onPress() {
      const obj2 = { type: constants2.CONTACT_SYNC_MODAL, location: null };
      let str = location;
      let str2 = location;
