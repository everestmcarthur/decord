...
// Dependencies: [5, 32, 19, 17, 1372, 12828, 21, 4640, 5770, 576, 1484, 4636, 1115, 7158, 7159, 12827, 563, 7152, 38, 7192, 7107, 2]
// Exports: AddPhoneScreen, VerifyPasswordScreen, VerifyPhoneScreen

// Module 12854 (AddPhoneScreens)
...
let obj2 = { container: { paddingTop: fn(5770).NAV_BAR_HEIGHT + 32 }, redesignContainer: null, header: null, title: null, subtitle: null };
let obj3 = { paddingTop: fn(5770).NAV_BAR_HEIGHT + 32 };
obj2.redesignContainer = { flex: 1, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, paddingTop: fn(5770).NAV_BAR_HEIGHT + 32 };
