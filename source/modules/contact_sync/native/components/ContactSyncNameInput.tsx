...
// Dependencies: [32, 19, 17, 21, 4640, 576, 7095, 1115, 4636, 1177, 5062, 12845, 2]
// Exports: default

// Module 12848 (ContactSyncNameInput)
...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  const items1 = [timestampProducer(tmp9(4636).Text, obj3), , , , ];
  ...
  items1[1] = timestampProducer(tmp9(4636).Text, obj4);
  ...
  items1[2] = timestampProducer(tmp9(4636).Text, obj5);
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4636).Text, obj7);
  }
  ...
  items2[1] = timestampProducer(tmp9(5062).Button, {
    variant: "primary",
    size: str,
    text: stringResult,
    onPress() {
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(5062).Button, obj10);
