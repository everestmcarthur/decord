...
// Dependencies: [32, 19, 17, 21, 4607, 576, 7055, 1114, 4603, 1178, 5027, 12789, 2]
// Exports: default

// Module 12792 (ContactSyncNameInput)
...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  const items1 = [timestampProducer(tmp9(4603).Text, obj3), , , , ];
  ...
  items1[1] = timestampProducer(tmp9(4603).Text, obj4);
  ...
  items1[2] = timestampProducer(tmp9(4603).Text, obj5);
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4603).Text, obj7);
  }
  ...
  items2[1] = timestampProducer(tmp9(5027).Button, {
    variant: "primary",
    size: str,
    text: stringResult,
    onPress() {
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(5027).Button, obj10);
