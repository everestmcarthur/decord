...
// Dependencies: [32, 19, 17, 21, 4639, 576, 7088, 1115, 4635, 1177, 5059, 12829, 2]
// Exports: default

// Module 12832 (ContactSyncNameInput)
...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4635).Text, obj7);
  }
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(5059).Button, obj10);
