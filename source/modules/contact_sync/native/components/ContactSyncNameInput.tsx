...
// Dependencies: [32, 19, 17, 21, 4638, 576, 7091, 1115, 4634, 1177, 5060, 12837, 2]
// Exports: default

// Module 12840 (ContactSyncNameInput)
...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4634).Text, obj7);
  }
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(5060).Button, obj10);
