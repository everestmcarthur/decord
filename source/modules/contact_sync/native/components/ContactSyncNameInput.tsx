...
// Dependencies: [32, 19, 17, 21, 4605, 576, 7033, 1114, 4601, 1178, 5025, 12764, 2]
// Exports: default

// Module 12767 (ContactSyncNameInput)
...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  const items1 = [timestampProducer(tmp9(4601).Text, obj3), , , , ];
  ...
  items1[1] = timestampProducer(tmp9(4601).Text, obj4);
  ...
  items1[2] = timestampProducer(tmp9(4601).Text, obj5);
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4601).Text, obj7);
  }
  ...
  items2[1] = timestampProducer(tmp9(5025).Button, {
    variant: "primary",
    size: str,
    text: stringResult,
    onPress() {
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(5025).Button, obj10);
