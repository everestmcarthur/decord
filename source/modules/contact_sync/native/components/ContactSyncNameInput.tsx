...
// Dependencies: [32, 19, 17, 21, 4722, 576, 7177, 1115, 4718, 1177, 5144, 12936, 2]
// Exports: default

// Module 12939 (ContactSyncNameInput)
...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  const items1 = [timestampProducer(tmp9(4718).Text, obj3), , , , ];
  ...
  items1[1] = timestampProducer(tmp9(4718).Text, obj4);
  ...
  items1[2] = timestampProducer(tmp9(4718).Text, obj5);
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4718).Text, obj7);
  }
  ...
  items2[1] = timestampProducer(tmp9(5144).Button, {
    variant: "primary",
    size: str,
    text: stringResult,
    onPress() {
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(5144).Button, obj10);
