...
// Dependencies: [32, 19, 17, 21, 4606, 576, 7054, 1114, 4602, 1178, 5026, 12787, 2]
// Exports: default

// Module 12790 (ContactSyncNameInput)
...
export default function ContactSyncNameInput(prefilledFromContactBook) {
  ...
  const items1 = [timestampProducer(tmp9(4602).Text, obj3), , , , ];
  ...
  items1[1] = timestampProducer(tmp9(4602).Text, obj4);
  ...
  items1[2] = timestampProducer(tmp9(4602).Text, obj5);
  ...
  if (flag) {
    ...
    tmp12Result = tmp12(tmp9(4602).Text, obj7);
  }
  ...
  items2[1] = timestampProducer(tmp9(5026).Button, {
    variant: "primary",
    size: str,
    text: stringResult,
    onPress() {
  ...
  if (null != onRemoveName) {
    ...
    obj9.children = tmp12(tmp9(5026).Button, obj10);
