...
// Dependencies: [19, 17, 1372, 1074, 21, 4638, 576, 504, 5673, 12844, 4634, 1115, 5060, 1241, 4482, 8491, 2]
// Exports: default

// Module 12843 (ContactSyncInviteFriends)
...
const UserUtilsDefault = tmp(4482);
const showShareActionSheet = tmp5(8491);
require = fn;
