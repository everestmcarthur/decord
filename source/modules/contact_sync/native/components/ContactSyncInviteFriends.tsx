...
// Dependencies: [19, 17, 1371, 1074, 21, 4606, 576, 504, 5638, 12794, 4602, 1114, 5026, 1242, 4451, 8447, 2]
// Exports: default

// Module 12793 (ContactSyncInviteFriends)
...
const showShareActionSheet = tmp5(8447);
require = fn;
