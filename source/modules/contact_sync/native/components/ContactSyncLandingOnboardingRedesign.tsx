...
// Dependencies: [5, 19, 17, 4848, 21, 4638, 576, 5768, 5224, 12836, 4634, 1115, 5060, 12837, 12829, 2]
// Exports: default

// Module 12835 (ContactSyncLandingOnboardingRedesign)
...
import ContactSyncErrorDefault from "ContactSyncError" /* 12837 */;
...
let obj3 = { flex: 1, justifyContent: "center", alignItems: "center", textAlign: "center", marginTop: -nativeDefault.space.PX_32 - fn(5768).NAV_BAR_HEIGHT };
obj2.content = obj3;
...
export default function ContactSyncLandingOnboardingRedesign(onNext) {
  ...
  items1[1] = closure_8(onNext(4634).Text, obj4);
  ...
  items1[2] = closure_8(onNext(4634).Text, obj5);
  ...
  obj6.children = closure_8(onNext(5060).Button, obj7);
