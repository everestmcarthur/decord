...
// Dependencies: [5, 19, 17, 4849, 21, 4639, 576, 5767, 5223, 12828, 4635, 1115, 5059, 12829, 12821, 2]
// Exports: default

// Module 12827 (ContactSyncLandingOnboardingRedesign)
import nativeDefault from "native" /* 576 */;
import RedesignContactSyncDiscoverabilityFooterDefault from "RedesignContactSyncDiscoverabilityFooter" /* 12821 */;
import _modDef12828 from "module_12828" /* 12828 */;
import ContactSyncErrorDefault from "ContactSyncError" /* 12829 */;
...
let obj3 = { flex: 1, justifyContent: "center", alignItems: "center", textAlign: "center", marginTop: -nativeDefault.space.PX_32 - fn(5767).NAV_BAR_HEIGHT };
obj2.content = obj3;
...
export default function ContactSyncLandingOnboardingRedesign(onNext) {
  ...
  items1[1] = closure_8(onNext(4635).Text, obj4);
  ...
  items1[2] = closure_8(onNext(4635).Text, obj5);
  ...
  obj6.children = closure_8(onNext(5059).Button, obj7);
