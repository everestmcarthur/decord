...
// Dependencies: [5, 19, 7538, 1372, 1074, 7352, 3, 10852, 5686, 1241, 573, 7543, 4312, 1926, 10970, 1255, 2]
// Exports: default

// Module 10969 (useMobilePurchaseSKU)
...
const require = fn;
let closure_5 = fn(7538).useNativeCheckoutStoreOrNull;
