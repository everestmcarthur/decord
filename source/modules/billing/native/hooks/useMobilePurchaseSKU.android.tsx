...
// Dependencies: [5, 19, 7534, 1372, 1074, 7348, 3, 10844, 5684, 1241, 573, 7539, 4310, 1926, 10962, 1255, 2]
// Exports: default

// Module 10961 (useMobilePurchaseSKU)
...
const require = fn;
let closure_5 = fn(7534).useNativeCheckoutStoreOrNull;
