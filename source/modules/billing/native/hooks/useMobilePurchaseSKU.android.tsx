...
// Dependencies: [5, 19, 7498, 1371, 1074, 7312, 3, 10794, 5650, 1242, 573, 7503, 4279, 1925, 10907, 1256, 2]
// Exports: default

// Module 10906 (useMobilePurchaseSKU)
...
const require = fn;
let closure_5 = fn(7498).useNativeCheckoutStoreOrNull;
