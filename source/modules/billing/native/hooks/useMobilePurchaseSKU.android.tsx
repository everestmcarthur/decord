...
// Dependencies: [5, 19, 7476, 1371, 1074, 7290, 3, 10773, 5648, 1242, 573, 7481, 4277, 1925, 10886, 1256, 2]
// Exports: default

// Module 10885 (useMobilePurchaseSKU)
...
const require = fn;
let closure_5 = fn(7476).useNativeCheckoutStoreOrNull;
