...
// Dependencies: [5, 32, 19, 17, 1372, 5595, 1074, 1374, 21, 3, 1612, 10832, 504, 11181, 7648, 1886, 9499, 11153, 4606, 4984, 7661, 5057, 4635, 5692, 5059, 10962, 1255, 10796, 7257, 10955, 2]
// Exports: default

// Module 15795 (SimpleRequestOTPActionSheet)
...
function GiftPurchaseSKUView(selectedSkuId) {
  ...
  const giftStyle = selectedSkuId(10832).useNativeGiftContext().giftStyle;
  let obj = noop;
  let obj2 = selectedSkuId(10832);
  ...
  const fetchCollectiblesProduct = selectedSkuId(11181).useFetchCollectiblesProduct(selectedSkuId);
  ...
  closure_8 = tmp(11153)(obj6);
  const items5 = [product];
  let obj4 = selectedSkuId(11181);
  ...
  items6[14] = str;
  const items7 = [closure_11(selectedSkuId(4635).Text, { variant: "text-md/medium", color: "text-overlay-light", children: items6 }), , ];
  let str4 = "Send Gift";
  if (isFetching) {
    str4 = "Loading...";
  }
  let obj9 = {
    children: closure_12(selectedSkuId(5059).Button, {
      variant: "primary",
      text: str4,
  ...
  items7[1] = closure_12(selectedSkuId(5692).Card, obj9);
  const obj11 = { children: null };
  const obj12 = { variant: "text-md/medium", color: "text-overlay-light", children: null };
  const items8 = ["Select style: ", giftStyle];
  obj12.children = items8;
  const items9 = [closure_11(selectedSkuId(4635).Text, obj12), closure_12(first(10962), {})];
  obj11.children = items9;
  items7[2] = closure_11(selectedSkuId(5692).Card, obj11);
  obj8.children = items7;
  return closure_11(selectedSkuId(5057).Stack, obj8);
}
  ...
  if ("giftSku" === requestType) {
    if (null != selectedSkuId) {
      if (null != giftRecipientId) {
        ...
        let tmp6Result = closure_12(tmp(10832).NativeGiftContextProvider, obj2);
        let tmp8 = closure_12;
      }
      const obj4 = { children: tmp6Result };
      return tmp8(tmp(7257).BottomSheet, obj4);
    }
  }
  tmp8 = closure_12;
