...
// Dependencies: [5, 32, 19, 17, 1371, 5561, 1074, 1373, 21, 3, 1611, 10788, 504, 11137, 7614, 1885, 9458, 11109, 4573, 4951, 7627, 5024, 4602, 5658, 5026, 10918, 1256, 10752, 7223, 10911, 2]
// Exports: default

// Module 15760 (SimpleRequestOTPActionSheet)
...
function GiftPurchaseSKUView(selectedSkuId) {
  ...
  const giftStyle = selectedSkuId(10788).useNativeGiftContext().giftStyle;
  let obj = noop;
  let obj2 = selectedSkuId(10788);
  ...
  const fetchCollectiblesProduct = selectedSkuId(11137).useFetchCollectiblesProduct(selectedSkuId);
  ...
  closure_8 = tmp(11109)(obj6);
  const items5 = [product];
  let obj4 = selectedSkuId(11137);
  ...
  items6[14] = str;
  const items7 = [closure_11(selectedSkuId(4602).Text, { variant: "text-md/medium", color: "text-overlay-light", children: items6 }), , ];
  let str4 = "Send Gift";
  if (isFetching) {
    str4 = "Loading...";
  }
  let obj9 = {
    children: closure_12(selectedSkuId(5026).Button, {
      variant: "primary",
      text: str4,
  ...
  items7[1] = closure_12(selectedSkuId(5658).Card, obj9);
  const obj11 = { children: null };
  const obj12 = { variant: "text-md/medium", color: "text-overlay-light", children: null };
  const items8 = ["Select style: ", giftStyle];
  obj12.children = items8;
  const items9 = [closure_11(selectedSkuId(4602).Text, obj12), closure_12(first(10918), {})];
  obj11.children = items9;
  items7[2] = closure_11(selectedSkuId(5658).Card, obj11);
  obj8.children = items7;
  return closure_11(selectedSkuId(5024).Stack, obj8);
}
  ...
  if ("giftSku" === requestType) {
    if (null != selectedSkuId) {
      if (null != giftRecipientId) {
        ...
        let tmp6Result = closure_12(tmp(10788).NativeGiftContextProvider, obj2);
        let tmp8 = closure_12;
      }
      const obj4 = { children: tmp6Result };
      return tmp8(tmp(7223).BottomSheet, obj4);
    }
  }
  tmp8 = closure_12;
