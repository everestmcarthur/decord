...
// Dependencies: [5, 32, 19, 17, 1372, 5596, 1074, 1374, 21, 3, 1612, 10840, 504, 11195, 7651, 1886, 9510, 11167, 4605, 4983, 7664, 5058, 4634, 5693, 5060, 10975, 1255, 10804, 7260, 10968, 2]
// Exports: default

// Module 15813 (SimpleRequestOTPActionSheet)
...
function GiftPurchaseSKUView(selectedSkuId) {
  ...
  const giftStyle = selectedSkuId(10840).useNativeGiftContext().giftStyle;
  let obj = noop;
  let obj2 = selectedSkuId(10840);
  ...
  const fetchCollectiblesProduct = selectedSkuId(11195).useFetchCollectiblesProduct(selectedSkuId);
  ...
  closure_8 = tmp(11167)(obj6);
  const items5 = [product];
  let obj4 = selectedSkuId(11195);
  ...
  items6[14] = str;
  const items7 = [closure_11(selectedSkuId(4634).Text, { variant: "text-md/medium", color: "text-overlay-light", children: items6 }), , ];
  let str4 = "Send Gift";
  if (isFetching) {
    str4 = "Loading...";
  }
  let obj9 = {
    children: closure_12(selectedSkuId(5060).Button, {
      variant: "primary",
      text: str4,
  ...
  items7[1] = closure_12(selectedSkuId(5693).Card, obj9);
  const obj11 = { children: null };
  const obj12 = { variant: "text-md/medium", color: "text-overlay-light", children: null };
  const items8 = ["Select style: ", giftStyle];
  obj12.children = items8;
  const items9 = [closure_11(selectedSkuId(4634).Text, obj12), closure_12(first(10975), {})];
  obj11.children = items9;
  items7[2] = closure_11(selectedSkuId(5693).Card, obj11);
  obj8.children = items7;
  return closure_11(selectedSkuId(5058).Stack, obj8);
}
  ...
  if ("giftSku" === requestType) {
    if (null != selectedSkuId) {
      if (null != giftRecipientId) {
        ...
        let tmp6Result = closure_12(tmp(10840).NativeGiftContextProvider, obj2);
        let tmp8 = closure_12;
      }
      const obj4 = { children: tmp6Result };
      return tmp8(tmp(7260).BottomSheet, obj4);
    }
  }
  tmp8 = closure_12;
