...
// Dependencies: [5, 32, 19, 17, 1371, 5562, 1074, 1373, 21, 3, 1611, 10790, 504, 11139, 7615, 1885, 9460, 11111, 4574, 4952, 7628, 5025, 4603, 5659, 5027, 10920, 1256, 10754, 7224, 10913, 2]
// Exports: default
...
function GiftPurchaseSKUView(selectedSkuId) {
  ...
  const giftStyle = selectedSkuId(10790).useNativeGiftContext().giftStyle;
  let obj = noop;
  let obj2 = selectedSkuId(10790);
  ...
  const fetchCollectiblesProduct = selectedSkuId(11139).useFetchCollectiblesProduct(selectedSkuId);
  ...
  closure_8 = tmp(11111)(obj6);
  const items5 = [product];
  let obj4 = selectedSkuId(11139);
  ...
  items6[14] = str;
  const items7 = [closure_11(selectedSkuId(4603).Text, { variant: "text-md/medium", color: "text-overlay-light", children: items6 }), , ];
  let str4 = "Send Gift";
  if (isFetching) {
    str4 = "Loading...";
  }
  let obj9 = {
    children: closure_12(selectedSkuId(5027).Button, {
      variant: "primary",
      text: str4,
  ...
  items7[1] = closure_12(selectedSkuId(5659).Card, obj9);
  const obj11 = { children: null };
  const obj12 = { variant: "text-md/medium", color: "text-overlay-light", children: null };
  const items8 = ["Select style: ", giftStyle];
  obj12.children = items8;
  const items9 = [closure_11(selectedSkuId(4603).Text, obj12), closure_12(first(10920), {})];
  obj11.children = items9;
  items7[2] = closure_11(selectedSkuId(5659).Card, obj11);
  obj8.children = items7;
  return closure_11(selectedSkuId(5025).Stack, obj8);
}
  ...
  if ("giftSku" === requestType) {
    if (null != selectedSkuId) {
      if (null != giftRecipientId) {
        ...
        let tmp6Result = closure_12(tmp(10790).NativeGiftContextProvider, obj2);
        let tmp8 = closure_12;
      }
      const obj4 = { children: tmp6Result };
      return tmp8(tmp(7224).BottomSheet, obj4);
    }
  }
  tmp8 = closure_12;
