...
// Dependencies: [109, 5, 4301, 4299, 4303, 1074, 4308, 1085, 573, 1271, 4540, 4319, 4231, 4297, 4964, 4966, 4312, 4972, 4973, 1241, 2]
...
// Module 4963 (actions/BillingActionCreators)
...
import BillingPaymentGatewayActionCreators from "BillingPaymentGatewayActionCreators" /* 4966 */;
import HandleConfirmPaymentRegistry from "HandleConfirmPaymentRegistry" /* 4973 */;
    ...
    try {
      ...
      if (0 === c4) {
        if (arg0 === 1) {
          ...
          if (!tmp36) {
            tmp36 = _modDef4231().diff(lastLazyPerkSync, "hours") >= 1;
            const obj6 = _modDef4231();
          }
          if (tmp36) {
            FULL_RESYNC = constants2.FULL_RESYNC;
            closure_128_0 = _modDef4231();
          }
          const HTTP = HTTPUtils.HTTP;
...
const UserLazyPerkSyncLevels = fn(4308).UserLazyPerkSyncLevels;
Constants = fn(1085);
