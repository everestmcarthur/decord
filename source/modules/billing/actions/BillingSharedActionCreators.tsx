...
const StripeErrorTypes = fn(4933).StripeErrorTypes;
...
export const dispatchConfirmationError = function dispatchConfirmationError(type, flag, stringResult, arg3) {
  ...
  if (flag2) {
    ...
    obj9.extra = obj14;
    const result = tmp15(4279).captureBillingException(error1, obj9);
