...
const StripeErrorTypes = fn(4964).StripeErrorTypes;
...
export const dispatchConfirmationError = function dispatchConfirmationError(type, flag, stringResult, arg3) {
  ...
  if (flag2) {
    ...
    obj9.extra = obj14;
    const result = tmp15(4310).captureBillingException(error1, obj9);
    const tmp15Result = tmp15(4310);
  }
  return error1;
};
