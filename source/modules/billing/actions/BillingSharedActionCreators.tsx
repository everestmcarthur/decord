...
const StripeErrorTypes = fn(5048).StripeErrorTypes;
...
export const dispatchConfirmationError = function dispatchConfirmationError(type, flag, stringResult, arg3) {
  ...
  if (flag2) {
    ...
    obj9.extra = obj14;
    const result = tmp15(4395).captureBillingException(error1, obj9);
    const tmp15Result = tmp15(4395);
  }
  return error1;
};
