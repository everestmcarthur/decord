...
// Dependencies: [5, 32, 19, 17, 5587, 4860, 1372, 21, 4639, 576, 4458, 4341, 4489, 4338, 12398, 12399, 7563, 1115, 504, 1090, 4484, 12400, 10520, 4376, 4640, 1177, 10519, 5071, 5207, 10306, 4635, 5059, 2]
// Exports: default

// Module 12397 (DMMessageStickerGreeting)
...
const END = fn(4458).GradientPercentage.END;
        ...
        if (0 === c4) {
          if (arg0 === 1) {
            ...
            function showErrorToast(content) {
              ...
              obj.open({ key: "HANDLE_WAVE_PRESS_TOAST", content, icon: closure_1(12398) });
            }
