...
// Dependencies: [19, 17, 4867, 1074, 21, 4639, 1364, 576, 504, 7257, 1177, 4635, 1115, 2025, 2]
// Exports: default

// Module 11953 (MessageGameIconActionSheet)
...
export default function MessageGameIconActionSheet(applicationId) {
  ...
  if (null != stateFromStores) {
    ...
    tmp5Result = tmp5(tmp2(7257).BottomSheet, obj5);
  }
  return tmp5Result;
};
