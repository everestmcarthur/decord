...
// Dependencies: [32, 19, 17, 1955, 21, 4639, 576, 7889, 4607, 4608, 573, 4376, 4640, 10758, 1944, 1177, 7931, 4635, 1115, 4350, 2]
// Exports: default

// Module 17065 (BurstReactionAnimationContainer)
  ...
  if (null != animationData) {
    ...
    obj3.children = function children(markAsDismissed) {
      ...
      if (tmp6Result) {
        ...
        const items2 = [tmp(tmp2(4635).Text, obj9), ];
