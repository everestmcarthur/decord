...
// Dependencies: [32, 19, 17, 1955, 21, 4640, 576, 7904, 4608, 4609, 573, 4376, 4641, 10774, 1944, 1177, 7946, 4636, 1115, 4350, 2]
// Exports: default

// Module 17162 (BurstReactionAnimationContainer)
...
function BurstReactionAnimationContainerInner() {
  ...
  const effect = noop.useEffect(() => {
    function handleEffectReceived(channelId) {
      ...
      closure_1_4(true);
      ref.current = true;
      const result = handleEffectReceived(4608).triggerHapticFeedback(first(4609).IMPACT_HEAVY);
    }
  ...
  if (null != animationData) {
    ...
    obj3.children = function children(markAsDismissed) {
      ...
      obj2.style = items;
      const obj3 = {
        activeOpacity: closure_0(7904).BACKDROP_OPACITY,
        onPress() {
          closure_4(false);
      ...
      if (first1) {
        ...
        tmpResult = tmp(first(7946), obj7);
      }
      obj5.children = tmpResult;
      items1[1] = closure_1_8(handleComponentFinish, obj5);
      let tmp6Result = markAsDismissed.visibleContent === tmp2(1944).DismissibleContent.SUPER_REACTIONS_MOBILE_FULLSCREEN_TAP_TO_DISMISS;
      if (tmp6Result) {
        ...
        const items2 = [tmp(tmp2(4636).Text, obj9), ];
    ...
    tmp8 = closure_8(animationData(10774), obj3);
    let tmp11 = animationData(10774);
  }
  return tmp8;
}
...
obj3.opacity = fn(7904).BACKDROP_OPACITY;
