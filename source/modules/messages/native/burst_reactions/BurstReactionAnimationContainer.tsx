...
// Dependencies: [32, 19, 17, 1954, 21, 4605, 576, 7835, 4573, 4574, 573, 4341, 4606, 10695, 1943, 1178, 7877, 4601, 1114, 4315, 2]
// Exports: default

// Module 17009 (BurstReactionAnimationContainer)
...
function BurstReactionAnimationContainerInner() {
  ...
  const effect = noop.useEffect(() => {
    function handleEffectReceived(channelId) {
      ...
      closure_1_4(true);
      ref.current = true;
      const result = handleEffectReceived(4573).triggerHapticFeedback(first(4574).IMPACT_HEAVY);
    }
  ...
  if (null != animationData) {
    ...
    obj3.children = function children(markAsDismissed) {
      ...
      obj2.style = items;
      const obj3 = {
        activeOpacity: closure_0(7835).BACKDROP_OPACITY,
        onPress() {
          closure_4(false);
      ...
      if (tmp6Result) {
        ...
        const items2 = [tmp(tmp2(4601).Text, obj9), ];
      ...
      obj.children = closure_1_8(first(4341).View, obj2);
      return closure_1_8(closure_0(1178).OverlayView, obj);
    };
    tmp8 = closure_8(animationData(10695), obj3);
    let tmp11 = animationData(10695);
  }
  return tmp8;
}
...
obj3.opacity = fn(7835).BACKDROP_OPACITY;
