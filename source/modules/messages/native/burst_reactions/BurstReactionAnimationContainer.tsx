...
// Dependencies: [32, 19, 17, 1955, 21, 4722, 576, 7986, 4690, 4691, 573, 4458, 4723, 10868, 1944, 1177, 8028, 4718, 1115, 4432, 2]
// Exports: default
  ...
  if (null != animationData) {
    ...
    obj3.children = function children(markAsDismissed) {
      ...
      if (tmp6Result) {
        ...
        const items2 = [tmp(tmp2(4718).Text, obj9), ];
