...
// Dependencies: [32, 19, 17, 1955, 21, 4638, 576, 7898, 4606, 4607, 573, 4374, 4639, 10766, 1944, 1177, 7940, 4634, 1115, 4348, 2]
// Exports: default

// Module 17122 (BurstReactionAnimationContainer)
...
function BurstReactionAnimationContainerInner() {
  ...
  const effect = noop.useEffect(() => {
    function handleEffectReceived(channelId) {
      ...
      closure_1_4(true);
      ref.current = true;
      const result = handleEffectReceived(4606).triggerHapticFeedback(first(4607).IMPACT_HEAVY);
    }
  ...
  if (null != animationData) {
    ...
    obj3.children = function children(markAsDismissed) {
      ...
      if (tmp6Result) {
        ...
        const items2 = [tmp(tmp2(4634).Text, obj9), ];
      ...
      obj.children = closure_1_8(first(4374).View, obj2);
      return closure_1_8(closure_0(1177).OverlayView, obj);
    };
    tmp8 = closure_8(animationData(10766), obj3);
    let tmp11 = animationData(10766);
  }
  return tmp8;
}
