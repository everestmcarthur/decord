...
// Dependencies: [32, 19, 4631, 21, 4639, 504, 4376, 4640, 5614, 2]
// Exports: default

// Module 7932 (FadeOutLottieAnimation)
...
export default function FadeOutLottieAnimation(onComplete) {
  ...
  T.__closure = { isAnimationComplete, isFadeOut: first1, withTiming: onComplete(4640).withTiming, runOnJS: onComplete(4376).runOnJS, setIsFadeOut: tmp5[1] };
  ...
  if (!isAnimationComplete) {
    ...
    obj3.children = jsx(isAnimationComplete(5614), { style: tmp2.content, speed: null, onAnimationFinish: null });
    let tmp14Result = tmp14(isAnimationComplete(4376).View, obj3);
    const tmp16 = isAnimationComplete(5614);
  } else {
    tmp14Result = null;
  }
  return tmp14Result;
