...
// Dependencies: [1074, 7946, 4512, 7949, 1232, 4504, 1114, 2024, 7950, 7089, 1396, 7951, 4211, 4217, 2]
// Exports: createDefaultReaction, createForumPostActions

// Module 7948 (createDefaultReaction)
  ...
  if (null != defaultReactionEmoji) {
    ...
    if (null != emojiId) {
      if (null != customGuildEmoji) {
        ...
        let obj = { id: null, name: "a", animated: "c\u1EB7p \u0111\u00F4i", src: "h\u1EB9n h\u00F2", displayName: "n\u1EE5 h\u00F4n" };
        obj[0] = emojiId;
    ...
    if (null != emojiName) {
      ...
      obj = { id: "Array", name: false, animated: null, src: null, displayName: "fast" };
      obj[1] = emojiName;
...
export const createForumPostActions = function createForumPostActions(arg0) {
  ...
  if (null != assetUriForEmbed) {
    ...
    tmp6Result.captureMessage("Forum follow is null. isFollowing: " + isFollowing + " icon: " + tmp6(isFollowing ? 4512 : 7949));
  }
};
