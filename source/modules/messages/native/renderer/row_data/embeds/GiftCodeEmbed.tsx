...
// Function ID: 13436
// Name: GiftCodeEmbed
// Dependencies: [17, 502, 11681, 1372, 5680, 1074, 1374, 13436, 13437, 13438, 13439, 13440, 13441, 13442, 13443, 13444, 13445, 13446, 11276, 4566, 8164, 4573, 4540, 1115, 12051, 12052, 576, 4314, 8155, 8165, 13447, 13448, 13449, 13450, 13451, 7422, 4380, 2]
// Exports: createGiftCodeEmbed

// Module 13435 (GiftCodeEmbed)
          ...
          if (obj.getIsResolved(giftCode)) {
            ...
            if (null == value) {
              ...
              if (obj25.isThemeDark(closure_1)) {
                let tmp119Result = tmp119(12051);
                let tmp121 = tmp119;
              } else {
                tmp119Result = tmp119(12052);
                tmp121 = tmp119;
              }
              ...
              if (tmp17) {
                ...
                obj3.hours = expiresAt.diff(_modDef4314(), "h");
              ...
              if (tmp15) {
                ...
                if (TIER_0.TIER_0 === skuId) {
                  ...
                  if (tmp79Result2.isThemeDark(closure_1)) {
                    let tmp86Result = tmp86(13448);
                  } else {
                    tmp86Result = tmp86(13449);
                  }
                  ...
                  if (tmp50.TIER_1 === skuId) {
                    ...
                    if (tmp69Result2.isThemeDark(closure_1)) {
                      let tmp76Result = tmp76(13448);
                      let tmp78 = tmp76;
                    } else {
                      tmp76Result = tmp76(13449);
                      tmp78 = tmp76;
                    }
                    ...
                    if (tmp50.TIER_2 !== skuId) {
                      if (tmp50.LEGACY !== skuId) {
                        ...
                        if (obj29.isThemeDark(closure_1)) {
                          let tmp137Result = tmp137(13448);
                          tmp52 = tmp137;
                        } else {
                          tmp137Result = tmp137(13449);
                          tmp52 = tmp137;
                        }
                    ...
                    if (tmp58Result2.isThemeDark(closure_1)) {
                      let tmp65Result = tmp65(13448);
                      let tmp67 = tmp65;
                    } else {
                      tmp65Result = tmp65(13449);
                      tmp67 = tmp65;
                    }
                  ...
                  if (tmp55Result.isGameItemSKU(value2)) {
                    const str3 = tmp55(7422).getGameItemThumbnailUrl(value2);
                    let str1;
                    if (str3 != null) {
                      str1 = str3.toString();
                    }
                  ...
                  if (message.type === constants2.CUSTOM_GIFT) {
                    if (!tmp13) {
                      ...
                      let str4 = tmp52(4566).getName(currentUser);
                      if (str4 == null) {
                        str4 = "";
                      }
                      const obj8 = { recipientDisplayName: str4 };
                      const tmp52Result = tmp52(4566);
                      ...
                      obj6.splashHasRadialGradient = !tmp52(4380).isPremiumSku(value.skuId);
                      const tmp52Result5 = tmp52(4380);
                      let num5 = 0.97;
