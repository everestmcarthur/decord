...
// Function ID: 13326
// Name: GiftCodeEmbed
// Dependencies: [17, 502, 11567, 1372, 5595, 1074, 1374, 13326, 13327, 13328, 13329, 13330, 13331, 13332, 13333, 13334, 13335, 13336, 11161, 4484, 8052, 4491, 4458, 1115, 11943, 11944, 576, 4231, 8043, 8053, 13337, 13338, 13339, 13340, 13341, 7333, 4297, 2]
          ...
          if (obj.getIsResolved(giftCode)) {
            ...
            if (null == value) {
              ...
              if (obj25.isThemeDark(closure_1)) {
                let tmp119Result = tmp119(11943);
                let tmp121 = tmp119;
              } else {
                tmp119Result = tmp119(11944);
                tmp121 = tmp119;
              }
              ...
              if (tmp15) {
                ...
                if (TIER_0.TIER_0 === skuId) {
                  ...
                  if (tmp79Result2.isThemeDark(closure_1)) {
                    let tmp86Result = tmp86(13338);
                  } else {
                    tmp86Result = tmp86(13339);
                  }
                  ...
                  if (tmp50.TIER_1 === skuId) {
                    ...
                    if (tmp69Result2.isThemeDark(closure_1)) {
                      let tmp76Result = tmp76(13338);
                      let tmp78 = tmp76;
                    } else {
                      tmp76Result = tmp76(13339);
                      tmp78 = tmp76;
                    }
                    ...
                    if (tmp50.TIER_2 !== skuId) {
                      if (tmp50.LEGACY !== skuId) {
                        ...
                        if (obj29.isThemeDark(closure_1)) {
                          let tmp137Result = tmp137(13338);
                          tmp52 = tmp137;
                        } else {
                          tmp137Result = tmp137(13339);
                          tmp52 = tmp137;
                        }
                    ...
                    if (tmp58Result2.isThemeDark(closure_1)) {
                      let tmp65Result = tmp65(13338);
                      let tmp67 = tmp65;
                    } else {
                      tmp65Result = tmp65(13339);
                      tmp67 = tmp65;
                    }
                  ...
                  if (tmp55Result.isGameItemSKU(value2)) {
                    const str3 = tmp55(7333).getGameItemThumbnailUrl(value2);
                    let str1;
                    if (str3 != null) {
                      str1 = str3.toString();
                    }
