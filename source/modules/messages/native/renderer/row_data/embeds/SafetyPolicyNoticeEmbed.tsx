      ...
      if (type === MessageEmbedTypes.SAFETY_POLICY_NOTICE) {
        ...
        if (null != rawValue) {
          if (null != parsed) {
            ...
            obj.titleIcon = renderer_EmbedUtils.getAssetUriForEmbed(Image.resolveAssetSource(_modDef8622));
            const intl2 = util.intl;
            const obj3 = { daysAgo: null };
            const obj4 = _modDef4166();
            obj3.daysAgo = obj4.diff(_modDef4166.unix(parsed), "days");
