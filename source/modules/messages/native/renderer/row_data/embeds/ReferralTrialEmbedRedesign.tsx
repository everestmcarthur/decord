...
// Dependencies: [1958, 1372, 4303, 7564, 7351, 1074, 1374, 4640, 576, 7354, 8191, 1115, 4484, 2025, 4297, 7563, 8192, 1609, 8082, 8188, 2]
      ...
      if (channel.isDM()) {
        ...
        if (null != user) {
          if (null != user1) {
            ...
            obj6.headerImageUrl = tmp41(8191);
            ...
            if (null == relevantUserTrialOffer) {
              ...
              const values = Object.values(tmp39(7354).TrialIdToProductOfferId[closure_9]);
              id = undefined;
              ...
              const result = tmp39(7563).hasUserTrialOfferExpired(relevantUserTrialOffer);
              const tmp39Result = tmp39(7563);
              ...
              if (!tmp15) {
                ...
                const referralTrialOfferExpirationCopy = tmp39(8192).getReferralTrialOfferExpirationCopy(expiresAt.getTime());
                const intl = tmp39(1115).intl;
                const tmp39Result5 = tmp39(8192);
              ...
              if (tmp10) {
                if (!tmp21) {
                  ...
                  if (tmp27) {
                    ...
                    obj13.acceptLabelIconUrl = tmp39(8082).getAssetUriForEmbed(tmp41(8188));
                    tmp31 = obj13;
                    const tmp39Result7 = tmp39(8082);
                  }
                  return tmp31;
                }
              }
        ...
        const obj19 = { titleText: "", titleColor, headerImageUrl: tmp41(8191), headerText: "", headerColor: headerTextColor, backgroundColor, borderColor: backgroundColor, bodyText: null, bodyTextColor: null, canBeAccepted: false };
