...
// Dependencies: [1956, 4834, 502, 1957, 4646, 1371, 11403, 12034, 1114, 12035, 13313, 13323, 12036, 12037, 7236, 12225, 2]
// Exports: createActivityInstanceEmbed

// Module 13322 (EmbeddedActivityInstanceEmbed)
    ...
    if (null != id1) {
      if (null != channel) {
        ...
        if (ContentClassificationVisibility.ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          ...
          const embeddedActivityParticipantAvatarUris = tmp5(13313).getEmbeddedActivityParticipantAvatarUris(obj);
          id = application.id;
          value = undefined;
          if (found != null) {
          ...
          obj8 = PresenceStore;
          const tmp5Result = tmp5(13313);
          const playInContext = tmp5(12036).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(12037).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result9 = tmp5(12037);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            const application1 = tmp5(7236).fetchApplication(application.id);
            const tmp5Result10 = tmp5(7236);
          }
          const obj6 = { displayType: tmp5(12035).AppMessageEmbedDisplayType.DISPLAY, appId: application.id, messageId: message.id, title: null, header: null, info: null, tagline: null, staticBannerSrc: null, iconSrc: null, embedUrl: null, bannerRatio: "bot", actions: null, extendedType: null, gradientColors: null, backgroundColor: 0, borderColor: 0, headerColor: 0, headerText: null, type: null };
          ...
          const tmp5Result8 = tmp5(12036);
          const obj7 = { applicationId: application.id, referrerId: AuthenticationStore.getId() };
          obj6.embedUrl = tmp5(12225).getActivityLaunchURL(obj7);
          obj6.actions = items;
          obj6.extendedType = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result11 = tmp5(12225);
          obj6.gradientColors = tmp5(12037).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(12034).ContentClassificationVisibility.BLOCK_UNDERAGE) {
