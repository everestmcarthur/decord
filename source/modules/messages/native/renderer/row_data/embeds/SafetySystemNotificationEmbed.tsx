...
// Dependencies: [17, 1074, 4198, 8682, 5088, 8506, 8021, 1114, 2]
// Exports: createSafetySystemNotificationEmbed

// Module 13345 (SafetySystemNotificationEmbed)
          ...
          if (null != parseMessageForPropsResult) {
            ...
            if (null != parseMessageForPropsResult.ctas) {
              ...
              if (null != parseMessageForPropsResult.ctas[0]) {
                mapCtaToNativeDataResult = tmp6(8506).mapCtaToNativeData(parseMessageForPropsResult.ctas[0], parseMessageForPropsResult.learn_more_link, parseMessageForPropsResult.classification_id);
                const tmp6Result = tmp6(8506);
              }
              let mapCtaToNativeDataResult1;
              if (null != parseMessageForPropsResult.ctas[1]) {
                mapCtaToNativeDataResult1 = tmp6(8506).mapCtaToNativeData(parseMessageForPropsResult.ctas[1], parseMessageForPropsResult.learn_more_link, parseMessageForPropsResult.classification_id);
                const tmp6Result3 = tmp6(8506);
              }
            ...
            const obj2 = { titleText: str, titleIcon: tmp6(8021).getAssetUriForEmbed(Image.resolveAssetSource(importDefault("danger" === parseMessageForPropsResult.icon ? 8682 : 5088))), subtitleText: null, descriptionText: null, primaryCtaText: null, primaryCtaType: null, primaryCtaKey: null, secondaryCtaText: null, secondaryCtaType: null, secondaryCtaKey: null, footerTheme: null };
            ...
            const tmp6Result4 = tmp6(8021);
            const obj7 = _modDef4198();
            obj3.daysAgo = obj7.diff(_modDef4198.unix(num), "days");
