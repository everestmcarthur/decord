...
// Dependencies: [17, 11563, 7841, 8052, 11924, 13357, 1363, 1115, 8043, 576, 4491, 11943, 11944, 13355, 2]
...
import BuildOverrideStore2 from "BuildOverrideStore" /* 11563 */;
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 11924).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(tmp(13355)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
