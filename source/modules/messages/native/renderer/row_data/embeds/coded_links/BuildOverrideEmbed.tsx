...
// Dependencies: [17, 11558, 7838, 8049, 11919, 13351, 1364, 1114, 8040, 576, 4488, 11938, 11939, 13349, 2]
// Exports: createBuildOverrideEmbed

// Module 13350 (BuildOverrideEmbed)
...
import BuildOverrideStore2 from "BuildOverrideStore" /* 11558 */;
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 11919).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(tmp(13349)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
