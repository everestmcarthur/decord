...
// Dependencies: [17, 11521, 7809, 8020, 11885, 13320, 1364, 1114, 8011, 576, 4458, 11904, 11905, 13318, 2]
// Exports: createBuildOverrideEmbed

// Module 13319 (BuildOverrideEmbed)
...
import BuildOverrideStore2 from "BuildOverrideStore" /* 11521 */;
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 11885).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(tmp(13318)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
