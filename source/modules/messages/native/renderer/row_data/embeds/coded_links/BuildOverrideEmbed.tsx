...
// Dependencies: [17, 11559, 7838, 8049, 11920, 13352, 1362, 1114, 8040, 576, 4488, 11939, 11940, 13350, 2]
// Exports: createBuildOverrideEmbed

// Module 13351 (BuildOverrideEmbed)
...
import BuildOverrideStore2 from "BuildOverrideStore" /* 11559 */;
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 11920).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(tmp(13350)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
