...
// Dependencies: [17, 11519, 7808, 8019, 11883, 13318, 1364, 1114, 8010, 576, 4458, 11902, 11903, 13316, 2]
// Exports: createBuildOverrideEmbed

// Module 13317 (BuildOverrideEmbed)
...
import BuildOverrideStore2 from "BuildOverrideStore" /* 11519 */;
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 11883).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(tmp(13316)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
