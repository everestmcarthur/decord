...
// Dependencies: [19, 17, 502, 4556, 7841, 21, 8052, 7997, 11618, 11619, 4348, 11943, 11944, 11945, 8053, 11946, 7999, 4606, 4560, 7257, 7256, 11947, 11617, 2]
// Exports: createExperimentEmbed, default

// Module 11942 (ExperimentEmbed)
import ExperimentEmbedUtils from "ExperimentEmbedUtils" /* 7997 */;
...
import useCodedLinksExperimentEmbeds from "useCodedLinksExperimentEmbeds" /* 11617 */;
...
export const createExperimentEmbed = function createExperimentEmbed(url, arg1) {
  ...
  if (null != experimentFromEmbedURL) {
    if (null != tmp10) {
      ...
      const experimentBuckets = tmp4(7997).getExperimentBuckets(tmp10);
      ...
      const tmp4Result = tmp4(7997);
      const experimentServerAssignment = tmp4(11945).getExperimentServerAssignment(tmp10, id);
      const tmp4Result6 = tmp4(11945);
      const experimentServerAssignmentLabel = tmp4(7997).getExperimentServerAssignmentLabel(tmp10, experimentServerAssignment);
      if (EXPERIMENT === tmp13.EXPERIMENT_TREATMENT) {
        ...
        obj5.thumbnailUrl = tmp4(8053).getAssetUriForEmbed(tmp(11946));
        ...
        obj6.thumbnailUrl = tmp4(8053).getAssetUriForEmbed(tmp(11946));
