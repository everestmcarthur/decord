...
// Dependencies: [19, 17, 502, 4554, 7850, 21, 8061, 8006, 11626, 11627, 4346, 11951, 11952, 11953, 8062, 11954, 8008, 4605, 4558, 7260, 7259, 11955, 11625, 2]
...
export const createExperimentEmbed = function createExperimentEmbed(url, arg1) {
  ...
  if (null != experimentFromEmbedURL) {
    if (null != tmp10) {
      ...
      const experimentBuckets = tmp4(8006).getExperimentBuckets(tmp10);
      ...
      const tmp4Result = tmp4(8006);
      const experimentServerAssignment = tmp4(11953).getExperimentServerAssignment(tmp10, id);
      const tmp4Result6 = tmp4(11953);
      const experimentServerAssignmentLabel = tmp4(8006).getExperimentServerAssignmentLabel(tmp10, experimentServerAssignment);
      if (EXPERIMENT === tmp13.EXPERIMENT_TREATMENT) {
        ...
        obj5.thumbnailUrl = tmp4(8062).getAssetUriForEmbed(tmp(11954));
        ...
        obj6.thumbnailUrl = tmp4(8062).getAssetUriForEmbed(tmp(11954));
