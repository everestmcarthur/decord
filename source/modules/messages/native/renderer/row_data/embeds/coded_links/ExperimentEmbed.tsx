...
// Dependencies: [19, 17, 502, 4556, 7856, 21, 8081, 8012, 11634, 11635, 4348, 11960, 11961, 11962, 8082, 11963, 8014, 4607, 4560, 7264, 7263, 11964, 11633, 2]
...
export const createExperimentEmbed = function createExperimentEmbed(url, arg1) {
  ...
  if (null != experimentFromEmbedURL) {
    if (null != tmp10) {
      ...
      const experimentBuckets = tmp4(8012).getExperimentBuckets(tmp10);
      ...
      const experimentServerAssignment = tmp4(11962).getExperimentServerAssignment(tmp10, id);
      const tmp4Result6 = tmp4(11962);
      const experimentServerAssignmentLabel = tmp4(8012).getExperimentServerAssignmentLabel(tmp10, experimentServerAssignment);
      if (EXPERIMENT === tmp13.EXPERIMENT_TREATMENT) {
        ...
        obj5.thumbnailUrl = tmp4(8082).getAssetUriForEmbed(tmp(11963));
        ...
        obj6.thumbnailUrl = tmp4(8082).getAssetUriForEmbed(tmp(11963));
