...
// Dependencies: [1957, 1979, 8078, 8079, 8035, 8037, 1114, 4501, 8039, 2]
// Exports: createUserPremiumGuildSubscriptionTierAchievedSystemMessage

// Module 8080 (UserPremiumGuildSubscriptionTierAchievedSystemMessage)
  ...
  if (null == channel) {
    ...
    if (null == guild) {
      ...
      if (tmp13 > 1) {
        ...
        const obj2 = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: tmp16, guildName: guild.name, newTierName: tmp14(4501).getTierName(TIER_1), numSubscriptions: tmp13 };
        ...
        const obj3 = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: tmp16, guildName: guild.name, newTierName: tmp14(4501).getTierName(TIER_1) };
        formatToPartsResult = intl.formatToParts(tmp14(1114).t.oAYAP7, obj3);
        const tmp14Result2 = tmp14(4501);
      }
