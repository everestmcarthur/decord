...
// Dependencies: [1957, 8055, 8035, 8147, 1114, 8037, 8039, 2]
// Exports: createVoiceSessionSystemMessage

// Module 8146 (VoiceSessionSystemMessage)
...
export const createVoiceSessionSystemMessage = function createVoiceSessionSystemMessage(message) {
  ...
  if (null == tmp3) {
    ...
    obj3.usernameOnClick = tmp(8037)(obj4);
    ...
    obj5.usernameOnClick = tmp(8037)(obj6);
