...
// Dependencies: [1957, 8054, 8034, 8146, 1114, 8036, 8038, 2]
// Exports: createVoiceSessionSystemMessage

// Module 8145 (VoiceSessionSystemMessage)
...
export const createVoiceSessionSystemMessage = function createVoiceSessionSystemMessage(message) {
  ...
  if (null == tmp3) {
    ...
    obj3.usernameOnClick = tmp(8036)(obj4);
    ...
    obj5.usernameOnClick = tmp(8036)(obj6);
