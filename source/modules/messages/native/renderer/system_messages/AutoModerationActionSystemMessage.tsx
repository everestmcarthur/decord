...
// Dependencies: [17, 1957, 2021, 4245, 4255, 1371, 1074, 12, 4458, 576, 8011, 7582, 4840, 1114, 8066, 4198, 8089, 8090, 1396, 8093, 6684, 1399, 8094, 8095, 8039, 4760, 4233, 4288, 8096, 8097, 2]
// Exports: createAutoModerationActionSystemMessage

// Module 8088 (AutoModerationActionSystemMessage)
...
const CommunicationDisabledUtils = tmp(4233);
const DateUtils = tmp(4288);
const useChannelName = tmp(4760);
const useMessageAuthor = tmp(4840);
const AutomodMessageUtils = tmp(7582);
const RowGeneratorStyleSheet = tmp(8011);
const AutomodNotificationEmbedTypeKeys = tmp(8066);
const AutomodRaidAlertTypes = tmp(8089);
const GuildAntiRaidUtils = tmp(8090);
const getRoleIcon = tmp(8095);
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (result1) {
        ...
        if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.RAID !== notificationType) {
          if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.MENTION_RAID === notificationType) {
            ...
            if (null != resolvedReason.raidDatetime) {
              fromNowResult = _modDef4198(resolvedReason.raidDatetime).fromNow();
              const obj17 = _modDef4198(resolvedReason.raidDatetime);
            }
            ...
            obj2.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef6684)).uri;
            ...
            if (null != avatar) {
              ...
              obj4.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef8094)).uri;
              ...
              obj4.subtitleRight = _modDef4198(message.timestamp).fromNow();
              ...
              tmp14 = obj4;
              tmp15 = stringResult;
              const obj16 = _modDef4198(message.timestamp);
            }
            ...
            obj5.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef6684)).uri;
      ...
      let fromNowResult1;
      if (null != resolvedReason.raidDatetime) {
        fromNowResult1 = _modDef4198(resolvedReason.raidDatetime).fromNow();
        const obj22 = _modDef4198(resolvedReason.raidDatetime);
      }
      let str2 = "";
      if (null != resolvedReason.raidDatetime) {
        const _Date = Date;
      ...
      obj8.headerIconURL = getRaidAlertResolveCTAText(intl9(importDefault(tmp42 ? 8093 : 6684))).uri;
    ...
    if (null == guildId) {
      ...
      obj12.actionsIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(tmp57(result1 ? 8096 : 8097))).uri;
