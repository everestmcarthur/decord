...
// Dependencies: [17, 1958, 2022, 4278, 4288, 1372, 1074, 12, 4491, 576, 8043, 7615, 4872, 1115, 8098, 4231, 8121, 8122, 1397, 8125, 6717, 1400, 8126, 8127, 8071, 4792, 4266, 4321, 8128, 8129, 2]
// Exports: createAutoModerationActionSystemMessage

// Module 8120 (AutoModerationActionSystemMessage)
...
const useChannelName = tmp(4792);
const useMessageAuthor = tmp(4872);
const AutomodMessageUtils = tmp(7615);
const RowGeneratorStyleSheet = tmp(8043);
const AutomodNotificationEmbedTypeKeys = tmp(8098);
const AutomodRaidAlertTypes = tmp(8121);
const GuildAntiRaidUtils = tmp(8122);
const getRoleIcon = tmp(8127);
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (result1) {
      ...
      if (AutomodMessageUtils.IS_BACKWARDS_COMPAT_RAID_TYPE !== notificationType) {
        if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.RAID !== notificationType) {
          if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.MENTION_RAID === notificationType) {
            ...
            obj2.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef6717)).uri;
            ...
            if (null != avatar) {
              ...
              obj4.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef8126)).uri;
            ...
            obj5.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef6717)).uri;
      ...
      obj8.headerIconURL = getRaidAlertResolveCTAText(intl9(importDefault(tmp42 ? 8125 : 6717))).uri;
    ...
    if (null == guildId) {
      ...
      obj12.actionsIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(tmp57(result1 ? 8128 : 8129))).uri;
