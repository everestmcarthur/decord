...
// Dependencies: [1957, 1979, 8027, 8034, 8107, 8036, 8108, 8038, 1114, 1399, 1396, 2]
// Exports: createGuildReportRaidSystemMessage

// Module 8114 (GuildReportRaidSystemMessage)
...
import getTagPropertiesDefault from "getTagProperties" /* 8108 */;
...
export const createGuildReportRaidSystemMessage = function createGuildReportRaidSystemMessage(roleStyle) {
  ...
  obj3.guildName = str;
  const obj4 = {};
  const merged = Object.assign(tmp(8038)(roleStyle));
