...
// Dependencies: [1957, 1979, 8028, 8035, 8108, 8037, 8109, 8039, 1114, 1399, 1396, 2]
// Exports: createGuildReportRaidSystemMessage

// Module 8115 (GuildReportRaidSystemMessage)
...
import getTagPropertiesDefault from "getTagProperties" /* 8109 */;
...
export const createGuildReportRaidSystemMessage = function createGuildReportRaidSystemMessage(roleStyle) {
  ...
  obj3.guildName = str;
  const obj4 = {};
  const merged = Object.assign(tmp(8039)(roleStyle));
