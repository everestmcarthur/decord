...
// Function ID: 11634
// Name: ChatManager
// Dependencies: [8008, 11634, 1332, 2]

// Module 11633 (ChatManager)
import _modDef1332 from "module_1332" /* 1332 */;
import getEmbeddedActivityKeyDefault from "getEmbeddedActivityKey" /* 11634 */;
      ...
      while (true) {
        if (num3 !== self.rows.length) {
          if (num !== self._rows.length) {
            ...
            let obj2 = { changeType: tmp14.REMOVE, index: null };
            let sum2 = num3 + num2;
            obj2.index = sum2;
