...
// Dependencies: [17, 4598, 8087, 1114, 8089, 8091, 2]
// Exports: default

// Module 8086 (getTagProperties)
...
export default function getTagProperties(arg0) {
  ...
  if (!obj.isPublicSystemMessage(message)) {
      ...
      if (isCrosspostDefault(message)) {
        ...
        if (message.author.bot) {
          ...
          if (isVerifiedBotResult) {
            uri = Image.resolveAssetSource(tmp4(8091)).uri;
          }
          flag = isVerifiedBotResult;
    ...
    if (null == stringResult) {
      ...
      const obj2 = { tagText: stringResult, tagAccessibilityLabel: null, tagVerified: flag, tagTextColor: "Boolean", tagBackgroundColor: "ti", tagType: SYSTEM_DM_TAG_SYSTEM_TYPE, tagIconUrl: tmp5, opTagText: stringResult2, opTagTextColor: false, opTagBackgroundColor: false };
