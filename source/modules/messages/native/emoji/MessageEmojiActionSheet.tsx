...
// Dependencies: [19, 17, 1074, 21, 4607, 1115, 1256, 7224, 1242, 10421, 10428, 10429, 2]
// Exports: default

// Module 10420 (MessageEmojiActionSheet)
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import StandardEmojiContentDefault from "StandardEmojiContent" /* 10421 */;
import CustomEmojiContentDefault from "CustomEmojiContent" /* 10429 */;
...
function MessageCustomEmojiActionSheet(emojiNode) {
  ...
  if (emojiAndSource.isFetching) {
    ...
    return jsx(tmp2(7224).BottomSheet, {
      startExpanded: true,
      onDismiss() {
          AnalyticsUtilsDefault.track(AnalyticEvents.CLOSE_POPOUT, { nonce });
        },
