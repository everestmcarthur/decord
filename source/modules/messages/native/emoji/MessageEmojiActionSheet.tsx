...
// Dependencies: [19, 17, 1074, 21, 4722, 1364, 1255, 7346, 1241, 10572, 10579, 10580, 2]
// Exports: default

// Module 10571 (MessageEmojiActionSheet)
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import StandardEmojiContentDefault from "StandardEmojiContent" /* 10572 */;
import CustomEmojiContentDefault from "CustomEmojiContent" /* 10580 */;
...
function MessageCustomEmojiActionSheet(emojiNode) {
  ...
  if (emojiAndSource.isFetching) {
    ...
    return jsx(tmp2(7346).BottomSheet, {
      startExpanded: true,
      onDismiss() {
          AnalyticsUtilsDefault.track(AnalyticEvents.CLOSE_POPOUT, { nonce });
        },
