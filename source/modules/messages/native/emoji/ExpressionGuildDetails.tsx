...
// Dependencies: [19, 17, 5671, 21, 4638, 576, 5670, 1397, 5673, 4634, 1115, 5208, 10481, 5676, 1177, 2]

// Module 10482 (ExpressionGuildDetails)
...
const GuildBadgeDefault = tmp8(5676);
require = fn;
const View = fn(17).View;
const React4 = fn(5671).ExpressionSourceGuildRecord;
const jsxProd = fn(21);
