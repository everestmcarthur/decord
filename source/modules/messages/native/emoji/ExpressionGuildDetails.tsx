...
// Dependencies: [19, 17, 5670, 21, 4639, 576, 5669, 1397, 5672, 4635, 1115, 5207, 10473, 5675, 1177, 2]

// Module 10474 (ExpressionGuildDetails)
...
const GuildBadgeDefault = tmp8(5675);
require = fn;
const View = fn(17).View;
const React4 = fn(5670).ExpressionSourceGuildRecord;
const jsxProd = fn(21);
