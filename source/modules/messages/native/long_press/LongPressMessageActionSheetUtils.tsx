...
const isMessageComponentsV2 = fn(4256).isMessageComponentsV2;
                  ...
                  if (null != user) {
                    if (chatInputRef != null) {
                      ...
                      if (current7 != null) {
                        ...
                        current7.insertText("@" + tmp130(4451).getUserTag(user, { decoration: "never" }), null, true);
                        const tmp130Result = tmp130(4451);
                      }
                    }
                    if (chatInputRef != null) {
