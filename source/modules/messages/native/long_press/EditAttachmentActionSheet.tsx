...
// Dependencies: [5, 32, 19, 4943, 4715, 1074, 21, 8400, 8498, 1385, 1115, 4433, 7652, 7393, 7345, 5142, 576, 4718, 7281, 5774, 5144, 2]
// Exports: default

// Module 11919 (EditAttachmentActionSheet)
...
require = fn;
let closure_7 = fn(4715).LEGACY_SPOILER_ATTACHMENT_PREFIX;
...
export default function EditAttachmentActionSheet(arg0) {
  ...
  const tmp5 = attachment(8498)(attachment);
  ...
  if (null != tmp17) {
    ...
    tmp19Result = tmp19(tmp(4718).Text, obj7);
  }
  items[3] = tmp19Result;
