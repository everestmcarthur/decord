          ...
          if (obj6.hasFlag(num, MessageFlags.IS_GUILD_OFFICIAL)) {
            ...
            if (tmp5) {
              if (null == tmp4.messages[message.id]) {
                const messageRecord = tmp23(4859).createMessageRecord(message);
                if (null != obj[guildId]) {
                  obj = {};
                  const merged = Object.assign(obj);
                  const obj2 = {};
  ...
  MESSAGE_UPDATE: function handleMessageUpdate(message) {
    ...
    if (null == message.id) {
      ...
      if (null == guildId) {
        ...
        if (hasFlagResult) {
          if (null == tmp45) {
            const messageRecord = tmp46(4859).createMessageRecord(message);
            if (null != obj[guildId]) {
              const obj5 = {};
        ...
        if (hasFlagResult) {
          if (null != tmp45) {
            const updateMessageRecordResult1 = tmp46(4859).updateMessageRecord(tmp45, message);
            if (null != obj[guildId]) {
              const obj15 = {};
