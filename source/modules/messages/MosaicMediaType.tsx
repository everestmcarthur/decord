            ...
            if (!obj2.isImageFile(filename)) {
              ...
              if (tmp5Result.isVideoFile(filename)) {
                ...
                if (null != proxy_url.proxy_url) {
                  ...
                  str5 = str6;
                  tmp5Result2 = tmp5(1385);
                }
              }
              str3 = str5;
              tmp5Result = tmp5(4790);
            }
            let str = str3;
