...
// Dependencies: [1074, 1091, 7377, 11, 4321, 2]
// Exports: isNewGroupItem

// Module 12086 (isNewMessageGroup)
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4321).isWithinInterval(content.timestamp, type.timestamp, closure_6);
