...
// Dependencies: [1074, 1090, 7344, 11, 4288, 2]
// Exports: isNewGroupItem

// Module 12047 (isNewMessageGroup)
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4288).isWithinInterval(content.timestamp, type.timestamp, closure_6);
