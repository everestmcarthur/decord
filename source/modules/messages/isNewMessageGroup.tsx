...
// Dependencies: [1074, 1091, 7380, 11, 4319, 2]
// Exports: isNewGroupItem

// Module 12094 (isNewMessageGroup)
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4319).isWithinInterval(content.timestamp, type.timestamp, closure_6);
