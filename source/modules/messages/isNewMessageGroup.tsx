...
// Dependencies: [1074, 1091, 7466, 11, 4404, 2]
// Exports: isNewGroupItem

// Module 12194 (isNewMessageGroup)
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4404).isWithinInterval(content.timestamp, type.timestamp, closure_6);
