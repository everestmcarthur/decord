...
// Dependencies: [32, 19, 4847, 12407, 1074, 4376, 1110, 12924, 4466, 4479, 12917, 9640, 2]
// Exports: default

// Module 17240 (usePanelOpenState)
...
export default function usePanelOpenState(arg0, arg1, arg2, connected) {
  ...
  [first, closure_6] = doCloseChannel.useState(() => closure_1(12924).getHistory().location.pathname);
  const items1 = [arg0, first];
  const effect1 = doCloseChannel.useEffect(() => {
    closure_0 = closure_1(12924).addRouteChangeListener((pathname) => {
