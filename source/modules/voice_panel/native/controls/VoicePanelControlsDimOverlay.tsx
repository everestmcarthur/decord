...
// Dependencies: [19, 14337, 12515, 12513, 21, 12514, 4458, 17548, 5143, 14655, 5130, 2]

// Module 17583 (VoicePanelControlsDimOverlay)
...
require = fn;
let closure_4 = fn(14337).BACKDROP_OPAQUE_MAX_OPACITY;
