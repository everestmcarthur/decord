...
// Dependencies: [32, 19, 17, 4623, 17138, 7600, 1957, 1963, 21, 4542, 12367, 17120, 9755, 563, 9764, 9758, 9873, 4574, 9791, 17139, 9875, 8688, 9878, 1114, 5732, 17140, 10124, 17141, 7463, 8355, 4427, 6682, 1943, 17142, 12623, 7897, 2]
// Exports: useShouldShowFloatingCTA

// Module 17137 (VoicePanelFloatingCTAUtils)
...
import GuildScheduledEventsNoticesActionCreators from "GuildScheduledEventsNoticesActionCreators" /* 17139 */;
import soundboard_SoundboardActionCreators from "soundboard/SoundboardActionCreators" /* 17142 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import ChannelRTCStore from "ChannelRTCStore" /* 4623 */;
import EventBannerStore from "EventBannerStore" /* 17138 */;
...
function useFloatingCTAProps(stateFromStores) {
  let tmp3 = setShowFloatingCTA(8355)(noop.useContext(setShowFloatingCTA(12367)).showFloatingCTA);
  _require = tmp3;
  setShowFloatingCTA = undefined;
  setShowFloatingCTA = noop.useContext(setShowFloatingCTA(12367)).setShowFloatingCTA;
  ...
  const tmp5 = setShowFloatingCTA(4542)();
  const tmp6 = setShowFloatingCTA(17120)(noop.useContext(setShowFloatingCTA(12367)).channelId);
  let id1;
  ...
  const tmpResult = setShowFloatingCTA(9873);
  [][0] = stateFromStores;
    ...
    if (null != stateFromStores) {
      if (canManageGuildEventResult) {
        if (!tmp12) {
          ...
          const tmp7Result9 = tmp7(9875);
          obj3.eventTimeData = tmp7(9758).getEventTimeData(scheduled_start_time);
          ...
          const obj5 = { IconComponent: tmp7(9878).CalendarIcon, variant: "translucent" };
          obj4.icon = jsx(tmp7(8688).RowButton.Icon, { IconComponent: tmp7(9878).CalendarIcon, variant: "translucent" });
          obj4.label = name;
          ...
          obj7.onPress = tmp20;
          obj7.children = jsx(tmp7(5732).XSmallIcon, { color: "interactive-icon-default" });
          obj4.trailing = <Pressable accessibilityRole="button" accessibilityLabel={null} onPress={null}>{null}</Pressable>;
          const tmp21 = obj4;
          const tmp7Result10 = tmp7(9758);
        }
      }
    }
  }
  closure_130_0 = stateFromStores;
  tmpResultResult = setShowFloatingCTA(9873)(guild_id, id2, nextRecurrenceIdInEvent);
  const tmp26 = setShowFloatingCTA(17120)(noop.useContext(setShowFloatingCTA(12367)).channelId);
  ...
  if (null != stateFromStores) {
    if (tmp26) {
      if (stateFromStores1) {
        ...
        const obj9 = { IconComponent: tmp7(10124).GroupPlusIcon, variant: "translucent" };
        obj8.icon = jsx(tmp7(8688).RowButton.Icon, { IconComponent: tmp7(10124).GroupPlusIcon, variant: "translucent" });
        obj8.onPress = tmp29;
        const tmp30 = obj8;
      }
    }
...
function getDismissableCTAProps(arg0) {
  ...
  if (dismissible_content.DismissibleContent.VOICE_PANEL_BAD_CONNECTION_CTA === dismissableContent) {
    ...
    let obj = {
      icon: jsx(tmp(12623).SoundboardIcon, { color: "interactive-icon-default" }),
      onPress() {
          if (null != _require) {
    ...
    obj.label = tmp(7897).getDeviceSpecificString(obj2, tmp(1114).t.IJgkPX);
