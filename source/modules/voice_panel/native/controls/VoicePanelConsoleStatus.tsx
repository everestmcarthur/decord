...
// Dependencies: [19, 12515, 12518, 12513, 21, 4722, 576, 12514, 17549, 4458, 4432, 17556, 17554, 5143, 5759, 1177, 4718, 5292, 9686, 1115, 17557, 2]
// Exports: renderVoicePanelConsoleStatus

// Module 17555 (VoicePanelConsoleStatus)
...
const CONTROLS_HEIGHT = fn(12513).CONTROLS_HEIGHT;
const jsxProd = fn(21);
...
let obj5 = {};
let merged = Object.assign(fn(12515).MODE_CHANGE_PHYSICS);
