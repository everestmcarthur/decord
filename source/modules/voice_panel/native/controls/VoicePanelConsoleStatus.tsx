...
// Dependencies: [19, 12424, 12427, 12422, 21, 4640, 576, 12423, 17419, 4376, 4350, 17426, 17424, 5061, 5677, 1177, 4636, 5210, 9602, 1115, 17427, 2]
// Exports: renderVoicePanelConsoleStatus

// Module 17425 (VoicePanelConsoleStatus)
...
const CONTROLS_HEIGHT = fn(12422).CONTROLS_HEIGHT;
const jsxProd = fn(21);
...
let obj5 = {};
let merged = Object.assign(fn(12424).MODE_CHANGE_PHYSICS);
