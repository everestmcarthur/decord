...
// Dependencies: [32, 19, 4622, 2014, 502, 1957, 1908, 4243, 1371, 4624, 21, 3, 4605, 504, 7397, 10073, 10088, 12342, 4341, 17188, 4573, 9766, 6705, 17277, 17278, 1114, 10075, 4601, 9194, 10074, 2]
// Exports: MicButton, PTTButton

// Module 17276 (VoicePanelMicButton)
...
export const MicButton = function MicButton(arg0) {
  ...
  const memo = noop.useMemo(() => {
    if (dominantMuteState === VoiceActionUtils.DominantMuteState.SERVER_MUTE) {
      ...
      let tmp3Result = map1(tmp(9194).MicrophoneDenyIcon, obj2);
    } else {
      if (mute) {
      ...
      tmp3Result = map1(tmp(10074).VoicePanelRiveMicButton, obj);
    }
    return tmp3Result;
  }, items2);
