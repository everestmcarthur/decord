...
// Dependencies: [19, 17, 4744, 502, 21, 4458, 5144, 4722, 576, 10306, 504, 4774, 4723, 7269, 4718, 1115, 2]
// Exports: VoicePanelStreamPreview

// Module 13284 (VoicePanelStreamPreview)
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  if (stateFromStores) {
    ...
    obj8.children = tmp16(tmp8(4718).Text, obj9);
