...
// Dependencies: [19, 17, 4662, 502, 21, 4376, 5062, 4640, 576, 10212, 504, 4692, 4641, 7187, 4636, 1115, 2]
// Exports: VoicePanelStreamPreview

// Module 13193 (VoicePanelStreamPreview)
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  if (stateFromStores) {
    ...
    obj8.children = tmp16(tmp8(4636).Text, obj9);
