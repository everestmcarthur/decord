...
// Dependencies: [19, 17, 21, 4638, 1364, 4374, 5059, 4572, 7183, 5047, 4489, 5675, 2]

// Module 12424 (VoicePanelHeaderGlassBlur)
...
export default noop.memo(function HeaderGlassBlur(shown) {
  ...
  const animatedStyle = shown(4374).useAnimatedStyle(fn);
  let obj = shown(4374);
  ...
  const obj3 = shown(4374);
  fn2.__closure = { withSpring: shown(5059).withSpring, shown };
  ...
  obj5.style = items;
  const obj4 = { withSpring: shown(5059).withSpring, shown };
  ...
  items3[1] = closure_4(tmp6Result2, { style: tmp2(4489).isThemeDark(tmp7) ? tmp.strokeAlt : tmp.strokeAltLight });
