...
// Dependencies: [19, 17, 21, 4639, 1364, 4376, 5058, 4574, 7180, 5048, 4491, 5674, 2]

// Module 12416 (VoicePanelHeaderGlassBlur)
...
export default noop.memo(function HeaderGlassBlur(shown) {
  ...
  fn2.__closure = { withSpring: shown(5058).withSpring, shown };
  ...
  obj5.style = items;
  const obj4 = { withSpring: shown(5058).withSpring, shown };
