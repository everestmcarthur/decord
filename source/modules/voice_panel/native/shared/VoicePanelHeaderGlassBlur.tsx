...
// Dependencies: [19, 17, 21, 4640, 1364, 4376, 5061, 4574, 7187, 5049, 4491, 5677, 2]

// Module 12433 (VoicePanelHeaderGlassBlur)
...
export default noop.memo(function HeaderGlassBlur(shown) {
  ...
  const animatedStyle = shown(4376).useAnimatedStyle(fn);
  let obj = shown(4376);
  ...
  const obj3 = shown(4376);
  fn2.__closure = { withSpring: shown(5061).withSpring, shown };
  ...
  obj5.style = items;
  const obj4 = { withSpring: shown(5061).withSpring, shown };
  ...
  items3[1] = closure_4(tmp6Result2, { style: tmp2(4491).isThemeDark(tmp7) ? tmp.strokeAlt : tmp.strokeAltLight });
