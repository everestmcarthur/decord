...
// Dependencies: [19, 17, 4802, 1962, 1957, 4595, 21, 4574, 9244, 1114, 4990, 7156, 504, 4727, 9163, 8934, 576, 12302, 4726, 17142, 4987, 5047, 17065, 17139, 5051, 8295, 1094, 17138, 17143, 2]
...
function ChannelButtonIcons() {
  ...
  const items = [React7(ShieldLockIcon.ShieldLockIcon, obj2), React7(BaseTextButton.BaseTextButton.Icon, { source: _modDef7156 })];
  obj.children = items;
...
function ActivityButton(participant) {
  ...
  obj3.text = str;
  obj3.icon = _modDef5047;
  obj3.onPress = participant.onPress;
  const items1 = [closure_9(participant(8934).HeaderButton, obj3), closure_9(QuestActivityButtonDefault, { applicationId: participant.applicationId })];
  obj2.children = items1;
  return closure_10(participant(4987).Stack, obj2);
}
...
export default noop.memo(function VoicePanelTitleButton() {
  ...
  const derivedStateFromSharedValue = guildId(8295).useDerivedStateFromSharedValue(focused, (id) => {
    id = undefined;
    if (id != null) {
      id = id.id;
    }
