...
// Dependencies: [19, 17, 4833, 1962, 1957, 4626, 21, 4605, 9281, 1114, 5026, 7194, 504, 4758, 9200, 8971, 576, 12342, 4757, 17201, 5023, 5083, 17124, 17198, 5087, 8332, 1094, 17197, 17202, 2]

// Module 17200 (VoicePanelTitleButton)
...
import ShieldLockIcon from "ShieldLockIcon" /* 9281 */;
import VoicePanelStateContextDefault from "VoicePanelStateContext" /* 12342 */;
import QuestActivityButtonDefault from "QuestActivityButton" /* 17124 */;
import VoicePanelHeaderUserState from "VoicePanelHeaderUserState" /* 17198 */;
import _modDef17201 from "module_17201" /* 17201 */;
import VoicePanelSettingsActionCreators from "VoicePanelSettingsActionCreators" /* 17202 */;
import noop from "module_19" /* 19 */;
import ApplicationStore from "ApplicationStore" /* 4833 */;
import StageInstanceStore from "StageInstanceStore" /* 1962 */;
import ChannelStore from "ChannelStore" /* 1957 */;

const _modDef5087 = tmp5(5087);
require = fn;
function ChannelButtonIcons() {
  ...
  const items = [React7(ShieldLockIcon.ShieldLockIcon, obj2), React7(BaseTextButton.BaseTextButton.Icon, { source: _modDef7194 })];
  obj.children = items;
...
function ChannelButton(channelId) {
  ...
  const isCallSecureFramesVerified = channelId(9200).useIsCallSecureFramesVerified({ channelId });
...
function ActivityButton(participant) {
  ...
  obj3.text = str;
  obj3.icon = _modDef5083;
  obj3.onPress = participant.onPress;
  const items1 = [closure_9(participant(8971).HeaderButton, obj3), closure_9(QuestActivityButtonDefault, { applicationId: participant.applicationId })];
  obj2.children = items1;
  return closure_10(participant(5023).Stack, obj2);
}
...
export default noop.memo(function VoicePanelTitleButton() {
  ...
  const derivedStateFromSharedValue = guildId(8332).useDerivedStateFromSharedValue(focused, (id) => {
    id = undefined;
    if (id != null) {
      id = id.id;
    }
  ...
  const tmp3 = channelId(17197)(derivedStateFromSharedValue, channelId, guildId);
