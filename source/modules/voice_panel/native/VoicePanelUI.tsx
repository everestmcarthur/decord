...
function AnimatedWrapper(children) {
  ...
  obj7[2] = callback2(height(7073), obj8);
...
let closure_70 = importAllResult.memo((onPress) => {
  ...
  obj = { withSpring: opacity(4974).withSpring, opacity, DrawerShadeOpacityPhysics: closure_68 };
  fn.__closure = obj;
