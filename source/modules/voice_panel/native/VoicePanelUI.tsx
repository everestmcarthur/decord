...
// Function ID: 17340
// Name: VoicePanelUI
// Dependencies: [32, 19, 17, 4656, 8439, 4848, 12424, 12422, 4661, 12425, 21, 3, 5061, 4640, 576, 4376, 1609, 12423, 1612, 6766, 9649, 11508, 17340, 4608, 17334, 4341, 12428, 9830, 17338, 17325, 11152, 9761, 7717, 7187, 7276, 7296, 1248, 17341, 7270, 17342, 17343, 9662, 17344, 17346, 17377, 17406, 17410, 17415, 2]

// Module 17339 (VoicePanelUI)
...
import calculateVoicePanelHeaderSpecsDefault from "calculateVoicePanelHeaderSpecs" /* 12428 */;
import VoicePanelPIPUtils from "VoicePanelPIPUtils" /* 17334 */;
import utils_triggerIOSHapticDefault from "utils/triggerIOSHaptic" /* 17340 */;
import useControlsLockDefault from "useControlsLock" /* 17341 */;
...
function AnimatedWrapper(children) {
  ...
  let connected;
  let animatedStyle1;
  const height = wrapperOffset(9830).useGlobalStatusIndicatorState().height;
  const tmp3 = closure_31();
  dependencyMap = tmp3;
  const context = connected.useContext(height(12423));
  ...
  const derivedValue = wrapperOffset(4376).useDerivedValue(fn);
  obj4 = wrapperOffset(17338);
  const pIPState = obj4.usePIPState();
  let obj3 = wrapperOffset(4376);
      ...
      if (modeToSet !== VoicePanelModes.PIP) {
        ...
        if (modeToSet === tmp8.PANEL) {
          if (connected) {
            ...
            const maxPanelWidth = tmp(17325).getMaxPanelWidth(obj3);
            const tmpResult = tmp(17325);
            const panelX = tmp(17325).getPanelX(windowWidth, maxPanelWidth);
            const _Math = Math;
            const tmpResult2 = tmp(17325);
          ...
          tmp16(11508)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
        }
      }
    }
  };
  let obj5 = wrapperOffset(4376);
  fn3.__closure = { cheapWorkletShallowEqual: wrapperOffset(9649).cheapWorkletShallowEqual, VoicePanelModes: animatedStyle1, wrapperDimensions, updateSharedValueIfChanged: height(11508), wrapperOffset, getMaxPanelWidth: wrapperOffset(17325).getMaxPanelWidth, getPanelX: wrapperOffset(17325).getPanelX, roundToNearestPixel: height(11152), windowDimensions };
  fn3.__workletHash = 4997805261566;
  fn3.__initData = __initData17;
  const animatedReaction = obj5.useAnimatedReaction(fn2, fn3);
  let obj6 = { cheapWorkletShallowEqual: wrapperOffset(9649).cheapWorkletShallowEqual, VoicePanelModes: animatedStyle1, wrapperDimensions, updateSharedValueIfChanged: height(11508), wrapperOffset, getMaxPanelWidth: wrapperOffset(17325).getMaxPanelWidth, getPanelX: wrapperOffset(17325).getPanelX, roundToNearestPixel: height(11152), windowDimensions };
  ...
  let obj7 = wrapperOffset(4376);
  fn4.__closure = { useReducedMotion, wrapperDimensions, wrapperOffset, connected, mode, VoicePanelModes: animatedStyle1, runOnJS: wrapperOffset(4376).runOnJS, updateSourceTrackingView: height(9761).updateSourceTrackingView, withSpring: wrapperOffset(5061).withSpring, DRAWER_SPRING_PHYSICS_GESTURE_ACTIVE, DRAWER_SIZE_PHYSICS: obj4 };
  ...
  const obj9 = wrapperOffset(4376);
  M.__closure = { computeBorderRadii, mode, connected, wrapperDimensions, withSpring: wrapperOffset(5061).withSpring, BORDER_RADIUS_PHYSICS: windowDimensions, VoicePanelModes: animatedStyle1, styles: tmp3 };
  M.__workletHash = 4435209772815;
  M.__initData = __initData19;
  animatedStyle1 = obj9.useAnimatedStyle(M);
  if (!wrapperOffset(7717).isStable) {
    class Y {
      constructor() {
    ...
    const obj12 = { runOnJS: tmp(4376).runOnJS, log };
    fn5.__closure = obj12;
    fn5.__workletHash = 5206450827682;
    fn5.__initData = __initData21;
    const animatedReaction1 = tmp(4376).useAnimatedReaction(Y, fn5);
    let tmpResult = tmp(4376);
    class H {
      constructor() {
    ...
    const obj14 = { runOnJS: tmp(4376).runOnJS, log };
    T.__closure = obj14;
    T.__workletHash = 7760779241631;
    T.__initData = __initData23;
    const animatedReaction2 = tmp(4376).useAnimatedReaction(H, T);
    let tmpResult2 = tmp(4376);
  }
  ...
  const obj10 = { computeBorderRadii, mode, connected, wrapperDimensions, withSpring: wrapperOffset(5061).withSpring, BORDER_RADIUS_PHYSICS: windowDimensions, VoicePanelModes: animatedStyle1, styles: tmp3 };
  const obj16 = { style: wrapperTransformStyles, pointerEvents: "box-none", children: null };
  const tmp4Result = height(7187);
  obj16.children = closure_21(height(7187), { style: wrapperSurfaceStyles, layout: layoutTransition, children: children.children });
  obj15.children = closure_21(height(7187), obj16);
...
const POP_RESISTANCE = fn(12425).POP_RESISTANCE;
const jsxProd = fn(21);
...
layoutTransition.__closure = { withSpring: fn(5061).withSpring, LAYOUT_PHYSICS };
...
let obj = { withSpring: fn(5061).withSpring, LAYOUT_PHYSICS };
scrollViewLayoutTransition.__closure = { withSpring: fn(5061).withSpring, LAYOUT_PHYSICS, EMBEDDED_ACTIVITY_ORIENTATION_UPDATE_SAFE_LAYOUT_PHYSICS: obj2 };
...
obj9.zIndex = 1;
obj6.wrapper = obj9;
let obj3 = { withSpring: fn(5061).withSpring, LAYOUT_PHYSICS, EMBEDDED_ACTIVITY_ORIENTATION_UPDATE_SAFE_LAYOUT_PHYSICS: obj2 };
...
let closure_70 = noop.memo((onPress) => {
  ...
  let obj = opacity(4376);
  fn.__closure = { withSpring: opacity(5061).withSpring, opacity, DrawerShadeOpacityPhysics };
...
export default noop.memo(function VoicePanelUI() {
  ...
  const sharedValue = channelId(4376).useSharedValue(0);
  closure_129_21 = sharedValue;
  let obj = channelId(4376);
  const sharedValue1 = channelId(4376).useSharedValue(false);
  closure_129_22 = sharedValue1;
  obj2 = channelId(4376);
  const sharedValue2 = channelId(4376).useSharedValue(false);
  closure_129_23 = sharedValue2;
  let obj3 = channelId(4376);
  const sharedValue3 = channelId(4376).useSharedValue({ start: 0, end: VOICE_PANEL_CHUNK_DIVISOR });
  ...
  const animatedRef = channelId(4376).useAnimatedRef();
  closure_129_28 = animatedRef;
  let obj6 = channelId(4376);
  const sharedValue4 = channelId(4376).useSharedValue({ absoluteXStart: 0, absoluteYStart: 0, cancel: false, active: false, requiresPop: false });
  closure_129_29 = sharedValue4;
  let obj7 = channelId(4376);
  let fn = function f() {
      ...
      if (mode.connected) {
        if (!mode.gestureActive) {
          if (mode === VoicePanelModes.PANEL) {
            tmp2(4376).runOnJS(closure_2)(true);
            const tmp2Result = tmp2(4376);
          }
          if (mode === VoicePanelModes.PANEL) {
            tmp2(4376).runOnJS(closure_3)(true);
            const tmp2Result6 = tmp2(4376);
          } else {
            tmp2(4376).runOnJS(closure_3)(false);
            const tmp2Result7 = tmp2(4376);
          }
          if (mode === tmp9.PIP) {
            tmp2(4376).runOnJS(noop)(true);
            const tmp2Result8 = tmp2(4376);
          } else {
            tmp2(4376).runOnJS(noop)(false);
            const tmp2Result9 = tmp2(4376);
          }
          tmp9 = VoicePanelModes;
        }
      }
      tmp2(4376).runOnJS(closure_2)(false);
      const tmp2Result10 = tmp2(4376);
    }
  };
  const obj8 = channelId(4376);
  fn2.__closure = { cheapWorkletShallowEqual: channelId(9649).cheapWorkletShallowEqual, VoicePanelModes, runOnJS: channelId(4376).runOnJS, setPanelFullscreen: callback, setPanelOpen: callback1, setPanelPIP: callback2 };
  fn2.__workletHash = 10989484188294;
  fn2.__initData = __initData2;
  const animatedReaction = obj8.useAnimatedReaction(fn, fn2);
  const obj9 = { cheapWorkletShallowEqual: channelId(9649).cheapWorkletShallowEqual, VoicePanelModes, runOnJS: channelId(4376).runOnJS, setPanelFullscreen: callback, setPanelOpen: callback1, setPanelPIP: callback2 };
  let fn3 = function _() {
    return mode.get();
  };
  fn3.__closure = { mode };
  ...
  const obj12 = channelId(4376);
  Ve.__closure = { runOnJS: channelId(4376).runOnJS, handleFocusChange: callback3 };
  ...
  const memo1 = noop.useMemo(() => {
      ...
      if (connected.get()) {
        if (mode.get() !== setMode.PIP) {
          if (controlsSpecs.get().mode === wrapperDimensions.HIDDEN) {
            channelId(4376).runOnJS(showControls)({ debounce: true });
            obj2 = channelId(4376);
          } else {
            channelId(4376).runOnJS(hideControls)({ debounce: true });
            const obj = channelId(4376);
          }
        }
      }
    };
    ...
    const fn2 = function u(arg0) {
      if (!gestureState.get().cancel) {
        closure_1(11508)(wrapperOffset, { x: 0, y: 0 });
    ...
    const fn3 = function c(state, fail) {
      if (state.state === channelId(6766).State.BEGAN) {
        if (!gestureState.get().active) {
          if (!obj5.get().cancel) {
            ...
            if (mode.get() === setMode.PANEL) {
              ...
              flag = false;
              if (tmp12) {
                channelId(4376).runOnJS(closure_1(17340))();
                flag = true;
                const tmpResult = channelId(4376);
              }
            }
            const tmp25 = closure_1(11508);
            if (flag) {
        ...
        if (merged1 !== setMode.PIP) {
          ...
          if (lockScrolling.get()) {
            ...
            if (!obj.get().requiresPop) {
              ...
              closure_1(11508)(wrapperOffset, point);
            } else {
              const _Math = Math;
              ...
              if (merged1 > 180) {
                ...
                const obj6 = channelId(4376);
                channelId(4376).runOnJS(channelId(4608).triggerHapticFeedback)(channelId(4608).HapticFeedbackTypes.IMPACT_MEDIUM);
                diff = result;
                const runOnJSResult = channelId(4376).runOnJS(channelId(4608).triggerHapticFeedback);
              }
            }
          ...
          closure_1(11508)(wrapperOffset, point1);
          const tmp7 = closure_1(11508);
        }
      }
    };
    ...
    const fn5 = function s() {
      ...
      closure_1(11508)(gestureState, { cancel: false, active: false });
      closure_1(11508)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
    };
    ...
    const fn6 = function n(velocityY) {
      if (!gestureState.get().cancel) {
        ...
        if (mode.get() === setMode.PIP) {
          ...
          const result = channelId(17334).calculatePIPPositionFromVelocity(obj6);
          ({ pipX, pipY } = result);
          const obj7 = { pipX, pipY };
          closure_1(11508)(wrapperDimensions, obj7);
          closure_1(11508)(wrapperOffset, { gestureActive: false });
          const obj5 = channelId(17334);
          ...
          if (velocityY > 0) {
            if (connected.get()) {
              if (gestureState.get().requiresPop) {
                ...
                channelId(4376).runOnJS(closure_1_15)(tmp2.PIP);
                closure_1(11508)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
                obj4 = channelId(4376);
              }
            } else {
              ...
              if (wrapperOffset.get().y > 0.2 * diff) {
                closure_1(11508)(tmp12, { gestureActive: false });
                channelId(4376).runOnJS(dismissPanel)();
                const obj3 = channelId(4376);
              } else {
                closure_1(11508)(tmp12, { gestureActive: false, x: 0, y: 0 });
  ...
  const obj13 = { runOnJS: channelId(4376).runOnJS, handleFocusChange: callback3 };
  ...
  const obj14 = channelId(4376);
  Ae.__closure = { lockScrolling: sharedValue1, isSnappingBack: sharedValue2, scrollPosition, scrollTo: channelId(4376).scrollTo, scrollerRef: animatedRef, computeViewableChunksFromScrollPosition, windowDimensions, scrollableRegionSize: sharedValue, updateSharedValueIfChanged: updateSharedValueIfChangedDefault, viewableChunks: sharedValue3 };
  ...
  const animatedReaction3 = channelId(4376).useAnimatedReaction(Te, Me);
  const obj17 = channelId(4376);
  const token = channelId(4341).useToken(nativeDefault.modules.mobile.VOICE_PANEL_GUTTER);
  closure_129_31 = token;
  const obj18 = channelId(4341);
  class Ye {
    constructor() {
  ...
  const derivedValue = channelId(4376).useDerivedValue(ke);
  ...
  if (tmp6[0]) {
    ...
    const items7 = [closure_21(tmp2(17342), {}), , ];
    ...
    obj25.onAccessibilityEscape = tmp2(9662);
    const items8 = [closure_21(tmp2(17344), {}), , , ];
    ...
    obj27.children = closure_21(tmp2(17346), obj28);
    const items9 = [closure_21(tmp13(7270).LayerScope, obj27), ];
    ...
    const items10 = [closure_21(tmp2(17377), obj33), closure_21(tmp2(17406), {})];
    obj32.children = items10;
    obj31.children = lockScrolling(closure_32, obj32);
    obj30.children = closure_21(tmp13(6766).GestureDetector, obj31);
    obj29.children = closure_21(tmp2(7187), obj30);
    items9[1] = closure_21(tmp13(6766).GestureDetector, obj29);
    obj26.children = items9;
    items8[1] = lockScrolling(AnimatedWrapper, obj26);
    items8[2] = closure_21(tmp2(17410), {});
    const obj34 = { gestureState: sharedValue4 };
    items8[3] = closure_21(tmp2(17415), obj34);
    obj25.children = items8;
    items7[2] = lockScrolling(tmp2Result, obj25);
    obj23.children = items7;
    obj22.children = lockScrolling(tmp13(7270).LayerScope, obj23);
    tmp37 = closure_21(tmp13(7276).AnalyticsLocationProvider, obj22);
    const tmp2Result2 = tmp2(7187);
  }
  return tmp37;
});
