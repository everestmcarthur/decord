...
// Dependencies: [19, 12407, 12405, 12408, 7181, 12409, 1614, 12413, 2]

// Module 12406 (VoicePanelStateContext)
import VoicePanelCardLayoutManagerDefault from "VoicePanelCardLayoutManager" /* 12409 */;
import VoicePanelPIPHandoffDefault from "VoicePanelPIPHandoff" /* 12413 */;
...
ReanimatedHelperTypes = fn(7181);
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12408).MorphablePanelModes.PANEL);
