...
// Dependencies: [19, 12424, 12422, 12425, 7188, 12426, 1614, 12430, 2]

// Module 12423 (VoicePanelStateContext)
import VoicePanelCardLayoutManagerDefault from "VoicePanelCardLayoutManager" /* 12426 */;
import VoicePanelPIPHandoffDefault from "VoicePanelPIPHandoff" /* 12430 */;
...
ReanimatedHelperTypes = fn(7188);
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12425).MorphablePanelModes.PANEL);
