...
// Dependencies: [19, 12368, 12366, 12369, 7148, 12370, 1613, 2]

// Module 12367 (VoicePanelStateContext)
...
ReanimatedHelperTypes = fn(7148);
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12369).MorphablePanelModes.PANEL);
