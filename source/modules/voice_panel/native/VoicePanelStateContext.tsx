...
// Dependencies: [19, 12415, 12413, 12416, 7184, 12417, 1614, 12421, 2]

// Module 12414 (VoicePanelStateContext)
import VoicePanelCardLayoutManagerDefault from "VoicePanelCardLayoutManager" /* 12417 */;
import VoicePanelPIPHandoffDefault from "VoicePanelPIPHandoff" /* 12421 */;
...
ReanimatedHelperTypes = fn(7184);
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12416).MorphablePanelModes.PANEL);
