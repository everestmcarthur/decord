...
// Function ID: 17286
// Name: useTapGestures
// Dependencies: [19, 12406, 6760, 4376, 4607, 2]
// Exports: default

// Module 17285 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = noop.useContext(isFocusedVideoZoomed(12406)).isFocusedVideoZoomed;
  ...
  return noop.useMemo(() => {
    ...
    const Gesture = current(6760).Gesture;
    const Gesture2 = current(6760).Gesture;
    ...
    const Gesture3 = tmp(6760).Gesture;
    ...
    const Gesture4 = tmp(6760).Gesture;
    ...
    fn3.__closure = { runOnJS: current(4376).runOnJS, triggerHapticFeedback: current(4607).triggerHapticFeedback, HapticFeedbackTypes: current(4607).HapticFeedbackTypes, handleEvent };
