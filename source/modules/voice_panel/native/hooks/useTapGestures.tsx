...
// Function ID: 17171
// Name: useTapGestures
// Dependencies: [19, 12302, 6669, 4310, 4542, 2]
// Exports: default

// Module 17170 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = noop.useContext(isFocusedVideoZoomed(12302)).isFocusedVideoZoomed;
  ...
  return noop.useMemo(() => {
    ...
    const Gesture = current(6669).Gesture;
    const Gesture2 = current(6669).Gesture;
    ...
    fn.__closure = { runOnJS: current(4310).runOnJS, handleEvent };
    fn.__workletHash = 13571114432746;
    fn.__initData = __initData;
    const obj2 = { runOnJS: current(4310).runOnJS, handleEvent };
    ...
    fn2.__closure = { runOnJS: current(4310).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    const obj3 = { runOnJS: current(4310).runOnJS, handleEvent };
    ...
    fn3.__closure = { runOnJS: current(4310).runOnJS, triggerHapticFeedback: current(4542).triggerHapticFeedback, HapticFeedbackTypes: current(4542).HapticFeedbackTypes, handleEvent };
