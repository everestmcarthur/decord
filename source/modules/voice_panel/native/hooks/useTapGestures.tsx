...
// Function ID: 17230
// Name: useTapGestures
// Dependencies: [19, 12342, 6705, 4341, 4573, 2]
// Exports: default

// Module 17229 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = noop.useContext(isFocusedVideoZoomed(12342)).isFocusedVideoZoomed;
  ...
  return noop.useMemo(() => {
    ...
    const Gesture = current(6705).Gesture;
    const Gesture2 = current(6705).Gesture;
    ...
    fn.__closure = { runOnJS: current(4341).runOnJS, handleEvent };
    fn.__workletHash = 13571114432746;
    fn.__initData = __initData;
    const obj2 = { runOnJS: current(4341).runOnJS, handleEvent };
    const Gesture3 = tmp(6705).Gesture;
    ...
    fn2.__closure = { runOnJS: current(4341).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    const obj3 = { runOnJS: current(4341).runOnJS, handleEvent };
    const Gesture4 = tmp(6705).Gesture;
    ...
    fn3.__closure = { runOnJS: current(4341).runOnJS, triggerHapticFeedback: current(4573).triggerHapticFeedback, HapticFeedbackTypes: current(4573).HapticFeedbackTypes, handleEvent };
