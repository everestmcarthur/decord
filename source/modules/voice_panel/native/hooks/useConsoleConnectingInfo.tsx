...
// Dependencies: [4624, 4625, 9307, 563, 17257, 9556, 17258, 17259, 2]
// Exports: default

// Module 17256 (useConsoleConnectingInfo)
...
import useShouldDisplayCancelConsoleTransferDefault from "useShouldDisplayCancelConsoleTransfer" /* 17257 */;
import getConsoleColorDefault from "getConsoleColor" /* 17259 */;
...
export default function useConsoleConnectingInfo(arg0) {
  ...
  obj3.text = tmp5(17258).getConsoleConnectingText(stateFromStores1, stateFromStores, channelId === arg0);
