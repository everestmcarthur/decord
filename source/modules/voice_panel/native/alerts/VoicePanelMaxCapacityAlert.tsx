...
// Dependencies: [19, 1958, 21, 563, 4989, 4989, 17337, 1115, 2]
// Exports: default

// Module 17339 (VoicePanelMaxCapacityAlert)
import VoicePanelLockedIconDefault from "VoicePanelLockedIcon" /* 17337 */;
...
export default function VoicePanelMaxCapacityAlert(channelId) {
  ...
  obj4.onPress = channelId(4989).useDismissModalCallback();
  obj3.actions = jsx(channelId(4989).AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(channelId(4989).AlertModal, { header: jsx(VoicePanelLockedIconDefault, {}), title: null, content: null, actions: null });
};
