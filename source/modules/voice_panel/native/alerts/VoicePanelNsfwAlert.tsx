...
// Dependencies: [19, 1975, 1979, 21, 4955, 4955, 1114, 5570, 5461, 2]
// Exports: default

// Module 17284 (VoicePanelNsfwAlert)
...
export default function VoicePanelNsfwAlert(guildId) {
  ...
  dependencyMap = guildId(4955).useDismissModalCallback();
  ...
  const items = [closure_5(guildId(4955).AlertActionButton, obj4, "confirm"), ];
  const obj5 = {
    variant: "secondary",
    onPress() {
  ...
  items[1] = closure_5(guildId(4955).AlertActionButton, obj5, "add-profile-picture");
  obj3.children = items;
  obj2.actions = closure_6(guildId(4955).AlertActions, obj3);
  return closure_5(guildId(4955).AlertModal, obj2);
};
