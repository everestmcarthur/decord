...
// Dependencies: [19, 17, 21, 4574, 576, 12302, 4775, 5603, 4570, 1114, 2]

// Module 17173 (VoicePanelNoVideoParticipantsCard)
...
export default noop.memo(function VoicePanelNoVideoParticipantsCard() {
  ...
  const items1 = [closure_5(channelId(4570).Text, obj2), ];
  ...
  obj3.children = closure_5(channelId(4570).Text, obj4);
