...
// Dependencies: [19, 17, 21, 4605, 576, 12342, 4806, 5639, 4601, 1114, 2]

// Module 17232 (VoicePanelNoVideoParticipantsCard)
...
export default noop.memo(function VoicePanelNoVideoParticipantsCard() {
  ...
  const items1 = [closure_5(channelId(4601).Text, obj2), ];
  ...
  obj3.children = closure_5(channelId(4601).Text, obj4);
