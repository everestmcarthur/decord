...
// Dependencies: [19, 17, 21, 4607, 576, 12367, 4808, 5641, 4603, 1114, 2]

// Module 17222 (VoicePanelNoVideoParticipantsCard)
...
export default noop.memo(function VoicePanelNoVideoParticipantsCard() {
  ...
  const items1 = [closure_5(channelId(4603).Text, obj2), ];
  ...
  obj3.children = closure_5(channelId(4603).Text, obj4);
