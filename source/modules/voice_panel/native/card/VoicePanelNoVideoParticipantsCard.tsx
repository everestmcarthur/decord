...
// Dependencies: [19, 17, 21, 4638, 576, 12414, 4839, 5675, 4634, 1115, 2]

// Module 17344 (VoicePanelNoVideoParticipantsCard)
...
export default noop.memo(function VoicePanelNoVideoParticipantsCard() {
  ...
  const items1 = [closure_5(channelId(4634).Text, obj2), ];
  ...
  obj3.children = closure_5(channelId(4634).Text, obj4);
