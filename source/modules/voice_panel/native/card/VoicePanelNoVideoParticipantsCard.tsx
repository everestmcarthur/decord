...
// Dependencies: [19, 17, 21, 4640, 576, 12423, 4841, 5677, 4636, 1115, 2]

// Module 17385 (VoicePanelNoVideoParticipantsCard)
...
export default noop.memo(function VoicePanelNoVideoParticipantsCard() {
  ...
  const items1 = [closure_5(channelId(4636).Text, obj2), ];
  ...
  obj3.children = closure_5(channelId(4636).Text, obj4);
