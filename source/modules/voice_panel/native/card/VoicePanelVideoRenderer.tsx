...
// Dependencies: [32, 19, 17, 12303, 12301, 17122, 12304, 21, 4310, 9648, 4574, 12302, 4988, 9527, 4542, 6669, 9637, 17126, 9640, 9638, 17116, 11386, 17038, 9642, 4275, 576, 4575, 7087, 9645, 2]

// Module 17167 (VoicePanelVideoRenderer)
...
import DCDVideoRendererDefault from "DCDVideoRenderer" /* 9648 */;
      ...
      if (!inPip.inPip) {
        if (!inPip.isFocused) {
          ...
          if (true === isFocused) {
            ...
            num2 = tmpResult.withDelay(300, tmp(4575).withTiming(0.3, { duration: 0 }, "animate-never"));
