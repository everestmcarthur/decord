...
// Function ID: 17167
// Name: VoicePanelCard
// Dependencies: [32, 19, 17, 4596, 4597, 5433, 12303, 12301, 17122, 12306, 1074, 4595, 12304, 21, 4310, 4570, 5001, 1178, 4574, 576, 4716, 4626, 5603, 1114, 4989, 12302, 504, 9627, 4629, 13068, 9629, 9626, 17167, 9639, 8860, 8277, 4575, 4988, 7087, 5601, 4275, 17168, 11025, 9527, 4284, 7176, 17126, 17138, 17121, 17169, 17170, 8205, 6669, 17171, 12305, 17172, 17173, 17174, 17175, 17176, 17186, 2]

// Module 17166 (VoicePanelCard)
...
import computeCardBorderRadiusDefault from "computeCardBorderRadius" /* 17168 */;
import calculateContentCenterOffsetDefault from "calculateContentCenterOffset" /* 17169 */;
...
let closure_23 = ReanimatedRexport.createAnimatedComponent(fn(4570).Text);
let ReanimatedRexport = ReanimatedRexport_mod;
...
let closure_47 = { isSelf: false, hasVideo: false, user: { id: "disabled" } };
...
layoutTransitionFunction.__closure = { withSpring: fn(4988).withSpring };
...
let obj9 = { withSpring: fn(4988).withSpring };
size = fn(2);
