...
// Dependencies: [1957, 4654, 4660, 1909, 4659, 9762, 1370, 504, 2]
// Exports: default

// Module 17286 (useIsVoicePanelParticipantFocusable)
  ...
  if (null == id2) {
    ...
    if (null == participant) {
      ...
      if (React5(participant)) {
        ...
        result = tmp4(9762).canRenderParticipantVideo(participant, tmp);
