...
// Dependencies: [19, 1074, 21, 4638, 576, 1110, 17335, 5675, 17240, 5156, 1115, 2]
// Exports: default

// Module 17334 (VoicePanelHeaderChatButton)
...
import useChatBadgeDefault from "useChatBadge" /* 17335 */;
...
export default function VoicePanelHeaderChatButton(channelId) {
  ...
  if (tmp8Result) {
    ...
    obj4.style = items1;
    obj3.children = tmp8(tmp3(5675), obj4);
    tmp8Result = tmp8(tmp3(5675), obj3);
