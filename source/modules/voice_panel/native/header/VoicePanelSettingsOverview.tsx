...
// Dependencies: [19, 1956, 4590, 9518, 502, 1957, 1908, 4212, 1371, 4598, 1074, 4595, 9184, 21, 4574, 576, 504, 17146, 4727, 9202, 9163, 5603, 4570, 9244, 1114, 5109, 7, 4272, 17143, 8389, 5619, 5625, 15595, 8660, 5626, 573, 7214, 1935, 9121, 4775, 8658, 10010, 4541, 17147, 1896, 9186, 9205, 17148, 17136, 17091, 11454, 9150, 17149, 7394, 17150, 9155, 17151, 10142, 9982, 10064, 10063, 2]

// Module 17145 (VoicePanelSettingsOverview)
...
import useIsSecureFramesVerified from "useIsSecureFramesVerified" /* 9163 */;
import SecureFramesPlatformUtilsDefault from "SecureFramesPlatformUtils" /* 9186 */;
import useIsSecureFramesUIEnabled from "useIsSecureFramesUIEnabled" /* 9202 */;
...
import getChannelInfoSubtitleDefault from "getChannelInfoSubtitle" /* 17146 */;
...
function ShareActivityLogsButton() {
  ...
  const obj = { onPress: callback, icon: collapsedCategories(TableRowIcon.TableRowIcon, { IconComponent: WrenchIcon.WrenchIcon, source: _modDef8660 }), label: null, trailing: null };
  let intl = util.intl;
...
function ActivityDebugToggle() {
  ...
  obj2.icon = collapsedCategories(TableRowIcon.TableRowIcon, { IconComponent: WrenchIcon.WrenchIcon, source: _modDef8660 });
...
export default noop.memo(function VoicePanelSettingsOverview(guildId) {
  ...
  const callback4 = stateFromStores1.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(17147, dependencyMap.paths), closure_17, { channelId });
  }, items10);
