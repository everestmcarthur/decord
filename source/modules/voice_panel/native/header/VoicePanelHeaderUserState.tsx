...
// Dependencies: [19, 4590, 21, 4310, 8934, 4574, 576, 17140, 17138, 9151, 5603, 12302, 504, 4575, 2]

// Module 17139 (VoicePanelHeaderUserState)
import nativeDefault from "native" /* 576 */;
import timing from "timing" /* 4575 */;
import NativeViewDefault from "NativeView" /* 5603 */;
import useStableParticipant from "useStableParticipant" /* 17138 */;
...
function useVoicePanelHeaderUserStateIcons(participant, guildId, userIcons) {
  ...
  while (iter !== undefined) {
    ...
    if (nextResult.type === useVoicePanelCardUserStateIcons.VoicePanelCardUserStateIconType.USER_VIDEO_ICON) {
      ...
      obj2.children = jsx(tmp11(9151).VideoIcon, { style: tmp.floatingIcon, state: null });
      let arr = items.push(jsx(tmp11(8934).BackgroundBlurView, { blurTheme: "dark", style: tmp.floatingIconWrapper, children: null }, "video"));
    }
    if (tmp9.type === tmp11(17140).VoicePanelCardUserStateIconType.MUTE_DEAFEN_ICON) {
      let tmp35 = jsx;
      let tmp36 = jsx;
      ...
      obj4.children = tmp36(tmp11(9151).MuteDeafenIcon, obj5);
      let arr2 = items.push(tmp35(tmp11(8934).BackgroundBlurView, obj4, "mute-deafen"));
    }
    continue;
  }
  if (0 !== items.length) {
...
const jsx = fn(21).jsx;
let closure_6 = ReanimatedRexport.createAnimatedComponent(fn(8934).BackgroundBlurView);
...
export default noop.memo(function VoicePanelHeaderUserState(isHeaderHidden) {
  ...
  const tmp4 = useVoicePanelHeaderUserStateIcons(channelId(17138)(stateFromStores, channelId, guildId), guildId);
  isHeaderHidden(4310);
  const fn = function h() {
    let num = 0;
  ...
  fn.__closure = { withTiming: isHeaderHidden(4575).withTiming, isHeaderHidden, OPACITY_TIMING };
