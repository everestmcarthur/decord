...
// Dependencies: [19, 17, 1390, 21, 4640, 576, 4376, 1389, 1092, 4608, 4607, 7264, 7263, 1115, 5062, 15465, 14723, 2]
// Exports: default

// Module 15464 (DisplayNameStylesGummyCustomColorSheet)
...
export default function DisplayNameStylesGummyCustomColorSheet(onSelect) {
  ...
  const callback = noop.useCallback(() => {
    const result = onSelect(4608).triggerHapticFeedback(onSelect(4608).HapticFeedbackTypes.IMPACT_LIGHT);
  }, []);
  ...
  obj5.trailing = closure_7(onSelect(5062).Button, obj6);
  obj4.header = closure_7(onSelect(7263).BottomSheetTitleHeader, obj5);
  const obj7 = { style: tmp.body, children: null };
  const obj8 = { style: tmp.previewWrapper, children: null };
  const obj3 = onSelect(1092);
  obj8.children = closure_7(View, { style: tmp.preview, children: closure_7(sharedValue(15465), { hue: sharedValue }) });
  const items1 = [closure_7(View, obj8), ];
  const obj10 = { style: tmp.huePickerInset, children: closure_7(sharedValue(14723), { hue: sharedValue, onPanFinalize: callback, saturation, lightness, fullWidth: true }) };
  items1[1] = closure_7(View, obj10);
  obj7.children = items1;
  obj4.children = closure_8(View, obj7);
  return closure_7(onSelect(7264).BottomSheet, obj4);
};
