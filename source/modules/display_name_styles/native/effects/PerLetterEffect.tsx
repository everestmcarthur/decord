...
// Dependencies: [19, 17, 21, 4722, 11152, 11153, 4718, 2]
// Exports: default

// Module 11151 (PerLetterEffect)
...
export default function PerLetterEffect(name) {
  ...
  const memo = noop.useMemo(() => {
    const regex = colors(11152)();
    closure_1 = 0;
    let obj = name(11153);
    return name(11153).splitGraphemes(regex).map((children, index) => {
      regex.lastIndex = 0;
  ...
  obj2.style = items2;
  obj2.children = memo;
  obj.children = jsx(name(4718).Text, {});
