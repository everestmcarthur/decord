...
// Dependencies: [19, 17, 21, 4607, 10996, 10997, 4603, 2]
// Exports: default

// Module 10995 (PerLetterEffect)
...
export default function PerLetterEffect(name) {
  ...
  const memo = noop.useMemo(() => {
    const regex = colors(10996)();
    closure_1 = 0;
    let obj = name(10997);
    return name(10997).splitGraphemes(regex).map((children, index) => {
      regex.lastIndex = 0;
  ...
  obj2.style = items2;
  obj2.children = memo;
  obj.children = jsx(name(4603).Text, {});
