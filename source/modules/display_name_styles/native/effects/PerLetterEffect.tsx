...
// Dependencies: [19, 17, 21, 4639, 11038, 11039, 4635, 2]
// Exports: default

// Module 11037 (PerLetterEffect)
...
export default function PerLetterEffect(name) {
  ...
  const memo = noop.useMemo(() => {
    const regex = colors(11038)();
    closure_1 = 0;
    let obj = name(11039);
    return name(11039).splitGraphemes(regex).map((children, index) => {
      regex.lastIndex = 0;
  ...
  obj2.style = items2;
  obj2.children = memo;
  obj.children = jsx(name(4635).Text, {});
