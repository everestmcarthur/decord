...
// Dependencies: [32, 19, 17, 1389, 1074, 21, 1388, 4636, 576, 11030, 1390, 558, 15430, 4604, 15431, 1242, 4603, 7253, 7252, 5056, 1114, 14704, 10378, 2]
// Exports: default

// Module 15429 (DisplayNameStylesGummyColorPickerSheet)
...
import showGummyCustomColorSheetDefault from "showGummyCustomColorSheet" /* 15431 */;
...
export default function DisplayNameStylesGummyColorPickerSheet(selectedColors) {
  ...
  const displayNameStylesEffectConfig = selectedColors(11030).useDisplayNameStylesEffectConfig(selectedColors(1390).DisplayNameEffect.GUMMY);
  if (tmp5) {
  ...
  let obj = selectedColors(11030);
  const tmp11 = onSelectColors;
  const tmp12Result = onSelectColors(15430)(selectedColors(1390).DisplayNameEffect.GUMMY);
  ...
  if (findIndexResult >= 0) {
    ...
    tmp18Result = tmp18(tmp11(14704), obj10);
  }
  const items4 = [tmp18Result, ];
  const obj11 = { style: tmp.customIconOverlay, pointerEvents: "none", children: null };
  const tmp12 = onSelectColors(15430);
  const tmp21 = first1;
  obj11.children = closure_9(closure_5, { style: tmp.customIconScrim, children: closure_9(selectedColors(10378).PencilIcon, { color: "white", size: "sm" }) });
