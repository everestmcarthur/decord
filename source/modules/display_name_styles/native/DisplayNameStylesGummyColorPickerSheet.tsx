...
// Dependencies: [32, 19, 17, 1389, 1074, 21, 1388, 4606, 576, 10991, 1390, 558, 15408, 4574, 15409, 1242, 4573, 7223, 7222, 5026, 1114, 14670, 10339, 2]
// Exports: default

// Module 15407 (DisplayNameStylesGummyColorPickerSheet)
...
import showGummyCustomColorSheetDefault from "showGummyCustomColorSheet" /* 15409 */;
...
const DisplayNameStylesUtils = fn(1388);
...
export default function DisplayNameStylesGummyColorPickerSheet(selectedColors) {
  ...
  const displayNameStylesEffectConfig = selectedColors(10991).useDisplayNameStylesEffectConfig(selectedColors(1390).DisplayNameEffect.GUMMY);
  if (tmp5) {
  ...
  let obj = selectedColors(10991);
  const tmp11 = onSelectColors;
  const tmp12Result = onSelectColors(15408)(selectedColors(1390).DisplayNameEffect.GUMMY);
  ...
  obj4.text = intl.string(selectedColors(1114).t.XqMe3N);
  obj4.onPress = callback2;
  obj3.trailing = closure_9(selectedColors(5026).Button, obj4);
  obj2.header = closure_9(selectedColors(7222).BottomSheetTitleHeader, obj3);
  ...
  obj8.accessibilityLabel = intl2.string(selectedColors(1114).t["FHBa/1"]);
  if (findIndexResult >= 0) {
    const obj9 = { style: tmp.customSwatchEmpty };
    let tmp18Result = tmp18(tmp20, obj9);
  } else {
    const obj10 = { colors: first1 };
    tmp18Result = tmp18(tmp11(14670), obj10);
  }
  const items4 = [tmp18Result, ];
  const obj11 = { style: tmp.customIconOverlay, pointerEvents: "none", children: null };
  const tmp12 = onSelectColors(15408);
  const tmp21 = first1;
  obj11.children = closure_9(closure_5, { style: tmp.customIconScrim, children: closure_9(selectedColors(10339).PencilIcon, { color: "white", size: "sm" }) });
  items4[1] = closure_9(closure_5, obj11);
  obj8.children = items4;
  obj7.children = closure_10(tmp21, obj8);
  const items5 = [
  ...
  obj13.text = intl3.string(selectedColors(1114).t.yBZMsQ);
  obj13.onPress = callback1;
  items6[1] = closure_9(selectedColors(5026).Button, obj13);
  obj5.children = items6;
  obj2.children = closure_10(closure_5, obj5);
  return closure_9(selectedColors(7223).BottomSheet, obj2);
};
