...
// Dependencies: [19, 17, 1390, 21, 1391, 4640, 576, 1365, 11054, 4874, 9331, 1389, 4875, 9330, 4341, 11055, 4636, 4646, 4344, 11058, 1370, 2]

// Module 11053 (UsernameWithEffects)
...
export default noop.memo((userName) => {
  ...
  const isDisplayNameStylesFlywheelViewersEnabled = userName(9331).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  ...
  const displayNameStylesFont = userName(9330).useDisplayNameStylesFont({ displayNameStyles: result, ignoreDisabledStylesSetting });
  let tmp12;
  ...
  const displayNameStylesAccessibleColors = userName(11055).useDisplayNameStylesAccessibleColors({ displayNameStyles: result, backgroundColor: token });
  let first;
  ...
  const tmp20 = userName(4636).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
