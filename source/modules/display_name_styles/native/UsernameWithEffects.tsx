...
// Dependencies: [19, 17, 1390, 21, 1391, 4639, 576, 1365, 11033, 4873, 9309, 1389, 4874, 9308, 4341, 11034, 4635, 4645, 4344, 11037, 1370, 2]

// Module 11032 (UsernameWithEffects)
...
export default noop.memo((userName) => {
  ...
  if (STATIC === undefined) {
    STATIC = userName(11033).EffectDisplayType.STATIC;
  }
  ...
  let num2;
  const tmp6 = num2(4873)({ userId, guildId, pendingDisplayNameStyles, ignoreDisabledStylesSetting });
  const isDisplayNameStylesFlywheelViewersEnabled = userName(9309).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  const obj = userName(9309);
  ...
  const displayNameStylesEnabled = userName(4874).useDisplayNameStylesEnabled({ location: "UsernameWithEffects" });
  const obj3 = userName(4874);
  const displayNameStylesFont = userName(9308).useDisplayNameStylesFont({ displayNameStyles: result, ignoreDisabledStylesSetting });
  let tmp12;
  ...
  const displayNameStylesAccessibleColors = userName(11034).useDisplayNameStylesAccessibleColors({ displayNameStyles: result, backgroundColor: token });
  let first;
  ...
  const tmp7Result10 = userName(4645);
  const tmp20 = userName(4635).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
  ...
  if (displayNameStylesEnabled) {
    if (null != tmp6) {
      if (STATIC !== tmp7(11033).EffectDisplayType.PLAIN) {
        if (null != colorVariants) {
          ...
          if (effectId === tmp7(1391).DisplayNameEffect.GUMMY) {
            ...
            if (tmp7(1391).DisplayNameEffect.GRADIENT !== effectId) {
              if (tmp7(1391).DisplayNameEffect.PRISM !== effectId) {
                if (tmp7(1391).DisplayNameEffect.NEON === effectId) {
                  ...
                  if (null != colorVariants) {
                    ...
                    const items6 = [closure_9(tmp7(4635).Text, obj10), ];
                    const obj11 = {};
                    ...
                    items6[1] = closure_9(tmp7(4635).Text, obj11);
              ...
              return closure_9(tmp7(4635).Text, obj13);
            }
      ...
      return closure_9(tmp7(4635).Text, obj14);
    }
  }
  const obj15 = {};
  ...
  return closure_9(userName(4635).Text, obj15);
});
