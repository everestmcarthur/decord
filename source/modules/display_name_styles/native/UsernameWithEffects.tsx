...
// Dependencies: [19, 17, 1390, 21, 1391, 4638, 576, 1365, 11046, 4872, 9320, 1389, 4873, 9319, 4339, 11047, 4634, 4644, 4342, 11050, 1370, 2]

// Module 11045 (UsernameWithEffects)
...
export default noop.memo((userName) => {
  ...
  const isDisplayNameStylesFlywheelViewersEnabled = userName(9320).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  ...
  const displayNameStylesFont = userName(9319).useDisplayNameStylesFont({ displayNameStyles: result, ignoreDisabledStylesSetting });
  let tmp12;
  ...
  const displayNameStylesAccessibleColors = userName(11047).useDisplayNameStylesAccessibleColors({ displayNameStyles: result, backgroundColor: token });
  let first;
  ...
  const tmp20 = userName(4634).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
