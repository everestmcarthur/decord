...
// Dependencies: [19, 17, 1389, 21, 1390, 4605, 576, 1116, 10970, 4839, 9246, 1388, 4840, 9245, 4306, 10971, 4601, 4611, 4309, 10974, 1369, 2]

// Module 10969 (UsernameWithEffects)
...
export default noop.memo((userName) => {
  ...
  if (STATIC === undefined) {
    STATIC = userName(10970).EffectDisplayType.STATIC;
  }
  ...
  let num2;
  const tmp6 = num2(4839)({ userId, guildId, pendingDisplayNameStyles, ignoreDisabledStylesSetting });
  const isDisplayNameStylesFlywheelViewersEnabled = userName(9246).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  const obj = userName(9246);
  ...
  const displayNameStylesEnabled = userName(4840).useDisplayNameStylesEnabled({ location: "UsernameWithEffects" });
  const obj3 = userName(4840);
  const displayNameStylesFont = userName(9245).useDisplayNameStylesFont({ displayNameStyles: result, ignoreDisabledStylesSetting });
  let tmp12;
  ...
  const obj4 = userName(9245);
  const token = userName(4306).useToken(tmp4(576).colors.BACKGROUND_BASE_LOW);
  const tmp7Result = userName(4306);
  const token1 = userName(4306).useToken(tmp4(576).colors.WHITE);
  const tmp7Result7 = userName(4306);
  const displayNameStylesAccessibleColors = userName(10971).useDisplayNameStylesAccessibleColors({ displayNameStyles: result, backgroundColor: token });
  let first;
  ...
  const tmp7Result10 = userName(4611);
  const tmp20 = userName(4601).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
  ...
  if (displayNameStylesEnabled) {
    if (null != tmp6) {
      if (STATIC !== tmp7(10970).EffectDisplayType.PLAIN) {
        if (null != colorVariants) {
          ...
          if (effectId === tmp7(1390).DisplayNameEffect.GUMMY) {
            const tmp4Result = tmp4(10974);
            const tmp66 = closure_9;
            let str3 = tmp7(4309).getNodeText(userName);
            if (str3 == null) {
              str3 = "";
            }
            ...
            if (tmp7(1390).DisplayNameEffect.GRADIENT !== effectId) {
              if (tmp7(1390).DisplayNameEffect.PRISM !== effectId) {
                if (tmp7(1390).DisplayNameEffect.NEON === effectId) {
                  ...
                  if (null != colorVariants) {
                    ...
                    const items6 = [closure_9(tmp7(4601).Text, obj10), ];
                    const obj11 = {};
                    ...
                    items6[1] = closure_9(tmp7(4601).Text, obj11);
              ...
              return closure_9(tmp7(4601).Text, obj13);
            }
      ...
      return closure_9(tmp7(4601).Text, obj14);
    }
  }
  const obj15 = {};
  ...
  return closure_9(userName(4601).Text, obj15);
});
