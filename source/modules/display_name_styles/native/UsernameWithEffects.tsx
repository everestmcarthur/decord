...
// Dependencies: [19, 17, 1389, 21, 1390, 4574, 576, 1116, 10932, 4808, 9209, 1388, 4809, 9208, 4275, 10933, 4570, 4580, 4278, 10936, 1369, 2]

// Module 10931 (UsernameWithEffects)
...
export default noop.memo((userName) => {
  ...
  if (STATIC === undefined) {
    STATIC = userName(10932).EffectDisplayType.STATIC;
  }
  ...
  let num2;
  const tmp6 = num2(4808)({ userId, guildId, pendingDisplayNameStyles, ignoreDisabledStylesSetting });
  const isDisplayNameStylesFlywheelViewersEnabled = userName(9209).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  const obj = userName(9209);
  ...
  const displayNameStylesEnabled = userName(4809).useDisplayNameStylesEnabled({ location: "UsernameWithEffects" });
  const obj3 = userName(4809);
  const displayNameStylesFont = userName(9208).useDisplayNameStylesFont({ displayNameStyles: result, ignoreDisabledStylesSetting });
  let tmp12;
  ...
  const obj4 = userName(9208);
  const token = userName(4275).useToken(tmp4(576).colors.BACKGROUND_BASE_LOW);
  const tmp7Result = userName(4275);
  const token1 = userName(4275).useToken(tmp4(576).colors.WHITE);
  const tmp7Result7 = userName(4275);
  const displayNameStylesAccessibleColors = userName(10933).useDisplayNameStylesAccessibleColors({ displayNameStyles: result, backgroundColor: token });
  let first;
  ...
  const tmp7Result10 = userName(4580);
  const tmp20 = userName(4570).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
  ...
  if (displayNameStylesEnabled) {
    if (null != tmp6) {
      if (STATIC !== tmp7(10932).EffectDisplayType.PLAIN) {
        if (null != colorVariants) {
          ...
          if (effectId === tmp7(1390).DisplayNameEffect.GUMMY) {
            const tmp4Result = tmp4(10936);
            const tmp66 = closure_9;
            let str3 = tmp7(4278).getNodeText(userName);
            if (str3 == null) {
              str3 = "";
            }
            ...
            if (tmp7(1390).DisplayNameEffect.GRADIENT !== effectId) {
              if (tmp7(1390).DisplayNameEffect.PRISM !== effectId) {
                if (tmp7(1390).DisplayNameEffect.NEON === effectId) {
                  ...
                  if (null != colorVariants) {
                    ...
                    const items6 = [closure_9(tmp7(4570).Text, obj10), ];
                    const obj11 = {};
                    ...
                    items6[1] = closure_9(tmp7(4570).Text, obj11);
              ...
              return closure_9(tmp7(4570).Text, obj13);
            }
      ...
      return closure_9(tmp7(4570).Text, obj14);
    }
  }
  const obj15 = {};
  ...
  return closure_9(userName(4570).Text, obj15);
});
