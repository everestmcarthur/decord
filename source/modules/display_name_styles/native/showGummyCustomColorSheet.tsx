...
// Dependencies: [4603, 15432, 1896, 2]
// Exports: default

// Module 15431 (showGummyCustomColorSheet)
...
export default function showGummyCustomColorSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15432, dependencyMap.paths), DisplayNameStylesGummyCustomColorSheet, arg0, "stack");
};
