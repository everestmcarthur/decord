...
// Dependencies: [5, 502, 7578, 1963, 1074, 1272, 5461, 1100, 9774, 4847, 573, 9776, 11, 2]

// Module 9773 (GuildScheduledEventsActionCreators)
...
export default {
  ...
  fetchGuildEvent(arg0, arg1) {
    ...
    closure_1 = arg1;
    return (async () => {
      await tmp5(4847).httpGetWithCountryCodeQuery({ url: closure_1_10.GUILD_EVENT(tmp5, tmp2), rejectWithError: tmp5(1272).rejectWithMigratedError() });
  ...
  fetchGuildEventsForGuild(guild_id) {
    closure_0 = guild_id;
    return (async () => {
      await tmp5(4847).httpGetWithCountryCodeQuery({ url: closure_1_10.GUILD_EVENTS_FOR_GUILD(tmp5), rejectWithError: tmp5(1272).rejectWithMigratedError() });
      const body = arg1.body;
