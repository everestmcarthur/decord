...
// Dependencies: [5, 502, 7599, 1963, 1074, 1272, 5462, 1100, 9795, 4848, 573, 9797, 11, 2]
...
export default {
  ...
  fetchGuildEvent(arg0, arg1) {
    ...
    closure_1 = arg1;
    return (async () => {
      await tmp5(4848).httpGetWithCountryCodeQuery({ url: closure_1_10.GUILD_EVENT(tmp5, tmp2), rejectWithError: tmp5(1272).rejectWithMigratedError() });
  ...
  fetchGuildEventsForGuild(guild_id) {
    closure_0 = guild_id;
    return (async () => {
      await tmp5(4848).httpGetWithCountryCodeQuery({ url: closure_1_10.GUILD_EVENTS_FOR_GUILD(tmp5), rejectWithError: tmp5(1272).rejectWithMigratedError() });
      const body = arg1.body;
