...
// Function ID: 9817
// Name: ScheduleUtils
// Dependencies: [1372, 9817, 1964, 9818, 1115, 4231, 4321, 11, 1091, 12, 2]
...
const RecurrenceOptions = fn(9817).RecurrenceOptions;
...
let items = [fn(9818).RRule.MO.weekday, fn(9818).RRule.TU.weekday, fn(9818).RRule.WE.weekday, fn(9818).RRule.TH.weekday, fn(9818).RRule.FR.weekday];
let items1 = [fn(9818).RRule.SU.weekday, fn(9818).RRule.MO.weekday, fn(9818).RRule.TU.weekday, fn(9818).RRule.WE.weekday, fn(9818).RRule.TH.weekday];
let items2 = [fn(9818).RRule.TU.weekday, fn(9818).RRule.WE.weekday, fn(9818).RRule.TH.weekday, fn(9818).RRule.FR.weekday, fn(9818).RRule.SA.weekday];
let items3 = [fn(9818).RRule.SA.weekday, fn(9818).RRule.SU.weekday];
const items4 = [fn(9818).RRule.FR.weekday, fn(9818).RRule.SA.weekday];
const items5 = [fn(9818).RRule.SU.weekday, fn(9818).RRule.MO.weekday];
const items6 = [fn(9818).RRule.SU.weekday, fn(9818).RRule.MO.weekday, fn(9818).RRule.TU.weekday, fn(9818).RRule.WE.weekday, fn(9818).RRule.TH.weekday, fn(9818).RRule.FR.weekday, fn(9818).RRule.SA.weekday];
...
export const getBaseScheduleForRecurrence = function getBaseScheduleForRecurrence(nextRecurrenceIdInEvent, guildEvent) {
  ...
  if (null != scheduled_start_time) {
    const obj = { startDate: _modDef4231(scheduled_start_time), endDate: "a" };
    tmp = obj;
...
export const getScheduleFromEventData = function getScheduleFromEventData(arg0) {
  ...
  if (null != scheduledStartTime) {
    const obj = { startDate: _modDef4231(scheduledStartTime), endDate: "a" };
    tmp = obj;
      ...
      if (uTCHours === date1.getUTCHours()) {
        ...
        if (uTCMinutes === date1.getUTCMinutes()) {
          ...
          if (uTCSeconds === date1.getUTCSeconds()) {
            ...
            } else if (tmp(9818).RRule.YEARLY === frequency) {
...
export const recurrenceOptionToRecurrenceRule = function recurrenceOptionToRecurrenceRule(c7, toDate) {
  ...
  if (RecurrenceOptions.NONE !== c7) {
    if (tmp8.WEEKLY === c7) {
      const obj = { dtstart: toDateResult2, freq: tmp4(9818).RRule.WEEKLY };
      rRule = new tmp4(9818).RRule(obj);
    } else if (tmp8.BIWEEKLY === c7) {
      const obj2 = { dtstart: toDateResult2, freq: tmp4(9818).RRule.WEEKLY, interval: 2 };
      rRule = new tmp4(9818).RRule(obj2);
    } else if (tmp8.MONTHLY === c7) {
      const obj3 = { dtstart: toDateResult2, freq: tmp4(9818).RRule.MONTHLY, byweekday: null };
      items = [weekday.nth(rounded)];
      obj3.byweekday = items;
      rRule = new tmp4(9818).RRule(obj3);
    } else if (tmp8.YEARLY === c7) {
      const obj4 = { dtstart: toDateResult2, freq: tmp4(9818).RRule.YEARLY };
      rRule = new tmp4(9818).RRule(obj4);
    } else if (tmp8.DAILY === c7) {
      const obj5 = { dtstart: toDateResult2, freq: tmp4(9818).RRule.DAILY };
      rRule = new tmp4(9818).RRule(obj5);
    } else if (tmp8.WEEKDAY_ONLY === c7) {
      const obj6 = { dtstart: toDateResult2, freq: tmp4(9818).RRule.DAILY, byweekday: tmp };
      rRule = new tmp4(9818).RRule(obj6);
    } else if (tmp8.WEEKEND_ONLY === c7) {
      const obj7 = { dtstart: toDateResult2, freq: tmp4(9818).RRule.DAILY, byweekday: tmp2 };
      rRule = new tmp4(9818).RRule(obj7);
    }
  }
  if (null == rRule) {
    return null;
...
export const recurrenceRuleToOption = function recurrenceRuleToOption(startDate, recurrenceRule) {
  if (null == recurrenceRule) {
    ...
    } else if (tmp14(9818).RRule.YEARLY === freq) {
      return RecurrenceOptions.YEARLY;
    } else if (tmp14(9818).RRule.MONTHLY === freq) {
      return RecurrenceOptions.MONTHLY;
    } else if (tmp14(9818).RRule.DAILY === freq) {
