...
// Function ID: 9757
// Name: ScheduleUtils
// Dependencies: [1371, 9757, 1963, 9758, 1114, 4198, 4288, 11, 1090, 12, 2]
...
const RecurrenceOptions = fn(9757).RecurrenceOptions;
...
let items = [fn(9758).RRule.MO.weekday, fn(9758).RRule.TU.weekday, fn(9758).RRule.WE.weekday, fn(9758).RRule.TH.weekday, fn(9758).RRule.FR.weekday];
let items1 = [fn(9758).RRule.SU.weekday, fn(9758).RRule.MO.weekday, fn(9758).RRule.TU.weekday, fn(9758).RRule.WE.weekday, fn(9758).RRule.TH.weekday];
let items2 = [fn(9758).RRule.TU.weekday, fn(9758).RRule.WE.weekday, fn(9758).RRule.TH.weekday, fn(9758).RRule.FR.weekday, fn(9758).RRule.SA.weekday];
let items3 = [fn(9758).RRule.SA.weekday, fn(9758).RRule.SU.weekday];
const items4 = [fn(9758).RRule.FR.weekday, fn(9758).RRule.SA.weekday];
const items5 = [fn(9758).RRule.SU.weekday, fn(9758).RRule.MO.weekday];
const items6 = [fn(9758).RRule.SU.weekday, fn(9758).RRule.MO.weekday, fn(9758).RRule.TU.weekday, fn(9758).RRule.WE.weekday, fn(9758).RRule.TH.weekday, fn(9758).RRule.FR.weekday, fn(9758).RRule.SA.weekday];
      ...
      if (uTCHours === date1.getUTCHours()) {
        ...
        if (uTCMinutes === date1.getUTCMinutes()) {
          ...
          if (uTCSeconds === date1.getUTCSeconds()) {
            ...
            } else if (tmp(9758).RRule.YEARLY === frequency) {
...
export const recurrenceOptionToRecurrenceRule = function recurrenceOptionToRecurrenceRule(c7, toDate) {
  ...
  if (RecurrenceOptions.NONE !== c7) {
    if (tmp8.WEEKLY === c7) {
      const obj = { dtstart: toDateResult2, freq: tmp4(9758).RRule.WEEKLY };
      rRule = new tmp4(9758).RRule(obj);
    } else if (tmp8.BIWEEKLY === c7) {
      const obj2 = { dtstart: toDateResult2, freq: tmp4(9758).RRule.WEEKLY, interval: 2 };
      rRule = new tmp4(9758).RRule(obj2);
    } else if (tmp8.MONTHLY === c7) {
      const obj3 = { dtstart: toDateResult2, freq: tmp4(9758).RRule.MONTHLY, byweekday: null };
      items = [weekday.nth(rounded)];
      obj3.byweekday = items;
      rRule = new tmp4(9758).RRule(obj3);
    } else if (tmp8.YEARLY === c7) {
      const obj4 = { dtstart: toDateResult2, freq: tmp4(9758).RRule.YEARLY };
      rRule = new tmp4(9758).RRule(obj4);
    } else if (tmp8.DAILY === c7) {
      const obj5 = { dtstart: toDateResult2, freq: tmp4(9758).RRule.DAILY };
      rRule = new tmp4(9758).RRule(obj5);
    } else if (tmp8.WEEKDAY_ONLY === c7) {
      const obj6 = { dtstart: toDateResult2, freq: tmp4(9758).RRule.DAILY, byweekday: tmp };
      rRule = new tmp4(9758).RRule(obj6);
    } else if (tmp8.WEEKEND_ONLY === c7) {
      const obj7 = { dtstart: toDateResult2, freq: tmp4(9758).RRule.DAILY, byweekday: tmp2 };
      rRule = new tmp4(9758).RRule(obj7);
    }
  }
  if (null == rRule) {
    return null;
...
export const recurrenceRuleToOption = function recurrenceRuleToOption(startDate, recurrenceRule) {
  if (null == recurrenceRule) {
    ...
    } else if (tmp14(9758).RRule.YEARLY === freq) {
      return RecurrenceOptions.YEARLY;
    } else if (tmp14(9758).RRule.MONTHLY === freq) {
      return RecurrenceOptions.MONTHLY;
    } else if (tmp14(9758).RRule.DAILY === freq) {
