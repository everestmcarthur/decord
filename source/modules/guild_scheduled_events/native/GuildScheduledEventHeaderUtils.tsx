...
// Dependencies: [7600, 1963, 9758, 576, 9876, 1114, 8715, 9877, 2]
// Exports: getGuildScheduledEventHeaderProps

// Module 9875 (GuildScheduledEventHeaderUtils)
