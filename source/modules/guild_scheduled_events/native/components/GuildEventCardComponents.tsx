...
// Dependencies: [5, 32, 19, 17, 502, 1957, 2021, 1979, 4199, 1371, 7526, 1963, 1074, 1085, 21, 4560, 576, 9778, 9780, 8097, 1114, 9703, 7190, 4258, 9059, 4504, 504, 9676, 8678, 4511, 9781, 9782, 9670, 5520, 7342, 9783, 4905, 9708, 4994, 4767, 1369, 1477, 1396, 9784, 9785, 1178, 5089, 4495, 9674, 9673, 9787, 5123, 4556, 9790, 9776, 4713, 9710, 9774, 9775, 5584, 2]
...
// Module 9777 (usePrimaryActionButtonType)
...
import canEveryoneRoleViewEventDefault from "canEveryoneRoleViewEvent" /* 9778 */;
import ThrottledButtonDefault from "ThrottledButton" /* 9782 */;
import getGuildEventImageURLDefault from "getGuildEventImageURL" /* 9784 */;
...
import closure_17 from "scheduledEventSort" /* 7526 */;
import { GuildScheduledEventEntityTypes as closure_18 } from "GUILD_EVENT_MAX_NAME_LENGTH" /* 1963 */;
...
export const GuildEventShareAction = function GuildEventShareAction(event) {
  ...
  obj[0] = "" + intl.string(event(1114).t.RDE0Sc) + ", " + event.name;
  ...
  obj[2] = importDefault(tmp3 ? 9059 : 4504);
...
export const useEventRsvpState = function useEventRsvpState(id) {
  ...
  const items2 = [
    _require(504).useStateFromStores(items, () => closure_1_17.isInterestedInEventRecurrence(event.id, c1), items1),
    () => {
      const result = event(closure_1_2[21]).handleGuildScheduledEventRsvp(event.id, c1, event.guild_id);
    }
  ];
...
export const GuildEventIndicateInterestAction = function GuildEventIndicateInterestAction(event) {
  ...
  obj[2] = "" + intl.string(event(1114).t.DlcqlU) + ", " + event.name;
  obj[3] = str;
  obj[4] = callback4(BellIcon, { size: "sm" });
  const intl2 = tmp(1114).intl;
  obj[5] = intl2.string(event(1114).t.DlcqlU);
  obj[6] = tmp3[1];
...
export const GuildEventSimpleLocation = function GuildEventSimpleLocation(event) {
  ...
  obj1[4] = tmp7;
  items4[1] = callback4(channel_id(4556).Text, obj1);
  obj[1] = items4;
...
export const GuildEventCardSimpleGuildInfo = function GuildEventCardSimpleGuildInfo(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    obj[1] = tmp2(5584).GuildIconSizes.XSMALL_20;
    obj[2] = tmp.guildIcon;
    ...
    obj1[1] = callback4(tmp2(4556).Text, obj2);
