...
// Dependencies: [19, 17, 1963, 1074, 21, 4607, 576, 9755, 4574, 9174, 8684, 1178, 1114, 4603, 5027, 9796, 2]
// Exports: default

// Module 9898 (EndEventActionSheet)
...
export default function EndEventActionSheet(channel) {
  ...
  const tmp = closure_7();
  const activeEvent = channel(9755).useActiveEvent(channel.id);
  if (null == activeEvent) {
    return null;
  } else {
    ...
    obj6.children = closure_5(tmp2(5027).Button, obj7);
    ...
    obj8.children = closure_5(tmp2(5027).Button, obj9);
    items[3] = closure_5(View, obj8);
    obj3.children = items;
    obj2.children = closure_6(View, obj3);
    return closure_5(activeEvent(8684), obj2);
  }
  let obj = channel(9755);
};
