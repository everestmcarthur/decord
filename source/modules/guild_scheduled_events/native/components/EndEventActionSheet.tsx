...
// Dependencies: [19, 17, 1963, 1074, 21, 4606, 576, 9753, 4573, 9172, 8682, 1178, 1114, 4602, 5026, 9794, 2]
// Exports: default

// Module 9896 (EndEventActionSheet)
...
export default function EndEventActionSheet(channel) {
  ...
  const tmp = closure_7();
  const activeEvent = channel(9753).useActiveEvent(channel.id);
  if (null == activeEvent) {
    return null;
  } else {
    ...
    obj6.children = closure_5(tmp2(5026).Button, obj7);
    ...
    obj8.children = closure_5(tmp2(5026).Button, obj9);
    items[3] = closure_5(View, obj8);
    obj3.children = items;
    obj2.children = closure_6(View, obj3);
    return closure_5(activeEvent(8682), obj2);
  }
  let obj = channel(9753);
};
