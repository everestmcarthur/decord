...
// Dependencies: [32, 19, 17, 1962, 9975, 9944, 1074, 21, 4722, 576, 5292, 1177, 7188, 9976, 4718, 1115, 5144, 4925, 9977, 1897, 4689, 2]
// Exports: default

// Module 9974 (StageChannelUpsell)
...
let closure_7 = fn(9975).useStageChannelUpsellCardStore;
let closure_8 = fn(9944).CREATE_GUILD_EVENT_MODAL_KEY;
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4718).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9977, dependencyMap.paths), {
        guildId,
