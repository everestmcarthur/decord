...
// Dependencies: [32, 19, 17, 1961, 9823, 9792, 1074, 21, 4607, 576, 5175, 1178, 7066, 9824, 4603, 1114, 5027, 4810, 9825, 1896, 4574, 2]
// Exports: default

// Module 9822 (StageChannelUpsell)
...
let closure_7 = fn(9823).useStageChannelUpsellCardStore;
let closure_8 = fn(9792).CREATE_GUILD_EVENT_MODAL_KEY;
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4603).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9825, dependencyMap.paths), {
        guildId,
