...
// Dependencies: [32, 19, 17, 1961, 9821, 9790, 1074, 21, 4606, 576, 5174, 1178, 7065, 9822, 4602, 1114, 5026, 4809, 9823, 1896, 4573, 2]
// Exports: default

// Module 9820 (StageChannelUpsell)
...
import _modDef9822 from "module_9822" /* 9822 */;
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4602).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9823, dependencyMap.paths), {
        guildId,
