...
// Dependencies: [32, 19, 17, 1962, 9881, 9850, 1074, 21, 4640, 576, 5210, 1177, 7106, 9882, 4636, 1115, 5062, 4843, 9883, 1897, 4607, 2]
// Exports: default

// Module 9880 (StageChannelUpsell)
...
let closure_7 = fn(9881).useStageChannelUpsellCardStore;
let closure_8 = fn(9850).CREATE_GUILD_EVENT_MODAL_KEY;
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4636).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9883, dependencyMap.paths), {
        guildId,
