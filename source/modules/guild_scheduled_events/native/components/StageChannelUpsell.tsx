...
// Dependencies: [32, 19, 17, 1961, 9800, 9769, 1074, 21, 4605, 576, 5173, 1178, 7044, 9801, 4601, 1114, 5025, 4808, 9802, 1896, 4572, 2]
// Exports: default
...
export default function StageChannelUpsell(arg0) {
  ...
  if (!tmp2[0]) {
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9802, dependencyMap.paths), {
        guildId,
