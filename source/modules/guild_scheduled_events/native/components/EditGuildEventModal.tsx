...
// Dependencies: [5, 32, 19, 17, 1964, 21, 4639, 576, 1612, 9836, 9833, 1875, 9835, 4351, 1115, 9837, 9858, 9839, 9859, 9899, 9900, 7107, 2]

// Module 9857 (EditGuildEventModal)
...
import useGetEventChannelsByType from "useGetEventChannelsByType" /* 9858 */;
import EditGuildEventWhereDefault from "EditGuildEventWhere" /* 9859 */;
import EditGuildEventDetailsDefault from "EditGuildEventDetails" /* 9899 */;
import EditGuildEventPreviewDefault from "EditGuildEventPreview" /* 9900 */;
    ...
    if (c2 === 2) {
      ...
      try {
        ...
        if (0 === c1) {
          ...
          const AccessibilityAnnouncer2 = tmp4(4351).AccessibilityAnnouncer;
