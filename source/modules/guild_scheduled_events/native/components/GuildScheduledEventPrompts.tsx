...
// Dependencies: [19, 21, 4607, 576, 9764, 8686, 9791, 9876, 1114, 4288, 4198, 2]
// Exports: ScheduleEventPrompt, StartEventPrompt

// Module 9790 (GuildScheduledEventPrompts)
...
export const StartEventPrompt = function StartEventPrompt(event) {
  ...
  if (obj.useManageResourcePermissions(channel).canManageGuildEvent(event)) {
    ...
    const intl2 = tmp2(1114).intl;
    const obj4 = { startTime: tmp2(4288).calendarFormat(recurrenceId(4198)(scheduled_start_time)) };
