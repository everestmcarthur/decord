...
// Dependencies: [19, 17, 4245, 1074, 1085, 21, 4606, 5575, 576, 504, 8493, 9874, 9876, 4602, 1114, 9153, 2]
// Exports: default

// Module 9898 (GuildEventsNoContent)
...
export default function GuildEventsNoContent(guild) {
  ...
  obj3.icon = onClose(9874);
  obj3.IconComponent = guild(9876).CalendarIcon;
  const items2 = [closure_7(onClose(8493), obj3), , , ];
  ...
  items2[1] = closure_7(guild(4602).Text, obj4);
  ...
  items2[2] = closure_7(guild(4602).Text, obj5);
  if (stateFromStores) {
    ...
    stateFromStores = tmp7(tmp2(4602).Text, obj6);
  }
