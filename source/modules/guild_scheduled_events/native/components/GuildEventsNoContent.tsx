...
// Dependencies: [19, 17, 4212, 1074, 1085, 21, 4574, 5538, 576, 504, 8435, 9815, 9817, 4570, 1114, 9095, 2]
// Exports: default
...
export default function GuildEventsNoContent(guild) {
  ...
  obj3.icon = onClose(9815);
  obj3.IconComponent = guild(9817).CalendarIcon;
  const items2 = [closure_7(onClose(8435), obj3), , , ];
  ...
  items2[1] = closure_7(guild(4570).Text, obj4);
  ...
  items2[2] = closure_7(guild(4570).Text, obj5);
  if (stateFromStores) {
    ...
    stateFromStores = tmp7(tmp2(4570).Text, obj6);
  }
