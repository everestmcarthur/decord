...
// Dependencies: [19, 17, 1964, 1074, 21, 4639, 6711, 1115, 9797, 4635, 9034, 1875, 4606, 9558, 1897, 9843, 9844, 9845, 5185, 9846, 9847, 8748, 5181, 5770, 5773, 7192, 4231, 9849, 5057, 2]
...
// Module 9842 (GuildEventModalComponents)
...
import useGuildsUserCanStartStageIn from "useGuildsUserCanStartStageIn" /* 9844 */;
import _modDef9845 from "module_9845" /* 9845 */;
import _modDef9846 from "module_9846" /* 9846 */;
import LocationIcon from "LocationIcon" /* 9847 */;
import noop from "module_19" /* 19 */;

const _modDef8748 = tmp4(8748);
require = fn;
...
export const GuildEventEntityTypeSelection = function GuildEventEntityTypeSelection(arg0) {
  ...
  if (features.has(GuildFeatures.COMMUNITY)) {
    ...
    obj4.IconComponent = tmp(5181).StageIcon;
