...
// Dependencies: [19, 17, 1964, 1074, 21, 4722, 6799, 1115, 9910, 4718, 9144, 1875, 4689, 9664, 1897, 9956, 9957, 9958, 5270, 9959, 9960, 8860, 5266, 5855, 5858, 7281, 4314, 9962, 5142, 2]
...
// Module 9955 (GuildEventModalComponents)
...
import useGuildsUserCanStartStageIn from "useGuildsUserCanStartStageIn" /* 9957 */;
import _modDef9958 from "module_9958" /* 9958 */;
import _modDef9959 from "module_9959" /* 9959 */;
import LocationIcon from "LocationIcon" /* 9960 */;
import noop from "module_19" /* 19 */;

const _modDef8860 = tmp4(8860);
require = fn;
...
export const GuildEventRecurrence = function GuildEventRecurrence(startDate) {
  ...
  recurrenceOptions = startDate(9910).getRecurrenceOptions(startDate);
  ...
  obj3.children = closure_11(startDate(4718).Text, obj4);
  ...
  const obj5 = {
    onPress() {
      ...
      obj2.openLazy(asyncRequireImpl(9664, dependencyMap.paths), "SelectRecurrenceOption", obj3);
    },
    text: null,
    value: null,
    icon: null,
...
export const GuildEventEntityTypeSelection = function GuildEventEntityTypeSelection(arg0) {
  ...
  if (features.has(GuildFeatures.COMMUNITY)) {
    ...
    obj4.icon = _modDef8860;
    obj4.IconComponent = tmp(5266).StageIcon;
...
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  if (maximumDate === undefined) {
    let obj = timeLabel(4314)();
    maximumDate = timeLabel(4314)().add(30, "days").endOf("month");
    const addResult = timeLabel(4314)().add(30, "days");
  }
  ...
  const items = [closure_11(time(4718).Text, { style: tmp5.formHeader, variant: "text-sm/semibold", color: "text-subtle", children: dateLabel }), ];
  time = "date";
  items[1] = closure_11(time(9144).InputButton, {
    text: dateLabel,
  ...
  const items2 = [closure_11(time(4718).Text, { style: tmp5.formHeader, variant: "text-sm/semibold", color: "text-subtle", children: timeLabel }), ];
  ...
  time = "time";
  items2[1] = closure_11(time(9144).InputButton, {
    text: timeLabel,
  ...
  obj2.children = closure_12(time(5142).Stack, obj3);
