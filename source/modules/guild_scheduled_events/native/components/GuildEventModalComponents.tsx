...
// Dependencies: [19, 17, 1963, 1074, 21, 4606, 6677, 1114, 9756, 4602, 8992, 1874, 4573, 9517, 1896, 9802, 9803, 9804, 5152, 9805, 9806, 8713, 5148, 5736, 5739, 7158, 4198, 9808, 5024, 2]
...
export const GuildEventRecurrence = function GuildEventRecurrence(startDate) {
  ...
  recurrenceOptions = startDate(9756).getRecurrenceOptions(startDate);
  ...
  obj3.children = closure_11(startDate(4602).Text, obj4);
  ...
  const obj5 = {
    onPress() {
      ...
      obj2.openLazy(asyncRequireImpl(9517, dependencyMap.paths), "SelectRecurrenceOption", obj3);
    },
    text: null,
    value: null,
    icon: null,
  ...
  items1[1] = closure_11(startDate(8992).InputButton, obj5);
...
export const GuildEventEntityTypeSelection = function GuildEventEntityTypeSelection(arg0) {
  ...
  if (features.has(GuildFeatures.COMMUNITY)) {
    ...
    obj4.icon = _modDef8713;
    obj4.IconComponent = tmp(5148).StageIcon;
...
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  const items = [closure_11(time(4602).Text, { style: tmp5.formHeader, variant: "text-sm/semibold", color: "text-subtle", children: dateLabel }), ];
  time = "date";
  items[1] = closure_11(time(8992).InputButton, {
    text: dateLabel,
  ...
  const items2 = [closure_11(time(4602).Text, { style: tmp5.formHeader, variant: "text-sm/semibold", color: "text-subtle", children: timeLabel }), ];
  ...
  time = "time";
  items2[1] = closure_11(time(8992).InputButton, {
    text: timeLabel,
  ...
  obj2.children = closure_12(time(5024).Stack, obj3);
