...
// Dependencies: [19, 17, 1964, 1074, 21, 4638, 6714, 1115, 9805, 4634, 9045, 1875, 4605, 9569, 1897, 9851, 9852, 9853, 5186, 9854, 9855, 8757, 5182, 5771, 5774, 7195, 4229, 9857, 5058, 2]
...
// Module 9850 (GuildEventModalComponents)
...
import useGuildsUserCanStartStageIn from "useGuildsUserCanStartStageIn" /* 9852 */;
import _modDef9853 from "module_9853" /* 9853 */;
import _modDef9854 from "module_9854" /* 9854 */;
import LocationIcon from "LocationIcon" /* 9855 */;
import noop from "module_19" /* 19 */;

const _modDef8757 = tmp4(8757);
require = fn;
...
export const GuildEventEntityTypeSelection = function GuildEventEntityTypeSelection(arg0) {
  ...
  if (features.has(GuildFeatures.COMMUNITY)) {
    ...
    obj4.IconComponent = tmp(5182).StageIcon;
