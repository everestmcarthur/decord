...
// Dependencies: [19, 17, 21, 4722, 576, 10042, 4718, 1115, 11, 10044, 5144, 2]
// Exports: default

// Module 10041 (GuildEventRecurrences)
import SnowflakeUtilsDefault from "SnowflakeUtils" /* 11 */;
import nativeDefault from "native" /* 576 */;
import useGuildEventRecurrencesDefault from "useGuildEventRecurrences" /* 10042 */;
import GuildEventRecurrenceDefault from "GuildEventRecurrence" /* 10044 */;
...
export default function GuildEventRecurrences(guildEventId) {
  ...
  const items = [closure_6(guildEventId(4718).Text, obj2), , ];
  ...
  if (canViewMoreRecurrences) {
    ...
    canViewMoreRecurrences = tmp7(tmp8(5144).Button, obj4);
  }
