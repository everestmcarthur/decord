...
// Dependencies: [19, 17, 1979, 4788, 4789, 21, 4607, 504, 7271, 7223, 5636, 1114, 8686, 1178, 12471, 7184, 4574, 12472, 12473, 7193, 7188, 2]
// Exports: default

// Module 12470 (UpcomingEventsLongPressActionSheet)
...
export default function UpcomingEventsLongPressActionSheet(guildId) {
  ...
  obj5.size = guildId(5636).GuildIconSizes.LARGE;
  obj4.children = closure_7(stateFromStores1(5636), obj5);
  obj3.leading = closure_7(View, obj4);
  const intl = guildId(1114).intl;
  obj3.title = intl.string(guildId(1114).t.tlopTM);
  const items2 = [closure_7(guildId(7223).BottomSheetTitleHeader, obj3), , ];
  const obj6 = { leading: null, label: null, onPress: null };
  const tmp9 = stateFromStores1(5636);
  obj6.leading = closure_7(guildId(1178).Icon, { source: stateFromStores1(12471) });
  const obj8 = { text: null };
  const intl2 = guildId(1114).intl;
  obj8.text = intl2.string(guildId(1114).t.e6RscS);
  obj6.label = closure_7(guildId(8686).FormLabel, obj8);
  obj6.onPress = function onPress() {
    ReadStateActionCreators.ackGuildFeature(guildId, ReadStateTypes.GUILD_EVENT);
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items2[1] = closure_7(guildId(8686).FormRow, obj6);
  const obj9 = { leading: null, label: null, onPress: null };
  const obj7 = { source: stateFromStores1(12471) };
  obj9.leading = closure_7(guildId(1178).Icon, { source: tmp8(stateFromStores1 ? 12472 : 12473) });
  ...
  obj9.label = closure_7(guildId(8686).FormLabel, { text: stringResult });
  ...
  items2[2] = closure_7(guildId(8686).FormRow, obj9);
  obj11.children = items2;
  return tmp6(guildId(7271).ActionSheet, obj11);
};
