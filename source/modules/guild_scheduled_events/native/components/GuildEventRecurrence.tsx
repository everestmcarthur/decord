...
// Dependencies: [19, 17, 1957, 1979, 7599, 21, 4606, 576, 504, 9760, 9762, 9759, 9756, 1114, 5174, 9863, 4602, 9789, 1178, 9891, 2]
// Exports: default

// Module 9890 (GuildEventRecurrence)
...
export default function GuildEventRecurrence(recurrenceId) {
  ...
  let obj2 = guildEventId(9760)(recurrenceId, id);
  const tmp6 = guildEventId(9760);
  const items1 = [c6];
  ...
  closure_5 = recurrenceId(9762).useManageResourcePermissions(stateFromStores2).canManageGuildEvent(stateFromStores);
  const tmp2Result5 = recurrenceId(9762);
  const eventScheduleById = recurrenceId(9759).useEventScheduleById(guildEventId, recurrenceId);
  ...
  if (null == stateFromStores) {
    ...
    obj4.children = closure_8(tmp2(9863).GuildEventCardHeader, obj5);
    const items5 = [closure_8(tmp2(5174).PressableOpacity, obj4), ];
    ...
    if (tmp21Result) {
      ...
      tmp21Result = tmp21(tmp2(4602).Text, obj7);
    }
    ...
    const obj9 = { source: tmp5(9891), size: tmp2(1178).Icon.Sizes.REFRESH_SMALL_16, style: tmp.secondarySmallIcon };
    obj8.children = closure_8(tmp2(1178).Icon, obj9);
    items6[1] = closure_8(tmp2(5174).PressableOpacity, obj8);
    obj6.children = items6;
    items5[1] = closure_9(stateFromStores1, obj6);
    obj3.children = items5;
    return closure_9(stateFromStores1, obj3);
  }
  const tmp2Result6 = recurrenceId(9759);
};
