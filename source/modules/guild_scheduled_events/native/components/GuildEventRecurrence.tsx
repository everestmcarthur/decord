...
// Dependencies: [19, 17, 1957, 1979, 7600, 21, 4607, 576, 504, 9762, 9764, 9761, 9758, 1114, 5175, 9865, 4603, 9791, 1178, 9893, 2]
// Exports: default

// Module 9892 (GuildEventRecurrence)
...
export default function GuildEventRecurrence(recurrenceId) {
  ...
  let obj2 = guildEventId(9762)(recurrenceId, id);
  const tmp6 = guildEventId(9762);
  const items1 = [c6];
  ...
  closure_5 = recurrenceId(9764).useManageResourcePermissions(stateFromStores2).canManageGuildEvent(stateFromStores);
  const tmp2Result5 = recurrenceId(9764);
  const eventScheduleById = recurrenceId(9761).useEventScheduleById(guildEventId, recurrenceId);
  ...
  if (null == stateFromStores) {
    ...
    obj4.children = closure_8(tmp2(9865).GuildEventCardHeader, obj5);
    const items5 = [closure_8(tmp2(5175).PressableOpacity, obj4), ];
    ...
    if (tmp21Result) {
      ...
      obj7.children = intl2.string(tmp2(1114).t.fyBVRm);
      tmp21Result = tmp21(tmp2(4603).Text, obj7);
    }
    ...
    obj8.accessibilityLabel = "" + intl3.string(tmp2(1114).t.HIgA5a) + ", " + sum1;
    ...
    const obj9 = { source: tmp5(9893), size: tmp2(1178).Icon.Sizes.REFRESH_SMALL_16, style: tmp.secondarySmallIcon };
    obj8.children = closure_8(tmp2(1178).Icon, obj9);
    items6[1] = closure_8(tmp2(5175).PressableOpacity, obj8);
    obj6.children = items6;
    items5[1] = closure_9(stateFromStores1, obj6);
    obj3.children = items5;
    return closure_9(stateFromStores1, obj3);
  }
  const tmp2Result6 = recurrenceId(9761);
};
