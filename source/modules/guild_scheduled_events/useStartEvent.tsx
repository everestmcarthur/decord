...
// Function ID: 9816
// Name: useStartEvent
// Dependencies: [5, 32, 19, 9816, 9817, 4461, 2]
// Exports: default
          ...
          try {
            ...
            if (0 === c7) {
              ...
              if (arg0 === 1) {
                ...
                obj2[0] = callback2(9816).preStartEventActions(callback, permissionOverwrites);
                return obj2;
              }
            } else {
              if (2 === tmp7) {
                c6 = 0;
                aPIError = new callback(4461).APIError(closure_5);
                callback2(aPIError);
                callback(false);
                callback(false);
                c8 = 3;
