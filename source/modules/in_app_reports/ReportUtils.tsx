...
function genSubmitData(version, name, arr, email_token) {
  ...
  obj = { channel_id: "HermesInternal", message_id: "call", stage_instance_id: "formatToPlainString", guild_id: "PX_16", guild_scheduled_event_id: "call", user_id: "default", email_token: "isArray", application_id: "r", entrypoint: "HermesInternal", widget_id: "PX_16" };
  obj[2] = str;
