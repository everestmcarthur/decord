...
// Dependencies: [19, 17, 1085, 21, 4607, 576, 1114, 2528, 4603, 5027, 1178, 2]
// Exports: default

// Module 9172 (InAppReportsBottomButton)
  ...
  if (null == button) {
    ...
    if ("submit" === button.type) {
      ...
      if (null != tmp3) {
        ...
        tmp14Result = tmp14(tmp17(4603).Text, obj4);
      }
      ...
      items1[1] = React4(tmp17(5027).Button, obj5);
