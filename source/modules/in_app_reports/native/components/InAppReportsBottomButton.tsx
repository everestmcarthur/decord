...
// Dependencies: [19, 17, 1085, 21, 4606, 576, 1114, 2528, 4602, 5026, 1178, 2]
// Exports: default

// Module 9170 (InAppReportsBottomButton)
  ...
  if (null == button) {
    ...
    if ("submit" === button.type) {
      ...
      if (null != tmp3) {
        ...
        tmp14Result = tmp14(tmp17(4602).Text, obj4);
      }
      ...
      items1[1] = React4(tmp17(5026).Button, obj5);
