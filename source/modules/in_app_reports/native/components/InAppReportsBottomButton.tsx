...
// Dependencies: [19, 17, 1085, 21, 4605, 576, 1114, 2528, 4601, 5025, 1178, 2]
// Exports: default

// Module 9149 (InAppReportsBottomButton)
  ...
  if (null == button) {
    ...
    if ("submit" === button.type) {
      ...
      if (null != tmp3) {
        ...
        tmp14Result = tmp14(tmp17(4601).Text, obj4);
      }
      ...
      items1[1] = React4(tmp17(5025).Button, obj5);
