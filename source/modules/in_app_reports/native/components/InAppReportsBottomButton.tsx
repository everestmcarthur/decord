...
// Dependencies: [19, 17, 1085, 21, 4574, 576, 1114, 2528, 4570, 4989, 1178, 2]
// Exports: default

// Module 9112 (InAppReportsBottomButton)
  ...
  if (null == button) {
    ...
    if ("submit" === button.type) {
      ...
      if (null != tmp3) {
        ...
        tmp14Result = tmp14(tmp17(4570).Text, obj4);
      }
      ...
      items1[1] = React4(tmp17(4989).Button, obj5);
