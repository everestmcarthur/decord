...
// Dependencies: [19, 17, 1979, 21, 4607, 576, 504, 4456, 4603, 1114, 5636, 2]
// Exports: default

// Module 9129 (InAppReportsGuildScheduledEventPreview)
...
export default function GuildScheduledEventPreview(event) {
  ...
  if (null == stateFromStores) {
    ...
    obj7.size = tmp2(5636).GuildIconSizes.XXSMALL;
    ...
    items3[1] = closure_5(tmp2(4603).Text, obj8);
    ...
    items4[1] = closure_5(tmp2(4603).Text, obj9);
