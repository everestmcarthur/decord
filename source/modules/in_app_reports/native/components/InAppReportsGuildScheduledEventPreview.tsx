...
// Dependencies: [19, 17, 1979, 21, 4606, 576, 504, 4456, 4602, 1114, 5635, 2]
// Exports: default

// Module 9127 (InAppReportsGuildScheduledEventPreview)
...
export default function GuildScheduledEventPreview(event) {
  ...
  if (null == stateFromStores) {
    ...
    obj3.children = intl.string(tmp2(1114).t.SDTOL7);
    const items1 = [closure_5(tmp2(4602).Text, obj3), ];
    const obj4 = { style: null, children: null };
    const items2 = [tmp.itemContainer, ];
    const obj5 = { borderColor: tmp2(4456).hexWithOpacity(tmp.borderColor.color, 0.08) };
    items2[1] = obj5;
    obj4.style = items2;
    const obj6 = { style: tmp.guildInfo, children: null };
    const obj7 = { guild: stateFromStores, size: null, selected: false };
    const hexWithOpacityResult = tmp2(4456).hexWithOpacity(tmp.borderColor.color, 0.08);
    obj7.size = tmp2(5635).GuildIconSizes.XXSMALL;
    ...
    items3[1] = closure_5(tmp2(4602).Text, obj8);
    ...
    items4[1] = closure_5(tmp2(4602).Text, obj9);
