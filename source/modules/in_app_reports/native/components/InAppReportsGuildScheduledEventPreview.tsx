...
// Dependencies: [19, 17, 1979, 21, 4605, 576, 504, 4454, 4601, 1114, 5634, 2]
// Exports: default

// Module 9106 (InAppReportsGuildScheduledEventPreview)
...
export default function GuildScheduledEventPreview(event) {
  ...
  if (null == stateFromStores) {
    ...
    const items1 = [closure_5(tmp2(4601).Text, obj3), ];
    const obj4 = { style: null, children: null };
    const items2 = [tmp.itemContainer, ];
    const obj5 = { borderColor: tmp2(4454).hexWithOpacity(tmp.borderColor.color, 0.08) };
    items2[1] = obj5;
    obj4.style = items2;
    ...
    obj7.size = tmp2(5634).GuildIconSizes.XXSMALL;
    ...
    items3[1] = closure_5(tmp2(4601).Text, obj8);
    ...
    items4[1] = closure_5(tmp2(4601).Text, obj9);
