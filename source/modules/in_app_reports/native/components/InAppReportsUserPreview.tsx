...
// Dependencies: [19, 17, 21, 4606, 576, 7052, 4456, 4602, 1114, 1178, 2]
// Exports: default
...
export default function UserPreview(user) {
  ...
  if (null != typeConsolidationEyebrow.style) {
    ...
    let stringResult = intl2.string(tmp2(1114).t.Rsth7z);
  } else {
    const intl = tmp2(1114).intl;
    stringResult = intl.string(tmp2(1114).t.Rsth7z).toUpperCase();
    const str = intl.string(tmp2(1114).t.Rsth7z);
  }
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(4602).Text, obj8);
  }
