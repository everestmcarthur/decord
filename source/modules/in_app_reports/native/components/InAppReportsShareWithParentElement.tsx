...
// Dependencies: [32, 19, 21, 7613, 4304, 1114, 8492, 9143, 9145, 2]
// Exports: default

// Module 9144 (InAppReportsShareWithParentElement)
import FamilyCenterActionCreators from "FamilyCenterActionCreators" /* 7613 */;
import InAppReportsUpsellsTableRowDefault from "InAppReportsUpsellsTableRow" /* 9143 */;
...
export default function _default(parents) {
  ...
  if (0 === parents.length) {
    ...
    obj.icon = jsx(parents(9145).ShareIcon, {});
