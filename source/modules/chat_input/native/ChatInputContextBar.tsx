...
// Dependencies: [19, 17, 4566, 4915, 1371, 1074, 21, 1178, 4574, 576, 4275, 4570, 1114, 5137, 6954, 504, 4292, 4808, 9208, 7975, 12452, 4392, 4310, 4575, 11700, 1242, 11698, 1100, 4807, 12453, 7791, 12241, 7861, 2]

// Module 12451 (ChatInputContextBar)
...
function ChatInputReplyBarNoAuthor(onCancelReplying) {
  ...
  const tmp7 = map1;
  obj6.children = closure_1_12(native.Icon, { source: _modDef6954, size: native.Icon.Sizes.CUSTOM, style: tmp.floatingCloseIcon });
...
function ChatInputEditBar(onCancelEditing) {
  ...
  obj4.children = closure_1_12(native.Icon, { source: _modDef6954, size: native.Icon.Sizes.CUSTOM, style: tmp.floatingCloseIcon });
  const obj6 = { style: tmp.contextBarRow, children: null };
  const obj7 = { children: null };
  const items = [tmp8, ];
  const obj5 = { source: _modDef6954, size: native.Icon.Sizes.CUSTOM, style: tmp.floatingCloseIcon };
...
function ChatInputScheduledMessageBar(scheduledTimestamp) {
  ...
  const items = [tmp8, ];
  const obj7 = { source: _modDef6954, size: native.Icon.Sizes.CUSTOM, style: tmp.floatingCloseIcon };
