...
// Dependencies: [32, 19, 1371, 1074, 1373, 21, 4605, 504, 4262, 9373, 9383, 4303, 1114, 5173, 4601, 8732, 2]
...
const forwardRefResult = noop.forwardRef((analyticsLocations, ref) => {
  ...
  if (tmp6 > 0) {
    ...
    obj3.children = "-" + tmp6;
    const items2 = [closure_8(tmp2(4601).Text, obj3), closure_8(tmp2(8732).NitroWheelIcon, { size: "sm" })];
    obj2.children = items2;
    tmp10 = closure_9(tmp2(5173).PressableOpacity, obj2);
  }
  return tmp10;
});
