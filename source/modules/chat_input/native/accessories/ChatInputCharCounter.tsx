...
// Dependencies: [32, 19, 1372, 1074, 1374, 21, 4640, 504, 4297, 9458, 9467, 4338, 1115, 5210, 4636, 8817, 2]

// Module 12581 (ChatInputCharCounter)
...
const forwardRefResult = noop.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(9458)();
  _slicedToArray = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj3.children = "-" + tmp6;
    const items2 = [closure_8(tmp2(4636).Text, obj3), closure_8(tmp2(8817).NitroWheelIcon, { size: "sm" })];
    obj2.children = items2;
    tmp10 = closure_9(tmp2(5210).PressableOpacity, obj2);
  }
  return tmp10;
});
