...
// Dependencies: [32, 19, 1372, 1074, 1374, 21, 4638, 504, 4295, 9447, 9456, 4336, 1115, 5208, 4634, 8797, 2]

// Module 12572 (ChatInputCharCounter)
...
const forwardRefResult = noop.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(9447)();
  _slicedToArray = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj3.children = "-" + tmp6;
    const items2 = [closure_8(tmp2(4634).Text, obj3), closure_8(tmp2(8797).NitroWheelIcon, { size: "sm" })];
    obj2.children = items2;
    tmp10 = closure_9(tmp2(5208).PressableOpacity, obj2);
  }
  return tmp10;
});
