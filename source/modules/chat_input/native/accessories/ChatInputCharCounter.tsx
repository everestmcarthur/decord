...
// Dependencies: [32, 19, 1371, 1074, 1373, 21, 4607, 504, 4264, 9396, 9406, 4305, 1114, 5175, 4603, 8755, 2]

// Module 12524 (ChatInputCharCounter)
...
const forwardRefResult = noop.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(9396)();
  _slicedToArray = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj3.children = "-" + tmp6;
    const items2 = [closure_8(tmp2(4603).Text, obj3), closure_8(tmp2(8755).NitroWheelIcon, { size: "sm" })];
    obj2.children = items2;
    tmp10 = closure_9(tmp2(5175).PressableOpacity, obj2);
  }
  return tmp10;
});
