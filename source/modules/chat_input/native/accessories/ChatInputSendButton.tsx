...
// Dependencies: [32, 19, 17, 4631, 7792, 12096, 21, 4639, 576, 4341, 12380, 12389, 12373, 4584, 1115, 504, 4350, 12393, 4376, 2]

// Module 12388 (ChatInputSendButton)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4341 */;
import ReanimatedRexportDefault from "ReanimatedRexport" /* 4376 */;
import ChatInputActionButtonTransitionItemDefault from "ChatInputActionButtonTransitionItem" /* 12380 */;
import useChatInputFloatingWidthDefault from "useChatInputFloatingWidth" /* 12393 */;
...
let closure_8 = fn(12096).CHAT_INPUT_FLOATING_BOUNCE_ENTER_DELAY_MS;
const jsx = fn(21).jsx;
...
let closure_12 = noop.memo((type) => {
  ...
  if (type === constants.BUTTON_SEND_VOICE_MESSAGE || type === constants.BUTTON_SEND_VOICE_MESSAGE_DISABLED) {
    ...
    let tmp7Result = tmp7(tmp3(12389), obj5);
  } else {
...
const forwardRefResult = noop.forwardRef((channel, ref) => {
  ...
  if (stateFromStores) {
    ...
    if (canSendVoiceMessage) {
      ...
      let tmp15Result = tmp15(tmp3(12389), obj8);
    } else {
      ...
      obj9.disabled = !tmp12;
      tmp15Result = tmp15(tmp3(12373), obj9);
      const tmp3Result = tmp3(12373);
    }
    ...
    const obj12 = { buttonWidth: token, buttonHeight: token1, buttonMargin: token2, sendVoiceMessageEnabled: canSendVoiceMessage, children: tmp15(tmp(4350).TransitionGroup, obj10) };
