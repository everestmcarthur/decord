...
// Dependencies: [32, 19, 17, 4630, 7795, 12104, 21, 4638, 576, 4339, 12388, 12397, 12381, 4582, 1115, 504, 4348, 12401, 4374, 2]

// Module 12396 (ChatInputSendButton)
...
import useChatInputFloatingWidthDefault from "useChatInputFloatingWidth" /* 12401 */;
...
let closure_12 = noop.memo((type) => {
  ...
  if (type === constants.BUTTON_SEND_VOICE_MESSAGE || type === constants.BUTTON_SEND_VOICE_MESSAGE_DISABLED) {
    ...
    let tmp7Result = tmp7(tmp3(12397), obj5);
  } else {
...
const forwardRefResult = noop.forwardRef((channel, ref) => {
  ...
  if (stateFromStores) {
    ...
    if (canSendVoiceMessage) {
      ...
      let tmp15Result = tmp15(tmp3(12397), obj8);
    } else {
      ...
      obj9.disabled = !tmp12;
      tmp15Result = tmp15(tmp3(12381), obj9);
      const tmp3Result = tmp3(12381);
    }
    ...
    const obj12 = { buttonWidth: token, buttonHeight: token1, buttonMargin: token2, sendVoiceMessageEnabled: canSendVoiceMessage, children: tmp15(tmp(4348).TransitionGroup, obj10) };
