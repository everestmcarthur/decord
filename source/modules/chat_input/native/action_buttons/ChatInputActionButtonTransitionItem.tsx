...
// Dependencies: [19, 17, 12091, 21, 4347, 4373, 4637, 12376, 2]
// Exports: default, interactivityProps

// Module 12375 (ChatInputActionButtonTransitionItem)
...
function FadeTransitionItem(state) {
  ...
  const effect = noop.useEffect(() => {
    if (state === native.TransitionStates.YEETED) {
      ...
      let obj = { runOnJS: tmp(4373).runOnJS, cleanup };
      fn.__closure = obj;
      ...
      const result1 = sharedValue.set(tmp(4637).withTiming(1, CHAT_INPUT_TIMING_CONFIG, "respect-motion-settings"));
...
const CHAT_INPUT_TIMING_CONFIG = fn(12091).CHAT_INPUT_TIMING_CONFIG;
const jsx = fn(21).jsx;
