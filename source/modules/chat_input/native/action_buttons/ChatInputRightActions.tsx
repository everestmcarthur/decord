...
// Dependencies: [32, 19, 17, 12204, 21, 4722, 576, 4423, 4432, 12416, 1610, 12489, 4458, 12488, 12487, 2]

// Module 12673 (ChatInputRightActions)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 4432 */;
import ReanimatedRexportDefault from "ReanimatedRexport" /* 4458 */;
import ChatInputActionButtonGiftOrThreadDefault from "ChatInputActionButtonGiftOrThread" /* 12487 */;
import ChatInputActionButtonTransitionItem from "ChatInputActionButtonTransitionItem" /* 12488 */;
import useChatInputFloatingBounceDefault from "useChatInputFloatingBounce" /* 12489 */;
...
function LeftSlot(state) {
  ...
  obj2.children = React5(ChatInputActionButtonGiftOrThreadDefault, { canStartThreads: false, channel, onPress, styleButton: "PX_16", shouldShowThread: "Sao Tome and Principe" });
