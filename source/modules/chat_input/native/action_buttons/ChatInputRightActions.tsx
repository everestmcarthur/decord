...
// Dependencies: [32, 19, 17, 12055, 21, 4606, 576, 4308, 4317, 12267, 1609, 12340, 4343, 12339, 12338, 2]
...
function LeftSlot(state) {
  ...
  obj2.children = React5(ChatInputActionButtonGiftOrThreadDefault, { canStartThreads: false, channel, onPress, styleButton: "PX_16", shouldShowThread: "Path fill rule" });
...
const forwardRefResult = noop.forwardRef((channel, ref) => {
  ...
  items1[1] = closure_7(tmp3(12267), obj5);
