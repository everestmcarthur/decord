...
// Dependencies: [19, 17, 12204, 21, 4722, 12488, 12481, 1115, 12479, 12490, 4423, 576, 4432, 2]

// Module 12487 (ChatInputActionButtonGiftOrThread)
...
const ChatInputActionType = fn(12204).ChatInputActionType;
const jsx = fn(21).jsx;
