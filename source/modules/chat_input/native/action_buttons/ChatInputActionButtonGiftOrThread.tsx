...
// Dependencies: [19, 17, 11992, 21, 4574, 12276, 12269, 1114, 12267, 12278, 4275, 576, 4284, 2]

// Module 12275 (ChatInputActionButtonGiftOrThread)
...
const ChatInputActionType = fn(11992).ChatInputActionType;
const jsx = fn(21).jsx;
