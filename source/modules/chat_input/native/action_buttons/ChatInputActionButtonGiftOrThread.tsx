...
// Dependencies: [19, 17, 12096, 21, 4639, 12380, 12373, 1115, 12371, 12382, 4341, 576, 4350, 2]

// Module 12379 (ChatInputActionButtonGiftOrThread)
...
function renderChatInputActionButtonGiftAndThread(arg0, styleButton, state, cleanup) {
  ...
  if (shouldShowThread) {
    ...
    let tmpResult = tmp(tmp2(12373), obj2);
    const tmp2Result = tmp2(12373);
  } else {
    const obj3 = { accessible, channel, onPress, style: styleButtonWrapper, styleButton };
    tmpResult = tmp(tmp2(12382), obj3);
  }
