...
// Dependencies: [19, 17, 12032, 21, 4605, 12316, 12309, 1114, 12307, 12318, 4306, 576, 4315, 2]

// Module 12315 (ChatInputActionButtonGiftOrThread)
...
const ChatInputActionType = fn(12032).ChatInputActionType;
const jsx = fn(21).jsx;
