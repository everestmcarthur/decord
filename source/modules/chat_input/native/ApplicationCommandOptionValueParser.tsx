...
// Dependencies: [32, 19, 5520, 1961, 2012, 2021, 2015, 4222, 1371, 5014, 12, 1369, 4727, 5456, 1894, 7696, 2]
// Exports: getRoles, parseOptionValuesForSend, useApplicationCommandOptionValueParser

// Module 12023 (ApplicationCommandOptionValueParser)
...
function getChannels(getGuildId, arr) {
  ...
  if (null == guildId) {
    ...
    return guildId(12)(items).map((id) => {
      const obj = { id: id.id, text: closure_0(4727).computeChannelName(id, UserStore, RelationshipStore) };
      return obj;
    });
  } else {
