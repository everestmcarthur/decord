...
// Dependencies: [32, 19, 1479, 12032, 1877, 5629, 4472, 1609, 1477, 12102, 12103, 12104, 4606, 4609, 4341, 2]
// Exports: default, getChatInputHeightAnimationTiming, getChatInputHeightAnimationTimingWorklet, getChatInputMinHeight

// Module 12101 (useChatInputMaxHeight)
...
import useKeyboardStateSharedValue from "useKeyboardStateSharedValue" /* 12102 */;
import useWindowDimensionsSharedValue from "useWindowDimensionsSharedValue" /* 12103 */;
...
const CHAT_INPUT_PILL_CONTENT_SIZE = fn(12032).CHAT_INPUT_PILL_CONTENT_SIZE;
let c6 = 200;
...
getChatInputMaxHeightWorklet.__closure = { getKeyboardStateWorklet: fn(12102).getKeyboardStateWorklet, KeyboardTypes: fn(1609).KeyboardTypes, getWindowDimensionsWorklet: fn(12103).getWindowDimensionsWorklet, MAX_HEIGHT: 200, MIN_HEIGHT: CHAT_INPUT_PILL_CONTENT_SIZE };
...
let obj = { getKeyboardStateWorklet: fn(12102).getKeyboardStateWorklet, KeyboardTypes: fn(1609).KeyboardTypes, getWindowDimensionsWorklet: fn(12103).getWindowDimensionsWorklet, MAX_HEIGHT: 200, MIN_HEIGHT: CHAT_INPUT_PILL_CONTENT_SIZE };
getChatInputHeightAnimationTimingWorklet.__closure = { getChatInputMaxHeightWorklet, withTiming: fn(4606).withTiming, timingFastDuration: fn(4609).timingFastDuration, Easing: fn(4341).Easing };
  ...
  const effect = noop.useEffect(() => {
    function maybeUpdateMaxHeight() {
      closure_1((arg0) => {
        ...
        const tmp = closure_0;
        const customKeyboardHeight = closure_0(5629).getCustomKeyboardHeight();
        const obj2 = closure_0(5629);
        const keyboardType = closure_0(4472).getKeyboardType();
        if (keyboardType !== closure_0(1609).KeyboardTypes.SYSTEM) {
          systemKeyboardHeight = customKeyboardHeight;
        }
        let tmp6 = arg0;
        const obj3 = closure_0(4472);
