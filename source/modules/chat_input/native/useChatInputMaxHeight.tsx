...
// Dependencies: [32, 19, 1479, 11992, 1877, 5593, 4441, 1609, 1477, 12062, 12063, 12064, 4575, 4578, 4310, 2]
// Exports: default, getChatInputHeightAnimationTiming, getChatInputHeightAnimationTimingWorklet, getChatInputMinHeight

// Module 12061 (useChatInputMaxHeight)
...
import useKeyboardStateSharedValue from "useKeyboardStateSharedValue" /* 12062 */;
import useWindowDimensionsSharedValue from "useWindowDimensionsSharedValue" /* 12063 */;
...
getChatInputMaxHeightWorklet.__closure = { getKeyboardStateWorklet: fn(12062).getKeyboardStateWorklet, KeyboardTypes: fn(1609).KeyboardTypes, getWindowDimensionsWorklet: fn(12063).getWindowDimensionsWorklet, MAX_HEIGHT: 200, MIN_HEIGHT: CHAT_INPUT_PILL_CONTENT_SIZE };
...
let obj = { getKeyboardStateWorklet: fn(12062).getKeyboardStateWorklet, KeyboardTypes: fn(1609).KeyboardTypes, getWindowDimensionsWorklet: fn(12063).getWindowDimensionsWorklet, MAX_HEIGHT: 200, MIN_HEIGHT: CHAT_INPUT_PILL_CONTENT_SIZE };
getChatInputHeightAnimationTimingWorklet.__closure = { getChatInputMaxHeightWorklet, withTiming: fn(4575).withTiming, timingFastDuration: fn(4578).timingFastDuration, Easing: fn(4310).Easing };
