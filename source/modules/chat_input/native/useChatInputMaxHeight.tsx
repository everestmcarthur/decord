...
// Dependencies: [32, 19, 1480, 12104, 1878, 5665, 4506, 1610, 1478, 12174, 12175, 12176, 4639, 4642, 4374, 2]
// Exports: default, getChatInputHeightAnimationTiming, getChatInputHeightAnimationTimingWorklet, getChatInputMinHeight

// Module 12173 (useChatInputMaxHeight)
...
import useCustomKeyboardHeight from "useCustomKeyboardHeight" /* 5665 */;
import useKeyboardStateSharedValue from "useKeyboardStateSharedValue" /* 12174 */;
import useWindowDimensionsSharedValue from "useWindowDimensionsSharedValue" /* 12175 */;
...
const CHAT_INPUT_PILL_CONTENT_SIZE = fn(12104).CHAT_INPUT_PILL_CONTENT_SIZE;
let c6 = 200;
...
getChatInputMaxHeightWorklet.__closure = { getKeyboardStateWorklet: fn(12174).getKeyboardStateWorklet, KeyboardTypes: fn(1610).KeyboardTypes, getWindowDimensionsWorklet: fn(12175).getWindowDimensionsWorklet, MAX_HEIGHT: 200, MIN_HEIGHT: CHAT_INPUT_PILL_CONTENT_SIZE };
...
let obj = { getKeyboardStateWorklet: fn(12174).getKeyboardStateWorklet, KeyboardTypes: fn(1610).KeyboardTypes, getWindowDimensionsWorklet: fn(12175).getWindowDimensionsWorklet, MAX_HEIGHT: 200, MIN_HEIGHT: CHAT_INPUT_PILL_CONTENT_SIZE };
getChatInputHeightAnimationTimingWorklet.__closure = { getChatInputMaxHeightWorklet, withTiming: fn(4639).withTiming, timingFastDuration: fn(4642).timingFastDuration, Easing: fn(4374).Easing };
  ...
  const effect = noop.useEffect(() => {
    function maybeUpdateMaxHeight() {
      closure_1((arg0) => {
        ...
        const tmp = closure_0;
        const customKeyboardHeight = closure_0(5665).getCustomKeyboardHeight();
        const obj2 = closure_0(5665);
        const keyboardType = closure_0(4506).getKeyboardType();
        if (keyboardType !== closure_0(1610).KeyboardTypes.SYSTEM) {
          systemKeyboardHeight = customKeyboardHeight;
        }
        let tmp6 = arg0;
        const obj3 = closure_0(4506);
