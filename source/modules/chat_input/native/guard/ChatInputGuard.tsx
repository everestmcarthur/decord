...
// Function ID: 12542
// Name: ChatInputGuard
// Dependencies: [19, 17, 9576, 21, 4606, 576, 670, 7946, 12354, 12353, 5176, 1115, 12360, 5656, 8172, 11027, 11022, 4602, 5026, 5484, 8992, 2]
// Exports: ChatInputGuardContainer, default

// Module 12541 (ChatInputGuard)
...
import getChatInputPositionStyleDefault from "getChatInputPositionStyle" /* 12353 */;
...
export default function ChatInputGuard(type) {
  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(11027).ArrowSmallRightIcon, obj5);
        }
        obj4.icon = actionIcon;
        obj4.onPress = actionOnPress;
        let tmp7Result = tmp7(tmp9(8172).IconButton, obj4);
      }
      obj3.trailing = tmp7Result;
      const obj6 = { variant: "text-sm/semibold", children: message };
      obj3.label = tmp7(tmp9(4602).Text, obj6);
    ...
    if (null != countdown) {
      ...
      tmp7Result = tmp7(tmp(11022), obj7);
    }
    tmp8 = hasOwnProperty;
  } else {
    ...
    if (null != subtext2) {
      ...
      if (typeof subtext2 === "string") {
        ...
        if (subtext2.length > 0) {
          ...
          tmp13Result = tmp13(tmp14(4602).Text, obj);
        }
      }
    }
    ...
    if (null != buttonSecondaryText) {
      ...
      if (null != buttonSecondaryOnPress) {
        ...
        items2[1] = tmp13(tmp14(5026).Button, obj12);
        obj11.children = items2;
        tmp16Result = tmp16(tmp14(8992).TwinButtons, obj11);
      }
    }
    ...
    if (null != countdown2) {
      ...
      tmp13Result2 = tmp13(tmp(11022), obj14);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  const chatInputFloatingOverlayStyle = screenIndex(12354).useChatInputFloatingOverlayStyle();
  ...
  if (tmp3) {
    tmp10Result3 = tmp10(tmp(5176), { absolute: true, wide: true, tall: true, mix: true });
  }
  const items4 = [tmp10Result3, children];
  obj5.children = items4;
  items3[1] = closure_8(closure_5, obj5);
  const obj = screenIndex(12354);
  let tmp10Result4 = null;
  if (tmp4Result.isIOS()) {
    tmp10Result4 = null;
    if (null != channelId) {
      const obj6 = { channelId, screenIndex, onJumpToPresent };
      tmp10Result4 = tmp10(tmp(12360), obj6);
    }
  }
