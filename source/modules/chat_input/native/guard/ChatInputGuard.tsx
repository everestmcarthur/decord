...
// Function ID: 12578
// Name: ChatInputGuard
// Dependencies: [19, 17, 9615, 21, 4636, 576, 670, 7976, 12390, 12389, 5206, 1150, 12396, 5686, 8202, 11066, 11061, 4632, 5056, 5514, 9031, 2]
...
let closure_6 = fn(9615).updateChatInputContainerHeight;
const jsxProd = fn(21);
...
export default function ChatInputGuard(type) {
  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(11066).ArrowSmallRightIcon, obj5);
        }
        obj4.icon = actionIcon;
        obj4.onPress = actionOnPress;
        let tmp7Result = tmp7(tmp9(8202).IconButton, obj4);
      }
      obj3.trailing = tmp7Result;
      const obj6 = { variant: "text-sm/semibold", children: message };
      obj3.label = tmp7(tmp9(4632).Text, obj6);
    ...
    if (null != countdown) {
      ...
      tmp7Result = tmp7(tmp(11061), obj7);
    }
    tmp8 = hasOwnProperty;
  } else {
    ...
    if (null != subtext2) {
      ...
      if (typeof subtext2 === "string") {
        ...
        if (subtext2.length > 0) {
          ...
          tmp13Result = tmp13(tmp14(4632).Text, obj);
        }
      }
    }
    ...
    if (null != buttonSecondaryText) {
      ...
      if (null != buttonSecondaryOnPress) {
        ...
        items2[1] = tmp13(tmp14(5056).Button, obj12);
        obj11.children = items2;
        tmp16Result = tmp16(tmp14(9031).TwinButtons, obj11);
      }
    }
    ...
    if (null != countdown2) {
      ...
      tmp13Result2 = tmp13(tmp(11061), obj14);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  const chatInputFloatingOverlayStyle = screenIndex(12390).useChatInputFloatingOverlayStyle();
  ...
  if (tmp3) {
    tmp10Result3 = tmp10(tmp(5206), { absolute: true, wide: true, tall: true, mix: true });
  }
  const items4 = [tmp10Result3, children];
  obj5.children = items4;
  items3[1] = closure_8(closure_5, obj5);
  const obj = screenIndex(12390);
  let tmp10Result4 = null;
  if (tmp4Result.isIOS()) {
    tmp10Result4 = null;
    if (null != channelId) {
      const obj6 = { channelId, screenIndex, onJumpToPresent };
      tmp10Result4 = tmp10(tmp(12396), obj6);
    }
  }
