...
// Function ID: 12579
// Name: ChatInputGuard
// Dependencies: [19, 17, 9615, 21, 4636, 576, 670, 7976, 12391, 12390, 5206, 1363, 12397, 5686, 8202, 11067, 11062, 4632, 5056, 5514, 9031, 2]
...
export default function ChatInputGuard(type) {
  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(11067).ArrowSmallRightIcon, obj5);
        }
    ...
    if (null != countdown) {
      ...
      tmp7Result = tmp7(tmp(11062), obj7);
    }
    tmp8 = hasOwnProperty;
  } else {
    ...
    if (null != countdown2) {
      ...
      tmp13Result2 = tmp13(tmp(11062), obj14);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  if (tmp4Result.isIOS()) {
    ...
    if (null != channelId) {
      ...
      tmp10Result4 = tmp10(tmp(12397), obj6);
    }
  }
