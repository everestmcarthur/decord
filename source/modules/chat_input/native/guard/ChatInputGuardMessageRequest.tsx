...
// Dependencies: [5, 19, 1372, 21, 1484, 12592, 504, 12594, 4338, 1115, 5685, 4651, 12600, 2]

// Module 12591 (ChatInputGuardMessageRequest)
...
export default noop.memo(function ChatInputGuardMessageRequest(channel) {
  ...
  const isMessageRequestRestrictedViewer = channel(12592).useIsMessageRequestRestrictedViewer("ChatInputGuardMessageRequest");
  let obj2 = channel(12592);
