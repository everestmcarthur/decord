...
// Dependencies: [19, 17, 4632, 12113, 1074, 21, 4640, 5633, 4464, 12609, 1115, 4820, 5615, 12610, 5768, 5657, 504, 12600, 5617, 12611, 2]

// Module 12608 (ChatInputGuardGuildMemberVerification)
...
const LottieAnimationViewDefault = tmp14(5617);
require = fn;
...
export default noop.memo(function ChatInputGuardGuildMemberVerification(guildId) {
  ...
  const tmp = closure_8();
  const currentUserGuildJoinRequest = guildId(5633).useCurrentUserGuildJoinRequest(guildId);
  ...
  if (guildId(4464).GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
    ...
    const tmp7 = jsx(tmp2(5768).XSmallIcon, {});
  } else {
  ...
  if (null != tmp8) {
    ...
    const obj3 = { style: tmp.lottieAnimation, source: tmp2(12611), autoPlay: !stateFromStores };
