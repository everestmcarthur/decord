...
// Dependencies: [19, 17, 4630, 21, 4638, 4339, 576, 504, 1926, 1364, 8949, 5673, 2]

// Module 12392 (GiftIconTrinketsAnimation)
...
const FastImageDefault = tmp(5673);
const APNGPlayer2 = APNGPlayer(8949);
require = fn;
