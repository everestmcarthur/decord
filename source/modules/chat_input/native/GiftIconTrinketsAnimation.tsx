...
// Dependencies: [19, 17, 4599, 21, 4607, 4308, 576, 504, 1925, 1115, 8902, 5639, 2]

// Module 12345 (GiftIconTrinketsAnimation)
...
const FastImageDefault = tmp(5639);
const APNGPlayer2 = APNGPlayer(8902);
require = fn;
