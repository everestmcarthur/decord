...
// Dependencies: [19, 17, 4597, 21, 4605, 4306, 576, 504, 1925, 1115, 8879, 5637, 2]

// Module 12320 (GiftIconTrinketsAnimation)
...
const FastImageDefault = tmp(5637);
const APNGPlayer2 = APNGPlayer(8879);
require = fn;
