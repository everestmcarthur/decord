...
// Dependencies: [19, 10421, 21, 576, 4639, 12561, 4376, 10441, 10460, 4350, 2]

// Module 12566 (EmojiSuggestionBarSmall)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4376 */;
import EmojiPickerListRow from "EmojiPickerListRow" /* 10441 */;
import EmojiSuggestionBarUtils from "EmojiSuggestionBarUtils" /* 12561 */;
...
function EmojiSuggestionBarSmallAnimated(displayEmojis) {
  ...
  const suggestionBarHeight = displayEmojis(12561).useSuggestionBarHeight(transitionState, cleanUp, CONTAINER_SMALL_WRAPPER_HEIGHT, onOccupiedHeightChange);
  let obj = displayEmojis(12561);
  class A {
    constructor() {
      obj = { opacity: null };
  ...
  const obj4 = {
    ...
    children: displayEmojis.map((emoji, index) => {
      ...
      if (locked) {
        ...
        openEmojiActionSheet = tmp2(10460).openEmojiActionSheet;
      }
...
const jsx = fn(21).jsx;
const sum = fn(10421).IMAGE_SIZE + 2 * nativeDefault.space.PX_8 + 2;
