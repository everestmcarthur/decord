...
// Dependencies: [17, 13737, 13739, 3, 1150, 13738, 5222, 2]
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(13738).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(13738).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(13738).default;
      if (_default != null) {
