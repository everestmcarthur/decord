...
// Dependencies: [17, 13724, 13726, 3, 1115, 13725, 5191, 2]
// Exports: getCompressionHandler

// Module 13723 (GatewayCompressionHandler)
import LoggerDefault from "Logger" /* 3 */;
import _mod17 from "module_17" /* 17 */;
import PlatformUtils from "PlatformUtils" /* 1115 */;
import ProcessArgs2 from "ProcessArgs" /* 5191 */;
import GatewayZstdUtils from "GatewayZstdUtils" /* 13724 */;
import NativeCompressionModule from "NativeCompressionModule" /* 13725 */;
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = _mod13726;
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(13725).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(13725).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(13725).default;
      if (_default != null) {
