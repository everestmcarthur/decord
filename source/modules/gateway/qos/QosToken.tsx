...
// Function ID: 501
// Name: QosToken
// Dependencies: [501, 3, 14283, 1224, 2]
// Exports: buildQosToken

// Module 500 (QosToken)
import LoggerDefault from "Logger" /* 3 */;
import ProtoUtils from "ProtoUtils" /* 1224 */;
import qos_token from "qos_token" /* 14283 */;
...
function buildQosTokenFromDerivedData(derivedQosData, isActive) {
  ...
  if (null != derivedQosData) {
    try {
      derived = tmp2(1224).b64ToProto(tmp2(14283).DerivedQosData, derivedQosData);
  ...
  const QosToken = tmp2(14283).QosToken;
