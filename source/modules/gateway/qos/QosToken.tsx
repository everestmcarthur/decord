...
// Function ID: 501
// Name: QosToken
// Dependencies: [501, 3, 14319, 1223, 2]
// Exports: buildQosToken

// Module 500 (QosToken)
import LoggerDefault from "Logger" /* 3 */;
import ProtoUtils from "ProtoUtils" /* 1223 */;
import qos_token from "qos_token" /* 14319 */;
...
function buildQosTokenFromDerivedData(derivedQosData, isActive) {
  ...
  if (null != derivedQosData) {
    try {
      derived = tmp2(1223).b64ToProto(tmp2(14319).DerivedQosData, derivedQosData);
  ...
  const QosToken = tmp2(14319).QosToken;
