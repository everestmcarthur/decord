...
// Dependencies: [13734, 3, 13737, 38, 2]

// Module 13736 (BasicWorkScheduler)
import LoggerDefault from "Logger" /* 3 */;
import _modDef38 from "module_38" /* 38 */;
import WorkSchedulerTelemetry from "WorkSchedulerTelemetry" /* 13737 */;
import DispatcherWorkConstants from "DispatcherWorkConstants" /* 13734 */;
...
prototype["requestWorkTimeout"] = function requestWorkTimeout(flush, arg1) {
  ...
  if (!self.hasWorkScheduled) {
    ...
    telemetry.time(self(13737).WorkSchedulerTelemetryTiming.TIME_TO_QUEUE_EMPTY);
    if (self._nextDispatchTimeout === closure_6) {
      const telemetry2 = self.telemetry;
      telemetry2.track(tmp(13737).WorkSchedulerTelemetryEvent.LONGER_DISPATCH);
    }
    if (flag) {
