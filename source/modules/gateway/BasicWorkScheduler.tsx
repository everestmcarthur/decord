...
// Dependencies: [13743, 3, 13746, 38, 2]

// Module 13745 (BasicWorkScheduler)
...
prototype["requestWorkTimeout"] = function requestWorkTimeout(flush, arg1) {
  ...
  if (!self.hasWorkScheduled) {
    ...
    telemetry.time(self(13746).WorkSchedulerTelemetryTiming.TIME_TO_QUEUE_EMPTY);
    if (self._nextDispatchTimeout === closure_6) {
      const telemetry2 = self.telemetry;
      telemetry2.track(tmp(13746).WorkSchedulerTelemetryEvent.LONGER_DISPATCH);
    }
    if (flag) {
