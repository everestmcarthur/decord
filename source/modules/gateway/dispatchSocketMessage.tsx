...
import _deletePaymentSource from "_deletePaymentSource" /* 4884 */;
import fetchSubscriptionPlansForSKUAll from "fetchSubscriptionPlansForSKU" /* 7257 */;
...
import closure_8 from "createdAt" /* 1385 */;
...
function dispatchGuildMemberAdd(guild_id, author, member) {
  ...
  if (isEqualResult) {
    ...
    isEqualResult = obj(1881).isEqualAvatarDecoration(avatarDecoration, tmp9);
    const tmp2Result = obj(1881);
  }
  if (isEqualResult) {
  ...
  initialGuild.measure(() => {
    ...
    Emitter.batched(() => {
      ...
      if (null != closure_1_12.getCurrentUser()) {
        ...
        const obj3 = closure_1_1(tmp[21]);
        closure_1_1(tmp[21]).dispatch(obj).catch((error) => {
          closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
          const socket = obj(closure_1_3[13]).socket;
          obj = { error, action: obj.type };
          result = socket.resetSocketOnDispatchError(obj);
        ...
        const dispatchResult = closure_1_1(tmp[21]).dispatch(obj);
        const obj5 = closure_1_1(tmp[21]);
        closure_1_1(tmp[21]).dispatch(obj).catch((error) => {
          closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
          const socket = obj(closure_1_3[13]).socket;
          obj = { error, action: obj.type };
        ...
        const dispatchResult1 = closure_1_1(tmp[21]).dispatch(obj);
      }
    });
  });
});
defineSimpleDispatch(["READY_SUPPLEMENTAL"], (arg0) => {
    ...
    Emitter.batched(() => {
      ...
      let item = found.forEach((presences) => {
        ...
        presences.presences = presences.presences || [].map((activities) => {
          ...
          const tmp2Result = closure_1_1(closure_1_3[38])(activities, hidden_activities);
          const tmp = id;
          const tmp2 = closure_1_1(closure_1_3[38]);
      ...
      dispatchReadySupplemental.measure(() => {
        ...
        closure_2_1(closure_2_3[21]).dispatch(obj).catch((error) => {
          closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
          const socket = obj(closure_1_3[13]).socket;
          obj = { error, action: obj.type };
          result = socket.resetSocketOnDispatchError(obj);
      ...
      closure_1_1(closure_1_3[21]).dispatch(obj).catch((error) => {
        closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
        const socket = obj(closure_1_3[13]).socket;
        obj = { error, action: obj.type };
        result = socket.resetSocketOnDispatchError(obj);
  ...
  const timerId = setTimeout(() => {
    ...
    const obj2 = callback(table[21]);
    callback(table[21]).dispatch(obj).catch((error) => {
      closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
      const socket = obj(closure_1_3[13]).socket;
      obj = { error, action: obj.type };
      result = socket.resetSocketOnDispatchError(obj);
    ...
    ready.measure(() => {
      ...
      Emitter.batched(() => {
        ...
        dispatchReady.measure(() => {
          ...
          obj[28] = obj.auth;
          obj = { flags: obj.notification_settings.flags, declarativeSettings: result1 };
          obj[29] = obj;
          obj[30] = closure_3;
          ...
          const qos_token = obj.qos_token;
          obj[35] = qos_token;
          const obj3 = closure_2_1(closure_2_3[21]);
          closure_2_1(closure_2_3[21]).dispatch(obj).catch((error) => {
            closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
            const socket = obj(closure_1_3[13]).socket;
            obj = { error, action: obj.type };
...
defineSimpleDispatch(["THREAD_MEMBER_LIST_UPDATE"], (arg0) => {
  ...
  Emitter.batched(() => {
    ...
    const obj2 = closure_1_1(closure_1_3[21]);
    const tmp = obj;
    ...
    const dispatchResult = closure_1_1(closure_1_3[21]).dispatch(obj);
    tmp2(tmp3[12]).flush();
  });
});
defineSimpleDispatch(["GUILD_BAN_ADD", "GUILD_BAN_REMOVE", "GUILD_MEMBER_ADD", "GUILD_MEMBER_UPDATE", "GUILD_MEMBER_REMOVE"], (guildId, type) => {
  ...
  const obj2 = obj(1882);
  obj[14] = obj(1388).parseServerDisplayNameStyles(guildId.display_name_styles);
  const obj3 = obj(1388);
...
defineSimpleDispatch(["MESSAGE_POLL_VOTE_ADD", "MESSAGE_POLL_VOTE_REMOVE"], (channelId) => {
  ...
  obj = { type: str, channelId: channelId.channel_id, messageId: channelId.message_id, userId: channelId.user_id, emoji: obj, reactionType: obj(7763).ReactionTypes.VOTE };
...
defineSimpleDispatch(["MESSAGE_POLL_VOTE_ADD_MANY"], (channelId) => {
  let obj = {
    ...
    reactions: votes.map((answer_id) => {
      ...
      obj.reactionType = obj(table[28]).ReactionTypes.VOTE;
      return obj;
    })
  };
...
defineSimpleDispatch(["USER_PAYMENT_CLIENT_ADD"], (arg0) => {
  const _require = arg0;
  const purchaseTokenHash = _require(4893).getPurchaseTokenHash();
...
defineSimpleDispatch(["GUILD_MEMBER_LIST_UPDATE"], (arg0) => {
  ...
  Emitter.batched(() => {
    let obj = function handleItem(member) {
      if (null != member.member) {
        ...
        if (null != member.presence) {
          ...
          const tmp = closure_1_1(closure_1_3[38])(activities, hidden_activities);
          ...
          const tmp9 = closure_1_1(closure_1_3[38]);
        }
        tmp5 = obj;
      }
    };
    ...
    const obj3 = closure_1_1(closure_1_3[21]);
    closure_1_1(closure_1_3[21]).dispatch(obj).catch((error) => {
      closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
      const socket = obj(closure_1_3[13]).socket;
      obj = { error, action: obj.type };
...
defineSimpleDispatch(["NOTIFICATION_SETTINGS_UPDATE"], (declarative_settings_proto) => {
  let prop;
  if (declarative_settings_proto != null) {
    prop = declarative_settings_proto.declarative_settings_proto;
  }
  let result;
  if (null != prop) {
    obj = obj(13683);
  ...
  obj = { flags: declarative_settings_proto.flags, declarativeSettings: result };
  const obj4 = dispatcherDefault;
  dispatcherDefault.dispatch(obj).catch((error) => {
    closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
    const socket = obj(closure_1_3[13]).socket;
...
defineSimpleDispatch(["USER_DISCORD_ACHIEVEMENT_STATE_UPDATE"], (payload) => {
  const obj = { type: "USER_DISCORD_ACHIEVEMENT_STATE_UPDATE", payload };
  const obj2 = dispatcherDefault;
  dispatcherDefault.dispatch(obj).catch((error) => {
    closure_1_17.error("dispatchOrResetSocket error during " + obj.type + ":", error);
    const socket = obj(closure_1_3[13]).socket;
