...
set.state = { channelId: "flexDirection", connectionState: "content", selfMute: false, deafened: "four_leaf_clover", isPushToTalk: "animal", embeddedActivity: "bamboo", isStreaming: "face" };
