...
// Dependencies: [19, 1074, 11760, 21, 1241, 1115, 2659, 11763, 17507, 17514, 17508, 4606, 17509, 1897, 4337, 2]
// Exports: default

// Module 17513 (VoiceFeedbackActionSheet)
...
import FeedbackActionSheetV2Default from "FeedbackActionSheetV2" /* 17507 */;
import shouldShowLogUploadForCategory from "shouldShowLogUploadForCategory" /* 17508 */;
import trackVoiceFeedbackDefault from "trackVoiceFeedback" /* 17514 */;
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj.problemOptions = analyticsData(11763).getConnectionFeedbackOptions();
  ...
  let obj2 = analyticsData(11763);
  obj4.problemOptions = analyticsData(11763).getAudioFeedbackOptions({ isMobile: true });
  ...
  let obj5 = analyticsData(11763);
  obj7.problemOptions = analyticsData(11763).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11763);
  obj10.problemOptions = analyticsData(11763).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11763);
    ...
    if (null != rating) {
      ...
      if (null != reason) {
        if (obj3.shouldShowLogUploadForCategory(rating, category, reason)) {
          ...
          tmp20(4606).openLazy(asyncRequireImpl(17509, dependencyMap.paths), "UploadLogs", { mediaSessionId: null, rtcConnectionId: null });
          const obj7 = { mediaSessionId: null, rtcConnectionId: null };
          const tmp20Result = tmp20(4606);
        }
