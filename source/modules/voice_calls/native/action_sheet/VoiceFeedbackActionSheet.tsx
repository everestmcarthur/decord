...
// Dependencies: [19, 1074, 11768, 21, 1241, 1115, 2659, 11771, 17563, 17570, 17564, 4605, 17565, 1897, 4335, 2]
// Exports: default

// Module 17569 (VoiceFeedbackActionSheet)
...
import FeedbackActionSheetV2Default from "FeedbackActionSheetV2" /* 17563 */;
import shouldShowLogUploadForCategory from "shouldShowLogUploadForCategory" /* 17564 */;
import trackVoiceFeedbackDefault from "trackVoiceFeedback" /* 17570 */;
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj.problemOptions = analyticsData(11771).getConnectionFeedbackOptions();
  ...
  let obj2 = analyticsData(11771);
  obj4.problemOptions = analyticsData(11771).getAudioFeedbackOptions({ isMobile: true });
  ...
  let obj5 = analyticsData(11771);
  obj7.problemOptions = analyticsData(11771).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11771);
  obj10.problemOptions = analyticsData(11771).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11771);
    ...
    if (null != rating) {
      ...
      if (null != reason) {
        if (obj3.shouldShowLogUploadForCategory(rating, category, reason)) {
          ...
          tmp20(4605).openLazy(asyncRequireImpl(17565, dependencyMap.paths), "UploadLogs", { mediaSessionId: null, rtcConnectionId: null });
          const obj7 = { mediaSessionId: null, rtcConnectionId: null };
          const tmp20Result = tmp20(4605);
        }
