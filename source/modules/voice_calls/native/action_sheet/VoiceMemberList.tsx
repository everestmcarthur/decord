...
// Dependencies: [32, 5, 19, 17, 1957, 1386, 4661, 4278, 1372, 4663, 1074, 1181, 7258, 1085, 21, 4639, 13874, 10069, 504, 8719, 13553, 1115, 10162, 11724, 9952, 4635, 9751, 7269, 1875, 5496, 9665, 4846, 13879, 13880, 1478, 13887, 4497, 12, 4606, 8299, 4350, 13888, 7179, 2]

// Module 13878 (VoiceMemberList)
...
import GuildEventVoiceBannerDefault from "GuildEventVoiceBanner" /* 13874 */;
import VoiceMemberUser from "VoiceMemberUser" /* 13880 */;
...
function VoiceSectionRow(arg0) {
  ...
  importDefault = isActionSheet(9751).useAnalyticsContext();
  ...
  if (tmp3) {
    ...
    return closure_21(tmp2(13879), obj2);
  } else {
    let obj3 = {};
    const merged = Object.assign(item);
    obj3.onPress = onPressUser;
    obj3.isActionSheet = isActionSheet;
    return closure_21(tmp2(13880), obj3);
  }
  let obj = isActionSheet(9751);
...
let closure_26 = noop.memo((channel) => {
  ...
  if (!tmp3) {
    ...
    if (tmp6) {
      ...
      obj3.source = _modDef10162;
      obj3.size = tmp4(13553).CircularIconButton.Sizes.MEDIUM_32;
      obj2.leading = closure_21(tmp4(13553).CircularIconButton, obj3);
      ...
      items[1] = closure_21(tmp4(8719).FormRow, obj2);
      obj.children = items;
