...
// Dependencies: [19, 17, 1183, 502, 5328, 1957, 2021, 1908, 4645, 1074, 21, 4605, 576, 9548, 504, 4456, 13862, 13863, 1178, 13864, 13865, 13866, 13867, 9695, 4601, 1114, 8663, 7789, 10128, 4462, 4812, 4572, 5173, 9251, 4757, 9243, 4449, 2]

// Module 13861 (VoiceMemberUser)
...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    obj2.subLabel = closure_11(tmp3(8663).FormSubLabel, obj3);
    ...
    if (tmp10Result) {
      ...
      obj4.children = tmp10(channel(10128), obj5);
      tmp10Result = tmp10(closure_3, obj4);
      const tmp20 = channel(10128);
    }
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      closure_11(channelId(5173).PressableOpacity, obj);
    }
  }
  return tmp3;
}
...
let closure_16 = noop.memo((user) => {
  ...
  const tmp7 = channel(9548)({ userId: user.id });
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1178).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13867), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1178).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13864), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1178).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13865), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1178).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13866), style: tmp19 };
          }
          tmp20(tmp8(1178).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = tmp5(13862);
        } else {
          tmp5Result = tmp5(13863);
        }
  ...
  if (stateFromStores1) {
    ...
    items4[1] = closure_12(tmp8(4601).Text, obj17);
  ...
  obj15.label = closure_11(user(8663).FormRow.Label, obj18);
  if (localVideoAutoDisabled) {
    const obj19 = { style: tmp2.autoDisabledVideo, children: null };
    const obj20 = { source: tmp5(9695), size: tmp8(1178).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    ...
    items6[1] = tmp20(tmp8(4601).Text, obj21);
  ...
  return closure_11(user(8663).FormRow, obj15);
});
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  const obj = id(504);
  const name = id2(4757).getName(id2.guild_id, id2.id, id);
  const obj2 = id2(4757);
  const obj4 = {
    onPress() {
  ...
  const canRing = id(9243).useCanRing(id, "DisconnectedUserRow");
  ...
  obj4.label = closure_11(id(8663).FormRow.Label, obj5);
  const obj3 = id(9243);
  ...
  if (!canRing) {
    ...
    return tmp7(tmp2(8663).FormRow, obj7);
  } else {
