...
// Dependencies: [19, 17, 1182, 502, 5364, 1958, 2022, 1909, 4678, 1074, 21, 4638, 576, 9621, 504, 4489, 13894, 13895, 1177, 13896, 13897, 13898, 13899, 9765, 4634, 1115, 8728, 7852, 10197, 4495, 4845, 4605, 5208, 9325, 4790, 9317, 4482, 2]

// Module 13893 (VoiceMemberUser)
...
import StreamerApplicationSelectors from "StreamerApplicationSelectors" /* 7852 */;
import CallActionCreatorsDefault from "CallActionCreators" /* 9325 */;
...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    obj2.subLabel = closure_11(tmp3(8728).FormSubLabel, obj3);
    ...
    if (tmp10Result) {
      ...
      obj4.children = tmp10(channel(10197), obj5);
      tmp10Result = tmp10(closure_3, obj4);
      const tmp20 = channel(10197);
    }
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      closure_11(channelId(5208).PressableOpacity, obj);
    }
  }
  return tmp3;
}
...
let closure_16 = noop.memo((user) => {
  ...
  const tmp7 = channel(9621)({ userId: user.id });
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13899), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13896), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13897), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13898), style: tmp19 };
          }
          tmp20(tmp8(1177).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = tmp5(13894);
        } else {
          tmp5Result = tmp5(13895);
        }
  ...
  if (stateFromStores1) {
    ...
    items4[1] = closure_12(tmp8(4634).Text, obj17);
  ...
  obj15.label = closure_11(user(8728).FormRow.Label, obj18);
  if (localVideoAutoDisabled) {
    const obj19 = { style: tmp2.autoDisabledVideo, children: null };
    const obj20 = { source: tmp5(9765), size: tmp8(1177).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    ...
    items6[1] = tmp20(tmp8(4634).Text, obj21);
  ...
  return closure_11(user(8728).FormRow, obj15);
});
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  const obj = id(504);
  const name = id2(4790).getName(id2.guild_id, id2.id, id);
  const obj2 = id2(4790);
  const obj4 = {
    onPress() {
  ...
  const canRing = id(9317).useCanRing(id, "DisconnectedUserRow");
  ...
  obj4.label = closure_11(id(8728).FormRow.Label, obj5);
  const obj3 = id(9317);
  ...
  if (!canRing) {
    ...
    return tmp7(tmp2(8728).FormRow, obj7);
  } else {
