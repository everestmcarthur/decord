...
// Dependencies: [19, 17, 1182, 502, 5366, 1958, 2022, 1909, 4680, 1074, 21, 4640, 576, 9632, 504, 4491, 13902, 13903, 1177, 13904, 13905, 13906, 13907, 9776, 4636, 1115, 8748, 7858, 10208, 4497, 4847, 4607, 5210, 9336, 4792, 9328, 4484, 2]

// Module 13901 (VoiceMemberUser)
...
import CallActionCreatorsDefault from "CallActionCreators" /* 9336 */;
...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    obj2.subLabel = closure_11(tmp3(8748).FormSubLabel, obj3);
    ...
    if (tmp10Result) {
      ...
      obj4.children = tmp10(channel(10208), obj5);
      tmp10Result = tmp10(closure_3, obj4);
      const tmp20 = channel(10208);
    }
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      closure_11(channelId(5210).PressableOpacity, obj);
    }
  }
  return tmp3;
}
...
let closure_16 = noop.memo((user) => {
  ...
  const tmp7 = channel(9632)({ userId: user.id });
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13907), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13904), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13905), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13906), style: tmp19 };
          }
          tmp20(tmp8(1177).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = tmp5(13902);
        } else {
          tmp5Result = tmp5(13903);
        }
  ...
  if (stateFromStores1) {
    ...
    items4[1] = closure_12(tmp8(4636).Text, obj17);
  ...
  obj15.label = closure_11(user(8748).FormRow.Label, obj18);
  if (localVideoAutoDisabled) {
    const obj19 = { style: tmp2.autoDisabledVideo, children: null };
    const obj20 = { source: tmp5(9776), size: tmp8(1177).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    ...
    items6[1] = tmp20(tmp8(4636).Text, obj21);
  ...
  return closure_11(user(8748).FormRow, obj15);
});
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  const obj = id(504);
  const name = id2(4792).getName(id2.guild_id, id2.id, id);
  const obj2 = id2(4792);
  const obj4 = {
    onPress() {
  ...
  const canRing = id(9328).useCanRing(id, "DisconnectedUserRow");
  ...
  obj4.label = closure_11(id(8748).FormRow.Label, obj5);
  const obj3 = id(9328);
  ...
  if (!canRing) {
    ...
    return tmp7(tmp2(8748).FormRow, obj7);
  } else {
