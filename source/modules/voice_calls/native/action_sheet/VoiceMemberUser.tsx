...
// Dependencies: [19, 17, 1182, 502, 5363, 1958, 2022, 1909, 4679, 1074, 21, 4639, 576, 9610, 504, 4491, 13881, 13882, 1177, 13883, 13884, 13885, 13886, 9757, 4635, 1115, 8719, 7843, 10189, 4497, 4846, 4606, 5207, 9314, 4791, 9306, 4484, 2]

// Module 13880 (VoiceMemberUser)
...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    obj2.subLabel = closure_11(tmp3(8719).FormSubLabel, obj3);
    ...
    if (tmp10Result) {
      ...
      obj4.children = tmp10(channel(10189), obj5);
      tmp10Result = tmp10(closure_3, obj4);
      const tmp20 = channel(10189);
    }
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      closure_11(channelId(5207).PressableOpacity, obj);
    }
  }
  return tmp3;
}
...
let closure_16 = noop.memo((user) => {
  ...
  const tmp7 = channel(9610)({ userId: user.id });
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13886), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13883), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13884), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(13885), style: tmp19 };
          }
          tmp20(tmp8(1177).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = tmp5(13881);
        } else {
          tmp5Result = tmp5(13882);
        }
  ...
  if (stateFromStores1) {
    ...
    items4[1] = closure_12(tmp8(4635).Text, obj17);
  ...
  obj15.label = closure_11(user(8719).FormRow.Label, obj18);
  if (localVideoAutoDisabled) {
    const obj19 = { style: tmp2.autoDisabledVideo, children: null };
    const obj20 = { source: tmp5(9757), size: tmp8(1177).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    ...
    items6[1] = tmp20(tmp8(4635).Text, obj21);
  ...
  return closure_11(user(8719).FormRow, obj15);
});
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  const obj = id(504);
  const name = id2(4791).getName(id2.guild_id, id2.id, id);
  const obj2 = id2(4791);
  const obj4 = {
    onPress() {
  ...
  const canRing = id(9306).useCanRing(id, "DisconnectedUserRow");
  ...
  obj4.label = closure_11(id(8719).FormRow.Label, obj5);
  const obj3 = id(9306);
  ...
  if (!canRing) {
    ...
    return tmp7(tmp2(8719).FormRow, obj7);
  } else {
