...
// Dependencies: [9228, 1958, 1909, 4662, 2012, 1372, 9215, 4819, 9232, 9229, 573, 2]
// Exports: default

// Module 13721 (collectCallFeedback)
    ...
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        if (VideoBackgroundStore.hasUsedBackgroundInCall) {
          ...
          const lastUsedVideoBackgroundOption = tmp5(9232).getLastUsedVideoBackgroundOption(UserStore.getCurrentUser());
          ...
          const tmp5Result = tmp5(9232);
          obj7.video_effect_type = tmp5(9229).getEffectAnalyticsType(lastUsedVideoBackgroundOption);
          const tmp5Result3 = tmp5(9229);
          obj7.video_effect_detail = tmp5(9229).getEffectDetailAnalyticsName(lastUsedVideoBackgroundOption);
          const merged2 = Object.assign(obj7);
          const tmp5Result4 = tmp5(9229);
