...
// Dependencies: [9186, 1957, 1908, 4629, 2011, 1371, 9173, 4786, 9190, 9187, 573, 2]
// Exports: default

// Module 13681 (collectCallFeedback)
    ...
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        if (VideoBackgroundStore.hasUsedBackgroundInCall) {
          ...
          const lastUsedVideoBackgroundOption = tmp5(9190).getLastUsedVideoBackgroundOption(UserStore.getCurrentUser());
          ...
          const tmp5Result = tmp5(9190);
          obj7.video_effect_type = tmp5(9187).getEffectAnalyticsType(lastUsedVideoBackgroundOption);
          const tmp5Result3 = tmp5(9187);
          obj7.video_effect_detail = tmp5(9187).getEffectDetailAnalyticsName(lastUsedVideoBackgroundOption);
          const merged2 = Object.assign(obj7);
          const tmp5Result4 = tmp5(9187);
