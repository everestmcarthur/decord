...
// Dependencies: [9188, 1957, 1908, 4630, 2011, 1371, 9175, 4787, 9192, 9189, 573, 2]
// Exports: default

// Module 13683 (collectCallFeedback)
import DispatcherDefault from "Dispatcher" /* 573 */;
import AppAnalyticsUtils from "AppAnalyticsUtils" /* 4787 */;
import VideoBackgroundStore from "VideoBackgroundStore" /* 9188 */;
    ...
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        if (VideoBackgroundStore.hasUsedBackgroundInCall) {
          ...
          const lastUsedVideoBackgroundOption = tmp5(9192).getLastUsedVideoBackgroundOption(UserStore.getCurrentUser());
          ...
          const tmp5Result = tmp5(9192);
          obj7.video_effect_type = tmp5(9189).getEffectAnalyticsType(lastUsedVideoBackgroundOption);
          const tmp5Result3 = tmp5(9189);
          obj7.video_effect_detail = tmp5(9189).getEffectDetailAnalyticsName(lastUsedVideoBackgroundOption);
          const merged2 = Object.assign(obj7);
          const tmp5Result4 = tmp5(9189);
