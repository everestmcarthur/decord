...
// Dependencies: [5, 1074, 5066, 1115, 573, 1271, 7967, 8104, 8105, 8106, 7969, 2]

// Module 8103 (ForumActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import util from "util" /* 1115 */;
import HTTPUtils from "HTTPUtils" /* 1271 */;
import AnalyticsFeedItemSeenActionCreators from "AnalyticsFeedItemSeenActionCreators" /* 8104 */;
import ForumChannelSeenManager from "ForumChannelSeenManager" /* 8105 */;
import AnalyticsFeedItemSeenManager from "AnalyticsFeedItemSeenManager" /* 8106 */;
...
export default {
  ...
  searchForumPosts(guild_id, id, arg2, c1, c2) {
    ...
    return (async () => {
      ...
      await channelId(7967).searchThreads(closure_0, channelId, closure_2, closure_3, closure_4);
      if (1 === tmp7) {
        dependencyMap = 0;
        ...
        closure_128_0 = arg1;
        guild_id(7969).trackForumSearched({ guildId: closure_129_0, channelId: closure_129_1, numSearchResults: closure_128_0.length });
        guild_id(7969);
