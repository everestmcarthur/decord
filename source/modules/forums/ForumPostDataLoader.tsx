...
// Dependencies: [5, 1958, 7501, 7473, 7504, 1074, 12, 11, 504, 1271, 573, 2]
// Exports: preloadForumThreads, useFirstForumPostMessage, useMostRecentForumMessage

// Module 7500 (ForumPostDataLoader)
...
const computeThreadIdsSnapshot = fn(7501).computeThreadIdsSnapshot;
