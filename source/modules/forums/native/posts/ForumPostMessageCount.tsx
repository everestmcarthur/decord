...
// Dependencies: [19, 17, 21, 4640, 576, 1364, 8007, 1115, 5158, 4636, 11470, 2]
// Exports: default

// Module 12169 (ForumPostMessageCount)
...
export default function ForumPostMessageCount(hasUnreads) {
  ...
  if (isMaxMessageCount) {
    ...
    let tmp7Result = tmp7(tmp2(4636).Text, obj4);
  } else {
  ...
  if (tmp5Result) {
    ...
    tmp5Result = tmp5(tmp2(4636).Text, obj6);
  }
  items1[2] = tmp5Result;
