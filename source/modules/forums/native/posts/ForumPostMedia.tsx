...
// Function ID: 12105
// Name: ForumPostMedia
// Dependencies: [32, 19, 17, 1183, 1182, 21, 4607, 576, 5639, 5017, 12105, 7673, 12106, 1115, 7370, 5175, 8499, 8501, 12107, 4458, 1935, 10310, 1476, 2]
// Exports: ForumPostGridMedia, ForumPostMediaThumbnail, useSharedMediaProps

// Module 12104 (ForumPostMedia)
...
import SpoilerIconDefault from "SpoilerIcon" /* 12105 */;
...
function ForumPostMedia(obscureReason) {
  ...
  if (obscureReason.isMediaPost) {
    ...
    let tmp6Result = closure_10(ref(12106), obj2);
    let tmp12 = closure_10;
    const tmp19 = ref(12106);
  } else {
  ...
  if (null != obscureReason.obscureReason) {
    const AGE_VERIFICATION_OBSCURABLE_REASONS = tmp3(7370).AGE_VERIFICATION_OBSCURABLE_REASONS;
    if (AGE_VERIFICATION_OBSCURABLE_REASONS.has(obscureReason.obscureReason)) {
      if (shouldAgeVerifyForReason) {
        ...
        const obj6 = {
          ...
          onPress() {
                  const obj = ref(8499);
                  const result = obj.showAgeVerificationGetStartedModal({ entryPoint: obscureReason(8501).AgeVerificationModalEntryPoint.FORUM_POST_MEDIA_PREVIEW });
                },
          children: tmp6Result
        };
        obj5.children = tmp12(tmp3(5175).PressableOpacity, obj6);
  ...
  if (null != obscureReason.onPress) {
    ...
    obj7.children = tmp12(tmp3(5175).PressableOpacity, obj8);
