...
// Dependencies: [19, 17, 7347, 21, 4607, 7346, 12110, 12100, 12109, 12111, 12118, 12104, 2]
// Exports: default

// Module 12117 (ForumPostListBody)
import GameInvitesChannelUtils from "GameInvitesChannelUtils" /* 7346 */;
import ForumPostUsername from "ForumPostUsername" /* 12100 */;
import ForumPostTimestampDefault from "ForumPostTimestamp" /* 12109 */;
import ForumPostNewTagDefault from "ForumPostNewTag" /* 12110 */;
import ForumPostMessageContentDefault from "ForumPostMessageContent" /* 12118 */;
...
export default function ForumPostListBody(arg0) {
  ...
  if (!isGameInvitesPost) {
    ...
    tmp9Result = tmp9(tmp10(12111), obj7);
  }
  items2[1] = tmp9Result;
  ...
  if (!blocked) {
    ...
    if (null != media) {
      ...
      tmp9Result2 = tmp9(tmp2(12104).ForumPostMediaThumbnail, obj8);
    }
  }
