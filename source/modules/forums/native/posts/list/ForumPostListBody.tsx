...
// Dependencies: [19, 17, 7325, 21, 4605, 7324, 12085, 12075, 12084, 12086, 12093, 12079, 2]
// Exports: default

// Module 12092 (ForumPostListBody)
...
import ForumPostMessageContentDefault from "ForumPostMessageContent" /* 12093 */;
...
export default function ForumPostListBody(arg0) {
  ...
  if (!isGameInvitesPost) {
    ...
    tmp9Result = tmp9(tmp10(12086), obj7);
  }
  items2[1] = tmp9Result;
  ...
  if (!blocked) {
    ...
    if (null != media) {
      ...
      tmp9Result2 = tmp9(tmp2(12079).ForumPostMediaThumbnail, obj8);
    }
  }
