...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 12117, 7386, 12169, 12177, 12170, 11568, 2]
// Exports: default

// Module 12176 (ForumPostListFooter)
import nativeDefault from "native" /* 576 */;
import GameInvitesChannelUtils from "GameInvitesChannelUtils" /* 7386 */;
import useTypingUsersIds from "useTypingUsersIds" /* 12117 */;
import ForumPostMessageCountDefault from "ForumPostMessageCount" /* 12169 */;
import noop from "module_19" /* 19 */;

const ForumPostReactions = tmp2(11568);
require = fn;
...
export default function ForumPostListFooter(parentChannel) {
  ...
  if (isGameInvitesPost) {
    ...
    isGameInvitesPost = tmp8(tmp9(12177), obj4);
  }
