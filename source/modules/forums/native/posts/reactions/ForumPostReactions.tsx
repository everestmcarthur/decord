...
export const MaxForumPostReactions = function MaxForumPostReactions(thread) {
  ...
  ,
    ...
    if (tmp8) {
      ...
      obj1[2] = thread.id;
      tmp8 = callback(tmp3(10223).AdditionalReactionCount, obj1);
    }
    items1[1] = tmp8;
    ...
    if (!disableReactionCreates) {
      ...
      obj2[1] = thread.id;
      tmp10 = callback(tmp3(10223).AddReactionButton, obj2);
    }
    items1[2] = tmp10;
    obj[1] = items1;
