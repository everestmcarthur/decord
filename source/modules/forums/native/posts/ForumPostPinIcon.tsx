...
// Dependencies: [19, 17, 21, 4640, 576, 1177, 12155, 2]
// Exports: default

// Module 12154 (ForumPostPinIcon)
...
export default function ForumPostPinIcon(containerStyle) {
  const tmp = closure_5();
  const obj = { style: null, children: jsx(native.Icon, { source: _modDef12155, style: tmp.pinIcon }) };
  const items = [tmp.pin, containerStyle.containerStyle];
  obj.style = items;
  return <View style={null}>{jsx(native.Icon, { source: _modDef12155, style: tmp.pinIcon })}</View>;
};
