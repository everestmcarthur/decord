...
// Dependencies: [19, 17, 21, 4606, 576, 1178, 12097, 2]
// Exports: default

// Module 12096 (ForumPostPinIcon)
...
export default function ForumPostPinIcon(containerStyle) {
  const tmp = closure_5();
  const obj = { style: null, children: jsx(native.Icon, { source: _modDef12097, style: tmp.pinIcon }) };
  const items = [tmp.pin, containerStyle.containerStyle];
  obj.style = items;
  return <View style={null}>{jsx(native.Icon, { source: _modDef12097, style: tmp.pinIcon })}</View>;
};
