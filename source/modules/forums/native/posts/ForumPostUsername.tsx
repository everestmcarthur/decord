...
// Dependencies: [19, 17, 4631, 12135, 21, 4639, 7992, 1968, 11661, 12140, 504, 8068, 1177, 4635, 2]
...
function ForumPostUsername(arg0) {
  ...
  const diff = useChatWidthDefault() - tmp2(12140).GRID_HORIZONTAL_PADDING - num;
  ...
  if ("username" === stateFromStores) {
    ...
    const processColorStringsArray = tmp2(8068).useProcessColorStringsArray(authorColors);
    const tmp2Result4 = tmp2(8068);
    ...
    if (null != authorName) {
      ...
      items3[1] = React5(tmp2(4635).Text, obj6);
