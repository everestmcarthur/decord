...
// Dependencies: [19, 17, 4597, 12071, 21, 4605, 7937, 1967, 11598, 12076, 504, 8013, 1178, 4601, 2]
...
function ForumPostUsername(arg0) {
  ...
  const diff = useChatWidthDefault() - tmp2(12076).GRID_HORIZONTAL_PADDING - num;
  ...
  if ("username" === stateFromStores) {
    ...
    const processColorStringsArray = tmp2(8013).useProcessColorStringsArray(authorColors);
    const tmp2Result4 = tmp2(8013);
    ...
    if (null != authorName) {
      ...
      items3[1] = React5(tmp2(4601).Text, obj6);
