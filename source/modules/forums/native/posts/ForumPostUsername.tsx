...
// Dependencies: [19, 17, 4599, 12096, 21, 4607, 7960, 1967, 11622, 12101, 504, 8036, 1178, 4603, 2]
// Exports: ForumPostAuthor, ForumPostMessageAuthor

// Module 12100 (ForumPostUsername)
import initialize from "initialize" /* 504 */;
import ForumLayout from "ForumLayout" /* 1967 */;
import ForumHooks from "ForumHooks" /* 7960 */;
import useChatWidthDefault from "useChatWidth" /* 11622 */;
...
function ForumPostUsername(arg0) {
  ...
  const diff = useChatWidthDefault() - tmp2(12101).GRID_HORIZONTAL_PADDING - num;
  ...
  if ("username" === stateFromStores) {
    ...
    const processColorStringsArray = tmp2(8036).useProcessColorStringsArray(authorColors);
    const tmp2Result4 = tmp2(8036);
    ...
    if (null != authorName) {
      ...
      items3[1] = React5(tmp2(4603).Text, obj6);
