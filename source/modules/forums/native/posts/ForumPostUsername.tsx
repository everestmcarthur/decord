...
// Dependencies: [19, 17, 4630, 12143, 21, 4638, 8001, 1968, 11669, 12148, 504, 8077, 1177, 4634, 2]
// Exports: ForumPostAuthor, ForumPostMessageAuthor

// Module 12147 (ForumPostUsername)
import initialize from "initialize" /* 504 */;
import ForumLayout from "ForumLayout" /* 1968 */;
import ForumHooks from "ForumHooks" /* 8001 */;
import useChatWidthDefault from "useChatWidth" /* 11669 */;
...
function ForumPostUsername(arg0) {
  ...
  const diff = useChatWidthDefault() - tmp2(12148).GRID_HORIZONTAL_PADDING - num;
  ...
  if ("username" === stateFromStores) {
    ...
    const processColorStringsArray = tmp2(8077).useProcessColorStringsArray(authorColors);
    const tmp2Result4 = tmp2(8077);
    ...
    if (null != authorName) {
      ...
      items3[1] = React5(tmp2(4634).Text, obj6);
