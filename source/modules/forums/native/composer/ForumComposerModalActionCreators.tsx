...
// Dependencies: [7872, 4842, 10383, 1897, 2]
// Exports: closeCreateForumPostModal, openCreateForumPostModal

// Module 10382 (ForumComposerModalActionCreators)
...
export const openCreateForumPostModal = function openCreateForumPostModal(guildId) {
  ...
  if (!tmp4) {
    ...
    const result1 = tmp(7872).trackForumCreateNewPostStarted({ guildId: null, channelId: null });
    const obj3 = { guildId: null, channelId: null };
    const tmpResult = tmp(7872);
  }
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10383, tmp2.paths), guildId, c3);
};
