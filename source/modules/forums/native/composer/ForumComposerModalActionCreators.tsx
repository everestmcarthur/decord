...
// Dependencies: [7881, 4841, 10391, 1897, 2]
// Exports: closeCreateForumPostModal, openCreateForumPostModal

// Module 10390 (ForumComposerModalActionCreators)
...
export const openCreateForumPostModal = function openCreateForumPostModal(guildId) {
  ...
  if (!tmp4) {
    ...
    const result1 = tmp(7881).trackForumCreateNewPostStarted({ guildId: null, channelId: null });
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10391, tmp2.paths), guildId, c3);
};
