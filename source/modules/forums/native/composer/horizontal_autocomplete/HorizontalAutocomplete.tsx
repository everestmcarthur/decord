...
// Dependencies: [19, 17, 4630, 2016, 1980, 4286, 1372, 1074, 21, 4638, 5610, 576, 4374, 5077, 4639, 504, 1177, 4634, 4482, 7297, 7315, 8253, 5113, 4791, 5673, 2]

// Module 10765 (HorizontalAutocomplete)
...
export default {
  ...
  Role(onPress) {
    ...
    if (null != stateFromStores) {
      roleIconData = tmp2(7297).getRoleIconData(stateFromStores, 30);
      const tmp2Result = tmp2(7297);
    }
  ...
  Channel(channel) {
    ...
    if (channel.type === constants.GUILD_CATEGORY) {
      ...
      channelIconWithGuild = tmp2(5113).getChannelIconWithGuild(channel, tmp5);
    ...
    items[1] = closure_11(channel(4634).Text, { style: tmp.channelName, variant: "text-sm/semibold", children: channelName });
    obj.children = items;
