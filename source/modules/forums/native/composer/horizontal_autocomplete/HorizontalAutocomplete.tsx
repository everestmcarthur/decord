...
// Dependencies: [19, 17, 4631, 2016, 1980, 4288, 1372, 1074, 21, 4639, 5609, 576, 4376, 5076, 4640, 504, 1177, 4635, 4484, 7294, 7312, 8244, 5112, 4792, 5672, 2]

// Module 10757 (HorizontalAutocomplete)
...
export default {
  ...
  Role(onPress) {
    ...
    if (null != stateFromStores) {
      roleIconData = tmp2(7294).getRoleIconData(stateFromStores, 30);
      const tmp2Result = tmp2(7294);
    }
  ...
  Channel(channel) {
    ...
    if (channel.type === constants.GUILD_CATEGORY) {
      ...
      channelIconWithGuild = tmp2(5112).getChannelIconWithGuild(channel, tmp5);
    ...
    items[1] = closure_11(channel(4635).Text, { style: tmp.channelName, variant: "text-sm/semibold", children: channelName });
    obj.children = items;
