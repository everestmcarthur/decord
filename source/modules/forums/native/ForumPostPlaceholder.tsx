...
// Dependencies: [32, 19, 4632, 21, 4640, 576, 504, 4376, 4641, 5695, 2]

// Module 12178 (ForumPostPlaceholder)
...
export default noop.memo(() => {
  ...
  fn.__closure = { reducedMotion: stateFromStores, ROW_OPACITY_END, withDelay: stateFromStores(4376).withDelay, INITIAL_DELAY_MS: 1000, withRepeat: stateFromStores(4376).withRepeat, withSequence: stateFromStores(4376).withSequence, withTiming: stateFromStores(4641).withTiming, timingConfig };
  fn.__workletHash = 9488742940898;
  fn.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(fn);
  let obj4 = { style: animatedStyle, pointerEvents: "none", children: jsx(stateFromStores(5695).Card, { variant: "secondary", style: tmp.postPlaceholder }) };
  return jsx(timingConfig(4376).View, { style: animatedStyle, pointerEvents: "none", children: jsx(stateFromStores(5695).Card, { variant: "secondary", style: tmp.postPlaceholder }) });
});
