...
// Dependencies: [32, 19, 17, 4279, 4280, 1958, 1074, 21, 4640, 576, 504, 7418, 1478, 11406, 7993, 11568, 5210, 1115, 4590, 4636, 9927, 4582, 7570, 11, 4570, 11569, 2]
// Exports: default

// Module 11567 (ForumPostActionBar)
...
export default function ForumPostActionBar(channel) {
  ...
  let obj = channel(504);
  const firstMessage = channel(7418).useFirstForumPostMessage(channel).firstMessage;
  let obj2 = channel(7418);
  ...
  const items4 = [tmp.actionBarContainer, channel(7993).useGradientTop()];
  obj6.style = items4;
  ...
  if (tmp11) {
    ...
    obj7.children = closure_10(tmp2(11568).ForumPostActionBarReactions, obj8);
  ...
  if (stateFromStores2) {
    ...
    obj10.children = closure_10(tmp2(4582).LinkIcon, { size: "xs" });
    items7[1] = closure_10(tmp2(5210).PressableOpacity, obj10);
    ...
    obj11.children = closure_10(tmp2(11569).ArrowLargeUpIcon, { size: "xs" });
    items7[2] = closure_10(tmp2(5210).PressableOpacity, obj11);
    ...
    if (stateFromStores1) {
      ...
      intl = closure_10;
      items9 = [closure_10(tmp2(4590).CheckmarkLargeIcon, { size: "xs", color: "text-brand" }), ];
      Text = tmp2(4636).Text;
      ...
      obj12.style = tmp.actionButton;
      obj12.onPress = items9;
      const items11 = [closure_10(tmp2(9927).BellIcon, { size: "xs" }), ];
      ...
      items11[1] = closure_10(tmp2(4636).Text, obj14);
      obj12.children = items11;
      tmp15 = obj12;
    }
    tmp9(tmp2(5210).PressableOpacity, tmp15);
  }
};
