...
// Dependencies: [32, 19, 17, 4246, 4247, 1957, 1074, 21, 4607, 576, 504, 7378, 1477, 11348, 7946, 11510, 5175, 1114, 4558, 4603, 9869, 4550, 7530, 11, 4538, 11511, 2]
// Exports: default

// Module 11509 (ForumPostActionBar)
...
export default function ForumPostActionBar(channel) {
  ...
  let obj = channel(504);
  const firstMessage = channel(7378).useFirstForumPostMessage(channel).firstMessage;
  let obj2 = channel(7378);
  ...
  const items4 = [tmp.actionBarContainer, channel(7946).useGradientTop()];
  obj6.style = items4;
  ...
  if (tmp11) {
    ...
    obj7.children = closure_10(tmp2(11510).ForumPostActionBarReactions, obj8);
  ...
  if (stateFromStores2) {
    ...
    obj10.children = closure_10(tmp2(4550).LinkIcon, { size: "xs" });
    items7[1] = closure_10(tmp2(5175).PressableOpacity, obj10);
    ...
    obj11.children = closure_10(tmp2(11511).ArrowLargeUpIcon, { size: "xs" });
    items7[2] = closure_10(tmp2(5175).PressableOpacity, obj11);
    ...
    if (stateFromStores1) {
      ...
      intl = closure_10;
      items9 = [closure_10(tmp2(4558).CheckmarkLargeIcon, { size: "xs", color: "text-brand" }), ];
      Text = tmp2(4603).Text;
      ...
      obj12.style = tmp.actionButton;
      obj12.onPress = items9;
      const items11 = [closure_10(tmp2(9869).BellIcon, { size: "xs" }), ];
      ...
      items11[1] = closure_10(tmp2(4603).Text, obj14);
      obj12.children = items11;
      tmp15 = obj12;
    }
    tmp9(tmp2(5175).PressableOpacity, tmp15);
  }
};
