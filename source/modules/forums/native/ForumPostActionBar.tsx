...
// Dependencies: [32, 19, 17, 4244, 4245, 1957, 1074, 21, 4605, 576, 504, 7356, 1477, 11324, 7923, 11486, 5173, 1114, 4556, 4601, 9846, 4548, 7508, 11, 4536, 11487, 2]
// Exports: default

// Module 11485 (ForumPostActionBar)
...
export default function ForumPostActionBar(channel) {
  ...
  let obj = channel(504);
  const firstMessage = channel(7356).useFirstForumPostMessage(channel).firstMessage;
  let obj2 = channel(7356);
  ...
  const items4 = [tmp.actionBarContainer, channel(7923).useGradientTop()];
  obj6.style = items4;
  ...
  if (tmp11) {
    ...
    obj7.children = closure_10(tmp2(11486).ForumPostActionBarReactions, obj8);
  ...
  if (stateFromStores2) {
    ...
    obj10.children = closure_10(tmp2(4548).LinkIcon, { size: "xs" });
    items7[1] = closure_10(tmp2(5173).PressableOpacity, obj10);
    ...
    obj11.children = closure_10(tmp2(11487).ArrowLargeUpIcon, { size: "xs" });
    items7[2] = closure_10(tmp2(5173).PressableOpacity, obj11);
    ...
    if (stateFromStores1) {
      ...
      intl = closure_10;
      items9 = [closure_10(tmp2(4556).CheckmarkLargeIcon, { size: "xs", color: "text-brand" }), ];
      Text = tmp2(4601).Text;
      ...
      obj12.style = tmp.actionButton;
      obj12.onPress = items9;
      const items11 = [closure_10(tmp2(9846).BellIcon, { size: "xs" }), ];
      ...
      items11[1] = closure_10(tmp2(4601).Text, obj14);
      obj12.children = items11;
      tmp15 = obj12;
    }
    tmp9(tmp2(5173).PressableOpacity, tmp15);
  }
};
