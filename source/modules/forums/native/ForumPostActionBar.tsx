...
// Dependencies: [32, 19, 17, 4279, 4280, 1958, 1074, 21, 4639, 576, 504, 7411, 1478, 11390, 7978, 11552, 5207, 1115, 4590, 4635, 9908, 4582, 7563, 11, 4570, 11553, 2]
// Exports: default

// Module 11551 (ForumPostActionBar)
...
export default function ForumPostActionBar(channel) {
  ...
  let obj = channel(504);
  const firstMessage = channel(7411).useFirstForumPostMessage(channel).firstMessage;
  let obj2 = channel(7411);
  ...
  const items4 = [tmp.actionBarContainer, channel(7978).useGradientTop()];
  obj6.style = items4;
  ...
  if (tmp11) {
    ...
    obj7.children = closure_10(tmp2(11552).ForumPostActionBarReactions, obj8);
  ...
  if (stateFromStores2) {
    ...
    items7[1] = closure_10(tmp2(5207).PressableOpacity, obj10);
    ...
    obj11.children = closure_10(tmp2(11553).ArrowLargeUpIcon, { size: "xs" });
    items7[2] = closure_10(tmp2(5207).PressableOpacity, obj11);
    ...
    if (stateFromStores1) {
      ...
      obj12.style = tmp.actionButton;
      obj12.onPress = items9;
      const items11 = [closure_10(tmp2(9908).BellIcon, { size: "xs" }), ];
      ...
      items11[1] = closure_10(tmp2(4635).Text, obj14);
      obj12.children = items11;
      tmp15 = obj12;
    }
    tmp9(tmp2(5207).PressableOpacity, tmp15);
  }
};
