...
// Dependencies: [32, 19, 17, 4277, 4278, 1958, 1074, 21, 4638, 576, 504, 7414, 1478, 11398, 7987, 11560, 5208, 1115, 4588, 4634, 9916, 4580, 7566, 11, 4568, 11561, 2]
// Exports: default

// Module 11559 (ForumPostActionBar)
...
export default function ForumPostActionBar(channel) {
  ...
  let obj = channel(504);
  const firstMessage = channel(7414).useFirstForumPostMessage(channel).firstMessage;
  let obj2 = channel(7414);
  ...
  const items4 = [tmp.actionBarContainer, channel(7987).useGradientTop()];
  obj6.style = items4;
  ...
  if (tmp11) {
    ...
    obj7.children = closure_10(tmp2(11560).ForumPostActionBarReactions, obj8);
  ...
  if (stateFromStores2) {
    ...
    obj10.children = closure_10(tmp2(4580).LinkIcon, { size: "xs" });
    items7[1] = closure_10(tmp2(5208).PressableOpacity, obj10);
    ...
    obj11.children = closure_10(tmp2(11561).ArrowLargeUpIcon, { size: "xs" });
    items7[2] = closure_10(tmp2(5208).PressableOpacity, obj11);
    ...
    if (stateFromStores1) {
      ...
      intl = closure_10;
      items9 = [closure_10(tmp2(4588).CheckmarkLargeIcon, { size: "xs", color: "text-brand" }), ];
      Text = tmp2(4634).Text;
      ...
      obj12.style = tmp.actionButton;
      obj12.onPress = items9;
      const items11 = [closure_10(tmp2(9916).BellIcon, { size: "xs" }), ];
      ...
      items11[1] = closure_10(tmp2(4634).Text, obj14);
      obj12.children = items11;
      tmp15 = obj12;
    }
    tmp9(tmp2(5208).PressableOpacity, tmp15);
  }
};
