...
// Dependencies: [32, 19, 17, 5629, 1958, 1375, 21, 4722, 576, 1484, 504, 4718, 1115, 8103, 7573, 5142, 5857, 5775, 5292, 11374, 7326, 1397, 8997, 1177, 6809, 7396, 5067, 2]
// Exports: default

// Module 17235 (ChannelSettingsEditForumTag)
...
export default function ChannelSettingsEditForumTag(channelId) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return closure_10(channelId(4718).Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", children });
      }
    });
  }, items3);
  ...
  if (null != emoji) {
    if (null == emoji.name) {
      ...
      if (null != emoji) {
        const obj12 = {
          ...
          children: tmp27(tmp3(6809).CircleXIcon, { size: "xs" })
        };
        let tmp27Result = tmp27(tmp3(5292).PressableOpacity, obj12);
      } else {
        tmp27Result = null;
      }
      ...
      obj14.children = tmp27(tmp3(5775).TableRow, obj8);
      const items6 = [tmp27(tmp3(5857).TableRowGroup, obj14), ];
      ...
      obj15.children = tmp27(tmp3(4718).Text, obj16);
      ...
      obj18.children = tmp27(tmp3(7396).TableSwitchRow, obj17);
      items7[1] = tmp27(tmp3(5857).TableRowGroup, obj18);
      ...
      if (!tmp2) {
        ...
        obj19.children = tmp27(tmp3(5775).TableRow, obj20);
        tmp27Result3 = tmp27(tmp3(5857).TableRowGroup, obj19);
      }
      items7[2] = tmp27Result3;
      obj6.children = items7;
      obj5.children = tmp29(tmp3(5142).Stack, obj6);
    ...
    obj21.name = str2;
    tmp27Result4 = tmp27(tag(7326), obj21);
    tmp31 = tag;
    const tmp32 = tag(7326);
  }
  tmp27Result4 = tmp27(tmp3(8997).ReactionIcon, {});
};
