...
// Dependencies: [32, 19, 17, 5510, 1957, 1374, 21, 4606, 576, 1483, 504, 4602, 1114, 7972, 7450, 5024, 5738, 5656, 5174, 11216, 7203, 1396, 8848, 1178, 6687, 7273, 4951, 2]
// Exports: default

// Module 16941 (ChannelSettingsEditForumTag)
...
export default function ChannelSettingsEditForumTag(channelId) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return closure_10(channelId(4602).Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", children });
      }
    });
  }, items3);
  ...
  if (null != emoji) {
    if (null == emoji.name) {
      ...
      if (null != emoji) {
        const obj12 = {
          ...
          children: tmp27(tmp3(6687).CircleXIcon, { size: "xs" })
        };
        let tmp27Result = tmp27(tmp3(5174).PressableOpacity, obj12);
      } else {
        tmp27Result = null;
      }
      ...
      obj14.children = tmp27(tmp3(5656).TableRow, obj8);
      const items6 = [tmp27(tmp3(5738).TableRowGroup, obj14), ];
      ...
      obj15.children = tmp27(tmp3(4602).Text, obj16);
      ...
      obj18.children = tmp27(tmp3(7273).TableSwitchRow, obj17);
      items7[1] = tmp27(tmp3(5738).TableRowGroup, obj18);
      ...
      if (!tmp2) {
        ...
        obj19.children = tmp27(tmp3(5656).TableRow, obj20);
        tmp27Result3 = tmp27(tmp3(5738).TableRowGroup, obj19);
      }
      items7[2] = tmp27Result3;
      obj6.children = items7;
      obj5.children = tmp29(tmp3(5024).Stack, obj6);
    ...
    obj21.name = str2;
    tmp27Result4 = tmp27(tag(7203), obj21);
    tmp31 = tag;
    const tmp32 = tag(7203);
  }
  tmp27Result4 = tmp27(tmp3(8848).ReactionIcon, {});
};
