...
// Dependencies: [32, 19, 17, 5547, 1958, 1375, 21, 4640, 576, 1484, 504, 4636, 1115, 8020, 7491, 5060, 5775, 5693, 5210, 11282, 7244, 1397, 8913, 1177, 6727, 7314, 4985, 2]
// Exports: default

// Module 17104 (ChannelSettingsEditForumTag)
...
export default function ChannelSettingsEditForumTag(channelId) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return closure_10(channelId(4636).Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", children });
      }
    });
  }, items3);
  ...
  if (null != emoji) {
    if (null == emoji.name) {
      ...
      if (null != emoji) {
        const obj12 = {
          ...
          children: tmp27(tmp3(6727).CircleXIcon, { size: "xs" })
        };
        let tmp27Result = tmp27(tmp3(5210).PressableOpacity, obj12);
      } else {
        tmp27Result = null;
      }
      ...
      obj14.children = tmp27(tmp3(5693).TableRow, obj8);
      const items6 = [tmp27(tmp3(5775).TableRowGroup, obj14), ];
      ...
      obj15.children = tmp27(tmp3(4636).Text, obj16);
      ...
      obj18.children = tmp27(tmp3(7314).TableSwitchRow, obj17);
      items7[1] = tmp27(tmp3(5775).TableRowGroup, obj18);
      ...
      if (!tmp2) {
        ...
        obj19.children = tmp27(tmp3(5693).TableRow, obj20);
        tmp27Result3 = tmp27(tmp3(5775).TableRowGroup, obj19);
      }
      items7[2] = tmp27Result3;
      obj6.children = items7;
      obj5.children = tmp29(tmp3(5060).Stack, obj6);
    ...
    obj21.name = str2;
    tmp27Result4 = tmp27(tag(7244), obj21);
    tmp31 = tag;
    const tmp32 = tag(7244);
  }
  tmp27Result4 = tmp27(tmp3(8913).ReactionIcon, {});
};
