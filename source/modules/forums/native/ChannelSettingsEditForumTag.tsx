...
// Dependencies: [32, 19, 17, 5511, 1957, 1374, 21, 4607, 576, 1483, 504, 4603, 1114, 7973, 7451, 5025, 5739, 5657, 5175, 11218, 7204, 1396, 8850, 1178, 6688, 7274, 4952, 2]
// Exports: default
...
export default function ChannelSettingsEditForumTag(channelId) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return closure_10(channelId(4603).Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", children });
      }
    });
  }, items3);
  ...
  if (null != emoji) {
    if (null == emoji.name) {
      ...
      if (null != emoji) {
        const obj12 = {
          ...
          children: tmp27(tmp3(6688).CircleXIcon, { size: "xs" })
        };
        let tmp27Result = tmp27(tmp3(5175).PressableOpacity, obj12);
      } else {
        tmp27Result = null;
      }
      ...
      obj14.children = tmp27(tmp3(5657).TableRow, obj8);
      const items6 = [tmp27(tmp3(5739).TableRowGroup, obj14), ];
      ...
      obj15.children = tmp27(tmp3(4603).Text, obj16);
      ...
      obj18.children = tmp27(tmp3(7274).TableSwitchRow, obj17);
      items7[1] = tmp27(tmp3(5739).TableRowGroup, obj18);
      ...
      if (!tmp2) {
        ...
        obj19.children = tmp27(tmp3(5657).TableRow, obj20);
        tmp27Result3 = tmp27(tmp3(5739).TableRowGroup, obj19);
      }
      items7[2] = tmp27Result3;
      obj6.children = items7;
      obj5.children = tmp29(tmp3(5025).Stack, obj6);
    ...
    obj21.name = str2;
    tmp27Result4 = tmp27(tag(7204), obj21);
    tmp31 = tag;
    const tmp32 = tag(7204);
  }
  tmp27Result4 = tmp27(tmp3(8850).ReactionIcon, {});
};
