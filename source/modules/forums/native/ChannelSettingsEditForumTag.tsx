...
// Dependencies: [32, 19, 17, 5473, 1957, 1374, 21, 4574, 576, 1483, 504, 4570, 1114, 7912, 7391, 4987, 5701, 5619, 5137, 11153, 7144, 1396, 8790, 1178, 6630, 7214, 4919, 2]
// Exports: default
  ...
  if (null != emoji) {
    if (null == emoji.name) {
      ...
      if (null != emoji) {
        ...
        let tmp27Result = tmp27(tmp3(5137).PressableOpacity, obj12);
      } else {
        tmp27Result = null;
      }
      ...
      obj14.children = tmp27(tmp3(5619).TableRow, obj8);
      const items6 = [tmp27(tmp3(5701).TableRowGroup, obj14), ];
      ...
      obj15.children = tmp27(tmp3(4570).Text, obj16);
      ...
      obj18.children = tmp27(tmp3(7214).TableSwitchRow, obj17);
      items7[1] = tmp27(tmp3(5701).TableRowGroup, obj18);
      ...
      if (!tmp2) {
        ...
        obj19.children = tmp27(tmp3(5619).TableRow, obj20);
        tmp27Result3 = tmp27(tmp3(5701).TableRowGroup, obj19);
      }
      items7[2] = tmp27Result3;
      obj6.children = items7;
      obj5.children = tmp29(tmp3(4987).Stack, obj6);
    ...
    obj21.name = str2;
    tmp27Result4 = tmp27(tag(7144), obj21);
    tmp31 = tag;
    const tmp32 = tag(7144);
  }
  tmp27Result4 = tmp27(tmp3(8790).ReactionIcon, {});
};
