...
// Dependencies: [32, 19, 17, 5545, 1958, 1375, 21, 4638, 576, 1484, 504, 4634, 1115, 8014, 7487, 5058, 5773, 5691, 5208, 11274, 7240, 1397, 8897, 1177, 6724, 7310, 4983, 2]
// Exports: default

// Module 17065 (ChannelSettingsEditForumTag)
...
export default function ChannelSettingsEditForumTag(channelId) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return closure_10(channelId(4634).Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", children });
      }
    });
  }, items3);
  ...
  if (null != emoji) {
    if (null == emoji.name) {
      ...
      if (null != emoji) {
        const obj12 = {
          ...
          children: tmp27(tmp3(6724).CircleXIcon, { size: "xs" })
        };
        let tmp27Result = tmp27(tmp3(5208).PressableOpacity, obj12);
      } else {
        tmp27Result = null;
      }
      ...
      obj14.children = tmp27(tmp3(5691).TableRow, obj8);
      const items6 = [tmp27(tmp3(5773).TableRowGroup, obj14), ];
      ...
      obj15.children = tmp27(tmp3(4634).Text, obj16);
      ...
      obj18.children = tmp27(tmp3(7310).TableSwitchRow, obj17);
      items7[1] = tmp27(tmp3(5773).TableRowGroup, obj18);
      ...
      if (!tmp2) {
        ...
        obj19.children = tmp27(tmp3(5691).TableRow, obj20);
        tmp27Result3 = tmp27(tmp3(5773).TableRowGroup, obj19);
      }
      items7[2] = tmp27Result3;
      obj6.children = items7;
      obj5.children = tmp29(tmp3(5058).Stack, obj6);
    ...
    obj21.name = str2;
    tmp27Result4 = tmp27(tag(7240), obj21);
    tmp31 = tag;
    const tmp32 = tag(7240);
  }
  tmp27Result4 = tmp27(tmp3(8897).ReactionIcon, {});
};
