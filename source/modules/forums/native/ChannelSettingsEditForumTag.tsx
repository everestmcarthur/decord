...
// Dependencies: [32, 19, 17, 5509, 1957, 1374, 21, 4605, 576, 1483, 504, 4601, 1114, 7950, 7429, 5023, 5737, 5655, 5173, 11193, 7182, 1396, 8827, 1178, 6666, 7252, 4950, 2]
// Exports: default
  ...
  if (null != emoji) {
    if (null == emoji.name) {
      ...
      if (null != emoji) {
        ...
        let tmp27Result = tmp27(tmp3(5173).PressableOpacity, obj12);
      } else {
        tmp27Result = null;
      }
      ...
      obj14.children = tmp27(tmp3(5655).TableRow, obj8);
      const items6 = [tmp27(tmp3(5737).TableRowGroup, obj14), ];
      ...
      obj15.children = tmp27(tmp3(4601).Text, obj16);
      ...
      obj18.children = tmp27(tmp3(7252).TableSwitchRow, obj17);
      items7[1] = tmp27(tmp3(5737).TableRowGroup, obj18);
      ...
      if (!tmp2) {
        ...
        obj19.children = tmp27(tmp3(5655).TableRow, obj20);
        tmp27Result3 = tmp27(tmp3(5737).TableRowGroup, obj19);
      }
      items7[2] = tmp27Result3;
      obj6.children = items7;
      obj5.children = tmp29(tmp3(5023).Stack, obj6);
    ...
    obj21.name = str2;
    tmp27Result4 = tmp27(tag(7182), obj21);
    tmp31 = tag;
    const tmp32 = tag(7182);
  }
  tmp27Result4 = tmp27(tmp3(8827).ReactionIcon, {});
};
