...
// Function ID: 7900
// Name: ForumHooks
// Dependencies: [5, 19, 5473, 5520, 5521, 7320, 1957, 5440, 1979, 4212, 4589, 1371, 7319, 7291, 7900, 7782, 7287, 1074, 1964, 1113, 504, 7321, 573, 12, 1369, 5006, 11, 7795, 1966, 7901, 4807, 7902, 7911, 7912, 7124, 2]
...
export const useLastActiveTimestamp = function useLastActiveTimestamp(thread, sortOrder, format) {
  ...
  return lastMessageTimestamp.useMemo(() => {
    if (closure_1 === ThreadSortOrder.ThreadSortOrder.CREATION_DATE) {
      let timestampString = tmp(7795).getTimestampString(memo, memo1);
      const tmpResult = tmp(7795);
    } else {
      timestampString = tmp(7795).getTimestampString(lastMessageTimestamp, memo1);
...
export const useForumPostMessageAuthor = function useForumPostMessageAuthor(message, thread) {
  ...
  const obj = id(504);
  const nullableMessageAuthor = id(4807).useNullableMessageAuthor(message);
