...
// Function ID: 11763
// Name: FeedbackForm
// Dependencies: [32, 19, 11760, 21, 4639, 576, 8393, 12, 11763, 5076, 8719, 4635, 5692, 11764, 1115, 2]
// Exports: FeedbackForm

// Module 11762 (FeedbackForm)
...
require = fn;
let FeedbackRating = fn(11760).FeedbackRating;
const jsxProd = fn(21);
