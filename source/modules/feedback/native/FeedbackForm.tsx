...
// Function ID: 11724
// Name: FeedbackForm
// Dependencies: [32, 19, 11721, 21, 4607, 576, 8360, 12, 11724, 5044, 8686, 4603, 5659, 11725, 1114, 2]
// Exports: FeedbackForm

// Module 11723 (FeedbackForm)
...
require = fn;
let FeedbackRating = fn(11721).FeedbackRating;
const jsxProd = fn(21);
