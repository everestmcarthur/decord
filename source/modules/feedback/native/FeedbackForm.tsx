...
// Function ID: 11779
// Name: FeedbackForm
// Dependencies: [32, 19, 11776, 21, 4640, 576, 8421, 12, 11779, 5079, 8748, 4636, 5695, 11780, 1115, 2]
// Exports: FeedbackForm

// Module 11778 (FeedbackForm)
...
require = fn;
let FeedbackRating = fn(11776).FeedbackRating;
const jsxProd = fn(21);
