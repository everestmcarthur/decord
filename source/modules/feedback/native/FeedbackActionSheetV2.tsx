...
// Dependencies: [32, 19, 17, 11719, 21, 4606, 576, 4573, 12, 8358, 5043, 4809, 11741, 1896, 1114, 4602, 11723, 5655, 5738, 5656, 5026, 1611, 7223, 7222, 7271, 6698, 2]
// Exports: default

// Module 17437 (FeedbackActionSheetV2)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5043).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11741, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11741, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4602).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11723), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5655).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5656).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5738).TableRowGroup, obj10);
        ...
        items3[1] = closure_7(tmp20(5026).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5738).TableRowGroup, obj14);
      ...
      items4[1] = closure_7(tmp20(5026).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7271).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7222).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6698).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7223).BottomSheet, obj16);
};
