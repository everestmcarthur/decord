...
// Dependencies: [32, 19, 17, 11721, 21, 4607, 576, 4574, 12, 8360, 5044, 4810, 11743, 1896, 1114, 4603, 11725, 5656, 5739, 5657, 5027, 1611, 7224, 7223, 7272, 6699, 2]
// Exports: default

// Module 17438 (FeedbackActionSheetV2)
...
const FeedbackRating = fn(11721).FeedbackRating;
const jsxProd = fn(21);
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5044).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11743, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11743, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4603).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11725), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      obj6.label = intl3.string(tmp20(1114).t["5E9SB9"]);
      obj6.onPress = function onPress() {
        return closure_9(!first1);
      };
      tmp37Result = tmp37(tmp20(5656).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5657).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5739).TableRowGroup, obj10);
        ...
        obj11.text = intl2.string(tmp20(1114).t["13/7kX"]);
        obj11.onPress = function onPress() {
          return closure_11(null);
        };
        items3[1] = closure_7(tmp20(5027).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5739).TableRowGroup, obj14);
      ...
      obj15.text = intl.string(tmp20(1114).t["13/7kX"]);
      ...
      items4[1] = closure_7(tmp20(5027).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7272).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7223).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6699).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7224).BottomSheet, obj16);
};
