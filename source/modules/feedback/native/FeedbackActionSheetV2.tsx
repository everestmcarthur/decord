...
// Dependencies: [32, 19, 17, 11768, 21, 4638, 576, 4605, 12, 8402, 5077, 4841, 11790, 1897, 1115, 4634, 11772, 5690, 5773, 5691, 5060, 1612, 7260, 7259, 7308, 6735, 2]
// Exports: default

// Module 17563 (FeedbackActionSheetV2)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5077).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11790, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11790, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4634).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11772), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5690).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5691).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5773).TableRowGroup, obj10);
        ...
        items3[1] = closure_7(tmp20(5060).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5773).TableRowGroup, obj14);
      ...
      items4[1] = closure_7(tmp20(5060).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7308).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7259).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6735).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7260).BottomSheet, obj16);
};
