...
// Dependencies: [32, 19, 17, 11697, 21, 4605, 576, 4572, 12, 8337, 5042, 4808, 11719, 1896, 1114, 4601, 11701, 5654, 5737, 5655, 5025, 1611, 7202, 7201, 7250, 6677, 2]
// Exports: default

// Module 17447 (FeedbackActionSheetV2)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5042).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11719, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11719, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4601).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11701), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5654).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5655).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5737).TableRowGroup, obj10);
        ...
        items3[1] = closure_7(tmp20(5025).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5737).TableRowGroup, obj14);
      ...
      items4[1] = closure_7(tmp20(5025).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7250).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7201).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6677).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7202).BottomSheet, obj16);
};
