...
// Dependencies: [32, 19, 17, 11866, 21, 4722, 576, 4689, 12, 8504, 5161, 4925, 11888, 1897, 1115, 4718, 11870, 5774, 5857, 5775, 5144, 1612, 7346, 7345, 7394, 6820, 2]
// Exports: default

// Module 16922 (FeedbackActionSheetV2)
...
const FeedbackRating = fn(11866).FeedbackRating;
const jsxProd = fn(21);
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5161).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11888, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11888, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4718).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11870), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5774).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5775).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5857).TableRowGroup, obj10);
        ...
        items3[1] = closure_7(tmp20(5144).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5857).TableRowGroup, obj14);
      ...
      items4[1] = closure_7(tmp20(5144).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7394).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7345).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6820).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7346).BottomSheet, obj16);
};
