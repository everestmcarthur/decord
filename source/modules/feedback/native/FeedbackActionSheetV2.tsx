...
// Dependencies: [32, 19, 17, 11760, 21, 4639, 576, 4606, 12, 8393, 5076, 4842, 11782, 1897, 1115, 4635, 11764, 5689, 5772, 5690, 5059, 1612, 7257, 7256, 7305, 6732, 2]
// Exports: default

// Module 17507 (FeedbackActionSheetV2)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5076).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11782, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11782, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4635).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11764), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5689).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5690).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5772).TableRowGroup, obj10);
        ...
        items3[1] = closure_7(tmp20(5059).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5772).TableRowGroup, obj14);
      ...
      items4[1] = closure_7(tmp20(5059).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7305).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7256).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6732).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7257).BottomSheet, obj16);
};
