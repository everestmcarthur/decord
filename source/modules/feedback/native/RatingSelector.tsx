...
// Function ID: 11765
// Name: RatingSelector
// Dependencies: [19, 17, 11760, 21, 4639, 11765, 11766, 1115, 11770, 11771, 11775, 11776, 8721, 5207, 2]
// Exports: default

// Module 11764 (RatingSelector)
import _modDef11765 from "module_11765" /* 11765 */;
import _modDef11770 from "module_11770" /* 11770 */;
import _modDef11775 from "module_11775" /* 11775 */;
...
export default function RatingSelector(ratingOptions) {
  ...
  let obj3 = { selected: _modDef11765, normal: null };
  tmp = closure_9();
  obj3.normal = textLabels(11766).useFeedbackModalSadDesaturatedSource();
  obj2.source = obj3;
  ...
  let obj6 = { selected: _modDef11770, normal: null };
  let obj4 = textLabels(11766);
  obj6.normal = textLabels(11771).useFeedbackModalNeutralDesaturatedSource();
  obj5.source = obj6;
  ...
  const obj9 = { selected: _modDef11775, normal: null };
  let obj7 = textLabels(11771);
  obj9.normal = textLabels(11776).useFeedbackModalHappyDesaturatedSource();
  obj8.source = obj9;
  ...
  return <closure_3 style={tmp2.ratings}>{mapped.map((rating) => {
    ...
    if (null != rating) {
      ...
      obj.children = jsx(textLabels(8721).RowButton, { accessibilityRole: "button", accessibilityLabel: getLabel(), accessibilityState: null, onPress: null, icon: null, label: null });
      ...
      tmp14Result = jsx(textLabels(5207).PressableOpacity, { accessibilityRole: "button", accessibilityLabel: getLabel(), accessibilityState: null, onPress: null, children: null }, rating);
    }
    return tmp14Result;
  })}</closure_3>;
};
