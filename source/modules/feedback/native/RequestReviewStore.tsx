...
// Dependencies: [4555, 1235, 2012, 1074, 13808, 4669, 13809, 4498, 4497, 6736, 13811, 1094, 510, 1241, 504, 573, 2]

// Module 13807 (RequestReviewStore)
...
import RequestReviewNoTTIExperiment2 from "RequestReviewNoTTIExperiment" /* 13808 */;
import requestReviewModalDefault from "requestReviewModal" /* 13809 */;
import InstallTime from "InstallTime" /* 13811 */;
...
function showReviewRequestModal() {
  ...
  if (tmp3) {
    tmp3 = null != tmp(4497).coerceGuildsRoute(rootNavigationRef.getCurrentRoute());
  ...
  const RequestReviewNoTTIExperiment = tmp(13808).RequestReviewNoTTIExperiment;
  ...
  if (tmp18) {
    ...
    timeout = setTimeout(showReviewRequestModal, tmp(4669).MS_PER_MINUTE);
  }
}
