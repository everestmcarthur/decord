...
// Dependencies: [7321, 4662, 17504, 11760, 7320, 1936, 510, 12, 17505, 7225, 2]

// Module 17503 (feedback/FeedbackManager)
import _mod12 from "module_12" /* 12 */;
import UserSettings from "UserSettings" /* 1936 */;
import SearchResultsFeedbackExperiment from "SearchResultsFeedbackExperiment" /* 17505 */;
import HotspotStore from "hotspot/HotspotStore" /* 7321 */;
import RTCConnectionStore from "RTCConnectionStore" /* 4662 */;
import FeedbackOverrideStore from "FeedbackOverrideStore" /* 17504 */;
...
function recencyEligibilityCheck(cooldown, storageKey) {
  ...
  if (!isNaNResult) {
    const InAppFeedbackStates2 = tmp(1936).InAppFeedbackStates;
    InAppFeedbackStates2.updateSetting((arg0) => {
      const obj = {};
      const merged = Object.assign(arg0);
      obj2 = {};
...
obj3.hotspot = fn(7320).HotspotLocations.VOICE_CALL_FEEDBACK;
...
obj4.hotspot = fn(7320).HotspotLocations.REPORT_PROBLEM_POST_STREAM;
...
obj5.hotspot = fn(7320).HotspotLocations.VIDEO_BACKGROUND_FEEDBACK;
...
obj2[FeedbackType.ACTIVITY] = { cooldown: 0, chance: 0.5, group: FeedbackGroup.AV, hotspot: fn(7320).HotspotLocations.POST_ACTIVITY_FEEDBACK, storageKey: "lastActivityFeedback", feedbackType: FeedbackType.ACTIVITY };
const obj6 = { cooldown: 0, chance: 0.5, group: FeedbackGroup.AV, hotspot: fn(7320).HotspotLocations.POST_ACTIVITY_FEEDBACK, storageKey: "lastActivityFeedback", feedbackType: FeedbackType.ACTIVITY };
obj2[FeedbackType.IN_APP_REPORTS] = { cooldown: 172800000, chance: 0.5, group: FeedbackGroup.SAFETY, hotspot: fn(7320).HotspotLocations.IN_APP_REPORTS_FEEDBACK, storageKey: "inAppReportsFeedback", feedbackType: FeedbackType.IN_APP_REPORTS };
const obj8 = {};
const merged3 = Object.assign(obj);
obj8.group = FeedbackGroup.SEARCH;
obj8.hotspot = fn(7320).HotspotLocations.SEARCH_RESULTS_FEEDBACK;
...
const obj7 = { cooldown: 172800000, chance: 0.5, group: FeedbackGroup.SAFETY, hotspot: fn(7320).HotspotLocations.IN_APP_REPORTS_FEEDBACK, storageKey: "inAppReportsFeedback", feedbackType: FeedbackType.IN_APP_REPORTS };
obj2[FeedbackType.VIBEGRATIONS] = { cooldown: 3600000, chance: 1, group: FeedbackGroup.BUILDER, hotspot: fn(7320).HotspotLocations.VIBEGRATIONS_FEEDBACK, storageKey: "lastVibegrationsFeedback", feedbackType: FeedbackType.VIBEGRATIONS };
