...
// Dependencies: [32, 19, 17, 14804, 1955, 21, 4640, 576, 1944, 14837, 14843, 8560, 14838, 7502, 4594, 4636, 1115, 5210, 5768, 14875, 5062, 2]
// Exports: TinyBroncoAgeGroupHeader

// Module 14842 (TinyBroncoAgeGroupHeader)
...
import _modDef14843 from "module_14843" /* 14843 */;
...
function AccountStatusNotice(arg0) {
  ...
  if (shouldShowAgeNotice) {
    ...
    if (null != tmp5[0]) {
      ...
      items[1] = closure_8(tmp2(4636).Text, obj5);
      ...
      obj7.onPress = tmp7;
      obj7.children = closure_8(tmp2(5768).XSmallIcon, { size: "sm", color: "icon-strong" });
      items[2] = closure_8(tmp2(5210).PressableOpacity, obj7);
      obj3.children = items;
...
function AgeGroupDescription(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const obj3 = { handleOnAgeGatedContentHook: tmp(14837).handleOpenAgeGatedContentArticle };
    obj2.children = intl3.format(_modDef14843.gi4ulu, obj3);
    return React6(tmp(4636).Text, obj2);
  } else if (tmp(14837).AgeGroupState.TEEN === ageGroup) {
    const obj4 = { variant: "text-sm/normal", color: "text-default", children: null };
    const intl2 = tmp(1115).intl;
    const obj5 = { handleOnAgeGatedContentHook: tmp(14837).handleOpenAgeGatedContentArticle, handleOnConfirmAgeHook: tmp(14837).handleShowAgeVerification };
    obj4.children = intl2.format(_modDef14843["221iML"], obj5);
    return React6(tmp(4636).Text, obj4);
  } else if (tmp(14837).AgeGroupState.UNVERIFIED === ageGroup) {
    const obj = { variant: "text-sm/normal", color: "text-default", children: null };
    const intl = tmp(1115).intl;
    obj6 = { handleOnAgeGatedContentHook: tmp(14875).handleOpenUnconfirmedAgeGroupSupportArticle, handleOnConfirmAgeHook: tmp(14837).handleShowAgeVerification };
    obj.children = intl.format(_modDef14843["W0/7DD"], obj6);
    return React6(tmp(4636).Text, obj);
  }
}
function AgeGroupCallToAction(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const intl2 = tmp(1115).intl;
    obj2.text = intl2.string(_modDef14843["+7NlgO"]);
    obj2.onPress = tmp(14837).handleOpenAgeGatedContentArticle;
    return React6(tmp(5062).Button, obj2);
  } else if (tmp(14837).AgeGroupState.UNVERIFIED === ageGroup) {
    const obj = { grow: true, variant: "secondary", size: "md", text: null, onPress: null };
    const intl = tmp(1115).intl;
    obj.text = intl.string(_modDef14843["cI+bc/"]);
    obj.onPress = tmp(14837).handleShowAgeVerification;
    return React6(tmp(5062).Button, obj);
  }
}
const View = fn(17).View;
const TINY_BRONCO_BLOG_URL = fn(14804).TINY_BRONCO_BLOG_URL;
...
let closure_12 = [];
let obj6 = {};
obj6[fn(14837).AgeGroupState.ADULT] = _modDef14843["8TWztV"];
obj6[fn(14837).AgeGroupState.TEEN] = _modDef14843.qSkhZH;
obj6[fn(14837).AgeGroupState.UNVERIFIED] = _modDef14843.vGxRDB;
let obj7 = {};
obj7[fn(14837).AgeGroupState.ADULT] = _modDef14843.t5QjmQ;
obj7[fn(14837).AgeGroupState.TEEN] = _modDef14843["41MDhK"];
obj7[fn(14837).AgeGroupState.UNVERIFIED] = _modDef14843.m95jW8;
const size = fn(2);
