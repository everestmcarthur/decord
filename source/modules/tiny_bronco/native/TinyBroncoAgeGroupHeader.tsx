...
// Dependencies: [32, 19, 17, 14712, 1954, 21, 4574, 576, 1943, 14745, 14751, 8439, 14746, 7402, 4529, 4570, 1114, 5137, 5694, 14783, 4989, 2]
// Exports: TinyBroncoAgeGroupHeader

// Module 14750 (TinyBroncoAgeGroupHeader)
...
import _modDef14751 from "module_14751" /* 14751 */;
...
function AccountStatusNotice(arg0) {
  ...
  if (shouldShowTinyBroncoAccountStatus) {
    ...
    if (null != tmp5[0]) {
      ...
      const obj4 = { style: tmp.noticeIcon, children: closure_8(tmp2(4529).CircleInformationIcon, { size: "xs", color: "text-link" }) };
      ...
      items[1] = closure_8(tmp2(4570).Text, obj5);
      ...
      obj7.onPress = tmp7;
      obj7.children = closure_8(tmp2(5694).XSmallIcon, { size: "sm", color: "icon-strong" });
      items[2] = closure_8(tmp2(5137).PressableOpacity, obj7);
      obj3.children = items;
...
function AgeGroupDescription(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const obj3 = { handleOnAgeGatedContentHook: tmp(14783).handleOpenAgeGatedContentSupportArticle };
    obj2.children = intl3.format(_modDef14751.gi4ulu, obj3);
    return React6(tmp(4570).Text, obj2);
  } else if (tmp(14745).AgeGroupState.TEEN === ageGroup) {
    const obj4 = { variant: "text-sm/normal", color: "text-default", children: null };
    const intl2 = tmp(1114).intl;
    const obj5 = { handleOnAgeGatedContentHook: tmp(14783).handleOpenAgeGatedContentSupportArticle, handleOnConfirmAgeHook: tmp(14745).handleShowAgeVerification };
    obj4.children = intl2.format(_modDef14751["221iML"], obj5);
    return React6(tmp(4570).Text, obj4);
  } else if (tmp(14745).AgeGroupState.UNVERIFIED === ageGroup) {
    const obj = { variant: "text-sm/normal", color: "text-default", children: null };
    const intl = tmp(1114).intl;
    obj6 = { handleOnAgeGatedContentHook: tmp(14783).handleOpenAgeGatedContentSupportArticle, handleOnConfirmAgeHook: tmp(14745).handleShowAgeVerification };
    obj.children = intl.format(_modDef14751["W0/7DD"], obj6);
    return React6(tmp(4570).Text, obj);
  }
}
function AgeGroupCallToAction(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const intl2 = tmp(1114).intl;
    obj2.text = intl2.string(_modDef14751["+7NlgO"]);
    obj2.onPress = tmp(14783).handleOpenAgeGatedContentSupportArticle;
    return React6(tmp(4989).Button, obj2);
  } else if (tmp(14745).AgeGroupState.UNVERIFIED === ageGroup) {
    const obj = { grow: true, variant: "secondary", size: "md", text: null, onPress: null };
    const intl = tmp(1114).intl;
    obj.text = intl.string(_modDef14751["cI+bc/"]);
    obj.onPress = tmp(14745).handleShowAgeVerification;
    return React6(tmp(4989).Button, obj);
  }
}
const View = fn(17).View;
const TINY_BRONCO_BLOG_URL = fn(14712).TINY_BRONCO_BLOG_URL;
...
let closure_12 = [];
let obj6 = {};
obj6[fn(14745).AgeGroupState.ADULT] = _modDef14751["8TWztV"];
obj6[fn(14745).AgeGroupState.TEEN] = _modDef14751.qSkhZH;
obj6[fn(14745).AgeGroupState.UNVERIFIED] = _modDef14751.vGxRDB;
let obj7 = {};
obj7[fn(14745).AgeGroupState.ADULT] = _modDef14751.t5QjmQ;
obj7[fn(14745).AgeGroupState.TEEN] = _modDef14751["41MDhK"];
obj7[fn(14745).AgeGroupState.UNVERIFIED] = _modDef14751.m95jW8;
const size = fn(2);
