...
// Dependencies: [5, 4459, 3, 7757, 12, 1987, 1091, 2]

// Module 7764 (NonGuildVersions)
          ...
          databaseResult.transaction((database) => {
            ...
            if (null != guildId) {
              ...
              if (!isNaN(Number(guildId))) {
                const result = closure_1_1(1987).nonGuildVersionsTransaction(database);
                const obj2 = { id: "initial_guild_id", versionString: guildId };
                result.put(obj2);
                const obj = closure_1_1(1987);
              }
            }
            const result1 = closure_1_1(1987).nonGuildVersionsTransaction(database);
