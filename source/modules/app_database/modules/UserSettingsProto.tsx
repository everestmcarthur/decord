...
// Dependencies: [5, 1220, 502, 3, 1987, 2004, 12, 2]

// Module 7599 (UserSettingsProto)
    ...
    obj1.handleUserSettingsProtoChange = function handleUserSettingsProtoChange() {
      ...
      if (databaseResult != null) {
        databaseResult.transaction((database) => {
          ...
          const result = closure_1_0(1987).userSettingsTransaction(database);
          ...
          obj = closure_1_0(1987);
          const result1 = closure_1_0(1987).nonGuildVersionsTransaction(database);
