...
export default function getNotificationCenterItemBody(arg0) {
  ...
  if (NotificationCenterItemsTypes.NotificationCenterLocalItems.FRIEND_REQUESTS_GROUPED === type) {
    ...
    const name2 = tmp2(4481).getName(obj2.getUser(id2));
    ...
    let num;
    const name3 = tmp2(4481).getName(obj2.getUser(id3));
  ...
  } else if (tmp6(7742).NotificationCenterLocalItems.MOBILE_NATIVE_UPDATE_AVAILABLE === type) {
    let str7;
  ...
  } else if (tmp6(7742).NotificationCenterItems.FRIEND_SUGGESTION_CREATED === type) {
    ...
    return str5;
  } else if (tmp6(7742).NotificationCenterItems.GUILD_SCHEDULED_EVENT_STARTED === type) {
  ...
  } else if (tmp6(7742).NotificationCenterLocalItems.INCOMING_FRIEND_REQUESTS === type) {
  ...
  } else if (tmp6(7742).NotificationCenterLocalItems.INCOMING_FRIEND_REQUESTS_ACCEPTED === type) {
    if (null != applicationId) {
  ...
  } else if (tmp6(7742).NotificationCenterItems.FRIEND_REQUEST_ACCEPTED === type) {
    if (null != applicationId) {
  ...
  } else if (tmp6(7742).NotificationCenterLocalItems.INCOMING_GAME_FRIEND_REQUESTS_ACCEPTED === type) {
  ...
  } else if (tmp6(7742).NotificationCenterLocalItems.INCOMING_GAME_FRIEND_REQUESTS === type) {
  ...
  } else if (tmp6(7742).NotificationCenterItems.GAME_FRIEND_REQUEST_ACCEPTED === type) {
    if (null == applicationId) {
      let body = item.body;
    } else {
