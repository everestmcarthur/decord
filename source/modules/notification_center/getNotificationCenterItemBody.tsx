...
// Dependencies: [7640, 1980, 4288, 1372, 1074, 1115, 4484, 7754, 1926, 38, 2]
// Exports: default, getFriendRequestSentBody

// Module 16584 (getNotificationCenterItemBody)
...
export default function getNotificationCenterItemBody(arg0) {
  ...
  if (NotificationCenterItemsTypes.NotificationCenterLocalItems.FRIEND_REQUESTS_GROUPED === type) {
    ...
    const name2 = tmp2(4484).getName(obj2.getUser(id2));
    ...
    let num;
    const name3 = tmp2(4484).getName(obj2.getUser(id3));
  ...
  } else if (tmp6(7754).NotificationCenterLocalItems.MOBILE_NATIVE_UPDATE_AVAILABLE === type) {
    let str7;
  ...
  } else if (tmp6(7754).NotificationCenterItems.FRIEND_SUGGESTION_CREATED === type) {
    ...
    return str5;
  } else if (tmp6(7754).NotificationCenterItems.GUILD_SCHEDULED_EVENT_STARTED === type) {
    ...
    formatResult = str4;
    tmp6Result = tmp6(1926);
  } else if (tmp6(7754).NotificationCenterLocalItems.INCOMING_FRIEND_REQUESTS === type) {
  ...
  } else if (tmp6(7754).NotificationCenterLocalItems.INCOMING_FRIEND_REQUESTS_ACCEPTED === type) {
    if (null != applicationId) {
  ...
  } else if (tmp6(7754).NotificationCenterItems.FRIEND_REQUEST_ACCEPTED === type) {
    if (null != applicationId) {
  ...
  } else if (tmp6(7754).NotificationCenterLocalItems.INCOMING_GAME_FRIEND_REQUESTS_ACCEPTED === type) {
  ...
  } else if (tmp6(7754).NotificationCenterLocalItems.INCOMING_GAME_FRIEND_REQUESTS === type) {
  ...
  } else if (tmp6(7754).NotificationCenterItems.GAME_FRIEND_REQUEST_ACCEPTED === type) {
    if (null == applicationId) {
      let body = item.body;
    } else {
