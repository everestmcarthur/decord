...
// Dependencies: [19, 17, 21, 4639, 576, 1177, 10785, 4635, 1115, 2]
// Exports: ForYouUnreadClearedState

// Module 16556 (ForYouUnreadClearedState)
...
export const ForYouUnreadClearedState = function ForYouUnreadClearedState() {
  ...
  const items = [React4(View, { style: tmp.imageContainer }), React4(native.Icon, { source: _modDef10785, style: tmp.icon, color: tmp.icon.color }), ];
