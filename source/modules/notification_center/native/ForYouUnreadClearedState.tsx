...
// Dependencies: [19, 17, 21, 4638, 576, 1177, 10793, 4634, 1115, 2]
// Exports: ForYouUnreadClearedState

// Module 16576 (ForYouUnreadClearedState)
...
export const ForYouUnreadClearedState = function ForYouUnreadClearedState() {
  ...
  const items = [React4(View, { style: tmp.imageContainer }), React4(native.Icon, { source: _modDef10793, style: tmp.icon, color: tmp.icon.color }), ];
