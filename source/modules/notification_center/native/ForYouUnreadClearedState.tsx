...
// Dependencies: [19, 17, 21, 4607, 576, 1178, 10743, 4603, 1114, 2]
...
export const ForYouUnreadClearedState = function ForYouUnreadClearedState() {
  ...
  const items = [React4(View, { style: tmp.imageContainer }), React4(native.Icon, { source: _modDef10743, style: tmp.icon, color: tmp.icon.color }), ];
