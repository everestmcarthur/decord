...
// Dependencies: [19, 17, 21, 4605, 576, 1178, 10722, 4601, 1114, 2]
...
export const ForYouUnreadClearedState = function ForYouUnreadClearedState() {
  ...
  const items = [React4(View, { style: tmp.imageContainer }), React4(native.Icon, { source: _modDef10722, style: tmp.icon, color: tmp.icon.color }), ];
