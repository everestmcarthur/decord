...
// Dependencies: [19, 17, 21, 4574, 576, 1178, 10684, 4570, 1114, 2]
...
export const ForYouUnreadClearedState = function ForYouUnreadClearedState() {
  ...
  const items = [React4(View, { style: tmp.imageContainer }), React4(native.Icon, { source: _modDef10684, style: tmp.icon, color: tmp.icon.color }), ];
