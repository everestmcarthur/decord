...
// Dependencies: [32, 19, 17, 1074, 1955, 12545, 21, 4639, 576, 1241, 9191, 4635, 1115, 5059, 12546, 5207, 5765, 15578, 7495, 1944, 2]
// Exports: default

// Module 16520 (NotificationCenterPermissionNudge)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = { style: tmp.iconContainer, children: closure_14(onDismiss(9191).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }) };
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12546).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
