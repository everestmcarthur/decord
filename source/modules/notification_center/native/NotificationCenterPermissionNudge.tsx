...
// Dependencies: [32, 19, 17, 1074, 1955, 12553, 21, 4638, 576, 1241, 9202, 4634, 1115, 5060, 12554, 5208, 5766, 15595, 7498, 1944, 2]
// Exports: default

// Module 16540 (NotificationCenterPermissionNudge)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = { style: tmp.iconContainer, children: closure_14(onDismiss(9202).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }) };
  ...
  const items1 = [closure_14(onDismiss(4634).Text, obj5), , ];
  ...
  items1[1] = closure_14(onDismiss(4634).Text, obj6);
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12554).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
    const obj = onDismiss(12554);
  ...
  obj8.children = closure_14(onDismiss(5060).Button, obj9);
  ...
  obj10.children = closure_14(onDismiss(5766).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = closure_14(onDismiss(5208).PressableHighlight, obj10);
  obj.children = items;
