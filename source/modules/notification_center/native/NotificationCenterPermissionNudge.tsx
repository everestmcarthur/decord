...
// Dependencies: [32, 19, 17, 1074, 1954, 12503, 21, 4606, 576, 1242, 9149, 4602, 1114, 5026, 12504, 5174, 5731, 15545, 7461, 1943, 2]
// Exports: default
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = { style: tmp.iconContainer, children: closure_14(onDismiss(9149).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }) };
  ...
  const items1 = [closure_14(onDismiss(4602).Text, obj5), , ];
  ...
  items1[1] = closure_14(onDismiss(4602).Text, obj6);
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12504).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
    const obj = onDismiss(12504);
  ...
  obj8.children = closure_14(onDismiss(5026).Button, obj9);
  ...
  obj10.children = closure_14(onDismiss(5731).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = closure_14(onDismiss(5174).PressableHighlight, obj10);
  obj.children = items;
