...
// Dependencies: [19, 17, 4288, 1372, 21, 4639, 5112, 4792, 17951, 9956, 17952, 4606, 17953, 1897, 17954, 1115, 5669, 5696, 5057, 576, 5772, 5690, 7307, 1385, 8513, 2]
// Exports: default

// Module 17950 (AdvancedInstantInvite)
...
export default function AdvancedInstantInvite(maxAge) {
  ...
  const callback = maxUsesOptions.useCallback(() => {
    ...
    if (tmp) {
      ...
      obj.openLazy(asyncRequireImpl(17953, dependencyMap.paths), "SelectInviteRolesActionSheet", obj2, "stack");
    }
  }, items);
  ...
  const callback1 = maxUsesOptions.useCallback(() => {
    if (null != onChangeMaxAge) {
      const obj = ActionSheetActionCreatorsDefault;
      const tmp5 = asyncRequireImpl(17954, dependencyMap.paths);
