...
// Dependencies: [19, 17, 4255, 1371, 21, 4606, 5079, 4759, 17882, 9915, 17883, 4573, 17884, 1896, 17885, 1114, 5635, 5662, 5024, 576, 5738, 5656, 7273, 1384, 8478, 2]
// Exports: default

// Module 17881 (AdvancedInstantInvite)
...
export default function AdvancedInstantInvite(maxAge) {
  ...
  const callback = maxUsesOptions.useCallback(() => {
    ...
    if (tmp) {
      ...
      obj.openLazy(asyncRequireImpl(17884, dependencyMap.paths), "SelectInviteRolesActionSheet", obj2, "stack");
    }
  }, items);
