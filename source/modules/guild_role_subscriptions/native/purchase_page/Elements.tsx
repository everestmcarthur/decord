...
// Function ID: 16576
// Name: Elements
// Dependencies: [32, 19, 17, 4236, 21, 4574, 576, 4570, 1114, 5137, 1178, 16576, 9398, 15259, 563, 9401, 7248, 2]
// Exports: ArrowButton, TruncatedText, useFormattedSubscriptionPlan

// Module 16575 (Elements)
...
import useStoreFrontPriceDefault from "useStoreFrontPrice" /* 9401 */;
...
export const ArrowButton = function ArrowButton(arg0) {
  ...
  const items = [React7(Text_Text.Text, { variant: "text-md/semibold", color: "text-default", style: tmp.arrowButtonText, children: text }), React7(native.Icon, { size: native.Icon.Sizes.SMALL, source: _modDef16576, style: tmp.arrowButtonIcon })];
  obj.children = items;
