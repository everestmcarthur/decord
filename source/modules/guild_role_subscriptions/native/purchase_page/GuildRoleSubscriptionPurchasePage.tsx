...
// Dependencies: [19, 17, 1182, 1958, 1980, 1074, 21, 4638, 576, 4634, 1115, 1177, 10079, 7089, 15320, 15322, 15323, 563, 16672, 4791, 16674, 16675, 16676, 5113, 5673, 5670, 16677, 10486, 16679, 16680, 4332, 16681, 2]
// Exports: default

// Module 16671 (GuildRoleSubscriptionPurchasePage)
...
import GuildRoleSubscriptionPurchasePreviewCardDefault from "GuildRoleSubscriptionPurchasePreviewCard" /* 16681 */;
...
function SocialBadge(onPress) {
  ...
  if (tmp5Result) {
    const obj3 = { source: _modDef10079, style: tmp.socialBadgeArrow };
