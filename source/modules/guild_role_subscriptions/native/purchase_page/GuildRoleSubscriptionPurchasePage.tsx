...
// Dependencies: [19, 17, 1182, 1958, 1980, 1074, 21, 4639, 576, 4635, 1115, 1177, 10071, 7086, 15304, 15306, 15307, 563, 16652, 4792, 16654, 16655, 16656, 5112, 5672, 5669, 16657, 10478, 16659, 16660, 4334, 16661, 2]
// Exports: default

// Module 16651 (GuildRoleSubscriptionPurchasePage)
...
import GuildRoleSubscriptionPurchasePreviewCardDefault from "GuildRoleSubscriptionPurchasePreviewCard" /* 16661 */;
...
function SocialBadge(onPress) {
  ...
  if (tmp5Result) {
    const obj3 = { source: _modDef10071, style: tmp.socialBadgeArrow };
