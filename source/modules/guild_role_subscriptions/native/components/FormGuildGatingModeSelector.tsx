...
// Dependencies: [19, 17, 21, 4636, 17840, 4981, 1114, 4632, 17842, 11934, 17843, 2]
// Exports: default

// Module 17839 (FormGuildGatingModeSelector)
...
export default function FormGuildGatingModeSelector(isFullServerGating) {
  ...
  const tmp = closure_8();
  dependencyMap = tmp;
  const roleSubscriptionSettingsDisabled = isFullServerGating(17840).useRoleSubscriptionSettingsDisabled();
  let items = [onChange];
  ...
  const items2 = [closure_5(onChange(17842), obj3), closure_5(View, { style: tmp.space }), ];
  ...
  items2[2] = closure_5(onChange(17842), obj5);
