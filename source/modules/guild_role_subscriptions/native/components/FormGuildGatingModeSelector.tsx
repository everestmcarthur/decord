...
// Dependencies: [19, 17, 21, 4605, 17819, 4950, 1114, 4601, 17821, 11875, 17822, 2]
// Exports: default

// Module 17818 (FormGuildGatingModeSelector)
...
export default function FormGuildGatingModeSelector(isFullServerGating) {
  ...
  const tmp = closure_8();
  dependencyMap = tmp;
  const roleSubscriptionSettingsDisabled = isFullServerGating(17819).useRoleSubscriptionSettingsDisabled();
  let items = [onChange];
  ...
  let obj = isFullServerGating(17819);
  obj3.icon = onChange(11875);
  ...
  const items2 = [closure_5(onChange(17821), obj3), closure_5(View, { style: tmp.space }), ];
  let obj5 = { icon: null, title: null, description: null, selected: null, onPress: null, disabled: null };
  let obj4 = { style: tmp.space };
  const tmp5 = onChange(17821);
  obj5.icon = onChange(17822);
  ...
  items2[2] = closure_5(onChange(17821), obj5);
