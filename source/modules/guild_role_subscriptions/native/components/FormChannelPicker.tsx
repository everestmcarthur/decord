...
// Dependencies: [19, 1957, 21, 4605, 13973, 504, 4758, 9119, 4572, 17850, 1896, 5078, 5130, 4601, 1114, 1178, 10009, 2]
// Exports: default
...
export default function FormChannelPicker(channelId) {
  ...
  let obj2 = {
    ...
    onPress() {
      ...
      obj.openLazy(asyncRequireImpl(17850, dependencyMap.paths), "ChannelSelectorActionSheet", obj2);
    },
    children: null
  };
