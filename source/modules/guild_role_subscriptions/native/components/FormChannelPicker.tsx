...
// Dependencies: [19, 1957, 21, 4606, 13951, 504, 4759, 9140, 4573, 17841, 1896, 5079, 5131, 4602, 1114, 1178, 10030, 2]
// Exports: default

// Module 17840 (FormChannelPicker)
...
export default function FormChannelPicker(channelId) {
  ...
  let obj2 = {
    ...
    onPress() {
      ...
      obj.openLazy(asyncRequireImpl(17841, dependencyMap.paths), "ChannelSelectorActionSheet", obj2);
    },
    children: null
  };
  ...
  items3[2] = closure_4(channelId(stateFromStores[15]).Icon, { size: channelId(stateFromStores[15]).Icon.Sizes.MEDIUM, source: require("module_10030") });
