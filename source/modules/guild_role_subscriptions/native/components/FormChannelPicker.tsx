...
// Dependencies: [19, 1957, 21, 4607, 13953, 504, 4760, 9142, 4574, 17842, 1896, 5080, 5132, 4603, 1114, 1178, 10032, 2]
// Exports: default

// Module 17841 (FormChannelPicker)
...
export default function FormChannelPicker(channelId) {
  ...
  let obj2 = {
    ...
    onPress() {
      ...
      obj.openLazy(asyncRequireImpl(17842, dependencyMap.paths), "ChannelSelectorActionSheet", obj2);
    },
    children: null
  };
  ...
  items3[2] = closure_4(channelId(stateFromStores[15]).Icon, { size: channelId(stateFromStores[15]).Icon.Sizes.MEDIUM, source: require("module_10032") });
