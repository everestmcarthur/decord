...
// Function ID: 10433
// Name: ShinyButton
// Dependencies: [19, 21, 4639, 576, 5060, 1177, 10433, 2]
// Exports: default

// Module 10432 (ShinyButton)
...
export default function ShinyButton(style) {
  ...
  let tmp3Result;
  if (!loading) {
    const obj2 = { size: tmp4(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef10433, style: null };
