...
// Function ID: 10393
// Name: ShinyButton
// Dependencies: [19, 21, 4607, 576, 5028, 1178, 10393, 2]
// Exports: default

// Module 10392 (ShinyButton)
...
export default function ShinyButton(style) {
  ...
  let tmp3Result;
  if (!loading) {
    const obj2 = { size: tmp4(1178).Icon.Sizes.REFRESH_SMALL_16, source: _modDef10393, style: null };
