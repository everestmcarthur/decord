...
// Function ID: 10372
// Name: ShinyButton
// Dependencies: [19, 21, 4605, 576, 5026, 1178, 10372, 2]
// Exports: default

// Module 10371 (ShinyButton)
...
export default function ShinyButton(style) {
  ...
  let tmp3Result;
  if (!loading) {
    const obj2 = { size: tmp4(1178).Icon.Sizes.REFRESH_SMALL_16, source: _modDef10372, style: null };
