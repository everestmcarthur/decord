...
// Dependencies: [19, 17, 21, 4639, 5672, 17847, 17848, 4635, 5059, 1177, 15311, 2]
// Exports: default
...
function EligibilityChecklistRow(item) {
  ...
  if (item.checked) {
    let tmp6Result = tmp6(17847);
  } else {
    tmp6Result = tmp6(17848);
  }
  ...
  if (tmp5Result) {
    ...
    obj6.children = tmp5(tmp10(5059).Button, { text: null, onPress: null, grow: true });
  ...
  if (item.isLast) {
    ...
    tmp5Result2 = tmp5(tmp6(15311), obj15);
  }
