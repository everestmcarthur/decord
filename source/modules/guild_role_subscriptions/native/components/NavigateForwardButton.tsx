...
// Dependencies: [19, 21, 4605, 576, 5173, 4601, 1178, 15303, 2]
// Exports: default
...
export default function NavigateForwardButton(arg0) {
  ...
  const items = [React3(Text_Text.Text, { style: tmp.text, variant: "text-md/semibold", color: "interactive-text-active", children: text }), React3(native.Icon, { source: _modDef15303 })];
  obj.children = items;
