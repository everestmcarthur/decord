...
// Dependencies: [19, 21, 4640, 576, 5210, 4636, 1177, 15337, 2]
// Exports: default

// Module 15336 (NavigateForwardButton)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import Text_Text from "Text/Text" /* 4636 */;
import Pressables from "Pressables" /* 5210 */;
import _modDef15337 from "module_15337" /* 15337 */;
...
export default function NavigateForwardButton(arg0) {
  ...
  const items = [React3(Text_Text.Text, { style: tmp.text, variant: "text-md/semibold", color: "interactive-text-active", children: text }), React3(native.Icon, { source: _modDef15337 })];
  obj.children = items;
