...
// Function ID: 14011
// Name: FormDropdown
// Dependencies: [19, 1074, 21, 4640, 5612, 576, 1177, 14011, 10090, 14012, 9204, 2]
// Exports: default

// Module 14010 (FormDropdown)
...
const TouchableHitBoxDefault = tmp2(9204);
require = fn;
function LockedIcon() {
  return React3(native.Icon, { size: native.Icon.Sizes.MEDIUM, source: _modDef14011 });
}
function DropdownIcon() {
  const obj = { style: null, size: native.Icon.Sizes.MEDIUM, source: _modDef10090 };
