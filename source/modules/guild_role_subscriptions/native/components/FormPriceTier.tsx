...
// Function ID: 17982
// Name: FormPriceTier
// Dependencies: [19, 17940, 1074, 21, 1115, 14002, 7344, 38, 4605, 9569, 1897, 2]
// Exports: default

// Module 17981 (FormPriceTier)
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9569, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
        },
      placeholder: null
    };
