...
// Function ID: 17857
// Name: FormPriceTier
// Dependencies: [19, 17815, 1074, 21, 1114, 13949, 7307, 38, 4573, 9517, 1896, 2]
// Exports: default

// Module 17856 (FormPriceTier)
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9517, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
        },
      placeholder: null
    };
