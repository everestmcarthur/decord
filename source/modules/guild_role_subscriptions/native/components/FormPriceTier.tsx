...
// Function ID: 17858
// Name: FormPriceTier
// Dependencies: [19, 17816, 1074, 21, 1114, 13951, 7308, 38, 4574, 9519, 1896, 2]
// Exports: default

// Module 17857 (FormPriceTier)
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9519, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
        },
      placeholder: null
    };
