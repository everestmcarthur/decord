...
// Function ID: 17866
// Name: FormPriceTier
// Dependencies: [19, 17824, 1074, 21, 1114, 13971, 7286, 38, 4572, 9496, 1896, 2]
// Exports: default

// Module 17865 (FormPriceTier)
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9496, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
        },
      placeholder: null
    };
