...
// Function ID: 18046
// Name: FormPriceTier
// Dependencies: [19, 18004, 1074, 21, 1115, 14010, 7348, 38, 4607, 9580, 1897, 2]
// Exports: default

// Module 18045 (FormPriceTier)
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9580, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
        },
      placeholder: null
    };
