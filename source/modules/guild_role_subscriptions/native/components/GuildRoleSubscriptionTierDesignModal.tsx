...
// Dependencies: [32, 19, 17, 15299, 1074, 21, 4639, 576, 4341, 15332, 13991, 17896, 15321, 7294, 17879, 9948, 1115, 17885, 17923, 17888, 2]
// Exports: GuildRoleSubscriptionTierDesignTab, default

// Module 17922 (GuildRoleSubscriptionTierDesignModal)
...
import GuildRoleSubscriptionMemberPreview from "GuildRoleSubscriptionMemberPreview" /* 15332 */;
...
function Content() {
  ...
  items1[1] = closure_9(role(9948), obj7);
  ...
  items1[2] = closure_9(role(17885), obj8);
  const obj9 = { style: tmp3.header, children: null };
  const tmpResult3 = role(17885);
  const intl3 = tmp4(1115).intl;
  obj9.children = intl3.string(require("util").t["W7hH+z"]);
  items1[3] = closure_9(role(9948), obj9);
  items1[4] = closure_9(role(17923), { color: tmp7, onChange: tmp8, disabled: roleSubscriptionSettingsDisabled });
