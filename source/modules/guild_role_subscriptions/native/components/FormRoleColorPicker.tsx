...
// Dependencies: [19, 1074, 21, 4638, 4605, 16421, 1897, 14002, 14711, 1092, 2]
// Exports: default

// Module 17979 (FormRoleColorPicker)
...
export default function FormRoleColorPicker(color) {
  ...
  const callback = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16421, dependencyMap.paths), "RoleColorPicker", { color, onSelect: onChange });
  }, items);
