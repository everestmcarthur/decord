...
// Dependencies: [19, 17, 15338, 1074, 21, 4638, 576, 5610, 4356, 9193, 1177, 17973, 1115, 17974, 2]
// Exports: default

// Module 17972 (AllChannelsSwitch)
...
import _modDef17973 from "module_17973" /* 17973 */;
...
const AllChannelAccessOptions = fn(15338).AllChannelAccessOptions;
...
export default function AllChannelsSwitch(style) {
  ...
  obj.style = items;
  const obj2 = { icon: _modDef17973, label: null, selected: null, onPress: null, disabled: null };
  ...
  const obj4 = { icon: _modDef17974, label: null, selected: null, onPress: null, disabled: null };
