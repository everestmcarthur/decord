...
// Dependencies: [32, 19, 17, 1957, 7185, 4245, 1074, 4789, 21, 4607, 576, 5576, 4760, 4574, 16187, 5639, 17779, 504, 7271, 4603, 1114, 7124, 5175, 4810, 9825, 1896, 9828, 9830, 1178, 13662, 6699, 2]
// Exports: default
...
import useCreateChannelSubmit from "useCreateChannelSubmit" /* 9828 */;
...
function ChannelRow(channel) {
  ...
  const tmp4 = onChannelSelected(4760)(channel);
...
export default function ChannelSelectorActionSheet(guildId) {
  ...
  obj3.children = closure_11(guildId(4603).Text, { accessibilityRole: "header", variant: "text-md/bold", color: "mobile-text-heading-primary", children: title });
  ...
  obj4.children = closure_11(guildId(7124).SearchField, obj5);
  ...
  if (!hideCreateChannel) {
    const obj6 = {
      ...
      onPress() {
          ...
          obj2.pushLazy(asyncRequireImpl(9825, dependencyMap.paths), obj3, CreateChannelModalActionCreatorsDefault.CREATE_CHANNEL_MODAL_KEY);
        },
      children: null
    };
    let str1;
    ...
    const obj7 = { color: str1, source: _modDef13662 };
    ...
    items3[1] = tmp8(tmp5(4603).Text, obj8);
    obj6.children = items3;
    tmp9Result = tmp9(tmp5(5175).PressableOpacity, obj6);
  }
  items2[2] = tmp9Result;
  obj2.header = closure_13(closure_12, { children: items2 });
  obj2.children = closure_11(guildId(6699).BottomSheetFlatList, {
  ...
  return closure_11(guildId(7271).ActionSheet, obj2);
};
