...
// Dependencies: [19, 17, 1372, 21, 4638, 576, 1115, 504, 4790, 1397, 7297, 5673, 4634, 1092, 1177, 7315, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 15348 (GuildRoleSubscriptionMemberPreview)
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(7297).getRoleIconData(role, 16);
    const obj2 = { style: null, children: null };
    const items1 = [tmp3.container, style];
    obj2.style = items1;
    const obj3 = { style: tmp3.avatar, source };
    const items2 = [timestampProducer(tmp6(5673), obj3), ];
    ...
    const tmp4Result = tmp4(7297);
    obj7.color = utils_ColorUtilsAll.int2hex(role.color);
    obj6.style = obj7;
    obj6.children = tmp8;
    const items3 = [timestampProducer(tmp4(4634).Text, obj6), , , ];
