...
// Dependencies: [19, 17, 1371, 21, 4606, 576, 1114, 504, 4758, 1396, 7260, 5638, 4602, 1091, 1178, 7278, 2]
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(7260).getRoleIconData(role, 16);
    const obj2 = { style: null, children: null };
    const items1 = [tmp3.container, style];
    obj2.style = items1;
    const obj3 = { style: tmp3.avatar, source };
    const items2 = [timestampProducer(tmp6(5638), obj3), ];
    ...
    const tmp4Result = tmp4(7260);
    obj7.color = utils_ColorUtilsAll.int2hex(role.color);
    obj6.style = obj7;
    obj6.children = tmp8;
    const items3 = [timestampProducer(tmp4(4602).Text, obj6), , , ];
