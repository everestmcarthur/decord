...
// Dependencies: [19, 17, 1371, 21, 4605, 576, 1114, 504, 4757, 1396, 7239, 5637, 4601, 1091, 1178, 7257, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 15319 (GuildRoleSubscriptionMemberPreview)
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const tmp4Result = tmp4(7239);
    obj7.color = utils_ColorUtilsAll.int2hex(role.color);
    obj6.style = obj7;
    obj6.children = tmp8;
    const items3 = [timestampProducer(tmp4(4601).Text, obj6), , , ];
