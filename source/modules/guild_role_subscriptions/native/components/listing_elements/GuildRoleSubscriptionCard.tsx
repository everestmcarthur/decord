...
// Dependencies: [32, 19, 17, 21, 4722, 576, 7175, 4718, 15436, 10588, 1115, 1177, 15447, 15448, 15451, 2]
// Exports: Content

// Module 15446 (GuildRoleSubscriptionCard)
...
import GuildRoleSubscriptionEmojiGalleryDefault from "GuildRoleSubscriptionEmojiGallery" /* 15448 */;
import GuildRoleSubscriptionBenefitRow from "GuildRoleSubscriptionBenefitRow" /* 15451 */;
...
export const Content = function Content(arg0) {
  ...
  const items = [closure_6(SectionTitle, obj7), closure_6(guildId(1177).Spacer, { size: 8 }), closure_6(guildId(15447).GuildRoleSubscriptionMemberPreview, { guildId, role })];
  obj6.children = items;
  ...
  if (first1.length > 0) {
    ...
    items4[2] = tmp7(tmp5(10588).GappedList, obj15);
  ...
  if (first2.length > 0) {
    ...
    items5[2] = tmp7(tmp5(10588).GappedList, obj19);
    obj16.children = items5;
    tmp4Result4 = tmp4(tmp6, obj16);
  }
  items1[3] = tmp4Result4;
  obj5.children = items1;
  return closure_8(guildId(10588).GappedList, obj5);
};
