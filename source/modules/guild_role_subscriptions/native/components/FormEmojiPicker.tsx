...
// Dependencies: [19, 1074, 1375, 21, 4639, 5609, 576, 13991, 4292, 15335, 15334, 5672, 17913, 9182, 11260, 1177, 4296, 1115, 10071, 2]
// Exports: default

// Module 17912 (FormEmojiPicker)
...
export default function FormEmojiPicker(emoji) {
  ...
  const tmp4 = onChange(13991)();
  const emojiByIdOrName = guildId(15335).useEmojiByIdOrName(guildId, emojiId);
  if (null != emojiId) {
    let obj = { guildId, id: emojiId };
    let tmp9 = closure_4(tmp2(15334), obj);
    let tmp10 = closure_4;
  } else {
    const obj3 = { resizeMode: "contain", source: tmp2(17913) };
    tmp9 = closure_4(tmp2(5672), obj3);
    tmp10 = closure_4;
    const tmp2Result3 = tmp2(5672);
  }
  const obj4 = {
    style: null,
  ...
  const tmp2Result4 = onChange(9182);
  items1[2] = tmp10(guildId(1177).Icon, { size: guildId(1177).Icon.Sizes.MEDIUM, source: onChange(10071) });
