...
// Dependencies: [5, 32, 19, 17, 4288, 1372, 18027, 15320, 1074, 21, 4640, 576, 5612, 14012, 5210, 4597, 1177, 1115, 1612, 18029, 4793, 8748, 18031, 9967, 18032, 2]

// Module 18028 (GuildRoleSubscriptionBenefitEditorModal)
...
export default noop.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === constants.CHANNEL) {
      ...
      let tmp25 = closure_13(tmp2(18029), obj);
      ...
      tmp25 = closure_13(tmp20(8748).FormInput, obj2);
      tmp26 = closure_13;
    }
    ...
    const items = [tmp26(tmp2(18031), obj4), ];
    ...
    items2[5] = tmp26(tmp20(8748).FormInput, obj12);
