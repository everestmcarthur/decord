...
// Dependencies: [5, 32, 19, 17, 4222, 1371, 17788, 15237, 1074, 21, 4574, 576, 5538, 13924, 5137, 4532, 1178, 1114, 1611, 17790, 4727, 8626, 17792, 9848, 17793, 2]

// Module 17789 (GuildRoleSubscriptionBenefitEditorModal)
...
import GuildRoleSubscriptionBenefitEditorModalStateStore from "GuildRoleSubscriptionBenefitEditorModalStateStore" /* 17788 */;
...
export default noop.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === constants.CHANNEL) {
      ...
      let tmp25 = closure_13(tmp2(17790), obj);
      ...
      tmp25 = closure_13(tmp20(8626).FormInput, obj2);
      tmp26 = closure_13;
    }
    ...
    const items = [tmp26(tmp2(17792), obj4), ];
    ...
    items2[5] = tmp26(tmp20(8626).FormInput, obj12);
