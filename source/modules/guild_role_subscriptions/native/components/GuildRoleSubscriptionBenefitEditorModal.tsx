...
// Dependencies: [5, 32, 19, 17, 4288, 1372, 17907, 15299, 1074, 21, 4639, 576, 5609, 13991, 5207, 4597, 1177, 1115, 1612, 17909, 4792, 8719, 17911, 9948, 17912, 2]

// Module 17908 (GuildRoleSubscriptionBenefitEditorModal)
...
export default noop.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === constants.CHANNEL) {
      ...
      let tmp25 = closure_13(tmp2(17909), obj);
      ...
      tmp25 = closure_13(tmp20(8719).FormInput, obj2);
      tmp26 = closure_13;
    }
    ...
    const items = [tmp26(tmp2(17911), obj4), ];
    ...
    items2[5] = tmp26(tmp20(8719).FormInput, obj12);
