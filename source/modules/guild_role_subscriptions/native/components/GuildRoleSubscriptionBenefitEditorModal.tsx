...
// Function ID: 17757
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 4209, 1371, 17755, 15208, 1074, 21, 4560, 576, 5524, 13901, 5123, 4518, 1178, 1114, 1611, 17757, 4713, 8598, 17759, 9821, 17760, 2]

// Module 17756 (DeleteButton)
...
import closure_9 from "resetImperatively" /* 17755 */;
...
const forwardRefResult = importAllResult.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      let stringResult = intl2.string(_require(1114).t.Odqwp9);
      let tmp20 = _require;
    } else {
      const intl = _require(1114).intl;
      stringResult = intl.string(_require(1114).t["0rVUnI"]);
      tmp20 = _require;
    }
    if (benefitType.benefitType === _handleSave.CHANNEL) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      obj[2] = function handleChannelSelected(id) {
        callback3(id.id);
        dependencyMap(benefitType(4713).computeChannelName(id, first4, first3));
      };
      let tmp25 = callback2(tmp2(17757), obj);
      let tmp26 = callback2;
    } else {
      ...
      obj[5] = intl9.string(tmp20(1114).t["kV54/Y"]);
      obj[6] = tmp6;
      obj[8] = tmp20(1178).ClearButtonVisibility.WITH_CONTENT;
      tmp25 = callback2(tmp20(8598).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(17759), obj1), ];
    ...
    obj3[0] = first(1611)().bottom + 32 + 16;
    items1[1] = obj3;
    obj2[3] = items1;
    const obj4 = { style: null, children: null };
    obj4[0] = tmp4.header;
    obj4[1] = stringResult1;
    const items2 = [tmp26(tmp2(9821), obj4), tmp25, , , , , ];
    const obj5 = { style: null, children: null };
    obj5[0] = tmp4.header;
    let tmp2Result = tmp2(9821);
    const intl7 = tmp20(1114).intl;
    obj5[1] = intl7.string(tmp20(1114).t.sMOuuS);
    ...
    items2[3] = tmp26(tmp2(17760), obj6);
    const obj8 = { style: null, children: null };
    obj8[0] = tmp4.header;
    tmp2Result = tmp2(9821);
    const intl8 = tmp20(1114).intl;
    obj8[1] = intl8.string(tmp20(1114).t["74JctW"]);
    ...
    items2[5] = tmp26(tmp20(8598).FormInput, obj9);
