...
// Dependencies: [5, 32, 19, 17, 4286, 1372, 17963, 15315, 1074, 21, 4638, 576, 5610, 14004, 5208, 4595, 1177, 1115, 1612, 17965, 4791, 8728, 17967, 9956, 17968, 2]

// Module 17964 (GuildRoleSubscriptionBenefitEditorModal)
...
export default noop.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === constants.CHANNEL) {
      ...
      let tmp25 = closure_13(tmp2(17965), obj);
      ...
      tmp25 = closure_13(tmp20(8728).FormInput, obj2);
      tmp26 = closure_13;
    }
    ...
    const items = [tmp26(tmp2(17967), obj4), ];
    ...
    items2[5] = tmp26(tmp20(8728).FormInput, obj12);
