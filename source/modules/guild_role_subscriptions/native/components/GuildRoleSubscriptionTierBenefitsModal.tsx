...
// Dependencies: [32, 19, 17, 15343, 18004, 15320, 21, 4640, 576, 9204, 5675, 18020, 4636, 1115, 1397, 18021, 14012, 15347, 38, 17999, 8748, 9967, 18022, 18023, 18016, 15327, 17995, 15342, 18025, 18026, 18035, 15346, 18036, 18008, 2]
// Exports: GuildRoleSubscriptionTierChannelBenefitsModal, GuildRoleSubscriptionTierIntangibleBenefitsModal

// Module 18019 (GuildRoleSubscriptionTierBenefitsModal)
...
import useRoleSubscriptionFormatDefault from "useRoleSubscriptionFormat" /* 17995 */;
import GuildRoleSubscriptionTierEditStepDefault from "GuildRoleSubscriptionTierEditStep" /* 18008 */;
import _modDef18020 from "module_18020" /* 18020 */;
import EmojiAliasDefault from "EmojiAlias" /* 18021 */;
import useRoleSubscriptionEmojisDefault from "useRoleSubscriptionEmojis" /* 18025 */;
import GuildRoleSubscriptionsModalActionCreatorsAll from "GuildRoleSubscriptionsModalActionCreators" /* 18026 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;

const AllChannelsSwitchDefault = tmp10(18036);
require = fn;
...
function ListFooterSection(onChangeTrialInterval) {
  ...
  const tmp = closure_15();
  const tmp4 = options(14012)();
  const tmp5 = options(15347)(interval);
  ...
  const roleSubscriptionSettingsDisabled = onChangeTrialInterval(17999).useRoleSubscriptionSettingsDisabled();
  ...
  const items1 = [closure_12(onChangeTrialInterval(8748).FormSwitchRow, obj3), ];
  ...
  const items3 = [closure_12(onChangeTrialInterval(4636).Text, obj5), , , , , , ];
  const obj6 = { style: tmp4.header, children: null };
  const obj = onChangeTrialInterval(17999);
  const intl3 = tmp8(1115).intl;
  obj6.children = intl3.string(onChangeTrialInterval(1115).t.m1KuWd);
  items3[1] = closure_12(options(9967), obj6);
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    type = type.type;
    const obj = { style: closure_1(14012)().header, children: null };
    const tmp2 = closure_1(14012)();
    ...
    return tmp3(closure_1(9967), obj);
  }
  ...
  const obj10 = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
        ...
        obj.onPress = function onPress() {
          ...
          closure_1_2(dependencyMap[29]).showEditBenefitModal({
            ...
            onDelete() {
              ref_type = closure_1;
              if (ref_type.ref_type === constants.CHANNEL) {
                closure_2_8((arr) => arr.filter(/* F127542 */ function() { ... }));
              } else {
                closure_2_10((arr) => arr.filter(/* F127543 */ function() { ... }));
              }
            },
            onSave(ref_type) {
              closure_0 = ref_type;
        ...
        obj.children = closure_12(closure_0(18035).GuildRoleSubscriptionBenefitPreview, obj5);
        tmp3Result = tmp3(closure_1(9204), obj);
        const tmp6 = closure_1(9204);
      }
      return tmp3Result;
    },
...
let AllChannelAccessOptions = fn(15343).AllChannelAccessOptions;
const useGroupIsFullGateState = fn(18004).useGroupIsFullGateState;
