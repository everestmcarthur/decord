...
// Dependencies: [5, 32, 19, 17, 17824, 21, 4605, 576, 13973, 17836, 17828, 1114, 9886, 5637, 4601, 17860, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[1] = React6(tmp3(9886), obj8);
    ...
    items2[2] = React6(tmp6(4601).Text, obj9);
    obj7.children = items2;
    flag = tmp13(tmp16, obj7);
    const tmp3Result2 = tmp3(9886);
  }
