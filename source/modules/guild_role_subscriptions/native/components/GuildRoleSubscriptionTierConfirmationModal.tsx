...
// Dependencies: [5, 32, 19, 17, 17845, 21, 4636, 576, 13985, 17857, 17849, 1114, 9946, 5668, 4632, 17881, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[1] = React6(tmp3(9946), obj8);
    ...
    items2[2] = React6(tmp6(4632).Text, obj9);
    obj7.children = items2;
    flag = tmp13(tmp16, obj7);
    const tmp3Result2 = tmp3(9946);
  }
