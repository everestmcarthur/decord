...
// Dependencies: [5, 32, 19, 17, 17816, 21, 4607, 576, 13953, 17828, 17820, 1114, 9909, 5639, 4603, 17852, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[1] = React6(tmp3(9909), obj8);
    ...
    items2[2] = React6(tmp6(4603).Text, obj9);
    obj7.children = items2;
    flag = tmp13(tmp16, obj7);
    const tmp3Result2 = tmp3(9909);
  }
