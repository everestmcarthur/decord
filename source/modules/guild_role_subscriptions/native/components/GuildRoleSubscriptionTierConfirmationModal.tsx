...
// Dependencies: [5, 32, 19, 17, 17765, 21, 4574, 576, 13924, 17777, 17769, 1114, 9848, 5601, 4570, 17801, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[1] = React6(tmp3(9848), obj8);
    ...
    items2[2] = React6(tmp6(4570).Text, obj9);
    obj7.children = items2;
    flag = tmp13(tmp16, obj7);
    const tmp3Result2 = tmp3(9848);
  }
