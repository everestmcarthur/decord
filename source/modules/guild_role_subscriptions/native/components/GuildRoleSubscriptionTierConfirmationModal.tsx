...
// Dependencies: [5, 32, 19, 17, 17884, 21, 4639, 576, 13991, 17896, 17888, 1115, 9948, 5672, 4635, 17920, 2]
// Exports: default

// Module 17919 (GuildRoleSubscriptionTierConfirmationModal)
...
import GuildRoleSubscriptionListingPreview from "GuildRoleSubscriptionListingPreview" /* 17920 */;
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[1] = React6(tmp3(9948), obj8);
    ...
    items2[2] = React6(tmp6(4635).Text, obj9);
    obj7.children = items2;
    flag = tmp13(tmp16, obj7);
    const tmp3Result2 = tmp3(9948);
  }
