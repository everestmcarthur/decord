...
// Dependencies: [5, 32, 19, 17, 17815, 21, 4606, 576, 13951, 17827, 17819, 1114, 9907, 5638, 4602, 17851, 2]
// Exports: default

// Module 17850 (GuildRoleSubscriptionTierConfirmationModal)
...
import GuildRoleSubscriptionListingPreview from "GuildRoleSubscriptionListingPreview" /* 17851 */;
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[2] = React6(tmp6(4602).Text, obj9);
    obj7.children = items2;
    flag = tmp13(tmp16, obj7);
    const tmp3Result2 = tmp3(9907);
  }
