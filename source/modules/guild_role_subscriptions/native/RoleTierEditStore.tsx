...
// Dependencies: [32, 5, 1248, 1243, 7366, 4260, 5077, 15322, 2]
...
// Module 17940 (RoleTierEditStore)
...
const withEqualityFn = identity.createWithEqualityFn((arg0) => {
  ...
  obj.loadPriceTiers = function loadPriceTiers(arg0) {
    ...
    return (async () => {
      ...
      await closure_2_2(7366).getPriceTiers(priceTiers);
      if (1 === tmp7) {
        c2 = 0;
