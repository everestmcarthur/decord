...
// Dependencies: [32, 5, 1248, 1243, 7363, 4262, 5076, 15306, 2]
...
// Module 17884 (RoleTierEditStore)
...
const withEqualityFn = identity.createWithEqualityFn((arg0) => {
  ...
  obj.loadPriceTiers = function loadPriceTiers(arg0) {
    ...
    return (async () => {
      ...
      await closure_2_2(7363).getPriceTiers(priceTiers);
      if (1 === tmp7) {
        c2 = 0;
