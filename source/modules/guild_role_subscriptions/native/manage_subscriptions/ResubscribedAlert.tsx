...
// Dependencies: [19, 17, 21, 4722, 576, 5163, 1115, 15428, 1177, 4718, 2]
// Exports: default

// Module 15427 (ResubscribedAlert)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 1177 */;
import Text_Text from "Text/Text" /* 4718 */;
import common_AlertDefault from "common/Alert" /* 5163 */;
import _modDef15428 from "module_15428" /* 15428 */;
...
export default function ResubscribedAlert(onClose) {
  ...
  const items = [hasOwnProperty(React4, { source: _modDef15428, style: tmp.headerImage }), hasOwnProperty(native.Spacer, { size: 27 }), , , ];
