...
// Dependencies: [5, 32, 19, 17, 4303, 21, 4640, 576, 15342, 4231, 1115, 5672, 1177, 4636, 15332, 5675, 15350, 7276, 7296, 9520, 4985, 4964, 4337, 4319, 5062, 7093, 15338, 15327, 15351, 15352, 504, 2]
// Exports: default

// Module 15341 (UserSettingsGuildRoleSubscriptionsCancel)
...
import _modDef15350 from "module_15350" /* 15350 */;
import GuildRoleSubscriptionCardAll from "GuildRoleSubscriptionCard" /* 15352 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import SubscriptionStore from "SubscriptionStore" /* 4303 */;

const FastAssetImageDefault = tmp5(15351);
require = fn;
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  const analyticsLocations = subscription(7276)(subscription(7296).GUILD_ROLE_SUBSCRIPTION_CANCELLATION_MODAL).analyticsLocations;
  const tmp5 = subscription(7276);
  const cancelSubscription1 = subscription(9520).useCancelSubscription(subscription.id, subscription.isACOM);
          ...
          if (1 === tmp7) {
            if (arg0 === 1) {
              ...
              if (closure_129_6) {
                ...
                c4 = 4;
                c5 = 1;
                const obj13 = { value: tmp63(4964).cancelSubscription(closure_129_1.id, closure_129_4), done: false };
                return obj13;
              } else {
                const _Error = Error;
            ...
            if (2 === tmp7) {
              ...
              if (3 === tmp7) {
                ...
                if (arg0 === 1) {
                  ...
                  c4 = 5;
                  c5 = 1;
                  const obj16 = { value: tmp63(4964).fetchSubscriptions(), done: false };
                  return obj16;
                }
              } else if (arg0 === 1) {
                c5 = 3;
  ...
  obj2.children = closure_10(guild(5062).Button, obj3);
...
function Content(subscription) {
  ...
  if (null != listing) {
    ...
    if (null != guild) {
      ...
      items1[2] = closure_1_10(tmp(4636).Text, obj8);
