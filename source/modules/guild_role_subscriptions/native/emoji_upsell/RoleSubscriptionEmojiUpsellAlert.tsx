...
// Dependencies: [19, 1979, 1964, 21, 9405, 1114, 1477, 504, 5571, 5045, 10389, 9413, 2]
// Exports: default

// Module 10388 (RoleSubscriptionEmojiUpsellAlert)
...
export default function RoleSubscriptionEmojiUpsellAlert(arg0) {
  ...
  const memo = handleConfirm.useMemo(() => {
    ...
    const obj = { image: _modDef9405, title: null, description: null };
