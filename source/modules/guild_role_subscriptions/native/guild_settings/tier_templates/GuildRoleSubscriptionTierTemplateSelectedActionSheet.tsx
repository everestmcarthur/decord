...
// Dependencies: [19, 17, 1954, 21, 4605, 576, 1611, 7202, 6677, 4601, 1114, 1178, 5026, 2]
// Exports: default

// Module 17872 (GuildRoleSubscriptionTierTemplateSelectedActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [closure_5(markAsDismissed(4601).Text, obj4), closure_5(markAsDismissed(1178).Spacer, { size: 12 }), , , ];
  ...
  items[2] = closure_5(markAsDismissed(4601).Text, obj5);
  ...
  items[4] = closure_5(markAsDismissed(5026).BaseTextButton, obj6);
  obj3.children = items;
