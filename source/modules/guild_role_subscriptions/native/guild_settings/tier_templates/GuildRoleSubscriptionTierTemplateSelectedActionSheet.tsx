...
// Dependencies: [19, 17, 1955, 21, 4640, 576, 1612, 7264, 6738, 4636, 1115, 1177, 5063, 2]
// Exports: default

// Module 18052 (GuildRoleSubscriptionTierTemplateSelectedActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [closure_5(markAsDismissed(4636).Text, obj4), closure_5(markAsDismissed(1177).Spacer, { size: 12 }), , , ];
  ...
  items[2] = closure_5(markAsDismissed(4636).Text, obj5);
  ...
  items[4] = closure_5(markAsDismissed(5063).BaseTextButton, obj6);
  obj3.children = items;
