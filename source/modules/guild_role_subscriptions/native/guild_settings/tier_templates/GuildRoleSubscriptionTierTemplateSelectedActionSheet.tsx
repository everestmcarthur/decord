...
// Dependencies: [19, 17, 1955, 21, 4638, 576, 1612, 7260, 6735, 4634, 1115, 1177, 5061, 2]
// Exports: default

// Module 17988 (GuildRoleSubscriptionTierTemplateSelectedActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [closure_5(markAsDismissed(4634).Text, obj4), closure_5(markAsDismissed(1177).Spacer, { size: 12 }), , , ];
  ...
  items[2] = closure_5(markAsDismissed(4634).Text, obj5);
  ...
  items[4] = closure_5(markAsDismissed(5061).BaseTextButton, obj6);
  obj3.children = items;
