...
// Dependencies: [32, 19, 17, 4598, 1074, 1954, 21, 4606, 576, 5177, 563, 7223, 1114, 8393, 4602, 5026, 9153, 4573, 2]
// Exports: default

// Module 16320 (GuildRoleSubscriptionTierTemplateUpsellActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateUpsellActionSheet(arg0) {
  ...
  obj5.children = closure_10(markAsDismissed(8393), size);
