...
// Dependencies: [32, 19, 17, 4632, 1074, 1955, 21, 4640, 576, 5213, 563, 7264, 1115, 8456, 4636, 5062, 9217, 4607, 2]
// Exports: default

// Module 16409 (GuildRoleSubscriptionTierTemplateUpsellActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateUpsellActionSheet(arg0) {
  ...
  obj5.children = closure_10(markAsDismissed(8456), size);
