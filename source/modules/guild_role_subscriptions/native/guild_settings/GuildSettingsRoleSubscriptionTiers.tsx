...
// Dependencies: [32, 19, 17, 9156, 1979, 4239, 15266, 1074, 1373, 21, 4607, 576, 4574, 17823, 1896, 1114, 7308, 15292, 4603, 9142, 563, 15288, 5639, 10341, 1611, 13953, 1483, 15274, 17811, 13948, 15273, 12, 5676, 17825, 17826, 38, 9909, 17860, 17821, 2]
// Exports: default
...
function EditListingButton(editStateId) {
  ...
  if (undefined === first) {
    ...
    const items2 = [closure_17(tmp2(4603).Text, obj9), ];
    ...
    items3[3] = closure_17(tmp2(4603).Text, obj12);
    obj10.children = items3;
    items2[1] = closure_18(closure_7, obj10);
    obj8.children = items2;
    items1[1] = closure_18(closure_7, obj8);
    items1[2] = closure_17(tmp2(10341).PencilIcon, {});
    obj5.children = items1;
    obj11.children = closure_18(Row, obj5);
    return closure_17(closure_7, obj11);
  } else if (null != first2) {
    const intl = tmp2(1114).intl;
    const obj13 = { price: tmp2(7308).formatPrice(first, first2.currency), interval: null };
    ...
    const obj14 = { price: tmp2(7308).formatPrice(first, constants.USD), interval: null };
    const tmp2Result5 = tmp2(7308);
  ...
  const layoutEffect = editStateIds.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return closure_1_17(guildId(5676).NavigatorHeader, obj);
      }
    });
  });
