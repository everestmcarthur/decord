...
// Dependencies: [19, 1074, 21, 4639, 4606, 9195, 7489, 17842, 7257, 4635, 1115, 17846, 2]
// Exports: default

// Module 17841 (EligibilityActionSheet)
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4606 */;
import useCreatorMonetizationEligibilityItemsDefault from "useCreatorMonetizationEligibilityItems" /* 17842 */;
import EligibilityChecklistDefault from "EligibilityChecklist" /* 17846 */;
...
export default function EligibilityActionSheet(onRequireModeratorMFAClick) {
  ...
  const memo = noop.useMemo(() => ({
    actions: {
      onEnableMFAClick() {
        closure_1_1(4606).hideActionSheet(closure_1_7);
        const obj = closure_1_1(4606);
        closure_1_1(9195).close();
        const obj2 = closure_1_1(9195);
        onRequireModeratorMFAClick(7489).openUserSettings({ screen: constants.ACCOUNT });
      },
  ...
  const items1 = [closure_5(onRequireModeratorMFAClick(4635).Heading, obj2), ];
  ...
  obj.children = items1;
  return closure_6(onRequireModeratorMFAClick(7257).BottomSheet, obj);
};
