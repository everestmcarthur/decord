...
// Dependencies: [19, 1074, 21, 4722, 4689, 9301, 7578, 18056, 7346, 4718, 1115, 18060, 2]
// Exports: default

// Module 18055 (EligibilityActionSheet)
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4689 */;
import useCreatorMonetizationEligibilityItemsDefault from "useCreatorMonetizationEligibilityItems" /* 18056 */;
import EligibilityChecklistDefault from "EligibilityChecklist" /* 18060 */;
...
export default function EligibilityActionSheet(onRequireModeratorMFAClick) {
  ...
  const memo = noop.useMemo(() => ({
    actions: {
      onEnableMFAClick() {
        closure_1_1(4689).hideActionSheet(closure_1_7);
        const obj = closure_1_1(4689);
        closure_1_1(9301).close();
        const obj2 = closure_1_1(9301);
        onRequireModeratorMFAClick(7578).openUserSettings({ screen: constants.ACCOUNT });
      },
  ...
  const items1 = [closure_5(onRequireModeratorMFAClick(4718).Heading, obj2), ];
  ...
  obj.children = items1;
  return closure_6(onRequireModeratorMFAClick(7346).BottomSheet, obj);
};
