...
// Dependencies: [19, 17, 21, 4606, 576, 4602, 1178, 10391, 1114, 7052, 17794, 4301, 17766, 5638, 15301, 5027, 2]
// Exports: default
...
function GuildServerSubscriberCount(arg0) {
  ...
  items[2] = style;
  obj.style = items;
  const items1 = [timestampProducer(Text_Text.Text, { style: tmp.subscriberCount, variant: "text-sm/medium", color: "text-overlay-light", children: subscriberCount }), timestampProducer(native.Icon, { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10391 }), ];
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp6.isLoading) {
    const obj2 = { style: tmp.cardContainer, children: closure_6(tmp5(17766), {}) };
    ...
    obj5.source = obj6;
    const items1 = [closure_6(tmp5(5638), obj5), ];
    ...
    const items2 = [closure_6(tmp2(4602).Text, obj8), ];
    ...
    items3[1] = closure_6(tmp2(4602).Text, obj10);
    ...
    items3[2] = closure_6(tmp2(4602).Text, obj11);
    ...
    if (tmp9Result) {
      ...
      const items5 = [tmp11(tmp2(4602).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4602).Text, obj16);
      }
    ...
    obj18.onPress = tmp7;
    obj17.children = closure_6(tmp2(5027).BaseTextButton, obj18);
