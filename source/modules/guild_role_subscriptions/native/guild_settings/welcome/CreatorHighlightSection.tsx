...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp6.isLoading) {
    ...
    obj5.source = obj6;
    const items1 = [closure_6(tmp5(5668), obj5), ];
    ...
    items3[1] = closure_6(tmp2(4632).Text, obj10);
    ...
    items3[2] = closure_6(tmp2(4632).Text, obj11);
    ...
    if (tmp9Result) {
      ...
      const items5 = [tmp11(tmp2(4632).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4632).Text, obj16);
      }
    ...
    obj18.onPress = tmp7;
    obj17.children = closure_6(tmp2(5057).BaseTextButton, obj18);
