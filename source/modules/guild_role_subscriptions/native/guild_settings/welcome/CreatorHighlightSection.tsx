...
// Dependencies: [19, 17, 21, 4639, 576, 4635, 1177, 10433, 1115, 7086, 17863, 4334, 17835, 5672, 15334, 5060, 2]
// Exports: default

// Module 17862 (CreatorHighlightSection)
...
function GuildServerSubscriberCount(arg0) {
  ...
  items[2] = style;
  obj.style = items;
  const items1 = [timestampProducer(Text_Text.Text, { style: tmp.subscriberCount, variant: "text-sm/medium", color: "text-overlay-light", children: subscriberCount }), timestampProducer(native.Icon, { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10433 }), ];
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp6 = guild_id(17863)(guild_id, 3, 60);
  dependencyMap = tmp6;
  const hasAllImperativeDetails = tmp6.hasAllImperativeDetails;
  let items = [hasAllImperativeDetails, tmp6];
  if (tmp6.isLoading) {
    const obj2 = { style: tmp.cardContainer, children: closure_6(tmp5(17835), {}) };
    ...
    obj5.source = obj6;
    const items1 = [closure_6(tmp5(5672), obj5), ];
    ...
    items3[1] = closure_6(tmp2(4635).Text, obj10);
    ...
    items3[2] = closure_6(tmp2(4635).Text, obj11);
    ...
    if (tmp9Result) {
      ...
      const items5 = [tmp11(tmp2(4635).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4635).Text, obj16);
      }
    ...
    obj18.onPress = tmp7;
    obj17.children = closure_6(tmp2(5060).BaseTextButton, obj18);
