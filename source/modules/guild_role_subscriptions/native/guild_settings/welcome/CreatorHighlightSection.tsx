...
// Dependencies: [19, 17, 21, 4607, 576, 4603, 1178, 10393, 1114, 7053, 17795, 4301, 17767, 5639, 15301, 5028, 2]
// Exports: default

// Module 17794 (CreatorHighlightSection)
...
function GuildServerSubscriberCount(arg0) {
  ...
  items[2] = style;
  obj.style = items;
  const items1 = [timestampProducer(Text_Text.Text, { style: tmp.subscriberCount, variant: "text-sm/medium", color: "text-overlay-light", children: subscriberCount }), timestampProducer(native.Icon, { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10393 }), ];
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp6 = guild_id(17795)(guild_id, 3, 60);
  dependencyMap = tmp6;
  const hasAllImperativeDetails = tmp6.hasAllImperativeDetails;
  let items = [hasAllImperativeDetails, tmp6];
  if (tmp6.isLoading) {
    const obj2 = { style: tmp.cardContainer, children: closure_6(tmp5(17767), {}) };
    ...
    obj5.source = obj6;
    const items1 = [closure_6(tmp5(5639), obj5), ];
    ...
    const items2 = [closure_6(tmp2(4603).Text, obj8), ];
    ...
    items3[1] = closure_6(tmp2(4603).Text, obj10);
    ...
    obj11.children = intl.format(tmp2(1114).t.m0b6Kj, obj12);
    items3[2] = closure_6(tmp2(4603).Text, obj11);
    ...
    if (tmp9Result) {
      ...
      obj14.children = intl3.string(tmp2(1114).t.wg53L8);
      const items5 = [tmp11(tmp2(4603).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4603).Text, obj16);
      }
    ...
    obj18.text = intl4.string(tmp2(1114).t.mQ2IGa);
    obj18.onPress = tmp7;
    obj17.children = closure_6(tmp2(5028).BaseTextButton, obj18);
