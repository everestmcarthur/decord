...
// Dependencies: [19, 17, 21, 4605, 576, 4601, 1178, 10372, 1114, 7031, 17803, 4299, 17775, 5637, 15321, 5026, 2]
// Exports: default
...
function GuildServerSubscriberCount(arg0) {
  ...
  items[2] = style;
  obj.style = items;
  const items1 = [timestampProducer(Text_Text.Text, { style: tmp.subscriberCount, variant: "text-sm/medium", color: "text-overlay-light", children: subscriberCount }), timestampProducer(native.Icon, { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10372 }), ];
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp6.isLoading) {
    const obj2 = { style: tmp.cardContainer, children: closure_6(tmp5(17775), {}) };
    ...
    obj5.source = obj6;
    const items1 = [closure_6(tmp5(5637), obj5), ];
    ...
    items3[1] = closure_6(tmp2(4601).Text, obj10);
    ...
    items3[2] = closure_6(tmp2(4601).Text, obj11);
    ...
    if (tmp9Result) {
      ...
      const items5 = [tmp11(tmp2(4601).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4601).Text, obj16);
      }
    ...
    obj18.onPress = tmp7;
    obj17.children = closure_6(tmp2(5026).BaseTextButton, obj18);
