...
// Dependencies: [19, 17, 21, 4638, 576, 4634, 1177, 10441, 1115, 7089, 17919, 4332, 17891, 5673, 15350, 5061, 2]
// Exports: default

// Module 17918 (CreatorHighlightSection)
...
function GuildServerSubscriberCount(arg0) {
  ...
  items[2] = style;
  obj.style = items;
  const items1 = [timestampProducer(Text_Text.Text, { style: tmp.subscriberCount, variant: "text-sm/medium", color: "text-overlay-light", children: subscriberCount }), timestampProducer(native.Icon, { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10441 }), ];
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp6 = guild_id(17919)(guild_id, 3, 60);
  dependencyMap = tmp6;
  const hasAllImperativeDetails = tmp6.hasAllImperativeDetails;
  let items = [hasAllImperativeDetails, tmp6];
  if (tmp6.isLoading) {
    const obj2 = { style: tmp.cardContainer, children: closure_6(tmp5(17891), {}) };
    ...
    obj5.source = obj6;
    const items1 = [closure_6(tmp5(5673), obj5), ];
    ...
    const items2 = [closure_6(tmp2(4634).Text, obj8), ];
    ...
    items3[1] = closure_6(tmp2(4634).Text, obj10);
    ...
    items3[2] = closure_6(tmp2(4634).Text, obj11);
    ...
    if (tmp9Result) {
      ...
      const items5 = [tmp11(tmp2(4634).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4634).Text, obj16);
      }
    ...
    obj18.onPress = tmp7;
    obj17.children = closure_6(tmp2(5061).BaseTextButton, obj18);
