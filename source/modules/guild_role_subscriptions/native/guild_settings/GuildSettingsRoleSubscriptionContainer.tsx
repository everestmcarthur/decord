...
// Dependencies: [19, 17, 1979, 1074, 21, 4606, 504, 17796, 12316, 17769, 1114, 15274, 17810, 2]
// Exports: default

// Module 17820 (GuildSettingsRoleSubscriptionContainer)
import GroupListingsFetchContext from "GroupListingsFetchContext" /* 15274 */;
import useOnboardingMonetizationEnableFlowDefault from "useOnboardingMonetizationEnableFlow" /* 17796 */;
...
function ApplicationRejectedNotice(guildId) {
  ...
  if (null != resubmissionError) {
    ...
    let tmp14 = closure_7(tmp9(12316), obj2);
    const tmp9Result = tmp9(12316);
  } else if (null != requestRejectedNoticeText) {
    const obj3 = { notice: requestRejectedNoticeText };
    tmp14 = closure_7(tmp9(17769), obj3);
  } else if (tmp13) {
    const obj4 = { notice: null };
    const intl3 = tmp2(1114).intl;
    obj4.notice = intl3.string(tmp2(1114).t.MyJpJT);
    tmp14 = closure_7(tmp9(17769), obj4);
    const tmp9Result5 = tmp9(17769);
    ...
    tmp14 = closure_7(tmp9(17769), obj5);
    const tmp9Result6 = tmp9(17769);
  } else if (true === hasItem1) {
    const obj6 = { notice: null };
    const intl = tmp2(1114).intl;
    obj6.notice = intl.string(tmp2(1114).t.e2g9sW);
    tmp14 = closure_7(tmp9(17769), obj6);
    const tmp9Result7 = tmp9(17769);
  } else {
    tmp14 = null;
    if (true === hasItem) {
      ...
      tmp14 = closure_7(tmp9(17769), obj7);
      const tmp9Result8 = tmp9(17769);
    }
  }
  let tmp24 = null;
  if (null != tmp14) {
