...
// Dependencies: [19, 17, 1980, 1074, 21, 4638, 504, 17921, 12365, 17894, 1115, 15323, 17935, 2]
// Exports: default

// Module 17945 (GuildSettingsRoleSubscriptionContainer)
import GroupListingsFetchContext from "GroupListingsFetchContext" /* 15323 */;
import useOnboardingMonetizationEnableFlowDefault from "useOnboardingMonetizationEnableFlow" /* 17921 */;
...
function ApplicationRejectedNotice(guildId) {
  ...
  if (null != resubmissionError) {
    ...
    let tmp14 = closure_7(tmp9(12365), obj2);
    const tmp9Result = tmp9(12365);
  } else if (null != requestRejectedNoticeText) {
    const obj3 = { notice: requestRejectedNoticeText };
    tmp14 = closure_7(tmp9(17894), obj3);
  } else if (tmp13) {
    const obj4 = { notice: null };
    const intl3 = tmp2(1115).intl;
    obj4.notice = intl3.string(tmp2(1115).t.MyJpJT);
    tmp14 = closure_7(tmp9(17894), obj4);
    const tmp9Result5 = tmp9(17894);
    ...
    tmp14 = closure_7(tmp9(17894), obj5);
    const tmp9Result6 = tmp9(17894);
  } else if (true === hasItem1) {
    const obj6 = { notice: null };
    const intl = tmp2(1115).intl;
    obj6.notice = intl.string(tmp2(1115).t.e2g9sW);
    tmp14 = closure_7(tmp9(17894), obj6);
    const tmp9Result7 = tmp9(17894);
  } else {
    tmp14 = null;
    if (true === hasItem) {
      ...
      tmp14 = closure_7(tmp9(17894), obj7);
      const tmp9Result8 = tmp9(17894);
    }
  }
  let tmp24 = null;
  if (null != tmp14) {
