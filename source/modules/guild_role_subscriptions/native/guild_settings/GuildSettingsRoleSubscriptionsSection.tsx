...
// Dependencies: [19, 1975, 1371, 1074, 21, 504, 5739, 1114, 5657, 17611, 17612, 17613, 17614, 7334, 2]
// Exports: default

// Module 17610 (GuildSettingsRoleSubscriptionsSection)
import initialize from "initialize" /* 504 */;
import util from "util" /* 1114 */;
import TableRow from "TableRow" /* 5657 */;
import TableRowGroup from "TableRowGroup" /* 5739 */;
import _modDef17611 from "module_17611" /* 17611 */;
...
function HasCreatedListingsSection(arg0) {
  ...
  obj3.icon = closure_7(TableRow.TableRow.Icon, { source: _modDef17611 });
  ...
  const obj4 = { source: _modDef17611 };
  obj5.icon = closure_7(TableRow.TableRow.Icon, { source: _modDef17612 });
  ...
  if (stateFromStores) {
    ...
    const obj8 = { source: tmp6(17613) };
    obj7.icon = tmp5(tmp(5657).TableRow.Icon, obj8);
    obj7.onPress = function onPress() {
      return importDefault(constants2.ROLE_SUBSCRIPTIONS_PAYMENTS, { guildId: id.id });
    };
    stateFromStores = tmp5(tmp(5657).TableRow, obj7, "guild-role-subscriptions-payments");
  }
  ...
  const obj6 = { source: _modDef17612 };
  obj9.icon = closure_7(TableRow.TableRow.Icon, { source: _modDef17614 });
