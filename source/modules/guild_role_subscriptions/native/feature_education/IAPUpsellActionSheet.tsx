...
// Dependencies: [19, 1074, 1964, 1954, 21, 16278, 16279, 1114, 1100, 2]
// Exports: default

// Module 16277 (IAPUpsellActionSheet)
...
export default function IAPUpsellActionSheet(arg0) {
  ...
  const obj = { imageSource: markAsDismissed(16279), header: null, body: null, cta: null, onCTAPress: null, markAsDismissed: null };
  ...
  return jsx(markAsDismissed(16278), { imageSource: markAsDismissed(16279), header: null, body: null, cta: null, onCTAPress: null, markAsDismissed: null });
};
