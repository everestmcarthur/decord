...
// Dependencies: [19, 1074, 1965, 1955, 21, 16502, 16503, 1115, 1101, 2]
// Exports: default

// Module 16501 (IAPUpsellActionSheet)
...
export default function IAPUpsellActionSheet(arg0) {
  ...
  const obj = { imageSource: markAsDismissed(16503), header: null, body: null, cta: null, onCTAPress: null, markAsDismissed: null };
  ...
  return jsx(markAsDismissed(16502), { imageSource: markAsDismissed(16503), header: null, body: null, cta: null, onCTAPress: null, markAsDismissed: null });
};
