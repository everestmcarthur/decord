...
// Dependencies: [19, 1074, 1964, 1954, 21, 16327, 16328, 1114, 1100, 2]
// Exports: default

// Module 16326 (IAPUpsellActionSheet)
...
export default function IAPUpsellActionSheet(arg0) {
  ...
  const obj = { imageSource: markAsDismissed(16328), header: null, body: null, cta: null, onCTAPress: null, markAsDismissed: null };
  ...
  return jsx(markAsDismissed(16327), { imageSource: markAsDismissed(16328), header: null, body: null, cta: null, onCTAPress: null, markAsDismissed: null });
};
