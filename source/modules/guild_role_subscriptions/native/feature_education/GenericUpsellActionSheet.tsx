...
// Dependencies: [19, 17, 1954, 21, 4605, 576, 8233, 7202, 5637, 7206, 4601, 1178, 5025, 2]
// Exports: default
...
export default function GenericUpsellActionSheet(markAsDismissed) {
  ...
  const tmp = closure_7();
  const bottomSheetRef1 = markAsDismissed(8233).useBottomSheetRef();
  ...
  return closure_5(markAsDismissed(7202).BottomSheet, obj2);
};
