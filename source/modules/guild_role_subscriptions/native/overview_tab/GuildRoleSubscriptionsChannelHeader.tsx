...
// Dependencies: [19, 17, 21, 4722, 576, 1177, 13021, 4718, 1115, 2]

// Module 13511 (GuildRoleSubscriptionsChannelHeader)
...
export default noop.memo(function GuildRoleSubscriptionsChannelHeader() {
  ...
  const items = [React4(native.Icon, { source: _modDef13021, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
