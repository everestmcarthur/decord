...
// Dependencies: [19, 17, 21, 4605, 576, 1178, 12849, 4601, 1114, 2]

// Module 13339 (GuildRoleSubscriptionsChannelHeader)
...
export default noop.memo(function GuildRoleSubscriptionsChannelHeader() {
  ...
  const items = [React4(native.Icon, { source: _modDef12849, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
