...
// Dependencies: [19, 17, 1074, 1955, 21, 4639, 7257, 5672, 16353, 4635, 1115, 5059, 9195, 2]
// Exports: default

// Module 16352 (GuildRoleSubscriptionsUpsellActionSheet)
...
export default function GuildRoleSubscriptionsUpsellActionSheet(arg0) {
  ...
  const obj2 = { source: _modDef16353 };
