...
// Dependencies: [19, 17, 1074, 1955, 21, 4640, 7264, 5675, 16403, 4636, 1115, 5062, 9217, 2]
// Exports: default

// Module 16402 (GuildRoleSubscriptionsUpsellActionSheet)
...
export default function GuildRoleSubscriptionsUpsellActionSheet(arg0) {
  ...
  const obj2 = { source: _modDef16403 };
