...
// Dependencies: [19, 17, 1074, 1954, 21, 4574, 7164, 5601, 16276, 4570, 1114, 4989, 9095, 2]
// Exports: default

// Module 16275 (GuildRoleSubscriptionsUpsellActionSheet)
...
export default function GuildRoleSubscriptionsUpsellActionSheet(arg0) {
  ...
  const obj2 = { source: _modDef16276 };
