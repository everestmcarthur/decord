...
// Dependencies: [19, 17, 1965, 21, 4638, 576, 7307, 7259, 1177, 12922, 1115, 8728, 16229, 11106, 2]
// Exports: default

// Module 16336 (GuildRoleSubscriptionsChannelLongPressActionSheet)
...
import _modDef16229 from "module_16229" /* 16229 */;
...
export default function GuildRoleSubscriptionsChannelLongPressActionSheet(arg0) {
  ...
  const tmp = closure_7();
  obj3.children = closure_5(native.Icon, { disableColor: true, source: _modDef12922 });
  ...
  const obj4 = { disableColor: true, source: _modDef12922 };
  obj5.leading = closure_5(native.Icon, { source: _modDef16229 });
