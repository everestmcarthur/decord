...
// Dependencies: [19, 1074, 1964, 10209, 21, 4607, 576, 1100, 4574, 16277, 1896, 12474, 1114, 12874, 2]
// Exports: default
...
export default function GuildRoleSubscriptionsRow(selected) {
  ...
  const callback1 = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16277, dependencyMap.paths), c1, {
      guildId: id,
      onClose() {
  ...
  const ChannelModes = id(12474).ChannelModes;
  if (selected) {
  ...
  obj2.mode = DEFAULT;
  obj.name = jsx(tmp6(12474).BaseChannelName, { name: null, mode: null });
  obj.icon = jsx(tmp6(12474).BaseChannelIcon, { disableColor: true, mode: DEFAULT, source: _modDef12874 });
