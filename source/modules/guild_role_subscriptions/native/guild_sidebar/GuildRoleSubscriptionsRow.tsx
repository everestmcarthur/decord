...
// Dependencies: [19, 1074, 1964, 10188, 21, 4605, 576, 1100, 4572, 16288, 1896, 12449, 1114, 12849, 2]
// Exports: default

// Module 16287 (GuildRoleSubscriptionsRow)
...
export default function GuildRoleSubscriptionsRow(selected) {
  ...
  const callback1 = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16288, dependencyMap.paths), c1, {
      guildId: id,
      onClose() {
  ...
  const ChannelModes = id(12449).ChannelModes;
  if (selected) {
  ...
  obj2.mode = DEFAULT;
  obj.name = jsx(tmp6(12449).BaseChannelName, { name: null, mode: null });
  obj.icon = jsx(tmp6(12449).BaseChannelIcon, { disableColor: true, mode: DEFAULT, source: _modDef12849 });
