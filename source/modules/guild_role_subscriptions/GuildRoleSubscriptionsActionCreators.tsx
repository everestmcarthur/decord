...
// Dependencies: [32, 5, 1074, 7329, 573, 4930, 7330, 1242, 4786, 4635, 1090, 2]
...
// Module 7328 (GuildRoleSubscriptionsActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import GuildRoleSubscriptionsHttpApiAll from "GuildRoleSubscriptionsHttpApi" /* 7329 */;
...
let closure_18 = async function _fetchGuildRoleSubscriptionGroupListing() {
  ...
  closure_131_2 = obj4;
  await "PX_16";
  closure_131_3 = await closure_132_2(closure_132_3[3]).getGuildRoleSubscriptionGroupListing(closure_131_0, closure_131_1, closure_131_2);
  closure_132_1(closure_132_3[4]).dispatch({ type: "GUILD_ROLE_SUBSCRIPTIONS_UPDATE_GROUP_LISTING", listing: closure_131_3 });
...
let closure_19 = async function _createSubscriptionListing() {
  ...
  await "PX_16";
  closure_129_5 = await closure_130_2(closure_130_3[3]).createGuildRoleSubscriptionListing(closure_129_0, closure_129_1, closure_129_2);
  const merged = Object.assign(closure_130_0(closure_130_3[8]).collectGuildAnalyticsMetadata(closure_129_0));
  closure_130_1(closure_130_3[7]).track(closure_130_6.ROLE_SUBSCRIPTION_LISTING_CREATED, { role_subscription_listing_id: closure_129_5.id, role_subscription_group_listing_id: closure_129_1, template_name: closure_129_3.templateCategory, has_change_from_template: closure_129_3.hasChangeFromTemplate });
...
let closure_20 = async function _updateSubscriptionListing() {
  ...
  await "PX_16";
  closure_129_4 = await closure_130_2(closure_130_3[3]).updateGuildRoleSubscriptionListing(closure_129_0, closure_129_2, closure_129_1, closure_129_3);
