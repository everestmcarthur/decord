...
// Dependencies: [1957, 1979, 4597, 4222, 2011, 1371, 5432, 1962, 5428, 1074, 4217, 10924, 5439, 4727, 5431, 1332, 504, 573, 2]

// Module 11491 (StageChannelSelfRichPresenceStore)
        ...
        if (obj2.canEveryone(constants2.VIEW_CHANNEL, channel)) {
          ...
          if (null != guild) {
            ...
            if (features.has(constants.DISCOVERABLE)) {
              ...
              const mutableParticipants = StageChannelParticipantStore.getMutableParticipants(channel.id, tmp12(5439).StageChannelParticipantNamedIndex.SPEAKER);
              ...
              if (topic == null) {
                topic = tmp12(4727).computeChannelName(channel, UserStore, RelationshipStore);
                const tmp12Result = tmp12(4727);
              }
              obj.name = topic;
