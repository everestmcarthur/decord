...
// Dependencies: [1958, 1980, 4662, 4288, 2012, 1372, 5503, 1963, 5499, 1074, 4283, 11025, 5510, 4792, 5502, 1331, 504, 573, 2]
        ...
        if (obj2.canEveryone(constants2.VIEW_CHANNEL, channel)) {
          ...
          if (null != guild) {
            ...
            if (features.has(constants.DISCOVERABLE)) {
              ...
              const mutableParticipants = StageChannelParticipantStore.getMutableParticipants(channel.id, tmp12(5510).StageChannelParticipantNamedIndex.SPEAKER);
              ...
              if (topic == null) {
                topic = tmp12(4792).computeChannelName(channel, UserStore, RelationshipStore);
                const tmp12Result = tmp12(4792);
              }
              obj.name = topic;
