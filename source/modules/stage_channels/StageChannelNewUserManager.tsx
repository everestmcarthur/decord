...
// Dependencies: [502, 2012, 5507, 5500, 1899, 573, 510, 13072, 2]

// Module 13071 (StageChannelNewUserManager)
...
let require = fn;
let closure_7 = fn(5500).STAGE_AUDIENCE_NOTICE_SHOWN_STORAGE_KEY;
