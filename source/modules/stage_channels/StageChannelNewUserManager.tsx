...
// Dependencies: [502, 2012, 5509, 5502, 1899, 573, 510, 13080, 2]

// Module 13079 (StageChannelNewUserManager)
...
let require = fn;
let closure_7 = fn(5502).STAGE_AUDIENCE_NOTICE_SHOWN_STORAGE_KEY;
