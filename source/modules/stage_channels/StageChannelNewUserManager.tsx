...
// Dependencies: [502, 2012, 5506, 5499, 1899, 573, 510, 13064, 2]

// Module 13063 (StageChannelNewUserManager)
...
let require = fn;
let closure_7 = fn(5499).STAGE_AUDIENCE_NOTICE_SHOWN_STORAGE_KEY;
