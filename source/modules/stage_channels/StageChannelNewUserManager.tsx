...
// Dependencies: [502, 2011, 5473, 5466, 1898, 573, 510, 13024, 2]

// Module 13023 (StageChannelNewUserManager)
...
let require = fn;
let closure_7 = fn(5466).STAGE_AUDIENCE_NOTICE_SHOWN_STORAGE_KEY;
