...
// Dependencies: [4660, 502, 1958, 1980, 4276, 4286, 5505, 1372, 4657, 4662, 5507, 1963, 4272, 12, 5511, 4690, 1331, 504, 573, 2]

// Module 5504 (StageChannelParticipantStore)
import _modDef12 from "module_12" /* 12 */;
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import _modDef1331 from "module_1331" /* 1331 */;
import StageChannelParticipantsDefault from "StageChannelParticipants" /* 5511 */;
...
function updateParticipant(arg0) {
  ...
  f80415 = (dependencyMap) => dependencyMap.updateParticipant(f80415);
  if (mapped === undefined) {
...
function handleUserUpdate(user) {
  ...
  const f80415 = (dependencyMap) => dependencyMap.updateParticipant(f80415);
  let mapped1 = mapped;
  if (mapped === undefined) {
    const values2 = secondaryIndexMap.values(undefined, true);
...
function handleStreamClose(streamKey) {
  const decodeStreamKeyResult = f80415(4690).decodeStreamKey(streamKey.streamKey);
...
const secondaryIndexMap = new fn(4272).SecondaryIndexMap((getGuildId) => {
...
const stageChannelParticipantStore = new StageChannelParticipantStore(DispatcherDefault, {
  ...
  CHANNEL_UPDATES: function handleChannelUpdate(channels) {
    ...
    const f80419 = (rebuild) => rebuild.rebuild();
    let mapped = reduced;
