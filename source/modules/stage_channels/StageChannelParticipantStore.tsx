...
// Dependencies: [4661, 502, 1958, 1980, 4278, 4288, 5504, 1372, 4658, 4663, 5506, 1963, 4274, 12, 5510, 4691, 1331, 504, 573, 2]

// Module 5503 (StageChannelParticipantStore)
import _modDef12 from "module_12" /* 12 */;
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import _modDef1331 from "module_1331" /* 1331 */;
import StageChannelParticipantsDefault from "StageChannelParticipants" /* 5510 */;
...
function updateParticipant(arg0) {
  ...
  f80155 = (dependencyMap) => dependencyMap.updateParticipant(f80155);
  if (mapped === undefined) {
...
function handleUserUpdate(user) {
  ...
  const f80155 = (dependencyMap) => dependencyMap.updateParticipant(f80155);
  let mapped1 = mapped;
  if (mapped === undefined) {
    const values2 = secondaryIndexMap.values(undefined, true);
...
function handleStreamClose(streamKey) {
  const decodeStreamKeyResult = f80155(4691).decodeStreamKey(streamKey.streamKey);
...
const secondaryIndexMap = new fn(4274).SecondaryIndexMap((getGuildId) => {
...
const stageChannelParticipantStore = new StageChannelParticipantStore(DispatcherDefault, {
  ...
  CHANNEL_UPDATES: function handleChannelUpdate(channels) {
    ...
    const f80159 = (rebuild) => rebuild.rebuild();
    let mapped = reduced;
