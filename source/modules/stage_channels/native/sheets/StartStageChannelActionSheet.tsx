...
// Dependencies: [5, 32, 19, 17, 1962, 5465, 1074, 1963, 21, 4606, 576, 504, 5473, 5043, 1242, 1874, 8484, 4573, 4507, 8493, 4602, 1114, 7223, 7196, 6677, 8496, 5026, 2]
// Exports: default

// Module 8483 (StartStageChannelActionSheet)
...
const StageChannelsConstants = fn(5465);
...
export default function StartStageChannelEventActionSheet(channel) {
      ...
      try {
        ...
        if (0 === c4) {
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp33(8484).editStage(channel, tmp53, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp33(8484);
                c4 = 2;
                c5 = 1;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp45;
            const aPIError = new channel(4507).APIError(closure_128_1);
            ...
            tmp3(4573).hideActionSheet(closure_1_10);
            dependencyMap = 0;
            const obj2 = tmp3(4573);
          }
          dependencyMap = 0;
          c5 = 3;
  ...
  const shouldAgeVerifyToSpeakForCurrentUser = channel(5473).useShouldAgeVerifyToSpeakForCurrentUser(channel.id);
  ...
  const items1 = [closure_13(stateFromStores(8493), {}), , ];
  ...
  items1[1] = closure_13(channel(4602).Text, obj5);
  ...
  items1[2] = closure_13(channel(4602).Text, obj6);
  obj4.children = items1;
  let stringResult2;
  const tmp11 = stateFromStores;
  const tmp2Result = channel(5473);
  if (null == stateFromStores) {
  ...
  items2[1] = closure_13(channel(6677).TextInput, obj8);
  items2[2] = closure_13(tmp11(8496), {
    onConfirmPress() {
  ...
  if (null != obj3) {
    ...
    tmp15Result = tmp15(tmp2(4602).Text, obj10);
  }
  ...
  obj11.children = closure_13(channel(5026).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(4602).Text, obj13);
  }
  ...
  return closure_13(channel(7223).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7196).SafeAreaPaddingView, obj7) });
};
