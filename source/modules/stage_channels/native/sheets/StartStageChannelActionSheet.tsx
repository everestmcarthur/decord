...
// Dependencies: [5, 32, 19, 17, 1963, 5499, 1074, 1964, 21, 4639, 576, 504, 5507, 5076, 1241, 1875, 8519, 4606, 4540, 8528, 4635, 1115, 7257, 7230, 6711, 8531, 5059, 2]
// Exports: default

// Module 8518 (StartStageChannelActionSheet)
...
export default function StartStageChannelEventActionSheet(channel) {
      ...
      try {
        ...
        if (0 === c4) {
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp33(8519).editStage(channel, tmp53, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp33(8519);
                c4 = 2;
                c5 = 1;
          ...
          if (1 === tmp7) {
            ...
            tmp3(4606).hideActionSheet(closure_1_10);
            dependencyMap = 0;
            const obj2 = tmp3(4606);
          }
          dependencyMap = 0;
          c5 = 3;
  ...
  const shouldAgeVerifyToSpeakForCurrentUser = channel(5507).useShouldAgeVerifyToSpeakForCurrentUser(channel.id);
  stateFromStores(5076)(() => {
    let id;
    if (stateFromStores != null) {
  ...
  const items1 = [closure_13(stateFromStores(8528), {}), , ];
  ...
  items1[1] = closure_13(channel(4635).Text, obj5);
  ...
  items1[2] = closure_13(channel(4635).Text, obj6);
  obj4.children = items1;
  let stringResult2;
  const tmp11 = stateFromStores;
  const tmp2Result = channel(5507);
  if (null == stateFromStores) {
  ...
  items2[1] = closure_13(channel(6711).TextInput, obj8);
  items2[2] = closure_13(tmp11(8531), {
    onConfirmPress() {
  ...
  if (null != obj3) {
    ...
    tmp15Result = tmp15(tmp2(4635).Text, obj10);
  }
  ...
  obj11.children = closure_13(channel(5059).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(4635).Text, obj13);
  }
  ...
  return closure_13(channel(7257).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7230).SafeAreaPaddingView, obj7) });
};
