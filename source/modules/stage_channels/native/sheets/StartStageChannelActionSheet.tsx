...
export default function StartStageChannelEventActionSheet(channel) {
      ...
      try {
        ...
        if (0 === c4) {
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp33(8516).editStage(channel, tmp53, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp33(8516);
                c4 = 2;
                c5 = 1;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp45;
            const aPIError = new channel(4537).APIError(closure_128_1);
  ...
  if (null != obj3) {
    ...
    tmp15Result = tmp15(tmp2(4632).Text, obj10);
  }
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(4632).Text, obj13);
  }
