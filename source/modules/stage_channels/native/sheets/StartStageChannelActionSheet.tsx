...
// Dependencies: [5, 32, 19, 17, 1963, 5500, 1074, 1964, 21, 4638, 576, 504, 5508, 5077, 1241, 1875, 8528, 4605, 4538, 8537, 4634, 1115, 7260, 7233, 6714, 8540, 5060, 2]
// Exports: default

// Module 8527 (StartStageChannelActionSheet)
...
const StageChannelsConstants = fn(5500);
...
let closure_12 = fn(1964).GuildScheduledEventPrivacyLevel;
const jsxProd = fn(21);
...
export default function StartStageChannelEventActionSheet(channel) {
      ...
      try {
        ...
        if (0 === c4) {
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp33(8528).editStage(channel, tmp53, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp33(8528);
                c4 = 2;
                c5 = 1;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp45;
            const aPIError = new channel(4538).APIError(closure_128_1);
            ...
            tmp3(4605).hideActionSheet(closure_1_10);
            dependencyMap = 0;
            const obj2 = tmp3(4605);
          }
          dependencyMap = 0;
          c5 = 3;
  ...
  const shouldAgeVerifyToSpeakForCurrentUser = channel(5508).useShouldAgeVerifyToSpeakForCurrentUser(channel.id);
  stateFromStores(5077)(() => {
    let id;
    if (stateFromStores != null) {
  ...
  const items1 = [closure_13(stateFromStores(8537), {}), , ];
  ...
  items1[1] = closure_13(channel(4634).Text, obj5);
  ...
  items1[2] = closure_13(channel(4634).Text, obj6);
  obj4.children = items1;
  let stringResult2;
  const tmp11 = stateFromStores;
  const tmp2Result = channel(5508);
  if (null == stateFromStores) {
  ...
  items2[1] = closure_13(channel(6714).TextInput, obj8);
  items2[2] = closure_13(tmp11(8540), {
    onConfirmPress() {
  ...
  if (null != obj3) {
    ...
    tmp15Result = tmp15(tmp2(4634).Text, obj10);
  }
  ...
  obj11.children = closure_13(channel(5060).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(4634).Text, obj13);
  }
  ...
  return closure_13(channel(7260).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7233).SafeAreaPaddingView, obj7) });
};
