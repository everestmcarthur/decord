...
// Dependencies: [5, 32, 19, 17, 1962, 5466, 1074, 1963, 21, 4607, 576, 504, 5474, 5044, 1242, 1874, 8486, 4574, 4508, 8495, 4603, 1114, 7224, 7197, 6678, 8498, 5027, 2]
// Exports: default

// Module 8485 (StartStageChannelActionSheet)
...
const StageChannelsConstants = fn(5466);
...
export default function StartStageChannelEventActionSheet(channel) {
      ...
      try {
        ...
        if (0 === c4) {
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp33(8486).editStage(channel, tmp53, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp33(8486);
                c4 = 2;
                c5 = 1;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp45;
            const aPIError = new channel(4508).APIError(closure_128_1);
            ...
            tmp3(4574).hideActionSheet(closure_1_10);
            dependencyMap = 0;
            const obj2 = tmp3(4574);
          }
          dependencyMap = 0;
          c5 = 3;
  ...
  const shouldAgeVerifyToSpeakForCurrentUser = channel(5474).useShouldAgeVerifyToSpeakForCurrentUser(channel.id);
  stateFromStores(5044)(() => {
    let id;
    if (stateFromStores != null) {
  ...
  const items1 = [closure_13(stateFromStores(8495), {}), , ];
  ...
  items1[1] = closure_13(channel(4603).Text, obj5);
  ...
  items1[2] = closure_13(channel(4603).Text, obj6);
  obj4.children = items1;
  let stringResult2;
  const tmp11 = stateFromStores;
  const tmp2Result = channel(5474);
  if (null == stateFromStores) {
  ...
  items2[1] = closure_13(channel(6678).TextInput, obj8);
  items2[2] = closure_13(tmp11(8498), {
    onConfirmPress() {
  ...
  if (null != obj3) {
    ...
    tmp15Result = tmp15(tmp2(4603).Text, obj10);
  }
  ...
  obj11.children = closure_13(channel(5027).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(4603).Text, obj13);
  }
  ...
  return closure_13(channel(7224).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7197).SafeAreaPaddingView, obj7) });
};
