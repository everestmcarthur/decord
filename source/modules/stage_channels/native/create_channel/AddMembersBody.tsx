...
// Function ID: 9835
// Name: AddMembersBody
// Dependencies: [109, 32, 19, 17, 2021, 2015, 1371, 8466, 1085, 21, 4605, 576, 4248, 7033, 504, 4592, 9808, 1178, 1114, 9821, 4316, 6677, 9825, 5569, 4601, 9830, 2]
// Exports: default

// Module 9834 (AddMembersBody)
...
export default function AddMembersBody(pendingAdditions) {
  ...
  if (first) {
    ...
    if (tmp19) {
      items2 = tmp10(9808).getNoRolesRow();
      const tmp10Result3 = tmp10(9808);
    }
  }
  let obj5 = guild(504);
  ...
  if (inActionSheet) {
    let BottomSheetScrollView = tmp6(6677).BottomSheetScrollView;
  } else {
    BottomSheetScrollView = c8;
  }
  if (inActionSheet) {
    let BottomSheetSectionList = tmp6(6677).BottomSheetSectionList;
  } else {
  ...
  obj9.children = closure_16(pendingAdditions(9825), obj10);
  ...
  if (null != inputDesc) {
    ...
    obj11.children = tmp27(tmp6(4601).Text, obj12);
  ...
  if ("" !== str) {
    if (0 === items2.length) {
      if (0 === membersRows.length) {
        ...
        const obj16 = { Illustration: tmp6(9830).NoResultsAlt, style: null, bodyStyle: null, body: null };
  ...
  obj19.contentContainerStyle = { paddingHorizontal: pendingAdditions(576).space.PX_16, paddingBottom: pendingAdditions(576).space.PX_16 + pendingAdditions(7033)(obj).insets.bottom };
