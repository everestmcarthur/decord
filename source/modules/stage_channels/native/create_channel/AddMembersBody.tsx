...
// Function ID: 9916
// Name: AddMembersBody
// Dependencies: [109, 32, 19, 17, 2022, 2016, 1372, 8550, 1085, 21, 4640, 576, 4283, 7095, 504, 4627, 9889, 1177, 1115, 9902, 4351, 6738, 9906, 5607, 4636, 9911, 2]
// Exports: default

// Module 9915 (AddMembersBody)
...
const ChannelPermissionsConstants = fn(8550);
...
export default function AddMembersBody(pendingAdditions) {
  ...
  if (first) {
    ...
    if (tmp19) {
      items2 = tmp10(9889).getNoRolesRow();
      const tmp10Result3 = tmp10(9889);
    }
  }
  let obj5 = guild(504);
  ...
  if (inActionSheet) {
    let BottomSheetScrollView = tmp6(6738).BottomSheetScrollView;
  } else {
    BottomSheetScrollView = c8;
  }
  if (inActionSheet) {
    let BottomSheetSectionList = tmp6(6738).BottomSheetSectionList;
  } else {
  ...
  obj9.children = closure_16(pendingAdditions(9906), obj10);
  ...
  if (null != inputDesc) {
    ...
    obj11.children = tmp27(tmp6(4636).Text, obj12);
  ...
  if ("" !== str) {
    if (0 === items2.length) {
      if (0 === membersRows.length) {
        ...
        const obj16 = { Illustration: tmp6(9911).NoResultsAlt, style: null, bodyStyle: null, body: null };
  ...
  const tmp4Result = pendingAdditions(9906);
  obj19.contentContainerStyle = { paddingHorizontal: pendingAdditions(576).space.PX_16, paddingBottom: pendingAdditions(576).space.PX_16 + pendingAdditions(7095)(obj).insets.bottom };
