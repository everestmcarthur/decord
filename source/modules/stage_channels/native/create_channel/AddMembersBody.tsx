...
// Function ID: 9797
// Name: AddMembersBody
// Dependencies: [109, 32, 19, 17, 2021, 2015, 1371, 8429, 1085, 21, 4574, 576, 4217, 6995, 504, 4561, 9770, 1178, 1114, 9783, 4285, 6641, 9787, 5533, 4570, 9792, 2]
// Exports: default

// Module 9796 (AddMembersBody)
...
export default function AddMembersBody(pendingAdditions) {
  ...
  if (first) {
    ...
    if (tmp19) {
      items2 = tmp10(9770).getNoRolesRow();
      const tmp10Result3 = tmp10(9770);
    }
  }
  let obj5 = guild(504);
  ...
  if (inActionSheet) {
    let BottomSheetScrollView = tmp6(6641).BottomSheetScrollView;
  } else {
    BottomSheetScrollView = c8;
  }
  if (inActionSheet) {
    let BottomSheetSectionList = tmp6(6641).BottomSheetSectionList;
  } else {
  ...
  obj9.children = closure_16(pendingAdditions(9787), obj10);
  ...
  if (null != inputDesc) {
    ...
    obj11.children = tmp27(tmp6(4570).Text, obj12);
  ...
  if ("" !== str) {
    if (0 === items2.length) {
      if (0 === membersRows.length) {
        ...
        const obj16 = { Illustration: tmp6(9792).NoResultsAlt, style: null, bodyStyle: null, body: null };
  ...
  obj19.contentContainerStyle = { paddingHorizontal: pendingAdditions(576).space.PX_16, paddingBottom: pendingAdditions(576).space.PX_16 + pendingAdditions(6995)(obj).insets.bottom };
