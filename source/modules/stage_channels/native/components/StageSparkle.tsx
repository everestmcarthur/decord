...
// Function ID: 8538
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4638, 576, 8538, 5673, 8539, 4348, 2]
// Exports: default

// Module 8537 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8539) };
  items1[1] = React4(tmp10(5673), obj5);
  obj.children = items1;
