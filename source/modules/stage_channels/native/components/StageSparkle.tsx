...
// Function ID: 8496
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4607, 576, 8496, 5639, 8497, 4317, 2]
// Exports: default

// Module 8495 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8497) };
  items1[1] = React4(tmp10(5639), obj5);
  obj.children = items1;
