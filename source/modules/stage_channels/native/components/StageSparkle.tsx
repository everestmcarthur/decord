...
// Function ID: 8557
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4640, 576, 8557, 5675, 8558, 4350, 2]
// Exports: default

// Module 8556 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8558) };
  items1[1] = React4(tmp10(5675), obj5);
  obj.children = items1;
