...
// Function ID: 8494
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4606, 576, 8494, 5638, 8495, 4317, 2]
// Exports: default

// Module 8493 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8495) };
  items1[1] = React4(tmp10(5638), obj5);
  obj.children = items1;
