...
// Function ID: 8436
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4574, 576, 8436, 5601, 8437, 4284, 2]
// Exports: default

// Module 8435 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8437) };
  items1[1] = React4(tmp10(5601), obj5);
  obj.children = items1;
