...
// Function ID: 8529
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4639, 576, 8529, 5672, 8530, 4350, 2]
// Exports: default

// Module 8528 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8530) };
  items1[1] = React4(tmp10(5672), obj5);
  obj.children = items1;
