...
// Function ID: 8473
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4605, 576, 8473, 5637, 8474, 4315, 2]
// Exports: default

// Module 8472 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8474) };
  items1[1] = React4(tmp10(5637), obj5);
  obj.children = items1;
