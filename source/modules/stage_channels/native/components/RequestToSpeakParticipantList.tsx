...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 7269, 5207, 8299, 10055, 1177, 4635, 10056, 1115, 10057, 4786, 7099, 5516, 8519, 5672, 10058, 7179, 2]
// Exports: default

// Module 10054 (RequestToSpeakParticipantList)
...
export default function RequestToSpeakParticipantList(channel) {
  ...
  if (0 === sortedRequestToSpeakParticipants.length) {
    ...
    const obj4 = { source: require("module_10058") };
