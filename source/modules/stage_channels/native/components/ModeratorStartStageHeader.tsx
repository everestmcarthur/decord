...
// Dependencies: [19, 17, 21, 4607, 5734, 10125, 10119, 2]

// Module 10165 (ModeratorStartStageHeader)
import StageActionHeader from "StageActionHeader" /* 10119 */;
...
let obj = { header: { height: fn(5734).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", paddingHorizontal: 8, marginTop: 4, overflow: "visible" } };
let closure_6 = createStyles.createStyles(obj);
const obj3 = { height: fn(5734).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", paddingHorizontal: 8, marginTop: 4, overflow: "visible" };
const size = fn(2);
...
export default noop.memo((channel) => {
  ...
  if (speaker) {
    ...
    speaker = tmp7(tmp8(10119).MusicMuteButton, obj2);
  }
  items[2] = speaker;
