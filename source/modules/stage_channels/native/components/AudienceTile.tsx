...
// Function ID: 10209
// Name: AudienceTile
// Dependencies: [19, 17, 2022, 21, 4638, 576, 4785, 1177, 8751, 1478, 504, 5511, 4790, 6763, 1115, 8523, 10189, 4489, 10209, 2]
// Exports: getTileWidthStyle

// Module 10208 (AudienceTile)
...
function RaisedHandIcon(rtsState) {
  ...
  const obj = { style: items, children: hasOwnProperty(native.Icon, { style: tmp.raisedHand, source: tmp5(8751), color: PRIMARY_800 }) };
