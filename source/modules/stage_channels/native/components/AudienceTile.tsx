...
// Function ID: 10160
// Name: AudienceTile
// Dependencies: [19, 17, 2021, 21, 4606, 576, 4753, 1178, 8707, 1477, 504, 5476, 4758, 6726, 1114, 8479, 10140, 4458, 10160, 2]
// Exports: getTileWidthStyle

// Module 10159 (AudienceTile)
...
function RaisedHandIcon(rtsState) {
  ...
  const obj = { style: items, children: hasOwnProperty(native.Icon, { style: tmp.raisedHand, source: tmp5(8707), color: PRIMARY_800 }) };
