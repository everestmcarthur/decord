...
// Function ID: 10201
// Name: AudienceTile
// Dependencies: [19, 17, 2022, 21, 4639, 576, 4786, 1177, 8742, 1478, 504, 5510, 4791, 6760, 1115, 8514, 10181, 4491, 10201, 2]
// Exports: getTileWidthStyle

// Module 10200 (AudienceTile)
...
function RaisedHandIcon(rtsState) {
  ...
  const obj = { style: items, children: hasOwnProperty(native.Icon, { style: tmp.raisedHand, source: tmp5(8742), color: PRIMARY_800 }) };
