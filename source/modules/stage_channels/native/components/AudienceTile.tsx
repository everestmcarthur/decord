...
// Function ID: 10162
// Name: AudienceTile
// Dependencies: [19, 17, 2021, 21, 4607, 576, 4754, 1178, 8709, 1477, 504, 5477, 4759, 6727, 1114, 8481, 10142, 4458, 10162, 2]
// Exports: getTileWidthStyle

// Module 10161 (AudienceTile)
...
function RaisedHandIcon(rtsState) {
  ...
  const obj = { style: items, children: hasOwnProperty(native.Icon, { style: tmp.raisedHand, source: tmp5(8709), color: PRIMARY_800 }) };
