...
// Dependencies: [32, 19, 17, 4655, 10176, 1074, 21, 4639, 576, 504, 5517, 5207, 10185, 4635, 1115, 2]

// Module 10205 (ActiveSpeakerTooltip)
import nativeDefault from "native" /* 576 */;
import UserSummaryItemDefault from "UserSummaryItem" /* 10185 */;
...
export default noop.memo((channel) => {
  ...
  const first = _slicedToArray(channel(504).useStateFromStores(items, () => {
    ...
    return items;
  }, items1, channel(5517).isVersionEqual), 1)[0];
  let tmp5 = null;
  if (0 !== first.length) {
    tmp5 = null;
    if (_slicedToArray(closure_7(), 1)[0]) {
      ...
      obj6.children = closure_8(tmp2(4635).Text, obj7);
      items2[1] = closure_8(View, obj6);
      obj3.children = items2;
      obj2.children = closure_9(View, obj3);
      tmp5 = closure_8(tmp2(5207).PressableOpacity, obj2);
    }
  }
  return tmp5;
});
