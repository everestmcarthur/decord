...
// Dependencies: [19, 17, 1962, 5464, 1963, 21, 4605, 576, 4572, 1178, 504, 8661, 5637, 8662, 4601, 1114, 8663, 8684, 8685, 8686, 8687, 5025, 2]
// Exports: default

// Module 8660 (StageAudienceNotificationSheet)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1178 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4572 */;
import FastImageDefault from "FastImage" /* 5637 */;
import ScrollHandlingActionSheetDefault from "ScrollHandlingActionSheet" /* 8661 */;
...
let closure_5 = fn(5464).STAGE_AUDIENCE_NOTICE_SHEET_KEY;
...
export default function StageAudienceNotificationSheet(channelId) {
  ...
  obj5.children = intl.string(channelId(1114).t.UVuXCs);
  items1[1] = closure_7(channelId(4601).Text, obj5);
  const obj6 = { style: tmp.headerBulletList, children: null };
  const obj7 = { leading: null, label: null };
  obj7.leading = closure_7(BulletIcon, { source: _modDef8684 });
  const obj9 = { style: tmp.headerBullet, variant: "text-md/medium", color: "text-default", children: null };
  const intl2 = tmp2(1114).intl;
  obj9.children = intl2.string(channelId(1114).t.sBDfo6);
  obj7.label = closure_7(channelId(4601).Text, obj9);
  const items2 = [closure_7(channelId(8663).FormRow, obj7), , , ];
  const obj10 = { leading: null, label: null };
  const obj8 = { source: _modDef8684 };
  const tmp12 = BulletIcon;
  obj10.leading = closure_7(BulletIcon, { source: _modDef8685 });
  const obj12 = { style: tmp.headerBullet, variant: "text-md/medium", color: "text-default", children: null };
  const intl3 = tmp2(1114).intl;
  obj12.children = intl3.string(channelId(1114).t.x58YtH);
  obj10.label = closure_7(channelId(4601).Text, obj12);
  items2[1] = closure_7(channelId(8663).FormRow, obj10);
  const obj13 = { leading: null, label: null };
  const obj11 = { source: _modDef8685 };
  obj13.leading = closure_7(BulletIcon, { source: _modDef8686 });
  const obj15 = { style: tmp.headerBullet, variant: "text-md/medium", color: "text-default", children: null };
  const intl4 = tmp2(1114).intl;
  obj15.children = intl4.string(channelId(1114).t.XtVqla);
  obj13.label = closure_7(channelId(4601).Text, obj15);
  items2[2] = closure_7(channelId(8663).FormRow, obj13);
  let tmp6Result = null;
  if (privacy_level === constants.PUBLIC) {
    const obj16 = { leading: null, label: null };
    const obj17 = { source: _modDef8687 };
    ...
    obj18.children = intl6.string(tmp2(1114).t.nDsbJg);
    obj16.label = tmp6(tmp2(4601).Text, obj18);
    tmp6Result = tmp6(tmp2(8663).FormRow, obj16);
  }
  ...
  obj21.text = intl5.string(channelId(1114).t.obLqZ8);
  obj21.onPress = handleDismiss;
  obj20.children = closure_7(channelId(5025).Button, obj21);
