...
// Dependencies: [19, 17, 1962, 5428, 1963, 21, 4574, 576, 4541, 1178, 504, 8624, 5601, 8625, 4570, 1114, 8626, 8647, 8648, 8649, 8650, 4989, 2]
// Exports: default

// Module 8623 (StageAudienceNotificationSheet)
...
let closure_5 = fn(5428).STAGE_AUDIENCE_NOTICE_SHEET_KEY;
...
export default function StageAudienceNotificationSheet(channelId) {
  ...
  items1[1] = closure_7(channelId(4570).Text, obj5);
  const obj6 = { style: tmp.headerBulletList, children: null };
  const obj7 = { leading: null, label: null };
  obj7.leading = closure_7(BulletIcon, { source: _modDef8647 });
  ...
  obj7.label = closure_7(channelId(4570).Text, obj9);
  const items2 = [closure_7(channelId(8626).FormRow, obj7), , , ];
  const obj10 = { leading: null, label: null };
  const obj8 = { source: _modDef8647 };
  const tmp12 = BulletIcon;
  obj10.leading = closure_7(BulletIcon, { source: _modDef8648 });
  ...
  obj10.label = closure_7(channelId(4570).Text, obj12);
  items2[1] = closure_7(channelId(8626).FormRow, obj10);
  const obj13 = { leading: null, label: null };
  const obj11 = { source: _modDef8648 };
  obj13.leading = closure_7(BulletIcon, { source: _modDef8649 });
  ...
  obj13.label = closure_7(channelId(4570).Text, obj15);
  items2[2] = closure_7(channelId(8626).FormRow, obj13);
  let tmp6Result = null;
  if (privacy_level === constants.PUBLIC) {
    const obj16 = { leading: null, label: null };
    const obj17 = { source: _modDef8650 };
    ...
    obj16.label = tmp6(tmp2(4570).Text, obj18);
    tmp6Result = tmp6(tmp2(8626).FormRow, obj16);
  }
  ...
  obj20.children = closure_7(channelId(4989).Button, obj21);
