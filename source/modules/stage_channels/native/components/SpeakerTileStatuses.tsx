...
// Dependencies: [19, 17, 1908, 4624, 5471, 21, 4605, 576, 504, 10077, 9696, 9697, 1178, 10121, 10122, 7019, 2]
// Exports: BlockedStatus, IgnoredStatus

// Module 10120 (SpeakerTileStatuses)
...
export const BlockedStatus = function BlockedStatus() {
  const tmp = closure_8();
  return jsx(native.Icon, { style: closure_8().restricted, source: _modDef10122, size: native.Icon.Sizes.EXTRA_SMALL, color: nativeDefault.unsafe_rawColors.RED_400 });
};
export const IgnoredStatus = function IgnoredStatus() {
  const tmp = closure_8();
  return jsx(native.Icon, { style: closure_8().restricted, source: _modDef7019, size: native.Icon.Sizes.EXTRA_SMALL });
};
