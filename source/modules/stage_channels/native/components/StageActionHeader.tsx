...
// Dependencies: [19, 17, 4655, 1958, 7741, 1980, 1963, 10031, 1074, 21, 4639, 5767, 4489, 576, 1241, 4819, 9613, 4842, 4846, 504, 10056, 10159, 1115, 4840, 1177, 4792, 5516, 5510, 5071, 4635, 8748, 8745, 10160, 10161, 8515, 9794, 10162, 10163, 9952, 10033, 10039, 10040, 10045, 10164, 10165, 2]
// Exports: HideChannelCallButton, closeStageModal

// Module 10158 (StageActionHeader)
...
import ChannelCallHeaderButtons from "ChannelCallHeaderButtons" /* 10165 */;
...
let obj3 = { height: fn(5767).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", paddingHorizontal: 12, overflow: "visible" };
