...
// Dependencies: [5, 32, 19, 17, 4413, 1963, 1074, 21, 1115, 4722, 576, 4875, 504, 5161, 9932, 8858, 9921, 5592, 8643, 8645, 8630, 8626, 1177, 4718, 5145, 5144, 9923, 9831, 4656, 4430, 9719, 5197, 2]
// Exports: default

// Module 9931 (GlobalStageChannelStatus)
...
export default function GlobalStageChannelStatus(arg0) {
  ...
  let invitedHeaderText = tmp3(9831)(id);
    ...
    if (null != channel) {
      if (null != guild) {
        ...
        if (tmp7) {
          ...
          const items2 = [closure_10(tmp3(9719), obj4), , ];
          const obj5 = { style: activeSpeakerIcon, size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp8(5197).getChannelIconWithGuild(channel, guild) };
