...
// Dependencies: [5, 32, 19, 17, 4330, 1963, 1074, 21, 1115, 4640, 576, 4793, 504, 5079, 9838, 8775, 9827, 5510, 8560, 8562, 8547, 8543, 1177, 4636, 5063, 5062, 9829, 9737, 4574, 4348, 9635, 5115, 2]
// Exports: default

// Module 9837 (GlobalStageChannelStatus)
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null != id) {
                if (obj9.shouldAgeVerifyToSpeakForCurrentUser(id.id)) {
                  const obj5 = { entryPoint: tmp41(8562).AgeVerificationModalEntryPoint.STAGE_CHANNEL_RAISE_HAND };
                  const result = tmp3(8560).showAgeVerificationGetStartedModal(obj5);
                  const obj4 = tmp3(8560);
                } else {
                  dependencyMap(true);
                  dependencyMap = 1;
                  c4 = 2;
                  c5 = 1;
                  const obj6 = { value: tmp41(8547).audienceAckRequestToSpeak(id, false), done: false };
                  return obj6;
                }
                obj9 = channel(5510);
              }
            ...
            closure_129_3(false);
            if (null == key.getKey()) {
              tmp27(8543).openStageChannel(closure_129_0);
              const obj8 = tmp27(8543);
            }
          }
          dependencyMap = 0;
          c5 = 3;
...
export default function GlobalStageChannelStatus(arg0) {
  ...
  let invitedHeaderText = tmp3(9737)(id);
    ...
    if (null != channel) {
      if (null != guild) {
        ...
        if (tmp7) {
          ...
          const items2 = [closure_10(tmp3(9635), obj4), , ];
          const obj5 = { style: activeSpeakerIcon, size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp8(5115).getChannelIconWithGuild(channel, guild) };
