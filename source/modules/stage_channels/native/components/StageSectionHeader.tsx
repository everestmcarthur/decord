...
// Dependencies: [19, 17, 21, 4640, 576, 4376, 4641, 4636, 1177, 7272, 2]
// Exports: default

// Module 10203 (StageSectionHeader)
...
export default function StageSectionHeader(collapsed) {
  ...
  fn.__closure = { withTiming: collapsed(4641).withTiming, collapsed };
  ...
  obj5.children = items;
  const items1 = [closure_5(collapsed(4636).Text, obj5), , ];
  ...
  let obj2 = { withTiming: collapsed(4641).withTiming, collapsed };
  const tmp7 = closure_5;
  const tmp8 = closure_3;
  obj8.children = closure_6(tmp2(1177).Icon, { source: _modDef7272, style: tmp.collapseIcon });
