...
// Dependencies: [19, 17, 5584, 1074, 21, 4722, 576, 4689, 9320, 8829, 1177, 1115, 4718, 5144, 8630, 2]
// Exports: default

// Module 9319 (EndStageActionSheet)
...
let closure_4 = fn(5584).EXPLICIT_END_STAGE_SHEET_KEY;
const jsxProd = fn(21);
...
export default function EndStageActionSheet(channel) {
  ...
  items[1] = closure_5(channel(4718).Text, obj4);
  ...
  obj5.children = closure_5(channel(5144).Button, obj6);
  ...
  obj7.children = closure_5(channel(5144).Button, obj8);
