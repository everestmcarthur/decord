...
// Dependencies: [19, 17, 5464, 1074, 21, 4605, 576, 4572, 9151, 8661, 1178, 1114, 4601, 5025, 8463, 2]
// Exports: default

// Module 9150 (EndStageActionSheet)
...
export default function EndStageActionSheet(channel) {
  ...
  items[1] = closure_5(channel(4601).Text, obj4);
  ...
  obj5.children = closure_5(channel(5025).Button, obj6);
  ...
  obj7.children = closure_5(channel(5025).Button, obj8);
