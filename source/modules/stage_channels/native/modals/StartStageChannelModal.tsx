...
// Dependencies: [5, 32, 19, 17, 1962, 5465, 1074, 1963, 21, 4606, 576, 4809, 5174, 1114, 1178, 7162, 8493, 5635, 504, 7286, 8684, 4602, 9140, 9905, 9906, 5043, 1242, 1874, 8484, 7289, 4507, 9907, 9908, 8496, 5026, 7196, 5629, 2]

// Module 9904 (StartStageChannelModal)
...
export default noop.forwardRef((channel, ref) => {
      ...
      try {
        ...
        if (0 === c4) {
            ...
            if ("" !== first1) {
              if (null != first2) {
                ...
                if (null != memo) {
                  c4 = 3;
                  c5 = 1;
                  const obj8 = { value: tmp66(8484).editStage(channel, tmp75, tmp47), done: false };
                  return obj8;
                } else {
                  obj5 = tmp66(8484);
                  c4 = 2;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp66;
            const aPIError = new closure_0(4507).APIError(closure_128_1);
            ...
            if (2 === tmp7) {
              if (arg0 === 1) {
                ...
                if (tmp8) {
                  tmp66(7289).hideHotspot(closure_0(7286).HotspotLocations.LIVE_STAGE_NOTIFICATION_BADGE);
                  const obj2 = tmp66(7289);
                }
              }
            } else if (arg0 === 1) {
              c5 = 3;
  ...
  const imperativeHandle = first2.useImperativeHandle(ref, () => ({
    renderRightButton: function RightButton() {
      ...
      obj.source = require("module_7162");
      obj.onPress = onPress;
