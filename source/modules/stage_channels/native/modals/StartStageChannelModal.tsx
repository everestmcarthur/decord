...
// Dependencies: [5, 32, 19, 17, 1963, 5499, 1074, 1964, 21, 4639, 576, 4842, 5207, 1115, 1177, 7196, 8528, 5669, 504, 7320, 8719, 4635, 9182, 9946, 9947, 5076, 1241, 1875, 8519, 7323, 4540, 9948, 9949, 8531, 5059, 7230, 5663, 2]

// Module 9945 (StartStageChannelModal)
...
export default noop.forwardRef((channel, ref) => {
            ...
            if ("" !== first1) {
              if (null != first2) {
                ...
                if (null != memo) {
                  c4 = 3;
                  c5 = 1;
                  const obj8 = { value: tmp66(8519).editStage(channel, tmp75, tmp47), done: false };
                  return obj8;
                } else {
                  obj5 = tmp66(8519);
                  c4 = 2;
  ...
  const imperativeHandle = first2.useImperativeHandle(ref, () => ({
    renderRightButton: function RightButton() {
      ...
      obj.source = require("module_7196");
      obj.onPress = onPress;
