...
// Dependencies: [5, 32, 19, 17, 1963, 5500, 1074, 1964, 21, 4638, 576, 4841, 5208, 1115, 1177, 7199, 8537, 5670, 504, 7323, 8728, 4634, 9193, 9954, 9955, 5077, 1241, 1875, 8528, 7326, 4538, 9956, 9957, 8540, 5060, 7233, 5664, 2]

// Module 9953 (StartStageChannelModal)
...
export default noop.forwardRef((channel, ref) => {
      ...
      try {
        ...
        if (0 === c4) {
            ...
            if ("" !== first1) {
              if (null != first2) {
                ...
                if (null != memo) {
                  c4 = 3;
                  c5 = 1;
                  const obj8 = { value: tmp66(8528).editStage(channel, tmp75, tmp47), done: false };
                  return obj8;
                } else {
                  obj5 = tmp66(8528);
                  c4 = 2;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp66;
            const aPIError = new closure_0(4538).APIError(closure_128_1);
            ...
            if (2 === tmp7) {
              if (arg0 === 1) {
                ...
                if (tmp8) {
                  tmp66(7326).hideHotspot(closure_0(7323).HotspotLocations.LIVE_STAGE_NOTIFICATION_BADGE);
                  const obj2 = tmp66(7326);
                }
              }
            } else if (arg0 === 1) {
              c5 = 3;
  ...
  const imperativeHandle = first2.useImperativeHandle(ref, () => ({
    renderRightButton: function RightButton() {
      ...
      obj.source = require("module_7199");
      obj.onPress = onPress;
