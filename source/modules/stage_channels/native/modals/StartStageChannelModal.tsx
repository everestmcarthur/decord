...
// Dependencies: [5, 32, 19, 17, 1962, 5428, 1074, 1963, 21, 4574, 576, 4777, 5137, 1114, 1178, 7103, 8435, 5598, 504, 7227, 8626, 4570, 9082, 9846, 9847, 5006, 1242, 1874, 8426, 7230, 4475, 9848, 9849, 8438, 4989, 7137, 5592, 2]

// Module 9845 (StartStageChannelModal)
...
export default noop.forwardRef((channel, ref) => {
            ...
            if ("" !== first1) {
              if (null != first2) {
                ...
                if (null != memo) {
                  c4 = 3;
                  c5 = 1;
                  const obj8 = { value: tmp66(8426).editStage(channel, tmp75, tmp47), done: false };
                  return obj8;
                } else {
                  obj5 = tmp66(8426);
                  c4 = 2;
          ...
          if (1 === tmp7) {
            ...
            if (2 === tmp7) {
              if (arg0 === 1) {
                ...
                if (tmp8) {
                  tmp66(7230).hideHotspot(closure_0(7227).HotspotLocations.LIVE_STAGE_NOTIFICATION_BADGE);
                  const obj2 = tmp66(7230);
                }
              }
            } else if (arg0 === 1) {
              c5 = 3;
  ...
  const imperativeHandle = first2.useImperativeHandle(ref, () => ({
    renderRightButton: function RightButton() {
      ...
      obj.source = require("module_7103");
      obj.onPress = onPress;
