...
// Dependencies: [4246, 1975, 502, 1957, 1979, 4245, 1962, 1074, 1086, 4250, 1965, 504, 2]
...
// Module 5466 (StageChannelPermissionUtils)
...
export const isEmptyOverwrite = function isEmptyOverwrite(arg0) {
  ...
  if (equalsResult) {
    equalsResult = tmp(1086).equals(deny, tmp(4250).NONE);
