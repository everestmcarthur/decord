...
// Dependencies: [32, 5, 1371, 16675, 16676, 573, 16679, 16680, 16677, 16682, 1114, 3590, 16683, 16684, 559, 7804, 16685, 16686, 504, 2]
  ...
  if ("history_page" === type.type) {
    ...
    if ("control_claim" !== type.type) {
      if ("capture_claim" !== type.type) {
        if ("preview_operation" === type.type) {
          if ("begin" === type.phase) {
            const result3 = attachment_id(16677).beginPreviewOperation(projectId);
            const obj18 = attachment_id(16677);
          } else {
            attachment_id(16677).endPreviewOperation(projectId);
            const obj17 = attachment_id(16677);
          }
...
const map3 = new Map();
const map4 = new Map();
let value = { location: "connection", code: fn(16679).VibegrationErrorCodes.SEND_FAILED };
let obj2 = { location: "agent", code: fn(16679).VibegrationErrorCodes.AGENT_ERROR };
const map5 = new Map();
let closure_24 = { steered: true, queued: true, restarting: true, answered: true };
let obj3 = { build_error: { location: "build", code: fn(16679).VibegrationErrorCodes.BUILD_FAILED }, healthcheck_failed: null, error: null };
let obj4 = { location: "build", code: fn(16679).VibegrationErrorCodes.BUILD_FAILED };
obj3.healthcheck_failed = { location: "healthcheck", code: fn(16679).VibegrationErrorCodes.HEALTHCHECK_FAILED };
let obj5 = { location: "healthcheck", code: fn(16679).VibegrationErrorCodes.HEALTHCHECK_FAILED };
obj3.error = { location: "agent", code: fn(16679).VibegrationErrorCodes.AGENT_ERROR };
let obj7 = { web: null, preview: null };
let obj6 = { location: "agent", code: fn(16679).VibegrationErrorCodes.AGENT_ERROR };
obj7.web = { location: "runtime_frame", code: fn(16679).VibegrationErrorCodes.RUNTIME_FRAME_ERROR };
let obj8 = { location: "runtime_frame", code: fn(16679).VibegrationErrorCodes.RUNTIME_FRAME_ERROR };
obj7.preview = { location: "runtime_worker", code: fn(16679).VibegrationErrorCodes.RUNTIME_WORKER_ERROR };
const map6 = new Map();
const map7 = new Map();
const map8 = new Map();
const map9 = new Map();
