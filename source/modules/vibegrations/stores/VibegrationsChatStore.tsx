...
// Dependencies: [32, 109, 7647, 10220, 2012, 4459, 5365, 16723, 1074, 1965, 1115, 3591, 16724, 1936, 10042, 504, 573, 2]
// Exports: getOlderHistoryCursor, turnSettled

// Module 16722 (VibegrationsChatStore)
    ...
    if (tmp) {
      ...
      if (null != project) {
        ...
        if (!result4) {
          ...
          if (isWindowFocusedResult) {
            isWindowFocusedResult = tmp68(16724).isWindowFocused();
            const tmp68Result = tmp68(16724);
          }
          if (guild_id == null) {
