...
// Dependencies: [5, 9601, 16664, 1074, 9602, 573, 16667, 9598, 1272, 7318, 7236, 9117, 2]
    ...
    if (2 === tmp5) {
      if (arg0 === 1) {
        ...
        if (null != closure_130_6) {
          c4 = 3;
          c5 = 1;
          return { value: closure_131_0(closure_131_2[10]).fetchApplication(closure_130_6), done: false };
        } else {
