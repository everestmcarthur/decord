...
// Dependencies: [19, 17, 21, 4638, 576, 16800, 1115, 3591, 16798, 16797, 16811, 2]
// Exports: default

// Module 16810 (VibegrationsDebugWorkerTab)
...
import VibegrationsDebugPrimitives from "VibegrationsDebugPrimitives" /* 16800 */;
...
function EnvSection(title) {
  ...
  if (items.length <= 0) {
    ...
    obj4.children = intl.string(_modDef3591.W4hcKL);
    items = tmp7(tmp8(16800).DebugNote, obj4);
  }
  obj3.children = items;
...
function BotEnvBlock(arg0) {
  ...
  if (bot.ever_started) {
    ...
    obj3.label = intl2.formatToPlainString(_modDef3591.f8ix3w, obj4);
    const tmp6 = React5;
    ...
    obj7.label = intl3.string(_modDef3591["0AB7l3"]);
    ...
    if (null != bot.last_event_type) {
      if (null != bot.last_event_at) {
        ...
        combined = "" + bot.last_event_type + " \u00B7 " + tmp9(16797).formatObservedAt(bot.last_event_at);
        const tmp9Result6 = tmp9(16797);
      }
    }
    obj7.hint = combined;
    ...
    obj8.label = intl4.string(_modDef3591.ElaQ0A);
    ...
    obj9.label = intl5.string(_modDef3591.SJtBTN);
    ...
    if (null != bot.last_close_code) {
      if (null != bot.last_close_at) {
        ...
        const obj10 = { code: bot.last_close_code, time: tmp9(16797).formatObservedAt(bot.last_close_at) };
        formatToPlainStringResult = intl6.formatToPlainString(tmp11(3591).bSzLue, obj10);
        const tmp9Result9 = tmp9(16797);
      }
    }
    ...
    if (bot.dispatch_errors > 0) {
      ...
      obj11.label = intl7.string(tmp11(3591).N4l504);
      obj11.value = tmp9(16797).formatCount(bot.dispatch_errors);
      tmp8Result = tmp8(tmp9(16800).DebugStatRow, obj11);
      const tmp9Result10 = tmp9(16797);
    }
    ...
    obj.value = intl.string(_modDef3591.C6xjtD);
...
function OutboundEnvBlock(metrics) {
  ...
  obj.value = intl.formatToPlainString(_modDef3591.Yur5Zm, obj3);
  ...
  if (null != metrics.last_failure) {
    ...
    obj6.status = str;
    obj6.time = tmp3(16797).formatObservedAt(metrics.last_failure.at);
    let formatToPlainStringResult = intl3.formatToPlainString(tmp5(3591)["0ayoy+"], obj6);
    const tmp3Result = tmp3(16797);
  } else {
    const intl2 = tmp3(1115).intl;
    const obj7 = { time: tmp3(16797).formatObservedAt(metrics.since) };
    formatToPlainStringResult = intl2.formatToPlainString(tmp5(3591)["1PdrB1"], obj7);
    const tmp3Result2 = tmp3(16797);
  }
...
function RuntimeEnvBlock(env) {
  ...
  let obj3 = { env: env(16798).debugEnvLabel(env) };
  obj2.label = intl.formatToPlainString(_modDef3591.BVORfc, obj3);
  let obj4 = env(16798);
  obj2.value = env(16797).formatCount(runtime.connections);
  const items = [closure_5(env(16800).DebugStatRow, obj2), ];
  const schedules = runtime.schedules;
  items[1] = schedules.map((id) => {
    const obj = { label: null, value: null, hint: null };
    const intl = util.intl;
    obj.label = intl.formatToPlainString(_modDef3591.NQxkhU, { id: id.id });
    ...
    if (null != id.pending_state) {
      ...
      let formatToPlainStringResult = intl3.formatToPlainString(tmp4(3591).P8lBrO, obj3);
    } else if (null != id.next_run_at) {
      const intl2 = tmp2(1115).intl;
      const obj4 = { time: tmp2(16797).formatObservedAt(id.next_run_at) };
      formatToPlainStringResult = intl2.formatToPlainString(tmp4(3591)["7ecbr3"], obj4);
...
function AiEnvBlock(metrics) {
  ...
  obj.value = intl.formatToPlainString(_modDef3591.voXL2a, obj3);
...
function EnvMetricsSection(arg0) {
  ...
  if (null != metrics) {
    if (0 !== metrics.requests) {
      ...
      obj3.label = intl13.string(_modDef3591.KOnL3g);
      ...
      obj3.hint = intl14.formatToPlainString(_modDef3591["1PdrB1"], obj4);
      const items = [hasOwnProperty(VibegrationsDebugPrimitives.DebugStatRow, obj3), , , , , , ];
      const obj5 = { label: null, value: null, critical: null };
      const intl15 = util.intl;
      obj5.label = intl15.string(_modDef3591.CjPhyY);
      ...
      if (metrics.cpu_ms_total > 0) {
        ...
        const intl4 = tmp9(1115).intl;
        obj7.label = intl4.string(tmp12(3591)["V/nNbs"]);
        obj7.used = metrics.cpu_ms_max;
        obj7.max = limits.cpu_ms_per_request;
        obj7.formatValue = tmp9(16797).formatMs;
        const items1 = [tmp11(tmp9(16800).DebugMeter, obj7), ];
        const obj8 = { label: null, value: null, hint: null };
        const intl5 = tmp9(1115).intl;
        obj8.label = intl5.string(tmp12(3591)["+rYPHD"]);
        obj8.value = tmp9(16797).formatMs(metrics.cpu_ms_total / metrics.requests);
        const intl6 = tmp9(1115).intl;
        const obj9 = { total: null, wall: null };
        const tmp9Result = tmp9(16797);
        obj9.total = tmp9(16797).formatMs(metrics.cpu_ms_total);
        const tmp9Result7 = tmp9(16797);
        obj9.wall = tmp9(16797).formatMs(metrics.wall_ms_total);
        obj8.hint = intl6.formatToPlainString(tmp12(3591)["+LxC7W"], obj9);
        items1[1] = tmp11(tmp9(16800).DebugStatRow, obj8);
        obj6.children = items1;
        let tmp = tmp8(timestampProducer, obj6);
        const tmp9Result8 = tmp9(16797);
      } else {
        const obj = { label: null, value: null, hint: null };
        const intl = tmp9(1115).intl;
        obj.label = intl.string(tmp12(3591)["V/nNbs"]);
        const intl2 = tmp9(1115).intl;
        obj.value = intl2.string(tmp12(3591).YKWIxp);
        const intl3 = tmp9(1115).intl;
        obj.hint = intl3.string(tmp12(3591)["8GAiDk"]);
        tmp = tmp11(tmp9(16800).DebugStatRow, obj);
      }
      items[2] = tmp;
      ...
      if (metrics.cpu_ms_total <= 0) {
        ...
        if (metrics.wall_ms_total > 0) {
          ...
          const intl7 = tmp9(1115).intl;
          obj10.label = intl7.string(tmp12(3591).ueEMPa);
          obj10.value = tmp9(16797).formatMs(metrics.wall_ms_total);
          tmp11Result = tmp11(tmp9(16800).DebugStatRow, obj10);
          const tmp9Result9 = tmp9(16797);
        }
      }
      items[3] = tmp11Result;
      ...
      if (metrics.exceeded_cpu > 0) {
        ...
        obj11.label = intl8.string(tmp12(3591).vM2krr);
        obj11.value = tmp9(16797).formatCount(metrics.exceeded_cpu);
        tmp11Result3 = tmp11(tmp9(16800).DebugStatRow, obj11);
        const tmp9Result10 = tmp9(16797);
      }
      items[4] = tmp11Result3;
      const obj12 = { label: null, value: null, critical: null, hint: null };
      const intl9 = tmp9(1115).intl;
      obj12.label = intl9.string(_modDef3591.g1O88C);
      ...
      obj12.hint = intl10.formatToPlainString(_modDef3591["5iALNP"], obj13);
      ...
      if (null != metrics.build) {
        ...
        obj14.label = intl11.string(tmp12(3591).JUZs7g);
        obj14.value = tmp9(16797).shortBuildLabel(metrics.build);
        tmp11Result4 = tmp11(tmp9(16800).DebugStatRow, obj14);
        const tmp9Result12 = tmp9(16797);
      }
  ...
  obj16.children = intl12.string(_modDef3591["v/fbnv"]);
...
function StorageSection(status) {
  ...
  if (storage.shared_data) {
    ...
    obj3.label = intl.string(_modDef3591.Vrh0rD);
    obj3.metrics = stable;
    let items = [obj3];
    let tmp4 = limits;
    let items1 = items;
  } else {
    let obj = { key: "preview", label: limits(16798).debugEnvLabel("preview"), metrics: tmp };
    items1 = [obj, ];
    let obj5 = { key: "stable", label: null, metrics: null };
    let obj2 = limits(16798);
    obj5.label = limits(16798).debugEnvLabel("stable");
    obj5.metrics = stable;
    items1[1] = obj5;
    tmp4 = limits;
    let obj4 = limits(16798);
  }
  let obj6 = { title: null, children: null };
  let intl2 = tmp4(1115).intl;
  obj6.title = intl2.string(_modDef3591.i91625);
  obj6.children = items1.map((item) => {
    ...
    if (null == metrics) {
      ...
      obj4.label = intl2.formatToPlainString(_modDef3591["9TpIQg"], obj5);
      obj4.value = VibegrationsDebugFormat.formatBytes(metrics.r2_bytes);
      const intl3 = util.intl;
      const tmp32 = _modDef3591;
      ...
      if (null != metrics.db_bytes) {
        ...
        obj6.label = intl.formatToPlainString(tmp25(3591)["0OIswI"], obj7);
  ...
  return closure_5(tmp4(16800).DebugSection, obj6);
}
...
export default function VibegrationsDebugWorkerTab(status) {
  ...
  if (null != status) {
    ...
    obj2.title = intl.string(_modDef3591["+dpDma"]);
    ...
    obj3.title = intl2.string(_modDef3591.NQHyed);
    ...
    if (null != status.bot) {
      ...
      obj5.title = intl3.string(tmp10(3591).rx1pBg);
    ...
    if (null != status.outbound) {
      ...
      obj6.title = intl4.string(tmp10(3591)["t2+yv/"]);
    ...
    if (null != status.runtime) {
      ...
      obj7.title = intl5.string(tmp10(3591).QifItp);
    ...
    if (null != status.ai) {
      ...
      obj8.title = intl6.string(tmp10(3591).SWKshl);
    ...
    if (null != status.analytics) {
      ...
      tmp3Result8 = tmp3(tmp4(16811).VibegrationsDebugWorkerAnalyticsSection, obj9);
    }
    items1[7] = tmp3Result8;
    const obj10 = { title: null, children: null };
    const intl7 = tmp4(1115).intl;
    obj10.title = intl7.string(_modDef3591["HHe+8E"]);
    const obj11 = { label: tmp4(16798).debugEnvLabel("preview"), value: null };
    let str2 = "\u2014";
    let str3 = "\u2014";
    if (null != status.deployments.preview_build) {
      str3 = tmp4(16797).shortBuildLabel(status.deployments.preview_build);
      const tmp4Result4 = tmp4(16797);
    }
    obj11.value = str3;
    const items2 = [tmp3(tmp4(16800).DebugStatRow, obj11), ];
    const obj12 = { label: null, value: null };
    const tmp4Result = tmp4(16798);
    const tmp8 = timestampProducer;
    obj12.label = tmp4(16798).debugEnvLabel("stable");
    if (null != status.deployments.stable_build) {
      str2 = tmp4(16797).shortBuildLabel(status.deployments.stable_build);
      const tmp4Result6 = tmp4(16797);
    }
    const obj13 = { children: null };
    obj12.value = str2;
    items2[1] = tmp3(tmp4(16800).DebugStatRow, obj12);
    obj10.children = items2;
    items1[8] = tmp(tmp4(16800).DebugSection, obj10);
    obj13.children = items1;
    tmpResult = tmp(tmp8, obj13);
    const tmp4Result5 = tmp4(16798);
  }
  items[1] = tmpResult;
  obj.children = items;
