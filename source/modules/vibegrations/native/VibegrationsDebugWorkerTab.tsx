...
// Dependencies: [19, 17, 21, 4640, 576, 16839, 1115, 3593, 16837, 16836, 16850, 2]
// Exports: default
...
function EnvSection(title) {
  ...
  if (items.length <= 0) {
    ...
    items = tmp7(tmp8(16839).DebugNote, obj4);
  }
  obj3.children = items;
  ...
  if (bot.ever_started) {
    ...
    if (null != bot.last_event_type) {
      if (null != bot.last_event_at) {
        ...
        combined = "" + bot.last_event_type + " \u00B7 " + tmp9(16836).formatObservedAt(bot.last_event_at);
        const tmp9Result6 = tmp9(16836);
      }
    }
    obj7.hint = combined;
    ...
    if (null != bot.last_close_code) {
      if (null != bot.last_close_at) {
        ...
        const obj10 = { code: bot.last_close_code, time: tmp9(16836).formatObservedAt(bot.last_close_at) };
        formatToPlainStringResult = intl6.formatToPlainString(tmp11(3593).bSzLue, obj10);
        const tmp9Result9 = tmp9(16836);
      }
    }
    ...
    if (bot.dispatch_errors > 0) {
      ...
      obj11.label = intl7.string(tmp11(3593).N4l504);
      obj11.value = tmp9(16836).formatCount(bot.dispatch_errors);
      tmp8Result = tmp8(tmp9(16839).DebugStatRow, obj11);
      const tmp9Result10 = tmp9(16836);
    }
...
function OutboundEnvBlock(metrics) {
  ...
  if (null != metrics.last_failure) {
    ...
    obj6.status = str;
    obj6.time = tmp3(16836).formatObservedAt(metrics.last_failure.at);
    let formatToPlainStringResult = intl3.formatToPlainString(tmp5(3593)["0ayoy+"], obj6);
    const tmp3Result = tmp3(16836);
  } else {
    const intl2 = tmp3(1115).intl;
    const obj7 = { time: tmp3(16836).formatObservedAt(metrics.since) };
    formatToPlainStringResult = intl2.formatToPlainString(tmp5(3593)["1PdrB1"], obj7);
    const tmp3Result2 = tmp3(16836);
  }
...
function RuntimeEnvBlock(env) {
  ...
  items[1] = schedules.map((id) => {
    ...
    if (null != id.pending_state) {
      ...
      let formatToPlainStringResult = intl3.formatToPlainString(tmp4(3593).P8lBrO, obj3);
    } else if (null != id.next_run_at) {
      const intl2 = tmp2(1115).intl;
      const obj4 = { time: tmp2(16836).formatObservedAt(id.next_run_at) };
      formatToPlainStringResult = intl2.formatToPlainString(tmp4(3593)["7ecbr3"], obj4);
  ...
  if (null != metrics) {
    if (0 !== metrics.requests) {
      ...
      if (metrics.cpu_ms_total > 0) {
        ...
        const intl4 = tmp9(1115).intl;
        obj7.label = intl4.string(tmp12(3593)["V/nNbs"]);
        obj7.used = metrics.cpu_ms_max;
        obj7.max = limits.cpu_ms_per_request;
        obj7.formatValue = tmp9(16836).formatMs;
        const items1 = [tmp11(tmp9(16839).DebugMeter, obj7), ];
        const obj8 = { label: null, value: null, hint: null };
        const intl5 = tmp9(1115).intl;
        obj8.label = intl5.string(tmp12(3593)["+rYPHD"]);
        obj8.value = tmp9(16836).formatMs(metrics.cpu_ms_total / metrics.requests);
        const intl6 = tmp9(1115).intl;
        const obj9 = { total: null, wall: null };
        const tmp9Result = tmp9(16836);
        obj9.total = tmp9(16836).formatMs(metrics.cpu_ms_total);
        const tmp9Result7 = tmp9(16836);
        obj9.wall = tmp9(16836).formatMs(metrics.wall_ms_total);
        obj8.hint = intl6.formatToPlainString(tmp12(3593)["+LxC7W"], obj9);
        items1[1] = tmp11(tmp9(16839).DebugStatRow, obj8);
        obj6.children = items1;
        let tmp = tmp8(timestampProducer, obj6);
        const tmp9Result8 = tmp9(16836);
      } else {
        const obj = { label: null, value: null, hint: null };
        const intl = tmp9(1115).intl;
        obj.label = intl.string(tmp12(3593)["V/nNbs"]);
        const intl2 = tmp9(1115).intl;
        obj.value = intl2.string(tmp12(3593).YKWIxp);
        const intl3 = tmp9(1115).intl;
        obj.hint = intl3.string(tmp12(3593)["8GAiDk"]);
        tmp = tmp11(tmp9(16839).DebugStatRow, obj);
      }
      items[2] = tmp;
      ...
      if (metrics.cpu_ms_total <= 0) {
        ...
        if (metrics.wall_ms_total > 0) {
          ...
          const intl7 = tmp9(1115).intl;
          obj10.label = intl7.string(tmp12(3593).ueEMPa);
          obj10.value = tmp9(16836).formatMs(metrics.wall_ms_total);
          tmp11Result = tmp11(tmp9(16839).DebugStatRow, obj10);
          const tmp9Result9 = tmp9(16836);
        }
      }
      items[3] = tmp11Result;
      ...
      if (metrics.exceeded_cpu > 0) {
        ...
        obj11.label = intl8.string(tmp12(3593).vM2krr);
        obj11.value = tmp9(16836).formatCount(metrics.exceeded_cpu);
        tmp11Result3 = tmp11(tmp9(16839).DebugStatRow, obj11);
        const tmp9Result10 = tmp9(16836);
      }
      ...
      if (null != metrics.build) {
        ...
        obj14.label = intl11.string(tmp12(3593).JUZs7g);
        obj14.value = tmp9(16836).shortBuildLabel(metrics.build);
        tmp11Result4 = tmp11(tmp9(16839).DebugStatRow, obj14);
        const tmp9Result12 = tmp9(16836);
      }
  ...
  obj6.children = items1.map((item) => {
    ...
    if (null == metrics) {
      ...
      if (null != metrics.db_bytes) {
        ...
        obj6.label = intl.formatToPlainString(tmp25(3593)["0OIswI"], obj7);
...
export default function VibegrationsDebugWorkerTab(status) {
  ...
  if (null != status) {
    ...
    if (null != status.bot) {
      ...
      obj5.title = intl3.string(tmp10(3593).rx1pBg);
    ...
    if (null != status.outbound) {
      ...
      obj6.title = intl4.string(tmp10(3593)["t2+yv/"]);
    ...
    if (null != status.runtime) {
      ...
      obj7.title = intl5.string(tmp10(3593).QifItp);
    ...
    if (null != status.ai) {
      ...
      obj8.title = intl6.string(tmp10(3593).SWKshl);
    ...
    if (null != status.analytics) {
      ...
      tmp3Result8 = tmp3(tmp4(16850).VibegrationsDebugWorkerAnalyticsSection, obj9);
    }
    ...
    const obj11 = { label: tmp4(16837).debugEnvLabel("preview"), value: null };
    let str2 = "\u2014";
    let str3 = "\u2014";
    if (null != status.deployments.preview_build) {
      str3 = tmp4(16836).shortBuildLabel(status.deployments.preview_build);
      const tmp4Result4 = tmp4(16836);
    }
    obj11.value = str3;
    const items2 = [tmp3(tmp4(16839).DebugStatRow, obj11), ];
    const obj12 = { label: null, value: null };
    const tmp4Result = tmp4(16837);
    const tmp8 = timestampProducer;
    obj12.label = tmp4(16837).debugEnvLabel("stable");
    if (null != status.deployments.stable_build) {
      str2 = tmp4(16836).shortBuildLabel(status.deployments.stable_build);
      const tmp4Result6 = tmp4(16836);
    }
    const obj13 = { children: null };
    obj12.value = str2;
    items2[1] = tmp3(tmp4(16839).DebugStatRow, obj12);
    obj10.children = items2;
    items1[8] = tmp(tmp4(16839).DebugSection, obj10);
    obj13.children = items1;
    tmpResult = tmp(tmp8, obj13);
    const tmp4Result5 = tmp4(16837);
  }
  items[1] = tmpResult;
  obj.children = items;
