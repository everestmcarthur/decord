...
// Dependencies: [32, 19, 17, 21, 4638, 576, 16779, 4634, 1115, 3591, 5693, 5060, 6714, 2]
// Exports: default
...
export default function VibegrationsClarificationCard(clarification) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (null != onSubmit) {
      ...
      if (null == result) {
        const result1 = tmp13(16779).formatClarificationAnswers(tmp15, obj);
        if ("" !== result1) {
          tmp(result1);
        }
        const tmp13Result = tmp13(16779);
      } else {
        closure_6(result);
      }
      tmp13 = require;
