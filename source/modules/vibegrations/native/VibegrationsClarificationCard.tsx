...
// Dependencies: [32, 19, 17, 21, 4640, 576, 16811, 4636, 1115, 3593, 5695, 5062, 6717, 2]
// Exports: default
...
export default function VibegrationsClarificationCard(clarification) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (null != onSubmit) {
      ...
      if (null == result) {
        const result1 = tmp13(16811).formatClarificationAnswers(tmp15, obj);
        if ("" !== result1) {
          tmp(result1);
        }
        const tmp13Result = tmp13(16811);
      } else {
        closure_6(result);
      }
      tmp13 = require;
