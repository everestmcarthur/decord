...
// Dependencies: [19, 17, 21, 4638, 576, 4634, 1115, 3591, 16797, 5060, 2]
// Exports: DebugMeter, DebugNote, DebugSection, DebugSnapshotToolbar, DebugStatRow

// Module 16800 (VibegrationsDebugPrimitives)
...
export const DebugSnapshotToolbar = function DebugSnapshotToolbar(onRefresh) {
  ...
  if ("loading" === fetchState) {
    ...
    obj3.children = intl2.string(_modDef3591["K+FvtM"]);
    ...
    if (null != generatedAt) {
      ...
      obj4.children = intl.formatToPlainString(_modDef3591["4NpaEk"], obj6);
  ...
  obj7.text = intl3.string(_modDef3591.aw0IJm);
