...
// Dependencies: [5, 32, 19, 17, 16849, 21, 4722, 576, 7177, 7385, 1115, 3676, 4689, 7393, 7345, 4718, 5144, 6799, 2]
// Exports: default

// Module 16960 (VibegrationsSecretsSheet)
...
export default function VibegrationsSecretsSheet(projectId) {
  ...
  obj2.title = intl.string(require("module_3676").ACvhVC);
  ...
  obj5.children = intl2.string(require("module_3676").p0Ay4J);
  ...
  obj8.text = intl5.string(require("module_3676")["8SWZaW"]);
  obj8.loading = first1;
