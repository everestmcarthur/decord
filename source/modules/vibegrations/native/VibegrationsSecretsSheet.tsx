...
// Dependencies: [5, 32, 19, 17, 16623, 21, 4574, 576, 6995, 7203, 1114, 3560, 4541, 7211, 7163, 4570, 4989, 6620, 2]
// Exports: default
...
export default function VibegrationsSecretsSheet(projectId) {
  ...
  obj2.title = intl.string(require("module_3560").ACvhVC);
  ...
  obj5.children = intl2.string(require("module_3560").p0Ay4J);
  ...
  obj8.text = intl5.string(require("module_3560")["8SWZaW"]);
  obj8.loading = first1;
