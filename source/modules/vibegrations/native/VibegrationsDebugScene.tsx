...
// Dependencies: [32, 19, 17, 7828, 16725, 16793, 21, 4638, 576, 1115, 3591, 1484, 1612, 504, 9932, 7299, 16794, 4336, 4584, 16735, 9933, 16795, 16801, 16810, 16812, 2]
// Exports: default

// Module 16792 (VibegrationsDebugScene)
...
import VibegrationsDebugSnapshot from "VibegrationsDebugSnapshot" /* 16794 */;
...
const requestDebugStatus = fn(16725).requestDebugStatus;
const jsxProd = fn(21);
...
export default function VibegrationsDebugScene(projectId) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    obj4.content = intl.string(_modDef3591.sDSDiO);
