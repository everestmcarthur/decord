...
// Dependencies: [109, 32, 19, 17, 21, 16767, 1115, 3593, 5060, 576, 5773, 5776, 16768, 4636, 5775, 5693, 7314, 7311, 7263, 2]
    ...
    obj13 = {
      ...
      onChange(arg0) {
            ...
            if (null != tmp3) {
              ...
              tmp16(tmp(16767).vibegrationsSettingsForTier(tmp7));
              const tmpResult2 = tmp(16767);
            }
          },
      title: null,
