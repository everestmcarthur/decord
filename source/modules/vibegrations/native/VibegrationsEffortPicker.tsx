...
// Dependencies: [109, 32, 19, 17, 21, 16737, 1115, 3591, 5058, 576, 5771, 5774, 16738, 4634, 5773, 5691, 7310, 7307, 7259, 2]
    ...
    obj13 = {
      ...
      onChange(arg0) {
            ...
            if (null != tmp3) {
              ...
              tmp16(tmp(16737).vibegrationsSettingsForTier(tmp7));
