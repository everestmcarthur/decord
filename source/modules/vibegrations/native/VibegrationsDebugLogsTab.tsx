...
// Dependencies: [32, 19, 17, 16851, 21, 4722, 576, 16982, 11406, 7405, 4718, 16983, 1115, 3676, 5292, 5777, 1612, 504, 10037, 16984, 10038, 7246, 16985, 16986, 8957, 2]
// Exports: default

// Module 16981 (VibegrationsDebugLogsTab)
import nativeDefault from "native" /* 576 */;
import _modDef3676 from "module_3676" /* 3676 */;
import VibegrationsDebugJson from "VibegrationsDebugJson" /* 16982 */;
...
let closure_11 = noop.memo((entry) => {
  ...
  if (expanded) {
    let ChevronSmallRightIcon = tmp3(11406).ChevronSmallDownIcon;
    let tmp6 = tmp3;
  } else {
    ChevronSmallRightIcon = tmp3(7405).ChevronSmallRightIcon;
    tmp6 = tmp3;
  }
  const obj = { style: tmp.row, children: null };
  const obj2 = { style: tmp.rowHead, children: null };
  const obj3 = { variant: "text-xs/normal", color: "text-subtle", children: tmp6(16983).formatClockTime(entry.ts) };
  const items1 = [closure_7(tmp6(4718).Text, obj3), , , ];
  ...
  items1[1] = closure_7(tmp6(4718).Text, { variant: "text-xxs/semibold", color: str2, style: tmp.badge, children: entry.level });
  let tmp9Result = null;
  if (entry.showSource) {
    tmp9Result = null;
    if (null != entry.source) {
      const obj5 = { variant: "text-xxs/semibold", color: "text-subtle", style: tmp.badge, children: entry.source };
      tmp9Result = tmp9(tmp6(4718).Text, obj5);
    }
  }
  items1[2] = tmp9Result;
  ...
  if (null != entry.kind) {
    ...
    obj6.children = intl.string(_modDef3676.GO6JcR);
    tmp9Result4 = tmp9(tmp6(4718).Text, obj6);
  }
  ...
  if (null != memo) {
    ...
    if ("" !== memo.prefix) {
      ...
      tmp9Result5 = tmp9(tmp6(4718).Text, obj7);
    }
    ...
    obj8.accessibilityLabel = intl2.string(_modDef3676.ehmgbH);
    ...
    if ("[\u2026]" === memo.marker) {
      let wkbYxG = tmp16(3676).lXkB6Z;
    } else {
      wkbYxG = tmp16(3676).wkbYxG;
    }
    ...
    items4[1] = tmp7(tmp6(4718).Text, obj11);
    obj8.children = items4;
    items3[1] = tmp7(tmp6(5292).PressableOpacity, obj8);
    ...
    if (expanded) {
      ...
      obj13.children = tmp9(tmp6(4718).Text, obj14);
      tmp9Result6 = tmp9(tmp6(5777).Card, obj13);
    }
    ...
    tmp9Result7 = tmp9(tmp6(4718).Text, obj16);
  }
