...
// Dependencies: [32, 19, 17, 16723, 21, 4638, 576, 16796, 11306, 7319, 4634, 16797, 1115, 3591, 5208, 5693, 1612, 504, 9932, 16798, 9933, 7160, 16799, 16800, 9017, 2]
// Exports: default

// Module 16795 (VibegrationsDebugLogsTab)
import nativeDefault from "native" /* 576 */;
import _modDef3591 from "module_3591" /* 3591 */;
import VibegrationsDebugJson from "VibegrationsDebugJson" /* 16796 */;
...
let closure_11 = noop.memo((entry) => {
  ...
  if (expanded) {
    let ChevronSmallRightIcon = tmp3(11306).ChevronSmallDownIcon;
    let tmp6 = tmp3;
  } else {
    ChevronSmallRightIcon = tmp3(7319).ChevronSmallRightIcon;
    tmp6 = tmp3;
  }
  const obj = { style: tmp.row, children: null };
  const obj2 = { style: tmp.rowHead, children: null };
  const obj3 = { variant: "text-xs/normal", color: "text-subtle", children: tmp6(16797).formatClockTime(entry.ts) };
  const items1 = [closure_7(tmp6(4634).Text, obj3), , , ];
  ...
  items1[1] = closure_7(tmp6(4634).Text, { variant: "text-xxs/semibold", color: str2, style: tmp.badge, children: entry.level });
  let tmp9Result = null;
  if (entry.showSource) {
    tmp9Result = null;
    if (null != entry.source) {
      const obj5 = { variant: "text-xxs/semibold", color: "text-subtle", style: tmp.badge, children: entry.source };
      tmp9Result = tmp9(tmp6(4634).Text, obj5);
    }
  }
  items1[2] = tmp9Result;
  ...
  if (null != entry.kind) {
    ...
    obj6.children = intl.string(_modDef3591.GO6JcR);
    tmp9Result4 = tmp9(tmp6(4634).Text, obj6);
  }
  ...
  if (null != memo) {
    ...
    if ("" !== memo.prefix) {
      ...
      tmp9Result5 = tmp9(tmp6(4634).Text, obj7);
    }
    ...
    obj8.accessibilityLabel = intl2.string(_modDef3591.ehmgbH);
    ...
    if ("[\u2026]" === memo.marker) {
      let wkbYxG = tmp16(3591).lXkB6Z;
    } else {
      wkbYxG = tmp16(3591).wkbYxG;
    }
    ...
    items4[1] = tmp7(tmp6(4634).Text, obj11);
    obj8.children = items4;
    items3[1] = tmp7(tmp6(5208).PressableOpacity, obj8);
    ...
    if (expanded) {
      ...
      obj13.children = tmp9(tmp6(4634).Text, obj14);
      tmp9Result6 = tmp9(tmp6(5693).Card, obj13);
    }
    ...
    tmp9Result7 = tmp9(tmp6(4634).Text, obj16);
  }
