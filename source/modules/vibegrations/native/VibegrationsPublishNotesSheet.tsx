...
// Dependencies: [5, 32, 19, 17, 2012, 1979, 4222, 1371, 1074, 4567, 21, 4574, 576, 6995, 504, 7258, 9336, 510, 4541, 11362, 1114, 3560, 1100, 7696, 7470, 7211, 7163, 4570, 7099, 4727, 4989, 2]
// Exports: default

// Module 16632 (VibegrationsPublishNotesSheet)
...
export default function VibegrationsPublishNotesSheet(guildId) {
  ...
  const callback1 = obj4.useCallback(() => {
    ...
    obj4.title = intl.string(_modDef3560.IcSdnu);
    obj3.header = obj4;
          ...
          if (arg0 === 1) {
            ...
            if (null != found) {
              if ("" !== trimmed) {
                ...
                const parsed = tmp3(7696).parse(found, combined);
                const tmp35Result = tmp3(7470);
