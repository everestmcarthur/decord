...
// Dependencies: [5, 32, 19, 17, 2013, 1980, 4286, 1372, 1074, 4631, 21, 4638, 576, 7091, 504, 7354, 9447, 16754, 4605, 11476, 1115, 3591, 1101, 7790, 7566, 7307, 7259, 4634, 7195, 4791, 5060, 2]
// Exports: default

// Module 16753 (VibegrationsPublishNotesSheet)
...
import VibegrationsPatchNotesChannel from "VibegrationsPatchNotesChannel" /* 16754 */;
...
export default function VibegrationsPublishNotesSheet(guildId) {
      ...
      try {
        ...
        if (0 === c3) {
          if (arg0 === 1) {
            ...
            if (null != found) {
              if ("" !== trimmed) {
                ...
                const parsed = tmp3(7790).parse(found, combined);
                const tmp31Result = tmp3(7566);
          ...
          if (1 === tmp7) {
            ...
            if (false !== ok) {
              const result = guildId(16754).rememberPatchNotesChannel(closure_129_0, closure_129_17.id);
              closure_129_20();
              dependencyMap = 0;
              const obj = guildId(16754);
            }
          }
          const _Error = Error;
  ...
  if (stateFromStores.length > 0) {
    ...
    const obj17 = { label: null, placeholder: null, description: null, errorMessage: null, maxLength: null, value: null, onChange: null, isDisabled: null };
