...
// Dependencies: [32, 19, 17, 4714, 21, 4722, 504, 4458, 4723, 672, 5834, 5156, 2]
// Exports: default, shouldSweep

// Module 16938 (VibegrationsConjureShimmer)
...
export default function VibegrationsConjureShimmer(epoch) {
  ...
  let obj = tint(504);
  const tmp2 = tint;
  sharedValue = tint(4458).useSharedValue(0);
  if (live) {
  ...
  const animatedStyle = tmp2(4458).useAnimatedStyle(W);
  let obj4 = {
    style: tmp.root,
  ...
  if (live) {
    ...
    obj8.children = closure_8(width(5156), obj10);
    obj6.children = closure_8(width(4458).View, obj8);
    obj5.children = closure_8(width(5834), obj6);
    tmp14 = closure_8(tmp13, obj5);
    const tmp18 = width(5834);
  }
  items3[1] = tmp14;
