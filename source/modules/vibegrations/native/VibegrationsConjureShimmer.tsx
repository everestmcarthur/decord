...
// Dependencies: [32, 19, 17, 4631, 21, 4639, 504, 4376, 4640, 672, 5749, 5071, 2]
// Exports: default, shouldSweep

// Module 16730 (VibegrationsConjureShimmer)
...
export default function VibegrationsConjureShimmer(epoch) {
  ...
  if (live) {
    ...
    obj8.children = closure_8(width(5071), obj10);
    obj6.children = closure_8(width(4376).View, obj8);
    obj5.children = closure_8(width(5749), obj6);
    tmp14 = closure_8(tmp13, obj5);
    const tmp18 = width(5749);
  }
  items3[1] = tmp14;
