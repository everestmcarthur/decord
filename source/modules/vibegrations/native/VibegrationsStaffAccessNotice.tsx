...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 16784, 1101, 4334, 5695, 4594, 4636, 1115, 3593, 2]
// Exports: default

// Module 16783 (VibegrationsStaffAccessNotice)
...
export default function VibegrationsStaffAccessNotice() {
  const tmp = closure_8();
  vibegrationsStaffAccessTarget = vibegrationsStaffAccessTarget(16784).useVibegrationsStaffAccessTarget();
  ...
  if (null != vibegrationsStaffAccessTarget) {
    ...
    const items = [closure_6(tmp2(4594).CircleInformationIcon, obj4), ];
    const obj5 = { variant: "text-sm/normal", color: "text-default", style: tmp.copy, children: null };
    const intl = tmp2(1115).intl;
    const obj6 = { channel: tmp2(16784).VIBEGRATIONS_STAFF_ACCESS_CHANNEL_NAME, onNavigate: tmp5 };
    obj5.children = intl.format(_modDef3593["4BsHmp"], obj6);
    items[1] = closure_6(tmp2(4636).Text, obj5);
    obj3.children = items;
    obj2.children = closure_7(View, obj3);
    tmp6 = closure_6(tmp2(5695).Card, obj2);
  }
  return tmp6;
};
