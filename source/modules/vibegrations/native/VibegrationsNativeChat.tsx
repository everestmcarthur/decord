...
// Dependencies: [19, 17, 1895, 16663, 16666, 21, 4606, 576, 1114, 3590, 5024, 4602, 4596, 5026, 5658, 4301, 16681, 16682, 16684, 16686, 16688, 504, 8964, 16690, 2]
// Exports: default
...
function ProposalCard(proposal) {
  ...
  if ("" === trimmed) {
    ...
    stringResult = tmp8(4596).parse(trimmed, true, closure_16);
    const tmp8Result = tmp8(4596);
  }
  ...
  if (proposal.changes.length > 0) {
    ...
    const items2 = [tmp3(tmp6(4602).Text, obj4), ];
    ...
    tmp5Result = tmp5(tmp6(5024).Stack, obj3);
  }
  items1[2] = tmp5Result;
  ...
  if (bot_permissions.length > 0) {
    ...
    const items3 = [tmp3(tmp6(4602).Text, obj6), ];
    const obj7 = { variant: "text-sm/normal", color: "text-default", children: bot_permissions.join(", ") };
    items3[1] = tmp3(tmp6(4602).Text, obj7);
    obj5.children = items3;
    tmp5Result3 = tmp5(tmp6(5024).Stack, obj5);
  }
  ...
  if (privileged_intents.length > 0) {
    ...
    const items4 = [tmp3(tmp6(4602).Text, obj9), ];
    const obj10 = { variant: "text-sm/normal", color: "text-default", children: privileged_intents.join(", ") };
    items4[1] = tmp3(tmp6(4602).Text, obj10);
    obj8.children = items4;
    tmp5Result4 = tmp5(tmp6(5024).Stack, obj8);
  }
  ...
  if (actionable) {
    ...
    tmp3Result = tmp3(tmp6(5026).Button, obj11);
  }
  items1[5] = tmp3Result;
  ...
  return closure_14(closure_5, {
    ...
    children: attachments.map((id, index) => {
      if (null != id.id) {
        ...
        obj.children = closure_1_14(projectId(4602).Text, obj3);
        ...
        obj4.children = closure_1_14(projectId(4602).Text, obj5);
  ...
  if ("user" === message.role) {
    if ("" !== trimmed) {
      ...
      if ("" !== trimmed) {
        ...
        tmp51Result = tmp51(message(4602).Text, obj4);
      }
  ...
  ,
    ...
    if (null == proposal) {
      ...
      if ("" !== trimmed) {
        ...
        if (!tmp14) {
          ...
          obj8.children = tmp19(message(4602).Text, obj9);
    ...
    if (null != found) {
      ...
      if ("message" in found) {
        ...
        tmp19Result18 = tmp19(message(4602).Text, obj19);
      }
    }
