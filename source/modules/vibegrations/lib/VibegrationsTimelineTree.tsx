...
// Module 16803 (VibegrationsTimelineTree)
...
let obj = { assembling: _modDef3593["9G3ZmA"], installing_deps: _modDef3593.VZuRug, building: _modDef3593["s+ylXP"], bundling: _modDef3593.rEQlMx, committing: _modDef3593.Yvyw1H, built: _modDef3593.hOcVAj, build_error: _modDef3593["6L9Vwt"], healthchecking: _modDef3593.sz8yAj, awaiting_auth: _modDef3593["orD+xo"], healthcheck_passed: _modDef3593["x+sqTG"], healthcheck_failed: _modDef3593.FUWbq1, deploying: _modDef3593.wcXX8Z, preview_ready: _modDef3593["78YNh7"], working: _modDef3593.nv6pUM, error: _modDef3593.j3hBoA };
let size = fn(2);
...
export const describeTaskStatus = function describeTaskStatus(arg0) {
  if ("running" === arg0) {
    ...
    return intl5.string(_modDef3593["fW7T+d"]);
  } else if ("done" === arg0) {
    const intl4 = util.intl;
    return intl4.string(_modDef3593.X3c4hc);
  } else if ("failed" === arg0) {
    const intl3 = util.intl;
    return intl3.string(_modDef3593.LK4Wsd);
  } else if ("cancelled" === arg0) {
    const intl2 = util.intl;
    return intl2.string(_modDef3593.msWvKA);
  } else if ("incomplete" === arg0) {
    const intl = util.intl;
    return intl.string(_modDef3593.esfcU6);
  }
};
