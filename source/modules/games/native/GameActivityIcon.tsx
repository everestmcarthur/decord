...
// Dependencies: [19, 17, 21, 4606, 576, 4317, 8654, 4458, 5638, 1396, 2]

// Module 9273 (GameActivityIcon)
...
export default noop.memo(function GameActivityIcon(style) {
  ...
  if (null == iconURL) {
    if ("none" === style.fallback) {
      ...
      obj2.color = tmp2(4458).isThemeDark(obj.useThemeContext().theme) ? colors.WHITE : colors.BLACK;
      jsx(tmp2(8654).UnknownGameIcon, { size: "custom", style: null, color: null });
