...
// Dependencies: [19, 17, 4714, 1074, 21, 504, 16075, 1364, 9050, 16076, 5757, 5144, 1115, 13199, 576, 4689, 4417, 2025, 10471, 3224, 2]
// Exports: default
...
export default function IncentivizedAccountLinkConfirmationBottomSheet() {
  ...
  if (obj.useStateFromStores(items, () => useReducedMotion.useReducedMotion)) {
    ...
    if (tmpResult.isAndroid()) {
      const obj4 = { url: tmp4(16076), style: null };
      const size1 = { width: v150, height: v150 };
      obj4.style = size1;
      tmp3Result = tmp3(tmp4(9050), obj4);
      tmp8 = tmp4;
      tmp9 = tmp3;
      const tmp4Result = tmp4(9050);
    } else {
      const obj5 = { source: null, resizeMode: "contain", style: null };
      const obj6 = { uri: tmp4(16076) };
      obj5.source = obj6;
      const size2 = { width: v150, height: v150 };
      obj5.style = size2;
      tmp3Result = tmp3(tmp4(5757), obj5);
      tmp8 = tmp4;
      tmp9 = tmp3;
      const tmp4Result2 = tmp4(5757);
    }
    tmpResult = tmp(1364);
  }
