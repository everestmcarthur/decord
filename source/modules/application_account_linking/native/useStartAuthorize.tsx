...
// Dependencies: [5, 19, 7273, 1074, 7274, 7276, 4334, 1241, 7278, 2]
// Exports: default

// Module 7272 (useStartAuthorize)
...
const require = fn;
const AuthorizeFlow = fn(7273).AuthorizeFlow;
    ...
    if (c6 === 2) {
      ...
      try {
        ...
        if (0 === c5) {
          ...
          const result = closure_0(7278).accountLinkAuthorizationStarted(closure_0.id, obj9);
          c4 = 0;
          c6 = 3;
