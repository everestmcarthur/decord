...
// Dependencies: [5, 19, 7239, 1074, 7240, 7242, 4301, 1242, 7244, 2]
// Exports: default

// Module 7238 (useStartAuthorize)
...
const require = fn;
const AuthorizeFlow = fn(7239).AuthorizeFlow;
    ...
    if (c6 === 2) {
      ...
      try {
        ...
        if (0 === c5) {
          ...
          const result = closure_0(7244).accountLinkAuthorizationStarted(closure_0.id, obj9);
          c4 = 0;
          c6 = 3;
