...
// Dependencies: [5, 19, 7280, 1074, 7281, 7283, 4334, 1241, 7285, 2]
// Exports: default

// Module 7279 (useStartAuthorize)
...
const require = fn;
const AuthorizeFlow = fn(7280).AuthorizeFlow;
    ...
    if (c6 === 2) {
      ...
      try {
        ...
        if (0 === c5) {
          ...
          const result = closure_0(7285).accountLinkAuthorizationStarted(closure_0.id, obj9);
          c4 = 0;
          c6 = 3;
