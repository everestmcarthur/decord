...
// Dependencies: [19, 17, 1372, 1955, 21, 576, 7368, 10362, 5149, 4722, 563, 7358, 7378, 5777, 5292, 5850, 1177, 4718, 1115, 5144, 8975, 2]
// Exports: getScaledAccountLinkBannerHeight

// Module 16451 (AccountLinkBanner)
...
const NORMAL = fn(7368).GameIconSizes.NORMAL;
let closure_14 = fn(7368).GameIconImageSize[NORMAL];
