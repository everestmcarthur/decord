...
// Dependencies: [19, 17, 1371, 1954, 21, 576, 7245, 10208, 5031, 4606, 563, 7235, 7255, 5658, 5174, 5731, 1178, 4602, 1114, 5026, 8825, 2]
...
const NORMAL = fn(7245).GameIconSizes.NORMAL;
let closure_14 = fn(7245).GameIconImageSize[NORMAL];
