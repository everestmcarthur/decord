...
// Dependencies: [32, 5, 4835, 1918, 1371, 4512, 1074, 9654, 1090, 510, 9647, 8948, 9337, 9631, 9336, 9332, 9339, 4250, 1086, 1272, 573, 14531, 8427, 1471, 2]
// Exports: default

// Module 14570 (AuthCommandsFactory)
...
import LeakyBucket from "LeakyBucket" /* 9654 */;
    ...
    handler(socket) {
      ...
      if (null == access_token) {
        if (socket.transport === constants.IPC) {
          ...
          if (null == id) {
            let obj2 = { errorCode: constants2.INVALID_COMMAND };
            const tmp29 = new closure_1(9647)(obj2, "No application.");
            throw tmp29;
          } else {
            IDENTIFY = closure_0(8427).OAuth2Scopes.IDENTIFY;
                ...
                if (typeof _authorize === "function") {
                  ...
                  return authorizeWithPrompt(obj2, closure_0, closure_1).then((result) => {
                    if (null == result) {
                      ...
                      const tmp22 = new closure_1(9647)(obj, "Unknown error occurred");
                      throw tmp22;
                    } else {
                      ...
                      if (null != parsed.error) {
                        ...
                        const _HermesInternal = HermesInternal;
                        const tmp82 = new closure_1(9647)(obj2, "OAuth2 Error: " + parsed.error + ": " + str);
                        throw tmp82;
                      } else {
      ...
      if (null == access_token) {
        ...
        const tmp11 = new closure_1(9647)(obj, "No access token provided");
        throw tmp11;
      } else {
          ...
          if ("token" === args.response_type) {
            ...
            return authorizeWithPrompt(obj6, closure_0, hasItem).then((location) => {
              ...
              if (null == location) {
                ...
                const tmp25 = new hasItem(9647)(obj2, "Unknown error occurred");
                throw tmp25;
              } else {
                const _URL = URL;
                ...
                if (hasItem) {
                  ...
                  if (null != value2) {
                    if ("" !== value2) {
                      ...
                      const _HermesInternal = HermesInternal;
                      const tmp122 = new hasItem(9647)(obj4, "OAuth2 Error: " + value2 + ": " + str5);
                      throw tmp122;
                    }
                  }
                  if (null == value) {
                    const obj5 = { errorCode: constants2.OAUTH2_ERROR };
                    const tmp8 = new hasItem(9647)(obj5, "OAuth2 Error: Unable to find auth code");
                    throw tmp8;
                  } else {
