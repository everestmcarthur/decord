...
// Dependencies: [32, 5, 4833, 1918, 1371, 4510, 1074, 9631, 1090, 510, 9624, 8925, 9314, 9608, 9313, 9309, 9316, 4248, 1086, 1272, 573, 14553, 8404, 1471, 2]
// Exports: default
    ...
    handler(socket) {
      ...
      if (null == access_token) {
        if (socket.transport === constants.IPC) {
          ...
          if (null == id) {
            let obj2 = { errorCode: constants2.INVALID_COMMAND };
            const tmp29 = new closure_1(9624)(obj2, "No application.");
            throw tmp29;
          } else {
                  ...
                  return authorizeWithPrompt(obj2, closure_0, closure_1).then((result) => {
                    if (null == result) {
                      ...
                      if (null != parsed.error) {
                        ...
                        const _HermesInternal = HermesInternal;
                        const tmp82 = new closure_1(9624)(obj2, "OAuth2 Error: " + parsed.error + ": " + str);
                        throw tmp82;
                      } else {
          ...
          if ("token" === args.response_type) {
            ...
            return authorizeWithPrompt(obj6, closure_0, hasItem).then((location) => {
              ...
              if (null == location) {
                ...
                const tmp25 = new hasItem(9624)(obj2, "Unknown error occurred");
                throw tmp25;
              } else {
                const _URL = URL;
                ...
                if (hasItem) {
                  ...
                  if (null != value2) {
                    if ("" !== value2) {
                      ...
                      const _HermesInternal = HermesInternal;
                      const tmp122 = new hasItem(9624)(obj4, "OAuth2 Error: " + value2 + ": " + str5);
                      throw tmp122;
                    }
                  }
                  if (null == value) {
                    const obj5 = { errorCode: constants2.OAUTH2_ERROR };
                    const tmp8 = new hasItem(9624)(obj5, "OAuth2 Error: Unable to find auth code");
                    throw tmp8;
                  } else {
