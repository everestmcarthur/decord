...
// Function ID: 14607
// Name: soundboard
// Dependencies: [5, 5096, 1372, 4544, 1085, 8460, 7445, 5104, 9689, 7480, 7451, 9686, 7482, 7289, 2]

// Module 14606 (soundboard)
...
let obj3 = {};
let items = [fn(8460).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
let obj5 = {};
const items1 = [fn(8460).OAuth2Scopes.RPC, fn(8460).OAuth2Scopes.RPC_VOICE_WRITE];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp2(7445).maybeFetchSoundboardSounds(), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_2 = tmp5(7480)();
          let result = null != sound2;
          if (result) {
            result = null != currentUser2;
          }
          if (result) {
            result = tmp2(7451).canUseSoundboardSound(currentUser2, sound2, closure_128_2);
            const obj = tmp2(7451);
          }
          closure_128_3 = result;
          if (null == closure_128_2) {
            const obj8 = { errorCode: constants.INVALID_CHANNEL };
            const tmp52 = new tmp5(9686)(obj8, "Invalid Channel.");
            throw tmp52;
          } else if (closure_128_3) {
            if (tmp74(7482)(closure_128_2)) {
              if (null != sound2) {
                const items = [tmp5(7289).RPC];
                tmp2(7451).playSound(sound2, closure_128_2.id, items);
                const obj4 = tmp2(7451);
              }
              c3 = 3;
              return { value: "HermesInternal", done: null };
            } else {
              const obj9 = { errorCode: constants.INVALID_PERMISSIONS };
              const tmp32 = new tmp5(9686)(obj9, "Invalid Permissions.");
              throw tmp32;
            }
          } else {
            const obj10 = { errorCode: constants.INVALID_SOUND };
            const tmp22 = new tmp74(9686)(obj10, "Invalid Sound.");
            throw tmp22;
          }
        }
      } catch (tmp56) {
