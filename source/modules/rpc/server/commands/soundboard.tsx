...
// Function ID: 14585
// Name: soundboard
// Dependencies: [5, 5062, 1371, 4510, 1085, 8404, 7390, 5070, 9627, 7425, 7396, 9624, 7427, 7234, 2]

// Module 14584 (soundboard)
...
let obj3 = {};
let items = [fn(8404).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
let obj5 = {};
const items1 = [fn(8404).OAuth2Scopes.RPC, fn(8404).OAuth2Scopes.RPC_VOICE_WRITE];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp2(7390).maybeFetchSoundboardSounds(), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_2 = tmp5(7425)();
          let result = null != sound2;
          if (result) {
            result = null != currentUser2;
          }
          if (result) {
            result = tmp2(7396).canUseSoundboardSound(currentUser2, sound2, closure_128_2);
            const obj = tmp2(7396);
          }
          closure_128_3 = result;
          if (null == closure_128_2) {
            const obj8 = { errorCode: constants.INVALID_CHANNEL };
            const tmp52 = new tmp5(9624)(obj8, "Invalid Channel.");
            throw tmp52;
          } else if (closure_128_3) {
            if (tmp74(7427)(closure_128_2)) {
              if (null != sound2) {
                const items = [tmp5(7234).RPC];
                tmp2(7396).playSound(sound2, closure_128_2.id, items);
                const obj4 = tmp2(7396);
              }
              c3 = 3;
              return { value: "HermesInternal", done: null };
            } else {
              const obj9 = { errorCode: constants.INVALID_PERMISSIONS };
              const tmp32 = new tmp5(9624)(obj9, "Invalid Permissions.");
              throw tmp32;
            }
          } else {
            const obj10 = { errorCode: constants.INVALID_SOUND };
            const tmp22 = new tmp74(9624)(obj10, "Invalid Sound.");
            throw tmp22;
          }
        }
      } catch (tmp56) {
