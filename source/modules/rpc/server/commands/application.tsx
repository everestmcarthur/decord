...
// Function ID: 14584
// Name: application
// Dependencies: [4866, 4542, 1074, 9700, 9702, 14584, 8995, 9697, 9661, 1241, 1271, 8993, 2]

// Module 14583 (application)
  ...
  [RPCCommands.SEND_ANALYTICS_EVENT]: {
    ...
    handler(arg0) {
      ...
      if (tmpResult.hasApplicationFlag(application, constants.EMBEDDED_FIRST_PARTY)) {
        const activeAnalyticsSessionIDs = tmp(9661).getActiveAnalyticsSessionIDs(id);
        ...
        const tmp12 = new tmp5(9697)(obj6, "This application cannot access this API");
        throw tmp12;
      }
