...
// Function ID: 14598
// Name: activities
// Dependencies: [5, 1074, 14564, 14552, 9689, 8981, 9684, 14556, 9634, 2]

// Module 14597 (activities)
...
let obj = {};
let CONTEXT_MENU_ICON_NAMES = fn(14564);
obj[RPCCommands.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS] = CONTEXT_MENU_ICON_NAMES.createRPCCommand(RPCCommands.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS, {
  scope: fn(14552).activityInstanceConnectedParticipantsScope,
  handler(socket) {
...
CONTEXT_MENU_ICON_NAMES = fn(14564);
let obj3 = {
  scope: fn(14552).activityInstanceConnectedParticipantsScope,
  handler(socket) {
    const result = RPCHelpers.validatePostMessageTransport(socket.socket.transport);
