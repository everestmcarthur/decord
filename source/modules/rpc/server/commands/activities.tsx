...
// Function ID: 14587
// Name: activities
// Dependencies: [5, 1074, 14553, 14541, 9629, 8925, 9624, 14545, 9574, 2]

// Module 14586 (activities)
...
let obj = {};
let CONTEXT_MENU_ICON_NAMES = fn(14553);
obj[RPCCommands.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS] = CONTEXT_MENU_ICON_NAMES.createRPCCommand(RPCCommands.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS, {
  scope: fn(14541).activityInstanceConnectedParticipantsScope,
  handler(socket) {
...
CONTEXT_MENU_ICON_NAMES = fn(14553);
let obj3 = {
  scope: fn(14541).activityInstanceConnectedParticipantsScope,
  handler(socket) {
    const result = RPCHelpers.validatePostMessageTransport(socket.socket.transport);
