...
// Function ID: 14722
// Name: subscriptions
// Dependencies: [5, 1074, 9802, 14722, 1241, 14723, 2]

// Module 14721 (subscriptions)
      ...
      return (async (arg0, value) => {
        if (c3 === 2) {
          ...
          try {
            ...
            initialSubscriptionPayload = tmp2(14723).getInitialSubscriptionPayload(closure_129_1, closure_129_2, closure_129_3);
