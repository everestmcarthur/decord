...
// Function ID: 14555
// Name: subscriptions
// Dependencies: [5, 1074, 9645, 14555, 1242, 14556, 2]

// Module 14554 (subscriptions)
            ...
            if (0 === dependencyMap) {
              if (arg0 === 1) {
                ...
                if (null == events.events[event]) {
                  ...
                  const tmp352 = new v0(9645)(obj4, "Invalid event: " + event);
                  throw tmp352;
                } else if (v0(14555)(importDefault.authorization.scopes, tmp66.scope)) {
                  ...
                  const tmp10 = new tmp71(9645)(obj8, "Not authenticated or invalid scope");
                  throw tmp10;
                }
                obj13 = events;
              }
              ...
              if (null != closure_128_1.validate(closure_129_3, closure_128_0.validation(closure_128_1), { convert: false }).error) {
                ...
                const tmp63 = new v0(9645)(obj9, "Invalid subscription parameters provided");
                throw tmp63;
              }
            }
            const obj10 = { args: closure_129_3, socket: closure_129_1 };
            closure_128_2 = closure_128_0.handler(obj10);
            initialSubscriptionPayload = tmp2(14556).getInitialSubscriptionPayload(closure_129_1, closure_129_2, closure_129_3);
