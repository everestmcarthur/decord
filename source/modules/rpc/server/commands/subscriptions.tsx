// Module ID: 14504
// Function ID: 14505
// Dependencies: [5, 1074, 9559, 14505, 1242, 14506, 2]
          ...
          if (0 === closure_2) {
            if (arg0 === 1) {
              ...
              if (null == closure_1_0.events[dependencyMap]) {
                ...
                let tmp35 = closure_1_1(9559);
                tmp35 = new tmp35(obj1, "Invalid event: " + dependencyMap);
                throw tmp35;
              } else if (closure_1_1(14505)(closure_1_1.authorization.scopes, tmp67.scope)) {
                ...
                tmp72(1242).track(closure_1_4.RPC_SUBSCRIPTION_REQUESTED, obj2);
                ...
                const tmp72Result = tmp72(1242);
              } else {
                const obj4 = { errorCode: null };
                obj4[0] = closure_1_5.INVALID_PERMISSIONS;
                const tmp10 = new tmp72(9559)(obj4, "Not authenticated or invalid scope");
                throw tmp10;
              }
              obj13 = closure_1_0;
            }
            ...
            if (null != closure_1.validate(initialSubscriptionPayload, closure_0.validation(closure_1), { convert: false }).error) {
              ...
              const tmp64 = new closure_1_1(9559)(obj5, "Invalid subscription parameters provided");
              throw tmp64;
            }
          }
