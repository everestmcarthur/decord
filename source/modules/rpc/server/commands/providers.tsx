...
// Function ID: 14711
// Name: providers
// Dependencies: [5, 5451, 4626, 1074, 1921, 1085, 9805, 9807, 5453, 9802, 573, 1110, 9490, 5576, 2]

// Module 14710 (providers)
...
obj2 = {
  ...
  handler(arg0) {
    ...
    value = connection_redirect(5453).get(provider);
    dependencyMap = value;
    if (null == value) {
      const obj4 = { errorCode: constants2.INVALID_PROVIDER };
      const _HermesInternal = HermesInternal;
      const tmp4Result1 = new tmp4(9802)(obj4, "Platform not found for provider \"" + provider + "\"");
      throw tmp4Result1;
    } else if (provider !== constants.AMAZON_MUSIC) {
      let obj5 = { errorCode: constants2.UNAUTHORIZED_FOR_APPLICATION };
      const tmp22 = new tmp4(9802)(obj5, "Command not available for this application");
      throw tmp22;
                ...
                if (arg0 === 1) {
                  ...
                  if (null == account) {
                    ...
                    function handleConnectionsCallbackError() {
                      ...
                      const tmp = connection_redirect(9802);
                      successRedirect(new connection_redirect(9802)({ errorCode: closure_3_9.OAUTH2_ERROR }, "OAuth2 setup for \"" + closure_0 + "\" failed"));
                      const tmp2 = new connection_redirect(9802)({ errorCode: closure_3_9.OAUTH2_ERROR }, "OAuth2 setup for \"" + closure_0 + "\" failed");
                      connection_redirect(573).unsubscribe("USER_CONNECTIONS_UPDATE", closure_1_3);
                      const ComponentDispatch = closure_0(1110).ComponentDispatch;
                      ComponentDispatch.unsubscribe(constants2.CONNECTIONS_CALLBACK_ERROR, closure_1_4);
                    }
      ...
      const tmp10 = new tmp4(9802)(obj6, "Command not available for this application");
      throw tmp10;
    }
    let obj3 = connection_redirect(5453);
  }
};
