...
// Dependencies: [5, 5281, 4465, 1074, 1920, 1085, 9562, 9564, 5283, 9559, 573, 1109, 9257, 5406, 2]

// Module 14493 (AM_HARMONY_PRD_APPLICATION_ID)
              ...
              if (0 === c6) {
                if (arg0 === 1) {
                  ...
                  if (null == account) {
                    ...
                    const subscription = connection_redirect(573).subscribe("USER_CONNECTIONS_UPDATE", handleConnectionsUpdate);
                    let ComponentDispatch = callback(1109).ComponentDispatch;
                    ...
                    obj1[2] = callback2;
                    connection_redirect(9257)(obj1);
                    const obj6 = connection_redirect(573);
                  } else {
                    c5 = 1;
                    let obj3 = connection_redirect(5406);
                    c6 = 2;
                    c7 = 1;
                ...
                const tmp21 = new connection_redirect(9559)(obj4, "Refreshing access token did not return a new access token");
                throw tmp21;
              }
              c7 = 3;
            } catch (tmp44) {
      ...
      try {
        ...
        if (0 === type) {
          ...
          if (arg0 === 1) {
            ...
            const result = socket(9564).validatePostMessageTransport(socket.transport);
            const obj14 = socket(9564);
            dependencyMap = socket(9564).validateApplication(socket.application);
            const obj15 = socket(9564);
            type = provider(5283).get(provider);
            if (null == type) {
              const obj2 = { errorCode: null };
              obj2[0] = closure_9.INVALID_PROVIDER;
              const _HermesInternal = HermesInternal;
              let tmp59 = provider(9559);
              ...
              const tmp53 = new provider(9559)(obj3, "Command not available for this application");
              throw tmp53;
              ...
              if (null == id) {
                ...
                const tmp44 = new provider(9559)(obj4, "No connection found");
                throw tmp44;
              } else {
                let obj5 = provider(5406);
                type = 2;
                id = 1;
              ...
              const tmp24 = new provider(9559)(obj6, "Command not available for this application");
              throw tmp24;
            }
            const obj16 = provider(5283);
          }
        } else if (arg0 === 1) {
          id = 3;
          throw arg1;
          ...
          if (null == account) {
            ...
            const tmp15 = new provider(9559)(obj8, "Refreshing access token did not return a new access token");
            throw tmp15;
          } else {
            obj = { access_token: null };
            obj[0] = account;
