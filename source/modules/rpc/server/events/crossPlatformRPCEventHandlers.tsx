...
// Dependencies: [4950, 1916, 1976, 4744, 1958, 2022, 1980, 1909, 4745, 1372, 4741, 4626, 1074, 9805, 9807, 9802, 4933, 14678, 8571, 12, 14683, 1086, 558, 9808, 14740, 14741, 2]

// Module 14739 (crossPlatformRPCEventHandlers)
import _modDef12 from "module_12" /* 12 */;
import discord_common_shallowEqualDefault from "discord_common/shallowEqual" /* 558 */;
import BigFlagUtilsAll from "BigFlagUtils" /* 1086 */;
import RPCErrorDefault from "RPCError" /* 9802 */;
import createRpcJoiSchemaObjectDefault from "createRpcJoiSchemaObject" /* 9805 */;
...
import transformGuildMemberDefault from "transformGuildMember" /* 14740 */;
import transformApplicationDefault from "transformApplication" /* 14741 */;
...
obj2[RPCEvents.GUILD_STATUS] = {
  scope: fn(8571).OAuth2Scopes.RPC,
  validation(string) {
    const obj = createRpcJoiSchemaObjectDefault(string);
...
let obj5 = {};
const items1 = [fn(8571).OAuth2Scopes.RPC, fn(8571).OAuth2Scopes.RPC_VOICE_READ];
...
const obj7 = {};
const items2 = [fn(8571).OAuth2Scopes.RPC, fn(8571).OAuth2Scopes.RPC_VOICE_READ];
...
const obj9 = {};
const items3 = [fn(8571).OAuth2Scopes.RPC, fn(8571).OAuth2Scopes.RPC_VOICE_READ];
...
const obj11 = {};
const items4 = [fn(8571).OAuth2Scopes.RPC, fn(8571).OAuth2Scopes.RPC_VOICE_READ];
...
obj2[RPCEvents.MESSAGE_CREATE] = { scope: fn(8571).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
const obj12 = { scope: fn(8571).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
obj2[RPCEvents.MESSAGE_UPDATE] = { scope: fn(8571).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
const obj13 = { scope: fn(8571).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
obj2[RPCEvents.MESSAGE_DELETE] = { scope: fn(8571).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
const obj15 = { scope: null, validation: null, handler: null };
const obj16 = {};
const items5 = [fn(8571).OAuth2Scopes.RPC, fn(8571).OAuth2Scopes.RPC_VOICE_READ, RPC_LOCAL_SCOPE];
...
const obj18 = {};
const items6 = [fn(8571).OAuth2Scopes.RPC, fn(8571).OAuth2Scopes.RPC_VOICE_READ, RPC_LOCAL_SCOPE];
...
obj2[RPCEvents.VOICE_SESSION_PARTICIPANTS_UPDATE] = {
  ...
  handler(args) {
    ...
    const socket = args.socket;
    const result = socket(14678).validateEventSubscription(socket, session_id);
    return (prevState) => {
      prevState = prevState.prevState;
...
const obj14 = { scope: fn(8571).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
...
const obj22 = {};
const items7 = [fn(8571).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
const obj24 = {};
const items8 = [fn(8571).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
const obj26 = {};
const items9 = [fn(8571).OAuth2Scopes.RPC, RPC_AUTHENTICATED_SCOPE, RPC_LOCAL_SCOPE];
...
const obj28 = {};
const items10 = [fn(8571).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
const obj30 = {};
const items11 = [fn(8571).OAuth2Scopes.RPC, RPC_AUTHENTICATED_SCOPE, RPC_LOCAL_SCOPE];
...
const obj32 = {};
const items12 = [fn(8571).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
obj2[RPCEvents.ACTIVITY_INSTANCE_PARTICIPANTS_UPDATE] = fn(14683).activityInstanceConnectedParticipantsUpdateEvent;
const obj36 = {
  scope: null,
  handler() {
...
const obj40 = {};
const items15 = [fn(8571).OAuth2Scopes.RPC, fn(8571).OAuth2Scopes.RPC_NOTIFICATIONS_READ];
...
obj2[RPCEvents.RELATIONSHIP_UPDATE] = {
  scope: fn(8571).OAuth2Scopes.RELATIONSHIPS_READ,
  handler(socket) {
...
const obj43 = {};
const items16 = [RPC_LOCAL_SCOPE, fn(8571).OAuth2Scopes.IDENTIFY];
...
const obj45 = {};
const items17 = [fn(8571).OAuth2Scopes.IDENTIFY, fn(8571).OAuth2Scopes.GUILDS_MEMBERS_READ];
...
const obj49 = {};
const items20 = [RPC_LOCAL_SCOPE, fn(8571).OAuth2Scopes.RPC_SCREENSHARE_READ];
...
const obj51 = {};
const items21 = [RPC_LOCAL_SCOPE, fn(8571).OAuth2Scopes.RPC_VIDEO_READ];
