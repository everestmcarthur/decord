...
obj2[RPCEvents.GUILD_STATUS] = {
  scope: fn(8457).OAuth2Scopes.RPC,
  validation(string) {
    const obj = createRpcJoiSchemaObjectDefault(string);
...
const obj5 = {};
const items1 = [fn(8457).OAuth2Scopes.RPC, fn(8457).OAuth2Scopes.RPC_VOICE_READ];
...
const obj7 = {};
const items2 = [fn(8457).OAuth2Scopes.RPC, fn(8457).OAuth2Scopes.RPC_VOICE_READ];
...
const obj9 = {};
const items3 = [fn(8457).OAuth2Scopes.RPC, fn(8457).OAuth2Scopes.RPC_VOICE_READ];
...
const obj11 = {};
const items4 = [fn(8457).OAuth2Scopes.RPC, fn(8457).OAuth2Scopes.RPC_VOICE_READ];
...
obj2[RPCEvents.MESSAGE_CREATE] = { scope: fn(8457).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
const obj12 = { scope: fn(8457).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
obj2[RPCEvents.MESSAGE_UPDATE] = { scope: fn(8457).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
const obj13 = { scope: fn(8457).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
obj2[RPCEvents.MESSAGE_DELETE] = { scope: fn(8457).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
const obj15 = { scope: null, validation: null, handler: null };
const obj16 = {};
const items5 = [fn(8457).OAuth2Scopes.RPC, fn(8457).OAuth2Scopes.RPC_VOICE_READ, RPC_LOCAL_SCOPE];
...
const obj18 = {};
const items6 = [fn(8457).OAuth2Scopes.RPC, fn(8457).OAuth2Scopes.RPC_VOICE_READ, RPC_LOCAL_SCOPE];
...
const obj14 = { scope: fn(8457).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
...
const obj22 = {};
const items7 = [fn(8457).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
const obj24 = {};
const items8 = [fn(8457).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
const obj26 = {};
const items9 = [fn(8457).OAuth2Scopes.RPC, RPC_AUTHENTICATED_SCOPE, RPC_LOCAL_SCOPE];
...
const obj28 = {};
const items10 = [fn(8457).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
const obj30 = {};
const items11 = [fn(8457).OAuth2Scopes.RPC, RPC_AUTHENTICATED_SCOPE, RPC_LOCAL_SCOPE];
...
const obj32 = {};
const items12 = [fn(8457).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE];
...
const obj40 = {};
const items15 = [fn(8457).OAuth2Scopes.RPC, fn(8457).OAuth2Scopes.RPC_NOTIFICATIONS_READ];
...
obj2[RPCEvents.RELATIONSHIP_UPDATE] = {
  scope: fn(8457).OAuth2Scopes.RELATIONSHIPS_READ,
  handler(socket) {
...
const obj43 = {};
const items16 = [RPC_LOCAL_SCOPE, fn(8457).OAuth2Scopes.IDENTIFY];
...
const obj45 = {};
const items17 = [fn(8457).OAuth2Scopes.IDENTIFY, fn(8457).OAuth2Scopes.GUILDS_MEMBERS_READ];
...
const obj49 = {};
const items20 = [RPC_LOCAL_SCOPE, fn(8457).OAuth2Scopes.RPC_SCREENSHARE_READ];
...
const obj51 = {};
const items21 = [RPC_LOCAL_SCOPE, fn(8457).OAuth2Scopes.RPC_VIDEO_READ];
