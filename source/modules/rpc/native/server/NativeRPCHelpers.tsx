        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            if (null == dependencyMap) {
              ...
              c5 = 1;
              c6 = 1;
              const obj7 = { value: closure_0(9702).processSocketThrottlers(tmp32, tmp30.transport !== tmp2.POST_MESSAGE, tmp30.abortController.signal), done: false };
              return obj7;
            }
          ...
          c6 = 3;
          const obj9 = { value: closure_0(9702).validateSocketApplication(closure_131_0, closure_131_2, closure_131_1), done: true };
          return obj9;
        }
      } catch (tmp25) {
        c6 = tmp;
