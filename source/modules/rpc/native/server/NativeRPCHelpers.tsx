      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            c4 = 0;
            closure_3 = tmp2;
            const result = callback(9564).validateOriginAndUpdateSocket(callback, callback2);
            if (null == dependencyMap) {
              obj1 = { closeCode: null };
              obj1[0] = closure_1_4.INVALID_CLIENTID;
              const tmp23 = new callback2(9559)(obj1, "No Client ID Specified");
              c6 = 3;
              const obj2 = { value: null, done: true };
              obj2[0] = Promise.reject(tmp23);
              return obj2;
            } else {
              let obj3 = callback(9564);
              c5 = 1;
              c6 = 1;
...
export const getDeprecatedVoiceSettings = () => callback(9564).getDeprecatedVoiceSettingsWithShortcut(() => []);
export const getVoiceSettings = (arg0) => callback(9564).getVoiceSettingsWithShortcut(arg0, () => "");
