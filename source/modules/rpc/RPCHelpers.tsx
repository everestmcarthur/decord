...
// Function ID: 9692
// Name: RPCHelpers
// Dependencies: [5, 4867, 1919, 1962, 1386, 1958, 1980, 1909, 4860, 4679, 1372, 4658, 4544, 1074, 1366, 4626, 1091, 12, 7563, 4629, 4872, 9692, 4791, 1368, 8460, 1271, 9686, 9644, 9693, 2]
...
import LeakyBucketDefault from "LeakyBucket" /* 9693 */;
...
const transformUserDefault = tmp(9692);
require = fn;
    ...
    if (!nSFW.isNSFW()) {
      ...
      obj.voice_states = values.map((userId) => {
        ...
        if (null == user) {
          ...
          const obj = { nick: closure_1(4791).getName(tmp, id.id, user), mute: MediaEngineStore.isLocalMute(user.id), volume: MediaEngineStore.getLocalVolume(user.id), pan: MediaEngineStore.getLocalPan(user.id), voice_state: null, user: null };
          const obj3 = { mute, deaf, self_mute: selfMute, self_deaf: selfDeaf, suppress };
          obj.voice_state = obj3;
