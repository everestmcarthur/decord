...
// Dependencies: [5, 32, 1956, 4479, 1074, 1090, 9585, 568, 1109, 1242, 4202, 9586, 9588, 1896, 9589, 2]

// Module 9584 (PostMessageTransport)
...
const require = fn;
const RPC_EMBEDDED_APP_SCOPE = fn(4479).RPC_EMBEDDED_APP_SCOPE;
    ...
    tmp4.handleIFrameMount = function handleIFrameMount(id) {
      ...
      closure_0.handshakeFailureTimeoutId = setTimeout(() => {
        ...
        const item = Array.from(selfEmbeddedActivities.entries()).forEach((item) => {
          ...
          obj2.channel_id = closure_1_0(4202).getEmbeddedActivityLocationChannelId(tmp2.location);
          const obj3 = closure_1_0(4202);
          obj2.guild_id = closure_1_0(4202).getEmbeddedActivityLocationGuildId(tmp2.location);
  ...
  if (Array.isArray(arg2)) {
    ...
    if (RPCOpcodesDefault.HANDSHAKE === tmp5) {
      if (null != value) {
        ...
        const tmp35 = new tmp7(9586)(obj2, "Already connected");
        throw tmp35;
      } else {
        return self.handleHandshake(iframeId, tmp6, arg3);
      }
    } else if (tmp7(9585).FRAME === tmp5) {
      if (null == value) {
        const obj3 = { closeCode: constants2.CLOSE_UNSUPPORTED };
        const tmp27 = new tmp7(9586)(obj3, "Not connected");
        throw tmp27;
      } else {
        return self.handleFrame(iframeId, value, tmp6);
      }
    } else if (tmp7(9585).CLOSE === tmp5) {
      if (null == value) {
        const obj4 = { closeCode: constants2.CLOSE_UNSUPPORTED };
        const tmp20 = new tmp7(9586)(obj4, "Not connected");
        throw tmp20;
      } else {
      ...
      const obj = { closeCode: constants2.CLOSE_UNSUPPORTED };
      const tmp13 = new tmp7(9586)(obj, "Invalid opcode");
      throw tmp13;
    }
