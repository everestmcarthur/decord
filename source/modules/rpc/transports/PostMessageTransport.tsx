...
import { RPC_EMBEDDED_APP_SCOPE } from "RPC_SCOPE_CONFIG" /* 4465 */;
    ...
    tmp4.handleIFrameMount = function handleIFrameMount(id) {
      ...
      closure_0.handshakeFailureTimeoutId = setTimeout(() => {
        ...
        const item = Array.from(selfEmbeddedActivities.entries()).forEach((arg0) => {
          ...
          obj = { application_id: tmp, channel_id: callback(4189).getEmbeddedActivityLocationChannelId(tmp2.location), guild_id: null, timeout_ms: null };
