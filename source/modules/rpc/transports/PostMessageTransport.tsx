...
// Dependencies: [5, 32, 1957, 4542, 1074, 1091, 9696, 568, 1110, 1241, 4266, 9697, 9699, 1897, 9700, 2]
  ...
  if (Array.isArray(arg2)) {
    ...
    if (RPCOpcodesDefault.HANDSHAKE === tmp5) {
      if (null != value) {
        ...
        const tmp35 = new tmp7(9697)(obj2, "Already connected");
        throw tmp35;
      } else {
        return self.handleHandshake(iframeId, tmp6, arg3);
      }
    } else if (tmp7(9696).FRAME === tmp5) {
      if (null == value) {
        const obj3 = { closeCode: constants2.CLOSE_UNSUPPORTED };
        const tmp27 = new tmp7(9697)(obj3, "Not connected");
        throw tmp27;
      } else {
        return self.handleFrame(iframeId, value, tmp6);
      }
    } else if (tmp7(9696).CLOSE === tmp5) {
      if (null == value) {
        const obj4 = { closeCode: constants2.CLOSE_UNSUPPORTED };
        const tmp20 = new tmp7(9697)(obj4, "Not connected");
        throw tmp20;
      } else {
      ...
      const obj = { closeCode: constants2.CLOSE_UNSUPPORTED };
      const tmp13 = new tmp7(9697)(obj, "Invalid opcode");
      throw tmp13;
    }
