...
export const GUILD_ROLE_CONNECTION_APPLICATION_CONNECTION_TYPE = "application";
export const GUILD_ROLE_CONNECTION_APPLICATION_IDENTITY_CONNECTION_TYPE = "application_identity";
export const MetadataItemTypes = { INTEGER_LESS_THAN_EQUAL: 1, [1]: "INTEGER_LESS_THAN_EQUAL", INTEGER_GREATER_THAN_EQUAL: 2, [2]: "INTEGER_GREATER_THAN_EQUAL", INTEGER_EQUAL: 3, [3]: "INTEGER_EQUAL", INTEGER_NOT_EQUAL: 4, [4]: "INTEGER_NOT_EQUAL", DATETIME_LESS_THAN_EQUAL: 5, [5]: "DATETIME_LESS_THAN_EQUAL", DATETIME_GREATER_THAN_EQUAL: 6, [6]: "DATETIME_GREATER_THAN_EQUAL", BOOLEAN_EQUAL: 7, [7]: "BOOLEAN_EQUAL", BOOLEAN_NOT_EQUAL: 8, [8]: "BOOLEAN_NOT_EQUAL" };
