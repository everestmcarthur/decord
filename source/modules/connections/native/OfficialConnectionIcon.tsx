...
// Dependencies: [19, 17, 1074, 21, 4722, 7382, 7401, 576, 1092, 1177, 11807, 11808, 2]
// Exports: default

// Module 11806 (OfficialConnectionIcon)
...
export default function OfficialConnectionIcon(arg0) {
  ...
  obj5.style = items1;
  const obj6 = { style: null, size: native.Icon.Sizes.CUSTOM, source: _modDef11807, color: roleColor };
  const items2 = [tmp.verifiedCheck, size1];
  obj6.style = items2;
  const items3 = [timestampProducer(native.Icon, obj6), ];
  const obj7 = { style: null, size: native.Icon.Sizes.CUSTOM, source: _modDef11808, color: PRIMARY_630 };
