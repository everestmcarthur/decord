...
// Dependencies: [32, 19, 17, 1385, 502, 2021, 2015, 1074, 21, 4607, 576, 1178, 4542, 504, 1242, 4787, 5572, 4574, 11667, 1896, 11657, 11664, 5335, 1396, 4458, 4603, 1114, 2024, 11663, 7277, 10146, 2]
// Exports: default

// Module 11666 (GuildRoleConnectionsScreen)
...
export default function GuildRoleConnectionsScreen(guildId) {
  ...
  let tmp = closure_16();
  dependencyMap = tmp;
  _slicedToArray = onCloseModal(4542)();
  ...
  if (null == stateFromStores1) {
    ...
    const items5 = [closure_14(tmp4(4603).Text, obj6), ];
    const obj8 = {
          ...
          let obj = {
            ...
            onPress() {
              if (hasItem) {
                ...
                obj4.openLazy(asyncRequireImpl(11667, dependencyMap.paths), "LeaveConnectionRoleActionSheet-" + tmp.id, obj3);
                const tmp20 = asyncRequireImpl(11667, dependencyMap.paths);
              } else {
                let obj = ActionSheetActionCreatorsDefault;
                const tmp9 = asyncRequireImpl(11657, dependencyMap.paths);
