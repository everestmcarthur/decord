...
// Dependencies: [32, 19, 17, 1386, 502, 2022, 2016, 1074, 21, 4638, 576, 1177, 4572, 504, 1241, 4818, 5606, 4605, 11714, 1897, 11704, 11711, 5369, 1397, 4489, 4634, 1115, 2025, 11710, 7313, 10193, 2]
// Exports: default

// Module 11713 (GuildRoleConnectionsScreen)
          ...
          let obj = {
            ...
            onPress() {
              if (hasItem) {
                ...
                obj4.openLazy(asyncRequireImpl(11714, dependencyMap.paths), "LeaveConnectionRoleActionSheet-" + tmp.id, obj3);
