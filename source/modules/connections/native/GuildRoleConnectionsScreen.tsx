...
// Dependencies: [32, 19, 17, 1385, 502, 2021, 2015, 1074, 21, 4606, 576, 1178, 4541, 504, 1242, 4786, 5571, 4573, 11665, 1896, 11655, 11662, 5334, 1396, 4458, 4602, 1114, 2024, 11661, 7276, 10144, 2]
// Exports: default

// Module 11664 (GuildRoleConnectionsScreen)
...
export default function GuildRoleConnectionsScreen(guildId) {
  ...
  let tmp = closure_16();
  dependencyMap = tmp;
  _slicedToArray = onCloseModal(4541)();
  ...
  if (null == stateFromStores1) {
    ...
    const items5 = [closure_14(tmp4(4602).Text, obj6), ];
    const obj8 = {
          ...
          let obj = {
            ...
            onPress() {
              if (hasItem) {
                ...
                obj4.openLazy(asyncRequireImpl(11665, dependencyMap.paths), "LeaveConnectionRoleActionSheet-" + tmp.id, obj3);
                const tmp20 = asyncRequireImpl(11665, dependencyMap.paths);
              } else {
                let obj = ActionSheetActionCreatorsDefault;
                const tmp9 = asyncRequireImpl(11655, dependencyMap.paths);
