...
// Dependencies: [32, 19, 17, 1386, 502, 2022, 2016, 1074, 21, 4639, 576, 1177, 4574, 504, 1241, 4819, 5605, 4606, 11706, 1897, 11696, 11703, 5368, 1397, 4491, 4635, 1115, 2025, 11702, 7310, 10185, 2]
// Exports: default

// Module 11705 (GuildRoleConnectionsScreen)
          ...
          let obj = {
            ...
            onPress() {
              if (hasItem) {
                ...
                obj4.openLazy(asyncRequireImpl(11706, dependencyMap.paths), "LeaveConnectionRoleActionSheet-" + tmp.id, obj3);
