...
// Dependencies: [5, 32, 19, 17, 7217, 2026, 1386, 502, 1958, 5367, 2022, 4276, 5494, 1074, 21, 4638, 576, 4572, 5369, 1397, 4489, 1177, 5113, 4791, 4634, 1115, 5493, 11705, 7275, 9581, 11706, 11707, 12, 4339, 11708, 38, 4336, 11399, 5077, 8728, 5492, 504, 5495, 5606, 1241, 4818, 4605, 7492, 11711, 9395, 573, 4841, 9721, 1897, 9388, 11715, 7260, 11716, 7313, 5060, 2]

// Module 11704 (GuildRoleConnectionsConnectAccountsActionSheet)
...
function ConnectionsChecks(eligibilityStatesGroups) {
  ...
  roleColor = eligibilityStatesGroups(4339).useToken(nativeDefault.unsafe_rawColors.GREEN_330);
  ...
  obj3.children = sorted.map((item) => {
    ...
    const officialApplicationIds = eligibilityStatesGroups(5493).officialApplicationIds;
    let str;
    if (application != null) {
      str = application.id;
    }
    ...
    if (tmp3) {
      const obj3 = { source: tmp5(11706), style: closure_5.connectionsChecksGroupCheckmark };
      ...
      tmp22Result = tmp22(tmp15(4634).Text, obj4);
      tmp24 = tmp22;
    } else if (tmp8) {
      const obj5 = { source: tmp5(11707), style: closure_5.connectionsChecksGroupCaret };
      ...
      tmp22Result = tmp22(tmp15(4634).Text, obj6);
      tmp24 = tmp22;
    }
    let type1;
    if (value != null) {
    ...
    if (hasItem) {
      ...
      let tmp24Result = tmp24(tmp5(11708), obj7);
    } else if (null != tmp11) {
      const obj8 = { style: closure_5.botTag, verified: tmp11.isVerifiedBot() };
      tmp24Result = tmp24(tmp5(9581), obj8);
      const tmp5Result = tmp5(9581);
    }
    ...
    if (!tmp3) {
      ...
      if (tmp20) {
        ...
        obj10.children = tmp24(tmp15(4634).Text, obj11);
    ...
    const items2 = [tmp24(eligibilityStatesGroups(4634).Text, { variant: "text-md/medium", color: "mobile-text-heading-primary", children: name }), tmp24Result, ];
    ...
    if (null != tmp28) {
      const obj16 = {
        onPress() {
            ...
            obj.open({ key: "CONNECTIONS_STEAM_TOOLTIP", icon: _modDef11399, content: stringResult });
          },
        children: null
      };
      const obj17 = { source: tmp5(11399), size: tmp15(1177).Icon.Sizes.SMALL_20, style: tmp38.connectionsChecksGroupTextNameInfoIcon };
...
function ConnectedUserAccountOptions(account) {
  ...
  if (set.has(account.type)) {
    ...
    tmp12 = closure_29(account(8728).FormSwitchRow, obj2);
  }
  let tmp15;
  if (set2.has(account.type)) {
    ...
    tmp15 = closure_29(account(8728).FormSwitchRow, obj3);
  }
  let tmp18;
  if (true === value.hasMetadata) {
    ...
    tmp18 = closure_29(account(8728).FormSwitchRow, obj5);
  }
  ...
  const items = [closure_29(account(8728).FormSwitchRow, obj7), tmp18, tmp15, tmp12];
  obj6.children = items;
          ...
          handlePlatformConnect = function handlePlatformConnect(platformType, role_connections_verification_url) {
            ...
            let obj = {
              ...
              onClose() {
                ...
                let tmp7 = null;
                const guildRoleConnectionsConnectAccountsActionSheetKey = platformType(11711).makeGuildRoleConnectionsConnectAccountsActionSheetKey(role.id);
