...
// Dependencies: [32, 19, 17, 1386, 502, 2022, 2016, 1980, 11963, 5494, 1074, 21, 4638, 576, 1115, 5493, 4588, 4634, 4572, 12, 4339, 5369, 11708, 9581, 1177, 1397, 4489, 38, 7272, 7292, 504, 1241, 4818, 5606, 7260, 7313, 5060, 4605, 11711, 8308, 2]
// Exports: default

// Module 11962 (ConnectionsRoleMessageBadgeActionSheet)
...
import GuildRoleConnectionEligibilityStore from "GuildRoleConnectionEligibilityStore" /* 11963 */;
    ...
    obj1 = {
      children: keys.map((item, index) => {
            ...
            if (officialApplicationIds.includes(str)) {
              ...
              let tmp12 = value2(tmp2(11708), obj2);
            } else if (null != tmp7) {
              const obj3 = { style: closure_1.botTag, verified: false };
              tmp12 = value2(tmp2(9581), obj3);
            }
            ...
            if (null == value) {
              ...
              items1[2] = value2(tmp11(4634).Text, obj7);
              items1[3] = tmp12;
              ...
              obj8.source = tmp11Result.makeSource(tmp11(4489).isThemeDark(dependencyMap) ? icon.darkPNG : icon.lightPNG);
              obj8.size = tmp11(1177).Icon.Sizes.MEDIUM;
              tmp23(tmp11(1177).Icon, obj8);
              const tmp11Result2 = tmp11(4489);
            }
          })
    };
...
const OperatorTypes = fn(5494).OperatorTypes;
