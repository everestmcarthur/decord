...
// Dependencies: [32, 19, 17, 1074, 21, 4605, 576, 1483, 1272, 7175, 4601, 1114, 6655, 9351, 5025, 4808, 5674, 7052, 2]
// Exports: default

// Module 9350 (DomainVerifyModal)
...
import DomainVerifyUtils from "DomainVerifyUtils" /* 9351 */;
...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj2.headerLeft = onClose(5674).getHeaderBackButton(onClose);
    ...
    const obj3 = onClose(5674);
    obj4.headerLeft = onClose(5674).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(5674);
    obj6.headerLeft = onClose(5674).getHeaderBackButton(onClose);
    ...
    return closure_8(onClose(7052).Navigator, obj8);
  }
};
