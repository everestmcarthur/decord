...
// Dependencies: [32, 19, 17, 1074, 21, 4607, 576, 1483, 1272, 7197, 4603, 1114, 6677, 9374, 5027, 4810, 5676, 7074, 2]
// Exports: default

// Module 9373 (DomainVerifyModal)
...
import DomainVerifyUtils from "DomainVerifyUtils" /* 9374 */;
...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj2.headerLeft = onClose(5676).getHeaderBackButton(onClose);
    ...
    const obj3 = onClose(5676);
    obj4.headerLeft = onClose(5676).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(5676);
    obj6.headerLeft = onClose(5676).getHeaderBackButton(onClose);
    ...
    return closure_8(onClose(7074).Navigator, obj8);
  }
};
