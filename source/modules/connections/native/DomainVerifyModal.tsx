...
// Dependencies: [32, 19, 17, 1074, 21, 4574, 576, 1483, 1272, 7137, 4570, 1114, 6619, 9314, 4989, 4777, 5638, 7014, 2]
// Exports: default
...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj2.headerLeft = onClose(5638).getHeaderBackButton(onClose);
    ...
    const obj3 = onClose(5638);
    obj4.headerLeft = onClose(5638).getHeaderBackButton(onClose);
    ...
    obj6.headerLeft = onClose(5638).getHeaderBackButton(onClose);
    ...
    return closure_8(onClose(7014).Navigator, obj8);
  }
};
