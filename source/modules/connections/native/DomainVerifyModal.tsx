...
// Dependencies: [32, 19, 17, 1074, 21, 4606, 576, 1483, 1272, 7196, 4602, 1114, 6676, 9372, 5026, 4809, 5675, 7073, 2]
// Exports: default

// Module 9371 (DomainVerifyModal)
...
import DomainVerifyUtils from "DomainVerifyUtils" /* 9372 */;
...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj2.headerLeft = onClose(5675).getHeaderBackButton(onClose);
    ...
    const obj3 = onClose(5675);
    obj4.headerLeft = onClose(5675).getHeaderBackButton(onClose);
    ...
    obj6.headerLeft = onClose(5675).getHeaderBackButton(onClose);
    ...
    return closure_8(onClose(7073).Navigator, obj8);
  }
};
