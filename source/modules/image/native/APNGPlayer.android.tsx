...
// Function ID: 8950
// Name: APNGPlayer
// Dependencies: [19, 21, 8950, 2]
// Exports: useAPNGPlayerControls

// Module 8949 (APNGPlayer)
...
export const APNGPlayer = noop.forwardRef((onLoad, ref) => {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref, () => ({
    play() {
      if (null != ref.current) {
        const Commands = onLoad(8950).Commands;
    ...
    stop() {
      if (null != ref.current) {
        ...
        const Commands2 = onLoad(8950).Commands;
  ...
  return jsx(ref(8950), { ref, onLoad: callback });
});
