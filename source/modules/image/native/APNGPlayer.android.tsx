...
// Function ID: 8939
// Name: APNGPlayer
// Dependencies: [19, 21, 8939, 2]
// Exports: useAPNGPlayerControls

// Module 8938 (APNGPlayer)
...
export const APNGPlayer = noop.forwardRef((onLoad, ref) => {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref, () => ({
    play() {
      if (null != ref.current) {
        const Commands = onLoad(8939).Commands;
    ...
    stop() {
      if (null != ref.current) {
        ...
        const Commands2 = onLoad(8939).Commands;
  ...
  return jsx(ref(8939), { ref, onLoad: callback });
});
