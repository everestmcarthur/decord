...
// Function ID: 9050
// Name: APNGPlayer
// Dependencies: [19, 21, 9050, 2]
// Exports: useAPNGPlayerControls

// Module 9049 (APNGPlayer)
...
export const APNGPlayer = noop.forwardRef((onLoad, ref) => {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref, () => ({
    play() {
      if (null != ref.current) {
        const Commands = onLoad(9050).Commands;
    ...
    stop() {
      if (null != ref.current) {
        ...
        const Commands2 = onLoad(9050).Commands;
  ...
  return jsx(ref(9050), { ref, onLoad: callback });
});
