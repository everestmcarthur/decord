...
// Function ID: 8880
// Name: APNGPlayer
// Dependencies: [19, 21, 8880, 2]
// Exports: useAPNGPlayerControls

// Module 8879 (APNGPlayer)
...
export const APNGPlayer = noop.forwardRef((onLoad, ref) => {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref, () => ({
    play() {
      if (null != ref.current) {
        const Commands = onLoad(8880).Commands;
    ...
    stop() {
      if (null != ref.current) {
        ...
        const Commands2 = onLoad(8880).Commands;
  ...
  return jsx(ref(8880), { ref, onLoad: callback });
});
