...
// Function ID: 8966
// Name: APNGPlayer
// Dependencies: [19, 21, 8966, 2]
// Exports: useAPNGPlayerControls

// Module 8965 (APNGPlayer)
...
export const APNGPlayer = noop.forwardRef((onLoad, ref) => {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref, () => ({
    play() {
      if (null != ref.current) {
        const Commands = onLoad(8966).Commands;
    ...
    stop() {
      if (null != ref.current) {
        ...
        const Commands2 = onLoad(8966).Commands;
  ...
  return jsx(ref(8966), { ref, onLoad: callback });
});
