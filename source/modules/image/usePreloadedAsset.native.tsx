...
// Dependencies: [32, 19, 4631, 504, 1364, 17107, 5672, 2]
// Exports: default

// Module 17106 (usePreloadedAsset)
  ...
  const effect = obj4.useEffect(() => {
    if (null != c0) {
      if (closure_3) {
        ...
        if (dependencyMap) {
          if (null != num(17107)) {
            let preloadResult = num(17107).preload(tmp);
            const obj2 = num(17107);
          }
          preloadResult.then(() => {
            if (!c0) {
              c0 = true;
        ...
        preloadResult = num(5672).preload(tmp, timeout + 1000);
        let obj = num(5672);
      }
    }
  }, items1);
