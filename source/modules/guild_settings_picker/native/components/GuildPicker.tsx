...
// Function ID: 13950
// Name: GuildPicker
// Dependencies: [19, 21, 13950, 13951, 4574, 9519, 1896, 1114, 2]
// Exports: default

// Module 13949 (GuildPicker)
...
export default function GuildPicker(isGuildIncluded) {
  ...
  ({ options: c2, selectedGuild } = onChange(13950)({ isGuildIncluded: isGuildIncluded.isGuildIncluded, selectedGuildId: guildId }));
  let name;
  const tmp2 = onChange(13950)({ isGuildIncluded: isGuildIncluded.isGuildIncluded, selectedGuildId: guildId });
  const tmp3 = jsx;
  ...
  let obj = {
    ...
    onPress() {
      ...
      obj.openLazy(asyncRequireImpl(9519, dependencyMap.paths), GuildPicker, obj2);
    },
    placeholder: null
  };
  let intl = guildId(1114).intl;
  obj.placeholder = intl.string(guildId(1114).t.etZ9tX);
  return tmp3(onChange(13951), obj);
};
