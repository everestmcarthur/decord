...
// Dependencies: [19, 17, 1954, 21, 4607, 576, 1611, 4574, 7224, 5025, 5744, 4603, 1114, 2168, 5027, 2]
// Exports: default

// Module 7466 (GiftCardMobileConsumptionActionSheet)
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_6(View, { style: tmp.illustration, children: closure_6(markAsDismissed(5744).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
  ...
  items3[1] = closure_6(markAsDismissed(4603).Text, obj5);
  ...
  items3[2] = closure_6(markAsDismissed(5027).Button, obj6);
  obj3.children = items3;
  obj2.children = closure_7(markAsDismissed(5025).Stack, obj3);
  obj.children = closure_6(View, obj2);
  return closure_6(markAsDismissed(7224).BottomSheet, obj);
};
