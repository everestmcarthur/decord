...
// Dependencies: [19, 17, 1954, 21, 4606, 576, 1611, 4573, 7223, 5024, 5743, 4602, 1114, 2168, 5026, 2]
// Exports: default

// Module 7465 (GiftCardMobileConsumptionActionSheet)
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_6(View, { style: tmp.illustration, children: closure_6(markAsDismissed(5743).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
  ...
  items3[1] = closure_6(markAsDismissed(4602).Text, obj5);
  ...
  items3[2] = closure_6(markAsDismissed(5026).Button, obj6);
  obj3.children = items3;
  obj2.children = closure_7(markAsDismissed(5024).Stack, obj3);
