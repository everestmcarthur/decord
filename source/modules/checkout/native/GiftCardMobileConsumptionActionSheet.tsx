...
// Dependencies: [19, 17, 1955, 21, 4638, 576, 1612, 4605, 7260, 5058, 5778, 4634, 1115, 2169, 5060, 2]
// Exports: default

// Module 7502 (GiftCardMobileConsumptionActionSheet)
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_6(View, { style: tmp.illustration, children: closure_6(markAsDismissed(5778).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
  ...
  items3[1] = closure_6(markAsDismissed(4634).Text, obj5);
  ...
  items3[2] = closure_6(markAsDismissed(5060).Button, obj6);
  obj3.children = items3;
  obj2.children = closure_7(markAsDismissed(5058).Stack, obj3);
  obj.children = closure_6(View, obj2);
  return closure_6(markAsDismissed(7260).BottomSheet, obj);
};
