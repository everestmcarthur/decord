...
// Dependencies: [19, 17, 1955, 21, 4640, 576, 1612, 4607, 7264, 5060, 5780, 4636, 1115, 2169, 5062, 2]
// Exports: default

// Module 7506 (GiftCardMobileConsumptionActionSheet)
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_6(View, { style: tmp.illustration, children: closure_6(markAsDismissed(5780).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
  ...
  items3[1] = closure_6(markAsDismissed(4636).Text, obj5);
  ...
  items3[2] = closure_6(markAsDismissed(5062).Button, obj6);
  obj3.children = items3;
  obj2.children = closure_7(markAsDismissed(5060).Stack, obj3);
  obj.children = closure_6(View, obj2);
  return closure_6(markAsDismissed(7264).BottomSheet, obj);
};
