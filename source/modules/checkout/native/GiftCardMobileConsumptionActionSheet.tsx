...
// Dependencies: [19, 17, 1954, 21, 4605, 576, 1611, 4572, 7202, 5023, 5742, 4601, 1114, 2168, 5025, 2]
// Exports: default

// Module 7444 (GiftCardMobileConsumptionActionSheet)
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_6(View, { style: tmp.illustration, children: closure_6(markAsDismissed(5742).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
  ...
  items3[1] = closure_6(markAsDismissed(4601).Text, obj5);
  ...
  items3[2] = closure_6(markAsDismissed(5025).Button, obj6);
  obj3.children = items3;
  obj2.children = closure_7(markAsDismissed(5023).Stack, obj3);
