...
// Dependencies: [19, 17, 21, 4607, 576, 6693, 1114, 4451, 7125, 1178, 4603, 6688, 2]
// Exports: default

// Module 10948 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4603).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4603).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6688).CircleXIcon, { size: "xs" });
