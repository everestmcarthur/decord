...
// Dependencies: [19, 17, 21, 4606, 576, 6692, 1114, 4451, 7124, 1178, 4602, 6687, 2]
// Exports: default

// Module 10946 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4602).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4602).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6687).CircleXIcon, { size: "xs" });
