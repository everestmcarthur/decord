...
// Dependencies: [19, 17, 21, 4640, 576, 6732, 1115, 4484, 7165, 1177, 4636, 6727, 2]
// Exports: default

// Module 11011 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4636).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4636).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6727).CircleXIcon, { size: "xs" });
