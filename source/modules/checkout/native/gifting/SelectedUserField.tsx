...
// Dependencies: [19, 17, 21, 4639, 576, 6726, 1115, 4484, 7158, 1177, 4635, 6721, 2]
// Exports: default

// Module 10990 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4635).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4635).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6721).CircleXIcon, { size: "xs" });
