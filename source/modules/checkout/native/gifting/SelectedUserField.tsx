...
// Dependencies: [19, 17, 21, 4638, 576, 6729, 1115, 4482, 7161, 1177, 4634, 6724, 2]
// Exports: default

// Module 11003 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4634).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4634).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6724).CircleXIcon, { size: "xs" });
