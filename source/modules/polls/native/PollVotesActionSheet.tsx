...
// Dependencies: [32, 5, 19, 17, 4631, 5544, 1958, 4860, 1372, 21, 4639, 576, 504, 1397, 7237, 1115, 5207, 4635, 7866, 6760, 11851, 7269, 11857, 11394, 7868, 4791, 4484, 5690, 1177, 9935, 8299, 4376, 4640, 9006, 4574, 4491, 11858, 11859, 7289, 4606, 7257, 2]
// Exports: default
...
function NoResults() {
  ...
  if (obj3.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(11858);
  } else {
    tmp2Result = tmp2(11859);
  }
...
let closure_18 = noop.forwardRef((answer, ref) => {
  ...
  if (null != answer.poll_media.text) {
    ...
    tmp11 = closure_1_14(tmp3(4635).Text, obj4);
  }
  items2[1] = tmp11;
