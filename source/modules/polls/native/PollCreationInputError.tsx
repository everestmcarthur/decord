...
// Dependencies: [19, 17, 21, 4722, 576, 4433, 1177, 4718, 2]
// Exports: default

// Module 12472 (PollCreationInputError)
...
export default function PollCreationInputError(message) {
  ...
  const items1 = [closure_4(message(1177).WarningCircle, size), closure_4(message(4718).Text, { variant: "text-xs/medium", color: "text-feedback-critical", children: message })];
  obj.children = items1;
