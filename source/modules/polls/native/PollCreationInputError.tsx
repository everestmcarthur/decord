...
// Dependencies: [19, 17, 21, 4640, 576, 4351, 1177, 4636, 2]
// Exports: default

// Module 12381 (PollCreationInputError)
...
export default function PollCreationInputError(message) {
  ...
  const items1 = [closure_4(message(1177).WarningCircle, size), closure_4(message(4636).Text, { variant: "text-xs/medium", color: "text-feedback-critical", children: message })];
  obj.children = items1;
