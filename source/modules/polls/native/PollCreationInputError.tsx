...
// Dependencies: [19, 17, 21, 4638, 576, 4349, 1177, 4634, 2]
// Exports: default

// Module 12372 (PollCreationInputError)
...
export default function PollCreationInputError(message) {
  ...
  const items1 = [closure_4(message(1177).WarningCircle, size), closure_4(message(4634).Text, { variant: "text-xs/medium", color: "text-feedback-critical", children: message })];
  obj.children = items1;
