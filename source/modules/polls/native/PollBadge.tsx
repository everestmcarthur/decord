...
// Function ID: 16920
// Name: PollBadge
// Dependencies: [19, 17, 21, 4640, 576, 1177, 16920, 4636, 1115, 2]
// Exports: default

// Module 16919 (PollBadge)
...
export default function PollBadge(style) {
  ...
  obj.style = items;
  const items1 = [React4(native.Icon, { size: native.IconSizes.EXTRA_SMALL_10, source: _modDef16920 }), ];
