...
// Function ID: 16824
// Name: PollBadge
// Dependencies: [19, 17, 21, 4639, 576, 1177, 16824, 4635, 1115, 2]
// Exports: default

// Module 16823 (PollBadge)
...
export default function PollBadge(style) {
  ...
  obj.style = items;
  const items1 = [React4(native.Icon, { size: native.IconSizes.EXTRA_SMALL_10, source: _modDef16824 }), ];
