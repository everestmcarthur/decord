...
// Function ID: 16881
// Name: PollBadge
// Dependencies: [19, 17, 21, 4638, 576, 1177, 16881, 4634, 1115, 2]
// Exports: default

// Module 16880 (PollBadge)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 1177 */;
import Text_Text from "Text/Text" /* 4634 */;
import _modDef16881 from "module_16881" /* 16881 */;
...
export default function PollBadge(style) {
  ...
  obj.style = items;
  const items1 = [React4(native.Icon, { size: native.IconSizes.EXTRA_SMALL_10, source: _modDef16881 }), ];
