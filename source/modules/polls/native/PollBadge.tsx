...
// Function ID: 17060
// Name: PollBadge
// Dependencies: [19, 17, 21, 4722, 576, 1177, 17060, 4718, 1115, 2]
// Exports: default

// Module 17059 (PollBadge)
...
export default function PollBadge(style) {
  ...
  obj.style = items;
  const items1 = [React4(native.Icon, { size: native.IconSizes.EXTRA_SMALL_10, source: _modDef17060 }), ];
