...
// Dependencies: [19, 17, 7902, 21, 4607, 576, 12321, 4472, 4574, 7271, 4603, 1178, 7273, 1114, 12323, 2]
// Exports: default

// Module 12322 (ImageInputActionSheet)
...
let closure_5 = fn(7902).POLL_CREATION_IMAGE_INPUT_ACTION_SHEET_KEY;
const jsxProd = fn(21);
