...
// Dependencies: [19, 17, 7934, 21, 4639, 576, 12360, 4505, 4606, 7304, 4635, 1177, 7306, 1115, 12362, 2]
// Exports: default

// Module 12361 (ImageInputActionSheet)
...
let closure_5 = fn(7934).POLL_CREATION_IMAGE_INPUT_ACTION_SHEET_KEY;
const jsxProd = fn(21);
