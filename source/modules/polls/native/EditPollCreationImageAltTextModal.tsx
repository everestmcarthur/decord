...
// Dependencies: [32, 19, 17, 7949, 21, 4640, 576, 12377, 12379, 7237, 1115, 1177, 7106, 4636, 5666, 9967, 8748, 2]
// Exports: default

// Module 12380 (EditPollCreationImageAltTextModal)
...
const MAX_POLL_ANSWER_LENGTH = fn(7949).MAX_POLL_ANSWER_LENGTH;
const jsxProd = fn(21);
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = value(12377)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  const obj4 = { onPress: onSave(12379).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
  const intl = onSave(1115).intl;
  obj4.accessibilityLabel = intl.string(onSave(1115).t.cpT0Cq);
  obj4.children = closure_8(onSave(1177).Icon, { source: value(7106) });
  ...
  items1[1] = closure_8(onSave(4636).Text, obj6);
  ...
  obj7.children = closure_8(onSave(4636).Text, obj8);
  ...
  items4[2] = closure_8(onSave(8748).FormInput, obj14);
  ...
  return closure_9(onSave(7237).SafeAreaPaddingView, obj2);
};
