...
// Dependencies: [32, 19, 17, 7934, 21, 4639, 576, 12360, 12362, 7230, 1115, 1177, 7099, 4635, 5663, 9948, 8719, 2]
// Exports: default

// Module 12363 (EditPollCreationImageAltTextModal)
import nativeDefault from "native" /* 576 */;
import EditPollCreationImageAltTextModalActionCreators from "EditPollCreationImageAltTextModalActionCreators" /* 12362 */;
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const obj4 = { onPress: onSave(12362).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
