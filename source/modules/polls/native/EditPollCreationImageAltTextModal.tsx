...
// Dependencies: [32, 19, 17, 7843, 21, 4574, 576, 12256, 12258, 7137, 1114, 1178, 7006, 4570, 5592, 9848, 8626, 2]
// Exports: default

// Module 12259 (EditPollCreationImageAltTextModal)
import nativeDefault from "native" /* 576 */;
import EditPollCreationImageAltTextModalActionCreators from "EditPollCreationImageAltTextModalActionCreators" /* 12258 */;
...
const MAX_POLL_ANSWER_LENGTH = fn(7843).MAX_POLL_ANSWER_LENGTH;
const jsxProd = fn(21);
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = value(12256)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  const obj4 = { onPress: onSave(12258).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
  const intl = onSave(1114).intl;
  obj4.accessibilityLabel = intl.string(onSave(1114).t.cpT0Cq);
  obj4.children = closure_8(onSave(1178).Icon, { source: value(7006) });
  ...
  items1[1] = closure_8(onSave(4570).Text, obj6);
  ...
  obj7.children = closure_8(onSave(4570).Text, obj8);
  ...
  items4[2] = closure_8(onSave(8626).FormInput, obj14);
  ...
  return closure_9(onSave(7137).SafeAreaPaddingView, obj2);
};
