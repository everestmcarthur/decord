...
// Dependencies: [32, 19, 17, 7902, 21, 4607, 576, 12321, 12323, 7197, 1114, 1178, 7066, 4603, 5630, 9909, 8686, 2]
// Exports: default

// Module 12324 (EditPollCreationImageAltTextModal)
import nativeDefault from "native" /* 576 */;
import EditPollCreationImageAltTextModalActionCreators from "EditPollCreationImageAltTextModalActionCreators" /* 12323 */;
...
const MAX_POLL_ANSWER_LENGTH = fn(7902).MAX_POLL_ANSWER_LENGTH;
const jsxProd = fn(21);
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = value(12321)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  const obj4 = { onPress: onSave(12323).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
  const intl = onSave(1114).intl;
  obj4.accessibilityLabel = intl.string(onSave(1114).t.cpT0Cq);
  obj4.children = closure_8(onSave(1178).Icon, { source: value(7066) });
  ...
  items1[1] = closure_8(onSave(4603).Text, obj6);
  ...
  obj7.children = closure_8(onSave(4603).Text, obj8);
  ...
  items4[2] = closure_8(onSave(8686).FormInput, obj14);
  ...
  return closure_9(onSave(7197).SafeAreaPaddingView, obj2);
};
