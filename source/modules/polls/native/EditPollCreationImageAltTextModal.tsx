...
// Dependencies: [32, 19, 17, 7880, 21, 4605, 576, 12296, 12298, 7175, 1114, 1178, 7044, 4601, 5628, 9886, 8663, 2]
// Exports: default

// Module 12299 (EditPollCreationImageAltTextModal)
import nativeDefault from "native" /* 576 */;
import EditPollCreationImageAltTextModalActionCreators from "EditPollCreationImageAltTextModalActionCreators" /* 12298 */;
...
const MAX_POLL_ANSWER_LENGTH = fn(7880).MAX_POLL_ANSWER_LENGTH;
const jsxProd = fn(21);
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = value(12296)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  const obj4 = { onPress: onSave(12298).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
  const intl = onSave(1114).intl;
  obj4.accessibilityLabel = intl.string(onSave(1114).t.cpT0Cq);
  obj4.children = closure_8(onSave(1178).Icon, { source: value(7044) });
  ...
  items1[1] = closure_8(onSave(4601).Text, obj6);
  ...
  obj7.children = closure_8(onSave(4601).Text, obj8);
  ...
  items4[2] = closure_8(onSave(8663).FormInput, obj14);
  ...
  return closure_9(onSave(7175).SafeAreaPaddingView, obj2);
};
