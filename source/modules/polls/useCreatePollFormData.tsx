...
// Dependencies: [5, 32, 19, 7829, 7761, 12207, 11719, 12208, 12209, 12210, 1114, 11725, 2]
// Exports: default

// Module 12206 (createPollCreationImageForMedia)
import getPollVoteEventPropertiesDefault from "getPollVoteEventProperties" /* 11719 */;
...
function createPollCreationImageForMedia(mediaURL, status) {
  ...
  return { mediaAttachmentState, emoji: "Array", stickerId: "options" };
}
        ...
        try {
          ...
          if (0 === table) {
            if (arg0 === 1) {
              ...
              closure_1_19(first3(callback2, callback(12210).PollMediaUploadAttachmentStatus.PREPARING), closure_1);
              table = 1;
              c6 = 1;
              obj1 = { value: null, done: false };
              obj1[0] = callback2(12208).handlePollGifAttachmentAdd(callback, table[closure_1].localCreationAnswerId, callback2);
              return obj1;
            }
          } else if (arg0 === 1) {
            c6 = 3;
            ...
            if (null != arg1) {
              closure_1_19(first3(closure_1, callback(12210).PollMediaUploadAttachmentStatus.READY_TO_UPLOAD), callback);
            } else {
              closure_1_19(first3(closure_1, callback(12210).PollMediaUploadAttachmentStatus.ERROR), callback);
            }
            c6 = 3;
          }
        } catch (tmp25) {
