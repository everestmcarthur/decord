...
// Dependencies: [5, 4948, 7902, 12300, 8291, 5190, 5180, 9399, 2]
...
// Module 12299 (PollUploadAttachmentActionCreators)
...
const POLL_ATTACHMENT_FOLDER = fn(7902).POLL_ATTACHMENT_FOLDER;
let size = fn(2);
