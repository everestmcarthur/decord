...
// Dependencies: [32, 19, 17, 1074, 21, 4606, 12, 8333, 8334, 4456, 576, 8335, 1178, 5038, 2]
// Exports: useDominantColorFromImage

// Module 8332 (VideoBackground)
import native from "native" /* 1178 */;
import VideoBackgroundManagerDefault from "VideoBackgroundManager" /* 8334 */;
import useProfileTileGradientDefault from "useProfileTileGradient" /* 8335 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import apply from "module_12" /* 12 */;

const LinearGradientDefault = tmp6(5038);
require = fn;
function useDominantRGBFromImage(arg0, arg1) {
  ...
  const tmp5 = first(8333)();
  dependencyMap = tmp5;
  let hexToRgbResult;
  if (null != arg0) {
    hexToRgbResult = tmp3(8334).cachedDominantColors[arg0];
  }
      ...
      if (null == VideoBackgroundManagerDefault.cachedDominantColors[closure_0]) {
        ...
        dominantColorsLocalAsset.then((result) => {
          if (dependencyMap()) {
            ...
            closure_1_3(obj);
            first(8334).cachedDominantColors[closure_1_0] = obj;
        ...
        closure_3(tmp4(8334).cachedDominantColors[tmp6]);
      }
      tmp4 = importDefault;
    }
  }, items);
