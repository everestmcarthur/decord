...
// Dependencies: [32, 19, 17, 1074, 21, 4574, 12, 8275, 8276, 4423, 576, 8277, 1178, 5001, 2]
// Exports: useDominantColorFromImage

// Module 8274 (VideoBackground)
import native from "native" /* 1178 */;
import VideoBackgroundManagerDefault from "VideoBackgroundManager" /* 8276 */;
import useProfileTileGradientDefault from "useProfileTileGradient" /* 8277 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import apply from "module_12" /* 12 */;

const LinearGradientDefault = tmp6(5001);
require = fn;
  ...
  const effect = noop.useEffect(() => {
    ...
    if (tmp2) {
      if (null == VideoBackgroundManagerDefault.cachedDominantColors[closure_0]) {
        ...
        closure_3(tmp4(8276).cachedDominantColors[tmp6]);
      }
      tmp4 = importDefault;
    }
  }, items);
