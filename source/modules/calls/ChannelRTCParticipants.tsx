...
// Dependencies: [1957, 4662, 502, 5366, 1958, 1909, 5507, 1372, 9631, 4659, 4661, 1074, 4665, 5516, 4274, 9632, 12, 9633, 9634, 4792, 8364, 4692, 2]
...
prototype["_getParticipantsForUser"] = function _getParticipantsForUser(userId) {
  ...
  if (null == user) {
    ...
    if (tmp3) {
      ...
      obj.userAvatarDecoration = tmp8(8364).getAvatarDecoration(user, guildId);
