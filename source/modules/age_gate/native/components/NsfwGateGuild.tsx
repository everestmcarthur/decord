...
// Function ID: 10435
// Name: NsfwGateGuild
// Dependencies: [19, 17, 2022, 1372, 10435, 1074, 21, 4638, 576, 1115, 2025, 1241, 9439, 7083, 10436, 4634, 5060, 2]
// Exports: default

// Module 10434 (NsfwGateGuild)
...
const NsfwGateSource = fn(10435).NsfwGateSource;
...
export default function NsfwGateGuild(guildId) {
  ...
  const items1 = [closure_11(currentUser(7083), {}), , , , , ];
  const formatResult = intl3.format(guildId(1115).t.Z12LNW, obj);
  items1[1] = closure_11(closure_5, { source: currentUser(10436), style: tmp.image });
  items1[2] = closure_11(guildId(4634).Text, { style: tmp.header, variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: stringResult });
  items1[3] = closure_11(guildId(4634).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: stringResult1 });
  items1[4] = closure_11(guildId(4634).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: formatResult });
  ...
  items1[5] = closure_11(guildId(5060).Button, obj8);
