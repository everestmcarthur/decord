...
// Dependencies: [5, 32, 19, 17, 1951, 1371, 1098, 17340, 1074, 21, 4574, 1483, 504, 1242, 1114, 2024, 38, 15993, 4777, 4166, 16016, 7137, 4570, 17343, 4989, 2]
// Exports: default

// Module 17342 (ExistingUserAgeGate)
...
let closure_11 = fn(17340).ExistingUserAgeGateScreens;
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const diffResult = v1(4166)().diff(date, "years");
            if (diffResult < 18) {
              const obj4 = {
                source,
                onConfirm() {
