...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4607, 1483, 7197, 4603, 1114, 2024, 5027, 2]
// Exports: default

// Module 17393 (ExistingUserAgeGateConfirm)
...
export default function ExistingUserAgeGateConfirm(age) {
  ...
  const items = [closure_8(onConfirm(4603).Text, obj3), , ];
  ...
  items[1] = closure_8(onConfirm(4603).Text, obj4);
  ...
  obj7.children = closure_8(onConfirm(5027).Button, obj8);
  items[2] = closure_8(View, obj7);
  obj2.children = items;
  return closure_9(onConfirm(7197).SafeAreaPaddingView, obj2);
};
