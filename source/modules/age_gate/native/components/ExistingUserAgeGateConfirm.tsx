...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4605, 1483, 7175, 4601, 1114, 2024, 5025, 2]
// Exports: default

// Module 17403 (ExistingUserAgeGateConfirm)
...
export default function ExistingUserAgeGateConfirm(age) {
  ...
  const items = [closure_8(onConfirm(4601).Text, obj3), , ];
  ...
  items[1] = closure_8(onConfirm(4601).Text, obj4);
  ...
  obj7.children = closure_8(onConfirm(5025).Button, obj8);
  items[2] = closure_8(View, obj7);
  obj2.children = items;
  return closure_9(onConfirm(7175).SafeAreaPaddingView, obj2);
};
