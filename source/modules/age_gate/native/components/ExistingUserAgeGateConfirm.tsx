...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4606, 1483, 7196, 4602, 1114, 2024, 5026, 2]
// Exports: default

// Module 17392 (ExistingUserAgeGateConfirm)
...
export default function ExistingUserAgeGateConfirm(age) {
  ...
  const items = [closure_8(onConfirm(4602).Text, obj3), , ];
  ...
  items[1] = closure_8(onConfirm(4602).Text, obj4);
  ...
  obj7.children = closure_8(onConfirm(5026).Button, obj8);
  items[2] = closure_8(View, obj7);
  obj2.children = items;
  return closure_9(onConfirm(7196).SafeAreaPaddingView, obj2);
};
