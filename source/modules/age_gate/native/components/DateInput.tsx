...
// Function ID: 17518
// Name: DateInput
// Dependencies: [19, 17, 21, 4229, 4605, 9857, 1897, 6713, 1177, 2]

// Module 17517 (DateInput)
...
export default noop.forwardRef((date, ref) => {
  ...
  function openDatePicker() {
    ...
    obj.openLazy(asyncRequireImpl(9857, dependencyMap.paths), "DatePicker", obj2);
  }
  ({ style, error } = date);
  ref = ref.useRef(null);
  ...
  let obj = require("module_4229")();
  let result = obj.set("year", obj.year() - 10);
  const tmp4 = label;
  const tmp5 = require("module_4229");
  const formatResult1 = require("module_4229")(obj.toDate()).format("L");
  ...
  const tmp5Result = require("module_4229")(obj.toDate());
