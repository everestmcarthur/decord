...
// Dependencies: [1980, 4361, 1372, 1074, 1364, 4925, 10536, 1897, 9534, 2]
...
const AgeRestrictedContentSettingsUtils = tmp(9534);
require = fn;
...
export const handleNSFWGuildInvite = function handleNSFWGuildInvite(invite) {
  if (obj.isIOS()) {
    ...
    if (!tmp10) {
      ...
      obj2.pushLazy(asyncRequireImpl(10536, tmp2.paths), obj3);
      flag2 = true;
      const tmp12 = asyncRequireImpl(10536, tmp2.paths);
    }
    return flag2;
  } else {
    return false;
