...
// Dependencies: [1979, 4245, 1371, 1074, 1115, 4809, 10384, 1896, 9386, 2]
// Exports: handleNSFWGuildInvite, isNSFWInvite, shouldNSFWGateGuild

// Module 10383 (age_gate/AgeGateUtils)
...
const AgeRestrictedContentSettingsUtils = tmp(9386);
require = fn;
...
export const handleNSFWGuildInvite = function handleNSFWGuildInvite(invite) {
  if (obj.isIOS()) {
    ...
    if (!tmp10) {
      ...
      obj2.pushLazy(asyncRequireImpl(10384, tmp2.paths), obj3);
      flag2 = true;
      const tmp12 = asyncRequireImpl(10384, tmp2.paths);
    }
    return flag2;
  } else {
    return false;
