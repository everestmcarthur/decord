...
// Dependencies: [5, 1371, 8498, 8500, 4816, 8485, 21, 5190, 4809, 8501, 1896, 8490, 8510, 8511, 1608, 4952, 8512, 1379, 1115, 8513, 8514, 4819, 5474, 573, 8515, 8521, 8528, 8664, 8665, 4301, 8499, 8676, 8677, 2]

// Module 8497 (AgeVerificationActionCreators)
...
import ManualReviewDecidedTeenAlertModalDefault from "ManualReviewDecidedTeenAlertModal" /* 8676 */;
import ManualReviewFallbackAlertModalDefault from "ManualReviewFallbackAlertModal" /* 8677 */;
    ...
    (async (arg0, value) => {
      ...
      if (1 === tmp7) {
        ...
        if (arg0 === 1) {
          ...
          c4 = 1;
          return {
            value: tmp3(4809).pushLazy(v3(async () => {
...
export default {
  ...
  showAgeVerificationGetStartedModal(entryPoint) {
    ...
    UserStore = undefined;
    if (obj.isMetaQuest()) {
      tmp(4952).openAlert(closure_7, jsx(onClose(8512), {}), onClose);
      const tmpResult = tmp(4952);
    } else {
      let isAgeVerifiedResult = tmp(4819).isAgeVerified();
      if (isAgeVerifiedResult) {
        isAgeVerifiedResult = tmp(5474).hasAgeGatedFeatures();
        const tmpResult7 = tmp(5474);
      }
      dependencyMap = isAgeVerifiedResult;
      const tmpResult6 = tmp(4819);
      if (tmpResult8.isAgeVerificationIncodeEnabled(entryPoint)) {
        ...
        if (tmpResult9.isExpressiveModalV2Enabled(entryPoint)) {
              ...
              try {
                ...
                if (0 === dependencyMap) {
                  if (arg0 === 1) {
                    ...
                    dependencyMap = 1;
                    v3 = 1;
                    const obj5 = { value: entryPoint(8521).shouldShowManualReviewFallback(entryPoint), done: false };
                    return obj5;
                  }
                } else if (arg0 === 1) {
                  v3 = 3;
                  ...
                  if (value) {
                    ...
                    onClose(4809).pushLazy(v3(function*() {
          ...
          const tmpResult10 = tmp(8664);
          onClose(4809).pushLazy(prop(function*() {
