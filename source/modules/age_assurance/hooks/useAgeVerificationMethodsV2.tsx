...
// Dependencies: [5, 32, 19, 8541, 8506, 8525, 573, 2]
// Exports: useAgeVerificationMethodsV2

// Module 8540 (useAgeVerificationMethodsV2)
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            v0(false);
            v0 = 2;
            const result = closure_0(8506).isCurrentUserSuspended();
            const obj7 = closure_0(8525);
            if (result) {
              c5 = 4;
              c6 = 1;
