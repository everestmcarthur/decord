...
// Dependencies: [5, 32, 19, 8518, 8483, 8502, 573, 2]
// Exports: useAgeVerificationMethodsV2

// Module 8517 (useAgeVerificationMethodsV2)
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            v0(false);
            v0 = 2;
            const result = closure_0(8483).isCurrentUserSuspended();
