...
// Dependencies: [1957, 4827, 2011, 1371, 1074, 8485, 3, 1095, 7529, 7377, 7191, 1894, 5474, 5475, 8678, 5323, 2]

// Module 17394 (AgeVerificationManager)
      ...
      if (isFeatureAgeGatedResult) {
        ...
        if (tmp20) {
          (function handleLoadChannelMessages(channelId) {
            const messages = _true(7529).fetchMessages({ channelId, limit });
          })(tmp16);
