...
// Dependencies: [5, 32, 19, 1182, 8542, 8544, 21, 4638, 8547, 8551, 8552, 5058, 5663, 5778, 4634, 1115, 2947, 5773, 5691, 2]
// Exports: default

// Module 8546 (AgeVerificationIncodeMethodSelectScreen)
...
let closure_8 = fn(8544).buildIncodeParamsInjection;
const jsxProd = fn(21);
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: tmp6(tmp7(5663).ActivityIndicator, { size: "large" }) };
    obj2.children = tmp6(tmp7(5058).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(5778).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    obj7.children = intl.string(trustedOrigin(2947).eZvwAe);
    const items2 = [tmp6(tmp7(4634).Text, obj7), ];
    const obj8 = { variant: "text-md/medium", color: "text-strong", style: tmp5.header, children: null };
    const intl2 = tmp7(1115).intl;
    obj8.children = intl2.string(trustedOrigin(2947)["5yWXmT"]);
    items2[1] = tmp6(tmp7(4634).Text, obj8);
    obj6.children = items2;
    items1[1] = closure_10(tmp7(5058).Stack, obj6);
    obj5.children = items1;
    const items3 = [closure_10(tmp7(5058).Stack, obj5), , ];
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp7(4634).Text, obj9);
    }
    items3[1] = tmp6Result;
    const obj10 = { hasIcons: false, children: null };
    const obj11 = { arrow: true, label: null, subLabel: null, onPress: null };
    const intl4 = tmp7(1115).intl;
    obj11.label = intl4.string(trustedOrigin(2947).rgXXcW);
    const intl5 = tmp7(1115).intl;
    obj11.subLabel = intl5.string(trustedOrigin(2947).fm7qBC);
    obj11.onPress = function onPress() {
      closure_4(VerificationMethod.FACIAL_AGE_ESTIMATION);
    };
    const items4 = [tmp6(tmp7(5691).TableRow, obj11), ];
    const obj12 = { arrow: true, label: null, subLabel: null, onPress: null };
    const intl6 = tmp7(1115).intl;
    obj12.label = intl6.string(trustedOrigin(2947)["NeVlw/"]);
    const intl7 = tmp7(1115).intl;
    obj12.subLabel = intl7.string(trustedOrigin(2947).ARmJ0M);
    obj12.onPress = function onPress() {
      closure_4(VerificationMethod.ID_VERIFICATION);
    };
    items4[1] = tmp6(tmp7(5691).TableRow, obj12);
    obj10.children = items4;
    items3[2] = closure_10(tmp7(5773).TableRowGroup, obj10);
    obj4.children = items3;
    obj2.children = closure_10(tmp7(5058).Stack, obj4);
    obj.children = tmp6(ModalContent, obj2);
    tmp11 = obj;
  }
