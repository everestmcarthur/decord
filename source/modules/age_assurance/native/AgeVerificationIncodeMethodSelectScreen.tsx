...
// Dependencies: [5, 32, 19, 1182, 8533, 8535, 21, 4639, 8538, 8542, 8543, 5057, 5662, 5777, 4635, 1115, 2947, 5772, 5690, 2]
// Exports: default

// Module 8537 (AgeVerificationIncodeMethodSelectScreen)
...
let closure_8 = fn(8535).buildIncodeParamsInjection;
const jsxProd = fn(21);
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: tmp6(tmp7(5662).ActivityIndicator, { size: "large" }) };
    obj2.children = tmp6(tmp7(5057).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(5777).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    const items2 = [tmp6(tmp7(4635).Text, obj7), ];
    ...
    items2[1] = tmp6(tmp7(4635).Text, obj8);
    obj6.children = items2;
    items1[1] = closure_10(tmp7(5057).Stack, obj6);
    obj5.children = items1;
    const items3 = [closure_10(tmp7(5057).Stack, obj5), , ];
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp7(4635).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [tmp6(tmp7(5690).TableRow, obj11), ];
    ...
    items4[1] = tmp6(tmp7(5690).TableRow, obj12);
    obj10.children = items4;
    items3[2] = closure_10(tmp7(5772).TableRowGroup, obj10);
    obj4.children = items3;
    obj2.children = closure_10(tmp7(5057).Stack, obj4);
    obj.children = tmp6(ModalContent, obj2);
    tmp11 = obj;
  }
