...
// Dependencies: [5, 32, 19, 1182, 8644, 8647, 21, 4722, 8650, 8654, 8655, 5142, 5747, 5862, 4718, 1115, 3032, 5857, 5775, 2]
// Exports: default

// Module 8649 (AgeVerificationIncodeMethodSelectScreen)
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: tmp6(tmp7(5747).ActivityIndicator, { size: "large" }) };
    obj2.children = tmp6(tmp7(5142).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(5862).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    const items2 = [tmp6(tmp7(4718).Text, obj7), ];
    ...
    items2[1] = tmp6(tmp7(4718).Text, obj8);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp7(4718).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [tmp6(tmp7(5775).TableRow, obj11), ];
    ...
    items4[1] = tmp6(tmp7(5775).TableRow, obj12);
