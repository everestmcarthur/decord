...
// Dependencies: [5, 32, 19, 1182, 8561, 8564, 21, 4640, 8567, 8571, 8572, 5060, 5665, 5780, 4636, 1115, 2949, 5775, 5693, 2]
// Exports: default

// Module 8566 (AgeVerificationIncodeMethodSelectScreen)
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: tmp6(tmp7(5665).ActivityIndicator, { size: "large" }) };
    obj2.children = tmp6(tmp7(5060).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(5780).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    const items2 = [tmp6(tmp7(4636).Text, obj7), ];
    ...
    items2[1] = tmp6(tmp7(4636).Text, obj8);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp7(4636).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [tmp6(tmp7(5693).TableRow, obj11), ];
    ...
    items4[1] = tmp6(tmp7(5693).TableRow, obj12);
