...
// Dependencies: [5, 32, 19, 1183, 8498, 8500, 21, 4606, 8503, 8507, 8508, 5024, 5628, 5743, 4602, 1114, 2946, 5738, 5656, 2]
// Exports: default

// Module 8502 (AgeVerificationIncodeMethodSelectScreen)
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: tmp6(tmp7(5628).ActivityIndicator, { size: "large" }) };
    obj2.children = tmp6(tmp7(5024).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(5743).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    const items2 = [tmp6(tmp7(4602).Text, obj7), ];
    ...
    items2[1] = tmp6(tmp7(4602).Text, obj8);
    obj6.children = items2;
    items1[1] = closure_10(tmp7(5024).Stack, obj6);
    obj5.children = items1;
    const items3 = [closure_10(tmp7(5024).Stack, obj5), , ];
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp7(4602).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [tmp6(tmp7(5656).TableRow, obj11), ];
    ...
    items4[1] = tmp6(tmp7(5656).TableRow, obj12);
    obj10.children = items4;
    items3[2] = closure_10(tmp7(5738).TableRowGroup, obj10);
    obj4.children = items3;
    obj2.children = closure_10(tmp7(5024).Stack, obj4);
    obj.children = tmp6(ModalContent, obj2);
    tmp11 = obj;
  }
