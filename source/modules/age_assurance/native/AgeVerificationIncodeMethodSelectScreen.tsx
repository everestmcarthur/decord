...
// Dependencies: [5, 32, 19, 1183, 8500, 8502, 21, 4607, 8505, 8509, 8510, 5025, 5629, 5744, 4603, 1114, 2946, 5739, 5657, 2]
// Exports: default

// Module 8504 (AgeVerificationIncodeMethodSelectScreen)
...
const require = fn;
const VerificationMethod = fn(8500).VerificationMethod;
let closure_8 = fn(8502).buildIncodeParamsInjection;
const jsxProd = fn(21);
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: tmp6(tmp7(5629).ActivityIndicator, { size: "large" }) };
    obj2.children = tmp6(tmp7(5025).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(5744).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    obj7.children = intl.string(trustedOrigin(2946).eZvwAe);
    const items2 = [tmp6(tmp7(4603).Text, obj7), ];
    const obj8 = { variant: "text-md/medium", color: "text-strong", style: tmp5.header, children: null };
    const intl2 = tmp7(1114).intl;
    obj8.children = intl2.string(trustedOrigin(2946)["5yWXmT"]);
    items2[1] = tmp6(tmp7(4603).Text, obj8);
    obj6.children = items2;
    items1[1] = closure_10(tmp7(5025).Stack, obj6);
    obj5.children = items1;
    const items3 = [closure_10(tmp7(5025).Stack, obj5), , ];
    if (tmp6Result) {
      const obj9 = { variant: "text-sm/medium", color: "text-feedback-critical", style: tmp5.header, children: null };
      const intl3 = tmp7(1114).intl;
      obj9.children = intl3.string(tmp7(1114).t.c6kn6F);
      tmp6Result = tmp6(tmp7(4603).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    obj11.label = intl4.string(trustedOrigin(2946).rgXXcW);
    const intl5 = tmp7(1114).intl;
    obj11.subLabel = intl5.string(trustedOrigin(2946).fm7qBC);
    obj11.onPress = function onPress() {
      closure_4(VerificationMethod.FACIAL_AGE_ESTIMATION);
    };
    const items4 = [tmp6(tmp7(5657).TableRow, obj11), ];
    const obj12 = { arrow: true, label: null, subLabel: null, onPress: null };
    const intl6 = tmp7(1114).intl;
    obj12.label = intl6.string(trustedOrigin(2946)["NeVlw/"]);
    const intl7 = tmp7(1114).intl;
    obj12.subLabel = intl7.string(trustedOrigin(2946).ARmJ0M);
    obj12.onPress = function onPress() {
      closure_4(VerificationMethod.ID_VERIFICATION);
    };
    items4[1] = tmp6(tmp7(5657).TableRow, obj12);
    obj10.children = items4;
    items3[2] = closure_10(tmp7(5739).TableRowGroup, obj10);
    obj4.children = items3;
    obj2.children = closure_10(tmp7(5025).Stack, obj4);
    obj.children = tmp6(ModalContent, obj2);
    tmp11 = obj;
  }
