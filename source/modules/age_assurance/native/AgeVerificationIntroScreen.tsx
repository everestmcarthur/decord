...
// Dependencies: [5, 19, 17, 8498, 1074, 8505, 21, 4606, 576, 1611, 4819, 8667, 5743, 4602, 5738, 8668, 1114, 8497, 2024, 8499, 5026, 8669, 2]
// Exports: default

// Module 8666 (AgeVerificationIntroScreen)
...
let closure_6 = fn(8498).getAgeVerificationGetStartedSteps;
...
export default function GetStartedScreen(onComplete) {
  ...
  const initiateAgeVerification = modalSessionId(4819).useInitiateAgeVerification({ onComplete: onComplete.onClose, entryPoint });
  ({ initiateAgeVerification: c1, loading } = initiateAgeVerification);
  let obj = modalSessionId(4819);
  const isManualAgeVerificationHidden = modalSessionId(8667).useIsManualAgeVerificationHidden("age_verification_get_started_modal");
  let obj3 = { children: null };
  let obj4 = { style: tmp.getStartedContainer, children: null };
  let obj5 = { style: tmp.getStartedHeaderContainer, children: null };
  const items = [closure_9(modalSessionId(5743).ShieldSpotIllustration, {}), , ];
  const obj6 = { variant: "heading-xl/bold", color: "mobile-text-heading-primary", style: tmp.getStartedHeaderText, children: null };
  let obj2 = modalSessionId(8667);
  const tmp8 = closure_11;
  obj6.children = modalSessionId(4819).getAgeVerificationGetStartedTitle(entryPoint);
  items[1] = closure_9(modalSessionId(4602).Text, obj6);
  const obj8 = { variant: "heading-md/medium", color: "text-default", style: tmp.getStartedHeaderText, children: null };
  const obj7 = modalSessionId(4819);
  obj8.children = modalSessionId(4819).getAgeVerificationGetStartedSubtitle(entryPoint);
  items[2] = closure_9(modalSessionId(4602).Text, obj8);
  obj5.children = items;
  const items1 = [closure_10(closure_5, obj5), , ];
  const obj10 = { hasIcons: true, children: null };
  const obj9 = modalSessionId(4819);
  obj10.children = closure_6(modalSessionId).map((children, index) => {
    const description = children.description;
    const obj = { index: index + 1, tip: closure_1_9(modalSessionId(4602).Text, { variant: "text-md/medium", color: "mobile-text-heading-primary", children: children.title }), description: null };
    let tmpResult = null;
    if (null != description) {
      const obj2 = { variant: "text-xs/medium", color: "text-subtle", children: description };
      tmpResult = tmp(modalSessionId(4602).Text, obj2);
    }
    obj.description = tmpResult;
    return closure_1_9(_undefined(8668), obj, index);
  });
  items1[1] = closure_9(modalSessionId(5738).TableRowGroup, obj10);
  ...
  obj11.children = closure_9(modalSessionId(4602).Text, obj12);
  ...
  if (!isManualAgeVerificationHidden) {
    ...
    obj15.children = tmp9(tmp4(4602).Text, obj16);
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const result = v3(8499).trackAgeVerificationModalClicked(modalSessionId, v3(8499).AgeVerificationModalVersion.PRIMARY, v3(8499).AgeVerificationModalCta.GET_STARTED);
            v1 = 1;
            v3 = 1;
  ...
  obj20.icon = closure_9(modalSessionId(8669).LinkExternalSmallIcon, { color: nativeDefault.colors.WHITE });
  obj20.loading = loading;
  obj19.children = closure_9(modalSessionId(5026).Button, obj20);
