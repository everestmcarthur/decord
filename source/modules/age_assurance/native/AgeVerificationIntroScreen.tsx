...
// Dependencies: [5, 19, 17, 8542, 1074, 8549, 21, 4638, 576, 1612, 4851, 8711, 5778, 4634, 5773, 8712, 1115, 8541, 2025, 8543, 5060, 8713, 2]
// Exports: default

// Module 8710 (AgeVerificationIntroScreen)
...
let closure_6 = fn(8542).getAgeVerificationGetStartedSteps;
...
export default function GetStartedScreen(onComplete) {
  ...
  const initiateAgeVerification = modalSessionId(4851).useInitiateAgeVerification({ onComplete: onComplete.onClose, entryPoint });
  ({ initiateAgeVerification: c1, loading } = initiateAgeVerification);
  let obj = modalSessionId(4851);
  const isManualAgeVerificationHidden = modalSessionId(8711).useIsManualAgeVerificationHidden("age_verification_get_started_modal");
  let obj3 = { children: null };
  let obj4 = { style: tmp.getStartedContainer, children: null };
  let obj5 = { style: tmp.getStartedHeaderContainer, children: null };
  const items = [closure_9(modalSessionId(5778).ShieldSpotIllustration, {}), , ];
  const obj6 = { variant: "heading-xl/bold", color: "mobile-text-heading-primary", style: tmp.getStartedHeaderText, children: null };
  let obj2 = modalSessionId(8711);
  const tmp8 = closure_11;
  obj6.children = modalSessionId(4851).getAgeVerificationGetStartedTitle(entryPoint);
  items[1] = closure_9(modalSessionId(4634).Text, obj6);
  const obj8 = { variant: "heading-md/medium", color: "text-default", style: tmp.getStartedHeaderText, children: null };
  const obj7 = modalSessionId(4851);
  obj8.children = modalSessionId(4851).getAgeVerificationGetStartedSubtitle(entryPoint);
  items[2] = closure_9(modalSessionId(4634).Text, obj8);
  obj5.children = items;
  const items1 = [closure_10(closure_5, obj5), , ];
  const obj10 = { hasIcons: true, children: null };
  const obj9 = modalSessionId(4851);
  obj10.children = closure_6(modalSessionId).map((children, index) => {
    const description = children.description;
    const obj = { index: index + 1, tip: closure_1_9(modalSessionId(4634).Text, { variant: "text-md/medium", color: "mobile-text-heading-primary", children: children.title }), description: null };
    let tmpResult = null;
    if (null != description) {
      const obj2 = { variant: "text-xs/medium", color: "text-subtle", children: description };
      tmpResult = tmp(modalSessionId(4634).Text, obj2);
    }
    obj.description = tmpResult;
    return closure_1_9(_undefined(8712), obj, index);
  });
  items1[1] = closure_9(modalSessionId(5773).TableRowGroup, obj10);
  ...
  obj11.children = closure_9(modalSessionId(4634).Text, obj12);
  ...
  if (!isManualAgeVerificationHidden) {
    ...
    obj15.children = tmp9(tmp4(4634).Text, obj16);
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const result = v3(8543).trackAgeVerificationModalClicked(modalSessionId, v3(8543).AgeVerificationModalVersion.PRIMARY, v3(8543).AgeVerificationModalCta.GET_STARTED);
            v1 = 1;
            v3 = 1;
  ...
  obj20.icon = closure_9(modalSessionId(8713).LinkExternalSmallIcon, { color: nativeDefault.colors.WHITE });
  obj20.loading = loading;
  obj19.children = closure_9(modalSessionId(5060).Button, obj20);
