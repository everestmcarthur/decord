...
// Dependencies: [19, 8561, 8569, 21, 4640, 576, 8568, 7716, 7721, 5060, 1177, 1115, 5775, 4636, 2949, 5521, 5062, 8567, 5693, 8560, 2]
// Exports: AgeVerificationMethodsContainer

// Module 8739 (AgeVerificationMethodsContainer)
...
export const AgeVerificationMethodsContainer = function AgeVerificationMethodsContainer(ageVerificationMethods) {
  ...
  if (null != prop) {
    if (0 !== prop.length) {
      let mapped = prop.map((label) => closure_1_6(prop(5693).TableRow, {
        label: label.title,
    ...
    const items2 = [tmp6(prop(5060).Stack, obj2), ];
    ...
    if (isSuspendedUser) {
      ...
      tmp7Result = tmp7(tmp2(4636).Text, obj5);
    }
    const obj7 = { spacing: 8, align: "center", children: null };
    items2[1] = tmp7Result;
    obj7.children = items2;
    return tmp6(prop(5060).Stack, obj7);
  }
  ...
  mapped = tmp6(tmp2(5060).Stack, obj8);
};
