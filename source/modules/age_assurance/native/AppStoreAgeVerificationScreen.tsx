...
// Dependencies: [5, 32, 19, 17, 21, 7707, 7712, 1484, 4852, 8692, 8695, 8560, 8694, 8542, 8543, 5057, 4635, 1115, 2947, 5518, 5059, 8534, 2]
// Exports: default

// Module 8691 (AppStoreAgeVerificationScreen)
...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  const watchAgeVerificationStatusChange = modalSessionId(4852).useWatchAgeVerificationStatusChange(modalSessionId.onClose);
  ...
  if ("loading" === tmp5.type) {
    ...
    items3[1] = tmp10(tmp(4635).Text, obj4);
    ...
    const items4 = [tmp10(tmp(4635).Text, obj6), ];
    ...
    obj7.children = tmp10(tmp(5059).Button, obj8);
    items4[1] = tmp10(tmp(5518).ButtonGroup, obj7);
    obj5.children = items4;
    tmp15 = closure_9(closure_8, obj5);
  }
  let obj9 = { children: null };
  let obj2 = modalSessionId(4852);
  obj9.children = closure_7(modalSessionId(8543).ModalContent, { children: closure_7(modalSessionId(5057).Stack, { align: "center", justify: "center", spacing: 16, children: tmp15 }) });
