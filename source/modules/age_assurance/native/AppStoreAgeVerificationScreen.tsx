...
// Dependencies: [5, 32, 19, 17, 21, 7710, 7715, 1484, 4851, 8701, 8704, 8569, 8703, 8551, 8552, 5058, 4634, 1115, 2947, 5519, 5060, 8543, 2]
// Exports: default

// Module 8700 (AppStoreAgeVerificationScreen)
...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  const watchAgeVerificationStatusChange = modalSessionId(4851).useWatchAgeVerificationStatusChange(modalSessionId.onClose);
  ...
  if ("loading" === tmp5.type) {
    ...
    items3[1] = tmp10(tmp(4634).Text, obj4);
    ...
    const items4 = [tmp10(tmp(4634).Text, obj6), ];
    ...
    obj7.children = tmp10(tmp(5060).Button, obj8);
    items4[1] = tmp10(tmp(5519).ButtonGroup, obj7);
    obj5.children = items4;
    tmp15 = closure_9(closure_8, obj5);
  }
  let obj9 = { children: null };
  let obj2 = modalSessionId(4851);
  obj9.children = closure_7(modalSessionId(8552).ModalContent, { children: closure_7(modalSessionId(5058).Stack, { align: "center", justify: "center", spacing: 16, children: tmp15 }) });
  return closure_7(modalSessionId(8551).ModalScreen, obj9);
};
