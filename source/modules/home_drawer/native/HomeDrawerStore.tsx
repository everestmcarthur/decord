...
// Dependencies: [1074, 1244, 4373, 4637, 16117, 4259, 2]
// Exports: computeMaxX
...
const withEqualityFn = identity.createWithEqualityFn((arg0, arg1) => {
  ...
  obj.setPanelX = function setPanelX(arg0) {
    ...
    if (isOpenTarget.get() !== "open" === arg0) {
      ...
      const result1 = panelX.set(timing.withTiming(num, tmp9(16117).HOME_DRAWER_SETTLE_TIMING));
      const result2 = snapX.set(timing.withTiming(0, tmp9(16117).HOME_DRAWER_SETTLE_TIMING));
      const obj = {};
