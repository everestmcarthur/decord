...
// Dependencies: [19, 17, 2012, 4222, 4755, 4598, 1074, 21, 4574, 576, 13057, 1178, 4570, 1114, 10094, 5601, 5001, 16352, 504, 12, 13736, 2]
// Exports: GuildVoiceState, useVoiceUsers

// Module 16353 (HomeDrawerGuildVoiceState)
...
export const GuildVoiceState = function GuildVoiceState(arg0) {
  ...
  if (!tmp2) {
    ...
    if (null == previewUrl) {
      ...
      obj6.source = obj7;
      const items1 = [tmp7(tmp3(5601), obj6), , , , ];
