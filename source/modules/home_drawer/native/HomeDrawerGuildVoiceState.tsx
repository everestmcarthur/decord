...
// Dependencies: [19, 17, 2013, 4288, 4821, 4664, 1074, 21, 4640, 576, 13182, 1177, 4636, 1115, 10212, 5675, 5074, 16479, 504, 12, 13821, 2]
// Exports: GuildVoiceState, useVoiceUsers

// Module 16480 (HomeDrawerGuildVoiceState)
...
export const GuildVoiceState = function GuildVoiceState(arg0) {
  ...
  if (!tmp2) {
    ...
    if (null == previewUrl) {
      ...
      obj6.source = obj7;
      const items1 = [tmp7(tmp3(5675), obj6), , , , ];
