...
// Dependencies: [5, 17, 4395, 7110, 7111, 1074, 7112, 4541, 4777, 5534, 7113, 1396, 1878, 7117, 7118, 7119, 7135, 1896, 1100, 2]
...
function openAndWaitForOnboarding(guildId) {
  ...
  return new Promise((arg0) => {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(7135, dependencyMap.paths), {
      guildId,
      backShouldLeaveGuild: true,
      onFinish() {
