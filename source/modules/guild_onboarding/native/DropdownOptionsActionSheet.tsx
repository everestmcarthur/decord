...
// Dependencies: [19, 17, 5511, 7174, 1374, 21, 4607, 563, 7204, 1396, 1178, 1114, 4603, 7210, 1611, 4574, 7223, 7224, 6699, 5027, 2]
// Exports: default

// Module 7209 (DropdownOptionsActionSheet)
...
export default function DropdownOptionsActionSheet(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    const obj4 = { scrollable: true, header: closure_8(tmp3(7223).BottomSheetTitleHeader, obj3), children: null };
    ...
    obj8.children = closure_8(tmp3(5027).Button, obj9);
    items2[1] = closure_8(responses, obj8);
    obj5.children = items2;
    obj4.children = closure_9(tmp3(6699).BottomSheetScrollView, obj5);
    return closure_8(tmp3(7224).BottomSheet, obj4);
  }
};
