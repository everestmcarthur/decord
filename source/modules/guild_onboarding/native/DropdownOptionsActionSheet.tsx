...
// Dependencies: [19, 17, 5510, 7173, 1374, 21, 4606, 563, 7203, 1396, 1178, 1114, 4602, 7209, 1611, 4573, 7222, 7223, 6698, 5026, 2]
// Exports: default

// Module 7208 (DropdownOptionsActionSheet)
...
export default function DropdownOptionsActionSheet(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    const obj4 = { scrollable: true, header: closure_8(tmp3(7222).BottomSheetTitleHeader, obj3), children: null };
    ...
    obj8.children = closure_8(tmp3(5026).Button, obj9);
    items2[1] = closure_8(responses, obj8);
    obj5.children = items2;
    obj4.children = closure_9(tmp3(6698).BottomSheetScrollView, obj5);
    return closure_8(tmp3(7223).BottomSheet, obj4);
  }
};
