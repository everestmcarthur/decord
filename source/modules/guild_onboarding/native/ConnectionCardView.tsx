...
// Dependencies: [19, 17, 21, 4606, 576, 4602, 1114, 4566, 5026, 2]
// Exports: default

// Module 7250 (ConnectionCardView)
...
export default function ConnectionCardView(description) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(4602).Text, obj5);
  }
  items1[1] = tmp4Result;
  ...
  if (isLoading) {
    ...
    const items3 = [tmp4(tmp5(4602).Text, obj7), tmp4(tmp5(4566).CircleCheckIcon, { size: "sm", color: "status-positive" })];
    ...
    tmp4Result2 = tmp4(tmp5(5026).Button, obj8);
  }
