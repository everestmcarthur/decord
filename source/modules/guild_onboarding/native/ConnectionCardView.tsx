...
// Dependencies: [19, 17, 21, 4722, 576, 4718, 1115, 4681, 5144, 2]
// Exports: default

// Module 7373 (ConnectionCardView)
...
export default function ConnectionCardView(description) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(4718).Text, obj5);
  }
  items1[1] = tmp4Result;
  ...
  if (isLoading) {
    ...
    const items3 = [tmp4(tmp5(4718).Text, obj7), tmp4(tmp5(4681).CircleCheckIcon, { size: "sm", color: "status-positive" })];
    ...
    tmp4Result2 = tmp4(tmp5(5144).Button, obj8);
  }
