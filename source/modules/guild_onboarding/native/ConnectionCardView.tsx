...
// Dependencies: [19, 17, 21, 4639, 576, 4635, 1115, 4599, 5059, 2]
// Exports: default
...
export default function ConnectionCardView(description) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(4635).Text, obj5);
  }
  items1[1] = tmp4Result;
  ...
  if (isLoading) {
    ...
    const items3 = [tmp4(tmp5(4635).Text, obj7), tmp4(tmp5(4599).CircleCheckIcon, { size: "sm", color: "status-positive" })];
    ...
    tmp4Result2 = tmp4(tmp5(5059).Button, obj8);
  }
