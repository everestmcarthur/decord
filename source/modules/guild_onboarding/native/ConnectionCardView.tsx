...
// Dependencies: [19, 17, 21, 4607, 576, 4603, 1114, 4567, 5027, 2]
// Exports: default

// Module 7251 (ConnectionCardView)
...
export default function ConnectionCardView(description) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(4603).Text, obj5);
  }
  items1[1] = tmp4Result;
  ...
  if (isLoading) {
    ...
    const items3 = [tmp4(tmp5(4603).Text, obj7), tmp4(tmp5(4567).CircleCheckIcon, { size: "sm", color: "status-positive" })];
    ...
    tmp4Result2 = tmp4(tmp5(5027).Button, obj8);
  }
