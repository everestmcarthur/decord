...
// Dependencies: [32, 19, 17, 4597, 5509, 1374, 21, 4341, 4605, 576, 504, 4606, 5024, 7179, 4316, 1114, 4306, 4323, 5173, 7182, 1396, 4601, 7185, 1178, 2]
// Exports: default

// Module 7178 (GuildOnboardingPromptOptionButton)
...
let Easing = fn(4341).Easing;
obj.easing = Easing.out(fn(4341).Easing.ease);
...
export default function PromptOptionButton(option) {
  ...
  let obj3 = option(4341);
  R.__closure = { selected, withTiming: option(4606).withTiming, Easing: option(4341).Easing, useReducedMotion: stateFromStores1, withSequence: option(4341).withSequence, withSpring: option(5024).withSpring };
  R.__workletHash = 8281627194581;
  R.__initData = __initData;
  const animatedStyle = obj3.useAnimatedStyle(R);
  const tmp8 = selected(7179)(option.guildId);
  closure_5 = tmp8;
  num = 0;
  if (null != tmp8) {
    num = 0;
  ...
  let obj4 = { selected, withTiming: option(4606).withTiming, Easing: option(4341).Easing, useReducedMotion: stateFromStores1, withSequence: option(4341).withSequence, withSpring: option(5024).withSpring };
  ...
  let tmp2Result = option(4341);
  V.__closure = { showMemberCount, withDelay: option(4341).withDelay, withTiming: option(4606).withTiming, Easing: option(4341).Easing, useReducedMotion: stateFromStores1 };
  V.__workletHash = 9518487706997;
  V.__initData = token;
  const animatedStyle1 = tmp2Result.useAnimatedStyle(V);
  const obj6 = { showMemberCount, withDelay: option(4341).withDelay, withTiming: option(4606).withTiming, Easing: option(4341).Easing, useReducedMotion: stateFromStores1 };
  sharedValue = option(4341).useSharedValue(1);
  isUnseen = canBeNew;
  if (canBeNew) {
  ...
  const tmp2Result11 = option(4341);
  token = option(4306).useToken(tmp7(576).colors.BORDER_SUBTLE);
  const tmp2Result12 = option(4306);
  token1 = option(4306).useToken(tmp7(576).colors.BACKGROUND_BRAND);
  const tmp2Result13 = option(4306);
  token2 = option(4306).useToken(tmp7(576).colors.BORDER_STRONG);
  const tmp2Result14 = option(4306);
  token3 = option(4306).useToken(tmp7(576).colors.BACKGROUND_BASE_LOWEST);
  const tmp2Result15 = option(4306);
  const fn = function q() {
    obj = timing;
    num = 0;
    if (selected) {
  ...
  const tmp2Result16 = option(4341);
  fn.__closure = { withTiming: option(4606).withTiming, selected, SELECTION_TIMING: sharedValue };
  fn.__workletHash = 11553377214675;
  fn.__initData = token1;
  derivedValue = tmp2Result16.useDerivedValue(fn);
  const obj7 = { withTiming: option(4606).withTiming, selected, SELECTION_TIMING: sharedValue };
  ...
  const tmp2Result17 = option(4341);
  fn2.__closure = { withTiming: option(4606).withTiming, isNew: isUnseen, SELECTION_TIMING: sharedValue };
  fn2.__workletHash = 9359578148244;
  fn2.__initData = token2;
  derivedValue1 = tmp2Result17.useDerivedValue(fn2);
  const obj8 = { withTiming: option(4606).withTiming, isNew: isUnseen, SELECTION_TIMING: sharedValue };
  class W {
    constructor() {
      obj = closure_0(closure_2[7]);
      items = [, ];
  ...
  const tmp2Result18 = option(4341);
  W.__closure = { interpolateColor: option(4341).interpolateColor, newProgress: derivedValue1, unselectedBorderColor: token, newBorderColor: token1, selectedProgress: derivedValue, selectedBorderColor: token2, selectedBackgroundColor: token3 };
  W.__workletHash = 1340353593596;
  W.__initData = token3;
  const animatedStyle2 = tmp2Result18.useAnimatedStyle(W);
  const obj9 = { interpolateColor: option(4341).interpolateColor, newProgress: derivedValue1, unselectedBorderColor: token, newBorderColor: token1, selectedProgress: derivedValue, selectedBorderColor: token2, selectedBackgroundColor: token3 };
  class K {
    constructor() {
      if (closure_4) {
        obj = {};
  ...
  const animatedStyle3 = option(4341).useAnimatedStyle(K);
  const tmp2Result19 = option(4341);
  const checkboxA11yNative = option(4323).useCheckboxA11yNative({ checked: selected });
  ...
  if (tmp38Result) {
    ...
    obj13.name = str;
    obj12.children = closure_9(tmp7(7182), obj13);
    tmp38Result = tmp38(closure_5, obj12);
    const tmp7Result = tmp7(7182);
  }
  const items8 = [tmp38Result, ];
  const obj15 = { style: tmp.optionText, children: null };
  const items9 = [closure_9(option(4601).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: option.title }), ];
  ...
  if (tmp44Result) {
    ...
    tmp44Result = tmp44(tmp2(4601).Text, obj17);
  }
  items9[1] = tmp44Result;
  obj15.children = items9;
  items8[1] = ref(closure_5, obj15);
  obj11.children = items8;
  const items10 = [ref(option(5173).PressableOpacity, obj11), , , ];
  ...
  if (num > 0) {
    ...
    obj18.children = tmp44(tmp2(4601).Text, obj19);
    tmp44Result2 = tmp44(tmp7(4341).View, obj18);
  }
  ...
  const tmp2Result20 = option(4323);
  obj21.children = closure_9(option(7185).CheckmarkSmallIcon, { size: "xs", color: selected(576).colors.WHITE });
  items10[2] = closure_9(selected(4341).View, obj21);
  if (canBeNew) {
    canBeNew = !selected;
  }
  if (canBeNew) {
  ...
  return ref(selected(4341).View, obj10);
};
