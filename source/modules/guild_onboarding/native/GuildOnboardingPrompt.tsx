...
// Dependencies: [32, 19, 17, 5509, 5622, 1979, 7152, 7149, 1374, 21, 4605, 5732, 576, 1483, 504, 1611, 4306, 672, 7175, 5651, 4601, 1114, 5025, 5597, 5037, 1093, 7158, 7177, 7178, 7182, 1396, 4572, 7187, 1896, 5173, 7210, 2]
// Exports: DropdownPrompt, MultipleChoicePrompt, RulesPrompt

// Module 7176 (GuildOnboardingPrompt)
...
function PromptHeader(currentPrompt) {
  ...
  if (required) {
    ...
    items1[1] = tmp5(tmp6(4601).Text, obj6);
...
function DropdownOption(option) {
  ...
  const items1 = [closure_15(closure_6, obj3), closure_15(tmp2(4601).Text, { variant: "text-md/semibold", children: option.title })];
