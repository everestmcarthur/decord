...
// Dependencies: [32, 19, 17, 5511, 5624, 1979, 7174, 7171, 1374, 21, 4607, 5734, 576, 1483, 504, 1611, 4308, 672, 7197, 5653, 4603, 1114, 5027, 5599, 5039, 1093, 7180, 7199, 7200, 7204, 1396, 4574, 7209, 1896, 5175, 7232, 2]
// Exports: DropdownPrompt, MultipleChoicePrompt, RulesPrompt

// Module 7198 (GuildOnboardingPrompt)
...
import TermsFieldListDefault from "TermsFieldList" /* 5653 */;
...
function PromptHeader(currentPrompt) {
  ...
  if (required) {
    ...
    items1[1] = tmp5(tmp6(4603).Text, obj6);
...
function DropdownOption(option) {
  ...
  const items1 = [closure_15(closure_6, obj3), closure_15(tmp2(4603).Text, { variant: "text-md/semibold", children: option.title })];
