...
// Dependencies: [32, 19, 17, 5510, 5623, 1979, 7173, 7170, 1374, 21, 4606, 5733, 576, 1483, 504, 1611, 4308, 672, 7196, 5652, 4602, 1114, 5026, 5598, 5038, 1093, 7179, 7198, 7199, 7203, 1396, 4573, 7208, 1896, 5174, 7231, 2]
// Exports: DropdownPrompt, MultipleChoicePrompt, RulesPrompt

// Module 7197 (GuildOnboardingPrompt)
...
import TermsFieldListDefault from "TermsFieldList" /* 5652 */;
...
function PromptHeader(currentPrompt) {
  ...
  if (required) {
    ...
    items1[1] = tmp5(tmp6(4602).Text, obj6);
...
function DropdownOption(option) {
  ...
  const items1 = [closure_15(closure_6, obj3), closure_15(tmp2(4602).Text, { variant: "text-md/semibold", children: option.title })];
...
let obj3 = { display: "flex", flex: 1, flexGrow: 1, marginTop: fn(5733).NAV_BAR_HEIGHT, marginBottom: 16, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWER };
