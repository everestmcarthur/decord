...
// Dependencies: [5, 32, 2014, 1957, 2021, 1371, 7173, 1074, 4232, 4788, 1272, 573, 1232, 5603, 12, 7179, 1369, 7182, 1242, 4786, 7183, 11, 1384, 7186, 7193, 2]

// Module 7178 (GuildOnboardingActionCreators)
...
obj.completeOnboarding = function completeOnboarding(guildId, prompts) {
  ...
  const selectedRoleIds = items1(7179).getSelectedRoleIds(selectedOptions);
  const obj2 = items1(7179);
  ...
  const tmp2Result = items1(7179);
  [arr3, arr4] = items1(7179).getChannelCoverageForOnboarding(guildId, prompts, defaultChannelIds);
  ...
  const tmp6 = _slicedToArray(items1(7179).getChannelCoverageForOnboarding(guildId, prompts, defaultChannelIds), 2);
  const tmp2Result11 = items1(7182);
  if (null == tmp) {
    items1 = [];
  } else {
  ...
  const tmp2Result14 = items1(4786);
  const tmp2Result15 = items1(7183);
