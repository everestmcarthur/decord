...
// Dependencies: [2015, 1958, 7292, 7297, 7298, 12, 504, 1091, 11, 573, 2]

// Module 7296 (GuildOnboardingPromptsStore)
...
const GuildOnboardingStatus = fn(7292).GuildOnboardingStatus;
