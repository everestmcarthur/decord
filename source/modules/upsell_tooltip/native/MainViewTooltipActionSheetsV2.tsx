...
// Dependencies: [32, 19, 4295, 1221, 1074, 1954, 21, 17022, 1896, 17024, 17026, 17027, 17028, 17030, 17031, 15769, 17033, 17035, 17037, 17041, 17045, 12039, 1943, 1944, 1242, 1948, 10696, 4425, 1945, 17046, 504, 10695, 2]
// Exports: default

// Module 17021 (MainViewTooltipActionSheetsV2)
...
function TrackedDismissibleActionSheet(actionSheetConfig) {
  ...
  return jsx(actionSheetConfig(10696).DismissibleActionSheet, {});
}
let noop = fn(19);
...
let items = [
  {
    ...
    importer: function GooglePlayPriceChangeActionSheetImporter() {
      return asyncRequireImpl(17028, dependencyMap.paths);
    }
  },
,
,
...
items[1] = {
  ...
  importer: function PremiumDiscountOfferActionSheetImporter() {
    return asyncRequireImpl(17031, dependencyMap.paths);
  }
};
let obj2 = {
  id: fn(1943).DismissibleContent.DISCOUNT_OFFER_ACTION_SHEET,
...
items[2] = {
  ...
  importer: function PremiumTrialOfferActionSheetImporter() {
    return asyncRequireImpl(15769, dependencyMap.paths);
  }
};
let obj3 = {
  id: fn(1943).DismissibleContent.MOBILE_PREMIUM_TRIAL_OFFER_ACTION_SHEET,
...
items[3] = {
  ...
  importer: function BogoPromotionActionSheetImporter() {
    return asyncRequireImpl(17027, dependencyMap.paths);
  }
};
let items1 = [...items];
let obj4 = {
...
items1[sum7] = {
  ...
  importer: function RobloxConnectionCoachmarkImporter() {
    return asyncRequireImpl(17026, dependencyMap.paths);
  }
};
const sum8 = sum7 + 1;
const obj13 = {
...
items1[sum9] = {
  ...
  importer: function CollectiblesMobileAnnouncementActionSheetImporter() {
    return asyncRequireImpl(17041, dependencyMap.paths);
  }
};
const sum10 = sum9 + 1;
const obj15 = {
...
items1[sum10 + 1] = {
  ...
  importer: function CustomTypingIndicatorAnnounceActionSheetImporter() {
    return asyncRequireImpl(12039, dependencyMap.paths);
  }
};
const size = fn(2);
...
export default function MainViewTooltipActionSheetsV2() {
  mainViewTooltipActionSheetMap = mainViewTooltipActionSheetMap(17046).useMainViewTooltipActionSheetMap();
  ...
  let obj = mainViewTooltipActionSheetMap(17046);
  items1 = [obj5];
  ...
  if (null == first) {
    ...
    if ("snowflake_bound" === str2) {
      ...
      return jsx(tmp(10695).SelectedSnowflakeBoundDismissibleContent, { contentType: first.id, newSnowflakeId: null, groupName: null, children: null });
      ...
      return jsx(tmp(10695).SelectedVersionedDismissibleContent, {
        latestVersion: num,
        contentType: first.id,
        groupName: constants.MAIN_VIEW_TOOLTIPS,
        children(visibleContent) {
      ...
      return jsx(tmp(10695).SelectedTimeRecurringDismissibleContent, {
        contentType: first.id,
        timeRecurringConfig: obj5.cooldownConfig,
        groupName: constants.MAIN_VIEW_TOOLTIPS,
        bypassAutoDismiss: false,
      ...
      return jsx(first(10695), { contentTypes: null, groupName: null, children: null });
    } else {
      return null;
    }
    tmpResult = tmp(1944);
