...
// Dependencies: [5, 1961, 5593, 4429, 1074, 4431, 573, 1272, 5594, 4950, 1114, 5462, 2]

// Module 5592 (GuildJoinRequestActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import HTTPUtils from "HTTPUtils" /* 1272 */;
import MemberVerificationTypes from "MemberVerificationTypes" /* 4431 */;
import GuildJoinRequestAnalyticUtils from "GuildJoinRequestAnalyticUtils" /* 5594 */;
...
let closure_13 = async function _updateGuildJoinRequest(arg0, value) {
  if (c8 === 2) {
    c8 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp5 === 3) {
    ...
    try {
      ...
      if (0 === c7) {
        ...
        if (arg0 === 1) {
          ...
          const request = { url: closure_134_8.GUILD_JOIN_REQUEST(closure_133_0, closure_133_2), body: null, rejectWithError: null };
        ...
        closure_133_5 = value;
        const obj10 = { type: "GUILD_JOIN_REQUEST_UPDATE", guildId: closure_133_0, status: closure_133_5.body.application_status, request: closure_133_5.body };
...
let closure_17 = async function _createOrEnterJoinRequestInterview() {
  ...
  await "PX_16";
  const HTTP = closure_131_0(closure_131_2[7]).HTTP;
  closure_130_2 = await HTTP.post({ url: closure_131_8.JOIN_REQUEST_INTERVIEW(closure_130_0), rejectWithError: closure_131_0(closure_131_2[7]).rejectWithMigratedError() });
