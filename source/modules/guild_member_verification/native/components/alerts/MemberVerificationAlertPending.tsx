...
// Dependencies: [19, 21, 5615, 5625, 5626, 1115, 5062, 2]
// Exports: default

// Module 5624 (MemberVerificationAlertPending)
...
export default function MemberVerificationAlertPending(guildId) {
  ...
  obj.icon = guildId(5626).ClipboardListIcon;
  ...
  const items1 = [closure_4(guildId(5062).Button, obj3), ];
  ...
  items1[1] = closure_4(guildId(5062).Button, obj4);
