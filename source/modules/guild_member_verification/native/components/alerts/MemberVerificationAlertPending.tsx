...
// Dependencies: [19, 21, 5613, 5623, 5624, 1115, 5060, 2]
// Exports: default

// Module 5622 (MemberVerificationAlertPending)
...
export default function MemberVerificationAlertPending(guildId) {
  ...
  obj.icon = guildId(5624).ClipboardListIcon;
  ...
  const items1 = [closure_4(guildId(5060).Button, obj3), ];
  ...
  items1[1] = closure_4(guildId(5060).Button, obj4);
