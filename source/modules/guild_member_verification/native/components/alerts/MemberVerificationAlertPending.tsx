...
// Dependencies: [19, 21, 5612, 5622, 5623, 1115, 5059, 2]
// Exports: default

// Module 5621 (MemberVerificationAlertPending)
...
export default function MemberVerificationAlertPending(guildId) {
  ...
  obj.icon = guildId(5623).ClipboardListIcon;
  ...
  const items1 = [closure_4(guildId(5059).Button, obj3), ];
  ...
  items1[1] = closure_4(guildId(5059).Button, obj4);
