...
// Dependencies: [19, 17, 1074, 21, 4606, 5045, 1114, 4301, 7164, 4602, 2]
// Exports: default

// Module 7163 (MemberVerificationAlertUpdate)
import util from "util" /* 1114 */;
import LinkingDefault from "Linking" /* 4301 */;
import Text_Text from "Text/Text" /* 4602 */;
import common_AlertDefault from "common/Alert" /* 5045 */;
import _modDef7164 from "module_7164" /* 7164 */;
...
export default function MemberVerificationAlertUpdate(onClose) {
  ...
  const items = [hasOwnProperty(Image, { source: _modDef7164, style: tmp.headerImage }), , ];
