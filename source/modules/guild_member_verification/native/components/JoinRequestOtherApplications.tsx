...
// Dependencies: [19, 17, 21, 4640, 576, 4464, 4599, 6727, 16748, 4636, 1115, 16744, 4321, 2]

// Module 16747 (JoinRequestOtherApplications)
...
function ApplicationStatusIcon(status) {
  ...
  if (MemberVerificationTypes.GuildJoinRequestApplicationStatuses.APPROVED === status) {
    ...
    return timestampProducer(tmp(6727).CircleXIcon, obj);
  } else {
    return null;
  }
}
...
export default noop.memo((arg0) => {
  ...
  if (0 !== otherGuildJoinRequestsForUser.length) {
    ...
    let items = [closure_6(tmp2(4636).Text, obj3), ];
    let obj4 = {
      style: tmp.container,
