...
// Dependencies: [19, 1074, 1964, 10207, 21, 4606, 576, 16286, 5592, 4431, 1100, 12472, 1114, 5140, 1178, 2]
// Exports: default
...
let obj2 = { container: { marginVertical: fn(10207).CHANNEL_MARGIN_VERTICAL, marginHorizontal: 8, borderRadius: nativeDefault.radii.md }, badge: null, badgeText: null };
...
export default function GuildMemberDashChannelRow(arg0) {
  ...
  obj3.mode = tmp7;
  obj2.name = jsx(id(12472).BaseChannelName, { name: null, mode: null });
  const tmp9 = hasItem(12472);
  obj2.icon = jsx(id(12472).BaseChannelIcon, { mode: tmp7, IconComponent: id(5140).GroupIcon });
  let tmp8Result = null;
  if (num > 0) {
