...
// Dependencies: [19, 1074, 1965, 10256, 21, 4638, 576, 16345, 5627, 4462, 1101, 12522, 1115, 5174, 1177, 2]
// Exports: default

// Module 16344 (GuildMemberDashChannelRow)
...
let obj2 = { container: { marginVertical: fn(10256).CHANNEL_MARGIN_VERTICAL, marginHorizontal: 8, borderRadius: nativeDefault.radii.md }, badge: null, badgeText: null };
...
export default function GuildMemberDashChannelRow(arg0) {
  ...
  const tmp = closure_8();
  const id = guild.id;
  let num = id(16345).useSubmittedGuildJoinRequestTotal({ guildId: id });
  if (num == null) {
    num = 0;
  }
  ...
  const ChannelModes = tmp2(12522).ChannelModes;
  ...
  obj3.mode = tmp7;
  obj2.name = jsx(id(12522).BaseChannelName, { name: null, mode: null });
  const tmp9 = hasItem(12522);
  obj2.icon = jsx(id(12522).BaseChannelIcon, { mode: tmp7, IconComponent: id(5174).GroupIcon });
  let tmp8Result = null;
  if (num > 0) {
