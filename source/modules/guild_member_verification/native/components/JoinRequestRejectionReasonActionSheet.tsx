...
// Dependencies: [5, 32, 19, 21, 4574, 8196, 5555, 4398, 4272, 1114, 6630, 576, 4541, 7164, 7137, 7099, 5447, 4989, 2]

// Module 12664 (JoinRequestRejectionReasonActionSheet)
          ...
          if (0 === c4) {
            ...
            if (2 === tmp8) {
              ...
              obj6.icon = function icon() {
                return closure_1_6(closure_1_0(6630).CircleXIcon, { color: closure_1_1(576).colors.BACKGROUND_FEEDBACK_CRITICAL, secondaryColor: closure_1_1(576).colors.ICON_FEEDBACK_CRITICAL });
              };
