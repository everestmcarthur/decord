...
// Dependencies: [5, 32, 19, 21, 4639, 8290, 5626, 4464, 4338, 1115, 6721, 576, 4606, 7257, 7230, 7192, 5518, 5059, 2]

// Module 12769 (JoinRequestRejectionReasonActionSheet)
          ...
          if (0 === c4) {
            ...
            if (2 === tmp8) {
              ...
              obj6.icon = function icon() {
                return closure_1_6(closure_1_0(6721).CircleXIcon, { color: closure_1_1(576).colors.BACKGROUND_FEEDBACK_CRITICAL, secondaryColor: closure_1_1(576).colors.ICON_FEEDBACK_CRITICAL });
              };
