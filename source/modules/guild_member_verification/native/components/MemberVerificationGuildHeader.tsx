...
// Dependencies: [19, 17, 5659, 21, 4638, 576, 1397, 5669, 1612, 4374, 5072, 5670, 5676, 4634, 1115, 2]
// Exports: default

// Module 5668 (MemberVerificationGuildHeader)
...
export default function MemberVerificationGuildHeader(hasManualFormFields) {
  ...
  if (null != guild.banner) {
    ...
    tmp3 = top;
    guildBannerSource = require("module_5669");
    tmp5 = importDefault;
  }
