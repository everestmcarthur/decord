...
// Dependencies: [19, 17, 5658, 21, 4639, 576, 1397, 5668, 1612, 4376, 5071, 5669, 5675, 4635, 1115, 2]
// Exports: default

// Module 5667 (MemberVerificationGuildHeader)
...
export default function MemberVerificationGuildHeader(hasManualFormFields) {
  ...
  if (null != guild.banner) {
    ...
    tmp3 = top;
    guildBannerSource = require("module_5668");
    tmp5 = importDefault;
  }
