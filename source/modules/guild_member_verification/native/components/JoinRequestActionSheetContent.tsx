...
// Dependencies: [19, 17, 1957, 7165, 7222, 21, 4574, 576, 8267, 8256, 8253, 8264, 8205, 16612, 8272, 8282, 11143, 13090, 13147, 504, 12663, 4397, 4989, 5085, 1114, 4398, 9062, 4570, 6630, 4255, 11, 4534, 5447, 8113, 4525, 4527, 1611, 16615, 2]
...
function OpenInterviewButton(arg0) {
  ...
  if (!obj3.isActionedApplicationStatus(joinRequest.applicationStatus)) {
    ...
    obj4.icon = closure_8(tmp(5085).ChatIcon, obj5);
    if (label == null) {
    ...
    let tmp6Result = closure_8(tmp(4989).Button, obj4);
  } else {
    tmp6Result = null;
  }
  return tmp6Result;
...
let closure_12 = noop.memo((user) => {
  ...
  const tmp5 = joinRequest(8253)({ user, displayProfile });
  const tmp6 = user;
  const userProfileColors = user(8264).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null != user) {
    ...
    const items1 = [closure_8(tmp(8272), obj3), ];
    ...
    obj5.onPress = tmp8;
    const items2 = [closure_8(tmp(8282), obj5), ];
    ...
    const items4 = [closure_8(tmp6(13090).PrimaryInfo, obj10), ];
    const obj11 = { user };
    items4[1] = closure_8(tmp(13147), obj11);
    obj9.children = items4;
    obj7.children = closure_9(View, obj9);
    items2[1] = closure_8(tmp(11143), obj7);
    obj4.children = items2;
    items1[1] = closure_9(View, obj4);
    obj2.children = items1;
    tmp9 = closure_9(closure_10, obj2);
    const tmpResult = tmp(11143);
  }
  return tmp9;
});
let closure_14 = noop.memo((joinRequest) => {
  ...
  if (applicationStatus === MemberVerificationTypes.GuildJoinRequestApplicationStatuses.SUBMITTED) {
    if (null != joinRequest.interviewChannelId) {
      ...
      const items = [React6(tmp2(9062).HourglassIcon, obj4), ];
      ...
      obj5.children = React6(tmp2(4570).Text, obj6);
  ...
  if (MemberVerificationTypes.GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
    ...
    const items2 = [React6(tmp2(6630).CircleXIcon, obj10), ];
    ...
    const items3 = [React6(tmp2(4570).Text, obj11), , ];
    ...
    if (null != actionedByUser) {
      ...
      if (null != actionedAt) {
        ...
        const items4 = [tmp20(tmp2(4570).Text, obj13), , ];
        ...
        items4[2] = tmp20(tmp2(4570).Text, obj16);
    ...
    if (tmp20Result) {
      ...
      tmp20Result = tmp20(tmp2(4570).Text, obj17);
    }
  ...
  } else if (tmp2(4398).GuildJoinRequestApplicationStatuses.APPROVED === applicationStatus) {
    ...
    const items6 = [React6(tmp2(4534).CircleCheckIcon, obj22), ];
    ...
    const items7 = [React6(tmp2(4570).Text, obj23), ];
    let tmp6Result = null;
    if (null != actionedByUser) {
      tmp6Result = null;
      if (null != actionedAt) {
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const joinRequestButtonActions = joinRequest(12663).useJoinRequestButtonActions(joinRequest, joinRequest.interviewChannelId, callback);
  ...
  const obj = joinRequest(12663);
  const tmp5 = closure_9;
  obj2.icon = closure_8(joinRequest(4525).CheckmarkLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" });
  ...
  const children = [closure_8(joinRequest(8113).IconButton, obj2), , ];
  ...
  obj4.icon = closure_8(joinRequest(4527).XLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" });
  const intl2 = joinRequest(1114).intl;
  obj4.label = intl2.string(joinRequest(1114).t.hDtbsz);
  obj4.onPress = rejectRequest;
  obj4.disabled = submitting;
  children[1] = closure_8(joinRequest(8113).IconButton, obj4);
  ...
  if (tmp6Result) {
    ...
    obj6.icon = tmp6(tmp2(5085).ChatIcon, obj7);
    const intl3 = tmp2(1114).intl;
    obj6.label = intl3.string(tmp2(1114).t.KQeYoC);
    obj6.onPress = handleOpenInterview;
    obj6.disabled = submitting;
    tmp6Result = tmp6(tmp2(8113).IconButton, obj6);
  }
  children[2] = tmp6Result;
  return tmp5(joinRequest(5447).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
let closure_16 = noop.memo((arg0) => {
  ...
  if (MemberVerificationTypes.VerificationFormFieldTypes.TERMS === field_type) {
    ...
    const items1 = [React6(tmp2(4570).Text, obj3), ];
    ...
    items1[1] = React6(tmp2(4534).CircleCheckIcon, obj4);
    obj2.children = items1;
    return React7(View, obj2);
  } else if (tmp2(4398).VerificationFormFieldTypes.MULTIPLE_CHOICE === field_type) {
    const obj5 = { style: tmp.formQuestion, variant: "text-sm/semibold", color: "text-subtle", children: field.label };
    const items2 = [React6(tmp2(4570).Text, obj5), ];
    ...
    obj6.children = React6(tmp2(4570).Text, obj8);
    ...
    const items4 = [React6(tmp2(4570).Text, obj9), ];
    ...
    obj10.children = React6(tmp2(4570).Text, obj11);
