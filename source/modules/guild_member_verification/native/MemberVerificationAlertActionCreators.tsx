...
// Dependencies: [19, 21, 1875, 4983, 5614, 1897, 5622, 5626, 5060, 1115, 5630, 7200, 7202, 2]
...
// Module 5613 (MemberVerificationAlertActionCreators)
...
export const openMemberVerificationSuccessAlert = function openMemberVerificationSuccessAlert(guildId, arg1) {
  ...
  actions_AlertActionCreatorsDefault.openLazy({
    importer() {
      return asyncRequireImpl(5614, dependencyMap.paths).then((result) => {
...
export const openMemberVerificationPendingAlert = function openMemberVerificationPendingAlert(guildId, arg1) {
  ...
  actions_AlertActionCreatorsDefault.openLazy({
    importer() {
      return asyncRequireImpl(5622, dependencyMap.paths).then((result) => {
        closure_0 = result.default;
        return (arg0) => {
          const obj = {};
          const merged = Object.assign(arg0);
...
export const openMemberVerificationRejectedAlert = function openMemberVerificationRejectedAlert(canWithdraw) {
  ...
  onClose(4983).openLazy({
    importer() {
      return asyncRequireImpl(5630, dependencyMap.paths).then((result) => {
        closure_0 = result.default;
        return (arg0) => {
          const obj = {};
          const merged = Object.assign(arg0);
...
export const openMemberVerificationIncompleteAlert = function openMemberVerificationIncompleteAlert(guildId, arg1) {
  ...
  actions_AlertActionCreatorsDefault.openLazy({
    isDismissable: true,
    importer() {
      return asyncRequireImpl(7202, dependencyMap.paths).then((result) => {
        closure_0 = result.default;
        return (arg0) => {
          const obj = {};
          const merged = Object.assign(arg0);
