...
// Dependencies: [5146, 1074, 4464, 1370, 2]
...
// Module 5145 (MemberVerificationUtils)
  ...
  if (required.required) {
    if (null == response) {
      ...
      if (MemberVerificationTypes.VerificationFormFieldTypes.TERMS !== field_type) {
        if (tmp4(4464).VerificationFormFieldTypes.VERIFICATION !== field_type) {
          if (tmp4(4464).VerificationFormFieldTypes.TEXT_INPUT !== field_type) {
            if (tmp4(4464).VerificationFormFieldTypes.PARAGRAPH !== field_type) {
              if (tmp4(4464).VerificationFormFieldTypes.MULTIPLE_CHOICE === field_type) {
