...
// Dependencies: [5144, 1074, 4462, 1370, 2]
...
// Module 5143 (MemberVerificationUtils)
import Constants from "Constants" /* 1074 */;
import MemberVerificationTypes from "MemberVerificationTypes" /* 4462 */;
import MemberVerificationConstants from "MemberVerificationConstants" /* 5144 */;
  ...
  if (required.required) {
    if (null == response) {
      ...
      if (MemberVerificationTypes.VerificationFormFieldTypes.TERMS !== field_type) {
        if (tmp4(4462).VerificationFormFieldTypes.VERIFICATION !== field_type) {
          if (tmp4(4462).VerificationFormFieldTypes.TEXT_INPUT !== field_type) {
            if (tmp4(4462).VerificationFormFieldTypes.PARAGRAPH !== field_type) {
              if (tmp4(4462).VerificationFormFieldTypes.MULTIPLE_CHOICE === field_type) {
