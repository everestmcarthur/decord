...
// Function ID: 8488
// Name: HeaderAvatar
// Dependencies: [19, 17, 4714, 2022, 4762, 1074, 21, 4722, 576, 1177, 504, 8488, 8396, 8489, 8477, 5292, 2]

// Module 8487 (HeaderAvatar)
...
export default noop.forwardRef((animate, ref) => {
  ...
  obj7.streaming = tmp9(8489)(activities);
  if (flag) {
    flag = !stateFromStores;
  }
  obj7.animate = flag;
  obj7.avatarDecoration = tmp10(guildId(8396).getProfilePreviewValue(obj6));
  if (null != onPress) {
    ...
    jsx(obj(5292).PressableOpacity, { ref, onPress, onLongPress: onPress, style, activeOpacity: 0.8, accessibilityRole: "imagebutton" });
  } else {
    const obj11 = { ref, style, accessibilityRole: "image", accessible: true };
    const merged3 = Object.assign(merged);
    if (undefined !== pendingAvatarSrc) {
      const obj12 = { source: null };
      const objResult = obj(8477);
