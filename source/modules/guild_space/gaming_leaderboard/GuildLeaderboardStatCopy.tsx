...
// Dependencies: [4267, 1115, 2331, 2]
// Exports: getStatName

// Module 11043 (GuildLeaderboardStatCopy)
...
export const getStatName = function getStatName(winningStat) {
  if (GuildLeaderboardTypes.GamingLeaderboardStat.GAMING_LEADERBOARD_STAT_HOURS_PLAYED === winningStat) {
    ...
    return obj2;
  } else if (tmp(4267).GamingLeaderboardStat.GAMING_LEADERBOARD_STAT_DAYS_PLAYED === winningStat) {
    ...
    return obj3;
  } else if (tmp(4267).GamingLeaderboardStat.GAMING_LEADERBOARD_STAT_UNIQUE_GAMES_PLAYED === winningStat) {
