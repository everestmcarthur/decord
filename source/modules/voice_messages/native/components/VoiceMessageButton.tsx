...
// Dependencies: [5, 32, 19, 17, 4264, 7694, 1957, 4915, 11990, 11991, 1074, 4567, 4784, 21, 4574, 576, 7987, 4431, 4781, 12286, 4310, 11558, 1477, 11904, 5141, 5142, 7470, 9341, 11700, 1109, 4272, 1114, 10121, 4432, 5153, 4271, 9791, 6669, 12288, 12269, 10037, 2]
...
export default noop.memo((disabled) => {
  ...
  _require = sharedValue(function*(arg0) {
    closure_129_2 = yield closure_0(12286).endAudioRecording();
    ...
    if (null != channel) {
      const cloudUpload = new closure_0(5141).CloudUpload({ uri: data.filename, originalUri: data.filename, mimeType: "audio/ogg", filename: "voice-message.ogg", platform: closure_0(5142).UploadPlatform.REACT_NATIVE, durationSecs: data.durationSecs, waveform: data.waveform }, channel.id);
      ...
      { uri: data.filename, originalUri: data.filename, mimeType: "audio/ogg", filename: "voice-message.ogg", platform: closure_0(5142).UploadPlatform.REACT_NATIVE, durationSecs: data.durationSecs, waveform: data.waveform };
      const id = channel.id;
      ...
      sharedValue1(7470).sendMessage(id, { content: "", tts: false, invalidEmojis: [], validNonShortcutEmojis: [] }, undefined, obj17);
      sharedValue1(7470);
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              c3 = 1;
              const obj5 = { value: cancel(12286).endAudioRecording(), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            closure_128_0 = value;
            const result = cancel(12286).emitVoiceMessageRecorded(cancel(11904).VoiceMessageRecordingResult.CANCELLED_GESTURE_CONFLICT, closure_128_0.data.durationSecs, closure_128_0.startTimeMillis);
            const obj = cancel(12286);
          }
          c3 = 3;
  ...
  let obj6 = { ref: sharedValue1(12288)().tooltipTargetRef, IconComponent: null, active: false, accessibilityLabel: null, accessibilityActions: null, onAccessibilityAction: null, disabled: null };
  ...
  obj5.children = jsx(sharedValue1(12269), { ref: sharedValue1(12288)().tooltipTargetRef, IconComponent: null, active: false, accessibilityLabel: null, accessibilityActions: null, onAccessibilityAction: null, disabled: null });
