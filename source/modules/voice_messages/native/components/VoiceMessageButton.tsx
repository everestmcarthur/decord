...
// Dependencies: [5, 32, 19, 17, 4295, 7731, 1957, 4946, 12030, 12031, 1074, 4598, 4815, 21, 4605, 576, 8025, 4462, 4812, 12326, 4341, 11598, 1477, 11944, 5177, 5178, 7508, 9379, 11740, 1109, 4303, 1114, 10159, 4463, 5189, 4302, 9829, 6705, 12328, 12309, 10075, 2]

// Module 12325 (VoiceMessageButton)
...
import isChannelFocused from "isChannelFocused" /* 10159 */;
import VoiceMessageUtils from "VoiceMessageUtils" /* 12326 */;
...
export default noop.memo((disabled) => {
  ...
  const tmp9 = sharedValue1(11598)();
  _require = sharedValue(function*(arg0) {
    closure_129_2 = yield closure_0(12326).endAudioRecording();
    const data = closure_129_2.data;
    const startTimeMillis = closure_129_2.startTimeMillis;
    closure_1_6(false);
    if (closure_129_0) {
      closure_1_9.current = closure_129_1;
      let result = closure_0(12326).emitVoiceMessageRecorded(closure_129_1, data.durationSecs, startTimeMillis);
    }
    if (data.durationSecs < closure_2_20 / 1000) {
      const result1 = closure_0(12326).emitVoiceMessageRecorded(closure_0(11944).VoiceMessageRecordingResult.CANCELLED_DURATION, data.durationSecs, startTimeMillis);
      __initData();
    }
    const result2 = closure_0(12326).emitVoiceMessageRecorded(closure_0(11944).VoiceMessageRecordingResult.SENT, data.durationSecs, startTimeMillis);
    const channel = callback.getChannel(closure_1);
    if (null != channel) {
      const cloudUpload = new closure_0(5177).CloudUpload({ uri: data.filename, originalUri: data.filename, mimeType: "audio/ogg", filename: "voice-message.ogg", platform: closure_0(5178).UploadPlatform.REACT_NATIVE, durationSecs: data.durationSecs, waveform: data.waveform }, channel.id);
      const items = [cloudUpload];
      closure_129_6 = items;
      const pendingReply2 = pendingReply.getPendingReply(closure_1);
      const sendMessageOptionsForReply = sharedValue1(7508).getSendMessageOptionsForReply(pendingReply2);
      { uri: data.filename, originalUri: data.filename, mimeType: "audio/ogg", filename: "voice-message.ogg", platform: closure_0(5178).UploadPlatform.REACT_NATIVE, durationSecs: data.durationSecs, waveform: data.waveform };
      const id = channel.id;
      ...
      sharedValue1(7508).sendMessage(id, { content: "", tts: false, invalidEmojis: [], validNonShortcutEmojis: [] }, undefined, obj17);
      sharedValue1(7508);
      closure_0(11740).deletePendingReply(closure_1);
      closure_0(11740);
      sharedValue1(7508);
    }
    ...
    if (cancelReason === undefined) {
      cancelReason = closure_0(11944).VoiceMessageRecordingResult.CANCELLED_USER_REQUESTED;
    }
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              c3 = 1;
              const obj5 = { value: cancel(12326).endAudioRecording(), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            closure_128_0 = value;
            const result = cancel(12326).emitVoiceMessageRecorded(cancel(11944).VoiceMessageRecordingResult.CANCELLED_GESTURE_CONFLICT, closure_128_0.data.durationSecs, closure_128_0.startTimeMillis);
            const obj = cancel(12326);
          }
          c3 = 3;
  ...
  let obj6 = { ref: sharedValue1(12328)().tooltipTargetRef, IconComponent: null, active: false, accessibilityLabel: null, accessibilityActions: null, onAccessibilityAction: null, disabled: null };
  ...
  obj5.children = jsx(sharedValue1(12309), { ref: sharedValue1(12328)().tooltipTargetRef, IconComponent: null, active: false, accessibilityLabel: null, accessibilityActions: null, onAccessibilityAction: null, disabled: null });
