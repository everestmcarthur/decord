...
// Dependencies: [19, 17, 1074, 1955, 21, 11255, 11256, 11257, 1115, 4326, 2025, 4358, 4339, 576, 1241, 4458, 1944, 4348, 7260, 5673, 8437, 7264, 11258, 8976, 4634, 5060, 4638, 1364, 2]
// Exports: default

// Module 11254 (BalanceWidgetActionSheet)
...
export default function _default(balance) {
  ...
  const memo = noop.useMemo(() => {
    ...
    let tmp = null;
    if (num > 4100) {
      const obj = { backgroundVideo: _mod11255.default, backgroundImage: _mod11256.default, bannerImage: _mod11257.default, bannerText: null };
  ...
  const effect = noop.useEffect(() => {
    ...
    if (!obj3.UNSAFE_isDismissibleContentDismissed(dismissible_content.DismissibleContent.VIRTUAL_CURRENCY_MOBILE_ONBOARDING_PILL)) {
      ...
      const result = tmp3(4458).UNSAFE_markDismissibleContentAsDismissed(tmp3(1944).DismissibleContent.VIRTUAL_CURRENCY_MOBILE_ONBOARDING_PILL, obj4);
      const tmp3Result = tmp3(4458);
    }
  }, []);
