...
// Dependencies: [19, 17, 1074, 1076, 1954, 5495, 21, 5174, 4602, 1114, 10714, 1943, 1242, 11860, 5498, 15763, 8940, 4573, 11196, 1896, 7255, 7614, 11195, 4427, 5042, 4606, 576, 2]
// Exports: default
...
import BalanceWidgetPillButtonDefault from "BalanceWidgetPillButton" /* 11195 */;
    ...
    obj.children = function children(markAsDismissed) {
      ...
      if (markAsDismissed.visibleContent === dismissible_content.DismissibleContent.VIRTUAL_CURRENCY_MOBILE_ONBOARDING_PILL) {
        function handleOnboardingPress() {
          ...
          const obj2 = style(11860);
          obj2.openQuestHome({ filter: constants3.VIRTUAL_CURRENCY, fromContent: style(5498).QuestContent.MOBILE_ORBS_ONBOARDING_DC });
        }
...
function BalanceWidgetMenu(style) {
  let str;
  str = str(8940).useFetchVirtualCurrencyBalance().balance;
  let items = [str];
  const callback = noop.useCallback(() => {
    ...
    obj4.onButtonPress = function onButtonPress() {
      ...
      const result = str(7614).openCollectiblesShopMobile(obj5);
    };
    ...
    obj5.onButtonPress = function onButtonPress() {
      ...
      ActionSheetActionCreatorsDefault.hideActionSheet();
      const obj4 = str(11860);
      obj4.openQuestHome({ mergeExistingRoutes: true, filter: constants3.VIRTUAL_CURRENCY, fromContent: str(5498).QuestContent.ORBS_BALANCE_MENU });
    };
...
export default function BalanceWidgetMenuWrapper(style) {
  ...
  if (null == balance) {
    ...
    const obj3 = { style: tmp.loadingContainer, children: closure_1_10(tmp2(5042).Ellipsis, { variant: "primary", size: "sm" }) };
