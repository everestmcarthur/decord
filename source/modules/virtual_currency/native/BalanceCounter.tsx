...
class BalanceCounter {
  constructor(arg0) {
    ...
    obj = { isAnimating: first, animatedValue: sharedValue, runOnJS: require("module_4296").runOnJS, setDisplayValue: tmp5, setMaxDigits: tmp7 };
    F.__closure = obj;
    ...
    if (null !== value) {
      ...
      tmp14 = closure_9(require("module_4296").View, obj1);
    }
    return tmp14;
  }
}
