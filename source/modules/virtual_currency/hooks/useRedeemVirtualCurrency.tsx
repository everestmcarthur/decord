...
// Dependencies: [5, 32, 19, 8951, 8952, 7317, 8945, 1114, 2]
// Exports: useRedeemVirtualCurrency

// Module 8950 (useRedeemVirtualCurrency)
...
export const useRedeemVirtualCurrency = function useRedeemVirtualCurrency(order) {
  ...
  enabled = entitlements(8951).useConfig({ location: "orb_checkout_modal" }).enabled;
  order = undefined;
  if (order != null) {
    order = order.order;
  }
            ...
            if (1 === tmp8) {
              if (arg0 === 1) {
                ...
                if ("signed" === closure_131_3.type) {
                  ...
                  v4 = 4;
                  c8 = 1;
                  const obj9 = { value: skuId(7317).fetchOrderEntitlementsWithRetry(closure_131_3.order.id), done: false };
                  return obj9;
                } else {
                  tmp4(false);
                  c8 = 3;
              ...
              if (3 === tmp8) {
                ...
                if (0 === closure_131_4.length) {
                  const orderProcessingPendingError = new skuId(7317).OrderProcessingPendingError();
