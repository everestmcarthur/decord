...
// Dependencies: [19, 1074, 1085, 21, 13229, 11114, 5023, 13230, 11352, 10878, 1242, 13231, 4808, 8486, 8487, 11997, 38, 1256, 1114, 5674, 11999, 2]
// Exports: default

// Module 13228 (OrbCheckoutModal)
...
import OrbCheckoutModalContext from "OrbCheckoutModalContext" /* 13229 */;
import OrbCheckoutModalComponents from "OrbCheckoutModalComponents" /* 13230 */;
import "module_19";
...
function OrbCheckoutModalContent(orbBalance) {
  ...
  if (tmp6) {
    ...
    tmp6 = closure_1_11(tmp(13230).OrbCheckoutErrorCard, obj3);
  }
  const items = [tmp6, , ];
  if (product == null) {
    product = null;
...
function OrbCheckoutModalScreen(startTime) {
  ...
  let ref;
  const orbCheckoutModalContext = onRedeemVirtualCurrency(13229).useOrbCheckoutModalContext();
  ...
  let obj = onRedeemVirtualCurrency(13229);
  const orbCheckoutModalContext1 = onRedeemVirtualCurrency(13229).useOrbCheckoutModalContext();
  ...
  dependencyMap = tmp7;
  let obj2 = onRedeemVirtualCurrency(13229);
  const tmp6 = closure_6;
  const virtualCurrencyBalance = onRedeemVirtualCurrency(13231).useVirtualCurrencyBalance();
  ...
  let obj3 = onRedeemVirtualCurrency(13231);
  const obj4 = { children: null };
  const tmp6Result = tmp6(() => {
    ...
    onRedeemVirtualCurrency(() => {
      ...
      orbRedemptionError(4808).pop();
    });
  }, items4);
  const items5 = [closure_11(onRedeemVirtualCurrency(8487).ModalContent, { children: closure_11(OrbCheckoutModalContent, { orbBalance: current }) }), ];
  let obj5 = { children: closure_11(OrbCheckoutModalContent, { orbBalance: current }) };
  items5[1] = closure_11(onRedeemVirtualCurrency(11997).ModalFooter, { children: closure_11(OrbCheckoutModalFooter, { onPress: tmp6Result }) });
  obj4.children = items5;
  return closure_12(onRedeemVirtualCurrency(8486).ModalScreen, obj4);
}
const size = fn(2);
