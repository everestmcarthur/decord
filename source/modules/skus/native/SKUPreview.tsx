...
// Function ID: 8902
// Name: SKUPreview
// Dependencies: [19, 17, 7653, 1074, 21, 4639, 8902, 576, 8291, 8927, 1890, 8940, 8929, 8952, 8954, 8955, 4341, 4350, 1370, 2]
// Exports: default

// Module 8901 (SKUPreview)
...
import WishlistItemCardBase from "WishlistItemCardBase" /* 8902 */;
...
function CollectiblesSKUPreview(sku) {
  ...
  if (DEFAULT_ITEM_SIZE === undefined) {
    DEFAULT_ITEM_SIZE = sku(8902).DEFAULT_ITEM_SIZE;
  }
  const items = [sku];
...
let closure_5 = fn(7653).transformSKUToCollectiblesItem;
...
let size = { width: fn(8902).DEFAULT_ITEM_SIZE, height: fn(8902).DEFAULT_ITEM_SIZE };
size = fn(2);
