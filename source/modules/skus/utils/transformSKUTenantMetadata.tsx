...
// Module 5600 (transformSKUTenantMetadata)
    ...
    if (null != collectibles) {
      ...
      if (null != item) {
        ...
        if (CollectiblesItemType.CollectiblesItemType.AVATAR_DECORATION === type) {
          ...
          tmp7 = obj20;
        } else if (tmp8(1890).CollectiblesItemType.NAMEPLATE === type) {
          ...
          tmp7 = obj22;
        } else if (tmp8(1890).CollectiblesItemType.PROFILE_EFFECT === type) {
          ...
          tmp7 = obj24;
        } else if (tmp8(1890).CollectiblesItemType.PROFILE_FRAME === type) {
