...
// Dependencies: [19, 4566, 10127, 21, 4574, 10139, 504, 1178, 1114, 4807, 10173, 7696, 4285, 4777, 4585, 10174, 1896, 10202, 10206, 2]

// Module 10138 (MessageNotification)
...
export default noop.memo(function MessageNotification(notification) {
  ...
  const callback1 = guild.useCallback(() => ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10174, dependencyMap.paths), { channelId: channel.id }, "in-app-notification-settings-modal"), items3);
