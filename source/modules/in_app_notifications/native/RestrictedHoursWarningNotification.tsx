...
// Dependencies: [19, 17, 10187, 1074, 21, 4607, 576, 11416, 4810, 10188, 7456, 10261, 4603, 2]

// Module 11415 (RestrictedHoursWarningNotification)
...
const lineClamp = fn(10187).NOTIFICATION_PREVIEW_LINE_CLAMP;
...
export default noop.memo(function RestrictedHoursWarningNotification(notification) {
  ...
  let obj = { style: closure_9().iconContainer, children: jsx(notification(11416).ThemeDarkIcon, { size: "sm", color: type(576).colors.WHITE }) };
  ...
  const obj3 = { icon: <View style={closure_9().iconContainer}>{jsx(notification(11416).ThemeDarkIcon, { size: "sm", color: type(576).colors.WHITE })}</View>, header: memo, children: jsx(notification(4603).Text, { variant: "redesign/message-preview/medium", color: "text-subtle", lineClamp, children: notification.subtitle }), onPress: callback, notification };
  return jsx(notification(10261).NotificationPressable, { icon: <View style={closure_9().iconContainer}>{jsx(notification(11416).ThemeDarkIcon, { size: "sm", color: type(576).colors.WHITE })}</View>, header: memo, children: jsx(notification(4603).Text, { variant: "redesign/message-preview/medium", color: "text-subtle", lineClamp, children: notification.subtitle }), onPress: callback, notification });
});
