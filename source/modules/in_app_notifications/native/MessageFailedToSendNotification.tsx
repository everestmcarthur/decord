...
// Dependencies: [19, 17, 21, 4605, 576, 1114, 4616, 4536, 10240, 10250, 10177, 2]

// Module 10249 (MessageFailedToSendNotification)
...
export default noop.memo(function MessageFailedToSendNotification(notification) {
  ...
  const tmp = closure_6();
  obj3.children = jsx(channelId(10250).RetryIcon, { size: "md", color: messageId(576).colors.ICON_SUBTLE });
  ...
  obj2.children = jsx(channelId(10177).SystemMessageText, { text: null });
  obj2.header = obj;
  obj2.onPress = callback;
  obj2.notification = notification;
  return jsx(channelId(10240).NotificationPressable, { icon: null, children: null, header: null, onPress: null, notification: null });
});
