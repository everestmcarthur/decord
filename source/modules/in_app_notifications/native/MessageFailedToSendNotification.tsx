...
// Dependencies: [19, 17, 21, 4606, 576, 1114, 4617, 4537, 10259, 10269, 10196, 2]

// Module 10268 (MessageFailedToSendNotification)
...
export default noop.memo(function MessageFailedToSendNotification(notification) {
  ...
  const tmp = closure_6();
  obj3.children = jsx(channelId(10269).RetryIcon, { size: "md", color: messageId(576).colors.ICON_SUBTLE });
  ...
  obj2.children = jsx(channelId(10196).SystemMessageText, { text: null });
  obj2.header = obj;
  obj2.onPress = callback;
  obj2.notification = notification;
  return jsx(channelId(10259).NotificationPressable, { icon: null, children: null, header: null, onPress: null, notification: null });
});
