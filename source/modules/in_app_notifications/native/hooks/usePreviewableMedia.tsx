...
// Dependencies: [19, 17, 1074, 21, 4574, 4275, 576, 8484, 10164, 10167, 4724, 10169, 7316, 2]
// Exports: usePreviewableMedia

// Module 10163 (usePreviewableMedia)
...
import WaveformIcon from "WaveformIcon" /* 10167 */;
        ...
        if (obj.isImageFile(filename)) {
          ...
          if (tmp8Result.isVideoFile(tmp7)) {
            ...
            if (tmp8Result2.isAudioFile(tmp7)) {
              ...
              obj5.media = tmp6;
              obj5.icon = React5(tmp8(10164).CirclePlayIcon, { size: "lg", color: "background-brand", secondaryColor: "white" });
              let str5 = null;
              if (isForward) {
                str5 = "forward";
              }
              ...
              obj5.icon = React5(tmp8(10169).FileIcon, obj6);
              let str4 = null;
              if (isForward) {
                str4 = "forward";
              }
