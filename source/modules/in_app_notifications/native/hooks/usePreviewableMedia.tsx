...
// Dependencies: [19, 17, 1074, 21, 4606, 4308, 576, 8542, 10221, 10224, 4756, 10226, 7375, 2]
// Exports: usePreviewableMedia

// Module 10220 (usePreviewableMedia)
...
import WaveformIcon from "WaveformIcon" /* 10224 */;
        ...
        if (obj.isImageFile(filename)) {
          ...
          if (tmp8Result.isVideoFile(tmp7)) {
            ...
            if (tmp8Result2.isAudioFile(tmp7)) {
              ...
              obj5.media = tmp6;
              obj5.icon = React5(tmp8(10221).CirclePlayIcon, { size: "lg", color: "background-brand", secondaryColor: "white" });
              let str5 = null;
              if (isForward) {
                str5 = "forward";
              }
              ...
              obj5.icon = React5(tmp8(10226).FileIcon, obj6);
              let str4 = null;
              if (isForward) {
                str4 = "forward";
              }
