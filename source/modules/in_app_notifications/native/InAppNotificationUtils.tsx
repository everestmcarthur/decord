...
// Dependencies: [19, 10234, 1074, 12, 1255, 1365, 1091, 7412, 4818, 2]
...
// Module 10233 (InAppNotificationUtils)
...
require = fn;
const REACTION_MILESTONE_COUNTS = fn(10234).REACTION_MILESTONE_COUNTS;
