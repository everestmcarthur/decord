...
// Dependencies: [19, 10165, 1074, 12, 1256, 1116, 1090, 7354, 4785, 2]
...
// Module 10164 (InAppNotificationUtils)
...
require = fn;
const REACTION_MILESTONE_COUNTS = fn(10165).REACTION_MILESTONE_COUNTS;
