...
// Dependencies: [19, 10245, 1074, 12, 1255, 1365, 1091, 7416, 4820, 2]
...
// Module 10244 (InAppNotificationUtils)
...
require = fn;
const REACTION_MILESTONE_COUNTS = fn(10245).REACTION_MILESTONE_COUNTS;
