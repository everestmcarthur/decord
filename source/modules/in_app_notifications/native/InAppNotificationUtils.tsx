...
// Dependencies: [19, 10187, 1074, 12, 1256, 1116, 1090, 7376, 4787, 2]
...
// Module 10186 (InAppNotificationUtils)
...
require = fn;
const REACTION_MILESTONE_COUNTS = fn(10187).REACTION_MILESTONE_COUNTS;
