...
// Dependencies: [19, 17, 1958, 10234, 1085, 21, 4638, 1365, 576, 10246, 10247, 10233, 4634, 5673, 10269, 4871, 10277, 10278, 1096, 7412, 1115, 7995, 2]
// Exports: default

// Module 10245 (MessagePreviewText)
...
import useTruncatedGradientColorsDefault from "useTruncatedGradientColors" /* 10246 */;
import ChannelRowPreview from "ChannelRowPreview" /* 10247 */;
import usePreviewableMedia from "usePreviewableMedia" /* 10269 */;
import usePreviewableMediaText from "usePreviewableMediaText" /* 10277 */;
import useGetInitialMessagePreview from "useGetInitialMessagePreview" /* 10278 */;
...
export default function MessagePreviewText(message) {
  ...
  if (memo.length > 0) {
    ...
    if (tmp29) {
      tmp29 = previewableMedia[0].type === tmp(10269).PreviewableMediaTypes.GIF;
    }
    ...
    if (null != nullableMessageAuthor) {
      ...
      tmp(10233);
      if (null != channel) {
        const obj10 = { channel, message, color: "text-default", layout: tmp(7995).ChannelListLayoutTypes.COZY, variant: tmp24, muted: false, lineClamp };
        return React6(tmp(10247).ChannelRowPreview, obj10);
      }
    }
    ...
    if (previewableMedia.length > 0) {
      if (null !== text) {
        ...
        if (tmp17Result) {
          ...
          tmp17Result = React6(tmp(4634).Text, obj13);
        }
    ...
    if (null != message.poll) {
      ...
      items3[1] = React6(tmp(4634).Text, obj18);
