...
// Dependencies: [19, 17, 1958, 10226, 1085, 21, 4639, 1365, 576, 10238, 10239, 10225, 4635, 5672, 10261, 4872, 10269, 10270, 1096, 7409, 1115, 7986, 2]
// Exports: default
...
export default function MessagePreviewText(message) {
  ...
  if (memo.length > 0) {
    ...
    if (tmp29) {
      tmp29 = previewableMedia[0].type === tmp(10261).PreviewableMediaTypes.GIF;
    }
    ...
    if (null != nullableMessageAuthor) {
      ...
      tmp(10225);
      if (null != channel) {
        const obj10 = { channel, message, color: "text-default", layout: tmp(7986).ChannelListLayoutTypes.COZY, variant: tmp24, muted: false, lineClamp };
        return React6(tmp(10239).ChannelRowPreview, obj10);
      }
    }
    ...
    if (previewableMedia.length > 0) {
      if (null !== text) {
        ...
        if (tmp17Result) {
          ...
          tmp17Result = React6(tmp(4635).Text, obj13);
        }
    ...
    if (null != message.poll) {
      ...
      items3[1] = React6(tmp(4635).Text, obj18);
