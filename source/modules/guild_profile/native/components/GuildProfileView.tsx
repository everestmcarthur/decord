...
// Dependencies: [19, 17, 1980, 1074, 21, 4430, 4432, 4722, 576, 504, 1972, 1478, 1397, 9429, 4656, 4423, 9430, 5156, 9431, 4718, 9433, 9440, 2]
// Exports: default, getBackgroundForProfile

// Module 9428 (GuildProfileView)
...
import guild_profile_GuildProfileUtils from "guild_profile/GuildProfileUtils" /* 9430 */;
import GuildProfileHeaderDefault from "GuildProfileHeader" /* 9431 */;
import GuildProfileGamesDefault from "GuildProfileGames" /* 9433 */;
import GuildProfileTraitsDefault from "GuildProfileTraits" /* 9440 */;
...
function GuildProfileBackground(guildProfile) {
  ...
  if (stateFromStores) {
    if (null != guildProfile.customBanner) {
      ...
      obj2.size = tmp3(9429)() * useWindowDimensionsDefault().width;
...
export default function GuildProfileView(guildProfile) {
  ...
  if (tmp5Result) {
    ...
    tmp5Result = tmp5(guildProfile(4718).Text, obj3);
  }
