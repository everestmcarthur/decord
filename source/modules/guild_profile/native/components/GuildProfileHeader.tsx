...
// Dependencies: [19, 17, 2026, 502, 2022, 9348, 21, 4640, 576, 504, 7857, 11, 1972, 8899, 8898, 4338, 4607, 7456, 5672, 4636, 5210, 8896, 1115, 2]
// Exports: default

// Module 9347 (GuildProfileHeader)
...
const getBadgeTooltip = fn(9348).getBadgeTooltip;
const jsxProd = fn(21);
