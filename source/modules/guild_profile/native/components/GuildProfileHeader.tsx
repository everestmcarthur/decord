...
// Dependencies: [19, 17, 2026, 502, 2022, 9326, 21, 4639, 576, 504, 7842, 11, 1972, 8872, 8871, 4338, 4606, 7449, 5669, 4635, 5207, 8869, 1115, 2]
// Exports: default

// Module 9325 (GuildProfileHeader)
...
const getBadgeTooltip = fn(9326).getBadgeTooltip;
const jsxProd = fn(21);
