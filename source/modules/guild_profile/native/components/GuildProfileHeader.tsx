...
// Dependencies: [19, 17, 2025, 502, 2021, 9263, 21, 4605, 576, 504, 7788, 11, 1971, 8813, 8812, 4303, 4572, 7394, 5634, 4601, 5173, 8810, 1114, 2]
// Exports: default

// Module 9262 (GuildProfileHeader)
...
const getBadgeTooltip = fn(9263).getBadgeTooltip;
const jsxProd = fn(21);
