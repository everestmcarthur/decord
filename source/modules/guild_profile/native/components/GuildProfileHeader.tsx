...
// Dependencies: [19, 17, 2026, 502, 2022, 9432, 21, 4722, 576, 504, 7939, 11, 1972, 8983, 8982, 4420, 4689, 7538, 5754, 4718, 5292, 8980, 1115, 2]
// Exports: default

// Module 9431 (GuildProfileHeader)
...
const getBadgeTooltip = fn(9432).getBadgeTooltip;
const jsxProd = fn(21);
