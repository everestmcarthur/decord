...
// Dependencies: [19, 17, 2025, 502, 2021, 9286, 21, 4607, 576, 504, 7810, 11, 1971, 8836, 8835, 4305, 4574, 7416, 5636, 4603, 5175, 8833, 1114, 2]
// Exports: default

// Module 9285 (GuildProfileHeader)
...
const getBadgeTooltip = fn(9286).getBadgeTooltip;
const jsxProd = fn(21);
