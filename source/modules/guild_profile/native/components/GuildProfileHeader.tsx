...
// Dependencies: [19, 17, 2026, 502, 2022, 9337, 21, 4638, 576, 504, 7851, 11, 1972, 8883, 8882, 4336, 4605, 7452, 5670, 4634, 5208, 8880, 1115, 2]
// Exports: default

// Module 9336 (GuildProfileHeader)
...
const getBadgeTooltip = fn(9337).getBadgeTooltip;
const jsxProd = fn(21);
