...
// Dependencies: [19, 17, 21, 4373, 4640, 11486, 4637, 5660, 11491, 11493, 7259, 11494, 2]
// Exports: default
...
let obj = { duration: fn(4640).timingStandardDuration, easing: Easing.bezier(0.2, 0, 0, 1) };
