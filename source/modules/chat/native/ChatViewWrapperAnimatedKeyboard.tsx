...
// Dependencies: [19, 17, 21, 4376, 4643, 11490, 4640, 5664, 11495, 11497, 7263, 11498, 2]
// Exports: default

// Module 11489 (ChatViewWrapperAnimatedKeyboard)
import timing from "timing" /* 4640 */;
import useCustomKeyboardHeightDefault from "useCustomKeyboardHeight" /* 5664 */;
...
let obj = { duration: fn(4643).timingStandardDuration, easing: Easing.bezier(0.2, 0, 0, 1) };
