...
// Dependencies: [32, 19, 17, 4631, 5362, 4860, 2012, 1372, 1896, 1074, 21, 4639, 576, 4984, 5078, 1897, 504, 4635, 13406, 4376, 4640, 1115, 5207, 2]
// Exports: ChannelHeaderLoadingIndicator, useShouldChannelShowLoadingIndicator

// Module 13405 (ChatLoadingIndicator)
...
let closure_18 = noop.memo(() => {
  ...
  if (messagesCached !== false) {
    ...
    tmp4Result = tmp4(tmp(4635).Text, obj3);
  }
  items1[4] = tmp4Result;
  ...
  if (messagesReady !== true) {
    ...
    tmp4Result3 = tmp4(tmp(4635).Text, obj5);
  }
  ...
  if (connected !== true) {
    ...
    tmp4Result4 = tmp4(tmp(4635).Text, obj7);
  }
...
export const ChannelHeaderLoadingIndicator = function ChannelHeaderLoadingIndicator() {
  ...
  fn.__closure = { useReducedMotion: stateFromStores, withRepeat: stateFromStores(4376).withRepeat, withSequence: stateFromStores(4376).withSequence, withTiming: stateFromStores(4640).withTiming, Easing: stateFromStores(4376).Easing };
