...
// Dependencies: [32, 19, 17, 4630, 5363, 4859, 2012, 1372, 1896, 1074, 21, 4638, 576, 4983, 5079, 1897, 504, 4634, 13417, 4374, 4639, 1115, 5208, 2]
// Exports: ChannelHeaderLoadingIndicator, useShouldChannelShowLoadingIndicator

// Module 13416 (ChatLoadingIndicator)
...
let closure_18 = noop.memo(() => {
  ...
  if (messagesCached !== false) {
    ...
    tmp4Result = tmp4(tmp(4634).Text, obj3);
  }
  items1[4] = tmp4Result;
  ...
  if (messagesReady !== true) {
    ...
    tmp4Result3 = tmp4(tmp(4634).Text, obj5);
  }
  ...
  if (connected !== true) {
    ...
    tmp4Result4 = tmp4(tmp(4634).Text, obj7);
  }
...
export const ChannelHeaderLoadingIndicator = function ChannelHeaderLoadingIndicator() {
  ...
  let obj3 = stateFromStores(4374);
  fn.__closure = { useReducedMotion: stateFromStores, withRepeat: stateFromStores(4374).withRepeat, withSequence: stateFromStores(4374).withSequence, withTiming: stateFromStores(4639).withTiming, Easing: stateFromStores(4374).Easing };
  ...
  items3[1] = closure_13(stateFromStores(4634).Text, obj7);
  obj5.children = items3;
  const tmp8 = closure_14(View, obj5);
  let tmp7Result = tmp8;
  if (stateFromStores1) {
    let obj8 = { onPress: openLoadingIndicatorDebugBody, children: tmp8 };
    tmp7Result = closure_13(tmp2(5208).PressableOpacity, obj8);
  }
  return tmp7Result;
};
