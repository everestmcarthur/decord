...
// Dependencies: [32, 19, 17, 4714, 5447, 4943, 2012, 1372, 1896, 1074, 21, 4722, 576, 5067, 5163, 1897, 504, 4718, 13516, 4458, 4723, 1115, 5292, 2]
// Exports: ChannelHeaderLoadingIndicator, useShouldChannelShowLoadingIndicator

// Module 13515 (ChatLoadingIndicator)
...
let closure_18 = noop.memo(() => {
  ...
  if (messagesCached !== false) {
    ...
    tmp4Result = tmp4(tmp(4718).Text, obj3);
  }
  items1[4] = tmp4Result;
  ...
  if (messagesReady !== true) {
    ...
    tmp4Result3 = tmp4(tmp(4718).Text, obj5);
  }
  ...
  if (connected !== true) {
    ...
    tmp4Result4 = tmp4(tmp(4718).Text, obj7);
  }
...
export const ChannelHeaderLoadingIndicator = function ChannelHeaderLoadingIndicator() {
  ...
  let obj3 = stateFromStores(4458);
  fn.__closure = { useReducedMotion: stateFromStores, withRepeat: stateFromStores(4458).withRepeat, withSequence: stateFromStores(4458).withSequence, withTiming: stateFromStores(4723).withTiming, Easing: stateFromStores(4458).Easing };
  ...
  items3[1] = closure_13(stateFromStores(4718).Text, obj7);
  obj5.children = items3;
  const tmp8 = closure_14(View, obj5);
  let tmp7Result = tmp8;
  if (stateFromStores1) {
    let obj8 = { onPress: openLoadingIndicatorDebugBody, children: tmp8 };
    tmp7Result = closure_13(tmp2(5292).PressableOpacity, obj8);
  }
  return tmp7Result;
};
