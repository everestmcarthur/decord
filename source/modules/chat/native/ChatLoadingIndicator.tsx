...
// Dependencies: [32, 19, 17, 4632, 5365, 4861, 2012, 1372, 1896, 1074, 21, 4640, 576, 4985, 5081, 1897, 504, 4636, 13425, 4376, 4641, 1115, 5210, 2]
// Exports: ChannelHeaderLoadingIndicator, useShouldChannelShowLoadingIndicator

// Module 13424 (ChatLoadingIndicator)
...
let closure_18 = noop.memo(() => {
  ...
  if (messagesCached !== false) {
    ...
    tmp4Result = tmp4(tmp(4636).Text, obj3);
  }
  items1[4] = tmp4Result;
  ...
  if (messagesReady !== true) {
    ...
    tmp4Result3 = tmp4(tmp(4636).Text, obj5);
  }
  ...
  if (connected !== true) {
    ...
    tmp4Result4 = tmp4(tmp(4636).Text, obj7);
  }
...
export const ChannelHeaderLoadingIndicator = function ChannelHeaderLoadingIndicator() {
  ...
  fn.__closure = { useReducedMotion: stateFromStores, withRepeat: stateFromStores(4376).withRepeat, withSequence: stateFromStores(4376).withSequence, withTiming: stateFromStores(4641).withTiming, Easing: stateFromStores(4376).Easing };
  ...
  items3[1] = closure_13(stateFromStores(4636).Text, obj7);
  obj5.children = items3;
  const tmp8 = closure_14(View, obj5);
  let tmp7Result = tmp8;
  if (stateFromStores1) {
    let obj8 = { onPress: openLoadingIndicatorDebugBody, children: tmp8 };
    tmp7Result = closure_13(tmp2(5210).PressableOpacity, obj8);
  }
  return tmp7Result;
};
