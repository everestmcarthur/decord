...
// Dependencies: [17, 1364, 11410, 1231, 11411, 11412, 2]

// Module 11409 (NativeChatUtils)
import SentryUtilsDefault from "SentryUtils" /* 1231 */;
import PlatformUtils from "PlatformUtils" /* 1364 */;
import ChatNativeComponent from "ChatNativeComponent" /* 11410 */;
import NativeChatModuleDefault from "NativeChatModule" /* 11412 */;
...
export default {
  scrollTo(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp5(11410).Commands;
  ...
  scrollToBottom(arg0, arg1) {
    if (null != arg0) {
      if (obj.isIOS()) {
        ...
        const Commands = tmp2(11410).Commands;
  ...
  scrollIntoView(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp4(11410).Commands;
  ...
  updateRows(arg0, rows) {
    if (null != arg0) {
      if (obj6.isIOS()) {
        const andIncrementChangesetIdForChat = tmp31(11411).getAndIncrementChangesetIdForChat(arg0);
        ({ rows, forceReload } = rows);
        if (forceReload == null) {
          forceReload = false;
        }
        const tmp31Result = tmp31(11411);
        ...
        const Commands = tmp31(11410).Commands;
        const _JSON2 = JSON;
        ...
        if (null != tmp2) {
          ...
          const andIncrementChangesetIdForChat1 = tmp31(11411).getAndIncrementChangesetIdForChat(arg0);
          ...
          const tmp31Result2 = tmp31(11411);
        }
      }
      obj6 = PlatformUtils;
    }
  ...
  clearRows(arg0) {
    if (null != arg0) {
      if (obj4.isIOS()) {
        const Commands = tmp6(11410).Commands;
        Commands.clearRows(arg0, tmp6(11411).getAndIncrementChangesetIdForChat(arg0));
        const tmp6Result = tmp6(11411);
      } else {
        const tmp2 = React4(arg0);
        if (null != tmp2) {
          const obj = NativeChatModuleDefault;
          obj.clearRows(tmp2, tmp6(11411).getAndIncrementChangesetIdForChat(arg0));
          const tmp6Result2 = tmp6(11411);
        }
      }
      obj4 = PlatformUtils;
    }
