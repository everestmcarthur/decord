...
// Dependencies: [17, 1364, 11418, 1231, 11419, 11420, 2]

// Module 11417 (NativeChatUtils)
import SentryUtilsDefault from "SentryUtils" /* 1231 */;
import PlatformUtils from "PlatformUtils" /* 1364 */;
import ChatNativeComponent from "ChatNativeComponent" /* 11418 */;
import NativeChatModuleDefault from "NativeChatModule" /* 11420 */;
...
export default {
  scrollTo(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp5(11418).Commands;
  ...
  scrollToBottom(arg0, arg1) {
    if (null != arg0) {
      if (obj.isIOS()) {
        ...
        const Commands = tmp2(11418).Commands;
  ...
  scrollIntoView(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp4(11418).Commands;
  ...
  updateRows(arg0, rows) {
    if (null != arg0) {
      if (obj6.isIOS()) {
        const andIncrementChangesetIdForChat = tmp31(11419).getAndIncrementChangesetIdForChat(arg0);
        ({ rows, forceReload } = rows);
        if (forceReload == null) {
          forceReload = false;
        }
        const tmp31Result = tmp31(11419);
        ...
        const Commands = tmp31(11418).Commands;
        const _JSON2 = JSON;
        ...
        if (null != tmp2) {
          ...
          const andIncrementChangesetIdForChat1 = tmp31(11419).getAndIncrementChangesetIdForChat(arg0);
          ...
          const tmp31Result2 = tmp31(11419);
        }
      }
      obj6 = PlatformUtils;
    }
  ...
  clearRows(arg0) {
    if (null != arg0) {
      if (obj4.isIOS()) {
        const Commands = tmp6(11418).Commands;
        Commands.clearRows(arg0, tmp6(11419).getAndIncrementChangesetIdForChat(arg0));
        const tmp6Result = tmp6(11419);
      } else {
        const tmp2 = React4(arg0);
        if (null != tmp2) {
          const obj = NativeChatModuleDefault;
          obj.clearRows(tmp2, tmp6(11419).getAndIncrementChangesetIdForChat(arg0));
          const tmp6Result2 = tmp6(11419);
        }
      }
      obj4 = PlatformUtils;
    }
