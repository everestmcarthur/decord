...
// Dependencies: [4598, 1178, 504, 4343, 4607, 4610, 2]
// Exports: default

// Module 12732 (useChatPlaceholderAnimatedStyles)
...
require = fn;
let TIMING_CONFIG = { duration: 1300, easing: fn(1178).STANDARD_EASING };
