...
// Dependencies: [1957, 1074, 560, 1242, 2]
...
obj = { guildId: "ip", channelId: "isArray", channelType: "isArray", numMediaItems: "Array", hasMediaOptions: "call", source: "user", incrementableActions: "HermesInternal" };
...
const result = require("set").fileFinishedImporting("modules/media_viewer/MediaViewerAnalyticsManager.tsx");
