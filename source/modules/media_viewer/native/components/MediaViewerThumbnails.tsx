...
// Dependencies: [32, 19, 17, 8413, 21, 13100, 4341, 576, 4376, 5049, 1364, 4639, 5672, 8386, 4377, 7179, 2]
// Exports: default

// Module 13099 (MediaViewerThumbnails)
...
function ObscuredView(source) {
  ...
  if (tmp4) {
    if (source.spoiler) {
      ...
      tmp10Result = tmp10(tmp7(4376).View, obj2);
