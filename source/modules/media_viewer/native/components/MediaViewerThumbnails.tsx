...
// Dependencies: [32, 19, 17, 8422, 21, 13108, 4339, 576, 4374, 5048, 1364, 4638, 5673, 8395, 4375, 7182, 2]
// Exports: default

// Module 13107 (MediaViewerThumbnails)
...
function ObscuredView(source) {
  ...
  if (tmp4) {
    if (source.spoiler) {
      ...
      tmp10Result = tmp10(tmp7(4374).View, obj2);
