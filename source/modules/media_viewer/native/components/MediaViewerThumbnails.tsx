...
// Dependencies: [32, 19, 17, 8320, 21, 12994, 4275, 576, 4310, 4979, 1115, 4574, 5601, 8293, 4311, 7086, 2]
// Exports: default

// Module 12993 (MediaViewerThumbnails)
...
function ObscuredView(source) {
  ...
  if (tmp4) {
    if (source.spoiler) {
      ...
      tmp10Result = tmp10(tmp7(4310).View, obj2);
