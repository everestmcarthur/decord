...
// Dependencies: [19, 21, 10518, 10514, 4338, 1115, 10529, 10516, 1221, 8414, 8518, 10382, 576, 10388, 2]

// Module 13118 (MediaViewerOverlayButtonFavoriteGIF)
...
export default noop.memo(function GIFFavButton(source) {
  ...
  const callback = noop.useCallback(() => {
    if (isFavoriteGIF) {
      tmp(10514).removeFavoriteGIF(uri);
      const tmpResult = tmp(10514);
      ...
      const gIFThumbnailForFavorite = tmp(10516).getGIFThumbnailForFavorite({ providerName: null, thumbnail: null });
      const obj6 = { providerName: null, thumbnail: null };
      const tmpResult2 = tmp(10516);
