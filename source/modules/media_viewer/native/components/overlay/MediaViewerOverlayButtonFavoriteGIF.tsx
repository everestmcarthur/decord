...
// Dependencies: [19, 21, 10612, 10608, 4420, 1115, 10623, 10610, 1221, 8497, 8601, 10476, 576, 10482, 2]

// Module 13209 (MediaViewerOverlayButtonFavoriteGIF)
...
export default noop.memo(function GIFFavButton(source) {
  ...
  const callback = noop.useCallback(() => {
    if (isFavoriteGIF) {
      tmp(10608).removeFavoriteGIF(uri);
      const tmpResult = tmp(10608);
      ...
      const gIFThumbnailForFavorite = tmp(10610).getGIFThumbnailForFavorite({ providerName: null, thumbnail: null });
      const obj6 = { providerName: null, thumbnail: null };
      const tmpResult2 = tmp(10610);
