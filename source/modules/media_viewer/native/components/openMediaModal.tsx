...
// Function ID: 8346
// Name: openMediaModal
// Dependencies: [32, 5, 4297, 1074, 1477, 8346, 1896, 8347, 8348, 38, 4573, 8374, 4809, 8375, 2]
// Exports: openMediaModal

// Module 8345 (openMediaModal)
import _slicedToArray from "module_32" /* 32 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import ActionSheetStore from "ActionSheetStore" /* 4297 */;

const require = fn;
let closure_7 = async function _openMediaModal(arg0, value) {
  if (c4 === 2) {
    c4 = 3;
    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (arg0 === 1) {
          ...
          c3 = 2;
          c4 = 1;
          let obj6 = { value: Promise.all(items), done: false };
          return obj6;
        }
      } else if (arg0 === 1) {
        c4 = 3;
