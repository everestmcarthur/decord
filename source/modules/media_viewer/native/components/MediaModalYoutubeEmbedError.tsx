...
// Dependencies: [19, 17, 21, 4606, 576, 9692, 4602, 1114, 5026, 4301, 2]

// Module 13070 (MediaModalYoutubeEmbedError)
...
export default noop.memo(function MediaModalYoutubeEmbedError(videoId) {
  ...
  const items = [closure_4(videoId(9692).StreamFailed, { resizeMode: "contain" }), , ];
  ...
  items[1] = closure_4(videoId(4602).Text, obj2);
  ...
  items[2] = closure_4(videoId(5026).Button, obj3);
  obj.children = items;
