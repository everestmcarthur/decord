...
// Dependencies: [19, 17, 21, 4605, 576, 9671, 4601, 1114, 5025, 4299, 2]

// Module 13047 (MediaModalYoutubeEmbedError)
...
export default noop.memo(function MediaModalYoutubeEmbedError(videoId) {
  ...
  const items = [closure_4(videoId(9671).StreamFailed, { resizeMode: "contain" }), , ];
  ...
  items[1] = closure_4(videoId(4601).Text, obj2);
  ...
  items[2] = closure_4(videoId(5025).Button, obj3);
  obj.children = items;
