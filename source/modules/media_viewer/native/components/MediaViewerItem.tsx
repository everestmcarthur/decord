...
// Dependencies: [32, 19, 17, 21, 1364, 4505, 13119, 13120, 8386, 8385, 11796, 8381, 6760, 13121, 9746, 2]

// Module 13118 (MediaViewerItem)
import PlatformUtils2 from "PlatformUtils" /* 1364 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6760 */;
import useMediaViewerSources from "useMediaViewerSources" /* 8381 */;
import useEntranceAnimation from "useEntranceAnimation" /* 13120 */;
...
export const MediaViewerItem = noop.memo((index) => {
  ...
  const memo = obj.useMemo(() => {
    ...
    const Gesture2 = tmp(6760).Gesture;
    ...
    const Gesture5 = tmp(6760).Gesture;
    ...
    const Gesture6 = tmp(6760).Gesture;
