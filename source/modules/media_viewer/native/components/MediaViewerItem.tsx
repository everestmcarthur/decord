...
// Dependencies: [32, 19, 17, 21, 1364, 4504, 13130, 13131, 8395, 8394, 11804, 8390, 6763, 13132, 9754, 2]

// Module 13129 (MediaViewerItem)
import PlatformUtils2 from "PlatformUtils" /* 1364 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6763 */;
import useMediaViewerSources from "useMediaViewerSources" /* 8390 */;
import useEntranceAnimation from "useEntranceAnimation" /* 13131 */;
...
export const MediaViewerItem = noop.memo((index) => {
  ...
  const memo = obj.useMemo(() => {
    ...
    const Gesture2 = tmp(6763).Gesture;
    ...
    const Gesture5 = tmp(6763).Gesture;
    ...
    const Gesture6 = tmp(6763).Gesture;
