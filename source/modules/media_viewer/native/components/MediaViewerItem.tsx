...
// Dependencies: [32, 19, 17, 21, 1115, 4472, 13078, 13079, 8353, 8352, 11757, 8348, 6727, 13080, 9707, 2]

// Module 13077 (MediaViewerItem)
...
import useEntranceAnimation from "useEntranceAnimation" /* 13079 */;
...
export const MediaViewerItem = noop.memo((index) => {
  ...
  const memo = obj.useMemo(() => {
    ...
    const Gesture2 = tmp(6727).Gesture;
    ...
    const Gesture5 = tmp(6727).Gesture;
    ...
    const Gesture6 = tmp(6727).Gesture;
