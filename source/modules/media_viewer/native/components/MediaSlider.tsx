...
// Function ID: 8360
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4606, 1115, 5649, 12, 672, 5219, 5174, 1114, 8360, 8362, 4602, 8364, 8373, 576, 2]
// Exports: default

// Module 8359 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5649)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5649)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
  ...
  obj2.style = items3;
  const timeFormat = controls(5219).getTimeFormat(tmp3);
  ...
  if (paused) {
    let PauseIcon = tmp16(8360).PlayIcon;
  } else {
    PauseIcon = tmp16(8362).PauseIcon;
  }
  obj3.children = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5174).PressableOpacity, obj3), , , ];
  ...
  obj4.style = items5;
  items4[1] = closure_6(controls(4602).Text, obj4);
  ...
  let obj = controls(5219);
  const tmp9Result = paused(8364);
  ...
  items7[1] = closure_6(paused(8364), obj11);
  ...
  const tmp9Result4 = paused(8364);
  obj13.children = controls(5219).getTimeFormat(ref.current);
  items4[3] = closure_6(controls(4602).Text, obj13);
