...
// Function ID: 8362
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4607, 1115, 5650, 12, 672, 5220, 5175, 1114, 8362, 8364, 4603, 8366, 8375, 576, 2]
// Exports: default

// Module 8361 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5650)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5650)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
  ...
  obj2.style = items3;
  const timeFormat = controls(5220).getTimeFormat(tmp3);
  ...
  if (paused) {
    let PauseIcon = tmp16(8362).PlayIcon;
  } else {
    PauseIcon = tmp16(8364).PauseIcon;
  }
  obj3.children = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5175).PressableOpacity, obj3), , , ];
  ...
  obj4.style = items5;
  items4[1] = closure_6(controls(4603).Text, obj4);
  ...
  let obj = controls(5220);
  const tmp9Result = paused(8366);
  ...
  items7[1] = closure_6(paused(8366), obj11);
  ...
  const tmp9Result4 = paused(8366);
  obj13.children = controls(5220).getTimeFormat(ref.current);
  items4[3] = closure_6(controls(4603).Text, obj13);
