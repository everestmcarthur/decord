...
// Function ID: 8339
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4605, 1115, 5648, 12, 672, 5218, 5173, 1114, 8339, 8341, 4601, 8343, 8352, 576, 2]
// Exports: default

// Module 8338 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5648)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5648)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
  ...
  obj2.style = items3;
  const timeFormat = controls(5218).getTimeFormat(tmp3);
  ...
  if (paused) {
    let PauseIcon = tmp16(8339).PlayIcon;
  } else {
    PauseIcon = tmp16(8341).PauseIcon;
  }
  obj3.children = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5173).PressableOpacity, obj3), , , ];
  ...
  obj4.style = items5;
  items4[1] = closure_6(controls(4601).Text, obj4);
  ...
  let obj = controls(5218);
  const tmp9Result = paused(8343);
  ...
  items7[1] = closure_6(paused(8343), obj11);
  ...
  const tmp9Result4 = paused(8343);
  obj13.children = controls(5218).getTimeFormat(ref.current);
  items4[3] = closure_6(controls(4601).Text, obj13);
