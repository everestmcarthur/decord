...
// Function ID: 8404
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4638, 1364, 5684, 12, 672, 5253, 5208, 1115, 8404, 8406, 4634, 8408, 8417, 576, 2]
// Exports: default

// Module 8403 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5684)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5684)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
  ...
  obj2.style = items3;
  const timeFormat = controls(5253).getTimeFormat(tmp3);
  ...
  if (paused) {
    let PauseIcon = tmp16(8404).PlayIcon;
  } else {
    PauseIcon = tmp16(8406).PauseIcon;
  }
  obj3.children = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5208).PressableOpacity, obj3), , , ];
  ...
  obj4.style = items5;
  items4[1] = closure_6(controls(4634).Text, obj4);
  ...
  let obj = controls(5253);
  const tmp9Result = paused(8408);
  ...
  items7[1] = closure_6(paused(8408), obj11);
  ...
  const tmp9Result4 = paused(8408);
  obj13.children = controls(5253).getTimeFormat(ref.current);
  items4[3] = closure_6(controls(4634).Text, obj13);
