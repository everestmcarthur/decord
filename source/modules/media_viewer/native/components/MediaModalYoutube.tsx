...
// Dependencies: [32, 19, 1074, 21, 8383, 8358, 8347, 8351, 13070, 1115, 2]
...
export default noop.memo((visible) => {
  ...
  noop = undefined;
  [playerState, dependencyMap] = noop.useState(visible(8383).PlayerState.UNREADY);
  ...
  let youtubeVideoIdFromURI = visible(8351).getYoutubeVideoIdFromURI(source.uri);
  if (youtubeVideoIdFromURI == null) {
    youtubeVideoIdFromURI = tmp2(8351).getYoutubeClipVideoIdFromURI(source.uri);
  ...
  if (null == youtubeVideoIdFromURI) {
    ...
    return tmp16(tmp7(8383), obj3, youtubeVideoIdFromURI.videoId);
  }
