...
// Dependencies: [32, 19, 17, 21, 4640, 576, 1364, 4341, 13116, 4376, 5050, 5168, 4636, 1115, 2]
...
export default noop.memo(function MediaModalSpoilerOverlay(source) {
  ...
  if (!tmp5[0]) {
    ...
    if (source.obscure) {
      ...
      items2[1] = tmp9(tmp(4636).Text, obj7);
      ...
      obj6.children = tmp9(tmp(4636).Text, obj8);
