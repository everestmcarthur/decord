...
// Dependencies: [32, 19, 17, 21, 4638, 576, 1364, 4339, 13108, 4374, 5048, 5166, 4634, 1115, 2]
...
export default noop.memo(function MediaModalSpoilerOverlay(source) {
  ...
  if (!tmp5[0]) {
    ...
    if (source.obscure) {
      ...
      items2[1] = tmp9(tmp(4634).Text, obj7);
      ...
      obj6.children = tmp9(tmp(4634).Text, obj8);
