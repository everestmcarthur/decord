...
// Dependencies: [32, 19, 17, 21, 4722, 576, 1364, 4423, 13207, 4458, 5132, 5250, 4718, 1115, 2]
...
export default noop.memo(function MediaModalSpoilerOverlay(source) {
  ...
  if (!tmp5[0]) {
    ...
    if (source.obscure) {
      ...
      items2[1] = tmp9(tmp(4718).Text, obj7);
      ...
      obj6.children = tmp9(tmp(4718).Text, obj8);
    ...
    React5(tmp3(4458).View, obj3);
    const tmp3Result = tmp3(5132);
  }
});
