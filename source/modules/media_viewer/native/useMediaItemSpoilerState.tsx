...
// Dependencies: [32, 19, 8413, 4376, 4641, 1177, 2]
// Exports: useMediaItemSpoilerState

// Module 13116 (useMediaItemSpoilerState)
...
export const useMediaItemSpoilerState = function useMediaItemSpoilerState(index) {
  mediaItemHasSpoiler = mediaItemHasSpoiler(8413).useMediaItemHasSpoiler(index);
  let obj = mediaItemHasSpoiler(8413);
  let obj2 = noop;
