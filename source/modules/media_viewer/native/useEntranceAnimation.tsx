...
// Dependencies: [32, 19, 1178, 560, 1249, 4606, 4341, 2]
// Exports: useEntranceAnimation

// Module 13054 (useEntranceAnimation)
...
export const useEntranceAnimation = function useEntranceAnimation(entranceAnimationDriver) {
  ...
  const handleError = noop.useCallback(() => {
    if (1 !== entranceAnimationDriver.get()) {
      ...
      const obj3 = timing;
      const fn = function t() {
        closure_0(4341).runOnJS(setUseEntranceAnimationState)({ isComplete: true });
        obj = closure_0(4341);
        closure_0(4341).runOnJS(incrementLoads)();
      };
