...
// Dependencies: [5, 502, 8160, 1074, 11, 7967, 8347, 1895, 1271, 7652, 8348, 573, 4952, 2, 4949]
...
export const interactionCallbackErrorReason = fn(4949).interactionCallbackErrorReason;
