...
// Dependencies: [32, 19, 21, 4607, 10460, 10374, 10470, 8966, 10413, 2]
// Exports: default

// Module 10469 (GIFPickerResultsList)
import GIFPickerItemView from "GIFPickerItemView" /* 10470 */;
...
let obj2 = { list: { marginHorizontal: -fn(10460).GIF_PICKER_GUTTER_SPACING / 2 } };
let closure_6 = createStyles.createStyles(obj2);
const obj4 = { length: 20 };
let obj3 = { marginHorizontal: -fn(10460).GIF_PICKER_GUTTER_SPACING / 2 };
...
export default function GIFPickerResultsList(columnWidth) {
  ...
  const tmp11 = require("module_8966");
  if (inActionSheet) {
