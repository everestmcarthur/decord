...
// Dependencies: [32, 19, 17, 1074, 21, 4605, 576, 10439, 6672, 4341, 4606, 4609, 8150, 7104, 1114, 7102, 10437, 5173, 10445, 4601, 2]
...
obj.headerContainer = { flexDirection: "row", justifyContent: "space-between", gap: fn(10439).GIF_PICKER_GUTTER_SPACING };
let obj4 = { flexDirection: "row", justifyContent: "space-between", gap: fn(10439).GIF_PICKER_GUTTER_SPACING };
...
let obj5 = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6672).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
const size = fn(2);
...
export default noop.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(7102).SearchField, obj2);
  } else {
    ...
    const items = [tmp6(tmp2(10445).ChevronLargeLeftIcon, obj6), ];
    ...
    items[1] = tmp6(tmp2(4601).Text, obj7);
    obj4.children = items;
    const items1 = [React7(tmp2(5173).PressableOpacity, obj4), ];
