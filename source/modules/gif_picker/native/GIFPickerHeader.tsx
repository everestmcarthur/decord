...
// Dependencies: [32, 19, 17, 1074, 21, 4606, 576, 10458, 6693, 4343, 4607, 4610, 8172, 7125, 1114, 7123, 10456, 5174, 10464, 4602, 2]

// Module 10463 (GIFPickerHeader)
...
obj.headerContainer = { flexDirection: "row", justifyContent: "space-between", gap: fn(10458).GIF_PICKER_GUTTER_SPACING };
let obj4 = { flexDirection: "row", justifyContent: "space-between", gap: fn(10458).GIF_PICKER_GUTTER_SPACING };
obj.header = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6693).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
...
let obj5 = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6693).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
const size = fn(2);
...
export default noop.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(7123).SearchField, obj2);
  } else {
    ...
    const items = [tmp6(tmp2(10464).ChevronLargeLeftIcon, obj6), ];
    ...
    items[1] = tmp6(tmp2(4602).Text, obj7);
    obj4.children = items;
    const items1 = [React7(tmp2(5174).PressableOpacity, obj4), ];
