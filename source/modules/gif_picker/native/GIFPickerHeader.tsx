...
// Dependencies: [32, 19, 17, 1074, 21, 4607, 576, 10460, 6694, 4343, 4608, 4611, 8173, 7126, 1114, 7124, 10458, 5175, 10466, 4603, 2]

// Module 10465 (GIFPickerHeader)
...
obj.headerContainer = { flexDirection: "row", justifyContent: "space-between", gap: fn(10460).GIF_PICKER_GUTTER_SPACING };
let obj4 = { flexDirection: "row", justifyContent: "space-between", gap: fn(10460).GIF_PICKER_GUTTER_SPACING };
obj.header = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6694).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
...
let obj5 = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6694).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
const size = fn(2);
...
export default noop.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(7124).SearchField, obj2);
  } else {
    ...
    const items = [tmp6(tmp2(10466).ChevronLargeLeftIcon, obj6), ];
    ...
    items[1] = tmp6(tmp2(4603).Text, obj7);
    obj4.children = items;
    const items1 = [React7(tmp2(5175).PressableOpacity, obj4), ];
