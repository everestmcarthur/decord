...
// Dependencies: [19, 17, 21, 4722, 10611, 576, 1875, 4689, 10622, 1897, 1115, 5292, 5757, 2]
// Exports: default

// Module 10621 (GIFPickerItemView)
...
export default function GIFPickerItemView(onPressGIF) {
  ...
  const callback1 = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10622, dependencyMap.paths), "GIFPickerItemActionSheet", { item }, "stack");
    const obj2 = { item };
    const result = KeyboardManagerUtils.dismissGlobalKeyboard();
  }, items1);
