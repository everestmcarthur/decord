...
// Dependencies: [19, 17, 21, 4639, 10501, 576, 1875, 4606, 10512, 1897, 1115, 5207, 5672, 2]
// Exports: default

// Module 10511 (GIFPickerItemView)
...
export default function GIFPickerItemView(onPressGIF) {
  ...
  const callback1 = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10512, dependencyMap.paths), "GIFPickerItemActionSheet", { item }, "stack");
    const obj2 = { item };
    const result = KeyboardManagerUtils.dismissGlobalKeyboard();
  }, items1);
