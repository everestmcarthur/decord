...
// Dependencies: [19, 17, 4629, 21, 4605, 504, 5151, 576, 4601, 2]
// Exports: default

// Module 12096 (GameInviteVoiceCount)
...
export default function GameInviteVoiceCount(channel) {
  ...
  if (0 !== stateFromStores) {
    ...
    const items2 = [closure_5(tmp2(5151).VoiceNormalIcon, obj3), ];
    const obj4 = { variant: "text-sm/medium", color: "text-feedback-positive", children: stateFromStores };
    items2[1] = closure_5(tmp2(4601).Text, obj4);
