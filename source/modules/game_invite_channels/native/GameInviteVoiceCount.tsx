...
// Dependencies: [19, 17, 4598, 21, 4574, 504, 5115, 576, 4570, 2]
// Exports: default

// Module 12056 (GameInviteVoiceCount)
...
export default function GameInviteVoiceCount(channel) {
  ...
  if (0 !== stateFromStores) {
    ...
    const items2 = [closure_5(tmp2(5115).VoiceNormalIcon, obj3), ];
    const obj4 = { variant: "text-sm/medium", color: "text-feedback-positive", children: stateFromStores };
    items2[1] = closure_5(tmp2(4570).Text, obj4);
