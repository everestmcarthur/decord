...
// Dependencies: [4810, 12866, 1896, 2]
// Exports: closeCreateGameInvitePostModal, openCreateGameInvitePostModal

// Module 12865 (CreateGameInvitePostModalActionCreators)
...
export const openCreateGameInvitePostModal = function openCreateGameInvitePostModal(merged) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12866, dependencyMap.paths), merged, c3);
};
