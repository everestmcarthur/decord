...
// Dependencies: [32, 19, 17, 1957, 21, 4605, 576, 7214, 504, 5680, 12840, 7033, 12842, 4616, 4572, 11320, 1896, 1114, 5173, 5730, 4601, 3526, 7137, 7324, 5737, 5655, 7252, 5025, 2]
// Exports: default

// Module 12841 (CreateGameInvitePostModal)
...
function CreateGameInvitePostContent(parentChannel) {
  ...
  const insets = tags(7033)({ includeKeyboardHeight: true }).insets;
  ...
  const createGameInvitePost = parentChannel(12842).useCreateGameInvitePost({
    parentChannel,
    description: tmp5,
    appliedTagIds: memo,
    upload: NOOP_UPLOAD,
  ...
  const callback1 = noop.useCallback(() => {
    ...
    obj2.tags = tags;
    obj.openLazy(asyncRequireImpl(11320, dependencyMap.paths), "ForumPostTagsActionSheet", obj2);
  }, items2);
  ...
  obj5.children = closure_7(parentChannel(5730).XSmallIcon, {});
  const items4 = [closure_7(parentChannel(5173).PressableOpacity, obj5), ];
  ...
  items4[1] = closure_7(parentChannel(4601).Text, obj6);
  ...
  obj8.value = tmp5;
  obj8.onChange = tmp6;
  obj8.maxLength = parentChannel(7324).GAME_INVITE_POST_MESSAGE_MAX_LENGTH;
  const items6 = [closure_7(parentChannel(7137).TextArea, obj8), ];
  ...
  if (tmp15Result) {
    ...
    obj10.children = tmp15(tmp9(4601).Text, obj11);
    obj9.trailing = tmp15(tmp14, obj10);
    obj9.onPress = callback1;
    tmp15Result = tmp15(tmp9(5655).TableRow, obj9);
  }
  ...
  items7[1] = closure_7(parentChannel(7252).TableSwitchRow, obj13);
  obj12.children = items7;
  items6[1] = closure_8(parentChannel(5737).TableRowGroup, obj12);
  ...
  obj14.children = closure_7(parentChannel(5025).Button, obj15);
...
export default function CreateGameInvitePostModal(parentChannelId) {
  ...
  parentChannelId(5680).useNavigatorBackPressHandler(() => {
  ...
  if (null != stateFromStores) {
    ...
    if (stateFromStores.isGameInvitesChannel()) {
      ...
      tmp4 = closure_7(tmp2(7214).AnalyticsLocationProvider, obj2);
    }
  }
  return tmp4;
};
