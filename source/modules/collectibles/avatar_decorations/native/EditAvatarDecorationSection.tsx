...
// Dependencies: [19, 17, 7661, 1398, 21, 4640, 13325, 13323, 13326, 7296, 8969, 2]

// Module 13324 (EditAvatarDecorationSection)
...
import useAvatarDecorationSections from "useAvatarDecorationSections" /* 13323 */;
...
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13325).GUTTER_SIZE }, rowSpacer: null };
...
const memoResult = noop.memo((size) => {
  ...
  obj2.children = substr.map((avatarDecoration, index) => {
    if (avatarDecoration === useAvatarDecorationSections.NONE_ITEM) {
      ...
      return React5(tmp(13326).EditCollectiblesListItemNone, obj2, "none");
    } else if (avatarDecoration === tmp(13323).SHOP_ITEM) {
      const obj3 = { size, analyticsSource: AnalyticsLocationDefault.EDIT_AVATAR_DECORATION_SHEET };
      return React5(tmp(13326).EditCollectiblesListItemShop, obj3, "shop");
