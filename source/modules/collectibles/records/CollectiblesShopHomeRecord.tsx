...
// Dependencies: [7617, 7645, 7647, 7650, 7651, 7652, 7653, 7654, 7655, 7656, 7657, 7646, 2]

// Module 7644 (CollectiblesShopHomeRecord)
import ShopBlockType from "ShopBlockType" /* 7646 */;
import CollectiblesCategoryRecord from "CollectiblesCategoryRecord" /* 7617 */;

require = fn;
const CountdownTimerBlockRecord = fn(7645).CountdownTimerBlockRecord;
const FeaturedBlockRecord = fn(7647).FeaturedBlockRecord;
const FeedBlockRecord = fn(7650).FeedBlockRecord;
let closure_6 = fn(7651).GameServerHostingBannerBlockRecord;
const HeroBlockRecord = fn(7652).HeroBlockRecord;
let closure_8 = fn(7653).ImmersiveBannerBlockRecord;
const RewardHeroBlockRecord = fn(7654).RewardHeroBlockRecord;
const ShelfBlockRecord = fn(7655).ShelfBlockRecord;
let closure_11 = fn(7656).SocialLayerStorefrontPromotionalBannerBlockRecord;
const WideBannerBlockRecord = fn(7657).WideBannerBlockRecord;
