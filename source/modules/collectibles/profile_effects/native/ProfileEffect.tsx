...
// Function ID: 8873
// Name: ProfileEffect
// Dependencies: [32, 19, 17, 4597, 1895, 21, 4605, 1477, 8873, 8874, 8875, 8877, 504, 1093, 8878, 8876, 5637, 8289, 2]
// Exports: default, usePreloadProfileEffect

// Module 8872 (ProfileEffect)
import initialize from "initialize" /* 504 */;
import ConstantsIOS from "ConstantsIOS" /* 1093 */;
import useProfileEffectDefault from "useProfileEffect" /* 8289 */;
import utils from "utils" /* 8873 */;
import constants from "constants" /* 8874 */;
import ProfileEffectUtils from "ProfileEffectUtils" /* 8875 */;
import ProfileEffectLayerDefault from "ProfileEffectLayer" /* 8878 */;
...
function StaticEffect(useThumbnail) {
  ...
  if (0 === tmp8) {
    ...
    items1[1] = size1;
    size.style = items1;
    obj3.children = tmp10(tmp4(5637), size);
...
function ProfileEffect(profileEffect) {
  ...
  jsx = noop.useRef(-memo(8874).PROFILE_EFFECT_INTRO_DELAY);
  ...
  const tmp9Result = memo1(8877)(noop.useCallback((arg0) => {
    if (ref.current) {
      if (!ref3.current) {
        tmp.current = true;
