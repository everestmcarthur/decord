...
// Function ID: 8896
// Name: ProfileEffect
// Dependencies: [32, 19, 17, 4599, 1895, 21, 4607, 1477, 8896, 8897, 8898, 8900, 504, 1093, 8901, 8899, 5639, 8312, 2]
// Exports: default, usePreloadProfileEffect

// Module 8895 (ProfileEffect)
import initialize from "initialize" /* 504 */;
import ConstantsIOS from "ConstantsIOS" /* 1093 */;
import useProfileEffectDefault from "useProfileEffect" /* 8312 */;
import utils from "utils" /* 8896 */;
import constants from "constants" /* 8897 */;
import ProfileEffectUtils from "ProfileEffectUtils" /* 8898 */;
import ProfileEffectLayerDefault from "ProfileEffectLayer" /* 8901 */;
...
function StaticEffect(useThumbnail) {
  ...
  if (0 === tmp8) {
    ...
    items1[1] = size1;
    size.style = items1;
    obj3.children = tmp10(tmp4(5639), size);
...
function ProfileEffect(profileEffect) {
  ...
  jsx = noop.useRef(-memo(8897).PROFILE_EFFECT_INTRO_DELAY);
  ...
  const tmp9Result = memo1(8900)(noop.useCallback((arg0) => {
    if (ref.current) {
      if (!ref3.current) {
        tmp.current = true;
