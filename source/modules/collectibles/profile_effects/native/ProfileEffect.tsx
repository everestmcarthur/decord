...
// Function ID: 8932
// Name: ProfileEffect
// Dependencies: [32, 19, 17, 4631, 1896, 21, 4639, 1478, 8932, 8933, 8934, 8936, 504, 1094, 8937, 8935, 5672, 8345, 2]
// Exports: default, usePreloadProfileEffect

// Module 8931 (ProfileEffect)
import initialize from "initialize" /* 504 */;
import ConstantsIOS from "ConstantsIOS" /* 1094 */;
import useProfileEffectDefault from "useProfileEffect" /* 8345 */;
import utils from "utils" /* 8932 */;
import constants from "constants" /* 8933 */;
import ProfileEffectUtils from "ProfileEffectUtils" /* 8934 */;
import ProfileEffectLayerDefault from "ProfileEffectLayer" /* 8937 */;
...
function StaticEffect(useThumbnail) {
  ...
  if (0 === tmp8) {
    ...
    items1[1] = size1;
    size.style = items1;
    obj3.children = tmp10(tmp4(5672), size);
...
function ProfileEffect(profileEffect) {
  ...
  const tmp9Result = memo1(8936)(noop.useCallback((arg0) => {
    if (ref.current) {
      if (!ref3.current) {
        tmp.current = true;
