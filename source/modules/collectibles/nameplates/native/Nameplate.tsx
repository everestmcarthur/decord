...
// Function ID: 8976
// Name: Nameplate
// Dependencies: [19, 4632, 21, 4640, 504, 4574, 4376, 4641, 1887, 8976, 5074, 1364, 8965, 5675, 2]
// Exports: default

// Module 8975 (Nameplate)
...
function NameplateInner(isFocused) {
  ...
  const nameplateAssets = flag6(8976).getNameplateAssets(nameplate);
  ...
  if (null != backgroundGradientColors) {
    ...
    obj4.colors = items3;
    tmp15Result = closure_5(tmp5(5074), obj4);
    const tmp5Result = tmp5(5074);
  }
  const items4 = [tmp15Result, ];
  const tmp13 = closure_6;
  const tmpResult5 = flag6(8976);
  if (tmpResult6.isAndroid()) {
    if (tmp12) {
      const obj5 = { url: str, style: tmp4.img, autoplay: true };
      let tmp17 = closure_5(tmp(8965).APNGPlayer, obj5);
    }
    items4[1] = tmp17;
    obj3.children = items4;
    return tmp13(tmp5(4376).View, obj3);
  }
  tmp17 = closure_5(tmp5(5675), { source: { uri: str }, style: tmp4.img, accessibilityRole: "image" });
}
const jsxProd = fn(21);
