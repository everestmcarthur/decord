...
// Dependencies: [19, 17, 1182, 21, 1177, 576, 4722, 504, 4430, 9059, 9061, 9062, 2]
// Exports: NameplateDummyUserPreview

// Module 9058 (NameplateDummyUserPreview)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj4.children = hasOwnProperty(native.Avatar, { source: importDefault(stateFromStores ? 9061 : 9062), size: NORMAL, "aria-hidden": true, style: tmp3.avatar });
