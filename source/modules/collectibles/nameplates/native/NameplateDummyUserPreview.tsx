...
// Dependencies: [19, 17, 1183, 21, 1178, 576, 4607, 504, 4315, 8912, 8914, 8915, 2]
// Exports: NameplateDummyUserPreview

// Module 8911 (NameplateDummyUserPreview)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj4.children = hasOwnProperty(native.Avatar, { source: importDefault(stateFromStores ? 8914 : 8915), size: NORMAL, "aria-hidden": true, style: tmp3.avatar });
