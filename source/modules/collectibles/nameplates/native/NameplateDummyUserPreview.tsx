...
// Dependencies: [19, 17, 1182, 21, 1177, 576, 4638, 504, 4346, 8959, 8961, 8962, 2]
// Exports: NameplateDummyUserPreview

// Module 8958 (NameplateDummyUserPreview)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj4.children = hasOwnProperty(native.Avatar, { source: importDefault(stateFromStores ? 8961 : 8962), size: NORMAL, "aria-hidden": true, style: tmp3.avatar });
