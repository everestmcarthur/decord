...
// Dependencies: [19, 17, 1183, 21, 1178, 576, 4574, 504, 4282, 8852, 8854, 8855, 2]
// Exports: NameplateDummyUserPreview

// Module 8851 (NameplateDummyUserPreview)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj4.children = hasOwnProperty(native.Avatar, { source: importDefault(stateFromStores ? 8854 : 8855), size: NORMAL, "aria-hidden": true, style: tmp3.avatar });
