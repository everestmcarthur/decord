...
// Dependencies: [19, 17, 1182, 21, 1177, 576, 4640, 504, 4348, 8975, 8977, 8978, 2]
// Exports: NameplateDummyUserPreview

// Module 8974 (NameplateDummyUserPreview)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj4.children = hasOwnProperty(native.Avatar, { source: importDefault(stateFromStores ? 8977 : 8978), size: NORMAL, "aria-hidden": true, style: tmp3.avatar });
