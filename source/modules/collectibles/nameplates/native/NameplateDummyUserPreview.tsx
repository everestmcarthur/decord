...
// Dependencies: [19, 17, 1182, 21, 1177, 576, 4639, 504, 4348, 8948, 8950, 8951, 2]
// Exports: NameplateDummyUserPreview

// Module 8947 (NameplateDummyUserPreview)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj4.children = hasOwnProperty(native.Avatar, { source: importDefault(stateFromStores ? 8950 : 8951), size: NORMAL, "aria-hidden": true, style: tmp3.avatar });
