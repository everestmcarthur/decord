...
// Dependencies: [19, 17, 1888, 21, 4639, 13306, 14735, 13307, 7289, 1887, 8948, 2]

// Module 14736 (EditNameplateSection)
...
import useNameplateSections from "useNameplateSections" /* 14735 */;
...
const memoResult = noop.memo((arg0) => {
  ...
  obj2.children = substr.map((nameplate, index) => {
    ...
    } else if (nameplate === tmp(14735).SHOP_ITEM) {
...
const memoResult1 = noop.memo((nameplate) => {
  ...
  obj2.style = items2;
  obj.children = closure_6(setSelectedNameplate(8948), obj2);
