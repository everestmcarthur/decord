...
// Dependencies: [19, 17, 1887, 21, 4606, 13267, 14690, 13268, 7255, 1886, 8910, 2]

// Module 14691 (EditNameplateSection)
...
import useNameplateSections from "useNameplateSections" /* 14690 */;
...
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13267).GUTTER_SIZE }, rowSpacer: null, nameplate: null };
...
const memoResult = noop.memo((arg0) => {
  ...
  obj2.children = substr.map((nameplate, index) => {
    ...
    } else if (nameplate === tmp(14690).SHOP_ITEM) {
...
const memoResult1 = noop.memo((nameplate) => {
  ...
  obj2.style = items2;
  obj.children = closure_6(setSelectedNameplate(8910), obj2);
  return closure_6(nameplate(13268).EditCollectiblesListItemProduct, obj);
});
