...
// Dependencies: [19, 17, 1887, 21, 4607, 13269, 14693, 13270, 7256, 1886, 8912, 2]

// Module 14694 (EditNameplateSection)
...
import useNameplateSections from "useNameplateSections" /* 14693 */;
...
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13269).GUTTER_SIZE }, rowSpacer: null, nameplate: null };
...
const memoResult = noop.memo((arg0) => {
  ...
  obj2.children = substr.map((nameplate, index) => {
    ...
    } else if (nameplate === tmp(14693).SHOP_ITEM) {
...
const memoResult1 = noop.memo((nameplate) => {
  ...
  obj2.style = items2;
  obj.children = closure_6(setSelectedNameplate(8912), obj2);
  return closure_6(nameplate(13270).EditCollectiblesListItemProduct, obj);
});
