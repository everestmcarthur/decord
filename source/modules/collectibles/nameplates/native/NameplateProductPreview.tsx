...
// Dependencies: [19, 17, 4597, 21, 4605, 576, 8234, 1886, 1114, 4601, 5037, 8241, 8321, 8229, 504, 4449, 4839, 10969, 10970, 1178, 10980, 5655, 2]
// Exports: default

// Module 13216 (NameplateProductPreview)
...
function NameplateUser(arg0) {
  ...
  const icon = noop.useMemo(() => {
    const obj = { user: currentUser, guildId: "a", size: native.AvatarSizes.NORMAL, avatarDecoration, animate: !stateFromStores, autoStatusCutout: null, "aria-hidden": "\u{1F481}\u200D\u2642\uFE0F" };
...
export default function NameplateProductPreview(product) {
  ...
  if (null != nameplateData) {
    ...
    items[1] = React5(tmp2(4601).Text, obj8);
    ...
    items[5] = React5(tmp2(4601).Text, obj12);
