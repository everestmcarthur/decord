...
// Dependencies: [32, 4632, 8376, 7666, 563, 2]
// Exports: default

// Module 11241 (createUseCollectiblesShopStyles)
      ...
      if (0 === backgroundColors.length) {
        ...
        if (0 === buttonColors.length) {
          ...
          if (1 !== buttonColors.length) {
            ...
            [tmp44, tmp45, tmp46] = tmp(8376).getValueInColorGradientByPercentage(items1, items2, 50);
            const obj22 = { r: tmp44, g: tmp45, b: tmp46 };
            const tmp43 = _slicedToArray(tmp(8376).getValueInColorGradientByPercentage(items1, items2, 50), 3);
        ...
        if (1 !== backgroundColors.length) {
          ...
          [tmp9, tmp10, tmp11] = tmp(8376).getValueInColorGradientByPercentage(items3, items4, 50);
          const obj25 = { r: tmp9, g: tmp10, b: tmp11 };
          const tmp8 = _slicedToArray(tmp(8376).getValueInColorGradientByPercentage(items3, items4, 50), 3);
          ...
          const tmpResult4 = tmp(8376);
          [tmp16, tmp17, tmp18] = tmp(8376).getValueInColorGradientByPercentage(items5, items6, 50);
          const obj26 = { r: tmp16, g: tmp17, b: tmp18 };
          const tmp15 = _slicedToArray(tmp(8376).getValueInColorGradientByPercentage(items5, items6, 50), 3);
