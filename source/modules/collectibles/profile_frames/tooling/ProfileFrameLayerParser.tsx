...
// Dependencies: [718, 8355, 8356, 8357, 2]
// Exports: compareLayerFiles, isPreviewFilename, parseLayerFilename

// Module 8354 (ProfileFrameLayerParser)
import ProfileFrameLayerType from "ProfileFrameLayerType" /* 8356 */;
import _toArray from "_toArray" /* 718 */;

require = fn;
const preview = "preview";
const responsive = "responsive";
const items = [fn(8356).ProfileFrameLayerType.STAPLE, fn(8356).ProfileFrameLayerType.RAIL, fn(8356).ProfileFrameLayerType.BORDER];
const set = new Set(items);
const items1 = [fn(8357).ProfileFrameLayerAnchor.TOP, fn(8357).ProfileFrameLayerAnchor.BOTTOM, fn(8357).ProfileFrameLayerAnchor.CENTER];
...
export const FOLDER_ORDER_MAP = { foreground: fn(8355).ProfileFrameLayerOrder.FRONT, background: fn(8355).ProfileFrameLayerOrder.BACK };
        ...
        if (set.has(tmp20)) {
          if (tmp20 === ProfileFrameLayerType.ProfileFrameLayerType.BORDER) {
            ...
            if (substr.length > 1) {
              ...
              obj6.type = tmp20;
              obj6.anchor = tmp4(8357).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj10.type = tmp20;
                  obj10.anchor = first;
                  obj10.responsive = 2 === substr.length || tmp20 === tmp4(8356).ProfileFrameLayerType.RAIL;
                  obj9.parsed = obj10;
                  return obj9;
                }
              }
