...
// Dependencies: [718, 8437, 8438, 8439, 2]
// Exports: compareLayerFiles, isPreviewFilename, parseLayerFilename

// Module 8436 (ProfileFrameLayerParser)
import ProfileFrameLayerType from "ProfileFrameLayerType" /* 8438 */;
import _toArray from "_toArray" /* 718 */;

require = fn;
const preview = "preview";
const responsive = "responsive";
const items = [fn(8438).ProfileFrameLayerType.STAPLE, fn(8438).ProfileFrameLayerType.RAIL, fn(8438).ProfileFrameLayerType.BORDER];
const set = new Set(items);
const items1 = [fn(8439).ProfileFrameLayerAnchor.TOP, fn(8439).ProfileFrameLayerAnchor.BOTTOM, fn(8439).ProfileFrameLayerAnchor.CENTER];
...
export const FOLDER_ORDER_MAP = { foreground: fn(8437).ProfileFrameLayerOrder.FRONT, background: fn(8437).ProfileFrameLayerOrder.BACK };
        ...
        if (set.has(tmp20)) {
          if (tmp20 === ProfileFrameLayerType.ProfileFrameLayerType.BORDER) {
            ...
            if (substr.length > 1) {
              ...
              obj6.type = tmp20;
              obj6.anchor = tmp4(8439).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj10.type = tmp20;
                  obj10.anchor = first;
                  obj10.responsive = 2 === substr.length || tmp20 === tmp4(8438).ProfileFrameLayerType.RAIL;
                  obj9.parsed = obj10;
                  return obj9;
                }
              }
