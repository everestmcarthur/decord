...
// Dependencies: [718, 8270, 8271, 8272, 2]
// Exports: compareLayerFiles, isPreviewFilename, parseLayerFilename

// Module 8269 (ProfileFrameLayerParser)
import ProfileFrameLayerType from "ProfileFrameLayerType" /* 8271 */;
import _toArray from "_toArray" /* 718 */;

require = fn;
const preview = "preview";
const responsive = "responsive";
const items = [fn(8271).ProfileFrameLayerType.STAPLE, fn(8271).ProfileFrameLayerType.RAIL, fn(8271).ProfileFrameLayerType.BORDER];
const set = new Set(items);
const items1 = [fn(8272).ProfileFrameLayerAnchor.TOP, fn(8272).ProfileFrameLayerAnchor.BOTTOM, fn(8272).ProfileFrameLayerAnchor.CENTER];
...
const dependencyMap = { [fn(8270).ProfileFrameLayerOrder.FRONT]: 0, [fn(8270).ProfileFrameLayerOrder.BACK]: 1 };
const size = fn(2);
...
export const FOLDER_ORDER_MAP = { foreground: fn(8270).ProfileFrameLayerOrder.FRONT, background: fn(8270).ProfileFrameLayerOrder.BACK };
        ...
        if (set.has(tmp20)) {
          if (tmp20 === ProfileFrameLayerType.ProfileFrameLayerType.BORDER) {
            ...
            if (substr.length > 1) {
              ...
              obj6.type = tmp20;
              obj6.anchor = tmp4(8272).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj10.type = tmp20;
                  obj10.anchor = first;
                  obj10.responsive = 2 === substr.length || tmp20 === tmp4(8271).ProfileFrameLayerType.RAIL;
                  obj9.parsed = obj10;
                  return obj9;
                }
              }
