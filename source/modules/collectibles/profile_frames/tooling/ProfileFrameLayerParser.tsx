...
// Dependencies: [718, 8292, 8293, 8294, 2]
...
export const FOLDER_ORDER_MAP = { foreground: fn(8292).ProfileFrameLayerOrder.FRONT, background: fn(8292).ProfileFrameLayerOrder.BACK };
        ...
        if (set.has(tmp20)) {
          if (tmp20 === ProfileFrameLayerType.ProfileFrameLayerType.BORDER) {
            ...
            if (substr.length > 1) {
              ...
              obj6.type = tmp20;
              obj6.anchor = tmp4(8294).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj10.type = tmp20;
                  obj10.anchor = first;
                  obj10.responsive = 2 === substr.length || tmp20 === tmp4(8293).ProfileFrameLayerType.RAIL;
                  obj9.parsed = obj10;
                  return obj9;
                }
              }
