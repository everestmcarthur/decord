...
// Dependencies: [19, 17, 7663, 8369, 21, 576, 4640, 13325, 14754, 13326, 7296, 8979, 2]

// Module 14755 (EditProfileFrameSection)
...
import useProfileFrameSections from "useProfileFrameSections" /* 14754 */;
...
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13325).GUTTER_SIZE }, rowSpacer: null, previewContainer: null };
...
const memoResult = noop.memo((arg0) => {
  ...
  obj2.children = substr.map((profileFrame, index) => {
    ...
    } else if (profileFrame === tmp(14754).SHOP_ITEM) {
