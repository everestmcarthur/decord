...
// Dependencies: [19, 17, 7623, 8308, 21, 576, 4607, 13269, 14688, 13270, 7256, 8916, 2]

// Module 14689 (EditProfileFrameSection)
...
import useProfileFrameSections from "useProfileFrameSections" /* 14688 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
const isProfileFrameRecord = fn(7623).isProfileFrameRecord;
let closure_6 = fn(8308).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
({ jsx: closure_7, Fragment: closure_8, jsxs: closure_9 } = jsxProd);
const PX_8 = nativeDefault.space.PX_8;
const createStyles = fn(4607);
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13269).GUTTER_SIZE }, rowSpacer: null, previewContainer: null };
...
const memoResult = noop.memo((arg0) => {
  ...
  obj2.children = substr.map((profileFrame, index) => {
    ...
    } else if (profileFrame === tmp(14688).SHOP_ITEM) {
