...
// Dependencies: [19, 17, 7622, 8306, 21, 576, 4606, 13267, 14685, 13268, 7255, 8914, 2]

// Module 14686 (EditProfileFrameSection)
...
import useProfileFrameSections from "useProfileFrameSections" /* 14685 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
const isProfileFrameRecord = fn(7622).isProfileFrameRecord;
let closure_6 = fn(8306).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
({ jsx: closure_7, Fragment: closure_8, jsxs: closure_9 } = jsxProd);
const PX_8 = nativeDefault.space.PX_8;
const createStyles = fn(4606);
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13267).GUTTER_SIZE }, rowSpacer: null, previewContainer: null };
...
const memoResult = noop.memo((arg0) => {
  ...
  obj2.children = substr.map((profileFrame, index) => {
    if (profileFrame === useProfileFrameSections.NONE_ITEM) {
      ...
      return React5(tmp(13268).EditCollectiblesListItemNone, obj2, "none");
    } else if (profileFrame === tmp(14685).SHOP_ITEM) {
      const obj3 = { size: width, analyticsSource: AnalyticsLocationDefault.EDIT_PROFILE_FRAME_SHEET };
      return React5(tmp(13268).EditCollectiblesListItemShop, obj3, "shop");
