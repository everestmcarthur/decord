...
// Dependencies: [19, 17, 7601, 8285, 21, 576, 4605, 13244, 14710, 13245, 7234, 8893, 2]
...
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13244).GUTTER_SIZE }, rowSpacer: null, previewContainer: null };
...
const memoResult = noop.memo((arg0) => {
  ...
  obj2.children = substr.map((profileFrame, index) => {
    ...
    } else if (profileFrame === tmp(14710).SHOP_ITEM) {
