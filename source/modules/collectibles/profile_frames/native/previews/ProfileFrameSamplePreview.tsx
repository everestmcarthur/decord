...
// Dependencies: [19, 17, 8939, 7318, 21, 4638, 576, 8352, 4339, 8349, 8336, 5750, 5673, 8964, 2]
// Exports: default

// Module 8963 (ProfileFrameSamplePreview)
...
let obj2 = { profileFrameContainer: { flex: 1 }, profileContainer: { flex: 1, overflow: "hidden", borderWidth: 1, borderColor: nativeDefault.colors.BORDER_NORMAL, borderRadius: nativeDefault.radii.xs }, sampleProfile: { width: "100%", aspectRatio: fn(8939).SAMPLE_PROFILE_ASPECT_RATIO } };
