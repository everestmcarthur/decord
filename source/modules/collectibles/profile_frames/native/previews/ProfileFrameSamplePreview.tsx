...
// Dependencies: [19, 17, 8928, 7315, 21, 4639, 576, 8343, 4341, 8340, 8327, 5749, 5672, 8953, 2]
// Exports: default

// Module 8952 (ProfileFrameSamplePreview)
...
let obj2 = { profileFrameContainer: { flex: 1 }, profileContainer: { flex: 1, overflow: "hidden", borderWidth: 1, borderColor: nativeDefault.colors.BORDER_NORMAL, borderRadius: nativeDefault.radii.xs }, sampleProfile: { width: "100%", aspectRatio: fn(8928).SAMPLE_PROFILE_ASPECT_RATIO } };
