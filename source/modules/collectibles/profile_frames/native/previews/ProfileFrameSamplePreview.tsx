...
// Dependencies: [19, 17, 8890, 7281, 21, 4606, 576, 8308, 4308, 8305, 8292, 5715, 5638, 8915, 2]
// Exports: default

// Module 8914 (ProfileFrameSamplePreview)
...
let obj2 = { profileFrameContainer: { flex: 1 }, profileContainer: { flex: 1, overflow: "hidden", borderWidth: 1, borderColor: nativeDefault.colors.BORDER_NORMAL, borderRadius: nativeDefault.radii.xs }, sampleProfile: { width: "100%", aspectRatio: fn(8890).SAMPLE_PROFILE_ASPECT_RATIO } };
