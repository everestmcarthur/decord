...
// Function ID: 15923
// Name: HeroBlock
// Dependencies: [19, 17, 7649, 1076, 1074, 21, 8893, 4639, 576, 9000, 15923, 1484, 8896, 504, 11622, 4574, 15924, 4341, 4489, 15164, 15166, 7269, 7289, 15925, 1241, 4491, 15927, 15928, 15929, 5071, 4635, 5059, 1115, 11901, 5534, 5207, 7316, 7263, 15930, 9006, 2]
// Exports: default

// Module 15922 (HeroBlock)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import CollectiblesShopCardV2 from "CollectiblesShopCardV2" /* 8893 */;
...
import FeaturedFirstCardCoachmarkAnchorDefault from "FeaturedFirstCardCoachmarkAnchor" /* 15925 */;
...
const result = 0.75 * fn(8893).COLLECTIBLES_SHOP_CARD_WIDTH;
...
export default function _default(heroBlock) {
  ...
  closure_5 = undefined;
  closure_6 = undefined;
  let obj = heroBlock(15923);
  dependencyMap = heroBlock(1484).useNavigation();
  let obj2 = heroBlock(1484);
  noop = heroBlock(8896).useCollectiblesAnalyticsContext();
  ...
  let isEligibleForQuests = heroBlock(11622).getIsEligibleForQuests();
  const tmpResult9 = heroBlock(11622);
  const tmp7 = preferVCPrice(4574)();
  const tmp8 = closure_14();
  const tmpResult10 = heroBlock(15924);
  ...
  const tmp12 = preferVCPrice(15164)();
  closure_5 = tmp12;
  ...
  const filteredAndSortedProducts = heroBlock(15166).useFilteredAndSortedProducts({ products: memo, bypassAndroidUnsyncedFilter: tmp4 });
  closure_6 = tmp14;
  const tmpResult15 = heroBlock(15166);
  let unpublishedAt;
  ...
  if (undefined === stateFromStores) {
    ...
    if (!tmp4) {
      const obj4 = { value: tmp15(preferVCPrice(7289).COLLECTIBLES_SHOP_HERO).analyticsLocations, children: null };
      ...
      if (tmp24Result) {
        ...
        if (tmp4) {
          ...
          tmp22Result = tmp22(tmp6(5071), obj8);
        }
        ...
        items3[2] = tmp22(tmp6(5071), obj12);
      ...
      if (tmp4) {
        ...
        if (tmp22Result6) {
          ...
          tmp22Result6 = tmp22(tmp(4635).Text, obj15);
        }
        ...
        if (tmp22Result7) {
          ...
          tmp22Result7 = tmp22(tmp(4635).Text, obj16);
        }
        ...
        if (isEligibleForQuests) {
          ...
          isEligibleForQuests = tmp22(tmp(5059).Button, obj19);
        }
        ...
        const obj28 = { style: tmp8.heroViewAllIcon, children: tmp22(tmp(7316).ChevronSmallRightIcon, { size: "sm", color: "white" }) };
        items9[1] = tmp22(tmp25, obj28);
        obj24.children = items9;
        obj20.children = tmp24(tmp25, obj24);
        tmp24Result2 = tmp22(tmp(5207).PressableOpacity, obj20, stateFromStores.storeListingId);
      }
      ...
      if (tmp4) {
        ...
        let tmp22Result9 = tmp22(tmp6(15930), obj30);
        const tmp6Result3 = tmp6(15930);
      } else {
        if (0 === filteredAndSortedProducts.length) {
          ...
          obj34.snapToInterval = tmp(8893).COLLECTIBLES_SHOP_CARD_WIDTH + tmp6(576).space.PX_12;
          ...
          tmp22Result10 = tmp22(tmp(9006).FlashList, obj34);
        }
        const obj36 = { children: tmp22Result10 };
        tmp22Result9 = tmp22(closure_12, obj36);
      }
      const obj37 = { children: tmp22Result9 };
      obj29.children = closure_11(tmp(7263).LayerScope, obj37);
      items6[2] = closure_11(closure_5, obj29);
      obj6.children = items6;
      obj5.children = closure_13(closure_5, obj6);
      obj4.children = closure_11(tmp6(15929), obj5);
      return closure_11(tmp(7269).AnalyticsLocationProvider, obj4);
    } else {
      if (tmpResult16.isThemeDark(tmp7)) {
        let tmp6Result4 = tmp6(15927);
      } else {
        tmp6Result4 = tmp6(15928);
      }
