...
// Function ID: 15884
// Name: HeroBlock
// Dependencies: [19, 17, 7615, 1076, 1074, 21, 8855, 4606, 576, 15143, 15884, 1483, 8858, 504, 11578, 4541, 15885, 4308, 4456, 15130, 15132, 7235, 7255, 15886, 1242, 4458, 15888, 15889, 15890, 5038, 4602, 5026, 1114, 11860, 5500, 5174, 7282, 7229, 15891, 8964, 2]
// Exports: default
...
const result = 0.75 * fn(8855).COLLECTIBLES_SHOP_CARD_WIDTH;
...
export default function _default(heroBlock) {
  ...
  noop = heroBlock(8858).useCollectiblesAnalyticsContext();
  ...
  let isEligibleForQuests = heroBlock(11578).getIsEligibleForQuests();
  const tmpResult9 = heroBlock(11578);
  const tmp7 = preferVCPrice(4541)();
  ...
  if (undefined === stateFromStores) {
    ...
    if (!tmp4) {
      const obj4 = { value: tmp15(preferVCPrice(7255).COLLECTIBLES_SHOP_HERO).analyticsLocations, children: null };
      ...
      if (tmp24Result) {
        ...
        if (tmp4) {
          ...
          tmp22Result = tmp22(tmp6(5038), obj8);
        }
        ...
        items3[2] = tmp22(tmp6(5038), obj12);
      ...
      if (tmp4) {
        ...
        if (tmp22Result6) {
          ...
          tmp22Result6 = tmp22(tmp(4602).Text, obj15);
        }
        ...
        if (tmp22Result7) {
          ...
          tmp22Result7 = tmp22(tmp(4602).Text, obj16);
        }
        ...
        if (isEligibleForQuests) {
          ...
          isEligibleForQuests = tmp22(tmp(5026).Button, obj19);
        }
        ...
        const obj28 = { style: tmp8.heroViewAllIcon, children: tmp22(tmp(7282).ChevronSmallRightIcon, { size: "sm", color: "white" }) };
        items9[1] = tmp22(tmp25, obj28);
        obj24.children = items9;
        obj20.children = tmp24(tmp25, obj24);
        tmp24Result2 = tmp22(tmp(5174).PressableOpacity, obj20, stateFromStores.storeListingId);
      }
      ...
      if (tmp4) {
        ...
        if (0 === filteredAndSortedProducts.length) {
          ...
          obj34.snapToInterval = tmp(8855).COLLECTIBLES_SHOP_CARD_WIDTH + tmp6(576).space.PX_12;
