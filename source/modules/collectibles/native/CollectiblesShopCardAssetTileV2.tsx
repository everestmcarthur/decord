...
// Dependencies: [32, 19, 17, 1076, 21, 8904, 576, 4638, 8936, 5180, 7663, 1890, 8300, 8938, 5673, 8984, 1077, 8985, 8951, 8940, 8963, 8965, 4487, 4339, 8905, 2]

// Module 8983 (CollectiblesShopCardAssetTileV2)
...
import CheckmarkLargeBoldIcon from "CheckmarkLargeBoldIcon" /* 8936 */;
import BundleSampleV2Default from "BundleSampleV2" /* 8938 */;
import ProfileEffectSampleV2Default from "ProfileEffectSampleV2" /* 8940 */;
...
import NameplateCardPreviewDefault from "NameplateCardPreview" /* 8965 */;
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1890).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      let size = { skuId: product.skuId, width: tmp2(8985).FRACTIONAL_NITRO_COIN_SIZE.CARD, height: tmp2(8985).FRACTIONAL_NITRO_COIN_SIZE.CARD };
      return closure_7(tmp2(8985).FractionalNitroCoinIllustration, size);
    } else {
      ...
      if (tmp2(1890).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = { profileFrame: first, previewWidth: tmp2(8904).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32, previewHeight, profileBackgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
