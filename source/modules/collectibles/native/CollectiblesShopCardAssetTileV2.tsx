...
// Dependencies: [32, 19, 17, 1076, 21, 8920, 576, 4640, 8952, 5182, 7667, 1890, 8319, 8954, 5675, 9000, 1077, 9001, 8967, 8956, 8979, 8981, 4489, 4341, 8921, 2]

// Module 8999 (CollectiblesShopCardAssetTileV2)
...
import LockIcon from "LockIcon" /* 5182 */;
...
import CheckmarkLargeBoldIcon from "CheckmarkLargeBoldIcon" /* 8952 */;
import BundleSampleV2Default from "BundleSampleV2" /* 8954 */;
import ProfileEffectSampleV2Default from "ProfileEffectSampleV2" /* 8956 */;
import AvatarDecorationSampleV2Default from "AvatarDecorationSampleV2" /* 8967 */;
import ProfileFrameSamplePreviewDefault from "ProfileFrameSamplePreview" /* 8979 */;
import NameplateCardPreviewDefault from "NameplateCardPreview" /* 8981 */;
import _modDef9000 from "module_9000" /* 9000 */;
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1890).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      let size = { skuId: product.skuId, width: tmp2(9001).FRACTIONAL_NITRO_COIN_SIZE.CARD, height: tmp2(9001).FRACTIONAL_NITRO_COIN_SIZE.CARD };
      return closure_7(tmp2(9001).FractionalNitroCoinIllustration, size);
    } else {
      ...
      if (tmp2(1890).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = { profileFrame: first, previewWidth: tmp2(8920).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32, previewHeight, profileBackgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
