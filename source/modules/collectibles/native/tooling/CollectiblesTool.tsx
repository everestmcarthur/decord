...
// Dependencies: [32, 19, 17, 7616, 7631, 8289, 21, 4607, 576, 8857, 4603, 5028, 563, 10825, 15786, 1178, 11174, 2]
// Exports: default
...
let closure_9 = fn(8289).useFramePreviewOverrideStore;
const jsxProd = fn(21);
...
export default function _default() {
  ...
  if (tmp18Result) {
    ...
    obj17.style = items8;
    tmp18Result = tmp18(tmp2(tmp3[10]).Text, obj17);
  }
  ...
  if (tmp18Result2) {
    ...
    obj18.style = items9;
    tmp18Result2 = tmp18(tmp2(tmp3[10]).Text, obj18);
  }
  ...
  if (tmp20Result) {
    ...
    tmp20Result = tmp20(tmp2(tmp3[10]).Text, obj19);
  }
  ...
  if (null != product) {
    if (null != tmp16[0]) {
      ...
      items13[1] = tmp18(tmp2(tmp3[11]).BaseTextButton, obj26);
