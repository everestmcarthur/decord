...
// Dependencies: [32, 19, 17, 7649, 7664, 8323, 21, 4639, 576, 8893, 4635, 5060, 563, 10867, 15821, 1177, 11216, 2]
// Exports: default

// Module 15820 (CollectiblesTool)
...
let closure_9 = fn(8323).useFramePreviewOverrideStore;
const jsxProd = fn(21);
