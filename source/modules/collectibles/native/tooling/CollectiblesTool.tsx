...
// Dependencies: [32, 19, 17, 7652, 7667, 8332, 21, 4638, 576, 8904, 4634, 5061, 563, 10875, 15839, 1177, 11230, 2]
// Exports: default

// Module 15838 (CollectiblesTool)
...
let closure_9 = fn(8332).useFramePreviewOverrideStore;
const jsxProd = fn(21);
