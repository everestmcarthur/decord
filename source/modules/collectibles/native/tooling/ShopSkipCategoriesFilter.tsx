...
// Dependencies: [19, 17, 7594, 21, 4605, 576, 504, 5023, 4601, 7593, 2]
// Exports: ShopSkipCategoriesFilter

// Module 15801 (ShopSkipCategoriesFilter)
...
export const ShopSkipCategoriesFilter = function ShopSkipCategoriesFilter() {
  ...
  const items1 = [closure_5(stateFromStores(4601).Text, { variant: "text-md/normal", style: tmp.label, children: "Hide first # of categories" }), ];
  ...
  const items3 = [
    closure_5(closure_3, {
      ...
      children: closure_5(stateFromStores(4601).Text, { variant: "text-lg/semibold", children: "\u2212" })
    }),
    closure_5(stateFromStores(4601).Text, { variant: "text-md/semibold", style: tmp.valueText, children: stateFromStores }),
  ...
  obj2.children = closure_6(stateFromStores(5023).Stack, obj7);
