...
// Dependencies: [19, 17, 7615, 21, 4606, 576, 504, 5024, 4602, 7614, 2]
...
export const ShopSkipCategoriesFilter = function ShopSkipCategoriesFilter() {
  ...
  const items1 = [closure_5(stateFromStores(4602).Text, { variant: "text-md/normal", style: tmp.label, children: "Hide first # of categories" }), ];
  ...
  const items3 = [
    ...
    closure_5(stateFromStores(4602).Text, { variant: "text-md/semibold", style: tmp.valueText, children: stateFromStores }),
  ...
  obj2.children = closure_6(stateFromStores(5024).Stack, obj7);
