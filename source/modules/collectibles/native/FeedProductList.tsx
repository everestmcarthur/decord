...
// Dependencies: [19, 17, 21, 4639, 8893, 15931, 9000, 15932, 2]
// Exports: default

// Module 15930 (FeedProductList)
import CollectiblesShopCardsGridDefault from "CollectiblesShopCardsGrid" /* 15932 */;
...
function SkeletonGrid(accessibilityLabel) {
  ...
  num = undefined;
  const tmp = closure_5();
  const cardLayout = num(15931).useCardLayout();
  ...
  for (let num = 0; num < loadingCardsNum; num = num + columns) {
    ...
    obj3.children = arr.map((item, index) => {
      ...
      const obj2 = { marginBottom: num(8893).COLLECTIBLES_SHOP_CARD_GAP };
      obj.style = obj2;
      return closure_4(closure_1(9000), obj, "" + num + "-" + index);
    });
...
let obj2 = { skeletonGrid: { flex: 1, alignItems: "center" }, skeletonRow: { flexDirection: "row", gap: fn(8893).COLLECTIBLES_SHOP_CARD_GAP, paddingBottom: fn(8893).COLLECTIBLES_SHOP_CARD_GAP } };
