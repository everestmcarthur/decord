...
// Dependencies: [5, 32, 19, 1074, 3, 11111, 7615, 4574, 11174, 1608, 7390, 4279, 4305, 1114, 2]
// Exports: default, useHandleBuyNow

// Module 13265 (useHandleBuyNow)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(7615).fetchCollectiblesPurchases(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
