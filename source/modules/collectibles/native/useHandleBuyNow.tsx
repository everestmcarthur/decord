...
// Dependencies: [5, 32, 19, 1074, 3, 11167, 7651, 4605, 11230, 1609, 7426, 4310, 4336, 1115, 2]
// Exports: default, useHandleBuyNow

// Module 13313 (useHandleBuyNow)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(7651).fetchCollectiblesPurchases(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
