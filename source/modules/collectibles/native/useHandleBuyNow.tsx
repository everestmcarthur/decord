...
// Dependencies: [5, 32, 19, 1074, 3, 11046, 7555, 4541, 11109, 1608, 7330, 4246, 4272, 1114, 2]
// Exports: default, useHandleBuyNow

// Module 13193 (useHandleBuyNow)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(7555).fetchCollectiblesPurchases(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
