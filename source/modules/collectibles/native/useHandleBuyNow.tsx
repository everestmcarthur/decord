...
// Dependencies: [5, 32, 19, 1074, 3, 11086, 7593, 4572, 11149, 1608, 7368, 4277, 4303, 1114, 2]
// Exports: default, useHandleBuyNow

// Module 13240 (useHandleBuyNow)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(7593).fetchCollectiblesPurchases(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
