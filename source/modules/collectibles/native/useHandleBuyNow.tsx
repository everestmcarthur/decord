...
// Dependencies: [5, 32, 19, 1074, 3, 11175, 7655, 4607, 11238, 1609, 7430, 4312, 4338, 1115, 2]
// Exports: default, useHandleBuyNow

// Module 13321 (useHandleBuyNow)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(7655).fetchCollectiblesPurchases(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
