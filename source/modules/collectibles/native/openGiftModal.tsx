...
// Function ID: 11105
// Name: openGiftModal
// Dependencies: [4810, 11105, 1896, 2]
// Exports: closeShopGiftModal, openShopGiftModal

// Module 11104 (openGiftModal)
...
export const openShopGiftModal = function openShopGiftModal(items1) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11105, dependencyMap.paths), { skuId, analyticsLocations, lockedRecipientUser, onGiftModalDismiss, giftingOrigin }, c3, navigationParams);
};
