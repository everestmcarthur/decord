...
// Dependencies: [19, 17, 21, 4605, 576, 5030, 4341, 4606, 2]
// Exports: default

// Module 13241 (ProductDetailsActionSheetSkeleton)
...
obj2.purchaseButton = { height: fn(5030).LARGE_BUTTON_HEIGHT, borderRadius: nativeDefault.radii.round };
...
export default function ProductDetailsActionSheetSkeleton() {
  const tmp = closure_7();
  let sharedValue;
  sharedValue = sharedValue(4341).useSharedValue(0.3);
