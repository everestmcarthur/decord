...
// Dependencies: [32, 19, 17, 21, 4606, 13267, 4602, 12, 8964, 2]
...
let obj = { list: { flex: 1, marginTop: 12 }, listContent: { paddingBottom: 88 }, loadingContainer: { paddingVertical: 80, alignItems: "center" }, header: { paddingHorizontal: fn(13267).GUTTER_SIZE, paddingTop: 10, paddingBottom: 5 } };
