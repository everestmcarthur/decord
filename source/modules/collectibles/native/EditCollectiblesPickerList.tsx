...
// Dependencies: [32, 19, 17, 21, 4636, 13300, 4632, 12, 9003, 2]
...
let obj = { list: { flex: 1, marginTop: 12 }, listContent: { paddingBottom: 88 }, loadingContainer: { paddingVertical: 80, alignItems: "center" }, header: { paddingHorizontal: fn(13300).GUTTER_SIZE, paddingTop: 10, paddingBottom: 5 } };
