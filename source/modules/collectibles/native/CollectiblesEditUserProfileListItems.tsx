...
// Dependencies: [19, 17, 1371, 1076, 21, 4606, 576, 5174, 4574, 4575, 1178, 13269, 4602, 1114, 7235, 7614, 4573, 13270, 8922, 504, 4264, 8258, 7627, 2]
// Exports: EditCollectiblesListItemNone, EditCollectiblesListItemProduct, EditCollectiblesListItemShop

// Module 13268 (CollectiblesEditUserProfileListItems)
...
export const EditCollectiblesListItemNone = function EditCollectiblesListItemNone(asDefault) {
  ...
  const items = [React5(native.Icon, { source: _modDef13269, size: native.IconSizes.LARGE }), ];
...
export const EditCollectiblesListItemShop = function EditCollectiblesListItemShop(analyticsSource) {
  ...
  analyticsLocations = analyticsLocations(7235)(analyticsSource).analyticsLocations;
  ...
  const items1 = [closure_7(analyticsSource(1178).Icon, { source: analyticsLocations(13270), size: analyticsSource(1178).IconSizes.LARGE }), , ];
  ...
  items1[1] = closure_7(analyticsSource(4602).Text, obj3);
  items1[2] = closure_7(analyticsSource(8922).NewBadge, { style: tmp2.newIcon });
  obj.children = items1;
...
export const EditCollectiblesListItemProduct = function EditCollectiblesListItemProduct(skuId) {
  ...
  if (!result) {
    result = tmp3(7627).isPremiumCollectiblesPurchase(purchase);
  ...
  if (null == purchase) {
    if (!result) {
      ...
      let tmp14 = React5(tmp3(8922).LockBadge, obj6);
    }
    items1[1] = tmp14;
  ...
  if (result) {
    ...
    if (!isTryItOut) {
      if (null == purchase) {
        ...
        tmp15 = React5(tmp3(8922).PremiumBadge, obj7);
      } else {
        tmp15 = null;
      }
    }
