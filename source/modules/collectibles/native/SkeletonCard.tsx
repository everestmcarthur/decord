...
// Function ID: 9028
// Name: SkeletonCard
// Dependencies: [19, 21, 4640, 576, 8920, 4376, 4641, 2]
// Exports: default

// Module 9027 (SkeletonCard)
...
export default function _default(width) {
  ...
  if (COLLECTIBLES_SHOP_CARD_WIDTH === undefined) {
    COLLECTIBLES_SHOP_CARD_WIDTH = sharedValue(8920).COLLECTIBLES_SHOP_CARD_WIDTH;
  }
  let COLLECTIBLES_SHOP_CARD_HEIGHT = width.height;
  sharedValue = undefined;
  if (COLLECTIBLES_SHOP_CARD_HEIGHT == null) {
    COLLECTIBLES_SHOP_CARD_HEIGHT = sharedValue(8920).COLLECTIBLES_SHOP_CARD_HEIGHT;
  }
