...
// Dependencies: [19, 17, 7594, 1076, 1074, 21, 4605, 1483, 8837, 504, 15900, 15905, 5173, 1114, 576, 1242, 7593, 7234, 7606, 8901, 2]
// Exports: default

// Module 15910 (FeaturedCategorySubblock)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import CollectiblesActionCreators from "CollectiblesActionCreators" /* 7593 */;
import VisibilitySensorDefault from "VisibilitySensor" /* 15905 */;
...
export default function _default(subblock) {
  ...
  dependencyMap = subblock(8837).useCollectiblesAnalyticsContext();
  const assetUrl = subblock.assetUrl;
  let obj2 = subblock(8837);
  ...
  let obj5 = { onChange: subblock(15900).useTrackProductCardImpression(subblock.categoryStoreListingId, "mobile_home", "featured_block").handleCardVisibilityChange, children: null };
  let obj4 = subblock(15900);
  ...
  obj6.onPress = function onPress() {
    ...
    if (null != stateFromStores) {
      if (tmp9.isOrbsExclusive) {
        ...
        obj3.analyticsSource = tmp(7234).COLLECTIBLES_SHOP;
  ...
  let result = subblock(7606).shouldShowLimitedTimeBadge(date);
  if (result) {
    const obj11 = { style: tmp.limitedTimeBadge };
    result = tmp11(tmp2(8901).LimitedTimeBadge, obj11);
  }
  items1[1] = result;
  obj6.children = items1;
  obj5.children = tmp13(subblock(5173).PressableOpacity, obj6);
