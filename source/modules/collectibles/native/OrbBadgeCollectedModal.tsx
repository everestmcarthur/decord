...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  const items4 = [tmp13(tmp12(5668), obj8), ];
  ...
  const items5 = [tmp13(modalKey(4632).Text, obj12), ];
  ...
  items5[1] = tmp13(modalKey(4632).Text, obj13);
  ...
  items3[1] = tmp13(modalKey(7226).SafeAreaPaddingView, rect);
  ...
  let obj = {
    screens: {
      [closure_9.ROOT]: {
        ...
        headerRight() {
          return timestampProducer(BalanceWidgetPill.BalanceWidgetPill, { initialRenderedBalance: orbBalancePriorToPurchase, balance: _mod8975.useFetchVirtualCurrencyBalance().balance });
        },
        title: ""
      }
    },
