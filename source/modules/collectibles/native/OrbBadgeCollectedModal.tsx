...
// Dependencies: [19, 17, 4598, 21, 4606, 576, 5675, 4809, 8940, 11185, 504, 5638, 11878, 8393, 11879, 7196, 8935, 4602, 1114, 5026, 8252, 8938, 7073, 2]
// Exports: default

// Module 13255 (OrbBadgeCollectedModal)
import nativeDefault from "native" /* 576 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4809 */;
import NavigatorHeader from "NavigatorHeader" /* 5675 */;
import _mod8940 from "module_8940" /* 8940 */;
import BalanceWidgetPill from "BalanceWidgetPill" /* 11185 */;
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    const obj4 = { uri: onPressViewBadge(11878) };
    obj3.source = obj4;
    obj3.style = tmp.background;
    let tmp9Result = tmp9(onPressViewBadge(5638), obj3);
    let tmp12 = onPressViewBadge;
    let tmp13 = tmp9;
    const tmp15 = onPressViewBadge(5638);
  } else {
    const obj5 = { source: null, poster: null, style: null, resizeMode: "contain", muted: true, pauseWhileAppInactive: true, paused: false };
    const obj6 = { uri: onPressViewBadge(11879) };
    obj5.source = obj6;
    obj5.poster = onPressViewBadge(11878);
    obj5.style = tmp.background;
    tmp9Result = tmp9(tmp2(8393).VideoComponent, obj5);
  ...
  const items4 = [tmp13(tmp12(5638), obj8), ];
  ...
  const items5 = [tmp13(modalKey(4602).Text, obj12), ];
  ...
  items5[1] = tmp13(modalKey(4602).Text, obj13);
  ...
  items3[1] = tmp13(modalKey(7196).SafeAreaPaddingView, rect);
  ...
  let obj = {
    screens: {
      [closure_9.ROOT]: {
        ...
        headerRight() {
          return timestampProducer(BalanceWidgetPill.BalanceWidgetPill, { initialRenderedBalance: orbBalancePriorToPurchase, balance: _mod8940.useFetchVirtualCurrencyBalance().balance });
        },
        title: ""
      }
    },
