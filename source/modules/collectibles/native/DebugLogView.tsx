...
// Function ID: 15949
// Name: DebugLogView
// Dependencies: [19, 17, 4638, 7663, 21, 4639, 576, 504, 4635, 2]
// Exports: default

// Module 15948 (DebugLogView)
...
const CollectiblesDebugStore = fn(7663);
...
export default function DebugLogView() {
  ...
  if (stateFromStores) {
    if (0 !== arr.length) {
      ...
      const items3 = [closure_9(tmp2(4635).Text, obj4), ];
      const obj6 = {
        onPress() {
              closure_1();
            },
      ...
      obj6.children = closure_10(tmp2(4635).Text, obj7);
