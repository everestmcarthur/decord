...
// Function ID: 15910
// Name: DebugLogView
// Dependencies: [19, 17, 4605, 7629, 21, 4606, 576, 504, 4602, 2]
// Exports: default
...
const CollectiblesDebugStore = fn(7629);
...
export default function DebugLogView() {
  ...
  if (stateFromStores) {
    if (0 !== arr.length) {
      ...
      const items3 = [closure_9(tmp2(4602).Text, obj4), ];
      const obj6 = {
        onPress() {
              closure_1();
            },
      ...
      obj6.children = closure_10(tmp2(4602).Text, obj7);
