...
// Function ID: 15991
// Name: DebugLogView
// Dependencies: [19, 17, 4639, 7670, 21, 4640, 576, 504, 4636, 2]
// Exports: default

// Module 15990 (DebugLogView)
...
const CollectiblesDebugStore = fn(7670);
...
export default function DebugLogView() {
  ...
  if (stateFromStores) {
    if (0 !== arr.length) {
      ...
      const items3 = [closure_9(tmp2(4636).Text, obj4), ];
      const obj6 = {
        onPress() {
              closure_1();
            },
      ...
      obj6.children = closure_10(tmp2(4636).Text, obj7);
