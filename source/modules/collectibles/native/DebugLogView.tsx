...
// Function ID: 15969
// Name: DebugLogView
// Dependencies: [19, 17, 4637, 7666, 21, 4638, 576, 504, 4634, 2]
// Exports: default

// Module 15968 (DebugLogView)
...
const CollectiblesDebugStore = fn(7666);
...
export default function DebugLogView() {
  ...
  if (stateFromStores) {
    if (0 !== arr.length) {
      ...
      const items3 = [closure_9(tmp2(4634).Text, obj4), ];
      const obj6 = {
        onPress() {
              closure_1();
            },
      ...
      obj6.children = closure_10(tmp2(4634).Text, obj7);
