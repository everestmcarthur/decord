...
// Function ID: 8968
// Name: WishlistButton
// Dependencies: [5, 32, 19, 17, 502, 1372, 1076, 1085, 21, 4376, 5064, 4639, 576, 4350, 6725, 4491, 4360, 4338, 1115, 4640, 5058, 5062, 8968, 8903, 504, 8899, 8959, 8970, 8898, 2]
// Exports: default

// Module 8967 (WishlistButton)
...
import CollectiblesWishlistUtils from "CollectiblesWishlistUtils" /* 8898 */;
...
let obj2 = { sm: fn(5064).SMALL_BUTTON_HEIGHT, md: fn(5064).MEDIUM_BUTTON_HEIGHT };
