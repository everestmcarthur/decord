...
// Function ID: 8932
// Name: WishlistButton
// Dependencies: [5, 32, 19, 17, 502, 1371, 1076, 1085, 21, 4343, 5032, 4607, 576, 4317, 6692, 4458, 4327, 4305, 1114, 4608, 5026, 5030, 8932, 8867, 504, 8863, 8923, 8934, 8862, 2]
// Exports: default

// Module 8931 (WishlistButton)
...
import CollectiblesWishlistUtils from "CollectiblesWishlistUtils" /* 8862 */;
...
let obj2 = { sm: fn(5032).SMALL_BUTTON_HEIGHT, md: fn(5032).MEDIUM_BUTTON_HEIGHT };
