...
// Function ID: 8979
// Name: WishlistButton
// Dependencies: [5, 32, 19, 17, 502, 1372, 1076, 1085, 21, 4374, 5065, 4638, 576, 4348, 6728, 4489, 4358, 4336, 1115, 4639, 5059, 5063, 8979, 8914, 504, 8910, 8970, 8981, 8909, 2]
// Exports: default

// Module 8978 (WishlistButton)
...
import CollectiblesWishlistUtils from "CollectiblesWishlistUtils" /* 8909 */;
...
let obj2 = { sm: fn(5065).SMALL_BUTTON_HEIGHT, md: fn(5065).MEDIUM_BUTTON_HEIGHT };
