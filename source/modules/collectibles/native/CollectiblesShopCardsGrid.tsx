...
// Dependencies: [19, 17, 7656, 21, 4640, 8920, 8923, 15973, 12, 2]
// Exports: default

// Module 15974 (CollectiblesShopCardsGrid)
...
export default function CollectiblesShopCardsGrid(accessibilityLabel) {
  ...
  obj2.contentContainerStyle = { gap: products(8920).COLLECTIBLES_SHOP_CARD_GAP, paddingTop, paddingBottom, width: cardLayout.rowWidth, alignSelf: "center" };
