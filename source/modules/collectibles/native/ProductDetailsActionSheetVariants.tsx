...
// Dependencies: [19, 17, 21, 4606, 576, 8932, 5174, 1114, 8956, 7206, 7626, 4602, 2]
// Exports: default

// Module 13249 (ProductDetailsActionSheetVariants)
...
function VariantOption(onPress) {
  ...
  if (isPurchased) {
    ...
    let name = intl.formatToPlainString(tmp2(1114).t["SfQB4+"], obj2);
  } else {
    name = variant.name;
  }
