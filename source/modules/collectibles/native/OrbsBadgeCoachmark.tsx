...
// Dependencies: [19, 17, 21, 4605, 11260, 1114, 4463, 11199, 2]
...
function OrbsBadgeCoachmarkImg() {
  ...
  const obj2 = { source: { uri: _modDef11260 }, style: tmp.coachmarkImage };
  obj.children = <hasOwnProperty source={{ uri: _modDef11260 }} style={tmp.coachmarkImage} />;
