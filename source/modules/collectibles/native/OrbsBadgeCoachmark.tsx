...
// Dependencies: [19, 17, 21, 4639, 11327, 1115, 4498, 11266, 2]
// Exports: default, useOrbsBadgeCoachmark

// Module 11326 (OrbsBadgeCoachmark)
...
function OrbsBadgeCoachmarkImg() {
  ...
  const obj2 = { source: { uri: _modDef11327 }, style: tmp.coachmarkImage };
  obj.children = <hasOwnProperty source={{ uri: _modDef11327 }} style={tmp.coachmarkImage} />;
