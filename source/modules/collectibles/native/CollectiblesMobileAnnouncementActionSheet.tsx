...
// Dependencies: [19, 17, 1076, 7347, 1955, 21, 4722, 576, 1478, 6820, 1612, 4458, 17324, 4718, 7737, 7378, 7346, 17325, 1115, 5862, 5144, 2]
// Exports: default

// Module 17323 (CollectiblesMobileAnnouncementActionSheet)
...
import _modDef17324 from "module_17324" /* 17324 */;
...
export default function CollectiblesMobileAnnouncementActionSheet(markAsDismissed) {
  ...
  const obj3 = { source: { uri: _modDef17325 }, style: tmp.framePreviewImage, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants" };
  ...
  items3[1] = closure_9(markAsDismissed(4718).Text, obj5);
  const obj6 = { style: tmp.featureRows, children: null };
  const obj7 = { icon: closure_9(markAsDismissed(5862).PaintIllocon, { size: 32 }), text: null };
  ...
  const obj8 = { icon: closure_9(markAsDismissed(5862).HeartIllocon, { size: 32 }), text: null };
  ...
  const obj9 = { icon: closure_9(markAsDismissed(5862).ShopIllocon, { size: 32 }), text: null };
  ...
  items3[3] = closure_9(markAsDismissed(5144).Button, obj10);
  obj2.children = items3;
  obj.children = closure_10(closure_5, obj2);
  return closure_9(markAsDismissed(7346).BottomSheet, obj);
};
