...
// Dependencies: [19, 17, 1076, 7265, 1955, 21, 4640, 576, 1478, 6738, 1612, 4376, 17194, 4636, 7655, 7296, 7264, 17195, 1115, 5780, 5062, 2]
// Exports: default

// Module 17193 (CollectiblesMobileAnnouncementActionSheet)
...
import _modDef17195 from "module_17195" /* 17195 */;
...
export default function CollectiblesMobileAnnouncementActionSheet(markAsDismissed) {
  ...
  const obj3 = { source: { uri: _modDef17195 }, style: tmp.framePreviewImage, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants" };
  ...
  items3[1] = closure_9(markAsDismissed(4636).Text, obj5);
  const obj6 = { style: tmp.featureRows, children: null };
  const obj7 = { icon: closure_9(markAsDismissed(5780).PaintIllocon, { size: 32 }), text: null };
  ...
  const obj8 = { icon: closure_9(markAsDismissed(5780).HeartIllocon, { size: 32 }), text: null };
  ...
  const obj9 = { icon: closure_9(markAsDismissed(5780).ShopIllocon, { size: 32 }), text: null };
  ...
  items3[3] = closure_9(markAsDismissed(5062).Button, obj10);
  obj2.children = items3;
  obj.children = closure_10(closure_5, obj2);
  return closure_9(markAsDismissed(7264).BottomSheet, obj);
};
