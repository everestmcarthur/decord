...
// Dependencies: [19, 17, 21, 4640, 576, 8997, 9021, 7247, 9022, 8921, 7667, 2]

// Module 9020 (CollectiblesShopCardVariants)
...
import useIsVariantColorLightDefault from "useIsVariantColorLight" /* 9021 */;
import PlusSmallIcon from "PlusSmallIcon" /* 9022 */;
...
export default noop.memo(function CardProductVariants(product) {
  ...
  const tmp = closure_6();
  defaultVariantIndex = defaultVariantIndex(8921).useDefaultVariantIndex(product);
  const obj = defaultVariantIndex(8921);
