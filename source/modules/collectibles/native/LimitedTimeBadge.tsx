...
// Dependencies: [19, 17, 2025, 1183, 21, 4605, 576, 1114, 504, 4456, 7491, 4601, 2]
// Exports: default

// Module 8905 (LimitedTimeBadge)
...
export default function LimitedTimeBadge(unpublishedAt) {
  ...
  if (hasItem) {
    ...
    obj6.children = sum;
    obj5.children = jsx(tmp2(4601).Text, { color: str2, variant: "text-xs/bold", accessibilityLabel: null, allowFontScaling: false, children: null });
