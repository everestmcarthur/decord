...
// Dependencies: [19, 17, 7743, 1888, 7744, 7745, 8452, 9039, 21, 576, 4722, 9051, 9063, 5757, 9064, 9042, 1887, 9059, 2]

// Module 13385 (CollectiblesItemMiniPreview)
...
let closure_8 = fn(8452).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
