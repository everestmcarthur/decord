...
// Dependencies: [19, 17, 7621, 1887, 7622, 7623, 8308, 8892, 21, 576, 4607, 8904, 8916, 5639, 8917, 8895, 1886, 8912, 2]

// Module 13238 (CollectiblesItemMiniPreview)
...
let closure_8 = fn(8308).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
