...
// Dependencies: [5, 32, 19, 17, 8255, 7476, 1074, 1373, 21, 4605, 576, 7033, 10813, 504, 8247, 7214, 11076, 1242, 11086, 573, 4808, 4950, 11087, 1896, 1115, 10826, 4601, 1114, 5025, 2]
// Exports: default

// Module 11085 (CollectiblesShopGiftPurchaseSection)
...
export default function CollectiblesShopGiftPurchaseSection(disabled) {
  ...
  let obj2 = { product, analyticsLocations: giftOptions(giftingOrigin[15])().analyticsLocations, orderId: null, analyticsData: null, onPurchaseComplete: null, onPurchaseError: null, onPurchasePending: null, giftParams: null };
  let id;
  ...
  obj13.onPress = asyncGeneratorStep(async (arg0, value) => {
    if (c2 === 2) {
      c2 = 3;
