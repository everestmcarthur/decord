...
// Dependencies: [1074, 4500, 4497, 4498, 4466, 4479, 2]
// Exports: convertRouteToNavigation

// Module 12942 (convertRouteToNavigation)
  ...
  if (null != rootNavigationRef) {
    if (rootNavigationRef.isReady()) {
      if (pathname.startsWith("/channels/")) {
        ...
        const RouteParam = tmp(4479).RouteParam;
        const obj5 = Routes;
        const tmpResult = tmp(4466);
        const RouteParam2 = tmp(4479).RouteParam;
        ...
        if (null != tmpResult.matchPath(pathname, obj2)) {
          ...
          const RouteParam6 = tmp(4479).RouteParam;
          const tmpResult15 = tmp(4466);
          const RouteParam7 = tmp(4479).RouteParam;
          ...
          if (null != matchPathResult) {
            ...
            if (tmpResult16.getChatLayout().isChatLockedOpen) {
              ...
              tmp(4497).navigateToRootTab(obj11);
              const tmpResult25 = tmp(4497);
            }
            return true;
          }
      ...
      if (pathname.startsWith("/member-verification/")) {
        ...
        const RouteParam5 = tmp(4479).RouteParam;
        obj12.path = Routes.GUILD_MEMBER_VERIFICATION(RouteParam5.guildId());
        const matchPathResult1 = tmp(4466).matchPath(pathname, obj12);
        if (null != matchPathResult1) {
          const result = tmp(4497).navigateToMemberVerification(matchPathResult1.params.guildId, matchPathResult1.params.inviteCode);
          const tmpResult27 = tmp(4497);
        }
        return true;
      } else {
        ...
        tmp(4497).resetToAuthRoute();
        flag = true;
        const tmpResult28 = tmp(4497);
      }
    }
  }
  return true;
