...
// Dependencies: [1957, 1074, 4618, 4619, 1100, 4807, 38, 2]
...
export const transitionToChannel = function transitionToChannel(id, openTextInVoiceIfVoiceChannel) {
  ...
  if (null != channel) {
    ...
    if (prop) {
      tmp7(4807).updateChatOpen(channel.id, true);
      const tmp7Result = tmp7(4807);
    }
...
export const tryTransitionToThreadMessage = function tryTransitionToThreadMessage(parentChannelId, threadId, messageId, arg3) {
  ...
  if (null != channel) {
    ...
    if (null != channel1) {
      ...
      if (prop) {
        tmp20(4807).updateChatOpen(channel1.id, true);
        const tmp20Result = tmp20(4807);
      }
