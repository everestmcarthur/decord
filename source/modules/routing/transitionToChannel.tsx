...
// Dependencies: [1957, 1074, 4619, 4620, 1100, 4808, 38, 2]
...
// Module 4618 (transitionToChannel)
import _modDef38 from "module_38" /* 38 */;
import router_utils from "router_utils" /* 1100 */;
import useGuildIdForChannelRoute from "useGuildIdForChannelRoute" /* 4619 */;
...
export const transitionToChannel = function transitionToChannel(id, openTextInVoiceIfVoiceChannel) {
  ...
  if (null != channel) {
    ...
    if (prop) {
      tmp7(4808).updateChatOpen(channel.id, true);
      const tmp7Result = tmp7(4808);
    }
...
export const tryTransitionToThreadMessage = function tryTransitionToThreadMessage(parentChannelId, threadId, messageId, arg3) {
  ...
  if (null != channel) {
    ...
    if (null != channel1) {
      ...
      if (prop) {
        tmp20(4808).updateChatOpen(channel1.id, true);
        const tmp20Result = tmp20(4808);
      }
