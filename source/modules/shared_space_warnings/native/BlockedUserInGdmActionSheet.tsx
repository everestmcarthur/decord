...
// Dependencies: [19, 17, 1958, 1372, 13853, 1074, 21, 4640, 576, 4636, 4792, 1115, 504, 1370, 1177, 11977, 11067, 4599, 4594, 1241, 7311, 11528, 5775, 5693, 5062, 4607, 13854, 4653, 2]
// Exports: default

// Module 13852 (BlockedUserInGdmActionSheet)
...
import SharedSpacesWarningActionCreators from "SharedSpacesWarningActionCreators" /* 13854 */;
...
function UserCalloutAvatars(userIds) {
  ...
  if (1 === userIds.length) {
    if (null != UserStore.getUser(userIds[0])) {
      ...
      tmp6 = closure_11(tmp(11977).UserIcon, {});
    }
  } else {
    const obj4 = { users: found, size: tmp(1177).AvatarSizes.REFRESH_MEDIUM_32 };
    return closure_11(tmp(11067).FacepileGroupDMAvatar, obj4);
  }
}
...
const SharedSpaceWarningConstants = fn(13853);
