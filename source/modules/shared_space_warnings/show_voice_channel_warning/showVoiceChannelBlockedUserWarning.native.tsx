...
// Dependencies: [1895, 13791, 13794, 1093, 4574, 13797, 1896, 1250, 2]
// Exports: showVoiceChannelBlockedUserWarning

// Module 13796 (showVoiceChannelBlockedUserWarning)
...
const constants = fn(13794).VoiceChannelWarningSurfaces;
const size = fn(2);
...
export const showVoiceChannelBlockedUserWarning = function showVoiceChannelBlockedUserWarning(channelId, items1) {
  ...
  if (state === ConstantsIOS.AppStates.ACTIVE) {
    ...
    obj.openLazy(tmp2(1896)(13797, dependencyMap.paths), "gdm_blocked_user_action_sheet", obj2);
    const tmp11 = tmp2(1896)(13797, dependencyMap.paths);
  } else {
    React4();
  }
};
