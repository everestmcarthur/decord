...
// Dependencies: [1895, 13810, 13813, 1093, 4572, 13816, 1896, 1250, 2]
// Exports: showVoiceChannelBlockedUserWarning

// Module 13815 (showVoiceChannelBlockedUserWarning)
...
const constants = fn(13813).VoiceChannelWarningSurfaces;
const size = fn(2);
...
export const showVoiceChannelBlockedUserWarning = function showVoiceChannelBlockedUserWarning(channelId, items1) {
  ...
  if (state === ConstantsIOS.AppStates.ACTIVE) {
    ...
    obj.openLazy(tmp2(1896)(13816, dependencyMap.paths), "gdm_blocked_user_action_sheet", obj2);
    const tmp11 = tmp2(1896)(13816, dependencyMap.paths);
  } else {
    React4();
  }
};
