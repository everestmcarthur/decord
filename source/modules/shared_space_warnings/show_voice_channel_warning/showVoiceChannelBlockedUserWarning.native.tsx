...
// Dependencies: [1896, 13850, 13853, 1094, 4607, 13856, 1897, 1249, 2]
// Exports: showVoiceChannelBlockedUserWarning

// Module 13855 (showVoiceChannelBlockedUserWarning)
...
const constants = fn(13853).VoiceChannelWarningSurfaces;
const size = fn(2);
...
export const showVoiceChannelBlockedUserWarning = function showVoiceChannelBlockedUserWarning(channelId, items1) {
  ...
  if (state === ConstantsIOS.AppStates.ACTIVE) {
    ...
    obj.openLazy(tmp2(1897)(13856, dependencyMap.paths), "gdm_blocked_user_action_sheet", obj2);
    const tmp11 = tmp2(1897)(13856, dependencyMap.paths);
  } else {
    React4();
  }
};
