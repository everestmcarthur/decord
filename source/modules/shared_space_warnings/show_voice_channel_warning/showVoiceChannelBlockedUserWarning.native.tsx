...
// Dependencies: [1895, 13823, 13826, 1093, 4603, 13829, 1896, 1250, 2]
// Exports: showVoiceChannelBlockedUserWarning

// Module 13828 (showVoiceChannelBlockedUserWarning)
...
export const showVoiceChannelBlockedUserWarning = function showVoiceChannelBlockedUserWarning(channelId, items1) {
  ...
  if (state === ConstantsIOS.AppStates.ACTIVE) {
    ...
    obj.openLazy(tmp2(1896)(13829, dependencyMap.paths), "gdm_blocked_user_action_sheet", obj2);
    const tmp11 = tmp2(1896)(13829, dependencyMap.paths);
  } else {
    React4();
  }
};
