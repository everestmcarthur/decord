...
// Dependencies: [19, 17, 1955, 21, 4722, 576, 1612, 7346, 6820, 4718, 1115, 1177, 5144, 2]
// Exports: default

// Module 10506 (MediaPostMultipleThumbnailActionSheet)
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4718).Text, obj6), closure_5(markAsDismissed(1177).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4718).Text, obj7);
  ...
  items2[3] = closure_5(markAsDismissed(4718).Text, obj8);
  ...
  items2[5] = closure_5(markAsDismissed(5144).Button, obj9);
  obj3.children = items2;
  obj2.children = closure_6(markAsDismissed(6820).BottomSheetScrollView, obj3);
  obj.children = closure_5(View, obj2);
  return closure_5(markAsDismissed(7346).BottomSheet, obj);
};
