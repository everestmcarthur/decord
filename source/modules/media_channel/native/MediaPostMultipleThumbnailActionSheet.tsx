...
// Dependencies: [19, 17, 1954, 21, 4606, 576, 1611, 7223, 6698, 4602, 1114, 1178, 5026, 2]
// Exports: default

// Module 10354 (MediaPostMultipleThumbnailActionSheet)
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4602).Text, obj6), closure_5(markAsDismissed(1178).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4602).Text, obj7);
  ...
  items2[3] = closure_5(markAsDismissed(4602).Text, obj8);
  ...
  items2[5] = closure_5(markAsDismissed(5026).Button, obj9);
  obj3.children = items2;
  obj2.children = closure_6(markAsDismissed(6698).BottomSheetScrollView, obj3);
  obj.children = closure_5(View, obj2);
  return closure_5(markAsDismissed(7223).BottomSheet, obj);
};
