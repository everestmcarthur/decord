...
// Dependencies: [19, 17, 1954, 21, 4574, 576, 1611, 7164, 6641, 4570, 1114, 1178, 4989, 2]
// Exports: default

// Module 10297 (MediaPostMultipleThumbnailActionSheet)
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4570).Text, obj6), closure_5(markAsDismissed(1178).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4570).Text, obj7);
  ...
  items2[3] = closure_5(markAsDismissed(4570).Text, obj8);
  ...
  items2[5] = closure_5(markAsDismissed(4989).Button, obj9);
