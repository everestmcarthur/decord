...
// Dependencies: [19, 17, 1954, 21, 4605, 576, 1611, 7202, 6677, 4601, 1114, 1178, 5025, 2]
// Exports: default

// Module 10335 (MediaPostMultipleThumbnailActionSheet)
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4601).Text, obj6), closure_5(markAsDismissed(1178).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4601).Text, obj7);
  ...
  items2[3] = closure_5(markAsDismissed(4601).Text, obj8);
  ...
  items2[5] = closure_5(markAsDismissed(5025).Button, obj9);
  obj3.children = items2;
  obj2.children = closure_6(markAsDismissed(6677).BottomSheetScrollView, obj3);
