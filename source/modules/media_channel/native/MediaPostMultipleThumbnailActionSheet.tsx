...
// Dependencies: [19, 17, 1954, 21, 4607, 576, 1611, 7224, 6699, 4603, 1114, 1178, 5027, 2]
// Exports: default

// Module 10356 (MediaPostMultipleThumbnailActionSheet)
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4603).Text, obj6), closure_5(markAsDismissed(1178).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4603).Text, obj7);
  ...
  items2[3] = closure_5(markAsDismissed(4603).Text, obj8);
  ...
  items2[5] = closure_5(markAsDismissed(5027).Button, obj9);
  obj3.children = items2;
  obj2.children = closure_6(markAsDismissed(6699).BottomSheetScrollView, obj3);
  obj.children = closure_5(View, obj2);
  return closure_5(markAsDismissed(7224).BottomSheet, obj);
};
