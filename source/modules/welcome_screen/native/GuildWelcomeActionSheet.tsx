...
// Dependencies: [19, 17, 5629, 1958, 1980, 4361, 12896, 12900, 1074, 1375, 1085, 21, 4722, 576, 5694, 504, 4875, 1101, 4689, 5757, 1397, 4375, 4718, 1177, 12047, 8831, 573, 12898, 1241, 7393, 12901, 1115, 2]
// Exports: default

// Module 12899 (GuildWelcomeActionSheet)
...
import WelcomeScreenStore from "WelcomeScreenStore" /* 12896 */;
...
const NO_WELCOME_SCREEN = fn(12896).NO_WELCOME_SCREEN;
const WELCOME_SCREEN_TYPE = fn(12900).WELCOME_SCREEN_TYPE;
...
export default function GuildWelcomeActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != welcomeScreen) {
      ...
      const obj5 = { style: tmp.guildIcon, guild: stateFromStores, size: onHide(12901).Sizes.MEDIUM, textScale: 2 };
      const items9 = [closure_17(onHide(12901), obj5), , , , ];
      ...
      tmp12 = closure_17(tmp2(7393).ActionSheet, obj3);
