...
// Dependencies: [19, 17, 5547, 1958, 1980, 4278, 12805, 12809, 1074, 1375, 1085, 21, 4640, 576, 5612, 504, 4793, 1101, 4607, 5675, 1397, 4292, 4636, 1177, 11956, 8748, 573, 12807, 1241, 7311, 12810, 1115, 2]
// Exports: default

// Module 12808 (GuildWelcomeActionSheet)
...
import WelcomeScreenStore from "WelcomeScreenStore" /* 12805 */;
...
const NO_WELCOME_SCREEN = fn(12805).NO_WELCOME_SCREEN;
const WELCOME_SCREEN_TYPE = fn(12809).WELCOME_SCREEN_TYPE;
...
export default function GuildWelcomeActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != welcomeScreen) {
      ...
      const obj5 = { style: tmp.guildIcon, guild: stateFromStores, size: onHide(12810).Sizes.MEDIUM, textScale: 2 };
      const items9 = [closure_17(onHide(12810), obj5), , , , ];
      ...
      tmp12 = closure_17(tmp2(7311).ActionSheet, obj3);
