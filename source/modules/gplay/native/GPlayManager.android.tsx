...
// Function ID: 10842
// Name: GPlayManager
// Dependencies: [109, 5, 19, 17, 7527, 7528, 502, 4303, 7344, 9500, 7345, 1074, 4621, 1374, 21, 3, 7347, 573, 9499, 1240, 4231, 7536, 4312, 4963, 1241, 4984, 1115, 10842, 1897, 4842, 7519, 2]

// Module 10841 (GPlayManager)
import LoggerDefault from "Logger" /* 3 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import actions_BillingActionCreators from "actions/BillingActionCreators" /* 4963 */;
import GPlayActionCreators from "GPlayActionCreators" /* 9499 */;
...
const useGPlayAnalyticsStore = fn(9500).useGPlayAnalyticsStore;
let Constants = fn(7345);
...
let closure_28 = null;
let closure_29 = null;
const items = [fn(7347).ProductIds.PREMIUM_TIER_2_MONTHLY];
const size = fn(2);
