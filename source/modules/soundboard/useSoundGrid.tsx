...
// Function ID: 17213
// Name: useSoundGrid
// Dependencies: [32, 19, 1958, 1980, 4278, 2012, 1372, 5096, 5098, 1374, 5104, 4533, 17213, 504, 4297, 17214, 9803, 17215, 5076, 17216, 2]
  ...
  return allSounds.useMemo(() => {
    ...
    if (flag2) {
      ...
      if (undefined !== stateFromStores1) {
        ...
        if (!tmp26) {
          const obj8 = { type: tmp13(5104).SoundboardSoundItemType.ADD_SOUND, guild: tmp23 };
          mapped.push(obj8);
        }
        if (tmp28) {
          tmp28 = tmp25;
        ...
        if (!tmp28) {
          ...
          const obj10 = { type: tmp13(5104).SoundboardSoundGridSectionType.GUILD, guild: tmp23, isNitroLocked: false };
      ...
      if (!c11) {
        ...
        const obj11 = { key: tmp13(5104).SoundboardSoundGridSectionType.DEFAULTS, categoryInfo: null, items: null };
        const obj12 = { type: tmp13(5104).SoundboardSoundGridSectionType.DEFAULTS };
        obj11.categoryInfo = obj12;
        const sortSoundsOldestToNewestCreationDate = tmp13(17213).sortSoundsOldestToNewestCreationDate;
        let result1 = value7;
      ...
      if (tmp30) {
        ...
        const obj14 = { key: tmp13(5104).SoundboardSoundGridSectionType.DEFAULTS, categoryInfo: null, items: null };
        const obj15 = { type: tmp13(5104).SoundboardSoundGridSectionType.DEFAULTS };
        obj14.categoryInfo = obj15;
        const sortSoundsOldestToNewestCreationDate2 = tmp13(17213).sortSoundsOldestToNewestCreationDate;
        let result2 = value8;
