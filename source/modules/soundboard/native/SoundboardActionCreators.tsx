...
// Dependencies: [1074, 4689, 17435, 1897, 1110, 2]
// Exports: openSoundboardSoundPickerActionSheet, showSoundboardSoundPickerActionSheet

// Module 17434 (soundboard/SoundboardActionCreators)
...
export const openSoundboardSoundPickerActionSheet = function openSoundboardSoundPickerActionSheet(arg0) {
  ...
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(17435, dependencyMap.paths), "SoundboardSoundPickerActionSheet", { channel, analyticsSource, initialScrollLocation });
};
export const showSoundboardSoundPickerActionSheet = function showSoundboardSoundPickerActionSheet(arg0) {
  ...
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(17435, dependencyMap.paths), "SoundboardSoundPickerActionSheet", { channel: channel2, analyticsSource: analyticsSource2, initialScrollLocation });
};
