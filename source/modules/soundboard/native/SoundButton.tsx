...
// Function ID: 17219
// Name: SoundButton
// Dependencies: [19, 17, 17211, 21, 4376, 4639, 576, 1364, 5207, 5058, 7237, 12069, 17219, 17220, 7269, 7289, 17222, 17208, 17224, 4635, 5179, 2]

// Module 17218 (SoundButton)
...
import getSoundboardEmojiUrlDefault from "getSoundboardEmojiUrl" /* 12069 */;
import openSoundboardSoundPreviewActionSheetDefault from "openSoundboardSoundPreviewActionSheet" /* 17224 */;
...
function SoundButtonEmoji(arg0) {
  ...
  fn.__closure = { animationConfig, withDelay: animationConfig(4376).withDelay, withSpring: animationConfig(5058).withSpring, interpolate: animationConfig(4376).interpolate, SPRING_CONFIG };
  ...
  const obj3 = { animationConfig, withDelay: animationConfig(4376).withDelay, withSpring: animationConfig(5058).withSpring, interpolate: animationConfig(4376).interpolate, SPRING_CONFIG };
  ...
  fn2.__closure = { animationConfig: obj4, withDelay: animationConfig(4376).withDelay, withSpring: animationConfig(5058).withSpring, interpolate: animationConfig(4376).interpolate, SPRING_CONFIG };
  ...
  const obj6 = { animationConfig: obj4, withDelay: animationConfig(4376).withDelay, withSpring: animationConfig(5058).withSpring, interpolate: animationConfig(4376).interpolate, SPRING_CONFIG };
...
obj.button = { marginTop: 4, height: fn(17211).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
let obj2 = { marginTop: 4, height: fn(17211).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
...
let ReanimatedRexport = ReanimatedRexport_mod;
let closure_10 = ReanimatedRexport.createAnimatedComponent(fn(5207).PressableOpacity);
