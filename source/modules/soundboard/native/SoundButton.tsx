...
// Function ID: 17163
// Name: SoundButton
// Dependencies: [19, 17, 17155, 21, 4341, 4605, 576, 1115, 5173, 5024, 7182, 12005, 17163, 17164, 7214, 7234, 17166, 17152, 17168, 4601, 5145, 2]
...
function SoundButtonEmoji(arg0) {
  ...
  const obj2 = animationConfig(4341);
  fn.__closure = { animationConfig, withDelay: animationConfig(4341).withDelay, withSpring: animationConfig(5024).withSpring, interpolate: animationConfig(4341).interpolate, SPRING_CONFIG };
  ...
  const obj3 = { animationConfig, withDelay: animationConfig(4341).withDelay, withSpring: animationConfig(5024).withSpring, interpolate: animationConfig(4341).interpolate, SPRING_CONFIG };
  ...
  const obj5 = animationConfig(4341);
  fn2.__closure = { animationConfig: obj4, withDelay: animationConfig(4341).withDelay, withSpring: animationConfig(5024).withSpring, interpolate: animationConfig(4341).interpolate, SPRING_CONFIG };
  ...
  const obj6 = { animationConfig: obj4, withDelay: animationConfig(4341).withDelay, withSpring: animationConfig(5024).withSpring, interpolate: animationConfig(4341).interpolate, SPRING_CONFIG };
...
obj.button = { marginTop: 4, height: fn(17155).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
let obj2 = { marginTop: 4, height: fn(17155).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
