...
// Function ID: 17104
// Name: SoundButton
// Dependencies: [19, 17, 17096, 21, 4310, 4574, 576, 1115, 5137, 4988, 7144, 11965, 17104, 17105, 7176, 7196, 17107, 17093, 17109, 4570, 5109, 2]

// Module 17103 (SoundButton)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport2 from "ReanimatedRexport" /* 4310 */;
import spring from "spring" /* 4988 */;
import EmojiDefault from "Emoji" /* 7144 */;
import getSoundboardEmojiUrlDefault from "getSoundboardEmojiUrl" /* 11965 */;
import openSoundboardSoundPreviewActionSheetDefault from "openSoundboardSoundPreviewActionSheet" /* 17109 */;
...
function SoundButtonEmoji(arg0) {
  ...
  const obj2 = animationConfig(4310);
  fn.__closure = { animationConfig, withDelay: animationConfig(4310).withDelay, withSpring: animationConfig(4988).withSpring, interpolate: animationConfig(4310).interpolate, SPRING_CONFIG };
  ...
  const obj3 = { animationConfig, withDelay: animationConfig(4310).withDelay, withSpring: animationConfig(4988).withSpring, interpolate: animationConfig(4310).interpolate, SPRING_CONFIG };
  ...
  const obj5 = animationConfig(4310);
  fn2.__closure = { animationConfig: obj4, withDelay: animationConfig(4310).withDelay, withSpring: animationConfig(4988).withSpring, interpolate: animationConfig(4310).interpolate, SPRING_CONFIG };
  ...
  const obj6 = { animationConfig: obj4, withDelay: animationConfig(4310).withDelay, withSpring: animationConfig(4988).withSpring, interpolate: animationConfig(4310).interpolate, SPRING_CONFIG };
...
obj.button = { marginTop: 4, height: fn(17096).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
let obj2 = { marginTop: 4, height: fn(17096).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
...
let ReanimatedRexport = ReanimatedRexport_mod;
let closure_10 = ReanimatedRexport.createAnimatedComponent(fn(5137).PressableOpacity);
