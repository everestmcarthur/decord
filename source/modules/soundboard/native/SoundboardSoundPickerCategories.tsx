...
// Dependencies: [19, 17, 17266, 1372, 1074, 21, 4638, 576, 5105, 5670, 1115, 10531, 4600, 17282, 8855, 5208, 1177, 5180, 4606, 4607, 504, 4295, 10105, 1612, 6763, 4511, 8373, 2]

// Module 17284 (SoundboardSoundPickerCategories)
...
function SoundCategoryItem(style) {
  ...
  if (SoundboardTypes.SoundboardSoundGridSectionType.GUILD === type) {
    ...
    let tmp6 = null;
    let tmp7 = null;
  } else if (tmp2(5105).SoundboardSoundGridSectionType.FAVORITES === type) {
    const intl4 = tmp2(1115).intl;
    name = intl4.string(tmp2(1115).t.y3LQCG);
    tmp6 = _modDef10531;
    tmp7 = null;
    tmp14Result = null;
  } else if (tmp2(5105).SoundboardSoundGridSectionType.FREQUENTLY_USED === type) {
    const intl3 = tmp2(1115).intl;
    name = intl3.string(tmp2(1115).t["+cGVV6"]);
    const obj = { style: tmp.keyboardItem };
    tmp7 = closure_1_10(tmp2(4600).ClockIcon, obj);
    tmp6 = null;
    tmp14Result = null;
  } else if (tmp2(5105).SoundboardSoundGridSectionType.DEFAULTS === type) {
    const intl2 = tmp2(1115).intl;
    name = intl2.string(tmp2(1115).t.Rtvk9X);
    tmp6 = _modDef17282;
    tmp7 = null;
    tmp14Result = null;
  } else if (tmp2(5105).SoundboardSoundGridSectionType.SEARCH === type) {
    ...
    tmp14Result = null;
    name = null;
    if (tmp2(5105).SoundboardSoundGridSectionType.TOP_SOUNDS === type) {
      ...
      tmp7 = closure_1_10(tmp2(8855).TrophyIcon, obj4);
      tmp6 = null;
      tmp14Result = null;
    }
  }
  ...
  if (locked) {
    ...
    obj8.children = tmp14(tmp2(5180).LockIcon, obj9);
...
const setSearchQuery = fn(17266).setSearchQuery;
