...
// Dependencies: [19, 17, 17210, 1372, 1074, 21, 4639, 576, 5104, 5669, 1115, 10523, 4602, 17226, 8845, 5207, 1177, 5179, 4607, 4608, 504, 4297, 10097, 1612, 6760, 4512, 8364, 2]

// Module 17228 (SoundboardSoundPickerCategories)
...
function SoundCategoryItem(style) {
  ...
  if (SoundboardTypes.SoundboardSoundGridSectionType.GUILD === type) {
    ...
    let tmp6 = null;
    let tmp7 = null;
  } else if (tmp2(5104).SoundboardSoundGridSectionType.FAVORITES === type) {
    const intl4 = tmp2(1115).intl;
    name = intl4.string(tmp2(1115).t.y3LQCG);
    tmp6 = _modDef10523;
    tmp7 = null;
    tmp14Result = null;
  } else if (tmp2(5104).SoundboardSoundGridSectionType.FREQUENTLY_USED === type) {
    const intl3 = tmp2(1115).intl;
    name = intl3.string(tmp2(1115).t["+cGVV6"]);
    const obj = { style: tmp.keyboardItem };
    tmp7 = closure_1_10(tmp2(4602).ClockIcon, obj);
    tmp6 = null;
    tmp14Result = null;
  } else if (tmp2(5104).SoundboardSoundGridSectionType.DEFAULTS === type) {
    const intl2 = tmp2(1115).intl;
    name = intl2.string(tmp2(1115).t.Rtvk9X);
    tmp6 = _modDef17226;
    tmp7 = null;
    tmp14Result = null;
  } else if (tmp2(5104).SoundboardSoundGridSectionType.SEARCH === type) {
    ...
    tmp14Result = null;
    name = null;
    if (tmp2(5104).SoundboardSoundGridSectionType.TOP_SOUNDS === type) {
      ...
      tmp7 = closure_1_10(tmp2(8845).TrophyIcon, obj4);
      tmp6 = null;
      tmp14Result = null;
    }
  }
  ...
  if (locked) {
    ...
    obj8.children = tmp14(tmp2(5179).LockIcon, obj9);
...
const setSearchQuery = fn(17210).setSearchQuery;
