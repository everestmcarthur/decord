...
// Dependencies: [5, 1220, 1962, 4278, 1372, 5096, 5098, 1074, 1218, 1936, 4297, 7452, 7445, 7453, 573, 7480, 7481, 7482, 563, 4484, 1944, 1941, 5104, 1241, 4819, 2]
...
import VoiceChannelEffectsActionCreators from "VoiceChannelEffectsActionCreators" /* 7453 */;
import getCurrentVoiceChannelDefault from "getCurrentVoiceChannel" /* 7480 */;
              ...
              if (null != customJoinSound) {
                if (tmp50Result.canUseCustomCallSounds(currentUser)) {
                  if (tmp53Result.canSelectedVoiceChannelUseSoundboard()) {
                    c3 = 1;
                    c4 = 1;
                    const obj4 = { value: tmp53(7445).maybeFetchSoundboardSounds(), done: false };
                    return obj4;
                  }
                  tmp53Result = tmp53(7482);
                }
            ...
            if (closure_130_15(closure_129_0, sound, closure_129_1, true)) {
              ...
              if (closure_130_16(closure_129_1)) {
                (function playCustomJoinSound(sound, id) {
                  closure_1_0(7445).playSoundLocally(id, sound);
                  const obj = closure_1_0(7445);
                  const result = closure_1_0(7453).sendVoiceChannelCustomCallSoundEffect(id, sound, false);
...
export const updateCustomJoinSound = function updateCustomJoinSound(guildId, arg1, location_stack) {
  ...
  const result = require("UserSettingsProtoActionCreators").updateUserGuildSettings(guildId, (joinSound) => {
    ...
    if (null != joinSound.joinSound) {
      let ADDED = tmp6(5104).AnalyticsChangeType.UPDATED;
    } else {
      ADDED = tmp6(5104).AnalyticsChangeType.ADDED;
    }
    ...
    obj2.sound_type = tmp6(5104).AnalyticsSoundType.ENTRY;
