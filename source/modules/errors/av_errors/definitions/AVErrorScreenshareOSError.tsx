...
// Dependencies: [1364, 9253, 18044, 4690, 2]

// Module 18055 (AVErrorScreenshareOSError)
  ...
  getActiveErrors(activeStreams) {
    ...
    return found.map((errorCode) => {
      ...
      if (obj2.isMac()) {
        ...
        const tmpResult = tmp(18044);
        const merged = Object.assign(tmpResult.getStreamErrorContext(tmp(4690).encodeStreamKey(errorCode)));
        return obj;
      }
