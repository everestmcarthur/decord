...
// Dependencies: [1364, 9264, 18108, 4692, 2]
  ...
  getActiveErrors(activeStreams) {
    ...
    return found.map((errorCode) => {
      ...
      if (obj2.isMac()) {
        ...
        const tmpResult = tmp(18108);
        const merged = Object.assign(tmpResult.getStreamErrorContext(tmp(4692).encodeStreamKey(errorCode)));
        return obj;
      }
