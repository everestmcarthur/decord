...
// Dependencies: [5, 17, 1074, 1085, 675, 3, 1233, 1101, 1241, 14290, 7798, 7803, 1357, 1231, 1363, 7799, 1364, 4701, 1609, 1358, 1344, 2]
// Exports: initSentry
...
function trackCrash(event, hint, arg2) {
  ...
  const AppCrashedReasons = tmp11(14290).AppCrashedReasons;
  ...
  items[1] = "level:" + level;
  obj6.tags = items;
  tmp26(7798).increment(obj6, true);
}
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          const obj3 = { tunnel: `/error-reporting-proxy/${str2}`, autoInitializeNativeSdk: false, beforeSend, dist: "6453", dsn: SentryStaffDsn, environment: ReleaseChannel, tracesSampleRate: 0, sampleRate: 1, ignoreErrors, release: "discord_android@347.4.0-2+347204", tracePropagationTargets: null, integrations: null, beforeBreadcrumb: null };
          ...
          require("module_675").setTag("buildNumber", "6453");
