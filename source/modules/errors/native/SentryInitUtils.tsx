...
// Dependencies: [5, 17, 1074, 1085, 675, 3, 1234, 1100, 1242, 14108, 7616, 7621, 1358, 1232, 1364, 7617, 1115, 4553, 1608, 1359, 1345, 2]
// Exports: initSentry
...
function trackCrash(event, hint, arg2) {
  ...
  const AppCrashedReasons = tmp11(14108).AppCrashedReasons;
  ...
  items[1] = "level:" + level;
  obj6.tags = items;
  tmp26(7616).increment(obj6, true);
}
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          const obj3 = { tunnel: `/error-reporting-proxy/${str2}`, autoInitializeNativeSdk: false, beforeSend, dist: "6385", dsn: SentryStaffDsn, environment: ReleaseChannel, tracesSampleRate: 0, sampleRate: 1, ignoreErrors, release: "discord_android@346.2.0-2+346202", tracePropagationTargets: null, integrations: null, beforeBreadcrumb: null };
          ...
          require("module_675").setTag("buildNumber", "6385");
