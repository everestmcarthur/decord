...
// Dependencies: [5, 17, 1074, 1085, 675, 3, 1233, 1101, 1241, 14174, 7707, 7712, 1357, 1231, 1363, 7708, 1364, 4618, 1609, 1358, 1344, 2]
// Exports: initSentry
...
function trackCrash(event, hint, arg2) {
  ...
  const AppCrashedReasons = tmp11(14174).AppCrashedReasons;
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          require("module_675").setTag("buildNumber", "6425");
