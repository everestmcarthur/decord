...
// Dependencies: [5, 17, 1074, 1085, 675, 3, 1233, 1101, 1241, 14187, 7710, 7715, 1357, 1231, 1363, 7711, 1364, 4617, 1609, 1358, 1344, 2]
// Exports: initSentry
...
function trackCrash(event, hint, arg2) {
  ...
  const AppCrashedReasons = tmp11(14187).AppCrashedReasons;
  ...
  items[1] = "level:" + level;
  obj6.tags = items;
  tmp26(7710).increment(obj6, true);
}
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          const obj3 = { tunnel: `/error-reporting-proxy/${str2}`, autoInitializeNativeSdk: false, beforeSend, dist: "6437", dsn: SentryStaffDsn, environment: ReleaseChannel, tracesSampleRate: 0, sampleRate: 1, ignoreErrors, release: "discord_android@347.2.0-2+347202", tracePropagationTargets: null, integrations: null, beforeBreadcrumb: null };
          ...
          require("module_675").setTag("buildNumber", "6437");
