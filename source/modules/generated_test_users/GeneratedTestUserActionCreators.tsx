...
// Dependencies: [5, 1386, 15706, 1074, 8529, 6701, 8534, 4831, 1249, 573, 15730, 2]
// Exports: getGeneratedPoolById, loginAsGeneratedUser, removeGeneratedPoolFromList

// Module 15729 (GeneratedTestUserActionCreators)
...
let closure_8 = async function _getGeneratedPoolById() {
  ...
  await value.then((body) => {
    ...
    if (body.ok) {
      ...
      const GeneratedTestPoolRecord = closure_0(15730).GeneratedTestPoolRecord;
      ...
      closure_1(8534).showFailedToast(constants.GENERIC_ERROR);
      const obj = closure_1(8534);
    }
  }).catch(() => {
    closure_1_1(8534).showFailedToast(constants.GENERIC_ERROR);
    return null;
  });
  return arg1;
};
