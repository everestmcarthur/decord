...
// Dependencies: [5, 1386, 15688, 1074, 8520, 6698, 8525, 4832, 1249, 573, 15712, 2]
// Exports: getGeneratedPoolById, loginAsGeneratedUser, removeGeneratedPoolFromList

// Module 15711 (GeneratedTestUserActionCreators)
...
let closure_8 = async function _getGeneratedPoolById() {
  ...
  await value.then((body) => {
    ...
    if (body.ok) {
      ...
      const GeneratedTestPoolRecord = closure_0(15712).GeneratedTestPoolRecord;
      ...
      closure_1(8525).showFailedToast(constants.GENERIC_ERROR);
      const obj = closure_1(8525);
    }
  }).catch(() => {
    closure_1_1(8525).showFailedToast(constants.GENERIC_ERROR);
    return null;
  });
  return arg1;
};
