...
// Function ID: 17963
// Name: OverviewScreen
// Dependencies: [19, 21, 4605, 17963, 1483, 17964, 8486, 8487, 5023, 576, 4601, 1114, 2690, 5737, 8647, 17958, 11997, 17965, 11068, 2]
// Exports: default

// Module 17962 (OverviewScreen)
import SafetyFlowsUtils from "SafetyFlowsUtils" /* 17964 */;
...
export default function OverviewScreen() {
  let tmp = closure_6();
  task = task(17963).useSafetyFlowTask().task;
  let obj = task(17963);
  ...
  const items1 = [closure_4(task(4601).Text, obj4), , ];
  ...
  items1[1] = closure_4(task(4601).Text, obj5);
  ...
  if (flow_context != null) {
    ...
    if (tasks != null) {
      mapped = tasks.map((task_type, index) => {
        const obj = { tip: task(17958).TASK_TYPE_TO_TITLE[task_type.task_type], index: index + 1 };
        return closure_1_4(navigation(8647), obj, task_type.task_type);
      });
    }
  }
  const obj7 = { children: null };
  const obj8 = { children: null };
  const items2 = [closure_4(task(5737).TableRowGroup, { hasIcons: true, children: mapped }), ];
  const obj9 = { variant: "text-xs/medium", color: "text-muted", children: null };
  const intl3 = tmp2(1114).intl;
  obj9.children = intl3.string(navigation(2690)["0TnUrG"]);
  items2[1] = closure_4(task(4601).Text, obj9);
  obj6.children = items2;
  items1[2] = closure_5(task(5023).Stack, obj6);
  obj3.children = items1;
  obj8.children = closure_5(task(5023).Stack, obj3);
  const items3 = [closure_4(task(8487).ModalContent, obj8), ];
  const obj10 = { children: null };
  const items4 = [closure_4(navigation(17965), {}), ];
  const obj11 = { variant: "primary", text: null, onPress: null };
  const intl4 = tmp2(1114).intl;
  obj11.text = intl4.string(navigation(2690).Ks6opt);
  obj11.onPress = callback;
  items4[1] = closure_4(task(11068).ModalActionButton, obj11);
  obj10.children = items4;
  items3[1] = closure_5(task(11997).ModalFooter, obj10);
  obj7.children = items3;
  return closure_5(task(8486).ModalScreen, obj7);
};
