...
// Function ID: 17954
// Name: OverviewScreen
// Dependencies: [19, 21, 4606, 17954, 1483, 17955, 8507, 8508, 5024, 576, 4602, 1114, 2690, 5738, 8668, 17949, 12020, 17956, 11089, 2]
// Exports: default

// Module 17953 (OverviewScreen)
import SafetyFlowsUtils from "SafetyFlowsUtils" /* 17955 */;
...
export default function OverviewScreen() {
  let tmp = closure_6();
  task = task(17954).useSafetyFlowTask().task;
  let obj = task(17954);
  ...
  const items1 = [closure_4(task(4602).Text, obj4), , ];
  ...
  items1[1] = closure_4(task(4602).Text, obj5);
  ...
  items2[1] = closure_4(task(4602).Text, obj9);
  obj6.children = items2;
  items1[2] = closure_5(task(5024).Stack, obj6);
  obj3.children = items1;
  obj8.children = closure_5(task(5024).Stack, obj3);
  const items3 = [closure_4(task(8508).ModalContent, obj8), ];
  ...
  items4[1] = closure_4(task(11089).ModalActionButton, obj11);
  obj10.children = items4;
  items3[1] = closure_5(task(12020).ModalFooter, obj10);
  obj7.children = items3;
  return closure_5(task(8507).ModalScreen, obj7);
};
