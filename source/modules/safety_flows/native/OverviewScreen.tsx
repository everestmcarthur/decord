...
// Function ID: 17955
// Name: OverviewScreen
// Dependencies: [19, 21, 4607, 17955, 1483, 17956, 8509, 8510, 5025, 576, 4603, 1114, 2690, 5739, 8670, 17950, 12022, 17957, 11091, 2]
// Exports: default

// Module 17954 (OverviewScreen)
import SafetyFlowsUtils from "SafetyFlowsUtils" /* 17956 */;
...
export default function OverviewScreen() {
  let tmp = closure_6();
  task = task(17955).useSafetyFlowTask().task;
  let obj = task(17955);
  ...
  const items1 = [closure_4(task(4603).Text, obj4), , ];
  ...
  items1[1] = closure_4(task(4603).Text, obj5);
  ...
  if (flow_context != null) {
    ...
    if (tasks != null) {
      mapped = tasks.map((task_type, index) => {
        const obj = { tip: task(17950).TASK_TYPE_TO_TITLE[task_type.task_type], index: index + 1 };
        return closure_1_4(navigation(8670), obj, task_type.task_type);
      });
    }
  }
  const obj7 = { children: null };
  const obj8 = { children: null };
  const items2 = [closure_4(task(5739).TableRowGroup, { hasIcons: true, children: mapped }), ];
  const obj9 = { variant: "text-xs/medium", color: "text-muted", children: null };
  const intl3 = tmp2(1114).intl;
  obj9.children = intl3.string(navigation(2690)["0TnUrG"]);
  items2[1] = closure_4(task(4603).Text, obj9);
  obj6.children = items2;
  items1[2] = closure_5(task(5025).Stack, obj6);
  obj3.children = items1;
  obj8.children = closure_5(task(5025).Stack, obj3);
  const items3 = [closure_4(task(8510).ModalContent, obj8), ];
  const obj10 = { children: null };
  const items4 = [closure_4(navigation(17957), {}), ];
  const obj11 = { variant: "primary", text: null, onPress: null };
  const intl4 = tmp2(1114).intl;
  obj11.text = intl4.string(navigation(2690).Ks6opt);
  obj11.onPress = callback;
  items4[1] = closure_4(task(11091).ModalActionButton, obj11);
  obj10.children = items4;
  items3[1] = closure_5(task(12022).ModalFooter, obj10);
  obj7.children = items3;
  return closure_5(task(8509).ModalScreen, obj7);
};
