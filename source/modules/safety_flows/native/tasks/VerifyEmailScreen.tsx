...
// Dependencies: [5, 32, 19, 21, 17954, 17955, 17949, 4305, 1114, 2690, 17958, 5024, 576, 4602, 6677, 17960, 2]
// Exports: default

// Module 17959 (VerifyEmailScreen)
...
export default function _default() {
  ...
  obj3.title = intl.string(require("module_2690")["Qm6K/s"]);
  const intl2 = onTaskComplete(value[8]).intl;
  obj3.action = intl2.string(require("module_2690").wq2RDq);
  ...
  obj5.children = intl3.string(require("module_2690").aveKoG);
  ...
  obj7.placeholder = intl4.string(require("module_2690").d9Ykjr);
  obj7.value = value;
