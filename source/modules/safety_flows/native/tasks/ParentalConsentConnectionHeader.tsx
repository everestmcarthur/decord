...
// Dependencies: [19, 17, 1372, 21, 4640, 5770, 576, 1612, 504, 4636, 6703, 1115, 2691, 2]
// Exports: ParentalConsentConnectionNavbar

// Module 18152 (ParentalConsentConnectionHeader)
...
let obj2 = { row: { height: fn(5770).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 }, logOut: null };
let obj3 = { height: fn(5770).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 };
...
export const ParentalConsentConnectionNavbar = function ParentalConsentConnectionNavbar() {
  ...
  obj4.children = intl.string(_modDef2691["3HuGuY"]);
