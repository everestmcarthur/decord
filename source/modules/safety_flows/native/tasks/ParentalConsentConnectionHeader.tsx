...
// Dependencies: [19, 17, 1372, 21, 4722, 5852, 576, 1612, 504, 4718, 6785, 1115, 2774, 2]
// Exports: ParentalConsentConnectionNavbar

// Module 18246 (ParentalConsentConnectionHeader)
...
let obj2 = { row: { height: fn(5852).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 }, logOut: null };
let obj3 = { height: fn(5852).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 };
...
export const ParentalConsentConnectionNavbar = function ParentalConsentConnectionNavbar() {
  ...
  obj4.children = intl.string(_modDef2774["3HuGuY"]);
