...
// Dependencies: [19, 17, 1371, 21, 4607, 5734, 576, 1611, 504, 4603, 6665, 1114, 2690, 2]
// Exports: ParentalConsentConnectionNavbar

// Module 17964 (ParentalConsentConnectionHeader)
...
let obj2 = { row: { height: fn(5734).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 }, logOut: null };
let obj3 = { height: fn(5734).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 };
