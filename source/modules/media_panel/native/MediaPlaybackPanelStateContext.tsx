...
// Dependencies: [19, 14654, 12416, 7184, 2]

// Module 17428 (MediaPlaybackPanelStateContext)
...
obj.mode = ReanimatedHelperTypes.createFakeSharedValue(fn(14654).MediaPlaybackPanelModes.PIP);
...
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12416).MorphablePanelModes.PIP);
ReanimatedHelperTypes = fn(7184);
