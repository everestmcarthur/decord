...
// Dependencies: [19, 14636, 12408, 7181, 2]

// Module 17372 (MediaPlaybackPanelStateContext)
...
obj.mode = ReanimatedHelperTypes.createFakeSharedValue(fn(14636).MediaPlaybackPanelModes.PIP);
...
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12408).MorphablePanelModes.PIP);
ReanimatedHelperTypes = fn(7181);
