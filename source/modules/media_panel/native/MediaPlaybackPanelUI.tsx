...
// Dependencies: [32, 19, 9749, 14590, 12367, 12366, 21, 4606, 576, 1611, 1477, 17305, 4343, 9586, 11448, 17101, 4607, 4610, 5025, 17103, 7229, 6726, 17307, 2]
// Exports: default

// Module 17306 (MediaPlaybackPanelUI)
...
import MediaPlaybackPanelStateContextDefault from "MediaPlaybackPanelStateContext" /* 17305 */;
...
const MediaPlaybackPanelConstants = fn(14590);
({ MEDIA_PLAYBACK_PANEL_LAYOUT_PHYSICS: closure_7, MediaPlaybackPanelModes: closure_8 } = MediaPlaybackPanelConstants);
const IS_IOS = fn(12367).IS_IOS;
const BORDER_RADIUS_PHYSICS = fn(12366).BORDER_RADIUS_PHYSICS;
const jsx = fn(21).jsx;
...
export default function MediaPlaybackPanelUI() {
  ...
  if (mode.get() === MediaPlaybackPanelModes.PIP) {
    ...
    if (mode.get() === tmp12.PIP) {
      ...
      const obj11 = { withTiming: tmp6(4607).withTiming, wrapperOpacity: sharedValue2, timingFast: tmp6(4610).timingFast, animateWrapperTranslation: sharedValue3, withSpring: tmp6(5025).withSpring, wrapperTranslationX: sharedValue, MEDIA_PLAYBACK_PANEL_LAYOUT_PHYSICS, wrapperTranslationY: sharedValue1, wrapperDimensions, wrapperElevationStyles: maskEmptyElevation };
      L.__closure = obj11;
      ...
      const obj12 = { withSpring: tmp6(5025).withSpring, borderRadius: xl, BORDER_RADIUS_PHYSICS, maskElevationStyles: maskElevation };
      B.__closure = obj12;
      ...
      const context1 = obj2.useContext(tmp2(17305));
      ...
      obj14.mode = tmp6(17103).MorphablePanelModes.PIP;
      obj14.pipState = pipState2;
      obj14.wrapperOffset = wrapperOffset2;
      const tmp2Result = tmp2(17103);
      ...
      const obj19 = { gesture: tmp2(17103)(obj14), children: null };
      const obj20 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj20.style = items3;
      obj20.children = jsx(tmp2(17307), {});
      obj19.children = jsx(tmp2(4343).View, { style: null, children: null });
      obj18.children = jsx(tmp6(6726).GestureDetector, { gesture: tmp2(17103)(obj14), children: null });
      ...
      return jsx(tmp6(7229).LayerScope, { children: null });
    }
  }
