...
// Dependencies: [5, 32, 19, 17, 21, 4605, 576, 15766, 15767, 4303, 4601, 1178, 7175, 5025, 4808, 5674, 7052, 1114, 2]
// Exports: default

// Module 15765 (CaptchaTestModal)
import nativeDefault from "native" /* 576 */;
import NavigatorHeader from "NavigatorHeader" /* 5674 */;
import CaptchaTestActionCreators from "CaptchaTestActionCreators" /* 15767 */;
...
const prop = fn(15766).HCAPTCHA_DIFFICULTY_OPTIONS;
const options = prop.map((label) => ({ name: label.label, value: label.value }));
let items = [fn(15767).CaptchaDeciderType.HCAPTCHA_RQDATA, fn(15767).CaptchaDeciderType.SMITE_RQDATA];
const set = new Set(items);
const prop1 = fn(15766).CAPTCHA_DECIDER_TYPE_OPTIONS;
