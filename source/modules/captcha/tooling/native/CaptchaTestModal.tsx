...
// Dependencies: [5, 32, 19, 17, 21, 4574, 576, 15717, 15718, 4272, 4570, 1178, 7137, 4989, 4777, 5638, 7014, 1114, 2]
// Exports: default

// Module 15716 (CaptchaTestModal)
...
const prop = fn(15717).HCAPTCHA_DIFFICULTY_OPTIONS;
const options = prop.map((label) => ({ name: label.label, value: label.value }));
let items = [fn(15718).CaptchaDeciderType.HCAPTCHA_RQDATA, fn(15718).CaptchaDeciderType.SMITE_RQDATA];
const set = new Set(items);
const prop1 = fn(15717).CAPTCHA_DECIDER_TYPE_OPTIONS;
