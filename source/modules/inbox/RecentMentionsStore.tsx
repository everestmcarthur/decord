...
// Dependencies: [4223, 502, 1957, 4795, 4589, 4222, 4395, 4755, 1371, 1074, 510, 4797, 4785, 4812, 12, 4603, 7284, 7652, 504, 573, 2]

// Module 7651 (RecentMentionsStore)
        ...
        if (!tmp2(7652)(message, id)) {
          ...
          if (tmp2(4812)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(4812)(obj3);
