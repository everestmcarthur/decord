...
// Function ID: 11141
// Name: formatResults
// Dependencies: [5, 9985, 1958, 4278, 1372, 11141, 1074, 9986, 4653, 9995, 1115, 1370, 12, 2]
...
export const formatResultsWithHeaders = function formatResultsWithHeaders(hasNonEmptyQuery) {
  ...
  if (hasNonEmptyQuery.hasNonEmptyQuery) {
    ...
    if (null != queryMode) {
      ...
      items4 = [tmp(9986).createHeaderResult(intl2.string(tmp(1115).t["80lOZ1"])), , ];
      let tmp13 = null;
      if (null != selectedChannelId) {
        ...
        if (null != tmp7) {
          ...
          if (isAllowedType(tmp7)) {
            let canResult = tmp7.type === tmp(9986).AutocompleterResultTypes.USER;
            if (!canResult) {
