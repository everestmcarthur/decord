...
// Dependencies: [19, 21, 4640, 576, 1612, 5719, 7984, 5712, 1364, 7057, 2]
// Exports: default

// Module 11142 (SearchableDestinationListHeader)
...
const useIsWindowLarge = tmp5(7057);
require = fn;
const jsx = fn(21).jsx;
...
export default function SearchableDestinationListHeader(arg0) {
  ...
  return tmp4(_mod5719.Header, obj);
};
