...
// Function ID: 18199
// Name: AppShare
// Dependencies: [32, 19, 17, 7574, 14519, 502, 1074, 12566, 21, 504, 6703, 1364, 14558, 12569, 7589, 1241, 5079, 14679, 14014, 1609, 8511, 7153, 17158, 17205, 4990, 2]
// Exports: default

// Module 18198 (AppShare)
...
let closure_9 = fn(12566).MultiAccountSwitchLocation;
const jsxProd = fn(21);
...
export default function AppShare(targetUserId) {
  ...
  const effect1 = obj.useEffect(() => {
    ...
    if (tmp2) {
      ...
      const timerId = setTimeout(() => {
        const obj = closure_0(12569);
        closure_0(12569).switchAccount(targetUserId, false, constants.SHARE_EXTENSION).then(() => {
          closure_1_3(true);
        });
      }, 18);
    }
  ...
  if (first) {
    ...
    const tmp14Result = tmp14(14014);
    if (tmp9Result.isMetaQuest()) {
      exitApp = tmp14(8511).close;
    } else {
    ...
    const items5 = [tmp19(tmp9(7153).SceneLoadingIndicator, {}), , , ];
    const obj5 = { appEntryKey: tmp18 };
    items5[1] = tmp19(tmp9(17158).ActionSheetContainer, obj5);
    items5[2] = tmp19(tmp14(17205), {});
    items5[3] = tmp19(tmp9(4990).AlertModalContainer, {});
