...
// Dependencies: [19, 21, 9905, 11053, 10938, 7712, 10981, 10984, 1369, 2]
// Exports: default

// Module 16285 (SearchableDestinationListRow)
...
export default function SearchableDestinationListRow(result) {
  ...
  if (type === sortByMatchScore.AutocompleterResultTypes.HEADER) {
    ...
    if (tmp2(9905).AutocompleterResultTypes.USER === type) {
      ...
      obj.user = record;
      const tmp18 = onPressDestination(10938);
      obj.type = tmp2(7712).getRelationshipType(record.id);
      obj.onPress = fn;
      return <tmp18 />;
