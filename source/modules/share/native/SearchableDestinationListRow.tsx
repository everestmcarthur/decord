...
// Dependencies: [19, 21, 9928, 11076, 10959, 7734, 11003, 11006, 1369, 2]
// Exports: default
...
export default function SearchableDestinationListRow(result) {
  ...
  if (type === sortByMatchScore.AutocompleterResultTypes.HEADER) {
    ...
    if (tmp2(9928).AutocompleterResultTypes.USER === type) {
      ...
      obj.user = record;
      const tmp18 = onPressDestination(10959);
      obj.type = tmp2(7734).getRelationshipType(record.id);
      obj.onPress = fn;
      return <tmp18 />;
      ...
      obj2.channel = record;
      obj2.onPress = fn;
      return jsx(onPressDestination(11003), {});
    } else {
      ...
      obj3.channel = record;
      obj3.onPress = fn;
      return jsx(onPressDestination(11006), {});
    }
  }
};
