...
// Dependencies: [19, 17, 1958, 1980, 4679, 4288, 1372, 1085, 21, 4639, 576, 4792, 11046, 1177, 4635, 504, 4484, 11138, 4989, 4989, 1115, 2]
// Exports: default

// Module 11837 (DestinationFailedAlertModal)
...
function FailedChannelRow(channel) {
  ...
  const items1 = [closure_10(channel(11138).GuildIconWithChannelType, { "aria-label": "", guild: stateFromStores, channel, size: channel(11138).GuildIconWithChannelTypeSizes.SMALL_32 }), closure_10(channel(4635).Text, { style: tmp.label, variant: "text-md/medium", lineClamp: 1, ellipsizeMode: "tail", children: tmp3 })];
...
export default function DestinationFailedAlertModal(arg0) {
  ...
  if (null != onRetry) {
    ...
    const items = [tmp2(tmp3(4989).AlertActionButton, obj4, "confirm"), ];
    const obj5 = { variant: "secondary", text: null };
    const intl3 = tmp3(1115).intl;
    obj5.text = intl3.string(tmp3(1115).t.WAI6xu);
    items[1] = tmp2(tmp3(4989).AlertActionButton, obj5, "cancel");
    obj3.children = items;
    ...
    tmp2Result = tmp2(tmp3(4989).AlertActionButton, obj6, "confirm");
  }
