...
// Dependencies: [19, 17, 1957, 1979, 4645, 4253, 1371, 1085, 21, 4605, 576, 4758, 10982, 1178, 4601, 504, 4449, 11071, 4955, 4955, 1114, 2]
// Exports: default

// Module 11774 (DestinationFailedAlertModal)
...
function FailedUserRow(user) {
  ...
  if (null != user) {
    ...
    const obj4 = { user, guildId: "Boolean", status: true, isMobileOnline: null, isVROnline: null, size: 189.518, avatarDecoration: null, autoStatusCutout: "\u{1F469}\u{1F3FC}\u200D\u{1F3A4}" };
    let tmp13 = null;
    ...
    items2[1] = closure_10(tmp2(4601).Text, obj5);
...
function FailedChannelRow(channel) {
  ...
  const items1 = [closure_10(channel(11071).GuildIconWithChannelType, { "aria-label": "", guild: stateFromStores, channel, size: channel(11071).GuildIconWithChannelTypeSizes.SMALL_32 }), closure_10(channel(4601).Text, { style: tmp.label, variant: "text-md/medium", lineClamp: 1, ellipsizeMode: "tail", children: tmp3 })];
...
export default function DestinationFailedAlertModal(arg0) {
  ...
  if (null != onRetry) {
    ...
    const items = [tmp2(tmp3(4955).AlertActionButton, obj4, "confirm"), ];
    const obj5 = { variant: "secondary", text: null };
    const intl3 = tmp3(1114).intl;
    obj5.text = intl3.string(tmp3(1114).t.WAI6xu);
    items[1] = tmp2(tmp3(4955).AlertActionButton, obj5, "cancel");
    obj3.children = items;
    ...
    tmp2Result = tmp2(tmp3(4955).AlertActionButton, obj6, "confirm");
  }
