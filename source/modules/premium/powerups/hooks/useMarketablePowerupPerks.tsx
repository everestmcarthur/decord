...
// Dependencies: [19, 4526, 4527, 4530, 504, 12719, 2]
// Exports: default

// Module 13679 (useMarketablePowerupPerks)
...
let items = [...Array.from(tmp2.GUILD_TAG_BADGE_PACKS_WAVE_ONE_SKU_ID_SET), ...Array.from(tmp2.GUILD_TAG_BADGE_PACKS_WAVE_TWO_SKU_ID_SET), fn(4530).VANITY_URL_POWERUP_SKU_ID];
...
export default function useMarketablePowerupPerks(arg0) {
  ...
  let tmp2 = stateFromStores(12719)(arg0);
  dependencyMap = tmp2;
