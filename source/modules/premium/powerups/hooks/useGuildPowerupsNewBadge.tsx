...
// Dependencies: [32, 19, 4495, 4496, 1954, 1943, 504, 12596, 7461, 1945, 2]
// Exports: default, useAutoDismissGuildPowerupsNewBadge

// Module 12603 (useGuildPowerupsNewBadge)
...
export default function useGuildPowerupsNewBadge(arg0) {
  ...
  const tmp7 = _slicedToArray(tmp(7461).useSelectedVersionedDismissibleContent(tmp6, num), 2);
  _require = tmp8;
  importDefault = tmp9;
