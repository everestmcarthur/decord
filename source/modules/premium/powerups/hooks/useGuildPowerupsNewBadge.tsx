...
// Dependencies: [32, 19, 4496, 4497, 1954, 1943, 504, 12598, 7462, 1945, 2]
// Exports: default, useAutoDismissGuildPowerupsNewBadge

// Module 12605 (useGuildPowerupsNewBadge)
...
require = fn;
const constants = fn(4497).GuildPowerupNewPerkMarketingVersion;
...
export default function useGuildPowerupsNewBadge(arg0) {
  ...
  const tmp7 = _slicedToArray(tmp(7462).useSelectedVersionedDismissibleContent(tmp6, num), 2);
  _require = tmp8;
  importDefault = tmp9;
...
export const useAutoDismissGuildPowerupsNewBadge = function useAutoDismissGuildPowerupsNewBadge(guildId) {
  ...
  const tmp2Result = num(12598)(guildId, stateFromStores);
  num = 0;
