...
// Dependencies: [32, 19, 4547, 1980, 12635, 4526, 4527, 1074, 1955, 4531, 12637, 12638, 4530, 12639, 1370, 1944, 4550, 4546, 12640, 1946, 563, 12636, 12644, 4566, 4565, 12646, 12647, 12648, 12649, 12651, 12652, 12653, 12631, 2]
...
// Module 12634 (useGuildPowerupsNotifications)
...
import getExpiringGuildEntitlements from "getExpiringGuildEntitlements" /* 12636 */;
import GuildDismissibleContentUtils from "GuildDismissibleContentUtils" /* 12637 */;
import GuildPowerupsNotification from "GuildPowerupsNotification" /* 12638 */;
import useGuildPowerupRollbackNotificationConfigDefault from "useGuildPowerupRollbackNotificationConfig" /* 12640 */;
import useGuildPowerupNewPerkMarketingVersionDefault from "useGuildPowerupNewPerkMarketingVersion" /* 12646 */;
import useBoostToUnlockFeaturedPowerupDefault from "useBoostToUnlockFeaturedPowerup" /* 12647 */;
import useCanPurchaseBoostsDefault from "useCanPurchaseBoosts" /* 12648 */;
import useFeaturedExpiringPowerupDefault from "useFeaturedExpiringPowerup" /* 12649 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import GameServerStore from "GameServerStore" /* 4547 */;
import GuildStore from "GuildStore" /* 1980 */;
import GuildPowerupsNotificationStore from "GuildPowerupsNotificationStore" /* 12635 */;
...
function maybeGetPerkPurchaseablePopoutDCF(id, arg1, available, serverThemeEnabled) {
  ...
  if (0 !== found.length) {
    if (1 === found.length) {
      if (!tmp4Result.isContentDismissed(tmp4(1944).DismissibleGuildContent.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, id)) {
        let obj = {
          type: tmp4(12638).GuildPowerupNotificationPopoutType.PERKS_PURCHASABLE,
          powerups: found,
    ...
    let tmp6;
    if (found.length > 1) {
      if (!tmp4Result2.isContentDismissed(tmp4(1944).DismissibleGuildContent.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, id)) {
        const obj2 = {
          type: tmp4(12638).GuildPowerupNotificationPopoutType.PERKS_PURCHASABLE,
          powerups: found,
          markAsDismissed(AUTO_DISMISS) {
        ...
        if (!closure_4) {
          if (tmp15 !== num2) {
            if (diff > 0) {
              ...
              const obj2 = { type: tmp18(12638).GuildPowerupNotificationIndicatorType.UNREAD, count: diff };
              obj.indicator = obj2;
              let obj3 = obj;
            }
          }
...
function useGuildPowerupsChannelListPopout(id, arg1) {
  ...
  const tmp3Result = _slicedToArray(require("GuildPowerupsNotificationsDCF").useNewPerkAvailableCoachmarkDCF(tmp12, tmp11), 2);
  ...
  let tmp17 = useCanPurchaseBoostsDefault();
  let tmp18 = null != arg1;
  if (tmp18) {
    tmp18 = !tmp6;
  }
  ...
  const tmp3Result6 = _slicedToArray(require("GuildPowerupsNotificationsDCF").useBoostToUnlockCoachmarkDCF(tmp18, id), 2);
  const markAsDismissed3 = tmp20;
  let tmp21 = tmp3Result6[0] === require("dismissible_content").DismissibleContent.BOOST_TO_UNLOCK_COACHMARK;
  constants = tmp21;
  ...
  const tmp3Result7 = _slicedToArray(require("GuildPowerupsNotificationsDCF").useExpiringPowerupCoachmarkDCF(tmp23, id), 2);
  const markAsDismissed4 = tmp25;
  let tmp26 = tmp3Result7[0] === require("dismissible_content").DismissibleContent.EXPIRING_POWERUP_COACHMARK;
  closure_16 = tmp26;
  ...
  const tmp3Result8 = _slicedToArray(require("GuildPowerupsNotificationsDCF").useNewGamesCoachmarkDC(tmp29), 2);
  const markAsDismissed5 = tmp31;
  const tmp32 = tmp3Result8[0] === require("dismissible_content").DismissibleContent.GAME_SERVER_NEW_GAMES_COACHMARK;
  closure_18 = tmp32;
  ...
  const tmp3Result9 = _slicedToArray(require("GuildPowerupsNotificationsDCF").useGameServerPricingCoachmarkDCF(tmp34), 2);
  const markAsDismissed6 = tmp36;
  const tmp37 = tmp3Result9[0] === require("dismissible_content").DismissibleContent.GAME_SERVER_PRICING_CHANGE_COACHMARK;
  closure_20 = tmp37;
                  ...
                  if (null != found) {
                    ...
                    if (null != dependencyMap3[found]) {
                      if (!tmp8Result.isContentDismissed(tmp13, tmp7)) {
                        ...
                        if (null != tmp16) {
                          const obj = {
                            type: tmp8(12638).GuildPowerupNotificationPopoutType.LEVEL_REACHED,
                            powerup: tmp16,
                            markAsDismissed(AUTO_DISMISS) {
                                                    const result = closure_0(12637).markContentAsDismissed(dependencyMap, closure_0, true, AUTO_DISMISS);
                                                  }
                          };
                          tmp11 = obj;
                        }
                      }
                      tmp8Result = tmp8(12637);
                    }
                  }
                  if (null != tmp11) {
                    return tmp11;
                    ...
                    if (null != tmp26) {
                      ...
                      if (tmp8Result3.getGameServerEnabled(tmp7, "maybeGetGameServerHostingGuildEligiblePopoutDCF")) {
                        if (!stateFromStores) {
                          if (null != tmp28) {
                            if (tmp21 >= tmp28) {
                              if (!tmp8Result4.isContentDismissed(tmp8(1944).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, tmp7)) {
                                const obj2 = {
                                  type: tmp8(12638).GuildPowerupNotificationPopoutType.GAME_SERVER_HOSTING_GUILD_ELIGIBLE,
                                  markAsDismissed(AUTO_DISMISS) {
                                                                const result = closure_0(12637).markContentAsDismissed(closure_0(1944).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, closure_0, true, AUTO_DISMISS);
                                                              }
                                };
                                tmp17 = obj2;
                              }
                              tmp8Result4 = tmp8(12637);
                            }
                          }
                        }
                      }
  ...
  closure_23 = tmp41;
  const items3 = [arg1, tmp6, tmp4[1], memo, first, tmp3Result10[1], tmp15, tmp3Result[1], tmp11, tmp21, tmp16, tmp3Result6[1], tmp26, tmp22, tmp3Result7[1], tmp32, tmp3Result8[1], tmp37, tmp3Result9[1]];
...
export const maybeGetLevelUnlockedPopoutDCF = function maybeGetLevelUnlockedPopoutDCF(id, arg1) {
  ...
  if (null != found) {
    dependencyMap = tmp5;
    if (null != dependencyMap3[found]) {
      if (!tmpResult.isContentDismissed(tmp5, id)) {
        let tmp8;
        if (null != dependencyMap2[found]) {
          tmp8 = arg1.allPowerups[tmp7];
        }
        if (null != tmp8) {
          const obj = {
            type: tmp(12638).GuildPowerupNotificationPopoutType.LEVEL_REACHED,
            powerup: tmp8,
            markAsDismissed(AUTO_DISMISS) {
                      const result = closure_0(12637).markContentAsDismissed(dependencyMap, closure_0, true, AUTO_DISMISS);
                    }
...
export const maybeGetGameServerHostingGuildEligiblePopoutDCF = function maybeGetGameServerHostingGuildEligiblePopoutDCF(id, arg1, arg2, arg3) {
  ...
  if (obj.getGameServerEnabled(id, "maybeGetGameServerHostingGuildEligiblePopoutDCF")) {
    if (!arg1) {
      if (null != arg3) {
        if (arg2 >= arg3) {
          if (!tmpResult.isContentDismissed(tmp(1944).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, id)) {
            const obj2 = {
              type: tmp(12638).GuildPowerupNotificationPopoutType.GAME_SERVER_HOSTING_GUILD_ELIGIBLE,
              markAsDismissed(AUTO_DISMISS) {
                          const result = closure_0(12637).markContentAsDismissed(closure_0(1944).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, closure_0, true, AUTO_DISMISS);
                        }
            };
