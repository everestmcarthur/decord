...
// Module 17376 (handleSelectedGuildChange)
      ...
      if (null != guild) {
        ...
        if (!tmp10Result.getHasAllocateBoostPermission(closure_4, guild)) {
          ...
          if (isMobile) {
            ...
            const tmp10Result3 = tmp10(16170);
          }
          if (isMobile) {
          ...
          if (showCoachmark) {
            ...
            const tmp10Result5 = tmp10(16170);
          }
          if (showCoachmark) {
          ...
          const tmp10Result1 = tmp10(16170);
        }
