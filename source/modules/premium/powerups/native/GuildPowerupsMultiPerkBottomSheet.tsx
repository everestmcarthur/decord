...
// Dependencies: [17, 21, 4606, 576, 672, 4315, 4541, 12606, 12592, 12589, 12612, 12641, 12613, 12627, 12628, 12632, 12616, 1178, 1114, 4602, 12617, 5026, 2428, 1611, 12642, 7223, 6698, 12645, 12638, 2]
// Exports: default

// Module 12640 (GuildPowerupsMultiPerkBottomSheet)
...
import usePowerupActiveStatus from "usePowerupActiveStatus" /* 12592 */;
...
import useCanGuildPowerupBeToggledDefault from "useCanGuildPowerupBeToggled" /* 12627 */;
import useGuildPowerupOnActivateDefault from "useGuildPowerupOnActivate" /* 12628 */;
import useGuildPowerupOnShowDeactivateDefault from "useGuildPowerupOnShowDeactivate" /* 12632 */;
import useGuildPowerupColorConfigDefault from "useGuildPowerupColorConfig" /* 12641 */;
import usePowerupGroupConfigDefault from "usePowerupGroupConfig" /* 12642 */;
...
function GuildPowerupsMultiPerkCard(arg0) {
  ...
  if (null != calculatePowerupCardStatus) {
    ...
    let tmp18Result = tmp18(tmp(12617).GuildPowerupCardFooterStatus, obj11);
  } else {
    const obj12 = { cost: powerup.cost };
    tmp18Result = tmp18(tmp(12617).GuildPowerupCardFooterCost, obj12);
  }
...
export default function GuildPowerupsMultiPerkBottomSheet(guildId) {
  ...
  if (null != tmp4) {
    ...
    const items = [closure_4(tmp2(12645), { title: null, description: null }), , ];
    ...
    if (tmp6Result) {
      ...
      obj6.children = tmp6(tmp2(12638), obj7);
    ...
    obj2.children = items;
    obj.children = closure_5(guildId(6698).BottomSheetScrollView, obj2);
    tmp6Result2 = tmp6(guildId(7223).BottomSheet, obj);
