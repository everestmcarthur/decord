...
// Dependencies: [4573, 12608, 1896, 2]
// Exports: default

// Module 12607 (openGuildPowerupRollbackSheet)
...
export default function openGuildPowerupRollbackSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12608, dependencyMap.paths), GUILD_POWERUP_ROLLBACK_SHEET_KEY, arg0);
};
