...
// Dependencies: [4607, 12667, 1897, 2]
// Exports: default

// Module 12666 (openGuildPowerupRollbackSheet)
...
export default function openGuildPowerupRollbackSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12667, dependencyMap.paths), GUILD_POWERUP_ROLLBACK_SHEET_KEY, arg0);
};
