...
// Dependencies: [4605, 12658, 1897, 2]
// Exports: default

// Module 12657 (openGuildPowerupRollbackSheet)
...
export default function openGuildPowerupRollbackSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12658, dependencyMap.paths), GUILD_POWERUP_ROLLBACK_SHEET_KEY, arg0);
};
