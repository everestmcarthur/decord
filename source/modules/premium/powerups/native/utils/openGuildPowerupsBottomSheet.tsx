...
// Dependencies: [4605, 12661, 1897, 2]
// Exports: default

// Module 12660 (openGuildPowerupsBottomSheet)
...
export default function openGuildPowerupsBottomSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12661, dependencyMap.paths), GUILD_POWERUPS_BOTTOM_SHEET_KEY, arg0);
};
