...
// Dependencies: [4574, 12613, 1896, 2]
// Exports: default

// Module 12612 (openGuildPowerupsBottomSheet)
...
export default function openGuildPowerupsBottomSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12613, dependencyMap.paths), GUILD_POWERUPS_BOTTOM_SHEET_KEY, arg0);
};
