...
// Dependencies: [19, 17, 4610, 21, 4722, 576, 672, 4718, 13779, 12731, 12756, 1115, 2512, 13780, 2]
// Exports: default

// Module 13778 (GuildPowerupsMarketingHeader)
...
import useMarketablePowerupPerksDefault from "useMarketablePowerupPerks" /* 13779 */;
      ...
      if (null != arr) {
        ...
        if (0 !== arr.length) {
          ...
          if (1 === first.length) {
            ...
            formatResult = intl2.format(tmp2(2512).MNO3sG, obj4);
          }
        }
      }
      const obj7 = { perks: str2 };
      obj2.children = intl.format(tmp2(2512)["7lwpzR"], obj7);
