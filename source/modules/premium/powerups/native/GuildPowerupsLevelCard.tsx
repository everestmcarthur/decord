...
// Dependencies: [19, 17, 4496, 1074, 12659, 21, 4606, 576, 5038, 9466, 7053, 12641, 12620, 4602, 1114, 2428, 12592, 12612, 12660, 12661, 12617, 2]
// Exports: default
...
const GuildPowerupsCardDefault = tmp5(12661);
require = fn;
