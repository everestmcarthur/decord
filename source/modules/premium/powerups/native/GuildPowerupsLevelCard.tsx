...
// Dependencies: [19, 17, 4495, 1074, 12636, 21, 4605, 576, 5037, 9445, 7032, 12618, 12597, 4601, 1114, 2428, 12569, 12589, 12637, 12638, 12594, 2]
// Exports: default
...
const GuildPowerupsCardDefault = tmp5(12638);
require = fn;
