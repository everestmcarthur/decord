...
// Dependencies: [17, 21, 4639, 576, 12676, 12677, 12678, 4989, 6715, 1115, 2429, 4989, 4635, 2]
// Exports: default

// Module 12675 (GuildPowerupsDeactivateAlert)
import _mod17 from "module_17" /* 17 */;
import nativeDefault from "native" /* 576 */;
import _modDef2429 from "module_2429" /* 2429 */;
import Text_Text from "Text/Text" /* 4635 */;
import useGuildPowerupOnDeactivateDefault from "useGuildPowerupOnDeactivate" /* 12676 */;
import useDeactivateWarningTextDefault from "useDeactivateWarningText" /* 12677 */;
...
export default function GuildPowerupsDeactivateAlert(arg0) {
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(tmp5(4635).Text, obj7);
  }
