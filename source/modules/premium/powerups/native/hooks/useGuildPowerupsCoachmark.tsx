...
// Dependencies: [19, 4632, 1980, 4529, 1074, 1955, 1085, 21, 4640, 576, 504, 4574, 4548, 12665, 12647, 16333, 12631, 12673, 1115, 2429, 12675, 16334, 12672, 4532, 16330, 16335, 16336, 12703, 16337, 11288, 2]
// Exports: default

// Module 16332 (useGuildPowerupsCoachmark)
import nativeDefault from "native" /* 576 */;
import useGetGuildPowerupBannerImage from "useGetGuildPowerupBannerImage" /* 12672 */;
import GuildPowerupsBoostGemDefault from "GuildPowerupsBoostGem" /* 12673 */;
        ...
        if (null != found1) {
          ...
          obj12.renderImgComponent = function renderImgComponent() {
            ...
            if (guildPowerupBannerImage == null) {
              guildPowerupBannerImage = _modDef16330;
            }
