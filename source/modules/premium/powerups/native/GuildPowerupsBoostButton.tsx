...
// Dependencies: [19, 1979, 1371, 4502, 1074, 21, 504, 7467, 1379, 5486, 7476, 2]
// Exports: GuildPowerupsBoostButton

// Module 12682 (GuildPowerupsBoostButton)
...
export const GuildPowerupsBoostButton = function GuildPowerupsBoostButton(guildId) {
  ...
  const tmp6 = stateFromStores1(7467)({ forceFetch: true });
  ...
  if (null != stateFromStores) {
    ...
    tmp10 = jsx(tmp5(7476), { guild: stateFromStores, previousGuildSubscriptionSlot: memo, analyticsSection: AnalyticsSections.GUILD_POWERUPS_OVERVIEW_SIDEBAR, fractionalPremiumState: tmp6.fractionalState, onAvailableSlotPress: tmp9, premiumGroupRole: UNSPECIFIED });
  }
  return tmp10;
};
