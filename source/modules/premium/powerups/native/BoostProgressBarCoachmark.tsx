...
// Dependencies: [19, 17, 1955, 21, 4639, 9195, 1115, 2429, 4350, 11266, 2]
// Exports: default

// Module 16278 (BoostProgressBarCoachmark)
...
export default function BoostProgressBarCoachmark(guild) {
  ...
  const coachmark = guild(11266).useCoachmark(guild.targetRef, memo);
  return null;
};
