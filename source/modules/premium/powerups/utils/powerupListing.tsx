...
// Function ID: 12610
// Name: powerupListing
// Dependencies: [32, 19, 4495, 4496, 4499, 504, 2]
// Exports: useBuildGuildPowerupsSections

// Module 12609 (powerupListing)
...
let items = [fn(4499).GUILD_TAGS_BADGE_PACK_CREEPY_CRAWLIES_POWERUP_SKU_ID, fn(4499).GUILD_TAGS_BADGE_PACK_PETS_POWERUP_SKU_ID, fn(4499).GUILD_TAGS_BADGE_PACK_PLANT_POWERUP_SKU_ID, fn(4499).GUILD_TAGS_BADGE_PACK_FLEX_POWERUP_SKU_ID];
