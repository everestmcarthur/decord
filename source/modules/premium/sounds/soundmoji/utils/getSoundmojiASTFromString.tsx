...
// Dependencies: [5062, 4826, 1074, 5067, 5068, 5069, 5071, 1396, 2]
// Exports: default, getSoundmojiFromMessage

// Module 5061 (getSoundmojiASTFromString)
import SoundmojiRenderingExperiment from "SoundmojiRenderingExperiment" /* 5067 */;
import isSoundValidDefault from "isSoundValid" /* 5068 */;
import getSoundStringDefault from "getSoundString" /* 5071 */;
...
export default function getSoundmojiASTFromString(soundId, guildId) {
  ...
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(5069)(channelId, messageId, tmp2, soundboardSounds);
        tmp5 = tmp16;
        if (tmp9) {
          tmp5 = tmp16;
          if (null == tmp16) {
...
export const getSoundmojiFromMessage = function getSoundmojiFromMessage(guildId, channelId, messageId, soundId, arg4) {
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(5069)(channelId, messageId, soundId, arg4);
        if (tmp9) {
          if (null == tmp16) {
            const message = MessageStore.getMessage(channelId, messageId);
            let state;
