...
// Dependencies: [5064, 4828, 1074, 5069, 5070, 5071, 5073, 1396, 2]
// Exports: default, getSoundmojiFromMessage

// Module 5063 (getSoundmojiASTFromString)
import SoundmojiRenderingExperiment from "SoundmojiRenderingExperiment" /* 5069 */;
import isSoundValidDefault from "isSoundValid" /* 5070 */;
import getSoundStringDefault from "getSoundString" /* 5073 */;
...
export default function getSoundmojiASTFromString(soundId, guildId) {
  ...
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(5071)(channelId, messageId, tmp2, soundboardSounds);
        tmp5 = tmp16;
        if (tmp9) {
          tmp5 = tmp16;
          if (null == tmp16) {
...
export const getSoundmojiFromMessage = function getSoundmojiFromMessage(guildId, channelId, messageId, soundId, arg4) {
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(5071)(channelId, messageId, soundId, arg4);
        if (tmp9) {
          if (null == tmp16) {
            const message = MessageStore.getMessage(channelId, messageId);
            let state;
