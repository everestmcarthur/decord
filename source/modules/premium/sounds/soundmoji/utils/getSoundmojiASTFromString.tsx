...
// Dependencies: [5100, 4861, 1074, 5105, 5106, 5107, 5109, 1397, 2]
// Exports: default, getSoundmojiFromMessage

// Module 5099 (getSoundmojiASTFromString)
import SoundmojiRenderingExperiment from "SoundmojiRenderingExperiment" /* 5105 */;
import isSoundValidDefault from "isSoundValid" /* 5106 */;
import getSoundStringDefault from "getSoundString" /* 5109 */;
...
export default function getSoundmojiASTFromString(soundId, guildId) {
  ...
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(5107)(channelId, messageId, tmp2, soundboardSounds);
        tmp5 = tmp16;
        if (tmp9) {
          tmp5 = tmp16;
          if (null == tmp16) {
...
export const getSoundmojiFromMessage = function getSoundmojiFromMessage(guildId, channelId, messageId, soundId, arg4) {
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(5107)(channelId, messageId, soundId, arg4);
        if (tmp9) {
          if (null == tmp16) {
            const message = MessageStore.getMessage(channelId, messageId);
            let state;
