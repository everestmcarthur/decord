...
// Dependencies: [5097, 4859, 1074, 5102, 5103, 5104, 5106, 1397, 2]
// Exports: default, getSoundmojiFromMessage

// Module 5096 (getSoundmojiASTFromString)
import SoundmojiRenderingExperiment from "SoundmojiRenderingExperiment" /* 5102 */;
import isSoundValidDefault from "isSoundValid" /* 5103 */;
import getSoundStringDefault from "getSoundString" /* 5106 */;
...
export default function getSoundmojiASTFromString(soundId, guildId) {
  ...
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(5104)(channelId, messageId, tmp2, soundboardSounds);
        tmp5 = tmp16;
        if (tmp9) {
          tmp5 = tmp16;
          if (null == tmp16) {
...
export const getSoundmojiFromMessage = function getSoundmojiFromMessage(guildId, channelId, messageId, soundId, arg4) {
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(5104)(channelId, messageId, soundId, arg4);
        if (tmp9) {
          if (null == tmp16) {
            const message = MessageStore.getMessage(channelId, messageId);
            let state;
