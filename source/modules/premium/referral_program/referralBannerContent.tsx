...
// Dependencies: [13642, 1074, 13643, 13644, 7649, 1115, 2025, 2]
...
// Module 13653 (referralBannerContent)
...
import Constants from "Constants" /* 13642 */;
...
export const getReferralBannerHeadingText = function getReferralBannerHeadingText(arg0) {
  ...
  } else if (arg0 === tmp(13644).ReferralRewardType.DISCOUNT) {
  ...
  if (arg0) {
    if (null == arg2) {
      ...
      if (numSent.numSent === useReferralProgramBannerDetails.MAX_REFERRALS_SENT) {
        if (numSent.numRedeemed === v1aEjsH(13643).MAX_REFERRALS_SENT) {
    ...
    if (numSent.numRewardGranted !== useReferralProgramBannerDetails.MAX_REFERRALS_SENT) {
      if (numSent.numSent === OluhLp(13643).MAX_REFERRALS_SENT) {
        if (arg2 === OluhLp(13644).ReferralRewardType.ORBS) {
