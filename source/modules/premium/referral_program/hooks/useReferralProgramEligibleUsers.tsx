...
// Dependencies: [5, 32, 19, 7566, 504, 38, 7567, 8329, 2]
// Exports: useReferralProgramEligibleUsers

// Module 13551 (useReferralProgramEligibleUsers)
                ...
                if (null != tmp65) {
                  if (0 !== stateFromStores) {
                    ...
                    if (closure_3 === undefined) {
                      ...
                      if (closure_133_4[1] === searchQuery(7567).ReferralOfferStatus.PENDING) {
                        if (!closure_134_12.has(closure_133_5)) {
                          obj3 = searchQuery(8329);
                          c9 = 5;
                          c10 = 1;
