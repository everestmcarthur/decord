...
// Dependencies: [5, 32, 19, 7526, 504, 38, 7527, 8267, 2]
// Exports: useReferralProgramEligibleUsers

// Module 13495 (useReferralProgramEligibleUsers)
                ...
                if (null != tmp65) {
                  if (0 !== stateFromStores) {
                    ...
                    if (closure_3 === undefined) {
                      ...
                      if (closure_133_4[1] === searchQuery(7527).ReferralOfferStatus.PENDING) {
                        if (!closure_134_12.has(closure_133_5)) {
                          obj3 = searchQuery(8267);
                          c9 = 5;
                          c10 = 1;
