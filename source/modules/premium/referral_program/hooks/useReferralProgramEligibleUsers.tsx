...
// Dependencies: [5, 32, 19, 7562, 504, 38, 7563, 8310, 2]
// Exports: useReferralProgramEligibleUsers

// Module 13543 (useReferralProgramEligibleUsers)
                ...
                if (null != tmp65) {
                  if (0 !== stateFromStores) {
                    ...
                    if (closure_3 === undefined) {
                      ...
                      if (closure_133_4[1] === searchQuery(7563).ReferralOfferStatus.PENDING) {
                        if (!closure_134_12.has(closure_133_5)) {
                          obj3 = searchQuery(8310);
                          c9 = 5;
                          c10 = 1;
