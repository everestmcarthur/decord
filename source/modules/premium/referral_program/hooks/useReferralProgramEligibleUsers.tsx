...
// Dependencies: [5, 32, 19, 7525, 504, 38, 7526, 8266, 2]
// Exports: useReferralProgramEligibleUsers

// Module 13493 (useReferralProgramEligibleUsers)
                ...
                if (null != tmp65) {
                  if (0 !== stateFromStores) {
                    ...
                    if (closure_3 === undefined) {
                      ...
                      if (closure_133_4[1] === searchQuery(7526).ReferralOfferStatus.PENDING) {
                        if (!closure_134_12.has(closure_133_5)) {
                          obj3 = searchQuery(8266);
                          c9 = 5;
                          c10 = 1;
