...
// Function ID: 13558
// Name: ProgressWheel
// Dependencies: [19, 17, 21, 4640, 4341, 576, 13546, 5675, 13558, 8606, 13559, 2]
// Exports: default

// Module 13557 (ProgressWheel)
...
export default function ProgressWheel(arg0) {
  ...
  if (tmp9) {
    const obj4 = { source: tmp4(13558), style: tmp.glowImage };
    tmp9 = React4(tmp4(5675), obj4);
