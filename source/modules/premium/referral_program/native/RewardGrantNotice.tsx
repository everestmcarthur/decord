...
// Dependencies: [19, 17, 13471, 21, 4574, 576, 13473, 11122, 4570, 1114, 7147, 2]
// Exports: default

// Module 13485 (RewardGrantNotice)
...
export default function RewardGrantNotice(arg0) {
  ...
  if (nRewardsGranted < 1) {
    ...
    } else if (referralRewardType === tmp(13473).ReferralRewardType.DISCOUNT) {
