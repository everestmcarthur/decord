...
// Dependencies: [19, 17, 13487, 21, 4606, 576, 13489, 11185, 4602, 1114, 7206, 2]
// Exports: default

// Module 13501 (RewardGrantNotice)
...
import PremiumReferralIncentivesExperiment from "PremiumReferralIncentivesExperiment" /* 13489 */;
...
export default function RewardGrantNotice(arg0) {
  ...
  if (nRewardsGranted < 1) {
    ...
    } else if (referralRewardType === tmp(13489).ReferralRewardType.DISCOUNT) {
