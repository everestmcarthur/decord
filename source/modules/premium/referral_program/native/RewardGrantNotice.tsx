...
// Dependencies: [19, 17, 13489, 21, 4607, 576, 13491, 11187, 4603, 1114, 7207, 2]
// Exports: default

// Module 13503 (RewardGrantNotice)
...
import PremiumReferralIncentivesExperiment from "PremiumReferralIncentivesExperiment" /* 13491 */;
...
export default function RewardGrantNotice(arg0) {
  ...
  if (nRewardsGranted < 1) {
    ...
    } else if (referralRewardType === tmp(13491).ReferralRewardType.DISCOUNT) {
