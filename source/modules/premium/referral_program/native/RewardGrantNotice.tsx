...
// Dependencies: [19, 17, 13520, 21, 4605, 576, 13522, 11162, 4601, 1114, 7185, 2]
// Exports: default

// Module 13534 (RewardGrantNotice)
...
export default function RewardGrantNotice(arg0) {
  ...
  if (nRewardsGranted < 1) {
    ...
    } else if (referralRewardType === tmp(13522).ReferralRewardType.DISCOUNT) {
