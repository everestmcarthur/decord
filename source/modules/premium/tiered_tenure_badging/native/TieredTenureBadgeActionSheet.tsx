...
// Dependencies: [19, 17, 1372, 1374, 1074, 21, 4638, 576, 11311, 7742, 11336, 5673, 4634, 1115, 11337, 504, 1886, 8908, 1249, 1612, 7492, 4605, 8308, 10106, 10109, 7260, 6735, 2]
// Exports: default

// Module 11310 (TieredTenureBadgeActionSheet)
...
import showUserProfileActionSheet from "showUserProfileActionSheet" /* 8308 */;
import useMobileTenureBadgeImages from "useMobileTenureBadgeImages" /* 11311 */;
import useTenureBadgeRequirementString from "useTenureBadgeRequirementString" /* 11336 */;
...
function TieredTenureBadgeItem(arg0) {
  ...
  if (null != tieredTenureBadgeData) {
    ...
    if (isUsersBadge) {
      ...
      isUsersBadge = tmp11(tmp2(4634).Text, obj6);
    }
