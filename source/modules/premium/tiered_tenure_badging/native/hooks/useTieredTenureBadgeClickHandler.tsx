...
// Dependencies: [19, 1372, 1374, 8314, 1074, 7315, 11295, 7739, 504, 7489, 4606, 11296, 1897, 11296, 1241, 2]
// Exports: useTieredTenureBadgeClickHandler

// Module 11294 (useTieredTenureBadgeClickHandler)
...
export const useTieredTenureBadgeClickHandler = function useTieredTenureBadgeClickHandler(id, userId, themeType) {
  ...
  if (typeof id === "string") {
    tmp4 = null != tmp(7739).getTieredTenureBadge(id);
  ...
  if (tmp4) {
    callback = isPremiumSubscriber.useCallback(() => {
      if (closure_2 === UserProfileThemeTypes.YOU_SCREEN) {
        ...
        const tmp4 = asyncRequireImpl(11296, dependencyMap.paths);
        const obj4 = { userId };
