...
// Dependencies: [19, 1371, 1373, 8280, 1074, 7282, 11253, 7707, 504, 7456, 4574, 11254, 1896, 11254, 1242, 2]
// Exports: useTieredTenureBadgeClickHandler

// Module 11252 (useTieredTenureBadgeClickHandler)
...
export const useTieredTenureBadgeClickHandler = function useTieredTenureBadgeClickHandler(id, userId, themeType) {
  ...
  if (typeof id === "string") {
    tmp4 = null != tmp(7707).getTieredTenureBadge(id);
  ...
  if (tmp4) {
    callback = isPremiumSubscriber.useCallback(() => {
      if (closure_2 === UserProfileThemeTypes.YOU_SCREEN) {
        ...
        const tmp4 = asyncRequireImpl(11254, dependencyMap.paths);
        const obj4 = { userId };
