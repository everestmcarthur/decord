...
// Dependencies: [1374, 11437, 7830, 1115, 2]
// Exports: getTenureBadgeRequirementString, useTenureBadgeRequirementString

// Module 11436 (useTenureBadgeRequirementString)
import util from "util" /* 1115 */;
import PremiumConstants from "PremiumConstants" /* 1374 */;
import useTenureBadging from "useTenureBadging" /* 11437 */;
...
export const useTenureBadgeRequirementString = function useTenureBadgeRequirementString() {
  ...
  if (null == tieredTenureBadge) {
    ...
    const tieredTenureBadgeData = tmp(7830).getTieredTenureBadgeData(tieredTenureBadge);
