...
// Dependencies: [19, 17, 21, 4606, 576, 7235, 13478, 8859, 1250, 10831, 13481, 4602, 4301, 10060, 2]
// Exports: default

// Module 13477 (MarketingPageBannerTile)
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const obj = helpArticleLinkProps(13478);
  const obj3 = { type: null, name: null, properties: null };
  const buttonActionHandler = helpArticleLinkProps(13478).getButtonActionHandler(obj2);
  ...
  obj3.properties = { component_type: helpArticleLinkProps(10831).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  tmp2Result(obj3);
  const obj4 = { component_type: helpArticleLinkProps(10831).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  const formatStringWithCommonPremiumParams = helpArticleLinkProps(13481).useFormatStringWithCommonPremiumParams(bannerFields.body);
  const tmp4Result = helpArticleLinkProps(13481);
  helpArticleLinkProps = helpArticleLinkProps(13481).getHelpArticleLinkProps(bannerFields.helpArticle, bannerFields.helpArticleId);
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4602).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result3) {
    ...
    tmp12Result3 = tmp12(tmp4(4602).Text, obj11);
  }
  items3[2] = tmp12Result3;
  obj10.children = items3;
  items2[2] = closure_6(helpArticleLinkProps(4602).Text, obj10);
  ...
  if (tmp12Result4) {
    ...
    obj12.children = tmp12(tmp2(10060), obj13);
