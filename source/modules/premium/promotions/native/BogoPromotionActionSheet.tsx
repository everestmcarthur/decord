...
// Dependencies: [19, 17, 1374, 1074, 1955, 21, 4639, 576, 7269, 7529, 7257, 5672, 4635, 1115, 2025, 10101, 2]
// Exports: default

// Module 17083 (BogoPromotionActionSheet)
...
export default function BogoPromotionActionSheet(markAsDismissed) {
  ...
  obj2.style = items2;
  const items3 = [closure_12(analyticsLocations(5672), { source: { uri: "https://cdn.discordapp.com/assets/content/a59aed2e0e61a955dc3e0f4f6f7ab295e39f89a93c4f01e4bd84ed7fb418ec63.png" }, style: tmp.image }), , , ];
