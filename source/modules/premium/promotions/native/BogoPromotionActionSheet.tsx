...
// Dependencies: [19, 17, 1373, 1074, 1954, 21, 4606, 576, 7235, 7495, 7223, 5638, 4602, 1114, 2024, 10060, 2]
// Exports: default
...
export default function BogoPromotionActionSheet(markAsDismissed) {
  ...
  obj2.style = items2;
  const items3 = [closure_12(analyticsLocations(5638), { source: { uri: "https://cdn.discordapp.com/assets/content/a59aed2e0e61a955dc3e0f4f6f7ab295e39f89a93c4f01e4bd84ed7fb418ec63.png" }, style: tmp.image }), , , ];
  ...
  items3[1] = closure_12(markAsDismissed(4602).Text, obj4);
  ...
  items3[2] = closure_12(markAsDismissed(4602).Text, obj5);
  ...
  obj8.children = closure_12(analyticsLocations(10060), obj9);
