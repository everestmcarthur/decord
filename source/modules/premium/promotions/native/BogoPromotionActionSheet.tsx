...
// Dependencies: [19, 17, 1373, 1074, 1954, 21, 4574, 576, 7176, 7436, 7164, 5601, 4570, 1114, 2024, 10002, 2]
// Exports: default

// Module 16970 (BogoPromotionActionSheet)
...
export default function BogoPromotionActionSheet(markAsDismissed) {
  ...
  obj2.style = items2;
  const items3 = [closure_12(analyticsLocations(5601), { source: { uri: "https://cdn.discordapp.com/assets/content/a59aed2e0e61a955dc3e0f4f6f7ab295e39f89a93c4f01e4bd84ed7fb418ec63.png" }, style: tmp.image }), , , ];
  ...
  items3[1] = closure_12(markAsDismissed(4570).Text, obj4);
  ...
  items3[2] = closure_12(markAsDismissed(4570).Text, obj5);
  ...
  obj8.children = closure_12(analyticsLocations(10002), obj9);
  items3[3] = closure_12(View, obj8);
  obj2.children = items3;
  obj.children = closure_13(View, obj2);
  return closure_12(markAsDismissed(7164).BottomSheet, obj);
};
