...
// Dependencies: [1221, 10671, 1371, 10672, 10702, 504, 10703, 573, 2]

// Module 10670 (createEmptyPromotionsByType)
import initializeDefault from "initialize" /* 504 */;
import dispatcherDefault from "dispatcher" /* 573 */;
import closure_3 from "handleConnectionClosedOrResumed" /* 1221 */;
import closure_4 from "createFromServer" /* 10671 */;
import closure_5 from "mergeGuildAvatar" /* 1371 */;
import closure_6 from "createFromServer" /* 10672 */;
...
function getLatestActiveOutboundPromotionStartDate() {
  let startDate = null;
  const values = Object.values(dependencyMap[require(undefined, 10702) /* CountryListMode */.PromotionTypes.THIRD_PARTY_OUTBOUND]);
...
Object.defineProperty(prototype, "outboundPromotions", {
  get: function outboundPromotions() {
    return Object.values(dependencyMap[require(undefined, 10702) /* CountryListMode */.PromotionTypes.THIRD_PARTY_OUTBOUND]);
  },
  set: undefined
});
Object.defineProperty(prototype, "outboundRecurringPromotions", {
  get: function outboundRecurringPromotions() {
    return Object.values(dependencyMap[require(undefined, 10702) /* CountryListMode */.PromotionTypes.THIRD_PARTY_OUTBOUND_RECURRING]);
  },
  set: undefined
});
...
prototype["getMarketingComponentByType"] = function getMarketingComponentByType(GIFT_CUSTOMIZATION_BANNER) {
  ...
  if (componentType === GIFT_CUSTOMIZATION_BANNER) {
    ...
    return date(10703)(items, date, (isIncludedInRollout) => {
...
prototype["getPromotionsByPartner"] = function getPromotionsByPartner(arg0) {
  ...
  let values = Object.values(dependencyMap[_require(undefined, 10702).PromotionTypes.THIRD_PARTY_OUTBOUND]);
  obj[0] = values.filter((partnerId) => partnerId.partnerId === closure_0);
  values = Object.values(dependencyMap[_require(undefined, 10702).PromotionTypes.THIRD_PARTY_OUTBOUND_RECURRING]);
  obj[1] = values.filter((partnerId) => partnerId.partnerId === closure_0);
  return obj;
};
prototype["getGiftPromotion"] = function getGiftPromotion() {
  const tmp = dependencyMap[require(undefined, 10702) /* CountryListMode */.PromotionTypes.GIFT_PROMOTION];
...
prototype["getMarketingMomentPromotion"] = function getMarketingMomentPromotion() {
  const tmp = dependencyMap[require(undefined, 10702) /* CountryListMode */.PromotionTypes.MARKETING_MOMENT];
  const keys = Object.keys(tmp);
  if (0 === keys.length) {
    return null;
  } else {
...
prototype["getActiveBogoRewardPromotion"] = function getActiveBogoRewardPromotion() {
  const date = new Date();
  const values = Object.values(dependencyMap[date(undefined, 10702).PromotionTypes.MARKETING_MOMENT]);
...
const promotionsStore = new PromotionsStore(dispatcherDefault, {
  ...
  OUTBOUND_PROMOTION_NOTICE_DISMISS: function handleDismissOutboundPromotionNotice() {
    if (0 === Object.values(dependencyMap[require(undefined, 10702) /* CountryListMode */.PromotionTypes.THIRD_PARTY_OUTBOUND]).length) {
      return false;
    } else {
