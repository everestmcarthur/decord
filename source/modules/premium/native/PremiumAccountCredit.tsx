...
// Dependencies: [19, 17, 7501, 1074, 21, 4639, 576, 7279, 4297, 1115, 3075, 9507, 4635, 504, 12, 2]
// Exports: default

// Module 13484 (PremiumAccountCredit)
...
function AccountCreditTier(arg0) {
  ...
  if (result1) {
    ...
    obj8.children = tmp24(tmp2(9507).BoostGemIcon, obj9);
    let tmp24Result = tmp24(tmp22, obj8);
    let tmp27 = tmp24;
  } else {
    const obj10 = { size: tmp2(7279).GameIconSizes.SMALL, skuId: result };
    tmp24Result = tmp24(tmp4(7279), obj10);
    tmp27 = tmp24;
    const tmp4Result = tmp4(7279);
  }
  ...
  if (!tmp18) {
    ...
    tmp27Result = tmp27(tmp2(4635).Text, obj13);
  }
...
let size = { width: fn(7279).GameIconImageSize[fn(undefined, 7279).GameIconSizes.SMALL], height: fn(7279).GameIconImageSize[fn(undefined, 7279).GameIconSizes.SMALL], alignItems: "center", justifyContent: "center" };
obj2.boostIcon = size;
...
export default function PremiumAccountCredit(currentSubscription) {
  ...
  if (null != entitlements) {
    if (obj8.hasAccountCredit(entitlements)) {
      ...
      const items1 = [closure_6(tmp2(4635).Text, obj3), , , ];
      ...
      items1[2] = closure_6(tmp2(4635).Text, obj5);
      let tmp9Result = null;
      if (null != currentSubscription) {
        tmp9Result = null;
        if (currentSubscription.isPurchasedExternally) {
          ...
          tmp9Result = closure_6(tmp2(4635).Text, obj6);
        }
      }
      items1[3] = tmp9Result;
