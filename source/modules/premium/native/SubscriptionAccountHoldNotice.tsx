...
// Dependencies: [19, 17, 1074, 21, 4574, 576, 1178, 12799, 4570, 1114, 4231, 4989, 2]
// Exports: default

// Module 13372 (SubscriptionAccountHoldNotice)
...
export default function SubscriptionAccountHoldNotice(subscription) {
  ...
  if (subscription.status === SubscriptionStatusTypes.ACCOUNT_HOLD) {
    ...
    const obj3 = { size: subscription(1178).IconSizes.MEDIUM, style: tmp.icon, source: _modDef12799 };
    ...
    const obj5 = { endDate: subscription.currentPeriodEnd, planDescription: subscription(4231).getDisplayName(subscription.planId) };
    obj4.children = intl.format(subscription(1114).t["7I21Iz"], obj5);
    items[1] = closure_6(subscription(4570).Text, obj4);
    obj2.children = items;
    ...
    items1[1] = closure_6(subscription(4989).Button, obj7);
    obj.children = items1;
    tmp2 = closure_7(closure_4, obj);
    const obj6 = subscription(4231);
  }
  return tmp2;
};
