...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 1177, 12904, 4635, 1115, 4297, 5059, 2]
// Exports: default

// Module 13481 (SubscriptionAccountHoldNotice)
...
export default function SubscriptionAccountHoldNotice(subscription) {
  ...
  if (subscription.status === SubscriptionStatusTypes.ACCOUNT_HOLD) {
    ...
    const obj3 = { size: subscription(1177).IconSizes.MEDIUM, style: tmp.icon, source: _modDef12904 };
    ...
    items[1] = closure_6(subscription(4635).Text, obj4);
    obj2.children = items;
    ...
    items1[1] = closure_6(subscription(5059).Button, obj7);
    obj.children = items1;
