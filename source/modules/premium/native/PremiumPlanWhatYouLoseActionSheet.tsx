...
// Dependencies: [19, 17, 1373, 21, 4574, 576, 5601, 4570, 4231, 7176, 13362, 38, 13366, 1114, 13367, 13322, 13368, 13369, 4541, 7164, 7445, 4989, 10695, 2]
// Exports: default
...
export default function PremiumPlanWhatYouLoseActionSheet(arg0) {
  ...
  const memo = analyticsLocations.useMemo(() => {
    if (PremiumTypes.TIER_0 === premiumTypeFromSubscription) {
      const obj2 = { imageSource: _modDef13366, text: null };
      const intl7 = util.intl;
      obj2.text = intl7.format(util.t["0hUHi6"], {});
      const items = [obj2, ];
      const obj3 = { imageSource: _modDef13367, text: null };
      ...
      items1[1] = obj5;
      const obj6 = { imageSource: _modDef13368, text: null };
      const intl6 = util.intl;
      obj6.text = intl6.format(util.t.K4Hv69, {});
      items1[2] = obj6;
      return items1;
    } else if (tmp2.TIER_2 === tmp) {
      const obj = { imageSource: _modDef13369, text: null };
      const intl = util.intl;
      obj.text = intl.format(util.t["gpqr+n"], {});
      const items2 = [obj, , ];
      obj7 = { imageSource: _modDef13368, text: null };
      const intl2 = util.intl;
      obj7.text = intl2.format(util.t.wRxEDW, {});
      items2[1] = obj7;
      const obj8 = { imageSource: _modDef13322, text: null };
