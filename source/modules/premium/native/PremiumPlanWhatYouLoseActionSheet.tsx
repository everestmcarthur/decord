...
// Dependencies: [19, 17, 1373, 21, 4607, 576, 5639, 4603, 4264, 7236, 13434, 38, 13438, 1114, 13439, 13396, 13440, 13441, 4574, 7224, 7505, 5027, 10754, 2]
// Exports: default

// Module 13433 (PremiumPlanWhatYouLoseActionSheet)
...
export default function PremiumPlanWhatYouLoseActionSheet(arg0) {
  ...
  const memo = analyticsLocations.useMemo(() => {
    if (PremiumTypes.TIER_0 === premiumTypeFromSubscription) {
      const obj2 = { imageSource: _modDef13438, text: null };
      const intl7 = util.intl;
      obj2.text = intl7.format(util.t["0hUHi6"], {});
      const items = [obj2, ];
      const obj3 = { imageSource: _modDef13439, text: null };
      ...
      const items1 = [obj4, , ];
      const obj5 = { imageSource: _modDef13396, text: null };
      const intl5 = util.intl;
      obj5.text = intl5.format(util.t.wK04T1, {});
      items1[1] = obj5;
      const obj6 = { imageSource: _modDef13440, text: null };
      const intl6 = util.intl;
      obj6.text = intl6.format(util.t.K4Hv69, {});
      items1[2] = obj6;
      return items1;
    } else if (tmp2.TIER_2 === tmp) {
      const obj = { imageSource: _modDef13441, text: null };
      const intl = util.intl;
      obj.text = intl.format(util.t["gpqr+n"], {});
      const items2 = [obj, , ];
      obj7 = { imageSource: _modDef13440, text: null };
      const intl2 = util.intl;
      obj7.text = intl2.format(util.t.wRxEDW, {});
      items2[1] = obj7;
      const obj8 = { imageSource: _modDef13396, text: null };
