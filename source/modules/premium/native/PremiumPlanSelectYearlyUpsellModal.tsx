...
// Dependencies: [32, 19, 17, 2025, 7251, 13570, 1373, 1085, 21, 4574, 5538, 5455, 7423, 504, 1880, 5008, 13580, 1178, 1114, 4231, 4989, 2]
// Exports: default

// Module 13579 (PremiumPlanSelectYearlyUpsellModal)
...
const usePremiumPlanSelectStore = fn(13570).usePremiumPlanSelectStore;
...
obj2.header = obj3;
obj2.description = { alignSelf: "center", textAlign: "center", paddingBottom: 32, color: fn(5455).DARK_WHITE_500_LIGHT_BLACK_500 };
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  const premiumBundledItemsFromProductId = productId(7423).getPremiumBundledItemsFromProductId(productId);
  const obj2 = productId(7423);
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj9.planName = tmp5(4231).getPremiumTypeDisplayName(premiumTier);
    ...
    obj12.children = closure_11(tmp5(4989).Button, obj13);
    ...
    obj15.children = closure_11(tmp5(4989).Button, obj16);
    ...
    obj17.children = closure_11(tmp5(4989).Button, obj18);
