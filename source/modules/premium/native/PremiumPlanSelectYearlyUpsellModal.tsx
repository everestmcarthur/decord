...
// Dependencies: [32, 19, 17, 2026, 7344, 13635, 1374, 1085, 21, 4639, 5609, 5526, 7516, 504, 1881, 5078, 13645, 1177, 1115, 4297, 5059, 2]
// Exports: default
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj12.children = closure_11(tmp5(5059).Button, obj13);
    ...
    obj15.children = closure_11(tmp5(5059).Button, obj16);
    ...
    obj17.children = closure_11(tmp5(5059).Button, obj18);
