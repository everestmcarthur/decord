...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj2[2] = imageStyle;
      imageSrc = callback(tmp6(4556).Text, obj2);
      obj1[1] = imageSrc;
    ...
    if (null != description) {
      ...
      obj4[1] = description;
      let tmp21 = callback(tmp6(4556).Text, obj4);
    } else {
      tmp21 = null;
    ...
    obj8[0] = items5;
    obj8[3] = title;
    items4[2] = callback(tmp6(4556).Text, obj8);
    ...
    if (tmp29Result) {
      ...
      obj10[1] = tmp29(tmp6(4975).Button, obj11);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  const callback = React.useCallback(() => {
    obj = subscriptionPlansLoaded(7382);
    obj = { screen: constants.COLLECTIBLES_SHOP, params: null };
    obj = { analyticsSource: callback(7182).PREMIUM_MARKETING_PERK_CARD };
    obj[1] = obj;
  ...
  obj[0] = intl.string(subscriptionPlansLoaded(1114).t.KcyDwF);
  const intl2 = subscriptionPlansLoaded(1114).intl;
  obj[1] = intl2.string(subscriptionPlansLoaded(1114).t.Mt3U1W);
  obj[2] = registerAssetDefault;
  obj[3] = callback1;
  obj[0] = obj;
  obj1 = { title: null, description: null, imageSrc: null, buttonOnPress: null };
  const intl3 = subscriptionPlansLoaded(1114).intl;
  obj1[0] = intl3.string(subscriptionPlansLoaded(1114).t.kWM48G);
  const intl4 = subscriptionPlansLoaded(1114).intl;
  obj1[1] = intl4.string(subscriptionPlansLoaded(1114).t.CjRASJ);
  ...
  obj2[0] = intl5.string(subscriptionPlansLoaded(1114).t["NyDu/6"]);
  const intl6 = subscriptionPlansLoaded(1114).intl;
  obj2[1] = intl6.string(subscriptionPlansLoaded(1114).t["4pEwXL"]);
  ...
  obj3[0] = intl7.string(subscriptionPlansLoaded(1114).t["NyDu/6"]);
  const intl8 = subscriptionPlansLoaded(1114).intl;
  obj3[1] = intl8.string(subscriptionPlansLoaded(1114).t["4pEwXL"]);
  obj3[2] = registerAssetDefault4;
  const intl9 = subscriptionPlansLoaded(1114).intl;
  obj3[3] = intl9.string(subscriptionPlansLoaded(1114).t["/VzCKE"]);
  obj[3] = obj3;
  const obj4 = { title: null, description: null, imageSrc: null, buttonOnPress: null };
  const intl10 = subscriptionPlansLoaded(1114).intl;
  obj4[0] = intl10.string(subscriptionPlansLoaded(1114).t.OuItFi);
  const intl11 = subscriptionPlansLoaded(1114).intl;
  obj4[1] = intl11.string(subscriptionPlansLoaded(1114).t.mPyrE6);
  ...
  obj5[0] = intl12.string(subscriptionPlansLoaded(1114).t["R2IV/Q"]);
  const intl13 = subscriptionPlansLoaded(1114).intl;
  obj5[1] = intl13.string(subscriptionPlansLoaded(1114).t.R5Xag2);
  ...
  obj6[0] = intl14.string(subscriptionPlansLoaded(1114).t.LWsArT);
  const intl15 = subscriptionPlansLoaded(1114).intl;
  obj6[1] = intl15.string(subscriptionPlansLoaded(1114).t["4lSyCY"]);
  ...
  obj7[0] = intl16.string(subscriptionPlansLoaded(1114).t.tzdIwI);
  const intl17 = subscriptionPlansLoaded(1114).intl;
  obj7[1] = intl17.string(subscriptionPlansLoaded(1114).t.hJG8ZN);
  ...
  obj8[0] = intl18.string(subscriptionPlansLoaded(1114).t.EYxi0o);
  const intl19 = subscriptionPlansLoaded(1114).intl;
  obj8[1] = intl19.string(subscriptionPlansLoaded(1114).t.M9AIt1);
  ...
  obj9[0] = intl20.string(subscriptionPlansLoaded(1114).t["H4/NBN"]);
  const intl21 = subscriptionPlansLoaded(1114).intl;
  obj9[1] = intl21.string(subscriptionPlansLoaded(1114).t.wo3D3T);
  ...
  obj10[0] = intl22.formatToPlainString(subscriptionPlansLoaded(1114).t.jqhAdL, { premiumMaxSize: maxFileSizeForPremiumType });
  const intl23 = subscriptionPlansLoaded(1114).intl;
  obj10[1] = intl23.formatToPlainString(subscriptionPlansLoaded(1114).t["HI+cfm"], { premiumMaxSize: maxFileSizeForPremiumType });
  ...
  obj11[0] = intl24.string(subscriptionPlansLoaded(1114).t.RSXQYO);
  const intl25 = subscriptionPlansLoaded(1114).intl;
  obj11[1] = intl25.string(subscriptionPlansLoaded(1114).t.ymCPxp);
  ...
  obj12[0] = intl26.string(subscriptionPlansLoaded(1114).t["6S7kO7"]);
  const intl27 = subscriptionPlansLoaded(1114).intl;
  obj12[1] = intl27.string(subscriptionPlansLoaded(1114).t.A0U9fk);
  ...
  obj13[0] = intl28.string(subscriptionPlansLoaded(1114).t["f4M+H9"]);
  const intl29 = subscriptionPlansLoaded(1114).intl;
  obj13[1] = intl29.string(subscriptionPlansLoaded(1114).t["7ZCYvC"]);
  ...
  obj14[0] = intl30.string(subscriptionPlansLoaded(1114).t.dcFfSJ);
  const intl31 = subscriptionPlansLoaded(1114).intl;
  obj14[1] = intl31.string(subscriptionPlansLoaded(1114).t["37MFFq"]);
  ...
  obj18[1] = intl36.format(subscriptionPlansLoaded(1114).t["9Wv+8h"], obj19);
  obj16[3] = callback(subscriptionPlansLoaded(4556).Text, obj18);
  obj[16] = obj16;
  return obj;
};
