...
// Dependencies: [19, 17, 1373, 1074, 21, 5033, 13451, 4264, 7455, 7255, 1114, 13452, 13453, 13454, 13455, 13456, 13457, 13458, 13459, 13460, 13461, 13462, 13463, 13464, 13465, 13466, 13467, 13468, 4602, 2024, 4606, 576, 5638, 13469, 5026, 2]
// Exports: default, usePerkCardHeight, usePremiumPerkCard

// Module 13450 (PremiumPerkCard)
...
import PillTextDefault from "PillText" /* 13469 */;
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      imageSrc = React7(tmp6(4602).Text, obj5);
    ...
    if (null != description) {
      ...
      let tmp21 = React7(tmp6(4602).Text, obj7);
    } else {
      tmp21 = null;
    ...
    items4[2] = React7(tmp6(4602).Text, obj11);
    ...
    if (tmp29Result) {
      ...
      obj13.children = tmp29(tmp6(5026).Button, obj14);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  subscriptionPlansLoaded = subscriptionPlansLoaded(13451).useSubscriptionPlansLoaded();
  let obj = subscriptionPlansLoaded(13451);
  ...
  const callback = noop.useCallback(() => {
    ...
    const obj = subscriptionPlansLoaded(7455);
    obj2.params = { analyticsSource: AnalyticsLocationDefault.PREMIUM_MARKETING_PERK_CARD };
    obj.openUserSettings(obj2);
  }, []);
  const callback1 = noop.useCallback(() => {
    subscriptionPlansLoaded(7455).openUserSettings({ screen: constants.PROFILE_CUSTOMIZATION });
  }, []);
  const items = [subscriptionPlansLoaded];
  const callback2 = noop.useCallback(() => {
    subscriptionPlansLoaded(7455).openUserSettings({ screen: constants.APPEARANCE_THEME_PICKER });
  }, []);
  ...
  const callback4 = noop.useCallback(() => {
    subscriptionPlansLoaded(7455).openUserSettings({ screen: constants.APP_ICONS });
  }, []);
  ...
  obj20.imageSrc = { uri: _modDef13468 };
  ...
  obj20.bodyComponent = closure_9(subscriptionPlansLoaded(4602).Text, obj22);
