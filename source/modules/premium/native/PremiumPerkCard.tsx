...
// Dependencies: [19, 17, 1373, 1074, 21, 5032, 13493, 4262, 7434, 7234, 1114, 13494, 13495, 13496, 13497, 13498, 13499, 13500, 13501, 13502, 13503, 13504, 13505, 13506, 13507, 13508, 13509, 13510, 4601, 2024, 4605, 576, 5637, 13511, 5025, 2]
// Exports: default, usePerkCardHeight, usePremiumPerkCard

// Module 13492 (PremiumPerkCard)
...
import PillTextDefault from "PillText" /* 13511 */;
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      imageSrc = React7(tmp6(4601).Text, obj5);
    ...
    if (null != description) {
      ...
      let tmp21 = React7(tmp6(4601).Text, obj7);
    } else {
      tmp21 = null;
    ...
    items4[2] = React7(tmp6(4601).Text, obj11);
    ...
    if (tmp29Result) {
      ...
      obj13.children = tmp29(tmp6(5025).Button, obj14);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  subscriptionPlansLoaded = subscriptionPlansLoaded(13493).useSubscriptionPlansLoaded();
  let obj = subscriptionPlansLoaded(13493);
  const maxFileSizeForPremiumType = subscriptionPlansLoaded(4262).getMaxFileSizeForPremiumType(PremiumTypes.TIER_2);
  const callback = noop.useCallback(() => {
    const obj2 = { screen: constants.COLLECTIBLES_SHOP, params: null };
    const obj = subscriptionPlansLoaded(7434);
    obj2.params = { analyticsSource: AnalyticsLocationDefault.PREMIUM_MARKETING_PERK_CARD };
    obj.openUserSettings(obj2);
  }, []);
  const callback1 = noop.useCallback(() => {
    subscriptionPlansLoaded(7434).openUserSettings({ screen: constants.PROFILE_CUSTOMIZATION });
  }, []);
  const items = [subscriptionPlansLoaded];
  const callback2 = noop.useCallback(() => {
    subscriptionPlansLoaded(7434).openUserSettings({ screen: constants.APPEARANCE_THEME_PICKER });
  }, []);
  ...
  const callback4 = noop.useCallback(() => {
    subscriptionPlansLoaded(7434).openUserSettings({ screen: constants.APP_ICONS });
  }, []);
  ...
  let obj2 = subscriptionPlansLoaded(4262);
  obj20.imageSrc = { uri: _modDef13510 };
  ...
  obj20.bodyComponent = closure_9(subscriptionPlansLoaded(4601).Text, obj22);
