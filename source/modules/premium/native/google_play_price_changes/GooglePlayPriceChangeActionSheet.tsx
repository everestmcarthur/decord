...
// Dependencies: [19, 17, 4270, 17018, 1074, 1954, 21, 4607, 576, 504, 4264, 7308, 7224, 4603, 1114, 2024, 5027, 2]
// Exports: default
...
export default function GooglePlayPriceChangeActionSheet(markAsDismissed) {
  ...
  const tmp2Result7 = markAsDismissed(7308);
  const formatPriceResult = markAsDismissed(7308).formatPrice(stateFromStores.oldPrice, stateFromStores.oldCurrency);
  const tmp2Result8 = markAsDismissed(7308);
  ...
  const items2 = [closure_8(markAsDismissed(4603).Text, obj6), ];
  ...
  const formatPriceResult1 = markAsDismissed(7308).formatPrice(stateFromStores.newPrice, stateFromStores.newCurrency);
  ...
  items2[1] = closure_8(markAsDismissed(4603).Text, obj7);
  ...
  items3[1] = closure_8(markAsDismissed(5027).Button, obj9);
  obj4.children = items3;
  obj3.children = closure_9(View, obj4);
  return closure_8(markAsDismissed(7224).BottomSheet, obj3);
};
