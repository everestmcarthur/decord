...
// Dependencies: [19, 4631, 21, 4639, 576, 4341, 504, 1364, 4376, 5207, 5614, 2]
// Exports: PremiumAnimatedGiftButton

// Module 12383 (PremiumAnimatedGiftButton)
...
export const PremiumAnimatedGiftButton = function PremiumAnimatedGiftButton(arg0) {
  ...
  obj6.children = jsx(tmp3(5614), { ref: tmp9, style: tmp7.animationRefresh, source: { uri: animationDataUrl }, loop, autoPlay: false, onAnimationFinish: onAnimationFinished });
  ...
  return jsx(stateFromStores(4376).View, { exiting: FadeOut, children: null });
};
