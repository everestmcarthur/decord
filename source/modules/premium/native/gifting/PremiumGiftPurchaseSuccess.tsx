...
// Dependencies: [19, 17, 5561, 1373, 1074, 21, 4606, 576, 10788, 1483, 10832, 4845, 10751, 8447, 5026, 1114, 4264, 7262, 4304, 10919, 4602, 8992, 4554, 2]
// Exports: PremiumGiftSuccessActions, default

// Module 11168 (PremiumGiftPurchaseSuccess)
...
export default function PremiumGiftSuccessBody(giftCodeRecord) {
  ...
  let tmp = closure_11();
  const nativeGiftContext = giftCodeRecord(10788).useNativeGiftContext();
  ({ giftStyle, premiumType, planInterval } = nativeGiftContext);
  let obj = giftCodeRecord(10788);
  const giftCodeURL = giftCodeRecord(4845).getGiftCodeURL(giftCodeRecord.code);
  ...
  obj3.children = closure_8(giftCodeURL(10919), { giftStyle });
  ...
  items1[1] = closure_8(giftCodeRecord(4602).Text, obj6);
  ...
  items1[2] = closure_8(giftCodeRecord(4602).Text, obj7);
  ...
  const items2 = [closure_8(giftCodeRecord(4602).Text, obj10), ];
  obj5 = giftCodeURL(4264);
  const tmp10 = closure_9;
  const tmp12 = View;
  items2[1] = closure_8(giftCodeRecord(8992).InputButton, { text: giftCodeURL, icon: tmp6(4554), iconPosition: "end", onPress: callback });
  ...
  items1[4] = closure_8(giftCodeRecord(4602).Text, obj12);
