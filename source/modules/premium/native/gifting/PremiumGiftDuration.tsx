...
// Dependencies: [19, 17, 1374, 21, 4639, 576, 10832, 5690, 8721, 10884, 4358, 4635, 1115, 2]
// Exports: default

// Module 11184 (PremiumGiftDuration)
...
function PremiumGiftDurationButton(arg0) {
  ...
  if (selected) {
    let RowButton = tmp(5690).TableRow;
  } else {
    RowButton = tmp(8721).RowButton;
  }
  let combined = null;
  ...
  if (tmp11Result) {
    ...
    obj4.children = tmp11(tmp(4635).Text, obj5);
