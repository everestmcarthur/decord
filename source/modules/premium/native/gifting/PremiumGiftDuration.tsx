...
// Dependencies: [19, 17, 1373, 21, 4607, 576, 10790, 5657, 8688, 10842, 4325, 4603, 1114, 2]
// Exports: default

// Module 11142 (PremiumGiftDuration)
import nativeDefault from "native" /* 576 */;
import useA11yRolesNative from "useA11yRolesNative" /* 4325 */;
import Text_Text from "Text/Text" /* 4603 */;
import NativeGiftContext from "NativeGiftContext" /* 10790 */;
...
function PremiumGiftDurationButton(arg0) {
  ...
  if (selected) {
    let RowButton = tmp(5657).TableRow;
  } else {
    RowButton = tmp(8688).RowButton;
  }
  let combined = null;
  ...
  if (tmp11Result) {
    ...
    obj4.children = tmp11(tmp(4603).Text, obj5);
...
export default function PremiumGiftDuration() {
  ...
  planInterval = planInterval(10790).useNativeGiftContext().planInterval;
  ...
  items = [closure_6(planInterval(4603).Text, obj3), ];
