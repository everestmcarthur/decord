...
// Dependencies: [19, 17, 1373, 21, 4606, 576, 10788, 5656, 8686, 10840, 4325, 4602, 1114, 2]
// Exports: default

// Module 11140 (PremiumGiftDuration)
...
function PremiumGiftDurationButton(arg0) {
  ...
  if (selected) {
    let RowButton = tmp(5656).TableRow;
  } else {
    RowButton = tmp(8686).RowButton;
  }
  let combined = null;
  ...
  if (tmp11Result) {
    ...
    obj4.children = tmp11(tmp(4602).Text, obj5);
...
export default function PremiumGiftDuration() {
  ...
  planInterval = planInterval(10788).useNativeGiftContext().planInterval;
  ...
  items = [closure_6(planInterval(4602).Text, obj3), ];
