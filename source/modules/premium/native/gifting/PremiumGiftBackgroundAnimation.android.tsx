...
// Dependencies: [32, 19, 17, 4631, 21, 4639, 504, 8190, 10964, 5614, 2]
// Exports: default

// Module 10963 (PremiumGiftBackgroundAnimation)
import PremiumGiftingUtils from "PremiumGiftingUtils" /* 8190 */;
import GiftAnimationData from "GiftAnimationData" /* 10964 */;
...
export default function PremiumGiftBackgroundAnimation(giftStyle) {
  ...
  const callback = first.useCallback((arg0) => {
    if (first3) {
      ...
      if (!tmp4) {
        closure_9(tmp2(8190).AnimationState.ACTION);
        closure_5(tmp2(8190).AnimationState.LOOP);
      }
