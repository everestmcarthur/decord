...
// Dependencies: [19, 17, 1182, 1980, 4534, 4303, 1074, 21, 4639, 576, 5609, 7546, 4635, 1115, 11, 5207, 5519, 5669, 13594, 504, 1397, 13595, 13599, 4963, 4537, 12, 2]
// Exports: default

// Module 13593 (GuildBoostSlotsInventory)
...
const SubscriptionPlaceholderPattern = tmp2(13595);
require = fn;
...
function GuildBoostSlot(guildBoostSlot) {
  ...
  if (null == guildBoostSlot.guild) {
    ...
    if (!guildBoostSlot.isOnCooldown()) {
      ...
      obj5.children = tmp6(guildBoostSlot(4635).Text, obj6);
      tmp6Result2 = tmp6(guildBoostSlot(5207).PressableOpacity, obj5);
    }
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      if (found.length > 0) {
        ...
        const items3 = [closure_11(tmp3(4635).Text, obj7), found.map((guildId) => closure_2_11(BoostedGuild, { guildId, guildBoostSlots: valueResult[guildId] }, guildId))];
        obj6.children = items3;
