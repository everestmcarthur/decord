...
// Dependencies: [19, 17, 1182, 1980, 4532, 4301, 1074, 21, 4638, 576, 5610, 7549, 4634, 1115, 11, 5208, 5520, 5670, 13606, 504, 1397, 13607, 13611, 4962, 4535, 12, 2]
// Exports: default

// Module 13605 (GuildBoostSlotsInventory)
...
const SubscriptionPlaceholderPattern = tmp2(13607);
require = fn;
...
function GuildBoostSlot(guildBoostSlot) {
  ...
  if (null == guildBoostSlot.guild) {
    ...
    if (!guildBoostSlot.isOnCooldown()) {
      ...
      obj5.children = tmp6(guildBoostSlot(4634).Text, obj6);
      tmp6Result2 = tmp6(guildBoostSlot(5208).PressableOpacity, obj5);
    }
...
function UnusedGuildBoostSlots(unusedSlots) {
  ...
  if (found1.length > 0) {
    ...
    obj4.children = closure_11(found(4634).Text, obj5);
    obj2.action = closure_11(found(5208).PressableOpacity, obj4);
...
function BoostedGuildInfo(guild) {
  ...
  if (null != guild) {
    ...
    const obj7 = { source: _modDef13606, style: tmp.guildInfoRowIcon };
...
function BoostedGuild(arg0) {
  ...
  items3[2] = closure_11(guildBoostSlots(13611), { guild: stateFromStores, theme: stateFromStores1 });
...
export default function GuildBoostSlotsInventory() {
  ...
  const effect = noop.useEffect(() => {
    ...
    const guildBoostSlots = valueResult(4535).fetchGuildBoostSlots();
  }, []);
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      if (found.length > 0) {
        ...
        const items3 = [closure_11(tmp3(4634).Text, obj7), found.map((guildId) => closure_2_11(BoostedGuild, { guildId, guildBoostSlots: valueResult[guildId] }, guildId))];
        obj6.children = items3;
