...
// Dependencies: [19, 17, 1182, 1980, 4534, 4303, 1074, 21, 4640, 576, 5612, 7553, 4636, 1115, 11, 5210, 5522, 5672, 13614, 504, 1397, 13615, 13619, 4964, 4537, 12, 2]
// Exports: default

// Module 13613 (GuildBoostSlotsInventory)
...
const SubscriptionPlaceholderPattern = tmp2(13615);
require = fn;
...
function GuildBoostSlot(guildBoostSlot) {
  ...
  if (null == guildBoostSlot.guild) {
    ...
    if (!guildBoostSlot.isOnCooldown()) {
      ...
      obj5.children = tmp6(guildBoostSlot(4636).Text, obj6);
      tmp6Result2 = tmp6(guildBoostSlot(5210).PressableOpacity, obj5);
    }
...
function UnusedGuildBoostSlots(unusedSlots) {
  ...
  if (found1.length > 0) {
    ...
    obj4.children = closure_11(found(4636).Text, obj5);
    obj2.action = closure_11(found(5210).PressableOpacity, obj4);
...
function BoostedGuildInfo(guild) {
  ...
  if (null != guild) {
    ...
    const obj7 = { source: _modDef13614, style: tmp.guildInfoRowIcon };
...
function BoostedGuild(arg0) {
  ...
  items3[2] = closure_11(guildBoostSlots(13619), { guild: stateFromStores, theme: stateFromStores1 });
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      if (found.length > 0) {
        ...
        const items3 = [closure_11(tmp3(4636).Text, obj7), found.map((guildId) => closure_2_11(BoostedGuild, { guildId, guildBoostSlots: valueResult[guildId] }, guildId))];
        obj6.children = items3;
