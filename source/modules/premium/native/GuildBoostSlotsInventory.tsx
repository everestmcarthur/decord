...
// Dependencies: [19, 17, 1183, 1979, 4469, 4237, 1074, 21, 4574, 576, 5538, 7453, 4570, 1114, 11, 5137, 5448, 5598, 13529, 504, 1396, 13530, 13534, 4898, 4472, 12, 2]
// Exports: default

// Module 13528 (GuildBoostSlotsInventory)
...
const SubscriptionPlaceholderPattern = tmp2(13530);
require = fn;
...
function GuildBoostSlot(guildBoostSlot) {
  ...
  if (null == guildBoostSlot.guild) {
    ...
    if (!guildBoostSlot.isOnCooldown()) {
      ...
      obj5.children = tmp6(guildBoostSlot(4570).Text, obj6);
      tmp6Result2 = tmp6(guildBoostSlot(5137).PressableOpacity, obj5);
    }
...
function UnusedGuildBoostSlots(unusedSlots) {
  ...
  if (found1.length > 0) {
    ...
    obj4.children = closure_11(found(4570).Text, obj5);
    obj2.action = closure_11(found(5137).PressableOpacity, obj4);
...
function BoostedGuildInfo(guild) {
  ...
  if (null != guild) {
    ...
    const obj7 = { source: _modDef13529, style: tmp.guildInfoRowIcon };
...
function BoostedGuild(arg0) {
  ...
  items3[2] = closure_11(guildBoostSlots(13534), { guild: stateFromStores, theme: stateFromStores1 });
...
export default function GuildBoostSlotsInventory() {
  ...
  const effect = noop.useEffect(() => {
    ...
    const guildBoostSlots = valueResult(4472).fetchGuildBoostSlots();
  }, []);
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      if (found.length > 0) {
        ...
        const items3 = [closure_11(tmp3(4570).Text, obj7), found.map((guildId) => closure_2_11(BoostedGuild, { guildId, guildBoostSlots: valueResult[guildId] }, guildId))];
        obj6.children = items3;
