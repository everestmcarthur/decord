...
// Dependencies: [19, 11525, 1371, 21, 5676, 4810, 11535, 11548, 11549, 504, 11536, 7074, 2]
// Exports: default

// Module 11534 (GiftCodeRedeemModal)
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4810 */;
import GiftCodeRedeemStartDefault from "GiftCodeRedeemStart" /* 11535 */;
import useGiftCodeErrorMessageDefault from "useGiftCodeErrorMessage" /* 11536 */;
import GiftCodeRedeemSuccessDefault from "GiftCodeRedeemSuccess" /* 11548 */;
import GiftCodeRedeemErrorDefault from "GiftCodeRedeemError" /* 11549 */;
...
export default function GiftCodeRedeemModal(code) {
  ...
  if (null == stateFromStores1) {
    ...
    const obj4 = {
      headerTitle,
      headerLeft: tmp2(5676).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop()),
      render(arg0) {
          const obj = {};
    ...
    obj5.headerLeft = tmp2(5676).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop());
    ...
    const tmp2Result3 = tmp2(5676);
    obj6.headerLeft = tmp2(5676).getHeaderCloseButton(() => ModalActionCreatorsDefault.pop());
    ...
    if (null == stateFromStores) {
      ...
      jsx(tmp2(7074).Navigator, { screens: obj3, initialRouteStack: null });
    }
    const tmp2Result4 = tmp2(5676);
  }
};
