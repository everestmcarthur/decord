...
// Dependencies: [19, 17, 21, 4605, 576, 1484, 7175, 11526, 11527, 4601, 1114, 5025, 4808, 2]
// Exports: default

// Module 11525 (GiftCodeRedeemError)
...
export default function GiftCodeRedeemError(children) {
  ...
  if (theme.dark) {
    let tmp9Result = tmp9(11526);
  } else {
    tmp9Result = tmp9(11527);
  }
