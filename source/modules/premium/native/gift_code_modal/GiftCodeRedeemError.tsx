...
// Dependencies: [19, 17, 21, 4722, 576, 1485, 7319, 11706, 11707, 4718, 1115, 5144, 4925, 2]
// Exports: default

// Module 11705 (GiftCodeRedeemError)
...
export default function GiftCodeRedeemError(children) {
  ...
  if (theme.dark) {
    let tmp9Result = tmp9(11706);
  } else {
    tmp9Result = tmp9(11707);
  }
