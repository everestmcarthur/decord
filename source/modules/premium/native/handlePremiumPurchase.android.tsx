...
// Dependencies: [109, 5, 19, 9500, 502, 4303, 7344, 1074, 1085, 1271, 10837, 4540, 10838, 1115, 4319, 4983, 7347, 504, 7554, 10839, 10840, 10796, 10841, 7342, 4312, 9499, 1241, 2]
// Exports: useHandlePremiumPurchase

// Module 10836 (handlePremiumPurchase)
...
const setGPlayAnalytics = fn(9500).setGPlayAnalytics;
      ...
      if (1 === tmp10) {
        if (arg0 === 1) {
          ...
          closure_130_20 = (function getOfferId(arg0, arg1, arg2, arg3, offerIds) {
            ...
            if (null != offerIds) {
              if (null != arg2) {
                const tmp13 = premiumSubscription(7347).TrialIdToProductOfferId[arg2.trialId];
                let tmp14;
                if (tmp13 != null) {
                  tmp14 = tmp13[arg0];
                }
                ...
                const tmp9 = premiumSubscription(7347).DiscountIdToProductOfferId[arg3.discountId];
                let tmp10;
                if (tmp9 != null) {
                  tmp10 = tmp9[arg0];
                }
            ...
            if (arg1) {
              BOGO_OFFER_ID = null;
              if (arg0 === premiumSubscription(7347).ProductIds.PREMIUM_TIER_2_MONTHLY) {
                BOGO_OFFER_ID = tmp5(7347).BOGO_OFFER_ID;
              }
        ...
        (function showPurchaseErrorModal(combined) {
          ...
          if (!(combined instanceof premiumSubscription(4540).BillingError)) {
            billingError = new tmp(4540).BillingError(combined);
          }
          if (tmpResult.isSpendingLimitError(billingError)) {
            const result = tmp(10838).showSpendingLimitReachedAlert();
            const tmpResult2 = tmp(10838);
          } else {
            const intl = tmp(1115).intl;
            let tmp8 = billingError.code !== tmp(4319).ErrorCodes.UNKNOWN;
            if (tmp8) {
            ...
            obj.body = message;
            closure_1_1(4983).show(obj);
            const obj2 = closure_1_1(4983);
          }
        })(closure_130_23);
