...
// Dependencies: [1074, 7519, 4841, 7522, 1897, 7522, 7105, 2]
// Exports: launchPremiumPlanSelect

// Module 7521 (launchPremiumPlanSelect)
...
import PremiumModal from "PremiumModal" /* 7522 */;
...
export const launchPremiumPlanSelect = function launchPremiumPlanSelect(isBoostPurchaseFlow) {
  ...
  if (null != navigation) {
    ...
    const obj3 = flag2(4841);
    obj3.pushLazy(asyncRequireImpl(7522, dependencyMap.paths), obj4, PremiumModal.PREMIUM_KEY);
    const tmp7 = asyncRequireImpl(7522, dependencyMap.paths);
  }
