...
// Dependencies: [1074, 7423, 4777, 7426, 1896, 7426, 7009, 2]
// Exports: launchPremiumPlanSelect

// Module 7425 (launchPremiumPlanSelect)
...
import PremiumModal from "PremiumModal" /* 7426 */;
...
export const launchPremiumPlanSelect = function launchPremiumPlanSelect(isBoostPurchaseFlow) {
  ...
  if (null != navigation) {
    ...
    const obj3 = flag2(4777);
    obj3.pushLazy(asyncRequireImpl(7426, dependencyMap.paths), obj4, PremiumModal.PREMIUM_KEY);
    const tmp7 = asyncRequireImpl(7426, dependencyMap.paths);
  }
