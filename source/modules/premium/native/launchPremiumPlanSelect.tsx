...
// Dependencies: [1074, 7516, 4842, 7519, 1897, 7519, 7102, 2]
// Exports: launchPremiumPlanSelect

// Module 7518 (launchPremiumPlanSelect)
...
import PremiumModal from "PremiumModal" /* 7519 */;
...
export const launchPremiumPlanSelect = function launchPremiumPlanSelect(isBoostPurchaseFlow) {
  ...
  if (null != navigation) {
    ...
    const obj3 = flag2(4842);
    obj3.pushLazy(asyncRequireImpl(7519, dependencyMap.paths), obj4, PremiumModal.PREMIUM_KEY);
    const tmp7 = asyncRequireImpl(7519, dependencyMap.paths);
  }
