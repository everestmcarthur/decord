...
// Dependencies: [1074, 7482, 4809, 7485, 1896, 7485, 7068, 2]
// Exports: launchPremiumPlanSelect

// Module 7484 (launchPremiumPlanSelect)
...
import PremiumModal from "PremiumModal" /* 7485 */;
...
export const launchPremiumPlanSelect = function launchPremiumPlanSelect(isBoostPurchaseFlow) {
  ...
  if (null != navigation) {
    ...
    const obj3 = flag2(4809);
    obj3.pushLazy(asyncRequireImpl(7485, dependencyMap.paths), obj4, PremiumModal.PREMIUM_KEY);
    const tmp7 = asyncRequireImpl(7485, dependencyMap.paths);
  }
