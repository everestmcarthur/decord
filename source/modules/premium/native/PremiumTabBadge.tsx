...
// Dependencies: [32, 19, 17, 4303, 1374, 7539, 21, 4639, 576, 4356, 4491, 4574, 4635, 8897, 1249, 10875, 1177, 15082, 7554, 8168, 4297, 4460, 1944, 504, 7495, 8164, 8163, 13510, 1115, 5071, 1094, 1364, 2]
// Exports: default

// Module 15081 (PremiumTabBadge)
...
function OfferBadge(componentId) {
  ...
  if (acked) {
    ...
    const obj6 = { source: _modDef15082, size: tmp(1177).Icon.Sizes.EXTRA_SMALL, color: tmp4.icon.color, style: tmp4.icon };
    ...
    items[1] = React6(tmp(4635).Text, obj7);
    obj5.children = items;
...
export default function PremiumTabBadge() {
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const isEligibleSenderForReferralProgram = tmp(8164).useIsEligibleSenderForReferralProgram();
      const tmpResult11 = tmp(8164);
      const isReferralProgramEntrypointBadgeAcknowledged = tmp(8163).useIsReferralProgramEntrypointBadgeAcknowledged();
      const tmpResult12 = tmp(8163);
      const promotionMarketingComponent = tmp(13510).usePromotionMarketingComponent(tmp(10875).MarketingComponentType.PREMIUM_TAB);
      const tmpResult14 = tmp(7495);
      let prop = null;
      ...
      if (tmp7) {
        ...
        obj8.children = React6(tmp(4635).Text, obj9);
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          obj11.style = items4;
          const obj12 = { source: _modDef15082, size: tmp(1177).Icon.Sizes.EXTRA_SMALL, color: intl.icon.color, style: intl.icon };
          ...
          items5[1] = React6(tmp(4635).Text, obj13);
          ...
          obj14.children = React6(tmp(4635).Text, obj15);
        ...
        if (null != stringResult) {
          ...
          obj16.children = React6(tmp(4635).Text, obj17);
