...
// Dependencies: [32, 19, 17, 4303, 1374, 7546, 21, 4640, 576, 4356, 4491, 4574, 4636, 8924, 1249, 10891, 1177, 15106, 7561, 8197, 4297, 4460, 1944, 504, 7502, 8193, 8192, 13529, 1115, 5074, 1094, 1364, 2]
// Exports: default
...
function OfferBadge(componentId) {
  ...
  if (acked) {
    ...
    const obj6 = { source: _modDef15106, size: tmp(1177).Icon.Sizes.EXTRA_SMALL, color: tmp4.icon.color, style: tmp4.icon };
    ...
    items[1] = React6(tmp(4636).Text, obj7);
    obj5.children = items;
...
export default function PremiumTabBadge() {
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const isEligibleSenderForReferralProgram = tmp(8193).useIsEligibleSenderForReferralProgram();
      const tmpResult11 = tmp(8193);
      const isReferralProgramEntrypointBadgeAcknowledged = tmp(8192).useIsReferralProgramEntrypointBadgeAcknowledged();
      const tmpResult12 = tmp(8192);
      const promotionMarketingComponent = tmp(13529).usePromotionMarketingComponent(tmp(10891).MarketingComponentType.PREMIUM_TAB);
      const tmpResult14 = tmp(7502);
      let prop = null;
      ...
      if (tmp7) {
        ...
        obj8.children = React6(tmp(4636).Text, obj9);
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          obj11.style = items4;
          const obj12 = { source: _modDef15106, size: tmp(1177).Icon.Sizes.EXTRA_SMALL, color: intl.icon.color, style: intl.icon };
          ...
          items5[1] = React6(tmp(4636).Text, obj13);
          ...
          obj14.children = React6(tmp(4636).Text, obj15);
        ...
        if (null != stringResult) {
          ...
          obj16.children = React6(tmp(4636).Text, obj17);
