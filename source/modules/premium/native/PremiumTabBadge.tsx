...
// Dependencies: [32, 19, 17, 4301, 1374, 7542, 21, 4638, 576, 4354, 4489, 4572, 4634, 8908, 1249, 10883, 1177, 15098, 7557, 8177, 4295, 4458, 1944, 504, 7498, 8173, 8172, 13521, 1115, 5072, 1094, 1364, 2]
// Exports: default
...
function OfferBadge(componentId) {
  ...
  if (acked) {
    ...
    const obj6 = { source: _modDef15098, size: tmp(1177).Icon.Sizes.EXTRA_SMALL, color: tmp4.icon.color, style: tmp4.icon };
    ...
    items[1] = React6(tmp(4634).Text, obj7);
    obj5.children = items;
...
export default function PremiumTabBadge() {
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const isEligibleSenderForReferralProgram = tmp(8173).useIsEligibleSenderForReferralProgram();
      const tmpResult11 = tmp(8173);
      const isReferralProgramEntrypointBadgeAcknowledged = tmp(8172).useIsReferralProgramEntrypointBadgeAcknowledged();
      const tmpResult12 = tmp(8172);
      const promotionMarketingComponent = tmp(13521).usePromotionMarketingComponent(tmp(10883).MarketingComponentType.PREMIUM_TAB);
      const tmpResult14 = tmp(7498);
      let prop = null;
      ...
      if (tmp7) {
        ...
        obj8.children = React6(tmp(4634).Text, obj9);
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          obj11.style = items4;
          const obj12 = { source: _modDef15098, size: tmp(1177).Icon.Sizes.EXTRA_SMALL, color: intl.icon.color, style: intl.icon };
          ...
          items5[1] = React6(tmp(4634).Text, obj13);
          ...
          obj14.children = React6(tmp(4634).Text, obj15);
        ...
        if (null != stringResult) {
          ...
          obj16.children = React6(tmp(4634).Text, obj17);
