...
// Dependencies: [17, 4311, 21, 4640, 576, 7264, 6721, 4636, 1115, 3077, 2]
// Exports: default

// Module 13628 (PremiumGroupEducationActionSheet)
...
export default function PremiumGroupEducationActionSheet(children) {
  ...
  obj6.children = intl.format(_modDef3077.ah1Ecm, { helpCenterLink: HELP_CENTER_LINK });
