...
// Dependencies: [17, 4278, 21, 4607, 576, 4574, 13571, 1896, 1114, 3074, 4603, 2]
// Exports: default

// Module 13570 (BoostingUnavailablePill)
...
function handlePress() {
  ...
  const tmp = asyncRequireImpl(13571, dependencyMap.paths);
