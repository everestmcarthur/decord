...
// Dependencies: [17, 7542, 21, 4638, 576, 4634, 1115, 13590, 1177, 5072, 4487, 9524, 2]
// Exports: default

// Module 13589 (PremiumGroupFeaturesTableCard)
...
import ColorConstants from "ColorConstants" /* 7542 */;
import usePremiumGroupFeaturesTableCardTextDefault from "usePremiumGroupFeaturesTableCardText" /* 13590 */;
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  if (null == tmp4) {
    ...
    const items1 = [hasOwnProperty(tmp2(9524), { width: 181, height: 16 }), hasOwnProperty(BetaPill, {})];
