...
// Dependencies: [17, 7539, 21, 4639, 576, 4635, 1115, 13578, 1177, 5071, 4489, 9513, 2]
// Exports: default

// Module 13577 (PremiumGroupFeaturesTableCard)
...
import ColorConstants from "ColorConstants" /* 7539 */;
import usePremiumGroupFeaturesTableCardTextDefault from "usePremiumGroupFeaturesTableCardText" /* 13578 */;
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  if (null == tmp4) {
    ...
    const items1 = [hasOwnProperty(tmp2(9513), { width: 181, height: 16 }), hasOwnProperty(BetaPill, {})];
