...
// Dependencies: [10794, 1373, 1074, 10801, 13513, 7525, 7343, 13514, 7485, 2]
    ...
    return () => {
      ...
      let obj = {
        ...
        onPaymentDismiss(arg0) {
          ...
          if (isSuccess) {
            const result = tmp3(13514).showMarketingMomentRewardScreen(length[0]);
            const tmp3Result = tmp3(13514);
          }
        }
      };
