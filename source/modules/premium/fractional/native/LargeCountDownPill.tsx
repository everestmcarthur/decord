...
// Dependencies: [17, 21, 4606, 576, 4305, 1114, 4561, 4602, 2]
// Exports: default

// Module 13511 (LargeCountDownPill)
  ...
  const obj = {
    onPress() {
      ...
      obj2.icon = function icon() {
        return closure_2_5(closure_0(4561).CircleInformationIcon, { style: closure_1_0.iconStyle, color: nativeDefault.colors.STATUS_WARNING });
      };
