...
// Dependencies: [19, 17, 1074, 1955, 21, 4640, 576, 5079, 7496, 10377, 5780, 1115, 2497, 5062, 2]
// Exports: default

// Module 17197 (NitroFileUploadUpsellPromoSheet)
...
export default function NitroFileUploadUpsellPromoSheet(markAsDismissed) {
  ...
  obj2.title = intl.string(require("module_2497")["Uty2/X"]);
  const intl2 = markAsDismissed(callback[11]).intl;
  obj2.description = intl2.string(require("module_2497").VAgI8Q);
  ...
  obj4.text = intl3.string(require("module_2497").mRy6sO);
