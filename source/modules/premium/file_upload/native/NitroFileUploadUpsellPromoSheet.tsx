...
// Dependencies: [19, 17, 1074, 1954, 21, 4636, 576, 5073, 7485, 10358, 5773, 1114, 2496, 5056, 2]
// Exports: default

// Module 17061 (NitroFileUploadUpsellPromoSheet)
...
export default function NitroFileUploadUpsellPromoSheet(markAsDismissed) {
  ...
  obj2.title = intl.string(require("module_2496")["Uty2/X"]);
  const intl2 = markAsDismissed(callback[11]).intl;
  obj2.description = intl2.string(require("module_2496").VAgI8Q);
  ...
  obj4.text = intl3.string(require("module_2496").mRy6sO);
