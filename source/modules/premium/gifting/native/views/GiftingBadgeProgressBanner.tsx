...
// Dependencies: [19, 17, 21, 4638, 576, 7272, 8908, 1249, 10893, 4634, 1115, 2493, 2]
// Exports: default

// Module 10902 (GiftingBadgeProgressBanner)
...
export default function GiftingBadgeProgressBanner(arg0) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp2(10893), obj4);
  }
  obj3.children = tmp10Result;
  const items2 = [React4(View, obj3), ];
  const obj5 = { variant: "text-md/semibold", children: null };
  const intl = tmp6(1115).intl;
  obj5.children = intl.formatToPlainString(_modDef2493["0+xfd9"], { giftsRemaining: giftsToNextTier, nextTier: nextTierName });
