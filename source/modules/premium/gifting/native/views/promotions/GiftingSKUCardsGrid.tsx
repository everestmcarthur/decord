...
// Dependencies: [19, 17, 7620, 1887, 21, 4606, 576, 8263, 4325, 11137, 5174, 8916, 8902, 8887, 4602, 1114, 2]
// Exports: default

// Module 11136 (GiftingSKUCardsGrid)
...
let closure_10 = noop.memo((rewardSkuId) => {
  ...
  if (null == product) {
    ...
    if (claimed) {
      ...
      obj8.children = tmp7(tmp2(8887).CheckmarkLargeBoldIcon, obj9);
    ...
    const items4 = [React5(tmp2(4602).Text, obj11), ];
    ...
    items4[1] = React5(tmp2(4602).Text, obj12);
    obj10.children = items4;
    items3[2] = React6(View, obj10);
    obj4.children = items3;
    return React6(tmp2(5174).PressableOpacity, obj4);
  }
});
