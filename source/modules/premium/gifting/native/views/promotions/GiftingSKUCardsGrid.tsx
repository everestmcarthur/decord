...
// Dependencies: [19, 17, 7661, 1888, 21, 4640, 576, 8326, 4358, 11203, 5210, 8981, 8967, 8952, 4636, 1115, 2]
// Exports: default

// Module 11202 (GiftingSKUCardsGrid)
...
let closure_10 = noop.memo((rewardSkuId) => {
  ...
  if (null == product) {
    ...
    if (claimed) {
      ...
      obj8.children = tmp7(tmp2(8952).CheckmarkLargeBoldIcon, obj9);
    ...
    const items4 = [React5(tmp2(4636).Text, obj11), ];
    ...
    items4[1] = React5(tmp2(4636).Text, obj12);
    obj10.children = items4;
    items3[2] = React6(View, obj10);
    obj4.children = items3;
    return React6(tmp2(5210).PressableOpacity, obj4);
  }
});
