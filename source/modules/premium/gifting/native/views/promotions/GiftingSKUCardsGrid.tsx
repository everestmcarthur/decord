...
let closure_10 = noop.memo((rewardSkuId) => {
  ...
  if (null == product) {
    ...
    if (claimed) {
      ...
      obj8.children = tmp7(tmp2(8922).CheckmarkLargeBoldIcon, obj9);
    ...
    const items4 = [React5(tmp2(4632).Text, obj11), ];
    ...
    items4[1] = React5(tmp2(4632).Text, obj12);
    obj10.children = items4;
    items3[2] = React6(View, obj10);
    obj4.children = items3;
    return React6(tmp2(5204).PressableOpacity, obj4);
  }
});
