...
// Dependencies: [19, 17, 4632, 10814, 1074, 1955, 21, 4640, 576, 504, 10905, 10906, 8421, 4607, 7276, 7296, 10810, 7264, 1364, 8965, 5675, 10909, 4636, 5062, 11191, 1115, 2]
// Exports: default

// Module 17177 (GiftingPromotionCoachmark)
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const themeAndReducedMotionAwareAssetUrl = markAsDismissed(10905).useThemeAndReducedMotionAwareAssetUrl(asset);
  let obj2 = markAsDismissed(10905);
  ...
  const tickingFormattedLimitedOfferTimeLeft = markAsDismissed(10906).useTickingFormattedLimitedOfferTimeLeft(endDate);
  importDefault = tmp10;
  ...
  const tmp2Result3 = markAsDismissed(10906);
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp19Result) {
        ...
        tmp19Result = tmp19(tmp11(10909), obj5);
      }
      ...
      obj9.icon = tmp19(tmp2(11191).GiftIcon, obj10);
      const intl = tmp2(1115).intl;
      obj9.text = intl.string(tmp2(1115).t.Ve9Ge6);
      obj9.onPress = tmp17;
      items4[3] = tmp19(tmp2(5062).Button, obj9);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj11.children = tmp19(tmp2(8965).APNGPlayer, obj12);
      ...
      tmp19Result4 = tmp19(tmp11(5675), obj13);
