...
// Dependencies: [19, 17, 4597, 10735, 1074, 1954, 21, 4605, 576, 1115, 504, 10823, 17025, 8337, 4572, 7214, 7234, 10731, 7202, 8879, 5637, 4601, 5025, 11102, 1114, 2]
// Exports: default

// Module 17024 (GiftingPromotionCoachmark)
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const themeAndReducedMotionAwareAssetUrl = markAsDismissed(10823).useThemeAndReducedMotionAwareAssetUrl(asset);
  let obj2 = markAsDismissed(10823);
  ...
  const str = markAsDismissed(17025).useTickingFormattedLimitedOfferTimeLeft(endDate);
  importDefault = tmp9;
  ...
  const tmp2Result3 = markAsDismissed(17025);
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp18Result) {
        ...
        obj5.children = tmp18(tmp2(4601).Text, obj6);
      ...
      obj10.icon = tmp18(tmp2(11102).GiftIcon, obj11);
      const intl = tmp2(1114).intl;
      obj10.text = intl.string(tmp2(1114).t.Ve9Ge6);
      obj10.onPress = tmp16;
      items4[3] = tmp18(tmp2(5025).Button, obj10);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj12.children = tmp18(tmp2(8879).APNGPlayer, obj13);
      ...
      tmp18Result4 = tmp18(tmp10(5637), obj14);
