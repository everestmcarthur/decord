...
// Dependencies: [19, 17, 4599, 10756, 1074, 1954, 21, 4607, 576, 1115, 504, 10844, 17014, 8360, 4574, 7236, 7256, 10752, 7224, 8902, 5639, 4603, 5027, 11127, 1114, 2]
// Exports: default

// Module 17013 (GiftingPromotionCoachmark)
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const themeAndReducedMotionAwareAssetUrl = markAsDismissed(10844).useThemeAndReducedMotionAwareAssetUrl(asset);
  let obj2 = markAsDismissed(10844);
  ...
  const str = markAsDismissed(17014).useTickingFormattedLimitedOfferTimeLeft(endDate);
  importDefault = tmp9;
  ...
  const tmp2Result3 = markAsDismissed(17014);
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp18Result) {
        ...
        obj5.children = tmp18(tmp2(4603).Text, obj6);
      ...
      obj10.icon = tmp18(tmp2(11127).GiftIcon, obj11);
      const intl = tmp2(1114).intl;
      obj10.text = intl.string(tmp2(1114).t.Ve9Ge6);
      obj10.onPress = tmp16;
      items4[3] = tmp18(tmp2(5027).Button, obj10);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj12.children = tmp18(tmp2(8902).APNGPlayer, obj13);
      ...
      tmp18Result4 = tmp18(tmp10(5639), obj14);
