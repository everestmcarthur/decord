...
// Dependencies: [19, 17, 4566, 10697, 1074, 1954, 21, 4574, 576, 1115, 504, 10785, 16968, 8300, 4541, 7176, 7196, 10693, 7164, 8842, 5601, 4570, 4989, 11062, 1114, 2]
// Exports: default

// Module 16967 (GiftingPromotionCoachmark)
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const themeAndReducedMotionAwareAssetUrl = markAsDismissed(10785).useThemeAndReducedMotionAwareAssetUrl(asset);
  let obj2 = markAsDismissed(10785);
  ...
  const str = markAsDismissed(16968).useTickingFormattedLimitedOfferTimeLeft(endDate);
  importDefault = tmp9;
  ...
  const tmp2Result3 = markAsDismissed(16968);
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp18Result) {
        ...
        obj5.children = tmp18(tmp2(4570).Text, obj6);
      ...
      obj10.icon = tmp18(tmp2(11062).GiftIcon, obj11);
      const intl = tmp2(1114).intl;
      obj10.text = intl.string(tmp2(1114).t.Ve9Ge6);
      obj10.onPress = tmp16;
      items4[3] = tmp18(tmp2(4989).Button, obj10);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj12.children = tmp18(tmp2(8842).APNGPlayer, obj13);
      ...
      tmp18Result4 = tmp18(tmp10(5601), obj14);
