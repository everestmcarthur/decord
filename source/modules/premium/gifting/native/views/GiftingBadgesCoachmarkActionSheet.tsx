...
// Dependencies: [19, 17, 8321, 1955, 21, 4638, 576, 10888, 4605, 4496, 7260, 10893, 4634, 1115, 2493, 5060, 10802, 7292, 17148, 11183, 504, 8313, 2]
// Exports: default

// Module 17147 (GiftingBadgesCoachmarkActionSheet)
...
function HasBadgeCoachmark(markAsDismissed) {
  ...
  const isGiftingBadgeComplexArtEnabled = markAsDismissed(10888).useIsGiftingBadgeComplexArtEnabled("GiftingBadgesCoachmarkActionSheet");
  let obj = markAsDismissed(10888);
  const giftingBadgeTierIconUrl = markAsDismissed(10888).getGiftingBadgeTierIconUrl(currentTier, isGiftingBadgeComplexArtEnabled);
  ...
  const items3 = [closure_8(markAsDismissed(4634).Text, obj8), ];
  ...
  items3[1] = closure_8(markAsDismissed(4634).Text, obj9);
  ...
  obj10.children = closure_8(markAsDismissed(5060).Button, obj11);
  items2[2] = closure_8(closure_5, obj10);
  obj4.children = items2;
  obj3.children = closure_9(closure_5, obj4);
  return closure_8(markAsDismissed(7260).BottomSheet, obj3);
}
function NewBadgeCoachmark(markAsDismissed) {
  ...
  const obj4 = { source: { uri: _modDef17148 }, style: tmp.newBadgeImage };
  ...
  const items3 = [closure_8(markAsDismissed(4634).Text, obj7), ];
  ...
  items3[1] = closure_8(markAsDismissed(4634).Text, obj8);
  ...
  const obj5 = { uri: _modDef17148 };
  obj10.icon = closure_8(markAsDismissed(11183).GiftIcon, { size: "sm", color: nativeDefault.colors.CONTROL_PRIMARY_TEXT_DEFAULT });
  obj10.onPress = callback;
  obj9.children = closure_8(markAsDismissed(5060).Button, obj10);
  items2[2] = closure_8(closure_5, obj9);
  obj2.children = items2;
  obj.children = closure_9(closure_5, obj2);
  return closure_8(markAsDismissed(7260).BottomSheet, obj);
}
