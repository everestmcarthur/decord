...
// Dependencies: [5, 8283, 7650, 7646, 1374, 1074, 1364, 573, 1241, 1271, 8284, 1231, 4542, 1944, 1941, 2]
// Exports: acknowledgeUserOffer, fetchChurnDiscountOffer, fetchExistingChurnDiscountOffer, fetchUserOffer, triggerUserOffer

// Module 8282 (UserOfferActionCreators)
      ...
      if (0 === c12) {
        if (arg0 === 1) {
          ...
          if (closure_2 === undefined) {
            obj8 = { offerId: "PX_16", paymentGatewayOverride: "accessible" };
          }
          closure_136_2 = obj8;
