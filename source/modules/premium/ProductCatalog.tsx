...
// Function ID: 14007
// Name: ProductCatalog
// Dependencies: [1373, 3, 14007, 7867, 9391, 14008, 1379, 14009, 1377, 2]
// Exports: canUserUse

// Module 14006 (ProductCatalog)
import LoggerDefault from "Logger" /* 3 */;
import user from "user" /* 1379 */;
import EntitlementFeatureNames from "EntitlementFeatureNames" /* 7867 */;
import PremiumFeatureUtils from "PremiumFeatureUtils" /* 9391 */;
import SKUListingDefault from "SKUListing" /* 14008 */;
import DenormalizedPerksReadExperimentDefault from "DenormalizedPerksReadExperiment" /* 14009 */;
import PremiumConstants from "PremiumConstants" /* 1373 */;
import PremiumSKUFeature_mod from "PremiumSKUFeature" /* 14007 */;
...
export const canUserUse = function canUserUse(COLLECTIBLES, isPremiumWithFractionalPremiumOnly, arg2) {
  ...
  if (null != value) {
    ...
    if (null != perks) {
      ...
      if (config !== closure_0(14009).DenormalizedPerksReadConfig.CONTROL) {
        ...
        if (config === tmp9(14009).DenormalizedPerksReadConfig.DUAL_READ_RETURN_NEW) {
