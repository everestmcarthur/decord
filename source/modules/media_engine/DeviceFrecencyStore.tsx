...
// Dependencies: [1909, 1372, 4665, 4669, 4677, 504, 12, 573, 2]

// Module 4668 (DeviceFrecencyStore)
...
let obj2 = {};
const stopWatch = new fn(4669).StopWatch();
obj2[DeviceTypes.AUDIO_INPUT] = stopWatch;
const stopWatch1 = new fn(4669).StopWatch();
obj2[DeviceTypes.AUDIO_OUTPUT] = stopWatch1;
const stopWatch2 = new fn(4669).StopWatch();
