...
// Dependencies: [5, 1074, 1272, 573, 4462, 2]
...
// Module 9543 (_getApplicationSubscriptionGroupListingsForApplication)
...
export const fetchApplication = function fetchApplication(applicationId, signal) {
  ...
  obj = { url: Endpoints.APPLICATION_PUBLIC(applicationId), signal, rejectWithError: _require(1272).rejectWithMigratedError() };
