...
// Dependencies: [19, 17, 9196, 1074, 21, 4639, 576, 17713, 17753, 5368, 1397, 4491, 5772, 5690, 7307, 1115, 9195, 4984, 5078, 4341, 1484, 504, 4574, 5709, 7484, 7489, 2025, 8719, 5057, 4635, 7147, 2]
// Exports: default

// Module 17752 (GuildSettingsModalIntegrationPlatform)
...
import GuildSettingsModalIntegrations from "GuildSettingsModalIntegrations" /* 17713 */;
...
IntegrationItem.prototype["render"] = function render() {
  ...
  if (SUPPORTED_SETTINGS_INTEGRATION_PLATFORMS.includes(integration.type)) {
    ...
    if (tmp(17753).IntegrationTypes.YOUTUBE === type) {
      ...
      let combined = name;
    } else if (tmp(17753).IntegrationTypes.TWITCH === type) {
    ...
    if (null == value) {
      ...
      const items = [closure_1_11(tmp(5690).TableRow, obj2), ];
      ...
      items[1] = closure_1_11(tmp(7307).TableSwitchRow, obj5);
      obj4.children = items;
      return closure_1_12(tmp(5772).TableRowGroup, obj4);
    } else {
