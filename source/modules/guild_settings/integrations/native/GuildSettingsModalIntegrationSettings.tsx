...
// Dependencies: [19, 17, 2016, 9218, 21, 17846, 1115, 4640, 576, 5776, 5210, 5693, 17847, 5775, 7314, 4350, 4636, 5371, 1397, 4491, 8748, 5060, 4231, 5773, 17848, 7154, 9217, 504, 4574, 17810, 2]
// Exports: default

// Module 17845 (GuildSettingsModalIntegrationSettings)
...
function ForceSyncIcon(isSyncing) {
  if (isSyncing.isSyncing) {
    ...
    obj.onPress = tmp;
    const obj2 = { source: _modDef17847 };
...
GuildSettingsModalIntegrationSettings.prototype["render"] = function render() {
  ...
  if (null != tmp) {
    ...
    obj.trailing = closure_7(integration(4636).Text, obj2);
    const tmp2 = closure_7(integration(5693).TableRow, obj);
  }
  ...
  value = self(5371).get(integration.type);
  if (null == value) {
    const _Object = Object;
    const values = Object.values(tmp12(17846).IntegrationExpireGracePeriodTypes);
    ...
    obj7.children = closure_7(tmp15(5693).TableRow, obj8);
    const items1 = [closure_7(tmp15(5775).TableRowGroup, obj7), , , , ];
    ...
    const items2 = [closure_7(tmp15(5693).TableRow, obj10), tmp2];
    obj9.children = items2;
    items1[1] = closure_8(tmp15(5775).TableRowGroup, obj9);
    ...
    const obj17 = { value: tmp15(17848).IntegrationExpireBehaviorTypes.REMOVE_ROLE, label: null };
    const intl6 = tmp15(1115).intl;
    obj17.label = intl6.string(tmp15(1115).t["6kpw4i"]);
    const items3 = [closure_7(tmp15(5776).TableRadioRow, obj17), ];
    const obj18 = { value: tmp15(17848).IntegrationExpireBehaviorTypes.KICK, label: null };
    const intl7 = tmp15(1115).intl;
    obj18.label = intl7.string(tmp15(1115).t.fQUQIJ);
    items3[1] = closure_7(tmp15(5776).TableRadioRow, obj18);
    obj16.children = items3;
    items1[2] = closure_8(tmp15(5773).TableRadioGroup, obj16);
    ...
    items1[3] = closure_7(tmp15(5775).TableRowGroup, obj19);
    items1[4] = tmp13;
    obj6.children = items1;
    obj5.children = closure_8(tmp15(5060).Stack, obj6);
    const items4 = [closure_7(tmp15(8748).Form, obj5), closure_7(tmp15(7154).NavScrim, {})];
