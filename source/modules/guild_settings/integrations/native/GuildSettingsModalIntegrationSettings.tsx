...
// Dependencies: [19, 17, 2015, 9156, 21, 17681, 1114, 4607, 576, 5740, 5175, 5657, 17682, 5739, 7274, 4317, 4603, 5335, 1396, 4458, 8686, 5025, 4198, 5737, 17683, 7114, 9155, 504, 4542, 17645, 2]
// Exports: default

// Module 17680 (GuildSettingsModalIntegrationSettings)
...
import _modDef17682 from "module_17682" /* 17682 */;
...
function ForceSyncIcon(isSyncing) {
  if (isSyncing.isSyncing) {
    ...
    obj.onPress = tmp;
    const obj2 = { source: _modDef17682 };
...
GuildSettingsModalIntegrationSettings.prototype["render"] = function render() {
  ...
  if (null != tmp) {
    ...
    obj.trailing = closure_7(integration(4603).Text, obj2);
    const tmp2 = closure_7(integration(5657).TableRow, obj);
  }
  ...
  value = self(5335).get(integration.type);
  if (null == value) {
    const _Object = Object;
    const values = Object.values(tmp12(17681).IntegrationExpireGracePeriodTypes);
    ...
    obj7.children = closure_7(tmp15(5657).TableRow, obj8);
    const items1 = [closure_7(tmp15(5739).TableRowGroup, obj7), , , , ];
    ...
    const items2 = [closure_7(tmp15(5657).TableRow, obj10), tmp2];
    obj9.children = items2;
    items1[1] = closure_8(tmp15(5739).TableRowGroup, obj9);
    ...
    const obj17 = { value: tmp15(17683).IntegrationExpireBehaviorTypes.REMOVE_ROLE, label: null };
    const intl6 = tmp15(1114).intl;
    obj17.label = intl6.string(tmp15(1114).t["6kpw4i"]);
    const items3 = [closure_7(tmp15(5740).TableRadioRow, obj17), ];
    const obj18 = { value: tmp15(17683).IntegrationExpireBehaviorTypes.KICK, label: null };
    const intl7 = tmp15(1114).intl;
    obj18.label = intl7.string(tmp15(1114).t.fQUQIJ);
    items3[1] = closure_7(tmp15(5740).TableRadioRow, obj18);
    obj16.children = items3;
    items1[2] = closure_8(tmp15(5737).TableRadioGroup, obj16);
    ...
    items1[3] = closure_7(tmp15(5739).TableRowGroup, obj19);
    items1[4] = tmp13;
    obj6.children = items1;
    obj5.children = closure_8(tmp15(5025).Stack, obj6);
    const items4 = [closure_7(tmp15(8686).Form, obj5), closure_7(tmp15(7114).NavScrim, {})];
