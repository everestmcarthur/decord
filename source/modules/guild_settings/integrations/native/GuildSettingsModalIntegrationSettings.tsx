...
// Dependencies: [19, 17, 2016, 9207, 21, 17805, 1115, 4638, 576, 5774, 5208, 5691, 17806, 5773, 7310, 4348, 4634, 5369, 1397, 4489, 8728, 5058, 4229, 5771, 17807, 7150, 9206, 504, 4572, 17769, 2]
// Exports: default

// Module 17804 (GuildSettingsModalIntegrationSettings)
...
import _modDef17806 from "module_17806" /* 17806 */;
...
function ForceSyncIcon(isSyncing) {
  if (isSyncing.isSyncing) {
    ...
    obj.onPress = tmp;
    const obj2 = { source: _modDef17806 };
...
GuildSettingsModalIntegrationSettings.prototype["render"] = function render() {
  ...
  if (null != tmp) {
    ...
    obj.trailing = closure_7(integration(4634).Text, obj2);
    const tmp2 = closure_7(integration(5691).TableRow, obj);
  }
  ...
  value = self(5369).get(integration.type);
  if (null == value) {
    const _Object = Object;
    const values = Object.values(tmp12(17805).IntegrationExpireGracePeriodTypes);
    ...
    obj7.children = closure_7(tmp15(5691).TableRow, obj8);
    const items1 = [closure_7(tmp15(5773).TableRowGroup, obj7), , , , ];
    ...
    const obj12 = { datetime: tmp16(4229)(integration.synced_at).calendar() };
    ...
    const items2 = [closure_7(tmp15(5691).TableRow, obj10), tmp2];
    obj9.children = items2;
    items1[1] = closure_8(tmp15(5773).TableRowGroup, obj9);
    ...
    const obj17 = { value: tmp15(17807).IntegrationExpireBehaviorTypes.REMOVE_ROLE, label: null };
    const intl6 = tmp15(1115).intl;
    obj17.label = intl6.string(tmp15(1115).t["6kpw4i"]);
    const items3 = [closure_7(tmp15(5774).TableRadioRow, obj17), ];
    const obj18 = { value: tmp15(17807).IntegrationExpireBehaviorTypes.KICK, label: null };
    const intl7 = tmp15(1115).intl;
    obj18.label = intl7.string(tmp15(1115).t.fQUQIJ);
    items3[1] = closure_7(tmp15(5774).TableRadioRow, obj18);
    obj16.children = items3;
    items1[2] = closure_8(tmp15(5771).TableRadioGroup, obj16);
    ...
    items1[3] = closure_7(tmp15(5773).TableRowGroup, obj19);
    items1[4] = tmp13;
    obj6.children = items1;
    obj5.children = closure_8(tmp15(5058).Stack, obj6);
    const items4 = [closure_7(tmp15(8728).Form, obj5), closure_7(tmp15(7150).NavScrim, {})];
    ...
    const tmp15Result2 = tmp15(4489);
    const icon = { source: null, style: null };
    icon.source = tmp15Result.makeSource(tmp15(4489).isThemeDark(props.theme) ? icon.darkPNG : icon.lightPNG);
    icon.style = iter.integrationIcon;
    tmp18(tmp19, icon);
    const tmp20 = tmp15(4489).isThemeDark(props.theme) ? icon.darkPNG : icon.lightPNG;
  }
};
GuildSettingsModalIntegrationSettings.contextType = fn(4348).ThemeContext;
const size = fn(2);
