...
// Dependencies: [19, 17, 17798, 1980, 9196, 1074, 21, 4639, 576, 5709, 7484, 1115, 17799, 7864, 4635, 17676, 6711, 17800, 1484, 504, 7147, 2]
// Exports: default
...
prototype["render"] = function render() {
  ...
  if (isEditing) {
    ...
    if (tmp17Result) {
      ...
      tmp17Result = tmp17(tmp18(4635).Text, obj11);
    }
