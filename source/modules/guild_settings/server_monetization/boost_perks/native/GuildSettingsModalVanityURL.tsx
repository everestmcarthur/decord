...
// Dependencies: [19, 17, 17729, 1979, 9154, 1074, 21, 4606, 576, 5675, 7450, 1114, 17730, 7831, 4602, 17607, 6677, 17731, 1483, 504, 7113, 2]
// Exports: default

// Module 17728 (GuildSettingsModalVanityURL)
...
import GuildSettingsVanityURLUtils from "GuildSettingsVanityURLUtils" /* 17607 */;
import ChangeVanityURLActionCreatorsDefault from "ChangeVanityURLActionCreators" /* 17730 */;
import _modDef17731 from "module_17731" /* 17731 */;
import noop from "module_19" /* 19 */;
import ChangeVanityURLModalStore from "ChangeVanityURLModalStore" /* 17729 */;
...
prototype["updateNavigator"] = function updateNavigator(submitting, isEditing) {
  ...
  if (!tmp) {
    if (submitting) {
      ...
      fn = self(5675).getHeaderConditionalBackButton(this.handleCancel);
      let obj = self(5675);
    }
...
prototype["render"] = function render() {
  ...
  if (isEditing) {
    ...
    if (tmp17Result) {
      ...
      tmp17Result = tmp17(tmp18(4602).Text, obj11);
    }
    ...
    const obj13 = { source: _modDef17731, style: styles.image, resizeMode: "contain" };
...
export default function ConnectedGuildSettingsModalVanityURL(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const items3 = [closure_9(GuildSettingsModalVanityURL, obj6), closure_9(tmp2(7113).NavScrim, {})];
