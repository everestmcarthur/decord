...
// Dependencies: [4607, 17834, 1897, 2]
// Exports: showGuildSettingsModalStickerInfoActionSheet

// Module 17833 (showGuildSettingsModalStickerInfoActionSheet)
...
export const showGuildSettingsModalStickerInfoActionSheet = function showGuildSettingsModalStickerInfoActionSheet(arg0) {
  ...
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(17834, dependencyMap.paths), GuildSettingsModalStickerInfoActionSheet, {
    guildId,
    stickerId,
    hideActionSheet() {
