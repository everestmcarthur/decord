...
// Dependencies: [5, 32, 19, 17, 5547, 5590, 1074, 1375, 1939, 21, 4640, 576, 7095, 11307, 5686, 4292, 5225, 17830, 10536, 4979, 4636, 1115, 4536, 2025, 5062, 5060, 5210, 10322, 17831, 11282, 7244, 1397, 8913, 6717, 7199, 2]

// Module 17829 (GuildSettingsStickerCreate)
...
import useSafeAreaAvoidingInputsDefault from "useSafeAreaAvoidingInputs" /* 11307 */;
...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    items2[2] = onPressEmoji(stickerId(4636).Text, obj10);
    ...
    obj12.variant = str;
    items2[3] = tmp27(stickerId(5062).Button, obj12);
  ...
  const items4 = [onPressEmoji(stickerId(4636).Text, obj15), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    let tmp32Result = tmp32(tmp14(10322), obj17);
    const tmp14Result4 = tmp14(10322);
  } else if (null != uri) {
    ...
    tmp32Result = tmp32(tmp31(17831).StickerPlusIcon, { size: "lg" });
  }
  obj16.children = tmp32Result;
  items4[1] = onPressEmoji(stickerId(5210).PressableHighlight, obj16);
  ...
  items4[2] = onPressEmoji(stickerId(4636).Text, obj20);
  const obj21 = {
  ...
  if (null != first1) {
    ...
    obj22.src = emojiURL;
    let tmp32Result2 = tmp32(tmp14(7244), obj22);
    const tmp14Result5 = tmp14(7244);
  } else {
    tmp32Result2 = tmp32(tmp31(8913).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4636).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj21.children = items5;
  items4[3] = closure_17(stickerId(5210).PressableHighlight, obj21);
  ...
  items4[4] = onPressEmoji(stickerId(6717).TextInput, obj24);
  ...
  items4[5] = onPressEmoji(stickerId(7199).TextArea, obj26);
  const obj27 = {
  ...
  items4[6] = onPressEmoji(stickerId(5062).Button, obj27);
  obj14.children = items4;
  items3[1] = closure_17(stickerId(5060).Stack, obj14);
