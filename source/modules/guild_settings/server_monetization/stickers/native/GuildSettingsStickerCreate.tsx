...
// Dependencies: [5, 32, 19, 17, 5510, 5553, 1074, 1374, 1938, 21, 4606, 576, 7054, 11241, 5649, 4259, 5189, 17664, 10477, 4945, 4602, 1114, 4503, 2024, 5026, 5024, 5174, 10265, 17665, 11216, 7203, 1396, 8848, 6677, 7158, 2]

// Module 17663 (GuildSettingsStickerCreate)
...
import useSafeAreaAvoidingInputsDefault from "useSafeAreaAvoidingInputs" /* 11241 */;
...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    items2[2] = onPressEmoji(stickerId(4602).Text, obj10);
    ...
    obj12.variant = str;
    items2[3] = tmp27(stickerId(5026).Button, obj12);
  ...
  const items4 = [onPressEmoji(stickerId(4602).Text, obj15), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    let tmp32Result = tmp32(tmp14(10265), obj17);
    const tmp14Result4 = tmp14(10265);
  } else if (null != uri) {
    ...
    tmp32Result = tmp32(tmp31(17665).StickerPlusIcon, { size: "lg" });
  }
  obj16.children = tmp32Result;
  items4[1] = onPressEmoji(stickerId(5174).PressableHighlight, obj16);
  ...
  items4[2] = onPressEmoji(stickerId(4602).Text, obj20);
  const obj21 = {
  ...
  if (null != first1) {
    ...
    obj22.src = emojiURL;
    let tmp32Result2 = tmp32(tmp14(7203), obj22);
    const tmp14Result5 = tmp14(7203);
  } else {
    tmp32Result2 = tmp32(tmp31(8848).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4602).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj21.children = items5;
  items4[3] = closure_17(stickerId(5174).PressableHighlight, obj21);
  ...
  items4[4] = onPressEmoji(stickerId(6677).TextInput, obj24);
  ...
  items4[5] = onPressEmoji(stickerId(7158).TextArea, obj26);
  const obj27 = {
  ...
  items4[6] = onPressEmoji(stickerId(5026).Button, obj27);
  obj14.children = items4;
  items3[1] = closure_17(stickerId(5024).Stack, obj14);
