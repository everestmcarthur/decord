...
// Dependencies: [5, 32, 19, 17, 5629, 5672, 1074, 1375, 1939, 21, 4722, 576, 7177, 11399, 5768, 4375, 5307, 17924, 10630, 5061, 4718, 1115, 4618, 2025, 5144, 5142, 5292, 10416, 17925, 11374, 7326, 1397, 8997, 6799, 7281, 2]

// Module 17923 (GuildSettingsStickerCreate)
...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    items2[2] = onPressEmoji(stickerId(4718).Text, obj10);
    ...
    obj12.variant = str;
    items2[3] = tmp27(stickerId(5144).Button, obj12);
  ...
  const items4 = [onPressEmoji(stickerId(4718).Text, obj15), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    let tmp32Result = tmp32(tmp14(10416), obj17);
    const tmp14Result4 = tmp14(10416);
  } else if (null != uri) {
    ...
    tmp32Result = tmp32(tmp31(17925).StickerPlusIcon, { size: "lg" });
  }
  obj16.children = tmp32Result;
  items4[1] = onPressEmoji(stickerId(5292).PressableHighlight, obj16);
  ...
  items4[2] = onPressEmoji(stickerId(4718).Text, obj20);
  const obj21 = {
  ...
  if (null != first1) {
    ...
    obj22.src = emojiURL;
    let tmp32Result2 = tmp32(tmp14(7326), obj22);
    const tmp14Result5 = tmp14(7326);
  } else {
    tmp32Result2 = tmp32(tmp31(8997).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4718).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj21.children = items5;
  items4[3] = closure_17(stickerId(5292).PressableHighlight, obj21);
  ...
  items4[4] = onPressEmoji(stickerId(6799).TextInput, obj24);
  ...
  items4[5] = onPressEmoji(stickerId(7281).TextArea, obj26);
  const obj27 = {
  ...
  items4[6] = onPressEmoji(stickerId(5144).Button, obj27);
  obj14.children = items4;
  items3[1] = closure_17(stickerId(5142).Stack, obj14);
