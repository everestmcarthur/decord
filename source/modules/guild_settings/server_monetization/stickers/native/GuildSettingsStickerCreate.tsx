...
// Dependencies: [5, 32, 19, 17, 5545, 5588, 1074, 1375, 1939, 21, 4638, 576, 7091, 11299, 5684, 4290, 5223, 17789, 10528, 4977, 4634, 1115, 4534, 2025, 5060, 5058, 5208, 10314, 17790, 11274, 7240, 1397, 8897, 6714, 7195, 2]

// Module 17788 (GuildSettingsStickerCreate)
...
import useSafeAreaAvoidingInputsDefault from "useSafeAreaAvoidingInputs" /* 11299 */;
...
const MAX_STICKER_FILE_SIZE = fn(1939).MAX_STICKER_FILE_SIZE;
const jsxProd = fn(21);
...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    let obj9 = stickerId(4534);
    const tmp26 = closure_16;
    const tmp27 = onPressEmoji;
    obj11.articleUrl = tmp14(2025).getArticleURL(uri.STICKERS_UPLOAD);
    obj10.children = intl3.format(stickerId(1115).t.UBj0aX, obj11);
    items2[2] = onPressEmoji(stickerId(4634).Text, obj10);
    ...
    obj12.variant = str;
    items2[3] = tmp27(stickerId(5060).Button, obj12);
    obj13.children = items2;
    tmp23Result = tmp23(tmp26, obj13);
    const tmp14Result = tmp14(2025);
  }
  ...
  const items4 = [onPressEmoji(stickerId(4634).Text, obj15), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    let tmp32Result = tmp32(tmp14(10314), obj17);
    const tmp14Result4 = tmp14(10314);
  } else if (null != uri) {
    ...
    tmp32Result = tmp32(tmp31(17790).StickerPlusIcon, { size: "lg" });
  }
  obj16.children = tmp32Result;
  items4[1] = onPressEmoji(stickerId(5208).PressableHighlight, obj16);
  ...
  items4[2] = onPressEmoji(stickerId(4634).Text, obj20);
  const obj21 = {
  ...
  if (null != first1) {
    ...
    obj22.src = emojiURL;
    let tmp32Result2 = tmp32(tmp14(7240), obj22);
    const tmp14Result5 = tmp14(7240);
  } else {
    tmp32Result2 = tmp32(tmp31(8897).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4634).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj21.children = items5;
  items4[3] = closure_17(stickerId(5208).PressableHighlight, obj21);
  ...
  items4[4] = onPressEmoji(stickerId(6714).TextInput, obj24);
  ...
  items4[5] = onPressEmoji(stickerId(7195).TextArea, obj26);
  const obj27 = {
  ...
  items4[6] = onPressEmoji(stickerId(5060).Button, obj27);
  obj14.children = items4;
  items3[1] = closure_17(stickerId(5058).Stack, obj14);
