...
// Dependencies: [19, 17, 1980, 4278, 1372, 1074, 1939, 21, 1115, 17824, 9529, 13637, 4640, 576, 1612, 504, 9822, 17826, 7153, 4533, 4636, 4536, 5062, 17827, 8748, 5060, 5775, 5693, 5182, 10322, 1177, 4484, 5700, 17833, 2]

// Module 17823 (GuildSettingsModalStickers)
...
import showGuildSettingsStickerCreateModalDefault from "showGuildSettingsStickerCreateModal" /* 17827 */;
...
obj2.IconComponent = fn(17824).BoostGemOutlineIcon;
items[1] = obj2;
...
obj3.IconComponent = fn(9529).BoostGemIcon;
items[2] = obj3;
...
obj4.IconComponent = fn(13637).BoostTier3Icon;
items[3] = obj4;
  ...
  if ("success" !== tmp7.status) {
    ...
    const obj9 = {
      ...
      children: items.map((label) => {
          ...
          let tmp7Result2;
          if (guildTier < tier) {
            tmp7Result2 = tmp7(tmp2(5182).LockIcon, { color: "icon-muted" });
          }
          ...
          items[1] = Array.from({ length: incrementalStickerCountForTier }).map((item, index) => {
            ...
            if (null == closure_5[+closure_6]) {
              ...
              obj3.children = closure_1_12(closure_1_1(10322), obj4);
              ...
              items = [closure_1_12(guildId(4636).Text, obj5), ];
              ...
              if (null != user) {
                ...
                const obj7 = { variant: "text-sm/medium", color: "text-subtle", children: closure_1_1(4484).getName(user) };
                items1[1] = tmp9(tmp10(4636).Text, obj7);
                obj.children = items1;
                tmp16Result = tmp16(tmp12, obj);
                const tmp14Result = closure_1_1(4484);
              }
              ...
              let tmp9Result;
              if (tmp8) {
                tmp9Result = tmp9(tmp10(5700).TableRowArrow, {});
              }
              ...
              obj2.onPress = fn;
              return closure_1_12(guildId(5693).TableRow, obj2, index);
            }
          });
          obj7.children = items;
