...
// Dependencies: [19, 17, 1980, 4361, 1372, 1074, 1939, 21, 1115, 17918, 9613, 13728, 4722, 576, 1612, 504, 9916, 17920, 7235, 4615, 4718, 4618, 5144, 17921, 8831, 5142, 5857, 5775, 5264, 10416, 1177, 4566, 5782, 17927, 2]

// Module 17917 (GuildSettingsModalStickers)
...
import showGuildSettingsStickerCreateModalDefault from "showGuildSettingsStickerCreateModal" /* 17921 */;
...
obj2.IconComponent = fn(17918).BoostGemOutlineIcon;
items[1] = obj2;
...
obj3.IconComponent = fn(9613).BoostGemIcon;
items[2] = obj3;
...
obj4.IconComponent = fn(13728).BoostTier3Icon;
items[3] = obj4;
  ...
  if ("success" !== tmp7.status) {
    ...
    const obj9 = {
      ...
      children: items.map((label) => {
          ...
          let tmp7Result2;
          if (guildTier < tier) {
            tmp7Result2 = tmp7(tmp2(5264).LockIcon, { color: "icon-muted" });
          }
          ...
          items[1] = Array.from({ length: incrementalStickerCountForTier }).map((item, index) => {
            ...
            if (null == closure_5[+closure_6]) {
              ...
              obj3.children = closure_1_12(closure_1_1(10416), obj4);
              ...
              items = [closure_1_12(guildId(4718).Text, obj5), ];
              ...
              if (null != user) {
                ...
                const obj7 = { variant: "text-sm/medium", color: "text-subtle", children: closure_1_1(4566).getName(user) };
                items1[1] = tmp9(tmp10(4718).Text, obj7);
                obj.children = items1;
                tmp16Result = tmp16(tmp12, obj);
                const tmp14Result = closure_1_1(4566);
              }
              ...
              let tmp9Result;
              if (tmp8) {
                tmp9Result = tmp9(tmp10(5782).TableRowArrow, {});
              }
              ...
              obj2.onPress = fn;
              return closure_1_12(guildId(5775).TableRow, obj2, index);
            }
          });
          obj7.children = items;
