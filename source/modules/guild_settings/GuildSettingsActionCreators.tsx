...
// Dependencies: [5, 2014, 4246, 502, 2021, 1979, 9156, 1074, 3, 573, 1272, 7397, 9164, 5221, 7059, 4800, 1250, 4459, 1114, 1100, 5604, 2]

// Module 9155 (GuildSettingsActionCreators)
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              const obj4 = tmp2(1272);
              tmp27 = tmp2;
              dependencyMap = 1;
              c3 = 1;
              const obj6 = {
                value: HTTP.del(request).then(() => {
                          const AccessibilityAnnouncer = closure_1_0(4459).AccessibilityAnnouncer;
