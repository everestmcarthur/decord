...
// Dependencies: [5, 2014, 4244, 502, 2021, 1979, 9133, 1074, 3, 573, 1272, 7375, 9141, 5219, 7037, 4798, 1250, 4457, 1114, 1100, 5602, 2]

// Module 9132 (GuildSettingsActionCreators)
            ...
            if (arg0 === 1) {
              ...
              const obj6 = {
                value: HTTP.del(request).then(() => {
                          const AccessibilityAnnouncer = closure_1_0(4457).AccessibilityAnnouncer;
