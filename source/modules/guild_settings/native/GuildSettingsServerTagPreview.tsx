...
// Dependencies: [5, 32, 19, 17, 1372, 8163, 21, 4722, 576, 504, 4874, 1397, 14123, 4718, 1115, 5142, 10399, 9422, 14124, 14168, 5144, 5777, 2]
// Exports: default

// Module 14122 (GuildSettingsServerTagPreview)
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  let obj = guildId(504);
  const name = onAdopted(4874).useName(guildId, null, stateFromStores);
  let obj3 = onAdopted(4874);
  let avatarURL;
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp2(14123).adoptGuildIdentity(guildId, true), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
  ...
  const items2 = [closure_10(guildId(4718).Text, obj2), ];
  ...
  const items4 = [closure_10(closure_6, { source: onAdopted(10399), style: tmp.avatar, importantForAccessibility: "no" }), ];
  const obj8 = { style: tmp.messageBody, children: null };
  const items5 = [closure_10(guildId(4718).Text, { variant: "text-md/semibold", color: "text-default", children: "Locke" }), ];
  const obj9 = { variant: "text-md/normal", color: "text-default", children: null };
  const intl2 = tmp2(1115).intl;
  obj9.children = intl2.string(guildId(1115).t.KZQ4mF);
  items5[1] = closure_10(guildId(4718).Text, obj9);
  ...
  const items8 = [closure_10(guildId(4718).Text, { variant: "text-md/semibold", color: "text-default", children: name }), ];
  ...
  if (tmp15Result3) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(14124).GuildBadge, size);
    }
    obj14.guildBadge = tmp15Result;
    tmp15Result3 = tmp15(tmp2(9422).BaseGuildTagChiplet, obj14);
  }
  ...
  items9[1] = closure_10(guildId(4718).Text, obj15);
  ...
  const obj7 = { source: onAdopted(10399), style: tmp.avatar, importantForAccessibility: "no" };
  const tmp18 = closure_6;
  const items11 = [closure_10(tmp18, { source: onAdopted(14168), style: tmp.avatar, importantForAccessibility: "no" }), ];
  const obj19 = { style: tmp.messageBody, children: null };
  const items12 = [closure_10(guildId(4718).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }), ];
  ...
  items12[1] = closure_10(guildId(4718).Text, obj20);
  ...
  items6[3] = closure_10(guildId(5144).Button, obj21);
  obj5.children = items6;
  items2[1] = closure_11(guildId(5142).Stack, obj5);
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result4 = tmp15(tmp2(5777).Card, obj23);
  }
  return tmp15Result4;
};
