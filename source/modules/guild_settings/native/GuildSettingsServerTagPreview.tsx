...
// Dependencies: [5, 32, 19, 17, 1371, 8018, 21, 4606, 576, 504, 4758, 1396, 13967, 4602, 1114, 5024, 10248, 9274, 13968, 14012, 5026, 5658, 2]
// Exports: default
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  let obj = guildId(504);
  const name = onAdopted(4758).useName(guildId, null, stateFromStores);
  let obj3 = onAdopted(4758);
  let avatarURL;
  ...
  const items2 = [closure_10(guildId(4602).Text, obj2), ];
  ...
  const items4 = [closure_10(closure_6, { source: onAdopted(10248), style: tmp.avatar, importantForAccessibility: "no" }), ];
  const obj8 = { style: tmp.messageBody, children: null };
  const items5 = [closure_10(guildId(4602).Text, { variant: "text-md/semibold", color: "text-default", children: "Locke" }), ];
  const obj9 = { variant: "text-md/normal", color: "text-default", children: null };
  const intl2 = tmp2(1114).intl;
  obj9.children = intl2.string(guildId(1114).t.KZQ4mF);
  items5[1] = closure_10(guildId(4602).Text, obj9);
  ...
  const items8 = [closure_10(guildId(4602).Text, { variant: "text-md/semibold", color: "text-default", children: name }), ];
  ...
  if (tmp15Result3) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(13968).GuildBadge, size);
    }
    obj14.guildBadge = tmp15Result;
    tmp15Result3 = tmp15(tmp2(9274).BaseGuildTagChiplet, obj14);
  }
  ...
  items9[1] = closure_10(guildId(4602).Text, obj15);
  ...
  const obj7 = { source: onAdopted(10248), style: tmp.avatar, importantForAccessibility: "no" };
  const tmp18 = closure_6;
  const items11 = [closure_10(tmp18, { source: onAdopted(14012), style: tmp.avatar, importantForAccessibility: "no" }), ];
  const obj19 = { style: tmp.messageBody, children: null };
  const items12 = [closure_10(guildId(4602).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }), ];
  ...
  items12[1] = closure_10(guildId(4602).Text, obj20);
  ...
  items6[3] = closure_10(guildId(5026).Button, obj21);
  obj5.children = items6;
  items2[1] = closure_11(guildId(5024).Stack, obj5);
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result4 = tmp15(tmp2(5658).Card, obj23);
  }
  return tmp15Result4;
};
