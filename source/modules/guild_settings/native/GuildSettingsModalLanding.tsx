...
// Dependencies: [19, 2013, 1980, 4276, 1372, 16273, 9207, 1074, 21, 4818, 4638, 5691, 1115, 4592, 17728, 5624, 4281, 17730, 15070, 8897, 10252, 11882, 9210, 9001, 9892, 17732, 4580, 5773, 15709, 5174, 9576, 4339, 576, 1484, 504, 9206, 17733, 7370, 7377, 4335, 8728, 5058, 17061, 1397, 17734, 7150, 2]
// Exports: default

// Module 17727 (GuildSettingsModalLanding)
...
function SettingsSection(guild) {
  ...
  obj.icon = closure_15(guild(5691).TableRow.Icon, { IconComponent: guild(4592).CircleInformationIcon });
  obj.onPress = function onPress() {
    return importDefault(constants2.OVERVIEW);
  };
  const items = [closure_15(guild(5691).TableRow, obj, "overview")];
  const currentUser = UserStore.getCurrentUser();
  if (canManageGuild) {
    const obj3 = { label: null, arrow: true, icon: null, onPress: null };
    const intl2 = tmp2(1115).intl;
    obj3.label = intl2.string(tmp2(1115).t["5tbTdV"]);
    const obj4 = { IconComponent: tmp2(17728).ModerationIcon };
    obj3.icon = tmp(tmp2(5691).TableRow.Icon, obj4);
    obj3.onPress = function onPress() {
      return importDefault(constants2.MODERATION);
    };
    items.push(tmp(tmp2(5691).TableRow, obj3, "moderation"));
  }
  if (canViewAuditLog) {
    const obj5 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1115).intl;
    obj5.label = intl3.string(tmp2(1115).t.SPWLyT);
    const obj6 = { IconComponent: tmp2(5624).ClipboardListIcon };
    obj5.icon = tmp(tmp2(5691).TableRow.Icon, obj6);
    obj5.onPress = function onPress() {
      return importDefault(constants2.AUDIT_LOG);
    };
    items.push(tmp(tmp2(5691).TableRow, obj5, "auditlogs"));
  }
  ...
  if (canManageChannels) {
    ...
    const obj9 = { IconComponent: tmp2(17730).ChannelListIcon };
    obj8.icon = tmp(tmp2(5691).TableRow.Icon, obj9);
    obj8.onPress = function onPress() {
      guild = GuildSettingsModalChannelsStore.initGuild(guild.id);
      importDefault(constants2.CHANNELS);
    };
    items.push(tmp(tmp2(5691).TableRow, obj8, "channels"));
  }
  ...
  if (tmp11) {
    ...
    const obj11 = { IconComponent: tmp2(15070).PuzzlePieceIcon };
    obj10.icon = tmp(tmp2(5691).TableRow.Icon, obj11);
    obj10.onPress = function onPress() {
      return importDefault(constants2.INTEGRATIONS);
    };
    items.push(tmp(tmp2(5691).TableRow, obj10, "integrations"));
  }
  if (canManageGuildExpressions) {
    ...
    const obj13 = { IconComponent: tmp2(8897).ReactionIcon };
    obj12.icon = tmp(tmp2(5691).TableRow.Icon, obj13);
    obj12.onPress = function onPress() {
      return importDefault(constants2.EMOJI);
    };
    items.push(tmp(tmp2(5691).TableRow, obj12, "emoji"));
    const obj14 = { label: null, arrow: true, icon: null, onPress: null };
    const intl7 = tmp2(1115).intl;
    obj14.label = intl7.string(tmp2(1115).t.R5nQkS);
    const obj15 = { IconComponent: tmp2(10252).StickerIcon };
    obj14.icon = tmp(tmp2(5691).TableRow.Icon, obj15);
    obj14.onPress = function onPress() {
      return importDefault(constants2.STICKERS);
    };
    items.push(tmp(tmp2(5691).TableRow, obj14, "stickers"));
  }
  if (canConfigureOfficialMessages) {
    ...
    const obj17 = { IconComponent: tmp2(11882).StampIcon };
    obj16.icon = tmp(tmp2(5691).TableRow.Icon, obj17);
    obj16.onPress = function onPress() {
      return importDefault(constants2.OFFICIAL_MESSAGES);
    };
    items.push(tmp(tmp2(5691).TableRow, obj16, "official-messages"));
  }
  const obj2 = { IconComponent: guild(4592).CircleInformationIcon };
  if (tmp2Result.canUseMobileServerTagSettings(guild.id)) {
    ...
    const obj19 = { IconComponent: tmp2(9001).TagIcon };
    obj18.icon = tmp(tmp2(5691).TableRow.Icon, obj19);
    obj18.onPress = function onPress() {
      return importDefault(constants2.TAG);
    };
    items.push(tmp(tmp2(5691).TableRow, obj18, "server-tag"));
  }
  if (canManageGuild) {
    ...
    const obj21 = { IconComponent: tmp2(9892).ShieldUserIcon };
    obj20.icon = tmp(tmp2(5691).TableRow.Icon, obj21);
    obj20.onPress = function onPress() {
      return importDefault(constants2.SECURITY);
    };
    items.push(tmp(tmp2(5691).TableRow, obj20, "security"));
  }
  if (isGuildAdmin) {
    isGuildAdmin = tmp2(17732).canSeeVanityUrlSettings(guild);
    const tmp2Result2 = tmp2(17732);
  }
  if (isGuildAdmin) {
    ...
    const obj23 = { IconComponent: tmp2(4580).LinkIcon };
    obj22.icon = tmp(tmp2(5691).TableRow.Icon, obj23);
    obj22.onPress = function onPress() {
      return importDefault(constants2.VANITY_URL);
    };
    items.push(tmp(tmp2(5691).TableRow, obj22, "vanity"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    tmpResult = tmp(tmp2(5773).TableRowGroup, obj24);
  }
  return tmpResult;
}
function CommunitySection(pushScreen) {
  ...
  const TableRow = pushScreen(5691).TableRow;
  ...
  if (hasItem) {
    ...
    const obj3 = { IconComponent: tmp3(15709).TreehouseIcon };
    obj2.icon = tmp2(tmp3(5691).TableRow.Icon, obj3);
    ...
    const obj4 = { IconComponent: tmp3(15709).TreehouseIcon };
    obj2.icon = tmp2(tmp3(5691).TableRow.Icon, obj4);
    obj2.onPress = function onPress() {
  ...
  return closure_15(pushScreen(5773).TableRowGroup, obj);
}
function UserManagementSection(pushScreen) {
  ...
  obj.icon = closure_15(pushScreen(5691).TableRow.Icon, { IconComponent: pushScreen(5174).GroupIcon });
  obj.onPress = function onPress() {
    return pushScreen(constants2.MEMBERS);
  };
  const items = [closure_15(pushScreen(5691).TableRow, obj, "members")];
  if (canManageRoles) {
    const obj3 = { label: null, arrow: true, icon: null, onPress: null };
    const intl2 = tmp2(1115).intl;
    obj3.label = intl2.string(tmp2(1115).t["LPJmL/"]);
    const obj4 = { IconComponent: tmp2(9892).ShieldUserIcon };
    obj3.icon = tmp(tmp2(5691).TableRow.Icon, obj4);
    obj3.onPress = function onPress() {
      return pushScreen(constants2.ROLES);
    };
    items.push(tmp(tmp2(5691).TableRow, obj3, "roles"));
  }
  if (canManageGuild) {
    const obj5 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1115).intl;
    obj5.label = intl3.string(tmp2(1115).t.ngRFjZ);
    const obj6 = { IconComponent: tmp2(4580).LinkIcon };
    obj5.icon = tmp(tmp2(5691).TableRow.Icon, obj6);
    obj5.onPress = function onPress() {
      return pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(tmp(tmp2(5691).TableRow, obj5, "invites"));
  }
  if (canManageBans) {
    const obj7 = { label: null, arrow: true, icon: null, onPress: null };
    const intl4 = tmp2(1115).intl;
    obj7.label = intl4.string(tmp2(1115).t.ZbeITS);
    const obj8 = { IconComponent: tmp2(9576).HammerIcon };
    obj7.icon = tmp(tmp2(5691).TableRow.Icon, obj8);
    obj7.onPress = function onPress() {
      return pushScreen(constants2.BANS);
    };
    items.push(tmp(tmp2(5691).TableRow, obj7, "bans"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    obj9.children = items;
    tmpResult = tmp(tmp2(5773).TableRowGroup, obj9);
  }
  return tmpResult;
}
function GuildSettingsModalLandingInner(guild) {
  ...
  const token = guild(4339).useToken(updateErrors(576).modules.mobile.TABLE_ROW_PADDING);
  ...
  const obj5 = noop;
  const obj6 = guild(17733);
  const tmp11 = guild(17733).useChannelsAllowedToUnlink(guild.id).length > 0;
  const canManageGuildRoleSubscriptions = guild(7370).useCanManageGuildRoleSubscriptions(guild);
  let result = canManageGuild;
  if (canManageGuild) {
    result = tmp(7377).isGuildOfficialMessagesEnabled(guild, "GuildSettingsModalLanding");
  ...
  if (canManageGuildRoleSubscriptions) {
    ...
    tmp17Result2 = tmp17(tmp3(17734), obj12);
  }
  ...
  obj8.children = closure_16(guild(5058).Stack, obj9);
  const items6 = [closure_15(guild(8728).Form, obj8), closure_15(guild(7150).NavScrim, {})];
