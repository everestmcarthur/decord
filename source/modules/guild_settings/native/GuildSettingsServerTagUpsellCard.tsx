...
// Dependencies: [19, 17, 4528, 21, 4639, 576, 504, 4532, 12655, 12623, 5071, 5057, 12658, 4635, 1115, 5059, 16328, 2]
// Exports: default

// Module 17739 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(12658), obj8);
  }
  ...
  const items6 = [closure_6(guildId(4635).Text, obj10), ];
  ...
  items6[1] = closure_6(guildId(4635).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(guildId(5057).Stack, obj9);
  ...
  obj12.icon = closure_6(guildId(16328).BoostTier2Icon, { color: "white" });
  obj12.onPress = guildId.onUnlockPress;
  items5[2] = closure_6(guildId(5059).Button, obj12);
  obj6.children = items5;
  items4[3] = closure_7(guildId(5057).Stack, obj6);
