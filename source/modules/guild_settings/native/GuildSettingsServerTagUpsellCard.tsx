...
// Dependencies: [19, 17, 4463, 21, 4574, 576, 504, 4467, 12550, 12518, 5001, 4987, 12553, 4570, 1114, 4989, 16251, 2]
// Exports: default

// Module 17620 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(12553), obj8);
  }
  ...
  const items6 = [closure_6(guildId(4570).Text, obj10), ];
  ...
  items6[1] = closure_6(guildId(4570).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(guildId(4987).Stack, obj9);
  ...
  obj12.icon = closure_6(guildId(16251).BoostTier2Icon, { color: "white" });
  obj12.onPress = guildId.onUnlockPress;
  items5[2] = closure_6(guildId(4989).Button, obj12);
  obj6.children = items5;
  items4[3] = closure_7(guildId(4987).Stack, obj6);
