...
// Dependencies: [19, 17, 4494, 21, 4605, 576, 504, 4498, 12590, 12558, 5037, 5023, 12593, 4601, 1114, 5025, 16300, 2]
// Exports: default
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(12593), obj8);
  }
  ...
  const items6 = [closure_6(guildId(4601).Text, obj10), ];
  ...
  items6[1] = closure_6(guildId(4601).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(guildId(5023).Stack, obj9);
  ...
  obj12.icon = closure_6(guildId(16300).BoostTier2Icon, { color: "white" });
  obj12.onPress = guildId.onUnlockPress;
  items5[2] = closure_6(guildId(5025).Button, obj12);
  obj6.children = items5;
  items4[3] = closure_7(guildId(5023).Stack, obj6);
