...
// Function ID: 17782
// Name: AssetChooser
// Dependencies: [5, 19, 17, 1074, 21, 4640, 576, 4350, 5225, 5210, 1115, 17782, 17783, 1177, 2]

// Module 17781 (AssetChooser)
...
prototype["render"] = function render() {
  ...
  if (!disabled) {
    ...
    const obj4 = { style: tmp.uploadIcon, source: _modDef17783 };
