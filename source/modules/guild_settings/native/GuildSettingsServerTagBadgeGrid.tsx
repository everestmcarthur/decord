...
// Dependencies: [19, 17, 8019, 21, 576, 4607, 17675, 12574, 5025, 4603, 1114, 17676, 17677, 13970, 7283, 2]
// Exports: default

// Module 17674 (GuildSettingsServerTagBadgeGrid)
import nativeDefault from "native" /* 576 */;
import openGuildPowerupsModalDefault from "openGuildPowerupsModal" /* 12574 */;
import useGuildTagBadgeCollectionDefault from "useGuildTagBadgeCollection" /* 17675 */;
import GuildSettingsServerTagPickerCellDefault from "GuildSettingsServerTagPickerCell" /* 17676 */;
import getGuildTagBadgeLabelDefault from "getGuildTagBadgeLabel" /* 17677 */;
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  const items1 = [closure_7(guildId(4603).Text, obj2), , ];
  ...
  items1[1] = closure_7(closure_5, {
    ...
    children: unlockedBadges.map((badge) => {
      ...
      obj.children = closure_1_7(guildId(13970).GuildBadge, size);
  ...
  if (tmp6Result) {
    ...
    obj5.children = substr.map((badge) => {
      ...
      return closure_1_7(guildId(13970).GuildBadge, size, badge.kind);
    });
    ...
    items2[1] = tmp8(tmp7(4603).Text, obj6);
    const obj7 = { size: "md", color: nativeDefault.colors.ICON_SUBTLE };
    items2[2] = tmp8(tmp7(7283).ChevronSmallRightIcon, obj7);
    obj4.children = items2;
    tmp6Result = tmp6(closure_4, obj4);
  }
  items1[2] = tmp6Result;
  obj.children = items1;
  return closure_8(guildId(5025).Stack, obj);
};
