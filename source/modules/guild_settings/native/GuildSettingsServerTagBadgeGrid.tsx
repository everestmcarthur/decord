...
// Dependencies: [19, 17, 8051, 21, 576, 4639, 17743, 12614, 5057, 4635, 1115, 17744, 17745, 14008, 7316, 2]
// Exports: default

// Module 17742 (GuildSettingsServerTagBadgeGrid)
import nativeDefault from "native" /* 576 */;
import openGuildPowerupsModalDefault from "openGuildPowerupsModal" /* 12614 */;
import useGuildTagBadgeCollectionDefault from "useGuildTagBadgeCollection" /* 17743 */;
import GuildSettingsServerTagPickerCellDefault from "GuildSettingsServerTagPickerCell" /* 17744 */;
import getGuildTagBadgeLabelDefault from "getGuildTagBadgeLabel" /* 17745 */;
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  const items1 = [closure_7(guildId(4635).Text, obj2), , ];
  ...
  items1[1] = closure_7(closure_5, {
    ...
    children: unlockedBadges.map((badge) => {
      ...
      obj.children = closure_1_7(guildId(14008).GuildBadge, size);
  ...
  if (tmp6Result) {
    ...
    obj5.children = substr.map((badge) => {
      ...
      return closure_1_7(guildId(14008).GuildBadge, size, badge.kind);
    });
    ...
    items2[1] = tmp8(tmp7(4635).Text, obj6);
    const obj7 = { size: "md", color: nativeDefault.colors.ICON_SUBTLE };
    items2[2] = tmp8(tmp7(7316).ChevronSmallRightIcon, obj7);
    obj4.children = items2;
    tmp6Result = tmp6(closure_4, obj4);
  }
  items1[2] = tmp6Result;
  obj.children = items1;
  return closure_8(guildId(5057).Stack, obj);
};
