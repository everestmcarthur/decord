...
// Dependencies: [19, 17, 5592, 21, 4605, 576, 4449, 4601, 16667, 1396, 5655, 1178, 1611, 16672, 4429, 16673, 504, 1114, 8943, 8295, 7092, 2]
...
let closure_12 = noop.memo((joinRequest) => {
  ...
  if (null == joinRequest) {
    ...
    if (null == user) {
      ...
      obj2.start = start;
      obj2.end = end;
      return closure_7(joinRequest(5655).TableRow, obj2);
    }
  }
});
