...
// Dependencies: [19, 17, 5594, 21, 4607, 576, 4451, 4603, 16655, 1396, 5657, 1178, 1611, 16660, 4431, 16661, 504, 1114, 8966, 8318, 7114, 2]
...
let closure_12 = noop.memo((joinRequest) => {
  ...
  if (null == joinRequest) {
    ...
    if (null == user) {
      ...
      obj2.start = start;
      obj2.end = end;
      return closure_7(joinRequest(5657).TableRow, obj2);
    }
  }
});
