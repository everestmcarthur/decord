...
// Dependencies: [19, 17, 5593, 21, 4606, 576, 4451, 4602, 16655, 1396, 5656, 1178, 1611, 16660, 4431, 16661, 504, 1114, 8964, 8316, 7113, 2]
...
let closure_12 = noop.memo((joinRequest) => {
  ...
  if (null == joinRequest) {
    ...
    if (null == user) {
      ...
      obj2.start = start;
      obj2.end = end;
      return closure_7(joinRequest(5656).TableRow, obj2);
    }
  }
});
