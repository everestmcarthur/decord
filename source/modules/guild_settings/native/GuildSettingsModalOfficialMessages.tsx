...
// Dependencies: [32, 19, 17, 4597, 1979, 9133, 5653, 4598, 1085, 21, 4605, 576, 1114, 15348, 11392, 15350, 4605, 1483, 504, 9132, 5674, 7429, 4572, 16373, 1896, 9862, 4341, 5655, 14674, 1091, 4601, 9863, 4286, 7319, 672, 1178, 15363, 2]
// Exports: default

// Module 17885 (GuildSettingsModalOfficialMessages)
...
import GuildOfficialMessageUtils from "GuildOfficialMessageUtils" /* 7319 */;
...
obj2.chatSection = { paddingHorizontal: fn(5653).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
let obj5 = { paddingHorizontal: fn(5653).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
...
export default function GuildSettingsModalOfficialMessages(guildId) {
  ...
  const callback = officialMessageColor.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(16373, dependencyMap.paths), "RoleColorPicker", obj2);
  }, items5);
  ...
  const memo = officialMessageColor.useMemo(() => {
    ...
    obj3.label = intl3.string(guildId(submitting[12]).t.pQwSpQ);
    obj3.id = constants.MIDNIGHT;
  ...
  const animatedReaction = tmp2Result5.useAnimatedReaction(B, P);
