...
// Dependencies: [32, 19, 17, 4630, 1980, 9207, 5689, 4631, 1085, 21, 4638, 576, 1115, 15379, 11466, 15381, 4638, 1484, 504, 9206, 5710, 7487, 4605, 16421, 1897, 9932, 4374, 5691, 14711, 1092, 4634, 9933, 4319, 7377, 672, 1177, 15394, 2]
// Exports: default

// Module 18001 (GuildSettingsModalOfficialMessages)
...
function MessagePreview(theme) {
  ...
  const items2 = [closure_1_12(native.Avatar, { source: _modDef15394 }), ];
...
obj2.chatSection = { paddingHorizontal: fn(5689).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
let obj5 = { paddingHorizontal: fn(5689).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
...
export default function GuildSettingsModalOfficialMessages(guildId) {
  ...
  const callback = officialMessageColor.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(16421, dependencyMap.paths), "RoleColorPicker", obj2);
  }, items5);
