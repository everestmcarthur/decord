...
// Dependencies: [32, 19, 17, 4632, 1980, 9218, 5691, 4633, 1085, 21, 4640, 576, 1115, 15384, 11474, 15386, 4640, 1484, 504, 9217, 5712, 7491, 4607, 16451, 1897, 9943, 4376, 5693, 14719, 1092, 4636, 9944, 4321, 7381, 672, 1177, 15399, 2]
// Exports: default

// Module 18065 (GuildSettingsModalOfficialMessages)
...
import GuildOfficialMessageUtils from "GuildOfficialMessageUtils" /* 7381 */;
...
function MessagePreview(theme) {
  ...
  const items2 = [closure_1_12(native.Avatar, { source: _modDef15399 }), ];
...
obj2.chatSection = { paddingHorizontal: fn(5691).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
let obj5 = { paddingHorizontal: fn(5691).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
...
export default function GuildSettingsModalOfficialMessages(guildId) {
  ...
  const callback = officialMessageColor.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(16451, dependencyMap.paths), "RoleColorPicker", obj2);
  }, items5);
