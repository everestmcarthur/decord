...
// Dependencies: [32, 19, 17, 4631, 1980, 9196, 5688, 4632, 1085, 21, 4639, 576, 1115, 15363, 11458, 15365, 4639, 1484, 504, 9195, 5709, 7484, 4606, 16401, 1897, 9924, 4376, 5690, 14695, 1092, 4635, 9925, 4321, 7374, 672, 1177, 15378, 2]
// Exports: default

// Module 17945 (GuildSettingsModalOfficialMessages)
...
function MessagePreview(theme) {
  ...
  const items2 = [closure_1_12(native.Avatar, { source: _modDef15378 }), ];
...
obj2.chatSection = { paddingHorizontal: fn(5688).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
let obj5 = { paddingHorizontal: fn(5688).TABLE_ROW_PADDING, gap: nativeDefault.space.PX_8 };
...
export default function GuildSettingsModalOfficialMessages(guildId) {
  ...
  const callback = officialMessageColor.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(16401, dependencyMap.paths), "RoleColorPicker", obj2);
  }, items5);
