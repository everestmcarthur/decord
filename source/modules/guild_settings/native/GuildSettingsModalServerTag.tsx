...
// Dependencies: [5, 32, 19, 17, 9155, 1979, 9154, 1074, 8018, 21, 4606, 576, 1483, 9157, 504, 9277, 8250, 9278, 9153, 4304, 1114, 12572, 4499, 5675, 7450, 1484, 4951, 1178, 7112, 9293, 4602, 5738, 7273, 5656, 5024, 13968, 8684, 13966, 17670, 2]
// Exports: default

// Module 17669 (GuildSettingsModalServerTag)
...
let GuildProfileFetchStatus = fn(9155).GuildProfileFetchStatus;
...
export default function GuildSettingsModalServerTag(guildId) {
  ...
  const result = guildId(9157).canUseMobileServerTagSettings(guildId);
  dependencyMap = result;
  let obj2 = guildId(9157);
  const items = [result1];
  ...
  if (guildSupportsTagsResult) {
    guildSupportsTagsResult = tmp2(8250).guildSupportsTags(stateFromStores);
    const tmp2Result = tmp2(8250);
  }
  ...
  result1 = guildId(9157).isServerTagDraftDirty(stateFromStores1, stateFromStores2);
              ...
              if (!ref.current) {
                if (closure_9) {
                  if (dependencyMap) {
                    ...
                    dependencyMap = 1;
                    c3 = 1;
                    const obj7 = { value: tmp2(9278).saveGuildProfile(guildId, { tag: null, badge: null, badgeColorPrimary: null, badgeColorSecondary: null }), done: false };
                    return obj7;
                  }
                }
              }
  ...
  const effect2 = obj7.useEffect(() => {
    if (c2) {
      if (closure_12) {
        if (c7) {
          let obj = {
            headerRight: first ? (() => closure_1_13(guildId(5675).HeaderSubmittingIndicator, {})) : (() => {
                    const obj = { text: null, onPress: null, disabled: null };
                    const intl = guildId(1114).intl;
                    obj.text = intl.string(guildId(1114).t["R3BPH+"]);
                    obj.onPress = onPress;
                    obj.disabled = !closure_1_9;
                    return closure_13(guildId(7450).HeaderActionButton, obj);
                  })
          };
  ...
  const tmp2Result3 = guildId(9157);
  let tmp26 = result1;
  if (result1) {
    tmp26 = !first;
  }
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return closure_13(navigation(9293), obj8);
      } else if (null == stateFromStores1) {
        return closure_13(tmp2(7112).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = closure_13(tmp2(4602).Text, obj9);
            }
          }
        }
        ...
        const items11 = [closure_13(tmp2(7273).TableSwitchRow, obj11), ];
        ...
        if (null != tmp29) {
          ...
          tmp31Result = tmp31(tmp2(5024).Stack, obj13);
        }
        obj12.trailing = tmp31Result;
        items11[1] = closure_13(tmp2(5656).TableRow, obj12);
        obj10.children = items11;
        const tmp31Result2 = closure_14(tmp2(5738).TableRowGroup, obj10);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4602).Text, obj17), tmp31Result2, , ];
          ...
          items14[2] = tmp32(tmp2(4602).Text, obj18);
          ...
          const items15 = [tmp32(tmp39(17670), obj20), tmp31Result2];
          obj15.children = items15;
          tmp40 = obj15;
        }
        obj14.children = closure_14(tmp2(5024).Stack, tmp40);
        return closure_13(tmp2(8684).Form, obj14);
      }
    } else {
      return closure_13(tmp2(7112).SceneLoadingIndicator, {});
    }
