...
// Dependencies: [5, 32, 19, 17, 9197, 1980, 9196, 1074, 8051, 21, 4639, 576, 1484, 9199, 504, 9319, 8285, 9320, 9195, 4337, 1115, 12614, 4532, 5709, 7484, 1485, 4984, 1177, 7146, 9335, 4635, 5772, 7307, 5690, 5057, 14008, 8719, 14006, 17739, 2]
// Exports: default

// Module 17738 (GuildSettingsModalServerTag)
...
import openGuildPowerupsModalDefault from "openGuildPowerupsModal" /* 12614 */;
...
export default function GuildSettingsModalServerTag(guildId) {
  ...
  const result = guildId(9199).canUseMobileServerTagSettings(guildId);
  dependencyMap = result;
  let obj2 = guildId(9199);
  const items = [result1];
  const items1 = [guildId];
  const stateFromStores = guildId(504).useStateFromStores(items, () => GuildStore.getGuild(guildId), items1);
  const obj3 = guildId(504);
  const guildProfile1 = guildId(9319).useGuildProfile(guildId);
  ({ guildProfile, fetchStatus } = guildProfile1);
  const obj4 = guildId(9319);
  ...
  if (guildSupportsTagsResult) {
    guildSupportsTagsResult = tmp2(8285).guildSupportsTags(stateFromStores);
  ...
  result1 = guildId(9199).isServerTagDraftDirty(stateFromStores1, stateFromStores2);
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
              ...
              if (!ref.current) {
                if (closure_9) {
                  if (dependencyMap) {
                    ...
                    dependencyMap = 1;
                    c3 = 1;
                    const obj7 = { value: tmp2(9320).saveGuildProfile(guildId, { tag: null, badge: null, badgeColorPrimary: null, badgeColorSecondary: null }), done: false };
                    return obj7;
                  }
                }
              }
          ...
          tmp2(4337).presentError(intl.string(tmp2(1115).t.RTSuVn));
          const obj = tmp2(4337);
        }
        c3 = 3;
      } catch (tmp27) {
  ...
  const effect2 = obj7.useEffect(() => {
    if (c2) {
      if (closure_12) {
        if (c7) {
          let obj = {
            headerRight: first ? (() => closure_1_13(guildId(5709).HeaderSubmittingIndicator, {})) : (() => {
                    const obj = { text: null, onPress: null, disabled: null };
                    const intl = guildId(1115).intl;
                    obj.text = intl.string(guildId(1115).t["R3BPH+"]);
                    obj.onPress = onPress;
                    obj.disabled = !closure_1_9;
                    return closure_13(guildId(7484).HeaderActionButton, obj);
                  })
          };
  ...
  const tmp2Result3 = guildId(9199);
  let tmp26 = result1;
  if (result1) {
    tmp26 = !first;
  }
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return closure_13(navigation(9335), obj8);
      } else if (null == stateFromStores1) {
        return closure_13(tmp2(7146).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = closure_13(tmp2(4635).Text, obj9);
            }
          }
        }
        ...
        const items11 = [closure_13(tmp2(7307).TableSwitchRow, obj11), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(14008).GuildBadge, size);
          }
          const items12 = [tmp32Result, tmp29];
          obj13.children = items12;
          tmp31Result = tmp31(tmp2(5057).Stack, obj13);
        }
        obj12.trailing = tmp31Result;
        items11[1] = closure_13(tmp2(5690).TableRow, obj12);
        obj10.children = items11;
        const tmp31Result2 = closure_14(tmp2(5772).TableRowGroup, obj10);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4635).Text, obj17), tmp31Result2, , ];
          ...
          items14[2] = tmp32(tmp2(4635).Text, obj18);
          ...
          items14[3] = tmp32(tmp39(14006), obj19);
          obj15.children = items14;
          let tmp40 = obj15;
        } else {
          const obj20 = { guildId, onUnlockPress: callback2 };
          const items15 = [tmp32(tmp39(17739), obj20), tmp31Result2];
          obj15.children = items15;
          tmp40 = obj15;
        }
        obj14.children = closure_14(tmp2(5057).Stack, tmp40);
        return closure_13(tmp2(8719).Form, obj14);
      }
    } else {
      return closure_13(tmp2(7146).SceneLoadingIndicator, {});
    }
