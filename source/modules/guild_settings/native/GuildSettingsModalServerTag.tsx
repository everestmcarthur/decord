...
// Dependencies: [5, 32, 19, 17, 9157, 1979, 9156, 1074, 8019, 21, 4607, 576, 1483, 9159, 504, 9279, 8251, 9280, 9155, 4304, 1114, 12574, 4500, 5676, 7451, 1484, 4952, 1178, 7113, 9295, 4603, 5739, 7274, 5657, 5025, 13970, 8686, 13968, 17671, 2]
// Exports: default

// Module 17670 (GuildSettingsModalServerTag)
import nativeDefault from "native" /* 576 */;
import Powerups from "Powerups" /* 4500 */;
...
let GuildProfileFetchStatus = fn(9157).GuildProfileFetchStatus;
...
export default function GuildSettingsModalServerTag(guildId) {
  ...
  const result = guildId(9159).canUseMobileServerTagSettings(guildId);
  dependencyMap = result;
  let obj2 = guildId(9159);
  const items = [result1];
  ...
  if (guildSupportsTagsResult) {
    guildSupportsTagsResult = tmp2(8251).guildSupportsTags(stateFromStores);
  ...
  result1 = guildId(9159).isServerTagDraftDirty(stateFromStores1, stateFromStores2);
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
              ...
              if (!ref.current) {
                if (closure_9) {
                  if (dependencyMap) {
                    ...
                    dependencyMap = 1;
                    c3 = 1;
                    const obj7 = { value: tmp2(9280).saveGuildProfile(guildId, { tag: null, badge: null, badgeColorPrimary: null, badgeColorSecondary: null }), done: false };
                    return obj7;
                  }
                }
              }
          ...
          tmp2(4304).presentError(intl.string(tmp2(1114).t.RTSuVn));
          const obj = tmp2(4304);
        }
        c3 = 3;
      } catch (tmp27) {
  ...
  const effect2 = obj7.useEffect(() => {
    if (c2) {
      if (closure_12) {
        if (c7) {
          let obj = {
            headerRight: first ? (() => closure_1_13(guildId(5676).HeaderSubmittingIndicator, {})) : (() => {
                    const obj = { text: null, onPress: null, disabled: null };
                    const intl = guildId(1114).intl;
                    obj.text = intl.string(guildId(1114).t["R3BPH+"]);
                    obj.onPress = onPress;
                    obj.disabled = !closure_1_9;
                    return closure_13(guildId(7451).HeaderActionButton, obj);
                  })
          };
  ...
  const tmp2Result3 = guildId(9159);
  let tmp26 = result1;
  if (result1) {
    tmp26 = !first;
  }
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return closure_13(navigation(9295), obj8);
      } else if (null == stateFromStores1) {
        return closure_13(tmp2(7113).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = closure_13(tmp2(4603).Text, obj9);
            }
          }
        }
        ...
        const items11 = [closure_13(tmp2(7274).TableSwitchRow, obj11), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(13970).GuildBadge, size);
          }
          const items12 = [tmp32Result, tmp29];
          obj13.children = items12;
          tmp31Result = tmp31(tmp2(5025).Stack, obj13);
        }
        obj12.trailing = tmp31Result;
        items11[1] = closure_13(tmp2(5657).TableRow, obj12);
        obj10.children = items11;
        const tmp31Result2 = closure_14(tmp2(5739).TableRowGroup, obj10);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4603).Text, obj17), tmp31Result2, , ];
          ...
          items14[2] = tmp32(tmp2(4603).Text, obj18);
          ...
          items14[3] = tmp32(tmp39(13968), obj19);
          obj15.children = items14;
          let tmp40 = obj15;
        } else {
          const obj20 = { guildId, onUnlockPress: callback2 };
          const items15 = [tmp32(tmp39(17671), obj20), tmp31Result2];
          obj15.children = items15;
          tmp40 = obj15;
        }
        obj14.children = closure_14(tmp2(5025).Stack, tmp40);
        return closure_13(tmp2(8686).Form, obj14);
      }
    } else {
      return closure_13(tmp2(7113).SceneLoadingIndicator, {});
    }
