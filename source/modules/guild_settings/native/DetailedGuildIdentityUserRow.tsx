...
// Dependencies: [19, 17, 1371, 21, 4605, 576, 4757, 4449, 9873, 1178, 504, 8663, 5655, 2]

// Module 11014 (DetailedGuildIdentityUserRow)
...
const memoResult = noop.memo((height) => {
  ...
  if (nickname == null) {
    nickname = tmp2(4449).getGlobalName(user);
...
export default noop.memo(function DetailedGuildIdentityUserRow(arrow) {
  ...
  if (null == stateFromStores) {
    ...
    let tmp2Result = tmp2(tmp(8663).FormRow, obj2);
  } else {
    ...
    tmp2Result = tmp2(tmp(5655).TableRow, obj4);
  }
});
