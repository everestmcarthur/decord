...
// Dependencies: [19, 17, 9303, 21, 4722, 576, 9425, 9426, 14122, 4689, 4718, 1115, 5144, 7235, 7393, 7345, 2]
// Exports: default

// Module 14121 (ServerTagPreviewActionSheet)
import nativeDefault from "native" /* 576 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4689 */;
import GuildProfileActionCreators from "GuildProfileActionCreators" /* 9426 */;
import GuildSettingsServerTagPreviewDefault from "GuildSettingsServerTagPreview" /* 14122 */;
...
export default function ServerTagPreviewActionSheet(guildId) {
  ...
  if (null != guildProfile) {
    ...
    const items1 = [closure_6(tmp2(4718).Text, obj4), ];
    ...
    items1[1] = closure_6(tmp2(5144).Button, obj6);
    obj3.children = items1;
    tmp7 = closure_7(View, obj3);
    tmp8 = closure_6;
  } else {
    tmp7 = closure_6(tmp2(7235).SceneLoadingIndicator, {});
    tmp8 = closure_6;
  }
  ...
  const items2 = [tmp8(guildId(7345).BottomSheetTitleHeader, obj13), tmp7];
  obj7.children = items2;
  return closure_7(guildId(7393).ActionSheet, obj7);
};
