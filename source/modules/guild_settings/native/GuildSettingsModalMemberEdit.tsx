...
// Dependencies: [19, 17, 4566, 1975, 2016, 2021, 2015, 1979, 4212, 1371, 11868, 1074, 21, 4574, 576, 4217, 12, 5618, 1178, 4570, 5619, 1114, 5701, 4284, 7391, 5638, 4418, 9470, 4201, 8626, 4987, 6620, 11869, 11870, 4271, 11875, 1483, 504, 38, 9435, 7325, 7054, 11880, 11882, 5612, 7014, 2]
// Exports: default

// Module 11867 (GuildSettingsModalMemberEdit)
...
import TableRow2 from "TableRow" /* 5619 */;
...
import GuildSettingsModalMembersActionCreatorsDefault from "GuildSettingsModalMembersActionCreators" /* 11869 */;
import GuildDisableCommunicationActionCreators from "GuildDisableCommunicationActionCreators" /* 11870 */;
import TransferOwnershipModalActionCreatorsDefault from "TransferOwnershipModalActionCreators" /* 11875 */;
...
import GuildSettingsModalMembersStore from "GuildSettingsModalMembersStore" /* 11868 */;
...
prototype["updateNavigator"] = function updateNavigator(submitting) {
  ...
  if (!tmp) {
    if (submitting) {
      ...
      fn = self(5638).getHeaderCloseButton(onClose);
      let obj = self(5638);
    }
...
prototype["render"] = function render() {
  ...
  if (null == member) {
    ...
    if (user.bot) {
      ...
      tmp18Result = tmp18(tmp21(9470), obj);
      const tmp21Result = tmp21(9470);
    }
    items[1] = tmp18Result;
    obj2.children = items;
    if (null == member) {
      ...
      if (!bot) {
        ...
        obj4.children = tmp18(tmp19(5619).TableRow, obj5);
        tmp18Result3 = tmp18(tmp19(5701).TableRowGroup, obj4);
      }
      ...
      obj9.label = tmp7;
      obj8.children = tmp18(tmp19(5619).TableRow, obj9);
      const items2 = [tmp18(tmp19(5701).TableRowGroup, obj8), , , , , , ];
      if (!canChangeNick) {
      ...
      if (canChangeNick) {
        ...
        canChangeNick = tmp18(tmp19(6620).TextInput, obj11);
      }
      ...
      if (canKick) {
        ...
        const obj15 = { user: tmp21(4418).getName(user) };
        obj14.label = intl5.formatToPlainString(tmp19(1114).t.yOiJHB, obj15);
        obj14.onPress = self.handleKick;
        obj13.children = tmp18(tmp19(5619).TableRow, obj14);
        canKick = tmp18(tmp19(5701).TableRowGroup, obj13);
        const tmp21Result5 = tmp21(4418);
      }
      items2[4] = canKick;
      if (canBan) {
        ...
        const obj20 = { user: tmp21(4418).getName(user) };
        obj19.label = intl6.formatToPlainString(tmp19(1114).t.TuAZuW, obj20);
        obj19.onPress = self.handleBan;
        obj18.children = tmp18(tmp19(5619).TableRow, obj19);
        canBan = tmp18(tmp19(5701).TableRowGroup, obj18);
        const tmp21Result6 = tmp21(4418);
      }
      items2[5] = canBan;
      items2[6] = tmp18Result3;
      obj7.children = items2;
      obj6.children = tmp16(tmp19(4987).Stack, obj7);
      return tmp18(tmp19(8626).Form, obj6);
    } else {
      const result = tmp19(4201).isMemberCommunicationDisabled(member);
      const TableRowGroup = tmp19(5701).TableRowGroup;
      const obj21 = { hasIcons: false, children: null };
      const TableRow = tmp19(5619).TableRow;
      ...
      if (result) {
        const obj23 = { user: tmp21(4418).getName(user) };
        ...
        const tmp21Result7 = tmp21(4418);
      } else {
        const obj24 = { user: tmp21(4418).getName(user) };
        ...
        const tmp21Result8 = tmp21(4418);
      }
      const tmp19Result = tmp19(4201);
    }
    tmp16 = closure_1_20;
  }
};
GuildSettingsModalMemberEdit.contextType = fn(4284).ThemeContext;
const size = fn(2);
...
export default function MemberModalEdit(onClose) {
  ...
  const tmp = onRemove(5612)(guildId);
  closure_2 = tmp;
    ...
    return {
      ...
      [closure_2_18.MEMBER_KICK]: {
        ...
        render(arg0) {
          ...
          obj.guildId = guildId;
          obj.onKick = onKick;
          return closure_2_19(onRemove(11880), obj);
        }
      },
      [closure_2_18.MEMBER_BAN]: {
        ...
        render(arg0) {
          ...
          obj.guildId = guildId;
          obj.onBan = onBan;
          return closure_2_19(onRemove(11882), obj);
        }
      }
    };
  }, items);
  ...
  return closure_19(onClose(7014).Navigator, obj);
};
