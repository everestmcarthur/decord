...
// Dependencies: [19, 17, 4632, 1976, 2017, 2022, 2016, 1980, 4278, 1372, 11989, 1074, 21, 4640, 576, 4283, 12, 5692, 1177, 4636, 5693, 1115, 5775, 4350, 7491, 5712, 4484, 9592, 4266, 8748, 5060, 6717, 11990, 11991, 4337, 11996, 1484, 504, 38, 9557, 7425, 7154, 12001, 12003, 5686, 7114, 2]
// Exports: default

// Module 11988 (GuildSettingsModalMemberEdit)
...
import TableRow2 from "TableRow" /* 5693 */;
import NavigatorHeader from "NavigatorHeader" /* 5712 */;
import HeaderActionButton from "HeaderActionButton" /* 7491 */;
import useCanToggleCommunicationDisableOnUser from "useCanToggleCommunicationDisableOnUser" /* 9557 */;
import GuildSettingsModalMembersActionCreatorsDefault from "GuildSettingsModalMembersActionCreators" /* 11990 */;
import GuildDisableCommunicationActionCreators from "GuildDisableCommunicationActionCreators" /* 11991 */;
import TransferOwnershipModalActionCreatorsDefault from "TransferOwnershipModalActionCreators" /* 11996 */;
...
import GuildSettingsModalMembersStore from "GuildSettingsModalMembersStore" /* 11989 */;
  ...
  if (props.isEditing) {
    ...
    const valueResult2 = found3.map((children) => {
      ...
      if (tmpResult) {
        ...
        tmpResult = tmp(tmp2(1177).RoleDot, obj3);
      }
...
prototype["updateNavigator"] = function updateNavigator(submitting) {
  ...
  if (!tmp) {
    if (submitting) {
      ...
      fn = self(5712).getHeaderCloseButton(onClose);
      let obj = self(5712);
    }
...
prototype["render"] = function render() {
  ...
  if (null == member) {
    ...
    if (user.bot) {
      ...
      tmp18Result = tmp18(tmp21(9592), obj);
      const tmp21Result = tmp21(9592);
    }
    items[1] = tmp18Result;
    obj2.children = items;
    if (null == member) {
      ...
      if (!bot) {
        ...
        obj4.children = tmp18(tmp19(5693).TableRow, obj5);
        tmp18Result3 = tmp18(tmp19(5775).TableRowGroup, obj4);
      }
      ...
      obj9.label = tmp7;
      obj8.children = tmp18(tmp19(5693).TableRow, obj9);
      const items2 = [tmp18(tmp19(5775).TableRowGroup, obj8), , , , , , ];
      if (!canChangeNick) {
      ...
      if (canChangeNick) {
        ...
        const intl3 = tmp19(1115).intl;
        obj11.label = intl3.string(tmp19(1115).t["621LJD"]);
        if (str == null) {
          str = "";
        }
        obj11.value = str;
        ...
        canChangeNick = tmp18(tmp19(6717).TextInput, obj11);
      }
      ...
      if (canKick) {
        ...
        obj13.children = tmp18(tmp19(5693).TableRow, obj14);
        canKick = tmp18(tmp19(5775).TableRowGroup, obj13);
      ...
      if (canBan) {
        ...
        obj18.children = tmp18(tmp19(5693).TableRow, obj19);
        canBan = tmp18(tmp19(5775).TableRowGroup, obj18);
        const tmp21Result6 = tmp21(4484);
      }
      items2[5] = canBan;
      items2[6] = tmp18Result3;
      obj7.children = items2;
      obj6.children = tmp16(tmp19(5060).Stack, obj7);
      return tmp18(tmp19(8748).Form, obj6);
    } else {
      const result = tmp19(4266).isMemberCommunicationDisabled(member);
      const TableRowGroup = tmp19(5775).TableRowGroup;
      const obj21 = { hasIcons: false, children: null };
      const TableRow = tmp19(5693).TableRow;
...
export default function MemberModalEdit(onClose) {
  ...
  const tmp = onRemove(5686)(guildId);
  closure_2 = tmp;
    ...
    return {
      ...
      [closure_2_18.MEMBER_KICK]: {
        ...
        render(arg0) {
          ...
          obj.guildId = guildId;
          obj.onKick = onKick;
          return closure_2_19(onRemove(12001), obj);
        }
      },
      [closure_2_18.MEMBER_BAN]: {
        ...
        render(arg0) {
          ...
          obj.guildId = guildId;
          obj.onBan = onBan;
          return closure_2_19(onRemove(12003), obj);
        }
      }
    };
  }, items);
  ...
  return closure_19(onClose(7114).Navigator, obj);
};
