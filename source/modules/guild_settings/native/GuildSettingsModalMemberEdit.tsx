...
// Dependencies: [19, 17, 4597, 1975, 2016, 2021, 2015, 1979, 4243, 1371, 11908, 1074, 21, 4605, 576, 4248, 12, 5654, 1178, 4601, 5655, 1114, 5737, 4315, 7429, 5674, 4449, 9508, 4231, 8663, 5023, 6656, 11909, 11910, 4302, 11915, 1483, 504, 38, 9473, 7363, 7092, 11920, 11922, 5648, 7052, 2]
// Exports: default

// Module 11907 (GuildSettingsModalMemberEdit)
...
import TableRow2 from "TableRow" /* 5655 */;
...
import GuildSettingsModalMembersActionCreatorsDefault from "GuildSettingsModalMembersActionCreators" /* 11909 */;
import GuildDisableCommunicationActionCreators from "GuildDisableCommunicationActionCreators" /* 11910 */;
import TransferOwnershipModalActionCreatorsDefault from "TransferOwnershipModalActionCreators" /* 11915 */;
...
import GuildSettingsModalMembersStore from "GuildSettingsModalMembersStore" /* 11908 */;
...
prototype["updateNavigator"] = function updateNavigator(submitting) {
  ...
  if (!tmp) {
    if (submitting) {
      ...
      fn = self(5674).getHeaderCloseButton(onClose);
      let obj = self(5674);
    }
...
prototype["render"] = function render() {
  ...
  if (null == member) {
    ...
    if (user.bot) {
      ...
      tmp18Result = tmp18(tmp21(9508), obj);
      const tmp21Result = tmp21(9508);
    }
    items[1] = tmp18Result;
    obj2.children = items;
    if (null == member) {
      ...
      if (!bot) {
        ...
        obj4.children = tmp18(tmp19(5655).TableRow, obj5);
        tmp18Result3 = tmp18(tmp19(5737).TableRowGroup, obj4);
      }
      ...
      obj9.label = tmp7;
      obj8.children = tmp18(tmp19(5655).TableRow, obj9);
      const items2 = [tmp18(tmp19(5737).TableRowGroup, obj8), , , , , , ];
      if (!canChangeNick) {
      ...
      if (canChangeNick) {
        ...
        canChangeNick = tmp18(tmp19(6656).TextInput, obj11);
      }
      ...
      if (canKick) {
        ...
        const obj15 = { user: tmp21(4449).getName(user) };
        obj14.label = intl5.formatToPlainString(tmp19(1114).t.yOiJHB, obj15);
        obj14.onPress = self.handleKick;
        obj13.children = tmp18(tmp19(5655).TableRow, obj14);
        canKick = tmp18(tmp19(5737).TableRowGroup, obj13);
        const tmp21Result5 = tmp21(4449);
      }
      items2[4] = canKick;
      if (canBan) {
        ...
        const obj20 = { user: tmp21(4449).getName(user) };
        obj19.label = intl6.formatToPlainString(tmp19(1114).t.TuAZuW, obj20);
        obj19.onPress = self.handleBan;
        obj18.children = tmp18(tmp19(5655).TableRow, obj19);
        canBan = tmp18(tmp19(5737).TableRowGroup, obj18);
        const tmp21Result6 = tmp21(4449);
      }
      items2[5] = canBan;
      items2[6] = tmp18Result3;
      obj7.children = items2;
      obj6.children = tmp16(tmp19(5023).Stack, obj7);
      return tmp18(tmp19(8663).Form, obj6);
    } else {
      const result = tmp19(4231).isMemberCommunicationDisabled(member);
      const TableRowGroup = tmp19(5737).TableRowGroup;
      const obj21 = { hasIcons: false, children: null };
      const TableRow = tmp19(5655).TableRow;
      ...
      if (result) {
        const obj23 = { user: tmp21(4449).getName(user) };
        ...
        const tmp21Result7 = tmp21(4449);
      } else {
        const obj24 = { user: tmp21(4449).getName(user) };
        ...
        const tmp21Result8 = tmp21(4449);
      }
      const tmp19Result = tmp19(4231);
    }
    tmp16 = closure_1_20;
  }
};
GuildSettingsModalMemberEdit.contextType = fn(4315).ThemeContext;
const size = fn(2);
...
export default function MemberModalEdit(onClose) {
  ...
  const tmp = onRemove(5648)(guildId);
  closure_2 = tmp;
    ...
    return {
      ...
      [closure_2_18.MEMBER_KICK]: {
        ...
        render(arg0) {
          ...
          obj.guildId = guildId;
          obj.onKick = onKick;
          return closure_2_19(onRemove(11920), obj);
        }
      },
      [closure_2_18.MEMBER_BAN]: {
        ...
        render(arg0) {
          ...
          obj.guildId = guildId;
          obj.onBan = onBan;
          return closure_2_19(onRemove(11922), obj);
        }
      }
    };
  }, items);
  ...
  return closure_19(onClose(7052).Navigator, obj);
};
