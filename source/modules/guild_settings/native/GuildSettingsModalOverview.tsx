...
// Dependencies: [19, 1976, 1958, 2013, 4559, 4278, 4288, 1372, 9196, 1074, 21, 4639, 576, 1115, 4350, 4337, 5709, 7484, 9195, 11467, 1385, 7301, 4984, 5078, 6711, 4792, 5772, 5690, 8099, 17488, 7307, 5770, 5773, 16267, 2025, 17684, 1397, 11485, 1177, 7192, 5634, 8719, 5057, 7147, 1484, 504, 2]
// Exports: default

// Module 17683 (GuildSettingsModalOverview)
...
import openChannelPickerDefault from "openChannelPicker" /* 11467 */;
import ChannelSummariesExperiment from "ChannelSummariesExperiment" /* 11485 */;
import AssetChooserDefault from "AssetChooser" /* 17684 */;
...
class GuildSettingsModalOverview extends PureComponent {
  constructor() {
    ...
    applyArgumentsResult.handleAFKTimeoutChange = function handleAFKTimeoutChange() {
      const obj = applyArgumentsResult(7301);
...
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj4.trailing = closure_1_19(tmp4(5690).TableRow.TrailingText, { text: channelName });
  obj4.onPress = self.handleAfkChannelChange;
  const items = [closure_1_19(tmp4(5690).TableRow, obj4), ];
  ...
  obj5.disabled = tmp15;
  obj5.trailing = closure_1_19(tmp4(5690).TableRow.TrailingText, { text: labelResult });
  obj5.onPress = self.handleAFKTimeoutChange;
  items[1] = closure_1_19(tmp4(5690).TableRow, obj5);
  obj3.children = items;
  return closure_1_20(tmp4(5772).TableRowGroup, obj3);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  const result = tmp(8099).isEligibleForRoleSubscriptionPurchaseSystemMessageSettings(guild);
  ...
  const tmpResult = tmp(8099);
  let result1 = tmp(17488).isPastVcActivityMessagesEnabled(guild.id, "GuildSettingsModalOverview");
  if (!result1) {
  ...
  obj3.trailing = closure_1_19(tmp(5690).TableRow.TrailingText, { text: channelName });
  obj3.onPress = self.handleSystemChannelChange;
  const items = [closure_1_19(tmp(5690).TableRow, obj3), , , , , , , ];
  ...
  items[1] = closure_1_19(tmp(7307).TableSwitchRow, obj4);
  ...
  items[2] = closure_1_19(tmp(7307).TableSwitchRow, obj5);
  ...
  items[3] = closure_1_19(tmp(7307).TableSwitchRow, obj6);
  ...
  items[4] = closure_1_19(tmp(7307).TableSwitchRow, obj7);
  if (hasFlagResult) {
    ...
    hasFlagResult = tmp16(tmp(7307).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = tmp16(tmp(7307).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = tmp16(tmp(7307).TableSwitchRow, obj10);
    const tmpResult22 = tmp(1385);
  }
  items[7] = result1;
  obj2.children = items;
  return tmp15(tmp(5772).TableRowGroup, obj2);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  if (obj.getMobileBoostProgressBarEnabled("GuildSettingsModalOverview")) {
    ...
    obj2.children = closure_1_19(tmp(7307).TableSwitchRow, obj3);
    tmp3 = closure_1_19(tmp(5772).TableRowGroup, obj2);
  }
  return tmp3;
};
...
prototype["renderSummaries"] = function renderSummaries() {
  ...
  if (obj.canGuildUseConversationSummaries(guild, false)) {
    ...
    obj4.children = closure_1_19(tmp(7307).TableSwitchRow, obj5);
    return closure_1_19(tmp(5772).TableRowGroup, obj4);
  } else {
    return null;
  }
...
GuildSettingsModalOverview.contextType = fn(4350).ThemeContext;
const size = fn(2);
