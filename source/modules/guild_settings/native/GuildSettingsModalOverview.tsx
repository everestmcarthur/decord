...
// Dependencies: [19, 1976, 1958, 2013, 4557, 4276, 4286, 1372, 9207, 1074, 21, 4638, 576, 1115, 4348, 4335, 5710, 7487, 9206, 11475, 1385, 7304, 4983, 5079, 6714, 4791, 5773, 5691, 8108, 17544, 7310, 5771, 5774, 16287, 2025, 17740, 1397, 11493, 1177, 7195, 5635, 8728, 5058, 7150, 1484, 504, 2]
// Exports: default

// Module 17739 (GuildSettingsModalOverview)
...
import openChannelPickerDefault from "openChannelPicker" /* 11475 */;
import ChannelSummariesExperiment from "ChannelSummariesExperiment" /* 11493 */;
import AssetChooserDefault from "AssetChooser" /* 17740 */;
...
class GuildSettingsModalOverview extends PureComponent {
  constructor() {
    ...
    applyArgumentsResult.handleAFKTimeoutChange = function handleAFKTimeoutChange() {
      const obj = applyArgumentsResult(7304);
...
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj4.trailing = closure_1_19(tmp4(5691).TableRow.TrailingText, { text: channelName });
  obj4.onPress = self.handleAfkChannelChange;
  const items = [closure_1_19(tmp4(5691).TableRow, obj4), ];
  ...
  obj5.disabled = tmp15;
  obj5.trailing = closure_1_19(tmp4(5691).TableRow.TrailingText, { text: labelResult });
  obj5.onPress = self.handleAFKTimeoutChange;
  items[1] = closure_1_19(tmp4(5691).TableRow, obj5);
  obj3.children = items;
  return closure_1_20(tmp4(5773).TableRowGroup, obj3);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  const result = tmp(8108).isEligibleForRoleSubscriptionPurchaseSystemMessageSettings(guild);
  ...
  let result1 = tmp(17544).isPastVcActivityMessagesEnabled(guild.id, "GuildSettingsModalOverview");
  if (!result1) {
  ...
  obj3.trailing = closure_1_19(tmp(5691).TableRow.TrailingText, { text: channelName });
  obj3.onPress = self.handleSystemChannelChange;
  const items = [closure_1_19(tmp(5691).TableRow, obj3), , , , , , , ];
  ...
  items[1] = closure_1_19(tmp(7310).TableSwitchRow, obj4);
  ...
  items[2] = closure_1_19(tmp(7310).TableSwitchRow, obj5);
  ...
  items[3] = closure_1_19(tmp(7310).TableSwitchRow, obj6);
  ...
  items[4] = closure_1_19(tmp(7310).TableSwitchRow, obj7);
  if (hasFlagResult) {
    ...
    hasFlagResult = tmp16(tmp(7310).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = tmp16(tmp(7310).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = tmp16(tmp(7310).TableSwitchRow, obj10);
    const tmpResult22 = tmp(1385);
  }
  items[7] = result1;
  obj2.children = items;
  return tmp15(tmp(5773).TableRowGroup, obj2);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  if (obj.getMobileBoostProgressBarEnabled("GuildSettingsModalOverview")) {
    ...
    obj2.children = closure_1_19(tmp(7310).TableSwitchRow, obj3);
    tmp3 = closure_1_19(tmp(5773).TableRowGroup, obj2);
  }
  return tmp3;
};
...
prototype["renderSummaries"] = function renderSummaries() {
  ...
  if (obj.canGuildUseConversationSummaries(guild, false)) {
    ...
    obj4.children = closure_1_19(tmp(7310).TableSwitchRow, obj5);
    return closure_1_19(tmp(5773).TableRowGroup, obj4);
  } else {
    return null;
  }
...
GuildSettingsModalOverview.contextType = fn(4348).ThemeContext;
const size = fn(2);
