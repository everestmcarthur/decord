...
// Dependencies: [19, 1975, 1957, 2012, 4527, 4245, 4255, 1371, 9156, 1074, 21, 4607, 576, 1114, 4317, 4304, 5676, 7451, 9155, 11425, 1384, 7268, 4952, 5046, 6678, 4760, 5739, 5657, 8067, 17419, 7274, 5737, 5740, 16228, 2024, 17616, 1396, 11443, 1178, 7159, 5601, 8686, 5025, 7114, 1483, 504, 2]
// Exports: default

// Module 17615 (GuildSettingsModalOverview)
...
import GuildProfileLimits from "GuildProfileLimits" /* 5601 */;
...
import openChannelPickerDefault from "openChannelPicker" /* 11425 */;
import ChannelSummariesExperiment from "ChannelSummariesExperiment" /* 11443 */;
import AssetChooserDefault from "AssetChooser" /* 17616 */;
...
class GuildSettingsModalOverview extends PureComponent {
  constructor() {
    ...
    applyArgumentsResult.handleAFKTimeoutChange = function handleAFKTimeoutChange() {
      const obj = applyArgumentsResult(7268);
...
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj4.trailing = closure_1_19(tmp4(5657).TableRow.TrailingText, { text: channelName });
  obj4.onPress = self.handleAfkChannelChange;
  const items = [closure_1_19(tmp4(5657).TableRow, obj4), ];
  ...
  obj5.disabled = tmp15;
  obj5.trailing = closure_1_19(tmp4(5657).TableRow.TrailingText, { text: labelResult });
  obj5.onPress = self.handleAFKTimeoutChange;
  items[1] = closure_1_19(tmp4(5657).TableRow, obj5);
  obj3.children = items;
  return closure_1_20(tmp4(5739).TableRowGroup, obj3);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  const result = tmp(8067).isEligibleForRoleSubscriptionPurchaseSystemMessageSettings(guild);
  ...
  const tmpResult = tmp(8067);
  let result1 = tmp(17419).isPastVcActivityMessagesEnabled(guild.id, "GuildSettingsModalOverview");
  if (!result1) {
  ...
  obj3.trailing = closure_1_19(tmp(5657).TableRow.TrailingText, { text: channelName });
  obj3.onPress = self.handleSystemChannelChange;
  const items = [closure_1_19(tmp(5657).TableRow, obj3), , , , , , , ];
  ...
  items[1] = closure_1_19(tmp(7274).TableSwitchRow, obj4);
  ...
  items[2] = closure_1_19(tmp(7274).TableSwitchRow, obj5);
  ...
  items[3] = closure_1_19(tmp(7274).TableSwitchRow, obj6);
  ...
  items[4] = closure_1_19(tmp(7274).TableSwitchRow, obj7);
  if (hasFlagResult) {
    ...
    hasFlagResult = tmp16(tmp(7274).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = tmp16(tmp(7274).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = tmp16(tmp(7274).TableSwitchRow, obj10);
    const tmpResult22 = tmp(1384);
  }
  items[7] = result1;
  obj2.children = items;
  return tmp15(tmp(5739).TableRowGroup, obj2);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  if (obj.getMobileBoostProgressBarEnabled("GuildSettingsModalOverview")) {
    ...
    obj2.children = closure_1_19(tmp(7274).TableSwitchRow, obj3);
    tmp3 = closure_1_19(tmp(5739).TableRowGroup, obj2);
  }
  return tmp3;
};
...
prototype["renderSummaries"] = function renderSummaries() {
  ...
  if (obj.canGuildUseConversationSummaries(guild, false)) {
    ...
    obj4.children = closure_1_19(tmp(7274).TableSwitchRow, obj5);
    return closure_1_19(tmp(5739).TableRowGroup, obj4);
  } else {
    return null;
  }
