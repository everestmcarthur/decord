...
// Dependencies: [19, 1976, 1958, 2013, 4559, 4278, 4288, 1372, 9218, 1074, 21, 4640, 576, 1115, 4350, 4337, 5712, 7491, 9217, 11483, 1385, 7308, 4985, 5081, 6717, 4793, 5775, 5693, 8128, 17585, 7314, 5773, 5776, 16317, 2025, 17781, 1397, 11501, 1177, 7199, 5637, 8748, 5060, 7154, 1484, 504, 2]
// Exports: default

// Module 17780 (GuildSettingsModalOverview)
...
import openChannelPickerDefault from "openChannelPicker" /* 11483 */;
import ChannelSummariesExperiment from "ChannelSummariesExperiment" /* 11501 */;
import AssetChooserDefault from "AssetChooser" /* 17781 */;
...
class GuildSettingsModalOverview extends PureComponent {
  constructor() {
    ...
    applyArgumentsResult.handleAFKTimeoutChange = function handleAFKTimeoutChange() {
      const obj = applyArgumentsResult(7308);
...
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj4.trailing = closure_1_19(tmp4(5693).TableRow.TrailingText, { text: channelName });
  obj4.onPress = self.handleAfkChannelChange;
  const items = [closure_1_19(tmp4(5693).TableRow, obj4), ];
  ...
  obj5.disabled = tmp15;
  obj5.trailing = closure_1_19(tmp4(5693).TableRow.TrailingText, { text: labelResult });
  obj5.onPress = self.handleAFKTimeoutChange;
  items[1] = closure_1_19(tmp4(5693).TableRow, obj5);
  obj3.children = items;
  return closure_1_20(tmp4(5775).TableRowGroup, obj3);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  const result = tmp(8128).isEligibleForRoleSubscriptionPurchaseSystemMessageSettings(guild);
  ...
  const tmpResult = tmp(8128);
  let result1 = tmp(17585).isPastVcActivityMessagesEnabled(guild.id, "GuildSettingsModalOverview");
  if (!result1) {
  ...
  obj3.trailing = closure_1_19(tmp(5693).TableRow.TrailingText, { text: channelName });
  obj3.onPress = self.handleSystemChannelChange;
  const items = [closure_1_19(tmp(5693).TableRow, obj3), , , , , , , ];
  ...
  items[1] = closure_1_19(tmp(7314).TableSwitchRow, obj4);
  ...
  items[2] = closure_1_19(tmp(7314).TableSwitchRow, obj5);
  ...
  items[3] = closure_1_19(tmp(7314).TableSwitchRow, obj6);
  ...
  items[4] = closure_1_19(tmp(7314).TableSwitchRow, obj7);
  if (hasFlagResult) {
    ...
    hasFlagResult = tmp16(tmp(7314).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = tmp16(tmp(7314).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = tmp16(tmp(7314).TableSwitchRow, obj10);
    const tmpResult22 = tmp(1385);
  }
  items[7] = result1;
  obj2.children = items;
  return tmp15(tmp(5775).TableRowGroup, obj2);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  if (obj.getMobileBoostProgressBarEnabled("GuildSettingsModalOverview")) {
    ...
    obj2.children = closure_1_19(tmp(7314).TableSwitchRow, obj3);
    tmp3 = closure_1_19(tmp(5775).TableRowGroup, obj2);
  }
  return tmp3;
};
...
prototype["renderSummaries"] = function renderSummaries() {
  ...
  if (obj.canGuildUseConversationSummaries(guild, false)) {
    ...
    obj4.children = closure_1_19(tmp(7314).TableSwitchRow, obj5);
    return closure_1_19(tmp(5775).TableRowGroup, obj4);
  } else {
    return null;
  }
