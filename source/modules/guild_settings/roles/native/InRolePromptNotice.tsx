...
// Dependencies: [19, 17, 1074, 21, 4638, 576, 1385, 17842, 1177, 9765, 4634, 1115, 2]
// Exports: default
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      ...
      items1[1] = tmp6(tmp(4634).Text, obj6);
      obj2.children = items1;
      tmp4Result = tmp4(tmp5, obj2);
    }
    isRolePowerfulResult = tmp(17842).isRolePowerful(role);
  }
};
