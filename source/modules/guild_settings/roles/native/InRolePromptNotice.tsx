...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 1385, 17786, 1177, 9757, 4635, 1115, 2]
// Exports: default

// Module 17785 (InRolePromptNotice)
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      ...
      items1[1] = tmp6(tmp(4635).Text, obj6);
      obj2.children = items1;
      tmp4Result = tmp4(tmp5, obj2);
    }
    isRolePowerfulResult = tmp(17786).isRolePowerful(role);
  }
};
