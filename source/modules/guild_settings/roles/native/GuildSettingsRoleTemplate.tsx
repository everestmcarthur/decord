...
// Dependencies: [32, 19, 17, 4714, 1980, 17952, 1074, 21, 4722, 576, 7139, 1478, 5129, 4458, 1241, 4902, 8510, 5292, 4718, 11005, 1177, 11804, 5144, 1115, 2]
// Exports: default

// Module 17956 (GuildSettingsRoleTemplate)
...
import PaginationDefault from "Pagination" /* 11005 */;
...
export default function GuildSettingsRoleTemplate(arg0) {
  ...
  let obj6 = { accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: closure_14(_modDef8510, { maximumValue: values.length - 1, minimumTrackTintColor: values[value].color, minimumValue: constants.COSMETIC, onSlidingComplete: updateLevel, style: tmp.slider, thumbTintColor: values[value].color, value, accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no" }) };
      ...
      renderItem(item) {
        ...
        if (null != contentPrefaceResult) {
          ...
          if ("" !== contentPrefaceResult) {
            ...
            tmp3Result = tmp3(tmp10(4718).Text, obj6);
          }
        }
        ...
        obj8.children = item.contents().map((children, index) => {
          ...
          const items = [closure_3_14(native.Icon, { source: _modDef11804, size: native.IconSizes.MEDIUM, color: nativeDefault.unsafe_rawColors.GREEN_360 }), closure_3_14(Text_Text.Text, { style: closure_3.templateContentText, variant: "text-sm/medium", children })];
          obj.children = items;
