...
// Dependencies: [32, 19, 17, 4630, 1980, 17818, 1074, 21, 4638, 576, 7053, 1478, 5045, 4374, 1241, 4818, 8408, 5208, 4634, 10903, 1177, 11706, 5060, 1115, 2]
// Exports: default
      ...
      renderItem(item) {
        ...
        if (null != contentPrefaceResult) {
          ...
          if ("" !== contentPrefaceResult) {
            ...
            tmp3Result = tmp3(tmp10(4634).Text, obj6);
          }
        }
