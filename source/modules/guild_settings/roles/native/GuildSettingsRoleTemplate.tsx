...
// Dependencies: [32, 19, 17, 4632, 1980, 17859, 1074, 21, 4640, 576, 7057, 1478, 5047, 4376, 1241, 4820, 8427, 5210, 4636, 10911, 1177, 11714, 5062, 1115, 2]
// Exports: default

// Module 17863 (GuildSettingsRoleTemplate)
...
import PaginationDefault from "Pagination" /* 10911 */;
...
export default function GuildSettingsRoleTemplate(arg0) {
  ...
  let obj6 = { accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: closure_14(_modDef8427, { maximumValue: values.length - 1, minimumTrackTintColor: values[value].color, minimumValue: constants.COSMETIC, onSlidingComplete: updateLevel, style: tmp.slider, thumbTintColor: values[value].color, value, accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no" }) };
      ...
      renderItem(item) {
        ...
        if (null != contentPrefaceResult) {
          ...
          if ("" !== contentPrefaceResult) {
            ...
            tmp3Result = tmp3(tmp10(4636).Text, obj6);
          }
        }
        ...
        obj8.children = item.contents().map((children, index) => {
          ...
          const items = [closure_3_14(native.Icon, { source: _modDef11714, size: native.IconSizes.MEDIUM, color: nativeDefault.unsafe_rawColors.GREEN_360 }), closure_3_14(Text_Text.Text, { style: closure_3.templateContentText, variant: "text-sm/medium", children })];
          obj.children = items;
