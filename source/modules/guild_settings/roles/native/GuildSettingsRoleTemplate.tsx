...
// Dependencies: [32, 19, 17, 4566, 1979, 17643, 1074, 21, 4574, 576, 6959, 1477, 4976, 4310, 1242, 4754, 8306, 5137, 4570, 10789, 1178, 11595, 4989, 1114, 2]
// Exports: default

// Module 17647 (GuildSettingsRoleTemplate)
...
import PaginationDefault from "Pagination" /* 10789 */;
...
export default function GuildSettingsRoleTemplate(arg0) {
  ...
  let obj6 = { accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: closure_14(_modDef8306, { maximumValue: values.length - 1, minimumTrackTintColor: values[value].color, minimumValue: constants.COSMETIC, onSlidingComplete: updateLevel, style: tmp.slider, thumbTintColor: values[value].color, value, accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no" }) };
      ...
      renderItem(item) {
        ...
        if (null != contentPrefaceResult) {
          ...
          if ("" !== contentPrefaceResult) {
            ...
            tmp3Result = tmp3(tmp10(4570).Text, obj6);
          }
        }
        ...
        obj8.children = item.contents().map((children, index) => {
          ...
          const items = [closure_3_14(native.Icon, { source: _modDef11595, size: native.IconSizes.MEDIUM, color: nativeDefault.unsafe_rawColors.GREEN_360 }), closure_3_14(Text_Text.Text, { style: closure_3.templateContentText, variant: "text-sm/medium", children })];
          obj.children = items;
