...
// Dependencies: [32, 19, 17, 4598, 1979, 17693, 1074, 21, 4606, 576, 7016, 1477, 5013, 4343, 1242, 4786, 8364, 5174, 4602, 10846, 1178, 11657, 5026, 1114, 2]
// Exports: default

// Module 17697 (GuildSettingsRoleTemplate)
...
import PaginationDefault from "Pagination" /* 10846 */;
...
export default function GuildSettingsRoleTemplate(arg0) {
  ...
  let obj6 = { accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: closure_14(_modDef8364, { maximumValue: values.length - 1, minimumTrackTintColor: values[value].color, minimumValue: constants.COSMETIC, onSlidingComplete: updateLevel, style: tmp.slider, thumbTintColor: values[value].color, value, accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no" }) };
      ...
      renderItem(item) {
        ...
        if (null != contentPrefaceResult) {
          ...
          if ("" !== contentPrefaceResult) {
            ...
            tmp3Result = tmp3(tmp10(4602).Text, obj6);
          }
        }
        ...
        obj8.children = item.contents().map((children, index) => {
          ...
          const items = [closure_3_14(native.Icon, { source: _modDef11657, size: native.IconSizes.MEDIUM, color: nativeDefault.unsafe_rawColors.GREEN_360 }), closure_3_14(Text_Text.Text, { style: closure_3.templateContentText, variant: "text-sm/medium", children })];
          obj.children = items;
