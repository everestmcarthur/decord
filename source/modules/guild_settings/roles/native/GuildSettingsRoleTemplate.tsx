...
// Dependencies: [32, 19, 17, 4631, 1980, 17762, 1074, 21, 4639, 576, 7050, 1478, 5046, 4376, 1241, 4819, 8399, 5207, 4635, 10890, 1177, 11698, 5059, 1115, 2]
// Exports: default
      ...
      renderItem(item) {
        ...
        if (null != contentPrefaceResult) {
          ...
          if ("" !== contentPrefaceResult) {
            ...
            tmp3Result = tmp3(tmp10(4635).Text, obj6);
          }
        }
