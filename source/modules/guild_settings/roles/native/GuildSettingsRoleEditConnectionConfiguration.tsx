...
// Dependencies: [32, 19, 17, 1074, 5493, 21, 4639, 576, 4574, 11697, 1177, 1397, 4491, 5690, 1115, 5207, 5765, 7307, 17792, 1364, 4635, 5368, 5772, 2]
// Exports: default
...
function NumericalConfigRule(existingPendingConfiguration) {
  ...
  if (undefined !== fieldTextHook) {
    ...
    if (undefined !== fieldText) {
      ...
      items1[1] = onInputValueChange(tmp(4635).Text, obj7);
    ...
    return onInputValueChange(tmp(7307).TableSwitchRow, obj8, metadataField);
  }
}
