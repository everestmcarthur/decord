...
// Dependencies: [5, 32, 19, 17, 1976, 2016, 1372, 9302, 17952, 1074, 21, 4722, 5852, 576, 1241, 4902, 4718, 1115, 17950, 504, 38, 4366, 1484, 6818, 5794, 5690, 4419, 17949, 4689, 16548, 1897, 5142, 6799, 5857, 5775, 14813, 1092, 5144, 17956, 17957, 9301, 17958, 7177, 5129, 5138, 7235, 5161, 7196, 2]
// Exports: default

// Module 17951 (GuildSettingsRoleCreateModal)
...
import GuildSettingsRoleCreateModalActionCreatorsDefault from "GuildSettingsRoleCreateModalActionCreators" /* 17950 */;
...
function RoleCreateScene() {
  ...
  const callback1 = onSelect.useCallback(asyncGeneratorStep(async () => {
    ...
    await tmp3(5690).createRole(stateFromStores.id, str, num5);
    if (1 === tmp7) {
      c2 = 0;
      closure_129_5(false);
      const result = tmp3(4419).roleCreateFailedToast();
      c4 = 3;
      tmp3(4419);
    } else if (arg0 === 1) {
      c4 = 3;
      ...
      const result1 = GuildSettingsStore.addConditionalChangeListener(() => {
        ...
        if (null != selectedRoleId) {
          if (null != role) {
            if (null != guild) {
              closure_0(4419).roleCreatedToast();
              const obj5 = closure_0(4419);
              const tmp13 = closure_0;
              closure_0(17949).setRoleJustCreated(true);
              ...
              const merged = Object.assign(tmp13(4902).collectGuildAnalyticsMetadata(guild.id));
  ...
  const callback2 = onSelect.useCallback(() => {
    React6.dismiss();
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16548, dependencyMap.paths), "RoleColorPicker", { color, onSelect });
  }, items3);
...
const GuildSettingsRoleConstants = fn(17952);
...
export default function GuildSettingsRoleCreateModal() {
  ...
  return closure_21(stateFromStores(7196).Navigator, { screens, initialRouteName: obj7.STEP_DISPLAY });
};
