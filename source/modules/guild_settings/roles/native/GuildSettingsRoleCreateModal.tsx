...
// Dependencies: [5, 32, 19, 17, 1976, 2016, 1372, 9196, 17762, 1074, 21, 4639, 5767, 576, 1241, 4819, 4635, 1115, 17760, 504, 38, 4283, 1484, 6730, 5709, 5605, 4337, 17759, 4606, 16401, 1897, 5057, 6711, 5772, 5690, 14695, 1092, 5059, 17766, 17767, 9195, 17768, 7088, 5046, 5055, 7146, 5076, 7107, 2]
// Exports: default

// Module 17761 (GuildSettingsRoleCreateModal)
...
import GuildSettingsRoleCreateModalActionCreatorsDefault from "GuildSettingsRoleCreateModalActionCreators" /* 17760 */;
...
function RoleCreateScene() {
  ...
  const callback1 = onSelect.useCallback(asyncGeneratorStep(async () => {
    ...
    await tmp3(5605).createRole(stateFromStores.id, str, num5);
    if (1 === tmp7) {
      c2 = 0;
      closure_129_5(false);
        ...
        if (null != selectedRoleId) {
          if (null != role) {
            if (null != guild) {
              ...
              closure_0(17759).setRoleJustCreated(true);
              ...
              const merged = Object.assign(tmp13(4819).collectGuildAnalyticsMetadata(guild.id));
  ...
  const callback2 = onSelect.useCallback(() => {
    React6.dismiss();
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16401, dependencyMap.paths), "RoleColorPicker", { color, onSelect });
  }, items3);
...
export default function GuildSettingsRoleCreateModal() {
  ...
  return closure_21(stateFromStores(7107).Navigator, { screens, initialRouteName: obj7.STEP_DISPLAY });
};
