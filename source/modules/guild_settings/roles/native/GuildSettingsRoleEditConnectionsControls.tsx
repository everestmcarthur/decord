...
// Dependencies: [19, 17, 7324, 17953, 1074, 5578, 21, 4722, 576, 5577, 12, 6803, 4718, 1115, 5142, 5292, 2025, 5855, 5858, 17981, 5144, 11456, 4689, 17983, 1897, 17984, 17986, 504, 8831, 17967, 2]
// Exports: default
...
function HeaderSection(arg0) {
  ...
  if (hasConnections) {
    ...
    obj6.children = tmp13(tmp10(4718).Text, obj7);
    tmp13Result = tmp13(tmp10(5292).PressableOpacity, obj6);
  }
...
function AndOrRadios(setPendingRoleConfigurations) {
  ...
  if (ConnectionsUtils.ConnectionConfigurationRuleOperator.OR === ConnectionsUtils.ConnectionConfigurationRuleOperator.AND) {
    ...
    const obj3 = { value: tmp(5577).ConnectionConfigurationRuleOperator.OR, label: null, disabled: null };
    ...
    obj3.disabled = tmp11;
    const items2 = [closure_1_10(tmp(5858).TableRadioRow, obj3), ];
    const obj4 = { value: tmp(5577).ConnectionConfigurationRuleOperator.AND, label: null, disabled: null };
    const intl3 = tmp(1115).intl;
    obj4.label = intl3.string(tmp(1115).t.gHXS9A);
    obj4.disabled = locked;
    items2[1] = closure_1_10(tmp(5858).TableRadioRow, obj4);
    obj2.children = items2;
    return closure_1_11(tmp(5855).TableRadioGroup, obj2);
  }
}
