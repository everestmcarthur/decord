...
// Dependencies: [4808, 17701, 1896, 2]

// Module 17700 (GuildSettingsRoleCreateModalActionCreators)
...
export default {
  open() {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(17701, dependencyMap.paths), undefined, GUILD_SETTINGS_ROLE_CREATE_MODAL_KEY);
  },
  close() {
