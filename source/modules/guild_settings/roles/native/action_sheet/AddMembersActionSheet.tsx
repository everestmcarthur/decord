...
// Dependencies: [32, 19, 17, 17859, 21, 4640, 576, 4358, 11100, 5705, 7095, 4627, 1177, 4351, 1115, 8873, 9906, 5607, 17864, 11, 9911, 7425, 7264, 7263, 5062, 9217, 4607, 4636, 2]
// Exports: default

// Module 17865 (action_sheet/AddMembersActionSheet)
...
const MAX_BULK_ROLE_MEMBERS_ADD = fn(17859).MAX_BULK_ROLE_MEMBERS_ADD;
const jsxProd = fn(21);
