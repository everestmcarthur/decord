...
// Dependencies: [32, 19, 17, 17724, 21, 4636, 576, 4355, 11074, 5698, 7084, 4623, 1176, 4348, 1114, 9003, 9885, 5600, 17729, 11, 9890, 7414, 7253, 7252, 5056, 9192, 4603, 4632, 2]
// Exports: default

// Module 17730 (action_sheet/AddMembersActionSheet)
...
const MAX_BULK_ROLE_MEMBERS_ADD = fn(17724).MAX_BULK_ROLE_MEMBERS_ADD;
const jsxProd = fn(21);
