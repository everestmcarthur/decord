...
// Dependencies: [32, 19, 17, 7142, 1074, 21, 4574, 576, 4272, 5611, 1114, 17648, 7325, 504, 4918, 9095, 1178, 1242, 4541, 17649, 1896, 10974, 8113, 6630, 7064, 4529, 4570, 5619, 11236, 2]
// Exports: default

// Module 17670 (GuildSettingsRoleMembers)
...
function onMembersLoadFail() {
  const obj2 = { key: "ERROR_OCCURRED_TRY_AGAIN", icon: _modDef5611, content: null };
...
export default function GuildSettingsRoleMembers(guild) {
    ...
    if (found.length !== arr.length) {
      ...
      obj2.onConfirm = function onConfirm() {
        ...
        GuildSettingsActionCreatorsDefault.updateMemberRoles(guild.id, name.id, found, [], items).catch(() => {
          ...
          obj2.icon = found(5611);
          found(4272).open(obj2);
        });
      };
  ...
  const callback1 = found.useCallback(() => {
    ...
    obj2.openLazy(asyncRequireImpl(17649, dependencyMap.paths), "role-add-members-" + guild.id + "-" + role.id, { guild, role });
  }, items3);
