...
// Function ID: 17573
// Name: AuditLogUtils
// Dependencies: [5473, 7114, 4761, 1962, 5516, 17571, 1957, 2015, 4222, 1371, 17570, 1074, 1964, 11893, 7115, 1963, 3, 4603, 1114, 8420, 11, 17573, 1086, 1384, 4727, 1894, 4418, 14, 1091, 9854, 17574, 4255, 4166, 2]
    ...
    if (tmp.CHANNEL !== targetType) {
      if (tmp.CHANNEL_OVERWRITE !== targetType) {
        if (tmp.USER === targetType) {
          ...
          const obj23 = {};
          obj23[__3TkD(8420).GuildInviteFlags.IS_GUEST_INVITE] = __3TkD(1114).t.XYZMbL;
          __3TkD = obj23;
      ...
      if (null != timeAndUnit.unit) {
        if (null != timeAndUnit.time) {
          if (timeAndUnit.unit in obj) {
            ...
            if (unit2 === tmp25(4603).TimeUnits.SECONDS) {
              const _Math2 = Math;
      ...
      if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_UPDATE !== action) {
        if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_DELETE === action) {
          ...
          if (null == found2) {
            ...
            } else if (tmp198(17573).GuildFeedItemTypes.FORUM_POST === newValue) {
    ...
    if (null != tmp3) {
      ...
      if (null != result1.options) {
        ...
        if (null != result1.options.event_exception_id) {
          ...
          let obj5 = closure_0(4255);
          let tmp244 = items(4166);
          let str5;
          if (found20 != null) {
                                        ...
                                        if (tmp323.AUTO_MODERATION_REMOVE_ALLOW_LIST !== key19) {
                                          if (tmp323.AUTO_MODERATION_EXEMPT_CHANNELS === key19) {
                                            ...
                                            if (null != newValue.oldValue) {
                                              ...
                                              oldValue = obj2.dateFormat(_modDef4166(date1), "LLLL");
                                            }
                                            if (!oldValue) {
                                              oldValue = newValue.oldValue;
                                            }
