...
// Function ID: 17748
// Name: AuditLogUtils
// Dependencies: [5545, 7210, 4825, 1963, 5588, 17746, 1958, 2016, 4286, 1372, 17745, 1074, 1965, 12005, 7211, 1964, 3, 4667, 1115, 8522, 11, 17748, 1086, 1385, 4791, 1895, 4482, 14, 1092, 9962, 17749, 4319, 4229, 2]
...
import GuildFeedItemTypes from "GuildFeedItemTypes" /* 17748 */;
import AutomodRuleUtils from "AutomodRuleUtils" /* 17749 */;
      ...
      if (null != timeAndUnit.unit) {
        if (null != timeAndUnit.time) {
          if (timeAndUnit.unit in obj) {
            ...
            if (unit2 === tmp25(4667).TimeUnits.SECONDS) {
              const _Math2 = Math;
      ...
      if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_UPDATE !== action) {
        if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_DELETE === action) {
          ...
          if (null == found2) {
            ...
            } else if (tmp198(17748).GuildFeedItemTypes.FORUM_POST === newValue) {
                      ...
                      if (tmp2.GUILD_SCHEDULED_EVENT !== targetType) {
                        if (tmp2.GUILD_SCHEDULED_EVENT_EXCEPTION !== targetType) {
                          if (tmp2.THREAD === targetType) {
                            ...
                            let tmp10 = null;
                            if (tmp9) {
                              tmp10 = ((channel) => result3(4791).computeChannelName(channel, user, closure_1_12, true))(tmp7);
                            }
                            let tmp11 = tmp10;
                            if (null == tmp10) {
                              tmp11 = tmp10;
