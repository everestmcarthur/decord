...
// Function ID: 17654
// Name: AuditLogUtils
// Dependencies: [5540, 7203, 4823, 1962, 5583, 17652, 1957, 2015, 4285, 1371, 17651, 1074, 1964, 11993, 7204, 1963, 3, 4665, 1114, 8510, 11, 17654, 1086, 1384, 4789, 1894, 4481, 14, 1091, 9952, 17655, 4318, 4228, 2]
...
import GuildFeedItemTypes from "GuildFeedItemTypes" /* 17654 */;
import AutomodRuleUtils from "AutomodRuleUtils" /* 17655 */;
...
let items = [fn(4665).TimeUnits.DAYS, fn(4665).TimeUnits.HOURS, fn(4665).TimeUnits.MINUTES, fn(4665).TimeUnits.SECONDS];
      ...
      if (null != timeAndUnit.unit) {
        if (null != timeAndUnit.time) {
          if (timeAndUnit.unit in obj) {
            ...
            if (unit2 === tmp25(4665).TimeUnits.SECONDS) {
              const _Math2 = Math;
      ...
      if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_UPDATE !== action) {
        if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_DELETE === action) {
          ...
          if (null == found2) {
            ...
            } else if (tmp198(17654).GuildFeedItemTypes.FORUM_POST === newValue) {
    ...
    if (constants2.GUILD !== targetType) {
      ...
      if (tmp2.GUILD_HOME !== targetType) {
        ...
        if (tmp2.GUILD_PROFILE !== targetType) {
                      ...
                      if (tmp2.GUILD_SCHEDULED_EVENT !== targetType) {
                        if (tmp2.GUILD_SCHEDULED_EVENT_EXCEPTION !== targetType) {
                          if (tmp2.THREAD === targetType) {
                            ...
                            let tmp10 = null;
                            if (tmp9) {
                              tmp10 = ((channel) => result3(4789).computeChannelName(channel, user, closure_1_12, true))(tmp7);
                            }
                            let tmp11 = tmp10;
                            if (null == tmp10) {
                              tmp11 = tmp10;
          ...
          let tmp208 = null;
          if (tmp207) {
            tmp208 = ((channel) => result3(4789).computeChannelName(channel, user, closure_1_12, true))(tmp205);
          }
          let tmp209 = tmp208;
          if (null == tmp208) {
            tmp209 = tmp208;
