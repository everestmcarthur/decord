...
// Function ID: 17692
// Name: AuditLogUtils
// Dependencies: [5544, 7207, 4826, 1963, 5587, 17690, 1958, 2016, 4288, 1372, 17689, 1074, 1965, 11997, 7208, 1964, 3, 4668, 1115, 8513, 11, 17692, 1086, 1385, 4792, 1895, 4484, 14, 1092, 9954, 17693, 4321, 4231, 2]
...
import AutomodRuleUtils from "AutomodRuleUtils" /* 17693 */;
      ...
      if (null != timeAndUnit.unit) {
        if (null != timeAndUnit.time) {
          if (timeAndUnit.unit in obj) {
            ...
            if (unit2 === tmp25(4668).TimeUnits.SECONDS) {
              const _Math2 = Math;
      ...
      if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_UPDATE !== action) {
        if (tmp.GUILD_SCHEDULED_EVENT_EXCEPTION_DELETE === action) {
          ...
          if (null == found2) {
            ...
            } else if (tmp198(17692).GuildFeedItemTypes.FORUM_POST === newValue) {
                      ...
                      if (tmp2.GUILD_SCHEDULED_EVENT !== targetType) {
                        if (tmp2.GUILD_SCHEDULED_EVENT_EXCEPTION !== targetType) {
                          if (tmp2.THREAD === targetType) {
                            ...
                            let tmp10 = null;
                            if (tmp9) {
                              tmp10 = ((channel) => result3(4792).computeChannelName(channel, user, closure_1_12, true))(tmp7);
                            }
                            let tmp11 = tmp10;
                            if (null == tmp10) {
                              tmp11 = tmp10;
