...
function ApplicationHook(applicationId) {
  ...
  return closure_14(Text.Text, { variant: "text-sm/semibold", children });
}
          ...
          if (tmp2.action !== tmp3.MEMBER_ROLE_UPDATE) {
            if (tmp2.action === tmp3.INVITE_CREATE) {
              ...
              if (null == tmp18Result) {
                ...
                const obj2 = { oldValue: null, newValue: null, count: null, subtarget: null, newColorHook: null, newColorsHook: null, oldColorHook: null, oldTagHook: null, newTagHook: null, oldEmojiHook: null, newEmojiHook: null, applicationHook: null, oldApplicationHook: null, newApplicationHook: null };
                obj2[0] = oldValue2;
                obj2[1] = newValue;
                const _Array = Array;
                let num = 0;
                ...
                obj2[12] = function oldApplicationHook(arg0, arg1) {
                  return closure_2_14(closure_2_17, { applicationId: changeItemTextLine }, arg1);
                };
                obj2[13] = function newApplicationHook(arg0, arg1) {
                  return closure_2_14(closure_2_17, { applicationId: items3 }, arg1);
                };
