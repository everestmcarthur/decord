...
// Function ID: 17806
// Name: AuditLog
// Dependencies: [19, 17, 1182, 1386, 4288, 1372, 1074, 21, 4640, 576, 1400, 1397, 5371, 4491, 7282, 4636, 1364, 4350, 17788, 1115, 4484, 1177, 1972, 4793, 4785, 4231, 1370, 1092, 10776, 7244, 5695, 17797, 5210, 4607, 8327, 14724, 504, 2]

// Module 17805 (AuditLog)
...
import AppliedForumTag from "AppliedForumTag" /* 10776 */;
import AuditLogUtilsAll from "AuditLogUtils" /* 17788 */;
          ...
          if (log.targetType === constants.GUILD) {
            if (typeof target === "object") {
              if (obj6.isGuildRecord(tmp5)) {
                ...
                tmp8Result = closure_2_14(tmp15(4636).Text, obj5, `target${tmp5.id}`);
              }
...
prototype["render"] = function render() {
  ...
  const items2 = [closure_14(user(17797), { action: log.action }), , , ];
      ...
      if (log.action !== tmp21.AUTO_MODERATION_USER_COMMUNICATION_DISABLED) {
        if (log.action !== tmp21.AUTO_MODERATION_QUARANTINE_USER) {
          if (null != log.options.integration_type) {
            value = tmp18(5371).get(log.options.integration_type);
            if (null != value) {
        ...
        items2[1] = tmp17(tmp10(5210).PressableOpacity, obj7);
        ...
        items2[2] = tmp15(tmp10(5210).PressableOpacity, obj9);
        ...
        return tmp15(tmp10(5695).Card, obj4);
      }
    }
  }
