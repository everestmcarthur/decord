...
// Dependencies: [19, 17, 21, 4640, 576, 4338, 5695, 4636, 4594, 1115, 11569, 17952, 2]
// Exports: default

// Module 17951 (GuildSettingsAnalyticsCard)
...
export default function GuildSettingsAnalyticsCard(metricKey) {
  ...
  const items1 = [closure_6(metricKey(4636).Text, { variant: "text-md/medium", color: "text-subtle", children: title }), ];
  let tmp7Result = null;
  if (null != description) {
    ...
    obj3.children = tmp7(tmp4(4594).CircleInformationIcon, obj4);
  ...
  if (null != subtext) {
    ...
    if (isTrendingUp) {
      ...
      tmp7Result3 = tmp7(tmp4(11569).ArrowLargeUpIcon, obj7);
    }
