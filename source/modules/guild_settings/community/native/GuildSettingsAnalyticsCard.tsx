...
// Dependencies: [19, 17, 21, 4722, 576, 4420, 5777, 4718, 4676, 1115, 11667, 18046, 2]
// Exports: default

// Module 18045 (GuildSettingsAnalyticsCard)
...
export default function GuildSettingsAnalyticsCard(metricKey) {
  ...
  const items1 = [closure_6(metricKey(4718).Text, { variant: "text-md/medium", color: "text-subtle", children: title }), ];
  let tmp7Result = null;
  if (null != description) {
    ...
    obj3.children = tmp7(tmp4(4676).CircleInformationIcon, obj4);
  ...
  if (null != subtext) {
    ...
    if (isTrendingUp) {
      ...
      tmp7Result3 = tmp7(tmp4(11667).ArrowLargeUpIcon, obj7);
    }
