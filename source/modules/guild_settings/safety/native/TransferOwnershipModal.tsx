...
// Dependencies: [5, 19, 11981, 21, 11979, 1249, 1115, 5709, 11982, 6709, 9195, 4337, 7107, 2]
// Exports: default

// Module 11980 (TransferOwnershipModal)
...
export default function TransferOwnershipModal(guild) {
    ...
    obj5.render = function render() {
      ...
      guild = closure_1_3((arg0) => {
        ...
        return (function*(arg0, value) {
          yield toUser(9195).transferOwnership(id.id, id2.id, constants.EMAIL, id);
          return value;
        })();
      });
      ...
      obj.onSuccess = function onSuccess() {
        toUser(11979).close();
        const obj = toUser(11979);
        toUser(9195).close();
        const obj2 = toUser(9195);
      ...
      return closure_1_7(toUser(6709), obj);
    };
  ...
  return jsx(guild(7107).Navigator, { screens: memo, initialRouteName: constants.TRANFSER_OWNERSHIP, headerBackTitle: null });
};
