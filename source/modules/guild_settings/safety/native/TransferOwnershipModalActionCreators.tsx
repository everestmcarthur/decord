...
// Dependencies: [4808, 11916, 1896, 573, 2]

// Module 11915 (TransferOwnershipModalActionCreators)
...
export default {
  open(guild, toUser) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11916, dependencyMap.paths), { guild, toUser }, TRANSFER_OWNERSHIP_MODAL_KEY);
  },
  close() {
