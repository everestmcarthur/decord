...
// Dependencies: [4810, 11941, 1896, 573, 2]

// Module 11940 (TransferOwnershipModalActionCreators)
...
export default {
  open(guild, toUser) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11941, dependencyMap.paths), { guild, toUser }, TRANSFER_OWNERSHIP_MODAL_KEY);
  },
  close() {
