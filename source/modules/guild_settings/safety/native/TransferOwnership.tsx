...
// Dependencies: [5, 32, 19, 17, 1372, 11998, 1074, 21, 4640, 576, 4341, 1484, 504, 38, 9217, 11996, 4337, 4792, 5672, 4636, 12000, 1177, 1115, 4484, 5775, 5692, 5062, 2]
// Exports: default

// Module 11999 (TransferOwnership)
...
const TransferOwnershipConstants = fn(11998);
...
export default function TransferOwnership(guild) {
          ...
          if (arg0 === 1) {
            ...
            if (!mfaEnabled.mfaEnabled) {
              if (null != tmp27.email) {
                v1 = 1;
                dependencyMap = 1;
                const obj6 = { value: v1(9217).sendTransferOwnershipPincode(user.id), done: false };
                return obj6;
              }
            }
            let MFA = null;
            ...
            const obj4 = v1(9217);
            v1(9217).transferOwnership(user.id, id.id, MFA).then(() => {
              v1(11996).close();
              const obj = v1(11996);
              v1(9217).close();
              const obj2 = v1(9217);
            ...
            dependencyMap = 3;
            const transferOwnershipResult = v1(9217).transferOwnership(user.id, id.id, MFA);
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
          throw value;
  ...
  nickname = toUser(4792).getNickname(guild.id, undefined, toUser);
  ...
  const items1 = [closure_13(c7, { source: toUser(12000), style: tmp5.arrow }), , , ];
  const obj10 = { style: tmp5.avatarsWrapper, children: null };
  const obj9 = { source: toUser(12000), style: tmp5.arrow };
  ...
  items1[2] = closure_13(guild(4636).Text, { variant: "text-xs/medium", color: "text-default", children: guild.name });
  if (null == nickname) {
    ...
    obj17.children = tmp11(tmp(5692).TableCheckboxRow, obj18);
    items3[1] = tmp11(tmp(5775).TableRowGroup, obj17);
    const obj20 = {
    ...
    obj20.disabled = !tmp8;
    items3[2] = tmp11(tmp(5062).Button, obj20);
