...
// Dependencies: [19, 17, 1975, 1979, 1371, 9133, 1074, 21, 4605, 576, 504, 9132, 4601, 1114, 5025, 14870, 7092, 2]
// Exports: default

// Module 17695 (GuildSettingsModalSecurity)
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [closure_12(guildId(4601).Text, obj5), , ];
  ...
  obj6.children = closure_12(guildId(5025).Button, obj7);
  ...
  if (hasItem) {
    ...
    tmp17Result = tmp17(tmp2(4601).Text, obj8);
  }
  ...
  const items6 = [closure_12(closure_5, { source: stateFromStores(14870), style: tmp.image, resizeMode: "contain" }), ];
  ...
  obj12.children = closure_12(guildId(4601).Text, obj13);
  items6[1] = closure_12(closure_4, obj12);
  obj10.children = items6;
  items5[1] = closure_13(closure_4, obj10);
  obj3.children = items5;
  const items7 = [closure_13(closure_4, obj3), closure_12(guildId(7092).NavScrim, {})];
