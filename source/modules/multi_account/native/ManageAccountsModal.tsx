...
// Dependencies: [32, 5, 19, 17, 502, 4485, 1372, 12565, 12566, 16536, 1074, 21, 8035, 4640, 576, 504, 1177, 4985, 1115, 12569, 5210, 15429, 16103, 4376, 4641, 8421, 1241, 7237, 16537, 16104, 12575, 16538, 5703, 8748, 11358, 7114, 7984, 11082, 16129, 6703, 7054, 16128, 2]

// Module 16535 (ManageAccountsModal)
...
function RemoveMultiAccountUserButton(user) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            v3 = 1;
            const obj7 = { value: v1(4985).confirm(obj4), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          v3 = 3;
          ...
          if (value) {
            v3(12569).removeAccount(closure_128_0.id);
            const obj = v3(12569);
          }
          v3 = 3;
          return { value: "HermesInternal", done: null };
  ...
  if (id === user.id) {
    ...
    obj3.children = closure_18(tmp(15429).CircleMinusIcon, obj4);
    return closure_18(tmp(5210).PressableOpacity, obj3);
  }
  let obj2 = user(504);
}
...
const ManageAccountsScreens = fn(16536).ManageAccountsScreens;
Constants = fn(1074);
...
export default noop.memo(function ManageAccountsModal(initialRouteName) {
  ...
  const items = [
    ...
    closure_18(closure_20.Screen, {
      ...
      children() {
        return closure_1_18(isEditing(16129), {
          handleLogin(login, password, undelete) {
            isEditing(6703).login({ login, password, undelete });
          },
          onReset() {
            isEditing(6703).loginReset(true);
          }
        });
      }
    }),
    closure_18(closure_20.Screen, {
      ...
      children() {
        return closure_1_18(isEditing(7054), { isMultiAccount: true });
      }
    }),
    closure_18(closure_20.Screen, {
      ...
      children() {
        return closure_1_18(isEditing(16128), { isMultiAccount: true });
      }
    })
  ];
  obj2.children = items;
