...
// Dependencies: [19, 17, 1386, 4567, 1372, 12656, 21, 4722, 504, 4681, 576, 4676, 4718, 1115, 5292, 4440, 1177, 4566, 2]
// Exports: default

// Module 16201 (AccountSwitcherListItem)
...
export default function AccountSwitcherListItem(arg0) {
  ...
  if (user.id === id) {
    if (showActiveAccountLabel) {
      ...
      let tmp8 = React7(tmp2(4718).Text, obj4);
    }
    if (null == onPressUser) {
      let PressableOpacity = React3;
    } else {
      PressableOpacity = tmp2(5292).PressableOpacity;
    }
    const obj5 = { selected: tmp7 };
    const radioA11yNative = tmp2(4440).useRadioA11yNative(obj5);
    ...
    const items4 = [React7(tmp2(4718).Text, obj12), ];
    ...
    if (tmp18Result) {
      ...
      tmp18Result = tmp18(tmp2(4718).Text, obj15);
    }
  ...
  if (user.tokenStatus === MultiAccountTokenStatus.INVALID) {
    ...
    tmp8 = React7(tmp2(4718).Text, obj17);
  }
};
