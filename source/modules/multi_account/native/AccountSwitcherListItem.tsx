...
// Dependencies: [19, 17, 1386, 4485, 1372, 12548, 21, 4639, 504, 4599, 576, 4594, 4635, 1115, 5207, 4358, 1177, 4484, 2]
// Exports: default

// Module 16062 (AccountSwitcherListItem)
...
export default function AccountSwitcherListItem(arg0) {
  ...
  if (user.id === id) {
    if (showActiveAccountLabel) {
      ...
      let tmp8 = React7(tmp2(4635).Text, obj4);
    }
    if (null == onPressUser) {
      let PressableOpacity = React3;
    } else {
      PressableOpacity = tmp2(5207).PressableOpacity;
    }
    ...
    const items4 = [React7(tmp2(4635).Text, obj12), ];
    ...
    if (tmp18Result) {
      ...
      tmp18Result = tmp18(tmp2(4635).Text, obj15);
    }
  ...
  if (user.tokenStatus === MultiAccountTokenStatus.INVALID) {
    ...
    tmp8 = React7(tmp2(4635).Text, obj17);
  }
};
