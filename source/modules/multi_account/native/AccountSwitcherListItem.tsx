...
// Dependencies: [19, 17, 1385, 4450, 1371, 12483, 21, 4605, 504, 4565, 576, 4560, 4601, 1114, 5173, 4323, 1178, 4449, 2]
// Exports: default

// Module 16034 (AccountSwitcherListItem)
...
export default function AccountSwitcherListItem(arg0) {
  ...
  if (user.id === id) {
    if (showActiveAccountLabel) {
      ...
      obj4.children = intl.string(tmp2(1114).t.seV8yt);
      let tmp8 = React7(tmp2(4601).Text, obj4);
    }
    if (null == onPressUser) {
      let PressableOpacity = React3;
    } else {
      PressableOpacity = tmp2(5173).PressableOpacity;
    }
    const obj5 = { selected: tmp7 };
    const radioA11yNative = tmp2(4323).useRadioA11yNative(obj5);
    ...
    const items4 = [React7(tmp2(4601).Text, obj12), ];
    ...
    if (tmp18Result) {
      ...
      tmp18Result = tmp18(tmp2(4601).Text, obj15);
    }
  ...
  if (user.tokenStatus === MultiAccountTokenStatus.INVALID) {
    ...
    obj17.children = intl3.string(tmp2(1114).t.tYX2ps);
    tmp8 = React7(tmp2(4601).Text, obj17);
  }
};
