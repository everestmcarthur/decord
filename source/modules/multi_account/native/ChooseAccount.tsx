      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            obj5 = tmp2(4981).confirm(obj5);
            dependencyMap = 1;
            c4 = 1;
            const obj8 = tmp2(4981);
          }
        } else if (arg0 === 1) {
          c4 = 3;
          throw value;
  ...
  let items = [
    multiAccountUsers.map((user) => {
      ...
      let obj2 = {
        ...
        onPress() {
          multiAccountUsers(4603).hideActionSheet();
          let obj = multiAccountUsers(4603);
          ...
          items[1] = obj5;
          obj3.options = items;
          const result = user(7297).showSimpleActionSheet(obj3);
        },
        children: null
      };
