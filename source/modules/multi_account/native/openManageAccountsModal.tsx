...
// Dependencies: [12543, 4603, 4839, 16470, 1896, 2]
// Exports: default
...
export default function openManageAccountsModal(initialRouteName) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(16470, dependencyMap.paths), { initialRouteName }, SWITCH_ACCOUNTS_MODAL_KEY);
};
