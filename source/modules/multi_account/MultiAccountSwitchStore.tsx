...
// Dependencies: [12542, 1074, 3, 15, 1099, 1242, 504, 573, 2]

// Module 13718 (MultiAccountSwitchStore)
    ...
    if (c11) {
      ...
      if (tmp45) {
        ...
        if (flag4) {
          ...
          if (0 !== found.length) {
            let tmp46 = tmp41(1099).getToken(id2) === token2;
            const obj13 = {};
        ...
        tmp41(1099).setToken(token2, user.id);
        const tmp41Result2 = tmp41(1099);
      }
      const id3 = user.id;
