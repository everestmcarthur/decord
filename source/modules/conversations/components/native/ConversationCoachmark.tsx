...
// Dependencies: [32, 19, 17, 1954, 21, 1943, 4607, 576, 4603, 1114, 7462, 11224, 2]
// Exports: ConversationCoachmark

// Module 13356 (ConversationCoachmark)
...
export const ConversationCoachmark = function ConversationCoachmark(arg0) {
  ...
  const tmp = closure_9();
  const tmp3 = _slicedToArray(first(7462).useSelectedDismissibleContent(items), 2);
  first = tmp3[0];
  dependencyMap = tmp5;
  items = [tmp3[1], first];
  ...
  let obj = first(7462);
  const coachmark = first(11224).useCoachmark(ref, memo);
  const items1 = [tmp3[1]];
