...
// Dependencies: [32, 19, 17, 1955, 21, 1944, 4639, 576, 4635, 1115, 7495, 11266, 2]
// Exports: ConversationCoachmark

// Module 13393 (ConversationCoachmark)
...
export const ConversationCoachmark = function ConversationCoachmark(arg0) {
  ...
  const tmp = closure_9();
  const tmp3 = _slicedToArray(first(7495).useSelectedDismissibleContent(items), 2);
  first = tmp3[0];
  dependencyMap = tmp5;
  items = [tmp3[1], first];
  ...
  let obj = first(7495);
  const coachmark = first(11266).useCoachmark(ref, memo);
  const items1 = [tmp3[1]];
