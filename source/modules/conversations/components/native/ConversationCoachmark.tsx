...
// Dependencies: [32, 19, 17, 1954, 21, 1943, 4606, 576, 4602, 1114, 7461, 11222, 2]
// Exports: ConversationCoachmark

// Module 13354 (ConversationCoachmark)
...
export const ConversationCoachmark = function ConversationCoachmark(arg0) {
  ...
  const tmp = closure_9();
  const tmp3 = _slicedToArray(first(7461).useSelectedDismissibleContent(items), 2);
  first = tmp3[0];
  dependencyMap = tmp5;
  items = [tmp3[1], first];
  ...
  let obj = first(7461);
  const coachmark = first(11222).useCoachmark(ref, memo);
  const items1 = [tmp3[1]];
