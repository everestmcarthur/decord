...
// Dependencies: [19, 21, 4308, 576, 7936, 1115, 7987, 7073, 7997, 7998, 1114, 7999, 13347, 13348, 4465, 2]
// Exports: default, openConversationNavigator

// Module 7986 (ConversationNavigator)
import nativeDefault from "native" /* 576 */;
import PlatformUtils from "PlatformUtils" /* 1115 */;
import useToken from "useToken" /* 4308 */;
import RootNavigationRef from "RootNavigationRef" /* 4465 */;
import HeaderShared from "HeaderShared" /* 7936 */;
import ConversationNavigatorHeaderDefault from "ConversationNavigatorHeader" /* 7998 */;
import ConversationNavigatorMoreMenuDefault from "ConversationNavigatorMoreMenu" /* 13347 */;
...
export default function ConversationNavigator(route) {
  ...
  let obj2 = { id: "conversation-navigator", screenOptions: channelId(7073).useAccessibilityNativeStackOptions(), children: null };
  let obj = channelId(7073);
  ({ Navigator, Screen } = Screen);
  const items = [
    closure_3(Screen, {
      initialParams: { channelId, guildId: params.guildId },
      name: channelId(7997).ConversationNavigatorScreens.LIST,
      options(navigation) {
        let obj = {
          header(arg0) {
            const merged = Object.assign(arg0);
  ...
  items[1] = closure_3(Screen.Screen, {
    name: channelId(7997).ConversationNavigatorScreens.FOCUS,
    options(route) {
      route = route.route;
      const obj = {
        header(arg0) {
    ...
    getComponent() {
      return channelId(13348).default;
    }
  });
  obj2.children = items;
