...
// Dependencies: [19, 17, 1958, 21, 4640, 576, 504, 4793, 7984, 4341, 1365, 1115, 8047, 2]
// Exports: conversationNavigatorFocusHeaderOptions, conversationNavigatorListHeaderOptions

// Module 8046 (ConversationNavigatorHeader)
...
import ConversationNavigatorMoreMenuDefault from "ConversationNavigatorMoreMenu" /* 8047 */;
...
function ConversationNavigatorHeader(channelId) {
  ...
  obj2.children = jsx(channelId(7984).GenericHeaderTitle, { title: channelId.title, subtitle: tmp3, variant: "heading-lg/semibold", subtitleColor: "text-muted" });
