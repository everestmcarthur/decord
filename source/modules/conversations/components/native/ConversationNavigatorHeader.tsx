...
// Dependencies: [19, 17, 1957, 21, 4574, 576, 504, 4727, 7877, 2]
// Exports: default
...
export default function ConversationNavigatorHeader(channelId) {
  ...
  obj2.children = jsx(channelId(7877).GenericHeaderTitle, { title: channelId.title, subtitle: tmp3, variant: "heading-lg/semibold", subtitleColor: "text-muted" });
