...
// Dependencies: [19, 17, 1957, 21, 4606, 576, 504, 4759, 7936, 2]
// Exports: default

// Module 7998 (ConversationNavigatorHeader)
...
export default function ConversationNavigatorHeader(channelId) {
  ...
  obj2.children = jsx(channelId(7936).GenericHeaderTitle, { title: channelId.title, subtitle: tmp3, variant: "heading-lg/semibold", subtitleColor: "text-muted" });
