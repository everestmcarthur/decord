...
// Dependencies: [19, 17, 1958, 21, 4638, 576, 504, 4791, 7978, 2]
// Exports: default

// Module 8040 (ConversationNavigatorHeader)
...
export default function ConversationNavigatorHeader(channelId) {
  ...
  obj2.children = jsx(channelId(7978).GenericHeaderTitle, { title: channelId.title, subtitle: tmp3, variant: "heading-lg/semibold", subtitleColor: "text-muted" });
