...
// Dependencies: [19, 21, 5023, 576, 7981, 7018, 4601, 1114, 2]
// Exports: default

// Module 7980 (ConversationPreviewBlockedMessage)
...
export default function ConversationPreviewBlockedMessage(reason) {
  ...
  if ("blocked" === reason.reason) {
    let EyeSlashIcon = tmp2(7981).DenyIcon;
  } else {
    EyeSlashIcon = tmp2(7018).EyeSlashIcon;
  }
