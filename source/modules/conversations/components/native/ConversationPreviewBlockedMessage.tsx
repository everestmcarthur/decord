...
// Dependencies: [19, 21, 5060, 576, 8065, 7080, 4636, 1115, 2]
// Exports: default

// Module 8064 (ConversationPreviewBlockedMessage)
...
export default function ConversationPreviewBlockedMessage(reason) {
  ...
  if ("blocked" === reason.reason) {
    let EyeSlashIcon = tmp2(8065).DenyIcon;
  } else {
    EyeSlashIcon = tmp2(7080).EyeSlashIcon;
  }
