...
// Dependencies: [5, 32, 19, 17, 7712, 7709, 21, 4640, 576, 8062, 4636, 1115, 1487, 1612, 8028, 504, 11, 8029, 8031, 8873, 2]
// Exports: default

// Module 8061 (ConversationListScreen)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import Text_Text from "Text/Text" /* 4636 */;
import ConversationsAnalytics2 from "ConversationsAnalytics" /* 8031 */;
import ConversationListItemDefault from "ConversationListItem" /* 8062 */;
...
export default function ConversationListScreen() {
  ...
  obj7.children = jsx(tmp(8873).FlashList, { data: memo, renderItem, keyExtractor, contentContainerStyle: tmp3.content, scrollIndicatorInsets: { bottom }, onEndReached: null, ListEmptyComponent: null, ListFooterComponent: null, onViewableItemsChanged: null, viewabilityConfig: null });
