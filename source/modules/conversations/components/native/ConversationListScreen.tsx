...
// Dependencies: [5, 32, 19, 17, 7647, 7649, 21, 4605, 576, 7978, 4601, 1114, 1486, 1611, 7958, 504, 11, 7959, 7961, 8943, 2]
// Exports: default

// Module 7977 (ConversationListScreen)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import Text_Text from "Text/Text" /* 4601 */;
import ConversationsAnalytics2 from "ConversationsAnalytics" /* 7961 */;
import ConversationListItemDefault from "ConversationListItem" /* 7978 */;
...
export default function ConversationListScreen() {
  ...
  obj7.children = jsx(tmp(8943).FlashList, { data: memo, renderItem, keyExtractor, contentContainerStyle: tmp3.content, scrollIndicatorInsets: { bottom }, onEndReached: null, ListEmptyComponent: null, ListFooterComponent: null, onViewableItemsChanged: null, viewabilityConfig: null });
