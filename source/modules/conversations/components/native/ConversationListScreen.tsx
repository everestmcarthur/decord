...
// Dependencies: [5, 32, 19, 17, 7669, 7671, 21, 4607, 576, 8001, 4603, 1114, 1486, 1611, 7981, 504, 11, 7982, 7984, 8966, 2]
// Exports: default

// Module 8000 (ConversationListScreen)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import Text_Text from "Text/Text" /* 4603 */;
import ConversationsAnalytics2 from "ConversationsAnalytics" /* 7984 */;
import ConversationListItemDefault from "ConversationListItem" /* 8001 */;
...
export default function ConversationListScreen() {
  ...
  obj7.children = jsx(tmp(8966).FlashList, { data: memo, renderItem, keyExtractor, contentContainerStyle: tmp3.content, scrollIndicatorInsets: { bottom }, onEndReached: null, ListEmptyComponent: null, ListFooterComponent: null, onViewableItemsChanged: null, viewabilityConfig: null });
