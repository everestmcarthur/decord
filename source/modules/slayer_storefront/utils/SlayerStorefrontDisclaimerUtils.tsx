...
// Dependencies: [2025, 7302, 1074, 10912, 1114, 3460, 2]
...
// Module 10911 (SlayerStorefrontDisclaimerUtils)
...
let closure_6 = { [fn(10912).StorefrontPlatform.DESKTOP]: "PC", [fn(10912).StorefrontPlatform.XBOX]: "Xbox", [fn(10912).StorefrontPlatform.PLAYSTATION]: "PlayStation", [fn(10912).StorefrontPlatform.SWITCH]: "Switch", [fn(10912).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade", [fn(10912).StorefrontPlatform.NETFLIX]: "Netflix", [fn(10912).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+" };
let items = [fn(10912).StorefrontPlatform.PLAYSTATION];
const size = fn(2);
...
export const getFinePrintMessageForApplication = function getFinePrintMessageForApplication(name, shouldAppendDisclaimer) {
  ...
  if (shouldAppendDisclaimer.shouldAppendDisclaimer) {
    ...
    if (0 !== arr.length) {
      ...
      str2 = intl3.formatToPlainString(tmp4(3460)["5h8p5P"], obj3);
    }
...
export const getMobileFinePrintMessageForApplication = function getMobileFinePrintMessageForApplication(getOrFetchApplication, stringResult, shouldAppendDisclaimer) {
  ...
  if (shouldAppendDisclaimer.shouldAppendDisclaimer) {
    ...
    if (0 !== arr2.length) {
      ...
      str2 = intl3.formatToPlainString(tmp3(3460)["5h8p5P"], obj2);
    }
    const obj3 = { platforms_info: str2 };
    items = [format(tmp4.Q0dHYO, obj3), ];
    const intl2 = tmp(1114).intl;
    items[1] = intl2.format(tmp3(3460).Ufm9XX, obj);
    let items1 = items;
  } else {
