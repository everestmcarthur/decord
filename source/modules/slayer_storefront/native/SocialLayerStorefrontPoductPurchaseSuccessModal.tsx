...
// Dependencies: [32, 718, 19, 17, 4631, 5595, 7336, 1074, 21, 4639, 576, 4376, 5058, 4640, 4607, 1478, 504, 5210, 7333, 4635, 5059, 1115, 5071, 7230, 5716, 5765, 8955, 7275, 7272, 11145, 7289, 1241, 5076, 10930, 3461, 8864, 4484, 2]
// Exports: SocialLayerStorefrontProductGiftPurchaseSuccessModal, SocialLayerStorefrontProductSelfPurchaseSuccessModal

// Module 11144 (SocialLayerStorefrontPoductPurchaseSuccessModal)
...
const numDays = fn(7336).SOCIAL_LAYER_DAYS_TO_CLAIM_ITEM;
  ...
  const memo1 = obj4.useMemo(() => {
    if (hasAlreadyLinked) {
      ...
      if (closure_10) {
        ...
        formatToPlainStringResult = formatToPlainString(_modDef3461.eNNnIG, obj);
      }
    }
