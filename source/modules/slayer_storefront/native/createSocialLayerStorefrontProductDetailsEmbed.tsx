...
// Dependencies: [32, 19, 4950, 5680, 1074, 7938, 8164, 1115, 11772, 7427, 7422, 3546, 9604, 4710, 11046, 1365, 504, 1370, 7364, 2]
        ...
        if (tmp(11772)(application)) {
          if ("guild" !== guildOrApplication.type) {
            ...
            if (result1) {
              ...
              stringResult = string(tmp(3546).BKf0MM);
            }
