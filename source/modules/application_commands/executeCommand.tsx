...
// Function ID: 9444
// Name: executeCommand
// Dependencies: [5, 5473, 2025, 1979, 4914, 1371, 7794, 1074, 4567, 7537, 573, 7779, 7535, 1894, 9444, 9446, 38, 9447, 4754, 7792, 9339, 4226, 1369, 7767, 8143, 7848, 8142, 9448, 8207, 7766, 7470, 5148, 5143, 1114, 7856, 2]
// Exports: default, retryCommandMessage

// Module 9443 (executeCommand)
...
import InteractionActionCreatorsAll from "InteractionActionCreators" /* 8143 */;
...
function enqueueCommandInteraction(interactionLifecycleOptions) {
  ...
  if (null != context.channel) {
    ...
    if (nonce == null) {
      nonce = onMessageSuccess(7767).createNonce();
      let obj2 = onMessageSuccess(7767);
    }
    message.nonce = nonce;
    ...
    const obj10 = { type: tmp10(7848).MessageDataType.COMMAND, message };
    message(7848).enqueue(obj10, (ok) => {
      ({ nonce, applicationId, channelId, guildId } = closure_0);
      if (guildId == null) {
        guildId = null;
      }
              ...
              if (null == cachedApplicationSection) {
                ...
                if (null == bot) {
                  if (null != cachedApplicationSection.botId) {
                    ...
                    c7 = 2;
                    c8 = 1;
                    const obj9 = { value: tmp65(8207).getUser(cachedApplicationSection.botId), done: false };
                    return obj9;
                  }
                }
              }
...
function getAnalyticsLocationFromCommandOrigin(arg0) {
  if (ApplicationCommandTypes.CommandOrigin.APPLICATION_LAUNCHER === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.APP_LAUNCHER;
  } else if (tmp(7537).CommandOrigin.APP_LAUNCHER_APPLICATION_VIEW === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.APP_LAUNCHER_APPLICATION_VIEW;
  } else if (tmp(7537).CommandOrigin.IMAGE_RECS_MENU === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.IMAGE_RECS_MENU;
  } else if (tmp(7537).CommandOrigin.IMAGE_RECS_SUBMENU === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.IMAGE_RECS_SUBMENU;
  } else if (tmp(7537).CommandOrigin.ACTIVITY_INSTANCE_EMBED === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.ACTIVITY_INSTANCE_EMBED;
  } else if (tmp(7537).CommandOrigin.ACTIVITY_BOOKMARK_EMBED === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.ACTIVITY_BOOKMARK_EMBED;
  } else if (tmp(7537).CommandOrigin.MINI_SHELF === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.ACTIVITIES_MINI_SHELF;
  } else if (tmp(7537).CommandOrigin.VOICE_TILE_ACTIVITY_SUGGESTIONS === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.VC_TILE_ACTIVITY_SUGGESTION;
  } else if (tmp(7537).CommandOrigin.APP_DMS_ENTRY_POINT_COMMAND_BUTTON === arg0) {
    return tmp(7537).ApplicationCommandTriggerLocations.APP_DMS_ENTRY_POINT_COMMAND_BUTTON;
  } else {
    return tmp(7537).ApplicationCommandTriggerLocations.SLASH_UI;
  }
}
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_132_5 = function handleUploadsTooLarge(arg0) {
            ...
            const obj = closure_2(8143);
            obj2.maxSize = closure_0(5148).sizeString(dependencyMap);
...
let closure_15 = fn(4567).DEFAULT_MOBILE_PRE_COMPRESSION_MAX_ATTACHMENT_SIZE;
const size = fn(2);
