...
// Dependencies: [5, 1958, 4278, 1372, 5086, 1074, 9455, 2024, 4633, 7637, 1115, 9456, 1895, 1936, 9457, 9458, 7383, 9459, 1095, 9460, 7570, 7796, 5608, 4484, 1091, 9557, 4231, 4653, 38, 7362, 9558, 2]
// Exports: getBuiltInCommands

// Module 9454 (ApplicationCommandBuiltIns)
...
import ChangeNicknameActionCreatorsDefault from "ChangeNicknameActionCreators" /* 9457 */;
...
const DiceRollConstants = fn(9455);
({ ALLOWED_DICE_SIDES, MAX_DICE_COUNT } = DiceRollConstants);
let closure_11 = fn(2024).getDisableCommunicationDurationOptions;
const MessageSendLocation = fn(4633).MessageSendLocation;
let obj = {};
let obj2 = { id: BuiltInSectionId.BUILT_IN, type: fn(7637).ApplicationCommandSectionType.BUILT_IN };
...
let obj3 = { id: BuiltInSectionId.FRECENCY, type: fn(7637).ApplicationCommandSectionType.BUILT_IN };
...
let items = [...fn(9456).default];
let obj4 = { id: "-1", untranslatedName: "shrug", displayName: "shrug", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
let obj5 = { name: "message", displayName: "message", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[tmp5] = obj4;
const sum = tmp5 + 1;
let obj6 = { id: "-2", untranslatedName: "tableflip", displayName: "tableflip", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
let obj7 = { name: "message", displayName: "message", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum] = obj6;
const sum1 = sum + 1;
let obj8 = { id: "-3", untranslatedName: "unflip", displayName: "unflip", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
let obj9 = { name: "message", displayName: "message", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum1] = obj8;
const sum2 = sum1 + 1;
let obj10 = { id: "-4", untranslatedName: "tts", displayName: "tts", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj11 = { name: "message", displayName: "message", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum2] = obj10;
const sum3 = sum2 + 1;
const obj12 = { id: "-5", untranslatedName: "me", displayName: "me", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj13 = { name: "message", displayName: "message", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum3] = obj12;
const sum4 = sum3 + 1;
const obj14 = { id: "-6", untranslatedName: "spoiler", displayName: "spoiler", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj15 = { name: "message", displayName: "message", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum4] = obj14;
const sum5 = sum4 + 1;
const obj16 = { id: "-7", untranslatedName: "nick", displayName: "nick", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj17 = { name: "new_nick", displayName: "new_nick", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum5] = obj16;
const sum6 = sum5 + 1;
const obj18 = { id: "-10", untranslatedName: "thread", displayName: "thread", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj19 = { name: "name", displayName: "name", type: fn(1895).ApplicationCommandOptionType.STRING };
...
const items8 = [obj19, ];
const obj20 = { name: "message", displayName: "message", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum6] = obj18;
const sum7 = sum6 + 1;
const obj21 = { id: "-11", untranslatedName: "kick", displayName: "kick", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj22 = { name: "user", displayName: "user", type: fn(1895).ApplicationCommandOptionType.USER };
...
obj22.required = true;
const items9 = [obj22, ];
const obj23 = { name: "reason", displayName: "reason", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum7] = obj21;
const sum8 = sum7 + 1;
const obj24 = { id: "-12", untranslatedName: "ban", displayName: "ban", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj25 = { name: "user", displayName: "user", type: fn(1895).ApplicationCommandOptionType.USER };
...
obj25.required = true;
const items10 = [obj25, , ];
const obj26 = { name: "delete_messages", displayName: "delete_messages", type: fn(1895).ApplicationCommandOptionType.INTEGER };
...
items10[1] = obj26;
const obj27 = { name: "reason", displayName: "reason", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum8] = obj24;
const sum9 = sum8 + 1;
const obj28 = { id: "-13", untranslatedName: "timeout", displayName: "timeout", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj29 = { name: "user", displayName: "user", type: fn(1895).ApplicationCommandOptionType.USER };
...
obj29.required = true;
const items11 = [obj29, , ];
const obj30 = { name: "duration", displayName: "duration", type: fn(1895).ApplicationCommandOptionType.INTEGER };
...
items11[1] = obj30;
const obj31 = { name: "reason", displayName: "reason", type: fn(1895).ApplicationCommandOptionType.STRING };
...
items[sum9] = obj28;
const sum10 = sum9 + 1;
const obj32 = { id: "-14", untranslatedName: "msg", displayName: "msg", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj33 = { name: "user", displayName: "user", type: fn(1895).ApplicationCommandOptionType.USER };
...
obj33.required = true;
const items12 = [obj33, ];
const obj34 = { name: "message", displayName: "message", type: fn(1895).ApplicationCommandOptionType.STRING };
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            c0 = 1;
            const obj6 = {
              value: v1(4653).openPrivateChannel(obj5).then((result) => {
                        channel = channel.getChannel(result);
                        c1(38)(null != channel, "Newly created PrivateChannel is null");
                        const obj = c1(7570);
                        obj.sendMessage(channel.id, c1(7796).parse(channel, dependencyMap), true, { location: constants.PRIVATE_MESSAGE_COMMAND });
                      }),
              done: false
            };
            return obj6;
...
items[sum10] = obj32;
const obj35 = { id: "-18", untranslatedName: "roll-dice", displayName: "roll-dice", type: fn(1895).ApplicationCommandType.CHAT, inputType: fn(7637).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
const obj36 = { name: "count", displayName: "count", type: fn(1895).ApplicationCommandOptionType.INTEGER };
...
const items13 = [obj36, ];
const obj37 = { name: "size", displayName: "size", type: fn(1895).ApplicationCommandOptionType.INTEGER };
...
export const PLATFORM_COMMANDS = fn(9456).default;
