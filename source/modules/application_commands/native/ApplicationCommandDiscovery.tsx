...
// Dependencies: [32, 19, 17, 5083, 12530, 10394, 1074, 21, 12531, 4639, 576, 5066, 12532, 9548, 1895, 9430, 4351, 1115, 4819, 12, 12533, 7630, 12534, 12535, 1177, 10551, 2]
// Exports: default

// Module 12529 (ApplicationCommandDiscovery)
...
import ApplicationSectionHeader from "ApplicationSectionHeader" /* 12531 */;
import ApplicationCommandDiscoveryManager from "ApplicationCommandDiscoveryManager" /* 12532 */;
import ApplicationCommandsCategoriesDefault from "ApplicationCommandsCategories" /* 12533 */;
...
const ITEM_HEIGHT = fn(12530).ITEM_HEIGHT;
const AUTOCOMPLETE_ROW_HEIGHT = fn(10394).AUTOCOMPLETE_ROW_HEIGHT;
...
export default function ApplicationCommandDiscovery(channel) {
  ...
  const discovery = channel(9548).useDiscovery(obj5);
  ...
  obj9.renderItem = function renderItem(item) {
    ...
    if (item.inputType === ApplicationCommandTypes.ApplicationCommandInputType.PLACEHOLDER) {
      return filteredSectionId(onHeightChange(12534), {});
    } else {
      ...
      return filteredSectionId(onHeightChange(12535), obj);
    }
  };
  obj9.renderSectionHeader = function renderSectionHeader(section) {
    ...
    if (tmp3Result) {
      const obj3 = { lightSource: tmp4(10551), darkSource: tmp4(10551), body: null, containerStyle: null, imageStyle: null };
      const intl = util.intl;
