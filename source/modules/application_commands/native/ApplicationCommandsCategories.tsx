...
// Dependencies: [19, 17, 2021, 12488, 21, 4606, 576, 504, 12324, 5638, 5174, 1114, 4574, 4575, 2]
// Exports: default

// Module 12491 (ApplicationCommandsCategories)
...
let closure_10 = noop.memo((section) => {
  ...
  return jsx(section(5174).PressableOpacity, {
    onPress() {
      return importDefault(dependencyMap);
    },
    accessibilityRole: "button",
