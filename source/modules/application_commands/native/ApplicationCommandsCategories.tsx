...
// Dependencies: [19, 17, 2022, 12538, 21, 4638, 576, 504, 12373, 5673, 5208, 1115, 4606, 4607, 2]
// Exports: default

// Module 12541 (ApplicationCommandsCategories)
...
const ApplicationCommandsCategoriesConstants = fn(12538);
...
let closure_10 = noop.memo((section) => {
  ...
  return jsx(section(5208).PressableOpacity, {
    onPress() {
      return importDefault(dependencyMap);
    },
    accessibilityRole: "button",
