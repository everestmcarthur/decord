...
// Dependencies: [19, 17, 4597, 1957, 2015, 1979, 4826, 4253, 1371, 9359, 5049, 1074, 1482, 5050, 21, 4605, 576, 1894, 1178, 4572, 8242, 4449, 4601, 4758, 1114, 7214, 504, 4839, 9245, 8013, 5637, 1399, 5657, 1115, 11693, 4302, 5655, 1609, 7575, 5023, 5737, 7234, 8180, 7202, 2]
// Exports: default

// Module 11692 (ExecutedApplicationCommandPopout)
...
import NativeCommandClipboardModuleDefault from "NativeCommandClipboardModule" /* 11693 */;
      ...
      if (null != iter.value) {
        ...
        if (tmp6(1894).ApplicationCommandOptionType.USER === type) {
          ...
          if (null != channel1) {
            ...
            const items1 = [closure_20, tmp6(4758).computeChannelName(channel1, UserStore, RelationshipStore)];
            obj.children = items1;
    ...
    if (item10021.type !== tmp5(1894).ApplicationCommandOptionType.SUB_COMMAND_GROUP) {
      ...
      if (null != item10021.value) {
        ...
        if (tmp5(1894).ApplicationCommandOptionType.USER === type) {
          ...
          sum = null;
          if (null != channel) {
            sum = closure_1_20 + tmp5(4758).computeChannelName(channel, UserStore, RelationshipStore);
            const tmp5Result = tmp5(4758);
          }
          ...
          if (items.includes(tmp3.options[0].type)) {
            ...
            if (chatInputRef != null) {
              ...
              if (current2 != null) {
                ...
                const obj3 = { initialRouteName: AppLauncherRouteName.COMMAND_VIEW, analyticsLocation: tmp4(7575).ApplicationCommandTriggerLocations.RECALL, preSelectedCommand: null };
...
export default function ExecutedCommandPopout(channelId) {
  ...
  const obj2 = { value: messageId(7214)(messageId(7234).EXECUTED_COMMAND).analyticsLocations, children: null };
  ...
  obj2.children = closure_23(channelId(7202).BottomSheet, obj3);
  return closure_23(channelId(7214).AnalyticsLocationProvider, obj2);
};
