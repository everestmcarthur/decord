...
// Dependencies: [19, 17, 4599, 1957, 2015, 1979, 4828, 4255, 1371, 9382, 5051, 1074, 1482, 5052, 21, 4607, 576, 1894, 1178, 4574, 8265, 4451, 4603, 4760, 1114, 7236, 504, 4841, 9268, 8036, 5639, 1399, 5659, 1115, 11717, 4304, 5657, 1609, 7597, 5025, 5739, 7256, 8203, 7224, 2]
// Exports: default

// Module 11716 (ExecutedApplicationCommandPopout)
...
import NativeCommandClipboardModuleDefault from "NativeCommandClipboardModule" /* 11717 */;
    ...
    if (iter.type !== tmp6(1894).ApplicationCommandOptionType.SUB_COMMAND_GROUP) {
      if (null != iter.value) {
        function getUserComponent(user, styles) {
          ...
          const items = [closure_1_22, channel(4451).getUserTag(user, { decoration: "never" })];
          obj.children = items;
        ...
        if (tmp6(1894).ApplicationCommandOptionType.USER === type) {
          ...
          if (null != channel1) {
            ...
            const items1 = [closure_20, tmp6(4760).computeChannelName(channel1, UserStore, RelationshipStore)];
            obj.children = items1;
            const _HermesInternal3 = HermesInternal;
            userComponent = closure_24(tmp6(1178).LegacyText, obj, "optionValue-" + iter.name);
            const tmp6Result = tmp6(4760);
          }
        } else {
    ...
    if (item10021.type !== tmp5(1894).ApplicationCommandOptionType.SUB_COMMAND_GROUP) {
      ...
      if (null != item10021.value) {
        ...
        if (tmp5(1894).ApplicationCommandOptionType.USER === type) {
          ...
          sum = null;
          if (null != channel) {
            sum = closure_1_20 + tmp5(4760).computeChannelName(channel, UserStore, RelationshipStore);
            const tmp5Result = tmp5(4760);
          }
          ...
          if (items.includes(tmp3.options[0].type)) {
            ...
            if (chatInputRef != null) {
              ...
              if (current2 != null) {
                ...
                const obj3 = { initialRouteName: AppLauncherRouteName.COMMAND_VIEW, analyticsLocation: tmp4(7597).ApplicationCommandTriggerLocations.RECALL, preSelectedCommand: null };
...
export default function ExecutedCommandPopout(channelId) {
  ...
  const obj2 = { value: messageId(7236)(messageId(7256).EXECUTED_COMMAND).analyticsLocations, children: null };
  ...
  obj2.children = closure_23(channelId(7224).BottomSheet, obj3);
  return closure_23(channelId(7236).AnalyticsLocationProvider, obj2);
};
