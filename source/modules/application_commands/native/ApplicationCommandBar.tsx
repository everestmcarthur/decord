...
// Dependencies: [32, 19, 17, 2021, 21, 4605, 576, 5491, 5173, 1114, 1178, 504, 12301, 5637, 4601, 8663, 8337, 12474, 2]
// Exports: default

// Module 12473 (ApplicationCommandBar)
...
import DescriptionEllipsisDefault from "DescriptionEllipsis" /* 12474 */;
...
obj2.applicationCommandOption = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5491).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
let obj5 = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5491).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
...
obj2.completeCommandOption = { backgroundColor: fn(5491).DARK_PRIMARY_660_LIGHT_PRIMARY_300 };
...
export default function _default(command) {
  ...
  if (tmp22) {
    ...
    tmp22 = ref(section(5637), obj4);
  }
  const items5 = [tmp22, ref(command(4601).Text, { style: tmp.applicationName, lineClamp: 1, variant: "text-sm/semibold", color: "mobile-text-heading-primary", children: `/ ${command.displayName}` }), , ];
  ...
  if (tmp4) {
    ...
    items7[1] = tmp25(tmp12(4601).Text, obj7);
  ...
  const items8 = [c10(closure_6, obj3), ref(command(8663).FormDivider, { style: tmp.applicationDescriptionDivider }), ref(stateFromStores, { command, option: currentOption, optionState: tmp17 }), ref(command(8663).FormDivider, { style: tmp.applicationDescriptionDivider })];
