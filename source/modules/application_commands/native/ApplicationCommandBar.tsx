...
// Dependencies: [32, 19, 17, 2022, 21, 4722, 576, 5611, 5292, 1115, 1177, 504, 12473, 5757, 4718, 8831, 8504, 12647, 2]
// Exports: default

// Module 12646 (ApplicationCommandBar)
...
import application_commands_ApplicationCommandUtils from "application_commands/ApplicationCommandUtils" /* 12473 */;
import DescriptionEllipsisDefault from "DescriptionEllipsis" /* 12647 */;
...
obj2.applicationCommandOption = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5611).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
let obj5 = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5611).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
...
obj2.completeCommandOption = { backgroundColor: fn(5611).DARK_PRIMARY_660_LIGHT_PRIMARY_300 };
...
export default function _default(command) {
  ...
  if (tmp22) {
    ...
    tmp22 = ref(section(5757), obj4);
  }
  const items5 = [tmp22, ref(command(4718).Text, { style: tmp.applicationName, lineClamp: 1, variant: "text-sm/semibold", color: "mobile-text-heading-primary", children: `/ ${command.displayName}` }), , ];
  ...
  if (tmp4) {
    ...
    items7[1] = tmp25(tmp12(4718).Text, obj7);
  ...
  const items8 = [c10(closure_6, obj3), ref(command(8831).FormDivider, { style: tmp.applicationDescriptionDivider }), ref(stateFromStores, { command, option: currentOption, optionState: tmp17 }), ref(command(8831).FormDivider, { style: tmp.applicationDescriptionDivider })];
