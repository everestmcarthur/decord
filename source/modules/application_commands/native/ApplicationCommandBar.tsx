...
// Dependencies: [32, 19, 17, 2022, 21, 4640, 576, 5529, 5210, 1115, 1177, 504, 12382, 5675, 4636, 8748, 8421, 12556, 2]
// Exports: default

// Module 12555 (ApplicationCommandBar)
...
import application_commands_ApplicationCommandUtils from "application_commands/ApplicationCommandUtils" /* 12382 */;
import DescriptionEllipsisDefault from "DescriptionEllipsis" /* 12556 */;
...
obj2.applicationCommandOption = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5529).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
let obj5 = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5529).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
...
export default function _default(command) {
  ...
  const items5 = [tmp22, ref(command(4636).Text, { style: tmp.applicationName, lineClamp: 1, variant: "text-sm/semibold", color: "mobile-text-heading-primary", children: `/ ${command.displayName}` }), , ];
  ...
  const items8 = [c10(closure_6, obj3), ref(command(8748).FormDivider, { style: tmp.applicationDescriptionDivider }), ref(stateFromStores, { command, option: currentOption, optionState: tmp17 }), ref(command(8748).FormDivider, { style: tmp.applicationDescriptionDivider })];
