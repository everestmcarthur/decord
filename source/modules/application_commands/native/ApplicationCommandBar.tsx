...
// Dependencies: [32, 19, 17, 2021, 21, 4606, 576, 5492, 5174, 1114, 1178, 504, 12324, 5638, 4602, 8684, 8358, 12497, 2]
// Exports: default

// Module 12496 (ApplicationCommandBar)
...
import DescriptionEllipsisDefault from "DescriptionEllipsis" /* 12497 */;
...
obj2.applicationCommandOption = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5492).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
let obj5 = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5492).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
...
obj2.completeCommandOption = { backgroundColor: fn(5492).DARK_PRIMARY_660_LIGHT_PRIMARY_300 };
...
export default function _default(command) {
  ...
  if (tmp22) {
    ...
    tmp22 = ref(section(5638), obj4);
  }
  const items5 = [tmp22, ref(command(4602).Text, { style: tmp.applicationName, lineClamp: 1, variant: "text-sm/semibold", color: "mobile-text-heading-primary", children: `/ ${command.displayName}` }), , ];
  ...
  if (tmp4) {
    ...
    items7[1] = tmp25(tmp12(4602).Text, obj7);
  ...
  const items8 = [c10(closure_6, obj3), ref(command(8684).FormDivider, { style: tmp.applicationDescriptionDivider }), ref(stateFromStores, { command, option: currentOption, optionState: tmp17 }), ref(command(8684).FormDivider, { style: tmp.applicationDescriptionDivider })];
