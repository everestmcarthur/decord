...
// Dependencies: [32, 19, 17, 2021, 21, 4607, 576, 5493, 5175, 1114, 1178, 504, 12326, 5639, 4603, 8686, 8360, 12499, 2]
// Exports: default

// Module 12498 (ApplicationCommandBar)
...
import DescriptionEllipsisDefault from "DescriptionEllipsis" /* 12499 */;
...
obj2.applicationCommandOption = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5493).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
let obj5 = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5493).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
...
obj2.completeCommandOption = { backgroundColor: fn(5493).DARK_PRIMARY_660_LIGHT_PRIMARY_300 };
...
export default function _default(command) {
  ...
  if (tmp22) {
    ...
    tmp22 = ref(section(5639), obj4);
  }
  const items5 = [tmp22, ref(command(4603).Text, { style: tmp.applicationName, lineClamp: 1, variant: "text-sm/semibold", color: "mobile-text-heading-primary", children: `/ ${command.displayName}` }), , ];
  ...
  if (tmp4) {
    ...
    items7[1] = tmp25(tmp12(4603).Text, obj7);
  ...
  const items8 = [c10(closure_6, obj3), ref(command(8686).FormDivider, { style: tmp.applicationDescriptionDivider }), ref(stateFromStores, { command, option: currentOption, optionState: tmp17 }), ref(command(8686).FormDivider, { style: tmp.applicationDescriptionDivider })];
