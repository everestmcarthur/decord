...
// Dependencies: [19, 17, 10531, 21, 4722, 576, 1177, 8386, 4718, 1115, 10548, 2]

// Module 10550 (EmojiPickerListComponents)
...
const memoResult = noop.memo(() => {
  ...
  const items = [React4(native.Icon, { source: _modDef8386, size: native.Icon.Sizes.SMALL }), ];
