...
// Dependencies: [32, 19, 17, 1074, 21, 4640, 4376, 9649, 5210, 1115, 10497, 2]
// Exports: default

// Module 10508 (EmojiPickerCategoriesUnicodeShortcutItem)
  ...
  const fn2 = function b(end, current) {
    if (null != end) {
      if (!obj.cheapWorkletShallowEqual(end, tmp)) {
        ...
        tmp2(4376).runOnJS(closure_5)(result > diff);
