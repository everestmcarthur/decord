...
// Dependencies: [32, 19, 17, 5515, 1074, 21, 4607, 576, 4343, 4608, 4611, 5175, 5636, 10440, 5147, 2]

// Module 10439 (EmojiPickerCategoriesItem)
...
let EmojiCategoryTypes = fn(5515).EmojiCategoryTypes;
