...
// Dependencies: [1375, 1397, 1875, 4607, 10477, 1897, 2]
// Exports: openEmojiActionSheet

// Module 10476 (openEmojiActionSheet)
...
export const openEmojiActionSheet = function openEmojiActionSheet(uniqueName) {
  if (null != uniqueName.uniqueName) {
    ...
    if (null == uniqueName.id) {
      ...
      obj6.openLazy(asyncRequireImpl(10477, dependencyMap.paths), "MessageEmojiActionSheet", obj7, "stack");
    }
