...
// Dependencies: [1375, 1397, 1875, 4606, 10461, 1897, 2]
// Exports: openEmojiActionSheet

// Module 10460 (openEmojiActionSheet)
...
export const openEmojiActionSheet = function openEmojiActionSheet(uniqueName) {
  if (null != uniqueName.uniqueName) {
    ...
    if (null == uniqueName.id) {
      ...
      obj6.openLazy(asyncRequireImpl(10461, dependencyMap.paths), "MessageEmojiActionSheet", obj7, "stack");
    }
