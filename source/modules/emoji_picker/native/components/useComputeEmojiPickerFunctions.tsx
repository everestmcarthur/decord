...
// Dependencies: [32, 19, 5551, 10437, 10441, 4292, 12, 10432, 1934, 2]
// Exports: default

// Module 10440 (useComputeEmojiPickerFunctions)
...
const constants3 = fn(10437).EmojiPickerRenderingDataType;
const size = fn(2);
