...
// Dependencies: [32, 19, 5514, 10379, 10383, 4259, 12, 10374, 1933, 2]
// Exports: default

// Module 10382 (useComputeEmojiPickerFunctions)
...
const constants3 = fn(10379).EmojiPickerRenderingDataType;
const size = fn(2);
