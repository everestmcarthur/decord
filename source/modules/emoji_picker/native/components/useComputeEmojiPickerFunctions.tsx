...
// Dependencies: [32, 19, 5515, 10381, 10385, 4259, 12, 10376, 1933, 2]
// Exports: default

// Module 10384 (useComputeEmojiPickerFunctions)
...
const constants3 = fn(10381).EmojiPickerRenderingDataType;
const size = fn(2);
