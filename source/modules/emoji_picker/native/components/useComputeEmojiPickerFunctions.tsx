...
// Dependencies: [32, 19, 5513, 10360, 10364, 4257, 12, 10355, 1933, 2]
// Exports: default

// Module 10363 (useComputeEmojiPickerFunctions)
...
const constants3 = fn(10360).EmojiPickerRenderingDataType;
const size = fn(2);
