...
// Dependencies: [32, 19, 5633, 10531, 10535, 4375, 12, 10526, 1934, 2]
// Exports: default

// Module 10534 (useComputeEmojiPickerFunctions)
...
const constants3 = fn(10531).EmojiPickerRenderingDataType;
const size = fn(2);
