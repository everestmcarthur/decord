...
// Dependencies: [32, 19, 5544, 10418, 10422, 4289, 12, 10413, 1933, 2]
// Exports: default

// Module 10421 (useComputeEmojiPickerFunctions)
...
const constants3 = fn(10418).EmojiPickerRenderingDataType;
const size = fn(2);
