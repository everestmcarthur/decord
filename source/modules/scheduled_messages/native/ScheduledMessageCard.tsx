...
// Dependencies: [19, 17, 1957, 1074, 21, 4606, 576, 504, 1100, 4809, 5658, 12308, 5628, 12309, 10201, 4602, 1114, 7917, 12310, 12302, 12311, 2]

// Module 12307 (ScheduledMessageCard)
...
import ForLaterCardStatusHeader from "ForLaterCardStatusHeader" /* 12310 */;
import ScheduledMessageCardActionButtonsDefault from "ScheduledMessageCardActionButtons" /* 12311 */;
...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_7(tmp2(12308).ForLaterCardHeader, obj4);
    const obj5 = { style: tmp.cardDivider };
    items1[2] = closure_7(View, obj5);
    if (isPendingRemoval) {
      const obj6 = { style: tmp.pendingRemoval, children: tmp10(tmp2(5628).ActivityIndicator, { size: "small" }) };
      ...
      if (length > 0) {
        ...
        const items2 = [tmp10(tmp2(10201).AttachmentIcon, obj9), ];
        ...
        items2[1] = tmp10(tmp2(4602).Text, obj10);
        obj8.children = items2;
        tmp9Result = tmp9(tmp12, obj8);
      }
      obj7.footer = tmp9Result;
      tmp10Result = tmp10(tmp2(12309).ForLaterMessageRow, obj7);
    }
    items1[3] = tmp10Result;
    obj2.children = items1;
    return closure_8(tmp2(5658).Card, obj2);
  }
