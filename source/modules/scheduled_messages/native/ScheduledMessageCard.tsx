...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    if (isPendingRemoval) {
      const obj6 = { style: tmp.pendingRemoval, children: tmp10(tmp2(5658).ActivityIndicator, { size: "small" }) };
      ...
      if (length > 0) {
        ...
        const items2 = [tmp10(tmp2(10240).AttachmentIcon, obj9), ];
        ...
        items2[1] = tmp10(tmp2(4632).Text, obj10);
    ...
    return closure_8(tmp2(5688).Card, obj2);
  }
