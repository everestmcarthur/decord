...
// Dependencies: [19, 17, 1958, 1074, 21, 4639, 576, 504, 1101, 4842, 5692, 12349, 5662, 12350, 10242, 4635, 1115, 7950, 12351, 12343, 12352, 2]

// Module 12348 (ScheduledMessageCard)
...
import ForLaterCardStatusHeader from "ForLaterCardStatusHeader" /* 12351 */;
import ScheduledMessageCardActionButtonsDefault from "ScheduledMessageCardActionButtons" /* 12352 */;
...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    if (isPendingRemoval) {
      const obj6 = { style: tmp.pendingRemoval, children: tmp10(tmp2(5662).ActivityIndicator, { size: "small" }) };
      ...
      if (length > 0) {
        ...
        const items2 = [tmp10(tmp2(10242).AttachmentIcon, obj9), ];
        ...
        items2[1] = tmp10(tmp2(4635).Text, obj10);
        obj8.children = items2;
        tmp9Result = tmp9(tmp12, obj8);
      }
      obj7.footer = tmp9Result;
      tmp10Result = tmp10(tmp2(12350).ForLaterMessageRow, obj7);
    }
