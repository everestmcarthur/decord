...
// Dependencies: [19, 17, 1958, 1074, 21, 4640, 576, 504, 1101, 4843, 5695, 12366, 5665, 12367, 10261, 4636, 1115, 7965, 12368, 12360, 12369, 2]
...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    if (isPendingRemoval) {
      const obj6 = { style: tmp.pendingRemoval, children: tmp10(tmp2(5665).ActivityIndicator, { size: "small" }) };
      ...
      if (length > 0) {
        ...
        const items2 = [tmp10(tmp2(10261).AttachmentIcon, obj9), ];
        ...
        items2[1] = tmp10(tmp2(4636).Text, obj10);
        obj8.children = items2;
        tmp9Result = tmp9(tmp12, obj8);
      }
      obj7.footer = tmp9Result;
      tmp10Result = tmp10(tmp2(12367).ForLaterMessageRow, obj7);
    }
