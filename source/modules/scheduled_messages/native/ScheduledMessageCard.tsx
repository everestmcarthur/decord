...
// Dependencies: [19, 17, 1958, 1074, 21, 4638, 576, 504, 1101, 4841, 5693, 12357, 5663, 12358, 10250, 4634, 1115, 7959, 12359, 12351, 12360, 2]

// Module 12356 (ScheduledMessageCard)
...
import ScheduledMessageCardActionButtonsDefault from "ScheduledMessageCardActionButtons" /* 12360 */;
...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    if (isPendingRemoval) {
      const obj6 = { style: tmp.pendingRemoval, children: tmp10(tmp2(5663).ActivityIndicator, { size: "small" }) };
      ...
      if (length > 0) {
        ...
        const items2 = [tmp10(tmp2(10250).AttachmentIcon, obj9), ];
        ...
        items2[1] = tmp10(tmp2(4634).Text, obj10);
        obj8.children = items2;
        tmp9Result = tmp9(tmp12, obj8);
      }
      obj7.footer = tmp9Result;
      tmp10Result = tmp10(tmp2(12358).ForLaterMessageRow, obj7);
    }
