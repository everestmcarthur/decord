...
// Dependencies: [17, 21, 4638, 576, 12362, 4634, 1115, 10250, 12351, 11101, 2]
// Exports: default

// Module 12361 (ScheduledMessagesIntro)
...
export default function ScheduledMessagesIntro() {
  ...
  const items = [timestampProducer(React3, { source: _modDef12362, style: tmp.upsellImage }), , ];
  ...
  const obj3 = { source: _modDef12362, style: tmp.upsellImage };
