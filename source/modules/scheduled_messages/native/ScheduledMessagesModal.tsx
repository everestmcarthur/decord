...
// Dependencies: [32, 19, 17, 12355, 1074, 1374, 7960, 21, 7292, 4638, 576, 1612, 1115, 4374, 5059, 5717, 7978, 1364, 5710, 4841, 7958, 504, 12356, 7959, 5663, 12361, 9017, 7272, 9456, 1094, 10106, 4295, 12363, 2]
// Exports: default

// Module 12354 (ScheduledMessagesModal)
...
import ScheduledMessageActionCreators from "ScheduledMessageActionCreators" /* 7958 */;
import HeaderShared from "HeaderShared" /* 7978 */;
import PremiumUpsellUtils from "PremiumUpsellUtils" /* 9456 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 10106 */;
import ScheduledMessageCardDefault from "ScheduledMessageCard" /* 12356 */;
import NitroLimitUpsellBarDefault from "NitroLimitUpsellBar" /* 12363 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import ScheduledMessageStore from "ScheduledMessageStore" /* 12355 */;

const NavigatorHeader = tmp4(5710);
require = fn;
...
export default function ScheduledMessagesModal() {
  ...
  obj5 = PlatformUtils;
  obj6.headerLeft = NavigatorHeader.getHeaderCloseButton(sharedValue(4841).pop);
  ({ headerLeftContainer: obj4.headerLeftContainerStyle, headerRightContainer: obj4.headerRightContainerStyle } = tmp);
  const items1 = [closure_10(_mod5717.Header, obj6), , ];
  const obj7 = { style: null };
  const items2 = [tmp.headerBorder, animatedStyle];
  obj7.style = items2;
  items1[1] = closure_10(sharedValue(4374).View, obj7);
