...
// Dependencies: [32, 19, 17, 12347, 1074, 1374, 7951, 21, 7289, 4639, 576, 1612, 1115, 4376, 5058, 5716, 7969, 1364, 5709, 4842, 7949, 504, 12348, 7950, 5662, 12353, 9006, 7269, 9445, 1094, 10098, 4297, 12355, 2]
// Exports: default

// Module 12346 (ScheduledMessagesModal)
...
import ScheduledMessageActionCreators from "ScheduledMessageActionCreators" /* 7949 */;
import HeaderShared from "HeaderShared" /* 7969 */;
import PremiumUpsellUtils from "PremiumUpsellUtils" /* 9445 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 10098 */;
import ScheduledMessageCardDefault from "ScheduledMessageCard" /* 12348 */;
import NitroLimitUpsellBarDefault from "NitroLimitUpsellBar" /* 12355 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import ScheduledMessageStore from "ScheduledMessageStore" /* 12347 */;

const NavigatorHeader = tmp4(5709);
require = fn;
...
export default function ScheduledMessagesModal() {
  ...
  obj5 = PlatformUtils;
  obj6.headerLeft = NavigatorHeader.getHeaderCloseButton(sharedValue(4842).pop);
  ({ headerLeftContainer: obj4.headerLeftContainerStyle, headerRightContainer: obj4.headerRightContainerStyle } = tmp);
  const items1 = [closure_10(_mod5716.Header, obj6), , ];
  const obj7 = { style: null };
  const items2 = [tmp.headerBorder, animatedStyle];
  obj7.style = items2;
  items1[1] = closure_10(sharedValue(4376).View, obj7);
