...
// Dependencies: [32, 19, 5363, 4979, 1955, 1944, 4458, 504, 1946, 2]
// Exports: useScheduledMessageDraftCoachmarkState

// Module 12128 (ScheduledMessageDraftCoachmarkHooks)
...
export const useScheduledMessageDraftCoachmarkState = function useScheduledMessageDraftCoachmarkState(channel) {
  ...
  let result = channel(4458).useIsDismissibleContentDismissed_UNSAFE(closure_7);
