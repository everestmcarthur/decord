...
// Dependencies: [1074, 4338, 1115, 4602, 6727, 7965, 7969, 7296, 4984, 4843, 12363, 1897, 2]
...
// Module 7968 (ScheduledMessageNotifications)
...
export const handleScheduleMessageError = function handleScheduleMessageError(body) {
  ...
  if (code === AbortCodes.TOO_MANY_SCHEDULED_MESSAGES) {
    ...
    if (scheduledMessagesLimit.isUpgradable) {
      const items = [tmp11(7296).SCHEDULED_MESSAGES_ROADBLOCK];
      tmp11(7969)(items);
      ...
      tmp11(4984).show(obj2);
      const tmp11Result2 = tmp11(4984);
    }
  } else {
