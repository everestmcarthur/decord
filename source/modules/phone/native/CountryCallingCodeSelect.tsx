...
// Dependencies: [32, 19, 17, 4790, 21, 4574, 576, 6958, 4791, 7063, 5531, 5619, 4570, 7064, 7067, 7068, 1114, 7069, 2]
// Exports: default

// Module 7062 (CountryCallingCodeSelect)
...
const getI18NCountryName = fn(4790).getI18NCountryName;
const jsxProd = fn(21);
