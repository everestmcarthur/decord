...
// Dependencies: [32, 19, 17, 4823, 21, 4607, 576, 7016, 4824, 7123, 5569, 5657, 4603, 7124, 7127, 7128, 1114, 7129, 2]
// Exports: default

// Module 7122 (CountryCallingCodeSelect)
...
const getI18NCountryName = fn(4823).getI18NCountryName;
const jsxProd = fn(21);
