...
// Dependencies: [32, 19, 17, 4821, 21, 4605, 576, 6994, 4822, 7101, 5567, 5655, 4601, 7102, 7105, 7106, 1114, 7107, 2]
// Exports: default

// Module 7100 (CountryCallingCodeSelect)
...
const getI18NCountryName = fn(4821).getI18NCountryName;
const jsxProd = fn(21);
