...
// Module 9089 (UserProfileApplicationWidgetBottomCollectionLayout)
...
function CollectionItem(arg0) {
  ...
  if (null != fieldValue) {
    ...
    tmp11 = React4(tmp3(9083).ImageSkeleton, obj6);
    tmp12 = React4;
  }
  const items1 = [tmp11, ];
  ...
  if ("value" === singleStringOrSkeleton.status) {
    ...
    let tmp12Result = tmp12(tmp3(4601).Text, obj8);
  } else {
    tmp12Result = tmp12(tmp3(9083).TextSkeleton, { variant: "text-xs/medium", widthChars: 6 });
  }
  ...
  if ("value" === singleStringOrSkeleton1.status) {
    ...
    let tmp12Result2 = tmp12(tmp3(4601).Text, obj9);
  } else {
    tmp12Result2 = tmp12(tmp3(9083).TextSkeleton, { variant: "text-xxs/medium", widthChars: 10 });
  }
