...
// Dependencies: [19, 17, 21, 4605, 576, 8995, 9082, 4601, 9083, 2]
// Exports: default

// Module 9087 (UserProfileApplicationWidgetBottomStatsLayout)
      ...
      if (null == item) {
        ...
        if ("value" === iter.label.status) {
          ...
          if ("skeleton" === iter.label.status) {
            tmp5Result = tmp5(Text(9083).TextSkeleton, { variant: "text-xs/normal", widthChars: 6 });
          }
        }
        items[1] = tmp5Result;
        obj.children = items;
