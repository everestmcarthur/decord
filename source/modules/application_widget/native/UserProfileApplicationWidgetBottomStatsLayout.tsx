...
// Dependencies: [19, 17, 21, 4638, 576, 9069, 9156, 4634, 9157, 2]
// Exports: default

// Module 9161 (UserProfileApplicationWidgetBottomStatsLayout)
      ...
      if (null == item) {
        ...
        if ("value" === iter.label.status) {
          ...
          if ("skeleton" === iter.label.status) {
            tmp5Result = tmp5(Text(9157).TextSkeleton, { variant: "text-xs/normal", widthChars: 6 });
          }
        }
        items[1] = tmp5Result;
        obj.children = items;
