...
// Dependencies: [19, 17, 21, 4607, 576, 9018, 9105, 4603, 9106, 2]
// Exports: default

// Module 9110 (UserProfileApplicationWidgetBottomStatsLayout)
      ...
      if (null == item) {
        ...
        if ("value" === iter.label.status) {
          ...
          if ("skeleton" === iter.label.status) {
            tmp5Result = tmp5(Text(9106).TextSkeleton, { variant: "text-xs/normal", widthChars: 6 });
          }
        }
        items[1] = tmp5Result;
        obj.children = items;
