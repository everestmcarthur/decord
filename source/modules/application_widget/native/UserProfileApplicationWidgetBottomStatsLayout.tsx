...
// Dependencies: [19, 17, 21, 4639, 576, 9058, 9145, 4635, 9146, 2]
// Exports: default

// Module 9150 (UserProfileApplicationWidgetBottomStatsLayout)
      ...
      if (null == item) {
        ...
        if ("value" === iter.label.status) {
          ...
          if ("skeleton" === iter.label.status) {
            tmp5Result = tmp5(Text(9146).TextSkeleton, { variant: "text-xs/normal", widthChars: 6 });
          }
        }
        items[1] = tmp5Result;
        obj.children = items;
