...
// Module 9024 (UserProfileApplicationWidgetBottomProgressLayout)
...
export default function UserProfileApplicationWidgetBottomProgressLayout(arg0) {
  ...
  if (null != fieldValue) {
    ...
    obj2[0] = tmp.image;
    tmp14 = callback(tmp3(9019).ImageSkeleton, obj2);
    tmp15 = callback;
  }
  const items3 = [tmp14, ];
  ...
  if ("value" === singleStringOrSkeleton.status) {
    ...
    tmp15Result = tmp15(tmp3(9019).TextSkeleton, { variant: "heading-sm/medium" });
  }
  ...
  if ("value" === singleStringOrSkeleton1.status) {
    ...
    tmp15Result = tmp15(tmp3(9019).TextSkeleton, { variant: "text-xs/medium" });
  }
  ...
  if (null != iter) {
    ...
    items7[1] = tmp15(tmp3(9019).TextSkeleton, { variant: "text-sm/medium", widthChars: 4 });
    obj8[1] = items7;
