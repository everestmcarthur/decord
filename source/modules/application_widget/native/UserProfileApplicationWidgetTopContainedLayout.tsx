...
// Dependencies: [19, 17, 21, 4722, 576, 9164, 9251, 9252, 2]
// Exports: default

// Module 9255 (UserProfileApplicationWidgetTopContainedLayout)
...
export default function UserProfileApplicationWidgetTopContainedLayout(header) {
  ...
  if (null != fieldValue) {
    ...
    tmp12Result = tmp12(tmp2(9252).ImageSkeleton, obj10);
  }
