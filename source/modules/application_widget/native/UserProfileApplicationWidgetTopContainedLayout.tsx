...
// Dependencies: [19, 17, 21, 4639, 576, 9058, 9145, 9146, 2]
// Exports: default

// Module 9149 (UserProfileApplicationWidgetTopContainedLayout)
...
export default function UserProfileApplicationWidgetTopContainedLayout(header) {
  ...
  if (null != fieldValue) {
    ...
    tmp12Result = tmp12(tmp2(9146).ImageSkeleton, obj10);
  }
