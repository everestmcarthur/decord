...
// Dependencies: [5, 9169, 1074, 9171, 559, 1091, 573, 1271, 1231, 2]
// Exports: fetchDeveloperWidgetConfigs, fetchFeaturedWidgetConfigs, fetchWidgetConfigs

// Module 9170 (ApplicationWidgetConfigActions)
import DurationsDefault from "Durations" /* 1091 */;
import HTTPUtils from "HTTPUtils" /* 1271 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import ApplicationWidgetConfigStore from "ApplicationWidgetConfigStore" /* 9169 */;
...
const promiseDeduper = new fn(9171).PromiseDeduper();
...
const promiseDeduper3 = new fn(9171).PromiseDeduper();
const promiseDeduper4 = new fn(9171).PromiseDeduper();
const size = fn(2);
