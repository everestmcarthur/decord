...
// Function ID: 7174
// Name: JoinServer
// Dependencies: [19, 17, 7174, 21, 4722, 576, 7175, 4718, 1115, 7177, 1484, 1478, 6798, 5144, 2]
// Exports: default

// Module 7173 (JoinServer)
...
export default function JoinServer(arg0) {
  ...
  if (useWindowDimensionsDefault().height > closure_6) {
    ...
    const items2 = [closure_8(tmp4(4718).Text, obj5), ];
    ...
    items2[1] = closure_8(tmp4(4718).Text, obj6);
  ...
  items3[2] = closure_8(navigation(4718).Text, obj9);
  ...
  items5[1] = closure_8(navigation(5144).Button, obj13);
  ...
  items5[3] = closure_8(navigation(5144).Button, obj14);
