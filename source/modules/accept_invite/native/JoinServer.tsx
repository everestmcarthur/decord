...
// Function ID: 7030
// Name: JoinServer
// Dependencies: [19, 17, 7030, 21, 4605, 576, 7031, 4601, 1114, 7033, 1483, 1477, 6655, 5025, 2]
// Exports: default
...
export default function JoinServer(arg0) {
  ...
  if (useWindowDimensionsDefault().height > closure_6) {
    ...
    const items2 = [closure_8(tmp4(4601).Text, obj5), ];
    ...
    items2[1] = closure_8(tmp4(4601).Text, obj6);
  ...
  items3[2] = closure_8(navigation(4601).Text, obj9);
  ...
  items5[1] = closure_8(navigation(5025).Button, obj13);
  ...
  items5[3] = closure_8(navigation(5025).Button, obj14);
