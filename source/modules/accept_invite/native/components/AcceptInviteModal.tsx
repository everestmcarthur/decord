...
// Dependencies: [19, 7085, 21, 1249, 4624, 12851, 8867, 7107, 2]
// Exports: default

// Module 17454 (AcceptInviteModal)
import discord_common_AnalyticsUtils from "discord_common/AnalyticsUtils" /* 1249 */;
import InviteCodeUtils from "InviteCodeUtils" /* 4624 */;
import AcceptInviteContainerDefault from "AcceptInviteContainer" /* 12851 */;
...
export default function AcceptInviteModal(arg0) {
  ...
  obj.screens = noop.useMemo(() => {
    ...
    obj2.render = function render() {
      ...
      obj.onPressClose = closure_0(8867).clearDisplayedInvite;
