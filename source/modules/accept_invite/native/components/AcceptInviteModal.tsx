...
// Dependencies: [19, 7088, 21, 1249, 4623, 12859, 8878, 7110, 2]
// Exports: default

// Module 17510 (AcceptInviteModal)
import discord_common_AnalyticsUtils from "discord_common/AnalyticsUtils" /* 1249 */;
import InviteCodeUtils from "InviteCodeUtils" /* 4623 */;
import AcceptInviteContainerDefault from "AcceptInviteContainer" /* 12859 */;
...
export default function AcceptInviteModal(arg0) {
  ...
  obj.screens = noop.useMemo(() => {
    ...
    obj2.render = function render() {
      ...
      obj.onPressClose = closure_0(8878).clearDisplayedInvite;
