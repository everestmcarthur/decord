...
// Dependencies: [19, 7092, 21, 1249, 4625, 12867, 8894, 7114, 2]
// Exports: default

// Module 17551 (AcceptInviteModal)
import discord_common_AnalyticsUtils from "discord_common/AnalyticsUtils" /* 1249 */;
import InviteCodeUtils from "InviteCodeUtils" /* 4625 */;
import AcceptInviteContainerDefault from "AcceptInviteContainer" /* 12867 */;
...
export default function AcceptInviteModal(arg0) {
  ...
  obj.screens = noop.useMemo(() => {
    ...
    obj2.render = function render() {
      ...
      obj.onPressClose = closure_0(8894).clearDisplayedInvite;
