...
// Function ID: 12813
// Name: AcceptInvite
// Dependencies: [32, 19, 17, 1074, 21, 4607, 576, 1369, 4308, 5633, 12813, 12816, 1396, 1430, 12821, 1477, 5659, 2]
// Exports: default

// Module 12812 (AcceptInvite)
...
function AcceptInviteCardComponent(invite) {
  ...
  if (null == invite) {
    ...
    obj2.invite = invite;
    return closure_9(first(12813), obj2);
  } else if (tmp22.ERROR === first) {
    let obj = {};
    const merged1 = Object.assign(invite);
    obj.invite = invite;
    return closure_9(first(12816), obj);
  } else {
    return closure_9(InviteResolving, {});
  }
}
...
export default function AcceptInvite(invite) {
  ...
  if (null == splash) {
    let guildSplashSource = tmp3(12821);
  } else {
