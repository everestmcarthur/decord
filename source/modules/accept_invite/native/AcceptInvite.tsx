...
// Function ID: 12861
// Name: AcceptInvite
// Dependencies: [32, 19, 17, 1074, 21, 4638, 576, 1370, 4339, 5667, 12861, 12864, 1397, 1431, 12869, 1478, 5693, 2]
// Exports: default

// Module 12860 (AcceptInvite)
...
function AcceptInviteCardComponent(invite) {
  ...
  if (null == invite) {
    ...
    obj2.invite = invite;
    return closure_9(first(12861), obj2);
  } else if (tmp22.ERROR === first) {
    let obj = {};
    const merged1 = Object.assign(invite);
    obj.invite = invite;
    return closure_9(first(12864), obj);
  } else {
    return closure_9(InviteResolving, {});
  }
}
...
export default function AcceptInvite(invite) {
  ...
  if (null == splash) {
    let guildSplashSource = tmp3(12869);
  } else {
