...
// Function ID: 12853
// Name: AcceptInvite
// Dependencies: [32, 19, 17, 1074, 21, 4639, 576, 1370, 4341, 5666, 12853, 12856, 1397, 1431, 12861, 1478, 5692, 2]
// Exports: default

// Module 12852 (AcceptInvite)
...
function AcceptInviteCardComponent(invite) {
  ...
  if (null == invite) {
    ...
    obj2.invite = invite;
    return closure_9(first(12853), obj2);
  } else if (tmp22.ERROR === first) {
    let obj = {};
    const merged1 = Object.assign(invite);
    obj.invite = invite;
    return closure_9(first(12856), obj);
  } else {
    return closure_9(InviteResolving, {});
  }
}
...
export default function AcceptInvite(invite) {
  ...
  if (null == splash) {
    let guildSplashSource = tmp3(12861);
  } else {
