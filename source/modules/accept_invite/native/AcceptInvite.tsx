...
// Function ID: 12748
// Name: AcceptInvite
// Dependencies: [32, 19, 17, 1074, 21, 4574, 576, 1369, 4275, 5595, 12748, 12751, 1396, 1430, 12756, 1477, 5621, 2]
// Exports: default

// Module 12747 (AcceptInvite)
...
function AcceptInviteCardComponent(invite) {
  ...
  if (null == invite) {
    ...
    obj2.invite = invite;
    return closure_9(first(12748), obj2);
  } else if (tmp22.ERROR === first) {
    let obj = {};
    const merged1 = Object.assign(invite);
    obj.invite = invite;
    return closure_9(first(12751), obj);
  } else {
    return closure_9(InviteResolving, {});
  }
}
...
export default function AcceptInvite(invite) {
  ...
  if (null == splash) {
    let guildSplashSource = tmp3(12756);
  } else {
