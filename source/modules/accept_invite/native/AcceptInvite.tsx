...
// Function ID: 12811
// Name: AcceptInvite
// Dependencies: [32, 19, 17, 1074, 21, 4606, 576, 1369, 4308, 5632, 12811, 12814, 1396, 1430, 12819, 1477, 5658, 2]
// Exports: default
...
function AcceptInviteCardComponent(invite) {
  ...
  if (null == invite) {
    ...
    obj2.invite = invite;
    return closure_9(first(12811), obj2);
...
export default function AcceptInvite(invite) {
  ...
  if (null == splash) {
    let guildSplashSource = tmp3(12819);
  } else {
