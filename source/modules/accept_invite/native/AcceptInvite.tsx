...
// Function ID: 12788
// Name: AcceptInvite
// Dependencies: [32, 19, 17, 1074, 21, 4605, 576, 1369, 4306, 5631, 12788, 12791, 1396, 1430, 12796, 1477, 5657, 2]
// Exports: default

// Module 12787 (AcceptInvite)
...
function AcceptInviteCardComponent(invite) {
  ...
  if (null == invite) {
    ...
    obj2.invite = invite;
    return closure_9(first(12788), obj2);
...
export default function AcceptInvite(invite) {
  ...
  if (null == splash) {
    let guildSplashSource = tmp3(12796);
  } else {
