...
// Dependencies: [5, 2026, 13799, 9198, 1074, 1115, 1370, 7448, 1241, 17981, 1255, 2]
...
// Module 17982 (GlobalDiscoveryServersUtils)
import util from "util" /* 1115 */;
import v1 from "v1" /* 1255 */;
import GlobalUtils from "GlobalUtils" /* 1370 */;
import GlobalDiscoveryServersSearchResultsStoreDefault from "GlobalDiscoveryServersSearchResultsStore" /* 13799 */;
import GlobalDiscoveryServersFeaturedSearchManagerDefault from "GlobalDiscoveryServersFeaturedSearchManager" /* 17981 */;
...
export const fromDiscoverableGuildSearchResult = function fromDiscoverableGuildSearchResult(id) {
  const obj = { id: id.id, name: id.name, description: id.description, splash: id.splash, banner: id.banner, icon: id.icon, features: new Set(id.features), presenceCount: null, memberCount: null, premiumSubscriptionCount: "r", preferredLocale: "isArray", discoverySplash: 1174405818, emojis: 0. };
