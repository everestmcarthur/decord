...
// Dependencies: [32, 19, 17, 1085, 21, 4638, 576, 8857, 8821, 8389, 8437, 1365, 8847, 8858, 2]
// Exports: default

// Module 8856 (GameProfileMedia)
import nativeDefault from "native" /* 576 */;
import openMediaModal from "openMediaModal" /* 8389 */;
import GameProfileAnalyticUtils from "GameProfileAnalyticUtils" /* 8821 */;
import GameProfileMediaSources from "GameProfileMediaSources" /* 8857 */;
...
obj2.mediaItem = { maxWidth: fn(8857).MEDIA_ITEM_MAX_WIDTH, maxHeight: fn(8857).MEDIA_ITEM_MAX_HEIGHT, borderRadius: nativeDefault.radii.lg, overflow: "hidden" };
