...
// Dependencies: [32, 19, 17, 8840, 21, 4639, 576, 4376, 8843, 5071, 8844, 4635, 2]
// Exports: default
...
export default function GameProfileHeader(game) {
  ...
  if (game != null) {
    ...
    const mapped = genres.map(tmp3(8843).getGenreText);
    joined = mapped.join(", ");
  }
  let l30Rank;
  if (game != null) {
  ...
  if (tmp18Result3) {
    ...
    tmp18Result3 = tmp18(tmp14(8844), obj17);
  }
  ...
  if (null != joined) {
    ...
    if ("" !== joined) {
      ...
      tmp18Result4 = tmp18(tmp3(4635).Text, obj19);
    }
  }
