...
// Dependencies: [19, 17, 8849, 21, 4638, 576, 4374, 8852, 8853, 5072, 8854, 4634, 2]
// Exports: default

// Module 8851 (GameProfileHeader)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4374 */;
import Text_Text from "Text/Text" /* 4634 */;
import LinearGradientDefault from "LinearGradient" /* 5072 */;
import useGameProfileHeroBackgroundURLDefault from "useGameProfileHeroBackgroundURL" /* 8853 */;
...
obj2.headerContent = { paddingTop: nativeDefault.space.PX_32, paddingHorizontal: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_12, flexDirection: "row", alignItems: "flex-end", maxWidth: fn(8849).MOBILE_GAME_PROFILE_MAX_WIDTH, alignSelf: "center", width: "100%" };
let obj4 = { paddingTop: nativeDefault.space.PX_32, paddingHorizontal: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_12, flexDirection: "row", alignItems: "flex-end", maxWidth: fn(8849).MOBILE_GAME_PROFILE_MAX_WIDTH, alignSelf: "center", width: "100%" };
...
export default function GameProfileHeader(game) {
  ...
  const mapped = genres.map(tmp2(8852).getGenreText);
  ...
  if (tmp15Result3) {
    ...
    tmp15Result3 = tmp15(tmp6(8854), obj16);
  }
  ...
  if (null != joined) {
    ...
    if ("" !== joined) {
      ...
      tmp15Result4 = tmp15(tmp2(4634).Text, obj18);
    }
  }
