...
// Dependencies: [19, 17, 8444, 21, 4606, 576, 4301, 8806, 1114, 1894, 4288, 8968, 8975, 4602, 2]
// Exports: default

// Module 8967 (GameProfileDetails)
...
const IGDB_ATTRIBUTION_LINK = fn(8444).IGDB_ATTRIBUTION_LINK;
const jsxProd = fn(21);
          ...
          if (!tmp34) {
            ...
            if (!tmp61) {
              ...
              if (obj != null) {
                ...
                if (websites != null) {
                  const mapped3 = websites.map((item) => trackAction(8975)(item, trackAction(576).colors.ICON_SUBTLE));
              ...
              const obj8 = { style: closure_2.platformsContainer, children: platforms.map((platform) => closure_1_8(game(8968).GameUpdatePlatformIcon, { platform, size: "md", color: trackAction(576).colors.ICON_SUBTLE }, platform)) };
