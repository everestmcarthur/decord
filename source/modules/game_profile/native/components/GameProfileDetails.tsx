...
// Dependencies: [19, 17, 8590, 21, 4722, 576, 4417, 8948, 1115, 1895, 4404, 9120, 9127, 4718, 2]
// Exports: default

// Module 9119 (GameProfileDetails)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import Server from "Server" /* 1895 */;
import DateUtilsAll from "DateUtils" /* 4404 */;
...
const IGDB_ATTRIBUTION_LINK = fn(8590).IGDB_ATTRIBUTION_LINK;
const jsxProd = fn(21);
          ...
          if (!tmp34) {
            ...
            if (!tmp61) {
              ...
              if (obj != null) {
                ...
                if (websites != null) {
                  const mapped3 = websites.map((item) => trackAction(9127)(item, trackAction(576).colors.ICON_SUBTLE));
              ...
              const obj8 = { style: closure_2.platformsContainer, children: platforms.map((platform) => closure_1_8(game(9120).GameUpdatePlatformIcon, { platform, size: "md", color: trackAction(576).colors.ICON_SUBTLE }, platform)) };
