...
// Dependencies: [19, 17, 8479, 21, 4639, 576, 4334, 8843, 1115, 1895, 4321, 9010, 9017, 4635, 2]
// Exports: default

// Module 9009 (GameProfileDetails)
        ...
        if (!tmp19) {
          ...
          if (!tmp34) {
            ...
            if (!tmp61) {
              ...
              const obj8 = { style: closure_2.platformsContainer, children: platforms.map((platform) => closure_1_8(game(9010).GameUpdatePlatformIcon, { platform, size: "md", color: trackAction(576).colors.ICON_SUBTLE }, platform)) };
