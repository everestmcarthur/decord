...
// Dependencies: [32, 19, 17, 8849, 8901, 21, 576, 4638, 8811, 8821, 8815, 1115, 8873, 4634, 8872, 8891, 9019, 1478, 9017, 8858, 2]
// Exports: default

// Module 9018 (GameProfileSimilarGames)
...
import useSimilarGamesDefault from "useSimilarGames" /* 9019 */;
...
let closure_8 = fn(8849).MOBILE_GAME_PROFILE_MAX_WIDTH;
...
let closure_20 = noop.memo((cardWidth) => {
  ...
  return closure_10(cardWidth(8872).GameProfileSectionSkeleton, obj);
});
let size = fn(2);
...
export default function GameProfileSimilarGames(arg0) {
  ...
  if (set.has(gameId)) {
    ...
    const obj5 = {
      horizontal: true,
      renderScrollComponent: tmp2(8858),
      data: similarGames,
      renderItem(game) {
    ...
    obj3.children = closure_10(_mod9017.FlashList, obj5);
    tmp7 = closure_10(tmp2(8872), obj3);
    const tmp2Result = tmp2(8872);
  }
};
