...
// Dependencies: [32, 19, 17, 8840, 8890, 21, 576, 4639, 8802, 8812, 8806, 1115, 8863, 4635, 8862, 8880, 9008, 1478, 9006, 8848, 2]
// Exports: default

// Module 9007 (GameProfileSimilarGames)
...
import useSimilarGamesDefault from "useSimilarGames" /* 9008 */;
...
let closure_8 = fn(8840).MOBILE_GAME_PROFILE_MAX_WIDTH;
fn(8890).SIMILAR_GAMES_BLOCKED_GAME_IDS;
const jsxProd = fn(21);
...
let closure_20 = noop.memo((cardWidth) => {
  ...
  return closure_10(cardWidth(8862).GameProfileSectionSkeleton, obj);
});
let size = fn(2);
...
export default function GameProfileSimilarGames(arg0) {
  ...
  if (set.has(gameId)) {
    ...
    const obj5 = {
      horizontal: true,
      renderScrollComponent: tmp2(8848),
      data: similarGames,
      renderItem(game) {
    ...
    obj3.children = closure_10(_mod9006.FlashList, obj5);
    tmp7 = closure_10(tmp2(8862), obj3);
    const tmp2Result = tmp2(8862);
  }
};
