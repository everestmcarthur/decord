...
// Dependencies: [5, 19, 1074, 21, 8719, 7330, 1894, 4989, 1114, 2]
// Exports: default

// Module 8928 (GameProfileGameClaimCta)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            v3 = 1;
            const obj5 = { value: v1(7330).redirectDeveloperPortalWithHandoffToken(constants.DEVELOPER_PORTAL_APPLICATIONS_GAME_IDENTITY), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          v3 = 3;
