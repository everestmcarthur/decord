...
// Dependencies: [5, 19, 1074, 21, 8777, 7389, 1894, 5026, 1114, 2]
// Exports: default
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            v3 = 1;
            const obj5 = { value: v1(7389).redirectDeveloperPortalWithHandoffToken(constants.DEVELOPER_PORTAL_APPLICATIONS_GAME_IDENTITY), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          v3 = 3;
