...
// Dependencies: [19, 17, 8849, 21, 5080, 1115, 4638, 576, 8873, 7053, 8872, 8891, 8892, 4634, 8895, 4319, 8897, 7272, 8899, 8821, 8815, 8902, 8858, 2]
// Exports: default
...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp13Result2) {
      ...
      const items6 = [tmp11(tmp34(8897).ReactionIcon, obj23), ];
      ...
      items6[1] = tmp11(tmp34(4634).Text, obj25);
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp10Result) {
    ...
    const items3 = [tmp26(tmp27(8897).ReactionIcon, obj15), ];
    ...
    items3[1] = tmp26(tmp27(4634).Text, obj17);
...
function PollAnnouncementCard(message) {
  ...
  if (null == poll) {
    ...
    if (tmp9Result) {
      ...
      tmp9Result = tmp9(tmp13(4634).Text, obj);
    }
    items1[1] = tmp9Result;
