...
// Dependencies: [19, 17, 21, 4607, 576, 4343, 4608, 1396, 8994, 4603, 8809, 2]
// Exports: default

// Module 8993 (GameProfileNavigationHeader)
...
export default function GameProfileNavigationHeader(game) {
  ...
  if (null != name) {
    ...
    const items2 = [closure_7(tmp3(8994).BackgroundBlurFill, {}), ];
    ...
    const items4 = [closure_7(tmp3(4603).Heading, obj7), ];
    let l30Rank;
    if (game != null) {
