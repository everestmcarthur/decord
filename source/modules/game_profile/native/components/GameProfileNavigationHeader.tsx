...
// Dependencies: [19, 17, 21, 4606, 576, 4343, 4607, 1396, 8992, 4602, 8807, 2]
// Exports: default

// Module 8991 (GameProfileNavigationHeader)
...
export default function GameProfileNavigationHeader(game) {
  ...
  sharedValue = game(4343).useSharedValue(num);
  ...
  const animatedStyle = game(4343).useAnimatedStyle(fn);
  const tmp3Result = game(4343);
  ...
  const animatedStyle1 = game(4343).useAnimatedStyle(fn2);
  ...
  if (null != name) {
    ...
    const items2 = [closure_7(tmp3(8992).BackgroundBlurFill, {}), ];
    ...
    const items4 = [closure_7(tmp3(4602).Heading, obj7), ];
    let l30Rank;
    if (game != null) {
    ...
    if (tmp13Result) {
      ...
      const items5 = [tmp15(application(8807), obj9), ];
      const obj10 = { style: null, children: null };
      const items6 = [StyleSheet.absoluteFill, animatedStyle1];
      obj10.style = items6;
      const obj11 = { rank: game.l30Rank };
      obj10.children = tmp15(application(8807), obj11);
      items5[1] = tmp15(application(4343).View, obj10);
    ...
    if (tmp15Result2) {
      ...
      tmp15Result2 = tmp15(application(4343).View, obj12);
    }
