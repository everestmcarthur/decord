...
// Dependencies: [38, 4689, 8912, 1897, 573, 2]

// Module 8911 (GameProfileActionCreators)
...
export default {
  openGameProfileModal(arg0) {
    ...
    obj.openLazy(asyncRequireImpl(8912, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, sourceUserId }, stackingBehavior);
  },
  returnToGameProfile(gameId) {
    ...
    obj2.openLazy(asyncRequireImpl(8912, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, initialScrollOffset });
  },
