...
// Dependencies: [38, 4572, 8751, 1896, 573, 2]

// Module 8750 (GameProfileActionCreators)
...
export default {
  openGameProfileModal(arg0) {
    ...
    obj.openLazy(asyncRequireImpl(8751, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, sourceUserId }, stackingBehavior);
  },
  returnToGameProfile(gameId) {
    ...
    obj2.openLazy(asyncRequireImpl(8751, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, initialScrollOffset });
  },
