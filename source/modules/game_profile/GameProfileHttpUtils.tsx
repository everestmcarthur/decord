...
// Dependencies: [5, 2025, 8752, 1074, 8831, 573, 4847, 1272, 504, 559, 1090, 8822, 2]
// Exports: getGameAnnouncements, getShopCollection

// Module 8830 (GameProfileHttpUtils)
...
let closure_7 = fn(8831).SIMILAR_GAMES_BLOCKED_GAME_IDS;
