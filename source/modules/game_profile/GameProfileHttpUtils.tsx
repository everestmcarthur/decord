...
// Dependencies: [5, 2025, 8775, 1074, 8854, 573, 4849, 1272, 504, 559, 1090, 8845, 2]
// Exports: getGameAnnouncements, getShopCollection

// Module 8853 (GameProfileHttpUtils)
...
let closure_7 = fn(8854).SIMILAR_GAMES_BLOCKED_GAME_IDS;
