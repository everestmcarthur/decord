...
// Dependencies: [5, 2025, 8773, 1074, 8852, 573, 4848, 1272, 504, 559, 1090, 8843, 2]
// Exports: getGameAnnouncements, getShopCollection

// Module 8851 (GameProfileHttpUtils)
...
let closure_7 = fn(8852).SIMILAR_GAMES_BLOCKED_GAME_IDS;
