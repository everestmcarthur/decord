...
// Dependencies: [19, 10230, 11982, 8152, 1074, 21, 4640, 7311, 7263, 1115, 7313, 563, 8151, 4607, 1177, 5693, 5775, 7314, 9776, 8743, 5521, 5062, 11983, 1241, 11984, 2]

// Module 11981 (GuildIncidentActionsActionSheet)
...
import GuildAntiRaidActionCreators from "GuildAntiRaidActionCreators" /* 11983 */;
import noop from "module_19" /* 19 */;
import GuildIncidentsStore from "GuildIncidentsStore" /* 10230 */;

const ActionSheetActionCreatorsDefault = ActionSheetActionCreators;

const GuildRaidLockdownFeedbackActionSheetDefault = tmp7(11984);
require = fn;
function DurationSelectionActionSheet(onClose) {
  ...
  const items = [closure_14(onClose(7263).BottomSheetTitleHeader, obj2), ];
  const arr = getTimeframes();
  items[1] = closure_14(onClose(7313).ActionSheetRow.Group, {
    hasIcons: false,
  ...
  obj.children = items;
  return closure_15(onClose(7311).ActionSheet, obj);
}
const GuildIncidentsActionSheetStore = fn(11982);
...
const getTimeframes = fn(8152).getTimeframes;
