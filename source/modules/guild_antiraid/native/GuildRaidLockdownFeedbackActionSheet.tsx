...
// Dependencies: [32, 19, 1074, 21, 4640, 1115, 7632, 4607, 7311, 7263, 5666, 5775, 5692, 7199, 5062, 4820, 2]
// Exports: default

// Module 11984 (GuildRaidLockdownFeedbackActionSheet)
...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  obj7.header = closure_6(guildId(7263).BottomSheetTitleHeader, obj8);
  const obj9 = { style: closure_8().container, children: null };
  const tmp = closure_8();
  const tmp8 = closure_7;
  const tmp9 = raid_lockdown_feedback_type(5666);
  const items1 = [
    closure_6(guildId(5775).TableRowGroup, {
      hasIcons: false,
  ...
  let hasItem = raid_lockdown_feedback_type.includes(guildId(7632).RaidLockdownFeedbackType.OTHER);
  if (hasItem) {
    ...
    hasItem = tmp7(tmp5(7199).TextArea, obj11);
  }
  items1[1] = hasItem;
  const obj12 = {
    onPress() {
  ...
  items1[2] = closure_6(guildId(5062).Button, obj12);
  obj9.children = items1;
  obj7.children = tmp8(tmp9, obj9);
  return closure_6(guildId(7311).ActionSheet, obj7);
};
