...
// Dependencies: [32, 19, 1074, 21, 4606, 1114, 7591, 4573, 7270, 7222, 5629, 5738, 5655, 7158, 5026, 4786, 2]
// Exports: default

// Module 11926 (GuildRaidLockdownFeedbackActionSheet)
...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  obj7.header = closure_6(guildId(7222).BottomSheetTitleHeader, obj8);
  const obj9 = { style: closure_8().container, children: null };
  const tmp = closure_8();
  const tmp8 = closure_7;
  const tmp9 = raid_lockdown_feedback_type(5629);
  const items1 = [
    closure_6(guildId(5738).TableRowGroup, {
      hasIcons: false,
  ...
  let hasItem = raid_lockdown_feedback_type.includes(guildId(7591).RaidLockdownFeedbackType.OTHER);
  if (hasItem) {
    ...
    hasItem = tmp7(tmp5(7158).TextArea, obj11);
  }
  items1[1] = hasItem;
  const obj12 = {
    onPress() {
  ...
  items1[2] = closure_6(guildId(5026).Button, obj12);
  obj9.children = items1;
  obj7.children = tmp8(tmp9, obj9);
  return closure_6(guildId(7270).ActionSheet, obj7);
};
