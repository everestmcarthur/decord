...
// Dependencies: [32, 19, 1074, 21, 4605, 1114, 7570, 4572, 7249, 7201, 5628, 5737, 5654, 7137, 5025, 4785, 2]
// Exports: default

// Module 11903 (GuildRaidLockdownFeedbackActionSheet)
...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  obj.value = guildId(7570).RaidLockdownFeedbackType.DM_SPAM;
  let items = [obj, , , , , ];
  let obj2 = { text: null, value: null };
  const intl2 = guildId(1114).intl;
  obj2.text = intl2.string(guildId(1114).t.SdVsip);
  obj2.value = guildId(7570).RaidLockdownFeedbackType.MENTION_SPAM;
  items[1] = obj2;
  const obj3 = { text: null, value: null };
  const intl3 = guildId(1114).intl;
  obj3.text = intl3.string(guildId(1114).t.uTiSVL);
  obj3.value = guildId(7570).RaidLockdownFeedbackType.CHANNEL_SPAM;
  items[2] = obj3;
  const obj4 = { text: null, value: null };
  const intl4 = guildId(1114).intl;
  obj4.text = intl4.string(guildId(1114).t.GQczU8);
  obj4.value = guildId(7570).RaidLockdownFeedbackType.SUS_NEW_MEMBERS;
  items[3] = obj4;
  const obj5 = { text: null, value: null };
  const intl5 = guildId(1114).intl;
  obj5.text = intl5.string(guildId(1114).t.AAgqy3);
  obj5.value = guildId(7570).RaidLockdownFeedbackType.CHANGING_SETTINGS;
  items[4] = obj5;
  const obj6 = { text: null, value: null };
  const intl6 = guildId(1114).intl;
  obj6.text = intl6.string(guildId(1114).t.ryPKb7);
  obj6.value = guildId(7570).RaidLockdownFeedbackType.OTHER;
  items[5] = obj6;
  const obj7 = { startExpanded: true, header: null, children: null };
  const obj8 = { title: null };
  const intl7 = guildId(1114).intl;
  obj8.title = intl7.string(guildId(1114).t.f5hd9P);
  obj7.header = closure_6(guildId(7201).BottomSheetTitleHeader, obj8);
  const obj9 = { style: closure_8().container, children: null };
  const tmp = closure_8();
  const tmp8 = closure_7;
  const tmp9 = raid_lockdown_feedback_type(5628);
  const items1 = [
    closure_6(guildId(5737).TableRowGroup, {
      hasIcons: false,
  ...
  let hasItem = raid_lockdown_feedback_type.includes(guildId(7570).RaidLockdownFeedbackType.OTHER);
  if (hasItem) {
    const obj11 = { autoComplete: "off", value: first1, placeholder: null, onChange: null };
    const intl8 = tmp5(1114).intl;
    obj11.placeholder = intl8.string(tmp5(1114).t["PAM+JR"]);
    obj11.onChange = function onChange(arg0) {
      closure_4(arg0);
    };
    hasItem = tmp7(tmp5(7137).TextArea, obj11);
  }
  items1[1] = hasItem;
  const obj12 = {
    onPress() {
  ...
  obj12.text = intl9.string(guildId(1114).t.nAt0rE);
  items1[2] = closure_6(guildId(5025).Button, obj12);
  obj9.children = items1;
  obj7.children = tmp8(tmp9, obj9);
  return closure_6(guildId(7249).ActionSheet, obj7);
};
