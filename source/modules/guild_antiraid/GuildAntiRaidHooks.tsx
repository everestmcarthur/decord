...
// Dependencies: [1220, 1980, 4278, 4461, 1372, 10230, 8152, 1074, 563, 11, 8151, 1086, 4283, 10248, 2]
...
// Module 10247 (GuildAntiRaidHooks)
...
import GuildAntiRaidPermissionsUtils from "GuildAntiRaidPermissionsUtils" /* 10248 */;
...
let closure_10 = fn(8152).IncidentAlertModeratorPermissions;
  ...
  while (iter !== undefined) {
    ...
    if (null != nextResult) {
      ...
      if (null != tmp15) {
        ...
        let obj8 = stateFromStores1(8151);
...
export const useGuildIncidentsState = function useGuildIncidentsState(id) {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = tmp(8151).isUnderLockdown(stateFromStores1);
