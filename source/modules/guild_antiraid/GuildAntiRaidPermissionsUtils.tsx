...
export const useCanReportRaid = function useCanReportRaid(guild) {
  ...
  if (hasDetectedActivityResult) {
    hasDetectedActivityResult = tmp(8067).hasDetectedActivity(stateFromStores1);
