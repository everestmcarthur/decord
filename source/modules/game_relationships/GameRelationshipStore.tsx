...
// Dependencies: [4253, 1074, 4239, 504, 573, 2]

// Module 7709 (GameRelationshipStore)
...
const secondaryIndexMap = new fn(4239).SecondaryIndexMap(function gameRelationshipsIndex(arg0) {
  const items = [];
