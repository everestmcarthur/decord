...
// Dependencies: [5, 7586, 4553, 1182, 502, 1958, 1346, 1074, 7779, 1965, 21, 4617, 7780, 1255, 1363, 4496, 4495, 10, 1231, 1241, 7781, 4502, 7783, 9, 1091, 1358, 7784, 4983, 5079, 1897, 2]
...
const NavigationRouteUtils = tmp(4495);
require = fn;
