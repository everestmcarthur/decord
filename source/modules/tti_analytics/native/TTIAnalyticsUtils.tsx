...
// Dependencies: [5, 7672, 4637, 1182, 502, 1958, 1346, 1074, 7867, 1965, 21, 4701, 7868, 1255, 1363, 4580, 4579, 10, 1231, 1241, 7869, 4586, 7871, 9, 1091, 1358, 7872, 5067, 5163, 1897, 2]
...
const NavigationRouteUtils = tmp(4579);
require = fn;
