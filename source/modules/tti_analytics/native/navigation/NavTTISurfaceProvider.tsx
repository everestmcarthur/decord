...
// Dependencies: [19, 17, 21, 16621, 16619, 16620, 2]
...
export const NavTTISurfaceProvider = function NavTTISurfaceProvider(navigationKey) {
  ...
  const result = navigationKey(16621).isNavigationTTIEnabled();
  ...
  obj2.children = <View />;
  return jsx(navigationKey(16620).NavTTISurfaceContext.Provider, { value: memo, children: null });
};
