...
// Dependencies: [19, 17, 1958, 1980, 8465, 21, 4638, 576, 504, 4791, 5712, 5670, 1177, 8480, 7307, 11151, 16589, 5773, 5691, 2]
// Exports: default
...
const GuildIconDefault = tmp5(5670);
require = fn;
...
export default function ItemDetailsActionSheet(arg0) {
  ...
  if (null != stateFromStores1) {
    const obj4 = { guild: stateFromStores1, size: tmp(5670).GuildIconSizes.LARGE };
  ...
  if (result) {
    result = tmp(8480).isChannelCustomScoreEligible(stateFromStores);
  ...
  if (result) {
    ...
    tmp16Result = tmp16(tmp(16589).ChannelScoreSettings, obj8);
  }
  ...
  if (tmp15Result) {
    ...
    items4[1] = tmp16(tmp(16589).GuildScoreSettings, obj11);
  ...
  if (null != stateFromStores2) {
    ...
    if (tmp8) {
      ...
      obj12.children = tmp16(tmp(5691).TableRow, obj13);
      tmp16Result2 = tmp16(tmp(5773).TableRowGroup, obj12);
    }
  }
