...
// Dependencies: [19, 17, 1958, 1980, 8456, 21, 4639, 576, 504, 4792, 5711, 5669, 1177, 8471, 7304, 11137, 16569, 5772, 5690, 2]
// Exports: default
...
const GuildIconDefault = tmp5(5669);
require = fn;
...
export default function ItemDetailsActionSheet(arg0) {
  ...
  if (null != stateFromStores1) {
    const obj4 = { guild: stateFromStores1, size: tmp(5669).GuildIconSizes.LARGE };
  ...
  if (result) {
    result = tmp(8471).isChannelCustomScoreEligible(stateFromStores);
  ...
  if (result) {
    ...
    tmp16Result = tmp16(tmp(16569).ChannelScoreSettings, obj8);
  }
  ...
  if (tmp15Result) {
    ...
    items4[1] = tmp16(tmp(16569).GuildScoreSettings, obj11);
  ...
  if (null != stateFromStores2) {
    ...
    if (tmp8) {
      ...
      obj12.children = tmp16(tmp(5690).TableRow, obj13);
      tmp16Result2 = tmp16(tmp(5772).TableRowGroup, obj12);
    }
  }
