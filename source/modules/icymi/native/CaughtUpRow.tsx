...
// Function ID: 16676
// Name: CaughtUpRow
// Dependencies: [5, 32, 19, 17, 21, 4376, 4636, 16612, 576, 8500, 16629, 16625, 4498, 4641, 4341, 13166, 1115, 5062, 16651, 5074, 1094, 672, 2]
// Exports: default

// Module 16675 (CaughtUpRow)
...
let closure_9 = ReanimatedRexport.createAnimatedComponent(fn(4636).Text);
...
export default function ExploreServersRow(visible) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            dependencyMap(true);
            v1(8500).itemInteracted("caught_up", "caught_up", "press_explore");
            const obj5 = v1(8500);
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj7 = { value: tmp4(16629).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const callback1 = noop.useCallback(() => {
    sharedValue(8500).itemInteracted("caught_up", "caught_up", "press_home");
    const obj = sharedValue(8500);
    sharedValue(8500).feedItemActioned({ itemId: "caught_up", itemType: "caught_up", actionParameters: { actionGestureType: "press", actionTargetElement: "back_to_home_button", actionIntentType: "navigate", actionDestinationType: "guild_home" } });
    const obj2 = sharedValue(8500);
  ...
  E.__closure = { visibleSharedValue: sharedValue, withTiming: visible(4641).withTiming, Easing: visible(4376).Easing };
  E.__workletHash = 6575188656069;
  E.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(E);
  let obj3 = { visibleSharedValue: sharedValue, withTiming: visible(4641).withTiming, Easing: visible(4376).Easing };
  const fn = function b() {
    let num = 0;
    if (sharedValue.get()) {
  ...
  fn.__closure = { visibleSharedValue: sharedValue, withDelay: visible(4376).withDelay, withSequence: visible(4376).withSequence, withTiming: visible(4641).withTiming, Easing: visible(4376).Easing };
  fn.__workletHash = 469742746264;
  fn.__initData = __initData2;
  const animatedStyle1 = obj4.useAnimatedStyle(fn);
  let obj5 = { visibleSharedValue: sharedValue, withDelay: visible(4376).withDelay, withSequence: visible(4376).withSequence, withTiming: visible(4641).withTiming, Easing: visible(4376).Easing };
  ...
  fn2.__closure = { visibleSharedValue: sharedValue, withDelay: visible(4376).withDelay, withSequence: visible(4376).withSequence, withTiming: visible(4641).withTiming, Easing: visible(4376).Easing };
  fn2.__workletHash = 14933607481025;
  fn2.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(fn2);
  let obj7 = { visibleSharedValue: sharedValue, withDelay: visible(4376).withDelay, withSequence: visible(4376).withSequence, withTiming: visible(4641).withTiming, Easing: visible(4376).Easing };
  ...
  const obj12 = { style: null, children: closure_7(visible(13166).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }) };
  ...
  const items6 = [closure_7(visible(5062).Button, obj17), ];
  ...
  items6[1] = closure_7(visible(5062).Button, obj18);
  obj16.children = items6;
  items5[1] = closure_8(View, obj16);
  obj10.children = items5;
  const items7 = [closure_8(View, obj10), closure_7(visible(16651).Separator, {}), ];
