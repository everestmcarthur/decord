...
// Function ID: 16550
// Name: CaughtUpRow
// Dependencies: [5, 32, 19, 17, 21, 4310, 4570, 16486, 576, 8379, 16503, 16499, 4432, 4575, 4275, 13041, 1114, 4989, 16525, 5001, 1093, 672, 2]
// Exports: default

// Module 16549 (CaughtUpRow)
...
let closure_9 = ReanimatedRexport.createAnimatedComponent(fn(4570).Text);
...
export default function ExploreServersRow(visible) {
  ...
  const sharedValue = visible(4310).useSharedValue(false);
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            dependencyMap(true);
            v1(8379).itemInteracted("caught_up", "caught_up", "press_explore");
            const obj5 = v1(8379);
            ...
            v1(8379).feedItemActioned(obj4);
            const obj6 = v1(8379);
            v1 = 1;
            dependencyMap = 1;
            const obj7 = { value: tmp4(16503).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const callback1 = noop.useCallback(() => {
    sharedValue(8379).itemInteracted("caught_up", "caught_up", "press_home");
    const obj = sharedValue(8379);
    sharedValue(8379).feedItemActioned({ itemId: "caught_up", itemType: "caught_up", actionParameters: { actionGestureType: "press", actionTargetElement: "back_to_home_button", actionIntentType: "navigate", actionDestinationType: "guild_home" } });
    const obj2 = sharedValue(8379);
    const rootNavigationRef = visible(4432).getRootNavigationRef();
    if (rootNavigationRef != null) {
      rootNavigationRef.navigate("tabs", { screen: "guilds" });
    }
  }, []);
  let obj = visible(4310);
  class E {
    constructor() {
      obj = closure_1;
      num = -80;
  ...
  let obj2 = visible(4310);
  E.__closure = { visibleSharedValue: sharedValue, withTiming: visible(4575).withTiming, Easing: visible(4310).Easing };
  E.__workletHash = 6575188656069;
  E.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(E);
  let obj3 = { visibleSharedValue: sharedValue, withTiming: visible(4575).withTiming, Easing: visible(4310).Easing };
  const fn = function b() {
    let num = 0;
    if (sharedValue.get()) {
  ...
  let obj4 = visible(4310);
  fn.__closure = { visibleSharedValue: sharedValue, withDelay: visible(4310).withDelay, withSequence: visible(4310).withSequence, withTiming: visible(4575).withTiming, Easing: visible(4310).Easing };
  fn.__workletHash = 469742746264;
  fn.__initData = __initData2;
  const animatedStyle1 = obj4.useAnimatedStyle(fn);
  let obj5 = { visibleSharedValue: sharedValue, withDelay: visible(4310).withDelay, withSequence: visible(4310).withSequence, withTiming: visible(4575).withTiming, Easing: visible(4310).Easing };
  ...
  let obj6 = visible(4310);
  fn2.__closure = { visibleSharedValue: sharedValue, withDelay: visible(4310).withDelay, withSequence: visible(4310).withSequence, withTiming: visible(4575).withTiming, Easing: visible(4310).Easing };
  fn2.__workletHash = 14933607481025;
  fn2.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(fn2);
  let obj7 = { visibleSharedValue: sharedValue, withDelay: visible(4310).withDelay, withSequence: visible(4310).withSequence, withTiming: visible(4575).withTiming, Easing: visible(4310).Easing };
  const token = visible(4275).useToken(sharedValue(576).colors.BACKGROUND_BRAND);
  const obj9 = { children: null };
  const obj10 = { style: tmp.container, children: null };
  const obj11 = { style: tmp.textContainer, children: null };
  const obj12 = { style: null, children: closure_7(visible(13041).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }) };
  const items1 = [tmp.iconWrapper, animatedStyle];
  obj12.style = items1;
  const items2 = [closure_7(sharedValue(4310).View, obj12), , ];
  ...
  obj14.children = intl.string(visible(1114).t.xjxffq);
  ...
  obj15.children = intl2.string(visible(1114).t.sAApb0);
  ...
  obj17.text = intl3.string(visible(1114).t.lNJYV8);
  obj17.onPress = callback;
  const items6 = [closure_7(visible(4989).Button, obj17), ];
  const obj18 = { size: "md", text: null, grow: true, variant: "secondary", onPress: null };
  const intl4 = visible(1114).intl;
  obj18.text = intl4.string(visible(1114).t.AGrUbj);
  obj18.onPress = callback1;
  items6[1] = closure_7(visible(4989).Button, obj18);
  obj16.children = items6;
  items5[1] = closure_8(View, obj16);
  obj10.children = items5;
  const items7 = [closure_8(View, obj10), closure_7(visible(16525).Separator, {}), ];
  ...
  const obj8 = visible(4275);
  obj19.start = visible(1093).VerticalGradient.START;
  obj19.end = visible(1093).VerticalGradient.END;
  const tmp11 = sharedValue(5001);
