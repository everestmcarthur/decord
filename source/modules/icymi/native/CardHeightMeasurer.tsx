...
// Dependencies: [19, 17, 21, 16456, 8351, 2]

// Module 16523 (CardHeightMeasurer)
...
const memoResult = importAllResult.memo((children) => {
  ...
  }, items)} pointerEvents="box-none" style={{ width: importAllResult.useContext(itemId(16456).ICYMIContext).width, alignSelf: "center" }}>{arg0.children}</View>;
});
