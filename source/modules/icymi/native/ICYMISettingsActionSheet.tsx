...
// Dependencies: [5, 19, 17, 4620, 8412, 8400, 1074, 21, 4605, 576, 504, 8417, 7249, 5737, 1114, 7252, 8416, 5655, 8413, 1094, 11, 7162, 4572, 8415, 4808, 16538, 1896, 16547, 2]
// Exports: default

// Module 16537 (ICYMISettingsActionSheet)
...
export default function ICYMISettingsActionSheet() {
  ...
  const ICYMIStaffDebuggingUtilityExperiment = stateFromStoresObject(8417).ICYMIStaffDebuggingUtilityExperiment;
  ...
  if (ICYMIStaffDebuggingUtilityExperiment.useConfig({ location: "settings action sheet" }).enabled) {
    ...
    const items1 = [closure_10(tmp(7252).TableSwitchRow, obj3), , ];
    let obj5 = {
    ...
    items1[1] = closure_10(tmp(5655).TableRow, obj5);
    let obj6 = {
            ...
            try {
              ...
              if (0 === v1) {
                if (arg0 === 1) {
                  ...
                  v1 = 1;
                  dependencyMap = 1;
                  const obj5 = { value: tmp4(8415).regenerateFeedAndClearReadStates(constants.ACK_GRAVITY_REGENERATE_FEED_AND_CLEAR_READ_STATES_BUTTON), done: false };
                  return obj5;
                }
              } else if (arg0 === 1) {
                dependencyMap = 3;
    ...
    items1[2] = closure_10(tmp(5655).TableRow, obj6);
  ...
  items2[1] = closure_10(stateFromStoresObject(5655).TableRow, obj8);
  obj2.children = items2;
  const items3 = [closure_12(stateFromStoresObject(5737).TableRowGroup, obj2), ];
  const tmp4 = closure_13();
  items3[1] = closure_10(View, { style: closure_13().padding });
  obj7.children = items3;
  return closure_12(stateFromStoresObject(7249).ActionSheet, obj7);
};
