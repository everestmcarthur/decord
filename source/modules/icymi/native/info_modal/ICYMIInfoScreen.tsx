...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4638, 576, 5768, 1612, 4572, 1484, 8489, 16599, 4841, 7978, 7986, 1115, 5673, 16601, 16602, 16603, 16604, 4634, 9429, 13156, 4597, 4605, 16605, 1897, 5060, 2]
// Exports: default

// Module 16598 (ICYMIInfoScreen)
...
let size = { position: "absolute", justifyContent: "center", left: 12, width: 24, height: fn(5768).NAV_BAR_HEIGHT, zIndex: 2 };
obj2.closeIcon = size;
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: tmp2(16599).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj5;
          } else {
            v1(4841).pop();
            dependencyMap = 3;
  ...
  obj2.style = items2;
  let obj3 = {
    source: navigation(7986),
    onPress() {
      return navigation(4841).pop();
    },
  ...
  obj2.children = closure_9(extendedOnboarding(7978).HeaderIconButton, obj3);
  ...
  obj6.uri = navigation(16601);
  obj5.source = obj6;
  obj5.style = tmp.bgImage;
  const items5 = [closure_9(navigation(5673), obj5), ];
  const obj7 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5673);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(16602);
  } else {
    tmp2Result = tmp2(16603);
  }
  const items7 = [closure_9(navigation(5673), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj11 = { source: null, style: null };
  const obj10 = { source: { uri: tmp2Result }, style: tmp.headerImg };
  const tmp17 = navigation(5673);
  obj11.source = navigation(16604);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5673), obj11);
  ...
  items7[2] = closure_9(extendedOnboarding(4634).Text, obj12);
  ...
  items7[3] = closure_9(extendedOnboarding(4634).Text, obj13);
  ...
  const tmp2Result2 = navigation(5673);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9429).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = closure_9(extendedOnboarding(4634).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9429).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13156).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = closure_9(extendedOnboarding(4634).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13156).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj23 = { style: tmp.divider };
  const items12 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(4597).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = closure_9(extendedOnboarding(4634).Text, obj26);
  ...
  obj27.children = intl7.format(extendedOnboarding(1115).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(extendedOnboarding(4634).Text, {
  ...
  items13[1] = closure_9(extendedOnboarding(4634).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(5060).Button, obj30);
