...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4639, 576, 5767, 1612, 4574, 1484, 8480, 16579, 4842, 7969, 7977, 1115, 5672, 16581, 16582, 16583, 16584, 4635, 9418, 13145, 4599, 4606, 16585, 1897, 5059, 2]
// Exports: default

// Module 16578 (ICYMIInfoScreen)
...
let size = { position: "absolute", justifyContent: "center", left: 12, width: 24, height: fn(5767).NAV_BAR_HEIGHT, zIndex: 2 };
obj2.closeIcon = size;
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: tmp2(16579).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj5;
          } else {
            v1(4842).pop();
            dependencyMap = 3;
  ...
  obj2.style = items2;
  let obj3 = {
    source: navigation(7977),
    onPress() {
      return navigation(4842).pop();
    },
  ...
  obj2.children = closure_9(extendedOnboarding(7969).HeaderIconButton, obj3);
  ...
  obj6.uri = navigation(16581);
  obj5.source = obj6;
  obj5.style = tmp.bgImage;
  const items5 = [closure_9(navigation(5672), obj5), ];
  const obj7 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5672);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(16582);
  } else {
    tmp2Result = tmp2(16583);
  }
  const items7 = [closure_9(navigation(5672), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj11 = { source: null, style: null };
  const obj10 = { source: { uri: tmp2Result }, style: tmp.headerImg };
  const tmp17 = navigation(5672);
  obj11.source = navigation(16584);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5672), obj11);
  ...
  items7[2] = closure_9(extendedOnboarding(4635).Text, obj12);
  ...
  items7[3] = closure_9(extendedOnboarding(4635).Text, obj13);
  ...
  const tmp2Result2 = navigation(5672);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9418).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = closure_9(extendedOnboarding(4635).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9418).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13145).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = closure_9(extendedOnboarding(4635).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13145).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  ...
  items12[1] = closure_9(extendedOnboarding(4635).Text, obj26);
  ...
  obj27.children = intl7.format(extendedOnboarding(1115).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(extendedOnboarding(4635).Text, {
  ...
  items13[1] = closure_9(extendedOnboarding(4635).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(5059).Button, obj30);
