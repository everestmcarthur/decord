...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4636, 576, 5763, 1611, 4571, 1483, 8477, 16566, 4839, 7966, 7974, 1114, 5668, 16568, 16569, 16570, 16571, 4632, 9415, 13140, 4596, 4603, 16572, 1896, 5056, 2]
// Exports: default

// Module 16565 (ICYMIInfoScreen)
...
let size = { position: "absolute", justifyContent: "center", left: 12, width: 24, height: fn(5763).NAV_BAR_HEIGHT, zIndex: 2 };
obj2.closeIcon = size;
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const ICYMIAnalytics = tmp2(8477).ICYMIAnalytics;
            const result = ICYMIAnalytics.trackFeedOnboardingScreenSkipped({ location: "overview" });
            dependencyMap(true);
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: tmp2(16566).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj5;
          } else {
            v1(4839).pop();
            dependencyMap = 3;
  ...
  obj2.style = items2;
  let obj3 = {
    source: navigation(7974),
    onPress() {
      return navigation(4839).pop();
    },
  ...
  obj2.children = closure_9(extendedOnboarding(7966).HeaderIconButton, obj3);
  ...
  obj6.uri = navigation(16568);
  obj5.source = obj6;
  obj5.style = tmp.bgImage;
  const items5 = [closure_9(navigation(5668), obj5), ];
  const obj7 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5668);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(16569);
  } else {
    tmp2Result = tmp2(16570);
  }
  const items7 = [closure_9(navigation(5668), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj11 = { source: null, style: null };
  const obj10 = { source: { uri: tmp2Result }, style: tmp.headerImg };
  const tmp17 = navigation(5668);
  obj11.source = navigation(16571);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5668), obj11);
  ...
  items7[2] = closure_9(extendedOnboarding(4632).Text, obj12);
  ...
  items7[3] = closure_9(extendedOnboarding(4632).Text, obj13);
  ...
  const tmp2Result2 = navigation(5668);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9415).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = closure_9(extendedOnboarding(4632).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9415).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13140).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = closure_9(extendedOnboarding(4632).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13140).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj23 = { style: tmp.divider };
  const items12 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(4596).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = closure_9(extendedOnboarding(4632).Text, obj26);
  ...
  obj27.children = intl7.format(extendedOnboarding(1114).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(extendedOnboarding(4632).Text, {
  ...
  items13[1] = closure_9(extendedOnboarding(4632).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(5056).Button, obj30);
