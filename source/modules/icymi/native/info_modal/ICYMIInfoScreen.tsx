...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4606, 576, 5733, 1611, 4541, 1483, 8445, 16540, 4809, 7936, 7944, 1114, 5638, 16542, 16543, 16544, 16545, 4602, 9376, 13102, 4566, 4573, 16546, 1896, 5026, 2]
// Exports: default

// Module 16539 (ICYMIInfoScreen)
...
let size = { position: "absolute", justifyContent: "center", left: 12, width: 24, height: fn(5733).NAV_BAR_HEIGHT, zIndex: 2 };
obj2.closeIcon = size;
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  const tmp5 = navigation(4541)();
  navigation = extendedOnboarding(1483).useNavigation();
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const ICYMIAnalytics = tmp2(8445).ICYMIAnalytics;
            const result = ICYMIAnalytics.trackFeedOnboardingScreenSkipped({ location: "overview" });
            dependencyMap(true);
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: tmp2(16540).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj5;
          } else {
            v1(4809).pop();
            dependencyMap = 3;
  ...
  obj2.style = items2;
  let obj3 = {
    source: navigation(7944),
    onPress() {
      return navigation(4809).pop();
    },
    accessibilityLabel: null,
    color: null
  };
  const intl = extendedOnboarding(1114).intl;
  obj3.accessibilityLabel = intl.string(extendedOnboarding(1114).t.cpT0Cq);
  obj3.color = tmp.closeIconColor.backgroundColor;
  obj2.children = closure_9(extendedOnboarding(7936).HeaderIconButton, obj3);
  ...
  obj6.uri = navigation(16542);
  obj5.source = obj6;
  obj5.style = tmp.bgImage;
  const items5 = [closure_9(navigation(5638), obj5), ];
  const obj7 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5638);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(16543);
  } else {
    tmp2Result = tmp2(16544);
  }
  const items7 = [closure_9(navigation(5638), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj11 = { source: null, style: null };
  const obj10 = { source: { uri: tmp2Result }, style: tmp.headerImg };
  const tmp17 = navigation(5638);
  obj11.source = navigation(16545);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5638), obj11);
  const obj12 = { variant: "heading-xl/bold", color: "mobile-text-heading-primary", children: null };
  const intl2 = tmp6(1114).intl;
  obj12.children = intl2.string(extendedOnboarding(1114).t["jnXV/V"]);
  items7[2] = closure_9(extendedOnboarding(4602).Text, obj12);
  const obj13 = { variant: "text-md/normal", color: "text-default", style: tmp.headerText, children: null };
  const intl3 = tmp6(1114).intl;
  obj13.children = intl3.string(extendedOnboarding(1114).t["9SjvoK"]);
  items7[3] = closure_9(extendedOnboarding(4602).Text, obj13);
  ...
  const tmp2Result2 = navigation(5638);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9376).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  obj18.children = intl4.string(extendedOnboarding(1114).t.knxfqR);
  items9[1] = closure_9(extendedOnboarding(4602).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9376).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13102).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  obj22.children = intl5.string(extendedOnboarding(1114).t.BnUXZi);
  items11[1] = closure_9(extendedOnboarding(4602).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13102).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj23 = { style: tmp.divider };
  const items12 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(4566).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  obj26.children = intl6.string(extendedOnboarding(1114).t.itb1rh);
  items12[1] = closure_9(extendedOnboarding(4602).Text, obj26);
  ...
  obj27.children = intl7.format(extendedOnboarding(1114).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(extendedOnboarding(4602).Text, {
  ...
  items13[1] = closure_9(extendedOnboarding(4602).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(5026).Button, obj30);
