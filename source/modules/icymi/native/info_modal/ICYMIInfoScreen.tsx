...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4605, 576, 5732, 1611, 4540, 1483, 8424, 16552, 4808, 7914, 7922, 1114, 5637, 16554, 16555, 16556, 16557, 4601, 9355, 13079, 4565, 4572, 16558, 1896, 5025, 2]
// Exports: default

// Module 16551 (ICYMIInfoScreen)
...
let size = { position: "absolute", justifyContent: "center", left: 12, width: 24, height: fn(5732).NAV_BAR_HEIGHT, zIndex: 2 };
obj2.closeIcon = size;
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj5 = { value: tmp2(16552).maybeFetchGuildDiscoveryCategories(), done: false };
            return obj5;
          } else {
            v1(4808).pop();
            dependencyMap = 3;
  ...
  obj2.style = items2;
  let obj3 = {
    source: navigation(7922),
    onPress() {
      return navigation(4808).pop();
    },
  ...
  obj2.children = closure_9(extendedOnboarding(7914).HeaderIconButton, obj3);
  ...
  obj6.uri = navigation(16554);
  obj5.source = obj6;
  obj5.style = tmp.bgImage;
  const items5 = [closure_9(navigation(5637), obj5), ];
  const obj7 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5637);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(16555);
  } else {
    tmp2Result = tmp2(16556);
  }
  const items7 = [closure_9(navigation(5637), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj11 = { source: null, style: null };
  const obj10 = { source: { uri: tmp2Result }, style: tmp.headerImg };
  const tmp17 = navigation(5637);
  obj11.source = navigation(16557);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5637), obj11);
  ...
  items7[2] = closure_9(extendedOnboarding(4601).Text, obj12);
  ...
  items7[3] = closure_9(extendedOnboarding(4601).Text, obj13);
  ...
  const tmp2Result2 = navigation(5637);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9355).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = closure_9(extendedOnboarding(4601).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9355).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13079).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = closure_9(extendedOnboarding(4601).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13079).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj23 = { style: tmp.divider };
  const items12 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(4565).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = closure_9(extendedOnboarding(4601).Text, obj26);
  ...
  obj27.children = intl7.format(extendedOnboarding(1114).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(extendedOnboarding(4601).Text, {
  ...
  items13[1] = closure_9(extendedOnboarding(4601).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(5025).Button, obj30);
