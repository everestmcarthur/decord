...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4607, 576, 5734, 1611, 4542, 1483, 8447, 16540, 4810, 7937, 7945, 1114, 5639, 16542, 16543, 16544, 16545, 4603, 9378, 13104, 4567, 4574, 16546, 1896, 5027, 2]
// Exports: default
...
let size = { position: "absolute", justifyContent: "center", left: 12, width: 24, height: fn(5734).NAV_BAR_HEIGHT, zIndex: 2 };
obj2.closeIcon = size;
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const ICYMIAnalytics = tmp2(8447).ICYMIAnalytics;
  ...
  obj2.style = items2;
  let obj3 = {
    source: navigation(7945),
    onPress() {
      return navigation(4810).pop();
    },
  ...
  obj2.children = closure_9(extendedOnboarding(7937).HeaderIconButton, obj3);
  ...
  const items5 = [closure_9(navigation(5639), obj5), ];
  const obj7 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5639);
  ...
  const items7 = [closure_9(navigation(5639), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj11 = { source: null, style: null };
  const obj10 = { source: { uri: tmp2Result }, style: tmp.headerImg };
  const tmp17 = navigation(5639);
  obj11.source = navigation(16545);
  obj11.style = tmp.flashIcon;
  items7[1] = closure_9(navigation(5639), obj11);
  ...
  items7[2] = closure_9(extendedOnboarding(4603).Text, obj12);
  ...
  items7[3] = closure_9(extendedOnboarding(4603).Text, obj13);
  ...
  const tmp2Result2 = navigation(5639);
  const items9 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9378).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = closure_9(extendedOnboarding(4603).Text, obj18);
  ...
  const obj17 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9378).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj19 = { style: tmp.divider };
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13104).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = closure_9(extendedOnboarding(4603).Text, obj22);
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13104).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj23 = { style: tmp.divider };
  const items12 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(4567).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = closure_9(extendedOnboarding(4603).Text, obj26);
  ...
  obj27.children = intl7.format(extendedOnboarding(1114).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(extendedOnboarding(4603).Text, {
  ...
  items13[1] = closure_9(extendedOnboarding(4603).Text, obj27);
  ...
  obj29.children = closure_9(extendedOnboarding(5027).Button, obj30);
