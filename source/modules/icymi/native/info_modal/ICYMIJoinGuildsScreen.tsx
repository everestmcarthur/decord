...
// Dependencies: [5, 32, 19, 17, 4566, 1979, 16517, 1074, 21, 16486, 576, 5598, 9318, 4310, 4575, 7069, 504, 1396, 8847, 5601, 5137, 4570, 4989, 4534, 1114, 1611, 8387, 8379, 4272, 4777, 16501, 8906, 2]
// Exports: default

// Module 16518 (ICYMIJoinGuildsScreen)
...
import ICYMIPopularGuildsStore from "ICYMIPopularGuildsStore" /* 16517 */;
...
function SelectedServersRow(selectedGuilds) {
  ...
  let obj = selectedGuilds(4310);
  fn.__closure = { withTiming: selectedGuilds(4575).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  ...
  let num = 3;
  let obj2 = { withTiming: selectedGuilds(4575).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  const tmp8 = v50;
  ...
  obj3.children = closure_12(first(7069), obj4);
  return closure_12(first(4310).View, obj3);
}
function CutoutGuildBanner(guild) {
  ...
  obj7.style = items4;
  obj7.size = guild(5598).GuildIconSizes.LARGE;
...
function FeaturedServer(guild) {
  ...
  const items3 = [closure_12(guild(4570).Text, { maxFontSizeMultiplier: 1, style: tmp.featuredServerTitle, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: guild.name }), closure_12(guild(4570).Text, { maxFontSizeMultiplier: 1, lineClamp: 2, variant: "text-xs/normal", color: "text-default", children: guild.description }), ];
  ...
  if (selected) {
    ...
    tmp7Result = tmp7(tmp2(4534).CircleCheckIcon, obj8);
  }
  ...
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj7.variant = str;
      obj6.children = tmp7(guild(4989).Button, obj7);
      items3[2] = tmp7(tmp8, obj6);
      obj3.children = items3;
      items2[1] = tmp6(tmp8, obj3);
      obj2.children = items2;
      return tmp6(guild(5137).PressableHighlight, obj2);
    }
  }
      ...
      try {
        ...
        if (0 === v3) {
          if (arg0 === 1) {
            ...
            v3 = 1;
            dependencyMap = 1;
            const obj5 = { value: v3(8379).gravityJoinGuild(Array.from(first), "icymi_info_modal"), done: false };
            return obj5;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            v3 = 2;
            dependencyMap = 1;
            const obj11 = { value: tmp51(8379).fetchDehydrated({ isReloading: true, forceRefresh: true }), done: false };
            return obj11;
          } else {
            ...
            tmp51(4272).open(obj12);
            const tmp51Result2 = tmp51(4272);
            const dehydrated = v3(8379).fetchDehydrated();
            const obj7 = v3(8379);
            const guildChannelScores = v3(8379).getGuildChannelScores();
            const obj8 = v3(8379);
            const recommendedGuilds = v3(8379).getRecommendedGuilds();
            const obj9 = v3(8379);
            v3(4777).popWithKey(stateFromStoresArray(16501).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          if (arg0 === 1) {
            ...
            v3 = 3;
            dependencyMap = 1;
            const obj16 = { value: v3(8379).reloadICYMITab(), done: false };
            return obj16;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
          ...
          const guildChannelScores1 = v3(8379).getGuildChannelScores();
          const obj19 = v3(8379);
          const recommendedGuilds1 = v3(8379).getRecommendedGuilds();
          const obj20 = v3(8379);
          v3(4777).popWithKey(stateFromStoresArray(16501).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
