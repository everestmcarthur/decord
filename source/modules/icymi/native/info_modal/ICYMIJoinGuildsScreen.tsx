...
// Dependencies: [5, 32, 19, 17, 4597, 1979, 16566, 1074, 21, 16535, 576, 5634, 9355, 4341, 4606, 7107, 504, 1396, 8884, 5637, 5173, 4601, 5025, 4565, 1114, 1611, 8424, 8416, 4303, 4808, 16550, 8943, 2]
// Exports: default

// Module 16567 (ICYMIJoinGuildsScreen)
...
import ICYMIPopularGuildsStore from "ICYMIPopularGuildsStore" /* 16566 */;
...
function SelectedServersRow(selectedGuilds) {
  ...
  let obj = selectedGuilds(4341);
  fn.__closure = { withTiming: selectedGuilds(4606).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  ...
  let num = 3;
  let obj2 = { withTiming: selectedGuilds(4606).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  const tmp8 = v50;
  ...
  obj3.children = closure_12(first(7107), obj4);
  return closure_12(first(4341).View, obj3);
}
function CutoutGuildBanner(guild) {
  ...
  obj7.style = items4;
  obj7.size = guild(5634).GuildIconSizes.LARGE;
...
function FeaturedServer(guild) {
  ...
  const items3 = [closure_12(guild(4601).Text, { maxFontSizeMultiplier: 1, style: tmp.featuredServerTitle, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: guild.name }), closure_12(guild(4601).Text, { maxFontSizeMultiplier: 1, lineClamp: 2, variant: "text-xs/normal", color: "text-default", children: guild.description }), ];
  ...
  if (selected) {
    ...
    tmp7Result = tmp7(tmp2(4565).CircleCheckIcon, obj8);
  }
  ...
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj7.variant = str;
      obj6.children = tmp7(guild(5025).Button, obj7);
      items3[2] = tmp7(tmp8, obj6);
      obj3.children = items3;
      items2[1] = tmp6(tmp8, obj3);
      obj2.children = items2;
      return tmp6(guild(5173).PressableHighlight, obj2);
    }
  }
      ...
      try {
        ...
        if (0 === v3) {
          if (arg0 === 1) {
            ...
            v3 = 1;
            dependencyMap = 1;
            const obj5 = { value: v3(8416).gravityJoinGuild(Array.from(first), "icymi_info_modal"), done: false };
            return obj5;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            v3 = 2;
            dependencyMap = 1;
            const obj11 = { value: tmp51(8416).fetchDehydrated({ isReloading: true, forceRefresh: true }), done: false };
            return obj11;
          } else {
            ...
            tmp51(4303).open(obj12);
            const tmp51Result2 = tmp51(4303);
            const dehydrated = v3(8416).fetchDehydrated();
            const obj7 = v3(8416);
            const guildChannelScores = v3(8416).getGuildChannelScores();
            const obj8 = v3(8416);
            const recommendedGuilds = v3(8416).getRecommendedGuilds();
            const obj9 = v3(8416);
            v3(4808).popWithKey(stateFromStoresArray(16550).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          if (arg0 === 1) {
            ...
            v3 = 3;
            dependencyMap = 1;
            const obj16 = { value: v3(8416).reloadICYMITab(), done: false };
            return obj16;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
          ...
          const guildChannelScores1 = v3(8416).getGuildChannelScores();
          const obj19 = v3(8416);
          const recommendedGuilds1 = v3(8416).getRecommendedGuilds();
          const obj20 = v3(8416);
          v3(4808).popWithKey(stateFromStoresArray(16550).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
