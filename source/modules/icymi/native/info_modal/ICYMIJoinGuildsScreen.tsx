...
// Dependencies: [5, 32, 19, 17, 4631, 1980, 16593, 1074, 21, 16562, 576, 5669, 9418, 4376, 4640, 7162, 504, 1397, 8943, 5672, 5207, 4635, 5059, 4599, 1115, 1612, 8480, 8472, 4338, 4842, 16577, 9006, 2]
// Exports: default

// Module 16594 (ICYMIJoinGuildsScreen)
...
import ICYMIAnalytics2 from "ICYMIAnalytics" /* 8480 */;
import ClipViewDefault from "ClipView" /* 8943 */;
...
import ICYMIPopularGuildsStore from "ICYMIPopularGuildsStore" /* 16593 */;
...
function SelectedServersRow(selectedGuilds) {
  ...
  fn.__closure = { withTiming: selectedGuilds(4640).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  ...
  let num = 3;
  let obj2 = { withTiming: selectedGuilds(4640).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  const tmp8 = v50;
  ...
  obj3.children = closure_12(first(7162), obj4);
...
function CutoutGuildBanner(guild) {
  ...
  obj7.style = items4;
  obj7.size = guild(5669).GuildIconSizes.LARGE;
...
function FeaturedServer(guild) {
  ...
  const items3 = [closure_12(guild(4635).Text, { maxFontSizeMultiplier: 1, style: tmp.featuredServerTitle, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: guild.name }), closure_12(guild(4635).Text, { maxFontSizeMultiplier: 1, lineClamp: 2, variant: "text-xs/normal", color: "text-default", children: guild.description }), ];
  ...
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj7.variant = str;
      obj6.children = tmp7(guild(5059).Button, obj7);
      items3[2] = tmp7(tmp8, obj6);
      obj3.children = items3;
      items2[1] = tmp6(tmp8, obj3);
      obj2.children = items2;
      return tmp6(guild(5207).PressableHighlight, obj2);
    }
  }
      ...
      try {
        ...
        if (0 === v3) {
          if (arg0 === 1) {
            ...
            v3 = 1;
            dependencyMap = 1;
            const obj5 = { value: v3(8472).gravityJoinGuild(Array.from(first), "icymi_info_modal"), done: false };
            return obj5;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            v3 = 2;
            dependencyMap = 1;
            const obj11 = { value: tmp51(8472).fetchDehydrated({ isReloading: true, forceRefresh: true }), done: false };
            return obj11;
          } else {
            ...
            const dehydrated = v3(8472).fetchDehydrated();
            const obj7 = v3(8472);
            const guildChannelScores = v3(8472).getGuildChannelScores();
            const obj8 = v3(8472);
            const recommendedGuilds = v3(8472).getRecommendedGuilds();
            const obj9 = v3(8472);
            v3(4842).popWithKey(stateFromStoresArray(16577).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          if (arg0 === 1) {
            ...
            v3 = 3;
            dependencyMap = 1;
            const obj16 = { value: v3(8472).reloadICYMITab(), done: false };
            return obj16;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
          ...
          const guildChannelScores1 = v3(8472).getGuildChannelScores();
          const obj19 = v3(8472);
          const recommendedGuilds1 = v3(8472).getRecommendedGuilds();
          const obj20 = v3(8472);
          v3(4842).popWithKey(stateFromStoresArray(16577).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
