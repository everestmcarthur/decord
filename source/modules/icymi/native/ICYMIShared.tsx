...
// Function ID: 16602
// Name: ICYMIShared
// Dependencies: [19, 17, 7413, 1958, 2022, 4278, 1372, 1074, 21, 8469, 9330, 5171, 10262, 16530, 7217, 7354, 7145, 7563, 4570, 16562, 1364, 576, 1177, 8943, 5669, 5066, 5207, 4635, 7746, 16602, 8798, 504, 4791, 8472, 8299, 5178, 8471, 16198, 9917, 1115, 16563, 4574, 4341, 4489, 4376, 4640, 4652, 5155, 7316, 4629, 2]
...
import openDetailsActionSheet from "openDetailsActionSheet" /* 16602 */;
  ...
  if (obj2.useStateFromStores(items2, () => PermissionStore.canWithPartialContext(constants5.VIEW_CHANNEL, { channelId: parentMessage.id }))) {
    if (null != thread) {
      if (null != mostRecentMessage) {
        ...
        items4[1] = closure_18(tmp2(4635).Text, obj5);
        const obj7 = { style: tmp.commentCount, children: null };
        const obj8 = { style: tmp.commentsIcon };
        const items5 = [closure_18(tmp2(5155).ChatIcon, obj8), , ];
        const obj9 = { variant: "text-sm/bold", color: "interactive-text-default", children: str };
        items5[1] = closure_18(tmp2(4635).Text, obj9);
        const obj10 = { style: tmp.chevron, size: "xxs" };
        items5[2] = closure_18(tmp2(7316).ChevronSmallRightIcon, obj10);
        obj7.children = items5;
        items4[2] = closure_19(View, obj7);
        obj3.children = items4;
        return closure_19(tmp2(5207).PressableHighlight, obj3);
      }
    }
    ...
    const items7 = [closure_18(tmp2(4635).Text, obj12), ];
    const obj13 = { style: tmp.commentCount, children: null };
    const obj14 = { style: tmp.commentsIcon };
    const items8 = [closure_18(tmp2(5155).ChatIcon, obj14), ];
    const obj15 = { style: tmp.chevron, size: "xxs" };
    items8[1] = closure_18(tmp2(7316).ChevronSmallRightIcon, obj15);
    obj13.children = items8;
    items7[1] = closure_19(View, obj13);
    obj11.children = items7;
    return closure_19(tmp2(5207).PressableHighlight, obj11);
  } else {
    return null;
  }
