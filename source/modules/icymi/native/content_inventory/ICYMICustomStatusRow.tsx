...
// Dependencies: [32, 19, 17, 1372, 8456, 21, 576, 4639, 16562, 1177, 11383, 4635, 1115, 7978, 4489, 504, 4873, 9308, 11013, 11028, 1364, 5207, 4597, 10381, 11868, 8886, 11, 1091, 16618, 4484, 7746, 16622, 8943, 2]
// Exports: default

// Module 16621 (ICYMICustomStatusRow)
...
function UploadPlaceholder() {
  ...
  const items = [React6(native.Icon, { source: _modDef11383, size: native.IconSizes.SMALL }), ];
