...
// Dependencies: [32, 5, 19, 17, 4566, 1979, 8363, 1074, 21, 16486, 576, 504, 1396, 1971, 8847, 5601, 5598, 8379, 4272, 1114, 5534, 4570, 4989, 16525, 7069, 2]
...
function CutoutGuildBanner(guild) {
  ...
  if (null != guild.banner) {
    ...
    let tmp12Result = tmp12(tmp13(5601), obj5);
  } else {
...
function FeaturedServer(guild) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            closure_1(8379).feedItemActioned(obj5);
            const obj18 = closure_1(8379);
            const items = [guild.id];
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: closure_1(8379).gravityJoinGuild(items, "recommended_guilds"), done: false };
            return obj6;
          }
        } else if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            obj11.state = obj12;
            closure_128_0 = obj11;
            const result = closure_1(8379).addedRecommendedGuild();
            let obj8 = closure_1(8379);
            const dehydrated = closure_1(8379).fetchDehydrated({ isReloading: true, forceRefresh: true });
                ...
                try {
                  ...
                  if (0 === v2) {
                    if (arg0 === 1) {
                      ...
                      v2 = 1;
                      dependencyMap = 1;
                      const obj5 = { value: v2(8379).reloadICYMITab(), done: false };
                      return obj5;
                    }
                  } else if (1 === tmp4) {
                    if (arg0 === 1) {
                      ...
                      v2 = 2;
                      dependencyMap = 1;
                      const obj8 = { value: v2(8379).getGuildChannelScores(), done: false };
                      return obj8;
                    }
                  } else if (arg0 === 1) {
                    dependencyMap = 3;
                    ...
                    const recommendedGuilds = v2(8379).getRecommendedGuilds();
                    dependencyMap = 3;
                    return { value: "HermesInternal", done: null };
                  }
                } catch (tmp14) {
            ...
            let obj9 = closure_1(8379);
            const obj14 = {};
            const merged = Object.assign(closure_128_0);
            dependencyMap = 2;
            c3 = 1;
            const obj15 = { value: closure_1(5534).transitionToGuildSync(closure_129_0.id, obj14), done: false };
            return obj15;
          } else {
            closure_129_1(false);
  ...
  obj6.children = closure_14(guild(4989).Button, obj7);
...
export const ICYMIServerRecommendationRow = function ICYMIServerRecommendationRow() {
  ...
  if (0 !== stateFromStoresArray.length) {
    ...
    const items1 = [closure_1_14(tmp(4570).Text, obj4), , ];
    ...
    items1[1] = closure_1_14(tmp(4570).Text, obj5);
    const obj6 = { discoverableGuilds: stateFromStoresArray };
    items1[2] = closure_1_14(RecommendedGuildsRow, obj6);
    obj3.children = items1;
    const items2 = [__initData(View, obj3), closure_1_14(tmp(16525).Separator, {})];
    obj2.children = items2;
