...
// Dependencies: [32, 19, 17, 7599, 1957, 1979, 4788, 8423, 21, 4607, 576, 504, 4760, 8438, 1114, 4574, 16529, 1896, 5080, 5657, 1178, 10236, 4603, 7602, 1611, 16530, 11250, 8966, 2]
// Exports: default

// Module 16528 (ICYMICustomScoresGuildScreen)
...
export default function ICYMICustomScoresGuildScreen(navigation) {
  ...
  const numberToCustomScoreResult = navigation(8438).numberToCustomScore(stateFromStores1);
  noop = numberToCustomScoreResult;
  const tmp2Result3 = navigation(8438);
          ...
          if (first !== guildChannels.voiceChannelsSectionNumber) {
            ...
            if (null != found) {
              if (0 !== arr3.length) {
                ...
                if (first === tmp27(7602).SECTION_INDEX_FAVORITES) {
                ...
                } else if (first !== tmp27(7602).SECTION_INDEX_RECENTS) {
                  if (first >= tmp27(7602).SECTION_INDEX_FIRST_NAMED_CATEGORY) {
  ...
  obj3.children = closure_11(navigation(8966).AnimatedFlashList, obj4);
