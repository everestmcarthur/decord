...
// Dependencies: [32, 19, 17, 7632, 1958, 1980, 4820, 8456, 21, 4639, 576, 504, 4792, 8471, 1115, 4606, 16568, 1897, 5112, 5690, 1177, 10275, 4635, 7635, 1612, 16569, 11292, 9006, 2]
// Exports: default
          ...
          if (first !== guildChannels.voiceChannelsSectionNumber) {
            ...
            if (null != found) {
              if (0 !== arr3.length) {
                ...
                if (first === tmp27(7635).SECTION_INDEX_FAVORITES) {
                ...
                } else if (first !== tmp27(7635).SECTION_INDEX_RECENTS) {
                  if (first >= tmp27(7635).SECTION_INDEX_FIRST_NAMED_CATEGORY) {
