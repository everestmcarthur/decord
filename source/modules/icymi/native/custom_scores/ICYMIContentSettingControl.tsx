...
// Dependencies: [32, 19, 17, 4755, 8363, 21, 4574, 576, 8378, 1114, 1178, 16494, 16495, 16496, 9824, 9825, 504, 16497, 4570, 7214, 4727, 2]
// Exports: ChannelScoreSettings, GuildScoreSettings

// Module 16493 (ICYMIContentSettingControl)
...
import _modDef16495 from "module_16495" /* 16495 */;
import _modDef16496 from "module_16496" /* 16496 */;
import NativeICYMIActionCreatorsDefault from "NativeICYMIActionCreators" /* 16497 */;
...
function ContentSettingsControl(initialValue) {
  ...
  const obj2 = { source: _modDef16494, style: null };
  ...
  const obj4 = { source: _modDef16495, style: null };
  ...
  const obj6 = { source: _modDef16496, style: null };
  ...
  const obj7 = {
    ...
    onSetActiveIndex(arg0) {
      ...
      if (0 === arg0) {
        MORE = tmp(8378).ICYMICustomScore.LESS;
      } else if (2 === arg0) {
        MORE = tmp(8378).ICYMICustomScore.MORE;
      }
      _undefined(MORE);
      closure_1_0(MORE);
    },
  ...
  if (ICYMIUtils.ICYMICustomScore.LESS !== tmp3) {
    num = 1;
    if (tmp4(8378).ICYMICustomScore.MORE === tmp3) {
      num = 2;
    }
  }
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  let obj = id(504);
  const numberToCustomScoreResult = id(8378).numberToCustomScore(stateFromStores);
  ...
  const items3 = [closure_8(id(4570).Text, obj3), , , , ];
  ...
  items3[1] = closure_8(id(4570).Text, obj4);
  ...
  obj9.children = closure_8(id(7214).TableSwitchRow, obj10);
  ...
  items3[4] = closure_8(id(4570).Text, obj11);
