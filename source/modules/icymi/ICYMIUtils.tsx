...
// Function ID: 8472
// Name: ICYMIUtils
// Dependencies: [5, 7633, 1962, 1958, 1980, 4860, 4654, 8456, 8470, 1074, 8469, 8472, 4862, 11, 504, 8473, 8477, 8250, 8478, 8004, 1115, 7217, 1897, 1074, 2]
  ...
  if (channel.type === constants.GUILD_ANNOUNCEMENT) {
    ...
    if (message.attachments.length > 0) {
      ...
      if (obj.isValidImageAttachment(message.attachments[0])) {
        ContentType = tmp6(8469).ContentType;
        let IMAGE = ContentType.IMAGE;
      } else {
        const result = tmp6(8004).isValidVideoAttachment(message.attachments[0]);
        const ContentType2 = tmp6(8469).ContentType;
        IMAGE = result ? ContentType2.VIDEO : ContentType2.FILE;
        const tmp6Result = tmp6(8004);
      }
...
export const contentTypeToText = function contentTypeToText(arg0) {
  ...
  if (ICYMITypes.ContentType.POPULAR_MESSAGE === arg0) {
  ...
  } else if (tmp(8469).ContentType.IMAGE === arg0) {
    const intl9 = tmp(1115).intl;
    return intl9.string(tmp(1115).t.gmOWAo);
  } else if (tmp(8469).ContentType.VIDEO === arg0) {
    const intl8 = tmp(1115).intl;
    return intl8.string(tmp(1115).t.swhcPM);
  } else if (tmp(8469).ContentType.LINK === arg0) {
    const intl7 = tmp(1115).intl;
    return intl7.string(tmp(1115).t.oj5yvD);
  } else if (tmp(8469).ContentType.THREAD === arg0) {
    const intl6 = tmp(1115).intl;
    return intl6.string(tmp(1115).t.DwLrLK);
  } else if (tmp(8469).ContentType.FORUM_POST === arg0) {
    const intl5 = tmp(1115).intl;
    return intl5.string(tmp(1115).t["Q9/6BS"]);
  } else if (tmp(8469).ContentType.CHANGED_STATUS === arg0) {
    const intl4 = tmp(1115).intl;
    return intl4.string(tmp(1115).t.TGrUmi);
  } else if (tmp(8469).ContentType.INTERESTING === arg0) {
    const intl3 = tmp(1115).intl;
    return intl3.string(tmp(1115).t["TahE/i"]);
  } else if (tmp(8469).ContentType.ANNOUNCEMENT === arg0) {
    ...
    return stringResult;
  } else if (tmp(8469).ContentType.FILE === arg0) {
