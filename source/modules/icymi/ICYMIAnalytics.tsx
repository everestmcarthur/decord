...
// Function ID: 8481
// Name: ICYMIAnalytics
// Dependencies: [8456, 1074, 8250, 8469, 1241, 2]

// Module 8480 (ICYMIAnalytics)
  ...
  trackFeedLoaded(unreadFeedItems) {
    ...
    const item = unreadFeedItems.forEach((id) => {
      ...
      if (ICYMITypes.ICYMIItemTypes.MESSAGE === type) {
        ...
        if (tmp3(8469).ICYMIItemTypes.ACTIVITY !== type) {
          str = "hotwheels_custom_status";
          if (tmp3(8469).ICYMIItemTypes.CUSTOM_STATUS !== type) {
            str = "guild_event";
            if (tmp3(8469).ICYMIItemTypes.GUILD_EVENT !== type) {
              if (tmp3(8469).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
