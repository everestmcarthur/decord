...
// Function ID: 8448
// Name: ICYMIAnalytics
// Dependencies: [8423, 1074, 8216, 8436, 1242, 2]

// Module 8447 (ICYMIAnalytics)
  ...
  trackFeedLoaded(unreadFeedItems) {
    ...
    const item = unreadFeedItems.forEach((id) => {
      ...
      if (ICYMITypes.ICYMIItemTypes.MESSAGE === type) {
        ...
        if (tmp3(8436).ICYMIItemTypes.ACTIVITY !== type) {
          str = "hotwheels_custom_status";
          if (tmp3(8436).ICYMIItemTypes.CUSTOM_STATUS !== type) {
            str = "guild_event";
            if (tmp3(8436).ICYMIItemTypes.GUILD_EVENT !== type) {
              if (tmp3(8436).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
