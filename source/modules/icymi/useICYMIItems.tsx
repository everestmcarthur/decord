...
// Function ID: 16570
// Name: useICYMIItems
// Dependencies: [19, 8400, 8413, 504, 8416, 2]
// Exports: default

// Module 16569 (useICYMIItems)
...
function createItem(id, type, unread) {
  ...
  if (ICYMITypes.ICYMIItemTypes.MESSAGE === type) {
    ...
    if (tmp(8413).ICYMIItemTypes.ACTIVITY !== type) {
      if (tmp(8413).ICYMIItemTypes.CUSTOM_STATUS !== type) {
        if (tmp(8413).ICYMIItemTypes.GUILD_EVENT === type) {
          ...
          obj6.unread = unread;
          return obj6;
        } else if (tmp(8413).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
