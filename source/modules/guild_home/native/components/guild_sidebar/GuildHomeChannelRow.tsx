...
// Dependencies: [19, 1074, 1964, 10246, 21, 4636, 576, 1100, 12508, 1114, 13929, 2]
// Exports: default

// Module 16302 (GuildHomeChannelRow)
...
export default function GuildHomeChannelRow(selected) {
  ...
  obj.icon = jsx(tmp5(12508).BaseChannelIcon, { mode: DEFAULT, IconComponent: tmp5(13929).SignPostIcon });
