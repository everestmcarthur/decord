...
// Dependencies: [19, 1074, 1964, 10188, 21, 4605, 576, 1100, 12449, 1114, 13916, 2]
// Exports: default

// Module 16289 (GuildHomeChannelRow)
...
export default function GuildHomeChannelRow(selected) {
  ...
  obj.icon = jsx(tmp5(12449).BaseChannelIcon, { mode: DEFAULT, IconComponent: tmp5(13916).SignPostIcon });
