...
// Dependencies: [19, 1074, 1964, 10209, 21, 4607, 576, 1100, 12474, 1114, 13897, 2]
// Exports: default
...
export default function GuildHomeChannelRow(selected) {
  ...
  obj.icon = jsx(tmp5(12474).BaseChannelIcon, { mode: DEFAULT, IconComponent: tmp5(13897).SignPostIcon });
