...
// Dependencies: [1091, 1083, 1115, 2397, 2]
...
// Module 7652 (FamilyCenterConstants)
...
const items = [
  obj2.USER_INTERACTION,
  {
    ...
    tooltipHeader() {
      ...
      return intl.string(_modDef2397.kvTgWP);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
      const tmp = _modDef2397;
      if (arg0) {
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2397["4T3zWT"], { count });
    },
    ...
    timestampFormatter() {
      ...
      const intl = util.intl;
      obj.today = intl.string(_modDef2397.fLBUx7);
      const intl2 = util.intl;
      obj.yesterday = intl2.string(_modDef2397.cHHgxI);
      obj.days = _modDef2397.qvKjp8;
      return obj;
    }
  }
];
...
const items2 = [
  obj2.USER_CALLED,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2397.D7Sngz);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2397["0GE4Ni"], { count });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    timestampFormatter() {
      const obj = { today: null, yesterday: null, days: null };
      const intl = util.intl;
      obj.today = intl.string(_modDef2397.IHd5cZ);
      const intl2 = util.intl;
      obj.yesterday = intl2.string(_modDef2397.wOsfxv);
      obj.days = _modDef2397.oCk8c4;
      return obj;
    }
  }
];
...
const items3 = [
  obj2.USER_ADD,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2397.kIcKAj);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2397["TEvo+H"], { count });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    timestampFormatter() {
      const obj = { today: null, yesterday: null, days: null };
      const intl = util.intl;
      obj.today = intl.string(_modDef2397.JUHIYZ);
      const intl2 = util.intl;
      obj.yesterday = intl2.string(_modDef2397.GiswUW);
      obj.days = _modDef2397["fwQgE/"];
      return obj;
    }
  }
];
...
const items4 = [
  obj2.GUILD_ADD,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2397.uav9Bh);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2397["7feG7T"], { count });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
...
const items5 = [
  obj2.GUILD_INTERACTION,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2397.CcrbCw);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2397.rcPInc, { count });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
...
const items6 = [
  obj2.TOTAL_VOICE_MINUTES,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2397.eo4Fxh);
    },
    tooltipDescription() {
      const intl = util.intl;
      return intl.string(_modDef2397["O/AElu"]);
    },
    sectionHeader(count) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2397.eGFWUd, { count });
    },
    sectionDescription() {
      const intl = util.intl;
      return intl.string(_modDef2397["O/AElu"]);
...
const items7 = [
  obj2.PURCHASES,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2397.NMYKsh);
    },
    tooltipDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
    ...
    sectionHeader(amount) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2397.FPViWL, { amount });
    },
    sectionDescription(arg0) {
      const intl = util.intl;
      const string = intl.string;
...
const items8 = [
  obj2.GIFTS,
  {
    ...
    tooltipHeader() {
      const intl = util.intl;
      return intl.string(_modDef2397.ULUspo);
    },
    tooltipDescription() {
      const intl = util.intl;
      return intl.string(_modDef2397.nH8vlc);
    },
    sectionHeader(amount) {
      const intl = util.intl;
      return intl.formatToPlainString(_modDef2397["0R6I/b"], { amount });
    },
    sectionDescription() {
      const intl = util.intl;
      return intl.string(_modDef2397.nH8vlc);
...
export const FAMILY_CENTER_LINK_REQUEST_ERROR_EXPERIENCES = {
  [obj4.GENERIC_ERROR]: {
    header() {
      const intl = util.intl;
      return intl.string(_modDef2397.nGX8Co);
    },
    description() {
      const intl = util.intl;
      return intl.string(_modDef2397.Uss2dn);
    },
    icon: obj3.X
  },
  [obj4.PENDING_REQUEST_EXISTS]: {
    header() {
      const intl = util.intl;
      return intl.string(_modDef2397.tu0MRv);
    },
    description(email) {
      email = email.email;
      if (null != email) {
        const intl2 = util.intl;
        const obj = { email };
        let formatToPlainStringResult = intl2.formatToPlainString(_modDef2397.xNEkdx, obj);
      } else {
        const intl = util.intl;
        formatToPlainStringResult = intl.string(_modDef2397.Xyjnwn);
      }
  ...
  [obj4.INELIGIBLE_FOR_FAMILY_CENTER]: {
    header() {
      const intl = util.intl;
      return intl.string(_modDef2397.W9JLJh);
    },
    description() {
      const intl = util.intl;
      return intl.format(_modDef2397.On5iRI, { link: "https://support.discord.com/hc/requests/new?ticket_form_id=360000029731" });
    },
    icon: obj3.X
  }
};
...
export const PENDING_LINK_REQUEST_TIMESTAMP_FORMATTER = () => {
  ...
  const intl = util.intl;
  time.seconds = intl.string(_modDef2397.CJdoee);
  time.minutes = _modDef2397.InzMn3;
  time.hours = _modDef2397.ErkYCI;
  const intl2 = util.intl;
  time.yesterday = intl2.string(_modDef2397.GvfssA);
  time.days = _modDef2397.pWig18;
  time.date = _modDef2397.MP3khg;
  return time;
};
export const ACCEPTED_LINK_REQUEST_TIMESTAMP_FORMATTER = () => {
  const time = { seconds: null, minutes: null, hours: null, yesterday: null, days: null, date: null };
  const intl = util.intl;
  time.seconds = intl.string(_modDef2397.Bqsamd);
  time.minutes = _modDef2397.kX3wJg;
  time.hours = _modDef2397.J18GbG;
  const intl2 = util.intl;
  time.yesterday = intl2.string(_modDef2397.Ln9zMn);
  time.days = _modDef2397.WRtySz;
  time.date = _modDef2397.Y3ZYtM;
  return time;
};
