...
// Dependencies: [5, 19, 17, 1372, 7652, 21, 4640, 576, 1484, 563, 7653, 12067, 7706, 12068, 8571, 8572, 1177, 1397, 1115, 2397, 4636, 12069, 12070, 12078, 5521, 5062, 4843, 5780, 8801, 38, 11714, 7106, 5665, 8421, 1895, 8560, 8562, 4853, 5712, 12079, 12080, 2]
// Exports: default

// Module 12066 (FamilyCenterModalRequest)
...
import NavigatorHeader2 from "NavigatorHeader" /* 5712 */;
...
import FamilyCenterModalRequestRouting from "FamilyCenterModalRequestRouting" /* 12067 */;
...
function FamilyCenterConfirmAgeScreen(teenIdentity) {
  ...
  const tmp7 = stateFromStores(8421)(stateFromStores);
  dependencyMap = tmp7;
  ...
  const callback = noop.useCallback(() => {
    const obj = stateFromStores(8560);
    const result = obj.showAgeVerificationGetStartedModal({ entryPoint: navigation(8562).AgeVerificationModalEntryPoint.FAMILY_CENTER_CONNECTION });
  }, []);
  const obj3 = { style: tmp.content, children: null };
  const obj2 = navigation(563);
  const items2 = [closure_12(closure_6, { style: tmp.art, children: closure_12(navigation(5780).FamilyShieldSpotIllustration, {}) }), , ];
  ...
  items2[1] = closure_12(navigation(4636).Text, obj5);
  ...
  items2[2] = closure_12(navigation(4636).Text, obj7);
  ...
  const items4 = [closure_12(navigation(5062).Button, obj10), ];
  const obj11 = { variant: "tertiary", text: null, onPress: null };
  const intl4 = tmp2(1115).intl;
  obj11.text = intl4.string(navigation(1115).t.oEAioF);
  obj11.onPress = function onPress() {
    return stateFromStores(4843).pop();
  };
  items4[1] = closure_12(navigation(5062).Button, obj11);
  obj9.children = items4;
  obj8.children = closure_13(navigation(5521).ButtonGroup, obj9);
  items3[1] = closure_12(navigation(12078).ModalFooter, obj8);
  obj6.children = items3;
  return closure_13(navigation(8571).ModalScreen, obj6);
}
...
function FamilyCenterPrereqMustBeAdultScreen() {
  ...
  const tmp3 = stateFromStores(8421)(stateFromStores);
  dependencyMap = tmp3;
  ...
  obj5.onPress = stateFromStores(4843).pop;
...
export default function FamilyCenterRequestModal(userId) {
  ...
  const FamilyCenterConnectionPrereqExperiment = userId(12079).FamilyCenterConnectionPrereqExperiment;
  ...
  const FamilyCenterModalRequestSections = userId(12067).FamilyCenterModalRequestSections;
  ...
  return closure_12(userId(12080).Modal, obj);
};
