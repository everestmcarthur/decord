...
// Dependencies: [19, 17, 7644, 21, 4639, 576, 1115, 2397, 4337, 4842, 12051, 563, 14980, 8542, 8543, 5057, 4635, 14981, 5662, 5709, 12063, 2]
// Exports: default

// Module 17616 (ConnectGuardianShareModal)
...
function ConnectGuardianShareScreen() {
  ...
  if (null != stateFromStores) {
    if (null != stateFromStores1) {
      ...
      let tmp11Result = tmp11(tmp2(14981).ConnectGuardianCard, obj11);
    }
    const obj12 = { children: null };
    const obj13 = { children: null };
    items4[1] = tmp11Result;
    obj9.children = items4;
    items3[1] = tmp12(getLinkCode(5057).Stack, obj9);
    obj5.children = items3;
    obj13.children = tmp12(getLinkCode(5057).Stack, obj5);
    obj12.children = tmp11(getLinkCode(8543).ModalContent, obj13);
    return tmp11(getLinkCode(8542).ModalScreen, obj12);
  }
  tmp11Result = tmp11(View, { style: tmp.loading, children: closure_6(getLinkCode(5662).ActivityIndicator, {}) });
}
