...
// Dependencies: [19, 17, 7651, 21, 4640, 576, 1115, 2397, 4337, 4843, 12068, 563, 15004, 8571, 8572, 5060, 4636, 15005, 5665, 5712, 12080, 2]
// Exports: default

// Module 17713 (ConnectGuardianShareModal)
...
function ConnectGuardianShareScreen() {
  ...
  getLinkCode = getLinkCode(12068).useFamilyCenterActions({ onError: callback }).getLinkCode;
  const obj2 = getLinkCode(12068);
  ...
  const items2 = [closure_6(getLinkCode(4636).Text, obj7), ];
  ...
  items2[1] = closure_6(getLinkCode(4636).Text, obj8);
  obj6.children = items2;
  const items3 = [closure_7(getLinkCode(5060).Stack, obj6), ];
  ...
  const items4 = [closure_6(getLinkCode(4636).Text, obj10), ];
  if (null != stateFromStores) {
    if (null != stateFromStores1) {
      const obj11 = { shareActions: "full", linkCode: stateFromStores, expiresAt: stateFromStores1, onRefresh: getLinkCode };
      let tmp11Result = tmp11(tmp2(15005).ConnectGuardianCard, obj11);
    }
    const obj12 = { children: null };
    const obj13 = { children: null };
    items4[1] = tmp11Result;
    obj9.children = items4;
    items3[1] = tmp12(getLinkCode(5060).Stack, obj9);
    obj5.children = items3;
    obj13.children = tmp12(getLinkCode(5060).Stack, obj5);
    obj12.children = tmp11(getLinkCode(8572).ModalContent, obj13);
    return tmp11(getLinkCode(8571).ModalScreen, obj12);
  }
  tmp11Result = tmp11(View, { style: tmp.loading, children: closure_6(getLinkCode(5665).ActivityIndicator, {}) });
}
