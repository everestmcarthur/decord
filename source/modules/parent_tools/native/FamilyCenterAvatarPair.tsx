...
// Dependencies: [19, 17, 1372, 21, 4638, 576, 563, 1177, 2]
// Exports: default

// Module 15038 (FamilyCenterAvatarPair)
...
export default function FamilyCenterAvatarPair(otherUser) {
  ...
  if (undefined !== stateFromStores) {
    ...
    if (undefined !== otherUser) {
      ...
      const obj3 = { size: tmp2(1177).AvatarSizes.LARGE_48, user: stateFromStores, guildId: "Array", avatarDecoration: stateFromStores.avatarDecoration };
      const items1 = [React4(tmp2(1177).Avatar, obj3), , ];
      const obj4 = { style: null, size: null, source: null };
      const items2 = [tmp.icon, iconStyles];
      obj4.style = items2;
      obj4.size = tmp2(1177).Icon.Sizes.EXTRA_SMALL;
      obj4.source = iconSrc;
      items1[1] = React4(tmp2(1177).Icon, obj4);
      const obj5 = { size: tmp2(1177).AvatarSizes.LARGE_48, user: otherUser, guildId: "Array", avatarDecoration: otherUser.avatarDecoration };
      items1[2] = React4(tmp2(1177).Avatar, obj5);
