...
// Module 15027 (FamilyCenterModalCancel)
...
function FamilyCenterModalCancelScreen(otherUser) {
  ...
  obj5.iconSrc = cancelLinkRequest(7099);
  const items1 = [closure_5(cancelLinkRequest(15022), obj5), , ];
  ...
  items1[2] = closure_5(cancelLinkRequest(14992), { user: otherUser });
  obj4.children = items1;
  obj3.children = closure_6(View, obj4);
  const items2 = [closure_5(otherUser(8543).ModalContent, obj3), ];
  ...
  const items3 = [closure_5(otherUser(5059).Button, obj9), ];
  ...
  obj10.onPress = cancelLinkRequest(4842).pop;
  items3[1] = closure_5(otherUser(5059).Button, obj10);
  obj8.children = items3;
  obj7.children = closure_6(otherUser(5518).ButtonGroup, obj8);
  items2[1] = closure_5(otherUser(12061).ModalFooter, obj7);
