...
// Dependencies: [19, 17, 21, 4605, 576, 8236, 14980, 7286, 14981, 4601, 2]
// Exports: default

// Module 14979 (FamilyCenterActivityPurchaseRow)
...
const FamilyCenterActivityItemPreviewDefault = tmp2(14981);
require = fn;
...
export default function FamilyCenterActivityPurchaseRow(arg0) {
  ...
  if (null == displayName) {
    ...
    const formatPriceResult = tmp5(7286).formatPrice(total, currency);
    if (product == null) {
      product = null;
    }
