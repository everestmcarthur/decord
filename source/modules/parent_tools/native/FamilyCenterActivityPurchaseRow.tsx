...
// Dependencies: [19, 17, 21, 4639, 576, 8293, 15002, 7341, 15003, 4635, 2]
// Exports: default
...
const FamilyCenterActivityItemPreviewDefault = tmp2(15003);
require = fn;
...
export default function FamilyCenterActivityPurchaseRow(arg0) {
  ...
  if (null == displayName) {
    ...
    const formatPriceResult = tmp5(7341).formatPrice(total, currency);
    if (product == null) {
      product = null;
    }
