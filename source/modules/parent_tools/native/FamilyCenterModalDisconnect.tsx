...
// Dependencies: [32, 19, 17, 21, 4606, 576, 4809, 4451, 8736, 4304, 1114, 12010, 12013, 2396, 8507, 8508, 14977, 7065, 4602, 14929, 5024, 9520, 12020, 5484, 5026, 5675, 12022, 2]
// Exports: default
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  const requiresParentalConsent = otherUser(8736).useRequiresParentalConsent(otherUser.id);
  const obj2 = otherUser(8736);
  ...
  const obj3 = otherUser(12010);
  let intl = otherUser(1114).intl;
  const obj4 = otherUser(12013);
  ...
  items3[1] = closure_6(otherUser(4602).Text, obj11);
  items3[2] = closure_6(otherUser(4602).Text, { style: tmp.subtitle, variant: "text-sm/bold", color: "text-default", children: ageSpecificText });
  ...
  items4[2] = closure_6(otherUser(4602).Text, { style: tmp.body, variant: "text-md/normal", color: "text-default", children: ageSpecificText2 });
  const obj16 = { spacing: nativeDefault.space.PX_12, children: null };
  const items5 = [closure_6(otherUser(9520).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), closure_6(otherUser(9520).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
  obj16.children = items5;
  items4[3] = closure_7(otherUser(5024).Stack, obj16);
  obj14.children = items4;
  const items6 = [closure_7(otherUser(8508).ModalContent, obj14), ];
  let tmp31 = !tmp9;
  if (tmp9) {
    tmp31 = !tmp11;
  }
  ...
  const items7 = [closure_6(otherUser(5026).Button, obj20), ];
  ...
  items7[1] = closure_6(otherUser(5026).Button, obj21);
  obj19.children = items7;
  obj18.children = closure_7(otherUser(5484).ButtonGroup, obj19);
  items6[1] = closure_6(otherUser(12020).ModalFooter, obj18);
  obj17.children = items6;
  return closure_7(otherUser(8507).ModalScreen, obj17);
}
...
export default function FamilyCenterModalDisconnect(otherUser) {
  ...
  return closure_6(otherUser(12022).Modal, obj);
};
