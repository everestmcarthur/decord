...
// Dependencies: [19, 17, 1371, 7610, 7611, 1074, 21, 4606, 576, 1178, 38, 563, 11, 4602, 4451, 7665, 5635, 5641, 1114, 2396, 14956, 14959, 14960, 2]
// Exports: default
...
const ACTION_TO_TEXT = fn(7611).ACTION_TO_TEXT;
...
const memoResult = noop.memo((action) => {
  ...
  if (null == stateFromStores) {
    ...
    const items2 = [closure_8(tmp6(4602).Text, obj6), ];
    ...
    obj7.children = tmp6(7665).formatUserActivityTimestamp(date.getTime(), value.timestampFormatter);
    items2[1] = closure_8(tmp6(4602).Text, obj7);
...
const memoResult1 = noop.memo((action) => {
  ...
  if (undefined === stateFromStores) {
    ...
    obj4.size = tmp2(5635).GuildIconSizes.NORMAL;
    const items1 = [closure_8(tmp6(5635), obj4), ];
    ...
    if (hasItem) {
      const obj8 = { style: tmp.badge, guild: stateFromStores, size: tmp6(5641).Sizes.SMALL, disableColor: true };
      tmp11Result = tmp11(tmp6(5641), obj8);
      const tmp6Result2 = tmp6(5641);
    }
    ...
    items2[1] = closure_8(tmp2(4602).Text, obj9);
    ...
    if (undefined !== stateFromStores.approximateMemberCount) {
      ...
      tmp11Result2 = tmp11(tmp2(4602).Text, obj10);
    }
