...
// Dependencies: [19, 17, 1372, 7651, 7652, 1074, 21, 4640, 576, 1177, 38, 563, 11, 4636, 4484, 7706, 5672, 5678, 1115, 2397, 15025, 15028, 15029, 2]
// Exports: default
...
const memoResult1 = noop.memo((action) => {
  ...
  if (undefined === stateFromStores) {
    ...
    const items1 = [closure_8(tmp6(5672), obj4), ];
    ...
    if (hasItem) {
      const obj8 = { style: tmp.badge, guild: stateFromStores, size: tmp6(5678).Sizes.SMALL, disableColor: true };
      tmp11Result = tmp11(tmp6(5678), obj8);
      const tmp6Result2 = tmp6(5678);
    }
    ...
    if (undefined !== stateFromStores.approximateMemberCount) {
      ...
      tmp11Result2 = tmp11(tmp2(4636).Text, obj10);
    }
  ...
  if (tmpResult9.isPurchase(action)) {
    ...
    if (tmpResult10.isGift(action)) {
      ...
      if (null == giftInfo) {
        ...
        const giftRowDisplayInfo = tmp(15028).getGiftRowDisplayInfo(giftInfo);
