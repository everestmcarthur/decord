...
// Dependencies: [19, 17, 21, 4606, 576, 4809, 4304, 1114, 12010, 8507, 8508, 14977, 4550, 4602, 2396, 14947, 12012, 12020, 5484, 5026, 5675, 12022, 2]
// Exports: default
...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  obj5.iconSrc = acceptLinkRequest(4550);
  ...
  const items2 = [closure_6(View, obj4), closure_5(acceptLinkRequest(12012), {}), ];
  ...
  items2[2] = closure_5(otherUser(4602).Text, obj7);
  obj3.children = items2;
  const items3 = [closure_6(otherUser(8508).ModalContent, obj3), ];
  ...
  const items4 = [closure_5(otherUser(5026).Button, obj11), ];
  ...
  obj12.onPress = acceptLinkRequest(4809).pop;
  items4[1] = closure_5(otherUser(5026).Button, obj12);
  obj10.children = items4;
  obj9.children = closure_6(otherUser(5484).ButtonGroup, obj10);
  items3[1] = closure_5(otherUser(12020).ModalFooter, obj9);
