...
// Dependencies: [19, 17, 1372, 7644, 7645, 1074, 4849, 21, 4639, 576, 8771, 4337, 1115, 12051, 563, 14977, 1241, 14978, 4606, 14979, 1897, 5057, 5059, 9185, 2397, 14982, 4842, 1366, 12048, 1609, 5223, 13961, 2]
// Exports: FamilyCenterParentQRCodeButton, FamilyCenterTeenQRCodeButton

// Module 14976 (FamilyCenterBannerButton)
...
const NativePermissionUtilsDefault = tmp(5223);
require = fn;
function FamilyCenterTeenQRCodeButtonInner() {
  ...
  const callback2 = obj.useCallback(() => {
    ...
    if (tmp2) {
      ...
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14979, dependencyMap.paths), React5, obj4);
    }
  }, items4);
...
export const FamilyCenterParentQRCodeButton = function FamilyCenterParentQRCodeButton() {
  ...
  if (obj.useHasMaxConnections()) {
    ...
    obj2.text = intl.string(_modDef2397.z4a9HP);
  ...
  obj = handleQrCodeScanSucess(8771);
