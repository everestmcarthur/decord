...
// Dependencies: [19, 17, 7590, 21, 4605, 576, 8716, 8715, 11990, 1114, 2396, 4601, 14994, 14996, 5173, 4808, 14999, 1896, 1178, 15001, 2]
// Exports: default

// Module 14993 (FamilyCenterAcceptedLinks)
...
import FamilyCenterLinkRowDefault from "FamilyCenterLinkRow" /* 14996 */;
...
function FamilyCenterAcceptedLinkRow(otherUser) {
  ...
  if (undefined !== str) {
    ...
    obj.onPress = function onPress() {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14999, dependencyMap.paths), { otherUser: str });
    };
    obj.style = tmp.actionButton;
    const obj4 = { size: str(1178).Icon.Sizes.SMALL, disableColor: true, source: _modDef15001 };
    obj.children = closure_6(str(1178).Icon, obj4);
    obj2.actions = closure_6(str(5173).PressableOpacity, obj);
...
export default function FamilyCenterAcceptedLinks() {
  ...
  if (0 === activeLinkUsers.length) {
    ...
    obj6.children = tmp10(tmp2(14994), obj7);
    let mapped = tmp10(tmp9, obj6);
    const tmp2Result = tmp2(14994);
  } else {
