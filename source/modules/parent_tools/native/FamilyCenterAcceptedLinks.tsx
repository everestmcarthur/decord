...
// Dependencies: [19, 17, 7652, 21, 4640, 576, 8801, 8800, 12071, 1115, 2397, 4636, 15040, 15042, 5210, 4843, 15045, 1897, 1177, 15047, 2]
// Exports: default

// Module 15039 (FamilyCenterAcceptedLinks)
...
import FamilyCenterLinkRowDefault from "FamilyCenterLinkRow" /* 15042 */;
...
export default function FamilyCenterAcceptedLinks() {
  ...
  const ageSpecificText = tmp5Result.useAgeSpecificText(intl.formatToPlainString(_modDef2397["+tnO34"], obj2), intl2.formatToPlainString(tmp2(2397)["pu6/U0"], obj2));
  ...
  if (0 === activeLinkUsers.length) {
    ...
    obj7.text = intl3.string(tmp2(2397).C4ScLD);
    obj6.children = tmp10(tmp2(15040), obj7);
    let mapped = tmp10(tmp9, obj6);
    const tmp2Result = tmp2(15040);
  } else {
