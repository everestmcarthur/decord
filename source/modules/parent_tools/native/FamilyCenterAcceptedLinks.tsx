...
// Dependencies: [19, 17, 7648, 21, 4638, 576, 8781, 8780, 12062, 1115, 2397, 4634, 15032, 15034, 5208, 4841, 15037, 1897, 1177, 15039, 2]
// Exports: default

// Module 15031 (FamilyCenterAcceptedLinks)
...
import FamilyCenterLinkRowDefault from "FamilyCenterLinkRow" /* 15034 */;
...
export default function FamilyCenterAcceptedLinks() {
  ...
  if (0 === activeLinkUsers.length) {
    ...
    obj6.children = tmp10(tmp2(15032), obj7);
    let mapped = tmp10(tmp9, obj6);
    const tmp2Result = tmp2(15032);
  } else {
