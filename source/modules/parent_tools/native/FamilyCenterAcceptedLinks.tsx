...
// Dependencies: [19, 17, 7612, 21, 4607, 576, 8739, 8738, 12015, 1114, 2396, 4603, 14971, 14973, 5175, 4810, 14976, 1896, 1178, 14978, 2]
// Exports: default
...
function FamilyCenterAcceptedLinkRow(otherUser) {
  ...
  if (undefined !== str) {
    ...
    obj2.actions = closure_6(str(5175).PressableOpacity, obj);
