...
// Dependencies: [19, 17, 7645, 21, 4639, 576, 8772, 8771, 12054, 1115, 2397, 4635, 15016, 15018, 5207, 4842, 15021, 1897, 1177, 15023, 2]
// Exports: default

// Module 15015 (FamilyCenterAcceptedLinks)
...
import FamilyCenterLinkRowDefault from "FamilyCenterLinkRow" /* 15018 */;
...
export default function FamilyCenterAcceptedLinks() {
  ...
  if (0 === activeLinkUsers.length) {
    ...
    obj6.children = tmp10(tmp2(15016), obj7);
    let mapped = tmp10(tmp9, obj6);
    const tmp2Result = tmp2(15016);
  } else {
