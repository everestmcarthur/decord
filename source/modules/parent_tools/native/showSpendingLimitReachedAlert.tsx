...
// Dependencies: [4540, 4319, 8800, 4985, 1115, 7700, 4653, 2]
// Exports: isSpendingLimitError, showSpendingLimitReachedAlert

// Module 10854 (showSpendingLimitReachedAlert)
...
export const isSpendingLimitError = function isSpendingLimitError(billingError) {
  ...
  if (tmp3) {
    let tmp4 = billingError.code === tmp(4319).ErrorCodes.BILLING_SPENDING_LIMIT_REACHED;
    if (!tmp4) {
      tmp4 = billingError.code === tmp(4319).ErrorCodes.BILLING_SPENDING_LIMIT_WILL_EXCEED;
    }
    tmp3 = tmp4;
  }
  return tmp3;
...
export const showSpendingLimitReachedAlert = function showSpendingLimitReachedAlert() {
  activeLinkUserIds = activeLinkUserIds(8800).getActiveLinkUserIds();
  let obj = activeLinkUserIds(8800);
