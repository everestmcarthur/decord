...
// Dependencies: [5, 32, 19, 17, 1372, 1074, 21, 4607, 9868, 1897, 4640, 576, 1177, 5060, 4636, 1115, 2397, 1484, 7108, 10233, 563, 15059, 15060, 4597, 5775, 7314, 5693, 7237, 5062, 2]
// Exports: default

// Module 15058 (ScheduleDowntimeScreen)
...
export default function ScheduleDowntimeScreen() {
  ...
  if (null == teenId) {
    ...
    obj13.onPress = function handleStartTimePress() {
      ...
      const tmp2 = asyncRequireImpl(9868, dependencyMap.paths);
