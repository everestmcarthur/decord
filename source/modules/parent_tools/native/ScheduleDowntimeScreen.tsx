...
// Dependencies: [5, 32, 19, 17, 1372, 1074, 21, 4606, 9849, 1897, 4639, 576, 1177, 5057, 4635, 1115, 2397, 1484, 7101, 10214, 563, 15035, 15036, 4597, 5772, 7307, 5690, 7230, 5059, 2]
// Exports: default

// Module 15034 (ScheduleDowntimeScreen)
...
export default function ScheduleDowntimeScreen() {
  ...
  if (null == teenId) {
    ...
    obj13.onPress = function handleStartTimePress() {
      ...
      const tmp2 = asyncRequireImpl(9849, dependencyMap.paths);
