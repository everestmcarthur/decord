...
// Dependencies: [5, 32, 19, 17, 1372, 1074, 21, 4605, 9857, 1897, 4638, 576, 1177, 5058, 4634, 1115, 2397, 1484, 7104, 10222, 563, 15051, 15052, 4595, 5773, 7310, 5691, 7233, 5060, 2]
// Exports: default

// Module 15050 (ScheduleDowntimeScreen)
...
function OverlappingSchedulesWarning(conflictingEntries) {
  ...
  if (0 !== conflictingEntries.length) {
    ...
    obj3.children = intl.string(_modDef2397["26A0Df"]);
...
export default function ScheduleDowntimeScreen() {
  ...
  if (null == teenId) {
    ...
    obj15.onPress = function handleEndTimePress() {
      ...
      const stringResult = intl.string(_modDef2397["+JkWJV"]);
      const obj2 = { title: stringResult, mode: "time", startDate: null, onSubmit: null };
      const obj = ActionSheetActionCreatorsDefault;
      const tmp2 = asyncRequireImpl(9857, dependencyMap.paths);
