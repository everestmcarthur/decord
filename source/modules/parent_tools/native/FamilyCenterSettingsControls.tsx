...
// Dependencies: [19, 17, 7645, 1074, 21, 4639, 576, 4635, 1115, 2397, 4842, 15007, 1897, 15009, 5690, 8771, 14993, 1484, 15010, 5057, 5772, 5059, 7693, 4652, 14925, 7646, 15011, 2]
// Exports: default

// Module 15006 (FamilyCenterSettingsControls)
...
function SpendingLimitRow(teenId) {
  ...
  const tmp = closure_9();
  const spendingLimitDisplayState = teenId(15009).useSpendingLimitDisplayState(teenId.cap);
  ...
  if ("off" === kind) {
    ...
    obj2.trailing = closure_7(tmp2(4635).Text, obj3);
    let tmp8 = obj2;
    ...
    obj4.trailing = closure_7(tmp2(4635).Text, obj5);
    tmp8 = obj4;
    ...
    obj12.trailing = closure_7(tmp2(4635).Text, obj13);
    ...
    obj12.subLabel = closure_7(tmp2(4635).Text, obj14);
    tmp8 = obj12;
  ...
  if (null != teenId) {
    fn = () => {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(15007, dependencyMap.paths), { teenId }, undefined, { animation: "slide_from_right" });
    };
  }
  obj15.onPress = fn;
  obj15.arrow = null != teenId;
  obj15.disabled = null == teenId;
  return closure_7(teenId(5690).TableRow, obj15);
}
...
function FamilyCenterSettingsParentalControls() {
  const tmp = closure_9();
  selectedTeenUser = selectedTeenUser(14993).useSelectedTeenUser();
  let obj = selectedTeenUser(14993);
  const shouldLoadSettingsForSelectedTeenUser = selectedTeenUser(14993).useShouldLoadSettingsForSelectedTeenUser();
  const obj2 = selectedTeenUser(14993);
  ...
  const ParentalControlledSpendingLimit = tmp2(14925).ParentalControlledSpendingLimit;
  let id;
  if (selectedTeenUser != null) {
  ...
  ({ subLabel, trailing } = shouldLoadSettingsForSelectedTeenUser(15010)(rules));
  ...
  const items1 = [closure_7(selectedTeenUser(4635).Text, obj5), , ];
  ...
  items1[1] = closure_7(selectedTeenUser(4635).Text, obj6);
  ...
  const items2 = [closure_7(selectedTeenUser(5690).TableRow, obj8), , , ];
  ...
  items2[1] = closure_7(selectedTeenUser(5690).TableRow, obj9);
  let id2;
  if (selectedTeenUser != null) {
  ...
  if (tmp14Result2) {
    ...
    tmp14Result2 = tmp14(tmp2(5690).TableRow, obj11);
  }
  items2[3] = tmp14Result2;
  obj7.children = closure_8(selectedTeenUser(5772).TableRowGroup, { hasIcons: false, children: items2 });
  items1[2] = closure_7(View, obj7);
  obj4.children = items1;
  return closure_8(selectedTeenUser(5057).Stack, obj4);
}
const View = fn(17).View;
const FamilyCenterSubPages = fn(7645).FamilyCenterSubPages;
