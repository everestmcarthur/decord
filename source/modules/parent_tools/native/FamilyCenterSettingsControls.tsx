...
// Dependencies: [19, 17, 7648, 1074, 21, 4638, 576, 4634, 1115, 2397, 4841, 15023, 1897, 15025, 5691, 8780, 15009, 1484, 15026, 5058, 5773, 5060, 7696, 4651, 14941, 7649, 15027, 2]
// Exports: default

// Module 15022 (FamilyCenterSettingsControls)
...
function SpendingLimitRow(teenId) {
  ...
  const tmp = closure_9();
  const spendingLimitDisplayState = teenId(15025).useSpendingLimitDisplayState(teenId.cap);
  ...
  if ("off" === kind) {
    ...
    obj2.trailing = closure_7(tmp2(4634).Text, obj3);
    let tmp8 = obj2;
    ...
    obj4.trailing = closure_7(tmp2(4634).Text, obj5);
    tmp8 = obj4;
    ...
    obj12.trailing = closure_7(tmp2(4634).Text, obj13);
    ...
    obj12.subLabel = closure_7(tmp2(4634).Text, obj14);
    tmp8 = obj12;
  ...
  if (null != teenId) {
    fn = () => {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(15023, dependencyMap.paths), { teenId }, undefined, { animation: "slide_from_right" });
    };
  }
  obj15.onPress = fn;
  obj15.arrow = null != teenId;
  obj15.disabled = null == teenId;
  return closure_7(teenId(5691).TableRow, obj15);
}
...
function FamilyCenterSettingsParentalControls() {
  const tmp = closure_9();
  selectedTeenUser = selectedTeenUser(15009).useSelectedTeenUser();
  let obj = selectedTeenUser(15009);
  const shouldLoadSettingsForSelectedTeenUser = selectedTeenUser(15009).useShouldLoadSettingsForSelectedTeenUser();
  const obj2 = selectedTeenUser(15009);
  ...
  const ParentalControlledSpendingLimit = tmp2(14941).ParentalControlledSpendingLimit;
  let id;
  if (selectedTeenUser != null) {
  ...
  ({ subLabel, trailing } = shouldLoadSettingsForSelectedTeenUser(15026)(rules));
  ...
  const items1 = [closure_7(selectedTeenUser(4634).Text, obj5), , ];
  ...
  items1[1] = closure_7(selectedTeenUser(4634).Text, obj6);
  ...
  const items2 = [closure_7(selectedTeenUser(5691).TableRow, obj8), , , ];
  ...
  items2[1] = closure_7(selectedTeenUser(5691).TableRow, obj9);
  let id2;
  if (selectedTeenUser != null) {
  ...
  if (tmp14Result2) {
    ...
    tmp14Result2 = tmp14(tmp2(5691).TableRow, obj11);
  }
  items2[3] = tmp14Result2;
  obj7.children = closure_8(selectedTeenUser(5773).TableRowGroup, { hasIcons: false, children: items2 });
  items1[2] = closure_7(View, obj7);
  obj4.children = items1;
  return closure_8(selectedTeenUser(5058).Stack, obj4);
}
const View = fn(17).View;
const FamilyCenterSubPages = fn(7648).FamilyCenterSubPages;
