...
// Dependencies: [19, 17, 21, 4560, 576, 8173, 14896, 14905, 14907, 4404, 14906, 4556, 2]
// Exports: default
...
export default function FamilyCenterActivityGiftRow(arg0) {
  ...
  if (null == displayName) {
    ...
    obj3[4] = displayName;
    const items1 = [closure_4(tmp5(4556).Text, obj3), ];
    const obj4 = { variant: "text-xs/medium", color: "text-muted", children: null };
    obj4[2] = giftSubtext;
    items1[1] = closure_4(tmp5(4556).Text, obj4);
    obj2[1] = items1;
