...
// Dependencies: [19, 17, 21, 4638, 576, 8302, 15009, 15018, 15020, 4482, 15019, 4634, 2]
// Exports: default

// Module 15021 (FamilyCenterActivityGiftRow)
...
export default function FamilyCenterActivityGiftRow(arg0) {
  ...
  if (null == displayName) {
    ...
    if (null != teenUserForId) {
      name = tmp2(4482).getName(teenUserForId);
    ...
    const items = [React4(tmp2(15019), obj5), ];
    ...
    const items1 = [React4(tmp5(4634).Text, obj7), ];
    const obj8 = { variant: "text-xs/medium", color: "text-muted", children: giftSubtext };
    items1[1] = React4(tmp5(4634).Text, obj8);
