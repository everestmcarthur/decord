...
// Dependencies: [19, 17, 21, 4639, 576, 8293, 14993, 15002, 15004, 4484, 15003, 4635, 2]
// Exports: default
...
export default function FamilyCenterActivityGiftRow(arg0) {
  ...
  if (null == displayName) {
    ...
    const items = [React4(tmp2(15003), obj5), ];
    ...
    const items1 = [React4(tmp5(4635).Text, obj7), ];
    const obj8 = { variant: "text-xs/medium", color: "text-muted", children: giftSubtext };
    items1[1] = React4(tmp5(4635).Text, obj8);
