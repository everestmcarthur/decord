...
// Dependencies: [5, 19, 17, 21, 4640, 576, 8743, 4636, 1115, 2397, 15032, 4338, 4599, 4843, 4337, 7348, 8571, 8572, 5060, 6717, 12078, 5521, 5062, 5712, 12080, 2]
// Exports: default

// Module 15031 (ChangeSpendingLimitModal)
...
function ChangeSpendingLimitScreen(teenId) {
  ...
  if (null != monthlySpend) {
    ...
    if (monthlySpend > 0) {
      formatPriceResult = tmp2(7348).formatPrice(monthlySpend, tmp5);
      const tmp2Result = tmp2(7348);
    }
  }
  ...
  if (null == formatPriceResult) {
    ...
    items[1] = tmp8(tmp2(5060).Stack, obj4);
    obj2.children = items;
    obj8.children = tmp8(tmp2(5060).Stack, obj2);
    const items3 = [tmp9(tmp2(8572).ModalContent, obj8), ];
    if (isClearingCap) {
    ...
    const items4 = [tmp9(tmp2(5062).Button, obj10), ];
    const obj14 = { variant: "tertiary", text: null, onPress: null };
    const intl9 = tmp2(1115).intl;
    obj14.text = intl9.string(tmp2(1115).t["ETE/oC"]);
    obj14.onPress = tmp10(4843).pop;
    items4[1] = tmp9(tmp2(5062).Button, obj14);
    obj13.children = items4;
    obj12.children = tmp8(tmp2(5521).ButtonGroup, obj13);
    items3[1] = tmp9(tmp2(12078).ModalFooter, obj12);
    obj11.children = items3;
    return tmp8(tmp2(8571).ModalScreen, obj11);
    ...
    const items5 = [tmp9(tmp2(8743).WarningIcon, obj16), ];
    ...
    items5[1] = tmp9(tmp2(4636).Text, obj17);
    ...
    tmp9Result1 = tmp9(tmp2(4636).Text, obj19);
  }
}
...
export default function ChangeSpendingLimitModal(teenId) {
  ...
  const memo = noop.useMemo(() => {
    ...
    const obj2 = {
      ...
      headerTitle() {
        ...
        return closure_1_6(teenId(4636).Text, obj);
      },
      render() {
  ...
  return closure_6(teenId(12080).Modal, obj);
};
