...
// Dependencies: [32, 19, 17, 7611, 21, 4606, 576, 8737, 7665, 14949, 4602, 12010, 1114, 2396, 14955, 5174, 2]
// Exports: default
...
export default function FamilyCenterActivitySection(displayType) {
  ...
  const familyCenterActions = displayType(12010).useFamilyCenterActions({});
  ...
  if (0 === actionsForDisplayType.length) {
    ...
    if (substr.length >= actionTotalsForDisplayType) {
      ...
      if (familyCenterActions.isMoreLoading) {
        ...
        obj10.children = tmp17(tmp(4602).Text, obj11);
        tmp17Result = tmp17(tmp(5174).PressableOpacity, obj10);
      }
