...
// Dependencies: [4853, 7645, 1074, 1241, 7646, 4842, 12049, 1897, 2]
// Exports: handleFamilyCenterQRCodeScan, resumeFamilyCenterConnection

// Module 12048 (FamilyCenterNativeUtils)
...
export const handleFamilyCenterQRCodeScan = function handleFamilyCenterQRCodeScan(pathname, FamilyCenterQRCodeScan) {
  ...
  if (null === match) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12049, dependencyMap.paths), obj5, c7);
  }
};
export const resumeFamilyCenterConnection = function resumeFamilyCenterConnection() {
  ...
  if (flag) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12049, dependencyMap.paths), { userId: null, linkCode: null }, c7);
    flag = true;
