...
// Dependencies: [4820, 7611, 1074, 1242, 7612, 4809, 12008, 1896, 2]
// Exports: handleFamilyCenterQRCodeScan, resumeFamilyCenterConnection

// Module 12007 (FamilyCenterNativeUtils)
...
export const handleFamilyCenterQRCodeScan = function handleFamilyCenterQRCodeScan(pathname, FamilyCenterQRCodeScan) {
  ...
  if (null === match) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12008, dependencyMap.paths), obj5, c7);
  }
};
export const resumeFamilyCenterConnection = function resumeFamilyCenterConnection() {
  ...
  if (flag) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12008, dependencyMap.paths), { userId: null, linkCode: null }, c7);
    flag = true;
