...
// Dependencies: [19, 17, 21, 4638, 8780, 8781, 14992, 576, 12062, 1115, 2397, 14999, 15000, 4634, 2]
// Exports: default
...
const FamilyCenterBannerButton = tmp2(14992);
require = fn;
...
export default function FamilyCenterActivityBanner() {
  ...
  obj5.source = tmp(tmp3 ? 14999 : 15000);
  obj5.style = tmp4.art;
