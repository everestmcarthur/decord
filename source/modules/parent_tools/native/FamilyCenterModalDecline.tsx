...
// Dependencies: [19, 17, 21, 4640, 576, 8801, 4843, 4337, 1115, 12068, 38, 8571, 8572, 15046, 7106, 4636, 2397, 15016, 12078, 5521, 5062, 5712, 12080, 2]
// Exports: default

// Module 15050 (FamilyCenterModalDecline)
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  obj5.iconSrc = declineLinkRequest(7106);
  const items1 = [closure_5(declineLinkRequest(15046), obj5), , ];
  ...
  items1[2] = closure_5(declineLinkRequest(15016), { user: otherUser });
  ...
  const items3 = [closure_5(otherUser(4636).Text, obj8), ];
  ...
  items3[1] = closure_5(otherUser(4636).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(8572).ModalContent, obj3), ];
  ...
  const items5 = [closure_5(otherUser(5062).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(4843).pop;
  items5[1] = closure_5(otherUser(5062).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5521).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12078).ModalFooter, obj10);
