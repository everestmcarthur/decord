...
// Dependencies: [19, 17, 21, 4639, 576, 8772, 4842, 4337, 1115, 12051, 38, 8542, 8543, 15022, 7099, 4635, 2397, 14992, 12061, 5518, 5059, 5709, 12063, 2]
// Exports: default

// Module 15026 (FamilyCenterModalDecline)
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  const obj = otherUser(12051);
  obj5.iconSrc = declineLinkRequest(7099);
  const items1 = [closure_5(declineLinkRequest(15022), obj5), , ];
  ...
  items1[1] = closure_5(otherUser(4635).Text, obj6);
  items1[2] = closure_5(declineLinkRequest(14992), { user: otherUser });
  ...
  const items3 = [closure_5(otherUser(4635).Text, obj8), ];
  ...
  items3[1] = closure_5(otherUser(4635).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(8543).ModalContent, obj3), ];
  ...
  const items5 = [closure_5(otherUser(5059).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(4842).pop;
  items5[1] = closure_5(otherUser(5059).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5518).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12061).ModalFooter, obj10);
  obj2.children = items4;
  return closure_6(otherUser(8542).ModalScreen, obj2);
}
...
export default function FamilyCenterModalDecline(otherUser) {
  ...
  return closure_5(otherUser(12063).Modal, obj);
};
