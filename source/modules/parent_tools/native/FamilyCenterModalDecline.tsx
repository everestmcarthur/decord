...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  obj5.iconSrc = declineLinkRequest(7065);
  ...
  const items3 = [closure_5(otherUser(4602).Text, obj8), ];
  ...
  items3[1] = closure_5(otherUser(4602).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(8508).ModalContent, obj3), ];
  ...
  const items5 = [closure_5(otherUser(5026).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(4809).pop;
  items5[1] = closure_5(otherUser(5026).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5484).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12020).ModalFooter, obj10);
