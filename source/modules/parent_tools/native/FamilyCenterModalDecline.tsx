...
// Dependencies: [19, 17, 21, 4638, 576, 8781, 4841, 4335, 1115, 12059, 38, 8551, 8552, 15038, 7102, 4634, 2397, 15008, 12069, 5519, 5060, 5710, 12071, 2]
// Exports: default

// Module 15042 (FamilyCenterModalDecline)
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  const callback = noop.useCallback(() => {
    declineLinkRequest(4841).pop();
  }, []);
  const callback1 = noop.useCallback(() => {
    const intl = otherUser(1115).intl;
    otherUser(4335).presentFailedToast(intl.string(otherUser(1115).t.R0RpRX));
  }, []);
  const tmp2 = declineLinkRequest(8781)();
  ...
  const obj = otherUser(12059);
  obj5.iconSrc = declineLinkRequest(7102);
  const items1 = [closure_5(declineLinkRequest(15038), obj5), , ];
  const obj6 = { style: tmp.headerText, variant: "text-lg/bold", children: null };
  let intl = otherUser(1115).intl;
  obj6.children = intl.string(declineLinkRequest(2397).teIRCR);
  items1[1] = closure_5(otherUser(4634).Text, obj6);
  items1[2] = closure_5(declineLinkRequest(15008), { user: otherUser });
  ...
  obj8.children = intl2.string(declineLinkRequest(2397).cXgKMD);
  const items3 = [closure_5(otherUser(4634).Text, obj8), ];
  const obj9 = { variant: "text-sm/normal", color: "text-default", children: null };
  const intl3 = otherUser(1115).intl;
  obj9.children = intl3.string(declineLinkRequest(2397).LcM8BS);
  items3[1] = closure_5(otherUser(4634).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(8552).ModalContent, obj3), ];
  ...
  obj12.text = intl4.string(declineLinkRequest(2397).dKxFcn);
  obj12.onPress = callback2;
  const items5 = [closure_5(otherUser(5060).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(4841).pop;
  items5[1] = closure_5(otherUser(5060).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5519).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12069).ModalFooter, obj10);
  obj2.children = items4;
  return closure_6(otherUser(8551).ModalScreen, obj2);
}
...
export default function FamilyCenterModalDecline(otherUser) {
  ...
  return closure_5(otherUser(12071).Modal, obj);
};
