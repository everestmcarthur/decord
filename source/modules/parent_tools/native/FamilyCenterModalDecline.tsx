...
// Dependencies: [19, 17, 21, 4722, 576, 8884, 4925, 4419, 1115, 12160, 38, 8654, 8655, 15140, 7188, 4718, 2480, 15110, 12170, 5603, 5144, 5794, 11451, 2]
// Exports: default

// Module 15144 (FamilyCenterModalDecline)
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  obj5.iconSrc = declineLinkRequest(7188);
  const items1 = [closure_5(declineLinkRequest(15140), obj5), , ];
  const obj6 = { style: tmp.headerText, variant: "text-lg/bold", children: null };
  let intl = otherUser(1115).intl;
  obj6.children = intl.string(declineLinkRequest(2480).teIRCR);
  items1[1] = closure_5(otherUser(4718).Text, obj6);
  items1[2] = closure_5(declineLinkRequest(15110), { user: otherUser });
  ...
  obj8.children = intl2.string(declineLinkRequest(2480).cXgKMD);
  const items3 = [closure_5(otherUser(4718).Text, obj8), ];
  const obj9 = { variant: "text-sm/normal", color: "text-default", children: null };
  const intl3 = otherUser(1115).intl;
  obj9.children = intl3.string(declineLinkRequest(2480).LcM8BS);
  items3[1] = closure_5(otherUser(4718).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(8655).ModalContent, obj3), ];
  ...
  obj12.text = intl4.string(declineLinkRequest(2480).dKxFcn);
  obj12.onPress = callback2;
  const items5 = [closure_5(otherUser(5144).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(4925).pop;
  items5[1] = closure_5(otherUser(5144).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5603).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12170).ModalFooter, obj10);
