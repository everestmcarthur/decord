...
// Module 14981 (FamilyCenterModalDecline)
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  obj5.iconSrc = declineLinkRequest(7066);
  const items1 = [closure_5(declineLinkRequest(14977), obj5), , ];
  ...
  const items3 = [closure_5(otherUser(4603).Text, obj8), ];
  ...
  items3[1] = closure_5(otherUser(4603).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(8510).ModalContent, obj3), ];
  ...
  const items5 = [closure_5(otherUser(5027).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(4810).pop;
  items5[1] = closure_5(otherUser(5027).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5485).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12022).ModalFooter, obj10);
