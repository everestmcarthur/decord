...
// Dependencies: [5, 32, 19, 7644, 14925, 504, 7342, 14927, 2]
// Exports: useChangeSpendingLimitFormState

// Module 15008 (ChangeSpendingLimitFormState)
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (closure_6) {
              ...
              c3 = 1;
              if (closure_5) {
                const ParentalControlledSpendingLimit2 = tmp3(14925).ParentalControlledSpendingLimit;
                dependencyMap = 2;
                c4 = 1;
                const obj4 = { value: ParentalControlledSpendingLimit2.updateControlledSetting(tmp3, null), done: false };
                return obj4;
              } else if (null != rounded) {
                const ParentalControlledSpendingLimit = tmp3(14925).ParentalControlledSpendingLimit;
