...
// Dependencies: [32, 4856, 1073, 1372, 7652, 1972, 11, 7653, 7706, 2]

// Module 7651 (FamilyCenterStore)
...
function handleInitialLoad(arg0) {
  ...
  closure_32 = guilds.reduce((acc, approximate_member_count) => {
    ...
    const obj2 = {};
    const merged1 = Object.assign(closure_0(1972).dangerouslyConstructGuildRecordFromUntypedObject(approximate_member_count));
...
const getCountryCodeByAlpha2 = fn(4856).getCountryCodeByAlpha2;
...
prototype["loadCache"] = function loadCache() {
  ...
  if (null != snapshot) {
    ...
    snapshot = teenActivityTotals.reduce((acc, item) => {
      ...
      const result = closure_0(7706).displayTypeFromString(tmp2);
      let tmp5 = acc;
      if (undefined !== result) {
        const obj2 = {};
        const merged = Object.assign(acc);
