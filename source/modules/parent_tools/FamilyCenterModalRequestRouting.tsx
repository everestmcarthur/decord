...
// Dependencies: [5, 7612, 7613, 2]
// Exports: resolveConnectionPrereqTarget

// Module 12011 (FamilyCenterModalRequestRouting)
...
let obj = { section: frozen.ERROR, params: { failureCode: fn(7612).FamilyCenterFailureCode.GENERIC_ERROR } };
const size = fn(2);
