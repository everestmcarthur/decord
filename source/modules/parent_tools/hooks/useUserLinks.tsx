...
// Function ID: 8781
// Name: useUserLinks
// Dependencies: [19, 1372, 7647, 7648, 563, 8781, 8782, 7702, 2]
...
export const useHasMaxConnections = function useHasMaxConnections() {
  const ACTIVE = constants.ACTIVE;
  let stateFromStores;
  const tmp = stateFromStores(8781)();
  const items = [FamilyCenterStore];
...
export const useActivityWindowTimeStamp = function useActivityWindowTimeStamp(activityWindowTimestampFormatter) {
  ...
  if (null != stateFromStores) {
    ...
    result = tmp(7702).formatUserActivityTimestamp(date.getTime(), () => closure_0, 7);
