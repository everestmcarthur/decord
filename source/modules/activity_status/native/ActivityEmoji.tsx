...
// Function ID: 11143
// Name: ActivityEmoji
// Dependencies: [19, 21, 4722, 1936, 1397, 8997, 7326, 2]
// Exports: default

// Module 11142 (ActivityEmoji)
...
export default function ActivityEmoji(emoji) {
  ...
  const AnimateEmoji = emoji(1936).AnimateEmoji;
  let animated;
  ...
  if (null == emoji) {
    ReactionIcon = ReactionIcon(8997).ReactionIcon;
