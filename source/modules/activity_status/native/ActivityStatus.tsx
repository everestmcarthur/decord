...
// Function ID: 10947
// Name: ActivityStatus
// Dependencies: [19, 17, 4645, 4253, 1371, 10947, 1074, 21, 4605, 504, 10948, 10949, 10950, 10951, 10956, 10957, 10963, 10965, 10955, 2]
// Exports: default

// Module 10946 (ActivityStatus)
...
export default function ActivityStatus(guildId) {
  ...
  const gameMentionsAsPlainText = userId(10950).useGameMentionsAsPlainText(state);
  const obj3 = userId(10950);
  ...
  if (tmp2Result.useStateFromStores(items3, () => RelationshipStore.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      ...
      obj4.hideIcon = tmp12;
      obj4.hideText = tmp13;
      let tmp18Result = closure_10(tmp5(10951), obj4);
      ...
      if (null != found1) {
        ...
        obj5.hideIcon = tmp12;
        obj5.hideText = tmp13;
        tmp18Result = closure_10(tmp5(10957), obj5);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj6.hideIcon = tmp12;
          obj6.hideText = tmp13;
          tmp18Result = closure_10(tmp5(10963), obj6);
        }
      }
    }
    let tmp21 = null;
    if (null != memo) {
      ...
      if (null != memo) {
        ...
        if (tmp25) {
          ...
          tmp25 = closure_10(tmp5(10965), obj7);
        }
        const items7 = [tmp25, ];
        ...
        if (tmp27) {
          ...
          tmp27 = closure_10(tmp5(10955), obj8);
        }
    ...
    if (tmp31) {
      ...
      tmp31 = closure_10(tmp5(10955), obj11);
    }
    items8[1] = tmp31;
    items8[2] = tmp21;
