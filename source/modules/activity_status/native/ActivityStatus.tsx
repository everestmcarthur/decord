...
// Function ID: 10966
// Name: ActivityStatus
// Dependencies: [19, 17, 4646, 4255, 1371, 10966, 1074, 21, 4606, 504, 10967, 10968, 10969, 10970, 10975, 10976, 10982, 10984, 10974, 2]
// Exports: default

// Module 10965 (ActivityStatus)
...
const DOT_UNICODE = fn(10966).DOT_UNICODE;
...
export default function ActivityStatus(guildId) {
  ...
  const voiceChannel = stateFromStores1(10968)({ userId, guildId: guildId.guildId }).voiceChannel;
  ...
  const tmp6 = stateFromStores1(10967)(userId);
  let state;
  if (memo != null) {
    state = memo.state;
  }
  const gameMentionsAsPlainText = userId(10969).useGameMentionsAsPlainText(state);
  const obj3 = userId(10969);
  ...
  if (tmp2Result.useStateFromStores(items3, () => RelationshipStore.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      let found;
      if (stateFromStores1 != null) {
        found = stateFromStores1.find(tmp5(10975));
      }
      ...
      obj4.hideIcon = tmp12;
      obj4.hideText = tmp13;
      let tmp18Result = closure_10(tmp5(10970), obj4);
      const tmp5Result = tmp5(10970);
    } else {
      let found1;
      if (stateFromStores1 != null) {
      ...
      if (null != found1) {
        ...
        obj5.hideIcon = tmp12;
        obj5.hideText = tmp13;
        tmp18Result = closure_10(tmp5(10976), obj5);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj6.hideIcon = tmp12;
          obj6.hideText = tmp13;
          tmp18Result = closure_10(tmp5(10982), obj6);
        }
      }
    }
    let tmp21 = null;
    if (null != memo) {
      ...
      if (null != memo) {
        ...
        if (tmp25) {
          ...
          tmp25 = closure_10(tmp5(10984), obj7);
        }
        const items7 = [tmp25, ];
        ...
        if (tmp27) {
          ...
          tmp27 = closure_10(tmp5(10974), obj8);
        }
    ...
    if (tmp31) {
      ...
      tmp31 = closure_10(tmp5(10974), obj11);
    }
    items8[1] = tmp31;
    items8[2] = tmp21;
