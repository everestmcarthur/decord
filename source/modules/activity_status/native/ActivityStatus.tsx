...
// Function ID: 11031
// Name: ActivityStatus
// Dependencies: [19, 17, 4680, 4288, 1372, 11031, 1074, 21, 4640, 504, 11032, 11033, 11034, 11035, 11040, 11041, 11047, 11049, 11039, 2]
// Exports: default

// Module 11030 (ActivityStatus)
...
const DOT_UNICODE = fn(11031).DOT_UNICODE;
...
export default function ActivityStatus(guildId) {
  ...
  const voiceChannel = stateFromStores1(11033)({ userId, guildId: guildId.guildId }).voiceChannel;
  ...
  const tmp6 = stateFromStores1(11032)(userId);
  let state;
  if (memo != null) {
    state = memo.state;
  }
  const gameMentionsAsPlainText = userId(11034).useGameMentionsAsPlainText(state);
  const obj3 = userId(11034);
  ...
  if (tmp2Result.useStateFromStores(items3, () => RelationshipStore.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      let found;
      if (stateFromStores1 != null) {
        found = stateFromStores1.find(tmp5(11040));
      }
      ...
      obj4.hideIcon = tmp12;
      obj4.hideText = tmp13;
      let tmp18Result = closure_10(tmp5(11035), obj4);
      const tmp5Result = tmp5(11035);
    } else {
      let found1;
      if (stateFromStores1 != null) {
      ...
      if (null != found1) {
        ...
        obj5.hideIcon = tmp12;
        obj5.hideText = tmp13;
        tmp18Result = closure_10(tmp5(11041), obj5);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj6.hideIcon = tmp12;
          obj6.hideText = tmp13;
          tmp18Result = closure_10(tmp5(11047), obj6);
        }
      }
    }
    let tmp21 = null;
    if (null != memo) {
      ...
      if (null != memo) {
        ...
        if (tmp25) {
          ...
          tmp25 = closure_10(tmp5(11049), obj7);
        }
        const items7 = [tmp25, ];
        ...
        if (tmp27) {
          ...
          tmp27 = closure_10(tmp5(11039), obj8);
        }
    ...
    if (tmp31) {
      ...
      tmp31 = closure_10(tmp5(11039), obj11);
    }
    items8[1] = tmp31;
    items8[2] = tmp21;
