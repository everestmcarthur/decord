...
// Function ID: 10968
// Name: ActivityStatus
// Dependencies: [19, 17, 4647, 4255, 1371, 10968, 1074, 21, 4607, 504, 10969, 10970, 10971, 10972, 10977, 10978, 10984, 10986, 10976, 2]
// Exports: default

// Module 10967 (ActivityStatus)
...
const DOT_UNICODE = fn(10968).DOT_UNICODE;
...
export default function ActivityStatus(guildId) {
  ...
  const voiceChannel = stateFromStores1(10970)({ userId, guildId: guildId.guildId }).voiceChannel;
  ...
  const tmp6 = stateFromStores1(10969)(userId);
  let state;
  if (memo != null) {
    state = memo.state;
  }
  const gameMentionsAsPlainText = userId(10971).useGameMentionsAsPlainText(state);
  const obj3 = userId(10971);
  ...
  if (tmp2Result.useStateFromStores(items3, () => RelationshipStore.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      let found;
      if (stateFromStores1 != null) {
        found = stateFromStores1.find(tmp5(10977));
      }
      ...
      obj4.hideIcon = tmp12;
      obj4.hideText = tmp13;
      let tmp18Result = closure_10(tmp5(10972), obj4);
      const tmp5Result = tmp5(10972);
    } else {
      let found1;
      if (stateFromStores1 != null) {
      ...
      if (null != found1) {
        ...
        obj5.hideIcon = tmp12;
        obj5.hideText = tmp13;
        tmp18Result = closure_10(tmp5(10978), obj5);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj6.hideIcon = tmp12;
          obj6.hideText = tmp13;
          tmp18Result = closure_10(tmp5(10984), obj6);
        }
      }
    }
    let tmp21 = null;
    if (null != memo) {
      ...
      if (null != memo) {
        ...
        if (tmp25) {
          ...
          tmp25 = closure_10(tmp5(10986), obj7);
        }
        const items7 = [tmp25, ];
        ...
        if (tmp27) {
          ...
          tmp27 = closure_10(tmp5(10976), obj8);
        }
    ...
    if (tmp31) {
      ...
      tmp31 = closure_10(tmp5(10976), obj11);
    }
    items8[1] = tmp31;
    items8[2] = tmp21;
