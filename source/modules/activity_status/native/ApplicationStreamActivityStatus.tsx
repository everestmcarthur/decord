...
// Dependencies: [19, 21, 1114, 10971, 10972, 10974, 2]
// Exports: default

// Module 10970 (ApplicationStreamActivityStatus)
import util from "util" /* 1114 */;
import ActivityStatusIconDefault from "ActivityStatusIcon" /* 10971 */;
import ActivityStatusTextDefault from "ActivityStatusText" /* 10974 */;
...
export default function ApplicationStreamActivityStatus(hideText) {
  ...
  let tmp12 = !hideIcon;
  if (!hideIcon) {
    const obj2 = { icon: tmp7(10972).TvIcon, style: iconStyle };
