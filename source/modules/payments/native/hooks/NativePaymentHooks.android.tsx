...
// Dependencies: [5, 32, 19, 7344, 3, 504, 12, 9499, 4312, 2]
...
// Module 9498 (NativePaymentHooks)
        ...
        try {
          ...
          if (0 === v2) {
                ...
                if (!tmp46) {
                  if (0 !== arr.length) {
                    if (0 !== differenceResult.length) {
                      ...
                      v2 = 2;
                      c5 = 1;
                      const obj7 = { value: closure_2_0(9499).loadInAppSkus(differenceResult), done: false };
                      return obj7;
                    }
                  }
                }
            ...
            if (1 === tmp8) {
              ...
              v2("Unable to fetch");
              const result = closure_2_0(4312).captureBillingException(closure_128_1);
              const obj3 = closure_2_0(4312);
            } else if (arg0 === 1) {
              c5 = 3;
              throw value;
            } else if (arg0 !== 2) {
