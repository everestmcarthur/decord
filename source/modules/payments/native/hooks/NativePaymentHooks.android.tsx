...
// Dependencies: [5, 32, 19, 7351, 3, 504, 12, 9521, 4312, 2]
...
// Module 9520 (NativePaymentHooks)
                ...
                if (!tmp46) {
                  if (0 !== arr.length) {
                    if (0 !== differenceResult.length) {
                      ...
                      v2 = 2;
                      c5 = 1;
                      const obj7 = { value: closure_2_0(9521).loadInAppSkus(differenceResult), done: false };
                      return obj7;
                    }
                  }
                }
