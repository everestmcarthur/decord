...
// Dependencies: [5, 32, 19, 7346, 4302, 4303, 7344, 1074, 3, 504, 7526, 10888, 4312, 10939, 5683, 1241, 10941, 7347, 38, 4963, 10943, 10944, 2]
// Exports: useCancelSubscription, useCreateSubscription, useGoogleSkuIds, useMobileStoreFront, useResubscribeSubscription

// Module 10938 (hooks/NativePaymentHooks)
import LoggerDefault from "Logger" /* 3 */;
import initialize from "initialize" /* 504 */;
import BillingUtils from "BillingUtils" /* 4312 */;
import ProductIds from "ProductIds" /* 7347 */;
import BillingActionCreatorsDefault from "BillingActionCreators" /* 7526 */;
...
function useCancelSubscription(arg0, arg1) {
  ...
  obj2.cancelSubscription = memo.useCallback(storeFront(function*() {
    ...
    closure_128_0 = yield tmp2(7526).cancelGenericSubscription(closure_6.requestIdentifier, closure_6.subscriptionId, closure_1);
    yield tmp2(4963).fetchSubscriptions();
...
function useResubscribeSubscription(arg0) {
  ...
  obj2.resubscribeSubscription = noop.useCallback(stateFromStores(function*() {
    ...
    closure_128_0 = yield tmp2(7526).resubscribeGenericSubscription(closure_5, stateFromStores.isACOM);
    yield tmp2(4963).fetchSubscriptions();
    return closure_128_0;
  }), items3);
  return obj2;
