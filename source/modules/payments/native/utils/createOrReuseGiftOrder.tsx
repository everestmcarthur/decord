...
// Dependencies: [5, 19, 4588, 1373, 1085, 3, 7502, 1115, 4198, 4279, 2]
// Exports: useCreateOrReuseGiftOrder

// Module 10835 (createOrReuseGiftOrder)
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              if (null == closure_129_3) {
                ...
                c4 = 1;
                let getOrCreateOrder = _location(7502).getOrCreateOrder;
                ...
                const utcResult = _modDef4198().utc();
                obj6.createdAfter = _modDef4198().utc().subtract(_location(7502).DRAFT_ORDER_LOOKBACK_DAYS, "days").toISOString();
                ...
                c5 = 3;
                c6 = 1;
                const subtractResult = _modDef4198().utc().subtract(_location(7502).DRAFT_ORDER_LOOKBACK_DAYS, "days");
              }
            }
          } else if (2 === tmp7) {
            c4 = 0;
            ...
            obj11.tags = obj12;
            const result = _location(4279).captureBillingException(closure_129_5, obj11);
            throw closure_129_5;
          } else if (arg0 === 1) {
            c6 = 3;
            throw value;
