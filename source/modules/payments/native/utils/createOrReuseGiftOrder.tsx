...
// Dependencies: [5, 19, 4621, 1374, 1085, 3, 7536, 1364, 4231, 4312, 2]
// Exports: useCreateOrReuseGiftOrder

// Module 10879 (createOrReuseGiftOrder)
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              if (null == closure_129_3) {
                ...
                obj6.createdAfter = _modDef4231().utc().subtract(_location(7536).DRAFT_ORDER_LOOKBACK_DAYS, "days").toISOString();
