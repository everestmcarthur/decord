...
// Dependencies: [5, 19, 4589, 1373, 1085, 3, 7503, 1115, 4198, 4279, 2]
// Exports: useCreateOrReuseGiftOrder

// Module 10837 (createOrReuseGiftOrder)
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              if (null == closure_129_3) {
                ...
                c4 = 1;
                let getOrCreateOrder = _location(7503).getOrCreateOrder;
                ...
                obj6.createdAfter = _modDef4198().utc().subtract(_location(7503).DRAFT_ORDER_LOOKBACK_DAYS, "days").toISOString();
                ...
                c5 = 3;
                c6 = 1;
                const subtractResult = _modDef4198().utc().subtract(_location(7503).DRAFT_ORDER_LOOKBACK_DAYS, "days");
              }
            }
          } else if (2 === tmp7) {
            c4 = 0;
