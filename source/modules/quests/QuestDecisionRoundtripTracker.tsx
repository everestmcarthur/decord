...
// Dependencies: [7805, 4688, 1074, 5536, 7806, 7566, 1241, 7782, 7569, 2]

// Module 11419 (QuestDecisionRoundtripTracker)
...
function trackRoundtrip(apiResponseTimestamp, transition_case, fetched_at) {
  if (Math.random() <= 0.1) {
    ...
    obj4.is_foregrounded = tmp2(7569).isForegrounded();
    ...
    if (tmp5 != previousAdDecision) {
      ...
      if (tmp5 != previousAdDecision.creative) {
        ...
        if (AdCreativeType.AdCreativeType.QUEST !== type) {
          str4 = "bounty";
          if (tmp8(5536).AdCreativeType.BOUNTY !== type) {
            if (tmp8(5536).AdCreativeType.QUEST_HOME_HERO === type) {
    ...
    if (tmp5 != tmp7) {
      ...
      if (tmp5 != tmp7.creative) {
        ...
        if (AdCreativeType.AdCreativeType.QUEST !== type2) {
          str7 = "bounty";
          if (tmp10(5536).AdCreativeType.BOUNTY !== type2) {
            if (tmp10(5536).AdCreativeType.QUEST_HOME_HERO === type2) {
