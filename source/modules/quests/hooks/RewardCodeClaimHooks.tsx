...
// Dependencies: [5, 32, 19, 11308, 5461, 11805, 11518, 11224, 11225, 11229, 5465, 7742, 4262, 2]
  ...
  return trackQuestContentClickedWithImpression.useCallback(() => {
    if (null != fetchCode) {
      if (obj7.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_reward_code_redemption_link")) {
        const obj2 = { type: tmp18(11229).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp18(5465).AdCreativeType.QUEST, adCreativeId: claimCode.id, questContentCTA: tmp18(7742).QuestContentCTA.REDEEM_REWARD, surfaceId: hasError, sourceQuestContent: quest, impressionId: GET_REWARD_CODE, questContentPosition: onDismiss };
        tmp18(11225).captureAdUserAction(obj2);
        const tmp18Result = tmp18(11225);
        const obj3 = { type: tmp18(11229).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp18(5465).AdCreativeType.QUEST, adCreativeId: claimCode.id, questContentCTA: tmp18(7742).QuestContentCTA.VISIT_REDEMPTION_LINK, surfaceId: hasError, sourceQuestContent: quest, impressionId: GET_REWARD_CODE, questContentPosition: onDismiss };
        tmp18(11225).captureAdUserAction(obj3);
        const tmp18Result2 = tmp18(11225);
      } else {
        const obj = { questId: claimCode.id, questContent: hasError, questContentCTA: tmp18(7742).QuestContentCTA.REDEEM_REWARD, questContentPosition: onDismiss, sourceQuestContent: quest };
        questContent(obj);
        const obj4 = { questId: claimCode.id, questContent: hasError, questContentCTA: tmp18(7742).QuestContentCTA.VISIT_REDEMPTION_LINK, questContentPosition: onDismiss, sourceQuestContent: quest };
        questContent(obj4);
      }
      openURLDefault(tmp);
    ...
    if (hasError) {
      ...
      if (null != claimedAt) {
        ...
        if (obj4.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_reward_code_primary_cta")) {
          const obj2 = { type: tmp23(11229).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp23(5465).AdCreativeType.QUEST, adCreativeId: tmp7.id, questContentCTA: GET_REWARD_CODE, surfaceId: tmp25, sourceQuestContent, impressionId: questImpressionId, questContentPosition };
          tmp23(11225).captureAdUserAction(obj2);
          const tmp23Result = tmp23(11225);
        } else {
