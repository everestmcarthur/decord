...
// Dependencies: [5, 32, 19, 2025, 1371, 5444, 1074, 1373, 1114, 11488, 7722, 7724, 11295, 2024, 11781, 1885, 504, 11782, 8680, 8691, 5447, 11300, 1880, 9534, 11518, 11501, 7728, 7727, 2]
...
// Module 11780 (_getQuestsInstructionsToWinReward)
...
function _getQuestsInstructionsToWinReward(arg0) {
  ...
  if (isConsoleQuestResult) {
    isConsoleQuestResult = _1votF6(7724).shouldUsePlayOnDesktopTask(quest);
    const v1votF6Result = _1votF6(7724);
  }
  const v1votF6Result1 = _1votF6(7722);
  const isSponsoredPlayQuestResult = _1votF6(7722).isSponsoredPlayQuest(quest);
  const defaultRewardNameWithArticle = _1votF6(11295).getDefaultRewardNameWithArticle(quest.config, currentUser);
  if (isSponsoredPlayQuestResult) {
    ({ targetMinutes: targetMinutes4, applications } = taskDetails);
    if (withoutMarkdown) {
      const intl12 = _1votF6(1114).intl;
      ...
      obj = undefined;
      obj = {};
      const gameSheetHook = _1votF6(11781).createGameSheetHook(obj);
      obj[constants2.PACKAGE_ACTION_ADVENTURE] = _1votF6(1114).t.H485IA;
      obj[constants2.PACKAGE_RPG_MMO] = _1votF6(1114).t["3XS8Ni"];
      obj[constants2.PACKAGE_RACING_SPORTS] = _1votF6(1114).t["X+UCju"];
      obj[constants2.PACKAGE_SANDBOX_CREATIVE] = _1votF6(1114).t["6o4n1Q"];
      obj[constants2.PACKAGE_FAMILY_FRIENDLY] = _1votF6(1114).t.DUsNmf;
      obj[constants2.PACKAGE_HOLIDAY_SEASON] = _1votF6(1114).t["cWP8/Z"];
      obj[constants2.PACKAGE_NEW_YEARS] = _1votF6(1114).t["8+sIJz"];
      ...
      if (CDeHul == null) {
        CDeHul = _1votF6(1114).t.CDeHul;
      }
      const intl11 = _1votF6(1114).intl;
      ...
      const v1votF6Result3 = _1votF6(11781);
    }
  } else if (isConsoleQuestResult) {
    const targetMinutes3 = taskDetails.targetMinutes;
    const result = _1votF6(11295).isCollectibleQuestRewardPremiumExtendable(quest.config);
    const v1votF6Result4 = _1votF6(11295);
    const features4 = quest.config.features;
    const result1 = _1votF6(11295).isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config);
    const hasItem = features4.includes(constants2.NON_GAMING_PLAY_QUEST);
    if (isPremiumResult) {
      if (result) {
        if (!result1) {
          const t25 = _1votF6(1114).t;
          if (hasItem) {
          } else {
          }
        }
        if (!hasItem) {
          if (null != collectibleQuestRewardDuration) {
            const t27 = _1votF6(1114).t;
          } else {
            const t26 = _1votF6(1114).t;
          }
        }
        if (null != collectibleQuestRewardDuration) {
          let ztXW8V2 = _1votF6(1114).t.u5QXpw;
        } else {
          ztXW8V2 = _1votF6(1114).t.ztXW8V;
        }
      }
    }
    if (!result) {
      if (null == collectibleQuestRewardDuration) {
        const t23 = _1votF6(1114).t;
        if (hasItem) {
          e_K3xJ = t23["e+K3xJ"];
        } else {
          e_K3xJ = tmp74 ? t23.GFdaUK : t23.NIimTt;
        }
        ...
        const intl10 = _1votF6(1114).intl;
        if (withoutMarkdown) {
    ...
    const t24 = _1votF6(1114).t;
    if (hasItem) {
      let enQ3jU2 = t24.enQ3jU;
    } else {
      enQ3jU2 = tmp74 ? t24["4JS2QJ"] : t24.AwuMRS;
    }
    const v1votF6Result5 = _1votF6(11295);
  } else {
    if (v1votF6Result6.isConsoleQuest(quest)) {
      const targetMinutes2 = taskDetails.targetMinutes;
      const result2 = _1votF6(11295).isCollectibleQuestRewardPremiumExtendable(quest.config);
      const v1votF6Result7 = _1votF6(11295);
      if (isPremiumResult) {
        if (result2) {
          if (!v1votF6Result8.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config)) {
            const t20 = _1votF6(1114).t;
          }
          if (null == collectibleQuestRewardDuration) {
            const t21 = _1votF6(1114).t;
          }
          const t22 = _1votF6(1114).t;
        }
      }
      if (!result2) {
        if (null == collectibleQuestRewardDuration) {
          const t18 = _1votF6(1114).t;
          const tmp62 = tmp61 ? t18.GFdaUK : t18.NIimTt;
          ...
          const intl9 = _1votF6(1114).intl;
          if (withoutMarkdown) {
            let formatToPlainStringResult2 = intl9.formatToPlainString(tmp62, obj3);
          } else {
            formatToPlainStringResult2 = intl9.format(tmp62, obj3);
          }
        }
      }
      const t19 = _1votF6(1114).t;
      v1votF6Result8 = _1votF6(11295);
    } else {
      if (v1votF6Result9.shouldUsePlayOnDesktopTask(quest)) {
        const result3 = _1votF6(11295).isCollectibleQuestRewardPremiumExtendable(quest.config);
        const v1votF6Result10 = _1votF6(11295);
        const features3 = quest.config.features;
        const result4 = _1votF6(11295).isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config);
        const hasItem1 = features3.includes(constants2.NON_GAMING_PLAY_QUEST);
        if (isPremiumResult) {
          if (result3) {
            if (!result4) {
              const t15 = _1votF6(1114).t;
              if (hasItem1) {
              } else {
              }
            }
            if (!hasItem1) {
              if (null != collectibleQuestRewardDuration) {
                const t17 = _1votF6(1114).t;
              } else {
                const t16 = _1votF6(1114).t;
              }
            }
            if (null != collectibleQuestRewardDuration) {
              let ztXW8V = _1votF6(1114).t.u5QXpw;
            } else {
              ztXW8V = _1votF6(1114).t.ztXW8V;
            }
          }
        }
        if (!result3) {
          if (null == collectibleQuestRewardDuration) {
            const t13 = _1votF6(1114).t;
            if (hasItem1) {
            } else {
            }
        ...
        const t14 = _1votF6(1114).t;
        if (hasItem1) {
          let enQ3jU = t14.enQ3jU;
        } else {
          enQ3jU = tmp51 ? t14["4JS2QJ"] : t14.AwuMRS;
        }
        const v1votF6Result11 = _1votF6(11295);
      } else {
        const obj5 = { quest: null };
        obj5[0] = quest;
        if (v1votF6Result12.isTieredRewardCodeQuest(obj5)) {
          if (null != onGameTitleClick) {
            a_ia7F = _1votF6(1114).t.HHVg4i;
          } else {
            a_ia7F = _1votF6(1114).t["a/ia7F"];
          }
          ...
          const v1votF6Result13 = _1votF6(7724);
          const v1votF6Result14 = _1votF6(7724);
          if (hasWatchVideoTasksResult) {
            ...
            const result5 = _1votF6(11295).isCollectibleQuestRewardPremiumExtendable(quest.config);
            const v1votF6Result15 = _1votF6(11295);
            if (result5) {
              if (isPremiumResult) {
                if (!v1votF6Result16.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config)) {
                  vs_xBu = _1votF6(1114).t["vs/xBu"];
                }
                if (null != collectibleQuestRewardDuration) {
                  xqX_r5 = _1votF6(1114).t.tXwfJT;
                } else {
                  xqX_r5 = _1votF6(1114).t["xqX+r5"];
                }
              }
            }
            if (!result5) {
              if (null == collectibleQuestRewardDuration) {
                if (quest.id === closure_9) {
                  W_HkLO = _1votF6(1114).t.Rsd5bL;
                } else {
                  W_HkLO = _1votF6(1114).t["g+InPC"];
                }
              }
            ...
            W_HkLO = _1votF6(1114).t["W/HkLO"];
            v1votF6Result16 = _1votF6(11295);
            ...
            if (!v1votF6Result17.isPlayAnyActivityQuest(quest)) {
              ...
              if (features.includes(constants2.CLOUD_GAMING_ACTIVITY)) {
                ...
                if (features2.includes(tmp27.CLOUD_GAMING_PROVIDER_NVIDIA)) {
              ...
              const UuzHh8 = _1votF6(1114).t.UuzHh8;
            ...
            v1votF6Result17 = _1votF6(7722);
          } else {
            if (v1votF6Result18.hasAchievementInGameTask(quest)) {
              if (null != thirdPartyTaskDetails) {
                const result6 = _1votF6(11295).isCollectibleQuestRewardPremiumExtendable(quest.config);
                _1votF6(11295);
                if (needsToConnect) {
                  const t12 = _1votF6(1114).t;
                } else {
                  if (isPremiumResult) {
                    if (result6) {
                      if (!tmp16) {
                        if (null != collectibleQuestRewardDuration) {
                          const t9 = _1votF6(1114).t;
                        } else {
                          const t8 = _1votF6(1114).t;
                        }
                      }
                      if (null == collectibleQuestRewardDuration) {
                        const t10 = _1votF6(1114).t;
                      }
                      const t11 = _1votF6(1114).t;
                    }
                  }
                  if (!result6) {
                    if (null == collectibleQuestRewardDuration) {
                      const t6 = _1votF6(1114).t;
                  ...
                  const t7 = _1votF6(1114).t;
                }
                const v1votF6Result19 = _1votF6(11295);
              }
            }
            if (null != thirdPartyTaskDetails) {
              let description = thirdPartyTaskDetails.description;
            } else {
              const result7 = _1votF6(11295).isCollectibleQuestRewardPremiumExtendable(quest.config);
              const v1votF6Result21 = _1votF6(11295);
              if (isPremiumResult) {
                if (result7) {
                  if (!v1votF6Result22.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config)) {
                    const t3 = _1votF6(1114).t;
                  }
                  if (null == collectibleQuestRewardDuration) {
                    const t4 = _1votF6(1114).t;
                  }
                  const t5 = _1votF6(1114).t;
                }
              }
              if (!result7) {
                if (null == collectibleQuestRewardDuration) {
                  const t = _1votF6(1114).t;
                  const tmp9 = tmp90 ? t.ER9rII : t["hkJ+Gs"];
              ...
              const t2 = _1votF6(1114).t;
              v1votF6Result22 = _1votF6(11295);
            }
            return description;
          }
          hasWatchVideoTasksResult = _1votF6(7724).hasWatchVideoTasks(quest);
        }
        v1votF6Result12 = _1votF6(11295);
      }
      v1votF6Result9 = _1votF6(7724);
    }
    v1votF6Result6 = _1votF6(7724);
  }
}
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  if (tmpResult.isConsoleQuest(config)) {
    ...
    if (tmpResult1.hasWatchVideoTasks(config)) {
      const defaultWatchVideoTask = tmp(7724).getDefaultWatchVideoTask(config.config);
      let videoTitle;
      if (defaultWatchVideoTask != null) {
      ...
      if (tmpResult3.hasPlayActivityTask(config)) {
        const result = tmp(7722).isPlayAnyActivityQuest(config);
    ...
    if (isExpanded) {
      ...
      if (activeScreen !== tmp(5447).TaskPlatformScreen.SELECT) {
        if (tmpResult2.isSponsoredPlayQuest(quest)) {
          if (tmp10) {
            if (!tmp11) {
              const defaultRewardNameWithArticle = tmp(11295).getDefaultRewardNameWithArticle(quest.config, stateFromStores);
              const intl5 = tmp(1114).intl;
      ...
      if (tmpResult1.hasWatchVideoTasks(quest)) {
        ...
        if (!tmpResult4.hasAchievementInGameTask(quest)) {
          if (isQuestProgressing) {
            ...
            let contextualEntrypointHeading = tmp(11300).getContextualEntrypointHeading(obj4);
            const tmpResult5 = tmp(11300);
          } else {
            const intl2 = tmp(1114).intl;
...
export const useQuestBarTitle = function useQuestBarTitle(questDockQuest) {
  let obj = initialize;
  const items = [closure_6];
  const stateFromStores = obj.useStateFromStores(items, () => locale.locale);
  const questTaskDetails = useQuests.useQuestTaskDetails(questDockQuest);
  const obj2 = useQuests;
  const obj3 = useQuests;
  const thirdPartyTaskDetails = useQuests.useThirdPartyTaskDetails(questDockQuest);
  ...
  if (null != completedAt) {
    ...
    if (null != enrolledAt) {
      if (tmp7 > 0) {
        ...
        const intl3 = tmp(1114).intl;
        obj = { percent: null };
        obj[0] = tmp(1880).formatPercent(stateFromStores, tmp7, { roundingMode: "floor" });
        return intl3.formatToPlainString(tmp(1114).t.lVZaXD, obj);
      }
    }
    if (callback(obj3.useTaskPlatformScreen(questDockQuest, questTaskDetails), 1)[0] === tmp(5447).TaskPlatformScreen.SELECT) {
      const intl2 = tmp(1114).intl;
...
export const useModalCtaConfig = function useModalCtaConfig(quest) {
      ...
      if (dependencyMap === 2) {
        ...
        try {
          ...
          if (0 === c1) {
            ...
            obj2[0] = c1;
            obj2[1] = closure_1_0(7728).QuestContentCTA.OPEN_GAME_LINK;
            let tmp5;
            if (callback != null) {
              tmp5 = callback();
            }
            obj2[2] = tmp5;
            obj2[3] = closure_4;
            closure_1_0(11501).openGameLinkDirectly(closure_0, obj2);
            dependencyMap = 3;
            return { value: "HermesInternal", done: null };
          }
        } catch (tmp11) {
  ...
  obj[0] = quest(11300).getExternalCtaLabel(quest);
