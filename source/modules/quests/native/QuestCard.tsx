...
// Function ID: 15198
// Name: QuestCard
// Dependencies: [5, 32, 19, 17, 1372, 7811, 5530, 1085, 21, 576, 4638, 4490, 4487, 4354, 5533, 7817, 11916, 11629, 1478, 11431, 15198, 9017, 7710, 7715, 7836, 504, 11436, 7832, 7807, 11441, 4572, 11195, 4339, 15225, 11632, 7837, 7838, 7848, 5537, 11642, 4605, 15227, 1897, 11917, 7662, 1115, 11909, 11659, 15231, 11422, 11438, 11439, 5067, 10257, 8821, 1364, 8976, 4634, 15232, 5693, 15271, 5673, 5072, 1094, 15257, 5677, 15238, 11912, 15272, 5058, 5060, 15275, 8214, 10319, 15258, 2]

// Module 15197 (QuestCard)
import nativeDefault from "native" /* 576 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1897 */;
import design_shared from "design/shared" /* 4490 */;
...
import openVideoQuestModalDefault from "openVideoQuestModal" /* 15231 */;
import VideoQuestModal from "VideoQuestModal" /* 15232 */;
...
export const QuestCard = noop.memo((questContent) => {
  function trackClick(CLAIM_REWARD) {
    if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_card")) {
      const obj2 = { type: tmp(7848).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp(5537).AdCreativeType.QUEST, adCreativeId: quest.id, questContentCTA: CLAIM_REWARD, surfaceId: QUEST_HOME_MOBILE, sourceQuestContent, impressionId: getQuestImpressionId() };
  ...
  function showQuestBottomSheet() {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15227, dependencyMap.paths), "QuestBottomSheet", { questId: quest.id, questContentPosition, sourceQuestContent });
  }
  const tmp = require;
        ...
        if (hasWatchVideoTasksResult) {
          ...
          obj10.onPress = function onPress() {
            ...
            if (hasWatchVideoOnMobileTasks) {
              ...
              tmp5(4605).openLazy(asyncRequireImpl(15227, dependencyMap.paths), "QuestBottomSheet", obj2);
              const tmp5Result = tmp5(4605);
            }
          };
          let tmp63 = null;
          if (isQuestAccessSuspended) {
          ...
          try {
            ...
            if (0 === v1) {
              if (arg0 === 1) {
                ...
                if (!isMobileActivityQuest) {
                  if (!hasWatchVideoTasksResult) {
                    let START_QUEST = tmp30(7836).QuestContentCTA.ACCEPT_QUEST;
                  }
                ...
                START_QUEST = tmp30(7836).QuestContentCTA.START_QUEST;
              }
            } else if (arg0 === 1) {
              dependencyMap = 3;
              throw value;
  ...
  const memo1 = obj7.useMemo(() => {
    ...
    if (closure_16) {
      if (result2) {
        ...
        const items1 = [closure_2_12(tmp2(8976).OrbsIcon, obj4), , ];
        ...
        items1[2] = closure_2_12(tmp2(4634).Text, obj7);
    ...
    if (closure_16) {
      ...
      tmp15Result = closure_2_12(tmp2(4634).Text, obj9);
    } else if (result2) {
      ...
      const items2 = [closure_2_12(tmp2(4634).Text, obj11), ];
      ...
      const items3 = [closure_2_12(tmp2(8976).OrbsIcon, obj14), , ];
      ...
      items3[2] = closure_2_12(tmp2(4634).Text, obj17);
      ...
      tmp15Result = closure_2_12(tmp2(4634).Text, obj19);
    }
  }, items10);
  if (isQuestExpiredResult) {
    tmp86 = tmp91Result10;
  ...
  if (tmp46) {
    ...
    const obj44 = {
      onPress() {
          ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15275, dependencyMap.paths), "QuestEnrollmentBlockedBottomSheet", { questId: quest.id, questEnrollmentBlockedUntil, sourceQuestContent });
        },
      variant: "tertiary",
      text: null
    };
