...
export const QuestCard = noop.memo((questContent) => {
  ...
  function showQuestBottomSheet() {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15178, dependencyMap.paths), "QuestBottomSheet", { questId: quest.id, questContentPosition, sourceQuestContent });
  }
  const tmp = require;
  ...
  if (tmp46) {
    ...
    const obj44 = {
      onPress() {
          ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15226, dependencyMap.paths), "QuestEnrollmentBlockedBottomSheet", { questId: quest.id, questEnrollmentBlockedUntil, sourceQuestContent });
        },
      variant: "tertiary",
      text: null
    };
