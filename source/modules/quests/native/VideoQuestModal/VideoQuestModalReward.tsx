...
// Dependencies: [19, 21, 4605, 15205, 11555, 11838, 5023, 576, 15210, 4601, 1114, 2]

// Module 15228 (VideoQuestModalReward)
...
export default noop.memo(function VideoQuestModalReward(style) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp3(4601).Text, obj8);
  }
  items2[1] = tmp9Result;
  obj5.children = items2;
  items1[1] = closure_5(quest(5023).Stack, obj5);
  obj3.children = items1;
  return closure_5(quest(5023).Stack, obj3);
});
