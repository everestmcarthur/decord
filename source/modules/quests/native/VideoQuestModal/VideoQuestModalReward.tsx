...
// Dependencies: [19, 21, 4640, 15238, 11637, 11918, 5060, 576, 15243, 4636, 1115, 2]

// Module 15261 (VideoQuestModalReward)
...
export default noop.memo(function VideoQuestModalReward(style) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp3(4636).Text, obj8);
  }
  items2[1] = tmp9Result;
  obj5.children = items2;
  items1[1] = closure_5(quest(5060).Stack, obj5);
  obj3.children = items1;
  return closure_5(quest(5060).Stack, obj3);
});
