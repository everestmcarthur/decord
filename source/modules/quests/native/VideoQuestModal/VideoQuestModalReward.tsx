...
// Dependencies: [19, 21, 4606, 15184, 11577, 11860, 5024, 576, 15189, 4602, 1114, 2]
...
export default noop.memo(function VideoQuestModalReward(style) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp3(4602).Text, obj8);
  }
  items2[1] = tmp9Result;
  obj5.children = items2;
  items1[1] = closure_5(quest(5024).Stack, obj5);
  obj3.children = items1;
  return closure_5(quest(5024).Stack, obj3);
});
