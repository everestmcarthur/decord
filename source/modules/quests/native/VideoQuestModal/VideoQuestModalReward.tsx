...
// Dependencies: [19, 21, 4607, 15184, 11579, 11862, 5025, 576, 15189, 4603, 1114, 2]

// Module 15207 (VideoQuestModalReward)
...
export default noop.memo(function VideoQuestModalReward(style) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp3(4603).Text, obj8);
  }
  items2[1] = tmp9Result;
  obj5.children = items2;
  items1[1] = closure_5(quest(5025).Stack, obj5);
  obj3.children = items1;
  return closure_5(quest(5025).Stack, obj3);
});
