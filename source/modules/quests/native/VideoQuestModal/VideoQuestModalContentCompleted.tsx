...
// Dependencies: [32, 19, 17, 21, 4639, 576, 15222, 15217, 11423, 15246, 15213, 11216, 11621, 4376, 5058, 7827, 8482, 11433, 11917, 15187, 8388, 7230, 5057, 4635, 1115, 15239, 7180, 15240, 5059, 15209, 5207, 10310, 5532, 5672, 9185, 2]

// Module 15248 (VideoQuestModalContentCompleted)
...
obj.contentRewardsWrapper = { flexGrow: 1, flexShrink: 0, paddingTop: fn(15222).COMPLETION_GLOW_CLEARANCE };
obj.contentRewards = { alignItems: "center" };
obj.contentRewardsCopy = { textAlign: "center" };
let obj4 = { flexGrow: 1, flexShrink: 0, paddingTop: fn(15222).COMPLETION_GLOW_CLEARANCE };
