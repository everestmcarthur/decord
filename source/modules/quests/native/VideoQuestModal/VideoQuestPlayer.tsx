...
// Dependencies: [32, 19, 7810, 5529, 21, 15217, 11621, 11423, 4262, 15114, 15225, 7829, 15227, 1363, 11650, 11414, 15235, 15125, 2]
      ...
      if (0 !== arr.length) {
        if (null != ref.current) {
          ...
          if (obj.getVideoQoEMetricsConfig(obj2).externalAnalyticsEnabled) {
            ...
            const mobileMuxWrapper = new tmp2(15227).MobileMuxWrapper(obj3);
