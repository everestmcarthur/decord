...
// Dependencies: [19, 17, 7813, 21, 4638, 576, 15233, 11629, 7832, 4260, 11658, 4634, 1115, 15255, 2]
// Exports: default

// Module 15260 (VideoQuestModalHeader)
...
const useVideoQuestUIStore = fn(7813).useVideoQuestUIStore;
const jsxProd = fn(21);
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11658).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(11658);
  }
  ...
  const items1 = [closure_5(quest(4634).Text, obj5), ];
  ...
  items1[1] = closure_5(quest(4634).Text, obj7);
  obj4.children = items1;
  const items2 = [closure_6(View, obj4), closure_5(questTaskDetails(15255), { iconColor: closeButtonIconColor, onClose })];
