...
// Dependencies: [19, 17, 7819, 21, 4640, 576, 15238, 11637, 7838, 4262, 11666, 4636, 1115, 15260, 2]
// Exports: default

// Module 15265 (VideoQuestModalHeader)
...
const useVideoQuestUIStore = fn(7819).useVideoQuestUIStore;
const jsxProd = fn(21);
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  quest = quest(15238).useVideoQuestModalContext().quest;
  let obj = quest(15238);
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11666).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(11666);
  }
  ...
  const items1 = [closure_5(quest(4636).Text, obj5), ];
  ...
  items1[1] = closure_5(quest(4636).Text, obj7);
  obj4.children = items1;
  const items2 = [closure_6(View, obj4), closure_5(questTaskDetails(15260), { iconColor: closeButtonIconColor, onClose })];
