...
// Dependencies: [19, 17, 7810, 21, 4639, 576, 15217, 11621, 7829, 4262, 11650, 4635, 1115, 15239, 2]
// Exports: default

// Module 15244 (VideoQuestModalHeader)
...
const useVideoQuestUIStore = fn(7810).useVideoQuestUIStore;
const jsxProd = fn(21);
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11650).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(11650);
  }
  ...
  const items1 = [closure_5(quest(4635).Text, obj5), ];
  ...
  items1[1] = closure_5(quest(4635).Text, obj7);
  obj4.children = items1;
  const items2 = [closure_6(View, obj4), closure_5(questTaskDetails(15239), { iconColor: closeButtonIconColor, onClose })];
