...
// Dependencies: [19, 17, 7756, 21, 4605, 576, 15205, 11555, 7775, 4227, 11584, 4601, 1114, 15227, 2]
// Exports: default

// Module 15232 (VideoQuestModalHeader)
...
const useVideoQuestUIStore = fn(7756).useVideoQuestUIStore;
const jsxProd = fn(21);
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  quest = quest(15205).useVideoQuestModalContext().quest;
  let obj = quest(15205);
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11584).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(11584);
  }
  ...
  const items1 = [closure_5(quest(4601).Text, obj5), ];
  ...
  items1[1] = closure_5(quest(4601).Text, obj7);
  obj4.children = items1;
  const items2 = [closure_6(View, obj4), closure_5(questTaskDetails(15227), { iconColor: closeButtonIconColor, onClose })];
