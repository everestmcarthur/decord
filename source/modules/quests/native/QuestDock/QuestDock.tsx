...
// Function ID: 15296
// Name: QuestDock
// Dependencies: [5, 32, 109, 19, 17, 15205, 5532, 15207, 1074, 1085, 21, 4640, 576, 15214, 15204, 15208, 15211, 5047, 4376, 8416, 1612, 15212, 4341, 15296, 5061, 15206, 5065, 5044, 15297, 7187, 1115, 15298, 15299, 15300, 5048, 11637, 5535, 15301, 7716, 7721, 7842, 15294, 504, 11638, 11430, 4350, 15203, 1241, 15302, 15303, 15310, 15311, 15313, 11929, 5539, 15315, 15316, 15318, 2]

// Module 15295 (QuestDock)
...
import QuestDockGestureContext from "QuestDockGestureContext" /* 15208 */;
import QuestDockBountyHeaderDefault from "QuestDockBountyHeader" /* 15315 */;
import QuestDockBountyBodyDefault from "QuestDockBountyBody" /* 15316 */;
import QuestDockBountyBackgroundDefault from "QuestDockBountyBackground" /* 15318 */;
            ...
            if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
              ...
              if (obj3.get() === QuestDockMode.EXPANDED) {
                ...
                if (tmp) {
                  ...
                  num5 = tmp16(5061).withSpring(num6, tmp19);
                  const tmp16Result = tmp16(5061);
                }
                ...
                if (tmp) {
                  ...
                  num7 = tmp16(5061).withSpring(num8, tmp19);
                  const tmp16Result2 = tmp16(5061);
                }
...
function QuestDockWithEntranceAnimation(arg0) {
  ...
  const context = noop.useContext(identifierMetricTag(15294));
  ...
  if (!tmp14) {
    ...
    tmp16 = closure_23(tmp(4376).View, obj6);
  }
  return tmp16;
}
...
function QuestDockBountyContent(bounty) {
  ...
  const bountyPreviewImageUrl = bounty(15204).useBountyPreviewImageUrl(bounty);
  let obj = bounty(15204);
  const questDockBountyBackgroundColor = bounty(15204).useQuestDockBountyBackgroundColor();
  const obj3 = { bounty, children: null };
  const obj2 = bounty(15204);
  ...
  return closure_23(bounty(15214).QuestDockBountyProvider, obj3);
}
let closure_3 = ["mode"];
...
let obj7 = {};
const merged4 = Object.assign(fn(5065).SUBTLE_SPRING);
...
export default noop.memo(function QuestDockWithVisibilityContext() {
  ...
  const memo1 = noop.useMemo(() => {
    ...
    } else if (tmp2(5539).AdCreativeType.QUEST === type) {
      const obj = { quest: tmp.quest };
      return __initData3(QuestDockQuestContent, obj);
    } else if (tmp2(5539).AdCreativeType.NO_FILL === type) {
      return null;
    }
  }, items1);
  let tmp7 = null;
