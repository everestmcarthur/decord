...
// Function ID: 15390
// Name: QuestDock
// Dependencies: [5, 32, 109, 19, 17, 15299, 5614, 15301, 1074, 1085, 21, 4722, 576, 15308, 15298, 15302, 15305, 5129, 4458, 8499, 1612, 15306, 4423, 15390, 5143, 15300, 5147, 5126, 15391, 7269, 1115, 15392, 15393, 15394, 5130, 11729, 5617, 15395, 7798, 7803, 7924, 15388, 504, 11730, 11528, 4432, 15297, 1241, 15396, 15397, 15404, 15405, 15407, 12020, 5621, 15409, 15410, 15412, 2]

// Module 15389 (QuestDock)
...
import QuestDockGestureContext from "QuestDockGestureContext" /* 15302 */;
import QuestDockBountyHeaderDefault from "QuestDockBountyHeader" /* 15409 */;
import QuestDockBountyBodyDefault from "QuestDockBountyBody" /* 15410 */;
import QuestDockBountyBackgroundDefault from "QuestDockBountyBackground" /* 15412 */;
            ...
            if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
              ...
              if (obj3.get() === QuestDockMode.EXPANDED) {
                ...
                if (tmp) {
                  ...
                  num5 = tmp16(5143).withSpring(num6, tmp19);
                  const tmp16Result = tmp16(5143);
                }
                ...
                if (tmp) {
                  ...
                  num7 = tmp16(5143).withSpring(num8, tmp19);
                  const tmp16Result2 = tmp16(5143);
                }
...
function QuestDockWithEntranceAnimation(arg0) {
  ...
  const context = noop.useContext(identifierMetricTag(15388));
  ...
  if (!tmp14) {
    ...
    tmp16 = closure_23(tmp(4458).View, obj6);
  }
  return tmp16;
}
...
function QuestDockBountyContent(bounty) {
  ...
  const bountyPreviewImageUrl = bounty(15298).useBountyPreviewImageUrl(bounty);
  let obj = bounty(15298);
  const questDockAppThemedBackgroundColor = bounty(15298).useQuestDockAppThemedBackgroundColor();
  const obj3 = { bounty, children: null };
  const obj2 = bounty(15298);
  ...
  return closure_23(bounty(15308).QuestDockBountyProvider, obj3);
}
let closure_3 = ["mode"];
...
let obj7 = {};
const merged4 = Object.assign(fn(5147).SUBTLE_SPRING);
...
export default noop.memo(function QuestDockWithVisibilityContext() {
  ...
  const memo1 = noop.useMemo(() => {
    ...
    } else if (tmp2(5621).AdCreativeType.QUEST === type) {
      const obj = { quest: tmp.quest };
      return __initData3(QuestDockQuestContent, obj);
    } else if (tmp2(5621).AdCreativeType.NO_FILL === type) {
      return null;
    }
  }, items1);
  let tmp7 = null;
