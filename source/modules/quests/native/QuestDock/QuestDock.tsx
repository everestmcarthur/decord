...
// Function ID: 15275
// Name: QuestDock
// Dependencies: [5, 32, 109, 19, 17, 15184, 5529, 15186, 1074, 1085, 21, 4639, 576, 15193, 15183, 15187, 15190, 5046, 4376, 8388, 1612, 15191, 4341, 15275, 5058, 15185, 5062, 5043, 15276, 7180, 1115, 15277, 15278, 15279, 5047, 11621, 5532, 15280, 7707, 7712, 7833, 15273, 504, 11622, 11414, 4350, 15182, 1241, 15281, 15282, 15289, 15290, 15292, 11912, 5536, 15294, 15295, 15297, 2]

// Module 15274 (QuestDock)
...
import QuestDockGestureContext from "QuestDockGestureContext" /* 15187 */;
import QuestDockBountyHeaderDefault from "QuestDockBountyHeader" /* 15294 */;
import QuestDockBountyBodyDefault from "QuestDockBountyBody" /* 15295 */;
import QuestDockBountyBackgroundDefault from "QuestDockBountyBackground" /* 15297 */;
            ...
            if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
              ...
              if (obj3.get() === QuestDockMode.EXPANDED) {
                ...
                if (tmp) {
                  ...
                  num5 = tmp16(5058).withSpring(num6, tmp19);
                  const tmp16Result = tmp16(5058);
                }
                ...
                if (tmp) {
                  ...
                  num7 = tmp16(5058).withSpring(num8, tmp19);
                  const tmp16Result2 = tmp16(5058);
                }
...
function QuestDockWithEntranceAnimation(arg0) {
  ...
  const context = noop.useContext(identifierMetricTag(15273));
...
function QuestDockBountyContent(bounty) {
  ...
  const bountyPreviewImageUrl = bounty(15183).useBountyPreviewImageUrl(bounty);
  let obj = bounty(15183);
  const questDockBountyBackgroundColor = bounty(15183).useQuestDockBountyBackgroundColor();
  const obj3 = { bounty, children: null };
  const obj2 = bounty(15183);
  ...
  return closure_23(bounty(15193).QuestDockBountyProvider, obj3);
}
let closure_3 = ["mode"];
...
let obj7 = {};
const merged4 = Object.assign(fn(5062).SUBTLE_SPRING);
...
export default noop.memo(function QuestDockWithVisibilityContext() {
  ...
  const memo1 = noop.useMemo(() => {
    ...
    } else if (tmp2(5536).AdCreativeType.QUEST === type) {
      const obj = { quest: tmp.quest };
      return __initData3(QuestDockQuestContent, obj);
    } else if (tmp2(5536).AdCreativeType.NO_FILL === type) {
      return null;
    }
  }, items1);
  let tmp7 = null;
