...
// Function ID: 15291
// Name: QuestDock
// Dependencies: [5, 32, 109, 19, 17, 15200, 5530, 15202, 1074, 1085, 21, 4638, 576, 15209, 15199, 15203, 15206, 5045, 4374, 8397, 1612, 15207, 4339, 15291, 5059, 15201, 5063, 5042, 15292, 7183, 1115, 15293, 15294, 15295, 5046, 11629, 5533, 15296, 7710, 7715, 7836, 15289, 504, 11630, 11422, 4348, 15198, 1241, 15297, 15298, 15305, 15306, 15308, 11920, 5537, 15310, 15311, 15313, 2]

// Module 15290 (QuestDock)
...
import QuestDockGestureContext from "QuestDockGestureContext" /* 15203 */;
import QuestDockBountyHeaderDefault from "QuestDockBountyHeader" /* 15310 */;
import QuestDockBountyBodyDefault from "QuestDockBountyBody" /* 15311 */;
import QuestDockBountyBackgroundDefault from "QuestDockBountyBackground" /* 15313 */;
            ...
            if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
              ...
              if (obj3.get() === QuestDockMode.EXPANDED) {
                ...
                if (tmp) {
                  ...
                  num5 = tmp16(5059).withSpring(num6, tmp19);
                  const tmp16Result = tmp16(5059);
                }
                ...
                if (tmp) {
                  ...
                  num7 = tmp16(5059).withSpring(num8, tmp19);
                  const tmp16Result2 = tmp16(5059);
                }
...
function QuestDockWithEntranceAnimation(arg0) {
  ...
  const context = noop.useContext(identifierMetricTag(15289));
  ...
  if (!tmp14) {
    ...
    tmp16 = closure_23(tmp(4374).View, obj6);
  }
  return tmp16;
}
...
function QuestDockBountyContent(bounty) {
  ...
  const bountyPreviewImageUrl = bounty(15199).useBountyPreviewImageUrl(bounty);
  let obj = bounty(15199);
  const questDockBountyBackgroundColor = bounty(15199).useQuestDockBountyBackgroundColor();
  const obj3 = { bounty, children: null };
  const obj2 = bounty(15199);
  ...
  return closure_23(bounty(15209).QuestDockBountyProvider, obj3);
}
let closure_3 = ["mode"];
...
let obj7 = {};
const merged4 = Object.assign(fn(5063).SUBTLE_SPRING);
...
export default noop.memo(function QuestDockWithVisibilityContext() {
  ...
  const memo1 = noop.useMemo(() => {
    ...
    } else if (tmp2(5537).AdCreativeType.QUEST === type) {
      const obj = { quest: tmp.quest };
      return __initData3(QuestDockQuestContent, obj);
    } else if (tmp2(5537).AdCreativeType.NO_FILL === type) {
      return null;
    }
  }, items1);
  let tmp7 = null;
