...
// Dependencies: [19, 17, 1085, 21, 4639, 15193, 15183, 15204, 5532, 7833, 4574, 4491, 15182, 15283, 4635, 1115, 5672, 15287, 15288, 15241, 2]

// Module 15282 (QuestDockUnenrolledHeader)
...
import QuestGameLogotypeDefault from "QuestGameLogotype" /* 15241 */;
...
export default noop.memo(function QuestDockUnenrolledHeader() {
  ...
  if (LIGHT === tmp10.DARK) {
    let tmp7Result4 = tmp7(15287);
  } else {
    tmp7Result4 = tmp7(15288);
  }
