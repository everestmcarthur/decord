...
// Dependencies: [19, 17, 1085, 21, 4605, 15181, 15171, 15192, 5497, 7779, 4540, 4456, 15170, 15271, 4601, 1114, 5637, 15275, 15276, 15229, 2]
...
export default noop.memo(function QuestDockUnenrolledHeader() {
  const questDockQuest = questCreative(15181).useQuestDockQuest();
  let obj = questCreative(15181);
  questCreative = questCreative(15181).useQuestCreative(questDockQuest);
  let obj2 = questCreative(15181);
  ...
  const actionSheetPressHandler = questCreative(15171).useActionSheetPressHandler(questCreative);
  ...
  obj5.collapsedContent = closure_6(questCreative(4601).Text, obj6);
  ...
  if (LIGHT === tmp10.DARK) {
    let tmp7Result4 = tmp7(15275);
  } else {
    tmp7Result4 = tmp7(15276);
  }
