...
// Dependencies: [19, 17, 1085, 21, 4574, 15132, 15122, 15143, 5461, 7742, 4509, 4425, 15121, 15222, 4570, 1114, 5601, 15226, 15227, 15180, 2]
...
export default noop.memo(function QuestDockUnenrolledHeader() {
  const questDockQuest = questCreative(15132).useQuestDockQuest();
  let obj = questCreative(15132);
  questCreative = questCreative(15132).useQuestCreative(questDockQuest);
  let obj2 = questCreative(15132);
  const items = [questCreative];
  const obj3 = questCreative(15122);
  ...
  const actionSheetPressHandler = questCreative(15122).useActionSheetPressHandler(questCreative);
  ...
  const tmpResult = questCreative(15121);
  ...
  obj5.collapsedContent = closure_6(questCreative(4570).Text, obj6);
  ...
  if (LIGHT === tmp10.DARK) {
    let tmp7Result4 = tmp7(15226);
  } else {
    tmp7Result4 = tmp7(15227);
  }
