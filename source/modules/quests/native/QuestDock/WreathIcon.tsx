...
// Function ID: 15217
// Name: WreathIcon
// Dependencies: [19, 21, 576, 4340, 15217, 2]
// Exports: default

// Module 15216 (WreathIcon)
...
export default function WreathIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15217, color: INTERACTIVE_TEXT_DEFAULT, style: color.style });
};
