...
// Dependencies: [5, 19, 17, 7717, 15123, 5458, 15125, 21, 4574, 576, 15129, 15126, 8295, 15121, 15154, 5461, 15151, 15150, 15152, 15132, 1611, 7738, 2]

// Module 15228 (QuestDockEnrolledBody)
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              if (tmp12) {
                const obj4 = { questId: tmp2.id, sourceQuestContent: quest(5461).QuestContent.QUEST_BAR_MOBILE };
                v1 = 1;
                c2 = 1;
                const obj5 = { value: setRestingQuestDockMode(15154)(obj4), done: false };
                return obj5;
              } else {
                c2 = 3;
              }
...
export default noop.memo(function QuestDockEnrolledBody() {
  const questDockQuest = minExpandedContentHeight(15132).useQuestDockQuest();
  const obj = minExpandedContentHeight(15132);
  minExpandedContentHeight = noop.useContext(minExpandedContentHeight(15126).QuestDockGestureContext).minExpandedContentHeight;
