...
// Dependencies: [5, 19, 5530, 1074, 21, 15209, 11666, 5537, 11441, 1115, 5533, 7836, 7837, 7838, 7848, 7826, 7309, 9221, 8728, 11642, 4605, 7307, 7830, 15211, 11909, 5766, 11422, 15213, 11667, 11629, 8855, 15214, 15216, 15218, 7078, 7492, 4584, 7299, 11258, 15220, 2]
// Exports: default

// Module 15210 (QuestDockContextMenuActionSheet)
...
function QuestDockPreviewTools(quest) {
  ...
  c3 = undefined;
  c4 = undefined;
  const questPreviewActions = quest(11629).useQuestPreviewActions(quest.id);
  ...
  let obj = quest(11629);
  obj3.icon = closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(8855).TrophyIcon });
  const obj5 = { text: null };
  const intl2 = quest(1115).intl;
  obj5.text = intl2.string(quest(1115).t.jQEfRT);
  obj3.label = closure_6(quest(8728).FormLabel, obj5);
  obj3.onPress = function onPress() {
    _undefined();
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  let items = [closure_6(quest(7309).ActionSheetRow, obj3), , , , , , ];
  const obj6 = { icon: null, label: null, onPress: null };
  const obj4 = { IconComponent: quest(8855).TrophyIcon };
  obj6.icon = closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(15214).RedoIcon });
  const obj8 = { text: null };
  const intl3 = quest(1115).intl;
  obj8.text = intl3.string(quest(1115).t.cKSLr4);
  obj6.label = closure_6(quest(8728).FormLabel, obj8);
  obj6.onPress = function onPress() {
    _undefined2(0.9 * Math.random() + 0.03);
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[1] = closure_6(quest(7309).ActionSheetRow, obj6);
  const obj9 = { icon: null, label: null, onPress: null };
  const obj7 = { IconComponent: quest(15214).RedoIcon };
  obj9.icon = closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(15216).UndoIcon });
  const obj11 = { text: null };
  const intl4 = quest(1115).intl;
  obj11.text = intl4.string(quest(1115).t.taqkwK);
  obj9.label = closure_6(quest(8728).FormLabel, obj11);
  obj9.onPress = function onPress() {
    _undefined4();
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[2] = closure_6(quest(7309).ActionSheetRow, obj9);
  const obj12 = { icon: null, label: null, onPress: null };
  const obj10 = { IconComponent: quest(15216).UndoIcon };
  obj12.icon = closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(15218).UnsendIcon });
  const obj14 = { text: null };
  const intl5 = quest(1115).intl;
  obj14.text = intl5.string(quest(1115).t.JF6W66);
  obj12.label = closure_6(quest(8728).FormLabel, obj14);
  obj12.onPress = function onPress() {
    _undefined3();
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[3] = closure_6(quest(7309).ActionSheetRow, obj12);
  const obj15 = { icon: null, label: null, onPress: null };
  const obj13 = { IconComponent: quest(15218).UnsendIcon };
  obj15.icon = closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(7078).EyeIcon });
  const obj17 = { text: null };
  const intl6 = quest(1115).intl;
  obj17.text = intl6.string(quest(1115).t["lL6/zF"]);
  obj15.label = closure_6(quest(8728).FormLabel, obj17);
  obj15.onPress = function onPress() {
    const items = [quest.id];
    QuestActionCreators.markAdContentUnseen(AdCreativeType.AdCreativeType.QUEST, items);
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[4] = closure_6(quest(7309).ActionSheetRow, obj15);
  const obj18 = { icon: null, label: null, onPress: null };
  const obj16 = { IconComponent: quest(7078).EyeIcon };
  obj18.icon = closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(7078).EyeIcon });
  const obj20 = { text: null };
  const intl7 = quest(1115).intl;
  obj20.text = intl7.string(quest(1115).t.tx5Ax5);
  obj18.label = closure_6(quest(8728).FormLabel, obj20);
  ...
  items[5] = closure_6(quest(7309).ActionSheetRow, obj18);
  const obj21 = { icon: null, label: null, onPress: null };
  const obj19 = { IconComponent: quest(7078).EyeIcon };
  obj21.icon = closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(4584).CopyIcon });
  const obj23 = { text: null };
  const intl8 = quest(1115).intl;
  obj23.text = intl8.string(quest(1115).t.oisrFi);
  obj21.label = closure_6(quest(8728).FormLabel, obj23);
  obj21.onPress = function onPress() {
    ClipboardUtils.copy(quest.id);
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[6] = closure_6(quest(7309).ActionSheetRow, obj21);
  obj2.children = items;
  return closure_7(quest(7309).ActionSheetRow.Group, obj2);
}
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = { icon: closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(4584).CopyIcon }), label: null, onPress: null };
  const obj3 = { text: null };
  const intl = quest(1115).intl;
  obj3.text = intl.string(quest(1115).t.WqhZss);
  obj.label = closure_6(quest(8728).FormLabel, obj3);
  ...
  return closure_6(quest(7309).ActionSheetRow, obj);
}
function QuestDockDisclosureRow(creative) {
  creative = creative.creative;
  let obj = { icon: closure_6(creative(7309).ActionSheetRow.Icon, { IconComponent: creative(11258).CircleQuestionIcon }), label: null, onPress: null };
  let obj3 = { text: null };
  const intl = creative(1115).intl;
  obj3.text = intl.string(creative(1115).t.GcsZKJ);
  obj.label = closure_6(creative(8728).FormLabel, obj3);
  obj.onPress = function onPress() {
  ...
  return closure_6(creative(7309).ActionSheetRow, obj);
}
...
export default function QuestDockContextMenuActionSheet(creative) {
  ...
  function trackInternalClick(CONTEXT_MENU_HIDE_CONTENT) {
    if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
      const obj2 = { type: tmp(7848).AdUserActionType.CLICK_INTERNAL };
      const merged = Object.assign(adCreativeType);
      obj2.questContentCTA = CONTEXT_MENU_HIDE_CONTENT;
      obj2.surfaceId = tmp(5533).QuestContent.QUEST_BAR_MOBILE;
      obj2.sourceQuestContent = tmp(5533).QuestContent.QUEST_BAR_MOBILE;
      tmp(7838).captureAdUserAction(obj2);
      const tmpResult = tmp(7838);
    } else if (adCreativeType.adCreativeType === tmp(5537).AdCreativeType.QUEST) {
      const obj4 = { questId: tmp3.adCreativeId, questContent: tmp(5533).QuestContent.QUEST_BAR_MOBILE, questContentCTA: CONTEXT_MENU_HIDE_CONTENT, sourceQuestContent: tmp(5533).QuestContent.QUEST_BAR_MOBILE };
      const result = tmp(7826).trackQuestContentClicked(obj4);
      const tmpResult3 = tmp(7826);
    } else {
      ...
      obj5.questContent = tmp(5533).QuestContent.QUEST_BAR_MOBILE;
      obj5.questContentCTA = CONTEXT_MENU_HIDE_CONTENT;
      obj5.sourceQuestContent = tmp(5533).QuestContent.QUEST_BAR_MOBILE;
      const result1 = tmp(7826).trackAdContentClicked(obj5);
  ...
  obj4.onPress = function onPress() {
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      tmp2(11642).openGameLinkDirectly(tmp.quest, obj3);
      const tmp2Result = tmp2(11642);
    } else if (tmp2(5537).AdCreativeType.BOUNTY === type) {
      const obj = { adContentId: tmp.bounty.id, adCreativeType: tmp2(5537).AdCreativeType.BOUNTY, cta: tmp.bounty.cta };
      const result = tmp2(11642).openAdGameLinkDirectly(obj, obj3);
      const tmp2Result2 = tmp2(11642);
    }
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  ...
  if (!tmp3) {
    ...
    obj7.onPress = function onPress() {
      ...
      const type = creative.type;
      if (AdCreativeType.AdCreativeType.QUEST === type) {
        const obj = { scrollToQuestId: creative.quest.id, fromContent: tmp(5533).QuestContent.QUEST_BAR_MOBILE };
        tmp(11909).openQuestHome(obj);
        const tmpResult = tmp(11909);
      } else if (tmp(5537).AdCreativeType.BOUNTY === type) {
        const obj2 = { fromContent: tmp(5533).QuestContent.QUEST_BAR_MOBILE };
        tmp(11909).openQuestHome(obj2);
        const tmpResult2 = tmp(11909);
      }
      ActionSheetActionCreatorsDefault.hideActionSheet();
    };
      ...
      try {
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            trackInternalClick(tmp2(7836).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT);
            const type = creative.type;
            if (tmp2(5537).AdCreativeType.QUEST === type) {
              const obj7 = tmp2(11422);
              const dismissQuestContentResult = tmp2(11422).dismissQuestContent(tmp36.quest.id, tmp2(5533).QuestContent.QUEST_BAR_MOBILE);
              v2(4605).hideActionSheet();
              v2 = 1;
              dependencyMap = 1;
              const obj9 = { value: dismissQuestContentResult, done: false };
              return obj9;
            } else if (tmp2(5537).AdCreativeType.BOUNTY === type) {
              const obj4 = tmp2(11667);
              const dismissAdContentResult = tmp2(11667).dismissAdContent(closure_1, tmp2(5533).QuestContent.QUEST_BAR_MOBILE);
              v2(4605).hideActionSheet();
              v2 = 2;
              dependencyMap = 1;
          ...
          if (arg0 === 1) {
            ...
            const result = tmp2(15213).displayQuestDismissalToast();
            const obj2 = tmp2(15213);
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
          throw value;
