...
// Dependencies: [5, 19, 1074, 21, 15181, 5501, 11367, 1114, 5497, 7779, 11264, 11265, 11269, 7769, 7251, 9147, 8663, 11568, 4572, 7249, 7773, 15183, 11838, 5730, 11348, 15185, 11596, 11555, 8787, 15186, 15188, 15190, 7020, 7434, 4552, 7241, 11177, 15192, 2]
// Exports: default
...
function QuestDockPreviewTools(quest) {
  ...
  c3 = undefined;
  c4 = undefined;
  const questPreviewActions = quest(11555).useQuestPreviewActions(quest.id);
  ...
  let obj = quest(11555);
  obj3.icon = closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(8787).TrophyIcon });
  const obj5 = { text: null };
  const intl2 = quest(1114).intl;
  obj5.text = intl2.string(quest(1114).t.jQEfRT);
  obj3.label = closure_5(quest(8663).FormLabel, obj5);
  obj3.onPress = function onPress() {
    _undefined();
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  let items = [closure_5(quest(7251).ActionSheetRow, obj3), , , , , , ];
  const obj6 = { icon: null, label: null, onPress: null };
  const obj4 = { IconComponent: quest(8787).TrophyIcon };
  obj6.icon = closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(15186).RedoIcon });
  const obj8 = { text: null };
  const intl3 = quest(1114).intl;
  obj8.text = intl3.string(quest(1114).t.cKSLr4);
  obj6.label = closure_5(quest(8663).FormLabel, obj8);
  obj6.onPress = function onPress() {
    _undefined2(0.9 * Math.random() + 0.03);
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[1] = closure_5(quest(7251).ActionSheetRow, obj6);
  const obj9 = { icon: null, label: null, onPress: null };
  const obj7 = { IconComponent: quest(15186).RedoIcon };
  obj9.icon = closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(15188).UndoIcon });
  const obj11 = { text: null };
  const intl4 = quest(1114).intl;
  obj11.text = intl4.string(quest(1114).t.taqkwK);
  obj9.label = closure_5(quest(8663).FormLabel, obj11);
  obj9.onPress = function onPress() {
    _undefined4();
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[2] = closure_5(quest(7251).ActionSheetRow, obj9);
  const obj12 = { icon: null, label: null, onPress: null };
  const obj10 = { IconComponent: quest(15188).UndoIcon };
  obj12.icon = closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(15190).UnsendIcon });
  const obj14 = { text: null };
  const intl5 = quest(1114).intl;
  obj14.text = intl5.string(quest(1114).t.JF6W66);
  obj12.label = closure_5(quest(8663).FormLabel, obj14);
  obj12.onPress = function onPress() {
    _undefined3();
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[3] = closure_5(quest(7251).ActionSheetRow, obj12);
  const obj15 = { icon: null, label: null, onPress: null };
  const obj13 = { IconComponent: quest(15190).UnsendIcon };
  obj15.icon = closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(7020).EyeIcon });
  const obj17 = { text: null };
  const intl6 = quest(1114).intl;
  obj17.text = intl6.string(quest(1114).t["lL6/zF"]);
  obj15.label = closure_5(quest(8663).FormLabel, obj17);
  obj15.onPress = function onPress() {
    const items = [quest.id];
    QuestActionCreators.markAdContentUnseen(AdCreativeType.AdCreativeType.QUEST, items);
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[4] = closure_5(quest(7251).ActionSheetRow, obj15);
  const obj18 = { icon: null, label: null, onPress: null };
  const obj16 = { IconComponent: quest(7020).EyeIcon };
  obj18.icon = closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(7020).EyeIcon });
  const obj20 = { text: null };
  const intl7 = quest(1114).intl;
  obj20.text = intl7.string(quest(1114).t.tx5Ax5);
  obj18.label = closure_5(quest(8663).FormLabel, obj20);
  ...
  items[5] = closure_5(quest(7251).ActionSheetRow, obj18);
  const obj21 = { icon: null, label: null, onPress: null };
  const obj19 = { IconComponent: quest(7020).EyeIcon };
  obj21.icon = closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(4552).CopyIcon });
  const obj23 = { text: null };
  const intl8 = quest(1114).intl;
  obj23.text = intl8.string(quest(1114).t.oisrFi);
  obj21.label = closure_5(quest(8663).FormLabel, obj23);
  obj21.onPress = function onPress() {
    ClipboardUtils.copy(quest.id);
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  items[6] = closure_5(quest(7251).ActionSheetRow, obj21);
  obj2.children = items;
  return closure_6(quest(7251).ActionSheetRow.Group, obj2);
}
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = { icon: closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(4552).CopyIcon }), label: null, onPress: null };
  const obj3 = { text: null };
  const intl = quest(1114).intl;
  obj3.text = intl.string(quest(1114).t.WqhZss);
  obj.label = closure_5(quest(8663).FormLabel, obj3);
  ...
  return closure_5(quest(7251).ActionSheetRow, obj);
}
function QuestDockDisclosureRow(creative) {
  creative = creative.creative;
  let obj = { icon: closure_5(creative(7251).ActionSheetRow.Icon, { IconComponent: creative(11177).CircleQuestionIcon }), label: null, onPress: null };
  let obj3 = { text: null };
  const intl = creative(1114).intl;
  obj3.text = intl.string(creative(1114).t.GcsZKJ);
  obj.label = closure_5(creative(8663).FormLabel, obj3);
  obj.onPress = function onPress() {
  ...
  return closure_5(creative(7251).ActionSheetRow, obj);
}
...
export default function QuestDockContextMenuActionSheet(creative) {
  ...
  function trackInternalClick(CONTEXT_MENU_HIDE_CONTENT) {
    if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
      obj2 = { type: tmp(11269).AdUserActionType.CLICK_INTERNAL };
      const merged = Object.assign(adCreativeType);
      obj2.questContentCTA = CONTEXT_MENU_HIDE_CONTENT;
      obj2.surfaceId = tmp(5497).QuestContent.QUEST_BAR_MOBILE;
      obj2.sourceQuestContent = tmp(5497).QuestContent.QUEST_BAR_MOBILE;
      tmp(11265).captureAdUserAction(obj2);
      const tmpResult = tmp(11265);
    } else if (adCreativeType.adCreativeType === tmp(5501).AdCreativeType.QUEST) {
      const obj4 = { questId: tmp3.adCreativeId, questContent: tmp(5497).QuestContent.QUEST_BAR_MOBILE, questContentCTA: CONTEXT_MENU_HIDE_CONTENT, sourceQuestContent: tmp(5497).QuestContent.QUEST_BAR_MOBILE };
      const result = tmp(7769).trackQuestContentClicked(obj4);
      const tmpResult3 = tmp(7769);
    } else {
      ...
      obj5.questContent = tmp(5497).QuestContent.QUEST_BAR_MOBILE;
      obj5.questContentCTA = CONTEXT_MENU_HIDE_CONTENT;
      obj5.sourceQuestContent = tmp(5497).QuestContent.QUEST_BAR_MOBILE;
      const result1 = tmp(7769).trackAdContentClicked(obj5);
  ...
  obj3.onPress = function onPress() {
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      tmp2(11568).openGameLinkDirectly(tmp.quest, obj2);
      const tmp2Result = tmp2(11568);
    } else if (tmp2(5501).AdCreativeType.BOUNTY === type) {
      const obj = { adContentId: tmp.bounty.id, adCreativeType: tmp2(5501).AdCreativeType.BOUNTY, cta: tmp.bounty.cta };
      const result = tmp2(11568).openAdGameLinkDirectly(obj, obj2);
      const tmp2Result2 = tmp2(11568);
    }
  ...
  obj7.onPress = function onPress() {
    ...
    const type = creative.type;
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      const obj = { scrollToQuestId: creative.quest.id, fromContent: tmp(5497).QuestContent.QUEST_BAR_MOBILE };
      tmp(11838).openQuestHome(obj);
      const tmpResult = tmp(11838);
    } else if (tmp(5501).AdCreativeType.BOUNTY === type) {
      obj2 = { fromContent: tmp(5497).QuestContent.QUEST_BAR_MOBILE };
      tmp(11838).openQuestHome(obj2);
      ...
      try {
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            trackInternalClick(tmp2(7779).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT);
            const type = creative.type;
            if (tmp2(5501).AdCreativeType.QUEST === type) {
              const obj7 = tmp2(11348);
              const dismissQuestContentResult = tmp2(11348).dismissQuestContent(tmp36.quest.id, tmp2(5497).QuestContent.QUEST_BAR_MOBILE);
              v2(4572).hideActionSheet();
              v2 = 1;
              dependencyMap = 1;
              const obj9 = { value: dismissQuestContentResult, done: false };
              return obj9;
            } else if (tmp2(5501).AdCreativeType.BOUNTY === type) {
              const obj4 = tmp2(11596);
              const dismissAdContentResult = tmp2(11596).dismissAdContent(closure_1, tmp2(5497).QuestContent.QUEST_BAR_MOBILE);
              v2(4572).hideActionSheet();
              v2 = 2;
              dependencyMap = 1;
