...
// Dependencies: [19, 17, 5495, 15153, 21, 4606, 15154, 15155, 4343, 5025, 7146, 15152, 7227, 1114, 2]

// Module 15246 (QuestDockDragHandle)
...
export default noop.memo(function QuestDockDragHandle(arg0) {
  ...
  const tmp = closure_9();
  const context = youBarHorizontalMargin.useContext(activeQuestDockMode(15154).QuestDockGestureContext);
  activeQuestDockMode = context.activeQuestDockMode;
  const windowDimensions = context.windowDimensions;
  dependencyMap = tmp5;
  youBarHorizontalMargin = activeQuestDockMode(15155).useYouBarHorizontalMargin();
  const obj = activeQuestDockMode(15155);
  ...
  const animatedStyle = activeQuestDockMode(4343).useAnimatedStyle(fn);
  ...
  const animatedStyle1 = activeQuestDockMode(4343).useAnimatedStyle(fn2);
  const obj4 = activeQuestDockMode(4343);
  ...
  const obj6 = activeQuestDockMode(4343);
  M.__closure = { withSpring: activeQuestDockMode(5025).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  M.__workletHash = 7055026667171;
  M.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(M);
  const obj7 = { withSpring: activeQuestDockMode(5025).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  class C {
    constructor() {
      tmp = closure_0(closure_2[9]);
      if (!closure_2) {
  ...
  C.__closure = { withSpring: activeQuestDockMode(5025).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  ...
  obj10.style = items;
  const obj9 = { withSpring: activeQuestDockMode(5025).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  const tmp12 = windowDimensions;
  const obj11 = { style: animatedStyle1, layout: null, children: null };
  const tmp13 = windowDimensions(7146);
  const tmp14 = closure_8;
  obj11.layout = activeQuestDockMode(15152).dimensionsLayoutTransition;
  const obj12 = { style: null, children: null };
  const items1 = [tmp.dragHandleOverlay, animatedStyle3];
  obj12.style = items1;
  const tmp15 = windowDimensions(7146);
  ...
  obj12.children = closure_7(activeQuestDockMode(7227).ActionSheetHeaderBar, { variant: "overlay", accessibilityLabel: stringResult });
  const items2 = [closure_7(windowDimensions(7146), obj12), ];
  ...
  obj13.style = items3;
  const tmp16 = windowDimensions(7146);
  obj13.children = closure_7(tmp2(7227).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = closure_7(tmp12(7146), obj13);
