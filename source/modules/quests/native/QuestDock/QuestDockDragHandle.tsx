...
export default noop.memo(function QuestDockDragHandle(arg0) {
  ...
  const animatedStyle = activeQuestDockMode(4373).useAnimatedStyle(fn);
  ...
  const animatedStyle1 = activeQuestDockMode(4373).useAnimatedStyle(fn2);
  const obj4 = activeQuestDockMode(4373);
  ...
  const obj6 = activeQuestDockMode(4373);
  M.__closure = { withSpring: activeQuestDockMode(5055).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  M.__workletHash = 7055026667171;
  M.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(M);
  const obj7 = { withSpring: activeQuestDockMode(5055).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  class C {
    constructor() {
      tmp = closure_0(closure_2[9]);
      if (!closure_2) {
  ...
  C.__closure = { withSpring: activeQuestDockMode(5055).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  ...
  obj10.style = items;
  const obj9 = { withSpring: activeQuestDockMode(5055).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  ...
  obj12.style = items1;
  const tmp15 = windowDimensions(7176);
  ...
  obj12.children = closure_7(activeQuestDockMode(7257).ActionSheetHeaderBar, { variant: "overlay", accessibilityLabel: stringResult });
  const items2 = [closure_7(windowDimensions(7176), obj12), ];
  ...
  obj13.style = items3;
  const tmp16 = windowDimensions(7176);
  obj13.children = closure_7(tmp2(7257).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = closure_7(tmp12(7176), obj13);
