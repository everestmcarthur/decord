...
// Dependencies: [19, 17, 5496, 15153, 21, 4607, 15154, 15155, 4343, 5026, 7147, 15152, 7228, 1114, 2]
...
export default noop.memo(function QuestDockDragHandle(arg0) {
  ...
  M.__closure = { withSpring: activeQuestDockMode(5026).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  M.__workletHash = 7055026667171;
  M.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(M);
  const obj7 = { withSpring: activeQuestDockMode(5026).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  class C {
    constructor() {
      tmp = closure_0(closure_2[9]);
      if (!closure_2) {
  ...
  C.__closure = { withSpring: activeQuestDockMode(5026).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  ...
  obj10.style = items;
  const obj9 = { withSpring: activeQuestDockMode(5026).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  const tmp12 = windowDimensions;
  const obj11 = { style: animatedStyle1, layout: null, children: null };
  const tmp13 = windowDimensions(7147);
  ...
  obj12.style = items1;
  const tmp15 = windowDimensions(7147);
  ...
  obj12.children = closure_7(activeQuestDockMode(7228).ActionSheetHeaderBar, { variant: "overlay", accessibilityLabel: stringResult });
  const items2 = [closure_7(windowDimensions(7147), obj12), ];
  ...
  obj13.style = items3;
  const tmp16 = windowDimensions(7147);
  obj13.children = closure_7(tmp2(7228).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = closure_7(tmp12(7147), obj13);
