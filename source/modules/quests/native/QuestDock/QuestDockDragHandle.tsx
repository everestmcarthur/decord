...
// Dependencies: [19, 17, 5532, 15207, 21, 4640, 15208, 15209, 4376, 5061, 7187, 15206, 7268, 1115, 2]

// Module 15300 (QuestDockDragHandle)
...
export default noop.memo(function QuestDockDragHandle(arg0) {
  ...
  const tmp = closure_9();
  const context = youBarHorizontalMargin.useContext(activeQuestDockMode(15208).QuestDockGestureContext);
  activeQuestDockMode = context.activeQuestDockMode;
  const windowDimensions = context.windowDimensions;
  dependencyMap = tmp5;
  youBarHorizontalMargin = activeQuestDockMode(15209).useYouBarHorizontalMargin();
  const obj = activeQuestDockMode(15209);
  ...
  M.__closure = { withSpring: activeQuestDockMode(5061).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  M.__workletHash = 7055026667171;
  M.__initData = __initData3;
  const animatedStyle2 = obj6.useAnimatedStyle(M);
  const obj7 = { withSpring: activeQuestDockMode(5061).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  class C {
    constructor() {
      tmp = closure_0(closure_2[9]);
      if (!closure_2) {
  ...
  C.__closure = { withSpring: activeQuestDockMode(5061).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  ...
  obj10.style = items;
  const obj9 = { withSpring: activeQuestDockMode(5061).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  const tmp12 = windowDimensions;
  const obj11 = { style: animatedStyle1, layout: null, children: null };
  const tmp13 = windowDimensions(7187);
  const tmp14 = closure_8;
  obj11.layout = activeQuestDockMode(15206).dimensionsLayoutTransition;
  const obj12 = { style: null, children: null };
  const items1 = [tmp.dragHandleOverlay, animatedStyle3];
  obj12.style = items1;
  const tmp15 = windowDimensions(7187);
  ...
  obj12.children = closure_7(activeQuestDockMode(7268).ActionSheetHeaderBar, { variant: "overlay", accessibilityLabel: stringResult });
  const items2 = [closure_7(windowDimensions(7187), obj12), ];
  ...
  obj13.style = items3;
  const tmp16 = windowDimensions(7187);
  obj13.children = closure_7(tmp2(7268).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = closure_7(tmp12(7187), obj13);
