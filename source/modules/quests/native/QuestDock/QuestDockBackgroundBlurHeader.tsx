...
// Dependencies: [32, 19, 17, 5458, 15125, 21, 4574, 576, 4988, 15126, 1116, 4275, 15214, 4310, 7087, 15223, 15191, 5137, 4570, 1114, 11137, 15225, 8705, 2]

// Module 15222 (QuestDockBackgroundBlurHeader)
...
questDockHeaderLayoutAnimation.__closure = { withSpring: fn(4988).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
...
let obj5 = { withSpring: fn(4988).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
let size = fn(2);
...
export default noop.memo(function QuestDockBackgroundBlurHeader(arg0) {
  ...
  const context = noop.useContext(activeQuestDockMode(15126).QuestDockGestureContext);
  ...
  token = activeQuestDockMode(4275).useToken(questDockWrapperSpecs(576).modules.mobile.QUEST_DOCK_BORDER_RADIUS);
  const tmp9 = questDockWrapperSpecs(15214)(token);
  noop = tmp9;
  let obj = activeQuestDockMode(4275);
  class G {
    constructor() {
  ...
  let obj2 = activeQuestDockMode(4310);
  G.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(4988).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  G.__workletHash = 17202411570804;
  G.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(G);
  let obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(4988).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  const fn = function b() {
    let num = 1;
  ...
  let obj4 = activeQuestDockMode(4310);
  ...
  let obj5 = { withSpring: activeQuestDockMode(4988).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  class Y {
    constructor() {
      right = 0;
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  const animatedStyle2 = activeQuestDockMode(4310).useAnimatedStyle(Y);
  let obj6 = activeQuestDockMode(4310);
  ...
  const obj8 = activeQuestDockMode(4310);
  fn2.__closure = { withSpring: activeQuestDockMode(4988).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn2.__workletHash = 6229744150165;
  fn2.__initData = __initData4;
  const animatedStyle3 = obj8.useAnimatedStyle(fn2);
  const obj9 = { withSpring: activeQuestDockMode(4988).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  const animatedStyle4 = activeQuestDockMode(4310).useAnimatedStyle(fn3);
  const obj10 = activeQuestDockMode(4310);
  class W {
    constructor() {
      pointerEvents = "none";
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  const animatedProps = activeQuestDockMode(4310).useAnimatedProps(W);
  const obj11 = activeQuestDockMode(4310);
  class V {
    constructor() {
      obj = activeQuestDockMode;
      tmp = QuestDockMode;
  ...
  const obj12 = activeQuestDockMode(4310);
  V.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(4988).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  ...
  obj14.style = items;
  const obj13 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(4988).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  const tmp19 = questDockWrapperSpecs(7087);
  if (obj15.isAndroid()) {
    if (null != blurHash) {
      const obj16 = { placeholder: blurHash, animatedStyle: animatedStyle5, animatedLayout: tmp20 };
      let tmp23 = closure_12(tmp7(15223), obj16);
    ...
    if (withPressableDisclosure) {
      ...
      obj26.children = tmp22(tmp(4570).Text, obj27);
      tmp22Result = tmp22(tmp25, obj26);
    }
    const items8 = [tmp22Result, tmp22(tmp7(15225), {}), ];
    ...
    obj28.children = tmp22(tmp(8705).MoreHorizontalIcon, obj30);
    items8[2] = tmp22(tmp(5137).PressableOpacity, obj28);
    obj21.children = items8;
    obj20.children = tmp18(tmp7(7087), obj21);
  ...
  tmp22 = closure_12;
  tmp23 = closure_12(tmp7(15191), { animatedStyle: animatedStyle5, animatedLayout: tmp20 });
});
