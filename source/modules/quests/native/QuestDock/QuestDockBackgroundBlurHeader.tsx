...
// Dependencies: [32, 19, 17, 5530, 15202, 21, 4638, 576, 5059, 15203, 1365, 4339, 15291, 4374, 7183, 15300, 15268, 5208, 4634, 1115, 11258, 15302, 8807, 2]

// Module 15299 (QuestDockBackgroundBlurHeader)
...
questDockHeaderLayoutAnimation.__closure = { withSpring: fn(5059).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
...
let obj5 = { withSpring: fn(5059).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
let size = fn(2);
...
export default noop.memo(function QuestDockBackgroundBlurHeader(arg0) {
  ...
  const context = noop.useContext(activeQuestDockMode(15203).QuestDockGestureContext);
  ...
  token = activeQuestDockMode(4339).useToken(questDockWrapperSpecs(576).modules.mobile.QUEST_DOCK_BORDER_RADIUS);
  const tmp9 = questDockWrapperSpecs(15291)(token);
  noop = tmp9;
  let obj = activeQuestDockMode(4339);
  class G {
    constructor() {
  ...
  G.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5059).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  G.__workletHash = 17202411570804;
  G.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(G);
  let obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5059).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  const fn = function b() {
    let num = 1;
  ...
  let obj4 = activeQuestDockMode(4374);
  ...
  let obj5 = { withSpring: activeQuestDockMode(5059).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  class Y {
    constructor() {
      right = 0;
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  const animatedStyle2 = activeQuestDockMode(4374).useAnimatedStyle(Y);
  let obj6 = activeQuestDockMode(4374);
  ...
  fn2.__closure = { withSpring: activeQuestDockMode(5059).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn2.__workletHash = 6229744150165;
  fn2.__initData = __initData4;
  const animatedStyle3 = obj8.useAnimatedStyle(fn2);
  const obj9 = { withSpring: activeQuestDockMode(5059).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  const animatedStyle4 = activeQuestDockMode(4374).useAnimatedStyle(fn3);
  const obj10 = activeQuestDockMode(4374);
  class W {
    constructor() {
      pointerEvents = "none";
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  const animatedProps = activeQuestDockMode(4374).useAnimatedProps(W);
  const obj11 = activeQuestDockMode(4374);
  class V {
    constructor() {
      obj = activeQuestDockMode;
      tmp = QuestDockMode;
  ...
  const obj12 = activeQuestDockMode(4374);
  V.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5059).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  ...
  obj14.style = items;
  const obj13 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5059).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  const tmp19 = questDockWrapperSpecs(7183);
  if (obj15.isAndroid()) {
    if (null != blurHash) {
      const obj16 = { placeholder: blurHash, animatedStyle: animatedStyle5, animatedLayout: tmp20 };
      let tmp23 = closure_12(tmp7(15300), obj16);
    ...
    obj18.children = tmp22(tmp7(7183), obj19);
    const items3 = [tmp22(tmp7(7183), obj18), ];
    ...
    if (withPressableDisclosure) {
      ...
      obj26.children = tmp22(tmp(4634).Text, obj27);
      tmp22Result = tmp22(tmp25, obj26);
    }
    const items8 = [tmp22Result, tmp22(tmp7(15302), {}), ];
    ...
    obj28.children = tmp22(tmp(8807).MoreHorizontalIcon, obj30);
    items8[2] = tmp22(tmp(5208).PressableOpacity, obj28);
    obj21.children = items8;
    obj20.children = tmp18(tmp7(7183), obj21);
  ...
  tmp22 = closure_12;
  tmp23 = closure_12(tmp7(15268), { animatedStyle: animatedStyle5, animatedLayout: tmp20 });
});
