...
// Dependencies: [32, 19, 17, 5529, 15186, 21, 4639, 576, 5058, 15187, 1365, 4341, 15275, 4376, 7180, 15284, 15252, 5207, 4635, 1115, 11244, 15286, 8798, 2]

// Module 15283 (QuestDockBackgroundBlurHeader)
...
questDockHeaderLayoutAnimation.__closure = { withSpring: fn(5058).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
...
let obj5 = { withSpring: fn(5058).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
let size = fn(2);
...
export default noop.memo(function QuestDockBackgroundBlurHeader(arg0) {
  ...
  const context = noop.useContext(activeQuestDockMode(15187).QuestDockGestureContext);
  ...
  token = activeQuestDockMode(4341).useToken(questDockWrapperSpecs(576).modules.mobile.QUEST_DOCK_BORDER_RADIUS);
  const tmp9 = questDockWrapperSpecs(15275)(token);
  noop = tmp9;
  let obj = activeQuestDockMode(4341);
  class G {
    constructor() {
  ...
  G.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5058).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  G.__workletHash = 17202411570804;
  G.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(G);
  let obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5058).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  const fn = function b() {
    let num = 1;
  ...
  let obj4 = activeQuestDockMode(4376);
  fn.__closure = { withSpring: activeQuestDockMode(5058).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn.__workletHash = 5804990093011;
  fn.__initData = __initData2;
  const animatedStyle1 = obj4.useAnimatedStyle(fn);
  let obj5 = { withSpring: activeQuestDockMode(5058).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  class Y {
    constructor() {
      right = 0;
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  const animatedStyle2 = activeQuestDockMode(4376).useAnimatedStyle(Y);
  let obj6 = activeQuestDockMode(4376);
  ...
  fn2.__closure = { withSpring: activeQuestDockMode(5058).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn2.__workletHash = 6229744150165;
  fn2.__initData = __initData4;
  const animatedStyle3 = obj8.useAnimatedStyle(fn2);
  const obj9 = { withSpring: activeQuestDockMode(5058).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  const animatedStyle4 = activeQuestDockMode(4376).useAnimatedStyle(fn3);
  const obj10 = activeQuestDockMode(4376);
  class W {
    constructor() {
      pointerEvents = "none";
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  const animatedProps = activeQuestDockMode(4376).useAnimatedProps(W);
  const obj11 = activeQuestDockMode(4376);
  class V {
    constructor() {
      obj = activeQuestDockMode;
      tmp = QuestDockMode;
  ...
  const obj12 = activeQuestDockMode(4376);
  V.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5058).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  ...
  obj14.style = items;
  const obj13 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5058).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  const tmp19 = questDockWrapperSpecs(7180);
  if (obj15.isAndroid()) {
    if (null != blurHash) {
      const obj16 = { placeholder: blurHash, animatedStyle: animatedStyle5, animatedLayout: tmp20 };
      let tmp23 = closure_12(tmp7(15284), obj16);
    ...
    if (withPressableDisclosure) {
      ...
      obj24.children = intl2.string(tmp(1115).t.o6FLcF);
      const items6 = [tmp22(tmp(4635).Text, obj24), ];
      const obj25 = { color: tmp7(576).colors.INTERACTIVE_TEXT_ACTIVE, style: tmp17.actionDisclosuresIcon };
      items6[1] = tmp22(tmp(11244).CircleQuestionIcon, obj25);
      obj23.children = items6;
      obj22.children = tmp18(closure_13, obj23);
      let tmp22Result = tmp22(tmp(5207).PressableOpacity, obj22);
    } else {
      ...
      obj27.children = intl.string(tmp(1115).t.o6FLcF);
      obj26.children = tmp22(tmp(4635).Text, obj27);
      tmp22Result = tmp22(tmp25, obj26);
    }
    const items8 = [tmp22Result, tmp22(tmp7(15286), {}), ];
    ...
    obj28.accessibilityLabel = obj29.string(tmp(1115).t.PdRCRg);
    obj28.onPress = onSubmenuPress;
    obj28.style = tmp17.tertiaryContent;
    const obj30 = { color: tmp7(576).colors.INTERACTIVE_TEXT_ACTIVE };
    obj28.children = tmp22(tmp(8798).MoreHorizontalIcon, obj30);
    items8[2] = tmp22(tmp(5207).PressableOpacity, obj28);
    obj21.children = items8;
    obj20.children = tmp18(tmp7(7180), obj21);
  ...
  tmp22 = closure_12;
  tmp23 = closure_12(tmp7(15252), { animatedStyle: animatedStyle5, animatedLayout: tmp20 });
});
