...
// Dependencies: [19, 17, 5525, 15175, 21, 576, 4636, 15182, 15176, 4373, 5055, 15172, 15272, 5668, 7176, 4632, 2]
...
export default noop.memo(function QuestDockBountyHeader() {
  const questDockBounty = activeQuestDockMode(15182).useQuestDockBounty();
  ...
  const obj2 = { withSpring: activeQuestDockMode(5055).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  const bountyCreative = activeQuestDockMode(15182).useBountyCreative(questDockBounty);
  const tmpResult3 = activeQuestDockMode(15182);
  const tmpResult4 = activeQuestDockMode(15172);
  const obj3 = { onSubmenuPress: activeQuestDockMode(15172).useActionSheetPressHandler(bountyCreative), children: null };
  ...
  if (tmp8Result) {
    ...
    obj5.source = obj6;
    tmp8Result = tmp8(tmp9(5668), obj5);
  }
  ...
  obj8.children = closure_7(activeQuestDockMode(4632).Text, { variant: "text-md/medium", color: "text-strong", lineClamp: 1, accessible: false, children: str });
