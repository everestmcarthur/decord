...
// Dependencies: [19, 17, 5532, 15207, 21, 4640, 15208, 11507, 4376, 15206, 5061, 7187, 2]

// Module 15299 (QuestDockContentExpanded)
...
let QUEST_DOCK_MODE_CHANGE_PHYSICS = fn(15207).QUEST_DOCK_MODE_CHANGE_PHYSICS;
const jsx = fn(21).jsx;
