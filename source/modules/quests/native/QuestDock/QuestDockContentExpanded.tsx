...
// Dependencies: [19, 17, 5530, 15202, 21, 4638, 15203, 11499, 4374, 15201, 5059, 7183, 2]

// Module 15294 (QuestDockContentExpanded)
...
let QUEST_DOCK_MODE_CHANGE_PHYSICS = fn(15202).QUEST_DOCK_MODE_CHANGE_PHYSICS;
const jsx = fn(21).jsx;
