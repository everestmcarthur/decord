...
// Dependencies: [19, 17, 5529, 15186, 21, 4639, 15187, 11491, 4376, 15185, 5058, 7180, 2]

// Module 15278 (QuestDockContentExpanded)
...
let QUEST_DOCK_MODE_CHANGE_PHYSICS = fn(15186).QUEST_DOCK_MODE_CHANGE_PHYSICS;
const jsx = fn(21).jsx;
