...
// Dependencies: [32, 19, 17, 4599, 5496, 15153, 1074, 21, 4607, 15154, 4343, 5026, 7147, 15157, 15240, 8355, 1477, 1611, 504, 15152, 672, 1115, 11862, 8395, 5639, 5039, 2]

// Module 15260 (QuestDockVideoBackground)
...
function QuestDockBackgroundMediaFade(arg0) {
  ...
  let obj = activeQuestDockMode(4343);
...
export default noop.memo(function QuestDockVideoBackground(gradientBaseColor) {
  ...
  const setRestingQuestDockMode = windowDimensions.useContext(gradientBaseColor(15157).QuestDockExternalCoordinationContext).setRestingQuestDockMode;
  const tmp8 = expandedHeight(8355)(activeQuestDockMode);
  ...
  let obj3 = gradientBaseColor(4343);
  fn.__closure = { withSpring: gradientBaseColor(5026).withSpring, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: isRendered, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, windowDimensions };
  ...
  let obj4 = { withSpring: gradientBaseColor(5026).withSpring, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: isRendered, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, windowDimensions };
  ...
  if (isRendered) {
    isRendered = !tmp4(1115).isAndroid();
    const tmp4Result = tmp4(1115);
  }
  if (isRendered) {
    isRendered = tmp4(11862).isHeroVideoSupported(gradientBaseColor.videoMimetype);
    const tmp4Result3 = tmp4(11862);
  }
  if (isRendered) {
    let tmp25 = !tmp2;
    if (tmp2) {
  ...
  const tmp4Result4 = gradientBaseColor(4343);
  fn2.__closure = { withSpring: gradientBaseColor(5026).withSpring, shouldShowVideo: isRendered, videoLoaded: first1, isMediaHiddenWhenCollapsed: collapsedMediaMode === windowDimensions.HIDDEN, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED: tmp13 };
  ...
  if (isRendered) {
    ...
    tmp31 = closure_11(tmp4(8395).VideoComponent, obj6);
  }
  const items4 = [tmp31, ];
  let tmp33 = null;
  if (null != imageUrl) {
    ...
    obj9.source = obj10;
    obj8.children = closure_11(tmp7(5639), obj9);
    tmp33 = closure_11(tmp7(7147), obj8);
  ...
  const obj5 = { withSpring: gradientBaseColor(5026).withSpring, shouldShowVideo: isRendered, videoLoaded: first1, isMediaHiddenWhenCollapsed: collapsedMediaMode === obj.HIDDEN, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED: tmp13 };
  ...
  obj13.style = items9;
  items8[1] = closure_11(expandedHeight(5039), obj13);
  obj11.children = items8;
  return closure_12(expandedHeight(7147), obj11);
});
