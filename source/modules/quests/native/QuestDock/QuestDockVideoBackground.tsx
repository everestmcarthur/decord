...
// Dependencies: [32, 19, 17, 4597, 5494, 15174, 1074, 21, 4605, 15175, 4341, 5024, 7125, 15178, 15261, 8332, 1477, 1611, 504, 15173, 672, 1115, 11838, 8372, 5637, 5037, 2]
...
export default noop.memo(function QuestDockVideoBackground(gradientBaseColor) {
  ...
  let obj3 = gradientBaseColor(4341);
  fn.__closure = { withSpring: gradientBaseColor(5024).withSpring, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: isRendered, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, windowDimensions };
  ...
  let obj4 = { withSpring: gradientBaseColor(5024).withSpring, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: isRendered, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, windowDimensions };
  ...
  if (isRendered) {
    isRendered = tmp4(11838).isHeroVideoSupported(gradientBaseColor.videoMimetype);
    const tmp4Result3 = tmp4(11838);
  }
  if (isRendered) {
    let tmp25 = !tmp2;
    if (tmp2) {
  ...
  const tmp4Result4 = gradientBaseColor(4341);
  fn2.__closure = { withSpring: gradientBaseColor(5024).withSpring, shouldShowVideo: isRendered, videoLoaded: first1, isMediaHiddenWhenCollapsed: collapsedMediaMode === windowDimensions.HIDDEN, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED: tmp13 };
  ...
  if (isRendered) {
    ...
    tmp31 = closure_11(tmp4(8372).VideoComponent, obj6);
  }
  const items4 = [tmp31, ];
  let tmp33 = null;
  if (null != imageUrl) {
    ...
    obj9.source = obj10;
    obj8.children = closure_11(tmp7(5637), obj9);
    tmp33 = closure_11(tmp7(7125), obj8);
  ...
  const obj5 = { withSpring: gradientBaseColor(5024).withSpring, shouldShowVideo: isRendered, videoLoaded: first1, isMediaHiddenWhenCollapsed: collapsedMediaMode === obj.HIDDEN, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED: tmp13 };
  ...
  obj13.style = items9;
  items8[1] = closure_11(expandedHeight(5037), obj13);
  obj11.children = items8;
  return closure_12(expandedHeight(7125), obj11);
});
