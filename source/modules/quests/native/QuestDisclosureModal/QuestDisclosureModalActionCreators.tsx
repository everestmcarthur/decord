...
// Dependencies: [5539, 7838, 15214, 7843, 7844, 7854, 7832, 4843, 15226, 1897, 2]

// Module 15225 (QuestDisclosureModalActionCreators)
...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      const result = tmp(7832).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(7832).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5539).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(7838).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(7838);
    } else if (tmp(5539).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5539).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
    const merged1 = Object.assign(tmp11);
    obj12.isTargetedDisclosure = isTargetedDisclosure.isTargetedDisclosure;
    obj9.pushLazy(asyncRequireImpl(15226, tmp2.paths), obj12, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
