...
// Dependencies: [5501, 7775, 15181, 11264, 11265, 11269, 7769, 4808, 15193, 1896, 2]
...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      const result = tmp(7769).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(7769).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5501).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(7775).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(7775);
    } else if (tmp(5501).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5501).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
    const merged1 = Object.assign(tmp11);
    obj12.isTargetedDisclosure = isTargetedDisclosure.isTargetedDisclosure;
    obj9.pushLazy(asyncRequireImpl(15193, tmp2.paths), obj12, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
