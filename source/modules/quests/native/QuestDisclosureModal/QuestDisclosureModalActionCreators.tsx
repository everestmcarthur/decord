...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      const result = tmp(7820).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(7820).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5532).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(7826).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(7826);
    } else if (tmp(5532).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5532).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
