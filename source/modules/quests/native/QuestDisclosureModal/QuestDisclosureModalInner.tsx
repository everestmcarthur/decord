...
// Dependencies: [17, 1074, 21, 4606, 576, 1935, 9376, 1114, 8976, 11919, 9313, 5743, 4602, 11389, 5658, 2024, 5026, 2]
// Exports: default
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  if (setting) {
    obj.icon = tmp5(tmp2(9376).ServerIcon, { size: "xs" });
    ...
    obj.icon = tmp5(tmp2(8976).GlobeEarthIcon, { size: "xs" });
    const intl = tmp2(1114).intl;
    obj.text = intl.string(tmp2(1114).t.xQSdPv);
    items1 = [obj, , ];
    const obj2 = { icon: tmp5(tmp2(11919).UserIcon, { size: "xs" }), text: null };
    const intl2 = tmp2(1114).intl;
    obj2.text = intl2.string(tmp2(1114).t.mYt7hQ);
    items1[1] = obj2;
    const obj3 = { icon: tmp5(tmp2(9313).GameControllerIcon, { size: "xs" }), text: null };
  ...
  if (isTargetedDisclosure) {
    ...
    isTargetedDisclosure = tmp6(tmp2(5658).Card, obj7);
  }
