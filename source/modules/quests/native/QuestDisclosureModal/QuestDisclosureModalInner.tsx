...
// Dependencies: [17, 1074, 21, 4639, 576, 1936, 9418, 1115, 9018, 11960, 9355, 5777, 4635, 11433, 5692, 2025, 5059, 2]
// Exports: default

// Module 15206 (QuestDisclosureModalInner)
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  if (setting) {
    obj.icon = tmp5(tmp2(9418).ServerIcon, { size: "xs" });
    ...
    obj.icon = tmp5(tmp2(9018).GlobeEarthIcon, { size: "xs" });
    const intl = tmp2(1115).intl;
    obj.text = intl.string(tmp2(1115).t.xQSdPv);
    items1 = [obj, , ];
    const obj2 = { icon: tmp5(tmp2(11960).UserIcon, { size: "xs" }), text: null };
    const intl2 = tmp2(1115).intl;
    obj2.text = intl2.string(tmp2(1115).t.mYt7hQ);
    items1[1] = obj2;
    const obj3 = { icon: tmp5(tmp2(9355).GameControllerIcon, { size: "xs" }), text: null };
  ...
  if (isTargetedDisclosure) {
    ...
    isTargetedDisclosure = tmp6(tmp2(5692).Card, obj7);
  }
  ...
  obj9.privacySettingsUrl = items1(2025).getArticleURL(HelpdeskArticles.QUESTS_PRIVACY_CONTROLS);
