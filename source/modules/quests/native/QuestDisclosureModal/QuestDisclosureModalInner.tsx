...
// Dependencies: [17, 1074, 21, 4640, 576, 1936, 9440, 1115, 9044, 11977, 9377, 5780, 4636, 11449, 5695, 2025, 5062, 2]
// Exports: default

// Module 15227 (QuestDisclosureModalInner)
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  if (setting) {
    obj.icon = tmp5(tmp2(9440).ServerIcon, { size: "xs" });
    ...
    obj.icon = tmp5(tmp2(9044).GlobeEarthIcon, { size: "xs" });
    const intl = tmp2(1115).intl;
    obj.text = intl.string(tmp2(1115).t.xQSdPv);
    items1 = [obj, , ];
    const obj2 = { icon: tmp5(tmp2(11977).UserIcon, { size: "xs" }), text: null };
    const intl2 = tmp2(1115).intl;
    obj2.text = intl2.string(tmp2(1115).t.mYt7hQ);
    items1[1] = obj2;
    const obj3 = { icon: tmp5(tmp2(9377).GameControllerIcon, { size: "xs" }), text: null };
  ...
  if (isTargetedDisclosure) {
    ...
    isTargetedDisclosure = tmp6(tmp2(5695).Card, obj7);
  }
