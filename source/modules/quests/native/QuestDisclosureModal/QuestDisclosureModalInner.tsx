...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  const items2 = [tmp6(closure_4, { style: tmp.illustration, children: tmp6(_require(5692).WumpusCouchSpotIllustration, {}) }), , , , ];
  const obj3 = { variant: "text-md/normal", color: "mobile-text-heading-primary", children: null };
  const obj2 = { style: tmp.illustration, children: tmp6(_require(5692).WumpusCouchSpotIllustration, {}) };
  ...
  obj8[3] = intl6.string(_require(1114).t.cpT0Cq);
  obj8[4] = onClose;
  obj7[1] = tmp6(_require(4975).Button, obj8);
