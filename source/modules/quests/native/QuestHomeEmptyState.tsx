...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 1115, 4341, 4500, 7237, 1364, 4636, 15180, 5074, 2]
// Exports: default
...
export default function QuestHomeEmptyState(subtitle) {
  ...
  if (!useChatLayoutDefault().isChatLockedOpen) {
    ...
    const obj11 = { style: tmp5.emptyImage, source: tmp7(15180), resizeMode: "cover" };
