...
// Dependencies: [19, 17, 1074, 21, 4574, 576, 1114, 4275, 4434, 7137, 1115, 4570, 15094, 5001, 2]
// Exports: default

// Module 15093 (QuestHomeEmptyState)
...
export default function QuestHomeEmptyState(subtitle) {
  ...
  if (!useChatLayoutDefault().isChatLockedOpen) {
    ...
    const obj11 = { style: tmp5.emptyImage, source: tmp7(15094), resizeMode: "cover" };
