...
// Dependencies: [19, 17, 1074, 21, 4605, 576, 1114, 4306, 4465, 7175, 1115, 4601, 15143, 5037, 2]
// Exports: default

// Module 15142 (QuestHomeEmptyState)
...
export default function QuestHomeEmptyState(subtitle) {
  ...
  if (!useChatLayoutDefault().isChatLockedOpen) {
    ...
    const obj11 = { style: tmp5.emptyImage, source: tmp7(15143), resizeMode: "cover" };
