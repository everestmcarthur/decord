...
// Dependencies: [32, 19, 17, 7810, 1955, 21, 576, 4638, 1944, 7498, 15174, 573, 15176, 11629, 504, 15186, 15192, 2]

// Module 15173 (QuestHomeBounties)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import dismissible_content from "dismissible_content" /* 1944 */;
import openBountiesNuxPromoSheetDefault from "openBountiesNuxPromoSheet" /* 15174 */;
import BountiesCtaHeaderDefault from "BountiesCtaHeader" /* 15186 */;
import QuestHomeOrbShopCarouselDefault from "QuestHomeOrbShopCarousel" /* 15192 */;
...
export default noop.memo(function QuestHomeBounties(shopCarouselConfig) {
  ...
  if (0 !== questHomeBounties.length) {
    if (!stateFromStores) {
      ...
      if (tmp11) {
        tmp11 = orbShopProducts.length >= tmp(15176).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
        const tmp12 = orbShopProducts.length >= tmp(15176).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
      }
      if (!tmp11) {
