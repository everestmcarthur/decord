...
// Function ID: 13323
// Name: QuestEmbed
// Dependencies: [17, 1183, 7776, 5496, 1074, 7809, 1115, 1114, 7797, 11870, 5499, 4458, 11381, 1608, 13323, 7772, 7791, 7795, 8020, 2]
// Exports: createQuestsEmbed

// Module 13322 (QuestEmbed)
import _mod17 from "module_17" /* 17 */;
import Constants from "Constants" /* 1074 */;
import Constants2 from "Constants" /* 7809 */;
...
export const createQuestsEmbed = function createQuestsEmbed(questId) {
  ...
  if (obj.isMetaQuest()) {
    ...
    obj2.thumbnailUrl = Image.resolveAssetSource(tmp(13323)).uri;
    ...
    const result = tmp2(7772).findQuestOrReplacement(questId, QuestStore.quests, QuestStore.excludedQuests);
    ...
    if (null == result) {
      if (null == value) {
        const result1 = tmp2(7791).trackQuestEmbedFallbackViewed(questId, constants2.UNKNOWN_QUEST);
        const intl12 = tmp2(1114).intl;
        const tmp2Result18 = tmp2(7791);
        ...
        obj8.thumbnailUrl = Image.resolveAssetSource(tmp(13323)).uri;
      ...
      const result2 = tmp2(7791).trackQuestEmbedFallbackViewed(questId, constants2.EXCLUDED_QUEST);
      const intl7 = tmp2(1114).intl;
      const tmp2Result20 = tmp2(7791);
      ...
      obj10.thumbnailUrl = Image.resolveAssetSource(tmp(13323)).uri;
      ...
      if (tmp2Result22.isShareableQuest(result.config)) {
        ...
        if (result.config.expiresAt < date1.toISOString()) {
          ...
          const questTaskDetails = tmp2(7797).getQuestTaskDetails(result);
          const tmp2Result24 = tmp2(7797);
          const thirdPartyTaskDetails = tmp2(7797).getThirdPartyTaskDetails(result);
          const tmp2Result25 = tmp2(7797);
          const obj15 = { quest: result, taskDetails: questTaskDetails, location: constants.EMBED_MOBILE, sourceQuestContent: tmp2(5499).QuestContent.QUEST_EMBED_MOBILE, thirdPartyTaskDetails, withoutMarkdown: true, currentUser };
          formatToPlainStringResult1 = tmp2(11870).getQuestsInstructionsToWinReward(obj15);
          const tmp2Result26 = tmp2(11870);
        }
        ...
        obj16.thumbnailUrl = tmp2(11381).getQuestAsset(result, tmp2(11381).QuestAssetType.GAME_TILE, tmp29).url;
        obj16.embedCanBeTapped = true;
        obj16.canBeAccepted = true;
        obj16.type = InviteTypes.GUILD;
        const tmp2Result27 = tmp2(11381);
        const obj17 = {};
        ...
        const result3 = tmp2(7791).trackQuestEmbedFallbackViewed(questId, constants2.NOT_SHAREABLE_QUEST);
        const intl = tmp2(1114).intl;
        const tmp2Result29 = tmp2(7791);
        ...
        obj20.thumbnailUrl = Image.resolveAssetSource(tmp(13323)).uri;
      ...
      tmp2Result22 = tmp2(7795);
    }
    const tmp2Result16 = tmp2(7772);
  }
};
