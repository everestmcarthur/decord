...
// Function ID: 13360
// Name: QuestEmbed
// Dependencies: [17, 1182, 7808, 5529, 1074, 7841, 1364, 1115, 7829, 11909, 5532, 4491, 11423, 1609, 13360, 7804, 7823, 7827, 8052, 2]
// Exports: createQuestsEmbed

// Module 13359 (QuestEmbed)
import _mod17 from "module_17" /* 17 */;
import Constants from "Constants" /* 1074 */;
import Constants2 from "Constants" /* 7841 */;
...
export const createQuestsEmbed = function createQuestsEmbed(questId) {
  ...
  if (obj.isMetaQuest()) {
    ...
    obj2.thumbnailUrl = Image.resolveAssetSource(tmp(13360)).uri;
    ...
    const result = tmp2(7804).findQuestOrReplacement(questId, QuestStore.quests, QuestStore.excludedQuests);
    ...
    if (null == result) {
      if (null == value) {
        const result1 = tmp2(7823).trackQuestEmbedFallbackViewed(questId, constants2.UNKNOWN_QUEST);
        const intl12 = tmp2(1115).intl;
        const tmp2Result18 = tmp2(7823);
        ...
        obj8.thumbnailUrl = Image.resolveAssetSource(tmp(13360)).uri;
      ...
      const result2 = tmp2(7823).trackQuestEmbedFallbackViewed(questId, constants2.EXCLUDED_QUEST);
      const intl7 = tmp2(1115).intl;
      const tmp2Result20 = tmp2(7823);
      ...
      obj10.thumbnailUrl = Image.resolveAssetSource(tmp(13360)).uri;
      ...
      if (tmp2Result22.isShareableQuest(result.config)) {
        ...
        if (result.config.expiresAt < date1.toISOString()) {
          ...
          const questTaskDetails = tmp2(7829).getQuestTaskDetails(result);
          const tmp2Result24 = tmp2(7829);
          const thirdPartyTaskDetails = tmp2(7829).getThirdPartyTaskDetails(result);
          const tmp2Result25 = tmp2(7829);
          const obj15 = { quest: result, taskDetails: questTaskDetails, location: constants.EMBED_MOBILE, sourceQuestContent: tmp2(5532).QuestContent.QUEST_EMBED_MOBILE, thirdPartyTaskDetails, withoutMarkdown: true, currentUser };
          formatToPlainStringResult1 = tmp2(11909).getQuestsInstructionsToWinReward(obj15);
          const tmp2Result26 = tmp2(11909);
        }
        ...
        obj16.thumbnailUrl = tmp2(11423).getQuestAsset(result, tmp2(11423).QuestAssetType.GAME_TILE, tmp29).url;
        obj16.embedCanBeTapped = true;
        obj16.canBeAccepted = true;
        obj16.type = InviteTypes.GUILD;
        const tmp2Result27 = tmp2(11423);
        const obj17 = {};
        ...
        const result3 = tmp2(7823).trackQuestEmbedFallbackViewed(questId, constants2.NOT_SHAREABLE_QUEST);
        const intl = tmp2(1115).intl;
        const tmp2Result29 = tmp2(7823);
        ...
        obj20.thumbnailUrl = Image.resolveAssetSource(tmp(13360)).uri;
      ...
      tmp2Result22 = tmp2(7827);
    }
    const tmp2Result16 = tmp2(7804);
  }
};
