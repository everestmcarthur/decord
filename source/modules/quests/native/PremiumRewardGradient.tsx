...
// Dependencies: [19, 17, 21, 4574, 4423, 576, 4275, 4509, 4426, 5001, 5678, 2]
// Exports: default

// Module 15194 (PremiumRewardGradient)
...
function PremiumRewardGlowGradient(arg0) {
  ...
  items2[1] = glowLight;
  const items3 = [timestampProducer(_modDef5678, obj5), children];
  obj4.children = items3;
