...
// Dependencies: [19, 17, 21, 4639, 4489, 576, 4341, 4574, 4492, 5071, 5749, 2]
// Exports: default

// Module 15255 (PremiumRewardGradient)
...
function PremiumRewardGlowGradient(arg0) {
  ...
  items2[1] = glowLight;
  const items3 = [timestampProducer(_modDef5749, obj5), children];
  obj4.children = items3;
