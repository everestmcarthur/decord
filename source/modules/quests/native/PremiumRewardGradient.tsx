...
// Dependencies: [19, 17, 21, 4640, 4489, 576, 4341, 4574, 4492, 5074, 5752, 2]
// Exports: default

// Module 15276 (PremiumRewardGradient)
...
function PremiumRewardGlowGradient(arg0) {
  ...
  items2[1] = glowLight;
  const items3 = [timestampProducer(_modDef5752, obj5), children];
  obj4.children = items3;
