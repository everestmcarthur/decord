...
// Dependencies: [19, 17, 21, 4606, 4456, 576, 4308, 4541, 4459, 5038, 5715, 2]
// Exports: default

// Module 15222 (PremiumRewardGradient)
...
function PremiumRewardGlowGradient(arg0) {
  ...
  items2[1] = glowLight;
  const items3 = [timestampProducer(_modDef5715, obj5), children];
  obj4.children = items3;
