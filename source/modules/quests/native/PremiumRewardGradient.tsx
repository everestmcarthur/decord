...
// Dependencies: [19, 17, 21, 4638, 4487, 576, 4339, 4572, 4490, 5072, 5750, 2]
// Exports: default

// Module 15271 (PremiumRewardGradient)
...
function PremiumRewardGlowGradient(arg0) {
  ...
  items2[1] = glowLight;
  const items3 = [timestampProducer(_modDef5750, obj5), children];
  obj4.children = items3;
