...
// Dependencies: [19, 17, 1371, 21, 4607, 576, 11862, 4574, 11579, 11386, 7781, 1114, 504, 7224, 5025, 11865, 4603, 2]
// Exports: default

// Module 11864 (QuestRewardDetailsBottomSheet)
...
function QuestRewardDetailsBottomSheet(quest) {
  ...
  let obj = quest(504);
  const tmp4 = quest;
  const defaultRewardName = quest(11386).getDefaultRewardName(quest.config, stateFromStores);
  ...
  const items3 = [closure_6(memo(11865), { quest, height: 56, width: 56, withAnimation: true }), ];
  ...
  const items4 = [closure_6(quest(4603).Text, obj6), closure_6(quest(4603).Text, { variant: "heading-lg/semibold", color: "text-strong", children: defaultRewardName })];
  obj5.children = items4;
  items3[1] = closure_7(quest(5025).Stack, obj5);
  obj4.children = items3;
  const items5 = [closure_7(quest(5025).Stack, obj4), ];
  ...
  if (tmp9Result) {
    ...
    items6[1] = tmp8(tmp4(4603).Text, obj9);
    obj7.children = items6;
    tmp9Result = tmp9(closure_8, obj7);
  }
  const obj2 = quest(11386);
  items5[1] = tmp9Result;
  obj3.children = items5;
  return closure_6(quest(7224).BottomSheet, { startExpanded: true, children: closure_7(quest(5025).Stack, obj3) });
}
