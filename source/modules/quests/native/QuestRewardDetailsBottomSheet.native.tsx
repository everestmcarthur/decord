...
// Dependencies: [19, 17, 1371, 21, 4605, 576, 11838, 4572, 11555, 11362, 7759, 1114, 504, 7202, 5023, 11841, 4601, 2]
// Exports: default

// Module 11840 (QuestRewardDetailsBottomSheet)
...
function QuestRewardDetailsBottomSheet(quest) {
  ...
  let obj = quest(504);
  const tmp4 = quest;
  const defaultRewardName = quest(11362).getDefaultRewardName(quest.config, stateFromStores);
  ...
  const items3 = [closure_6(memo(11841), { quest, height: 56, width: 56, withAnimation: true }), ];
  ...
  const items4 = [closure_6(quest(4601).Text, obj6), closure_6(quest(4601).Text, { variant: "heading-lg/semibold", color: "text-strong", children: defaultRewardName })];
  obj5.children = items4;
  items3[1] = closure_7(quest(5023).Stack, obj5);
  obj4.children = items3;
  const items5 = [closure_7(quest(5023).Stack, obj4), ];
  ...
  if (tmp9Result) {
    ...
    items6[1] = tmp8(tmp4(4601).Text, obj9);
    obj7.children = items6;
    tmp9Result = tmp9(closure_8, obj7);
  }
  const obj2 = quest(11362);
  items5[1] = tmp9Result;
  obj3.children = items5;
  return closure_6(quest(7202).BottomSheet, { startExpanded: true, children: closure_7(quest(5023).Stack, obj3) });
}
