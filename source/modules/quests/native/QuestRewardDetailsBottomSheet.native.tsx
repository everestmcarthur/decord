...
// Dependencies: [19, 17, 1372, 21, 4638, 576, 11909, 4605, 11629, 11436, 7816, 1115, 504, 7260, 5058, 11912, 4634, 2]
// Exports: default

// Module 11911 (QuestRewardDetailsBottomSheet)
...
function QuestRewardDetailsBottomSheet(quest) {
  ...
  const items4 = [closure_6(quest(4634).Text, obj6), closure_6(quest(4634).Text, { variant: "heading-lg/semibold", color: "text-strong", children: defaultRewardName })];
  ...
  if (tmp9Result) {
    ...
    items6[1] = tmp8(tmp4(4634).Text, obj9);
