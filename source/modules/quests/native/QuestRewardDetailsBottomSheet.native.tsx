...
// Dependencies: [19, 17, 1372, 21, 4639, 576, 11901, 4606, 11621, 11428, 7813, 1115, 504, 7257, 5057, 11904, 4635, 2]
// Exports: default

// Module 11903 (QuestRewardDetailsBottomSheet)
...
function QuestRewardDetailsBottomSheet(quest) {
  ...
  let obj = quest(504);
  const tmp4 = quest;
  const defaultRewardName = quest(11428).getDefaultRewardName(quest.config, stateFromStores);
  ...
  const items3 = [closure_6(memo(11904), { quest, height: 56, width: 56, withAnimation: true }), ];
  ...
  const items4 = [closure_6(quest(4635).Text, obj6), closure_6(quest(4635).Text, { variant: "heading-lg/semibold", color: "text-strong", children: defaultRewardName })];
  obj5.children = items4;
  items3[1] = closure_7(quest(5057).Stack, obj5);
  obj4.children = items3;
  const items5 = [closure_7(quest(5057).Stack, obj4), ];
  ...
  if (tmp9Result) {
    ...
    items6[1] = tmp8(tmp4(4635).Text, obj9);
    obj7.children = items6;
    tmp9Result = tmp9(closure_8, obj7);
  }
  const obj2 = quest(11428);
  items5[1] = tmp9Result;
  obj3.children = items5;
  return closure_6(quest(7257).BottomSheet, { startExpanded: true, children: closure_7(quest(5057).Stack, obj3) });
}
