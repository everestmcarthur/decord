...
// Dependencies: [5, 19, 17, 9748, 7899, 5614, 9743, 21, 4722, 576, 504, 12020, 5617, 8140, 8143, 1115, 5295, 7364, 7920, 9897, 11729, 12017, 15328, 9745, 4689, 12009, 8593, 11547, 7346, 5757, 5156, 1094, 12012, 9292, 15357, 5142, 4718, 5144, 15324, 2]
// Exports: default

// Module 17409 (QuestProgressBottomSheet)
...
const FramesActionCreatorsDefault = tmp(9745);
require = fn;
...
function QuestProgressBottomSheet(quest) {
  ...
  let completedAt;
  const questsInstructionsToWinReward = tmpResult4.useQuestsInstructionsToWinReward({ quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_BOTTOM_SHEET, sourceQuestContent: quest(5617).QuestContent.RUNNING_ACTIVITY });
  if (userStatus != null) {
  ...
  let obj5 = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_BOTTOM_SHEET, sourceQuestContent: quest(5617).QuestContent.RUNNING_ACTIVITY };
  ...
  const questRewardClaimHandler = tmpResult6.useQuestRewardClaimHandler({ quest, questContent: quest(5617).QuestContent.RUNNING_ACTIVITY, sourceQuestContent: quest(5617).QuestContent.RUNNING_ACTIVITY });
  ...
  const obj6 = { quest, questContent: quest(5617).QuestContent.RUNNING_ACTIVITY, sourceQuestContent: quest(5617).QuestContent.RUNNING_ACTIVITY };
  ...
  const obj13 = { icon: claim(9292), onPress: callback2, variant: "secondary-overlay", size: "sm", accessibilityLabel: null };
  ...
  const items7 = [closure_11(quest(4718).Text, { variant: str, color: "mobile-text-heading-primary", children: formatToPlainStringResult }), ];
