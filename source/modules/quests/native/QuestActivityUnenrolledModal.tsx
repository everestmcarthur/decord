...
// Dependencies: [5, 32, 19, 17, 7811, 17237, 5530, 21, 4638, 576, 1365, 4572, 4346, 504, 7278, 7832, 11629, 11917, 5533, 1397, 11422, 7836, 4841, 4356, 11916, 15225, 5058, 5673, 11912, 4634, 1115, 5060, 5703, 7487, 7102, 11920, 12071, 2]
// Exports: default

// Module 17238 (QuestActivityUnenrolledModal)
...
import openQuestAccessSuspendedBottomSheetDefault from "openQuestAccessSuspendedBottomSheet" /* 15225 */;
...
function QuestActivityUnenrolledModalInner(quest) {
  ...
  const theme = quest(4572).useTheme();
  let obj = quest(4572);
  const tmp4 = closure_14(quest(4346).isThemeDark(theme));
  let obj2 = quest(4346);
  ...
  let obj3 = quest(504);
  let obj4 = quest(7278);
  const getOrFetchApplication = obj4.useGetOrFetchApplication(quest(7832).getActivityApplicationId(quest));
  const obj5 = quest(7832);
  const questTaskDetails = quest(11629).useQuestTaskDetails(quest);
  let obj6 = quest(11629);
  const obj7 = quest(11917);
  const items1 = [getOrFetchApplication];
  const questsInstructionsToWinReward = obj7.useQuestsInstructionsToWinReward({ quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5533).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL });
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const obj4 = { questContent: tmp4(5533).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL, questContentCTA: tmp4(7836).QuestContentCTA.START_QUEST, sourceQuestContent: tmp4(5533).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(11422).enrollInQuest(quest.id, obj4), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const obj8 = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5533).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
  const checkboxA11yNative = quest(4356).useCheckboxA11yNative({ checked });
  ({ accessibilityRole, accessibilityState } = checkboxA11yNative);
  const obj9 = quest(4356);
  const isQuestAccessSuspended = quest(11629).useIsQuestAccessSuspended();
  const obj10 = quest(11629);
  trackQuestContentClickedWithImpression = quest(11916).useTrackQuestContentClickedWithImpression();
  ...
  if (tmp18Result) {
    ...
    obj16.children = tmp18(checked(5673), obj17);
  ...
  obj19.children = closure_11(checked(11912), size);
  ...
  const items6 = [closure_11(quest(4634).Text, obj21), ];
  ...
  items6[1] = closure_12(quest(4634).Text, obj22);
  ...
  const items9 = [closure_11(quest(5060).Button, obj26), ];
  ...
  items9[1] = closure_11(quest(5060).Button, obj27);
  ...
  if (null == stateFromStores) {
    ...
    const obj3 = {
      ...
      headerTitle() {
          ...
          return closure_1_11(questId(4634).Text, obj);
        },
      render() {
    ...
    return closure_11(tmp(12071).Modal, obj4);
  }
  let obj = questId(504);
  tmp = questId;
};
