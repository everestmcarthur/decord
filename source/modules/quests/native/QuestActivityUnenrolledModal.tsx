...
// Dependencies: [5, 32, 19, 17, 7808, 17181, 5529, 21, 4639, 576, 1365, 4574, 4348, 504, 7275, 7829, 11621, 11909, 5532, 1397, 11414, 7833, 4842, 4358, 11908, 15209, 5057, 5672, 11904, 4635, 1115, 5059, 5702, 7484, 7099, 11912, 12063, 2]
// Exports: default

// Module 17182 (QuestActivityUnenrolledModal)
...
import openQuestAccessSuspendedBottomSheetDefault from "openQuestAccessSuspendedBottomSheet" /* 15209 */;
...
function QuestActivityUnenrolledModalInner(quest) {
  ...
  let obj3 = quest(504);
  let obj4 = quest(7275);
  const getOrFetchApplication = obj4.useGetOrFetchApplication(quest(7829).getActivityApplicationId(quest));
  const obj5 = quest(7829);
  const questTaskDetails = quest(11621).useQuestTaskDetails(quest);
  let obj6 = quest(11621);
  const obj7 = quest(11909);
  const items1 = [getOrFetchApplication];
  const questsInstructionsToWinReward = obj7.useQuestsInstructionsToWinReward({ quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5532).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL });
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const obj4 = { questContent: tmp4(5532).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL, questContentCTA: tmp4(7833).QuestContentCTA.START_QUEST, sourceQuestContent: tmp4(5532).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(11414).enrollInQuest(quest.id, obj4), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const obj8 = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5532).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
  ...
  const obj10 = quest(11621);
  trackQuestContentClickedWithImpression = quest(11908).useTrackQuestContentClickedWithImpression();
  ...
  if (tmp18Result) {
    ...
    obj16.children = tmp18(checked(5672), obj17);
  ...
  obj19.children = closure_11(checked(11904), size);
  ...
  const items6 = [closure_11(quest(4635).Text, obj21), ];
  ...
  items6[1] = closure_12(quest(4635).Text, obj22);
  ...
  const items9 = [closure_11(quest(5059).Button, obj26), ];
  ...
  items9[1] = closure_11(quest(5059).Button, obj27);
  ...
  if (null == stateFromStores) {
    ...
    const obj3 = {
      ...
      headerTitle() {
          ...
          return closure_1_11(questId(4635).Text, obj);
        },
      render() {
    ...
    return closure_11(tmp(12063).Modal, obj4);
  }
  let obj = questId(504);
  tmp = questId;
};
