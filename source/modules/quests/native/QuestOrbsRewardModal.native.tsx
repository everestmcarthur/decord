...
// Dependencies: [32, 5, 19, 17, 4598, 1371, 1895, 5495, 21, 4809, 11872, 1896, 4606, 576, 8927, 5682, 5731, 1114, 5638, 8900, 1116, 11873, 11874, 11875, 504, 8940, 1093, 11384, 11876, 11860, 5498, 11877, 7196, 4602, 5026, 2]
...
function AnimatedOrbContainer(isAppActive) {
  ...
  const items1 = [tmp13, , ];
  const obj3 = { uri: _modDef11874, style: null, onLoad: null, animate: null };
  ...
  if (tmp15Result) {
    const obj5 = { uri: _modDef11875, style: null, onLoad: null, animate: null };
...
export default function QuestOrbsRewardModal(quest) {
  ...
  let obj = num(504);
  num = num(8940).useFetchVirtualCurrencyBalance().balance;
  let obj2 = num(8940);
  ...
  let string = obj3.useCallback(() => {
    _undefined(4809).popWithKey(QuestOrbsRewardModal);
    const obj = _undefined(4809);
    const obj2 = num(11860);
    obj2.openQuestHome({ filter: constants.VIRTUAL_CURRENCY, fromContent: num(5498).QuestContent.REWARD_MODAL });
  }, []);
  const obj6 = { style: tmp.root, children: null };
  const obj7 = { style: absoluteFill.absoluteFill, accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: closure_13(num(11877).OrbsRewardBackground, { style: tmp.background, onReady: callback }) };
  ...
  if (!tmp6) {
    ...
    let items6 = [tmp13(tmp2(4602).Heading, obj14), ];
    ...
    items6[1] = tmp13(tmp2(4602).Text, obj16);
    ...
    tmp11(tmp2(7196).SafeAreaPaddingView, rect);
  }
};
