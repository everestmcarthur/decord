...
// Dependencies: [32, 5, 19, 17, 4599, 1371, 1895, 5496, 21, 4810, 11874, 1896, 4607, 576, 8929, 5683, 5732, 1114, 5639, 8902, 1116, 11875, 11876, 11877, 504, 8942, 1093, 11386, 11878, 11862, 5499, 11879, 7197, 4603, 5027, 2]
// Exports: default, openQuestOrbsRewardModal

// Module 11874 (QuestOrbsRewardModal)
import nativeDefault from "native" /* 576 */;
import utils_PlatformUtils from "utils/PlatformUtils" /* 1116 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4810 */;
import FastImageDefault from "FastImage" /* 5639 */;
import XSmallIcon from "XSmallIcon" /* 5732 */;
import APNGPlayer from "APNGPlayer" /* 8902 */;
...
function CancelButton() {
  ...
  return closure_13(require("module_5683").HeaderBackButton, obj);
}
function StaticOrb() {
...
function AnimatedOrbContainer(isAppActive) {
  ...
  const items1 = [tmp13, , ];
  const obj3 = { uri: _modDef11876, style: null, onLoad: null, animate: null };
  ...
  if (tmp15Result) {
    const obj5 = { uri: _modDef11877, style: null, onLoad: null, animate: null };
...
export default function QuestOrbsRewardModal(quest) {
  ...
  let obj = num(504);
  num = num(8942).useFetchVirtualCurrencyBalance().balance;
  let obj2 = num(8942);
  ...
  if (num2 == null) {
    num2 = tmp2(11386).getQuestOrbRewardQuantityForUser(quest.config, stateFromStores2);
    const tmp2Result = tmp2(11386);
  }
  const effect = obj3.useEffect(() => {
    num(11878).applyOrientationLock("PORTRAIT");
    return () => {
  ...
  let string = obj3.useCallback(() => {
    _undefined(4810).popWithKey(QuestOrbsRewardModal);
    const obj = _undefined(4810);
    const obj2 = num(11862);
    obj2.openQuestHome({ filter: constants.VIRTUAL_CURRENCY, fromContent: num(5499).QuestContent.REWARD_MODAL });
  }, []);
  const obj6 = { style: tmp.root, children: null };
  const obj7 = { style: absoluteFill.absoluteFill, accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: closure_13(num(11879).OrbsRewardBackground, { style: tmp.background, onReady: callback }) };
  ...
  if (!tmp6) {
    ...
    if (stateFromStores) {
      ...
      const obj12 = { isAppActive: stateFromStores1 === num(1093).AppStates.ACTIVE };
    ...
    let items6 = [tmp13(tmp2(4603).Heading, obj14), ];
    ...
    if (num >= 4100) {
      ...
      const obj17 = {
        ...
        profileDecoHook() {
              ...
              return closure_1_13(num(4603).Text, obj, "profileDeco");
            }
      };
    ...
    tmp11(tmp2(7197).SafeAreaPaddingView, rect);
  }
};
