...
function CancelButton() {
  ...
  return closure_13(require("module_5712").HeaderBackButton, obj);
}
function StaticOrb() {
...
export default function QuestOrbsRewardModal(quest) {
  ...
  let obj = num(504);
  num = num(8975).useFetchVirtualCurrencyBalance().balance;
  let obj2 = num(8975);
  ...
  if (!tmp6) {
    ...
    let items6 = [tmp13(tmp2(4632).Heading, obj14), ];
    ...
    if (num >= 4100) {
      ...
      const obj17 = {
        ...
        profileDecoHook() {
              ...
              return closure_1_13(num(4632).Text, obj, "profileDeco");
            }
      };
    ...
    tmp11(tmp2(7226).SafeAreaPaddingView, rect);
  }
};
