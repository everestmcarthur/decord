...
// Dependencies: [21, 4605, 576, 11558, 4341, 4606, 4609, 15119, 5025, 11568, 5501, 5499, 7779, 1114, 2]
// Exports: default

// Module 15124 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  let tmp = closure_5();
  closure_3 = bounty(11558).useGetQuestImpressionId();
  let obj = bounty(11558);
  const fn = function y() {
    let num = 0;
    if (visible) {
      num = 1;
  ...
  let obj2 = bounty(4341);
  fn.__closure = { withTiming: bounty(4606).withTiming, visible, timingStandard: bounty(4609).timingStandard };
  ...
  if (visible) {
    ...
    const items1 = [closure_3(tmp2(5025).Button, obj5), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(5025).Button, obj6);
    }
    items1[1] = tmp9Result;
    obj4.children = items1;
    visible = closure_4(visible(4341).View, obj4);
    tmp9 = closure_3;
  }
  return visible;
};
