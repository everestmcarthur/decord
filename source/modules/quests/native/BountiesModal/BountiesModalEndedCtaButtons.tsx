...
// Dependencies: [21, 4638, 576, 11632, 4374, 4639, 4642, 15155, 5060, 11642, 5537, 5535, 7836, 1115, 2]
// Exports: default

// Module 15160 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  let tmp = closure_5();
  closure_3 = bounty(11632).useGetQuestImpressionId();
  let obj = bounty(11632);
  const fn = function y() {
    let num = 0;
    if (visible) {
      num = 1;
  ...
  let obj2 = bounty(4374);
  fn.__closure = { withTiming: bounty(4639).withTiming, visible, timingStandard: bounty(4642).timingStandard };
  ...
  if (visible) {
    ...
    const items1 = [closure_3(tmp2(5060).Button, obj5), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(5060).Button, obj6);
    }
    items1[1] = tmp9Result;
    obj4.children = items1;
    visible = closure_4(visible(4374).View, obj4);
    tmp9 = closure_3;
  }
  return visible;
};
