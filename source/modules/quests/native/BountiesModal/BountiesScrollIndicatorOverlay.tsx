...
// Dependencies: [32, 19, 17, 21, 4609, 4605, 576, 4341, 4606, 5037, 15117, 4601, 1114, 2]
// Exports: default

// Module 15116 (BountiesScrollIndicatorOverlay)
...
let closure_9 = 5000 + fn(4609).timingSlowDuration;
...
export default function BountiesScrollIndicatorOverlay(enabled) {
  ...
  let fn = function j() {
    ...
    if (!isEndCardVisible) {
      if (enabled) {
        let timingStandard = tmp(4609).timingSlow;
      }
      const obj2 = { opacity: obj.withTiming(num, timingStandard) };
      return obj2;
    }
    timingStandard = tmp(4609).timingStandard;
  };
