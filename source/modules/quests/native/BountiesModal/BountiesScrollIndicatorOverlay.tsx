...
// Dependencies: [32, 19, 17, 21, 4610, 4606, 576, 4343, 4607, 5038, 15094, 4602, 1114, 2]
// Exports: default
...
let closure_9 = 5000 + fn(4610).timingSlowDuration;
...
export default function BountiesScrollIndicatorOverlay(enabled) {
  ...
  let fn = function j() {
    ...
    if (!isEndCardVisible) {
      if (enabled) {
        let timingStandard = tmp(4610).timingSlow;
      }
      const obj2 = { opacity: obj.withTiming(num, timingStandard) };
      return obj2;
    }
    timingStandard = tmp(4610).timingStandard;
  };
