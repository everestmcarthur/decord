...
// Dependencies: [32, 19, 17, 21, 4644, 4640, 576, 4376, 4641, 5074, 15161, 4636, 1115, 2]
// Exports: default

// Module 15160 (BountiesScrollIndicatorOverlay)
...
let closure_9 = 5000 + fn(4644).timingSlowDuration;
...
export default function BountiesScrollIndicatorOverlay(enabled) {
  ...
  let fn = function j() {
    ...
    if (!isEndCardVisible) {
      if (enabled) {
        let timingStandard = tmp(4644).timingSlow;
      }
      const obj2 = { opacity: obj.withTiming(num, timingStandard) };
      return obj2;
    }
    timingStandard = tmp(4644).timingStandard;
  };
