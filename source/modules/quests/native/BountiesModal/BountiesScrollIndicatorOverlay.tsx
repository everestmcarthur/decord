...
// Dependencies: [32, 19, 17, 21, 4726, 4722, 576, 4458, 4723, 5156, 15255, 4718, 1115, 2]
// Exports: default

// Module 15254 (BountiesScrollIndicatorOverlay)
...
let closure_9 = 5000 + fn(4726).timingSlowDuration;
...
export default function BountiesScrollIndicatorOverlay(enabled) {
  ...
  let fn = function j() {
    ...
    if (!isEndCardVisible) {
      if (enabled) {
        let timingStandard = tmp(4726).timingSlow;
      }
      const obj2 = { opacity: obj.withTiming(num, timingStandard) };
      return obj2;
    }
    timingStandard = tmp(4726).timingStandard;
  };
