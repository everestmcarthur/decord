...
// Dependencies: [32, 19, 17, 21, 4642, 4638, 576, 4374, 4639, 5072, 15153, 4634, 1115, 2]
// Exports: default

// Module 15152 (BountiesScrollIndicatorOverlay)
...
let closure_9 = 5000 + fn(4642).timingSlowDuration;
...
export default function BountiesScrollIndicatorOverlay(enabled) {
  ...
  let fn = function j() {
    ...
    if (!isEndCardVisible) {
      if (enabled) {
        let timingStandard = tmp(4642).timingSlow;
      }
      const obj2 = { opacity: obj.withTiming(num, timingStandard) };
      return obj2;
    }
    timingStandard = tmp(4642).timingStandard;
  };
