...
// Dependencies: [32, 19, 17, 21, 4611, 4607, 576, 4343, 4608, 5039, 15094, 4603, 1114, 2]
// Exports: default

// Module 15093 (BountiesScrollIndicatorOverlay)
...
let closure_9 = 5000 + fn(4611).timingSlowDuration;
...
export default function BountiesScrollIndicatorOverlay(enabled) {
  ...
  let fn = function j() {
    ...
    if (!isEndCardVisible) {
      if (enabled) {
        let timingStandard = tmp(4611).timingSlow;
      }
      const obj2 = { opacity: obj.withTiming(num, timingStandard) };
      return obj2;
    }
    timingStandard = tmp(4611).timingStandard;
  };
