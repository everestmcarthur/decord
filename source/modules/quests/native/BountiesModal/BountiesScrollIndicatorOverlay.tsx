...
// Dependencies: [32, 19, 17, 21, 4643, 4639, 576, 4376, 4640, 5071, 15137, 4635, 1115, 2]
// Exports: default

// Module 15136 (BountiesScrollIndicatorOverlay)
...
let closure_9 = 5000 + fn(4643).timingSlowDuration;
...
export default function BountiesScrollIndicatorOverlay(enabled) {
  ...
  let fn = function j() {
    ...
    if (!isEndCardVisible) {
      if (enabled) {
        let timingStandard = tmp(4643).timingSlow;
      }
      const obj2 = { opacity: obj.withTiming(num, timingStandard) };
      return obj2;
    }
    timingStandard = tmp(4643).timingStandard;
  };
