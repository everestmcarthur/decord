...
// Dependencies: [32, 19, 17, 7816, 5532, 15130, 1074, 1955, 21, 1365, 576, 4640, 4376, 1478, 1612, 15131, 11637, 7813, 15126, 4641, 4644, 7832, 11651, 1110, 504, 15134, 15135, 1255, 7842, 15136, 11430, 5539, 5537, 11666, 15137, 15169, 15139, 11929, 15170, 8873, 15174, 5074, 15175, 4365, 15176, 2]
// Exports: default

// Module 15129 (BountiesModalContentScroll)
...
import useBountiesRecapScroll from "useBountiesRecapScroll" /* 15135 */;
import BountiesScrollVideoItem from "BountiesScrollVideoItem" /* 15137 */;
import BountiesScrollRecapPage from "BountiesScrollRecapPage" /* 15170 */;
import shared_ThemeTypes from "shared/ThemeTypes" /* 15176 */;
...
function BountiesModalContentScrollInner(initialBountyId) {
  ...
  noop.useRef(null);
  [tmp7, c4] = height(noop.useState(initialBountyId(15131).BOUNTIES_MODAL_BASE_FOOTER_HEIGHT), 2);
  closure_129_0 = tmp7;
  ...
  let tmp6 = height(noop.useState(initialBountyId(15131).BOUNTIES_MODAL_BASE_FOOTER_HEIGHT), 2);
  const questHomeBounties = initialBountyId(11637).useQuestHomeBounties().questHomeBounties;
  ...
  let obj2 = initialBountyId(11637);
  ...
  const bountyRecurringSwipeUpNux = initialBountyId(15134).useBountyRecurringSwipeUpNux({ isEligible: tmp24 });
  ...
  const obj6 = initialBountyId(15134);
  const handleRecapMomentumEnd = initialBountyId(15135).useBountiesRecapScroll({ listRef: ref, enabled: tmp28, offsets: memo4 }).handleRecapMomentumEnd;
  ...
  closure_32 = tmp38;
  const obj7 = initialBountyId(15135);
  ...
  __initData7 = initialBountyId(15136).useBountiesRecapOrbCount({ scrollY: sharedValue4, lastBountyScrollOffset: result, recapRevealHeight: height3, targetOrbAmount: stateFromStores, enabled: tmp28 });
  ...
  const obj11 = initialBountyId(15136);
  ...
  Tt.__closure = { showRecapPullZone: stateFromStores > 0, scrollY: sharedValue4, lastBountyScrollOffset: result, RECAP_SNAP_EPSILON: initialBountyId(15135).RECAP_SNAP_EPSILON };
  ...
  const obj20 = { showRecapPullZone: stateFromStores > 0, scrollY: sharedValue4, lastBountyScrollOffset: result, RECAP_SNAP_EPSILON: initialBountyId(15135).RECAP_SNAP_EPSILON };
  ...
  Ct.__closure = { showRecapPullZone: stateFromStores > 0, scrollY: sharedValue4, fullRecapScrollOffset: sum1, RECAP_SNAP_EPSILON: initialBountyId(15135).RECAP_SNAP_EPSILON };
  ...
  const obj25 = { showRecapPullZone: stateFromStores > 0, scrollY: sharedValue4, fullRecapScrollOffset: sum1, RECAP_SNAP_EPSILON: initialBountyId(15135).RECAP_SNAP_EPSILON };
  ...
  Jt.__closure = { getRevealProgress: initialBountyId(15135).getRevealProgress, scrollY: sharedValue4, lastBountyScrollOffset: result, recapRevealHeight: height3 };
  Jt.__workletHash = 1141192763711;
  Jt.__initData = first4;
  derivedValue = obj30.useDerivedValue(Jt);
  const obj31 = { getRevealProgress: initialBountyId(15135).getRevealProgress, scrollY: sharedValue4, lastBountyScrollOffset: result, recapRevealHeight: height3 };
  class Ut {
    constructor() {
      obj = { opacity: null };
  ...
  if (0 === data.length) {
    ...
    if (tmp43) {
      ...
      tmp85 = isVideoEndAppStoreOverlayVisible(tmp5(15169).BountiesScrollRecapFooter, obj40);
    }
    ...
    if (tmp28) {
      ...
      const obj44 = {
        adContentId,
        adCreativeType: tmp5(5539).AdCreativeType.BOUNTY,
        questContent: tmp5(5537).QuestContent.BOUNTIES_END_INTERSTITIAL,
      ...
      obj43.children = tmp86(tmp5(11929).QuestContentImpressionTrackerNative, obj44);
    ...
    obj45.children = isVideoEndAppStoreOverlayVisible(tmp5(8873).AnimatedFlashList, obj46);
    ...
    if (null != tmp16) {
      ...
      tmp86Result4 = tmp86(tmp2(15174), obj47);
    }
    ...
    if (tmp78) {
      ...
      if (data.length > 1) {
        ...
        obj48.children = tmp86(tmp2(5074), obj49);
    ...
    if (tmp40) {
      ...
      tmp86Result6 = tmp86(tmp2(15175), obj51);
    }
    ...
    items26[5] = isVideoEndAppStoreOverlayVisible(tmp2(15131), obj52);
    obj42.children = items26;
    obj41.children = memo1(questHomeBounties, obj42);
    return isVideoEndAppStoreOverlayVisible(tmp5(15139).BountyVideoEndAppStoreProvider, obj41);
  }
...
const BountiesModalConstants = fn(15130);
