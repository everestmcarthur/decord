...
// Dependencies: [19, 17, 4599, 5496, 21, 4607, 576, 4608, 4611, 11617, 15096, 1114, 4343, 5039, 15099, 15101, 4603, 10271, 15063, 504, 15064, 10061, 2]
// Exports: default

// Module 15098 (BountiesScrollEndCard)
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const isBountiesVerticalScrollExperimentEnabled = isActive(11617).useIsBountiesVerticalScrollExperimentEnabled("BountiesScrollEndCard");
  let obj = isActive(11617);
  const bountyCtaInfo = isActive(15096).getBountyCtaInfo(bounty);
  const intl = isActive(1114).intl;
  const stringResult = intl.string(isActive(1114).t["9UtZAY"]);
  let obj2 = isActive(15096);
  const fn = function y() {
  ...
  const obj3 = isActive(4343);
  fn.__closure = { isScrollingInBoundsSharedValue, withTiming: isActive(4608).withTiming, isActive, timingStandard: isActive(4611).timingStandard };
  ...
  obj5.style = items;
  const items1 = [closure_9(closure_6, { style: tmp.backdropTint, pointerEvents: "none" }), closure_9(isScrollingInBoundsSharedValue(5039), { colors: ["rgba(0, 0, 0, 0.48)", "rgba(0, 0, 0, 0.8)"], style: tmp.backdropGradient, pointerEvents: "none" }), ];
  if (isBountiesVerticalScrollExperimentEnabled) {
    ...
    const items3 = [tmp10(tmp9(15099), obj9), ];
    ...
    obj10.children = tmp10(tmp9(15101), obj11);
    items3[1] = tmp10(tmp11, obj10);
    obj8.children = items3;
    let tmp10Result = tmp8(tmp9(4343).View, obj8);
  } else {
    let tmp13;
    if (isActive) {
      tmp13 = onReplay;
    ...
    items6[1] = tmp10(tmp2(10271).RetryIcon, obj17);
    obj13.children = items6;
    obj12.children = tmp8(tmp9(4343).View, obj13);
    tmp10Result = tmp10(closure_4, obj12);
  }
  items1[2] = tmp10Result;
  obj5.children = items1;
  return closure_10(isScrollingInBoundsSharedValue(4343).View, obj5);
}
