...
// Dependencies: [19, 17, 4598, 5495, 21, 4606, 576, 4607, 4610, 11615, 15096, 1114, 4343, 5038, 15099, 15101, 4602, 10269, 15063, 504, 15064, 10059, 2]
// Exports: default
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const isBountiesVerticalScrollExperimentEnabled = isActive(11615).useIsBountiesVerticalScrollExperimentEnabled("BountiesScrollEndCard");
  ...
  fn.__closure = { isScrollingInBoundsSharedValue, withTiming: isActive(4607).withTiming, isActive, timingStandard: isActive(4610).timingStandard };
  ...
  obj5.style = items;
  const items1 = [closure_9(closure_6, { style: tmp.backdropTint, pointerEvents: "none" }), closure_9(isScrollingInBoundsSharedValue(5038), { colors: ["rgba(0, 0, 0, 0.48)", "rgba(0, 0, 0, 0.8)"], style: tmp.backdropGradient, pointerEvents: "none" }), ];
  if (isBountiesVerticalScrollExperimentEnabled) {
    ...
    items6[1] = tmp10(tmp2(10269).RetryIcon, obj17);
