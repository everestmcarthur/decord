...
// Dependencies: [19, 17, 4631, 5529, 21, 4639, 576, 4640, 4643, 4376, 5071, 15142, 15144, 15108, 504, 15109, 10100, 2]
// Exports: default

// Module 15141 (BountiesScrollEndCard)
...
import BountiesModalTransitionsRefactorExperiment from "BountiesModalTransitionsRefactorExperiment" /* 15108 */;
import useVisibilityTransition from "useVisibilityTransition" /* 15109 */;
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  S.__closure = { isScrollingInBoundsSharedValue, withTiming: isActive(4640).withTiming, isActive, timingStandard: isActive(4643).timingStandard };
  ...
  obj3.style = items;
  const items1 = [closure_8(closure_5, { style: tmp.backdropTint, pointerEvents: "none" }), closure_8(isScrollingInBoundsSharedValue(5071), { colors: ["rgba(0, 0, 0, 0.48)", "rgba(0, 0, 0, 0.8)"], style: tmp.backdropGradient, pointerEvents: "none" }), ];
  const obj6 = { style: null, pointerEvents: "box-none", children: null };
  const items2 = [tmp.overlayContent, animatedStyle];
  obj6.style = items2;
  const items3 = [closure_8(isScrollingInBoundsSharedValue(15142), { bounty, sourceQuestContent, disabled: !isActive }), ];
  const obj8 = {
    style: tmp.endedCtaButtonsContainer,
    pointerEvents: "box-none",
    children: closure_8(isScrollingInBoundsSharedValue(15144), {
      bounty,
      visible,
      sourceQuestContent,
      onClose() {
...
entering.__closure = { withTiming: fn(4640).withTiming, timingStandard: fn(4643).timingStandard };
...
let obj2 = { withTiming: fn(4640).withTiming, timingStandard: fn(4643).timingStandard };
fn2.__closure = { withTiming: fn(4640).withTiming, timingStandard: fn(4643).timingStandard };
