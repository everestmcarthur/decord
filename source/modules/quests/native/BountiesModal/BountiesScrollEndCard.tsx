...
// Dependencies: [19, 17, 4630, 5530, 21, 4638, 576, 4639, 4642, 4374, 5072, 15158, 15160, 15124, 504, 15125, 10108, 2]
// Exports: default

// Module 15157 (BountiesScrollEndCard)
...
import BountiesModalTransitionsRefactorExperiment from "BountiesModalTransitionsRefactorExperiment" /* 15124 */;
import useVisibilityTransition from "useVisibilityTransition" /* 15125 */;
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  let obj = isActive(4374);
  S.__closure = { isScrollingInBoundsSharedValue, withTiming: isActive(4639).withTiming, isActive, timingStandard: isActive(4642).timingStandard };
  ...
  obj3.style = items;
  const items1 = [closure_8(closure_5, { style: tmp.backdropTint, pointerEvents: "none" }), closure_8(isScrollingInBoundsSharedValue(5072), { colors: ["rgba(0, 0, 0, 0.48)", "rgba(0, 0, 0, 0.8)"], style: tmp.backdropGradient, pointerEvents: "none" }), ];
  const obj6 = { style: null, pointerEvents: "box-none", children: null };
  const items2 = [tmp.overlayContent, animatedStyle];
  obj6.style = items2;
  const items3 = [closure_8(isScrollingInBoundsSharedValue(15158), { bounty, sourceQuestContent, disabled: !isActive }), ];
  const obj8 = {
    style: tmp.endedCtaButtonsContainer,
    pointerEvents: "box-none",
    children: closure_8(isScrollingInBoundsSharedValue(15160), {
      bounty,
      visible,
      sourceQuestContent,
      onClose() {
  ...
  items1[2] = closure_9(isScrollingInBoundsSharedValue(4374).View, obj6);
  obj3.children = items1;
  return closure_9(isScrollingInBoundsSharedValue(4374).View, obj3);
}
...
entering.__closure = { withTiming: fn(4639).withTiming, timingStandard: fn(4642).timingStandard };
...
let obj2 = { withTiming: fn(4639).withTiming, timingStandard: fn(4642).timingStandard };
fn2.__closure = { withTiming: fn(4639).withTiming, timingStandard: fn(4642).timingStandard };
