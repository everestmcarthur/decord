...
// Dependencies: [19, 17, 21, 5032, 4343, 8544, 4607, 576, 1115, 4608, 4603, 9532, 2]
// Exports: default
...
let c7 = "#2ECC71";
let result = (fn(5032).SMALL_BUTTON_HEIGHT - 4) / 2;
...
let closure_13 = ReanimatedRexport.createAnimatedComponent(fn(8544).Circle);
...
let size = { alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT, borderRadius: nativeDefault.radii.round, width: fn(5032).SMALL_BUTTON_HEIGHT, height: fn(5032).SMALL_BUTTON_HEIGHT };
obj.progress = size;
