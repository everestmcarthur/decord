...
// Dependencies: [19, 17, 21, 5067, 4376, 8606, 4640, 576, 1364, 4641, 4636, 9593, 2]
// Exports: default

// Module 15164 (BountiesModalTimer)
...
let c7 = "#2ECC71";
let result = (fn(5067).SMALL_BUTTON_HEIGHT - 4) / 2;
...
let closure_13 = ReanimatedRexport.createAnimatedComponent(fn(8606).Circle);
...
let size = { alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT, borderRadius: nativeDefault.radii.round, width: fn(5067).SMALL_BUTTON_HEIGHT, height: fn(5067).SMALL_BUTTON_HEIGHT };
obj.progress = size;
