...
// Dependencies: [19, 17, 21, 5065, 4374, 8586, 4638, 576, 1364, 4639, 4634, 9582, 2]
// Exports: default

// Module 15156 (BountiesModalTimer)
...
let c7 = "#2ECC71";
let result = (fn(5065).SMALL_BUTTON_HEIGHT - 4) / 2;
...
let closure_13 = ReanimatedRexport.createAnimatedComponent(fn(8586).Circle);
...
let size = { alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT, borderRadius: nativeDefault.radii.round, width: fn(5065).SMALL_BUTTON_HEIGHT, height: fn(5065).SMALL_BUTTON_HEIGHT };
obj.progress = size;
