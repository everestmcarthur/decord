...
// Dependencies: [19, 17, 15261, 21, 4722, 576, 11732, 15257, 11537, 11742, 5621, 5619, 7924, 5757, 4718, 2]
// Exports: default

// Module 15260 (BountiesEndCardPressableCta)
...
const END_CARD_IMAGE_SIZE = fn(15261).END_CARD_IMAGE_SIZE;
const jsxProd = fn(21);
