...
// Dependencies: [4808, 15081, 1896, 2]

// Module 15080 (BountiesModalActionCreators)
...
export default {
  showModal(arg0) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(15081, dependencyMap.paths), { bountyId, sourceQuestContent, variant }, BOUNTIES_MODAL);
  },
  hideModal() {
