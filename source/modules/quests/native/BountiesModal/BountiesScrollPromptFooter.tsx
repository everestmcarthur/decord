...
// Dependencies: [19, 17, 4630, 5530, 21, 4638, 576, 4639, 4642, 504, 1612, 4374, 4348, 15124, 15125, 10108, 2]
// Exports: default

// Module 15123 (BountiesScrollPromptFooter)
...
function BountiesScrollPromptFooterContent(zIndex) {
  ...
  obj3.children = closure_7(zIndex(4348).BountiesScrollGradientRive, { stateMachine: "State Machine 1", fit: "fill", alignment: "bottom-center", withReducedMotion: str });
