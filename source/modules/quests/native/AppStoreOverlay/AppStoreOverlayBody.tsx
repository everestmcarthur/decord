...
// Dependencies: [19, 17, 1074, 7225, 21, 4607, 576, 5639, 4603, 11599, 1114, 11602, 11607, 1611, 4308, 672, 5039, 5027, 2]
// Exports: AppStoreOverlayBody, AppStoreOverlayFooter

// Module 11598 (AppStoreOverlayBody)
import nativeDefault from "native" /* 576 */;
import _modDef672 from "module_672" /* 672 */;
import Text_Text from "Text/Text" /* 4603 */;
import FastImageDefault from "FastImage" /* 5639 */;
import AppStoreOverlayStatsCarouselDefault from "AppStoreOverlayStatsCarousel" /* 11599 */;
import AppStoreOverlayMediaCarouselDefault from "AppStoreOverlayMediaCarousel" /* 11602 */;
import AppStoreOverlayAboutSectionDefault from "AppStoreOverlayAboutSection" /* 11607 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
const VerticalGradient = fn(1074).VerticalGradient;
let closure_6 = fn(7225).ACTION_SHEET_MINIMUM_BOTTOM_PADDING;
const jsxProd = fn(21);
...
export const AppStoreOverlayBody = function AppStoreOverlayBody(metadata) {
  ...
  if (tmp16Result) {
    ...
    tmp16Result = tmp16(tmp17(4603).Text, obj10);
  }
  ...
  if (tmp3Result) {
    ...
    const items4 = [tmp16(tmp17(4603).Text, obj13), ];
...
export const AppStoreOverlayFooter = function AppStoreOverlayFooter(arg0) {
  ...
  token = bottom(4308).useToken(token(576).colors.MOBILE_ACTIONSHEET_BACKGROUND);
  let items = [token];
  const items1 = [bottom];
  ...
  const items2 = [closure_7(token(5039), { pointerEvents: "none", style: tmp.footerGradient, colors: memo, start: VerticalGradient.START, end: VerticalGradient.END }), ];
  ...
  obj4.children = closure_7(bottom(5027).Button, obj5);
