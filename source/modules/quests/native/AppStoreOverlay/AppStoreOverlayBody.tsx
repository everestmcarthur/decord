...
// Dependencies: [19, 17, 1074, 7224, 21, 4606, 576, 5638, 4602, 11597, 1114, 11600, 11605, 1611, 4308, 672, 5038, 5026, 2]
// Exports: AppStoreOverlayBody, AppStoreOverlayFooter

// Module 11596 (AppStoreOverlayBody)
import nativeDefault from "native" /* 576 */;
import _modDef672 from "module_672" /* 672 */;
import Text_Text from "Text/Text" /* 4602 */;
import FastImageDefault from "FastImage" /* 5638 */;
import AppStoreOverlayStatsCarouselDefault from "AppStoreOverlayStatsCarousel" /* 11597 */;
import AppStoreOverlayMediaCarouselDefault from "AppStoreOverlayMediaCarousel" /* 11600 */;
import AppStoreOverlayAboutSectionDefault from "AppStoreOverlayAboutSection" /* 11605 */;
...
export const AppStoreOverlayBody = function AppStoreOverlayBody(metadata) {
  ...
  if (tmp16Result) {
    ...
    tmp16Result = tmp16(tmp17(4602).Text, obj10);
  }
  ...
  if (tmp3Result) {
    ...
    const items4 = [tmp16(tmp17(4602).Text, obj13), ];
...
export const AppStoreOverlayFooter = function AppStoreOverlayFooter(arg0) {
  ...
  const items2 = [closure_7(token(5038), { pointerEvents: "none", style: tmp.footerGradient, colors: memo, start: VerticalGradient.START, end: VerticalGradient.END }), ];
  ...
  obj4.children = closure_7(bottom(5026).Button, obj5);
