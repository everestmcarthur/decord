...
// Dependencies: [19, 17, 1074, 7203, 21, 4605, 576, 5637, 4601, 11575, 1114, 11578, 11583, 1611, 4306, 672, 5037, 5025, 2]
// Exports: AppStoreOverlayBody, AppStoreOverlayFooter

// Module 11574 (AppStoreOverlayBody)
import nativeDefault from "native" /* 576 */;
import _modDef672 from "module_672" /* 672 */;
import Text_Text from "Text/Text" /* 4601 */;
import FastImageDefault from "FastImage" /* 5637 */;
import AppStoreOverlayStatsCarouselDefault from "AppStoreOverlayStatsCarousel" /* 11575 */;
import AppStoreOverlayMediaCarouselDefault from "AppStoreOverlayMediaCarousel" /* 11578 */;
import AppStoreOverlayAboutSectionDefault from "AppStoreOverlayAboutSection" /* 11583 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
const VerticalGradient = fn(1074).VerticalGradient;
let closure_6 = fn(7203).ACTION_SHEET_MINIMUM_BOTTOM_PADDING;
const jsxProd = fn(21);
...
export const AppStoreOverlayBody = function AppStoreOverlayBody(metadata) {
  ...
  if (tmp16Result) {
    ...
    tmp16Result = tmp16(tmp17(4601).Text, obj10);
  }
  ...
  if (tmp3Result) {
    ...
    const items4 = [tmp16(tmp17(4601).Text, obj13), ];
...
export const AppStoreOverlayFooter = function AppStoreOverlayFooter(arg0) {
  ...
  token = bottom(4306).useToken(token(576).colors.MOBILE_ACTIONSHEET_BACKGROUND);
  let items = [token];
  const items1 = [bottom];
  ...
  const items2 = [closure_7(token(5037), { pointerEvents: "none", style: tmp.footerGradient, colors: memo, start: VerticalGradient.START, end: VerticalGradient.END }), ];
  ...
  obj4.children = closure_7(bottom(5025).Button, obj5);
