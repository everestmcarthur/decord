...
// Dependencies: [19, 17, 21, 4574, 576, 11536, 1114, 11537, 4570, 1115, 6669, 2]
// Exports: default
...
function AppStoreOverlayStatCardItem(onRatingPress) {
  ...
  if ("rating" === type) {
    ...
    if (null != stat.ratingCount) {
      result1 = tmp9(11536).formatAppStoreRatingCount(stat.ratingCount, tmp9(1114).intl.currentLocale);
      const tmp9Result = tmp9(11536);
    }
  ...
  if (tmp23Result) {
    ...
    if (null == secondaryContent) {
      ...
      secondaryContent = tmp23(tmp20(4570).Text, obj9);
    }
