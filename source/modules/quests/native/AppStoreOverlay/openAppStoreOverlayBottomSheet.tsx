...
// Dependencies: [1074, 4573, 11595, 1896, 7790, 1109, 11591, 2]
// Exports: openAppStoreOverlayBottomSheet

// Module 11594 (openAppStoreOverlayBottomSheet)
...
export const openAppStoreOverlayBottomSheet = function openAppStoreOverlayBottomSheet(appId, arg1) {
  _require = arg1;
  appId = appId.appId;
  appId(4573).openLazy(require("asyncRequireImpl")(11595, dependencyMap.paths), "QuestAppStoreOverlayBottomSheet", {
    metadata: appId,
    onOpen() {
