...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 4574, 4348, 4341, 4489, 11621, 11431, 1115, 8788, 4635, 5207, 15257, 5071, 2]
// Exports: QuestOrbMultiplierPerkPill

// Module 15256 (QuestOrbMultiplierPerkPill)
...
import openQuestOrbMultiplierPerkInfoActionSheetDefault from "openQuestOrbMultiplierPerkInfoActionSheet" /* 15257 */;
...
export const QuestOrbMultiplierPerkPill = function QuestOrbMultiplierPerkPill(questId) {
  ...
  if (null == questOrbRewardMultiplier) {
    ...
    if (!tmp13) {
      ...
      tmp21Result = tmp21(tmp6(5071), obj18);
    }
    ...
    return closure_6(tmp2(5207).PressableOpacity, obj15);
  }
};
