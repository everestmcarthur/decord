...
// Dependencies: [19, 17, 1074, 21, 576, 4638, 11629, 11916, 11632, 11642, 4605, 7492, 15227, 1897, 7837, 7838, 7848, 5537, 7836, 5533, 9395, 5773, 5691, 9024, 1115, 8843, 2]
// Exports: default

// Module 15270 (QuestBottomSheetConsoleConnect)
...
export default function QuestBottomSheetConsoleConnect(quest) {
  ...
  function openQuestBottomSheet() {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15227, dependencyMap.paths), "QuestBottomSheet", { questId: quest.id, initialStep, sourceQuestContent });
  }
