...
// Dependencies: [5, 19, 5530, 15206, 15227, 4605, 11632, 15231, 7837, 7838, 7848, 5537, 7836, 5533, 7826, 2]
// Exports: useMobileActivityPressHandler, useWatchTaskPressHandler

// Module 15230 (QuestBottomSheetHooks)
...
export const useWatchTaskPressHandler = function useWatchTaskPressHandler(questId) {
  ...
  return noop.useCallback(() => {
    ...
    if (obj3.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_bottom_sheet_watch_task")) {
      const obj4 = { type: tmp8(7848).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp8(5537).AdCreativeType.QUEST, adCreativeId: tmp4, questContentCTA: tmp8(7836).QuestContentCTA.WATCH_VIDEO, surfaceId: tmp8(5533).QuestContent.QUEST_BOTTOM_SHEET, sourceQuestContent: tmp6, impressionId: null, questContentPosition: null };
      let id;
      if (obj2 != null) {
        id = obj2.getId();
      }
      ...
      tmp8(7838).captureAdUserAction(obj4);
      const tmp8Result = tmp8(7838);
    } else {
      const obj5 = { questId: tmp4, questContent: tmp8(5533).QuestContent.QUEST_BOTTOM_SHEET, questContentCTA: tmp8(7836).QuestContentCTA.WATCH_VIDEO, questContentPosition: null, impressionId: null, sourceQuestContent: null };
      ...
      const result = tmp8(7826).trackQuestContentClicked(obj5);
      const tmp8Result2 = tmp8(7826);
    }
  }, items1);
};
    ...
    if (dependencyMap === 2) {
      ...
      try {
        ...
        if (0 === c1) {
          ...
          if (obj12.shouldMigrateToAdAnalyticsInterface(tmp4(7837).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_bottom_sheet_mobile_activity")) {
            captureAdUserAction = captureAdUserAction(7838).captureAdUserAction;
            const obj9 = { type: tmp4(7848).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp4(5537).AdCreativeType.QUEST, adCreativeId: closure_128_0, questContentCTA: tmp4(7836).QuestContentCTA.LAUNCH_MOBILE_ACTIVITY, surfaceId: tmp4(5533).QuestContent.QUEST_BOTTOM_SHEET, sourceQuestContent: closure_128_1, impressionId: null, questContentPosition: null };
            let id;
            ...
            const captureAdUserActionResult = captureAdUserAction(7838);
            obj6 = closure_128_4;
            obj7 = closure_128_4;
          } else {
            const obj10 = { questId: closure_128_0, questContent: tmp4(5533).QuestContent.QUEST_BOTTOM_SHEET, questContentCTA: tmp4(7836).QuestContentCTA.LAUNCH_MOBILE_ACTIVITY, questContentPosition: null, impressionId: null, sourceQuestContent: null };
            let questContentPosition1;
            if (closure_128_4 != null) {
            ...
            const result = captureAdUserAction(7826).trackQuestContentClicked(obj10);
            const captureAdUserActionResult2 = captureAdUserAction(7826);
            obj3 = closure_128_4;
            obj4 = closure_128_4;
          }
          dependencyMap = 3;
