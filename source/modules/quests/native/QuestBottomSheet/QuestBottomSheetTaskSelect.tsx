...
// Dependencies: [19, 5444, 21, 5687, 5605, 8884, 1114, 9228, 2]
// Exports: default
...
export default function QuestBottomSheetTaskSelect(onTaskSelect) {
  ...
  obj = { arrow: true, icon: callback(onTaskSelect(8884).ScreenIcon, {}), label: null, onPress: null };
  ...
  obj = { arrow: true, icon: callback(onTaskSelect(9228).GameControllerIcon, {}), label: null, onPress: null };
