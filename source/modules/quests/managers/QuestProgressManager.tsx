...
// Dependencies: [5, 32, 1957, 9664, 1916, 4662, 1932, 4664, 7817, 17277, 5532, 9665, 1091, 7823, 7813, 11669, 5533, 11430, 5535, 7842, 4771, 4770, 7232, 5540, 7838, 4692, 1370, 4769, 7836, 573, 2]
  ...
  for (const item10020 of eligibleQuestsForApplicationId) {
    if (tmp) {
      ...
      if (features.includes(QuestVariants.QuestVariants.MOBILE_ACTIVITY_QUEST)) {
        let tmp6Result = tmp6(11430);
        let obj3 = { questContent: tmp6(5535).QuestContent.RUNNING_ACTIVITY, questContentCTA: tmp6(7842).QuestContentCTA.START_QUEST, sourceQuestContent: tmp6(5535).QuestContent.RUNNING_ACTIVITY };
...
prototype["getActivelyProgressingQuests"] = function getActivelyProgressingQuests(arg0) {
  ...
  } else if (tmp(5540).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP === arg0) {
    return self.getActivelyProgressingStreamOnDesktopQuests();
  } else if (tmp(5540).FirstPartyQuestTaskTypes.PLAY_ACTIVITY === arg0) {
      ...
      if (isQuestProgressable(nextResult)) {
        if (null != desktopApplicationIds) {
          ...
          if (null != found) {
            ...
            obj4.applicationId = tmp7(4771).ROBLOX_APPLICATION_ID;
