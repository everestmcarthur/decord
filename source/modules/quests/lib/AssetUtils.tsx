...
// Function ID: 11382
// Name: AssetUtils
// Dependencies: [5496, 1074, 11382, 11383, 11384, 11385, 11386, 7781, 11393, 11394, 5504, 1365, 1878, 2]
...
// Module 11381 (AssetUtils)
import URLUtilsDefault from "URLUtils" /* 1365 */;
import getDevicePixelRatioDefault from "getDevicePixelRatio" /* 1878 */;
import FirstPartyQuestTaskTypes2 from "FirstPartyQuestTaskTypes" /* 5504 */;
...
import _modDef11384 from "module_11384" /* 11384 */;
...
const obj11 = { [TIER_1]: _modDef11382, [TIER_2]: _modDef11383, [TIER_3]: _modDef11384, [TIER_4]: _modDef11385 };
  ...
  if (obj.HERO === VIDEO_PLAYER_TRANSCRIPT) {
    ...
    if (questPrimaryReward.type === QuestRewardTypes.QuestRewardTypes.VIRTUAL_CURRENCY) {
      ...
      if (null != tmp29) {
        ...
        const obj4 = { url: _modDef11393, mimetype: "video/mp4", isAnimated: true };
        obj5 = obj4;
      } else {
        obj5 = { url: _modDef11394, mimetype: "video/webm", isAnimated: true };
      }
      return obj5;
    } else {
