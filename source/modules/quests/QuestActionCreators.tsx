...
// Dependencies: [5, 7814, 7847, 5527, 4689, 5526, 7817, 7819, 5532, 1074, 5535, 1271, 573, 4541, 1115, 7824, 1231, 4833, 1249, 11431, 7843, 7844, 7854, 5539, 7832, 11434, 7813, 4830, 4838, 11435, 7575, 7835, 11436, 4479, 11437, 11438, 11453, 1241, 7791, 11455, 11439, 1091, 11456, 2]
...
// Module 11430 (QuestActionCreators)
...
import QuestDecisionRoundtripTrackerDefault from "QuestDecisionRoundtripTracker" /* 11435 */;
import EarnedDecisionRoundtripTrackerDefault from "EarnedDecisionRoundtripTracker" /* 11455 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import AdDeliveryStore from "AdDeliveryStore" /* 7814 */;
import ExpandedGuildFolderStore from "ExpandedGuildFolderStore" /* 5527 */;
...
import VideoQuestUIStore from "VideoQuestUIStore" /* 7819 */;
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (1 === tmp8) {
          ...
          const found = quests2.filter((item) => closure_1_0(7824).isQuestWithKnownConfigVersion(item));
          closure_129_3 = found.map((item) => closure_1_0(7824).questWithUserStatusFromServer(item));
          ...
          closure_129_13 = excluded_quests.map((item) => closure_1_0(7824).excludedQuestFromServer(item));
          ...
          if (arg0 === 1) {
            ...
            if (null != questContentCTA.questContentCTA) {
              ...
              if (obj27.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "enroll_in_quest")) {
                ...
                tmp73(7844).captureAdUserAction(obj5);
                const tmp73Result = tmp73(7844);
              } else {
                ...
                const result = tmp73(7832).trackQuestContentClicked(obj6);
                const tmp73Result2 = tmp73(7832);
              }
        ...
        if (arg0 === 1) {
          ...
          if (!fetchingEarnedQuestToDeliverByPlacement.isFetchingEarnedQuestToDeliverByPlacement(closure_1)) {
            ...
            const found = arr2.filter((item) => {
              ...
              return !closure_0(7813).earnedDecisionIsValid(value);
            });
            closure_132_2 = found;
            if (0 !== found.length) {
              const _Date = Date;
...
const getVisibleGuildIdsMethod = fn(7847).getVisibleGuildIdsMethod;
const FetchStatus = fn(7819).FetchStatus;
const ORBS_INTRO_QUEST_ID = fn(5532).ORBS_INTRO_QUEST_ID;
const Constants = fn(1074);
({ AnalyticEvents: map1, Endpoints: closure_14 } = Constants);
let items = [fn(5535).QuestContent.QUEST_BAR, fn(5535).QuestContent.QUEST_BAR_V2, fn(5535).QuestContent.QUEST_BAR_MOBILE];
