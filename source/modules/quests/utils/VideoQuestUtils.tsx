...
// Dependencies: [4654, 7754, 7756, 1074, 7750, 11348, 7775, 1114, 7769, 4462, 2, 11585]
...
export const getVideoQuestWatchCtaText = fn(11585).getVideoQuestWatchCtaText;
...
export const getVideoQuestProgressRemainingAccessibilityLabel = function getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, arg1) {
  if (arg1) {
    ...
    const remainingTaskTime = tmp(7775).getRemainingTaskTime(questTaskDetails);
...
export const handleVideoQuestModalClose = function handleVideoQuestModalClose(arg0) {
  ...
  if (null != videoProgress) {
    ...
    if (tmp4) {
      ...
      if (!isQuestExpiredResult) {
        tmp6(11348).updateVideoProgress(quest.id, videoProgress.maxTimestampSec);
        const tmp6Result = tmp6(11348);
      }
      tmp6 = require;
    }
