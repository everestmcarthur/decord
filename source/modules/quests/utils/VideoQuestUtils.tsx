...
// Dependencies: [4685, 7805, 7807, 1074, 7801, 11409, 7826, 1114, 7820, 4494, 2, 11646]
...
export const getVideoQuestProgressRemainingAccessibilityLabel = function getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, arg1) {
  if (arg1) {
    ...
    const remainingTaskTime = tmp(7826).getRemainingTaskTime(questTaskDetails);
...
export const handleVideoQuestModalClose = function handleVideoQuestModalClose(arg0) {
  ...
  if (null != videoProgress) {
    ...
    if (tmp4) {
      ...
      if (!isQuestExpiredResult) {
        tmp6(11409).updateVideoProgress(quest.id, videoProgress.maxTimestampSec);
        const tmp6Result = tmp6(11409);
      }
      tmp6 = require;
    }
