...
// Function ID: 7797
// Name: QuestTaskUtils
// Dependencies: [7775, 5503, 12, 1090, 7771, 1369, 2]
...
let items = [fn(5503).FirstPartyQuestTaskTypes.PLAY_ON_XBOX, fn(5503).FirstPartyQuestTaskTypes.PLAY_ON_PLAYSTATION];
let closure_129_0 = items;
const hasSomeConsoleTasks = (arg0) => {
  const config = arg0;
  return config.some((item) => null != config.config.taskConfigV2.tasks[item]);
};
const items1 = [fn(5503).FirstPartyQuestTaskTypes.WATCH_VIDEO];
let closure_130_0 = items1;
const fn2 = (arg0) => {
  const config = arg0;
  return config.some((item) => null != config.config.taskConfigV2.tasks[item]);
};
const items2 = [fn(5503).FirstPartyQuestTaskTypes.WATCH_VIDEO_ON_MOBILE];
let closure_131_0 = items2;
const fn3 = (arg0) => {
  const config = arg0;
  return config.some((item) => null != config.config.taskConfigV2.tasks[item]);
};
const items3 = [fn(5503).FirstPartyQuestTaskTypes.WATCH_VIDEO, fn(5503).FirstPartyQuestTaskTypes.WATCH_VIDEO_ON_MOBILE];
let closure_132_0 = items3;
const fn4 = (arg0) => {
  const config = arg0;
  return config.some((item) => null != config.config.taskConfigV2.tasks[item]);
};
const items4 = [fn(5503).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP, fn(5503).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP, fn(5503).FirstPartyQuestTaskTypes.PLAY_ON_PLAYSTATION, fn(5503).FirstPartyQuestTaskTypes.PLAY_ON_XBOX, fn(5503).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_GAME];
let closure_133_0 = items4;
const items5 = [fn(5503).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_ACTIVITY, fn(5503).FirstPartyQuestTaskTypes.PLAY_ACTIVITY];
...
export const getQuestTaskDetails = function getQuestTaskDetails(value, DESKTOP) {
  if (arr.some((item) => null != value.config.taskConfigV2.tasks[item])) {
    let obj = { progressSeconds: 0, targetSeconds: 1, targetMinutes: 1, percentComplete: 0, taskType: tmp(5503).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP };
    let tmp13Result = obj;
    ...
    if (closure_133_0.some((item) => null != config.config.taskConfigV2.tasks[item])) {
      ...
      if (DESKTOP != null) {
        ...
        tmp13Result = (function _getLatestTaskDetails(arg0) {
          ...
          if (includeTaskTypes === undefined) {
            includeTaskTypes = value(5503).FirstPartyQuestTaskTypesSets.ALL;
          }
          const userStatus = quest.userStatus;
          let progress;
          if (userStatus != null) {
        ...
        const FirstPartyQuestTaskTypesSets = tmp(5503).FirstPartyQuestTaskTypesSets;
      ...
      if (closure_136_0.some((item) => null != config.config.taskConfigV2.tasks[item])) {
        ...
        let tmp14 = config.taskConfigV2.tasks[tmp(undefined, 5503).FirstPartyQuestTaskTypes.WATCH_VIDEO];
        const tmp15 = config.taskConfigV2.tasks[tmp(undefined, 5503).FirstPartyQuestTaskTypes.WATCH_VIDEO_ON_MOBILE];
        if (null == tmp14) {
          let tmp18 = tmp15;
          if (tmp15 == null) {
            tmp18 = tmp14;
        ...
        let tmp8 = null != value;
        if (tmp8) {
          tmp8 = null != value.config.taskConfigV2.tasks[tmp(undefined, 5503).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP];
        }
        if (tmp8) {
          const obj4 = { quest: value, taskType: tmp(5503).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP };
          tmp13Result = _getTaskDetailsForType(obj4);
        } else if (null != value.config.taskConfigV2.tasks[tmp(undefined, 5503).FirstPartyQuestTaskTypes.PLAY_ACTIVITY]) {
          const obj5 = { quest: value, taskType: tmp(5503).FirstPartyQuestTaskTypes.PLAY_ACTIVITY };
          tmp13Result = _getTaskDetailsForType(obj5);
        } else {
          const obj6 = { quest: value, taskType: tmp(5503).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP };
  ...
  if (null != tmp13Result) {
    ...
    if (null == tmp26) {
      const obj8 = { progressSeconds: 0, targetSeconds: 1, targetMinutes: 1, percentComplete: 0, taskType: tmp(5503).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP };
      tmp26 = obj8;
    }
    return tmp26;
  }
