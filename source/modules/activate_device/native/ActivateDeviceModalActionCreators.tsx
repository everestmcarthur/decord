...
// Dependencies: [4809, 13927, 1896, 2]

// Module 13926 (ActivateDeviceModalActionCreators)
...
export default {
  showModal(userCode) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(13927, dependencyMap.paths), { userCode }, ACTIVATE_DEVICE_MODAL_KEY);
  },
  hideModal() {
