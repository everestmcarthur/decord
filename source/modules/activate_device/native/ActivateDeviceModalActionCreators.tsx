...
// Dependencies: [4839, 13961, 1896, 2]

// Module 13960 (ActivateDeviceModalActionCreators)
...
export default {
  showModal(userCode) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(13961, dependencyMap.paths), { userCode }, ACTIVATE_DEVICE_MODAL_KEY);
  },
  hideModal() {
