...
// Function ID: 13969
// Name: ActivateDevice
// Dependencies: [32, 19, 17, 21, 4639, 576, 13969, 13971, 9705, 9393, 13972, 9370, 13973, 5672, 13974, 13978, 13979, 1397, 13980, 7230, 2]
// Exports: ActivateDevice

// Module 13968 (ActivateDevice)
...
export const ActivateDevice = (onClose) => {
  ...
  obj6.source = first(first1[17]).makeSource(require("module_13980"));
