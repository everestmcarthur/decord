...
// Function ID: 13990
// Name: ActivateDevice
// Dependencies: [32, 19, 17, 21, 4640, 576, 13990, 13992, 9727, 9415, 13993, 9392, 13994, 5675, 13995, 13999, 14000, 1397, 14001, 7237, 2]
// Exports: ActivateDevice

// Module 13989 (ActivateDevice)
...
import _modDef13994 from "module_13994" /* 13994 */;
...
export const ActivateDevice = (onClose) => {
  ...
  obj6.source = first(first1[17]).makeSource(require("module_14001"));
