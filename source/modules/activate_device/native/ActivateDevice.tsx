...
// Function ID: 13982
// Name: ActivateDevice
// Dependencies: [32, 19, 17, 21, 4638, 576, 13982, 13984, 9716, 9404, 13985, 9381, 13986, 5673, 13987, 13991, 13992, 1397, 13993, 7233, 2]
// Exports: ActivateDevice

// Module 13981 (ActivateDevice)
...
import _modDef13986 from "module_13986" /* 13986 */;
...
export const ActivateDevice = (onClose) => {
  ...
  obj6.source = first(first1[17]).makeSource(require("module_13993"));
