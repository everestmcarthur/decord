...
// Function ID: 14084
// Name: ActivateDevice
// Dependencies: [32, 19, 17, 21, 4722, 576, 14084, 14086, 9821, 9499, 14087, 9476, 14088, 5757, 14089, 14093, 14094, 1397, 14095, 7319, 2]
// Exports: ActivateDevice

// Module 14083 (ActivateDevice)
import nativeDefault from "native" /* 576 */;
import FastImageDefault from "FastImage" /* 5757 */;
import ConsoleOAuthApplications from "ConsoleOAuthApplications" /* 9499 */;
...
export const ActivateDevice = (onClose) => {
  ...
  obj6.source = first(first1[17]).makeSource(require("module_14095"));
