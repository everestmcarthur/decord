...
// Function ID: 13929
// Name: ActivateDevice
// Dependencies: [32, 19, 17, 21, 4606, 576, 13929, 13931, 9664, 9351, 13932, 9328, 13933, 5638, 13934, 13938, 13939, 1396, 13940, 7196, 2]
// Exports: ActivateDevice

// Module 13928 (ActivateDevice)
...
import _modDef13933 from "module_13933" /* 13933 */;
...
export const ActivateDevice = (onClose) => {
  ...
  obj6.source = first(first1[17]).makeSource(require("module_13940"));
