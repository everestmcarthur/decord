...
// Dependencies: [19, 1940, 9503, 1115, 1894, 2]
// Exports: default

// Module 12136 (useActivityShelfItemsSorting)
  ...
  return noop.useMemo(() => {
    ...
    const found = mapped.filter((item) => {
      ...
      if (embeddedActivityConfig != null) {
        ...
        const tmp7 = embeddedActivityConfig.client_platform_config[closure_1(9503)(undefined, obj.getOS(obj))];
        if (tmp7 != null) {
          label_type = tmp7.label_type;
        }
        const tmp5 = closure_1(9503);
      }
      let tmp8 = null != label_type;
      if (tmp8) {
        tmp8 = label_type === items(1894).EmbeddedActivityLabelTypes.NEW || label_type === items(1894).EmbeddedActivityLabelTypes.UPDATED;
        const tmp11 = label_type === items(1894).EmbeddedActivityLabelTypes.NEW || label_type === items(1894).EmbeddedActivityLabelTypes.UPDATED;
      }
      return tmp8;
    });
