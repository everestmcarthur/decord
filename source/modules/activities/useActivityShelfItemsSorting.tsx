...
// Dependencies: [19, 1940, 9442, 1115, 1894, 2]
// Exports: default

// Module 12071 (useActivityShelfItemsSorting)
  ...
  return noop.useMemo(() => {
    ...
    const found = mapped.filter((item) => {
      ...
      if (embeddedActivityConfig != null) {
        ...
        const tmp7 = embeddedActivityConfig.client_platform_config[closure_1(9442)(undefined, obj.getOS(obj))];
        if (tmp7 != null) {
          label_type = tmp7.label_type;
        }
        const tmp5 = closure_1(9442);
      }
