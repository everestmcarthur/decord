...
// Dependencies: [5, 9382, 4835, 4623, 4750, 1918, 502, 1957, 1979, 4245, 1371, 4626, 1956, 1920, 9598, 1074, 1350, 1954, 7809, 9599, 7826, 9600, 9616, 9617, 9618, 573, 9663, 9620, 4509, 4836, 8948, 9639, 9664, 1894, 9665, 9632, 9504, 1242, 9630, 9675, 9625, 4951, 1114, 9621, 9638, 1250, 4800, 4235, 9569, 4808, 1272, 1369, 8466, 7530, 4620, 7755, 1945, 1943, 2]
...
// Module 9597 (EmbeddedActivitiesActionCreators)
...
import PopoutWindowStore from "PopoutWindowStore" /* 4750 */;
...
const ChannelRTCActionCreatorsDefault = tmp2(4808);
const ChannelRTCParticipants = tmp6(9569);
require = fn;
          ...
          if (closure_140_2) {
            if (null != closure_140_0) {
              if ((function isSupportedChannelType(arg0, type) {
                ...
                const obj = closure_1_0(8948);
                const hasApplicationFlagResult = closure_1_0(8948).hasApplicationFlag(application, constants.EMBEDDED);
                const result = closure_1_0(9639).isActivityInTextSupportedForChannel(type);
                if (tmp2) {
                        ...
                        if (null != error_code) {
                          if (null != error_message) {
                            if (null != error_status) {
                              ...
                              obj3.body = obj4;
                              const tmp21 = new tmp3(4509)(obj3);
                              closure_1_1(tmp21);
                            }
                          }
                        }
                        if (null != error_reason_code) {
                          if (error_reason_code in tmp3(4836).ReasonCodes) {
                            const tmp14 = new tmp3(4836)(error_reason_code);
                            closure_1_1(tmp14);
                          }
                        }
                        const obj = nonce(1242);
                        const tmp3Result = nonce(4836);
                        closure_1_1(new nonce(4836)(nonce(4836).ReasonCodes.UNKNOWN));
                      }
                    };
                  }
                };
...
let closure_38 = async function _sendEmbeddedActivityInviteUser() {
  ...
  await closure_130_1(closure_130_2[54]).ensurePrivateChannel(closure_129_2).then((result) => {
    ...
    if (null == channel) {
      ...
      let content;
      if (null != closure_1_5) {
        content = closure_1(7755).parse(channel, tmp2).content;
        const obj = closure_1(7755);
      }
...
let closure_4 = fn(9382).getOrFetchApplicationCommandIndexForTarget;
