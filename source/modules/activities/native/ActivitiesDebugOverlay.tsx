...
// Dependencies: [19, 17, 21, 4640, 4489, 576, 9719, 1612, 4636, 2]
// Exports: default

// Module 17391 (ActivitiesDebugOverlay)
...
export default function ActivitiesDebugOverlay() {
  ...
  if (useThermalState.ThermalStates.UNHANDLED !== tmp4) {
    ...
    str2 = "nominal";
    if (tmp5(9719).ThermalStates.NOMINAL !== tmp4) {
      str = "text-feedback-warning";
      str2 = "fair";
      if (tmp5(9719).ThermalStates.FAIR !== tmp4) {
        str2 = "serious";
        str = "text-feedback-critical";
        if (tmp5(9719).ThermalStates.SERIOUS !== tmp4) {
          if (tmp5(9719).ThermalStates.CRITICAL === tmp4) {
            str2 = "critical";
            str = "text-feedback-critical";
          }
        }
