...
// Dependencies: [19, 17, 21, 4606, 4456, 576, 9656, 1611, 4602, 2]
// Exports: default

// Module 17227 (ActivitiesDebugOverlay)
...
export default function ActivitiesDebugOverlay() {
  ...
  if (useThermalState.ThermalStates.UNHANDLED !== tmp4) {
    ...
    str2 = "nominal";
    if (tmp5(9656).ThermalStates.NOMINAL !== tmp4) {
      str = "text-feedback-warning";
      str2 = "fair";
      if (tmp5(9656).ThermalStates.FAIR !== tmp4) {
        str2 = "serious";
        str = "text-feedback-critical";
        if (tmp5(9656).ThermalStates.SERIOUS !== tmp4) {
          if (tmp5(9656).ThermalStates.CRITICAL === tmp4) {
            str2 = "critical";
            str = "text-feedback-critical";
          }
        }
