...
// Dependencies: [5, 32, 19, 17, 1958, 1372, 1957, 11014, 4633, 21, 4640, 576, 504, 11140, 12283, 14610, 7282, 1370, 14612, 7570, 7796, 4338, 1115, 7303, 4337, 1478, 1612, 1364, 5719, 7984, 5712, 7491, 4582, 5212, 11143, 11154, 2]
// Exports: default

// Module 14611 (ActivityShareLinkModal)
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != first3) {
              dependencyMap = 1;
              c3 = 1;
              let obj4 = { value: Promise.all(first1.map(tmp2(11140).getOrResolveChannelIdFromDestinationId)), done: false };
              return obj4;
            } else {
              c3 = 3;
            }
          ...
          closure_128_1 = tmp2(14612).resolveActivityShareMessageContent(closure_129_3, closure_129_14, closure_129_12);
          closure_129_6(true);
                ...
                try {
                  ...
                  if (0 === c2) {
                    if (arg0 === 1) {
                      ...
                      if (null != channel) {
                        const obj2 = closure_2_1(7570);
                        const obj6 = { location: constants.ACTIVITY_SHARE };
                        c2 = 1;
                        c1 = 1;
                        const obj7 = { value: obj2.sendMessage(tmp17, closure_2_1(7796).parse(channel, c1), false, obj6), done: false };
                        return obj7;
                      }
                    }
                  } else if (arg0 === 1) {
          ...
          let obj6 = tmp3(4338);
          const result = tmp2(14610).closeActivityShareLinkModal();
          const obj9 = tmp2(14610);
        }
        c3 = 3;
