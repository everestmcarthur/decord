...
// Dependencies: [5, 32, 19, 17, 1958, 1372, 1957, 11006, 4631, 21, 4638, 576, 504, 11132, 12274, 14602, 7278, 1370, 14604, 7566, 7790, 4336, 1115, 7299, 4335, 1478, 1612, 1364, 5717, 7978, 5710, 7487, 4580, 5210, 11135, 11146, 2]
// Exports: default

// Module 14603 (ActivityShareLinkModal)
...
let UserRowModes = fn(11006).UserRowModes;
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != first3) {
              dependencyMap = 1;
              c3 = 1;
              let obj4 = { value: Promise.all(first1.map(tmp2(11132).getOrResolveChannelIdFromDestinationId)), done: false };
              return obj4;
            } else {
              c3 = 3;
            }
          ...
          closure_128_1 = tmp2(14604).resolveActivityShareMessageContent(closure_129_3, closure_129_14, closure_129_12);
          closure_129_6(true);
                ...
                try {
                  ...
                  if (0 === c2) {
                    if (arg0 === 1) {
                      ...
                      if (null != channel) {
                        const obj2 = closure_2_1(7566);
                        const obj6 = { location: constants.ACTIVITY_SHARE };
                        c2 = 1;
                        c1 = 1;
                        const obj7 = { value: obj2.sendMessage(tmp17, closure_2_1(7790).parse(channel, c1), false, obj6), done: false };
                        return obj7;
                      }
                    }
                  } else if (arg0 === 1) {
          ...
          let obj6 = tmp3(4336);
          const result = tmp2(14602).closeActivityShareLinkModal();
          const obj9 = tmp2(14602);
        }
        c3 = 3;
