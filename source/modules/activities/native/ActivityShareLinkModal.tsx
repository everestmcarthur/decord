...
// Dependencies: [5, 32, 19, 17, 1958, 1372, 1957, 11108, 4715, 21, 4722, 576, 504, 11233, 12374, 14705, 7364, 1370, 14707, 7652, 7878, 4420, 1115, 7385, 4419, 1478, 1612, 1364, 5801, 8067, 5794, 7573, 4664, 5294, 11236, 11247, 2]
// Exports: default

// Module 14706 (ActivityShareLinkModal)
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != first3) {
              dependencyMap = 1;
              c3 = 1;
              let obj4 = { value: Promise.all(first1.map(tmp2(11233).getOrResolveChannelIdFromDestinationId)), done: false };
              return obj4;
            } else {
              c3 = 3;
            }
          ...
          closure_128_1 = tmp2(14707).resolveActivityShareMessageContent(closure_129_3, closure_129_14, closure_129_12);
          closure_129_6(true);
                ...
                try {
                  ...
                  if (0 === c2) {
                    if (arg0 === 1) {
                      ...
                      if (null != channel) {
                        const obj2 = closure_2_1(7652);
                        const obj6 = { location: constants.ACTIVITY_SHARE };
                        c2 = 1;
                        c1 = 1;
                        const obj7 = { value: obj2.sendMessage(tmp17, closure_2_1(7878).parse(channel, c1), false, obj6), done: false };
                        return obj7;
                      }
                    }
                  } else if (arg0 === 1) {
          ...
          let obj6 = tmp3(4420);
          const result = tmp2(14705).closeActivityShareLinkModal();
          const obj9 = tmp2(14705);
        }
        c3 = 3;
