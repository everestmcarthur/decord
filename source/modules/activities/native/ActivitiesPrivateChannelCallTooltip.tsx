...
// Dependencies: [19, 17, 4599, 1920, 21, 4607, 504, 4343, 4608, 1178, 1114, 5027, 2]
// Exports: default

// Module 12875 (ActivitiesPrivateChannelCallTooltip)
...
export default function ActivitiesPrivateChannelCallTooltip(onClosePress) {
  ...
  const tmp2Result = num(4343);
  T.__closure = { withRepeat: num(4343).withRepeat, withSequence: num(4343).withSequence, withTiming: num(4608).withTiming, OFFSET: 40, translateBounceOffset: num, TIMING_CONFIG };
  ...
  obj6.children = jsx(num(5027).Button, { text: null, onPress: null, variant: "secondary", size: "sm", grow: true });
