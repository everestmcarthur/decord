...
// Dependencies: [19, 17, 4630, 1921, 21, 4638, 504, 4374, 4639, 1177, 1115, 5060, 2]
// Exports: default

// Module 12923 (ActivitiesPrivateChannelCallTooltip)
...
export default function ActivitiesPrivateChannelCallTooltip(onClosePress) {
  ...
  const tmp2Result = num(4374);
  T.__closure = { withRepeat: num(4374).withRepeat, withSequence: num(4374).withSequence, withTiming: num(4639).withTiming, OFFSET: 40, translateBounceOffset: num, TIMING_CONFIG };
  ...
  obj6.children = jsx(num(5060).Button, { text: null, onPress: null, variant: "secondary", size: "sm", grow: true });
