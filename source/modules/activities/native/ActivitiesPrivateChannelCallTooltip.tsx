...
// Dependencies: [19, 17, 4632, 1921, 21, 4640, 504, 4376, 4641, 1177, 1115, 5062, 2]
// Exports: default

// Module 12931 (ActivitiesPrivateChannelCallTooltip)
...
export default function ActivitiesPrivateChannelCallTooltip(onClosePress) {
  ...
  T.__closure = { withRepeat: num(4376).withRepeat, withSequence: num(4376).withSequence, withTiming: num(4641).withTiming, OFFSET: 40, translateBounceOffset: num, TIMING_CONFIG };
  ...
  obj6.children = jsx(num(5062).Button, { text: null, onPress: null, variant: "secondary", size: "sm", grow: true });
