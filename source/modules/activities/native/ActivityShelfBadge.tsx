...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 1177, 1895, 4635, 1115, 2]
// Exports: default
...
export default function ActivityShelfBadge(arg0) {
  ...
  if (labelType === Server.EmbeddedActivityLabelTypes.NEW) {
    ...
    obj.children = jsx(tmp2(4635).Text, { variant: "text-xs/semibold", style: tmp.badgeText, color: "text-overlay-light", children: null });
    ...
    if (labelType === tmp2(1895).EmbeddedActivityLabelTypes.UPDATED) {
      ...
      obj3.children = jsx(tmp2(4635).Text, { variant: "text-xs/semibold", style: tmp.badgeText, color: "text-overlay-light", children: null });
