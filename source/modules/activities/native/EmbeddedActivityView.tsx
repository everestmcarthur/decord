...
// Dependencies: [109, 32, 19, 17, 1957, 1921, 1349, 21, 4722, 9879, 1478, 573, 9881, 9882, 9884, 9877, 504, 9886, 9753, 9887, 9895, 2]

// Module 9880 (EmbeddedActivityView)
import DispatcherDefault from "Dispatcher" /* 573 */;
import EmbeddedActivitiesNativeManagerDefault from "EmbeddedActivitiesNativeManager" /* 9753 */;
import doesOrientationMatchLockStateDefault from "doesOrientationMatchLockState" /* 9881 */;
import WakeLockDefault from "WakeLock" /* 9884 */;
...
const memoResult = noop.memo(function EmbeddedActivityViewInner(portraitSafeAreasConfig) {
  ...
  const tmp4 = currentEmbeddedActivity(9877)();
  dependencyMap = tmp4;
  ...
  if (null == currentEmbeddedActivity) {
    ...
    const discordEnvQueryParams = tmp5(9882).getDiscordEnvQueryParams();
    ...
    const tmp5Result = tmp5(9882);
  }
  currentEmbeddedActivity(9886)({ connectedEmbeddedActivity: currentEmbeddedActivity });
  ...
  const obj5 = { orientationLockState: stateFromStores, showLoadingIndicator: tmp22, setShowLoadingStateForLockingOrientation: tmp9, application: tmp4, setOrientationLockState: layoutMode(9879).setOrientationLockState };
  setIsResetting = useBaseActivityView({ orientationLockState: stateFromStores, showLoadingIndicator: tmp22, setShowLoadingStateForLockingOrientation: tmp9, application: tmp4, setOrientationLockState: layoutMode(9879).setOrientationLockState }).setIsResetting;
  ...
  if (null != currentEmbeddedActivity) {
    ...
    if (null != id) {
      ...
      const tmp2Result = tmp2(9887);
      obj7.allowPopups = tmp5(9895).allowPopups(tmp4);
      obj7.isPipOrGridMode = layoutMode === constants.PIP || layoutMode === constants.GRID;
      obj7.webViewKey = tmp5(9753).EMBEDDED_ACTIVITY_WEB_VIEW_KEY;
      if (tmp26) {
