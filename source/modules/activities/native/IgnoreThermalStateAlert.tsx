...
// Dependencies: [19, 21, 4606, 5045, 1114, 9595, 4602, 2]
// Exports: IgnoreThermalStateAlert

// Module 9677 (IgnoreThermalStateAlert)
...
export const IgnoreThermalStateAlert = function IgnoreThermalStateAlert(onConfirm) {
  ...
  const items = [closure_3(onConfirm(4602).Text, obj2), ];
  ...
  items[1] = closure_3(onConfirm(4602).Text, obj3);
  obj.children = items;
