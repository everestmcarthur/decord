...
// Dependencies: [19, 21, 4639, 5078, 1115, 9636, 4635, 2]
// Exports: IgnoreThermalStateAlert

// Module 9718 (IgnoreThermalStateAlert)
...
export const IgnoreThermalStateAlert = function IgnoreThermalStateAlert(onConfirm) {
  ...
  const items = [closure_3(onConfirm(4635).Text, obj2), ];
  ...
  items[1] = closure_3(onConfirm(4635).Text, obj3);
  obj.children = items;
