...
// Dependencies: [5, 1957, 1371, 9542, 9539, 9519, 9554, 9509, 2]
// Exports: default

// Module 9553 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = closure_1_1(9542)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
