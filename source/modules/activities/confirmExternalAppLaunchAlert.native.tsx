...
// Dependencies: [19, 17, 1920, 21, 4606, 9635, 4602, 1114, 5026, 4301, 4950, 2]
// Exports: confirmExternalAppLaunchAlert

// Module 9634 (confirmExternalAppLaunchAlert)
...
import _modDef9635 from "module_9635" /* 9635 */;
...
function ConfirmActivityGateContent(activityName) {
  ...
  const items = [timestampProducer(React3, { source: _modDef9635, style: tmp.announcementBirb }), , , ];
