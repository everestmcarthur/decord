...
// Dependencies: [19, 17, 4632, 9809, 1958, 1957, 1921, 9659, 17263, 1074, 12425, 21, 1177, 4640, 576, 1612, 504, 1478, 17258, 11508, 4376, 17264, 4350, 4641, 5061, 17265, 17266, 1115, 6766, 4268, 17260, 9786, 2]
// Exports: useBaseActivityPanelPIPView

// Module 17262 (ActivityPanelPIPView)
...
let closure_15 = fn(17263).DEFAULT_PORTRAIT_LETTERBOX_CONFIG;
const ThemeTypes = fn(1074).ThemeTypes;
const PIP_WINDOW_OFFSET = fn(12425).PIP_WINDOW_OFFSET;
const jsx = fn(21).jsx;
