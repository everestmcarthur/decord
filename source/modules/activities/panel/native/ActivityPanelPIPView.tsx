...
// Dependencies: [19, 17, 4630, 9798, 1958, 1957, 1921, 9648, 17223, 1074, 12416, 21, 1177, 4638, 576, 1612, 504, 1478, 17218, 11500, 4374, 17224, 4348, 4639, 5059, 17225, 17226, 1115, 6763, 4266, 17220, 9775, 2]
// Exports: useBaseActivityPanelPIPView

// Module 17222 (ActivityPanelPIPView)
...
let closure_15 = fn(17223).DEFAULT_PORTRAIT_LETTERBOX_CONFIG;
const ThemeTypes = fn(1074).ThemeTypes;
const PIP_WINDOW_OFFSET = fn(12416).PIP_WINDOW_OFFSET;
const jsx = fn(21).jsx;
