...
// Dependencies: [5, 1957, 1956, 1074, 9628, 9616, 573, 4507, 4235, 9631, 9605, 9632, 8946, 9634, 2]
// Exports: confirmActivityLaunchChecks

// Module 9630 (confirmActivityLaunchChecks)
      ...
      new Promise((fn) => {
        ...
        if (null != value) {
          if (null != channel) {
            ...
            shouldClosePopout(9631)(tmp, channel, () => {
