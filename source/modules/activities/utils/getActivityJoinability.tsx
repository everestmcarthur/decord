...
// Dependencies: [1074, 11903, 11900, 9674, 9645, 7423, 13182, 1364, 11897, 11898, 11899, 2]
// Exports: default
    ...
    if (null == user) {
      ...
      if (obj4.hasPartySize(partySize)) {
        if (!tmp27Result.isPartyFull(partySize)) {
          ...
          if (tmp30(7423)(activity, tmp31.PARTY_PRIVACY_VOICE_CHANNEL)) {
