...
// Dependencies: [1074, 11912, 11909, 9685, 9656, 7427, 13190, 1364, 11906, 11907, 11908, 2]
// Exports: default
    ...
    if (null == user) {
      ...
      if (obj4.hasPartySize(partySize)) {
        if (!tmp27Result.isPartyFull(partySize)) {
          ...
          if (tmp30(7427)(activity, tmp31.PARTY_PRIVACY_VOICE_CHANNEL)) {
