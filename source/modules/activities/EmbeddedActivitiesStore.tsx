...
// Dependencies: [32, 502, 1957, 2011, 1371, 1920, 9575, 1074, 9549, 9550, 4233, 9582, 14060, 1109, 9604, 573, 9598, 9480, 1115, 1894, 7575, 504, 2]
...
import ContentClassificationEmbeddedActivityFilterExperiment2 from "ContentClassificationEmbeddedActivityFilterExperiment" /* 9549 */;
import ContentClassificationReference from "ContentClassificationReference" /* 9550 */;
import getURLForApplicationDefault from "getURLForApplication" /* 9582 */;
...
const isVoiceEmbeddedActivityDefault = combined(9598);
require = fn;
...
function updateEmbeddedActivities(content_classification) {
  ...
  if (null != tmp3) {
    const embeddedActivityLocationChannelId = application_id(4233).getEmbeddedActivityLocationChannelId(_location);
    ...
    const obj19 = application_id(4233);
      ...
      if (_location.id === value9.location.id) {
        if (application_id === value9.applicationId) {
          if (someResult) {
            ...
            const embeddedActivityLocationChannelId1 = tmp76(4233).getEmbeddedActivityLocationChannelId(_location);
            if (null != embeddedActivityLocationChannelId1) {
              ...
              let str5 = tmp76(4233).getEmbeddedActivityLocationGuildId(_location);
              if (str5 == null) {
                str5 = "0";
              }
              ...
              obj17 = map1;
              obj22 = map2;
              const tmp76Result4 = tmp76(4233);
            }
            const tmp76Result = tmp76(4233);
          } else {
            const _Array = Array;
            const arr = Array.from(value9.userIds);
          }
          obj5.delete(value9.applicationId);
          const ComponentDispatch = tmp76(1109).ComponentDispatch;
      ...
      if (sessionId === obj4.getSessionId()) {
        ...
        if (null != tmp36) {
          if (null != obj4.getSessionId()) {
            ...
            if (id1 !== _location.id) {
              const embeddedActivityLocationChannelId2 = tmp76(4233).getEmbeddedActivityLocationChannelId(_location);
    ...
    obj6 = map4;
    const someResult1 = mapped.some((item) => application_id(14060).isActivityParticipantCurrentUserCurrentSession(item));
  }
}
