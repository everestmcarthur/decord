...
// Dependencies: [32, 502, 1958, 2012, 1372, 1921, 9659, 1074, 9633, 9634, 4268, 9666, 14099, 1110, 9688, 573, 9682, 9564, 1364, 1895, 7637, 504, 2]
...
const isVoiceEmbeddedActivityDefault = combined(9682);
require = fn;
...
function updateEmbeddedActivities(content_classification) {
  ...
  if (null != tmp3) {
    ...
    obj6 = map4;
    const someResult1 = mapped.some((item) => application_id(14099).isActivityParticipantCurrentUserCurrentSession(item));
  }
}
