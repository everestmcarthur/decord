...
// Dependencies: [32, 502, 1958, 2012, 1372, 1921, 9637, 1074, 9611, 9612, 4268, 9644, 14078, 1110, 9666, 573, 9660, 9542, 1364, 1895, 7630, 504, 2]

// Module 1957 (EmbeddedActivitiesStore)
...
import ContentClassificationEmbeddedActivityFilterExperiment2 from "ContentClassificationEmbeddedActivityFilterExperiment" /* 9611 */;
import ContentClassificationReference from "ContentClassificationReference" /* 9612 */;
...
const isVoiceEmbeddedActivityDefault = combined(9660);
require = fn;
...
function updateEmbeddedActivities(content_classification) {
  ...
  if (null != tmp3) {
    const embeddedActivityLocationChannelId = application_id(4268).getEmbeddedActivityLocationChannelId(_location);
    ...
    const obj19 = application_id(4268);
      ...
      if (_location.id === value9.location.id) {
        if (application_id === value9.applicationId) {
          if (someResult) {
            ...
            const embeddedActivityLocationChannelId1 = tmp76(4268).getEmbeddedActivityLocationChannelId(_location);
            if (null != embeddedActivityLocationChannelId1) {
              ...
              let str5 = tmp76(4268).getEmbeddedActivityLocationGuildId(_location);
              if (str5 == null) {
                str5 = "0";
              }
              ...
              obj17 = map1;
              obj22 = map2;
              const tmp76Result4 = tmp76(4268);
            }
            const tmp76Result = tmp76(4268);
          } else {
            const _Array = Array;
      ...
      if (sessionId === obj4.getSessionId()) {
        ...
        if (null != tmp36) {
          if (null != obj4.getSessionId()) {
            ...
            if (id1 !== _location.id) {
              const embeddedActivityLocationChannelId2 = tmp76(4268).getEmbeddedActivityLocationChannelId(_location);
    ...
    obj6 = map4;
    const someResult1 = mapped.some((item) => application_id(14078).isActivityParticipantCurrentUserCurrentSession(item));
  }
}
...
let layout = fn(1921).ActivityPopoutWindowLayouts.NORMAL;
