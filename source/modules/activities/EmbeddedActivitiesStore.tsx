...
// Dependencies: [32, 502, 1958, 2012, 1372, 1921, 9648, 1074, 9622, 9623, 4266, 9655, 14091, 1110, 9677, 573, 9671, 9553, 1364, 1895, 7633, 504, 2]
...
import ContentClassificationEmbeddedActivityFilterExperiment2 from "ContentClassificationEmbeddedActivityFilterExperiment" /* 9622 */;
import ContentClassificationReference from "ContentClassificationReference" /* 9623 */;
import getURLForApplicationDefault from "getURLForApplication" /* 9655 */;
...
const isVoiceEmbeddedActivityDefault = combined(9671);
require = fn;
...
function updateEmbeddedActivities(content_classification) {
  ...
  if (null != tmp3) {
    const embeddedActivityLocationChannelId = application_id(4266).getEmbeddedActivityLocationChannelId(_location);
    ...
    const obj19 = application_id(4266);
      ...
      if (_location.id === value9.location.id) {
        if (application_id === value9.applicationId) {
          if (someResult) {
            ...
            const embeddedActivityLocationChannelId1 = tmp76(4266).getEmbeddedActivityLocationChannelId(_location);
            if (null != embeddedActivityLocationChannelId1) {
              ...
              let str5 = tmp76(4266).getEmbeddedActivityLocationGuildId(_location);
              if (str5 == null) {
                str5 = "0";
              }
              ...
              obj17 = map1;
              obj22 = map2;
              const tmp76Result4 = tmp76(4266);
            }
            const tmp76Result = tmp76(4266);
          } else {
            const _Array = Array;
      ...
      if (sessionId === obj4.getSessionId()) {
        ...
        if (null != tmp36) {
          if (null != obj4.getSessionId()) {
            ...
            if (id1 !== _location.id) {
              const embeddedActivityLocationChannelId2 = tmp76(4266).getEmbeddedActivityLocationChannelId(_location);
    ...
    obj6 = map4;
    const someResult1 = mapped.some((item) => application_id(14091).isActivityParticipantCurrentUserCurrentSession(item));
  }
}
