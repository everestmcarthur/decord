...
// Dependencies: [5, 4656, 1962, 502, 1958, 4663, 2012, 1372, 9673, 1957, 1074, 9564, 1364, 1271, 4268, 9674, 9675, 1241, 9661, 9677, 9678, 4841, 1255, 1926, 9449, 9679, 9680, 1899, 1110, 573, 9682, 9666, 7277, 9656, 1115, 9683, 9658, 9684, 9702, 1895, 7296, 2]
// Exports: getActiveAnalyticsSessionIDs, trackFrameSessionEnd, trackFrameSessionStart, trackFrameSessionStartFailed

// Module 9672 (EmbeddedActivitiesManager)
...
import getShelfItemDataDefault from "getShelfItemData" /* 9674 */;
import ThermalUtilsDefault from "ThermalUtils" /* 9675 */;
import pendingFrameLaunch from "pendingFrameLaunch" /* 9678 */;
import activityLaunchErrorUtils from "activityLaunchErrorUtils" /* 9680 */;
...
import ActivityShelfStore from "ActivityShelfStore" /* 9673 */;
          ...
          if (null != currentUser) {
            ...
            if (tmp55 != null) {
              ...
              if (activity != null) {
                ...
                release_phase = activity.client_platform_config[tmp54(9564)(undefined, tmp4Result14.getOS(tmp4Result14))].release_phase;
                const tmp54Result = tmp54(9564);
              }
            }
            ...
            if (null != channel) {
              commandContextType = tmp4(9449).computeCommandContextType(channel, applicationId);
              const tmp4Result16 = tmp4(9449);
            }
  ...
  if (null != tmp4) {
    ...
    if (null != currentUser) {
      ...
      if (locationKind == null) {
        if (null != channel) {
          if (null != guildId) {
            let PRIVATE_CHANNEL = tmp2(9679).EmbeddedActivityLocationKind.GUILD_CHANNEL;
          } else {
            PRIVATE_CHANNEL = tmp2(9679).EmbeddedActivityLocationKind.PRIVATE_CHANNEL;
          }
        }
      }
      const mediaSessionId = RTCConnectionStore.getMediaSessionId();
      ...
      if (tmp27 != null) {
        ...
        if (activity != null) {
          ...
          release_phase = activity.client_platform_config[tmp26(9564)(undefined, tmp2Result3.getOS(tmp2Result3))].release_phase;
          const tmp26Result = tmp26(9564);
        }
      }
      ...
      let commandContextType = null;
      if (null != channel) {
        commandContextType = tmp2(9449).computeCommandContextType(channel, applicationId);
        const tmp2Result4 = tmp2(9449);
      }
    ...
    if (null != currentUser) {
      ...
      if (tmp13 != null) {
        ...
        if (activity != null) {
          ...
          release_phase = activity.client_platform_config[tmp11(9564)(undefined, obj2.getOS(obj2))].release_phase;
          const tmp11Result = tmp11(9564);
        }
      }
      const rawThermalState = ThermalUtilsDefault.getRawThermalState();
      let diff = null;
