...
// Module 17769 (CreatorMonetizationEligibilityConstants)
...
export const CreatorMonetizationOnboardingMarketingSection = { HOW_IT_WORKS: "HOW_IT_WORKS", BENEFITS: "BENEFITS", OTHER_CREATORS: "OTHER_CREATORS" };
