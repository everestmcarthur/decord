...
// Function ID: 12479
// Name: DiceRollBar
// Dependencies: [19, 17, 4599, 12054, 21, 4607, 576, 504, 4343, 4608, 1178, 12479, 8926, 4603, 2]
// Exports: default

// Module 12478 (DiceRollBar)
...
const useDiceRollState = fn(12054).useDiceRollState;
const jsxProd = fn(21);
