...
// Function ID: 12627
// Name: DiceRollBar
// Dependencies: [19, 17, 4714, 12201, 21, 4722, 576, 504, 4458, 4723, 1177, 12627, 9073, 4718, 2]
// Exports: default

// Module 12626 (DiceRollBar)
...
const useDiceRollState = fn(12201).useDiceRollState;
const jsxProd = fn(21);
