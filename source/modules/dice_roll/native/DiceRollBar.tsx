...
// Function ID: 12454
// Name: DiceRollBar
// Dependencies: [19, 17, 4597, 12029, 21, 4605, 576, 504, 4341, 4606, 1178, 12454, 8903, 4601, 2]
// Exports: default

// Module 12453 (DiceRollBar)
...
const useDiceRollState = fn(12029).useDiceRollState;
const jsxProd = fn(21);
