...
// Dependencies: [32, 19, 17, 11624, 1954, 21, 4574, 11622, 11629, 11625, 7402, 1943, 1114, 1178, 10063, 8695, 576, 11621, 11159, 2]
// Exports: default
...
export default function GroupDMNitroCapCoachmark(channelId) {
  ...
  obj3.acquisitionStrategy = channelId(11622).GroupDMNitroAcquisitionStrategy.MARKETING;
  const tmp7Result = _location(11629)(obj3);
