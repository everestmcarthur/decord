...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 1364, 11741, 4341, 1115, 4636, 8817, 12339, 2]
// Exports: default

// Module 17003 (GroupDMRecipientLimitTitle)
...
export default function GroupDMRecipientLimitTitle(arg0) {
  ...
  if (tmp9) {
    ...
    tmp15Result = tmp15(tmp2(8817).NitroWheelIcon, obj7);
  }
