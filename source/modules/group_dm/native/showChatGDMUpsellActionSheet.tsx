...
// Dependencies: [4605, 11745, 1897, 2]
// Exports: default

// Module 11744 (showChatGDMUpsellActionSheet)
...
export default function showChatGDMUpsellActionSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11745, dependencyMap.paths), "ChatGDMUpsellActionSheet", arg0);
};
