...
// Dependencies: [19, 17, 21, 4638, 576, 1612, 4458, 1944, 4605, 7260, 5673, 11746, 5060, 1115, 6735, 4634, 11747, 4580, 2]
// Exports: default

// Module 11745 (ChatGDMUpsellActionSheet)
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  const obj3 = { source: _modDef11746, resizeMode: "contain" };
  ...
  const items2 = [closure_5(onClick(5060).Button, obj6), ];
  ...
  obj7.children = closure_5(onClick(5060).Button, obj8);
  ...
  const items3 = [closure_5(onClick(4634).Text, obj10), , ];
  ...
  items3[1] = closure_5(onClick(4634).Text, obj11);
  ...
  const items4 = [closure_5(View, { style: tmp.item, children: closure_5(onClick(11747).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = closure_5(onClick(4634).Text, obj15);
  obj13.children = items4;
  const items5 = [closure_6(View, obj13), ];
  const obj16 = { style: tmp.secondInnerContainer, children: null };
  const obj14 = { style: tmp.item, children: closure_5(onClick(11747).TimerIcon, { size: "sm" }) };
  const items6 = [closure_5(View, { style: tmp.item, children: closure_5(onClick(4580).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = closure_5(onClick(4634).Text, obj18);
  obj16.children = items6;
  items5[1] = closure_6(View, obj16);
  obj12.children = items5;
  items3[2] = closure_6(View, obj12);
  obj9.children = items3;
  obj.children = closure_6(onClick(6735).BottomSheetScrollView, obj9);
  return closure_5(onClick(7260).BottomSheet, obj);
};
