...
// Dependencies: [19, 17, 21, 4607, 576, 1611, 4427, 1943, 4574, 7224, 5639, 11699, 5027, 1114, 6699, 4603, 11700, 4550, 2]
// Exports: default

// Module 11698 (ChatGDMUpsellActionSheet)
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  const obj3 = { source: _modDef11699, resizeMode: "contain" };
  ...
  const items2 = [closure_5(onClick(5027).Button, obj6), ];
  ...
  obj7.children = closure_5(onClick(5027).Button, obj8);
  ...
  const items3 = [closure_5(onClick(4603).Text, obj10), , ];
  ...
  items3[1] = closure_5(onClick(4603).Text, obj11);
  ...
  const items4 = [closure_5(View, { style: tmp.item, children: closure_5(onClick(11700).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = closure_5(onClick(4603).Text, obj15);
  obj13.children = items4;
  const items5 = [closure_6(View, obj13), ];
  const obj16 = { style: tmp.secondInnerContainer, children: null };
  const obj14 = { style: tmp.item, children: closure_5(onClick(11700).TimerIcon, { size: "sm" }) };
  const items6 = [closure_5(View, { style: tmp.item, children: closure_5(onClick(4550).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = closure_5(onClick(4603).Text, obj18);
  obj16.children = items6;
  items5[1] = closure_6(View, obj16);
  obj12.children = items5;
  items3[2] = closure_6(View, obj12);
  obj9.children = items3;
  obj.children = closure_6(onClick(6699).BottomSheetScrollView, obj9);
  return closure_5(onClick(7224).BottomSheet, obj);
};
