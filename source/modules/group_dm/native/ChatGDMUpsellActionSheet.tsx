...
// Dependencies: [19, 17, 21, 4640, 576, 1612, 4460, 1944, 4607, 7264, 5675, 11754, 5062, 1115, 6738, 4636, 11755, 4582, 2]
// Exports: default

// Module 11753 (ChatGDMUpsellActionSheet)
...
import _modDef11754 from "module_11754" /* 11754 */;
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  const obj3 = { source: _modDef11754, resizeMode: "contain" };
  ...
  const items2 = [closure_5(onClick(5062).Button, obj6), ];
  ...
  obj7.children = closure_5(onClick(5062).Button, obj8);
  ...
  const items3 = [closure_5(onClick(4636).Text, obj10), , ];
  ...
  items3[1] = closure_5(onClick(4636).Text, obj11);
  ...
  const items4 = [closure_5(View, { style: tmp.item, children: closure_5(onClick(11755).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = closure_5(onClick(4636).Text, obj15);
  obj13.children = items4;
  const items5 = [closure_6(View, obj13), ];
  const obj16 = { style: tmp.secondInnerContainer, children: null };
  const obj14 = { style: tmp.item, children: closure_5(onClick(11755).TimerIcon, { size: "sm" }) };
  const items6 = [closure_5(View, { style: tmp.item, children: closure_5(onClick(4582).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = closure_5(onClick(4636).Text, obj18);
  obj16.children = items6;
  items5[1] = closure_6(View, obj16);
  obj12.children = items5;
  items3[2] = closure_6(View, obj12);
  obj9.children = items3;
  obj.children = closure_6(onClick(6738).BottomSheetScrollView, obj9);
  return closure_5(onClick(7264).BottomSheet, obj);
};
