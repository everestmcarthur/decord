...
// Dependencies: [19, 17, 4632, 11743, 1074, 21, 4640, 576, 504, 11741, 1241, 4607, 11747, 10117, 11748, 7264, 4636, 1115, 5062, 8817, 2]
// Exports: default

// Module 11746 (GroupDMNitroCapLimitSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4607 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 10117 */;
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11747 */;
import useGroupDMNitroUpsellActionDefault from "useGroupDMNitroUpsellAction" /* 11748 */;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  const groupDMNitroAudience = _location(11741).useGroupDMNitroAudience();
  importDefault = tmp6;
  ...
  let obj2 = _location(11741);
  let obj3 = noop;
  obj4.acquisitionStrategy = _location(11741).GroupDMNitroAcquisitionStrategy.CHECKOUT;
  ...
  const items3 = [closure_11(_location(4636).Text, obj6), , ];
  ...
  items3[1] = closure_11(_location(4636).Text, obj8);
  ...
  obj11.text = intl3.string(_location(11741).getGroupDMNitroCapCTAMessage(groupDMNitroAudience));
  const tmp2Result = _location(11741);
  obj11.icon = closure_11(_location(8817).NitroWheelIcon, { style: tmp.nitroWheelIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: "custom" });
  ...
  obj11.onPress = tmp16;
  const items4 = [closure_11(_location(5062).Button, obj11), ];
  ...
  items4[1] = closure_11(_location(5062).Button, obj14);
  obj10.children = items4;
  items3[2] = closure_12(View, obj10);
  obj5.children = items3;
  obj13.children = closure_12(View, obj5);
  return closure_11(_location(7264).BottomSheet, obj13);
};
