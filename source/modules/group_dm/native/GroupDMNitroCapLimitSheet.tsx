...
// Dependencies: [19, 17, 4597, 11664, 1074, 21, 4605, 576, 504, 11662, 1242, 4572, 11668, 10037, 11669, 7202, 4601, 1114, 5025, 8732, 2]
// Exports: default

// Module 11667 (GroupDMNitroCapLimitSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4572 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 10037 */;
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11668 */;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  const groupDMNitroAudience = _location(11662).useGroupDMNitroAudience();
  importDefault = tmp6;
  ...
  let obj2 = _location(11662);
  let obj3 = noop;
  obj4.acquisitionStrategy = _location(11662).GroupDMNitroAcquisitionStrategy.CHECKOUT;
  ...
  const items3 = [closure_11(_location(4601).Text, obj6), , ];
  ...
  items3[1] = closure_11(_location(4601).Text, obj8);
  ...
  obj11.text = intl3.string(_location(11662).getGroupDMNitroCapCTAMessage(groupDMNitroAudience));
  const tmp2Result = _location(11662);
  obj11.icon = closure_11(_location(8732).NitroWheelIcon, { style: tmp.nitroWheelIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: "custom" });
  ...
  obj11.onPress = tmp16;
  const items4 = [closure_11(_location(5025).Button, obj11), ];
  ...
  items4[1] = closure_11(_location(5025).Button, obj14);
  obj10.children = items4;
  items3[2] = closure_12(View, obj10);
  obj5.children = items3;
  obj13.children = closure_12(View, obj5);
  return closure_11(_location(7202).BottomSheet, obj13);
};
