...
// Dependencies: [1372, 11735, 1074, 1374, 1886, 11736, 2]
// Exports: default

// Module 11734 (getGroupDMRecipientLimit)
import PremiumTypeUtils from "PremiumTypeUtils" /* 1886 */;
import UserStore from "UserStore" /* 1372 */;

require = fn;
let closure_3 = fn(11735).MAX_GROUP_DM_NITRO_PARTICIPANTS;
