...
// Dependencies: [9880, 1115, 2]
// Exports: default

// Module 9879 (getAppChannelApplicationUnsupportedText)
import GuildEmbeddedApplicationUnsupportedReason from "GuildEmbeddedApplicationUnsupportedReason" /* 9880 */;
...
export default function getAppChannelApplicationUnsupportedText(supported) {
  if (!supported.supported) {
    ...
    } else if (tmp(9880).GuildEmbeddedApplicationUnsupportedReason.SURFACE_NOT_SUPPORTED === reason) {
