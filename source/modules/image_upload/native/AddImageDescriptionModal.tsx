...
// Dependencies: [32, 19, 17, 4980, 4979, 21, 4639, 576, 504, 1478, 1484, 7088, 11285, 7969, 1115, 9439, 11377, 7192, 11060, 2]
// Exports: default

// Module 11378 (AddImageDescriptionModal)
    ...
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = channelId(stateFromStores[13]).getRenderHeaderTextButton(intl.string(channelId(stateFromStores[14]).t["R3BPH+"]), () => {
          ...
          id(9439).update(closure_1_0, closure_1_1, ChannelMessage.ChannelMessage, obj2);
          const obj = id(9439);
          id(11377).close();
        });
