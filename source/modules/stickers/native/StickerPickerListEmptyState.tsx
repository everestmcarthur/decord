...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 10469, 6738, 1177, 1115, 10567, 2]

// Module 10566 (StickerPickerListEmptyState)
...
export default noop.memo(function StickerPickerListEmptyState(insetBottom) {
  ...
  const tmp = closure_7();
  const modalDismissGuardRefreshControl = insetTop(10469).useModalDismissGuardRefreshControl();
  if (inActionSheet) {
    let BottomSheetScrollView = tmp3(6738).BottomSheetScrollView;
  } else {
