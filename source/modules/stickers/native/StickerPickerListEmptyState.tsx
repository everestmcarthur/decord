...
// Dependencies: [19, 17, 1074, 21, 4607, 576, 10412, 6699, 1178, 1114, 10509, 2]

// Module 10508 (StickerPickerListEmptyState)
...
export default noop.memo(function StickerPickerListEmptyState(insetBottom) {
  ...
  const tmp = closure_7();
  const modalDismissGuardRefreshControl = insetTop(10412).useModalDismissGuardRefreshControl();
  if (inActionSheet) {
