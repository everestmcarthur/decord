...
// Dependencies: [1074, 1242, 4574, 10486, 1896, 2]
// Exports: default

// Module 10485 (openStickerPackDetailActionSheet)
...
export default function openStickerPackDetailActionSheet(stickerPack) {
  ...
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10486, dependencyMap.paths), "StickerPackDetailActionSheet", { stickerPack, analyticsPopoutType });
};
