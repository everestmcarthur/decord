...
// Dependencies: [1074, 1241, 4606, 10527, 1897, 2]
// Exports: default

// Module 10526 (openStickerPackDetailActionSheet)
...
export default function openStickerPackDetailActionSheet(stickerPack) {
  ...
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10527, dependencyMap.paths), "StickerPackDetailActionSheet", { stickerPack, analyticsPopoutType });
};
