...
// Dependencies: [1074, 1242, 4573, 10484, 1896, 2]
// Exports: default

// Module 10483 (openStickerPackDetailActionSheet)
...
export default function openStickerPackDetailActionSheet(stickerPack) {
  ...
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10484, dependencyMap.paths), "StickerPackDetailActionSheet", { stickerPack, analyticsPopoutType });
};
