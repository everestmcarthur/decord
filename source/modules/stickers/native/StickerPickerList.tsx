...
// Dependencies: [32, 19, 17, 5587, 10522, 10404, 21, 4639, 576, 1177, 10547, 4635, 1115, 10438, 5353, 4376, 10454, 10422, 504, 10548, 10437, 10549, 10533, 12, 7169, 10550, 7162, 5664, 10445, 10459, 7958, 2]

// Module 10546 (StickerPickerList)
...
import StickerPickerListRowDefault from "StickerPickerListRow" /* 10533 */;
import _modDef10547 from "module_10547" /* 10547 */;
import useStickerPickerListData from "useStickerPickerListData" /* 10548 */;
import StickerPickerPremiumSearchUpsellDefault from "StickerPickerPremiumSearchUpsell" /* 10549 */;
...
let closure_15 = noop.memo((height) => {
  ...
  obj.style = items;
  const items1 = [closure_1_11(native.Icon, { source: _modDef10547, size: native.Icon.Sizes.SMALL }), ];
...
export default noop.memo((bottomSheetRef) => {
  ...
  const callback4 = obj.useCallback((arg0, arg1) => {
    if (null == rowsBySection[arg0]) {
      ...
      } else if (tmp21(10548).StickerPickerSectionType.NSFW === type) {
        tmp2 = closure_2_11;
      ...
      if (true === sectionNitroLocked[arg0]) {
        ...
        const items = [tmp2(tmp21(10438).PremiumUpsellGradientBackground, {}), tmp5];
        obj3.children = items;
