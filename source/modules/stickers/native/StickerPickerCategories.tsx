...
// Dependencies: [32, 19, 17, 1980, 10538, 1074, 1218, 21, 4640, 576, 1936, 4979, 5356, 1241, 5210, 1177, 1397, 5672, 10322, 5182, 4608, 4609, 10506, 10507, 7169, 1115, 10569, 2]
// Exports: default

// Module 10568 (StickerPickerCategories)
...
let useStickerPickerStore = fn(10538).useStickerPickerStore;
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(10506)();
  const tmp20 = closure_15;
  const items9 = [closure_14(categoryIndex(7169), { estimatedListSize: "windowSize", horizontal: true, itemSize: EXPRESSION_FOOTER_HEIGHT, keyboardShouldPersistTaps: "always", listId: ExpressionPickerViewType.STICKER, onLayout: callback4, onScroll: callback1, placeholderConfig: tmp19, ref, scrollReporting: "callbacks", sections: memo, renderItem: callback5, showsHorizontalScrollIndicator: false, style: tmp.list }), ];
  ...
  if (tmp22Result) {
    ...
    obj4.style = items10;
    const obj5 = { style: tmp.guildIcon, source: tmp17(10569) };
    obj4.children = tmp22(categories(1177).Icon, obj5);
    obj3.children = tmp22(closure_5, obj4);
    tmp22Result = tmp22(categories(5210).PressableOpacity, obj3);
  }
  items9[1] = tmp22Result;
  obj.children = items9;
  return tmp20(categoryIndex(10507), obj);
};
