...
// Dependencies: [32, 19, 17, 1980, 10522, 1074, 1218, 21, 4639, 576, 1936, 4978, 5353, 1241, 5207, 1177, 1397, 5669, 10306, 5179, 4607, 4608, 10490, 10491, 7162, 1115, 10553, 2]
// Exports: default

// Module 10552 (StickerPickerCategories)
...
export default function _default(categories) {
  ...
  const items9 = [closure_14(categoryIndex(7162), { estimatedListSize: "windowSize", horizontal: true, itemSize: EXPRESSION_FOOTER_HEIGHT, keyboardShouldPersistTaps: "always", listId: ExpressionPickerViewType.STICKER, onLayout: callback4, onScroll: callback1, placeholderConfig: tmp19, ref, scrollReporting: "callbacks", sections: memo, renderItem: callback5, showsHorizontalScrollIndicator: false, style: tmp.list }), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(5207).PressableOpacity, obj3);
  }
  items9[1] = tmp22Result;
  obj.children = items9;
  return tmp20(categoryIndex(10491), obj);
};
