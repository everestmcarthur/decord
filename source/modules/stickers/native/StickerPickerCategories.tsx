...
// Dependencies: [32, 19, 17, 1979, 10460, 1074, 1219, 21, 4605, 576, 1935, 4944, 5318, 1242, 5173, 1178, 1396, 5634, 10246, 5145, 4573, 4574, 10428, 10429, 7107, 1114, 10490, 2]
// Exports: default
...
export default function _default(categories) {
  ...
  const items9 = [closure_14(categoryIndex(7107), { estimatedListSize: "windowSize", horizontal: true, itemSize: EXPRESSION_FOOTER_HEIGHT, keyboardShouldPersistTaps: "always", listId: ExpressionPickerViewType.STICKER, onLayout: callback4, onScroll: callback1, placeholderConfig: tmp19, ref, scrollReporting: "callbacks", sections: memo, renderItem: callback5, showsHorizontalScrollIndicator: false, style: tmp.list }), ];
  ...
  if (tmp22Result) {
    ...
    obj4.style = items10;
    const obj5 = { style: tmp.guildIcon, source: tmp17(10490) };
    obj4.children = tmp22(categories(1178).Icon, obj5);
    obj3.children = tmp22(closure_5, obj4);
    tmp22Result = tmp22(categories(5173).PressableOpacity, obj3);
  }
  items9[1] = tmp22Result;
  obj.children = items9;
  return tmp20(categoryIndex(10429), obj);
};
