...
// Dependencies: [32, 19, 17, 1980, 10530, 1074, 1218, 21, 4638, 576, 1936, 4977, 5354, 1241, 5208, 1177, 1397, 5670, 10314, 5180, 4606, 4607, 10498, 10499, 7165, 1115, 10561, 2]
// Exports: default

// Module 10560 (StickerPickerCategories)
...
let useStickerPickerStore = fn(10530).useStickerPickerStore;
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(10498)();
  const tmp20 = closure_15;
  const items9 = [closure_14(categoryIndex(7165), { estimatedListSize: "windowSize", horizontal: true, itemSize: EXPRESSION_FOOTER_HEIGHT, keyboardShouldPersistTaps: "always", listId: ExpressionPickerViewType.STICKER, onLayout: callback4, onScroll: callback1, placeholderConfig: tmp19, ref, scrollReporting: "callbacks", sections: memo, renderItem: callback5, showsHorizontalScrollIndicator: false, style: tmp.list }), ];
  ...
  if (tmp22Result) {
    ...
    obj4.style = items10;
    const obj5 = { style: tmp.guildIcon, source: tmp17(10561) };
    obj4.children = tmp22(categories(1177).Icon, obj5);
    obj3.children = tmp22(closure_5, obj4);
    tmp22Result = tmp22(categories(5208).PressableOpacity, obj3);
  }
  items9[1] = tmp22Result;
  obj.children = items9;
  return tmp20(categoryIndex(10499), obj);
};
