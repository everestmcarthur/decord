...
// Dependencies: [19, 17, 10364, 21, 4607, 576, 4603, 4946, 1178, 10488, 10489, 1114, 10490, 5175, 2]

// Module 10487 (StickerPackHeader)
...
import StickerPackBannerDefault from "StickerPackBanner" /* 10490 */;
...
export default noop.memo((withDescription) => {
  ...
  if (result) {
    ...
    const obj6 = { source: _modDef10488, style: tmp.animatedIcon, size: tmp6(1178).Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color };
  ...
  obj7.children = React4(native.Icon, { source: _modDef10489, style: tmp.premiumIcon, size: native.Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color });
  ...
  if (null != onPress) {
    ...
    let tmp4Result = tmp4(tmp6(5175).PressableOpacity, obj15);
  } else {
