...
// Dependencies: [19, 17, 10362, 21, 4606, 576, 4602, 4945, 1178, 10486, 10487, 1114, 10488, 5174, 2]
...
export default noop.memo((withDescription) => {
  ...
  if (result) {
    ...
    const obj6 = { source: _modDef10486, style: tmp.animatedIcon, size: tmp6(1178).Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color };
  ...
  obj7.children = React4(native.Icon, { source: _modDef10487, style: tmp.premiumIcon, size: native.Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color });
  ...
  if (null != onPress) {
    ...
    let tmp4Result = tmp4(tmp6(5174).PressableOpacity, obj15);
  } else {
