...
// Dependencies: [19, 17, 10404, 21, 4639, 576, 4635, 4978, 1177, 10529, 10530, 1115, 10531, 5207, 2]

// Module 10528 (StickerPackHeader)
...
import StickerPackBannerDefault from "StickerPackBanner" /* 10531 */;
...
export default noop.memo((withDescription) => {
  ...
  if (result) {
    ...
    const obj6 = { source: _modDef10529, style: tmp.animatedIcon, size: tmp6(1177).Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color };
  ...
  obj7.children = React4(native.Icon, { source: _modDef10530, style: tmp.premiumIcon, size: native.Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color });
  ...
  if (null != onPress) {
    ...
    let tmp4Result = tmp4(tmp6(5207).PressableOpacity, obj15);
  } else {
