...
// Dependencies: [19, 17, 10412, 21, 4638, 576, 4634, 4977, 1177, 10537, 10538, 1115, 10539, 5208, 2]

// Module 10536 (StickerPackHeader)
...
import StickerPackBannerDefault from "StickerPackBanner" /* 10539 */;
...
export default noop.memo((withDescription) => {
  ...
  if (result) {
    ...
    const obj6 = { source: _modDef10537, style: tmp.animatedIcon, size: tmp6(1177).Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color };
  ...
  obj7.children = React4(native.Icon, { source: _modDef10538, style: tmp.premiumIcon, size: native.Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color });
  ...
  if (null != onPress) {
    ...
    let tmp4Result = tmp4(tmp6(5208).PressableOpacity, obj15);
  } else {
