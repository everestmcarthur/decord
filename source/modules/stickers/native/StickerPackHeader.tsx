...
// Dependencies: [19, 17, 10420, 21, 4640, 576, 4636, 4979, 1177, 10545, 10546, 1115, 10547, 5210, 2]
...
export default noop.memo((withDescription) => {
  ...
  if (result) {
    ...
    const obj6 = { source: _modDef10545, style: tmp.animatedIcon, size: tmp6(1177).Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color };
  ...
  if (null != onPress) {
    ...
    let tmp4Result = tmp4(tmp6(5210).PressableOpacity, obj15);
  } else {
