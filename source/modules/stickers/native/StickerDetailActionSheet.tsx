...
// Dependencies: [5, 32, 19, 17, 1979, 1371, 5552, 10343, 1074, 7203, 21, 4605, 1115, 576, 10457, 10305, 10311, 4572, 4601, 1114, 10458, 4303, 504, 1477, 1242, 10471, 5025, 10473, 10459, 10464, 4262, 7240, 1935, 4944, 10475, 1896, 4785, 5570, 10476, 7434, 10246, 8742, 10040, 10477, 8663, 10412, 7202, 2]

// Module 10474 (StickerDetailActionSheet)
...
import StickersActionCreators from "StickersActionCreators" /* 10458 */;
import openStickersPremiumUpsellAlertDefault from "openStickersPremiumUpsellAlert" /* 10477 */;
...
function UnavailableStickerDetail(arg0) {
  ...
  const callback = obj2.useCallback(() => {
    if (null != stickerAssetUrl) {
      ...
      obj.openLazy(asyncRequireImpl(10475, dependencyMap.paths), "StickerOptionsActionSheet", obj2, "stack");
    }
  }, items1);
...
function GuildStickerDetail(sticker) {
  ...
  const callback = obj.useCallback((arg0) => {
    ...
    if (arg0) {
      let StarOutlineIcon = tmp9(10305).StarIcon;
    } else {
      StarOutlineIcon = tmp9(10311).StarOutlineIcon;
    }
...
export default noop.memo(function StickerDetailActionSheet(chatInputRef) {
  ...
  if (null == first) {
    ...
    return tmp6(tmp2(7202).BottomSheet, obj3);
  }
