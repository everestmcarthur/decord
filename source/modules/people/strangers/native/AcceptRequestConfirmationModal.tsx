...
// Dependencies: [19, 17, 21, 4605, 576, 5044, 1114, 4949, 4601, 2]
// Exports: default

// Module 10945 (AcceptRequestConfirmationModal)
...
export default function AcceptRequestConfirmationModal(onConfirm) {
  ...
  const items = [closure_4(onConfirm(4601).Text, obj3), ];
  ...
  items[1] = closure_4(onConfirm(4601).Text, obj4);
  obj2.children = items;
