...
// Dependencies: [19, 17, 21, 4607, 576, 5046, 1114, 4951, 4603, 2]
// Exports: default

// Module 10966 (AcceptRequestConfirmationModal)
...
export default function AcceptRequestConfirmationModal(onConfirm) {
  ...
  const items = [closure_4(onConfirm(4603).Text, obj3), ];
  ...
  items[1] = closure_4(onConfirm(4603).Text, obj4);
  obj2.children = items;
