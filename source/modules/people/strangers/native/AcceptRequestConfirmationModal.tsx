...
// Dependencies: [19, 17, 21, 4606, 576, 5045, 1114, 4950, 4602, 2]
// Exports: default

// Module 10964 (AcceptRequestConfirmationModal)
...
export default function AcceptRequestConfirmationModal(onConfirm) {
  ...
  const items = [closure_4(onConfirm(4602).Text, obj3), ];
  ...
  items[1] = closure_4(onConfirm(4602).Text, obj4);
  obj2.children = items;
