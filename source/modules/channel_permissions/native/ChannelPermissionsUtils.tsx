...
// Dependencies: [1074, 1241, 4605, 9890, 1897, 11751, 2]
// Exports: openAddMembersActionSheet, openChannelMembersActionSheet

// Module 11750 (channel_permissions/ChannelPermissionsUtils)
...
export const openAddMembersActionSheet = function openAddMembersActionSheet(stateFromStores) {
  ...
  obj2.openLazy(asyncRequireImpl(9890, dependencyMap.paths), "channel-add-members-" + stateFromStores.id, { channel: stateFromStores, canSkip: flag });
};
export const openChannelMembersActionSheet = function openChannelMembersActionSheet(id, guild_id) {
  ...
  const obj2 = ActionSheetActionCreatorsDefault;
  obj2.openLazy(asyncRequireImpl(11751, dependencyMap.paths), "channel-members-" + id, { channelId: id, guildId: guild_id });
};
