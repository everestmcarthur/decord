...
// Dependencies: [19, 17, 1958, 2022, 2016, 1980, 4278, 1074, 21, 4640, 576, 1612, 504, 1484, 4793, 11760, 9889, 1115, 7264, 7263, 5210, 4607, 8780, 11762, 7494, 8750, 11758, 10182, 1177, 6738, 9902, 4636, 2]
// Exports: default

// Module 11759 (ChannelMembersActionSheet)
...
import AppChannelPermissionUtils from "AppChannelPermissionUtils" /* 11760 */;
    ...
    if (null != guild) {
      if (null != sortedGuildRoles) {
        ...
        if (canResult) {
          ...
          obj9.children = tmp32(tmp5(7494).SettingsIcon, {});
          tmp32Result = tmp32(tmp5(5210).PressableOpacity, obj9);
        }
        const obj10 = { scrollable: true, header: null, startExpanded: true, children: null };
        obj8.trailing = tmp32Result;
        obj10.header = closure_11(tmp5(7263).BottomSheetTitleHeader, obj8);
        ...
        if (canResult) {
          ...
          obj12.icon = tmp32(tmp5(10182).GroupPlusIcon, {});
          let tmp32Result2 = tmp32(tmp5(8750).RowButton, obj12);
        } else {
        ...
        items6[1] = closure_11(tmp5(6738).BottomSheetSectionList, obj15);
        obj11.children = items6;
        obj10.children = closure_12(stateFromStores, obj11);
        return closure_11(tmp5(7264).BottomSheet, obj10);
      }
    }
  }
  return null;
