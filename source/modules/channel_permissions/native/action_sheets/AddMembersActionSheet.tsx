...
// Dependencies: [5, 109, 32, 19, 17, 2021, 2015, 1979, 1371, 8519, 1085, 21, 4636, 576, 4280, 7084, 4623, 504, 9868, 4348, 1114, 1178, 4632, 9881, 6728, 9003, 9885, 5600, 9890, 4789, 4781, 9869, 4334, 4603, 7253, 7252, 5056, 2]
// Exports: default

// Module 9880 (AddMembersActionSheet)
...
export default function AddMembersActionSheet(channel) {
  ...
  if (null == stateFromStores) {
    ...
    if (channel.canSkip) {
      ...
      obj4.header = tmp11(tmp4(7252).BottomSheetTitleHeader, obj2);
      ...
      return tmp11(tmp4(7253).BottomSheet, obj4);
    }
