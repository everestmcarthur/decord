...
// Dependencies: [5, 32, 19, 17, 1957, 12812, 1074, 21, 4606, 576, 1483, 7054, 12825, 4507, 1114, 12820, 5743, 4602, 4573, 12826, 1896, 6676, 1178, 5026, 2]
// Exports: default

// Module 12824 (HubEmailConnectionContent)
...
import HubEmailConnectionModal from "HubEmailConnectionModal" /* 12820 */;
...
export default function HubEmailConnectionContent(arg0) {
  ...
  items[1] = { paddingBottom: invite(7054)().insets.bottom + invite(576).space.PX_16 };
  obj4.contentContainerStyle = items;
  let obj6 = { style: tmp.container, children: null };
  let obj5 = { paddingBottom: invite(7054)().insets.bottom + invite(576).space.PX_16 };
  ...
  items1[3] = closure_12(invite(6676), obj11);
