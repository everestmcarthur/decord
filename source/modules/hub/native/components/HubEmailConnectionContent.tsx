...
// Dependencies: [5, 32, 19, 17, 1958, 12870, 1074, 21, 4640, 576, 1484, 7095, 12883, 4540, 1115, 12878, 5780, 4636, 4607, 12884, 1897, 6716, 1177, 5062, 2]
// Exports: default

// Module 12882 (HubEmailConnectionContent)
...
import HubEmailConnectionModal from "HubEmailConnectionModal" /* 12878 */;
...
export default function HubEmailConnectionContent(arg0) {
  ...
  items[1] = { paddingBottom: invite(7095)().insets.bottom + invite(576).space.PX_16 };
  obj4.contentContainerStyle = items;
  let obj6 = { style: tmp.container, children: null };
  let obj5 = { paddingBottom: invite(7095)().insets.bottom + invite(576).space.PX_16 };
  ...
  items1[3] = closure_12(invite(6716), obj11);
