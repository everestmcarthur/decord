...
// Dependencies: [5, 32, 19, 17, 1957, 12789, 1074, 21, 4605, 576, 1483, 7033, 12802, 4506, 1114, 12797, 5742, 4601, 4572, 12803, 1896, 6655, 1178, 5025, 2]
// Exports: default

// Module 12801 (HubEmailConnectionContent)
...
import HubEmailConnectionModal from "HubEmailConnectionModal" /* 12797 */;
...
export default function HubEmailConnectionContent(arg0) {
  ...
  items[1] = { paddingBottom: invite(7033)().insets.bottom + invite(576).space.PX_16 };
  obj4.contentContainerStyle = items;
  let obj6 = { style: tmp.container, children: null };
  let obj5 = { paddingBottom: invite(7033)().insets.bottom + invite(576).space.PX_16 };
  ...
  items1[3] = closure_12(invite(6655), obj11);
