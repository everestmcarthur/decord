...
// Dependencies: [5, 32, 19, 17, 1957, 12749, 1074, 21, 4574, 576, 1483, 6995, 12762, 4475, 1114, 12757, 5706, 4570, 4541, 12763, 1896, 6619, 1178, 4989, 2]
// Exports: default

// Module 12761 (HubEmailConnectionContent)
...
export default function HubEmailConnectionContent(arg0) {
  ...
  items[1] = { paddingBottom: invite(6995)().insets.bottom + invite(576).space.PX_16 };
  obj4.contentContainerStyle = items;
  let obj6 = { style: tmp.container, children: null };
  let obj5 = { paddingBottom: invite(6995)().insets.bottom + invite(576).space.PX_16 };
  ...
  items1[3] = closure_12(invite(6619), obj11);
