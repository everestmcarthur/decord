...
// Dependencies: [5, 32, 19, 17, 1957, 12814, 1074, 21, 4607, 576, 1483, 7055, 12827, 4508, 1114, 12822, 5744, 4603, 4574, 12828, 1896, 6677, 1178, 5027, 2]
// Exports: default

// Module 12826 (HubEmailConnectionContent)
...
import HubEmailConnectionModal from "HubEmailConnectionModal" /* 12822 */;
...
export default function HubEmailConnectionContent(arg0) {
  ...
  if (null != guild) {
    ...
    if (invite.guild.id !== closure_10) {
      ...
      if (null != prop) {
        ...
        formatToPlainStringResult = intl2.formatToPlainString(tmp2(1114).t["4T4+p1"], obj3);
      }
    }
  }
  ...
  items[1] = { paddingBottom: invite(7055)().insets.bottom + invite(576).space.PX_16 };
  obj4.contentContainerStyle = items;
  let obj6 = { style: tmp.container, children: null };
  let obj5 = { paddingBottom: invite(7055)().insets.bottom + invite(576).space.PX_16 };
  ...
  items1[3] = closure_12(invite(6677), obj11);
