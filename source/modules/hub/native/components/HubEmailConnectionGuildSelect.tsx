...
// Dependencies: [5, 32, 19, 17, 12862, 21, 4638, 576, 8728, 5670, 1972, 4634, 1115, 1612, 5060, 1177, 1484, 7487, 7161, 12875, 4538, 12870, 2]
// Exports: default

// Module 12880 (HubEmailConnectionGuildSelect)
            ...
            try {
              ...
              if (0 === c4) {
                if (arg0 === 1) {
                  ...
                  c4 = 3;
                  v3 = 1;
                  const obj5 = { value: email(12875).sendVerificationEmail(email, true, id), done: false };
                  return obj5;
                }
              } else if (1 === tmp8) {
                c3 = 0;
