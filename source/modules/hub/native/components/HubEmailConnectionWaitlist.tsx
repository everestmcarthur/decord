...
// Dependencies: [19, 17, 1074, 21, 4638, 576, 1484, 7487, 1115, 12878, 1177, 4634, 5060, 2]
// Exports: default

// Module 12877 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerLeft() {
        ...
        obj.onPress = onPress;
        return closure_2_6(onClose(7487).HeaderActionButton, obj);
      }
    });
  }, items);
  const obj2 = { style: tmp.container, children: null };
  let obj = onClose(1484);
  const items1 = [closure_6(closure_5, { source: navigation(12878), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4634).Text, obj5);
  ...
  obj6.children = closure_6(onClose(5060).Button, obj7);
