...
// Dependencies: [19, 17, 1074, 21, 4606, 576, 1483, 7450, 1114, 12828, 1178, 4602, 5026, 2]
// Exports: default

// Module 12827 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerLeft() {
        ...
        obj.onPress = onPress;
        return closure_2_6(onClose(7450).HeaderActionButton, obj);
      }
    });
  }, items);
  const obj2 = { style: tmp.container, children: null };
  let obj = onClose(1483);
  const items1 = [closure_6(closure_5, { source: navigation(12828), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4602).Text, obj5);
  ...
  obj6.children = closure_6(onClose(5026).Button, obj7);
