...
// Dependencies: [19, 17, 1074, 21, 4607, 576, 1483, 7451, 1114, 12830, 1178, 4603, 5027, 2]
// Exports: default

// Module 12829 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerLeft() {
        ...
        obj.onPress = onPress;
        return closure_2_6(onClose(7451).HeaderActionButton, obj);
      }
    });
  }, items);
  const obj2 = { style: tmp.container, children: null };
  let obj = onClose(1483);
  const items1 = [closure_6(closure_5, { source: navigation(12830), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4603).Text, obj5);
  ...
  obj6.children = closure_6(onClose(5027).Button, obj7);
