...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 1484, 7491, 1115, 12886, 1177, 4636, 5062, 2]
// Exports: default

// Module 12885 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerLeft() {
        ...
        obj.onPress = onPress;
        return closure_2_6(onClose(7491).HeaderActionButton, obj);
      }
    });
  }, items);
  const obj2 = { style: tmp.container, children: null };
  let obj = onClose(1484);
  const items1 = [closure_6(closure_5, { source: navigation(12886), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4636).Text, obj5);
  ...
  obj6.children = closure_6(onClose(5062).Button, obj7);
