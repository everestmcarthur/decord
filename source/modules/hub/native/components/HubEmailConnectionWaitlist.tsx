...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 1484, 7484, 1115, 12870, 1177, 4635, 5059, 2]
// Exports: default

// Module 12869 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerLeft() {
        ...
        obj.onPress = onPress;
        return closure_2_6(onClose(7484).HeaderActionButton, obj);
      }
    });
  }, items);
  const obj2 = { style: tmp.container, children: null };
  let obj = onClose(1484);
  const items1 = [closure_6(closure_5, { source: navigation(12870), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4635).Text, obj5);
  ...
  obj6.children = closure_6(onClose(5059).Button, obj7);
