...
// Dependencies: [19, 17, 1074, 21, 4605, 576, 1483, 7429, 1114, 12805, 1178, 4601, 5025, 2]
// Exports: default

// Module 12804 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerLeft() {
        ...
        obj.onPress = onPress;
        return closure_2_6(onClose(7429).HeaderActionButton, obj);
      }
    });
  }, items);
  const obj2 = { style: tmp.container, children: null };
  let obj = onClose(1483);
  const items1 = [closure_6(closure_5, { source: navigation(12805), style: tmp.header }), , , ];
  ...
  items1[2] = closure_6(onClose(4601).Text, obj5);
  ...
  obj6.children = closure_6(onClose(5025).Button, obj7);
