...
// Dependencies: [32, 5, 19, 17, 1980, 21, 4638, 4336, 10023, 12882, 11363, 12, 12875, 1115, 4538, 7452, 12870, 12883, 4634, 7190, 2]
// Exports: default

// Module 12881 (HubEmailConnectionPinVerify)
import ToastActionCreatorsDefault from "ToastActionCreators" /* 4336 */;
import _modDef10023 from "module_10023" /* 10023 */;
import HubJoinManagerDefault from "HubJoinManager" /* 12882 */;
...
function presentResendToast(content) {
  ...
  obj.open({ key: "HUB_EMAIL_RESET", content, icon: _modDef10023 });
}
...
export default function HubEmailConnectionPinVerify(email) {
  ...
  const tmp7 = email;
  const items1 = [closure_9(closure_7, { source: require("module_12883") }), , , , , ];
  ...
  const obj4 = { source: require("module_12883") };
