...
// Dependencies: [32, 5, 19, 17, 1980, 21, 4639, 4338, 10015, 12874, 11355, 12, 12867, 1115, 4540, 7449, 12862, 12875, 4635, 7187, 2]
// Exports: default

// Module 12873 (HubEmailConnectionPinVerify)
import ToastActionCreatorsDefault from "ToastActionCreators" /* 4338 */;
import _modDef10015 from "module_10015" /* 10015 */;
import HubJoinManagerDefault from "HubJoinManager" /* 12874 */;
...
function presentResendToast(content) {
  ...
  obj.open({ key: "HUB_EMAIL_RESET", content, icon: _modDef10015 });
}
...
export default function HubEmailConnectionPinVerify(email) {
  ...
  const tmp7 = email;
  const items1 = [closure_9(closure_7, { source: require("module_12875") }), , , , , ];
  ...
  const obj4 = { source: require("module_12875") };
