...
// Dependencies: [1961, 502, 1957, 2012, 4494, 2021, 2015, 1979, 1908, 4212, 4614, 4597, 4589, 4222, 2011, 4395, 4755, 1371, 4593, 1074, 1964, 4217, 1086, 4757, 1242, 1090, 4758, 4760, 12, 2]
...
import hasPendingMemberAction from "hasPendingMemberAction" /* 4760 */;
...
export const collectVoiceAnalyticsMetadata = function collectVoiceAnalyticsMetadata(id) {
  if (null == id) {
    ...
    if (null == channel) {
      ...
      const merged1 = Object.assign(id(4757).getVoiceAnalyticsMetadataAdditional());
      return obj;
    }
  }
};
