...
// Function ID: 15769
// Name: MFAModal
// Dependencies: [5, 19, 17, 21, 7056, 4842, 1115, 15769, 7484, 7099, 5709, 15770, 15771, 15776, 15779, 15780, 15781, 7107, 4984, 2]
// Exports: openMFAModal

// Module 15768 (MFAModal)
...
import MFAUtils from "MFAUtils" /* 7056 */;
import MfaStepsTypes from "MfaStepsTypes" /* 15769 */;
...
class MFAModal {
  constructor(arg0) {
    ...
    memo2 = c4.useMemo(() => {
      ...
      if ("webauthn" === type) {
        let headerCloseButton = tmp(5709).getHeaderCloseButton(callback1);
        const tmpResult = tmp(5709);
      } else {
        headerCloseButton = tmp(5709).getHeaderBackButton();
        const tmpResult10 = tmp(5709);
      }
      ...
      obj5.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_6(closure_1_1(15771), {});
      };
      ...
      if ("totp" === type2) {
        let headerCloseButton1 = tmp(5709).getHeaderCloseButton(callback1);
        const tmpResult11 = tmp(5709);
      } else {
        headerCloseButton1 = tmp(5709).getHeaderBackButton();
      ...
      obj6.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_6(closure_1_1(15776), {});
      };
      ...
      if ("backup" === type4) {
        let headerCloseButton2 = tmp(5709).getHeaderCloseButton(callback1);
        const tmpResult13 = tmp(5709);
      } else {
        headerCloseButton2 = tmp(5709).getHeaderBackButton();
        const tmpResult14 = tmp(5709);
      }
      ...
      obj7.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_6(closure_1_1(15779), {});
      };
      ...
      if ("sms" === type6) {
        let headerCloseButton3 = tmp(5709).getHeaderCloseButton(callback1);
        const tmpResult15 = tmp(5709);
      } else {
        headerCloseButton3 = tmp(5709).getHeaderBackButton();
        const tmpResult16 = tmp(5709);
      }
      ...
      obj8.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_6(closure_1_1(15780), {});
      };
      ...
      if ("password" === type8) {
        let headerCloseButton4 = tmp(5709).getHeaderCloseButton(callback1);
        const tmpResult17 = tmp(5709);
      } else {
        headerCloseButton4 = tmp(5709).getHeaderBackButton();
        const tmpResult18 = tmp(5709);
      }
      ...
      obj9.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_6(closure_1_1(15781), {});
      };
