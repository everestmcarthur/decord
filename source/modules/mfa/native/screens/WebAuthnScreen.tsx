...
// Function ID: 15891
// Name: WebAuthnScreen
// Dependencies: [32, 19, 21, 4722, 576, 6792, 1115, 1177, 1364, 1271, 7145, 15891, 14891, 7143, 15894, 2]
// Exports: default

// Module 15890 (WebAuthnScreen)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 1177 */;
import NativeSecurityKeyManagerModuleDefault from "NativeSecurityKeyManagerModule" /* 6792 */;
  ...
  const callback = obj.useCallback(() => {
    ...
    memo(challenge).then((data) => finish({ mfaType: "webauthn", data })).then(() => closure_1_4(true)).catch((error) => {
      if (error instanceof finish(1271).HTTPResponseError) {
        ...
        const result = tmp(7145).captureWebAuthnException(error, {});
