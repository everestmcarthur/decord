...
// Function ID: 15781
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 1074, 21, 7049, 15773, 1115, 1271, 15777, 15772, 6711, 5059, 15775, 2]
// Exports: default

// Module 15780 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  const tmp2 = finish(7049)();
  const screenStyles = finish(15773).useScreenStyles(tmp2);
  const tmp4 = first(noop.useState(null), 2);
  dependencyMap = tmp4[1];
  let obj = finish(15773);
  ...
  let obj4 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15777).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  const items1 = [handleChange(mfaChallenge(6711).TextInput, obj4), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(15777).SMS_CODE_LENGTH;
  }
  obj6.disabled = tmp6;
  obj2.submit = handleChange(finish(15775), obj6);
