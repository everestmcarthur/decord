...
// Function ID: 15805
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 1074, 21, 7056, 15797, 1115, 1271, 15801, 15796, 6717, 5062, 15799, 2]
// Exports: default

// Module 15804 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  const tmp2 = finish(7056)();
  const screenStyles = finish(15797).useScreenStyles(tmp2);
  const tmp4 = first(noop.useState(null), 2);
  dependencyMap = tmp4[1];
  let obj = finish(15797);
  ...
  let obj4 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15801).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  const items1 = [handleChange(mfaChallenge(6717).TextInput, obj4), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(15801).SMS_CODE_LENGTH;
  }
  obj6.disabled = tmp6;
  obj2.submit = handleChange(finish(15799), obj6);
