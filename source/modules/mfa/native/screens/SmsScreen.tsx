...
// Function ID: 15761
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 1074, 21, 6994, 15753, 1114, 1272, 15757, 15752, 6656, 5025, 15755, 2]
// Exports: default

// Module 15760 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  const tmp2 = finish(6994)();
  const screenStyles = finish(15753).useScreenStyles(tmp2);
  const tmp4 = first(noop.useState(null), 2);
  dependencyMap = tmp4[1];
  let obj = finish(15753);
  ...
  let obj4 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15757).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  const items1 = [handleChange(mfaChallenge(6656).TextInput, obj4), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(15757).SMS_CODE_LENGTH;
  }
  obj6.disabled = tmp6;
  obj2.submit = handleChange(finish(15755), obj6);
