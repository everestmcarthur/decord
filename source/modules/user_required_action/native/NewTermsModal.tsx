...
// Function ID: 17670
// Name: NewTermsModal
// Dependencies: [5, 32, 19, 17, 1952, 1074, 21, 4639, 576, 7301, 1115, 6698, 1612, 5715, 5056, 8301, 8897, 1249, 4635, 5059, 9182, 9932, 2]
// Exports: default

// Module 17669 (NewTermsModal)
...
export default function NewTermsModal() {
  ...
  memo(5715).useNavigatorBackPressHandler(memo(5056).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [closure_12(tmp6(4635).Text, obj6), , , , , , ];
    ...
    items2[1] = closure_12(tmp6(4635).Text, obj7);
    ...
    items2[2] = closure_12(tmp6(4635).Text, obj9);
    ...
    items2[3] = closure_12(tmp6(4635).Text, obj11);
    ...
    items2[4] = closure_12(tmp6(4635).Text, obj13);
    ...
    items2[5] = closure_12(tmp6(4635).Text, obj15);
    ...
    items2[6] = closure_12(tmp6(4635).Text, obj17);
    ...
    obj18.children = closure_12(tmp6(5059).Button, obj19);
    ...
    items3[2] = closure_12(tmp2(9182), obj20);
    obj3.children = items3;
    tmp10 = closure_13(closure_6, obj3);
    const tmp2Result = tmp2(9182);
  }
  return tmp10;
};
