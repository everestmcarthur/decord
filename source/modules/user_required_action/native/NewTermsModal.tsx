...
// Function ID: 17601
// Name: NewTermsModal
// Dependencies: [5, 32, 19, 17, 1951, 1074, 21, 4606, 576, 7267, 1114, 6664, 1611, 5681, 5023, 8266, 8859, 1250, 4602, 5026, 9140, 9891, 2]
// Exports: default
...
export default function NewTermsModal() {
  ...
  memo(5681).useNavigatorBackPressHandler(memo(5023).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [closure_12(tmp6(4602).Text, obj6), , , , , , ];
    ...
    items2[1] = closure_12(tmp6(4602).Text, obj7);
    ...
    items2[2] = closure_12(tmp6(4602).Text, obj9);
    ...
    items2[3] = closure_12(tmp6(4602).Text, obj11);
    ...
    items2[4] = closure_12(tmp6(4602).Text, obj13);
    ...
    items2[5] = closure_12(tmp6(4602).Text, obj15);
    ...
    items2[6] = closure_12(tmp6(4602).Text, obj17);
    ...
    obj18.children = closure_12(tmp6(5026).Button, obj19);
    ...
    items3[2] = closure_12(tmp2(9140), obj20);
