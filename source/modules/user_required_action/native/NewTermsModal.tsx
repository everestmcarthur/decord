...
// Function ID: 17551
// Name: NewTermsModal
// Dependencies: [5, 32, 19, 17, 1951, 1074, 21, 4574, 576, 7208, 1114, 6607, 1611, 5644, 4986, 8207, 8801, 1250, 4570, 4989, 9082, 9832, 2]
// Exports: default

// Module 17550 (NewTermsModal)
...
export default function NewTermsModal() {
  ...
  memo(5644).useNavigatorBackPressHandler(memo(4986).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [closure_12(tmp6(4570).Text, obj6), , , , , , ];
    ...
    items2[1] = closure_12(tmp6(4570).Text, obj7);
    ...
    items2[2] = closure_12(tmp6(4570).Text, obj9);
    ...
    items2[3] = closure_12(tmp6(4570).Text, obj11);
    ...
    items2[4] = closure_12(tmp6(4570).Text, obj13);
    ...
    items2[5] = closure_12(tmp6(4570).Text, obj15);
    ...
    items2[6] = closure_12(tmp6(4570).Text, obj17);
    ...
    obj18.children = closure_12(tmp6(4989).Button, obj19);
    ...
    items3[2] = closure_12(tmp2(9082), obj20);
