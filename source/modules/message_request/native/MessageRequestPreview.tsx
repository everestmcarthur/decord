...
// Dependencies: [19, 17, 4255, 1074, 21, 4606, 5575, 576, 12687, 504, 1242, 1114, 7962, 4945, 1178, 2]
...
export default noop.memo(function MessageRequestPreview(channel) {
  ...
  const tmp = closure_9();
  const messageRequestPreview = channel(12687).useMessageRequestPreview(channel);
