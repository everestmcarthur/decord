...
// Dependencies: [19, 17, 4288, 21, 4639, 1177, 576, 504, 4484, 17030, 1400, 4635, 1115, 17031, 17032, 2]
// Exports: default
...
export default function MessageRequestRowSenderDetails(isRestricted) {
  ...
  if (!flag) {
    ...
    tmp11Result = tmp11(tmp7(17031), obj12);
  }
  ...
  if (flag) {
    ...
    flag = tmp11(tmp7(17032), obj13);
    const tmp7Result = tmp7(17032);
  }
