...
// Dependencies: [19, 17, 4371, 21, 4722, 1177, 576, 504, 4566, 17258, 1400, 4718, 1115, 17259, 17260, 2]
// Exports: default
...
export default function MessageRequestRowSenderDetails(isRestricted) {
  ...
  if (tmp9Result) {
    ...
    const items3 = [" ", tmp2(4566).getUserTag(otherUser)];
  ...
  if (!flag) {
    ...
    tmp11Result = tmp11(tmp7(17259), obj12);
  }
  ...
  if (flag) {
    ...
    flag = tmp11(tmp7(17260), obj13);
    const tmp7Result = tmp7(17260);
  }
