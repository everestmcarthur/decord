...
// Dependencies: [32, 19, 17, 1958, 4861, 1372, 21, 4640, 576, 1612, 504, 17146, 17148, 12591, 2]
// Exports: default

// Module 17145 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [closure_10(tmp2(17146), obj6), ];
      const obj7 = { channelId };
      items8[1] = closure_10(tmp2(17148), obj7);
      ...
      obj8.children = closure_10(tmp2(12591), obj10);
