...
// Dependencies: [32, 19, 17, 1958, 4943, 1372, 21, 4722, 576, 1612, 504, 17277, 17279, 12682, 2]
// Exports: default

// Module 17276 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [closure_10(tmp2(17277), obj6), ];
      const obj7 = { channelId };
      items8[1] = closure_10(tmp2(17279), obj7);
      ...
      obj8.children = closure_10(tmp2(12682), obj10);
