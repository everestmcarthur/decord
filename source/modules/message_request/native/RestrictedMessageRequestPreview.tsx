...
// Dependencies: [32, 19, 17, 1957, 4795, 1371, 21, 4574, 576, 1611, 504, 16936, 16938, 12469, 2]
// Exports: default
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [closure_10(tmp2(16936), obj6), ];
      const obj7 = { channelId };
      items8[1] = closure_10(tmp2(16938), obj7);
      ...
      obj8.children = closure_10(tmp2(12469), obj10);
