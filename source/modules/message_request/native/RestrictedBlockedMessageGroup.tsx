...
// Dependencies: [32, 19, 17, 21, 4607, 16985, 576, 5175, 4603, 1114, 2]
// Exports: default
...
let obj2 = { toggle: { marginLeft: fn(16985).RESTRICTED_CONTENT_INSET, marginVertical: nativeDefault.space.PX_8 } };
