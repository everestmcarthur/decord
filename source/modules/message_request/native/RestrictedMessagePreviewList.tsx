...
// Dependencies: [19, 17, 4857, 21, 4636, 17012, 576, 5162, 4632, 1114, 4591, 4318, 7265, 504, 8296, 8036, 17013, 8775, 5204, 17014, 2]
// Exports: default

// Module 17011 (RestrictedMessagePreviewList)
...
import RestrictedBlockedMessageGroupDefault from "RestrictedBlockedMessageGroup" /* 17014 */;
...
let obj2 = { container: { flexDirection: "column" }, hiddenMedia: { marginLeft: fn(17012).RESTRICTED_CONTENT_INSET }, messageRow: { position: "relative" }, avatarHitbox: null, dateDivider: null, dividerLine: null, mediaPlaceholderCard: null, mediaHiddenRow: null };
let size = { position: "absolute", top: 0, left: 0, width: fn(17012).RESTRICTED_CONTENT_INSET, height: fn(17012).RESTRICTED_AVATAR_SIZE };
obj2.avatarHitbox = size;
let obj3 = { marginLeft: fn(17012).RESTRICTED_CONTENT_INSET };
