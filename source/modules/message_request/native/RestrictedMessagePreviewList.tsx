...
// Dependencies: [19, 17, 4861, 21, 4640, 17149, 576, 5168, 4636, 1115, 4594, 4321, 7276, 504, 8327, 8068, 17150, 8807, 5210, 17151, 2]
// Exports: default

// Module 17148 (RestrictedMessagePreviewList)
...
import RestrictedBlockedMessageGroupDefault from "RestrictedBlockedMessageGroup" /* 17151 */;
...
let obj2 = { container: { flexDirection: "column" }, hiddenMedia: { marginLeft: fn(17149).RESTRICTED_CONTENT_INSET }, messageRow: { position: "relative" }, avatarHitbox: null, dateDivider: null, dividerLine: null, mediaPlaceholderCard: null, mediaHiddenRow: null };
let size = { position: "absolute", top: 0, left: 0, width: fn(17149).RESTRICTED_CONTENT_INSET, height: fn(17149).RESTRICTED_AVATAR_SIZE };
obj2.avatarHitbox = size;
let obj3 = { marginLeft: fn(17149).RESTRICTED_CONTENT_INSET };
