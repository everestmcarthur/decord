...
// Dependencies: [19, 17, 1074, 21, 4574, 576, 1114, 12480, 4272, 5611, 4585, 4777, 12472, 1242, 5137, 16916, 1178, 9598, 14952, 8626, 1611, 16925, 16932, 16923, 5006, 7616, 7621, 16926, 1115, 4570, 2]
// Exports: default

// Module 16931 (SpamMessageList)
...
import useSortedSpamMessageRequestsDefault from "useSortedSpamMessageRequests" /* 16932 */;
import noop from "module_19" /* 19 */;

const MessageRequestEmptyDefault = tmp2(16926);
require = fn;
...
export default function SpamMessageList(goToMessageRequestPreview) {
  ...
  dependencyMap = goToMessageRequestPreview(16925).useSpamMessageRequestCount();
  const arr = useSortedSpamMessageRequestsDefault();
  let obj = goToMessageRequestPreview(16925);
  const hasSingleMessageRequest = goToMessageRequestPreview(16923).useListHasSingleSpamMessageRequest();
  ...
  let obj2 = goToMessageRequestPreview(16923);
};
