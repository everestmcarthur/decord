...
// Dependencies: [19, 17, 1074, 21, 4638, 576, 1115, 12593, 4336, 5683, 4649, 4841, 12585, 1241, 5208, 17086, 1177, 9709, 15039, 8728, 1612, 17095, 17102, 17093, 5077, 7710, 7715, 17096, 1364, 4634, 2]
// Exports: default

// Module 17101 (SpamMessageList)
...
import useSortedSpamMessageRequestsDefault from "useSortedSpamMessageRequests" /* 17102 */;
import noop from "module_19" /* 19 */;

const MessageRequestEmptyDefault = tmp2(17096);
require = fn;
...
export default function SpamMessageList(goToMessageRequestPreview) {
  ...
  dependencyMap = goToMessageRequestPreview(17095).useSpamMessageRequestCount();
  const arr = useSortedSpamMessageRequestsDefault();
  let obj = goToMessageRequestPreview(17095);
  const hasSingleMessageRequest = goToMessageRequestPreview(17093).useListHasSingleSpamMessageRequest();
  ...
  let obj2 = goToMessageRequestPreview(17093);
};
