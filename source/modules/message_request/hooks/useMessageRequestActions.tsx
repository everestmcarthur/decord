...
// Dependencies: [5, 32, 19, 7726, 12578, 1074, 12579, 11096, 4540, 10476, 8307, 1241, 12581, 1936, 8755, 2]
// Exports: useMessageRequestActions

// Module 12577 (useMessageRequestActions)
...
require = fn;
const MessageRequestConstants = fn(12578);
