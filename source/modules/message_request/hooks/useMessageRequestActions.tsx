...
// Dependencies: [5, 32, 19, 7635, 12473, 1074, 12474, 10991, 4475, 10376, 8213, 1242, 12476, 1935, 8662, 2]
// Exports: useMessageRequestActions

// Module 12472 (useMessageRequestActions)
...
require = fn;
const MessageRequestConstants = fn(12473);
