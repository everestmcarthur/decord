...
// Dependencies: [5, 32, 19, 7729, 12586, 1074, 12587, 11110, 4538, 10484, 8316, 1241, 12589, 1936, 8764, 2]
// Exports: useMessageRequestActions

// Module 12585 (useMessageRequestActions)
...
require = fn;
const MessageRequestConstants = fn(12586);
