...
// Dependencies: [5, 32, 19, 7694, 12538, 1074, 12539, 11054, 4508, 10435, 8273, 1242, 12541, 1935, 8722, 2]
// Exports: useMessageRequestActions

// Module 12537 (useMessageRequestActions)
...
require = fn;
const MessageRequestConstants = fn(12538);
