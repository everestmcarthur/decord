...
// Dependencies: [4607, 12120, 1897, 2]
// Exports: openCustomTypingIndicatorAnnounceActionSheet

// Module 12119 (openCustomTypingIndicatorAnnounceActionSheet)
...
export const openCustomTypingIndicatorAnnounceActionSheet = function openCustomTypingIndicatorAnnounceActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12120, dependencyMap.paths), CustomTypingIndicatorAnnounceActionSheet, {
    markAsDismissed() {
