...
// Dependencies: [19, 17, 1074, 1954, 21, 4606, 576, 7455, 7223, 7196, 7227, 12063, 1379, 12065, 12066, 12067, 12068, 12069, 12070, 12071, 1178, 1114, 4602, 3592, 5026, 2]
// Exports: default

// Module 12062 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_7(markAsDismissed(7227).ActionSheetHeaderBar, {
      onPress() {
  ...
  const items5 = [ref(12065), ref(12066), ref(12065)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12063), obj7);
  ...
  items3[3] = closure_7(markAsDismissed(4602).Text, obj13);
  ...
  items3[4] = closure_7(markAsDismissed(4602).Text, obj14);
  ...
  const items11 = [closure_7(markAsDismissed(5026).Button, obj16), ];
  ...
  items11[1] = closure_7(markAsDismissed(5026).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7196).SafeAreaPaddingView, obj2);
  return closure_7(markAsDismissed(7223).BottomSheet, obj);
};
