...
// Dependencies: [19, 17, 1074, 1954, 21, 4607, 576, 7456, 7224, 7197, 7228, 12065, 1379, 12067, 12068, 12069, 12070, 12071, 12072, 12073, 1178, 1114, 4603, 3592, 5027, 2]
// Exports: default

// Module 12064 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_7(markAsDismissed(7228).ActionSheetHeaderBar, {
      onPress() {
  ...
  const items5 = [ref(12067), ref(12068), ref(12067)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12065), obj7);
  ...
  items3[3] = closure_7(markAsDismissed(4603).Text, obj13);
  const obj14 = { variant: "text-md/normal", style: tmp2.body, color: "text-muted", children: null };
  const intl3 = markAsDismissed(1114).intl;
  obj14.children = intl3.string(ref(3592).yezU3E);
  items3[4] = closure_7(markAsDismissed(4603).Text, obj14);
  ...
  obj16.text = intl4.string(ref(3592).TswY68);
  obj16.onPress = callback;
  const items11 = [closure_7(markAsDismissed(5027).Button, obj16), ];
  ...
  items11[1] = closure_7(markAsDismissed(5027).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7197).SafeAreaPaddingView, obj2);
  return closure_7(markAsDismissed(7224).BottomSheet, obj);
};
