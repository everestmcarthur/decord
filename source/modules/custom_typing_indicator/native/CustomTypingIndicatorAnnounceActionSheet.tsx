...
// Dependencies: [19, 17, 1074, 1955, 21, 4638, 576, 7492, 7260, 7233, 7264, 12112, 1380, 12114, 12115, 12116, 12117, 12118, 12119, 12120, 1177, 1115, 4634, 3593, 5060, 2]
// Exports: default

// Module 12111 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_7(markAsDismissed(7264).ActionSheetHeaderBar, {
      onPress() {
  ...
  const items5 = [ref(12114), ref(12115), ref(12114)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12112), obj7);
  ...
  obj13.children = intl2.string(ref(3593).uGxDiu);
  items3[3] = closure_7(markAsDismissed(4634).Text, obj13);
  const obj14 = { variant: "text-md/normal", style: tmp2.body, color: "text-muted", children: null };
  const intl3 = markAsDismissed(1115).intl;
  obj14.children = intl3.string(ref(3593).yezU3E);
  items3[4] = closure_7(markAsDismissed(4634).Text, obj14);
  ...
  obj16.text = intl4.string(ref(3593).TswY68);
  obj16.onPress = callback;
  const items11 = [closure_7(markAsDismissed(5060).Button, obj16), ];
  ...
  items11[1] = closure_7(markAsDismissed(5060).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7233).SafeAreaPaddingView, obj2);
  return closure_7(markAsDismissed(7260).BottomSheet, obj);
};
