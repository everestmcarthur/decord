...
// Dependencies: [19, 17, 1074, 1954, 21, 4605, 576, 7434, 7202, 7175, 7206, 12040, 1379, 12042, 12043, 12044, 12045, 12046, 12047, 12048, 1178, 1114, 4601, 3592, 5025, 2]
// Exports: default

// Module 12039 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_7(markAsDismissed(7206).ActionSheetHeaderBar, {
      onPress() {
  ...
  const items5 = [ref(12042), ref(12043), ref(12042)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12040), obj7);
  ...
  items3[3] = closure_7(markAsDismissed(4601).Text, obj13);
  ...
  items3[4] = closure_7(markAsDismissed(4601).Text, obj14);
  ...
  const items11 = [closure_7(markAsDismissed(5025).Button, obj16), ];
  ...
  items11[1] = closure_7(markAsDismissed(5025).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7175).SafeAreaPaddingView, obj2);
  return closure_7(markAsDismissed(7202).BottomSheet, obj);
};
