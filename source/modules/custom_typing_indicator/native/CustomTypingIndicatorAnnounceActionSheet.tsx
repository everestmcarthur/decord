...
// Dependencies: [19, 17, 1074, 1955, 21, 4639, 576, 7489, 7257, 7230, 7261, 12104, 1380, 12106, 12107, 12108, 12109, 12110, 12111, 12112, 1177, 1115, 4635, 3595, 5059, 2]
// Exports: default

// Module 12103 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_7(markAsDismissed(7261).ActionSheetHeaderBar, {
      onPress() {
  ...
  const items5 = [ref(12106), ref(12107), ref(12106)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12104), obj7);
  ...
  obj13.children = intl2.string(ref(3595).uGxDiu);
  items3[3] = closure_7(markAsDismissed(4635).Text, obj13);
  const obj14 = { variant: "text-md/normal", style: tmp2.body, color: "text-muted", children: null };
  const intl3 = markAsDismissed(1115).intl;
  obj14.children = intl3.string(ref(3595).yezU3E);
  items3[4] = closure_7(markAsDismissed(4635).Text, obj14);
  ...
  obj16.text = intl4.string(ref(3595).TswY68);
  obj16.onPress = callback;
  const items11 = [closure_7(markAsDismissed(5059).Button, obj16), ];
  ...
  items11[1] = closure_7(markAsDismissed(5059).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7230).SafeAreaPaddingView, obj2);
  return closure_7(markAsDismissed(7257).BottomSheet, obj);
};
