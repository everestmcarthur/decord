...
// Dependencies: [19, 17, 1074, 1954, 21, 4574, 576, 7396, 7164, 7137, 7168, 12000, 1379, 12002, 12003, 12004, 12005, 12006, 12007, 12008, 1178, 1114, 4570, 3562, 4989, 2]
// Exports: default

// Module 11999 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_7(markAsDismissed(7168).ActionSheetHeaderBar, {
      onPress() {
  ...
  const items5 = [ref(12002), ref(12003), ref(12002)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12000), obj7);
  ...
  obj13.children = intl2.string(ref(3562).uGxDiu);
  items3[3] = closure_7(markAsDismissed(4570).Text, obj13);
  const obj14 = { variant: "text-md/normal", style: tmp2.body, color: "text-muted", children: null };
  const intl3 = markAsDismissed(1114).intl;
  obj14.children = intl3.string(ref(3562).yezU3E);
  items3[4] = closure_7(markAsDismissed(4570).Text, obj14);
  ...
  obj16.text = intl4.string(ref(3562).TswY68);
  obj16.onPress = callback;
  const items11 = [closure_7(markAsDismissed(4989).Button, obj16), ];
  const obj17 = { text: null, variant: "secondary", size: "lg", onPress: null };
  const intl5 = markAsDismissed(1114).intl;
  obj17.text = intl5.string(markAsDismissed(1114).t.TulDPl);
  obj17.onPress = callback1;
  items11[1] = closure_7(markAsDismissed(4989).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7137).SafeAreaPaddingView, obj2);
  return closure_7(markAsDismissed(7164).BottomSheet, obj);
};
