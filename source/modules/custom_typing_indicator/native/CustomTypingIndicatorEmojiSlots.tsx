...
// Dependencies: [32, 19, 1374, 21, 15424, 15426, 15428, 15430, 15432, 15434, 15436, 15438, 15440, 15442, 15444, 15446, 15448, 15450, 15452, 15454, 15456, 15458, 15460, 15462, 15464, 15466, 4607, 7204, 1396, 4343, 5026, 5030, 11218, 1114, 3592, 1392, 5659, 12, 5025, 2]
// Exports: default
...
function PlaceholderEmojiGlyph(pressed) {
  ...
  fn.__closure = { pressed, withSpring: pressed(5026).withSpring, interpolate: pressed(4343).interpolate, PLACEHOLDER_EMOJI_RESTING_OPACITY: 0.4, ON_PRESS_SPRING: pressed(5030).ON_PRESS_SPRING, PLACEHOLDER_EMOJI_ACTIVE_SCALE: 1.14 };
