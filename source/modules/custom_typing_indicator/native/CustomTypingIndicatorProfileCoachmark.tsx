...
// Dependencies: [19, 17, 1074, 1955, 21, 4638, 576, 1115, 3593, 7492, 11280, 12112, 1380, 12116, 12117, 2]
// Exports: default

// Module 16998 (CustomTypingIndicatorProfileCoachmark)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import user from "user" /* 1380 */;
import _modDef3593 from "module_3593" /* 3593 */;
import CustomTypingIndicatorDynamicAssetDefault from "CustomTypingIndicatorDynamicAsset" /* 12112 */;
...
function CoachmarkPreview() {
  ...
  const items = [_modDef12116, _modDef12117, _modDef12116];
...
export default function CustomTypingIndicatorProfileCoachmark(visible) {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj.buttonLabel = intl.string(_modDef3593["6NP6ic"]);
