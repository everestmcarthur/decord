...
// Dependencies: [32, 19, 21, 4606, 576, 7270, 7222, 1114, 3592, 5736, 12064, 5739, 2]
// Exports: default
...
export default function CustomTypingIndicatorTypingSuggestionPickerSheet(onChange) {
  ...
  return jsx(onChange(7270).ActionSheet, { contentStyles: closure_6().content, header: null, dismissAccessibilityLabel: null, children: null });
};
