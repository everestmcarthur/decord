...
// Dependencies: [32, 19, 1074, 1954, 21, 1483, 12064, 7461, 1943, 1114, 14671, 3592, 12074, 2]
// Exports: default

// Module 14692 (UserProfileTypingIndicatorEditButton)
...
export default function UserProfileTypingIndicatorEditButton(isTryItOut) {
  ...
  const stringResult = intl.string(isTryItOut(12064).getCustomTypingIndicatorSuggestionMessage(currentCustomTypingIndicatorConfig.typingSuggestion));
  ...
  const obj4 = isTryItOut(12064);
  obj5.labelTrailing = jsx(isTryItOut(14671).UserProfileEditFormLabelBadges, { showPremiumIcon: true, showNewBadge: tmp3[0] === isTryItOut(1943).DismissibleContent.CUSTOM_TYPING_INDICATOR_MOBILE_NEW_BADGE_PROFILE_PAGE });
  obj5.leading = jsx(nativeStackNavigation(12074), { config: currentCustomTypingIndicatorConfig, size: 24 });
  obj5.buttonText = stringResult;
  obj5.accessibilityValue = { text: stringResult };
  obj5.onPress = tmp5;
  return jsx(isTryItOut(14671).UserProfileEditFormButton, { label: null, labelTrailing: null, leading: null, buttonText: null, accessibilityValue: null, onPress: null });
};
