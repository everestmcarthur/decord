...
// Dependencies: [32, 19, 17, 21, 4640, 576, 5695, 4636, 1380, 1115, 3595, 7311, 12132, 5060, 2]
// Exports: default

// Module 15476 (CustomTypingIndicatorAnimationPickerSheet)
...
export default function CustomTypingIndicatorAnimationPickerSheet(onChange) {
  ...
  obj7.config = obj8;
  obj6.children = closure_6(animation(12132), obj7);
  ...
  items1[1] = closure_6(onChange(5060).Stack, obj9);
  obj5.children = items1;
  return closure_7(onChange(7311).ActionSheet, obj5);
};
