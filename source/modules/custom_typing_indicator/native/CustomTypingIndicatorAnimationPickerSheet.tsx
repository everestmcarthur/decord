...
// Dependencies: [32, 19, 17, 21, 4574, 576, 5621, 4570, 1379, 1114, 3562, 7211, 12011, 4987, 2]
// Exports: default
...
export default function CustomTypingIndicatorAnimationPickerSheet(onChange) {
  ...
  obj7.config = obj8;
  obj6.children = closure_6(animation(12011), obj7);
  ...
  items1[1] = closure_6(onChange(4987).Stack, obj9);
  obj5.children = items1;
  return closure_7(onChange(7211).ActionSheet, obj5);
};
