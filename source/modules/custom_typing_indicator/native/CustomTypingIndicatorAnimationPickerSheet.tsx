...
export default function CustomTypingIndicatorAnimationPickerSheet(onChange) {
  ...
  items1[1] = callback2(onChange(4973).Stack, obj6);
  obj2[2] = items1;
  return callback3(onChange(7198).ActionSheet, obj2);
};
