...
// Dependencies: [14568, 1115, 14573, 14574, 1231, 2]

// Module 14572 (NotifSettingsUtils)
...
function buildChannelsAndMapping() {
  const assignedNotifSettingsAndMappings = map(14574).getAssignedNotifSettingsAndMappings();
