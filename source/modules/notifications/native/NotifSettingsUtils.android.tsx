...
// Dependencies: [14560, 1115, 14565, 14566, 1231, 2]

// Module 14564 (NotifSettingsUtils)
...
function buildChannelsAndMapping() {
  const assignedNotifSettingsAndMappings = map(14566).getAssignedNotifSettingsAndMappings();
