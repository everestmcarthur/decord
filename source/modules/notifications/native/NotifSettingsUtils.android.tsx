...
// Dependencies: [14542, 1115, 14547, 14548, 1231, 2]

// Module 14546 (NotifSettingsUtils)
...
function buildChannelsAndMapping() {
  const assignedNotifSettingsAndMappings = map(14548).getAssignedNotifSettingsAndMappings();
