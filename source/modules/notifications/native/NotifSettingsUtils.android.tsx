...
// Dependencies: [14663, 1115, 14668, 14669, 1231, 2]

// Module 14667 (NotifSettingsUtils)
...
function buildChannelsAndMapping() {
  const assignedNotifSettingsAndMappings = map(14669).getAssignedNotifSettingsAndMappings();
