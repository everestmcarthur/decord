...
// Dependencies: [14472, 1114, 14477, 14478, 1232, 2]

// Module 14476 (NotifSettingsUtils)
...
function buildChannelsAndMapping() {
  const assignedNotifSettingsAndMappings = map(14478).getAssignedNotifSettingsAndMappings();
