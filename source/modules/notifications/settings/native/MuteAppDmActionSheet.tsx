...
// Dependencies: [19, 17, 21, 4606, 576, 7223, 9867, 4602, 1114, 5026, 7192, 7187, 4573, 4305, 1178, 8023, 2]
// Exports: default

// Module 12692 (MuteAppDmActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj7.onPress = function onPress() {
    ...
    obj4.icon = function icon() {
      const obj = { style: closure_1_0.mutedNotificationContainer, children: closure_2_4(closure_0(1178).Icon, { source: channel(8023), color: channel(576).unsafe_rawColors.WHITE, style: closure_1_0.mutedNotification }) };
