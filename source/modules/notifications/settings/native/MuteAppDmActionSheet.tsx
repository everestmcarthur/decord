...
// Dependencies: [19, 17, 21, 4640, 576, 7264, 9927, 4636, 1115, 5062, 7233, 7228, 4607, 4338, 1177, 8085, 2]
// Exports: default

// Module 12750 (MuteAppDmActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj7.onPress = function onPress() {
    ...
    obj4.icon = function icon() {
      const obj = { style: closure_1_0.mutedNotificationContainer, children: closure_2_4(closure_0(1177).Icon, { source: channel(8085), color: channel(576).unsafe_rawColors.WHITE, style: closure_1_0.mutedNotification }) };
