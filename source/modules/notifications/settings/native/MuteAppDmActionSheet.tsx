...
// Dependencies: [19, 17, 21, 4638, 576, 7260, 9916, 4634, 1115, 5060, 7229, 7224, 4605, 4336, 1177, 8065, 2]
// Exports: default

// Module 12742 (MuteAppDmActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj7.onPress = function onPress() {
    ...
    obj4.icon = function icon() {
      const obj = { style: closure_1_0.mutedNotificationContainer, children: closure_2_4(closure_0(1177).Icon, { source: channel(8065), color: channel(576).unsafe_rawColors.WHITE, style: closure_1_0.mutedNotification }) };
