...
// Dependencies: [19, 17, 21, 4639, 576, 7257, 9908, 4635, 1115, 5059, 7226, 7221, 4606, 4338, 1177, 8056, 2]
// Exports: default

// Module 12734 (MuteAppDmActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj7.onPress = function onPress() {
    ...
    obj4.icon = function icon() {
      const obj = { style: closure_1_0.mutedNotificationContainer, children: closure_2_4(closure_0(1177).Icon, { source: channel(8056), color: channel(576).unsafe_rawColors.WHITE, style: closure_1_0.mutedNotification }) };
