...
// Dependencies: [19, 17, 21, 4607, 576, 7224, 9869, 4603, 1114, 5027, 7193, 7188, 4574, 4305, 1178, 8024, 2]
// Exports: default

// Module 12694 (MuteAppDmActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj7.onPress = function onPress() {
    ...
    obj4.icon = function icon() {
      const obj = { style: closure_1_0.mutedNotificationContainer, children: closure_2_4(closure_0(1178).Icon, { source: channel(8024), color: channel(576).unsafe_rawColors.WHITE, style: closure_1_0.mutedNotification }) };
