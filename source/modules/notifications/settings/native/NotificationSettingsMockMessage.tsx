...
// Dependencies: [19, 17, 1371, 1074, 21, 4574, 576, 504, 4418, 4310, 4575, 4578, 4570, 1114, 1178, 10191, 2]
// Exports: default

// Module 10190 (NotificationSettingsMockMessage)
...
export default function NotificationSettingsMockMessage(notificationSetting) {
  ...
  let str = sharedValue(4418).getName(stateFromStores);
  if (str == null) {
    str = "Roka";
  }
  _require = tmp7;
  const obj2 = sharedValue(4418);
  ...
  if (notificationSetting.notificationSetting === tmp6.ALL_MESSAGES) {
    ...
    let tmp11 = closure_7(tmp2(4570).Text, obj4);
    let tmp12 = closure_7;
  } else {
    ...
    const items2 = [closure_8(tmp2(4570).Text, obj7), ];
    const intl3 = tmp2(1114).intl;
    items2[1] = intl3.string(tmp2(1114).t.WYyzI5);
    obj6.children = items2;
    obj5.children = closure_8(tmp2(4570).Text, obj6);
  ...
  obj10.children = tmp12(require("native").Avatar, { source: sharedValue(10191), size: require("native").AvatarSizes.LARGE_48 });
  ...
  obj14.style = items7;
  items6[1] = tmp12(sharedValue(4310).View, obj14);
