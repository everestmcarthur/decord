...
// Dependencies: [19, 17, 1372, 1074, 21, 4640, 576, 504, 4484, 4376, 4641, 4644, 4636, 1115, 1177, 10305, 2]
// Exports: default

// Module 10304 (NotificationSettingsMockMessage)
...
export default function NotificationSettingsMockMessage(notificationSetting) {
  ...
  if (notificationSetting.notificationSetting === tmp6.ALL_MESSAGES) {
    ...
    let tmp11 = closure_7(tmp2(4636).Text, obj4);
    let tmp12 = closure_7;
  } else {
    ...
    const items2 = [closure_8(tmp2(4636).Text, obj7), ];
    const intl3 = tmp2(1115).intl;
    items2[1] = intl3.string(tmp2(1115).t.WYyzI5);
    obj6.children = items2;
    obj5.children = closure_8(tmp2(4636).Text, obj6);
  ...
  obj10.children = tmp12(require("native").Avatar, { source: sharedValue(10305), size: require("native").AvatarSizes.LARGE_48 });
