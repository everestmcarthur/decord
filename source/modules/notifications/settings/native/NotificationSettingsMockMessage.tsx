...
// Dependencies: [19, 17, 1372, 1074, 21, 4638, 576, 504, 4482, 4374, 4639, 4642, 4634, 1115, 1177, 10297, 2]
// Exports: default

// Module 10296 (NotificationSettingsMockMessage)
...
export default function NotificationSettingsMockMessage(notificationSetting) {
  ...
  let str = sharedValue(4482).getName(stateFromStores);
  if (str == null) {
    str = "Roka";
  }
  _require = tmp7;
  ...
  if (notificationSetting.notificationSetting === tmp6.ALL_MESSAGES) {
    ...
    let tmp11 = closure_7(tmp2(4634).Text, obj4);
    let tmp12 = closure_7;
  } else {
    ...
    const items2 = [closure_8(tmp2(4634).Text, obj7), ];
    const intl3 = tmp2(1115).intl;
    items2[1] = intl3.string(tmp2(1115).t.WYyzI5);
    obj6.children = items2;
    obj5.children = closure_8(tmp2(4634).Text, obj6);
  ...
  obj10.children = tmp12(require("native").Avatar, { source: sharedValue(10297), size: require("native").AvatarSizes.LARGE_48 });
  ...
  obj14.style = items7;
  items6[1] = tmp12(sharedValue(4374).View, obj14);
