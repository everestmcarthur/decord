...
// Dependencies: [19, 15577, 8082, 21, 16023, 1115, 2723, 15578, 11606, 15580, 5076, 16024, 14786, 2]

// Module 16022 (RedesignSettingsNotificationScreen)
...
require = fn;
let closure_4 = fn(15577).initializeAndroidNotificationSettingsStore;
