...
// Dependencies: [32, 1958, 4820, 1074, 4821, 1084, 563, 4823, 10277, 7226, 10280, 7221, 2]
...
// Module 10279 (notficationSettingsChannelFlagUtils)
...
export const updateChannelPreset = function updateChannelPreset(guild_id, id, arg2) {
  ...
  if (arg2 === notificationSettingsPresetUtils.Presets.ALL_MESSAGES) {
    ...
    const obj2 = { message_notifications: UserNotificationSettings.ALL_MESSAGES, flags: tmp2(10280).withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ALL_MESSAGES) };
    const result = obj4.updateChannelOverrideSettings(guild_id, id, obj2, tmp2(7221).NotificationLabels.PresetAll);
    const tmp2Result = tmp2(10280);
  } else if (arg2 === tmp2(4823).Presets.MENTIONS) {
    const obj = NotificationSettingsModalActionCreatorsDefault;
    const obj3 = { message_notifications: UserNotificationSettings.ONLY_MENTIONS, flags: tmp2(10280).withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ONLY_MENTIONS) };
    const result1 = obj.updateChannelOverrideSettings(guild_id, id, obj3, tmp2(7221).NotificationLabels.PresetMentions);
    const tmp2Result3 = tmp2(10280);
  } else if (arg2 === tmp2(4823).Presets.NOTHING) {
    const obj7 = NotificationSettingsModalActionCreatorsDefault;
    const obj5 = { message_notifications: UserNotificationSettings.NO_MESSAGES, flags: tmp2(10280).withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ONLY_MENTIONS) };
    const result2 = obj7.updateChannelOverrideSettings(guild_id, id, obj5, tmp2(7221).NotificationLabels.PresetNothing);
    const tmp2Result4 = tmp2(10280);
  }
};
