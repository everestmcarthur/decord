...
import { ChannelNotificationSettingsFlags as closure_8 } from "MAX_FAVORITES" /* 1084 */;
...
export const useChannelPresetSettings = function useChannelPresetSettings(channel) {
  ...
  const stateFromStores1 = _require(563).useStateFromStores(items1, () => closure_1_5.resolvedMessageNotifications(closure_0));
...
export const useChannelPresetInheritance = function useChannelPresetInheritance(channel) {
  ...
  [tmp2, tmp3] = callback(_require(563).useStateFromStoresArray(items1, () => {
