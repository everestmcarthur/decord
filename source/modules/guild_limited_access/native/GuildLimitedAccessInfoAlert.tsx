...
// Dependencies: [19, 1979, 13886, 1074, 21, 4606, 5575, 576, 1114, 5045, 1178, 4602, 2]
// Exports: default

// Module 13885 (GuildLimitedAccessInfoAlert)
...
require = fn;
const helpdeskArticle = fn(13886).GUILD_LIMITED_ACCESS_HC_LINK;
const jsxProd = fn(21);
