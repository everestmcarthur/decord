...
// Dependencies: [19, 1979, 13907, 1074, 21, 4605, 5574, 576, 1114, 5044, 1178, 4601, 2]
// Exports: default

// Module 13906 (GuildLimitedAccessInfoAlert)
...
require = fn;
const helpdeskArticle = fn(13907).GUILD_LIMITED_ACCESS_HC_LINK;
const jsxProd = fn(21);
