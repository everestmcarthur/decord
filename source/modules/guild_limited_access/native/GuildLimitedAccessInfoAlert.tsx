...
// Dependencies: [19, 1980, 13947, 1074, 21, 4640, 5612, 576, 1115, 5081, 1177, 4636, 2]
// Exports: default

// Module 13946 (GuildLimitedAccessInfoAlert)
...
require = fn;
const helpdeskArticle = fn(13947).GUILD_LIMITED_ACCESS_HC_LINK;
const jsxProd = fn(21);
