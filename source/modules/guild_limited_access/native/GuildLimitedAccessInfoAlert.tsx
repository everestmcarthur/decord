...
// Dependencies: [19, 1979, 13888, 1074, 21, 4607, 5576, 576, 1114, 5046, 1178, 4603, 2]
// Exports: default

// Module 13887 (GuildLimitedAccessInfoAlert)
...
require = fn;
const helpdeskArticle = fn(13888).GUILD_LIMITED_ACCESS_HC_LINK;
const jsxProd = fn(21);
