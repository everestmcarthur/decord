...
// Dependencies: [5, 32, 19, 17, 8529, 8781, 1074, 21, 4640, 5079, 1271, 12, 576, 11089, 7153, 1177, 11107, 11108, 1115, 5712, 1249, 7114, 2]

// Module 11088 (GroupDMInviteManagementScreen)
import _modDef12 from "module_12" /* 12 */;
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import discord_common_AnalyticsUtils from "discord_common/AnalyticsUtils" /* 1249 */;
import NavigatorHeader from "NavigatorHeader" /* 5712 */;
import InstantInviteDefault from "InstantInvite" /* 11089 */;
...
function GroupDMInviteManagement(channelId) {
  ...
  if (tmp3[0]) {
    let tmp14 = jsx(channelId(7153).SceneLoadingIndicator, {});
  } else if (0 === first.length) {
    let obj2 = { lightSource: tmp4(11107), darkSource: tmp4(11108), title: null, body: null };
    ...
    tmp14 = jsx(channelId(1177).EmptyState, { lightSource: tmp4(11107), darkSource: tmp4(11108), title: null, body: null });
  } else {
...
const ChannelSettingsStore = fn(8781);
...
export default noop.memo(function GroupDMInviteManagementScreen(channelId) {
  ...
  return jsx(channelId(7114).Navigator, { screens: memo, initialRouteName: constants.INSTANT_INVITES_MANAGEMENT });
});
