...
// Dependencies: [5, 32, 19, 17, 8510, 8761, 1074, 21, 4638, 5077, 1271, 12, 576, 11081, 7149, 1177, 11099, 11100, 1115, 5710, 1249, 7110, 2]

// Module 11080 (GroupDMInviteManagementScreen)
import _modDef12 from "module_12" /* 12 */;
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import discord_common_AnalyticsUtils from "discord_common/AnalyticsUtils" /* 1249 */;
import NavigatorHeader from "NavigatorHeader" /* 5710 */;
import InstantInviteDefault from "InstantInvite" /* 11081 */;
...
function GroupDMInviteManagement(channelId) {
  ...
  if (tmp3[0]) {
    let tmp14 = jsx(channelId(7149).SceneLoadingIndicator, {});
  } else if (0 === first.length) {
    let obj2 = { lightSource: tmp4(11099), darkSource: tmp4(11100), title: null, body: null };
    ...
    tmp14 = jsx(channelId(1177).EmptyState, { lightSource: tmp4(11099), darkSource: tmp4(11100), title: null, body: null });
  } else {
...
const ChannelSettingsStore = fn(8761);
...
export default noop.memo(function GroupDMInviteManagementScreen(channelId) {
  ...
  return jsx(channelId(7110).Navigator, { screens: memo, initialRouteName: constants.INSTANT_INVITES_MANAGEMENT });
});
