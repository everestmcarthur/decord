...
// Dependencies: [5, 32, 19, 17, 8445, 8696, 1074, 21, 4605, 5042, 1272, 12, 576, 11004, 7091, 1178, 11021, 11022, 1114, 5674, 1250, 7052, 2]
...
function GroupDMInviteManagement(channelId) {
  ...
  if (tmp3[0]) {
    ...
    let obj2 = { lightSource: tmp4(11021), darkSource: tmp4(11022), title: null, body: null };
