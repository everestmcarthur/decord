...
// Dependencies: [5, 32, 19, 17, 8408, 8659, 1074, 21, 4574, 5006, 1272, 12, 576, 10964, 7053, 1178, 10981, 10982, 1114, 5638, 1250, 7014, 2]
...
function GroupDMInviteManagement(channelId) {
  ...
  if (tmp3[0]) {
    ...
    let obj2 = { lightSource: tmp4(10981), darkSource: tmp4(10982), title: null, body: null };
