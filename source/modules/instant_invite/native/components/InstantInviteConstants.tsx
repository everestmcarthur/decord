...
// Dependencies: [17, 9918, 1074, 9950, 9146, 576, 1114, 9913, 9953, 4551, 9954, 1608, 9955, 4574, 9956, 1896, 7832, 1115, 9973, 9974, 4740, 7530, 4952, 9975, 9976, 9977, 9978, 9979, 9980, 9981, 9982, 2]

// Module 9949 (components/InstantInviteConstants)
...
import icons_ShareDefault from "icons/Share" /* 9950 */;
...
import InstantInviteConstants from "InstantInviteConstants" /* 9918 */;
import Constants from "Constants" /* 1074 */;
import MetaQuestUtils from "MetaQuestUtils" /* 1608 */;
import PlatformUtils_mod from "PlatformUtils" /* 1115 */;
import DCDSendUtils_mod from "DCDSendUtils" /* 4740 */;
import InstantInviteUtils_mod from "instant_invite/InstantInviteUtils" /* 9913 */;
...
let obj4 = { type: obj.QR_CODE, icon: _modDef9954, isAvailable: null, IconComponent: null, getLabel: null, onPress: null };
obj4.isAvailable = Promise.resolve(!MetaQuestUtils.isMetaQuest());
obj4.IconComponent = _modDef9955;
...
obj4.onPress = function onPress(code) {
  ...
  obj.openLazy(asyncRequireImpl(9956, dependencyMap.paths), combined, obj2, "stack");
};
items[2] = obj4;
...
if (PlatformUtils.isIOS()) {
  importDefaultResult = _modDef9973;
}
obj5.fullIcon = importDefaultResult;
let PlatformUtils = PlatformUtils_mod;
let importDefaultResult1;
if (PlatformUtils.isAndroid()) {
  importDefaultResult1 = _modDef9974;
}
...
obj5.onPress = function onPress(channel) {
  ...
  channel(9913).trackOptionClicked(code, channel, constants.SMS, _location);
  let obj = channel(9913);
  const tmp = channel;
  if (obj2.isIOS()) {
    code(4574).hideActionSheet();
    let obj3 = code(4574);
  }
  obj2 = channel(1115);
  tmp(4740).sendSMS({ body: message }, (arg0, arg1, arg2) => {
    if (arg0) {
...
if (PlatformUtils.isIOS()) {
  importDefaultResult2 = _modDef9975;
}
obj6.fullIcon = importDefaultResult2;
let PlatformUtils = PlatformUtils_mod;
let importDefaultResult3;
if (PlatformUtils.isAndroid()) {
  importDefaultResult3 = _modDef9976;
}
...
obj6.onPress = function onPress(channel) {
  ...
  const code = channel.code;
  ({ message, location: _location } = channel);
  channel(9913).trackOptionClicked(code, channel, constants.EMAIL, _location);
  let obj = channel(9913);
  const tmp = channel;
  if (obj2.isIOS()) {
    code(4574).hideActionSheet();
  ...
  obj2 = channel(1115);
  tmp(4740).sendMail({ subject: "", body: message }, (arg0, arg1, arg2) => {
    if (arg0) {
...
items[4] = obj6;
const obj7 = { type: obj.FB_MESSENGER, fullIcon: _modDef9977, isAvailable: null, getLabel: null, onPress: null };
...
items[5] = obj7;
const obj8 = { type: obj.GMAIL, fullIcon: _modDef9978, isAvailable: null, getLabel: null, onPress: null };
let InstantInviteUtils = InstantInviteUtils_mod;
...
items[6] = obj8;
const obj9 = { type: obj.TELEGRAM, fullIcon: _modDef9979, isAvailable: null, getLabel: null, onPress: null };
let InstantInviteUtils = InstantInviteUtils_mod;
...
items[7] = obj9;
const obj10 = { type: obj.TWITTER, fullIcon: _modDef9980, isAvailable: null, getLabel: null, onPress: null };
let InstantInviteUtils = InstantInviteUtils_mod;
...
items[8] = obj10;
const obj11 = { type: obj.WHATSAPP, fullIcon: _modDef9981, isAvailable: null, getLabel: null, onPress: null };
let InstantInviteUtils = InstantInviteUtils_mod;
...
items[9] = obj11;
const obj12 = { type: obj.LINE, fullIcon: _modDef9982, isAvailable: null, getLabel: null, onPress: null };
let InstantInviteUtils = InstantInviteUtils_mod;
