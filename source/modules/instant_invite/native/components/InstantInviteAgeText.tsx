...
// Dependencies: [19, 17, 10066, 21, 4722, 7176, 504, 4718, 10067, 5292, 10065, 1115, 2]
// Exports: default
...
export default function InstantInviteAgeText(style) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [tmp2(10067).maxAgeString(stateFromStores.maxAge, stateFromStores.maxUses), " "];
    obj4.children = items2;
    const items3 = [closure_4(tmp2(4718).Text, obj4), ];
    if (canEditInvite) {
      const obj5 = {
        onPress() {
      ...
      obj5.children = closure_5(tmp2(4718).Text, obj6);
      canEditInvite = tmp9(tmp2(5292).PressableOpacity, obj5);
    }
    items3[1] = canEditInvite;
    obj3.children = items3;
    tmp7Result = tmp7(View, obj3);
    const tmp2Result = tmp2(10067);
  }
  return tmp7Result;
};
