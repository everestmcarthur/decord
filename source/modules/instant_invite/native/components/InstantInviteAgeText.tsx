...
// Dependencies: [19, 17, 9953, 21, 4639, 7087, 504, 4635, 9954, 5207, 9952, 1115, 2]
// Exports: default

// Module 10023 (InstantInviteAgeText)
...
export default function InstantInviteAgeText(style) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [tmp2(9954).maxAgeString(stateFromStores.maxAge, stateFromStores.maxUses), " "];
    obj4.children = items2;
    const items3 = [closure_4(tmp2(4635).Text, obj4), ];
    if (canEditInvite) {
      const obj5 = {
        onPress() {
      ...
      obj5.children = closure_5(tmp2(4635).Text, obj6);
      canEditInvite = tmp9(tmp2(5207).PressableOpacity, obj5);
    }
    items3[1] = canEditInvite;
    obj3.children = items3;
    tmp7Result = tmp7(View, obj3);
    const tmp2Result = tmp2(9954);
  }
  return tmp7Result;
};
