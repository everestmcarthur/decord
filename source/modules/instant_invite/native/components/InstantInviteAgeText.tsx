...
// Dependencies: [19, 17, 9972, 21, 4640, 7094, 504, 4636, 9973, 5210, 9971, 1115, 2]
// Exports: default
...
export default function InstantInviteAgeText(style) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [tmp2(9973).maxAgeString(stateFromStores.maxAge, stateFromStores.maxUses), " "];
    obj4.children = items2;
    const items3 = [closure_4(tmp2(4636).Text, obj4), ];
    if (canEditInvite) {
      const obj5 = {
        onPress() {
      ...
      obj5.children = closure_5(tmp2(4636).Text, obj6);
      canEditInvite = tmp9(tmp2(5210).PressableOpacity, obj5);
    }
    items3[1] = canEditInvite;
    obj3.children = items3;
    tmp7Result = tmp7(View, obj3);
    const tmp2Result = tmp2(9973);
  }
  return tmp7Result;
};
