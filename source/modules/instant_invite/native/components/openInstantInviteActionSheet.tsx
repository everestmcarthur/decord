...
// Dependencies: [4572, 9898, 1896, 1250, 2]
// Exports: default

// Module 9897 (openInstantInviteActionSheet)
...
export default function openInstantInviteActionSheet(invite_channel_id) {
  ...
  obj.openLazy(asyncRequireImpl(9898, dependencyMap.paths), combined, obj2, invite_channel_id.stackingBehavior);
};
