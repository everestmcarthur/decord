...
// Dependencies: [4573, 9919, 1896, 1250, 2]
// Exports: default

// Module 9918 (openInstantInviteActionSheet)
...
export default function openInstantInviteActionSheet(invite_channel_id) {
  ...
  obj.openLazy(asyncRequireImpl(9919, dependencyMap.paths), combined, obj2, invite_channel_id.stackingBehavior);
};
