...
// Dependencies: [19, 17, 9912, 21, 4606, 576, 504, 1178, 9945, 1114, 7010, 5174, 7453, 4602, 9913, 5026, 2]
// Exports: default
...
export default function _default(link) {
  ...
  const obj3 = { containerStyle: tmp.emptyStateContainer, imageStyle: tmp.emptyStateArt, titleStyle: tmp.emptyStateTitle, source: _modDef9945, title: null, body: null };
  ...
  obj6.children = closure_5(stateFromStores(7453).SettingsIcon, {});
  items2[1] = closure_5(stateFromStores(5174).PressableOpacity, obj6);
  ...
  if (null == stateFromStores) {
    ...
    items1[3] = tmp7(tmp2(5026).Button, obj8);
    obj2.children = items1;
    return tmp5(tmp6, obj2);
  } else {
    const maxAgeOptionByValue = tmp8(9913).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(9913).getMaxUsesOptions;
