...
// Dependencies: [19, 17, 10066, 21, 4722, 576, 504, 1177, 10099, 1115, 7133, 5292, 7576, 4718, 10067, 5144, 2]
// Exports: default

// Module 10098 (InstantInviteEmptyState)
import nativeDefault from "native" /* 576 */;
import FreeFormTextInputDefault from "FreeFormTextInput" /* 7133 */;
...
export default function _default(link) {
  ...
  const obj3 = { containerStyle: tmp.emptyStateContainer, imageStyle: tmp.emptyStateArt, titleStyle: tmp.emptyStateTitle, source: _modDef10099, title: null, body: null };
  ...
  obj6.children = closure_5(stateFromStores(7576).SettingsIcon, {});
  items2[1] = closure_5(stateFromStores(5292).PressableOpacity, obj6);
  ...
  if (null == stateFromStores) {
    ...
    items1[3] = tmp7(tmp2(5144).Button, obj8);
    obj2.children = items1;
    return tmp5(tmp6, obj2);
  } else {
    const maxAgeOptionByValue = tmp8(10067).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(10067).getMaxUsesOptions;
