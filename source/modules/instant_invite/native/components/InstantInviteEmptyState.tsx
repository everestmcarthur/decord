...
// Dependencies: [19, 17, 9953, 21, 4639, 576, 504, 1177, 9986, 1115, 7044, 5207, 7487, 4635, 9954, 5059, 2]
// Exports: default

// Module 9985 (InstantInviteEmptyState)
import nativeDefault from "native" /* 576 */;
import FreeFormTextInputDefault from "FreeFormTextInput" /* 7044 */;
...
export default function _default(link) {
  ...
  const obj3 = { containerStyle: tmp.emptyStateContainer, imageStyle: tmp.emptyStateArt, titleStyle: tmp.emptyStateTitle, source: _modDef9986, title: null, body: null };
  ...
  obj6.children = closure_5(stateFromStores(7487).SettingsIcon, {});
  items2[1] = closure_5(stateFromStores(5207).PressableOpacity, obj6);
  ...
  if (null == stateFromStores) {
    ...
    items1[3] = tmp7(tmp2(5059).Button, obj8);
    obj2.children = items1;
    return tmp5(tmp6, obj2);
  } else {
    const maxAgeOptionByValue = tmp8(9954).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(9954).getMaxUsesOptions;
