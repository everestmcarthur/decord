...
// Dependencies: [19, 17, 9972, 21, 4640, 576, 504, 1177, 10005, 1115, 7051, 5210, 7494, 4636, 9973, 5062, 2]
// Exports: default

// Module 10004 (InstantInviteEmptyState)
...
export default function _default(link) {
  ...
  const obj3 = { containerStyle: tmp.emptyStateContainer, imageStyle: tmp.emptyStateArt, titleStyle: tmp.emptyStateTitle, source: _modDef10005, title: null, body: null };
  ...
  obj6.children = closure_5(stateFromStores(7494).SettingsIcon, {});
  items2[1] = closure_5(stateFromStores(5210).PressableOpacity, obj6);
  ...
  if (null == stateFromStores) {
    ...
    items1[3] = tmp7(tmp2(5062).Button, obj8);
    obj2.children = items1;
    return tmp5(tmp6, obj2);
  } else {
    const maxAgeOptionByValue = tmp8(9973).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(9973).getMaxUsesOptions;
