...
// Dependencies: [19, 17, 9961, 21, 4638, 576, 504, 1177, 9994, 1115, 7047, 5208, 7490, 4634, 9962, 5060, 2]
// Exports: default

// Module 9993 (InstantInviteEmptyState)
...
export default function _default(link) {
  ...
  const obj3 = { containerStyle: tmp.emptyStateContainer, imageStyle: tmp.emptyStateArt, titleStyle: tmp.emptyStateTitle, source: _modDef9994, title: null, body: null };
  ...
  obj6.children = closure_5(stateFromStores(7490).SettingsIcon, {});
  items2[1] = closure_5(stateFromStores(5208).PressableOpacity, obj6);
  ...
  if (null == stateFromStores) {
    ...
    items1[3] = tmp7(tmp2(5060).Button, obj8);
    obj2.children = items1;
    return tmp5(tmp6, obj2);
  } else {
    const maxAgeOptionByValue = tmp8(9962).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(9962).getMaxUsesOptions;
