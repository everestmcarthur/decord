...
// Dependencies: [32, 19, 17, 9949, 21, 4607, 576, 5034, 6727, 9983, 8173, 9146, 2]

// Module 9948 (InstantInviteShareApps)
...
const InstantInviteConstants = fn(9949);
...
export default noop.memo(function InstantInviteShareApps(onItemPressed) {
  ...
  closure_1 = onItemPressed(5034).useFontScale();
  let obj = onItemPressed(5034);
  [arr, c2] = noop.useState(closure_8);
  const tmp2 = _slicedToArray(noop.useState(closure_8), 2);
  const gesture = onItemPressed(6727).useNativeGesture({ disallowInterruption: true });
  ...
  return jsx(onItemPressed(6727).GestureDetector, { gesture, children });
});
