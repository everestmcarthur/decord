...
// Dependencies: [32, 19, 17, 10101, 21, 4722, 576, 5151, 6848, 10135, 8140, 9292, 2]

// Module 10100 (InstantInviteShareApps)
...
const InstantInviteConstants = fn(10101);
...
export default noop.memo(function InstantInviteShareApps(onItemPressed) {
  ...
  closure_1 = onItemPressed(5151).useFontScale();
  let obj = onItemPressed(5151);
  [arr, c2] = noop.useState(closure_8);
  const tmp2 = _slicedToArray(noop.useState(closure_8), 2);
  const gesture = onItemPressed(6848).useNativeGesture({ disallowInterruption: true });
  ...
  return jsx(onItemPressed(6848).GestureDetector, { gesture, children });
});
