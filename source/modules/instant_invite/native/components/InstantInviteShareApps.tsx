...
// Dependencies: [32, 19, 17, 10007, 21, 4640, 576, 5069, 6766, 10041, 8057, 9208, 2]

// Module 10006 (InstantInviteShareApps)
...
const InstantInviteConstants = fn(10007);
...
export default noop.memo(function InstantInviteShareApps(onItemPressed) {
  ...
  closure_1 = onItemPressed(5069).useFontScale();
  let obj = onItemPressed(5069);
  [arr, c2] = noop.useState(closure_8);
  const tmp2 = _slicedToArray(noop.useState(closure_8), 2);
  const gesture = onItemPressed(6766).useNativeGesture({ disallowInterruption: true });
  ...
  return jsx(onItemPressed(6766).GestureDetector, { gesture, children });
});
