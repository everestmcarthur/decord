...
// Dependencies: [19, 17, 1980, 1372, 1074, 21, 4639, 576, 5669, 504, 1115, 573, 4337, 7304, 7256, 9996, 4635, 2]
// Exports: default

// Module 9995 (InstantInviteQRCodeActionSheet)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import GuildIconDefault from "GuildIcon" /* 5669 */;
import components_native_QRCodeDefault from "components_native/QRCode" /* 9996 */;
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != GuildStore.getGuild(channel2.guild_id)) {
        const obj4 = { guild: obj8.getGuild(channel2.guild_id), size: tmp6(5669).GuildIconSizes.LARGE };
    ...
    if (tmp19Result2) {
      ...
      tmp19Result2 = tmp19(tmp6(4635).Text, obj13);
    }
