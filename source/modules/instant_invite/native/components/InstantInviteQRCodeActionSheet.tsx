...
// Dependencies: [19, 17, 1979, 1371, 1074, 21, 4574, 576, 5598, 504, 1114, 573, 4271, 7211, 7163, 9896, 4570, 2]
// Exports: default

// Module 9895 (InstantInviteQRCodeActionSheet)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import GuildIconDefault from "GuildIcon" /* 5598 */;
import components_native_QRCodeDefault from "components_native/QRCode" /* 9896 */;
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != GuildStore.getGuild(channel2.guild_id)) {
        const obj4 = { guild: obj8.getGuild(channel2.guild_id), size: tmp6(5598).GuildIconSizes.LARGE };
        tmp13 = closure_9(GuildIconDefault, obj4);
      }
      obj8 = GuildStore;
    }
    presentFriendRequestAcceptedToast = tmp6(4271).presentFriendRequestAcceptedToast;
    ...
    obj5.header = closure_9(tmp6(7163).BottomSheetTitleHeader, obj6);
    ...
    if (tmp19Result2) {
      ...
      tmp19Result2 = tmp19(tmp6(4570).Text, obj13);
    }
    items3[1] = tmp19Result2;
    obj7.children = items3;
    obj5.children = closure_10(View, obj7);
    return closure_9(tmp6(7211).ActionSheet, obj5);
  }
  tmp12 = null;
