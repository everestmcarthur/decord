...
// Dependencies: [19, 17, 1980, 1372, 1074, 21, 4640, 576, 5672, 504, 1115, 573, 4337, 7311, 7263, 10015, 4636, 2]
// Exports: default

// Module 10014 (InstantInviteQRCodeActionSheet)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import GuildIconDefault from "GuildIcon" /* 5672 */;
import components_native_QRCodeDefault from "components_native/QRCode" /* 10015 */;
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != GuildStore.getGuild(channel2.guild_id)) {
        const obj4 = { guild: obj8.getGuild(channel2.guild_id), size: tmp6(5672).GuildIconSizes.LARGE };
    ...
    if (tmp19Result2) {
      ...
      tmp19Result2 = tmp19(tmp6(4636).Text, obj13);
    }
