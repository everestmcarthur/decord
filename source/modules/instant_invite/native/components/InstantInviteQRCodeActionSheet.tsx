...
// Dependencies: [19, 17, 1979, 1371, 1074, 21, 4607, 576, 5636, 504, 1114, 573, 4304, 7271, 7223, 9957, 4603, 2]
// Exports: default

// Module 9956 (InstantInviteQRCodeActionSheet)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import GuildIconDefault from "GuildIcon" /* 5636 */;
import components_native_QRCodeDefault from "components_native/QRCode" /* 9957 */;
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != GuildStore.getGuild(channel2.guild_id)) {
        const obj4 = { guild: obj8.getGuild(channel2.guild_id), size: tmp6(5636).GuildIconSizes.LARGE };
        tmp13 = closure_9(GuildIconDefault, obj4);
      }
      obj8 = GuildStore;
    }
    presentFriendRequestAcceptedToast = tmp6(4304).presentFriendRequestAcceptedToast;
    ...
    obj5.header = closure_9(tmp6(7223).BottomSheetTitleHeader, obj6);
    ...
    if (tmp19Result2) {
      ...
      tmp19Result2 = tmp19(tmp6(4603).Text, obj13);
    }
    items3[1] = tmp19Result2;
    obj7.children = items3;
    obj5.children = closure_10(View, obj7);
    return closure_9(tmp6(7271).ActionSheet, obj5);
  }
  tmp12 = null;
