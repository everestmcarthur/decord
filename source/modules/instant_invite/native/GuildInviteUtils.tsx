...
// Dependencies: [5, 19, 2012, 4494, 2021, 1979, 4212, 5452, 1371, 13129, 7750, 1074, 1242, 4541, 13130, 1896, 5531, 504, 4285, 1114, 8406, 9854, 9927, 2]
// Exports: sendGuildInvite, showGuildInviteActionSheet, useServerInviteRows

// Module 13128 (GuildInviteUtils)
...
const setSendState = fn(13129).setSendState;
...
export const showGuildInviteActionSheet = function showGuildInviteActionSheet(id, newestAnalyticsLocation) {
  ...
  obj3.openLazy(asyncRequireImpl(13130, dependencyMap.paths), "invite-to-guilds-" + id, { recipientId: id, source: newestAnalyticsLocation });
};
