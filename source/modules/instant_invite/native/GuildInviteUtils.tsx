...
// Dependencies: [5, 19, 2013, 4559, 2022, 1980, 4278, 5526, 1372, 13261, 7856, 1074, 1241, 4607, 13262, 1897, 5605, 504, 4351, 1115, 8527, 9973, 10046, 2]
// Exports: sendGuildInvite, showGuildInviteActionSheet, useServerInviteRows

// Module 13260 (GuildInviteUtils)
...
const setSendState = fn(13261).setSendState;
...
export const showGuildInviteActionSheet = function showGuildInviteActionSheet(id, newestAnalyticsLocation) {
  ...
  obj3.openLazy(asyncRequireImpl(13262, dependencyMap.paths), "invite-to-guilds-" + id, { recipientId: id, source: newestAnalyticsLocation });
};
