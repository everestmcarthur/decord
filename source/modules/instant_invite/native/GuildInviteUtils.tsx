...
// Dependencies: [5, 19, 2012, 4525, 2021, 1979, 4243, 5488, 1371, 13176, 7787, 1074, 1242, 4572, 13177, 1896, 5567, 504, 4316, 1114, 8443, 9892, 9965, 2]
// Exports: sendGuildInvite, showGuildInviteActionSheet, useServerInviteRows

// Module 13175 (GuildInviteUtils)
      ...
      if (0 === c6) {
        ...
        if (1 === tmp7) {
          ...
          closure_132_1(closure_132_2[22]).enqueue(obj7, () => {
            ...
            const AccessibilityAnnouncer = closure_0(4316).AccessibilityAnnouncer;
...
const setSendState = fn(13176).setSendState;
...
export const showGuildInviteActionSheet = function showGuildInviteActionSheet(id, newestAnalyticsLocation) {
  ...
  obj3.openLazy(asyncRequireImpl(13177, dependencyMap.paths), "invite-to-guilds-" + id, { recipientId: id, source: newestAnalyticsLocation });
};
