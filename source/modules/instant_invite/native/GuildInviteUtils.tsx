...
// Dependencies: [5, 19, 2013, 4557, 2022, 1980, 4276, 5524, 1372, 13253, 7850, 1074, 1241, 4605, 13254, 1897, 5603, 504, 4349, 1115, 8508, 9962, 10035, 2]
// Exports: sendGuildInvite, showGuildInviteActionSheet, useServerInviteRows

// Module 13252 (GuildInviteUtils)
      ...
      if (0 === c6) {
        ...
        if (1 === tmp7) {
          ...
          closure_132_1(closure_132_2[22]).enqueue(obj7, () => {
            ...
            const AccessibilityAnnouncer = closure_0(4349).AccessibilityAnnouncer;
...
const setSendState = fn(13253).setSendState;
...
export const showGuildInviteActionSheet = function showGuildInviteActionSheet(id, newestAnalyticsLocation) {
  ...
  obj3.openLazy(asyncRequireImpl(13254, dependencyMap.paths), "invite-to-guilds-" + id, { recipientId: id, source: newestAnalyticsLocation });
};
