...
// Dependencies: [5, 19, 2013, 4641, 2022, 1980, 4361, 5608, 1372, 13352, 7938, 1074, 1241, 4689, 13353, 1897, 5687, 504, 4433, 1115, 8610, 10067, 10140, 2]
// Exports: sendGuildInvite, showGuildInviteActionSheet, useServerInviteRows

// Module 13351 (GuildInviteUtils)
...
const setSendState = fn(13352).setSendState;
...
export const showGuildInviteActionSheet = function showGuildInviteActionSheet(id, newestAnalyticsLocation) {
  ...
  obj3.openLazy(asyncRequireImpl(13353, dependencyMap.paths), "invite-to-guilds-" + id, { recipientId: id, source: newestAnalyticsLocation });
};
