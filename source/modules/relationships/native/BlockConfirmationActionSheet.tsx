...
// Dependencies: [32, 19, 17, 1957, 4255, 1371, 9135, 11478, 1074, 21, 4607, 576, 8271, 1114, 4564, 5739, 5657, 1178, 1611, 7236, 7256, 504, 8267, 7224, 1242, 6699, 8005, 4603, 4759, 7041, 4574, 11480, 1896, 1250, 5027, 9134, 8492, 2024, 4301, 2]

// Module 11479 (BlockConfirmationActionSheet)
...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp2(8005) };
    ...
    const obj13 = { username: tmp2(4759).getName(stateFromStores2, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1114).t.CIbzHR, obj13);
    items9[1] = closure_14(tmp7(4603).Text, obj12);
    ...
    items9[2] = closure_14(tmp7(4603).Text, obj14);
    ...
    if (!stateFromStores1) {
      ...
      const obj19 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp2(7041) };
      ...
      obj18.onPress = function onPress() {
        ...
        const tmp2 = asyncRequireImpl(11480, dependencyMap.paths);
      ...
      obj17.children = tmp13(tmp7(5657).TableRow, obj18);
      obj16.children = tmp13(tmp7(5739).TableRowGroup, obj17);
    ...
    obj22.onPress = function onPress() {
      ...
      obj.blockUser(userId, { location: AnalyticsLocationDefault.BLOCK_CONFIRMATION_ACTION_SHEET }).then(() => {
        const result = channelId(8492).showBlockSuccessToast(userId, closure_1_1);
        if (onSuccess != null) {
          onSuccess();
        }
        const obj = channelId(8492);
    ...
    obj22.disabled = tmp6;
    obj22.loading = tmp6;
    const items11 = [closure_14(tmp7(5027).Button, obj22), ];
    ...
    items11[1] = closure_14(tmp7(4603).Text, obj23);
    obj21.children = items11;
    items10[3] = closure_15(c5, obj21);
    obj20.children = items10;
    obj5.children = closure_15(tmp7(6699).BottomSheetScrollView, obj20);
    obj4.children = closure_14(tmp7(7224).BottomSheet, obj5);
    tmp13Result2 = tmp13(tmp7(7236).AnalyticsLocationProvider, obj4);
