...
// Dependencies: [32, 19, 17, 1957, 4253, 1371, 9112, 11454, 1074, 21, 4605, 576, 8248, 1114, 4562, 5737, 5655, 1178, 1611, 7214, 7234, 504, 8244, 7202, 1242, 6677, 7982, 4601, 4757, 7019, 4572, 11456, 1896, 1250, 5025, 9111, 8469, 2024, 4299, 2]

// Module 11455 (BlockConfirmationActionSheet)
...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp2(7982) };
    ...
    const obj13 = { username: tmp2(4757).getName(stateFromStores2, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1114).t.CIbzHR, obj13);
    items9[1] = closure_14(tmp7(4601).Text, obj12);
    ...
    items9[2] = closure_14(tmp7(4601).Text, obj14);
    ...
    if (!stateFromStores1) {
      ...
      const obj19 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp2(7019) };
      ...
      obj18.onPress = function onPress() {
        ...
        const tmp2 = asyncRequireImpl(11456, dependencyMap.paths);
      ...
      obj17.children = tmp13(tmp7(5655).TableRow, obj18);
      obj16.children = tmp13(tmp7(5737).TableRowGroup, obj17);
    ...
    obj22.disabled = tmp6;
    obj22.loading = tmp6;
    const items11 = [closure_14(tmp7(5025).Button, obj22), ];
    ...
    items11[1] = closure_14(tmp7(4601).Text, obj23);
    obj21.children = items11;
    items10[3] = closure_15(c5, obj21);
    obj20.children = items10;
    obj5.children = closure_15(tmp7(6677).BottomSheetScrollView, obj20);
    obj4.children = closure_14(tmp7(7202).BottomSheet, obj5);
    tmp13Result2 = tmp13(tmp7(7214).AnalyticsLocationProvider, obj4);
