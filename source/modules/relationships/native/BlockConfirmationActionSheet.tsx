...
// Dependencies: [32, 19, 17, 1957, 4222, 1371, 9075, 11414, 1074, 21, 4574, 576, 8211, 1114, 4531, 5701, 5619, 1178, 1611, 7176, 7196, 504, 8207, 7164, 1242, 6641, 7944, 4570, 4726, 6983, 4541, 11416, 1896, 1250, 4989, 9074, 8432, 2024, 4268, 2]

// Module 11415 (BlockConfirmationActionSheet)
...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp2(7944) };
    ...
    const obj13 = { username: tmp2(4726).getName(stateFromStores2, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1114).t.CIbzHR, obj13);
    items9[1] = closure_14(tmp7(4570).Text, obj12);
    ...
    items9[2] = closure_14(tmp7(4570).Text, obj14);
    ...
    if (!stateFromStores1) {
      ...
      const obj19 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp2(6983) };
      ...
      obj18.onPress = function onPress() {
        ...
        const tmp2 = asyncRequireImpl(11416, dependencyMap.paths);
      ...
      obj17.children = tmp13(tmp7(5619).TableRow, obj18);
      obj16.children = tmp13(tmp7(5701).TableRowGroup, obj17);
    ...
    obj22.disabled = tmp6;
    obj22.loading = tmp6;
    const items11 = [closure_14(tmp7(4989).Button, obj22), ];
    ...
    items11[1] = closure_14(tmp7(4570).Text, obj23);
    obj21.children = items11;
    items10[3] = closure_15(c5, obj21);
    obj20.children = items10;
    obj5.children = closure_15(tmp7(6641).BottomSheetScrollView, obj20);
    obj4.children = closure_14(tmp7(7164).BottomSheet, obj5);
    tmp13Result2 = tmp13(tmp7(7176).AnalyticsLocationProvider, obj4);
