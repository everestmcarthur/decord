...
// Dependencies: [32, 19, 17, 1958, 1372, 9175, 11520, 1074, 21, 4639, 576, 8305, 1115, 4596, 5772, 5690, 1177, 1612, 7269, 7289, 504, 1241, 8301, 7257, 6732, 7074, 4635, 4791, 8037, 4606, 11521, 1897, 1249, 5059, 9174, 2025, 4334, 2]

// Module 11522 (IgnoreConfirmationActionSheet)
...
import _modDef4596 from "module_4596" /* 4596 */;
...
import _modDef8305 from "module_8305" /* 8305 */;
...
const UserRemediationAction = fn(9175).UserRemediationAction;
const RestrictionConfirmationConstants = fn(11520);
...
export default noop.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  items = [channelId(7289).IGNORE_CONFIRMATION_ACTION_SHEET];
  const tmp6 = channelId(7269);
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(7074) };
    ...
    const obj13 = { username: tmp4(4791).getName(stateFromStores1, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1115).t["WrQD/Y"], obj13);
    items7[1] = closure_13(tmp7(4635).Text, obj12);
    ...
    items7[2] = closure_13(tmp7(4635).Text, obj14);
    ...
    const obj19 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(8037), color: tmp.destructiveIcon.color };
    ...
    obj18.subLabel = closure_13(tmp7(4635).Text, obj20);
    ...
    obj17.children = closure_13(tmp7(5690).TableRow, obj18);
    obj16.children = closure_13(tmp7(5772).TableRowGroup, obj17);
    ...
    obj22.onPress = function onPress() {
      ...
      RelationshipActionCreatorsDefault.ignoreUser(userId, AnalyticsLocationDefault.IGNORE_CONFIRMATION_ACTION_SHEET, channelId).then(() => {
        ...
        channelId(4606).hideActionSheet();
      });
    ...
    obj22.disabled = tmp3;
    obj22.loading = tmp3;
    const items9 = [closure_13(tmp7(5059).Button, obj22), ];
    ...
    items9[1] = closure_13(tmp7(4635).Text, obj23);
    obj21.children = items9;
    items8[3] = closure_14(stateFromStores, obj21);
    obj8.children = items8;
    obj4.children = closure_14(tmp7(6732).BottomSheetScrollView, obj8);
    obj3.children = closure_13(tmp7(7257).BottomSheet, obj4);
    tmp12Result = tmp12(tmp7(7269).AnalyticsLocationProvider, obj3);
