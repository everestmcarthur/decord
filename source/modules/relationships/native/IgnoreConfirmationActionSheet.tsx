...
// Dependencies: [32, 19, 17, 1957, 1371, 9135, 11478, 1074, 21, 4607, 576, 8271, 1114, 4564, 5739, 5657, 1178, 1611, 7236, 7256, 504, 1242, 8267, 7224, 6699, 7041, 4603, 4759, 8005, 4574, 11479, 1896, 1250, 5027, 9134, 2024, 4301, 2]

// Module 11480 (IgnoreConfirmationActionSheet)
...
import _modDef4564 from "module_4564" /* 4564 */;
...
const UserRemediationAction = fn(9135).UserRemediationAction;
const RestrictionConfirmationConstants = fn(11478);
...
export default noop.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  items = [channelId(7256).IGNORE_CONFIRMATION_ACTION_SHEET];
  const tmp6 = channelId(7236);
  ...
  if (null != stateFromStores) {
    ...
    const obj11 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp4(7041) };
    ...
    const obj13 = { username: tmp4(4759).getName(stateFromStores1, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1114).t["WrQD/Y"], obj13);
    items7[1] = closure_13(tmp7(4603).Text, obj12);
    ...
    items7[2] = closure_13(tmp7(4603).Text, obj14);
    ...
    const obj19 = { size: tmp7(1178).Icon.Sizes.MEDIUM, source: tmp4(8005), color: tmp.destructiveIcon.color };
    ...
    obj18.subLabel = closure_13(tmp7(4603).Text, obj20);
    ...
    obj18.onPress = function onPress() {
      ...
      const tmp2 = asyncRequireImpl(11479, dependencyMap.paths);
    ...
    obj17.children = closure_13(tmp7(5657).TableRow, obj18);
    obj16.children = closure_13(tmp7(5739).TableRowGroup, obj17);
    ...
    obj22.onPress = function onPress() {
      ...
      RelationshipActionCreatorsDefault.ignoreUser(userId, AnalyticsLocationDefault.IGNORE_CONFIRMATION_ACTION_SHEET, channelId).then(() => {
        ...
        channelId(4574).hideActionSheet();
      });
    ...
    obj22.disabled = tmp3;
    obj22.loading = tmp3;
    const items9 = [closure_13(tmp7(5027).Button, obj22), ];
    ...
    items9[1] = closure_13(tmp7(4603).Text, obj23);
    obj21.children = items9;
    items8[3] = closure_14(stateFromStores, obj21);
    obj8.children = items8;
    obj4.children = closure_14(tmp7(6699).BottomSheetScrollView, obj8);
    obj3.children = closure_13(tmp7(7224).BottomSheet, obj4);
    tmp12Result = tmp12(tmp7(7236).AnalyticsLocationProvider, obj3);
    const tmp4Result = tmp4(4759);
  }
  return tmp12Result;
});
