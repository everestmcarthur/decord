...
// Dependencies: [32, 19, 17, 4598, 1074, 21, 4606, 13636, 576, 4541, 563, 4343, 4500, 5025, 5038, 4458, 2]
// Exports: default

// Module 13635 (GuildBoostingMarketingProgressBar)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4343 */;
import GuildBoostingUtils from "GuildBoostingUtils" /* 4500 */;
import spring from "spring" /* 5025 */;
import GuildBoostingMarketingProgressBarMarker from "GuildBoostingMarketingProgressBarMarker" /* 13636 */;
...
let obj2 = { progressBarContainer: { display: "flex", alignItems: "center", width: "100%", marginTop: 40, paddingHorizontal: fn(13636).MARKER_DIMENSIONS / 2 + 34 }, progressBar: { height: 54, maxWidth: 660, width: "100%" }, progressBarScrubber: null, progressBarTrack: null, progressBarFill: null, progressBarGradientFill: null };
let obj3 = { display: "flex", alignItems: "center", width: "100%", marginTop: 40, paddingHorizontal: fn(13636).MARKER_DIMENSIONS / 2 + 34 };
obj2.progressBarScrubber = { height: 8, top: fn(13636).MARKER_DIMENSIONS / 2 - 4, marginHorizontal: fn(13636).MARKER_DIMENSIONS / 2 + 2 };
