...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 8913, 1115, 10263, 12684, 5188, 5184, 10529, 13698, 9525, 4582, 13700, 4640, 576, 13692, 5529, 4376, 4641, 4636, 4574, 4491, 5074, 5210, 4533, 13701, 13703, 4489, 1177, 13705, 13706, 5669, 12716, 2]
// Exports: default

// Module 13697 (GuildBoostingMarketingTierCards)
...
import ServerBoostStreamQualityMarketingExperiment from "ServerBoostStreamQualityMarketingExperiment" /* 13700 */;
...
let items = [
  {
    orderCollapsed: 0,
    isIncluded: true,
    IconComponent: fn(8913).ReactionIcon,
    getCopy() {
...
items[1] = {
  isIncluded: true,
  IconComponent: fn(10263).StickerIcon,
  getCopy() {
    const intl = util.intl;
...
items[2] = {
  isIncluded: true,
  IconComponent: fn(12684).ScreenArrowIcon,
  getCopy() {
    const intl = util.intl;
...
items[3] = {
  orderCollapsed: 2,
  isIncluded: true,
  IconComponent: fn(5188).VoiceNormalIcon,
  getCopy() {
    const intl = util.intl;
...
items[4] = {
  isIncluded: true,
  IconComponent: fn(5184).StageIcon,
  getCopy() {
    const intl = util.intl;
...
items[5] = {
  orderCollapsed: 1,
  isIncluded: true,
  IconComponent: fn(10529).GifIcon,
  getCopy() {
    const intl = util.intl;
...
items[6] = {
  isIncluded: true,
  IconComponent: fn(13698).ServerGridIcon,
  getCopy() {
    const intl = util.intl;
...
items[7] = {
  isIncluded: false,
  IconComponent: fn(9525).UploadIcon,
  getCopy() {
    const intl = util.intl;
...
items[10] = {
  isIncluded: false,
  IconComponent: fn(4582).LinkIcon,
  getCopy() {
    const intl = util.intl;
...
obj37.cardsScroller = { flex: 1, marginTop: fn(13692).PROGRESS_BAR_SPACING };
...
const obj41 = { flex: 1, marginTop: fn(13692).PROGRESS_BAR_SPACING };
obj37.sparkleStar = { position: "absolute", tintColor: fn(5529).DARK_WHITE_500_LIGHT_GUILD_BOOSTING_PINK };
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13701).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13703).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      const tmp2Result4 = tmp2(5074);
      const items7 = [tmp7(4489).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result7 = tmp7(4489);
      items7[1] = tmp7(4489).hexWithOpacity(tmp9, 1);
      const tmp7Result8 = tmp7(4489);
      items7[2] = tmp7(4489).hexWithOpacity(tmp9, 0);
      obj15.colors = items7;
      obj15.start = { x: 0, y: 0 };
      obj15.end = { x: 1, y: 0 };
      ...
      const tmp7Result9 = tmp7(4489);
      const tmp2Result5 = tmp2(5074);
      const items10 = [tmp7(4489).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result10 = tmp7(4489);
      items10[1] = tmp7(4489).hexWithOpacity(tmp9, 1);
      const tmp7Result11 = tmp7(4489);
      items10[2] = tmp7(4489).hexWithOpacity(tmp9, 0);
    ...
    obj22 = tmp13(tmp7(4636).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5074), obj21);
    const tmp2Result6 = tmp2(5074);
  }
});
const size = fn(2);
