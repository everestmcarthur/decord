...
// Dependencies: [32, 19, 17, 1074, 1373, 21, 8850, 1114, 10205, 12627, 5153, 5149, 10472, 13643, 9464, 4550, 13645, 4607, 576, 13637, 5493, 4343, 4608, 4603, 4542, 4458, 5039, 5175, 4501, 13646, 13648, 4456, 1178, 13650, 13651, 5633, 12659, 2]
// Exports: default

// Module 13642 (GuildBoostingMarketingTierCards)
...
import ServerBoostStreamQualityMarketingExperiment from "ServerBoostStreamQualityMarketingExperiment" /* 13645 */;
...
let items = [
  {
    orderCollapsed: 0,
    isIncluded: true,
    IconComponent: fn(8850).ReactionIcon,
    getCopy() {
...
items[1] = {
  isIncluded: true,
  IconComponent: fn(10205).StickerIcon,
  getCopy() {
    const intl = util.intl;
...
items[2] = {
  isIncluded: true,
  IconComponent: fn(12627).ScreenArrowIcon,
  getCopy() {
    const intl = util.intl;
...
items[3] = {
  orderCollapsed: 2,
  isIncluded: true,
  IconComponent: fn(5153).VoiceNormalIcon,
  getCopy() {
    const intl = util.intl;
...
items[4] = {
  isIncluded: true,
  IconComponent: fn(5149).StageIcon,
  getCopy() {
    const intl = util.intl;
...
items[5] = {
  orderCollapsed: 1,
  isIncluded: true,
  IconComponent: fn(10472).GifIcon,
  getCopy() {
    const intl = util.intl;
...
items[6] = {
  isIncluded: true,
  IconComponent: fn(13643).ServerGridIcon,
  getCopy() {
    const intl = util.intl;
...
items[7] = {
  isIncluded: false,
  IconComponent: fn(9464).UploadIcon,
  getCopy() {
    const intl = util.intl;
...
items[10] = {
  isIncluded: false,
  IconComponent: fn(4550).LinkIcon,
  getCopy() {
    const intl = util.intl;
...
obj37.cardsScroller = { flex: 1, marginTop: fn(13637).PROGRESS_BAR_SPACING };
...
const obj41 = { flex: 1, marginTop: fn(13637).PROGRESS_BAR_SPACING };
obj37.sparkleStar = { position: "absolute", tintColor: fn(5493).DARK_WHITE_500_LIGHT_GUILD_BOOSTING_PINK };
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13646).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13648).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      const items7 = [tmp7(4456).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result7 = tmp7(4456);
      items7[1] = tmp7(4456).hexWithOpacity(tmp9, 1);
      const tmp7Result8 = tmp7(4456);
      items7[2] = tmp7(4456).hexWithOpacity(tmp9, 0);
      obj15.colors = items7;
      obj15.start = { x: 0, y: 0 };
      obj15.end = { x: 1, y: 0 };
      ...
      const tmp7Result9 = tmp7(4456);
      const tmp2Result5 = tmp2(5039);
      const items10 = [tmp7(4456).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result10 = tmp7(4456);
      items10[1] = tmp7(4456).hexWithOpacity(tmp9, 1);
      const tmp7Result11 = tmp7(4456);
      items10[2] = tmp7(4456).hexWithOpacity(tmp9, 0);
    ...
    obj22 = tmp13(tmp7(4603).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5039), obj21);
    const tmp2Result6 = tmp2(5039);
  }
});
const size = fn(2);
