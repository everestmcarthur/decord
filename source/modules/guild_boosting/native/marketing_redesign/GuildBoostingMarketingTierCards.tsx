...
// Dependencies: [32, 19, 17, 1074, 1373, 21, 8827, 1114, 10184, 12602, 5151, 5147, 10451, 13451, 9441, 4548, 13664, 4605, 576, 13658, 5491, 4341, 4606, 4601, 4540, 4456, 5037, 5173, 4499, 13665, 13667, 4454, 1178, 13669, 13670, 5631, 12634, 2]
// Exports: default

// Module 13663 (GuildBoostingMarketingTierCards)
...
import ServerBoostStreamQualityMarketingExperiment from "ServerBoostStreamQualityMarketingExperiment" /* 13664 */;
...
obj37.cardsScroller = { flex: 1, marginTop: fn(13658).PROGRESS_BAR_SPACING };
...
const obj41 = { flex: 1, marginTop: fn(13658).PROGRESS_BAR_SPACING };
obj37.sparkleStar = { position: "absolute", tintColor: fn(5491).DARK_WHITE_500_LIGHT_GUILD_BOOSTING_PINK };
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13665).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13667).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      const tmp2Result4 = tmp2(5037);
      const items7 = [tmp7(4454).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result7 = tmp7(4454);
      items7[1] = tmp7(4454).hexWithOpacity(tmp9, 1);
      const tmp7Result8 = tmp7(4454);
      items7[2] = tmp7(4454).hexWithOpacity(tmp9, 0);
      obj15.colors = items7;
      obj15.start = { x: 0, y: 0 };
      obj15.end = { x: 1, y: 0 };
      ...
      const tmp7Result9 = tmp7(4454);
      const tmp2Result5 = tmp2(5037);
      const items10 = [tmp7(4454).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result10 = tmp7(4454);
      items10[1] = tmp7(4454).hexWithOpacity(tmp9, 1);
      const tmp7Result11 = tmp7(4454);
      items10[2] = tmp7(4454).hexWithOpacity(tmp9, 0);
    ...
    obj22 = tmp13(tmp7(4601).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5037), obj21);
    const tmp2Result6 = tmp2(5037);
  }
});
const size = fn(2);
