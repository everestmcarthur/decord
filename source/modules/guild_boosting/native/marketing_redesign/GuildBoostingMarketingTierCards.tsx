...
// Dependencies: [32, 19, 17, 1074, 1373, 21, 8848, 1114, 10203, 12625, 5152, 5148, 10470, 13641, 9462, 4549, 13643, 4606, 576, 13635, 5492, 4343, 4607, 4602, 4541, 4458, 5038, 5174, 4500, 13644, 13646, 4456, 1178, 13648, 13649, 5632, 12657, 2]
// Exports: default

// Module 13640 (GuildBoostingMarketingTierCards)
...
import ServerBoostStreamQualityMarketingExperiment from "ServerBoostStreamQualityMarketingExperiment" /* 13643 */;
...
obj37.cardsScroller = { flex: 1, marginTop: fn(13635).PROGRESS_BAR_SPACING };
...
const obj41 = { flex: 1, marginTop: fn(13635).PROGRESS_BAR_SPACING };
obj37.sparkleStar = { position: "absolute", tintColor: fn(5492).DARK_WHITE_500_LIGHT_GUILD_BOOSTING_PINK };
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13644).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13646).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    obj22 = tmp13(tmp7(4602).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5038), obj21);
    const tmp2Result6 = tmp2(5038);
  }
});
const size = fn(2);
