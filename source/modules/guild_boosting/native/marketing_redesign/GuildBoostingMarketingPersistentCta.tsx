...
// Dependencies: [19, 17, 4631, 1074, 21, 4639, 576, 563, 4376, 5058, 5071, 5669, 4635, 7509, 2]
// Exports: default

// Module 7508 (GuildBoostingMarketingPersistentCta)
...
export default function GuildBoostingMarketingPersistentCta(arg0) {
  ...
  fn.__closure = { useReducedMotion: stateFromStores, VISIBILITY_OFFSET: 120, withSpring: isVisible(5058).withSpring, isVisible, SPRING_CONFIG };
  ...
  const obj3 = { useReducedMotion: stateFromStores, VISIBILITY_OFFSET: 120, withSpring: isVisible(5058).withSpring, isVisible, SPRING_CONFIG };
  ...
  const tmp4 = stateFromStores(5071);
  obj8.size = isVisible(5669).GuildIconSizes.LARGE;
  const items3 = [closure_6(stateFromStores(5669), obj8), closure_6(isVisible(4635).Text, { style: tmp.guildName, variant: "text-md/bold", lineClamp: 1, children: guild.name })];
  obj7.children = items3;
  const items4 = [closure_7(View, obj7), ];
  const obj10 = { style: tmp.buttonContainer, children: closure_6(stateFromStores(7509), { guild, previousGuildSubscriptionSlot, useShortenedCTA: true, styles: tmp.button, analyticsSection: AnalyticsSections.PREMIUM_GUILD_USER_MODAL_FLOATING_CTA_BAR, fractionalPremiumState, premiumGroupRole }) };
