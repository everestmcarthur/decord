...
// Dependencies: [19, 17, 1074, 21, 13686, 13687, 13688, 4638, 576, 4572, 4374, 4487, 4489, 5059, 12727, 11706, 4634, 4531, 2]
// Exports: default

// Module 13685 (GuildBoostingMarketingProgressBarMarker)
...
let obj2 = { [TIER_1]: _modDef13686, [TIER_2]: _modDef13687, [TIER_3]: _modDef13688 };
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items1[1] = obj4;
    obj3.style = items1;
    const animatedStyle = tmp5(4374).useAnimatedStyle(P);
    const obj5 = { style: null };
    const items2 = [tmp.progressBarMarkerBackground, animatedStyle];
    obj5.style = items2;
    const items3 = [closure_7(tmp2(4374).View, obj5), , ];
    ...
    if (tmp20Result) {
      const obj8 = { source: tmp2(11706), style: tmp.progressBarMarkerUnlockedIcon };
    ...
    obj9.children = tmp5(4531).getTierName(tier, { useLevels: false });
    items5[1] = closure_7(tmp5(4634).Text, obj9);
    obj7.children = items5;
    items3[2] = closure_8(PREMIUM_PERK_PINK, obj7);
    obj3.children = items3;
    return closure_8(PREMIUM_PERK_PINK, obj3);
  }
  const tmp4 = sharedValue(4572)();
  const tmp5Result5 = useReducedMotion(4489);
  const isThemeDarkResult = useReducedMotion(4489).isThemeDark(tmp4);
  const hexWithOpacity = useReducedMotion(4487).hexWithOpacity;
