...
// Dependencies: [19, 17, 1074, 21, 13694, 13695, 13696, 4640, 576, 4574, 4376, 4489, 4491, 5061, 12736, 11714, 4636, 4533, 2]
// Exports: default

// Module 13693 (GuildBoostingMarketingProgressBarMarker)
...
let obj2 = { [TIER_1]: _modDef13694, [TIER_2]: _modDef13695, [TIER_3]: _modDef13696 };
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    if (tmp20Result) {
      const obj8 = { source: tmp2(11714), style: tmp.progressBarMarkerUnlockedIcon };
    ...
    items5[1] = closure_7(tmp5(4636).Text, obj9);
