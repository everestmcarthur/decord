...
// Dependencies: [19, 17, 1074, 21, 13611, 13612, 13613, 4574, 576, 4509, 4310, 4423, 4425, 4988, 12614, 11595, 4570, 4468, 2]
// Exports: default

// Module 13610 (GuildBoostingMarketingProgressBarMarker)
...
let obj2 = { [TIER_1]: _modDef13611, [TIER_2]: _modDef13612, [TIER_3]: _modDef13613 };
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items1[1] = obj4;
    obj3.style = items1;
    const animatedStyle = tmp5(4310).useAnimatedStyle(P);
    const obj5 = { style: null };
    const items2 = [tmp.progressBarMarkerBackground, animatedStyle];
    obj5.style = items2;
    const items3 = [closure_7(tmp2(4310).View, obj5), , ];
    ...
    if (tmp20Result) {
      const obj8 = { source: tmp2(11595), style: tmp.progressBarMarkerUnlockedIcon };
    ...
    obj9.children = tmp5(4468).getTierName(tier, { useLevels: false });
    items5[1] = closure_7(tmp5(4570).Text, obj9);
    obj7.children = items5;
    items3[2] = closure_8(PREMIUM_PERK_PINK, obj7);
    obj3.children = items3;
    return closure_8(PREMIUM_PERK_PINK, obj3);
  }
  const tmp4 = sharedValue(4509)();
  const tmp5Result5 = useReducedMotion(4425);
  const isThemeDarkResult = useReducedMotion(4425).isThemeDark(tmp4);
  const hexWithOpacity = useReducedMotion(4423).hexWithOpacity;
