...
// Dependencies: [32, 19, 17, 1372, 4534, 1074, 1374, 21, 1091, 4640, 576, 1177, 4376, 4641, 7276, 7296, 563, 13568, 8202, 4548, 4297, 1380, 13627, 13629, 5074, 13686, 4636, 1115, 5672, 5210, 13614, 7516, 13689, 13690, 5062, 5522, 10810, 13691, 9546, 2]
// Exports: default

// Module 13685 (GuildBoostingMarketingCtaBar)
import nativeDefault from "native" /* 576 */;
import DurationsDefault from "Durations" /* 1091 */;
import timing from "timing" /* 4641 */;
import actions_BoostingActionCreators from "actions/BoostingActionCreators" /* 5522 */;
...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  analyticsLocations = isVisible(7276)(isVisible(7296).BOOSTED_GUILD_PERKS_MODAL).analyticsLocations;
  const tmp6 = isVisible(7276);
  const items = [ref];
  ...
  let obj3 = guild(4376);
  fn.__closure = { withTiming: guild(4641).withTiming, isVisible };
  fn.__workletHash = 6895237370657;
  fn.__initData = __initData;
  closure_130_0 = tmp12;
  const animatedStyle = obj3.useAnimatedStyle(fn);
  const obj4 = { withTiming: guild(4641).withTiming, isVisible };
  ...
  const obj5 = guild(4376);
  fn2.__closure = { withTiming: guild(4641).withTiming, isVisible: !isVisible };
  fn2.__workletHash = 6895237370657;
  fn2.__initData = __initData;
  const animatedStyle1 = obj5.useAnimatedStyle(fn2);
  const obj6 = { withTiming: guild(4641).withTiming, isVisible: !isVisible };
  const tmp14 = isVisible(13568);
  const tmp14Result = isVisible(13568)(fractionalPremiumInfo.endsAt, guild(13568).CountDownMessageTypes.LONG_TIME_LEFT);
  const isInReverseTrial = guild(8202).useIsInReverseTrial();
  const obj7 = guild(8202);
  ...
  const tmp4Result = isVisible(5074);
  const items5 = [closure_12(isVisible(13686), { guild }), , , ];
  ...
  const items6 = [closure_12(guild(4636).Heading, obj14), , , , ];
  const obj15 = { style: tmp.guildIcon, textStyle: tmp.guildIconText, guild, size: null };
  const tmp4Result3 = isVisible(5074);
  obj15.size = guild(5672).GuildIconSizes.LARGE;
  items6[1] = closure_12(isVisible(5672), obj15);
  const obj16 = {
    onPress() {
      window.clearTimeout(ref.current);
      closure_2((arg0) => !arg0);
  ...
  const items7 = [closure_12(guild(4636).Text, { style: tmp.guildName, color: "text-overlay-light", variant: "text-md/bold", children: guild.name }), ];
  ...
  const tmp4Result4 = isVisible(5672);
  const items9 = [closure_12(guild(1177).Icon, { style: tmp.guildBoostCountIcon, source: isVisible(13614), color: isVisible(576).unsafe_rawColors.GUILD_BOOSTING_PINK, size: guild(1177).Icon.Sizes.SMALL }), ];
  ...
  obj21.children = intl2.format(guild(1115).t["pob/cL"], { subscriptions: isVisible(4548)(premiumGroupRole.guild.id).total });
  items9[1] = closure_12(guild(4636).Text, obj21);
  obj19.children = items9;
  const items10 = [closure_13(isVisible(4376).View, obj19), ];
  ...
  obj22.children = closure_12(guild(4636).Text, obj23);
  items10[1] = closure_12(isVisible(4376).View, obj22);
  obj18.children = items10;
  items7[1] = closure_13(memo, obj18);
  obj16.children = items7;
  items6[2] = closure_13(guild(5210).PressableOpacity, obj16);
  items6[3] = tmp20;
  ...
  items6[4] = closure_12(isVisible(7516), obj24);
  obj13.children = items6;
  items5[1] = closure_13(memo, obj13);
  items5[2] = closure_12(isVisible(13689), { style: tmp.headerStars });
  items5[3] = closure_12(isVisible(13690), { style: tmp.headerWave });
  ...
  if (isPremiumResult) {
    ...
    const obj29 = { size: tmp7(1177).Icon.Sizes.SMALL, source: tmp4(13691), style: tmp.giftIcon };
  ...
  obj27.children = closure_12(guild(5062).Button, obj30);
