...
// Dependencies: [32, 19, 17, 1371, 4501, 1074, 1373, 21, 1090, 4606, 576, 1178, 4343, 4607, 7235, 7255, 563, 13509, 8140, 4515, 4264, 1379, 13568, 13570, 5038, 13629, 4602, 1114, 5635, 5174, 13555, 7475, 13632, 13633, 5026, 5485, 10750, 13634, 9483, 2]
// Exports: default

// Module 13628 (GuildBoostingMarketingCtaBar)
...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  analyticsLocations = isVisible(7235)(isVisible(7255).BOOSTED_GUILD_PERKS_MODAL).analyticsLocations;
  const tmp6 = isVisible(7235);
  const items = [ref];
  ...
  let obj3 = guild(4343);
  fn.__closure = { withTiming: guild(4607).withTiming, isVisible };
  fn.__workletHash = 6895237370657;
  fn.__initData = __initData;
  closure_130_0 = tmp12;
  const animatedStyle = obj3.useAnimatedStyle(fn);
  const obj4 = { withTiming: guild(4607).withTiming, isVisible };
  ...
  fn2.__closure = { withTiming: guild(4607).withTiming, isVisible: !isVisible };
  fn2.__workletHash = 6895237370657;
  fn2.__initData = __initData;
  const animatedStyle1 = obj5.useAnimatedStyle(fn2);
  const obj6 = { withTiming: guild(4607).withTiming, isVisible: !isVisible };
  const tmp14 = isVisible(13509);
  const tmp14Result = isVisible(13509)(fractionalPremiumInfo.endsAt, guild(13509).CountDownMessageTypes.LONG_TIME_LEFT);
  const isInReverseTrial = guild(8140).useIsInReverseTrial();
  const obj7 = guild(8140);
  ...
  if (premiumGroupRole === guild(1379).PremiumSubscriptionGroupRole.MEMBER) {
    ...
    let tmp20 = closure_12(tmp4(13568), obj9);
  } else {
    tmp20 = null;
    if (fractionalPremiumInfo.fractionalState !== FractionalPremiumStates.NONE) {
      ...
      tmp20 = closure_12(tmp4(13570), obj10);
    }
  }
  ...
  const tmp4Result = isVisible(5038);
  const items5 = [closure_12(isVisible(13629), { guild }), , , ];
  ...
  const items6 = [closure_12(guild(4602).Heading, obj14), , , , ];
  const obj15 = { style: tmp.guildIcon, textStyle: tmp.guildIconText, guild, size: null };
  const tmp4Result3 = isVisible(5038);
  obj15.size = guild(5635).GuildIconSizes.LARGE;
  items6[1] = closure_12(isVisible(5635), obj15);
  const obj16 = {
    onPress() {
      window.clearTimeout(ref.current);
      closure_2((arg0) => !arg0);
  ...
  const items7 = [closure_12(guild(4602).Text, { style: tmp.guildName, color: "text-overlay-light", variant: "text-md/bold", children: guild.name }), ];
  ...
  const tmp4Result4 = isVisible(5635);
  const items9 = [closure_12(guild(1178).Icon, { style: tmp.guildBoostCountIcon, source: isVisible(13555), color: isVisible(576).unsafe_rawColors.GUILD_BOOSTING_PINK, size: guild(1178).Icon.Sizes.SMALL }), ];
  ...
  obj21.children = intl2.format(guild(1114).t["pob/cL"], { subscriptions: isVisible(4515)(premiumGroupRole.guild.id).total });
  items9[1] = closure_12(guild(4602).Text, obj21);
  ...
  items6[4] = closure_12(isVisible(7475), obj24);
  obj13.children = items6;
  items5[1] = closure_13(memo, obj13);
  items5[2] = closure_12(isVisible(13632), { style: tmp.headerStars });
  items5[3] = closure_12(isVisible(13633), { style: tmp.headerWave });
  ...
  if (isPremiumResult) {
    ...
    const obj29 = { size: tmp7(1178).Icon.Sizes.SMALL, source: tmp4(13634), style: tmp.giftIcon };
  ...
  obj27.children = closure_12(guild(5026).Button, obj30);
