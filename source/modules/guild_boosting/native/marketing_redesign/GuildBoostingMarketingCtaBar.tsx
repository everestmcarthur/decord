...
// Dependencies: [32, 19, 17, 1372, 4532, 1074, 1374, 21, 1091, 4638, 576, 1177, 4374, 4639, 7272, 7292, 563, 13560, 8182, 4546, 4295, 1380, 13619, 13621, 5072, 13678, 4634, 1115, 5670, 5208, 13606, 7512, 13681, 13682, 5060, 5520, 10802, 13683, 9535, 2]
// Exports: default

// Module 13677 (GuildBoostingMarketingCtaBar)
...
import GuildBoostSlotStore from "GuildBoostSlotStore" /* 4532 */;
...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  analyticsLocations = isVisible(7272)(isVisible(7292).BOOSTED_GUILD_PERKS_MODAL).analyticsLocations;
  const tmp6 = isVisible(7272);
  const items = [ref];
  ...
  let obj3 = guild(4374);
  fn.__closure = { withTiming: guild(4639).withTiming, isVisible };
  fn.__workletHash = 6895237370657;
  fn.__initData = __initData;
  closure_130_0 = tmp12;
  const animatedStyle = obj3.useAnimatedStyle(fn);
  const obj4 = { withTiming: guild(4639).withTiming, isVisible };
  ...
  const obj5 = guild(4374);
  fn2.__closure = { withTiming: guild(4639).withTiming, isVisible: !isVisible };
  fn2.__workletHash = 6895237370657;
  fn2.__initData = __initData;
  const animatedStyle1 = obj5.useAnimatedStyle(fn2);
  const obj6 = { withTiming: guild(4639).withTiming, isVisible: !isVisible };
  const tmp14 = isVisible(13560);
  const tmp14Result = isVisible(13560)(fractionalPremiumInfo.endsAt, guild(13560).CountDownMessageTypes.LONG_TIME_LEFT);
  const isInReverseTrial = guild(8182).useIsInReverseTrial();
  const obj7 = guild(8182);
  ...
  const tmp4Result = isVisible(5072);
  const items5 = [closure_12(isVisible(13678), { guild }), , , ];
  ...
  const items6 = [closure_12(guild(4634).Heading, obj14), , , , ];
  const obj15 = { style: tmp.guildIcon, textStyle: tmp.guildIconText, guild, size: null };
  const tmp4Result3 = isVisible(5072);
  obj15.size = guild(5670).GuildIconSizes.LARGE;
  items6[1] = closure_12(isVisible(5670), obj15);
  const obj16 = {
    onPress() {
      window.clearTimeout(ref.current);
      closure_2((arg0) => !arg0);
  ...
  const items7 = [closure_12(guild(4634).Text, { style: tmp.guildName, color: "text-overlay-light", variant: "text-md/bold", children: guild.name }), ];
  ...
  const tmp4Result4 = isVisible(5670);
  const items9 = [closure_12(guild(1177).Icon, { style: tmp.guildBoostCountIcon, source: isVisible(13606), color: isVisible(576).unsafe_rawColors.GUILD_BOOSTING_PINK, size: guild(1177).Icon.Sizes.SMALL }), ];
  ...
  obj21.children = intl2.format(guild(1115).t["pob/cL"], { subscriptions: isVisible(4546)(premiumGroupRole.guild.id).total });
  items9[1] = closure_12(guild(4634).Text, obj21);
  obj19.children = items9;
  const items10 = [closure_13(isVisible(4374).View, obj19), ];
  ...
  obj22.children = closure_12(guild(4634).Text, obj23);
  items10[1] = closure_12(isVisible(4374).View, obj22);
  obj18.children = items10;
  items7[1] = closure_13(memo, obj18);
  obj16.children = items7;
  items6[2] = closure_13(guild(5208).PressableOpacity, obj16);
  items6[3] = tmp20;
  ...
  items6[4] = closure_12(isVisible(7512), obj24);
  obj13.children = items6;
  items5[1] = closure_13(memo, obj13);
  items5[2] = closure_12(isVisible(13681), { style: tmp.headerStars });
  items5[3] = closure_12(isVisible(13682), { style: tmp.headerWave });
  ...
  if (isPremiumResult) {
    ...
    const obj29 = { size: tmp7(1177).Icon.Sizes.SMALL, source: tmp4(13683), style: tmp.giftIcon };
  ...
  obj27.children = closure_12(guild(5060).Button, obj30);
