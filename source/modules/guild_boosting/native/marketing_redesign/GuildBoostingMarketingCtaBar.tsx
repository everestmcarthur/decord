...
// Dependencies: [32, 19, 17, 1371, 4502, 1074, 1373, 21, 1090, 4607, 576, 1178, 4343, 4608, 7236, 7256, 563, 13511, 8141, 4516, 4264, 1379, 13570, 13572, 5039, 13631, 4603, 1114, 5636, 5175, 13557, 7476, 13634, 13635, 5027, 5486, 10752, 13636, 9485, 2]
// Exports: default

// Module 13630 (GuildBoostingMarketingCtaBar)
...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  analyticsLocations = isVisible(7236)(isVisible(7256).BOOSTED_GUILD_PERKS_MODAL).analyticsLocations;
  const tmp6 = isVisible(7236);
  const items = [ref];
  ...
  let obj3 = guild(4343);
  fn.__closure = { withTiming: guild(4608).withTiming, isVisible };
  fn.__workletHash = 6895237370657;
  fn.__initData = __initData;
  closure_130_0 = tmp12;
  const animatedStyle = obj3.useAnimatedStyle(fn);
  const obj4 = { withTiming: guild(4608).withTiming, isVisible };
  ...
  const obj5 = guild(4343);
  fn2.__closure = { withTiming: guild(4608).withTiming, isVisible: !isVisible };
  fn2.__workletHash = 6895237370657;
  fn2.__initData = __initData;
  const animatedStyle1 = obj5.useAnimatedStyle(fn2);
  const obj6 = { withTiming: guild(4608).withTiming, isVisible: !isVisible };
  const tmp14 = isVisible(13511);
  const tmp14Result = isVisible(13511)(fractionalPremiumInfo.endsAt, guild(13511).CountDownMessageTypes.LONG_TIME_LEFT);
  const isInReverseTrial = guild(8141).useIsInReverseTrial();
  const obj7 = guild(8141);
  ...
  const tmp4Result = isVisible(5039);
  const items5 = [closure_12(isVisible(13631), { guild }), , , ];
  ...
  const items6 = [closure_12(guild(4603).Heading, obj14), , , , ];
  const obj15 = { style: tmp.guildIcon, textStyle: tmp.guildIconText, guild, size: null };
  const tmp4Result3 = isVisible(5039);
  obj15.size = guild(5636).GuildIconSizes.LARGE;
  items6[1] = closure_12(isVisible(5636), obj15);
  const obj16 = {
    onPress() {
      window.clearTimeout(ref.current);
      closure_2((arg0) => !arg0);
  ...
  const items7 = [closure_12(guild(4603).Text, { style: tmp.guildName, color: "text-overlay-light", variant: "text-md/bold", children: guild.name }), ];
  ...
  const tmp4Result4 = isVisible(5636);
  const items9 = [closure_12(guild(1178).Icon, { style: tmp.guildBoostCountIcon, source: isVisible(13557), color: isVisible(576).unsafe_rawColors.GUILD_BOOSTING_PINK, size: guild(1178).Icon.Sizes.SMALL }), ];
  ...
  obj21.children = intl2.format(guild(1114).t["pob/cL"], { subscriptions: isVisible(4516)(premiumGroupRole.guild.id).total });
  items9[1] = closure_12(guild(4603).Text, obj21);
  obj19.children = items9;
  const items10 = [closure_13(isVisible(4343).View, obj19), ];
  ...
  obj22.children = closure_12(guild(4603).Text, obj23);
  items10[1] = closure_12(isVisible(4343).View, obj22);
  obj18.children = items10;
  items7[1] = closure_13(memo, obj18);
  obj16.children = items7;
  items6[2] = closure_13(guild(5175).PressableOpacity, obj16);
  items6[3] = tmp20;
  ...
  items6[4] = closure_12(isVisible(7476), obj24);
  obj13.children = items6;
  items5[1] = closure_13(memo, obj13);
  items5[2] = closure_12(isVisible(13634), { style: tmp.headerStars });
  items5[3] = closure_12(isVisible(13635), { style: tmp.headerWave });
  ...
  if (isPremiumResult) {
    ...
    const obj29 = { size: tmp7(1178).Icon.Sizes.SMALL, source: tmp4(13636), style: tmp.giftIcon };
  ...
  obj27.children = closure_12(guild(5027).Button, obj30);
