...
// Dependencies: [5295, 5293, 4591, 9265, 1074, 504, 17158, 2]
// Exports: default

// Module 17157 (useConsoleConnectedAccountForVoiceUpsell)
...
const require = fn;
const CONSOLE_VOICE_PLATFORMS = fn(9265).CONSOLE_VOICE_PLATFORMS;
