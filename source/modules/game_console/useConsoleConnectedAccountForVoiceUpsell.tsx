...
// Dependencies: [5366, 5364, 4656, 9365, 1074, 504, 17273, 2]
// Exports: default

// Module 17272 (useConsoleConnectedAccountForVoiceUpsell)
...
const require = fn;
const CONSOLE_VOICE_PLATFORMS = fn(9365).CONSOLE_VOICE_PLATFORMS;
