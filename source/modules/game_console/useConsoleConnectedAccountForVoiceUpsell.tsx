...
// Dependencies: [5333, 5331, 4624, 9325, 1074, 504, 17207, 2]
// Exports: default

// Module 17206 (useConsoleConnectedAccountForVoiceUpsell)
...
const require = fn;
const CONSOLE_VOICE_PLATFORMS = fn(9325).CONSOLE_VOICE_PLATFORMS;
