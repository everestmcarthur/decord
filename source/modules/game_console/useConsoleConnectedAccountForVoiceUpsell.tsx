...
// Dependencies: [5331, 5329, 4622, 9302, 1074, 504, 17217, 2]
// Exports: default

// Module 17216 (useConsoleConnectedAccountForVoiceUpsell)
...
const require = fn;
const CONSOLE_VOICE_PLATFORMS = fn(9302).CONSOLE_VOICE_PLATFORMS;
