...
// Dependencies: [5, 502, 1909, 4662, 4657, 4658, 4656, 9365, 4664, 3, 38, 9221, 10140, 7225, 1953, 9580, 1370, 4983, 1115, 17522, 9583, 2]

// Module 17521 (GameConsoleManager)
      ...
      if (null != error) {
        ...
        if (commandId === tmp) {
          ...
          if (null != tmp8Result) {
            ...
            const result1 = tmp6(9583).showSelfDismissableAlert(obj2);
            const tmp6Result = tmp6(9583);
          }
