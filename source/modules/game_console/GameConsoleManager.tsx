...
// Dependencies: [5, 502, 1908, 4659, 4654, 4655, 4653, 9362, 4661, 3, 38, 9218, 10138, 7221, 1952, 9578, 1369, 4980, 1114, 17482, 9581, 2]

// Module 17481 (GameConsoleManager)
      ...
      if (null != error) {
        ...
        if (commandId === tmp) {
          ...
          if (null != tmp8Result) {
            ...
            const result1 = tmp6(9581).showSelfDismissableAlert(obj2);
