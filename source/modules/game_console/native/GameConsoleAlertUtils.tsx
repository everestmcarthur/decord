...
// Dependencies: [19, 1909, 9365, 1074, 21, 4460, 1944, 1115, 4984, 9585, 9384, 2]

// Module 9584 (game_console/GameConsoleAlertUtils)
...
require = fn;
let closure_4 = fn(9365).GAME_CONSOLE_ALERT_MODAL_LOCATION;
...
export default {
        ...
        if (null == obj[XBOX]) {
          ...
          resolved = new Promise((arg0) => {
            ...
            obj2.onConfirm = function onConfirm() {
              const result = closure_0(4460).UNSAFE_markDismissibleContentAsDismissed(closure_0(1944).DismissibleContent.CONSOLE_PTT_DISABLE_ALERT);
              closure_0();
            };
  ...
  showSelfDismissableAlert(reconnectPlatformType) {
    ...
    obj2.body = jsx(reconnectPlatformType(9585).SelfDismissibleAlertBody, { body, errorCodeMessage, dismissCallback: actions_AlertActionCreatorsDefault.close });
    obj2.onConfirm = function onConfirm() {
