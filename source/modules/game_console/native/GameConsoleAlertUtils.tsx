...
// Dependencies: [19, 1909, 9376, 1074, 21, 4458, 1944, 1115, 4983, 9596, 9395, 2]

// Module 9595 (game_console/GameConsoleAlertUtils)
...
export default {
        ...
        if (null == obj[XBOX]) {
          ...
          resolved = new Promise((arg0) => {
            ...
            obj2.onConfirm = function onConfirm() {
              const result = closure_0(4458).UNSAFE_markDismissibleContentAsDismissed(closure_0(1944).DismissibleContent.CONSOLE_PTT_DISABLE_ALERT);
              closure_0();
            };
  ...
  showSelfDismissableAlert(reconnectPlatformType) {
    ...
    obj2.body = jsx(reconnectPlatformType(9596).SelfDismissibleAlertBody, { body, errorCodeMessage, dismissCallback: actions_AlertActionCreatorsDefault.close });
    obj2.onConfirm = function onConfirm() {
