...
// Dependencies: [5, 32, 19, 17, 4622, 1074, 21, 4605, 576, 7175, 5025, 1114, 9527, 4601, 9528, 504, 9518, 38, 9525, 4572, 1109, 1178, 9529, 7202, 7201, 6677, 2]
// Exports: default

// Module 9526 (GameConsoleDeviceListActionSheet)
...
function DeviceOption(children) {
  ...
  const items = [closure_1_12(React6, { style: tmp.deviceIcon, source: _modDef9527 }), closure_1_12(Text_Text.Text, { style: tmp.deviceText, color: "mobile-text-heading-primary", variant: "text-md/bold", children: children.name })];
  obj.children = items;
...
function EmptyState() {
  ...
  const items = [closure_1_12(React6, { source: _modDef9528, style: tmp.emptyArt }), , ];
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj4 = { value: tmp4(9525).transferToPlaystationWithAlert(require, stateFromStores[_slicedToArray], importDefault), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
