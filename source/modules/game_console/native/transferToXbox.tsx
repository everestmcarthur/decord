...
// Dependencies: [5, 19, 17, 1074, 21, 9456, 9453, 9466, 4905, 9467, 1896, 9459, 4702, 2]
// Exports: default

// Module 9465 (_transferToXbox)
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              obj1[0] = closure_1_1(9456).maybeShowPTTAlert(closure_1_6.XBOX);
              return obj1;
            }
          } else if (1 === tmp5) {
            if (arg0 === 1) {
              ...
              obj3[0] = callback2(9453).disconnectRemote();
              return obj3;
            }
          } else if (2 === tmp5) {
            if (arg0 === 1) {
            ...
            if (arg0 === 1) {
              ...
              obj7[0] = callback;
              callback2 = callback(9466)(user, obj7);
              dependencyMap = 4;
              c4 = 1;
            ...
            tmp47(9459)(user.id, constants.XBOX);
            obj3 = callback2(9453);
            ...
            obj11[0] = tmp47(4905).openLazy(obj10);
            return obj11;
          }
        } catch (tmp39) {
          c4 = tmp;
