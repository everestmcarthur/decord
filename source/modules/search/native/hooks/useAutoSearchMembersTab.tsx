...
// Dependencies: [19, 12469, 12483, 1074, 12, 12470, 12491, 12468, 2]
...
export const useAutoSearchMembersTab = function useAutoSearchMembersTab(searchContext, arg1) {
    ...
    if (!closure_1) {
      const debounceResult = _mod12.debounce((searchQueryString) => {
        if (!autocompleteVisible.isAutocompleteVisible(searchContext)) {
          const guildIdFromSearchContext = closure_0(12470).getGuildIdFromSearchContext(tmp);
          if (null != guildIdFromSearchContext) {
            ...
            obj4.threadId = tmp12;
            closure_1(12491).searchGuildMemberTab(obj4);
            const obj3 = closure_1(12491);
          }
          const obj2 = closure_0(12470);
        }
      }, closure_5);
  ...
  const effect1 = noop.useEffect(() => () => {
    const result = closure_1(12491).cleanupGuildMemberTab(searchContext);
  }, items1);
};
