...
// Dependencies: [19, 12491, 12505, 1074, 12, 12492, 12513, 12490, 2]
// Exports: useAutoSearchMembersTab

// Module 16969 (useAutoSearchMembersTab)
...
export const useAutoSearchMembersTab = function useAutoSearchMembersTab(searchContext, arg1) {
    ...
    if (!closure_1) {
      const debounceResult = _mod12.debounce((searchQueryString) => {
        if (!autocompleteVisible.isAutocompleteVisible(searchContext)) {
          const guildIdFromSearchContext = closure_0(12492).getGuildIdFromSearchContext(tmp);
          if (null != guildIdFromSearchContext) {
            ...
            obj4.threadId = tmp12;
            closure_1(12513).searchGuildMemberTab(obj4);
            const obj3 = closure_1(12513);
          }
          const obj2 = closure_0(12492);
        }
      }, closure_5);
  ...
  const effect1 = noop.useEffect(() => () => {
    const result = closure_1(12513).cleanupGuildMemberTab(searchContext);
  }, items1);
};
