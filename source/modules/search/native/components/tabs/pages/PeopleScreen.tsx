...
// Function ID: 16768
// Name: PeopleScreen
// Dependencies: [5, 19, 12460, 12434, 7953, 7952, 21, 12435, 504, 16726, 16722, 4620, 12453, 16768, 16718, 16730, 2]

// Module 16767 (PeopleScreen)
...
let closure_9 = fn(7952).SearchResultContentEntityTypes;
const jsx = fn(21).jsx;
const size = fn(2);
