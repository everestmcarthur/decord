...
// Dependencies: [19, 11768, 7354, 12432, 7952, 7951, 1074, 21, 504, 16726, 11767, 16722, 12451, 16770, 16730, 16729, 16794, 2]
...
let closure_11 = fn(7951).SearchResultContentEntityTypes;
