...
// Function ID: 16837
// Name: MembersScreen
// Dependencies: [19, 17, 7386, 1958, 2022, 1980, 2012, 1372, 12499, 12474, 7985, 7984, 1074, 21, 4639, 576, 563, 7269, 12475, 16793, 4283, 1875, 12493, 8299, 1115, 4351, 16837, 16835, 16785, 11722, 16797, 16838, 7289, 11726, 12320, 16840, 2]
...
export default noop.memo(function MembersScreen(searchContext) {
  ...
  if (constants3.CHANNEL === type) {
    ...
    if (stateFromStores) {
      ...
      tmp21Result = tmp21(tmp2(16840), obj7);
    }
