...
// Dependencies: [19, 17, 7930, 21, 4605, 576, 16738, 4341, 16740, 12, 4601, 1114, 12408, 16741, 2]
// Exports: RecentsMediaGridPlaceholder, default

// Module 16739 (MediaGridPlaceholder)
...
import GridItemPlaceholderDefault from "GridItemPlaceholder" /* 16740 */;
...
export const RecentsMediaGridPlaceholder = function RecentsMediaGridPlaceholder(visible) {
  ...
  return closure_8(numRows(4341).View, obj2);
};
