...
// Dependencies: [19, 17, 7892, 21, 4574, 576, 16681, 4310, 16683, 12, 4570, 1114, 12368, 16684, 2]
// Exports: RecentsMediaGridPlaceholder, default

// Module 16682 (MediaGridPlaceholder)
...
import GridItemPlaceholderDefault from "GridItemPlaceholder" /* 16683 */;
...
export const RecentsMediaGridPlaceholder = function RecentsMediaGridPlaceholder(visible) {
  ...
  return closure_8(numRows(4310).View, obj2);
};
