...
// Function ID: 16777
// Name: ChannelsScreen
// Dependencies: [19, 4631, 12458, 12434, 7953, 7952, 21, 12435, 504, 16309, 16722, 1114, 4318, 16726, 12453, 16768, 16718, 16730, 2]

// Module 16776 (ChannelsScreen)
...
let closure_10 = fn(7952).SearchResultContentEntityTypes;
const jsx = fn(21).jsx;
const size = fn(2);
