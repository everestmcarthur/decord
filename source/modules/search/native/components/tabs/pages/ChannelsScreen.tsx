...
// Function ID: 16901
// Name: ChannelsScreen
// Dependencies: [19, 4662, 12506, 12482, 7994, 7993, 21, 12483, 504, 16368, 16846, 1115, 4349, 16850, 12501, 16892, 16842, 16854, 2]

// Module 16900 (ChannelsScreen)
...
let closure_10 = fn(7993).SearchResultContentEntityTypes;
const jsx = fn(21).jsx;
const size = fn(2);
