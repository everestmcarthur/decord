...
// Dependencies: [19, 17, 7388, 12474, 7985, 21, 4639, 576, 563, 12475, 4376, 4640, 7158, 1364, 2]

// Module 16776 (SearchBarActivityIcon)
...
let closure_7 = fn(7985).SEARCH_MESSAGE_TAB_SENTINEL;
const jsxProd = fn(21);
