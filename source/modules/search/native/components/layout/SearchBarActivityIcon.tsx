...
// Dependencies: [19, 17, 7333, 12409, 7930, 21, 4605, 576, 563, 12410, 4341, 4606, 7103, 1115, 2]

// Module 16721 (SearchBarActivityIcon)
...
let closure_7 = fn(7930).SEARCH_MESSAGE_TAB_SENTINEL;
const jsxProd = fn(21);
