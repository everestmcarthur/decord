...
// Dependencies: [2022, 4288, 1372, 12474, 7985, 1074, 1115, 11822, 4582, 9563, 10771, 10242, 10240, 5171, 12663, 10244, 11960, 9567, 16878, 12475, 4484, 2]
...
// Module 16877 (AutocompleteScreenUtils)
...
require = fn;
const SearchListItemTypes = fn(7985).SearchListItemTypes;
...
export const getSearchFilterAuthorTypeIcon = function getSearchFilterAuthorTypeIcon(text) {
  ...
  if (intl.string(util.t.tPZo4p) === text) {
    return tmp(11960).UserIcon;
  } else {
    const intl3 = tmp(1115).intl;
    if (intl3.string(tmp(1115).t.JL7sRS) === text) {
      return tmp(9567).RobotIcon;
    } else {
      const intl2 = tmp(1115).intl;
      if (intl2.string(tmp(1115).t.WjkIKU) === text) {
        return tmp(16878).WebhookIcon;
      }
    }
  }
};
