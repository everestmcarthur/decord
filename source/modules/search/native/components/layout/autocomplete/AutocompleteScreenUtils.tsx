...
// Dependencies: [2021, 4255, 1371, 12432, 7952, 1074, 1114, 11781, 4549, 9522, 10727, 10201, 10199, 5138, 12621, 10203, 11919, 9526, 16811, 12433, 4451, 2]
...
// Module 16810 (AutocompleteScreenUtils)
...
require = fn;
const SearchListItemTypes = fn(7952).SearchListItemTypes;
...
export const getSearchFilterAuthorTypeIcon = function getSearchFilterAuthorTypeIcon(text) {
  ...
  if (intl.string(util.t.tPZo4p) === text) {
    return tmp(11919).UserIcon;
  } else {
    const intl3 = tmp(1114).intl;
    if (intl3.string(tmp(1114).t.JL7sRS) === text) {
      return tmp(9526).RobotIcon;
    } else {
      const intl2 = tmp(1114).intl;
      if (intl2.string(tmp(1114).t.WjkIKU) === text) {
        return tmp(16811).WebhookIcon;
      }
    }
  }
};
