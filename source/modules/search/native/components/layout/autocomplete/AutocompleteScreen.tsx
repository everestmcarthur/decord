...
// Dependencies: [32, 19, 1958, 4286, 1372, 12485, 12482, 7994, 1074, 21, 504, 16850, 12481, 12504, 12501, 4482, 4791, 12483, 16934, 12489, 12484, 16892, 16842, 1115, 16854, 2]

// Module 16933 (AutocompleteScreen)
...
import AutocompleteScreenUtils from "AutocompleteScreenUtils" /* 16934 */;
          ...
          if (0 !== results.length) {
            item = results.forEach((item) => {
              ...
              if (tmp22) {
                ...
                const obj2 = { text, icon: tmp(16934).getSearchFilterHasIcon(text), onPress: callback1 };
                element.props = obj2;
                items.push(element);
                const tmpResult3 = tmp(16934);
              }
              if (tmp27) {
                const element1 = { type: constants.GENERIC, props: null };
                const obj3 = { text, icon: tmp(16934).getSearchFilterAuthorTypeIcon(text), onPress: callback1 };
                element1.props = obj3;
                items.push(element1);
                const tmpResult4 = tmp(16934);
              }
            });
          }
        }
