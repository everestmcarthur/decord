...
// Dependencies: [32, 19, 1958, 4288, 1372, 12494, 12491, 8000, 1074, 21, 504, 16889, 12490, 12513, 12510, 4484, 4793, 12492, 16973, 12498, 12493, 16931, 16881, 1115, 16893, 2]

// Module 16972 (AutocompleteScreen)
...
import AutocompleteScreenUtils from "AutocompleteScreenUtils" /* 16973 */;
          ...
          if (0 !== results.length) {
            item = results.forEach((item) => {
              ...
              if (tmp22) {
                ...
                const obj2 = { text, icon: tmp(16973).getSearchFilterHasIcon(text), onPress: callback1 };
                element.props = obj2;
                items.push(element);
                const tmpResult3 = tmp(16973);
              }
              if (tmp27) {
                const element1 = { type: constants.GENERIC, props: null };
                const obj3 = { text, icon: tmp(16973).getSearchFilterAuthorTypeIcon(text), onPress: callback1 };
                element1.props = obj3;
                items.push(element1);
                const tmpResult4 = tmp(16973);
              }
            });
          }
        }
