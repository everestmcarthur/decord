...
// Dependencies: [5, 19, 17, 1958, 4737, 1372, 8083, 21, 4722, 576, 12604, 5292, 5850, 17025, 12601, 17035, 4718, 7247, 563, 17036, 8411, 4735, 17034, 17038, 17051, 1115, 2]

// Module 17037 (SearchHistoryRow)
...
function SearchHistoryRemoveIcon(searchContext) {
  ...
  return closure_10(searchContext(5292).PressableHighlight, { onPress: callback, accessibilityRole: "button", unstable_pressDelay: 130, style: { marginLeft: 16 }, hitSlop: { bottom: 16, left: 16, right: 16, top: 16 }, children: closure_10(searchContext(5850).XSmallIcon, { size: "sm", color: "interactive-text-default" }) });
}
function SearchHistoryTextRow(searchContext) {
  ...
  dependencyMap = tmp;
  const onPressSearchHistoryText = searchContext(17025).useOnPressSearchHistoryText({ searchContext });
  ...
  const items1 = [mapped, closure_10(searchContext(4718).Text, { lineClamp: 1, variant: "text-md/semibold", color: "mobile-text-heading-primary", style: tmp.text, children: searchHistoryItem.text })];
  ...
  obj3.icon = closure_10(View, { style: tmp.iconContainer, children: closure_10(searchContext(7247).MagnifyingGlassIcon, { size: "sm", color: "interactive-text-default" }) });
  return closure_10(searchContext(17035).SearchListRow, obj3);
}
...
const SearchHistoryItemTypes = fn(8083).SearchHistoryItemTypes;
const jsxProd = fn(21);
