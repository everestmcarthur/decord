...
// Dependencies: [1957, 4255, 1371, 7952, 7951, 1074, 4759, 1114, 12433, 12445, 1933, 504, 573, 2]

// Module 12432 (SearchQueryStore)
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import SearchUtils from "SearchUtils" /* 12433 */;
import SearchQueryTagManagerDefault from "SearchQueryTagManager" /* 12445 */;
...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (isObfuscatedResult) {
    ...
    if (null == channelName) {
      ...
      obj3.text = "" + stringResult + ": " + obj(12433).quoteChannelName(channelName);
