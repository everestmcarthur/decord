...
// Dependencies: [1958, 4288, 1372, 8000, 7999, 1074, 4793, 1115, 12492, 12504, 1934, 504, 573, 2]

// Module 12491 (SearchQueryStore)
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import SearchUtils from "SearchUtils" /* 12492 */;
import SearchQueryTagManagerDefault from "SearchQueryTagManager" /* 12504 */;
...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (isObfuscatedResult) {
    ...
    let channelName;
    if (null != channel) {
      channelName = obj(4793).computeChannelName(channel, UserStore, RelationshipStore);
      const obj2 = obj(4793);
    }
    if (null == channelName) {
      let items1 = [];
