...
// Dependencies: [1958, 12491, 7999, 1074, 12511, 12492, 4820, 1255, 1936, 2]

// Module 12510 (search/tracking/Tracking)
...
require = fn;
let closure_5 = fn(7999).SEARCH_HISTORY_TO_ANALYTICS_SEARCH_HISTORY;
