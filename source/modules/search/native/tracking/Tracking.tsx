...
// Dependencies: [1958, 12482, 7993, 1074, 12502, 12483, 4818, 1255, 1936, 2]

// Module 12501 (search/tracking/Tracking)
...
require = fn;
let closure_5 = fn(7993).SEARCH_HISTORY_TO_ANALYTICS_SEARCH_HISTORY;
