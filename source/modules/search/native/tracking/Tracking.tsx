...
// Dependencies: [1957, 12432, 7951, 1074, 12452, 12433, 4786, 1256, 1935, 2]

// Module 12451 (search/tracking/Tracking)
...
require = fn;
let closure_5 = fn(7951).SEARCH_HISTORY_TO_ANALYTICS_SEARCH_HISTORY;
