...
// Dependencies: [5, 32, 19, 17, 4598, 5510, 1074, 1374, 21, 4606, 1115, 576, 4343, 4607, 5043, 504, 5025, 1935, 4259, 8042, 1396, 7203, 1242, 7255, 11219, 4573, 7270, 4602, 1114, 12384, 12475, 5026, 2]
// Exports: default

// Module 12474 (DoubleTapToReactActionSheet)
  ...
  callback1 = obj.useCallback(asyncGeneratorStep(async (arg0, value) => {
    if (c3 === 2) {
      ...
      try {
        ...
        const obj7 = { emoji_id: closure_129_2.id, emoji_name: closure_129_2.name, emoji_animated: closure_129_2.animated, recommended: closure_129_4.current, location: tmp22(7255).DOUBLE_TAP_TO_REACT_ACTION_SHEET };
