...
// Dependencies: [5, 32, 19, 17, 4631, 5544, 1074, 1375, 21, 4639, 1364, 576, 4376, 4640, 5076, 504, 5058, 1936, 4292, 8075, 1397, 7237, 1241, 7289, 11263, 4606, 7304, 4635, 1115, 12426, 12517, 5059, 2]
// Exports: default

// Module 12516 (DoubleTapToReactActionSheet)
...
function EmojiConfetti(children) {
  ...
  let obj4 = top(4376);
  const mountLayoutEffect = top(5076).useMountLayoutEffect(() => {
    let num = 0;
    if (!dependencyMap) {
      const _Math = Math;
  ...
  callback1 = obj.useCallback(asyncGeneratorStep(async (arg0, value) => {
    if (c3 === 2) {
      ...
      try {
        ...
        const obj7 = { emoji_id: closure_129_2.id, emoji_name: closure_129_2.name, emoji_animated: closure_129_2.animated, recommended: closure_129_4.current, location: tmp22(7289).DOUBLE_TAP_TO_REACT_ACTION_SHEET };
