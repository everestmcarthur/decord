...
// Dependencies: [5, 19, 17, 4632, 1479, 1074, 1375, 21, 4640, 576, 1936, 8104, 1481, 504, 1397, 11282, 1241, 11285, 4636, 1115, 7244, 5210, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11884 (DoubleTapEmojiEditNudge)
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const callback = noop.useCallback(() => {
          ...
          try {
            ...
            if (0 === c3) {
              if (arg0 === 1) {
                ...
                const DoubleTapReactionEmoji = _location(1936).DoubleTapReactionEmoji;
              ...
              const result = _location(11285).showDoubleTapEmojiUpdatedToast(obj17);
              c4 = 3;
              return { value: "HermesInternal", done: null };
            }
          } catch (tmp12) {
    ...
    let result = _location(11282).openEmojiPickerActionSheet(obj2, "stack");
  }, items2);
  ...
  const items3 = [closure_11(_location(4636).Text, obj4), , ];
  ...
  obj5.name = str;
  items3[1] = closure_11(emoji(7244), obj5);
  ...
  obj6.children = closure_11(_location(4636).Text, obj7);
  items3[2] = closure_11(_location(5210).PressableOpacity, obj6);
...
export const DoubleTapEmojiEditNudge = function DoubleTapEmojiEditNudge(location) {
  ...
  let setting;
  const DoubleTapReactionEmoji = setting(1936).DoubleTapReactionEmoji;
