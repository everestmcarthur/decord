...
// Dependencies: [19, 17, 4597, 7203, 1374, 21, 4605, 1115, 576, 504, 5173, 7182, 1396, 10355, 1477, 4261, 8020, 11193, 7814, 8827, 2]
...
let closure_13 = noop.memo((emoji) => {
  ...
  return closure_9(emoji(5173).PressableOpacity, obj2);
});
