...
// Dependencies: [19, 17, 4566, 7165, 1374, 21, 4574, 1115, 576, 504, 5137, 7144, 1396, 10317, 1477, 4230, 7982, 11153, 7777, 8790, 2]

// Module 12412 (SelectDoubleTapEmojiRow)
...
let closure_13 = noop.memo((emoji) => {
  ...
  return closure_9(emoji(5137).PressableOpacity, obj2);
});
