...
// Dependencies: [19, 17, 4632, 7265, 1375, 21, 4640, 1364, 576, 504, 5210, 7244, 1397, 10432, 1478, 4296, 8104, 11282, 7883, 8913, 2]

// Module 12534 (SelectDoubleTapEmojiRow)
...
let closure_13 = noop.memo((emoji) => {
  ...
  return closure_9(emoji(5210).PressableOpacity, obj2);
});
