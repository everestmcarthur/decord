...
// Dependencies: [19, 17, 4599, 7225, 1374, 21, 4607, 1115, 576, 504, 5175, 7204, 1396, 10376, 1477, 4263, 8043, 11218, 7836, 8850, 2]

// Module 12477 (SelectDoubleTapEmojiRow)
...
let closure_13 = noop.memo((emoji) => {
  ...
  return closure_9(emoji(5175).PressableOpacity, obj2);
});
