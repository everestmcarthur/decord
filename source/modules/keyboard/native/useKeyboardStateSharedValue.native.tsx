...
// Dependencies: [1480, 4458, 5749, 1878, 4590, 11606, 2]
// Exports: default, getKeyboardStateWorklet

// Module 12274 (useKeyboardStateSharedValue)
...
const useCustomKeyboardHeight = fn(5749);
