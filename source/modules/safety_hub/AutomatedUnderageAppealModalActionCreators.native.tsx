...
// Dependencies: [5, 8569, 8561, 21, 12033, 573, 4607, 12036, 1897, 8568, 8579, 8562, 8585, 8560, 4843, 8592, 8729, 2]

// Module 12035 (AutomatedUnderageAppealModalActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1897 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4607 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;

const ModalActionCreatorsDefault = tmp(4843);
require = fn;
...
let closure_6 = fn(8561).AGE_VERIFICATION_GET_STARTED_MODAL_KEY;
const jsx = fn(21).jsx;
let obj = {
  open(classificationId, onClose) {
    DispatcherDefault.dispatch({ type: "SAFETY_HUB_AUTOMATED_UNDERAGE_APPEAL_MODAL_OPEN" });
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12036, dependencyMap.paths), React4, { classificationId, onClose });
  },
  openV2(classificationId, onClose) {
    ...
    if (obj2.isCurrentUserSuspended()) {
      if (tmp4Result.isExpressiveModalV2Enabled(tmp4(8562).AgeVerificationModalEntryPoint.AUTOMATED_UNDERAGE_APPEALS)) {
        const _Math = Math;
        const _Date = Date;
            ...
            try {
              ...
              if (0 === dependencyMap) {
                if (arg0 === 1) {
                  ...
                  dependencyMap = 1;
                  v3 = 1;
                  const obj6 = { value: classificationId(8585).shouldShowManualReviewFallback(classificationId(8562).AgeVerificationModalEntryPoint.AUTOMATED_UNDERAGE_APPEALS), done: false };
                  return obj6;
                }
              } else if (arg0 === 1) {
                v3 = 3;
                ...
                if (value) {
                  const result = onClose(8560).showManualReviewFallbackModal(classificationId(8562).AgeVerificationModalEntryPoint.AUTOMATED_UNDERAGE_APPEALS, closure_129_1);
                  const obj3 = onClose(8560);
                } else {
                  const obj8 = { onClose: closure_129_1 };
                  onClose(4843).pushLazy(v3(async () => {
                    ...
                    return () => closure_3_7(closure_1_0, {
                      ...
                      onComplete() {
                        ...
                        closure_2_0(12033).resetAgeCheckStatus();
                        obj = closure_2_0(12033);
