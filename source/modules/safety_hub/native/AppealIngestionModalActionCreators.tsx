...
// Dependencies: [573, 4841, 12029, 1897, 2]

// Module 12028 (AppealIngestionModalActionCreators)
...
export default {
  open(classificationId) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12029, dependencyMap.paths), classificationId, APPEAL_INGESTION_MODAL_KEY);
  },
  close() {
