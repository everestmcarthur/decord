...
// Dependencies: [19, 17, 8551, 8540, 21, 4639, 576, 504, 7230, 8205, 1115, 6698, 7099, 4635, 4334, 14865, 2]
// Exports: default
...
export default function SuspendedUserSafetyHubPage() {
  ...
  if (tmp6Result) {
    ...
    const items1 = [tmp5(tmp2(8205).IconButton, obj4), ];
    const obj5 = {
      style: tmp.text,
      onPress() {
    ...
    items2[2] = tmp5(tmp2(4635).Text, obj6);
    obj5.children = items2;
    items1[1] = tmp6(tmp2(4635).Text, obj5);
