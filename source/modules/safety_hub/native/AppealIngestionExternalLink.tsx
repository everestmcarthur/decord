...
// Dependencies: [19, 17, 21, 4638, 576, 5208, 4332, 4634, 1177, 8774, 2]
// Exports: default

// Module 12043 (AppealIngestionExternalLink)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import LinkingDefault from "Linking" /* 4332 */;
import Text_Text from "Text/Text" /* 4634 */;
import Pressables from "Pressables" /* 5208 */;
import _mod8774 from "module_8774" /* 8774 */;
...
export default function AppealIngestionExternalLink(children) {
  ...
  const items = [closure_4(Text_Text.Text, { style: tmp.childButtonText, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: children.text }), closure_4(native.Icon, { source: _mod8774, color: tmp.chevron.color })];
  obj2.children = items;
