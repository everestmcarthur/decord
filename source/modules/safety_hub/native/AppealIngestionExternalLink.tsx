...
// Dependencies: [19, 17, 21, 4639, 576, 5207, 4334, 4635, 1177, 8765, 2]
// Exports: default

// Module 12035 (AppealIngestionExternalLink)
...
export default function AppealIngestionExternalLink(children) {
  ...
  const items = [closure_4(Text_Text.Text, { style: tmp.childButtonText, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: children.text }), closure_4(native.Icon, { source: _mod8765, color: tmp.chevron.color })];
  obj2.children = items;
