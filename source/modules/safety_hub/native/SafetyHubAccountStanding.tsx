...
// Dependencies: [32, 19, 17, 1371, 8458, 8447, 21, 8448, 14801, 4574, 576, 1114, 14795, 4534, 6624, 9657, 6630, 6954, 504, 1396, 8845, 1178, 4570, 2]
// Exports: default

// Module 14800 (SafetyHubAccountStanding)
...
let obj = { [fn(8448).AccountStandingState.ALL_GOOD]: { left: "0%" } };
let obj2 = { left: "25%", transform: null };
let items = [{ translateX: -0.5 * fn(14801).SUBWAY_MARKER_WIDTH }];
obj2.transform = items;
obj[fn(8448).AccountStandingState.LIMITED] = obj2;
let obj4 = { left: "50%", transform: null };
let obj3 = { translateX: -0.5 * fn(14801).SUBWAY_MARKER_WIDTH };
let items1 = [{ translateX: -0.5 * fn(14801).SUBWAY_MARKER_WIDTH }];
obj4.transform = items1;
obj[fn(8448).AccountStandingState.VERY_LIMITED] = obj4;
let obj6 = { left: "75%", transform: null };
let obj5 = { translateX: -0.5 * fn(14801).SUBWAY_MARKER_WIDTH };
let items2 = [{ translateX: -0.5 * fn(14801).SUBWAY_MARKER_WIDTH }];
obj6.transform = items2;
obj[fn(8448).AccountStandingState.AT_RISK] = obj6;
let obj8 = { left: "100%", transform: null };
let obj7 = { translateX: -0.5 * fn(14801).SUBWAY_MARKER_WIDTH };
let items3 = [{ translateX: -fn(14801).SUBWAY_MARKER_WIDTH }];
obj8.transform = items3;
obj[fn(8448).AccountStandingState.SUSPENDED] = obj8;
...
const obj9 = { translateX: -fn(14801).SUBWAY_MARKER_WIDTH };
...
export default function SafetyHubAccountStanding() {
  ...
  const items5 = [closure_9(accountStanding(4570).Text, obj8), closure_9(accountStanding(4570).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
