...
// Dependencies: [32, 19, 17, 1371, 8518, 8507, 21, 8508, 14827, 4607, 576, 1114, 14821, 4567, 6682, 9718, 6688, 7012, 504, 1396, 8905, 1178, 4603, 2]
// Exports: default

// Module 14826 (SafetyHubAccountStanding)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import CircleCheckIcon from "CircleCheckIcon" /* 4567 */;
import Text_Text from "Text/Text" /* 4603 */;
import CircleErrorIcon from "CircleErrorIcon" /* 6682 */;
import CircleXIcon from "CircleXIcon" /* 6688 */;
...
import SafetyHubAccountStandingLabels from "SafetyHubAccountStandingLabels" /* 14821 */;
...
let obj = { [fn(8508).AccountStandingState.ALL_GOOD]: { left: "0%" } };
let obj2 = { left: "25%", transform: null };
let items = [{ translateX: -0.5 * fn(14827).SUBWAY_MARKER_WIDTH }];
obj2.transform = items;
obj[fn(8508).AccountStandingState.LIMITED] = obj2;
let obj4 = { left: "50%", transform: null };
let obj3 = { translateX: -0.5 * fn(14827).SUBWAY_MARKER_WIDTH };
let items1 = [{ translateX: -0.5 * fn(14827).SUBWAY_MARKER_WIDTH }];
obj4.transform = items1;
obj[fn(8508).AccountStandingState.VERY_LIMITED] = obj4;
let obj6 = { left: "75%", transform: null };
let obj5 = { translateX: -0.5 * fn(14827).SUBWAY_MARKER_WIDTH };
let items2 = [{ translateX: -0.5 * fn(14827).SUBWAY_MARKER_WIDTH }];
obj6.transform = items2;
obj[fn(8508).AccountStandingState.AT_RISK] = obj6;
let obj8 = { left: "100%", transform: null };
let obj7 = { translateX: -0.5 * fn(14827).SUBWAY_MARKER_WIDTH };
let items3 = [{ translateX: -fn(14827).SUBWAY_MARKER_WIDTH }];
obj8.transform = items3;
obj[fn(8508).AccountStandingState.SUSPENDED] = obj8;
...
const obj9 = { translateX: -fn(14827).SUBWAY_MARKER_WIDTH };
...
export default function SafetyHubAccountStanding() {
  ...
  if (null != stateFromStores) {
    let userAvatarSource = height(1396).getUserAvatarSource(stateFromStores);
    let obj2 = height(1396);
  } else {
    userAvatarSource = height(8905);
  }
  ...
  let obj5 = { source: userAvatarSource, size: accountStanding(1178).AvatarSizes.XXLARGE, "aria-label": null };
  let str;
  ...
  obj5["aria-label"] = str;
  obj4.children = closure_9(accountStanding(1178).Avatar, obj5);
  ...
  const items5 = [closure_9(accountStanding(4603).Text, obj8), closure_9(accountStanding(4603).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
