...
// Dependencies: [32, 19, 17, 1371, 8516, 8505, 21, 8506, 14826, 4606, 576, 1114, 14818, 4566, 6681, 9716, 6687, 7011, 504, 1396, 8903, 1178, 4602, 2]
// Exports: default

// Module 14825 (SafetyHubAccountStanding)
...
import SafetyHubAccountStandingLabels from "SafetyHubAccountStandingLabels" /* 14818 */;
...
let obj = { [fn(8506).AccountStandingState.ALL_GOOD]: { left: "0%" } };
let obj2 = { left: "25%", transform: null };
let items = [{ translateX: -0.5 * fn(14826).SUBWAY_MARKER_WIDTH }];
obj2.transform = items;
obj[fn(8506).AccountStandingState.LIMITED] = obj2;
let obj4 = { left: "50%", transform: null };
let obj3 = { translateX: -0.5 * fn(14826).SUBWAY_MARKER_WIDTH };
let items1 = [{ translateX: -0.5 * fn(14826).SUBWAY_MARKER_WIDTH }];
obj4.transform = items1;
obj[fn(8506).AccountStandingState.VERY_LIMITED] = obj4;
let obj6 = { left: "75%", transform: null };
let obj5 = { translateX: -0.5 * fn(14826).SUBWAY_MARKER_WIDTH };
let items2 = [{ translateX: -0.5 * fn(14826).SUBWAY_MARKER_WIDTH }];
obj6.transform = items2;
obj[fn(8506).AccountStandingState.AT_RISK] = obj6;
let obj8 = { left: "100%", transform: null };
let obj7 = { translateX: -0.5 * fn(14826).SUBWAY_MARKER_WIDTH };
let items3 = [{ translateX: -fn(14826).SUBWAY_MARKER_WIDTH }];
obj8.transform = items3;
obj[fn(8506).AccountStandingState.SUSPENDED] = obj8;
...
const obj9 = { translateX: -fn(14826).SUBWAY_MARKER_WIDTH };
...
export default function SafetyHubAccountStanding() {
  ...
  const items5 = [closure_9(accountStanding(4602).Text, obj8), closure_9(accountStanding(4602).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
