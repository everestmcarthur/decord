...
// Dependencies: [19, 17, 8549, 21, 4638, 12031, 1115, 12029, 12049, 4634, 12043, 2]
// Exports: default

// Module 12048 (AppealIngestionRequestSent)
import AppealIngestionExternalLinkDefault from "AppealIngestionExternalLink" /* 12043 */;
import _modDef12049 from "module_12049" /* 12049 */;
...
export default function AppealIngestionRequestSent() {
  ...
  const items = [closure_7(closure_4, { source: _modDef12049, style: tmp.checkboxPng }), closure_7(require("AppealIngestionModal").AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: stringResult1 }), , , ];
  ...
  const obj4 = { source: _modDef12049, style: tmp.checkboxPng };
