...
// Dependencies: [19, 17, 8507, 21, 4607, 11984, 1114, 11982, 12002, 4603, 11996, 2]
// Exports: default

// Module 12001 (AppealIngestionRequestSent)
import AppealIngestionExternalLinkDefault from "AppealIngestionExternalLink" /* 11996 */;
import _modDef12002 from "module_12002" /* 12002 */;
...
export default function AppealIngestionRequestSent() {
  ...
  const items = [closure_7(closure_4, { source: _modDef12002, style: tmp.checkboxPng }), closure_7(require("AppealIngestionModal").AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: stringResult1 }), , , ];
  ...
  const obj4 = { source: _modDef12002, style: tmp.checkboxPng };
