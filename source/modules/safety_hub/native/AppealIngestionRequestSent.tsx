...
// Dependencies: [19, 17, 8569, 21, 4640, 12040, 1115, 12038, 12058, 4636, 12052, 2]
// Exports: default

// Module 12057 (AppealIngestionRequestSent)
import AppealIngestionExternalLinkDefault from "AppealIngestionExternalLink" /* 12052 */;
...
export default function AppealIngestionRequestSent() {
  ...
  const items = [closure_7(closure_4, { source: _modDef12058, style: tmp.checkboxPng }), closure_7(require("AppealIngestionModal").AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: stringResult1 }), , , ];
  ...
  const obj4 = { source: _modDef12058, style: tmp.checkboxPng };
