...
// Dependencies: [19, 17, 8495, 8484, 1074, 21, 4605, 504, 11951, 11959, 1114, 11957, 11960, 11970, 11971, 4601, 2]
// Exports: default

// Module 11958 (AppealIngestionSpeedBump)
import AppealIngestionActivitySummaryDefault from "AppealIngestionActivitySummary" /* 11960 */;
import AppealIngestionPolicySummaryDefault from "AppealIngestionPolicySummary" /* 11970 */;
...
export default function AppealIngestionSpeedBump(arg0) {
  ...
  if (isCoppa) {
    ...
    tmp9Result3 = tmp9(tmp13(11971), obj6);
    const tmp13Result = tmp13(11971);
  }
  ...
  if (isSpam) {
    ...
    isSpam = tmp9(tmp13(11971), obj7);
    const tmp13Result4 = tmp13(11971);
  }
  items2[3] = isSpam;
  if (isDeveloperClassification) {
    ...
    isDeveloperClassification = tmp9(tmp13(11971), obj8);
    const tmp13Result5 = tmp13(11971);
  }
  ...
  if (!isCoppa) {
    ...
    tmp9Result4 = tmp9(tmp13(11971), obj9);
    const tmp13Result6 = tmp13(11971);
  }
  ...
  if (isDsaEligible) {
    ...
    isDsaEligible = tmp9(tmp2(4601).Text, obj10);
  }
