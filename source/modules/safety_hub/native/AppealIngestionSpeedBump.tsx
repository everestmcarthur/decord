...
// Dependencies: [19, 17, 8458, 8447, 1074, 21, 4574, 504, 11911, 11919, 1114, 11917, 11920, 11930, 11931, 4570, 2]
// Exports: default

// Module 11918 (AppealIngestionSpeedBump)
import AppealIngestionActivitySummaryDefault from "AppealIngestionActivitySummary" /* 11920 */;
import AppealIngestionPolicySummaryDefault from "AppealIngestionPolicySummary" /* 11930 */;
...
export default function AppealIngestionSpeedBump(arg0) {
  ...
  if (isCoppa) {
    ...
    tmp9Result3 = tmp9(tmp13(11931), obj6);
    const tmp13Result = tmp13(11931);
  }
  ...
  if (isSpam) {
    ...
    isSpam = tmp9(tmp13(11931), obj7);
    const tmp13Result4 = tmp13(11931);
  }
  items2[3] = isSpam;
  if (isDeveloperClassification) {
    ...
    isDeveloperClassification = tmp9(tmp13(11931), obj8);
    const tmp13Result5 = tmp13(11931);
  }
  ...
  if (!isCoppa) {
    ...
    tmp9Result4 = tmp9(tmp13(11931), obj9);
    const tmp13Result6 = tmp13(11931);
  }
  ...
  if (isDsaEligible) {
    ...
    isDsaEligible = tmp9(tmp2(4570).Text, obj10);
  }
