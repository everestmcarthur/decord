...
// Dependencies: [19, 17, 8518, 8507, 1074, 21, 4607, 504, 11976, 11984, 1114, 11982, 11985, 11995, 11996, 4603, 2]
// Exports: default

// Module 11983 (AppealIngestionSpeedBump)
import AppealIngestionActivitySummaryDefault from "AppealIngestionActivitySummary" /* 11985 */;
import AppealIngestionPolicySummaryDefault from "AppealIngestionPolicySummary" /* 11995 */;
...
export default function AppealIngestionSpeedBump(arg0) {
  ...
  if (isCoppa) {
    ...
    tmp9Result3 = tmp9(tmp13(11996), obj6);
    const tmp13Result = tmp13(11996);
  }
  ...
  if (isSpam) {
    ...
    isSpam = tmp9(tmp13(11996), obj7);
    const tmp13Result4 = tmp13(11996);
  }
  items2[3] = isSpam;
  if (isDeveloperClassification) {
    ...
    isDeveloperClassification = tmp9(tmp13(11996), obj8);
    const tmp13Result5 = tmp13(11996);
  }
  ...
  if (!isCoppa) {
    ...
    tmp9Result4 = tmp9(tmp13(11996), obj9);
    const tmp13Result6 = tmp13(11996);
  }
  ...
  if (isDsaEligible) {
    ...
    isDsaEligible = tmp9(tmp2(4603).Text, obj10);
  }
