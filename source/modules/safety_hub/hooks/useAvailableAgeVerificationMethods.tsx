...
// Dependencies: [32, 19, 8558, 573, 8559, 2]
// Exports: useAvailableAgeVerificationMethods

// Module 14866 (useAvailableAgeVerificationMethods)
import AgeVerificationMethodsV2 from "AgeVerificationMethodsV2" /* 8558 */;
...
export const useAvailableAgeVerificationMethods = function useAvailableAgeVerificationMethods() {
  ...
  const effect = noop.useEffect(() => {
    ...
    const nextPromise = ageVerificationMethodsV2SuspendedUser.then((methods) => {
      ...
      return _true(8559).getAvailableMethodsV2(methods.methods);
    });
