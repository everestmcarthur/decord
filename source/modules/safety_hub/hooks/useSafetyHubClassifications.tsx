...
// Dependencies: [19, 8560, 8549, 504, 11, 8548, 8550, 12024, 2]
...
// Module 12023 (useSafetyHubClassifications)
...
require = fn;
const ViolationType = fn(8549).ViolationType;
const size = fn(2);
...
export const useSafetyHubClassification = function useSafetyHubClassification(classificationId) {
  ...
  if (obj5.isGuildClassification(stateFromStores)) {
    ...
    if (member_type === tmp(8550).MemberType.OWNER) {
