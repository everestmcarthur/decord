...
// Dependencies: [19, 8518, 8507, 504, 11, 8506, 8508, 11977, 2]
...
// Module 11976 (useSafetyHubClassifications)
...
require = fn;
const ViolationType = fn(8507).ViolationType;
const size = fn(2);
...
export const useSafetyHubClassification = function useSafetyHubClassification(classificationId) {
  ...
  if (obj5.isGuildClassification(stateFromStores)) {
    ...
    if (member_type === tmp(8508).MemberType.OWNER) {
