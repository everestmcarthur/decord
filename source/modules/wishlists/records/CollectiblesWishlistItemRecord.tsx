...
// Dependencies: [7743, 7742, 1888, 7744, 7745, 5681, 9019, 1074, 1890, 2]
// Exports: isCollectiblesWishlistItemRecord

// Module 9020 (CollectiblesWishlistItemRecord)
...
let closure_3 = fn(7742).transformSKUToCollectiblesItem;
