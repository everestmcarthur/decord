...
// Dependencies: [7561, 7560, 1887, 7562, 7563, 5525, 8812, 1074, 1889, 2]
// Exports: isCollectiblesWishlistItemRecord

// Module 8813 (CollectiblesWishlistItemRecord)
...
let closure_3 = fn(7560).transformSKUToCollectiblesItem;
