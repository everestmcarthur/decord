...
// Dependencies: [7657, 7656, 1888, 7658, 7659, 5597, 8919, 1074, 1890, 2]
// Exports: isCollectiblesWishlistItemRecord

// Module 8920 (CollectiblesWishlistItemRecord)
...
let closure_3 = fn(7656).transformSKUToCollectiblesItem;
