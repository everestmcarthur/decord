...
// Dependencies: [7661, 7660, 1888, 7662, 7663, 5599, 8935, 1074, 1890, 2]
// Exports: isCollectiblesWishlistItemRecord

// Module 8936 (CollectiblesWishlistItemRecord)
...
let closure_3 = fn(7660).transformSKUToCollectiblesItem;
