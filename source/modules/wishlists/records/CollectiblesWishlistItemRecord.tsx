...
// Dependencies: [7654, 7653, 1888, 7655, 7656, 5596, 8908, 1074, 1890, 2]
// Exports: isCollectiblesWishlistItemRecord

// Module 8909 (CollectiblesWishlistItemRecord)
...
let closure_3 = fn(7653).transformSKUToCollectiblesItem;
