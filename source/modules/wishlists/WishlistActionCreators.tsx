...
// Dependencies: [5, 7635, 1371, 4233, 7241, 8811, 1074, 1116, 1369, 573, 7245, 1272, 8809, 1232, 4475, 1242, 8207, 2]

// Module 8816 (WishlistActionCreators)
...
import WishlistRecord from "WishlistRecord" /* 8811 */;
...
const getWishlistSkuIds = fn(8811).getWishlistSkuIds;
