...
// Dependencies: [19, 17, 7260, 21, 4605, 13170, 13172, 2]
// Exports: default
...
let closure_5 = createStyles.createStyles({ itemsContainer: { flexDirection: "row", flexWrap: "wrap", gap: fn(7260).WISHLIST_SUGGESTION_CARD_GAP, justifyContent: "flex-start" } });
const size = fn(2);
