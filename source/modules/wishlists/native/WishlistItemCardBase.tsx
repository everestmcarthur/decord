...
// Dependencies: [19, 17, 21, 576, 4606, 4305, 8865, 4317, 8322, 4308, 8867, 1114, 1369, 8887, 5146, 2]
// Exports: default

// Module 8864 (WishlistItemCardBase)
...
function SourceIcon(toastText) {
  ...
  const obj = {
    ...
    children: closure_5(toastText(8865).HeartIcon, { color: nativeDefault.colors.INTERACTIVE_ICON_DEFAULT, size: "md" })
  };
...
export default function WishlistItemCardBase(username) {
  ...
  let tmp14Result4 = source === tmp2(8867).WishlistItemSource.WISHLIST;
  ...
  if (tmp14Result) {
    ...
    obj7.children = tmp14(tmp2(8887).CheckmarkLargeBoldIcon, obj8);
  ...
  if (tmp14Result3) {
    ...
    obj9.children = tmp14(tmp2(5146).LockIcon, obj10);
