...
// Dependencies: [19, 11997, 21, 4842, 12001, 1897, 4984, 12004, 2]
...
// Module 11996 (GuildAutomodActionActionCreators)
...
export const openSubmitFeedback = function openSubmitFeedback(messageId, content, decisionId, channel) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12001, dependencyMap.paths), obj2, React4);
};
...
export const openAutomodProfileQuarantineAlert = function openAutomodProfileQuarantineAlert(guildId) {
  ...
  actions_AlertActionCreatorsDefault.openLazy({
    importer() {
      return asyncRequireImpl(12004, dependencyMap.paths).then((result) => {
