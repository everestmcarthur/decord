...
// Dependencies: [19, 12005, 21, 4841, 12009, 1897, 4983, 12012, 2]
...
// Module 12004 (GuildAutomodActionActionCreators)
...
export const openSubmitFeedback = function openSubmitFeedback(messageId, content, decisionId, channel) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12009, dependencyMap.paths), obj2, React4);
};
...
export const openAutomodProfileQuarantineAlert = function openAutomodProfileQuarantineAlert(guildId) {
  ...
  actions_AlertActionCreatorsDefault.openLazy({
    importer() {
      return asyncRequireImpl(12012, dependencyMap.paths).then((result) => {
