...
// Dependencies: [32, 19, 1957, 4243, 4253, 1371, 1074, 7561, 7562, 7563, 1114, 7564, 7565, 7566, 4758, 7567, 7568, 7569, 504, 7570, 2]
...
// Module 7560 (AutomodMessageUtils)
import useChannelName from "useChannelName" /* 4758 */;
import AutomodMessageEmbedKeys from "AutomodMessageEmbedKeys" /* 7561 */;
import AutomodQuarantineUserActionMessageEmbedKeys from "AutomodQuarantineUserActionMessageEmbedKeys" /* 7562 */;
import AutomodQuarantineUserMessageEmbedKeys from "AutomodQuarantineUserMessageEmbedKeys" /* 7567 */;
import AutomodNotificationEmbedKeys from "AutomodNotificationEmbedKeys" /* 7568 */;
import AutomodAlert from "AutomodAlert" /* 7569 */;
...
function _getUserProfileRuleHeaderText(profileUpdateTypeFromMessage, quarantineActionFromMessage, quarantineEventFromMessage) {
  if (AutomodQuarantineUserActionMessageEmbedKeys.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === quarantineActionFromMessage) {
    if (tmp(7563).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_UPDATE === profileUpdateTypeFromMessage) {
      const intl6 = tmp(1114).intl;
      let stringResult = intl6.string(tmp(1114).t.t98DPb);
    } else if (tmp(7563).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_RESET === profileUpdateTypeFromMessage) {
      const intl5 = tmp(1114).intl;
      stringResult = intl5.string(tmp(1114).t["7u/rlU"]);
    }
    return stringResult;
  } else if (tmp(7562).AutomodQuarantineUserActionMessageEmbedKeys.QUARANTINE_USER === quarantineActionFromMessage) {
    if (tmp(7564).AutomodQuarantineEventMessageEmbedKeys.MESSAGE_SEND === quarantineEventFromMessage) {
      const intl4 = tmp(1114).intl;
      let stringResult1 = intl4.string(tmp(1114).t.PmSMMS);
    } else if (tmp(7564).AutomodQuarantineEventMessageEmbedKeys.GUILD_JOIN === quarantineEventFromMessage) {
      const intl3 = tmp(1114).intl;
      stringResult1 = intl3.string(tmp(1114).t.m9wWzo);
    } else if (tmp(7564).AutomodQuarantineEventMessageEmbedKeys.USERNAME_UPDATE === quarantineEventFromMessage) {
      const intl2 = tmp(1114).intl;
      stringResult1 = intl2.string(tmp(1114).t.KNSkC6);
    } else if (tmp(7564).AutomodQuarantineEventMessageEmbedKeys.CLAN_TAG_UPDATE === quarantineEventFromMessage) {
      const intl7 = tmp(1114).intl;
      stringResult1 = intl7.string(tmp(1114).t.qV4K6j);
    }
    return stringResult1;
  } else if (tmp(7562).AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_GUEST_JOIN === quarantineActionFromMessage) {
...
function extractAutomodMessageFields(message) {
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.ALERT_ACTIONS_EXECUTION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.RULE_NAME;
  ...
  obj.ruleName = tmp19;
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.DECISION_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.KEYWORD;
  ...
  obj.keyword = tmp31;
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.KEYWORD_MATCHED_CONTENT;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.FLAGGED_MESSAGE_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.TIMEOUT_DURATION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.QUARANTINE_USER;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.QUARANTINE_USER_ACTION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.DECISION_REASON;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.INTERACTION_USER_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7561).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  ...
  } else if (tmp(7567).AutomodQuarantineUserMessageEmbedKeys.USERNAME === quarantineType) {
    const intl4 = tmp(1114).intl;
    return intl4.string(tmp(1114).t.pJQVnr);
  } else if (tmp(7567).AutomodQuarantineUserMessageEmbedKeys.GLOBAL_NAME === quarantineType) {
    const intl3 = tmp(1114).intl;
    return intl3.string(tmp(1114).t.V9eJ85);
  } else if (tmp(7567).AutomodQuarantineUserMessageEmbedKeys.CLAN_TAG === quarantineType) {
    const intl2 = tmp(1114).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  ...
  NOTIFICATION_TYPE = tmp(7568).AutomodNotificationEmbedKeys.JOIN_ATTEMPTS;
  let embeds1 = message.embeds;
  if (embeds1 == null) {
    embeds1 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7568).AutomodNotificationEmbedKeys.RAID_DATETIME;
  let embeds2 = message.embeds;
  if (embeds2 == null) {
    embeds2 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7568).AutomodNotificationEmbedKeys.DMS_SENT;
  let embeds3 = message.embeds;
  if (embeds3 == null) {
    embeds3 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7568).AutomodNotificationEmbedKeys.RAID_TYPE;
  let embeds4 = message.embeds;
  if (embeds4 == null) {
    embeds4 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7568).AutomodNotificationEmbedKeys.RESOLVED_REASON;
  let embeds5 = message.embeds;
  if (embeds5 == null) {
    embeds5 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7568).AutomodNotificationEmbedKeys.DECISION_ID;
  let embeds6 = message.embeds;
  if (embeds6 == null) {
    embeds6 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7568).AutomodNotificationEmbedKeys.SUSPICIOUS_MENTION_ACTIVITY_UNTIL;
  let embeds7 = message.embeds;
  if (embeds7 == null) {
    embeds7 = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (tmp3(7570).RaidResolutionType.DM_SPAM === resolvedReason) {
    const intl3 = tmp3(1114).intl;
    return intl3.string(tmp3(1114).t.j5V0ij);
  } else if (tmp3(7570).RaidResolutionType.JOIN_RAID === resolvedReason) {
