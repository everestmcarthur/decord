...
// Dependencies: [32, 109, 19, 17, 502, 2021, 1979, 11893, 1074, 4200, 21, 4574, 576, 5008, 1114, 1178, 11901, 4570, 11902, 7396, 563, 4218, 5006, 1242, 2]
// Exports: default

// Module 11900 (AutomodUserProfileQuarantineAlert)
...
import _modDef11901 from "module_11901" /* 11901 */;
...
function ChatBlockedAlert(arg0) {
  ...
  const items = [value2(native.Icon, { source: _modDef11901, size: native.Icon.Sizes.CUSTOM, style: tmp2.mainIcon }), value2(Text_Text.Text, { style: tmp2.title, accessibilityRole: "header", variant: "heading-md/medium", color: "mobile-text-heading-primary", children: title }), value2(Text_Text.Text, { style: tmp2.description, variant: "text-sm/medium", color: "text-default", children: description })];
  obj2.children = items;
...
function PerServerProfileAlert(arg0) {
  ...
  const tmp2Result = tmp2(11902);
  [require, tmp8] = tmp2(11902).useOpenFixQuarantinedProfileModal({ guildId });
  if (!tmp8) {
...
const QUARANTINE_USER_ALERT_KEY = fn(11893).QUARANTINE_USER_ALERT_KEY;
