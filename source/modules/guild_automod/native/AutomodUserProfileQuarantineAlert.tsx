...
// Dependencies: [32, 109, 19, 17, 502, 2021, 1979, 11933, 1074, 4230, 21, 4605, 576, 5044, 1114, 1178, 11941, 4601, 11942, 7434, 563, 4249, 5042, 1242, 2]
// Exports: default

// Module 11940 (AutomodUserProfileQuarantineAlert)
...
function ChatBlockedAlert(arg0) {
  ...
  const items = [value2(native.Icon, { source: _modDef11941, size: native.Icon.Sizes.CUSTOM, style: tmp2.mainIcon }), value2(Text_Text.Text, { style: tmp2.title, accessibilityRole: "header", variant: "heading-md/medium", color: "mobile-text-heading-primary", children: title }), value2(Text_Text.Text, { style: tmp2.description, variant: "text-sm/medium", color: "text-default", children: description })];
  obj2.children = items;
...
function PerServerProfileAlert(arg0) {
  ...
  const tmp2Result = tmp2(11942);
  [require, tmp8] = tmp2(11942).useOpenFixQuarantinedProfileModal({ guildId });
  if (!tmp8) {
...
const QUARANTINE_USER_ALERT_KEY = fn(11933).QUARANTINE_USER_ALERT_KEY;
