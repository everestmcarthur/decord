...
// Dependencies: [5, 32, 19, 2013, 1372, 1074, 21, 4640, 5770, 5607, 5225, 12472, 5608, 1972, 9998, 7237, 12486, 2]
// Exports: default

// Module 12485 (CreateGuildContainer)
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5770).NAV_BAR_HEIGHT } };
