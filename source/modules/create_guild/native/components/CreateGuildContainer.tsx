...
// Dependencies: [5, 32, 19, 2012, 1371, 1074, 21, 4605, 5732, 5569, 5188, 12390, 5570, 1971, 9917, 7175, 12404, 2]
// Exports: default

// Module 12403 (CreateGuildContainer)
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5732).NAV_BAR_HEIGHT } };
