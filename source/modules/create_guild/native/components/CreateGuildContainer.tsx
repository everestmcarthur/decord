...
// Dependencies: [5, 32, 19, 2012, 1371, 1074, 21, 4574, 5696, 5533, 5152, 12350, 5534, 1971, 9879, 7137, 12364, 2]
// Exports: default

// Module 12363 (CreateGuildContainer)
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5696).NAV_BAR_HEIGHT } };
