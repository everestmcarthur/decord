...
// Dependencies: [5, 19, 2022, 1980, 4622, 1074, 4263, 21, 4638, 576, 1484, 504, 5710, 1385, 7205, 1897, 7849, 9838, 7425, 8508, 10433, 12860, 7233, 4348, 2]
// Exports: default

// Module 12859 (AcceptInviteContainer)
            ...
            if (obj11.handleNSFWGuildInvite(invite)) {
              ...
              if (!stateFromStoresObject.isGuildMember) {
                if (null != invite) {
                  ...
                  obj6.context = obj9;
                  obj6.callback = function callback(arg0) {
                    v1(arg0);
                  };
