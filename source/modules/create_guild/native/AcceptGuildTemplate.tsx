...
// Dependencies: [19, 17, 1962, 2017, 1074, 7436, 21, 4638, 576, 5610, 5663, 1177, 11939, 1115, 7089, 38, 1612, 2018, 4634, 11941, 6713, 5060, 8734, 12, 9853, 11946, 11947, 11097, 1092, 2]
// Exports: default

// Module 11938 (AcceptGuildTemplate)
...
import InvalidLink from "InvalidLink" /* 11939 */;
import GuildIconUploaderDefault from "GuildIconUploader" /* 11941 */;
import noop from "module_19" /* 19 */;
import TextStyles_mod from "TextStyles" /* 5610 */;

const FormDividerDefault = tmp5(8734);
require = fn;
...
function GuildTemplateResolved(guildTemplate) {
  ...
  const typeConsolidationTextTransform = guildTemplate(7089).useTypeConsolidationTextTransform("AcceptGuildTemplate");
  ...
  obj8.children = closure_11(guildTemplate(5060).Button, obj9);
  ...
  items1[6] = closure_11(guildTemplate(4634).Text, obj11);
  ...
  items1[7] = closure_11(guildTemplate(4634).Text, obj12);
  ...
  items1[9] = closure_12(guildTemplate(4634).Text, obj14);
  let tmp9Result = null;
  if (found.length > 0) {
    ...
    const items5 = [tmp11(tmp2(4634).Text, obj17), , ];
    ...
    items5[1] = tmp11(tmp2(4634).Text, obj18);
  ...
  let obj2 = {
    ...
    children: _modDef12(channels.channels).sortBy((parent_id) => {
      ...
      if (isGuildVocalChannelType(type)) {
        let tmp10Result = tmp10(9853);
      } else if (type === constants2.GUILD_CATEGORY) {
        tmp10Result = tmp10(11946);
      } else {
        tmp10Result = tmp10(11947);
      }
