...
// Dependencies: [19, 17, 1961, 2016, 1074, 7378, 21, 4605, 576, 5574, 5627, 1178, 11867, 1114, 7031, 38, 1611, 2017, 4601, 11869, 6655, 5025, 8669, 12, 9783, 11874, 11875, 11019, 1091, 2]
// Exports: default

// Module 11866 (AcceptGuildTemplate)
...
import InvalidLink from "InvalidLink" /* 11867 */;
import GuildIconUploaderDefault from "GuildIconUploader" /* 11869 */;
import noop from "module_19" /* 19 */;
import TextStyles_mod from "TextStyles" /* 5574 */;

const FormDividerDefault = tmp5(8669);
require = fn;
...
function GuildTemplateResolved(guildTemplate) {
  ...
  const typeConsolidationTextTransform = guildTemplate(7031).useTypeConsolidationTextTransform("AcceptGuildTemplate");
  ...
  obj8.children = closure_11(guildTemplate(5025).Button, obj9);
  ...
  items1[6] = closure_11(guildTemplate(4601).Text, obj11);
  ...
  items1[7] = closure_11(guildTemplate(4601).Text, obj12);
  ...
  items1[9] = closure_12(guildTemplate(4601).Text, obj14);
  let tmp9Result = null;
  if (found.length > 0) {
    ...
    const items5 = [tmp11(tmp2(4601).Text, obj17), , ];
    ...
    items5[1] = tmp11(tmp2(4601).Text, obj18);
  ...
  let obj2 = {
    ...
    children: _modDef12(channels.channels).sortBy((parent_id) => {
      ...
      if (isGuildVocalChannelType(type)) {
        let tmp10Result = tmp10(9783);
      } else if (type === constants2.GUILD_CATEGORY) {
        tmp10Result = tmp10(11874);
      } else {
        tmp10Result = tmp10(11875);
      }
