...
// Dependencies: [7051, 4809, 12802, 1896, 12797, 2]
...
export default {
  openCreateGuildModal(onSuccess) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12802, dependencyMap.paths), { onSuccess }, React4);
  },
  ...
  openGuildInviteScreen(channel) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12802, dependencyMap.paths), { channel }, React4);
  },
  openGuildJoinServerScreen() {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12802, dependencyMap.paths), { initialState: constants.JOIN_SERVER }, React4);
  }
};
