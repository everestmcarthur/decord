...
// Function ID: 12430
// Name: CreateGuild
// Dependencies: [19, 17, 1371, 1074, 21, 4607, 576, 5014, 5023, 5025, 4603, 1114, 11894, 6678, 7274, 5027, 7013, 2]
// Exports: default

// Module 12429 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4603).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4603).Text, obj4);
  items1[2] = closure_7(ref(11894), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6678).TextInput, obj6);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7274).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4603).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(5027).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(7013), obj11);
        const tmp12Result = ref(7013);
      }
    }
  }
  items1[7] = tmp9Result2;
  obj.children = closure_8(isScreenReaderEnabled(5025).Stack, { children: items1 });
