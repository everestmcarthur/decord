...
// Function ID: 12478
// Name: CreateGuild
// Dependencies: [19, 17, 1372, 1074, 21, 4638, 576, 5045, 5054, 5058, 4634, 1115, 11941, 6714, 7310, 5060, 7049, 2]
// Exports: default

// Module 12477 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4634).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4634).Text, obj4);
  items1[2] = closure_7(ref(11941), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6714).TextInput, obj6);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7310).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4634).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(5060).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(7049), obj11);
        const tmp12Result = ref(7049);
      }
    }
  }
  items1[7] = tmp9Result2;
  obj.children = closure_8(isScreenReaderEnabled(5058).Stack, { children: items1 });
