...
// Function ID: 12405
// Name: CreateGuild
// Dependencies: [19, 17, 1371, 1074, 21, 4605, 576, 5012, 5021, 5023, 4601, 1114, 11869, 6656, 7252, 5025, 6991, 2]
// Exports: default

// Module 12404 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4601).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4601).Text, obj4);
  items1[2] = closure_7(ref(11869), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6656).TextInput, obj6);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7252).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4601).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(5025).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(6991), obj11);
