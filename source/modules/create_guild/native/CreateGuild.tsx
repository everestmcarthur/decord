...
// Function ID: 12428
// Name: CreateGuild
// Dependencies: [19, 17, 1371, 1074, 21, 4606, 576, 5013, 5022, 5024, 4602, 1114, 11892, 6677, 7273, 5026, 7012, 2]
// Exports: default

// Module 12427 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4602).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4602).Text, obj4);
  items1[2] = closure_7(ref(11892), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6677).TextInput, obj6);
  if (tmp9Result) {
    const obj7 = { onValueChange: onStaffOnlyChange, value: guild.staffOnly, start: true, end: true, label: "Staff Only", subLabel: null };
    const intl4 = tmp4(1114).intl;
    obj7.subLabel = intl4.string(tmp4(1114).t.edQ5va);
    tmp9Result = tmp9(tmp4(7273).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  const obj8 = { style: tmp.hint, variant: "text-xs/medium", color: "text-muted", children: null };
  const intl5 = tmp4(1114).intl;
  obj8.children = intl5.format(isScreenReaderEnabled(1114).t["2bprXx"], { guidelinesURL: MarketingURLs.GUIDELINES });
  items1[5] = closure_7(isScreenReaderEnabled(4602).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(5026).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(7012), obj11);
        const tmp12Result = ref(7012);
      }
    }
  }
  items1[7] = tmp9Result2;
  obj.children = closure_8(isScreenReaderEnabled(5024).Stack, { children: items1 });
