...
// Function ID: 12487
// Name: CreateGuild
// Dependencies: [19, 17, 1372, 1074, 21, 4640, 576, 5047, 5056, 5060, 4636, 1115, 11950, 6717, 7314, 5062, 7053, 2]
// Exports: default

// Module 12486 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4636).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4636).Text, obj4);
  items1[2] = closure_7(ref(11950), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6717).TextInput, obj6);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7314).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4636).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(5062).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(7053), obj11);
        const tmp12Result = ref(7053);
      }
    }
  }
  items1[7] = tmp9Result2;
  obj.children = closure_8(isScreenReaderEnabled(5060).Stack, { children: items1 });
