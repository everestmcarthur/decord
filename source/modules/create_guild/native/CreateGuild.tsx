...
// Function ID: 12470
// Name: CreateGuild
// Dependencies: [19, 17, 1372, 1074, 21, 4639, 576, 5046, 5055, 5057, 4635, 1115, 11933, 6711, 7307, 5059, 7046, 2]
// Exports: default

// Module 12469 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4635).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4635).Text, obj4);
  items1[2] = closure_7(ref(11933), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6711).TextInput, obj6);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7307).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4635).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(5059).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(7046), obj11);
        const tmp12Result = ref(7046);
      }
    }
  }
  items1[7] = tmp9Result2;
  obj.children = closure_8(isScreenReaderEnabled(5057).Stack, { children: items1 });
