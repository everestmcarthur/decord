...
// Function ID: 16446
// Name: YouBar
// Dependencies: [5, 32, 19, 17, 4424, 4426, 1371, 15177, 1074, 1954, 21, 4605, 576, 1477, 15170, 11599, 4465, 15176, 15180, 4341, 5024, 8417, 16446, 16447, 504, 8281, 16449, 4463, 4573, 1369, 12, 16452, 1896, 4462, 11290, 7394, 1943, 1114, 7434, 16092, 6705, 1178, 16466, 16467, 16468, 16473, 16476, 4315, 16478, 16479, 2]
...
import getNavigatorCurrentRouteDefault from "getNavigatorCurrentRoute" /* 11290 */;
import YouBarFloatingShadeDefault from "YouBarFloatingShade" /* 16478 */;
import ConnectionBannerDefault from "ConnectionBanner" /* 16479 */;
...
let closure_26 = noop.memo(() => {
  ...
  const drawerWidth = isMobileQuestDockRenderedBase(11599).useDrawerWidth();
  let obj3 = isMobileQuestDockRenderedBase(11599);
  ...
  const tmp10 = youBarHorizontalMargin(4465)().isChatBesideChannelList ? drawerWidth - result : youBarHorizontalMargin(1477)().width - result;
  dependencyMap = tmp10;
  ...
  sharedValue = isMobileQuestDockRenderedBase(4341).useSharedValue(false);
  const tmp4Result12 = isMobileQuestDockRenderedBase(4341);
  let fn = function r() {
  ...
  const tmp4Result13 = isMobileQuestDockRenderedBase(4341);
  fn.__closure = { withSpring: isMobileQuestDockRenderedBase(5024).withSpring, barMarginBottom: youBarBottomMargin, connectionBannerHeight, YOU_BAR_SPRING_CONFIG: callback3, isPressedValue: sharedValue, isQuestRendered: isMobileQuestDockRenderedBase };
  fn.__workletHash = 7314807713815;
  fn.__initData = __initData;
  const animatedStyle = tmp4Result13.useAnimatedStyle(fn);
  const obj5 = { withSpring: isMobileQuestDockRenderedBase(5024).withSpring, barMarginBottom: youBarBottomMargin, connectionBannerHeight, YOU_BAR_SPRING_CONFIG: callback3, isPressedValue: sharedValue, isQuestRendered: isMobileQuestDockRenderedBase };
  const iCYMIEnabled = isMobileQuestDockRenderedBase(8417).useICYMIEnabled("TabsNavigator");
  const tmp4Result14 = isMobileQuestDockRenderedBase(8417);
  const youBarCoachmark = isMobileQuestDockRenderedBase(16446).useYouBarCoachmark({ isQuestRendered: isMobileQuestDockRenderedBase });
  const visibleContent = youBarCoachmark.visibleContent;
  const markAsDismissed = youBarCoachmark.markAsDismissed;
  const tmp4Result15 = isMobileQuestDockRenderedBase(16446);
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(16447).useShowTinyBroncoPromoSheet({ visibleContent, markAsDismissed });
  ...
  const tmp4Result16 = isMobileQuestDockRenderedBase(16447);
  ...
  const nameplate = isMobileQuestDockRenderedBase(8281).useNameplate({ user: stateFromStores });
  const tmp4Result18 = isMobileQuestDockRenderedBase(8281);
  const youBarAccessibilityLabel = isMobileQuestDockRenderedBase(16449).useYouBarAccessibilityLabel(stateFromStores);
  ...
  callback3 = sharedValue.useCallback(() => {
    ...
    if (null != coerceGuildsRouteResult) {
      const result = tmp(4573).triggerHapticFeedback(tmp(4573).HapticFeedbackTypes.SOFT);
  ...
  const context = sharedValue.useContext(tmp2(16092));
  const gesture = context.gesture;
  const translateX = context.translateX;
  const tmp4Result19 = isMobileQuestDockRenderedBase(16449);
  hitSlop = isMobileQuestDockRenderedBase(4341).useSharedValue(0);
  ...
  obj6.style = items9;
  const items10 = [closure_19(youBarHorizontalMargin(16466), { hasNameplate: null != nameplate, isLargeAvatar: !isMobileQuestDockRenderedBase, barWidth: tmp10, isQuestRendered: isMobileQuestDockRenderedBase, avatarSize: tmp37 }), , , ];
  let tmp40Result = tmp22;
  if (null != nameplate) {
    const obj7 = { nameplate, barWidth: tmp10, isQuestRendered: isMobileQuestDockRenderedBase, avatarSize: tmp37 };
    tmp40Result = tmp40(tmp2(16467), obj7);
  }
  ...
  obj9.children = closure_19(youBarHorizontalMargin(16468), { isQuestRendered: isMobileQuestDockRenderedBase, onAvatarPress: memo1 });
  obj8.children = closure_19(markAsDismissed, obj9);
  items10[2] = closure_19(isMobileQuestDockRenderedBase(6705).GestureDetector, obj8);
  const obj10 = { style: tmp.youRowRight, children: null };
  let tmp40Result2 = null;
  if (iCYMIEnabled) {
    const obj11 = { hasNameplate: tmp22 };
    tmp40Result2 = tmp40(tmp2(16473), obj11);
  }
  const items11 = [tmp40Result2, closure_19(youBarHorizontalMargin(16476), { hasNameplate: null != nameplate })];
  obj10.children = items11;
  items10[3] = closure_20(visibleContent, obj10);
  obj6.children = items10;
  return closure_20(youBarHorizontalMargin(4341).View, obj6);
});
