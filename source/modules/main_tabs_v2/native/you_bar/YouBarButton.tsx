...
class YouBarButtonIcon {
  constructor(arg0) {
    ...
    items2[0] = memo;
    items2[1] = hasBadge;
    memo1 = obj2.useMemo(() => ({ position: "absolute", left: size2 - badgeSize + num3, top: size2 - badgeSize + num4, right: "id", bottom: "jsx", padding: "justifyContent", minWidth: "enumerable" }), items1);
