...
// Dependencies: [19, 17, 15128, 1074, 21, 4574, 576, 4275, 1178, 8847, 8790, 2]

// Module 16420 (YouBarAvatarDefault)
...
const ClipViewDefault = tmp4(8847);
require = fn;
function AvatarDefault() {
  ...
  const point = { shape: tmp2(8847).CutoutShape.Circle, x: diff, y: diff, size: 2 * sum };
