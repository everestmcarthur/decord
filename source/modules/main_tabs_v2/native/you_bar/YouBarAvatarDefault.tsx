...
// Dependencies: [19, 17, 15177, 1074, 21, 4605, 576, 4306, 1178, 8884, 8827, 2]

// Module 16469 (YouBarAvatarDefault)
...
const ClipViewDefault = tmp4(8884);
require = fn;
function AvatarDefault() {
  ...
  const point = { shape: tmp2(8884).CutoutShape.Circle, x: diff, y: diff, size: 2 * sum };
