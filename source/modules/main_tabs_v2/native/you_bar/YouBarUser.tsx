...
// Function ID: 16496
// Name: YouBarUser
// Dependencies: [19, 17, 1372, 15189, 21, 4639, 576, 504, 4376, 5058, 4484, 16496, 16497, 16498, 2]

// Module 16495 (YouBarUser)
...
export default noop.memo(function YouBarUser(isQuestRendered) {
  ...
  obj8.style = items4;
  const items5 = [closure_9(sharedValue(16496), { isLarge: !isQuestRendered }), ];
