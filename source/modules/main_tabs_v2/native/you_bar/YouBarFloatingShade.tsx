...
// Dependencies: [19, 17, 4457, 15205, 16412, 21, 4638, 504, 4339, 576, 15207, 1478, 4498, 16147, 4456, 1092, 5072, 2]
...
export default noop.memo(function YouBarFloatingShade() {
  ...
  const gradientValue = client_themes_ClientThemesUtils.useGradientValue(tmp2(4456).GradientPercentage.END);
