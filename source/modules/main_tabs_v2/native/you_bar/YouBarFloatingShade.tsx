...
// Dependencies: [19, 17, 4426, 15156, 16353, 21, 4606, 504, 4308, 576, 15158, 1477, 4467, 16088, 4425, 1091, 5038, 2]

// Module 16466 (YouBarFloatingShade)
...
export default noop.memo(function YouBarFloatingShade() {
  ...
  const gradientValue = client_themes_ClientThemesUtils.useGradientValue(tmp2(4425).GradientPercentage.END);
