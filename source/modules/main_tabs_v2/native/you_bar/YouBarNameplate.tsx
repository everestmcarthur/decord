...
// Dependencies: [19, 4632, 15210, 21, 4341, 576, 15296, 504, 4376, 5061, 8975, 2]

// Module 16544 (YouBarNameplate)
import spring from "spring" /* 5061 */;
import noop from "module_19" /* 19 */;
import AccessibilityStore from "AccessibilityStore" /* 4632 */;

require = fn;
const YOU_BAR_SPRING_CONFIG = fn(15210).YOU_BAR_SPRING_CONFIG;
const jsx = fn(21).jsx;
...
export default noop.memo(function YouBarNameplate(isQuestRendered) {
  ...
  fn.__closure = { withSpring: isQuestRendered(5061).withSpring, isQuestRendered, questDockAnimatedBorderRadius: tmp4, borderRadius: token, YOU_BAR_SPRING_CONFIG };
  ...
  const obj4 = { withSpring: isQuestRendered(5061).withSpring, isQuestRendered, questDockAnimatedBorderRadius: tmp4, borderRadius: token, YOU_BAR_SPRING_CONFIG };
  if (str) {
    str = "always";
  }
  obj6.animate = str;
  obj5.children = jsx(tmp2(8975), { nameplate, isFocused: true, animate: null });
