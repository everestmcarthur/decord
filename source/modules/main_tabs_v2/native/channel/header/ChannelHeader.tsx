...
// Function ID: 13511
// Name: ChannelHeader
// Dependencies: [19, 1958, 1074, 1965, 21, 1364, 4588, 11712, 1110, 4580, 563, 4933, 13511, 13512, 13513, 13521, 1115, 13523, 2]
  ...
  if (channelId === StaticChannelRoute.ROLE_SUBSCRIPTIONS) {
    ...
    if (isPrivateResult) {
      ...
      if (isForumLikeChannelResult) {
        ...
        tmp8Result = tmp8(tmp9(13521), obj4);
        const tmp9Result = tmp9(13521);
      } else {
        ...
        tmp8Result = tmp8(tmp9(13523), obj5);
        const tmp9Result2 = tmp9(13523);
      }
    }
  }
  return tmp8Result;
...
export const navigateToChannelDetails = function navigateToChannelDetails(channelId, screenIndex, source) {
  if (obj.isIOS()) {
    const chatInputRef = tmp(4588).getChatInputRef(channelId, screenIndex);
