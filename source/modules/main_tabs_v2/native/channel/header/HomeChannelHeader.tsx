...
// Dependencies: [19, 17, 21, 4722, 576, 1177, 13019, 4718, 1115, 2]

// Module 13512 (HomeChannelHeader)
...
export default noop.memo(function HomeChannelHeader() {
  ...
  const items = [React4(native.Icon, { source: _modDef13019, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
