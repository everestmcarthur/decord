...
// Dependencies: [19, 17, 21, 4640, 576, 1177, 12928, 4636, 1115, 2]

// Module 13421 (HomeChannelHeader)
...
export default noop.memo(function HomeChannelHeader() {
  ...
  const items = [React4(native.Icon, { source: _modDef12928, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
