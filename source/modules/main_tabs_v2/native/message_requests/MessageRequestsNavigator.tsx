...
// Dependencies: [19, 17, 21, 8020, 4639, 576, 7107, 7582, 1612, 7969, 1115, 11061, 17027, 17046, 17047, 2]
// Exports: default

// Module 17026 (MessageRequestsNavigator)
...
export default function MessageRequestsNavigator() {
  ...
  obj4.getComponent = function getComponent() {
    return closure_0(17027).default;
  };
  ...
  obj6.getComponent = function getComponent() {
    return closure_0(17046).default;
  };
  ...
  obj8.getComponent = function getComponent() {
    return closure_0(17047).default;
  };
