...
// Dependencies: [19, 4622, 1074, 21, 12535, 10034, 10169, 16981, 11436, 2]
// Exports: default
...
export default function MessageRequestsScreen(route) {
  ...
  const isMessageRequestRestrictedViewer = channelId(12535).useIsMessageRequestRestrictedViewer("MessageRequestsPreviewScreen");
  ...
  if (isMessageRequestRestrictedViewer) {
    ...
    tmp5Result = tmp5(tmp7(11436), obj4);
  }
  obj2.children = tmp5Result;
  return jsx(channelId(10169).ChannelContainer, { guildId: ME, channelId, children: null });
};
