...
// Dependencies: [32, 19, 17, 9653, 7979, 1074, 9654, 1085, 21, 4638, 16660, 4374, 5077, 4572, 4498, 16661, 4348, 4375, 5013, 16662, 1485, 16136, 4504, 16140, 6763, 4491, 16135, 9711, 573, 4505, 2]

// Module 16659 (MainTabsChannelScreenStack)
  ...
  const effect3 = obj.useEffect(() => {
    ...
    if (tmp3) {
      ...
      if (tmp.channelId === ref.current) {
        ...
        if (!isChatLockedOpen) {
          isChatLockedOpen = tmp7(4498).getChatLayout().isChatLockedOpen;
          const tmp7Result = tmp7(4498);
        }
        if (!isChatLockedOpen) {
