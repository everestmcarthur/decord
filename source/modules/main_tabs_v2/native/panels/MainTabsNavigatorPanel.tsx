// Module ID: 16006
// Function ID: 16007
// Dependencies: [32, 19, 17, 1074, 21, 3, 4560, 576, 1484, 4420, 11533, 11532, 16007, 4425, 16008, 4418, 4571, 1109, 16009, 4573, 16012, 4296, 5626, 7874, 16013, 6655, 16014, 16015, 16530, 16531, 16532, 16737, 2]
...
const memoResult = importAllResult.memo(function MainTabsNavigatorPanel() {
  ...
  obj1 = navigation(drawerWidth[10]);
  ...
  closure_7 = tmp10[1];
  const first1 = arr2[0];
  closure_9 = importAllResult.useRef(first1);
  const items1 = [first1];
  ...
  const effect6 = obj2.useEffect(() => {
    ...
    if (type === navigation(drawerWidth[14]).ChannelScreenType.BACKGROUND_SAVED) {
      ...
      obj = isChatLockedOpen(drawerWidth[19]);
    }
  }, items8);
  ...
  if (isChatBesideChannelList) {
    ...
    const memo = obj2.useMemo(() => {
      let tmp = null;
      if (isChatBesideChannelList) {
        obj = { translateX: null, maxWidth: null, isChatLockedOpen: null };
        obj[0] = translateX;
        obj[1] = maxWidth;
