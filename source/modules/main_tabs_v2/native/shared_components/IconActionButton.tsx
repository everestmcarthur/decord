...
// Dependencies: [19, 21, 4605, 576, 1115, 1178, 5032, 5173, 4601, 7920, 2]
// Exports: default

// Module 13327 (IconActionButton)
import nativeDefault from "native" /* 576 */;
import PlatformUtils from "PlatformUtils" /* 1115 */;
import native from "native" /* 1178 */;
import useFontScale from "useFontScale" /* 5032 */;
import Pressables from "Pressables" /* 5173 */;
import Badge from "Badge" /* 7920 */;
...
export default function IconActionButton(variant) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp2(4601).Text, obj2);
  }
