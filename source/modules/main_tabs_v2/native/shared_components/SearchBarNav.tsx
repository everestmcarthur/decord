...
// Function ID: 7451
// Name: SearchBarNav
// Dependencies: [19, 17, 21, 4607, 5734, 576, 5175, 1114, 1115, 5680, 4603, 7124, 2]

// Module 7450 (SearchBarNav)
...
let obj = { container: { flexDirection: "row", alignItems: "center", height: fn(5734).NAV_BAR_HEIGHT, paddingHorizontal: nativeDefault.space.PX_16, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: nativeDefault.colors.BORDER_STRONG }, cancelText: null, cancelIcon: null, flex: null };
let obj3 = { flexDirection: "row", alignItems: "center", height: fn(5734).NAV_BAR_HEIGHT, paddingHorizontal: nativeDefault.space.PX_16, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: nativeDefault.colors.BORDER_STRONG };
...
export default noop.forwardRef((onClose, ref) => {
  ...
  if (obj2.isAndroid()) {
    ...
    let tmp3Result = tmp3(tmp4(5680).ArrowLargeLeftIcon, obj3);
  } else {
    ...
    tmp3Result = tmp3(tmp4(4603).Text, obj4);
  }
