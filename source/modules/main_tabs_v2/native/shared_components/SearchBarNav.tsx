...
// Function ID: 7491
// Name: SearchBarNav
// Dependencies: [19, 17, 21, 4640, 5770, 576, 5210, 1115, 1364, 5716, 4636, 7164, 2]
...
export default noop.forwardRef((onClose, ref) => {
  ...
  if (obj2.isAndroid()) {
    ...
    let tmp3Result = tmp3(tmp4(5716).ArrowLargeLeftIcon, obj3);
  } else {
    ...
    tmp3Result = tmp3(tmp4(4636).Text, obj4);
  }
