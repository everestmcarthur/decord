...
// Dependencies: [19, 17, 7292, 7293, 21, 4606, 504, 16100, 5026, 1114, 8172, 13350, 9974, 2]
// Exports: default
...
export default function MessageRequestsButton(alternateVariant) {
  ...
  if (flag) {
    ...
    if (null != str1) {
      ...
      let tmp21 = React5(tmp3(5026).Button, obj4);
      let tmp16 = React5;
    } else {
      tmp16 = React5;
      ...
      tmp21 = React5(tmp3(8172).IconButton, obj5);
    }
    const items2 = [tmp21, str > 0 && tmp16(tmp3(13350).ButtonBadge, { badgePosition: "right" })];
    obj3.children = items2;
    return React6(View, obj3);
  } else {
    const obj6 = { source: _modDef9974, IconComponent: MessageRequestAnimation, accessibilityLabel: null, buttonText: null, badge: null, badgePosition: "right" };
