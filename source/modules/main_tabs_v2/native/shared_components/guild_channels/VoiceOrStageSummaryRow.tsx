...
// Dependencies: [19, 17, 21, 4722, 576, 10364, 4718, 1177, 17041, 2]

// Module 17040 (guild_channels/VoiceOrStageSummaryRow)
...
export default noop.memo(function VoiceOrStageSummaryRow(layout) {
  ...
  if (tmp8Result) {
    ...
    obj5.style = items3;
    let obj6 = { size: tmp(tmp2[7]).Icon.Sizes.CUSTOM, style: { height: 14, width: 14 }, source: require("module_17041") };
