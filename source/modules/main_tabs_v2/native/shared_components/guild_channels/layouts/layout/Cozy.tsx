...
obj.icon = { avatarSize: fn(1177).AvatarSizes.LARGE_48, guildIconSize: fn(5669).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5669).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj5 = { avatarSize: fn(1177).AvatarSizes.LARGE_48, guildIconSize: fn(5669).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5669).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
