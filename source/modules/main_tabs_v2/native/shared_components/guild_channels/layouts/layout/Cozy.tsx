...
obj.voiceOrStageSummaryRow = { size: 32, avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32 };
const obj3 = { size: 32, avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32 };
...
const obj4 = { text: { variant: "redesign/message-preview/medium" }, messageTypeIconSize: fn(1178).IconSizes.REFRESH_SMALL_16, messageTypeIconSizeNew: "xs", height: 18, margin: { marginTop: 2 } };
obj.icon = { avatarSize: fn(1178).AvatarSizes.LARGE_48, guildIconSize: fn(5634).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5634).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj5 = { avatarSize: fn(1178).AvatarSizes.LARGE_48, guildIconSize: fn(5634).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5634).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
obj6.icon = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7224).GameIconSizes.SMALL };
...
const obj7 = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7224).GameIconSizes.SMALL };
