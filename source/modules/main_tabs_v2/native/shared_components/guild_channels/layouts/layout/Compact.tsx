...
// Function ID: 10274
// Name: Compact
// Dependencies: [576, 1177, 5672, 7286, 10272, 2]
// Exports: getCompactStyles

// Module 10273 (Compact)
import nativeDefault from "native" /* 576 */;
import deepmergeDefault from "deepmerge" /* 10272 */;
...
CHANNEL_LIST_STYLES_COMPACT.icon = { avatarSize: fn(1177).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5672).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5672).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj5 = { avatarSize: fn(1177).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5672).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5672).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
obj7.icon = { size: fn(1177).IconSizes.EXTRA_SMALL, gameSize: fn(7286).GameIconSizes.SIZE_24 };
...
const obj8 = { size: fn(1177).IconSizes.EXTRA_SMALL, gameSize: fn(7286).GameIconSizes.SIZE_24 };
const size = fn(2);
