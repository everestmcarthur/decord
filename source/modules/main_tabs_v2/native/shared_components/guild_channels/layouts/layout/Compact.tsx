...
// Function ID: 10214
// Name: Compact
// Dependencies: [576, 1178, 5635, 7245, 10212, 2]
// Exports: getCompactStyles

// Module 10213 (Compact)
import nativeDefault from "native" /* 576 */;
import deepmergeDefault from "deepmerge" /* 10212 */;
...
CHANNEL_LIST_STYLES_COMPACT.icon = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5635).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5635).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj5 = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5635).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5635).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
obj7.icon = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7245).GameIconSizes.SIZE_24 };
...
const obj8 = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7245).GameIconSizes.SIZE_24 };
const size = fn(2);
