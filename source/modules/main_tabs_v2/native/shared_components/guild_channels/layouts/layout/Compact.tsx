...
// Function ID: 10253
// Name: Compact
// Dependencies: [576, 1178, 5665, 7275, 10251, 2]
// Exports: getCompactStyles

// Module 10252 (Compact)
import nativeDefault from "native" /* 576 */;
import deepmergeDefault from "deepmerge" /* 10251 */;
...
CHANNEL_LIST_STYLES_COMPACT.icon = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5665).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5665).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj5 = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5665).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5665).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
obj7.icon = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7275).GameIconSizes.SIZE_24 };
...
const obj8 = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7275).GameIconSizes.SIZE_24 };
const size = fn(2);
