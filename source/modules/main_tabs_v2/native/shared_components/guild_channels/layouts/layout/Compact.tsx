...
// Function ID: 10195
// Name: Compact
// Dependencies: [576, 1178, 5634, 7224, 10193, 2]
// Exports: getCompactStyles

// Module 10194 (Compact)
import nativeDefault from "native" /* 576 */;
import deepmergeDefault from "deepmerge" /* 10193 */;
...
CHANNEL_LIST_STYLES_COMPACT.icon = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5634).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5634).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj5 = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5634).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5634).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
obj7.icon = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7224).GameIconSizes.SIZE_24 };
...
const obj8 = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7224).GameIconSizes.SIZE_24 };
const size = fn(2);
