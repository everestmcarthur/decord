...
// Function ID: 10251
// Name: CozyDrawer
// Dependencies: [10251, 10252, 576, 1178, 5665, 7275, 2]

// Module 10250 (CozyDrawer)
...
obj.icon = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5665).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5665).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5665).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5665).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7275).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7275).GameIconSizes.SMALL };
