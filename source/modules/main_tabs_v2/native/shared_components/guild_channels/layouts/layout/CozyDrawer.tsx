...
// Function ID: 10253
// Name: CozyDrawer
// Dependencies: [10253, 10254, 576, 1177, 5669, 7279, 2]

// Module 10252 (CozyDrawer)
import nativeDefault from "native" /* 576 */;
import "deepmerge";
import deepmerge from "deepmerge" /* 10253 */;
...
obj.icon = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5669).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5669).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5669).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5669).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
