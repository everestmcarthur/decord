...
// Function ID: 10214
// Name: CozyDrawer
// Dependencies: [10214, 10215, 576, 1178, 5636, 7246, 2]

// Module 10213 (CozyDrawer)
import nativeDefault from "native" /* 576 */;
import "deepmerge";
import deepmerge from "deepmerge" /* 10214 */;
...
obj.messagePreview = { text: { variant: "text-xs/medium" }, messageTypeIconSize: fn(1178).IconSizes.EXTRA_SMALL, messageTypeIconSizeNew: "xs", height: 18, margin: { marginTop: 0 } };
obj.inviteRow = { text: { variant: "text-md/semibold" } };
const obj3 = { text: { variant: "text-xs/medium" }, messageTypeIconSize: fn(1178).IconSizes.EXTRA_SMALL, messageTypeIconSizeNew: "xs", height: 18, margin: { marginTop: 0 } };
obj.icon = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5636).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5636).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5636).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5636).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7246).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7246).GameIconSizes.SMALL };
...
const importDefaultResultResult = deepmerge(fn(10215).CHANNEL_LIST_STYLES_COMPACT, obj);
obj9.icon = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32 };
const obj10 = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32 };
const size = fn(2);
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(10215).CHANNEL_LIST_STYLES_COMPACT, obj9);
