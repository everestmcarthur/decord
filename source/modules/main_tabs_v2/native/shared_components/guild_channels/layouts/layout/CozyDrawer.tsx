...
// Function ID: 10366
// Name: CozyDrawer
// Dependencies: [10366, 10367, 576, 1177, 5754, 7368, 2]

// Module 10365 (CozyDrawer)
import nativeDefault from "native" /* 576 */;
import "deepmerge";
import deepmerge from "deepmerge" /* 10366 */;
...
obj.icon = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5754).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5754).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5754).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5754).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(7368).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(7368).GameIconSizes.SMALL };
...
const importDefaultResultResult = deepmerge(fn(10367).CHANNEL_LIST_STYLES_COMPACT, obj);
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(10367).CHANNEL_LIST_STYLES_COMPACT, obj9);
