...
// Function ID: 10212
// Name: CozyDrawer
// Dependencies: [10212, 10213, 576, 1178, 5635, 7245, 2]

// Module 10211 (CozyDrawer)
...
obj.icon = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5635).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5635).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5635).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5635).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7245).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7245).GameIconSizes.SMALL };
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(10213).CHANNEL_LIST_STYLES_COMPACT, obj9);
