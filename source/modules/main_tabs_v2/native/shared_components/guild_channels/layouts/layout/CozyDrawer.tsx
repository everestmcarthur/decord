...
// Function ID: 10155
// Name: CozyDrawer
// Dependencies: [10155, 10156, 576, 1178, 5598, 7186, 2]

// Module 10154 (CozyDrawer)
import nativeDefault from "native" /* 576 */;
import "deepmerge";
import deepmerge from "deepmerge" /* 10155 */;
...
obj.icon = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5598).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5598).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5598).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5598).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7186).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7186).GameIconSizes.SMALL };
...
const importDefaultResultResult = deepmerge(fn(10156).CHANNEL_LIST_STYLES_COMPACT, obj);
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(10156).CHANNEL_LIST_STYLES_COMPACT, obj9);
