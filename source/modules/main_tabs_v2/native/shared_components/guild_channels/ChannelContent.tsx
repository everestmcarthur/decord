...
// Function ID: 17044
// Name: ChannelContent
// Dependencies: [19, 17, 10361, 4904, 21, 4722, 1364, 10364, 5231, 17044, 5264, 8826, 16375, 4718, 2]
// Exports: renderChannelContent

// Module 17043 (ChannelContent)
import isRoleRequiredDefault from "isRoleRequired" /* 5231 */;
import ChannelListLayout from "ChannelListLayout" /* 10364 */;
import guild_channels_ChannelTitleDefault from "guild_channels/ChannelTitle" /* 17044 */;
import noop from "module_19" /* 19 */;

const GuildRoleSubscriptionGatedChannelIconDefault = tmp13(16375);
require = fn;
function ChannelContentComponent(arg0) {
  ...
  if (obj17) {
    ...
    tmp10Result5 = tmp10(tmp2(4718).Text, obj16);
  }
...
let obj4 = { opacity: fn(10361).SUBTITLE_OPACITY_NORMAL, marginRight: 4, marginTop: null };
