...
// Function ID: 16741
// Name: ChannelContent
// Dependencies: [19, 17, 10209, 4789, 21, 4607, 1115, 10212, 5114, 16741, 5147, 8681, 16189, 4603, 2]
...
function ChannelContentComponent(arg0) {
  ...
  if (obj17) {
    ...
    tmp10Result5 = tmp10(tmp2(4603).Text, obj16);
  }
...
let obj4 = { opacity: fn(10209).SUBTITLE_OPACITY_NORMAL, marginRight: 4, marginTop: null };
