...
// Function ID: 16753
// Name: ChannelContent
// Dependencies: [19, 17, 10188, 4787, 21, 4605, 1115, 10191, 5112, 16753, 5145, 8658, 16200, 4601, 2]
// Exports: renderChannelContent

// Module 16752 (ChannelContent)
import isRoleRequiredDefault from "isRoleRequired" /* 5112 */;
import ChannelListLayout from "ChannelListLayout" /* 10191 */;
import guild_channels_ChannelTitleDefault from "guild_channels/ChannelTitle" /* 16753 */;
import noop from "module_19" /* 19 */;

const GuildRoleSubscriptionGatedChannelIconDefault = tmp13(16200);
require = fn;
function ChannelContentComponent(arg0) {
  ...
  if (obj17) {
    ...
    tmp10Result5 = tmp10(tmp2(4601).Text, obj16);
  }
...
let obj4 = { opacity: fn(10188).SUBTITLE_OPACITY_NORMAL, marginRight: 4, marginTop: null };
