...
// Function ID: 16904
// Name: ChannelContent
// Dependencies: [19, 17, 10267, 4822, 21, 4640, 1364, 10270, 5149, 16904, 5182, 8743, 16278, 4636, 2]
// Exports: renderChannelContent

// Module 16903 (ChannelContent)
import isRoleRequiredDefault from "isRoleRequired" /* 5149 */;
import ChannelListLayout from "ChannelListLayout" /* 10270 */;
import guild_channels_ChannelTitleDefault from "guild_channels/ChannelTitle" /* 16904 */;
import noop from "module_19" /* 19 */;

const GuildRoleSubscriptionGatedChannelIconDefault = tmp13(16278);
require = fn;
function ChannelContentComponent(arg0) {
  ...
  if (obj17) {
    ...
    tmp10Result5 = tmp10(tmp2(4636).Text, obj16);
  }
...
let obj4 = { opacity: fn(10267).SUBTITLE_OPACITY_NORMAL, marginRight: 4, marginTop: null };
