...
// Function ID: 16741
// Name: ChannelContent
// Dependencies: [19, 17, 10207, 4788, 21, 4606, 1115, 10210, 5113, 16741, 5146, 8679, 16189, 4602, 2]
// Exports: renderChannelContent

// Module 16740 (ChannelContent)
import isRoleRequiredDefault from "isRoleRequired" /* 5113 */;
import ChannelListLayout from "ChannelListLayout" /* 10210 */;
import guild_channels_ChannelTitleDefault from "guild_channels/ChannelTitle" /* 16741 */;
import noop from "module_19" /* 19 */;

const GuildRoleSubscriptionGatedChannelIconDefault = tmp13(16189);
require = fn;
function ChannelContentComponent(arg0) {
  ...
  if (obj17) {
    ...
    tmp10Result5 = tmp10(tmp2(4602).Text, obj16);
  }
...
let obj4 = { opacity: fn(10207).SUBTITLE_OPACITY_NORMAL, marginRight: 4, marginTop: null };
