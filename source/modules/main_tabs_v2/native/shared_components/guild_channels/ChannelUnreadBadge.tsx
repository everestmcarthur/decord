...
// Dependencies: [19, 17, 10267, 4822, 21, 4640, 10270, 5069, 7990, 2]
...
export default noop.memo(function ChannelUnreadBadge(panelVariant) {
  ...
  if (unread) {
    ...
    items[3] = tmp2(10270).makeSizeStyle(layoutStyles.unreadBadge.size);
    obj2.style = items;
    const obj3 = { classic: flag, size: null, badgeStyle: null };
    const tmp2Result = tmp2(10270);
    const tmp9 = View;
    const _Math = Math;
    obj3.size = tmp2(7990).CHANNEL_BADGE_SIZE * Math.max(tmp6, 1);
