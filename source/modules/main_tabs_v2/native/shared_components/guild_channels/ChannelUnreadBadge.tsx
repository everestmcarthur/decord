...
// Dependencies: [19, 17, 10207, 4788, 21, 4606, 10210, 5033, 7942, 2]
...
export default noop.memo(function ChannelUnreadBadge(panelVariant) {
  ...
  if (unread) {
    ...
    items[3] = tmp2(10210).makeSizeStyle(layoutStyles.unreadBadge.size);
    obj2.style = items;
    const obj3 = { classic: flag, size: null, badgeStyle: null };
    const tmp2Result = tmp2(10210);
    const tmp9 = View;
    const _Math = Math;
    obj3.size = tmp2(7942).CHANNEL_BADGE_SIZE * Math.max(tmp6, 1);
