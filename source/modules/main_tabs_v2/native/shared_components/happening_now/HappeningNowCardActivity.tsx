...
// Dependencies: [19, 17, 1963, 1372, 15406, 1074, 1085, 21, 16204, 16205, 4638, 576, 7272, 504, 7278, 1241, 9679, 1897, 8308, 16199, 4790, 16206, 15407, 16200, 1177, 16209, 11037, 16210, 10051, 13149, 8843, 5182, 9366, 1115, 4487, 1364, 10198, 5673, 16201, 16212, 10201, 8268, 16214, 8376, 2]

// Module 16203 (HappeningNowCardActivity)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1897 */;
import ColorUtils from "ColorUtils" /* 4487 */;
import useFetchStreamPreviewDefault from "useFetchStreamPreview" /* 10201 */;
import useLiveStageData from "useLiveStageData" /* 16201 */;
import _modDef16204 from "module_16204" /* 16204 */;
import _modDef16205 from "module_16205" /* 16205 */;
import HappeningNowAvatarStack from "HappeningNowAvatarStack" /* 16212 */;
...
function IconOrPreview(arg0) {
  ...
  if (null != assetImage) {
    ...
    if (null != stream) {
      ...
      obj3.children = closure_11(tmp2(10198), obj8);
      ...
      obj11.children = closure_11(tmp2(5673), obj12);
...
let items = [_modDef16204, _modDef16205];
...
export default noop.memo((userId) => {
  ...
  const callback = activity.useCallback(() => {
    ...
    if (null != stream) {
      asyncRequireImpl(9679, tmp6.paths).then((result) => result.default(channelId.channelId, true));
      const promise2 = asyncRequireImpl(9679, tmp6.paths);
    } else {
      asyncRequireImpl(8308, tmp6.paths).then((result) => result.default({ userId, localUser, sourceAnalyticsLocations }));
      const promise = asyncRequireImpl(8308, tmp6.paths);
    }
  }, items2);
