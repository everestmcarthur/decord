...
// Dependencies: [32, 19, 17, 2026, 13176, 21, 4638, 576, 1177, 4374, 563, 5059, 8954, 4634, 1881, 16213, 2]
// Exports: HappeningNowAvatarStack

// Module 16212 (HappeningNowAvatarStack)
...
export const HappeningNowAvatarStack = function HappeningNowAvatarStack(userLimit) {
  ...
  mapped = substr.map((user, index) => {
    ...
    if (index !== diff) {
      ...
      const point = { shape: tmp3(8954).CutoutShape.Circle, x: tmp3(1177).AVATAR_SIZE_MAP[tmp5] - num3 - num2, y: -num2, size: tmp3(1177).AVATAR_SIZE_MAP[tmp5] + 2 * num2 };
      const items = [point];
      obj3.cutouts = items;
      obj3.children = tmp6;
