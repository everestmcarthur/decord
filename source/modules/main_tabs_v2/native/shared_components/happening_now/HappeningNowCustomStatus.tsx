...
// Dependencies: [5, 32, 19, 17, 4678, 15406, 1085, 21, 4638, 576, 563, 4872, 9319, 16207, 16208, 11026, 9910, 15407, 1364, 11041, 1177, 4634, 2]
// Exports: CustomStatusActivityCard

// Module 16206 (HappeningNowCustomStatus)
import nativeDefault from "native" /* 576 */;
import ActivityEmojiDefault from "ActivityEmoji" /* 11041 */;
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let tmp10 = activity(4872)({ userId: user.id, guildId });
  const displayNameStylesFont = user(9319).useDisplayNameStylesFont({ displayNameStyles: tmp10 });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                const obj5 = { value: user(16207).getEmojiSource(c1.emoji), done: false };
                return obj5;
              } else {
                v3 = 3;
              }
            ...
            if (arg0 === 1) {
              ...
              c2 = 2;
              v3 = 1;
              const obj9 = { value: user(16208).getEmojiDominantColors(obj8), done: false };
              return obj9;
            }
          } else if (arg0 === 1) {
            v3 = 3;
  ...
  let obj3 = user(9319);
  const gameMentionsAsPlainText = user(11026).useGameMentionsAsPlainText(activity.state);
  const items2 = [userTitle, , ];
  const tmp6Result = user(11026);
  items2[1] = user(9910).getStatusLabel(status);
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(11041), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15407).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4634).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15407).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4634).Text, obj19);
  ...
  return closure_12(activity(15407), obj4);
};
