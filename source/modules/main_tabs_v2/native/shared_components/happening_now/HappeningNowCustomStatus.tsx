...
// Dependencies: [5, 32, 19, 17, 4645, 15375, 1085, 21, 4605, 576, 563, 4839, 9245, 16159, 16160, 10950, 9840, 15376, 1115, 10965, 1178, 4601, 2]
// Exports: CustomStatusActivityCard

// Module 16158 (HappeningNowCustomStatus)
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let tmp10 = activity(4839)({ userId: user.id, guildId });
  const displayNameStylesFont = user(9245).useDisplayNameStylesFont({ displayNameStyles: tmp10 });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                const obj5 = { value: user(16159).getEmojiSource(c1.emoji), done: false };
                return obj5;
              } else {
                v3 = 3;
              }
            ...
            if (arg0 === 1) {
              ...
              c2 = 2;
              v3 = 1;
              const obj9 = { value: user(16160).getEmojiDominantColors(obj8), done: false };
              return obj9;
            }
          } else if (arg0 === 1) {
            v3 = 3;
  ...
  let obj3 = user(9245);
  const gameMentionsAsPlainText = user(10950).useGameMentionsAsPlainText(activity.state);
  const items2 = [userTitle, , ];
  const tmp6Result = user(10950);
  items2[1] = user(9840).getStatusLabel(status);
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(10965), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15376).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4601).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15376).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4601).Text, obj19);
  ...
  return closure_12(activity(15376), obj4);
};
