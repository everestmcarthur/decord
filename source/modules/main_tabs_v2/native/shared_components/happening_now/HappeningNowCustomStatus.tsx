...
// Dependencies: [5, 32, 19, 17, 4680, 15411, 1085, 21, 4640, 576, 563, 4874, 9330, 16237, 16238, 11034, 9921, 15412, 1364, 11049, 1177, 4636, 2]
// Exports: CustomStatusActivityCard

// Module 16236 (HappeningNowCustomStatus)
import nativeDefault from "native" /* 576 */;
import ActivityEmojiDefault from "ActivityEmoji" /* 11049 */;
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let tmp10 = activity(4874)({ userId: user.id, guildId });
  const displayNameStylesFont = user(9330).useDisplayNameStylesFont({ displayNameStyles: tmp10 });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                const obj5 = { value: user(16237).getEmojiSource(c1.emoji), done: false };
                return obj5;
              } else {
                v3 = 3;
              }
            ...
            if (arg0 === 1) {
              ...
              c2 = 2;
              v3 = 1;
              const obj9 = { value: user(16238).getEmojiDominantColors(obj8), done: false };
              return obj9;
            }
          } else if (arg0 === 1) {
            v3 = 3;
  ...
  let obj3 = user(9330);
  const gameMentionsAsPlainText = user(11034).useGameMentionsAsPlainText(activity.state);
  const items2 = [userTitle, , ];
  const tmp6Result = user(11034);
  items2[1] = user(9921).getStatusLabel(status);
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(11049), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15412).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4636).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15412).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4636).Text, obj19);
  ...
  return closure_12(activity(15412), obj4);
};
