...
// Dependencies: [5, 32, 19, 17, 4762, 15505, 1085, 21, 4722, 576, 563, 4956, 9414, 16334, 16335, 11128, 10015, 15506, 1364, 11142, 1177, 4718, 2]
// Exports: CustomStatusActivityCard

// Module 16333 (HappeningNowCustomStatus)
import nativeDefault from "native" /* 576 */;
import ActivityEmojiDefault from "ActivityEmoji" /* 11142 */;
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let tmp10 = activity(4956)({ userId: user.id, guildId });
  const displayNameStylesFont = user(9414).useDisplayNameStylesFont({ displayNameStyles: tmp10 });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                const obj5 = { value: user(16334).getEmojiSource(c1.emoji), done: false };
                return obj5;
              } else {
                v3 = 3;
              }
            ...
            if (arg0 === 1) {
              ...
              c2 = 2;
              v3 = 1;
              const obj9 = { value: user(16335).getEmojiDominantColors(obj8), done: false };
              return obj9;
            }
          } else if (arg0 === 1) {
            v3 = 3;
  ...
  let obj3 = user(9414);
  const gameMentionsAsPlainText = user(11128).useGameMentionsAsPlainText(activity.state);
  const items2 = [userTitle, , ];
  const tmp6Result = user(11128);
  items2[1] = user(10015).getStatusLabel(status);
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(11142), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15506).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4718).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15506).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4718).Text, obj19);
  ...
  return closure_12(activity(15506), obj4);
};
