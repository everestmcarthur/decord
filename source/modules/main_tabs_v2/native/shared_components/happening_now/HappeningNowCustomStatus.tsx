...
// Dependencies: [5, 32, 19, 17, 4614, 15326, 1085, 21, 4574, 576, 563, 4808, 9208, 16110, 16111, 10912, 9802, 15327, 1115, 10927, 1178, 4570, 2]
// Exports: CustomStatusActivityCard

// Module 16109 (HappeningNowCustomStatus)
import nativeDefault from "native" /* 576 */;
import ActivityEmojiDefault from "ActivityEmoji" /* 10927 */;
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let tmp10 = activity(4808)({ userId: user.id, guildId });
  const displayNameStylesFont = user(9208).useDisplayNameStylesFont({ displayNameStyles: tmp10 });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                const obj5 = { value: user(16110).getEmojiSource(c1.emoji), done: false };
                return obj5;
              } else {
                v3 = 3;
              }
            ...
            if (arg0 === 1) {
              ...
              c2 = 2;
              v3 = 1;
              const obj9 = { value: user(16111).getEmojiDominantColors(obj8), done: false };
              return obj9;
            }
          } else if (arg0 === 1) {
            v3 = 3;
  ...
  let obj3 = user(9208);
  const gameMentionsAsPlainText = user(10912).useGameMentionsAsPlainText(activity.state);
  const items2 = [userTitle, , ];
  const tmp6Result = user(10912);
  items2[1] = user(9802).getStatusLabel(status);
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(10927), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15327).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4570).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15327).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4570).Text, obj19);
  ...
  return closure_12(activity(15327), obj4);
};
