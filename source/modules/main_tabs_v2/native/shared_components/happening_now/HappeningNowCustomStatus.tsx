...
// Dependencies: [5, 32, 19, 17, 4679, 15390, 1085, 21, 4639, 576, 563, 4873, 9308, 16187, 16188, 11013, 9902, 15391, 1364, 11028, 1177, 4635, 2]
// Exports: CustomStatusActivityCard

// Module 16186 (HappeningNowCustomStatus)
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let tmp10 = activity(4873)({ userId: user.id, guildId });
  const displayNameStylesFont = user(9308).useDisplayNameStylesFont({ displayNameStyles: tmp10 });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                const obj5 = { value: user(16187).getEmojiSource(c1.emoji), done: false };
                return obj5;
              } else {
                v3 = 3;
              }
            ...
            if (arg0 === 1) {
              ...
              c2 = 2;
              v3 = 1;
              const obj9 = { value: user(16188).getEmojiDominantColors(obj8), done: false };
              return obj9;
            }
          } else if (arg0 === 1) {
            v3 = 3;
  ...
  let obj3 = user(9308);
  const gameMentionsAsPlainText = user(11013).useGameMentionsAsPlainText(activity.state);
  const items2 = [userTitle, , ];
  const tmp6Result = user(11013);
  items2[1] = user(9902).getStatusLabel(status);
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(11028), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15391).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4635).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15391).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4635).Text, obj19);
  ...
  return closure_12(activity(15391), obj4);
};
