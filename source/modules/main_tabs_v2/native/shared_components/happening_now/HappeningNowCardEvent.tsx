...
// Dependencies: [19, 17, 2026, 1372, 15505, 1074, 21, 4722, 576, 1177, 9054, 504, 16345, 9910, 10025, 1241, 10034, 1397, 10024, 15506, 5258, 4718, 1881, 1115, 2]

// Module 16344 (HappeningNowCardEvent)
...
const point = { shape: fn(9054).CutoutShape.Circle, x: -8, y: HAPPENING_NOW_CONTENT_HEIGHT / 2 - 8, size: 16 };
let items = [point];
