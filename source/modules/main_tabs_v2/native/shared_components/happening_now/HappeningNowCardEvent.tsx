...
// Dependencies: [19, 17, 2025, 1371, 15326, 1074, 21, 4574, 576, 1178, 8847, 504, 16121, 9697, 9812, 1242, 9821, 1396, 9811, 15327, 5103, 4570, 1880, 1114, 2]

// Module 16120 (HappeningNowCardEvent)
...
const point = { shape: fn(8847).CutoutShape.Circle, x: -8, y: HAPPENING_NOW_CONTENT_HEIGHT / 2 - 8, size: 16 };
let items = [point];
