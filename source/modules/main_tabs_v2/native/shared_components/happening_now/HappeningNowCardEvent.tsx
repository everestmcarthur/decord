...
// Dependencies: [19, 17, 2026, 1372, 15411, 1074, 21, 4640, 576, 1177, 8970, 504, 16248, 9816, 9931, 1241, 9940, 1397, 9930, 15412, 5176, 4636, 1881, 1115, 2]

// Module 16247 (HappeningNowCardEvent)
...
const point = { shape: fn(8970).CutoutShape.Circle, x: -8, y: HAPPENING_NOW_CONTENT_HEIGHT / 2 - 8, size: 16 };
let items = [point];
