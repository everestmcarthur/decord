...
// Dependencies: [19, 17, 2026, 1372, 15390, 1074, 21, 4639, 576, 1177, 8943, 504, 16198, 9797, 9912, 1241, 9921, 1397, 9911, 15391, 5173, 4635, 1881, 1115, 2]

// Module 16197 (HappeningNowCardEvent)
...
const point = { shape: fn(8943).CutoutShape.Circle, x: -8, y: HAPPENING_NOW_CONTENT_HEIGHT / 2 - 8, size: 16 };
let items = [point];
