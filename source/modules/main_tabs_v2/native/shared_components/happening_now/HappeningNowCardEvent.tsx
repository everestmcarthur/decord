...
// Dependencies: [19, 17, 2026, 1372, 15406, 1074, 21, 4638, 576, 1177, 8954, 504, 16218, 9805, 9920, 1241, 9929, 1397, 9919, 15407, 5174, 4634, 1881, 1115, 2]

// Module 16217 (HappeningNowCardEvent)
...
const point = { shape: fn(8954).CutoutShape.Circle, x: -8, y: HAPPENING_NOW_CONTENT_HEIGHT / 2 - 8, size: 16 };
let items = [point];
