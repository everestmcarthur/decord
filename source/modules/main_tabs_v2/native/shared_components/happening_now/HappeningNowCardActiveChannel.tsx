...
// Dependencies: [19, 17, 13762, 1957, 12060, 1371, 15357, 1074, 21, 4607, 504, 11, 1369, 12, 16159, 1242, 1100, 4760, 1114, 5080, 15358, 16153, 2]
...
const MAX_STORED_MESSAGES = fn(13762).MAX_STORED_MESSAGES;
