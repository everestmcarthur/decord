...
// Dependencies: [19, 17, 15390, 1074, 21, 4639, 576, 1241, 9668, 1897, 16181, 16182, 16183, 15391, 5181, 1177, 16192, 4792, 1115, 4791, 2]

// Module 16180 (HappeningNowCardLiveStage)
...
export default noop.memo((arg0) => {
  ...
  const callback = noop.useCallback(() => {
    ...
    asyncRequireImpl(9668, dependencyMap.paths).then((result) => {
