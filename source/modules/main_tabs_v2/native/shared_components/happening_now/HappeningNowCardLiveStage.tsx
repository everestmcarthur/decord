...
// Dependencies: [19, 17, 15406, 1074, 21, 4638, 576, 1241, 9679, 1897, 16201, 16202, 16203, 15407, 5182, 1177, 16212, 4791, 1115, 4790, 2]

// Module 16200 (HappeningNowCardLiveStage)
...
export default noop.memo((arg0) => {
  ...
  const callback = noop.useCallback(() => {
    ...
    asyncRequireImpl(9679, dependencyMap.paths).then((result) => {
