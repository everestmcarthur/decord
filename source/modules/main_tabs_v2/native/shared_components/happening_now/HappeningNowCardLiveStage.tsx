...
// Dependencies: [19, 17, 15411, 1074, 21, 4640, 576, 1241, 9690, 1897, 16231, 16232, 16233, 15412, 5184, 1177, 16242, 4793, 1115, 4792, 2]

// Module 16230 (HappeningNowCardLiveStage)
...
export default noop.memo((arg0) => {
  ...
  const callback = noop.useCallback(() => {
    ...
    asyncRequireImpl(9690, dependencyMap.paths).then((result) => {
