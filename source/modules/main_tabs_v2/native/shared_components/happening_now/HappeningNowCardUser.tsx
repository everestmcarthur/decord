...
// Dependencies: [19, 17, 4762, 1372, 15505, 1074, 21, 1177, 4722, 7358, 504, 1241, 8409, 1897, 4566, 10015, 15506, 8489, 2]

// Module 16347 (HappeningNowCardUser)
...
let closure_7 = fn(15505).HappeningNowCardTrackingType;
