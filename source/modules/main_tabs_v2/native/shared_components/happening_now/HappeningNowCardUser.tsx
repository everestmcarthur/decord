...
// Dependencies: [19, 17, 4679, 1372, 15390, 1074, 21, 1177, 4639, 7269, 504, 1241, 8299, 1897, 4484, 9902, 15391, 8378, 2]

// Module 16200 (HappeningNowCardUser)
...
let closure_7 = fn(15390).HappeningNowCardTrackingType;
