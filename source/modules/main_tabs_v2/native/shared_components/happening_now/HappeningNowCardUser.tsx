...
// Dependencies: [19, 17, 4678, 1372, 15406, 1074, 21, 1177, 4638, 7272, 504, 1241, 8308, 1897, 4482, 9910, 15407, 8387, 2]

// Module 16220 (HappeningNowCardUser)
...
let closure_7 = fn(15406).HappeningNowCardTrackingType;
