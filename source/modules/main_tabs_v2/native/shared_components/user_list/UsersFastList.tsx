...
// Function ID: 11000
// Name: UsersFastList
// Dependencies: [32, 19, 17, 10344, 21, 4639, 576, 11000, 5690, 7978, 4376, 4635, 1177, 5207, 5209, 1612, 7156, 10343, 11001, 11045, 11048, 7162, 2]
...
let closure_16 = noop.memo(function UserSectionInner(stickyAt) {
  ...
  if (null != onTitlePress) {
    ...
    tmp18 = React5(tmp3(5207).PressableOpacity, obj10);
  }
  ...
  if (null != actionTitle) {
    ...
    obj12.children = React5(tmp3(4635).Text, obj13);
    tmp21 = React5(tmp3(5207).PressableOpacity, obj12);
  }
  items5[1] = tmp21;
  ...
  if (!disableStickySections) {
    ...
    if (!disableThemedGradient) {
      const obj15 = { style: animatedStyle1, children: React5(tmp25(5209), { absolute: true, tall: true, wide: true, mix: true }) };
