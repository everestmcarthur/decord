...
// Function ID: 10958
// Name: UsersFastList
// Dependencies: [32, 19, 17, 10304, 21, 4607, 576, 10958, 5657, 7946, 4343, 4603, 1178, 5175, 5177, 1611, 7123, 10303, 10959, 11003, 11006, 7129, 2]

// Module 10957 (UsersFastList)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4343 */;
import Text_Text from "Text/Text" /* 4603 */;
import TableRow from "TableRow" /* 5657 */;
import ClientThemesOverrides from "ClientThemesOverrides" /* 7946 */;
import useFastestListTableRowPlaceholderConfig from "useFastestListTableRowPlaceholderConfig" /* 10958 */;
import UserRowDefault from "UserRow" /* 10959 */;
import GroupDMRowDefault from "GroupDMRow" /* 11003 */;
import ChannelRowDefault from "ChannelRow" /* 11006 */;
...
const UsersFastListConstants = fn(10304);
...
let closure_16 = noop.memo(function UserSectionInner(stickyAt) {
  ...
  if (null != onTitlePress) {
    ...
    tmp18 = React5(tmp3(5175).PressableOpacity, obj10);
  }
  ...
  if (null != actionTitle) {
    ...
    obj12.children = React5(tmp3(4603).Text, obj13);
    tmp21 = React5(tmp3(5175).PressableOpacity, obj12);
  }
  items5[1] = tmp21;
  ...
  if (!disableStickySections) {
    ...
    if (!disableThemedGradient) {
      const obj15 = { style: animatedStyle1, children: React5(tmp25(5177), { absolute: true, tall: true, wide: true, mix: true }) };
      tmp26 = React5(tmp25(4343).View, obj15);
    }
