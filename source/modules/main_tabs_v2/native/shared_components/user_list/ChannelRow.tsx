...
// Function ID: 11049
// Name: ChannelRow
// Dependencies: [19, 17, 1958, 1980, 4654, 4288, 1372, 10993, 4821, 21, 4639, 576, 504, 4792, 11049, 11138, 5172, 5164, 4635, 4321, 4231, 5689, 5690, 2]

// Module 11048 (ChannelRow)
...
import GuildIconWithChannelType from "GuildIconWithChannelType" /* 11138 */;
  ...
  const memo2 = onLongPress.useMemo(() => {
    if (undefined !== subLabel) {
      ...
      if (channel.isForumPost()) {
        let TextIcon = tmp3(5172).ForumIcon;
      } else {
        TextIcon = tmp3(5164).TextIcon;
      }
