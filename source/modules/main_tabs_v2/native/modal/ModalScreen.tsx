...
// Dependencies: [109, 19, 17, 1074, 21, 4640, 576, 4843, 8924, 1249, 7589, 1612, 17122, 1364, 17004, 2]
// Exports: default

// Module 17121 (modal/ModalScreen)
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(7589).trackAppUIViewed("ModalScreen"), []);
  ...
  tmp7Result = modal(17122);
  let isIOSResult = modal(1364).isIOS();
  if (isIOSResult) {
    isIOSResult = closure_9(tmp7(17004).PortalKeyboardRenderer, { portal: false });
  }
