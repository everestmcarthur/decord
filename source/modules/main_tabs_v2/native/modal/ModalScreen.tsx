...
// Dependencies: [109, 19, 17, 1074, 21, 4638, 576, 4841, 8908, 1249, 7585, 1612, 17082, 1364, 16965, 2]
// Exports: default

// Module 17081 (modal/ModalScreen)
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(7585).trackAppUIViewed("ModalScreen"), []);
  ...
  tmp7Result = modal(17082);
  let isIOSResult = modal(1364).isIOS();
  if (isIOSResult) {
    isIOSResult = closure_9(tmp7(16965).PortalKeyboardRenderer, { portal: false });
  }
