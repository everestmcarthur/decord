...
// Dependencies: [109, 19, 17, 1074, 21, 4606, 576, 4809, 8859, 1250, 7548, 1611, 16958, 1115, 16841, 2]
// Exports: default
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(7548).trackAppUIViewed("ModalScreen"), []);
