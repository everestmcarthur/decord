...
// Dependencies: [109, 19, 17, 1074, 21, 4639, 576, 4842, 8897, 1249, 7582, 1612, 17025, 1364, 16908, 2]
// Exports: default

// Module 17024 (modal/ModalScreen)
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(7582).trackAppUIViewed("ModalScreen"), []);
  ...
  tmp7Result = modal(17025);
  let isIOSResult = modal(1364).isIOS();
  if (isIOSResult) {
    isIOSResult = closure_9(tmp7(16908).PortalKeyboardRenderer, { portal: false });
  }
