...
// Function ID: 16110
// Name: MessagesHeader
// Dependencies: [19, 17, 1074, 21, 576, 12257, 10189, 5030, 4605, 4341, 5024, 16102, 4463, 12408, 5675, 8150, 11023, 1114, 4601, 7104, 16110, 5025, 4543, 2]
// Exports: getMessagesHeaderHeight

// Module 16109 (MessagesHeader)
...
import MobileVisualRefreshExperiment from "MobileVisualRefreshExperiment" /* 12257 */;
...
obj.headerPanelButtons = { height: fn(5030).SMALL_BUTTON_HEIGHT, gap: nativeDefault.modules.mobile.MESSAGES_HEADER_BUTTON_GAP, flexDirection: nativeDefault.modules.mobile.MESSAGES_HEADER_BUTTON_LAYOUT, alignItems: "center" };
let obj6 = {};
...
let obj5 = { height: fn(5030).SMALL_BUTTON_HEIGHT, gap: nativeDefault.modules.mobile.MESSAGES_HEADER_BUTTON_GAP, flexDirection: nativeDefault.modules.mobile.MESSAGES_HEADER_BUTTON_LAYOUT, alignItems: "center" };
const size = fn(2);
...
export default noop.memo(function MessagesHeader(height) {
  ...
  let obj = height(4341);
  fn.__closure = { withSpring: height(5024).withSpring, scrollPosition };
  fn.__workletHash = 17233409273245;
  fn.__initData = __initData;
  const animatedStyle = obj.useAnimatedStyle(fn);
  let obj2 = { withSpring: height(5024).withSpring, scrollPosition };
  const isHomeDrawerEnabled = height(16102).useIsHomeDrawerEnabled();
  ...
  let obj3 = height(16102);
  const obj4 = { variant: "primary", icon: null, size: "sm", accessibilityLabel: null, onPress: null };
  const tmp12 = scrollPosition(5675)("bespoke");
  obj4.icon = closure_6(height(11023).PlusLargeIcon, { size: "sm", color: scrollPosition(576).colors.WHITE });
  ...
  obj7.children = closure_6(height(4601).Text, { color: "mobile-text-heading-primary", variant: "heading-lg/semibold", maxFontSizeMultiplier: 1.75, accessibilityRole: "header", children: stringResult });
  const items1 = [closure_6(closure_4, obj7), , , ];
  const obj8 = { style: tmp.headerPanelButtons, children: null };
  const obj9 = { onPress: callback2, variant: "secondary", size: "sm", icon: scrollPosition(7104), accessibilityLabel: null };
  const intl3 = tmp3(1114).intl;
  obj9.accessibilityLabel = intl3.string(height(1114).t["5h0QOP"]);
  const items2 = [closure_6(height(8150).IconButton, obj9), closure_6(scrollPosition(16110), { noMargin: true, onPress: callback, alternateVariant: true }), , ];
  const obj10 = { variant: "secondary", grow: true, shrink: true, size: "sm", icon: scrollPosition(4543), onPress: callback1, maxFontSizeMultiplier: 1, text: null };
  const intl4 = tmp3(1114).intl;
  obj10.text = intl4.string(height(1114).t.zIJnA6);
  items2[2] = closure_6(height(5025).Button, obj10);
  items2[3] = closure_6(height(8150).IconButton, obj4);
  obj8.children = items2;
  items1[1] = closure_7(closure_4, obj8);
  const obj11 = { style: null };
  const items3 = [tmp.headerBorder, animatedStyle];
  obj11.style = items3;
  items1[2] = closure_6(scrollPosition(4341).View, obj11);
  items1[3] = tmp12;
