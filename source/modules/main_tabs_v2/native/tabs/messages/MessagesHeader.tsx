...
// Function ID: 16158
// Name: MessagesHeader
// Dependencies: [19, 17, 1074, 21, 576, 12329, 10257, 5065, 4638, 4374, 5059, 16150, 4496, 12481, 5711, 8214, 11101, 1115, 4634, 7162, 16158, 5060, 4575, 2]
// Exports: getMessagesHeaderHeight

// Module 16157 (MessagesHeader)
...
obj.headerPanelButtons = { height: fn(5065).SMALL_BUTTON_HEIGHT, gap: nativeDefault.modules.mobile.MESSAGES_HEADER_BUTTON_GAP, flexDirection: nativeDefault.modules.mobile.MESSAGES_HEADER_BUTTON_LAYOUT, alignItems: "center" };
let obj6 = {};
...
let obj5 = { height: fn(5065).SMALL_BUTTON_HEIGHT, gap: nativeDefault.modules.mobile.MESSAGES_HEADER_BUTTON_GAP, flexDirection: nativeDefault.modules.mobile.MESSAGES_HEADER_BUTTON_LAYOUT, alignItems: "center" };
const size = fn(2);
...
export default noop.memo(function MessagesHeader(height) {
  ...
  let obj = height(4374);
  fn.__closure = { withSpring: height(5059).withSpring, scrollPosition };
  fn.__workletHash = 17233409273245;
  fn.__initData = __initData;
  const animatedStyle = obj.useAnimatedStyle(fn);
  let obj2 = { withSpring: height(5059).withSpring, scrollPosition };
  const isHomeDrawerEnabled = height(16150).useIsHomeDrawerEnabled();
  ...
  let obj3 = height(16150);
  const obj4 = { variant: "primary", icon: null, size: "sm", accessibilityLabel: null, onPress: null };
  const tmp12 = scrollPosition(5711)("bespoke");
  obj4.icon = closure_6(height(11101).PlusLargeIcon, { size: "sm", color: scrollPosition(576).colors.WHITE });
  ...
  obj7.children = closure_6(height(4634).Text, { color: "mobile-text-heading-primary", variant: "heading-lg/semibold", maxFontSizeMultiplier: 1.75, accessibilityRole: "header", children: stringResult });
  const items1 = [closure_6(closure_4, obj7), , , ];
  const obj8 = { style: tmp.headerPanelButtons, children: null };
  const obj9 = { onPress: callback2, variant: "secondary", size: "sm", icon: scrollPosition(7162), accessibilityLabel: null };
  const intl3 = tmp3(1115).intl;
  obj9.accessibilityLabel = intl3.string(height(1115).t["5h0QOP"]);
  const items2 = [closure_6(height(8214).IconButton, obj9), closure_6(scrollPosition(16158), { noMargin: true, onPress: callback, alternateVariant: true }), , ];
  const obj10 = { variant: "secondary", grow: true, shrink: true, size: "sm", icon: scrollPosition(4575), onPress: callback1, maxFontSizeMultiplier: 1, text: null };
  const intl4 = tmp3(1115).intl;
  obj10.text = intl4.string(height(1115).t.zIJnA6);
  items2[2] = closure_6(height(5060).Button, obj10);
  items2[3] = closure_6(height(8214).IconButton, obj4);
  obj8.children = items2;
  items1[1] = closure_7(closure_4, obj8);
  const obj11 = { style: null };
  const items3 = [tmp.headerBorder, animatedStyle];
  obj11.style = items3;
  items1[2] = closure_6(scrollPosition(4374).View, obj11);
  items1[3] = tmp12;
