...
// Dependencies: [32, 19, 17, 21, 4638, 1478, 1484, 8908, 1249, 5211, 15207, 16184, 4634, 1115, 5060, 2]
// Exports: default

// Module 16183 (MessagesEmptyState)
...
export default function MessagesEmptyState() {
  ...
  const obj8 = { resizeMode: "contain", source: _modDef16184, style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
