...
// Dependencies: [32, 19, 17, 21, 4639, 1478, 1484, 8897, 1249, 5210, 15191, 16164, 4635, 1115, 5059, 2]
// Exports: default

// Module 16163 (MessagesEmptyState)
...
export default function MessagesEmptyState() {
  ...
  const obj8 = { resizeMode: "contain", source: _modDef16164, style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
