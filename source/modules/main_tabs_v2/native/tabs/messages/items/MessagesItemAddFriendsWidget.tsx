...
// Dependencies: [5, 19, 17, 1074, 21, 13408, 576, 4640, 8527, 4337, 1115, 9971, 7879, 4498, 5210, 4636, 13969, 16259, 2]

// Module 16258 (MessagesItemAddFriendsWidget)
...
const sum = fn(13408).ICON_ACTION_BUTTON_SIZE + nativeDefault.space.PX_16;
...
export default noop.memo(function MessagesItemAddFriendsWidget() {
  ...
  const obj5 = { style: tmp.actionIcon, variant: "filled", source: _modDef13969, onPress: handleShare, accessibilityLabel: null };
