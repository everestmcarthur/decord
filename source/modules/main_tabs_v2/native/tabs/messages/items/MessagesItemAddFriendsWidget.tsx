...
// Dependencies: [5, 19, 17, 1074, 21, 13327, 576, 4605, 8443, 4302, 1114, 9890, 7810, 4463, 5173, 4601, 13929, 16181, 2]

// Module 16180 (MessagesItemAddFriendsWidget)
...
import _modDef13929 from "module_13929" /* 13929 */;
...
export default noop.memo(function MessagesItemAddFriendsWidget() {
  ...
  const obj5 = { style: tmp.actionIcon, variant: "filled", source: _modDef13929, onPress: handleShare, accessibilityLabel: null };
