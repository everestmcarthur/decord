...
// Dependencies: [19, 1074, 3, 1241, 4374, 2]
// Exports: trackTabPressed, useTrackTabPerformance

// Module 16144 (TabsPerformanceTracker)
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    ...
    if (null != dependencyMap2[GUILDS]) {
      if (null != tmp3.startTime) {
        ...
        let obj3 = { runOnJS: GUILDS(4374).runOnJS, log };
        fn.__closure = obj3;
        fn.__workletHash = 7114578957129;
        fn.__initData = __initData;
        GUILDS(4374).runOnUI(fn)();
        const obj2 = GUILDS(4374);
      }
    }
    let obj = tmp[tmp2];
    if (obj == null) {
