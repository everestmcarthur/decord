...
// Dependencies: [19, 1074, 3, 1241, 4376, 2]
// Exports: trackTabPressed, useTrackTabPerformance

// Module 16124 (TabsPerformanceTracker)
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    ...
    if (null != dependencyMap2[GUILDS]) {
      if (null != tmp3.startTime) {
        ...
        let obj3 = { runOnJS: GUILDS(4376).runOnJS, log };
        fn.__closure = obj3;
        fn.__workletHash = 7114578957129;
        fn.__initData = __initData;
        GUILDS(4376).runOnUI(fn)();
        const obj2 = GUILDS(4376);
      }
    }
    let obj = tmp[tmp2];
    if (obj == null) {
