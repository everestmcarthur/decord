...
// Dependencies: [19, 17, 21, 16662, 576, 9054, 4722, 1115, 9144, 4718, 2]

// Module 17173 (YouScreenNavIcon)
...
const md = fn(16662).ICON_SIZE.md;
const result = (nativeDefault.space.PX_32 - md) / 2;
const TEXT_DEFAULT = nativeDefault.colors.TEXT_DEFAULT;
const point = { shape: fn(9054).CutoutShape.Circle, x: md - 8 - 4, y: -4, size: 16 };
let items = [point];
