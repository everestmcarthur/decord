...
// Dependencies: [19, 17, 21, 16535, 576, 8954, 4638, 1115, 9045, 4634, 2]

// Module 17003 (YouScreenNavIcon)
...
const md = fn(16535).ICON_SIZE.md;
const result = (nativeDefault.space.PX_32 - md) / 2;
const TEXT_DEFAULT = nativeDefault.colors.TEXT_DEFAULT;
const point = { shape: fn(8954).CutoutShape.Circle, x: md - 8 - 4, y: -4, size: 16 };
let items = [point];
