...
// Dependencies: [19, 17, 21, 16515, 576, 8943, 4639, 1115, 9034, 4635, 2]

// Module 16946 (YouScreenNavIcon)
...
const md = fn(16515).ICON_SIZE.md;
const result = (nativeDefault.space.PX_32 - md) / 2;
const TEXT_DEFAULT = nativeDefault.colors.TEXT_DEFAULT;
const point = { shape: fn(8943).CutoutShape.Circle, x: md - 8 - 4, y: -4, size: 16 };
let items = [point];
