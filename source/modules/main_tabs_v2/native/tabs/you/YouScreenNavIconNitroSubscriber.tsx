...
// Dependencies: [32, 19, 7555, 13480, 1954, 21, 8161, 504, 7491, 1943, 16904, 16906, 8785, 1114, 2]
...
export default noop.memo(function SubscriberNitroIcon(onPress) {
  ...
  const tmp5 = _slicedToArray(tmpResult2.useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: onPress(16904).REFERRAL_NITRO_BUTTON_RED_DOT_COOLDOWN_MS }, undefined, true), 2);
  dependencyMap = tmp6;
  ...
  const obj2 = { cooldownDurationMs: onPress(16904).REFERRAL_NITRO_BUTTON_RED_DOT_COOLDOWN_MS };
  ...
  return jsx(showReferralNotificationDot(16906), { IconComponent: null, accessibilityLabel: null, onPress: null, showRedDot: null });
});
