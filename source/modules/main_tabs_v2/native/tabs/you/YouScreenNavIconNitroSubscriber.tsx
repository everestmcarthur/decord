...
// Dependencies: [32, 19, 7526, 13449, 1954, 21, 8132, 504, 7462, 1943, 16877, 16879, 8755, 1114, 2]
...
export default noop.memo(function SubscriberNitroIcon(onPress) {
  ...
  obj3.IconComponent = onPress(8755).NitroWheelIcon;
