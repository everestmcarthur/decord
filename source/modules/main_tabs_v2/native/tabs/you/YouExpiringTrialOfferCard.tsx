...
// Dependencies: [19, 17, 13817, 1074, 7539, 1374, 21, 1091, 4639, 576, 16958, 1241, 1115, 4231, 563, 7554, 7546, 16956, 2025, 4635, 4297, 5207, 1177, 8788, 5071, 7314, 2]
// Exports: default

// Module 16957 (YouExpiringTrialOfferCard)
...
import NoticeActionCreatorsDefault from "NoticeActionCreators" /* 16958 */;
...
export default function YouExpiringTrialOfferCard(navigateToPremium) {
  ...
  importDefault = _modDef4231().add(5, "days");
  ...
  const premiumTrialOffer = navigateToPremium(7554).usePremiumTrialOffer();
  let num = 0;
  const obj3 = navigateToPremium(7554);
  ...
  shouldShowExpiringTrialOfferCard = navigateToPremium(16956).useShouldShowExpiringTrialOfferCard();
  ...
  if (shouldShowExpiringTrialOfferCard) {
    if (null != premiumTrialOffer) {
      if (null != stateFromStores) {
        ...
        const result = tmp4(4297).formatIntervalDuration(obj5);
        if (time.days > 0) {
        ...
        obj4.children = closure_12(tmp4(4635).Text, obj10);
        ...
        items2[1] = closure_12(tmp4(5207).PressableOpacity, obj11);
  ...
  const tmp4Result = navigateToPremium(16956);
};
