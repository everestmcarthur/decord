...
// Dependencies: [19, 17, 13830, 1074, 7542, 1374, 21, 1091, 4638, 576, 17015, 1241, 1115, 4229, 563, 7557, 7549, 17013, 2025, 4634, 4295, 5208, 1177, 8797, 5072, 7317, 2]
// Exports: default

// Module 17014 (YouExpiringTrialOfferCard)
...
import NoticeActionCreatorsDefault from "NoticeActionCreators" /* 17015 */;
...
export default function YouExpiringTrialOfferCard(navigateToPremium) {
  ...
  importDefault = _modDef4229().add(5, "days");
  ...
  const premiumTrialOffer = navigateToPremium(7557).usePremiumTrialOffer();
  let num = 0;
  const obj3 = navigateToPremium(7557);
  ...
  shouldShowExpiringTrialOfferCard = navigateToPremium(17013).useShouldShowExpiringTrialOfferCard();
  ...
  if (shouldShowExpiringTrialOfferCard) {
    if (null != premiumTrialOffer) {
      if (null != stateFromStores) {
        ...
        const result = tmp4(4295).formatIntervalDuration(obj5);
        if (time.days > 0) {
        ...
        obj4.children = closure_12(tmp4(4634).Text, obj10);
        ...
        items2[1] = closure_12(tmp4(5208).PressableOpacity, obj11);
  ...
  const tmp4Result = navigateToPremium(17013);
};
