...
// Dependencies: [19, 17, 11237, 21, 4638, 576, 1612, 16144, 1478, 4498, 16992, 1365, 2]

// Module 16991 (YouScreenContainer)
...
const useChatLayoutDefault = tmp(4498);
const YouScreenDefault = tmp(16992);
require = fn;
