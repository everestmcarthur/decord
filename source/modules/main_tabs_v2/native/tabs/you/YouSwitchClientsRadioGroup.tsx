...
// Dependencies: [32, 19, 21, 16478, 16479, 4603, 5766, 5769, 10947, 2]
// Exports: default
      ...
      if (arr.length >= 2) {
        let obj = {
          ...
          children: arr.map((value) => {
                  const obj = { value, label: memo(16479).DISCORD_VARIANTS[value].label, icon: jsx(memo(10947).ClydeIcon, { color: memo(16479).DISCORD_VARIANTS[value].color }) };
                  return jsx(memo(5769).TableRadioRow, { value, label: memo(16479).DISCORD_VARIANTS[value].label, icon: jsx(memo(10947).ClydeIcon, { color: memo(16479).DISCORD_VARIANTS[value].color }) }, value);
                })
        };
