...
// Dependencies: [19, 17, 12548, 1182, 1386, 7825, 4485, 1372, 1074, 12549, 21, 4639, 576, 4635, 5696, 14204, 14201, 14202, 14203, 1936, 7087, 10222, 4606, 1115, 5770, 5773, 9902, 504, 15269, 12082, 9490, 15363, 1228, 16482, 11458, 15365, 4484, 1177, 16061, 16484, 1241, 7289, 12552, 5207, 10221, 5772, 7307, 9191, 16489, 1897, 16479, 11249, 4341, 11013, 5692, 11252, 11028, 8886, 11259, 7196, 5711, 7304, 7256, 5057, 16490, 15845, 2]
...
function CustomStatus() {
  ...
  if (null != emoji2) {
    ...
    let tmp14Result = tmp14(tmp5(11028), obj6);
  } else {
    const obj7 = { size: "md", style: tmp.leadingIcon };
    tmp14Result = tmp14(tmp2(8886).ReactionIcon, obj7);
  }
  ...
  if (null != customStatusActivity) {
    ...
    const obj10 = { style: tmp.trailingIcon, source: tmp5(7196) };
    obj9.children = tmp14(timestampProducer, obj10);
    tmp14Result2 = tmp14(tmp2(5207).PressableOpacity, obj9);
  }
