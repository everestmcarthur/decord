...
// Dependencies: [19, 21, 1090, 1114, 10160, 7249, 5737, 5655, 2]
// Exports: default
...
export default function FocusModeOptionsActionSheet(onSelect) {
  ...
  const focusModeEnabled = onSelect(10160).useFocusModeEnabled();
  ...
  if (focusModeEnabled) {
    ...
    tmp4Result = tmp4(tmp(5655).TableRow, obj3);
  }
  ...
  obj2.children = items;
  obj4.children = closure_3(onSelect(5737).TableRowGroup, obj2);
  return closure_2(onSelect(7249).ActionSheet, obj4);
};
