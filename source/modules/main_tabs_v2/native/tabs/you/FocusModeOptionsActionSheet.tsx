...
// Dependencies: [19, 21, 1090, 1114, 10182, 7271, 5739, 5657, 2]
// Exports: default
...
export default function FocusModeOptionsActionSheet(onSelect) {
  ...
  const focusModeEnabled = onSelect(10182).useFocusModeEnabled();
  ...
  if (focusModeEnabled) {
    ...
    tmp4Result = tmp4(tmp(5657).TableRow, obj3);
  }
  ...
  obj2.children = items;
  obj4.children = closure_3(onSelect(5739).TableRowGroup, obj2);
  return closure_2(onSelect(7271).ActionSheet, obj4);
};
