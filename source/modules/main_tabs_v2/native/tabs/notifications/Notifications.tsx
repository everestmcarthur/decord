...
// Dependencies: [19, 17, 11245, 1955, 21, 4640, 576, 4498, 7057, 7975, 16562, 7237, 5210, 1115, 16563, 4636, 16564, 7981, 16566, 7276, 7296, 7589, 5718, 7270, 16570, 16571, 12048, 4493, 1612, 16174, 5212, 4350, 2]
// Exports: ThemedNotificationsModal

// Module 16561 (notifications/Notifications)
...
import useForLaterCoachmarkDefault from "useForLaterCoachmark" /* 16562 */;
import NotificationCenterPermissionNudgeDefault from "NotificationCenterPermissionNudge" /* 16570 */;
import NotificationCenterForYou from "NotificationCenterForYou" /* 16571 */;
...
let closure_12 = noop.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  if (!nestedInLaunchPad) {
    ...
    obj4.onPress = goBack;
    obj4.children = tmp12(tmp5(16563).LeftBackIconWithBadge, {});
    const items1 = [tmp12(tmp5(5210).PressableOpacity, obj4), , ];
    ...
    items1[1] = tmp12(tmp5(4636).Text, obj5);
    const obj6 = { style: tmp.actionButtons, children: null };
    let tmp10Result = null;
    if (isForLaterExperimentOn) {
      const obj7 = { children: null };
      const obj8 = { ref, type: tmp5(7981).SavedMessageSortTypes.BOOKMARK, onOpen: callback };
      const items2 = [tmp12(tmp2(16564), obj8), ];
      const obj9 = { type: null, onOpen: null };
      const tmp2Result = tmp2(16564);
      obj9.type = tmp5(7981).SavedMessageSortTypes.REMINDER;
      obj9.onOpen = callback;
      items2[1] = tmp12(tmp2(16564), obj9);
      obj7.children = items2;
      tmp10Result = tmp10(closure_8, obj7);
      const tmp2Result2 = tmp2(16564);
    }
    const items3 = [tmp10Result, tmp12(tmp2(16566), {})];
