...
// Dependencies: [19, 17, 16176, 1074, 16442, 21, 4640, 16182, 16443, 4376, 11152, 5212, 16185, 7995, 4341, 576, 1365, 5056, 12048, 2]

// Module 16441 (HomePanelContent)
...
import useHomeDrawerGesture from "useHomeDrawerGesture" /* 16182 */;
import GuildsBarDefault from "GuildsBar" /* 16443 */;
...
function ContentMaskGradient(offsetX) {
  ...
  const obj4 = { pointerEvents: "none", style: null, children: closure_9(guildsBarPullX(5212), { absolute: true, tall: true, wide: true, mix: true }) };
...
function HomeDrawerPanelContent() {
  ...
  const obj9 = ref(4376);
  fn2.__closure = { interpolate: ref(4376).interpolate, panelTranslateX, INITIAL_OPEN_WIDTH: ref(16182).INITIAL_OPEN_WIDTH, Extrapolation: ref(4376).Extrapolation, isGradientTheme: isClientThemeOrCustomThemeActive, interpolateColor: ref(4376).interpolateColor, maxX: tmp9, baseLowest: token, panelBg: token1 };
  ...
  if (doesLandOnHomeDrawer) {
    tmp17Result2 = tmp17(tmp3(12048).TTIFirstContentfulPaint, { label: "home_drawer", checkFocusedScreen: "guilds" });
  }
