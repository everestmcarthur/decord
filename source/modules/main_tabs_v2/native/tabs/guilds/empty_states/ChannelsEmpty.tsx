...
// Function ID: 16385
// Name: ChannelsEmpty
// Dependencies: [19, 17, 4276, 1074, 21, 4638, 4634, 576, 563, 9206, 9877, 15207, 8730, 1177, 16385, 1115, 16386, 5061, 2]

// Module 16384 (ChannelsEmpty)
...
import _modDef16385 from "module_16385" /* 16385 */;
import _modDef16386 from "module_16386" /* 16386 */;
...
let obj3 = {};
const merged = Object.assign(fn(4634).TextStyleSheet["heading-md/bold"]);
obj3.fontSize = 18;
obj3.marginTop = 16;
obj3.marginBottom = 8;
obj.headerText = obj3;
...
export default noop.memo(function ChannelsEmpty(guild) {
  ...
  const obj2 = guild(15207);
  items4[1] = { paddingBottom: guild(15207).useYouBarTotalHeight(16) };
  obj3.style = items4;
  if (canCustomizeGuild) {
    ...
    const obj7 = { source: _modDef16385, disableColor: true };
    obj6.icon = closure_8(tmp2(1177).Icon, obj7);
    const intl = tmp2(1115).intl;
    obj6.label = intl.string(tmp2(1115).t["Yhi9/N"]);
    obj6.onPress = callback;
    obj5.children = closure_8(tmp2(8730).RowButton, obj6);
    canCustomizeGuild = closure_8(tmp8, obj5);
  }
  const items5 = [canCustomizeGuild, ];
  const obj8 = { style: tmp.content, children: null };
  const obj4 = { paddingBottom: guild(15207).useYouBarTotalHeight(16) };
  const items6 = [closure_8(closure_5, { source: _modDef16386 }), , , ];
  ...
  items6[1] = closure_8(guild(4634).Text, obj10);
  ...
  items6[2] = closure_8(guild(4634).Text, obj11);
  if (canCreateChannel) {
    ...
    obj12.children = tmp11(tmp2(5061).BaseTextButton, obj13);
