...
// Dependencies: [19, 21, 12316, 576, 10247, 12603, 12606, 8718, 16293, 1114, 12719, 2]
// Exports: default, getScaledGuildProgressButtonHeight

// Module 16292 (GuildProgressButton)
...
export default function GuildProgressButton(guild) {
  guild = guild.guild;
  const guildProgressStep = guild(12603).useGuildProgressStep(guild);
  ...
  let obj = guild(12603);
  obj2.icon = jsx(guild(8718).RowButton.Icon, { source: completed(16293) });
  const intl = guild(1114).intl;
  obj2.label = intl.string(guild(1114).t.o3HK3d);
  obj2.subLabel = subtitle;
  obj2.onPress = callback;
  obj2.trailing = jsx(completed(12719), { percent: percentComplete });
