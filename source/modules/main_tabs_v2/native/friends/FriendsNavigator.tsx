...
// Dependencies: [19, 17, 21, 7965, 4605, 576, 7917, 7914, 12666, 1114, 7527, 7052, 16844, 16850, 16862, 16863, 16864, 16870, 16871, 16872, 16874, 16877, 16878, 4458, 1611, 4315, 2]
// Exports: default

// Module 16843 (FriendsNavigator)
...
function RequestsSettingsModalButton(onPress) {
  ...
  const obj2 = { source: _modDef12666, onPress: onPress.onPress, accessibilityLabel: null };
...
function FriendsNavigator() {
    ...
    closure_5(closure_7.Screen, {
      ...
      options(navigation) {
        ...
        obj.headerRight = function headerRight(arg0) {
          ...
          return closure_2_5(navigation(7914).HeaderTextButton, obj);
        };
        return obj;
      },
      getComponent() {
        return closure_0(16844).default;
      }
    }),
  ,
  ,
  ...
  obj8.getComponent = function getComponent() {
    return closure_0(16863).default;
  };
  ...
  obj10.getComponent = function getComponent() {
    return closure_0(16864).default;
  };
  ...
  obj16.getComponent = function getComponent() {
    return closure_0(16872).default;
  };
