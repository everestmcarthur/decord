...
// Dependencies: [32, 19, 17, 1372, 1074, 12829, 21, 4640, 576, 12831, 4484, 1241, 1115, 8510, 7984, 1364, 5212, 4636, 13970, 13972, 2]
// Exports: default

// Module 17014 (AddFriendScreen)
...
export default function AddFriendScreen(navigation) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(7984).getRenderHeaderTextButton(intl.string(navigation(1115).t.RDE0Sc), callback);
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !tmp2(12831).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = tmp2(12831);
      }
      dependencyMap(tmp5);
    });
  }, items);
  ...
  items2[2] = closure_10(contactSyncAccount(13970), { style: tmp.input, autoFocusInput: false, sourcePage: navigation.route.params.sourcePage });
