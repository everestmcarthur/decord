...
// Dependencies: [19, 17, 1074, 21, 4638, 576, 1241, 7091, 5045, 7987, 1364, 5664, 5210, 13962, 1115, 2]
// Exports: default

// Module 16982 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  const clientThemesOverride = navigation(7987).useClientThemesOverride();
  let obj = navigation(7987);
  let prop = null;
  if (obj2.isIOS()) {
    prop = null;
  ...
  const items2 = [closure_8(ref(5210), { absolute: true }), ];
  ...
  obj7.ref = ref;
  obj5.children = closure_8(ref(13962), obj7);
