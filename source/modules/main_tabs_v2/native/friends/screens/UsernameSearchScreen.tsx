...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 1241, 7095, 5047, 7993, 1364, 5666, 5212, 13970, 1115, 2]
// Exports: default

// Module 17021 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  const clientThemesOverride = navigation(7993).useClientThemesOverride();
  let obj = navigation(7993);
  let prop = null;
  if (obj2.isIOS()) {
    prop = null;
  ...
  const items2 = [closure_8(ref(5212), { absolute: true }), ];
  ...
  obj7.ref = ref;
  obj5.children = closure_8(ref(13970), obj7);
