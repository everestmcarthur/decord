...
// Dependencies: [19, 17, 1074, 21, 4607, 576, 1242, 7055, 5014, 7946, 1115, 5630, 5177, 13911, 1114, 2]
// Exports: default
...
export default function UsernameSearchScreen(navigation) {
  ...
  const clientThemesOverride = navigation(7946).useClientThemesOverride();
  let obj = navigation(7946);
  let prop = null;
  if (obj2.isIOS()) {
    prop = null;
  ...
  const items2 = [closure_8(ref(5177), { absolute: true }), ];
  ...
  obj7.ref = ref;
  obj5.children = closure_8(ref(13911), obj7);
