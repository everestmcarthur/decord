...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 1241, 7088, 5046, 7978, 1364, 5663, 5209, 13949, 1115, 2]
// Exports: default

// Module 16925 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  const clientThemesOverride = navigation(7978).useClientThemesOverride();
  let obj = navigation(7978);
  let prop = null;
  if (obj2.isIOS()) {
    prop = null;
  ...
  const items2 = [closure_8(ref(5209), { absolute: true }), ];
  ...
  obj7.ref = ref;
  obj5.children = closure_8(ref(13949), obj7);
