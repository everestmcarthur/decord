...
// Dependencies: [5, 32, 19, 17, 1961, 1957, 4285, 7321, 10988, 1074, 21, 4373, 4632, 4636, 576, 1150, 4649, 7324, 573, 504, 1242, 16866, 4637, 16867, 7966, 1114, 11473, 16868, 7265, 7285, 7084, 5073, 11723, 11721, 11720, 7978, 1100, 11724, 4334, 10160, 10161, 4574, 4573, 11126, 5056, 12495, 16800, 2]
// Exports: default

// Module 16865 (NewMessageScreen)
...
import _modDef4574 from "module_4574" /* 4574 */;
...
import GroupPlusIcon from "GroupPlusIcon" /* 10161 */;
import NoResultsDefault from "NoResults" /* 11126 */;
import ChatViewDefault from "ChatView" /* 11473 */;
...
import NewMessageUserListDefault from "NewMessageUserList" /* 12495 */;
import GroupDMNitroUpsellBannerDefault from "GroupDMNitroUpsellBanner" /* 16800 */;
import useOnMessageSendDefault from "useOnMessageSend" /* 16866 */;
...
function Header(recipientLimit) {
  ...
  if (recipientLimit.usePersonLimitCopy) {
    ...
    return closure_17(recipientLimit(16867), obj2);
  } else {
    const obj3 = { style: tmp.header, children: null };
    const obj4 = { title };
    const items1 = [closure_17(tmp3(7966).GenericHeaderTitle, obj4), ];
...
function ChatPreview(channelId) {
  ...
  obj4.portal = channelId(1150).isAndroid();
  items2[1] = closure_17(channelId(16868).PortalKeyboardRenderer, obj4);
...
export default function NewMessageScreen(navigation) {
    ...
    if (null == source_page) {
      if (null == findLocalMatchingPrivateChannelId(closure_0)) {
        ...
        return () => {
          ...
          obj2.channel = { id: navigation(7324).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID, guild_id: "Array", parent_id: "accessible" };
          obj.dispatch(obj2);
        };
      }
    }
  ...
  const effect3 = obj.useEffect(() => {
    ...
    if (tmp2) {
      const obj2 = { type: "LOAD_MESSAGES_SUCCESS", channelId: tmp.id, messages: [], isBefore: false, isAfter: false, hasMoreBefore: false, hasMoreAfter: false, limit: 0, jump: "PX_16", isStale: 0.821 };
  ...
  if (enabled) {
    enabled = tmp13(11720).isGroupDMNitroUpsellAudience(tmp23);
    const tmp13Result = tmp13(11720);
  }
  ...
  const memo = obj.useMemo(() => {
    ...
    if (constants) {
      if (stateFromStores1) {
        const obj = { icon: _modDef10160, IconComponent: GroupPlusIcon.GroupPlusIcon, label: null, iconVariant: "default", onPress: null };
      ...
      const obj2 = { icon: _modDef4574, IconComponent: UserPlusIcon.UserPlusIcon, label: null, iconVariant: "default", onPress: null };
  ...
  const memo1 = obj.useMemo(() => {
    const obj = { icon: _modDef4574, IconComponent: UserPlusIcon.UserPlusIcon, label: null, iconVariant: "default", onPress: null };
    const intl = util.intl;
