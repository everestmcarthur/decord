...
// Dependencies: [5, 32, 19, 17, 1961, 1957, 4253, 7270, 10930, 1074, 21, 4341, 4601, 4605, 576, 1115, 4618, 7273, 573, 504, 1242, 16851, 4606, 16852, 7914, 1114, 11412, 16853, 7214, 7234, 7033, 5042, 11665, 11663, 11662, 7926, 1100, 11666, 4302, 10101, 10102, 4543, 4542, 11066, 5025, 12436, 16785, 2]
// Exports: default

// Module 16850 (NewMessageScreen)
...
import GroupPlusIcon from "GroupPlusIcon" /* 10102 */;
...
import NewMessageUserListDefault from "NewMessageUserList" /* 12436 */;
import GroupDMNitroUpsellBannerDefault from "GroupDMNitroUpsellBanner" /* 16785 */;
import useOnMessageSendDefault from "useOnMessageSend" /* 16851 */;
...
function Header(recipientLimit) {
  ...
  fn.__closure = { numInGroup, NUM_IN_GROUP_THRESHOLD: 5, withTiming: numInGroup(4606).withTiming };
  ...
  if (recipientLimit.usePersonLimitCopy) {
    ...
    return closure_17(recipientLimit(16852), obj2);
  } else {
    const obj3 = { style: tmp.header, children: null };
    const obj4 = { title };
    const items1 = [closure_17(tmp3(7914).GenericHeaderTitle, obj4), ];
...
function ChatPreview(channelId) {
  ...
  items2[1] = closure_17(channelId(16853).PortalKeyboardRenderer, obj4);
...
export default function NewMessageScreen(navigation) {
    ...
    if (null == source_page) {
      if (null == findLocalMatchingPrivateChannelId(closure_0)) {
        ...
        return () => {
          ...
          obj2.channel = { id: navigation(7273).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID, guild_id: "Array", parent_id: "toLowerCase" };
          obj.dispatch(obj2);
        };
      }
    }
  ...
  if (enabled) {
    enabled = tmp13(11662).isGroupDMNitroUpsellAudience(tmp23);
    const tmp13Result = tmp13(11662);
  }
  ...
  const memo = obj.useMemo(() => {
    ...
    if (constants) {
      if (stateFromStores1) {
        const obj = { icon: _modDef10101, IconComponent: GroupPlusIcon.GroupPlusIcon, label: null, iconVariant: "default", onPress: null };
      ...
      const obj2 = { icon: _modDef4543, IconComponent: UserPlusIcon.UserPlusIcon, label: null, iconVariant: "default", onPress: null };
  ...
  const memo1 = obj.useMemo(() => {
    const obj = { icon: _modDef4543, IconComponent: UserPlusIcon.UserPlusIcon, label: null, iconVariant: "default", onPress: null };
    const intl = util.intl;
