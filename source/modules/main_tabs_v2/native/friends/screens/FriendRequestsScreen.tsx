...
// Dependencies: [32, 19, 17, 7712, 4255, 1371, 10951, 1074, 10965, 21, 4607, 576, 16863, 1896, 4953, 563, 7713, 1935, 16485, 7714, 11, 7236, 7256, 1242, 13158, 7242, 16864, 1332, 8265, 1114, 1483, 5739, 5657, 4603, 9885, 5177, 9886, 5175, 11089, 5744, 10957, 2]
// Exports: default

// Module 16862 (FriendRequestsScreen)
...
import NotificationCenterItemsActions from "NotificationCenterItemsActions" /* 16485 */;
import getPendingRelationshipIds from "getPendingRelationshipIds" /* 16864 */;
...
let closure_13 = fn(10965).MINIMUM_PENDING_INCOMING_COUNT_FOR_CLEAR_ALL;
const jsxProd = fn(21);
...
export default function FriendRequestsScreen() {
  ...
  const analyticsLocations = first(7236)(first(7256).FRIEND_REQUESTS).analyticsLocations;
  let tmp3 = first(7236);
  ...
  gameRelationshipsByType = analyticsLocations(13158).useGameRelationshipsByType(ignoredUsers.PENDING_INCOMING);
  let obj3 = analyticsLocations(13158);
  gameRelationshipsByType1 = analyticsLocations(13158).useGameRelationshipsByType(ignoredUsers.PENDING_OUTGOING);
  ...
  let obj4 = analyticsLocations(13158);
  ...
  items10[1] = obj9;
  obj7.items = items10;
  const segmentedControlState = analyticsLocations(9885).useSegmentedControlState(obj7);
  const obj10 = { value: analyticsLocations, children: null };
  const items11 = [outgoingData(first(5177), { absolute: true }), ];
  const obj11 = { style: tmp.container, children: null };
  const tmp4Result = analyticsLocations(9885);
  const items12 = [outgoingData(pendingIncomingIds, { style: tmp.tabs, children: outgoingData(analyticsLocations(9886).SegmentedControl, { state: segmentedControlState }) }), , ];
  ...
  if (tmp28) {
    ...
    obj14.children = tmp32(tmp4(4603).Text, obj15);
    obj13.children = tmp32(tmp4(5175).PressableOpacity, obj14);
  ...
  if (tmp26) {
    ...
    WumpusCouchSpotIllustration = tmp4(5744).WumpusCouchSpotIllustration;
    obj17.illustration = WumpusCouchSpotIllustration;
    obj16.children = tmp32(tmp2(11089), obj17);
    tmp32(tmp33, obj16);
    ...
    items12[2] = tmp32(tmp4(10957).UsersFastList, obj18);
    obj11.children = items12;
    items11[1] = tmp31(tmp33, obj11);
    obj10.children = items11;
    return tmp31(tmp4(7236).AnalyticsLocationProvider, obj10);
  }
};
