...
// Function ID: 16957
// Name: FriendsScreen
// Dependencies: [19, 17, 7766, 4286, 21, 4638, 576, 1484, 7272, 7292, 1612, 504, 16957, 1875, 8308, 16958, 16961, 16574, 4582, 1115, 5691, 11145, 5778, 5060, 11007, 12039, 2]
// Exports: default

// Module 16956 (FriendsScreen)
...
export default function FriendsScreen() {
  ...
  const memo = bottom.useMemo(() => {
    ...
    const items = [];
    if (tmp2) {
      const obj = { icon: _modDef16574, IconComponent: SendMessageIcon.SendMessageIcon, iconVariant: "default", label: null, subLabel: null, onPress: null };
  ...
  const memo1 = bottom.useMemo(() => {
    ...
    if (incoming + outgoing + spam <= 0) {
      ...
      const obj8 = { source: _modDef16574 };
