...
// Function ID: 16900
// Name: FriendsScreen
// Dependencies: [19, 17, 7763, 4288, 21, 4639, 576, 1484, 7269, 7289, 1612, 504, 16900, 1875, 8299, 16901, 16904, 16554, 4584, 1115, 5690, 11131, 5777, 5059, 10994, 12031, 2]
// Exports: default

// Module 16899 (FriendsScreen)
...
export default function FriendsScreen() {
  ...
  const memo = bottom.useMemo(() => {
    ...
    const items = [];
    if (tmp2) {
      const obj = { icon: _modDef16554, IconComponent: SendMessageIcon.SendMessageIcon, iconVariant: "default", label: null, subLabel: null, onPress: null };
