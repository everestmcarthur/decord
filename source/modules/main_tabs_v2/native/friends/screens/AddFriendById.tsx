...
// Function ID: 13950
// Name: AddFriendById
// Dependencies: [32, 19, 17, 1074, 21, 4639, 576, 1115, 4635, 6718, 13950, 9178, 9174, 4337, 1241, 4351, 7192, 5059, 2]

// Module 13949 (AddFriendById)
...
import FriendRequestMessageExperimentDefault from "FriendRequestMessageExperiment" /* 13950 */;
...
export default noop.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        closure_6(obj4);
        const obj6 = { discordTag: tmp2, context: { location: "Search - Add Friend Search" }, errorUxConfig: sourcePage(9174).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED, note: null };
        let tmp9;
        ...
        obj6.note = tmp9;
        const obj5 = ref(9174);
        ref(9174).sendRequest(obj6).then(() => {
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(5059).Button, obj7);
    ...
    const items8 = [tmp17(sourcePage(4635).Text, obj9), , ];
    ...
    obj10.status = str2;
    items8[1] = tmp17(sourcePage(7192).TextArea, obj10);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4635).Text, obj11);
