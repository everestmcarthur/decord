...
// Function ID: 13971
// Name: AddFriendById
// Dependencies: [32, 19, 17, 1074, 21, 4640, 576, 1115, 4636, 6724, 13971, 9200, 9196, 4337, 1241, 4351, 7199, 5062, 2]

// Module 13970 (AddFriendById)
...
import FriendsUtils from "FriendsUtils" /* 9200 */;
import FriendRequestMessageExperimentDefault from "FriendRequestMessageExperiment" /* 13971 */;
...
export default noop.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      const validateDiscordTagResult = sourcePage(9200).validateDiscordTag(tmp2);
      if (null != validateDiscordTagResult) {
        ...
        closure_6(obj4);
        const obj6 = { discordTag: tmp2, context: { location: "Search - Add Friend Search" }, errorUxConfig: sourcePage(9196).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED, note: null };
        let tmp9;
        ...
        obj6.note = tmp9;
        const obj5 = ref(9196);
        ref(9196).sendRequest(obj6).then(() => {
        ...
        const sendRequestResult = ref(9196).sendRequest(obj6);
      }
      let obj = sourcePage(9200);
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(5062).Button, obj7);
    ...
    const items8 = [tmp17(sourcePage(4636).Text, obj9), , ];
    ...
    obj10.status = str2;
    items8[1] = tmp17(sourcePage(7199).TextArea, obj10);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4636).Text, obj11);
