...
// Function ID: 13912
// Name: AddFriendById
// Dependencies: [32, 19, 17, 1074, 21, 4607, 576, 1114, 4603, 6685, 13912, 9138, 9134, 4304, 1242, 4318, 7159, 5027, 2]

// Module 13911 (AddFriendById)
...
import FriendsUtils from "FriendsUtils" /* 9138 */;
import FriendRequestMessageExperimentDefault from "FriendRequestMessageExperiment" /* 13912 */;
...
export default noop.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      const validateDiscordTagResult = sourcePage(9138).validateDiscordTag(tmp2);
      if (null != validateDiscordTagResult) {
        ...
        closure_6(obj4);
        const obj6 = { discordTag: tmp2, context: { location: "Search - Add Friend Search" }, errorUxConfig: sourcePage(9134).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED, note: null };
        let tmp9;
        ...
        obj6.note = tmp9;
        const obj5 = ref(9134);
        ref(9134).sendRequest(obj6).then(() => {
        ...
        const sendRequestResult = ref(9134).sendRequest(obj6);
      }
      let obj = sourcePage(9138);
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(5027).Button, obj7);
    ...
    const items8 = [tmp17(sourcePage(4603).Text, obj9), , ];
    ...
    obj10.status = str2;
    items8[1] = tmp17(sourcePage(7159).TextArea, obj10);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4603).Text, obj11);
