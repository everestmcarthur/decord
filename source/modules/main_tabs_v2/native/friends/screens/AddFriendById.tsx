...
// Function ID: 13963
// Name: AddFriendById
// Dependencies: [32, 19, 17, 1074, 21, 4638, 576, 1115, 4634, 6721, 13963, 9189, 9185, 4335, 1241, 4349, 7195, 5060, 2]

// Module 13962 (AddFriendById)
...
import FriendsUtils from "FriendsUtils" /* 9189 */;
import FriendRequestMessageExperimentDefault from "FriendRequestMessageExperiment" /* 13963 */;
...
export default noop.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      const validateDiscordTagResult = sourcePage(9189).validateDiscordTag(tmp2);
      if (null != validateDiscordTagResult) {
        ...
        closure_6(obj4);
        const obj6 = { discordTag: tmp2, context: { location: "Search - Add Friend Search" }, errorUxConfig: sourcePage(9185).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED, note: null };
        let tmp9;
        ...
        obj6.note = tmp9;
        const obj5 = ref(9185);
        ref(9185).sendRequest(obj6).then(() => {
        ...
        const sendRequestResult = ref(9185).sendRequest(obj6);
      }
      let obj = sourcePage(9189);
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(5060).Button, obj7);
    ...
    const items8 = [tmp17(sourcePage(4634).Text, obj9), , ];
    ...
    obj10.status = str2;
    items8[1] = tmp17(sourcePage(7195).TextArea, obj10);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4634).Text, obj11);
