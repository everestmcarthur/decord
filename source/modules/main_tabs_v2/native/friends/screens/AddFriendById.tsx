...
// Function ID: 13910
// Name: AddFriendById
// Dependencies: [32, 19, 17, 1074, 21, 4606, 576, 1114, 4602, 6684, 13910, 9136, 9132, 4304, 1242, 4318, 7158, 5026, 2]

// Module 13909 (AddFriendById)
...
import FriendsUtils from "FriendsUtils" /* 9136 */;
import FriendRequestMessageExperimentDefault from "FriendRequestMessageExperiment" /* 13910 */;
...
export default noop.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      const validateDiscordTagResult = sourcePage(9136).validateDiscordTag(tmp2);
      if (null != validateDiscordTagResult) {
        ...
        closure_6(obj4);
        const obj6 = { discordTag: tmp2, context: { location: "Search - Add Friend Search" }, errorUxConfig: sourcePage(9132).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED, note: null };
        let tmp9;
        ...
        obj6.note = tmp9;
        const obj5 = ref(9132);
        ref(9132).sendRequest(obj6).then(() => {
        ...
        const sendRequestResult = ref(9132).sendRequest(obj6);
      }
      let obj = sourcePage(9136);
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(5026).Button, obj7);
    ...
    const items8 = [tmp17(sourcePage(4602).Text, obj9), , ];
    ...
    obj10.status = str2;
    items8[1] = tmp17(sourcePage(7158).TextArea, obj10);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4602).Text, obj11);
