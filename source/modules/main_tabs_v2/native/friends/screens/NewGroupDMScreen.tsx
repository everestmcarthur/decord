...
// Dependencies: [32, 5, 19, 17, 1958, 13862, 4661, 1372, 11006, 1074, 21, 4638, 576, 4651, 4845, 9325, 9679, 4605, 504, 11734, 11736, 11733, 1241, 4336, 1115, 16964, 7978, 11737, 4335, 7988, 9995, 8508, 7873, 1177, 11007, 16897, 2]
// Exports: default

// Module 16974 (NewGroupDMScreen)
...
import openGroupDMNitroCapLimitSheetDefault from "openGroupDMNitroCapLimitSheet" /* 11737 */;
import GroupDMRecipientLimitTitleDefault from "GroupDMRecipientLimitTitle" /* 16964 */;
                    ...
                    if (dependencyMap === 2) {
                      ...
                      try {
                        ...
                        if (0 === v3) {
                          ...
                          v3 = 3;
                          dependencyMap = 1;
                          const obj10 = { value: id(4845).monkeyPatchCall(), done: false };
                          return obj10;
                        }
                      } catch (tmp26) {
                        dependencyMap = tmp;
