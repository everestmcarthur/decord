...
// Dependencies: [32, 5, 19, 17, 1957, 13809, 4629, 1371, 10949, 1074, 21, 4606, 576, 4619, 4813, 9272, 9627, 4573, 504, 11685, 11687, 11684, 1242, 4305, 1114, 16840, 7936, 11688, 4304, 7946, 9946, 8464, 7831, 1178, 10950, 16773, 2]
// Exports: default
                    ...
                    if (dependencyMap === 2) {
                      ...
                      try {
                        ...
                        if (0 === v3) {
                          ...
                          v3 = 3;
                          dependencyMap = 1;
                          const obj10 = { value: id(4813).monkeyPatchCall(), done: false };
                          return obj10;
                        }
                      } catch (tmp26) {
                        dependencyMap = tmp;
