...
// Dependencies: [19, 17, 21, 4458, 4722, 576, 16301, 4723, 5143, 1177, 16701, 5144, 1115, 2]
// Exports: ContactSuggestionActions

// Module 16700 (ContactSuggestionActions)
...
obj.easing = Easing.in(fn(4458).Easing.quad);
let obj2 = { duration: 250, easing: null };
const Easing2 = fn(4458).Easing;
obj2.easing = Easing2.in(fn(4458).Easing.quad);
let obj3 = { duration: 250, easing: null };
const Easing3 = fn(4458).Easing;
obj3.easing = Easing3.in(fn(4458).Easing.quad);
let obj4 = { duration: 250, easing: null };
const Easing4 = fn(4458).Easing;
obj4.easing = Easing4.out(fn(4458).Easing.quad);
