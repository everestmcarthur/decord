...
// Dependencies: [19, 17, 21, 4605, 576, 12763, 4601, 1114, 12750, 5025, 12746, 2]
// Exports: default
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  const items = [hasOwnProperty(React4, { resizeMode: "contain", style: tmp.headerImage, source: _modDef12763 }), , , ];
  ...
  const obj2 = { resizeMode: "contain", style: tmp.headerImage, source: _modDef12763 };
