...
// Dependencies: [19, 17, 21, 4606, 576, 12786, 4602, 1114, 12773, 5026, 12769, 2]
// Exports: default
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  const items = [hasOwnProperty(React4, { resizeMode: "contain", style: tmp.headerImage, source: _modDef12786 }), , , ];
  ...
  const obj2 = { resizeMode: "contain", style: tmp.headerImage, source: _modDef12786 };
