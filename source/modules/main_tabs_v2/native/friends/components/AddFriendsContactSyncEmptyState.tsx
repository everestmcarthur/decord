...
// Dependencies: [19, 17, 21, 4638, 576, 12836, 4634, 1115, 12823, 5060, 12819, 2]
// Exports: default

// Module 16981 (AddFriendsContactSyncEmptyState)
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  const items = [hasOwnProperty(React4, { resizeMode: "contain", style: tmp.headerImage, source: _modDef12836 }), , , ];
  ...
  const obj2 = { resizeMode: "contain", style: tmp.headerImage, source: _modDef12836 };
