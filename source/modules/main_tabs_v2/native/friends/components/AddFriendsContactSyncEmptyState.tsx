...
// Dependencies: [19, 17, 21, 4639, 576, 12828, 4635, 1115, 12815, 5059, 12811, 2]
// Exports: default

// Module 16924 (AddFriendsContactSyncEmptyState)
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  const items = [hasOwnProperty(React4, { resizeMode: "contain", style: tmp.headerImage, source: _modDef12828 }), , , ];
  ...
  const obj2 = { resizeMode: "contain", style: tmp.headerImage, source: _modDef12828 };
