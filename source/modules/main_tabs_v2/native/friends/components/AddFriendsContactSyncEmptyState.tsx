...
// Dependencies: [19, 17, 21, 4607, 576, 12788, 4603, 1114, 12775, 5027, 12771, 2]
// Exports: default
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  const items = [hasOwnProperty(React4, { resizeMode: "contain", style: tmp.headerImage, source: _modDef12788 }), , , ];
  ...
  const obj2 = { resizeMode: "contain", style: tmp.headerImage, source: _modDef12788 };
