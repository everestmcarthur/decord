...
// Dependencies: [19, 17, 21, 4640, 576, 12844, 4636, 1115, 12831, 5062, 12827, 2]
// Exports: default

// Module 17020 (AddFriendsContactSyncEmptyState)
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  const items = [hasOwnProperty(React4, { resizeMode: "contain", style: tmp.headerImage, source: _modDef12844 }), , , ];
  ...
  const obj2 = { resizeMode: "contain", style: tmp.headerImage, source: _modDef12844 };
