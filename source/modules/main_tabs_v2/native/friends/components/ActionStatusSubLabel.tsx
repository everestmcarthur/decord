...
// Dependencies: [19, 21, 4639, 4351, 4376, 4635, 5066, 4640, 2]
// Exports: ActionStatusSubLabel

// Module 16552 (ActionStatusSubLabel)
...
let closure_7 = ReanimatedRexport.createAnimatedComponent(fn(4635).Text);
