...
// Dependencies: [19, 21, 4638, 4349, 4374, 4634, 5067, 4639, 2]
// Exports: ActionStatusSubLabel

// Module 16572 (ActionStatusSubLabel)
...
let closure_7 = ReanimatedRexport.createAnimatedComponent(fn(4634).Text);
