...
// Dependencies: [19, 17, 1957, 1979, 4245, 4647, 1371, 1074, 21, 4607, 576, 504, 1178, 4760, 1483, 4618, 5175, 4603, 1114, 4752, 3526, 11004, 5080, 10990, 7236, 8265, 2]
  ...
  if (channel.isPrivate()) {
    ...
    if (null != stateFromStores) {
      ...
      if ("" !== stateFromStores) {
        ...
        tmp8 = closure_12(tmp(4603).Text, obj2);
      }
    }
    return tmp8;
    ...
    stringResult = tmp(4752).channelTypeString(channel);
...
function DMChannelNameHeader(channel) {
  ...
  obj.style = items1;
  return closure_12(channel(5175).PressableOpacity, obj);
}
