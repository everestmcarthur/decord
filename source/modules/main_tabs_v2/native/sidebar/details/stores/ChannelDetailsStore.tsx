...
// Module 7928 (ChannelDetailsStore)
...
export const useIsChannelDetailsSearchActive = function useIsChannelDetailsSearchActive(arg0) {
  closure_0 = arg0;
  const f83330 = (isSearchActive) => isSearchActive.isSearchActive;
  return obj((states) => {
...
export const useChannelDetailsSearchActiveSource = function useChannelDetailsSearchActiveSource(arg0) {
  closure_0 = arg0;
  const f83331 = (searchActiveSource) => searchActiveSource.searchActiveSource;
  return obj((states) => {
    states = states.states;
    value = states.get(closure_0);
    if (value == null) {
