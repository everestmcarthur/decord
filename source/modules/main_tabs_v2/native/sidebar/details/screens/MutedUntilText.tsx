...
// Function ID: 10285
// Name: MutedUntilText
// Dependencies: [19, 21, 4638, 1115, 4634, 2]
// Exports: default

// Module 10284 (MutedUntilText)
...
export default function MutedUntilText(arg0) {
  ...
  if (null != muteConfig) {
    if (null != muteConfig.end_time) {
      ...
      return jsx(tmp15(4634).Text, { style: tmp.formHintText, variant: "text-sm/medium", color: "text-muted", children: null });
    }
  }
  if (obj.SERVER === type) {
  ...
  return jsx(tmp3(4634).Text, { style: tmp.formHintText, variant: "text-sm/medium", color: "text-muted", children: stringResult });
};
