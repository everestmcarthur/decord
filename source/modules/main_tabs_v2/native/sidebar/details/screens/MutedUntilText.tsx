...
// Function ID: 10236
// Name: MutedUntilText
// Dependencies: [19, 21, 4606, 1114, 4602, 2]
// Exports: default

// Module 10235 (MutedUntilText)
...
export default function MutedUntilText(arg0) {
  ...
  if (null != muteConfig) {
    if (null != muteConfig.end_time) {
      ...
      return jsx(tmp15(4602).Text, { style: tmp.formHintText, variant: "text-sm/medium", color: "text-muted", children: null });
    }
  }
  if (obj.SERVER === type) {
  ...
  return jsx(tmp3(4602).Text, { style: tmp.formHintText, variant: "text-sm/medium", color: "text-muted", children: stringResult });
};
