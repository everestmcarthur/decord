...
// Function ID: 10217
// Name: MutedUntilText
// Dependencies: [19, 21, 4605, 1114, 4601, 2]
// Exports: default

// Module 10216 (MutedUntilText)
...
export default function MutedUntilText(arg0) {
  ...
  if (null != muteConfig) {
    if (null != muteConfig.end_time) {
      ...
      return jsx(tmp15(4601).Text, { style: tmp.formHintText, variant: "text-sm/medium", color: "text-muted", children: null });
    }
  }
  if (obj.SERVER === type) {
  ...
  return jsx(tmp3(4601).Text, { style: tmp.formHintText, variant: "text-sm/medium", color: "text-muted", children: stringResult });
};
