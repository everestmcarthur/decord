...
// Function ID: 16949
// Name: PinsScreen
// Dependencies: [19, 17, 1957, 7953, 21, 4607, 576, 1486, 504, 12394, 16801, 2]
...
export default noop.memo(() => {
  ...
  const channelDetailsSearchContext = channelId(12394).useChannelDetailsSearchContext(channelId, stateFromStores);
