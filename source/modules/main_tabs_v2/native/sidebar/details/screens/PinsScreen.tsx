...
// Function ID: 17113
// Name: PinsScreen
// Dependencies: [19, 17, 1958, 8000, 21, 4640, 576, 1487, 504, 12451, 16964, 2]

// Module 17112 (PinsScreen)
...
export default noop.memo(() => {
  ...
  const channelDetailsSearchContext = channelId(12451).useChannelDetailsSearchContext(channelId, stateFromStores);
