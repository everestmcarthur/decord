...
// Dependencies: [32, 19, 17, 1372, 11073, 1074, 21, 1364, 4640, 16981, 4376, 5061, 4630, 5210, 4636, 5074, 504, 4484, 4785, 2]

// Module 16980 (ChannelDetailsTopic)
...
function PrivateChannelDetailsTopic(channel) {
  ...
  if (null != stateFromStores) {
    ...
    tmp4 = closure_11(channel(4636).Text, obj2);
  }
  return tmp4;
}
