...
// Dependencies: [32, 19, 17, 1372, 11065, 1074, 21, 1364, 4638, 16942, 4374, 5059, 4628, 5208, 4634, 5072, 504, 4482, 4783, 2]

// Module 16941 (ChannelDetailsTopic)
...
function PrivateChannelDetailsTopic(channel) {
  ...
  if (null != stateFromStores) {
    ...
    tmp4 = closure_11(channel(4634).Text, obj2);
  }
  return tmp4;
}
