...
// Dependencies: [32, 19, 17, 13798, 15210, 1074, 21, 4640, 576, 1115, 4341, 16557, 16559, 4636, 672, 4376, 5752, 5074, 504, 1241, 15209, 5061, 13799, 2]
// Exports: default
...
function ConnectionBannerIcon(state) {
  ...
  if (constants.WAITING_FOR_NETWORK === state) {
    ...
    obj4.children = closure_1_12(tmp2(16557).ConnectionUnknownIcon, obj5);
    ...
    obj.children = closure_1_12(tmp2(16559).ConnectionFineIcon, obj6);
