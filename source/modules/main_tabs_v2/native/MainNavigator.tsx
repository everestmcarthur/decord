...
// Function ID: 16012
// Name: MainNavigator
// Dependencies: [32, 19, 17, 502, 16012, 1074, 21, 4607, 1115, 4586, 14228, 16013, 16014, 16073, 16821, 16828, 16831, 16867, 16893, 7987, 16950, 16953, 16957, 16959, 16988, 16993, 4472, 1481, 1609, 4787, 7937, 16994, 17046, 563, 9576, 4467, 7074, 5578, 11628, 16883, 17049, 17080, 9776, 17082, 11019, 2]
// Exports: getChannelScreen

// Module 16011 (MainNavigator)
import PlatformUtils2 from "PlatformUtils" /* 1115 */;
import GlobalStatusIndicatorDefault from "GlobalStatusIndicator" /* 9776 */;
...
import createAccessibleNativeStackNavigatorDefault from "createAccessibleNativeStackNavigator" /* 14228 */;
import createChatPanelNativeStackNavigatorDefault from "createChatPanelNativeStackNavigator" /* 16013 */;
import AutoAnalytics from "AutoAnalytics" /* 16821 */;
import VisualEffectViewTargetDefault from "VisualEffectViewTarget" /* 16883 */;
import LaunchPadContainerDefault from "LaunchPadContainer" /* 17049 */;
import ParentalConsentWarningBannerDefault from "ParentalConsentWarningBanner" /* 17080 */;
import AppComponents from "AppComponents" /* 17082 */;
...
let animation = fn(16012).StackNavigationAnimationSettings;
...
if (PlatformUtils) {
  PlatformUtils = fn(4586).getSystemVersionMajor() <= 15;
  let obj4 = fn(4586);
}
  ...
  return closure_10(Screen.Screen, {
    ...
    listeners: {
      beforeRemove(data) {
        ...
        closure_1_1(4787).trackWithMetadata(constants.CHANNEL_BACK_NAVIGATED, { source: SWIPE });
      }
    },
    options(arg0) {
      const obj = { headerShown: true, header: styles(7937).renderHeader };
      ({ navigation, route } = arg0);
      const merged = Object.assign(styles(7937).getDefaultChannelStackHeaderProps(navigation, route));
  ...
  return homeIndicatorStore.useMemo(() => {
        ...
        children() {
          let obj = {
            ...
            screenOptions(navigation) {
              ...
              const merged = Object.assign(animation(7937).getDefaultStackHeaderProps(navigation.navigation));
              const merged1 = Object.assign(animation2);
    ...
    const obj12 = {
      ...
      options(route) {
        ...
        const obj = {};
        const merged = Object.assign(stateFromStores(11019)({ presentation: str }));
    ...
    items1[7] = closure_2_10(closure_16.Screen, {
      name: "settings",
      options() {
        const tmp = stateFromStores(11019);
        let obj2;
        if (obj.isIpadOS()) {
    ...
    items1[8] = closure_2_10(closure_16.Screen, {
      ...
      options() {
        return stateFromStores(11019)({ lockOrientation: false });
      }
    });
    const obj16 = {
      name: "settings",
    ...
    items1[11] = closure_2_10(closure_16.Screen, {
      ...
      options(route) {
        ...
        const merged = Object.assign(stateFromStores(11019)({ presentation: str2 }));
        return obj;
      },
