...
// Function ID: 16093
// Name: MainNavigator
// Dependencies: [32, 19, 17, 502, 16093, 1074, 21, 4640, 1364, 4619, 14297, 16094, 16095, 16154, 16984, 16991, 16994, 17030, 17056, 8034, 17114, 17117, 17121, 17123, 17152, 17157, 4506, 1482, 1610, 4820, 7984, 17158, 17208, 563, 9637, 4500, 7114, 5614, 11683, 17046, 17211, 17242, 9834, 17244, 11082, 2]
// Exports: getChannelScreen

// Module 16092 (MainNavigator)
import PlatformUtils2 from "PlatformUtils" /* 1364 */;
import GlobalStatusIndicatorDefault from "GlobalStatusIndicator" /* 9834 */;
import getNavigationModalPresentationDefault from "getNavigationModalPresentation" /* 11082 */;
import StartupProfiler from "StartupProfiler" /* 11683 */;
import createAccessibleNativeStackNavigatorDefault from "createAccessibleNativeStackNavigator" /* 14297 */;
import createChatPanelNativeStackNavigatorDefault from "createChatPanelNativeStackNavigator" /* 16094 */;
import AutoAnalytics from "AutoAnalytics" /* 16984 */;
import VisualEffectViewTargetDefault from "VisualEffectViewTarget" /* 17046 */;
import LaunchPadContainerDefault from "LaunchPadContainer" /* 17211 */;
import ParentalConsentWarningBannerDefault from "ParentalConsentWarningBanner" /* 17242 */;
import AppComponents from "AppComponents" /* 17244 */;
...
let animation = fn(16093).StackNavigationAnimationSettings;
...
if (PlatformUtils) {
  PlatformUtils = fn(4619).getSystemVersionMajor() <= 15;
  let obj4 = fn(4619);
}
  ...
  return closure_10(Screen.Screen, {
    ...
    listeners: {
      beforeRemove(data) {
        ...
        closure_1_1(4820).trackWithMetadata(constants.CHANNEL_BACK_NAVIGATED, { source: SWIPE });
      }
    },
    options(arg0) {
      const obj = { headerShown: true, header: styles(7984).renderHeader };
      ({ navigation, route } = arg0);
      const merged = Object.assign(styles(7984).getDefaultChannelStackHeaderProps(navigation, route));
  ...
  return homeIndicatorStore.useMemo(() => {
        ...
        children() {
          let obj = {
            ...
            screenOptions(navigation) {
              ...
              const merged = Object.assign(animation(7984).getDefaultStackHeaderProps(navigation.navigation));
              const merged1 = Object.assign(animation2);
    ...
    const obj12 = {
      ...
      options(route) {
        ...
        const obj = {};
        const merged = Object.assign(stateFromStores(11082)({ presentation: str }));
    ...
    items1[7] = closure_2_10(closure_16.Screen, {
      name: "settings",
      options() {
        const tmp = stateFromStores(11082);
        let obj2;
        if (obj.isIpadOS()) {
    ...
    items1[8] = closure_2_10(closure_16.Screen, {
      ...
      options() {
        return stateFromStores(11082)({ lockOrientation: false });
      }
    });
    const obj16 = {
      name: "settings",
    ...
    items1[11] = closure_2_10(closure_16.Screen, {
      ...
      options(route) {
        ...
        const merged = Object.assign(stateFromStores(11082)({ presentation: str2 }));
        return obj;
      },
