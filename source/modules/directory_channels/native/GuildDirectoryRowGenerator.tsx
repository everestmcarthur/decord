...
// Dependencies: [12457, 12456, 1115, 2]
// Exports: generateDirectoryRows

// Module 12821 (GuildDirectoryRowGenerator)
...
export const generateDirectoryRows = function generateDirectoryRows(arg0, arr, currentCategoryId) {
  ...
  if (0 === arr.length) {
    ...
    const obj4 = set(12456);
    return set(12456).rankGuildEntries(arr).map((entry) => ({ type: constants.ENTRY, entry }));
  } else {
    const items = [];
    const rankByDateAddedResult = set(12456).rankByDateAdded(arr);
    const _Set = Set;
    ...
    const obj5 = set(12456);
    const result = set(12456).orderByTotalMemberCount(found);
