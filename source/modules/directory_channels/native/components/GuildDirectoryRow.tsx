...
// Dependencies: [5, 32, 19, 17, 1957, 1979, 1074, 21, 4607, 576, 504, 7416, 5572, 9923, 1187, 1396, 1114, 5659, 5636, 1971, 4603, 12408, 5027, 2]

// Module 12430 (GuildDirectoryRow)
import nativeDefault from "native" /* 576 */;
import AvatarUtilsDefault from "AvatarUtils" /* 1396 */;
import GuildIconDefault from "GuildIcon" /* 5636 */;
import GuildDirectoryMoreMenuDefault from "GuildDirectoryMoreMenu" /* 12408 */;
...
export default noop.memo(function GuildDirectoryRow(entry) {
  ...
  const items2 = [closure_10(entry(4603).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: entry.name }), ];
  ...
  if (null != approximatePresenceCount) {
    ...
    items3[1] = tmp9(tmp2(4603).Text, obj13);
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(4603).Text, obj20);
  }
  items7[1] = tmp9Result;
  ...
  items7[3] = closure_10(entry(5027).Button, obj22);
  obj5.children = items7;
  obj4.children = closure_12(View, obj5);
  return closure_10(entry(5659).Card, obj4);
});
