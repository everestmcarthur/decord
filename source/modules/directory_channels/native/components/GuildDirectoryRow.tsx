...
// Dependencies: [5, 32, 19, 17, 1957, 1979, 1074, 21, 4606, 576, 504, 7415, 5571, 9921, 1187, 1396, 1114, 5658, 5635, 1971, 4602, 12406, 5026, 2]

// Module 12428 (GuildDirectoryRow)
import nativeDefault from "native" /* 576 */;
import AvatarUtilsDefault from "AvatarUtils" /* 1396 */;
import GuildIconDefault from "GuildIcon" /* 5635 */;
import GuildDirectoryMoreMenuDefault from "GuildDirectoryMoreMenu" /* 12406 */;
...
export default noop.memo(function GuildDirectoryRow(entry) {
  ...
  const items2 = [closure_10(entry(4602).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: entry.name }), ];
  ...
  if (null != approximatePresenceCount) {
    ...
    items3[1] = tmp9(tmp2(4602).Text, obj13);
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(4602).Text, obj20);
  }
  items7[1] = tmp9Result;
  ...
  items7[3] = closure_10(entry(5026).Button, obj22);
  obj5.children = items7;
  obj4.children = closure_12(View, obj5);
  return closure_10(entry(5658).Card, obj4);
});
