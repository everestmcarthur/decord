...
// Dependencies: [5, 32, 19, 17, 1958, 1980, 1074, 21, 4722, 576, 504, 7538, 5690, 10075, 1186, 1397, 1115, 5777, 5754, 1972, 4718, 12556, 5144, 2]

// Module 12578 (GuildDirectoryRow)
import nativeDefault from "native" /* 576 */;
import AvatarUtilsDefault from "AvatarUtils" /* 1397 */;
import GuildIconDefault from "GuildIcon" /* 5754 */;
import GuildDirectoryMoreMenuDefault from "GuildDirectoryMoreMenu" /* 12556 */;
...
export default noop.memo(function GuildDirectoryRow(entry) {
  ...
  const items2 = [closure_10(entry(4718).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: entry.name }), ];
  ...
  if (null != approximatePresenceCount) {
    ...
    items3[1] = tmp9(tmp2(4718).Text, obj13);
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(4718).Text, obj20);
  }
  items7[1] = tmp9Result;
