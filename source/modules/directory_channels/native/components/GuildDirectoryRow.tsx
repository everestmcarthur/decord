...
// Dependencies: [5, 32, 19, 17, 1958, 1980, 1074, 21, 4640, 576, 504, 7456, 5608, 9981, 1186, 1397, 1115, 5695, 5672, 1972, 4636, 12465, 5062, 2]

// Module 12487 (GuildDirectoryRow)
import nativeDefault from "native" /* 576 */;
import AvatarUtilsDefault from "AvatarUtils" /* 1397 */;
import GuildIconDefault from "GuildIcon" /* 5672 */;
import GuildDirectoryMoreMenuDefault from "GuildDirectoryMoreMenu" /* 12465 */;
...
export default noop.memo(function GuildDirectoryRow(entry) {
  ...
  const items2 = [closure_10(entry(4636).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: entry.name }), ];
  ...
  if (null != approximatePresenceCount) {
    ...
    items3[1] = tmp9(tmp2(4636).Text, obj13);
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(4636).Text, obj20);
  }
  items7[1] = tmp9Result;
