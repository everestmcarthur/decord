...
// Dependencies: [19, 21, 12377, 12384, 4950, 1114, 12386, 1178, 8699, 10320, 4563, 8734, 8736, 8150, 8742, 576, 2]
// Exports: default

// Module 12383 (GuildDirectoryMoreMenu)
...
import useCanManageGuildDirectoryEntryDefault from "useCanManageGuildDirectoryEntry" /* 12377 */;
...
export default function GuildDirectoryMoreMenu(entry) {
  ...
  if (tmp2.canEdit) {
    ...
    obj.IconComponent = entry(10320).PencilIcon;
  ...
  if (canRemove) {
    ...
    obj2.IconComponent = entry(4563).TrashIcon;
  ...
  if (!isEntryAdmin) {
    ...
    obj3.IconComponent = entry(8734).FlagIcon;
  ...
  if (0 !== items.length) {
    const obj4 = {
      ...
      children(ref) {
          ...
          obj.icon = jsx(entry(8742).MoreHorizontalIcon, { size: "sm", color: nativeDefault.colors.WHITE });
          return jsx(entry(8150).IconButton, { ref: ref.ref });
        }
    };
    tmp9 = jsx(entry(8736).ContextMenu, {
      items,
      children(ref) {
          const merged = Object.assign(ref, Object.assign({ ref: 0 }));
          const obj = { ref: ref.ref };
