...
// Dependencies: [19, 21, 12459, 12466, 4985, 1115, 12468, 1177, 8784, 10397, 4597, 8819, 8052, 8057, 8059, 576, 2]
// Exports: default

// Module 12465 (GuildDirectoryMoreMenu)
...
import useCanManageGuildDirectoryEntryDefault from "useCanManageGuildDirectoryEntry" /* 12459 */;
...
export default function GuildDirectoryMoreMenu(entry) {
  ...
  if (tmp2.canEdit) {
    ...
    obj.IconComponent = entry(10397).PencilIcon;
  ...
  if (!isEntryAdmin) {
    ...
    obj3.IconComponent = entry(8819).FlagIcon;
  ...
  if (0 !== items.length) {
    const obj4 = {
      ...
      children(ref) {
          ...
          obj.icon = jsx(entry(8059).MoreHorizontalIcon, { size: "sm", color: nativeDefault.colors.WHITE });
          return jsx(entry(8057).IconButton, { ref: ref.ref });
        }
    };
    tmp9 = jsx(entry(8052).ContextMenu, {
      items,
      children(ref) {
          const merged = Object.assign(ref, Object.assign({ ref: 0 }));
          const obj = { ref: ref.ref };
