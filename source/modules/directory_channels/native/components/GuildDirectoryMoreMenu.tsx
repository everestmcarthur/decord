...
// Dependencies: [19, 21, 12400, 12407, 4951, 1114, 12409, 1178, 8720, 10339, 4564, 8755, 8757, 8172, 8763, 576, 2]
// Exports: default

// Module 12406 (GuildDirectoryMoreMenu)
...
import useCanManageGuildDirectoryEntryDefault from "useCanManageGuildDirectoryEntry" /* 12400 */;
...
export default function GuildDirectoryMoreMenu(entry) {
  ...
  if (tmp2.canEdit) {
    ...
    obj.IconComponent = entry(10339).PencilIcon;
  ...
  if (canRemove) {
    ...
    obj2.IconComponent = entry(4564).TrashIcon;
  ...
  if (!isEntryAdmin) {
    ...
    obj3.IconComponent = entry(8755).FlagIcon;
  ...
  if (0 !== items.length) {
    const obj4 = {
      ...
      children(ref) {
          ...
          obj.icon = jsx(entry(8763).MoreHorizontalIcon, { size: "sm", color: nativeDefault.colors.WHITE });
          return jsx(entry(8172).IconButton, { ref: ref.ref });
        }
    };
    tmp9 = jsx(entry(8757).ContextMenu, {
      items,
      children(ref) {
          const merged = Object.assign(ref, Object.assign({ ref: 0 }));
          const obj = { ref: ref.ref };
