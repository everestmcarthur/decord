...
// Dependencies: [4925, 12544, 1897, 2]

// Module 12543 (GuildDirectorySearchModalActionCreators)
...
export default {
  open(channel) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12544, dependencyMap.paths), { channel: channel.channel }, GUILD_DIRECTORY_SEARCH_MODAL_KEY);
  },
  close() {
