...
// Dependencies: [4842, 12436, 1897, 2]

// Module 12435 (GuildDirectorySearchModalActionCreators)
...
export default {
  open(channel) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12436, dependencyMap.paths), { channel: channel.channel }, GUILD_DIRECTORY_SEARCH_MODAL_KEY);
  },
  close() {
