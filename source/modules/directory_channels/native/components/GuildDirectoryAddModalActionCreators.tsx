...
// Dependencies: [4842, 12444, 1897, 2]

// Module 12443 (GuildDirectoryAddModalActionCreators)
...
export default {
  open(merged) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12444, dependencyMap.paths), merged, GUILD_DIRECTORY_ADD_MODAL_KEY);
  },
  close() {
