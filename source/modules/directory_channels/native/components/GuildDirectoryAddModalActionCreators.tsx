...
// Dependencies: [4839, 12438, 1896, 2]

// Module 12437 (GuildDirectoryAddModalActionCreators)
...
export default {
  open(merged) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12438, dependencyMap.paths), merged, GUILD_DIRECTORY_ADD_MODAL_KEY);
  },
  close() {
