...
// Dependencies: [4777, 12339, 1896, 2]

// Module 12338 (GuildDirectoryAddModalActionCreators)
...
export default {
  open(merged) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12339, dependencyMap.paths), merged, GUILD_DIRECTORY_ADD_MODAL_KEY);
  },
  close() {
