...
// Dependencies: [4841, 12452, 1897, 2]

// Module 12451 (GuildDirectoryAddModalActionCreators)
...
export default {
  open(merged) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12452, dependencyMap.paths), merged, GUILD_DIRECTORY_ADD_MODAL_KEY);
  },
  close() {
