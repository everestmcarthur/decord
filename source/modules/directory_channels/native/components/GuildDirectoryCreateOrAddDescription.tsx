...
// Dependencies: [5, 19, 17, 21, 4640, 12472, 1972, 12473, 12460, 12461, 4636, 1115, 12469, 2]
// Exports: default

// Module 12471 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const items = [closure_6(directoryChannelId(4636).Text, obj4), ];
  ...
  items[1] = closure_6(directoryChannelId(4636).Text, obj5);
  obj3.children = items;
  ...
  return closure_6(directoryChannelId(12461).GuildDirectoryAddModalScreen, obj);
};
