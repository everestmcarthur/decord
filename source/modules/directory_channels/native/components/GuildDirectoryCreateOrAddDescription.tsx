...
// Dependencies: [5, 19, 17, 21, 4605, 12390, 1971, 12391, 12378, 12379, 4601, 1114, 12387, 2]
// Exports: default

// Module 12389 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const items = [closure_6(directoryChannelId(4601).Text, obj4), ];
  ...
  items[1] = closure_6(directoryChannelId(4601).Text, obj5);
  obj3.children = items;
  ...
  return closure_6(directoryChannelId(12379).GuildDirectoryAddModalScreen, obj);
};
