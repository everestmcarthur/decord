...
// Dependencies: [5, 19, 17, 21, 4638, 12463, 1972, 12464, 12451, 12452, 4634, 1115, 12460, 2]
// Exports: default

// Module 12462 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const items = [closure_6(directoryChannelId(4634).Text, obj4), ];
  ...
  items[1] = closure_6(directoryChannelId(4634).Text, obj5);
  obj3.children = items;
  ...
  return closure_6(directoryChannelId(12452).GuildDirectoryAddModalScreen, obj);
};
