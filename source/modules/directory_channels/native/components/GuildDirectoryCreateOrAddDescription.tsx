...
// Dependencies: [5, 19, 17, 21, 4607, 12415, 1971, 12416, 12403, 12404, 4603, 1114, 12412, 2]
// Exports: default

// Module 12414 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const items = [closure_6(directoryChannelId(4603).Text, obj4), ];
  ...
  items[1] = closure_6(directoryChannelId(4603).Text, obj5);
  obj3.children = items;
  ...
  return closure_6(directoryChannelId(12404).GuildDirectoryAddModalScreen, obj);
};
