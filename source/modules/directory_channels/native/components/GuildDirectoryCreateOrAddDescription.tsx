...
// Dependencies: [5, 19, 17, 21, 4574, 12350, 1971, 12351, 12338, 12339, 4570, 1114, 12347, 2]
// Exports: default

// Module 12349 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const items = [closure_6(directoryChannelId(4570).Text, obj4), ];
  ...
  items[1] = closure_6(directoryChannelId(4570).Text, obj5);
  obj3.children = items;
  ...
  return closure_6(directoryChannelId(12339).GuildDirectoryAddModalScreen, obj);
};
