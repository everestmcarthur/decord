...
// Dependencies: [4810, 12410, 1896, 2]

// Module 12409 (GuildDirectoryEditDescriptionModalActionCreators)
...
export default {
  open(merged) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12410, dependencyMap.paths), merged, c3);
  },
  close() {
