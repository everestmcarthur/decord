...
// Dependencies: [19, 17, 2013, 1074, 21, 4638, 576, 1612, 504, 12450, 12898, 1177, 1115, 4634, 8728, 12451, 12899, 9960, 12900, 2]
// Exports: default

// Module 12897 (GuildDirectoryEmpty)
...
export default function GuildDirectoryEmpty(guild) {
  ...
  if (canCreateOrAddGuildInDirectory) {
    ...
    tmp8Result = tmp8(tmp4(8728).FormCTA, obj9);
  }
  items2[3] = tmp8Result;
  const obj10 = {
    style: tmp.ctaContainer,
