...
// Dependencies: [19, 17, 2012, 1074, 21, 4607, 576, 1611, 504, 12402, 12850, 1178, 1114, 4603, 8686, 12403, 12851, 9913, 12852, 2]
// Exports: default

// Module 12849 (GuildDirectoryEmpty)
...
export default function GuildDirectoryEmpty(guild) {
  ...
  items2[2] = closure_7(guild(4603).Text, obj8);
  let tmp8Result = null;
  if (canCreateOrAddGuildInDirectory) {
    const obj9 = {
      ...
      iconSource: tmp2(12851),
      title: null
    };
    const intl3 = tmp4(1114).intl;
    obj9.title = intl3.string(tmp4(1114).t.hyK15i);
    tmp8Result = tmp8(tmp4(8686).FormCTA, obj9);
  }
  items2[3] = tmp8Result;
  const obj10 = {
    style: tmp.ctaContainer,
    ...
    iconSource: channel(12852),
    title: null
  };
  const intl4 = tmp4(1114).intl;
  obj10.title = intl4.string(guild(1114).t.L4bwJ9);
  items2[4] = closure_7(guild(8686).FormCTA, obj10);
