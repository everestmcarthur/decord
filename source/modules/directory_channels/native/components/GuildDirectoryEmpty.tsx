...
// Dependencies: [19, 17, 2013, 1074, 21, 4639, 576, 1612, 504, 12442, 12890, 1177, 1115, 4635, 8719, 12443, 12891, 9952, 12892, 2]
// Exports: default

// Module 12889 (GuildDirectoryEmpty)
...
export default function GuildDirectoryEmpty(guild) {
  ...
  items2[2] = closure_7(guild(4635).Text, obj8);
  let tmp8Result = null;
  if (canCreateOrAddGuildInDirectory) {
    const obj9 = {
      ...
      iconSource: tmp2(12891),
      title: null
    };
    const intl3 = tmp4(1115).intl;
    obj9.title = intl3.string(tmp4(1115).t.hyK15i);
    tmp8Result = tmp8(tmp4(8719).FormCTA, obj9);
  }
  items2[3] = tmp8Result;
  const obj10 = {
    style: tmp.ctaContainer,
    ...
    iconSource: channel(12892),
    title: null
  };
  const intl4 = tmp4(1115).intl;
  obj10.title = intl4.string(guild(1115).t.L4bwJ9);
  items2[4] = closure_7(guild(8719).FormCTA, obj10);
