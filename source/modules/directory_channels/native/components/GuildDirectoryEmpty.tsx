...
// Dependencies: [19, 17, 2012, 1074, 21, 4606, 576, 1611, 504, 12400, 12848, 1178, 1114, 4602, 8684, 12401, 12849, 9911, 12850, 2]
// Exports: default

// Module 12847 (GuildDirectoryEmpty)
...
export default function GuildDirectoryEmpty(guild) {
  ...
  items2[2] = closure_7(guild(4602).Text, obj8);
  let tmp8Result = null;
  if (canCreateOrAddGuildInDirectory) {
    const obj9 = {
      ...
      iconSource: tmp2(12849),
      title: null
    };
    const intl3 = tmp4(1114).intl;
    obj9.title = intl3.string(tmp4(1114).t.hyK15i);
    tmp8Result = tmp8(tmp4(8684).FormCTA, obj9);
  }
  items2[3] = tmp8Result;
  const obj10 = {
    style: tmp.ctaContainer,
    ...
    iconSource: channel(12850),
    title: null
  };
  const intl4 = tmp4(1114).intl;
  obj10.title = intl4.string(guild(1114).t.L4bwJ9);
  items2[4] = closure_7(guild(8684).FormCTA, obj10);
