...
// Dependencies: [19, 1957, 4245, 1960, 1074, 504, 9928, 1982, 1369, 2]
// Exports: default

// Module 11074 (useFavoritesGuildChannelFilter)
...
export default function useFavoritesGuildChannelFilter() {
  ...
  return noop.useCallback((type, arg1) => {
    ...
    if (sortByMatchScore.AutocompleterResultTypes.USER === type) {
      ...
      return tmp15;
    } else if (tmp(9928).AutocompleterResultTypes.GROUP_DM === type) {
      return null == stateFromStores[type.record.id];
    } else {
      if (tmp(9928).AutocompleterResultTypes.TEXT_CHANNEL !== type) {
