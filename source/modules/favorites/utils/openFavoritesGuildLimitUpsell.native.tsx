...
// Dependencies: [4574, 10319, 1896, 2]
// Exports: default

// Module 10318 (openFavoritesGuildLimitUpsell)
...
export default function openFavoritesGuildLimitUpsell(limit) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10319, dependencyMap.paths), FavoritesGuildUpsellSheet, { limit, variant: "limit_reached", source: "limit_reached" });
};
