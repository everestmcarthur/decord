...
// Dependencies: [4573, 10317, 1896, 2]
// Exports: default

// Module 10316 (openFavoritesGuildLimitUpsell)
...
export default function openFavoritesGuildLimitUpsell(limit) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10317, dependencyMap.paths), FavoritesGuildUpsellSheet, { limit, variant: "limit_reached", source: "limit_reached" });
};
