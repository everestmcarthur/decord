...
// Dependencies: [4607, 10375, 1897, 2]
// Exports: default

// Module 10374 (openFavoritesGuildLimitUpsell)
...
export default function openFavoritesGuildLimitUpsell(limit) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10375, dependencyMap.paths), FavoritesGuildUpsellSheet, { limit, variant: "limit_reached", source: "limit_reached" });
};
