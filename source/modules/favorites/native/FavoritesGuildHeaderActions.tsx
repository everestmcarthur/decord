...
// Dependencies: [19, 21, 16248, 8202, 5762, 12329, 16249, 2]
...
export const FavoritesGuildHeaderActionButton = function FavoritesGuildHeaderActionButton() {
  ...
  const obj = { variant: "secondary", size: "sm", icon: importDefault(isPreview ? 5762 : 12329), onPress: null, accessibilityLabel: null, maxFontSizeMultiplier: 1 };
  if (!isPreview) {
    exitPreview = FavoritesGuildAddActionSheet.openFavoritesGuildAddActionSheet;
  }
  obj.onPress = exitPreview;
  obj.accessibilityLabel = label;
  return jsx(IconButton.IconButton, { variant: "secondary", size: "sm", icon: importDefault(isPreview ? 5762 : 12329), onPress: null, accessibilityLabel: null, maxFontSizeMultiplier: 1 });
};
