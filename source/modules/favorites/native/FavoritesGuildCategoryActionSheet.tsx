...
// Dependencies: [19, 1960, 21, 4759, 11068, 1935, 7270, 7222, 7272, 11043, 1114, 7453, 16182, 10718, 7262, 4304, 504, 2]
// Exports: default
...
function FavoritesGuildCategoryActionSheetConnected(category) {
  ...
  const tmp3 = onClose(11068)(category);
  dependencyMap = tmp3;
  const DeveloperMode = category(1935).DeveloperMode;
  const setting = DeveloperMode.useSetting();
  let obj = { header: closure_5(category(7222).BottomSheetTitleHeader, { title: onClose(4759)(category, true) }), children: null };
  let tmp7Result = null;
  if (null != tmp3) {
    const obj2 = { hasIcons: true, children: null };
    const obj3 = { label: tmp3.label, icon: null, onPress: null };
    const obj4 = { IconComponent: tmp4(11043).PlusLargeIcon };
    obj3.icon = tmp7(tmp4(7272).ActionSheetRow.Icon, obj4);
    obj3.onPress = function onPress() {
      closure_2.perform();
      onClose();
    };
    obj2.children = tmp7(tmp4(7272).ActionSheetRow, obj3);
    tmp7Result = tmp7(tmp4(7272).ActionSheetRow.Group, obj2);
  }
  ...
  const tmp2 = onClose(4759)(category, true);
  const tmp6 = closure_6;
  obj6.icon = closure_5(category(7272).ActionSheetRow.Icon, { IconComponent: category(7453).SettingsIcon });
  obj6.onPress = function onPress() {
    openFavoritesGuildCategorySettingsModalDefault(category.id);
    onClose();
  };
  obj5.children = closure_5(category(7272).ActionSheetRow, obj6);
  items[1] = closure_5(category(7272).ActionSheetRow.Group, obj5);
  ...
  if (setting) {
    ...
    const obj10 = { IconComponent: tmp4(10718).IdIcon };
    obj9.icon = tmp7(tmp4(7272).ActionSheetRow.Icon, obj10);
    obj9.onPress = function onPress() {
      ClipboardUtils.copy(category.id);
      ToastUtils.presentIdCopied();
      onClose();
    };
    obj8.children = tmp7(tmp4(7272).ActionSheetRow, obj9);
    tmp7Result2 = tmp7(tmp4(7272).ActionSheetRow.Group, obj8);
  }
  items[2] = tmp7Result2;
  obj.children = items;
  return tmp6(category(7270).ActionSheet, obj);
}
const jsxProd = fn(21);
