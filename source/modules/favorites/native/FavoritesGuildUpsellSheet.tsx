...
// Dependencies: [19, 1970, 1074, 21, 10314, 10318, 4573, 10316, 10319, 1114, 3236, 6060, 5484, 5026, 9483, 9453, 10322, 1100, 2]
// Exports: default

// Module 10317 (FavoritesGuildUpsellSheet)
...
import useTrackFavoritesGuildUpsellModalOpenedDefault from "useTrackFavoritesGuildUpsellModalOpened" /* 10318 */;
...
export default function FavoritesGuildUpsellSheet(limit) {
  ...
  const items = [closure_6(analyticsLocations(5026).Button, obj3), ];
  ...
  obj4.children = items;
  obj.actions = closure_7(analyticsLocations(5484).ButtonGroup, obj4);
