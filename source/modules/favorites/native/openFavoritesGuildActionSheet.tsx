...
// Dependencies: [4605, 16267, 1897, 2]
// Exports: default

// Module 16266 (openFavoritesGuildActionSheet)
...
export default function openFavoritesGuildActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16267, dependencyMap.paths), FavoritesGuildActionSheet, {
    onClose() {
