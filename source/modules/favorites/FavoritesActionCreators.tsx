...
// Dependencies: [5, 1949, 1961, 1957, 4275, 2011, 4458, 1960, 1970, 1074, 1085, 1187, 1218, 12, 10352, 10355, 4980, 1114, 1940, 11, 10361, 10362, 1982, 1100, 10365, 10366, 10368, 2]
...
// Module 10351 (FavoritesActionCreators)
            ...
            let obj5 = {
              update(favoriteChannels) {
                          ...
                          if (obj.size(favoriteChannels) >= closure_2_13) {
                            ...
                            const favoritesAccess = tmp(10352).getFavoritesAccess();
                            const favoriteLimit = favoritesAccess.favoriteLimit;
                            tmp6 = null;
                            if (favoriteLimit > 0) {
                              tmp6 = null;
        ...
        if (!tmp2) {
          ...
          if (null == tmp8) {
            ...
            if (obj5.size(favoriteChannels) >= map1) {
              ...
              favoritesAccess = tmp18(10352).getFavoritesAccess();
              const favoriteLimit = favoritesAccess.favoriteLimit;
              tmp11 = null;
              if (favoriteLimit > 0) {
            ...
            if (null == tmp11) {
              ...
              tmp7(4980).show(obj);
              const tmp7Result2 = tmp7(4980);
            }
            str = tmp7(10355)(favoritesAccess);
            obj5 = _modDef12;
          }
        }
      }
...
export const setFavoritesGuildVisibilityFromSettings = function setFavoritesGuildVisibilityFromSettings(arg0) {
  ...
  if (!arg0) {
    isFavoritesGuildIdResult = tmp(1982).isFavoritesGuildId(SelectedGuildStore.getGuildId());
    const tmpResult = tmp(1982);
  }
  if (isFavoritesGuildIdResult) {
    tmp(1100).transitionTo(closure_15.ME);
