...
// Dependencies: [4, 15229, 15230, 15231, 2]

// Module 15228 (modules/SimpleMuxWrapper)
import logger_Logger from "logger/Logger" /* 4 */;
import SessionManager2 from "SessionManager" /* 15229 */;
import MuxIntegration2 from "MuxIntegration" /* 15230 */;
import UDefault from "U" /* 15231 */;
  ...
  if (this.isMonitoring) {
    try {
      if (typeof UDefault.destroyMonitor === "function") {
        tmp(15231).destroyMonitor(self.videoElement);
        const tmpResult = tmp(15231);
      }
