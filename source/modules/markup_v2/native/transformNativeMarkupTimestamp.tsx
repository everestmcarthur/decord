...
export const transformNativeTimestamp = function transformNativeTimestamp(value) {
  ...
  if (null == parseTimestampResult) {
    const obj2 = { type: tmp2(5080).AST_KEY.TEXT, content: tmp2(5106).unparseTimestamp(str1, style) };
    let obj3 = obj2;
    const tmp2Result = tmp2(5106);
  } else {
    obj3 = {};
    const merged = Object.assign(parseTimestampResult);
    obj3.type = tmp2(5080).AST_KEY.TIMESTAMP;
  }
  return obj3;
};
