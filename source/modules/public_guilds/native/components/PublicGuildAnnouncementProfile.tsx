...
// Dependencies: [19, 17, 21, 4639, 576, 7257, 5672, 8142, 1177, 11784, 4635, 1115, 2]
// Exports: default

// Module 11783 (PublicGuildAnnouncementProfile)
...
export default function PublicGuildAnnouncementProfile() {
  ...
  const items1 = [React4(native.Icon, { source: _modDef11784, disableColor: true }), ];
