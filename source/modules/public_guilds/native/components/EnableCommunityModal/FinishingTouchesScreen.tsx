...
// Dependencies: [32, 19, 17, 9196, 2016, 8143, 1074, 21, 4341, 576, 504, 4283, 9195, 1086, 17777, 17821, 17820, 17818, 1115, 4635, 5057, 5772, 17830, 7307, 2025, 2]
// Exports: default

// Module 17832 (FinishingTouchesScreen)
...
const PublicGuildsConstants = fn(8143);
...
export default function FinishingTouchesScreen() {
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(9195).saveGuild(features.id, obj4);
      if (removeResult !== everyoneRole.permissions) {
        const items = [obj2];
        guild(17777).saveRoleSettings(features.id, items);
        const obj = guild(17777);
      }
      const obj5 = first(9195);
    }
  }, []);
  const tmp11 = _slicedToArray(noop.useState(!closure_11.some((item) => PermissionUtilsAll.canEveryone(item, guild))), 2);
  const tmp19 = defaultMessageNotifications(17821)();
  const enableCommunitySharedStyles = guild(17820).useEnableCommunitySharedStyles();
  let obj4 = { headerRef: ref, currentStep: guild(17818).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [closure_16(guild(4635).Text, obj6), closure_16(closure_6, { resizeMode: "contain", source: tmp19.finishingTouches }), , ];
  ...
  items2[2] = closure_16(guild(4635).Heading, obj8);
  ...
  items2[3] = closure_16(guild(4635).Text, obj9);
  ...
  obj11.children = closure_16(guild(7307).TableSwitchRow, obj12);
  const items4 = [closure_16(defaultMessageNotifications(17830), obj11), ];
  ...
  const tmp4Result = defaultMessageNotifications(17830);
  ...
  obj15.children = closure_16(guild(7307).TableSwitchRow, obj16);
  items4[1] = closure_16(defaultMessageNotifications(17830), obj15);
  obj14.children = items4;
  const items5 = [closure_17(guild(5772).TableRowGroup, obj14), ];
  ...
  obj19.value = first1;
  obj18.children = closure_16(guild(7307).TableSwitchRow, obj19);
  items5[1] = closure_16(guild(5772).TableRowGroup, obj18);
  obj10.children = items5;
  items3[1] = closure_17(guild(5057).Stack, obj10);
  ...
  const tmp4Result4 = defaultMessageNotifications(17830);
  ...
  items3[2] = closure_16(guild(4635).Text, obj20);
  obj4.children = items3;
  return closure_17(guild(17818).EnableCommunityModalScreen, obj4);
};
