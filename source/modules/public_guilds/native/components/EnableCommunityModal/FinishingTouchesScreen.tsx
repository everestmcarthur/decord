...
// Dependencies: [32, 19, 17, 9302, 2016, 8255, 1074, 21, 4423, 576, 504, 4366, 9301, 1086, 17967, 18011, 18010, 18008, 1115, 4718, 5142, 5857, 18020, 7396, 2025, 2]
// Exports: default

// Module 18022 (FinishingTouchesScreen)
...
const PublicGuildsConstants = fn(8255);
...
export default function FinishingTouchesScreen() {
  ...
  const token = guild(4423).useToken(defaultMessageNotifications(576).modules.mobile.TABLE_ROW_PADDING);
  let obj2 = guild(4423);
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(9301).saveGuild(features.id, obj4);
      if (removeResult !== everyoneRole.permissions) {
        const items = [obj2];
        guild(17967).saveRoleSettings(features.id, items);
        const obj = guild(17967);
      }
      const obj5 = first(9301);
    }
  }, []);
  const tmp11 = _slicedToArray(noop.useState(!closure_11.some((item) => PermissionUtilsAll.canEveryone(item, guild))), 2);
  const tmp19 = defaultMessageNotifications(18011)();
  const enableCommunitySharedStyles = guild(18010).useEnableCommunitySharedStyles();
  let obj4 = { headerRef: ref, currentStep: guild(18008).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [closure_16(guild(4718).Text, obj6), closure_16(closure_6, { resizeMode: "contain", source: tmp19.finishingTouches }), , ];
  ...
  items2[2] = closure_16(guild(4718).Heading, obj8);
  ...
  items2[3] = closure_16(guild(4718).Text, obj9);
  ...
  obj11.children = closure_16(guild(7396).TableSwitchRow, obj12);
  const items4 = [closure_16(defaultMessageNotifications(18020), obj11), ];
  ...
  const tmp4Result = defaultMessageNotifications(18020);
  ...
  obj15.children = closure_16(guild(7396).TableSwitchRow, obj16);
  items4[1] = closure_16(defaultMessageNotifications(18020), obj15);
  obj14.children = items4;
  const items5 = [closure_17(guild(5857).TableRowGroup, obj14), ];
  ...
  obj19.value = first1;
  obj18.children = closure_16(guild(7396).TableSwitchRow, obj19);
  items5[1] = closure_16(guild(5857).TableRowGroup, obj18);
  obj10.children = items5;
  items3[1] = closure_17(guild(5142).Stack, obj10);
  ...
  const tmp4Result4 = defaultMessageNotifications(18020);
  obj21.communityGuidelines = defaultMessageNotifications(2025).getArticleURL(constants.PUBLIC_GUILD_GUILDLINES);
  const tmp4Result5 = defaultMessageNotifications(2025);
  obj21.typesOfGuilds = defaultMessageNotifications(2025).getArticleURL(constants.FRIEND_COMMUNITY_DISCOVERABLE_GUILD_TYPES);
  obj20.children = intl9.format(guild(1115).t["BwbW/Q"], obj21);
  items3[2] = closure_16(guild(4718).Text, obj20);
  obj4.children = items3;
  return closure_17(guild(18008).EnableCommunityModalScreen, obj4);
};
