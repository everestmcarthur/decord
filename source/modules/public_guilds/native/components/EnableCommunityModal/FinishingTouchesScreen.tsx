...
const PublicGuildsConstants = fn(8140);
...
export default function FinishingTouchesScreen() {
  ...
  const token = guild(4338).useToken(defaultMessageNotifications(576).modules.mobile.TABLE_ROW_PADDING);
  let obj2 = guild(4338);
  ...
  const items2 = [closure_16(guild(4632).Text, obj6), closure_16(closure_6, { resizeMode: "contain", source: tmp19.finishingTouches }), , ];
  ...
  items2[2] = closure_16(guild(4632).Heading, obj8);
  ...
  items2[3] = closure_16(guild(4632).Text, obj9);
  ...
  obj19.value = first1;
  obj18.children = closure_16(guild(7303).TableSwitchRow, obj19);
  items5[1] = closure_16(guild(5768).TableRowGroup, obj18);
  obj10.children = items5;
  items3[1] = closure_17(guild(5054).Stack, obj10);
