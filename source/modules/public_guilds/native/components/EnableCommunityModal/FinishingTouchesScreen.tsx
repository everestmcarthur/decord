...
// Dependencies: [32, 19, 17, 9133, 2015, 8088, 1074, 21, 4306, 576, 504, 4248, 9132, 1086, 17717, 17761, 17760, 17758, 1114, 4601, 5023, 5737, 17770, 7252, 2024, 2]
// Exports: default

// Module 17772 (FinishingTouchesScreen)
...
const PublicGuildsConstants = fn(8088);
...
export default function FinishingTouchesScreen() {
  ...
  const token = guild(4306).useToken(defaultMessageNotifications(576).modules.mobile.TABLE_ROW_PADDING);
  let obj2 = guild(4306);
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(9132).saveGuild(features.id, obj4);
      if (removeResult !== everyoneRole.permissions) {
        const items = [obj2];
        guild(17717).saveRoleSettings(features.id, items);
        const obj = guild(17717);
      }
      const obj5 = first(9132);
    }
  }, []);
  const tmp11 = _slicedToArray(noop.useState(!closure_11.some((item) => PermissionUtilsAll.canEveryone(item, guild))), 2);
  const tmp19 = defaultMessageNotifications(17761)();
  const enableCommunitySharedStyles = guild(17760).useEnableCommunitySharedStyles();
  let obj4 = { headerRef: ref, currentStep: guild(17758).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [closure_16(guild(4601).Text, obj6), closure_16(closure_6, { resizeMode: "contain", source: tmp19.finishingTouches }), , ];
  ...
  items2[2] = closure_16(guild(4601).Heading, obj8);
  ...
  items2[3] = closure_16(guild(4601).Text, obj9);
  ...
  obj11.children = closure_16(guild(7252).TableSwitchRow, obj12);
  const items4 = [closure_16(defaultMessageNotifications(17770), obj11), ];
  ...
  const tmp4Result = defaultMessageNotifications(17770);
  ...
  obj15.children = closure_16(guild(7252).TableSwitchRow, obj16);
  items4[1] = closure_16(defaultMessageNotifications(17770), obj15);
  obj14.children = items4;
  const items5 = [closure_17(guild(5737).TableRowGroup, obj14), ];
  ...
  obj19.value = first1;
  obj18.children = closure_16(guild(7252).TableSwitchRow, obj19);
  items5[1] = closure_16(guild(5737).TableRowGroup, obj18);
  obj10.children = items5;
  items3[1] = closure_17(guild(5023).Stack, obj10);
  ...
  const tmp4Result4 = defaultMessageNotifications(17770);
  ...
  items3[2] = closure_16(guild(4601).Text, obj20);
  obj4.children = items3;
  return closure_17(guild(17758).EnableCommunityModalScreen, obj4);
};
