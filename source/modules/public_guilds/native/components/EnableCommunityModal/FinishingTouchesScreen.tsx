...
// Dependencies: [32, 19, 17, 9218, 2016, 8172, 1074, 21, 4341, 576, 504, 4283, 9217, 1086, 17874, 17918, 17917, 17915, 1115, 4636, 5060, 5775, 17927, 7314, 2025, 2]
// Exports: default

// Module 17929 (FinishingTouchesScreen)
...
const PublicGuildsConstants = fn(8172);
...
export default function FinishingTouchesScreen() {
  ...
  const token = guild(4341).useToken(defaultMessageNotifications(576).modules.mobile.TABLE_ROW_PADDING);
  let obj2 = guild(4341);
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(9217).saveGuild(features.id, obj4);
      if (removeResult !== everyoneRole.permissions) {
        const items = [obj2];
        guild(17874).saveRoleSettings(features.id, items);
        const obj = guild(17874);
      }
      const obj5 = first(9217);
    }
  }, []);
  const tmp11 = _slicedToArray(noop.useState(!closure_11.some((item) => PermissionUtilsAll.canEveryone(item, guild))), 2);
  const tmp19 = defaultMessageNotifications(17918)();
  const enableCommunitySharedStyles = guild(17917).useEnableCommunitySharedStyles();
  let obj4 = { headerRef: ref, currentStep: guild(17915).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [closure_16(guild(4636).Text, obj6), closure_16(closure_6, { resizeMode: "contain", source: tmp19.finishingTouches }), , ];
  ...
  items2[2] = closure_16(guild(4636).Heading, obj8);
  ...
  items2[3] = closure_16(guild(4636).Text, obj9);
  ...
  obj11.children = closure_16(guild(7314).TableSwitchRow, obj12);
  const items4 = [closure_16(defaultMessageNotifications(17927), obj11), ];
  ...
  const tmp4Result = defaultMessageNotifications(17927);
  ...
  obj15.children = closure_16(guild(7314).TableSwitchRow, obj16);
  items4[1] = closure_16(defaultMessageNotifications(17927), obj15);
  obj14.children = items4;
  const items5 = [closure_17(guild(5775).TableRowGroup, obj14), ];
  ...
  obj19.value = first1;
  obj18.children = closure_16(guild(7314).TableSwitchRow, obj19);
  items5[1] = closure_16(guild(5775).TableRowGroup, obj18);
  obj10.children = items5;
  items3[1] = closure_17(guild(5060).Stack, obj10);
  ...
  const tmp4Result4 = defaultMessageNotifications(17927);
  ...
  items3[2] = closure_16(guild(4636).Text, obj20);
  obj4.children = items3;
  return closure_17(guild(17915).EnableCommunityModalScreen, obj4);
};
