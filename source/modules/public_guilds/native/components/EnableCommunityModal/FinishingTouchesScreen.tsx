...
// Dependencies: [32, 19, 17, 9154, 2015, 8110, 1074, 21, 4308, 576, 504, 4250, 9153, 1086, 17708, 17752, 17751, 17749, 1114, 4602, 5024, 5738, 17761, 7273, 2024, 2]
// Exports: default

// Module 17763 (FinishingTouchesScreen)
...
const PublicGuildsConstants = fn(8110);
...
export default function FinishingTouchesScreen() {
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(9153).saveGuild(features.id, obj4);
      if (removeResult !== everyoneRole.permissions) {
        const items = [obj2];
        guild(17708).saveRoleSettings(features.id, items);
        const obj = guild(17708);
      }
      const obj5 = first(9153);
    }
  }, []);
  const tmp11 = _slicedToArray(noop.useState(!closure_11.some((item) => PermissionUtilsAll.canEveryone(item, guild))), 2);
  const tmp19 = defaultMessageNotifications(17752)();
  const enableCommunitySharedStyles = guild(17751).useEnableCommunitySharedStyles();
  let obj4 = { headerRef: ref, currentStep: guild(17749).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [closure_16(guild(4602).Text, obj6), closure_16(closure_6, { resizeMode: "contain", source: tmp19.finishingTouches }), , ];
  ...
  items2[2] = closure_16(guild(4602).Heading, obj8);
  ...
  items2[3] = closure_16(guild(4602).Text, obj9);
  ...
  obj11.children = closure_16(guild(7273).TableSwitchRow, obj12);
  const items4 = [closure_16(defaultMessageNotifications(17761), obj11), ];
  ...
  const tmp4Result = defaultMessageNotifications(17761);
  ...
  obj15.children = closure_16(guild(7273).TableSwitchRow, obj16);
  items4[1] = closure_16(defaultMessageNotifications(17761), obj15);
  obj14.children = items4;
  const items5 = [closure_17(guild(5738).TableRowGroup, obj14), ];
  ...
  obj19.value = first1;
  obj18.children = closure_16(guild(7273).TableSwitchRow, obj19);
  items5[1] = closure_16(guild(5738).TableRowGroup, obj18);
  obj10.children = items5;
  items3[1] = closure_17(guild(5024).Stack, obj10);
  ...
  const tmp4Result4 = defaultMessageNotifications(17761);
  ...
  items3[2] = closure_16(guild(4602).Text, obj20);
  obj4.children = items3;
  return closure_17(guild(17749).EnableCommunityModalScreen, obj4);
};
