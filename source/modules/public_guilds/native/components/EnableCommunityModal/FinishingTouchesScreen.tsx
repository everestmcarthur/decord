...
// Dependencies: [32, 19, 17, 9156, 2015, 8111, 1074, 21, 4308, 576, 504, 4250, 9155, 1086, 17709, 17753, 17752, 17750, 1114, 4603, 5025, 5739, 17762, 7274, 2024, 2]
// Exports: default

// Module 17764 (FinishingTouchesScreen)
...
const PublicGuildsConstants = fn(8111);
...
export default function FinishingTouchesScreen() {
  ...
  const token = guild(4308).useToken(defaultMessageNotifications(576).modules.mobile.TABLE_ROW_PADDING);
  let obj2 = guild(4308);
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(9155).saveGuild(features.id, obj4);
      if (removeResult !== everyoneRole.permissions) {
        const items = [obj2];
        guild(17709).saveRoleSettings(features.id, items);
        const obj = guild(17709);
      }
      const obj5 = first(9155);
    }
  }, []);
  const tmp11 = _slicedToArray(noop.useState(!closure_11.some((item) => PermissionUtilsAll.canEveryone(item, guild))), 2);
  const tmp19 = defaultMessageNotifications(17753)();
  const enableCommunitySharedStyles = guild(17752).useEnableCommunitySharedStyles();
  let obj4 = { headerRef: ref, currentStep: guild(17750).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [closure_16(guild(4603).Text, obj6), closure_16(closure_6, { resizeMode: "contain", source: tmp19.finishingTouches }), , ];
  ...
  items2[2] = closure_16(guild(4603).Heading, obj8);
  ...
  items2[3] = closure_16(guild(4603).Text, obj9);
  ...
  obj11.children = closure_16(guild(7274).TableSwitchRow, obj12);
  const items4 = [closure_16(defaultMessageNotifications(17762), obj11), ];
  ...
  const tmp4Result = defaultMessageNotifications(17762);
  ...
  obj15.children = closure_16(guild(7274).TableSwitchRow, obj16);
  items4[1] = closure_16(defaultMessageNotifications(17762), obj15);
  obj14.children = items4;
  const items5 = [closure_17(guild(5739).TableRowGroup, obj14), ];
  ...
  obj19.value = first1;
  obj18.children = closure_16(guild(7274).TableSwitchRow, obj19);
  items5[1] = closure_16(guild(5739).TableRowGroup, obj18);
  obj10.children = items5;
  items3[1] = closure_17(guild(5025).Stack, obj10);
  ...
  const tmp4Result4 = defaultMessageNotifications(17762);
  ...
  items3[2] = closure_16(guild(4603).Text, obj20);
  obj4.children = items3;
  return closure_17(guild(17750).EnableCommunityModalScreen, obj4);
};
