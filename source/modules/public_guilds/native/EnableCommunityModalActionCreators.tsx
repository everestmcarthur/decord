...
// Dependencies: [4777, 17698, 1896, 2]

// Module 17697 (EnableCommunityModalActionCreators)
...
export default {
  open() {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(17698, dependencyMap.paths), undefined, ENABLED_COMMUNITY_MODAL_KEY);
  },
  close() {
