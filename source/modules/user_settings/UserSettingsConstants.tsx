...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "PX_16", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: false, errorCallbacks: false, loaded: false, loading: "call", triggeredMigrations: false, offlineEditDataVersion: false };
  obj[4] = [];
  obj[5] = [];
  return obj;
};
