...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "PX_16", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: [], errorCallbacks: [], loaded: false, loading: "channel", triggeredMigrations: "dancers", offlineEditDataVersion: "compressing" };
  return obj;
};
