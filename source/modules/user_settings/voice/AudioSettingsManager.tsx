...
// Dependencies: [32, 4655, 5097, 502, 1909, 4663, 9236, 11, 1186, 510, 1941, 9235, 12, 14176, 9591, 7228, 2]

// Module 17527 (AudioSettingsManager)
import SnowflakeUtilsDefault from "SnowflakeUtils" /* 11 */;
import Storage2 from "Storage" /* 510 */;
import UserSettingsProtoActionCreators from "UserSettingsProtoActionCreators" /* 1941 */;
import AudioSettingsUtils from "AudioSettingsUtils" /* 9235 */;
import AudioSettingsDefaultVolumes from "AudioSettingsDefaultVolumes" /* 9236 */;
import AudioSettingsPending from "AudioSettingsPending" /* 14176 */;
          ...
          if (closure_0[result][arg1] != null) {
            ...
            if (typeof DEFAULT_VOLUME_FOR_CONTEXT === "function") {
              if (arg0 === constants.STREAM) {
                let USER2 = tmp5(9236).AudioSettingsDefaultVolumes.STREAM;
              } else {
                USER2 = tmp5(9236).AudioSettingsDefaultVolumes.USER;
              }
              if (!tmp21) {
                delete tmp2[tmp];
              }
            ...
            if (arg0 === constants.STREAM) {
              let USER = tmp5(9236).AudioSettingsDefaultVolumes.STREAM;
            } else {
              USER = tmp5(9236).AudioSettingsDefaultVolumes.USER;
            }
