...
// Dependencies: [32, 4657, 5100, 502, 1909, 4665, 9247, 11, 1186, 510, 1941, 9246, 12, 14184, 9602, 7232, 2]

// Module 17568 (AudioSettingsManager)
...
import AudioSettingsDefaultVolumes from "AudioSettingsDefaultVolumes" /* 9247 */;
import AudioSettingsPending from "AudioSettingsPending" /* 14184 */;
          ...
          if (closure_0[result][arg1] != null) {
            ...
            if (typeof DEFAULT_VOLUME_FOR_CONTEXT === "function") {
              if (arg0 === constants.STREAM) {
                let USER2 = tmp5(9247).AudioSettingsDefaultVolumes.STREAM;
              } else {
                USER2 = tmp5(9247).AudioSettingsDefaultVolumes.USER;
              }
              if (!tmp21) {
                delete tmp2[tmp];
              }
            ...
            if (arg0 === constants.STREAM) {
              let USER = tmp5(9247).AudioSettingsDefaultVolumes.STREAM;
            } else {
              USER = tmp5(9247).AudioSettingsDefaultVolumes.USER;
            }
