...
// Dependencies: [32, 4656, 5096, 502, 1909, 4664, 9225, 11, 1186, 510, 1941, 9224, 12, 14163, 9580, 7225, 2]

// Module 17471 (AudioSettingsManager)
...
import AudioSettingsPending from "AudioSettingsPending" /* 14163 */;
...
function handleSetLocalMute(arg0) {
  ...
  if (userId !== AuthenticationStore.getId()) {
    ...
    PreloadedUserSettingsActionCreators.updateAsync("audioContextSettings", async (arg0) => {
      closure_0 = arg0;
      let result = closure_0(14163).drainPendingAudioSettings((arg0, arg1, arg2) => {
        let diff;
          ...
          if (closure_0[result][arg1] != null) {
            ...
            if (typeof DEFAULT_VOLUME_FOR_CONTEXT === "function") {
              if (arg0 === constants.STREAM) {
                let USER2 = tmp5(9225).AudioSettingsDefaultVolumes.STREAM;
              } else {
                USER2 = tmp5(9225).AudioSettingsDefaultVolumes.USER;
              }
              if (!tmp21) {
                delete tmp2[tmp];
              }
            ...
            if (arg0 === constants.STREAM) {
              let USER = tmp5(9225).AudioSettingsDefaultVolumes.STREAM;
            } else {
              USER = tmp5(9225).AudioSettingsDefaultVolumes.USER;
            }
...
let apply = apply_mod;
let closure_13 = apply.debounce(fn(9580).remoteAudioSettingsUpdate, 500, { maxWait: 500 });
