...
// Dependencies: [19, 17, 1074, 21, 4722, 7540, 7358, 10223, 1115, 5775, 10230, 7534, 4718, 2025, 2]
// Exports: default

// Module 10233 (UserSettingsSoundboardVolume)
...
export default function SoundboardVolume() {
  const tmp = closure_8();
  const amplitudinalSoundboardVolume = analyticsLocations(7540).getAmplitudinalSoundboardVolume();
  ...
  const obj = analyticsLocations(7540);
  ...
  items[1] = closure_5(analyticsLocations(4718).Text, obj7);
  obj4.children = items;
  obj3.subLabel = closure_7(closure_6, obj4);
  obj2.children = closure_5(analyticsLocations(5775).TableRow, obj3);
  return closure_5(analyticsLocations(10223).UserSettingsTableRowGroup, obj2);
};
