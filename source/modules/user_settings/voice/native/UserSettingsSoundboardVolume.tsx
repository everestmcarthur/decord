...
// Dependencies: [19, 17, 1074, 21, 4574, 7358, 7176, 10011, 1114, 5619, 10018, 7352, 4570, 2024, 2]
// Exports: default

// Module 10021 (UserSettingsSoundboardVolume)
...
export default function SoundboardVolume() {
  const tmp = closure_8();
  const amplitudinalSoundboardVolume = analyticsLocations(7358).getAmplitudinalSoundboardVolume();
  ...
  const obj = analyticsLocations(7358);
  ...
  items[1] = closure_5(analyticsLocations(4570).Text, obj7);
  obj4.children = items;
  obj3.subLabel = closure_7(closure_6, obj4);
  obj2.children = closure_5(analyticsLocations(5619).TableRow, obj3);
  return closure_5(analyticsLocations(10011).UserSettingsTableRowGroup, obj2);
};
