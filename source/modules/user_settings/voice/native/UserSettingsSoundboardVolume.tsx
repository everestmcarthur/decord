...
// Dependencies: [19, 17, 1074, 21, 4605, 7396, 7214, 10049, 1114, 5655, 10056, 7390, 4601, 2024, 2]
// Exports: default

// Module 10059 (UserSettingsSoundboardVolume)
...
export default function SoundboardVolume() {
  const tmp = closure_8();
  const amplitudinalSoundboardVolume = analyticsLocations(7396).getAmplitudinalSoundboardVolume();
  ...
  const obj = analyticsLocations(7396);
  ...
  items[1] = closure_5(analyticsLocations(4601).Text, obj7);
  obj4.children = items;
  obj3.subLabel = closure_7(closure_6, obj4);
  obj2.children = closure_5(analyticsLocations(5655).TableRow, obj3);
  return closure_5(analyticsLocations(10049).UserSettingsTableRowGroup, obj2);
};
