...
// Dependencies: [19, 17, 4661, 502, 1909, 4664, 21, 4639, 504, 38, 9221, 10110, 1115, 5690, 10117, 2]
// Exports: default

// Module 10116 (UserSettingsVoiceOutputOptions)
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(5690).TableRow, obj8);
    const tmp11Result = VolumeSliderDefault;
  }
  items4[1] = tmp9Result;
  obj4.children = items4;
  return tmp8(stateFromStores1(10110).UserSettingsTableRowGroup, obj4);
};
