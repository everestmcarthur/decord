...
// Dependencies: [19, 17, 4662, 502, 1909, 4665, 21, 4640, 504, 38, 9243, 10129, 1115, 5693, 10136, 2]
// Exports: default

// Module 10135 (UserSettingsVoiceOutputOptions)
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  const items4 = [closure_9(stateFromStores1(5693).TableRow, obj5), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(5693).TableRow, obj8);
    const tmp11Result = VolumeSliderDefault;
  }
  items4[1] = tmp9Result;
  obj4.children = items4;
  return tmp8(stateFromStores1(10129).UserSettingsTableRowGroup, obj4);
};
