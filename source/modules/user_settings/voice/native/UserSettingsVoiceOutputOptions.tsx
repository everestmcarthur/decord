...
// Dependencies: [19, 17, 4660, 502, 1909, 4663, 21, 4638, 504, 38, 9232, 10118, 1115, 5691, 10125, 2]
// Exports: default

// Module 10124 (UserSettingsVoiceOutputOptions)
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  const items4 = [closure_9(stateFromStores1(5691).TableRow, obj5), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(5691).TableRow, obj8);
    const tmp11Result = VolumeSliderDefault;
  }
  items4[1] = tmp9Result;
  obj4.children = items4;
  return tmp8(stateFromStores1(10118).UserSettingsTableRowGroup, obj4);
};
