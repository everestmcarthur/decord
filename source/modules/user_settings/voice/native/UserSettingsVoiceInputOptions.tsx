...
// Dependencies: [19, 17, 1909, 1074, 21, 4640, 7308, 1115, 9243, 504, 10129, 5693, 4636, 7314, 10134, 2]
// Exports: default

// Module 10133 (UserSettingsVoiceInputOptions)
...
import VoiceSensitivityDefault from "VoiceSensitivity" /* 10134 */;
...
export default function UserSettingsVoiceInputOptions() {
  ...
  obj3.trailing = closure_6(inputMode(4636).Text, obj4);
  obj3.onPress = handleInputModePress;
  const items1 = [closure_6(inputMode(5693).TableRow, obj3), ];
  let tmp4Result = null;
  if (inputMode !== InputModes.PUSH_TO_TALK) {
    ...
    const items2 = [tmp5(tmp(7314).TableSwitchRow, obj6), ];
    ...
    items2[1] = tmp5(tmp(5693).TableRow, obj7);
    obj5.children = items2;
    tmp4Result = tmp4(closure_7, obj5);
  }
  items1[1] = tmp4Result;
  obj2.children = items1;
  return closure_8(inputMode(10129).UserSettingsTableRowGroup, obj2);
};
