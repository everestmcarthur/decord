...
// Dependencies: [19, 17, 1909, 1074, 21, 4639, 7301, 1115, 9221, 504, 10110, 5690, 4635, 7307, 10115, 2]
// Exports: default

// Module 10114 (UserSettingsVoiceInputOptions)
...
import VoiceSensitivityDefault from "VoiceSensitivity" /* 10115 */;
...
export default function UserSettingsVoiceInputOptions() {
  ...
  obj3.trailing = closure_6(inputMode(4635).Text, obj4);
  obj3.onPress = handleInputModePress;
  const items1 = [closure_6(inputMode(5690).TableRow, obj3), ];
  let tmp4Result = null;
  if (inputMode !== InputModes.PUSH_TO_TALK) {
    ...
    const items2 = [tmp5(tmp(7307).TableSwitchRow, obj6), ];
    ...
    items2[1] = tmp5(tmp(5690).TableRow, obj7);
    obj5.children = items2;
    tmp4Result = tmp4(closure_7, obj5);
  }
  items1[1] = tmp4Result;
  obj2.children = items1;
  return closure_8(inputMode(10110).UserSettingsTableRowGroup, obj2);
};
