...
// Dependencies: [19, 17, 1908, 1074, 21, 4606, 7267, 1114, 9179, 504, 10069, 5656, 4602, 7273, 10074, 2]
// Exports: default
...
export default function UserSettingsVoiceInputOptions() {
  ...
  obj3.trailing = closure_6(inputMode(4602).Text, obj4);
  obj3.onPress = handleInputModePress;
  const items1 = [closure_6(inputMode(5656).TableRow, obj3), ];
  let tmp4Result = null;
  if (inputMode !== InputModes.PUSH_TO_TALK) {
    ...
    const items2 = [tmp5(tmp(7273).TableSwitchRow, obj6), ];
    ...
    items2[1] = tmp5(tmp(5656).TableRow, obj7);
    obj5.children = items2;
    tmp4Result = tmp4(closure_7, obj5);
  }
  items1[1] = tmp4Result;
  obj2.children = items1;
  return closure_8(inputMode(10069).UserSettingsTableRowGroup, obj2);
};
