...
// Dependencies: [19, 17, 1908, 8027, 1074, 21, 2024, 4605, 4540, 4456, 10068, 10069, 1114, 6705, 10067, 4601, 10064, 11540, 14767, 2]
// Exports: default

// Module 15328 (SettingsVoiceScreen)
import util from "util" /* 1114 */;
import useThemeDefault from "useTheme" /* 4540 */;
import Text_Text from "Text/Text" /* 4601 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6705 */;
import KrispLogo2 from "KrispLogo" /* 10067 */;
...
function SystemProcessingSubLabel() {
  ...
  if (obj.useNoiseCancellationDeferredToSystem()) {
    ...
    tmp3 = React7(tmp(4601).Text, obj2);
  }
  return tmp3;
}
