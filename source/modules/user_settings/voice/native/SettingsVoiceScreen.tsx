...
// Dependencies: [19, 17, 1909, 8111, 1074, 21, 2025, 4640, 4574, 4491, 10148, 10149, 1115, 6766, 10147, 4636, 10144, 11622, 14810, 2]
// Exports: default

// Module 15362 (SettingsVoiceScreen)
import util from "util" /* 1115 */;
import useThemeDefault from "useTheme" /* 4574 */;
import Text_Text from "Text/Text" /* 4636 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6766 */;
import KrispLogo2 from "KrispLogo" /* 10147 */;
...
function KrispLogo() {
  ...
  if (obj.isThemeLight(tmp4)) {
    let tmp2Result = tmp2(10148);
  } else {
    tmp2Result = tmp2(10149);
  }
...
function SystemProcessingSubLabel() {
  ...
  if (obj.useNoiseCancellationDeferredToSystem()) {
    ...
    tmp3 = React7(tmp(4636).Text, obj2);
  }
  return tmp3;
}
