...
// Dependencies: [19, 17, 1909, 8082, 1074, 21, 2025, 4639, 4574, 4491, 10129, 10130, 1115, 6760, 10128, 4635, 10125, 11606, 14786, 2]
// Exports: default

// Module 15341 (SettingsVoiceScreen)
import util from "util" /* 1115 */;
import useThemeDefault from "useTheme" /* 4574 */;
import Text_Text from "Text/Text" /* 4635 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6760 */;
import KrispLogo2 from "KrispLogo" /* 10128 */;
...
function SystemProcessingSubLabel() {
  ...
  if (obj.useNoiseCancellationDeferredToSystem()) {
    ...
    tmp3 = React7(tmp(4635).Text, obj2);
  }
  return tmp3;
}
