...
// Dependencies: [19, 17, 1909, 8091, 1074, 21, 2025, 4638, 4572, 4489, 10137, 10138, 1115, 6763, 10136, 4634, 10133, 11614, 14802, 2]
// Exports: default

// Module 15357 (SettingsVoiceScreen)
import util from "util" /* 1115 */;
import useThemeDefault from "useTheme" /* 4572 */;
import Text_Text from "Text/Text" /* 4634 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6763 */;
import KrispLogo2 from "KrispLogo" /* 10136 */;
...
function KrispLogo() {
  ...
  if (obj.isThemeLight(tmp4)) {
    let tmp2Result = tmp2(10137);
  } else {
    tmp2Result = tmp2(10138);
  }
...
function SystemProcessingSubLabel() {
  ...
  if (obj.useNoiseCancellationDeferredToSystem()) {
    ...
    tmp3 = React7(tmp(4634).Text, obj2);
  }
  return tmp3;
}
