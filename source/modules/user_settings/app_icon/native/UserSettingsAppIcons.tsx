...
// Dependencies: [5, 19, 17, 1372, 1074, 9466, 21, 4638, 504, 13554, 1886, 7272, 9467, 9456, 8728, 15640, 10109, 9535, 9505, 1115, 2]

// Module 15639 (UserSettingsAppIcons)
...
import NitroUpsellButtonDefault from "NitroUpsellButton" /* 10109 */;
import AppIconRowsDefault from "AppIconRows" /* 15640 */;
...
export default noop.memo(() => {
          ...
          if (arg0 === 1) {
            ...
            if (null != tmp24) {
              ...
              if (id === tmp22) {
                if (importDefault !== id) {
                  if (tmp26) {
                    if (!closure_2_2) {
                      ...
                      const result = v3(9456).handleShowUpsellAlert(obj6);
                      const obj5 = v3(9456);
                    }
                  }
                  let premiumType;
                  ...
                  dependencyMap = 1;
                  v3 = 1;
                  const obj8 = { value: stateFromStores(13554).setAppIcon(id, premiumType), done: false };
                  return obj8;
                }
              } else {
                let premiumType1;
                ...
                dependencyMap = 2;
                v3 = 1;
                const obj9 = { value: stateFromStores(13554).setAppIcon(stateFromStores(9467).FreemiumAppIconIds.DEFAULT, premiumType1), done: false };
                return obj9;
              }
            }
  ...
  importDefault = stateFromStores(13554).useCurrentAppIcon();
  let obj2 = stateFromStores(13554);
  ...
  const children = [closure_9(stateFromStores(8728).Form, obj5), ];
