...
// Dependencies: [5, 19, 17, 1372, 1074, 9477, 21, 4640, 504, 13562, 1886, 7276, 9478, 9467, 8748, 15646, 10120, 9546, 9516, 1115, 2]

// Module 15645 (UserSettingsAppIcons)
...
import AppIconRowsDefault from "AppIconRows" /* 15646 */;
          ...
          if (arg0 === 1) {
            ...
            if (null != tmp24) {
              ...
              if (id === tmp22) {
                ...
                dependencyMap = 2;
                v3 = 1;
                const obj9 = { value: stateFromStores(13562).setAppIcon(stateFromStores(9478).FreemiumAppIconIds.DEFAULT, premiumType1), done: false };
                return obj9;
              }
            }
