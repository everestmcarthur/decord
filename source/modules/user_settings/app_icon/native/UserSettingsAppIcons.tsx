...
// Dependencies: [5, 19, 17, 1372, 1074, 9455, 21, 4639, 504, 13542, 1886, 7269, 9456, 9445, 8719, 15623, 10101, 9524, 9494, 1115, 2]

// Module 15622 (UserSettingsAppIcons)
...
import NitroUpsellButtonDefault from "NitroUpsellButton" /* 10101 */;
import AppIconRowsDefault from "AppIconRows" /* 15623 */;
...
export default noop.memo(() => {
          ...
          if (arg0 === 1) {
            ...
            if (null != tmp24) {
              ...
              if (id === tmp22) {
                if (importDefault !== id) {
                  if (tmp26) {
                    if (!closure_2_2) {
                      ...
                      const result = v3(9445).handleShowUpsellAlert(obj6);
                      const obj5 = v3(9445);
                    }
                  }
                  let premiumType;
                  ...
                  dependencyMap = 1;
                  v3 = 1;
                  const obj8 = { value: stateFromStores(13542).setAppIcon(id, premiumType), done: false };
                  return obj8;
                }
              } else {
                let premiumType1;
                ...
                dependencyMap = 2;
                v3 = 1;
                const obj9 = { value: stateFromStores(13542).setAppIcon(stateFromStores(9456).FreemiumAppIconIds.DEFAULT, premiumType1), done: false };
                return obj9;
              }
            }
  ...
  importDefault = stateFromStores(13542).useCurrentAppIcon();
  let obj2 = stateFromStores(13542);
  ...
  const children = [closure_9(stateFromStores(8719).Form, obj5), ];
