...
// Dependencies: [19, 17, 1372, 4303, 8111, 1074, 21, 4640, 576, 1484, 563, 4297, 4636, 1115, 5695, 1177, 10546, 7104, 11622, 14810, 2]
// Exports: default

// Module 15576 (SettingsChatScreen)
...
function VideoUploadQualityNitroUpsell() {
  ...
  if (!stateFromStores) {
    ...
    const obj7 = { style: tmp3.cardIcon, source: _modDef10546, size: tmp(1177).Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.PRIMARY_400 };
    ...
    items2[1] = tmp7(tmp(4636).Text, obj8);
    obj6.children = items2;
    obj5.children = tmp5(tmp6, obj6);
    obj4.children = tmp7(tmp(5695).Card, obj5);
