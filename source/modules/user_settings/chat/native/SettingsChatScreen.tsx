...
// Dependencies: [19, 17, 1372, 4303, 8082, 1074, 21, 4639, 576, 1484, 563, 4297, 4635, 1115, 5692, 1177, 10530, 7097, 11606, 14786, 2]
// Exports: default

// Module 15555 (SettingsChatScreen)
...
function VideoUploadQualityNitroUpsell() {
  ...
  if (!stateFromStores) {
    ...
    const obj7 = { style: tmp3.cardIcon, source: _modDef10530, size: tmp(1177).Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.PRIMARY_400 };
    ...
    items2[1] = tmp7(tmp(4635).Text, obj8);
    obj6.children = items2;
    obj5.children = tmp5(tmp6, obj6);
    obj4.children = tmp7(tmp(5692).Card, obj5);
