...
// Dependencies: [19, 17, 1372, 4386, 8194, 1074, 21, 4722, 576, 1484, 563, 4380, 4718, 1115, 5777, 1177, 10640, 7186, 11714, 14904, 2]
// Exports: default
...
function VideoUploadQualityNitroUpsell() {
  ...
  if (!stateFromStores) {
    ...
    const obj7 = { style: tmp3.cardIcon, source: _modDef10640, size: tmp(1177).Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.PRIMARY_400 };
    ...
    items2[1] = tmp7(tmp(4718).Text, obj8);
    obj6.children = items2;
    obj5.children = tmp5(tmp6, obj6);
    obj4.children = tmp7(tmp(5777).Card, obj5);
