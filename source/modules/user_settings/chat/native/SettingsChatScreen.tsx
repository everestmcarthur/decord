...
// Dependencies: [19, 17, 1372, 4301, 8091, 1074, 21, 4638, 576, 1484, 563, 4295, 4634, 1115, 5693, 1177, 10538, 7100, 11614, 14802, 2]
// Exports: default

// Module 15571 (SettingsChatScreen)
...
function VideoUploadQualityNitroUpsell() {
  ...
  if (!stateFromStores) {
    ...
    const obj7 = { style: tmp3.cardIcon, source: _modDef10538, size: tmp(1177).Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.PRIMARY_400 };
    ...
    items2[1] = tmp7(tmp(4634).Text, obj8);
    obj6.children = items2;
    obj5.children = tmp5(tmp6, obj6);
    obj4.children = tmp7(tmp(5693).Card, obj5);
