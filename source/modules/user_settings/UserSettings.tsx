...
// Function ID: 1936
// Name: UserSettings
// Dependencies: [1936, 1084, 1937, 1074, 1938, 1939, 1218, 1187, 558, 7893, 12, 504, 5437, 7313, 1226, 2]
...
const items1 = [fn(7893).MessagePreviewTypes.ALL, fn(7893).MessagePreviewTypes.UNREADS, fn(7893).MessagePreviewTypes.NONE];
