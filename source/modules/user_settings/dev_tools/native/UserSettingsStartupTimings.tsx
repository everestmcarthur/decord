...
import closure_7 from "refreshSourceMapCookie" /* 1347 */;
import jsxProd from "jsxProd" /* 21 */;
import createCacheKey from "createCacheKey" /* 4560 */;
import importDefaultResult from "enforcing" /* 4424 */;
...
export default function UserSettingsStartupTimings() {
  ...
  const lastTrackedAppUiViewed2Properties = _require(7475).getLastTrackedAppUiViewed2Properties();
  num = undefined;
  ...
  closure_14 = obj.useCallback(first1(function*() {
    if (c3 === 2) {
      c3 = 3;
  ...
  obj1 = { paddingBottom: first(1611)().bottom + first(576).space.PX_16 };
  obj[0] = obj1;
  obj[1] = function ListHeaderComponent() {
    let obj = { spacing: 16, style: { padding: 16 }, children: null };
    obj = { title: "Performance testing", hasIcons: false, children: callback(lib(5604).TableCheckboxRow, obj) };
    obj = {
    ...
    const items = [callback(lib(5687).TableRowGroup, obj), , , , ];
    obj1 = { children: null };
    ...
    const obj2 = { color: "text-brand", children: "" + result + "s (" + Math.round(closure_7 / num * 100) + "%)" };
    ...
    obj14[2] = callback(lib(5605).TableRow, obj15);
    items[1] = callback(lib(5687).TableRowGroup, obj14);
    ...
    obj18[2] = callback(lib(5605).TableRow, obj19);
    items[2] = callback(lib(5687).TableRowGroup, obj18);
    const obj21 = { title: "Detailed Times", hasIcons: false, children: null };
    const items11 = [
      callback(lib(5604).TableCheckboxRow, {
    ...
    obj21[2] = items11;
    items[3] = callback2(lib(5687).TableRowGroup, obj21);
