...
// Dependencies: [5, 32, 19, 17, 1347, 1074, 21, 4607, 576, 4603, 4471, 1611, 10284, 504, 9, 7549, 8449, 8966, 5025, 5739, 5656, 1348, 5657, 9145, 2]
// Exports: default

// Module 15632 (UserSettingsStartupTimings)
...
import ShareIcon from "ShareIcon" /* 9145 */;
import serializeAppStartLogsDefault from "serializeAppStartLogs" /* 10284 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;
import DeveloperOptionsStore from "DeveloperOptionsStore" /* 1347 */;
import NativeTTIManagerModule from "NativeTTIManagerModule" /* 4471 */;
...
export default function UserSettingsStartupTimings() {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp5(4471).getAppFirstVisibleTimestamp(), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          closure_128_1 = tmp5(10284)(closure_128_0);
          const obj7 = { message: closure_128_1 };
          tmp2(8449).showShareActionSheet(obj7, "Startup Timing");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp17) {
  ...
  obj5.contentContainerStyle = { paddingBottom: checked(1611)().bottom + tmp2(576).space.PX_16 };
  obj5.ListHeaderComponent = function ListHeaderComponent() {
    ...
    const items10 = [React7(Code, { children: ["\u2615", " - Java / Kotlin"] }), React7(Code, { children: ["\u{1F3A8}", " - React render"] }), React7(Code, { children: ["\u{1F4BE}", " - CacheStore"] }), React7(Code, { children: ["\u{1F9A5}", " - Slow Store Update / Handler"] }), React7(Code, { children: ["\u{1F3C3}", " - Startup Event"] }), React7(Code, { children: ["\u{1F310}", " - Socket Event"] })];
  ...
  obj4.children = closure_8(tmp10(8966).FlashList, obj5);
