...
// Dependencies: [5, 21, 1483, 13818, 4952, 4304, 1114, 4956, 2946, 4956, 2]
// Exports: default
      ...
      try {
        ...
        if (0 === c1) {
          if (dependencyMap === 1) {
            ...
            c1 = 2;
            c3 = 1;
            const obj6 = { value: tmp3(13818).resetAgeVerification(), done: false };
            return obj6;
          }
        } else if (1 === tmp7) {
          dependencyMap = 0;
          ...
          tmp3(4952).dismissAlert(closure_1_6);
