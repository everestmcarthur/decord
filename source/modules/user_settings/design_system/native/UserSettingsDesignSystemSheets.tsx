...
// Dependencies: [32, 19, 17, 1074, 21, 4606, 7270, 7222, 9809, 7271, 5024, 6677, 7272, 4573, 5026, 1114, 10319, 5885, 5658, 4602, 2]
// Exports: default
...
function DemoActionSheet() {
  ...
  if (tmp2) {
    ...
    tmp14Result2 = tmp14(tmp15(7271).ActionSheetCloseButton, obj3);
  }
