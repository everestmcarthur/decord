...
// Dependencies: [32, 19, 17, 21, 4638, 576, 4634, 4339, 4487, 9932, 5058, 12757, 12902, 12759, 5060, 7310, 2]
// Exports: default

// Module 15897 (UserSettingsDesignSystemTabs)
...
export default function UserSettingsDesignSystemTabs() {
  ...
  if (first2) {
    ...
    tmp20Result = tmp20(tmp18(12902), obj5);
  }
