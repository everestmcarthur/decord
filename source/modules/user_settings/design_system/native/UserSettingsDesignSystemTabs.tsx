...
// Dependencies: [32, 19, 17, 21, 4639, 576, 4635, 4341, 4489, 9924, 5057, 12749, 12894, 12751, 5059, 7307, 2]
// Exports: default

// Module 15879 (UserSettingsDesignSystemTabs)
...
export default function UserSettingsDesignSystemTabs() {
  ...
  if (first2) {
    ...
    tmp20Result = tmp20(tmp18(12894), obj5);
  }
