...
// Dependencies: [32, 19, 17, 21, 4638, 576, 7110, 5710, 4841, 7487, 1115, 6714, 4332, 12071, 14290, 8551, 8552, 4634, 12069, 14292, 11147, 11146, 5773, 7310, 5060, 2]
// Exports: default

// Module 15915 (UserSettingsDesignSystemModal)
  ...
  const navigatorScreens = Navigator.useNavigatorScreens(() => {
    ...
    const obj2 = {
      ...
      headerRight() {
        ...
        obj.onPress = closure_1_1(4841).pop;
        return closure_1_7(closure_1_0(7487).HeaderActionButton, obj);
      },
      headerTitle() {
        return closure_1_7(closure_1_0(5710).NavigatorHeader, { title: constants.START, subtitle: "I said come on fhqwhgads" });
      },
      render(arg0, arg1) {
        closure_0 = arg1;
        return closure_7(closure_13, {
          ...
          onSecondaryAction: closure_1(4841).pop,
    ...
    obj4.headerTitle = function headerTitle() {
      return closure_1_7(closure_1_0(5710).NavigatorHeader, { title: constants.WHO_DAT });
    };
    obj4.render = function render(arg0, arg1) {
      ...
      return closure_7(closure_13, {
        ...
        children: closure_7(closure_0(6714).TextInput, { placeholder: "My friend Jake" })
      });
    };
    ...
    obj7.headerTitle = function headerTitle() {
      return closure_1_7(closure_1_0(5710).NavigatorHeader, { title: constants.EVERYBODY });
    };
    ...
    obj10.headerTitle = function headerTitle() {
      return closure_1_7(closure_1_0(5710).NavigatorHeader, { title: constants.JOCKIN, subtitle: "Tryin' to play like, you know me" });
    };
    ...
    obj13.headerRight = function headerRight() {
      return closure_1_7(closure_1_0(5710).HeaderSubmittingIndicator, {});
    };
    obj13.headerTitle = function headerTitle() {
      return closure_1_7(closure_1_0(5710).NavigatorHeader, { title: constants.LIMIT });
    };
...
function DemoScreen(arg0) {
  ...
  if (tmp5) {
    ...
    obj.children = React5(tmp3(4634).Text, obj2);
  ...
  if (footer == null) {
    ...
    if (tmp8Result3) {
      ...
      tmp8Result3 = tmp8(tmp3(11147).ModalActionButton, obj6);
    }
    ...
    if (tmp8Result4) {
      ...
      tmp8Result4 = tmp8(tmp3(11147).ModalActionButton, obj7);
    }
    const obj8 = { children: null };
    items2[2] = tmp8Result4;
    obj8.children = items2;
    footer = tmp2(tmp3(12069).ModalFooter, obj8);
  }
  children1[1] = footer;
...
function SwitchesScreen(onAction) {
  ...
  obj.footer = closure_7(parts(11146).ModalFloatingAction, { isVisible: arr2.some((item) => item), floatingBackgroundColor: tmp.screen.backgroundColor, text: "Come on fhqwhgads", onPress: onAction.onAction });
  ...
  obj3.children = closure_7(parts(5773).TableRowGroup, {
    hasIcons: false,
  ...
  const items = [closure_7(closure_5, obj3), closure_7(parts(11146).ModalFloatingActionSpacer, {})];
  obj.children = items;
