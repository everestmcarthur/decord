...
// Dependencies: [32, 19, 17, 1074, 1229, 21, 15894, 5062, 15895, 8057, 7495, 10041, 14287, 8085, 14289, 9214, 14288, 9282, 4640, 576, 1484, 4607, 15896, 1897, 5060, 4636, 10801, 10031, 10037, 10039, 10038, 10036, 10035, 5521, 4350, 1092, 5074, 5695, 5212, 9067, 2]
// Exports: default

// Module 15893 (UserSettingsDesignSystemButton)
...
import useDesignSystemSettingsStateDefault from "useDesignSystemSettingsState" /* 15894 */;
import _modDef15895 from "module_15895" /* 15895 */;
...
function ExampleCustomIconToggleButton() {
  ...
  obj2.on = { variant: "destructive", accessibilityLabel: "Mute", icon: _modDef9282 };
  const obj3 = { variant: "destructive", accessibilityLabel: "Mute", icon: _modDef9282 };
  obj2.off = { variant: "secondary", accessibilityLabel: "Mute", icon: _modDef9282 };
...
export default function UserSettingsDesignSystemButton() {
  ...
  navigation.setOptions({
    headerRight() {
      return closure_2_10(IconButton.IconButton, { onPress, icon: _modDef7495, size: "sm", variant: "secondary", accessibilityLabel: "Settings" });
    }
  });
  ...
  obj25.icon = closure_10(require("components/Button/Button").Button.Icon, { source: _modDef10801 });
  ...
  const obj26 = { source: _modDef10801 };
  obj28.icon = closure_10(require("components/Button/Button").Button.Icon, { variant: "entity", source: _modDef10031 });
  ...
  const obj29 = { variant: "entity", source: _modDef10031 };
  ...
  obj59.children = closure_10(ExampleImageButton, { image: _modDef10037, label: "Telegram" });
  const items24 = [closure_10(closure_5, obj59), , ];
  const obj61 = { style: null, children: null };
  const items25 = [tmp.buttonContainer];
  obj61.style = items25;
  const obj60 = { image: _modDef10037, label: "Telegram" };
  obj61.children = closure_10(ExampleImageButton, { image: _modDef10039, label: "WhatsApp" });
  items24[1] = closure_10(closure_5, obj61);
  const obj63 = { style: null, children: null };
  const items26 = [tmp.buttonContainer];
  obj63.style = items26;
  const obj62 = { image: _modDef10039, label: "WhatsApp" };
  obj63.children = closure_10(ExampleImageButton, { image: _modDef10038, label: "Twitter" });
  ...
  const obj64 = { image: _modDef10038, label: "Twitter" };
  ...
  const items31 = [closure_10(ExampleImageButton, { image: _modDef10036, label: "Label", showLabel: true }), , ];
  const obj78 = { image: _modDef10036, label: "Label", showLabel: true };
  items31[1] = closure_10(ExampleImageButton, { image: _modDef10031, label: "Label", showLabel: true });
  const obj79 = { image: _modDef10031, label: "Label", showLabel: true };
  items31[2] = closure_10(ExampleImageButton, { image: _modDef10035, label: "Label", showLabel: true });
  ...
  const obj80 = { image: _modDef10035, label: "Label", showLabel: true };
  const items32 = [closure_10(ExampleImageButton, { image: _modDef10037, label: "Supercalifragilisticexpialidocious", showLabel: true }), , ];
  const obj83 = { image: _modDef10037, label: "Supercalifragilisticexpialidocious", showLabel: true };
  items32[1] = closure_10(ExampleImageButton, { image: _modDef10039, label: "Supercalifragilisticexpialidocious", showLabel: true });
  const obj84 = { image: _modDef10039, label: "Supercalifragilisticexpialidocious", showLabel: true };
  items32[2] = closure_10(ExampleImageButton, { image: _modDef10038, label: "Supercalifragilisticexpialidocious", showLabel: true });
  ...
  const obj85 = { image: _modDef10038, label: "Supercalifragilisticexpialidocious", showLabel: true };
