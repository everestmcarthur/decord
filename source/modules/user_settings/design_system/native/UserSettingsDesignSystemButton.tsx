...
// Dependencies: [32, 19, 17, 1074, 1230, 21, 15822, 5026, 15823, 8172, 7454, 9981, 14216, 8023, 14218, 9150, 14217, 9218, 4606, 576, 1483, 4573, 15824, 1896, 5024, 4602, 10741, 9971, 9977, 9979, 9978, 9976, 9975, 5484, 4317, 1091, 5038, 5658, 5176, 8999, 2]
// Exports: default
...
import _modDef9150 from "module_9150" /* 9150 */;
...
function ExampleCustomIconToggleButton() {
  ...
  obj2.on = { variant: "destructive", accessibilityLabel: "Mute", icon: _modDef9218 };
  const obj3 = { variant: "destructive", accessibilityLabel: "Mute", icon: _modDef9218 };
  obj2.off = { variant: "secondary", accessibilityLabel: "Mute", icon: _modDef9218 };
...
export default function UserSettingsDesignSystemButton() {
  ...
  navigation.setOptions({
    headerRight() {
      return closure_2_10(IconButton.IconButton, { onPress, icon: _modDef7454, size: "sm", variant: "secondary", accessibilityLabel: "Settings" });
    }
  });
  ...
  obj25.icon = closure_10(require("components/Button/Button").Button.Icon, { source: _modDef10741 });
  ...
  const obj26 = { source: _modDef10741 };
  obj28.icon = closure_10(require("components/Button/Button").Button.Icon, { variant: "entity", source: _modDef9971 });
  ...
  const obj29 = { variant: "entity", source: _modDef9971 };
  ...
  obj59.children = closure_10(ExampleImageButton, { image: _modDef9977, label: "Telegram" });
  const items24 = [closure_10(closure_5, obj59), , ];
  const obj61 = { style: null, children: null };
  const items25 = [tmp.buttonContainer];
  obj61.style = items25;
  const obj60 = { image: _modDef9977, label: "Telegram" };
  obj61.children = closure_10(ExampleImageButton, { image: _modDef9979, label: "WhatsApp" });
  items24[1] = closure_10(closure_5, obj61);
  const obj63 = { style: null, children: null };
  const items26 = [tmp.buttonContainer];
  obj63.style = items26;
  const obj62 = { image: _modDef9979, label: "WhatsApp" };
  obj63.children = closure_10(ExampleImageButton, { image: _modDef9978, label: "Twitter" });
  ...
  const obj64 = { image: _modDef9978, label: "Twitter" };
  ...
  const items31 = [closure_10(ExampleImageButton, { image: _modDef9976, label: "Label", showLabel: true }), , ];
  const obj78 = { image: _modDef9976, label: "Label", showLabel: true };
  items31[1] = closure_10(ExampleImageButton, { image: _modDef9971, label: "Label", showLabel: true });
  const obj79 = { image: _modDef9971, label: "Label", showLabel: true };
  items31[2] = closure_10(ExampleImageButton, { image: _modDef9975, label: "Label", showLabel: true });
  ...
  const obj80 = { image: _modDef9975, label: "Label", showLabel: true };
  const items32 = [closure_10(ExampleImageButton, { image: _modDef9977, label: "Supercalifragilisticexpialidocious", showLabel: true }), , ];
  const obj83 = { image: _modDef9977, label: "Supercalifragilisticexpialidocious", showLabel: true };
  items32[1] = closure_10(ExampleImageButton, { image: _modDef9979, label: "Supercalifragilisticexpialidocious", showLabel: true });
  const obj84 = { image: _modDef9979, label: "Supercalifragilisticexpialidocious", showLabel: true };
  items32[2] = closure_10(ExampleImageButton, { image: _modDef9978, label: "Supercalifragilisticexpialidocious", showLabel: true });
  ...
  const obj85 = { image: _modDef9978, label: "Supercalifragilisticexpialidocious", showLabel: true };
