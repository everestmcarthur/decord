...
// Dependencies: [19, 17, 21, 4638, 1177, 5670, 5058, 5693, 4634, 13174, 1400, 14293, 12761, 11153, 12762, 8954, 2]
// Exports: default

// Module 15917 (UserSettingsDesignSystemPile)
...
let items1 = [fn(5670).GuildIconSizes.XSMALL, fn(5670).GuildIconSizes.SMALL_32, fn(5670).GuildIconSizes.NORMAL, fn(5670).GuildIconSizes.LARGE, fn(5670).GuildIconSizes.XLARGE];
...
export default function UserSettingsDesignSystemPile() {
  ...
  items[0] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items = [closure_5(size(4634).Text, { variant: "text-md/medium", color: "text-subtle", children }), ];
      ...
      items[1] = closure_5(size(13174).AvatarPile, obj3);
      obj.children = items;
      return closure_6(size(5058).Stack, obj, children);
    })
  });
  let obj3 = {
    title: "Avatar Pile",
  ...
  items[2] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items[1] = closure_5(size(14293).AvatarDuoPile, obj3);
      obj.children = items;
      return closure_6(size(5058).Stack, obj, children);
    })
  });
  ...
  items[4] = hasOwnProperty(SampleCard, {
    ...
    children: items1.map((size) => {
      const obj = { children: null };
      items = [closure_5(size(4634).Text, { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() }), ];
      const obj2 = { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() };
      items[1] = closure_5(size(12761).GuildIconPile, { size, names: names2, totalCount: 128, children: names2.map((value, index) => closure_2_5(GuildIconDefault, { value, size }, index)) });
      obj.children = items;
      return closure_6(size(5058).Stack, obj, size);
    })
  });
  ...
  items1[1] = items2.map((item) => {
    ...
    obj3.children = names2.map((value, index) => {
      const obj = { value, size: closure_1_0(5670).GuildIconSizes.LARGE };
      return closure_1_5(closure_1_1(5670), obj, index);
    });
