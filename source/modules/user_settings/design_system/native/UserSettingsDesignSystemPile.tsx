...
// Dependencies: [19, 17, 21, 4640, 1177, 5672, 5060, 5695, 4636, 13182, 1400, 14301, 12769, 11161, 12770, 8970, 2]
// Exports: default

// Module 15934 (UserSettingsDesignSystemPile)
...
let items1 = [fn(5672).GuildIconSizes.XSMALL, fn(5672).GuildIconSizes.SMALL_32, fn(5672).GuildIconSizes.NORMAL, fn(5672).GuildIconSizes.LARGE, fn(5672).GuildIconSizes.XLARGE];
...
export default function UserSettingsDesignSystemPile() {
  ...
  items[0] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items = [closure_5(size(4636).Text, { variant: "text-md/medium", color: "text-subtle", children }), ];
      ...
      items[1] = closure_5(size(13182).AvatarPile, obj3);
      obj.children = items;
      return closure_6(size(5060).Stack, obj, children);
    })
  });
  let obj3 = {
    title: "Avatar Pile",
  ...
  items[2] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items[1] = closure_5(size(14301).AvatarDuoPile, obj3);
      obj.children = items;
      return closure_6(size(5060).Stack, obj, children);
    })
  });
  ...
  items[4] = hasOwnProperty(SampleCard, {
    ...
    children: items1.map((size) => {
      const obj = { children: null };
      items = [closure_5(size(4636).Text, { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() }), ];
      const obj2 = { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() };
      items[1] = closure_5(size(12769).GuildIconPile, { size, names: names2, totalCount: 128, children: names2.map((value, index) => closure_2_5(GuildIconDefault, { value, size }, index)) });
      obj.children = items;
      return closure_6(size(5060).Stack, obj, size);
    })
  });
  ...
  items1[1] = items2.map((item) => {
    ...
    obj3.children = names2.map((value, index) => {
      const obj = { value, size: closure_1_0(5672).GuildIconSizes.LARGE };
      return closure_1_5(closure_1_1(5672), obj, index);
    });
