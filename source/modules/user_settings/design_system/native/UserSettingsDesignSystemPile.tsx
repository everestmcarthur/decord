...
// Dependencies: [19, 17, 21, 4639, 1177, 5669, 5057, 5692, 4635, 13163, 1400, 14275, 12753, 11139, 12754, 8943, 2]
// Exports: default

// Module 15899 (UserSettingsDesignSystemPile)
...
import ListUtils from "ListUtils" /* 12754 */;
...
let items1 = [fn(5669).GuildIconSizes.XSMALL, fn(5669).GuildIconSizes.SMALL_32, fn(5669).GuildIconSizes.NORMAL, fn(5669).GuildIconSizes.LARGE, fn(5669).GuildIconSizes.XLARGE];
...
export default function UserSettingsDesignSystemPile() {
  ...
  items[0] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items = [closure_5(size(4635).Text, { variant: "text-md/medium", color: "text-subtle", children }), ];
      ...
      items[1] = closure_5(size(13163).AvatarPile, obj3);
      obj.children = items;
      return closure_6(size(5057).Stack, obj, children);
    })
  });
  let obj3 = {
    title: "Avatar Pile",
  ...
  items[2] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items[1] = closure_5(size(14275).AvatarDuoPile, obj3);
      obj.children = items;
      return closure_6(size(5057).Stack, obj, children);
    })
  });
  ...
  items[4] = hasOwnProperty(SampleCard, {
    ...
    children: items1.map((size) => {
      const obj = { children: null };
      items = [closure_5(size(4635).Text, { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() }), ];
      const obj2 = { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() };
      items[1] = closure_5(size(12753).GuildIconPile, { size, names: names2, totalCount: 128, children: names2.map((value, index) => closure_2_5(GuildIconDefault, { value, size }, index)) });
      obj.children = items;
      return closure_6(size(5057).Stack, obj, size);
    })
  });
  ...
  items1[1] = items2.map((item) => {
    ...
    obj3.children = names2.map((value, index) => {
      const obj = { value, size: closure_1_0(5669).GuildIconSizes.LARGE };
      return closure_1_5(closure_1_1(5669), obj, index);
    });
