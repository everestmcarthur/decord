...
// Dependencies: [19, 17, 21, 1177, 4634, 5060, 4638, 576, 5058, 8728, 2]
// Exports: default

// Module 15881 (UserSettingsDesignSystemLegacyButton)
...
function ComparisonRow(entry) {
  ...
  if (null != redesignVariant) {
    ...
    const items5 = [tmp9(tmp4(4634).Text, { variant: "text-xxs/medium", color: "text-muted", children: "mana" }), ];
    const obj7 = {
    ...
    items5[1] = tmp9(tmp4(5060).Button, obj7);
    obj6.children = items5;
    let tmp9Result = tmp7(tmp8, obj6);
  } else {
    const obj8 = { style: tmp.comparisonSide, children: tmp9(tmp4(4634).Text, { variant: "text-xs/medium", color: "text-muted", children: "no mapping" }) };
