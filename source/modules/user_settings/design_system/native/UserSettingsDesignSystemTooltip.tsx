...
// Dependencies: [32, 19, 17, 21, 4639, 8453, 11267, 5059, 7307, 4635, 7230, 7263, 2]
// Exports: default, useCanRotate

// Module 15889 (UserSettingsDesignSystemTooltip)
...
function Content() {
  ...
  const tooltip = first1(11267).useTooltip(ref, memo);
  const obj3 = { children: null };
  const obj4 = {
    style: tmp.container,
    children: closure_5(first1(5059).Button, {
      ref,
      onPress() {
        closure_1(!first1);
      },
  ...
  const items2 = [closure_5(View, obj4), closure_5(first1(7307).TableSwitchRow, { label: "Unlock Orientation", value: tmp9, onValueChange: tmp10 }), closure_5(first1(7307).TableSwitchRow, { label: "Enable Bottom Position", value: first2, onValueChange: tmp11[1] }), closure_5(TooltipNote, {})];
