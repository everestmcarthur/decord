...
// Dependencies: [19, 21, 15822, 1249, 7223, 7222, 8684, 2]
// Exports: default
...
export default function UserSettingsDesignSystemButtonActionSheet() {
  ...
  items1 = [
    closure_4(require("Form").FormSection, {
      ...
      children: items.map((label) => {
        ...
        items = [
          closure_4(closure_0(8684).FormRadioRow, {
            align: "right",
          ...
          closure_4(closure_0(8684).FormDivider, {})
        ];
        obj.children = items;
  ...
  items5[1] = items6.map((item) => {
    ...
    items = [closure_4(closure_0(8684).FormRadioRow, obj), closure_4(closure_0(8684).FormDivider, {})];
    obj2.children = items;
    let str2 = "disabled";
    if (true === item) {
      str2 = "enabled";
