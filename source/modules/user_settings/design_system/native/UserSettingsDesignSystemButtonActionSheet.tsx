...
// Dependencies: [19, 21, 15788, 1249, 7164, 7163, 8626, 2]
// Exports: default

// Module 15790 (UserSettingsDesignSystemButtonActionSheet)
  ...
  items1 = [
    closure_4(require("Form").FormSection, {
      ...
      children: items.map((label) => {
        ...
        items = [
          closure_4(closure_0(8626).FormRadioRow, {
            align: "right",
          ...
          closure_4(closure_0(8626).FormDivider, {})
        ];
        obj.children = items;
