...
// Dependencies: [32, 19, 17, 21, 4638, 5693, 5058, 4634, 5060, 4374, 5059, 5063, 5041, 5046, 2]
// Exports: default

// Module 15913 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  let obj = showBackdrop(4374);
  fn.__closure = { withSpring: showBackdrop(5059).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5063).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5058).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5046).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4634).Text, obj9);
    obj7.children = tmp13(tmp8(5693).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5041).Dialog, obj5);
  }
