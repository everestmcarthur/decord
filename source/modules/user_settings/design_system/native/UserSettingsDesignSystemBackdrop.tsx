...
// Dependencies: [32, 19, 17, 21, 4607, 5659, 5025, 4603, 5027, 4343, 5026, 5030, 5010, 5015, 2]
// Exports: default

// Module 15858 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  let obj = showBackdrop(4343);
  fn.__closure = { withSpring: showBackdrop(5026).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5030).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5025).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5015).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4603).Text, obj9);
    obj7.children = tmp13(tmp8(5659).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5010).Dialog, obj5);
  }
