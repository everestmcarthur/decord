...
// Dependencies: [32, 19, 17, 21, 4606, 5658, 5024, 4602, 5026, 4343, 5025, 5029, 5009, 5014, 2]
// Exports: default
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  fn.__closure = { withSpring: showBackdrop(5025).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5029).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5024).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5014).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4602).Text, obj9);
    obj7.children = tmp13(tmp8(5658).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5009).Dialog, obj5);
  }
