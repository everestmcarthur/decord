...
// Dependencies: [32, 19, 17, 21, 4640, 5695, 5060, 4636, 5062, 4376, 5061, 5065, 5043, 5048, 2]
// Exports: default

// Module 15930 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  fn.__closure = { withSpring: showBackdrop(5061).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5065).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5060).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5048).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4636).Text, obj9);
    obj7.children = tmp13(tmp8(5695).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5043).Dialog, obj5);
  }
