...
// Dependencies: [32, 19, 17, 21, 4639, 5692, 5057, 4635, 5059, 4376, 5058, 5062, 5042, 5047, 2]
// Exports: default

// Module 15895 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  let obj = showBackdrop(4376);
  fn.__closure = { withSpring: showBackdrop(5058).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5062).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5057).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5047).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4635).Text, obj9);
    obj7.children = tmp13(tmp8(5692).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5042).Dialog, obj5);
  }
