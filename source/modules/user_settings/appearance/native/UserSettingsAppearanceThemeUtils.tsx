...
// Dependencies: [1228, 1183, 1186, 1074, 1230, 1373, 1231, 1187, 15258, 12077, 9488, 1229, 4485, 15259, 1242, 2]
...
export const handleSaveTheme = function handleSaveTheme(mobileThemes, analyticsLocations, isSynced) {
  if (mobileThemes.type === ClientThemesTypes.ClientThemeType.CUSTOM_BACKGROUND_GRADIENT) {
    ...
    if ("system" === mobileThemes.theme) {
      const result = tmp(15258).resetBackgroundGradientPreset();
      const tmpResult = tmp(15258);
      tmp(12077).resetCustomTheme();
      const tmpResult13 = tmp(12077);
      ...
      const result1 = tmp(15258).resetBackgroundGradientPreset();
      const tmpResult16 = tmp(15258);
      tmp(12077).updateCustomTheme(mobileThemes.customThemeSettings, customThemeBaseTheme);
      const tmpResult17 = tmp(12077);
      ...
      if (mobileThemes.type === tmp(1231).ClientThemeType.BACKGROUND_GRADIENT_PRESET) {
        const result2 = tmp(15258).updateBackgroundGradientPreset(mobileThemes.id);
        const tmpResult19 = tmp(15258);
        tmp(12077).resetCustomTheme();
        const tmpResult20 = tmp(12077);
        ...
        const result3 = tmp(15258).resetBackgroundGradientPreset();
        const tmpResult22 = tmp(15258);
        tmp(12077).resetCustomTheme();
        const tmpResult23 = tmp(12077);
