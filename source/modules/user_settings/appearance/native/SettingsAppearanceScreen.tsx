...
// Dependencies: [19, 4459, 1183, 1182, 15359, 8082, 1074, 21, 1484, 1364, 7969, 1115, 10250, 1248, 3237, 2025, 5076, 15360, 563, 11606, 14786, 2]

// Module 15358 (SettingsAppearanceScreen)
...
export default noop.memo(() => {
  nativeStackNavigation(5076)(() => {
    if (SelectivelySyncedUserSettingsStore.shouldSync("appearance")) {
      const userCustomThemes = closure_0(15360).fetchUserCustomThemes();
      const obj = closure_0(15360);
    }
  });
  ...
  const effect = noop.useEffect(() => {
    if (obj.isAndroid()) {
      ...
      obj2.headerRight = tmp(7969).getRenderHeaderTextButton(intl.string(tmp(1115).t["R3BPH+"]), () => nativeStackNavigation(10250).setCustomFontScale(closure_1_0.fontScale, closure_1_0.isClassicChatFontScaleEnabled));
  ...
  return jsx(nativeStackNavigation(14786), { node }, "" + theme + "-" + gradientPresetId);
});
