...
// Dependencies: [19, 4457, 1183, 1182, 15375, 8091, 1074, 21, 1484, 1364, 7978, 1115, 10258, 1248, 3237, 2025, 5077, 15376, 563, 11614, 14802, 2]

// Module 15374 (SettingsAppearanceScreen)
...
export default noop.memo(() => {
  nativeStackNavigation(5077)(() => {
    if (SelectivelySyncedUserSettingsStore.shouldSync("appearance")) {
      const userCustomThemes = closure_0(15376).fetchUserCustomThemes();
      const obj = closure_0(15376);
    }
  });
  ...
  const effect = noop.useEffect(() => {
    if (obj.isAndroid()) {
      ...
      obj2.headerRight = tmp(7978).getRenderHeaderTextButton(intl.string(tmp(1115).t["R3BPH+"]), () => nativeStackNavigation(10258).setCustomFontScale(closure_1_0.fontScale, closure_1_0.isClassicChatFontScaleEnabled));
      nativeStackNavigation.setOptions(obj2);
      const tmpResult = tmp(7978);
    }
  }, items1);
  ...
  const node = noop.useMemo(() => {
    ...
    const obj = closure_0(11614);
    obj9.helpCenterLink = nativeStackNavigation(2025).getArticleURL(constants2.FAVORITES_GUILD);
    obj8.subLabel = intl3.format(nativeStackNavigation(3237).GR2KOG, obj9);
    items1[5] = obj8;
  ...
  return jsx(nativeStackNavigation(14802), { node }, "" + theme + "-" + gradientPresetId);
});
