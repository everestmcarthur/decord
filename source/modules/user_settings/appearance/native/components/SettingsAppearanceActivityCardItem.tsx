...
// Dependencies: [19, 17, 2026, 15505, 21, 4458, 1177, 4722, 576, 563, 9054, 5757, 4718, 1881, 15506, 15507, 15508, 2]
// Exports: default

// Module 15504 (SettingsAppearanceActivityCardItem)
  ...
  if (null != avatars) {
    mapped = substr.map((source, index) => {
      ...
      if (index !== diff) {
        ...
        const point = { shape: tmp3(9054).CutoutShape.Circle, x: tmp3(1177).AVATAR_SIZE_MAP[tmp3(undefined, 1177).AvatarSizes.XSMALL_20] - 4 - 2, y: -2, size: tmp3(1177).AVATAR_SIZE_MAP[tmp3(undefined, 1177).AvatarSizes.XSMALL_20] + 4 };
        const items = [point];
        obj3.cutouts = items;
        obj3.children = tmp5;
