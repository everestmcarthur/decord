...
// Dependencies: [19, 17, 2026, 15390, 21, 4376, 1177, 4639, 576, 563, 8943, 5672, 4635, 1881, 15391, 15392, 15393, 2]
// Exports: default

// Module 15389 (SettingsAppearanceActivityCardItem)
  ...
  if (null != avatars) {
    mapped = substr.map((source, index) => {
      ...
      if (index !== diff) {
        ...
        const point = { shape: tmp3(8943).CutoutShape.Circle, x: tmp3(1177).AVATAR_SIZE_MAP[tmp3(undefined, 1177).AvatarSizes.XSMALL_20] - 4 - 2, y: -2, size: tmp3(1177).AVATAR_SIZE_MAP[tmp3(undefined, 1177).AvatarSizes.XSMALL_20] + 4 };
        const items = [point];
        obj3.cutouts = items;
        obj3.children = tmp5;
