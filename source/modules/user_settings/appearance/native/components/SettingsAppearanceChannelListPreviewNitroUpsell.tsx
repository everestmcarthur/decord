...
// Dependencies: [19, 17, 4599, 1074, 21, 4343, 5039, 5026, 5030, 4607, 576, 7236, 7256, 9485, 9455, 5027, 1114, 1178, 504, 10061, 2]
...
function SettingsAppearanceChannelListPreviewNitroUpsellComponent(theme) {
  ...
  let obj = theme(4343);
  fn.__closure = { theme, ThemeTypes, StyleSheet, withSpring: theme(5026).withSpring, springStandard: theme(5030).springStandard };
  fn.__workletHash = 16911565077998;
  fn.__initData = __initData2;
  const animatedStyle = obj.useAnimatedStyle(fn);
  const obj2 = { theme, ThemeTypes, StyleSheet, withSpring: theme(5026).withSpring, springStandard: theme(5030).springStandard };
  analyticsLocations = analyticsLocations(7236)(analyticsLocations(7256).CLIENT_THEMES_EDITOR).analyticsLocations;
  ...
  items1[1] = closure_10(theme(5027).Button, obj5);
...
animationEntering.__closure = { withSpring: fn(5026).withSpring, springStandard: fn(5030).springStandard };
...
let obj = { withSpring: fn(5026).withSpring, springStandard: fn(5030).springStandard };
animationExiting.__closure = { withSpring: fn(5026).withSpring, springStandard: fn(5030).springStandard };
...
let obj2 = { withSpring: fn(5026).withSpring, springStandard: fn(5030).springStandard };
size = fn(2);
