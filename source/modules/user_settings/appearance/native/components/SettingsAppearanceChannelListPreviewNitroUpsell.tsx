...
// Dependencies: [19, 17, 4714, 1074, 21, 4458, 5156, 5143, 5147, 4722, 576, 7358, 7378, 9630, 9600, 5144, 1115, 1177, 504, 10213, 2]

// Module 15512 (SettingsAppearanceChannelListPreviewNitroUpsell)
...
function SettingsAppearanceChannelListPreviewNitroUpsellComponent(theme) {
  ...
  let obj = theme(4458);
  fn.__closure = { theme, ThemeTypes, StyleSheet, withSpring: theme(5143).withSpring, springStandard: theme(5147).springStandard };
  fn.__workletHash = 16911565077998;
  fn.__initData = __initData2;
  const animatedStyle = obj.useAnimatedStyle(fn);
  const obj2 = { theme, ThemeTypes, StyleSheet, withSpring: theme(5143).withSpring, springStandard: theme(5147).springStandard };
  analyticsLocations = analyticsLocations(7358)(analyticsLocations(7378).CLIENT_THEMES_EDITOR).analyticsLocations;
  ...
  items1[1] = closure_10(theme(5144).Button, obj5);
...
animationEntering.__closure = { withSpring: fn(5143).withSpring, springStandard: fn(5147).springStandard };
...
let obj = { withSpring: fn(5143).withSpring, springStandard: fn(5147).springStandard };
animationExiting.__closure = { withSpring: fn(5143).withSpring, springStandard: fn(5147).springStandard };
...
let obj2 = { withSpring: fn(5143).withSpring, springStandard: fn(5147).springStandard };
size = fn(2);
