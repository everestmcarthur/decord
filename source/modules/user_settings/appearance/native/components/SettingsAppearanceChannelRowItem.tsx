...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 1177, 11046, 4635, 2]
// Exports: default

// Module 15386 (SettingsAppearanceChannelRowItem)
import nativeDefault from "native" /* 576 */;
import native2 from "native" /* 1177 */;
import GroupDMAvatar from "GroupDMAvatar" /* 11046 */;
...
export default function ChannelRowItem(isUnread) {
  ...
  const items3 = [React4(tmp6(4635).Text, { animated: true, style: flag ? animatedStyles.textNormal : animatedStyles.textMuted, variant: "redesign/channel-title/semibold", children: title }), React4(tmp6(4635).Text, { animated: true, style: animatedStyles.textMuted, variant: "text-xs/medium", children: timestamp })];
  ...
  if (null == preview) {
    ...
    tmp5(tmp6(4635).Text, animatedStyles);
