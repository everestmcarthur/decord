...
// Dependencies: [19, 17, 1074, 21, 4574, 576, 1178, 10942, 4570, 2]
// Exports: default

// Module 15322 (SettingsAppearanceChannelRowItem)
import nativeDefault from "native" /* 576 */;
import native2 from "native" /* 1178 */;
import GroupDMAvatar from "GroupDMAvatar" /* 10942 */;
...
export default function ChannelRowItem(isUnread) {
  ...
  const items3 = [React4(tmp6(4570).Text, { animated: true, style: flag ? animatedStyles.textNormal : animatedStyles.textMuted, variant: "redesign/channel-title/semibold", children: title }), React4(tmp6(4570).Text, { animated: true, style: animatedStyles.textMuted, variant: "text-xs/medium", children: timestamp })];
  ...
  if (null == preview) {
    ...
    tmp5(tmp6(4570).Text, animatedStyles);
