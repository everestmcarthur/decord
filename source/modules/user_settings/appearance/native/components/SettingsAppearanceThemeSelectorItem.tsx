...
// Dependencies: [19, 17, 1182, 15389, 1085, 21, 4640, 576, 4490, 4348, 5212, 1177, 15391, 563, 4341, 15392, 1230, 4358, 5210, 1115, 2]
// Exports: default

// Module 15390 (SettingsAppearanceThemeSelectorItem)
...
import ThemedGradient from "ThemedGradient" /* 5212 */;
import noop from "module_19" /* 19 */;
import ThemeStore from "ThemeStore" /* 1182 */;
import SettingsAppearanceConstants from "SettingsAppearanceConstants" /* 15389 */;

const ThemedGradientDefault = ThemedGradient;

const native = tmp(1177);
const _modDef15391 = tmp8(15391);
const SynchronizeIconNativeDefault = tmp5(15392);
require = fn;
function GradientThemeBackground(arg0) {
  ...
  if (isThemeLocked) {
    const obj6 = { source: _modDef15391, style: tmp4.lock };
