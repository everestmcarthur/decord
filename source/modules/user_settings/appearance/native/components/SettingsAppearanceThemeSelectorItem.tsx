...
// Dependencies: [19, 17, 1182, 15384, 1085, 21, 4638, 576, 4488, 4346, 5210, 1177, 15386, 563, 4339, 15387, 1230, 4356, 5208, 1115, 2]
// Exports: default

// Module 15385 (SettingsAppearanceThemeSelectorItem)
...
import ThemedGradient from "ThemedGradient" /* 5210 */;
import noop from "module_19" /* 19 */;
import ThemeStore from "ThemeStore" /* 1182 */;
import SettingsAppearanceConstants from "SettingsAppearanceConstants" /* 15384 */;

const ThemedGradientDefault = ThemedGradient;

const native = tmp(1177);
const _modDef15386 = tmp8(15386);
const SynchronizeIconNativeDefault = tmp5(15387);
require = fn;
function GradientThemeBackground(arg0) {
  ...
  if (isThemeLocked) {
    const obj6 = { source: _modDef15386, style: tmp4.lock };
