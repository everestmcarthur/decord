...
// Dependencies: [19, 8548, 21, 8800, 14808, 2397, 7700, 4653, 2]
// Exports: default

// Module 14939 (FamilyCenterSettingsNotice)
...
export default function FamilyCenterSettingsParentalControlsNotice() {
  activeLinkUserIds = activeLinkUserIds(8800).useActiveLinkUserIds();
