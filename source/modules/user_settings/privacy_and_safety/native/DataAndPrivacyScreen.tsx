...
// Dependencies: [19, 6595, 7975, 1074, 21, 1114, 2024, 9155, 1483, 14858, 14861, 11473, 14818, 14692, 2]
// Exports: default

// Module 15868 (DataAndPrivacySettings)
...
export default function DataAndPrivacySettings() {
  ...
  obj[1] = intl.format(stackNavigation(1114).t["igTSG/"], obj);
  items1 = [obj, , , ];
  ...
  obj1[1] = intl2.format(stackNavigation(1114).t["eQL/Mr"], obj2);
  items1[1] = obj1;
  ...
  obj3[1] = intl3.format(stackNavigation(1114).t.cf9mvV, obj4);
  items1[2] = obj3;
  ...
  obj5[1] = intl4.format(stackNavigation(1114).t["2QFDU/"], obj6);
  items1[3] = obj5;
  const obj7 = { label: null, settings: null, subLabel: null };
  const intl5 = stackNavigation(1114).intl;
  obj7[0] = intl5.string(stackNavigation(1114).t.BG7QsQ);
  ...
  obj12[0] = stackNavigation(14818).SettingsScreen.DATA_AND_PRIVACY;
  const items9 = [callback(items1(14818), obj12), callback(items1(14692), { node: memo })];
  obj11[0] = items9;
