...
// Dependencies: [19, 17, 1074, 21, 1186, 2071, 1936, 7310, 1115, 4638, 576, 5773, 2025, 2]
// Exports: default

// Module 15988 (ManageSponsoredContentScreen)
...
function AdTopicRow(adTopic) {
  ...
  return closure_5(adTopic(7310).TableSwitchRow, obj);
}
