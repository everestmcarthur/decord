...
// Dependencies: [19, 17, 1372, 21, 4722, 576, 7788, 15033, 15034, 5593, 5594, 4935, 15035, 15036, 2]
// Exports: default

// Module 15032 (SettingsScreenNotices)
...
import FamilyCenterSettingsNoticeDefault from "FamilyCenterSettingsNotice" /* 15033 */;
import AgeConfirmationNoticeDefault from "AgeConfirmationNotice" /* 15035 */;
...
let items = [{ order: 100, predicate: fn(7788).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault }, , , ];
const obj6 = { order: 100, predicate: fn(7788).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault };
items[1] = { order: 150, predicate: fn(15034).shouldShowTinyBroncoUnconfirmedNotice, Component: fn(15034).ContentFiltersUnconfirmedNotice };
const obj7 = { order: 150, predicate: fn(15034).shouldShowTinyBroncoUnconfirmedNotice, Component: fn(15034).ContentFiltersUnconfirmedNotice };
items[2] = {
  order: 200,
  predicate() {
...
items[3] = {
  ...
  Component: fn(15036).SensitiveContentFiltersTeenNotice
};
...
const items1 = [{ order: 100, predicate: fn(7788).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault }, ];
const obj10 = { order: 100, predicate: fn(7788).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault };
items1[1] = {
  order: 200,
  predicate() {
    let isFeatureAgeGatedResult = RegionalFeatureConfigUtils.isFeatureAgeGated(AgeGatedFeature.AgeGatedFeature.REACTIVE_CHECK);
...
const items2 = [{ order: 100, predicate: fn(7788).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault }];
