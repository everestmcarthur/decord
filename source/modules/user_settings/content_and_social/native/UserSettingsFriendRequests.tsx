...
// Dependencies: [19, 17, 1074, 21, 1936, 7102, 5772, 1115, 7307, 1385, 2]
// Exports: default

// Module 16928 (UserSettingsFriendRequests)
...
export default function UserSettingsFriendRequests() {
  ...
  const items1 = [closure_7(setting(7307).TableSwitchRow, obj3), , ];
  ...
  items1[1] = closure_7(setting(7307).TableSwitchRow, obj4);
  ...
  items1[2] = closure_7(setting(7307).TableSwitchRow, obj5);
  obj2.children = items1;
  obj.children = closure_8(setting(5772).TableRowGroup, obj2);
