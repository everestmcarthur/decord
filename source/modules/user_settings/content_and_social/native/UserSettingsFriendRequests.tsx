...
// Dependencies: [19, 17, 1074, 21, 1935, 7047, 5737, 1114, 7252, 1384, 2]
// Exports: default

// Module 16873 (UserSettingsFriendRequests)
...
export default function UserSettingsFriendRequests() {
  ...
  const items1 = [closure_7(setting(7252).TableSwitchRow, obj3), , ];
  ...
  items1[1] = closure_7(setting(7252).TableSwitchRow, obj4);
  ...
  items1[2] = closure_7(setting(7252).TableSwitchRow, obj5);
  obj2.children = items1;
  obj.children = closure_8(setting(5737).TableRowGroup, obj2);
