...
// Dependencies: [19, 17, 1074, 21, 1936, 7105, 5773, 1115, 7310, 1385, 2]
// Exports: default

// Module 16985 (UserSettingsFriendRequests)
...
export default function UserSettingsFriendRequests() {
  ...
  const items1 = [closure_7(setting(7310).TableSwitchRow, obj3), , ];
  ...
  items1[1] = closure_7(setting(7310).TableSwitchRow, obj4);
  ...
  items1[2] = closure_7(setting(7310).TableSwitchRow, obj5);
  obj2.children = items1;
  obj.children = closure_8(setting(5773).TableRowGroup, obj2);
