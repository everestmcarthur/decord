...
// Dependencies: [19, 17, 1074, 21, 1936, 7109, 5775, 1115, 7314, 1385, 2]
// Exports: default

// Module 17024 (UserSettingsFriendRequests)
...
export default function UserSettingsFriendRequests() {
  let FriendSourceFlagsSetting = setting(1936).FriendSourceFlagsSetting;
  ...
  const items1 = [closure_7(setting(7314).TableSwitchRow, obj3), , ];
  ...
  items1[1] = closure_7(setting(7314).TableSwitchRow, obj4);
  ...
  items1[2] = closure_7(setting(7314).TableSwitchRow, obj5);
  obj2.children = items1;
  obj.children = closure_8(setting(5775).TableRowGroup, obj2);
