...
function IgnoredUserRow(userRecord) {
  ...
  return jsx(userRecord(5686).TableRow, { icon: jsx(userRecord(1178).Avatar, { source: userRecord.getAvatarSource(undefined), size: userRecord(1178).AvatarSizes.REFRESH_MEDIUM_32 }), label: null, subLabel: null, labelLineClamp: 1, subLabelLineClamp: 1, accessibilityRole: "button", accessibilityActions: null, onAccessibilityAction: null, onPress: null, trailing: null });
}
const jsx = fn(21).jsx;
const size = fn(2);
