...
// Dependencies: [32, 19, 17, 1371, 1074, 21, 4605, 5574, 576, 14749, 504, 15027, 5023, 5737, 1114, 5655, 7175, 4601, 1369, 5173, 1178, 7044, 1483, 12334, 7042, 15028, 8948, 10134, 7010, 15029, 2]
// Exports: default

// Module 15026 (UserSettingsSessions)
...
import AuthSessionsActionCreators from "AuthSessionsActionCreators" /* 15027 */;
...
const _modDef7044 = tmp10(7044);
require = fn;
function UserSettingsSessions() {
  const tmp = closure_13();
  let authSessions = otherSessions(14749).useAuthSessions();
  ({ currentSession, otherSessions } = authSessions);
  const obj = otherSessions(14749);
  ...
  if (null == currentSession) {
    ...
    const items1 = [closure_10(tmp2(5737).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      ...
      let tmp20Result = tmp20(tmp2(5737).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result2 = tmp21(tmp2(5655).TableRow, obj8);
    }
    items1[2] = tmp21Result2;
    obj4.children = items1;
    tmp20Result2 = tmp20(tmp2(5023).Stack, obj4);
  }
  ...
  const items3 = [closure_10(otherSessions(4601).Text, obj11), tmp20Result2];
  obj10.children = items3;
  obj9.children = closure_11(otherSessions(7175).SafeAreaPaddingView, obj10);
...
function SessionInfo(session) {
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
        ...
        if ("ios" !== trimmed) {
          if ("android" !== trimmed) {
            if ("horizon os" === trimmed) {
              const obj2 = { text: os, iconSource: _modDef10134, IconComponent: session(15029).VrHeadsetIcon };
              let tmp9 = session;
              let obj = obj2;
            } else {
              obj = { text: os, iconSource: _modDef15028, IconComponent: session(8948).ScreenIcon };
              tmp9 = session;
            }
          }
        }
        const obj3 = { text: os, iconSource: _modDef10134, IconComponent: session(7010).MobilePhoneIcon };
        tmp9 = session;
        obj = obj3;
      }
      ...
      if (!current) {
        formatDateResult = tmp9(14749).formatDate(session.approx_last_used_time);
        const tmp9Result = tmp9(14749);
      }
      ...
      if (!current) {
        ...
        const obj5 = { style: tmp.logoutButton, source: _modDef7044 };
        obj4.children = closure_10(tmp9(1178).Icon, obj5);
        tmp18 = closure_10(tmp9(5173).PressableOpacity, obj4);
      }
      ...
      const items1 = [closure_10(tmp9(4601).Text, obj8), ];
      ...
      if (tmp22Result) {
        ...
        const items2 = [tmp20(tmp9(4601).Text, obj10), ];
        const obj11 = { variant: "text-md/semibold", children: found[1] };
        items2[1] = tmp20(tmp9(4601).Text, obj11);
      ...
      obj12.icon = closure_10(tmp9(5655).TableRow.Icon, obj13);
      ...
      if (tmp20Result3) {
        ...
        obj14.children = tmp20(tmp9(4601).Text, obj15);
      ...
      if (tmp20Result4) {
        ...
        obj16.children = tmp20(tmp9(4601).Text, obj17);
      ...
      return closure_10(tmp9(5655).TableRow, obj12);
    }
  }
  ...
  obj19.iconSource = _modDef15028;
  obj19.IconComponent = session(8948).ScreenIcon;
  tmp9 = session;
  obj = obj19;
}
function UnknownLegacySessionsInfo() {
  ...
  obj2.icon = closure_10(require("TableRow").TableRow.Icon, { variant: "translucent", source: _modDef12334 });
