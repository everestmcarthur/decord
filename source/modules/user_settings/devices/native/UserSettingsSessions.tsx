...
function UserSettingsSessions() {
  ...
  if (null == currentSession) {
    ...
    const items1 = [closure_10(tmp2(5768).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      ...
      let tmp20Result = tmp20(tmp2(5768).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result2 = tmp21(tmp2(5686).TableRow, obj8);
    }
    items1[2] = tmp21Result2;
    obj4.children = items1;
    tmp20Result2 = tmp20(tmp2(5054).Stack, obj4);
  }
  ...
  const items3 = [closure_10(otherSessions(4632).Text, obj11), tmp20Result2];
  obj10.children = items3;
  obj9.children = closure_11(otherSessions(7226).SafeAreaPaddingView, obj10);
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
      if ("" !== trimmed) {
        ...
        const obj3 = { text: os, iconSource: _modDef10193, IconComponent: session(7061).MobilePhoneIcon };
        tmp9 = session;
        obj = obj3;
      }
      ...
      const items1 = [closure_10(tmp9(4632).Text, obj8), ];
      ...
      if (tmp22Result) {
        ...
        const items2 = [tmp20(tmp9(4632).Text, obj10), ];
        const obj11 = { variant: "text-md/semibold", children: found[1] };
        items2[1] = tmp20(tmp9(4632).Text, obj11);
      ...
      obj12.icon = closure_10(tmp9(5686).TableRow.Icon, obj13);
      ...
      if (tmp20Result3) {
        ...
        obj14.children = tmp20(tmp9(4632).Text, obj15);
      ...
      if (tmp20Result4) {
        ...
        obj16.children = tmp20(tmp9(4632).Text, obj17);
      ...
      return closure_10(tmp9(5686).TableRow, obj12);
    }
  }
