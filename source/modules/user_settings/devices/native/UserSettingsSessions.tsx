...
// Dependencies: [32, 19, 17, 1372, 1074, 21, 4640, 5612, 576, 14792, 504, 15073, 5060, 5775, 1115, 5693, 7237, 4636, 1370, 5210, 1177, 7106, 1484, 12415, 7104, 15074, 9037, 10214, 7072, 15075, 2]
// Exports: default

// Module 15072 (UserSettingsSessions)
import nativeDefault from "native" /* 576 */;
import UserSettingsModalActionCreatorsDefault from "UserSettingsModalActionCreators" /* 7104 */;
import _modDef10214 from "module_10214" /* 10214 */;
import _modDef12415 from "module_12415" /* 12415 */;
import AuthSessionsActionCreators from "AuthSessionsActionCreators" /* 15073 */;
...
const _modDef7106 = tmp10(7106);
require = fn;
function UserSettingsSessions() {
  const tmp = closure_13();
  let authSessions = otherSessions(14792).useAuthSessions();
  ({ currentSession, otherSessions } = authSessions);
  const obj = otherSessions(14792);
  ...
  if (null == currentSession) {
    ...
    const items1 = [closure_10(tmp2(5775).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      ...
      let tmp20Result = tmp20(tmp2(5775).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result2 = tmp21(tmp2(5693).TableRow, obj8);
    }
    items1[2] = tmp21Result2;
    obj4.children = items1;
    tmp20Result2 = tmp20(tmp2(5060).Stack, obj4);
  }
  ...
  const items3 = [closure_10(otherSessions(4636).Text, obj11), tmp20Result2];
  obj10.children = items3;
  obj9.children = closure_11(otherSessions(7237).SafeAreaPaddingView, obj10);
...
function SessionInfo(session) {
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
        ...
        if ("ios" !== trimmed) {
          if ("android" !== trimmed) {
            if ("horizon os" === trimmed) {
              const obj2 = { text: os, iconSource: _modDef10214, IconComponent: session(15075).VrHeadsetIcon };
              let tmp9 = session;
              let obj = obj2;
            } else {
              obj = { text: os, iconSource: _modDef15074, IconComponent: session(9037).ScreenIcon };
              tmp9 = session;
            }
          }
        }
        const obj3 = { text: os, iconSource: _modDef10214, IconComponent: session(7072).MobilePhoneIcon };
        tmp9 = session;
        obj = obj3;
      }
      ...
      if (!current) {
        formatDateResult = tmp9(14792).formatDate(session.approx_last_used_time);
        const tmp9Result = tmp9(14792);
      }
      ...
      if (!current) {
        ...
        const obj5 = { style: tmp.logoutButton, source: _modDef7106 };
        obj4.children = closure_10(tmp9(1177).Icon, obj5);
        tmp18 = closure_10(tmp9(5210).PressableOpacity, obj4);
      }
      ...
      const items1 = [closure_10(tmp9(4636).Text, obj8), ];
      ...
      if (tmp22Result) {
        ...
        const items2 = [tmp20(tmp9(4636).Text, obj10), ];
        const obj11 = { variant: "text-md/semibold", children: found[1] };
        items2[1] = tmp20(tmp9(4636).Text, obj11);
      ...
      obj12.icon = closure_10(tmp9(5693).TableRow.Icon, obj13);
      ...
      if (tmp20Result3) {
        ...
        obj14.children = tmp20(tmp9(4636).Text, obj15);
      ...
      if (tmp20Result4) {
        ...
        obj16.children = tmp20(tmp9(4636).Text, obj17);
      ...
      return closure_10(tmp9(5693).TableRow, obj12);
    }
  }
  ...
  obj19.iconSource = _modDef15074;
  obj19.IconComponent = session(9037).ScreenIcon;
  tmp9 = session;
  obj = obj19;
}
function UnknownLegacySessionsInfo() {
  ...
  obj2.icon = closure_10(require("TableRow").TableRow.Icon, { variant: "translucent", source: _modDef12415 });
