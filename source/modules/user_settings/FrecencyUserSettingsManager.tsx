...
// Dependencies: [5, 9446, 9445, 5547, 5100, 5589, 5597, 1220, 1084, 1349, 1091, 7232, 1941, 1221, 1222, 12, 2]

// Module 17617 (FrecencyUserSettingsManager)
...
const MAX_NUM_SELECTED_ITEMS = fn(5597).MAX_NUM_SELECTED_ITEMS;
