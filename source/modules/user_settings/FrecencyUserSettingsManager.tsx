...
// Dependencies: [5, 9382, 9381, 5510, 5063, 5552, 5560, 1221, 1084, 1350, 1090, 7191, 1940, 1222, 1223, 12, 2]

// Module 17450 (FrecencyUserSettingsManager)
...
const MAX_NUM_SELECTED_ITEMS = fn(5560).MAX_NUM_SELECTED_ITEMS;
