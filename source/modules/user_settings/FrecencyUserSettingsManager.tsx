...
// Dependencies: [5, 9384, 9383, 5511, 5064, 5553, 5561, 1221, 1084, 1350, 1090, 7192, 1940, 1222, 1223, 12, 2]

// Module 17451 (FrecencyUserSettingsManager)
...
const MAX_NUM_SELECTED_ITEMS = fn(5561).MAX_NUM_SELECTED_ITEMS;
