...
// Dependencies: [19, 17, 1074, 21, 4638, 576, 4572, 9395, 15076, 15077, 1397, 4489, 5693, 1177, 4605, 15073, 1897, 4634, 7613, 1612, 5058, 1115, 2]
// Exports: default

// Module 15075 (ConnectionsEmptyStateUpsell)
...
import ConnectionsTracking from "ConnectionsTracking" /* 15076 */;
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = closure_8();
  emptyStatePlatforms = emptyStatePlatforms(7613).useEmptyStatePlatforms();
  ...
  const obj = emptyStatePlatforms(7613);
  ...
  const items3 = [closure_6(emptyStatePlatforms(5058).Stack, { spacing: 16, justify: "center", direction: "horizontal", children: memo.map((platform) => closure_1_6(EmptyStateCard, { platform }, platform.type)) }), ];
  ...
  items3[1] = closure_7(emptyStatePlatforms(5058).Stack, obj7);
  obj5.children = items3;
  const items5 = [closure_7(emptyStatePlatforms(5058).Stack, obj5), ];
  ...
  const items6 = [closure_6(emptyStatePlatforms(4634).Text, obj10), ];
  ...
  items6[1] = closure_6(emptyStatePlatforms(4634).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(emptyStatePlatforms(5058).Stack, obj9);
