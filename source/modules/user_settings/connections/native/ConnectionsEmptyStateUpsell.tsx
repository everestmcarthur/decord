...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 4574, 9406, 15084, 15085, 1397, 4491, 5695, 1177, 4607, 15081, 1897, 4636, 7617, 1612, 5060, 1115, 2]
// Exports: default

// Module 15083 (ConnectionsEmptyStateUpsell)
...
import ConnectionsTracking from "ConnectionsTracking" /* 15084 */;
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = closure_8();
  emptyStatePlatforms = emptyStatePlatforms(7617).useEmptyStatePlatforms();
  ...
  const obj = emptyStatePlatforms(7617);
  ...
  const items3 = [closure_6(emptyStatePlatforms(5060).Stack, { spacing: 16, justify: "center", direction: "horizontal", children: memo.map((platform) => closure_1_6(EmptyStateCard, { platform }, platform.type)) }), ];
  ...
  items3[1] = closure_7(emptyStatePlatforms(5060).Stack, obj7);
  obj5.children = items3;
  const items5 = [closure_7(emptyStatePlatforms(5060).Stack, obj5), ];
  ...
  const items6 = [closure_6(emptyStatePlatforms(4636).Text, obj10), ];
  ...
  items6[1] = closure_6(emptyStatePlatforms(4636).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(emptyStatePlatforms(5060).Stack, obj9);
