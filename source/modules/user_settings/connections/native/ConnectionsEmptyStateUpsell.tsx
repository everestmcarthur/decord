...
// Dependencies: [19, 17, 1074, 21, 4722, 576, 4656, 9490, 15178, 15179, 1397, 4573, 5777, 1177, 4689, 15175, 1897, 4718, 7699, 1612, 5142, 1115, 2]
// Exports: default

// Module 15177 (ConnectionsEmptyStateUpsell)
...
import ConnectionsTracking from "ConnectionsTracking" /* 15178 */;
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = closure_8();
  emptyStatePlatforms = emptyStatePlatforms(7699).useEmptyStatePlatforms();
  ...
  const obj = emptyStatePlatforms(7699);
  ...
  const items3 = [closure_6(emptyStatePlatforms(5142).Stack, { spacing: 16, justify: "center", direction: "horizontal", children: memo.map((platform) => closure_1_6(EmptyStateCard, { platform }, platform.type)) }), ];
  ...
  items3[1] = closure_7(emptyStatePlatforms(5142).Stack, obj7);
  obj5.children = items3;
  const items5 = [closure_7(emptyStatePlatforms(5142).Stack, obj5), ];
  ...
  const items6 = [closure_6(emptyStatePlatforms(4718).Text, obj10), ];
  ...
  items6[1] = closure_6(emptyStatePlatforms(4718).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(emptyStatePlatforms(5142).Stack, obj9);
