...
// Dependencies: [19, 17, 1074, 21, 4606, 576, 4541, 9342, 15015, 15016, 1396, 4458, 5658, 1178, 4573, 15012, 1896, 4602, 7576, 1611, 5024, 1114, 2]
// Exports: default
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = closure_8();
  emptyStatePlatforms = emptyStatePlatforms(7576).useEmptyStatePlatforms();
  ...
  const obj = emptyStatePlatforms(7576);
  ...
  items3[1] = closure_7(emptyStatePlatforms(5024).Stack, obj7);
  obj5.children = items3;
  const items5 = [closure_7(emptyStatePlatforms(5024).Stack, obj5), ];
  ...
  const items6 = [closure_6(emptyStatePlatforms(4602).Text, obj10), ];
  ...
  items6[1] = closure_6(emptyStatePlatforms(4602).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(emptyStatePlatforms(5024).Stack, obj9);
