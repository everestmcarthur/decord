...
// Dependencies: [19, 17, 1074, 1955, 21, 4640, 576, 5612, 1177, 10774, 4636, 5062, 1115, 2]
// Exports: OneWayToTwoWayLinkUpsell

// Module 15090 (OneWayToTwoWayLinkUpsell)
...
export const OneWayToTwoWayLinkUpsell = function OneWayToTwoWayLinkUpsell(newIndicatorDismissibleContent) {
  ...
  const items1 = [closure_6(SelectedDismissibleContentDefault, obj4), closure_6(newIndicatorDismissibleContent(4636).Text, { style: tmp.title, variant: "text-md/semibold", children: title })];
  obj3.children = items1;
  const items2 = [closure_7(View, obj3), img];
  obj2.children = items2;
  const items3 = [closure_7(View, obj2), closure_6(newIndicatorDismissibleContent(4636).Text, { style: tmp.body, variant: "text-sm/medium", children: body }), ];
  ...
  obj7.children = closure_6(newIndicatorDismissibleContent(5062).Button, obj8);
