...
// Function ID: 9373
// Name: XboxLinkModal
// Dependencies: [19, 9373, 1074, 21, 7491, 7106, 9371, 1115, 9374, 9381, 9382, 9386, 9594, 9599, 9600, 9380, 9423, 7114, 2]
// Exports: default

// Module 9372 (XboxLinkModal)
...
import XboxLinkEducationDefault from "XboxLinkEducation" /* 9599 */;
import XboxLinkErrorDefault from "XboxLinkError" /* 9600 */;
...
const XboxLinkModalScenes = fn(9373).XboxLinkModalScenes;
...
export default function XboxLinkModal(locationStack) {
  ...
  const memo = noop.useMemo(() => {
    function onClose() {
      return closure_1_1(9371).hideModal();
    }
    function blank() {
      return null;
    }
    return {
      [closure_2_4.LANDING]: {
        ...
        render() {
          return closure_1_6(closure_1_1(9374), {});
        }
      },
      [closure_2_4.PRE_CONNECT]: {
        ...
        render() {
          return closure_1_6(closure_1_1(9382), {});
        }
      },
      [closure_2_4.DISCORD_CONSENT]: {
        ...
        render(arg0) {
          ...
          return closure_1_6(closure_1_1(9386), { callbackCode, callbackState });
        }
      },
      [closure_2_4.SUCCESS]: {
        headerLeft: blank,
        ...
        headerStyle: twoWayLinkStyles.navHeader,
        render() {
          return closure_1_6(closure_1_1(9594), {});
        }
      },
  ...
  const accountLinkStepTracking = twoWayLinkStyles(9423).useAccountLinkStepTracking(PlatformTypes.XBOX, locationStack.locationStack);
  ...
  return jsx(twoWayLinkStyles(7114).Navigator, { onStateChange: accountLinkStepTracking, screens: memo, initialRouteName: XboxLinkModalScenes.LANDING, headerBackTitle: null });
};
