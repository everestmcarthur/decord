...
// Function ID: 9362
// Name: XboxLinkModal
// Dependencies: [19, 9362, 1074, 21, 7487, 7102, 9360, 1115, 9363, 9370, 9371, 9375, 9583, 9588, 9589, 9369, 9412, 7110, 2]
// Exports: default

// Module 9361 (XboxLinkModal)
...
import XboxLinkEducationDefault from "XboxLinkEducation" /* 9588 */;
import XboxLinkErrorDefault from "XboxLinkError" /* 9589 */;
...
export default function XboxLinkModal(locationStack) {
  ...
  const memo = noop.useMemo(() => {
    ...
    return {
      ...
      [closure_2_4.PRE_CONNECT]: {
        ...
        render() {
          return closure_1_6(closure_1_1(9371), {});
        }
      },
      [closure_2_4.DISCORD_CONSENT]: {
        ...
        render(arg0) {
          ...
          return closure_1_6(closure_1_1(9375), { callbackCode, callbackState });
        }
      },
      [closure_2_4.SUCCESS]: {
        headerLeft: blank,
        ...
        headerStyle: twoWayLinkStyles.navHeader,
        render() {
          return closure_1_6(closure_1_1(9583), {});
        }
      },
  ...
  const accountLinkStepTracking = twoWayLinkStyles(9412).useAccountLinkStepTracking(PlatformTypes.XBOX, locationStack.locationStack);
  ...
  return jsx(twoWayLinkStyles(7110).Navigator, { onStateChange: accountLinkStepTracking, screens: memo, initialRouteName: XboxLinkModalScenes.LANDING, headerBackTitle: null });
};
