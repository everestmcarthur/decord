...
// Function ID: 9351
// Name: XboxLinkModal
// Dependencies: [19, 9351, 1074, 21, 7484, 7099, 9349, 1115, 9352, 9359, 9360, 9364, 9572, 9577, 9578, 9358, 9401, 7107, 2]
// Exports: default

// Module 9350 (XboxLinkModal)
...
import XboxLinkEducationDefault from "XboxLinkEducation" /* 9577 */;
import XboxLinkErrorDefault from "XboxLinkError" /* 9578 */;
...
export default function XboxLinkModal(locationStack) {
  ...
  const memo = noop.useMemo(() => {
    function onClose() {
      return closure_1_1(9349).hideModal();
    }
    function blank() {
      return null;
    }
    return {
      [closure_2_4.LANDING]: {
        ...
        render() {
          return closure_1_6(closure_1_1(9352), {});
        }
      },
      [closure_2_4.PRE_CONNECT]: {
        ...
        render() {
          return closure_1_6(closure_1_1(9360), {});
        }
      },
      [closure_2_4.DISCORD_CONSENT]: {
        ...
        render(arg0) {
          ...
          return closure_1_6(closure_1_1(9364), { callbackCode, callbackState });
        }
      },
      [closure_2_4.SUCCESS]: {
        headerLeft: blank,
        ...
        headerStyle: twoWayLinkStyles.navHeader,
        render() {
          return closure_1_6(closure_1_1(9572), {});
        }
      },
  ...
  const accountLinkStepTracking = twoWayLinkStyles(9401).useAccountLinkStepTracking(PlatformTypes.XBOX, locationStack.locationStack);
  ...
  return jsx(twoWayLinkStyles(7107).Navigator, { onStateChange: accountLinkStepTracking, screens: memo, initialRouteName: XboxLinkModalScenes.LANDING, headerBackTitle: null });
};
