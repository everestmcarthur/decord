...
// Dependencies: [32, 19, 17, 9351, 9365, 21, 4639, 576, 9358, 1364, 1484, 9573, 4635, 1115, 9574, 9575, 1177, 9576, 7230, 5059, 2]
// Exports: default

// Module 9572 (XboxLinkSuccess)
...
export default function XboxLinkDiscordSuccess() {
  ...
  obj5.source = require("module_9573");
  ...
  obj9.children = closure_13(closure_5, { source: require("module_9574"), style: tmp.appLogo });
