...
// Dependencies: [19, 17, 1074, 21, 4639, 9358, 2025, 9396, 4635, 1115, 7230, 5059, 2]
// Exports: default

// Module 9577 (XboxLinkEducation)
...
export default function XboxLinkEducation(onClose) {
  ...
  const items = [React5(React4, { source: noop.useMemo(() => ({ uri: _modDef9396 }), []), style: tmp.image }), , ];
