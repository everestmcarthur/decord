...
// Dependencies: [19, 9457, 1074, 21, 4722, 1115, 5270, 9459, 5258, 9461, 1484, 2025, 9462, 9463, 2]
// Exports: default

// Module 9458 (XboxLinkLanding)
...
export default function XboxLinkLanding() {
  ...
  const memo1 = noop.useMemo(() => ({ uri: _modDef9462 }), []);
  ...
  return jsx(navigation(9463).TwoWayLinkLanding, { platformType: constants2.XBOX, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
};
