...
// Dependencies: [19, 9362, 1074, 21, 4638, 1115, 5186, 9364, 5174, 9366, 1484, 2025, 9367, 9368, 2]
// Exports: default

// Module 9363 (XboxLinkLanding)
...
export default function XboxLinkLanding() {
  ...
  const memo1 = noop.useMemo(() => ({ uri: _modDef9367 }), []);
  ...
  return jsx(navigation(9368).TwoWayLinkLanding, { platformType: constants2.XBOX, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
};
