...
// Dependencies: [19, 9373, 1074, 21, 4640, 1115, 5188, 9375, 5176, 9377, 1484, 2025, 9378, 9379, 2]
// Exports: default

// Module 9374 (XboxLinkLanding)
...
export default function XboxLinkLanding() {
  ...
  const memo1 = noop.useMemo(() => ({ uri: _modDef9378 }), []);
  ...
  return jsx(navigation(9379).TwoWayLinkLanding, { platformType: constants2.XBOX, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
};
