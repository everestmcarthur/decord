...
// Dependencies: [19, 9398, 21, 4638, 1484, 9402, 9373, 1115, 2]
// Exports: PlayStationLinkPreConnect

// Module 9401 (PlayStationLinkPreConnect)
import _modDef9402 from "module_9402" /* 9402 */;
...
export const PlayStationLinkPreConnect = function PlayStationLinkPreConnect(platformType) {
  ...
  const memo = noop.useMemo(() => ({ uri: _modDef9402 }), []);
  ...
  return jsx(navigation(9373).TwoWayLinkPreConnect, { platformType: platformType.platformType, onError: callback1, onNext: callback, img: memo, imgStyle: tmp.image, title: null, body: null });
};
