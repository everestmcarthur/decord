...
// Dependencies: [19, 17, 21, 4605, 9295, 9333, 4601, 1114, 7175, 5025, 2]
// Exports: PlayStationLinkSuccess

// Module 9332 (PlayStationLinkSuccess)
...
export const PlayStationLinkSuccess = function PlayStationLinkSuccess(onClose) {
  ...
  const items = [timestampProducer(React4, { source: noop.useMemo(() => ({ uri: _modDef9333 }), []), style: tmp.image }), , ];
