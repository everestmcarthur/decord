...
// Dependencies: [19, 9415, 1074, 21, 4638, 1115, 8404, 1484, 9368, 9417, 2025, 2]
// Exports: default

// Module 9416 (CrunchyrollLinkLanding)
...
export default function CrunchyrollLinkLanding() {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj.icon = navigation(8404).PlayIcon;
    const items = [obj];
    return items;
  }, []);
  ...
  const obj2 = { platformType: constants2.CRUNCHYROLL, img: _modDef9417, imgStyle: tmp.image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null };
  ...
  return jsx(navigation(9368).TwoWayLinkLanding, { platformType: constants2.CRUNCHYROLL, img: _modDef9417, imgStyle: tmp.image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null });
};
