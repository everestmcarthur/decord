...
// Dependencies: [19, 9362, 1074, 21, 4606, 1114, 8360, 1483, 9315, 9364, 2024, 2]
// Exports: default

// Module 9363 (CrunchyrollLinkLanding)
...
export default function CrunchyrollLinkLanding() {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj.icon = navigation(8360).PlayIcon;
    const items = [obj];
    return items;
  }, []);
  ...
  const obj2 = { platformType: constants2.CRUNCHYROLL, img: _modDef9364, imgStyle: tmp.image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null };
  ...
  return jsx(navigation(9315).TwoWayLinkLanding, { platformType: constants2.CRUNCHYROLL, img: _modDef9364, imgStyle: tmp.image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null });
};
