...
// Dependencies: [19, 9404, 1074, 21, 4639, 1115, 8395, 1484, 9357, 9406, 2025, 2]
// Exports: default

// Module 9405 (CrunchyrollLinkLanding)
...
export default function CrunchyrollLinkLanding() {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj.icon = navigation(8395).PlayIcon;
    const items = [obj];
    return items;
  }, []);
  ...
  const obj2 = { platformType: constants2.CRUNCHYROLL, img: _modDef9406, imgStyle: tmp.image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null };
  ...
  return jsx(navigation(9357).TwoWayLinkLanding, { platformType: constants2.CRUNCHYROLL, img: _modDef9406, imgStyle: tmp.image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null });
};
