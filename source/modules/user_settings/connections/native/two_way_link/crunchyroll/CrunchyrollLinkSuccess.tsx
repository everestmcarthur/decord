...
// Dependencies: [19, 17, 21, 4722, 9464, 9517, 4718, 1115, 7319, 5144, 2]
// Exports: default

// Module 9516 (CrunchyrollLinkSuccess)
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef9517, style: tmp.image }), , ];
