...
// Dependencies: [4808, 9340, 1896, 2]

// Module 9339 (CrunchyrollLinkModalActionCreators)
...
export default {
  showModal(locationStack) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9340, dependencyMap.paths), { locationStack }, c3);
  },
  hideModal() {
