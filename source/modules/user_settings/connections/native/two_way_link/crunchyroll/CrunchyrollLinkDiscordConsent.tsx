...
// Dependencies: [19, 9426, 1074, 8487, 21, 1484, 9388, 2]
// Exports: default

// Module 9431 (CrunchyrollLinkDiscordConsent)
import noop from "module_19" /* 19 */;

const require = fn;
let closure_3 = fn(9426).CrunchyrollLinkModalScenes;
const PlatformTypes = fn(1074).PlatformTypes;
const CrunchyrollConnectionConstants = fn(8487);
...
export default function CrunchyrollLinkDiscordConsent(arg0) {
  ...
  return jsx(navigation(9388).TwoWayLinkDiscordConsent, { platformType: PlatformTypes.CRUNCHYROLL, callbackCode, callbackState, clientId, scopes, onNext: callback, onError: callback1 });
};
