...
// Dependencies: [19, 17, 21, 4638, 9369, 9411, 4634, 7233, 5058, 5060, 1115, 2]
// Exports: TwoWayLinkError

// Module 9410 (TwoWayLinkError)
...
export const TwoWayLinkError = function TwoWayLinkError(arg0) {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef9411, style: tmp.image }), hasOwnProperty(Text_Text.Text, { variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", style: twoWayLinkStyles.title, children: title }), hasOwnProperty(Text_Text.Text, { variant: "text-md/normal", color: "text-default", style: twoWayLinkStyles.body, children: body })];
  obj3.children = items;
