...
// Dependencies: [19, 17, 7303, 1074, 21, 576, 4722, 9479, 9128, 9669, 4676, 1612, 504, 1484, 1485, 7366, 4718, 1115, 5857, 1397, 5775, 12298, 7186, 7191, 2]
// Exports: DisclosureIcon, default

// Module 15156 (UserSettingsAuthedApps)
...
import applications from "applications" /* 9479 */;
...
export const DisclosureIcon = function DisclosureIcon(disclosure) {
  ...
  return noop.useMemo(() => {
    if (applications.ApplicationDisclosureType.IP_LOCATION === disclosure) {
      ...
      return closure_2_11(tmp2(9128).GlobeEarthIcon, obj2);
    } else if (tmp2(9479).ApplicationDisclosureType.DISPLAYS_ADVERTISEMENTS === tmp) {
      const obj3 = { style, size: "xs" };
      return closure_2_11(tmp2(9669).EmbedIcon, obj3);
    } else {
      const obj = { style, size: "xs" };
      return closure_2_11(tmp2(4676).CircleInformationIcon, obj);
    }
    tmp = disclosure;
  }, items);
};
