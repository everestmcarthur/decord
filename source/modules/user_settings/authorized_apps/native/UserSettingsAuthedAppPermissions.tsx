...
// Dependencies: [19, 17, 21, 4639, 9370, 8460, 1115, 4635, 4599, 576, 9372, 15038, 2]
// Exports: default
      ...
      if (_undefined3 != null) {
        mapped = _undefined3.map((disclosure, index) => {
          ...
          if (null != textForDisclosure) {
            ...
            items = [hasOwnProperty(tmp(15038).DisclosureIcon, obj3), ];
            const obj4 = { style: items.permissionText, variant: "text-sm/normal", children: textForDisclosure };
            items[1] = hasOwnProperty(tmp(4635).Text, obj4);
            obj2.children = items;
