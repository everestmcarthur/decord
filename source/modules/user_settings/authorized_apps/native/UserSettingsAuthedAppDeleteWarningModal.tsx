...
// Dependencies: [21, 11772, 1115, 12840, 9697, 5072, 2]
// Exports: default

// Module 12839 (UserSettingsAuthedAppDeleteWarningModal)
import util from "util" /* 1115 */;
import AlertModal from "AlertModal" /* 5072 */;
import isSocialLayerApplication from "isSocialLayerApplication" /* 11772 */;
import shouldWarnAuthorizedAppTwoWayDefault from "shouldWarnAuthorizedAppTwoWay" /* 12840 */;
...
export default function UserSettingsAuthedAppDeleteWarningModal(application) {
  ...
  if (tmp9) {
    ...
    tmp9 = React3(tmp8(9697), obj5);
    const tmp8Result = tmp8(9697);
  }
  const items = [tmp9, ];
  let tmp12 = result;
  if (result) {
    const obj7 = { look: tmp(9697).InfoBoxLooks.WARNING, children: null };
    const intl4 = tmp(1115).intl;
    obj7.children = intl4.string(tmp(1115).t.LY35Zy);
    tmp12 = React3(tmp8(9697), obj7);
    const tmp8Result2 = tmp8(9697);
  }
  items[1] = tmp12;
