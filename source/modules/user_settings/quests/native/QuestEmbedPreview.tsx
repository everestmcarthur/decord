...
// Dependencies: [19, 4289, 1372, 1074, 21, 8039, 504, 4627, 11433, 15264, 1115, 8778, 2]
// Exports: QuestEmbedPreview

// Module 15265 (QuestEmbedPreview)
...
export const QuestEmbedPreview = function QuestEmbedPreview(questId) {
  ...
  if (null != memo1) {
    ...
    obj2.children = jsx(stateFromStores(8778), { rowGenerator: memo, message: memo1, horizontalOffset: 0, pointerEvents: "none" });
