...
// Dependencies: [109, 5, 19, 8280, 7726, 1980, 5523, 1372, 1074, 504, 12006, 1953, 573, 9342, 14745, 11225, 7095, 14703, 8287, 4540, 1115, 2]
// Exports: default

// Module 14744 (useGuildProfileEditForm)
...
const IGNORE_GUILD_IDS = fn(8280).IGNORE_GUILD_IDS;
...
export default function useGuildProfileEditForm() {
  ...
  const memo = pendingThemeColors.useMemo(() => {
    const delayedCall = new stateFromStores(pendingNickname[11]).DelayedCall(200, () => {
      pendingAvatar(573).wait(stateFromStores(9342).resetAllPending);
    });
    return delayedCall;
  }, []);
  const items3 = [memo];
