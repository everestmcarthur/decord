...
// Dependencies: [19, 21, 4640, 576, 7311, 7263, 1115, 1177, 5775, 5693, 4607, 2]
// Exports: default

// Module 14746 (EditProfileThemeActionSheet)
...
export default function EditProfileThemeActionSheet(onResetTheme) {
  ...
  const items = [closure_3(onResetTheme(7263).BottomSheetTitleHeader, obj3), ];
  ...
  obj5.children = closure_3(onResetTheme(5693).TableRow, obj9);
  items[1] = closure_3(onResetTheme(5775).TableRowGroup, obj5);
  obj.children = items;
  return closure_4(onResetTheme(7311).ActionSheet, obj);
};
