...
// Dependencies: [1957, 1074, 12543, 1187, 1942, 7316, 510, 1223, 504, 1218, 1943, 7624, 2]

// Module 14543 (PreloadedUserSettingsMigrations)
...
let closure_5 = fn(12543).MULTIACCOUNT_TOOLTIP_SEEN_KEY;
let items = [
  {
    version: 2,
    run(inbox) {
