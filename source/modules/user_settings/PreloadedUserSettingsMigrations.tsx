...
let items = [
  ...
  },
  {
    ...
    run(userContent) {
      ...
      if (tmp4) {
        const CHANNEL_NOTICE_INVITE = tmp(1944).DismissibleContent.CHANNEL_NOTICE_INVITE;
        if (null == userContent.userContent) {
          const UserContentSettings = tmp(1186).UserContentSettings;
          userContent.userContent = UserContentSettings.create();
        }
        ...
        if (!tmpResult.hasBit(userContent.userContent.dismissedContents, CHANNEL_NOTICE_INVITE)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, CHANNEL_NOTICE_INVITE);
          flag2 = true;
          const tmpResult6 = tmp(1943);
        }
        tmp4 = flag2;
        tmpResult = tmp(1943);
      }
      ...
      if (tmp10) {
        const CHANNEL_NOTICE_QUICKSWITCHER = tmp(1944).DismissibleContent.CHANNEL_NOTICE_QUICKSWITCHER;
        if (null == userContent.userContent) {
        ...
        if (!tmpResult7.hasBit(userContent.userContent.dismissedContents, CHANNEL_NOTICE_QUICKSWITCHER)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, CHANNEL_NOTICE_QUICKSWITCHER);
          flag3 = true;
          const tmpResult8 = tmp(1943);
        }
        tmp10 = flag3;
        tmpResult7 = tmp(1943);
      }
      ...
      if (tmp16) {
        const CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION = tmp(1944).DismissibleContent.CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION;
        if (null == userContent.userContent) {
        ...
        if (!tmpResult9.hasBit(userContent.userContent.dismissedContents, CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION);
          flag4 = true;
          const tmpResult10 = tmp(1943);
        }
        tmp16 = flag4;
        tmpResult9 = tmp(1943);
      }
  ...
  },
  {
    ...
    run(userContent) {
      ...
      if (value) {
        const NAGBAR_NOTICE_DOWNLOAD = tmp(1944).DismissibleContent.NAGBAR_NOTICE_DOWNLOAD;
        if (null == userContent.userContent) {
          const UserContentSettings = tmp(1186).UserContentSettings;
          userContent.userContent = UserContentSettings.create();
        }
        ...
        if (!tmpResult.hasBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_DOWNLOAD)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_DOWNLOAD);
          flag = true;
          const tmpResult6 = tmp(1943);
        }
        value = flag;
      ...
      if (value3) {
        const NAGBAR_NOTICE_CONNECT_SPOTIFY = tmp(1944).DismissibleContent.NAGBAR_NOTICE_CONNECT_SPOTIFY;
        if (null == userContent.userContent) {
          const UserContentSettings2 = tmp(1186).UserContentSettings;
          userContent.userContent = UserContentSettings2.create();
        }
        ...
        if (!tmpResult7.hasBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_CONNECT_SPOTIFY)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_CONNECT_SPOTIFY);
          flag3 = true;
          const tmpResult8 = tmp(1943);
        }
        value3 = flag3;
      ...
      if (value4) {
        const NAGBAR_NOTICE_CONNECT_PLAYSTATION = tmp(1944).DismissibleContent.NAGBAR_NOTICE_CONNECT_PLAYSTATION;
        if (null == userContent.userContent) {
          const UserContentSettings3 = tmp(1186).UserContentSettings;
          userContent.userContent = UserContentSettings3.create();
        }
        ...
        if (!tmpResult9.hasBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_CONNECT_PLAYSTATION)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_CONNECT_PLAYSTATION);
          flag4 = true;
          const tmpResult10 = tmp(1943);
        }
        value4 = flag4;
  ...
  },
  {
    ...
    run(userContent) {
      ...
      if (value) {
        const NAGBAR_NOTICE_PREMIUM_PROMO = tmp(1944).DismissibleContent.NAGBAR_NOTICE_PREMIUM_PROMO;
        if (null == userContent.userContent) {
          const UserContentSettings = tmp(1186).UserContentSettings;
          userContent.userContent = UserContentSettings.create();
        }
        ...
        if (!tmpResult.hasBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_PREMIUM_PROMO)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_PREMIUM_PROMO);
          flag = true;
          const tmpResult6 = tmp(1943);
        }
        value = flag;
      ...
      if (value3) {
        const NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING = tmp(1944).DismissibleContent.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING;
        if (null == userContent.userContent) {
          const UserContentSettings2 = tmp(1186).UserContentSettings;
          userContent.userContent = UserContentSettings2.create();
        }
        ...
        if (!tmpResult7.hasBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING);
          flag3 = true;
          const tmpResult8 = tmp(1943);
        }
        value3 = flag3;
      ...
      if (value4) {
        const NAGBAR_NOTICE_PREMIUM_REACTIVATE = tmp(1944).DismissibleContent.NAGBAR_NOTICE_PREMIUM_REACTIVATE;
        if (null == userContent.userContent) {
          const UserContentSettings3 = tmp(1186).UserContentSettings;
          userContent.userContent = UserContentSettings3.create();
        }
        ...
        if (!tmpResult9.hasBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_PREMIUM_REACTIVATE)) {
          userContent.userContent.dismissedContents = tmp(1943).addBit(userContent.userContent.dismissedContents, NAGBAR_NOTICE_PREMIUM_REACTIVATE);
          flag4 = true;
          const tmpResult10 = tmp(1943);
        }
        value4 = flag4;
