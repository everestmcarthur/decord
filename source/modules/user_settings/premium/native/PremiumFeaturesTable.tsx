...
// Dependencies: [32, 19, 17, 1074, 1373, 21, 4605, 576, 5491, 4540, 4456, 1178, 13553, 13554, 4601, 1114, 5037, 9434, 4262, 13555, 13556, 5637, 13557, 13558, 13559, 13560, 13561, 2]
// Exports: default
...
function CheckIcon() {
  ...
  return closure_1_11(native.Icon, { source: _modDef13553, color: shared.isThemeDark(tmp3) ? unsafe_rawColors.WHITE : unsafe_rawColors.PRIMARY_860, size: native.IconSizes.SMALL });
}
function CloseIcon() {
...
obj2.themedHighlightedCell = { backgroundColor: fn(5491).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
...
let obj7 = { icon: null };
let obj5 = { backgroundColor: fn(5491).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
