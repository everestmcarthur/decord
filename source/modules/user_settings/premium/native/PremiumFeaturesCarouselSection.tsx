...
// Dependencies: [32, 19, 17, 1074, 7506, 1373, 21, 576, 4607, 5039, 1093, 4603, 5639, 1114, 13527, 13528, 13529, 13530, 5014, 1608, 10848, 1178, 7236, 1477, 1242, 2]
// Exports: default

// Module 13526 (PremiumFeaturesCarouselSection)
...
function PremiumFeaturesCarousel(arg0) {
  ...
  const isScreenReaderEnabled = onEndReached(5014).useIsScreenReaderEnabled();
  ...
  if (!onEndReached(1608).isThumbstickScrollDevice) {
    if (!isScreenReaderEnabled) {
      ...
      let tmp19 = closure_10(currentIndex(10848), obj3);
    }
    let items3 = [tmp19, ];
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  const tmp = closure_14();
  const analyticsLocations = first(7236)().analyticsLocations;
  ...
  const items2 = [closure_10(analyticsLocations(4603).Text, obj3), closure_10(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
