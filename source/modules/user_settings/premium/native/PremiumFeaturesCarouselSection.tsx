...
// Dependencies: [32, 19, 17, 1074, 7542, 1374, 21, 576, 4638, 5072, 1094, 4634, 5673, 1115, 13576, 13577, 13578, 13579, 5045, 1609, 10903, 1177, 7272, 1478, 1241, 2]
// Exports: default

// Module 13575 (PremiumFeaturesCarouselSection)
...
function PremiumFeaturesCarousel(arg0) {
  ...
  const isScreenReaderEnabled = onEndReached(5045).useIsScreenReaderEnabled();
  ...
  if (!onEndReached(1609).isThumbstickScrollDevice) {
    if (!isScreenReaderEnabled) {
      ...
      let tmp19 = closure_10(currentIndex(10903), obj3);
    }
    let items3 = [tmp19, ];
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  const tmp = closure_14();
  const analyticsLocations = first(7272)().analyticsLocations;
  ...
  const items2 = [closure_10(analyticsLocations(4634).Text, obj3), closure_10(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
