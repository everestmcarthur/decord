...
// Dependencies: [32, 19, 17, 1074, 7546, 1374, 21, 576, 4640, 5074, 1094, 4636, 5675, 1115, 13584, 13585, 13586, 13587, 5047, 1609, 10911, 1177, 7276, 1478, 1241, 2]
// Exports: default

// Module 13583 (PremiumFeaturesCarouselSection)
...
function PremiumFeaturesCarousel(arg0) {
  ...
  const isScreenReaderEnabled = onEndReached(5047).useIsScreenReaderEnabled();
  ...
  if (!onEndReached(1609).isThumbstickScrollDevice) {
    if (!isScreenReaderEnabled) {
      ...
      let tmp19 = closure_10(currentIndex(10911), obj3);
    }
    let items3 = [tmp19, ];
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  const tmp = closure_14();
  const analyticsLocations = first(7276)().analyticsLocations;
  ...
  const items2 = [closure_10(analyticsLocations(4636).Text, obj3), closure_10(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
