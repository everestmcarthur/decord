...
// Dependencies: [32, 19, 17, 8278, 21, 4607, 576, 7236, 7256, 504, 8270, 4603, 1114, 2492, 10840, 5027, 11127, 10752, 13626, 13628, 11250, 2]
// Exports: default

// Module 13625 (UserSettingsGiftingBadgeProgress)
...
import GiftingBadgeIconDefault from "GiftingBadgeIcon" /* 10840 */;
...
let closure_8 = fn(8278).getSingleRequirementThreshold;
const jsxProd = fn(21);
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(13626).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
    if (null != nextTier) {
    ...
    if (tmp16Result) {
      ...
      tmp16Result = tmp16(tmp4(10840), obj10);
    }
    ...
    obj15.children = closure_9(tmp7(4603).Text, obj17);
    ...
    obj18.icon = closure_9(tmp7(11127).GiftIcon, obj19);
    const intl4 = tmp7(1114).intl;
    obj18.text = intl4.string(tmp4(2492).DZnomS);
    obj18.onPress = function onPress() {
      utils_openGiftModal.openGiftModal({ analyticsLocation, analyticsLocations });
    };
    items5[1] = closure_9(tmp7(5027).Button, obj18);
    ...
    const items6 = [closure_9(tmp7(4603).Text, obj22), ];
    if (tmp11Result) {
      let ChevronSmallDownIcon = tmp7(13628).ChevronSmallUpIcon;
    } else {
      ChevronSmallDownIcon = tmp7(11250).ChevronSmallDownIcon;
    }
    ...
    if (tmp11Result) {
      ...
      items7[1] = tmp16(tmp7(4603).Text, obj26);
