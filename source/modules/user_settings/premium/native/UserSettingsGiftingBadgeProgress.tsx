...
// Dependencies: [32, 19, 17, 8255, 21, 4605, 576, 7214, 7234, 504, 8247, 4601, 1114, 2492, 10819, 5025, 11102, 10731, 13647, 13649, 11225, 2]
// Exports: default

// Module 13646 (UserSettingsGiftingBadgeProgress)
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(13647).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
    if (null != nextTier) {
    ...
    if (tmp16Result) {
      ...
      tmp16Result = tmp16(tmp4(10819), obj10);
    }
    ...
    obj15.children = closure_9(tmp7(4601).Text, obj17);
    ...
    obj18.icon = closure_9(tmp7(11102).GiftIcon, obj19);
    const intl4 = tmp7(1114).intl;
    obj18.text = intl4.string(tmp4(2492).DZnomS);
    obj18.onPress = function onPress() {
      utils_openGiftModal.openGiftModal({ analyticsLocation, analyticsLocations });
    };
    items5[1] = closure_9(tmp7(5025).Button, obj18);
    ...
    const items6 = [closure_9(tmp7(4601).Text, obj22), ];
    if (tmp11Result) {
    ...
    if (tmp11Result) {
      ...
      items7[1] = tmp16(tmp7(4601).Text, obj26);
