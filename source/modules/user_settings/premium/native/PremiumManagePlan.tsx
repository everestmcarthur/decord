...
// Dependencies: [5, 32, 19, 17, 4298, 1372, 4299, 4302, 4303, 7501, 1896, 7344, 1074, 5688, 4621, 1374, 21, 3, 4639, 576, 1484, 5207, 5713, 4635, 1115, 7269, 13479, 7289, 504, 4350, 4491, 1094, 4963, 5683, 10796, 7511, 1241, 4297, 38, 7341, 13590, 13591, 13456, 13466, 8176, 5059, 13445, 13483, 13482, 5175, 9495, 13488, 2025, 5692, 5071, 1177, 8159, 1612, 13546, 7500, 5076, 7364, 8173, 13548, 13515, 1975, 5048, 7097, 7102, 13484, 13568, 2]
// Exports: default
...
function FractionalPremiumCredits(durationText) {
  ...
  if (hasUnactivatedUnits) {
    if (fractionalPremiumInfo.fractionalState === constants4.NONE) {
      ...
      let tmp8Result = tmp8(tmp9(4635).Text, obj16);
    }
    items4[1] = tmp8Result;
    ...
    if (hasUnactivatedUnits) {
      if (fractionalPremiumInfo.fractionalState === constants4.NONE) {
        ...
        const items6 = [tmp8(tmp9(4635).Text, obj21), ];
        ...
        if (tmp8Result3) {
          ...
          tmp8Result3 = tmp8(tmp9(4635).Text, obj22);
        }
      ...
      if (hasUnactivatedUnits) {
        if (fractionalPremiumInfo.fractionalState === constants4.NONE) {
          ...
          obj25.children = tmp8(tmp9(4635).Text, obj26);
      ...
      obj28.children = tmp8(tmp9(4635).Text, obj29);
    ...
    tmp8Result5 = tmp8(tmp9(4635).Text, obj30);
  }
  ...
  tmp8Result = tmp8(tmp9(4635).Text, obj31);
}
...
export default function PremiumManagePlan() {
  ...
  if (isInReverseTrial) {
    ...
    isInReverseTrial = tmp29(tmp2(9495), obj13);
  }
  ...
  if (tmp29Result3) {
    ...
    tmp29Result3 = tmp29(tmp2(9495), obj14);
  }
  ...
  if (tmp27Result) {
    ...
    const items10 = [tmp29(tmp2(13445), obj17), ];
    const obj18 = { style: tmp.billingInfo, subscription: tmp10 };
    items10[1] = tmp29(tmp2(13482), obj18);
