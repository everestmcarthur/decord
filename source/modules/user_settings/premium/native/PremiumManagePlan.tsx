...
// Dependencies: [5, 32, 19, 17, 4296, 1372, 4297, 4300, 4301, 7504, 1896, 7347, 1074, 5689, 4620, 1374, 21, 3, 4638, 576, 1484, 5208, 5714, 4634, 1115, 7272, 13490, 7292, 504, 4348, 4489, 1094, 4962, 5684, 10804, 7514, 1241, 4295, 38, 7344, 13602, 13603, 13467, 13477, 8185, 5060, 13456, 13494, 13493, 5176, 9506, 13499, 2025, 5693, 5072, 1177, 8168, 1612, 13558, 7503, 5077, 7367, 8182, 13560, 13526, 1975, 5047, 7100, 7105, 13495, 13580, 2]
// Exports: default
...
function FractionalPremiumCredits(durationText) {
  ...
  if (hasUnactivatedUnits) {
    if (fractionalPremiumInfo.fractionalState === constants4.NONE) {
      ...
      let tmp8Result = tmp8(tmp9(4634).Text, obj16);
    }
    items4[1] = tmp8Result;
    ...
    if (hasUnactivatedUnits) {
      if (fractionalPremiumInfo.fractionalState === constants4.NONE) {
        ...
        const items6 = [tmp8(tmp9(4634).Text, obj21), ];
        ...
        if (tmp8Result3) {
          ...
          tmp8Result3 = tmp8(tmp9(4634).Text, obj22);
        }
      ...
      if (hasUnactivatedUnits) {
        if (fractionalPremiumInfo.fractionalState === constants4.NONE) {
          ...
          obj25.children = tmp8(tmp9(4634).Text, obj26);
      ...
      obj28.children = tmp8(tmp9(4634).Text, obj29);
    ...
    tmp8Result5 = tmp8(tmp9(4634).Text, obj30);
  }
  ...
  tmp8Result = tmp8(tmp9(4634).Text, obj31);
}
...
export default function PremiumManagePlan() {
  ...
  if (isInReverseTrial) {
    ...
    isInReverseTrial = tmp29(tmp2(9506), obj13);
  }
  ...
  if (tmp29Result3) {
    ...
    tmp29Result3 = tmp29(tmp2(9506), obj14);
  }
  ...
  if (tmp27Result) {
    ...
    const items10 = [tmp29(tmp2(13456), obj17), ];
    const obj18 = { style: tmp.billingInfo, subscription: tmp10 };
    items10[1] = tmp29(tmp2(13493), obj18);
