...
// Dependencies: [19, 1374, 4309, 1380, 4337, 1115, 3075, 9514, 4295, 8897, 9516, 8797, 9364, 9518, 9520, 576, 2]
// Exports: default

// Module 9513 (usePremiumFeatures)
...
import ScreenStreamIcon from "ScreenStreamIcon" /* 9364 */;
...
import UserSquareIcon from "UserSquareIcon" /* 9520 */;
...
const TOTAL_PREMIUM_GROUP_USERS = fn(4309).TOTAL_PREMIUM_GROUP_USERS;
const size = fn(2);
...
export default function usePremiumFeatures(arg0) {
  ...
  return noop.useMemo(() => {
    ...
    obj.label = intl.formatToPlainString(_modDef3075.gsE005, { totalSeats: TOTAL_PREMIUM_GROUP_USERS });
    ...
    obj3.label = intl2.string(_modDef3075["G6K/+s"]);
    ...
    obj11.label = intl8.formatToPlainString(_modDef3075.HVCRVf, { numBoosts });
