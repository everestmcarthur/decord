...
// Dependencies: [1372, 8091, 1074, 7153, 504, 14909, 1115, 14793, 14911, 4983, 4841, 7152, 1897, 7155, 12, 11614, 14794, 2]

// Module 14913 (AccountSmsBackupSetting)
...
import showUserSettingsInputAlertDefault from "showUserSettingsInputAlert" /* 14911 */;
...
let closure_6 = apply.debounce(function toggleSMS(user) {
  ...
  if (user.mfaSMSEnabled) {
    ...
    obj.pushLazy(asyncRequireImpl(7152, dependencyMap.paths), obj5, closure_5);
    const tmp5 = asyncRequireImpl(7152, dependencyMap.paths);
  }
}, 200);
...
const toggle = SettingBuilders.createToggle({
  ...
  usePredicate: fn(14794).useIsTOTPEnabled
});
const size = fn(2);
