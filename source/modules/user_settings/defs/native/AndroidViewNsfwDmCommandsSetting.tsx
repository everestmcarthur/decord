...
// Dependencies: [8091, 9439, 4849, 9440, 4851, 1364, 8541, 8543, 1936, 11614, 1115, 2]
...
const toggle = SettingBuilders.createToggle({
  ...
  onValueChange: function handleValueChange(arg0) {
    if (obj.shouldAgeVerifyForSettingsToggles()) {
      if (arg0) {
        const obj3 = { entryPoint: tmp(8543).AgeVerificationModalEntryPoint.AGE_RESTRICTED_DM_COMMANDS_SETTINGS };
