...
// Dependencies: [19, 8027, 1074, 14758, 1114, 1178, 14874, 11540, 14759, 14757, 2]

// Module 14873 (AccountViewBackupCodesSetting)
...
const route = SettingBuilders.createRoute({
  ...
  usePredicate: fn(14759).useIs2FAEnabled,
