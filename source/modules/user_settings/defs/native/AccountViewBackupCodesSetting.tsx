...
// Dependencies: [19, 8111, 1074, 14801, 1115, 1177, 14919, 11622, 14802, 14800, 2]

// Module 14918 (AccountViewBackupCodesSetting)
...
const route = SettingBuilders.createRoute({
  ...
  usePredicate: fn(14802).useIs2FAEnabled,
