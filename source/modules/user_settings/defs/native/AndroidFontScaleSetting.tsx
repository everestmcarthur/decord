...
// Dependencies: [19, 15474, 1084, 8194, 21, 1248, 15523, 11456, 1115, 11714, 1364, 2]

// Module 15522 (AndroidFontScaleSetting)
...
require = fn;
const useFontScaleStore = fn(15474).useFontScaleStore;
