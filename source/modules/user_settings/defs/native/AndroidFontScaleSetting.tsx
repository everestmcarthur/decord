...
// Dependencies: [19, 15380, 1084, 8111, 21, 1248, 15429, 11358, 1115, 11622, 1364, 2]

// Module 15428 (AndroidFontScaleSetting)
...
require = fn;
const useFontScaleStore = fn(15380).useFontScaleStore;
