...
// Dependencies: [19, 15375, 1084, 8091, 21, 1248, 15424, 11350, 1115, 11614, 1364, 2]

// Module 15423 (AndroidFontScaleSetting)
...
require = fn;
const useFontScaleStore = fn(15375).useFontScaleStore;
