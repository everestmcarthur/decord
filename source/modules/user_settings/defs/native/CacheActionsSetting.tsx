...
// Dependencies: [5, 32, 19, 5363, 21, 4605, 4336, 4592, 1115, 504, 1936, 15685, 7307, 7259, 5773, 5691, 15653, 15688, 15686, 10275, 5663, 15689, 4602, 11614, 2]

// Module 15684 (CacheActionsSetting)
...
import CacheActionsDiskUsageSection from "CacheActionsDiskUsageSection" /* 15685 */;
import DiskUsageManagerDefault from "DiskUsageManager" /* 15686 */;
import CacheActionCreators from "CacheActionCreators" /* 15688 */;
import FileWarningIcon from "FileWarningIcon" /* 15689 */;
...
function CacheActionsActionSheet() {
  ...
  if (tmp7Result3) {
    let obj5 = { icon: tmp7(tmp(10275).FileIcon, {}), label: null, trailing: null, disabled: null, accessibilityState: null, onPress: null };
    const intl4 = tmp(1115).intl;
    const t = tmp(1115).t;
    obj5.label = intl4.string(isCalculating ? t.Ynmbie : t.iAFGRu);
    let tmp7Result = null;
    if (isCalculating) {
      tmp7Result = tmp7(tmp(5663).ActivityIndicator, { size: "small", accessible: false });
    }
    ...
    tmp7Result3 = tmp7(tmp(5691).TableRow, obj5);
  }
