...
// Dependencies: [1346, 1347, 10361, 504, 1364, 11622, 1115, 15683, 15874, 2]

// Module 15887 (CreateBugReportSetting)
import initialize from "initialize" /* 504 */;
import util from "util" /* 1115 */;
import DeveloperOptionsActionCreators from "DeveloperOptionsActionCreators" /* 1347 */;
import BugReportManagerDefault from "BugReportManager" /* 10361 */;
...
const toggle = SettingBuilders.createToggle({
  ...
  parent: null,
  IconComponent: fn(15683).WrenchIcon,
  ...
  usePredicate: fn(15874).useBugReporterExperimentSettingPredicate
});
const size = fn(2);
