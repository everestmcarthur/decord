...
// Dependencies: [5, 17, 8111, 1074, 4850, 12562, 12570, 1241, 9838, 11622, 1115, 2]

// Module 15607 (SystemNotificationsSetting)
...
let closure_6 = fn(4850).NotificationAuthorizationStatus;
