...
// Dependencies: [5, 17, 8027, 1074, 4815, 12480, 12488, 1242, 9757, 11540, 1114, 2]

// Module 15568 (SystemNotificationsSetting)
...
let closure_6 = fn(4815).NotificationAuthorizationStatus;
