...
// Dependencies: [19, 17, 4253, 1371, 1074, 8464, 21, 4605, 576, 14765, 1114, 7434, 504, 7050, 5671, 5655, 5025, 2]
...
export default noop.memo(() => {
  ...
  if (null != bannerText) {
    ...
    if (null != bannerText) {
      ...
      obj9.trailing = React7(tmp2(5025).Button, obj10);
      tmp14 = React7(tmp2(5655).TableRow, obj9);
    }
    items2[1] = tmp14;
