...
// Dependencies: [19, 17, 4288, 1372, 1074, 8520, 21, 4639, 576, 14784, 1115, 7489, 504, 7105, 5706, 5690, 5059, 2]
...
export default noop.memo(() => {
  ...
  if (null != bannerText) {
    ...
    if (null != bannerText) {
      ...
      obj9.trailing = React7(tmp2(5059).Button, obj10);
      tmp14 = React7(tmp2(5690).TableRow, obj9);
    }
    items2[1] = tmp14;
