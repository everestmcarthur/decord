...
// Dependencies: [19, 17, 13801, 21, 4606, 576, 7262, 4304, 5656, 7206, 1114, 4308, 504, 14732, 5024, 4602, 5738, 2]
// Exports: default
...
function CodeRow(code) {
  ...
  if (showCheckMark) {
    ...
    tmp2Result = tmp2(code(7206).CheckmarkSmallIcon, obj2);
  }
...
export default function UserSettingsAccountBackupCodes(headerLabel) {
  ...
  if (tmp10Result3) {
    ...
    tmp10Result3 = tmp10(tmp3(5738).TableRowGroup, obj6);
  }
  ...
  if (tmp10Result4) {
    ...
    obj8.label = tmp10(tmp3(4602).Text, obj9);
    ...
    obj7.children = tmp10(tmp3(5656).TableRow, obj8);
    tmp10Result4 = tmp10(tmp3(5738).TableRowGroup, obj7);
  }
  const obj4 = { paddingHorizontal: token, paddingTop: nativeDefault.space.PX_16 };
  items2[3] = tmp10Result4;
  obj3.children = items2;
  return closure_6(tmp11, { children: tmp12(stateFromStores(5024).Stack, obj3) });
};
