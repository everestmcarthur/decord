...
// Dependencies: [19, 1372, 21, 4638, 576, 5707, 1115, 504, 5208, 4634, 2]
// Exports: default

// Module 7108 (UserSettingsAccountUnverifiedHeader)
...
export default function UserSettingsAccountUnverifiedHeader() {
  ...
  if (null != tmp4) {
    ...
    const items1 = [React4(tmp2(4634).Text, obj3), ];
    const obj4 = { style: tmp.accountWarningButton, variant: "text-xs/medium", color: "text-overlay-light", children: tmp4.button };
    items1[1] = React4(tmp2(4634).Text, obj4);
    obj2.children = items1;
    tmp5 = hasOwnProperty(tmp2(5208).PressableOpacity, obj2);
  }
  return tmp5;
};
