...
// Dependencies: [19, 1371, 21, 4605, 576, 5671, 1114, 504, 5173, 4601, 2]
// Exports: default

// Module 7050 (UserSettingsAccountUnverifiedHeader)
...
export default function UserSettingsAccountUnverifiedHeader() {
  ...
  if (null != tmp4) {
    ...
    const items1 = [React4(tmp2(4601).Text, obj3), ];
    const obj4 = { style: tmp.accountWarningButton, variant: "text-xs/medium", color: "text-overlay-light", children: tmp4.button };
    items1[1] = React4(tmp2(4601).Text, obj4);
    obj2.children = items1;
    tmp5 = hasOwnProperty(tmp2(5173).PressableOpacity, obj2);
  }
  return tmp5;
};
