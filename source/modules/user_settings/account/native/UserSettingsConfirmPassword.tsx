...
// Dependencies: [5, 32, 19, 17, 1372, 1074, 21, 4638, 576, 7104, 504, 7105, 4538, 1231, 1115, 7108, 4634, 6713, 7049, 5060, 2]
...
const forwardRefResult = noop.forwardRef((arg0, ref) => {
  ...
  if (null != stateFromStores) {
    ...
    const items3 = [closure_10(tmp3(4634).Text, obj5), , , , ];
    ...
    items3[1] = closure_10(tmp3(4634).Text, obj6);
    ...
    if (null != obj2) {
      ...
      if (null == obj2.getFieldMessage("password")) {
        ...
        tmp19Result = tmp19(tmp20(7049), obj9);
      }
    }
    ...
    obj18.loading = tmp7;
    obj10.children = closure_10(tmp3(5060).Button, obj18);
