...
// Dependencies: [19, 17, 1951, 7497, 1372, 1074, 21, 4640, 576, 4350, 7098, 7105, 12, 1241, 7104, 7112, 14901, 4636, 1115, 5060, 6717, 5062, 7108, 504, 38, 1484, 2]
// Exports: default

// Module 14900 (UserSettingsAccountEditPassword)
...
import UserSettingsAccountActionCreatorsAll from "UserSettingsAccountActionCreators" /* 7098 */;
import UserSettingsModalActionCreatorsDefault from "UserSettingsModalActionCreators" /* 7104 */;
import showInvalidUsernameToastNative from "showInvalidUsernameToastNative" /* 7105 */;
import UserSettingsAccountUnverifiedHeader from "UserSettingsAccountUnverifiedHeader" /* 7112 */;
...
const state = { newPassword: "call", password: 17085505 };
...
prototype["render"] = function render() {
  ...
  if (showForcedPasswordUpdate) {
    ...
    const obj4 = { source: _modDef14901, style: tmp.image };
...
export default function EditPasswordWrapper() {
  const params = flag(7108).useSettingNavigationRoute().params;
  flag = undefined;
  if (params != null) {
