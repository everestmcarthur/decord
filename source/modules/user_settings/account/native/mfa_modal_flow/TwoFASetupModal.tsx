...
// Dependencies: [19, 17, 14838, 21, 4607, 576, 1483, 14836, 7197, 5027, 1114, 14839, 5676, 14840, 14843, 14844, 14846, 5650, 7023, 7074, 2]
// Exports: TwoFASetupModalScreen, default

// Module 14837 (TwoFASetupModal)
...
import TwoFASetupScanDefault from "TwoFASetupScan" /* 14843 */;
import TwoFASetupEnterCodeDefault from "TwoFASetupEnterCode" /* 14844 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
const TwoFAModalSetupSections = fn(14838).TwoFAModalSetupSections;
const jsxProd = fn(21);
...
export default function TwoFASetupModal(initialRouteName) {
  ...
  let obj = {
    ...
    screens: useInitialValueDefault(() => {
      totpSecret = totpSecret(7023).generateTotpSecret();
      const obj2 = {};
      const obj3 = { headerLeft: null, headerTitle: null, render: null };
      const obj = totpSecret(7023);
      obj3.headerLeft = totpSecret(5676).getHeaderCloseButton(closure_1(14836).close);
      obj3.headerTitle = function headerTitle() {
        return closure_1_6(totpSecret(14839).PageMarker, { currentPage: dependencyMap2[constants.LANDING], numMarkers: Object.keys(dependencyMap2).length - 1 });
      };
      obj3.render = function render() {
        return closure_1_6(closure_1_1(14840), {});
      };
      obj2[constants.LANDING] = obj3;
      obj2[constants.SCAN] = {
        headerTitle() {
          return closure_1_6(totpSecret(14839).PageMarker, { currentPage: dependencyMap2[constants.SCAN], numMarkers: Object.keys(dependencyMap2).length - 1 });
        },
        render() {
      ...
      obj2[constants.ENTER_CODE] = {
        headerTitle() {
          return closure_1_6(totpSecret(14839).PageMarker, { currentPage: dependencyMap2[constants.ENTER_CODE], numMarkers: Object.keys(dependencyMap2).length - 1 });
        },
        render() {
      ...
      const obj4 = totpSecret(5676);
      obj5.headerLeft = totpSecret(5676).getHeaderCloseButton(closure_1(14836).close);
      obj5.headerTitle = function headerTitle() {
        return null;
      };
      obj5.render = function render() {
        return closure_1_6(closure_1_1(14846), {});
      };
...
export const TwoFASetupModalScreen = function TwoFASetupModalScreen(children) {
  ...
  if (name === TwoFAModalSetupSections.ENTER_CODE) {
    ...
    obj4 = tmp8(tmp2(5027).Button, obj4);
    obj3.children = obj4;
    closure_6(tmp2(7197).SafeAreaPaddingView, obj3);
  }
};
