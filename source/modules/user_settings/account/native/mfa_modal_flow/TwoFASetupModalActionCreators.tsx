...
// Dependencies: [4809, 14836, 1896, 2]

// Module 14835 (TwoFASetupModalActionCreators)
...
export default {
  open(initialRouteName) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14836, dependencyMap.paths), { initialRouteName }, TWO_FA_SETUP_MODAL_KEY);
  },
  close() {
