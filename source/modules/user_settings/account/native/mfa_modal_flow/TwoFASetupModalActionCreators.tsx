...
// Dependencies: [4842, 14881, 1897, 2]

// Module 14880 (TwoFASetupModalActionCreators)
...
export default {
  open(initialRouteName) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14881, dependencyMap.paths), { initialRouteName }, TWO_FA_SETUP_MODAL_KEY);
  },
  close() {
