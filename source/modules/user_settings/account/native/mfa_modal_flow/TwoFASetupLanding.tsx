...
// Dependencies: [19, 17, 21, 4639, 14885, 14881, 7230, 14886, 4635, 1115, 2]
// Exports: default

// Module 14884 (TwoFASetupLanding)
import util from "util" /* 1115 */;
import Text_Text from "Text/Text" /* 4635 */;
import common_SafeAreaView from "common/SafeAreaView" /* 7230 */;
import TwoFASetupModal from "TwoFASetupModal" /* 14881 */;
import TwoFASetupStyles from "TwoFASetupStyles" /* 14885 */;
...
export default function TwoFASetupLanding() {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef14886, style: tmp.authIcon }), , ];
