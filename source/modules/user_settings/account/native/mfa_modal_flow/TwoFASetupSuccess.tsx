...
// Dependencies: [5, 32, 19, 17, 21, 4574, 576, 6611, 1114, 14810, 6963, 14811, 14821, 4570, 1178, 4989, 2]
// Exports: default
...
export default function TwoFASetupSuccess() {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              c5 = 3;
              c6 = 1;
              const obj5 = { value: setRegistering(6611).finishRegisterWebAuthnCredential(intl.string(setRegistering(1114).t["8H5RmH"]), closure_129_0, closure_129_1), done: false };
              return obj5;
            }
          } else {
            if (2 === tmp8) {
              ...
              setError(14810).close();
              c4 = 0;
              const obj = setError(14810);
            }
            c4 = 0;
            c6 = 3;
  ...
  items[1] = closure_8(closure_7, { source: _mod14821, style: tmp.image });
