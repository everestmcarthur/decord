...
// Dependencies: [5, 32, 19, 17, 21, 4607, 576, 6669, 1114, 14836, 7021, 14837, 14847, 4603, 1178, 5027, 2]
// Exports: default

// Module 14846 (TwoFASetupSuccess)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import native from "native" /* 1178 */;
import Text_Text from "Text/Text" /* 4603 */;
import components_Button_Button from "components/Button/Button" /* 5027 */;
import TwoFASetupModal from "TwoFASetupModal" /* 14837 */;
...
export default function TwoFASetupSuccess() {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              c5 = 3;
              c6 = 1;
              const obj5 = { value: setRegistering(6669).finishRegisterWebAuthnCredential(intl.string(setRegistering(1114).t["8H5RmH"]), closure_129_0, closure_129_1), done: false };
              return obj5;
            }
          } else {
            if (2 === tmp8) {
              ...
              setError(14836).close();
              c4 = 0;
              const obj = setError(14836);
            }
            c4 = 0;
            c6 = 3;
  ...
  items[1] = closure_8(closure_7, { source: _mod14847, style: tmp.image });
