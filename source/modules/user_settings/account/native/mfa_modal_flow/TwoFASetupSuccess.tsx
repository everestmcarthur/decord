...
// Dependencies: [5, 32, 19, 17, 21, 4605, 576, 6647, 1114, 14859, 6999, 14860, 14870, 4601, 1178, 5025, 2]
// Exports: default
...
export default function TwoFASetupSuccess() {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              c5 = 3;
              c6 = 1;
              const obj5 = { value: setRegistering(6647).finishRegisterWebAuthnCredential(intl.string(setRegistering(1114).t["8H5RmH"]), closure_129_0, closure_129_1), done: false };
              return obj5;
            }
          } else {
            if (2 === tmp8) {
              ...
              setError(14859).close();
              c4 = 0;
              const obj = setError(14859);
            }
            c4 = 0;
            c6 = 3;
  ...
  items[1] = closure_8(closure_7, { source: _mod14870, style: tmp.image });
