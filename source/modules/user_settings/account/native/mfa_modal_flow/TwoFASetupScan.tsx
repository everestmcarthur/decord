...
// Function ID: 14912
// Name: TwoFASetupScan
// Dependencies: [32, 19, 21, 4640, 576, 7303, 14909, 14905, 7237, 1177, 1115, 4636, 5210, 2]
// Exports: default

// Module 14911 (TwoFASetupScan)
...
export default function TwoFASetupScan(totpSecret) {
  ...
  items2[2] = closure_4(totpSecret(4636).Text, { variant: "text-md/bold", style: { textAlign: "center" }, children: totpSecret });
