...
// Function ID: 14904
// Name: TwoFASetupScan
// Dependencies: [32, 19, 21, 4638, 576, 7299, 14901, 14897, 7233, 1177, 1115, 4634, 5208, 2]
// Exports: default

// Module 14903 (TwoFASetupScan)
...
export default function TwoFASetupScan(totpSecret) {
  ...
  items2[2] = closure_4(totpSecret(4634).Text, { variant: "text-md/bold", style: { textAlign: "center" }, children: totpSecret });
