...
// Function ID: 14888
// Name: TwoFASetupScan
// Dependencies: [32, 19, 21, 4639, 576, 7296, 14885, 14881, 7230, 1177, 1115, 4635, 5207, 2]
// Exports: default

// Module 14887 (TwoFASetupScan)
...
export default function TwoFASetupScan(totpSecret) {
  ...
  items2[2] = closure_4(totpSecret(4635).Text, { variant: "text-md/bold", style: { textAlign: "center" }, children: totpSecret });
