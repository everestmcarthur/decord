...
// Dependencies: [19, 21, 1272, 5025, 4603, 6678, 5046, 5630, 2]

// Module 14852 (UserSettingsInputAlert)
...
const hasOwnProperty = { input: "", error: "apply" };
...
prototype["renderContent"] = function renderContent() {
  ...
  if (null != this.props.error) {
    ...
    if (tmp7) {
      ...
      tmp7 = React3(tmp5(4603).Text, obj);
    }
    const items = [tmp7, ];
