...
// Dependencies: [5, 32, 19, 17, 1372, 1074, 21, 4640, 576, 4825, 14827, 4636, 1115, 1484, 504, 4297, 14828, 7104, 7098, 1271, 1485, 7984, 6717, 7112, 7050, 2]
// Exports: default
  ...
  onSubmitEditing = obj5.useCallback(() => {
    if (isMatch) {
      ...
      navigation = closure_4(function*(arg0) {
        ...
        closure_129_0 = yield closure_2_2(7098).saveAccountChanges(user, { close: false });
        if (!closure_129_0.ok) {
