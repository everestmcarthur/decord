...
// Dependencies: [19, 17, 1074, 12505, 21, 4607, 576, 12506, 1242, 5659, 9151, 4603, 1114, 5027, 2]
// Exports: default
...
export default function NotificationPermissionSettingsHeader() {
  ...
  canSeePushNotificationNudge = canSeePushNotificationNudge(12506).useCanSeePushNotificationNudge();
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj5.children = closure_11(tmp2(9151).BellSlashIcon, obj6);
    ...
    items1[1] = closure_11(tmp2(4603).Text, obj7);
    ...
    items1[2] = closure_11(tmp2(4603).Text, obj8);
    ...
    obj10.onPress = tmp6;
    obj9.children = closure_11(tmp2(5027).Button, obj10);
    items1[3] = closure_11(View, obj9);
    obj4.children = items1;
    obj3.children = closure_12(View, obj4);
    obj2.children = closure_11(tmp2(5659).Card, obj3);
