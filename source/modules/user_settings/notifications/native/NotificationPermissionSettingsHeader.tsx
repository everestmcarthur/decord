...
// Dependencies: [19, 17, 1074, 12480, 21, 4605, 576, 12481, 1242, 5657, 9128, 4601, 1114, 5025, 2]
// Exports: default

// Module 15565 (NotificationPermissionSettingsHeader)
...
export default function NotificationPermissionSettingsHeader() {
  ...
  canSeePushNotificationNudge = canSeePushNotificationNudge(12481).useCanSeePushNotificationNudge();
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj5.children = closure_11(tmp2(9128).BellSlashIcon, obj6);
    ...
    items1[1] = closure_11(tmp2(4601).Text, obj7);
    ...
    items1[2] = closure_11(tmp2(4601).Text, obj8);
    ...
    obj10.onPress = tmp6;
    obj9.children = closure_11(tmp2(5025).Button, obj10);
    items1[3] = closure_11(View, obj9);
    obj4.children = items1;
    obj3.children = closure_12(View, obj4);
    obj2.children = closure_11(tmp2(5657).Card, obj3);
