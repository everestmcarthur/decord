...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4605, 576, 6672, 510, 10261, 1611, 7102, 5173, 1114, 8426, 10262, 9122, 8943, 4601, 2]
// Exports: default

// Module 15650 (UserSettingsPushNotificationLogs)
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7102).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10261)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10262)(closure_128_0, false) };
          tmp2(8426).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(9122).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5173).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(8943).FlashList, obj4);
  obj.children = items2;
