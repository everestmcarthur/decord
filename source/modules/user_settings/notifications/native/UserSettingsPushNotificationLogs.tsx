...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4640, 576, 6733, 510, 10337, 1612, 7164, 5210, 1115, 8510, 10338, 9207, 8873, 4636, 2]
// Exports: default

// Module 15689 (UserSettingsPushNotificationLogs)
...
let size = { backgroundColor: nativeDefault.colors.INPUT_BACKGROUND_DEFAULT, marginLeft: nativeDefault.space.PX_8, borderRadius: nativeDefault.radii.md, height: fn(6733).InputHeights.MD, width: fn(6733).InputHeights.MD, justifyContent: "center", alignItems: "center" };
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7164).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10337)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10338)(closure_128_0, false) };
          tmp2(8510).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(9207).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5210).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(8873).FlashList, obj4);
  obj.children = items2;
