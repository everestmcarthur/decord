...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4607, 576, 6694, 510, 10282, 1611, 7124, 5175, 1114, 8449, 10283, 9145, 8966, 4603, 2]
// Exports: default

// Module 15633 (UserSettingsPushNotificationLogs)
...
let size = { backgroundColor: nativeDefault.colors.INPUT_BACKGROUND_DEFAULT, marginLeft: nativeDefault.space.PX_8, borderRadius: nativeDefault.radii.md, height: fn(6694).InputHeights.MD, width: fn(6694).InputHeights.MD, justifyContent: "center", alignItems: "center" };
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7124).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10282)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10283)(closure_128_0, false) };
          tmp2(8449).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(9145).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5175).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(8966).FlashList, obj4);
  obj.children = items2;
