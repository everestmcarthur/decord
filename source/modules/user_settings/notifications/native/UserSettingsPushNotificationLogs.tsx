...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4606, 576, 6693, 510, 10280, 1611, 7123, 5174, 1114, 8447, 10281, 9143, 8964, 4602, 2]
// Exports: default
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7123).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10280)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10281)(closure_128_0, false) };
          tmp2(8447).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(9143).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5174).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(8964).FlashList, obj4);
  obj.children = items2;
