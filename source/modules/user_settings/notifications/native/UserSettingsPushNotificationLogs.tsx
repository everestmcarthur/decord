...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4574, 576, 6636, 510, 10223, 1611, 7064, 5137, 1114, 8389, 10224, 9085, 8906, 4570, 2]
// Exports: default

// Module 15601 (UserSettingsPushNotificationLogs)
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7064).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10223)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10224)(closure_128_0, false) };
          tmp2(8389).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(9085).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5137).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(8906).FlashList, obj4);
  obj.children = items2;
