...
// Dependencies: [5, 1244, 1115, 9780, 1249, 4229, 2]
...
let closure_4 = identity.createWithEqualityFn(() => ({ isLightsEnabled: "unicodeVersion", isVibrationsEnabled: "children", isSoundsEnabled: "isArray", isNotifyEveryTime: "id" }));
const size = fn(2);
