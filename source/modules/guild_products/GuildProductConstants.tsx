...
// Module 5264 (GuildProductConstants)
...
export const MAX_ATTACHMENT_UPLOAD_TOTAL_FILESIZE_BYTES = 1073741824;
export const MAX_ATTACHMENT_UPLOAD_COUNT = 10;
export const MAX_PUBLISHED_GUILD_PRODUCT_LISTINGS = 50;
