...
// Dependencies: [19, 17, 4632, 4866, 21, 4640, 504, 1364, 4350, 2]
// Exports: default

// Module 15815 (CheckpointKnickKnacks)
import noop from "module_19" /* 19 */;
import AccessibilityStore from "AccessibilityStore" /* 4632 */;

const require = fn;
const View = fn(17).View;
const CHECKPOINT_PRIMARY = fn(4866).CHECKPOINT_PRIMARY;
const jsx = fn(21).jsx;
...
export default function CheckpointKnickKnacks(style) {
  ...
  if (!obj2.isAndroid()) {
    ...
    obj3.children = jsx(tmp(4350).CheckpointKnickKnacksRive, { artboard: "Entry", dataBinding: memo });
