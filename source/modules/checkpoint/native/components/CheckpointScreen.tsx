...
// Dependencies: [19, 17, 4866, 1074, 21, 576, 4640, 7095, 5074, 15813, 2]
// Exports: default

// Module 15812 (CheckpointScreen)
...
export default function CheckpointScreen(children) {
  ...
  const items1 = [closure_9(insets(5074), { colors, start: VerticalGradient.START, end: VerticalGradient.END, style: tmp.background }), , ];
