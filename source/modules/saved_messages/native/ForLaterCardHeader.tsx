...
// Dependencies: [17, 1980, 21, 4638, 576, 7319, 504, 5670, 11059, 1177, 5156, 4791, 5113, 1115, 4634, 2]
// Exports: ForLaterCardHeader

// Module 12357 (ForLaterCardHeader)
...
function HeaderIcon(channel) {
  ...
  if (null != stateFromStores) {
    const obj2 = { guild: stateFromStores, size: tmp2(5670).GuildIconSizes.XSMALL };
    ...
    if (isGroupDMResult) {
      ...
      const obj4 = { style: tmp.dmIcon, children: tmp6(tmp2(5156).ChatIcon, { size: "xxs" }) };
...
function ChannelName(channel) {
  ...
  const channelIconComponentWithGuild = channel(5113).getChannelIconComponentWithGuild(channel, stateFromStores);
  ...
  const items1 = [tmp12, closure_5(channel(4634).Text, { style: tmp.channelName, variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: formatToPlainStringResult })];
