...
// Dependencies: [17, 1980, 21, 4640, 576, 7323, 504, 5672, 11067, 1177, 5158, 4793, 5115, 1115, 4636, 2]
// Exports: ForLaterCardHeader

// Module 12366 (ForLaterCardHeader)
...
function HeaderIcon(channel) {
  ...
  if (null != stateFromStores) {
    ...
    if (isGroupDMResult) {
      ...
      const obj4 = { style: tmp.dmIcon, children: tmp6(tmp2(5158).ChatIcon, { size: "xxs" }) };
...
function ChannelName(channel) {
  ...
  const items1 = [tmp12, closure_5(channel(4636).Text, { style: tmp.channelName, variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: formatToPlainStringResult })];
