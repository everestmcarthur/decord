...
// Dependencies: [17, 1979, 21, 4607, 576, 7283, 504, 5636, 11004, 1178, 5123, 4760, 5080, 1114, 4603, 2]
// Exports: ForLaterCardHeader

// Module 12310 (ForLaterCardHeader)
...
function HeaderIcon(channel) {
  ...
  if (null != stateFromStores) {
    const obj2 = { guild: stateFromStores, size: tmp2(5636).GuildIconSizes.XSMALL };
    ...
    if (isGroupDMResult) {
      ...
      const obj4 = { style: tmp.dmIcon, children: tmp6(tmp2(5123).ChatIcon, { size: "xxs" }) };
...
function ChannelName(channel) {
  ...
  const channelIconComponentWithGuild = channel(5080).getChannelIconComponentWithGuild(channel, stateFromStores);
  ...
  const items1 = [tmp12, closure_5(channel(4603).Text, { style: tmp.channelName, variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: formatToPlainStringResult })];
