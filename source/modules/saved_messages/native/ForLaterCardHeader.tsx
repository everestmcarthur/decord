...
// Dependencies: [17, 1980, 21, 4639, 576, 7316, 504, 5669, 11046, 1177, 5155, 4792, 5112, 1115, 4635, 2]
// Exports: ForLaterCardHeader

// Module 12349 (ForLaterCardHeader)
...
function HeaderIcon(channel) {
  ...
  if (null != stateFromStores) {
    ...
    if (isGroupDMResult) {
      ...
      const obj4 = { style: tmp.dmIcon, children: tmp6(tmp2(5155).ChatIcon, { size: "xxs" }) };
...
function ChannelName(channel) {
  ...
  const items1 = [tmp12, closure_5(channel(4635).Text, { style: tmp.channelName, variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: formatToPlainStringResult })];
