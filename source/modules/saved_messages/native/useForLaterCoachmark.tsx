...
// Dependencies: [32, 19, 17, 1954, 21, 1943, 4605, 13368, 7906, 7440, 1114, 11199, 2]
// Exports: default

// Module 16485 (useForLaterCoachmark)
...
export default function useForLaterCoachmark(targetRef) {
  ...
  obj = first(7906);
  const tmp4 = _slicedToArray(first(7440).useSelectedDismissibleContent(items1, undefined, true), 2);
  first = tmp4[0];
  closure_1 = tmp6;
  ...
  const coachmark = first(11199).useCoachmark(targetRef, memo);
  return tmp4[1];
};
