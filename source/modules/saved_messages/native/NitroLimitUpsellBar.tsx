...
// Dependencies: [17, 21, 4639, 576, 8714, 10095, 4635, 1115, 10101, 5059, 2]
// Exports: default

// Module 12355 (NitroLimitUpsellBar)
...
export default function NitroLimitUpsellBar(isAtLimit) {
  ...
  if (isAtLimit) {
    ...
    const obj3 = { source: _modDef10095, style: tmp.icon };
