...
// Dependencies: [17, 21, 4605, 576, 8658, 10033, 4601, 1114, 10040, 5025, 2]
// Exports: default

// Module 12291 (NitroLimitUpsellBar)
...
export default function NitroLimitUpsellBar(isAtLimit) {
  ...
  if (isAtLimit) {
    ...
    const obj3 = { source: _modDef10033, style: tmp.icon };
