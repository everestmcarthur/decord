...
// Dependencies: [17, 21, 4638, 576, 8723, 10103, 4634, 1115, 10109, 5060, 2]
// Exports: default

// Module 12363 (NitroLimitUpsellBar)
...
export default function NitroLimitUpsellBar(isAtLimit) {
  ...
  if (isAtLimit) {
    ...
    const obj3 = { source: _modDef10103, style: tmp.icon };
