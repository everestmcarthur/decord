...
// Dependencies: [17, 21, 4640, 576, 8743, 10114, 4636, 1115, 10120, 5062, 2]
// Exports: default

// Module 12372 (NitroLimitUpsellBar)
...
export default function NitroLimitUpsellBar(isAtLimit) {
  ...
  if (isAtLimit) {
    ...
    const obj3 = { source: _modDef10114, style: tmp.icon };
