...
// Function ID: 13392
// Name: ForLaterIntro
// Dependencies: [17, 7225, 21, 4607, 576, 7934, 13392, 13393, 4603, 1114, 13394, 11802, 4570, 7283, 2]
// Exports: default

// Module 13391 (ForLaterIntro)
...
import BookmarkIcon from "BookmarkIcon" /* 11802 */;
...
function IntroDemo(isReminder) {
  ...
  const obj3 = { source: { uri: _modDef13394 }, style: tmp.avatar };
...
export default function ForLaterIntro(type) {
  ...
  const items = [timestampProducer(React3, { source: importDefault(tmp4 ? 13392 : 13393), style: tmp.upsellImage }), , ];
  ...
  const obj3 = { source: importDefault(tmp4 ? 13392 : 13393), style: tmp.upsellImage };
