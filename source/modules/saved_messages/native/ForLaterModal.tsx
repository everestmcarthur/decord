...
// Function ID: 7969
// Name: ForLaterModal
// Dependencies: [19, 17, 21, 4639, 576, 1612, 1115, 7966, 5716, 7969, 1364, 5709, 4842, 13419, 2]
// Exports: default

// Module 7968 (ForLaterModal)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4842 */;
import HeaderShared from "HeaderShared" /* 7969 */;
import ForLaterScreenDefault from "ForLaterScreen" /* 13419 */;
...
export default function ForLaterModal(type) {
  ...
  const items = [closure_4(require("module_5716").Header, obj3), ];
