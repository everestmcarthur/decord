...
// Function ID: 7978
// Name: ForLaterModal
// Dependencies: [19, 17, 21, 4638, 576, 1612, 1115, 7975, 5717, 7978, 1364, 5710, 4841, 13430, 2]
// Exports: default

// Module 7977 (ForLaterModal)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4841 */;
import HeaderShared from "HeaderShared" /* 7978 */;
import ForLaterScreenDefault from "ForLaterScreen" /* 13430 */;
...
export default function ForLaterModal(type) {
  ...
  const items = [closure_4(require("module_5717").Header, obj3), ];
