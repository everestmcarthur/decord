...
// Function ID: 7984
// Name: ForLaterModal
// Dependencies: [19, 17, 21, 4640, 576, 1612, 1115, 7981, 5719, 7984, 1364, 5712, 4843, 13438, 2]
// Exports: default

// Module 7983 (ForLaterModal)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4843 */;
import HeaderShared from "HeaderShared" /* 7984 */;
import ForLaterScreenDefault from "ForLaterScreen" /* 13438 */;
...
export default function ForLaterModal(type) {
  ...
  const items = [closure_4(require("module_5719").Header, obj3), ];
