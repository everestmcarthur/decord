...
// Dependencies: [21, 11862, 12368, 4602, 2]
// Exports: ForLaterCardReminderHeader

// Module 13446 (ForLaterCardReminderHeader)
import jsxProd from "jsxProd" /* 21 */;
import SavedMessageUtils from "SavedMessageUtils" /* 11862 */;
...
export const ForLaterCardReminderHeader = function ForLaterCardReminderHeader(savedMessage) {
  ...
  if (null != savedMessage.saveData.dueAt) {
    ...
    tmp7 = jsx(tmp(12368).ForLaterCardStatusHeader, { IconComponent: tmp(4602).ClockIcon, label: tmp5, isCritical: tmp6, actions });
  }
  return tmp7;
};
