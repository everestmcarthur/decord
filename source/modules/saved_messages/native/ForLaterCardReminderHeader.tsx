...
// Dependencies: [21, 11853, 12359, 4600, 2]
...
export const ForLaterCardReminderHeader = function ForLaterCardReminderHeader(savedMessage) {
  ...
  if (null != savedMessage.saveData.dueAt) {
    const obj3 = { IconComponent: tmp(4600).ClockIcon, label: tmp5, isCritical: tmp6, actions };
    tmp7 = jsx(tmp(12359).ForLaterCardStatusHeader, { IconComponent: tmp(4600).ClockIcon, label: tmp5, isCritical: tmp6, actions });
  }
  return tmp7;
};
