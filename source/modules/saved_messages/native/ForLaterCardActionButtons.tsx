...
// Dependencies: [19, 17, 21, 4606, 4573, 11803, 1896, 11797, 11802, 1114, 11829, 5731, 13386, 10339, 8757, 8172, 8764, 2]
// Exports: default
...
export default function ForLaterCardActionButtons(savedMessage) {
  ...
  const callback = noop.useCallback(() => ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11803, dependencyMap.paths), "MessageReminderDurationActionSheet", {
    createReminder(dueAt) {
      const obj2 = {};
      const merged = Object.assign(closure_1_0.saveData);
      obj2.dueAt = dueAt;
      obj2.source = savedMessage(11802).SavedMessageSources.FOR_LATER_LIST;
      return savedMessage(11797).addOrUpdateSavedMessage(obj2);
    },
    removeReminder() {
      return savedMessage(11797).removeSavedMessage({ channelId: closure_1_0.saveData.channelId, messageId: closure_1_0.saveData.messageId, displayToast: true, isReminder: true });
    },
  ...
  items1[1] = {
    ...
    IconComponent: savedMessage(5731).XSmallIcon,
    action() {
  ...
  if (null == savedMessage.saveData.dueAt) {
    ...
    obj3.children = jsx(tmp3(8757).ContextMenu, {
      items: items1,
      keyboardShouldPersistTaps: "handled",
      triggerOnTap: true,
      children(ref) {
