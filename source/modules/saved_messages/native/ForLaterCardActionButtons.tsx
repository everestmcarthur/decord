...
// Dependencies: [19, 17, 21, 4607, 4574, 11805, 1896, 11799, 11804, 1114, 11831, 5732, 13388, 10341, 8759, 8173, 8766, 2]
// Exports: default

// Module 13387 (ForLaterCardActionButtons)
...
export default function ForLaterCardActionButtons(savedMessage) {
  ...
  const callback = noop.useCallback(() => ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11805, dependencyMap.paths), "MessageReminderDurationActionSheet", {
    createReminder(dueAt) {
      const obj2 = {};
      const merged = Object.assign(closure_1_0.saveData);
      obj2.dueAt = dueAt;
      obj2.source = savedMessage(11804).SavedMessageSources.FOR_LATER_LIST;
      return savedMessage(11799).addOrUpdateSavedMessage(obj2);
    },
    removeReminder() {
      return savedMessage(11799).removeSavedMessage({ channelId: closure_1_0.saveData.channelId, messageId: closure_1_0.saveData.messageId, displayToast: true, isReminder: true });
    },
  ...
  obj.IconComponent = savedMessage(11831).ChatArrowRightIcon;
  ...
  items1[1] = {
    ...
    IconComponent: savedMessage(5732).XSmallIcon,
    action() {
  ...
  if (null == savedMessage.saveData.dueAt) {
    ...
    const obj4 = {
      ...
      children(ref) {
          ...
          obj.size = "sm";
          obj.icon = jumpToMessage(8766);
          return jsx(savedMessage(8173).IconButton, { ref: ref.ref });
        }
    };
    obj3.children = jsx(tmp3(8759).ContextMenu, {
      items: items1,
      keyboardShouldPersistTaps: "handled",
      triggerOnTap: true,
      children(ref) {
    ...
    if (savedMessage.throttledNow > savedMessage.saveData.dueAt) {
      let PencilIcon = tmp3(13388).BellZIcon;
    } else {
      PencilIcon = tmp3(10341).PencilIcon;
    }
