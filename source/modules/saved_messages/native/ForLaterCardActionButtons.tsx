...
// Dependencies: [19, 17, 21, 4639, 4606, 11844, 1897, 11838, 11843, 1115, 11870, 5765, 13425, 10381, 8792, 8205, 8799, 2]
// Exports: default

// Module 13424 (ForLaterCardActionButtons)
...
export default function ForLaterCardActionButtons(savedMessage) {
  ...
  const callback = noop.useCallback(() => ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11844, dependencyMap.paths), "MessageReminderDurationActionSheet", {
    createReminder(dueAt) {
      const obj2 = {};
      const merged = Object.assign(closure_1_0.saveData);
      obj2.dueAt = dueAt;
      obj2.source = savedMessage(11843).SavedMessageSources.FOR_LATER_LIST;
      return savedMessage(11838).addOrUpdateSavedMessage(obj2);
    },
    removeReminder() {
      return savedMessage(11838).removeSavedMessage({ channelId: closure_1_0.saveData.channelId, messageId: closure_1_0.saveData.messageId, displayToast: true, isReminder: true });
    },
  ...
  obj.IconComponent = savedMessage(11870).ChatArrowRightIcon;
  ...
  items1[1] = {
    ...
    IconComponent: savedMessage(5765).XSmallIcon,
    action() {
  ...
  if (null == savedMessage.saveData.dueAt) {
    ...
    const obj4 = {
      ...
      children(ref) {
          ...
          return jsx(savedMessage(8205).IconButton, { ref: ref.ref });
        }
    };
    obj3.children = jsx(tmp3(8792).ContextMenu, {
      items: items1,
      keyboardShouldPersistTaps: "handled",
      triggerOnTap: true,
      children(ref) {
    ...
    if (savedMessage.throttledNow > savedMessage.saveData.dueAt) {
      let PencilIcon = tmp3(13425).BellZIcon;
    } else {
      PencilIcon = tmp3(10381).PencilIcon;
    }
