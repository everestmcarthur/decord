...
// Dependencies: [19, 17, 21, 4638, 4605, 11852, 1897, 11846, 11851, 1115, 11878, 5766, 13436, 10389, 8801, 8214, 8808, 2]
// Exports: default

// Module 13435 (ForLaterCardActionButtons)
...
export default function ForLaterCardActionButtons(savedMessage) {
  ...
  const callback = noop.useCallback(() => ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11852, dependencyMap.paths), "MessageReminderDurationActionSheet", {
    createReminder(dueAt) {
      const obj2 = {};
      const merged = Object.assign(closure_1_0.saveData);
      obj2.dueAt = dueAt;
      obj2.source = savedMessage(11851).SavedMessageSources.FOR_LATER_LIST;
      return savedMessage(11846).addOrUpdateSavedMessage(obj2);
    },
    removeReminder() {
      return savedMessage(11846).removeSavedMessage({ channelId: closure_1_0.saveData.channelId, messageId: closure_1_0.saveData.messageId, displayToast: true, isReminder: true });
    },
  ...
  obj.IconComponent = savedMessage(11878).ChatArrowRightIcon;
  ...
  items1[1] = {
    ...
    IconComponent: savedMessage(5766).XSmallIcon,
    action() {
  ...
  if (null == savedMessage.saveData.dueAt) {
    ...
    const obj4 = {
      ...
      children(ref) {
          ...
          obj.size = "sm";
          obj.icon = jumpToMessage(8808);
          return jsx(savedMessage(8214).IconButton, { ref: ref.ref });
        }
    };
    obj3.children = jsx(tmp3(8801).ContextMenu, {
      items: items1,
      keyboardShouldPersistTaps: "handled",
      triggerOnTap: true,
      children(ref) {
    ...
    if (savedMessage.throttledNow > savedMessage.saveData.dueAt) {
      let PencilIcon = tmp3(13436).BellZIcon;
    } else {
      PencilIcon = tmp3(10389).PencilIcon;
    }
