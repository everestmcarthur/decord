...
// Dependencies: [32, 19, 17, 21, 4574, 576, 1611, 1874, 4541, 9749, 1896, 1114, 5645, 7877, 1115, 5638, 5137, 4570, 2]

// Module 11744 (MessageRemindersCustomDurationModal)
...
export default noop.memo((onClose) => {
  ...
  function handleOpenDatePicker(date) {
    ...
    obj2.openLazy(asyncRequireImpl(9749, dependencyMap.paths), "DatePicker", obj3);
  }
  const tmp = onPress();
  ...
  obj5 = onClose(1115);
  obj3.headerLeft = onClose(5638).getHeaderCloseButton(onClose);
  ...
  const items1 = [error(onClose(5645).Header, obj3), ];
  ...
  obj8.children = intl.string(onClose(1114).t.pSZKvM);
  const items2 = [error(onClose(4570).Text, obj8), ];
  ...
  obj9.accessibilityLabel = intl2.string(onClose(1114).t.pSZKvM);
  obj9.accessibilityValue = { text: formatResult };
  obj9.onPress = function onPress() {
    handleOpenDatePicker("date");
  };
  obj9.style = tmp.inputContainer;
  obj9.children = error(onClose(4570).Text, { variant: "text-md/medium", children: formatResult });
  items2[1] = error(onClose(5137).PressableOpacity, obj9);
  ...
  obj10.children = intl3.string(onClose(1114).t.GOmEb8);
  const items4 = [error(onClose(4570).Text, obj10), , ];
  ...
  obj11.accessibilityLabel = intl4.string(onClose(1114).t.GOmEb8);
  obj11.accessibilityValue = { text: formatResult1 };
  obj11.onPress = function onPress() {
    handleOpenDatePicker("time");
  };
  obj11.style = tmp.inputContainer;
  obj11.children = error(onClose(4570).Text, { variant: "text-md/medium", children: formatResult1 });
  items4[1] = error(onClose(5137).PressableOpacity, obj11);
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp11(4570).Text, obj12);
  }
