...
// Dependencies: [5, 11810, 1074, 1271, 7981, 573, 4863, 2]
// Exports: deleteSavedMessage, fetchAndUpdateSavedMessages, upsertSavedMessage

// Module 11856 (SavedMessagesActions)
...
let closure_8 = async function _fetchAndUpdateSavedMessages() {
  ...
  closure_128_1 = results.map((message) => {
    ...
    if (null != message.message) {
      messageRecord = closure_1_0(4863).createMessageRecord(message.message);
      const obj = closure_1_0(4863);
    }
    const obj2 = { message: messageRecord, saveData: closure_1_0(7981).savedMessageDataToClient(message.save_data) };
    return obj2;
  });
