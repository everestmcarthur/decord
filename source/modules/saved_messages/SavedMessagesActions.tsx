...
// Dependencies: [5, 11753, 1074, 1272, 7933, 573, 4829, 2]
// Exports: deleteSavedMessage, fetchAndUpdateSavedMessages, upsertSavedMessage

// Module 11798 (SavedMessagesActions)
...
let closure_8 = async function _fetchAndUpdateSavedMessages() {
  ...
  closure_128_1 = results.map((message) => {
    ...
    if (null != message.message) {
      messageRecord = closure_1_0(4829).createMessageRecord(message.message);
      const obj = closure_1_0(4829);
    }
    const obj2 = { message: messageRecord, saveData: closure_1_0(7933).savedMessageDataToClient(message.save_data) };
    return obj2;
  });
