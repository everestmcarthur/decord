...
require = fn;
let items = ["GB", "AU"];
HermesBuiltin.arraySpread(fn(4858).CountryCodesSets.EU_COUNTRIES, 2);
...
export const useIsTeenInCountrySet = function useIsTeenInCountrySet(set) {
  ...
  let userIsTeen = stateFromStores(8799).useUserIsTeen();
  if (userIsTeen) {
