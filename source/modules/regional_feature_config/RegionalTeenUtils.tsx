...
require = fn;
let items = ["GB", "AU"];
HermesBuiltin.arraySpread(fn(4856).CountryCodesSets.EU_COUNTRIES, 2);
...
export const useIsTeenInCountrySet = function useIsTeenInCountrySet(set) {
  ...
  let userIsTeen = stateFromStores(8779).useUserIsTeen();
  if (userIsTeen) {
