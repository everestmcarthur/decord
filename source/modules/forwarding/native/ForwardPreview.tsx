...
// Function ID: 11700
// Name: MessagePreview
// Dependencies: [19, 17, 21, 4560, 576, 4495, 8126, 7932, 8657, 11700, 1894, 11701, 12, 11702, 1114, 11704, 10137, 5087, 10117, 5587, 1476, 8818, 4556, 2914, 8143, 2]
// Exports: ForwardPreview

// Module 11699 (MessagePreview)
...
import useForwardPreviewContent from "useForwardPreviewContent" /* 11700 */;
...
function MessagePreview(content) {
  ...
  const callback = React.useCallback((message) => {
    message.contextType = attachmentCount(closure_1_2[6]).MessageContextType.SEARCH;
    let num = 2;
    if (attachmentCount > 0) {
      num = 1;
    }
  ...
  obj[4] = memo;
  return callback(DCDChatItemDefault, obj);
}
...
export const ForwardPreview = function ForwardPreview(message) {
  ...
  const tmp = callback3();
  let obj = useForwardPreviewContent;
    ...
    if (num2 > 0) {
      ...
      if (num3 > 0) {
        if (length === num3) {
          ...
          const obj2 = { uri: null };
          let obj17 = getSrcWithWidthAndHeightDefault;
      ...
      if (length > 0) {
        ...
        if (null != proxyURL) {
          ...
          let obj9 = { uri: null };
          obj9 = getSrcWithWidthAndHeightDefault;
          obj9[0] = obj9.getMobileOptimizedSrc(embeds[0].thumbnail.proxyURL, c7, c7);
          obj8[0] = obj9;
          obj8[1] = c7;
          obj8[2] = c7;
          obj7[1] = callback(preloadDefault, obj8);
          tmp7 = callback(View, obj7);
          tmp8 = AttachmentIcon;
          tmp9 = formatToPlainStringResult;
          const tmp17 = preloadDefault;
        }
      }
    }
    if (num3 > 0) {
  ...
  if (attachments.length > 1) {
    ...
    if (null != tmp7) {
      ...
      obj13[0] = tmp2(8818).CutoutShape.RoundedRect;
  ...
  if (tmp36Result3) {
    ...
    obj26[3] = obj28;
    obj25[1] = tmp36(preloadDefault, obj26);
    tmp36Result3 = tmp36(tmp35, obj25);
    const tmp46 = preloadDefault;
  }
