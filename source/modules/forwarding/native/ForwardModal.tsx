...
// Function ID: 11833
// Name: ForwardModal
// Dependencies: [5, 32, 19, 17, 7708, 7712, 8484, 1958, 4861, 8509, 11833, 11014, 21, 4640, 576, 1478, 11140, 504, 11831, 11830, 5718, 11834, 4338, 1115, 1370, 11836, 4986, 11837, 10092, 4651, 11838, 11839, 4785, 4608, 4609, 4337, 7303, 1364, 11142, 7491, 4582, 5212, 11143, 11842, 11154, 2]
// Exports: default

// Module 11832 (ForwardModal)
...
import ForwardDestinationUtils from "ForwardDestinationUtils" /* 11834 */;
              ...
              if (arg0 === 1) {
                ...
                if (forwardOptions(source[25])(message, closure_129_1)) {
                  const promise = new Promise((arg0) => {
                    closure_0 = arg0;
                    closure_1_0(4986).openAlert("staff-to-non-staff-forward", closure_1_15(forwardOptions(11837), {
                      onConfirm() {
