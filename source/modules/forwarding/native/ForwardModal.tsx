...
// Function ID: 11714
// Name: ForwardModal
// Dependencies: [5, 32, 19, 17, 7610, 8363, 1957, 4795, 8388, 11714, 10892, 21, 4574, 576, 1477, 11013, 504, 11712, 11711, 5644, 11715, 4272, 1114, 1369, 11716, 4920, 11717, 9973, 4585, 11718, 11719, 4719, 4542, 4543, 4271, 7203, 1115, 11015, 7391, 4517, 5139, 11016, 11722, 11027, 2]
// Exports: default
              ...
              if (arg0 === 1) {
                ...
                if (forwardOptions(source[24])(message, closure_129_1)) {
                  const promise = new Promise((arg0) => {
                    closure_0 = arg0;
                    closure_1_0(4920).openAlert("staff-to-non-staff-forward", ref2(forwardOptions(11717), {
                      onConfirm() {
