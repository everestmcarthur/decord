...
// Dependencies: [32, 5, 1958, 4276, 1074, 4631, 8478, 7790, 1097, 7792, 1385, 7566, 11826, 4881, 2]

// Module 11829 (ForwardActionCreators)
import allSettledDefault from "allSettled" /* 4881 */;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (prop) {
                let guild_id = tmp2(8478).GAME_CONTENT_GUILD_ID;
              ...
              if (null == channel) {
                ...
                const parsed = item(7790).parse(channel, "");
                ...
                let num9 = 0;
                if (null != withMessage) {
                  const tmp39 = v3(item(7792)(withMessage), 2);
                  num9 = 0;
                  if (tmp39[0]) {
            ...
            if (1 === tmp5) {
              if (arg0 === 1) {
                ...
                if (!result) {
                  result = tmp2(11826).isRatelimitedInChannel(closure_128_0, PermissionStore);
                  const obj2 = tmp2(11826);
                }
                if (!result) {
                  const obj3 = item(7566);
                  const id = closure_128_0.id;
                  const obj25 = { location: constants2.FORWARDING, flags: closure_128_1 };
                  dependencyMap = 2;
                  v3 = 1;
                  const obj26 = { value: obj3.sendMessage(id, item(7790).parse(closure_128_0, closure_128_2), false, obj25), done: false };
                  return obj26;
                }
              }
            } else if (arg0 === 1) {
