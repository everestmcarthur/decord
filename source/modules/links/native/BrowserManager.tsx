...
// Function ID: 4603
// Name: BrowserManager
// Dependencies: [5, 17, 1364, 4603, 4604, 560, 1094, 4332, 1370, 2]
...
import NativeBrowserManagerModuleDefault from "NativeBrowserManagerModule" /* 4603 */;
    ...
    if (selectedBrowser !== tmp2(1094).WebBrowserType.CHROME) {
      ...
      if (tmp2(1094).WebBrowserType.IN_APP === selectedBrowser) {
        ...
        if (tmp2Result3.isAndroid()) {
          let openInChromeURLResult = tmp6(4603).openInChromeURL(href);
          const tmp6Result = tmp6(4603);
        } else {
          openInChromeURLResult = tmp6(4604).openInChromeURL(href, true);
          const tmp6Result2 = tmp6(4604);
        }
...
export const browserManagerSelectBrowser = function browserManagerSelectBrowser(selectedBrowser) {
  if (obj.isAndroid()) {
    const obj3 = {};
    obj3[tmp(1094).WebBrowserType.SAFARI] = tmp(4603).BrowserType.SAFARI;
    obj3[tmp(1094).WebBrowserType.IN_APP] = tmp(4603).BrowserType.IN_APP;
    obj3[tmp(1094).WebBrowserType.CHROME] = tmp(4603).BrowserType.CHROME;
