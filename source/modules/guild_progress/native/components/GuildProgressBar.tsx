...
// Dependencies: [19, 17, 21, 4639, 12609, 576, 4376, 4640, 4643, 2]
// Exports: default

// Module 14069 (GuildProgressBar)
...
const obj2 = { wrapper: { position: "relative", backgroundColor: fn(12609).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 }, progress: null };
let obj3 = { position: "relative", backgroundColor: fn(12609).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 };
