...
// Dependencies: [19, 17, 21, 4636, 12603, 576, 4373, 4637, 4640, 2]
// Exports: default

// Module 14063 (GuildProgressBar)
...
const obj2 = { wrapper: { position: "relative", backgroundColor: fn(12603).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 }, progress: null };
let obj3 = { position: "relative", backgroundColor: fn(12603).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 };
