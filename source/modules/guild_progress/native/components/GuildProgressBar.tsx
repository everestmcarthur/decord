...
// Dependencies: [19, 17, 21, 4636, 12604, 576, 4373, 4637, 4640, 2]
// Exports: default

// Module 14064 (GuildProgressBar)
...
const obj2 = { wrapper: { position: "relative", backgroundColor: fn(12604).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 }, progress: null };
let obj3 = { position: "relative", backgroundColor: fn(12604).PROGRESS_BACKGROUND_COLOR, borderRadius: nativeDefault.radii.xs, height: 8 };
...
export default function GuildProgressBar(percent) {
  ...
  obj3.style = items1;
  const animatedStyle = percent(4373).useAnimatedStyle(fn);
  const obj4 = { style: null };
  const items2 = [tmp.progress, animatedStyle];
  obj4.style = items2;
  obj3.children = jsx(sharedValue(4373).View, { style: null });
