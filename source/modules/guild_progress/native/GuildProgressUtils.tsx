...
// Dependencies: [2012, 1979, 4245, 12570, 12564, 1074, 4574, 12571, 1896, 12572, 504, 12567, 12683, 1114, 11, 2]
// Exports: createGuildProgress, hideActionSheet, openActionSheet, useGuildProgressStep, useIsEligibleForGuildProgress

// Module 12569 (GuildProgressUtils)
...
function useIOSCompletionStates(guild) {
  ...
  if (stateFromStores) {
    const ServerSetupBoostCtaExperiment = tmp(12683).ServerSetupBoostCtaExperiment;
...
export const openActionSheet = function openActionSheet(guild) {
  ...
  obj.openLazy(asyncRequireImpl(12571, dependencyMap.paths), "guild-progress-" + guild.id, { guild });
};
