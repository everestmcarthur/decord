...
// Dependencies: [2012, 1979, 4275, 12604, 12598, 1074, 4603, 12605, 1896, 12606, 504, 12601, 12717, 1114, 11, 2]
...
export const openActionSheet = function openActionSheet(guild) {
  ...
  obj.openLazy(asyncRequireImpl(12605, dependencyMap.paths), "guild-progress-" + guild.id, { guild });
};
