...
// Dependencies: [2012, 1979, 4245, 12568, 12562, 1074, 4573, 12569, 1896, 12570, 504, 12565, 12681, 1114, 11, 2]
// Exports: createGuildProgress, hideActionSheet, openActionSheet, useGuildProgressStep, useIsEligibleForGuildProgress

// Module 12567 (GuildProgressUtils)
...
export const openActionSheet = function openActionSheet(guild) {
  ...
  obj.openLazy(asyncRequireImpl(12569, dependencyMap.paths), "guild-progress-" + guild.id, { guild });
};
