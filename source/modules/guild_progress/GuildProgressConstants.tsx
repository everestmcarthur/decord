...
// Module 12562 (GuildProgressConstants)
...
export const AnalyticsSetupTypes = { CHANNEL_WELCOME: "Channel Welcome CTA", GUILD_PROGRESS: "Guild Progress", HUB_PROGRESS: "Hub Progress" };
