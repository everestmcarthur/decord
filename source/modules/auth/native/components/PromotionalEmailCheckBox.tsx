...
// Dependencies: [19, 17, 6644, 21, 4605, 4323, 1114, 5667, 4601, 2]
// Exports: default

// Module 16067 (PromotionalEmailCheckBox)
...
const PromoEmailConsentStore = fn(6644);
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    const items = [closure_6(tmp4(5667).FormCheckbox, obj4), ];
    ...
    items[1] = closure_6(tmp4(4601).Text, obj5);
    obj3.children = items;
