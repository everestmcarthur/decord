...
// Dependencies: [19, 17, 6704, 21, 4640, 4358, 1115, 5705, 4636, 2]
// Exports: default

// Module 16137 (PromotionalEmailCheckBox)
...
const PromoEmailConsentStore = fn(6704);
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    const items = [closure_6(tmp4(5705).FormCheckbox, obj4), ];
    ...
    items[1] = closure_6(tmp4(4636).Text, obj5);
    obj3.children = items;
