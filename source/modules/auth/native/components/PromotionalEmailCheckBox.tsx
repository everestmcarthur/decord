...
// Dependencies: [19, 17, 6702, 21, 4638, 4356, 1115, 5703, 4634, 2]
// Exports: default

// Module 16115 (PromotionalEmailCheckBox)
...
const PromoEmailConsentStore = fn(6702);
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    const items = [closure_6(tmp4(5703).FormCheckbox, obj4), ];
    ...
    items[1] = closure_6(tmp4(4634).Text, obj5);
    obj3.children = items;
