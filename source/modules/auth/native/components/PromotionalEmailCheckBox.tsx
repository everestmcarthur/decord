...
// Dependencies: [19, 17, 6666, 21, 4607, 4325, 1114, 5669, 4603, 2]
// Exports: default

// Module 16056 (PromotionalEmailCheckBox)
...
const PromoEmailConsentStore = fn(6666);
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    const items = [closure_6(tmp4(5669).FormCheckbox, obj4), ];
    ...
    items[1] = closure_6(tmp4(4603).Text, obj5);
    obj3.children = items;
