...
// Dependencies: [19, 17, 6665, 21, 4606, 4325, 1114, 5668, 4602, 2]
// Exports: default
...
const PromoEmailConsentStore = fn(6665);
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    const items = [closure_6(tmp4(5668).FormCheckbox, obj4), ];
    ...
    items[1] = closure_6(tmp4(4602).Text, obj5);
    obj3.children = items;
