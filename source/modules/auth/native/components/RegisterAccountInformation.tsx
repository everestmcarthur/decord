...
// Dependencies: [5, 32, 19, 17, 6700, 4623, 8868, 16056, 16057, 1074, 21, 4639, 576, 4376, 7049, 16053, 504, 16079, 16081, 16064, 1115, 16072, 16055, 16071, 7077, 16082, 16083, 5059, 7046, 5663, 2]
// Exports: default

// Module 16078 (RegisterAccountInformation)
...
import AuthFormViewDefault from "AuthFormView" /* 7077 */;
import useInitialRegistrationStepDefault from "useInitialRegistrationStep" /* 16071 */;
import useAuthFlowBackHandlerDefault from "useAuthFlowBackHandler" /* 16072 */;
...
export default function RegisterAccountInformation() {
  ...
  const result = context(16064).hasAllRegistrationFieldsCompleted(obj6, { isConsentRequired: true === stateFromStores1 });
  ConsentStore = result;
  ...
  const items4 = [closure_17(closure_6, { style: tmp4.container, children: closure_17(context(16082).RegisterUsernameInput, { username, setUsername, onSubmitEditing: callback, usernameStatus, submitBehavior: "submit", autoFocus: true }) }), , ];
  ...
  if (null != tmp11.message) {
    ...
    if ("" !== tmp11.message) {
      ...
      tmp27Result = tmp27(tmp(7046), obj15);
    }
  }
  ...
  if (!tmp3) {
    ...
    tmp27Result4 = tmp27(tmp(5663), obj16);
  }
  return tmp27Result4;
};
