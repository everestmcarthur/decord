...
// Dependencies: [5, 32, 19, 16028, 16029, 1074, 21, 16025, 16044, 5042, 7097, 1114, 7131, 16057, 7132, 2]
// Exports: default

// Module 16056 (components/VerifyPhone)
import RegistrationBailoutButtonDefault from "RegistrationBailoutButton" /* 16057 */;
...
export default function VerifyPhone(phone) {
  ...
  onBail(function*(arg0) {
    ...
    yield onPhoneTokenReceived(7097).verifyPhone(closure_0, closure_0, false);
    if (1 === tmp7) {
      v0 = 0;
  ...
  obj.footer = memo;
  obj.disabled = tmp5;
  return jsx(onPhoneTokenReceived(7132), { title, description, error: tmp3, onCodeEntered, codeType: null, footer: null, disabled: null, loading: null, disableKeyboardAvoidingView: true });
};
