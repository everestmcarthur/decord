...
// Function ID: 7078
// Name: AuthFormView
// Dependencies: [19, 17, 21, 4639, 576, 7049, 7078, 7079, 7080, 7083, 2]
// Exports: default

// Module 7077 (AuthFormView)
import nativeDefault from "native" /* 576 */;
import useWideAuthViewDefault from "useWideAuthView" /* 7049 */;
import WideAuthScrollContext from "WideAuthScrollContext" /* 7078 */;
...
export default function AuthFormView(arg0) {
  ...
  if (tmp3) {
    ...
    if (null != headerText) {
      ...
      tmp15 = timestampProducer(tmp(7079), obj3);
    }
    const items1 = [tmp15, , ];
    let tmp17 = null;
    if (null != subHeader) {
    ...
    const items3 = [timestampProducer(tmp(7080), obj5), timestampProducer(tmp(7083), {}), ];
