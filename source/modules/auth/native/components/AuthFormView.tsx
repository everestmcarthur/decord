...
// Function ID: 7023
// Name: AuthFormView
// Dependencies: [19, 17, 21, 4605, 576, 6994, 7023, 7024, 7025, 7028, 2]
// Exports: default

// Module 7022 (AuthFormView)
import nativeDefault from "native" /* 576 */;
import useWideAuthViewDefault from "useWideAuthView" /* 6994 */;
import WideAuthScrollContext from "WideAuthScrollContext" /* 7023 */;
...
export default function AuthFormView(arg0) {
  ...
  if (tmp3) {
    ...
    if (null != headerText) {
      ...
      tmp15 = timestampProducer(tmp(7024), obj3);
    }
    const items1 = [tmp15, , ];
    let tmp17 = null;
    if (null != subHeader) {
    ...
    const items3 = [timestampProducer(tmp(7025), obj5), timestampProducer(tmp(7028), {}), ];
