...
// Function ID: 16056
// Name: PrivacyHint
// Dependencies: [19, 17, 6666, 16017, 1074, 21, 4607, 4603, 1114, 4325, 5669, 8686, 16056, 2]
// Exports: default
...
function PrivacyPolicyCheckbox(onToggleConsent) {
  ...
  if (asCheckbox) {
    ...
    let tmp7Result = tmp7(tmp2(5669).FormCheckbox, obj3);
    let tmp9 = tmp7;
  } else {
    const obj4 = { selected: consent };
    tmp7Result = tmp7(tmp2(8686).FormRow.Radio, obj4);
    tmp9 = tmp7;
  }
