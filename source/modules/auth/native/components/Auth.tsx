...
// Function ID: 16074
// Name: Auth
// Dependencies: [32, 19, 17, 12556, 1074, 21, 16074, 16075, 5710, 16084, 7112, 7059, 4638, 576, 16125, 7052, 1626, 7083, 16126, 7081, 7110, 1365, 1115, 16127, 7585, 16131, 2]
...
import BackgroundImageDefault from "BackgroundImage" /* 7083 */;
import StackNavigator from "StackNavigator" /* 7112 */;
import RegistrationHandoff from "RegistrationHandoff" /* 16074 */;
import RegistrationUtils from "RegistrationUtils" /* 16084 */;
import useIsHCaptchaModalOpenTracking from "useIsHCaptchaModalOpenTracking" /* 16125 */;
import _mod16126 from "module_16126" /* 16126 */;
import AuthManagerDefault from "AuthManager" /* 16127 */;
import useOrientationLockDefault from "useOrientationLock" /* 16131 */;
...
function NavigatorWithCaptchaHook() {
  ...
  obj3.backgroundImageSource = _mod16126;
  ...
  if (tmp5) {
    ...
    obj10.children = tmp17(tmp(7110).Navigator, obj11);
    obj7.children = tmp17(closure_6, obj10);
    obj5.children = tmp17(closure_6, obj7);
    let tmp17Result = tmp17(tmp(7081).WideAuthScrollContext.Provider, obj5);
    tmpResult = tmp(1365);
  } else {
    ...
    tmp17Result = tmp17(tmp(7110).Navigator, obj13);
  }
...
let RegistrationStepsUtils = fn(16075);
