...
// Function ID: 16096
// Name: Auth
// Dependencies: [32, 19, 17, 12565, 1074, 21, 16096, 16097, 5712, 16106, 7116, 7063, 4640, 576, 16147, 7056, 1626, 7087, 16148, 7085, 7114, 1365, 1115, 16149, 7589, 16153, 2]
...
import BackgroundImageDefault from "BackgroundImage" /* 7087 */;
import StackNavigator from "StackNavigator" /* 7116 */;
import RegistrationHandoff from "RegistrationHandoff" /* 16096 */;
import RegistrationUtils from "RegistrationUtils" /* 16106 */;
import useIsHCaptchaModalOpenTracking from "useIsHCaptchaModalOpenTracking" /* 16147 */;
import _mod16148 from "module_16148" /* 16148 */;
import AuthManagerDefault from "AuthManager" /* 16149 */;
import useOrientationLockDefault from "useOrientationLock" /* 16153 */;
...
function NavigatorWithCaptchaHook() {
  ...
  obj3.backgroundImageSource = _mod16148;
  ...
  if (tmp5) {
    ...
    obj10.children = tmp17(tmp(7114).Navigator, obj11);
    obj7.children = tmp17(closure_6, obj10);
    obj5.children = tmp17(closure_6, obj7);
    let tmp17Result = tmp17(tmp(7085).WideAuthScrollContext.Provider, obj5);
    tmpResult = tmp(1365);
  } else {
    ...
    tmp17Result = tmp17(tmp(7114).Navigator, obj13);
  }
...
let RegistrationStepsUtils = fn(16097);
