...
// Function ID: 16068
// Name: auth/register
// Dependencies: [5, 16068, 502, 1074, 1099, 4231, 1241, 4832, 1249, 4541, 11415, 573, 16069, 16070, 2]
// Exports: default, registerPhone, scorePassword

// Module 16067 (auth/register)
...
import AgeGateActionCreatorsAll from "AgeGateActionCreators" /* 16070 */;
...
function registerFull(giftCodeSKUId) {
  ...
  if (null != birthday) {
    tmp4(16069)(birthday, constants2.REGISTER);
    ...
    const diffResult = tmp4(4231)().diff(birthday, "years");
    if (diffResult >= 13) {
      if (diffResult < 13) {
        let str3 = "23+";
        if (diffResult >= 18) {
...
const ParentalConsentStore = fn(16068);
