...
// Function ID: 15991
// Name: auth/register
// Dependencies: [5, 15991, 502, 1074, 1098, 4166, 1242, 4767, 1250, 4476, 11309, 573, 15992, 15993, 2]
// Exports: default, registerPhone, scorePassword

// Module 15990 (auth/register)
...
import AgeGateActionCreatorsAll from "AgeGateActionCreators" /* 15993 */;
...
function registerFull(giftCodeSKUId) {
  ...
  if (null != birthday) {
    tmp4(15992)(birthday, constants2.REGISTER);
    ...
    const diffResult = tmp4(4166)().diff(birthday, "years");
    if (diffResult >= 13) {
      if (diffResult < 13) {
        let str3 = "23+";
        if (diffResult >= 18) {
...
const ParentalConsentStore = fn(15991);
