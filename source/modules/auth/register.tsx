...
// Function ID: 16088
// Name: auth/register
// Dependencies: [5, 16088, 502, 1074, 1099, 4229, 1241, 4831, 1249, 4539, 11423, 573, 16089, 16090, 2]
// Exports: default, registerPhone, scorePassword

// Module 16087 (auth/register)
...
import AgeGateActionCreatorsAll from "AgeGateActionCreators" /* 16090 */;
...
function registerFull(giftCodeSKUId) {
  ...
  if (null != birthday) {
    tmp4(16089)(birthday, constants2.REGISTER);
    ...
    const diffResult = tmp4(4229)().diff(birthday, "years");
    if (diffResult >= 13) {
      if (diffResult < 13) {
        let str3 = "23+";
        if (diffResult >= 18) {
...
const ParentalConsentStore = fn(16088);
