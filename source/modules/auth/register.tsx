...
// Function ID: 16110
// Name: auth/register
// Dependencies: [5, 16110, 502, 1074, 1099, 4231, 1241, 4833, 1249, 4541, 11431, 573, 16111, 16112, 2]
// Exports: default, registerPhone, scorePassword

// Module 16109 (auth/register)
...
import AgeGateActionCreatorsAll from "AgeGateActionCreators" /* 16112 */;
...
function registerFull(giftCodeSKUId) {
  ...
  if (null != birthday) {
    tmp4(16111)(birthday, constants2.REGISTER);
...
const ParentalConsentStore = fn(16110);
