...
// Dependencies: [19, 17, 1980, 21, 4640, 576, 504, 17590, 17594, 7311, 11528, 4636, 1115, 5672, 5062, 7109, 1936, 4338, 9720, 4607, 14021, 2]
// Exports: default

// Module 17593 (DmSettingsUpsellActionSheet)
...
import DmSettingsUpsellManager from "DmSettingsUpsellManager" /* 17590 */;
import DmSettingsUpsellUtils from "DmSettingsUpsellUtils" /* 17594 */;
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj4 = { source: stateFromStores(11528), style: tmp.headerImage };
    ...
    items2[1] = closure_7(tmp2(4636).Text, obj5);
    ...
    items2[2] = closure_7(tmp2(4636).Text, obj6);
    ...
    const items3 = [closure_7(tmp2(4636).Text, obj9), ];
    const obj10 = { style: tmp.guildInfo, children: null };
    const obj11 = { guild: stateFromStores, size: tmp2(5672).GuildIconSizes.SMALL_32 };
    const items4 = [closure_7(stateFromStores(5672), obj11), ];
    const obj12 = { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: stateFromStores.name };
    items4[1] = closure_7(tmp2(4636).Text, obj12);
    ...
    const obj13 = {
      ...
      onPress() {
          ...
          RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
            const obj2 = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: stateFromStores(9720), content: null };
            const intl = guildId(1115).intl;
            obj2.content = intl.string(guildId(1115).t.rlYD1W);
            stateFromStores(4338).open(obj2);
          });
    ...
    items2[4] = closure_7(tmp2(5062).Button, obj13);
    const obj14 = {
      size: "lg",
      variant: "secondary",
      onPress() {
    ...
    items2[5] = closure_7(tmp2(5062).Button, obj14);
    ...
    items2[6] = closure_7(tmp2(4636).Text, obj15);
    obj3.children = items2;
    obj2.children = closure_8(closure_4, obj3);
    tmp6 = closure_7(tmp2(7311).ActionSheet, obj2);
    const tmp12 = stateFromStores(5672);
  }
  return tmp6;
};
