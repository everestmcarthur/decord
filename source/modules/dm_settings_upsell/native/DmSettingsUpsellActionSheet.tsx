...
// Dependencies: [19, 17, 1979, 21, 4574, 576, 504, 17374, 17378, 7211, 11406, 4570, 1114, 5598, 4989, 7009, 1935, 4272, 9598, 4541, 13933, 2]
// Exports: default

// Module 17377 (DmSettingsUpsellActionSheet)
...
import DmSettingsUpsellManager from "DmSettingsUpsellManager" /* 17374 */;
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj4 = { source: stateFromStores(11406), style: tmp.headerImage };
    ...
    items2[2] = closure_7(tmp2(4570).Text, obj6);
    ...
    const items3 = [closure_7(tmp2(4570).Text, obj9), ];
    const obj10 = { style: tmp.guildInfo, children: null };
    const obj11 = { guild: stateFromStores, size: tmp2(5598).GuildIconSizes.SMALL_32 };
    const items4 = [closure_7(stateFromStores(5598), obj11), ];
    const obj12 = { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: stateFromStores.name };
    items4[1] = closure_7(tmp2(4570).Text, obj12);
    ...
    const obj13 = {
      ...
      onPress() {
          ...
          RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
            const obj2 = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: stateFromStores(9598), content: null };
            const intl = guildId(1114).intl;
            obj2.content = intl.string(guildId(1114).t.rlYD1W);
            stateFromStores(4272).open(obj2);
          });
    ...
    items2[4] = closure_7(tmp2(4989).Button, obj13);
    const obj14 = {
      size: "lg",
      variant: "secondary",
      onPress() {
    ...
    items2[5] = closure_7(tmp2(4989).Button, obj14);
    ...
    items2[6] = closure_7(tmp2(4570).Text, obj15);
    obj3.children = items2;
    obj2.children = closure_8(closure_4, obj3);
    tmp6 = closure_7(tmp2(7211).ActionSheet, obj2);
