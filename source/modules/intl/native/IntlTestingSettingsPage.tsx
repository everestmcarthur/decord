...
// Dependencies: [32, 5, 19, 17, 2027, 2026, 21, 4638, 576, 5771, 1115, 9501, 5774, 504, 4229, 5773, 5691, 1154, 5058, 4634, 15741, 15773, 2]
// Exports: default

// Module 15740 (IntlTestingSettingsPage)
...
import _modDef15773 from "module_15773" /* 15773 */;
...
export default function IntlTestingSettingsPage() {
  ...
  obj9.children = intl6.format(_modDef15741.XOdbAy, {
    ...
    usernameHook(children) {
      const obj = { style: { backgroundColor: "green", borderRadius: 4, paddingHorizontal: 6, paddingVertical: 0 }, children: closure_1_10(closure_0(4634).Text, { variant: "text-sm/normal", color: "text-overlay-light", children }) };
