...
// Function ID: 7591
// Name: CacheStore
// Dependencies: [32, 5, 5365, 502, 2012, 4461, 1074, 3, 510, 2009, 7591, 7602, 9, 10, 2008, 7603, 7604, 7605, 7606, 7607, 7758, 7779, 504, 573, 2007, 7764, 7770, 7768, 7762, 1984, 7780, 1364, 7782, 7784, 2004, 2]

// Module 7590 (CacheStore)
...
import modules_MessagesDefault from "modules/Messages" /* 7591 */;
import timeRequireDefault from "timeRequire" /* 7606 */;
      ...
      if (0 === c8) {
        if (arg0 === 1) {
          ...
          if (null == closure_0) {
            ...
            resolved = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: user_settings", async () => closure_1(7603).getAll(closure_1_0));
          }
          if (null == closure_0) {
            let resolved1 = Promise.resolve([]);
          } else {
            resolved1 = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: read_states", async () => closure_1(7604).getAll(closure_1_0));
          }
          if (null == closure_0) {
            let resolveResult = allResult.Promise.resolve([]);
            const _Promise5 = allResult.Promise;
          } else {
            resolveResult = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: user_guild_settings", async () => closure_1(7605).getAll(closure_1_0));
          }
          timeRequireDefault("AllCacheStores", () => closure_1_0(7607));
          timeRequireDefault("MobileAppDatabaseManager", () => closure_1_0(7758));
          let items = [
            result,
            measureAsyncResult,
          ...
          if (null == closure_0) {
            ...
            if ("private-channels" !== page) {
              ...
              if (c22) {
                c6 = 1;
                c7 = 1;
                const obj6 = { value: TryLoad.tryLoadAsync(async () => closure_1(10).timeAsync("\u{1F4BE}", "cache: guilds", async () => closure_2_1(7764).getAsync(closure_1_0))), done: false };
                return obj6;
              } else {
                c6 = 2;
                c7 = 1;
        ...
        if (arg0 === 1) {
          ...
          if (null != closure_132_2) {
            if ("@me" !== closure_132_2) {
              c6 = 3;
              c7 = 1;
              const obj13 = { value: closure_133_0(closure_133_2[24]).tryLoadAsync(async () => closure_1(7764).getOneAsync(closure_1_0, dependencyMap)), done: false };
              return obj13;
            }
          }
          c7 = 3;
            ...
            value: fetchLazyCache.measureAsync(async () => {
                      const items = [
                        closure_0(initialGuildId[24]).tryLoadAsync(async () => {
                          if (null != closure_1_0) {
                            let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync("\u{1F4BE}", "cache: cache_version", async () => closure_2_1(7768).okAsync(closure_1_0));
                      ...
                      items[1] = closure_0(initialGuildId[24]).tryLoadAsync(async () => {
                        if (null != closure_1_0) {
                          if (!closure_2_22) {
                            let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync("\u{1F4BE}", "cache: lazy guilds", async () => closure_2_1(7764).getAsync(closure_1_0));
                            const obj = closure_2_1(initialGuildId[13]);
                          }
                          return timeAsyncResult;
                        }
                      ...
                      items[2] = closure_0(initialGuildId[24]).tryLoadAsync(async () => {
                        if (null != closure_1_0) {
                          let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync("\u{1F4BE}", "cache: basic_channels", async () => closure_2_1(7762).getAsync(closure_1_0));
              ...
              if (closure_128_5) {
                ...
                const obj11 = {
                  value: (function dontLoadLateLazyCache() {
                                const f126504 = () => closure_1(_true[23]).dispatch({ type: "CACHE_LOADED_LAZY_NO_CACHE" });
