...
// Function ID: 7587
// Name: CacheStore
// Dependencies: [32, 5, 5363, 502, 2012, 4459, 1074, 3, 510, 2009, 7587, 7598, 9, 10, 2008, 7599, 7600, 7601, 7602, 7603, 7752, 7773, 504, 573, 2007, 7758, 7764, 7762, 7756, 1984, 7774, 1364, 7776, 7778, 2004, 2]

// Module 7586 (CacheStore)
...
import TryLoad from "TryLoad" /* 2007 */;
import modules_MessagesDefault from "modules/Messages" /* 7587 */;
import timeRequireDefault from "timeRequire" /* 7602 */;
import NonGuildVersionsDefault from "NonGuildVersions" /* 7764 */;
    ...
    try {
      ...
      if (0 === c8) {
        if (arg0 === 1) {
          ...
          if (null != closure_0) {
            let timeAsyncResult = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: private_channels", async () => closure_1(2008).getAsync(closure_1_0, null));
          } else {
          ...
          if (null == closure_0) {
            ...
            resolved = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: user_settings", async () => closure_1(7599).getAll(closure_1_0));
          }
          if (null == closure_0) {
            let resolved1 = Promise.resolve([]);
          } else {
            resolved1 = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: read_states", async () => closure_1(7600).getAll(closure_1_0));
          }
          if (null == closure_0) {
            let resolveResult = allResult.Promise.resolve([]);
            const _Promise5 = allResult.Promise;
          } else {
            resolveResult = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: user_guild_settings", async () => closure_1(7601).getAll(closure_1_0));
          }
          timeRequireDefault("AllCacheStores", () => closure_1_0(7603));
          timeRequireDefault("MobileAppDatabaseManager", () => closure_1_0(7752));
          let items = [
            result,
            measureAsyncResult,
          ...
          if (null == closure_0) {
            ...
            if ("private-channels" !== page) {
              ...
              if (c22) {
                c6 = 1;
                c7 = 1;
                const obj6 = { value: TryLoad.tryLoadAsync(async () => closure_1(10).timeAsync("\u{1F4BE}", "cache: guilds", async () => closure_2_1(7758).getAsync(closure_1_0))), done: false };
                return obj6;
              } else {
                c6 = 2;
                c7 = 1;
        ...
        if (arg0 === 1) {
          ...
          if (null != closure_132_2) {
            if ("@me" !== closure_132_2) {
              c6 = 3;
              c7 = 1;
              const obj13 = { value: closure_133_0(closure_133_2[24]).tryLoadAsync(async () => closure_1(7758).getOneAsync(closure_1_0, dependencyMap)), done: false };
              return obj13;
            }
          }
          c7 = 3;
            ...
            value: fetchLazyCache.measureAsync(async () => {
                      const items = [
                        closure_0(initialGuildId[24]).tryLoadAsync(async () => {
                          if (null != closure_1_0) {
                            let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync("\u{1F4BE}", "cache: cache_version", async () => closure_2_1(7762).okAsync(closure_1_0));
                      ...
                      items[1] = closure_0(initialGuildId[24]).tryLoadAsync(async () => {
                        if (null != closure_1_0) {
                          if (!closure_2_22) {
                            let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync("\u{1F4BE}", "cache: lazy guilds", async () => closure_2_1(7758).getAsync(closure_1_0));
                            const obj = closure_2_1(initialGuildId[13]);
                          }
                          return timeAsyncResult;
                        }
                      ...
                      items[2] = closure_0(initialGuildId[24]).tryLoadAsync(async () => {
                        if (null != closure_1_0) {
                          let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync("\u{1F4BE}", "cache: basic_channels", async () => closure_2_1(7756).getAsync(closure_1_0));
              ...
              if (closure_128_5) {
                ...
                const obj11 = {
                  value: (function dontLoadLateLazyCache() {
                                const f126107 = () => closure_1(_true[23]).dispatch({ type: "CACHE_LOADED_LAZY_NO_CACHE" });
