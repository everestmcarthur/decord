...
// Dependencies: [19, 17, 11064, 11509, 21, 4638, 576, 563, 11517, 4336, 1115, 9544, 9545, 11516, 4634, 1177, 11524, 11525, 2]
// Exports: default

// Module 11523 (WasThisHelpfulSection)
...
const _modDef9544 = tmp6(9544);
require = fn;
get_ActivityIndicator = fn(17);
({ Pressable: closure_4, View: hasOwnProperty } = get_ActivityIndicator);
let closure_7 = fn(11064).SafetyWarningFeedbackTypes;
