...
// Dependencies: [19, 17, 11072, 11517, 21, 4640, 576, 563, 11525, 4338, 1115, 9555, 9556, 11524, 4636, 1177, 11532, 11533, 2]
// Exports: default

// Module 11531 (WasThisHelpfulSection)
...
const _modDef9555 = tmp6(9555);
require = fn;
get_ActivityIndicator = fn(17);
({ Pressable: closure_4, View: hasOwnProperty } = get_ActivityIndicator);
let closure_7 = fn(11072).SafetyWarningFeedbackTypes;
