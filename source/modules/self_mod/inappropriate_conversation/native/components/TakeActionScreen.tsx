...
// Dependencies: [5, 32, 19, 17, 4288, 1372, 11517, 21, 4640, 576, 504, 11544, 11547, 1484, 9196, 8553, 11524, 8784, 4338, 1115, 4599, 4337, 5062, 11555, 8820, 5135, 8734, 4334, 4636, 2]
// Exports: default

// Module 15860 (TakeActionScreen)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            const obj5 = {
              value: tmp4(8784).submitReportForInappropriateConversationSafetyAlert(lastChannelMessage, () => {
                        dependencyMap(true);
          ...
          closure_128_6(false);
          const result = v1(8553).showReportSuccessToast(closure_128_0, closure_128_1);
          closure_128_3(tmp4(11524).CtaEventTypes.USER_TAKEOVER_MODAL_REPORT);
          const obj = v1(8553);
        }
        dependencyMap = 3;
