...
// Dependencies: [32, 19, 17, 1372, 11517, 21, 4640, 576, 504, 4484, 1484, 5780, 4636, 1115, 5062, 11524, 15860, 11530, 5712, 11548, 4843, 11525, 7114, 2]
// Exports: default

// Module 15859 (InappropriateConversationModal)
...
import TakeActionScreenDefault from "TakeActionScreen" /* 15860 */;
...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items2 = [closure_13(trackAnalyticsEvent(5062).Button, obj6), ];
  ...
  items2[1] = closure_13(trackAnalyticsEvent(5062).Button, obj7);
  obj5.children = items2;
