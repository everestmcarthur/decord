...
// Dependencies: [32, 19, 17, 1372, 11615, 21, 4722, 576, 504, 4566, 1484, 5862, 4718, 1115, 5144, 11622, 15955, 11628, 5794, 11646, 4925, 11623, 7196, 2]
// Exports: default

// Module 15954 (InappropriateConversationModal)
...
import TakeActionScreenDefault from "TakeActionScreen" /* 15955 */;
...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items2 = [closure_13(trackAnalyticsEvent(5144).Button, obj6), ];
  ...
  items2[1] = closure_13(trackAnalyticsEvent(5144).Button, obj7);
  obj5.children = items2;
