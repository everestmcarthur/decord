...
// Dependencies: [32, 19, 17, 1372, 11509, 21, 4638, 576, 504, 4482, 1484, 5778, 4634, 1115, 5060, 11516, 15843, 11522, 5710, 11540, 4841, 11517, 7110, 2]
// Exports: default

// Module 15842 (InappropriateConversationModal)
...
import TakeActionScreenDefault from "TakeActionScreen" /* 15843 */;
...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items2 = [closure_13(trackAnalyticsEvent(5060).Button, obj6), ];
  ...
  items2[1] = closure_13(trackAnalyticsEvent(5060).Button, obj7);
  obj5.children = items2;
