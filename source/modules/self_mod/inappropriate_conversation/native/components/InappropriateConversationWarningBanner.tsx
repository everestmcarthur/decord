...
// Dependencies: [19, 4285, 11047, 21, 11504, 504, 11505, 4981, 11522, 1896, 11525, 11506, 1114, 2]

// Module 11521 (InappropriateConversationWarningBanner)
        ...
        importer() {
          return channelId(senderId[9])(senderId[8], senderId.paths).then((result) => {
            ...
            return (arg0) => {
              ...
              obj.analyticsBlockAndReportContext = closure_3_0(11504).CtaEventTypes.USER_BANNER_BLOCK_AND_REPORT_CONFIRM;
