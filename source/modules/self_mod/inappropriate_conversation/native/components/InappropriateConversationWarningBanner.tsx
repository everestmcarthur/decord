...
// Dependencies: [19, 4288, 11072, 21, 11524, 504, 11525, 4985, 11542, 1897, 11545, 11526, 1115, 2]

// Module 11541 (InappropriateConversationWarningBanner)
        ...
        importer() {
          return channelId(senderId[9])(senderId[8], senderId.paths).then((result) => {
            ...
            return (arg0) => {
              ...
              obj.analyticsBlockContext = closure_3_0(11524).CtaEventTypes.USER_BANNER_BLOCK_CONFIRM;
              obj.analyticsBlockAndReportContext = closure_3_0(11524).CtaEventTypes.USER_BANNER_BLOCK_AND_REPORT_CONFIRM;
              obj.analyticsCancelContext = closure_3_0(11524).CtaEventTypes.USER_BANNER_BLOCK_CANCEL;
