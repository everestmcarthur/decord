...
// Dependencies: [10042, 4762, 7228, 2]

// Module 18020 (InappropriateConversationsManager)
import _modDef4762 from "module_4762" /* 4762 */;
...
function fadeIn() {
  ...
  interval = setInterval(() => {
    ...
    if (rounded <= 0) {
      ...
      closure_2.volume = _modDef4762(closure_3, 0, 0.5);
    }
    clearInterval(c5);
    if (tmp9) {
      undefined();
