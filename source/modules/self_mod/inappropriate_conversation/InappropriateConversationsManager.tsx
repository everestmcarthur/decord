...
// Dependencies: [10053, 4764, 7232, 2]

// Module 18084 (InappropriateConversationsManager)
import _modDef4764 from "module_4764" /* 4764 */;
...
function fadeIn() {
  ...
  interval = setInterval(() => {
    ...
    if (rounded <= 0) {
      ...
      closure_2.volume = _modDef4764(closure_3, 0, 0.5);
    }
    clearInterval(c5);
    if (tmp9) {
      undefined();
