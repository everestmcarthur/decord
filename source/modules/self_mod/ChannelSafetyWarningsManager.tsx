...
// Module 17334 (handleChannelSelect)
      ...
      if (null == currentlySelectedChannelId) {
        ...
        if (null == found) {
          ...
          if (!tmp6) {
            ...
            obj[3] = found.id;
            tmp(17335).showTakeoverModal(obj);
            flag3 = true;
            const tmpResult1 = tmp(17335);
          }
          return flag3;
        }
      }
