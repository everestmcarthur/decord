...
// Dependencies: [19, 17, 11509, 21, 4638, 576, 11545, 1115, 4634, 5060, 4332, 11516, 2]
// Exports: default

// Module 11544 (SafetyToolsCrisisTextLineActionSheet)
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  const items = [closure_6(trackAnalyticsEvent(4634).Text, obj3), , ];
  ...
  items[1] = closure_6(trackAnalyticsEvent(5060).Button, obj4);
  ...
  items[2] = closure_6(trackAnalyticsEvent(5060).Button, obj5);
  obj2.children = items;
