...
// Dependencies: [19, 17, 11501, 21, 4639, 576, 11537, 1115, 4635, 5059, 4334, 11508, 2]
// Exports: default

// Module 11536 (SafetyToolsCrisisTextLineActionSheet)
import nativeDefault from "native" /* 576 */;
import LinkingDefault from "Linking" /* 4334 */;
import SafetyWarningUtils from "SafetyWarningUtils" /* 11508 */;
import SafetyToolsActionSheetWrapperDefault from "SafetyToolsActionSheetWrapper" /* 11537 */;
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  const items = [closure_6(trackAnalyticsEvent(4635).Text, obj3), , ];
  ...
  items[1] = closure_6(trackAnalyticsEvent(5059).Button, obj4);
  ...
  items[2] = closure_6(trackAnalyticsEvent(5059).Button, obj5);
  obj2.children = items;
