...
// Dependencies: [32, 19, 4655, 7435, 4847, 4499, 4497, 4498, 4500, 2]
// Exports: isChannelFocused, isChannelFocusedForReadStateAck, useIsChannelFocused

// Module 10220 (isChannelFocused)
...
import NavigationHistoryStore from "NavigationHistoryStore" /* 7435 */;
...
const CHANNEL_PREFIX = fn(7435).CHANNEL_PREFIX;
let c9 = null;
const size = fn(2);
