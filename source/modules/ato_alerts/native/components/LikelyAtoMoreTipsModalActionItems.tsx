...
// Dependencies: [19, 1371, 21, 504, 4451, 5738, 5656, 1114, 9149, 2]
// Exports: default

// Module 11474 (LikelyAtoMoreTipsModalActionItems)
...
export default function LikelyAtoMoreTipsModalActionItems(senderId) {
  ...
  obj3.icon = jsx(senderId(9149).BellSlashIcon, {});
  obj2.children = jsx(senderId(5656).TableRow, { label: null, subLabel: null, onPress: null, icon: null });
  return jsx(senderId(5738).TableRowGroup, { hasIcons: true, children: null });
};
