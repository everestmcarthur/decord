...
import closure_5 from "getCurrentBuildOverride" /* 11430 */;
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  const items1 = [str];
  stateFromStores = str(504).useStateFromStores(items, () => closure_1_5.getBuildOverride(str), items1);
  ...
  obj2[2] = intl.string(str(1114).t["6ILkNN"]);
  items2[1] = callback(str(4556).Text, obj2);
  if (null != id) {
    obj3 = { children: null };
    ...
    obj4[3] = id;
    const items3 = [tmp14(tmp5(4556).Text, obj4), ];
    ...
    obj5[3] = intl3.format(tmp5(1114).t.lOsPpu, obj6);
    items3[1] = tmp14(tmp5(4556).Text, obj5);
    obj3[0] = items3;
    ...
    obj7[3] = intl2.string(tmp5(1114).t["cz+sue"]);
    tmp14Result = tmp14(tmp5(4556).Text, obj7);
  }
  ...
  if (null != id) {
    ...
    obj11[0] = intl5.string(tmp5(1114).t.v0MBqF);
