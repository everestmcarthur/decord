...
// Dependencies: [19, 17, 11519, 21, 4606, 576, 4541, 4458, 13924, 13925, 504, 11883, 4198, 7196, 4602, 1114, 5026, 4809, 2]
// Exports: default

// Module 13923 (BuildOverrideModal)
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  let stateFromStores;
  const tmp = closure_9();
  const tmp4 = stateFromStores(4541)();
  if (obj.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(13924);
  } else {
    tmp2Result = tmp2(13925);
  }
  obj = str(4458);
  ...
  if (override != null) {
    ...
    if (targetBuildOverride != null) {
      const tmp9 = targetBuildOverride[tmp5(undefined, 11883).DEVICE_FIELD];
      if (tmp9 != null) {
        id = tmp9.id;
      }
    }
  ...
  if (null != id) {
    ...
    items3[1] = tmp14(tmp5(4602).Text, obj8);
    ...
    tmp14Result = tmp14(tmp5(4602).Text, obj10);
  }
  ...
  if (null != id) {
    ...
    obj13.children = tmp14(tmp5(5026).Button, obj14);
    ...
    items5[1] = tmp14(tmp5(5026).Button, obj15);
    ...
    tmp12Result2 = tmp14(tmp5(5026).Button, obj16);
  }
  obj11.children = tmp12Result2;
  items4[1] = closure_6(closure_4, obj11);
  rect.children = items4;
  return closure_8(str(7196).SafeAreaPaddingView, rect);
};
