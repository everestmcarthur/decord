...
// Dependencies: [19, 17, 11563, 21, 4639, 576, 4574, 4491, 13964, 13965, 504, 11924, 4231, 7230, 4635, 1115, 5059, 4842, 2]
// Exports: default

// Module 13963 (BuildOverrideModal)
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  if (obj.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(13964);
  } else {
    tmp2Result = tmp2(13965);
  }
  obj = str(4491);
  ...
  if (override != null) {
    ...
    if (targetBuildOverride != null) {
      const tmp9 = targetBuildOverride[tmp5(undefined, 11924).DEVICE_FIELD];
      if (tmp9 != null) {
        id = tmp9.id;
      }
    }
  ...
  if (null != id) {
    ...
    items3[1] = tmp14(tmp5(4635).Text, obj8);
    ...
    tmp14Result = tmp14(tmp5(4635).Text, obj10);
  }
  ...
  if (null != id) {
    ...
    obj13.children = tmp14(tmp5(5059).Button, obj14);
    ...
    items5[1] = tmp14(tmp5(5059).Button, obj15);
    ...
    tmp12Result2 = tmp14(tmp5(5059).Button, obj16);
  }
  obj11.children = tmp12Result2;
  items4[1] = closure_6(closure_4, obj11);
  rect.children = items4;
  return closure_8(str(7230).SafeAreaPaddingView, rect);
};
