...
// Dependencies: [19, 17, 5499, 1961, 1957, 2012, 4660, 10246, 1964, 7637, 21, 16283, 16285, 16289, 576, 7175, 7631, 16200, 1114, 12424, 16278, 16290, 16225, 5061, 16292, 16294, 16296, 16300, 16302, 16303, 16304, 16305, 16306, 16309, 16311, 16312, 16315, 16208, 1094, 16319, 16320, 16330, 16332, 16334, 1982, 16218, 5506, 16216, 16335, 2]
...
// Module 16284 (renderRedesignChannelListItem)
...
import CategoryChannel from "CategoryChannel" /* 16200 */;
import ThreadChannelDefault from "ThreadChannel" /* 16208 */;
import VoiceUserSummary from "VoiceUserSummary" /* 16225 */;
import channel_list_v2_ChannelListUtils from "channel_list_v2/ChannelListUtils" /* 16278 */;
import ShowAllVoiceChannelsButtonDefault from "ShowAllVoiceChannelsButton" /* 16290 */;
import SectionFooterHelpers from "SectionFooterHelpers" /* 16335 */;
...
const GuildSidebarConstants = fn(7637);
({ ChannelListChannelNoticeRow: closure_16, ChannelListGuildActionRow: closure_17 } = GuildSidebarConstants);
const jsxProd = fn(21);
({ jsx: closure_18, jsxs: closure_19, Fragment: closure_20 } = jsxProd);
let obj = { nonChannelContainer: { marginHorizontal: 16 }, liveChannelNotice: { marginTop: fn(16283).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16283).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 }, gameClaimNotice: null, applicationAccountLinkNotice: null, showAllVoiceChannelsButtonLastShownChannelActive: null, showAllVoiceChannelsButtonLastShownChannelInactive: null };
let obj2 = { marginTop: fn(16283).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16283).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.gameClaimNotice = { marginTop: fn(16285).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16285).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj3 = { marginTop: fn(16285).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16285).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.applicationAccountLinkNotice = { marginTop: fn(16289).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16289).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj4 = { marginTop: fn(16289).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16289).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
...
export const getFastListRecyclerKey = function getFastListRecyclerKey(guildChannels, arg1, arg2, arg3) {
  ...
  } else if (arg1 === tmp(7175).FastListItemTypes.SECTION) {
  ...
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    if (obj.isNamedCategorySection(section)) {
      ...
      if (null != namedCategoryFromSection) {
        ...
        tmp5 = collapsedCategories(tmp(16200).CategoryChannel, obj8);
      }
      return tmp5;
    } else {
      return null;
...
export const renderChannelListSectionFooter = function renderChannelListSectionFooter(guildChannels, section, ref, channels) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return null;
  } else if (tmp5(7631).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    let flag = false;
...
export const getChannelListSectionFooterSize = function getChannelListSectionFooterSize(guildChannels, section, result) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return 0;
  } else if (tmp3(7631).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    let flag = false;
    if (!guildActionSection.isEmpty()) {
      const rows = guildActionSection.getRows();
    ...
    let num5 = 0;
    if (flag) {
      num5 = tmp3(12424).DIVIDER_HEIGHT;
    }
    return num5;
  } else {
    if (guildChannels.favoritesSectionNumber !== section) {
      if (guildChannels.recentsSectionNumber !== section) {
        if (guildChannels.voiceChannelsSectionNumber === section) {
          ...
          if (!obj.render) {
            ...
            const sum = num + tmp3(5061).SMALL_BUTTON_HEIGHT;
            if (tmp6) {
    ...
    return tmp3(12424).DIVIDER_HEIGHT;
  }
};
export const renderChannelListItem = function renderChannelListItem(arg0) {
  ...
  if (channel(7631).SECTION_INDEX_CHANNEL_NOTICES === section) {
    const channelNoticeSection = guildChannels.getChannelNoticeSection();
    ...
    if (null != row1) {
      if (constants.SPACER === row1) {
        ...
        const obj5 = { guild };
        obj4.children = closure_18(selectedChannelId(16292), obj5);
        tmp65 = closure_18(View, obj4);
      } else if (tmp66.MFA_WARNING === row1) {
        const obj6 = { style: obj.nonChannelContainer, children: closure_18(selectedChannelId(16294), {}) };
        tmp65 = closure_18(View, obj6);
      } else if (tmp66.LIVE_CHANNEL_NOTICE === row1) {
        const obj7 = { style: obj.liveChannelNotice, guild };
        tmp65 = closure_18(selectedChannelId(16283), obj7);
        ...
        if (null != gameClaimMarkAsDismissed) {
          ...
          obj9.children = closure_18(selectedChannelId(16285), obj10);
        ...
        if (null != applicationAccountLinkMarkAsDismissed) {
          ...
          if (null != startApplicationAccountLinkAuthorization) {
            ...
            if (null != accountLinkApplication) {
              ...
              obj11.children = closure_18(selectedChannelId(16289), obj12);
        ...
        if (tmp66.FAVORITES_SUGGESTIONS === row1) {
          tmp65 = closure_18(selectedChannelId(16296), {});
        }
      }
    }
    return tmp65;
  } else if (tmp(7631).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    ...
    if (null != row2) {
      if (constants2.GUILD_ROLE_SUBSCRIPTIONS === row2) {
        ...
        tmp55Result = closure_18(selectedChannelId(16300), obj13);
      } else if (tmp32.GUILD_HOME === row2) {
        const obj14 = { guild, selected: selectedChannelId === StaticChannelRoute.GUILD_HOME };
        tmp55Result = closure_18(selectedChannelId(16302), obj14);
        ...
        tmp55Result = closure_18(tmp(16303).GuildRolesAndChannelsRow, obj15);
        ...
        tmp55Result = closure_18(selectedChannelId(16304), obj16);
        ...
        obj18.children = closure_18(tmp(16305).NewMemberActionsProgress, obj19);
        const items = [closure_18(View, obj18), closure_18(selectedChannelId(12424), {})];
        obj17.children = items;
        tmp55Result = closure_19(View, obj17);
      } else if (tmp32.GUILD_HUB_HEADER_OPTIONS === row2) {
        const obj20 = { guild };
        tmp55Result = closure_18(selectedChannelId(16306), obj20);
    ...
    if (null != channelFromSectionRow) {
      ...
      if (tmp(1094).ChannelTypes.GUILD_APP === type) {
        ...
        const items2 = [closure_18(selectedChannelId(16319), obj27), ];
        ...
        const items3 = [closure_18(selectedChannelId(16320), obj28), ];
        ...
        tmp13 = closure_18(selectedChannelId(16330), obj30);
      } else if (tmp(1094).ChannelTypes.GUILD_STAGE_VOICE === type) {
        const obj31 = { channel: record, selected: tmp5 };
        tmp13 = closure_18(selectedChannelId(16332), obj31);
      } else {
          ...
          if (tmp(1094).ChannelTypes.GROUP_DM !== type) {
            if (section === guildChannels.voiceChannelsSectionNumber) {
              if (record.isCategory()) {
                ...
                let tmp9 = closure_18(tmp(16200).CategoryChannel, obj32);
              }
              tmp13 = tmp9;
            }
            if (tmpResult.isFavoritesGuildId(guildChannels.id)) {
              if (set2.has(record.type)) {
                ...
                tmp9 = closure_18(selectedChannelId(16320), obj33);
              }
            }
            const obj34 = { channel: record, selected: tmp5 };
            tmp9 = closure_18(selectedChannelId(16319), obj34);
            tmpResult = tmp(1982);
          }
        }
        const obj35 = { channel: record, selected: tmp5 };
        tmp13 = closure_18(selectedChannelId(16334), obj35);
      }
    }
    return tmp13;
  }
...
export const getChannelListItemSize = function getChannelListItemSize(liveChannelNoticeHeight) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    ...
    if (constants.SPACER === row1) {
      ...
      return tmp(16292).getScaledGuildProgressButtonHeight(fontScale);
    } else if (tmp28.MFA_WARNING === row1) {
      return tmp(16294).getScaledGuildMFAWarningHeight(fontScale);
      ...
      return tmp(16285).getScaledGameClaimNoticeHeight(fontScale);
    } else if (tmp28.APPLICATION_ACCOUNT_LINK === row1) {
      return tmp(16289).getScaledAccountLinkBannerHeight(fontScale);
                ...
                if (tmp26.GUILD_BOOSTS !== row2) {
                  ...
                  if (tmp26.GUILD_VIBEGRATIONS !== row2) {
                    if (tmp26.GUILD_NEW_MEMBER_ACTIONS_PROGRESS_BAR === row2) {
                      num4 = 48 + tmp(12424).DIVIDER_HEIGHT;
                    } else {
                      ...
                      if (tmp26.GUILD_HUB_HEADER_OPTIONS !== row2) {
                        ...
                        if (tmp26.GUILD_SCHEDULED_EVENTS !== row2) {
                          if (tmp26.GUILD_PREMIUM_PROGRESS_BAR === row2) {
                            num4 = tmp(16315).BOOST_PROGRESS_BAR_HEIGHT + tmp(12424).DIVIDER_HEIGHT;
                          } else {
                            num4 = 0;
    ...
    if (null != channelFromSectionRow) {
      ...
      if (type1 === type) {
              ...
              if (tmp(1094).ChannelTypes.GROUP_DM !== type) {
                if (tmp(1094).ChannelTypes.PUBLIC_THREAD !== type) {
                  if (tmp(1094).ChannelTypes.PRIVATE_THREAD !== type) {
                    ...
                    tmpResult11 = tmp(1982);
                  }
                }
                const result = SortedVoiceStateStore.countVoiceStatesForChannel(record.id);
                let sum1 = tmp31;
                if (result > 0) {
                  sum1 = tmp31 + result * tmp(16218).getVoiceUserHeight(fontScale);
                  const tmpResult12 = tmp(16218);
                }
                num = sum1;
              }
            }
        ...
        const voiceUserHeight = tmp(16218).getVoiceUserHeight(fontScale);
        if (record.type === tmp(1094).ChannelTypes.GUILD_STAGE_VOICE) {
          let participantCount = StageChannelParticipantStore.getParticipantCount(record.id, tmp(5506).StageChannelParticipantNamedIndex.SPEAKER);
        } else {
        ...
        if (record.type === tmp(1094).ChannelTypes.GUILD_STAGE_VOICE) {
          num3 = 0;
          if (StageChannelParticipantStore.getParticipantCount(record.id, tmp(5506).StageChannelParticipantNamedIndex.AUDIENCE) > 0) {
            num3 = tmp(16216).getAudienceItemHeight(fontScale);
            const tmpResult14 = tmp(16216);
          }
        }
        let sum4 = tmp31;
        if (participantCount > 0) {
          const sum2 = tmp31 + num2;
          const sum3 = sum2 + tmp(16330).VOICE_USERS_MARGIN_TOP + voiceUserHeight * participantCount;
          sum4 = sum3 + tmp(16330).VOICE_USERS_MARGIN_BOTTOM + num3;
        }
        num = sum4;
        const tmpResult13 = tmp(16218);
      }
    }
    return num;
  }
...
export const calculateVoiceSummary = function calculateVoiceSummary(arg0) {
  ...
  if (!obj.isVoiceChannelsSection(section, guildChannels)) {
    if (section < tmp(7631).SECTION_INDEX_FIRST_NAMED_CATEGORY) {
      return null;
    }
  }
  obj = channel_list_v2_ChannelListUtils;
  if (tmpResult.getSectionFooterConfig(guildChannels, optInChannelsEnabled, section).canHaveVoiceSummary) {
    ...
    if (null == namedCategoryFromSection) {
      ...
      const sectionFooterActiveVoiceChannels = tmp(16335).getSectionFooterActiveVoiceChannels(obj2);
      let tmp5 = null;
