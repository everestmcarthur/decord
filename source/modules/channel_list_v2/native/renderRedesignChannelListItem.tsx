...
// Dependencies: [19, 17, 5504, 1962, 1958, 2013, 4662, 10256, 1965, 7644, 21, 16318, 16320, 16324, 576, 7182, 7638, 16235, 1115, 12438, 16313, 16325, 16260, 5065, 16327, 16329, 16331, 16335, 16337, 16338, 16339, 16340, 16341, 16344, 16346, 16347, 16350, 16243, 1095, 16354, 16355, 16365, 16367, 16369, 1983, 16253, 5511, 16251, 16370, 2]
...
// Module 16319 (renderRedesignChannelListItem)
...
import CategoryChannel from "CategoryChannel" /* 16235 */;
import ThreadChannelDefault from "ThreadChannel" /* 16243 */;
import VoiceUserSummary from "VoiceUserSummary" /* 16260 */;
import channel_list_v2_ChannelListUtils from "channel_list_v2/ChannelListUtils" /* 16313 */;
import ShowAllVoiceChannelsButtonDefault from "ShowAllVoiceChannelsButton" /* 16325 */;
import SectionFooterHelpers from "SectionFooterHelpers" /* 16370 */;
...
const GuildSidebarConstants = fn(7644);
({ ChannelListChannelNoticeRow: closure_16, ChannelListGuildActionRow: closure_17 } = GuildSidebarConstants);
const jsxProd = fn(21);
({ jsx: closure_18, jsxs: closure_19, Fragment: closure_20 } = jsxProd);
let obj = { nonChannelContainer: { marginHorizontal: 16 }, liveChannelNotice: { marginTop: fn(16318).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16318).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 }, gameClaimNotice: null, applicationAccountLinkNotice: null, showAllVoiceChannelsButtonLastShownChannelActive: null, showAllVoiceChannelsButtonLastShownChannelInactive: null };
let obj2 = { marginTop: fn(16318).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16318).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.gameClaimNotice = { marginTop: fn(16320).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16320).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj3 = { marginTop: fn(16320).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16320).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.applicationAccountLinkNotice = { marginTop: fn(16324).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16324).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj4 = { marginTop: fn(16324).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16324).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
...
export const getFastListRecyclerKey = function getFastListRecyclerKey(guildChannels, arg1, arg2, arg3) {
  ...
  } else if (arg1 === tmp(7182).FastListItemTypes.SECTION) {
  ...
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    if (obj.isNamedCategorySection(section)) {
      ...
      if (null != namedCategoryFromSection) {
        ...
        tmp5 = collapsedCategories(tmp(16235).CategoryChannel, obj8);
      }
      return tmp5;
    } else {
      return null;
...
export const renderChannelListSectionFooter = function renderChannelListSectionFooter(guildChannels, section, ref, channels) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return null;
  } else if (tmp5(7638).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    let flag = false;
...
export const getChannelListSectionFooterSize = function getChannelListSectionFooterSize(guildChannels, section, result) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return 0;
  } else if (tmp3(7638).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    let flag = false;
    if (!guildActionSection.isEmpty()) {
      const rows = guildActionSection.getRows();
    ...
    let num5 = 0;
    if (flag) {
      num5 = tmp3(12438).DIVIDER_HEIGHT;
    }
    return num5;
  } else {
    if (guildChannels.favoritesSectionNumber !== section) {
      if (guildChannels.recentsSectionNumber !== section) {
        if (guildChannels.voiceChannelsSectionNumber === section) {
          ...
          if (!obj.render) {
            ...
            const sum = num + tmp3(5065).SMALL_BUTTON_HEIGHT;
            if (tmp6) {
    ...
    return tmp3(12438).DIVIDER_HEIGHT;
  }
};
export const renderChannelListItem = function renderChannelListItem(arg0) {
  ...
  if (channel(7638).SECTION_INDEX_CHANNEL_NOTICES === section) {
    const channelNoticeSection = guildChannels.getChannelNoticeSection();
    ...
    if (null != row1) {
      if (constants.SPACER === row1) {
        ...
        const obj5 = { guild };
        obj4.children = closure_18(selectedChannelId(16327), obj5);
        tmp65 = closure_18(View, obj4);
      } else if (tmp66.MFA_WARNING === row1) {
        const obj6 = { style: obj.nonChannelContainer, children: closure_18(selectedChannelId(16329), {}) };
        tmp65 = closure_18(View, obj6);
      } else if (tmp66.LIVE_CHANNEL_NOTICE === row1) {
        const obj7 = { style: obj.liveChannelNotice, guild };
        tmp65 = closure_18(selectedChannelId(16318), obj7);
        ...
        if (null != gameClaimMarkAsDismissed) {
          ...
          obj9.children = closure_18(selectedChannelId(16320), obj10);
        ...
        if (null != applicationAccountLinkMarkAsDismissed) {
          ...
          if (null != startApplicationAccountLinkAuthorization) {
            ...
            if (null != accountLinkApplication) {
              ...
              obj11.children = closure_18(selectedChannelId(16324), obj12);
        ...
        if (tmp66.FAVORITES_SUGGESTIONS === row1) {
          tmp65 = closure_18(selectedChannelId(16331), {});
        }
      }
    }
    return tmp65;
  } else if (tmp(7638).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    ...
    if (null != row2) {
      if (constants2.GUILD_ROLE_SUBSCRIPTIONS === row2) {
        ...
        tmp55Result = closure_18(selectedChannelId(16335), obj13);
      } else if (tmp32.GUILD_HOME === row2) {
        const obj14 = { guild, selected: selectedChannelId === StaticChannelRoute.GUILD_HOME };
        tmp55Result = closure_18(selectedChannelId(16337), obj14);
        ...
        tmp55Result = closure_18(tmp(16338).GuildRolesAndChannelsRow, obj15);
        ...
        tmp55Result = closure_18(selectedChannelId(16339), obj16);
        ...
        obj18.children = closure_18(tmp(16340).NewMemberActionsProgress, obj19);
        const items = [closure_18(View, obj18), closure_18(selectedChannelId(12438), {})];
        obj17.children = items;
        tmp55Result = closure_19(View, obj17);
      } else if (tmp32.GUILD_HUB_HEADER_OPTIONS === row2) {
        const obj20 = { guild };
        tmp55Result = closure_18(selectedChannelId(16341), obj20);
    ...
    if (null != channelFromSectionRow) {
      ...
      if (tmp(1095).ChannelTypes.GUILD_APP === type) {
        ...
        const items2 = [closure_18(selectedChannelId(16354), obj27), ];
        ...
        const items3 = [closure_18(selectedChannelId(16355), obj28), ];
        ...
        tmp13 = closure_18(selectedChannelId(16365), obj30);
      } else if (tmp(1095).ChannelTypes.GUILD_STAGE_VOICE === type) {
        const obj31 = { channel: record, selected: tmp5 };
        tmp13 = closure_18(selectedChannelId(16367), obj31);
      } else {
          ...
          if (tmp(1095).ChannelTypes.GROUP_DM !== type) {
            if (section === guildChannels.voiceChannelsSectionNumber) {
              if (record.isCategory()) {
                ...
                let tmp9 = closure_18(tmp(16235).CategoryChannel, obj32);
              }
              tmp13 = tmp9;
            }
            if (tmpResult.isFavoritesGuildId(guildChannels.id)) {
              if (set2.has(record.type)) {
                ...
                tmp9 = closure_18(selectedChannelId(16355), obj33);
              }
            }
            const obj34 = { channel: record, selected: tmp5 };
            tmp9 = closure_18(selectedChannelId(16354), obj34);
            tmpResult = tmp(1983);
          }
        }
        const obj35 = { channel: record, selected: tmp5 };
        tmp13 = closure_18(selectedChannelId(16369), obj35);
      }
    }
    return tmp13;
  }
...
export const getChannelListItemSize = function getChannelListItemSize(liveChannelNoticeHeight) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    ...
    if (constants.SPACER === row1) {
      ...
      return tmp(16327).getScaledGuildProgressButtonHeight(fontScale);
    } else if (tmp28.MFA_WARNING === row1) {
      return tmp(16329).getScaledGuildMFAWarningHeight(fontScale);
      ...
      return tmp(16320).getScaledGameClaimNoticeHeight(fontScale);
    } else if (tmp28.APPLICATION_ACCOUNT_LINK === row1) {
      return tmp(16324).getScaledAccountLinkBannerHeight(fontScale);
                ...
                if (tmp26.GUILD_BOOSTS !== row2) {
                  ...
                  if (tmp26.GUILD_VIBEGRATIONS !== row2) {
                    if (tmp26.GUILD_NEW_MEMBER_ACTIONS_PROGRESS_BAR === row2) {
                      num4 = 48 + tmp(12438).DIVIDER_HEIGHT;
                    } else {
                      ...
                      if (tmp26.GUILD_HUB_HEADER_OPTIONS !== row2) {
                        ...
                        if (tmp26.GUILD_SCHEDULED_EVENTS !== row2) {
                          if (tmp26.GUILD_PREMIUM_PROGRESS_BAR === row2) {
                            num4 = tmp(16350).BOOST_PROGRESS_BAR_HEIGHT + tmp(12438).DIVIDER_HEIGHT;
                          } else {
                            num4 = 0;
    ...
    if (null != channelFromSectionRow) {
      ...
      if (type1 === type) {
          ...
          if (tmp(1095).ChannelTypes.GUILD_STAGE_VOICE !== type) {
            ...
            if (tmp(1095).ChannelTypes.DM !== type) {
              ...
              if (tmp(1095).ChannelTypes.GROUP_DM !== type) {
                ...
                let sum1 = tmp31;
                if (result > 0) {
                  sum1 = tmp31 + result * tmp(16253).getVoiceUserHeight(fontScale);
                  const tmpResult12 = tmp(16253);
                }
                num = sum1;
              }
            }
        ...
        const voiceUserHeight = tmp(16253).getVoiceUserHeight(fontScale);
        if (record.type === tmp(1095).ChannelTypes.GUILD_STAGE_VOICE) {
          let participantCount = StageChannelParticipantStore.getParticipantCount(record.id, tmp(5511).StageChannelParticipantNamedIndex.SPEAKER);
        } else {
        ...
        if (record.type === tmp(1095).ChannelTypes.GUILD_STAGE_VOICE) {
          num3 = 0;
          if (StageChannelParticipantStore.getParticipantCount(record.id, tmp(5511).StageChannelParticipantNamedIndex.AUDIENCE) > 0) {
            num3 = tmp(16251).getAudienceItemHeight(fontScale);
            const tmpResult14 = tmp(16251);
          }
        }
        let sum4 = tmp31;
        if (participantCount > 0) {
          const sum2 = tmp31 + num2;
          const sum3 = sum2 + tmp(16365).VOICE_USERS_MARGIN_TOP + voiceUserHeight * participantCount;
          sum4 = sum3 + tmp(16365).VOICE_USERS_MARGIN_BOTTOM + num3;
        }
        num = sum4;
        const tmpResult13 = tmp(16253);
      }
    }
    return num;
  }
...
export const calculateVoiceSummary = function calculateVoiceSummary(arg0) {
  ...
  if (!obj.isVoiceChannelsSection(section, guildChannels)) {
    if (section < tmp(7638).SECTION_INDEX_FIRST_NAMED_CATEGORY) {
      return null;
    }
  }
  obj = channel_list_v2_ChannelListUtils;
  if (tmpResult.getSectionFooterConfig(guildChannels, optInChannelsEnabled, section).canHaveVoiceSummary) {
    ...
    if (null == namedCategoryFromSection) {
      ...
      const sectionFooterActiveVoiceChannels = tmp(16370).getSectionFooterActiveVoiceChannels(obj2);
      let tmp5 = null;
