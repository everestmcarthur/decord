...
export default function ChannelListStickyHeader(guild) {
  ...
  const tmp6Result5 = guild(4308);
  const token1 = guild(4308).useToken(tmp2(576).modules.mobile.CHANNEL_LIST_SUBTITLE_TEXT_STYLE);
  ...
  if (isFavoritesGuildIdResult) {
    tmp24Result5 = tmp24(tmp6(16221).FavoritesGuildHeaderActionButton, {});
  }
  ...
  if (tmp24Result7) {
    ...
    obj17.children = tmp24(tmp2(16226), obj18);
  ...
  if (flag3) {
    ...
    tmp24Result8 = tmp24(tmp2(16227), obj20);
  }
