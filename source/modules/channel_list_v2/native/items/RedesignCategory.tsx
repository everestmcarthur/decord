...
// Dependencies: [19, 17, 7641, 7227, 4819, 10256, 21, 4638, 1364, 576, 4634, 12896, 5208, 11306, 11700, 11062, 504, 4791, 11126, 16237, 16238, 7223, 1115, 7305, 11701, 6724, 2]
// Exports: CategoryChannel, RecentlyActiveCategory, SuggestedCategory, useCategoryPressEvents

// Module 16236 (RedesignCategory)
...
import useFavoritesGuildCategoryAddActionDefault from "useFavoritesGuildCategoryAddAction" /* 11126 */;
import CategoryCollapseActionCreators from "CategoryCollapseActionCreators" /* 11700 */;
import useFavoritesGuildCategoryFullNoticeDefault from "useFavoritesGuildCategoryFullNotice" /* 16237 */;
import useFavoritesGuildCategoryLongPressDefault from "useFavoritesGuildCategoryLongPress" /* 16238 */;
...
function renderCategoryItem(muted) {
  ...
  if (typeof name === "string") {
    ...
    tmp34Result = closure_11(trailingAction(4634).Text, obj2);
  }
  let tmp3 = null;
  if (null != icon) {
  ...
  if (Icon == null) {
    Icon = trailingAction(12896).PlusMediumIcon;
  }
  if (null == trailingAction) {
    ...
    if (null == note) {
      ...
      if (tmp) {
        ...
        let tmp28Result = tmp28(trailingAction(5208).PressableHighlight, obj7);
      } else {
    ...
    obj10 = tmp9(trailingAction(5208).PressableOpacity, obj10);
    obj9.children = obj10;
...
export const CategoryChannel = function CategoryChannel(channel) {
  ...
  if (null != tmp10) {
    ...
    tmp13 = closure_11(tmp2(4634).Text, obj4);
  }
  obj2.note = tmp13;
  ...
  obj7.icon = closure_11(channel(11306).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed2 ? obj3 : obj4 });
...
export const RecentlyActiveCategory = function RecentlyActiveCategory(guildId) {
  ...
  obj3 = {};
  const merged1 = Object.assign(merged);
  obj3.icon = closure_11(tmp2(11306).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed ? obj3 : obj4 });
