...
// Dependencies: [1961, 502, 4215, 12, 504, 573, 2]

// Module 4214 (JoinedThreadsStore)
import _modDef12 from "module_12" /* 12 */;
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import ChannelRecord from "ChannelRecord" /* 1961 */;
import MuteTimersDefault from "MuteTimers" /* 4215 */;
  ...
  THREAD_MEMBER_LOCAL_UPDATE: function handleThreadMemberLocalUpdate(arg0) {
    ...
    if (tmp3) {
      if (null === guildId) {
        ...
        obj = { threadId: id, guildId, flags: 0, muted: true, muteConfig: { end_time: "disabled" }, joinTimestamp: null };
        const _Date = Date;
        const date = new Date();
        guildId = date;
        obj.joinTimestamp = date;
