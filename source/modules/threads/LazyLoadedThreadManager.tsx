...
// Dependencies: [5365, 1962, 1958, 2012, 1074, 1965, 573, 7335, 4466, 4479, 1271, 2]

// Module 7428 (LazyLoadedThreadManager)
  ...
  loadThreadsBulk(arr) {
    ...
    if (GatewayConnectionStore.isConnected()) {
      ...
      while (iter !== undefined) {
        let tmp9 = nextResult;
        if (nextResult !== items1(7335).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) {
