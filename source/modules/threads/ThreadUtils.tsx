...
// Function ID: 7854
// Name: ThreadUtils
// Dependencies: [109, 4621, 4787, 4247, 1113, 1074, 1114, 7572, 4786, 1242, 7846, 7187, 1384, 504, 11, 4198, 2]
...
export const trackThreadNotificationSettingsUpdated = function trackThreadNotificationSettingsUpdated(getGuildId, flags) {
  ...
  if (null != result) {
    ...
    const currentChannelSettings = tmp(7187).getCurrentChannelSettings(guildId, parent_id);
    ...
    let result1 = tmp(7187).muteConfigToTimestamp(obj7.getMuteConfig(getGuildId.id));
    ...
    if (null != flags.mute_config) {
      result1 = tmp(7187).muteConfigToTimestamp(flags.mute_config);
      const tmpResult4 = tmp(7187);
    }
    obj2.new_thread_muted_until = result1;
    const tmpResult3 = tmp(7187);
