...
// Dependencies: [4606, 16225, 1897, 2]
// Exports: default

// Module 16224 (showThreadLongPressActionSheet)
...
export default function showThreadLongPressActionSheet(channelId) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16225, dependencyMap.paths), "ThreadLongPressActionSheet", {
    channelId,
    onClose() {
