...
// Dependencies: [4541, 16148, 1896, 2]
// Exports: default

// Module 16147 (showThreadLongPressActionSheet)
...
export default function showThreadLongPressActionSheet(channelId) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16148, dependencyMap.paths), "ThreadLongPressActionSheet", {
    channelId,
    onClose() {
