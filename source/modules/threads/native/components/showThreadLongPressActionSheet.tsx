...
// Dependencies: [4607, 16275, 1897, 2]
// Exports: default

// Module 16274 (showThreadLongPressActionSheet)
...
export default function showThreadLongPressActionSheet(channelId) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16275, dependencyMap.paths), "ThreadLongPressActionSheet", {
    channelId,
    onClose() {
