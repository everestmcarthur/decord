...
// Dependencies: [4605, 16245, 1897, 2]
// Exports: default

// Module 16244 (showThreadLongPressActionSheet)
...
export default function showThreadLongPressActionSheet(channelId) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16245, dependencyMap.paths), "ThreadLongPressActionSheet", {
    channelId,
    onClose() {
