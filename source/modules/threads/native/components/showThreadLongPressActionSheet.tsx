...
// Dependencies: [4572, 16197, 1896, 2]
// Exports: default

// Module 16196 (showThreadLongPressActionSheet)
...
export default function showThreadLongPressActionSheet(channelId) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16197, dependencyMap.paths), "ThreadLongPressActionSheet", {
    channelId,
    onClose() {
