...
// Dependencies: [19, 17, 4598, 2021, 1371, 7379, 1074, 1085, 21, 4606, 576, 504, 7853, 5055, 5571, 4602, 1114, 4451, 7384, 4839, 11, 1178, 7962, 8035, 2]
...
function MessageContent(arg0) {
  ...
  const subscribeGuildMembers = message(7384).useSubscribeGuildMembers({ [thread.guild_id]: items }, "ThreadBrowserRowSubtext");
  ...
  obj7.children = closure_9(message(4602).Text, obj8);
...
export const ThreadSubtext = function ThreadSubtext(thread) {
  ...
  const obj2 = id(7853);
  const timestampString = id(7853).getTimestampString(lastMessageTimestamp);
  const tmpResult = id(7853);
  const tmpResult2 = id(7853);
  return closure_9(closure_14, { thread, timestamp: timestampString, accessibilityLabel: id(7853).getTimestampAccessibilityLabel(lastMessageTimestamp) });
};
