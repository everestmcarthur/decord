...
// Dependencies: [19, 17, 4632, 2022, 1372, 7420, 1074, 1085, 21, 4640, 576, 504, 7901, 5091, 5608, 4636, 1115, 4484, 7425, 4873, 11, 1177, 8010, 8097, 2]
// Exports: ThreadSubtext

// Module 16954 (ThreadBrowserRowSubtext)
...
import useHasEnhancedRoleColorsDefault from "useHasEnhancedRoleColors" /* 5091 */;
...
function MessageContent(arg0) {
  ...
  const subscribeGuildMembers = message(7425).useSubscribeGuildMembers({ [thread.guild_id]: items }, "ThreadBrowserRowSubtext");
...
export const ThreadSubtext = function ThreadSubtext(thread) {
  ...
  return closure_9(closure_14, { thread, timestamp: timestampString, accessibilityLabel: id(7901).getTimestampAccessibilityLabel(lastMessageTimestamp) });
};
