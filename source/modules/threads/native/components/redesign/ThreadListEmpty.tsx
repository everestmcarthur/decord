...
// Dependencies: [19, 17, 21, 4574, 576, 1178, 12268, 4570, 1114, 4989, 2]

// Module 16747 (ThreadListEmpty)
...
export default noop.memo((onCreateThreadPress) => {
  ...
  const obj2 = { style: tmp.iconWrapper, children: React4(native.Icon, { source: _modDef12268, size: native.Icon.Sizes.MEDIUM }) };
  ...
  if (tmp4Result) {
    ...
    tmp4Result = React4(tmp5(4989).Button, obj6);
  }
  items[3] = tmp4Result;
  obj.children = items;
