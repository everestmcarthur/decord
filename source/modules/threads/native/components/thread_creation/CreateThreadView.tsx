...
// Dependencies: [5, 32, 19, 17, 4979, 7795, 1074, 21, 4638, 576, 9448, 7891, 7272, 7292, 1612, 7091, 5210, 5158, 16822, 7310, 1115, 16824, 12125, 12100, 12785, 11504, 1485, 1241, 4818, 4503, 1101, 10394, 16823, 4504, 2]

// Module 16821 (CreateThreadView)
...
import useCreateThreadViewPropsDefault from "useCreateThreadViewProps" /* 11504 */;
...
function CreateThreadViewInner(screenIndex) {
  ...
  const tmp12Result = parentChannel(10394)(obj4);
          ...
          if (0 === v2) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  current(closure_0(16823).makeEmptyTitleError());
                  const obj8 = closure_0(16823);
                  closure_0(4504).dismissKeyboard();
                  tmp60.current = false;
                  c5 = 0;
                  c7 = 3;
                  return { value: "HermesInternal", done: null };
            ...
            if (1 === current) {
              ...
              if (code === constants.AUTOMOD_TITLE_BLOCKED) {
                current(closure_0(16823).makeAutomodViolationError(closure_130_0.body, closure_0));
                const obj5 = closure_0(16823);
                closure_0(4504).dismissKeyboard();
                const obj6 = closure_0(4504);
              } else {
                ...
                if (tmp23) {
                  current(closure_0(16823).makeApiNameRequiredError());
                  const obj3 = closure_0(16823);
                  closure_0(4504).dismissKeyboard();
                  const obj4 = closure_0(4504);
                }
              }
            } else if (arg0 === 1) {
              c7 = 3;
              ...
              parentChannel(7891).saveDraft(closure_0.id, "", DraftType.FirstThreadMessage);
              c5 = 0;
              const obj = parentChannel(7891);
            }
            current = tmp60;
  ...
  const tmp12 = parentChannel(10394);
  const tmp11Result = parentChannel(7272);
  const tmp16 = parentChannel(1612)();
  const ref = noop.useRef(null);
  const ref1 = noop.useRef(null);
  let obj5 = { value: tmp11Result(parentChannel(7292).CREATE_THREAD).analyticsLocations, children: null };
  const items3 = [closure_13(parentChannel(5210), { absolute: true }), ];
  let obj6 = { style: null, children: null };
  const items4 = [tmp.container, { marginBottom: parentChannel(7091)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom - tmp16.bottom }];
  obj6.style = items4;
  ...
  const items6 = [closure_13(closure_6, { style: tmp.threadIconContainer, children: closure_13(require("ThreadIcon").ThreadIcon, { size: "lg" }) }), closure_13(parentChannel(16822), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(9448).PrivateThreadMode.Disabled) {
        const obj12 = { style: tmp.optionPrivateThread, children: null };
        const obj13 = { start: true, end: true, disabled: privateThreadMode !== tmp2(9448).PrivateThreadMode.Enabled, label: null, subLabel: null, value: null, onValueChange: null };
        const intl = tmp2(1115).intl;
        obj13.label = intl.string(tmp2(1115).t.F1zyvU);
        const intl2 = tmp2(1115).intl;
        obj13.subLabel = intl2.string(tmp2(1115).t.Wy5RIQ);
        obj13.value = tmp2(9448).getIsPrivate(threadSettingsDraft, privateThreadMode);
        ...
        obj12.children = tmp22(tmp2(7310).TableSwitchRow, obj13);
        tmp22Result = tmp22(tmp23, obj12);
        const tmp2Result = tmp2(9448);
      }
    }
  }
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(16824).ThreadCreationStarterMessage, obj16);
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj17.children = tmp22(tmp11(12125), obj18);
    tmp22Result2 = tmp22(tmp23, obj17);
  }
  items5[2] = tmp22Result2;
  items5[3] = closure_13(parentChannel(12100), { ref, channel: parentChannel, onJumpToPresent, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = closure_13(parentChannel(12785), { channelId: parentChannel.id });
