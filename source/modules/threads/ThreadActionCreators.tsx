...
// Dependencies: [5, 1962, 502, 1958, 4276, 7880, 4278, 7890, 1074, 1965, 1271, 573, 4982, 1115, 4818, 7891, 7892, 7895, 7896, 1370, 1969, 2]

// Module 7879 (ThreadActionCreators)
...
const PAGE_SIZE = fn(7880).PAGE_SIZE;
