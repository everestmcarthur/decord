...
// Dependencies: [5, 1962, 502, 1958, 4278, 7871, 4280, 7881, 1074, 1965, 1271, 573, 4983, 1115, 4819, 7882, 7883, 7886, 7887, 1370, 1969, 2]
...
const ApplicationCommandActionCreators = tmp(7883);
require = fn;
