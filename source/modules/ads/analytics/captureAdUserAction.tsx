...
// Dependencies: [5, 7808, 1074, 5536, 7823, 7804, 7833, 7839, 1241, 1255, 1364, 7782, 11332, 7834, 7814, 11335, 2]
// Exports: captureAdUserAction

// Module 11331 (captureAdUserAction)
...
import getQuestLogger from "getQuestLogger" /* 7814 */;
import AnalyticsActions from "AnalyticsActions" /* 7823 */;
import AnalyticsTypes from "AnalyticsTypes" /* 7833 */;
import AdDataUtils from "AdDataUtils" /* 7834 */;
import BrandSafetyContext from "BrandSafetyContext" /* 11332 */;
...
function handleViewImpression(minViewTimeSeconds) {
  ...
  if (minViewTimeSeconds.adCreativeType !== AdCreativeType.AdCreativeType.QUEST) {
    ...
    tmp9(7823).trackAdContentEvent(obj6);
    const tmp9Result = tmp9(7823);
  } else {
    ...
    const tmp9Result5 = tmp9(7823);
    let adMetadataSealed = tmp9(7804).getAdMetadataSealed(sourceQuestContent, adCreativeId);
    if (adMetadataSealed == null) {
      adMetadataSealed = null;
    }
    obj10.metadata_sealed = adMetadataSealed;
    const tmp9Result6 = tmp9(7804);
    const currentQuestHomeSearchSession = tmp9(7839).getCurrentQuestHomeSearchSession();
    let uuid;
    if (currentQuestHomeSearchSession != null) {
      uuid = currentQuestHomeSearchSession.uuid;
    }
    ...
    const tmp9Result7 = tmp9(7839);
    let adTrafficMetadataSealed = tmp9(7804).getAdTrafficMetadataSealed(sourceQuestContent, adCreativeId);
    if (adTrafficMetadataSealed == null) {
...
export const captureAdUserAction = function captureAdUserAction(captureAdUserActionResult1) {
  try {
    ...
    } else if (tmp2(11335).AdUserActionType.CLICK_INTERNAL === type) {
    ...
    } else if (tmp2(11335).AdUserActionType.CLICK_EXTERNAL_ADVERTISER_CTA === type) {
    ...
    } else if (tmp2(11335).AdUserActionType.VIEW_INTERNAL_SURFACE_IMPRESSION === type) {
    ...
    } else if (tmp2(11335).AdUserActionType.VIEW_EXTERNAL_PAID_AD_PLACEMENT_IMPRESSION === type) {
