...
// Dependencies: [5, 11499, 3, 11496, 11497, 11500, 2]
// Exports: endImpression, getStoreKitCredential, registerViewThroughImpression

// Module 11498 (isCurrentImpression)
import timestampDefault from "timestamp" /* 3 */;
import getActiveIosAttributionFramework from "getActiveIosAttributionFramework" /* 11496 */;
          ...
          if (0 === signAbort) {
            ...
            if (arg0 === 1) {
              ...
              if (null == logger) {
                ...
                const result = callback(11497).trackIosAttributionImpression(callback(11497).IosAttributionImpressionResult.NO_FRAMEWORK, c2);
                ...
                obj3[0] = callback(11500).fetchIosAttributionSignedPayloads(obj2);
                return obj3;
              }
            }
          } else {
            if (2 === tmp5) {
              if (arg0 === 1) {
                ...
                if (callback2(callback, signAbort)) {
                  ...
                  callback2 = tmp38;
                  if (null == callback2) {
                    let obj6 = callback(11497);
                    const result1 = obj6.trackIosAttributionImpression(callback(11497).IosAttributionImpressionResult.SIGN_FAILED, c2, callback);
                    set.delete(callback);
                    logger = 3;
            ...
            if (null == callback3) {
              obj1 = callback(11497);
              const result2 = obj1.trackIosAttributionImpression(callback(11497).IosAttributionImpressionResult.NO_TOKEN, c2, callback);
              set.delete(callback);
              logger = 3;
              ...
              obj = callback(11497);
              const result3 = obj.trackIosAttributionImpression(callback(11497).IosAttributionImpressionResult.REGISTERED, c2, callback);
