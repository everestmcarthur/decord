...
// Dependencies: [5, 19, 17, 4850, 21, 1364, 1609, 5230, 3, 5234, 5236, 1897, 4986, 1115, 2]

// Module 5233 (mobile/NativePermissionUtils)
import LoggerDefault from "Logger" /* 3 */;
import util from "util" /* 1115 */;
import useAlertStore from "useAlertStore" /* 4986 */;
import openPrivacySettingsDefault from "openPrivacySettings" /* 5234 */;
...
const NativePermissionBaseUtils = fn(5230).NativePermissionBaseUtils;
