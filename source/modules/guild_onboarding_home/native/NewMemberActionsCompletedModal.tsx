...
// Dependencies: [19, 17, 21, 4639, 576, 4376, 4640, 4842, 12420, 4635, 1115, 2]
// Exports: default

// Module 17524 (NewMemberActionsCompletedModal)
...
export default function NewMemberActionsCompleted(arg0) {
  ...
  fn.__closure = { withDelay: sharedValue(4376).withDelay, withTiming: sharedValue(4640).withTiming, barWidth: sharedValue };
  fn.__workletHash = 7643178959760;
  fn.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(fn);
  const effect1 = noop.useEffect(() => {
    const timerId = setTimeout(() => closure_1_1(4842).popWithKey(sharedValue(12420).NEW_MEMBER_ACTION_COMPLETE_MODAL_KEY), 2500);
  }, []);
