...
// Dependencies: [32, 5, 2015, 502, 1958, 2022, 1980, 4461, 4827, 4828, 4265, 7232, 1385, 4843, 17621, 1897, 12437, 1094, 12436, 7336, 7337, 2]

// Module 17620 (GuildOnboardingHomeManager)
      ...
      if (!onboardingCompleteGuilds2.has(guildId)) {
        ...
        if (obj.hasFlag(flags, GuildMemberFlags.COMPLETED_HOME_ACTIONS)) {
          ...
          if (0 !== num) {
            ...
            const tmp9 = tmp(1897)(17621, tmp2.paths);
            const obj3 = { initialPercent: (num - 1) / num, numActions: num };
            const obj4 = { animation: tmp(1094).ModalAnimation.FADE };
            obj2.pushLazy(tmp9, obj3, tmp(12437).NEW_MEMBER_ACTION_COMPLETE_MODAL_KEY, obj4);
          }
        }
        obj = FlagUtils;
        tmp2 = dependencyMap;
      ...
      try {
        ...
        if (0 === c3) {
          ...
          if (1 === tmp5) {
            ...
            if (tmp13) {
              tmp13 = closure_129_5.actionType === applyArgumentsResult(12437).NewMemberActionTypes.VIEW;
            }
            if (tmp13) {
              const result = applyArgumentsResult(12436).completeNewMemberAction(closure_129_0, closure_129_1);
              const obj = applyArgumentsResult(12436);
            }
            arr = memberActions;
          }
          c4 = 3;
