...
// Function ID: 16647
// Name: ResourcesRow
// Dependencies: [19, 17, 16647, 21, 4605, 576, 16648, 12354, 4572, 16649, 1896, 5173, 4601, 1114, 2]
// Exports: default

// Module 16646 (ResourcesRow)
...
export default function ResourcesRow(guildId) {
  ...
  const items = [
    substr.map((children) => {
      ...
      const obj = {
        ...
        children: closure_1_5(guildId(4601).Text, { variant: "text-md/medium", color: "text-default", children: children.title })
      };
  ...
  if (tmp3) {
    const obj2 = {
      ...
      onPress() {
          ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16649, dependencyMap.paths), closure_4, { guildId });
        },
      children: null
    };
    ...
    obj2.children = closure_5(guildId(4601).Text, obj3);
    tmp6 = closure_5(guildId(5173).PressableOpacity, obj2);
  }
  items[1] = tmp6;
  obj.children = items;
