...
// Dependencies: [5, 17262, 3, 13693, 7771, 15, 9, 10, 504, 2]
// Exports: default

// Module 17261 (executeRunnable)
...
const require = fn;
const NativeAppStartup = fn(17262);
...
export default function executeRunnable(arg0, arg1) {
  ...
  return RequestGatewaySocketAll.withRequest(combined, asyncGeneratorStep(async () => {
    ...
    v2(7771).startBridgeTo("AppContainer:" + closure_129_0.toLowerCase());
