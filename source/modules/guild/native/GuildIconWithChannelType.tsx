...
// Dependencies: [19, 17, 21, 5598, 4574, 576, 5042, 11032, 8847, 1178, 2]
// Exports: GuildIconWithChannelType

// Module 11031 (GuildIconWithChannelType)
...
let obj2 = {};
obj2[obj.SMALL_32] = { pileSize: 32, guildIconSize: fn(5598).GuildIconSizes.XSMALL, typeIconSize: 12, typeIconPadding: 4, gap: 3 };
const createStyles = fn(4574);
let obj5 = { typeIconWrapper: null };
let obj3 = { pileSize: 32, guildIconSize: fn(5598).GuildIconSizes.XSMALL, typeIconSize: 12, typeIconPadding: 4, gap: 3 };
