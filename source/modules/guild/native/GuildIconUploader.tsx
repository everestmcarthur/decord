...
// Dependencies: [19, 17, 1182, 21, 4640, 576, 4350, 4491, 11951, 11952, 4636, 1115, 11953, 11954, 5210, 2]

// Module 11950 (GuildIconUploader)
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    if (obj6.isThemeDark(ThemeStore.theme)) {
      let tmp13Result = tmp13(11951);
    } else {
      tmp13Result = tmp13(11952);
    }
