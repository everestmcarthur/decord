...
// Dependencies: [19, 17, 1182, 21, 4722, 576, 4432, 4573, 12042, 12043, 4718, 1115, 12044, 12045, 5292, 2]

// Module 12041 (GuildIconUploader)
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    if (obj6.isThemeDark(ThemeStore.theme)) {
      let tmp13Result = tmp13(12042);
    } else {
      tmp13Result = tmp13(12043);
    }
...
GuildIconUploader.contextType = fn(4432).ThemeContext;
size = fn(2);
