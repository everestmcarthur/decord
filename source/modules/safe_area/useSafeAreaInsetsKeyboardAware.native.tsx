...
// Dependencies: [32, 19, 1480, 5665, 5666, 1612, 1481, 1364, 1878, 4507, 1610, 5664, 2]
// Exports: default
...
export default function useSafeAreaInsetsKeyboardAware() {
  ...
  callback = callback.useCallback(() => {
    ...
    if (0 === systemKeyboardHeight) {
      const keyboardType = tmp(4507).getKeyboardType(tmp5);
      let num3 = 0;
      if (keyboardType !== tmp(1610).KeyboardTypes.SYSTEM) {
        num3 = 0;
        if (flag3) {
          num3 = tmp(5664).getCustomKeyboardHeight(tmp5);
          const tmpResult6 = tmp(5664);
        }
      }
      systemKeyboardHeight = num3;
      const tmpResult5 = tmp(4507);
    }
