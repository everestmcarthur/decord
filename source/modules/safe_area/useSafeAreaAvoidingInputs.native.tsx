...
// Dependencies: [5, 19, 1477, 576, 11281, 5661, 2]
// Exports: default
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != found) {
              if (null != current2) {
                dependencyMap = 1;
                c3 = 1;
                const obj4 = { value: tmp2(11281).measureViewRefInWindow(found.ref), done: false };
                return obj4;
              }
            }
          }
          ...
          if (arg0 === 1) {
            ...
            dependencyMap = 2;
            c3 = 1;
            const obj6 = { value: tmp2(11281).measureViewRefInView(closure_128_1.ref, closure_128_0), done: false };
            return obj6;
          }
        } else {
          if (2 === tmp5) {
            if (arg0 === 1) {
              ...
              if (null != closure_128_2) {
                if (null != closure_128_3) {
                  dependencyMap = 3;
                  c3 = 1;
                  const obj9 = { value: tmp2(11281).measureViewInWindow(closure_128_0), done: false };
                  return obj9;
                }
              }
            }
