...
// Dependencies: [5, 19, 1478, 576, 11286, 5665, 2]
// Exports: default

// Module 11285 (useSafeAreaAvoidingInputs)
import nativeDefault from "native" /* 576 */;
import useKeyboardDuration from "useKeyboardDuration" /* 5665 */;
import ViewMeasureUtils from "ViewMeasureUtils" /* 11286 */;
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != found) {
              if (null != current2) {
                dependencyMap = 1;
                c3 = 1;
                const obj4 = { value: tmp2(11286).measureViewRefInWindow(found.ref), done: false };
                return obj4;
              }
            }
          }
          ...
          if (arg0 === 1) {
            ...
            dependencyMap = 2;
            c3 = 1;
            const obj6 = { value: tmp2(11286).measureViewRefInView(closure_128_1.ref, closure_128_0), done: false };
            return obj6;
          }
        } else {
          if (2 === tmp5) {
            if (arg0 === 1) {
              ...
              if (null != closure_128_2) {
                if (null != closure_128_3) {
                  dependencyMap = 3;
                  c3 = 1;
                  const obj9 = { value: tmp2(11286).measureViewInWindow(closure_128_0), done: false };
                  return obj9;
                }
              }
            }
