...
// Dependencies: [32, 19, 17, 4631, 1958, 2022, 7867, 4278, 1074, 21, 4376, 4635, 4639, 576, 504, 4290, 1331, 7868, 7869, 5683, 12, 7269, 11395, 4791, 4484, 8299, 7244, 1177, 1397, 9935, 1364, 5765, 8725, 11396, 1115, 11397, 4489, 1936, 7237, 11398, 4640, 1478, 4597, 4606, 11399, 1897, 7316, 7295, 11400, 4607, 4608, 1612, 8351, 7257, 6732, 510, 7376, 7889, 7930, 11401, 7179, 2]
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  const analyticsLocations = tmp19(7269)().analyticsLocations;
  ...
  if (NORMAL === tmp10(7868).ReactionTypes.BURST) {
    ...
    obj4.children = tmp27(tmp19(7930), obj5);
  ...
  if (tmp26) {
    ...
    let tmp27Result4 = tmp27(tmp19(11401), obj7, name);
    const tmp19Result3 = tmp19(11401);
  } else {
    const obj8 = { inActionSheet: true };
    const merged1 = Object.assign(obj2);
    tmp27Result4 = tmp27(tmp19(7179), obj8, name);
    const tmp19Result4 = tmp19(7179);
  }
