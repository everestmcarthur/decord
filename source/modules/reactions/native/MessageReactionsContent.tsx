...
// Dependencies: [32, 19, 17, 4566, 1957, 2021, 7776, 4212, 1074, 21, 4310, 4570, 4574, 576, 504, 4224, 1332, 7777, 7778, 5612, 12, 7176, 11289, 4726, 4418, 8205, 7151, 1178, 1396, 9835, 1115, 5694, 8632, 11290, 1114, 11291, 4423, 1935, 7144, 11292, 4575, 1477, 4532, 4541, 11293, 1896, 7223, 7202, 11294, 4542, 4543, 1611, 8258, 7164, 6641, 510, 7283, 7798, 7839, 11295, 7086, 2]
// Exports: MessageReactionsContent, MessageReactionsEmpty

// Module 11288 (MessageReactionsContent)
...
import ReactionToProfileExperimentDefault from "ReactionToProfileExperiment" /* 11289 */;
...
function ReactionTab(arg0) {
  ...
  if (null != emojiColorPalette) {
    const obj3 = { backgroundColor: tmp3(4423).hexOpacityToRgba(emojiColorPalette.backgroundColor, emojiColorPalette.opacity) };
    tmp8 = obj3;
    const tmp3Result = tmp3(4423);
  }
...
function EmojiOptionsButton(channelId) {
  ...
  const tmp3 = messageId(11292)(stateFromStores);
  const canRemoveReactions = tmp3;
  dependencyMap = tmp4;
  const items2 = [channelId, messageId, reactions[reactionSelectedIndex], tmp3];
  const obj2 = {
    onPress: noop.useCallback(() => {
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11293, dependencyMap.paths), "ReactionEmojiOptionsActionSheet", { channelId, messageId, reaction, canRemoveReactions }, "replaceTopSheet");
    }, items2),
  ...
  const items3 = [closure_17(channelId(4570).Text, obj3), ];
  const obj = channelId(504);
  items3[1] = closure_17(channelId(7223).ChevronSmallRightIcon, { color: messageId(576).colors.ICON_SUBTLE, size: "xs" });
...
function ReactionTabs(setReactionSelectedIndex) {
  ...
  const obj = setReactionSelectedIndex(7202);
  ...
  obj4.initialNumTabsToRender = reactionSelectedIndex(4224).MAX_REACTIONS;
  const items = [closure_17(setReactionSelectedIndex(11294), obj4), closure_17(setReactionSelectedIndex(8632), { outer: true }), ];
  ...
  const tmp5 = setReactionSelectedIndex(11294);
  obj7.children = reactionSelectedIndex(4224).getReactionEmojiName(reactions[reactionSelectedIndex].emoji);
  const items1 = [closure_17(reactionSelectedIndex(4570).Text, obj7), ];
  const obj12 = {};
  const obj6 = reactionSelectedIndex(4224);
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  if (null != reactions[bound].me_vote) {
    let NORMAL = channelId(7777).ReactionTypes.VOTE;
    let tmp8 = channelId;
    let tmp10 = channelId;
  } else if (tmp5.burst_count > 0) {
    NORMAL = channelId(7777).ReactionTypes.BURST;
    tmp8 = channelId;
    tmp10 = channelId;
  } else {
    NORMAL = channelId(7777).ReactionTypes.NORMAL;
    tmp8 = channelId;
    tmp10 = channelId;
  }
  let tmp2 = closure_20();
  ...
  const isActiveChannelOrUnarchivableThread = tmp10(7283).useIsActiveChannelOrUnarchivableThread(stateFromStores);
  closure_130_0 = channelId;
  const tmp10Result3 = tmp10(7283);
  ...
  const analyticsLocations = tmp19(7176)().analyticsLocations;
  ...
  let obj3 = { scrollable: true, backdropOpacity: tmp10(7798).BACKDROP_OPACITY, backdropChildren: null, header: null, children: null };
  let tmp27Result = null;
  if (NORMAL === tmp10(7777).ReactionTypes.BURST) {
    ...
    obj4.children = tmp27(tmp19(7839), obj5);
  ...
  if (tmp26) {
    ...
    let tmp27Result4 = tmp27(tmp19(11295), obj7, name);
    const tmp19Result3 = tmp19(11295);
  } else {
    const obj8 = { inActionSheet: true };
    const merged1 = Object.assign(obj2);
    tmp27Result4 = tmp27(tmp19(7086), obj8, name);
    const tmp19Result4 = tmp19(7086);
  }
  obj3.children = tmp27Result4;
  return closure_17(tmp10(7164).BottomSheet, obj3);
};
