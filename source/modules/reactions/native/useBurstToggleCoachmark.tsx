...
// Dependencies: [32, 19, 17, 1372, 1955, 21, 1944, 4640, 576, 9527, 504, 4297, 7502, 1115, 11288, 2]
// Exports: default

// Module 11287 (useBurstToggleCoachmark)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import SuperReactionIcon from "SuperReactionIcon" /* 9527 */;
...
export default function useBurstToggleCoachmark(targetRef) {
  ...
  obj2 = first(4297);
  const tmp5 = _slicedToArray(first(7502).useSelectedDismissibleContent(items2), 2);
  first = tmp5[0];
  closure_1 = tmp7;
