...
// Dependencies: [32, 5, 19, 17, 12504, 12505, 1074, 4817, 9783, 1242, 12507, 12513, 12514, 504, 2]
...
// Module 12506 (NotificationPermissionUtil)
...
let closure_10 = fn(4817).NotificationAuthorizationStatus;
const size = fn(2);
