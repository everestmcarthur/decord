...
// Dependencies: [32, 5, 19, 17, 12552, 12553, 1074, 4848, 9830, 1241, 12555, 12561, 12562, 504, 2]
...
// Module 12554 (NotificationPermissionUtil)
...
let closure_10 = fn(4848).NotificationAuthorizationStatus;
const size = fn(2);
