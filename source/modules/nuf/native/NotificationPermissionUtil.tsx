...
// Dependencies: [32, 5, 19, 17, 12561, 12562, 1074, 4850, 9841, 1241, 12564, 12570, 12571, 504, 2]
...
// Module 12563 (NotificationPermissionUtil)
...
let closure_10 = fn(4850).NotificationAuthorizationStatus;
const size = fn(2);
