...
// Dependencies: [19, 17, 1074, 7652, 21, 4640, 576, 1612, 17705, 1241, 5665, 4636, 1115, 2397, 15005, 5062, 2]
// Exports: default

// Module 17704 (ConnectGuardianModal)
...
const FamilyCenterAction = fn(7652).FamilyCenterAction;
const jsxProd = fn(21);
...
export default function ConnectGuardianModal(route) {
  ...
  const tmp = closure_9();
  const connectGuardianGate = onComplete(17705).useConnectGuardianGate();
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj2.style = items1;
    obj2.children = closure_7(tmp4(5665).ActivityIndicator, {});
    ...
    obj5.children = intl.string(tmp2(2397).ITlV6p);
    const items2 = [closure_7(tmp4(4636).Text, obj5), ];
    const obj6 = { style: tmp.description, variant: "text-sm/medium", color: "text-muted", children: null };
    const intl2 = tmp4(1115).intl;
    obj6.children = intl2.format(tmp2(2397).F4GT2S, { link: "https://support.discord.com/hc/articles/14155060633623" });
    items2[1] = closure_7(tmp4(4636).Text, obj6);
    ...
    obj8.children = intl3.string(tmp2(2397).Mi60fm);
    const items4 = [closure_7(tmp4(4636).Text, obj8), ];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(15005).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    ...
    obj12.children = closure_7(tmp4(5062).Button, obj25);
