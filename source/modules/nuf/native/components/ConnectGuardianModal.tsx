...
import { FamilyCenterAction } from "items" /* 7538 */;
...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    items4[1] = callback(tmp4(14884).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    obj4[1] = items4;
