...
// Dependencies: [19, 17, 1074, 7590, 21, 4605, 576, 1611, 17548, 1242, 5627, 4601, 1114, 2396, 14959, 5025, 2]
// Exports: default

// Module 17547 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  const tmp = closure_9();
  const connectGuardianGate = onComplete(17548).useConnectGuardianGate();
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj2.style = items1;
    obj2.children = closure_7(tmp4(5627).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4601).Text, obj5), ];
    ...
    items2[1] = closure_7(tmp4(4601).Text, obj6);
    ...
    const items4 = [closure_7(tmp4(4601).Text, obj8), ];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(14959).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    ...
    obj12.children = closure_7(tmp4(5025).Button, obj25);
