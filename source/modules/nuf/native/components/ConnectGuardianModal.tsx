...
// Dependencies: [19, 17, 1074, 7552, 21, 4574, 576, 1611, 17489, 1242, 5591, 4570, 1114, 2396, 14910, 4989, 2]
// Exports: default

// Module 17488 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  const tmp = closure_9();
  const connectGuardianGate = onComplete(17489).useConnectGuardianGate();
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj2.style = items1;
    obj2.children = closure_7(tmp4(5591).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4570).Text, obj5), ];
    ...
    items2[1] = closure_7(tmp4(4570).Text, obj6);
    ...
    const items4 = [closure_7(tmp4(4570).Text, obj8), ];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(14910).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    ...
    obj12.children = closure_7(tmp4(4989).Button, obj25);
