...
// Dependencies: [19, 17, 1074, 7611, 21, 4606, 576, 1611, 17539, 1242, 5628, 4602, 1114, 2396, 14936, 5026, 2]
// Exports: default

// Module 17538 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  const tmp = closure_9();
  const connectGuardianGate = onComplete(17539).useConnectGuardianGate();
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj2.style = items1;
    obj2.children = closure_7(tmp4(5628).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4602).Text, obj5), ];
    ...
    items2[1] = closure_7(tmp4(4602).Text, obj6);
    ...
    const items4 = [closure_7(tmp4(4602).Text, obj8), ];
    ...
    obj12.children = closure_7(tmp4(5026).Button, obj25);
