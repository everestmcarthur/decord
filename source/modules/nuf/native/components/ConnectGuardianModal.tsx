...
// Dependencies: [19, 17, 1074, 7612, 21, 4607, 576, 1611, 17540, 1242, 5629, 4603, 1114, 2396, 14936, 5027, 2]
// Exports: default

// Module 17539 (ConnectGuardianModal)
...
const FamilyCenterAction = fn(7612).FamilyCenterAction;
const jsxProd = fn(21);
...
export default function ConnectGuardianModal(route) {
  ...
  const tmp = closure_9();
  const connectGuardianGate = onComplete(17540).useConnectGuardianGate();
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj2.style = items1;
    obj2.children = closure_7(tmp4(5629).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4603).Text, obj5), ];
    ...
    items2[1] = closure_7(tmp4(4603).Text, obj6);
    ...
    const items4 = [closure_7(tmp4(4603).Text, obj8), ];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(14936).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    ...
    const obj13 = { paddingBottom: connectGuardianGate(1611)().bottom + tmp2(576).space.PX_16 };
    items5[1] = obj13;
    obj12.style = items5;
    const obj25 = { variant: "primary", size: "lg", text: null, onPress: null };
    const intl4 = tmp4(1114).intl;
    obj25.text = intl4.string(tmp4(1114).t["3PatSz"]);
    ...
    obj12.children = closure_7(tmp4(5027).Button, obj25);
