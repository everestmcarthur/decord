...
// Dependencies: [19, 17, 1074, 7648, 21, 4638, 576, 1612, 17664, 1241, 5663, 4634, 1115, 2397, 14997, 5060, 2]
// Exports: default

// Module 17663 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  const tmp = closure_9();
  const connectGuardianGate = onComplete(17664).useConnectGuardianGate();
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj2.style = items1;
    obj2.children = closure_7(tmp4(5663).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4634).Text, obj5), ];
    ...
    items2[1] = closure_7(tmp4(4634).Text, obj6);
    ...
    const items4 = [closure_7(tmp4(4634).Text, obj8), ];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(14997).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    ...
    obj12.children = closure_7(tmp4(5060).Button, obj25);
