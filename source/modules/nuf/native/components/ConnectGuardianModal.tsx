...
// Dependencies: [19, 17, 1074, 7645, 21, 4639, 576, 1612, 17608, 1241, 5662, 4635, 1115, 2397, 14981, 5059, 2]
// Exports: default

// Module 17607 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  const tmp = closure_9();
  const connectGuardianGate = onComplete(17608).useConnectGuardianGate();
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj2.style = items1;
    obj2.children = closure_7(tmp4(5662).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4635).Text, obj5), ];
    ...
    items2[1] = closure_7(tmp4(4635).Text, obj6);
    ...
    const items4 = [closure_7(tmp4(4635).Text, obj8), ];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(14981).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    ...
    obj12.children = closure_7(tmp4(5059).Button, obj25);
