...
// Dependencies: [19, 17, 12828, 1372, 1074, 21, 4640, 576, 5770, 1484, 504, 12835, 1094, 12855, 12899, 12848, 1249, 7114, 1115, 2]

// Module 12898 (DiscoverabilityModal)
...
import ContactSyncNameInputDefault from "ContactSyncNameInput" /* 12848 */;
...
function DiscoverabilityNameScene() {
  ...
  const callback = noop.useCallback((arg0) => {
    const result = allowPhone(12855).startContactSyncForDiscoverability(arg0);
    const obj = allowPhone(12855);
    const result1 = allowPhone(12855).closeDiscoverabilityModal(false);
  }, []);
...
let obj2 = { container: { flex: 1, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, justifyContent: "center", paddingBottom: 44, paddingTop: fn(5770).NAV_BAR_HEIGHT + 32 } };
