...
// Dependencies: [19, 17, 12820, 1372, 1074, 21, 4638, 576, 5768, 1484, 504, 12827, 1094, 12847, 12891, 12840, 1249, 7110, 1115, 2]

// Module 12890 (DiscoverabilityModal)
...
import ContactSyncNameInputDefault from "ContactSyncNameInput" /* 12840 */;
...
function DiscoverabilityNameScene() {
  ...
  const callback = noop.useCallback((arg0) => {
    const result = allowPhone(12847).startContactSyncForDiscoverability(arg0);
    const obj = allowPhone(12847);
    const result1 = allowPhone(12847).closeDiscoverabilityModal(false);
  }, []);
...
let obj2 = { container: { flex: 1, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, justifyContent: "center", paddingBottom: 44, paddingTop: fn(5768).NAV_BAR_HEIGHT + 32 } };
