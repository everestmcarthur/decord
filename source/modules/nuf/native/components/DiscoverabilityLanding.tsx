...
// Dependencies: [19, 17, 12820, 1074, 21, 4638, 576, 5610, 1612, 4605, 12892, 1897, 5768, 5673, 12893, 4634, 1115, 8728, 12847, 5060, 2]
// Exports: default

// Module 12891 (DiscoverabilityLanding)
...
export default function DiscoverabilityLanding(onNext) {
  ...
  noop = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12892, dependencyMap.paths), "Discoverability Landing", { allowPhone, allowEmail });
  }, items);
