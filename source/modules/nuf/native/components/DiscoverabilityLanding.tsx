...
// Dependencies: [19, 17, 12707, 1074, 21, 4574, 576, 5538, 1611, 4541, 12779, 1896, 5696, 5601, 12780, 4570, 1114, 8626, 12734, 4989, 2]
// Exports: default

// Module 12778 (DiscoverabilityLanding)
...
export default function DiscoverabilityLanding(onNext) {
  ...
  noop = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12779, dependencyMap.paths), "Discoverability Landing", { allowPhone, allowEmail });
  }, items);
