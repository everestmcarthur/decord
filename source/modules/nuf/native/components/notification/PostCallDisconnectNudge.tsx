...
// Dependencies: [32, 19, 2011, 4655, 12538, 12539, 21, 16620, 1114, 15567, 12540, 504, 7491, 1943, 12541, 4603, 16621, 1896, 2]
// Exports: default, usePostCallDisconnectNudge

// Module 16621 (PostCallDisconnectNudge)
...
export const usePostCallDisconnectNudge = function usePostCallDisconnectNudge() {
  ...
  const effect1 = obj5.useEffect(() => {
    if (null != first) {
      ...
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16621, dependencyMap.paths), c11, obj3);
    }
  }, items3);
};
