...
// Dependencies: [19, 17, 12562, 1074, 21, 4640, 576, 1241, 12563, 4607, 7264, 17708, 4636, 1115, 5521, 5062, 2]
// Exports: default

// Module 17707 (NotificationReactivationActionSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4607 */;
import NotificationPermissionUtil from "NotificationPermissionUtil" /* 12563 */;
import _modDef17708 from "module_17708" /* 17708 */;
import noop from "module_19" /* 19 */;

require = fn;
get_ActivityIndicator = fn(17);
({ View: closure_4, Image: hasOwnProperty } = get_ActivityIndicator);
const EventActionType = fn(12562).EventActionType;
...
export default function NotificationReactivationActionSheet(location) {
  ...
  const items2 = [closure_8(closure_5, { style: tmp.image, source: _modDef17708, resizeMode: "contain" }), , , ];
  ...
  items2[1] = closure_8(_location(4636).Text, obj4);
  ...
  items2[2] = closure_8(_location(4636).Text, obj5);
  ...
  const items3 = [closure_8(_location(5062).Button, obj7), ];
  ...
  items3[1] = closure_8(_location(5062).Button, obj8);
  obj6.children = items3;
  items2[3] = closure_9(_location(5521).ButtonGroup, obj6);
  obj2.children = items2;
  obj.children = closure_9(closure_4, obj2);
  return closure_8(_location(7264).BottomSheet, obj);
};
