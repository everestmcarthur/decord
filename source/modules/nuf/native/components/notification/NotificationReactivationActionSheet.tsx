...
// Dependencies: [19, 17, 12653, 1074, 21, 4722, 576, 1241, 12654, 4689, 7346, 17772, 4718, 1115, 5603, 5144, 2]
// Exports: default

// Module 17771 (NotificationReactivationActionSheet)
...
const EventActionType = fn(12653).EventActionType;
...
export default function NotificationReactivationActionSheet(location) {
  ...
  const items2 = [closure_8(closure_5, { style: tmp.image, source: _modDef17772, resizeMode: "contain" }), , , ];
  ...
  items2[1] = closure_8(_location(4718).Text, obj4);
  ...
  items2[2] = closure_8(_location(4718).Text, obj5);
  ...
  const items3 = [closure_8(_location(5144).Button, obj7), ];
  ...
  items3[1] = closure_8(_location(5144).Button, obj8);
  obj6.children = items3;
  items2[3] = closure_9(_location(5603).ButtonGroup, obj6);
  obj2.children = items2;
  obj.children = closure_9(closure_4, obj2);
  return closure_8(_location(7346).BottomSheet, obj);
};
