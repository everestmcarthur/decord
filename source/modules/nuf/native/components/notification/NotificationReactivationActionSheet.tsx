...
// Dependencies: [19, 17, 12503, 1074, 21, 4606, 576, 1242, 12504, 4573, 7223, 17542, 4602, 1114, 5484, 5026, 2]
// Exports: default

// Module 17541 (NotificationReactivationActionSheet)
...
export default function NotificationReactivationActionSheet(location) {
  ...
  const items2 = [closure_8(closure_5, { style: tmp.image, source: _modDef17542, resizeMode: "contain" }), , , ];
  ...
  items2[1] = closure_8(_location(4602).Text, obj4);
  ...
  items2[2] = closure_8(_location(4602).Text, obj5);
  ...
  const items3 = [closure_8(_location(5026).Button, obj7), ];
  ...
  items3[1] = closure_8(_location(5026).Button, obj8);
  obj6.children = items3;
  items2[3] = closure_9(_location(5484).ButtonGroup, obj6);
  obj2.children = items2;
  obj.children = closure_9(closure_4, obj2);
  return closure_8(_location(7223).BottomSheet, obj);
};
