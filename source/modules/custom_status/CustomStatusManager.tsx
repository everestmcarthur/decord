...
// Dependencies: [5449, 1074, 1953, 7314, 1936, 10335, 1941, 1217, 10334, 2]

// Module 17668 (CustomStatusManager)
    ...
    if (null != setting) {
      if ("0" !== setting) {
        ...
        if (diff > 0) {
          ...
          applyArgumentsResult(10334).setFocusMode(false);
          timeout1.stop();
          const tmpResult = applyArgumentsResult(10334);
        }
      }
    }
    if (null != timeout1) {
