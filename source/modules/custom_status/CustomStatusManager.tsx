...
// Dependencies: [5329, 1074, 4492, 7170, 1935, 10161, 1940, 1218, 10160, 2]

// Module 17431 (CustomStatusManager)
    ...
    if (null != setting) {
      if ("0" !== setting) {
        ...
        if (diff > 0) {
          ...
          applyArgumentsResult(10160).setFocusMode(false);
          timeout1.stop();
          const tmpResult = applyArgumentsResult(10160);
        }
      }
    }
    if (null != timeout1) {
