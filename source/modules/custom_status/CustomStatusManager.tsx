...
// Dependencies: [5331, 1074, 4494, 7192, 1935, 10183, 1940, 1218, 10182, 2]

// Module 17421 (CustomStatusManager)
    ...
    if (null != setting) {
      if ("0" !== setting) {
        ...
        if (diff > 0) {
          ...
          applyArgumentsResult(10182).setFocusMode(false);
          timeout1.stop();
          const tmpResult = applyArgumentsResult(10182);
        }
      }
    }
    if (null != timeout1) {
