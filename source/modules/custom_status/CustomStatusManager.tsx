...
// Dependencies: [5367, 1074, 1953, 7232, 1936, 10241, 1941, 1217, 10240, 2]

// Module 17587 (CustomStatusManager)
    ...
    if (null != setting) {
      if ("0" !== setting) {
        ...
        if (diff > 0) {
          ...
          applyArgumentsResult(10240).setFocusMode(false);
          timeout1.stop();
          const tmpResult = applyArgumentsResult(10240);
        }
      }
    }
    if (null != timeout1) {
