...
// Dependencies: [32, 19, 17, 11187, 21, 4605, 576, 7202, 7201, 1114, 5735, 5738, 11274, 5025, 4572, 2]
// Exports: default

// Module 11273 (ClearAfterOptionsActionSheet)
...
const ClearAfterOptions = fn(11187).ClearAfterOptions;
const jsxProd = fn(21);
...
export default function ClearAfterOptionsActionSheet(arg0) {
  ...
  obj3.children = ClearAfterOptions.map((value) => closure_1_7(TableRadioRow.TableRadioRow, { value, label: closure_1(11274)(value) }, value));
