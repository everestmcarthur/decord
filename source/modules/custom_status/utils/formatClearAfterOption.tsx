...
// Dependencies: [11147, 4255, 1114, 1090, 1369, 2]
// Exports: default

// Module 11234 (formatClearAfterOption)
import DurationsDefault from "Durations" /* 1090 */;
import util from "util" /* 1114 */;
import GlobalUtils from "GlobalUtils" /* 1369 */;
import DateUtils from "DateUtils" /* 4255 */;
import Constants from "Constants" /* 11147 */;
...
export default function formatClearAfterOption(arg0) {
  if (ClearAfterValues.TODAY === arg0) {
    ...
    if (isSameDayResult) {
      ...
      formatTimeResult = intl9.formatToPlainString(tmp66(1114).t.DN91Jz, obj3);
    }
    ...
    if (isSameDayResult1) {
      ...
      formatTimeResult1 = intl7.formatToPlainString(tmp46(1114).t.DN91Jz, obj5);
    }
    ...
    if (isSameDayResult2) {
      ...
      formatTimeResult2 = intl5.formatToPlainString(tmp27(1114).t.DN91Jz, obj7);
    }
    ...
    if (isSameDayResult3) {
      ...
      formatTimeResult3 = intl3.formatToPlainString(tmp7(1114).t.DN91Jz, obj9);
    }
