...
// Dependencies: [5, 502, 4630, 9244, 206, 9227, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 9249 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(9244).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
