...
// Dependencies: [5, 502, 4663, 9306, 206, 9289, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 9311 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(9306).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
