...
// Dependencies: [5, 502, 4662, 9284, 206, 9267, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 9289 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(9284).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
