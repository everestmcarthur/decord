...
// Dependencies: [5, 502, 4661, 9295, 206, 9278, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 9300 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(9295).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
