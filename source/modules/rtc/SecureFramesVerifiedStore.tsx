...
// Dependencies: [502, 4661, 4677, 9276, 9277, 1074, 9293, 4690, 4693, 504, 573, 2]

// Module 9275 (SecureFramesVerifiedStore)
  ...
  RTC_CONNECTION_STATE: function handleRtcConnectionState(state) {
    ...
    if (state.state !== RTCConnectionStates.DISCONNECTED) {
      ...
      if (BaseConnectionEvent.MediaEngineContextTypes.STREAM === context) {
        ...
        return tmp6;
      } else if (tmp10(4693).MediaEngineContextTypes.DEFAULT === context) {
        map.clear();
        map1.clear();
        c10 = false;
      }
