...
// Dependencies: [502, 4629, 4645, 9223, 9224, 1074, 9240, 4658, 4661, 504, 573, 2]

// Module 9222 (SecureFramesVerifiedStore)
  ...
  RTC_CONNECTION_STATE: function handleRtcConnectionState(state) {
    ...
    if (state.state !== RTCConnectionStates.DISCONNECTED) {
      ...
      if (BaseConnectionEvent.MediaEngineContextTypes.STREAM === context) {
        ...
        return tmp6;
      } else if (tmp10(4661).MediaEngineContextTypes.DEFAULT === context) {
        map.clear();
        map1.clear();
        c10 = false;
      }
