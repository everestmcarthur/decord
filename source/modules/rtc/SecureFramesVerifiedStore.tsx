...
// Dependencies: [502, 4628, 4644, 9202, 9203, 1074, 9219, 4657, 4660, 504, 573, 2]

// Module 9201 (SecureFramesVerifiedStore)
  ...
  RTC_CONNECTION_STATE: function handleRtcConnectionState(state) {
    ...
    if (state.state !== RTCConnectionStates.DISCONNECTED) {
      ...
      if (BaseConnectionEvent.MediaEngineContextTypes.STREAM === context) {
        ...
        return tmp6;
      } else if (tmp10(4660).MediaEngineContextTypes.DEFAULT === context) {
        map.clear();
        map1.clear();
        c10 = false;
      }
