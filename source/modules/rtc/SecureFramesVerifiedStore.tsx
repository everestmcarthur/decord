...
// Dependencies: [502, 4630, 4646, 9225, 9226, 1074, 9242, 4659, 4662, 504, 573, 2]

// Module 9224 (SecureFramesVerifiedStore)
  ...
  RTC_CONNECTION_STATE: function handleRtcConnectionState(state) {
    ...
    if (state.state !== RTCConnectionStates.DISCONNECTED) {
      ...
      if (BaseConnectionEvent.MediaEngineContextTypes.STREAM === context) {
        ...
        return tmp6;
      } else if (tmp10(4662).MediaEngineContextTypes.DEFAULT === context) {
        map.clear();
        map1.clear();
        c10 = false;
      }
