...
// Dependencies: [1957, 4629, 9242, 1074, 4809, 9245, 1896, 4573, 9256, 1114, 4951, 1178, 7320, 9259, 2]

// Module 9244 (SecureFramesPlatformUtils)
...
export default {
  openSecureFramesStreamVerification(streamKey, channelId) {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(9256, dependencyMap.paths), timestampProducer, { streamKey, channelId });
  },
  openSecureFramesUserVerificationModal(id, id2, fn) {
    if (fn()) {
      const obj2 = { userId: id, channelId: id2 };
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9245, dependencyMap.paths), obj2, React5);
    }
  },
