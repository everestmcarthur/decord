...
// Dependencies: [32, 19, 1220, 4461, 1948, 1950, 1074, 1084, 1241, 1944, 7504, 1946, 504, 4482, 1943, 4460, 11, 2]
...
// Module 7503 (useGetDismissibleContent)
...
function useGetVisibleContent(found1, stateFromStores, GUILD_HEADER_TOOLTIPS, latestVersion, newSnowflakeId) {
  ...
  if (result) {
    result = tmp2(1946).isDismissibleContentBlockedByOverlay(found1, first, tmp6);
    const tmp2Result = tmp2(1946);
  }
...
const removeCandidateContent = fn(1950).removeCandidateContent;
