...
// Function ID: 5013
// Name: MarkupRules
// Dependencies: [32, 718, 1957, 2015, 1979, 1371, 1074, 5013, 5014, 5015, 1114, 5018, 2018, 4726, 4418, 4270, 5019, 5020, 5023, 4226, 5025, 5036, 5037, 5038, 5039, 5040, 5011, 5041, 12, 2]
// Exports: hydrateCommandMention

// Module 5012 (MarkupRules)
...
import MarkupLinkRule from "MarkupLinkRule" /* 5015 */;
...
import StaticRouteRendering from "StaticRouteRendering" /* 5037 */;
import MarkupHeadingRuleDefault from "MarkupHeadingRule" /* 5038 */;
import MarkupListRuleDefault from "MarkupListRule" /* 5039 */;
import MarkupSubtextRuleDefault from "MarkupSubtextRule" /* 5040 */;
import PlatformMarkupRulesDefault from "PlatformMarkupRules" /* 5041 */;
...
function hydrateUserMention(everyoneOrHere, channelId) {
  ...
  if (null != str) {
    ...
    if (null != channel) {
      ...
      if (nickname == null) {
        nickname = tmp4(4418).getName(str);
        const tmp4Result = tmp4(4418);
      }
      str1 = nickname;
      tmp4 = importDefault;
    }
