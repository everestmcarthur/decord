...
function parseLink(arg0) {
  ...
  if (null == punycodeLinkResult) {
    ...
    const items = [obj1];
    obj[1] = items;
    obj[2] = punycodeLinkResult.target;
  }
  return obj;
}
function hydrateRoleMention(arg0, guildId) {
  ...
  let role = null;
  if (null != guild) {
    role = role.getRole(guild.id, arg0);
  }
  if (null == role) {
    ...
    if (hasEnhancedRoleColorsForRole) {
      ...
      obj1 = { primaryColor: null, secondaryColor: null, tertiaryColor: null };
      obj1[0] = primary_color;
      const colors2 = role.colors;
      let secondary_color;
      if (colors2 != null) {
        secondary_color = colors2.secondary_color;
      }
      obj1[1] = secondary_color;
      const colors3 = role.colors;
      let tertiary_color;
      if (colors3 != null) {
        tertiary_color = colors3.tertiary_color;
      }
      obj1[2] = tertiary_color;
      tmp11 = obj1;
    }
    obj[5] = tmp11;
    const _HermesInternal = HermesInternal;
    obj[6] = "@" + role.name;
    ({ color: obj3[7], colorString: obj3[8] } = role);
...
function hydrateUserMention(everyoneOrHere, channelId) {
  ...
  obj[5] = tmp14;
  obj[6] = everyoneOrHere.everyoneOrHere;
  if (null != tmp2) {
    const _HermesInternal2 = HermesInternal;
    combined = "@" + tmp2;
  }
  const items = [{ type: "text", content: combined }];
  obj[7] = items;
  return obj;
}
({ ID_REGEX: c9, MARKDOWN_SPOILER_REGEXP: c10, MARKDOWN_STATIC_ROUTE_NAME_REGEXP: unpackModuleId } = ME);
const re14 = /^( *>>> +([\s\S]*))|^( *>(?!>>) +[^\n]*(\n *>(?!>>) +[^\n]*)*\n?)/;
const re15 = /^$|\n *$/;
const re16 = /^ *>>> ?/;
const re17 = /^ *> ?/gm;
const re18 = /^((?:https?|steam):\/\/[^\s<]+[^<.,:;"'\]\s])/;
let obj = { newline: importDefaultResult.defaultRules.newline, paragraph: importDefaultResult.defaultRules.paragraph, escape: null, blockQuote: null, link: null, autolink: null, mailto: null, tel: null, url: null, strong: null, em: null, u: null, br: null, text: null, inlineCode: null, emoticon: null, codeBlock: null, roleMention: null, mention: null, silentPrefix: null, channelMention: null, channelOrMessageUrl: null, mediaPostLink: null, attachmentLink: null, commandMention: null, timestampMentionInput: null, gameMention: null, emoji: null, soundboard: null, customEmoji: null, timestamp: null, s: null, spoiler: null, staticRouteLink: null, heading: null, list: null, subtext: null };
obj = {};
let merged = Object.assign(importDefaultResult.defaultRules.escape);
obj.match = function match(arg0, allowEscape) {
  let match = null;
  if (false !== allowEscape.allowEscape) {
    match = importDefaultResult.defaultRules.escape.match(arg0, allowEscape, arg2);
    const str = importDefaultResult.defaultRules.escape;
  }
  return match;
};
obj[2] = obj;
obj = {};
const merged1 = Object.assign(importDefaultResult.defaultRules.blockQuote);
...
obj.match = function match(arg0, prevCapture) {
  ...
  if (!prevCapture.inQuote) {
    if (!prevCapture.nested) {
      if (null == prevCapture) {
        return regex4.exec(arg0);
      } else {
        let match = null;
        if (regex5.test(prevCapture[0])) {
          match = regex4.exec(arg0);
        }
        return match;
      }
    }
...
obj.parse = function parse(arg0, arg1, inQuote) {
  const BooleanResult = Boolean(regex6.exec(arg0[0]));
  let tmp2 = regex6;
  if (!BooleanResult) {
    tmp2 = closure_17;
  }
  ...
  const content = arg1(replaced, inQuote);
  inQuote.inQuote = flag;
  inQuote.inline = inQuote.inline || false;
  if (0 === content.length) {
...
obj[3] = obj;
obj[4] = validateContentTypesDefault;
let obj1 = {};
const merged2 = Object.assign(importDefaultResult.defaultRules.autolink);
obj1.parse = parseLink;
obj[5] = obj1;
let obj2 = {};
const merged3 = Object.assign(importDefaultResult.defaultRules.mailto);
obj2.match = importDefaultResult.inlineRegex(/^<([^\s<>@]+@[^\s<>@]+\.[^\s<>@]+)>/);
...
obj[6] = obj2;
const obj3 = {};
const merged4 = Object.assign(importDefaultResult.defaultRules.mailto);
obj3.requiredFirstCharacters = ["<"];
obj3.match = importDefaultResult.inlineRegex(/^<((?:(?:tel|sms):\+?|\+)(?:(?:[0-9]|\([0-9]+\)))(?:[- .\/]?(?:[0-9]|\([0-9]+\)))+)>/);
...
obj[7] = obj3;
const obj4 = {};
const merged5 = Object.assign(importDefaultResult.defaultRules.url);
...
obj[8] = obj4;
obj[9] = importDefaultResult.defaultRules.strong;
obj[10] = importDefaultResult.defaultRules.em;
obj[11] = importDefaultResult.defaultRules.u;
obj[12] = importDefaultResult.defaultRules.br;
obj[13] = textRegexpDefault;
const obj5 = {};
const merged6 = Object.assign(importDefaultResult.defaultRules.inlineCode);
obj5.parse = function parse(arg0, arg1, parseInlineCodeChildContent) {
  const inlineCode = importDefaultResult.defaultRules.inlineCode;
  ...
  if (true === parseInlineCodeChildContent.parseInlineCodeChildContent) {
    ...
    obj.validationChildContent = arg1(parsed.content, parseInlineCodeChildContent);
    tmp2 = obj;
  }
  return tmp2;
};
...
obj[16] = {
  order: importDefaultResult.defaultRules.codeBlock.order,
  requiredFirstCharacters: ["`"],
  match(arg0) {
    return /^```(?:([a-z0-9_+\-.#]+?)\n)?\n*([^\n][^]*?)\n*```/i.exec(arg0);
  },
  parse(arg0, arg1, inQuote) {
    let str = arg0[1];
    if (str == null) {
      str = "";
    }
    const obj = { lang: str, content: null, inQuote: null };
    let str2 = arg0[2];
    if (str2 == null) {
      str2 = "";
    }
    obj[1] = str2;
    obj[2] = inQuote.inQuote || inQuote.formatInline || false;
    return obj;
  }
};
const obj7 = {
...
obj[17] = {
  ...
  parse(arg0, arg1, returnMentionIds) {
    ...
    if (returnMentionIds.returnMentionIds) {
      const obj = { type: "roleMention", id: null };
      obj[1] = tmp;
      let tmp3 = obj;
    } else {
...
obj[18] = {
  ...
  requiredFirstCharacters: ["<", "@"],
  match(arg0) {
    const match = /^<@!?(\d+)>|^(@(?:everyone|here))/.exec(arg0);
    let tmp2 = null;
    if (null != match) {
      tmp2 = match;
    }
...
obj[27] = {
  ...
  match(arg0) {
    ...
    if (null != match) {
      ...
      tmpResult = parseRawEmojiObjectDefault;
    }
    return tmp4;
  },
  parse(arg0) {
    let content = parseRawEmojiObjectDefault.convertNameToSurrogate(arg0[1]);
    if (null == content) {
      const _HermesInternal = HermesInternal;
      content = ":" + arg0[1] + ":";
    }
...
obj[30] = {
  order: textRegexpDefault.order - 1,
  requiredFirstCharacters: ["<"],
  match(arg0) {
...
const obj18 = { order: importDefaultResult.defaultRules.u.order, requiredFirstCharacters: ["~"], match: null, parse: null };
const obj17 = {
  order: textRegexpDefault.order - 1,
  requiredFirstCharacters: ["<"],
  match(arg0) {
...
obj18[2] = importDefaultResult.inlineRegex(/^~~([\s\S]+?)~~(?!_)/);
obj18[3] = importDefaultResult.defaultRules.u.parse;
obj[31] = obj18;
...
obj[32] = {
  ...
  parse(arg0, arg1, channelId) {
    return { content: arg1(arg0[1], channelId), channelId: channelId.channelId };
  }
};
const obj19 = {
  order: textRegexpDefault.order,
...
obj[33] = {
  ...
  parse(arg0, arg1, guildId) {
    ...
    obj = { content: items, mainContent: null, itemContent: null, itemId: null, id: null, guildId: null, channelId: null };
    ...
    obj[3] = tmp[2];
    obj[4] = tmp[1];
    const channel1 = store.getChannel(guildId.channelId);
    let guildId1;
    if (channel1 != null) {
...
items[1] = matchDefault2;
const importDefaultResult3Result = importDefaultResult3(items);
const omitResult = importDefaultResult4.omit(importDefaultResult3Result, ["inlineCode", "codeBlock", "br", "blockQuote", "subtext", "soundboard"]);
const importDefaultResult5 = importDefaultResult4;
const omitResult1 = importDefaultResult4.omit(importDefaultResult3Result, ["inlineCode", "codeBlock", "br", "blockQuote", "autolink", "url", "attachmentLink", "mention", "roleMention", "channelMention", "channelOrMessageUrl", "mediaPostLink", "subtext", "soundboard", "gameMention"]);
const importDefaultResult6 = importDefaultResult4;
const omitResult2 = importDefaultResult4.omit(importDefaultResult3Result, ["codeBlock", "br", "mention", "channel", "roleMention", "attachmentLink", "subtext", "soundboard", "gameMention"]);
let items1 = [
...
const importDefaultResult7 = importDefaultResult4;
const obj21 = {
  match(arg0, arg1, arg2) {
    const match = importDefaultResult3Result.codeBlock.match(arg0, arg1, arg2);
    if (null != match) {
...
const omitResult3 = importDefaultResult4.omit(importDefaultResult3(items1), ["blockQuote", "codeBlock", "br"]);
const importDefaultResult8 = importDefaultResult4;
const omitResult4 = importDefaultResult4.omit(importDefaultResult3Result, ["codeBlock", "br", "blockQuote"]);
const importDefaultResult9 = importDefaultResult4;
const omitResult5 = importDefaultResult4.omit(importDefaultResult3Result, ["codeBlock", "br", "attachmentLink", "mention", "roleMention", "channel", "paragraph", "newline", "subtext", "soundboard"]);
const importDefaultResult10 = importDefaultResult4;
const omitResult6 = importDefaultResult4.omit(importDefaultResult3Result, ["codeBlock", "blockQuote", "br"]);
const importDefaultResult11 = importDefaultResult4;
let items2 = [
  {
    highlightWord: {
      order: -1,
      ...
      parse(arg0, arg1, arg2) {
        ...
        const _module = require(global[2], obj);
        const _module1 = require(global[3], obj);
...
const omitResult7 = importDefaultResult4.omit(importDefaultResult3Result, ["codeBlock", "br", "inlineCode"]);
const importDefaultResult12 = importDefaultResult3;
items2[1] = importDefaultResult4.omit(importDefaultResult3Result, ["url"]);
const importDefaultResult13 = importDefaultResult4;
const obj23 = { RULES: importDefaultResult3Result, CHANNEL_TOPIC_RULES: omitResult, VOICE_CHANNEL_STATUS_RULES: omitResult1, EMBED_TITLE_RULES: omitResult2, INLINE_REPLY_RULES: omitResult3, GUILD_VERIFICATION_FORM_RULES: omitResult4, GUILD_EVENT_RULES: omitResult6, PROFILE_BIO_RULES: omitResult5, AUTO_MODERATION_SYSTEM_MESSAGE_RULES: importDefaultResult12(items2), NATIVE_SEARCH_RESULT_LINK_RULES: omitResult7 };
let result = require("set").fileFinishedImporting("modules/markup/MarkupRules.tsx");

export default obj23;
...
export const hydrateCommandMention = function hydrateCommandMention(commandName, commandId, channelId) {
  const items = [...callback2(commandName.split(" ")).slice(1)];
  const mapped = items.map((arg0) => "" + closure_12 + arg0);
  let obj = { type: "commandMention", channelId: channelId.channelId, commandId, commandName, commandKey: "" + commandId + mapped.join(""), content: null };
