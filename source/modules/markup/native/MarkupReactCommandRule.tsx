...
// Dependencies: [19, 1958, 1483, 5086, 5087, 21, 7637, 4498, 4607, 1610, 4985, 1115, 1177, 11367, 4337, 7303, 1936, 10778, 7308, 11369, 4636, 4506, 11371, 8233, 2]
// Exports: default

// Module 11366 (MarkupReactCommandRule)
...
function handleLongPressCommandMention(arg0, arg1) {
  ...
  if (DeveloperMode.getSetting()) {
    ...
    obj2.IconComponent = tmp(10778).IdIcon;
...
export default function MarkupReactCommandRule(node) {
  ...
  closure_1 = null != noop.useContext(node(11369).AppLauncherContext);
  ...
  const items = ["/", node(8233).smartOutput(node, output, state)];
  obj.children = items;
  return jsxs(node(4636).Text, {
    style,
    variant: "text-md/bold",
    onPress() {
      const bestActiveInput = node(closure_2[21]).getBestActiveInput();
