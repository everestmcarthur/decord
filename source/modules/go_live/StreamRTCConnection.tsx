...
// Dependencies: [1914, 4651, 4652, 502, 1957, 4654, 1908, 4655, 4629, 4656, 1074, 4631, 1090, 4633, 4657, 1952, 4658, 4659, 12, 573, 4660, 4661, 4735, 1242, 4600, 4741, 4635, 4742, 4746, 4747, 13729, 7744, 2]

// Module 4650 (StreamRTCConnection)
import _modDef12 from "module_12" /* 12 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import DurationsDefault from "Durations" /* 1090 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import CrossPlatformNativeUtilsDefault from "CrossPlatformNativeUtils" /* 4600 */;
import SoundshareStatsAggregatorDefault from "SoundshareStatsAggregator" /* 4657 */;
import StreamKeyUtils from "StreamKeyUtils" /* 4658 */;
import VideoStreamStatsDefault from "VideoStreamStats" /* 4659 */;
import BaseConnectionEvent from "BaseConnectionEvent" /* 4661 */;
import GameAnalyticsUtils from "GameAnalyticsUtils" /* 4735 */;
import getSoundshareAnalyticsContextDefault from "getSoundshareAnalyticsContext" /* 4741 */;
import getReportedStreamResolutionDefault from "getReportedStreamResolution" /* 4742 */;
import getStreamSourceMetadataDefault from "getStreamSourceMetadata" /* 4746 */;
...
import RTCConnection from "RTCConnection" /* 4633 */;
...
prototype["initializeEvents"] = function initializeEvents() {
      ...
      if (_connection8 != null) {
        _connection8.on(BaseConnectionEvent.BaseConnectionEvent.ScreenshareFinish, (screenshare_frames, videohook_frames, hybrid_dxgi_frames, hybrid_gdi_frames, hybrid_videohook_frames, hybrid_graphics_capture_frames, hybrid_capture_method_switches, hybrid_gdi_bitblt_frames, hybrid_gdi_printwindow_frames, hybrid_graphics_capture_frames_unique, hybrid_dxgi_frames_unique, hybrid_videohook_frames_unique, hybrid_gdi_bitblt_frames_unique, hybrid_gdi_printwindow_frames_unique, skip_history_json, quartz_frames, desktop_capturer_type, activity, go_live_camera_frames, screencapturekit_frames, hdr_frames_capable, hdr_frames, target_window_elevated, arg23, arg24, videohook_backend) => {
          ...
          closure_1_4().then((result) => {
            ...
            obj3.discord_is_elevated = self(4600).getDiscordIsElevated();
      ...
      if (_connection5 != null) {
        _connection5.on(BaseConnectionEvent.BaseConnectionEvent.FirstFrameStats, (remoteVideoStreamCreatedTimestamp) => {
          if (!closure_1_1._firstFrameDelivered) {
            ...
            const obj2 = self(1242);
            const obj4 = c0(4635);
            obj5.time_total_to_first_frame = c0(4635).now() - obj.getCreatedTime();
  ...
  this.on(require("RTCConnectionEvent").RTCConnectionEvent.VideoSourceQualityChanged, (guildId, channelId, senderUserId, arg3, maxFrameRate, context) => {
    ...
    let tmp4 = arg3;
    if (senderUserId === id) {
      tmp4 = self(4742)("StreamRTCConnection", guildId, arg3, maxFrameRate);
    }
...
prototype["trackVideoEndStats"] = function trackVideoEndStats(reason) {
  ...
  if (null != _videoQuality) {
    ...
    let obj = { stream_application_name: obj5(4747).default.getApplicationNames() };
    if (self.isOwner) {
      let obj2 = { clips_enabled: tmp5(13729).isClipsEnabled(), clips_buffer_length: tmp8.clipsLength };
      obj3 = obj2;
      const tmp5Result = tmp5(13729);
    } else {
      obj3 = {};
    }
    if (self.isOwner) {
    ...
    const _default = obj5(4747).default;
    tmp5 = obj5;
  }
};
