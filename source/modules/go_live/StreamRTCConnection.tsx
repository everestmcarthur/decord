...
// Dependencies: [1915, 4683, 4684, 502, 1958, 4686, 1909, 4687, 4661, 4688, 1074, 4663, 1091, 4665, 4689, 1953, 4690, 4691, 12, 573, 4692, 4693, 4767, 1241, 4632, 4773, 4667, 4774, 4778, 4779, 13778, 7780, 2]

// Module 4682 (StreamRTCConnection)
import _modDef12 from "module_12" /* 12 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import DurationsDefault from "Durations" /* 1091 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import CrossPlatformNativeUtilsDefault from "CrossPlatformNativeUtils" /* 4632 */;
import SoundshareStatsAggregatorDefault from "SoundshareStatsAggregator" /* 4689 */;
import StreamKeyUtils from "StreamKeyUtils" /* 4690 */;
import VideoStreamStatsDefault from "VideoStreamStats" /* 4691 */;
import BaseConnectionEvent from "BaseConnectionEvent" /* 4693 */;
import GameAnalyticsUtils from "GameAnalyticsUtils" /* 4767 */;
import getSoundshareAnalyticsContextDefault from "getSoundshareAnalyticsContext" /* 4773 */;
import getReportedStreamResolutionDefault from "getReportedStreamResolution" /* 4774 */;
import getStreamSourceMetadataDefault from "getStreamSourceMetadata" /* 4778 */;
...
import RTCConnection from "RTCConnection" /* 4665 */;
...
prototype["initializeEvents"] = function initializeEvents() {
      ...
      if (_connection8 != null) {
        _connection8.on(BaseConnectionEvent.BaseConnectionEvent.ScreenshareFinish, (screenshare_frames, videohook_frames, hybrid_dxgi_frames, hybrid_gdi_frames, hybrid_videohook_frames, hybrid_graphics_capture_frames, hybrid_capture_method_switches, hybrid_gdi_bitblt_frames, hybrid_gdi_printwindow_frames, hybrid_graphics_capture_frames_unique, hybrid_dxgi_frames_unique, hybrid_videohook_frames_unique, hybrid_gdi_bitblt_frames_unique, hybrid_gdi_printwindow_frames_unique, skip_history_json, quartz_frames, desktop_capturer_type, activity, go_live_camera_frames, screencapturekit_frames, hdr_frames_capable, hdr_frames, target_window_elevated, arg23, arg24, videohook_backend) => {
          ...
          closure_1_4().then((result) => {
            ...
            obj3.discord_is_elevated = self(4632).getDiscordIsElevated();
      ...
      if (_connection5 != null) {
        _connection5.on(BaseConnectionEvent.BaseConnectionEvent.FirstFrameStats, (remoteVideoStreamCreatedTimestamp) => {
          if (!closure_1_1._firstFrameDelivered) {
            ...
            const obj2 = self(1241);
            const obj4 = c0(4667);
            obj5.time_total_to_first_frame = c0(4667).now() - obj.getCreatedTime();
  ...
  this.on(require("RTCConnectionEvent").RTCConnectionEvent.VideoSourceQualityChanged, (guildId, channelId, senderUserId, arg3, maxFrameRate, context) => {
    ...
    let tmp4 = arg3;
    if (senderUserId === id) {
      tmp4 = self(4774)("StreamRTCConnection", guildId, arg3, maxFrameRate);
    }
...
prototype["trackVideoEndStats"] = function trackVideoEndStats(reason) {
  ...
  if (null != _videoQuality) {
    ...
    let obj = { stream_application_name: obj5(4779).default.getApplicationNames() };
    if (self.isOwner) {
      let obj2 = { clips_enabled: tmp5(13778).isClipsEnabled(), clips_buffer_length: tmp8.clipsLength };
      obj3 = obj2;
      const tmp5Result = tmp5(13778);
    } else {
      obj3 = {};
    }
    if (self.isOwner) {
    ...
    const _default = obj5(4779).default;
    tmp5 = obj5;
  }
};
