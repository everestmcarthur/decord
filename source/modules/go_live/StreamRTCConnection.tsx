...
// Dependencies: [1915, 4684, 4685, 502, 1958, 4687, 1909, 4688, 4662, 4689, 1074, 4664, 1091, 4666, 4690, 1953, 4691, 4692, 12, 573, 4693, 4694, 4768, 1241, 4633, 4774, 4668, 4775, 4779, 4780, 13769, 7777, 2]

// Module 4683 (StreamRTCConnection)
import _modDef12 from "module_12" /* 12 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import DurationsDefault from "Durations" /* 1091 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import CrossPlatformNativeUtilsDefault from "CrossPlatformNativeUtils" /* 4633 */;
import SoundshareStatsAggregatorDefault from "SoundshareStatsAggregator" /* 4690 */;
import StreamKeyUtils from "StreamKeyUtils" /* 4691 */;
import VideoStreamStatsDefault from "VideoStreamStats" /* 4692 */;
import BaseConnectionEvent from "BaseConnectionEvent" /* 4694 */;
import GameAnalyticsUtils from "GameAnalyticsUtils" /* 4768 */;
import getSoundshareAnalyticsContextDefault from "getSoundshareAnalyticsContext" /* 4774 */;
import getReportedStreamResolutionDefault from "getReportedStreamResolution" /* 4775 */;
import getStreamSourceMetadataDefault from "getStreamSourceMetadata" /* 4779 */;
...
import RTCConnection from "RTCConnection" /* 4666 */;
...
prototype["initializeEvents"] = function initializeEvents() {
      ...
      if (_connection8 != null) {
        _connection8.on(BaseConnectionEvent.BaseConnectionEvent.ScreenshareFinish, (screenshare_frames, videohook_frames, hybrid_dxgi_frames, hybrid_gdi_frames, hybrid_videohook_frames, hybrid_graphics_capture_frames, hybrid_capture_method_switches, hybrid_gdi_bitblt_frames, hybrid_gdi_printwindow_frames, hybrid_graphics_capture_frames_unique, hybrid_dxgi_frames_unique, hybrid_videohook_frames_unique, hybrid_gdi_bitblt_frames_unique, hybrid_gdi_printwindow_frames_unique, skip_history_json, quartz_frames, desktop_capturer_type, activity, go_live_camera_frames, screencapturekit_frames, hdr_frames_capable, hdr_frames, target_window_elevated, arg23, arg24, videohook_backend) => {
          ...
          closure_1_4().then((result) => {
            ...
            obj3.discord_is_elevated = self(4633).getDiscordIsElevated();
      ...
      if (_connection5 != null) {
        _connection5.on(BaseConnectionEvent.BaseConnectionEvent.FirstFrameStats, (remoteVideoStreamCreatedTimestamp) => {
          if (!closure_1_1._firstFrameDelivered) {
            ...
            const obj2 = self(1241);
            const obj4 = c0(4668);
            obj5.time_total_to_first_frame = c0(4668).now() - obj.getCreatedTime();
  ...
  this.on(require("RTCConnectionEvent").RTCConnectionEvent.VideoSourceQualityChanged, (guildId, channelId, senderUserId, arg3, maxFrameRate, context) => {
    ...
    let tmp4 = arg3;
    if (senderUserId === id) {
      tmp4 = self(4775)("StreamRTCConnection", guildId, arg3, maxFrameRate);
    }
...
prototype["trackVideoEndStats"] = function trackVideoEndStats(reason) {
  ...
  if (null != _videoQuality) {
    ...
    let obj = { stream_application_name: obj5(4780).default.getApplicationNames() };
    if (self.isOwner) {
      let obj2 = { clips_enabled: tmp5(13769).isClipsEnabled(), clips_buffer_length: tmp8.clipsLength };
      obj3 = obj2;
      const tmp5Result = tmp5(13769);
    } else {
      obj3 = {};
    }
    if (self.isOwner) {
    ...
    const _default = obj5(4780).default;
    tmp5 = obj5;
  }
};
