...
// Dependencies: [5, 17, 4662, 1958, 2012, 1074, 1921, 3, 1953, 1936, 573, 1271, 1899, 1911, 38, 4782, 4841, 4692, 1478, 10102, 9838, 1115, 2]

// Module 4781 (VoiceEngineStreamingManager)
...
const getAppIntentScheme = fn(1921).getAppIntentScheme;
...
prototype["_initialize"] = function _initialize() {
  ...
  let result = voiceEngine.setBroadcastRequestCallback(() => {
    ...
    if (null != channel) {
      ...
      currentUserActiveStream(4782).startStream(guildId, channel.id, { sourceId: "screen:0" });
      currentUserActiveStream = currentAppIntent.getCurrentUserActiveStream();
      if (null != currentUserActiveStream) {
        const tmp2Result = closure_1(4841);
        const participant = tmp2Result.selectParticipant(channel.id, tmp9(4692).encodeStreamKey(currentUserActiveStream));
        ...
        const tmp9Result = tmp9(4692);
      }
      const obj3 = currentUserActiveStream(4782);
