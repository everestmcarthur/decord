...
// Dependencies: [5, 17, 4627, 1957, 2011, 1074, 1920, 3, 4492, 1935, 573, 1272, 1898, 1910, 38, 4747, 4806, 4657, 1477, 10021, 9757, 1114, 2]

// Module 4746 (VoiceEngineStreamingManager)
  ...
  let result = voiceEngine.setBroadcastRequestCallback(() => {
    ...
    if (null != channel) {
      ...
      if (null != currentUserActiveStream) {
        ...
        const participant = tmp2Result.selectParticipant(channel.id, tmp9(4657).encodeStreamKey(currentUserActiveStream));
