...
// Dependencies: [5, 17, 4744, 1958, 2012, 1074, 1921, 3, 1953, 1936, 573, 1271, 1899, 1911, 38, 4864, 4923, 4774, 1478, 10196, 9932, 1115, 2]

// Module 4863 (VoiceEngineStreamingManager)
...
prototype["_initialize"] = function _initialize() {
  ...
  let result = voiceEngine.setBroadcastRequestCallback(() => {
    ...
    if (null != channel) {
      ...
      currentUserActiveStream(4864).startStream(guildId, channel.id, { sourceId: "screen:0" });
      currentUserActiveStream = currentAppIntent.getCurrentUserActiveStream();
      if (null != currentUserActiveStream) {
        const tmp2Result = closure_1(4923);
        const participant = tmp2Result.selectParticipant(channel.id, tmp9(4774).encodeStreamKey(currentUserActiveStream));
        ...
        const tmp9Result = tmp9(4774);
      }
      const obj3 = currentUserActiveStream(4864);
