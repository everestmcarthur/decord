...
// Dependencies: [5, 17, 4661, 1958, 2012, 1074, 1921, 3, 1953, 1936, 573, 1271, 1899, 1911, 38, 4781, 4840, 4691, 1478, 10083, 9819, 1115, 2]

// Module 4780 (VoiceEngineStreamingManager)
  ...
  let result = voiceEngine.setBroadcastRequestCallback(() => {
    ...
    if (null != channel) {
      ...
      if (null != currentUserActiveStream) {
        ...
        const participant = tmp2Result.selectParticipant(channel.id, tmp9(4691).encodeStreamKey(currentUserActiveStream));
