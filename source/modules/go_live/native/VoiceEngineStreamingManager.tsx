...
// Dependencies: [5, 17, 4660, 1958, 2012, 1074, 1921, 3, 1953, 1936, 573, 1271, 1899, 1911, 38, 4780, 4839, 4690, 1478, 10091, 9827, 1115, 2]

// Module 4779 (VoiceEngineStreamingManager)
  ...
  let result = voiceEngine.setBroadcastRequestCallback(() => {
    ...
    if (null != channel) {
      ...
      if (null != currentUserActiveStream) {
        ...
        const participant = tmp2Result.selectParticipant(channel.id, tmp9(4690).encodeStreamKey(currentUserActiveStream));
