...
// Dependencies: [19, 4686, 4687, 4665, 21, 3, 18128, 4985, 18129, 1897, 10109, 9243, 2]

// Module 18127 (ApplicationStreamingManager)
...
import ApplicationStreamingManager from "go_live/ApplicationStreamingManager" /* 18128 */;

const require = fn;
const ApplicationStreamPresets = fn(4687).ApplicationStreamPresets;
...
prototype["platformHandleStreamStart"] = function platformHandleStreamStart(sourceId) {
  ...
  if (null != sourceId) {
    ...
    setGoLiveSource = setGoLiveSource(9243).setGoLiveSource;
    ...
    const setGoLiveSourceResult = setGoLiveSource(9243);
  } else {
