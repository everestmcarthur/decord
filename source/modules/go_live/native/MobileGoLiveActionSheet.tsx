...
// Dependencies: [32, 19, 4685, 4661, 1958, 1980, 2012, 1372, 4686, 1074, 4664, 21, 4639, 576, 1365, 4606, 10084, 1897, 1249, 504, 10085, 10090, 7269, 7289, 4376, 4781, 9221, 7065, 1115, 2235, 10091, 10093, 5674, 4635, 4340, 10095, 7257, 6732, 7230, 5772, 5770, 9445, 1094, 5773, 10096, 7958, 10101, 7307, 5059, 10083, 2]
// Exports: showMobileGoLiveActionSheet

// Module 10084 (MobileGoLiveActionSheet)
...
import getStreamSettingsForPreset from "getStreamSettingsForPreset" /* 10085 */;
import SpeedometerIcon from "SpeedometerIcon" /* 10091 */;
import ImageSparkleIcon from "ImageSparkleIcon" /* 10093 */;
...
require = fn;
let ApplicationStreamPresets = fn(4686).ApplicationStreamPresets;
  ...
  if (tmp11) {
    ...
    const obj11 = {
      ...
      children: closure_18.map((value) => {
          ...
          items[1] = closure_2_14(BaseIconImage.BaseIconImage, { source: _modDef10095, size: "xs" });
          obj9.children = items;
...
export const showMobileGoLiveActionSheet = function showMobileGoLiveActionSheet(location_stack) {
  ...
  obj.openLazy(asyncRequireImpl(10084, dependencyMap.paths), MobileGoLiveActionSheet, obj2);
};
