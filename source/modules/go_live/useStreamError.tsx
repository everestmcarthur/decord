...
// Function ID: 9712
// Name: useStreamError
// Dependencies: [9687, 9200, 504, 2]
// Exports: default

// Module 9711 (useStreamError)
import AVErrorStore from "AVErrorStore" /* 9687 */;

const require = fn;
let closure_3 = { [fn(9200).AVError.STREAM_SOUNDSHARE_FAILED]: 0, [fn(9200).AVError.STREAM_SEND_HIGH_PACKET_LOSS]: 1, [fn(9200).AVError.STREAM_VIEW_HIGH_PACKET_LOSS]: 1, [fn(9200).AVError.STREAM_SEND_LOW_FPS]: 2, [fn(9200).AVError.STREAM_VIEW_LOW_FPS]: 2, [fn(9200).AVError.STREAM_BAD_NETWORK_QUALITY]: 3 };
const size = fn(2);
