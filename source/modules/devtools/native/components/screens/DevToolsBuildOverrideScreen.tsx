...
// Dependencies: [32, 19, 17, 11571, 21, 4638, 576, 9001, 15699, 7091, 504, 11932, 5058, 5773, 5691, 4584, 7299, 4335, 15265, 4595, 5771, 5774, 6714, 5060, 1370, 2]

// Module 15698 (DevToolsBuildOverrideScreen)
...
let items = [{ label: "Branch Name", value: "branch", icon: jsx(fn(9001).TagIcon, {}) }, ];
let obj5 = { label: "Branch Name", value: "branch", icon: jsx(fn(9001).TagIcon, {}) };
items[1] = { label: "Commit SHA", value: "id", icon: jsx(fn(15699).HashmarkIcon, {}) };
let obj6 = { label: "Commit SHA", value: "id", icon: jsx(fn(15699).HashmarkIcon, {}) };
const size = fn(2);
...
export default noop.memo(() => {
  ...
  const stateFromStores = first(504).useStateFromStores(items, () => {
    ...
    let tmp;
    if (overrides != null) {
      tmp = overrides[first(undefined, 11932).DEVICE_FIELD];
    }
    return tmp;
  });
  ...
  obj3.paddingBottom = tmp.contentContainer.padding + first(7091)({ includeKeyboardHeight: true }).insets.bottom;
  obj2.contentContainerStyle = obj3;
  let tmp10Result = null;
  if (null != stateFromStores) {
    const obj4 = { icon: tmp7(tmp3(4584).CopyIcon, {}), label: null, subLabel: null, onPress: null };
    first = stateFromStores;
    ...
    const items1 = [tmp7(tmp3(5691).TableRow, obj4), , ];
    const obj6 = { icon: tmp7(tmp3(15265).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(11932).refreshBuildOverride, arrow: true };
    items1[1] = tmp7(tmp3(5691).TableRow, obj6);
    const obj7 = { icon: tmp7(tmp3(4595).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(11932).clearBuildOverride, arrow: true };
    items1[2] = tmp7(tmp3(5691).TableRow, obj7);
    obj5.children = items1;
    tmp10Result = tmp10(tmp3(5773).TableRowGroup, obj5);
  }
  ...
  let obj = first(504);
  items2[1] = jsx(first(5771).TableRadioGroup, {
    ...
    children: items.map((value) => {
      value = value.value;
      ({ icon, label } = value);
      return jsx(first(5774).TableRadioRow, { value, label, icon }, value);
    })
  });
  ...
  obj10.label = jsx(first(6714).TextInput, {
    size: "md",
  ...
  obj9.children = jsx(first(5691).TableRow, { icon, label: null });
  items2[2] = jsx(first(5773).TableRowGroup, { title: label1, hasIcons: true, children: null });
  items2[3] = jsx(first(5060).Button, {
  ...
  obj2.children = jsxs(first(5058).Stack, { spacing: 16, children: null });
