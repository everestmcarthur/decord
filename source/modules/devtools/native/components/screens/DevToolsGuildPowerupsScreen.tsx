...
// Dependencies: [5, 19, 17, 1221, 12632, 1979, 4426, 15784, 1074, 21, 4605, 576, 1272, 4196, 4503, 12558, 15698, 7252, 12564, 1940, 1943, 1611, 504, 4601, 5737, 5655, 2]
// Exports: default

// Module 15783 (DevToolsGuildPowerupsScreen)
    ...
    try {
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          let addResult = null;
          if (!closure_2) {
            addResult = _modDef4196().add(1, "day");
            const obj4 = _modDef4196();
          }
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12564).markContentAsDismissed(dc, guildId, false);
  ...
  return closure_18(dc(7252).TableSwitchRow, { label: closure_15(dc), value: dc.isDismissed, onValueChange: callback });
}
get_ActivityIndicator = fn(17);
({ ScrollView: hasOwnProperty, View: metroRequire } = get_ActivityIndicator);
const DevToolsGuildPowerupsConstants = fn(15784);
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj5.style = items4;
    obj5.children = closure_18(tmp5(4601).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
    ...
    obj8.children = closure_18(tmp5(5655).TableRow, obj9);
    const items6 = [closure_18(tmp5(5737).TableRowGroup, obj8), , , , , , ];
    ...
    const items7 = [closure_18(tmp5(5655).TableRow, obj11), ];
    const obj12 = {
    ...
    items7[1] = closure_18(tmp5(5655).TableRow, obj12);
    obj10.children = items7;
    items6[1] = closure_19(tmp5(5737).TableRowGroup, obj10);
    const obj13 = { title: "User Level DCs", hasIcons: false, children: closure_13.map((dc) => closure_1_18(UserDCSwitchRow, { dc }, dc)) };
    items6[2] = closure_18(tmp5(5737).TableRowGroup, obj13);
    ...
    items6[3] = closure_18(tmp5(5737).TableRowGroup, obj14);
    ...
    obj17.children = closure_18(tmp5(5655).TableRow, obj18);
    items6[6] = closure_18(tmp5(5737).TableRowGroup, obj17);
