...
// Dependencies: [5, 19, 17, 1220, 12697, 1980, 4461, 15804, 1074, 21, 4639, 576, 1271, 4231, 4537, 12623, 15716, 7307, 12629, 1941, 1944, 1612, 504, 4635, 5772, 5690, 2]
// Exports: default

// Module 15803 (DevToolsGuildPowerupsScreen)
...
import toggleDismissibleContentDismissStateDefault from "toggleDismissibleContentDismissState" /* 15716 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import UserSettingsProtoStore from "UserSettingsProtoStore" /* 1220 */;
import AppliedGuildBoostStore from "AppliedGuildBoostStore" /* 12697 */;
    ...
    try {
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          let addResult = null;
          if (!closure_2) {
            addResult = _modDef4231().add(1, "day");
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12629).markContentAsDismissed(dc, guildId, false);
      const tmpResult = tmp(12629);
    } else {
      const result1 = tmp(1941).removeDismissedRecurringContent(dismissible_content.DismissibleContent.GUILD_POWERUP_NOTIFICATION);
      const tmpResult2 = tmp(1941);
      const result2 = GuildDismissibleContentUtils.unmarkContentAsDismissed(dc, guildId);
    }
  }, items);
  return closure_18(dc(7307).TableSwitchRow, { label: closure_15(dc), value: dc.isDismissed, onValueChange: callback });
}
get_ActivityIndicator = fn(17);
({ ScrollView: hasOwnProperty, View: metroRequire } = get_ActivityIndicator);
const DevToolsGuildPowerupsConstants = fn(15804);
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj5.style = items4;
    obj5.children = closure_18(tmp5(4635).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
    ...
    obj8.children = closure_18(tmp5(5690).TableRow, obj9);
    const items6 = [closure_18(tmp5(5772).TableRowGroup, obj8), , , , , , ];
    ...
    const items7 = [closure_18(tmp5(5690).TableRow, obj11), ];
    const obj12 = {
    ...
    items7[1] = closure_18(tmp5(5690).TableRow, obj12);
    obj10.children = items7;
    items6[1] = closure_19(tmp5(5772).TableRowGroup, obj10);
    const obj13 = { title: "User Level DCs", hasIcons: false, children: closure_13.map((dc) => closure_1_18(UserDCSwitchRow, { dc }, dc)) };
    items6[2] = closure_18(tmp5(5772).TableRowGroup, obj13);
    ...
    items6[3] = closure_18(tmp5(5772).TableRowGroup, obj14);
    ...
    obj17.children = closure_18(tmp5(5690).TableRow, obj18);
    items6[6] = closure_18(tmp5(5772).TableRowGroup, obj17);
