...
// Dependencies: [32, 19, 17, 4868, 7221, 1980, 4461, 21, 4640, 576, 504, 7284, 1612, 7282, 7279, 5775, 5693, 4636, 6717, 5062, 2]
// Exports: default

// Module 15861 (DevToolsAccountLinkingScreen)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import useStartAuthorizeDefault from "useStartAuthorize" /* 7279 */;
...
export default function DevToolsAccountLinkingScreen() {
  ...
  getOrFetchApplication = value(7282).useGetOrFetchApplication(value);
  const tmp8Result = value(7282);
  ...
  if (null != stateFromStores) {
    if (found.length > 0) {
      ...
      mapped1 = tmp18(tmp8(5693).TableRow, { label: "No official games" });
    }
  } else {
    obj6.children = tmp18(tmp8(5693).TableRow, { label: "No guild selected" });
    const items6 = [tmp18(tmp8(5775).TableRowGroup, obj6), , , ];
    const obj7 = { style: null, children: null };
    const obj8 = { padding: tmp2(576).space.PX_12 };
    obj7.style = obj8;
    const obj9 = { label: "Application ID", value, onChange: tmp7 };
    obj7.children = tmp18(tmp8(6717).TextInput, obj9);
    ...
    items7[1] = tmp18(tmp8(5693).TableRow, obj11);
    const obj12 = { label: null };
    const _HermesInternal2 = HermesInternal;
    obj12.label = "Linked Games: " + str2;
    items7[2] = tmp18(tmp8(5693).TableRow, obj12);
    obj10.children = items7;
    items6[1] = tmp16(tmp8(5775).TableRowGroup, obj10);
    ...
    obj13.children = str7;
    obj14.trailing = tmp18(tmp8(4636).Text, obj13);
    const items8 = [tmp18(tmp8(5693).TableRow, obj14), , ];
    let str8 = "text-muted";
    if (hasAlreadyLinked) {
    ...
    obj15.children = str9;
    obj17.trailing = tmp18(tmp8(4636).Text, obj15);
    items8[1] = tmp18(tmp8(5693).TableRow, obj17);
    ...
    if (tmp16Result) {
      ...
      items10[1] = tmp18(tmp8(5693).TableRow, obj26);
      obj25.children = items10;
      tmp16Result = tmp16(tmp8(5775).TableRowGroup, obj25);
    }
