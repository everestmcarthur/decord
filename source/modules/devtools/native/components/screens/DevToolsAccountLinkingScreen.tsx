...
// Dependencies: [32, 19, 17, 4866, 7217, 1980, 4459, 21, 4638, 576, 504, 7280, 1612, 7278, 7275, 5773, 5691, 4634, 6714, 5060, 2]
// Exports: default

// Module 15844 (DevToolsAccountLinkingScreen)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import useStartAuthorizeDefault from "useStartAuthorize" /* 7275 */;
...
export default function DevToolsAccountLinkingScreen() {
  ...
  getOrFetchApplication = value(7278).useGetOrFetchApplication(value);
  const tmp8Result = value(7278);
  ...
  if (null != stateFromStores) {
    if (found.length > 0) {
      ...
      mapped1 = tmp18(tmp8(5691).TableRow, { label: "No official games" });
    }
  } else {
    obj6.children = tmp18(tmp8(5691).TableRow, { label: "No guild selected" });
    const items6 = [tmp18(tmp8(5773).TableRowGroup, obj6), , , ];
    const obj7 = { style: null, children: null };
    const obj8 = { padding: tmp2(576).space.PX_12 };
    obj7.style = obj8;
    const obj9 = { label: "Application ID", value, onChange: tmp7 };
    obj7.children = tmp18(tmp8(6714).TextInput, obj9);
    ...
    items7[1] = tmp18(tmp8(5691).TableRow, obj11);
    const obj12 = { label: null };
    const _HermesInternal2 = HermesInternal;
    obj12.label = "Linked Games: " + str2;
    items7[2] = tmp18(tmp8(5691).TableRow, obj12);
    obj10.children = items7;
    items6[1] = tmp16(tmp8(5773).TableRowGroup, obj10);
    ...
    obj13.children = str7;
    obj14.trailing = tmp18(tmp8(4634).Text, obj13);
    const items8 = [tmp18(tmp8(5691).TableRow, obj14), , ];
    let str8 = "text-muted";
    if (hasAlreadyLinked) {
    ...
    obj15.children = str9;
    obj17.trailing = tmp18(tmp8(4634).Text, obj15);
    items8[1] = tmp18(tmp8(5691).TableRow, obj17);
    ...
    if (tmp16Result) {
      ...
      items10[1] = tmp18(tmp8(5691).TableRow, obj26);
      obj25.children = items10;
      tmp16Result = tmp16(tmp8(5773).TableRowGroup, obj25);
    }
