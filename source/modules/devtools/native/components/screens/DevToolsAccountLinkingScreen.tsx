...
// Dependencies: [32, 19, 17, 4802, 7121, 1979, 4395, 21, 4574, 576, 504, 7184, 1611, 7182, 7179, 5701, 5619, 4570, 6620, 4989, 2]
// Exports: default

// Module 15757 (DevToolsAccountLinkingScreen)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1611 */;
import useStartAuthorizeDefault from "useStartAuthorize" /* 7179 */;
...
export default function DevToolsAccountLinkingScreen() {
  ...
  getOrFetchApplication = value(7182).useGetOrFetchApplication(value);
  const tmp8Result = value(7182);
  ...
  if (null != stateFromStores) {
    if (found.length > 0) {
      ...
      mapped1 = tmp18(tmp8(5619).TableRow, { label: "No official games" });
    }
  } else {
    obj6.children = tmp18(tmp8(5619).TableRow, { label: "No guild selected" });
    const items6 = [tmp18(tmp8(5701).TableRowGroup, obj6), , , ];
    const obj7 = { style: null, children: null };
    const obj8 = { padding: tmp2(576).space.PX_12 };
    obj7.style = obj8;
    const obj9 = { label: "Application ID", value, onChange: tmp7 };
    obj7.children = tmp18(tmp8(6620).TextInput, obj9);
    ...
    items7[1] = tmp18(tmp8(5619).TableRow, obj11);
    const obj12 = { label: null };
    const _HermesInternal2 = HermesInternal;
    obj12.label = "Linked Games: " + str2;
    items7[2] = tmp18(tmp8(5619).TableRow, obj12);
    obj10.children = items7;
    items6[1] = tmp16(tmp8(5701).TableRowGroup, obj10);
    ...
    obj13.children = str7;
    obj14.trailing = tmp18(tmp8(4570).Text, obj13);
    const items8 = [tmp18(tmp8(5619).TableRow, obj14), , ];
    let str8 = "text-muted";
    if (hasAlreadyLinked) {
    ...
    obj15.children = str9;
    obj17.trailing = tmp18(tmp8(4570).Text, obj15);
    items8[1] = tmp18(tmp8(5619).TableRow, obj17);
    ...
    if (tmp16Result) {
      ...
      items10[1] = tmp18(tmp8(5619).TableRow, obj26);
      obj25.children = items10;
      tmp16Result = tmp16(tmp8(5701).TableRowGroup, obj25);
    }
