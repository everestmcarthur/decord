...
// Dependencies: [32, 19, 17, 4867, 7214, 1980, 4461, 21, 4639, 576, 504, 7277, 1612, 7275, 7272, 5772, 5690, 4635, 6711, 5059, 2]
// Exports: default

// Module 15826 (DevToolsAccountLinkingScreen)
...
export default function DevToolsAccountLinkingScreen() {
  ...
  getOrFetchApplication = value(7275).useGetOrFetchApplication(value);
  const tmp8Result = value(7275);
  ...
  if (null != stateFromStores) {
    if (found.length > 0) {
      ...
      mapped1 = tmp18(tmp8(5690).TableRow, { label: "No official games" });
    }
  } else {
    obj6.children = tmp18(tmp8(5690).TableRow, { label: "No guild selected" });
    const items6 = [tmp18(tmp8(5772).TableRowGroup, obj6), , , ];
    const obj7 = { style: null, children: null };
    const obj8 = { padding: tmp2(576).space.PX_12 };
    obj7.style = obj8;
    const obj9 = { label: "Application ID", value, onChange: tmp7 };
    obj7.children = tmp18(tmp8(6711).TextInput, obj9);
    ...
    items7[1] = tmp18(tmp8(5690).TableRow, obj11);
    const obj12 = { label: null };
    const _HermesInternal2 = HermesInternal;
    obj12.label = "Linked Games: " + str2;
    items7[2] = tmp18(tmp8(5690).TableRow, obj12);
    obj10.children = items7;
    items6[1] = tmp16(tmp8(5772).TableRowGroup, obj10);
    ...
    obj13.children = str7;
    obj14.trailing = tmp18(tmp8(4635).Text, obj13);
    const items8 = [tmp18(tmp8(5690).TableRow, obj14), , ];
    let str8 = "text-muted";
    if (hasAlreadyLinked) {
    ...
    obj15.children = str9;
    obj17.trailing = tmp18(tmp8(4635).Text, obj15);
    items8[1] = tmp18(tmp8(5690).TableRow, obj17);
    ...
    if (tmp16Result) {
      ...
      items10[1] = tmp18(tmp8(5690).TableRow, obj26);
      obj25.children = items10;
      tmp16Result = tmp16(tmp8(5772).TableRowGroup, obj25);
    }
