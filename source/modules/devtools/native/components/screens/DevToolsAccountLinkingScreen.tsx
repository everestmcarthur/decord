...
// Dependencies: [32, 19, 17, 4833, 7159, 1979, 4426, 21, 4605, 576, 504, 7222, 1611, 7220, 7217, 5737, 5655, 4601, 6656, 5025, 2]
// Exports: default

// Module 15806 (DevToolsAccountLinkingScreen)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1611 */;
import useStartAuthorizeDefault from "useStartAuthorize" /* 7217 */;
...
export default function DevToolsAccountLinkingScreen() {
  ...
  getOrFetchApplication = value(7220).useGetOrFetchApplication(value);
  const tmp8Result = value(7220);
  ...
  if (null != stateFromStores) {
    if (found.length > 0) {
      ...
      mapped1 = tmp18(tmp8(5655).TableRow, { label: "No official games" });
    }
  } else {
    obj6.children = tmp18(tmp8(5655).TableRow, { label: "No guild selected" });
    const items6 = [tmp18(tmp8(5737).TableRowGroup, obj6), , , ];
    const obj7 = { style: null, children: null };
    const obj8 = { padding: tmp2(576).space.PX_12 };
    obj7.style = obj8;
    const obj9 = { label: "Application ID", value, onChange: tmp7 };
    obj7.children = tmp18(tmp8(6656).TextInput, obj9);
    ...
    items7[1] = tmp18(tmp8(5655).TableRow, obj11);
    const obj12 = { label: null };
    const _HermesInternal2 = HermesInternal;
    obj12.label = "Linked Games: " + str2;
    items7[2] = tmp18(tmp8(5655).TableRow, obj12);
    obj10.children = items7;
    items6[1] = tmp16(tmp8(5737).TableRowGroup, obj10);
    ...
    obj13.children = str7;
    obj14.trailing = tmp18(tmp8(4601).Text, obj13);
    const items8 = [tmp18(tmp8(5655).TableRow, obj14), , ];
    let str8 = "text-muted";
    if (hasAlreadyLinked) {
    ...
    obj15.children = str9;
    obj17.trailing = tmp18(tmp8(4601).Text, obj15);
    items8[1] = tmp18(tmp8(5655).TableRow, obj17);
    ...
    if (tmp16Result) {
      ...
      items10[1] = tmp18(tmp8(5655).TableRow, obj26);
      obj25.children = items10;
      tmp16Result = tmp16(tmp8(5737).TableRowGroup, obj25);
    }
