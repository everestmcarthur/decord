...
// Dependencies: [32, 19, 17, 4950, 7303, 1980, 4543, 21, 4722, 576, 504, 7366, 1612, 7364, 7361, 5857, 5775, 4718, 6799, 5144, 2]
// Exports: default

// Module 15956 (DevToolsAccountLinkingScreen)
import nativeDefault from "native" /* 576 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1612 */;
import useStartAuthorizeDefault from "useStartAuthorize" /* 7361 */;
...
export default function DevToolsAccountLinkingScreen() {
  ...
  getOrFetchApplication = value(7364).useGetOrFetchApplication(value);
  const tmp8Result = value(7364);
  ...
  if (null != stateFromStores) {
    if (found.length > 0) {
      ...
      mapped1 = tmp18(tmp8(5775).TableRow, { label: "No official games" });
    }
  } else {
    obj6.children = tmp18(tmp8(5775).TableRow, { label: "No guild selected" });
    const items6 = [tmp18(tmp8(5857).TableRowGroup, obj6), , , ];
    const obj7 = { style: null, children: null };
    const obj8 = { padding: tmp2(576).space.PX_12 };
    obj7.style = obj8;
    const obj9 = { label: "Application ID", value, onChange: tmp7 };
    obj7.children = tmp18(tmp8(6799).TextInput, obj9);
    ...
    items7[1] = tmp18(tmp8(5775).TableRow, obj11);
    const obj12 = { label: null };
    const _HermesInternal2 = HermesInternal;
    obj12.label = "Linked Games: " + str2;
    items7[2] = tmp18(tmp8(5775).TableRow, obj12);
    obj10.children = items7;
    items6[1] = tmp16(tmp8(5857).TableRowGroup, obj10);
    ...
    obj13.children = str7;
    obj14.trailing = tmp18(tmp8(4718).Text, obj13);
    const items8 = [tmp18(tmp8(5775).TableRow, obj14), , ];
    let str8 = "text-muted";
    if (hasAlreadyLinked) {
    ...
    obj15.children = str9;
    obj17.trailing = tmp18(tmp8(4718).Text, obj15);
    items8[1] = tmp18(tmp8(5775).TableRow, obj17);
    ...
    if (tmp16Result) {
      ...
      items10[1] = tmp18(tmp8(5775).TableRow, obj26);
      obj25.children = items10;
      tmp16Result = tmp16(tmp8(5857).TableRowGroup, obj25);
    }
