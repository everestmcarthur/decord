...
// Dependencies: [5, 32, 19, 17, 1085, 21, 4606, 576, 7223, 7222, 4602, 11885, 4573, 5024, 5738, 5656, 15627, 7262, 7984, 4555, 15723, 2]
// Exports: default
...
function OtaVerificationActionSheet(result) {
  ...
  if (null !== result.totalFileCount) {
    ...
    const items4 = [tmp5(tmp3(4602).Text, { variant: "heading-md/bold", children: "File Counts" }), ];
    ...
    items4[1] = tmp2(tmp3(4602).Text, obj6);
  ...
  if (result.failures.length > 0) {
    ...
    const items6 = [tmp5(tmp3(4602).Text, { variant: "heading-md/bold", children: "Failures" }), ];
...
export default function DevToolsOTATestScreen() {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj5 = { value: tmp5(11885).verifyOtaFiles(), done: false };
            return obj5;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          tmp5(4573).openLazy(Promise.resolve(obj7), "OtaVerificationActionSheet", obj8);
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp10) {
  ...
  const items = [
    closure_8(subLabel(5656).TableRow, { label: "Status", subLabel: tmp8[0], icon: closure_8(subLabel(15627).WrenchIcon, {}) }),
    closure_8(subLabel(5656).TableRow, {
  ...
  obj2.children = items;
  const items1 = [closure_9(subLabel(5738).TableRowGroup, obj2), , , ];
  let str;
  if (tmp5 != null) {
    str = tmp5.source;
  }
  ...
  const items2 = [closure_8(subLabel(5656).TableRow, { label: "Manifest Source", subLabel: str, icon: closure_8(subLabel(15627).WrenchIcon, {}) }), ];
  const obj6 = { icon: closure_8(subLabel(7984).PaperIcon, {}), label: null };
  let str2 = "{}";
  if (null != tmp5) {
  ...
  obj6.label = str2;
  items2[1] = closure_8(subLabel(5656).TableRow, obj6);
  obj7.children = items2;
  items1[1] = closure_9(subLabel(5738).TableRowGroup, obj7);
  ...
  obj8.subLabel = str3;
  const items3 = [closure_8(subLabel(5656).TableRow, obj8), ];
  let tmp12Result = null != tmp7;
  if (tmp12Result) {
    const obj9 = { icon: tmp12(tmp15(15627).WrenchIcon, {}), label: null };
    const _JSON = JSON;
    obj9.label = JSON.stringify(tmp7, null, 2);
    tmp12Result = tmp12(tmp15(5656).TableRow, obj9);
  }
  items3[1] = tmp12Result;
  items1[2] = closure_9(subLabel(5738).TableRowGroup, { title: "Build Override Cookie", hasIcons: true, children: items3 });
  let obj5 = { label: "Manifest Source", subLabel: str, icon: closure_8(subLabel(15627).WrenchIcon, {}) };
  const items4 = [closure_8(subLabel(5656).TableRow, { label: "Check for Update & Reload", icon: closure_8(subLabel(4555).DownloadIcon, {}), onPress: BundleUpdaterDefault.checkForUpdateAndReload }), ];
  ...
  const obj10 = { label: "Check for Update & Reload", icon: closure_8(subLabel(4555).DownloadIcon, {}), onPress: BundleUpdaterDefault.checkForUpdateAndReload };
  items4[1] = closure_8(subLabel(5656).TableRow, {
  ...
  items1[3] = closure_9(subLabel(5738).TableRowGroup, obj12);
  obj11.children = items1;
  obj.children = closure_9(subLabel(5024).Stack, obj11);
