...
// Dependencies: [19, 17, 5587, 1962, 4289, 1958, 1980, 2012, 1372, 1074, 21, 4639, 576, 4338, 8714, 10225, 10227, 5353, 11, 1612, 1177, 5772, 5690, 15683, 5697, 2]
// Exports: default

// Module 15828 (DevToolsInAppNotificationTestingScreen)
...
export default function DevToolsInAppNotificationTestingScreen() {
  ...
  items1 = [
    ...
    closure_25.map((title) => {
      ...
      obj2.children = options.map((label) => {
        closure_0 = label;
        return closure_1_14(closure_1_0(5690).TableRow, {
          label: label.label,
          subLabel: label.subLabel,
          icon: closure_1_14(closure_1_0(15683).BeakerIcon, {}),
          onPress() {
            return closure_2_0(closure_0);
          },
          trailing: closure_1_14(closure_1_0(5697).TableRowArrow, {})
        }, label.label);
      });
  ...
  items1[2] = closure_14(require("TableRowGroup").TableRowGroup, {
    ...
    hasIcons: true,
    children: items3.map((label) => closure_1_14(label(5690).TableRow, {
      label: label.label,
      subLabel: label.subLabel,
      icon: closure_1_14(label(15683).BeakerIcon, {}),
      onPress() {
        return label(label);
      },
      trailing: closure_1_14(label(5697).TableRowArrow, {})
    }, label.label))
  });
  obj.children = items1;
