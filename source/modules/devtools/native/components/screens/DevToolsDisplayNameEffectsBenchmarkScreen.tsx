...
// Dependencies: [32, 19, 17, 1372, 1390, 21, 1391, 11153, 1115, 11149, 2870, 4722, 576, 5142, 4718, 5144, 11146, 11147, 504, 15960, 5857, 5775, 9667, 4958, 2]
// Exports: default

// Module 15959 (DevToolsDisplayNameEffectsBenchmarkScreen)
...
export default function DevToolsDisplayNameEffectsBenchmarkScreen() {
  ...
  const items3 = [memo];
  const memo1 = first1.useMemo(() => _mod11153.splitGraphemes(memo).length, items3);
  const items4 = [first];
  ...
  if (null != run) {
    ...
    if (null != stateFromStores) {
      ...
      obj16.children = Array.from(obj17, (arg0, arg1) => {
        ...
        const splitGraphemesResult = _mod11153.splitGraphemes(run.params.name);
