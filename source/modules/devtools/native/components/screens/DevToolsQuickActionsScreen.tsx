...
// Dependencies: [32, 5, 19, 17, 4597, 5327, 1372, 2025, 1183, 1185, 1371, 7770, 1074, 12775, 1373, 11435, 1186, 21, 4605, 576, 12816, 573, 12774, 9428, 14514, 1940, 1943, 4425, 4808, 15746, 1896, 11474, 14859, 14861, 13773, 4303, 15644, 1611, 504, 1935, 15762, 5737, 7252, 15656, 1178, 15348, 4456, 15408, 15763, 10320, 1114, 5655, 15502, 5662, 7008, 15764, 7018, 1232, 1351, 1115, 2]
// Exports: default

// Module 15745 (DevToolsQuickActionsScreen)
...
import requestReviewModalDefault from "requestReviewModal" /* 13773 */;
...
import OverridePremiumTypeActions from "OverridePremiumTypeActions" /* 15763 */;
...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11474, dependencyMap.paths), {
    onClose() {
...
function launchTotpSetupSuccess() {
  ...
  const items = [asyncRequireImpl(14859, dependencyMap.paths), asyncRequireImpl(14861, dependencyMap.paths)];
...
function launchMFA() {
  ModalActionCreatorsDefault.pop();
  asyncRequireImpl(15746, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    return closure_21(tmp5(15762).default, {});
  } else {
    ...
    obj7.children = closure_21(tmp5(7252).TableSwitchRow, obj8);
    const items5 = [closure_21(tmp5(5737).TableRowGroup, obj7), , , , , , , , , ];
    const obj9 = { size: tmp2(576).space.PX_16 };
    items5[1] = closure_21(tmp5(1178).Spacer, obj9);
    let str = "Light Theme";
    if (usingSystemTheme) {
      str = "(using system theme)";
    }
    const obj10 = { title: "Appearance", hasIcons: true, children: null };
    const obj11 = { label: str, disabled: usingSystemTheme, icon: tmp14(tmp5(15348).ThemeLightIcon, {}), value: tmp5(4456).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [tmp14(tmp5(7252).TableSwitchRow, obj11), ];
    const obj12 = { label: "Reduced Motion", icon: tmp14(tmp5(15408).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    items6[1] = tmp14(tmp5(7252).TableSwitchRow, obj12);
    obj10.children = items6;
    items5[2] = closure_22(tmp5(5737).TableRowGroup, obj10);
    const obj13 = { size: tmp2(576).space.PX_16 };
    items5[3] = tmp14(tmp5(1178).Spacer, obj13);
    const obj14 = {
    ...
    const obj17 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp11, icon: tmp14(tmp5(15502).LanguageIcon, {}), trailing: tmp14(tmp5(5662).TableRowArrow, {}) };
    const items7 = [tmp14(tmp5(5655).TableRow, obj17), , , , , , , , , ];
    const obj18 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: tmp14(tmp5(7008).KeyIcon, {}), trailing: tmp14(tmp5(5662).TableRowArrow, {}) };
    items7[1] = tmp14(tmp5(5655).TableRow, obj18);
    ...
    obj19.icon = tmp14(tmp5(15644).WrenchIcon, {});
    obj19.trailing = tmp14(tmp5(5662).TableRowArrow, {});
    items7[2] = tmp14(tmp5(5655).TableRow, obj19);
    const obj20 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: tmp14(tmp5(7008).KeyIcon, {}), trailing: tmp14(tmp5(5662).TableRowArrow, {}) };
    items7[3] = tmp14(tmp5(5655).TableRow, obj20);
    const obj21 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: tmp14(tmp5(7008).KeyIcon, {}), trailing: tmp14(tmp5(5662).TableRowArrow, {}) };
    items7[4] = tmp14(tmp5(5655).TableRow, obj21);
    const obj22 = { label: "Reset Launch Welcome", subLabel: "Resets launch welcome NUX flag, requires an app restart to take effect.", onPress: handleLaunchWelcomeReset, icon: tmp14(tmp5(7008).KeyIcon, {}), trailing: tmp14(tmp5(5662).TableRowArrow, {}) };
    items7[5] = tmp14(tmp5(5655).TableRow, obj22);
    const obj23 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: tmp14(tmp5(7008).KeyIcon, {}), trailing: tmp14(tmp5(5662).TableRowArrow, {}) };
    items7[6] = tmp14(tmp5(5655).TableRow, obj23);
    const obj24 = { label: "Test captcha", onPress: tmp5(15764).showCaptchaTestModal, icon: tmp14(tmp5(7008).KeyIcon, {}), trailing: tmp14(tmp5(5662).TableRowArrow, {}) };
    items7[7] = tmp14(tmp5(5655).TableRow, obj24);
    const obj25 = {
      label: "Ignored Profile Speedbump Suppression",
      subLabel: "Suppresses the speedbump for ignored profiles.",
      icon: tmp14(tmp5(7018).EyeSlashIcon, {}),
      value: setting,
      onValueChange() {
    ...
    const items8 = [tmp14(tmp5(5655).TableRow, obj29), , , , , ];
    const obj30 = {
      icon: tmp14(tmp5(15644).WrenchIcon, {}),
    ...
    items8[1] = tmp14(tmp5(5655).TableRow, obj30);
    const obj31 = {
      icon: tmp14(tmp5(15644).WrenchIcon, {}),
    ...
    items8[2] = tmp14(tmp5(5655).TableRow, obj31);
    const obj32 = {
      icon: tmp14(tmp5(15644).WrenchIcon, {}),
    ...
    items8[3] = tmp14(tmp5(5655).TableRow, obj32);
    const obj33 = {
      icon: tmp14(tmp5(15644).WrenchIcon, {}),
    ...
    items8[4] = tmp14(tmp5(5655).TableRow, obj33);
    const obj34 = {
      icon: tmp14(tmp5(15644).WrenchIcon, {}),
    ...
    items8[5] = tmp14(tmp5(5655).TableRow, obj34);
    obj28.children = items8;
    items5[8] = closure_22(tmp5(5737).TableRowGroup, obj28);
    const tmp13 = ScrollView;
    const tmp5Result = tmp5(4456);
    let isIOSResult = tmp5(1115).isIOS();
    if (isIOSResult) {
      const obj35 = { children: null };
      const obj36 = { size: tmp2(576).space.PX_16 };
      const items9 = [tmp14(tmp5(1178).Spacer, obj36), ];
      ...
      obj37.children = tmp14(tmp5(5655).TableRow, obj38);
      items9[1] = tmp14(tmp5(5737).TableRowGroup, obj37);
