...
// Dependencies: [32, 5, 19, 17, 4628, 5358, 1372, 2025, 1183, 1185, 1371, 7821, 1074, 12834, 1373, 11496, 1186, 21, 4636, 576, 12875, 573, 12833, 9488, 14525, 1940, 1943, 4457, 4839, 15753, 1896, 11535, 14869, 14871, 13786, 4335, 15649, 1611, 504, 1935, 15769, 5768, 7303, 15661, 1178, 15352, 4488, 15412, 15770, 10378, 1114, 5686, 15506, 5693, 7059, 15771, 7069, 1232, 1351, 1150, 2]
// Exports: default

// Module 15752 (DevToolsQuickActionsScreen)
...
import OverridePremiumTypeActions from "OverridePremiumTypeActions" /* 15770 */;
...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11535, dependencyMap.paths), {
    onClose() {
...
function launchTotpSetupSuccess() {
  ...
  const items = [asyncRequireImpl(14869, dependencyMap.paths), asyncRequireImpl(14871, dependencyMap.paths)];
...
function launchMFA() {
  ModalActionCreatorsDefault.pop();
  asyncRequireImpl(15753, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    return closure_21(tmp5(15769).default, {});
  } else {
    ...
    const obj11 = { label: str, disabled: usingSystemTheme, icon: tmp14(tmp5(15352).ThemeLightIcon, {}), value: tmp5(4488).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [tmp14(tmp5(7303).TableSwitchRow, obj11), ];
    const obj12 = { label: "Reduced Motion", icon: tmp14(tmp5(15412).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    ...
    const obj14 = {
      ...
      children: closure_17.map((item) => {
          ...
          return closure_1_21(locale(7303).TableSwitchRow, {
            ...
            label,
            icon: closure_1_21(locale(10378).PencilIcon, {}),
    ...
    const obj17 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp11, icon: tmp14(tmp5(15506).LanguageIcon, {}), trailing: tmp14(tmp5(5693).TableRowArrow, {}) };
    ...
    obj19.icon = tmp14(tmp5(15649).WrenchIcon, {});
    ...
    const obj24 = { label: "Test captcha", onPress: tmp5(15771).showCaptchaTestModal, icon: tmp14(tmp5(7059).KeyIcon, {}), trailing: tmp14(tmp5(5693).TableRowArrow, {}) };
    ...
    let isIOSResult = tmp5(1150).isIOS();
    if (isIOSResult) {
