...
// Dependencies: [32, 5, 19, 17, 4599, 5329, 1372, 2025, 1183, 1185, 1371, 7792, 1074, 12800, 1373, 11459, 1186, 21, 4607, 576, 12841, 573, 12799, 9451, 14492, 1940, 1943, 4427, 4810, 15731, 1896, 11498, 14836, 14838, 13754, 4305, 15627, 1611, 504, 1935, 15747, 5739, 7274, 15639, 1178, 15330, 4458, 15390, 15748, 10341, 1114, 5657, 15484, 5664, 7030, 15749, 7040, 1232, 1351, 1115, 2]
// Exports: default
...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11498, dependencyMap.paths), {
    onClose() {
...
function launchTotpSetupSuccess() {
  ...
  const items = [asyncRequireImpl(14836, dependencyMap.paths), asyncRequireImpl(14838, dependencyMap.paths)];
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    ...
    obj7.children = closure_21(tmp5(7274).TableSwitchRow, obj8);
    const items5 = [closure_21(tmp5(5739).TableRowGroup, obj7), , , , , , , , , ];
    ...
    const items6 = [tmp14(tmp5(7274).TableSwitchRow, obj11), ];
    ...
    items6[1] = tmp14(tmp5(7274).TableSwitchRow, obj12);
    obj10.children = items6;
    items5[2] = closure_22(tmp5(5739).TableRowGroup, obj10);
    ...
    const obj17 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp11, icon: tmp14(tmp5(15484).LanguageIcon, {}), trailing: tmp14(tmp5(5664).TableRowArrow, {}) };
    const items7 = [tmp14(tmp5(5657).TableRow, obj17), , , , , , , , , ];
    const obj18 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: tmp14(tmp5(7030).KeyIcon, {}), trailing: tmp14(tmp5(5664).TableRowArrow, {}) };
    items7[1] = tmp14(tmp5(5657).TableRow, obj18);
    ...
    obj19.trailing = tmp14(tmp5(5664).TableRowArrow, {});
    items7[2] = tmp14(tmp5(5657).TableRow, obj19);
    const obj20 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: tmp14(tmp5(7030).KeyIcon, {}), trailing: tmp14(tmp5(5664).TableRowArrow, {}) };
    items7[3] = tmp14(tmp5(5657).TableRow, obj20);
    const obj21 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: tmp14(tmp5(7030).KeyIcon, {}), trailing: tmp14(tmp5(5664).TableRowArrow, {}) };
    items7[4] = tmp14(tmp5(5657).TableRow, obj21);
    const obj22 = { label: "Reset Launch Welcome", subLabel: "Resets launch welcome NUX flag, requires an app restart to take effect.", onPress: handleLaunchWelcomeReset, icon: tmp14(tmp5(7030).KeyIcon, {}), trailing: tmp14(tmp5(5664).TableRowArrow, {}) };
    items7[5] = tmp14(tmp5(5657).TableRow, obj22);
    const obj23 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: tmp14(tmp5(7030).KeyIcon, {}), trailing: tmp14(tmp5(5664).TableRowArrow, {}) };
    items7[6] = tmp14(tmp5(5657).TableRow, obj23);
    const obj24 = { label: "Test captcha", onPress: tmp5(15749).showCaptchaTestModal, icon: tmp14(tmp5(7030).KeyIcon, {}), trailing: tmp14(tmp5(5664).TableRowArrow, {}) };
    items7[7] = tmp14(tmp5(5657).TableRow, obj24);
    const obj25 = {
      label: "Ignored Profile Speedbump Suppression",
      subLabel: "Suppresses the speedbump for ignored profiles.",
      icon: tmp14(tmp5(7040).EyeSlashIcon, {}),
      value: setting,
      onValueChange() {
    ...
    items7[8] = tmp14(tmp5(7274).TableSwitchRow, obj25);
    ...
    items7[9] = tmp14(tmp5(5657).TableRow, obj26);
    obj16.children = items7;
    items5[6] = closure_22(tmp5(5739).TableRowGroup, obj16);
    ...
    const items8 = [tmp14(tmp5(5657).TableRow, obj29), , , , , ];
    const obj30 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[1] = tmp14(tmp5(5657).TableRow, obj30);
    const obj31 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[2] = tmp14(tmp5(5657).TableRow, obj31);
    const obj32 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[3] = tmp14(tmp5(5657).TableRow, obj32);
    const obj33 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[4] = tmp14(tmp5(5657).TableRow, obj33);
    const obj34 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[5] = tmp14(tmp5(5657).TableRow, obj34);
    obj28.children = items8;
    items5[8] = closure_22(tmp5(5739).TableRowGroup, obj28);
    ...
    if (isIOSResult) {
      ...
      obj37.children = tmp14(tmp5(5657).TableRow, obj38);
      items9[1] = tmp14(tmp5(5739).TableRowGroup, obj37);
