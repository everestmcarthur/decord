...
// Dependencies: [32, 5, 19, 17, 4631, 5362, 1373, 2026, 1182, 1184, 1372, 7824, 1074, 12840, 1374, 11501, 1185, 21, 4639, 576, 12881, 573, 12839, 9490, 14535, 1941, 1944, 4460, 4842, 15766, 1897, 11540, 14880, 14882, 13792, 4338, 15660, 1612, 504, 1936, 15782, 5772, 7307, 15674, 1177, 15363, 4491, 15423, 15783, 10381, 1115, 5690, 15517, 5697, 7063, 15784, 7073, 1231, 1350, 1364, 2]
// Exports: default

// Module 15765 (DevToolsQuickActionsScreen)
...
import nuf_NUFActionCreators from "nuf/NUFActionCreators" /* 12881 */;
import requestReviewModalDefault from "requestReviewModal" /* 13792 */;
...
import OverridePremiumTypeActions from "OverridePremiumTypeActions" /* 15783 */;
...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11540, dependencyMap.paths), {
    onClose() {
...
function launchTotpSetupSuccess() {
  ...
  const items = [asyncRequireImpl(14880, dependencyMap.paths), asyncRequireImpl(14882, dependencyMap.paths)];
...
const NewUserTypes = fn(12840).NewUserTypes;
...
function launchMFA() {
  ModalActionCreatorsDefault.pop();
  asyncRequireImpl(15766, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    return closure_21(tmp5(15782).default, {});
  } else {
    ...
    obj7.children = closure_21(tmp5(7307).TableSwitchRow, obj8);
    const items5 = [closure_21(tmp5(5772).TableRowGroup, obj7), , , , , , , , , ];
    ...
    const obj11 = { label: str, disabled: usingSystemTheme, icon: tmp14(tmp5(15363).ThemeLightIcon, {}), value: tmp5(4491).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [tmp14(tmp5(7307).TableSwitchRow, obj11), ];
    const obj12 = { label: "Reduced Motion", icon: tmp14(tmp5(15423).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    items6[1] = tmp14(tmp5(7307).TableSwitchRow, obj12);
    obj10.children = items6;
    items5[2] = closure_22(tmp5(5772).TableRowGroup, obj10);
    ...
    const obj17 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp11, icon: tmp14(tmp5(15517).LanguageIcon, {}), trailing: tmp14(tmp5(5697).TableRowArrow, {}) };
    const items7 = [tmp14(tmp5(5690).TableRow, obj17), , , , , , , , , ];
    const obj18 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: tmp14(tmp5(7063).KeyIcon, {}), trailing: tmp14(tmp5(5697).TableRowArrow, {}) };
    items7[1] = tmp14(tmp5(5690).TableRow, obj18);
    ...
    obj19.icon = tmp14(tmp5(15660).WrenchIcon, {});
    obj19.trailing = tmp14(tmp5(5697).TableRowArrow, {});
    items7[2] = tmp14(tmp5(5690).TableRow, obj19);
    const obj20 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: tmp14(tmp5(7063).KeyIcon, {}), trailing: tmp14(tmp5(5697).TableRowArrow, {}) };
    items7[3] = tmp14(tmp5(5690).TableRow, obj20);
    const obj21 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: tmp14(tmp5(7063).KeyIcon, {}), trailing: tmp14(tmp5(5697).TableRowArrow, {}) };
    items7[4] = tmp14(tmp5(5690).TableRow, obj21);
    const obj22 = { label: "Reset Launch Welcome", subLabel: "Resets launch welcome NUX flag, requires an app restart to take effect.", onPress: handleLaunchWelcomeReset, icon: tmp14(tmp5(7063).KeyIcon, {}), trailing: tmp14(tmp5(5697).TableRowArrow, {}) };
    items7[5] = tmp14(tmp5(5690).TableRow, obj22);
    const obj23 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: tmp14(tmp5(7063).KeyIcon, {}), trailing: tmp14(tmp5(5697).TableRowArrow, {}) };
    items7[6] = tmp14(tmp5(5690).TableRow, obj23);
    const obj24 = { label: "Test captcha", onPress: tmp5(15784).showCaptchaTestModal, icon: tmp14(tmp5(7063).KeyIcon, {}), trailing: tmp14(tmp5(5697).TableRowArrow, {}) };
    items7[7] = tmp14(tmp5(5690).TableRow, obj24);
    const obj25 = {
      label: "Ignored Profile Speedbump Suppression",
      subLabel: "Suppresses the speedbump for ignored profiles.",
      icon: tmp14(tmp5(7073).EyeSlashIcon, {}),
      value: setting,
      onValueChange() {
    ...
    const items8 = [tmp14(tmp5(5690).TableRow, obj29), , , , , ];
    const obj30 = {
      icon: tmp14(tmp5(15660).WrenchIcon, {}),
    ...
    items8[1] = tmp14(tmp5(5690).TableRow, obj30);
    const obj31 = {
      icon: tmp14(tmp5(15660).WrenchIcon, {}),
    ...
    items8[2] = tmp14(tmp5(5690).TableRow, obj31);
    const obj32 = {
      icon: tmp14(tmp5(15660).WrenchIcon, {}),
    ...
    items8[3] = tmp14(tmp5(5690).TableRow, obj32);
    const obj33 = {
      icon: tmp14(tmp5(15660).WrenchIcon, {}),
    ...
    items8[4] = tmp14(tmp5(5690).TableRow, obj33);
    const obj34 = {
      icon: tmp14(tmp5(15660).WrenchIcon, {}),
    ...
    items8[5] = tmp14(tmp5(5690).TableRow, obj34);
    obj28.children = items8;
    items5[8] = closure_22(tmp5(5772).TableRowGroup, obj28);
    const tmp13 = ScrollView;
    const tmp5Result = tmp5(4491);
    let isIOSResult = tmp5(1364).isIOS();
    if (isIOSResult) {
      const obj35 = { children: null };
      const obj36 = { size: tmp2(576).space.PX_16 };
      const items9 = [tmp14(tmp5(1177).Spacer, obj36), ];
      ...
      obj37.children = tmp14(tmp5(5690).TableRow, obj38);
      items9[1] = tmp14(tmp5(5772).TableRowGroup, obj37);
