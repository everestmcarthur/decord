...
// Dependencies: [32, 5, 19, 17, 4598, 5328, 1372, 2025, 1183, 1185, 1371, 7791, 1074, 12798, 1373, 11457, 1186, 21, 4606, 576, 12839, 573, 12797, 9449, 14490, 1940, 1943, 4427, 4809, 15731, 1896, 11496, 14835, 14837, 13752, 4305, 15627, 1611, 504, 1935, 15747, 5738, 7273, 15639, 1178, 15330, 4458, 15390, 15748, 10339, 1114, 5656, 15484, 5663, 7029, 15749, 7039, 1232, 1351, 1115, 2]
// Exports: default

// Module 15730 (DevToolsQuickActionsScreen)
...
import OverridePremiumTypeActions from "OverridePremiumTypeActions" /* 15748 */;
...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11496, dependencyMap.paths), {
    onClose() {
...
function launchTotpSetupSuccess() {
  ...
  const items = [asyncRequireImpl(14835, dependencyMap.paths), asyncRequireImpl(14837, dependencyMap.paths)];
...
const VIBING_WUMPUS_MODAL_KEY = fn(11457).VIBING_WUMPUS_MODAL_KEY;
...
function launchMFA() {
  ModalActionCreatorsDefault.pop();
  asyncRequireImpl(15731, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    return closure_21(tmp5(15747).default, {});
  } else {
    ...
    obj7.children = closure_21(tmp5(7273).TableSwitchRow, obj8);
    const items5 = [closure_21(tmp5(5738).TableRowGroup, obj7), , , , , , , , , ];
    ...
    const obj11 = { label: str, disabled: usingSystemTheme, icon: tmp14(tmp5(15330).ThemeLightIcon, {}), value: tmp5(4458).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [tmp14(tmp5(7273).TableSwitchRow, obj11), ];
    const obj12 = { label: "Reduced Motion", icon: tmp14(tmp5(15390).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    items6[1] = tmp14(tmp5(7273).TableSwitchRow, obj12);
    obj10.children = items6;
    items5[2] = closure_22(tmp5(5738).TableRowGroup, obj10);
    ...
    const obj17 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp11, icon: tmp14(tmp5(15484).LanguageIcon, {}), trailing: tmp14(tmp5(5663).TableRowArrow, {}) };
    const items7 = [tmp14(tmp5(5656).TableRow, obj17), , , , , , , , , ];
    const obj18 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: tmp14(tmp5(7029).KeyIcon, {}), trailing: tmp14(tmp5(5663).TableRowArrow, {}) };
    items7[1] = tmp14(tmp5(5656).TableRow, obj18);
    ...
    obj19.icon = tmp14(tmp5(15627).WrenchIcon, {});
    obj19.trailing = tmp14(tmp5(5663).TableRowArrow, {});
    items7[2] = tmp14(tmp5(5656).TableRow, obj19);
    const obj20 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: tmp14(tmp5(7029).KeyIcon, {}), trailing: tmp14(tmp5(5663).TableRowArrow, {}) };
    items7[3] = tmp14(tmp5(5656).TableRow, obj20);
    const obj21 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: tmp14(tmp5(7029).KeyIcon, {}), trailing: tmp14(tmp5(5663).TableRowArrow, {}) };
    items7[4] = tmp14(tmp5(5656).TableRow, obj21);
    const obj22 = { label: "Reset Launch Welcome", subLabel: "Resets launch welcome NUX flag, requires an app restart to take effect.", onPress: handleLaunchWelcomeReset, icon: tmp14(tmp5(7029).KeyIcon, {}), trailing: tmp14(tmp5(5663).TableRowArrow, {}) };
    items7[5] = tmp14(tmp5(5656).TableRow, obj22);
    const obj23 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: tmp14(tmp5(7029).KeyIcon, {}), trailing: tmp14(tmp5(5663).TableRowArrow, {}) };
    items7[6] = tmp14(tmp5(5656).TableRow, obj23);
    const obj24 = { label: "Test captcha", onPress: tmp5(15749).showCaptchaTestModal, icon: tmp14(tmp5(7029).KeyIcon, {}), trailing: tmp14(tmp5(5663).TableRowArrow, {}) };
    items7[7] = tmp14(tmp5(5656).TableRow, obj24);
    const obj25 = {
      label: "Ignored Profile Speedbump Suppression",
      subLabel: "Suppresses the speedbump for ignored profiles.",
      icon: tmp14(tmp5(7039).EyeSlashIcon, {}),
      value: setting,
      onValueChange() {
    ...
    const items8 = [tmp14(tmp5(5656).TableRow, obj29), , , , , ];
    const obj30 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[1] = tmp14(tmp5(5656).TableRow, obj30);
    const obj31 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[2] = tmp14(tmp5(5656).TableRow, obj31);
    const obj32 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[3] = tmp14(tmp5(5656).TableRow, obj32);
    const obj33 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[4] = tmp14(tmp5(5656).TableRow, obj33);
    const obj34 = {
      icon: tmp14(tmp5(15627).WrenchIcon, {}),
    ...
    items8[5] = tmp14(tmp5(5656).TableRow, obj34);
    obj28.children = items8;
    items5[8] = closure_22(tmp5(5738).TableRowGroup, obj28);
    const tmp13 = ScrollView;
    const tmp5Result = tmp5(4458);
    ...
    if (isIOSResult) {
      ...
      obj37.children = tmp14(tmp5(5656).TableRow, obj38);
      items9[1] = tmp14(tmp5(5738).TableRowGroup, obj37);
