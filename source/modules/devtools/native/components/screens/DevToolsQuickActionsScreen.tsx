...
// Dependencies: [32, 5, 19, 17, 4714, 5447, 1373, 2026, 1182, 1184, 1372, 7915, 1074, 12947, 1374, 11615, 1185, 21, 4722, 576, 12988, 573, 12946, 9596, 14656, 4925, 15885, 1897, 11654, 1941, 1944, 14998, 15000, 13901, 4420, 15778, 15901, 1612, 504, 1936, 15902, 5857, 7396, 15793, 1177, 15478, 4573, 15538, 15903, 10491, 1115, 5775, 15633, 5782, 7152, 15904, 15914, 7162, 1231, 1350, 1364, 2]
// Exports: default

// Module 15884 (DevToolsQuickActionsScreen)
...
import requestReviewModalDefault from "requestReviewModal" /* 13901 */;
...
import OverridePremiumTypeActions from "OverridePremiumTypeActions" /* 15903 */;
...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11654, dependencyMap.paths), {
    onClose() {
...
function launchTotpSetupSuccess() {
  ...
  const items = [asyncRequireImpl(14998, dependencyMap.paths), asyncRequireImpl(15000, dependencyMap.paths)];
...
const VIBING_WUMPUS_MODAL_KEY = fn(11615).VIBING_WUMPUS_MODAL_KEY;
...
function launchMFA() {
  ModalActionCreatorsDefault.pop();
  asyncRequireImpl(15885, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  const tmp2 = locale;
  let isCheckpointEnabled = locale(15901).useIsCheckpointEnabled("DevToolsQuickActionsScreen");
  let obj = locale(15901);
  ...
  if (tmp9) {
    return closure_21(tmp2(15902).default, {});
  } else {
    ...
    obj8.children = closure_21(tmp2(7396).TableSwitchRow, obj9);
    const items5 = [closure_21(tmp2(5857).TableRowGroup, obj8), , , , , , , , , ];
    ...
    const obj12 = { label: str, disabled: usingSystemTheme, icon: tmp15(tmp2(15478).ThemeLightIcon, {}), value: tmp2(4573).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [tmp15(tmp2(7396).TableSwitchRow, obj12), ];
    const obj13 = { label: "Reduced Motion", icon: tmp15(tmp2(15538).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    items6[1] = tmp15(tmp2(7396).TableSwitchRow, obj13);
    obj11.children = items6;
    items5[2] = closure_22(tmp2(5857).TableRowGroup, obj11);
    ...
    const obj18 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp12, icon: tmp15(tmp2(15633).LanguageIcon, {}), trailing: tmp15(tmp2(5782).TableRowArrow, {}) };
    const items7 = [tmp15(tmp2(5775).TableRow, obj18), , , , , , , , , ];
    const obj19 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: tmp15(tmp2(7152).KeyIcon, {}), trailing: tmp15(tmp2(5782).TableRowArrow, {}) };
    items7[1] = tmp15(tmp2(5775).TableRow, obj19);
    ...
    obj20.icon = tmp15(tmp2(15778).WrenchIcon, {});
    obj20.trailing = tmp15(tmp2(5782).TableRowArrow, {});
    items7[2] = tmp15(tmp2(5775).TableRow, obj20);
    const obj21 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: tmp15(tmp2(7152).KeyIcon, {}), trailing: tmp15(tmp2(5782).TableRowArrow, {}) };
    items7[3] = tmp15(tmp2(5775).TableRow, obj21);
    const obj22 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: tmp15(tmp2(7152).KeyIcon, {}), trailing: tmp15(tmp2(5782).TableRowArrow, {}) };
    items7[4] = tmp15(tmp2(5775).TableRow, obj22);
    const obj23 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: tmp15(tmp2(7152).KeyIcon, {}), trailing: tmp15(tmp2(5782).TableRowArrow, {}) };
    items7[5] = tmp15(tmp2(5775).TableRow, obj23);
    if (isCheckpointEnabled) {
      const obj24 = {
        label: "Launch Checkpoint",
        subLabel: "Look back at your year on Discord",
        onPress() {
              return showDevWidget(15904)("devtools");
            },
        icon: tmp15(tmp2(7152).KeyIcon, {}),
        trailing: tmp15(tmp2(5782).TableRowArrow, {})
      };
      isCheckpointEnabled = tmp15(tmp2(5775).TableRow, obj24);
    }
    items7[6] = isCheckpointEnabled;
    const obj25 = { label: "Test captcha", onPress: tmp2(15914).showCaptchaTestModal, icon: tmp15(tmp2(7152).KeyIcon, {}), trailing: tmp15(tmp2(5782).TableRowArrow, {}) };
    items7[7] = tmp15(tmp2(5775).TableRow, obj25);
    const obj26 = {
      label: "Ignored Profile Speedbump Suppression",
      subLabel: "Suppresses the speedbump for ignored profiles.",
      icon: tmp15(tmp2(7162).EyeSlashIcon, {}),
      value: setting,
      onValueChange() {
    ...
    const items8 = [tmp15(tmp2(5775).TableRow, obj30), , , , , ];
    const obj31 = {
      icon: tmp15(tmp2(15778).WrenchIcon, {}),
    ...
    items8[1] = tmp15(tmp2(5775).TableRow, obj31);
    const obj32 = {
      icon: tmp15(tmp2(15778).WrenchIcon, {}),
    ...
    items8[2] = tmp15(tmp2(5775).TableRow, obj32);
    const obj33 = {
      icon: tmp15(tmp2(15778).WrenchIcon, {}),
    ...
    items8[3] = tmp15(tmp2(5775).TableRow, obj33);
    const obj34 = {
      icon: tmp15(tmp2(15778).WrenchIcon, {}),
    ...
    items8[4] = tmp15(tmp2(5775).TableRow, obj34);
    const obj35 = {
      icon: tmp15(tmp2(15778).WrenchIcon, {}),
    ...
    items8[5] = tmp15(tmp2(5775).TableRow, obj35);
    obj29.children = items8;
    items5[8] = closure_22(tmp2(5857).TableRowGroup, obj29);
    ...
    if (isIOSResult) {
      ...
      obj38.children = tmp15(tmp2(5775).TableRow, obj39);
      items9[1] = tmp15(tmp2(5857).TableRowGroup, obj38);
