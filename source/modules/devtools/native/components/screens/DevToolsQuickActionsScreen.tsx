...
// Dependencies: [32, 5, 19, 17, 4632, 5365, 1373, 2026, 1182, 1184, 1372, 7833, 1074, 12856, 1374, 11517, 1185, 21, 4640, 576, 12897, 573, 12855, 9512, 14561, 4843, 15790, 1897, 11556, 1941, 1944, 14904, 14906, 13809, 4338, 15683, 15806, 1612, 504, 1936, 15807, 5775, 7314, 15698, 1177, 15384, 4491, 15444, 15808, 10397, 1115, 5693, 15538, 5700, 7070, 15809, 15819, 7080, 1231, 1350, 1364, 2]
// Exports: default

// Module 15789 (DevToolsQuickActionsScreen)
...
import nuf_NUFActionCreators from "nuf/NUFActionCreators" /* 12897 */;
import requestReviewModalDefault from "requestReviewModal" /* 13809 */;
...
import OverridePremiumTypeActions from "OverridePremiumTypeActions" /* 15808 */;
...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11556, dependencyMap.paths), {
    onClose() {
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp9) {
    return closure_21(tmp2(15807).default, {});
  } else {
    ...
    obj8.children = closure_21(tmp2(7314).TableSwitchRow, obj9);
    const items5 = [closure_21(tmp2(5775).TableRowGroup, obj8), , , , , , , , , ];
    ...
    const obj12 = { label: str, disabled: usingSystemTheme, icon: tmp15(tmp2(15384).ThemeLightIcon, {}), value: tmp2(4491).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [tmp15(tmp2(7314).TableSwitchRow, obj12), ];
    const obj13 = { label: "Reduced Motion", icon: tmp15(tmp2(15444).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    items6[1] = tmp15(tmp2(7314).TableSwitchRow, obj13);
    obj11.children = items6;
    items5[2] = closure_22(tmp2(5775).TableRowGroup, obj11);
    ...
    const obj15 = {
      ...
      children: closure_17.map((item) => {
          ({ label, value } = item);
          locale = value;
          return closure_1_21(locale(7314).TableSwitchRow, {
            onValueChange(arg0) {
    ...
    items5[4] = tmp15(tmp2(5775).TableRowGroup, obj15);
    ...
    const obj18 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp12, icon: tmp15(tmp2(15538).LanguageIcon, {}), trailing: tmp15(tmp2(5700).TableRowArrow, {}) };
    const items7 = [tmp15(tmp2(5693).TableRow, obj18), , , , , , , , , ];
    const obj19 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: tmp15(tmp2(7070).KeyIcon, {}), trailing: tmp15(tmp2(5700).TableRowArrow, {}) };
    items7[1] = tmp15(tmp2(5693).TableRow, obj19);
    ...
    obj20.icon = tmp15(tmp2(15683).WrenchIcon, {});
    obj20.trailing = tmp15(tmp2(5700).TableRowArrow, {});
    items7[2] = tmp15(tmp2(5693).TableRow, obj20);
    const obj21 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: tmp15(tmp2(7070).KeyIcon, {}), trailing: tmp15(tmp2(5700).TableRowArrow, {}) };
    items7[3] = tmp15(tmp2(5693).TableRow, obj21);
    const obj22 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: tmp15(tmp2(7070).KeyIcon, {}), trailing: tmp15(tmp2(5700).TableRowArrow, {}) };
    items7[4] = tmp15(tmp2(5693).TableRow, obj22);
    const obj23 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: tmp15(tmp2(7070).KeyIcon, {}), trailing: tmp15(tmp2(5700).TableRowArrow, {}) };
    items7[5] = tmp15(tmp2(5693).TableRow, obj23);
    if (isCheckpointEnabled) {
      const obj24 = {
        ...
        icon: tmp15(tmp2(7070).KeyIcon, {}),
        trailing: tmp15(tmp2(5700).TableRowArrow, {})
      };
      isCheckpointEnabled = tmp15(tmp2(5693).TableRow, obj24);
    }
    items7[6] = isCheckpointEnabled;
    const obj25 = { label: "Test captcha", onPress: tmp2(15819).showCaptchaTestModal, icon: tmp15(tmp2(7070).KeyIcon, {}), trailing: tmp15(tmp2(5700).TableRowArrow, {}) };
    items7[7] = tmp15(tmp2(5693).TableRow, obj25);
    const obj26 = {
      label: "Ignored Profile Speedbump Suppression",
      subLabel: "Suppresses the speedbump for ignored profiles.",
      icon: tmp15(tmp2(7080).EyeSlashIcon, {}),
      value: setting,
      onValueChange() {
    ...
    const items8 = [tmp15(tmp2(5693).TableRow, obj30), , , , , ];
    const obj31 = {
      icon: tmp15(tmp2(15683).WrenchIcon, {}),
    ...
    items8[1] = tmp15(tmp2(5693).TableRow, obj31);
    const obj32 = {
      icon: tmp15(tmp2(15683).WrenchIcon, {}),
    ...
    items8[2] = tmp15(tmp2(5693).TableRow, obj32);
    const obj33 = {
      icon: tmp15(tmp2(15683).WrenchIcon, {}),
    ...
    items8[3] = tmp15(tmp2(5693).TableRow, obj33);
    const obj34 = {
      icon: tmp15(tmp2(15683).WrenchIcon, {}),
    ...
    items8[4] = tmp15(tmp2(5693).TableRow, obj34);
    const obj35 = {
      icon: tmp15(tmp2(15683).WrenchIcon, {}),
    ...
    items8[5] = tmp15(tmp2(5693).TableRow, obj35);
    obj29.children = items8;
    items5[8] = closure_22(tmp2(5775).TableRowGroup, obj29);
    ...
    if (isIOSResult) {
      ...
      obj38.children = tmp15(tmp2(5693).TableRow, obj39);
      items9[1] = tmp15(tmp2(5775).TableRowGroup, obj38);
