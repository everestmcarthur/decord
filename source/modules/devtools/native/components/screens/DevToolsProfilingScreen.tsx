...
// Dependencies: [32, 19, 17, 1074, 21, 4606, 576, 10283, 5024, 5738, 5656, 4602, 15726, 2]
// Exports: default
...
import ComponentProfiler from "ComponentProfiler" /* 10283 */;
...
export default function DevToolsProfilingScreen() {
  ...
  if (tmp7) {
    ...
    obj4.children = tmp8(tmp4(5656).TableRow, obj5);
    let items = [tmp8(tmp4(5738).TableRowGroup, obj4), ];
    ...
    const items1 = ["Make sure you wrap your component in ", tmp8(tmp4(4602).Text, obj9), " to enable measurements."];
    obj8.children = items1;
    obj7.subLabel = tmp10(tmp4(4602).Text, obj8);
    obj6.children = tmp8(tmp4(5656).TableRow, obj7);
    tmp8Result = tmp8(tmp4(5738).TableRowGroup, obj6);
  }
