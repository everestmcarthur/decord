...
// Dependencies: [32, 19, 17, 1074, 21, 4607, 576, 10285, 5025, 5739, 5657, 4603, 15726, 2]
// Exports: default

// Module 15725 (DevToolsProfilingScreen)
import nativeDefault from "native" /* 576 */;
import Stack_Stack from "Stack/Stack" /* 5025 */;
import TableRowGroup from "TableRowGroup" /* 5739 */;
import ComponentProfiler from "ComponentProfiler" /* 10285 */;
import DevToolsProfilingUseStateFromStores from "DevToolsProfilingUseStateFromStores" /* 15726 */;
...
export default function DevToolsProfilingScreen() {
  ...
  if (tmp7) {
    ...
    obj4.children = tmp8(tmp4(5657).TableRow, obj5);
    let items = [tmp8(tmp4(5739).TableRowGroup, obj4), ];
    ...
    const items1 = ["Make sure you wrap your component in ", tmp8(tmp4(4603).Text, obj9), " to enable measurements."];
    obj8.children = items1;
    obj7.subLabel = tmp10(tmp4(4603).Text, obj8);
    obj6.children = tmp8(tmp4(5657).TableRow, obj7);
    tmp8Result = tmp8(tmp4(5739).TableRowGroup, obj6);
  }
