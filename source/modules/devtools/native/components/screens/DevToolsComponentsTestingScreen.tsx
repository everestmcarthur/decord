...
// Dependencies: [32, 19, 17, 2012, 21, 4638, 576, 4863, 1895, 8241, 5693, 4634, 15831, 15834, 5060, 5058, 15835, 573, 2]
// Exports: default

// Module 15830 (DevToolsComponentsTestingScreen)
...
import StringSelectActionComponentDefault from "StringSelectActionComponent" /* 15831 */;
import SearchableSelectActionComponentDefault from "SearchableSelectActionComponent" /* 15834 */;
import TextDisplayComponentDefault from "TextDisplayComponent" /* 15835 */;
...
function Select(children) {
  ...
  if (type1 === obj.type) {
    ...
    tmp6(tmp4(4634).Text, state);
  } else {
    items[2] = tmp7(tmp4(4634).Text, { variant: "text-md/normal", children: "Nothing selected" });
    let str3 = "off";
    if (tmp2) {
      str3 = "on";
    }
    ...
    items[3] = tmp7(tmp4(5060).Button, obj6);
    obj3.children = items;
...
const InteractionComponentUtils = fn(4863);
...
items1[1] = { type: fn(1895).ComponentType.TEXT_DISPLAY, content: "hello world! :eyes: **bold** `code` https://cdn.discordapp.com/attachments/1408191424968523819/1408191500277387274/advaith.webp\nhttps://discord.com [google](https://google.com) ||spoiler|| <t:1755730638:t> <a:wumpus_party:393564669765353483>" };
const transformComponentsResult = InteractionComponentUtils.transformComponents(items1);
let c10 = transformComponentsResult;
let obj7 = { type: fn(1895).ComponentType.TEXT_DISPLAY, content: "hello world! :eyes: **bold** `code` https://cdn.discordapp.com/attachments/1408191424968523819/1408191500277387274/advaith.webp\nhttps://discord.com [google](https://google.com) ||spoiler|| <t:1755730638:t> <a:wumpus_party:393564669765353483>" };
