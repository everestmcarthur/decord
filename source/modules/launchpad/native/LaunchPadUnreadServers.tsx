...
// Dependencies: [19, 17, 1958, 4654, 1372, 1074, 21, 4639, 576, 7449, 17125, 504, 1177, 11046, 5672, 13166, 4652, 4650, 7974, 16216, 1478, 17130, 1115, 7179, 2]

// Module 17124 (LaunchPadUnreadServers)
...
import isGuildSelectableDefault from "isGuildSelectable" /* 17130 */;
...
let closure_13 = noop.memo(function GuildItemInner(guildId) {
  ...
  obj.children = closure_10(onGuildSelect(17125), { size: 48, borderRadius: 16, guildId, selected: guildId.selected, onPress: callback, onLongPress: callback1, backgroundColor: tmp.maskStrokeStyle.backgroundColor });
