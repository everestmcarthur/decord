...
// Dependencies: [19, 17, 1957, 4621, 1371, 1074, 21, 4606, 576, 7415, 17058, 504, 1178, 11002, 5638, 13123, 4619, 4617, 7941, 16177, 1477, 17063, 1114, 7145, 2]

// Module 17057 (LaunchPadUnreadServers)
...
import isGuildSelectableDefault from "isGuildSelectable" /* 17063 */;
...
let closure_13 = noop.memo(function GuildItemInner(guildId) {
  ...
  obj.children = closure_10(onGuildSelect(17058), { size: 48, borderRadius: 16, guildId, selected: guildId.selected, onPress: callback, onLongPress: callback1, backgroundColor: tmp.maskStrokeStyle.backgroundColor });
