...
// Dependencies: [32, 19, 17, 11560, 1074, 21, 4607, 576, 12884, 1109, 4464, 17054, 8355, 1242, 17051, 4575, 5024, 5638, 4343, 17055, 5011, 1114, 4982, 17057, 2]
// Exports: default

// Module 17053 (LaunchPadWrapper)
import nativeDefault from "native" /* 576 */;
import ComponentDispatchUtils from "ComponentDispatchUtils" /* 1109 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1242 */;
import LaunchPadPullTabCache from "LaunchPadPullTabCache" /* 17051 */;
  ...
  const effect2 = ref.useEffect(() => {
    if (launchPadType === LaunchPadTypes.PULL_TAB) {
      if (!isModalOpen) {
        ...
        if (closure_3) {
          const result1 = tmp2(4575).triggerHapticFeedback(tmp2(4575).HapticFeedbackTypes.IMPACT_LIGHT);
