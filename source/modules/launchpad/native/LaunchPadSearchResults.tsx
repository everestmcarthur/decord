...
// Dependencies: [19, 17, 2025, 7687, 1979, 4787, 21, 4605, 576, 16755, 7394, 504, 5032, 17076, 5173, 16756, 17077, 5634, 16758, 17078, 9905, 17079, 17084, 17085, 17087, 16188, 4601, 1114, 1477, 16757, 7124, 2]

// Module 17075 (LaunchPadSearchResults)
...
import renderChannelWrapperDefault from "renderChannelWrapper" /* 16756 */;
import getScaledChannelRowHeightDefault from "getScaledChannelRowHeight" /* 16757 */;
import renderChannelContentDefault from "renderChannelContent" /* 16758 */;
import renderChannelPressableWrapperDefault from "renderChannelPressableWrapper" /* 17076 */;
import UnreadBadgeDefault from "UnreadBadge" /* 17077 */;
import shared_renderChannelBadgeDefault from "shared/renderChannelBadge" /* 17078 */;
import shared_TextChannelDefault from "shared/TextChannel" /* 17079 */;
import shared_DMChannelDefault from "shared/DMChannel" /* 17084 */;
import VoiceOrStageChannelDefault from "VoiceOrStageChannel" /* 17085 */;
import LaunchPadSearchResultUserDefault from "LaunchPadSearchResultUser" /* 17087 */;
...
function renderItemJSX(result) {
  ...
  if (null == result) {
    ...
    } else if (tmp13(9905).AutocompleterResultTypes.TEXT_CHANNEL === type) {
    ...
    } else if (tmp13(9905).AutocompleterResultTypes.HEADER === type) {
      const obj8 = { name: result.record.text, styles: tmp };
      return tmp13(16188).renderCategoryItem(obj8);
    } else {
      const obj = { variant: "text-sm/semibold", children: result.type };
      return React7(tmp13(4601).Text, obj);
    }
  }
}
...
let closure_14 = noop.memo((guild) => {
  ...
  const obj = guild(504);
  const fontScale = guild(5032).useFontScale();
  const obj2 = guild(5032);
  ...
  return tmp7(closure_9(guild(5173).PressableHighlight, obj4));
});
