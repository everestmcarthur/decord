...
// Dependencies: [19, 17, 5594, 2026, 1958, 1181, 4822, 21, 4640, 16906, 576, 16504, 7383, 504, 4793, 8007, 15434, 7443, 5069, 17232, 5095, 12210, 10258, 8001, 17234, 9700, 16392, 17228, 5210, 17235, 16905, 17229, 17230, 2]
...
export default noop.memo(function TextChannel(subtitle) {
  ...
  if (null != tmp8ResultResult) {
    ...
    return tmp8Result4(tmp26(tmp2(5210).PressableHighlight, obj6));
  }
