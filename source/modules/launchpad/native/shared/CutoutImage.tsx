...
// Function ID: 17185
// Name: CutoutImage
// Dependencies: [32, 19, 17, 21, 1255, 8586, 13178, 2]

// Module 17184 (CutoutImage)
import v1 from "v1" /* 1255 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;

const getReactNativeSVGImageSourceDefault = tmp13(13178);
require = fn;
  ...
  if (num14 <= 0) {
    ...
    if (null == v4Result) {
      ...
      if (null != imageBackgroundColor) {
        ...
        tmp15Result13 = tmp15(tmp(8586).Rect, size3);
      }
      ...
      if (null == imageSource) {
        ...
        if (null != borderStroke) {
          ...
          tmp15Result14 = tmp15(tmp(8586).Rect, size4);
        }
        ...
        if (typeof imageSource !== "number") {
          ...
          let tmp15Result15 = tmp15(tmp(8586).Image, size5);
        }
    ...
    tmp15Result18 = tmp15(tmp(8586).Rect, size9);
  }
});
