...
// Function ID: 17014
// Name: CutoutImage
// Dependencies: [32, 19, 17, 21, 1256, 8484, 13061, 2]

// Module 17013 (CutoutImage)
  ...
  if (num14 <= 0) {
    ...
    if (null == v4Result) {
      ...
      if (null != imageBackgroundColor) {
        ...
        tmp15Result13 = tmp15(tmp(8484).Rect, size3);
      }
      ...
      if (null == imageSource) {
        ...
        if (null != borderStroke) {
          ...
          tmp15Result14 = tmp15(tmp(8484).Rect, size4);
        }
        ...
        if (typeof imageSource !== "number") {
          ...
          let tmp15Result15 = tmp15(tmp(8484).Image, size5);
        }
    ...
    tmp15Result18 = tmp15(tmp(8484).Rect, size9);
  }
});
