// Module ID: 16976
// Function ID: 16977
// Dependencies: [32, 19, 17, 21, 1256, 8456, 13035, 2]
...
const memoResult = importAllResult.memo(function CutoutImage(cutoutTopLeftSize) {
  ...
  if (imageBorderRadius === imageSize / 2) {
    ...
    obj1[1] = imageSize / 2;
    obj1[2] = imageSize / 2;
    let tmp16 = callback2(tmp(8456).Circle, obj1);
    let tmp15 = callback2;
  } else {
    tmp15 = callback2;
    ...
    tmp16 = callback2(tmp(8456).Rect, obj2);
  }
  const items1 = [tmp16, , , , , ];
  ...
  if (num > 0) {
    ...
    obj3[1] = num3;
    obj3[2] = num;
    tmp15Result = tmp15(tmp(8456).Circle, obj3);
  }
  ...
  if (num4 > 0) {
    ...
    obj4[1] = num6;
    obj4[2] = num4;
    tmp15Result = tmp15(tmp(8456).Circle, obj4);
  }
  ...
  if (num7 > 0) {
    ...
    obj5[2] = num7;
    tmp15Result1 = tmp15(tmp(8456).Circle, obj5);
  }
  ...
  if (num10 > 0) {
    ...
    obj6[2] = num10;
    tmp15Result2 = tmp15(tmp(8456).Circle, obj6);
  }
  items1[4] = tmp15Result2;
  if (num14 <= 0) {
    items1[5] = null;
    obj[3] = items1;
    const items2 = [tmp12(tmp(8456).Mask, obj), ];
    if (null == v4Result) {
      const obj7 = { children: null };
      items2[1] = null;
      obj7[0] = items2;
      const items3 = [tmp12(tmp(8456).Defs, obj7), , , ];
      ...
      if (null != imageBackgroundColor) {
        ...
        obj8[3] = combined;
        obj8[4] = combined1;
        tmp15Result3 = tmp15(tmp(8456).Rect, obj8);
      }
      ...
      if (null == imageSource) {
        ...
        if (null != borderStroke) {
          ...
          tmp15Result4 = tmp15(tmp(8456).Rect, obj9);
        }
        ...
        if (typeof imageSource !== "number") {
          ...
          obj10[3] = combined;
          obj10[4] = combined1;
          let tmp15Result5 = tmp15(tmp(8456).Image, obj10);
        }
        ...
        tmp15Result5 = tmp15(tmp(8456).ForeignObject, obj11);
      }
    } else {
      ...
      if (imageBorderRadius === imageSize / 2) {
        ...
        obj15[1] = imageSize / 2;
        obj15[2] = imageSize / 4;
        let tmp15Result6 = tmp15(tmp(8456).Circle, obj15);
      } else {
        ...
        tmp15Result6 = tmp15(tmp(8456).Rect, obj16);
      }
      obj14[1] = tmp15Result6;
      tmp15(tmp(8456).ClipPath, obj14);
    }
    ...
    obj17[1] = imageSize / 2;
    obj17[2] = num14 / 2;
    let tmp15Result8 = tmp15(tmp(8456).Circle, obj17);
  } else {
    ...
    tmp15Result8 = tmp15(tmp(8456).Rect, obj18);
  }
});
