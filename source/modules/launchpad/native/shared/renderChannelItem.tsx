...
// Dependencies: [19, 17, 1980, 4371, 1372, 4904, 21, 10015, 1115, 4722, 576, 17046, 504, 5754, 12433, 7837, 17047, 11160, 17049, 4875, 2]
// Exports: default, getChannelAccessibilityProps

// Module 17045 (renderChannelItem)
...
function LaunchpadChannelIcon(channel) {
  ...
  const items1 = [closure_8(View, obj3), closure_8(channel(12433).ChannelIcon, { channel, size: "sm", wrapperSize: 32 })];
...
export default function renderChannelItem(unread) {
  ...
  if (channel.isGroupDM()) {
    ...
    let tmp11Result = tmp11(tmp5(11160), obj3);
  } else {
    const obj4 = { channel };
