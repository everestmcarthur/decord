...
// Dependencies: [19, 17, 1980, 4288, 1372, 4822, 21, 9921, 1115, 4640, 576, 16906, 504, 5672, 12342, 7755, 16907, 11067, 16909, 4793, 2]
// Exports: default, getChannelAccessibilityProps

// Module 16905 (renderChannelItem)
...
function LaunchpadChannelIcon(channel) {
  ...
  const items1 = [closure_8(View, obj3), closure_8(channel(12342).ChannelIcon, { channel, size: "sm", wrapperSize: 32 })];
...
export default function renderChannelItem(unread) {
  ...
  if (channel.isGroupDM()) {
    ...
    let tmp11Result = tmp11(tmp5(11067), obj3);
  } else {
    const obj4 = { channel };
