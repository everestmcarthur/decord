...
// Dependencies: [19, 17, 1372, 5772, 1074, 21, 4640, 576, 1484, 504, 1241, 1094, 5780, 4636, 1115, 5062, 5709, 2]
// Exports: default

// Module 5779 (ChangeEmailWarning)
...
const hcArticle = fn(5772).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(5780).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4636).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4636).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(5062).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(5062).Button, obj10);
