...
// Dependencies: [19, 17, 1371, 5735, 1074, 21, 4606, 576, 1483, 504, 1242, 1093, 5743, 4602, 1114, 5026, 5672, 2]
// Exports: default

// Module 5742 (ChangeEmailWarning)
...
const hcArticle = fn(5735).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(5743).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4602).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4602).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(5026).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(5026).Button, obj10);
