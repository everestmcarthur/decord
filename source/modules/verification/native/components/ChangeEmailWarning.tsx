...
// Dependencies: [19, 17, 1372, 5854, 1074, 21, 4722, 576, 1484, 504, 1241, 1094, 5862, 4718, 1115, 5144, 5791, 2]
// Exports: default

// Module 5861 (ChangeEmailWarning)
...
const hcArticle = fn(5854).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(5862).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4718).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4718).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(5144).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(5144).Button, obj10);
