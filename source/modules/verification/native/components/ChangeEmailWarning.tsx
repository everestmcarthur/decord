...
// Dependencies: [19, 17, 1371, 5698, 1074, 21, 4574, 576, 1483, 504, 1242, 1093, 5706, 4570, 1114, 4989, 5635, 2]
// Exports: default

// Module 5705 (ChangeEmailWarning)
...
const hcArticle = fn(5698).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(5706).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4570).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4570).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(4989).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(4989).Button, obj10);
