...
// Dependencies: [19, 17, 1372, 5770, 1074, 21, 4638, 576, 1484, 504, 1241, 1094, 5778, 4634, 1115, 5060, 5707, 2]
// Exports: default

// Module 5777 (ChangeEmailWarning)
...
const hcArticle = fn(5770).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(5778).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4634).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4634).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(5060).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(5060).Button, obj10);
