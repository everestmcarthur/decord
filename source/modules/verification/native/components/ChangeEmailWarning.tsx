...
// Dependencies: [19, 17, 1371, 5736, 1074, 21, 4607, 576, 1483, 504, 1242, 1093, 5744, 4603, 1114, 5027, 5673, 2]
// Exports: default

// Module 5743 (ChangeEmailWarning)
...
const hcArticle = fn(5736).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(5744).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4603).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4603).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(5027).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(5027).Button, obj10);
