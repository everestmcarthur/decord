...
// Dependencies: [5, 19, 17, 17594, 1951, 1371, 1074, 21, 4607, 1178, 17595, 1114, 5027, 1484, 1250, 5676, 7451, 9893, 7268, 6665, 17599, 6663, 6675, 6672, 7056, 7118, 7119, 6664, 17600, 7152, 7067, 504, 4574, 4472, 7074, 2]
// Exports: default

// Module 17593 (VerificationModal)
import Link from "Link" /* 1484 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4574 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import PhoneVerificationStore from "PhoneVerificationStore" /* 17594 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17595).VerifyPhone, title: null, body: null, children: null };
  ...
  obj2.children = jsx(navigation(5027).Button, { text: null, onPress: null });
  obj.children = <View style={closure_12().button}>{null}</View>;
  return jsx(navigation(1178).EmptyState, { Illustration: navigation(17595).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  const effect = noop.useEffect(() => {
    ...
    stateFromStores(4472).dismissKeyboard();
  }, []);
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(9893), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(7268).showSimpleActionSheet(obj2);
        };
        return closure_1_11(stateFromStores(7451).HeaderActionButton, obj);
      };
      obj8.render = function render() {
        return closure_1_11(closure_1_1(17599), {});
      };
      ...
      let obj10 = stateFromStores(5676);
      ...
      obj11.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      obj11.render = function render() {
        return closure_1_11(closure_1_1(6663), {});
      };
      ...
      const obj13 = stateFromStores(5676);
      ...
      obj14.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5676);
      ...
      obj17.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      obj17.render = function render() {
        return closure_1_11(closure_1_1(6675), { isChangeEmail: false });
      };
      ...
      const obj19 = stateFromStores(5676);
      ...
      obj20.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      obj20.render = function render() {
        return closure_1_11(closure_1_1(6672), {});
      };
      ...
      const obj22 = stateFromStores(5676);
      ...
      obj23.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      obj23.render = function render() {
        return closure_1_11(closure_1_1(7056), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5676);
      ...
      obj26.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      obj26.render = function render(arg0, arg1) {
        closure_0 = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = closure_0(7119).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return closure_0.push(constants.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F126393 */ function() { ... });
              obj.onSubmit = function onSubmit() { ... };
              closure_1 = closure_1_3(/* F126395 */ function() { ... });
              obj.onSuccess = function onSuccess() { ... };
              closure_0.push(constants.VERIFY_PASSWORD, obj);
            }
          });
        };
        return closure_11(closure_1(7118), obj);
      };
      ...
      const obj28 = stateFromStores(5676);
      ...
      obj29.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      obj29.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7152), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5676);
      ...
      obj32.headerTitle = stateFromStores(5676).getHeaderNoTitle();
      obj32.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7067), {});
      };
      ...
      const obj34 = stateFromStores(5676);
      ...
      obj35.headerTitle = stateFromStores(5676).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(7074).Navigator, {
    screens: noop.useMemo(() => {
      let obj = {};
      let obj2 = { impressionName: stateFromStores(1250).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: { impression_group: stateFromStores(1250).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS }, headerTitle: null, render: null };
      let obj3 = { impression_group: stateFromStores(1250).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
