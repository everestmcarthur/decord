...
// Dependencies: [5, 19, 17, 17759, 1952, 1372, 1074, 21, 4640, 1177, 17760, 1115, 5062, 1485, 1249, 5712, 7491, 9951, 7308, 6703, 17764, 6701, 6714, 6711, 7096, 7158, 7159, 6702, 17765, 7192, 7107, 504, 4607, 4506, 7114, 2]
// Exports: default

// Module 17758 (VerificationModal)
import Link from "Link" /* 1485 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4607 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import PhoneVerificationStore from "PhoneVerificationStore" /* 17759 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17760).VerifyPhone, title: null, body: null, children: null };
  ...
  obj2.children = jsx(navigation(5062).Button, { text: null, onPress: null });
  obj.children = <View style={closure_12().button}>{null}</View>;
  return jsx(navigation(1177).EmptyState, { Illustration: navigation(17760).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  const effect = noop.useEffect(() => {
    ...
    stateFromStores(4506).dismissKeyboard();
  }, []);
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(9951), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(7308).showSimpleActionSheet(obj2);
        };
        return closure_1_11(stateFromStores(7491).HeaderActionButton, obj);
      };
      obj8.render = function render() {
        return closure_1_11(closure_1_1(17764), {});
      };
      ...
      let obj10 = stateFromStores(5712);
      ...
      obj11.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      ...
      const obj13 = stateFromStores(5712);
      ...
      obj14.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5712);
      ...
      obj17.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      obj17.render = function render() {
        return closure_1_11(closure_1_1(6714), { isChangeEmail: false });
      };
      ...
      const obj19 = stateFromStores(5712);
      ...
      obj20.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      obj20.render = function render() {
        return closure_1_11(closure_1_1(6711), {});
      };
      ...
      const obj22 = stateFromStores(5712);
      ...
      obj23.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      obj23.render = function render() {
        return closure_1_11(closure_1_1(7096), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5712);
      ...
      obj26.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      obj26.render = function render(arg0, arg1) {
        closure_0 = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = closure_0(7159).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return closure_0.push(constants.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F127635 */ function() { ... });
              obj.onSubmit = function onSubmit() { ... };
              closure_1 = closure_1_3(/* F127637 */ function() { ... });
              obj.onSuccess = function onSuccess() { ... };
              closure_0.push(constants.VERIFY_PASSWORD, obj);
            }
          });
        };
        return closure_11(closure_1(7158), obj);
      };
      ...
      const obj28 = stateFromStores(5712);
      ...
      obj29.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      obj29.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7192), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5712);
      ...
      obj32.headerTitle = stateFromStores(5712).getHeaderNoTitle();
      obj32.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7107), {});
      };
      ...
      const obj34 = stateFromStores(5712);
      ...
      obj35.headerTitle = stateFromStores(5712).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(7114).Navigator, {
    screens: noop.useMemo(() => {
      let obj = {};
      let obj2 = { impressionName: stateFromStores(1249).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS }, headerTitle: null, render: null };
      let obj3 = { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
