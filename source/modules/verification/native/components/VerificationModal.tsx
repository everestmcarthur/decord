...
// Dependencies: [5, 19, 17, 17602, 1951, 1371, 1074, 21, 4605, 1178, 17603, 1114, 5025, 1484, 1250, 5674, 7429, 9870, 7246, 6643, 17607, 6641, 6653, 6650, 7034, 7096, 7097, 6642, 17608, 7130, 7045, 504, 4572, 4470, 7052, 2]
// Exports: default
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17603).VerifyPhone, title: null, body: null, children: null };
  ...
  obj2.children = jsx(navigation(5025).Button, { text: null, onPress: null });
  obj.children = <View style={closure_12().button}>{null}</View>;
  return jsx(navigation(1178).EmptyState, { Illustration: navigation(17603).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(9870), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(7246).showSimpleActionSheet(obj2);
        };
      ...
      let obj10 = stateFromStores(5674);
      ...
      obj11.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      const obj13 = stateFromStores(5674);
      ...
      obj14.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5674);
      ...
      const obj19 = stateFromStores(5674);
      ...
      obj20.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      const obj22 = stateFromStores(5674);
      ...
      obj23.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      obj26.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      obj29.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      obj32.headerTitle = stateFromStores(5674).getHeaderNoTitle();
      ...
      obj35.headerTitle = stateFromStores(5674).getHeaderNoTitle();
