...
// Dependencies: [5, 19, 17, 17662, 1952, 1372, 1074, 21, 4639, 1177, 17663, 1115, 5059, 1485, 1249, 5709, 7484, 9932, 7301, 6698, 17667, 6696, 6708, 6705, 7089, 7151, 7152, 6697, 17668, 7185, 7100, 504, 4606, 4505, 7107, 2]
// Exports: default

// Module 17661 (VerificationModal)
import Link from "Link" /* 1485 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4606 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import PhoneVerificationStore from "PhoneVerificationStore" /* 17662 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17663).VerifyPhone, title: null, body: null, children: null };
  ...
  obj2.children = jsx(navigation(5059).Button, { text: null, onPress: null });
  obj.children = <View style={closure_12().button}>{null}</View>;
  return jsx(navigation(1177).EmptyState, { Illustration: navigation(17663).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  const effect = noop.useEffect(() => {
    ...
    stateFromStores(4505).dismissKeyboard();
  }, []);
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(9932), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(7301).showSimpleActionSheet(obj2);
        };
        return closure_1_11(stateFromStores(7484).HeaderActionButton, obj);
      };
      obj8.render = function render() {
        return closure_1_11(closure_1_1(17667), {});
      };
      ...
      let obj10 = stateFromStores(5709);
      ...
      obj11.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      obj11.render = function render() {
        return closure_1_11(closure_1_1(6696), {});
      };
      ...
      const obj13 = stateFromStores(5709);
      ...
      obj14.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5709);
      ...
      obj17.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      obj17.render = function render() {
        return closure_1_11(closure_1_1(6708), { isChangeEmail: false });
      };
      ...
      const obj19 = stateFromStores(5709);
      ...
      obj20.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      obj20.render = function render() {
        return closure_1_11(closure_1_1(6705), {});
      };
      ...
      const obj22 = stateFromStores(5709);
      ...
      obj23.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      obj23.render = function render() {
        return closure_1_11(closure_1_1(7089), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5709);
      ...
      obj26.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      obj26.render = function render(arg0, arg1) {
        closure_0 = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = closure_0(7152).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return closure_0.push(constants.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F126711 */ function() { ... });
              obj.onSubmit = function onSubmit() { ... };
              closure_1 = closure_1_3(/* F126713 */ function() { ... });
              obj.onSuccess = function onSuccess() { ... };
              closure_0.push(constants.VERIFY_PASSWORD, obj);
            }
          });
        };
        return closure_11(closure_1(7151), obj);
      };
      ...
      const obj28 = stateFromStores(5709);
      ...
      obj29.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      obj29.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7185), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5709);
      ...
      obj32.headerTitle = stateFromStores(5709).getHeaderNoTitle();
      obj32.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7100), {});
      };
      ...
      const obj34 = stateFromStores(5709);
      ...
      obj35.headerTitle = stateFromStores(5709).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(7107).Navigator, {
    screens: noop.useMemo(() => {
      let obj = {};
      let obj2 = { impressionName: stateFromStores(1249).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS }, headerTitle: null, render: null };
      let obj3 = { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
