...
// Dependencies: [5, 19, 17, 17718, 1952, 1372, 1074, 21, 4638, 1177, 17719, 1115, 5060, 1485, 1249, 5710, 7487, 9940, 7304, 6701, 17723, 6699, 6711, 6708, 7092, 7154, 7155, 6700, 17724, 7188, 7103, 504, 4605, 4504, 7110, 2]
// Exports: default

// Module 17717 (VerificationModal)
import Link from "Link" /* 1485 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4605 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import PhoneVerificationStore from "PhoneVerificationStore" /* 17718 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17719).VerifyPhone, title: null, body: null, children: null };
  ...
  obj2.children = jsx(navigation(5060).Button, { text: null, onPress: null });
  obj.children = <View style={closure_12().button}>{null}</View>;
  return jsx(navigation(1177).EmptyState, { Illustration: navigation(17719).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  const effect = noop.useEffect(() => {
    ...
    stateFromStores(4504).dismissKeyboard();
  }, []);
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(9940), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(7304).showSimpleActionSheet(obj2);
        };
        return closure_1_11(stateFromStores(7487).HeaderActionButton, obj);
      };
      obj8.render = function render() {
        return closure_1_11(closure_1_1(17723), {});
      };
      ...
      let obj10 = stateFromStores(5710);
      ...
      obj11.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      obj11.render = function render() {
        return closure_1_11(closure_1_1(6699), {});
      };
      ...
      const obj13 = stateFromStores(5710);
      ...
      obj14.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5710);
      ...
      obj17.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      obj17.render = function render() {
        return closure_1_11(closure_1_1(6711), { isChangeEmail: false });
      };
      ...
      const obj19 = stateFromStores(5710);
      ...
      obj20.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      obj20.render = function render() {
        return closure_1_11(closure_1_1(6708), {});
      };
      ...
      const obj22 = stateFromStores(5710);
      ...
      obj23.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      obj23.render = function render() {
        return closure_1_11(closure_1_1(7092), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5710);
      ...
      obj26.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      obj26.render = function render(arg0, arg1) {
        closure_0 = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = closure_0(7155).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return closure_0.push(constants.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F127237 */ function() { ... });
              obj.onSubmit = function onSubmit() { ... };
              closure_1 = closure_1_3(/* F127239 */ function() { ... });
              obj.onSuccess = function onSuccess() { ... };
              closure_0.push(constants.VERIFY_PASSWORD, obj);
            }
          });
        };
        return closure_11(closure_1(7154), obj);
      };
      ...
      const obj28 = stateFromStores(5710);
      ...
      obj29.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      obj29.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7188), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5710);
      ...
      obj32.headerTitle = stateFromStores(5710).getHeaderNoTitle();
      obj32.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(7103), {});
      };
      ...
      const obj34 = stateFromStores(5710);
      ...
      obj35.headerTitle = stateFromStores(5710).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(7110).Navigator, {
    screens: noop.useMemo(() => {
      let obj = {};
      let obj2 = { impressionName: stateFromStores(1249).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS }, headerTitle: null, render: null };
      let obj3 = { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
