...
// Dependencies: [19, 17, 1371, 5736, 1074, 21, 4607, 576, 504, 1483, 1242, 1093, 5737, 5740, 5742, 4603, 1114, 5027, 2]
// Exports: default

// Module 5735 (ChangeEmailCollectReasons)
...
const VerificationConstants = fn(5736);
