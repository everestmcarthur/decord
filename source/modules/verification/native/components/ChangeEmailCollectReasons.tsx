...
// Dependencies: [19, 17, 1371, 5698, 1074, 21, 4574, 576, 504, 1483, 1242, 1093, 5699, 5702, 5704, 4570, 1114, 4989, 2]
// Exports: default

// Module 5697 (ChangeEmailCollectReasons)
...
const VerificationConstants = fn(5698);
