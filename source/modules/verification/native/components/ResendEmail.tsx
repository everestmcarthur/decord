...
// Function ID: 6606
// Name: ResendEmail
// Dependencies: [32, 19, 17, 1951, 1371, 1074, 21, 4574, 1483, 504, 38, 6606, 5635, 5706, 4570, 1114, 4989, 6607, 4272, 2]
// Exports: default

// Module 6605 (ResendEmail)
...
export default function ResendEmail() {
  ...
  const result = verified(6606).isEmailReverification(stateFromStores1);
  let tmp16Result = !result;
  const obj4 = verified(6606);
  ...
  items4[1] = closure_9(navigation(4570).Text, obj6);
  ...
  items4[2] = closure_9(navigation(4570).Text, obj7);
  ...
  obj9.children = closure_9(navigation(4989).Button, obj10);
  ...
  if (!result) {
    ...
    obj11.children = tmp16(tmp2(4989).Button, obj12);
