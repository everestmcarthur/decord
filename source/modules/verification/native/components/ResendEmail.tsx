...
// Function ID: 6664
// Name: ResendEmail
// Dependencies: [32, 19, 17, 1951, 1371, 1074, 21, 4607, 1483, 504, 38, 6664, 5673, 5744, 4603, 1114, 5027, 6665, 4305, 2]
// Exports: default

// Module 6663 (ResendEmail)
...
export default function ResendEmail() {
  ...
  const result = verified(6664).isEmailReverification(stateFromStores1);
  let tmp16Result = !result;
  const obj4 = verified(6664);
  ...
  const items4 = [closure_9(navigation(5744).EnvelopeOpenSpotIllustration, { scale: 0.75 }), , , , ];
  ...
  items4[1] = closure_9(navigation(4603).Text, obj6);
  ...
  items4[2] = closure_9(navigation(4603).Text, obj7);
  ...
  obj9.children = closure_9(navigation(5027).Button, obj10);
  ...
  if (!result) {
    ...
    obj11.children = tmp16(tmp2(5027).Button, obj12);
