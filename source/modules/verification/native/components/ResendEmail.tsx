...
// Function ID: 6642
// Name: ResendEmail
// Dependencies: [32, 19, 17, 1951, 1371, 1074, 21, 4605, 1483, 504, 38, 6642, 5671, 5742, 4601, 1114, 5025, 6643, 4303, 2]
// Exports: default

// Module 6641 (ResendEmail)
...
export default function ResendEmail() {
  ...
  const result = verified(6642).isEmailReverification(stateFromStores1);
  let tmp16Result = !result;
  const obj4 = verified(6642);
  ...
  const items4 = [closure_9(navigation(5742).EnvelopeOpenSpotIllustration, { scale: 0.75 }), , , , ];
  ...
  items4[1] = closure_9(navigation(4601).Text, obj6);
  ...
  items4[2] = closure_9(navigation(4601).Text, obj7);
  ...
  obj9.children = closure_9(navigation(5025).Button, obj10);
  ...
  if (!result) {
    ...
    obj11.children = tmp16(tmp2(5025).Button, obj12);
