...
// Function ID: 6663
// Name: ResendEmail
// Dependencies: [32, 19, 17, 1951, 1371, 1074, 21, 4606, 1483, 504, 38, 6663, 5672, 5743, 4602, 1114, 5026, 6664, 4305, 2]
// Exports: default
...
export default function ResendEmail() {
  ...
  const result = verified(6663).isEmailReverification(stateFromStores1);
  let tmp16Result = !result;
  const obj4 = verified(6663);
  ...
  items4[1] = closure_9(navigation(4602).Text, obj6);
  ...
  items4[2] = closure_9(navigation(4602).Text, obj7);
  ...
  obj9.children = closure_9(navigation(5026).Button, obj10);
  ...
  if (!result) {
    ...
    obj11.children = tmp16(tmp2(5026).Button, obj12);
