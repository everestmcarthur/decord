...
// Dependencies: [19, 17, 5674, 21, 4606, 576, 5672, 6673, 4602, 1114, 5026, 2]
// Exports: default

// Module 7072 (ChangeEmailComplete)
...
export default function ChangeEmailComplete(email) {
  ...
  const items = [React5(React4, { style: tmp.image, source: _modDef6673 }), , , ];
