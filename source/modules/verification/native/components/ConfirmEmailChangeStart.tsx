...
// Dependencies: [5, 32, 19, 17, 1371, 21, 4606, 1483, 504, 6672, 1093, 4508, 4305, 1114, 6673, 4602, 5026, 2]
// Exports: default

// Module 6671 (ConfirmEmailChangeStart)
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    let obj6 = { style: tmp.image, source: navigation(6673) };
    ...
    items1[1] = closure_10(tmp2(4602).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5026).Button, obj9);
