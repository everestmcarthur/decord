...
// Dependencies: [5, 32, 19, 17, 1371, 21, 4605, 1483, 504, 6651, 1093, 4507, 4303, 1114, 6652, 4601, 5025, 2]
// Exports: default

// Module 6650 (ConfirmEmailChangeStart)
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    let obj6 = { style: tmp.image, source: navigation(6652) };
    ...
    items1[1] = closure_10(tmp2(4601).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5025).Button, obj9);
