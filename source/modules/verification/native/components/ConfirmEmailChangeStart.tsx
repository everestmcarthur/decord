...
// Dependencies: [5, 32, 19, 17, 1372, 21, 4722, 1484, 504, 6794, 1094, 4623, 4420, 1115, 6795, 4718, 5144, 2]
// Exports: default

// Module 6793 (ConfirmEmailChangeStart)
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    let obj6 = { style: tmp.image, source: navigation(6795) };
    ...
    items1[1] = closure_10(tmp2(4718).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5144).Button, obj9);
