...
// Dependencies: [5, 32, 19, 17, 1372, 21, 4640, 1484, 504, 6712, 1094, 4541, 4338, 1115, 6713, 4636, 5062, 2]
// Exports: default

// Module 6711 (ConfirmEmailChangeStart)
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    let obj6 = { style: tmp.image, source: navigation(6713) };
    ...
    items1[1] = closure_10(tmp2(4636).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5062).Button, obj9);
