...
// Dependencies: [5, 32, 19, 17, 1371, 21, 4607, 1483, 504, 6673, 1093, 4509, 4305, 1114, 6674, 4603, 5027, 2]
// Exports: default

// Module 6672 (ConfirmEmailChangeStart)
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    let obj6 = { style: tmp.image, source: navigation(6674) };
    ...
    items1[1] = closure_10(tmp2(4603).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5027).Button, obj9);
