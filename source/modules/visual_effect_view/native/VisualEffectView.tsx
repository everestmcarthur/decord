...
// Dependencies: [19, 17, 5051, 1074, 21, 1364, 5052, 4341, 576, 5055, 2]
// Exports: isBlurDisabled, isBlurThemeLight, normalizeBlurTheme

// Module 5050 (VisualEffectView)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4341 */;
import VisualEffectViewAndroid from "VisualEffectViewAndroid" /* 5055 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
let closure_4 = fn(5051).useVisualEffectViewOverrides;
...
export default noop.forwardRef(function VisualEffectView(blurAmount, ref) {
  ...
  if (closure_7) {
    ...
    if (!tmp18) {
      if (android_softwareBlurDisabled) {
        android_softwareBlurDisabled = !tmp6(5055).MODERN_ANDROID_BLURRING_AVAILABLE;
      }
  ...
  if (tmp17) {
    ...
    tmp19Result = tmp19(tmp8(5055), obj5);
    ...
    if (blurEffectNameOverride != null) {
      ...
      if (!tmp6(5052).MODERN_IOS_BLURS_EFFECTS_AVAILABLE) {
        if (tmp3) {
