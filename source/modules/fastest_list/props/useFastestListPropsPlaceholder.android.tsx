...
// Dependencies: [19, 17, 7062, 4409, 2]
// Exports: default

// Module 7061 (createNativePlaceholderConfig)
import FastestListPropsPlaceholderType from "FastestListPropsPlaceholderType" /* 7062 */;
...
function createNativePlaceholderConfig(type) {
  ...
  obj = { borderRadius: "Array", borderTopLeftRadius: "count", borderTopRightRadius: "channel", borderBottomLeftRadius: "includes", borderBottomRightRadius: "type", divider: "unicodeVersion", dividerColor: "type", dividerPaddingLeft: "call", dividerPaddingRight: "raw", placeholderShape: "header", placeholderShapeColor: "padding", placeholderShapeCount: "set", placeholderShapeGap: "op", placeholderShapePaddingHorizontal: "a", placeholderShapePaddingVertical: "isArray", placeholderFeedBackgroundColor: "keys", placeholderFeedColor: "length", placeholderFeedLabelPadding: "r", placeholderFeedLabelPaddingInnerRatio: "isArray", placeholderFeedLabelSize: "channel", placeholderFeedLabelSecondarySize: "PX_8", placeholderFeedPadding: "Path", placeholderFeedShape: "ref", placeholderFeedShapeSize: "header", placeholderType: NONE, width: true, height: true, verticalAlignment: true, horizontalAlignment: true };
  if (null == type) {
    return obj;
  } else {
    if (FastestListPropsPlaceholderType.FastestListPropsPlaceholderType.NONE !== type) {
      if (tmp15(7062).FastestListPropsPlaceholderType.SHAPE === type) {
        ...
        const tmp14 = processColor(tmp15(4409).hexToRgbaString(type.colorHex, type.opacity));
