...
// Dependencies: [19, 17, 21, 4606, 576, 12481, 9313, 4602, 1114, 8684, 2]

// Module 12495 (GameMentionSearchBar)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import Text_Text from "Text/Text" /* 4602 */;
import Form from "Form" /* 8684 */;
import GameControllerIcon from "GameControllerIcon" /* 9313 */;
import useGameMentionSearchBarHeight from "useGameMentionSearchBarHeight" /* 12481 */;
...
obj.headerRow = { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: fn(12481).GAME_MENTION_SEARCH_BAR_HEADER_PADDING_VERTICAL };
obj.icon = { marginRight: 12 };
const obj4 = { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: fn(12481).GAME_MENTION_SEARCH_BAR_HEADER_PADDING_VERTICAL };
obj.description = { paddingHorizontal: 16, paddingBottom: fn(12481).GAME_MENTION_SEARCH_BAR_DESCRIPTION_PADDING_BOTTOM };
const obj5 = { paddingHorizontal: 16, paddingBottom: fn(12481).GAME_MENTION_SEARCH_BAR_DESCRIPTION_PADDING_BOTTOM };
