...
// Dependencies: [19, 17, 21, 4607, 576, 12483, 9315, 4603, 1114, 8686, 2]

// Module 12497 (GameMentionSearchBar)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import Text_Text from "Text/Text" /* 4603 */;
import Form from "Form" /* 8686 */;
import GameControllerIcon from "GameControllerIcon" /* 9315 */;
import useGameMentionSearchBarHeight from "useGameMentionSearchBarHeight" /* 12483 */;
...
obj.headerRow = { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: fn(12483).GAME_MENTION_SEARCH_BAR_HEADER_PADDING_VERTICAL };
obj.icon = { marginRight: 12 };
const obj4 = { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: fn(12483).GAME_MENTION_SEARCH_BAR_HEADER_PADDING_VERTICAL };
obj.description = { paddingHorizontal: 16, paddingBottom: fn(12483).GAME_MENTION_SEARCH_BAR_DESCRIPTION_PADDING_BOTTOM };
const obj5 = { paddingHorizontal: 16, paddingBottom: fn(12483).GAME_MENTION_SEARCH_BAR_DESCRIPTION_PADDING_BOTTOM };
