...
// Dependencies: [19, 17, 21, 4605, 576, 12458, 9292, 4601, 1114, 8663, 2]

// Module 12472 (GameMentionSearchBar)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import Text_Text from "Text/Text" /* 4601 */;
import Form from "Form" /* 8663 */;
import GameControllerIcon from "GameControllerIcon" /* 9292 */;
import useGameMentionSearchBarHeight from "useGameMentionSearchBarHeight" /* 12458 */;
...
obj.headerRow = { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: fn(12458).GAME_MENTION_SEARCH_BAR_HEADER_PADDING_VERTICAL };
obj.icon = { marginRight: 12 };
const obj4 = { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: fn(12458).GAME_MENTION_SEARCH_BAR_HEADER_PADDING_VERTICAL };
obj.description = { paddingHorizontal: 16, paddingBottom: fn(12458).GAME_MENTION_SEARCH_BAR_DESCRIPTION_PADDING_BOTTOM };
const obj5 = { paddingHorizontal: 16, paddingBottom: fn(12458).GAME_MENTION_SEARCH_BAR_DESCRIPTION_PADDING_BOTTOM };
