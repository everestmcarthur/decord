...
// Dependencies: [5, 7181, 1074, 4494, 573, 1272, 2]

// Module 7244 (AuthorizedAppsActionCreators)
...
const batchInvocationManager = new fn(4494).BatchInvocationManager(fetchAuthorizedApps, {
  predicate(arg0) {
