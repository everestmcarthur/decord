...
// Dependencies: [5, 7121, 1074, 4461, 573, 1272, 2]

// Module 7184 (AuthorizedAppsActionCreators)
...
const batchInvocationManager = new fn(4461).BatchInvocationManager(fetchAuthorizedApps, {
  predicate(arg0) {
