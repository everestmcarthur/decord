...
// Function ID: 9558
// Name: GuildSelector
// Dependencies: [19, 17, 1074, 21, 4639, 576, 4606, 9558, 1897, 1115, 1086, 4635, 1177, 8719, 2]
// Exports: default

// Module 9557 (GuildSelector)
...
export default function GuildSelector(disabled) {
  ...
  items1[2] = closure_7(selectedGuildId(8719).FormRow, { label: name, disabled: disabled.disabled, trailing: closure_7(selectedGuildId(8719).FormRow.Arrow, {}), DEPRECATED_style: tmp.select, onPress: callback });
