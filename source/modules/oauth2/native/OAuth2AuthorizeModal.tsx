...
// Dependencies: [19, 17, 21, 4722, 576, 9473, 1612, 4458, 5143, 5292, 1115, 9827, 5850, 4718, 7319, 9829, 2]
// Exports: default

// Module 9826 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  const tmp = closure_8();
  const tmp4 = sharedValue(9473)(arg0);
  _require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9827).ArrowSmallLeftIcon, obj7);
  } else {
    const obj8 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = tmp11(tmp5(5850).XSmallIcon, obj8);
  }
  ...
  obj11.style = items3;
  items2[2] = closure_5(sharedValue(4458).View, obj11);
  ...
  obj12.children = closure_5(sharedValue(9829), obj13);
