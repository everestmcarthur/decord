...
// Dependencies: [19, 17, 21, 4605, 576, 9304, 1611, 4341, 5024, 5173, 1114, 9649, 5730, 4601, 7175, 9651, 2]
// Exports: default
...
export default function OAuth2AuthorizeModal(arg0) {
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9649).ArrowSmallLeftIcon, obj7);
  } else {
    const obj8 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = tmp11(tmp5(5730).XSmallIcon, obj8);
  }
  ...
  obj11.style = items3;
  items2[2] = closure_5(sharedValue(4341).View, obj11);
  ...
  obj12.children = closure_5(sharedValue(9651), obj13);
