...
// Dependencies: [19, 17, 21, 4640, 576, 9389, 1612, 4376, 5061, 5210, 1115, 9733, 5768, 4636, 7237, 9735, 2]
// Exports: default

// Module 9732 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  const tmp = closure_8();
  const tmp4 = sharedValue(9389)(arg0);
  _require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9733).ArrowSmallLeftIcon, obj7);
  } else {
    const obj8 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = tmp11(tmp5(5768).XSmallIcon, obj8);
  }
  ...
  obj12.children = closure_5(sharedValue(9735), obj13);
