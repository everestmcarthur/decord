...
// Dependencies: [19, 17, 21, 4638, 576, 9378, 1612, 4374, 5059, 5208, 1115, 9722, 5766, 4634, 7233, 9724, 2]
// Exports: default

// Module 9721 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  const tmp = closure_8();
  const tmp4 = sharedValue(9378)(arg0);
  _require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let stringResult = intl2.string(tmp5(1115).t["13/7kX"]);
  } else {
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9722).ArrowSmallLeftIcon, obj7);
  } else {
    const obj8 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = tmp11(tmp5(5766).XSmallIcon, obj8);
  }
  ...
  obj11.style = items3;
  items2[2] = closure_5(sharedValue(4374).View, obj11);
  ...
  obj12.children = closure_5(sharedValue(9724), obj13);
