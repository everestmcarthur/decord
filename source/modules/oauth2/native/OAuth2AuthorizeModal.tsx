...
// Dependencies: [19, 17, 21, 4639, 576, 9367, 1612, 4376, 5058, 5207, 1115, 9711, 5765, 4635, 7230, 9713, 2]
// Exports: default

// Module 9710 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  const tmp = closure_8();
  const tmp4 = sharedValue(9367)(arg0);
  _require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9711).ArrowSmallLeftIcon, obj7);
  } else {
    const obj8 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = tmp11(tmp5(5765).XSmallIcon, obj8);
  }
  ...
  obj11.style = items3;
  items2[2] = closure_5(sharedValue(4376).View, obj11);
  ...
  obj12.children = closure_5(sharedValue(9713), obj13);
