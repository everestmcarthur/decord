...
// Function ID: 9676
// Name: oauth2/Header
// Dependencies: [19, 17, 1074, 21, 4722, 576, 1397, 1177, 4718, 9676, 1385, 1115, 2]
// Exports: default

// Module 9675 (oauth2/Header)
...
export default function Header(accountScopes) {
  ...
  if (null != bot) {
    ...
    tmp8Result = tmp8(tmp2(9676), obj13);
    const tmp2Result2 = tmp2(9676);
  }
  items3[1] = tmp8Result;
