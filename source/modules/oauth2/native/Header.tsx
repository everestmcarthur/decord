...
// Function ID: 9531
// Name: oauth2/Header
// Dependencies: [19, 17, 1074, 21, 4607, 576, 1396, 1178, 4603, 9531, 1384, 1114, 2]
// Exports: default

// Module 9530 (oauth2/Header)
...
export default function Header(accountScopes) {
  ...
  if (null != bot) {
    ...
    tmp8Result = tmp8(tmp2(9531), obj13);
    const tmp2Result2 = tmp2(9531);
  }
  items3[1] = tmp8Result;
