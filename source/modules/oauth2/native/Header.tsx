...
// Function ID: 9508
// Name: oauth2/Header
// Dependencies: [19, 17, 1074, 21, 4605, 576, 1396, 1178, 4601, 9508, 1384, 1114, 2]
// Exports: default

// Module 9507 (oauth2/Header)
...
export default function Header(accountScopes) {
  ...
  if (null != bot) {
    ...
    tmp8Result = tmp8(tmp2(9508), obj13);
    const tmp2Result2 = tmp2(9508);
  }
  items3[1] = tmp8Result;
