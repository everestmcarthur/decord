...
// Function ID: 9470
// Name: oauth2/Header
// Dependencies: [19, 17, 1074, 21, 4574, 576, 1396, 1178, 4570, 9470, 1384, 1114, 2]
// Exports: default

// Module 9469 (oauth2/Header)
...
export default function Header(accountScopes) {
  ...
  if (null != bot) {
    ...
    tmp8Result = tmp8(tmp2(9470), obj13);
    const tmp2Result2 = tmp2(9470);
  }
  items3[1] = tmp8Result;
