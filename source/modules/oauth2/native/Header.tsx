...
// Function ID: 9592
// Name: oauth2/Header
// Dependencies: [19, 17, 1074, 21, 4640, 576, 1397, 1177, 4636, 9592, 1385, 1115, 2]
// Exports: default

// Module 9591 (oauth2/Header)
...
export default function Header(accountScopes) {
  ...
  if (null != bot) {
    ...
    tmp8Result = tmp8(tmp2(9592), obj13);
    const tmp2Result2 = tmp2(9592);
  }
  items3[1] = tmp8Result;
