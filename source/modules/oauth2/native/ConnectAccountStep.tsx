...
// Dependencies: [19, 17, 4867, 502, 1372, 21, 4639, 576, 4574, 504, 5368, 1397, 4491, 7270, 1177, 8798, 4635, 1115, 5059, 9384, 4594, 4590, 2]
// Exports: ConnectedAccountCard, default

// Module 9383 (ConnectAccountStep)
...
export default function ConnectAccountStep(clientId) {
  ...
  value = platformType(5368).get(platformType);
  if (null == value) {
    ...
    items4[1] = closure_8(tmp5(8798).MoreHorizontalIcon, obj10);
    ...
    items6[1] = closure_8(tmp5(4635).Text, obj14);
    ...
    items7[1] = closure_8(tmp5(4635).Text, obj18);
    const obj19 = {
      variant: "primary",
      size: "sm",
      onPress() {
    ...
    items7[2] = closure_8(tmp5(5059).Button, obj19);
    ...
    items8[1] = closure_8(tmp5(4635).Text, obj22);
