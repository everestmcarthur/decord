...
// Dependencies: [19, 17, 4835, 502, 1371, 21, 4607, 576, 4542, 504, 5335, 1396, 4458, 7237, 1178, 8765, 4603, 1114, 5027, 9344, 4562, 4558, 2]
// Exports: ConnectedAccountCard, default

// Module 9343 (ConnectAccountStep)
...
export default function ConnectAccountStep(clientId) {
  ...
  value = platformType(5335).get(platformType);
  if (null == value) {
    ...
    items4[1] = closure_8(tmp5(8765).MoreHorizontalIcon, obj10);
    ...
    items6[1] = closure_8(tmp5(4603).Text, obj14);
    ...
    items7[1] = closure_8(tmp5(4603).Text, obj18);
    const obj19 = {
      variant: "primary",
      size: "sm",
      onPress() {
    ...
    items7[2] = closure_8(tmp5(5027).Button, obj19);
    ...
    const items8 = [closure_8(tmp5(4562).CircleInformationIcon, obj21), ];
    ...
    items8[1] = closure_8(tmp5(4603).Text, obj22);
