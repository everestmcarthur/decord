...
// Dependencies: [9667, 4810, 9341, 1896, 1365, 9669, 4572, 1093, 4301, 2]
// Exports: default

// Module 9668 (authorizeCallback)
...
import Constants from "Constants" /* 9667 */;
...
export default function authorizeCallback(arg0) {
  ...
  if (null != _location) {
      ...
      if (tmp8Result.isDiscordHostname(host)) {
        if (null != pathname) {
          if (null != pathname.match(re5)) {
            ...
            tmp8(4810).pushLazy(asyncRequireImpl(9669, tmp9.paths), obj3, React3);
          } else if (null != pathname.match(re6)) {
            if (!canceled) {
              let str1;
              const tmp8Result5 = tmp8(4810);
              ...
              tmp8Result5.pushLazy(asyncRequireImpl(9341, tmp9.paths), obj4, React4);
              const tmp17 = asyncRequireImpl(9341, tmp9.paths);
            }
          }
        }
      }
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9341, dependencyMap.paths), undefined, React4);
  }
};
