...
// Dependencies: [19, 17, 1074, 21, 4638, 576, 9386, 8469, 1115, 4337, 9564, 9366, 7490, 4634, 9566, 2]
// Exports: default

// Module 9563 (ApplicationEducation)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4634 */;
import OAuth2Scopes from "OAuth2Scopes" /* 8469 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9386 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4337).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9564).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9366).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7490).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8469).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4337).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9366).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7490).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4634).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9566).AuthorizeFormSeparator, {})];
