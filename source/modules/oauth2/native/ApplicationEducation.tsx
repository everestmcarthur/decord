...
// Dependencies: [19, 17, 1074, 21, 4605, 576, 9312, 8404, 1114, 4304, 9491, 9292, 7432, 4601, 9493, 2]
// Exports: default

// Module 9490 (ApplicationEducation)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4601 */;
import OAuth2Scopes from "OAuth2Scopes" /* 8404 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9312 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    if (tmp3) {
      ...
      let formatToPlainStringResult = intl5.formatToPlainString(tmp4(1114).t["3Mau0y"], obj2);
    } else {
      formatToPlainStringResult = intl5.string(tmp4(1114).t.ex4sMU);
    }
    const obj3 = { iconComponent: tmp4(4304).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9491).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9292).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7432).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8404).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4304).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9292).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7432).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4601).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9493).AuthorizeFormSeparator, {})];
