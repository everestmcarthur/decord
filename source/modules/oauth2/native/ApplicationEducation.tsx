...
// Dependencies: [19, 17, 1074, 21, 4574, 576, 9275, 8367, 1114, 4273, 9453, 9255, 7394, 4570, 9455, 2]
// Exports: default

// Module 9452 (ApplicationEducation)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4570 */;
import OAuth2Scopes from "OAuth2Scopes" /* 8367 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9275 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4273).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9453).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9255).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7394).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8367).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4273).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9255).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7394).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4570).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9455).AuthorizeFormSeparator, {})];
