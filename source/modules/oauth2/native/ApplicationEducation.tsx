...
// Dependencies: [19, 17, 1074, 21, 4607, 576, 9335, 8427, 1114, 4306, 9514, 9315, 7454, 4603, 9516, 2]
// Exports: default

// Module 9513 (ApplicationEducation)
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4306).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9514).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9315).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7454).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8427).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4306).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9315).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7454).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4603).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9516).AuthorizeFormSeparator, {})];
