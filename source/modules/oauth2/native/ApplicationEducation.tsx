...
// Dependencies: [19, 17, 1074, 21, 4606, 576, 9333, 8425, 1114, 4306, 9512, 9313, 7453, 4602, 9514, 2]
// Exports: default

// Module 9511 (ApplicationEducation)
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj6 = { iconComponent: tmp4(9512).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9313).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7453).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8425).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj12 = { iconComponent: tmp4(9313).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7453).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4602).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9514).AuthorizeFormSeparator, {})];
