...
// Dependencies: [19, 17, 1074, 21, 4640, 576, 9397, 8488, 1115, 4339, 9575, 9377, 7494, 4636, 9577, 2]
// Exports: default

// Module 9574 (ApplicationEducation)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4636 */;
import OAuth2Scopes from "OAuth2Scopes" /* 8488 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9397 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4339).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9575).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9377).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7494).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8488).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4339).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9377).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7494).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4636).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9577).AuthorizeFormSeparator, {})];
