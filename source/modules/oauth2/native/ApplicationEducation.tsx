...
// Dependencies: [19, 17, 1074, 21, 4639, 576, 9375, 8460, 1115, 4339, 9553, 9355, 7487, 4635, 9555, 2]
// Exports: default

// Module 9552 (ApplicationEducation)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4635 */;
import OAuth2Scopes from "OAuth2Scopes" /* 8460 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9375 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj6 = { iconComponent: tmp4(9553).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9355).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7487).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8460).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj12 = { iconComponent: tmp4(9355).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7487).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4635).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9555).AuthorizeFormSeparator, {})];
