...
// Dependencies: [5, 32, 19, 17, 1961, 4255, 1371, 21, 4607, 576, 4574, 9519, 1896, 1114, 4760, 9336, 4603, 1178, 8686, 2]
// Exports: default

// Module 9520 (WebhookGuildChannelSelector)
  ...
  const callback = noop.useCallback(() => {
    ...
    if (tmp2) {
      ...
      obj2.items = channels.map((id) => {
        const obj = { label: selectedGuildId(4760).computeChannelName(closure_1_7(id), closure_1_9, closure_1_8), value: id.id };
        return obj;
      });
      ...
      obj.openLazy(asyncRequireImpl(9519, dependencyMap.paths), WebhookGuildChannelSelector, obj2);
      const tmp7 = asyncRequireImpl(9519, dependencyMap.paths);
    }
  }, items);
