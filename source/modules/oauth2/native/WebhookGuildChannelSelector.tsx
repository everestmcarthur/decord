...
// Dependencies: [5, 32, 19, 17, 1961, 4253, 1371, 21, 4605, 576, 4572, 9496, 1896, 1114, 4758, 9313, 4601, 1178, 8663, 2]
// Exports: default

// Module 9497 (WebhookGuildChannelSelector)
  ...
  const callback = noop.useCallback(() => {
    ...
    if (tmp2) {
      ...
      obj2.items = channels.map((id) => {
        const obj = { label: selectedGuildId(4758).computeChannelName(closure_1_7(id), closure_1_9, closure_1_8), value: id.id };
        return obj;
      });
      ...
      obj.openLazy(asyncRequireImpl(9496, dependencyMap.paths), WebhookGuildChannelSelector, obj2);
      const tmp7 = asyncRequireImpl(9496, dependencyMap.paths);
    }
  }, items);
