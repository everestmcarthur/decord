...
// Dependencies: [5, 32, 19, 17, 1962, 4371, 1372, 21, 4722, 576, 4689, 9664, 1897, 1115, 4875, 9482, 4718, 1177, 8831, 2]
// Exports: default

// Module 9665 (WebhookGuildChannelSelector)
  ...
  const callback = noop.useCallback(() => {
    ...
    if (tmp2) {
      ...
      obj2.items = channels.map((id) => {
        const obj = { label: selectedGuildId(4875).computeChannelName(closure_1_7(id), closure_1_9, closure_1_8), value: id.id };
        return obj;
      });
      ...
      obj.openLazy(asyncRequireImpl(9664, dependencyMap.paths), WebhookGuildChannelSelector, obj2);
      const tmp7 = asyncRequireImpl(9664, dependencyMap.paths);
    }
  }, items);
