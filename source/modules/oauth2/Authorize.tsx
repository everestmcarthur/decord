...
// Function ID: 9370
// Name: Authorize
// Dependencies: [1958, 4461, 1074, 9370, 8460, 5541, 4283, 1086, 2]
// Exports: filterScopes, parseOAuth2AuthorizeProps

// Module 9369 (Authorize)
...
export const filterScopes = function filterScopes(items) {
  ...
  if (hasItem) {
    hasItem = !found.includes(tmp(8460).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  if (hasItem) {
    found.push(tmp(8460).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  return found;
};
