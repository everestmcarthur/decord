...
// Dependencies: [19, 17, 21, 11472, 11473, 11474, 11475, 11476, 11477, 1115, 4639, 4574, 4491, 7547, 12, 5078, 4635, 2]
// Exports: default

// Module 11471 (ChannelFollowSuccessAlert)
...
const common_AlertDefault = tmp2(5078);
require = fn;
