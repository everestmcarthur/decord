...
// Dependencies: [19, 17, 21, 11366, 11367, 11368, 11369, 11370, 11371, 1114, 4574, 4509, 4425, 7454, 12, 5008, 4570, 2]
// Exports: default

// Module 11365 (ChannelFollowSuccessAlert)
...
const common_AlertDefault = tmp2(5008);
require = fn;
