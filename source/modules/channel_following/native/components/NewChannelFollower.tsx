...
// Dependencies: [32, 19, 17, 1962, 1958, 2013, 1980, 4278, 5526, 1074, 21, 4640, 576, 8318, 4574, 504, 4793, 5079, 4491, 11481, 11482, 7264, 6738, 5672, 1177, 5115, 4636, 1115, 5060, 5775, 5693, 4607, 9580, 1897, 11483, 8748, 5521, 5062, 11486, 7268, 2]
// Exports: default

// Module 11480 (NewChannelFollower)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1897 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4607 */;
import openChannelPickerDefault from "openChannelPicker" /* 11483 */;
import ChannelFollowerActionCreatorsDefault from "ChannelFollowerActionCreators" /* 11486 */;
...
export default function NewChannelFollower(targetChannelId) {
  ...
  obj15.onPress = function onPress() {
    ...
    obj.openLazy(asyncRequireImpl(9580, dependencyMap.paths), "NewChannelFollowerGuildPicker", obj2);
  };
