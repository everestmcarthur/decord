...
import { GestureHandlerRootView } from "PanGestureHandler" /* 7005 */;
...
class StackView {
  constructor() {
    ...
    obj = { routes: [], previousState: "y", openingRouteKeys: false, closingRouteKeys: null, replacingRouteKeys: 200, descriptors: "parallax" };
    obj[2] = [];
    obj[3] = [];
    obj[4] = [];
    obj[5] = {};
