...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8509, 8494, 8495]
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8509 */;
...
let obj = {
  ...
  value: function render() {
    ...
    const merged1 = Object.assign(self(8494).extractFilter(this.props));
    const obj2 = self(8494);
    const merged2 = Object.assign(self(8494).extractIn(this.props));
