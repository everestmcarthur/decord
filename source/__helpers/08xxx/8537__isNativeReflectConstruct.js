...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8534, 8538, 8539, 8471, 8480]

// Module 8537 (_isNativeReflectConstruct)
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8539 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = _modDef8534[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = _modDef8534[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
