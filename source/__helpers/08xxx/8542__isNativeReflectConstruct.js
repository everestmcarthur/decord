...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8464, 8534, 8543, 8469, 8480]

// Module 8542 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(8464)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(8534)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(8464);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(8469)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(8543), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
