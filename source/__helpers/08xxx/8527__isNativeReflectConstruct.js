...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8469, 8528, 8471, 8480]
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8528 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      let obj = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: self(8469).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
      [tmp2, tmp3] = parts;
      const tmp6 = self(8469).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(8469).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(8469).alignEnum[tmp2] || "xMidYMid";
      const tmp11 = __INTERNAL_VIEW_CONFIGDefault;
      const merged = Object.assign(self(8471).withoutXY(this, props));
