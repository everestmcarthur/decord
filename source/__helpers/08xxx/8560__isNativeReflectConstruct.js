...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8472, 8561, 8471, 8480]
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8561 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      let match = str;
      if (str) {
        match = str.match(self(8472).idPattern);
      }
      let tmp4 = match;
      if (match) {
        tmp4 = match[1];
