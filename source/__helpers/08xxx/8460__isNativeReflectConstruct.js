...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8461, 8462, 8463, 8464, 8468, 8469, 8470, 8480]

// Module 8460 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractOpacityDefault from "extractOpacity" /* 8462 */;
import keysDefault from "keys" /* 8463 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8468 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8470 */;
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8480 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(8464).extractTransformSvgView(tmp);
        const obj3 = self(8464);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8469)({ viewBox, preserveAspectRatio }));
