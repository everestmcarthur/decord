...
// Module 14237 (__exportStarResult25)
const require = arg1;
...
arg5.PartitionNumberRangePattern = function PartitionNumberRangePattern(arg0, isNaN, isNaN2, getInternalSlots) {
  ...
  items(14209).invariant(tmp4, "Input must be a number", RangeError);
  ...
  if (FormatNumericResult === items(14234).FormatNumeric(internalSlots, isNaN2)) {
    ...
    return tmp(14222).CollapseNumberRange(arg0, items, obj);
  }
  FormatNumericResult = items(14234).FormatNumeric(internalSlots, isNaN);
};
