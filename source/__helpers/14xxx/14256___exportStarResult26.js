...
// Dependencies: [14212, 14209, 14214, 14213]

// Module 14256 (__exportStarResult26)
...
arg5.SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(internalSlots, result1, minimumFractionDigits, arg3, GetOptionResult1) {
  ...
  const GetNumberOptionResult = __exportStarResult3.GetNumberOption(result1, "roundingIncrement", 1, 5000, 1);
  ...
  if (flag2) {
    if (tmp11) {
      internalSlots.minimumSignificantDigits = tmp2(14213).DefaultNumberOption(minimumSignificantDigits, 1, 21, 1);
      internalSlots.maximumSignificantDigits = tmp2(14213).DefaultNumberOption(maximumSignificantDigits, internalSlots.minimumSignificantDigits, 21, 21);
    } else {
  ...
  if (flag) {
    if (tmp12) {
      const DefaultNumberOptionResult = tmp2(14213).DefaultNumberOption(minimumFractionDigits, 0, 100, undefined);
      const DefaultNumberOptionResult1 = tmp2(14213).DefaultNumberOption(maximumFractionDigits, 0, 100, undefined);
      if (undefined === DefaultNumberOptionResult) {
        tmp2(14209).invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      tmp2(14209).invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
      const _RangeError = RangeError;
      tmp2(14209).invariant(internalSlots.maximumFractionDigits === internalSlots.minimumFractionDigits, "With roundingIncrement > 1, maximumFractionDigits and minimumFractionDigits must be equal.", RangeError);
    }
  }
