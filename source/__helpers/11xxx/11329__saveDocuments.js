...
// Function ID: 11330
// Name: _saveDocuments
// Dependencies: [5, 17, 11322]
// Exports: saveDocuments

// Module 11329 (_saveDocuments)
...
let closure_3 = async function _saveDocuments() {
  ...
  await asyncGeneratorStep(async () => {
    ...
    const NativeDocumentPicker2 = tmp2(11322).NativeDocumentPicker;
    closure_128_0 = await NativeDocumentPicker2.saveDocument(tmp2);
    const NativeDocumentPicker = tmp2(11322).NativeDocumentPicker;
