...
// Function ID: 11266
// Name: _saveDocuments
// Dependencies: [5, 17, 11258]
// Exports: saveDocuments

// Module 11265 (_saveDocuments)
...
let closure_3 = async function _saveDocuments() {
  ...
  await asyncGeneratorStep(async () => {
    ...
    const NativeDocumentPicker2 = tmp2(11258).NativeDocumentPicker;
    closure_128_0 = await NativeDocumentPicker2.saveDocument(tmp2);
    const NativeDocumentPicker = tmp2(11258).NativeDocumentPicker;
