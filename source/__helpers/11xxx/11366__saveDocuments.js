...
// Function ID: 11367
// Name: _saveDocuments
// Dependencies: [5, 17, 11359]
// Exports: saveDocuments

// Module 11366 (_saveDocuments)
...
let closure_3 = async function _saveDocuments() {
  ...
  await asyncGeneratorStep(async () => {
    ...
    const NativeDocumentPicker2 = tmp2(11359).NativeDocumentPicker;
    closure_128_0 = await NativeDocumentPicker2.saveDocument(tmp2);
    const NativeDocumentPicker = tmp2(11359).NativeDocumentPicker;
