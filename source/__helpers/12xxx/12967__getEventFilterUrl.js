...
// Dependencies: [12948, 12920, 12892, 12903, 12901]

// Module 12967 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod12920.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(12903).getEventDescription(tmp));
      const tmp6Result = tmp6(12903);
    }
    return null;
  }
}
    ...
    processEvent(type, arg1, getOptions) {
      ...
      if (tmp10) {
        if ((function _isSentryError(type) {
          ...
          let flag6 = true;
          if (_mod12920.DEBUG_BUILD) {
            const logger6 = _mod12892.logger;
            const _HermesInternal6 = HermesInternal;
            logger6.warn("Event dropped due to being internal Sentry Error.\nEvent: " + _mod12903.getEventDescription(type));
            flag6 = true;
          }
        }
        let tmp77 = null;
      ...
      if (flag) {
        flag6 = true;
        if (_mod12920.DEBUG_BUILD) {
          const logger5 = _mod12892.logger;
        ...
        if (flag2) {
          flag6 = true;
          if (_mod12920.DEBUG_BUILD) {
            const logger4 = _mod12892.logger;
          ...
          if ("transaction" === type.type) {
            ...
            if (items3.length) {
              ...
              if (result) {
                result = _mod12901.stringMatchesSomePattern(transaction, items3);
              }
              flag3 = result;
            }
          }
          if (flag3) {
            ...
            if (items1.length) {
              ...
              let result1 = tmp16;
              if (result1) {
                result1 = _mod12901.stringMatchesSomePattern(tmp16, items1);
              }
              flag4 = result1;
            }
            if (flag4) {
              ...
              if (_mod12920.DEBUG_BUILD) {
                ...
                const eventDescription = _mod12903.getEventDescription(type);
              ...
              if (items.length) {
                ...
                let result2 = !tmp21;
                if (tmp21) {
                  result2 = _mod12901.stringMatchesSomePattern(tmp21, items);
                }
                flag5 = result2;
              }
              flag6 = false;
              if (!flag5) {
                ...
                if (_mod12920.DEBUG_BUILD) {
                  ...
                  const eventDescription1 = _mod12903.getEventDescription(type);
