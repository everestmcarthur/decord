...
// Module 12906 (_addTracingHeadersToFetchRequest)
import errorCallback from "errorCallback" /* 12797 */;
import SyncPromise from "SyncPromise" /* 12825 */;
...
import consoleSandbox from "consoleSandbox" /* 12801 */;
  ...
  if (fetchData.fetchData) {
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              ...
              obj[0] = setHttpStatus(12818).SPAN_STATUS_ERROR;
              obj10.setStatus(obj);
            }
            endResult = obj10.end();
            delete tmp2[tmp];
    ...
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj1[3] = tmp7;
        obj1[4] = host;
        obj1[setHttpStatus(12816).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj1[setHttpStatus(12816).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj[1] = obj1;
        let startInactiveSpanResult = setHttpStatus(12835).startInactiveSpan(obj);
