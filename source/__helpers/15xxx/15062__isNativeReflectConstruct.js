...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8456, 9880]

// Module 15062 (_isNativeReflectConstruct)
...
import importDefaultResult3 from "emptyFunction" /* 9880 */;
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        obj3[3] = lineCap;
        obj3[4] = mapped1;
        tmp23Result = tmp23(tmp24(8456).Path, obj3);
      }
      ...
      if (tmp23Result) {
        ...
        obj4[3] = fillLineCap;
        obj4[4] = mapped;
        tmp23Result = tmp23(tmp24(8456).Path, obj4);
      }
      items[1] = tmp23Result;
      items[2] = renderCapResult;
      obj2[3] = items;
      obj1[2] = closure_7(CircularProgress(8456).G, obj2);
      const items1 = [closure_6(CircularProgress(8456).Svg, obj1), ];
