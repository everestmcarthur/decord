...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, start, text) {
      const parseDurationResult = ENMergeRelativeAfterDateRefiner(10436).parseDuration(text.text);
      ...
      return new ENMergeRelativeAfterDateRefiner(10440).ParsingResult(reference, index, "" + start.text + arg0 + text.text, relativeFromReference);
    }
  }
];
