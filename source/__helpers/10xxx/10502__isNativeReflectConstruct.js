...
// Dependencies: [41, 42, 93, 95, 98, 10499, 10439, 10440, 10444]
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp("il y a\\s*(" + FRTimeUnitAgoFormatParser(10499).TIME_UNITS_PATTERN + ")(?=(?:\\W|$))", "i");
      return regExp;
    }
  },
  {
    ...
    value: function innerExtract(reference) {
      const parseDurationResult = FRTimeUnitAgoFormatParser(10499).parseDuration(arg1[1]);
      const ParsingComponents = FRTimeUnitAgoFormatParser(10440).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, FRTimeUnitAgoFormatParser(10439).reverseDuration(FRTimeUnitAgoFormatParser(10499).parseDuration(arg1[1])));
    }
  }
];
