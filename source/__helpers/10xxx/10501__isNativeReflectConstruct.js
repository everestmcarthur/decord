...
// Dependencies: [41, 42, 93, 95, 98, 10499, 10437, 10438, 10444]
...
import WEEKDAY_DICTIONARY from "WEEKDAY_DICTIONARY" /* 10499 */;
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10499).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10499).parseOrdinalNumberPattern(index[2]);
