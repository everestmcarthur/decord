...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ParsingComponents.createRelativeFromReference(reference.reference, NLTimeUnitAgoFormatParser(10439).reverseDuration(NLTimeUnitAgoFormatParser(10531).parseDuration(arg1[1])));
    }
  }
];
