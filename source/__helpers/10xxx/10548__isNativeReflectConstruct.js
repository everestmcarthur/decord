...
class ZHHansTimeExpressionParser {
  constructor() {
    self = this;
    tmp = closure_2(this, ZHHansTimeExpressionParser);
    tmp2 = closure_4;
              ...
              if (num38 >= 60) {
                ...
                if (match[9]) {
                  if (rounded1 > 12) {
                    ...
                    parsingResult = match[9][0].toLowerCase();
                    let tmp94 = rounded1;
                    if ("a" == parsingResult) {
                      let num42 = rounded1;
                      if (12 == rounded1) {
