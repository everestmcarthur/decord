...
// Dependencies: [41, 42, 93, 95, 98, 10437, 10581, 10464, 10444]
...
import WEEKDAY_DICTIONARY from "WEEKDAY_DICTIONARY" /* 10581 */;
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(este|esta|pasado|pr[o\u00F3]ximo)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(WEEKDAY_DICTIONARY.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(este|esta|pasado|pr[\u00F3o]ximo)\\s*semana)?(?=\\W|\\d|$)", "i");
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      const tmp4 = ESWeekdayParser(10581).WEEKDAY_DICTIONARY[formatted];
      if (undefined === tmp4) {
        return null;
      } else {
        ...
        return tmp2(10464).createParsingComponentsAtWeekday(reference.reference, tmp4, str5);
      }
      const str = arg1[2];
