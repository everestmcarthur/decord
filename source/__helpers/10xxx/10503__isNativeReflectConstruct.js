...
// Dependencies: [41, 42, 93, 95, 98, 10499, 10440, 10444]

// Module 10503 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp("(?:dans|en|pour|pendant|de)\\s*(" + FRTimeUnitWithinFormatParser(10499).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
      return regExp;
    }
  },
  {
    ...
    value: function innerExtract(reference) {
      const ParsingComponents = FRTimeUnitWithinFormatParser(10440).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, FRTimeUnitWithinFormatParser(10499).parseDuration(arg1[1]));
    }
  }
];
