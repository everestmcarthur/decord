...
let items = [
  obj,
  {
    ...
    value: function __getValue() {
      ...
      const f107499 = (__getValue) => __getValue.__getValue();
      return _transforms.map((obj) => {
        ...
        for (const key10006 in arg0) {
          ...
          if (arr instanceof f107502(closure_1_1[6])) {
            let tmp4 = f107502;
            obj[key10006] = f107502(arr);
            continue;
          } else {
            let _Array = Array;
            if (Array.isArray(arr)) {
              ...
              if (typeof arr === "object") {
                ...
                for (const key10013 in arr) {
                  ...
                  let tmp3 = tmp9;
                  if (tmp9 instanceof f107502(closure_1_1[6])) {
                    let tmp2 = f107502;
                    tmp3 = f107502(tmp9);
                  }
                  obj[key10013] = tmp3;
  ...
  },
  {
    ...
    value: function __getValueWithStaticTransforms(arr) {
      ...
      const _transforms = this._transforms;
      f107501 = (__getValue) => {
        f107501.push(__getValue.__getValue());
      };
  ...
  },
  {
    ...
    value: function __getAnimatedValue() {
      const _transforms = this._transforms;
      const f107502 = (__getAnimatedValue) => __getAnimatedValue.__getAnimatedValue();
      return _transforms.map((obj) => {
        obj = {};
        for (const key10006 in arg0) {
          let tmp5 = key10006;
