...
// Dependencies: [32, 5, 5365, 5630, 7571, 7572, 7792, 7794, 7707, 5590, 4662, 502, 1958, 7795, 1980, 4624, 4861, 4278, 4680, 4655, 7801, 1372, 1074, 7803, 7440, 4633, 17, 3, 4623, 7804, 4628, 7807, 7808, 4820, 7813, 5537, 7832, 1241, 4625, 7855, 7858, 4879, 7860, 1115, 2025, 5216, 573, 7872, 4825, 7873, 7714, 1271, 4863, 7335, 9, 7602, 5360, 11, 1987, 2007, 7591, 5363, 7874, 7875, 7879, 7880, 4297, 7798, 1385, 7381, 7881, 7950, 7954, 7957, 7963, 7964, 7968, 5631, 1091, 8075, 1895, 7885, 4491, 10893, 4984, 2]

// Module 7570 (MessageActionCreators)
...
import MessageCacheStatsDefault from "MessageCacheStats" /* 7602 */;
import ExplicitMediaRedactionUtils from "ExplicitMediaRedactionUtils" /* 7714 */;
import createMessage from "createMessage" /* 7872 */;
...
import PremiumGiftingIntentActionCreators from "PremiumGiftingIntentActionCreators" /* 10893 */;
...
import MessageRoundtripTrackerStore from "MessageRoundtripTrackerStore" /* 7572 */;
...
function trackInvite(channelId) {
  ...
  if (result1) {
    result1 = tmp3(7855).isEmbeddedApplicationInvite(invite);
    const tmp3Result = tmp3(7855);
  }
  let id1;
  if (invite != null) {
  ...
  if (tmp8) {
    const result2 = tmp3(7808).trackAppEmbedLinkSent(id1, LinkType.ACTIVITY_INVITE, id);
    const tmp3Result5 = tmp3(7808);
  }
  ...
  if (null != channel1) {
        ...
        if (null != invite.channel) {
          ...
          if (null != lastActiveStream) {
            ...
            if (lastActiveStream.channelId === channel.id) {
              ...
              const streamerApplication = tmp3(7858).getStreamerApplication(lastActiveStream, PresenceStore);
              let id3 = null;
    ...
    let inviteInstanceId = tmp3(4625).getInviteInstanceId(result.baseCode, messageId);
    ...
    if (tmp12) {
      ...
      let inviteInstanceId1 = tmp3(4625).getInviteInstanceId(result.baseCode, messageId);
...
const SlowmodeType = fn(7801).SlowmodeType;
...
const LinkType = fn(7803).LinkType;
const GuildTemplateStates = fn(7440).GuildTemplateStates;
const MessageConstants = fn(4633);
...
let obj17 = {
  ...
  sendExplicitMediaClydeError(c0, attachments, EXPLICIT_MEDIA_ADD_MEDIA_TO_FORUM_POST_BLOCKED) {
    ...
    if (null != channel) {
      ...
      const match = _mod4825.match(obj);
        ...
        try {
          ...
          if (0 === c2) {
            ...
            if (closure_128_0.body.length > 0) {
              dependencyMap = 3;
              const obj7 = { value: v0(4863).createMessageRecord(closure_128_0.body[0]), done: true };
              return obj7;
            } else {
              dependencyMap = 3;
              return { value: "HermesInternal", done: null };
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const orCreate = tmp2(5360).getOrCreate(closure_0);
              const obj13 = tmp2(5360);
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != databaseResult) {
                if (null != basicChannel) {
                  orCreate = tmp2(5360).getOrCreate(closure_0);
                  if (!orCreate.hasMoreAfter) {
                    c2 = 1;
                    dependencyMap = 1;
                    const obj6 = { value: v0(2007).tryLoadAsync(async () => closure_1(7591).load(closure_1_1, c0, closure_1)), done: false };
                    return obj6;
                  }
                  const obj2 = tmp2(5360);
                }
              }
              dependencyMap = 3;
            ...
            if (null != closure_128_3) {
              orCreate = tmp2(5360).getOrCreate(closure_129_0);
              ...
              if (0 !== closure_128_5.length) {
                ...
                const obj8 = tmp2(573);
                obj9.isForegroundCacheLoad = v0(5363).isIOSPushNotificationRawPayloadFixExperimentEnabled();
                obj8.dispatch(obj9);
                const obj10 = v0(5363);
              }
              const obj7 = tmp2(5360);
            }
          }
          dependencyMap = 3;
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (tmp2.reaction) {
                ...
                dependencyMap = 1;
                c4 = 1;
                const obj6 = { value: tmp2(7874)(closure_0), done: false };
                return obj6;
              }
            }
          } else if (arg0 === 1) {
            ...
            if (null != closure_129_0) {
              ...
              closure_0 = nonce;
              if (nonce == null) {
                closure_0 = closure_0(7873).createNonce();
                const obj = closure_0(7873);
              }
              ...
              closure_130_3 = obj9;
              closure_129_2 = tmp2(7875).backgroundify(function _trySend() {
              ...
              if (ready.isReady(closure_130_0)) {
                ...
                if (closure_130_2) {
                  if (closure_130_0 !== closure_0(7335).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) {
                    const _HermesInternal = HermesInternal;
          ...
          if (null != closure_131_10) {
            ...
            const promise2 = new Promise((arg0, arg1) => {
              ...
              emojiUsed(inviteAnalyticsMetadata[72]).enqueue(channel, (ok) => {
                if (ok.ok) {
                  id(7880).donateSentMessage(content, channelId);
                  ...
                  if (null != request) {
                    ...
                    let result = closure_0(5631).trackMemberApplicationInterviewMessage(obj7);
                    let obj19 = closure_0(5631);
                  }
                  ...
                  if (closure_2_13 === constants3.REPLY) {
                    ...
                    if ("message_swipe" === pendingReplyActionSource) {
                      ...
                      let merged = Object.assign(closure_0(4820).collectGuildAnalyticsMetadata(guild_id2));
                      const obj21 = closure_0(4820);
                      let merged1 = Object.assign(closure_0(4820).collectChannelAnalyticsMetadata(channel1));
                      obj39.track(constants2.MESSAGE_SHORTCUT_ACTION_SENT, obj11);
                      const obj22 = closure_0(4820);
                    }
                  }
                  const obj18 = id(11);
                  ...
                  const id2 = id.getId();
                  const obj31 = id(573);
                  const item = id(4623)(content).forEach((url) => {
                    ({ type, code } = url);
                  ...
                  const arr2 = id(4623)(content);
                  const obj35 = closure_0(4879);
                  const item1 = closure_0(4879).findGiftCodes(content).forEach((gift_code) => {
                  ...
                  if (null != c2.gifMetadata) {
                    ...
                    if (null != channel2) {
                      ...
                      const obj41 = id(1241);
                      const merged2 = Object.assign(closure_0(4820).collectGuildAnalyticsMetadata(channel2.getGuildId()));
                      const obj43 = closure_0(4820);
                      const merged3 = Object.assign(closure_0(4820).collectChannelAnalyticsMetadata(channel2));
                      obj41.track(constants2.MESSAGE_SENT_WITH_GIF, obj28);
                      const obj44 = closure_0(4820);
                    }
                  }
                  ...
                  closure_0(ok);
                  const findGiftCodesResult = closure_0(4879).findGiftCodes(content);
                } else {
                      ...
                      if (ok.status < 500) {
                        ...
                        if (ok.body) {
                          if (ok.body.code === constants.SLOWMODE_RATE_LIMITED) {
                            ...
                            const AUTOMOD_ERROR_CODES = closure_0(8075).AUTOMOD_ERROR_CODES;
                  ...
                  if (flag) {
                    ...
                    if (!hasErr) {
                      ...
                      let result2 = closure_4_55.sendExplicitMediaClydeError(channelId, attachments1, closure_0(7714).TrackMediaRedactionContext.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED);
                    }
                    ...
                    let result3 = closure_0(7963).logMessageSendFailure(obj40);
                    const obj12 = closure_0(7963);
                    let result4 = id(7954).cancelPendingSendRequests(channelId);
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              dependencyMap = 1;
              const obj5 = { value: tmp2(7885).unarchiveThreadIfNecessary(tmp3), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
            ...
            closure_128_2 = obj6;
            const obj8 = { type: tmp3(7954).MessageDataType.EDIT, message: closure_128_2 };
            tmp2(7954).enqueue(obj8, (hasErr) => {
              hasErr = hasErr.hasErr;
              let hasItem = !hasErr;
              if (!hasErr) {
                const AUTOMOD_ERROR_CODES = channelId(8075).AUTOMOD_ERROR_CODES;
                hasItem = AUTOMOD_ERROR_CODES.has(hasErr.body.code);
              }
              if (hasItem) {
                const obj = { type: channelId(7954).MessageDataType.EDIT, message };
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              dependencyMap = 1;
              const obj5 = { value: tmp5(7885).unarchiveThreadIfNecessary(tmp2), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              c2 = 1;
              const obj5 = { value: v1(7885).unarchiveThreadIfNecessary(tmp4), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c2 = 3;
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (flag) {
                ...
                c2 = 1;
                dependencyMap = 1;
                const obj5 = { value: id(7885).unarchiveThreadIfNecessary(channelId), done: false };
                return obj5;
              }
            }
          } else if (arg0 === 1) {
