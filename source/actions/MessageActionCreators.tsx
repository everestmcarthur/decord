...
import getUncachedChannelPermissionsDefault from "getUncachedChannelPermissions" /* 4199 */;
...
import closure_8 from "handleGuildTemplateResolveSuccess" /* 7457 */;
import closure_9 from "trackRoundtrip" /* 7458 */;
import closure_10 from "initialize" /* 7678 */;
import closure_11 from "getState" /* 7680 */;
import closure_12 from "processMessage" /* 7595 */;
import { ReferencedMessageState } from "processMessage" /* 7595 */;
import closure_14 from "loadSavedGuildStickers" /* 5502 */;
import closure_15 from "reset" /* 4582 */;
import closure_16 from "fetchFingerprint" /* 502 */;
import closure_17 from "ensureGuildLoaded" /* 1957 */;
import closure_18 from "initialize" /* 7681 */;
import closure_19 from "createGuildRecordFromRust" /* 1979 */;
import closure_20 from "updateInvite" /* 4544 */;
import closure_21 from "reinjectEphemerals" /* 4781 */;
import closure_22 from "sortActivity" /* 4600 */;
import closure_23 from "generateOldThreadCutoff" /* 4575 */;
import { SlowmodeType } from "setCooldown" /* 7687 */;
import closure_25 from "mergeGuildAvatar" /* 1371 */;
...
let obj14 = {
  ...
  sendGreetMessage(id, closure_1_14, sendMessageOptionsForReply) {
    ...
    obj = { url: closure_28.MESSAGES_GREET(id), body: { sticker_ids: items, allowed_mentions: allowedMentions, message_reference: messageReference }, oldFormErrors: true, rejectWithError: _require(1272).rejectWithMigratedError(), context: null };
    items = [closure_1_14];
