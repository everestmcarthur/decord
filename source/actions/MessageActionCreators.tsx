...
// Dependencies: [32, 5, 5329, 5594, 7531, 7532, 7751, 7753, 7668, 5554, 4629, 502, 1957, 7754, 1979, 4591, 4828, 4245, 4647, 4622, 7760, 1371, 1074, 7762, 7400, 4600, 17, 3, 4590, 7763, 4595, 7766, 7767, 4787, 7772, 5501, 7791, 1242, 4592, 7808, 7811, 4846, 7813, 1114, 2024, 5181, 573, 7825, 4792, 7826, 7673, 1272, 4830, 7295, 9, 7562, 5324, 11, 1986, 2006, 7551, 5327, 7827, 7828, 7832, 7833, 4264, 7757, 1384, 7341, 7834, 7903, 7907, 7910, 7916, 7917, 7921, 11782, 5595, 1090, 8014, 1894, 7838, 4458, 10835, 4951, 2]

// Module 7530 (MessageActionCreators)
...
import MessageCacheStatsDefault from "MessageCacheStats" /* 7562 */;
import ExplicitMediaRedactionUtils from "ExplicitMediaRedactionUtils" /* 7673 */;
import createMessage from "createMessage" /* 7825 */;
...
import PremiumGiftingIntentActionCreators from "PremiumGiftingIntentActionCreators" /* 10835 */;
...
import GuildTemplateStore from "GuildTemplateStore" /* 7531 */;
import MessageRoundtripTrackerStore from "MessageRoundtripTrackerStore" /* 7532 */;
import PoggermodeSettingsStore from "PoggermodeSettingsStore" /* 7751 */;
...
function trackInvite(channelId) {
  ...
  if (result1) {
    result1 = tmp3(7808).isEmbeddedApplicationInvite(invite);
    const tmp3Result = tmp3(7808);
  }
  let id1;
  if (invite != null) {
  ...
  if (tmp8) {
    const result2 = tmp3(7767).trackAppEmbedLinkSent(id1, LinkType.ACTIVITY_INVITE, id);
    const tmp3Result5 = tmp3(7767);
  }
  ...
  if (null != channel1) {
        ...
        if (null != invite.channel) {
          ...
          if (null != lastActiveStream) {
            ...
            if (lastActiveStream.channelId === channel.id) {
              ...
              const streamerApplication = tmp3(7811).getStreamerApplication(lastActiveStream, PresenceStore);
              let id3 = null;
    ...
    let inviteInstanceId = tmp3(4592).getInviteInstanceId(result.baseCode, messageId);
    ...
    if (tmp12) {
      ...
      let inviteInstanceId1 = tmp3(4592).getInviteInstanceId(result.baseCode, messageId);
...
const LinkType = fn(7762).LinkType;
...
let obj17 = {
  ...
  sendClydeError(id, code) {
    ...
    if (null != channel) {
      if (null != closure_54[num]) {
        obj17.sendBotMessage(id, obj.messageGetter(channel), obj.messageName);
      } else {
        const intl = util.intl;
        const obj2 = { helpUrl: HelpdeskUtilsDefault.getArticleURL(constants7.DM_COULD_NOT_BE_DELIVERED) };
        const _HermesInternal = HermesInternal;
        obj17.sendBotMessage(id, intl.formatToPlainString(util.t.SkGL7l, obj2), "SEND_FAILED (" + num + ")");
  ...
  sendExplicitMediaClydeError(channelId, attachments, EXPLICIT_MEDIA_ADD_MEDIA_TO_FORUM_POST_BLOCKED) {
    ...
    if (null != channel) {
      ...
      const match = _mod4792.match(obj);
      ...
      const obj3 = { action: ExplicitMediaRedactionUtils.TrackMediaRedactionActionType.EXPLICIT_MEDIA_FALSE_POSITIVE_CLYDE_MESSAGE_SENT, messageId: nonce, channelId, context: EXPLICIT_MEDIA_ADD_MEDIA_TO_FORUM_POST_BLOCKED };
      ...
      if (tmp) {
        const obj4 = { type: "MESSAGE_EXPLICIT_CONTENT_FP_CREATE", messageId: nonce, channelId, attachments };
        ...
        try {
          ...
          if (0 === c2) {
            ...
            if (closure_128_0.body.length > 0) {
              dependencyMap = 3;
              const obj7 = { value: v0(4830).createMessageRecord(closure_128_0.body[0]), done: true };
              return obj7;
            } else {
              dependencyMap = 3;
              return { value: "HermesInternal", done: null };
        ...
        if (typeof RemoteFetch === "function") {
          ...
          return value.then((result) => {
            ...
            dispatchMessages.measure(() => {
              ...
              const obj2 = { type: "LOAD_MESSAGES_SUCCESS", channelId, messages: body, isBefore: null != before, isAfter: null != after, hasMoreBefore: tmp12, hasMoreAfter: flag3, limit, jump, forICYMI, isStale: null, truncate: null, avoidInitialScroll: null };
              let tmp19 = !closure_9;
              if (closure_9) {
              ...
              const result = MessageCacheStatsDefault.recordChannelFetchedNetwork(tmp15, tmp23, tmp, tmp3, tmp18, body);
            });
            return true;
          }, () => {
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const orCreate = tmp2(5324).getOrCreate(closure_0);
              const obj13 = tmp2(5324);
                ...
                if (null != basicChannel) {
                  if (null == closure_2) {
                    if (null == closure_3) {
                      ...
                      c2 = 1;
                      dependencyMap = 1;
                      const obj10 = { value: num2(2006).tryLoadAsync(async () => closure_1(closure_3[60]).load(closure_1_1, num2, limit)), done: false };
                      return obj10;
                    }
                    dependencyMap = 3;
                  }
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != databaseResult) {
                if (null != basicChannel) {
                  orCreate = tmp2(5324).getOrCreate(closure_0);
                  if (!orCreate.hasMoreAfter) {
                    c2 = 1;
                    dependencyMap = 1;
                    const obj6 = { value: v0(2006).tryLoadAsync(async () => closure_1(7551).load(closure_1_1, c0, closure_1)), done: false };
                    return obj6;
                  }
                  const obj2 = tmp2(5324);
                }
              }
              dependencyMap = 3;
            ...
            if (null != closure_128_3) {
              orCreate = tmp2(5324).getOrCreate(closure_129_0);
              ...
              if (0 !== closure_128_5.length) {
                ...
                const obj8 = tmp2(573);
                obj9.isForegroundCacheLoad = v0(5327).isIOSPushNotificationRawPayloadFixExperimentEnabled();
                obj8.dispatch(obj9);
                const obj10 = v0(5327);
              }
              const obj7 = tmp2(5324);
            }
          }
          dependencyMap = 3;
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (tmp2.reaction) {
                ...
                dependencyMap = 1;
                c4 = 1;
                const obj6 = { value: tmp2(7827)(closure_0), done: false };
                return obj6;
              }
            }
          } else if (arg0 === 1) {
            ...
            if (null != closure_129_0) {
              ...
              closure_0 = nonce;
              if (nonce == null) {
                closure_0 = closure_0(7826).createNonce();
                const obj = closure_0(7826);
              }
              ...
              closure_130_3 = obj9;
              closure_129_2 = tmp2(7828).backgroundify(function _trySend() {
              ...
              if (ready.isReady(closure_130_0)) {
                ...
                if (closure_130_2) {
                  if (closure_130_0 !== closure_0(7295).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) {
                    const _HermesInternal = HermesInternal;
  ...
  getSendMessageOptions(pendingReply) {
    ...
    const merged6 = Object.assign(obj17.getSendMessageOptionsForAlsoForwardToChannel({}));
    return {};
  },
        ...
        try {
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              const promise = nonce(tmp5[62])(channelId);
              if (null != promise) {
                ...
                if (tmp97[0]) {
                  closure_131_0 = tmp98;
                  addFlagResult = channelId(tmp5[68]).addFlag(tmp93, constants3.SUPPRESS_NOTIFICATIONS);
                  tmp100 = tmp98;
                ...
                if (obj14.canSendGuildOfficialMessages(guild, channel, "_sendMessage")) {
                  addFlagResult1 = channelId(tmp5[68]).addFlag(addFlagResult, constants3.IS_GUILD_OFFICIAL);
                ...
                nonce = publish.nonce;
                if (nonce == null) {
                  nonce = channelId(tmp5[49]).createNonce();
                ...
                if (!c51) {
                  if (null != invalidEmojis) {
                    if (invalidEmojis.length > 0) {
                      c51 = true;
                      const validateMessageResult = obj17.validateMessage(invalidEmojis, authStore.getCurrentUser(), channelId);
                ...
                let obj12 = { channelId, content: tmp100, nonce, tts: tmp75, message_reference: messageReference, allowed_mentions: allowedMentions, flags: addFlagResult1, analyticsLocation: _location };
                obj11.message = obj12;
            ...
            if (arg0 === 1) {
              ...
              if (null == closure_131_18) {
                ...
                if (null != attachments2) {
                  closure_131_17.message.attachments = attachments2.map((item, index) => channelId(5181).getAttachmentPayload(item, index));
                }
                c6 = 0;
              }
            }
            ...
            if (null != uploader) {
              ...
              nonce(tmp5[46]).dispatch(obj29);
              let obj6 = nonce(tmp5[46]);
            }
            ...
            if (null != uploader) {
              ...
              nonce(tmp5[46]).dispatch(obj31);
              let obj = nonce(tmp5[46]);
            }
          ...
          if (null != closure_131_10) {
            ...
            const promise2 = new Promise((content, emojiUsed) => {
              closure_2 = Date.now();
              emojiUsed(7907).length;
              const rounded = Math.floor(10000 * Math.random());
              logger2.info("Queueing message to be sent LogId:" + rounded);
              emojiUsed(7907).enqueue(messageData, (ok) => {
                content = ok;
                if (ok.ok) {
                  emojiUsed(length[65]).donateSentMessage(content, channelId);
                  let obj4 = { sendAnalytics: null, poll: null };
                  let obj5 = { duration: tmp, queueSize: channel3 };
                  obj4.sendAnalytics = obj5;
                  obj4.poll = poll;
                  closure_3_55.receiveMessage(channelId, ok.body, true, obj4);
                  if (null != publish.alsoForwardToChannelId) {
                    const obj18 = emojiUsed(length[77]);
                    let obj19 = content(length[52]);
                    const sendForwardResult = obj18.sendForward(content(length[52]).createMessageRecord(ok.body), publish.alsoForwardToChannelId);
                    obj18.sendForward(content(length[52]).createMessageRecord(ok.body), publish.alsoForwardToChannelId).then(() => {
                    ...
                    const nextPromise = obj18.sendForward(content(length[52]).createMessageRecord(ok.body), publish.alsoForwardToChannelId).then(() => {
                      const body = closure_0.body;
                      id = undefined;
                      if (body != null) {
                        id = body.id;
                  ...
                  const obj15 = emojiUsed(length[65]);
                  ...
                  if (null != request) {
                    ...
                    let result = content(length[78]).trackMemberApplicationInterviewMessage(obj7);
                  ...
                  if (closure_1_13 === constants4.REPLY) {
                    ...
                    if ("message_swipe" === pendingReplyActionSource) {
                      ...
                      let obj9 = { message_id: id, channel_id: tmp174, guild_id: null, swipe_action: "reply", is_own_message: null };
                      let guild_id;
                      if (channel != null) {
                        guild_id = channel.guild_id;
                      }
                      ...
                      emojiUsed(length[37]).track(constants2.MESSAGE_SWIPE_ACTION_SENT, obj9);
                      ...
                      const obj11 = { message_id: id, channel_id: tmp174, guild_id: null, original_message_id: null, action: "reply" };
                      let guild_id1;
                      if (channel1 != null) {
                      ...
                      obj41.track(constants2.MESSAGE_SHORTCUT_ACTION_SENT, obj11);
                      const obj24 = content(length[33]);
                    }
                  }
                  const obj20 = emojiUsed(length[57]);
                  const obj13 = { type: "SLOWMODE_RESET_COOLDOWN", slowmodeType: closure_3_24.SendMessage, channelId };
                  emojiUsed(length[46]).dispatch(obj13);
                  const obj27 = emojiUsed(length[46]);
                  const obj16 = { type: "EMOJI_TRACK_USAGE", emojiUsed };
                  emojiUsed(length[46]).dispatch(obj16);
                  const obj29 = emojiUsed(length[46]);
                  obj17 = { type: "STICKER_TRACK_USAGE", stickerIds: rounded };
                  emojiUsed(length[46]).dispatch(obj17);
                  const obj31 = emojiUsed(length[46]);
                  const obj22 = { type: "LOCAL_MESSAGE_CREATE", message: null };
                  const obj26 = { channel_id: channelId, author: authStore.getCurrentUser() };
                  obj22.message = obj26;
                  emojiUsed(length[46]).dispatch(obj22);
                  const obj28 = { content, channelId, messageId: ok.body.id, location: null, inviteAnalyticsMetadata: null };
                  ...
                  obj28.location = str5;
                  obj28.inviteAnalyticsMetadata = length;
                  ({ channelId: closure_0, messageId: id, location: attachments, inviteAnalyticsMetadata: channel3, overrideProperties, content } = obj28);
                  if (overrideProperties === undefined) {
                    overrideProperties = {};
                  }
                  const id2 = id.getId();
                  ...
                  const item = emojiUsed(length[28])(content).forEach((url) => {
                    ...
                    if (obj.isApplicationCodedLink(type)) {
                      ...
                      const obj4 = { inviteKey: code, channelId, messageId: id, location: attachments, inviteAnalyticsMetadata: channel3, overrideProperties };
                      closure_2_53(obj4);
                      ...
                      if (null != guildTemplate) {
                        if (guildTemplate.state !== constants3.RESOLVING) {
                          const obj5 = { guild_template_code: code, guild_template_name: null, guild_template_description: null, guild_template_guild_id: null };
                          ...
                          id(tmp2[33]).trackWithMetadata(closure_2_27.GUILD_TEMPLATE_LINK_SENT, obj5);
                                  ...
                                  if (tmp(tmp2[30]).CodedLinkType.SOCIAL_LAYER_STOREFRONT !== type) {
                                    if (tmp(tmp2[30]).CodedLinkType.SOCIAL_LAYER_STOREFRONT_APP !== type) {
                                      if (tmp(tmp2[30]).CodedLinkType.QUESTS_EMBED === type) {
                                        ...
                                        const obj6 = { questId: code, event: closure_2_27.QUEST_LINK_SHARED, properties: null, trackGuildAndChannelMetadata: true, sourceQuestContent: null };
                                        let tmp8 = null;
                                        if (null != adMetadataSealed) {
                                          tmp8 = adMetadataSealed;
                                        }
                                        const obj7 = { metadata_sealed: tmp8 };
                                        obj6.properties = obj7;
                                        obj6.sourceQuestContent = tmp(tmp2[35]).QuestContent.QUESTS_EMBED;
                                        tmp(tmp2[36]).trackQuestEvent(obj6);
                                        const tmpResult18 = tmp(tmp2[36]);
                                      } else if (tmp(tmp2[30]).CodedLinkType.GAME_PROFILE === type) {
                                        const obj8 = { game_id: code };
                                        id(tmp2[37]).track(closure_2_27.GAME_PROFILE_LINK_EMBED_SENT, obj8);
                                        const obj2 = id(tmp2[37]);
                  ...
                  if (null != publish.gifMetadata) {
                    ...
                    if (null != channel2) {
                      const obj30 = { location: str4, message_id: ok.body.id, gif_provider: null, load_id: null, source_object: null, gif_url: null, gif_id: null };
                      ...
                      obj43.track(constants2.MESSAGE_SENT_WITH_GIF, obj30);
                  ...
                  if (null != closure_1_16) {
                    const obj32 = { type: "UPLOAD_COMPLETE", channelId, file: closure_1_16._file, aborted: false };
                    emojiUsed(length[46]).dispatch(obj32);
                      ...
                      if (ok.status < 500) {
                        ...
                        if (ok.body) {
                          if (ok.body.code === constants.SLOWMODE_RATE_LIMITED) {
                            ...
                            flag = false;
                            if (tmp21) {
                              const obj34 = { type: "SLOWMODE_SET_COOLDOWN", channelId, slowmodeType: closure_3_24.SendMessage, cooldownMs: retry_after * emojiUsed(length[79]).Millis.SECOND };
                              emojiUsed(length[46]).dispatch(obj34);
                              flag = false;
                              let obj6 = emojiUsed(length[46]);
                            }
                          } else {
                            const AUTOMOD_ERROR_CODES = content(length[80]).AUTOMOD_ERROR_CODES;
                            if (AUTOMOD_ERROR_CODES.has(ok.body.code)) {
                              const obj35 = { type: "MESSAGE_SEND_FAILED_AUTOMOD", messageData, errorResponseBody: null };
                              const obj36 = { code: ok.body.code, message: ok.body.message };
                              obj35.errorResponseBody = obj36;
                              emojiUsed(length[46]).dispatch(obj35);
                              flag = false;
                              let obj3 = emojiUsed(length[46]);
                            } else if (ok.body.code === tmp6.POGGERMODE_TEMPORARILY_DISABLED) {
                              emojiUsed(length[46]).dispatch({ type: "POGGERMODE_TEMPORARILY_DISABLED" });
                              flag = false;
                              let obj2 = emojiUsed(length[46]);
                  ...
                  if (flag) {
                    ...
                    if (null != closure_1_16) {
                      const obj38 = { type: "UPLOAD_FAIL", channelId, file: closure_1_16._file, messageId, reason: EXPLICIT_CONTENT, noSendFailed: true };
                      emojiUsed(length[46]).dispatch(obj38);
                      let obj8 = emojiUsed(length[46]);
                    }
                    ...
                    const obj40 = { type: "MESSAGE_SEND_FAILED", messageId, channelId, shouldNotify: !publish.doNotNotifyOnError, reason: EXPLICIT_CONTENT };
                    emojiUsed(length[46]).dispatch(obj40);
                    const obj10 = emojiUsed(length[46]);
                    let status;
                    if (!ok.hasErr) {
                      status = ok.status;
                    }
                    const obj42 = { failureCode: status, errorMessage: null };
                    let message1;
                    if (ok.hasErr) {
                      message1 = ok.err.message;
                    }
                    obj42.errorMessage = message1;
                    let result3 = content(length[74]).logMessageSendFailure(obj42);
                    const obj12 = content(length[74]);
                    let result4 = emojiUsed(length[72]).cancelPendingSendRequests(channelId);
                    ...
                    const obj14 = emojiUsed(length[72]);
                  }
                  id(ok);
                }
              }, rounded);
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              dependencyMap = 1;
              const obj5 = { value: tmp2(7838).unarchiveThreadIfNecessary(tmp3), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
            ...
            closure_128_2 = obj6;
            const obj8 = { type: tmp3(7907).MessageDataType.EDIT, message: closure_128_2 };
            tmp2(7907).enqueue(obj8, (hasErr) => {
              hasErr = hasErr.hasErr;
              let hasItem = !hasErr;
              if (!hasErr) {
                const AUTOMOD_ERROR_CODES = channelId(8014).AUTOMOD_ERROR_CODES;
                hasItem = AUTOMOD_ERROR_CODES.has(hasErr.body.code);
              }
              if (hasItem) {
                const obj = { type: channelId(7907).MessageDataType.EDIT, message };
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              dependencyMap = 1;
              const obj5 = { value: tmp5(7838).unarchiveThreadIfNecessary(tmp2), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              c2 = 1;
              const obj5 = { value: v1(7838).unarchiveThreadIfNecessary(tmp4), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c2 = 3;
            ...
            if (arg0 === 1) {
              ...
              if (flag) {
                (function dispatchDelete() {
                  ...
                  id(573).dispatch({ type: "MESSAGE_DELETE", id, channelId }).then(() => {
                    const AccessibilityAnnouncer = channelId(4458).AccessibilityAnnouncer;
                    const intl = channelId(1114).intl;
                ...
                c2 = 1;
                dependencyMap = 1;
                const obj5 = { value: id(7838).unarchiveThreadIfNecessary(channelId), done: false };
                return obj5;
              }
            }
          } else if (arg0 === 1) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            if (429 === closure_128_1.status) {
              ...
              let formatToPlainStringResult = intl2.formatToPlainString(channel(1114).t["77cuqz"], obj7);
            } else {
            ...
            obj8.title = intl3.string(channel(1114).t.Vd1hs6);
            obj8.body = closure_128_0;
            const intl4 = channel(1114).intl;
            obj8.confirmText = intl4.string(channel(1114).t.BddRzS);
            tmp3(4951).show(obj8);
            c5 = 3;
            const obj4 = tmp3(4951);
          } else if (arg0 === 1) {
            c5 = 3;
            throw value;
          } else if (arg0 === 2) {
