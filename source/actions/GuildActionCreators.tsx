...
// Dependencies: [109, 5, 5573, 502, 5491, 2012, 1979, 2011, 4428, 1371, 1074, 1098, 4951, 1114, 573, 5574, 1272, 5577, 7169, 1896, 7285, 7286, 7291, 7321, 7395, 4800, 1250, 7396, 4250, 1086, 7397, 4287, 1242, 7401, 1100, 4818, 7403, 2]

// Module 5572 (GuildActionCreators)
...
import LurkerActionCreators from "LurkerActionCreators" /* 7395 */;
import GuildTemplateTooltipActionCreatorsDefault from "GuildTemplateTooltipActionCreators" /* 7397 */;
import getPreviousSafeRouteForNsfwReturnDefault from "getPreviousSafeRouteForNsfwReturn" /* 7401 */;
...
export default {
        ...
        try {
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              obj5.colors = obj6;
              obj5.permissions = primary_color(4250).NONE;
              c6 = 1;
              const HTTP = color(1272).HTTP;
              const request = { url: closure_1_16.GUILD_ROLES(closure_0), oldFormErrors: true, body: obj5, rejectWithError: color(1272).rejectWithMigratedError() };
              c7 = 2;
              c8 = 1;
            ...
            const tmp30 = new obj6(4287)(closure_131_2);
            throw tmp30;
          } else if (arg0 === 1) {
            c8 = 3;
            throw value;
            ...
            const result = obj6(7397).checkGuildTemplateDirty(closure_132_0);
            c6 = 0;
            c8 = 3;
  ...
  updateRole(id, id2, arg2) {
    ...
    return (async () => {
      ...
      const result = tmp2(7397).checkGuildTemplateDirty(closure_129_0);
  ...
  batchChannelUpdate(arg0, arg1) {
    ...
    return (async () => {
      ...
      closure_128_0 = await HTTP.patch(request);
      const result = body(7397).checkGuildTemplateDirty(closure_129_0);
      return closure_128_0;
    })();
  },
        ...
        if (null != defaultChannel) {
          if (!obj3.isChannelContentGated(defaultChannel)) {
            if (!tmp11Result.isChannelSpoilerGated(defaultChannel)) {
              tmp11(1100).transitionTo(__initData.CHANNEL(guildId, defaultChannel.id));
              const tmp11Result2 = tmp11(1100);
            }
            tmp11Result = tmp11(7403);
          }
          obj3 = AgeGateUtils;
        }
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              let body;
              const obj4 = { url: closure_1_16.GUILD_APPLICATIONS(tmp5), oldFormErrors: true, rejectWithError: tmp5(1272).rejectWithMigratedError() };
              if (null != tmp2) {
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              const request = { url: closure_1_16.GUILD_BANS(guildId), oldFormErrors: true, query: obj5, rejectWithError: v3(1272).rejectWithMigratedError() };
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              const HTTP = v3(1272).HTTP;
              const request = { url: closure_1_16.GUILD_BANS_SEARCH(guildId), oldFormErrors: true, query: obj5, rejectWithError: v3(1272).rejectWithMigratedError() };
              value = HTTP.get(request);
              c1 = 1;
              v3 = 1;
              const obj6 = {
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              const HTTP = v3(1272).HTTP;
              const obj4 = { url: closure_1_16.GUILD_BANS(closure_0), oldFormErrors: true, rejectWithError: v3(1272).rejectWithMigratedError() };
              value = HTTP.get(obj4);
              c1 = 1;
              v3 = 1;
              const obj5 = {
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              const HTTP = v3(1272).HTTP;
              const obj4 = { url: closure_1_16.GUILD_ROLE_CONNECTIONS_ASSIGN(closure_0, closure_1), oldFormErrors: true, rejectWithError: v3(1272).rejectWithMigratedError() };
              c1 = 1;
              v3 = 1;
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              const HTTP = v3(1272).HTTP;
              const obj4 = { url: closure_1_16.GUILD_ROLE_CONNECTIONS_UNASSIGN(closure_0, closure_1), oldFormErrors: true, rejectWithError: v3(1272).rejectWithMigratedError() };
              c1 = 1;
              v3 = 1;
              const obj5 = { value: HTTP.post(obj4), done: false };
              return obj5;
