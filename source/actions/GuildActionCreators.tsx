...
// Dependencies: [109, 5, 5691, 502, 5609, 2013, 1980, 2012, 4543, 1372, 1074, 1099, 5066, 1115, 573, 5692, 1271, 5695, 7291, 1897, 7407, 7408, 7413, 7443, 7517, 4915, 1249, 7518, 4366, 1086, 7519, 4403, 1241, 7523, 1101, 4933, 7525, 2]

// Module 5690 (GuildActionCreators)
...
import LurkerActionCreators from "LurkerActionCreators" /* 7517 */;
import GuildTemplateTooltipActionCreatorsDefault from "GuildTemplateTooltipActionCreators" /* 7519 */;
import getPreviousSafeRouteForNsfwReturnDefault from "getPreviousSafeRouteForNsfwReturn" /* 7523 */;
...
export default {
        ...
        try {
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              obj5.colors = obj6;
              obj5.permissions = primary_color(4366).NONE;
              c6 = 1;
            ...
            const tmp30 = new obj6(4403)(closure_131_2);
            throw tmp30;
          } else if (arg0 === 1) {
            c8 = 3;
            throw value;
            ...
            const result = obj6(7519).checkGuildTemplateDirty(closure_132_0);
            c6 = 0;
            c8 = 3;
  ...
  updateRole(id, id2, arg2) {
    ...
    return (async () => {
      ...
      const result = tmp2(7519).checkGuildTemplateDirty(closure_129_0);
  ...
  batchChannelUpdate(arg0, arg1) {
    ...
    return (async () => {
      ...
      closure_128_0 = await HTTP.patch(request);
      const result = body(7519).checkGuildTemplateDirty(closure_129_0);
      return closure_128_0;
    })();
  },
