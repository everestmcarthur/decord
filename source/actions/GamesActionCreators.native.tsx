...
function fetchJoinSecret(application) {
  ...
  return value.then((arg0) => f125163(arg0), () => {
            ...
            if (arg0 === 1) {
              ...
              if (embedded) {
                ...
                tmp9 = (function joinViaDeeplink(application) {
                  let f125163 = application;
                  application = application.application;
                  if (application.id === f125163(application[4]).DISCORD_CONNECT_EXAMPLE_APP_APPLICATION_ID) {
                  ...
                  const value = HTTP.get(obj);
                  resolved = value.then((arg0) => f125163(arg0), () => {
                    let obj = id(application[7]);
                    obj = { type: "ACTIVITY_JOIN_FAILED", applicationId: id };
                    obj.dispatch(obj);
                    return false;
