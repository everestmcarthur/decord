...
// Dependencies: [109, 5, 17, 9500, 502, 7344, 1074, 7345, 1374, 1085, 3, 7347, 7364, 4857, 573, 4310, 559, 1364, 1462, 4312, 1241, 4983, 1115, 1271, 2]
...
// Module 9499 (GPlayActionCreators)
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_1 = tmp77;
          id = id.getId();
          const SubscriptionProductIds = React(7347).SubscriptionProductIds;
