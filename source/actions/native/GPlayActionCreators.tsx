...
// Dependencies: [109, 5, 17, 9438, 502, 7289, 1074, 7290, 1373, 1085, 3, 7292, 7309, 4823, 573, 4275, 559, 1115, 1461, 4277, 1242, 4949, 1114, 1272, 2]
...
// Module 9437 (GPlayActionCreators)
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_1 = tmp77;
          id = id.getId();
          const SubscriptionProductIds = React(7292).SubscriptionProductIds;
...
const GPlayAnalyticsStore = fn(9438);
  ...
  if (c8 === 2) {
    ...
    try {
      ...
      if (0 === v2) {
        ...
        obj7.tags = obj8;
        const result = closure_0(4277).captureBillingException(closure_131_4, obj7);
