...
// Dependencies: [109, 5, 17, 9400, 502, 7251, 1074, 7252, 1373, 1085, 3, 7254, 7271, 4792, 573, 4244, 559, 1115, 1461, 4246, 1242, 4918, 1114, 1272, 2]
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_1 = tmp77;
          id = id.getId();
          const SubscriptionProductIds = React(7254).SubscriptionProductIds;
  ...
  if (c8 === 2) {
    ...
    try {
      ...
      if (0 === v2) {
        ...
        obj7.tags = obj8;
        const result = closure_0(4246).captureBillingException(closure_131_4, obj7);
