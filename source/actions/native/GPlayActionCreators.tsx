...
// Dependencies: [109, 5, 17, 9606, 502, 7433, 1074, 7434, 1374, 1085, 3, 7436, 7453, 4940, 573, 4393, 559, 1364, 1462, 4395, 1241, 5066, 1115, 1271, 2]
...
// Module 9605 (GPlayActionCreators)
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_1 = tmp77;
          id = id.getId();
          const SubscriptionProductIds = React(7436).SubscriptionProductIds;
...
const GPlayAnalyticsStore = fn(9606);
  ...
  if (c8 === 2) {
    ...
    try {
      ...
      if (0 === v2) {
        ...
        obj7.tags = obj8;
        const result = closure_0(4395).captureBillingException(closure_131_4, obj7);
