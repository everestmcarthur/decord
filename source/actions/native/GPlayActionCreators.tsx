...
// Dependencies: [109, 5, 17, 9511, 502, 7347, 1074, 7348, 1374, 1085, 3, 7350, 7367, 4856, 573, 4308, 559, 1364, 1462, 4310, 1241, 4982, 1115, 1271, 2]
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_1 = tmp77;
          id = id.getId();
          const SubscriptionProductIds = React(7350).SubscriptionProductIds;
