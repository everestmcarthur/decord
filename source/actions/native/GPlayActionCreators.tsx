...
// Dependencies: [109, 5, 17, 9522, 502, 7351, 1074, 7352, 1374, 1085, 3, 7354, 7371, 4858, 573, 4310, 559, 1364, 1462, 4312, 1241, 4984, 1115, 1271, 2]
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_1 = tmp77;
          id = id.getId();
          const SubscriptionProductIds = React(7354).SubscriptionProductIds;
