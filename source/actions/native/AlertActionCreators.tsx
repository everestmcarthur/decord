...
// Dependencies: [19, 21, 4572, 573, 4951, 1114, 4955, 5044, 5044, 1896, 2]

// Module 4950 (actions/AlertActionCreators)
...
export default {
  ...
  show(hideActionSheet) {
    ...
    if (!tmp7) {
      if (flag) {
        merged(4572).hideActionSheet();
        const obj4 = merged(4572);
      }
      if (null != c6) {
        confirmText(4951).dismissAlert(c6);
        const obj5 = confirmText(4951);
      }
      ...
      const tmp31 = c5;
      const tmp32 = c4;
      obj8.variant = confirmText(5044).getAlertButtonVariant(confirmColor);
      ...
      const items = [c3(confirmText(4955).AlertActionButton, obj8), ];
      ...
      if (null != cancelText) {
        ...
        tmp30Result = tmp30(tmp29(4955).AlertActionButton, obj9);
      }
      ...
      obj7.openAlert(text, c3(confirmText(4955).AlertModal, obj3), () => {
        if (!c5) {
          if (c4 != null) {
            tmp();
          }
