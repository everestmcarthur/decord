...
// Dependencies: [19, 21, 4606, 573, 4985, 1115, 4989, 5078, 5078, 1897, 2]

// Module 4984 (actions/AlertActionCreators)
...
export default {
  ...
  show(hideActionSheet) {
    ...
    if (!tmp7) {
      ...
      obj7.openAlert(text, c3(confirmText(4989).AlertModal, obj3), () => {
        if (!c5) {
          if (c4 != null) {
            tmp();
          }
