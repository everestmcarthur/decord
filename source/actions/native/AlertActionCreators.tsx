...
// Dependencies: [19, 21, 4573, 573, 4952, 1114, 4956, 5045, 5045, 1896, 2]

// Module 4951 (actions/AlertActionCreators)
...
export default {
  ...
  show(hideActionSheet) {
    ...
    if (!tmp7) {
      if (flag) {
        merged(4573).hideActionSheet();
        const obj4 = merged(4573);
      }
      if (null != c6) {
        confirmText(4952).dismissAlert(c6);
        const obj5 = confirmText(4952);
      }
      ...
      const tmp31 = c5;
      const tmp32 = c4;
      obj8.variant = confirmText(5045).getAlertButtonVariant(confirmColor);
      ...
      const items = [c3(confirmText(4956).AlertActionButton, obj8), ];
      ...
      if (null != cancelText) {
        ...
        tmp30Result = tmp30(tmp29(4956).AlertActionButton, obj9);
      }
      ...
      obj7.openAlert(text, c3(confirmText(4956).AlertModal, obj3), () => {
        if (!c5) {
          if (c4 != null) {
            tmp();
          }
