...
// Dependencies: [5, 9222, 1958, 1909, 4662, 2012, 1372, 1074, 9223, 4664, 3, 1241, 551, 573, 9224, 9226, 9227, 9241, 2]

// Module 9221 (AudioActionCreators)
...
import applyBackgroundOption from "applyBackgroundOption" /* 9227 */;
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              dependencyMap = 1;
              const obj4 = { value: v1(9226)("debug_logging_enabled", closure_0, debugLogging.getDebugLogging()), done: false };
              return obj4;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              dependencyMap = 1;
              const obj4 = { value: v1(9226)("audio_subsystem", closure_0, audioSubsystem.getAudioSubsystem()), done: false };
              return obj4;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
