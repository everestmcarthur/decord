...
// Dependencies: [5, 4903, 1074, 4374, 1084, 573, 7310, 7312, 11, 4573, 1115, 1385, 1271, 2]

// Module 7315 (NotificationSettingsModalActionCreators)
...
const constants = fn(4374).NotificationSettingsUpdateType;
