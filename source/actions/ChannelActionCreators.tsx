...
// Dependencies: [32, 5, 4650, 1961, 1957, 4651, 1074, 9311, 1272, 5603, 4495, 4647, 5492, 573, 8492, 1242, 1100, 4488, 1114, 7426, 4878, 2]
...
export default {
  ...
  closePrivateChannel(id, arg1, arg2) {
    ...
    DispatcherDefault.dispatch({ type: "CHANNEL_DELETE", channel: { id, guild_id: "Array", parent_id: "accessible" }, silent: flag2 });
    if (flag) {
    ...
    const obj2 = { type: "CHANNEL_DELETE", channel: { id, guild_id: "Array", parent_id: "accessible" }, silent: flag2 };
