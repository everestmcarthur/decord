...
// Dependencies: [5, 8781, 1958, 1074, 573, 4498, 7885, 1271, 7437, 2]
...
// Module 8780 (ChannelSettingsActionCreators)
    ...
    try {
      ...
      if (0 === c4) {
        ...
        request = then((arg0) => {
          ...
          if (!tmp5) {
            const result = closure_1(7437).checkGuildTemplateDirty(guildId);
            const tmpResult = closure_1(7437);
          }
          return arg0;
        }, (body) => {
