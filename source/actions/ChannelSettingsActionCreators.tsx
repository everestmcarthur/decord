...
// Dependencies: [5, 8719, 1957, 1074, 573, 4465, 7838, 1272, 7397, 2]
...
// Module 8718 (ChannelSettingsActionCreators)
    ...
    try {
      ...
      if (0 === c4) {
        ...
        request = then((arg0) => {
          ...
          if (!tmp5) {
            const result = closure_1(7397).checkGuildTemplateDirty(guildId);
            const tmpResult = closure_1(7397);
          }
          return arg0;
        }, (body) => {
