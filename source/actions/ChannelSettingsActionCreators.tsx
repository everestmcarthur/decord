...
// Dependencies: [5, 8761, 1958, 1074, 573, 4496, 7879, 1271, 7433, 2]
...
// Module 8760 (ChannelSettingsActionCreators)
    ...
    try {
      ...
      if (0 === c4) {
        ...
        request = then((arg0) => {
          ...
          if (!tmp5) {
            const result = closure_1(7433).checkGuildTemplateDirty(guildId);
            const tmpResult = closure_1(7433);
          }
          return arg0;
        }, (body) => {
