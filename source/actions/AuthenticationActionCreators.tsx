...
// Dependencies: [5, 6699, 502, 6700, 1074, 6701, 3, 4633, 573, 4498, 1101, 4842, 4832, 1249, 1271, 4540, 6702, 6703, 510, 1100, 2]

// Module 6698 (AuthenticationActionCreators)
...
const setPromoEmailConsentState = fn(6699).setPromoEmailConsentState;
...
export default {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj5 = { value: closure_0(6702).fetchWebAuthnPasswordlessChallenge(), done: false };
              return obj5;
            }
          } else if (1 === tmp8) {
            dependencyMap = 0;
            ...
            if (4 === tmp8) {
              ...
              if (tmp16) {
                c4 = 6;
                c5 = 1;
                const obj15 = { value: tmp3(6703).signalUnknownCredential(closure_128_3), done: false };
                return obj15;
              }
            } else if (5 === tmp8) {
              if (arg0 === 1) {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj7 = { value: tmp3(4832).post(request), done: false };
              return obj7;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
  ...
  logout(TTI_test, LOGIN) {
    ...
    request.body = obj2;
    const obj = DEFAULT_LOGGED_OUT(4832);
    const tmp3 = _require;
  ...
  verify(arg0) {
    ...
    return (async () => {
      ...
      closure_128_0 = await tmp2(4832).post(request);
