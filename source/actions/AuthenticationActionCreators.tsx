...
// Dependencies: [5, 6702, 502, 6703, 1074, 6704, 3, 4632, 573, 4496, 1101, 4841, 4831, 1249, 1271, 4538, 6705, 6706, 510, 1100, 2]

// Module 6701 (AuthenticationActionCreators)
...
function handleLogout(source, CHANNELResult) {
  ...
  if (null != DEFAULT_LOGGED_OUT) {
    ...
    if (null != rootNavigationRef) {
      ...
      const tmp2Result2 = tmp2(4841);
    } else {
      const obj4 = { source };
      tmp12(1101).transitionTo(DEFAULT_LOGGED_OUT, obj4);
      const tmp12Result = tmp12(1101);
    }
    tmp12 = require;
  }
}
const setPromoEmailConsentState = fn(6702).setPromoEmailConsentState;
const Constants = fn(1074);
({ Endpoints: closure_9, DEVICE_TOKEN: c10, DEVICE_VOIP_TOKEN: closure_11, AbortCodes: closure_12, Routes: map1 } = Constants);
const PushNotificationConstants = fn(6704);
...
export default {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj5 = { value: closure_0(6705).fetchWebAuthnPasswordlessChallenge(), done: false };
              return obj5;
            }
          } else if (1 === tmp8) {
            dependencyMap = 0;
            ...
            if (4 === tmp8) {
              ...
              let tmp16 = closure_128_4 instanceof closure_0(4538).APIError;
              if (tmp16) {
              ...
              if (tmp16) {
                c4 = 6;
                c5 = 1;
                const obj15 = { value: tmp3(6706).signalUnknownCredential(closure_128_3), done: false };
                return obj15;
              }
            } else if (5 === tmp8) {
              if (arg0 === 1) {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj7 = { value: tmp3(4831).post(request), done: false };
              return obj7;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
            ...
            const v6OrEarlierAPIError = new ticket(4538).V6OrEarlierAPIError(closure_128_1);
  ...
  logout(TTI_test, LOGIN) {
    ...
    request.body = obj2;
    const obj = DEFAULT_LOGGED_OUT(4831);
    const tmp3 = _require;
  ...
  verify(arg0) {
    ...
    return (async () => {
      const token = tmp5;
      const request = { url: constants.VERIFY, body: { token }, trackedActionData: { event: token(1249).NetworkActionNames.USER_VERIFY }, rejectWithError: null };
      { event: token(1249).NetworkActionNames.USER_VERIFY };
      request.rejectWithError = token(1271).rejectWithMigratedError();
      closure_128_0 = await tmp2(4831).post(request);
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            const v6OrEarlierAPIError = new token(4538).V6OrEarlierAPIError(closure_128_9);
  ...
  resetPasswordMFAv2(arg0) {
    ...
    return (async () => {
      ...
      const request = { url: constants.RESET_PASSWORD, body: { code, ticket, password, token, source, method }, oldFormErrors: true, trackedActionData: { event: v3(1249).NetworkActionNames.USER_RESET_PASSWORD, properties: { mfa: true } }, rejectWithError: true };
      await v1(4831).post(request);
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            const v6OrEarlierAPIError = new login(4538).V6OrEarlierAPIError(closure_128_2);
