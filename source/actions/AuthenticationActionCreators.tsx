...
// Dependencies: [5, 6704, 502, 6705, 1074, 6706, 3, 4634, 573, 4498, 1101, 4843, 4833, 1249, 1271, 4540, 6707, 6708, 510, 1100, 2]

// Module 6703 (AuthenticationActionCreators)
...
const setPromoEmailConsentState = fn(6704).setPromoEmailConsentState;
...
export default {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj5 = { value: closure_0(6707).fetchWebAuthnPasswordlessChallenge(), done: false };
              return obj5;
            }
          } else if (1 === tmp8) {
            dependencyMap = 0;
            ...
            if (4 === tmp8) {
              ...
              let tmp16 = closure_128_4 instanceof closure_0(4540).APIError;
              if (tmp16) {
              ...
              if (tmp16) {
                c4 = 6;
                c5 = 1;
                const obj15 = { value: tmp3(6708).signalUnknownCredential(closure_128_3), done: false };
                return obj15;
              }
            } else if (5 === tmp8) {
              if (arg0 === 1) {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj7 = { value: tmp3(4833).post(request), done: false };
              return obj7;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
            ...
            const v6OrEarlierAPIError = new ticket(4540).V6OrEarlierAPIError(closure_128_1);
  ...
  logout(TTI_test, LOGIN) {
    ...
    request.body = obj2;
    const obj = DEFAULT_LOGGED_OUT(4833);
    const tmp3 = _require;
  ...
  verify(arg0) {
    ...
    return (async () => {
      ...
      closure_128_0 = await tmp2(4833).post(request);
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            const v6OrEarlierAPIError = new token(4540).V6OrEarlierAPIError(closure_128_9);
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            const v6OrEarlierAPIError = new login(4540).V6OrEarlierAPIError(closure_128_2);
