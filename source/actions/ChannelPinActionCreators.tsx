...
// Dependencies: [5, 11770, 1074, 7838, 1272, 4508, 1114, 4951, 573, 2]

// Module 11769 (ChannelPinActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import ChannelPinsStore from "ChannelPinsStore" /* 11770 */;

const require = fn;
const FetchState = fn(11770).FetchState;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp2(7838).unarchiveThreadIfNecessary(tmp3.id), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            HTTP.put(obj6).catch((error) => {
              const aPIError = new _private(4508).APIError(error);
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: id(7838).unarchiveThreadIfNecessary(channel.id), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            HTTP.del(obj6).catch(() => {
              ...
              return closure_1(4951).show(obj2);
            });
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
