...
// Dependencies: [5, 11817, 1074, 7879, 1271, 4538, 1115, 4982, 573, 2]

// Module 11816 (ChannelPinActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import ChannelPinsStore from "ChannelPinsStore" /* 11817 */;

const require = fn;
const FetchState = fn(11817).FetchState;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp2(7879).unarchiveThreadIfNecessary(tmp3.id), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            HTTP.put(obj6).catch((error) => {
              const aPIError = new _private(4538).APIError(error);
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: id(7879).unarchiveThreadIfNecessary(channel.id), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            HTTP.del(obj6).catch(() => {
              ...
              return closure_1(4982).show(obj2);
            });
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
